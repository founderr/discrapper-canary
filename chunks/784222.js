...
var r, i, a, o, s, l, u = n(470079), c = n(392711), d = n.n(c), _ = n(772848), E = n(442837), f = n(80932), h = n(339085), p = n(906411), m = n(689789), I = n(633302), T = n(806966), g = n(28546), S = n(889161), A = n(984933), N = n(430824), v = n(914010), O = n(771845), R = n(594174), C = n(176354), y = n(111361), D = n(392552), L = n(543241), b = n(304852), M = n(199257), P = n(149203), U = n(185923), w = n(689938);
...
let x = e => {
    let {
            ...
            emojiSpriteSize: l
        } = e, c = (0, E.e7)([h.Z], () => h.Z.categories), f = (0, E.e7)([N.Z], () => N.Z.getGuild(null == t ? void 0 : t.getGuildId()), [t]), T = null == t ? null : t.getGuildId(), g = (0, E.e7)([h.Z], () => h.Z.getDisambiguatedEmojiContext(T), [T]), x = (0, L.NJ)(T), G = (0, L.wC)(T), k = (0, L.q5)(T), {canSplitFrecencyList: B} = (0, m.S)({
            location: 'useEmojiGrid',
            autoTrackExposure: !0
        }), {
            topEmojis: F,
            newlyAddedEmojis: V
        } = (0, M.Z)(T, i), H = (0, E.Wu)([O.ZP], () => O.ZP.getFlattenedGuildIds(), []), {canCreateExpressions: Z} = (0, S.XJ)(f), Y = (0, E.e7)([R.default], () => R.default.getCurrentUser()), j = (0, y.I5)(Y), W = g.getCustomEmoji(), K = e => {
            if (e.type === p.B.GUILD)
                return e.guildId;
        }, z = u.useMemo(() => d().groupBy(W, K), [W]), {
            enabled: q,
            treatment: Q
        } = D.Z.useExperiment({ location: 'EmojiPicker' }, {
            autoTrackExposure: !0,
            disable: !Z
        });
    return u.useMemo(() => {
        ...
        if (null != g && null != o) {
            let T = Math.floor(o / (l + 2 * s)), g = (a, o) => {
                    let s = new Map(), c = n.has(o.sectionId), [_, f] = d().partition(a, e => {
                            ...
                            return s.set(e, n), !n;
                        }), I = _.concat(f), g = o.guild, S = v.Z.getGuildId(), A = o.sectionId === P.En.TOP_GUILD_EMOJI, N = !A && null != g && S === g.id && I.length < g.getMaxEmojiSlots(), O = A && I.length < T && !q, R = null != g && A && q && Q === D.B.WITH_TOP_LIST && z[g.id].length < g.getMaxEmojiSlots(), y = r && Z && null != g && (N || O || R);
                    y && R && I.length === T && I.shift();
                    let b = q && y && !c, M = Math.ceil((y ? I.length + 1 : I.length) / T), U = [];
                    for (let e = 0; e < M; e++) {
                        let t = 0 === e, n = e * T - (b && e > 0 ? 1 : 0), r = n + T - (b && t ? 1 : 0), i = I.slice(n, r).map((e, n) => {
                                var r, i;
                                return {
                                    type: 0,
                                    emoji: e,
                ...
                for (let e of c)
                    if (e === P.UX.CUSTOM) {
                        let n = n => {
                            ...
                            if (0 === a.length)
                                return;
                            let o = N.Z.getGuild(n), s = !j && C.ZP.isEmojiCategoryNitroLocked({
                                    categoryEmojis: a,
                                    channel: t,
                                    intention: i
                                });
...
let G = e => {
        ...
        let {emojiListRef: t} = e, n = (0, g.Iu)(e => e.searchQuery), r = u.useCallback(e => {
                var n;

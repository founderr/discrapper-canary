...
var r, i, a, o, s = n(442837), l = n(570140), u = n(700785), c = n(592125), d = n(131951), _ = n(19780), E = n(944486), f = n(981631), h = n(65154);
let p = new Map(), m = null, I = null, T = null;
function g(e, t) {
    let n = p.get(e);
    if (null == n)
        return !1;
...
function A(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], r = p.get(e);
    if (null == r)
        return !1;
...
class v extends (r = s.ZP.Store) {
    ...
    getSpeakingDuration(e, t) {
        var n, r;
        let i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : h.Yn.DEFAULT, a = null === (r = p.get(i)) || void 0 === r ? void 0 : null === (n = r.get(e)) || void 0 === n ? void 0 : n.since;
        return null != a ? t - a : 0;
    }
    getSpeakers() {
        var e, t;
...
o = 'SpeakingStore', (a = 'displayName') in (i = v) ? Object.defineProperty(i, a, {
    ...
    SPEAKING: function (e) {
        ...
        return function (e, t, n) {
            var r, i;
            let a = function () {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : h.Yn.DEFAULT, t = p.get(e);
                    return null == t && (t = new Map(), p.set(e, t)), t;
                }(e), o = a.get(t), s = null !== (r = null == o ? void 0 : o.flags) && void 0 !== r ? r : 0;
            if (0 === s && 0 === n)
                return !1;
            if (0 === n)
                a.delete(t), 0 === a.size && p.delete(e);
            else {
                let e = null !== (i = null == o ? void 0 : o.since) && void 0 !== i ? i : null, r = (s & h.Dg.VOICE) === h.Dg.VOICE, l = (n & h.Dg.VOICE) === h.Dg.VOICE;

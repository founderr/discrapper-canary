s(47120), s(653041);
var n, i, o = s(735250), l = s(470079), a = s(120356), r = s.n(a), h = s(285952), d = s(286290);
function u(e, t, s) {
...
class c extends (n = l.PureComponent) {
    ...
    constructor(...e) {
        super(...e), u(this, '_codeBlockRef', void 0), u(this, 'setCodeBlockRef', e => {
            ...
            let t = 8 === e.which || 37 === e.which || 39 === e.which, s = e.which >= 48 && e.which <= 57 || e.keyCode >= 96 && e.keyCode <= 105;
...
class p extends (i = l.PureComponent) {
    render() {
        let {
                className: e,
                inputClassName: t
            } = this.props, {codes: s} = this.state, n = [];
        for (let e = 0; e < s.length; e++)
            e === s.length / 2 && n.push((0, o.jsx)('div', { className: d.spacer }, 'spacer')), n.push((0, o.jsx)(c, {

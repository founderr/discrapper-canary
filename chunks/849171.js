...
channelId: E.id,
application: f
  }) === _.Fw.CAN_JOIN, y = null !== (n = E.getGuildId()) && void 0 !== n ? n : void 0, k = l.useId(), U = E.id, w = f.id, {
submitting: B
  } = (0, S.Z)({
applicationId: w,
channelId: U,
...
children: [
  ...
  (0, s.jsx)(u.Text, {
    ...
    children: x.length > 1 ? P.Z.Messages.EMBEDDED_ACTIVITIES_USERNAME_AND_OTHERS.format({
      username: A,
      count: x.length - 1
    }) : P.Z.Messages.EMBEDDED_ACTIVITIES_IS_PLAYING.format({
      username: A
    })
  }),
  (0, s.jsx)(u.Text, {

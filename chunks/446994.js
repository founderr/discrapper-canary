    ...
    return (() => {
        var e, t, i, r, o, n, a, s, u, d = {
                ...
                525: (e, t, i) => {
                    var r = i(331);
                    function o() {
                        return 'undefined' != typeof Reflect && Reflect.get ? e.exports = o = Reflect.get : e.exports = o = function (e, t, i) {
                            var o = r(e, t);
                            if (o) {
                ...
                489: e => {
                    function t(i, r) {
                        ...
                        }, e.exports.__esModule = !0, e.exports.default = e.exports, t(i, r);
                    }
                    e.exports = t, e.exports.__esModule = !0, e.exports.default = e.exports;
                },
                331: (e, t, i) => {
                    ...
                    window, e.exports = function (e) {
                        ...
                        function (e, t) {
                            ...
                            i.prototype.flush = function () {
                                ...
                                for (var t = [], i = 0; i < this.channels; i++)
                                    t[i] = new Float32Array(e);
                                return t;
                            }, i.prototype.validate = function (e) {
                                if (e.length !== this.channels)
                                    return !1;
                                ...
                                var r = e[0].length, o = t + Math.min(i, r);
                                if (0 == t && o >= r)
                                    return e;
                                for (var n = [], a = 0; a < this.channels; a++)
                                    n[a] = e[a].subarray(t, o);
                                return n;
                            }, e.exports = i;
                        },
                        function (e, t, i) {
                            !function () {
                                ...
                                o.prototype.rate = 0, o.prototype.targetRate = 0, o.prototype.channels = 0, o.prototype.bufferSize = 0, Object.defineProperty(o.prototype, 'bufferDuration', {
                                    get: function () {
                                    ...
                                    var t = this.rate, i = this.channels, r = this._backend.rate, o = this._backend.channels;
                                    if (t == r && i == o)
                                        return e;
                                    var n, a = [], s = e[0].length, u = this._resampleFractional, d = s * r / t + u, c = Math.floor(d), h = d - c;
                                    n = t < r ? function (e, i, o, n) {
                                        for (var a = function (t) {
                                                    return t < 0 ? o && o.length + t > 0 ? o[o.length + t] : e[0] : e[t];
                                                }, s = 0; s < i.length; s++) {
                                            var d, c = (s + 1 - u) * t / r - 1, h = Math.floor(c), f = Math.ceil(c);
                                    ...
                                    for (var l = 0; l < o; l++) {
                                        var _ = l;
                                        l >= i && (_ = 0);
                                        var p = e[_], m = new Float32Array(c);
                        ...
                        function (e, t, i) {
                            !function () {
                                ...
                                n.prototype.bufferSize = 4096, n.prototype.bufferThreshold = 8192, n.prototype._volume = 1, Object.defineProperty(n.prototype, 'volume', {
                                ...
                                }), n.prototype._muted = !1, Object.defineProperty(n.prototype, 'muted', {
                                    get: function () {
                                        return this._muted;
                                    },
                                    set: function (e) {
                                    ...
                                    var t, i, r, n, a, s = this._playbackTimeAtBufferTail;
                                    if (s < a && (this._delayedTime += a - s), this._bufferQueue.sampleCount() < this.bufferSize && this.onstarved && this.onstarved(), this._bufferQueue.sampleCount() < this.bufferSize) {
                                        for (t = 0; t < this.channels; t++)
                                            for (r = e.outputBuffer.getChannelData(t), n = 0; n < this.bufferSize; n++)
                                                r[n] = 0;
                                        this._dropped++;
                                    } else {
                                        var u = this.muted ? 0 : this.volume, d = this._bufferQueue.nextBuffer();
                                        if (d[0].length < this.bufferSize)
                                            throw 'Audio buffer not expected length.';
                                        for (t = 0; t < this.channels; t++)
                                            for (i = d[t], this._liveBuffer[t].set(d[t]), r = e.outputBuffer.getChannelData(t), n = 0; n < i.length; n++)
                                                r[n] = i[n] * u;
                                    ...
                                    if (this._node) {
                                        ...
                                        if (e > 0) {
                                            var t = Math.round(e * this.rate), i = this._liveBuffer ? this._liveBuffer[0].length : 0;
                                ...
                                }, n.prototype.onstarved = null, n.prototype.onbufferlow = null, n.isSupported = function () {
                                    return !!t;
                                }, n.sharedAudioContext = null, n.initSharedAudioContext = function () {
                                    if (!n.sharedAudioContext && n.isSupported()) {
                                        var e, i = new t();
                                        if (i.createScriptProcessor)
                                            e = i.createScriptProcessor(1024, 0, 2);
                                        else {
                                ...
                                return function (e) {
                                    ...
                                    function (e, t, i) {
                                        ...
                                        r = i(0), o = i(2), e.exports = function (e) {
                                            var t = (e = e || {}).sampleRate || 44100, i = e.wsizeLog || 11, n = e.tempo || 1, a = (e.numChannels, Math.pow(2, 50 / 1200) - 1), s = 1 << i, u = o(i), d = 1 << i - 2;
                                            d -= d % 100;
                                            for (var c = r.float_array(s + d + 5), h = r.float_array(s + d + 5), f = d, l = d, _ = r.float_array(s), p = 0; p < s; p++)
                                                _[p] = 0.5 * (1 - Math.cos(2 * Math.PI * p / s));
                                            var m = 1 + (s >> 1), V = r.float_array(m), v = r.float_array(m), g = r.float_array(m), y = r.float_array(m), b = r.float_array(m), T = r.float_array(m), A = 1 + (m >> 1), k = [
                                                    0,
                                                    0
                                                ], E = [], P = [], w = [], x = [];
                                            for (p = 0; p < 2; p++)
                                                E.push(r.float_array(A)), P.push(r.float_array(A)), w.push(r.float_array(A)), x.push(r.float_array(m));
                                            var R = r.float_array(A), F = r.float_array(A), O = 0, S = 0, C = [{
                                                        in_time: 0,
                                                        out_time: 0,
                                                        tempo: n
                                                    }], D = 0, M = 0, B = 1, I = 0, j = 0, L = 0, U = 0, G = {
                                                    mapOutputToInputTime: function (e) {
                                                        for (var t = C.length - 1; e < C[t].out_time && t > 0;)
                                                            t--;
                                                        var i = C[t];
                                                    ...
                                                    flush: function (e) {
                                                        ...
                                                        if (e) {
                                                            ...
                                                            for (var r = C.length - 1; S <= C[r].out_time && r >= 0;)
                                                                C.pop(), r--;
                                                            C.push({
                                                                in_time: O,
                                                                out_time: S,
                                                    ...
                                                    setTempo: function (e) {
                                                        f = l = d, e >= 1 ? l = Math.round(f / e) : f = Math.round(l * e), j = (1 / e - 1 * l / f) * f, B = function (e, t) {
                                                            for (var i = e.length / t | 0, r = 0, o = 0; o < i; o++)
                                                                r += e[o * t];
                                                            return 0.9 / r;
                                                        }(_, l), n = e;
                                                        var t = C[C.length - 1];
                                            ...
                                            var W = function (e, t, i) {
                                                    var r = Math.floor(i), o = r % 2 == 1 ? -1 : 1;
                                                    return Math.atan2(o * (t[r] - t[r + 1]), o * (e[r] - e[r + 1]));
                                                }, N = function (e, t, i, r, o) {
                                                    var n, a = 2 * Math.PI / s * 0.5 * (r + t) * f;
                                                    return ((n = e - i - a) - 2 * Math.PI * Math.round(n / (2 * Math.PI)) + a) * o;
                                                }, X = function (e, t, i, r, o, n) {
                                                    for (var u = e % 2, d = 1 - u, c = x[d], h = k[d], f = E[d], l = P[d], _ = w[d], p = x[u], m = 1; m < p.length; m++)
                                                        p[m] = t[m] * t[m] + i[m] * i[m];
                                                    var V = E[u], v = k[u] = function (e, t) {
                                                            for (var i = 0, r = 0; r < e.length; r++)
                                                                e[r] > i && (i = e[r]);
                                                            var o = 1e-8 * i, n = 1, s = 1;
                                                    ...
                                                    I -= e;
                                                    for (var t = 0; t < s; t++)
                                                        u.m_re[t] = _[t] * c[t], u.m_im[t] = _[t] * c[f + t];
                                                    ...
                                                    var o = 0, n = B;
                                                    for (t = 0; t < l; t++)
                                                        Math.abs(2 * u.m_re[t]) > o && (o = Math.abs(2 * u.m_re[t]));
                                                    for (t = 0; t < s - l; t++)
                                                        Math.abs(u.m_re[t + l + e] + u.m_im[t]) > o && (o = Math.abs(u.m_re[t + l + e] + u.m_im[t]));
                                                    for (t = s - l; t < s; t++)
                                            ...
                                            return G.process = function (e) {
                                                ...
                                                var V = 2 * Math.floor(Math.max(0, L + i - (s - f)) / (2 * f)), v = U + l * V + Math.floor(I + j * V);
                                                U > v && (v = U);
                                    ...
                                    function (e, t, i) {
                                        ...
                                        e.exports = function (e) {
                                            ...
                                            i.inplace = function (e) {
                                                var t = i.m_re, r = i.m_im, o = i.m_N, n = i.m_logN, a = o >> 1, s = o >> 1, u = o;
                                                if (e)
                                                    for (var d = 1 / o, c = 0; c < o; c++)
                                                        t[c] *= d, r[c] *= d;
                                                for (var h = 0; h < n; h++) {
                                                    var f = i.twiddleRe[h], l = i.twiddleIm[h];
                                                    e || (l *= -1);
                                                    for (var _ = 0; _ < o;) {
                                                        for (var p = _, m = _ + s, V = 1, v = 0, g = 0; g < a; g++) {
                                                            var y = t[p], b = r[p], T = t[m], A = r[m];
                                                ...
                                                for (var E, P, w = i.m_revTgt, x = 0; x < o; x++)
                                                    w[x] > x && (P = t[E = w[x]], t[E] = t[x], t[x] = P, P = r[E], r[E] = r[x], r[x] = P);
                                            };
                                            var h = t >> 1;
                                            return i.unpack = function (e, r, o, n) {
                                                e[0] = i.m_re[0], o[0] = i.m_im[0], r[0] = n[0] = 0, e[h] = i.m_re[h], o[h] = i.m_im[h], r[h] = n[h] = 0;
                                                for (var a = 1; a < h; a++)
                                                    e[a] = (i.m_re[a] + i.m_re[t - a]) / 2, r[a] = (i.m_im[a] - i.m_im[t - a]) / 2, o[a] = (i.m_im[a] + i.m_im[t - a]) / 2, n[a] = (-i.m_re[a] + i.m_re[t - a]) / 2;
                                            }, i.repack = function (e, r, o, n) {
                                                i.m_re[0] = e[0], i.m_im[0] = o[0], i.m_re[h] = e[h], i.m_im[h] = o[h];
                                                for (var a = 1; a < h; a++)
                                                    i.m_re[a] = e[a] - n[a], i.m_im[a] = r[a] + o[a], i.m_re[t - a] = e[a] + n[a], i.m_im[t - a] = -r[a] + o[a];
                                            }, i;
                                        };
                                    }
                                ]);
                ...
                893: (e, t, i) => {
                    ...
                    var o = r(i(575)), n = r(i(913)), a = function () {
                            function e(t) {
                ...
                523: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(575)), n = r(i(913)), a = new (function () {
                            function e() {
                                (0, o.default)(this, e);
                            }
                            return (0, n.default)(e, [
                ...
                408: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(575)), n = r(i(913)), a = r(i(205)), s = r(i(585)), u = r(i(754)), d = function (e) {
                            (0, a.default)(d, e);
                            var t, i, r = (t = d, i = function () {
                ...
                445: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(575)), n = r(i(913)), a = r(i(539)), s = '1.8.9-20220406232920-cb5f7ff', u = {
                            ...
                            return (0, n.default)(e, [
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, i) {
                                        var r = this;
                                        i = i || {};
                                        var o = this.getGlobal(), n = this.urlForClass(e), a = function (t) {
                                                return (t = t || {}).locateFile = function (e) {
                                                    return 'data:' === e.slice(0, 5) ? e : r.urlForScript(e);
                                                }, t.mainScriptUrlOrBlob = r.scriptForClass(e) + '?version=' + encodeURIComponent(s), o[e](t);
                                            };
                                        'function' == typeof o[e] ? t(a) : this.loadScript(n, function () {
                                            t(a);
                                        });
                                    }
                                }
                ...
                964: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(575)), n = r(i(913)), a = r(i(525)), s = r(i(205)), u = r(i(585)), d = r(i(754)), c = r(i(408)), h = r(i(319)), f = r(i(445)), l = {
                            audio: {
                                proxy: c.default,
                            ...
                            return (0, n.default)(c, [
                                ...
                                },
                                {
                                    key: 'defaultBase',
                                    value: function () {
                                        for (var e, t, i = document.querySelectorAll('script'), r = /^(?:|(.*)\/)ogv(?:-support|-es2017)?\.js(?:\?|#|$)/, o = 0; o < i.length; o++)
                                            if ((e = i[o].getAttribute('src')) && (t = e.match(r)))
                                                return t[1];
                                    }
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        var i = this;
                                        if ('done' == this.scriptStatus[e])
                                            t();
                                        else if ('loading' == this.scriptStatus[e])
                                            this.scriptCallbacks[e].push(t);
                                        else {
                                            this.scriptStatus[e] = 'loading', this.scriptCallbacks[e] = [t];
                                            var r = document.createElement('script'), o = function (t) {
                                                    var r = i.scriptCallbacks[e];
                                                    delete i.scriptCallbacks[e], i.scriptStatus[e] = 'done', r.forEach(function (e) {
                                                        e();
                                                    });
                                                };
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t) {
                                        var i = l[_[e]];
                                        if (!i)
                                            throw Error('Requested worker for class with no proxy: ' + e);
                                        var r, o = i.proxy, n = i.worker, a = this.urlForScript(this.scriptForClass(e)), s = this.urlForScript(n), u = function (t) {
                                                return new o(r, e, t);
                                            };
                                        if (s.match(/^https?:|\/\//i)) {
                                            var d, c, h, f, m, V = function () {
                                                    if (1 == v && 1 == g) {
                                                        ...
                                                        r = new Worker(URL.createObjectURL(m)), t(function (e) {
                                                            return Promise.resolve(new u(e));
                                                        });
                                                    }
                                                }, v = !1, g = !1;
                                            (d = new XMLHttpRequest()).open('GET', a, !0), d.onreadystatechange = function () {
                                                4 == d.readyState && 200 == d.status && (h = d.responseText, v = !0, V());
                                            }, d.send(), (c = new XMLHttpRequest()).open('GET', s, !0), c.onreadystatechange = function () {
                                                4 == c.readyState && 200 == c.status && (f = c.responseText, g = !0, V());
                                            }, c.send();
                                        } else
                                            r = new Worker(s), t(function (e) {
                                                return Promise.resolve(new u(e));
                                            });
                                    }
                                }
                ...
                759: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(913)), n = r(i(575)), a = r(i(309)), s = {
                            MEDIA_ERR_ABORTED: 1,
                            MEDIA_ERR_NETWORK: 2,
                            MEDIA_ERR_DECODE: 3,
                ...
                869: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(575)), n = r(i(913)), a = r(i(506)), s = r(i(205)), u = r(i(585)), d = r(i(754)), c = r(i(8)), h = r(i(731)), f = r(i(936)), l = r(i(848)), _ = r(i(964)), p = r(i(893)), m = r(i(309)), V = r(i(759)), v = r(i(278)), g = r(i(168)), y = r(i(625)), b = r(i(302)), T, A = function () {
                            if ('function' == typeof setImmediate)
                                return setImmediate;
                            var e = new MessageChannel(), t = [];
                            ...
                            HAVE_FUTURE_DATA: 3,
                            HAVE_ENOUGH_DATA: 4
                        }, E = 'INITIAL', P = 'SEEKING_END', w = 'LOADED', x = 'PRELOAD', R = 'READY', F = 'PLAYING', O = 'SEEKING', S = 'ERROR', C = 'NOT_SEEKING', D = 'BISECT_TO_TARGET', M = 'BISECT_TO_KEYPOINT', B = 'LINEAR_TO_TARGET', I = 'fast';
                    function j() {
                    ...
                    var L = function (e) {
                        ...
                        function c(e) {
                            var t;
                            if ((0, o.default)(this, c), t = r.call(this), (e = e || {}).base = e.base || _.default.base, t._options = e, t._instanceId = 'ogvjs' + ++c.instanceCount, void 0 !== e.worker ? t._enableWorker = !!e.worker : t._enableWorker = !!window.Worker, !_.default.wasmSupported())
                                throw Error('WebAssembly not supported');
                            return t._enableThreading = !!e.threading, t._enableSIMD = !!e.simd, t._state = E, t._seekState = C, t._detectedType = null, t._canvas = document.createElement('canvas'), t._frameSink = null, t.className = t._instanceId, (0, m.default)((0, a.default)(t), k), t._view = t._canvas, t._view.style.position = 'absolute', t._view.style.top = '0', t._view.style.left = '0', t._view.style.width = '100%', t._view.style.height = '100%', t._view.style.objectFit = 'contain', t.appendChild(t._view), t._startTime = T(), t._codec = null, t._audioInfo = null, t._videoInfo = null, t._actionQueue = [], t._audioFeeder = null, t._muted = !1, t._initialPlaybackPosition = 0, t._initialPlaybackOffset = 0, t._prebufferingAudio = !1, t._initialSeekTime = 0, t._currentSrc = '', t._crossOrigin = null, t._streamEnded = !1, t._mediaError = null, t._dataEnded = !1, t._byteLength = 0, t._duration = null, t._lastSeenTimestamp = null, t._nextProcessingTimer, t._nextFrameTimer = null, t._loading = !1, t._started = !1, t._paused = !0, t._ended = !1, t._startedPlaybackInDocument = !1, t._stream = void 0, t._framesProcessed = 0, t._targetPerFrameTime = 1000 / 60, t._actualPerFrameTime = 0, t._totalFrameTime = 0, t._totalFrameCount = 0, t._playTime = 0, t._bufferTime = 0, t._drawingTime = 0, t._proxyTime = 0, t._totalJitter = 0, t._droppedAudio = 0, t._delayedAudio = 0, t._lateFrames = 0, t._poster = '', t._thumbnail = null, t._frameEndTimestamp = 0, t._audioEndTimestamp = 0, t._decodedFrames = [], t._pendingFrames = [], t._lastFrameDecodeTime = 0, t._lastFrameVideoCpuTime = 0, t._lastFrameAudioCpuTime = 0, t._lastFrameDemuxerCpuTime = 0, t._lastFrameDrawingTime = 0, t._lastFrameBufferTime = 0, t._lastFrameProxyTime = 0, t._lastVideoCpuTime = 0, t._lastAudioCpuTime = 0, t._lastDemuxerCpuTime = 0, t._lastBufferTime = 0, t._lastProxyTime = 0, t._lastDrawingTime = 0, t._lastFrameTimestamp = 0, t._currentVideoCpuTime = 0, t._lastTimeUpdate = 0, t._timeUpdateInterval = 250, t._seekTargetTime = 0, t._bisectTargetTime = 0, t._seekMode = null, t._lastSeekPosition = null, t._seekBisector = null, t._didSeek = null, t._depth = 0, t._needProcessing = !1, t._pendingFrame = 0, t._pendingAudio = 0, t._framePipelineDepth = 8, t._frameParallelism = t._enableThreading ? Math.min(16, navigator.hardwareConcurrency) || 1 : 0, t._audioPipelineDepth = 12, t._videoInfo = null, t._audioInfo = null, t._width = 0, t._height = 0, t._volume = 1, t._playbackRate = 1, Object.defineProperties((0, a.default)(t), {
                                src: {
                                    get: function () {
                                ...
                                seekable: {
                                    get: function () {
                                        return new g.default(this.duration < 1 / 0 && this._stream && this._stream.seekable && this._codec && this._codec.seekable ? [[
                                                0,
                                                this._duration
                                            ]] : []);
                                    }
                                ...
                                poster: {
                                    ...
                                    set: function (e) {
                                        ...
                                        if (this._poster = e, !this._started) {
                                            ...
                                            var i = new Image();
                                            i.crossOrigin = this.crossOrigin, i.src = this._poster, i.className = 'ogvjs-poster', i.style.position = 'absolute', i.style.top = '0', i.style.left = '0', i.style.width = '100%', i.style.height = '100%', i.style.objectFit = 'contain', i.style.visibility = 'hidden', i.addEventListener('load', function () {
                                                t._thumbnail === i && (c.styleManager.appendRule('.' + t._instanceId, {
                                                    width: i.naturalWidth + 'px',
                                                    height: i.naturalHeight + 'px'
                                                }), i.style.visibility = 'visible');
                                            }), this._thumbnail = i, this.appendChild(i);
                                        }
                                    }
                                },
                                videoWidth: {
                            ...
                            }), t.onframecallback = null, t.onloadstate = null, t.onprogress = null, t.onsuspend = null, t.onabort = null, t.onemptied = null, t.onstalled = null, t.onloadedmetadata = null, t.onloadeddata = null, t.oncanplay = null, t.oncanplaythrough = null, t.onplaying = null, t.onwaiting = null, t.onseeking = null, t.onseeked = null, t.onended = null, t.ondurationchange = null, t.ontimeupdate = null, t.onplay = null, t.onpause = null, t.onratechange = null, t.onresize = null, t.onvolumechange = null, t.onaudiofeedercreated = null, t;
                        }
                        return (0, n.default)(c, [
                            {
                                key: '_time',
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    var i, r = 'function' == typeof Event;
                                    for (var o in (r ? i = new CustomEvent(e) : (i = document.createEvent('Event')).initEvent(e, !1, !1), t))
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    this._log('fireEventAsync ' + e), A(function () {
                                        t._fireEvent(e, i);
                                    });
                                }
                            },
                            {
                                ...
                                value: function () {
                                    var e = this, t = this._options, i = { bufferSize: 8192 };
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    if (this._audioFeeder) {
                                        ...
                                        this._initialPlaybackPosition = this._playbackRate * T() / 1000;
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    this._startedPlaybackInDocument && !document.body.contains(this) && A(function () {
                                        e.stop();
                                    });
                                    var i = T(), r = i - this._lastFrameTimestamp, o = this._actualPerFrameTime - this._targetPerFrameTime;
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    if (this._log('requested seek to ' + e + ', mode ' + t), this.readyState == this.HAVE_NOTHING)
                                        return this._log('not yet loaded; saving seek position for later'), void (this._initialSeekTime = e);
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    var t = this;
                                    this._streamEnded = !1, this._dataEnded = !1, this._ended = !1, this._state = O, this._seekTargetTime = e, this._lastSeekPosition = -1, this._decodedFrames = [], this._pendingFrames = [], this._pendingFrame = 0, this._pendingAudio = 0, this._didSeek = !1, this._codec.seekToKeypoint(e, function (i) {
                                        if (i)
                                            return t._seekState = B, t._fireEventAsync('seeking'), t._didSeek ? void 0 : void t._pingProcessing();
                            ...
                            },
                            {
                                key: '_startBisection',
                                value: function (e) {
                                    var t = this, i = Math.max(0, this._stream.length - 65536);
                                    this._bisectTargetTime = e, this._seekBisector = new p.default({
                                        start: 0,
                                        end: i,
                                ...
                                value: function () {
                                    ...
                                    if (this._codec.hasVideo && this._decodedFrames.length) {
                                        ...
                                        if (this._codec.hasVideo && this._codec.frameReady)
                                            return this._codec.decodeFrame(function (i) {
                                ...
                                value: function () {
                                    ...
                                    if (e = this._codec.hasVideo ? this._targetPerFrameTime / 1000 : 1 / 256, this._codec.hasVideo) {
                                        ...
                                        if (this._codec.frameTimestamp <= this._seekTargetTime) {
                                            ...
                                            return this._pendingFrame++, this._pendingFrames.push({ frameEndTimestamp: i }), this._decodedFrames.splice(0, this._decodedFrames.length), this._codec.decodeFrame(function (e) {
                            ...
                            },
                            {
                                key: '_doProcessing',
                                value: function () {
                                    if (this._didSeek && (this._didSeek = !1), this._nextProcessingTimer = null, this._isProcessing(), this._depth > 0)
                                        throw Error('REENTRANCY FAIL: doProcessing recursing unexpectedly');
                                    var e = 0;
                                    do {
                                        if (this._needProcessing = !1, this._depth++, this._doProcessingLoop(), this._depth--, this._needProcessing && this._isProcessing())
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    this._codec.frameReady ? (this._log('saw frame with ' + this._codec.frameTimestamp), this._lastSeenTimestamp = Math.max(this._lastSeenTimestamp, this._codec.frameTimestamp), this._codec.discardFrame(function () {
                                        ...
                                        t ? e._pingProcessing() : e._stream.eof ? (e._log('seek-duration: we are at the end: ' + e._lastSeenTimestamp), e._lastSeenTimestamp > 0 && (e._duration = e._lastSeenTimestamp), e._state = w, e._codec.flush(function () {
                                    ...
                                    if (this._paused)
                                        ...
                                        if (t.hasAudio && this._audioFeeder ? (n = this._audioFeeder.getPlaybackState(), a = this._getPlaybackTime(n), s = this._dataEnded && 0 == this._audioFeeder.durationBuffered, this._prebufferingAudio && (this._audioFeeder.durationBuffered >= 2 * this._audioFeeder.bufferThreshold && (!t.hasVideo || this._decodedFrames.length >= this._framePipelineDepth) || this._dataEnded) && (this._log('prebuffering audio done; buffered to ' + this._audioFeeder.durationBuffered), this._startPlayback(a), this._prebufferingAudio = !1), n.dropped != this._droppedAudio && this._log('dropped ' + (n.dropped - this._droppedAudio)), n.delayed != this._delayedAudio && this._log('delayed ' + (n.delayed - this._delayedAudio)), this._droppedAudio = n.dropped, this._delayedAudio = n.delayed, (i = this._audioFeeder.durationBuffered <= 2 * this._audioFeeder.bufferThreshold) && (this._codec.audioReady ? this._pendingAudio >= this._audioPipelineDepth && (this._log('audio decode disabled: ' + this._pendingAudio + ' packets in flight'), i = !1) : i = !1)) : (a = this._getPlaybackTime(), i = this._codec.audioReady && this._audioEndTimestamp < a), this._codec.hasVideo) {
                                            ...
                                            if (this._prebufferingAudio)
                                                ...
                                                var l = this._codec.nextKeyframeTimestamp, _ = l - this._targetPerFrameTime / 1000 * (this._framePipelineDepth + this._pendingFrame);
                                                if (l >= 0 && l != this._codec.frameTimestamp && a >= _) {
                                                    ...
                                                    for (this._pendingFrames = [], this._pendingFrame = 0; this._codec.frameReady && this._codec.frameTimestamp < l;) {
                                                        ...
                                                        u = 1000 * (g.frameEndTimestamp - a), this._actualPerFrameTime = this._targetPerFrameTime - u, this._lateFrames++, this._codec.discardFrame(function () {
                                                        }), this._framesProcessed++, this._doFrameComplete(g);
                                                    }
                                        ...
                                        if (o) {
                                            ...
                                            var b = this._pendingFrames, T = !1, A = this._time(function () {
                                                    e._codec.decodeFrame(function (t) {
                                                        b === e._pendingFrames ? (e._log('play loop callback: decoded frame'), e._pendingFrame--, e._pendingFrames.shift(), t ? e._decodedFrames.push({
                                            ...
                                            var k = this._codec.audioTimestamp, E = this._time(function () {
                                                    e._codec.decodeAudio(function (t) {
                                                        if (e._pendingAudio--, e._log('play loop callback: decoded audio'), e._audioEndTimestamp = k, t) {
                                                            ...
                                                            if (i && (e._bufferTime += e._time(function () {
                                            ...
                                            this._currentVideoCpuTime = P.videoCpuTime, this._drawingTime += this._time(function () {
                                                e._drawFrame(P.yCbCrBuffer);
                                            }), this._framesProcessed++, this._doFrameComplete(P), this._pingProcessing();
                                            ...
                                            if (this._dataEnded && !(this._pendingAudio || this._pendingFrame || this._decodedFrames.length)) {
                                                this._log('play loop: playback reached end of data ' + [
                                                    this._pendingAudio,
                                                    this._pendingFrame,
                                                ...
                                                this._prebufferingAudio && (t.hasVideo && !t.frameReady || t.hasAudio && !t.audioReady) ? (this._log('play loop: prebuffering demuxing'), this._doProcessPlayDemux()) : this._log('play loop: waiting on async/timers');
                                        } else {
                                            var x = u;
                                            this._log('play loop: setting a timer for drawing ' + x), this._nextFrameTimer = setTimeout(function () {
                                                e._nextFrameTimer = null, e._pingProcessing();
                                            }, x);
                                        }
                                    } else
                                        this._log('play loop: demuxing'), this._doProcessPlayDemux();
                                }
                            },
                            {
                                key: '_doProcessPlayDemux',
                                value: function () {
                                    var e = this, t = this._codec.frameReady, i = this._codec.audioReady;
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    if (this._stream && this._stream.waiting)
                                        ...
                                        t > -1 / 256 ? this._nextProcessingTimer = setTimeout(function () {
                                            e._pingProcessing();
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    this._stopVideo(), this._currentSrc = '', this._loading = !0, this._actionQueue.push(function () {
                                        e && 'none' === t.preload ? t._loading = !1 : (t._options.stream ? t._stream = t._options.stream : t._stream = new f.default({
                                            url: t.src,
                                            cacheSize: 16777216,
                                            progressive: !1
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    return 'ogg' !== t.minor || 'audio' !== t.major && 'video' !== t.major && 'application' !== t.major ? 'webm' !== t.minor || 'audio' !== t.major && 'video' !== t.major ? '' : i([
                                        'vorbis',
                                        'opus',
                                        'vp8',
                                        'vp9'
                    ...
                    (0, m.default)(L, k), L.instanceCount = 0, L.styleManager = new function () {
                        ...
                        this.appendRule = function (e, i) {
                            var r = [];
                            for (var o in i)
                                i.hasOwnProperty(o) && r.push(o + ':' + i[o]);
                            var n = e + '{' + r.join(';') + '}';
                ...
                580: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(575)), n = r(i(913));
                    t.default = function (e) {
                        return function () {
                            function t(i, r, n) {
                                var a = this;
                                for (var s in ((0, o.default)(this, t), n = n || {}, this.worker = i, this.transferables = function () {
                                        var e = new ArrayBuffer(1024), t = new Uint8Array(e);
                                        try {
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        if (this.processingQueue--, 'callback' === e.data.action) {
                                            var t = e.data, i = t.callbackId, r = t.args, o = this.pendingCallbacks[i];
                                            if (t.props)
                                                for (var n in t.props)
                                                    t.props.hasOwnProperty(n) && (this[n] = t.props[n]);
                ...
                625: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(575)), n = r(i(913)), a = r(i(964));
                    function s(e, t) {
                    ...
                    var u = function () {
                        function e(t) {
                            return (0, o.default)(this, e), this.options = t || {}, this.demuxer = null, this.videoDecoder = null, this.audioDecoder = null, this.flushIter = 0, this.loadedMetadata = !1, this.processing = !1, Object.defineProperties(this, {
                                duration: {
                                    get: function () {
                        ...
                        return (0, n.default)(e, [
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    this.processing = !0, t = 'video/webm' === this.options.type || 'audio/webm' === this.options.type ? 'OGVDemuxerWebMW' : 'OGVDemuxerOggW', a.default.loadClass(t, function (t) {
                                        t().then(function (t) {
                                            i.demuxer = t, t.onseek = function (e) {
                                                i.onseek && i.onseek(e);
                                            }, t.init(function () {
                                                i.processing = !1, e();
                                            });
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    var t = this;
                                    if (this.processing)
                                        throw Error('reentrancy fail on OGVWrapperCodec.process');
                                    this.processing = !0;
                                    var i = function (i) {
                                            t.processing = !1, e(i);
                                        }, r = function () {
                                    ...
                                    }) : this.loadedDemuxerMetadata && !this.loadedAudioMetadata ? this.audioDecoder.loadedMetadata ? (this.loadedAudioMetadata = !0, this.loadedAllMetadata = this.loadedAudioMetadata && this.loadedVideoMetadata, i(!0)) : this.demuxer.audioReady ? this.demuxer.dequeueAudioPacket(function (e, r) {
                                        t.audioBytes += e.byteLength, t.audioDecoder.processHeader(e, function (e) {
                                            i(!0);
                                        });
                                    }) : r() : this.loadedAudioMetadata && !this.loadedVideoMetadata ? this.videoDecoder.loadedMetadata ? (this.loadedVideoMetadata = !0, this.loadedAllMetadata = this.loadedAudioMetadata && this.loadedVideoMetadata, i(!0)) : this.demuxer.frameReady ? (this.processing = !0, this.demuxer.dequeueVideoPacket(function (e) {
                                        t.videoBytes += e.byteLength, t.videoDecoder.processHeader(e, function () {
                                            i(!0);
                                        });
                                    })) : r() : this.loadedVideoMetadata && !this.loadedMetadata && this.loadedAllMetadata ? (this.loadedMetadata = !0, i(!0)) : this.loadedMetadata && (!this.hasAudio || this.demuxer.audioReady) && (!this.hasVideo || this.demuxer.frameReady) ? i(!0) : r();
                                }
                            },
                            {
                                key: 'decodeFrame',
                                value: function (e) {
                                    var t = this, i = this.flushSafe(e), r = this.frameTimestamp, o = this.keyframeTimestamp;
                                    ...
                                    this.demuxer.dequeueAudioPacket(function (e, r) {
                                        t.audioBytes += e.byteLength, t.audioDecoder.processAudio(e, function (e) {
                                            if (r) {
                                                ...
                                                try {
                                                    for (a.s(); !(o = a.n()).done;) {
                                                        var u = o.value, d = Math.round(r * t.audioFormat.rate / 1000000000);
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    if (this.demuxer.audioCodec) {
                                        ...
                                        this.processing = !0, a.default.loadClass(i, function (i) {
                                            var r = {};
                                            t.demuxer.audioFormat && (r.audioFormat = t.demuxer.audioFormat), i(r).then(function (i) {
                                                t.audioDecoder = i, i.init(function () {
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    if (this.demuxer.videoCodec) {
                                        var i = !!this.options.simd, r = !!this.options.threading, o = {
                                        ...
                                        this.processing = !0, a.default.loadClass(o, function (i) {
                                            var o = {};
                                            t.demuxer.videoFormat && (o.videoFormat = t.demuxer.videoFormat), r && delete window.ENVIRONMENT_IS_PTHREAD, i(o).then(function (i) {
                                                t.videoDecoder = i, i.init(function () {
                ...
                539: (e, t, i) => {
                    var r = i(318);
                    Object.defineProperty(t, '__esModule', { value: !0 }), t.default = void 0;
                    var o = r(i(8)), n = r(i(575)), a = r(i(913)), s = new (function () {
                            function e() {
                            ...
                            return (0, a.default)(e, [{
                                    ...
                                    value: function () {
                                        if (!this.tested) {
                                            try {
                                                var e, t;
                                                'object' === ('undefined' == typeof WebAssembly ? 'undefined' : (0, o.default)(WebAssembly)) ? this.testResult = (e = new Uint8Array([
                                                    0,
                                                    97,
                                                    115,
                                                    109,
                                                    ...
                                                    0,
                                                    11
                                                ]), t = new WebAssembly.Module(e), 0 !== new WebAssembly.Instance(t, {}).exports.test(4)) : this.testResult = !1;
                                            } catch (e) {
                ...
                431: (e, t, i) => {
                    var r = function () {
                        ...
                        }, n = i(828), a = 'arraybuffer', s = function (e) {
                            function t() {
                                return function (e, t) {
                                    if (!(e instanceof t))
                                        throw TypeError('Cannot call a class as a function');
                ...
                306: (e, t, i) => {
                    ...
                    var n = function (e) {
                        function t(e) {
                            var i = e.url, r = e.offset, o = e.length, n = e.cachever;
                            !function (e, t) {
                                if (!(e instanceof t))
                                    throw TypeError('Cannot call a class as a function');
                            }(this, t);
                                    ...
                                    return new Promise(function (t, i) {
                                        ...
                                        var n = function () {
                                                if (2 == e.xhr.readyState) {
                                                    if (206 == e.xhr.status) {
                                                        var n, a, s, u = (s = o(e.xhr)) ? parseInt(s[1], 10) : 0;
                                                        if (e.offset != u)
                                                            return console.log('Expected start at ' + e.offset + ' but got ' + u + '; working around Safari range caching bug: https://bugs.webkit.org/show_bug.cgi?id=82672'), e.cachever++, e.emit('cachever'), e.abort(), r(), void e.load().then(t).catch(i);
                                                        e.seekable = !0;
                                                    }
                                                    e.xhr.status >= 200 && e.xhr.status < 300 ? (e.length = function (e) {
                                                        if (206 == e.status) {
                                                            var t;
                                                    ...
                                                    }(e.xhr), e.headers = (n = e.xhr, a = {}, n.getAllResponseHeaders().split(/\r?\n/).forEach(function (e) {
                                                        var t = e.split(/:\s*/, 2);
                                                        t.length > 1 && (a[t[0].toLowerCase()] = t[1]);
                                                    }), a), e.onXHRStart()) : (r(), i(Error('HTTP error ' + e.xhr.status)));
                                                }
                                            }, a = function () {
                                        ...
                                        }, e.initXHR(), e.xhr.addEventListener('readystatechange', n), e.xhr.addEventListener('error', a), e.on('open', s), e.xhr.send();
                                    });
                                }
                            },
                            {
                                    ...
                                    value: function (e) {
                                        ...
                                        return new Promise(function (i, r) {
                                            if (t.eof || t.offset >= e)
                                                ...
                                                }, t.buffering = !0, t.on('buffer', n), t.on('done', a), t.on('error', s);
                                            }
                                        });
                                    }
                                },
                ...
                761: (e, t, i) => {
                    var r = i(855), o = i(810), n = i(431), a = null;
                    e.exports = function (e) {
                        if (!1 === e.progressive)
                            return new n(e);
                ...
                855: (e, t, i) => {
                    var r = function () {
                            ...
                            var a = o.get;
                            return void 0 !== a ? a.call(r) : void 0;
                        }, n = i(828), a = 'moz-chunked-arraybuffer', s = function (e) {
                            function t() {
                                return function (e, t) {
                                    if (!(e instanceof t))
                                        throw TypeError('Cannot call a class as a function');
                ...
                503: e => {
                    var t = function () {
                            ...
                            function e() {
                                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = t.buffer, r = void 0 === i ? void 0 : i, o = t.string, n = void 0 === o ? void 0 : o, a = t.start, s = void 0 === a ? 0 : a, u = t.end, d = void 0 === u ? s + (r ? r.byteLength : n ? n.length : 0) : u, c = t.prev, h = t.next, f = t.eof, l = t.empty, _ = void 0 === l ? !(r || n) : l, p = t.timestamp, m = void 0 === p ? Date.now() : p;
                                (function (e, t) {
                                    if (!(e instanceof t))
                                        throw TypeError('Cannot call a class as a function');
                            ...
                            return t(e, [
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, i) {
                                        ...
                                        if (this.buffer) {
                                            ...
                                            for (var a = this.string, s = 0; s < o; s++)
                                                e[s] = a.charCodeAt(r + s);
                                        }
                                ...
                                },
                                {
                                    key: 'last',
                                    value: function (e) {
                                        for (var t = null, i = this; i && e(i); i = i.next)
                                            t = i;
                                        return t;
                                    }
                                }
                ...
                91: (e, t, i) => {
                    var r = function () {
                            ...
                            function e() {
                                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = t.cacheSize;
                                !function (e, t) {
                                    if (!(e instanceof t))
                                        throw TypeError('Cannot call a class as a function');
                                }(this, e);
                            ...
                            return r(e, [
                                {
                                    key: 'bytesReadable',
                                    value: function () {
                                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1 / 0, t = this.readOffset, i = this.readCursor.last(function (i) {
                                ...
                                },
                                {
                                    key: 'bytesWritable',
                                    value: function () {
                                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1 / 0, t = this.writeOffset, i = this.writeCursor;
                                        if (i.eof)
                                            return e;
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        if (!t)
                                            throw Error('read seek out of range');
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        if (!t)
                                            throw Error('write seek out of range');
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        for (var t = e.byteLength, i = this.bytesReadable(t), r = this.readOffset, o = r + i, n = r, a = this.readCursor; a && !a.empty && !(a.start >= o); a = a.next) {
                                            var s = Math.min(o, a.end), u = e.subarray(n - r, s - r);
                                            a.readBytes(u, n, s), n = s;
                                        }
                                        return this.readOffset = n, this.readCursor = this.readCursor.first(function (e) {
                                            return e.contains(n);
                                        }), i;
                                    }
                                },
                                {
                                    key: 'write',
                                    value: function (e) {
                                        var t = this.bufferItem(e), i = this.writeCursor;
                                        if (!i.empty)
                                            throw Error('write cursor not empty');
                                        if (!i.contains(t.end) && i.end !== t.end)
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        for (var e = 0, t = [], i = this.head; i; i = i.next)
                                            i.empty || (e += i.length, (i.end < this.readOffset || i.start > this.readOffset + this.chunkSize) && t.push(i));
                                        if (e > this.cacheSize) {
                                            t.sort(function (e, t) {
                                ...
                                },
                                {
                                    ...
                                    value: function (e, t, i, r) {
                                        ...
                                        var n = e.prev, a = t.next;
                                        e.prev = null, t.next = null, n && (n.next = i, i.prev = n), a && (a.prev = r, r.next = a), e === this.head && (this.head = i), t === this.tail && (this.tail = r), this.readCursor = this.head.first(function (e) {
                ...
                936: (e, t, i) => {
                    ...
                    i(566);
                    var o = i(814), n = i(761), a = function () {
                            function e(t) {
                                var i = t.url, r = t.chunkSize, n = t.cacheSize, a = t.progressive;
                                !function (e, t) {
                                    if (!(e instanceof t))
                                        throw TypeError('Cannot call a class as a function');
                                }(this, e), this.length = -1, this.loaded = !1, this.loading = !1, this.seekable = !1, this.buffering = !1, this.seeking = !1, this.progressive = void 0 === a || a, Object.defineProperties(this, {
                                    offset: {
                                        get: function () {
                                ...
                                }), this.url = void 0 === i ? '' : i, this.headers = {}, this._cache = new o({ cacheSize: void 0 === n ? 0 : n }), this._backend = null, this._cachever = 0, this._chunkSize = void 0 === r ? 1048576 : r;
                            }
                            return r(e, [
                                {
                                    key: 'load',
                                    value: function () {
                                        ...
                                        return new Promise(function (t, i) {
                                            ...
                                            if (e.loaded)
                                                throw Error('cannot load when loaded');
                                            e.loading = !0, e._openBackend().then(function (i) {
                                    ...
                                    value: function () {
                                        ...
                                        return new Promise(function (t, i) {
                                            if (e._backend)
                                                ...
                                                i(Error('cannot open at end of file'));
                                            else {
                                                var r = e._cache, o = e._chunkSize, a = r.bytesReadable(o), s = r.readOffset + a;
                                                if (r.seekWrite(s), e.length >= 0 && s >= e.length)
                                                    return void t(null);
                                                ...
                                                if (0 === u)
                                                    ...
                                                    var d = e._backend = new n({
                                                            ...
                                                            d !== e._backend ? (c(), i(Error('invalid state'))) : (d.on('buffer', function (t) {
                                                    ...
                                                    }, d.on('open', h), d.on('error', f), d.on('cachever', function () {
                                                        e._cachever++;
                                                    }), d.load();
                                                }
                                            }
                                ...
                                },
                                {
                                    key: 'readSync',
                                    value: function (e) {
                                        var t = this.bytesAvailable(e), i = new Uint8Array(t);
                                        if (this.readBytes(i) !== t)
                                ...
                                },
                                {
                                    ...
                                    value: function (e) {
                                        ...
                                        return new Promise(function (i, r) {
                                            ...
                                            if (e !== (0 | e) || e < 0)
                                                throw Error('invalid input');
                                            var o = t._clampToLength(t.offset + e), n = o - t.offset, a = t.bytesAvailable(n);
                                            a >= n ? i(a) : (t.buffering = !0, t._openBackend().then(function (i) {
                                                return i ? i.bufferToOffset(o).then(function () {
                ...
                926: (e, t, i) => {
                    !function () {
                        var t = i(487), r = i(627);
                        function o(e) {
                            var t = e.getContext('2d'), i = null, o = null, n = null;
                            return this.drawFrame = function (a) {
                                var s, u, d = a.format;
                                e.width === d.displayWidth && e.height === d.displayHeight || (e.width = d.displayWidth, e.height = d.displayHeight), null !== i && i.width == d.width && i.height == d.height || function (e, r) {
                                    for (var o = (i = t.createImageData(e, r)).data, n = e * r * 4, a = 0; a < n; a += 4)
                                        o[a + 3] = 255;
                                }(d.width, d.height), r.convertYCbCr(a, i.data);
                                var c, h = d.cropWidth != d.displayWidth || d.cropHeight != d.displayHeight;
                ...
                895: (e, t, i) => {
                    !function () {
                        var t = i(487), r = i(826);
                        function o(e) {
                            var t, i, n = this, a = o.contextForCanvas(e);
                            if (null === a)
                            ...
                            var u, d, c, h, f, l, _, p, m, V, v = new Float32Array([
                                    -1,
                                    -1,
                                    1,
                                    -1,
                            ...
                            function A(e, t, i, r, n) {
                                ...
                                if (a.activeTexture(a.TEXTURE0), o.stripe) {
                                    var d = !g[e + '_temp'] || t, c = T(e + '_temp', t);
                                    ...
                                    var h = g[e + '_stripe'], f = !h || t;
                                    f && (h = T(e + '_stripe', t)), a.bindTexture(a.TEXTURE_2D, h), f && (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.NEAREST), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.NEAREST), a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, i, 1, 0, a.RGBA, a.UNSIGNED_BYTE, function (e) {
                                        if (b[e])
                                            return b[e];
                            ...
                            function P(e, t) {
                                var i = s(a.VERTEX_SHADER, e), r = s(a.FRAGMENT_SHADER, t), o = a.createProgram();
                            ...
                            return n.drawFrame = function (s) {
                                var g = s.format, y = !t || e.width !== g.displayWidth || e.height !== g.displayHeight;
                                if (y && (e.width = g.displayWidth, e.height = g.displayHeight, n.clear()), t || function () {
                                        if (o.stripe) {
                                    ...
                                    var b = function (e, t, i) {
                                        var r = g.cropLeft / i, o = (g.cropLeft + g.cropWidth) / i, n = (g.cropTop + g.cropHeight) / g.height, s = g.cropTop / g.height, u = new Float32Array([
                                                r,
                                                n,
                                                o,
                                                n,
                        ...
                        o.stripe = !1, o.contextForCanvas = function (e) {
                            var t = {
                            ...
                            if (e) {
                                var i = e.TEXTURE0, r = e.createTexture(), n = new Uint8Array(16), a = o.stripe ? 1 : 4, s = o.stripe ? e.RGBA : e.ALPHA, u = o.stripe ? e.NEAREST : e.LINEAR;
                ...
                627: (e, t, i) => {
                    ...
                    r = i(877), e.exports = {
                        convertYCbCr: function (e, t) {
                            var i = 0 | e.format.width, o = 0 | e.format.height, n = 0 | r(e.format.width / e.format.chromaWidth), a = 0 | r(e.format.height / e.format.chromaHeight), s = e.y.bytes, u = e.u.bytes, d = e.v.bytes, c = 0 | e.y.stride, h = 0 | e.u.stride, f = 0 | e.v.stride, l = i << 2, _ = 0, p = 0, m = 0, V = 0, v = 0, g = 0, y = 0, b = 0, T = 0, A = 0, k = 0, E = 0, P = 0, w = 0, x = 0, R = 0, F = 0, O = 0;
                            if (1 == n && 1 == a)
                                for (y = 0, b = l, O = 0, R = 0; R < o; R += 2) {
                                    for (m = (p = R * c | 0) + c | 0, V = O * h | 0, v = O * f | 0, x = 0; x < i; x += 2)
                                        T = 0 | u[V++], E = (409 * (A = 0 | d[v++]) | 0) - 57088 | 0, P = (100 * T | 0) + (208 * A | 0) - 34816 | 0, w = (516 * T | 0) - 70912 | 0, k = 298 * s[p++] | 0, t[y] = k + E >> 8, t[y + 1] = k - P >> 8, t[y + 2] = k + w >> 8, y += 4, k = 298 * s[p++] | 0, t[y] = k + E >> 8, t[y + 1] = k - P >> 8, t[y + 2] = k + w >> 8, y += 4, k = 298 * s[m++] | 0, t[b] = k + E >> 8, t[b + 1] = k - P >> 8, t[b + 2] = k + w >> 8, b += 4, k = 298 * s[m++] | 0, t[b] = k + E >> 8, t[b + 1] = k - P >> 8, t[b + 2] = k + w >> 8, b += 4;
                                    y += l, b += l, O++;
                                }
                            else
                                for (g = 0, R = 0; R < o; R++)
                                    for (F = 0, _ = R * c | 0, V = (O = R >> a) * h | 0, v = O * f | 0, x = 0; x < i; x++)
                                        T = 0 | u[V + (F = x >> n)], E = (409 * (A = 0 | d[v + F]) | 0) - 57088 | 0, P = (100 * T | 0) + (208 * A | 0) - 34816 | 0, w = (516 * T | 0) - 70912 | 0, k = 298 * s[_++] | 0, t[g] = k + E >> 8, t[g + 1] = k - P >> 8, t[g + 2] = k + w >> 8, g += 4;
                        }
                    };
                },
                877: e => {
                    e.exports = function (e) {
                        for (var t = 0, i = e >> 1; 0 != i;)
                            i >>= 1, t++;
                        if (e !== 1 << t)
                ...
                731: (e, t, i) => {
                    var r, o, n;
                    r = i(487), o = i(926), n = i(895), e.exports = {
                        FrameSink: r,
                        SoftwareFrameSink: o,
                        WebGLFrameSink: n,
                        attach: function (e, t) {
        ...
        h.d = (e, t) => {
            for (var i in t)
                h.o(t, i) && !h.o(e, i) && Object.defineProperty(e, i, {
                    enumerable: !0,
                    get: t[i]
                });
        ...
        var f = {};
        return e = h(318), Object.defineProperty(f, '__esModule', { value: !0 }), Object.defineProperty(f, 'OGVCompat', {
            enumerable: !0,
            get: function () {
                return i.default;
            }

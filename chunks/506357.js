...
function h(e) {
  ...
  let {
    ...
    incidentData: P,
    isUnderLockdown: D
  } = (0, I.useGuildIncidentsState)(R), x = (0, r.useCanAccessMemberSafetyPage)(null !== (t = null == v ? void 0 : v.id) && void 0 !== t ? t : N.EMPTY_STRING_SNOWFLAKE_ID), y = a.useCallback(() => null != v && (0, o.goToMemberSafetyDashboard)(v.id), [v]);
  if (null == v || null == P || !L) return null;
  let U = e => {
      if (e && x && O !== S.StaticChannelRoute.MEMBER_SAFETY && y()) {
        T.default.track(N.AnalyticEvents.APP_NOTICE_PRIMARY_CTA_OPENED, {
        ...
        let e = {
            ...
            alertType: (0, p.getIncidentAlertType)(P)
          },
          {
            default: t
    ...
    b = (0, p.getSecurityActionDetailsString)(P, v.name);
  if (null != (null !== (h = P.dmsDisabledUntil) && void 0 !== h ? h : P.invitesDisabledUntil) && D) return (0, s.jsxs)(_.default, {
    className: A.notice,
  ...
  let G = (0, p.hasDetectedRaid)(P) ? C.default.Messages.GUILD_ANTIRAID_NAGBAR_RAID_MESSAGE_2_NEW.format({
      guildName: v.name
    }) : (0, p.hasDetectedDMRaid)(P) ? C.default.Messages.GUILD_ANTIRAID_NAGBAR_DM_RAID_MESSAGE_2_NEW.format({
      guildName: v.name
    }) : C.default.Messages.GUILD_ANTIRAID_NAGBAR_MESSAGE_2_NEW.format({
      guildName: v.name
    }),
    B = x && O === S.StaticChannelRoute.MEMBER_SAFETY;

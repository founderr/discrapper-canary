...
function C(e) {
  ...
  let {
onDismiss: g
  } = e, S = (0, s.e7)([u.Z], () => u.Z.getGuildId()), A = (0, s.e7)([d.Z], () => null != S ? d.Z.getChannelId(S) : null, [S]), R = null != S ? S : null, O = (0, s.e7)([c.Z], () => null != R ? c.Z.getGuild(R) : null, [R]), {
shouldShowIncidentActions: x,
incidentData: M,
isUnderLockdown: v
  } = (0, I.mI)(R), L = (0, l.n2)(null !== (t = null == O ? void 0 : O.id) && void 0 !== t ? t : h.lds), Z = a.useCallback(() => null != O && (0, o._X)(O.id), [O]);
  if (null == O || null == M || !x)
return null;
  let P = e => {

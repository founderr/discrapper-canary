...
function p(e) {
  ...
  let {
onDismiss: g
  } = e, S = (0, a.e7)([_.Z], () => _.Z.getGuildId()), A = (0, a.e7)([d.Z], () => null != S ? d.Z.getChannelId(S) : null, [S]), R = null != S ? S : null, x = (0, a.e7)([u.Z], () => null != R ? u.Z.getGuild(R) : null, [R]), {
shouldShowIncidentActions: O,
incidentData: M,
isUnderLockdown: v
  } = (0, I.mI)(R), L = (0, o.n2)(null !== (t = null == x ? void 0 : x.id) && void 0 !== t ? t : h.lds), Z = s.useCallback(() => null != x && (0, c._X)(x.id), [x]);
  if (null == x || null == M || !O)
return null;
  let P = e => {

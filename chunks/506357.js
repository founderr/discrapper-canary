...
var i = n(735250), a = n(470079), s = n(442837), l = n(481060), r = n(241559), o = n(527379), c = n(430824), d = n(944486), u = n(914010), _ = n(346656), E = n(626135), m = n(528011), I = n(666657), T = n(533244), h = n(981631), N = n(176505), p = n(689938), f = n(928112);
function C(e) {
    var t, C;
    ...
    let j = (0, T.CG)(M) ? p.Z.Messages.GUILD_ANTIRAID_NAGBAR_RAID_MESSAGE_2_NEW.format({ guildName: O.name }) : (0, T.kk)(M) ? p.Z.Messages.GUILD_ANTIRAID_NAGBAR_DM_RAID_MESSAGE_2_NEW.format({ guildName: O.name }) : p.Z.Messages.GUILD_ANTIRAID_NAGBAR_MESSAGE_2_NEW.format({ guildName: O.name }), U = L && A === N.oC.MEMBER_SAFETY;
    return (0, i.jsxs)(l.Notice, {
        className: f.notice,

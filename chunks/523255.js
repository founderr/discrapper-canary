...
var i = n(913527), a = n.n(i), s = n(835913), r = n(675478), l = n(581883), o = n(905567);
let c = e => {
        var t;
        if (!d(e))
            return !1;
        let n = null === (t = l.Z.settings.userContent) || void 0 === t ? void 0 : t.safetyUserSentimentNoticeDismissedAt, i = null != n ? s.E.toDate(n) : void 0, r = null != i ? a()().diff(i, 'days') : null, c = null != n;
        if (c && !(null != r && r > 30))
            return !1;

...
var r, i, a, o, s = n(392711), l = n.n(s), u = n(442837), c = n(433517), d = n(570140), _ = n(85521), E = n(630388), f = n(780570), h = n(314897), p = n(981631);
let m = 'LibraryApplicationStore';
function I() {
    var e;
    return null !== (e = c.K.get(m)) && void 0 !== e ? e : {};
}
let T = !1, g = {}, S = {}, A = new Set(), N = {}, v = {}, O = !1;
function R() {
    c.K.set(m, {
        ...I(),
...
function D(e) {
    let {libraryApplication: t} = e, n = _.Z.createFromServer(t), r = (0, f.Tu)(n.id, n.branchId);
    g[r] = n, A.delete(r);
}
function L(e, t) {
    var n;
...
class M extends (r = u.ZP.Store) {
    ...
    hasApplication(e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], r = L(e, t);
    ...
    getActiveLibraryApplication(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = N[e];
        if (null != n) {
            var r;
            let i = (0, f.Tu)(e, n), a = null !== (r = g[i]) && void 0 !== r ? r : S[i];

...
function U(e) {
    let { onAnimationComplete: t, onClick: n, position: i, size: l } = e,
        ...
        { createMultipleConfettiAt: g, confettiCanvas: E } = s.useContext(_.h),
        [C, I] = s.useState(null),
        x = (0, d.uR)(E, C),
        N = (function (e, t) {
    ...
    return (
        s.useEffect(() => {
            if ('confetti' === c) {
                let { confettiVelocityDirection: e } = P[f],
                    t = (function (e, t) {
                        ...
                        let r = P[t].getConfettiPosition(n);
                        return {
                            x: i.left + r.x,
                            y: i.top + r.y
                        };
...
function w(e) {
    ...
    let O = s.useCallback(() => {
        ...
        k = s.useCallback(() => {
            (0, C.AI)({ settingsVisible: !0 }), g.Z.open(S.oAB.POGGERMODE), f(!1);
        }, []),
        D = s.useCallback(
            (e, t) => {

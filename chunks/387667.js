...
return A.KFR.USER;
  else if (e <= A.rsA.ROLE_DELETE)
return A.KFR.ROLE;
  else if (e <= A.rsA.INVITE_DELETE)
return A.KFR.INVITE;
  else if (e <= A.rsA.WEBHOOK_DELETE)
return A.KFR.WEBHOOK;
  else if (e <= A.rsA.EMOJI_DELETE)
return A.KFR.EMOJI;
  else if (e <= A.rsA.INTEGRATION_DELETE)
return A.KFR.INTEGRATION;
  else if (e <= A.rsA.STAGE_INSTANCE_DELETE)
return A.KFR.STAGE_INSTANCE;
  else if (e <= A.rsA.STICKER_DELETE)
return A.KFR.STICKER;
  else if (e <= A.rsA.GUILD_SCHEDULED_EVENT_DELETE)
return A.KFR.GUILD_SCHEDULED_EVENT;
  else if (e <= A.rsA.THREAD_DELETE)
return A.KFR.THREAD;
...
return A.KFR.USER;
  else if (e === A.rsA.AUTO_MODERATION_FLAG_TO_CHANNEL)
return A.KFR.USER;
  else if (e === A.rsA.AUTO_MODERATION_USER_COMMUNICATION_DISABLED)
return A.KFR.USER;
  else if (e === A.rsA.AUTO_MODERATION_QUARANTINE_USER)
return A.KFR.USER;
...
return A.KFR.ONBOARDING_PROMPT;
  else if (e <= A.rsA.ONBOARDING_UPDATE)
return A.KFR.GUILD_ONBOARDING;
  else if (e <= A.rsA.GUILD_HOME_REMOVE_ITEM)
return A.KFR.GUILD_HOME;
  else if (e <= A.rsA.HARMFUL_LINKS_BLOCKED_MESSAGE)
return A.KFR.GUILD;
  else if (e <= A.rsA.HOME_SETTINGS_UPDATE)
return A.KFR.HOME_SETTINGS;

...
function O(e) {
  ...
  let {
    ...
    initialTab: l,
    guildId: i
  } = e, M = (0, r.useStateFromStores)([I.default], () => I.default.getGuild(i)), O = (0, r.useStateFromStores)([f.default], () => f.default.isViewingServerShop(i)), R = (0, p.useGuildShopPreviewVisible)(M, "guild_shop_page"), v = (0, N.useIsEligibleForSubscriptionsInGuildShop)(i, "guild_shop_page"), L = (null == M ? void 0 : M.hasFeature(h.GuildFeatures.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, P = (0, E.useRoleSubscriptionsVisibleInGuild)(null == M ? void 0 : M.id), x = null === (t = (0, c.useSubscriptionsSettings)(i)) || void 0 === t ? void 0 : t.server_shop_tab_order, D = [], y = S.GuildShopTab.GUILD_SHOP_FULL_PREVIEW;
  O || L && P ? (D.push(x === C.ServerShopTabOrder.PRODUCTS_FIRST ? S.GuildShopTab.GUILD_PRODUCTS : S.GuildShopTab.GUILD_ROLE_SUBSCRIPTIONS), D.push(x === C.ServerShopTabOrder.PRODUCTS_FIRST ? S.GuildShopTab.GUILD_ROLE_SUBSCRIPTIONS : S.GuildShopTab.GUILD_PRODUCTS), y = D[0]) : L && !P ? (D.push(S.GuildShopTab.GUILD_PRODUCTS), y = S.GuildShopTab.GUILD_PRODUCTS) : !L && P && (D.push(S.GuildShopTab.GUILD_ROLE_SUBSCRIPTIONS), y = S.GuildShopTab.GUILD_ROLE_SUBSCRIPTIONS, R && D.push(S.GuildShopTab.GUILD_PRODUCTS_PREVIEW)), l = null != l ? l : y;

...
function x(e) {
    ...
    let [b, j] = s.useState(a),
        U = (O && !(L && M)) || b === f.y.GUILD_PRODUCTS_PREVIEW;
    return (
        s.useEffect(() => {
            j(a);
        }, [a]),
        (0, i.jsx)(A.Provider, {
            value: {
                ...
                handlePreviewDismiss: (e) => {
                    ...
                    let t = { ...(0, c.hH)(r) };
                    if (b === f.y.GUILD_PRODUCTS_PREVIEW) e.stopPropagation(), j(f.y.GUILD_ROLE_SUBSCRIPTIONS), (t.action_taken = g.mz.DISMISS_TAB_PREVIEW);
                    else {
                        var n;

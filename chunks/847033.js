    ...
    value: {
      ...
      handlePreviewDismiss: e => {
        ...
        if (U === N.GuildShopTab.GUILD_PRODUCTS_PREVIEW) e.stopPropagation(), b(N.GuildShopTab.GUILD_ROLE_SUBSCRIPTIONS), t.action_taken = C.GuildShopPreviewClickActions.DISMISS_TAB_PREVIEW;
          ...
          var n;
          (0, _.replaceWith)(A.Routes.CHANNEL(i, null === (n = m.default.getDefaultChannel(i)) || void 0 === n ? void 0 : n.id)), t.action_taken = C.GuildShopPreviewClickActions.DISMISS_FULL_PREVIEW
        }

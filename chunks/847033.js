...
function x(e) {
  ...
  let {
    ...
    initialTab: s,
    guildId: l
  } = e, R = (0, r.e7)([T.Z], () => T.Z.getGuild(l)), x = (0, r.e7)([E.Z], () => E.Z.isViewingServerShop(l)), O = (0, f.g)(R, "guild_shop_page"), M = (0, N.RF)(l, "guild_shop_page"), v = (null == R ? void 0 : R.hasFeature(S.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, L = (0, _.mY)(null == R ? void 0 : R.id), Z = null === (t = (0, u.YB)(l)) || void 0 === t ? void 0 : t.server_shop_tab_order, P = [], b = p.y.GUILD_SHOP_FULL_PREVIEW;

...
initialTab: s,
guildId: r
  } = e, R = (0, l.e7)([T.Z], () => T.Z.getGuild(r)), O = (0, l.e7)([E.Z], () => E.Z.isViewingServerShop(r)), x = (0, p.g)(R, 'guild_shop_page'), M = (0, N.RF)(r, 'guild_shop_page'), v = (null == R ? void 0 : R.hasFeature(S.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, L = (0, _.mY)(null == R ? void 0 : R.id), Z = null === (t = (0, u.YB)(r)) || void 0 === t ? void 0 : t.server_shop_tab_order, P = [], b = f.y.GUILD_SHOP_FULL_PREVIEW;
  ...
  let [D, j] = a.useState(s), U = x && !(L && M) || D === f.y.GUILD_PRODUCTS_PREVIEW;
  return a.useEffect(() => {
j(s);

...
function O(e) {
    ...
    let { children: n, initialTab: a, guildId: r } = e,
        ...
        O = (0, l.e7)([E.Z], () => E.Z.isViewingServerShop(r)),
        x = (0, f.g)(R, 'guild_shop_page'),
    ...
    let [b, j] = s.useState(a),
        U = (x && !(L && M)) || b === C.y.GUILD_PRODUCTS_PREVIEW;
    return (
        s.useEffect(() => {
            j(a);
        }, [a]),
        (0, i.jsx)(A.Provider, {
            value: {
                ...
                handlePreviewDismiss: (e) => {
                    ...
                    let t = { ...(0, c.hH)(r) };
                    if (b === C.y.GUILD_PRODUCTS_PREVIEW) e.stopPropagation(), j(C.y.GUILD_ROLE_SUBSCRIPTIONS), (t.action_taken = g.mz.DISMISS_TAB_PREVIEW);
                    else {
                        var n;

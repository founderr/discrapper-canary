...
function O(e) {
  ...
  let {
    ...
    initialTab: s,
    guildId: l
  } = e, R = (0, r.e7)([T.Z], () => T.Z.getGuild(l)), O = (0, r.e7)([E.Z], () => E.Z.isViewingServerShop(l)), x = (0, f.g)(R, "guild_shop_page"), M = (0, N.RF)(l, "guild_shop_page"), v = (null == R ? void 0 : R.hasFeature(S.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) === !0, L = (0, _.mY)(null == R ? void 0 : R.id), Z = null === (t = (0, u.YB)(l)) || void 0 === t ? void 0 : t.server_shop_tab_order, P = [], b = p.y.GUILD_SHOP_FULL_PREVIEW;
  ...
  let [D, j] = a.useState(s), U = x && !(L && M) || D === p.y.GUILD_PRODUCTS_PREVIEW;
  return a.useEffect(() => {
    j(s)
    ...
    value: {
      ...
      handlePreviewDismiss: e => {
        ...
        if (D === p.y.GUILD_PRODUCTS_PREVIEW) e.stopPropagation(), j(p.y.GUILD_ROLE_SUBSCRIPTIONS), t.action_taken = g.mz.DISMISS_TAB_PREVIEW;
          ...
          var n;
          (0, I.dL)(S.Z5c.CHANNEL(l, null === (n = m.ZP.getDefaultChannel(l)) || void 0 === n ? void 0 : n.id)), t.action_taken = g.mz.DISMISS_FULL_PREVIEW
        }

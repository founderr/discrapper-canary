...
class M extends (r = a.ZP.PersistedStore) {
    initialize(e) {
        if (null != e) {
            var t, n, r, i, a;
            (g = null !== (t = e.isMembersOpen) && void 0 !== t && t), (A = null !== (n = e.isSummariesOpen) && void 0 !== n && n), (N = null === (r = e.isProfileOpen) || void 0 === r || r), (O = null !== (i = e.sidebars) && void 0 !== i ? i : {}), (v = null !== (a = e.guildSidebars) && void 0 !== a ? a : {});
        }
    ...
    getSection(e, t) {
        if (R) return p.ULH.SEARCH;
        let n = C(e);
        return null != n && null != O[n] ? p.ULH.SIDEBAR_CHAT : t && N ? p.ULH.PROFILE : A ? p.ULH.SUMMARIES : g ? p.ULH.MEMBERS : p.ULH.NONE;
    }
    getSidebarState(e) {
        let t = C(e);
...
T(M, 'displayName', 'ChannelSectionStore'),
    ...
    (t.ZP = new M(s.Z, {
        ...
        PROFILE_PANEL_TOGGLE_SECTION: function () {
            !N && l.S.dispatch(p.CkL.SEARCH_RESULTS_CLOSE), (N = y(N));
        },

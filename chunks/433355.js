...
var r, i = n(873546), a = n(442837), o = n(570140), s = n(897473), l = n(585483), u = n(709054), c = n(592125), d = n(496675), _ = n(768119), E = n(944486), f = n(914010), h = n(594174), p = n(981631), m = n(176505), I = n(231338);
function T(e, t, n) {
...
let g = 'message_requests', S = !1, A = !1, N = !0, v = !1, O = {}, R = {};
function C(e) {
    if (null == e)
        return null;
    if ((0, m.AB)(e)) {
...
T(M, 'displayName', 'ChannelSectionStore'), T(M, 'persistKey', 'ChannelSectionStore2'), t.ZP = new M(o.Z, {
    ...
    THREAD_CREATE: function (e) {
        var t;
        let {channel: n} = e;
        if (n.ownerId === (null === (t = h.default.getCurrentUser()) || void 0 === t ? void 0 : t.id))
            return !1;
        let r = O[n.parent_id];
        null != r && r.type === s.tI.CREATE_THREAD && r.parentMessageId === u.default.castChannelIdAsMessageId(n.id) && (O[n.parent_id] = {
            type: s.tI.VIEW_THREAD,
            channelId: n.id
        });
    },
    THREAD_DELETE: function (e) {
        let {channel: t} = e, n = O[t.parent_id];
        if (null == n || n.type !== s.tI.VIEW_THREAD || n.channelId !== t.id)
            return !1;

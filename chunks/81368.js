var n = r(546870), i = r(680643), o = r(65183), a = r(581079), u = r(896775), s = o.List, c = o.Map, l = function (t, e, r) {
        if (!t)
            return;
        var n = e.get(t);
        if (!!n)
...
t.exports = function (t, e) {
    e.isCollapsed() || a(!1);
    var r, o, f, p = e.getAnchorKey(), h = t.getBlockMap(), d = h.get(p), g = d.getText();
    if (!g) {
        var y = d.getType();
    ...
    var v = e.getAnchorOffset(), m = d.getCharacterList(), _ = i(), b = d instanceof n, S = d.merge({
            text: g.slice(0, v),
    ...
    if (b) {
        ...
        d.getChildKeys().isEmpty() || a(!1), r = C, o = S, f = w, C = r.withMutations(function (t) {
            var e = o.getKey(), r = f.getKey();
            l(o.getParentKey(), t, function (t) {
                var n = t.getChildKeys(), i = n.indexOf(e) + 1, o = n.toArray();

...
function L(e) {
  ...
  return {
    ...
    channel_member_perms: String(null != i && null !== (t = g.default.getChannelPermissions(e)) && void 0 !== t ? t : y.default.NONE),
    channel_hidden: n
  }
}
...
function U(e) {
  ...
  let l = !("location" in a) || a.location !== R.AnalyticsLocations.GUILD_CREATE_INVITE_SUGGESTION,
    d = "guild_id" in a ? a.guild_id : l ? S.default.getGuildId() : null,
    c = "channel_id" in a ? a.channel_id : l ? v.default.getChannelId(d) : null,
...
function V(e, t) {
  ...
  return s(I.default.getVoiceStates(e)).forEach(e => {
    e.channelId === t && null != m.default.findActivity(e.userId, e => e.type === R.ActivityTypes.CUSTOM_STATUS) && n.custom_status_count++
  }), n
}
var G = {
  trackWithMetadata: U,

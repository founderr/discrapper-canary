...
var r, i, a = n(570140), o = n(923928), s = n(593472), l = n(594190), u = n(77498), c = n(594174), d = n(626135), _ = n(358085), E = n(998502), f = n(96592), h = n(981631);
let p = {
    development: [
        0,
        0,
...
async function I() {
    ...
    return function (e) {
        if (null == e.setFlags)
            return;
        let t = 0, n = f.Z.getCurrentConfig({ location: 'edd7d3_1' }, { autoTrackExposure: !1 });
...
function T(e, t) {
    return I().then(n => {
        var r;
        let i = null === (r = l.ZP.getGameForPID(e)) || void 0 === r ? void 0 : r.name, c = u.Z.getGameByName(i), _ = null;
        return new Promise(r => {
            let u = (e, n) => {
                ...
                }, E = l.ZP.getOverlayOptionsForPID(e), f = {
                    ...s.r,
                    ...E,

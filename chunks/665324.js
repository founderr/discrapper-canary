...
function F(e) {
  let {
    ...
    var e;
    return [null !== (e = S.Z.getSoundsForGuild(t.id)) && void 0 !== e ? e : D.Hy, S.Z.isFetchingSounds() || S.Z.isFetchingDefaultSounds()]
  }), {
    canCreateExpressions: l
  } = (0, m.XJ)(t), o = a.useRef(null), d = (0, I.ZP)(), _ = t.premiumTier, E = (0, L.yw)(t, i, _);
  a.useEffect(() => {
    (0, N.w)()
  }, []);
  ...
  let p = b ? (0, s.jsx)(u.Button, {
    onClick: function() {
      (0, u.openModalLazy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("56035"), n.e("86266")]).then(n.bind(n, 758961));
        return n => (0, s.jsx)(e, {
          ...n,
          guildId: t.id
        })
  ...
  return (0, s.jsxs)(s.Fragment, {
    children: [(0, s.jsxs)("div", {
      ...
      children: [(0, s.jsx)(u.FormDivider, {
        className: Z.divider
      }), (0, s.jsx)(u.Heading, {
...
function k(e) {
  let {
    ...
    emojiId: h,
    emojiName: g
  } = t, x = (0, c.e7)([p.default], () => null != T ? T : p.default.getUser(S), [S, T]), {
    canManageGuildExpression: R
  } = (0, m.XJ)(o), L = a.useMemo(() => R(t), [t, R]), O = null != h || null != g, [A, M] = a.useState(!1);
  async function D() {
    if (!A) {
      M(!0);
      try {
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [O ? (0, s.jsx)(E.Z, {
      ...
      children: (0, s.jsxs)(u.Text, {
        variant: "text-sm/normal",
        className: Z.soundName,
        children: [I, " ", (0, s.jsx)(u.VoiceNormalIcon, {
          size: "md",
          color: "currentColor",

...
var n = s(250683), a = s(909766), i = s(369541);
function r(e) {
...
function _(e, t, s) {
    let i = new DataView(Uint8Array.from(n.toByteArray(e)).buffer), r = 16, o = Math.ceil(t.clusterSize / 1200), l = t.numClusters * o, c = 0, d = 0, _ = 0, E = null, u = null, T = null, I = null, S = null;
    for (let e = 0; e < i.byteLength / r; e++) {
        let t = i.getUint32(4 * (4 * e + 0)), n = i.getUint32(4 * (4 * e + 1)), a = i.getUint32(4 * (4 * e + 2)), r = i.getUint32(4 * (4 * e + 3));
        c++, d += n, _ += n + s, null == u && (u = r), T = r, null == E && (E = a), null == I && (I = t);
        let o = r - (a - E);
        null == S && (S = o), o < S && (S = o);
    }
    let N = new a.b(), C = null;
    for (let e = 0; e < i.byteLength / r; e++) {
        let t = i.getUint32(4 * (4 * e + 2)), s = (i.getUint32(4 * (4 * e + 3)) - (t - E) - S) / 1000;
        N.addSample(s), null == C && (C = s), s > C && (C = s);
    }
    let m = null != u && null != T ? (T - u) / 1000 : 0, A = 1 - c / l, h = 8 * d / m, g = 8 * _ / m, O = N.getReport([
            50,
            95,
            99
        ]);

...
var s = l(735250), a = l(470079), t = l(913527), i = l.n(t), r = l(442837), o = l(481060), d = l(933557), c = l(592125), u = l(430824), E = l(496675), _ = l(699516), I = l(594174), x = l(924301), N = l(518756), m = l(545165), T = l(77810), h = l(274311), g = l(230900), v = l(63712), S = l(765305), C = l(981631), L = l(689938), A = l(249989);
let Z = e => e === S.WX.EXTERNAL, f = (e, n) => {
        let l = c.Z.getChannel(e);
        if (null == l)
            return null;
        let a = l.type === C.d4z.GUILD_STAGE_VOICE, t = (0, h.Q)(l, n), i = t ? o.VoiceNormalIcon : o.VoiceLockIcon, r = t ? o.StageIcon : o.StageLockIcon;
...
function V(e) {
    ...
    let I = D(t), N = p(t), m = (0, g.xV)(l), T = (0, g.xC)(d), h = (0, x.xt)(l);
...
function O(e) {
    let {
            ...
            onChange: i,
            isSlideReady: d = !1
        } = e, {entityType: c} = a, _ = (0, r.e7)([u.Z], () => u.Z.getGuild(n), [n]), I = (0, T.q)(_), x = (0, r.e7)([E.Z], () => E.Z.can(C.Plq.MANAGE_CHANNELS, _)), N = null == _ ? void 0 : _.hasFeature(C.oNc.COMMUNITY), m = R(i, a), h = N && !Z(c) && 0 === I.length && x && null != c;
    return (0, s.jsxs)('div', {

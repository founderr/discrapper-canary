...
class R extends o.Component {
  ...
  constructor(...e) {
    super(...e), S(this, "timeoutId", void 0)
  }
}
...
class C extends(r = o.Component) {
  ...
  render() {
    ...
    return (0, s.jsxs)("div", {
      ...
      children: [(0, s.jsxs)("svg", {
        ...
        }) : null, S ? (0, s.jsxs)(o.Fragment, {
          children: [(0, s.jsx)("g", {
            className: f.focusStroke,
            mask: "url(#".concat(g, ")"),
            children: (0, s.jsx)("use", {
              href: "#".concat(p)
            })
          }), (0, s.jsxs)("g", {
            className: f.focusFill,
  ...
  constructor(...e) {
    super(...e), S(this, "timeout", new T.V7), S(this, "state", {
      renderComplex: !1,
      hasRenderedBadge: !1,
      maskId: (0, E.Z)(),
      focused: !1
    }), S(this, "handleTimeout", () => {

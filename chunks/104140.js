...
class N extends (i = s.Component) {
    ...
    getPathInterpolation() {
        var e;
        return null === (e = this.state.borderRadiusMask) || void 0 === e ? void 0 : e.springs.spring.to(S);
    }
    render() {
                                    ...
                                    ? (0, a.jsxs)(s.Fragment, {
                                          children: [
                                              (0, a.jsx)('g', {
                                                  ...
                                                  mask: 'url(#'.concat(A, ')'),
                                                  children: (0, a.jsx)('use', { href: '#'.concat(S) })
                                              }),
                                              (0, a.jsxs)('g', {
                                                  className: g.focusFill,
                                                  children: [null != u ? (0, a.jsx)('use', { href: '#'.concat(I) }) : null, null != r ? (0, a.jsx)('use', { href: '#'.concat(T) }) : null]
                                              })
                                          ]
                                      })
                                    : null,

...
var r = n(69122), i = n(825842), a = n(17146);
let o = {
...
class l {
    ...
    sfixed64(e) {
        let t = new Uint8Array(8), n = new DataView(t.buffer), i = r.M.from(e);
        return n.setInt32(0, i.lo, !0), n.setInt32(4, i.hi, !0), this.raw(t);
    }
    fixed64(e) {
        let t = new Uint8Array(8), n = new DataView(t.buffer), i = r.p.from(e);
        return n.setInt32(0, i.lo, !0), n.setInt32(4, i.hi, !0), this.raw(t);
    }
    int64(e) {
        let t = r.M.from(e);
    ...
    sint64(e) {
        let t = r.M.from(e), n = t.hi >> 31, a = t.lo << 1 ^ n, o = (t.hi << 1 | t.lo >>> 31) ^ n;

...
var r = n(442837), i = n(147913), a = n(592125), o = n(131951), s = n(944486), l = n(979651), u = n(557177), c = n(565799), d = n(431328), _ = n(501655), E = n(427679), f = n(754277);
let h = e => e / 400, p = !1, m = (0, u.tu)('stage_waiting', 'stage_waiting', h(o.Z.getOutputVolume()));
function I() {
...
function T(e) {
    let t = (0, r.e7)([s.Z], () => s.Z.getVoiceChannelId() === e), n = null != (0, d.w8)(e, _.pV.SPEAKER).find(e => !e.voiceState.isVoiceMuted()), i = (0, r.e7)([E.Z], () => E.Z.getStageInstanceByChannel(e));
    return t && null == i && !n;
}
function g(e) {
    let t = s.Z.getVoiceChannelId() === e, n = null != c.Z.getMutableParticipants(e, _.pV.SPEAKER).find(e => !e.voiceState.isVoiceMuted()), r = E.Z.getStageInstanceByChannel(e);
    return t && null == r && !n;
}
class S extends i.Z {

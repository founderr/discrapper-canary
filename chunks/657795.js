...
function R(e) {
    ...
    return (0, r.jsxs)('div', {
        className: s()(N.emptyState, R, { [N.unifyTrialUpsell]: y }),
        children: [
            y
                ? (0, r.jsx)(E.ZP, {
                      discountOffer: D,
            ...
            !y &&
                (0, r.jsx)(m.Z, {
                    ...
                    buttonText: y ? (b ? A.Z.Messages.PREMIUM_TRIAL_TIER_0_CTA_BUTTON_VARIANT : A.Z.Messages.PREMIUM_TRIAL_CTA_BUTTON_VARIANT) : void 0
                })
        ]
    });
}

...
var i = n(735250);
n(470079);
var a = n(442837), s = n(704215), l = n(481060), r = n(232567), o = n(230711), c = n(726542), d = n(100527), u = n(231757), _ = n(674525), E = n(29458), m = n(636629), I = n(33885), T = n(963249), h = n(346585), N = n(303172), f = n(463230), p = n(246965), C = n(703656), g = n(706454), S = n(933429), A = n(395361), x = n(626135), O = n(243778), R = n(921944), M = n(981631), v = n(801461), L = n(474936), Z = n(689938), P = n(596791);
let b = e => {
    let {
    ...
    return (0, i.jsx)(O.Z, {
        ...
        children: e => {
            ...
            case s.z.GUILD_ONBOARDING_UPSELL_NAGBAR:
                return (0, i.jsx)(I.Z, { dismissCurrentNotice: () => S(R.L.UNKNOWN) });
            ...
            case s.z.NAGBAR_NOTICE_CONNECT_SPOTIFY:
                return (0, i.jsxs)(l.Notice, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(A.Z, { className: P.platformIcon }),
            ...
            case s.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION:
                return (0, i.jsxs)(l.Notice, {
                    ...
                    children: [
                        (0, i.jsx)(l.NoticeCloseButton, { onClick: () => S(R.L.UNKNOWN) }),
                        (0, i.jsx)('img', {
                            alt: '',
            ...
            case s.z.NAGBAR_NOTICE_PREMIUM_PROMO:
                return (0, i.jsxs)(l.Notice, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(l.NoticeCloseButton, {
                            onClick: () => {
                                S(R.L.UNKNOWN), (0, r.mB)(M.xW$.PREMIUM_PROMO_DISMISSED, !0);
                            },
                            noticeType: b
                        })
                    ]
                ...
                return (0, i.jsxs)(l.Notice, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(l.PrimaryCTANoticeButton, {
                            noticeType: b,
                            onClick: () => {
                                S(R.L.UNKNOWN), o.Z.open(M.oAB.PREMIUM);
                            },
                ...
                return (0, i.jsxs)(l.Notice, {
                    ...
                    children: [
                        ...
                        (0, i.jsx)(l.PrimaryCTANoticeButton, {
                            noticeType: b,
                            onClick: () => {
                                S(R.L.PRIMARY), (0, C.uL)(1 === y.length ? M.Z5c.GUILD_SETTINGS(y[0], 'role-subscriptions') : M.Z5c.PICK_GUILD_SETTINGS('role-subscriptions', void 0, 'server-subscriptions-finish-setting-up'));
                            },
            ...
            case s.z.UU_MIGRATION_NOTICE:
                return (0, i.jsxs)(l.Notice, {
                    ...
                    children: [
                        ...
                        Z.Z.Messages.POMELO_ACTION_NEEDED_FORCE.format({ date: (0, h.IE)(j) }),
                        (0, i.jsx)(l.PrimaryCTANoticeButton, {
                            onClick: () => (0, N.Z)(v.Kq.NOTICE),
                            noticeType: b,
                            children: Z.Z.Messages.GET_STARTED

        ...
        case l.DismissibleContent.NAGBAR_BOUNCED_EMAIL_NOTICE:
          return (0, s.jsxs)(h.default, {
            ...
            children: [(0, s.jsx)(h.NoticeCloseButton, {
              ...
              noticeType: x,
              onClick: () => {
                (0, N.transitionTo)(R.Routes.SETTINGS("account"))
              },
        ...
        case l.DismissibleContent.NAGBAR_ACTIVATE_SERVER_SUBSCRIPTION:
          ...
          return (0, s.jsxs)(h.default, {
            ...
            children: [(0, s.jsx)(h.NoticeCloseButton, {
              ...
              noticeType: x,
              onClick: () => {
                C(O.ContentDismissActionType.PRIMARY), (0, N.transitionTo)(1 === b.length ? R.Routes.GUILD_SETTINGS(b[0], "role-subscriptions") : R.Routes.PICK_GUILD_SETTINGS("role-subscriptions", void 0, "server-subscriptions-finish-setting-up"))
              },

...
function o(e, t, n, r, i) {
    for (var a, o, s, l, u = n[0], c = n[1], d = n[2], _ = n[3], E = e[0] ^ t[0], f = e[1] ^ t[1], h = e[2] ^ t[2], p = e[3] ^ t[3], m = 4, I = 1; I < i; I++) (a = u[E >>> 24] ^ c[(f >>> 16) & 255] ^ d[(h >>> 8) & 255] ^ _[255 & p] ^ t[m++]), (o = u[f >>> 24] ^ c[(h >>> 16) & 255] ^ d[(p >>> 8) & 255] ^ _[255 & E] ^ t[m++]), (s = u[h >>> 24] ^ c[(p >>> 16) & 255] ^ d[(E >>> 8) & 255] ^ _[255 & f] ^ t[m++]), (l = u[p >>> 24] ^ c[(E >>> 16) & 255] ^ d[(f >>> 8) & 255] ^ _[255 & h] ^ t[m++]), (E = a), (f = o), (h = s), (p = l);
    return (a = ((r[E >>> 24] << 24) | (r[(f >>> 16) & 255] << 16) | (r[(h >>> 8) & 255] << 8) | r[255 & p]) ^ t[m++]), (o = ((r[f >>> 24] << 24) | (r[(h >>> 16) & 255] << 16) | (r[(p >>> 8) & 255] << 8) | r[255 & E]) ^ t[m++]), (s = ((r[h >>> 24] << 24) | (r[(p >>> 16) & 255] << 16) | (r[(E >>> 8) & 255] << 8) | r[255 & f]) ^ t[m++]), (l = ((r[p >>> 24] << 24) | (r[(E >>> 16) & 255] << 16) | (r[(f >>> 8) & 255] << 8) | r[255 & h]) ^ t[m++]), [(a >>>= 0), (o >>>= 0), (s >>>= 0), (l >>>= 0)];
}
var s = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
    l = (function () {
        for (var e = Array(256), t = 0; t < 256; t++) t < 128 ? (e[t] = t << 1) : (e[t] = (t << 1) ^ 283);
        for (var n = [], r = [], i = [[], [], [], []], a = [[], [], [], []], o = 0, s = 0, l = 0; l < 256; ++l) {
...
(u.blockSize = 16),
    ...
    (u.prototype.decryptBlock = function (e) {
        var t = (e = i(e))[1];
        (e[1] = e[3]), (e[3] = t);
        var n = o(e, this._invKeySchedule, l.INV_SUB_MIX, l.INV_SBOX, this._nRounds),
            a = r.allocUnsafe(16);

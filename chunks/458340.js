...
function s(e, t, n, r, i) {
    for (var a, s, o, l, u = n[0], c = n[1], d = n[2], f = n[3], _ = e[0] ^ t[0], h = e[1] ^ t[1], p = e[2] ^ t[2], m = e[3] ^ t[3], g = 4, E = 1; E < i; E++) (a = u[_ >>> 24] ^ c[(h >>> 16) & 255] ^ d[(p >>> 8) & 255] ^ f[255 & m] ^ t[g++]), (s = u[h >>> 24] ^ c[(p >>> 16) & 255] ^ d[(m >>> 8) & 255] ^ f[255 & _] ^ t[g++]), (o = u[p >>> 24] ^ c[(m >>> 16) & 255] ^ d[(_ >>> 8) & 255] ^ f[255 & h] ^ t[g++]), (l = u[m >>> 24] ^ c[(_ >>> 16) & 255] ^ d[(h >>> 8) & 255] ^ f[255 & p] ^ t[g++]), (_ = a), (h = s), (p = o), (m = l);
    return (a = ((r[_ >>> 24] << 24) | (r[(h >>> 16) & 255] << 16) | (r[(p >>> 8) & 255] << 8) | r[255 & m]) ^ t[g++]), (s = ((r[h >>> 24] << 24) | (r[(p >>> 16) & 255] << 16) | (r[(m >>> 8) & 255] << 8) | r[255 & _]) ^ t[g++]), (o = ((r[p >>> 24] << 24) | (r[(m >>> 16) & 255] << 16) | (r[(_ >>> 8) & 255] << 8) | r[255 & h]) ^ t[g++]), (l = ((r[m >>> 24] << 24) | (r[(_ >>> 16) & 255] << 16) | (r[(h >>> 8) & 255] << 8) | r[255 & p]) ^ t[g++]), [(a >>>= 0), (s >>>= 0), (o >>>= 0), (l >>>= 0)];
}

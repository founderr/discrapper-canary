...
function s(e, t, n, r, i) {
    for (var a, s, o, l, u = n[0], c = n[1], d = n[2], _ = n[3], E = e[0] ^ t[0], f = e[1] ^ t[1], h = e[2] ^ t[2], p = e[3] ^ t[3], I = 4, m = 1; m < i; m++) (a = u[E >>> 24] ^ c[(f >>> 16) & 255] ^ d[(h >>> 8) & 255] ^ _[255 & p] ^ t[I++]), (s = u[f >>> 24] ^ c[(h >>> 16) & 255] ^ d[(p >>> 8) & 255] ^ _[255 & E] ^ t[I++]), (o = u[h >>> 24] ^ c[(p >>> 16) & 255] ^ d[(E >>> 8) & 255] ^ _[255 & f] ^ t[I++]), (l = u[p >>> 24] ^ c[(E >>> 16) & 255] ^ d[(f >>> 8) & 255] ^ _[255 & h] ^ t[I++]), (E = a), (f = s), (h = o), (p = l);
    return (a = ((r[E >>> 24] << 24) | (r[(f >>> 16) & 255] << 16) | (r[(h >>> 8) & 255] << 8) | r[255 & p]) ^ t[I++]), (s = ((r[f >>> 24] << 24) | (r[(h >>> 16) & 255] << 16) | (r[(p >>> 8) & 255] << 8) | r[255 & E]) ^ t[I++]), (o = ((r[h >>> 24] << 24) | (r[(p >>> 16) & 255] << 16) | (r[(E >>> 8) & 255] << 8) | r[255 & f]) ^ t[I++]), (l = ((r[p >>> 24] << 24) | (r[(E >>> 16) & 255] << 16) | (r[(f >>> 8) & 255] << 8) | r[255 & h]) ^ t[I++]), [(a >>>= 0), (s >>>= 0), (o >>>= 0), (l >>>= 0)];
}

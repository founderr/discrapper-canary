...
class N extends(r = l.ZP.Store) {
  ...
  getCurrentRevision() {
    ...
    if (null == i) {
      var e;
      i = null !== (e = u.K.get(f)) && void 0 !== e ? e : null
    }
    return i
  }
  async getBlockedDomainList() {
    return null == S && (S = new Set(await I.Z.getBlockedDomains())), S
  }
  isBlockedDomain(e) {
    let t = n(647229);
    ...
    S.has(s) && (o = i);
    let a = i.indexOf(".");
    for (; - 1 !== a && "" === o;) i = i.substring(a + 1), r.reset(), s = t.codec.hex.fromBits(r.update(i).finalize()), S.has(s) && (o = i), a = i.indexOf(".");
...
a = "BlockedDomainStore", (o = "displayName") in(s = N) ? Object.defineProperty(s, o, {
  ...
  BLOCKED_DOMAIN_LIST_FETCHED: function(e) {
    ...
    i = null, S = new Set(t), I.Z.saveBlockedDomains(t), u.K.set("BlockedDomainRevision", n)
  }
})
...
let c = [
        {
            ...
            angle: 180,
            getName: () => u.intl.string(u.t.kCdS4e),
        ...
        },
        {
            ...
            angle: 180,
            getName: () => u.intl.string(u.t.S4UnEx),
            midpointPercentage: 27
        },
        {
            ...
            angle: 148.71,
            getName: () => u.intl.string(u.t['48xnKS']),
        ...
        },
        {
            ...
            angle: 38.08,
            getName: () => u.intl.string(u.t.G4HsBA),
            midpointPercentage: 50
        },
        {
            id: o.Us.SUNRISE,
            ...
            angle: 154.19,
            getName: () => u.intl.string(u.t['NAt88/']),
            midpointPercentage: 50
        },
        {
            ...
            angle: 180.14,
            getName: () => u.intl.string(u.t.godtzM),
            midpointPercentage: 50
        },
        {
            id: o.Us.LOFI_VIBES,
            ...
            angle: 179.52,
            getName: () => u.intl.string(u.t.hlS2xs),
            midpointPercentage: 27
        },
        {
            ...
            angle: 38.99,
            getName: () => u.intl.string(u.t['abMn9/']),
            midpointPercentage: 50
        }
    ],
    d = [
        {
            ...
            angle: 141.68,
            getName: () => u.intl.string(u.t.JKDra2),
        ...
        },
        {
            ...
            angle: 128.92,
            getName: () => u.intl.string(u.t.kwc8Ul),
        ...
        },
        {
            ...
            angle: 162.27,
            getName: () => u.intl.string(u.t['TeA/j4']),
            midpointPercentage: 50
        },
        {
            ...
            angle: 64.92,
            getName: () => u.intl.string(u.t.blIucn),
        ...
        },
        {
            ...
            angle: 48.17,
            getName: () => u.intl.string(u.t.O1yOXF),
        ...
        },
        {
            ...
            angle: 170.82,
            getName: () => u.intl.string(u.t['1swi9v']),
            midpointPercentage: 50
        },
        {
            id: o.Us.DUSK,
            ...
            angle: 180,
            getName: () => u.intl.string(u.t.So2Wur),
            midpointPercentage: 50
        },
        {
            ...
            angle: 179.14,
            getName: () => u.intl.string(u.t['a22o4+']),
            midpointPercentage: 50
        },
        {
            id: o.Us.RETRO_STORM,
            ...
            angle: 148.71,
            getName: () => u.intl.string(u.t.Bf294e),
        ...
        },
        {
            ...
            angle: 180,
            getName: () => u.intl.string(u.t['p+XCtb']),
            midpointPercentage: 50
        },
        {
            ...
            angle: 161.03,
            getName: () => u.intl.string(u.t['d5Ar+v']),
        ...
        },
        {
            ...
            angle: 239.16,
            getName: () => u.intl.string(u.t.Je1FWF),
        ...
        },
        {
            ...
            angle: 69.98,
            getName: () => u.intl.string(u.t['Z+Un4+']),
            midpointPercentage: 50
        }
    ],
    f = {
...
let p = [
        ...
        {
            theme: l.BR.LIGHT,
            getName: () => u.intl.string(u.t.K2sFfn)
        },
        {
            theme: l.BR.MIDNIGHT,
            getName: () => u.intl.string(u.t.pQwSpa)
        },
        {
            theme: 'system',

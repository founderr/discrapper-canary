...
var l = t(735250), s = t(470079), a = t(120356), i = t.n(a), r = t(512722), o = t.n(r), u = t(848246), c = t(442837), d = t(481060), m = t(410575), E = t(2052), _ = t(924557), S = t(736871), g = t(1163), h = t(594174), C = t(285952), N = t(672752), Z = t(74538), I = t(451467), x = t(122186), f = t(37113), A = t(981631), R = t(474936), T = t(689938), v = t(1871), L = t(631083), M = t(549856);
function p(e) {
    let {
        analyticsLocation: n,
        onClose: s
...
function j(e) {
    ...
    return r ? (n = (0, l.jsx)(d.TooltipContainer, {
        ...
        children: (0, l.jsx)(d.Text, {
            ...
            className: i()(L.selectorText, { [L.enhancedSelectorNitroText]: o }),
            children: S
        })
    }), t = () => c(_)), {
        content: n,
...
function P(e) {
    let {
        ...
        }), U = Z.ZP.canStreamQuality(Z.U2.MID, G), {location: b} = (0, E.O)(), w = (0, _.Zq)({ autoTrackExposure: !1 }), B = (0, Z.I5)(G, R.p9.TIER_1), {inPerksDemosExperiment: y} = S.Z.useExperiment({ location: 'Go Live Modal' }, {
            autoTrackExposure: !0,
            disable: B
        });
    ...
    let V = (0, Z.So)(u.q.STREAM_HIGH_QUALITY), k = !U && !w || V, [H, W] = s.useState(!1), F = D ? f.z8 : f.WC, z = {
            ...b,
            ...
            children: [
                (0, l.jsx)(C.Z, {
                    children: (0, l.jsx)(d.FormItem, {
                        ...
                        children: (0, l.jsx)(d.Text, {
                            variant: 'text-xs/normal',
                            children: T.Z.Messages.STREAM_PRESET_DOCUMENTS_DESCRIPTION_NITRO.format({ fps: i })
                        })
                    })
                }),
                k ? (0, l.jsx)(x.Z, {

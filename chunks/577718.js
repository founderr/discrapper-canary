...
children: (() => {
  switch (k) {
    ...
    case s.z.GUILD_HEADER_INVITE_SPLASH:
      let e = (0, S.f2)(a, C.Eu4.TIER_1) ? Z.Z.Messages.INVITE_SPLASH_GUILD_HEADER_TOOLTIP_CONTENT.format() : Z.Z.Messages.INVITE_SPLASH_GUILD_HEADER_TOOLTIP_CONTENT_LOCKED.format({
          boostCount: (0, S.KK)(a, C.Eu4.TIER_1)
        }),

...
class h {
  parse(e) {
    ...
    if ("percent" === this.options.style) {
      ...
      return new l(this.locale, e).parse(new a(this.locale, e).format(n))
    }
  ...
  constructor(e, t = {}) {
    ...
    this.locale = e, this.formatter = new Intl.NumberFormat(e, t), this.options = this.formatter.resolvedOptions(), this.symbols = function(e, t, n, r) {
      ...
      let u = new Intl.NumberFormat(e, {
        ...
        p = null !== (c = null === (i = l.find(e => "minusSign" === e.type)) || void 0 === i ? void 0 : i.value) && void 0 !== c ? c : "-",
      ...
      let b = null === (s = new Intl.NumberFormat(e, {
        ...
        y = null === (a = l.find(e => "group" === e.type)) || void 0 === a ? void 0 : a.value,
        x = l.filter(e => !v.has(e.type)).map(e => m(e.value)),

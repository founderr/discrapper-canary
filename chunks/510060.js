...
class o {
    ...
    getRenderOptions(e) {
        ...
        let t = e / this.maxWidth, n = Math.max(Math.floor(t + (e / this.minWidth - t) / 2), 1), a = this.gap * (n - 1);
        return {
            columns: n,
            columnWidth: (e - a) / n
        };
...
let c = {
        ...
        let t = e - 2, n = Math.ceil(t * l);
        return [
            t,
            n
        ];
    }, u = 12, m = e => 60 + d(e - 2 * u)[1] + 24 + 3 * i;

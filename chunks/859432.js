...
let F = l.memo(function (e) {
    ...
    let Y = (0, o.e7)([O.ZP], () => O.ZP.isGuildCollapsed(n.id), [n.id]), {
        ...
        }, [n]), q = (0, p.N8)(n), X = n.isOwner(F), J = (0, o.e7)([S.Z], () => S.Z.isLurking(n.id), [n.id]), Q = (0, o.e7)([U.ZP], () => U.ZP.isCurrentUserGuest(n.id)), $ = (0, Z.Z)(n.id, !0), ee = (0, _.ZP)(n), en = (0, L.Z)({
            ...
            icon: d.PencilIcon
        }), ea = n.hasFeature(w.oNc.HUB), el = n.id === B._, ei = (0, R.Z)(n.id), es = (0, N.Z)(n), eo = (0, f.Z)(n), er = (0, T.Z)(n, !0), {isFavoritesPerk: ed} = (0, M.z)('GuildHeaderPopout'), {triggerDeadchat: eu} = I.Z.useExperiment({
            guildId: n.id,
            location: 'guild header'
        }, { autoTrackExposure: !1 }), {triggerGamingStats: ec} = E.F.useExperiment({
            guildId: n.id,
            location: 'guild header'
        }, { autoTrackExposure: !1 }), eE = b.Y.useExperiment({ location: 'GuildHeaderPopout' }, { autoTrackExposure: !0 }).enabled, [eI] = (0, g.c)([r.z.PREMIUM_CUSTOM_NOTIFICATION_SOUNDS_GUILD_BADGE]), e_ = eE && eI === r.z.PREMIUM_CUSTOM_NOTIFICATION_SOUNDS_GUILD_BADGE;

s.r(t), s(47120);
var n = s(735250), i = s(470079), o = s(442837), l = s(279837), a = s(479531), r = s(144114), h = s(23434), d = s(594174), u = s(585111), c = s(1964), p = s(689938);
t.default = i.forwardRef(function (e, t) {
    let {
            ...
            if (null != R)
                c.Z.isPhoneReverification(g, y) ? await r.Z.reverifyPhone(R, e, f) : await r.Z.addPhone(R, e, f), null == s || s(), m();
        }, [
            s,
            m,
            R,
    ...
    return null != R ? (0, n.jsx)(l.default, {
        onClose: m,
        transitionState: C,

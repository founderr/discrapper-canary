t(47120);
var l = t(735250), s = t(470079), a = t(512722), i = t.n(a), r = t(442837), o = t(704215), u = t(481060), c = t(605236), d = t(706140), m = t(765585), E = t(556296), _ = t(63063), S = t(13140), g = t(435064), h = t(894694), C = t(39604), N = t(981631), Z = t(921944), I = t(689938), x = t(291779), f = t(278768);
let A = e => {
    let {
            clipsEnabled: n,
            isAnimationDone: t,
    ...
    s.useEffect(() => {
        n && (0, c.EW)(o.z.CLIPS_ONBOARDING_GO_LIVE_COACHMARK, { forceTrack: !0 });
    }, [n]);
    let L = (e, n) => {
                ...
                body: (0, l.jsxs)(l.Fragment, {
                    children: [
                        ...
                        f ? (0, l.jsx)(u.Text, {
                            ...
                            children: I.Z.Messages.CLIPS_ONBOARDING_GO_LIVE_DEFAULT_DISABLED_COACHMARK_HARDWARE_IMPACT_WARNING.format({ url: _.Z.getArticleURL(N.BhN.CLIPS) })
                        }) : null
                    ]
                }),

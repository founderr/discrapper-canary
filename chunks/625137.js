...
var r = n(149765), i = n(866442), a = n(709054);
function o(e) {
...
function l(e, t) {
    ...
    return t.sort((t, n) => {
        var r, i;
        let o = e === t.id ? 1 / 0 : -(null !== (r = t.originalPosition) && void 0 !== r ? r : t.position), s = e === n.id ? 1 / 0 : -(null !== (i = n.originalPosition) && void 0 !== i ? i : n.position);

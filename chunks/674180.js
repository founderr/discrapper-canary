...
var r = n(470079), i = n(442837), a = n(81897), o = n(423117), s = n(289393), l = n(430824), u = n(738774), c = n(981631);
let d = e => {
        let t = (0, a.Z)();
        r.useEffect(() => {
        ...
        let n = null == e ? void 0 : e.id, l = (0, i.Wu)([s.Z], () => {
                var e;
        ...
        let n = (0, i.e7)([l.Z], () => l.Z.getGuild(e), [e]), {
                restrictions: r,
                restrictionsLoading: a
            } = d(n), o = a ? null === (t = null == n ? void 0 : n.hasFeature(c.oNc.CREATOR_MONETIZABLE_RESTRICTED)) || void 0 === t || t : (0, u.Q6)(r), s = !!(null == n ? void 0 : n.hasFeature(c.oNc.CREATOR_MONETIZABLE_PENDING_NEW_OWNER_ONBOARDING));
        return {

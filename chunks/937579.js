...
var r = n(544891), i = n(704215), a = n(570140), o = n(605236), s = n(675478), l = n(626135), u = n(981631);
async function c(e) {
    ...
    if (t) {
        ...
        try {
            ...
            let t = await r.tn.post({ url: u.ANM.USER_OFFER }), _ = null !== (n = t.body.user_trial_offer) && void 0 !== n ? n : null, E = null !== (c = t.body.user_discount) && void 0 !== c ? c : null, f = null !== (d = t.body.user_discount_offer) && void 0 !== d ? d : null;
            return null == _ && (0, o.un)(i.z.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING) && (0, s.w9)(i.z.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING), a.Z.dispatch({

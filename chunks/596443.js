...
categoryTitle: x,
userId: S
  } = e, A = (0, c.e7)([E.Z], () => E.Z.getRoles(g.id)), M = N.Plq[o], b = null !== (s = null === (t = I[M.toString()]) || void 0 === t ? void 0 : t.title) && void 0 !== s ? s : (0, _.wt)(M), R = null !== (r = null === (n = I[M.toString()]) || void 0 === n ? void 0 : n.description) && void 0 !== r ? r : '', j = T._o.has(M), L = T.Qn.includes(o), P = f.length, O = (0, c.e7)([C.Z], () => C.Z.can(N.Plq.MANAGE_ROLES, g), [g]), y = a.useCallback(async e => {
if (!!O)
  await p.Z.open(g.id, N.pNK.ROLES), await p.Z.selectRole(e);
  }, [
O,
g.id
  ]);

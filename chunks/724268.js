...
let B = a.memo(function() {
  ...
  H = a.memo(function(e) {
    ...
    } = (0, f.default)(t.id), H = (0, A.useIsChecked)(s.id, t.id, a.id), F = (0, A.useIsDisabled)(s.id, t.id, a.id), U = (0, A.useDisabledTooltip)(s.id, a.id), k = (0, r.useStateFromStores)([E.default], () => E.default.getActiveThreadCount(s.id, t.id)), P = (0, r.useStateFromStores)([x.default], () => x.default.shouldIndicateNewChannel(s.id, t.id)), G = e => {
...
function F(e) {
  let {
    ...
    onChannelClick: c
  } = (0, v.default)(l.id), f = (0, h.useIsDismissibleContentDismissed)(d.DismissibleContent.CHANNEL_BROWSER_NUX), m = f ? 0 : -1, C = a.useCallback(e => {
    let {
      section: a
    } = e;

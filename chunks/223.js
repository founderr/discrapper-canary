...
function Q(e) {
  let {
    ...
    quarantineType: el
  } = (0, T.default)(l), ei = a.useMemo(() => (0, p.renderAutomodMessageMarkup)(ee, J, r.id), [ee, J, r]), {
    selected: er,
    ...eo
  } = function(e, t) {
    let {
    ...
    null != et && null != X && (e.stopPropagation(), e.preventDefault(), (0, N.default)(G.Routes.CHANNEL(null == X ? void 0 : X.guild_id, null == X ? void 0 : X.id, et)))
  }, [X, et]), ec = a.useCallback(() => {
    (0, m.executeAlertAction)(l.id, r, _.AutomodAlertActionType.DELETE_USER_MESSAGE)
  }, [r, l.id]), eE = a.useMemo(() => (0, T.getActionHeaderText)(l, X, () => (0, s.jsx)("div", {
  ...
  })), [l, X]), ef = (0, F.getFriendlyDurationString)(Number(en)), e_ = null != es, eT = Q && null != et && (null == ea || !ea.actions.hasOwnProperty(_.AutomodAlertActionType.DELETE_USER_MESSAGE));
  return (0, s.jsx)("div", {
    onMouseEnter: g,
    onMouseLeave: O,

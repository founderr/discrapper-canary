...
function E(e) {
  let {
    ...
    height: S,
    ref: _
  } = (0, o.default)(), T = n ? S : 59 + (null != C ? C : 100) + 101, I = (0, r.useSpring)({
    from: {
      height: 0
    },
    to: {
    ...
    config: h,
    delay: 1e3
  }), x = (0, u.useTheme)(), v = x === d.ThemeTypes.LIGHT ? "#FFFFFF" : "#1C1D23", N = x === d.ThemeTypes.LIGHT ? "#EBEDEF" : "#26272F", M = x === d.ThemeTypes.LIGHT ? "#CCCCCC" : "#1A1A1E";
  return (0, a.jsx)("div", {
    className: c.container,
    ref: _,
    children: (0, a.jsxs)(r.animated.div, {
      className: c.heightContainer,
      style: {
        ...I,

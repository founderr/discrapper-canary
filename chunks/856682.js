...
function g(e) {
  let {
    ...
    height: _,
    ref: I
  } = (0, o.Z)(), x = n ? _ : 59 + (null != f ? f : 100) + 101, T = (0, r.useSpring)({
    from: {
      height: 0
    },
    to: {
    ...
    config: m,
    delay: 1e3
  }), Z = (0, c.Fg)(), S = Z === u.BR.LIGHT ? "#FFFFFF" : "#1C1D23", v = Z === u.BR.LIGHT ? "#EBEDEF" : "#26272F", A = Z === u.BR.LIGHT ? "#CCCCCC" : "#1A1A1E";
  return (0, l.jsx)("div", {
    ...
    children: (0, l.jsxs)(r.animated.div, {
      ...
      children: [(0, l.jsx)(E, {
        ...
        className: a()(d.content, n && d.fullHeight),
        ref: C,
        children: (0, l.jsx)("div", {
          className: a()(d.innerContent, n && d.fullHeight),
          style: {
            backgroundColor: S
          },
          children: (0, l.jsx)(r.animated.div, {
            className: a()(d.contentAnimContainer, n && d.fullHeight),
            style: N,
            children: t
          })
        })

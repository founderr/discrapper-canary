...
t.default = function(e) {
  let {
    ...
    await G(t)
  }, [A, G]), B = i.useCallback(async (e, t) => {
    if (A[e] === t) return;
    let n = [...A];
    n[e] = t, await G(n)
  }, [A, G]), k = i.useCallback(async (e, t, n) => {
    let a = A.indexOf(e),
      i = [...A];
    if (null != t && t !== a && (i.splice(a, 1), i.splice(t, 0, e), R(i)), n) try {
      await G(i), null !== N && S(null)
    } catch (e) {
      w()
    } else N !== t && S(t)
  }, [N, A, G, w]), H = i.useCallback(async e => {
    try {
      await G([...A.slice(0, e), ...A.slice(e + 1)])
    } catch (e) {
      w()
    }
  }, [A, G, w]), V = (0, a.jsxs)(a.Fragment, {
  ...
  return F ? (0, a.jsxs)(a.Fragment, {
    children: [!C && V, !D && (0, a.jsx)(d.default, {
      addFormField: U,

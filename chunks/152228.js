...
function D(e, t) {
  let r = U();
  if (r.startSpan)
return r.startSpan(e, t);
  let n = m(e),
{
  forceTransaction: a,
  parentSpan: o
} = e;
  return (0, _.$e)(e.scope, () => v(o)(() => {
let r = (0, _.nZ)(),
  o = y(r),
  i = e.onlyIfParent && !o ? new N.b() : P({
    parentSpan: o,
    spanArguments: n,
    forceTransaction: a,
    scope: r
  });
return (0, l.D)(r, i), (0, I.i)(() => t(i), () => {
  let {
    status: e
  } = (0, R.XU)(i);
...
function L(e, t) {
  let r = U();
  if (r.startSpanManual)
return r.startSpanManual(e, t);
  let n = m(e),
{
  forceTransaction: a,
  parentSpan: o
...
let t = (0, _.nZ)(),
  a = y(t);
return e.onlyIfParent && !a ? new N.b() : P({
  parentSpan: a,
  spanArguments: r,
  forceTransaction: n,
  scope: t
...
a = function(e, t, r) {
  let {
    spanId: n,
    traceId: a
  } = e.spanContext(), o = !t.getScopeData().sdkProcessingMetadata[S] && (0, R.Tt)(e), i = o ? new p.s({
    ...r,
    parentSpanId: n,
    traceId: a,
    sampled: o
...
[E, s] = t.getScopeData().sdkProcessingMetadata[S] ? [!1] : (0, d.R)(a, {
  name: o,
  parentSampled: r,
  attributes: i,
  transactionContext: {

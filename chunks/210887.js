...
let y = null !== (i = (0, p.Z)()) && void 0 !== i ? i : T.BRd.DARK,
    A = null,
    N = !1;
function C() {
    let e = (function () {
        var e, t;
        if (__OVERLAY__) return T.BRd.DARK;
        ...
        if (null == a) return y;
        if (!_.i.getCurrentConfig({ location: 'ThemeStore' }).enabled) return a === o.Q2.LIGHT ? T.BRd.LIGHT : T.BRd.DARK;
        switch (a) {
            case o.Q2.LIGHT:
                return T.BRd.LIGHT;
            case o.Q2.DARK:

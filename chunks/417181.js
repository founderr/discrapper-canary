...
function L(e, t, r, a, n, s, o, i, u, c) {
  ...
  return function y() {
    ...
    if (a && (m = function(e, t, r, a) {
      ...
      var j = x(m, k);
      return q(e, t, L, y.placeholder, r, m, j, i, u, c - g)
    }
    var C = f ? r : this,
      M = b ? C[e] : e;
    return g = m.length, i ? m = function(e, t) {
      ...
      return e
    }(m, i) : h && g > 1 && m.reverse(), l && u < g && (m.length = u), this && this !== w && this instanceof y && (M = p || I(M)), M.apply(C, m)
  }
}
    ...
    if (e = b[0], t = b[1], r = b[2], a = b[3], n = b[4], !(i = b[9] = null == b[9] ? u ? 0 : e.length : B(b[9] - c, 0)) && 24 & t && (t &= -25), t && 1 != t) {
      ...
      if (8 == t || 16 == t) {
        ...
        d = e, h = t, p = i, y = I(d), S = function e() {
          ...
          return (t -= s.length) < p ? q(d, h, L, e.placeholder, void 0, r, s, void 0, void 0, p - t) : E(this && this !== w && this instanceof e ? y : d, this, r)
        }
      } else if (32 != t && 33 != t || n.length) S = L.apply(void 0, b);
      else {
        ;
        g = e, v = t, m = r, O = a, k = 1 & v, j = I(g), S = function e() {
          for (var t = -1, r = arguments.length, a = -1, n = O.length, s = Array(n + r); ++a < n;) s[a] = O[a];
          for (; r--;) s[a++] = arguments[++t];
          return E(this && this !== w && this instanceof e ? j : g, k ? m : this, s)
        }
      }
    } else {
      var d, h, p, y, g, v, m, O, k, j, C, M, _, A, R, S = (C = e, M = t, _ = r, A = 1 & M, R = I(C), function e() {

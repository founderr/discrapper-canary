...
var _ = (a = /[^.]+$/.exec(A && A.keys && A.keys.IE_PROTO || "")) ? "Symbol(src)_1." + a : "",
  ...
  F = Math.max,
  T = Math.min;
var N = (n = $(Object, "defineProperty"), (s = $.name) && s.length > 2 ? n : void 0);
...
function I(e) {
  return function() {
    ...
    var a = W(t = e.prototype) ? B(t) : {},
      n = e.apply(a, r);
    return W(n) ? n : a
  }
}

function L(e, t, r, a, n, s, o, i, u, l) {
  var c = 128 & t,
    f = 1 & t,
    b = 2 & t,
    d = 24 & t,
  ...
  return function g() {
    ...
    if (a && (m = function(e, t, r, a) {
        for (var n = -1, s = e.length, o = r.length, i = -1, u = t.length, l = F(s - o, 0), c = Array(u + l), f = !a; ++i < u;) c[i] = t[i];
        for (; ++n < o;)(f || n < s) && (c[r[n]] = e[n]);
        for (; l--;) c[i++] = e[n++];
        return c
      }(m, a, n, d)), s && (m = function(e, t, r, a) {
        for (var n = -1, s = e.length, o = -1, i = r.length, u = -1, l = t.length, c = F(s - i, 0), f = Array(c + l), b = !a; ++n < c;) f[n] = e[n];
        for (var d = n; ++u < l;) f[d + u] = t[u];
        for (; ++o < i;)(b || n < s) && (f[d + r[o]] = e[n++]);
        return f
      }(m, s, o, d)), y -= E, d && y < l) {
      var x = j(m, w);
      return q(e, t, L, g.placeholder, r, m, x, i, u, l - y)
    }
    var C = f ? r : this,
      M = b ? C[e] : e;
    return y = m.length, i ? m = function(e, t) {
      ...
      return e
    }(m, i) : h && y > 1 && m.reverse(), c && u < y && (m.length = u), this && this !== k && this instanceof g && (M = p || I(M)), M.apply(C, m)
  }
}

function q(e, t, r, a, n, s, o, i, u, l) {
  var c = 8 & t;
  t |= c ? 32 : 64, !(4 & (t &= ~(c ? 64 : 32))) && (t &= -4);
  var f = r(e, t, n, c ? s : void 0, c ? o : void 0, c ? void 0 : s, c ? void 0 : o, i, u, l);
...
function G(e, t, r) {
  var a = function(e, t, r, a, n, s, o, i) {
    ...
    var b = [e, t, r, a, n, c, f, s, o, i];
    if (e = b[0], t = b[1], r = b[2], a = b[3], n = b[4], !(i = b[9] = null == b[9] ? u ? 0 : e.length : F(b[9] - l, 0)) && 24 & t && (t &= -25), t && 1 != t) {
      ;
      if (8 == t || 16 == t) {
        ;
        d = e, h = t, p = i, g = I(d), R = function e() {
          for (var t = arguments.length, r = Array(t), a = t, n = z(e); a--;) r[a] = arguments[a];
          var s = t < 3 && r[0] !== n && r[t - 1] !== n ? [] : j(r, n);
          return (t -= s.length) < p ? q(d, h, L, e.placeholder, void 0, r, s, void 0, void 0, p - t) : E(this && this !== k && this instanceof e ? g : d, this, r)
        }
      } else if (32 != t && 33 != t || n.length) R = L.apply(void 0, b);
      else {
        ;
        y = e, v = t, m = r, O = a, w = 1 & v, x = I(y), R = function e() {
          for (var t = -1, r = arguments.length, a = -1, n = O.length, s = Array(n + r); ++a < n;) s[a] = O[a];
          for (; r--;) s[a++] = arguments[++t];
          return E(this && this !== k && this instanceof e ? x : y, w ? m : this, s)
        }
      }
    } else {
      var d, h, p, g, y, v, m, O, w, x, C, M, A, _, S, R = (C = e, M = t, A = r, _ = 1 & M, S = I(C), function e() {

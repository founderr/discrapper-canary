...
function L(e, t, r, a, n, s, o, i, u, l) {
  ...
  return function g() {
    ...
    if (a && (m = function(e, t, r, a) {
        for (var n = -1, s = e.length, o = r.length, i = -1, u = t.length, l = T(s - o, 0), c = Array(u + l), f = !a; ++i < u;) c[i] = t[i];
        for (; ++n < o;)(f || n < s) && (c[r[n]] = e[n]);
        for (; l--;) c[i++] = e[n++];
        return c
      }(m, a, n, d)), s && (m = function(e, t, r, a) {
        for (var n = -1, s = e.length, o = -1, i = r.length, u = -1, l = t.length, c = T(s - i, 0), f = Array(c + l), b = !a; ++n < c;) f[n] = e[n];
...
function G(e, t, r) {
  var a = function(e, t, r, a, n, s, o, i) {
    ...
    var l = a ? a.length : 0;
    if (!l && (t &= -97, a = n = void 0), o = void 0 === o ? o : T(V(o), 0), i = void 0 === i ? i : V(i), l -= n ? n.length : 0, 64 & t) {
      var c = a,
        f = n;
      a = n = void 0
    }
    var b = [e, t, r, a, n, c, f, s, o, i];
    if (e = b[0], t = b[1], r = b[2], a = b[3], n = b[4], !(i = b[9] = null == b[9] ? u ? 0 : e.length : T(b[9] - l, 0)) && 24 & t && (t &= -25), t && 1 != t) {
      ;
      if (8 == t || 16 == t) {
        ;
      ...
      var d, h, p, g, y, v, m, O, w, x, C, M, _, A, R, S = (C = e, M = t, _ = r, A = 1 & M, R = I(C), function e() {

...
function ei(e) {
  ...
  }), Z = (0, l.e7)([k.Z], () => k.Z.showKeybindIndicators), I = (0, l.e7)([R.default], () => R.default.getId()), S = (0, l.e7)([L.Z], () => L.Z.isLocalMute(i.id)), C = (0, l.e7)([y.Z], () => y.Z.getCurrentUserActiveStream()), v = (0, l.Wu)([y.Z], () => null != C ? y.Z.getViewerIds(C) : []), x = (0, g.Z)({
    userId: i.id,
    context: f
  }), T = (0, l.e7)([D.Z], () => D.Z.isPrioritySpeaker(i.id, f)), N = (0, l.e7)([y.Z], () => null != y.Z.getStreamForUser(i.id, _)), O = a.useMemo(() => null != C && C.ownerId !== i.id && v.includes(i.id), [C, i.id, v]);
    ...
    return (0, s.jsx)(z.ZP.Bar, {
      ...
      children: (0, s.jsxs)(z.ZP.Content, {
        ...
        children: [(0, s.jsxs)("div", {
          ...
          children: [(null == c ? void 0 : c.id) != null && c.id === (null == o ? void 0 : o.id) ? (0, s.jsx)(B.Z, {
...
function ea(e) {
  var t;
  let n = (0, l.e7)([P.Z, M.Z], () => M.Z.getChannel(P.Z.getVoiceChannelId())),
    i = (0, E.ZP)(n),
    o = function() {
      let [e] = (0, l.e7)([j.ZP, T.Z, P.Z, M.Z], () => {
        let e = M.Z.getChannel(P.Z.getVoiceChannelId());
        return null == e ? [
          [], -1
        ] : e.isGuildStageVoice() ? [T.Z.getMutableParticipants(e.id, N.pV.SPEAKER), T.Z.getParticipantsVersion(e.id)] : [j.ZP.getVoiceStatesForChannel(e), j.ZP.getVoiceStateVersion(e.getGuildId())]
      }, [], Y.Q), t = (0, l.e7)([R.default], () => R.default.getId()), {
    ...
    r = (0, l.e7)([y.Z], () => y.Z.getStreamerActiveStreamMetadata()),
    c = (0, l.e7)([Z.ZP, w.Z, b.Z], () => {
      var e;
      let t = (0, v.Z)(Z.ZP, w.Z);
      return null != t ? null === (e = b.Z.getGameByGameData(t)) || void 0 === e ? void 0 : e.id : null
    }),
    d = (0, m.q)(c),
    u = (0, l.cj)([Z.ZP, w.Z, y.Z, k.Z], () => {
      let e = (0, v.Z)(Z.ZP, w.Z),

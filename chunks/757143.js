var e = r(197187), i = r(926515), u = r(581031), o = r(527221), a = r(936940), c = r(24033), s = r(354848), f = r(35179), l = r(959318), h = r(552028), v = r(714050), p = r(676125), d = r(344597), x = r(995739), g = r(115726), I = r(651673), y = r(641236)('replace'), E = Math.max, b = Math.min, R = u([].concat), $ = u([].push), A = u(''.indexOf), k = u(''.slice), m = '$0' === 'a'.replace(/./, '$0'), C = !!/./[y] && '' === /./[y]('a', '$0');
o('replace', function (n, t, r) {
    var u = C ? '$' : '$0';
    return [
        function (n, r) {
            var e = p(this), u = f(n) ? void 0 : x(n, y);

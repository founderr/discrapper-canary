...
async function I(e) {
  ...
  if (null == p) {
    ...
    l()(null != e, "Could not find store listing for sku"), e.sku.type === m.SKUTypes.SUBSCRIPTION_GROUP && await (0, E.fetchAllSubscriptionListingsDataForApplication)(t, e.id)
  }
  ...
  let h = function() {
    let e = f.default.getWindow(m.PopoutWindowKeys.CHANNEL_CALL_POPOUT);

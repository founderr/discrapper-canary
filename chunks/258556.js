...
var ei = function(e) {
  ...
  } = (0, E.default)([...r, h.default.COLLECTIBLES_SHOP]), v = (0, u.useStateFromStores)([_.default], () => _.default.getLayers().includes(Q.Layers.COLLECTIBLES_SHOP)), L = (0, f.useHasAnyModalOpen)(), {
    onClose: B
  } = (0, Z.useCollectiblesShopRouting)(), W = (0, u.useStateFromStores)([k.default], () => k.default.getCurrentUser()), V = P.default.canUseCollectibles(W), z = (0, S.default)("shop_disable_cache"), Y = (0, S.default)("shop_include_unpublished"), {
    categories: X,
  ...
  }), eo = (0, u.useStateFromStores)([F.default], () => F.default.products), ec = s.useMemo(() => {
    let e = [...eo.values()].filter(e => e.type === c.CollectiblesItemType.PROFILE_EFFECT);
    return e.some(e => null == I.default.getProfileEffectById(e.items[0].id))
  }, [eo]);
  (0, N.default)(ec);
  let eu = (0, U.usePurchasedCategoriesSort)(X),
    {
      tallerCardsEnabled: ed
    } = (0, M.useCollectiblesShopTallerCardsExperiment)({
      location: "CollectiblesShop"
    }),
    ef = s.useRef(null),
  ...
  s.useEffect(() => {
    A.default.track(Q.AnalyticEvents.COLLECTIBLES_SHOP_VIEWED, {
      ...
      source: a,
      page_session_id: eg
    }), !V && A.default.track(Q.AnalyticEvents.PREMIUM_UPSELL_VIEWED, {
      type: ea.PremiumUpsellTypes.COLLECTIBLES_SHOP,
      location_stack: o
    })
  }, [V, o, a, eg]), s.useEffect(() => {
    ...
    if (!t || v || L) return;
    let e = e => {
      e.key === et.KeyboardEventKey.Escape && B()
    };
  ...
  return (0, l.jsxs)(i, {
    children: [(0, l.jsxs)("div", {
      ...
      children: [t ? null : (0, l.jsxs)(T.default, {
        className: n((0, R.getThemeClass)(eb), es.headerBar),
        toolbar: !0,
        ...
        children: (0, l.jsx)(g.default, {
          className: es.close,
          closeAction: v ? j.closeCollectiblesShop : B,
          keybind: "ESC"
        })
      }), (0, l.jsx)(m.AdvancedScroller, {
        className: n(es.shopScroll, {
          [es.shopScrollBackgroundPrimary]: ed
        }),
        ref: eC,
        onScroll: eh,
        children: (0, l.jsx)("div", {
          className: n(es.pageWrapper, {
            ...
            [es.pageWrapperBackgroundPrimary]: ed
          }),
          children: (0, l.jsxs)("main", {
            className: n(es.page, {
              [es.pageWithShopBannerHidden]: eS && !t
            }),
            children: [t ? (0, l.jsx)(y.default, {
              ...
              isFullScreen: t
            }), $ ? (0, l.jsx)(q.default, {}) : ei ? (0, l.jsx)(K.default, {
              onRetry: eE
            }) : (0, l.jsx)("div", {
              className: es.categories,
              children: eu.filter(e => {
                let {
                  products: t
                } = e;
                return t.length > 0
                ...
                isGiftEasterEggEnabled: em
              }, e.skuId))
            })]
          })
        })
      })]
    }), em && (0, l.jsx)(J.default, {})]
  })
}
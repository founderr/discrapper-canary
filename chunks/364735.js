...
(a = class extends r.PureComponent {
  get typeString() {
    ...
    else if (e instanceof c.AppleSourceRecord) return E.default.Types.APPLE;
  ...
  getLabel(e) {
    ...
    }) : e instanceof c.CashAppSourceRecord ? m.default.Messages.PAYMENT_SOURCE_CASH_APP_PAY : e instanceof c.AppleSourceRecord ? m.default.Messages.PAYMENT_SOURCE_APPLE : m.default.Messages.PAYMENT_SOURCE_UNKNOWN
  }
  renderDescription() {
    let {
      paymentSource: e,

...
var r = n(599295), i = n(634450), a = n(115953), o = n(568895);
function s(e) {
...
function g(e) {
    ...
    var i = (-1 === (t = window.navigator.userAgent).indexOf('Android 2.') && -1 === t.indexOf('Android 4.0') || -1 === t.indexOf('Mobile Safari') || -1 !== t.indexOf('Chrome') || -1 !== t.indexOf('Windows Phone')) && window.history && 'pushState' in window.history, a = -1 !== window.navigator.userAgent.indexOf('Trident'), l = e, E = l.forceRefresh, g = void 0 !== E && E, S = l.getUserConfirmation, A = void 0 === S ? p : S, N = l.keyLength, v = void 0 === N ? 6 : N, O = e.basename ? c(s(e.basename)) : '';
    function R(e) {
    ...
    function P(e) {
        M ? (M = !1, D()) : y.confirmTransitionTo(e, 'POP', A, function (t) {
            t ? D({
                ...
                var t = V.location, n = w.indexOf(t.key);
                -1 === n && (n = 0);
    ...
    var F = !1, V = {
            ...
            createHref: x,
            push: function (e, t) {
                var r = 'PUSH', a = _(e, t, C(), V.location);
                y.confirmTransitionTo(a, r, A, function (e) {
                    if (e) {
                        var t = x(a), o = a.key, s = a.state;
                        if (i) {
                            if (n.pushState({
                                    key: o,
                                    state: s
                                ...
                                var l = w.indexOf(V.location.key), u = w.slice(0, l + 1);
                                u.push(a.key), w = u, D({
                                    action: r,
                                    location: a
                                });
            ...
            replace: function (e, t) {
                var r = 'REPLACE', a = _(e, t, C(), V.location);
                y.confirmTransitionTo(a, r, A, function (e) {
                    if (e) {
                        var t = x(a), o = a.key, s = a.state;
                        if (i) {
...
function R(e) {
    ...
    var n = e, i = n.getUserConfirmation, a = void 0 === i ? p : i, l = n.hashType, E = e.basename ? c(s(e.basename)) : '', m = A[void 0 === l ? 'slash' : l], I = m.encodePath, T = m.decodePath;
    function g() {
        var e = T(v());
            ...
            D = null, function (e) {
                y ? (y = !1, C()) : R.confirmTransitionTo(e, 'POP', a, function (t) {
                    t ? C({
                        ...
                        var t = B.location, n = U.lastIndexOf(d(t));
                        -1 === n && (n = 0);
    ...
    var k = !1, B = {
            ...
            push: function (e, t) {
                var n = 'PUSH', r = _(e, void 0, void 0, B.location);
                R.confirmTransitionTo(r, n, a, function (e) {
                    if (e) {
                        var t = d(r), i = I(E + t);
                        if (v() !== i) {
                            D = t, a = i, window.location.hash = a;
                            var a, o = U.lastIndexOf(d(B.location)), s = U.slice(0, o + 1);
                            s.push(t), U = s, C({
                                action: n,
                                location: r
                            });
            ...
            replace: function (e, t) {
                var n = 'REPLACE', r = _(e, void 0, void 0, B.location);
                R.confirmTransitionTo(r, n, a, function (e) {
                    if (e) {
                        var t = d(r), i = I(E + t);
                        v() !== i && (D = t, O(i));
...
function y(e) {
    void 0 === e && (e = {});
    var t = e, n = t.getUserConfirmation, i = t.initialEntries, a = void 0 === i ? ['/'] : i, o = t.initialIndex, s = t.keyLength, l = void 0 === s ? 6 : s, u = f();
    function c(e) {
    ...
    var h = C(void 0 === o ? 0 : o, 0, a.length - 1), p = a.map(function (e) {
            return 'string' == typeof e ? _(e, void 0, E()) : _(e, void 0, e.key || E());
        });
    function m(e) {
        var t = C(I.index + e, 0, I.entries.length - 1), r = I.entries[t];
    ...
    var I = {
        ...
        createHref: d,
        push: function (e, t) {
            var r = 'PUSH', i = _(e, t, E(), I.location);
            u.confirmTransitionTo(i, r, n, function (e) {
                if (e) {
                    var t = I.index + 1, n = I.entries.slice(0);
        ...
        replace: function (e, t) {
            var r = 'REPLACE', i = _(e, t, E(), I.location);
            u.confirmTransitionTo(i, r, n, function (e) {

...
var i = n(392711), s = n.n(i), a = n(243814), r = n(570140), l = n(626135), o = n(81063), c = n(70956), d = n(996106), u = n(914946), _ = n(452426), h = n(186901), E = n(981631);
    ...
    [E.Etm.SET_ACTIVITY]: {
        ...
        handler(e) {
            ...
            if (![
                ...
                throw new d.Z({ errorCode: E.lTL.INVALID_COMMAND }, 'command not available from "'.concat(i.transport, '" transport'));
            if (null == a && h.He.IPC === i.transport)
                throw new d.Z({ errorCode: E.lTL.INVALID_COMMAND }, 'nonzero pid required');
            if (null == _)
                return r.Z.dispatch({
            ...
            let g = i.transport === h.He.POST_MESSAGE, p = (0, u.S5)(_, g);
            ...
            if ((null == A || A !== E.IIU.PLAYING && !g) && (_.type = E.IIU.PLAYING), null != f) {
                let e = s().values(f).filter(e => !!e);
                if (null != S && s().intersection(e, [S.id]).length > 0 && !I.includes(i.application.id))
                    throw new d.Z({ errorCode: E.lTL.INVALID_ACTIVITY_SECRET }, 'secrets cannot match the party id');
                if (s().uniq(e).length < e.length)
                    throw new d.Z({ errorCode: E.lTL.INVALID_ACTIVITY_SECRET }, 'secrets must be unique');
                if (null != N)
                    throw new d.Z({ errorCode: E.lTL.INVALID_ACTIVITY_SECRET }, 'secrets cannot currently be sent with buttons');
            }
            if (null != N && (_.metadata = { button_urls: N.map(e => e.url) }, _.buttons = N.map(e => e.label)), null != C)

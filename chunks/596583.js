...
var t = r(735250);
r(470079);
var a = r(120356), i = r.n(a), n = r(512722), l = r.n(n), C = r(442837), o = r(780384), d = r(481060), c = r(493683), _ = r(37234), x = r(410030), p = r(204197), h = r(819640), f = r(63063), u = r(51144), R = r(281494), m = r(276444), E = r(792451), j = r(814667), L = r(981631), g = r(689938), S = r(674471);
let A = (e, s) => {
                        ...
                        c ? (0, t.jsxs)(t.Fragment, {
                            children: [
                                ...
                                (0, t.jsx)(d.Text, {
                                    ...
                                    children: g.Z.Messages.REFERRAL_PROGRAM_CONFIRMATION_ERROR_PAGE.format({ userName: C })
                                })
                            ]
                        }) : (0, t.jsx)(d.Tooltip, {
...
s.Z = e => {
    ...
    let c = (0, x.Fg)(), _ = (0, o.ap)(c) ? j.Z : E.Z, p = g.Z.Messages.REFERRAL_PROGRAM_FRIEND_SELECT_RESENT_COMPLETE_HEADER, h = [...r.values()].filter(e => e === R.Fz.SUCCESS).length;
    return n > 0 && (p = g.Z.Messages.REFERRAL_PROGRAM_FRIEND_SELECT_COMPLETE_HEADER.format({ numReferrals: h })), 0 === h && (p = g.Z.Messages.REFERRAL_PROGRAM_CONFIRMATION_ERROR_PAGE_HEADER), (0, t.jsxs)('div', {

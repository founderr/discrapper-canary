...
s.Z = (e) => {
    ...
    return (
        n > 0 && (p = g.Z.Messages.REFERRAL_PROGRAM_FRIEND_SELECT_COMPLETE_HEADER.format({ numReferrals: h })),
        0 === h && (p = g.Z.Messages.REFERRAL_PROGRAM_CONFIRMATION_ERROR_PAGE_HEADER),
        (0, t.jsxs)('div', {

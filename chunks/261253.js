...
function c(e) {
	let { user: t, onClose: n, className: c } = e,
		...
		_ = (0, r.jsxs)('div', {
			...
			children: [(0, r.jsx)(i.PhoneCallIcon, { size: 'xs' }), ' ', l.Z.Messages.START_VOICE_CALL]
		}),
		E = (0, a.Z)({
			user: t,
			label: _,
			id: 'voice-call',
			onCall: () => {
				d({ action: 'VOICE_CALL' }), null == n || n();
			}
		}),
		f = (0, r.jsxs)('div', {
			className: u.menuItemLabel,
			children: [(0, r.jsx)(i.VideoIcon, { size: 'xs' }), ' ', l.Z.Messages.START_VIDEO_CALL]
		}),
		h = (0, a.Z)({
			user: t,
			label: f,

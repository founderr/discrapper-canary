...
let z = B.ZP.getEnableHardwareAcceleration(),
    ...
    K = l.memo(function (e) {
        let { channel: t, sectionId: r, userId: a, guildOwnerId: s } = e,
            ...
            C = (0, h.e7)([L.default], () => L.default.getUser(a)),
            x = (0, h.e7)([L.default], () => L.default.getCurrentUser()),
            _ = (null == C ? void 0 : C.id) === (null == x ? void 0 : x.id),
            v = (0, h.e7)([y.Z, P.Z], () => (_ ? P.Z.getStatus() : y.Z.getStatus(a, t.guild_id))),
            E = (0, h.e7)([y.Z], () => y.Z.isMobileOnline(a)),
            b = (0, h.e7)([y.Z, P.Z], () => (_ ? P.Z.getActivities() : y.Z.getActivities(a, t.guild_id))),
            R = (0, h.e7)([T.Z], () => T.Z.getAnyStreamForUser(a)),
            k = (0, c.JA)(a),
...
function X(e) {
    let { channel: t, guild: n } = e,
        ...
        { navigator: f, listRef: _ } = (function (e, t) {
        ...
        children: [
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, i.jsx)(R.Z, { className: F.emptyStateStars })
                ]
            }),
            (0, i.jsx)(p.Heading, {

...
let O = s.forwardRef(function(e, t) {
  ...
  }), H = (null === (n = D.userStatus) || void 0 === n ? void 0 : n.enrolledAt) != null, B = (null === (l = D.userStatus) || void 0 === l ? void 0 : l.completedAt) != null, V = s.useMemo(() => (0, S.hasQuestCollectibleRewards)(D.config), [D.config]), Y = L && M, W = (0, S.getQuestBarHeroAssetUrl)(D), K = (0, S.getQuestsInstructionsToWinReward)({
    quest: D
  }), z = s.useMemo(() => {

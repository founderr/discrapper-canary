...
function d(e) {
  ...
  let f = p.length > 1,
    T = null != A ? A.message : "";
  return (null != A && A instanceof r.BillingError && (A.code === l.ErrorCodes.CARD_DECLINED && f && (T += " ".concat(c.default.Messages.BILLING_ERROR_TRY_ANOTHER)), A.code === l.ErrorCodes.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED && (T = c.default.Messages.GIFT_CODE_SMITE_REJECT_HELP_TEXT), A.code === u.AbortCodes.BILLING_NON_REFUNDABLE_PAYMENT_SOURCE && (T = c.default.Messages.GIFT_CODE_PAYMENT_SOURCE_INVALID)), null == A) ? null : (0, n.jsx)("div", {
    className: d,

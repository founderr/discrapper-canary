...
let a = {
        ...
        [s.Q5.OPEN_SHARE_MOMENT_DIALOG]: {
            response: void 0,
            request: e => (0, s.C5)(e.object({ mediaUrl: e.string().required().max(1024) }))
        },
        [s.Q5.AUTHENTICATE]: {
            request: e => (0, s.C5)(e.object({ access_token: e.string().allow(null).optional() })),
            response: e => e.object({
        ...
        [s.Q5.GET_ACTIVITY_INSTANCE_CONNECTED_PARTICIPANTS]: {
            request: void 0,
            response: e => e.object({ participants: e.array().items(r(e).keys({ nickname: e.string().description('Server nickname. Not unique.') }).required()).required() }).required()
        }
    }, r = e => e.object({

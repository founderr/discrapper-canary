...
function H(e) {
    ...
    if (g.QL.has(e.type)) {
        var t, n;
        return (t = e), m.ldS.has(t.type) ? null : JSON.stringify({ type: null !== (n = g.QL.get(t.type)) && void 0 !== n ? n : null });
    }
    return V(e);
}
async function Z() {
...
async function en(e) {
    ...
    if ((null == n ? void 0 : null === (t = n.body) || void 0 === t ? void 0 : t.status) === g.Py.FAILED) throw L('payment failed');

...
var r = n(392711), i = n.n(r), a = n(433517), o = n(147913), s = n(536442), l = n(810788), u = n(19780), c = n(531578);
function d(e, t, n) {
...
function p(e) {
    if (null != e.storageKey) {
        ...
        if (null != t && Date.now() - t < e.cooldown)
            return !1;
    }
    return !0;
}
class m extends o.Z {
    possiblyShowFeedbackModal(e, t) {
        if (!!function (e) {
                ...
                if (__OVERLAY__)
                    return !1;
                let n = E[e], r = null !== (t = n.eligibilityChecks) && void 0 !== t ? t : [];
                return [
                    p,
                    h,
                    f
                ].every(e => e(n)) && r.every(e => e(n));
            }(e) && (null == this.feedbackTypeToShow || !(c.b5[this.feedbackTypeToShow] < c.b5[e])))
            this.feedbackTypeToShow = e, this.showFeedbackModalDebounced(t);
    }
    constructor(...e) {
        super(...e), d(this, 'feedbackTypeToShow', null), d(this, 'showFeedbackModalDebounced', i().debounce(e => {

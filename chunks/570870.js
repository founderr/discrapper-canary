var i = t(735250), r = t(470079), a = t(512722), s = t.n(a), o = t(442837), l = t(481060), u = t(10718), d = t(667204), c = t(826298), E = t(17165), _ = t(276022), I = t(430824), T = t(594174), N = t(689079), S = t(689938), p = t(768075);
n.Z = e => {
    let n, {
            commandType: t,
            commandTargetId: a,
            ...
            onHeightUpdate: O,
            context: h
        } = e, M = (0, o.e7)([I.Z], () => I.Z.getGuild(null != A ? A : f.guild_id)), Z = (0, o.e7)([T.default], () => T.default.getUser(a)), m = (0, _.Z)({
            user: Z,
            ...
            loading: v
        } = u.wi(f, { commandType: t }, { limit: N.lr }), {sections: C} = r.useMemo(() => {
            let e = {};
            return g.forEach(n => {
                e[n.id] = n;
            }), { sections: e };
        }, [g]), G = r.useRef(v.current);
    r.useEffect(() => {
    ...
    let y = r.useCallback(e => {
        ...
        let n = C[e.applicationId], t = null != n ? (0, c.ky)(n) : void 0;

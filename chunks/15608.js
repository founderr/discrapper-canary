...
var a = s(735250),
	...
	u = s(441365);
function m(e) {
	let { guildTemplate: t, onClick: s, autoFocus: l } = e,
		o = n.useCallback(() => {
			s(t);
		}, [t, s]);
	return (0, a.jsx)(i.Z, {
...
function C(e) {
	let { onClose: t, onBack: s, onChooseTemplate: n, directoryGuildName: i } = e,
		r = (0, c.Pp)();
			...
			(0, a.jsxs)(l.ModalHeader, {
				...
				children: [
					(0, a.jsx)(l.Heading, {
						...
						children: d.Z.Messages.HUB_CREATE_OR_ADD_GUILD_TITLE.format({ guildName: i })
					}),
					(0, a.jsx)(l.Text, {

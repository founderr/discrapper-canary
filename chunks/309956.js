...
let i = (e, t) => {
    ...
    let o = (e) => new Promise((t) => setTimeout(t, e)),
        c = r.useCallback(
            async (e) => {
                e && (i(a.f7.OUT), await o(1.1 * a.lb)), e && l(a.f7.IN), i(a.f7.HIDDEN), null != t.current && t.current.scrollTo({ to: 0 }), l(a.f7.VISIBLE);
            },
            [t]
        );
    return {
        ...
        transitionToFeed: r.useCallback(() => {
            null != t.current && t.current.scrollTo({ to: 0 }), l(a.f7.HIDDEN), i(a.f7.VISIBLE);
        }, [t])
    };
};

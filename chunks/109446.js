...
var i = n(735250), l = n(470079), r = n(392711), a = n.n(r), s = n(442837), o = n(481060), c = n(99690), u = n(359110), d = n(601070), h = n(91159), p = n(488131), _ = n(496675), f = n(306680), m = n(594174), g = n(768581), C = n(709054), I = n(981631), E = n(124368), N = n(689938), x = n(542326);
function S(e) {
    let {channel: t} = e, r = (0, s.Wu)([
            ...
            return a()(d.Z.getActiveJoinedThreadsForParent(t.guild_id, t.id)).values().map(e => e.channel).concat(a().values(d.Z.getActiveUnjoinedThreadsForParent(t.guild_id, t.id))).filter(t => !(t.id in e) && _.Z.can(I.Plq.VIEW_CHANNEL, t)).sort((e, t) => {
                let n = f.ZP.lastMessageId(e.id), i = f.ZP.lastMessageId(t.id);

...
location: 'SimplifiedUserProfileModalHeader'
  }), [$, ee] = i.useState(), [en, et] = i.useState(), es = e => {
ee(e.interactionType), et(e.interactionSourceType);
  }, ei = (0, x.ZP)(n.id, W ? z : void 0), eo = (0, x.ZP)(n.id, z), el = (0, o.e7)([I.Z], () => I.Z.getRelationshipType(n.id)), er = i.useMemo(() => null != z ? {
[z]: [n.id]
  } : {}, [
z,
n.id
...
[eI, e_] = i.useState(!1),
[ef, eE] = i.useState(!1),
em = () => (null == eo ? void 0 : eo.guildId) == null ? null : (null == ei ? void 0 : ei.guildId) != null ? (0, s.jsx)(l.MenuItem, {
...
children: (0, s.jsx)(f.Mt, {
  ...
  children: (0, s.jsxs)(l.ModalRoot, {
    ...
    children: [
      ...
      (null == ei ? void 0 : ei.profileEffectId) != null && (0, s.jsx)(u.Z, {

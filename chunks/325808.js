...
var n = s(735250);
s(470079);
var a = s(120356), i = s.n(a), r = s(442837), o = s(481060), l = s(846027), c = s(230711), d = s(825209), _ = s(131951), E = s(285952), u = s(153124), T = s(358085), I = s(962100), S = s(981631), N = s(689938), C = s(972633), m = s(331651);
let A = !T.isPlatformEmbedded, h = (0, u.hQ)();
function g(e) {
    let {value: t} = e;
    t === S.pM4.PUSH_TO_TALK && A && (0, o.openModalLazy)(async () => {
        let {default: e} = await Promise.resolve().then(s.bind(s, 468026));
        return t => (0, n.jsx)(e, {
                    ...
                    (0, n.jsx)(E.Z.Child, {
                        ...
                        children: (0, n.jsx)(o.FormItem, {
                            ...
                            children: (0, n.jsx)(d.Z, {
                                defaultValue: a,
                                onChange: e => l.Z.setMode(s, { shortcut: e })
                            })
                        })
                    }),
                    (0, n.jsx)(E.Z.Child, {
                        ...
                        children: (0, n.jsxs)(o.FormItem, {
                            children: [
                                ...
                                (0, n.jsx)(o.Slider, {
                                    initialValue: u,
                                    onValueChange: e => l.Z.setMode(s, { delay: e }),
                                    onValueRender: O,
                                    maxValue: S.qhL,
                                    'aria-labelledby': h
                                })
...
function R() {
    let e = (0, r.e7)([_.Z], () => _.Z.getMode()), t = [
            {

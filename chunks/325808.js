...
function R(e) {
    ...
    return (
        (s =
            I.isPlatformEmbedded || t !== C.pM4.PUSH_TO_TALK
                ? (0, n.jsx)(l.FormText, {
                      type: l.FormText.Types.DESCRIPTION,
                      className: r()(m.pttToolsMessage, g.marginBottom8),
                      children: A.Z.Messages.USER_SETTINGS_VOICE_ADD_MULTIPLE.format({ onClick: () => d.Z.setSection(C.oAB.KEYBINDS) })
                  })
                : (0, n.jsx)(l.FormText, {
                      type: l.FormText.Types.DESCRIPTION,
...
function x() {
    ...
    return (0, n.jsxs)(n.Fragment, {
        children: [
            ...
            s === C.pM4.PUSH_TO_TALK && (0, n.jsx)(R, { inputMode: s })
        ]
    });
}

...
messageId: x,
roleId: G
  }), Y = (0, a.e7)([E.Z], () => null != U ? E.Z.getGuild(U) : null), j = (0, a.e7)([_.ZP], () => null != U ? _.ZP.getMember(U, t.id) : null), W = i.useMemo(() => null != U ? {
[U]: [t.id]
  } : {}, [
U,
t.id
...
B
  ...
  let [er, ei] = i.useState(), [ea, es] = i.useState(), [eo, el] = i.useState(), eu = e => {
        ...
        children: [
          ...
          (0, r.jsx)(s.Popout, {
            renderPopout: e => {
              ...
              return null == ea ? (0, r.jsx)(r.Fragment, {}) : (0, r.jsx)(A.Z, {
                user: t,
                guildId: U,
                channelId: w,
                profileType: b.y0.BITE_SIZE,

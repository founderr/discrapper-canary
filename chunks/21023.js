  ...
  let r = {
      0: {
        ...
        column1: (0, i.jsx)(i.Fragment, {
          children: (0, i.jsx)(S, {
            text: c.default.formatPriceString(e, E.SubscriptionIntervalTypes.MONTH)
          })
        }),
        column2: (0, i.jsx)(i.Fragment, {
          children: (0, i.jsx)(S, {
            text: s ? a : c.default.formatPriceString(t, E.SubscriptionIntervalTypes.MONTH)
          })
        }),
        withBottomBorder: !0
      },
      ...
      5: {
        ...
        column1: (0, i.jsx)(S, {
          text: (0, c.getMaxFileSizeForPremiumType)(E.PremiumTypes.TIER_0)
        }),
        column2: (0, i.jsx)(S, {
          text: (0, c.getMaxFileSizeForPremiumType)(E.PremiumTypes.TIER_2)
        })
      },
      6: {
        label: (0, i.jsx)(f, {
      ...
      7: {
        label: (0, i.jsx)(f, {
          text: T.default.Messages.PREMIUM_TIER_0_DESKTOP_MARKETING_COMPARISON_TABLE_ROW_LABEL_BOOSTS.format({
            ...
            percentageOff: (0, d.formatPercent)(l.default.locale, E.GUILD_BOOST_COST_FOR_PREMIUM_USER_DISCOUNT_PERCENT / 100)
          })
        }),
        column1: (0, i.jsx)(m, {
          includes: !1
      ...
      17: {
        label: (0, i.jsx)(f, {
          text: T.default.Messages.PREMIUM_TIER_0_DESKTOP_MARKETING_COMPARISON_TABLE_ROW_LABEL_MESSAGE_LENGTH.format({
            maxChars: R.MAX_MESSAGE_LENGTH_PREMIUM
          })
        }),
        column1: (0, i.jsx)(m, {
          includes: !1
      ...
      22: {
        label: (0, i.jsx)(f, {
          text: T.default.Messages.REFERRAL_PROGRAM_PLAN_COMPARISON_ROW
        }),
        column1: (0, i.jsx)(m, {
          includes: !1
        }),

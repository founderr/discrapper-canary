...
function g(e, t) {
    for (var n, r; ; ) {
        if (e.lookahead < d) {
            if ((S(e), e.lookahead < d && 0 === t)) return 1;
...
(t.deflateInit = function (e, t) {
                    ...
                    : 3 === i.strategy
                      ? (function (e, t) {
                            for (var n, r, i, s, o = e.window; ; ) {
                                if (e.lookahead <= 258) {
                                    if ((S(e), e.lookahead <= 258 && 0 === t)) return 1;
                                    if (0 === e.lookahead) break;
                                }
    ...
    (t.deflateSetDictionary = function (e, t) {
        ...
        for (1 === o && (e.adler = s(e.adler, t, _, 0)), n.wrap = 0, _ >= n.w_size && (0 === o && (f(n.head), (n.strstart = 0), (n.block_start = 0), (n.insert = 0)), (d = new i.Buf8(n.w_size)), i.arraySet(d, t, _ - n.w_size, n.w_size, 0), (t = d), (_ = n.w_size)), l = e.avail_in, u = e.next_in, c = e.input, e.avail_in = _, e.next_in = 0, e.input = t, S(n); n.lookahead >= 3; ) {

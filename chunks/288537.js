...
function m(e, t) {
    a._tr_flush_block(e, e.block_start >= 0 ? e.block_start : -1, e.strstart - e.block_start, t), (e.block_start = e.strstart), p(e.strm);
}
function g(e, t) {
...
function v(e, t) {
    ...
    do {
        if (u[(n = t) + s] !== p || u[n + s - 1] !== h || u[n] !== u[a] || u[++n] !== u[a + 1]) continue;
        (a += 2), n++;
        do;
        while (u[++a] === u[++n] && u[++a] === u[++n] && u[++a] === u[++n] && u[++a] === u[++n] && u[++a] === u[++n] && u[++a] === u[++n] && u[++a] === u[++n] && u[++a] === u[++n] && a < _);
        if (((r = 258 - (_ - a)), (a = _ - 258), r > s)) {
...
function b(e, t) {
    for (var n, r, i; ; ) {
        ...
        if (((n = 0), e.lookahead >= 3 && ((e.ins_h = ((e.ins_h << e.hash_shift) ^ e.window[e.strstart + 3 - 1]) & e.hash_mask), (n = e.prev[e.strstart & e.w_mask] = e.head[e.ins_h]), (e.head[e.ins_h] = e.strstart)), (e.prev_length = e.match_length), (e.prev_match = e.match_start), (e.match_length = 2), 0 !== n && e.prev_length < e.max_lazy_match && e.strstart - n <= e.w_size - d && ((e.match_length = v(e, n)), e.match_length <= 5 && (1 === e.strategy || (3 === e.match_length && e.strstart - e.match_start > 4096)) && (e.match_length = 2)), e.prev_length >= 3 && e.match_length <= e.prev_length)) {
            ...
            if (((r = a._tr_tally(e, 0, e.window[e.strstart - 1])) && m(e, !1), e.strstart++, e.lookahead--, 0 === e.strm.avail_out)) return 1;
...
r = [
    new T(0, 0, 0, 0, function (e, t) {
        ...
        for (65535 > e.pending_buf_size - 5 && (n = e.pending_buf_size - 5); ; ) {
            if (e.lookahead <= 1) {
                if ((I(e), 0 === e.lookahead && 0 === t)) return 1;
                if (0 === e.lookahead) break;
            }
            (e.strstart += e.lookahead), (e.lookahead = 0);
            var r = e.block_start + n;
            if (((0 === e.strstart || e.strstart >= r) && ((e.lookahead = e.strstart - r), (e.strstart = r), m(e, !1), 0 === e.strm.avail_out)) || (e.strstart - e.block_start >= e.w_size - d && (m(e, !1), 0 === e.strm.avail_out))) return 1;
        }
...
function C(e, t, n, r, a, s) {
    if (!e) return -2;
    var o = 1;
    if ((-1 === t && (t = 6), r < 0 ? ((o = 0), (r = -r)) : r > 15 && ((o = 2), (r -= 16)), a < 1 || a > 9 || 8 !== n || r < 8 || r > 15 || t < 0 || t > 9 || s < 0 || s > 4)) return f(e, -2);
    8 === r && (r = 9);
    var l = new y();
...
(t.deflateInit = function (e, t) {
    ...
    (t.deflate = function (e, t) {
        ...
        if (((i.strm = e), (n = i.last_flush), (i.last_flush = t), 42 === i.status)) {
            if (2 === i.wrap) (e.adler = 0), g(i, 31), g(i, 139), g(i, 8), i.gzhead ? (g(i, (i.gzhead.text ? 1 : 0) + (i.gzhead.hcrc ? 2 : 0) + (i.gzhead.extra ? 4 : 0) + (i.gzhead.name ? 8 : 0) + (i.gzhead.comment ? 16 : 0)), g(i, 255 & i.gzhead.time), g(i, (i.gzhead.time >> 8) & 255), g(i, (i.gzhead.time >> 16) & 255), g(i, (i.gzhead.time >> 24) & 255), g(i, 9 === i.level ? 2 : i.strategy >= 2 || i.level < 2 ? 4 : 0), g(i, 255 & i.gzhead.os), i.gzhead.extra && i.gzhead.extra.length && (g(i, 255 & i.gzhead.extra.length), g(i, (i.gzhead.extra.length >> 8) & 255)), i.gzhead.hcrc && (e.adler = o(e.adler, i.pending_buf, i.pending, 0)), (i.gzindex = 0), (i.status = 69)) : (g(i, 0), g(i, 0), g(i, 0), g(i, 0), g(i, 0), g(i, 9 === i.level ? 2 : i.strategy >= 2 || i.level < 2 ? 4 : 0), g(i, 3), (i.status = 113));
            else {
                var n,
                    i,
                    s,
                    ...
                    u = (8 + ((i.w_bits - 8) << 4)) << 8,
                    c = -1;
                (u |= (c = i.strategy >= 2 || i.level < 2 ? 0 : i.level < 6 ? 1 : 6 === i.level ? 2 : 3) << 6), 0 !== i.strstart && (u |= 32), (u += 31 - (u % 31)), (i.status = 113), E(i, u), 0 !== i.strstart && (E(i, e.adler >>> 16), E(i, 65535 & e.adler)), (e.adler = 1);
            }
        }
        if (69 === i.status) {
            if (i.gzhead.extra) {
                for (s = i.pending; i.gzindex < (65535 & i.gzhead.extra.length) && (i.pending !== i.pending_buf_size || (i.gzhead.hcrc && i.pending > s && (e.adler = o(e.adler, i.pending_buf, i.pending - s, s)), p(e), (s = i.pending), i.pending !== i.pending_buf_size)); ) {
        ...
        if (73 === i.status) {
            if (i.gzhead.name) {
                s = i.pending;
                do {
                    if (i.pending === i.pending_buf_size && (i.gzhead.hcrc && i.pending > s && (e.adler = o(e.adler, i.pending_buf, i.pending - s, s)), p(e), (s = i.pending), i.pending === i.pending_buf_size)) {
                        l = 1;
                        break;
                    }
                    (l = i.gzindex < i.gzhead.name.length ? 255 & i.gzhead.name.charCodeAt(i.gzindex++) : 0), g(i, l);
                } while (0 !== l);
        ...
        if (91 === i.status) {
            if (i.gzhead.comment) {
                ...
                do {
                    ...
                    (l = i.gzindex < i.gzhead.comment.length ? 255 & i.gzhead.comment.charCodeAt(i.gzindex++) : 0), g(i, l);
                } while (0 !== l);
                i.gzhead.hcrc && i.pending > s && (e.adler = o(e.adler, i.pending_buf, i.pending - s, s)), 0 === l && (i.status = 103);
            } else i.status = 103;
        }
        if ((103 === i.status && (i.gzhead.hcrc ? (i.pending + 2 > i.pending_buf_size && p(e), i.pending + 2 <= i.pending_buf_size && (g(i, 255 & e.adler), g(i, (e.adler >> 8) & 255), (e.adler = 0), (i.status = 113))) : (i.status = 113)), 0 !== i.pending)) {
            if ((p(e), 0 === e.avail_out)) return (i.last_flush = -1), 0;
        } else if (0 === e.avail_in && _(t) <= _(n) && 4 !== t) return f(e, -5);
        ...
        if (0 !== e.avail_in || 0 !== i.lookahead || (0 !== t && 666 !== i.status)) {
            var d =
                2 === i.strategy
                    ? (function (e, t) {
                          for (var n; ; ) {
                              if (0 === e.lookahead && (I(e), 0 === e.lookahead)) {
                                  if (0 === t) return 1;
                                  break;
                              }
                              if (((e.match_length = 0), (n = a._tr_tally(e, 0, e.window[e.strstart])), e.lookahead--, e.strstart++, n && (m(e, !1), 0 === e.strm.avail_out))) return 1;
                          }
                          if (((e.insert = 0), 4 === t)) return (m(e, !0), 0 === e.strm.avail_out) ? 3 : 4;
                          return e.last_lit && (m(e, !1), 0 === e.strm.avail_out) ? 1 : 2;
                      })(i, t)
                    : 3 === i.strategy
                      ? (function (e, t) {
                            for (var n, r, i, s, o = e.window; ; ) {
                                if (e.lookahead <= 258) {
                                    if ((I(e), e.lookahead <= 258 && 0 === t)) return 1;
                                    if (0 === e.lookahead) break;
                                }
                                ...
                                if ((e.match_length >= 3 ? ((n = a._tr_tally(e, 1, e.match_length - 3)), (e.lookahead -= e.match_length), (e.strstart += e.match_length), (e.match_length = 0)) : ((n = a._tr_tally(e, 0, e.window[e.strstart])), e.lookahead--, e.strstart++), n && (m(e, !1), 0 === e.strm.avail_out))) return 1;
                            }
                            if (((e.insert = 0), 4 === t)) return (m(e, !0), 0 === e.strm.avail_out) ? 3 : 4;
                            return e.last_lit && (m(e, !1), 0 === e.strm.avail_out) ? 1 : 2;
                        })(i, t)
            ...
            if (2 === d && (1 === t ? a._tr_align(i) : 5 !== t && (a._tr_stored_block(i, 0, 0, !1), 3 === t && (h(i.head), 0 === i.lookahead && ((i.strstart = 0), (i.block_start = 0), (i.insert = 0)))), p(e), 0 === e.avail_out)) return (i.last_flush = -1), 0;
        }
        return 4 !== t ? 0 : i.wrap <= 0 ? 1 : (2 === i.wrap ? (g(i, 255 & e.adler), g(i, (e.adler >> 8) & 255), g(i, (e.adler >> 16) & 255), g(i, (e.adler >> 24) & 255), g(i, 255 & e.total_in), g(i, (e.total_in >> 8) & 255), g(i, (e.total_in >> 16) & 255), g(i, (e.total_in >> 24) & 255)) : (E(i, e.adler >>> 16), E(i, 65535 & e.adler)), p(e), i.wrap > 0 && (i.wrap = -i.wrap), 0 !== i.pending ? 0 : 1);
    }),
    ...
    (t.deflateSetDictionary = function (e, t) {
        ...
        for (1 === o && (e.adler = s(e.adler, t, f, 0)), n.wrap = 0, f >= n.w_size && (0 === o && (h(n.head), (n.strstart = 0), (n.block_start = 0), (n.insert = 0)), (d = new i.Buf8(n.w_size)), i.arraySet(d, t, f - n.w_size, n.w_size, 0), (t = d), (f = n.w_size)), l = e.avail_in, u = e.next_in, c = e.input, e.avail_in = f, e.next_in = 0, e.input = t, I(n); n.lookahead >= 3; ) {
            ...
            while (--a);
            (n.strstart = r), (n.lookahead = 2), I(n);
        }

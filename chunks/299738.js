...
function N(e) {
  ...
  let {
    ...
    onClose: f,
    onNext: T
  } = e, g = (0, c.useEmitAppealIngestionEvent)(), C = null !== (t = null == s ? void 0 : s.explainer_link) && void 0 !== t ? t : "", p = null != s && null != s.flagged_content && s.flagged_content.length > 0, m = (0, r.capitalizeText)(null == s ? void 0 : s.description), L = !N && !I, h = (0, d.useIsSafetyHubDisplayGuildViolationsEnabled)("classification_evidence"), M = null != s && ((0, r.isGuildClassification)(s) && h || p);

...
function S(e) {
  ...
  let {
    ...
    onClose: x,
    onNext: f
  } = e, T = (0, r.useEmitAppealIngestionEvent)(), g = null !== (t = null == s ? void 0 : s.explainer_link) && void 0 !== t ? t : "", C = null != s && null != s.flagged_content && s.flagged_content.length > 0, p = (0, d.capitalizeText)(null == s ? void 0 : s.description), m = !S && !N, L = C && !(0, d.isGuildClassification)(s);

...
function S(e) {
  ...
  let {
    ...
    onClose: x,
    onNext: f
  } = e, T = (0, r.useEmitAppealIngestionEvent)(), g = null !== (t = null == s ? void 0 : s.explainer_link) && void 0 !== t ? t : "", m = null != s && null != s.flagged_content && s.flagged_content.length > 0, C = (0, d.capitalizeText)(null == s ? void 0 : s.description), p = !S && !N, L = m && null == s.guild_metadata;

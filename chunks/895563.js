...
var t = i(735250);
i(470079);
var r = i(392711), a = i.n(r), l = i(442837), u = i(481060), s = i(984933), o = i(853856), d = i(117984), c = i(593214), Z = i(362658), h = i(981631), M = i(689938);
function f(n, e) {
...
function _(n) {
    let e = (0, l.e7)([s.ZP], () => s.ZP.getChannels(h.I_8))[h.d4z.GUILD_CATEGORY], {isFavoritesPerk: i} = (0, Z.z)('58e21a_1'), {notifyFavoriteAdded: r} = (0, c.up)();
    if (!(0, c.li)(n))
        return null;

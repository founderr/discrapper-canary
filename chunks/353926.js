        ...
        null != n &&
            n.forEach((e) => {
                ...
                R[t] = {
                    ...
                    aaMode: 1 === _,
                    triggerDebuggingEnabled: k(1 === p, t),
                    assignmentSource: r,
                    sessionId: i,
                    loadedFromCache: s,
                    fingerprint: a
        ...
        (y = (function () {
            ...
            !(function () {
                ...
                for (let e of r)
                    for (let t in e) {
                        let n = e[t];
                        null == n || (n.type !== h.xY.USER && n.type !== h.xY.GUILD) || null == n.bucket || !0 !== n.override || n.fromCookie ? (delete e[t], (a = !0)) : n.type === h.xY.USER ? (D[t] = n) : (L[t] = n);
                    }
                let s = (0, u._S)();
                for (let e in s)
                    (D[e] = {

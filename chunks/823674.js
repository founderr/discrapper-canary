...
function er(e) {
  let {
    ...
    let U = (0, Y.canReportMessage)(n),
      k = (0, q.default)(n, t, x),
      B = !t.isSystemDM() && (0, K.default)(n, f) && h && !E,
      {
      ...
      G = t.type === et.ChannelTypes.GUILD_ANNOUNCEMENT && null != d && d.hasFeature(et.GuildFeatures.NEWS) && (F || x) && n.type === et.MessageTypes.DEFAULT,
      V = t.getGuildId(),

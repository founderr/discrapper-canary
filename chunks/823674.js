...
function er(e) {
  let {
    ...
    let w = (0, K.canReportMessage)(a),
      ...
      $ = (0, u.useStateFromStores)([m.default], () => null != m.default.getMessageReminders().find(e => e.messageId === a.id)),
      en = (0, ee.default)(),

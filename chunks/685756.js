...
class D extends f.Z {
    ...
    handleHello(e) {
        ...
        } else (this.heartbeatInterval = e.heartbeat_interval * this.heartbeatIntervalModifier), !I.isPlatformEmbedded && (this.heartbeatInterval = Math.min(O, null !== (n = this.heartbeatInterval) && void 0 !== n ? n : NaN));

...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(873546), l = n(442837), u = n(481060), c = n(100527), d = n(906732), _ = n(366030), E = n(71619), f = n(340797), h = n(98278), p = n(869765), m = n(243317), I = n(621853), T = n(484459), g = n(204197), S = n(740492), A = n(430824), N = n(496675), v = n(594174), O = n(176278), R = n(768581), C = n(585483), y = n(630388), D = n(74538), L = n(276554), b = n(421399), M = n(453687), P = n(318713), U = n(304176), w = n(47930), x = n(981631), G = n(689938), k = n(475525), B = n(255963);
function F(e) {
    let {
        avatarSrc: t,
...
function j(e) {
    let {
            ...
            let {
                    ...
                    showAvatarPopout: y
                } = a, [D, L] = i.useState(!1), {analyticsLocations: b} = (0, d.ZP)(c.Z.AVATAR), M = (0, l.e7)([S.ZP], () => {
                    var e;
                    ...
                    var e, t;
                    return H && null == U.avatar && (null === (e = h.application) || void 0 === e ? void 0 : e.icon) != null ? null !== (t = R.ZP.getApplicationIconURL({
                        id: h.application.id,
            ...
            return (i.useEffect(() => {
                if (null != I)
                    return C.S.subscribeKeyed(x.LPv.ANIMATE_CHAT_AVATAR, ''.concat(I, ':').concat(w), L), () => void C.S.unsubscribeKeyed(x.LPv.ANIMATE_CHAT_AVATAR, ''.concat(I, ':').concat(w), L);
            }, [
                w,
                I
            ]), m && !M) ? void 0 : null != _ && null != y ? (0, r.jsx)(d.Gt, {
                value: b,
    ...
    let eu = V(e, K, el), ec = (0, M.XX)(t, B), ed = (0, M.Dv)(t), e_ = Z ? ''.concat(ec) : ''.concat(ec, ' ').concat(ed), eE = (null == n ? void 0 : n.state) === p.Y.LOADED ? (0, M.Gq)(t) : void 0;
    return (0, r.jsx)(H, {
        message: t,
        avatar: $,

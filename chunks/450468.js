...
var n, a, i = s(735250), r = s(470079), o = s(512722), l = s.n(o), c = s(442837), d = s(780384), _ = s(481060), E = s(355467), u = s(179360), T = s(100527), I = s(906732), S = s(431369), N = s(210887), C = s(78839), m = s(285952), A = s(74538), h = s(689938), g = s(634554);
async function O(e, t, s, n) {
    await (0, u.bG)(s), await (0, E.Mg)(e, { items: (0, A.MY)(e, t) }, n);
}
function p(e) {
    let {
            ...
            onNext: n,
            onClose: a
        } = e, [o, E] = r.useState(!1), u = (0, c.e7)([N.Z], () => N.Z.theme), {analyticsLocations: T} = (0, I.ZP)();
        ...
        children: [
            (0, i.jsxs)(_.ModalHeader, {
                ...
                children: [
                    ...
                    (0, i.jsx)(_.ModalCloseButton, { onClick: t })
                ]
            }),
            (0, i.jsxs)(_.ModalContent, {
                ...
                children: [
                    ...
                    (0, i.jsx)('div', { children: h.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_INVENTORY_UNCANCEL_CONFIRM_DESCRIPTION })
                ]
            }),
...
function x(e) {
    let t, {
            ...
            transitionState: n,
            onClose: a
        } = e, {analyticsLocations: o} = (0, I.ZP)(T.Z.GUILD_BOOST_UNCANCELLATION_MODAL);
    r.useEffect(() => {
        !C.ZP.hasFetchedSubscriptions() && (0, E.jg)();
    }, []);
    let l = (0, c.e7)([C.ZP], () => C.ZP.getPremiumTypeSubscription()), [d, u] = r.useState(1);
    if (null == l)
        t = (0, i.jsx)(_.ModalContent, { children: (0, i.jsx)(_.Spinner, {}) });
    else
        switch (d) {
        case 1:
            t = (0, i.jsx)(p, {

...
class E extends n.Store {
  ...
  handleLocalMessagesLoaded(e) {
    ...
    if (null != t) {
      var a;
      (0, l.requireSortedDescending)(e.messages), this.data(t.guild_id).putNew(e.channelId, null !== (a = e.messages[0]) && void 0 !== a ? a : null, c)
    }
  }
  ...
  handleMessagePreviewsLocallyLoaded(e) {
    ...
    let t = this.data(e.guildId);
    for (let [a, n] of e.messages) !t.has(a) && t.put(a, n, c);
    t.localNeeded = !1
  }
  handleLogout(e) {
    this.guilds.clear()

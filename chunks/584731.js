n(47120);
var i = n(445346), s = n(570140), a = n(513418), r = n(710845), l = n(57132), o = n(592125), c = n(375954), d = n(625236);
function u(e, t, n) {
...
let _ = -1 / 0, E = new r.Z('MessagePreviewStore');
class h extends i.y {
    isLatest(e, t) {
        var n;
    ...
    handleMessageDelete(e) {
        ...
        if ((null === (t = this.data(i)) || void 0 === t ? void 0 : t.messageId(e.channelId)) === e.id) {
            let t = c.Z.getMessages(e.channelId), n = t.hasMoreAfter ? null : t.last();
    ...
    handleMessageUpdate(e) {
        ...
        if (!(0, l.cn)())
            return;
        let n = null !== (t = e.guildId) && void 0 !== t ? t : null, i = e.message.channel_id, s = e.message.id;
        if (null == i || null == s)
            return !1;
        let a = this.data(n);

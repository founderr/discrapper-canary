var s = n(735250), a = n(470079), r = n(120356), i = n.n(r), l = n(91192), o = n(481060), c = n(209613), d = n(151827), _ = n(785681), u = n(485664), E = n(880257), T = n(631885), I = n(895328), R = n(568671), C = n(419821), p = n(367515), g = n(250285), A = n(292352), N = n(689938), m = n(277421), f = n(549856), S = n(926895);
function h(e) {
    let {
        header: t,
        description: n,
                    ...
                    (0, s.jsxs)('div', {
                        ...
                        children: [
                            (0, s.jsx)(o.Heading, {
                                ...
                                children: (0, s.jsx)(o.HeadingLevel, { children: N.Z.Messages.FAMILY_CENTER_REQUESTS_LINKING_BANNER_HEADER_PARENT })
                            }),
                            (0, s.jsx)(o.Text, {
                                variant: 'text-sm/medium',
                                color: 'text-muted',
                                className: f.marginBottom20,
                                children: N.Z.Messages.FAMILY_CENTER_REQUESTS_LINKING_BANNER_DESCRIPTION_PARENT
                            })
                        ]
                    }),
                    (0, s.jsx)('img', {
                        ...
                        src: S,
                        alt: N.Z.Messages.FAMILY_CENTER_REQUESTS_LINKING_BANNER_TEEN_ASSET_ALT
                    })
                ]
            }),
            (0, s.jsxs)('div', {
            ...
            (0, s.jsxs)('div', {
                children: [
                    (0, s.jsx)(o.Heading, {
                        className: f.marginBottom8,
                        variant: 'heading-xl/medium',
                        children: (0, s.jsx)(o.HeadingLevel, { children: N.Z.Messages.FAMILY_CENTER_REQUESTS_LINKING_BANNER_HEADER_TEEN })
                    }),
                    (0, s.jsx)(o.Text, {
                        variant: 'text-sm/medium',
                        color: 'text-muted',
                        className: f.marginBottom20,
                        children: N.Z.Messages.FAMILY_CENTER_REQUESTS_LINKING_BANNER_DESCRIPTION_TEEN.format({ link: 'https://support.discord.com/hc/articles/14155060633623' })
                    }),
                    e ? null : (0, s.jsx)(R.Z, {})
                ]
            }),
...
let O = () => {
        ...
        return (0, s.jsx)(s.Fragment, {
            children: t.length > 0 ? (0, s.jsx)(b, {
                ...
                children: [
                    ...
                    (0, s.jsx)('div', {
                        className: m.box,
                        children: (0, s.jsx)(I.Z, { text: N.Z.Messages.FAMILY_CENTER_ACCEPTED_REQUESTS_EMPTY_DESCRIPTION })
                    })
                ]
            })
        });
    }, P = () => {
        let e = (0, T.VM)(), t = (0, E.Z)() ? A.AG : A.i0, n = (0, _.o)(N.Z.Messages.FAMILY_CENTER_REQUESTS_LIMIT_INFO_TEEN.format({ maxConnections: t }), N.Z.Messages.FAMILY_CENTER_REQUESTS_LIMIT_INFO_PARENT.format({ maxConnections: t }));
        ...
        className: i()(m.__invalid_helpLineInfo, f.marginTop20),
        children: [
            (0, s.jsx)(o.Heading, {
                className: m.supportHeader,
                variant: 'heading-sm/semibold',
                children: (0, s.jsx)(o.HeadingLevel, { children: N.Z.Messages.FAMILY_CENTER_HELP_LINE_HEADER })
            }),
            (0, s.jsx)(o.Text, {
                variant: 'text-xs/medium',
                color: 'text-muted',
                children: N.Z.Messages.FAMILY_CENTER_HELP_LINE_CONTENT.format({ helpLink: 'https://support.discord.com/hc/articles/7925648993943-Crisis-Text-Line' })
            })
        ]
    }) : null, v = () => {
        let e = (0, T.mq)(A.ne.PENDING), t = (0, _.o)(N.Z.Messages.FAMILY_CENTER_PENDING_REQUESTS_TITLE_TEEN.format({ count: e.length }), N.Z.Messages.FAMILY_CENTER_PENDING_REQUESTS_TITLE_PARENT.format({ count: e.length }));

...
function M(e) {
  let {
    ...
    return null == i ? null : (0, n.jsx)(g.default, {
      userId: i.id,
      isLast: r,
      children: () => t === p.UserLinkStatus.ACTIVE ? (0, n.jsx)(C.UserLinkAcceptedRequestRow, {
        user: i
...
let O = () => {
    let e = (0, f.default)(),
      ...
      s = e ? p.MAX_PARENT_TO_TEEN_ACTIVE_CONNECTIONS : p.MAX_TEEN_TO_PARENT_ACTIVE_CONNECTIONS,
      a = {
        count: t.length,
        max: s
      },
      l = (0, c.useAgeSpecificText)(A.default.Messages.FAMILY_CENTER_ACCEPTED_REQUESTS_TITLE_TEEN.format(a), A.default.Messages.FAMILY_CENTER_ACCEPTED_REQUESTS_TITLE_PARENT.format(a));
  ...
  L = () => {
    let e = (0, _.useHasMaxConnections)(),
      t = (0, f.default)() ? p.MAX_PARENT_TO_TEEN_ACTIVE_CONNECTIONS : p.MAX_TEEN_TO_PARENT_ACTIVE_CONNECTIONS,

...
let h = 1 * o.default.Millis.HOUR,
  ...
  g = new r.default("AutoUpdateManager");
class S {
  destroy() {
  ...
  async _requestNewUpdaterBootstrap() {
    ...
    try {
      ...
      g.log("Failed to bootstrap new updater:", e), this._handleNativeUpdateNotAvailable(), d.default.captureException(e)
    }
  }
  _emitCallbacks() {
  ...
  constructor(e = h) {
    ...
    f(this, "updateAvailable", !1), f(this, "hasNativeUpdate", !1), f(this, "_checkInterval", void 0), f(this, "_callbacks", []), f(this, "_bootstrapper", null), f(this, "checkForUpdates", function() {
      ...
      this._handleCheckingForUpdates(), a.HTTP.get({
        ...
        if (null == e.body || "395ed711cbc7b96b5a6bec1849460b5b7cc3b57c" === e.body.hash) return this._handleUpdateNotAvailable();

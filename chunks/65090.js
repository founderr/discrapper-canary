...
let t, n, {
  ...
  g = o.map((e, t) => (0, r.jsx)(a.ZP.Generic, {
    onClick: I,
    onHover: m,
...
return null != u ? a.insertText(function(e, t, n) {
  return o.ZP.hasSameRoleAsUsername(t, e) ? ''.concat(d.ME).concat(e.tag) : ''.concat(d.ME).concat(l.ZP.getUserTag(e, {

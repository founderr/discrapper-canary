...
var t = i(735250);
i(470079);
var l = i(442837), s = i(481060), a = i(889161), u = i(471253), o = i(924301), r = i(482241), d = i(765305), c = i(689938);
function Z(e, n, i) {
    let {canManageGuildEvent: Z} = (0, a.XJ)(null != i ? i : n), E = (0, l.e7)([o.ZP], () => o.ZP.isActive(e)), M = (0, l.e7)([o.ZP], () => o.ZP.getGuildScheduledEvent(e), [e]), _ = Z(M);
    if (null == e || !_ || !E || (null == M ? void 0 : M.entity_type) === d.WX.EXTERNAL)
        return null;
    let N = () => {
    ...
    return (0, t.jsx)(s.MenuItem, {
        ...
        action: function () {
            (0, s.openModal)(e => (0, t.jsx)(s.ConfirmModal, {
                ...e,

...
var r = n(470079), i = n(442837), a = n(889161), o = n(675478), s = n(430824), l = n(496675), u = n(594174), c = n(74538), d = n(709054), _ = n(164878), E = n(178106), f = n(763296), h = n(697426), p = n(549771), m = n(710111);
function I(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = e.map(e => ({
            type: h.vB.SOUND,
            sound: e
        }));
...
function S(e) {
    ...
    return r.useMemo(() => {
        ...
        return n ? (g(e, m), {
            ...
            if (null == t)
                return;
            let o = null !== (a = r.get(t.id)) && void 0 !== a ? a : [], s = I(o), l = o.length < t.getMaxSoundboardSlots() && n, u = 0 === s.length;
            (l || u) && !i && s.push({
                type: h.vB.ADD_SOUND,
                guild: t
            });

...
var u = new r.default("GuildEmojis"),
  s = function() {
    var e, t, n;
    ...
    function r() {
      ...
      ! function(e, t) {
        ...
        GUILD_EMOJIS_UPDATE: function(e, t) {
          return o.handleGuildEmojisUpdate(e, t)
        },
    ...
    return e = r, t = [{
      ...
      value: function(e) {
        ...
        return (t = function() {
          ...
          return function(e, t) {
            ...
            switch (i.label) {
              case 0:
                return t = performance.now(), [4, o.default.emojis(e).getMapEntries()];
              case 1:
      ...
      value: function(e, t) {
        ...
        e.promisesForBackgroundSyncToWaitOn.push(Promise.all(e.emojis.map(function(e) {
          ...
          "full" === e.dataMode ? (u.verbose("Replacing ".concat(e.entities.length, " emojis for ").concat(e.guildId)), n.replace(e.guildId, e.entities, t)) : (e.updatedEntities.length > 0 || e.deletedEntityIds.length > 0) && (u.verbose("Updating ".concat(e.updatedEntities.length, " and deleting ").concat(e.deletedEntityIds.length, " emojis for ").concat(e.guildId)), n.update(e.guildId, e.updatedEntities, e.deletedEntityIds, t))
        })))
      }
    }, {
      ...
      value: function(e, t, n) {
        o.default.emojisTransaction(n).replaceAll(e, t)
      }
    }, {
      key: "delete",
      value: function(e, t) {
        o.default.emojisTransaction(t).delete(e)
      }
    }, {
      key: "update",
      value: function(e, t, n, r) {
        var i = o.default.emojisTransaction(r);
        i.putAll(e, t);
        var a = !0,
          u = !1,
          s = void 0;

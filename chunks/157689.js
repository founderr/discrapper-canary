...
function r(e, t, n, r) {
  let a = (0, i.iA)(t, e),
    ...
    u = (0, i.Uq)(a.endDate, n.endDate) ? null : n.endDate;
  if (null != r) return (0, i.Y4)(n, a) ? s.Z.deleteGuildEventException(e.guild_id, e.id, r.event_exception_id) : s.Z.updateGuildEventException({

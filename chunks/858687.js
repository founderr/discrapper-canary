...
var a = t(735250), l = t(470079), i = t(481060), r = t(493683), u = t(699516), o = t(594174), s = t(933557), d = t(689938);
function c(e, n) {
    let c = l.useCallback(() => {
        let l = (0, s.F6)(e, o.default, u.Z), c = d.Z.Messages.LEAVE_GROUP_DM_TITLE.format({ name: l }), _ = d.Z.Messages.LEAVE_GROUP_DM_BODY.format({ name: l });

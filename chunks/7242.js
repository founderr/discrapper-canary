...
className: n,
onClose: p
  } = e, I = (0, i.e7)([u.default], () => u.default.getId()), m = (0, i.e7)([
c.Z,
_.Z
  ], () => {
var e;
return c.Z.getChannel(null === (e = _.Z.getVoiceStateForUser(I)) || void 0 === e ? void 0 : e.channelId);
  }), T = null == m ? void 0 : m.isPrivate(), g = (0, i.e7)([d.Z], () => d.Z.can(f.Plq.CREATE_INSTANT_INVITE, m));
  if (null == m || T || !g || t.bot)
return null;
  let S = async () => {
await o.Z.createInvite(null == m ? void 0 : m.id, {
  max_uses: 1,
  unique: !0

...
function g(e) {
  ...
  return l.useEffect(() => {
    ...
    children: [!n && c.length < S.MAX_NUMBER_OF_ONBOARDING_PROMPTS_IN_ONBOARDING ? (0, a.jsxs)(o.Clickable, {
      className: N.addPrompt,
      onClick: () => (0, I.editGuildOnboardingPrompts)(t, [...d, (0, S.getEmptyPrompt)(!0)], !1),
    ...
    if (s.length > S.MAX_NUMBER_OF_ONBOARDING_PROMPTS_IN_ONBOARDING) {
      d.default.show({
        ...
        body: m.default.Messages.ONBOARDING_QUESTIONS_SAVE_TOO_MANY_PROMPTS_IN_ONBOARDING.format({
          numQuestions: S.MAX_NUMBER_OF_ONBOARDING_PROMPTS_IN_ONBOARDING
        })
      });
      return
  ...
  return null == u ? null : (0, a.jsxs)(a.Fragment, {
    children: [l ? null : (0, a.jsxs)(a.Fragment, {
      ...
      children: [R.map((e, t) => (0, a.jsx)(f.default, {
        ...
        onPromptDragReset: O,
        onPromptDragComplete: p
      }, e.id)), h.length < S.MAX_NUM_PROMPTS ? (0, a.jsxs)(o.Clickable, {
        className: N.addPrompt,
        onClick: () => (0, I.editGuildOnboardingPrompts)(u, [...h, (0, S.getEmptyPrompt)(!1)], !1),
        children: [(0, a.jsx)(_.default, {
          className: N.plusIcon,
          width: 20,
          height: 20

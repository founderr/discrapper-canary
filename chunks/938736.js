...
switch (n) {
  ...
  case 1:
    ...
    if (s.redeemed <= 1)
      return u.Z.Messages.REFERRAL_INCENTIVE_FRIEND_PASSES_CONVERT_GET_INCENTIVE.format(a);
    return u.Z.Messages.REFERRAL_INCENTIVE_FRIEND_PASSES_REDEEMED.format(a);
  case 2:
    return s.redeemed === E ? u.Z.Messages.REFERRAL_INCENTIVE_FRIEND_PASS_COUNTDOWN_HAS_BEGUN.format({
      learnMoreLink: 'PLACEHOLDER',
      numberOfTimerPeriods: '',
      timePeriodInterval: u.Z.Messages.GIFT_CONFIRMATION_NITRO_TIME_FRAME_MONTHS.format({
        time: 6
      })
...
return t ? u.Z.Messages.REFERRAL_PROGRAM_PROGRESS_BAR_SUBHEADER_ALL_SHARED_NO_REFRESH.format({
  helpdeskArticle: a
}) : n ? u.Z.Messages.REFERRAL_PROGRAM_PROGRESS_BAR_SUBHEADER_AT_LEAST_ONE_SHARED.format({
  numFriends: E - s,
  helpdeskArticle: a
...
(0, _.B)(e, !s);
let {
  isEligibleForIncentive: i,
  isQualifiedForIncentive: l
} = (0, r.cj)([o.Z], () => ({

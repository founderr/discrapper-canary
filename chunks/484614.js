var s, o = t(735250), r = t(470079), a = t(120356), l = t.n(a), i = t(846519), c = t(481060), u = t(572004), d = t(689938), E = t(87390);
function _(e, n, t) {
...
class I extends (s = r.PureComponent) {
    ...
    render() {
        let {
                ...
                className: s,
                inputClassName: r
            } = this.props, {mode: a} = this.state, i = a === c.CopyInput.Modes.SUCCESS ? d.Z.Messages.COPIED : t;
        return e ? (0, o.jsxs)('div', {
            className: l()(s, a),
            children: [
                (0, o.jsx)(c.TextInput, {
                    value: n,

var r, s = n(735250), a = n(470079), o = n(120356), l = n.n(o), i = n(846519), d = n(481060), c = n(572004), u = n(689938), p = n(71062);
function m(e, t, n) {
...
class C extends (r = a.PureComponent) {
    ...
    render() {
        let {
                ...
                className: r,
                inputClassName: a
            } = this.props, {mode: o} = this.state, i = o === d.CopyInput.Modes.SUCCESS ? u.Z.Messages.COPIED : n;

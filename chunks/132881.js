...
function S(e) {
  let {
    ...
    messageCount: v
  } = _, x = new Intl.NumberFormat(p.default.getLocale()).format(I), N = new Intl.NumberFormat(p.default.getLocale()).format(T), A = new Intl.NumberFormat(p.default.getLocale()).format(v), M = a.useCallback(async e => {
    if (null == S) return;
  ...
  return (0, l.jsx)(o.FormItem, {
    ...
    children: (0, l.jsxs)(h.UserModInfoItemContainer, {
      children: [(0, l.jsx)(h.UserModInfoItem, {
        ...
        description: I === f.HAS_NO_COUNT ? (0, l.jsx)(o.Spinner, {
        ...
        description: T === f.HAS_NO_COUNT ? (0, l.jsx)(o.Spinner, {
          type: o.SpinnerTypes.SPINNING_CIRCLE,
          className: E.loadingSpinner
        }) : (0, l.jsx)(o.Text, {
          variant: "text-sm/semibold",
        ...
        description: v === f.HAS_NO_COUNT ? (0, l.jsx)(o.Spinner, {
          type: o.SpinnerTypes.SPINNING_CIRCLE,
          className: E.loadingSpinner
        }) : (0, l.jsx)(o.Text, {
          variant: "text-sm/semibold",

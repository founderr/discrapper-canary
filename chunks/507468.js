...
t.Z = {
    init() {
        (o.Z[u.yP.PRELOADED_USER_SETTINGS] = l.Z), (o.Z[u.yP.FRECENCY_AND_FAVORITES_SETTINGS] = r.Z), s.Z.subscribe('CONNECTION_OPEN', _), s.Z.subscribe('USER_SETTINGS_PROTO_ENQUEUE_UPDATE', h), s.Z.subscribe('USER_SETTINGS_PROTO_LOAD_IF_NECESSARY', E), s.Z.subscribe('APP_STATE_UPDATE', m);
    }
};

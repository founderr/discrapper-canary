...
function w(i, e) {
  ...
  } = (0, I.ZP)(), X = (0, l.e7)([y.default], () => y.default.getCurrentUser()), q = (0, l.e7)([j.ZP], () => j.ZP.getSelfEmbeddedActivities()), z = (0, l.Wu)([h.Z], () => h.Z.getActivities().filter(i => null != i.application_id && !(null == q ? void 0 : q.has(i.application_id)))), B = (0, l.Wu)([m.Z], () => null != e ? m.Z.getActivities(e.id, null == i ? void 0 : i.getGuildId()) : [], [e, i]), H = (0, l.Wu)([j.ZP], () => {
  ...
  }, [e, i]), K = (0, J.Z)(), Q = (0, l.e7)([C.Z], () => null == i || i.isPrivate() || C.Z.can(k.Plq.SEND_MESSAGES, i), [i]), $ = (0, l.Wu)([O.Z], () => [...B.map(i => null != i.application_id && O.Z.getState(i.application_id, k.mFx.JOIN) === k.OcF.LOADING), ...H.map(i => O.Z.getState(i.applicationId, k.mFx.JOIN) === k.OcF.LOADING)], [B, H]), ii = (0, u.Z)([...B.filter(i => (null == i ? void 0 : i.application_id) != null).map(i => i.application_id), ...H.map(i => i.applicationId)]), ie = null == i ? void 0 : i.id, it = (0, l.Wu)([E.Z, v.Z, S.Z, A.Z, b.Z, f.Z, C.Z], () => [...B.map(i => (0, U.Z)({
    user: null != e ? e : X,
    activity: i,
  ...
  })], [B, ii, ie, X, H, e]), il = (0, l.Wu)([c.Z, T.default], () => B.map(i => i.type === k.IIU.LISTENING && null != e ? (0, _.Z)(c.Z, T.default, e, i) : void 0), [e, B]), ia = (0, s.O)();
  if (!Q) return null;
  let id = (n, t) => {
    ...
    io = (l, d) => {
      ...
      return null == o || null == s ? void 0 : null != e ? g.pu({
        ...
        let {
          default: e
        } = await Promise.all([n.e("49237"), n.e("99387"), n.e("7654"), n.e("1187"), n.e("53700")]).then(n.bind(n, 560114));
        return n => (0, t.jsx)(e, {
          ...n,
          guild: s,
          channel: o,
  ...
  return null == q || q.forEach(n => {
    let l = (null == e ? void 0 : e.id) != null && n.userIds.has(null == e ? void 0 : e.id),
      d = C.Z.can(k.Plq.CREATE_INSTANT_INVITE, i),
      o = ii.find(i => (null == i ? void 0 : i.id) === n.applicationId);
    if (null != n.launchId && !l && !!d && null != o) iu.push((0, t.jsx)(a.MenuItem, {
    ...
    if (n.type === k.IIU.PLAYING && (0, Y.Z)(n, k.xjy.JOIN) && null != n.session_id && null != n.application_id) {
      ...
      } else iu.push((0, t.jsx)(a.MenuItem, {
        id: "ask-to-join",
    ...
    var n;
    let l = i.userIds.has(null !== (n = null == X ? void 0 : X.id) && void 0 !== n ? n : k.lds),
      d = e + B.length,
      o = $[d] || l,
      s = W.Z.Messages.EMBEDDED_ACTIVITIES_JOIN_ACTIVITY;

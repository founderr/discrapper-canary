var r, i, a, s, o, l, u, c, d, _, E, f, h, p, I, m, T, g, S, A, N, O, R, v, C, y, D, L, b, M, P, U;
n.d(t, {
    B8: function () {
        return d;
    },
    ...
    ((y = _ || (_ = {}))[(y.ACTION_ROW = 1)] = 'ACTION_ROW'),
    (y[(y.BUTTON = 2)] = 'BUTTON'),
    (y[(y.STRING_SELECT = 3)] = 'STRING_SELECT'),
    (y[(y.INPUT_TEXT = 4)] = 'INPUT_TEXT'),
    (y[(y.USER_SELECT = 5)] = 'USER_SELECT'),
    (y[(y.ROLE_SELECT = 6)] = 'ROLE_SELECT'),
    (y[(y.MENTIONABLE_SELECT = 7)] = 'MENTIONABLE_SELECT'),
    (y[(y.CHANNEL_SELECT = 8)] = 'CHANNEL_SELECT'),
    (y[(y.TEXT = 10)] = 'TEXT'),

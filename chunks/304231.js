...
function T(e) {
    let {selectedGame: t} = e, n = (0, E.GN)(e => e.selectedGames, r.Z), a = s.useMemo(() => new Set(n), [n]), l = (0, I.J)({ selectedGame: t }), o = s.useCallback(e => E.GN.getState().setSelectedGames(Array.from(e)), []);
    return (0, i.jsx)(c.Z, {
...
function S() {
    let e = (0, E.GN)(e => e.selectedPlaystyle, r.Z), t = s.useCallback(e => E.GN.getState().setSelectedPlaystyle(e), []);
    return (0, i.jsx)(d.Z, {

...
t.inflateReset = p, t.inflateReset2 = h, t.inflateResetKeep = f, t.inflateInit = function(e) {
  ...
  var n, d, f, p, h, v, m, y, x, w, S, k, E, _, M, D, C, P, T, A, R, I, O, j, L = 0,
    N = new o.Buf8(4),
    F = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
  if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return -2;
  12 === (n = e.state).mode && (n.mode = 13), h = e.next_out, f = e.output, m = e.avail_out, p = e.next_in, d = e.input, v = e.avail_in, y = n.hold, x = n.bits, w = v, S = m, I = 0;
  n: for (;;) switch (n.mode) {
    case 1:
      if (0 === n.wrap) {
        n.mode = 13;
    ...
    case 5:
      ...
      n.mode = 6;
    case 6:
      if (1024 & n.flags && ((k = n.length) > v && (k = v), k && (n.head && (R = n.head.extra_len - n.length, !n.head.extra && (n.head.extra = Array(n.head.extra_len)), o.arraySet(n.head.extra, d, p, k, R)), 512 & n.flags && (n.check = a(n.check, d, k, p)), v -= k, p += k, n.length -= k), n.length)) break n;
      n.length = 0, n.mode = 7;
    case 7:
      if (2048 & n.flags) {
        if (0 === v) break n;
        k = 0;
        do R = d[p + k++], n.head && R && n.length < 65536 && (n.head.name += String.fromCharCode(R)); while (R && k < v);
        if (512 & n.flags && (n.check = a(n.check, d, k, p)), v -= k, p += k, R) break n
    ...
    case 8:
      if (4096 & n.flags) {
        if (0 === v) break n;
        k = 0;
        do R = d[p + k++], n.head && R && n.length < 65536 && (n.head.comment += String.fromCharCode(R)); while (R && k < v);
        if (512 & n.flags && (n.check = a(n.check, d, k, p)), v -= k, p += k, R) break n
    ...
    case 10:
      ...
      e.adler = n.check = l(y), y = 0, x = 0, n.mode = 11;
    case 11:
    ...
    case 16:
      if (k = n.length) {
        ...
        o.arraySet(f, d, p, k, h), v -= k, p += k, m -= k, h += k, n.length -= k;
        break
      }
      n.mode = 12;
      break;
    ...
    case 21:
      if (v >= 6 && m >= 258) {
        e.next_out = h, e.avail_out = m, e.next_in = p, e.avail_in = v, n.hold = y, n.bits = x, c(e, S), h = e.next_out, f = e.output, m = e.avail_out, p = e.next_in, d = e.input, v = e.avail_in, y = n.hold, x = n.bits, 12 === n.mode && (n.back = -1);
        break
      }
    ...
    case 27:
      if (n.wrap) {
        ...
        if (S -= m, e.total_out += S, n.total += S, S && (e.adler = n.check = n.flags ? a(n.check, f, S, h - S) : s(n.check, f, S, h - S)), S = m, (n.flags ? y : l(y)) !== n.check) {

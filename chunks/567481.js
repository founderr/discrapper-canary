    ...
    [g.Etm.OPEN_OVERLAY_ACTIVITY_INVITE]: {
        ...
        handler(e) {
            ...
            return (0, r.h7)(a, o).then(() => {
                if (l(), o)
                    throw new _.Z({ errorCode: g.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure user does have have privacy enabled.');
            });
        }
    },
    [g.Etm.OPEN_OVERLAY_GUILD_INVITE]: {
        ...
        handler(e) {
            ...
            return l.Z.resolveInvite(t, 'Game SDK').then(e => {
                ...
                if (null == t)
                    throw new _.Z({ errorCode: g.lTL.INVALID_INVITE }, 'Invalid invite id: '.concat(i));
                let {
                    context: s,
                    lock: r
                } = (0, I.s0)(n);

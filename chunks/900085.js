...
class H extends r.PureComponent {
    ...
    componentDidUpdate(e, t) {
        let {
                ...
                query: i
            } = this.state, {selectedIndex: l} = this.props, {current: r} = this.scrollerRef;
        if (null != r)
            i !== t.query ? r.scrollTo({ to: 0 }) : n && l >= 0 && r.scrollToIndex({
                section: 0,
                row: l,
                padding: 10
            });
    ...
    renderResults() {
        let {query: e} = this.state, {results: t} = this.props;
    ...
    constructor(...e) {
        super(...e), O(this, 'scrollerRef', r.createRef()), O(this, 'inputRef', r.createRef()), O(this, '_listId', (0, Z.hQ)()), O(this, 'state', {
            ...
            case _.h8.VOICE_CHANNEL:
                let i = t.record, r = C.Z.getGuild(i.getGuildId());
                if (null == r)
                    return;
                switch (i.type) {
            ...
            let {
                    ...
                    query: n
                } = this.state, {results: i} = this.props;
            !1 === t && this.setState({ mouseFocusDisabled: !0 });
            let l = e.key.toLowerCase(), {selectedIndex: r} = this.props;
            switch (l) {
            case 'escape':
            ...
            switch (n.type) {
            case _.h8.HEADER:
                return (0, l.jsx)(S.h4, { children: n.record.text }, ''.concat(n.type, '-').concat(n.record.id));
            case _.h8.TEXT_CHANNEL:
                return (0, l.jsx)(U, {
                    id: this.getRowId(t),
                    focused: i >= 0 && t === i,

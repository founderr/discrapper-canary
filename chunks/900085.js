            ...
            children: [
                ...
                (0, l.jsx)('div', {
                    ...
                    children: (0, l.jsx)(u.Anchor, {
                        href: S.Z.getArticleURL(A.BhN.QUICK_SWITCHER_TUTORIAL),
...
let O = c.ZP.connectStores([I.ZP, _.Z], (e) => {
    ...
    G = c.ZP.connectStores([x.default], (e) => {
        let { guild: t } = e;
...
class V extends r.PureComponent {
    ...
    focusNode(e) {
        E.S.dispatch(A.CkL.QUICKSWITCHER_RESULT_FOCUS, { node: e });
    }
    getRowId(e) {
    ...
    renderProtip() {
        return (0, l.jsx)(g.Z, {
            ...
            children: P.intl.format(P.t.wukqXV, {
                userSymbolHook: (e, t) => H(t, f.xQ.USER, P.intl.string(P.t.GQRCGh)),
                ...
                helpdeskArticle: S.Z.getArticleURL(A.BhN.QUICK_SWITCHER_TUTORIAL)
            })
        });
    }
    renderTutorial() {

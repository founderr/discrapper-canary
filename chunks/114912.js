! function(r, n) {
  ...
  Y.VERSION = "0.7.36", Y.BROWSER = U([l, h, s]), Y.CPU = U([d]), Y.DEVICE = U([c, p, f, g, y, m, v, _, b]), Y.ENGINE = Y.OS = U([l, h]), typeof e !== o ? (t.exports && (e = t.exports = Y), e.UAParser = Y) : typeof define === i && define.amd ? define(function() {
    return Y

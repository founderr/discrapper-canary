...
function S() {
  ...
  I.overwriteHistory(a().mapValues(n, e => ({
    ...e,
...
c(h, "displayName", "ApplicationCommandFrecencyStore"), c(h, "persistKey", "ApplicationCommandFrecencyV2"), t.default = new h(o.default, {

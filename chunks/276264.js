...
t.Z = function(e) {
  ...
  let {
    ...
    tabIndex: er,
    itemProps: es
  } = e, eo = null == G ? void 0 : G.id, ea = p.ZP.useName(G), el = (null === (t = S.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === eo, eu = r.useRef(null), [e_, ec] = r.useState(!1), [ed, eE] = r.useState(null), {

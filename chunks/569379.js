...
var s = n(470079), o = n(338545), r = n(442837), a = n(410030), i = n(706454), l = n(930153), c = n(113434), d = n(497505), u = n(918701), p = n(585500), x = n(566078), m = n(46140), g = n(689938);
function C(e) {
    var t, n;
...
function f(e, t) {
    var n;
    let s = (0, c.B6)(x.r.build(e.config).rewardsExpireAt), o = (0, c.Rf)(e), r = (null === (n = e.userStatus) || void 0 === n ? void 0 : n.completedAt) != null, a = (0, c.z)(e), i = (0, p.D)({
            quest: e,
    ...
    if (r)
        return g.Z.Messages.QUESTS_CLAIM_BY_DATE.format({ expirationDate: s });
    if (t)
        return i;

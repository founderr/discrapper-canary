...
function f(e) {
  var t, n;
  let a = (0, i.useStateFromStores)([l.default], () => l.default.locale),
...
function E(e, t) {
  ...
  let s = (0, o.useQuestFormattedDate)(e.config.rewardCodeExpiresAt),
    i = a.useMemo(() => (0, u.calculatePercentComplete)(e), [e]);
  return (null === (n = e.userStatus) || void 0 === n ? void 0 : n.completedAt) != null ? c.default.Messages.QUESTS_CLAIM_BY_DATE.format({
    ...
    useV2Variants: !0
  }) : i > 0 ? (0, u.getContextualEntrypointHeading)(e) : c.default.Messages.QUESTS_COMPLETION_PROGRESS_NOT_STARTED_SUBTITLE
}

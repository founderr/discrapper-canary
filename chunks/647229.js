...
function u(e, t, n) {
    ...
    var h = o[1],
        ...
        m = o[3],
        I = o[4];
    for (d = 0; d < _; d++) (o = e[i >>> 24] ^ h[(a >> 16) & 255] ^ p[(s >> 8) & 255] ^ m[255 & t] ^ r[E]), (u = e[a >>> 24] ^ h[(s >> 16) & 255] ^ p[(t >> 8) & 255] ^ m[255 & i] ^ r[E + 1]), (c = e[s >>> 24] ^ h[(t >> 16) & 255] ^ p[(i >> 8) & 255] ^ m[255 & a] ^ r[E + 2]), (t = e[t >>> 24] ^ h[(i >> 16) & 255] ^ p[(a >> 8) & 255] ^ m[255 & s] ^ r[E + 3]), (E += 4), (i = o), (a = u), (s = c);
    for (d = 0; 4 > d; d++) (f[n ? 3 & -d : d] = (I[i >>> 24] << 24) ^ (I[(a >> 16) & 255] << 16) ^ (I[(s >> 8) & 255] << 8) ^ I[255 & t] ^ r[E++]), (o = i), (i = a), (a = s), (s = t), (t = o);
    return f;
}
function c(e, t) {
    var n,

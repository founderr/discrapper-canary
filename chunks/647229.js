...
function u(e, t, n) {
    ...
    var h = s[1],
        ...
        m = s[3],
        I = s[4];
    for (d = 0; d < _; d++) (s = e[i >>> 24] ^ h[(a >> 16) & 255] ^ p[(o >> 8) & 255] ^ m[255 & t] ^ r[E]), (u = e[a >>> 24] ^ h[(o >> 16) & 255] ^ p[(t >> 8) & 255] ^ m[255 & i] ^ r[E + 1]), (c = e[o >>> 24] ^ h[(t >> 16) & 255] ^ p[(i >> 8) & 255] ^ m[255 & a] ^ r[E + 2]), (t = e[t >>> 24] ^ h[(i >> 16) & 255] ^ p[(a >> 8) & 255] ^ m[255 & o] ^ r[E + 3]), (E += 4), (i = s), (a = u), (o = c);
    for (d = 0; 4 > d; d++) (f[n ? 3 & -d : d] = (I[i >>> 24] << 24) ^ (I[(a >> 16) & 255] << 16) ^ (I[(o >> 8) & 255] << 8) ^ I[255 & t] ^ r[E++]), (s = i), (i = a), (a = o), (o = t), (t = s);
    return f;
}
function c(e, t) {
    var n,
        ...
        E = a[6],
        f = a[7];
    for (n = 0; 64 > n; n++) 16 > n ? (r = t[n]) : ((r = t[(n + 1) & 15]), (i = t[(n + 14) & 15]), (r = t[15 & n] = (((r >>> 7) ^ (r >>> 18) ^ (r >>> 3) ^ (r << 25) ^ (r << 14)) + ((i >>> 17) ^ (i >>> 19) ^ (i >>> 10) ^ (i << 15) ^ (i << 13)) + t[15 & n] + t[(n + 9) & 15]) | 0)), (r = r + f + ((d >>> 6) ^ (d >>> 11) ^ (d >>> 25) ^ (d << 26) ^ (d << 21) ^ (d << 7)) + (E ^ (d & (_ ^ E))) + o[n]), (f = E), (E = _), (_ = d), (d = (c + r) | 0), (c = u), (u = l), (s = (r + (((l = s) & u) ^ (c & (l ^ u))) + ((l >>> 2) ^ (l >>> 13) ^ (l >>> 22) ^ (l << 30) ^ (l << 19) ^ (l << 10))) | 0);
...
(l.cipher.aes = function (e) {
    ...
    (l.cipher.aes.prototype = {
        ...
        O: function () {
            ...
            for (t = n = 0; !u[t]; t ^= r || 1, n = _[n] || 1) for (a = ((a = n ^ (n << 1) ^ (n << 2) ^ (n << 3) ^ (n << 4)) >> 8) ^ (255 & a) ^ 99, u[t] = a, c[a] = t, o = (16843009 * (i = d[(e = d[(r = d[t])])])) ^ (65537 * e) ^ (257 * r) ^ (16843008 * t), i = (257 * d[a]) ^ (16843008 * a), e = 0; 4 > e; e++) (s[e][t] = i = (i << 24) ^ (i >>> 8)), (l[e][a] = o = (o << 24) ^ (o >>> 8));
    ...
    (l.codec.base32 = {
        ...
        fromBits: function (e, t, n) {
            ...
            for (n && (s = l.codec.base32.X), n = 0; a.length * r < c; ) (a += s.charAt((u ^ (e[n] >>> o)) >>> i)), o < r ? ((u = e[n] << (r - o)), (o += i), n++) : ((u <<= r), (o -= r));
            for (; 7 & a.length && !t; ) a += '=';
            return a;
        },
        toBits: function (e, t) {
    ...
    (l.codec.base64 = {
        ...
        toBits: function (e, t) {
            ...
            for (t && (o = o.substr(0, 62) + '-_'), n = 0; n < e.length; n++) {
                if (0 > (r = o.indexOf(e.charAt(n)))) throw new l.exception.invalid("this isn't base64!");
    ...
    (l.mode.ccm = {
        ...
        decrypt: function (e, t, n, r, i) {
            ...
            var a = l.bitArray,
                ...
                c = a.bitSlice(t, s - i),
                s = (s - i) / 8;
            if (7 > o) throw new l.exception.invalid('ccm: iv must be at least 7 bytes');
            for (t = 2; 4 > t && s >>> (8 * t); t++);
            if ((t < 15 - o && (t = 15 - o), (n = a.clamp(n, 8 * (15 - t))), (u = l.mode.ccm.C(e, u, n, c, i, t)), (e = l.mode.ccm.V(e, u.data, n, r, i, t)), !a.equal(u.tag, e))) throw new l.exception.corrupt("ccm: tag doesn't match");
            return u.data;
        },
        na: function (e, t, n, r, i, a) {
            var o = [],
                s = l.bitArray,
                u = s.i;
            if (((r = [s.partial(8, (t.length ? 64 : 0) | ((r - 2) << 2) | (a - 1))]), (r = s.concat(r, n)), (r[3] |= i), (r = e.encrypt(r)), t.length)) for (65279 >= (n = s.bitLength(t) / 8) ? (o = [s.partial(16, n)]) : 4294967295 >= n && (o = s.concat([s.partial(16, 65534)], [n])), o = s.concat(o, t), t = 0; t < o.length; t += 4) r = e.encrypt(u(r, o.slice(t, t + 4).concat([0, 0, 0])));
            return r;
        },
        V: function (e, t, n, r, i, a) {
            ...
            for (n = l.mode.ccm.na(e, r, n, i, o.bitLength(t) / 8, a), r = 0; r < t.length; r += 4) n = e.encrypt(s(n, t.slice(r, r + 4).concat([0, 0, 0])));
        ...
        C: function (e, t, n, r, i, a) {
            ...
            if (
                ((n = s
                    ...
                    .concat([0, 0, 0])
                    .slice(0, 4)),
                (r = s.bitSlice(o(r, e.encrypt(n)), 0, i)),
                !u)
            )
                return {
                    tag: r,
            ...
            for (o = 0; o < u; o += 4) o > d && (l.mode.ccm.fa(o / u), (d += _)), n[3]++, (i = e.encrypt(n)), (t[o] ^= i[0]), (t[o + 1] ^= i[1]), (t[o + 2] ^= i[2]), (t[o + 3] ^= i[3]);
            return {
                tag: r,
                data: s.clamp(t, c)
            };
    ...
    (l.mode.ocb2 = {
        ...
        encrypt: function (e, t, n, r, i, a) {
            ...
            var _,
                E = [];
            for (o = 0, r = r || [], i = i || 64; o + 4 < t.length; o += 4) (d = c(d, (_ = t.slice(o, o + 4)))), (E = E.concat(c(n, e.encrypt(c(n, _))))), (n = s(n));
            return (_ = t.slice(o)), (t = u.bitLength(_)), (o = e.encrypt(c(n, [0, 0, 0, t]))), (_ = u.clamp(c(_.concat([0, 0, 0]), o), t)), (d = c(d, c(_.concat([0, 0, 0]), o))), (d = e.encrypt(c(d, c(n, s(n))))), r.length && (d = c(d, a ? r : l.mode.ocb2.pmac(e, r))), E.concat(u.concat(_, u.clamp(d, i)));
        },
        decrypt: function (e, t, n, r, i, a) {
            ...
            var o,
                ...
                h = [];
            for (n = 0, r = r || []; n + 4 < f / 32; n += 4) (o = d(E, e.decrypt(d(E, t.slice(n, n + 4))))), (_ = d(_, o)), (h = h.concat(o)), (E = u(E));
            if (((s = f - 32 * n), (o = e.encrypt(d(E, [0, 0, 0, s]))), (o = d(o, c.clamp(t.slice(n), s).concat([0, 0, 0]))), (_ = d(_, o)), (_ = e.encrypt(d(_, d(E, u(E))))), r.length && (_ = d(_, a ? r : l.mode.ocb2.pmac(e, r))), !c.equal(c.clamp(_, i), c.bitSlice(t, f)))) throw new l.exception.corrupt("ocb: tag doesn't match");
    ...
    (l.mode.gcm = {
        ...
        decrypt: function (e, t, n, r, i) {
            var a = t.slice(0),
                o = l.bitArray,
                s = o.bitLength(a);
            if (((r = r || []), (i = i || 128) <= s ? ((t = o.bitSlice(a, s - i)), (a = o.bitSlice(a, 0, s - i))) : ((t = a), (a = [])), (e = l.mode.gcm.C(!1, e, a, r, n, i)), !o.equal(e.tag, t))) throw new l.exception.corrupt("gcm: tag doesn't match");
            return e.data;
        },
        ka: function (e, t) {
            var n,
        ...
        C: function (e, t, n, r, i, a) {
            var o,
                ...
                f,
                h = l.bitArray;
            for (_ = n.length, E = h.bitLength(n), f = h.bitLength(r), s = h.bitLength(i), o = t.encrypt([0, 0, 0, 0]), 96 === s ? ((i = i.slice(0)), (i = h.concat(i, [1]))) : ((i = l.mode.gcm.j(o, [0, 0, 0, 0], i)), (i = l.mode.gcm.j(o, i, [0, 0, Math.floor(s / 4294967296), 4294967295 & s]))), s = l.mode.gcm.j(o, [0, 0, 0, 0], r), d = i.slice(0), r = s.slice(0), e || (r = l.mode.gcm.j(o, s, n)), c = 0; c < _; c += 4) d[3]++, (u = t.encrypt(d)), (n[c] ^= u[0]), (n[c + 1] ^= u[1]), (n[c + 2] ^= u[2]), (n[c + 3] ^= u[3]);
            return (
                (n = h.clamp(n, E)),
                e && (r = l.mode.gcm.j(o, s, n)),
                (e = [Math.floor(f / 4294967296), 4294967295 & f, Math.floor(E / 4294967296), 4294967295 & E]),
                (r = l.mode.gcm.j(o, r, e)),
                (u = t.encrypt(i)),
                (r[0] ^= u[0]),
                (r[1] ^= u[1]),
                (r[2] ^= u[2]),
    ...
    (l.misc.pbkdf2 = function (e, t, n, r, i) {
        ...
        for (u = 1; 32 * c.length < (r || 1); u++) {
            for (o = 1, i = a = e.encrypt(d.concat(t, [u])); o < n; o++) for (a = e.encrypt(a), s = 0; s < a.length; s++) i[s] ^= a[s];
            c = c.concat(i);
        }
...
a: try {
    ...
    if (o && i.randomBytes) (r = i.randomBytes(128)), (r = new Uint32Array(new Uint8Array(r).buffer)), l.random.addEntropy(r, 1024, "crypto['randomBytes']");

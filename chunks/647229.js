...
function u(e, t, n) {
    ...
    var r = e.b[n], i = t[0] ^ r[0], a = t[n ? 3 : 1] ^ r[1], o = t[2] ^ r[2];
    t = t[n ? 1 : 3] ^ r[3];
    var s, u, c, d, _ = r.length / 4 - 2, E = 4, f = [
            0,
            0,
            0,
            0
    ...
    e = (s = e.s[n])[0];
    var h = s[1], p = s[2], m = s[3], I = s[4];
    for (d = 0; d < _; d++)
        s = e[i >>> 24] ^ h[a >> 16 & 255] ^ p[o >> 8 & 255] ^ m[255 & t] ^ r[E], u = e[a >>> 24] ^ h[o >> 16 & 255] ^ p[t >> 8 & 255] ^ m[255 & i] ^ r[E + 1], c = e[o >>> 24] ^ h[t >> 16 & 255] ^ p[i >> 8 & 255] ^ m[255 & a] ^ r[E + 2], t = e[t >>> 24] ^ h[i >> 16 & 255] ^ p[a >> 8 & 255] ^ m[255 & o] ^ r[E + 3], E += 4, i = s, a = u, o = c;
    for (d = 0; 4 > d; d++)
        f[n ? 3 & -d : d] = I[i >>> 24] << 24 ^ I[a >> 16 & 255] << 16 ^ I[o >> 8 & 255] << 8 ^ I[255 & t] ^ r[E++], s = i, i = a, a = o, o = t, t = s;
    return f;
}
function c(e, t) {
    var n, r, i, a = e.F, o = e.b, s = a[0], l = a[1], u = a[2], c = a[3], d = a[4], _ = a[5], E = a[6], f = a[7];
    for (n = 0; 64 > n; n++)
        16 > n ? r = t[n] : (r = t[n + 1 & 15], i = t[n + 14 & 15], r = t[15 & n] = (r >>> 7 ^ r >>> 18 ^ r >>> 3 ^ r << 25 ^ r << 14) + (i >>> 17 ^ i >>> 19 ^ i >>> 10 ^ i << 15 ^ i << 13) + t[15 & n] + t[n + 9 & 15] | 0), r = r + f + (d >>> 6 ^ d >>> 11 ^ d >>> 25 ^ d << 26 ^ d << 21 ^ d << 7) + (E ^ d & (_ ^ E)) + o[n], f = E, E = _, _ = d, d = c + r | 0, c = u, u = l, s = r + ((l = s) & u ^ c & (l ^ u)) + (l >>> 2 ^ l >>> 13 ^ l >>> 22 ^ l << 30 ^ l << 19 ^ l << 10) | 0;
    a[0] = a[0] + s | 0, a[1] = a[1] + l | 0, a[2] = a[2] + u | 0, a[3] = a[3] + c | 0, a[4] = a[4] + d | 0, a[5] = a[5] + _ | 0, a[6] = a[6] + E | 0, a[7] = a[7] + f | 0;
}
function d(e, t) {
    var n, r = l.random.K[e], i = [];
    for (n in r)
...
l.cipher.aes = function (e) {
    this.s[0][0][0] || this.O();
    var t, n, r, i, a = this.s[0][4], o = this.s[1];
    t = e.length;
    var s = 1;
    if (4 !== t && 6 !== t && 8 !== t)
    ...
    for (this.b = [
        ...
        n = r[e - 1], (0 == e % t || 8 === t && 4 == e % t) && (n = a[n >>> 24] << 24 ^ a[n >> 16 & 255] << 16 ^ a[n >> 8 & 255] << 8 ^ a[255 & n], 0 == e % t && (n = n << 8 ^ n >>> 24 ^ s << 24, s = s << 1 ^ 283 * (s >> 7))), r[e] = r[e - t] ^ n;
    for (t = 0; e; t++, e--)
        n = r[3 & t ? e : e - 4], i[t] = 4 >= e || 4 > t ? n : o[0][a[n >>> 24]] ^ o[1][a[n >> 16 & 255]] ^ o[2][a[n >> 8 & 255]] ^ o[3][a[255 & n]];
    ...
    O: function () {
        var e, t, n, r, i, a, o, s = this.s[0], l = this.s[1], u = s[4], c = l[4], d = [], _ = [];
        for (e = 0; 256 > e; e++)
            _[(d[e] = e << 1 ^ 283 * (e >> 7)) ^ e] = e;
        for (t = n = 0; !u[t]; t ^= r || 1, n = _[n] || 1)
            for (a = (a = n ^ n << 1 ^ n << 2 ^ n << 3 ^ n << 4) >> 8 ^ 255 & a ^ 99, u[t] = a, c[a] = t, o = 16843009 * (i = d[e = d[r = d[t]]]) ^ 65537 * e ^ 257 * r ^ 16843008 * t, i = 257 * d[a] ^ 16843008 * a, e = 0; 4 > e; e++)
                s[e][t] = i = i << 24 ^ i >>> 8, l[e][a] = o = o << 24 ^ o >>> 8;
        for (e = 0; 5 > e; e++)
            s[e] = s[e].slice(0), l[e] = l[e].slice(0);
    }
}, l.bitArray = {
    ...
    concat: function (e, t) {
        if (0 === e.length || 0 === t.length)
            return e.concat(t);
        var n = e[e.length - 1], r = l.bitArray.getPartial(n);
    ...
    fromBits: function (e) {
        var t, n, r = '', i = l.bitArray.bitLength(e);
        for (t = 0; t < i / 8; t++)
    ...
    fromBits: function (e, t, n) {
        var r = l.codec.base32.BASE, i = l.codec.base32.REMAINING, a = '', o = 0, s = l.codec.base32.B, u = 0, c = l.bitArray.bitLength(e);
        for (n && (s = l.codec.base32.X), n = 0; a.length * r < c;)
            a += s.charAt((u ^ e[n] >>> o) >>> i), o < r ? (u = e[n] << r - o, o += i, n++) : (u <<= r, o -= r);
        for (; 7 & a.length && !t;)
            a += '=';
        return a;
    },
    toBits: function (e, t) {
        ...
        var n, r, i = l.codec.base32.BITS, a = l.codec.base32.BASE, o = l.codec.base32.REMAINING, s = [], u = 0, c = l.codec.base32.B, d = 0, _ = 'base32';
        for (t && (c = l.codec.base32.X, _ = 'base32hex'), n = 0; n < e.length; n++) {
            ...
            u > o ? (u -= o, s.push(d ^ r >>> u), d = r << i - u) : (u += a, d ^= r << i - u);
        }
        return 56 & u && s.push(l.bitArray.partial(56 & u, d, 1)), s;
    }
}, l.codec.base32hex = {
    ...
    fromBits: function (e, t, n) {
        var r = '', i = 0, a = l.codec.base64.B, o = 0, s = l.bitArray.bitLength(e);
        for (n && (a = a.substr(0, 62) + '-_'), n = 0; 6 * r.length < s;)
            r += a.charAt((o ^ e[n] >>> i) >>> 26), 6 > i ? (o = e[n] << 6 - i, i += 26, n++) : (o <<= 6, i -= 6);
        for (; 3 & r.length && !t;)
            r += '=';
        return r;
    },
    ...
    finalize: function () {
        var e, t = this.A, n = this.F, t = l.bitArray.concat(t, [l.bitArray.partial(1, 1)]);
    ...
    encrypt: function (e, t, n, r, i) {
        var a, o = t.slice(0), s = l.bitArray, u = s.bitLength(n) / 8, c = s.bitLength(o) / 8;
        if (i = i || 64, r = r || [], 7 > u)
            throw new l.exception.invalid('ccm: iv must be at least 7 bytes');
        for (a = 2; 4 > a && c >>> 8 * a; a++);
        return a < 15 - u && (a = 15 - u), n = s.clamp(n, 8 * (15 - a)), t = l.mode.ccm.V(e, t, n, r, i, a), o = l.mode.ccm.C(e, o, n, t, i, a), s.concat(o.data, o.tag);
    },
    decrypt: function (e, t, n, r, i) {
        i = i || 64, r = r || [];
        var a = l.bitArray, o = a.bitLength(n) / 8, s = a.bitLength(t), u = a.clamp(t, s - i), c = a.bitSlice(t, s - i), s = (s - i) / 8;
        if (7 > o)
            throw new l.exception.invalid('ccm: iv must be at least 7 bytes');
        for (t = 2; 4 > t && s >>> 8 * t; t++);
        if (t < 15 - o && (t = 15 - o), n = a.clamp(n, 8 * (15 - t)), u = l.mode.ccm.C(e, u, n, c, i, t), e = l.mode.ccm.V(e, u.data, n, r, i, t), !a.equal(u.tag, e))
            throw new l.exception.corrupt('ccm: tag doesn\'t match');
        return u.data;
    },
    na: function (e, t, n, r, i, a) {
        var o = [], s = l.bitArray, u = s.i;
        if (r = [s.partial(8, (t.length ? 64 : 0) | r - 2 << 2 | a - 1)], r = s.concat(r, n), r[3] |= i, r = e.encrypt(r), t.length)
            for (65279 >= (n = s.bitLength(t) / 8) ? o = [s.partial(16, n)] : 4294967295 >= n && (o = s.concat([s.partial(16, 65534)], [n])), o = s.concat(o, t), t = 0; t < o.length; t += 4)
                r = e.encrypt(u(r, o.slice(t, t + 4).concat([
                    0,
                    0,
                    0
                ])));
    ...
    V: function (e, t, n, r, i, a) {
        ...
        for (n = l.mode.ccm.na(e, r, n, i, o.bitLength(t) / 8, a), r = 0; r < t.length; r += 4)
            n = e.encrypt(s(n, t.slice(r, r + 4).concat([
                0,
                0,
                0
            ])));
    ...
    C: function (e, t, n, r, i, a) {
        var o, s = l.bitArray;
        o = s.i;
        var u = t.length, c = s.bitLength(t), d = u / 50, _ = d;
        if (n = s.concat([s.partial(8, a - 1)], n).concat([
                0,
                0,
                0
            ]).slice(0, 4), r = s.bitSlice(o(r, e.encrypt(n)), 0, i), !u)
            return {
                tag: r,
                data: []
            };
        for (o = 0; o < u; o += 4)
            o > d && (l.mode.ccm.fa(o / u), d += _), n[3]++, i = e.encrypt(n), t[o] ^= i[0], t[o + 1] ^= i[1], t[o + 2] ^= i[2], t[o + 3] ^= i[3];
        return {
            tag: r,
            data: s.clamp(t, c)
        };
    ...
    encrypt: function (e, t, n, r, i, a) {
        ...
        var o, s = l.mode.ocb2.S, u = l.bitArray, c = u.i, d = [
                0,
                0,
                0,
                0
        ...
        n = s(e.encrypt(n));
        var _, E = [];
        for (o = 0, r = r || [], i = i || 64; o + 4 < t.length; o += 4)
            d = c(d, _ = t.slice(o, o + 4)), E = E.concat(c(n, e.encrypt(c(n, _)))), n = s(n);
        return _ = t.slice(o), t = u.bitLength(_), o = e.encrypt(c(n, [
            0,
            0,
            0,
            t
            ...
            0,
            0
        ]), o), t), d = c(d, c(_.concat([
            0,
            0,
            0
        ]), o)), d = e.encrypt(c(d, c(n, s(n)))), r.length && (d = c(d, a ? r : l.mode.ocb2.pmac(e, r))), E.concat(u.concat(_, u.clamp(d, i)));
    },
    decrypt: function (e, t, n, r, i, a) {
        if (128 !== l.bitArray.bitLength(n))
            throw new l.exception.invalid('ocb iv must be 128 bits');
        i = i || 64;
        var o, s, u = l.mode.ocb2.S, c = l.bitArray, d = c.i, _ = [
                0,
                0,
                0,
                0
            ], E = u(e.encrypt(n)), f = l.bitArray.bitLength(t) - i, h = [];
        for (n = 0, r = r || []; n + 4 < f / 32; n += 4)
            o = d(E, e.decrypt(d(E, t.slice(n, n + 4)))), _ = d(_, o), h = h.concat(o), E = u(E);
        if (s = f - 32 * n, o = e.encrypt(d(E, [
                0,
                0,
                0,
                s
            ])), o = d(o, c.clamp(t.slice(n), s).concat([
                0,
                0,
                0
            ])), _ = d(_, o), _ = e.encrypt(d(_, d(E, u(E)))), r.length && (_ = d(_, a ? r : l.mode.ocb2.pmac(e, r))), !c.equal(c.clamp(_, i), c.bitSlice(t, f)))
            throw new l.exception.corrupt('ocb: tag doesn\'t match');
        return h.concat(c.clamp(o, s));
    },
    pmac: function (e, t) {
        var n, r = l.mode.ocb2.S, i = l.bitArray, a = i.i, o = [
                0,
                0,
                0,
                0
        ...
        for (n = 0; n + 4 < t.length; n += 4)
            s = r(s), o = a(o, e.encrypt(a(s, t.slice(n, n + 4))));
        return n = t.slice(n), 128 > i.bitLength(n) && (s = a(s, r(s)), n = i.concat(n, [
            -2147483648,
            0,
            0,
            0
        ])), o = a(o, n), e.encrypt(a(r(a(s, r(s))), o));
    },
    S: function (e) {
        return [
            e[0] << 1 ^ e[1] >>> 31,
    ...
    decrypt: function (e, t, n, r, i) {
        var a = t.slice(0), o = l.bitArray, s = o.bitLength(a);
        if (r = r || [], (i = i || 128) <= s ? (t = o.bitSlice(a, s - i), a = o.bitSlice(a, 0, s - i)) : (t = a, a = []), e = l.mode.gcm.C(!1, e, a, r, n, i), !o.equal(e.tag, t))
            throw new l.exception.corrupt('gcm: tag doesn\'t match');
        return e.data;
    },
    ka: function (e, t) {
        var n, r, i, a, o, s = l.bitArray.i;
        for (n = 0, i = [
                0,
                0,
                0,
            ...
            for ((r = 0 != (e[Math.floor(n / 32)] & 1 << 31 - n % 32)) && (i = s(i, a)), o = 0 != (1 & a[3]), r = 3; 0 < r; r--)
    ...
    C: function (e, t, n, r, i, a) {
        var o, s, u, c, d, _, E, f, h = l.bitArray;
        for (_ = n.length, E = h.bitLength(n), f = h.bitLength(r), s = h.bitLength(i), o = t.encrypt([
                0,
                0,
                0,
                0
            ]), 96 === s ? (i = i.slice(0), i = h.concat(i, [1])) : (i = l.mode.gcm.j(o, [
                0,
                0,
                0,
                0
            ], i), i = l.mode.gcm.j(o, i, [
                0,
                0,
                ...
                0,
                0
            ], r), d = i.slice(0), r = s.slice(0), e || (r = l.mode.gcm.j(o, s, n)), c = 0; c < _; c += 4)
            d[3]++, u = t.encrypt(d), n[c] ^= u[0], n[c + 1] ^= u[1], n[c + 2] ^= u[2], n[c + 3] ^= u[3];
        return n = h.clamp(n, E), e && (r = l.mode.gcm.j(o, s, n)), e = [
            Math.floor(f / 4294967296),
            4294967295 & f,
            Math.floor(E / 4294967296),
            4294967295 & E
        ], r = l.mode.gcm.j(o, r, e), u = t.encrypt(i), r[0] ^= u[0], r[1] ^= u[1], r[2] ^= u[2], r[3] ^= u[3], {
    ...
    var e = this.R.finalize(), e = new this.W(this.w[1]).update(e).finalize();
    return this.reset(), e;
    ...
    var a, o, s, u, c = [], d = l.bitArray;
    for (u = 1; 32 * c.length < (r || 1); u++) {
        for (o = 1, i = a = e.encrypt(d.concat(t, [u])); o < n; o++)
            for (a = e.encrypt(a), s = 0; s < a.length; s++)
                i[s] ^= a[s];
        c = c.concat(i);
    }
    ...
    randomWords: function (e, t) {
        ...
        if (n & this.J) {
            ...
            for (this.P >= 1 << this.c.length && (this.c.push(new l.hash.sha256()), this.m.push(0)), this.f -= o, o > this.o && (this.o = o), this.P++, this.b = l.hash.sha256.hash(this.b.concat(i)), this.L = new l.cipher.aes(this.b), n = 0; 4 > n && (this.h[n] = this.h[n] + 1 | 0, !this.h[n]); n++);
        }
        for (n = 0; n < e; n += 4)
    ...
    addEntropy: function (e, t, n) {
        ...
        case 'object':
            ...
            break;
        case 'string':
            void 0 === t && (t = e.length), this.c[o].update([
                r,
                this.N++,
                3,
                t,
...
l.json = {
    ...
    ja: function (e, t, n, r) {
        n = n || {}, r = r || {};
        var i, a = l.json, o = a.g({ iv: l.random.randomWords(4, 0) }, a.defaults);
        if (a.g(o, n), n = o.adata, 'string' == typeof o.salt && (o.salt = l.codec.base64.toBits(o.salt)), 'string' == typeof o.iv && (o.iv = l.codec.base64.toBits(o.iv)), !l.mode[o.mode] || !l.cipher[o.cipher] || 'string' == typeof e && 100 >= o.iter || 64 !== o.ts && 96 !== o.ts && 128 !== o.ts || 128 !== o.ks && 192 !== o.ks && 256 !== o.ks || 2 > o.iv.length || 4 < o.iv.length)
            throw new l.exception.invalid('json encrypt: invalid parameters');
        return 'string' == typeof e ? (e = (i = l.misc.cachedPbkdf2(e, o)).key.slice(0, o.ks / 32), o.salt = i.salt) : l.ecc && e instanceof l.ecc.elGamal.publicKey && (i = e.kem(), o.kemtag = i.tag, e = i.key.slice(0, o.ks / 32)), 'string' == typeof t && (t = l.codec.utf8String.toBits(t)), 'string' == typeof n && (o.adata = n = l.codec.utf8String.toBits(n)), i = new l.cipher[o.cipher](e), a.g(r, o), r.key = e, o.ct = 'ccm' === o.mode && l.arrayBuffer && l.arrayBuffer.ccm && t instanceof ArrayBuffer ? l.arrayBuffer.ccm.encrypt(i, t, o.iv, n, o.ts) : l.mode[o.mode].encrypt(i, t, o.iv, n, o.ts), o;
    },
    encrypt: function (e, t, n, r) {
        var i = l.json, a = i.ja.apply(i, arguments);
        return i.encode(a);
    },
    ia: function (e, t, n, r) {
        n = n || {}, r = r || {};
        var i, a, o = l.json;
        if (i = (t = o.g(o.g(o.g({}, o.defaults), t), n, !0)).adata, 'string' == typeof t.salt && (t.salt = l.codec.base64.toBits(t.salt)), 'string' == typeof t.iv && (t.iv = l.codec.base64.toBits(t.iv)), !l.mode[t.mode] || !l.cipher[t.cipher] || 'string' == typeof e && 100 >= t.iter || 64 !== t.ts && 96 !== t.ts && 128 !== t.ts || 128 !== t.ks && 192 !== t.ks && 256 !== t.ks || !t.iv || 2 > t.iv.length || 4 < t.iv.length)
            throw new l.exception.invalid('json decrypt: invalid parameters');
        return 'string' == typeof e ? (e = (a = l.misc.cachedPbkdf2(e, t)).key.slice(0, t.ks / 32), t.salt = a.salt) : l.ecc && e instanceof l.ecc.elGamal.secretKey && (e = e.unkem(l.codec.base64.toBits(t.kemtag)).slice(0, t.ks / 32)), 'string' == typeof i && (i = l.codec.utf8String.toBits(i)), a = new l.cipher[t.cipher](e), i = 'ccm' === t.mode && l.arrayBuffer && l.arrayBuffer.ccm && t.ct instanceof ArrayBuffer ? l.arrayBuffer.ccm.decrypt(a, t.ct, t.iv, t.tag, i, t.ts) : l.mode[t.mode].decrypt(a, t.ct, t.iv, i, t.ts), o.g(r, t), r.key = e, 1 === n.raw ? i : l.codec.utf8String.fromBits(i);
    },
    ...
    var n, r = l.misc.pa;
    return n = (t = t || {}).iter || 1000, n = (r = r[e] = r[e] || {})[n] = r[n] || { firstSalt: t.salt && t.salt.length ? t.salt.slice(0) : l.random.randomWords(2, 0) }, r = void 0 === t.salt ? n.firstSalt : t.salt, n[r] = n[r] || l.misc.pbkdf2(e, r, t.iter), {
        key: n[r].slice(0),
        salt: r.slice(0)
    };

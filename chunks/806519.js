...
var r, i, a = n(735250), o = n(470079), s = n(120356), l = n.n(s), u = n(182294), c = n(419061), d = n(525049), _ = n(955711);
...
function f(e, t, n) {
    let r = (0, u.UC)(t), i = 32 === r.size, o = i ? 8 : 0, s = i ? 24 : 12;
...
function p(e) {
    let t = e.size, n = e.size / (d.z3 + d.o), r = n * d.z3, i = d.o * n / t + r / 2 / t, a = (d.$V + r / 2) / t;
    return {
        totalSize: t,
        backAvatarSize: n,
        frontAvatarSize: r,
...
function T(e, t) {
    let n = (0, u.UC)(t), r = p(n), i = r.totalSize, o = n.status / 2;
    return (0, a.jsxs)('mask', {
        id: e,
        maskContentUnits: 'objectBoundingBox',
        viewBox: '0 0 1 1',
...
function g(e, t) {
    let n = (0, u.UC)(t), r = p(n), i = r.totalSize, o = (2.5 * n.status - n.status + 2 * n.stroke) / 2, s = n.size - n.status - o - n.offset, l = n.status + 2 * n.stroke;
    return (0, a.jsxs)('mask', {
        id: e,
        maskContentUnits: 'objectBoundingBox',
        viewBox: '0 0 1 1',
...
function N(e, t) {
    let n = (0, u.UC)(t), r = n.status / 2, i = (r + n.stroke) / n.size / c.hs, o = E((n.size - r - n.offset) / n.size);
    return (0, a.jsxs)('mask', {
        id: e,
        maskContentUnits: 'objectBoundingBox',
        viewBox: '0 0 1 1',
...
function v(e, t) {
    let n = (0, u.UC)(t), r = (2.5 * n.status - n.status + 2 * n.stroke) / 2, i = n.size - n.status - r - n.offset, o = n.status + 2 * n.stroke;
    return (0, a.jsxs)('mask', {
        id: e,
        maskContentUnits: 'objectBoundingBox',
        viewBox: '0 0 1 1',
...
function O(e, t) {
    let n = (0, u.UC)(t), r = (2.5 * n.status - n.status + 2 * n.stroke) / 2, i = E((n.size - n.status - n.stroke - n.offset) / n.size), o = E((n.size - n.status - r - n.offset) / n.size), s = (2.5 * n.status + 2 * n.stroke) / n.size / c.hs, l = (n.status + 2 * n.stroke) / n.size / c.hs, d = E(l / 2 / n.size);
    return (0, a.jsxs)('mask', {
        id: e,
        maskContentUnits: 'objectBoundingBox',
        viewBox: '0 0 1 1',
...
function C(e, t) {
    let n = (0, u.UC)(t), r = E((n.size - n.status - n.stroke - n.offset) / n.size), i = E((n.size - n.status * u.EW - n.stroke - n.offset) / n.size), o = (n.status + 2 * n.stroke) / n.size / c.hs, s = (n.status * u.EW + 2 * n.stroke) / n.size / c.hs;
    return (0, a.jsxs)('mask', {
        id: e,
        maskContentUnits: 'objectBoundingBox',
        viewBox: '0 0 1 1',
...
let D = o.memo(function () {
    ...
    return (0, a.jsxs)('svg', {
        ...
        children: [
            ...
            function (e, t) {
                let n = (0, u.UC)(t), r = n.status / 2, i = n.size * c.hs / n.size, o = (r + n.stroke) / n.size / i, s = E((n.size - r - n.offset) / n.size, i);
                return (0, a.jsxs)('mask', {
                    id: e,
                    maskContentUnits: 'objectBoundingBox',
                    viewBox: '0 0 1 1',
            ...
            function (e, t) {
                let n = (0, u.UC)(t), r = n.size * c.hs / n.size, i = E((n.size - n.status - n.stroke - n.offset) / n.size, r), o = E((n.size - n.status * u.EW - n.stroke - n.offset) / n.size, r), s = (n.status + 2 * n.stroke) / n.size / r, l = (n.status * u.EW + 2 * n.stroke) / n.size / r;
                return (0, a.jsxs)('mask', {
                    id: e,
                    maskContentUnits: 'objectBoundingBox',
                    viewBox: '0 0 1 1',

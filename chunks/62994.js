(() => {
  ...
  75: (A, I, g) => {
    ...
    class i extends AudioWorkletNode {
      constructor(A, I, g, i) {
        let o = A.sampleRate,
          ...
          h = {
            ...
            sharedBuffers: I.useSharedArrayBuffer ? (0, Q.createSharedBuffers)({
              sampleRate: o
            }) : void 0
          };
        super(A, B.WORKLET_PROCESSOR_NAME, {
          processorOptions: h
        }), this.params = I, this.isReady = !1, this.enabled = !1, this.wasmParams = h, this.debugLogs && h.sharedBuffers && x.Logger.info('AudioFilterNode:constructor', 'SharedArrayBuffer\'s has been initialized');
        try {
          g && this.addEventListener('ready', g), i && this.addEventListener('dispose', i), this.debugLogs && x.Logger.info('AudioFilterNode:constructor', 'creating web worker (type: module)'), this.worker = new C.KWebWorker(D.WORKER_URL, {
            type: 'module'
          }), this.debugLogs && x.Logger.info('AudioFilterNode:constructor', 'adding event listener for worker'), this.worker.addEventListener('message', this._onWasmWorkerMessage.bind(this)), this.debugLogs && (x.Logger.info('AudioFilterNode:constructor', 'Connecting with other threads for logging'), x.Logger.collectFrom(this.worker, h), x.Logger.collectFrom(this.port, h)), this.debugLogs && x.Logger.info('AudioFilterNode:constructor', 'Send init WASM processor event'), this.worker.postMessage({
      ...
      _onWasmWorkerMessage(A) {
        ...
        switch (I) {
          ...
          case 'BUFFER_OVERFLOW':
            this.debugLogs && x.Logger.info('AudioFilterNode:_onWasmWorkerMessage', 'Buffer overflown:', JSON.stringify(g)), this.dispatchEvent(new MessageEvent('buffer_overflow', {
              data: g
            }));
        }
      }
      ...
      checkReadiness(A) {
        if (this.debugLogs && x.Logger.info('AudioFilterNode:checkReadiness', JSON.stringify({
            isReady: this.isReady
          })), !A)
          throw Error('WASM_OR_WORKER_NOT_READY');
      }
      isEnabled() {
        return this.debugLogs && x.Logger.info('AudioFilterNode:isEnabled', JSON.stringify({
  ...
  `;
          return (0, C.downloadBlob)(`report-${ new Date().toISOString() }.html`, new Blob([I], {
            type: 'text/html'
          })), !0;
        } catch (A) {
...
`;
  ...
  333: (A, I) => {
    Object.defineProperty(I, '__esModule', {
      value: !0
    }), I.sampleModelMap = void 0, I.sampleModelMap = {
      8000: 'model8',
      16000: 'model16',
      24000: 'model32',
      32000: 'model32',
  ...
  687: (A, I) => {
    Object.defineProperty(I, '__esModule', {
      value: !0
    }), I.createWAVBlob = I.downloadBlob = I.blobToBase64 = void 0, I.blobToBase64 = async function(A) {
      ...
      return A.forEach((A, I) => {
        ...
        let g = I.isFloat ? Float32Array : Uint16Array,
          C = function(A) {
            ...
            numFrames: A.byteLength / g.BYTES_PER_ELEMENT
          })),
  ...
  479: (A, I) => {
    Object.defineProperty(I, '__esModule', {
      value: !0
    }), I.isMobile = I.isSafari = void 0, I.isSafari = function() {
  ...
  761: (A, I) => {
    Object.defineProperty(I, '__esModule', {
      value: !0
    }), I.SUPPORTED_SAMPLE_RATES = I.SDK_FRAME_DURATION_10MS = I.BUFFER_OVERFLOW_MS = I.BUFFER_DROP_KEEP_MS = I.BUFFER_DROP_SIZE_MS = I.WORKLET_PROCESSOR_NAME = I.WEB_AUDIO_CHUNK_SIZE = void 0, I.WEB_AUDIO_CHUNK_SIZE = 128, I.WORKLET_PROCESSOR_NAME = 'processor', I.BUFFER_DROP_SIZE_MS = 500, I.BUFFER_DROP_KEEP_MS = 40, I.BUFFER_OVERFLOW_MS = 200, I.SDK_FRAME_DURATION_10MS = 10, I.SUPPORTED_SAMPLE_RATES = [
      8000,
      16000,
      24000,
      32000,
...
Q.default = i;
  ...
  for (var B in Q)
I[B] = Q[B];
  Q.__esModule && Object.defineProperty(I, '__esModule', {
value: !0
  });
})();
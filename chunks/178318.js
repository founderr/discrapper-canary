...
let C = _.ZP.requireModule('discord_rpc').RPCWebSocket,
...
function Z(e, t, n) {
    ...
    (n = n ? JSON.stringify(n) : ''),
        ...
        t.setHeader('Content-Length', T.byteLength(n).toString()),
...
class O extends m.Z {
    ...
    constructor(e, t, n) {
        if ((super('ws', t, n), S(this, '_socket', void 0), -1 === ['etf', 'json'].indexOf(n))) throw new h.Z({ closeCode: p.$VG.INVALID_ENCODING }, 'Invalid Encoding: '.concat(n));
...
class x extends m.Z {
    ...
    constructor(e, t, n, i) {
        if ((super('http', n, i), S(this, '_sendCallback', void 0), S(this, '_closeCallback', void 0), 'json' !== i)) throw new h.Z({ closeCode: p.$VG.INVALID_ENCODING }, 'Invalid Encoding: '.concat(i));
        (this._sendCallback = e), (this._closeCallback = t);
    }
}
class b extends s.EventEmitter {
    handleRequest(e, t) {
        let [n, i] = v(e.url).split('?'),
            a = v(e.method);
        if ('/rpc' === n && 'OPTIONS' === a) {
            Z(e, t, { body: '' });
            return;
        ...
        if ('/rpc' === n && ('GET' === a || s)) {
            let n = new URLSearchParams(i),
                ...
                l = function () {
                    ...
                    i === location.protocol && a === location.host ? t.setHeader('Location', n.get('callback')) : t.setHeader('Location', f), t.writeHead(301), t.end();
                },
                c = new x(s ? Z.bind(null, e, t) : l, s ? R.bind(null, e, t, 400) : l, Number(n.get('v')), a);
            if (s)
    ...
    constructor() {
        ...
        super();
        let t = 0;
        (a = C.http.createServer()).on('error', (e) => {

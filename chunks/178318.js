...
class O extends m.Z {
    ...
    constructor(e, t, n) {
        if ((super('ws', t, n), C(this, '_socket', void 0), -1 === ['etf', 'json'].indexOf(n))) throw new E.Z({ closeCode: g.$VG.INVALID_ENCODING }, 'Invalid Encoding: '.concat(n));
...
class x extends m.Z {
    ...
    constructor(e, t, n, i) {
        if ((super('http', n, i), C(this, '_sendCallback', void 0), C(this, '_closeCallback', void 0), 'json' !== i)) throw new E.Z({ closeCode: g.$VG.INVALID_ENCODING }, 'Invalid Encoding: '.concat(i));
        ...
        if ('/rpc' === n && ('GET' === a || s)) {
            let n = new URLSearchParams(i),
                ...
                l = function () {
                    ...
                    i === location.protocol && a === location.host ? t.setHeader('Location', n.get('callback')) : t.setHeader('Location', S), t.writeHead(301), t.end();
                },

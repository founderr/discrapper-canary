...
class M extends h.default {
  send(e) {
    (c.default.isLoggingOverlayEvents || e.cmd !== S.RPCCommands.OVERLAY && e.evt !== S.RPCEvents.OVERLAY) && A.info("Socket Emit: ".concat(this.id), (0, _.default)(e)), null != a && "etf" === this.encoding ? this._socket.send(a.pack(e), {
      binary: !0
...
class y extends l.EventEmitter {
  ...
  handleMessage(e, t) {
    ...
    try {
      ...
      return
    }(c.default.isLoggingOverlayEvents || n.cmd !== S.RPCCommands.OVERLAY) && A.info("Socket Message: ".concat(e.id), (0, _.default)(n)), this.emit("request", e, n)
  }
  constructor() {
    var e;
    super();

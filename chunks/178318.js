...
class O extends m.Z {
    ...
    constructor(e, t, n) {
        if ((super('ws', t, n), f(this, '_socket', void 0), -1 === ['etf', 'json'].indexOf(n))) throw new E.Z({ closeCode: p.$VG.INVALID_ENCODING }, 'Invalid Encoding: '.concat(n));
...
class x extends m.Z {
    ...
    constructor(e, t, n, i) {
        if ((super('http', n, i), f(this, '_sendCallback', void 0), f(this, '_closeCallback', void 0), 'json' !== i)) throw new E.Z({ closeCode: p.$VG.INVALID_ENCODING }, 'Invalid Encoding: '.concat(i));

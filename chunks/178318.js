...
class R extends I.Z {
  send(e) {
    (u.default.isLoggingOverlayEvents || e.cmd !== g.Etm.OVERLAY && e.evt !== g.zMe.OVERLAY) && N.info("Socket Emit: ".concat(this.id), (0, h.Z)(e)), null != i && "etf" === this.encoding ? this._socket.send(i.pack(e), {
      binary: !0
  ...
  constructor(e, t, n) {
    if (super("ws", t, n), C(this, "_socket", void 0), -1 === ["etf", "json"].indexOf(n)) throw new E.Z({
      closeCode: g.$VG.INVALID_ENCODING
    }, "Invalid Encoding: ".concat(n));
    if ("etf" === n && null == i) throw new E.Z({
      closeCode: g.$VG.INVALID_ENCODING
...
class x extends I.Z {
  ...
  constructor(e, t, n, i) {
    if (super("http", n, i), C(this, "_sendCallback", void 0), C(this, "_closeCallback", void 0), "json" !== i) throw new E.Z({
      closeCode: g.$VG.INVALID_ENCODING
...
class P extends a.EventEmitter {
  handleRequest(e, t) {
    ...
    if ("/rpc" === n && ("GET" === s || a)) {
      ...
      if (a)(0, m.em)(c, Z(e.headers).origin, n.get("client_id")).then(() => {
        let n = "";
  ...
  constructor() {
    ...
    (s = f.http.createServer()).on("error", e => {
      N.error("Error: ".concat(e.message)), ("EADDRINUSE" === e.code || e.message.includes("EADDRINUSE")) && setTimeout(() => L(++t), 1e3)

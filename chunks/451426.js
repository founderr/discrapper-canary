...
var a = s(735250), t = s(470079), l = s(442837), i = s(481060), o = s(570140), r = s(285952), c = s(103879), d = s(236289), _ = s(788080), E = s(613734), N = s(981631), u = s(689938), x = s(393188), A = s(298196);
function I(e) {
    let {
            className: n,
            onClose: s,
            onNext: I,
            onBack: C
        } = e, S = (0, l.e7)([d.Z], () => d.Z.getAppealClassificationId()), {classification: T} = (0, E.YG)(null != S ? S : N.lds), m = (0, _.c7)(null == T ? void 0 : T.description), h = (0, l.e7)([d.Z], () => d.Z.getIsSubmitting()), M = (0, l.e7)([d.Z], () => d.Z.getAppealSignal()), L = (0, l.e7)([d.Z], () => d.Z.getFreeTextAppealReason()), [g, O] = t.useState(!1), [p, j] = t.useState(''), P = t.useCallback(e => {
            o.Z.dispatch({
                ...
                children: [
                    (0, a.jsx)('ul', {
                        ...
                        children: [
                            (0, _.ox)(M),
                            L
                        ].filter(e => e.length > 0).map((e, n) => (0, a.jsx)('li', {

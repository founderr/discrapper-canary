...
function I(e) {
  let {
    ...
    if (null !== f) try {
      O(""), await r.requestReview(f, C, m), null == I || I()
    } catch (t) {
      var e;
  ...
  return (0, l.jsxs)(l.Fragment, {
    children: [(0, l.jsxs)(i.ModalHeader, {
      ...
      children: [(0, l.jsx)("ul", {
        ...
        children: [(0, u.getAppealSignalDisplayText)(C), m].filter(e => e.length > 0).map((e, t) => (0, l.jsx)("li", {

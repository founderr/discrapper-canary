...
function h(e) {
  let {
    ...
    className: h,
    ...f
  } = e, E = r.useRef(null), _ = r.useRef(null), m = r.useRef({
    width: 0,
    height: 0
  }), S = r.useRef({
    streamId: t,
    ...
    if (null != e) {
      ...
      t.style.display = "block", t.style.width = "100%", t.style.height = "100%", t.autoplay = !0, t.muted = !0, t.addEventListener("pause", function() {
        ...
        let {
          width: a,
          height: o
        } = m.current, l = null !== (n = null === (e = _.current) || void 0 === e ? void 0 : e.videoWidth) && void 0 !== n ? n : 0, u = null !== (i = null === (t = _.current) || void 0 === t ? void 0 : t.videoHeight) && void 0 !== i ? i : 0;
        if (a !== l || o !== u) {
          let e = {
            width: l,
            height: u
          };
          null === (r = (s = S.current).onResize) || void 0 === r || r.call(s, e), m.current = e
        }
      ...
      }), u.info("create video element for ".concat(S.current.streamId, ", readyState=").concat(t.readyState)), t.readyState > 3 && u.error("video element for ".concat(S.current.streamId, " was ready before attached")), e.appendChild(t), _.current = t
    }
  }, []), r.useEffect(() => {
    S.current.streamId = t, S.current.paused = n, S.current.onReady = s, S.current.onResize = o
  }), r.useEffect(() => {
    let e = _.current;
    if (null != e) {
      if (n) null != e.srcObject && (e.srcObject = null, p(t));
      else {
        var i;
        let n;

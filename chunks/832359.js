...
function _(e) {
  let {
    ...
    className: _,
    ...h
  } = e, g = s.useRef(null), m = s.useRef(null), E = s.useRef({
    width: 0,
    height: 0
  }), p = s.useRef({
    streamId: t,
    ...
    if (null != e) {
      ...
      t.style.display = "block", t.style.width = "100%", t.style.height = "100%", t.autoplay = !0, t.muted = !0, t.addEventListener("pause", function() {
        ...
        let {
          width: a,
          height: o
        } = E.current, l = null !== (n = null === (e = m.current) || void 0 === e ? void 0 : e.videoWidth) && void 0 !== n ? n : 0, u = null !== (i = null === (t = m.current) || void 0 === t ? void 0 : t.videoHeight) && void 0 !== i ? i : 0;
        if (a !== l || o !== u) {
          let e = {
            width: l,
            height: u
          };
          null === (s = (r = p.current).onResize) || void 0 === s || s.call(r, e), E.current = e
        }
      ...
      }), u.info("create video element for ".concat(p.current.streamId, ", readyState=").concat(t.readyState)), t.readyState > 3 && u.error("video element for ".concat(p.current.streamId, " was ready before attached")), e.appendChild(t), m.current = t
    }
  }, []), s.useEffect(() => {

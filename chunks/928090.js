...
function x(e) {
    let {
            ...
            onClose: A,
            transitionState: p
        } = e, [h, O] = t.useState(!1), F = s.hasFeature(N.oNc.VERIFIED) || s.hasFeature(N.oNc.PARTNERED), M = F ? f.Z.Messages.TRANSFER_OWNERSHIP_PROTECTED_GUILD_PAUSED : null, b = F ? f.Z.Messages.TRANSFER_OWNERSHIP_PROTECTED_GUILD_LINK_PAUSED.format({ ticketUrl: S() }) : null, g = s.hasFeature(N.oNc.CREATOR_MONETIZABLE) || s.hasFeature(N.oNc.CREATOR_MONETIZABLE_PROVISIONAL);
    async function C(e) {
    ...
    let L = u.ZP.getNickname(s.id, void 0, _), j = _.hasAvatarForGuild(s.id), v = () => (0, r.jsxs)('span', {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(i.FormSwitch, {
                            ...
                            children: (0, r.jsx)(i.FormText, {
                                type: i.FormText.Types.DESCRIPTION,
                                children: f.Z.Messages.TRANSFER_OWNERSHIP_ACKNOWLEDGE.format({ username: (0, m.W5)(_) })
                            })
                        }),
                        (0, r.jsx)(i.FormText, {

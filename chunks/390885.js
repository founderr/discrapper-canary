var o = n(652874), r = n(433517), i = n(710845), a = n(626135), c = n(630724), l = n(981631);
let _ = 'UserFlowAnalyticsStore_current', u = 'UserFlowAnalyticsStore';
function d(e) {
    if (e === c.MK.UNKNOWN)
        return null;
...
let s = (0, o.Z)((e, t) => ({
    ...
    activeFlow: () => {
        ...
        if (null == n)
            return null;
        let {[n]: o} = t().flows, i = null != o ? o : d(n);
...
function f(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], o = e;
    if (e === c.MK.ANY) {
        var r;

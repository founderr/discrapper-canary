...
traceXHR: D.traceXHR,
...t
  }, M = 'function' == typeof T ? T : e => !0, P = e => function(e, t) {
...
let t = function(e, t, r, a) {
  let o = e.xhr,
    R = o && o[n.xU];
  if (!o || o.__sentry_own_request__ || !R)
    return;
  let T = (0, _.z)() && t(R.url);
  if (e.endTimestamp && T) {
  ...
  let D = (0, u.s3)();
  return o.setRequestHeader && r(R.url) && D && function(e, t, r) {
    let n = (0, u.nZ)(),
      {
        traceId: a,
        spanId: o,

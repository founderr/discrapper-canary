  ...
  return (l.useEffect(() => {
    ...
    children: (0, a.jsxs)("div", {
      ...
      children: [(0, a.jsxs)("div", {
        ...
        onClick: () => {
          !y && O && (u.default.selectVoiceChannel(x.id), E.default.track(I.AnalyticEvents.HANG_STATUS_CTA_CLICKED, {
            source: "HangStatusPopout",
            guild_id: x.guild_id,
            channel_id: x.id
          }))

...
var t = s(735250), a = s(470079), o = s(120356), l = s.n(o), i = s(442837), c = s(481060), r = s(239091), d = s(2052), u = s(100527), _ = s(906732), E = s(142497), O = s(810788), g = s(810090), m = s(626135), I = s(768581), p = s(709054), x = s(647177), A = s(63985), C = s(678916), N = s(981631), M = s(190378), R = s(486324), k = s(474936), D = s(689938), j = s(535019);
function T(e) {
    let {
        icon: n,
        onClick: s,
...
function f(e) {
    let {
            ...
            hotspotLocation: C,
            ...M
        } = e, R = (0, d.O)(), {analyticsLocations: T} = (0, _.ZP)(u.Z.VIDEO_BACKGROUND_IMAGE_OPTION), f = (0, i.e7)([O.Z], () => null != C && O.Z.hasHotspot(C)), U = A ? (0, t.jsx)(g.Z, {
            className: j.backgroundImageOption,
            src: a,
            loop: !0,
            playOnHover: !0,
...
function v(e) {
    let {onClick: n} = e, s = (0, d.O)(), {analyticsLocations: o} = (0, _.ZP)(u.Z.VIDEO_BACKGROUND_CUSTOM_UPSELL);
    return a.useEffect(() => {
...
function P(e) {
    let {
            ...
            disabled: a
        } = e, o = (0, c.useModalContext)(), l = a ? D.Z.Messages.CAMERA_PREVIEW_VIDEO_BACKGROUND_UPLOAD_TOOLTIP_MAX_REACHED.format({ maxCustomBackgrounds: 25 }) : D.Z.Messages.CAMERA_PREVIEW_VIDEO_BACKGROUND_UPLOAD_TOOLTIP_PREMIUM, i = [{
...
function Z(e) {
    let {
            ...
            smallerOptions: d
        } = e, E = a.useMemo(() => s.sort((e, n) => null == e.last_used || null == n.last_used ? p.default.compare(n.id, e.id) : new Date(n.last_used).getTime() - new Date(e.last_used).getTime()), [s]), O = E.length >= 25, {analyticsLocations: g} = (0, _.ZP)(u.Z.VIDEO_BACKGROUND_OPTIONS), m = Object.values((0, A.Z)()).sort((e, n) => C.E1[e.id] - C.E1[n.id]);
    return (0, t.jsx)(_.Gt, {
        value: g,
        children: (0, t.jsxs)('div', {
            ...
            children: [
                ...
                (0, t.jsx)(T, {
                    ...
                    children: (0, t.jsx)('div', { className: j.backgroundOptionBlurBackground })
                }),
                n ? (0, t.jsx)(P, {
                    onAddBackgroundImage: r,
                    disabled: O

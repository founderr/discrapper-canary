...
function P(e) {
  ...
  let Z = null != n && n.planId === s,
    ...
    w = (0, T.Ng)(),
    B = (0, T.z1)(),
    H = M && null != g && O.interval === S.rV.YEAR,
    k = O.interval === S.rV.YEAR ? x.Z.Messages.BILLING_TRIAL_YEARLY_PRICE_AFTER_TRIAL : x.Z.Messages.BILLING_TRIAL_MONTHLY_PRICE_AFTER_TRIAL,
    ...
    children: [(0, l.jsxs)("div", {
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [!y && (0, l.jsx)(u.Checkbox, {
          ...
          children: [(0, l.jsxs)("div", {
            ...
            children: [(0, p.L7)(O.interval, L, U, O.intervalCount, y, (0, p.Rd)(O.id)), y && Y()]
          }), y && (0, l.jsx)("div", {
        ...
        children: H ? (() => {
          ...
          price: v && null != f && O.interval === S.rV.MONTH ? (0, N.T4)(G.amount - f, G.currency) : C ? (0, N.T4)(0, G.currency, {
      ...
      children: (0, l.jsx)(u.Text, {
        ...
        children: (() => {
          ...
          if (M && null != g && O.interval === S.rV.YEAR) return x.Z.Messages.BILLING_ANNUAL_DISCOUNT_YEARLY_PRICE_SUBTEXT.format({
            regularPrice: (0, N.T4)(G.amount, G.currency)
          });
          if (C) return k.format({
            price: (0, N.T4)(G.amount, G.currency)
          });
          else O.interval === S.rV.YEAR && x.Z.Messages.BILLING_YEARLY_PLAN_SAVINGS.format({
            percent: D
          });
          return null
        })()

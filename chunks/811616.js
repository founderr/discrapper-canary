...
var l = s(735250);
s(470079);
var t = s(120356), i = s.n(t), r = s(512722), a = s.n(r), c = s(442837), o = s(692547), u = s(481060), d = s(987209), _ = s(706454), m = s(509545), E = s(669079), I = s(930153), p = s(74538), N = s(937615), T = s(104494), x = s(474936), S = s(689938), h = s(901770);
function P(e) {
    let {
    ...
    let L = null != n && n.planId === s, y = L || s === x.Xh.PREMIUM_MONTH_TIER_2 && null != n && [
            x.Xh.PREMIUM_YEAR_TIER_0,
            x.Xh.PREMIUM_YEAR_TIER_1
        ].includes(n.planId), Z = x.nH[s], b = (0, p.aS)(s, !1, O, P), D = (0, p.Ap)(P.paymentSourceId), G = null != Z && !f, U = (0, T.Ng)(), F = C.interval === x.rV.YEAR ? S.Z.Messages.BILLING_TRIAL_YEARLY_PRICE_AFTER_TRIAL : S.Z.Messages.BILLING_TRIAL_MONTHLY_PRICE_AFTER_TRIAL, B = () => null != Z && (0, l.jsx)(u.Text, {
            tag: 'span',
            variant: 'eyebrow',
            color: 'always-white',
            className: h.planOptionDiscount,
            children: S.Z.Messages.BILLING_PLAN_SELECTION_DISCOUNT.format({ discount: (0, I.T3)(g, Z / 100) })
            ...
            (0, l.jsxs)('div', {
                ...
                children: [
                            ...
                            (0, l.jsxs)('div', {
                                children: [
                                    ...
                                    j && (0, l.jsx)('div', {
                                        ...
                                        children: S.Z.Messages.ONE_TIME_CHARGE.format({ currencyAmount: (0, N.T4)(b.amount, b.currency) })
                                    })
                                ]
                            }),
                            L && (0, l.jsxs)('span', {
                    ...
                    f ? (0, l.jsx)('div', {
                        ...
                        children: S.Z.Messages.BILLING_TRIAL_PRICE_NOW.format({ price: A && null != v && C.interval === x.rV.MONTH ? (0, N.T4)(b.amount - v, b.currency) : M ? (0, N.T4)(0, b.currency, { maximumFractionDigits: 0 }) : (0, N.T4)(b.amount, b.currency) })
                    }) : (0, l.jsx)('div', {
                        className: i()({ [h.optionSelected]: r || j }),
            ...
            f && (0, l.jsx)('div', {
                ...
                children: (0, l.jsx)(u.Text, {
                    ...
                    children: (() => {
                        ...
                        return M ? F.format({ price: (0, N.T4)(b.amount, b.currency) }) : (C.interval === x.rV.YEAR && S.Z.Messages.BILLING_YEARLY_PLAN_SAVINGS.format({ percent: Z }), null);
                    })()
                })
            })
        ]

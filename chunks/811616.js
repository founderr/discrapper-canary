...
k = () => y.interval === N.rV.YEAR && null != n || w && !R ? y.interval === N.rV.YEAR && null != n ? (0, i.jsxs)('span', {
...
children: [
    ...
    children: [
      ...
      b ? (0, i.jsx)('div', {
        ...
        children: S.Z.Messages.BILLING_TRIAL_PRICE_NOW.format({
          price: g && null != P && y.interval === N.rV.MONTH ? (0, E.T4)(Z.amount - P, Z.currency) : v ? (0, E.T4)(0, Z.currency, {
  ...
  b && (0, i.jsx)('div', {
    ...
    children: (0, i.jsx)(u.Text, {
      ...
      children: (() => {
        if (g && null != P && y.interval === N.rV.MONTH) {
          var e;
        ...
        }) : (y.interval === N.rV.YEAR && S.Z.Messages.BILLING_YEARLY_PLAN_SAVINGS.format({
          percent: j
        }), null);
      })()
    })

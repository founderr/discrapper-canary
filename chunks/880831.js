...
function j(e) {
  ...
  let {
    message: n
  } = e, l = (0, c.e7)([x.Z], () => x.Z.isBlockedForMessage(n)), r = (0, E.Uj)(n), o = a.useContext(m.Z), [d, I] = a.useState(!1), v = (0, _.p)(), S = a.useCallback(e => {
    if ("A" !== e.target.nodeName) h.Z.updateChatOpen(n.channel_id, !0), p.Z.jumpToMessage({
      channelId: n.channel_id,
      messageId: n.id,
      flash: !0
    })
  }, [n.channel_id, n.id]), Z = null != n.content && "" !== n.content ? (0, f.ZP)(n, {
    isInteracting: d,
  ...
  return (0, i.jsxs)(u.Clickable, {
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [null != O ? null : L, null !== (t = null != R ? R : O) && void 0 !== t ? t : (0, i.jsx)("span", {
        children: A
      }), null != O ? null : j]
    }), (0, i.jsx)("img", {
      alt: "",
  ...
  let {
    ...
    a.useEffect(() => {
      function e(e) {
        ...
        if (t === n && i.type !== A.uaV.STAGE_START && i.type !== A.uaV.STAGE_END && i.type !== A.uaV.STAGE_TOPIC && i.type !== A.uaV.STAGE_SPEAKER && i.type !== A.uaV.STAGE_RAISE_HAND) clearTimeout(m.current), m.current = setTimeout(_, s), o(e => [...e, i.id])
      }
    ...
    return {
      toastsHidden: u,
      toastMessages: (0, c.Wu)([I.Z], () => f.map(e => I.Z.getMessage(n, e)), [n, f]).filter(S.lm)
    }
  }({
    channelId: t,
    isFrozen: l,

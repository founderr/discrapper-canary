...
function j(e) {
  ...
  let {
    message: n
  } = e, s = (0, u.useStateFromStores)([T.default], () => T.default.isBlocked(n.author.id)), r = (0, C.useNullableMessageAuthor)(n), o = l.useContext(m.default), [c, _] = l.useState(!1), x = (0, p.useActiveKeywordFiltersCacheKey)(), v = l.useCallback(e => {

...
class l {
    ...
    static extend(e, t) {
        ...
        if (null == t)
            return e;
        let s = null !== (r = null !== (n = null == t ? void 0 : t.width) && void 0 !== n ? n : null == e ? void 0 : e.width) && void 0 !== r ? r : 0, l = null !== (a = null !== (i = null == t ? void 0 : t.height) && void 0 !== i ? i : null == e ? void 0 : e.height) && void 0 !== a ? a : 0;
        return {
            width: s,
            height: l,
...
class u {
    getQuality(e) {
        let t = this.connection.getLocalWant(e), n = this.isStreamContext ? this.getGoliveQuality(t) : this.getVideoQuality(t);
    ...
    getVideoQuality(e) {
        let t = this.ladder.getResolution(e), n = this.options.videoBitrate.min * t.budgetPortion, r = this.options.videoBitrate.max * t.budgetPortion, i = this.isMuted ? t.mutedFramerate : t.framerate;
        return new s({
            encode: {
                ...t,
                framerate: i

...
function _(e) {
  ...
  this._readableState = new E(e, this, t), this.readable = !0, e && ("function" == typeof e.read && (this._read = e.read), "function" == typeof e.destroy && (this._destroy = e.destroy)), l.call(this)
}
...
function M(e, t, n, r, o) {
  ...
  if (null === t) c.reading = !1,
    function(e, t) {
      ...
      var n, r;
      if (r = t, !d.isBuffer(r) && !(r instanceof f) && "string" != typeof t && void 0 !== t && !e.objectMode) n = new m("chunk", ["string", "Buffer", "Uint8Array"], t);
      return n
    }(c, t)), a) S(e, a);
  else if (c.objectMode || t && t.length > 0) {
    if ("string" != typeof t && !c.objectMode && Object.getPrototypeOf(t) !== d.prototype) {
      ;
      s = t, t = d.from(s)
    }
...
_.prototype._read = function(e) {
  ...
  function s(t, o) {
    i("onunpipe"), t === n && o && !1 === o.hasUnpiped && (o.hasUnpiped = !0, function() {
      i("cleanup"), e.removeListener("close", h), e.removeListener("finish", v), e.removeListener("drain", l), e.removeListener("error", p), e.removeListener("unpipe", s), n.removeListener("end", a), n.removeListener("end", g), n.removeListener("data", f), d = !0, r.awaitDrain && (!e._writableState || e._writableState.needDrain) && l()
    }())
  }
  ...
  function f(t) {
    i("ondata");
    var o = e.write(t);
    i("dest.write", o), !1 === o && ((1 === r.pipesCount && r.pipes === e || r.pipesCount > 1 && -1 !== z(r.pipes, e)) && !d && (i("false write response, pause", r.awaitDrain), r.awaitDrain++), n.pause())
  }

...
function S(e) {
  let t = function(e) {
    ...
    [n, r] = (0, i.useStateFromStores)([C.default], () => a.partition(t, e => C.default.hasJoined(e)), [t], i.statesWillNeverBeEqual);
  return {
    joinedThreadIds: n,
    unjoinedThreadIds: r
  }
...
function _(e, t, n) {
  ...
  let C = (0, i.useStateFromStoresArray)([p.default, u.default, o.default], () => a(p.default.getThreads(e.id, t, n)).filter(e => {

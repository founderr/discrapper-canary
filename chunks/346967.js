...
...s
  ...
  (0, o.t)();
  let [g] = n.recipients, C = (0, r.e7)([u.default], () => u.default.getUser(g));
  l()(null != C, 'ProfilePanelExperimentWrapper: user cannot be undefined');
  let I = (0, r.e7)([u.default], () => u.default.getCurrentUser());
  l()(null != I, 'ProfilePanelExperimentWrapper: currentUser cannot be undefined'), a.useEffect(() => {
(0, h.Z)(C, {
...
v = (0, d.sS)({
  ...
  return (a.useEffect(() => {
N(x);
  }, [x]), E) ? null : T && v ? (0, i.jsx)(p.Z, {
user: C,
channel: n,
onViewBlockedProfileClick: () => N(!1),
...s
  }) : C.isNonUserBot() ? (0, i.jsx)(_.Z, {
user: C,
channel: n,
...s
  }) : (0, i.jsx)(f.Z, {

...
class eB extends l.Component {
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      else if (n === S.CodedLinkType.CHANNEL_LINK) return (0, s.jsx)(em.default, {
        code: l,
        messageData: e
      }, l);

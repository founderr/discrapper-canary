...
var r = n(913527), i = n.n(r), a = n(55935);
function o(e, t, n) {
...
let s = /^[0]+/, l = /:00/, u = /(AM|ΠΜ|सुबह)/i, c = /(PM|ΜΜ|शाम)/i, d = /\s+/, _ = e => e.replace(s, '').replace(l, '').replace(u, '').replace(d, ''), E = e => e.replace(s, '').replace(c, '').replace(d, ''), f = (e, t) => {
        let n = t.toUpperCase().trim();
        if (n.length > 0) {
            let t = i()(''.concat(null == e ? void 0 : e.format('YYYY-MM-DD'), ' ').concat(n), 'YYYY-MM-DD LT');
            if (_(t.format('LT')) === _(n))
                return t;
        }
    }, h = i()('2021-04-12T00:00:00'), p = (e, t) => e.clone().hours(t.hour()).minutes(t.minutes()).seconds(0), m = (e, t) => e.value.unix() - t.value.unix();
class I {
    lookupByValue(e) {
        if (null == e)
            return;
    ...
    _generateTimeOptions() {
        ...
        let e = i()(h), t = i()(e).add(1, 'day'), n = i()(e);
        for (; n < t;) {
    ...
    _addNewOption(e) {
        let t = p(h, e), n = this._createLabel(t);

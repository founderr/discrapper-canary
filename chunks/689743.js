var r = n(814033), i = n(689118), a = n(806981), o = n(685053);
function s(e) {
...
i(s, a), e.exports = s, s.prototype.validate = function (e) {
...
}, i(l, a.BasePoint), s.prototype.decodePoint = function (e, t) {
    ...
    var n = this.x.redAdd(this.z), r = this.x.redSub(this.z), i = e.x.redAdd(e.z), a = e.x.redSub(e.z).redMul(n), o = i.redMul(r), s = t.z.redMul(a.redAdd(o).redSqr()), l = t.x.redMul(a.redISub(o).redSqr());

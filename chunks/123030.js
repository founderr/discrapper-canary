...
function S(e) {
  let {
    ...
    onClick: I,
    isActive: L
  } = e, _ = (0, a.useStateFromStores)([E.default], () => E.default.getGuildScheduledEvent(S)), m = (0, f.default)(t, null == _ ? void 0 : _.id), x = (0, a.useStateFromStores)([d.default], () => d.default.getGuild(null == _ ? void 0 : _.guild_id)), T = (0, a.useStateFromStores)([r.default], () => r.default.getChannel(null == _ ? void 0 : _.channel_id));
  if (null == _) return null;
  let {
    is_canceled: R = !1
  } = null != m ? m : {}, p = (null == m ? void 0 : m.scheduled_start_time) != null ? new Date(null == m ? void 0 : m.scheduled_start_time) : s, M = (0, h.getNextRecurrenceIdInEvent)(_), B = R ? g.GuildScheduledEventStatus.CANCELED : g.GuildScheduledEventStatus.SCHEDULED;
  M === t && (B = _.status);
  let G = e => {

...
let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
  t = null,
  n = null;
return T.$k && (e || !R.isAnimated(this.props)) ? (t = 'webp', R.isSrcPNG(this.props) && (n = 'lossless')) : e && (t = 'png'), {
  format: t,
  quality: n
};
  }
...
if (e && h.Z.increment({
  ...
  }), !this.imageLoadAnalyticsEnabled)
  return;
...
super(e), N(this, 'imageLoadAnalyticsEnabled', !1), N(this, 'state', {
  ...
  this.setState({
    readyState: e ? S.zo9.ERROR : S.zo9.READY
  }, () => {
    var n;
  ...
  (1 !== i || 1 !== a) && this.loadImage(this.getSrc((0, g.Dc)({
    width: i,
    height: a,
    maxWidth: n,
    maxHeight: r
...
N(R, 'visibilityObserver', new c.Z({
  threshold: 0.7
})), N(R, 'defaultProps', {
  shouldLink: !1,
  autoPlay: !1,

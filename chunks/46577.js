...
var n = s(735250), a = s(470079), l = s(442837), o = s(481060), i = s(239091), r = s(410575), u = s(881052), d = s(299206), _ = s(430824), M = s(236413), c = s(727072), E = s(36459), O = s(65912), T = s(572456), R = s(273504), D = s(981631), U = s(689938);
function I(e) {
    let {
            rule: t,
            analyticsContext: s,
            onSelect: I
        } = e, g = (0, M.Vb)(t), A = function (e) {
            let {
                editingRule: t,
                setEditingRule: s
            } = (0, O.V)();
            ...
            let {setEditingRule: t} = (0, O.V)(), [s, i] = a.useState(!1), {removeRule: r} = (0, c.pH)(e.guildId), d = (0, l.e7)([_.Z], () => _.Z.getGuild(e.guildId)), M = async () => {

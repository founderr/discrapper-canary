...
function N(e) {
  ...
  } = e, j = n.useRef(null), R = (0, a.useStateFromStores)([c.default], () => c.default.getRulesPrompt(l.id)), [b, S] = n.useState(null !== (t = null == R ? void 0 : R.response) && void 0 !== t && t), C = (0, a.useStateFromStores)([c.default], () => c.default.get(l.id)), T = (0, o.default)(), _ = n.useRef(null), M = n.useRef(null), D = (0, r.isThemeDark)(T) ? "linear-gradient(to top, rgba(54, 57, 63, 1), rgba(54, 57, 63, 0))" : "linear-gradient(to top, rgba(242, 243, 245, 1), rgba(242, 243, 245, 0))", B = n.useCallback(async () => {
    if (null != C && null != R) {
      try {

...
var s = n(735250), r = n(470079), o = n(120356), l = n.n(o), i = n(920906), a = n(442837), d = n(481060), c = n(749210), u = n(830064), m = n(393238), p = n(607070), h = n(480608), g = n(160404), x = n(703656), f = n(430824), _ = n(257915), N = n(768581), I = n(302221), b = n(956664), C = n(549817), E = n(45966), v = n(819553), j = n(548473), O = n(15320), Z = n(973051), B = n(981631), R = n(689938), T = n(749153);
async function D(e) {
...
function M(e) {
    let {guildId: t} = e, n = (0, a.e7)([p.Z], () => p.Z.useReducedMotion), {
            ref: o,
            width: b,
            height: M
    ...
    let q = r.useCallback(e => {
            ...
            t,
            G
        ]), V = (0, a.e7)([g.Z], () => g.Z.isFullServerPreview(t)), z = (0, a.e7)([v.ZP], () => v.ZP.getOnboardingStatus(t)), Y = null != S && S.length > 0, Q = r.useCallback(() => {
            (0, v.kp)(z) && L && Y ? q(0) : w();
        }, [
            z,
            L,
    ...
    let W = (0, i.useTransition)(G, {
        ...
        }), X = v.ZP.shouldShowOnboarding(t), K = null == F;
    if (r.useEffect(() => {
            if (!X || K) {
                let e = setTimeout(() => {
    ...
    return (0, s.jsxs)('div', {
        ...
        children: [
            ...
            null != P && (0, s.jsx)('div', {
                ...
                style: { background: 'linear-gradient(180deg, '.concat((0, I.aD)(P, 0.16), ' 0%, ').concat((0, I.aD)(P, 1), ' 100%)') }
            }),
            (0, s.jsx)('div', { className: T.gradient }),
            W((e, t, n) => {
                let {key: r} = n;
            ...
            'cover' === G && (0, s.jsx)('div', {
                ...
                children: (0, s.jsx)(d.Heading, {
                    ...
                    children: R.Z.Messages.ONBOARDING_COVER_PRIVACY_POLICY.format({ privacyLink: B.EYA.PRIVACY })
                })
            })
        ]
    });

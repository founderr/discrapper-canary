n(47120);
var s = n(710845), a = n(314897), r = n(430824), i = n(411198), l = n(625137), o = n(287328);
let c = new s.Z('Guilds');
t.Z = new class e {
    async getAsync(e) {
        let t = performance.now(), n = await o.Z.guilds(e).getMany(), s = performance.now();
    ...
    handleConnectionOpen(e, t) {
        for (let n of (this.clear(t), e.guilds))
            this.putOne(n, t);
    }
    ...
    handleGuildUpdate(e, t) {
        let n = r.Z.getGuild(e.guild.id), s = i.di(e.guild, n);
    ...
    handleGuildRoleChange(e, t) {
        let n = r.Z.getGuild(e.guildId), s = r.Z.getRoles(e.guildId);
    ...
    putOne(e, t) {
        let n = r.Z.getGuild(e.id), s = i.cy(i.wD(e, n), e.roles instanceof Array ? (0, l.C5)(e.id, e.roles) : e.roles);
        this.put(s, t);
    }
    put(e, t) {

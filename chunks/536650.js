...
function A(e) {
    let {
            ...
            let u = _.current, d = f.current, m = N.current, p = parseInt(null !== (e = null == P ? void 0 : P.height) && void 0 !== e ? e : ''), E = parseInt(null !== (n = null == x ? void 0 : x.height) && void 0 !== n ? n : '');
            if (null != u && null != d && null != m && !isNaN(p) && !isNaN(E)) {
                ;
                let e = null !== (t = u.scrollTop) && void 0 !== t ? t : 0, n = 0 !== u.scrollHeight ? u.scrollHeight : E + 20, _ = 0 !== u.clientHeight ? u.clientHeight : E + 20, f = E - p, h = (0, a.clamp)(n - _, f + 1, E + 20);

...
function _(e) {
  let t, n, _, {
    ...
    S = I === T.id;
  return S ? (t = E.default.Messages.INVITE_BUTTON_INVALID_OWNER, _ = E.default.Messages.INVITE_BUTTON_TITLE_INVITER_INVALID) : (_ = E.default.Messages.INVITE_BUTTON_TITLE_INVITED_INVALID, m ? t = E.default.Messages.INSTANT_INVITE_BANNED_INFO : null != p ? (t = E.default.Messages.INSTANT_INVITE_ASK_USER_FOR_NEW_INVITE.format({
    username: p

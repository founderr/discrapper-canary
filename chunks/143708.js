...
function m(e) {
  let t, n, m, {
    ...
    N = (0, a.e7)([r.Z], () => r.Z.getChannelId()),
    f = d.ZP.useName(I),
    p = h === I.id;
  return p ? (t = _.Z.Messages.INVITE_BUTTON_INVALID_OWNER, m = _.Z.Messages.INVITE_BUTTON_TITLE_INVITER_INVALID) : (m = _.Z.Messages.INVITE_BUTTON_TITLE_INVITED_INVALID, T ? t = _.Z.Messages.INSTANT_INVITE_BANNED_INFO : null != f ? (t = _.Z.Messages.INSTANT_INVITE_ASK_USER_FOR_NEW_INVITE.format({
    username: f
  }), n = (0, i.jsx)(o.Z.Button, {
    onClick: function() {
      let {
        id: e
      } = I, t = "@".concat(d.ZP.getUserTag(I, {
        decoration: "never"
      }));

...
var s = n("37983"),
  ...
  T = function(e) {
    ...
    }), D = (0, l.useStateFromStores)([u.default], () => u.default.didAgree(x)), P = D && !O, j = a.useMemo(() => !N && (T.isPrivate() && !T.isManaged() || null != x && (!T.isNSFW() || P) && v && d.default.canChatInGuild(x)), [v, P, T, x, N]), b = y ? S.ChannelTypesSets.GUILD_THREADS_ONLY.has(T.type) ? _.default.Messages.UPLOAD_TO_NEW_POST : _.default.Messages.UPLOAD_TO_NEW_THREAD : M ? _.default.Messages.UPLOAD_TO.format({
    ...
    return R || !j ? null : (0, s.jsx)(E.default, {
      ...
      onDrop: e => {
        if (R) return !1;
        j && null != T && ((0, m.promptToUpload)(e, T, A, {
          requireConfirm: M,

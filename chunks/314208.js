...
var a = t(735250), s = t(470079), l = t(442837), r = t(481060), i = t(99690), o = t(58540), c = t(471445), d = t(905405), u = t(937889), h = t(739566), m = t(267128), g = t(271383), E = t(306680), f = t(699516), Z = t(594174), x = t(709054), T = t(51144), v = t(144140), _ = t(91159), R = t(217702), j = t(689938), N = t(322515);
function S(e) {
...
function I(e) {
    ...
    let c = (0, l.e7)([Z.default], () => {
            ...
            nick: g,
            colorString: E
        } = (0, h.ZP)(t), T = (0, l.e7)([f.Z], () => f.Z.isBlockedForMessage(t)), v = (0, d.p)(), j = s.useMemo(() => {
...
function M(e) {
    var n, t, s;
    let {channel: d} = e, u = (0, l.e7)([E.ZP], () => E.ZP.lastMessageId(d.id)), h = null == u ? new Date(null !== (t = null === (n = d.threadMetadata) || void 0 === n ? void 0 : n.archiveTimestamp) && void 0 !== t ? t : Date.now()).getTime() : x.default.extractTimestamp(u);
    (0, o.$)({ [d.guild_id]: [d.ownerId] });
    let m = (0, l.e7)([Z.default], () => Z.default.getUser(d.ownerId)), f = (0, l.e7)([g.ZP], () => g.ZP.getMember(d.guild_id, d.ownerId)), v = null !== (s = (0, c.KS)(d)) && void 0 !== s ? s : r.ThreadIcon;

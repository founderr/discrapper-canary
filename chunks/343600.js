...
function S(e) {
  ...
  return (0, t.jsxs)(n.ModalHeader, {
    ...
    children: [(0, t.jsx)("div", {
      ...
      children: null != a ? (0, t.jsx)(n.Avatar, {
        src: a,
        "aria-label": s.name,
      ...
      children: [(0, t.jsx)(n.Heading, {
        ...
        children: x.default.Messages.SAFETY_REMOVE_RISKY_PERMS_MODAL_TITLE
      }), (0, t.jsx)(n.Text, {
        variant: "text-md/normal",
        color: "header-primary",
        children: x.default.Messages.SAFETY_REMOVE_RISKY_PERMS_MODAL_SUBTITLE
      })]
    })]
  })
}
let N = e => {
  if (e.toString() === m.Permissions.MENTION_EVERYONE.toString()) return x.default.Messages.ENABLE_COMMUNITY_MODAL_EVERYONE_ROLE_PERMISSION_MENTION_EVERYONE;
...
function I(e) {
  ...
  return (0, t.jsxs)("div", {
    ...
    children: [(0, t.jsx)(n.Text, {
      ...
      color: "text-muted",
      children: x.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_ENABLED_PERMISSIONS
    }), (0, t.jsx)("div", {
...
function _(e) {
  ...
  return (0, t.jsxs)("div", {
    ...
    children: [(0, t.jsx)(n.Text, {
      ...
      variant: "text-xs/semibold",
      color: "text-muted",
      children: x.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_DISABLED_PERMISSIONS
    }), (0, t.jsx)("div", {
      className: E.permissionsTable,
      children: s.map((e, s) => (0, t.jsxs)("div", {
        className: E.permissionRow,
...
function h(e) {
  ...
  return (0, t.jsxs)(n.ModalFooter, {
    ...
    children: [(0, t.jsx)(n.Button, {
      onClick: s,
      children: x.default.Messages.UPDATE_COMMUNICATION_NOTIFICATIONS_CONFIRMATION
    }), (0, t.jsx)(n.Button, {
...
function j(e) {
  let {
    ...
    let e = [],
      a = [];
    return u.MODERATOR_PERMISSIONS.map(t => {

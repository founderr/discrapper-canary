...
activated: d,
hqStreamingState: _
  } = (0, F.k)(h.q.STREAM_HIGH_QUALITY), f = null != u && d, C = l.useRef(null), I = t.getGuildId(), x = l.useCallback(() => {
if (null == i || i(), !a)
  return (0, eC.Z)();
...
canGoLive: (0, U.Z)(es.Z)
  })), g = (0, y.Z)(), x = (0, m.e7)([O.Z], () => null != O.Z.getAwaitingRemoteSessionInfo()), v = null != g, S = (0, m.e7)([el.Z], () => {
var e;

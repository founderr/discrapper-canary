...
function ev(e) {
    let { channel: t, currentUser: n, exitFullScreen: i, canGoLive: s, hasPermission: r, disabled: o } = e,
        ...
        T = l.useCallback(() => {
            ...
            (0, ef.Z)(x, t.id, eg.ZY5.GUILD_CHANNEL);
        }, [x, t.id, s, i]),
        ...
        M = (e, t) => {
            ...
            return (0, a.jsx)(J.O, {
                ...
                onPopoutClick: s
                    ? function (e) {
                          E.hqStreamingIsEnabled && !E.hqStreamingPopoutDismissed && Z(), null == n || n(e);
                      }
                    : null,
                popoutOpen: t,
                shouldShowTooltip: !t,
...
let eN = l.memo(function (e) {
    let { connectedActivityApplicationId: t, currentUser: n, onDisconnectCall: i, channel: s } = e,
        ...
        p = (0, m.e7)([$.Z], () => (null != h ? $.Z.getActiveStreamForStreamKey(h) : null), [h]),
        f = (null == r ? void 0 : r.type) === eC.fO.STREAM && null != p && p.ownerId !== (null == n ? void 0 : n.id),
        C = (0, m.Wu)([$.Z], () =>
    ...
    return (0, a.jsxs)(a.Fragment, {
        children: [
            (0, a.jsx)(Q.C, {
                ...
                className: ex.controlButton,
                iconClassName: ex.__invalid_joinIcon,
                onChange: d
            }),
            (0, a.jsx)(Y.Z, {
                centerButton: !0,
                color: 'green',
                channel: t,
                className: o()(ex.controlButton, ex.__invalid_lastButton)
            }),
            p
                ? (0, a.jsx)(z.Z, {
                      color: 'red',
...
t.ZP = function (e) {
    ...
    let { channel: n, className: i, onDisconnectCall: s, exitFullScreen: l, idleProps: r } = e,
        ...
        P = (0, m.e7)([en.Z], () => {
            var e;
            return (null !== (e = null == T ? void 0 : T.channelId) && void 0 !== e ? e : en.Z.getVoiceChannelId()) === n.id;
        }),
        y = (0, Z.Z)(n, !0),
        D = (0, m.e7)([x.ZP], () => {

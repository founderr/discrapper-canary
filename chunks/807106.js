...
let c = (e, t) => {
  ...
  return t.forEach(e => {
    ...
    var t, i;
    let [l] = e, n = null === (i = l.application.embeddedActivityConfig) || void 0 === i ? void 0 : null === (t = i.client_platform_config[(0, o.default)((0, u.getOS)())]) || void 0 === t ? void 0 : t.label_type;

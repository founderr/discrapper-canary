...
let u = {
    ...
    TAX_EXCLUSIVE: new Set([
        'CA',
        'US'
    ]),
    NITRO_TAX_EXCLUSIVE_COUNTRIES: new Set([
        'CA',
        'KR',
        'US'
    ]),
    TAX_ADDRESS_REQUIRE_POSTAL_CODE: new Set([
        'CA',
        'US'
    ]),
    NITRO_TAX_EXCLUSIVE_EXPERIMENT_STATES: new Set([
        'TN',
        'WI'
    ]),

e.exports = {
    settingsColumn: 'settingsColumn_b2b948 ' + n('765063').customColumn,
    settingsContainer: 'settingsContainer_b2b948 ' + n('765063').customContainer,
    settingsScroller: 'settingsScroller_b2b948 ' + n('765063').customScroller + ' ' + n('765063').contentRegionScroller,
    settingsContent: 'settingsContent_b2b948 ' + n('765063').contentColumnDefault + ' settingsColumn_b2b948 ' + n('765063').customColumn,

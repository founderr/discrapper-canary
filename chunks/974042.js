...
class N {
  reset() {
    let e = a().map(I.Z.getRelationships(), (e, t) => new S({
        key: t,
        type: e,
      ...
      t = a().map(d.Z.getSuggestions(), e => new S({
        key: e.key,
        type: 99,
        nickname: e.name,
        ...T(e.key),
...
function P() {
  if (A = !0, O ? Z = !1 : x(), v = v.reset(), R) return;
...
class D extends(i = r.ZP.Store) {
  initialize() {
    this.waitFor(I.Z, h.Z, m.default, E.Z, _.ZP, u.Z, d.Z), this.syncWith([I.Z], b), this.syncWith([d.Z], b), this.syncWith([m.default], M(T)), this.syncWith([h.Z, u.Z], M(C)), P()
  }
  getState() {
    return {
      fetching: Z,

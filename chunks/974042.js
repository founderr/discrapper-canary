...
class U extends (i = r.ZP.Store) {
    initialize() {
        this.waitFor(p.Z, I.Z, g.default, m.Z, h.ZP, E.Z, d.Z), this.syncWith([p.Z], y), this.syncWith([d.Z], y), this.syncWith([u.Z], y), this.syncWith([g.default], j(f)), this.syncWith([I.Z, E.Z], j(N)), D();
    }
    getState() {
        return {
            fetching: R,

...
function R() {
    ...
    x && (e || (L !== I.pJs.ONLINE && L !== I.pJs.ADD_FRIEND)) && !Z && ((x = !1), (Z = !0), s.Z.fetchRelationships());
}
function j() {
    if (((x = !0), y ? (Z = !1) : R(), (P = P.reset()), O)) return;
...
function M(e) {
    return function () {
        return !y && !!P.update(e) && ((P = P.clone()), !0);
    };
}

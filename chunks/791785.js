...
purchaseType: eM,
defaultPlanId: eh
  } = (0, N.usePaymentContext)(), ev = (0, k.Z)(), eI = J || (null == ev ? void 0 : ev.isLargeModal) ? s.ModalSize.LARGE : s.ModalSize.SMALL, {
isGift: ey,
giftRecipient: eN,
customGiftMessage: eR,
emojiConfetti: eC,
soundEffect: ek
  } = (0, y.wD)(), eL = (0, p.Ng)(), eZ = null != T && !ey && (0, p.Wp)(eL, T), [eO, eb] = i.useState({
load_id: em.loadId,
...
if (null != eh && el ? ed(eh) : ed(m), null != z)
  ea(z);
else if (null != m) {
  var e;
...
ex = i.useMemo(() => () => null == M ? void 0 : M(eu === C.A.COMPLETED, er), [
  M,
  eu,
  er
]),
...
isGift: C
  } = (0, y.wD)(), k = v.current, O = (0, Z.Z)({
isGift: C,
skuId: S,
referralTrialOfferId: o
  }), {
defaultToMonthlyPlan: w
  } = T.k.getCurrentConfig({
location: '055ec5_1'
  }, {
autoTrackExposure: !1
  }), {
redirectToPlanSelectStep: D
  } = m.m.useExperiment({
location: 'PaymentPredicateStep'
  }, {
autoTrackExposure: !1
  }), [U, G] = i.useState(!0), Y = (0, a.e7)([M.Z], () => M.Z.applicationIdsFetched.has(x.RQ));
  return (i.useEffect(() => {
G(!p || !A || g);
  }, [
g,

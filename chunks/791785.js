...
function w(n) {
  ...
  let nU = u.useCallback(() => {
      let n = (0, S.MY)(nR) === S.xr.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD,
        e = Date.now();
    ...
    }, [nk, ng, ny, nR, nP, nC, nf.startTime, nx]),
    nD = u.useMemo(() => () => null == C ? void 0 : C(nu === y.A.COMPLETED, nr), [C, nu, nr]),
    nG = (0, a.Z)(() => Date.now(), [nE]),
    ...
    }, [nc, Q, nd, nE, nk, nG, nf.startTime, nU, d, ne, nD, nM]);
...
function b(n) {
  let {
    ...
    autoTrackExposure: !1
  }), [x, D] = u.useState(!0), G = (0, o.e7)([A.Z], () => A.Z.applicationIdsFetched.has(U.RQ));
  return (u.useEffect(() => {
    D(!m || !T || M)
  }, [M, T, m]), (0, d.Z)("Payment Modal", x, 5, {
    hasFetchedSubscriptions: m,
    hasFetchedSubscriptionPlans: T,
    currencyLoading: M
  }, {
  ...
  }, [E, p, G, t, x, i, e, I, v, O, Z, S, y, g, s]), x) ? (0, l.jsx)(k.Z, {}) : p ? (0, l.jsx)(_.Vq, {
    onClose: a
  }) : null
}
...
var a = n("37983"),
  ...
  N = e => {
    ...
    let {
      guildId: n,
      inviteCode: N
    } = e, [R, O] = s.useState(m.WaveStates.INITIAL), L = (0, i.useStateFromStores)([_.default], () => _.default.get(n)), v = (0, i.useStateFromStores)([C.default], () => C.default.getRequest(n)), M = (0, i.useStateFromStores)([o.default], () => o.default.getGuild(n)), {

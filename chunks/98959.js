...
var r = n("697309"),
  ...
  m = {
    ...
    fn: function(e) {
      ...
      if (E) {
        if (void 0 === h || h) {
          var I, R = "y" === x ? r.top : r.left,
            A = "y" === x ? r.bottom : r.right,
            z = "y" === x ? "height" : "width",
            W = E[x],
            B = W + D[R],
            U = W - D[A],
            ...
            Q = $[R],
            Z = $[A],
            X = (0, s.within)(0, P[z], q[z]),
            ee = Y ? P[z] / 2 - K - X - Q - H.mainAxis : V - X - Q - H.mainAxis,
            et = Y ? -P[z] / 2 + K + X + Z + H.mainAxis : J + X + Z + H.mainAxis,

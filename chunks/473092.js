...
function c(e) {
  ...
  l.default.track(_.rMx.SAFETY_WARNING_VIEWED, {
    channel_id: t,
...
function E(e) {
  ...
  l.default.track(_.rMx.SAFETY_WARNING_CTA_CLICKED, {
    channel_id: t,
    warning_id: null != n ? parseInt(n) : void 0,
    warning_type: r,
    other_user_id: i,

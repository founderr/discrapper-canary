...
function F(e) {
  ...
  function H() {
    I.default.track(L.AnalyticEvents.CHANNEL_ATTACH_MENU_USE_APPS_CLICKED), M("/", (0, N.toRichValue)("/"))
  }
  ...
  function W() {
    let e = _,
      ...
      a = "",
      l = _.match(b);
    null != l && (a = l[1], n = l[2], e = l[3], a += l[4]), (0, x.promptToUpload)([(0, v.makeFile)(new Blob([e], {
      type: "text/plain"

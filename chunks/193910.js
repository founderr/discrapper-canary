...
function j(e) {
    let { channel: t, options: l, onFileUpload: c, onClose: p, onSelect: _, draftType: E, editorTextContent: j, setValue: O, openClips: P } = e,
    ...
    function k() {
        g.default.track(S.rMx.CHANNEL_ATTACH_MENU_USE_APPS_CLICKED), O('/', (0, x.JM)('/'));
    }
    function U() {
        P();
    }

...
function b(e) {
  let {
guildId: n
  } = e, [s, o] = a.useState(''), I = (0, i.e7)([h.Z], () => h.Z.getGuild(n)), b = (0, i.e7)([u.ZP], () => u.ZP.getChannels(n)), E = (0, i.e7)([d.Z], () => d.Z.getCategories(n)), Z = (0, f.Fo)(n, E, b, s), v = (0, i.e7)([m.Z], () => m.Z.canWithPartialContext(p.Plq.MANAGE_CHANNELS, {
guildId: n
  })), T = (0, i.e7)([c.ZP], () => null != c.ZP.getCurrentSidebarChannelId(x.oC.CHANNEL_BROWSER)), j = a.useCallback(() => o(''), [o]), S = a.useCallback(() => {
  ...
  (0, l.jsxs)('div', {
    ...
    children: [
      (0, l.jsx)(r.SearchBar, {
        ...
        query: s,
        onChange: e => {
          '' === s && '' !== e && _.default.track(p.rMx.SEARCH_STARTED, {

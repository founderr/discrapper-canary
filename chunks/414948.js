...
function _(e, t = {}) {
    ...
    for (let t in e)
        Object.prototype.hasOwnProperty.call(e, t) && (u.has(t) || n && c.has(t) || (null == r ? void 0 : r.has(t)) || d.test(t)) && (i[t] = e[t]);
    return i;
}
let E = new Map(), f = new Set();
function h() {

    ...
    case null != _:
      if ((null == _ ? void 0 : _.newValue) != null) {
        let E = new Date(null == _ ? void 0 : _.newValue).getTime(),
          ...
          T = Math.round((E - s) / 1e3 / 60),
          I = [A.J6.DAYS, A.J6.HOURS, A.J6.MINUTES, A.J6.SECONDS],
          n = (0, A.CI)(T, I);
...
function J(e, _) {
  switch (e) {
    ...
    case o.Plq.MANAGE_CHANNELS:
      if (_.targetType === o.KFR.CHANNEL || _.targetType === o.KFR.CHANNEL_OVERWRITE) return c.Z.Messages.MANAGE_CHANNEL;

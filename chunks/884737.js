    ...
    case null != t:
      if ((null == t ? void 0 : t.newValue) != null) {
        let E = new Date(null == t ? void 0 : t.newValue).getTime(),
          ...
          a = (0, A.getTimeAndUnit)(Math.round((E - s) / 1e3 / 60), _);
...
function q(e, t) {
  ...
  return e.forEach(e => {
    ...
    if (null != a && (null != s || e.action === O.AuditLogActions.MEMBER_PRUNE || e.action === O.AuditLogActions.MEMBER_DISCONNECT || e.action === O.AuditLogActions.MEMBER_MOVE || e.action === O.AuditLogActions.CREATOR_MONETIZATION_REQUEST_CREATED || e.action === O.AuditLogActions.CREATOR_MONETIZATION_TERMS_ACCEPTED)) {
                ...
                return function(e) {
                  ...
                  return Object.values(O.SystemChannelFlags).forEach(s => {
                    let _ = (e.oldValue & s) === s,
                      a = (e.newValue & s) === s;
                    if (_ === a) return;
                    let T = new r.AuditLogChange(t[s], !_, !a);
                    E.push(T)
                  }), E
                }(e)
            }
...
function $(e, t) {
  let E = a.deserialize("string" == typeof e ? e : 0),
    s = a.deserialize("string" == typeof t ? t : 0),
    _ = a.remove(s, E),
    T = a.remove(E, s),
    A = [],
    n = [],
  ...
  for (let e in I) {
    let t = I[e];
    a.has(_, t) && A.push(t), a.has(T, t) && n.push(t)
  }
  return {
    added: A,
    removed: n
...
function et(e, t, E, s, _) {
  ...
  if (null != T && null != s && (a = s(T)), null == a && null != T && (a = T), null == a) {

...
let C = new a.Z('AuditLogUtils'),
    d = -1,
    g = () => ({ [u.zUn.REASON]: c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMON_REASON }),
    f = () => ({
    ...
    z = {
        ...
        [u.KFR.INTEGRATION]: { [u.zUn.TYPE]: !0 },
        [u.KFR.THREAD]: {
            [u.zUn.ID]: !0,
            [u.zUn.TYPE]: !0
        },
    ...
    switch (!0) {
        case null != _:
            if ((null == _ ? void 0 : _.newValue) != null) {
                ...
                if (n.unit in k) return k[n.unit](n.time);
                return null;
            }
...
function J(e, _) {
    switch (e) {
        ...
        case u.Plq.MANAGE_CHANNELS:
            if (_.targetType === u.KFR.CHANNEL || _.targetType === u.KFR.CHANNEL_OVERWRITE) return c.Z.Messages.MANAGE_CHANNEL;
                    ...
                    switch (e.targetType) {
                        ...
                        case u.KFR.INTEGRATION:
                            return e_(
                                e,
                                u.zUn.TYPE,
                                (e) => l.Z.integrations.find((_) => _.id === e),
                                (e) => e.name
                            );
                        case u.KFR.WEBHOOK:
                            return e_(
                        ...
                        case u.KFR.GUILD_SCHEDULED_EVENT:
                            return e_(
                                e,
                                u.zUn.NAME,
                                (e) => l.Z.guildScheduledEvents.find((_) => _.id === e),
                                (e) => e.name
                            );
                        case u.KFR.THREAD:
                            return e_(
                        ...
                        case u.KFR.APPLICATION_COMMAND:
                            ...
                            return e_(
                                e,
                                u.zUn.NAME,
                                (e) => l.Z.applicationCommands.find((_) => _.id === e),
                                (e) => {

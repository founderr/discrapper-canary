...
var E = s("654861"),
  ...
  O = s("765305"),
  C = s("689938");
let U = new u.default("AuditLogUtils"),
  M = -1,
  R = () => ({
  ...
  h = () => ({
    ...
    [G.AuditLogChangeKeys.TOPIC]: ea(C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CHANGE, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CREATE, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CLEAR),
    ...
    [G.AuditLogChangeKeys.RTC_REGION_OVERRIDE]: ea(C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CHANGE, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CREATE, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_DELETE),
  ...
  p = () => ({
    [G.AuditLogChangeKeys.NICK]: ea(C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_CHANGE, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_CREATE, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_DELETE),
    ...
    [G.AuditLogChangeKeys.COMMUNICATION_DISABLED_UNTIL]: ea(C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL, C.default.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL_REMOVED),
...
function k(e) {
  let t = j().find(t => t.value === e.action),
    s = w(G.AuditLogChangeKeys.COMMUNICATION_DISABLED_UNTIL, e);
  switch (!0) {
    case null != s:
...
function W(e) {
  let t = w(G.AuditLogChangeKeys.COMMUNICATION_DISABLED_UNTIL, e),
    ...
    let E = function(e, t) {
        switch (e.targetType) {
          ...
          case G.AuditLogTargetTypes.CHANNEL_OVERWRITE:
            return et(e, G.AuditLogChangeKeys.NAME, e => d.default.getChannel(e), e => (0, A.computeChannelName)(e, g.default, S.default, !0));
            ...
            if (t.action === G.AuditLogActions.APPLICATION_COMMAND_PERMISSION_UPDATE) {
              ...
              switch (t.type) {
                ...
                case G.ApplicationCommandPermissionTypes.CHANNEL:
                  t.id === _()(s.id).subtract(1).toString() ? e.subtarget = C.default.Messages.ALL_CHANNELS : e.subtarget = es(t.id, e => d.default.getChannel(e), e => (0, A.computeChannelName)(e, g.default, S.default, !0))
              }
              return e
            }
            switch (e.key) {
              ...
              case G.AuditLogChangeKeys.PUBLIC_UPDATES_CHANNEL_ID:
                return ee(e, e => d.default.getChannel(e), e => (0, A.computeChannelName)(e, g.default, S.default, !0));
              ...
              case G.AuditLogChangeKeys.VIDEO_QUALITY_MODE:
                return ee(e, e => e === G.VideoQualityMode.FULL ? C.default.Messages.VIDEO_QUALITY_MODE_FULL : C.default.Messages.VIDEO_QUALITY_MODE_AUTO);

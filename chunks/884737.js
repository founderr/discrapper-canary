...
let C = new r.Z('AuditLogUtils'), g = -1, d = () => ({ [o.zUn.REASON]: c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMON_REASON }), f = () => ({
        ...
        [o.KFR.INTEGRATION]: { [o.zUn.TYPE]: !0 },
        [o.KFR.THREAD]: {
            [o.zUn.ID]: !0,
            [o.zUn.TYPE]: !0
        },
...
function j(e) {
    let _ = K().find(_ => _.value === e.action), E = y(o.zUn.COMMUNICATION_DISABLED_UNTIL, e);
    switch (!0) {
    case null != E:
...
let k = {
    [A.J6.SECONDS]: e => c.Z.Messages.DURATION_SECONDS.format({ seconds: e }),
    [A.J6.MINUTES]: e => c.Z.Messages.DURATION_MINUTES.format({ minutes: e }),
    [A.J6.HOURS]: e => c.Z.Messages.DURATION_HOURS.format({ hours: e }),
    [A.J6.DAYS]: e => c.Z.Messages.DURATION_DAYS.format({ days: e })
};
function W(e) {
    let _ = y(o.zUn.COMMUNICATION_DISABLED_UNTIL, e), E = Y(o.zUn.ROLES_ADD, e).length > 0, s = Y(o.zUn.ROLES_REMOVE, e).length > 0;
    switch (!0) {
    case null != _:
        if ((null == _ ? void 0 : _.newValue) != null) {
            let E = new Date(null == _ ? void 0 : _.newValue).getTime(), s = R.default.extractTimestamp(e.id), T = Math.round((E - s) / 1000 / 60), I = [
                    A.J6.DAYS,
                    A.J6.HOURS,
                    A.J6.MINUTES,
                    A.J6.SECONDS
...
function w(e) {
    let _ = Y(o.zUn.ROLES_ADD, e), E = Y(o.zUn.ROLES_REMOVE, e), s = null == _ ? void 0 : _.map(e => {
            let {newValue: _} = e;
            return null == _ ? void 0 : _.map(e => {
                let {name: _} = e;
                return _;
            }).join(', ');
        }).join(', '), T = null == E ? void 0 : E.map(e => {
            let {newValue: _} = e;
            return null == _ ? void 0 : _.map(e => {
                let {name: _} = e;
                return _;
...
function Q(e, _) {
    ...
    return e.forEach(e => {
        let s = function (e, _) {
            ...
            }(e, _), I = i.default.getUser(e.userId);
                        ...
                        case o.zUn.SYSTEM_CHANNEL_FLAGS:
                            return function (e) {
                                ...
                                return Object.values(o.xmn).forEach(s => {
                                    let T = (e.oldValue & s) === s, I = (e.newValue & s) === s;
                                    if (T === I)
                                        return;
...
function $(e, _) {
    let E = I.vB('string' == typeof e ? e : 0), s = I.vB('string' == typeof _ ? _ : 0), T = I.Od(s, E), n = I.Od(E, s), A = [], t = [], a = { ...o.Plq };
    for (let e in a) {
        let _ = a[e];
...
function e_(e, _, E, s, T) {
    let I = null, n = E(T = null != T ? T : e.targetId);

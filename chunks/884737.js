    ...
    case null != t:
      if ((null == t ? void 0 : t.newValue) != null) {
        let E = new Date(null == t ? void 0 : t.newValue).getTime(),
          ...
          _ = [n.TimeUnits.DAYS, n.TimeUnits.HOURS, n.TimeUnits.MINUTES, n.TimeUnits.SECONDS],
          a = (0, n.getTimeAndUnit)(Math.round((E - s) / 1e3 / 60), _);
...
function $(e, t) {
  ...
  for (let e in I) {
    let t = I[e];
    a.has(_, t) && n.push(t), a.has(T, t) && A.push(t)
  }
  return {
    added: n,
    removed: A

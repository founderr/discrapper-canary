...
function d(e) {
  let {
    ...
    gridNotice: b,
    renderHeader: G
  } = e, w = r.useRef(null), k = r.useRef(null), B = r.useRef(null), x = 0 === t.length, V = (0, s.useExpressionPickerStore)(e => e.searchQuery), F = _.useStore(e => e.inspectedExpressionPosition), H = (0, a.useExpressionPickerGridWidth)({
    gridWrapperRef: w,
    containerWidth: d,
    showingEmptyState: x
  }), {

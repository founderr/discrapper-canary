...
imageUrl: c,
mimeType: r
  } = e, m = (0, o.e7)([I.Z], () => I.Z.getChannel(d));
...
imageUrl: y,
mimeType: S
  } = e, U = (0, o.e7)([f.Z], () => f.Z.getGuild(I.guild_id)), {
fetchState: Z,
imageRecCommandContexts: F
  } = (0, b.hR)({
channelId: I.id
  }), w = Z === R.M.FETCHING, D = (0, M.g)(I), L = (0, s.PL)(!0, !0), j = (0, s.LD)(I.guild_id, !0), k = N.P.useExperiment({
...
G = a.useCallback(async (e, t, n) => {
  var i, a;
  if (!D)
    return;
  let o = b.Id[e.id];
  await H(o.imageOption), null != p.Z.getActiveCommand(I.id) && u.Po({
    channelId: I.id,
    command: null,
    section: null
  });
...
B = a.useCallback(async (e, t) => {
  ...
  if ((0, E.qJ)({
    ...
    await H(t.imageOption), await (0, g.Z)({
      command: {
        ...e
      },
      optionValues: {

...
function w() {
  ...
  x(t), m.default.track(M.AnalyticEvents.NOTIFICATION_MIGRATION_COMPLETED, {
    auto_migrated: !0,
...
async function x(e) {
  await V(() => F()), await V(() => d.default.setAccountFlag(v.AccountNotificationFlags.USE_NEW_NOTIFICATIONS, !0));

...
var r = n(470079), i = n(392711), a = n.n(i), o = n(442837), s = n(433517), l = n(570140), u = n(668781), c = n(92114), d = n(181945), _ = n(149071), E = n(516373), f = n(480294), h = n(650774), p = n(888369), m = n(430824), I = n(771845), T = n(9156), g = n(626135), S = n(630388), A = n(823379), N = n(960048), v = n(709054), O = n(223683), R = n(630114), C = n(506712), y = n(468788), D = n(789662), L = n(981631), b = n(490897), M = n(526761), P = n(689938);
function U(e, t) {
    let [n, i] = r.useState(D.nf), [s, l] = r.useState({});
    (0, E.D)();
    let u = (0, o.Wu)([m.Z], () => Object.values(m.Z.getGuilds())), c = r.useCallback(() => {
            let r = {};
            for (let i of u)
                r[i.id] = function (e, t, n, r, i) {
                    var a;
                    let [o, s, l] = f.Z.hasConsented(L.pjP.PERSONALIZATION) ? (0, C.q)(e, t, n, r, !0) : (0, C.A)(e, n), u = null !== (a = n.filter(t => t.guild_id === e.id)[0]) && void 0 !== a ? a : {}, c = (0, R.Z)(e, null != i ? i : o, u, r, t);
                    return {
                        guildId: e.id,
                        mode: o,
                        debugReason: l,
    ...
    return r.useEffect(() => _(c()), [c]), {
        ...
        getDebug: () => function (e, t) {
            let n = t.reduce((e, t) => {
                ...
                }, 0), i = I.ZP.getFlattenedGuildIds(), o = a().sortBy(Object.values(e), e => {
                    let t = i.indexOf(e.guildId);
                    return -1 === t ? i.length : t;
                }), s = [
                    [
                        'Use Grey Dot',
                        new Set([D.AR.UseGreyDot])
                    ],
                    [
                        'Keep As Is',
                        new Set([D.AR.KeepAsIs])
                    ]
                ].map(e => {
                    let [t, n] = e, r = o.filter(e => {
                            ...
                            let t = m.Z.getGuild(e.guildId), n = e.actions.map(e => {
                                    var t;
...
function x() {
    let e = Object.values(m.Z.getGuilds()), t = {};
    for (let i of e) {
        var n, r;
    ...
    B(t), g.default.track(L.rMx.NOTIFICATION_MIGRATION_COMPLETED, {
        auto_migrated: !0,
...
function G(e) {
    let [t, n] = r.useState(!1), [i, a] = r.useState(!1), o = r.useCallback(async t => {
            if (i)
                throw Error('Already submitted notifications migration');
            n(!0);
            try {
                await k(t, e), a(!0);
            } finally {
...
async function k(e, t) {
    ...
    try {
        ...
        for (let n of Object.values(e)) {
            var r, i;
            let e = null !== (r = T.ZP.getAllSettings().userGuildSettings[n.guildId]) && void 0 !== r ? r : {}, a = {};
            for (let t of n.actions)
                null === (i = t.apply) || void 0 === i || i.call(t, a, e);
            t[n.guildId] = a;
        }
        await B(t);
        ...
        N.Z.captureException(e), u.Z.show({
...
async function V() {
    ...
    }() && (0, O.dt)(e) : (0, O.$U)('Backup from '.concat(new Date().toLocaleDateString()));
}
async function H() {
    s.K.set('turnedOffNewNotifications', !0), g.default.track(L.rMx.NOTIFICATION_MIGRATION_OPTOUT, { num_guilds_with_new_setting: Object.values(m.Z.getGuilds()).filter(e => T.ZP.resolveGuildUnreadSetting(e) === b.i.ONLY_MENTIONS).length });
    let e = await (0, O.Tn)(), t = a().sortBy(e, e => new Date(e.recorded_at).getTime());
    if (t.length > 0) {
        let e = t[t.length - 1];
        ...
        })), await (0, O.xx)(e.id), await c.Z.setAccountFlag(y.c.USE_NEW_NOTIFICATIONS, !1);
    } else
...
function Z(e) {
    ...
    if (null == e)
        return [];
    let i = a().keyBy(null !== (t = e.voice_joins) && void 0 !== t ? t : [], 'channel_id'), o = a().keyBy(null !== (n = e.message_sends) && void 0 !== n ? n : [], 'channel_id');
    return (null !== (r = e.channel_opens) && void 0 !== r ? r : []).map(e => {
        var t, n, r, a, s, l, u, c, d, _, E;
        let f = null !== (t = i[e.channel_id]) && void 0 !== t ? t : {}, h = null !== (n = o[e.channel_id]) && void 0 !== n ? n : {};
        return {

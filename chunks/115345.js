...
function x() {
    ...
    B(t),
        S.default.track(L.rMx.NOTIFICATION_MIGRATION_COMPLETED, {
            auto_migrated: !0,
...
async function H() {
    o.K.set('turnedOffNewNotifications', !0), S.default.track(L.rMx.NOTIFICATION_MIGRATION_OPTOUT, { num_guilds_with_new_setting: Object.values(I.Z.getGuilds()).filter((e) => T.ZP.resolveGuildUnreadSetting(e) === b.i.ONLY_MENTIONS).length });
    let e = await (0, R.Tn)(),

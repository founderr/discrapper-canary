            ...
            for (let i of u)
                r[i.id] = (function (e, t, n, r, i) {
                    ...
                    return {
                        ...
                        actions: c,
                        overrideMode: i,
                        messagePain: u.messages === L.XR.High,
                        visitsALot: o,
            ...
            getDebug: () =>
                (function (e, t) {
                    let n = t.reduce((e, t) => {
                        ...
                        o = [
                            ['Use Grey Dot', new Set([L.AR.UseGreyDot])],
                            ['Keep As Is', new Set([L.AR.KeepAsIs])]
                        ].map((e) => {
                            let [t, n] = e,
                                r = s
                                    .filter((e) => {
...
function w(e, t) {
    return Object.values(I.Z.getGuilds()).some((n) => {
        let [r] = f.Z.hasConsented(D.pjP.PERSONALIZATION) ? (0, C.q)(n, L.nf, e, t, !1) : (0, C.A)(n, e);
        return r === L.AR.UseGreyDot;
    });
}
function x() {
    ...
    B(t),
        g.default.track(D.rMx.NOTIFICATION_MIGRATION_COMPLETED, {
            auto_migrated: !0,
...
async function k(e, t) {
    ...
    let n = (function (e) {
        let t = Object.values(e)
                .filter((e) => {
                    var t;
                    return (null !== (t = e.overrideMode) && void 0 !== t ? t : e.mode) === L.AR.UseGreyDot;
                })
                .map((e) => {
                    var t;
                    return {
        ...
        return () => {
            g.default.track(D.rMx.NOTIFICATION_MIGRATION_COMPLETED, {
                ...
                pre_selected_server_ids: Object.values(e)
                    .filter((e) => e.mode === L.AR.UseGreyDot)
                    .map((e) => e.guildId),
...
async function H() {
    o.K.set('turnedOffNewNotifications', !0), g.default.track(D.rMx.NOTIFICATION_MIGRATION_OPTOUT, { num_guilds_with_new_setting: Object.values(I.Z.getGuilds()).filter((e) => T.ZP.resolveGuildUnreadSetting(e) === b.i.ONLY_MENTIONS).length });
    let e = await (0, R.Tn)(),

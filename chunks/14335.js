...
function C() {
  ...
  return (0, i.jsxs)(r.Notice, {
    ...
    children: [(0, i.jsx)(r.NoticeCloseButton, {
      ...
      className: p.text,
      children: [f.Z.Messages.OUTBOUND_PROMO_UPSELL_EXPERIMENT_NAG_BAR_TITLE_V2, " ", f.Z.Messages.LEARN_MORE_CLICK.format({
        onClick: A
      })]
    }) : f.Z.Messages.OUTBOUND_PROMO_UPSELL_EXPERIMENT_NAG_BAR_TITLE : f.Z.Messages.OUTBOUND_PROMOTION_NOTICE, (0, i.jsx)(r.PrimaryCTANoticeButton, {
      noticeType: N.kVF.OUTBOUND_PROMOTION,
      onClick: R,

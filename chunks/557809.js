...
function L(e) {
  ...
  switch (t.type) {
    ...
    case N.ChannelTypes.GUILD_MEDIA:
      return (0, a.jsxs)(s.Fragment, {
        children: [y(A, t.type === N.ChannelTypes.GUILD_ANNOUNCEMENT ? I.default.Messages.NEWS_CHANNEL : I.default.Messages.TEXT_CHANNEL), (0, a.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          children: R
    ...
    case N.ChannelTypes.GUILD_VOICE:
      return (0, a.jsxs)(s.Fragment, {
        children: [y(A, I.default.Messages.VOICE_CHANNEL), (0, a.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          children: R
    ...
    case N.ChannelTypes.GUILD_STAGE_VOICE:
      return (0, a.jsxs)(s.Fragment, {
        children: [y(A, I.default.Messages.STAGE_CHANNEL), (0, a.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          children: R
    ...
    case N.ChannelTypes.PRIVATE_THREAD:
      ...
      if (!f && null != l) {
        ...
        O = (0, a.jsxs)(s.Fragment, {
          children: [y(e, I.default.Messages.TEXT_CHANNEL), (0, a.jsx)(T.default.Title, {
            level: x,
            onContextMenu: g,
            onClick: E,
      ...
      return (0, a.jsxs)(s.Fragment, {
        children: [O, y(D ? null : A, I.default.Messages.THREAD), (0, a.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          className: i({

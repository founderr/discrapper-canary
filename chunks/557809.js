...
function L(e) {
  ...
  switch (t.type) {
    ...
    case N.ChannelTypes.GUILD_MEDIA:
      return (0, s.jsxs)(a.Fragment, {
        children: [y(_, t.type === N.ChannelTypes.GUILD_ANNOUNCEMENT ? I.default.Messages.NEWS_CHANNEL : I.default.Messages.TEXT_CHANNEL), (0, s.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          children: R
    ...
    case N.ChannelTypes.GUILD_VOICE:
      return (0, s.jsxs)(a.Fragment, {
        children: [y(_, I.default.Messages.VOICE_CHANNEL), (0, s.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          children: R
    ...
    case N.ChannelTypes.GUILD_STAGE_VOICE:
      return (0, s.jsxs)(a.Fragment, {
        children: [y(_, I.default.Messages.STAGE_CHANNEL), (0, s.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          children: R
    ...
    case N.ChannelTypes.PRIVATE_THREAD:
      ...
      return (0, s.jsxs)(a.Fragment, {
        children: [O, y(D ? null : _, I.default.Messages.THREAD), (0, s.jsx)(T.default.Title, {
          level: x,
          onContextMenu: p,
          onClick: h,
          className: i({
    ...
    case N.ChannelTypes.GUILD_DIRECTORY:
      ...
      return (0, s.jsxs)(a.Fragment, {
        children: [null !== _ ? (0, s.jsx)(T.default.Icon, {
...
function R(e, t) {
  switch (e.type) {
    ...
    case N.ChannelTypes.GUILD_STAGE_VOICE:
    case N.ChannelTypes.GROUP_DM:
      return null != t ? (0, s.jsx)(_.default, {
        channel: e,
        guild: t
      }, e.id) : null;
    default:

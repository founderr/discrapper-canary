...
function L(e) {
  ...
  }(t.type, r), x = (0, s.jsxs)(s.Fragment, {
  ...
  switch (t.type) {
    ...
    case I.ChannelTypes.GUILD_MEDIA:
      return (0, s.jsxs)(a.Fragment, {
        children: [y(T, t.type === I.ChannelTypes.GUILD_ANNOUNCEMENT ? N.default.Messages.NEWS_CHANNEL : N.default.Messages.TEXT_CHANNEL), (0, s.jsx)(A.default.Title, {
          level: R,
          onContextMenu: p,
          onClick: h,
          children: x
    ...
    case I.ChannelTypes.GUILD_VOICE:
      return (0, s.jsxs)(a.Fragment, {
        children: [y(T, N.default.Messages.VOICE_CHANNEL), (0, s.jsx)(A.default.Title, {
          level: R,
          onContextMenu: p,
          onClick: h,
          children: x
    ...
    case I.ChannelTypes.GUILD_STAGE_VOICE:
      return (0, s.jsxs)(a.Fragment, {
        children: [y(T, N.default.Messages.STAGE_CHANNEL), (0, s.jsx)(A.default.Title, {
          level: R,
          onContextMenu: p,
          onClick: h,
          children: x
    ...
    case I.ChannelTypes.GUILD_DIRECTORY:
      ...
      return (0, s.jsxs)(a.Fragment, {
        children: [null !== T ? (0, s.jsx)(A.default.Icon, {
          iconClassName: v.icon,
          icon: T,
          "aria-hidden": !0
        }) : null, (0, s.jsxs)(A.default.Title, {
          level: R,
          onContextMenu: p,
          onClick: h,
          children: [null != L ? (0, s.jsxs)(o.HiddenVisually, {
...
function x(e, t) {
  switch (e.type) {
    ...
    case I.ChannelTypes.GUILD_STAGE_VOICE:
    case I.ChannelTypes.GROUP_DM:
      return null != t ? (0, s.jsx)(T.default, {
        channel: e,
        guild: t
      }, e.id) : null;
    default:
...
function y(e, t) {
  return (0, s.jsxs)(s.Fragment, {
    children: [null !== e && (0, s.jsx)(A.default.Icon, {
      iconClassName: v.icon,
      icon: e,
      "aria-hidden": !0
...
function O(e) {
  ...
  return l !== I.FAVORITES || null == t ? null : (0, s.jsxs)("div", {
    ...
    children: ["left" === a && (0, s.jsx)(A.default.Caret, {
      direction: "left"
    }), (0, s.jsx)(g.default, {
      guild: t,
      ...
      active: !0
    }), (0, s.jsx)(A.default.Title, {
      onClick: () => {
        (0, f.transitionToGuild)(t.id, n.id)
      },
      className: i(v.parentChannelName, v.cursorPointer),
      children: t.name
    }), "right" === a && (0, s.jsx)(A.default.Caret, {
      direction: "right"
    })]
  })
}
var n = r(556019), i = r(464762), o = r(581079);
function a(t, e, r, a, u, s, c) {
    var l = r.getStartOffset(), f = r.getEndOffset(), p = t.__get(u).getMutability(), h = c ? l : f;
    if ('MUTABLE' === p)
        return r;
...
t.exports = function (t, e, r, n, i) {
    var o = n.getStartOffset(), u = n.getEndOffset(), s = e.getEntityAt(o), c = r.getEntityAt(u - 1);
    if (!s && !c)
        return n;
    var l = n;
    if (s && s === c)
        ...
        var f = a(t, e, l, i, s, !1, !0), p = a(t, r, l, i, c, !1, !1);
        l = l.merge({

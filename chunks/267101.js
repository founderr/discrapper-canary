...
var o = t(38618),
	...
	d = t(981631);
let _ = (e) => {
		let n = (0, i.e7)([c.Z], () => (null != e ? c.Z.getGuildProductsForGuildFetchState(e) : c.M.FETCHED), [e]),
			t = (0, i.e7)([o.Z], () => o.Z.isConnected()),
			[l, u] = r.useState(!0);
		return (
			r.useEffect(() => {
				l && (n === c.M.NOT_FETCHED || (n === c.M.FETCHED && c.Z.isGuildProductsCacheExpired(e))) && t && s.EB(e), u(!t);
			}, [e, t, n, l]),
	...
	E = function (e) {
		...
		return (0, i.e7)([c.Z, l.Z], () => c.Z.getGuildProductsForGuild(e, { publishedOnly: null != n ? n : !l.Z.isViewingServerShop(e) }));
	},

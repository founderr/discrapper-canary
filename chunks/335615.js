                        ...
                        children: (0, i.jsx)(c.SJ, {
                            children: n => {
                                ...
                                return (0, i.jsx)(m.List, {
                                    ...
                                    className: l()(z.members, { [z.fullWidth]: u.tq }),
                                    paddingTop: 0,
                                    sectionHeight: 40,
    ...
    constructor(...e) {
        super(...e), Y(this, '_list', null), Y(this, '_areActivitiesExperimentallyHidden', !1), Y(this, 'lastReportedAnalyticsChannel', void 0), Y(this, 'setList', e => {
            ...
            let {
                    ...
                    row: n,
                    rowIndex: a
                } = e, {channel: s} = this.props, l = this.getRowProps(e);
            if (null != l) {
...
function en(e) {
    let {
            channel: t,
            className: n
        } = e, {analyticsLocations: s} = (0, T.ZP)(I.Z.MEMBER_LIST), r = (0, h.e7)([g.Z], () => g.Z.keyboardModeEnabled), o = (0, h.cj)([P.ZP], () => P.ZP.getProps(t.guild_id, t.id)), {
            rows: u,
            groups: p,
            version: m,
            updateMaxRowSeen: _
            ...
            if (null == n)
                return;
            let i = parseInt(t, 10), [a, s] = n.getSectionRowFromIndex(i), l = 0 === a && 0 === s ? q : 0;
            n.scrollToIndex({
                section: a,
                row: s,
                padding: l,

...
function o(e) {
    ...
    if (!r)
        throw Error('cannot check visibility of non attached element');
    ...
    return function e(o, n = !1) {
        ...
        if ('INPUT' === o.tagName && 'hidden' == o.type.toLowerCase() || 'NOSCRIPT' === o.tagName)
            return !1;
        let l = r.getComputedStyle(o).visibility;
        if ('collapse' == l || 'hidden' == l || !function e(t) {
                if ('none' == r.getComputedStyle(t).display)
                    return !1;
                let a = t.parentElement;
                return !a || e(a);
            }(o) || !n && 0 == function e(t) {
                let a = 1, o = r.getComputedStyle(t).opacity;
                o && (a = Number(o));
        ...
        return !!(t || i(o)) && !(!t && function e(t) {
            return 'hidden' == function e(t) {
                let a, o = t.getBoundingClientRect(), n = t.ownerDocument, l = n.documentElement, i = n.body, s = r.getComputedStyle(l).overflow;
                function u(e) {
                    let t = r.getComputedStyle(e).position;
                    if ('fixed' == t)
                        return a = !0, e == l ? null : l;
                    {
                ...
                for (let n = u(t); n; n = u(n)) {
                    ...
                    if ('visible' == t.x && 'visible' == t.y)
                        continue;
                    let u = n.getBoundingClientRect();
                    if (0 == u.width || 0 == u.height)
                        return 'hidden';
                    let c = o.right < u.left, p = o.bottom < u.top;
                    if (c && 'hidden' == t.x || p && 'hidden' == t.y)
                        return 'hidden';
                    if (c && 'visible' != t.x || p && 'visible' != t.y) {
                        let r = d(n), a = o.right < u.left - r.x, l = o.bottom < u.top - r.y;
                        if (a && 'visible' != t.x || l && 'visible' != t.x)
                            return 'hidden';
                        return 'hidden' == e(n) ? 'hidden' : 'scroll';
                    }
                    let m = o.left >= u.left + u.width, f = o.top >= u.top + u.height;
                    if (m && 'hidden' == t.x || f && 'hidden' == t.y)
                        return 'hidden';
                    if (m && 'visible' != t.x || f && 'visible' != t.y) {
                        if (a) {
                            let e = d(n);
                            if (o.left >= l.scrollWidth - e.x || o.right >= l.scrollHeight - e.y)
                                return 'hidden';
                        }
                        return 'hidden' == e(n) ? 'hidden' : 'scroll';
                    }

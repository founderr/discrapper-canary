...
function $(e) {
  ...
  let {
    ...
    priceOptions: R
  } = e, v = (0, U.default)(), O = l.interval, A = l.intervalCount, x = (0, c.useStateFromStores)([h.default], () => h.default.getForSkuAndInterval(Q.PremiumSubscriptionSKUs.GUILD, O, A)), b = (0, c.useStateFromStores)([D.default], () => D.default.getCurrentUser()), G = (0, c.useStateFromStores)([y.default], () => y.default.getGuild(a), [a]);
  ...
  return m(es), (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: es ? (0, i.jsx)(I.Spinner, {}) : eS ? (0, K.formatPrice)(ec.amount, ec.currency) : function(e) {
          let {
            amount: n,
            currency: t,
            intervalType: i,
...
function ee(e) {
  let {
    ...
    priceOptions: s
  } = e, r = t.interval, o = t.intervalCount, d = (0, c.useStateFromStores)([h.default], () => h.default.getForSkuAndInterval(Q.PremiumSubscriptionSKUs.GUILD, r, o));

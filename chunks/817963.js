...
let d = {
  ...
  v = e => {
    let [t, n] = e instanceof s.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : h(e), [r, a, v, m] = (0, l.useStateFromStoresArray)([o.default], () => [o.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e), o.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e), o.default.can(t, e), o.default.can(n, e)]), E = (0, l.useStateFromStores)([u.default], () => u.default.getCurrentUser()), C = i.useCallback(e => f(e, E, a, r), [r, a, E]), g = i.useCallback(e => f(e, E, m, v), [m, v, E]);
    return null == e ? d : {

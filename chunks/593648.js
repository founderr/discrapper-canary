...
function W(e) {
    let {
        ...
        } = e, {allowAprilFoolsSoundpack: o} = x.Z.useExperiment({ location: '791c79_1' }, { autoTrackExposure: !1 }), l = m.Z.useIsRingtoneEligible();
    a.useEffect(() => {
        x.Z.trackExposure({ location: '791c79_3' });
    }, []);
    let c = a.useRef(), _ = (0, A.p)(), u = a.useCallback((e, t) => {
...
function K() {
    let e = (0, c.e7)([N.Z], () => N.Z.getGuildAlertSettings()), [t, s] = a.useState(null), i = b.default.keys(e).map(t => {
            let s = e[t];
            return {
                label: s.guildName,
                value: s.guildId
        ...
        children: [
            ...
            (0, n.jsxs)(d.FormItem, {
                ...
                children: [
                    ...
                    null != t ? null : (0, n.jsx)(d.FormDivider, { className: r()(w.marginTop20, w.marginBottom40) })
                ]
            })
        ]
    });
...
async function J(e) {
    ...
    0 === t.length ? await (0, O.oL)() : _.Z.show({
        ...
        body: V.Z.Messages.NOTIF_MIGRATION_SETTINGS_CONFIRM_BODY.format({ date: new Date(t[t.length - 1].recorded_at) }),

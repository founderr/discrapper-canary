...
t.default = function(e) {
  let {
    guild: t
  } = e, n = (0, i.useStateFromStores)([r.default], () => r.default.getChannels(t.id)[r.GUILD_VOCAL_CHANNELS_KEY][0]), s = (0, i.useStateFromStores)([o.default], () => null != n && o.default.can(f.Permissions.CONNECT, n.channel));

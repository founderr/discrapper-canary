...
let b = {
    ...
    [N.kg4.PUSH_TO_TALK]: {
        onTrigger(e, t) {
            E.Z.getMode(t.context) === N.pM4.PUSH_TO_TALK && ((b[N.kg4.PUSH_TO_TALK].isPressed = e), E.Z.getMediaEngine().eachConnection((t) => t.setForceAudioInput(e, !1), t.context));
        },
        keyEvents: {
            keyup: !0,
            keydown: !0
    ...
    [N.kg4.PUSH_TO_TALK_PRIORITY]: {
        onTrigger(e) {
            E.Z.getMode() === N.pM4.PUSH_TO_TALK && ((b[N.kg4.PUSH_TO_TALK_PRIORITY].isPressed = e), E.Z.getMediaEngine().eachConnection((t) => t.setForceAudioInput(e, !0), A.Yn.DEFAULT));
        },
        keyEvents: {
            keyup: !0,
            keydown: !0
    ...
    [N.kg4.PUSH_TO_MUTE]: {
        onTrigger(e) {
            if (!(E.Z.getMode() !== N.pM4.VOICE_ACTIVITY || E.Z.isSelfDeaf())) (b[N.kg4.PUSH_TO_MUTE].isPressed = e), r.Z.setTemporarySelfMute(e);
        },
        keyEvents: {
            keyup: !0,
            keydown: !0
    ...
    [N.kg4.TOGGLE_VOICE_MODE]: {
        onTrigger() {
            let e = E.Z.getMode() === N.pM4.PUSH_TO_TALK ? N.pM4.VOICE_ACTIVITY : N.pM4.PUSH_TO_TALK;
            r.Z.setMode(e);
        },
        keyEvents: {
            keyup: !0,
    ...
    [N.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET]: {
        onTrigger() {
            let e = C.Z.getFocusedPID(),
                t = null != e;
            null != e && t && v.Z.isPinned(N.Odu.TEXT) && v.Z.isLocked(e) && C.Z.isReady(e) && l.Z.activateRegion(N.O0n.TEXT_WIDGET);
        },
        keyEvents: {
            keyup: !0,
            keydown: !1
    ...
    [N.kg4.SAVE_CLIP]: {
        onTrigger: () => {
            (0, d.ln)() && (S.default.track(N.rMx.CLIP_SAVE_KEYBIND_PRESSED), (0, u.C1)());
        },
        keyEvents: {
            keyup: !1,
            keydown: !0

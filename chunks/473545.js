...
var l = t(735250);
t(470079);
var i = t(442837), u = t(481060), s = t(41776), r = t(314897), a = t(924301), d = t(482241), E = t(894017), o = t(765305), c = t(689938);
function _(e) {
    let {
            guildEventId: n,
            guildId: t,
            recurrenceId: _
        } = e, T = (0, i.e7)([s.Z], () => s.Z.isLurking(t), [t]), N = (0, i.e7)([r.default], () => r.default.getId()), {
            rsvped: I,
            baseRsvp: Z,
            recurrenceRsvp: f
        } = (0, i.cj)([a.ZP], () => ({
    ...
    if (T || (null == g ? void 0 : g.is_canceled))
        return null;
    let M = function () {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], l = (null == Z ? void 0 : Z.response) === o.gv.INTERESTED ? o.gv.UNINTERESTED : o.gv.INTERESTED, i = e ? null : _;

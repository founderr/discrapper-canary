n(47120);
var s = n(735250), r = n(470079), i = n(990547), a = n(442837), l = n(481060), o = n(893776), c = n(232567), u = n(388905), d = n(353926), h = n(82554), _ = n(726521), E = n(185625), g = n(314897), p = n(63063), f = n(981631), I = n(689938), m = n(102122), N = n(331651);
a.ZP.initialize();
let T = e => {
    let {
            title: t,
...
t.Z = () => {
    ...
    return r.useEffect(() => {
        _ ? (t(!0), c.k({ withAnalyticsToken: !0 }).then(() => A()).catch(() => t(!1))) : A();
    }, [_]), r.useEffect(() => {
        (async () => {
            !x && (await o.Z.getLocationMetadata(), o.Z.getExperiments());
        })();
    }, [x]), e || !x ? (0, s.jsx)(u.ZP, { children: (0, s.jsx)(l.Spinner, {}) }) : n && (0, s.jsxs)(u.ZP, {
        children: [
            (0, s.jsx)(u.Dx, {
            ...
            (0, s.jsx)(u.DK, {
                className: N.marginBottom8,
                children: I.Z.Messages.URF_LANDING_PAGE_SUBTITLE.format({ supportURL: p.Z.getArticleURL(f.BhN.COPYRIGHT_AND_IP_POLICY) })
            }),
            (0, s.jsxs)('div', {

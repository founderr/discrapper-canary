var n = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(481060), l = s(100527), c = s(906732), d = s(626135), _ = s(335131), E = s(410154), u = s(302800), T = s(981631), I = s(474936), S = s(689938), N = s(362265), C = s(353437), m = s(786792);
let A = e => {
    var t, s, a, i, l;
    let {
        displayOptions: c,
...
t.Z = () => {
    var e;
    let {analyticsLocations: t} = (0, c.ZP)(l.Z.COLLECTIBLES_PROFILE_SETTINGS_UPSELL), s = a.useRef(null), i = (0, E.ZP)('CollectiblesUpsellBanner'), C = u.GX[i];
    return a.useEffect(() => {

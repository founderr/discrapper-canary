...
function l(e) {
    let n = (function (e) {
        let { PI: n, min: t, max: l, cos: s, round: a } = Math,
            ...
            g = (n, t, l) => {
                let s = [];
                for (let a = 0; a < t; a++) for (let i = a ? 0 : 1; i * t < n * (t - a); i++) s.push((((e[x + (C >> 1)] >> ((1 & C++) << 2)) & 15) / 7.5 - 1) * l);
                return s;
            },
            I = g(E, _, ((i >> 18) & 31) / 31),
        ...
        for (let e = 0, a = 0; e < T; e++)
            for (let i = 0; i < A; i++, a += 4) {
                let r = o,
                    ...
                    h = u,
                    x = S;
                for (let e = 0, t = l(E, d ? 5 : 3); e < t; e++) L[e] = s((n / A) * (i + 0.5) * e);
                for (let t = 0, a = l(_, d ? 5 : 3); t < a; t++) M[t] = s((n / T) * (e + 0.5) * t);
                for (let e = 0, n = 0; e < _; e++) for (let t = e ? 0 : 1, l = 2 * M[e]; t * _ < E * (_ - e); t++, n++) r += I[n] * L[t] * l;
                for (let e = 0, n = 0; e < 3; e++)
                    for (let t = e ? 0 : 1, l = 2 * M[e]; t < 3 - e; t++, n++) {
                        let e = L[t] * l;
                        (m += N[n] * e), (h += Z[n] * e);
                    }
                if (d) for (let e = 0, n = 0; e < 5; e++) for (let t = e ? 0 : 1, l = 2 * M[e]; t < 5 - e; t++, n++) x += f[n] * L[t] * l;
                let C = r - (2 / 3) * m,
                    g = (3 * r - C + h) / 2,
                    R = g - h;
                (v[a] = l(0, 255 * t(1, g))), (v[a + 1] = l(0, 255 * t(1, R))), (v[a + 2] = l(0, 255 * t(1, C))), (v[a + 3] = l(0, 255 * t(1, x)));
            }
        return {
            w: A,
            h: T,

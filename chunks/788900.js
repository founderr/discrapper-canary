...
function l(e) {
  let n = function(e) {
    let {
      ...
      cos: s,
      round: a
    } = Math, i = e[0] | e[1] << 8 | e[2] << 16, r = e[3] | e[4] << 8, o = (63 & i) / 63, u = (i >> 6 & 63) / 31.5 - 1, c = (i >> 12 & 63) / 31.5 - 1, d = i >> 23, m = r >> 15, E = l(3, m ? d ? 5 : 7 : 7 & r), _ = l(3, m ? 7 & r : d ? 5 : 7), S = d ? (15 & e[5]) / 15 : 1, h = (e[5] >> 4) / 15, g = d ? 6 : 5, C = 0, I = (n, t, l) => {
      let s = [];
      for (let a = 0; a < t; a++)
    ...
    for (let e = 0, a = 0; e < R; e++)
      for (let i = 0; i < T; i++, a += 4) {
        ...
        for (let e = 0, n = 0; e < _; e++)
          for (let t = e ? 0 : 1, l = 2 * p[e]; t * _ < E * (_ - e); t++, n++) r += Z[n] * L[t] * l;
        ...
        let C = r - 2 / 3 * m,
          I = (3 * r - C + h) / 2,
          A = I - h;
        v[a] = l(0, 255 * t(1, I)), v[a + 1] = l(0, 255 * t(1, A)), v[a + 2] = l(0, 255 * t(1, C)), v[a + 3] = l(0, 255 * t(1, g))
      }
    return {
      w: T,
      h: R,

...
function l(e) {
  let n = function(e) {
    let {
      ...
      cos: s,
      round: a
    } = Math, i = e[0] | e[1] << 8 | e[2] << 16, r = e[3] | e[4] << 8, o = (63 & i) / 63, u = (i >> 6 & 63) / 31.5 - 1, c = (i >> 12 & 63) / 31.5 - 1, d = i >> 23, m = r >> 15, E = l(3, m ? d ? 5 : 7 : 7 & r), _ = l(3, m ? 7 & r : d ? 5 : 7), S = d ? (15 & e[5]) / 15 : 1, h = (e[5] >> 4) / 15, g = d ? 6 : 5, C = 0, Z = (n, t, l) => {
      let s = [];
      for (let a = 0; a < t; a++)
        for (let i = a ? 0 : 1; i * t < n * (t - a); i++) s.push(((e[g + (C >> 1)] >> ((1 & C++) << 2) & 15) / 7.5 - 1) * l);
      return s
    }, N = Z(E, _, (i >> 18 & 31) / 31), I = Z(3, 3, (r >> 3 & 63) / 63 * 1.25), x = Z(3, 3, (r >> 9 & 63) / 63 * 1.25), f = d && Z(5, 5, h), A = function(e) {
      let n = e[3],
        t = 128 & e[2],
        l = 128 & e[4];
    ...
    for (let e = 0, a = 0; e < R; e++)
      for (let i = 0; i < T; i++, a += 4) {
        ...
        let C = r - 2 / 3 * m,
          Z = (3 * r - C + h) / 2,
          A = Z - h;
        v[a] = l(0, 255 * t(1, Z)), v[a + 1] = l(0, 255 * t(1, A)), v[a + 2] = l(0, 255 * t(1, C)), v[a + 3] = l(0, 255 * t(1, g))
      }
    return {
      w: T,
      h: R,

...
function s(e) {
  let t = function(e) {
    let {
      ...
      cos: s,
      round: i
    } = Math, r = e[0] | e[1] << 8 | e[2] << 16, u = e[3] | e[4] << 8, o = (63 & r) / 63, d = (r >> 6 & 63) / 31.5 - 1, c = (r >> 12 & 63) / 31.5 - 1, f = r >> 23, m = u >> 15, S = n(3, m ? f ? 5 : 7 : 7 & u), E = n(3, m ? 7 & u : f ? 5 : 7), _ = f ? (15 & e[5]) / 15 : 1, h = (e[5] >> 4) / 15, N = f ? 6 : 5, C = 0, g = (t, l, a) => {
      let n = [];
      for (let s = 0; s < l; s++)
        for (let i = s ? 0 : 1; i * l < t * (l - s); i++) n.push(((e[N + (C >> 1)] >> ((1 & C++) << 2) & 15) / 7.5 - 1) * a);
      return n
    ...
    for (let e = 0, a = 0; e < v; e++)
      for (let i = 0; i < T; i++, a += 4) {
        ...
        let N = r - 2 / 3 * u,
          C = (3 * r - N + m) / 2,
          g = C - m;
        L[a] = n(0, 255 * l(1, C)), L[a + 1] = n(0, 255 * l(1, g)), L[a + 2] = n(0, 255 * l(1, N)), L[a + 3] = n(0, 255 * l(1, h))
      }
    return {
      w: T,
      h: v,

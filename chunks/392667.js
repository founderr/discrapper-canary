...
var l = "currentColor",
  ...
  E = function(e, t, n, r, o) {
    if (!t || r) return e ? "url(#nitro_hover)" : l;
    var i = n ? u(f.keys()).filter(function(e) {
        return e !== o
      }) : u(c.keys()).filter(function(e) {
        return e !== o
      }),
...
function p(e) {
  var t, n, a, u, f, p = e.width,
    m = e.height,
    y = e.referralsRemaining,
    I = e.isResending,
    h = e.hovered,
    O = e.shouldShowBirthdayUX,
    T = e.isLightTheme,
    S = function(e, t) {
      if (null == e) return {};
      ...
      return o
    }(e, ["width", "height", "referralsRemaining", "isResending", "hovered", "shouldShowBirthdayUX", "isLightTheme"]);
  var v = (t = r.useState(l), n = 2, function(e) {
    ...
    g = v[0],
    A = v[1],
    b = null !== (f = c.get(g)) && void 0 !== f ? f : null;
  return r.useEffect(function() {
    h ? A(function(e) {
      return E(h, O, T, I, e)
    }) : I && A(l)
  }, [h, O, T, I]), r.createElement("svg", (a = function(e) {

...
var i = n("446674"),
  ...
  a = n("521012"),
  o = n("646718");
new l.default("useSubscriptionPlansLoaded");
let u = e => {};

function d() {
  let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [...o.ACTIVE_PREMIUM_SKUS];
  return (0, i.useStateFromStores)([r.default, s.default, a.default], () => c(e, [r.default, s.default, a.default]), [e])
}

function c() {
  var e;
  let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [...o.ACTIVE_PREMIUM_SKUS],
    [n, i, l] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [r.default, s.default, a.default],
    d = n.paymentSourceIds,
    c = n.defaultPaymentSourceId,
    f = i.isLoadedForSKUs(t),
    E = null === (e = l.getPremiumTypeSubscription()) || void 0 === e ? void 0 : e.paymentSourceId;

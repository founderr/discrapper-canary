...
function V(e, t) {
  return i.useMemo(() => {
    if (null != t) return n => (0, s.jsx)(C.Z, {
      ...n,
...
function K(e) {
  let {
    alertAction: t,
    guildId: n
  } = e, i = (0, d.e7)([A.default], () => A.default.getUser(t.actor), [t.actor]);
  try {
    let e = parseInt(t.actionType);
    if (null == i) return Y(e, {});
    let l = function(e, t, n) {
      var s;
      let i = null !== (s = f.ZP.getNickname(n, null, t)) && void 0 !== s ? s : O.ZP.getUserTag(t),
        l = o()(e.ts),
...
function Q(e) {
  let {
    ...
    handleFocus: x,
    handleBlur: Z
  } = (0, P.bb)(f), D = (0, d.e7)([_.Z], () => _.Z.keyboardModeEnabled), U = (0, d.e7)([S.Z], () => S.Z.can(y.Plq.MANAGE_MESSAGES, r), [r]), {
    ruleName: V,
    embedChannel: Y,
    decisionId: K,
  ...
  } = (0, T.ZP)(l), ei = i.useMemo(() => (0, R.k$)(q, Q, r.id), [q, Q, r]), {
    selected: el,
    ...ea
  } = F(l, r), er = i.useCallback(() => {
    (0, N._s)(l.id, q, K, r)
  }, [l.id, q, K, r]), eo = i.useCallback(e => {
    if (null != J && null != Y) e.stopPropagation(), e.preventDefault(), (0, h.Z)(y.Z5c.CHANNEL(null == Y ? void 0 : Y.guild_id, null == Y ? void 0 : Y.id, J))
  }, [Y, J]), ec = i.useCallback(() => {
    (0, m.Xx)(l.id, r, I.d.DELETE_USER_MESSAGE)
  }, [r, l.id]), eu = (0, B.L9)(Number($)), ed = null != ee, eE = U && null != J && (null == et || !et.actions.hasOwnProperty(I.d.DELETE_USER_MESSAGE));
  return (0, s.jsx)("div", {
    onMouseEnter: C,
    onMouseLeave: A,

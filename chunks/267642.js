...
n(913527);
var s = n(274136), l = n(314884), u = n(78839), c = n(424218), d = n(823379), _ = n(63063), E = n(74538), f = n(981631), h = n(474936), p = n(689938);
Object.freeze({
    1: 1,
    2: 2,
    3: 3,
...
let m = [
    ...
    }, T = (e, t) => null != t && t.hasFeature(f.oNc.MORE_STICKERS) && e === f.Eu4.TIER_3 ? s.D.MAX_STICKER_SLOTS : h.$8[e], g = e => h.pH[e], S = (e, t) => null != t && t.hasFeature(f.oNc.MORE_SOUNDBOARD) ? 96 : h._k[e], A = e => {
        if (e === f.Eu4.NONE)
            return h._k[e];
...
let R = o().memoize(e => h.HO[f.Eu4.TIER_1].features.includes(e) ? f.Eu4.TIER_1 : h.HO[f.Eu4.TIER_2].features.includes(e) ? f.Eu4.TIER_2 : h.HO[f.Eu4.TIER_3].features.includes(e) ? f.Eu4.TIER_3 : null), C = e => {
        if (e === f.Eu4.NONE)
            return f.Qqv.NONE;
        if (e === f.Eu4.TIER_1)
            return f.Qqv.TIER_1;
...
function U(e, t) {
    let n = y(e.length, t), r = w(t)[n], i = e.filter(e => null != e.endsAt);
...
function k(e, t) {
    let n = g(t), r = m.indexOf(t);
    if (-1 === r)
        return 0;
    let i = m[r - 1], a = null != i ? T(i) : 0, o = T(t);

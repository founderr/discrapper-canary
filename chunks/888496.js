...
o = '1' === e[_.PC.REDDIT_MOD];
  return i > -1 && a.push((0, n.jsx)(O, {
className: t,
count: i,
label: E.Z.Messages.CONNECTIONS_PROFILE_REDDIT_KARMA
  }, _.PC.REDDIT_TOTAL_KARMA)), r && a.push((0, n.jsx)(p, {
className: t,
label: E.Z.Messages.CONNECTIONS_REDDIT_GOLD
  }, _.PC.REDDIT_GOLD)), o && a.push((0, n.jsx)(p, {
className: t,
...
d = Number(null !== (i = e[_.PC.STEAM_ITEM_COUNT_TF2]) && void 0 !== i ? i : -1);
  return l > -1 && o.push((0, n.jsx)(O, {
className: r,
count: l,
label: E.Z.Messages.CONNECTIONS_PROFILE_STEAM_GAMES
  }, _.PC.STEAM_GAME_COUNT)), c > -1 && o.push((0, n.jsx)(h, {
className: r,
...
imageAlt: E.Z.Messages.CONNECTIONS_STEAM_DOTA2
  }, _.PC.STEAM_ITEM_COUNT_DOTA2)), d > -1 && o.push((0, n.jsx)(h, {
className: r,
label: E.Z.Messages.CONNECTIONS_STEAM_ITEMS.format({
  count: d
}),
...
i = Object.keys(e.metadata);
  if (null == e.application_metadata || 0 === Object.keys(e.application_metadata).length || 0 === i.length)
return a;
...
try {
  switch (i.type) {
    ...
    case _.xn.BOOLEAN_NOT_EQUAL:
      (i.type === _.xn.BOOLEAN_EQUAL && '1' === o || i.type === _.xn.BOOLEAN_NOT_EQUAL && '1' !== o) && a.push((0, n.jsx)(p, {
        className: s,
        label: i.name
      }, i.key));
      break;
...
d = (0, c.$U)(t) + (o ? '%' : '');
  return s = 'string' == typeof a ? E.Z.Messages.CONNECTIONS_PROFILE_GENERIC_VANITY_METRIC.format({
name: a,
value: d
  }) : a.format({
value: d

...
let M = e => {
  ...
  return void 0 !== s ? L = R.Z.Messages.PREMIUM_DISCOUNT_AMOUNT_OFF_BADGE.format({
    percent: s
  }) : c && (L = R.Z.Messages.REFERRAL_PROGRAM_TWO_WEEK_TRIAL), (0, a.jsx)("div", {
...
n.Z = function(e) {
  ...
  let H = (0, c.e7)([L.Z], () => L.Z.useReducedMotion),
    B = (0, S.Ng)(),
    P = null == B ? void 0 : null === (n = B.discount) || void 0 === n ? void 0 : n.amount;
  return (0, a.jsxs)("div", {
    "aria-hidden": !0,
    className: r()({
    ...
    children: [H || Z !== f.nL.WINTER ? null : (0, a.jsx)(h.Z, {
      className: p.snow,
      wind: 5
    }), (v || O) && (0, a.jsx)(d.Z, {
      ...
      children: function(e, n) {
        let s = N.ZP.getDefaultPrice(e),
          {
            intervalType: a
          } = N.ZP.getInterval(e),
          t = (0, T.T4)(s.amount, s.currency);
        if (n) return t;
        switch (a) {
          case f.rV.MONTH:

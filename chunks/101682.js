var r = n(685053), i = n(814033), a = n(689118), o = n(806981), s = r.assert;
function l(e) {
    o.call(this, 'short', e), this.a = new i(e.a, 16).toRed(this.red), this.b = new i(e.b, 16).toRed(this.red), this.tinv = this.two.redInvm(), this.zeroA = 0 === this.a.fromRed().cmpn(0), this.threeA = 0 === this.a.fromRed().sub(this.p).cmpn(-3), this.endo = this._getEndomorphism(e), this._endoWnafT1 = [
        ,
        ,
        ,
        ,
...
a(l, o), e.exports = l, l.prototype._getEndomorphism = function (e) {
    ...
    var t = e === this.p ? this.red : i.mont(e), n = new i(2).toRed(t).redInvm(), r = n.redNeg(), a = new i(3).toRed(t).redNeg().redSqrt().redMul(n);
    return [
        r.redAdd(a).fromRed(),
        r.redSub(a).fromRed()
    ];
    ...
    var t = this.endo.basis, n = t[0], r = t[1], i = r.b.mul(e).divRound(this.n), a = n.b.neg().mul(e).divRound(this.n), o = i.mul(n.a), s = a.mul(r.a), l = i.mul(n.b), u = a.mul(r.b);
    return {
        k1: e.sub(o).sub(s),
        k2: l.add(u).neg()
    };
    ...
    for (var r = this._endoWnafT1, i = this._endoWnafT2, a = 0; a < e.length; a++) {
        var o = this._endoSplit(t[a]), s = e[a], l = s._getBeta();
    ...
    if (e.isInfinity())
        return this;
    var t = e.z.redSqr(), n = this.z.redSqr(), r = this.x.redMul(t), i = e.x.redMul(n), a = this.y.redMul(t.redMul(e.z)), o = e.y.redMul(n.redMul(this.z)), s = r.redSub(i), l = a.redSub(o);
    if (0 === s.cmpn(0))
        return 0 !== l.cmpn(0) ? this.curve.jpoint(null, null, null) : this.dbl();
    var u = s.redSqr(), c = u.redMul(s), d = r.redMul(u), _ = l.redSqr().redIAdd(c).redISub(d).redISub(d), E = l.redMul(d.redISub(_)).redISub(a.redMul(c)), f = this.z.redMul(e.z).redMul(s);
    ...
    var l = o.redSqr(), u = l.redMul(o), c = n.redMul(l), d = s.redSqr().redIAdd(u).redISub(c).redISub(c), _ = s.redMul(c.redISub(d)).redISub(i.redMul(u)), E = this.z.redMul(o);
    ...
    var r = this.curve.a, i = this.curve.tinv, a = this.x, o = this.y, s = this.z, l = s.redSqr().redSqr(), u = o.redAdd(o);
    for (t = 0; t < e; t++) {
        var c = a.redSqr(), d = u.redSqr(), _ = d.redSqr(), E = c.redAdd(c).redIAdd(c).redIAdd(r.redMul(l)), f = a.redMul(d), h = E.redSqr().redISub(f.redAdd(f)), p = f.redISub(h), m = E.redMul(p);
    ...
    if (this.zOne) {
        ...
        o = o.redIAdd(o);
        var s = r.redAdd(r).redIAdd(r), l = s.redSqr().redISub(o).redISub(o), u = a.redIAdd(a);
        u = (u = u.redIAdd(u)).redIAdd(u), e = l, t = s.redMul(o.redISub(l)).redISub(u), n = this.y.redAdd(this.y);
    } else {
        var c = this.x.redSqr(), d = this.y.redSqr(), _ = d.redSqr(), E = this.x.redAdd(d).redSqr().redISub(c).redISub(_);
        E = E.redIAdd(E);
        var f = c.redAdd(c).redIAdd(c), h = f.redSqr(), p = _.redIAdd(_);
    ...
    if (this.zOne) {
        var e, t, n, r = this.x.redSqr(), i = this.y.redSqr(), a = i.redSqr(), o = this.x.redAdd(i).redSqr().redISub(r).redISub(a);
        o = o.redIAdd(o);
        var s = r.redAdd(r).redIAdd(r).redIAdd(this.curve.a), l = s.redSqr().redISub(o).redISub(o);
        e = l;
        var u = a.redIAdd(a);
        u = (u = u.redIAdd(u)).redIAdd(u), t = s.redMul(o.redISub(l)).redISub(u), n = this.y.redAdd(this.y);
    } else {
        var c = this.z.redSqr(), d = this.y.redSqr(), _ = this.x.redMul(d), E = this.x.redSub(c).redMul(this.x.redAdd(c));
        E = E.redAdd(E).redIAdd(E);
        var f = _.redIAdd(_), h = (f = f.redIAdd(f)).redAdd(f);
    ...
    var e = this.curve.a, t = this.x, n = this.y, r = this.z, i = r.redSqr().redSqr(), a = t.redSqr(), o = n.redSqr(), s = a.redAdd(a).redIAdd(a).redIAdd(e.redMul(i)), l = t.redAdd(t), u = (l = l.redIAdd(l)).redMul(o), c = s.redSqr().redISub(u.redAdd(u)), d = u.redISub(c), _ = o.redSqr();
    _ = (_ = (_ = _.redIAdd(_)).redIAdd(_)).redIAdd(_);
    var E = s.redMul(d).redISub(_), f = n.redAdd(n).redMul(r);
    return this.curve.jpoint(c, E, f);
}, c.prototype.trpl = function () {
    if (!this.curve.zeroA)
        return this.dbl().add(this);
    var e = this.x.redSqr(), t = this.y.redSqr(), n = this.z.redSqr(), r = t.redSqr(), i = e.redAdd(e).redIAdd(e), a = i.redSqr(), o = this.x.redAdd(t).redSqr().redISub(e).redISub(r), s = (o = (o = (o = o.redIAdd(o)).redAdd(o).redIAdd(o)).redISub(a)).redSqr(), l = r.redIAdd(r);
    l = (l = (l = l.redIAdd(l)).redIAdd(l)).redIAdd(l);
    var u = i.redIAdd(o).redSqr().redISub(a).redISub(s).redISub(l), c = t.redMul(u);

    ...
    let { analyticsLocations: e } = (0, u.ZP)(_.Z.PREMIUM_MARKETING_PERK_CARD),
        ...
        eb = {
            ...
            clips: eR
                ? {
                      ...
                      onCtaClick: ef
                          ...
                          : () => {
                                window.open(m.Z.getArticleURL(D.BhN.CLIPS), '_blank');
                            },
                      perkImage: z
                  }
                : {
            ...
            referralProgram: {
                ...
                description: j.Z.Messages.PREMIUM_MARKETING_WHATS_NEW_REFERRAL_PROGRAM_DESCRIPTION.format({ helpdeskArticle: m.Z.getArticleURL(D.BhN.REFERRAL_PROGRAM) }),

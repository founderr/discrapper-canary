...
t.Z = () => {
    let { analyticsLocations: e } = (0, _.ZP)(d.Z.PREMIUM_MARKETING_PERK_CARD),
        t = (0, c.ZP)(),
        n = (0, g.BU)(((0, p.Xv)() ? b.wb : b.Uq) / 1024, { useKibibytes: !0 }),
        s = (0, i.e7)([C.ZP], () => C.ZP.getPremiumTypeSubscription()),
        a = null != s ? m.ZP.getPremiumPlanItem(s) : null,
        ec = null != a ? m.ZP.getSkuIdForPlan(a.planId) : null,
        ed = ec === b.Si.TIER_2,
        e_ = ec === b.Si.TIER_0,
        { flipped: eu } = (0, f.JP)(),
        { flipped: eE } = (0, f.as)(),
        ...
        ef = {
            ...
            specialStickerAccess: {
                ...
                perkImage: (0, O.gx)(t, U, ea),
                description: Z.Z.Messages.NITRO_HOME_CARD_INCLUDED_WITH_BASIC_AND_NITRO
            },
            largeUploads: {
                name: 'largeUploads',
                title: Z.Z.Messages.PREMIUM_MARKETING_UPLOADS_SMALL_PERK_TITLE.format({ premiumMaxSize: n }),
                subtitle: Z.Z.Messages.PREMIUM_MARKETING_UPLOADS_SMALL_PERK_DESCRIPTION.format({ premiumMaxSize: n }),
                perkImage: eo,
            ...
            referralProgram: {
                ...
                description: Z.Z.Messages.PREMIUM_MARKETING_WHATS_NEW_REFERRAL_PROGRAM_DESCRIPTION.format({ helpdeskArticle: N.Z.getArticleURL(P.BhN.REFERRAL_PROGRAM) }),
    ...
    if (null != eg) {
        let { title: t, subtitle: n, description: s, pillText: a, ctaDescription: i, dismissibleContentType: l } = eg,
            c = (0, r.jsx)(M.Z, {
                showAnimations: !0,
                percentage: eR,
        ...
        ef.freeBoost = {
            ...
            descriptionCta: i,
            onCtaClick: () => {
                o.Z.open(P.oAB.GUILD_BOOSTING, null, { analyticsLocations: e });
            },

...
function N(e) {
  let {
  ...
  } = (0, m.useGlobalOrGuildIdentityPendingProfileEffect)(n), [E, C] = r.useMemo(() => {
    ...
    let t = E.find(e => (null == e ? void 0 : e.id) === _),
      n = null != t || null === _,
      i = null !== (e = null != t ? t : C.find(e => (null == e ? void 0 : e.id) === _)) && void 0 !== e ? e : null;
    return [i, n]
  }, [_, E, C]), {
    product: M,
    purchase: R
...
function x(e) {
  let {
    ...
    categories: p,
    purchases: S
  } = (0, h.default)(), I = (0, s.useStateFromStores)([E.default], () => E.default.getCurrentUser()), {

n(47120);
var i = n(735250), a = n(470079), s = n(399606), l = n(704215), r = n(952265), o = n(481060), c = n(243778), d = n(38618), u = n(914010), h = n(921944);
function p(e) {
    return 'dismissible_content_'.concat(h.R.GUILD_TAKEOVER_MODAL, '-').concat(e);
}
t.Z = a.memo(function () {
    return !function () {
        let e = (0, s.e7)([d.Z], () => d.Z.isConnected()) ? [] : [], [t, m] = (0, c.U)(e, h.R.GUILD_TAKEOVER_MODAL), _ = (0, r.f9)(), f = a.useRef(null);
        a.useEffect(() => {
            if (null == t) {
                f.current = null;
                return;

...
let o = {
  [i.DismissibleContent.COLLECTIBLES_SHOP_LUNARNEWYEAR_NEW_BADGE]: {
    type: 1,
    title: () => l.default.Messages.COLLECTIBLES_LUNAR_NEW_YEAR_TOOLTIP_TEXT,
    emojiName: "dragon"
  },
  [i.DismissibleContent.COLLECTIBLES_SHOP_ELEMENTS_TOOLTIP]: {
    type: 1,
    title: () => l.default.Messages.COLLECTIBLES_ELEMENTS_TOOLTIP_TITLE,
    emojiName: "fire"
  },
  [i.DismissibleContent.COLLECTIBLES_SHOP_ELEMENTS_COACHTIP]: {
    type: 2,
    title: () => l.default.Messages.COLLECTIBLES_ELEMENTS_COACHTIP_TITLE,
    body: () => l.default.Messages.COLLECTIBLES_ELEMENTS_COACHTIP_DISCRIPTION,
    imageSrc: r,

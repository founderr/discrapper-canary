...
function p(e) {
  ...
  for (let {
    ...
    if (g.length > 1 && L.type === S.ActivityTypes.PLAYING && !(0, i.default)(L) && null != M) O((0, n.jsx)(_.default.GameSection, {
    ...
    null != p && null != M && M.id === p.config.applicationId && O((0, n.jsx)(c.default, {
      quest: p

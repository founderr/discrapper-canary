...
function I(e) {
  ...
  for (let {
    ...
    } return A.length > 0 && T && A.forEach(e => {
    let {
      stream: t,
      streamUser: n,
      activity: i
    ...
    if (g.length > 1 && L.type === S.ActivityTypes.PLAYING && !(0, i.default)(L) && null != P) v((0, a.jsx)(h.default.GameSection, {
    ...
    } else if ((null != L.assets || (0, i.default)(L)) && L.type === S.ActivityTypes.PLAYING) v((0, a.jsx)(h.default.RichPresenceSection, {
      activity: L,
      ...
      getAssetImage: E.getAssetImage,
      members: M
    }, "spotify-".concat(null !== (C = L.session_id) && void 0 !== C ? C : t, "-").concat(y.id))) : (null != L.assets || (0, i.default)(L)) && L.type === S.ActivityTypes.LISTENING ? v((0, a.jsx)(h.default.RichPresenceSection, {
      activity: L,
      getAssetImage: E.getAssetImage
    }, "rich-presence-".concat(null !== (T = L.session_id) && void 0 !== T ? T : t, "-").concat(y.id))) : (0, u.default)(L) && v((0, a.jsx)(h.default.XboxSection, {
      title: P.name
    }, "xbox-".concat(null !== (A = L.session_id) && void 0 !== A ? A : t)));

n(47120), n(411104);
var i = n(934951), r = n(266067), a = n(38618), o = n(57132), s = n(215355), l = n(777639), u = n(311163), c = n(272423), d = n(781157), h = n(700615), f = n(905423), g = n(703656), _ = n(981631);
function I(e, t, n) {
...
t.Z = new class e {
    ...
    convertRouteToNavigation(e, t) {
        var n, i, a;
        let {pathname: f} = e, g = (0, l.D)(), I = (0, o.cn)(), {mergeTabs: v} = (0, s.LI)({ location: 'convertRouteToNavigation' });
        if (null == g || !g.isReady())
            return;
        let C = e.navigationReplace, R = null !== (n = e.useScreen) && void 0 !== n && n;
        ...
        if (f.startsWith('/channels/')) {
            let e = (0, r.LX)(f, { path: _.Z5c.CHANNEL(':guildId', ':channelId?', ':messageId?') }), t = (0, r.LX)(f, { path: ''.concat(_.Z5c.CHANNEL(':guildId', ':channelId?')).concat(_.Z5c.VOICE_CHAT_CHANNEL_PARTIAL(':voiceGuildId', ':voiceChannelId', ':voiceMessageId?')) });
            if (!I) {
        ...
        if (f.startsWith('/member-verification/')) {
            let e = (0, r.LX)(f, { path: _.Z5c.GUILD_MEMBER_VERIFICATION(':guildId', ':inviteCode?') });
    ...
    executeRouteRewrites(e, t) {
        if (this.routeChangeCount += 1, this.routeChangeCount < 10)
            for (let n of this.rewrites) {
                let r = (0, g.s1)().location.pathname, a = n(e, t);
                if (null != a)
                    return (0, i.n_)({
    ...
    constructor() {
        I(this, 'unlistenHistory', void 0), I(this, 'unlistenKeyboardChange', void 0), I(this, 'rewrites', new Set()), I(this, 'listeners', new Set()), I(this, 'routeChangeCount', 0), I(this, 'timer', -1), I(this, 'connected', !1), I(this, 'handleConnectionChange', () => {
            let e = a.Z.isConnected(), t = e && !this.connected;

...
let U = (e) => {
        ...
        null != c &&
            (n = (0, i.jsx)(u.Tooltip, {
                ...
                children: (e) =>
                    (0, i.jsx)(u.Clickable, {
                        ...e,
                        className: s()(L.hoverButton, y.removeMosaicItemHoverButton),
                        focusProps: { offset: 2 },
                        onClick: c,
    ...
    return (E &&
        (r = (0, i.jsx)(_.Z, {
            ...
            showMenu: m,
            channelId: p,
            className: s()(L.hoverButton, { [L.selected]: m }),
            imageUrl: l,
            mimeType: o
        })),

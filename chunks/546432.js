...
function O(e, n) {
  ...
  if (n && null != i && i > 0 && null != s && s > 0) {
    if ((0, p.CO)(t)) return "IMAGE";
    if (!(0, p.NU)(t) || null == e.proxy_url) return "INVALID";
    else {
      var o;
      return (0, I.yE)(null !== (o = e.flags) && void 0 !== o ? o : 0, j.J0y.IS_CLIP) ? "CLIP" : "VIDEO"
    }
  }
  if (null != n && M.test(t) && null != e.url) return "AUDIO";
  if (null != e.url && (0, g.O)(t)) return "PLAINTEXT_PREVIEW";
  return "OTHER"
}
...
function w(e, n) {
  ...
  if (n && i > 0 && s > 0) return (0, p.tw)(t) ? "IMAGE" : (0, p.X2)(t) ? "VIDEO" : "INVALID";
  return "OTHER"
}
let A = e => {
  let n, t, {
...
function L(e) {
  let {
    ...
    type: k,
    contentType: W
  } = t, [R, Z] = s.useState(!1), U = (0, d.Z)(n.getChannelId()), q = s.useMemo(() => null != W && -1 !== W.indexOf("/") ? W.split("/") : ["unknown", "unknown"], [W]), z = s.useCallback(() => {
    u(t)
  }, [t, u]), X = s.useCallback(() => {
    if (L === f.hV.MOSAIC) {
      let e = !U && ["VIDEO", "CLIP", "AUDIO"].includes(k) || "OTHER" === k;
      if (_) {
        ...
        if (!P && (e * B < f.OF || e * G < f.OF)) return null
      }
      return !R && (0, i.jsx)(A, {
    ...
    B = function() {
      ...
      return (0, i.jsx)(L, {
        ...
        className: l()(t, y.mosaicItemContent, {
          ...
          [y.hiddenExplicit]: E && null != N && [C.wk.EXPLICIT_CONTENT, C.wk.POTENTIAL_EXPLICIT_CONTENT].includes(N),
    ...
    children: (0, i.jsxs)("div", {
      ...
      children: [null != N ? (0, i.jsx)(c.Z, {
        ...
        obscurityControlClassName: l()({
          [y.obscureVideoSpacing]: "VIDEO" === M && I && !E && P
        }),

...
if (!(0, v.NU)(t) || null == e.proxy_url)
  ...
  if (null != n && S.test(t) && null != e.url)
return 'AUDIO';
  if (null != e.url && (0, E.O)(t))
...
children: e => (0, i.jsx)(r.Clickable, {
  ...
  return (I && (l = (0, i.jsx)(m.Z, {
toggleShowMenu: f,
showMenu: g,
channelId: p,
className: s()(L.hoverButton, {
  [L.selected]: g
}),
imageUrl: u,
mimeType: a
...
type: J,
contentType: $
  } = t, [K, Q] = o.useState(!1), [Y, ee] = o.useState(!1), en = n.getChannelId(), et = f.Z.getChannel(en), ei = (0, C.Z)(en), eo = d.P.useExperiment({
location: 'MediaMosaicItem'
  }, {
autoTrackExposure: !0
  }).imageRecsEnabled, el = o.useMemo(() => null != $ && -1 !== $.indexOf('/') ? $.split('/') : [
'unknown',
'unknown'
  ], [$]), es = 'IMAGE' === J && !g.u.test(t.downloadUrl), ea = !1;
  if (W) {
(null == X || null == q) && (ea = !0);
let e = (0, T.Dc)({
  width: null != X ? X : 0,
...
height: C,
type: f
  } = l, j = r(l, (0, x.V)(a.channel_id, a.author.id)), [M, v] = o.useState(null != j), E = d === N.hV.MOSAIC, O = !E && (null != g && g < 200 || null != C && C < 50);

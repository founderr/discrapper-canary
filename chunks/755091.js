...
var i = r(n(449686)), a = n(372542), o = n(699581), s = n(179237), l = r(n(865481)), u = n(560656), c = n(698091), d = r(n(624482)), _ = /^--/, E = {}, f = {
...
var p = /^(matrix|translate|scale|rotate|skew)/, m = /^(translate)/, I = /^(rotate|skew)/, T = function (e, t) {
        ...
        return n.get = function () {
            ...
            return c.each(this.inputs, function (r, i) {
                var a = c.getFluidValue(r[0]), o = e.transforms[i](c.is.arr(a) ? a : r.map(c.getFluidValue)), s = o[0], l = o[1];
                t += ' ' + s, n = n && l;
            }), n ? 'none' : t;
...
var N = u.createHost([
    ...
    applyAnimatedValues: function (e, t) {
        if (!e.nodeType || !e.setAttribute)
            return !1;
        var n = 'filter' === e.nodeName || e.parentNode && 'filter' === e.parentNode.nodeName, r = t.style, a = t.children, o = t.scrollTop, s = t.scrollLeft, l = i(t, [
                'style',
                'children',
                'scrollTop',
                'scrollLeft'
            ]), u = Object.values(l), d = Object.keys(l).map(function (t) {

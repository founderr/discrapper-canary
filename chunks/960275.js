...
class E extends s.default {
  ...
  constructor(...e) {
    super(...e), c(this, "handleSettingsUpdate", e => {
      ...
      t.enabled ? (0, l.unlockAchievement)(o.PoggermodeAchievementId.ENABLE_POGGERMODE) : !1 === t.enabled && (0, l.unlockAchievement)(o.PoggermodeAchievementId.DISABLE_POGGERMODE), Object.keys(t).some(e => e.startsWith("confetti")) && (0, l.unlockAchievement)(o.PoggermodeAchievementId.CUSTOMIZE_CONFETTI)
      ...
      if ((null == c ? void 0 : c.find(e => e.id === E)) != null ? (0, l.unlockAchievement)(o.PoggermodeAchievementId.PING_ME) : (null !== (t = null == c ? void 0 : c.length) && void 0 !== t ? t : 0) > 0 && (null == a ? void 0 : a.id) === E && (0, l.unlockAchievement)(o.PoggermodeAchievementId.PING_SOMEONE), !(0, d.shouldTrackMessage)(null == a ? void 0 : a.id, E, s, f)) return !1;

    ...
    constructor(...e) {
        super(...e),
            u(this, 'handleSettingsUpdate', (e) => {
                let { settings: t } = e;
                t.enabled ? (0, l.T)(o.hn.ENABLE_POGGERMODE) : !1 === t.enabled && (0, l.T)(o.hn.DISABLE_POGGERMODE), Object.keys(t).some((e) => e.startsWith('confetti')) && (0, l.T)(o.hn.CUSTOMIZE_CONFETTI);
            }),
            u(this, 'handleMessageCreate', (e) => {
                ...
                let m = a.default.getId();
                if (((null == u ? void 0 : u.find((e) => e.id === m)) != null ? (0, l.T)(o.hn.PING_ME) : (null !== (t = null == u ? void 0 : u.length) && void 0 !== t ? t : 0) > 0 && (null == i ? void 0 : i.id) === m && (0, l.T)(o.hn.PING_SOMEONE), !(0, d.wU)(null == i ? void 0 : i.id, m, r, h))) return !1;

...
function A(e) {
    ...
    E.delete(e), delete b[e], t && delete T[e], (v += 1);
}
function N(e) {
    return null != e ? e : S;
}
...
class U extends (r = u.ZP.Store) {
    ...
    getUserCount(e, t) {
        var n, r, i, a;
        if (null == e) return 0;
        let s = null !== (i = null === (n = T[e]) || void 0 === n ? void 0 : n[S]) && void 0 !== i ? i : 0;
...
(s = 'GuildScheduledEventStore'),
    ...
    (t.ZP = new U(d.Z, {
        CONNECTION_OPEN: function (e) {
            let { guilds: t } = e;
            return E.clear(), (v = 0), (b = {}), (T = {}), I.forEach(y), t.forEach((e) => e.guild_scheduled_events.forEach((e) => y(e))), !0;
        },

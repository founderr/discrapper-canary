...
let A = new d.SecondaryIndexMap(e => {
    let {
      guild_id: t,
      entity_id: n,
      channel_id: i
...
function C(e) {
  ...
  A.delete(e), delete O[e], t && delete p[e], h += 1
}
...
function D(e) {
  ...
  let s = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
    ...
    o = (null === (n = O[e.guild_scheduled_event_id]) || void 0 === n ? void 0 : null === (t = n[a]) || void 0 === t ? void 0 : t[e.user_id]) != null,
    l = e.user_id === c.default.getId();
  (o || !l) && (null === (r = O[e.guild_scheduled_event_id]) || void 0 === r || null === (i = r[a]) || void 0 === i || delete i[e.user_id], function(e) {
    var t, n;
    let i = g(e.guild_scheduled_event_exception_id),
      r = null !== (n = null === (t = p[e.guild_scheduled_event_id]) || void 0 === t ? void 0 : t[i]) && void 0 !== n ? n : 0,
      s = null != e.guild_scheduled_event_exception_id && e.response === T.GuildScheduledEventUserResponses.UNINTERESTED || null == e.guild_scheduled_event_exception_id && e.response === T.GuildScheduledEventUserResponses.INTERESTED ? -1 : 1;
...
function M(e, t) {
  A.values(f.GUILD_EVENT(e)).forEach(e => C(e.id, t))
}
...
class w extends(i = u.default.Store) {
  ...
  getUserCount(e, t) {
    var n, i, r, s;
    if (null == e) return 0;
    let a = null !== (r = null === (n = p[e]) || void 0 === n ? void 0 : n[N]) && void 0 !== r ? r : 0;
    return null == t ? a : a - (null !== (s = null === (i = p[e]) || void 0 === i ? void 0 : i[t]) && void 0 !== s ? s : 0)
  }
  hasUserCount(e, t) {
    var n;
    let i = g(t);
...
a = "GuildScheduledEventStore", (s = "displayName") in(r = w) ? Object.defineProperty(r, s, {
  ...
  CONNECTION_OPEN: function(e) {
    ...
    return A.clear(), h = 0, O = {}, p = {}, m.forEach(R), t.forEach(e => e.guild_scheduled_events.forEach(e => R(e))), !0
  },
  ...
  FETCH_GUILD_EVENTS_FOR_GUILD: function(e) {
    ...
    } = e, i = A.values(f.GUILD_EVENT(t), !0).map(e => e.id), r = n.map(e => e.id);
  ...
  GUILD_SCHEDULED_EVENT_USER_ADD: function(e) {
    ...
    let {
      ...
      response: o
    } = e, l = g(a), u = null === (n = O[r]) || void 0 === n ? void 0 : null === (t = n[l]) || void 0 === t ? void 0 : t[i];
    null != u && D(u, !1);
  ...
  GUILD_SCHEDULED_EVENT_RSVPS_FETCH_SUCESS: function(e) {
    ...
    return t.forEach(e => L(e, !1, !1)), h += 1, !0
  },

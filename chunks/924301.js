...
var r, i, a, o, s = n(392711), l = n.n(s), u = n(442837), c = n(759174), d = n(570140), _ = n(314897), E = n(271383), f = n(709054), h = n(765305);
let p = {
    EVENT: 'event',
    EVENT_ACTIVE: 'active',
...
function C(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], r = e.guild_scheduled_event_id;
    null == A[r] && (A[r] = {});
    let i = R(e.guild_scheduled_event_exception_id);
    null == A[r][i] && (A[r][i] = {}), A[r][i][e.user_id] = e, t && function (e) {
        var t, n;
        let r = R(e.guild_scheduled_event_exception_id), i = null !== (n = null === (t = N[e.guild_scheduled_event_id]) || void 0 === t ? void 0 : t[r]) && void 0 !== n ? n : 0, a = null != e.guild_scheduled_event_exception_id && e.response === h.gv.UNINTERESTED || null == e.guild_scheduled_event_exception_id && e.response === h.gv.INTERESTED ? 1 : -1;
        D(e.guild_scheduled_event_id, e.guild_scheduled_event_exception_id, i + a);
    }(e), n && (T += 1);
}
function y(e) {
    var t, n, r, i;
    let a = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], o = R(e.guild_scheduled_event_exception_id), s = (null === (n = A[e.guild_scheduled_event_id]) || void 0 === n ? void 0 : null === (t = n[o]) || void 0 === t ? void 0 : t[e.user_id]) != null, l = e.user_id === _.default.getId();
...
function M(e) {
    let {eventException: t} = e, n = I.get(t.event_id);
    if (null == n)
        return !1;
    let r = n.guild_scheduled_event_exceptions.findIndex(e => e.event_exception_id === t.event_exception_id), i = [...n.guild_scheduled_event_exceptions];
...
class x extends (r = u.ZP.Store) {
    ...
    isInterestedInEventRecurrence(e, t) {
        let n = _.default.getId(), r = this.getRsvp(e, null, n), i = this.getRsvp(e, t, n), a = (null == r ? void 0 : r.response) === h.gv.INTERESTED, o = (null == i ? void 0 : i.response) === h.gv.INTERESTED, s = (null == i ? void 0 : i.response) === h.gv.UNINTERESTED;
        return a && !s || o;
    }
    getUserCount(e, t) {
        var n, r, i, a;
...
o = 'GuildScheduledEventStore', (a = 'displayName') in (i = x) ? Object.defineProperty(i, a, {
    ...
    INVITE_RESOLVE_SUCCESS: function (e) {
        let {invite: t} = e, n = t.guild_scheduled_event;
        return null != n && (v(n), !0);
    },

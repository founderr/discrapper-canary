...
var r = n(833858), i = n(657305), a = n(841784), o = n(420660), s = n(981631), l = n(689938);
function u(e) {
    return {
...
function c(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], c = arguments.length > 3 ? arguments[3] : void 0;
    if (null != e && e.type === s.IIU.CUSTOM_STATUS)
        return null != e.state ? e.state.trim() : null;
    if (null != t)
        return null == e || e.type !== s.IIU.PLAYING ? l.Z.Messages.SHARING_SCREEN : u(n)[s.IIU.STREAMING].format({ name: e.name });
    ...
    if ((0, o.Z)(e)) {
        ...
        return u(n)[s.IIU.STREAMING].format({ name: t });
    }

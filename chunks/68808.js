...
return (0, r.ZT)(t, e), t.fromDate = function(e) {
  ...
  for (t && (this.hour += Math.floor((23 - this.hour) / e) * e);;) {
    ...
    var r = (0, a.qq)(this.hour, 24),
      i = r.div,
      s = r.mod;
    if (i && (this.hour = s, this.addDaily(i)), (0, a.cS)(n) || (0, a.q9)(n, this.hour))
      break;
  }
  ...
  for (t && (this.minute += Math.floor((1439 - (60 * this.hour + this.minute)) / e) * e);;) {
    ...
    var i = (0, a.qq)(this.minute, 60),
      s = i.div,
      o = i.mod;
    if (s && (this.minute = o, this.addHours(s, !1, n)), ((0, a.cS)(n) || (0, a.q9)(n, this.hour)) && ((0, a.cS)(r) || (0, a.q9)(r, this.minute)))
      break;
  }
  ...
  for (t && (this.second += Math.floor((86399 - (3600 * this.hour + 60 * this.minute + this.second)) / e) * e);;) {
    ...
    var s = (0, a.qq)(this.second, 60),
      o = s.div,
      l = s.mod;
    if (o && (this.second = l, this.addMinutes(o, !1, n, r)), ((0, a.cS)(n) || (0, a.q9)(n, this.hour)) && ((0, a.cS)(r) || (0, a.q9)(r, this.minute)) && ((0, a.cS)(i) || (0, a.q9)(i, this.second)))
      break;
  }

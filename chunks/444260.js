...
var l = t(735250), s = t(470079), a = t(120356), i = t.n(a), r = t(481060), o = t(268939), d = t(473403), u = t(603236), c = t(689938), h = t(165932), I = t(331651);
let g = e => {
        let {
                guild: n,
                inviteChannel: t,
                setInviteChannel: a
            } = e, i = (0, o.Z)(n.id), u = s.useMemo(() => i.reduce((e, n) => ({
                ...e,
                [n.id]: n
            }), {}), [i]), h = s.useMemo(() => Object.values(u).map(e => ({
                value: e.id,
                label: e.name
            })), [u]);
        return (0, l.jsx)(r.SearchableSelect, {
            ...
            renderOptionPrefix: e => {
                if (null == e)
                    return null;
                let t = u[e.value];
                return null == t ? null : (0, l.jsx)(d._, {
                    channel: t,
                    guild: n
                });
            }

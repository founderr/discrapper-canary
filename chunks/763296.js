...
function D(e) {
    ...
    null != n && null != r && -1 !== r ? ((n[r] = t), b.set(t.guildId, [...n])) : null != n && (null == n || n.push(t), b.set(t.guildId, [...n]));
}
let L = c().debounce((e) => {
...
class w extends (i = d.ZP.Store) {
    ...
    getSound(e, t) {
        var n;
        return (null !== (n = b.get(e)) && void 0 !== n ? n : []).find((e) => e.soundId === t);
    }
    getSoundById(e) {
...
(l = 'SoundboardStore'),
    ...
    (t.Z = new w(f.Z, {
        LOGOUT: function () {
            b.clear(), S.clear(), R.clear(), (O = !1), (N = 0), (A = 0);
        },
        ...
        GUILD_SOUNDBOARD_SOUND_PLAY_START: function (e) {
            ...
            S.set(i, s), R.set(a, o), a !== (null === (t = h.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (O = !0);
        },
        GUILD_SOUNDBOARD_SOUND_PLAY_END: function (e) {
            var t, n;
            let { soundId: r, userId: i } = e,
                a = (null !== (t = S.get(r)) && void 0 !== t ? t : 0) - 1,
                s = (null !== (n = R.get(i)) && void 0 !== n ? n : 0) - 1;
            a <= 0 ? S.delete(r) : S.set(r, a), s <= 0 ? R.delete(i) : R.set(i, s);
        },
        ...
        OVERLAY_INITIALIZE: function (e) {
            ...
            (b = new Map(E.default.entries(t.soundboardSounds))), (C = new Set(t.favoritedSoundIds)), (y = new Set(t.localSoundboardMutes));
        },

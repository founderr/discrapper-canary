...
var n = s(735250), o = s(470079), a = s(481060), i = s(194359), l = s(153124), r = s(51144), u = s(689938), d = s(714628);
function c(e) {
    let {
            user: t,
            nickname: s,
            transitionState: c,
            onClose: N
        } = e, h = (0, l.Dt)(), [p, M] = o.useState(!1), [I, x] = o.useState(s), C = o.useRef(null), E = async e => {

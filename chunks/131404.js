...
n.default = (0, u.Z)((0, l.Z)(function(e) {
  let {
    ...
    user: n
  }), $ = (0, V.Z)(n.id), ee = (0, P.Z)(t.id, l), en = (0, y.Z)({
    user: n
  }), et = (0, o.Z)(null, n), ei = (0, D.Z)(n.id), ea = (0, b.Z)(n.id, t.id), er = (0, O.Z)(n), el = (0, L.Z)(n.id), eu = (0, I.P)({
    userId: n.id,
    channelId: t.id,
    location: "DMUserContextMenu"
  }), es = (0, G.Z)(n.id, t.id), eo = (0, v.Z)({
    user: n
  ...
  return (0, i.jsxs)(a.Menu, {
    ...
    children: [(0, i.jsx)(a.MenuGroup, {
      ...
      children: [(0, i.jsx)(a.MenuGroup, {
        ...
        children: [d && el, z && eu, d && es, eZ, z && en, er, z && eo, d && eT]
      }), (0, i.jsxs)(a.MenuGroup, {
        children: [u && ed, ec]

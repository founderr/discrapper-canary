...
let R = (0, p.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_CATEGORY_LIST_PADDING), C = (0, p.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_CATEGORY_ICON_SIZE), y = (0, p.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_CATEGORY_ICON_MARGIN), D = (0, p.Mg)(s.Z.STICKERS_CONSTANTS_STICKER_CATEGORY_UNICODE_ICON_SIZE), L = (0, p.Mg)(s.Z.STICKERS_CONSTANTS_CATEGORY_SEPARATOR_SIZE), b = (0, p.Mg)(s.Z.STICKERS_CONSTANTS_CATEGORY_SEPARATOR_MARGIN_VERTICAL), M = [
        ...
        let {
                ...
                var u, d;
                let _;
                let m = (null === (u = n[0]) || void 0 === u ? void 0 : u.type) === T.Ih.FAVORITE, R = m ? 1 : 0, y = (null === (d = n[R]) || void 0 === d ? void 0 : d.type) === T.Ih.RECENT, L = n.length > 0, b = n.length;
                if (0 === a && m)
                    return (0, r.jsx)('div', {
                        role: 'listitem',
                        'aria-setsize': b,
                ...
                let M = t === a, P = n[a], U = n[a + 1], w = null != U && P.type === T.Ih.GUILD && U.type !== T.Ih.GUILD, x = P.type === T.Ih.PACK, G = '', k = null;
...
t.Z = e => {
    let {
            ...
            var e, t;
            let n = _.filter(e => e.type === T.Ih.GUILD).length, r = (null === (e = _[0]) || void 0 === e ? void 0 : e.type) === T.Ih.RECENT, i = n + (r ? 1 : 0) + ((null === (t = _[0]) || void 0 === t ? void 0 : t.type) === T.Ih.FAVORITE ? 1 : 0), a = i * (C + y) - y + U;
            return {
    ...
    return (0, r.jsx)(E.Z, {
        ...
        children: e => I && s && (0, r.jsx)(l.Clickable, {
            className: o()(O.standardStickerShortcut, { [O.invisibleShortcut]: !s }),
            onClick: () => N(e),

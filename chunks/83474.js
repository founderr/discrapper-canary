...
function Z(e) {
  ...
  let {
    ...
    memberCount: Z,
    emojis: C
  } = n, S = (0, c.e7)([x.default], () => x.default.getId()), O = (0, c.e7)([g.ZP], () => g.ZP.isMember(p, S), [p, S]), [A, D] = i.useState(!1), F = e => {
    if (e.stopPropagation(), O)(0, m.XU)(p, r, u);
    else {
      let e = {
  ...
  return null != M && M.length > 6 && null != C && (M = null !== (s = null == C ? void 0 : C.slice(Math.max((null == C ? void 0 : C.length) - 6, 0))) && void 0 !== s ? s : [], y = C.length - 6), (0, a.jsxs)(o.Dialog, {
    ...
    children: [null != G ? (0, a.jsx)("img", {
      ...
      className: E.footer,
      children: [null != M && M.length > 0 ? (0, a.jsxs)(a.Fragment, {

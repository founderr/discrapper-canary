...
var o = a(n(470079)), r = n(699581), i = a(n(79125));
function a(e) {
...
var u = function (e) {
    ...
    return u.handleLifecycle = function (e, t, n) {
        var i, a = this.props.children, u = o.default.Children.toArray(a)[t];
        u.props[e] && (i = u.props)[e].apply(i, n), this.props[e] && this.props[e]((0, r.findDOMNode)(this));
    }, u.render = function () {
        var e = this.props, t = e.children, n = e.in, r = function (e, t) {
                if (null == e)
                    return {};
                ...
                'children',
                'in'
            ]), a = o.default.Children.toArray(t), u = a[0], s = a[1];

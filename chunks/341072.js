...
function H(e) {
  ...
  let {
    ...
    onSubmit: S,
    onClose: G
  } = e, P = (0, f.useUID)(), F = (0, f.useUID)(), U = (0, f.useUID)(), B = (0, f.useUID)(), [k, Y] = l.useState(y.NULL_STRING_CHANNEL_ID), [V, w] = l.useState(y.ChannelTypes.GUILD_TEXT), [X, W] = l.useState(""), [K, z] = l.useState(!1), J = (0, i.useStateFromStores)([h.default], () => h.default.getGuild(H), [H]), q = (0, C.useGuildEligibleForStageChannels)(H), Q = (0, E.useCanCreateForumChannel)(H), Z = (0, N.useGuildEligibleForMediaChannels)(J), $ = l.useMemo(() => (function(e) {
    let {
      ...
      description: j.default.Messages.CREATE_TEXT_CHANNEL_DESCRIPTION
    }, {
      icon: M.default,
      label: j.default.Messages.VOICE_CHANNEL_TYPE,
      value: y.ChannelTypes.GUILD_VOICE,
      description: j.default.Messages.CREATE_VOICE_CHANNEL_DESCRIPTION
    }];
    return a && n.push({
      icon: x.default,
      label: j.default.Messages.STAGE_VOICE_CHANNEL_TYPE,
      value: y.ChannelTypes.GUILD_STAGE_VOICE,
      description: j.default.Messages.CREATE_STAGE_CHANNEL_DESCRIPTION
    }), s && (n.push({
      icon: I.default,
      ...
      description: j.default.Messages.CREATE_MEDIA_CHANNEL_DESCRIPTION,
      isBeta: !0
    })), n.map(e => {
      let {
        icon: a,
        ...
        name: (0, t.jsxs)("div", {
          ...
          children: [(0, t.jsx)(a, {
            ...
            children: [(0, t.jsxs)(o.Text, {
              ...
              children: [s, (0, t.jsx)(u.ChannelTypeBadge, {
                isBeta: i
              })]
            }), (0, t.jsx)(o.Text, {
  ...
  }), [q, Q, Z]), ee = (0, i.useStateFromStores)([p.default], () => p.default.getCategories(H)._categories, [H]), ea = l.useMemo(() => ee.map(e => {
    let {
      channel: a
    } = e;
    return {
  ...
  }), [ee]), es = null !== (s = null === (a = $.find(e => e.value === V)) || void 0 === a ? void 0 : a.channelIcon) && void 0 !== s ? s : D.NOOP_NULL, et = "" !== X;
  return (0, t.jsx)("form", {
    onSubmit: function(e) {
    ...
    children: (0, t.jsxs)(o.ModalRoot, {
      ...
      children: [(0, t.jsxs)(o.ModalHeader, {
        ...
        children: [(0, t.jsx)(o.FormItem, {
          title: j.default.Messages.CATEGORY,
          titleId: F,
          children: (0, t.jsx)(o.SingleSelect, {
            placeholder: j.default.Messages.CREATE_CHANNEL_MODAL_CATEGORY_PLACEHOLDER,
            value: k,
            options: ea,
            onChange: e => Y(e),
            "aria-labelledby": F
          ...
          children: (0, t.jsx)(o.TextInput, {
            value: X,
            onChange: function(e) {
              (0, _.isGuildTextChannelType)(V) && (e = (0, v.sanitizeGuildTextChannelName)(e)), W(e)
            },

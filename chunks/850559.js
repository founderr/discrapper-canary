...
function l(e) {
    ...
    (0, a.useEffect)(() => {
        var t, n;
        g && (b.size > 0 || p) && !w.isOpen && L !== B.current && 'manual' !== h && x(null, 'input'), !T && !p && w.isOpen && 0 === b.size && k(), null != R && R !== V.current && k(), L !== B.current && (O.setFocusedKey(null), S(!1), '' === L && (void 0 === e.inputValue || void 0 === e.selectedKey) && v(null)), R !== V.current && (void 0 === e.inputValue || void 0 === e.selectedKey) ? F() : (B.current = L);

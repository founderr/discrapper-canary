...
var i, E, r, o, l, s, c, a, I, S, _, u, A, N, T = n("981631");
...
class f {}
L(f, "CLASSIFICATION_ID", "classification_id"), L(f, "INCIDENT_TIMESTAMP", "incident_time"), (E = I || (I = {})).POLICY_VIOLATION_DETAIL = "policy_violation_detail", E.LEARN_MORE_LINK = "learn_more_link";
class O {}
...
let d = [0, 1, 2, 3],
  R = 372,
  M = 279;
(s = A || (A = {})).SPEED_BUMP = "speed-bump", s.COLLECT_SIGNAL = "collect-signal", s.CONFIRM_SUBMISSION = "confirm-submission", s.REQUEST_SENT = "request-sent", s.THANKS = "thanks";
let D = {
    "speed-bump": {
      next: "collect-signal",
      prev: null
...
(c = N || (N = {}))[c.USER = 1] = "USER", c[c.GUILD_OWNER = 2] = "GUILD_OWNER", c[c.GUILD_MEMBER = 3] = "GUILD_MEMBER"
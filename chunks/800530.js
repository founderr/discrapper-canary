...
class C {}
N(C, 'CLASSIFICATION_ID', 'classification_id'), N(C, 'INCIDENT_TIMESTAMP', 'incident_time'), ((s = d || (d = {})).POLICY_VIOLATION_DETAIL = 'policy_violation_detail'), (s.LEARN_MORE_LINK = 'learn_more_link');
class p {}

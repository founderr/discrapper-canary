...
var i = n(392711), a = n.n(i), s = n(772848), l = n(652874), r = n(125268), o = n(673125), c = n(292793), d = n(88315), u = n(199766), h = n(813900);
let p = {
        X_OFFSET: 2 * h.qh,
        Y_OFFSET: 25,
        X_SPEED: 0.5,
...
function f(e) {
    ...
    if (_(f, e => {
            ...
            var i;
            let l = null !== (i = m.getState().lastSpawned[e.id]) && void 0 !== i ? i : 0, r = Date.now();
            if (!(l + 100 > r) && e.state !== c.f.STOP && !!(0.8 >= Math.random() || l + 300 < r))
                m.setState(i => {
                    var l, r, o;
                    let c = null !== (l = i.particles[e.id]) && void 0 !== l ? l : {}, d = a().random(1, 2);
                    for (let e = 0; e < d; e++) {
                        ;
                        let e = (r = t, o = n, {
                            id: (0, s.Z)(),
            ...
            if (null == t)
                return;
            let i = n.size * window.devicePixelRatio, a = n.x - i / 2 * window.devicePixelRatio, s = n.y - 1.2 * i * window.devicePixelRatio;

...
}(E, A, M), (0, h.I)(C, A, M, b, p.q2), (0, h.T)(C, A, M, E.userId), f(E, e => function(e, t, n) {
  if (null == t)
    return;
...
}(C, Z, e)), E.lastUpdatedAt + p.FO < Date.now() && (0, o.ZZ)(v, E), E.state === u.f.STOP && (i = E, !(Object.keys(null !== (l = _.getState().particles[i.id]) && void 0 !== l ? l : {}).length > 0)))
S.push(E);
  C.restore();
}
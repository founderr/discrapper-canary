...
function E(e) {
    var t, n, i, l;
    let { emojiHose: E, context: g, canvasWidth: C, canvasHeight: I, fallbackColor: x, outlineColorDark: T, outlineColorLight: S, streamerId: v, deadDrawables: N } = e;
    g.save();
    let A = c.Z.getEmojiImage(null !== (n = null !== (t = E.emojiId) && void 0 !== t ? t : E.emojiName) && void 0 !== n ? n : ''),
        Z = (0, d.np)(E.x, C),
        M = (0, d.np)(E.y, I),
        { outlineColor: b } = (0, d.bg)(E.userId, T, S, x);
    if (
        (f(E, (e) => {
            var t, n;
            return (

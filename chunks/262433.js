...
var i = n(392711), a = n.n(i), l = n(772848), s = n(652874), r = n(125268), o = n(673125), c = n(292793), d = n(88315), u = n(199766), h = n(813900);
let p = {
        X_OFFSET: 2 * h.qh,
        Y_OFFSET: 25,
        X_SPEED: 0.5,
...
function f(e) {
    ...
    E.save();
    let S = o.Z.getEmojiImage(null !== (n = null !== (t = f.emojiId) && void 0 !== t ? t : f.emojiName) && void 0 !== n ? n : ''), Z = (0, d.np)(f.x, C), A = (0, d.np)(f.y, g), {outlineColor: M} = (0, d.bg)(f.userId, x, T, I);
    if (_(f, e => {
            var t, n;
            ...
            if (!(s + 100 > r) && e.state !== c.f.STOP && !!(0.8 >= Math.random() || s + 300 < r))
                m.setState(i => {
                    var s, r, o;
                    let c = null !== (s = i.particles[e.id]) && void 0 !== s ? s : {}, d = a().random(1, 2);
                    for (let e = 0; e < d; e++) {
                        ;
                        let e = (r = t, o = n, {
                            id: (0, l.Z)(),

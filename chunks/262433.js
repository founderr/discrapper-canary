...
var i = n(392711), a = n.n(i), l = n(772848), s = n(652874), r = n(125268), o = n(673125), c = n(292793), u = n(88315), d = n(199766), h = n(813900);
let p = {
        X_OFFSET: 2 * h.qh,
        Y_OFFSET: 25,
        X_SPEED: 0.5,
...
function f(e) {
    ...
    E.save();
    let S = o.Z.getEmojiImage(null !== (n = null !== (t = f.emojiId) && void 0 !== t ? t : f.emojiName) && void 0 !== n ? n : ''), Z = (0, u.np)(f.x, C), A = (0, u.np)(f.y, g), {outlineColor: M} = (0, u.bg)(f.userId, x, T, I);
    if (_(f, e => {
            var t, n;
            ...
            var i;
            let s = null !== (i = m.getState().lastSpawned[e.id]) && void 0 !== i ? i : 0, r = Date.now();
            if (!(s + 100 > r) && e.state !== c.f.STOP && !!(0.8 >= Math.random() || s + 300 < r))
                m.setState(i => {
                    var s, r, o;
                    let c = null !== (s = i.particles[e.id]) && void 0 !== s ? s : {}, u = a().random(1, 2);
                    for (let e = 0; e < u; e++) {
                        ;
                        let e = (r = t, o = n, {
                            id: (0, l.Z)(),
            ...
            if (null == t)
                return;
            let i = n.size * window.devicePixelRatio, a = n.x - i / 2 * window.devicePixelRatio, l = n.y - 1.2 * i * window.devicePixelRatio;
            e.globalAlpha = n.opacity, e.drawImage(t, i / 2 + a, i / 2 + l, i, i);
        }(E, S, e)), f.lastUpdatedAt + h.FO < Date.now() && (0, r.ZZ)(N, f), f.state === c.f.STOP && (i = f, !(Object.keys(null !== (s = m.getState().particles[i.id]) && void 0 !== s ? s : {}).length > 0)))
        v.push(f);
    E.restore();
}

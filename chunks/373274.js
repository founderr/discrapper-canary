...
class eo extends(l = s.PureComponent) {
  ...
  constructor(...e) {
    super(...e), er(this, "_list", null), er(this, "unreadTopRef", s.createRef()), er(this, "unreadBottomRef", s.createRef()), er(this, "state", {
      ...
      null != n && s.includes(n) && (a = (0, S.getFirstRouteFor)(t)), (0, S.clearRecentChannels)(e.id, s, a)
      ...
      let {
        category: g,
        channel: S
      } = m, N = g instanceof D.ChannelListFavoritesCategory, T = S.record, A = "".concat(t).concat(S.id);
      switch (T.type) {
        ...
        case el.ChannelTypes.GROUP_DM:
          return (0, a.jsxs)(s.Fragment, {
            children: [(0, a.jsx)(Q.default, {
              ...
              withGuildIcon: C
            }), S.threadCount > 0 ? (0, a.jsx)(z.default, {
              withGuildIcon: C,
              channel: T,
        ...
        case el.ChannelTypes.GUILD_CATEGORY:
          ...
          return (0, a.jsx)(P.ReadonlyCategoryChannel, {
            channel: T
...
let eu = e => {
  ...
  } = (0, m.default)(C.default.GUILD_CHANNEL_LIST), d = (0, u.useStateFromStores)([x.default], () => x.default.getChannel(n)), c = (0, u.useStateFromStores)([x.default], () => x.default.getChannel(l)), f = (0, u.useStateFromStores)([O.default], () => O.default.getGuildId()), g = (0, N.useOptInEnabledForGuild)(t), E = s.useRef(null), _ = s.useCallback((e, t) => {
    let n = E.current;
    if (null != n) {

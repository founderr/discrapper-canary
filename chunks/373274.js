...
class ec extends (i = r.PureComponent) {
    ...
    componentDidUpdate(e, t) {
        let {
                ...
                guildId: i,
                selectedChannelId: l
            } = this.props, {initialized: r} = this.state, {scrollTop: a} = b.Z.getGuildDimensions(i);
    ...
    scrollToChannel(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : ei.yE, i = arguments.length > 3 ? arguments[3] : void 0, l = this._list, r = this.getSectionRowsFromChannel(e)[0];
        if (null != r && null != l) {
    ...
    isUnreadVisible() {
        let {guildChannels: e} = this.props, t = this._list;
        return null != t && t.getItems().some(n => {
            ...
            if (i < O.wd || e.isPlaceholderRow(i, l))
                return !1;
            ...
            return !!(0, L.vc)(a.record.type) && (!s.isCollapsed || !s.isMuted) && !a.isMuted && !!t.isItemVisible(i, l, !0) && (0, Z.d)(a.record);
        });
    }
    renderTopUnread() {
        let {
    ...
    constructor(...e) {
        super(...e), eo(this, '_list', null), eo(this, 'unreadTopRef', r.createRef()), eo(this, 'unreadBottomRef', r.createRef()), eo(this, 'state', {
            ...
            let n = this.getSectionRowsFromChannel(e), i = this._list;
            if (null == i)
                return !1;
            for (let {
                        row: e,
            ...
            if (null == e)
                return [];
            let t = e.getItems(), n = e.getScrollerState(), i = [];
            for (var l = 0; l < t.length; l++) {
                let r = t[l];
                if ((0, d.isListItemRow)(r) && r.section >= this.props.guildChannels.favoritesSectionNumber) {
                    let t = this.props.guildChannels.getChannelFromSectionRow(r.section, r.row), [l, a] = e.getScrollPosition(r.section, r.row);
            ...
            var e, t;
            let {showNewUnreadsBar: n} = this.props, i = null !== (t = null === (e = this._list) || void 0 === e ? void 0 : e.getScrollerState()) && void 0 !== t ? t : null;
            ...
            var e, t;
            let {onScroll: n} = this.props, i = null !== (t = null === (e = this._list) || void 0 === e ? void 0 : e.getScrollerState()) && void 0 !== t ? t : null;
            if (null != i) {
                let {scrollTop: e} = i;
            ...
            if (c.record.type === el.d4z.GUILD_CATEGORY)
                return 40;
            let {isFavoritesPerk: d} = C.Z.getCurrentConfig({ location: 'channel_list' }, { autoTrackExposure: !0 });
            ...
            if (null != c.subtitle && (s += ei.NY), c.record.isGuildStageVoice()) {
                var h, p;
                let e = null !== (h = i[c.id]) && void 0 !== h ? h : [], t = null !== (p = l[c.id]) && void 0 !== p ? p : [];
                if (null != e && e.length > 0) {
            ...
            if (null == i)
                return;
            let l = null, r = i.getShownChannelAndThreadIds();
            ...
            if (t === O.zm) {
                let e = u.getCommunitySection(), t = e.getRow(n);
                if (null == t)
                    return null;
                switch (t) {
            ...
            if (e !== O.zm) {
                if (null == t)
                    return e === O.p2 ? 'favorites-header' : e === r.recentsSectionNumber ? 'recents-header' : e === r.voiceChannelsSectionNumber ? 'voice-channels' : e === O.wd ? 'uncategorized-header' : null === (l = r.getNamedCategoryFromSection(e)) || void 0 === l ? void 0 : l.id;
            ...
            if (!T.Z.shouldShow('voice-conversations'))
                return;
            let {guildChannels: e} = this.props, t = e.getFirstVoiceChannel();
            if (null == t) {
...
function ed(e) {
    let t = (0, j.o)(), {isFavoritesPerk: n} = (0, C.z)('favorites-channel-list');
    return (0, l.jsx)(eu, {
        ...e,
        guildChannels: t,
...
function eh(e) {
    let t = (0, U.Z)(e.guild), n = (0, D.Z)(e.guild), i = s().uniq(n.concat(t)), r = (0, u.cj)([P.Z], () => P.Z.getGuild(e.guildId, i));
    return (0, l.jsx)(eu, {
        ...e,
        ...r
    });

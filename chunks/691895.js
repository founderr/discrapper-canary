...
var r = n(392711), i = n.n(r), a = n(956067), o = n(91159);
function s(e) {
    ...
    return a.Z.logGroups.map(r => {
        ...
        let {
                ...
                nativeLogs: _,
                serverTrace: E
            } = r, f = 0 === u ? null !== (s = null === (a = i().find(d, e => e.log.indexOf('Logger loaded') >= 0)) || void 0 === a ? void 0 : a.timestamp) && void 0 !== s ? s : e : c, h = function (e, t) {
                var n, r;
                let a = function (e) {
                        let t = [];
                    ...
                    }), o = null !== (n = i().max(a.map(e => e.totalTime.length))) && void 0 !== n ? n : 0, s = null !== (r = i().max(a.map(e => e.deltaTime.length))) && void 0 !== r ? r : 0;
                return a.map(e => {
                    let {
                        totalTime: t,
                        deltaTime: n,
                ...
                e = e.slice();
                let i = new Set(t.map(l)), a = '', o = [];
                t.forEach(t => {
                    let r = l(t), s = 0, u = n || !t.autoGenerated, c = r.startsWith('Start ') && !r.includes('RUN_JS_BUNDLE') && i.has(r.replace('Start ', 'Finish '));
            ...
            }(d, _, t, n), f), p = 'Trace #'.concat(u + 1, ' started ').concat((0, o.Ye)(c), '\n').concat(h);

...
let {
  ...
  nativeLogs: _,
  serverTrace: E
} = r, f = 0 === u ? null !== (o = null === (a = i().find(d, e => e.log.indexOf('Logger loaded') >= 0)) || void 0 === a ? void 0 : a.timestamp) && void 0 !== o ? o : e : c, h = function(e, t) {
  var n, r;
  let a = function(e) {
      let t = [];
...
}(d, _, t, n), f), p = 'Trace #'.concat(u + 1, ' started ').concat((0, s.Ye)(c), '\n').concat(h);

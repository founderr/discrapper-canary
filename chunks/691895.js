...
function o(e) {
  ...
  return s.default.logGroups.map(i => {
    ...
    let {
      ...
      nativeLogs: c,
      serverTrace: E
    } = i, I = 0 === u ? null !== (o = null === (s = r().find(_, e => e.log.indexOf("Logger loaded") >= 0)) || void 0 === s ? void 0 : s.timestamp) && void 0 !== o ? o : e : d, T = function(e, t) {
      var n, i;
      let s = (function(e) {
          let t = [];
        ...
        a = null !== (n = r().max(s.map(e => e.totalTime.length))) && void 0 !== n ? n : 0,
        o = null !== (i = r().max(s.map(e => e.deltaTime.length))) && void 0 !== i ? i : 0;
      return s.map(e => {
        let {
          totalTime: t,
          deltaTime: n,
        ...
        return "".concat(r().padStart(t, a), " ").concat(r().padStart(n, o), " ").concat(i)
      }).join("")
    }(function(e, t, n, i) {
      e = e.slice();
      ...
      t.forEach(t => {
        let i = l(t),
          o = 0,
          u = n || !t.autoGenerated,
          d = i.startsWith("Start ") && !i.includes("RUN_JS_BUNDLE") && r.has(i.replace("Start ", "Finish "));
    ...
    }(_, c, t, n), I), f = "Trace #".concat(u + 1, " started ").concat((0, a.getTimestampString)(d), "\n").concat(T);
    return null != E && (f += "\n Server trace for trace #".concat(u + 1).concat(E)), f
  }).join("\n\n")
}

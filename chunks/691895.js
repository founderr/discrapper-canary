...
function o(e) {
  ...
  return a.default.logGroups.map(i => {
    var a, o;
    let {
      index: u,
      timestamp: d,
      ...
      nativeLogs: c,
      serverTrace: E
    } = i, I = 0 === u ? null !== (o = null === (a = r().find(_, e => e.log.indexOf("Logger loaded") >= 0)) || void 0 === a ? void 0 : a.timestamp) && void 0 !== o ? o : e : d, T = function(e, t) {
      var n, i;
      let a = (function(e) {
          let t = [];
    ...
    }(_, c, t, n), I), f = "Trace #".concat(u + 1, " started ").concat((0, s.getTimestampString)(d), "\n").concat(T);

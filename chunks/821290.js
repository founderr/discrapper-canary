...
function a(e, t, n, r, i) {
  ...
  return l(e, s, t, n, r, i)
}

function c(e, t, n, i, o) {
  let s = e;
  return t.years ? s = (0, r.startOfYear)(e) : t.months ? s = (0, r.startOfMonth)(e) : t.weeks && (s = (0, r.startOfWeek)(e, n)), l(e, s, t, n, i, o)
}
...
function p(e) {
  let t = (0, o.useMemo)(() => new r.DateFormatter(e.locale), [e.locale]),
    ...
    D = (0, o.useMemo)(() => e.focusedValue ? d((0, r.toCalendar)((0, r.toCalendarDate)(e.focusedValue), S), b, m) : void 0, [e.focusedValue, S, b, m]),
    C = (0, o.useMemo)(() => d(e.defaultFocusedValue ? (0, r.toCalendar)((0, r.toCalendarDate)(e.defaultFocusedValue), S) : _ || (0, r.toCalendar)((0, r.today)(M), S), b, m), [e.defaultFocusedValue, _, M, S, b, m]),
  ...
  function B(t) {
    !e.isDisabled && !e.isReadOnly && (t = f(t = d(t, b, m), A, x)) && (t = (0, r.toCalendar)(t, (null == k ? void 0 : k.calendar) || new r.GregorianCalendar), k && "hour" in k ? E(k.set(t)) : E(t))
  }
  s(P, b, m) ? T(d(P, b, m)) : 0 > P.compare(A) ? R(u(P, g, p, b, m)) : P.compare(j) > 0 && R(c(P, g, p, b, m));
  ...
  return {
    ...
    focusNextPage() {
      let e = A.add(V);
      T(d(P.add(V), b, m)), R(c(l(P, e, V, p, b, m), V, p))
    },
    focusPreviousPage() {
      let e = A.subtract(V);
      T(d(P.subtract(V), b, m)), R(c(l(P, e, V, p, b, m), V, p))
    },
    focusSectionStart() {
...
function v(e) {
  ...
  if (w && w.start && w.end) {
    let e = a((0, r.toCalendarDate)(w.start), h, l, v, y).add(h).subtract({
      days: 1
    });
  ...
  let j = e => {
    ...
    N = t => {
      if (!e.isReadOnly) {
        if (t = f(t = d(t, P, T), A.visibleRange.start, e.isDateUnavailable)) {
          if (k) {
            let e = g(k, t);
            S({

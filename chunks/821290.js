...
function f(e) {
  ...
  let _ = (0, i.useMemo)(() => !!k && (!!(x && x(k)) || o(k, g, y)), [k, x, g, y]),
    z = e.isInvalid || "invalid" === e.validationState || _,
...
function h(e) {
  ...
  let N = e => {
    ...
    z = (0, i.useMemo)(() => !!S && !D && (!!(_ && (_(S.start) || _(S.end))) || o(S.start, h, b) || o(S.end, h, b)), [_, S, D, h, b]),

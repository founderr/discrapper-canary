...
location: f,
reward: p
  } = e, N = o.useRef(null), [v, w] = o.useState(null), A = o.useRef(new s.qA()), S = (0, d.e7)([c.Z], () => c.Z.useReducedMotion), M = (0, m.j8)(C), y = (null === (a = C.userStatus) || void 0 === a ? void 0 : a.claimedAt) != null, [E, T] = o.useState(y ? 'claimed' : 'loading');
  o.useEffect(() => {
if (!y) {
  let e = _.r.build(C.config),
    a = e.rewardPlatforms.length > 0 ? e.rewardPlatforms[0] : g.y$.CROSS_PLATFORM;
  (0, h.QB)(C.id, a, f).then(() => T('claimed')).catch(() => T('error'));
}
  }, [
C,
f,
    ...
    children: (0, r.jsxs)('div', {
      ...
      children: [
        (0, r.jsx)(l.Heading, {
          ...
          color: 'always-white',
          className: b.heading,
          children: N.Z.Messages.QUESTS_REWARD_AVATAR_DECORATION_HEADER
        }),
        (0, r.jsx)(l.Text, {
          variant: 'text-sm/normal',
          color: 'always-white',
          className: b.text,
          children: N.Z.Messages.QUESTS_REWARD_MODAL_FOOTER_IN_GAME_BODY.format({
            rewardName: n
          })
        })
      ]

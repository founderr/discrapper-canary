...
function S(e) {
    var t, n;
    let { userId: r, guildId: S, location: Z, className: T, onNavigate: N } = e,
        j = l.useRef(null),
        A = (0, o.e7)([f.ZP], () => f.ZP.getGuildSidebarState(S), [S]),
        y = l.useRef(0),
        ...
        k = (0, o.e7)([g.ZP], () => g.ZP.getMember(S, r), [S, r]);
    l.useLayoutEffect(() => {
    ...
    let O = l.useCallback(
        ...
        U = null !== (n = null == P ? void 0 : P.offset) && void 0 !== n ? n : 0,
        B = (0, o.e7)(
            [d.Z],
            () => {

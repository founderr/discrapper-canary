...
function x(e) {
  ...
  let {
    ...
    className: M,
    onNavigate: R
  } = e, y = l.useRef(null), L = (0, o.useStateFromStores)([p.default], () => p.default.getGuildSidebarState(x), [x]), j = l.useRef(0), [O, P] = l.useState(null !== (t = null == L ? void 0 : L.details.additionalSearchQuery) && void 0 !== t ? t : {}), D = (0, S.useServerMessageHistoryForUser)(s, x, {
    addtionalQuery: O,
    shouldDispatch: !0
  ...
  let w = l.useCallback(e => {
      ...
      j.current = t, (0, g.openGuildMemberModViewSidebar)(x, s, L.baseChannelId, {

...
var r = n(581282), i = n(69122), a = n(36056), o = n(17146);
class s {
    constructor(e) {
        var t;
    ...
    write(e, t) {
        ...
        for (let r of this.fields) {
            ...
            let i = e[r.oneof];
            if (i.oneofKind !== r.localName)
                continue;
            let a = 'scalar' == r.kind || 'enum' == r.kind ? Object.assign(Object.assign({}, t), { emitDefaultValues: !0 }) : t, s = this.field(r, i[r.localName], a);
            (0, o.hu)(void 0 !== s), n[t.useProtoFieldName ? r.name : r.jsonName] = s;
        }
        return n;
    }
    field(e, t, n) {
    ...
    enum(e, t, n, r, i, a) {
        ...
        if (0 !== t || i || r)
            return ((0, o.hu)('number' == typeof t), (0, o.hu)(Number.isInteger(t)), a || !e[1].hasOwnProperty(t)) ? t : e[2] ? e[2] + e[1][t] : e[1][t];
    }
    message(e, t, n, r) {
    ...
    scalar(e, t, n, s, l) {
        ...
        case a.wx.DOUBLE:
            if (0 === t)
                return u ? 0 : void 0;
            if ((0, o.hu)('number' == typeof t), Number.isNaN(t))
                return 'NaN';
        ...
        case a.wx.SINT64:
            ...
            return d.toString();
        case a.wx.BYTES:
            if ((0, o.hu)(t instanceof Uint8Array), !t.byteLength)
                return u ? '' : void 0;
            return (0, r.m)(t);
        }
    }

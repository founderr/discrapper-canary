...
if (0 !== t || i || r)
  return ((0, s.hu)('number' == typeof t), (0, s.hu)(Number.isInteger(t)), a || !e[1].hasOwnProperty(t)) ? t : e[2] ? e[2] + e[1][t] : e[1][t];
  }
  message(e, t, n, r) {
...
switch (e) {
  ...
  case a.wx.DOUBLE:
    if (0 === t)
      return u ? 0 : void 0;
    if ((0, s.hu)('number' == typeof t), Number.isNaN(t))
      return 'NaN';
  ...
  case a.wx.SINT64:
    ...
    return d.toString();
  case a.wx.BYTES:
    if ((0, s.hu)(t instanceof Uint8Array), !t.byteLength)
      return u ? '' : void 0;
    return (0, r.m)(t);
}
  }

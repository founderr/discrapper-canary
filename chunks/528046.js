...
class s {
    ...
    enum(e, t, n, r, i, a) {
        ...
        if (0 !== t || i || r) return ((0, o.hu)('number' == typeof t), (0, o.hu)(Number.isInteger(t)), a || !e[1].hasOwnProperty(t)) ? t : e[2] ? e[2] + e[1][t] : e[1][t];
    }
    message(e, t, n, r) {
    ...
    scalar(e, t, n, s, l) {
        ...
        switch (e) {
            ...
            case a.wx.SINT64:
                ...
                return d.toString();
            case a.wx.BYTES:
                if (((0, o.hu)(t instanceof Uint8Array), !t.byteLength)) return u ? '' : void 0;
                return (0, r.m)(t);
        }
    }
}

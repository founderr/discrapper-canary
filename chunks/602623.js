...
var r, i = n(735250), a = n(470079), o = n(120356), s = n.n(o), l = n(512722), u = n.n(l), c = n(481060), d = n(484459), _ = n(103575), E = n(598077), f = n(594174), h = n(426563), p = n(806519), m = n(171553);
function I(e, t, n) {
...
class S extends (r = a.PureComponent) {
    renderUsers() {
        ...
        for (; u < s && u < e.length;) {
            var c;
            let t = null == l && null == a && u === e.length - 1, s = n(e[u], t, u);
            o.push(t ? (0, i.jsx)('div', {
                className: m.avatarContainer,
                children: s
            }, g(null !== (c = e[u]) && void 0 !== c ? c : null, u)) : (0, i.jsx)(p.ZP, {
    ...
    renderMoreUsers(e) {
        ...
        if (!r) {
            if (null != n) {
                if (n >= t)
                    return (0, i.jsx)(a.Fragment, { children: o(''.concat(t, '+'), t) }, 'more-users');
                if (n > s.length) {
                    let e = n - s.length;
    ...
    render() {
        let {
            ...
            } = this.props, {popoutUserId: l} = this.state, E = n.find(e => null != e && e.id === l), h = o && null == f.default.getUser(l);
        return (0, i.jsx)(c.Popout, {
            position: 'right',
            preload: null == E ? void 0 : () => (0, d.W)(E.id, E.getAvatarURL(r, 80), { guildId: r }),
    ...
    constructor(...e) {
        super(...e), I(this, 'state', { popoutUserId: null }), I(this, '_ref', a.createRef()), I(this, 'defaultRenderUser', (e, t, n) => {
            let {
                showUserPopout: r,
                guildId: a,
                size: o
            ...
            if (null == e) {
                if (!this.props.showDefaultAvatarsForNullUsers)
                    return (0, i.jsx)('div', { className: m.emptyUser });
                {
                    let e = (null != n ? n : 0) % h.Z.DEFAULT_AVATARS.length, t = h.Z.DEFAULT_AVATARS[e];
                    return (0, i.jsx)('img', {
                        src: t,
                        alt: '',
                        className: m.avatar

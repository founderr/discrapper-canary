...
var i = n(735250);
n(470079);
var a = n(913527), s = n.n(a), r = n(692547), l = n(481060), o = n(800530), c = n(689938), d = n(429576);
let u = e => s()().diff(s().unix(e), 'days');
function _(e) {
    var t, a, s, _, E;
    if (null == e.message.embeds || null == e.message.embeds[0].fields)
        return null;
    let I = e.message.embeds[0], m = null !== (s = null === (t = I.fields) || void 0 === t ? void 0 : t.find(e => e.rawName === o.Cg.CLASSIFICATION_ID)) && void 0 !== s ? s : void 0, T = null !== (_ = null == m ? void 0 : m.rawValue) && void 0 !== _ ? _ : void 0, h = null !== (E = null === (a = I.fields) || void 0 === a ? void 0 : a.find(e => e.rawName === o.Cg.INCIDENT_TIMESTAMP)) && void 0 !== E ? E : void 0, N = null == h || null == h.rawValue ? void 0 : parseFloat(h.rawValue);

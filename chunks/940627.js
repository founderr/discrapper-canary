...
class p extends o.PureComponent {
    ...
    render() {
        let {guild: e} = this.props, t = new Set(e.features);
        return t.has(E.oNc.INTERNAL_EMPLOYEE_ONLY) ? this.renderBadge(1, u.StaffBadgeIcon, h.staff) : t.has(E.oNc.VERIFIED) && t.has(E.oNc.HUB) ? this.renderBadge(4, u.HubIcon, h.verifiedHub) : t.has(E.oNc.HUB) ? this.renderBadge(5, u.HubIcon, h.hub) : t.has(E.oNc.VERIFIED) && t.has(E.oNc.PARTNERED) ? this.renderBadge(3, u.CheckmarkSmallIcon, h.verified) : t.has(E.oNc.VERIFIED) ? this.renderBadge(2, u.CheckmarkSmallIcon, h.verified) : t.has(E.oNc.PARTNERED) ? this.renderBadge(0, (0, u.makeIconCompat)(_.Z), h.partnered) : null;
    }
}
t.Z = p;

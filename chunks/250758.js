...
function A(e, t) {
  ...
  if (s === p.Sap.EMPTY || s === p.Sap.FILTER && l !== p.dCx.FILTER_FROM && l !== p.dCx.FILTER_MENTIONS) return;
  let r = 3;
...
function R(e, t, n) {
  ...
  if (h.Z.getSearchType(n) === p.aib.GUILD && (e === p.dCx.FILTER_FROM || e === p.dCx.FILTER_MENTIONS)) {
    ...
    var s;
    let l = null === (s = c.ZP[e]) || void 0 === s ? void 0 : s.getAutocompletions,
    ...
    return null != n && "" !== n && ((function(e) {
      ...
      if (null != n && "" !== n) {
        ...
        let e = null === (i = c.ZP[p.dCx.FILTER_BEFORE]) || void 0 === i ? void 0 : i.getAutocompletions(n, t, 1)[0],
          l = null === (a = c.ZP[p.dCx.FILTER_ON]) || void 0 === a ? void 0 : a.getAutocompletions(n, t, 1)[0],
          r = null === (s = c.ZP[p.dCx.FILTER_AFTER]) || void 0 === s ? void 0 : s.getAutocompletions(n, t, 1)[0];
        return null == e ? null : {
          group: p.rtL.DATES,
          results: [e, l, r]
        }

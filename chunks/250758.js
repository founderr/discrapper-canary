...
let p = {},
    g = {};
function S(e) {
    let { searchId: t, query: n, mode: i, tokens: s, cursorScope: a, autocompletes: r } = e,
        l = g[t];
    return (
        null == l &&
            ((l = {
...
function A(e, t) {
    ...
    let { type: a, filter: r } = s.mode;
    if (a === f.Sap.EMPTY || (a === f.Sap.FILTER && r !== f.dCx.FILTER_FROM && r !== f.dCx.FILTER_MENTIONS)) return;
    let l = 3;
    s.mode.type === f.Sap.FILTER && (l = 10),
...
function R(e, t, n) {
    ...
    if (N.Z.getSearchType(n) === f.aib.GUILD && (e === f.dCx.FILTER_FROM || e === f.dCx.FILTER_MENTIONS)) {
        let e = g[n];
        null == e
            ? (i = null)
            : ((null == t || 0 === t.getFullMatch().trim().length) &&
                  (e.results = _.ZP.getRecentlyTalked(n, 10).map((e) => {
                      let { record: t } = e;
                      return {
                          user: t,
...
function O(e) {
    let t = (null != e ? e.getFullMatch() : '').trim(),
        n = (function () {
            let e = (0, d.cn)() && !1;
            return {
                [f.dCx.FILTER_FROM]: !h.Z.hidePersonalInformation,
                [f.dCx.FILTER_MENTIONS]: !h.Z.hidePersonalInformation,
                [f.dCx.FILTER_HAS]: !0,
                [f.dCx.FILTER_BEFORE]: !0,
                [f.dCx.FILTER_AFTER]: !0,
                [f.dCx.FILTER_ON]: !0,
                [f.dCx.FILTER_IN]: N.Z.getSearchType() === f.aib.GUILD,
...
function x(e, t) {
    ...
    return (
        t.type === f.Sap.FILTER
            ? n.push(R(t.filter, t.token, e, 10))
            : t.type === f.Sap.FILTER_ALL
              ? (n = (function (e, t) {
                        ...
                        null != n &&
                            ...
                            ((function (e) {
                                let t = N.Z.getSearchType(e),
                                    n = [f.dCx.FILTER_HAS];
                                return !h.Z.hidePersonalInformation && (n.push(f.dCx.FILTER_FROM), n.push(f.dCx.FILTER_MENTIONS)), t === f.aib.GUILD && n.push(f.dCx.FILTER_IN), n;
                            })(t).forEach((n) => {
                                if (null == n) return;
                                let s = R(n, e, t, 3);
                                null != s && i.push(s);
...
function v(e) {
    let t = p[e];
    if (null == t) return;
    let { query: n, mode: i, tokens: s, cursorScope: a, autocompletes: r } = t;
    p[e] = S({
        searchId: e,
        query: n,
        mode: i,
...
function L() {
    ...
    let { query: t, mode: n, tokens: i, cursorScope: s } = p[e];
    p[e] = S({
        searchId: e,
        query: t,
        mode: n,
...
class Z extends (i = l.ZP.Store) {
    initialize() {
        this.waitFor(T.ZP, h.Z);
    }
    getState(e) {
        var t;
        return null !== (t = p[e]) && void 0 !== t ? t : S({ searchId: e });
    }
}
(r = 'SearchAutocompleteStore'),
...
let P = new Z(o.Z, {
    SEARCH_AUTOCOMPLETE_QUERY_UPDATE: function (e) {
        var t;
        let n,
            { searchId: i, tokens: s, cursorScope: a } = e,
            r = (0, I.cl)(s),
            l = (0, I.qc)(a, s),

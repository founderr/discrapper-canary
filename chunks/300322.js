...
function g(e, t) {
  let n = (0, s.useStateFromStores)([h.default], () => {
    let t = e.isForumLikeChannel() ? C.Permissions.SEND_MESSAGES : l.combine(C.Permissions.CREATE_PUBLIC_THREADS, C.Permissions.READ_MESSAGE_HISTORY);
...
function p(e, t) {
  let n = e.isForumLikeChannel() ? C.Permissions.SEND_MESSAGES : l.combine(C.Permissions.CREATE_PUBLIC_THREADS, C.Permissions.READ_MESSAGE_HISTORY),
    i = h.default.can(n, e);
  return I(i, e, t)
}

function S(e) {
  let t = (0, s.useStateFromStores)([h.default], () => h.default.can(l.combine(C.Permissions.CREATE_PRIVATE_THREADS), e), [e]);
...
function I(e, t, n) {
  return !(__OVERLAY__ || !e || !c.THREADED_CHANNEL_TYPES.has(t.type) || null != n && (n.hasFlag(C.MessageFlags.HAS_THREAD) || (0, a.default)(n))) && !0
}
...
function A(e) {
  return (0, s.useStateFromStoresObject)([m.default, h.default], () => {
    let t = m.default.getActiveJoinedThreadsForParent(e.guild_id, e.id),
      ...
      l = r(n).some(e => h.default.can(C.Permissions.VIEW_CHANNEL, e.channel)),
      s = r(t).some(e => !(e.channel.id in n) && h.default.can(C.Permissions.VIEW_CHANNEL, e.channel)),

...
let n = a(r(919565)), s = a(r(537978)), o = a(r(158965)), i = 'twhZNwxI1aFG3r4';
function c(e, ...t) {
    let r = '';
    for (let a = 0; a < e.length; a++)
        if (r += e[a], a < t.length) {
            ...
            if (o.default(e).value && (e = o.default(e).value, n = !0), e && e[i] || n) {
                let t = r.split('\n'), a = t[t.length - 1].search(/\S/), s = a > 0 ? ' '.repeat(a) : '';
...
c.pretty = e => s.default(e) ? { [i]: JSON.stringify(e, null, 2) } : e, t.default = c;

...
function H(e, t, n) {
  ...
  let R = (0, V.useLocalizedStringFormatter)((r = q) && r.__esModule ? r.default : r, "@react-aria/numberfield"),
    I = (0, N.useId)(o),
    {
      focusProps: O
    } = (0, z.useFocus)({
    ...
    H = (0, V.useNumberFormatter)({
      ...v,
      currencySign: void 0
    }),
    G = (0, F.useMemo)(() => isNaN(C) ? "" : H.format(C), [H, C]),
    {
      spinButtonProps: W,

...
var i = t(735250), a = t(470079), s = t(120356), l = t.n(s), o = t(512722), r = t.n(o), c = t(392711), d = t.n(c), u = t(399606), I = t(692547), m = t(481060), _ = t(447543), N = t(225433), E = t(129861), T = t(493544), h = t(700582), p = t(410030), g = t(933557), C = t(154285), f = t(666657), x = t(487419), O = t(664452), S = t(560114), A = t(699516), R = t(594174), b = t(373791), Z = t(285952), v = t(965638), M = t(302434), L = t(981631), j = t(689938), D = t(64215), P = t(735194), B = t(549856);
let y = {
    INVITER: 3,
    INVITE_CODE: 3,
    USES: 1,
...
function G(e) {
    ...
    return a.maxUses > 0 && (c = ''.concat(a.uses, '/').concat(a.maxUses)), (0, i.jsxs)(Z.Z, {
        className: l()(D.inviteSettingsInviteRow, P.card, { [D.inviteDisabledRow]: o }),
        children: [
            (0, i.jsx)(Z.Z, {
                grow: y.INVITER,
                basis: 0,
            ...
            (0, i.jsx)(Z.Z, {
                ...
                children: (0, i.jsx)(m.Text, {
                    ...
                    variant: 'text-sm/normal',
                    children: (0, i.jsx)(b.Z, { deadline: a.getExpiresAt() })
                })
            }),
            (0, i.jsx)(N.Z, {
...
function k(e) {
    ...
    let E = (0, v.MQ)(s), {enableInvitesDisabled: h} = (0, v.FR)(s), {showAlertMode: g} = (0, C.sw)(s.id), A = (0, u.e7)([x.Z], () => x.Z.getGuildIncident(s.id)), R = s.hasFeature(L.oNc.INVITES_DISABLED) || g && (null == A ? void 0 : A.invitesDisabledUntil) != null && new Date(A.invitesDisabledUntil) > new Date(), [b, P] = a.useState(!1);
    a.useEffect(() => {
    ...
    let k = (0, p.ZP)(), U = a.useMemo(() => null == n || _ ? [] : d()(n).sortBy(e => {
            var n, t;
            ...
            if (g) {
                let e = { source: f.Zu.GUILD_SETTINGS };
            ...
            return e = 0 !== U.length || _ ? (0, i.jsxs)(Z.Z, {
                children: [
                    (0, i.jsx)(Z.Z.Child, {
                        ...
                        children: (0, i.jsx)(m.FormTitle, { children: j.Z.Messages.INSTANT_INVITE_INVITER })
                    }),
                    (0, i.jsx)(Z.Z.Child, {
                        basis: 0,
                        grow: y.INVITE_CODE,
                        className: B.marginReset,
                        children: (0, i.jsx)(m.FormTitle, { children: j.Z.Messages.INSTANT_INVITE_INVITE_CODE })
                    }),
                    (0, i.jsx)(Z.Z.Child, {
                        grow: y.USES,
                        basis: 0,
                        className: D.textAlignRight,
                        children: (0, i.jsx)(m.FormTitle, { children: j.Z.Messages.INSTANT_INVITE_USES })
                    }),
                    (0, i.jsx)(Z.Z.Child, {
                        grow: y.EXPIRES,
                        basis: 0,
                        className: D.textAlignRight,
                        children: (0, i.jsx)(m.FormTitle, { children: j.Z.Messages.INSTANT_INVITE_EXPIRES })
                    })
                ]
                ...
                children: (0, i.jsxs)(m.HeadingLevel, {
                    ...
                    children: [
                        (0, i.jsx)(m.FormText, {
                            ...
                            children: N ? j.Z.Messages.SETTINGS_INVITE_TIP.format({ onCreateInvite: H }) : j.Z.Messages.SETTINGS_INVITE_TIP_WITHOUT_CREATE
                        }),
                        (h || g || R) && (0, i.jsxs)('div', {
                        ...
                        (0, i.jsx)(m.FormDivider, { className: D.headerDivider }),
                        e
                    ]
                })
            }, 'header');

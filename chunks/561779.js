...
var r, i, a, o = n(735250), s = n(470079), l = n(120356), u = n.n(l), c = n(392711), d = n.n(c), _ = n(374470), E = n(84735), f = n(981729), h = n(607070), p = n(236822);
function m(e, t, n) {
...
function T(e) {
    return {
        ...
        ...function (e) {
            ...
            let l = I(n, o = t.sort((e, t) => e - t)), u = o[0], c = o[o.length - 1], d = c - u;
            if (a) {
...
class g extends (i = s.PureComponent) {
    ...
    render() {
        ...
        m ? null != a && (null != l ? G = a[l] : null != s && (G = a[s])) : G = this.scaleValue(t);
        let k = ''.concat(G, '%'), B = null != a && null != i ? a.map((e, t) => {
                let n = i[t], r = null != v && v === n, a = this.renderMark(n);
                return (0, o.jsx)('div', {
                    className: u()(p.mark, {
                        [p.defaultValue]: r,
                        [p.markAbove]: 0 === M,
                    ...
                    style: { left: ''.concat(e, '%') },
                    children: null != C ? C(n) : (0, o.jsxs)(o.Fragment, {
                        children: [
                            (0, o.jsx)('div', {
                                className: p.markValue,
                                children: a
                            }),
                            (0, o.jsx)('div', { className: p['markDash'.concat(null == a ? 'simple' : '')] })
                        ]
                    })
                }, t);
            }) : null, F = null != R ? R(t) : ''.concat(G.toFixed(0), '%'), V = null !== (e = null == y ? void 0 : y(t)) && void 0 !== e ? e : void 0;
        return (0, o.jsx)(E.t, {
    ...
    moveStaggered(e) {
        ...
        let {
                ...
                markerPositions: a,
                sortedMarkers: o
            } = this.state, {asValueChanges: s} = this.props;
        if (null == n)
            return;
        let {
            left: l,
        ...
        if (e.clientX <= l || e.clientX >= u)
            return;
        let c = e.clientX - r, d = a[i] + c / (u - l) * 100;
        null != (t = this.props.equidistant ? I(d, a) : I(this.unscaleValue(d), o)) && (null == s || s(o[t])), this.setState({ newClosestIndex: t });
    }
    constructor(e) {
        super(e), m(this, 'containerRef', s.createRef()), m(this, 'grabberRef', s.createRef()), m(this, 'moveGrabber', e => {
            let {
                    sortedMarkers: t,
                    value: n,
                    min: r,
            ...
            if (s) {
                let {nextClosestMarkerIndex: e} = u.reduce((e, t, n) => {
                ...
                t = i + (r - i) * h, this.setState({ value: t }), this.handleMouseDown(e);
            ...
            let {
                    onValueChange: t,
                    stickToMarkers: n
                } = this.props, {newClosestIndex: r} = this.state;
            n && null != r ? (null == t || t(this.state.sortedMarkers[r]), this.setState({
                newClosestIndex: null,
                closestMarkerIndex: r
            })) : null == t || t(this.state.value), this.setState({ active: !1 });
            ...
            let {
                    ...
                    maxValue: n,
                    asValueChanges: r
                } = this.props, {boundingRect: i} = this.state;
            if (null == i)
                return;
            let {
                    left: a,
                    right: o
                } = i, s = n - t, l = Math.min(Math.max(t + (e.clientX - a) / (o - a) * s, t), n);

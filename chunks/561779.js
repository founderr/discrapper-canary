...
class A extends(r = a.PureComponent) {
    ...
    let B = "".concat(x, "%"),
      k = null != s && null != r ? s.map((e, t) => {
        ...
        return (0, o.jsx)("div", {
          ...
          children: null != v ? v(n) : (0, o.jsxs)(o.Fragment, {
  ...
  moveStaggered(e) {
    ...
    let _ = e.clientX - i,
      c = s[r] + _ / (u - l) * 100;
    null != (t = this.props.equidistant ? S(c, s) : S(this.unscaleValue(c), o)) && (null == a || a(o[t])), this.setState({
      newClosestIndex: t
    })
  }
  constructor(e) {
    super(e), f(this, "containerRef", a.createRef()), f(this, "grabberRef", a.createRef()), f(this, "moveGrabber", e => {
      let {
        sortedMarkers: t,
        value: n,
        min: i,
    ...
    }), f(this, "handleContainerMouseDown", e => {
      let t;
      let {
        disabled: n,
        maxValue: i,
      ...
      let {
        left: E,
        width: I
      } = c.getBoundingClientRect(), T = (_ - E) / I;
      if (a) {
        let {

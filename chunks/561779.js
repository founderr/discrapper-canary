...
let c = e.clientX - r,
  d = a[i] + c / (u - l) * 100;
null != (t = this.props.equidistant ? m(d, a) : m(this.unscaleValue(d), s)) && (null == o || o(s[t])), this.setState({
  newClosestIndex: t
});
  }
  constructor(e) {
super(e), I(this, 'containerRef', o.createRef()), I(this, 'grabberRef', o.createRef()), I(this, 'moveGrabber', e => {
  let {
    sortedMarkers: t,
    value: n,
    min: r,

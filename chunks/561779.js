    ...
    constructor(e) {
        super(e),
            ...
            I(this, 'handleContainerMouseDown', (e) => {
                ...
                if (!(0, _.k)(d)) return;
                let { left: f, width: p } = d.getBoundingClientRect(),
                    h = (c - f) / p;
                if (o) {

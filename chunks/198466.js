...
var r, i, a = n(735250), o = n(470079), s = n(920906), l = n(442837), u = n(481060), c = n(607070), d = n(745510), _ = n(887704);
function E(e) {
    let {
            children: t,
            ...
            tooltipProps: d
        } = e, [E, f] = o.useState(0), h = o.useRef(-1), p = o.useRef(!0), m = (0, l.e7)([c.Z], () => c.Z.useReducedMotion), {scaleFactor: I} = (0, s.useSpring)({
            from: { scaleFactor: 1 },
    ...
    return (o.useEffect(() => () => {
        p.current = !1;
    }, []), m) ? (0, a.jsx)(a.Fragment, { children: t }) : (0, a.jsx)(s.animated.div, {
...
t.Z = function (e) {
    ...
    return o.useEffect(() => () => {
        ...
        if (!r || s || null == n.current)
            return;
        let e = n.current.getBoundingClientRect(), i = e.left + e.width / 2;

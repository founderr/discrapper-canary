...
function C(e) {
  let {
    ...
    let t = [N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_EMOJI_SLOTS.format({
      numEmojiSlots: I.BoostedGuildFeatures[e].limits.emoji
    }), N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_STICKER_SLOTS.format({
      numStickerSlots: I.BoostedGuildFeatures[e].limits.stickers
    }), N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_SOUNDBOARD_SLOTS.format({
      numSoundboardSlots: I.BoostedGuildFeatures[e].limits.soundboardSounds
    }), N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_STREAM_QUALITY.format({
      resolution: I.BoostedGuildFeatures[e].limits.screenShareQualityResolution,
      framerate: I.BoostedGuildFeatures[e].limits.screenShareQualityFramerate
    }), N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_AUDIO_QUALITY.format({
      bitrate: I.BoostedGuildFeatures[e].limits.bitrate / 1e3
    }), N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_UPLOAD_SIZE_LIMIT.format({
      filesize: I.BoostedGuildFeatures[e].limits.fileSize / 1024 / 1024
    }), N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_VIDEO_STAGE_SEATS.format({
      numVideoStageSeats: I.BoostedGuildFeatures[e].limits.stageVideoUsers
    }), N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_ANIMATED_GUILD_ICON, N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_GUILD_INVITE_BACKGROUND];
    e >= h.BoostedGuildTiers.TIER_2 && (t.push(N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_GUILD_BANNER), t.push(N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_CUSTOM_ROLE_ICONS)), e >= h.BoostedGuildTiers.TIER_3 && t.push(N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_VANITY_URL);
    let s = t[Math.floor(Math.random() * t.length)];
    return N.default.Messages.GUILD_BOOSTING_USER_SETTINGS_PERK_TEMPLATE.format({
      perk: s
    })
...
function A(e) {
  ...
  } = e, f = (0, i.useStateFromStores)([o.default], () => o.default.useReducedMotion), g = n.useMemo(() => null != s.cooldownEndsAt ? new Date(s.cooldownEndsAt) : null, [s]), h = n.useMemo(() => null != g && g > new Date, [g]), I = (0, T.isGuildBoostSlotCanceled)(s);
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)(_.default, {
        ...
        children: null != g && h && !I ? (0, a.jsx)(m.default, {
          className: p.boostDescriptionInnerContainer,
          cooldown: g.getTime()
        }) : (0, a.jsx)(C, {
          guildTier: t,

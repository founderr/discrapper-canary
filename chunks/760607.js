...
class i {
    ...
    union(e) {
        let t = Math.min(this.x, e.x), n = Math.min(this.y, e.y), r = Math.max(this.maxX, e.maxX) - t, a = Math.max(this.maxY, e.maxY) - n;
        return new i(t, n, r, a);
    }
    intersection(e) {
...
let a = 'undefined' != typeof window ? window.performance : null, o = a && (a.now || a.webkitNow || a.msNow || a.mozNow);
o && o.bind(a);

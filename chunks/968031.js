...
var o = s(735250), a = s(470079), t = s(442837), i = s(481060), _ = s(100527), r = s(906732), T = s(197115), p = s(594174), E = s(626135), n = s(74538), M = s(300284), f = s(981631), d = s(474936), c = s(526761), S = s(689938), U = s(481466);
function L(e) {
    let {
            ...
            title: h,
            description: u
        } = e, I = (0, t.e7)([p.default], () => p.default.getCurrentUser()), {analyticsLocations: R} = (0, r.ZP)(l, _.Z.PROFILE_THEME_UPSELL_MODAL);
    a.useEffect(() => {

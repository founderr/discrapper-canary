...
function h(e, t) {
    ...
    let v = {
        ...
        }, b = T ? v.burst : v.standard, E = Math.max(0, (null !== (n = T ? null == f ? void 0 : f.burst_count : null == f ? void 0 : f.count) && void 0 !== n ? n : 0) - _.length), I = (0, o.Lh)(t);
    if (1 === _.length)
        return E > 0 ? null != h ? b.reactionTooltip1NInteractive.format({
            a: _[0],
            n: E,
            emojiName: I,
            onClick: h
    ...
    if (2 === _.length)
        return E > 0 ? null != h ? b.reactionTooltip2NInteractive.format({
            a: _[0],
            b: _[1],
            n: E,
            emojiName: I,
    ...
    if (3 === _.length)
        return E > 0 ? null != h ? b.reactionTooltip3NInteractive.format({
            a: _[0],
            b: _[1],
            c: _[2],
            n: E,
        ...
        return null != h ? b.reactionTooltipNInteractive.format({
            n: E,
            emojiName: I,
            onClick: h

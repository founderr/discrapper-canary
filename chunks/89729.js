...
function h(e, t) {
  ...
  let i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u.O.NORMAL,
    ...
    f = e.getReaction(t),
    T = i === u.O.BURST,
    _ = s()(m).reject(e => r.Z.isBlocked(e.id)).take(3).map(e => c.ZP.getName(g, null == p ? void 0 : p.id, e)).value();
  ...
  let v = {
    ...
    I = (0, o.Lh)(t);
  if (1 === _.length) return E > 0 ? null != h ? b.reactionTooltip1NInteractive.format({
    a: _[0],
    n: E,
    emojiName: I,
    onClick: h
  ...
  if (2 === _.length) return E > 0 ? null != h ? b.reactionTooltip2NInteractive.format({
    a: _[0],
    b: _[1],
    n: E,
    emojiName: I,
  ...
  if (3 === _.length) return E > 0 ? null != h ? b.reactionTooltip3NInteractive.format({
    a: _[0],
    b: _[1],
    c: _[2],
    n: E,
  ...
  else return null != h ? b.reactionTooltipNInteractive.format({
    n: E,
    emojiName: I,
    onClick: h

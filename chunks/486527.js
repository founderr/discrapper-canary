...
function D(_) {
    return '883060064561299456' === _
        ? [
              {
                  value: 1,
                  label: O.Z.Messages.DIRECTORY_CATEGORY_INTERNAL_1
              },
              {
                  value: 2,
                  label: O.Z.Messages.DIRECTORY_CATEGORY_INTERNAL_2
              },
              {
                  value: 3,
                  label: O.Z.Messages.DIRECTORY_CATEGORY_INTERNAL_3
              },
              {
                  value: 5,
                  label: O.Z.Messages.DIRECTORY_CATEGORY_INTERNAL_5
              }
          ]
        : [
              {
              ...
              {
                  value: 2,
                  label: O.Z.Messages.DIRECTORY_CATEGORY_CLASS
              },
              {
                  value: 3,
        ...
        HUB_STUDY: {
            ...
            channels: [
                ...
                },
                {
                    id: '22',
                    parent_id: '20',
                    name: O.Z.Messages.GUILD_TEMPLATE_NAME_VOICE_STUDY_ROOM.format({ number: 1 }),
                    type: G.d4z.GUILD_VOICE
                },
                {
                    id: '23',
                    parent_id: '20',
                    name: O.Z.Messages.GUILD_TEMPLATE_NAME_VOICE_STUDY_ROOM.format({ number: 2 }),
                    type: G.d4z.GUILD_VOICE
                }
            ],
            system_channel_id: '12'
        ...
        HUB_SOCIAL: {
            ...
            channels: [
                ...
                },
                {
                    id: '13',
                    parent_id: '10',
                    name: O.Z.Messages.GUILD_TEMPLATE_NAME_VOICE_UNNUMBERED_STUDY_ROOM,
                    type: G.d4z.GUILD_VOICE
                }
            ],

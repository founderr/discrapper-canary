...
var i = l(475179), n = l(166459), s = l(966390), a = l(531643), o = l(476326), r = l(367907), d = l(358221), u = l(117530), c = l(594174), _ = l(626135), m = l(403182), f = l(74538), h = l(979956), g = l(981631), E = l(959517), A = l(474936), p = l(689938);
function M(e, t) {
    let l = c.default.getCurrentUser(), i = e.getGuildId(), n = m.dg(i), s = [], o = 0, d = 0, u = 0, _ = [];
    for (let e of t)
...
function x(e, t, l) {
    ...
    if (u.Z.getUploadCount(t.id, l) + e.length > g.dN1) {
        (0, a.openUploadError)({
            ...
            help: p.Z.Messages.ATTACHMENT_TOO_MANY_ERROR_MESSAGE.format({ limit: g.dN1 })

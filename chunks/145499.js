n(47120), n(653041);
var s = n(735250), a = n(470079), i = n(120356), r = n.n(i), l = n(442837), o = n(481060), c = n(274136), d = n(2052), u = n(906732), _ = n(678558), I = n(852679), E = n(889161), T = n(626135), m = n(267642), N = n(268350), S = n(926491), h = n(386937), g = n(316350), C = n(863562), x = n(981631), p = n(689938), R = n(88725);
let f = (e, t) => e < (0, m.A3)(x.Eu4.NONE) ? x.Eu4.NONE : e < (0, m.A3)(x.Eu4.TIER_1) ? x.Eu4.TIER_1 : e < (0, m.A3)(x.Eu4.TIER_2) ? x.Eu4.TIER_2 : e < (0, m.A3)(x.Eu4.TIER_3) || null != t && t.hasFeature(x.oNc.MORE_STICKERS) && e < c.D.MAX_STICKER_SLOTS ? x.Eu4.TIER_3 : x.Eu4.NONE, L = e => {
        let {
                children: t,
                currentGuildTier: n,
                guildStickers: a,
        ...
        let {guild: t} = e, {location: n} = (0, d.O)(), {canCreateExpressions: a} = (0, E.XJ)(t);
...
t.Z = e => {
    let {guild: t} = e, [i, c] = a.useState(!0), d = (0, l.e7)([S.Z], () => {
            var e;
            return null !== (e = S.Z.getStickersByGuildId(t.id)) && void 0 !== e ? e : [];
        }, [t]), {analyticsLocations: T} = (0, u.ZP)(), O = t.hasFeature(x.oNc.MORE_STICKERS) ? x.Eu4.TIER_3 : t.premiumTier, D = t.hasFeature(x.oNc.MORE_STICKERS) ? (0, m.vn)(t.id)[x.Eu4.TIER_3] : t.premiumSubscriberCount;
    if (a.useEffect(() => {
            let e = !1;
            return (async () => {
    ...
    return (0, s.jsx)(h.Z, {
        ...
        renderTier: e => {
            let a, {
                ...
                } = (0, E.Gw)(t), S = u[I - 1], h = null != S ? (0, m.A3)(S.tier) : 0, L = (0, m.A3)(c.tier, t), j = (0, m.ig)(c.tier), Z = d.slice(h, L), b = Z.length > 0, U = O < c.tier, G = f(d.length, t), P = T && !U && G === c.tier && L !== Z.length, B = P || Z.length > 0, y = L - h, F = n(872732), w = j - Z.length, k = P ? Math.min(5 - (Z.length + 0) % 5, w) : 0, H = [];
            for (let e = 0; e < k; e++)
                H.push((0, s.jsx)(A, {}, 'placeholder-'.concat(e)));
            let V = G === I + 1 && G > O, Y = P || V || I > O;
            ...
            }) : P && (a = (0, s.jsx)(M, { guild: t })), (0, s.jsxs)(g.Z, {
                subscriptionCount: D,
                tier: c,
                onSetRef: l,
                isAnimatedTo: i,
                    ...
                    U && !b && (0, s.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, s.jsx)(o.Text, {
                                ...
                                variant: 'text-md/normal',
                                color: 'header-secondary',
                                children: c.tier === x.Eu4.TIER_1 ? p.Z.Messages.GUILD_STICKER_SETTINGS_ADDITIONAL_SLOTS_WITHOUT_TOTAL.format({ numAdditional: y }) : p.Z.Messages.GUILD_STICKER_SETTINGS_ADDITIONAL_SLOTS.format({
                                    numAdditional: y,
                                    numTotal: L
                                })
                            }),

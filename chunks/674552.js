...
var i = n(735250);
n(470079);
var l = n(120356), r = n.n(l), a = n(481060), s = n(44315), o = n(246364), c = n(460562), u = n(510601), d = n(981631), h = n(810817);
function p(e, t) {
...
function f(e) {
    let t, {
            ...
            activity: c,
            gaming: d
        } = e, h = (0, u.vg)('Guild Icon', !1);
    if (!o && !s && !c && !l && !i && d && u.ZP.trackExposure({ location: 'Guild Icon' }), o)
        t = a.CalendarIcon;
    else if (s)
        t = a.StageIcon;
    else if (c)
...
function g(e) {
    let {
        ...
        } = e, o = null == n ? { disableColor: !0 } : { color: (0, s.Lq)(n) };
    return (0, i.jsx)(a.IconBadge, {
        icon: t,

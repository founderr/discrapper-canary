...
let j = e => {
    ...
    let {
        ...
        }), H = (0, d.e7)([p.Z], () => p.Z.useReducedMotion), z = (0, T.m)('CollectiblesCollectedModal'), [V] = o.items, {avatarDecorationSrc: W} = (0, E.Z)({
            user: U,
            avatarDecorationOverride: (null == V ? void 0 : V.type) === c.Z.AVATAR_DECORATION ? V : null,
            size: (0, C.y9)(u.AvatarSizes.SIZE_120)
        }), G = a.useRef(null), {analyticsLocations: K} = (0, v.ZP)([
            ...D,
            g.Z.COLLECTIBLES_COLLECTED_MODAL
        ]), Y = (0, b.Z)({ analyticsLocations: K }), Q = a.useCallback(() => {

...
var a = n(5192),
  r = n(561308),
  l = n(689938);
let u = (t, e) => l.Z.Messages.ACTIVITY_REACTION_IMAGE_ALT_TEXT_PLAYING.format({
username: e.username,
...
return ((0, r.kr)(e) ? l.Z.Messages.CONTENT_INVENTORY_REACTION_USER_PLAYING : l.Z.Messages.CONTENT_INVENTORY_REACTION_USER_PLAYED).plainFormat({

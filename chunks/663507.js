...
let i = e => '__section__'.concat(e), a = e => '__section_header__'.concat(e), o = e => parseInt(e.replace(/^__section__/, ''), 10), s = () => 0;
class l {
    getPadding() {
    ...
    computeFullCoords() {
        ...
        let E = this.getPaddingHorizontal(), f = this.getPaddingVertical(), h = null !== (e = this.marginLeft) && void 0 !== e ? e : 0;
        ...
        for (; p < this.sections.length;) {
            ...
            let e = this.sections[p], c = 0, d = u(p), f = this.getMaxColumnHeight(this.columnHeights);
            ...
            for (; c < e;) {
                ...
                let a = s(p, c, this.columnWidth), u = {
                        position: 'absolute',
    ...
    computeVisibleSections(e, t) {
        ...
        for (; a < this.sections.length;) {
            let o = this.sections[a], s = i(a), l = r[s];
            if (null == l) {
                a++;
                continue;
            }
            let {top: u} = l, c = u + l.height;
            if (u > t)
                break;
            if (c < e) {
                a++;

...
var i = t(735250);
t(470079);
var a = t(442837), l = t(481060), r = t(58642), d = t(283595), s = t(417363), u = t(626135), c = t(630388), I = t(981631), o = t(689938);
function A(n, e) {
        ...
        action: function () {
            null != n && null != e && (n.isHidden() || !A ? _() : (0, l.openModal)(n => (0, i.jsx)(l.ConfirmModal, {
                ...
                children: (0, i.jsx)(l.Text, {
                    ...
                    children: o.Z.Messages.APPLICATION_LIBRARY_REMOVE_CONFIRM_BODY.format({ name: e.name })
                })
            })));
        }
    });

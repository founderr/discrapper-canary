...
function I(e, t) {
  ...
  function A() {
    let t = (0, o.toggleFlag)(e.getFlags(), c.LibraryApplicationFlags.HIDDEN);
    u.updateFlags(e.id, e.branchId, t), s.default.track(c.AnalyticEvents.APPLICATION_SETTINGS_UPDATED, {
      hidden_enabled: (0, o.hasFlag)(t, c.LibraryApplicationFlags.HIDDEN),
      ...e.getAnalyticsData()
    })
  }

...
function m(e) {
  ...
  n.useEffect(() => {
    (0, _.trackViewedEvent)(S.AnalyticEvents.SAFETY_WARNING_MODAL_VIEWED, {
      channelId: h,
      warningId: M,
      senderId: g,
              ...
              children: [(0, s.jsxs)("div", {
                ...
                onClick: y ? () => {
                  d.default.updateChannelOverrideSettings(null, h, {
                    muted: !1
                  }, N.NotificationLabels.Unmuted), (0, r.showToast)((0, r.createToast)(f.default.Messages.STRANGER_DANGER_UNMUTE_CONFIRM, r.ToastType.SUCCESS)), (0, _.trackCtaEvent)({
                    channelId: h,
                    warningId: M,
                    senderId: g,
                    warningType: R.SafetyWarningTypes.STRANGER_DANGER,
                    cta: _.CtaEventTypes.USER_MODAL_UNMUTE
                  })
                } : () => {
                  d.default.updateChannelOverrideSettings(null, h, {
                    muted: !0
                  }, N.NotificationLabels.Muted), (0, r.showToast)((0, r.createToast)(f.default.Messages.STRANGER_DANGER_MUTE_CONFIRM, r.ToastType.SUCCESS)), (0, _.trackCtaEvent)({
                    channelId: h,
                    warningId: M,
                    senderId: g,
                    warningType: R.SafetyWarningTypes.STRANGER_DANGER,
                    cta: _.CtaEventTypes.USER_MODAL_MUTE
                  })
                },

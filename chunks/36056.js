...
function l(e) {
  var t, n, r, i;
  return e.localName = null !== (t = e.localName) && void 0 !== t ? t : (0, c.c)(e.name), e.jsonName = null !== (n = e.jsonName) && void 0 !== n ? n : (0, c.c)(e.name), e.repeat = null !== (r = e.repeat) && void 0 !== r ? r : u.NO, e.opt = null !== (i = e.opt) && void 0 !== i ? i : !e.repeat && !e.oneof && "message" == e.kind, e

var e = function () {
    ...
    t.prototype = {
        ...
        repaint: function () {
            ...
            var t = this.canvas_.width, e = this.canvas_.height, r = this.canvas_.getContext('2d');
            if (r.fillStyle = this.backgroundColor, r.fillRect(0, 0, t, e), !(4 * this.fontSize > e) && !(t < 50)) {
                ...
                var i = this.startTime_ + n * this.scale_, a = e;
    ...
    var e = function () {
        ...
        return t.prototype = {
            ...
            layoutLabelsBasic_: function (t, e, r) {
                ...
                var i = 2 * this.fontHeight_ + 4, a = 1 + this.height_ / i;
                a < 2 ? a = 2 : a > 6 && (a = 6);

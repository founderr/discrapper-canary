...
function I(e) {
  let {
    smallerText: t
  } = e, s = (0, i.useStateFromStores)([d.default], () => d.default.affinities.slice(0, 3).reverse()), n = s.map((e, t) => (0, a.jsx)(T, {
    affinity: e,
    applyMask: t !== s.length - 1
  }, e.id)), l = e => null != e.globalName ? e.globalName : e.username, o = r.useMemo(() => 3 === s.length ? _.default.Messages.AFFINITIES_MARKETING_HEADER_3.format({
    username: l(s[2])

...
function T(e) {
  ...
  let S = null != a ? a : null === (i = d.getVoiceStateForSession(r, null == s ? void 0 : s.session_id)) || void 0 === i ? void 0 : i.channelId;
  if (null == S) return 4;
  ...
  if (!f.isPrivate()) {
    ...
    let t = d.getCurrentClientVoiceChannelId(f.getGuildId()) === S,
      n = (0, c.rY)(f, d, h),

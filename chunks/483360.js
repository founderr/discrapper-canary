...
t.ZP = {
  ...
  queryChannels(e) {
    ...
    return f.sort(l.Z), null != r && f.length > r && (f.length = r), f
  },
  queryGuilds(e) {
    let {
      query: t,
  ...
  queryMentionResults(e) {
    ...
    if (h < d && l) {
      ...
      null != t && (a()(v.Z.getRoles(t.id)).filter(t => {
        ...
        return (n || i || _) && (s()(f, r.toLowerCase()) || I && f === o) && o !== V.default.castGuildIdAsEveryoneGuildRoleId(e)
      }).take(d - h).forEach(e => {
        S.push(e)
      }), h += S.length)
    }

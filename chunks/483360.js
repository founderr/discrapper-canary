...
t.ZP = {
    ...
    queryChannels(e) {
        ...
        for (let e of t) {
            var m, T, g, A, O;
            if (((m = l), (T = e.type), (g = null != r), !(m === T || ((g || (0, N.Km)(T)) && (m === v.sH ? (0, N.r8)(T) || (0, N.bw)(T) : m === v.Zb && (0, N.bw)(T)))) || ((0, N.Km)(e.type) && !D.Z.can(_ ? e.accessPermissions : Y.Plq.VIEW_CHANNEL, e)) || !s(e))) continue;
            let t = [...h],

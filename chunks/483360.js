...
if (r.test(e))
  return 5;
if (l = i, u = e, l.split(/(?:,| )+/).every(e => RegExp(F.Z.escape(e), 'i').test(u)))
  return 3;
if (o && a()(i, e))
  return 1;
  } catch (e) {
...
filter: i,
allowSnowflake: s
  } = e, o = w.default.getUsers(), l = U.Z.getGuildId(), c = t.toLocaleLowerCase(), d = (0, H.Fv)(c), _ = [], E = [], f = n.length, h = 0, p = 0;
  for (; h < f;) {
var I, m, T, g, S, A, N, O, R;
let e, r;
let u = n[h];
u instanceof v.Z ? (r = u, e = null === (m = C.ZP.getNick(l, r.id)) || void 0 === m ? void 0 : m.toLocaleLowerCase()) : (e = null === (T = u.nick) || void 0 === T ? void 0 : T.toLocaleLowerCase(), r = o[u.userId]);
...
if (null == i || i(r)) {
  ...
  }) : o.substring(0, d.length) === d || (null == u ? void 0 : u.substring(0, d.length)) === d || (null == I ? void 0 : I.substring(0, d.length)) === d ? _.push({
    type: j.h8.USER,
    record: r,
    score: 1,
    comparator: null !== (A = null != f ? f : e) && void 0 !== A ? A : n,
    sortable: null !== (N = null != h ? h : l) && void 0 !== N ? N : i
  }) : p < 50 && (a()(c, i) || a()(d, o) || null != l && a()(c, l) || null != u && a()(d, u) || null != h && a()(c, h) || null != I && a()(d, I)) && (E.push({
    type: j.h8.USER,
    record: r,
    score: 1,
...
function eo(e, t) {
  ...
  return null == e || null == n ? [] : o()(D.Z.getMessages(e).toArray()).reverse().uniqBy(e => e.author.id).map(e => w.default.getUser(e.author.id)).filter(e => {
...
return ea({
  query: t,
  members: M.Z.getFriendIDs().map(e => w.default.getUser(e)).filter(G.lm),
  limit: n,
  filter: i
});
  },
...
return ea({
  query: t,
  members: O.Z.getDMUserIds().map(e => w.default.getUser(e)).filter(G.lm),
  limit: n,
  filter: r
});
  },
...
return i && n.length > 0 && k.Z.requestMembers(t, n, r), ea({
  query: n,
  members: l,
  limit: r,
  filter: s,
...
return n && e.length > 0 && k.Z.requestMembers(null, e, t), ea({
  query: e,
...
t = null != r ? o()(R.ZP.getChannels(r)[l]).map(e => e.channel).concat(S.Z.computeAllActiveJoinedThreads(r)).value() : o()(O.Z.loadAllGuildAndPrivateChannelsFromDisk()).values().concat(S.Z.computeAllActiveJoinedThreads()).value();
let p = {},
  I = [];
for (let e of t) {
  var m, T, g, A, v;
  if (m = l, T = e.type, g = null != r, !(m === T || (g || (0, N.Km)(T)) && (m === R.sH ? (0, N.r8)(T) || (0, N.bw)(T) : m === R.Zb && (0, N.bw)(T))) || (0, N.Km)(e.type) && !L.Z.can(_ ? e.accessPermissions : Y.Plq.VIEW_CHANNEL, e) || !s(e))
    continue;
  let t = [...h],
  ...
  if (0 !== u) {
    ...
    if (0 === u || t.length > 1 || 1 === t.length && !t[0].isFullMatch && !o)
      continue;
    if (A = l, v = e.type, A === R.sH && (0, N.bw)(v))
      u = Math.max(u - 1, 0.5);
    I.push({
...
return I.sort(u.Z), null != i && I.length > i && (I.length = i), I;
  },
  queryGuilds(e) {
let {
  query: t,
...
let {
  ...
  filter: i = q,
  boosters: a = {}
} = e, s = (0, H._I)((0, H.Fv)(t.toLocaleLowerCase())), l = {
  exactQuery: RegExp('^'.concat(F.Z.escape(s)), 'i'),
  containQuery: RegExp(F.Z.escape(s), 'i'),
  queryLower: s
}, d = o()(O.Z.getMutablePrivateChannels()).values().value(), _ = [];
for (let e of d) {
...
let {
  ...
  containQuery: RegExp(F.Z.escape(a), 'i'),
  queryLower: a
}, l = o()(x.Z.getSKUs()).values().value(), c = [];
for (let e of l)
...
}) : [], p = h.length, I = t.toLowerCase(), m = [];
if (p < _ && l) {
  let e = n.getGuildId(),
    t = y.Z.getGuild(e);
  null != t && (o()(y.Z.getRoles(t.id)).filter(t => {
    let {
      mentionable: n,
      name: i,
      id: s
    } = t;
    return (n || r || c) && (a()(I, i.toLowerCase()) || f && I === s) && s !== V.default.castGuildIdAsEveryoneGuildRoleId(e);
  }).take(_ - p).forEach(e => {
    m.push(e);
  }), p += m.length);
}
let T = [];
return !n.isPrivate() && r && l && (p < _ && a()(I, $().test) && (T.push($()), p += 1), i && p < _ && a()(I, J().test) && T.push(J())), {
  users: h,
  globals: T,
  roles: m
};
...
})) : [], c = u.length, _ = t.toLowerCase(), E = [];
if (c < Y.rnv && s) {
  let e = y.Z.getGuild(n);
  null != e && (o()(y.Z.getRoles(e.id)).filter(e => {
    let {
      mentionable: t,
      name: i,
      id: s
  ...
  }).take(Y.rnv - c).forEach(e => {
    E.push(e);
  }), c += E.length);
}
let f = [];
return r && s && (c < Y.rnv && a()(_, $().test) && (f.push($()), c += 1), c < Y.rnv && a()(_, J().test) && f.push(J())), {
  users: u,
  globals: f,
  roles: E
};
...
let {
  ...
  limit: r = 10,
  fuzzy: i = !0
} = e, a = t.toLocaleLowerCase(), s = RegExp('^'.concat(F.Z.escape(a)), 'i'), l = RegExp(F.Z.escape(a), 'i'), u = o()(n).map((e, t) => {
  let n = er(e.displayName.toLocaleLowerCase(), {
    exactQuery: s,
    containQuery: l,
    queryLower: a
  }, i);
...
}).filter(G.lm).sortBy(e => -1 * e.score);
...
let {
  ...
  queryLower: r
}, a = (0, p.s)(n.id) && !n.hasFeature(Y.oNc.HUB), s = n.hasFeature(Y.oNc.COMMUNITY), o = (0, h.t)(n) && n.hasFeature(Y.oNc.COMMUNITY), l = [{
...
for (let e of l) {
  if ((e.id !== W.HY.SERVER_GUIDE || !!a) && (e.id !== W.HY.CHANNEL_BROWSER || !!s) && (e.id !== W.HY.CUSTOMIZE_COMMUNITY || !!o))
    er(e.name.toLocaleLowerCase(), i, !1) > 0 && u.push(new N.nl({
      id: e.id,
      name: e.name,
      type: Y.d4z.UNKNOWN,
      guild_id: n.id
...
return s = s.filter(e => {
  ...
  return 'null' !== t.id;
}).sort(_.Z), null != i && s.length > i && (s = s.slice(0, i)), {
...
for (let {
  ...
  of Object.values(null != n ? y.Z.getRoles(n.id) : {}))

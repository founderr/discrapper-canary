...
function c(n) {
    ...
    (0, r.openModalLazy)(
        async () => {
            let { default: n } = await Promise.all([e.e('63288'), e.e('77298'), e.e('23357'), e.e('12013'), e.e('52249'), e.e('68956'), e.e('26182'), e.e('95900'), e.e('32776'), e.e('82622')]).then(e.bind(e, 409600));
            return (e) => {
                let { onClose: i, ...r } = e;
                return (0, l.jsx)(n, {
                    ...r,

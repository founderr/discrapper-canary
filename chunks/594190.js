...
var i, a, o, s, l = n(392711), u = n.n(l), c = n(913527), d = n.n(c), _ = n(442837), E = n(433517), f = n(570140), h = n(593472), p = n(726542), m = n(439849), I = n(710845), T = n(630699), g = n(855403), S = n(454991), A = n(77498), N = n(283595), v = n(417363), O = n(626135), R = n(70956), C = n(877481), y = n(823379), D = n(358085), L = n(998502), b = n(145597), M = n(370862), P = n(981631), U = n(987650);
let w = new I.Z('RunningGameStore'), x = 'RunningGameStore', G = [
        {
            executables: [
                {
                    os: 'win32',
    ...
    ], k = [], B = !0, F = new Set(), V = [], H = [], Z = [], Y = null, j = [], W = {}, K = {}, z = {
        gamesSeen: [],
        gameOverrides: {},
        enableOverlay: {},
        enableDetection: {}
    }, q = function () {
    }, Q = {}, X = 0, $ = null, J = null, ee = {}, et = new Set(), en = new Set(), er = null, ei = null;
function ea(e, t, n) {
    let r = e[t];
...
function el() {
    ...
    let e = [];
    for (let t of Z)
        !(t.pid in ee) && (ee[t.pid] = t, e.push(t));
    let t = [];
    for (let e of Object.values(ee))
        !Z.some(t => t.pid === e.pid) && (t.push(e), delete ee[e.pid]);
    w.info('games', {
        runningGames: Z,
        added: e,
        removed: t,
...
function ec(e) {
    ...
    let n = T.H() && (0, b.VS)() && !S.v.legacyEnabled, r = n ? U.gl.OutOfProcess : U.gl.Hook, i = z.enableOverlay[eu(e)];
    if (null != i)
        return {
...
function eh() {
    let e = !1;
    return V = u().values(N.Z.libraryApplications).reduce((t, n) => {
    ...
    if (null != e && 0 !== e.length)
        e.forEach(e => {
            if (z.gamesSeen.some(t => {
                ...
                if (e.hidden)
                    return;
                z.gamesSeen.unshift(function (e) {
                    let t = {
                        exePath: e.exePath,
                        cmdLine: e.cmdLine,
...
!__OVERLAY__ && (0, D.isDesktop)() && (q = function () {
    let e = [], t = new Set();
    r = {};
    let n = A.Z.games;
    for (let e of n) {
    ...
    [
        ...
        e = e.filter(e => (e.distributor = function (e) {
            ...
            return '0' === t ? null : t;
        }(e.pid, e.windowHandle), null == G.find(t => {
            let {name: n} = t;
            return n === e.name;
        }) || (n.push(e), !1)));
...
class eT extends (i = _.ZP.Store) {
    initialize() {
        var e, t, n, r;
        let i = null !== (e = E.K.get(x)) && void 0 !== e ? e : {
            gamesSeen: [],
            gameOverrides: {},
            enableOverlay: {},
            enableDetection: {}
        ...
        if (u().values(null !== (t = i.gameOverrides) && void 0 !== t ? t : {}).forEach(e => {
                let t = eu(e);
                z.gameOverrides[t] = e;
            }), z.enableOverlay = null !== (n = i.enableOverlay) && void 0 !== n ? n : {}, z.enableDetection = null !== (r = i.enableDetection) && void 0 !== r ? r : {}, ep(), Array.isArray(i.gamesSeen))
            for (let e of i.gamesSeen)
                'number' == typeof e.id && (e.nativeProcessObserverId = e.id, delete e.id, a = !0);
        em(i.gamesSeen), this.waitFor(A.Z), this.syncWith([
            N.Z,
            A.Z,
            v.Z
        ], u().throttle(eh, 1000)), a && eE();
    }
    getVisibleGame() {
    ...
    getRunningDiscordApplicationIds() {
        let e = [];
        for (let t of Z)
            null != W[t.exePath] && e.push(W[t.exePath]);
        return e;
    }
    getRunningVerifiedApplicationIds() {
        return this.getRunningGames().map(e => A.Z.getGameByName(e.name)).filter(y.lm).map(e => e.id);
    }
    getGameForPID(e) {
        var t;
    ...
    getGamesSeen(e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = eI();
        if (e) {
    ...
    getGameOverlayStatus(e) {
        if (e.hidden || e.isLauncher || e.elevated || e.sandboxed)
            return w.verbose('getGameOverlayStatus: Overlay not supported.', e), null;
        let t = ec(e);
...
s = 'RunningGameStore', (o = 'displayName') in (a = eT) ? Object.defineProperty(a, o, {
    ...
    RUNNING_GAME_ADD_OVERRIDE: function (e) {
        let t;
        let n = e.pid, r = Z.find(e => e.pid === n);
        if (null == r) {
            ...
            t = eu(r), r.hidden && (K[t] = !0), r.hidden = !1;
        (null == r.lastFocused || 0 === r.lastFocused) && (r.lastFocused = Math.floor(Date.now() / 1000)), z.gameOverrides[t] = {
            ...r,
            add: !0
        }, em(Z), ep(), eE(), el();
    },
    RUNNING_GAME_TOGGLE_OVERLAY: function (e) {
        if (z.enableOverlay[eu(e.game)] = e.newEnabledValue, eE(), !__OVERLAY__) {
            ...
            null != t && O.default.track(P.rMx.OVERLAY_TOGGLED, {
    ...
    RUNNING_GAME_EDIT_NAME: function (e) {
        let t = eu(e.game), n = z.gameOverrides[t];
        if (null == n) {
            var r;
            (n = {
                name: (r = e.game).name,
        ...
        n.name = e.newName;
        let i = eu(n);
        delete z.gameOverrides[t], z.gameOverrides[i] = n, ea(z.enableOverlay, t, i), ea(z.enableDetection, t, i), ea(K, t, i), z.gamesSeen.forEach(n => {
    ...
    RUNNING_GAME_DELETE_ENTRY: function (e) {
        let t = eu(e.game);
        delete z.gameOverrides[t], delete z.enableOverlay[t], delete z.enableDetection[t], z.gamesSeen = z.gamesSeen.filter(e => eu(e) !== t), K[t] && (Z.forEach(e => {
            t === eu(e) && (e.hidden = !0);
        }), delete K[t], el()), ep(), eE();
    },
    ...
    GAME_DETECTION_DEBUGGING_TICK: function (e) {
        let t = e.processes.map(e => {
            ...
            if (et.has(e.pid) || en.has(e.cleanedExePath))
                return !1;
            let t = k.some(t => e.cleanedExePath.includes(t));
            return t && et.add(e.pid), t;
        }).map(e => e.cleanedExePath);
        t.length > 0 && O.default.track(P.rMx.GAME_DETECTION_DEBUGGING_KEYWORD_MATCH, {
            keywords: k,
            paths: t,
            debugging_level: er,
            interval_seconds: ei

...
t.default = function(e) {
  ...
  let {
  ...
  }, [g]), U = null != I ? (0, u.getNumIncludedAndTenureRewardPremiumGuildSubscriptionSlots)(I, L) : 0, y = Math.max(0, U - D.length), B = j > U, F = U === g.length, G = F ? y : 1, k = n.useMemo(() => {
    let e = [];
    ...
    return e
  }, [G, M]), w = null != L, H = n.useMemo(() => P.find(e => e.isAvailable()), [P]);

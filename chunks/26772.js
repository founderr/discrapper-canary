...
class E extends d.default {
  ...
  handleHandoff(e) {
    ...
    null != n ? s.HTTP.post({
      ...
      (0, i.handoffSetUser)(t.user), r.default.loginToken(t.token, !1), f(!0, o)
    }, e => {
      if (null != a && f(!1, o), r.default.setFingerprint(a), (0, i.handoffEnd)(), o === l.LoginHandoffSource.ROLE_SUBSCRIPTION) {
        var t;
    ...
    }) : null != a ? (r.default.setFingerprint(a), f(!1, o), (0, i.handoffEnd)()) : (r.default.setFingerprint(a), (0, i.handoffUnavailable)())
  }
  constructor(...e) {

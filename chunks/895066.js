...
var r = n(392711), i = n.n(r), a = n(46973), o = n(379649), s = n(140828), l = n(179654);
function u(e, t, n) {
...
class c {
    ...
    constructor(e) {
        u(this, 'connection', void 0), u(this, 'inboundStats', void 0), u(this, 'outboundStats', void 0), u(this, 'networkQuality', void 0), u(this, 'systemResources', void 0), u(this, 'duration', void 0), u(this, 'decryptionFailures', void 0), u(this, 'routingFailures', void 0), u(this, 'periodicInboundStats', void 0), u(this, 'sampleStats', void 0), this.connection = e, this.sampleStats = e => {
            ...
            let t = this.outboundStats.packetsSent, n = i().reduce(this.inboundStats, (e, t) => (e.packetsReceived += t.packetsReceived, e), { packetsReceived: 0 });
            i().forEach(e.rtp.outbound, e => {
                ...
                i().forEach(t, t => {
                    if ('audio' === t.type) {
                        var r, a, o, s, l, u, c, d, _, E, f, h, p, m, I, T, g;
                        let S = null !== (r = e.transport.ping) && void 0 !== r ? r : 0, A = t.packetsReceived, N = t.packetsLost, v = t.bytesReceived, O = null !== (a = t.fecPacketsReceived) && void 0 !== a ? a : 0, R = null !== (o = t.fecPacketsDiscarded) && void 0 !== o ? o : 0, C = null !== (s = t.jitterBuffer) && void 0 !== s ? s : 0, y = {
                        ...
                        if (null != this.inboundStats[n]) {
                            let e = A - this.inboundStats[n].packetsReceived, r = N - this.inboundStats[n].packetsLost, a = 0, o = this.inboundStats[n].mosBuckets;
                            e > 0 && r >= 0 && (a = this.calculateMos(S + C, i().clamp(r / (e + r), 0, 1)), o[Math.floor(a)]++), this.inboundStats[n] = {
                                packetsReceived: A,
                                bytesReceived: v,
                                packetsLost: N,

...
class O extends r.PureComponent {
  ...
  componentDidUpdate(e) {
    ...
    if (t && !e.authenticated && s(_.Routes.APP), e.errors !== this.props.errors) {
      var a, r, n;
  ...
  renderDefaultForm() {
    ...
    let {
      ...
      children: [(0, a.jsx)(C.Title, {
        ...
        children: N.default.Messages.MULTI_ACCOUNT_LOGIN_TITLE
      }, "title"), (0, a.jsx)(i.Text, {
        color: "header-secondary",
        variant: "text-md/normal",
        className: M.subtitle,
        children: N.default.Messages.MULTI_ACCOUNT_LOGIN_SUBTITLE
      })]
    });
    return (0, a.jsxs)("div", {
      ...
      children: [n, (0, a.jsxs)(C.Block, {
        ...
        children: [(0, a.jsx)(g.default, {
          ...
          label: N.default.Messages.FORM_LABEL_EMAIL_OR_PHONE_NUMBER,
          ...
          label: N.default.Messages.FORM_LABEL_PASSWORD,
          ...
          children: N.default.Messages.FORGOT_PASSWORD
        })]
      })]
    })
  }
    ...
    return (0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)(C.default, {
        ...
        children: [(0, a.jsx)(i.Button, {
          ...
          "aria-label": "continue",
          submitting: t === _.LoginStates.LOGGING_IN,
          color: i.Button.Colors.BRAND,
          onClick: this.handleLogin,
          className: M.continueButton,
          children: N.default.Messages.CONTINUE
        })]
      })]
    })
  }
  ...
  renderDisabledAccount() {
    let {
      authBoxClassName: e,
      theme: t
    } = this.props, s = this.props.loginStatus === _.LoginStates.ACCOUNT_DISABLED, r = s ? N.default.Messages.ACCOUNT_DISABLED_TITLE : N.default.Messages.ACCOUNT_SCHEDULED_FOR_DELETION_TITLE, n = s ? N.default.Messages.ACCOUNT_DISABLED_DESCRIPTION : N.default.Messages.ACCOUNT_SCHEDULED_FOR_DELETION_DESCRIPTION;
    return (0, a.jsxs)(C.default, {
      ...
      children: [(0, a.jsx)(C.Title, {
        ...
        children: [(0, a.jsx)(i.Button, {
          ...
          type: "submit",
          fullWidth: !0,
          children: N.default.Messages._RETURN_TO_LOGIN
        }), (0, a.jsx)("div", {
          className: o(R.marginTop8, M.needAccount),
          children: N.default.Messages.ACCOUNT_SCHEDULED_FOR_DELETION_CANCEL.format({
    ...
    return (0, a.jsx)(C.default, {
      ...
      children: (0, a.jsx)("div", {
        ...
        children: (0, a.jsx)(h.default, {
          title: N.default.Messages.PASSWORD_RECOVERY_VERIFY_PHONE_TITLE,
          subtitle: N.default.Messages.PASSWORD_RECOVERY_VERIFY_PHONE_SUBTITLE_RESEND.format({
  ...
  render() {
    ...
    switch (e) {
      case _.LoginStates.LOGGING_IN_MFA_SMS:
      case _.LoginStates.MFA_SMS_STEP:
      case _.LoginStates.LOGGING_IN_MFA:
      case _.LoginStates.MFA_STEP:
        return this.renderMFA();
      case _.LoginStates.ACCOUNT_SCHEDULED_FOR_DELETION:
      case _.LoginStates.ACCOUNT_DISABLED:
        return this.renderDisabledAccount();
      case _.LoginStates.PASSWORD_RECOVERY_PHONE_VERIFICATION:
        return this.renderPhonePasswordRecovery();
      case _.LoginStates.LOGGING_IN:
      case _.LoginStates.NONE:
      default:
  ...
  constructor(e) {
    super(e), this.handleAuthToken = async e => {
      ...
      try {
        A.ComponentDispatch.dispatch(_.ComponentActions.WAVE_EMPHASIZE), await d.default.forgotPassword(s), (0, i.openModal)(e => (0, a.jsx)(i.ConfirmModal, {
          header: N.default.Messages.EMAIL_VERIFICATION_INSTRUCTIONS_HEADER,
          confirmText: N.default.Messages.OKAY,
          confirmButtonColor: i.Button.Colors.BRAND,
          ...e,
          children: (0, a.jsx)(i.Text, {
            variant: "text-md/normal",
            children: N.default.Messages.EMAIL_VERIFICATION_INSTRUCTIONS_BODY.format({
              email: s
            })
          })
        }))

            ...
            let e = (function (e) {
                ...
                return (
                    ...
                    (function (e, t, n, r, i, a, s, o, l, u, c, d, f, _, p, h) {
                        ...
                        R[y] += L;
                        let x = ((m = R), (g = o), (E = u), (v = t), (b = i), (I = a), null != m.top ? Math.max(0, g.height + g.top + g.scroll.top - (E.top + m.top) - (b.top + b.bottom + I)) : Math.max(0, v.top + E.top - (g.top + g.scroll.top) - (b.top + b.bottom + I)));
                                                      ...
                                                      (t.style.transform = ''),
                                                          ep &&
                                                              (ep.height < window.innerHeight
                                                                  ...
                                                                  : ep.addEventListener('resize', () => eb(t), { once: !0 }));
                                                  }));
                                          },
                                          !0
                                      )
...
function eT(e) {
    ...
    return B.createElement(eS.Provider, { value: a }, t);
}
function ey(e) {
    let t;
    let { modalProviderProps: n } = { modalProviderProps: { 'aria-hidden': (!!(t = (0, B.useContext)(eS)) && t.modalCount > 0) || null } };
...
function eA(e) {
    return B.createElement(eT, null, B.createElement(ey, e));
}
function eN(e) {
    let t = (0, Y.Av)(),

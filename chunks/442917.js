...
class el extends i.PureComponent {
    get viewProperties() {
        let { participantOnScreen: e, currentUserId: t, channel: n } = this.props,
            r = (0, ei._5)(e),
            i = null != e && e.type !== ei.fO.ACTIVITY && e.user.id === t;
        return {
            canPopout: r && !i,
            canSettings: r && i,
            canStopStream: r,
    ...
    render() {
        let { channel: e, streamId: t, participantOnScreen: n, isVideoEnabled: i, width: a } = this.props,
            o = (0, N.F6)(e, H.default, V.Z),
            l = this.isEmptyBroadcast(),
            u = (null == n ? void 0 : n.id) === B.default.getId() && i,
            c = this.renderStreamState(),
            d = null;
        return (
            (null == n ? void 0 : n.type) !== ei.fO.ACTIVITY &&
                (null != c
                    ? (d = c)
                    : ((null == n ? void 0 : n.type) === ei.fO.USER || (null == n ? void 0 : n.type) === ei.fO.STREAM) &&
                      (d = (0, r.jsx)(Q.Z, {
        ...
        super(...e),
            ...
            eo(this, 'handleStartStream', () => {
                let { canGoLive: e, channel: t } = this.props,
                    n = t.getGuildId();
                if ((l()(null != n, 'Cannot go live in non guild channel'), !e)) return (0, et.Z)();
            ...
            eo(this, 'renderViewersIcon', () => {
                ...
                return (
                    l()((0, ei._5)(e) || (null == e ? void 0 : e.type) === ei.fO.ACTIVITY, 'Cannot render participants for participant type '.concat(null == e ? void 0 : e.type)),
                    (0, r.jsx)(M.Z, {
...
t.Z = d.ZP.connectStores([F.Z, g.Z, B.default, Z.Z, Y.Z, k.Z, j.Z], (e) => {
    let { channel: t } = e,
        n = Z.Z.getSpeaker(t.id),
        r = g.Z.getParticipant(t.id, n),
        i = c()(F.Z.getVideoDevices()).values().first(),
        a = null == i || i.disabled,

...
var r = n(470079), i = n(230012), a = n(867330);
...
let l = !!('undefined' != typeof window && window.document && window.document.createElement), u = new Map();
function c(e) {
...
function V() {
    let e = (0, r.useRef)(new Map()), t = (0, r.useCallback)((t, n, r, i) => {
...
function Y(e, t) {
    let n = (0, r.useRef)(!0), i = (0, r.useRef)(null);
...
function J(e, t) {
    let n = ee(e, t, 'left'), r = ee(e, t, 'top'), i = t.offsetWidth, a = t.offsetHeight, o = e.scrollLeft, s = e.scrollTop, {
            borderTopWidth: l,
            borderLeftWidth: u
        } = getComputedStyle(e), c = e.scrollLeft + parseInt(u, 10), d = e.scrollTop + parseInt(l, 10), _ = c + e.clientWidth, E = d + e.clientHeight;
    n <= o ? o = n - parseInt(u, 10) : n + i > _ && (o += n + i - _), r <= d ? s = r - parseInt(l, 10) : r + a > E && (s += r + a - E), e.scrollLeft = o, e.scrollTop = s;
}
function ee(e, t, n) {
    let r = 'left' === n ? 'offsetLeft' : 'offsetTop', i = 0;

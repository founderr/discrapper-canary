...
var r = n(230367), i = n(36056), a = n(929412), o = n(436759);
class s {
    constructor(e) {
        this.info = e;
    }
    ...
    read(e, t, n, a) {
        ...
        for (; e.pos < o;) {
            ...
            if (!s) {
                ...
                if ('throw' == i)
                    throw Error(`Unknown field ${ a } (wire type ${ o }) for ${ this.info.typeName }`);
                let s = e.skip(o);
                !1 !== i && (!0 === i ? r.z.onRead : i)(this.info.typeName, t, a, o, s);
                continue;
            }
            let l = t, u = s.repeat, c = s.localName;
            switch (s.oneof && (l = l[s.oneof]).oneofKind !== c && (l = t[s.oneof] = { oneofKind: c }), s.kind) {
            case 'scalar':
            case 'enum':
                let d = 'enum' == s.kind ? i.wx.INT32 : s.T, _ = 'scalar' == s.kind ? s.L : void 0;
                if (u) {
                    let t = l[c];
            ...
            case 'message':
                if (u) {
                    let t = l[c], r = s.T().internalBinaryRead(e, e.uint32(), n);
                    t.push(r);
                } else
                    l[c] = s.T().internalBinaryRead(e, e.uint32(), n, l[c]);
                break;
            case 'map':

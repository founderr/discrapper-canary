...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(91192), l = n(442837), u = n(846519), c = n(692547), d = n(481060), _ = n(596454), E = n(607070), f = n(745510), h = n(594174), p = n(208049), m = n(763296), I = n(697426), T = n(242291), g = n(706667), S = n(286654), A = n(675654), N = n(689938), v = n(260240);
function O(e) {
    let {
        disabled: t = !1,
        onClick: n,
    ...
    return (0, r.jsx)(d.Tooltip, {
        ...
        children: e => (0, r.jsx)(d.Clickable, {
            ...e,
            'aria-label': i,
            className: o()(v.secondaryButton, { [v.buttonDisabled]: t }),
            onClick: n,
            children: a
        })
    });
...
t.ZP = i.forwardRef(function (e, t) {
    ...
    let {
            ...
            previewSound: z,
            isPlayingSound: q
        } = (0, g.Z)(y, null !== (n = null == D ? void 0 : D.id) && void 0 !== n ? n : null), {createMultipleConfettiAt: Q} = i.useContext(f.h), X = i.useRef(null);
    let $ = (a = y.soundId, C = X.current, i.useMemo(() => {
            ...
            C,
            a
        ])), J = (0, l.e7)([E.Z], () => E.Z.useReducedMotion), ee = i.useRef(0.01), et = i.useRef(new u.Xp()), en = '1' === y.soundId, er = (0, l.e7)([m.Z], () => m.Z.isFavoriteSound(V), [V]), ei = 'sound-'.concat(y.soundId), ea = (0, s.JA)(ei), eo = null != Z || null != Y, es = !(0, T.Nq)(j, y, D), el = M || U && !es;
    function eu(e) {
    ...
    let ed = R({
            ...
            children: [
                (0, r.jsx)('div', { className: o()({ [v.buttonOverlayBackground]: !w }) }),
                (0, r.jsxs)('div', {
    ...
    return i.useEffect(() => {
        ...
        children: [
            (0, r.jsxs)(d.ClickableContainer, {
                ...
                onClick: function () {
                    if (en && !J && (ee.current = Math.min(ee.current + 0.01, 0.1), Math.random() < ee.current && Q($.x, $.y, void 0, void 0, { sprite: A.vv })), null != G) {
                        G();
                        return;
                    }
                    w || K(k);
                    ...
                    (0, r.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, r.jsx)(d.Text, {
                                ...
                                className: o()(v.soundName, { [v.hasEmoji]: eo }),
                                children: H
                            })
                        ]
                    }),

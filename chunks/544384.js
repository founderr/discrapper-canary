...
disable: !(F && k && (!V || B)),
autoTrackExposure: !0
  }).enabled, Z = i.useCallback(() => {
var e, t, n;
(null === (n = p.Z.getGoLiveSource()) || void 0 === n ? void 0 : null === (t = n.desktopSource) || void 0 === t ? void 0 : null === (e = t.id) || void 0 === e ? void 0 : e.startsWith('prepicked:')) ? p.Z.getMediaEngine().eachConnection(e => {
    ...
    (0, r.jsx)(s.MenuGroup, {
      children: w.map(e => {
        ...
        return (0, r.jsx)(s.MenuItem, {
          id: t.ownerId,
          label: N.Z.Messages.STOP_WATCHING_USER.format({
            username: n
          }),
          icon: s.ScreenXIcon,
          action: () => (0, E.Z)(t)

...
function S(e) {
	var t;
	let { channel: n, currentUser: a, activeStreams: l, hideSelfOptions: _ = !1, showReportOption: f = !1, handleGoLive: h, onClose: S, onSelect: A, appContext: N = I.IlC.APP } = e,
		...
		D = i.useCallback(() => {
			var e, t, n;
			(null === (n = E.Z.getGoLiveSource()) || void 0 === n ? void 0 : null === (t = n.desktopSource) || void 0 === t ? void 0 : null === (e = t.id) || void 0 === e ? void 0 : e.startsWith('prepicked:'))

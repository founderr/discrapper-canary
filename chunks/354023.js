...
let S = (e, t) => null != e && r.default.isMember(e, t),
  o = e => {
    ...
    if (null != u)
      for (let e of u) {
        ...
        !(null == u || S(s, u.id)) && (a.add(u.id), I.push({
          type: "FRIEND",
          item: u,
          isSuggested: !0
        }), l.numFriends++)
  ...
  A = e => {
    ...
    f.default.queryDMUsers({
      ...
      let I = l.default.getDMFromUserId(t.id);
      if (null == I) return;
      let r = i.default.lastMessageId(I);
...
function R(e) {
  ...
  if ("" === t) {
    ...
    u === N.InviteTargetTypes.EMBEDDED_APPLICATION && c({
      ...e,
      inviteTargetType: u
    }), A({
      ...e,

...
function h() {
  ...
  let h = (0, o.X)(c.Z.getInputDevices()[t]),
    _ = (0, o.X)(c.Z.getOutputDevices()[s]);
  ...
  if ((t === u.w5 && o.Z.lastInputSystemDevice.justChanged || s === u.w5 && o.Z.lastOutputSystemDevice.justChanged) && !I) return;
  let m = l().first(Object.keys(o.Z.lastDeviceConnected)),
    g = null != m && "" !== m ? o.Z.lastDeviceConnected[m] : null;
  null != g && (o.Z.initialized && null != m && (r.Z.isCertified(o.Z.inputDevices[m]) ? e = r.Z.getCertifiedDevice(o.Z.inputDevices[m]) : r.Z.isCertified(o.Z.outputDevices[m]) && (e = r.Z.getCertifiedDevice(o.Z.outputDevices[m]))), E = !0, (0, a.openModalLazy)(async () => {
    let {
      default: t

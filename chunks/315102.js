...
function p(e) {
  ...
  let _ = null != c ? c : u && G(r) ? "gif" : "jpg";
  u && F(r) && (_ = "mp4");
  let f = window.GLOBAL_ENV.CDN_HOST;
  if (null != f ? ("jpg" === _ && (_ = g ? "webp" : "png"), t = "".concat(location.protocol, "//").concat(f, "/").concat(i, "/").concat(s, "/").concat(r, ".").concat(_)) : t = location.protocol + window.GLOBAL_ENV.API_ENDPOINT + n(s, r, _), "mp4" === _) return t;
  let E = {};
...
function v(e) {
  let {
    ...
    discriminator: s,
    bot: r
  } = e, a = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : _.AVATAR_SIZE, l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
  if (r && t !== f.CLYDE_AI_USER_ID) {
...
function A(e) {
  let t, {
      ...
      avatar: s,
      canAnimate: r = !1,
      size: o = _.AVATAR_SIZE
    } = e,
    u = r && G(s) ? "gif" : "jpg",
    {
      CDN_HOST: d
    } = window.GLOBAL_ENV;
  return null != d ? ("jpg" === u && (u = g ? "webp" : "png"), t = "".concat(location.protocol, "//").concat(d).concat(_.Endpoints.GUILD_MEMBER_AVATAR(n, i, s, u))) : t = location.protocol + window.GLOBAL_ENV.API_ENDPOINT + _.Endpoints.GUILD_MEMBER_AVATAR(n, i, s, u), t + "?".concat(a.stringify({
...
function y(e) {
  ...
  let a = window.GLOBAL_ENV.CDN_HOST,
    o = s && G(i) ? "gif" : "png";
  return t = (null != a ? "".concat(location.protocol, "//").concat(a, "/banners/").concat(n, "/").concat(i, ".").concat(o) : location.protocol + window.GLOBAL_ENV.API_ENDPOINT + _.Endpoints.USER_BANNER(n, i, o)) + "?size=".concat((0, l.getBestMediaProxySize)(r * (0, l.getDevicePixelRatio)()))
}
...
function N(e) {
  ...
  let {
    CDN_HOST: s,
    API_ENDPOINT: r
  } = window.GLOBAL_ENV, a = _.Endpoints.AVATAR_DECORATION_PRESETS(t.asset), u = new URL(null != s ? "".concat(location.protocol, "//").concat(s).concat(a) : "".concat(location.protocol).concat(r).concat(a));
...
function R(e) {
  ...
  let o = window.GLOBAL_ENV.CDN_HOST,
    u = r && G(s) ? "gif" : "png",
    d = _.Endpoints.GUILD_MEMBER_BANNER(i, n, s, u);
...
function O(e) {
  ...
  return t = (null != r ? "".concat(location.protocol, "//").concat(r, "/splashes/").concat(n, "/").concat(i, ".jpg") : location.protocol + window.GLOBAL_ENV.API_ENDPOINT + _.Endpoints.GUILD_SPLASH(n, i)) + "?size=".concat(s)
}
...
function D(e) {
  ...
  return t = (null != u ? "".concat(location.protocol, "//").concat(u, "/banners/").concat(n, "/").concat(i, ".").concat(o) : location.protocol + window.GLOBAL_ENV.API_ENDPOINT + _.Endpoints.GUILD_BANNER(n, i, o)) + "?size=".concat(r), "jpg" === o && (t += "&quality=lossless"), t
}
...
function P(e) {
  ...
  return t = (null != r ? "".concat(location.protocol, "//").concat(r, "/home-headers/").concat(n, "/").concat(i, ".png") : location.protocol + window.GLOBAL_ENV.API_ENDPOINT + _.Endpoints.GUILD_HOME_HEADER(n, i)) + "?size=".concat(s)
}
...
function L(e) {
  ...
  null == s && (s = window.screen.width * (0, l.getDevicePixelRatio)()), s = (0, l.getBestMediaProxySize)(s);
  let r = window.GLOBAL_ENV.CDN_HOST;
  return t = (null != r ? "".concat(location.protocol, "//").concat(r, "/discovery-splashes/").concat(n, "/").concat(i, ".jpg") : location.protocol + window.GLOBAL_ENV.API_ENDPOINT + _.Endpoints.GUILD_DISCOVERY_SPLASH(n, i)) + "?size=".concat(s)
}
...
function k(e) {
  ...
  return p({
    endpoint: (e, s, r) => _.Endpoints.VIDEO_FILTER_ASSET_STORAGE(t, n, i, r),

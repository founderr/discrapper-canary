s(47120);
var i, n = s(735250), a = s(470079), o = s(120356), l = s.n(o), r = s(772848), h = s(846519), d = s(481060), u = s(981631), c = s(689938), m = s(641324), g = s(483085), p = s(549856);
function E(e, t, s) {
...
class _ extends (i = a.PureComponent) {
    ...
    render() {
        ...
        return e = t && null != s ? c.Z.Messages.VERIFY_EMAIL_BODY_RESENT.format({ email: s }) : i ? c.Z.Messages.VERIFY_EMAIL_BODY : c.Z.Messages.ENTER_EMAIL_BODY, (0, n.jsxs)(d.ModalRoot, {
            transitionState: a,

...
function m(e) {
    return [
            ...
            posts: [
                {
                    ...
                    messageCount: 8,
                    reactionCount: 0,
                    activeAgo: t.Z.Messages.THREAD_BROWSER_TIMESTAMP_MINUTES.format({ count: 10 }),
                    attachment: n
                },
                {
                    user: {
                    ...
                    tagId: 1,
                    title: t.Z.Messages.FORUM_UPSELL_DEMO_1_POST_TITLE_2,
                    messageCount: 17,
                    reactionCount: 11,
                    activeAgo: t.Z.Messages.THREAD_BROWSER_TIMESTAMP_MINUTES.format({ count: 24 })
                },
                {
                    user: {
                        name: 'ladydaisy',
                    ...
                    messageCount: 18,
                    reactionCount: 15,
                    activeAgo: t.Z.Messages.THREAD_BROWSER_TIMESTAMP_MINUTES.format({ count: 40 })
                },
                {
                    user: {
                        name: 'kittyx',
                    ...
                    messageCount: 2,
                    reactionCount: 0,
                    activeAgo: t.Z.Messages.THREAD_BROWSER_TIMESTAMP_HOURS.format({ count: 1 }),
                    attachment: r
                }
            ],
            postPreview: {
                ...
                messages: [
                    {
                        ...
                        content: t.Z.Messages.FORUM_UPSELL_DEMO_1_MESSAGE_CONTENT_1
                    },
                    {
                        author: {
                            name: 'pocketman',
                ...
                messages: [
                    {
                        ...
                        content: t.Z.Messages.FORUM_UPSELL_DEMO_2_MESSAGE_CONTENT_1
                    },
                    {
                        author: {
                            name: 'pocketman',
        ...
        },
        {
            ...
            posts: [
                {
                    ...
                    tagId: null,
                    title: t.Z.Messages.FORUM_UPSELL_DEMO_3_POST_TITLE_1,
                    messageCount: 11,
                    reactionCount: 17,
                    activeAgo: t.Z.Messages.THREAD_BROWSER_TIMESTAMP_MINUTES.format({ count: 10 }),
                    attachment: i
                ...
                messages: [
                    {
                        ...
                        content: t.Z.Messages.FORUM_UPSELL_DEMO_3_MESSAGE_CONTENT_1
                    },
                    {
                        author: {
                            name: 'pocketman',
            ...
            ariaLabel: t.Z.Messages.FORUM_UPSELL_DEMO_3_ALT_TEXT
        }
    ][e];
}

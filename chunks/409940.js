...
var s = n(592093),
    ...
    d = (function (e) {
        function t(e) {
            ...
            return 'number' == typeof r.x && 'number' == typeof r.y ? ((n.x = new s(r.x)), (n.y = new s(r.y))) : (u(r.x instanceof s && r.y instanceof s, 'AnimatedValueXY must be initalized with an object of numbers or AnimatedValues.'), (n.x = r.x), (n.y = r.y)), (n._listeners = {}), n;
        }
        return (
            o(t, e),
            r(t, [

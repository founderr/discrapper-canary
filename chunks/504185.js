...
function ei(e) {
    let { channel: t, appContext: n, popoutOpen: a, popoutWindow: l, popoutWindowAlwaysOnTop: r, selectedParticipant: c } = e,
        u = t.getGuildId(),
        d = (0, o.e7)([j.Z], () => j.Z.getMostRecentSelectedTextChannelId(u), [u]),
        h = b.default.getId(),
        p = !(0, o.e7)([f.Z], () => f.Z.isFullscreenInContext(n)) && (!O.isPlatformEmbedded || (O.isPlatformEmbedded && y.ZP.supportsFeature(q.eRX.POPOUT_WINDOWS))),
...
function es(e) {
    let { channel: t } = e,
        n = (0, p.bp)(),
        s = (0, o.e7)([P.Z], () => P.Z.can(q.Plq.CREATE_INSTANT_INVITE, t)),
...
function ea(e) {
    let t,
        { channel: n, toggleRequestToSpeakSidebar: a, showRequestToSpeakSidebar: c, popoutWindow: u, popoutWindowAlwaysOnTop: d, popoutOpen: h, chatOpen: m } = e,
        _ = (0, p.bp)(),
        E = (0, o.e7)([j.Z], () => j.Z.getVoiceChannelId() === n.id, [n.id]),
        C = (0, o.e7)([P.Z], () => P.Z.can(q.Plq.CONNECT, n)),
...
function el(e) {
    let { channel: t } = e,
        ...
        x = null != E && !E.closed,
        { analyticsLocations: S } = (0, _.ZP)(m.Z.STAGE_CHANNEL_CALL),
        v = (0, p.bp)(),

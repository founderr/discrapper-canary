...
renderChatToasts: () => !M || p || T ? null : (0, i.jsx)(C.ZP, {
...
analyticsLocations: v
  } = (0, _.ZP)(p.Z.STAGE_CHANNEL_CALL), N = (0, m.bp)(), S = (0, o.e7)([f.Z], () => f.Z.getChatOpen(t.id), [t.id]), Z = (0, o.e7)([j.Z], () => j.Z.getGuild(t.guild_id), [t.guild_id]);
  a.useEffect(() => {

...
var _ = t(544891), E = t(570140), r = t(367907), i = t(430824), u = t(496675), A = t(823379), a = t(709054), o = t(177862), O = t(787824), T = t(226192), N = t(981631);
function I(n) {
    return {
        type: n.type,
...
async function L(n, e) {
    return await _.tn.del({ url: N.ANM.GUILD_AUTOMOD_RULE(e, n) }), !0;
}
async function S(n) {
    let e = await _.tn.get({ url: N.ANM.GUILD_AUTOMOD_RULES(n) });
    ...
    if (null != E && !!u.Z.can(N.Plq.MANAGE_GUILD, E))
        (0, T.UV)(() => {
            (0, r.yw)(N.rMx.GUILD_AUTOMOD_FEEDBACK, {
                ...
                decision_id: e
            }), _.tn.post({ url: N.ANM.GUILD_AUTOMOD_CLEAR_MENTION_RAID(n) }), t();
        });
}
function R(n) {
    E.Z.dispatch({

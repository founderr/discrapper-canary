...
var r = n(182823), i = n(464593), a = n(706682), o = n(148836), s = n(612001), l = n(470079), u = n(616073);
let c = new WeakMap();
function d(e, t) {
    let {id: n} = c.get(e);
    if (!n)
...
function _(e, t, n) {
    ...
    let f = (0, i.jS)({
            selectionManager: t.selectionManager,
            hasItemActions: !!u
        }), h = (0, a.pu)(n, { isDisabled: 0 !== t.collection.size }), p = (0, r.zL)(e, { labelable: !0 }), m = (0, r.dG)(p, {
            role: 'grid',
            id: E,
            'aria-multiselectable': 'multiple' === t.selectionManager.selectionMode ? 'true' : void 0
        }, 0 === t.collection.size ? { tabIndex: h ? -1 : 0 } : _, f);
    ...
    let {
            ...
            onKeyDownCapture: e => {
                ...
                case 'ArrowLeft': {
                        ...
                        if (i)
                            e.preventDefault(), e.stopPropagation(), (0, a.ex)(i), (0, r.Gt)(i, { containingElement: (0, r.rP)(n.current) });
...
function h(e, t) {
    let {key: n} = e, {checkboxProps: r} = (0, i.Ug)(e, t);
    return {
        checkboxProps: {
            ...r,

...
t.Z = (e) => {
    let t,
        { searchQuery: n, setSearchQuery: d, mostRecentQuery: h, handleClearSearch: m, handleSearchKeyPress: p, handleCreateOrAddGuild: _, searchResults: E, searchFetching: f } = e;
    if (f)
        t = (0, i.jsx)('div', {
        ...
        t = (0, i.jsx)('div', {
            ...
            children: E.map((e) => (0, i.jsx)(l.Z, { entry: e }, e.guildId))
        });
    return (0, i.jsx)('div', {
        className: o.pageContainer,

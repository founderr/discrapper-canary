...
function b(e) {
  let {
  ...
  } = e, D = (0, r.e7)([h.Z], () => null == s ? null : h.Z.getCommand(s), [s]), P = (null == D ? void 0 : D.defaultMemberPermissions) != null, B = (0, r.e7)([_.Z, m.ZP, N.Z], () => {
  ...
  }, [p, D, M, L]), y = null != s ? s : n, [G, k] = a.useMemo(() => {
    let e = {},
      n = {};
    for (let [t, i] of Object.entries(b)) i.type === d.Kw.CHANNEL ? e[t] = i : n[t] = i;
    return [e, n]
  }, [b]), U = a.useCallback(e => {
    ...
    if (0 !== n.length) {
      ...
      if (e.type === d.Kw.USER) t = f.s.REMOVE_SELF;
        ...
        let n = e.id;
        if (t = f.s.REMOVE_ROLE, (0, I.pM)(p, n)) i = "@everyone";
        else {
      ...
      if (t = f.s.DENY_ROLE, (0, I.pM)(p, n)) i = "@everyone";
      else {
        let e = _.Z.getRole(p, n);
        i = null != e ? e.name : "role"
      }
    }(0, f._)(t, i)
  }, [p, b]), w = a.useCallback((e, t) => {
    let i = {};
    for (let [e, n] of Object.entries(b)) i[e] = {
      id: n.id,
  ...
  }, [w, p, k, j]), V = a.useCallback(() => (0, c.openModalLazy)(async () => {
    let {
      default: e

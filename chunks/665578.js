...
var i = t(200651),
    ...
    A = t(457237);
function R(e) {
    let { applicationId: n, commandId: l, guildId: h, inModal: g, editedTargetPermissions: R, originalApplicationPermissions: v, originalCommandPermissions: M, selectedPermissionCount: L } = e,
        j = (0, r.e7)([T.Z], () => (null == l ? null : T.Z.getCommand(l)), [l]),
        ...
        w = a.useCallback(
            (e, t) => {
                ...
                if (((i = Object.assign(i, e)), t.length > 0 && (i = s().omit(i, t)), !k(i))) {
                    H(e, t);
                    return;
                }
                E.W4(n, B, i);
        ...
        Y = [
            {
                ...
                overwrites: G,
                title: null == l ? S.Z.Messages.INTEGRATIONS_APPLICATION_COMMAND_ROLE_MEMBER_ADD : S.Z.Messages.INTEGRATIONS_APPLICATION_COMMAND_OVERRIDE_SECTION_ROLE_MEMBER_HEADER
            },
            {
                buttonClick: U,
                ...
                overwrites: y,
                title: null == l ? S.Z.Messages.CHANNELS : S.Z.Messages.INTEGRATIONS_APPLICATION_COMMAND_OVERRIDE_SECTION_CHANNEL_HEADER
            }
        ];
        ...
        children: [
            ...
            Y.map((e, n) => {
                let t = (n) =>
                    ...
                    a = null;
                return (
                    P ? K && (a = S.Z.Messages.INTEGRATIONS_APPLICATION_PERMISSIONS_MAX) : (a = null != l ? S.Z.Messages.INTEGRATIONS_APPLICATION_PERMISSIONS_LOCKED_COMMAND : S.Z.Messages.INTEGRATIONS_APPLICATION_PERMISSIONS_LOCKED_APPLICATION),
                    (0, i.jsx)(
                        C.Z,
                        {

...
var i = t(735250), a = t(470079), s = t(392711), l = t.n(s), o = t(149765), r = t(442837), c = t(481060), d = t(895924), u = t(581364), I = t(605436), m = t(271383), _ = t(430824), N = t(496675), E = t(474333), T = t(821864), h = t(905753), p = t(937427), g = t(643886), C = t(869157), f = t(454092), x = t(289465), O = t(981631), S = t(689079), A = t(689938), R = t(501781);
function b(e) {
    let {
            applicationId: n,
            commandId: s,
            ...
            let e = _.Z.getGuild(p), n = m.ZP.getSelfMember(p);
            ...
            let n = _.Z.getGuild(p), t = m.ZP.getSelfMember(p);
            ...
            let {default: e} = await t.e('21897').then(t.bind(t, 303313)), n = D.defaultMemberPermissions;
    ...
    return (0, i.jsxs)(a.Fragment, {
        children: [
            K > 0 ? (0, i.jsx)(E.Z, {
                ...
                children: A.Z.Messages.INTEGRATIONS_APPLICATION_PERMISSIONS_NOTICE_TEXT.format({ removeCount: K })
            }) : null,
            P ? (0, i.jsxs)('div', {

i(47120);
var n, a, r, o, s = i(735250), l = i(470079), c = i(120356), d = i.n(c), u = i(392711), h = i.n(u), _ = i(846519), p = i(481060), m = i(570140), f = i(585483), g = i(996753), C = i(206895), x = i(259580), I = i(981631), b = i(689938), N = i(280827);
function v(e, t, i) {
...
class E extends (a = l.PureComponent) {
    ...
    render() {
        let {
            ...
            } = this.props, l = d()(N.arrowHitbox, { [N.arrowHitboxPadding]: i }, n);
        return (0, s.jsxs)('div', {
            ...
            children: [
                ...
                (0, s.jsx)('div', {
                    ...
                    children: h().times(t, t => (0, s.jsx)(p.Button, {
                        ...
                        'aria-label': b.Z.Messages.PAGINATION_SLIDE_LABEL.format({ pageNumber: t + 1 })
                    }, 'dot-'.concat(t)))
                }),
                (0, s.jsx)(p.Button, {
                    look: p.Button.Looks.BLANK,
...
class T extends (r = l.PureComponent) {
    ...
    componentDidUpdate(e, t) {
        ...
        let {items: l} = this.props, {visibleIndex: c} = this.state;
    ...
    render() {
        let {
                ...
                aspectRatio: f,
                children: g
            } = this.props, {visibleIndex: x} = this.state;
        return (0, s.jsxs)('div', {
            className: N.root,
            children: [
                (0, s.jsxs)('div', {
    ...
    constructor(e) {
        super(e), v(this, 'timer', new _.Xp()), v(this, 'handleWindowFocusChange', e => {
            ...
            let {visibleIndex: t} = this.state, {items: i} = this.props;

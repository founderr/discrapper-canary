...
function _(e) {
    ...
    return () => {
        ...
        return n.minute.slot !== a && ((n.minute.slot = a), (n.minute.budgetUsed = 0)), n.hour.slot !== _ && ((n.hour.slot = _), (n.hour.budgetUsed = 0)), !!(n.minute.budgetUsed < t) && (n.minute.budgetUsed++, !!(n.hour.budgetUsed < r)) && (n.hour.budgetUsed++, !0);
    };
}

t(47120);
var l = t(735250), a = t(470079), i = t(120356), s = t.n(i), r = t(392711), u = t(780384), o = t(481060), c = t(410030), d = t(44315), f = t(293501), m = t(943351), h = t(231338), g = t(552656);
    ...
    return a.useEffect(() => {
        ...
        if (0 !== N.width && 0 !== N.height) {
            if (null != S && S.length > 0) {
                let e = t / S.length, a = -(e * (m.nl.waveformBarWidth - 1));
                n.clearRect(0, 0, t, l), n.fillStyle = y.hex;
                for (let t = 0; t < S.length; t++) {
                    let i = S[t] * l, s = t * e + a, r = l / 2 - i / 2;

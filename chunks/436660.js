...
let o = a.bN.getSelectionOverlap(e, n),
  [s, l] = a.M8.edges(n),
  c = null !== (i = a.bN.before(e, s)) && void 0 !== i ? i : a.bN.start(e, []),
  d = a.bN.after(e, l);
a.M8.isExpanded(n) && r.YR.delete(e, {
  ...
  at: c
}), c = null != c ? c : a.bN.start(e, []), d = null != d ? d : a.bN.end(e, []), u(e, o, c, d, d);
  },
  textToVoid(e, t, n) {
...
var i;
let o = a.bN.getSelectionOverlap(e, n),
  s = null !== (i = a.bN.before(e, n)) && void 0 !== i ? i : a.bN.start(e, []),
  l = {
    path: s.path,
...
let i = a.bN.getSelectionOverlap(e, t),
  o = null !== (n = a.bN.before(e, t)) && void 0 !== n ? n : a.bN.start(e, []);
r.YR.delete(e, {
  at: t,
  voids: !0
}), u(e, i, o, o, o);
...
null != c && ('focus' === o ? r.YR.setSelection(e, {
  focus: c
}) : r.YR.setSelection(e, {
  focus: c,
  anchor: c
...
c = l(null === (o = e.selection) || void 0 === o ? void 0 : o.focus, t.focus, n, r, i);
  if (null != u && null != c)
s.select(e, {
  anchor: u,
  focus: c

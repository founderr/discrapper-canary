...
var r, i, a, o, s = n(470079), l = n(392711);
function u(e) {
    return 2 === e || 3 === e ? 1 : 0;
}
...
t.Z = e => {
    ...
    return s.useLayoutEffect(() => {
        if (!E || null == n.current)
            return;
        function e(e) {
            let t = 1 === u(d) ? e.screenX : e.screenY, n = 0 === d || 2 === d, a = (t - h.current) * (n ? -1 : 1), o = p.current + a;
            return (0, l.clamp)(o, null != i ? i : 0, null != r ? r : o);
        }
        let t = (0, l.throttle)(a, c), s = r => {
                if (null == n.current)
                    return null;
                let i = e(r), a = 1 === u(d) ? 'width' : 'height';
                n.current.style[a] = ''.concat(i, 'px'), t(i);
            }, m = t => {
                f(!1);
                let n = e(t);
                a(n), null == o || o(n);
            }, I = _ ? 'pointerup' : 'mouseup', T = _ ? 'pointermove' : 'mousemove', g = n.current.ownerDocument;

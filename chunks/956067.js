...
n(733860), n(653041);
let i = null == n.g.__getTotalRequireTime ? () => 0 : () => n.g.__getTotalRequireTime(), a = 'undefined' != typeof performance;
t.Z = new class e {
    get isTracing() {
    ...
    time(e, t, n) {
        ...
        let i = Date.now(), a = n(), o = Date.now() - i;
    ...
    async timeAsync(e, t, n) {
        ...
        let r = Date.now(), i = await n(), a = Date.now() - r;

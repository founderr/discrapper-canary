...
function c(e) {
  ...
  }, [E.guild_id]), T = (null === (t = c.messageReference) || void 0 === t ? void 0 : t.guild_id) != null && null != c.webhookId && c.hasFlag(d.MessageFlags.IS_CROSSPOST) && null != E.guild_id, I = E.type === a.ChannelTypes.GUILD_ANNOUNCEMENT && _, m = !c.hasFlag(d.MessageFlags.EPHEMERAL) && (T || I), p = T && null != c.messageReference ? c.messageReference.message_id : c.id, N = T && null != c.messageReference ? c.messageReference.channel_id : E.id, S = T && (null === (n = c.messageReference) || void 0 === n ? void 0 : n.guild_id) != null ? c.messageReference.guild_id : E.guild_id, C = s.useCallback(e => {
  ...
  }, [p, E.id, E.guild_id, N, S]), A = o.default.useExperiment({
    location: "836a4b_1"
  }, {
    disable: !m || !f,
    autoTrackExposure: !0

var r = n(570140), i = n(340332), a = n(672339), o = n(463395), s = n(131951), l = n(626135), u = n(557177), c = n(557457), d = n(981631), _ = n(65154);
function E() {
    (0, u.GN)('mention3');
}
...
t.Z = {
    ...
    toggleSelfMute() {
        ...
        return m() ? Promise.resolve() : (I({ usedKeybind: n }), s.Z.isEnabled()) ? r.Z.dispatch({
    ...
    setDisableLocalVideo(e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : _.Yn.DEFAULT, i = !(arguments.length > 3) || void 0 === arguments[3] || arguments[3], a = arguments.length > 4 && void 0 !== arguments[4] && arguments[4];
        !m() && r.Z.dispatch({
    ...
    setMode(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : _.Yn.DEFAULT;
        !m() && r.Z.dispatch({
            type: 'AUDIO_SET_MODE',
            context: n,
            mode: e,

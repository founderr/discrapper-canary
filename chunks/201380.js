...
class U extends a.PureComponent {
  ...
  constructor(...e) {
    super(...e), this.domElementRef = a.createRef(), this.state = {
      ...
      v.default.getId() !== e.id && c.default.selectVoiceChannel(t.id), n ? ((0, S.default)(a), u.default.selectParticipant(a.channelId, (0, E.encodeStreamKey)(a))) : (0, f.watchStreamAndTransitionToStream)(a), null == l || l(e.id)

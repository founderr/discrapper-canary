...
function c(e) {
  ...
  let {
    ...
    ...e,
    onSelectionChange: t => {
      e.onSelectionChange && e.onSelectionChange(t), t === k && (_(), K())
    },
  ...
  (0, i.useEffect)(() => {
    var t, n;
    S && (I.size > 0 || v) && !N.isOpen && M !== V.current && "manual" !== h && F(null, "input"), !b && !v && N.isOpen && 0 === I.size && K(), null != k && k !== z.current && K(), M !== V.current && (C.setFocusedKey(null), x(!1), "" === M && (void 0 === e.inputValue || void 0 === e.selectedKey) && P(null)), k !== z.current && (void 0 === e.inputValue || void 0 === e.selectedKey) ? _() : V.current = M;
    let r = null !== (n = null === (t = D.getItem(k)) || void 0 === t ? void 0 : t.textValue) && void 0 !== n ? n : "";
    !S && null != k && void 0 === e.inputValue && k === z.current && B.current !== r && (V.current = r, R(r)), z.current = k, B.current = r
  });
  let U = () => {
    ...
    q = (0, i.useMemo)(() => N.isOpen ? b ? D : I : O, [N.isOpen, D, I, b, O]);
  return {
    ...N,
    toggle: (t, n) => {
      let r = "manual" === n || "focus" === n && "focus" === h;

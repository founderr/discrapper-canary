...
var t = n(735250), r = n(470079), l = n(120356), s = n.n(l), o = n(263568), i = n(442837), c = n(481060), u = n(166459), d = n(596454), _ = n(273031), m = n(907040), E = n(906411), A = n(592125), f = n(703558), C = n(117530), L = n(153124), h = n(358085), R = n(79390), I = n(885001), x = n(35463), p = n(489887), O = n(185923), g = n(957825), T = n(689938), N = n(828765);
let P = {
    offset: {
        top: -4,
        bottom: -4,
...
function D(e) {
    let {
            ...
            emojiName: h.name,
            answerNumber: E + 1
        }) : T.Z.Messages.CREATE_POLL_ADD_EMOJI_ARIA.format({ answerNumber: E + 1 }), [
            p,
            h,
            E,
            D
            ...
            S,
            C
        ]), y = I ? (0, t.jsx)(c.Spinner, { className: M ? N.spinnerWrapperDefault : N.spinnerWrapperImageOnly }) : (0, t.jsx)(v, {
            hasUpload: p,
            mediaUrl: P,
            mediaFilename: D,
...
a.Z = r.forwardRef(function (e, a) {
    let {
            ...
            function e(e) {
                u.Z.update(l, d.localCreationAnswerId, f.d.Poll, { description: e });
            }
            ...
            let a = e.ctrlKey && !(e.altKey || e.metaKey || e.shiftKey), n = e.metaKey && !(e.altKey || e.ctrlKey || e.shiftKey);
            ...
            children: [
                (0, t.jsxs)('div', {
                    ...
                    children: [
                        V,
                        (0, t.jsx)(c.TextInput, {
                            'aria-label': T.Z.Messages.CREATE_POLL_ANSWER_INPUT_LABEL.format({ answerNumber: m + 1 }),
                ...
                v && (0, t.jsx)(c.Clickable, {
                    ...
                    'aria-label': T.Z.Messages.CREATE_POLL_REMOVE_ANSWER_A11Y.format({ answerNumber: m + 1 }),
                    ref: y,
                ...
                (0, t.jsxs)('div', {
                    ...
                    children: [
                        null != H ? (0, t.jsx)(_.Z, {
                            ...
                            'aria-label': J ? T.Z.Messages.CREATE_POLL_EDIT_ALT_ARIA_LABEL.format({ answerNumber: m + 1 }) : T.Z.Messages.CREATE_POLL_ADD_ALT_ARIA_LABEL.format({ answerNumber: m + 1 }),
                            onClick: G,

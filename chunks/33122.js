...
let P = {
    ...
    M = (e) => {
        let t,
            n,
            s,
            { item: a, size: r, onPlay: l, onEnded: o, onClick: u, playable: p, volume: m, isMuted: g, onVolumeChange: I, onMute: C } = e;
                ...
                return (0, i.jsxs)(
                    'div',
                    {
                        ...
                        children: [
                            ...
                            e.type === v.s9s.YOUTUBE_VIDEO || e.type === v.s9s.VIDEO ? (0, i.jsx)(T, {}) : null,

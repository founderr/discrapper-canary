  ...
  F = e => {
    let {
      ...
      return d && (0, n.jsx)(r.Clickable, {
        className: z ? S.spoilerRemoveAttachmentButton : S.removeAttachmentButton,
        focusProps: {
          offset: {
            bottom: 4
          }
...
var w = e => {
  ...
  let {
    ...
    width: p,
    height: E
  } = i, f = (0, d.useShouldRedactExplicitContent)(r.channel_id, r.author.id), C = (0, h.getObscureReason)(i, f), [v, T] = l.useState(null != C), N = m === y.MediaLayoutType.MOSAIC, O = !N && (null != p && p < 200 || null != E && E < 50), L = D(i, c);
    ...
    G = function() {
      ...
      return (0, n.jsx)(F, {
        ...
        className: s(a, S.attachmentContentItem, {
          ...
          [S.hiddenExplicit]: v && null != C && [h.ObscureReason.EXPLICIT_CONTENT, h.ObscureReason.POTENTIAL_EXPLICIT_CONTENT].includes(C),

...
function j(e) {
  ...
  let {
guildId: n
  } = e, s = (0, o.e7)([I.Z], () => I.Z.getGuild(n)), a = (0, o.e7)([E.ZP], () => E.ZP.getChannels(n)), r = (0, o.e7)([m.Z], () => m.Z.getCategories(n)), {
mutedChannels: d,
collapseMuted: u
  } = (0, o.cj)([T.ZP], () => ({
mutedChannels: T.ZP.getMutedChannels(n),
collapseMuted: T.ZP.isGuildCollapsed(n)
  })), h = (0, o.e7)([N.ZP], () => N.ZP.getVoiceStates(n)), O = (0, o.e7)([_.Z], () => _.Z.getCollapsed()), {
scrollTo: A

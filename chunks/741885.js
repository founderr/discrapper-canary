  ...
  checkGuildTemplateDirty: function(e) {
    ...
    return (t = function() {
      ...
      return function(e, t) {
        ...
        switch (n.label) {
          case 0:
            if (!o.default.canWithPartialContext(a.Permissions.MANAGE_GUILD, {
                guildId: e
              })) return [2];
            return [4, i.default.loadTemplatesForGuild(e)];
          case 1:
            return (t = n.sent()).body.length > 0 && r.default.dispatch({

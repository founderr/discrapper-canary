...
class m extends s.Z {
    ...
    setCodecs(e, t, n) {
        var r, i, a;
        let o;
        if (this.fpc.audioCodec !== e || this.fpc.videoCodec !== t) (o = this.codecs.find((t) => t.name === e)), (this.fpc.audioCodec = e), (this.fpc.audioPayloadType = null !== (r = null == o ? void 0 : o.payloadType) && void 0 !== r ? r : 0), (o = this.codecs.find((e) => e.name === t)), (this.fpc.videoCodec = t), (this.fpc.videoPayloadType = null !== (i = null == o ? void 0 : o.payloadType) && void 0 !== i ? i : 0), (this.fpc.rtxPayloadType = null !== (a = null == o ? void 0 : o.rtxPayloadType) && void 0 !== a ? a : 0), this.pc.negotiationNeeded();
    }
    setStream(e) {
    ...
    constructor(e, t, n, r) {
        ...
        s.on('addtrack', (e, t) => this.createOutput(p(e), t)),
            s.on('removetrack', (e, t) => this.destroyOutput(p(e), t)),
            s.once('connected', () => {
            ...
            s.on('connecting', () => this.setConnectionState(E.$j.DTLS_CONNECTING)),
            s.on('checking', () => this.setConnectionState(E.$j.ICE_CHECKING)),
            s.on('failed', () => this.setConnectionState(E.$j.NO_ROUTE)),
            s.on('disconnected', () => this.setConnectionState(E.$j.DISCONNECTED)),
            s.on('closed', () => this.setConnectionState(E.$j.DISCONNECTED)),
            s.on('offer', (e) => {
                let { sdp: t } = e,

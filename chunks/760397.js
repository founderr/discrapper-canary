...
h(C, "Thing", m), h(C, "Brand", m), h(C, "Person", function(e) {
  return I("Person", e)
}), h(C, "Organization", function(e) {
  return I("Organization", e)
}), h(C, "ItemPage", function(e) {
  return I("ItemPage", e)
}), h(C, "Product", p), h(C, "Offer", g), h(C, "Rating", function(e) {
  return I("Rating", e)
}), h(C, "AggregateRating", function(e) {
  return I("AggregateRating", e)
}), h(C, "AggregateOffer", function(e) {
  return I("AggregateOffer", e)
}), h(C, "QuantitativeValue", T), h(C, "UnitPriceSpecification", function(e) {

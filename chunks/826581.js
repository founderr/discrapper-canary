n(47120), n(653041);
var r, i, a, o, s = n(913527), l = n.n(s), u = n(442837), c = n(759174), d = n(570140), _ = n(430824), E = n(594174), f = n(70956), h = n(881952), p = n(246364), m = n(937111), I = n(981631);
let T = new Map(), g = {};
function S(e) {
    return g[e];
}
...
let v = !1, O = e => 'guild-join-request='.concat(e), R = (e, t) => 'guild-'.concat(e, '-').concat(t);
function C(e) {
    let t = [];
    return t.push(O(e.joinRequestId)), t.push(R(e.guildId, e.applicationStatus)), t;
}
let y = new c.h(C, e => ''.concat(e.joinRequestId)), D = new c.h(C, e => ''.concat(e.joinRequestId)), L = new c.h(C, e => ''.concat(e.actionedAt));
function b(e) {
    return y.get(e);
}
function M(e) {
...
let U = {}, w = {}, x = {}, G = {}, k = 10 * f.Z.Seconds.MINUTE;
class B extends (r = u.ZP.Store) {
    ...
    getSelectedApplicationTab(e) {
        var t;
        let n = _.Z.getGuild(e), r = (null == n ? void 0 : n.hasFeature(I.oNc.CLAN)) ? 'REVIEW_APPLICATION' : p.wB.SUBMITTED;
...
o = 'GuildJoinRequestStoreV2', (a = 'displayName') in (i = B) ? Object.defineProperty(i, a, {
    ...
    GUILD_JOIN_REQUESTS_FETCH_SUCCESS: function (e) {
        ...
        v = !1, t === p.wB.SUBMITTED && A(i, r), n.forEach(e => {
            M(e);
        });
    },

...
var l = t(470079), a = t(392711), i = t.n(a), r = t(442837), s = t(570140), o = t(724213), c = t(9156), d = t(630388), u = t(823379), h = t(549817), m = t(45966), _ = t(526761);
function f(e) {
    s.Z.dispatch({
        ...
        handleSelectOption: l.useCallback((n, t, l) => {
            let a = m.Z.getOnboardingResponses(e), {
                    ...
                    if (e.singleSelect && t) {
                        ...
                        let t = e.options.filter(e => l.includes(e.id)), a = t.filter(e => n.id !== e.id), r = t.map(e => e.roleIds).flat().filter(u.lm), s = a.map(e => e.roleIds).flat().filter(u.lm);
                    ...
                    if (c.singleSelect && h) {
                        ...
                        let e = c.options.filter(e => _.includes(e.id)), n = e.filter(e => d.id !== e.id), t = e.map(e => e.channelIds).flat().filter(u.lm), l = n.map(e => e.channelIds).flat().filter(u.lm);
                    ...
                    return n[t] = { flags: (0, d.mB)(l, _.ic.OPT_IN_ENABLED, !0) }, n;
                }, {}), g = p.reduce((n, t) => {
                    let l = c.ZP.getChannelIdFlags(e, t);
                    return n[t] = { flags: (0, d.mB)(l, _.ic.OPT_IN_ENABLED, !1) }, n;
                }, {}), N = {
                    ...x,
                    ...g
                };

...
function g(e) {
  let {
    ...
    context: T,
    icon: A
  } = e, h = (0, a.e7)([_.Z], () => _.Z.getGuild(n), [n]), f = (0, a.e7)([c.default], () => c.default.getId()), Z = (0, a.e7)([N.default], () => N.default.getUser(t)), O = (0, a.e7)([E.ZP], () => E.ZP.isGuestOrLurker(n, t), [n, t]), p = i.useMemo(() => ({
    [n]: [t]
  }), [n, t]), C = (0, d.EJ)(h);
  (0, u.$)(p);

...
function g(e) {
  let {
    ...
    context: I,
    icon: A
  } = e, h = (0, a.useStateFromStores)([S.default], () => S.default.getGuild(t), [t]), T = (0, a.useStateFromStores)([r.default], () => r.default.getId()), L = (0, a.useStateFromStores)([E.default], () => E.default.getUser(i)), m = (0, a.useStateFromStores)([c.default], () => c.default.isGuestOrLurker(t, i), [t, i]), O = s.useMemo(() => ({
    [t]: [i]
  ...
  return null != h && !G && (b || x || C) && null != L && !m && p && L.isStaff() ? (0, n.jsxs)(n.Fragment, {

n(47120);
var r = n(710845), i = n(430824), a = n(287328);
function o(e, t, n) {
...
t.Z = new class e {
    ...
    handleConnectionOpen(e, t) {
        for (let t of (this.reset(), e.guilds))
            this.updateWith(t.id, [t]);
        this.commit(t);
    }
    handleGuildCreate(e, t) {
        var n;
        let r = e.guild, i = e.guild.id;
    ...
    updateWith(e, t) {
        if (null != t) {
            var n, r;
            let i = Math.max(null !== (n = this.committed.get(e)) && void 0 !== n ? n : 0, null !== (r = this.pending.get(e)) && void 0 !== r ? r : 0), a = this.computeLatestVersion(i, t);

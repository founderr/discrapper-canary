n(627494), n(757143);
var s = n(735250), a = n(470079), i = n(120356), r = n.n(i), l = n(913527), o = n.n(l), c = n(91192), d = n(481060), u = n(100527), _ = n(933557), E = n(484459), I = n(103575), T = n(387667), m = n(699516), N = n(594174), S = n(259580), h = n(154921), g = n(934415), C = n(51144), x = n(884737), p = n(981631), R = n(609998);
function f(e, t) {
...
class L extends a.PureComponent {
    render() {
        ...
        return (0, s.jsx)(d.Popout, {
            ...
            children: a => (0, s.jsx)(d.Clickable, {
                ...a,
                onClick: e => {
...
class O extends a.PureComponent {
    hasChangesToRender() {
        let {log: e} = this.props, {changes: t} = e;
    ...
    getRowAccentColor() {
        ...
        if (e.action === p.rsA.MEMBER_BAN_ADD)
            return R.accentRed;
    }
    renderTitle() {
        let {
        ...
        return null != c ? (0, s.jsx)(d.Text, {
            ...
            children: c.format({
                ...
                target: l,
                reason: u,
                userHook: (a, i) => (0, s.jsx)(L, {
                    guildId: t,
                    user: e.user,
                    onContextMenu: n,
                    hideDiscriminator: !0
                }, i),
                targetHook: (n, i) => e.targetType === p.KFR.USER ? (0, s.jsx)(L, {
                    guildId: t,
                    user: e.target,
                    onContextMenu: a,
                    hideDiscriminator: !1
    ...
    renderRoleUpdate(e) {
        let {newValue: t} = e;
        return Array.isArray(t) ? t.map(e => (0, s.jsxs)('div', {
    ...
    renderChangeDetails(e) {
        ...
        let a = 0, i = t.changes.map((n, i) => {
                ...
                return null == u ? (console.warn('No change string for', n), null) : '' === u ? null : (a++, (0, s.jsxs)('div', {
                    className: R.detail,
                    children: [
                        (0, s.jsxs)('div', {
                            className: R.prefix,
    ...
    renderActionTag() {
        let {log: e} = this.props, t = (0, T.p5)(e.action);
        if (null != t)
            return (0, s.jsx)('div', {
                className: R.tag,
    ...
    render() {
        ...
        if (null == o)
            return null;
        let _ = this.hasChangesToRender(), T = R.headerDefault;
        a ? T = R.headerExpanded : _ && (T = R.headerClickable);
        let m = t.timestampStart.calendar(), N = t.timestampEnd.calendar();

...
class V extends s.PureComponent {
    ...
    constructor(...e) {
        super(...e), D(this, 'state', { fadeIn: !1 }), D(this, 'timeout', null), D(this, 'handleDismissInviteEducation', () => {
            let {activity: e} = this.props;
...
class G extends s.PureComponent {
    ...
    render() {
        ...
        let {
                ...
                poggermodeEnabled: _,
                isComboing: v
            } = this.props, {rateLimitPerUser: b} = p, I = j.default.getCurrentUser(), x = C.Z.getGuild(t), R = b > 0, N = f ? [] : r()(l).keys().filter(e => e !== (null == I ? void 0 : I.id)).reject(e => S.Z.isBlocked(e)).map(e => j.default.getUser(e)).filter(L.lm).map(e => w.ZP.getName(t, this.props.channel.id, e)).value();
        if (0 === N.length && !R && !v)
        ...
        if (R) {
            if (Z = (0, i.jsx)(g.TimerIcon, {
                ...
                let e = Math.floor(b / P.Z.Seconds.HOUR), t = Math.floor((b - e * P.Z.Seconds.HOUR) / P.Z.Seconds.MINUTE), n = b - e * P.Z.Seconds.HOUR - t * P.Z.Seconds.MINUTE;
        ...
        let [A, y, U] = N;
        return e = 0 === N.length ? '' : 1 === N.length ? k.Z.Messages.ONE_USER_TYPING.format({ a: A }) : 2 === N.length ? k.Z.Messages.TWO_USERS_TYPING.format({
            a: A,
            b: y
    ...
    constructor(...e) {
        super(...e), D(this, 'state', { color: new d.Z.Value(0) }), D(this, 'emphasizeSlowmodeCooldown', () => {
            let {color: e} = this.state;
            d.Z.sequence([
                d.Z.timing(e, {
                    toValue: 1,

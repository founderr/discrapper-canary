...
var n = r(862315), _ = r(868145), a = r(529866), i = r(874230), o = r(442853);
class E {
    __init() {
        this.spans = [];
    }
    constructor(t = 1000) {
        E.prototype.__init.call(this), this._maxlen = t;
    }
    add(t) {
...
class s {
    ...
    __init3() {
        this.spanId = (0, n.DM)().substring(16);
    }
    __init4() {
        this.startTimestamp = (0, _.ph)();
    }
    __init5() {
        this.tags = {};
    }
    ...
    constructor(t) {
        if (s.prototype.__init2.call(this), s.prototype.__init3.call(this), s.prototype.__init4.call(this), s.prototype.__init5.call(this), s.prototype.__init6.call(this), s.prototype.__init7.call(this), !t)
            return this;
    ...
    startChild(t) {
        ...
        if (e.spanRecorder = this.spanRecorder, e.spanRecorder && e.spanRecorder.add(e), e.transaction = this.transaction, ('undefined' == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && e.transaction) {
            let r = t && t.op || '< unknown op >', n = e.transaction.name || '< unknown name >', _ = e.transaction.spanId, i = `[Tracing] Starting '${ r }' span on transaction '${ n }' (${ _ }).`;
            e.transaction.metadata.spanMetadata[e.spanId] = { logMessage: i }, a.kg.log(i);
        }
        return e;
    }
    setTag(t, e) {
    ...
    finish(t) {
        ...
        this.endTimestamp = 'number' == typeof t ? t : (0, _.ph)();
    }
    toTraceparent() {
        return (0, i.$p)(this.traceId, this.spanId, this.sampled);
    }
    toContext() {
        return (0, o.Jr)({
            data: this.data,

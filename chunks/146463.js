...
s.Z = function (e) {
    ...
    let {
        ...
        } = e, P = (0, i.e7)([d.Z], () => d.Z.getGuild(u), [u]), g = (0, i.e7)([_.Z], () => _.Z.isFetching()), b = g ? [t.length + 25] : [t.length], j = (0, N.L)({ guildId: u }), v = null !== (s = (0, C.A)({ guildId: u })) && void 0 !== s ? s : 0, p = (0, c.Z)('guild-join-requests'), f = e => {
            let {row: s} = e, l = t[s];

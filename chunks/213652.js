...
function C(e) {
  ...
  })), I = r.default.getSettings().clipsEnabled, A = (null == g ? void 0 : g.ownerId) === f.default.getId(), x = !I || !(A || _) || T || null == n, v = l.useCallback(e => (0, a.jsx)(i.CameraIcon, {
    ...e,
    color: "currentColor"
  }), []);
  return (0, a.jsx)(d.default, {
    ...
    onClick: () => {
      !x && (A ? (0, o.saveClip)() : (0, o.saveClip)(n.id))
    },
    disabled: x,
    iconComponent: v,

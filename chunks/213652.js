...
function E(e) {
    ...
    return (0, i.jsx)(u.Z, {
        ...
        disabled: v,
        iconComponent: N,
        label: null == g ? _.Z.Messages.CLIPS_VIEWERSIDE_BUTTON_FOCUS_TOOLTIP : S || I ? (T ? (x ? void 0 : _.Z.Messages.CLIPS_SAVE) : _.Z.Messages.CLIPS_VIEWERSIDE_BUTTON_ENABLE_CLIPS_TOOLTIP) : _.Z.Messages.CLIPS_VIEWERSIDE_BUTTON_DISABLED_TOOLTIP,
        grow: !1
    });
}

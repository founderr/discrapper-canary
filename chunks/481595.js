...
function b(e) {
    ...
    let z = F[w], X = B[w], J = null != G ? G : S.c, q = null != X ? X[J] : null;
    r()(null != z, 'SKU must exist and be fetched.'), r()(null != v, 'Application must exist.');
    let Q = (0, c.e7)([
            E.Z,
            h.Z
        ], () => h.Z.inTestModeForApplication(v.id) || E.Z.inDevModeForApplication(v.id), [v.id]), $ = (0, c.e7)([T.Z], () => T.Z.enabled), ee = a.M.EEA_COUNTRIES.has(x.Z.ipCountryCodeWithFallback), en = b === C.A.PURCHASING || b === C.A.COMPLETED, es = null != G ? D[G].type : null, el = t.useMemo(() => null != q ? (0, l.jsx)(y, {
            sku: z,
            skuPricePreview: q
        ...
        children: [
            ...
            (0, l.jsx)(p.Z, {
                ...
                children: (0, l.jsx)(m.Z, {
                    ...
                    purchaseType: k,
                    isGift: Y,
                    checkboxLabel: z.productLine === R.POd.COLLECTIBLES ? j.Z.Messages.BILLING_LEGAL_MUMBO_JUMBO_TERMS_LABEL_SIMPLE.format({ paidURL: R.EYA.PAID_TERMS }) : void 0,

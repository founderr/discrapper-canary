...
function G(e) {
  let {
    ...
    isGift: K,
    giftRecipient: V
  } = (0, y.useGiftContext)(), Z = K && (0, x.shouldShowCustomGiftExperience)(V);
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [Q && (0, i.jsx)(d.default, {
      ...
      children: K ? b.default.Messages.PREMIUM_GIFTING_BUTTON : b.default.Messages.ONE_TIME_PURCHASE_REVIEW_STEP_PURCHASE_DETAILS_LABEL
    }), ei, (0, i.jsxs)("div", {
      ...
      children: (0, i.jsx)(f.default, {
        ...
        purchaseType: W,
        isGift: K,
        checkboxLabel: z.productLine === R.SKUProductLines.COLLECTIBLES ? b.default.Messages.BILLING_LEGAL_MUMBO_JUMBO_TERMS_LABEL_SIMPLE.format({
          paidURL: R.MarketingURLs.PAID_TERMS
        }) : void 0,

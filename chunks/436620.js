...
let a = parseInt(null !== (i = s().version) && void 0 !== i ? i : "0", 10),
  ...
  d = "Chrome" === s().name || "Safari" === s().name || "Firefox" === s().name && a >= 80 || "Opera" === s().name || "Microsoft Edge" === s().name,
  _ = o || "Firefox" === s().name && a >= 73 || "Safari" === s().name && a >= 13 || "Chrome" === s().name && a >= 80 || "Microsoft Edge" === s().name && a >= 80,
  c = "Chrome" === s().name && a >= 58 || "Safari" === s().name && a >= 15 || "Firefox" === s().name && a >= 108,

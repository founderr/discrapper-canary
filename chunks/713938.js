...
function u(e, t) {
    switch (e) {
        ...
        case r.x.GUILDS_CHANNELS_READ:
            return [i.Z.Messages.SCOPE_GUILDS_CHANNELS_READ];
        case r.x.GDM_JOIN:
...
function c(e) {
    return e.includes(r.x.DM_CHANNELS_MESSAGES_WRITE) || e.includes(r.x.SDK_SOCIAL_LAYER) ? i.Z.Messages.OAUTH2_CAN_READ_SEND_NOTICE.format() : e.includes(r.x.MESSAGES_READ) || e.includes(r.x.DM_CHANNELS_MESSAGES_READ) ? i.Z.Messages.OAUTH2_CAN_READ_NOTICE.format() : i.Z.Messages.OAUTH2_CANNOT_READ_SEND_NOTICE.format();
}

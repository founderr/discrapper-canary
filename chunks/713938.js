...
var r = n(243814),
	i = n(689938);
let a = [() => i.Z.Messages.OAUTH2_FAKE_SCOPE_1, () => i.Z.Messages.OAUTH2_FAKE_SCOPE_2, () => i.Z.Messages.OAUTH2_FAKE_SCOPE_3, () => i.Z.Messages.OAUTH2_FAKE_SCOPE_4, () => i.Z.Messages.OAUTH2_FAKE_SCOPE_5, () => i.Z.Messages.OAUTH2_FAKE_SCOPE_6, () => i.Z.Messages.OAUTH2_FAKE_SCOPE_7, () => i.Z.Messages.OAUTH2_FAKE_SCOPE_8],
	s = [r.x.BOT, r.x.OPENID, r.x.IDENTIFY, r.x.EMAIL, r.x.CONNECTIONS, r.x.MESSAGES_READ, r.x.GUILDS, r.x.GUILDS_JOIN, r.x.GUILDS_MEMBERS_READ, r.x.GDM_JOIN, r.x.RPC, r.x.RPC_NOTIFICATIONS_READ, r.x.RPC_VOICE_READ, r.x.RPC_VOICE_WRITE, r.x.RPC_VIDEO_READ, r.x.RPC_VIDEO_WRITE, r.x.RPC_SCREENSHARE_READ, r.x.RPC_SCREENSHARE_WRITE, r.x.RPC_ACTIVITIES_WRITE, r.x.APPLICATIONS_BUILDS_UPLOAD, r.x.APPLICATIONS_BUILDS_READ, r.x.APPLICATIONS_COMMANDS, r.x.APPLICATIONS_COMMANDS_UPDATE, r.x.APPLICATIONS_COMMANDS_PERMISSIONS_UPDATE, r.x.APPLICATIONS_STORE_UPDATE, r.x.APPLICATIONS_ENTITLEMENTS, r.x.ACTIVITIES_READ, r.x.ACTIVITIES_WRITE, r.x.RELATIONSHIPS_READ, r.x.RELATIONSHIPS_WRITE, r.x.VOICE, r.x.DM_CHANNELS_READ, r.x.DM_CHANNELS_MESSAGES_READ, r.x.DM_CHANNELS_MESSAGES_WRITE, r.x.ROLE_CONNECTIONS_WRITE, r.x.PRESENCES_READ, r.x.PRESENCES_WRITE, r.x.GATEWAY_CONNECT, r.x.PAYMENT_SOURCES_COUNTRY_CODE],
	o = s.concat([r.x.WEBHOOK_INCOMING, r.x.BOT]),
	l = ['rpc.api'];
function u(e, t) {
	switch (e) {
		case r.x.IDENTIFY:
		...
		case r.x.GUILDS_MEMBERS_READ:
			if (t.includes(r.x.VOICE)) return i.Z.Messages.SCOPE_GUILDS_MEMBERS_READ_VOICE;

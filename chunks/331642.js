...
function C(e) {
  let {
onSelect: t
  } = e, [s, r] = a.useState(!1), l = (0, i.e7)([c.default], () => c.default.getCurrentUser()), _ = d.ZP.canUseCustomCallSounds(l);
...
previewSound: s
  } = (0, E.Z)(t, null), a = 0 === (0, _.pI)() ? S.Z.Messages.SOUNDBOARD_SOUND_PREVIEW_SOUND_LOW_VOLUME : S.Z.Messages.SOUNDBOARD_SOUND_PREVIEW_SOUND.format({

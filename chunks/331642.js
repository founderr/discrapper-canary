...
function C(e) {
  let {
onSelect: s
  } = e, [t, r] = a.useState(!1), l = (0, i.e7)([c.default], () => c.default.getCurrentUser()), _ = d.ZP.canUseCustomCallSounds(l);
...
previewSound: t
  } = (0, E.Z)(s, null), a = 0 === (0, _.pI)() ? S.Z.Messages.SOUNDBOARD_SOUND_PREVIEW_SOUND_LOW_VOLUME : S.Z.Messages.SOUNDBOARD_SOUND_PREVIEW_SOUND.format({
...
isGlobal: t,
onSelect: a
  } = e, i = null != s, c = null == s ? void 0 : s.emojiId, d = null == s ? void 0 : s.emojiName, _ = i && (null != d || null != c), E = e => (0, n.jsx)(o.Text, {
  ...
  (0, n.jsxs)('div', {
    ...
    children: [
      ...
      (0, n.jsx)(o.Text, {
        ...
        children: null == s ? S.Z.Messages.NONE : t ? S.Z.Messages.CALL_SOUNDS_SETTINGS_ALL_SERVERS.format({
          soundName: s.name,
          subtextHook: E
        }) : s.name
      }),

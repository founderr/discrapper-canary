var r, o, a, i, s = n(67867), c = n(414629), l = n(42433), u = n(668530), d = n(570596), p = n(691244), h = n(600385), f = n(414847), m = n(187592), y = n(548828), v = n(735471), g = n(982665), b = n(13780), _ = n(992416), k = n(62691).set, C = n(584831), Z = n(502856), w = n(139545), S = n(6938), N = n(29461), x = n(197859), P = n(732116), A = n(653457), R = 'Promise', F = P.CONSTRUCTOR, O = P.REJECTION_EVENT, E = P.SUBCLASSING, I = N.getterFor(R), M = N.set, T = x && x.prototype, B = x, D = T, L = u.TypeError, V = u.document, j = u.process, U = A.f, q = U, H = !!(V && V.createEvent && u.dispatchEvent), K = 'unhandledrejection', z = function (e) {
        var t;
        return !!(g(e) && v(t = e.then)) && t;
    }, W = function (e, t) {
        var n, r, o, a = t.value, i = 1 === t.state, s = i ? e.ok : e.fail, c = e.resolve, l = e.reject, u = e.domain;
        try {

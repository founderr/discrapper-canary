...
function g(e) {
  i.useEffect(() => {
    if (null != e)(0, s.jU)(e), (0, o.GZ)(e), (0, u.km)(e)
  }, [e]);
  ...
  let S = null == l ? void 0 : l.applicationId,
    ...
    T = i.useCallback(() => {
      if ((null == l ? void 0 : l.applicationId) == null || (null == l ? void 0 : l.id) == null || (null == j ? void 0 : j.id) == null || (null == j ? void 0 : j.sku_flags) == null) return null;
      (0, a.openModal)(e => {
        let {
          onClose: n,
          transitionState: i
    ...
    }, [null == l ? void 0 : l.applicationId, null == l ? void 0 : l.id, null == j ? void 0 : j.id, null == j ? void 0 : j.sku_flags]),
    _ = i.useCallback(() => {
  ...
  if (null != l && null != x && (null == l || l.type !== C.epS.SUBSCRIPTION || null != j)) {
    if (null == e || null != l && !l.available) return {
      disabled: !0,

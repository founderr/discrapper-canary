...
var t = s(735250),
    ...
    v = s(726769);
function S(e) {
    let { user: n, currentUser: s, guild: c, guildMember: a, roles: d, highestRole: u, canManageRoles: _, onAddRole: I, onRemoveRole: f } = e,
        x = _ && null != a,
        ...
        N = d.map((e) => {
            ...
            return (0, t.jsx)(
                m.Z,
                {
                    ...
                    onRemove: () => f(e),
                    canRemove: _ ? E.r6(c, s.id, u, e) : (null === (i = e.tags) || void 0 === i ? void 0 : i.guild_connections) === null && n.id === s.id
                },
                e.id
            );
        });
...
function T(e) {
    let { user: n, currentUser: s, guild: o, scrollIntoView: l } = e,
        ...
        g = E.e9(o, s.id),
        [A] = (0, c.Wu)([I.Z], () => [I.Z.can(h.Plq.MANAGE_ROLES, o), null != o ? I.Z.getGuildVersion(o.id) : null]),
        N = i.useCallback(
            (e) => {
                var s, t;

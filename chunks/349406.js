...
function E(e) {
  let {
    ...
    transitionState: N,
    onClose: R
  } = e, g = (0, d.default)(), A = "".concat(S.default.Messages.PRIVACY_SETTINGS, "—").concat(null != _ ? _.toString() : "??"), f = _.hasFeature(c.GuildFeatures.HUB);
    ...
    children: [(0, i.jsx)(a.ModalHeader, {
      ...
      children: [(0, i.jsx)(a.FormItem, {
        children: (0, i.jsx)(a.FormSwitch, {
          value: !t,
          note: f ? S.default.Messages.PRIVACY_SETTINGS_DIRECT_MESSAGES_DESC_HUB : S.default.Messages.PRIVACY_SETTINGS_DIRECT_MESSAGES_DESC,
          onChange: s,
          hideBorder: !0,
        ...
        children: [(0, i.jsx)(a.FormItem, {
          children: (0, i.jsx)(a.FormSwitch, {
            value: !T,
            note: f ? S.default.Messages.PRIVACY_SETTINGS_MESSAGE_REQUESTS_DESC_HUB.format({
...
function T(e) {
  let {
    ...
    transitionState: s,
    onClose: a
  } = e, d = t.id, l = u.RestrictedGuildIds.useSetting().includes(d), c = u.MessageRequestRestrictedGuildIds.useSetting().includes(d), S = u.ActivityRestrictedGuilds.useSetting().includes(d), o = u.ActivityJoiningRestrictedGuilds.useSetting().includes(d), T = n.useCallback(e => {

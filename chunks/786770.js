...
function Q(e) {
  ...
  if (null == l || !l.isPrivate() || L.default.getStatus() === U.StatusTypes.DND || C.QuietMode.getSetting()) return !1;
...
var ee = new $(c.default, __OVERLAY__ ? {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if ((!P.default.isInstanceUILocked() || P.default.isPinned(U.OverlayWidgets.TEXT)) && a === R.default.getChannelId() || P.default.getTextChatNotificationMode() === U.OverlayNotificationTextChatTypes.DISABLED || M.default.disableNotifications || !(0, k.shouldNotify)(l, a)) return !1;
  ...
  CLIPS_SAVE_CLIP_START: function() {
    q((0, O.createClipsNotification)(F.default.Messages.CLIPS_SAVE_START_NOTIFICATION_TITLE))
  },
  CLIPS_SAVE_CLIP: function() {
    q((0, O.createClipsNotification)(F.default.Messages.CLIPS_NOTIFICATION_TITLE.format({
      duration: (0, w.getSecondsSliderLabel)(I.default.getSettings().clipsLength / 1e3, !0)
    })))
  },
  CLIPS_SAVE_CLIP_ERROR: function() {
    q((0, O.createClipsNotification)(F.default.Messages.CLIPS_SAVE_ERROR_NOTIFICATION_TITLE))
  },
  STREAM_START: function(e) {
    let t = (0, O.createClipsReminderNotification)();
    null != t && q(t)
  }
} : {})
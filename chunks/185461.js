...
eR = e => {
  if (!eu) {
    ...
    t.id = String(e.id), c.body.appendChild(t), (eu = t.attachShadow({
      mode: 'open'
...
eA = async (t, r, a) => {
  ...
  if (!a)
    throw M && _.kg.error('[Feedback] Missing feedback modal integration. Try using `feedbackSyncIntegration` in your `Sentry.init`.'), Error('[Feedback] Missing feedback modal integration!');
  return n && !o && M && _.kg.error('[Feedback] Missing feedback screenshot integration. Proceeding without screenshots.'), a.createDialog({
    options: e,
  ...
  if (!n)
    throw M && _.kg.error('[Feedback] Unable to attach to target element'), Error('Unable to attach to target element');
  let a = null,
    o = async () => {
      !a && (a = await eT({
        ...r,
  ...
  let t = P(eI, e),
    ...
    n = function({
      ...
      if (n.type = 'button', n.className = 'widget__actor', n.ariaHidden = 'false', n.ariaLabel = t || e || u, n.appendChild(function() {
...
setupOnce() {
  if (!!(0, E.j)() && !!eI.autoInject)
    'loading' === c.readyState ? c.addEventListener('DOMContentLoaded', () => eN().appendToDom()) : eN().appendToDom();
},
attachTo: ed,
createWidget(e = {}) {
  let t = eN(P(eI, e));
...
'key' == o ? n = t[o] : 'ref' == o ? a = t[o] : i[o] = t[o];
  if (arguments.length > 2 && (i.children = arguments.length > 3 ? w.call(arguments, 2) : r), 'function' == typeof e && null != e.defaultProps)
...
e.__d && (r = K.length, t = function(e, t, r) {
  var n, a = e.__v,
    o = a.__e,
    i = e.__P;
  if (i)
    return (n = $({}, a)).__v = a.__v + 1, H.vnode && H.vnode(n), eE(i, n, a, e.__n, void 0 !== i.ownerSVGElement, 32 & a.__u ? [o] : null, t, null == o ? ee(a) : o, !!(32 & a.__u), r), n.__.__k[n.__i] = n, n.__d = void 0, n.__e != o && function e(t) {
      var r, n;
...
}(e, n, a) || t, 0 === r || K.length > r ? (es(n, t, a), a.length = n.length = 0, t = void 0, K.sort(x)) : t && H.__c && H.__c(t, W));
  t && es(n, t, a), er.__r = 0;
}

function en(e, t, r, n, a, o, i, _, E, s, c) {
  var I, u, l, R, A, T = n && n.__k || W,
d = t.length;
  for (r.__d = E, function(e, t, r) {
  var n, a, o, i, _, E = t.length,
    s = r.length,
    c = s,
    I = 0;
  for (e.__k = [], n = 0; n < E; n++)
    null != (a = e.__k[n] = null == (a = t[n]) || 'boolean' == typeof a || 'function' == typeof a ? null : 'string' == typeof a || 'number' == typeof a || 'bigint' == typeof a || a.constructor == String ? J(null, a, null, null, a) : j(a) ? J(Q, {
      children: a
    }, null, null, null) : void 0 === a.constructor && a.__b > 0 ? J(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v) : a) ? (a.__ = e, a.__b = e.__b + 1, _ = function(e, t, r, n) {
      var a = e.key,
        o = e.type,
        i = r - 1,
        _ = r + 1,
        E = t[r];
      if (null === E || E && a == E.key && o === E.type)
        return r;
      if (n > (null != E && 0 == (131072 & E.__u) ? 1 : 0))
        for (; i >= 0 || _ < t.length;) {
          if (i >= 0) {
            if ((E = t[i]) && 0 == (131072 & E.__u) && a == E.key && o === E.type)
              return i;
            i--;
          }
          if (_ < t.length) {
            if ((E = t[_]) && 0 == (131072 & E.__u) && a == E.key && o === E.type)
              return _;
            _++;
          }
        }
      return -1;
    }(a, r, i = n + I, c), a.__i = _, o = null, -1 !== _ && (c--, (o = r[_]) && (o.__u |= 131072)), null == o || null === o.__v ? (-1 == _ && I--, 'function' != typeof a.type && (a.__u |= 65536)) : _ !== i && (_ === i + 1 ? I++ : _ > i ? c > E - i ? I += _ - i : I-- : I = _ < i && _ == i - 1 ? _ - i : 0, _ !== n + I && (a.__u |= 65536))) : (o = r[n]) && null == o.key && o.__e && (o.__e == e.__d && (e.__d = ee(o)), eI(o, o, !1), r[n] = null, c--);
  if (c)
    for (n = 0; n < s; n++)
      null != (o = r[n]) && 0 == (131072 & o.__u) && (o.__e == e.__d && (e.__d = ee(o)), eI(o, o));
}(r, t, T), E = r.__d, I = 0; I < d; I++)
null != (l = r.__k[I]) && 'boolean' != typeof l && 'function' != typeof l && (u = -1 === l.__i ? F : T[l.__i] || F, l.__i = I, eE(e, l, u, a, o, i, _, E, s, c), R = l.__e, l.ref && u.ref != l.ref && (u.ref && ec(u.ref, null, l), c.push(l.ref, l.__c || R, l)), null == A && null != R && (A = R), 65536 & l.__u || u.__k === l.__k ? E = function e(t, r, n) {
  var a, o;
  if ('function' == typeof t.type) {
    for (a = t.__k, o = 0; a && o < a.length; o++)
      a[o] && (a[o].__ = t, r = e(a[o], r, n));
    return r;
  }
  ...
  return r;
}(l, E, e) : 'function' == typeof l.type && void 0 !== l.__d ? E = l.__d : R && (E = R.nextSibling), l.__d = void 0, l.__u &= -196609);
  r.__d = E, r.__e = A;
}
...
if ('style' === t) {
  if ('string' == typeof r)
    ...
    if ('string' == typeof n && (e.style.cssText = n = ''), n)
      for (t in n)
        r && t in r || ea(e.style, t, '');
    if (r)
      for (t in r)
        n && r[t] === n[t] || ea(e.style, t, r[t]);
  }
} else if ('o' === t[0] && 'n' === t[1])
o = t !== (t = t.replace(/(PointerCapture)$|Capture$/i, '$1')), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + o] = r, r ? n ? r.u = n.u : (r.u = Date.now(), e.addEventListener(t, o ? e_ : ei, o)) : e.removeEventListener(t, o ? e_ : ei, o);
  else {
if (a)
...
function eE(e, t, r, n, a, o, i, _, E, s) {
  var c, I, u, l, R, A, T, d, N, p, O, f, S, D, L, h = t.type;
...
if ('function' == typeof h)
  try {
    if (d = t.props, N = (c = h.contextType) && n[c.__c], p = c ? N ? N.props.value : c.__ : n, r.__c ? T = (I = t.__c = r.__c).__ = I.__E : ('prototype' in h && h.prototype.render ? t.__c = I = new h(d, p) : (t.__c = I = new Z(d, p), I.constructor = h, I.render = eu), N && N.sub(I), I.props = d, I.state || (I.state = {}), I.context = p, I.__n = n, u = I.__d = !0, I.__h = [], I._sb = []), null == I.__s && (I.__s = I.state), null != h.getDerivedStateFromProps && (I.__s == I.state && (I.__s = $({}, I.__s)), $(I.__s, h.getDerivedStateFromProps(d, I.__s))), l = I.props, R = I.state, I.__v = t, u)
      null == h.getDerivedStateFromProps && null != I.componentWillMount && I.componentWillMount(), null != I.componentDidMount && I.__h.push(I.componentDidMount);
    else {
      if (null == h.getDerivedStateFromProps && d !== l && null != I.componentWillReceiveProps && I.componentWillReceiveProps(d, p), !I.__e && (null != I.shouldComponentUpdate && !1 === I.shouldComponentUpdate(d, I.__s, p) || t.__v === r.__v)) {
        for (t.__v !== r.__v && (I.props = d, I.state = I.__s, I.__d = !1), t.__e = r.__e, t.__k = r.__k, t.__k.forEach(function(e) {
            e && (e.__ = t);
          }), O = 0; O < I._sb.length; O++)
          I.__h.push(I._sb[O]);
        I._sb = [], I.__h.length && i.push(I);
        break t;
      }
      null != I.componentWillUpdate && I.componentWillUpdate(d, I.__s, p), null != I.componentDidUpdate && I.__h.push(function() {
        I.componentDidUpdate(l, R, A);
      });
    }
    if (I.context = p, I.props = d, I.__P = e, I.__e = !1, f = H.__r, S = 0, 'prototype' in h && h.prototype.render) {
      for (I.state = I.__s, I.__d = !1, f && f(t), c = I.render(I.props, I.state, I.context), D = 0; D < I._sb.length; D++)
        I.__h.push(I._sb[D]);
      I._sb = [];
    } else
      do
        I.__d = !1, f && f(t), c = I.render(I.props, I.state, I.context), I.state = I.__s;
      while (I.__d && ++S < 25);
...
null == o && t.__v === r.__v ? (t.__k = r.__k, t.__e = r.__e) : t.__e = function(e, t, r, n, a, o, i, _, E) {
  var s, c, I, u, l, R, A, T = r.props,
    d = t.props,
    N = t.type;
  if ('svg' === N && (a = !0), null != o) {
  ...
  if (null === N)
    T === d || _ && e.data === d || (e.data = d);
  else {
    if (o = o && w.call(e.childNodes), T = r.props || F, !_ && null != o)
      for (T = {}, s = 0; s < e.attributes.length; s++)
        T[(l = e.attributes[s]).name] = l.value;
    for (s in T)
      l = T[s], 'children' == s || ('dangerouslySetInnerHTML' == s ? I = l : 'key' === s || s in d || eo(e, s, null, l, a));
    for (s in d)
      l = d[s], 'children' == s ? u = l : 'dangerouslySetInnerHTML' == s ? c = l : 'value' == s ? R = l : 'checked' == s ? A = l : 'key' === s || _ && 'function' != typeof l || T[s] === l || eo(e, s, l, T[s], a);
    if (c)
      _ || I && (c.__html === I.__html || c.__html === e.innerHTML) || (e.innerHTML = c.__html), t.__k = [];
    else if (I && (e.innerHTML = ''), en(e, j(u) ? u : [u], t, r, n, a && 'foreignObject' !== N, o, i, o ? o[0] : r.__k && ee(r, 0), _, E), null != o)
      for (s = o.length; s--;)
        null != o[s] && q(o[s]);
...
for (var a, o, i; t = t.__;)
  if ((a = t.__c) && !a.__)
    try {
      if ((o = a.constructor) && null != o.getDerivedStateFromError && (a.setState(o.getDerivedStateFromError(e)), i = a.__d), null != a.componentDidCatch && (a.componentDidCatch(e, n || {}), i = a.__d), i)
        return a.__E = a;
    } catch (t) {
      e = t;
    }
...
}, Y = 0, Z.prototype.setState = function(e, t) {
  var r;
...
}, Z.prototype.render = Q, K = [], V = 'function' == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, x = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, er.__r = 0;
var el, eR, eA, eT, ed = 0,
  eN = [],
  ep = [],
  eO = H,
  ef = eO.__b,
...
eO.__b = function(e) {
  ...
  eS && eS(e), el = 0;
  var t = (eR = e.__c).__H;
  t && (eA === eR ? (t.__h = [], eR.__h = [], t.__.forEach(function(e) {
e.__N && (e.__ = e.__N), e.__V = ep, e.__N = e.i = void 0;
  })) : (t.__h.forEach(eb), t.__h.forEach(eB), t.__h = [], el = 0)), eA = eR;
}, eO.diffed = function(e) {
  eD && eD(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (1 !== eN.push(t) && eT === eO.requestAnimationFrame || ((eT = eO.requestAnimationFrame) || function(e) {
var t, r = function() {
    clearTimeout(n), ev && cancelAnimationFrame(t), setTimeout(e);
  },
  n = setTimeout(r, 100);
ev && (t = requestAnimationFrame(r));
  })(ey)), t.__H.__.forEach(function(e) {
e.i && (e.__H = e.i), e.__V !== ep && (e.__ = e.__V), e.i = void 0, e.__V = ep;
  })), eA = eR = null;
}, eO.__c = function(e, t) {
  t.some(function(e) {
try {
  e.__h.forEach(eb), e.__h = e.__h.filter(function(e) {
    return !e.__ || eB(e);
  });
} catch (r) {
  t.some(function(e) {
...
useErrorBoundary: function(e) {
  var t = eg(el++, 10),
    r = eM();
  return t.__ = e, eR.componentDidCatch || (eR.componentDidCatch = function(e, n) {
    t.__ && t.__(e, n), r[1](e);
  }), [
    r[0],
    function() {
...
useId: function() {
  var e = eg(el++, 11);
  if (!e.__) {
    for (var t = eR.__v; null !== t && !t.__m && null !== t.__;)
      t = t.__;
    var r = t.__m || (t.__m = [
      0,
      0
...
submitButtonLabel: D,
isRequiredLabel: L
  } = e, [h, C] = eM(null), [g, P] = eM(!1), m = c && c.input, [U, G] = eM(null), y = eG(e => {
G(e), P(!1);
  }, []), v = eG(e => {
let t = function(e, t) {
  let r = [];
...
`, e;
    ...
    l = t => {
      ...
      }), a = _, H.__ && H.__(n, a), c = (s = false, E && E.__k || a.__k), I = [], R = [], eE(a, n = (!s && E || a).__k = z(Q, null, [n]), c || F, F, void 0 !== a.ownerSVGElement, !s && E ? [E] : c ? null : a.firstChild ? w.call(a.childNodes) : null, I, !s && E ? E : c ? c.__e : a.firstChild, s, R), n.__d = void 0, es(I, n, R);
    };
  return I;
}
  }),
...
`, e;
        ...
        function O() {
          ...
          let n = u.current;
          n && (n.style.width = `${ t.width }px`, n.style.height = `${ t.height }px`), A({
            startX: 0,
            startY: 0,
            endX: t.width,
            endY: t.height
        ...
        let S = t.useCallback(e => function(t) {
            if (!l.current)
              return;
            let r = l.current,
            ...
            let t = e => {
                ...
                A(a => {
                  let o = Math.max(0, Math.min(a.startX + r, t.width / e3 - (a.endX - a.startX))),
                    ...
                    _ = o + (a.endX - a.startX),
                    E = i + (a.endY - a.startY);
                  return D.current.initialX = e.clientX, D.current.initialY = e.clientY, {
                    startX: o,
                    startY: i,
                    endX: _,
                    endY: E

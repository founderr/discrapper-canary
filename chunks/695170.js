...
var r = n(686942), i = function (e, t, n, r, i, a) {
        ...
        var n = e.getTime() - _(e), r = t.getTime() - _(t);
        ...
        if (!t)
            throw Error('Invalid UNTIL value: '.concat(e));
        ...
        var n = new Date(O(e, Intl.DateTimeFormat().resolvedOptions().timeZone)), r = new Date(O(e, null != t ? t : 'UTC')).getTime() - n.getTime();

...
var r = n(848246), i = n(710845), a = n(380684), o = n(533293), s = n(575691), l = n(474936);
let u = new i.Z('ProductCatalog.tsx'), c = Object.freeze({
    ...
    constructor(e, t) {
        super(e, e => function (e, t) {
            ...
            try {
                ...
                let r = k[n];
                if (null == r)
                    return u.warn('Cannot find the corresponding product catalog entry to the user\'s SKU '.concat(n, ' and premium type ').concat(t.premiumType)), !1;

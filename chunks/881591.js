    ...
    children: [(0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)(C.default, {
        ...
        children: [null == u ? (0, a.jsx)(h.Button, {
          ...
          onClick: () => {
            (0, A.transitionTo)(j.Routes.CHANNEL(null == N ? void 0 : N.getGuildId(), s.channelId, s.messageId))
          },
          size: h.Button.Sizes.MIN,
          color: h.Button.Colors.TRANSPARENT,
          className: P.loadButton,
...
function H() {
  return (0, c.useStateFromStores)([_.default], () => _.default.getMessageReminders().length > 0) ? null : (0, a.jsx)(F.default, {
    Icon: b.default,

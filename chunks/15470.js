...
var n = s(735250), i = s(470079), a = s(120356), r = s.n(a), l = s(302454), o = s.n(l), h = s(481060), d = s(378720), u = s(729035), c = s(73346), p = s(689938), m = s(801608);
function g(e, t, s) {
...
let I = /^!\[([^\]]*)\]\(asset:\/\/(\d+)\)/, C = {
        ...
        assetImage: {
            ...
            match(e, t) {
                let s = e.match(I);
                if (null != s) {
                    let e = s[2], n = t.assets.find(t => t.id === e);
                    return null != n && [
                        ...s,
                        n,
                        t.applicationId
    ...
    }, x = o().parserFor(C), f = o().reactFor(o().ruleOutput(C, 'react'));

...
t.default = r.memo(function(e) {
  ...
  let {
    ...
    onUpdate: S,
    contentRef: h
  } = e, A = s.isEdited(), m = s.state === c.MessageStates.SEND_FAILED, N = s.state === c.MessageStates.SENDING, p = s.isCommandType(), O = null === (t = s.editedTimestamp) || void 0 === t ? void 0 : t.toString(), C = r.useRef(!1);

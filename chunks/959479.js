...
class y extends s.Component {
  ...
  handleDragMove(e, t) {
    ...
    let {
      width: g,
      height: E
    } = S(n, this.size), m = t - h, y = e - f, I = (0, u.fitFullCoordsToContainer)((0, u.getFullCoordsFromAnchorCoords)({
      top: m,
      left: y,
      bottom: null,
      right: null
    }, a, l, g, E)), O = c ? (0, u.getAnchorCoordsFromFullCoords)(I) : v("RESIZE_SOUTH_EAST", I);
    this.setDOMPositions(O), !p && (null != r && r(), this.setState({
      operationStarted: !0

...
s = class extends _.default {
  ...
  _handleReady(e, t, n, i, s, r, a) {
    ...
    let d = ["unk"];
    if (P.default.supports(q.Features.AMD_EXPERIMENTAL_RATE_CONTROL) && d.push("amdRelaxRc"), this.context === q.MediaEngineContextTypes.STREAM) {
      let {
        nvMediumVbvSizeMs: e

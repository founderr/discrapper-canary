...
function eH(e) {
  ...
  return s.useEffect(() => () => T(), [r.enabled, T]), (0, n.jsx)(eu.VideoButtonWrapper, {
    onChange: p,
        ...
        children: (e, l) => {
          ...
          return (0, n.jsx)(_.Tooltip, {
            ...
            children: e => (0, n.jsx)(_.Button, {
              ...
              fullWidth: !0,
              children: I ? o : (0, n.jsxs)(eT.default, {
    ...
    children: e => {
      ...
      return (0, n.jsx)(_.Tooltip, {
        ...
        children: e => (0, n.jsx)(_.Button, {
          ...
          onClick: n => {
            var s;
            g ? a(n) : t(), null === (s = e.onClick) || void 0 === s || s.call(e)
          },
          disabled: !E || o,
          className: i()(ej.button, ej.buttonColor, {
          ...
          innerClassName: ej.buttonContents,
          wrapperClassName: ej.button,
          children: A ? M : (0, n.jsxs)(eT.default, {
            align: eT.default.Align.CENTER,
...
class eW extends s.PureComponent {
  renderConnectionStatus() {
    ...
    return null != a ? (e = eD.Routes.CHANNEL(a.id, t.id), d = "".concat(d, " / ").concat(a.name)) : e = eD.Routes.CHANNEL(eD.ME, t.id), o && t.isBroadcastChannel() && (d = eU.default.Messages.BROADCASTING), (0, n.jsx)(I.default, {
  ...
  renderNoiseCancellation() {
    ...
    return null != s ? null : (null == l ? void 0 : l.isGuildStageVoice()) && !(null != i.find(e => e.user.id === ec.default.getId() && (0, $.getAudienceRequestToSpeakState)(e.voiceState) === $.RequestToSpeakStates.ON_STAGE)) && (0, X.shouldShowStageMusicMuteButton)(l.id) ? (0, n.jsx)(eF, {}) : !a && t ? (0, n.jsx)(_.Tooltip, {

...
class eW extends s.PureComponent {
  ...
  renderNoiseCancellation() {
    ...
    return null != s ? null : (null == l ? void 0 : l.isGuildStageVoice()) && !(null != i.find(e => e.user.id === ec.default.getId() && (0, $.getAudienceRequestToSpeakState)(e.voiceState) === $.RequestToSpeakStates.ON_STAGE)) && (0, X.shouldShowStageMusicMuteButton)(l.id) ? (0, n.jsx)(eB, {}) : !a && t ? (0, n.jsx)(_.Tooltip, {

...
function eG() {
  let e = (0, d.e7)([J.Z], () => J.Z.isMuted()),
    t = e ? eb.Z.Messages.STAGE_MUSIC_UNMUTE : eb.Z.Messages.STAGE_MUSIC_MUTE;
  return (0, i.jsx)(eN.Z, {
    "aria-label": t,
    tooltipText: t,
...
function ew(e) {
  ...
  return s.useEffect(() => () => A(), [l.enabled, A]), (0, i.jsx)(ec.Z, {
    onChange: T,
        ...
        children: (e, a) => {
          ...
          return (0, i.jsx)(I.Tooltip, {
            ...
            children: e => (0, i.jsx)(I.Button, {
              ...
              fullWidth: !0,
              children: C ? o : (0, i.jsxs)(eS.Z, {
                align: eS.Z.Align.CENTER,
                children: [o, eb.Z.Messages.VIDEO]
              })
            })
          })
        }
...
function ek(e) {
  ...
  } = (0, P.ZP)(), l = s === ex.IlC.POPOUT, o = (0, L.KF)(t.id), c = (0, L.g5)(o), [_] = (0, d.e7)([N.ZP], () => null != t.id && "" !== t.id ? N.ZP.getEmbeddedActivitiesForChannel(t.id) : N.i6), {
    userInActivity: E
  } = (0, d.cj)([N.ZP], () => ({
    userInActivity: null != N.ZP.getSelfEmbeddedActivityForChannel(t.id)
  })), h = (0, f.O)(), m = (0, Z.a)(), p = o !== L.jy.CAN_LAUNCH, {
    Component: g,
    events: T
  } = (0, u.s)();
...
function eB(e) {
  ...
  let f = null != T || C.length > 0,
    S = E ? eb.Z.Messages.SHARE_YOUR_SCREEN : eb.Z.Messages.ACTIVITY_PANEL_GO_LIVE_TOOLTIP_NO_PERMISSION_IN_VOICE,
    A = m || l || p,
    Z = null != T,
    {
      Component: L,
      ...
      return (0, i.jsx)(I.Tooltip, {
        ...
        children: e => (0, i.jsx)(I.Button, {
          ...
          children: A ? R : (0, i.jsxs)(eS.Z, {
            align: eS.Z.Align.CENTER,
            children: [R, eb.Z.Messages.GO_LIVE_SHARE_SCREEN]
          })
        })
      })
    }
...
class eH extends s.PureComponent {
  ...
  renderChannelButtons() {
    ...
    return (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsx)(ew, {
        ...
        children: [d ? (0, i.jsx)(ek, {
          channel: e,
          enableActivities: s
        }) : null, (0, Y.Z)(e) ? (0, i.jsx)(W.Z, {
          className: r()(eM.button, eM.buttonColor),
          innerClassName: eM.buttonContents,
  ...
  constructor(...e) {
    super(...e), ey(this, "canScreenshare", () => {
      ...
      if (null != n)(0, el.Z)(n, t.id, ex.Sbl.VOICE_PANEL)
...
function eV(e) {
  ...
  return s.useEffect(() => () => r(), [a, r]), (0, i.jsx)(eN.Z, {
    ...t,
    onMouseEnter: () => {
      var e;
...
t.Z = (0, C.Z)(function(e) {
  let t = (0, j.Z)(),
    ...
    E = (0, d.e7)([eI.Z, B.Z], () => B.Z.hasHotspot(eP.v.VOICE_PANEL_INTRODUCTION) && (0, ev.EO)(a) && !eI.Z.isInteractionRequired() && !(null == o ? void 0 : o.isGuildStageVoice())),
    h = (0, d.e7)([eC.Z], () => null != r && eC.Z.hasVideo(r), [r]),
    m = (0, d.e7)([ed.Z], () => ed.Z.getCurrentUserActiveStream()),
    p = (0, d.e7)([eh.Z], () => eh.Z.hasLayers()),
    g = (0, d.e7)([H.Z], () => H.Z.isViewingRoles(c)),
    T = (0, d.e7)([em.Z], () => g && !em.Z.can(ex.Plq.VIEW_CHANNEL, o), [g, o]),
    C = ee.Fg.useSetting(),
    [f, S, N] = (0, d.Wu)([ef.ZP, z.Z], () => (null == o ? void 0 : o.isGuildStageVoice()) ? [z.Z.getMutableParticipants(o.id, K.pV.SPEAKER), z.Z.getParticipantsVersion(o.id), null] : [null, null, null != o ? ef.ZP.getVoiceStatesForChannel(o) : null], [o]),
    Z = s.useMemo(() => {
      var e, t;
  ...
  } = (0, P.ZP)(x.Z.RTC_PANEL), M = (0, A.Z)(null != c ? c : ex.lds, null == o ? void 0 : o.id), D = (0, v.Z)(null == o ? void 0 : o.id), w = (0, b.ZP)();
  return (0, i.jsx)(P.Gt, {
    value: R,
    children: (0, i.jsxs)("div", {

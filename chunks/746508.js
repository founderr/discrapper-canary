...
function eV(e) {
  ...
  })), C = (0, T.useAnalyticsContext)(), _ = (0, R.useShowActivityIndicator)(), S = o !== O.EmbeddedActivityLaunchability.CAN_LAUNCH, {
    Component: m,
    events: p
...
function eY(e) {
  let t, {
    ...
    S = (0, W.default)(n),
    m = s.useCallback(() => {
      (0, er.default)(C, n.id, ex.AnalyticsSections.ACTIVITY_PANEL)
    }, [C, n.id]),
    p = c.find(e => e.ownerId === (null == u ? void 0 : u.id)),
    I = (0, es.useOtherStreams)(n, u, c);
  t = null == p ? l ? m : ei.default : () => (0, B.default)(p);
...
class eW extends s.PureComponent {
  ...
  renderNoiseCancellation() {
    ...
    return null != s ? null : (null == l ? void 0 : l.isGuildStageVoice()) && !(null != i.find(e => e.user.id === ec.default.getId() && (0, $.getAudienceRequestToSpeakState)(e.voiceState) === $.RequestToSpeakStates.ON_STAGE)) && (0, X.shouldShowStageMusicMuteButton)(l.id) ? (0, a.jsx)(eF, {}) : !n && t ? (0, a.jsx)(h.Tooltip, {
...
function eK(e) {
  let {
    ...
    Component: r,
    events: o
  } = (0, C.useWaveformLottie)(l ? "disable" : "enable");
...
t.default = (0, g.default)(function(e) {
  let t = (0, G.default)(),
    ...
    E = (0, d.useStateFromStores)([eh.default, H.default], () => H.default.hasHotspot(eb.HotspotLocations.VOICE_PANEL_INTRODUCTION) && (0, ey.isNewUser)(l) && !eh.default.isInteractionRequired() && !(null == o ? void 0 : o.isGuildStageVoice())),
    C = (0, d.useStateFromStores)([eI.default], () => null != i && eI.default.hasVideo(i), [i]),
    _ = (0, d.useStateFromStores)([ed.default], () => ed.default.getCurrentUserActiveStream()),
    S = (0, d.useStateFromStores)([eC.default], () => eC.default.hasLayers()),
    m = (0, d.useStateFromStores)([V.default], () => V.default.isViewingRoles(u)),
    p = (0, d.useStateFromStores)([e_.default], () => m && !e_.default.can(ex.Permissions.VIEW_CHANNEL, o), [m, o]),

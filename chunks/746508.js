...
function ew(e) {
    ...
    eN.default.track(eO.rMx.NOISE_CANCELLATION_LINK_CLICKED, {
        text: t.text,
        href: t.href,
...
function ek() {
    ...
    (0, f.useFocusLock)(e),
        r.useEffect(() => {
            eN.default.track(eO.rMx.OPEN_POPOUT, { type: eO.jXE.NOISE_CANCELLATION_POPOUT });
        }, []);
    ...
    return (0, i.jsxs)('div', {
        ...
        children: [
            (0, i.jsx)(f.FormSwitch, {
                ...
                note: eP.intl.string(eP.t.uKdWn5),
                children: eP.intl.string(eP.t.WGWHv7)
            }),
            (0, i.jsx)(C.Z, {
                title: eP.intl.string(eP.t.JdUas7),
                notchBackground: C._.BLACK,
                buttonTest: eP.intl.string(eP.t['sG+MGh']),
                buttonStop: eP.intl.string(eP.t.Yp3SbG),
            ...
            (0, i.jsx)(f.FormTitle, {
                ...
                children: eP.intl.string(eP.t.k6h1Fx)
            }),
            (0, i.jsxs)(M.Z, {
                ...
                children: [
                    ...
                    (0, i.jsx)(f.Anchor, {
                        ...
                        onClick: (e) => ew(e),
                        children: eP.intl.string(eP.t.hvVgAQ)
                    })
                ]
            })
        ]
...
function eU() {
    let e = (0, d.e7)([ee.Z], () => ee.Z.isMuted()),
        t = e ? eP.intl.string(eP.t.ScHlfn) : eP.intl.string(eP.t.zqxfra);
    return (0, i.jsx)(ex.Z, {
        'aria-label': t,
        tooltipText: t,
...
function eG(e) {
    let { channel: t, enableActivities: n, disabled: l } = e,
        s = (0, ei.Z)(),
        o = (0, el.Z)(t),
        c = (0, d.cj)([N.ZP], () => null != N.ZP.getSelfEmbeddedActivityForChannel(t.id)),
        u = (0, W.Z)(t),
        ...
        I = r.useCallback(
            (e) => {
                ...
                let n = () => {
                    var n;
                    _.Z.setVideoEnabled(e), e && (0, z.uL)(eO.Z5c.CHANNEL(null !== (n = t.getGuildId()) && void 0 !== n ? n : eO.ME, t.id));
                };
                e ? (0, ed.Z)(n, E) : n();
            },
            [t, E]
        ...
        C = c || n || u,
        { Component: v, play: S, events: A } = (0, p.o)(s.enabled ? 'disable' : 'enable');
    return (
                                ...
                                (0, i.jsx)(f.Button, {
                                    ...
                                    children: C
                                        ...
                                        : (0, i.jsxs)(M.Z, {
                                              ...
                                              children: [o, eP.intl.string(eP.t.FlNoSU)]
                                          })
                                })
                        });
                    }
...
function eB(e) {
    let t,
        ...
        m = (0, x.KF)(r.id),
        p = (0, x.g5)(m),
        { userInActivity: g } = (0, d.cj)([N.ZP], () => ({ userInActivity: null != N.ZP.getSelfEmbeddedActivityForChannel(r.id) })),
        _ = (0, S.O)(),
        E = (0, b.a)(),
        I = m !== x.jy.CAN_LAUNCH,
        { enabled: C } = P.nS.useExperiment({ location: 'RTCConnection' }, { autoTrackExposure: !0 }),
        { Component: v, events: A, play: Z } = (0, u.s)(),
        { Component: O, events: j, play: D } = (0, h.w)();
...
function eV(e) {
    let t,
        ...
        h = (0, el.Z)(n),
        p = n.getGuildId(),
        g = (0, d.cj)([N.ZP], () => null != N.ZP.getSelfEmbeddedActivityForChannel(n.id)),
        _ = (0, W.Z)(n),
        E = r.useCallback(() => {
            (0, ec.Z)(p, n.id, eO.jXE.ACTIVITY_PANEL);
        }, [p, n.id]),
        I = u.find((e) => e.ownerId === (null == c ? void 0 : c.id)),
        C = (0, ea.E)(n, c, u);
    t = null == I ? (l ? E : eo.Z) : () => (0, B.Z)(I);
    let v = null != I || C.length > 0,
        S = h ? eP.intl.string(eP.t.fjBNo6) : eP.intl.string(eP.t.uQn9Bw),
        T = g || s || _,
        A = null != I,
                ...
                children: (e) =>
                    (0, i.jsx)(f.Button, {
                        ...
                        children: T
                            ...
                            : (0, i.jsxs)(M.Z, {
                                  align: M.Z.Align.CENTER,
                                  children: [L, eP.intl.string(eP.t['r0/+v7'])]
                              })
                    })
            });
        }
    ...
    renderNoiseCancellation() {
        ...
        return null != r
            ...
            : (null == l ? void 0 : l.isGuildStageVoice()) && !(null != a.find((e) => e.user.id === em.default.getId() && (0, et.gf)(e.voiceState) === et.xO.ON_STAGE)) && (0, $.U5)(l.id)
              ...
              : !n && t
                ? (0, i.jsx)(f.Tooltip, {
                      text: eP.intl.string(eP.t['i+SO/f']),
    ...
    constructor(...e) {
        super(...e),
            ...
            eM(this, 'handleGoLive', () => {
                ...
                if (null != n) (0, ec.Z)(n, t.id, eO.Sbl.VOICE_PANEL);
            }),
...
function eF(e) {
    ...
    return (
        ...
        (0, i.jsx)(ex.Z, {
            ...
            tooltipClassName: ej.noiseCancellationTooltip,
            tooltipText: n ? null : eP.intl.string(eP.t.vFiCS0),
            icon: s
        })
    );
}
t.Z = (0, v.Z)(function (e) {
    let t = (0, k.Z)(),
        ...
        m = (0, d.e7)([e_.Z, H.Z], () => H.Z.hasHotspot(eR.v.VOICE_PANEL_INTRODUCTION) && (0, eb.EO)(l) && !e_.Z.isInteractionRequired() && !(null == o ? void 0 : o.isGuildStageVoice())),
        ...
        C = en.Fg.useSetting(),
        [v, S, T] = (0, d.Wu)([eT.ZP, q.Z], () => ((null == o ? void 0 : o.isGuildStageVoice()) ? [q.Z.getMutableParticipants(o.id, X.pV.SPEAKER), q.Z.getParticipantsVersion(o.id), null] : [null, null, null != o ? eT.ZP.getVoiceStatesForChannel(o) : null]), [o]),
        N = r.useMemo(() => {
            var e, t;
            return null !==
                (t =
    ...
    let { analyticsLocations: L } = (0, R.ZP)(O.Z.RTC_PANEL),
        y = (0, A.Z)(null != c ? c : eO.lds, null == o ? void 0 : o.id),
        P = (0, Z.Z)(null == o ? void 0 : o.id);
    return (0, i.jsx)(R.Gt, {
        value: L,
                    ...
                    ? (0, i.jsxs)('div', {
                          ...
                          children: [
                              (0, i.jsx)(f.Text, {
                                  ...
                                  children: I ? eP.intl.string(eP.t.efjuQE) : eP.intl.string(eP.t.br8H2N)
                              }),
                              (0, i.jsx)(f.Button, {
                                  ...
                                  children: eP.intl.string(eP.t.WAI6xs)
                              })
                          ]
                      })
                    : null

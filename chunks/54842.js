...
let L = () => [{
    ...
    body: m.Z.Messages.GUILD_SETTINGS_COMMUNITY_INTRO_UPSELL_DISCOVERY_BODY.format({
      featureHook: (e, t) => (0, s.jsx)("strong", {
    ...
    body: m.Z.Messages.GUILD_SETTINGS_COMMUNITY_INTRO_UPSELL_ANALYTICS_BODY.format({
      infoHook: () => (0, s.jsx)(c.Tooltip, {
        ...
        children: e => (0, s.jsx)(c.CircleInformationIcon, {
          size: "xs",
          color: "currentColor",
...
t.Z = e => {
  let {
    guild: t
  } = e, [n, i] = a.useState(0), [r, o] = a.useState(0), [g, C] = a.useState(), x = (0, l.e7)([_.Z], () => _.Z.can(I.Plq.ADMINISTRATOR, t)), p = null == g ? void 0 : g.offsetWidth, R = null == g ? void 0 : g.offsetHeight;
  a.useEffect(() => {
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsxs)("div", {
      ...
      children: m.Z.Messages.GUILD_SETTINGS_COMMUNITY_INTRO_BODY_WITH_HELP_ARTICLE.format({
        helpdeskArticle: E.Z.getArticleURL(I.BhN.FRIEND_COMMUNITY_DISCOVERABLE_GUILD_TYPES)
      })
    }), (0, s.jsx)(c.Tooltip, {
      ...
      children: m.Z.Messages.GUILD_SETTINGS_COMMUNITY_INTRO_LEARN_MORE.format({
        helpdeskArticle: E.Z.getArticleURL(I.BhN.GUILD_COMMUNITY_FEATURE)
      })
    }), (0, s.jsx)("div", {

...
function F(e, t) {
  return Array.from(e.values()).find(e => k(t, e) && !V(e) && eS({
quest: e
  }));
}
...
function et(e, t) {
  for (let [n, r] of e)
if (!V(r) && r.targetedContent.includes(t))
  return r;
  return null;
}
...
return b.Z.Messages.QUESTS_COMPLETION_PROGRESS_COMPLETE;
...
return t >= 0.75 ? b.Z.Messages.QUESTS_COMPLETION_PROGRESS_ALMOST_COMPLETE : t >= 0.45 && t <= 0.55 ? b.Z.Messages.QUESTS_COMPLETION_PROGRESS_HALFWAY : t > 0 ? b.Z.Messages.QUESTS_COMPLETION_PROGRESS_STARTED : b.Z.Messages.QUESTS_COMPLETION_PROGRESS_NOT_STARTED;
  ...
  return b.Z.Messages.QUESTS_TITLE.format({
...
...(0, i.Z)({
  ...
  return (n.days >= 7 && (n.weeks = Math.floor(n.days / 7), n.days = n.days % 7), n.years > 0) ? b.Z.Messages.DURATION_YEARS.format({
years: n.years
  }) : n.months > 0 ? b.Z.Messages.DURATION_MONTHS.format({
months: n.months
  }) : n.weeks > 0 ? b.Z.Messages.DURATION_WEEKS.format({
weeks: n.weeks
  }) : b.Z.Messages.DURATION_DAYS.format({
days: n.days
  });
}
...
let eg = e => (0, o.EQ)(e.taskConfig).with({
...
configVersion: 2
  }, e => eR(t, y.S7.PLAYTIME_TASK) || eg(e)).exhaustive();
}
...
config: {
  ...
  }, e => null != e.userStatus && (eV(e.userStatus, l.X.PLAY_ON_XBOX) || eV(e.userStatus, l.X.PLAY_ON_PLAYSTATION))).exhaustive();
...
quest: a
  }), c = null != o ? o : null == s ? void 0 : s.platform, d = u ? eC({
quest: a,
...
hasQuestHomeExperiment: a
  ...
  if (i)
return t ? b.Z.Messages.QUESTS_DISCLOSURE_IN_HOUSE_QUEST_BAR : a ? b.Z.Messages.QUESTS_DISCLOSURE_IN_HOUSE_QUEST_HOME : b.Z.Messages.QUESTS_DISCLOSURE_IN_HOUSE;
  return t ? b.Z.Messages.QUESTS_DISCLOSURE_PUBLISHER_TARGETING.format({
gamePublisher: i ? b.Z.Messages.DISCORD : n
  }) : a ? b.Z.Messages.QUESTS_DISCLOSURE_PUBLISHER_PROMOTING_QUEST_HOME.format({
gamePublisher: n,
gameTitle: r

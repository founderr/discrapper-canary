...
F = (0, l.e7)([
  u.Z,
  p.default
], () => (null == D ? void 0 : D.type) === v.IIU.LISTENING && null != H ? (0, h.Z)(u.Z, p.default, H, D) : void 0, [
  D,
  H
], r.Z),
W = a.useCallback(() => {
...
subtitle: z,
badges: null,
children: (null === (t = D.timestamps) || void 0 === t ? void 0 : t.start) != null && (0, i.jsx)(R, {
  activity: D
})
  });
...
children: [
  ...
  (0, i.jsx)(x.St, {
    children: (0, i.jsx)(x.WT, {
      ...
      reactionImageAltText: (n = U, f = H, Z.Z.Messages.ACTIVITY_REACTION_IMAGE_ALT_TEXT_LISTENING.format({
        username: f.username,
        activity: n
      })),
      entry: P,

...
function R(e) {
    ...
    let x, Z, R, {
            ...
            if (null == j || null == B)
                return;
            let t = null === (e = y.timestamps) || void 0 === e ? void 0 : e.start, n = (0, f.T_)(null != t ? { start: t } : L, Date.now());
            return (0, E.CR)({
                user: B,
                channel: j,
                mediaImageSrc: U,
    ...
    let Y = (0, i.jsx)(I.wG, {
        ...
        subtitle: W,
        badges: null,
        children: (null === (t = y.timestamps) || void 0 === t ? void 0 : t.start) != null && (0, i.jsx)(b, { activity: y })
    });

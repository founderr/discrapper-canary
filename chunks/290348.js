...
let w = [];
function F(e) {
    let n = R(e, (e) => (null == e ? w : e.role_benefits.benefits.filter(m.rC)));
    return P(e, 'channelBenefits', n);
}
let G = [];
function k(e) {
    let n = R(e, (e) => (null == e ? G : e.role_benefits.benefits.filter(m.lL)));
...
async function J(e) {
    ...
    let { roleColor: s, roleIcon: c, trialLimit: _, trialInterval: m, tierEmojiIds: E } = a;
    (void 0 !== s || void 0 !== c) &&
...
async function Q(e) {
    ...
    let _ = p === N.I.ALL_CHANNELS_ACCESS,
        m = i;
    null == m && (m = (await g.uw(n, {})).id), null != s && s.length > 0 && (await (0, S.r4)(n, s));
                ...
                if ((n(!0), r(void 0), null != f))
                    l()(null != u, 'groupListingId is null'),
                        await (function (e) {
                            ...
                            l()(null != a, 'edit state does not exist');
                            let { name: s, description: c, channelBenefits: d, intangibleBenefits: f, priceTier: p, image: _, channelAccessFormat: E } = a,
                                I = {};
                            if ((s !== u.name && (I.name = s), c !== u.description && (I.description = c), p !== (null === (n = u.subscription_plans[0]) || void 0 === n ? void 0 : n.price) && (I.priceTier = p), null != _ && (I.image = _), null != E && (I.can_access_all_channels = E === N.I.ALL_CHANNELS_ACCESS), null != d || null != f)) {

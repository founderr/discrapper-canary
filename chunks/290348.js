...
function x(e, n) {
  let t = (0, m.Z)(n, e);
  return M(e, 'roleColor', r.useMemo(() => {
var e;
...
{
  selectedOption: r
} = (0, A.Z)(null !== (n = null == t ? void 0 : t.active_trial) && void 0 !== n ? n : null);
...
handleCreateOrUpdateFromEditState: r.useCallback(async e => {
  ...
  } = e, d = r, _ = S.Z.getSubscriptionListing(d);
  try {

n(47120);
var s = n(392711), a = n.n(s), r = n(710845), i = n(592125), l = n(306680), o = n(709054), c = n(287328);
function d(e, t, n) {
...
t.Z = new class e {
    async getAll(e) {
        let t = performance.now(), n = await c.Z.readStates(e).getMany(), s = performance.now();
    ...
    handleWriteCaches(e, t) {
        ...
        if (t) {
            ...
            if (null == this.readStateVersion)
                return;
            let t = '0', r = '0', l = Object.keys(i.Z.getMutablePrivateChannels()), d = new Set(l);
            for (let e of (r = null !== (s = a()(l).sort(o.default.compare).reverse().value()[0]) && void 0 !== s ? s : '0', n))
                null != e._lastMessageId && (1 === o.default.compare(e._lastMessageId, t) && (t = e._lastMessageId), d.has(e.channelId) && 1 === o.default.compare(e._lastMessageId, r) && (r = e._lastMessageId));

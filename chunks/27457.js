...
let eh = l.memo(e => {
  ...
  let {
    ...
    activated: eP,
    hqStreamingState: eb
  } = (0, L.usePerksDemo)(r.EntitlementFeatureNames.STREAM_HIGH_QUALITY), eD = ej && eP && eb.hqStreamingIsEnabled && eO, eU = (0, o.useStateFromStores)([P.default], () => null != eT ? P.default.getEffectForUserId(eT) : null), eF = (0, o.useStateFromStores)([k.default], () => k.default.getVoicePlatformForChannel(Y.id, null != eT ? eT : er.EMPTY_STRING_SNOWFLAKE_ID)), {
    enableHangStatus: ew
      ...
      children: (0, a.jsxs)(R.default, {
        ...
        children: [(0, a.jsx)(en.default, {
          ...
          children: (0, a.jsxs)(m.ClickableContainer, {
            ...
            children: [c.type === eo.ParticipantTypes.USER && null != eT && null != eU ? (0, a.jsx)(b.default, {
            ...
            }) : null, eX, eD ? (0, a.jsx)(O.PremiumStreamingEffectOverlay, {
              onPlayed: ez,
              played: eb.hqStreamingFrameAnimationPlayed
...
let ep = l.memo(e => {
  ...
  })), R === eo.ParticipantTypes.USER && null != P ? B = (0, a.jsx)(m.Tooltip, {
  ...
  }) : R === eo.ParticipantTypes.USER && null != b && (B = (0, a.jsx)(m.Tooltip, {

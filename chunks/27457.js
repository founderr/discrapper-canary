...
pulseSpeakingIndicator: eC = !1
  } = e, eI = a.useContext(L.h9), [ex, eT] = a.useState(!1), eN = (0, o.e7)([y.default], () => y.default.getId()), ev = (0, o.e7)([w.default], () => w.default.getCurrentUser()), eS = I.type === J.fO.ACTIVITY ? null : null === (t = I.user) || void 0 === t ? void 0 : t.id, [eZ] = (0, p.Z)(I.type === J.fO.ACTIVITY ? [I.id] : []), eA = (0, o.e7)([T.Z], () => T.Z.getEnabled()), eM = (0, o.e7)([k.Z], () => null != eS && k.Z.isLocalVideoDisabled(eS, (0, _.Z)(I.type)), [
eS,
I.type
  ]), eb = (0, o.e7)([k.Z], () => null != eS ? k.Z.getVideoToggleState(eS, (0, _.Z)(I.type)) : Q.ZUi.NONE, [
eS,
I.type
...
let r = (0, o.cj)([B.Z], () => {
    var e, i, a;
    let s = B.Z.getVoiceState(n, t.id);
    return {
  ...
  c = (0, o.cj)([k.Z], () => {
    ...
    return e === i ? {
      ...
      muted: k.Z.isLocalMute(i, n),
      localVideoDisabled: k.Z.isLocalVideoDisabled(i, n),
      localVideoAutoDisabled: k.Z.isLocalVideoAutoDisabled(i, n)
    };
  }, [
    e,
    t
...
return {
  ...
  }(eN, I, er.getGuildId()), ey = I.type === J.fO.STREAM && eS === eN, eD = (0, V.So)(r.q.STREAM_HIGH_QUALITY), ek = (0, b.j$)(), eU = eD && ey, ew = (0, M.o)(I, ev), eB = (0, A.lL)('CallTile', !0, ev, ew), eH = eB.persistentQualityIndicator && eB.enabled, eG = (0, o.e7)([P.Z], () => null != eS ? P.Z.getEffectForUserId(eS) : null), eV = (0, o.e7)([B.Z], () => B.Z.getVoicePlatformForChannel(er.id, null != eS ? eS : Q.lds)), {
enableHangStatus: eF
  } = C.n.useExperiment({
guildId: er.guild_id,
location: 'VoiceUsers'
...
hangStatusActivity: eF && null != eS ? U.Z.findActivity(eS, e => e.type === Q.IIU.HANG_STATUS) : null,
gameActivity: ez && null != eS ? U.Z.findActivity(eS, e => null != e.application_id && e.type === Q.IIU.PLAYING) : null
  }), [
eF,
eS,
ez
  ]), eq = (0, o.e7)([D.Z], () => (null == eK ? void 0 : eK.application_id) != null ? D.Z.getDetectableGame(eK.application_id) : null), eX = (0, o.e7)([m.Z], () => null != eq && (null == eK ? void 0 : eK.application_id) != null ? m.Z.getApplication(null == eK ? void 0 : eK.application_id) : void 0), eQ = (0, j.wV)({
userId: eS,
channelId: er.id,
location: 'CallTile'
  });
    ...
    children: [
      (0, i.jsx)(z.Z, {
        ...
        children: (0, i.jsxs)(u.ClickableContainer, {
          ...
          children: [
            I.type === J.fO.USER && null != eS && null != eG ? (0, i.jsx)(O.Z, {
...
secureFramesVerified: P
  } = e, O = null, y = null, D = null, U = null, w = (0, q.K)(m), B = (0, q.N)(m), H = (0, o.e7)([k.Z], () => null != Z && k.Z.isLocalVideoAutoDisabled(Z, (0, _.Z)(S)), [
Z,
S
  ]), G = (0, u.useRedesignIconContext)().enabled;
  if (!v) {
if (a && S === J.fO.STREAM && p && !T)
  O = (0, i.jsx)(u.Tooltip, {
  ...
  return f && k.Z.supports(ee.AN.VIDEO) || !p ? f && p && g && !H && (y = (0, i.jsx)(u.VideoSlashIcon, {
size: 'md',
color: 'currentColor',
...
size: 'md',
color: 'currentColor'
  }), S === J.fO.STREAM && !T && p && (D = (0, i.jsx)(u.Tooltip, {

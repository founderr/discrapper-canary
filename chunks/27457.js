...
eS,
ez
  ]), eq = (0, o.e7)([y.Z], () => (null == eK ? void 0 : eK.application_id) != null ? y.Z.getDetectableGame(eK.application_id) : null), eX = (0, o.e7)([m.Z], () => null != eq && (null == eK ? void 0 : eK.application_id) != null ? m.Z.getApplication(null == eK ? void 0 : eK.application_id) : void 0), eQ = (0, R.wV)({
userId: eS,
channelId: er.id,
location: 'CallTile'
  });
...
secureFramesVerified: P
  } = e, O = null, y = null, k = null, U = null, w = (0, q.K)(m), B = (0, q.N)(m), H = (0, o.e7)([D.Z], () => null != Z && D.Z.isLocalVideoAutoDisabled(Z, (0, _.Z)(S)), [
Z,
S
...
if (a && S === J.fO.STREAM && p && !T)
  ...
  return f && D.Z.supports(ee.AN.VIDEO) || !p ? f && p && C && !H && (y = (0, i.jsx)(u.VideoSlashIcon, {
size: 'md',
color: 'currentColor',
...
size: 'md',
color: 'currentColor'
  }), S === J.fO.STREAM && !T && p && (k = (0, i.jsx)(u.Tooltip, {

...
class eN extends a.PureComponent {
  ...
  handleSystemChannelFlagsChange(e, t) {
    let {
      guild: n
    } = this.props, s = (0, Y.mB)(n.systemChannelFlags, e, t);
    K.Z.updateGuild({
      ...
      children: [(0, s.jsxs)(w.Z, {
        ...
        children: [(0, s.jsxs)(w.Z.Child, {
          ...
          children: [(0, s.jsx)(U.Z, {
            ...
            imageClassName: r()(en.avatarUploaderInner, {
          ...
          children: [(0, s.jsx)(I.FormText, {
            ...
            children: [et.Z.Messages.UPLOAD_IMAGE, (0, s.jsx)(b.ZP, {
  ...
  renderAFKSection() {
    ...
    let {
      ...
      value: eo,
      label: et.Z.Messages.DURATION_MINUTES.format({
        minutes: 1
      })
    }, {
      value: ec,
      ...
      value: e_,
      label: et.Z.Messages.DURATION_HOURS.format({
        hours: 1
      })
    }], o = d()(a).filter(e => {
      let {
  ...
  renderJoinNotificationSection() {
    ...
    let c = (0, M.eI)(t),
      u = c || (0, Y.yE)(t.systemChannelFlags, Q.xmn.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATIONS),
      _ = c || (0, Y.yE)(t.systemChannelFlags, Q.xmn.SUPPRESS_ROLE_SUBSCRIPTION_PURCHASE_NOTIFICATION_REPLIES);
    return (0, s.jsxs)(I.FormSection, {
      className: en.divider,
      children: [(0, s.jsx)(I.FormTitle, {
        children: et.Z.Messages.FORM_LABEL_SYSTEM_CHANNEL
        ...
        children: (0, s.jsxs)("div", {
          ...
          children: [et.Z.Messages.FORM_HELP_SYSTEM_CHANNEL_DEADCHAT_PROMPT_MESSAGE, (0, s.jsx)(f.Z, {})]
        })
      })]
    })
  }
  renderNotificationSection() {
    ...
    return (0, s.jsx)("div", {
      ...
      children: (0, s.jsxs)(I.FormSection, {
        className: en.divider,
        children: [(0, s.jsx)(I.FormTitle, {
          children: et.Z.Messages.FORM_LABEL_DEFAULT_NOTIFICATION_SETTINGS
        }), (0, s.jsx)(I.FormText, {
          type: I.FormTextTypes.DESCRIPTION,
          className: en.marginBottom20,
    ...
    return (0, m.Jc)(e, !1) ? (0, s.jsx)("div", {
      children: (0, s.jsx)(I.FormSection, {
        ...
        children: (0, s.jsx)(I.FormSwitch, {
          ...
          hideBorder: !0,
          note: et.Z.Messages.GUILD_SETTINGS_SUMMARIES_TOGGLE_DESCRIPTION.format({
            helpdeskArticle: z.Z.getArticleURL(Q.BhN.CONVERSATION_SUMMARIES)
          }),
          disabled: !t,
          children: (0, s.jsxs)("div", {
            className: en.badgedItem,
            children: [et.Z.Messages.GUILD_SETTINGS_SUMMARIES_TOGGLE, (0, s.jsx)(I.TextBadge, {
          ...
          children: [(0, s.jsxs)(w.Z.Child, {
            ...
            children: [(0, s.jsxs)(I.FormTitle, {
              ...
              children: [(0, s.jsx)("div", {
                children: et.Z.Messages.GUILD_SETTINGS_SERVER_INVITE_BACKGROUND
              }), (0, s.jsx)(L.Z, {
                guild: e,
              ...
              type: I.FormTextTypes.DESCRIPTION,
              children: et.Z.Messages.GUILD_SETTINGS_SPLASH_RECOMMEND.format({
              ...
              children: [et.Z.Messages.UPLOAD_BACKGROUND, (0, s.jsx)(b.ZP, {
                disabled: !a,
                onChange: this.handleSplashChange,
                maxFileSizeBytes: ee.B,
                onFileSizeError: () => (0, j.Z)(ee.B)
      ...
      children: (0, s.jsxs)(w.Z, {
        ...
        children: [(0, s.jsxs)(w.Z.Child, {
          ...
          children: [(0, s.jsxs)(I.FormTitle, {
            className: en.flexFormTitle,
            children: [(0, s.jsx)("div", {
              children: et.Z.Messages.FORM_LABEL_SERVER_BANNER
            }), (0, s.jsx)(L.Z, {
              guild: e,
            ...
            type: I.FormTextTypes.DESCRIPTION,
            children: et.Z.Messages.GUILD_SETTINGS_BANNER_RECOMMEND.format({
  ...
  constructor(...e) {
    super(...e), ei(this, "_imageInputRef", a.createRef()), ei(this, "_displaySectionRef", a.createRef()), ei(this, "_inviteSectionRef", a.createRef()), ei(this, "_notificationSectionRef", a.createRef()), ei(this, "handleIconChange", e => {
      ...
      e ? n.add(Q.oNc.SUMMARIES_ENABLED_BY_USER) : n.delete(Q.oNc.SUMMARIES_ENABLED_BY_USER), K.Z.updateGuild({
        features: n
      })
...
function eS() {
  ...
  let d = (0, u.e7)([P.Z], () => P.Z.getCategories(null == t ? void 0 : t.id)),
    ...
    T = (0, u.e7)([B.Z], () => B.Z.getMemberCount(null == t ? void 0 : t.id)),
    m = (0, u.e7)([k.default], () => k.default.getCurrentUser());

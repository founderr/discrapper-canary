...
t.Z = {
	[c.Etm.GET_IMAGE]: {
		...
		handler(e) {
			let t,
				{
					args: { type: n, id: l, format: o = 'png', size: d = 128 }
				} = e;
			if ('user' === n) {
				...
				} else throw new r.Z({ errorCode: c.lTL.INVALID_USER }, 'Invalid user id: '.concat(l));
			}
			if (null == t) throw new r.Z({ errorCode: c.lTL.INVALID_COMMAND }, 'No valid type.');
			return fetch(t)
				.then((e) => e.blob())
				.then((e) => (0, s.fD)(e))
				.then((e) => ({ data_url: e }));

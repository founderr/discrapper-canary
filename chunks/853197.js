...
function E(e) {
  if (e.dropsQuestId === d.oL) return c.a;
  return null
}
...
function N(e, t) {
  let {
    endDate: n
  } = e, i = a()(), s = a()(n, d.fS), l = a()(i.clone().add(e.dropsNoticeBannerDurationDays, "days").format(d.fS)), r = s.isSameOrBefore(l), o = s.isBefore(i, "minute");
  return r && (t && !o || !t && o)
}

...
var r, i, a, o, s, l, u, c, d = n(286379), _ = n(524437), E = n(432877), f = n(768494), h = n(797614), p = n(182274), m = n(695346), I = n(592125), T = n(699516), g = n(594174), S = n(626135), A = n(630388), N = n(948561), v = n(651530), O = n(719548), R = n(981631), C = n(973005);
n(689938);
let y = {
        ...
        return {
            explicitContentGuilds: M({ setting: null == e ? void 0 : e.explicitContentGuilds }),
...
function j(e) {
    ...
    }), h.Z.distribution({ name: d.V.EXPLICIT_MEDIA_SCAN_CLIENT_TIMED_OUT_DISTRIBUTION }, (null !== (r = null == s ? void 0 : s.length) && void 0 !== r ? r : 0) + (null !== (i = null == l ? void 0 : l.length) && void 0 !== i ? i : 0));
}
function W(e) {
    let {
        channelId: t,
    ...
    let s = r + a;
    s > 0 && h.Z.distribution({ name: d.V.EXPLICIT_MEDIA_PENDING_MESSAGE_LOADED_V2 }, s);
}
function K(e) {
    let {
        messageId: t,
...
function z(e) {
    let t = e.attachments.map(e => (null == e.content_scan_version && (e.content_scan_version = -1), e)), n = (e = e.set('attachments', t)).embeds.map(e => (null == e.contentScanVersion && (e.contentScanVersion = -1), e));

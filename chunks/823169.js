n(47120);
var i = n(570140), s = n(317770), a = n(430824), r = n(594174), l = n(358085), o = n(53365), c = n(981631);
class d extends s.Z {
    _initialize() {
    ...
    constructor(...e) {
        ...
        super(...e), t = this, n = 'maybeFetchEligiblity', i = async () => {
            if ((0, l.isDesktop)() || (0, l.isWeb)()) {
                let e = Object.values(a.Z.getGuilds()), t = r.default.getCurrentUser(), n = e.filter(e => e.isOwner(t) && !e.hasFeature(c.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE) && !e.hasFeature(c.oNc.CREATOR_MONETIZABLE_RESTRICTED) && !e.hasFeature(c.oNc.CREATOR_MONETIZABLE_DISABLED) && (e.hasFeature(c.oNc.CREATOR_MONETIZABLE) || e.hasFeature(c.oNc.CREATOR_MONETIZABLE_PROVISIONAL)));

...
var r = n(836560), i = n(259443), a = n(740197), o = n(106617), s = n(290488), l = n(830795), u = n(65154), c = n(231338);
function d(e, t, n) {
...
let _ = new i.Y('Output'), E = new o.Z();
class f extends r.EventEmitter {
    ...
    getDelayedStream() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0.2, t = this.context;
        if (null == this.stream)
            throw Error('AudioInput: No MediaStream');
        ...
        try {
            ...
            if (this._noiseCancellation)
                try {
                    ...
                    let n = this.context.createMediaStreamSource(e), r = this.context.createMediaStreamDestination();
    ...
    setPTTActive(e) {
        if (!this.mute && this.speaking !== e)
            null != this.pttReleaseDelayTimeout && (window.clearTimeout(this.pttReleaseDelayTimeout), this.pttReleaseDelayTimeout = void 0), e ? this.setSpeaking(e) : this.pttReleaseDelayTimeout = window.setTimeout(() => {
    ...
    setupVoiceActivity(e) {
        let {threshold: t} = e;
        if (null == this.stream)
            throw Error('stream cannot be null');
        null == t && (t = -40);

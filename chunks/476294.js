...
let o = (e, t) => {
  ...
  let f = (null == d ? void 0 : d.type) === s.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_1,
    E = (null == d ? void 0 : d.type) === s.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_2;
  return {
    isTier1: f,
    isTier2: E
  }

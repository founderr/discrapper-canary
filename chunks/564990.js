        ...
        try {
            let e = (
                    await r.tn.get({
                        ...
                        ...(n === o.YN.GAME_PROFILE_FEED && { query: { for_game_profile: !0 } })
                    })
                ).body,
    ...
    d = async (e, t, n) => {
        try {
            i.Z.dispatch({ type: 'CONTENT_INVENTORY_DELETE_OUTBOX_ENTRY_START' }),
                await r.tn.del({ url: s.ANM.DELETE_MY_CONTENT_INVENTORY_OUTBOX_ENTRY_HISTORY(e.id) }),
                i.Z.dispatch({
            ...
            var a, o;
            let e = null !== (o = null == t ? void 0 : null === (a = t.body) || void 0 === a ? void 0 : a.message) && void 0 !== o ? o : l.Z.Messages.USER_ACTIVITY_DELETE_HISTORY_ERROR;
            i.Z.dispatch({

...
var i = n(735250), a = n(470079), l = n(120356), s = n.n(l), r = n(481060), o = n(923726), c = n(689938), d = n(311271);
function u(e) {
    let {
        text: t,
        hasScrolled: n
    ...
    return (0, i.jsxs)('div', {
        className: s()(d.container, { [d.containerHide]: n }),
        children: [
            (0, i.jsx)('div', {
                className: d.notice,
...
function h(e) {
    let [t, n] = a.useState(), [l, s] = a.useState(), [r, d] = a.useState(!1), [h, p] = a.useState(!1), {enabled: m} = (0, o.s1)(e);
    return a.useEffect(() => {

...
function g(e) {
    ...
    let { context: s, devicePixelRatio: o, canvasHeight: l, segmentValue: u, segmentIndex: c, constrainMin: d } = e,
        _ = d ? (24 - m) * u + m : 24 * u;
    if (0 !== _) (t = s), (n = 6 * c * o), (r = (l / 2 - _ / 2) * o), (i = _ * o), (a = 1 * o), t.moveTo(n, r + a), t.lineTo(n, r + i - a), t.arc(n + a, r + i - a, a, Math.PI, 0, !0), t.lineTo(n + 2 * a, r + a), t.arc(n + a, r + a, a, 0, Math.PI, !0), t.closePath();
}
function A(e, t, n) {
...
function R(e) {
    let { className: t, waveform: n, currentTime: a, duration: d, played: m, playing: R, onDrag: O, onDragStart: v, onDragEnd: C } = e,
        { ref: L, width: D } = (0, u.Z)(),
        y = i.useMemo(() => {
            var e;
            let t;
            ...
            let n = i.useMemo(
                    () =>
                        (function (e) {
                            ...
                            let n = [];
                            for (let e = 0; e < t.length; e++) n[e] = t.charCodeAt(e) / f.Xi;
                            return n;
                        })(e),
                    [e]
                ),
        ...
        i.useEffect(() => {
            ...
            return (
                (e = requestAnimationFrame(function t(n) {
                    ...
                    let s = !1;
                    (P.current !== m || U.current !== R) && ((P.current = m), (U.current = R), (w.current = n)), null != w.current && n > w.current + 200 && (w.current = null);
                    let o = r.height / x;

...
var s = a(735250), n = a(470079), o = a(481060), d = a(782568), l = a(53365), r = a(377176), _ = a(577275), c = a(153124), E = a(981631), O = a(829857), i = a(689938), T = a(941882);
function N(e) {
    let {
        selectedTeamId: t,
    ...
    return (0, s.jsx)('div', {
        ...
        children: 0 === n.length ? (0, s.jsx)(o.Text, {
...
function A(e) {
    let {
            ...
            onClose: A,
            transitionState: u
        } = e, h = (0, c.Dt)(), [M, x] = n.useState(), [I, m] = n.useState(!1), {teams: R} = (0, _.Z)(), f = R.filter(e => e.payout_account_status === O.C.ACTIVE), C = n.useMemo(() => f.map(e => ({
            label: e.name,
            value: e.id
        })), [f]), p = n.useCallback(() => {
        ...
        children: [
            ...
            (0, s.jsx)(o.ModalFooter, {
                ...
                children: (0, s.jsx)('div', {
                    className: T.buttons,
                    children: a && 0 === C.length ? (0, s.jsx)(o.Button, {
                        onClick: p,

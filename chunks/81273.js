...
t.default = (e, t, n, i) => {
  ...
  let D = (0, o.useStateFromStores)([C.default], () => C.default.isLurking(t)),
    ...
    Q = null == w || null != k,
    V = (0, L.useSubscriptionListingsForGroup)(n, {
    ...
    K = (0, L.useSubscriptionTrial)(null == e ? void 0 : e.id),
    {
  ...
  let ee = a.useCallback(async () => {
      ...
      if (l()(null != e, "No subscription listing"), l()(null != b, "No subscription plan"), l()(G, "Cannot purchase this unpublished plan"), (null == K ? void 0 : K.active_trial) != null) {
        ...
        analyticsLocations: J,
        analyticsLocation: i,
        renderHeader: (n, a, i) => (0, s.jsx)(M.Header, {
          onClose: a,
          listing: e,
          step: i,
          guildId: t
        ...
        skuId: b.sku_id,
        planGroup: V,
        renderPurchaseConfirmation: (n, a) => $ ? (0, s.jsx)(O.PurchaseConfirmationLite, {
          listing: e,
          onClose: a,
          guildId: t
        }) : (0, s.jsx)(M.PurchaseConfirmation, {
          listing: e,
          onClose: a,
          guildId: t
        }),

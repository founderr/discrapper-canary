...
var s = i(735250), l = i(470079), o = i(442837), t = i(692547), r = i(481060), a = i(239091), d = i(233440), c = i(314897), u = i(158776), I = i(699516), _ = i(998502), f = i(785717), E = i(621853), m = i(204197), S = i(735336), Z = i(520978), x = i(184325), v = i(652853), h = i(225714), p = i(228168), T = i(231338), g = i(689938), N = i(520067);
...
function A(e) {
    let {
            ...
            hasProfileEffect: L,
            onClose: P
        } = e, b = (0, o.e7)([I.Z], () => I.Z.getRelationshipType(_.id)), y = (0, o.e7)([u.Z], () => u.Z.isMobileOnline(_.id)), D = (0, o.e7)([u.Z], () => u.Z.getStatus(_.id)), F = (0, o.e7)([E.Z], () => E.Z.getUserProfile(_.id)), B = (0, o.e7)([c.default], () => c.default.getId() === _.id), {theme: G} = (0, v.z)(), {trackUserProfileAction: w} = (0, f.KZ)(), {
            avatarSrc: k,
            eventHandlers: V,

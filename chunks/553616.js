...
c = Math.max(a, o, s),
u = c - i;
  return c === i ? t = 0 : a === c ? t = (o - s) / u : o === c ? t = 2 + (s - a) / u : s === c && (t = 4 + (a - o) / u), (t = Math.min(60 * t, 360)) < 0 && (t += 360), n = (i + c) / 2, [
t,
100 * (r = c === i ? 0 : n <= 0.5 ? u / (c + i) : u / (2 - c - i)),
100 * n
  ];
}, s.rgb.hsv = function(e) {
  var t, r, n, a, o, s = e[0] / 255,
i = e[1] / 255,
c = e[2] / 255,
u = Math.max(s, i, c),
l = u - Math.min(s, i, c),
b = function(e) {
  ...
  return 0 === l ? a = o = 0 : (o = l / u, t = b(s), r = b(i), n = b(c), s === u ? a = n - r : i === u ? a = 1 / 3 + t - n : c === u && (a = 2 / 3 + r - t), a < 0 ? a += 1 : a > 1 && (a -= 1)), [
360 * a,
100 * o,
100 * u
  ];
...
a = s.rgb.hsl(e)[0];
  return [
a,
1 / 255 * Math.min(t, Math.min(r, n)) * 100,
...
n = e[2] / 255;
  return [
100 * (0.4124 * (t = t > 0.04045 ? Math.pow((t + 0.055) / 1.055, 2.4) : t / 12.92) + 0.3576 * (r = r > 0.04045 ? Math.pow((r + 0.055) / 1.055, 2.4) : r / 12.92) + 0.1805 * (n = n > 0.04045 ? Math.pow((n + 0.055) / 1.055, 2.4) : n / 12.92)),
...
return [
  ...
  r = c < 0.5 ? c * (1 + i) : c + i - c * i, t = 2 * c - r, a = [
0,
0,
0
  ];
  for (var u = 0; u < 3; u++)
(n = s + -(1 / 3 * (u - 1))) < 0 && n++, n > 1 && n--, o = 6 * n < 1 ? t + (r - t) * 6 * n : 2 * n < 1 ? r : 3 * n < 2 ? t + (r - t) * (2 / 3 - n) * 6 : t, a[u] = 255 * o;
  return a;
...
o = n,
s = Math.max(a, 0.01);
  return a *= 2, n *= a <= 1 ? a : 2 - a, o *= s <= 1 ? s : 2 - s, t = (a + n) / 2, [
r,
100 * (0 === a ? 2 * o / (s + o) : 2 * n / (a + n)),
100 * t
  ];
...
s = e[2] / 100,
i = Math.max(s, 0.01);
  return n = (2 - o) * s, t = (2 - o) * i, r = (r = o * i / (t <= 1 ? t : 2 - t)) || 0, [
a,
100 * r,
100 * (n /= 2)
  ];
}, s.hwb.rgb = function(e) {
  var t, r, n, a, o, s, i, c = e[0] / 360,
u = e[1] / 100,
l = e[2] / 100,
b = u + l;
  switch (b > 1 && (u /= b, l /= b), t = Math.floor(6 * c), r = 1 - l, n = 6 * c - t, (1 & t) != 0 && (n = 1 - n), a = u + n * (r - u), t) {
default:
case 6:
case 0:
  o = r, s = a, i = u;
...
o = e[1] / 100,
s = e[2] / 100;
  return t = 3.2406 * a + -1.5372 * o + -0.4986 * s, r = -0.9689 * a + 1.8758 * o + 0.0415 * s, n = 0.0557 * a + -0.204 * o + 1.057 * s, t = t > 0.0031308 ? 1.055 * Math.pow(t, 1 / 2.4) - 0.055 : 12.92 * t, r = r > 0.0031308 ? 1.055 * Math.pow(r, 1 / 2.4) - 0.055 : 12.92 * r, n = n > 0.0031308 ? 1.055 * Math.pow(n, 1 / 2.4) - 0.055 : 12.92 * n, [
...
r = e[1],
n = e[2];
  return t /= 95.047, r /= 100, n /= 108.883, t = t > 0.008856 ? Math.pow(t, 1 / 3) : 7.787 * t + 16 / 116, [
...
r,
n = (u > 0.008856 ? u : (n - 16 / 116) / 7.787) * 108.883
  ];
...
t
  ...
  var t, r, n = e[0],
a = e[1];
  return t = a * Math.cos(r = e[2] / 360 * 2 * Math.PI), [
n,
t,
a * Math.sin(r)
  ];
...
return [
  ...
  var n = Math.floor((e -= 16) / 36) / 5 * 255,
a = Math.floor((t = e % 36) / 6) / 5 * 255;
  return [
n,
a,
t % 6 / 5 * 255
...
a = e[1] / 255,
o = e[2] / 255,
s = Math.max(Math.max(n, a), o),
i = Math.min(Math.min(n, a), o),
c = s - i;
  return t = c < 1 ? i / (1 - c) : 0, [
360 * (r = (c <= 0 ? 0 : s === n ? (a - o) / c % 6 : s === a ? 2 + (o - n) / c : 4 + (n - a) / c + 4) / 6 % 1),
100 * c,
100 * t
  ];
...
n = 1,
a = 0;
  return (n = r < 0.5 ? 2 * t * r : 2 * t * (1 - r)) < 1 && (a = (r - 0.5 * n) / (1 - n)), [
e[0],
100 * n,
100 * a
  ];
...
r = e[2] / 100 * (1 - t) + 0.5 * t,
n = 0;
  return r > 0 && r < 0.5 ? n = t / (2 * r) : r >= 0.5 && r < 1 && (n = t / (2 * (1 - r))), [
e[0],
100 * n,
100 * r
  ];

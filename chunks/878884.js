t(47120), t(724458);
var r, u, l, i, c = t(286379), a = t(442837), o = t(570140), s = t(642047), d = t(797614), f = t(413402), C = t(189786), Z = t(5192), E = t(592125), g = t(19780), h = t(594174), N = t(979651), I = t(938475), S = t(981631), T = t(354459);
let _ = new s.Z(), m = new s.Z(), p = new Set(), v = !1;
function y(e, n, t) {
    let r = new C.Z({
            userId: e.id,
            channelId: t
...
function O(e) {
    let n = _.delete(e), t = m.delete(e), r = p.delete(e);
    return n || t || r;
}
function D() {
    var e;
    ...
    if (null == n)
        return !1;
    let t = null === (e = E.Z.getChannel(n)) || void 0 === e ? void 0 : e.getGuildId(), r = !1;
    return p.forEach(e => {
...
i = 'RTCConnectionDesyncStore', (l = 'displayName') in (u = V) ? Object.defineProperty(u, l, {
    ...
    VOICE_STATE_UPDATES: function (e) {
        let {voiceStates: n} = e, t = g.Z.getChannelId();
    ...
    RTC_CONNECTION_CLIENT_CONNECT: function (e) {
        ...
        return n.reduce((e, n) => {
            ...
            return null == u ? (null == t && v && d.Z.increment({ name: c.V.RTC_CONNECTION_DESYNC_STORE_UNKNOWN_USER }), p.add(n), e) : (y(u, t, r), !0);
        }, !1);
    },

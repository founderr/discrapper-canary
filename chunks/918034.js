...
function o(e) {
  ...
  return (0, i.jsxs)(i.Fragment, {
    children: [!n && (0, i.jsx)(a.MenuItem, {
      ...
      action: () => (0, l.markAsInappropriateConversation)(e.id, r.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_1)
    }), !o && (0, i.jsx)(a.MenuItem, {
      id: "mark-as-tier-2-inappro",
      label: u.default.Messages.INAPPROPRIATE_CONVERSATION_MARK_AS_TIER_2,
      action: () => (0, l.markAsInappropriateConversation)(e.id, r.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_2)
    })]
  })
}
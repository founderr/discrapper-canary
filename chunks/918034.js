...
function E(e) {
  ...
  let I = (null == E ? void 0 : E.type) === s.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_1,
    T = (null == E ? void 0 : E.type) === s.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_2;

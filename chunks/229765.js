...
var i = n(108131), s = n.n(i), a = n(544891), r = n(570140), l = n(10473), o = n(976757), c = n(981631);
let d = new Worker(new URL(n.p + n.u('59546'), n.b));
function u() {
    return r.Z.dispatch({ type: 'FETCH_STATIC_CLAN_LIST_START' }), a.tn.get({ url: c.ANM.DISCOVERY_ALL_GAMES }).then(e => {
...
async function _(e) {
    ...
    if ('loaded' === l.Z.getSearchResult(e).status)
        return;
    let a = s().v3(JSON.stringify(e)), o = l.Z.getStaticClans();

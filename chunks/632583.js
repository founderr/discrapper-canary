...
let l = 'currentColor',
    u = 'url(#nitro_hover)',
    c = 'url(#birthday_gradient_1_light)',
    d = 'url(#birthday_gradient_2_light)',
    _ = 'url(#birthday_gradient_3_light)',
    E = 'url(#birthday_secondary_gradient_1_light)',
    f = 'url(#birthday_secondary_gradient_2_light)',
    h = 'url(#birthday_secondary_gradient_3_light)',
    p = new Map([
    ...
    I = (e) => {
        let { referralsRemaining: t, fillColor: n, secondaryFillColor: r } = e;
    ...
    g = (e, t, n, r, i) => {
        if (!t || r) return e ? u : l;
        let a = n ? [...m.keys()].filter((e) => e !== i) : [...p.keys()].filter((e) => e !== i),
            o = Math.floor(Math.random() * a.length);
        return a[o];
    };
function S(e) {
    var t;
    let { width: n = 31, height: r = 22, referralsRemaining: u, isResending: c, hovered: d, shouldShowBirthdayUX: _, isLightTheme: E, ...f } = e,
        [h, m] = a.useState(l),
        S = null !== (t = p.get(h)) && void 0 !== t ? t : null;
    return (
        a.useEffect(() => {
            d ? m((e) => g(d, _, E, c, e)) : c && m(l);
        }, [d, _, E, c]),
        (0, i.jsxs)('svg', {
            width: n,
            height: r,
            ...
            children: [
                c
                    ? (0, i.jsx)(T, { fillColor: h })
                    : (0, i.jsx)(I, {
                          referralsRemaining: u,
                          fillColor: d ? h : l,
                          secondaryFillColor: d ? S : null
                      }),
                (0, i.jsxs)('defs', {
                    children: [
                        (0, i.jsxs)('linearGradient', {
                            ...
                            children: [
                                (0, i.jsx)('stop', { stopColor: o.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE.css }),
                                (0, i.jsx)('stop', {
                                    offset: '1',
                        ...
                        (0, i.jsxs)('linearGradient', {
                            ...
                            gradientUnits: 'userSpaceOnUse',
                            children: [
                                (0, i.jsx)('stop', { 'stop-color': '#FF52D2' }),
                                (0, i.jsx)('stop', {
                                    offset: '1',
                                    'stop-color': '#5665F9'
                                })
                        ...
                        (0, i.jsxs)('linearGradient', {
                            ...
                            gradientUnits: 'userSpaceOnUse',
                            children: [
                                (0, i.jsx)('stop', { 'stop-color': '#8547C6' }),
                                (0, i.jsx)('stop', {
                                    offset: '0.52899',
                                    'stop-color': '#B845C1'
                                }),

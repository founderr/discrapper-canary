...
var r = n(735250), i = n(470079), a = n(692547), o = n(325767);
let s = 'currentColor', l = new Map([
        [
            'url(#birthday_gradient_1)',
            'url(#birthday_secondary_gradient_1)'
        ],
        [
            'url(#birthday_gradient_2)',
            'url(#birthday_secondary_gradient_2)'
        ],
        [
            'url(#birthday_gradient_3)',
            'url(#birthday_secondary_gradient_3)'
        ]
    ]), u = new Map([
        [
            'url(#birthday_gradient_1_light)',
            'url(#birthday_secondary_gradient_1_light)'
        ],
        [
            'url(#birthday_gradient_2_light)',
            'url(#birthday_secondary_gradient_2_light)'
        ],
        [
            'url(#birthday_gradient_3_light)',
            'url(#birthday_secondary_gradient_3_light)'
        ]
    ]), c = e => {
        let {
        ...
        let a = n ? [...u.keys()].filter(e => e !== i) : [...l.keys()].filter(e => e !== i), o = Math.floor(Math.random() * a.length);
        return a[o];
    };
function E(e) {
    var t;
    ...
    return i.useEffect(() => {
        ...
        children: [
            f ? (0, r.jsx)(d, { fillColor: T }) : (0, r.jsx)(c, {
                referralsRemaining: E,
                fillColor: h ? T : s,
            ...
            (0, r.jsxs)('defs', {
                children: [
                    (0, r.jsxs)('linearGradient', {
                        ...
                        children: [
                            (0, r.jsx)('stop', { stopColor: a.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE.css }),
                            (0, r.jsx)('stop', {
                                offset: '1',
                    ...
                    (0, r.jsxs)('linearGradient', {
                        ...
                        gradientUnits: 'userSpaceOnUse',
                        children: [
                            (0, r.jsx)('stop', { 'stop-color': '#FF52D2' }),
                            (0, r.jsx)('stop', {
                                offset: '1',
                                'stop-color': '#5665F9'
                            })

...
var r, i, a = n(836560), o = n(936349), s = n(709054), l = n(981631);
...
class u extends a.EventEmitter {
    ...
    voiceStateUpdate(e) {
        ...
        null != n && o.Z.shouldIncludePreferredRegion() && (d.preferred_region = s, d.preferred_regions = l), null != u && (d.tracks = null == u ? void 0 : u.map(e => ({
            type: e.type,
            rid: e.rid,
            quality: e.quality
        }))), this.send(4, d);

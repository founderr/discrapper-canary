...
var r, i, a, o = n(392711), s = n.n(o), l = n(108131), u = n.n(l), c = n(149765), d = n(442837), _ = n(570140), E = n(353926), f = n(700785), h = n(199902), p = n(314897), m = n(592125), I = n(650774), T = n(271383), g = n(430824), S = n(158776), A = n(885110), N = n(594174), v = n(981631), O = n(689938);
function R(e, t, n) {
...
function D(e, t, n, r) {
    ...
    default:
        let i = g.Z.getGuild(e), a = null != i ? g.Z.getRole(i.id, t) : null;
        return {
            type: 'GROUP',
            key: t,
            id: t,
...
function L(e, t, n) {
    let r = n === p.default.getId(), i = S.Z.isMobileOnline(n), a = r ? A.Z.getStatus() : S.Z.getStatus(n, e), o = r ? A.Z.getActivities() : S.Z.getActivities(n, e), s = h.Z.getStreamForUser(n, e), l = N.default.getUser(n);
    return null == l ? null : {
        type: 'MEMBER',
        ...T.ZP.getMember(e, n),
        user: l,
...
let w = [];
function x() {
    let e = h.Z.getAllApplicationStreams(), t = w.concat(e);
    w = e, t.forEach(e => {

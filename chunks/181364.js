...
var i = n(735250);
n(470079);
var s = n(13245), a = n(237997), o = n(454902), r = n(312839), l = n(987650), c = n(689938);
let d = () => ({
        icon: n(328756),
    ...
    }), u = e => (0, o.QR)(e, (0, r.P)(), c.Z.Messages.OVERLAY_LAUNCH_OPEN_TIP);
function h(e) {
    let {type: t} = e, {
            icon: n,
            title: u,
    ...
    return {
        ...
        onNotificationClick: (e, n) => {
            m('unlock'), t === l.nc.NEWS && s.Z.updateNotificationStatus(n), a.Z.isInstanceUILocked() && s.Z.setInstanceLocked(!1);
        },
        onDismissClick: () => {
            m('dismiss');
        }

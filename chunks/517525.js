n(47120);
var i = n(735250), a = n(470079), l = n(120356), s = n.n(l), r = n(920906), o = n(468194), c = n(442837), d = n(692547), u = n(477690), h = n(481060), p = n(2052), m = n(906732), _ = n(484459), f = n(594174), E = n(368666), C = n(626135), g = n(74538), I = n(557457), x = n(475674), T = n(981631), N = n(474936), v = n(689938), S = n(102572);
let Z = (0, o.Mg)(u.Z.LIVE_INDICATOR_BORDER_RADIUS), A = {
    ...
    }, b = { opacity: 0 }, R = { opacity: 1 }, j = { borderRadius: ''.concat(Z, 'px ').concat(Z, 'px ').concat(Z, 'px ').concat(Z, 'px') }, L = { borderRadius: '0px '.concat(Z, 'px ').concat(Z, 'px 0px') }, P = {
        mass: 1,
        tension: 500,
        friction: 18,
        clamp: !0
        ...
        let t, l, {
                ...
                className: M,
                premiumIndicator: b
            } = e, R = (0, I.Wc)(r), {analyticsLocations: j} = (0, m.ZP)(), L = null != (0, x.Z)(r);
        try {
            t = (0, I.nG)(R);
        } catch (e) {
            t = !1;
        ...
        let P = t || l, {location: O} = (0, p.O)(), y = (0, c.e7)([f.default], () => f.default.getCurrentUser()), D = o && !g.ZP.isPremium(y, N.p9.TIER_1) && !g.ZP.canStreamQuality(g.ZP.StreamQuality.MID, y), k = a.useCallback(() => {

...
let Z = (0, o.Mg)(d.Z.LIVE_INDICATOR_BORDER_RADIUS),
  ...
  O = e => {
    ...
    if (a.useEffect(() => {
      ...
      }, [t, l, P, Z, A, j]), null == R) return null;
    let U = (0, i.jsx)(h.Tooltip, {
      ...
      children: e => (0, i.jsxs)(h.Clickable, {
        ...e,
        onClick: k,
        className: s()(S.qualityIndicator, _, E.eE[d], L ? S.qualityIndicatorLowQuality : S.qualityIndicatorFullQuality, {
          [S.clickable]: D && P
        }),
        children: [P ? (0, i.jsx)(h.NitroWheelIcon, {
          size: "md",
          color: "currentColor",

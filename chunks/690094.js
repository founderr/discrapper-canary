var a = r(364510), n = r(114170), s = [].slice, o = [
        'keyword',
        'gray',
        'hex'
    ], i = {};
...
u.prototype = {
    ...
    string: function (e) {
        var t = this.model in a.to ? this : this.rgb(), r = 1 === (t = t.round('number' == typeof e ? e : 1)).valpha ? t.color : t.color.concat(this.valpha);
    ...
    grayscale: function () {
        var e = this.rgb().color, t = 0.3 * e[0] + 0.59 * e[1] + 0.11 * e[2];
        return u.rgb(t, t, t);
    },
    fade: function (e) {
    ...
    mix: function (e, t) {
        ...
        var r = e.rgb(), a = this.rgb(), n = void 0 === t ? 0.5 : t, s = 2 * n - 1, o = r.alpha() - a.alpha(), i = ((s * o == -1 ? s : (s + o) / (1 + s * o)) + 1) / 2, c = 1 - i;

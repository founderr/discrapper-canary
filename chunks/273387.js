...
l = 'GuildDirectoryStore', (s = 'displayName') in(a = g) ? Object.defineProperty(a, s, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
...
if (null == o || (null === (t = m[l]) || void 0 === t ? void 0 : t[o.guildId]) != null)
  return;
m[l] = {
  ...m[l],
  [o.guildId]: o
...
let {
  channelId: i,
  guildId: a
} = e, s = null === (t = m[i]) || void 0 === t ? void 0 : t[a];
if (null == s)
  return;
...
let {
  channelId: h,
  entry: p
} = e, E = (0, c.MQ)(p), g = null === (t = m[h]) || void 0 === t ? void 0 : t[E.guildId];
m[h] = {
  ...m[h],
  [E.guildId]: {
    ...g,

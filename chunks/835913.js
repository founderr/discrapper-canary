...
var r = n(230367), i = n(320215), a = n(240773), o = n(660284), s = n(69122), l = n(495852);
class u extends l.C {
    now() {
        let e = this.create(), t = Date.now();
    ...
    internalBinaryRead(e, t, n, i) {
        let a = null != i ? i : this.create(), o = e.pos + t;
        for (; e.pos < o;) {
            let [t, i] = e.tag();
            switch (t) {
            case 1:

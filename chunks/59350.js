...
function ee(e) {
    ...
    let { guild: t, user: i } = e,
        ...
        C = (0, u.Wu)([j.ZP], () => j.ZP.getMemberRoleWithPendingUpdates(t.id, i.id)),
...
function en(e) {
    ...
    let { prompt: t, guild: i } = e,
        ...
        f = null == t ? void 0 : null === (n = t.options) || void 0 === n ? void 0 : n.filter((e) => d.has(e.id)),
        C = (0, y.L6)(f),
        p = (0, y.dX)(f),
        x = (0, u.Wu)([P.Z], () => P.Z.getOnboardingResponsesForPrompt(i.id, t.id)),

...
function en(e) {
  ...
  return (0, l.jsx)(l.Fragment, {
    children: (0, l.jsxs)(c.animated.div, {
      ...
      children: [t.isNew && (0, l.jsx)(_.TextBadge, {
...
function el(e) {
  ...
  }, [n, t]), h = (0, u.e7)([R.ZP], () => R.ZP.hasUnread(n, q.W.GUILD_ONBOARDING_QUESTION)), {
  ...
  }, [null == s ? void 0 : s.id, h]), a.useEffect(() => {
    if ((null == s ? void 0 : s.id) != null) {
      if (!I.Z.isFullServerPreview(s.id)) return () => {
  ...
  return (0, l.jsx)("div", {
    ...
    children: (0, l.jsxs)(_.AdvancedScroller, {
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [(g.length > 0 || b.length > 0) && (0, l.jsxs)(l.Fragment, {
          children: [(0, l.jsx)("div", {
            children: (0, l.jsx)(_.Heading, {
              variant: "heading-md/semibold",
              color: "header-primary",

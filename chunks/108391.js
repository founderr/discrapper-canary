...
(a = l || (l = {}))[a.NONE = 0] = "NONE", a[a.CONTINUATION = 1] = "CONTINUATION", a[a.BEGINNING_OF_STREAM = 2] = "BEGINNING_OF_STREAM", a[a.END_OF_STREAM = 4] = "END_OF_STREAM";
class r {
  appendBytes(e) {
  ...
  addPage(e) {
    ...
    this._buffer.set([255 & s, s >> 8 & 255, s >> 16 & 255, s >> 24 & 255], a), this._pageSequenceNumber++
  }
  finalize(e) {
    this.addPage({
      pageType: 4,
...
function u(e, t) {
  ...
  for (let t of (i.addPage({
    ...
    let e = function(e) {
      ...
      for (let l = 0; l <= t; l++) {
        let i = 0 === l ? 0 : 255 * l,
          a = l === t ? e.length : (l + 1) * 255;
        n.push(e.slice(i, a))
      }
      return n
    }(t.buffer);
    a += t.numSamples, i.addPage({
      pageType: 0,
      granulePosition: a,
      segments: e
    })

...
function _(e) {
  let {
    ...
    className: n,
    ..._
  } = e, I = i.useRef(null), x = (0, a.e7)([E.ZP], () => E.ZP.getFocusedLayout() === p.MI.RESIZABLE), T = i.useCallback(() => {
    let e = x ? p.MI.NO_CHAT : p.MI.RESIZABLE;
    (0, m.gC)(e)
  }, [x]), {
    unreadCount: N,
    mentionCount: Z
  ...
  let M = (0, a.e7)([E.ZP], () => E.ZP.getFocusedLayout()),
    R = Z > 0 ? Z : N,
    j = R > 0;
  return (0, l.jsxs)("div", {
    className: C.wrapper,
    children: [(0, l.jsx)(c.d, {
      ...
      "aria-label": A.join(", "),
      tooltipPosition: "top",
      iconComponent: M === p.MI.NO_CHAT ? r.ChevronLargeUpIcon : r.ChevronLargeDownIcon,
      themeable: !0,
      className: n,
      ..._
    }), j ? (0, l.jsx)(o.Z, {

...
var r = n(392711), i = n.n(r), a = n(846519), o = n(509848), s = n(483019), l = n(945689), u = n(981631);
function c(e, t, n) {
...
class _ {
    ...
    _subscribeToFeature(e, t, n) {
        if (d(e)) {
            if (!t.has(e))
                t.add(e), this._enqueue(e, n);
        }
    }
    constructor(e) {
        c(this, '_members', new s.Z((e, t) => this._enqueue(e, { members: t }))), c(this, '_channels', new o.ZP((e, t) => this._enqueue(e, { channels: t }))), c(this, '_threadMemberLists', new l.Z((e, t) => this._enqueue(e, { thread_member_lists: t }))), c(this, '_typing', new Set()), c(this, '_threads', new Set()), c(this, '_activities', new Set()), c(this, '_memberUpdates', new Set()), c(this, '_subscribed', new Set()), c(this, '_pending', {}), c(this, '_flush', new a.sW(0, () => this.flush())), c(this, '_onChange', void 0), this._onChange = e;
    }
}

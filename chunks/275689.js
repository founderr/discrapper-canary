...
class d {
  constructor(e = {}) {
this._traceId = e.traceId || (0, n.DM)(), this._spanId = e.spanId || (0, n.DM)().substring(16), this._startTime = e.startTimestamp || (0, a.ph)(), this._attributes = {}, this.setAttributes({
  [I.S3]: 'manual',
  [I.$J]: e.op,
  ...e.attributes
...
if (!this._endTime)
  this._endTime = (0, u.$k)(e), (0, R.w)(this), this._onSpanEnded();
  }
  getSpanJSON() {
return (0, o.Jr)({
...
return !!this._isStandaloneSpan;
  ...
  _onSpanEnded() {
let e = (0, _.s3)();
if (e && e.emit('spanEnd', this), !(this._isStandaloneSpan || this === (0, u.Gx)(this)))
  return;
if (this._isStandaloneSpan) {
  ...
  }((0, s.uE)([this], e)) : (E.X && i.kg.log('[Tracing] Discarding standalone span because its trace was not chosen to be sampled.'), e && e.recordDroppedEvent('sample_rate', 'span'));
  return;
}
...
let {
  scope: e,
  isolationScope: t
} = (0, T.I1)(this), r = (e || (0, _.nZ)()).getClient() || (0, _.s3)();
if (!0 !== this._sampled) {
...
let n = (0, u.Dp)(this).filter(e => e !== this && ! function(e) {
    return e instanceof d && e.isStandaloneSpan();
  }(e)).map(e => (0, u.XU)(e)).filter(p),

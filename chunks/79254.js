...
function R(e) {
  ...
  function V() {
    ...
    null != a && (s = a[1], n = a[2], e = a[3], s += a[4]), (0, _.promptToUpload)([(0, S.makeFile)(new Blob([e], {
      type: "text/plain"
    }), "message.".concat(n))], t, O), g.ComponentDispatch.dispatchToLastSubscribed(M.ComponentActions.CLEAR_TEXT), "" !== s && g.ComponentDispatch.dispatchToLastSubscribed(M.ComponentActions.INSERT_TEXT, {
      plainText: s
    })
  }

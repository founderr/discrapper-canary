...
function D(e) {
  ...
  } = (0, c.useManageResourcePermissions)(null != D ? D : t), F = V(M), H = (0, v.default)(M), B = (0, h.useIsChannelPublic)(null == D ? void 0 : D.id, M.id), {
    withinStartWindow: w
  } = (0, p.getEventTimeData)(y), k = (0, u.useStateFromStores)([I.default], () => (null == D ? !void 0 : !D.isGuildVocal()) || I.default.can(R.Permissions.CONNECT, D), [D]), j = (0, s.useShowMemberVerificationGate)(b), Y = (0, C.default)(U, O);
  ...
  return {
    ...
    onRsvpClick: K,
    onStartClick: F && w && !(null == Y ? void 0 : Y.is_canceled) ? function(e) {
    ...
    onInviteClick: function(e) {
      if (e.stopPropagation(), null != t) {
        if (!H || !B) {
          ...
          (0, T.copy)(e), S.default.track(R.AnalyticEvents.GUILD_SCHEDULED_EVENT_LINK_COPIED, {
            guild_id: b,

...
class i extends n.MessageType {
  ...
  internalBinaryRead(e, _, E, t) {
    ...
    for (; e.pos < i;) {
      ...
      switch (_) {
        case 1:
          o.versions = a.Versions.internalBinaryRead(e, e.uint32(), E, o.versions);
          break;
        case 2:
          o.favoriteGifs = T.internalBinaryRead(e, e.uint32(), E, o.favoriteGifs);
          break;
        case 3:

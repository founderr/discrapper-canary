...
var r = n(512722), i = n.n(r), a = n(933557), o = n(660199), s = n(763296), l = n(592125), u = n(430824), c = n(699516), d = n(914010), _ = n(594174), E = n(51144), f = n(887490);
function h(e, t) {
    let {
            mode: n,
...
function p(e, t) {
    ...
    null == s && (s = d ? '\n' : '');
    let _ = null !== (n = null == a ? void 0 : a.path[0]) && void 0 !== n ? n : 0, E = null !== (r = null == o ? void 0 : o.path[0]) && void 0 !== r ? r : e.length - 1;
    if (u)
        for (let t = E; t >= _; t--) {
            let n = e[t];
            if (f.LC.isText(n)) {
    ...
    let h = _ > 0 && f.aj.isType(e[_ - 1], 'blockQuote'), p = f.aj.isType(e[_], 'blockQuote'), I = f.aj.isType(e[E], 'blockQuote'), T = [];
    for (let t = _; t <= E; t++) {
        let n = e[t];
...
function m(e, t) {
    ...
    case 'testInlineVoid':
        return '';
    case 'blockQuote': {
            let n = p(e.children, t), i = null != r && 1 === r.path.length && 0 === r.path[0] && 0 === r.offset;
            if (h && (null == r || i))
                return '> '.concat(n);
            return n;
        }
    ...
    case 'customEmoji': {
            let t = e.emoji;
            if ('raw' === n) {
                let e = t.animated ? 'a' : '', n = t.name.replace(/:/g, '').split('~')[0];
    ...
    case 'roleMention': {
            ...
            if ('raw' === n)
                return t;
            let r = d.Z.getGuildId(), i = null != r ? u.Z.getRole(r, e.roleId) : void 0;
            if (null == i)
                return t;

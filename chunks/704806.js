...
var r, i = n(442837), a = n(570140), o = n(353926), s = n(626135), l = n(358085), u = n(998502);
function c(e, t, n) {
...
let d = { hashes: {} };
async function _() {
    if (!l.isPlatformEmbedded || !(0, l.isWindows)())
        return [];
...
async function E() {
    try {
        ...
        for (let {
            ...
            s.default.track(t, r), (d = { hashes: { ...d.hashes } }).hashes[t] = n;
...
class f extends (r = i.ZP.PersistedStore) {
    initialize(e) {
        d = null != e && 'object' == typeof e.hashes ? e : { hashes: {} }, this.waitFor(o.Z);
    }
    getState() {
        return d;
    }

...
var r = n(182823), i = n(882932), a = n(470079), o = n(612001), s = n(251433), l = n(616073), u = n(706682);
let c = new WeakMap();
function d(e, t) {
    let n = c.get(e);
    if (!n)
...
function _(e, t, n) {
    ...
    let {direction: h} = (0, l.bU)(), {
        ...
        } = (0, r.xi)(), I = (0, a.useRef)(null), T = 'rtl' === h, g = (0, a.useRef)(null), {moveProps: S} = (0, o.r_)({
            onMoveStart() {
                g.current = null;
            },
            onMove({
            ...
            if (n.current && !e.isDisabled && t.values.every((e, n) => !t.isThumbDragging(n))) {
                let e, {
                        ...
                        top: u,
                        left: c
                    } = n.current.getBoundingClientRect(), d = ((f ? o : a) - (f ? u : c)) / (f ? s : l);
                ('rtl' === h || f) && (d = 1 - d);
                let _ = t.getPercentValue(d), E = t.values.findIndex(e => _ - e < 0);
...
function E(e, t) {
    ...
    let {
            ...
            trackRef: p,
            inputRef: m,
            orientation: I = t.orientation,
            name: T
        } = e, g = e.isDisabled || t.isDisabled, S = 'vertical' === I, {direction: A} = (0, l.bU)(), {
            addGlobalListener: N,
        ...
        }), y = t.values[_], D = (0, a.useCallback)(() => {
            m.current && (0, r.Ao)(m.current);
        }, [m]), L = t.focusedThumb === _;
    (0, a.useEffect)(() => {
        L && D();
    }, [
        L,
    ...
    let b = 'rtl' === A, M = (0, a.useRef)(null), {keyboardProps: P} = (0, o.v5)({
            onKeyDown(e) {
                let {
                    getThumbMaxValue: n,
                    getThumbMinValue: r,
    ...
    let {focusableProps: w} = (0, u.kc)((0, r.dG)(e, {
            onFocus: () => t.setFocusedThumb(_),
            onBlur: () => t.setFocusedThumb(void 0)
        }), m), x = (0, a.useRef)(void 0), G = e => {

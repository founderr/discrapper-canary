...
a[e.displayName] = e, !i.has(e.name) && s.add(e.displayName);
  let o = null;
...
if ('line' === i.type || 'applicationCommand' === i.type)
  for (let u = 0; u < i.children.length; u++) {
    ...
    if (d.aj.isType(f, 'applicationCommandOption')) {
      if (null != o) {
        var l;
        o.valueRange.focus = null !== (l = d.bN.before(e, h)) && void 0 !== l ? l : d.bN.start(e, []), o.text = (0, c.sk)(n, {
          mode: 'raw',
          range: o.valueRange
    ...
    if (!!d.LC.isText(f))
      for (E.lastIndex = 0; null != (_ = E.exec(f.text));) {
        ...
        null != o && (o.valueRange.focus = d.keyRange.anchor, o.text = (0, c.sk)(n, {
          mode: 'raw',
          range: o.valueRange
        }).trim(), r.push(o)), o = d;
      }
  ...
  return null != o && (o.valueRange.focus = d.bN.end(e, []), o.text = (0, c.sk)(n, {
mode: 'raw',
range: o.valueRange
  }).trim(), r.push(o)), r;
}
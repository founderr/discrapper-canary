...
function b(e) {
  let {
    ...
    ...I
  } = e, f = (0, l.e7)([g.default], () => g.default.getCurrentUser()), {
  ...
  let O = n.useCallback(async () => {
    let e = 0,
      i = 0,
      a = 0,
      n = x.Z.getInviteSuggestionRows().filter(e => S.includes(e.item.id)).map(t => (function(t, n) {
        switch (t.type) {
          case A.bm.DM:
          case A.bm.FRIEND:
            e++;
  ...
  return (0, a.jsxs)(r.ModalRoot, {
    ...
    children: [(0, a.jsxs)(r.ModalHeader, {
      ...
      children: [(0, a.jsx)(r.Heading, {
        ...
        children: D.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_ACTIVITY_WITH.format({
...
function w(e) {
  ...
  return n.useEffect(() => {
    ...
    children: [o ? (0, a.jsx)(r.CircleCheckIcon, {
      size: "md",
      color: "currentColor"
    }) : (0, a.jsx)(r.LinkIcon, {
      size: "md",

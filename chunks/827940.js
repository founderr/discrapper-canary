...
var a = i(735250), n = i(470079), s = i(990547), l = i(442837), r = i(481060), o = i(493683), c = i(247272), d = i(904245), u = i(100527), m = i(906732), p = i(213609), I = i(43267), f = i(933557), h = i(430824), x = i(751771), C = i(699516), g = i(594174), N = i(626135), E = i(768581), S = i(572004), A = i(971130), T = i(624138), v = i(51144), _ = i(778569), Z = i(981631), j = i(245335), D = i(689938), y = i(997520);
function b(e) {
    let {
            activityItem: t,
            analyticsLocations: i,
            ...I
        } = e, f = (0, l.e7)([g.default], () => g.default.getCurrentUser()), {analyticsLocations: h} = (0, m.ZP)(i);
    (0, p.Z)({
    ...
    let [C, E] = n.useState(''), [S, T] = n.useState([]), v = (0, _.Z)({
            applicationId: t.application.id,
            size: 256
        }), b = ''.concat(window.location.origin).concat(Z.Z5c.ACTIVITY_DETAILS(t.application.id)), M = (0, l.Wu)([x.Z], () => x.Z.getInviteSuggestionRows());
    n.useEffect(() => {
        (0, c.x)({
            omitUserIds: new Set(),
            applicationId: t.application.id,
    ...
    }, [t.application.id]), n.useEffect(() => (0, c.C)(C), [C]);
    let O = n.useCallback(async () => {
        let e = 0, i = 0, a = 0, n = x.Z.getInviteSuggestionRows().filter(e => S.includes(e.item.id)).map(t => function (t, n) {
                switch (t.type) {
                case A.bm.DM:
                case A.bm.FRIEND:
                    e++;
        ...
        await n, N.default.track(Z.rMx.ACTIVITY_BOOKMARK_SHARED, {
...
function k(e) {
    ...
    case A.bm.FRIEND:
        ...
        }), l = v.ZP.getName(t.item), o = v.ZP.getUserTag(t.item);
        break;
    case A.bm.GROUP_DM: {
            let e = (0, I.x)(t.item), i = (0, f.F6)(t.item, g.default, C.Z);
            s = (0, a.jsx)(r.Avatar, {
                src: e,
                'aria-label': i,
                size: r.AvatarSizes.SIZE_40
    ...
    case A.bm.CHANNEL: {
            let e = t.item, i = h.Z.getGuild(e.guild_id);
            if (null == i)
                return null;
...
function w(e) {
    let {
            applicationId: t,
            link: i
        } = e, s = (0, l.e7)([g.default], () => g.default.getCurrentUser()), [o, c] = n.useState(!1);
    return n.useEffect(() => {
        let e;

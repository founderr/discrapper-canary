...
t === W.$Ab.ENABLED && !k.isPlatformEmbedded && b.Z.showNotification(n(185672), z.Z.Messages.NOTIFICATION_TITLE_DISCORD, z.Z.Messages.BROWSER_NOTIFICATIONS_ENABLED_BODY, {
...
if (null == n || null == u || null == i || null == a || !(0, w.LL)(n, a, u) || !m.Z.can(l.$e(W.Plq.CONNECT, W.Plq.VIEW_CHANNEL), u) || j.has(t.id))
  return !1;
j.add(t.id), b.Z.showNotification(i.getIconURL(128), z.Z.Messages.STAGE_START_PUSH_NOTIFICATION_TITLE.format({
  guildName: i.name
...
t.notification_type === x.sy.EVENT_START && (t.entity_type === x.WX.STAGE_INSTANCE || t.entity_type === x.WX.VOICE ? ! function(e) {
  ...
  if (null == n || null == u || null == i || null == a || !m.Z.can(l.$e(W.Plq.CONNECT, W.Plq.VIEW_CHANNEL), u))
    return !1;
  b.Z.showNotification(i.getIconURL(128), z.Z.Messages.GUILD_SCHEDULED_EVENT_STAGE_START_TITLE.format({
    guildName: i.name
  ...
  if (null == t || null == n)
    return !1;
  b.Z.showNotification(n.getIconURL(128), z.Z.Messages.GUILD_SCHEDULED_EVENT_STAGE_START_TITLE.format({
    guildName: n.name
    ...
    onClick() {
      d.Z.transitionToGuildSync(e.guild_id), (0, f.bO)({
        eventId: e.id
      });
    }
  });
...
return !en() && null != n && null != i && null != u && (b.Z.showNotification(t, n, i, {
  notif_type: u
}, {
  onClick() {
    null != l && (0, A.uL)(l);
...
if (!(!a.K.get(Q, !1) && k.isPlatformEmbedded && (e || t)))
  return !1;
let i = !1;
return null != $ && (i = ee.includes($)), !!i && (b.Z.showNotification(n(95045), z.Z.Messages.NOTIFICATION_TITLE_DISCORD, z.Z.Messages.NOTIFICATION_BODY_DISCORD_HIDDEN, {

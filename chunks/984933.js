  ...
  return M[e] = n, b[e] = [], ! function(e) {
    ...
    function(e) {
      ...
      e[L].forEach(e => {
        let {
          channel: i
        } = e, r = (0, E.computeChannelName)(i, C.default, O.default), s = Object.prototype.hasOwnProperty.call(n, r) ? n[r] : null;
...
class X extends(i = d.default.Store) {
  initialize() {
    this.waitFor(N.default, m.default, A.default, p.default, h.default, c.default, I.default), this.syncWith([I.default], Z)
  }
  getAllGuilds() {
    return M
  }

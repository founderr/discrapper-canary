...
n(592093);
var a = n(1108), o = n(144613), s = n(512722), l = n(510610);
function u(e, t) {
    return null == e ? t : e;
}
var c = function (e) {
    ...
    return !function (e, t) {
        ...
        },
        {
            key: 'onUpdate',
            value: function () {
                var e = this._lastPosition, t = this._lastVelocity, n = this._lastPosition, r = this._lastVelocity, i = Date.now();
                i > this._lastTime + 64 && (i = this._lastTime + 64);
                for (var o = Math.floor((i - this._lastTime) / 1), s = 0; s < o; ++s) {
                    var l = 0.001, u = t, c = this._tension * (this._toValue - n) - this._friction * r, n = e + u * l / 2, r = t + c * l / 2, d = r, _ = this._tension * (this._toValue - n) - this._friction * r;
                    n = e + d * l / 2;
                    var E = r = t + _ * l / 2, f = this._tension * (this._toValue - n) - this._friction * r;
                    n = e + E * l / 2;
                    var h = r = t + f * l / 2, p = this._tension * (this._toValue - n) - this._friction * r;
                    n = e + E * l / 2, r = t + f * l / 2;
                    var m = (c + 2 * (_ + f) + p) / 6;
                ...
                if (this._lastTime = i, this._lastPosition = e, this._lastVelocity = t, this._onUpdate(e), !!this.__active) {
                    ...
                    var T = Math.abs(t) <= this._restSpeedThreshold, g = !0;

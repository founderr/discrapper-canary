...
function A(e) {
    let { totalSize: t, backAvatarSize: n, frontAvatarSize: r, backAvatarCenter: a, frontAvatarCenter: o, strokeMaskRadius: s } = e;
    ...
    return (0, i.jsxs)('mask', {
        ...
        children: [
            ...
            (0, i.jsx)('rect', {
                ...
                width: (n.status * u.jR + 2 * n.stroke) / a,
                height: c / a,
                rx: c / 2 / a,
                ry: c / 2 / a
            })
    ...
    return (0, i.jsxs)('mask', {
        ...
        children: [
            ...
            (0, i.jsx)('rect', {
                ...
                y: (n.size - n.status * l.EW - n.stroke - n.offset) / n.size,
                width: (n.status + 2 * n.stroke) / n.size,
                height: (n.status * l.EW + 2 * n.stroke) / n.size,
                rx: ((n.status * l.EW + 2 * n.stroke) * l.ZC) / n.size,
                ry: ((n.status * l.EW + 2 * n.stroke) * l.ZC) / n.size
            })
        ]
    });
}
function U(e, t) {
    let n = (0, l.UC)(t),
        ...
        a = E((n.size - n.status * l.EW - n.stroke - n.offset) / n.size),
        o = (n.status + 2 * n.stroke) / n.size / c.hs,
        s = (n.status * l.EW + 2 * n.stroke) / n.size / c.hs;
    return (0, i.jsxs)('mask', {
        id: e,
        maskContentUnits: 'objectBoundingBox',
        viewBox: '0 0 1 1',
...
function J(e) {
    let { mask: t, width: n = _, height: r = _, rightOverhang: a = 0, bottomOverhang: o = 0, children: l, className: u, style: c, 'aria-label': E, ...f } = e;
    return (0, i.jsx)('svg', {
        width: n + a,
        height: r + o,
        className: s()(d.svg, u),
        viewBox: '0 0 '.concat(n + a, ' ').concat(r + o),
        style: c,
        'aria-label': E,
        ...f,
    ...
    function () {
        return (0, i.jsxs)('svg', {
            ...
            children: [
                ...
                g('svg-mask-voice-user-summary-item'),
                C('svg-mask-vertical-fade'),
                T('svg-mask-panel-button'),
                p('svg-mask-channel-call-control-button'),
                m('svg-mask-channel-call-control-button-badge-16', 16),
                m('svg-mask-channel-call-control-button-badge-22', 22),
                m('svg-mask-channel-call-control-button-badge-29', 29),
                y('svg-mask-avatar-default'),
                b('svg-mask-avatar-status-round-16', l.EF.SIZE_16),
                L('svg-mask-avatar-decoration-status-round-16', l.EF.SIZE_16),
                P('svg-mask-avatar-status-mobile-16', l.EF.SIZE_16),
                U('svg-mask-avatar-decoration-status-mobile-16', l.EF.SIZE_16),
                D('svg-mask-avatar-status-typing-16', l.EF.SIZE_16),
                M('svg-mask-avatar-decoration-status-typing-16', l.EF.SIZE_16),
                b('svg-mask-avatar-status-round-20', l.EF.SIZE_20),
                L('svg-mask-avatar-decoration-status-round-20', l.EF.SIZE_20),
                P('svg-mask-avatar-status-mobile-20', l.EF.SIZE_20),
                U('svg-mask-avatar-decoration-status-mobile-20', l.EF.SIZE_20),
                D('svg-mask-avatar-status-typing-20', l.EF.SIZE_20),
                M('svg-mask-avatar-decoration-status-typing-20', l.EF.SIZE_20),
                b('svg-mask-avatar-status-round-24', l.EF.SIZE_24),
                L('svg-mask-avatar-decoration-status-round-24', l.EF.SIZE_24),
                P('svg-mask-avatar-status-mobile-24', l.EF.SIZE_24),
                U('svg-mask-avatar-decoration-status-mobile-24', l.EF.SIZE_24),
                D('svg-mask-avatar-status-typing-24', l.EF.SIZE_24),
                M('svg-mask-avatar-decoration-status-typing-24', l.EF.SIZE_24),
                b('svg-mask-avatar-status-round-32', l.EF.SIZE_32),
                L('svg-mask-avatar-decoration-status-round-32', l.EF.SIZE_32),
                P('svg-mask-avatar-status-mobile-32', l.EF.SIZE_32),
                U('svg-mask-avatar-decoration-status-mobile-32', l.EF.SIZE_32),
                D('svg-mask-avatar-status-typing-32', l.EF.SIZE_32),
                M('svg-mask-avatar-decoration-status-typing-32', l.EF.SIZE_32),
                b('svg-mask-avatar-status-round-40', l.EF.SIZE_40),
                L('svg-mask-avatar-decoration-status-round-40', l.EF.SIZE_40),
                P('svg-mask-avatar-status-mobile-40', l.EF.SIZE_40),
                U('svg-mask-avatar-decoration-status-mobile-40', l.EF.SIZE_40),
                D('svg-mask-avatar-status-typing-40', l.EF.SIZE_40),
                M('svg-mask-avatar-decoration-status-typing-40', l.EF.SIZE_40),
                b('svg-mask-avatar-status-round-48', l.EF.SIZE_48),
                L('svg-mask-avatar-decoration-status-round-48', l.EF.SIZE_48),
                P('svg-mask-avatar-status-mobile-48', l.EF.SIZE_48),
                U('svg-mask-avatar-decoration-status-mobile-48', l.EF.SIZE_48),
                D('svg-mask-avatar-status-typing-48', l.EF.SIZE_48),
                M('svg-mask-avatar-decoration-status-typing-48', l.EF.SIZE_48),
                b('svg-mask-avatar-status-round-56', l.EF.SIZE_56),
                L('svg-mask-avatar-decoration-status-round-56', l.EF.SIZE_56),
                P('svg-mask-avatar-status-mobile-56', l.EF.SIZE_56),
                U('svg-mask-avatar-decoration-status-mobile-56', l.EF.SIZE_56),
                D('svg-mask-avatar-status-typing-56', l.EF.SIZE_56),
                M('svg-mask-avatar-decoration-status-typing-56', l.EF.SIZE_56),
                b('svg-mask-avatar-status-round-80', l.EF.SIZE_80),
                L('svg-mask-avatar-decoration-status-round-80', l.EF.SIZE_80),
                P('svg-mask-avatar-status-mobile-80', l.EF.SIZE_80),
                U('svg-mask-avatar-decoration-status-mobile-80', l.EF.SIZE_80),
                D('svg-mask-avatar-status-typing-80', l.EF.SIZE_80),
                M('svg-mask-avatar-decoration-status-typing-80', l.EF.SIZE_80),
                b('svg-mask-avatar-status-round-120', l.EF.SIZE_120),
                L('svg-mask-avatar-decoration-status-round-120', l.EF.SIZE_120),
                P('svg-mask-avatar-status-mobile-120', l.EF.SIZE_120),
                U('svg-mask-avatar-decoration-status-mobile-120', l.EF.SIZE_120),
                D('svg-mask-avatar-status-typing-120', l.EF.SIZE_120),
                M('svg-mask-avatar-decoration-status-typing-120', l.EF.SIZE_120),
                v('svg-mask-diagonal-facepile-16', l.EF.SIZE_16),
                N('svg-mask-diagonal-facepile-status-16', l.EF.SIZE_16),
                O('svg-mask-diagonal-facepile-typing-16', l.EF.SIZE_16),
                v('svg-mask-diagonal-facepile-20', l.EF.SIZE_20),
                N('svg-mask-diagonal-facepile-status-20', l.EF.SIZE_20),
                O('svg-mask-diagonal-facepile-typing-20', l.EF.SIZE_20),
                v('svg-mask-diagonal-facepile-24', l.EF.SIZE_24),
                N('svg-mask-diagonal-facepile-status-24', l.EF.SIZE_24),
                O('svg-mask-diagonal-facepile-typing-24', l.EF.SIZE_24),
                v('svg-mask-diagonal-facepile-32', l.EF.SIZE_32),
                N('svg-mask-diagonal-facepile-status-32', l.EF.SIZE_32),
                O('svg-mask-diagonal-facepile-typing-32', l.EF.SIZE_32),
                v('svg-mask-diagonal-facepile-40', l.EF.SIZE_40),
                N('svg-mask-diagonal-facepile-status-40', l.EF.SIZE_40),
                O('svg-mask-diagonal-facepile-typing-40', l.EF.SIZE_40),
                v('svg-mask-diagonal-facepile-48', l.EF.SIZE_48),
                N('svg-mask-diagonal-facepile-status-48', l.EF.SIZE_48),
                O('svg-mask-diagonal-facepile-typing-48', l.EF.SIZE_48),
                v('svg-mask-diagonal-facepile-56', l.EF.SIZE_56),
                N('svg-mask-diagonal-facepile-status-56', l.EF.SIZE_56),
                O('svg-mask-diagonal-facepile-typing-56', l.EF.SIZE_56),
                v('svg-mask-diagonal-facepile-80', l.EF.SIZE_80),
                N('svg-mask-diagonal-facepile-status-80', l.EF.SIZE_80),
                O('svg-mask-diagonal-facepile-typing-80', l.EF.SIZE_80),
                v('svg-mask-diagonal-facepile-120', l.EF.SIZE_120),
                N('svg-mask-diagonal-facepile-status-120', l.EF.SIZE_120),
                O('svg-mask-diagonal-facepile-typing-120', l.EF.SIZE_120),
                w('svg-mask-status-online-mobile'),
                y('svg-mask-status-online'),
                x('svg-mask-status-idle'),
                G('svg-mask-status-dnd'),
                k('svg-mask-status-offline'),
                B('svg-mask-status-streaming'),
                F('svg-mask-status-typing'),
                Z('svg-mask-status-screenshare'),
                f('svg-mask-avatar-voice-call-80'),
                h('svg-mask-avatar-call-icon', l.EF.SIZE_56, 1),
                h('svg-mask-avatar-call-icon-32', l.EF.SIZE_32, 0.5),
                V('svg-mask-sticker-rounded-rect'),
                H('svg-mask-chat-input-button-notification'),
                Y('svg-mask-sticker-shop-notification'),
                j('svg-mask-autocomplete-emoji-upsell-emoji'),
                W('svg-mask-event-ticket'),
                K('svg-mask-guild-icon-with-channel-type'),
                z('svg-mask-content-inventory-card-face-pile-avatar'),
                Q('svg-mask-guild-popout-activity-icon'),
                X('svg-mask-clan-icon'),
                $('svg-mask-forward-attachment-pile-overflow'),
                q('svg-mask-content-image-60', 60, 24, 2),
                q('svg-mask-content-image-72', 72, 32, 4)
            ]
        });
    },
    () => !0

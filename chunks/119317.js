var i = n(735250), s = n(470079), a = n(664751), r = n(481060), l = n(703656);
class o extends s.PureComponent {
    ...
    render() {
        let {
                ...
                maxVisiblePages: n,
                children: s
            } = this.props, {currentPage: a} = this.state;
        return s({
    ...
    constructor(e) {
        ...
        let s = (0, l.s1)().location.search, {offset: r} = null != s && s.length > 0 && s.startsWith('?') ? a.parse(s) : {}, o = null != r ? Math.floor(parseInt(r, 10) / e.pageSize) + 1 : 1;

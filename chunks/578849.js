...
let S = '[a-zA-Z]\\w*', A = '[a-zA-Z_]\\w*', N = '\\b\\d+(\\.\\d+)?', v = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)', O = '\\b(0b[01]+)', R = {
        begin: '\\\\[\\s\\S]',
        relevance: 0
    }, C = function (e, t, n = {}) {
        let r = a({
...
var q = function (e) {
    let n = Object.create(null), o = Object.create(null), s = [], l = !0, u = 'Could not find the language \'{}\', did you forget to load/include a language module?', c = {
            disableAutodetect: !0,
            name: 'Plain text',
            contains: []
        }, T = {
    ...
    function N(e, t, o, s) {
        ...
        function f(e, t) {
            ...
            for (; n <= r;) {
                ...
                let r = S.classNameAliases[e[n]] || e[n], i = t[n];
                ...
                if ('end' === i.type) {
                    let e = function (e) {
                        ...
                        if (!a)
                            return z;
                        let o = R;
                        R.endScope && R.endScope._wrap ? (E(), D.addKeyword(n, R.endScope._wrap)) : R.endScope && R.endScope._multi ? (E(), f(R.endScope, e)) : o.skip ? L += n : (!(o.returnEnd || o.excludeEnd) && (L += n), E(), o.excludeEnd && (L = n));
                        do
                            R.scope && D.closeNode(), !R.skip && !R.subLanguage && (b += R.relevance), R = R.parent;
                        while (R !== a.parent);
                        return a.starts && h(a.starts, e), o.returnEnd ? 0 : n.length;
                    }(i);
                    if (e !== z)
                        return e;
                }
        ...
        let A = function (e) {
                ...
                return e.classNameAliases = a(e.classNameAliases || {}), function n(i, o) {
                    ...
                    [
                        ...
                        W,
                        k
                    ].forEach(e => e(i, o)), e.compilerExtensions.forEach(e => e(i, o)), i.__beforeBegin = null, [
                        U,
                        w,
                        G
                    ...
                    return 'object' == typeof i.keywords && i.keywords.$pattern && (i.keywords = Object.assign({}, i.keywords), s = i.keywords.$pattern, delete i.keywords.$pattern), s = s || /\w+/, i.keywords && (i.keywords = function e(t, n, r = 'keyword') {
                        ...
                        return function (e) {
                            ...
                            }(e) ? a(e, { starts: e.starts ? a(e.starts) : null }) : Object.isFrozen(e) ? a(e) : e;
                        }('self' === e ? i : e);
            ...
            }(S), O = '', R = s || A, C = {}, D = new T.__emitter(T);
        !function () {
            let e = [];
        ...
        try {
            for (R.matcher.considerAll();;) {
                ...
                if (!e)
                    break;
                let n = t.substring(M, e.index), r = m(n, e);
                M = e.index + r;
            }
    ...
    function v(e, t) {
        ...
        let r = function (e) {
            ...
            }(e), a = t.filter(y).filter(L).map(t => N(t, e, !1));
        a.unshift(r);
        let [o, s] = a.sort((e, t) => {
    ...
    for (let r in (Object.assign(e, {
            ...
            unregisterLanguage: function (e) {
                for (let t of (delete n[e], Object.keys(o)))
                    o[t] === e && delete o[t];
            },

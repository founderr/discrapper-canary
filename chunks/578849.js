...
if (!s(e))
  return;
let t = '';
t = e.sublanguage ? `language-${ e.language }` : o(e.scope, {
...
return 'string' == typeof t ? e.addText(t) : t.children && (e.openNode(t), t.children.forEach(t => this._walk(e, t)), e.closeNode(t)), e;
  ...
  static _collapse(e) {
if ('string' != typeof e)
  e.children && (e.children.every(e => 'string' == typeof e) ? e.children = [e.children.join('')] : e.children.forEach(e => {
    c._collapse(e);
  }));
  }
}
...
var b = Object.freeze({
  ...
  SHEBANG: (e = {}) => {
let t = /^#![ ]*\//;
return e.binary && (e.begin = p(t, /.*\b/, e.binary, /\b.*/)), a({
  scope: 'meta',
  begin: t,
  end: /$/,
  relevance: 0,
...
function U(e, t) {
  if (!!t)
e.beginKeywords && (e.begin = '\\b(' + e.beginKeywords.split(' ').join('|') + ')(?!\\.)(?=\\b|\\s)', e.__beforeBegin = M, e.keywords = e.keywords || e.beginKeywords, delete e.beginKeywords, void 0 === e.relevance && (e.relevance = 0));
}
...
Object.keys(e).forEach(t => {
  delete e[t];
}), e.keywords = n.keywords, e.begin = p(n.beforeMatch, E(n.begin)), e.starts = {
  relevance: 0,
...
if (Array.isArray(e.begin)) {
  if (e.skip || e.excludeBegin || e.returnBegin)
    throw V('skip, excludeBegin, returnBegin not compatible with beginScope: {}'), Y;
  if ('object' != typeof e.beginScope || null === e.beginScope)
    throw V('beginScope must be object'), Y;
  j(e, e.begin, {
    key: 'beginScope'
  }), e.begin = g(e.begin, {
    joinWith: ''
...
if (Array.isArray(e.end)) {
  if (e.skip || e.excludeEnd || e.returnEnd)
    throw V('skip, excludeEnd, returnEnd not compatible with endScope: {}'), Y;
  if ('object' != typeof e.endScope || null === e.endScope)
    throw V('endScope must be object'), Y;
  j(e, e.end, {
    key: 'endScope'
  }), e.end = g(e.end, {
    joinWith: ''
...
function d() {
  ...
  for (; t;) {
    ...
    if (s) {
      let [e, r] = s;
      if (D.addText(n), n = '', c[a] = (c[a] || 0) + 1, c[a] <= 7 && (b += r), e.startsWith('_'))
        n += t[0];
      else {
...
function E() {
  null != R.subLanguage ? ! function() {
    ...
    if ('string' == typeof R.subLanguage) {
      ...
      e = v(L, R.subLanguage.length ? R.subLanguage : null);
...
function h(e, t) {
  return e.scope && 'string' == typeof e.scope && D.openNode(S.classNameAliases[e.scope] || e.scope), e.beginScope && (e.beginScope._wrap ? (D.addKeyword(L, S.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), L = '') : e.beginScope._multi && (f(e.beginScope, t), L = '')), R = Object.create(e, {
    parent: {
      value: R
    }
  });
  ...
  if ('illegal' !== i.type || s) {
    if ('end' === i.type) {
      let e = function(e) {
        ...
        do
          R.scope && D.closeNode(), !R.skip && !R.subLanguage && (b += R.relevance), R = R.parent;
        while (R !== a.parent);
...
let A = function(e) {
    ...
    return e.classNameAliases = a(e.classNameAliases || {}),
      function n(i, s) {
        ...
        let o = null;
        return 'object' == typeof i.keywords && i.keywords.$pattern && (i.keywords = Object.assign({}, i.keywords), o = i.keywords.$pattern, delete i.keywords.$pattern), o = o || /\w+/, i.keywords && (i.keywords = function e(t, n, r = 'keyword') {
        ...
        }(i.keywords, e.case_insensitive)), i.keywordPatternRe = t(o, !0), s && (!i.begin && (i.begin = /\B|\b/), i.beginRe = t(i.begin), !i.end && !i.endsWithParent && (i.end = /\B|\b/), i.end && (i.endRe = t(i.end)), i.terminatorEnd = _(i.end) || '', i.endsWithParent && s.terminatorEnd && (i.terminatorEnd += (i.end ? '|' : '') + s.terminatorEnd)), i.illegal && (i.illegalRe = t(i.illegal)), !i.contains && (i.contains = []), i.contains = [].concat(...i.contains.map(function(e) {
          return function(e) {
          ...
          n(e, i);
        }), i.starts && n(i.starts, s), i.matcher = function(e) {
          let t = new r();
...
let r = function(e) {
  ...
  a = t.filter(y).filter(L).map(t => N(t, e, !1));
a.unshift(r);
let [s, o] = a.sort((e, t) => {
  if (e.relevance !== t.relevance)
    return t.relevance - e.relevance;
  if (e.language && t.language) {
    if (y(e.language).supersetOf === t.language)
      return 1;
    if (y(t.language).supersetOf === e.language)
      return -1;
  }
  return 0;
});
...
o.forEach(function(n) {
  ...
  registerLanguage: function(t, r) {
    ...
    try {
      ...
      if (V('Language definition for \'{}\' could not be registered.'.replace('{}', t)), l)
        V(e);
      else
        throw e;
      i = c;
    }!i.name && (i.name = t), n[t] = i, i.rawDefinition = r.bind(null, e), i.aliases && D(i.aliases, {
      languageName: t
    });
  },
  unregisterLanguage: function(e) {
    for (let t of (delete n[e], Object.keys(s)))
      s[t] === e && delete s[t];
  },

    ...
    (t = e).scope && 'object' == typeof t.scope && null !== t.scope && ((t.beginScope = t.scope), delete t.scope),
        ...
        !(function (e) {
            if (Array.isArray(e.begin)) {
                ...
                j(e, e.begin, { key: 'beginScope' }), (e.begin = S(e.begin, { joinWith: '' }));
            }
        })(e),
        !(function (e) {
            if (Array.isArray(e.end)) {
                ...
                j(e, e.end, { key: 'endScope' }), (e.end = S(e.end, { joinWith: '' }));
            }
        })(e);
}
...
var q = (function (e) {
    ...
    function N(e, t, s, o) {
        ...
        function d() {
            ...
            let t = v.keywordPatternRe.exec(D),
                n = '';
            for (; t; ) {
                var r, i;
                n += D.substring(e, t.index);
                let a = g.case_insensitive ? t[0].toLowerCase() : t[0];
                let s = ((r = v), (i = a), r.keywords[i]);
                if (s) {
                    let [e, r] = s;
                    if ((y.addText(n), (n = ''), (c[a] = (c[a] || 0) + 1), c[a] <= 7 && (b += r), e.startsWith('_'))) n += t[0];
                    else {
                        let n = g.classNameAliases[e] || e;
                        y.addKeyword(t[0], n);
                    }
                } else n += t[0];
                (e = v.keywordPatternRe.lastIndex), (t = v.keywordPatternRe.exec(D));
            }
            (n += D.substring(e)), y.addText(n);
        }
        function E() {
            null != v.subLanguage
                ? !(function () {
                      ...
                      if ('string' == typeof v.subLanguage) {
                          ...
                          (e = N(v.subLanguage, D, !0, C[v.subLanguage])), (C[v.subLanguage] = e._top);
                      } else e = R(D, v.subLanguage.length ? v.subLanguage : null);
                      v.relevance > 0 && (b += e.relevance), y.addSublanguage(e._emitter, e.language);
                  })()
                : d(),
                (D = '');
        }
        function f(e, t) {
            ...
            for (; n <= r; ) {
                ...
                let r = g.classNameAliases[e[n]] || e[n],
                    i = t[n];
                r ? y.addKeyword(i, r) : ((D = i), d(), (D = '')), n++;
            }
        }
        function h(e, t) {
            return e.scope && 'string' == typeof e.scope && y.openNode(g.classNameAliases[e.scope] || e.scope), e.beginScope && (e.beginScope._wrap ? (y.addKeyword(D, g.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (D = '')) : e.beginScope._multi && (f(e.beginScope, t), (D = ''))), (v = Object.create(e, { parent: { value: v } }));
        }
        let p = {};
        function I(n, i) {
            let a = i && i[0];
            if (((D += n), null == a)) return E(), 0;
                ...
                return (function (e) {
                    ...
                    for (let r of [n.__beforeBegin, n['on:begin']])
                        if (r && (r(e, i), i.isMatchIgnored)) {
                            var a;
                            return (a = t), 0 === v.matcher.regexIndex ? ((D += a[0]), 1) : ((H = !0), 0);
                        }
                    return n.skip ? (D += t) : (n.excludeBegin && (D += t), E(), !n.returnBegin && !n.excludeBegin && (D = t)), h(n, e), n.returnBegin ? 0 : t.length;
                })(i);
            if ('illegal' !== i.type || s) {
                if ('end' === i.type) {
                    let e = (function (e) {
                        ...
                        if (!a) return z;
                        let s = v;
                        v.endScope && v.endScope._wrap ? (E(), y.addKeyword(n, v.endScope._wrap)) : v.endScope && v.endScope._multi ? (E(), f(v.endScope, e)) : s.skip ? (D += n) : (!(s.returnEnd || s.excludeEnd) && (D += n), E(), s.excludeEnd && (D = n));
                        do v.scope && y.closeNode(), !v.skip && !v.subLanguage && (b += v.relevance), (v = v.parent);
                        while (v !== a.parent);
        ...
        let g = L(e);
        if (!g) throw (V(u.replace('{}', e)), Error('Unknown language: "' + e + '"'));
        let A = (function (e) {
                function t(t, n) {
        ...
        !(function () {
            let e = [];
            for (let t = v; t !== g; t = t.parent) t.scope && e.unshift(t.scope);
            e.forEach((e) => y.openNode(e));
        })();
        let D = '',
            b = 0,
            M = 0,
    ...
    function R(e, t) {
        ...
        let [s, o] = a.sort((e, t) => {
            ...
            if (e.language && t.language) {
                ...
                if (L(t.language).supersetOf === e.language) return -1;
            }
            return 0;
        });
    ...
    function O(e) {
        let t = null,
            n = (function (e) {
                ...
                return t.split(/\s+/).find((e) => g(e) || L(e));
            })(e);
        if (g(n)) return;
        if (
    ...
    for (let r in (Object.assign(e, {
        ...
        registerLanguage: function (t, r) {
            ...
            !i.name && (i.name = t), (n[t] = i), (i.rawDefinition = r.bind(null, e)), i.aliases && y(i.aliases, { languageName: t });
        },

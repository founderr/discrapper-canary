...
function K(e) {
    ...
    if (null != n ? E = n.name : null != i && (E = i.name), null == E)
        return null;
    let _ = (0, y.Z)(i, n, d), g = s ? m.find(e => {
            let {id: n} = e;
            return n === (null == _ ? void 0 : _.id);
        }) : u, h = null != n && n.id.startsWith('screen') ? o.ScreenIcon : o.BrowserIcon;
    return (0, l.jsx)(o.FormItem, {
        ...
        children: (0, l.jsxs)(w.Z, {
            children: [
                ...
                }) : (0, l.jsx)(h, { className: F.selectedIcon }),
                (0, l.jsx)('span', {
...
function J(e) {
    let {guildId: n} = e, t = (0, r.e7)([N.Z], () => {
            ...
            g.eo.updateSetting(n), L.default.track(k.rMx.NOTIFY_STREAM_SETTING_UPDATE, { value: n });
        }, []);
...
function X(e) {
    ...
    let es = en ? (0, l.jsx)(_.Z, {
            guildId: S,
            isAnimationDone: V
        }) : et ? (0, l.jsx)(E.Z, {}) : void 0, ea = !!(null == n ? void 0 : n.id.startsWith('camera')), ei = null != ee && ee.verified && !ee.bot, er = null != z && !(0, d.Yk)(z), eo = !(0, r.e7)([I.Z], () => I.Z.getHardwareEncoding());
    return (0, l.jsxs)(s.Fragment, {
        children: [
            ...
            null != z ? (0, l.jsx)(b.Z, { channel: z }) : (0, l.jsx)(U.Z, {
                guildId: S,
                selectedChannelId: a,
                onChangeSelectedChannelId: M
            }),
            ...
            eo && (0, l.jsx)(h.Z, {
                ...
                children: W.Z.Messages.GO_LIVE_MODAL_HARDWARE_WARNING_INFOBOX.format({
                    onClick: () => {
                        R(), u.Z.open(k.oAB.VOICE, null, { scrollPosition: H.KQ.VoiceAndVideoScrollPositions.HARDWARE_ACCELERATION });
                    }
                })
            }),
            (0, l.jsx)(B.Z, {

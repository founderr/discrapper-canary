...
var n = s(735250), a = s(470079), i = s(442837), r = s(704215), o = s(481060), l = s(37234), c = s(100527), d = s(906732), _ = s(238302), E = s(514361), u = s(705262), T = s(605236), I = s(104494), S = s(639119), N = s(165583), C = s(197115), m = s(504983), A = s(626135), h = s(981631), g = s(921944), O = s(474936), p = s(689938), R = s(610275), x = s(331651);
let M = () => {
        ...
        return a.useEffect(() => {
            ...
            children: [
                (0, n.jsxs)(u.ZP, {
                    type: u.yH.SETTINGS,
                    children: [
                        (0, n.jsx)(u.ZP.Basic, { className: R.basicThemeSelectors }),
                        (0, n.jsxs)(m.Z, {
                            ...
                            children: [
                                    ...
                                    renderCTAButtons: () => !r || l ? null : (0, n.jsxs)('div', {
                                        ...
                                        children: [
                                            ...
                                            (0, n.jsx)(C.Z, {
                                                ...
                                                buttonText: T ? p.Z.Messages.PREMIUM_DISCOUNT_CTA.format({ percent: null == _ ? void 0 : _.discount.amount }) : p.Z.Messages.USER_SETTINGS_CUSTOMIZATION_UPSELL,
                                ...
                                l && r && (0, n.jsxs)('div', {
                                    children: [
                                        ...
                                        (0, n.jsx)('div', { className: R.premiumTier2Divider }),
                                        (0, n.jsx)(N.ZP, {

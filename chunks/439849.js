...
async function I() {
  ...
  let e = s.default.remoteApp.getPath;
  return c(await e("home")), c(await e("appData")), c(await e("desktop")), c(await e("documents")), c(await e("downloads")), (d = a().uniq(d)).sort((e, t) => t.length - e.length), i
}
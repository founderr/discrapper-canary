    ...
    return (
        a.useImperativeHandle(
            ...
            () => ({
                ...
                stop: () => {
                    if (null == N.current || b) return;
                },
                stopIfPlaying: (e) => {
                    null != N.current && !b && v.current === e && (N.current.resetSegments(!0), N.current.setSegment(T[e].start, T[e].start), N.current.stop());
                }
            }),
            [b, R, T]
        ),
            ...
            () => (
                Promise.resolve()
                    ...
                    .then((e) => {
                        ...
                        let n,
                            { default: r } = e,
                            i = null !== (t = v.current) && void 0 !== t ? t : L.current;
                        if (null != i && null != T[i]) {
                            let e = T[i];

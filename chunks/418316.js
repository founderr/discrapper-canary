...
function _(e) {
  ...
  switch (e.type) {
    ...
    case c.O7.FRIEND_REQUESTS_GROUPED:
      let x = o.ZP.getName(l.default.getUser(null === (m = e.other_users) || void 0 === m ? void 0 : null === (E = m[0]) || void 0 === E ? void 0 : E.id)),
        M = o.ZP.getName(l.default.getUser(null === (T = e.other_users) || void 0 === T ? void 0 : null === (I = T[1]) || void 0 === I ? void 0 : I.id)),

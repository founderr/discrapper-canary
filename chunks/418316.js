...
function E(e) {
  var t, n, E, _, I, T, m, N, h, C, S, A, g, p, f;
  let R = null !== (E = null === (t = e.other_user) || void 0 === t ? void 0 : t.id) && void 0 !== E ? E : u.lds,
    O = o.ZP.getName(a.default.getUser(null === (n = e.other_user) || void 0 === n ? void 0 : n.id));
  switch (e.type) {
    ...
    case c.O7.FRIEND_REQUESTS_GROUPED:
      let M = o.ZP.getName(a.default.getUser(null === (I = e.other_users) || void 0 === I ? void 0 : null === (_ = I[0]) || void 0 === _ ? void 0 : _.id)),
        x = o.ZP.getName(a.default.getUser(null === (m = e.other_users) || void 0 === m ? void 0 : null === (T = m[1]) || void 0 === T ? void 0 : T.id)),
    ...
    case c.DY.FRIEND_SUGGESTION_CREATED:
      let Z = l.Z.getRelationshipType(R) === u.OGo.PENDING_OUTGOING;
    ...
    case c.DY.GUILD_SCHEDULED_EVENT_STARTED:
      let P = e.guild_scheduled_event_id,
        ...
        U = null === (g = i.Z.getGuild(null == D ? void 0 : D.guild_id)) || void 0 === g ? void 0 : g.name,
        b = (0, s.Z2)(null != D ? D : void 0);
      return (0, r.Ew)(U) || (0, r.Ew)(j) || !b ? null !== (p = e.body) && void 0 !== p ? p : "" : d.Z.Messages.NOTIFICATION_CENTER_GUILD_SCHEDULED_EVENT_ENDED.format({
        event_name: j,
        guild_name: U
      });

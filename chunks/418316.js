...
var r = n(430824),
    ...
    d = n(388032);
function m(e) {
    var t, n, m, f, h, p, g, _, C, E, I, x, v, N, T;
    ...
    switch (e.type) {
        case c.O7.INCOMING_FRIEND_REQUESTS:
            return d.intl.formatToPlainString(d.t.uIomX1, { username: '**'.concat(b, '**') });
        case c.O7.FRIEND_REQUESTS_GROUPED:
            let A = s.ZP.getName(a.default.getUser(null === (h = e.other_users) || void 0 === h ? void 0 : null === (f = h[0]) || void 0 === f ? void 0 : f.id)),
        ...
        case c.O7.INCOMING_FRIEND_REQUESTS_ACCEPTED:
            return d.intl.formatToPlainString(d.t['5Uzkdn'], { username: '**'.concat(b, '**') });
    }

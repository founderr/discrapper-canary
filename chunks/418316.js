  ...
  switch (e.type) {
    ...
    case u.NotificationCenterItems.GUILD_SCHEDULED_EVENT_STARTED:
      let P = e.guild_scheduled_event_id,
        ...
        j = (0, s.isGuildEventEnded)(null != y ? y : void 0);
      return (0, r.isNullOrEmpty)(b) || (0, r.isNullOrEmpty)(U) || !j ? null !== (A = e.body) && void 0 !== A ? A : "" : c.default.Messages.NOTIFICATION_CENTER_GUILD_SCHEDULED_EVENT_ENDED.format({
        event_name: U,
        guild_name: b
      });

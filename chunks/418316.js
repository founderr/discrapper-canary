...
var s = n(430824),
    ...
    d = n(689938);
function _(e) {
    var t, n, _, E, I, m, T, N, h, C, f, p, g, S, A;
    ...
    switch (e.type) {
        case c.O7.INCOMING_FRIEND_REQUESTS:
            return d.Z.Messages.NOTIFICATION_CENTER_INCOMING_FRIEND_REQUEST.format({ username: '**'.concat(O, '**') });
        ...
        case c.O7.INCOMING_FRIEND_REQUESTS_ACCEPTED:
            return d.Z.Messages.NOTIFICATION_CENTER_INCOMING_FRIEND_REQUEST_ACCEPTED.format({ username: '**'.concat(O, '**') });
    }

...
var i = n(735250),
    ...
    R = n(129640);
function O(e) {
    let { setTab: t, onJump: n, showTutorial: a, setSeenTutorial: l, closePopout: O, badgeState: M } = e,
        v = s.useRef(null),
        [L, Z] = (0, g.ZP)(v),
                ...
                children: (0, i.jsx)(c.SJ, {
                    children: (e) => {
                        ...
                        return (0, i.jsxs)(_.AdvancedScrollerThin, {
                            ...
                            children: [a ? (0, i.jsx)(x, { setSeenTutorial: l }) : null, (0, p.Z)(D, Z, n), P === g.jd.Done ? null : (0, i.jsx)(_.Spinner, { className: R.spinner })]
                        });
                    }
                })
            })

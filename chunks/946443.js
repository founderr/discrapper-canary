...
function x(e) {
  let {
    ...
    closePopout: x,
    badgeState: L
  } = e, b = l.useRef(null), [O, y] = (0, C.default)(b), {
    loadState: j,
    channels: D
  } = O, {
    maybeLoadMore: F,
  ...
  let U = (0, d.useStateFromStores)([E.default], () => E.default.messageGroupSpacing),
    k = (0, m.default)("unreads", b);
  if (0 === D.length) {
    var w;
    return (0, a.jsxs)("div", {
  ...
  return (0, a.jsxs)("div", {
    className: i()(R.container, "group-spacing-".concat(U)),
      ...
      children: (0, a.jsx)(u.ListNavigatorContainer, {
        children: e => {
          ...
          return (0, a.jsxs)(f.AdvancedScrollerThin, {
            ...
            children: [s ? (0, a.jsx)(M, {
              setSeenTutorial: r
            }) : null, (0, T.default)(D, y, n), j === C.LoadState.Done ? null : (0, a.jsx)(f.Spinner, {
              className: R.spinner
            })]
          })
        }

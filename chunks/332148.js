...
let u = {
  async pinMessage(e, n) {
    ...
    await i.Z.unarchiveThreadIfNecessary(e.id), t.tn.put({
      ...
      let n;
      n = e.isPrivate() ? d.Z.Messages.PIN_MESSAGE_TOO_MANY_BODY_PRIVATE_CHANNEL.format({
        maxPins: o.tG9
      }) : d.Z.Messages.PIN_MESSAGE_TOO_MANY_BODY.format({
        maxPins: o.tG9,
        channelName: l
      }), r.Z.show({
  ...
  fetchPins(e) {
    let n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      s = a.Z.getPinnedMessages(e);
    if (!!n || null == s || !s.loaded && !s.loading) l.Z.dispatch({

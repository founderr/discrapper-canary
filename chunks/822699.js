...
class eg extends r.PureComponent {
  static getDerivedStateFromProps(e, t) {
    ...
    let o = null;
    if (null == s) o = (0, P.gK)(a);
    else if ((null == s ? void 0 : s.state) === q.r2o.RESOLVED) {
      let {
        guild: e,
        target_application: t
      } = s;
      null != t ? null != l && (o = (0, D.getAssetImage)(t.id, l, 1024)) : null != e && "string" == typeof e.splash && (o = C.ZP.getGuildSplashURL({
        id: e.id,
        splash: e.splash
      }))
    }
  ...
  maybeFetchApplicationSplash() {
    ...
    if ((null == e ? void 0 : e.state) === q.r2o.RESOLVED) {
      ...
      null != t && (0, D.fetchAssetIds)(t.id, ["embedded_splash"]).then(e => {
        let [t] = e;
...
t.default = o.ZP.connectStores([x.default, S.Z, O.Z, g.Z, m.Z], e => {
  ...
  let {
    match: r,
    location: i
  } = e, l = null == r ? void 0 : null === (t = r.params) || void 0 === t ? void 0 : t.inviteCode, a = Q.a ? Q.Y : void 0, o = null != l ? (0, A.mb)(l, i.search) : a, c = null == r ? void 0 : null === (n = r.params) || void 0 === n ? void 0 : n.giftCode, u = null == r ? void 0 : null === (s = r.params) || void 0 === s ? void 0 : s.guildTemplateCode;
  return {
    inviteKey: o,

...
if (!(null == e.match(i) || [
  ...
  var t = e.match(/.{1,2}/g);
  if (null != t)
    return new s(parseInt(t[0], 16), parseInt(t[1], 16), parseInt(t[2], 16), null != t[3] ? parseInt(t[3], 16) / 255 : 1);
}
  }
...
return function(e) {
  let {
    ...
    blue: r,
    alpha: i
  } = e, a = t / 255, s = n / 255, o = r / 255, l = Math.max(a, s, o), u = Math.min(a, s, o), c = l - u, d = (l + u) / 2, _ = c > 0 ? c / (1 - Math.abs(2 * d - 1)) : 0;
  if (0 === c)
    return {
      hue: 0,
      saturation: _,

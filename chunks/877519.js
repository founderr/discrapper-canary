n(47120);
var r = n(147913), i = n(70956), a = n(272008), o = n(569984), s = n(977156), l = n(46140);
function u(e, t, n) {
...
let c = i.Z.Millis.DAY, d = 30 * i.Z.Millis.MINUTE, _ = 5 * i.Z.Millis.SECOND, E = 5 * i.Z.Millis.MINUTE, f = 12 * i.Z.Millis.HOUR;
class h extends r.Z {
    _fetch() {
        if (!!(0, s.cB)({ location: l.dr.QUESTS_MANAGER }) && !o.Z.isFetchingCurrentQuests)
            (0, a.xw)();
    }
    constructor(...e) {

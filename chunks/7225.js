...
var o, s, i = a(735250), n = a(470079), r = a(442837), c = a(481060), l = a(728345), d = a(812206), u = a(886176), p = a(270144), f = a(572004), h = a(504211), m = a(283836), N = a(507608), T = a(981631), _ = a(272242), E = a(689938), g = a(435601);
function C(t) {
    let {
            onClose: e,
            transitionState: a,
            appId: o,
            guildId: s
        } = t, C = (0, r.e7)([d.Z], () => d.Z.getApplication(o), [o]), [S, I] = n.useState(() => d.Z.isFetchingApplication(o) ? { status: 1 } : { status: 0 }), R = n.useRef(null), [x, O] = n.useState(!0), L = () => {
            var t;
            (null === (t = R.current) || void 0 === t ? void 0 : t.isScrolledToBottom()) === !0 ? O(!1) : O(!0);
        };
    n.useEffect(() => {
        0 === S.status && (I({ status: 1 }), l.Z.fetchApplication(o).then(() => {
            I({ status: 2 });
        }).catch(t => {
            I({
                status: 3,
    ...
    if ((0, p.FE)(o, null == C ? void 0 : C.primarySkuId, { refetchOnMount: !0 }), null == C)
        return null;
    let j = E.Z.Messages.STOREFRONT_TITLE.format({ appName: C.name });

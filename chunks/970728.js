...
function ee(e) {
  let {
    ...
    if ((null == n ? void 0 : n.targetType) == null && !P.GUILD_VOCAL_CHANNEL_TYPES.has(t.type) && ((0, E.canSeeGuildHome)(e) || (0, S.canSeeOnboardingHome)(e))) return z.StaticChannelRoute.GUILD_HOME;
    let r = L.default.getChannel(t.id);
    return G.default.can(K.Permissions.VIEW_CHANNEL, r) ? t.id : null !== (s = null === (i = M.default.getDefaultChannel(e, !0, K.Permissions.CREATE_INSTANT_INVITE)) || void 0 === i ? void 0 : i.id) && void 0 !== s ? s : t.id
  }(t, i, s), {
    targetUserId: l,
    targetType: u,
    targetApplicationId: d
  } = null != s ? s : {}, c = a === K.ChannelTypes.GUILD_STAGE_VOICE, f = K.Routes.CHANNEL(t, o);
  P.GUILD_VOCAL_CHANNEL_TYPES.has(a) ? (0, m.addPostConnectionCallback)(() => {
...
let et = function(e, t) {
    ...
    L.default.addConditionalChangeListener(() => {
      ...
      return null == s || null == r || (!s.nsfw || !!r.nsfwAllowed) && ((null == t ? void 0 : t.guildScheduledEvent) != null ? (! function(e) {
        ...
        null != t && (0, m.addPostConnectionCallback)(() => {
          let e = {
        ...
        guildId: null !== (i = s.getGuildId()) && void 0 !== i ? i : K.ME,
        channel: s,
        options: t,
  ...
  en = async e => {
    ...
    (0, I.isGuildScheduledEventActive)(e) && null != n ? et(n) : await j.default.transitionToGuildSync(t)
  };
var ei = {
  ...
  acceptInvite(e) {
    ...
    let {
      ...
      callback: o,
      skipOnboarding: l
    } = e, c = (0, A.parseExtraDataFromInviteKey)(r), _ = c.baseCode, h = b.default.getSessionId();
    let g = (i = a, s = c, {
        ...i,
        invite_guild_scheduled_event_id: s.guildScheduledEventId
      }),
      m = F.default.getCurrentUser();
    return null !== (t = null == m ? void 0 : m.hasFlag(K.UserFlags.QUARANTINED)) && void 0 !== t && t ? ((0, N.default)(), new Promise((e, t) => t(Error()))) : (d.default.dispatch({
      type: "INVITE_ACCEPT",
      code: _
    }), u.default.post({
  ...
  openNativeAppModal(e) {
    g.default.openNativeAppModal(e, K.RPCCommands.INVITE_BROWSER)
  },
  openApp(e, t, n, i, r) {
    var u, c;
    let f;

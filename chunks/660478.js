...
function eI(e, t) {
  let n = B.default.getChannel(e.channel_id);
  return !(null == n || Q.default.isBlocked(e.author.id)) && (!!((0, S.default)({
    message: e,
    userId: t.id,
...
async function eD(e) {
  ...
  for (let n = 0; n < 3; n++) try {
    ...
    if (ea.error("", e), n + 1 < 3 && (await (0, _.timeoutPromise)((n + 1) * 2e3), await G.default.awaitOnline(), t !== H.default.getId())) return Promise.reject(Error("User changed."))
  }
}

function eN(e) {
  if (e.type !== er.ReadStateTypes.CHANNEL) return !1;
  let t = B.default.getChannel(e.channelId),
...
class eO {
  ...
  get guildId() {
    ...
    let e = B.default.getChannel(this.channelId);
  ...
  rebuildChannelState(e) {
    ...
    if (this.ackMessageId = null !== (t = null != e ? e : this._ackMessageId) && void 0 !== t ? t : this.guessAckMessageId(), this.isManualAck = null != e, this.oldestUnreadMessageId = null, this.estimated = !1, this.unreadCount = 0, s && (this.mentionCount = 0), this.hasUnread()) {
      ...
      o.forAll(n => {
        ...
        F.default.extractTimestamp(n.id) > t ? (this.unreadCount++, s && eI(n, e) && this.mentionCount++, a = null != a ? a : n.id) : r = !0
  ...
  canTrackUnreads() {
    ...
    let e = B.default.getBasicChannel(this.channelId);
  ...
  canBeUnread() {
    return !(this._isThread && !this._isJoinedThread || (0, C.isMessageRequestOrSpamRequest)(this.channelId, [T.default, I.default]) || !this._isThread && (0, N.isOptInEnabledForGuild)(this._guildId) && (this._lastMessageTimestamp < eE || !J.default.isChannelOrParentOptedIn(this._guildId, this.channelId) && !this.hasRecentlyVisitedAndRead() && !this.hasMentions())) && this.canTrackUnreads()
  }
  canHaveMentions() {
    return !(0 === this.mentionCount || this._isThread && !this._isJoinedThread || (0, C.isMessageRequestOrSpamRequest)(this.channelId, [T.default, I.default]) || (0, N.isOptInEnabledForGuild)(this._guildId) && this._lastMessageTimestamp < eE) && this.canTrackUnreads()
  }
  ...
  ack(e) {
    ...
    return this.estimated = !1, this.snapshot = this.takeSnapshot(), this.unreadCount = 0, this.mentionCount = 0, (null != t || null != (t = this.lastMessageId)) && (this.ackMessageId = t, this.isManualAck = !1, this._persisted = !0, ef && (this.ackedWhileCached = !0), function(e) {
      ...
      let n = B.default.getChannel(t.channelId);
  ...
  _shouldAck(e, t, n) {
    var s;
    return !!e || !!n || !!t || !!(!this.isManualAck && (this.type !== er.ReadStateTypes.CHANNEL || this.loadedMessages || (null === (s = B.default.getChannel(this.channelId)) || void 0 === s ? void 0 : s.isForumLikeChannel()))) || !1
  }
  _ack(e, t) {
    let {
      outgoingAck: s
    ...
    eD(() => f.default.post({
      ...
      null != e && (el === r && i === H.default.getId() && (el = e.body.token), g.default.dispatch({
        type: "MESSAGE_ACKED"
  ...
  delete() {
    ...
    let t = !(arguments.length > 0) || void 0 === arguments[0] || arguments[0],
      n = B.default.getBasicChannel(this.channelId);
  ...
  shouldDeleteReadState(e) {
    ...
    let t = B.default.getBasicChannel(this.channelId);
    ...
    return !!k.ALL_CHANNEL_TYPES.has(t.type) && (!(0, k.isReadableType)(t.type) || !(0, k.isPrivate)(t.type) && (!!(k.THREAD_CHANNEL_TYPES.has(t.type) && function(e, t, n) {
      let s = e.guildId,
        i = null != s && P.default.isActive(s, t.parent_id, e.channelId);
      return !i && eM(e, n)
  ...
  getAckTimestamp() {
    ...
    if (this.type === er.ReadStateTypes.GUILD_EVENT || this.type === er.ReadStateTypes.GUILD_ONBOARDING_QUESTION) e = W.default.getGuild(this.channelId);
      ...
      let t = B.default.getChannel(this.channelId);
      if (null != t) {
        let n = t.getGuildId();
...
function eR(e, t) {
  ...
  let r = B.default.getChannel(t),
    ...
    d = (null !== (i = null === (n = b.default.joinTimestamp(t)) || void 0 === n ? void 0 : n.getTime()) && void 0 !== i ? i : 0) - 5e3,
...
function eY() {
  let e = x.default.getCurrentSidebarChannelId(ed),
    t = !1;
...
class eX extends l.default.Store {
  initialize() {
    this.waitFor(Y.default, $.default, W.default, K.default, B.default, Z.default, q.default, X.default, h.default, P.default, b.default, x.default, p.default, j.default, v.default, J.default, ee.default, A.default, T.default, R.default, I.default), this.syncWith([x.default], eY)
  }
...
let eQ = new eX(g.default, {
  ...
  CONNECTION_OPEN: function(e) {
    ...
    eT(), el = null, !ef && !a.partial && eO.clearAll(), ef = !1, a.entries.forEach(e => {
      ...
      let a = B.default.getBasicChannel(e.id);
      null != a && (0, k.isThread)(a.type) && (null == e.last_message_id || 0 === e.last_message_id) ? r.ackMessageId = F.default.fromTimestamp(eR(a.guild_id, a.id)) : r.ackedWhileCached ? -1 === F.default.compare(r.ackMessageId, e.last_message_id) && (r.ackMessageId = e.last_message_id) : r.ackMessageId = e.last_message_id, r.ackedWhileCached = void 0, r.ackPinTimestamp = eC(e.last_pin_timestamp), eO._mentionChannels.delete(r.channelId), r._mentionCount > 0 && r.canHaveMentions() && eO._mentionChannels.add(r.channelId)
    ...
    for (let e of (function(e) {
      ...
      }(i), eP(r), s)) eP(null !== (n = e.channels) && void 0 !== n ? n : []), eU(e), eV(e);
  ...
  OVERLAY_INITIALIZE: function(e) {
    ...
    eT(), el = null, ed = n, eu = x.default.getCurrentSidebarChannelId(ed), eO.clearAll(), t.forEach(e => {
  ...
  GUILD_CREATE: function(e) {
    ...
    }), eP(null !== (t = n.channels) && void 0 !== t ? t : []), eU(n), eV(n)
  },
  ...
  MESSAGE_CREATE: function(e) {
    ...
    let d = $.default.getCurrentUser(),
      u = B.default.getBasicChannel(i);
    if (null != r.author && null != d && r.author.id === d.id) return null != o.outgoingAck && o.clearOutgoingAck(), eW({
      channelId: i,
      messageId: r.id,
      manual: !1
    });
    ...
    } else null == l && (t = Z.default.getChannelId(), n = x.default.getCurrentSidebarChannelId(t));
    let _ = t === i || n === i;
    ...
    !c && function(e, t, n) {
      if (null != t && (0, S.isRawMessageMentioned)({
          rawMessage: e,
          userId: t.id,
          suppressEveryone: J.default.isSuppressEveryoneEnabled(n.guildId),
          suppressRoles: J.default.isSuppressRolesEnabled(n.guildId)
        })) return !0;
      let s = B.default.getChannel(e.channel_id);
      return !!eS(s) || !!J.default.mentionOnAllMessages && null != s && !s.isVocal() && !J.default.isChannelMuted(s.guild_id, s.id) && J.default.resolvedMessageNotifications(s) === et.UserNotificationSettings.ALL_MESSAGES || !1
    }(r, d, o) && o.mentionCount++
  },
  MESSAGE_DELETE: eG,
  ...
  CHANNEL_SELECT: function(e) {
    let {
      channelId: t
    } = e, n = x.default.getCurrentSidebarChannelId(t), s = B.default.getChannel(t);
    if (null != s) {
      var i;
      let e = eO.get(s.id);
    ...
    ej(ed), ej(eu);
    let r = !1;
    return ed !== t && (r = eK(ed) || r, r = eK(eu) || r), (ed === t || (null == s ? void 0 : s.type) != null && et.ChannelTypesSets.GUILD_THREADS_ONLY.has(s.type)) && (r = ew(t) || r), ed === t && (r = ew(n) || r), ed = t, eu = n, r
  },
  ...
  THREAD_CREATE: function(e) {
    ...
    (function(e) {
      ...
      let t = eO.get(e.id);
      t.lastMessageId = e.lastMessageId, t.lastPinTimestamp = eC(e.lastPinTimestamp), t.syncThreadSettings(), e.ownerId === H.default.getId() && (t.loadedMessages = !0)
    })(t),
    function(e) {
      let t = e.parent_id,
        n = eO.get(t);
  ...
  THREAD_LIST_SYNC: function(e) {
    ...
    t.forEach(e => {
      ...
      let t = eO.get(e.id);
      if (t.lastMessageId = e.lastMessageId, t.lastPinTimestamp = eC(e.lastPinTimestamp), t._isThread = !0, t._isActiveThread = !0, t._isJoinedThread = b.default.hasJoined(e.id), e.isForumPost()) {
  ...
  THREAD_MEMBERS_UPDATE: function(e) {
    return (0, V.doesThreadMembersActionAffectMe)(e) && eO.get(e.id).syncThreadSettings()
  },
  CHANNEL_DELETE: eB,
  THREAD_DELETE: eB,
  ...
  RELATIONSHIP_ADD: function(e) {
    ...
    r < i && (n.lastMessageId = F.default.fromTimestamp(i), (0, A.default.active) ? eq(t.id, er.ReadStateTypes.NOTIFICATION_CENTER, void 0, !1) : s ? n.mentionCount-- : n.mentionCount++)
  },

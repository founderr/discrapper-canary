r(47120), r(653041);
var t = r(735250), a = r(470079), i = r(120356), n = r.n(i), l = r(512722), C = r.n(l), o = r(597312), d = r(442837), c = r(481060), _ = r(232567), x = r(461745), p = r(434650), h = r(210887), f = r(51144), u = r(281494), R = r(276444), m = r(529840), E = r(689938), j = r(953027), L = r(724531), g = r(99713), S = r(334202), A = r(7234);
function M(e) {
    let {numOfSelectedUsers: s} = e, r = (0, d.e7)([R.Z], () => R.Z.getReferralsRemaining());
    C()(null != r, 'Referrals remaining should not be null');
    let a = r - s, i = E.Z.Messages.REFERRAL_PROGRAM_FRIEND_SELECT_HEADER.format({ numReferrals: r });
    return a < r && (i = E.Z.Messages.REFERRAL_PROGRAM_SELECT_MORE_FRIEND.format({ numFriends: a }), 1 === a && (i = E.Z.Messages.REFERRAL_PROGRAM_SELECT_ONE_MORE_FRIEND), 0 === a && (i = E.Z.Messages.REFERRAL_PROGRAM_FRIEND_SELECTION_HIT_LIMIT.format({ numReferrals: r }))), (0, t.jsxs)(t.Fragment, {
        children: [
            (0, t.jsxs)('div', {
                className: j.title,
                children: [
...
function y(e) {
    let {onShare: s} = e, r = (0, d.e7)([R.Z], () => R.Z.getRecipientStatus()), [i, l] = a.useState([]), [C, o] = a.useState(new Set());
    return a.useEffect(() => {
        (async () => {
            let e = [];
            for (let [s, t] of r)
...
s.Z = function (e) {
    ...
    if (w)
        return (0, t.jsx)(v, { onClose: s });
    if (0 === i)
        return (0, t.jsx)(y, { onShare: r });

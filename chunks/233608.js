  ...
  generateChannelPermissionSpec: function(E, S, _, N) {
    ...
    switch (S.type) {
      case D.d4z.GUILD_CATEGORY:
        ;
        return [I.zO(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GENERAL_CATEGORY), I.Ny(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEMBERSHIP), I.vq(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_TEXT, {
          showPrivateThreads: !0,
          showCreateThreads: !0,
          showClydeAIPermissions: H
        }), I.WV(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE), I.xU(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_APPS), ...(R = u.showStageChannelPermissions, A = () => I.kv(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_STAGE), R ? [A()] : []), I.uu(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GUILD_EVENTS)];
      case D.d4z.GUILD_VOICE:
        return [I.zO(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GENERAL_CHANNEL, {
          showManageWebhooks: !0
        }), I.Ny(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEMBERSHIP), I.WV(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE), I.aW(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE_CHAT, {
          sectionDescription: f ? L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE_CHAT_DESCRIPTION.format({
            setUpAutomod: () => {
              M.Z.open(E, D.pNK.GUILD_AUTOMOD)
            }
          }) : void 0
        }), I.uu(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GUILD_EVENTS), I.xU(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_APPS)];
      case D.d4z.GUILD_STAGE_VOICE:
        return [I.zO(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GENERAL_CHANNEL, {
          showManageWebhooks: !1
        }), I.Ny(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEMBERSHIP), I.FX(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE, p), I.kv(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_STAGE), I.uu(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GUILD_EVENTS), I.aW(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE_CHAT, {
          sectionDescription: f ? L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE_CHAT_DESCRIPTION.format({
            setUpAutomod: () => {
              M.Z.open(E, D.pNK.GUILD_AUTOMOD)
            }
      ...
      case D.d4z.GUILD_MEDIA:
        ...
        return [I.zO(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GENERAL_CHANNEL), I.Ny(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEMBERSHIP), I.vq(G, h, {
          ...
          showClydeAIPermissions: H
        }), I.xU(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_APPS), ...(T = c, l = () => I.WV(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE), T ? [l()] : [])];
      default:
        ;
        return [I.zO(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GENERAL_CHANNEL), I.Ny(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEMBERSHIP), I.vq(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_TEXT, {
          showPrivateThreads: S.type !== D.d4z.GUILD_ANNOUNCEMENT,
          showCreateThreads: !0,
          showClydeAIPermissions: H
        }), I.xU(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_APPS), ...(C = c, U = () => I.WV(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE), C ? [U()] : [])]
    }
  },

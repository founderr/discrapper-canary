_(47120);
var I = _(253923), N = _(230711), R = _(581364), O = _(797610), A = _(200876), P = _(456269), t = _(228392), e = _(676317), T = _(467138), M = _(434404), i = _(71275), l = _(60222), s = _(665906), n = _(131704), r = _(430824), C = _(63063), D = _(981631), o = _(71080), L = _(689938);
function a(E) {
    let S = (0, l.A)(E), _ = (0, P.Eg)(E), I = (0, T.P)(E), t = r.Z.getGuild(E), e = null != t && (0, A.l)(t), M = (0, O.M9)(t), i = (0, R.vC)(E, { location: 'get_permission_options' });
    return {
...
S.Z = {
    generateChannelPermissionSpec: function (E, S, _, N) {
        var R, A, T, l, C, U;
        let g = (0, P.Eg)(E), G = (0, o.IG)(S, _, g, N), u = a(E), c = s.tM.getCurrentConfig({
                guildId: E,
                location: '3ad37d_1'
            }).enabled && n.Um.has(S.type), p = (0, i.tu)(E), f = (0, e.ze)(E), d = S.isMediaChannel(), V = r.Z.getGuild(E), H = (0, O.M9)(V);
        switch (S.type) {
        ...
        case D.d4z.GUILD_VOICE:
            return [
                I.zO(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GENERAL_CHANNEL, { showManageWebhooks: !0 }),
                I.Ny(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEMBERSHIP),
                I.WV(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_VOICE),
        ...
        case D.d4z.GUILD_STAGE_VOICE:
            return [
                I.zO(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_GENERAL_CHANNEL, { showManageWebhooks: !1 }),
                I.Ny(G, L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEMBERSHIP),
        ...
        case D.d4z.GUILD_MEDIA:
            ;
            let h = d ? L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEDIA_CHANNEL : L.Z.Messages.ROLE_PERMISSIONS_SECTION_FORUMS, B = d ? L.Z.Messages.ROLE_PERMISSIONS_SECTION_MEDIA_CHANNEL_DESCRIPTION : L.Z.Messages.ROLE_PERMISSIONS_SECTION_FORUMS_DESCRIPTION;
            return [

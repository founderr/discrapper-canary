...
function T(e) {
    ...
    return S && (T || I || A)
        ? (0, i.jsx)(r.MenuItem, {
              id: 'delete-channel',
              label: (() => {
                  if (e.type === _.d4z.GUILD_CATEGORY) return N.Z.Messages.DELETE_CATEGORY;
                  if (e.isForumPost()) return I ? N.Z.Messages.DELETE_FORUM_POST : N.Z.Messages.DELETE_MESSAGE;

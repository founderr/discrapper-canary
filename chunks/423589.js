...
var t = i(442837), s = i(798140), a = i(9156), _ = i(630388), S = i(709054), r = i(312400), o = i(981631), d = i(969943), u = i(526761), l = i(689938);
function E() {
    return [
        {
...
function N(e) {
    ...
    return S.default.keys(e).filter(i => {
        var t, a;
        let S = e[i].message_notifications !== o.bL.NULL, r = _.yE(null !== (t = e[i].flags) && void 0 !== t ? t : 0, u.ic.UNREADS_ALL_MESSAGES) || _.yE(null !== (a = e[i].flags) && void 0 !== a ? a : 0, u.ic.UNREADS_ONLY_MENTIONS);

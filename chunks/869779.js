...
var n = s(735250), l = s(470079), a = s(442837), i = s(481060), r = s(570140), o = s(787014), d = s(37234), c = s(503089), u = s(493544), h = s(367907), m = s(933557), g = s(471445), E = s(351123), T = s(665906), p = s(210887), N = s(131704), _ = s(533947), S = s(277053), x = s(388610), f = s(592125), C = s(496675), I = s(699516), M = s(594174), R = s(585483), Z = s(787263), v = s(975316), O = s(428813), A = s(2147), L = s(856606), b = s(981631), j = s(689938), D = s(242841);
function y(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, s = arguments.length > 2 ? arguments[2] : void 0;
        ...
        return null == l ? null : (0, n.jsx)(c.ZP, {
            ...
            sections: function (e) {
                let {
                        ...
                        canDeleteChannels: r,
                        canManageWebhooks: c
                    } = e, h = (0, g.KS)(t), {GUILD_CATEGORY: T} = b.d4z, p = N.Ec.has(t.type), f = t.type === T ? j.Z.Messages.DELETE_CATEGORY : p ? t.isForumPost() ? j.Z.Messages.DELETE_FORUM_POST : j.Z.Messages.DELETE_THREAD : j.Z.Messages.DELETE_CHANNEL;
                return [
                    {
                        section: u.ID.HEADER,

...
o ? (s.uv.announce(m.Z.Messages.BURST_REACTION_ADD_UNLIMITED_SUCCESS_A11Y.format({
  name: n.name
...
})) : s.uv.announce(m.Z.Messages.REACTION_ADD_SUCCESS_A11Y.format({
  name: n.name
}));
  }).catch(i => {
T(i, () => N(e, t, n, r, {
  ...
  burst: o
}), o ? s.uv.announce(m.Z.Messages.BURST_REACTION_ADD_UNLIMITED_ERROR_A11Y.format({
  name: n.name
})) : s.uv.announce(m.Z.Messages.REACTION_ADD_ERROR_A11Y.format({
  name: n.name
})));
  });
}
...
userId: o,
options: l
  } = e, d = null != l && !!l.burst, _ = null != l && !!l.isRetry;
  g('MESSAGE_REACTION_REMOVE', t, n, r, {
userId: o,
burst: d
  }), await c.Z.unarchiveThreadIfNecessary(t), a.tn.del({
url: S({
  channelId: t,
  messageId: n,
  emoji: r,
...
(null == l ? void 0 : l.burst) ? s.uv.announce(m.Z.Messages.BURST_REACTION_REMOVE_SUCCESS_A11Y.format({
  name: r.name
})): s.uv.announce(m.Z.Messages.REACTION_REMOVE_SUCCESS_A11Y.format({
  name: r.name
}));
  }).catch(async e => {
if (T(e, () => C({
  ...
  g('MESSAGE_REACTION_ADD', t, n, r, {
    ...
    burst: d,
    colors: e
  }), (null == l ? void 0 : l.burst) ? s.uv.announce(m.Z.Messages.BURST_REACTION_REMOVE_ERROR_A11Y.format({
    name: r.name
  })) : s.uv.announce(m.Z.Messages.REACTION_REMOVE_ERROR_A11Y.format({
    name: r.name
  }));
}
  });

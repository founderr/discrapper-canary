...
id: a = 'burst-reaction-toggle-button'
  } = e, g = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), S = E.default.getCurrentUser(), A = null == S || (0, f.I5)(S) ? [u.z.SUPER_REACTION_TOGGLE_EDUCATION_DESKTOP] : [], [N, v] = (0, _.US)(A), [O, R] = i.useState(!1), [C, y] = (0, c.useSpring)(() => ({})), D = (0, o.animated)(c.SuperReactionIcon);
  i.useEffect(() => {

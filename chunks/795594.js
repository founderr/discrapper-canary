        ...
        return (0, n.jsx)(u.Card, {
            ...
            children: (0, n.jsxs)(u.HeadingLevel, {
                ...
                children: [
                    (() => {
                        if (null != s.description && '' !== s.description)
                            return (0, n.jsx)(u.FormItem, {
                                ...
                                children: (0, n.jsx)(u.FormText, { children: s.description })
                            });
                    })(),
                    (() => {
                            ...
                            return (0, n.jsxs)('div', {
                                ...
                                children: [
                                    ...
                                    null != s.privacy_policy_url ? (0, n.jsxs)('div', {
                                        className: Z.privacy,
                                        children: [
                                            null != s.terms_of_service_url ? (0, n.jsx)('div', { className: Z.divider }) : null,
                                            (0, n.jsxs)(E.P, {
                                                tag: 'a',
                                                onClick: d,
                                                className: Z.privacy,
                                ...
                                children: (0, n.jsxs)('ul', {
                                    children: [
                                        e.map((e, t) => (0, n.jsxs)('li', {
                                            ...
                                            children: [
                                                (0, n.jsx)('i', { className: Z.permissionCheckmark }),
                                        ...
                                        null == i ? void 0 : i.map((t, s) => {
                                            ...
                                            return null != a ? (0, n.jsxs)('li', {
                                                className: r()(Z.permission, b.marginTop8),
                                                children: [
                                                    (0, n.jsx)(B, { disclosure: t }),
                                                    (0, n.jsx)(u.FormText, { children: a })
                                                ]
                                            }, s + e.length) : null;
                                        })
                                    ]
                    ...
                    _ && (0, n.jsx)(j, { application: s })
                ]
            })
        });
    };
t.Z = () => {
    let e = (0, d.e7)([O.Z], () => O.Z.hidePersonalInformation), t = (0, d.e7)([g.Z], () => g.Z.getApps()), i = (0, d.e7)([m.ZP], () => m.ZP.getSelfEmbeddedActivities());
    a.useEffect(() => {
        T.Z.fetch();
    }, []);
    let r = e => {

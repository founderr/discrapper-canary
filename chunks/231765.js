...
var n, a, i, r, o = s(735250), l = s(470079), c = s(392711), d = s(442837), _ = s(692547), E = s(481060), u = s(37234), T = s(607070), I = s(206895), S = s(585483), N = s(557177), C = s(57562), m = s(955204), A = s(64078), h = s(351780), g = s(954794), O = s(112843), p = s(524484), R = s(981631), x = s(689938), M = s(944744);
let D = {
        enabled: !0,
        combosEnabled: !0,
        screenshakeEnabled: !1,
        confettiEnabled: !1
    }, f = (0, c.range)(0, 11), P = (0, c.range)(0, 2.25, 0.25), L = (0, c.range)(1, 11), Z = (0, c.range)(1, 26);
...
function j(e) {
    ...
    return (0, o.jsxs)(o.Fragment, {
        children: [
            (0, o.jsx)(E.FormTitle, { children: x.Z.Messages.POGGERMODE_LOCATIONS }),
            i
        ]
    });
}
...
function k(e) {
    ...
    let _ = e => {
            ...
            0 === t && s && r.fire(a.x, a.y, { settings: e });

...
analyticsLocations: m
  ...
  return a.useEffect(() => {
i && !E.current && (E.current = !0, O.default.track(j.rMx.PREMIUM_UPSELL_VIEWED, {
...
icon: i,
...r
  } = e, l = F[n], o = 'pencil' === i ? u.PencilIcon : u.SettingsIcon;
...
hasProfileEffect: k = !1
  } = e, H = (0, o.e7)([p.Z], () => p.Z.getGuild(I)), Y = (0, o.e7)([S.default], () => S.default.getId()) === i.id && y, z = R.ZP.isPremiumAtLeast(null == _ ? void 0 : _.premiumType, U.p9.TIER_2), {
trackUserProfileAction: w
  } = (0, M.KZ)(), [W, V] = a.useState(!1), K = (0, o.e7)([A.Z], () => A.Z.isFocused()), X = N.QK.getSetting(), {
bannerSrc: q,
status: J
  } = (0, x.Z)({
displayProfile: _,
size: (0, g.e7)(L),
canAnimate: F || !X ? W : K
  }), Q = (0, u.useToken)(c.Z.unsafe_rawColors.PRIMARY_800).hex(), $ = (0, u.getAvatarSize)(u.AvatarSizes.SIZE_80), ee = (0, l._i)((0, E.ZP)(i.getAvatarURL(I, $), Q, !1)), es = (0, m.Z)(null !== (s = null == _ ? void 0 : _.primaryColor) && void 0 !== s ? s : ee).hsl, en = (0, T.Z)({
analyticsLocation: {
...
children: (0, t.jsxs)('div', {
  ...
  children: [
    ...
    }) : B && null != q && L !== Z.y0.SETTINGS ? (0, t.jsx)(G, {
      type: L,
      shown: void 0 === O ? W : O,
      onClick: () => {
        w({

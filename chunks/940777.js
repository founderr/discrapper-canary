...
var i = n(735250), l = n(470079), r = n(120356), a = n.n(r), s = n(91192), o = n(442837), c = n(481060), u = n(493683), d = n(239091), h = n(317381), p = n(276952), _ = n(682662), f = n(674552), m = n(593364), g = n(905423), C = n(199902), I = n(592125), E = n(944486), N = n(979651), x = n(709054), S = n(853856), v = n(593214), Z = n(919755), T = n(110977), L = n(603274), A = n(981631), b = n(689938), M = n(908978);
let R = {
    analyticsSource: {
...
function O() {
    let e = (0, s.Ie)('favorites'), {
        ...
        } = (0, v.up)(), [O, y] = l.useState(!1), {
            favoriteServerMuted: P,
            favoriteChannels: j
        } = (0, o.cj)([S.Z], () => ({
            favoriteChannels: S.Z.getFavoriteChannels(),
            favoriteServerMuted: S.Z.favoriteServerMuted
        })), D = (0, o.e7)([E.Z], () => E.Z.getChannelId(A.I_8)), U = (0, o.e7)([I.Z], () => I.Z.getChannel(D)), w = (0, g.Z)(e => e.guildId) === A.I_8, {
            badge: G,
            unread: k
        } = (0, Z.Z)(j), B = function (e) {
            let t = (0, o.e7)([E.Z], () => E.Z.getVoiceChannelId()), n = null != t && null != e[t], i = (0, o.e7)([C.Z], () => {
                    if (!n)
                        return !1;
                    let t = C.Z.getCurrentUserActiveStream();
                    return null != t && null != e[t.channelId];
                }), l = (0, o.e7)([C.Z], () => C.Z.getAllApplicationStreams().some(t => null != e[t.channelId])), r = (0, o.e7)([N.Z], () => n && null != t && N.Z.hasVideo(t), [
                    n,
                    t
        ...
        }(j), V = G > 0 ? (0, m.N)(G) : null, H = l.useCallback(() => {
            r();
        }, [r]);
    return (0, i.jsxs)(_.H, {
        children: [

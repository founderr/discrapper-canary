...
function K(e) {
  ...
  return (0, a.jsxs)(c.TabBar, {
    ...
    children: [(0, a.jsx)(c.TabBar.Item, {
      ...
      children: [H.default.Messages.FAMILY_CENTER_REQUESTS_TAB, s > 0 ? (0, a.jsx)(L.NumberBadge, {
        className: V.badge,
        count: s
      }) : null]
  ...
  return (0, a.jsxs)(S.default, {
    ...
    children: [(0, a.jsx)(S.default.Icon, {
      ...
      children: [(0, a.jsx)(c.TabBar.Item, {
        ...
        className: V.item,
        "aria-label": H.default.Messages.FAMILY_CENTER_REQUESTS_TAB,
        children: [H.default.Messages.FAMILY_CENTER_REQUESTS_TAB, o > 0 ? (0, a.jsx)(L.NumberBadge, {
          className: V.badge,
          count: o
        }) : null]
      })]
...
function q() {
  ...
  return (s.useEffect(() => {
    ...
    l && g && (R.default.track(k.AnalyticEvents.FAMILY_CENTER_VIEWED, {
...
function Q() {
  ...
  } = (0, _.default)(h.default.FAMILY_CENTER), t = (0, D.default)(), n = (0, b.useAcceptedRequestsCount)(), l = (0, m.useIsDismissibleContentDismissed)(d.DismissibleContent.FAMILY_CENTER_NEW_BADGE), r = (0, u.useStateFromStores)([P.default], () => P.default.getIsInitialized()), S = (0, x.useSelectedTeenId)(), v = (0, u.useStateFromStores)([g.default], () => g.default.theme), {
    selectedTab: L,
    handleTabChange: O
  ...
  if (s.useEffect(() => {
      ...
      r && G && (R.default.track(k.AnalyticEvents.FAMILY_CENTER_VIEWED, {
        ...
        selected_teen_id: S,
        initial_page: w.FamilyCenterSubPageAnalyticsIds[L],
        source: w.FamilyCenterPageLocationAnalyticsIds[w.FamilyCenterPageLocation.SIDENAV]
      }), p.default.increment({
        name: o.MetricEvents.FAMILY_CENTER_VIEW
      }))
  ...
  let K = L !== w.FamilyCenterSubPages.SETTINGS ? L : w.FamilyCenterSubPages.ACTIVITY,
    q = W[K];

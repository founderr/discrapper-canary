...
function z(e) {
  ...
  return (0, a.jsxs)(S.default, {
    className: l()((0, O.getThemeClass)(t), V.sidebarTabBar),
...
function q() {
  let e = (0, D.default)(),
    ...
    i = (0, u.useStateFromStores)([M.default], () => M.default.getIsInitialized()),
    ...
    T = i && null != S && !I;
  return (s.useEffect(() => {
    (0, g.trackAppUIViewed)("family-center"), y.default.initialPageLoad(), !n && (0, m.markDismissibleContentAsDismissed)(d.DismissibleContent.FAMILY_CENTER_NEW_BADGE, {
      dismissAction: B.ContentDismissActionType.AUTO,
      forceTrack: !0
    })
  }, []), s.useEffect(() => {
    i && I && (L.default.track(w.AnalyticEvents.FAMILY_CENTER_VIEWED, {
  ...
  }, [i, I]), T) ? ((0, E.openAgeGateModal)(F.AgeGateSource.FAMILY_CENTER), null) : (0, a.jsxs)("main", {
...
function Q() {
  ...
  } = (0, _.default)(h.default.FAMILY_CENTER), t = (0, D.default)(), n = (0, b.useAcceptedRequestsCount)(), i = (0, m.useIsDismissibleContentDismissed)(d.DismissibleContent.FAMILY_CENTER_NEW_BADGE), r = (0, u.useStateFromStores)([M.default], () => M.default.getIsInitialized()), S = (0, x.useSelectedTeenId)(), v = (0, u.useStateFromStores)([I.default], () => I.default.theme), {
    selectedTab: R,
    handleTabChange: O
  } = (0, P.default)(), U = (0, N.useUID)(), j = A.default.getCurrentUser(), G = null != t, Y = r && null != j && !G;
  if (s.useEffect(() => {
      f.setHomeLink(w.Routes.FAMILY_CENTER), (0, g.trackAppUIViewed)("family-center"), !M.default.isLoading() && M.default.canRefetch() && y.default.initialPageLoad(), !i && (0, m.markDismissibleContentAsDismissed)(d.DismissibleContent.FAMILY_CENTER_NEW_BADGE, {
        dismissAction: B.ContentDismissActionType.AUTO,
        forceTrack: !0
      })
    }, []), s.useEffect(() => {
      r && G && (L.default.track(w.AnalyticEvents.FAMILY_CENTER_VIEWED, {

...
function K(e) {
  ...
  return (0, a.jsxs)(c.TabBar, {
    ...
    children: [(0, a.jsx)(c.TabBar.Item, {
      ...
      children: [B.default.Messages.FAMILY_CENTER_REQUESTS_TAB, s > 0 ? (0, a.jsx)(v.NumberBadge, {
        className: V.badge,
        count: s
      }) : null]
  ...
  return (0, a.jsxs)(S.default, {
    ...
    children: [(0, a.jsx)(S.default.Icon, {
      ...
      children: [(0, a.jsx)(c.TabBar.Item, {
        ...
        className: V.item,
        "aria-label": B.default.Messages.FAMILY_CENTER_REQUESTS_TAB,
        children: [B.default.Messages.FAMILY_CENTER_REQUESTS_TAB, o > 0 ? (0, a.jsx)(v.NumberBadge, {
          className: V.badge,
          count: o
        }) : null]
      })]
...
function q() {
  let e = (0, D.default)(),
    ...
    g = l && null != S && !p;
  return (s.useEffect(() => {
    (0, T.trackAppUIViewed)("family-center"), M.default.initialPageLoad(), !n && (0, m.markDismissibleContentAsDismissed)(d.DismissibleContent.FAMILY_CENTER_NEW_BADGE, {
      dismissAction: H.ContentDismissActionType.AUTO,
      forceTrack: !0
    })
  }, []), s.useEffect(() => {
    l && p && (O.default.track(k.AnalyticEvents.FAMILY_CENTER_VIEWED, {
  ...
  }, [l, p]), g) ? ((0, E.openAgeGateModal)(F.AgeGateSource.FAMILY_CENTER), null) : (0, a.jsxs)("main", {
...
function Q() {
  ...
  } = (0, _.default)(h.default.FAMILY_CENTER), t = (0, D.default)(), n = (0, b.useAcceptedRequestsCount)(), l = (0, m.useIsDismissibleContentDismissed)(d.DismissibleContent.FAMILY_CENTER_NEW_BADGE), r = (0, u.useStateFromStores)([P.default], () => P.default.getIsInitialized()), S = (0, x.useSelectedTeenId)(), R = (0, u.useStateFromStores)([p.default], () => p.default.theme), {
    selectedTab: v,
    handleTabChange: L
  } = (0, y.default)(), U = (0, N.useUID)(), j = A.default.getCurrentUser(), G = null != t, Y = r && null != j && !G;
  if (s.useEffect(() => {
      f.setHomeLink(k.Routes.FAMILY_CENTER), (0, T.trackAppUIViewed)("family-center"), !P.default.isLoading() && P.default.canRefetch() && M.default.initialPageLoad(), !l && (0, m.markDismissibleContentAsDismissed)(d.DismissibleContent.FAMILY_CENTER_NEW_BADGE, {
        dismissAction: H.ContentDismissActionType.AUTO,
        forceTrack: !0
      })
    }, []), s.useEffect(() => {
      r && G && (O.default.track(k.AnalyticEvents.FAMILY_CENTER_VIEWED, {
        ...
        selected_teen_id: S,
        initial_page: w.FamilyCenterSubPageAnalyticsIds[v],
        source: w.FamilyCenterPageLocationAnalyticsIds[w.FamilyCenterPageLocation.SIDENAV]
      }), I.default.increment({
        name: o.MetricEvents.FAMILY_CENTER_VIEW
      }))
  ...
  let K = v !== w.FamilyCenterSubPages.SETTINGS ? v : w.FamilyCenterSubPages.ACTIVITY,
    q = W[K];

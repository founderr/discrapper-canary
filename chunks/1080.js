...
function b(e) {
  ...
  let {
    ...
    hideDiscriminator: o,
    onClose: c
  } = e, [u, I] = a.useState(!1), [T, S] = a.useState(null), {
    analyticsLocations: h
  } = (0, N.ZP)(), g = null !== (t = null == h ? void 0 : h[0]) && void 0 !== t ? t : null;
  async function C() {
    if (null != i) {
      S(null), I(!0);
      try {
...
function B() {
  ...
  let {
    ...
    return s
  }, [L]), M = a.useMemo(() => A(h, u, C), [h, A, u, C]), Z = null != h, b = M.length % 1e3 == 0 && M.length > 0 && Z, U = 0 === M.length, [B, y] = a.useState({
    currentPage: 1,
    pageSize: 100
  });
  a.useEffect(() => {
  ...
  let F = a.useCallback(e => {
    ...
    w = a.useCallback(e => {
      var t, n, s;
      if (null === (t = f.current) || void 0 === t || t.scrollToSectionTop(0), (e + 1) * B.pageSize > M.length && b && !E && (H.current = null !== (s = null === (n = M[M.length - 1]) || void 0 === n ? void 0 : n.id) && void 0 !== s ? s : null, F(H.current)), null != k[e - 1] || !!b) y(t => ({
        ...t,
        currentPage: e
      }))
    }, [B.pageSize, M, b, k, F, E]),
    H = a.useRef(null);
  a.useEffect(() => {
    F(H.current)
  }, [F]);
  ...
  return null == i ? null : (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsx)(P, {
      ...
      children: [!U && (0, s.jsx)(G, {
        ...
        children: [(0, s.jsx)(d.EmptyStateImage, {
          darkSrc: n(532747),
          lightSrc: n(433466),
          width: 256,
          height: 212

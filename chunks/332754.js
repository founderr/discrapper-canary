...
t.Z = {
  ...
  handleRequiredAction(e) {
    ...
    if (!_.s.isDisallowPopupsSet() && null != c.default.getCurrentUser()) t === h.c2C.REQUIRE_CAPTCHA || t === h.c2C.REQUIRE_VERIFIED_EMAIL || t === h.c2C.REQUIRE_VERIFIED_PHONE || t === h.c2C.REQUIRE_REVERIFIED_PHONE || t === h.c2C.REQUIRE_REVERIFIED_EMAIL_OR_REVERIFIED_PHONE || t === h.c2C.REQUIRE_VERIFIED_EMAIL_OR_REVERIFIED_PHONE || r.Z.isEmailReverification(t) ? (0, d.q4)(() => (0, i.jsx)(l.ZP, {}), {
      layerKey: "verification",
      Layer: u.ZP
    }) : t === h.c2C.AGREEMENTS ? (0, s.openModal)(e => (0, i.jsx)(E.Z, {
      ...e
    }), {
      modalKey: p,
      onCloseRequest: m.Vq

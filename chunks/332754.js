...
t.default = {
  ...
  handleRequiredAction(e) {
    ...
    !f.ProcessArgs.isDisallowPopupsSet() && null != u.default.getCurrentUser() && (t === C.UserRequiredActions.REQUIRE_CAPTCHA || t === C.UserRequiredActions.REQUIRE_VERIFIED_EMAIL || t === C.UserRequiredActions.REQUIRE_VERIFIED_PHONE || t === C.UserRequiredActions.REQUIRE_REVERIFIED_PHONE || t === C.UserRequiredActions.REQUIRE_REVERIFIED_EMAIL_OR_REVERIFIED_PHONE || t === C.UserRequiredActions.REQUIRE_VERIFIED_EMAIL_OR_REVERIFIED_PHONE || i.default.isEmailReverification(t) ? (0, d.openFullScreenLayer)(() => (0, a.jsx)(r.default, {}), {
      layerKey: "verification",
      Layer: c.default
    }) : t === C.UserRequiredActions.AGREEMENTS ? (0, s.openModal)(e => (0, a.jsx)(E.default, {
      ...e
    }), {
      modalKey: S,

...
function f(e) {
    let t,
        { selectionManager: n, keyboardDelegate: f, ref: _, autoFocus: h = !1, shouldFocusWrap: p = !1, disallowEmptySelection: m = !1, disallowSelectAll: g = !1, selectOnFocus: E = 'replace' === n.selectionBehavior, disallowTypeAhead: v = !1, shouldUseVirtualFocus: I, allowsTabNavigation: S = !1, isVirtualized: b, scrollRef: T = _, linkBehavior: y = 'action' } = e,
        { direction: A } = (0, l.bU)(),
        N = (0, s.tv)(),
        C = (0, i.useRef)({
            top: 0,
    ...
    (0, i.useEffect)(() => {
        ...
        if (n.isFocused && null != n.focusedKey && (null == T ? void 0 : T.current)) {
            ...
            t && ('keyboard' === e || R.current) && (!b && (0, s.zT)(T.current, t), (0, s.Gt)(t, { containingElement: _.current }));
        }
        n.isFocused && null == n.focusedKey && null != O.current && (0, a.ex)(_.current), (O.current = n.focusedKey), (R.current = !1);
    }, [b, T, n.focusedKey, n.isFocused, _]);
    let D = {
            onKeyDown: (e) => {
                var t, i, o, l, d, h, v, I;
                ...
                switch (e.key) {
                    case 'ArrowDown':
                        if (f.getKeyBelow) {
                            ...
                            null == r && p && (r = null === (i = f.getFirstKey) || void 0 === i ? void 0 : i.call(f, n.focusedKey)), b(r);
                        }
                        break;
                    case 'ArrowUp':
                        if (f.getKeyAbove) {
                            ...
                            null == t && p && (t = null === (l = f.getLastKey) || void 0 === l ? void 0 : l.call(f, n.focusedKey)), b(t);
                        }
                        break;
                    case 'ArrowLeft':
                        if (f.getKeyLeftOf) {
                            ...
                            null == t && p && (t = 'rtl' === A ? (null === (d = f.getFirstKey) || void 0 === d ? void 0 : d.call(f, n.focusedKey)) : null === (h = f.getLastKey) || void 0 === h ? void 0 : h.call(f, n.focusedKey)), b(t, 'rtl' === A ? 'first' : 'last');
                        }
                        break;
                    case 'ArrowRight':
                        if (f.getKeyRightOf) {
                            ...
                            null == t && p && (t = 'rtl' === A ? (null === (v = f.getLastKey) || void 0 === v ? void 0 : v.call(f, n.focusedKey)) : null === (I = f.getFirstKey) || void 0 === I ? void 0 : I.call(f, n.focusedKey)), b(t, 'rtl' === A ? 'last' : 'first');
                        }
                        break;
                    case 'Home':
                        if (f.getFirstKey) {
            ...
            onFocus: (e) => {
                ...
                if (e.currentTarget.contains(e.target)) {
                    ...
                    } else !b && ((T.current.scrollTop = C.current.top), (T.current.scrollLeft = C.current.left));

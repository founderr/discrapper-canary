...
t.default = new class e {
  ...
  handleChannelUpdates(e, t) {
    for (let s of e.channels.filter(e => null != e.guild_id)) T(o.default.getBasicChannel(s.id), s) && this.unsync(s.guild_id, t)
  }
  ...
  handleGuildRoleUpdate(e, t) {
    let s = e.role,
      a = u.default.getRole(e.guildId, s.id);
  ...
  onGuildUpdate(e, t, s, a) {
    (s.length > 0 || t.some(e => T(o.default.getBasicChannel(e.id), e))) && this.unsync(e, a)
  }
  onGuildSync(e, t) {
    this.unsync(e, t)
  }
  ...
  syncOne(e, t) {
    var s, a;
    return !(null == u.default.getGuild(e) || (null === (s = this.synced) || void 0 === s ? void 0 : s.has(e))) && (null === (a = this.synced) || void 0 === a || a.add(e), E.default.basicChannelsTransaction(t).put(e, function(e) {

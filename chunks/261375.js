...
t.Z = new class e {
  async getAsync(e) {
    let t = performance.now(),
      ...
      l = new Set(i);
    return this.synced = l, I.verbose("loaded in ".concat(a, "ms (guilds: ").concat(n.length, ", synced: ").concat(l.size, " unsynced: ").concat(r.length, ")")), {
      all: n,
      stale: r,
      channels: n.filter(e => {
        let [t, n] = e;
  ...
  unsync(e, t) {
    var n;
    null === (n = this.synced) || void 0 === n || n.delete(e), E.Z.basicChannelsTransaction(t).delete(e), E.Z.syncedBasicChannelsTransaction(t).put(e, !1), u.Z.invalidate(e)
  }
  sync(e) {

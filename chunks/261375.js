n(47120), n(653041);
var s = n(768433), a = n(710845), r = n(38618), i = n(131704), l = n(314897), o = n(592125), c = n(430824), d = n(496675), _ = n(386438), u = n(287328), E = n(458772);
function T(e, t, n) {
...
t.Z = new class e {
    async getAsync(e) {
        let t = performance.now(), [n, s] = await Promise.all([
                u.Z.basicChannels(e).getKvEntries(),
                u.Z.syncedBasicChannels(e).getKvEntries()
            ]), a = performance.now() - t, [r, i] = function (e) {
                let t = [], n = [];
                for (let [s, a] of e)
                    (a ? t : n).push(s);
                return [
        ...
        return this.synced = l, I.verbose('loaded in '.concat(a, 'ms (guilds: ').concat(n.length, ', synced: ').concat(l.size, ' unsynced: ').concat(i.length, ')')), {
            all: n,
            stale: i,
            channels: n.filter(e => {
                let [t, n] = e;
    ...
    handleChannelUpdates(e, t) {
        for (let n of e.channels.filter(e => null != e.guild_id))
            R(o.Z.getBasicChannel(n.id), n) && this.unsync(n.guild_id, t);
    }
    ...
    handleConnectionOpen(e, t) {
        for (let n of e.guilds)
            this.handleOneGuildCreate(n, t);
    }
    async handlePostConnectionOpen() {
        let e = r.Z.lastTimeConnectedChanged(), t = u.Z.database();
        if (null == this.synced || null == t || !(0, s.O)())
            return;
        let n = c.Z.getGuildIds(), a = n.filter(e => !this.synced.has(e));
        for (let s of (I.verbose('scheduling basic_channel optimstic writes (guilds: '.concat(a.length, ')')), n)) {
            if (null == this.synced || t !== u.Z.database() || e !== r.Z.lastTimeConnectedChanged())
                break;
    ...
    handleGuildRoleUpdate(e, t) {
        let n = e.role, s = c.Z.getRole(e.guildId, n.id);
    ...
    syncOne(e, t) {
        var n, s;
        return !(null == c.Z.getGuild(e) || (null === (n = this.synced) || void 0 === n ? void 0 : n.has(e))) && (null === (s = this.synced) || void 0 === s || s.add(e), u.Z.basicChannelsTransaction(t).put(e, function (e) {

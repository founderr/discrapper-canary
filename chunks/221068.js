...
function $(e) {
  ...
  let n, s, r, {
    ...
    eC = (0, _.useStrangerDangerWarning)(x.id, X.LOCATION_CONTEXT_WEB),
    ep = (0, E.useInappropriateConversationBannerForChannel)(x.id, X.LOCATION_CONTEXT_WEB),
    em = (0, H.default)(),
    eE = null != eC ? eC : ep;
  x.isDM() && null != eE && (n = eE.type === m.SafetyWarningTypes.STRANGER_DANGER ? (0, a.jsx)(S.StrangerDangerWarningBanner, {
    channelId: x.id,
    warningId: eE.id,
  ...
  let eS = null,
    ...
    eA = en.map((e, t) => {
      ...
      e.type === Y.ChannelStreamTypes.MESSAGE && null == eS && (eS = e);
  ...
  if (null == s && (0, o.canSeeChannelSummaries)(x) && eh && em.includes(z.ChatOverlays.SUMMARIES) && (s = (0, a.jsx)(G.TopicsPill, {
      channel: x,
      scrollManager: es

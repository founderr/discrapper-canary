t = r.nmd(t);
var n = function (t) {
    var e = c(9007199254740992), r = '0123456789abcdefghijklmnopqrstuvwxyz', _ = 'function' == typeof BigInt;
    function a(t, e, r, n) {
    ...
    function l(t, e) {
        var r, n, _ = t.length, a = e.length, i = Array(_), o = 0;
        for (n = 0; n < a; n++)
    ...
    function O(t, e, r) {
        var n, _, a = t.length, E = Array(a), s = -e;
        for (n = 0; n < a; n++)
    ...
    i.prototype.subtract = function (t) {
        ...
        var t = this.sign, e = new o(-this.value);
        return e.sign = !t, e;
    ...
    i.prototype.multiply = function (t) {
        var e, r, n, _ = W(t), o = this.value, E = _.value, s = this.sign !== _.sign;
        if (_.isSmall) {
            if (0 === E)
                return a[0];
            if (1 === E)
    ...
    function C(t, e) {
        ...
        var D = t.sign !== s.sign, f = n[1], L = t.sign;
    ...
    i.prototype.divmod = function (t) {
        ...
        var e, r, n, _ = W(t), i = this.value, E = _.value;
        if (0 === E)
            return a[1];
        if (0 === i)
            return a[0];
        ...
        var e = W(t), r = this.value, n = e.value, _ = BigInt(0), i = BigInt(1), o = BigInt(2);
        if (n === _)
            return a[1];
        if (r === _)
            return a[0];
        ...
        if (e.isNegative())
            return new E(_);
        for (var s = this, c = a[1]; (n & i) === i && (c = c.times(s), --n), n !== _;) {
            ;
            n /= o, s = s.square();
        }
        return c;
    ...
    var v = 1073758208;
    function B(t) {
        var e = t.value, r = 'number' == typeof e ? 1073741824 | e : 'bigint' == typeof e ? e | BigInt(1073741824) : e[0] + 10000000 * e[1] | v;
        return r & -r;
    }
    function w(t, e) {
    ...
    i.prototype.bitLength = function () {
        ...
        return (0 > t.compareTo(n(0)) && (t = t.negate().subtract(n(1))), 0 === t.compareTo(n(0))) ? n(0) : n(function t(e, r) {
            if (0 >= r.compareTo(e)) {
                var _ = t(e, r.square(r)), a = _.p, i = _.e, o = a.multiply(r);
    ...
    var K = function (t, e, n, _) {
        ...
        var a, i = t.length, o = Math.abs(e), E = {};
    ...
    return a.one = a[1], a.zero = a[0], a.minusOne = a[-1], a.max = w, a.min = H, a.gcd = Y, a.lcm = function (t, e) {
        ...
        t = W(t), e = W(e);
        var n = r || Math.random, _ = H(t, e), i = w(t, e).subtract(_).add(1);
        if (i.isSmall)

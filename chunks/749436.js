...
})), !t.isSearching && l && I.tI(n, h, u), e.mostRecentQuery !== r && this.setState({
  query: r,
  searchId: (0, p.P)(),
...
super(e), A(this, '_searchRef', s.createRef()), A(this, 'canSearch', e => e.trim().length >= 2 && !(0, g.x)(e)), A(this, 'doSearch', (e, t, n, i) => {
  ...
  this.canSearch(t) && n && e.charCode === f.yXg.ENTER ? (I.tI(i, s), this.doSearch(0, 12, void 0, !0)) : 0 === t.length && e.charCode === f.yXg.ENTER && this.setState({
    isSearching: !1
  });

...
class v extends(i = a.PureComponent) {
  ...
  componentDidUpdate(e, t) {
    ...
    } = this.state, u = this.context, _ = e.isFetchingSearch && !i, E = a !== C.Hk ? a : null;
    (l || d) && _ && (Z({
      loadId: n,
      searchId: o,
      query: c,
  ...
  renderCategories() {
    ...
    return (0, s.jsx)("div", {
      ...
      children: null == t ? void 0 : t.map(t => {
        ...
        return (0, s.jsx)(L, {
          categoryId: n,
          name: n === C.Hk ? S.Z.Messages.GUILD_DISCOVERY_ALL_CATEGORY_FILTER : T.Z.getCategoryName(n),

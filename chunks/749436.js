...
if (null == h.ZP.getSearchIndex() && _.Ue(), I.S.subscribe(S.CkL.GLOBAL_CLIPBOARD_PASTE, this.focusInput), I.S.subscribe(S.CkL.TEXTAREA_FOCUS, this.focusInput), s.length > 0) {
  let l = n !== f.Hk ? n : null;
  v({
    loadId: e,
    searchId: i,
...
} = this.state, u = this.context, _ = e.isFetchingSearch && !i, h = a !== f.Hk ? a : null;
(l || d) && _ && (v({
  loadId: n,
  searchId: o,
  query: c,

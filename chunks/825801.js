...
var r = n(735250);
n(470079);
var i = n(120356), a = n.n(i), o = n(442837), s = n(481060), l = n(607070), u = n(907040), c = n(404975), d = n(785717), _ = n(185923), E = n(689938), f = n(328849);
function h(e) {
    let {
            channel: t,
            isVisible: n,
            isExpandable: i
        } = e, {trackUserProfileAction: h} = (0, d.KZ)(), [p, m] = (0, o.Wu)([l.Z], () => [
            l.Z.useReducedMotion,
            l.Z.keyboardModeEnabled
        ]), I = !i || p || m ? 0 : 300, T = () => {
            h({ action: 'PRESS_REACT' });
        };

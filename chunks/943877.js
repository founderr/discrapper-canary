...
function I(e) {
    ...
    let j = O && Object.keys(B).length >= Object.keys(G).length ? O : D,
        H = (t) => {
            ...
            let n = Object.keys(B),
                i = Object.keys(G);
            null == t ? (R(null), L(p(e.placeholderValue, S, N, T)), Z({})) : n.length >= i.length || (n.length === i.length - 1 && G.dayPeriod && !B.dayPeriod && 'dayPeriod' !== F.current) ? R((t = (0, r.Mw)(t, (null == I ? void 0 : I.calendar) || new r.IQ()))) : L(t), (F.current = null);
        },

...
var l = n("37983"),
  ...
  _ = (0, r.default)(e => {
    ...
    let U = a.useMemo(() => n.filter(e => e.type !== S.ParticipantTypes.ACTIVITY || !e.participants.has(u.default.getId())), [n, r]);
    ...
    if (P === g.ChannelModes.VOICE) return (0, l.jsx)(o.default, {
      guildId: x.guild_id,
      width: L,

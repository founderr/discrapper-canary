...
function L(e) {
  let {
    skuId: t
  } = e, n = S.default.get(t), s = null != n ? I.default.getApplication(n.applicationId) : null;
  return {
    sku: n,
    application: s,
...
let x = (0, m.default)((0, T.default)(R));
t.default = r.default.connectStores(v, L)(x);
let P = (0, T.default)(r.default.connectStores(v, L)(R))
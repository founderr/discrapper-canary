...
function H(e) {
  ...
  }, [eM, eX, j]), eq = (0, s.IX)(W), ez = (0, d.yE)(null !== (t = null == eq ? void 0 : eq.flags) && void 0 !== t ? t : 0, D.udG.EMBEDDED) && (0, d.yE)(null !== (n = null == eq ? void 0 : eq.flags) && void 0 !== n ? n : 0, D.udG.EMBEDDED_IAP), e$ = (0, E.e7)([a.ZP], () => Array.from(a.ZP.getSelfEmbeddedActivities().values()).find(e => {
    let {
      applicationId: t
    } = e;
    return t === W

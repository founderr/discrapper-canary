...
function w(e) {
    var t, n, N;
    let { loadId: h, activeSubscription: Y, stepConfigs: w, breadcrumbs: W = [], skuIDs: g, isGift: V = !1, children: v, defaultPlanId: b, purchaseType: k = H.GZQ.SUBSCRIPTION, applicationId: J, referralCode: X, repeatPurchase: Q = !1 } = e,
        x = (0, F.Z)(),
        j = (0, T.Q)(),
        q = (0, f.Z)(),
        {

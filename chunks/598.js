...
function H(e) {
  ...
  } = (0, P.default)(), [eU, ep] = (0, o.useStateFromStoresArray)([d.default], () => [d.default.purchaseTokenAuthState, d.default.purchaseTokenHash]), [eh, eO] = (0, o.useStateFromStoresArray)([F.default], () => [F.default.browserCheckoutState, F.default.loadId]), [eL, em] = u.useState(null), [ey, eF] = u.useState(null), [eG, eg] = u.useState(null), [eB, eD] = u.useState(null), [eK, eH] = u.useState(null), [ev, eb] = u.useState(void 0), [ew, eY] = u.useState([]), eW = u.useMemo(() => null == eR || (0, I.isPremiumSubscriptionPlan)(eR.id), [eR]), eV = u.useRef(null != D ? D.planId : null);
  u.useEffect(() => {

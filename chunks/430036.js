...
var i = n(735250), s = n(470079), a = n(120356), o = n.n(a), r = n(512722), l = n.n(r), c = n(442837), d = n(481060), u = n(239091), h = n(430742), p = n(904245), f = n(13245), _ = n(144144), g = n(738619), m = n(744061), E = n(36311), Z = n(655687), I = n(823748), S = n(25007), C = n(199649), v = n(1397), x = n(541716), T = n(752305), N = n(974251), O = n(893718), A = n(957730), y = n(400023), R = n(623292), M = n(807092), b = n(592125), L = n(703558), P = n(731290), D = n(430824), w = n(375954), j = n(944486), k = n(914010), V = n(594174), B = n(556296), U = n(237997), z = n(583883), G = n(278297), W = n(547881), Y = n(585483), F = n(838440), H = n(13140), K = n(519591), X = n(906037), Q = n(786906), J = n(987650), q = n(981631), $ = n(689938), ee = n(151087);
function et(e, t, n) {
...
class ei extends s.Component {
    ...
    constructor(e) {
        ...
        super(e), t = this, et(this, 'draftDidChange', function () {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : t.props, {textValue: n} = t.state, i = L.Z.getDraft(e.channel.id, L.d.ChannelMessage);
            ...
            if (e.which === q.yXg.ARROW_UP && !e.shiftKey && !e.altKey && !e.ctrlKey && !e.metaKey && 0 === this.state.textValue.length) {
                e.preventDefault();
                let {channel: t} = this.props, n = w.Z.getLastEditableMessage(t.id);
...
class es extends s.PureComponent {
    ...
    renderContent() {
        ...
        if (null == t)
            return null;
        let _ = l || h, m = !a && null != t && t.isNSFW(), Z = !_ || c;
        return e = m && null != r ? (0, i.jsx)(E.Z, { guild: r }) : (0, i.jsx)(y.Z, {
            channel: t,
    ...
    renderWidgetWrapper(e) {
        ...
        let c = t && !s || a, d = n && (c || s), u = n && s, h = n && c && !s, p = (0, K.Z)(r);
        return (0, i.jsx)(W.ZP, {
            className: o()(p, {
                [ee.widgetWrapper]: !n,
...
function ea(e) {
    let {
        ...
        ]), p = (0, c.e7)([D.Z], () => D.Z.getGuild(s)), f = (0, c.e7)([P.Z], () => null != s && P.Z.didAgree(s)), _ = null != o && o.isPrivate() ? o.getRecipientId() : null, g = (0, c.e7)([M.Z], () => null != a ? M.Z.getPendingReply(a) : void 0), m = (0, c.e7)([V.default], () => null != _ ? V.default.getUser(_) : null), {placeholder: E} = (0, Z.Z)(o);

n(653041), n(536091);
var r, i, a, o, s = n(392711), l = n.n(s), u = n(442837), c = n(570140), d = n(160404), _ = n(592125), E = n(70956), f = n(709054), h = n(977258), p = n(819553), m = n(290511);
let I = {}, T = {}, g = {}, S = !1;
function A(e, t, n) {
    return e.map(e => function (e, t, n) {
        let r = !1, i = [];
        for (let t = 0; t < e.options.length; t++) {
            let a = e.options[t], o = null == n[a.id];
            o && (r = !0), i.push({
                ...a,
                isUnseen: o
            });
...
function N(e) {
    ...
    let {
            guildId: c,
            updates: d
        } = e, _ = null !== (a = null !== (i = d.onboardingPromptsSeen) && void 0 !== i ? i : null === (t = I[c]) || void 0 === t ? void 0 : t.onboardingPromptsSeen) && void 0 !== a ? a : {}, E = null !== (s = null !== (o = d.onboardingResponsesSeen) && void 0 !== o ? o : null === (n = I[c]) || void 0 === n ? void 0 : n.onboardingResponsesSeen) && void 0 !== s ? s : {}, f = A(null !== (u = null !== (l = d.prompts) && void 0 !== l ? l : null === (r = I[c]) || void 0 === r ? void 0 : r.prompts) && void 0 !== u ? u : [], _, E);
    I[c] = {
        ...I[c],
        ...d,
        prompts: f
...
class y extends (r = u.ZP.Store) {
    ...
    ackIdForGuild(e) {
        let t = this.getEnabledOnboardingPrompts(e), n = '0';
        return t.forEach(e => {
            e.options.forEach(e => {
...
o = 'GuildOnboardingPromptsStore', (a = 'displayName') in (i = y) ? Object.defineProperty(i, a, {
    value: o,
    enumerable: !0,
    configurable: !0,
    writable: !0
    ...
    GUILD_ONBOARDING_PROMPTS_FETCH_SUCCESS: function (e) {
        ...
        S = !1;
        let c = p.ZP.getOnboardingStatus(t) === p.uX.READY, d = A(n, o, s);
        I[t] = {
            enabled: i,
            mode: l,
            belowRequirements: u,
    ...
    GUILD_ONBOARDING_SELECT_OPTION: function (e) {
        ...
        return !!d.Z.isFullServerPreview(t) || null != I[t] && (null != i && i.length > 0 && l().pullAll(I[t].responses, i), r ? I[t].responses.push(n) : l().pull(I[t].responses, n), null == T[t] && (T[t] = {}), T[t][n] = r, null != i && i.forEach(e => T[t][e] = !1), T[t] = { ...T[t] }, !0);
    },

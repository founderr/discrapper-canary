...
function v() {
  Date.now() - I > h.OSm || N() ? m || l.Z.dispatch({
type: 'IDLE',
idle: !0,
idleSince: I
  }) : m && l.Z.dispatch({
type: 'IDLE',
idle: !1
  }), Date.now() - I > Math.min(d.CM.getSetting() * _.Z.Millis.SECOND, h.OSm) || N() ? T || l.Z.dispatch({
type: 'AFK',
afk: !0
  }) : T && l.Z.dispatch({
type: 'AFK',
afk: !1
  ...
  var t;
  let n = t => {
I = Math.max(Date.now() - t, I), v(), setTimeout(e, 10 * _.Z.Millis.SECOND);
  };
...
type: n
  ...
  return (!r || !(t <= I)) && (I = r ? t : Date.now(), __OVERLAY__ ? l.Z.dispatch({
...
return A = t === h.$7l.BACKGROUND, I = Date.now(), v(), !1;
  },

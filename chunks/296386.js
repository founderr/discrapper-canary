...
var a = t(544891), r = t(570140), i = t(706454), s = t(683301), o = t(150192), l = t(981631);
async function c() {
    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], t = i.default.locale, c = n && !s.ZP.getIsReady();
    if (t === o.Z.getFetchedLocale() && !c)
        return;

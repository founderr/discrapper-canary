...
function K(e) {
  ...
  let {
    message: n,
    compact: l
  } = e, i = P.default.getUser((0, C.getUserIdOfAutomodAction)(n)), r = null === (t = L.default.getBasicChannel(n.channel_id)) || void 0 === t ? void 0 : t.guild_id, u = null != r && null != i, d = u ? v.default.getMember(r, i.id) : null, {
    avatarSrc: c,

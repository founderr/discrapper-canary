...
t.Z = function () {
    let e = (0, o.e7)([M.ZP], () => M.ZP.getPremiumTypeSubscription()), t = (0, S.Z)({ subscriptionFilter: e => j.eS.has(e.status) }), s = t.length > 1, i = (0, o.e7)([x.Z], () => null != e && null != e.paymentSourceId ? x.Z.getPaymentSource(e.paymentSourceId) : null, [e]), E = (0, o.e7)([M.ZP], () => M.ZP.hasFetchedSubscriptions()), f = (0, o.e7)([R.Z], () => R.Z.isBusy), D = (0, N.V)(), P = (0, o.e7)([p.Z], () => p.Z.getSubsection());
    return (a.useEffect(() => (c.Z.wait(() => {
        (0, u.Y2)(), d.jg(), (0, _.X8)(), d.tZ();
    }), function () {
        T.Z.clearSubsection();
    }), []), O.Z.enabled) ? (0, n.jsx)(I.Z, {}) : E && D ? P === G.cP ? (0, n.jsx)(m.Z, { onGoBack: () => T.Z.clearSubsection() }) : P === G.XZ ? (0, n.jsx)(h.Z, { onGoBack: () => T.Z.clearSubsection() }) : (0, n.jsx)('div', {

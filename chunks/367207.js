...
var i = n(735250);
n(470079);
var l = n(392711), r = n(848246), a = n(481060), s = n(570140), o = n(904245), c = n(317770), u = n(100527), d = n(358221), h = n(963249), p = n(592125), _ = n(430824), f = n(594174), m = n(295226), g = n(626135), C = n(74538), I = n(557457), E = n(970645), N = n(30684), x = n(736871), S = n(6242), v = n(757692), Z = n(114064), T = n(684259), L = n(937579), A = n(485731), b = n(1163), M = n(841174), R = n(11352), O = n(474936), y = n(981631), P = n(354459), j = n(37113), D = n(689938);
function U(e, t, n) {
...
class w extends c.Z {
    ...
    maybeShowHDStreamingPerksDemoPostUpsellModal(e) {
        var t;
        let {inPerksDemosExperiment: n} = x.Z.getCurrentConfig({ location: 'PremiumManager' }, { autoTrackExposure: !1 }), {enabled: i} = b.Z.getCurrentConfig({ location: 'PremiumManager' }, { autoTrackExposure: !1 });
        if (!n || !i || e.state !== y.hes.DISCONNECTED || e.willReconnect)
            return;
        let l = p.Z.getChannel(e.channelId);
        if (null == l || !(null === (t = Z.Z.getPerksDemos()) || void 0 === t ? void 0 : t[r.q.STREAM_HIGH_QUALITY]))
            return;
        let a = Z.Z.getActivated()[r.q.STREAM_HIGH_QUALITY];
        if (a && s.Z.dispatch({
                type: 'PREMIUM_PERKS_DEMO_COMPLETE',
                perkType: r.q.STREAM_HIGH_QUALITY
            }), !!a && !!A.j$.getState().hqStreamingDidEnable)
            (0, M.Z)(l.guild_id);
    }
    constructor(...e) {
        super(...e), U(this, '_premiumPaymentModalCloseResolve', null), U(this, '_premiumPaymentModalCloseReject', null), U(this, '_lastStreamingChannelId', null), U(this, '_maybeFetchPremiumOffer', async () => {
            ...
            R.Y.trackExposure({ location: 'PremiumManager' });
        }), U(this, '_trackSkyLoadExposure', () => {
            T.Z.trackExposure({ location: 'PremiumManager' });
            ...
            var i, l;
            let r = d.Z.getSelectedParticipant(e), a = (0, v.o)(r, n), {sendNitroMessage: s} = (0, S.TD)(a), c = null !== (l = null === (i = _.Z.getGuild(t)) || void 0 === i ? void 0 : i.premiumTier) && void 0 !== l ? l : y.Eu4.NONE;
            if (!!s && !(c >= y.Eu4.TIER_2) && (null == r ? void 0 : r.type) === P.fO.STREAM && (null == r ? void 0 : r.id) !== (null == n ? void 0 : n.id) && null != r.maxResolution && null != r.maxFrameRate) {

n(47120);
var s = n(544891), r = n(570140), i = n(893776), a = n(899742), l = n(743142), o = n(117240), c = n(626135), u = n(317770), d = n(981631);
function h(e, t) {
...
class _ extends u.Z {
    ...
    handleHandoff(e) {
        ...
        }) : null != r ? (i.Z.setFingerprint(r), h(!1, o), (0, a.lx)()) : (i.Z.setFingerprint(r), (0, a.by)());
    }
    constructor(...e) {
        var t, n, s;
        super(...e), t = this, n = 'handleEnd', s = e => {
            ...
            null != s && o.Z.isHandoffAvailable() ? this.handleHandoff({
                handoffKey: s,
                handoffToken: t,
                fingerprint: n,

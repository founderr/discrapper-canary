...
function a(e, t) {
    ...
    r.useLayoutEffect(() => {
        let n = e.current, r = null == n ? void 0 : n.ownerDocument.defaultView;
        if (null != n && null != r) {
            let i = new r.ResizeObserver(n => {
                var r, i, a, o, s, l;
                let u = n[0], c = null == u ? void 0 : null === (i = u.borderBoxSize) || void 0 === i ? void 0 : null === (r = i[0]) || void 0 === r ? void 0 : r.inlineSize, d = null == u ? void 0 : null === (o = u.borderBoxSize) || void 0 === o ? void 0 : null === (a = o[0]) || void 0 === a ? void 0 : a.blockSize;
                if (null == c || null == d) {
                    let t = e.current;
                    if (null != t) {

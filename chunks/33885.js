...
function N(e) {
  ...
  } = e, n = (0, l.e7)([d.Z], () => d.Z.getGuildId(), []), N = (0, l.e7)([u.Z], () => u.Z.getGuild(n), [n]);
  return (i.useEffect(() => {
    (0, o.kk)(a.z.GUILD_ONBOARDING_UPSELL_NAGBAR)
  }, []), null == N) ? null : (0, s.jsxs)(r.Notice, {
    ...
    children: [(0, s.jsx)(r.NoticeCloseButton, {
      onClick: () => {
        E.default.track(I.rMx.UPSELL_CLICKED, {
          ...
          action: "dismiss"
        }), t(), (0, _.G)(N.id, a.z.GUILD_ONBOARDING_UPSELL_NAGBAR)
      }
      ...
      onClick: () => {
        E.default.track(I.rMx.UPSELL_CLICKED, {
          type: a.z[a.z.GUILD_ONBOARDING_UPSELL_NAGBAR],
          action: "primary"
        }), c.Z.open(N.id, I.pNK.ONBOARDING), (0, _.G)(N.id, a.z.GUILD_ONBOARDING_UPSELL_NAGBAR)
      },

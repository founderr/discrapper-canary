...
t.default = e => {
  let {
    ...
    return _
  }), [j, M] = r.useState(!1), O = _ === b ? L : f.CLAN_BADGE_PALETTE_PRESETS[b];
  return r.useEffect(() => {
    if (A === n && O.primary === s && O.secondary === x) return;
  ...
  }, [t, A, O.primary, O.secondary, N, n, s, x]), (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsxs)("div", {
          ...
          children: [(0, a.jsx)(c.Text, {
            ...
            children: [f.CLAN_BADGE_PALETTE_PRESETS.map((e, t) => (0, a.jsx)(c.Clickable, {
              onClick: () => {
                y(t), R(f.CLAN_BADGE_PALETTE_PRESETS[t])
              },
              className: i()(p.badgeAssetContainer, {
                [p.badgeAssetContainerSelected]: t === b
              }),
              children: (0, a.jsx)(d.ClanBadge, {
                badge: A,
                width: 32,
              ...
              children: e => (0, a.jsx)(c.Clickable, {
                ...
                className: i()(p.badgeAssetContainer, {
                  [p.badgeAssetContainerSelected]: _ === b
                }),

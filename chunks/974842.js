...
t.default = e => {
  let {
    ...
    error: I,
    furthestStep: N
  } = e, v = r.useRef(null), [A, S] = r.useState(n), [L, y] = r.useState({
  ...
  return r.useEffect(() => {
    if (A === n && O.primary === s && O.secondary === _) return;
  ...
  }, [t, A, O.primary, O.secondary, N, n, s, _]), (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsxs)("div", {
          ...
          children: [(0, a.jsx)(c.Text, {
            ...
            children: [f.CLAN_BADGE_PALETTE_PRESETS.map((e, t) => (0, a.jsx)(c.Clickable, {
              onClick: () => {
                b(t), y(f.CLAN_BADGE_PALETTE_PRESETS[t])
              },
              className: i()(p.badgeAssetContainer, {

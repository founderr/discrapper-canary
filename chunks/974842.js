t(47120);
var a = t(735250), r = t(470079), i = t(688619), s = t.n(i), o = t(120356), l = t.n(o), c = t(866442), d = t(481060), u = t(550271), m = t(688298), f = t(995119), C = t(116175), _ = t(308083), h = t(689938), x = t(802975), g = t(360884);
let p = [
    C.ZD.SWORD,
    C.ZD.WATER_DROP,
    C.ZD.SKULL,
...
n.Z = e => {
    ...
    let v = r.useMemo(() => {
            ...
            N.primary,
            N.secondary
        ]), [y, S] = r.useState(!1), A = r.useCallback(() => {
            let e = p[Math.floor(Math.random() * p.length)], t = s().random().hex();
            n({
                badgeKind: e,
                badgePrimaryColor: t,

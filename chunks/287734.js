n.r(t);
var r = n(570140), i = n(254238), a = n(258609);
n(473241);
var o = n(788983), s = n(703656), l = n(700615), u = n(592125), c = n(731290), d = n(131951), _ = n(944486), E = n(914010), f = n(594174), h = n(934415), p = n(604151), m = n(981631);
t.default = {
    selectChannel(e) {
        let {
            guildId: t,
    ...
    selectVoiceChannel(e) {
        var t;
        let n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = u.Z.getChannel(e), a = null == i ? void 0 : i.getGuildId();
    ...
    disconnect() {
        ...
        if (null != e && i._(e), (0, l.ur)())
            ...
            let e = u.Z.getChannel(_.Z.getChannelId()), t = _.Z.getChannelId() === _.Z.getVoiceChannelId() && (null == e ? void 0 : e.isThread()) === !0;

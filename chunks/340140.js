t.r(s), t(47120);
var a = t(735250), l = t(470079), n = t(481060), o = t(285952), r = t(538211), _ = t(698066), i = t(111810), E = t(689938), R = t(190899), u = t(425060);
function c(e, s, t) {
...
class M extends l.PureComponent {
    render() {
        let {
                ...
                transitionState: s,
                onClose: t
            } = this.props, {problem: l} = this.state;
    ...
    constructor(...e) {
        super(...e), c(this, 'state', { problem: null }), c(this, 'handleChanged', e => {
            ...
            let {
                    ...
                    analyticsData: l,
                    onClose: o
                } = this.props, {problem: r} = this.state;
            (0, _.Z)({
                problem: r,
                stream: e,
                feedback: '',

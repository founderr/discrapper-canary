...
function k(e) {
    var t, r, a, n, s = (t = e.theme, r = e, (n = Object.keys(a = {
            ...
            return r[e];
        })).length > 0 && (t = 'string' == typeof t ? { extend: t } : O({}, t), n.forEach(function (e) {
...
var E = function (e) {
    ...
    return (0, o.Z)(b, [
        ...
        },
        {
            key: 'render',
            value: function () {
                var e = this.props, t = e.data, r = e.keyPath, s = e.postprocessValue, o = e.hideRoot, i = (e.theme, e.invertTheme, (0, n.Z)(e, v)), c = this.state.styling;

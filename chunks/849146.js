var r = function () {
    ...
    }(), i = 'undefined' != typeof window && 'undefined' != typeof document && window.document === document, o = void 0 !== n.g && n.g.Math === Math ? n.g : 'undefined' != typeof self && self.Math === Math ? self : 'undefined' != typeof window && window.Math === Math ? window : Function('return this')(), s = 'function' == typeof requestAnimationFrame ? requestAnimationFrame.bind(o) : function (t) {
        ...
        'size',
        'weight'
    ], a = 'undefined' != typeof MutationObserver, h = function () {
        function t() {
        ...
        return t.prototype.addObserver = function (t) {
            ...
            if (!!i && !this.connected_)
                document.addEventListener('transitionend', this.onTransitionEnd_), window.addEventListener('resize', this.refresh), a ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
                    attributes: !0,
                    childList: !0,
                    characterData: !0,
                    subtree: !0
...
var b = function () {
        ...
        return t.prototype.isActive = function () {
            var t = function (t) {
                ...
                return function (t) {
                    ...
                    if (!e && !n)
                        return d;
                    var r = f(t).getComputedStyle(t), i = function (t) {
                            for (var e = {}, n = 0, r = [
                                        'top',
                                        'right',
                                        'bottom',
                            ...
                            return e;
                        }(r), o = i.left + i.right, s = i.top + i.bottom, c = p(r.width), a = p(r.height);
                    if ('border-box' === r.boxSizing && (Math.round(c + o) !== e && (c -= v(r, 'left', 'right') + o), Math.round(a + s) !== n && (a -= v(r, 'top', 'bottom') + s)), !function (t) {
                        ...
                        var h = Math.round(c + o) - e, u = Math.round(a + s) - n;
        ...
        var n, r, i, o, s, c, a = (r = (n = e).x, i = n.y, o = n.width, s = n.height, u(c = Object.create(('undefined' != typeof DOMRectReadOnly ? DOMRectReadOnly : Object).prototype), {
                x: r,
                y: i,
                width: o,
                height: s,
        ...
        return t.prototype.observe = function (t) {
            ...
            if (!e.has(t))
                e.set(t, new b(t)), this.controller_.addObserver(this), this.controller_.refresh();
    ...
    }(), g = 'undefined' != typeof WeakMap ? new WeakMap() : new r(), w = function t(e) {

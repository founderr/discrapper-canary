e.exports = function (e, t) {
    var n, r, i, a, s, o, l, u, c, d, _, E, f, h, p, I, m, T, g, S, A, N, O, R, v;
    ...
    n: do
        for (f < 15 && ((E += R[r++] << f), (f += 8), (E += R[r++] << f), (f += 8)), T = h[E & I]; ; ) {
            if (((E >>>= g = T >>> 24), (f -= g), 0 == (g = (T >>> 16) & 255))) v[a++] = 65535 & T;
            else if (16 & g)
                for (S = 65535 & T, (g &= 15) && (f < g && ((E += R[r++] << f), (f += 8)), (S += E & ((1 << g) - 1)), (E >>>= g), (f -= g)), f < 15 && ((E += R[r++] << f), (f += 8), (E += R[r++] << f), (f += 8)), T = p[E & m]; ; ) {
                    if (((E >>>= g = T >>> 24), (f -= g), 16 & (g = (T >>> 16) & 255))) {
                        if (((A = 65535 & T), f < (g &= 15) && ((E += R[r++] << f), (f += 8) < g && ((E += R[r++] << f), (f += 8))), (A += E & ((1 << g) - 1)) > l)) {
                        ...
                        if (((E >>>= g), (f -= g), A > (g = a - s))) {
                            ...
                            for (; S > 2; ) (v[a++] = O[N++]), (v[a++] = O[N++]), (v[a++] = O[N++]), (S -= 3);
                            S && ((v[a++] = O[N++]), S > 1 && (v[a++] = O[N++]));
                        } else {
                            N = a - A;
                            do (v[a++] = v[N++]), (v[a++] = v[N++]), (v[a++] = v[N++]), (S -= 3);
                            while (S > 2);
                            S && ((v[a++] = v[N++]), S > 1 && (v[a++] = v[N++]));
                        }
                    } else if ((64 & g) == 0) {
                        T = p[(65535 & T) + (E & ((1 << g) - 1))];
                        continue;

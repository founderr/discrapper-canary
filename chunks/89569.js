...
let d = "".concat("#").concat("itemSkuId", "="),
  ...
  C = e => {
    ...
    } = e, m = s.useRef(null), p = (0, r.useLocation)(), C = p.pathname === u.Routes.COLLECTIBLES_SHOP ? n.default.HOME_PAGE_SHOP_TAB : p.pathname === u.Routes.COLLECTIBLES_SHOP_FULLSCREEN ? n.default.COLLECTIBLES_SHOP_FULLSCREEN : n.default.COLLECTIBLES_SHOP, {

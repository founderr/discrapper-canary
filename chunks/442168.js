...
var i = n(735250), a = n(470079), l = n(338545), s = n(442837), r = n(780384), o = n(435064), c = n(39604), d = n(175470), u = n(569545), h = n(153850), p = n(420576);
...
function C(e) {
    let {
            stream: t,
            inPopout: n
        } = e, {reducedMotion: C} = a.useContext(r.Sf), g = (0, a.useRef)(null), I = d.n.getState().clipsButtonRef, x = (0, u.V9)(t), T = (0, s.e7)([o.Z], () => o.Z.getActiveAnimation()), v = (0, s.Wu)([o.Z], () => o.Z.getStreamClipAnimations(x)), N = (0, a.useRef)();
    a.useEffect(() => () => {
        (0, c.Gh)(x);
    }, [x]);
    let S = () => {
        ...
        }, A = (0, a.useRef)(null), M = (0, l.useTransition)(v, {
            keys: e => e.timestamp,
            ref: A,
            from: { opacity: 0.2 },
            enter: { opacity: 0 },
            config: _
        }), b = (0, a.useRef)(null), R = (0, l.useTransition)(v, {
            ref: b,
            keys: e => e.timestamp,
            from: e => ({
                position: 'fixed',

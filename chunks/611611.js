...
var t = n(735250), r = n(470079), l = n(120356), s = n.n(l), o = n(525769), i = n(263568), c = n(481060), u = n(213609), d = n(542383), _ = n(153124), m = n(79390), E = n(728076), A = n(2466), f = n(485168), C = n(309081), L = n(185306), h = n(759970), R = n(489887), I = n(20281), x = n(689938), p = n(314467);
let O = (0, _.hQ)(), g = (0, _.hQ)();
function T(e) {
    let {
            question: a,
            onChange: n,
...
function P(e) {
    ...
    let A = r.useRef(null), g = r.useRef([]), v = r.useRef([]), j = r.useRef(null), D = r.useRef([]), M = r.useCallback(e => {
            var a, n, t, r;
            let {
                indexToRemove: l,
                numberOfAnswers: s
        ...
        } = (0, E.Z)(a, l, M), {trackPollCreationCancelled: ea} = (0, f.l)(w, Z, b), en = r.useRef(w.length), et = b === i.C.DEFAULT, er = r.useCallback(() => {
            ea(), l();
        }, [
            l,
            ea

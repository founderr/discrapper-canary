...
function b(e) {
  ...
  let {
  ...
  })), f = (0, s.useStateFromStores)([C.default], () => C.default.getVoiceStates(n)), N = (0, s.useStateFromStores)([g.default], () => g.default.getCollapsed()), {
    scrollTo: _
    ...
    return t
  }), x = (0, s.useStateFromStores)([O.default], () => O.default.getVoiceChannelId()), L = (0, s.useStateFromStores)([I.default], () => I.default.getGuildVersion(n)), M = (0, s.useStateFromStores)([p.default], () => p.default.version), D = (0, s.useStateFromStores)([v.default], () => v.default.getGuildChangeSentinel(n)), j = (0, r.useEmbeddedAppsByChannel)(null == a ? void 0 : a.id), b = (0, d.useActiveEventsByChannel)(null == a ? void 0 : a.id), k = null !== (t = null == a ? void 0 : a.hasFeature(R.GuildFeatures.COMMUNITY)) && void 0 !== t && t;
  return (0, i.jsx)(P, {
    guildId: n,
    guild: a,
    channels: l,

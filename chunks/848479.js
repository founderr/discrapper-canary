n(724458);
var r = n(259443), i = n(579806), a = n(77450), o = n(998502);
let s = new r.Y('ProcessUtilsElectron');
class l extends a.h {
    setupReportingTimer() {
        var e, t;
        ...
        (null === (t = performance.memory) || void 0 === t ? void 0 : t.usedJSHeapSize) == null && s.error('usedJSHeapSize is not available.');
        setInterval(() => {
            var e, t, r;
    ...
    constructor() {
        var e, t, n, r, a;
        super(), n = this, a = void 0, (r = 'lastMemoryUsageKB') in n ? Object.defineProperty(n, r, {
            value: a,
            enumerable: !0,
            configurable: !0,
            writable: !0
        }) : n[r] = a, this.cpuCoreCount = null === i.Z || void 0 === i.Z ? void 0 : null === (t = i.Z.processUtils) || void 0 === t ? void 0 : null === (e = t.getCPUCoreCount) || void 0 === e ? void 0 : e.call(t), this.setupReportingTimer();
    }
}
t.Z = new l();

...
var r, i, a, o, s, l, u, c, d = n(379649), _ = n(909766), E = n(179654);
function f(e, t, n) {
...
(s = r || (r = {})).H264 = 'H264', s.H265 = 'H265', s.VP8 = 'VP8', s.VP9 = 'VP9', s.AV1 = 'AV1', s.UNKNOWN = 'UNKNOWN', (l = i || (i = {})).NVIDIA_CUDA = 'nvidia_cuda', l.NVIDIA_DIRECT_3D = 'nvidia_direct_3d', l.OPENH264 = 'openh264', l.VIDEOTOOLBOX = 'videotoolbox', l.AMD_DIRECT_3D = 'amd_direct_3d', l.INTEL = 'intel', l.INTEL_DIRECT_3D = 'intel_direct_3d', l.VP8_LIBVPX = 'vp8_libvpx', l.UNCATEGORIZED = 'uncategorized', l.UNKNOWN = 'unknown', (u = a || (a = {})).VIDEOTOOLBOX = 'videotoolbox', u.VP8_LIBVPX = 'vp8_libvpx', u.ELECTRON = 'electron', u.FFMPEG = 'ffmpeg', u.DAV1D = 'dav1d', u.UNCATEGORIZED = 'uncategorized', u.UNKNOWN = 'unknown';
let T = Object.freeze({
...
(c = o || (o = {}))[c.None = 0] = 'None', c[c.ClientSideDisableVideo = 1] = 'ClientSideDisableVideo', c[c.SenderStopped = 2] = 'SenderStopped';
function A(e) {
    if (null == e)
        return 'UNKNOWN';
    if ('H264' === (e = e.toUpperCase()))
        return 'H264';
    if ('H265' === e)
        return 'H265';
    if ('VP8' === e)
...
class N {
    ...
    static parseOutboundStats(e, t) {
        var n, r, i, a, o, s, l, u, c, d, _, E, f, h, p, m, I, T, g, v;
        let O = new N();
        return null == e ? O : {
            bytes: e.bytesSent,
...
class v {
    ...
    appendAndIncrementStats(e) {
        ...
        if (this.statsWindow.push(e), this.statsWindow.length < 2)
            return;
        let t = this.statsWindow[this.statsWindow.length - 1], n = this.statsWindow[this.statsWindow.length - 2];
        ...
        let g = (a - T) / 1000, S = (r - f) * 8 / g, A = (i - I) / g;
        h.forEach(e => {
            S <= e && (this.bitrateBuckets[e] += E);
        }), p.forEach(e => {
            A <= e && (this.fpsBuckets[e] += E);
        }), this.resolutionHistogram.addSample(o), this.bitrateHistogram.addSample(S), this.fpsHistogram.addSample(A), this.statsWindow.shift();
    }
    addSystemResources() {
    ...
    constructor(e) {
        f(this, 'decoderBuckets', {
            ...
            AV1: 0,
            UNKNOWN: 0
        }), f(this, 'statsWindow', []), f(this, 'fpsHistogram', new _.b()), f(this, 'bitrateHistogram', new _.b()), f(this, 'inboundBitrateEstimateHistogram', new _.b()), f(this, 'resolutionHistogram', new _.b()), f(this, 'systemResources', new E.Z()), f(this, 'decoderCodec', 'UNKNOWN'), f(this, 'startTime', void 0), f(this, 'timeToFirstFrame', void 0), f(this, 'aggregatedProperties', {
            framesCodec: 0,
            framesNetwork: 0,
            packets: 0,
            packetsLost: 0,
        ...
        }), f(this, 'aggregationDuration', 0), f(this, 'bitrateBuckets', {}), f(this, 'fpsBuckets', {}), f(this, 'resolutionBuckets', {}), f(this, 'resolutionTotal', 0), f(this, 'minorResolutionTotal', 0), f(this, 'majorResolutionTotal', 0), f(this, 'intervalTotal', 0), f(this, 'cryptorMaxAttempts', 0), f(this, 'videoStoppedWatch', void 0), f(this, 'videoStoppedReason', 0), this.startTime = e.now(), this.videoStoppedWatch = new d.G9(e), h.forEach(e => {

...
t.default = o().throttle(function(e, t) {
  var l, o;
  let u, {
    ...
    O = null !== (l = s.default.getState().guildId) && void 0 !== l ? l : C.ME,
  ...
  for (; null != O && "" !== O;) {
    if (u = L[D], T(O))
      for (; null != u && "" !== u;) {
        ...
        } else if ("object" == typeof u && f(u.resourceId, u.type)) return O !== r.default.getGuildId() && (0, A.transitionToChannel)(O, null === (o = d.default.getDefaultChannel(O)) || void 0 === o ? void 0 : o.id), (0, a.openModalLazy)(async () => {
          let {
            default: e

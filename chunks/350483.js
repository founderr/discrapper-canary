  ...
  for (; null != N && "" !== N;) {
    if (a = p[D], T(N))
      for (; null != a && "" !== a;) {
        ...
        } else if ("object" == typeof a && I(a.resourceId, a.type)) return N !== r.default.getGuildId() && (0, A.transitionToChannel)(N, null === (l = d.default.getDefaultChannel(N)) || void 0 === l ? void 0 : l.id), (0, u.openModalLazy)(async () => {
          let {
            default: e

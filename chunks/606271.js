...
class L {
    ...
    handleRelationshipRemove(e) {
        ...
        if (0 !== this.rpcServer.subscriptions.length) this.rpcServer.dispatchToSubscriptions(x.zMe.RELATIONSHIP_UPDATE, {}, (0, N.cD)(x.OGo.NONE, t));
    }
    handlePresenceUpdate(e) {
        ...
        if (0 !== this.rpcServer.subscriptions.length)
            t.forEach((e) => {
                ...
                i === x.OGo.NONE && o.Z.getUserAffinitiesUserIds().has(n) && (i = x.OGo.IMPLICIT), i !== x.OGo.NONE && this.rpcServer.dispatchToSubscriptions(x.zMe.RELATIONSHIP_UPDATE, {}, (0, N.cD)(i, n));
            });
    }
    handlePresencesReplace() {
        if (0 !== this.rpcServer.subscriptions.length)
            r().forEach(g.Z.getRelationships(), (e, t) => {
                this.rpcServer.dispatchToSubscriptions(x.zMe.RELATIONSHIP_UPDATE, {}, (0, N.cD)(e, t));
            });
    }

    ...
    handlePresenceUpdate(e) {
        ...
        if (0 !== this.rpcServer.subscriptions.length)
            t.forEach((e) => {
                ...
                i === b.OGo.NONE && o.Z.getUserAffinitiesUserIds().has(n) && (i = b.OGo.IMPLICIT), i !== b.OGo.NONE && this.rpcServer.dispatchToSubscriptions(b.zMe.RELATIONSHIP_UPDATE, {}, (0, N.cD)(i, n));
            });
    }

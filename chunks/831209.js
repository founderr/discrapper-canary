...
((r = n || (n = {})).ACTION_SHEET_GRADIENT_BG = 'var(--action-sheet-gradient-bg)'),
    ...
    (r.BACKGROUND_BASE_LOW = 'var(--background-base-low)'),
    (r.BACKGROUND_BASE_LOWER = 'var(--background-base-lower)'),
    (r.BACKGROUND_BASE_LOWEST = 'var(--background-base-lowest)'),
    ...
    (r.BACKGROUND_SURFACE_HIGH = 'var(--background-surface-high)'),
    (r.BACKGROUND_SURFACE_HIGHER = 'var(--background-surface-higher)'),
    (r.BACKGROUND_SURFACE_HIGHEST = 'var(--background-surface-highest)'),
    ...
    (r.GUILD_ICON_INACTIVE_BG = 'var(--guild-icon-inactive-bg)'),
    (r.GUILD_ICON_INACTIVE_NESTED_BG = 'var(--guild-icon-inactive-nested-bg)'),
    (r.GUILD_NOTIFICATIONS_BOTTOM_SHEET_PILL_BACKGROUND = 'var(--guild-notifications-bottom-sheet-pill-background)'),
    (r.HALO_POSITIVE = 'var(--halo-positive)'),

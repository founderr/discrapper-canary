var n, r;
((r = n || (n = {})).ACTION_SHEET_GRADIENT_BG = 'var(--action-sheet-gradient-bg)'),
    (r.ACTIVITY_CARD_BACKGROUND = 'var(--activity-card-background)'),
    (r.ACTIVITY_CARD_ICON_OVERLAY = 'var(--activity-card-icon-overlay)'),
    (r.ALERT_BG = 'var(--alert-bg)'),
    ...
    (r.AUTOCOMPLETE_BG = 'var(--autocomplete-bg)'),
    ...
    (r.BUTTON_DANGER_BORDER = 'var(--button-danger-border)'),
    (r.BUTTON_FILLED_BRAND_BACKGROUND = 'var(--button-filled-brand-background)'),
    (r.BUTTON_FILLED_BRAND_BACKGROUND_ACTIVE = 'var(--button-filled-brand-background-active)'),
    (r.BUTTON_FILLED_BRAND_BACKGROUND_HOVER = 'var(--button-filled-brand-background-hover)'),
    (r.BUTTON_FILLED_BRAND_BORDER = 'var(--button-filled-brand-border)'),
    (r.BUTTON_FILLED_BRAND_INVERTED_BACKGROUND = 'var(--button-filled-brand-inverted-background)'),
    (r.BUTTON_FILLED_BRAND_INVERTED_BACKGROUND_ACTIVE = 'var(--button-filled-brand-inverted-background-active)'),
    (r.BUTTON_FILLED_BRAND_INVERTED_BACKGROUND_HOVER = 'var(--button-filled-brand-inverted-background-hover)'),
    (r.BUTTON_FILLED_BRAND_INVERTED_TEXT = 'var(--button-filled-brand-inverted-text)'),
    (r.BUTTON_FILLED_BRAND_TEXT = 'var(--button-filled-brand-text)'),
    (r.BUTTON_FILLED_WHITE_BACKGROUND = 'var(--button-filled-white-background)'),
    (r.BUTTON_FILLED_WHITE_BACKGROUND_ACTIVE = 'var(--button-filled-white-background-active)'),
    (r.BUTTON_FILLED_WHITE_BACKGROUND_HOVER = 'var(--button-filled-white-background-hover)'),
    (r.BUTTON_FILLED_WHITE_TEXT = 'var(--button-filled-white-text)'),
    ...
    (r.BUTTON_POSITIVE_BORDER = 'var(--button-positive-border)'),
    ...
    (r.BUTTON_SECONDARY_TEXT = 'var(--button-secondary-text)'),
    (r.BUTTON_TRANSPARENT_BACKGROUND = 'var(--button-transparent-background)'),
    (r.BUTTON_TRANSPARENT_BACKGROUND_ACTIVE = 'var(--button-transparent-background-active)'),
    (r.BUTTON_TRANSPARENT_BACKGROUND_HOVER = 'var(--button-transparent-background-hover)'),
    (r.BUTTON_TRANSPARENT_TEXT = 'var(--button-transparent-text)'),
    ...
    (r.CHAT_BANNER_BG = 'var(--chat-banner-bg)'),
    ...
    (r.CHAT_SWIPE_TO_REPLY_GRADIENT_BACKGROUND = 'var(--chat-swipe-to-reply-gradient-background)'),
    (r.COACHMARK_BG = 'var(--coachmark-bg)'),
    (r.CONTENT_INVENTORY_MEDIA_SEEKBAR_CONTAINER = 'var(--content-inventory-media-seekbar-container)'),
    (r.CONTENT_INVENTORY_OVERLAY_TEXT_PRIMARY = 'var(--content-inventory-overlay-text-primary)'),
    (r.CONTENT_INVENTORY_OVERLAY_TEXT_SECONDARY = 'var(--content-inventory-overlay-text-secondary)'),
    (r.CONTENT_INVENTORY_OVERLAY_UI_MOD = 'var(--content-inventory-overlay-ui-mod)'),
    (r.CONTENT_INVENTORY_OVERLAY_UI_MOD_BG = 'var(--content-inventory-overlay-ui-mod-bg)'),
    (r.CONTEXT_MENU_BACKDROP_BACKGROUND = 'var(--context-menu-backdrop-background)'),
    ...
    (r.CUSTOM_STATUS_BUBBLE_BG = 'var(--custom-status-bubble-bg)'),
    ...
    (r.EMBED_BACKGROUND = 'var(--embed-background)'),
    (r.EMBED_BACKGROUND_ALTERNATE = 'var(--embed-background-alternate)'),
    (r.EMBED_TITLE = 'var(--embed-title)'),
    (r.EXPRESSION_PICKER_BG = 'var(--expression-picker-bg)'),
    ...
    (r.ICON_TRANSPARENT = 'var(--icon-transparent)'),
    ...
    (r.INPUT_BORDER = 'var(--input-border)'),
    (r.INPUT_ERROR_BACKGROUND = 'var(--input-error-background)'),
    (r.INPUT_ERROR_BORDER = 'var(--input-error-border)'),
    (r.INPUT_ERROR_TEXT = 'var(--input-error-text)'),
    (r.INPUT_FOCUSED_BORDER = 'var(--input-focused-border)'),
    ...
    (r.MENU_ITEM_DANGER_ACTIVE_BG = 'var(--menu-item-danger-active-bg)'),
    (r.MENU_ITEM_DANGER_HOVER_BG = 'var(--menu-item-danger-hover-bg)'),
    (r.MENU_ITEM_DEFAULT_ACTIVE_BG = 'var(--menu-item-default-active-bg)'),
    (r.MENU_ITEM_DEFAULT_HOVER_BG = 'var(--menu-item-default-hover-bg)'),
    ...
    (r.PANEL_BG = 'var(--panel-bg)'),
    (r.POLLS_NORMAL_FILL_HOVER = 'var(--polls-normal-fill-hover)'),
    (r.POLLS_NORMAL_IMAGE_BACKGROUND = 'var(--polls-normal-image-background)'),
    (r.POLLS_VICTOR_FILL = 'var(--polls-victor-fill)'),
    (r.POLLS_VOTED_FILL = 'var(--polls-voted-fill)'),
    (r.PREMIUM_NITRO_PINK_TEXT = 'var(--premium-nitro-pink-text)'),
    ...
    (r.REDESIGN_BUTTON_ACTIVE_BACKGROUND = 'var(--redesign-button-active-background)'),
    (r.REDESIGN_BUTTON_ACTIVE_PRESSED_BACKGROUND = 'var(--redesign-button-active-pressed-background)'),
    (r.REDESIGN_BUTTON_ACTIVE_TEXT = 'var(--redesign-button-active-text)'),
    ...
    (r.REDESIGN_BUTTON_DESTRUCTIVE_BACKGROUND = 'var(--redesign-button-destructive-background)'),
    (r.REDESIGN_BUTTON_DESTRUCTIVE_PRESSED_BACKGROUND = 'var(--redesign-button-destructive-pressed-background)'),
    (r.REDESIGN_BUTTON_DESTRUCTIVE_TEXT = 'var(--redesign-button-destructive-text)'),
    ...
    (r.REDESIGN_BUTTON_PREMIUM_PRIMARY_BLUE_FOR_GRADIENT = 'var(--redesign-button-premium-primary-blue-for-gradient)'),
    (r.REDESIGN_BUTTON_PREMIUM_PRIMARY_PINK_FOR_GRADIENT = 'var(--redesign-button-premium-primary-pink-for-gradient)'),
    (r.REDESIGN_BUTTON_PREMIUM_PRIMARY_PRESSED_BACKGROUND = 'var(--redesign-button-premium-primary-pressed-background)'),
    (r.REDESIGN_BUTTON_PREMIUM_PRIMARY_PURPLE_FOR_GRADIENT = 'var(--redesign-button-premium-primary-purple-for-gradient)'),
    (r.REDESIGN_BUTTON_PREMIUM_PRIMARY_PURPLE_FOR_GRADIENT_2 = 'var(--redesign-button-premium-primary-purple-for-gradient-2)'),
    ...
    (r.REDESIGN_BUTTON_PRIMARY_OVERLAY_BACKGROUND = 'var(--redesign-button-primary-overlay-background)'),
    (r.REDESIGN_BUTTON_PRIMARY_OVERLAY_PRESSED_BACKGROUND = 'var(--redesign-button-primary-overlay-pressed-background)'),
    (r.REDESIGN_BUTTON_PRIMARY_OVERLAY_TEXT = 'var(--redesign-button-primary-overlay-text)'),
    ...
    (r.REDESIGN_BUTTON_SELECTED_BACKGROUND = 'var(--redesign-button-selected-background)'),
    (r.REDESIGN_BUTTON_SELECTED_PRESSED_BACKGROUND = 'var(--redesign-button-selected-pressed-background)'),
    (r.REDESIGN_BUTTON_SELECTED_TEXT = 'var(--redesign-button-selected-text)'),
    (r.REDESIGN_BUTTON_TERTIARY_BACKGROUND = 'var(--redesign-button-tertiary-background)'),
    (r.REDESIGN_BUTTON_TERTIARY_PRESSED_BACKGROUND = 'var(--redesign-button-tertiary-pressed-background)'),
    (r.REDESIGN_BUTTON_TERTIARY_PRESSED_TEXT = 'var(--redesign-button-tertiary-pressed-text)'),
    (r.REDESIGN_BUTTON_TERTIARY_TEXT = 'var(--redesign-button-tertiary-text)'),
    ...
    (r.REDESIGN_IMAGE_BUTTON_PRESSED_BACKGROUND = 'var(--redesign-image-button-pressed-background)'),
    ...
    (r.STAGE_CARD_PILL_BG = 'var(--stage-card-pill-bg)'),
    ...
    (r.THREAD_CHANNEL_SPINE = 'var(--thread-channel-spine)'),
    (r.TOAST_BG = 'var(--toast-bg)'),
    (r.TYPING_INDICATOR_BG = 'var(--typing-indicator-bg)'),
    (r.USER_PROFILE_HEADER_OVERFLOW_BACKGROUND = 'var(--user-profile-header-overflow-background)'),
    (r.VOICE_VIDEO_VIDEO_TILE_BACKGROUND = 'var(--voice-video-video-tile-background)'),

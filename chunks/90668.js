...
function I(t, e, r) {
    let a;
    return (0, i.z)(e) ? void 0 !== t.sampled ? (t.setMetadata({ sampleRate: Number(t.sampled) }), t) : ('function' == typeof e.tracesSampler ? (a = e.tracesSampler(r), t.setMetadata({ sampleRate: Number(a) })) : void 0 !== r.parentSampled ? a = r.parentSampled : void 0 !== e.tracesSampleRate ? (a = e.tracesSampleRate, t.setMetadata({ sampleRate: Number(a) })) : (a = 1, t.setMetadata({ sampleRate: a })), !function (t) {
...
function R(t, e) {
    let r = this.getClient(), _ = r && r.getOptions() || {}, a = _.instrumenter || 'sentry', i = t.instrumenter || 'sentry';

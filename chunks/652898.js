...
function c(e) {
  ...
  if (null != e && null != e.channel) {
    let n = e.channel;
    t = e.target_type === d.InviteTargetTypes.STREAM ? _.LoggingInviteTypes.STREAM : e.target_type === d.InviteTargetTypes.EMBEDDED_APPLICATION ? _.LoggingInviteTypes.APPLICATION : (0, a.isMultiUserDM)(n.type) ? _.LoggingInviteTypes.GDM_INVITE : null == n || (0, a.isPrivate)(n.type) ? _.LoggingInviteTypes.FRIEND_INVITE : _.LoggingInviteTypes.SERVER_INVITE
  }
  return t
}
...
function E(e, t, n) {
  ...
  let a = (0, u.parseExtraDataFromInviteKey)(e),
    d = {
      ...n,
      with_counts: !0,
      with_expiration: !0,
  ...
  return l.default.get({
    url: _.Endpoints.INVITE(a.baseCode),
    query: d,
    oldFormErrors: !0,
    trackedActionData: {

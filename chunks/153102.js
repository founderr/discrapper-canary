...
t.Z = new class e {
    ...
    emitNonReactOnce(e, t) {
        let n = Date.now(), r = this.changedStores;
    ...
    emitReactOnce() {
        let e = Date.now(), t = this.reactChangedStores;

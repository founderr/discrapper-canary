...
var r, i = n(392711), a = n.n(i), o = n(913527), s = n.n(o), l = n(956067), u = n(442837), c = n(570140), d = n(704907), _ = n(287328), E = n(86670), f = n(489033), h = n(188742), p = n(353926), m = n(973542), I = n(889564), T = n(687476), g = n(978519), S = n(706454), A = n(581883), N = n(271383), v = n(93093), O = n(430824), R = n(771845), C = n(594174), y = n(70956), D = n(176354), L = n(823379), b = n(226951), M = n(709054), P = n(906411), U = n(689789), w = n(633302), x = n(174065), G = n(396352), k = n(347374), B = n(185923), F = n(981631), V = n(149203), H = n(526761);
function Z(e, t, n) {
...
let K = M.default.fromTimestamp(Date.now() - 60 * y.Z.Millis.DAY), z = [], q = 2, Q = Y.slice(0), X = {}, $ = {}, J = null, ee = new Map();
function et(e) {
    var t, n;
    let r = en()[e];
...
class ea {
    ...
    getFrequentlyUsedEmojisWithoutFetchingLatest() {
        ...
        let e = eo.frequently.map(e => null != e.id ? this.getById(e.id) : w.ZP.getByName(e.name)).filter(L.lm), t = (0, k.Z)(e);
    ...
    getFrequentlyUsedReactionEmojisWithoutFetchingLatest() {
        ...
        let e = es.frequently.map(e => null != e.id ? this.getById(e.id) : w.ZP.getByName(e.name)).filter(L.lm), t = (0, k.Z)(e);
    ...
    getTopEmojiWithoutFetchingLatest(e) {
        if (this.ensureDisambiguated(), null == this.topEmojis) {
            var t;
            let n = ee.get(e), r = G.Z.getTopEmojiIdsByGuildId(e);
            if (null == n && null == r)
                return z;
    ...
    nameMatchesChain(e) {
        return a()(this.getDisambiguatedEmoji()).filter(t => {
            let {
                    ...
                    names: r,
                    name: i
                } = t, o = null != r && a().some(r, e), s = null != i && e(i), l = null != i && a().some(h.Z.getTermsForEmoji(i), e), u = null != n && a().some(x.Z.getCaptionsForEmojiById({ emojiId: n }), e);
            return o || s || l || u;
        });
    }
...
let eo = ei(ea.resetFrequentlyUsed), es = ei(ea.resetFrequentlyUsedReactionEmojis);
function el() {
...
function ec() {
    $ = null, ea.reset(), 0 !== q && (eo.compute(), es.compute());
}
function ed(e, t) {
...
function e_() {
    var e, t, n, r, i, o;
    let s = null === (t = A.Z.settings.textAndImages) || void 0 === t ? void 0 : null === (e = t.diversitySurrogate) || void 0 === e ? void 0 : e.value;
    null != s && w.ZP.setDefaultDiversitySurrogate(s), ea.reset();
    let l = A.Z.frecencyWithoutFetchingLatest, u = null !== (i = null === (n = l.emojiFrecency) || void 0 === n ? void 0 : n.emojis) && void 0 !== i ? i : {}, c = null !== (o = null === (r = l.emojiReactionFrecency) || void 0 === r ? void 0 : r.emojis) && void 0 !== o ? o : {};
    eo.overwriteHistory(a().mapValues(u, e => ({
        ...e,
        recentUses: e.recentUses.map(Number).filter(e => e > 0)
    })), j.pendingUsages), es.overwriteHistory(a().mapValues(c, e => ({
        ...e,
        recentUses: e.recentUses.map(Number).filter(e => e > 0)
    })), j.emojiReactionPendingUsages), !function (e, t) {
        let {canSplitFrecencyList: n} = U.Z.getCurrentConfig({ location: 'populateInitialFrecencyData' }, { autoTrackExposure: !0 });
...
function eE(e) {
    ...
    for (let r of e) {
        ...
        null != e && (eo.track(e), j.pendingUsages.push({
            key: e,
            timestamp: Date.now()
        }));
    }
...
class eh extends (r = u.ZP.PersistedStore) {
    ...
    getSearchResultsOrder(e, t, n, r) {
        let i = t.toLowerCase(), o = b.Z.escape(i), {canSplitFrecencyList: s} = U.Z.getCurrentConfig({ location: 'getSearchResultsOrder' }, { autoTrackExposure: !0 });
        if (e.length > 0) {
            let t = RegExp('^'.concat(o), 'i'), n = new RegExp('(^|_|[A-Z])'.concat(o, 's?([A-Z]|_|$)')), l = n.test.bind(n), u = t.test.bind(t), c = function (e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : e;
                    if (null == e || null == t)
                        return 0;
                    let n = e.toLowerCase(), a = 1 + (n === i ? 4 : 0) + (l(n) || l(e) ? 2 : 0) + (u(e) ? 1 : 0), o = r === B.Hz.REACTION && s ? es.getScore(t) : eo.getScore(t);
    ...
    searchWithoutFetchingLatest(e) {
        ...
        er();
        let l = r.toLowerCase().replaceAll(/[ _]/g, ''), u = b.Z.escape(l);
        if (null == s) {
            let e = RegExp(''.concat(u), 'i');
            t = t => e.test(t.replaceAll('_', ''));
        } else
            t = s;
        let c = null != n ? n.getGuildId() : null, d = ea.get(c).nameMatchesChain(t).reduce((e, t) => {
...
Z(eh, 'displayName', 'EmojiStore'), Z(eh, 'persistKey', 'EmojiStoreV2'), Z(eh, 'migrations', [e => ({ ...e })]), t.Z = new eh(c.Z, {
    LOGOUT: function () {
        j.pendingUsages = [];
    },
    ...
    MESSAGE_REACTION_ADD: function (e) {
        if (!e.optimistic)
            return !1;
        let {canSplitFrecencyList: t} = U.Z.getCurrentConfig({ location: 'handleAddReaction' }, { autoTrackExposure: !0 }), n = null != e.emoji.id && '0' !== e.emoji.id ? e.emoji : w.ZP.getByName(w.ZP.convertSurrogateToName(e.emoji.name, !1));
        if (null == n)
            return !1;
        t ? function (e) {
            if (null == e)
            ...
            for (let r of e) {
                var t, n;
                let e = null !== (n = null !== (t = r.id) && void 0 !== t ? t : r.uniqueName) && void 0 !== n ? n : r.name;
                null != e && (es.track(e), j.emojiReactionPendingUsages.push({
                    key: e,
                    timestamp: Date.now()
                }));
            }

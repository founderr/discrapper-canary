...
let X = U.default.fromTimestamp(Date.now() - 60 * L.Z.Millis.DAY),
    $ = [];
...
class eu {
    ...
    rebuildFavoriteEmojisWithoutFetchingLatest() {
        ...
        let n = (null !== (t = null === (e = v.Z.frecencyWithoutFetchingLatest.favoriteEmojis) || void 0 === e ? void 0 : e.emojis) && void 0 !== t ? t : [])
                .map((e) => {
                    var t;
    ...
    _buildDisambiguatedCustomEmoji() {
        ...
        y.ZP.getFlattenedGuildIds().forEach((e) => {
            e !== this.guildId && i(e);
        }),
...
function ep() {
    var e, t, n, r, i, a;
    let s = null === (t = v.Z.settings.textAndImages) || void 0 === t ? void 0 : null === (e = t.diversitySurrogate) || void 0 === e ? void 0 : e.value;
    ...
    ec.overwriteHistory(
        ...
        !(function (e, t) {
            ...
            if (o().isEmpty(e) && o().isEmpty(q.pendingUsages) && v.Z.hasLoaded(j.yP.FRECENCY_AND_FAVORITES_SETTINGS)) for (let e of ['thumbsup', 'thumbsup', 'eyes', 'eyes', 'laughing', 'laughing', 'watermelon', 'fork_and_knife', 'yum', 'weary', 'tired_face', 'poop', '100']) ec.track(e);
            if ((n || r) && o().isEmpty(t) && o().isEmpty(q.emojiReactionPendingUsages) && v.Z.hasLoaded(j.yP.FRECENCY_AND_FAVORITES_SETTINGS)) for (let e of ['100', '100', 'thumbsup', 'thumbsup', 'thumbsdown', 'thumbsdown', 'heart', 'point_up', 'eyes', 'weary', 'laughing', 'white_check_mark', 'x']) ed.track(e);
        })(u, c);
}
function eI() {
...
class eg extends (i = d.ZP.PersistedStore) {
    initialize(e) {
        this.waitFor(f.Z, R.Z, O.ZP, C.Z, N.default, S.Z, F.Z, D.default, m.Z), null != e && (null != e.pendingUsages && (q.pendingUsages = e.pendingUsages), null != e.emojiReactionPendingUsages && (q.emojiReactionPendingUsages = e.emojiReactionPendingUsages), null != e.expandedSectionsByGuildIds && (q.expandedSectionsByGuildIds = new Set(e.expandedSectionsByGuildIds))), this.syncWith([v.Z], ep), this.syncWith([m.Z], eI);
    }
    getState() {
        return q;
    }
...
W(eg, 'displayName', 'EmojiStore'),
    W(eg, 'persistKey', 'EmojiStoreV2'),
    W(eg, 'migrations', [(e) => ({ ...e })]),
    (t.ZP = new eg(_.Z, {
        LOGOUT: function () {

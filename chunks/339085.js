...
function eO(e) {
    for (let t in (eg(), e.emojis)) ev(t, e.emojis[t]);
    (ea = 1), eA();
}
function eR() {
...
X(ej, 'displayName', 'EmojiStore'),
    X(ej, 'persistKey', 'EmojiStoreV2'),
    X(ej, 'migrations', [(e) => ({ ...e })]),
    (t.ZP = new ej(m.Z, {
        LOGOUT: eR,
        BACKGROUND_SYNC: eC,

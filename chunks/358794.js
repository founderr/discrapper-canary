...
function c(e, t) {
  let {
    ...
    pendingThemeColors: c,
    isPreview: E
  }), [S, h, A] = (0, s.useStateFromStoresArray)([o.default], () => [o.default.desaturateUserColors, o.default.saturation, o.default.syncProfileThemeWithUserTheme]), m = (0, a.default)(), N = i.useCallback(() => A || I ? m : (0, l.getProfileTheme)(T), [I, A, m, T]), [O, p] = i.useState(N()), R = (0, l.useProfileThemeValues)(O), C = (0, l.useDividerColor)(O, T), g = (0, l.useMessageInputBorderColor)(O, f), L = i.useCallback((e, t) => (0, r.int2hsl)(e, S, null, t), [S]);
  i.useEffect(() => {
    p(N())
  }, [T, A, m, I, N]);
  let D = (0, l.useAvatarBorderColor)(O, T, A),
  ...
  return i.useEffect(() => {
    if (null != T && null != f && null != O && null != D && null != C && null != g) {
      let e = A && O !== m ? null == R ? void 0 : R.overlaySyncedWithUserTheme : null == R ? void 0 : R.overlay;
  ...
  }, [T, f, D, O, m, n, L, A, C, null == R ? void 0 : R.overlaySyncedWithUserTheme, null == R ? void 0 : R.overlay, null == R ? void 0 : R.sectionBox, null == R ? void 0 : R.profileBodyBackgroundHover, null == R ? void 0 : R.dividerOpacity, null == R ? void 0 : R.noteBackgroundColor, null == R ? void 0 : R.rolePillBackgroundColor, null == R ? void 0 : R.rolePillBorderColor, g]), {

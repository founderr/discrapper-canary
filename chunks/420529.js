...
function h(e) {
  let t = (0, u.useStateFromStores)([s.default], () => s.default.getChannelId() === e.id),
    ...
    _ = (0, r.default)(e),
    T = !(0, u.useStateFromStores)([d.default], () => d.default.isInChannel(e.id)) && _ || v,
    m = (0, f.default)();
  if (!N && 0 === m.length) return null;
  let I = t => {
    ...
    t.type === S.PlatformTypes.XBOX ? (0, a.openModalLazy)(async () => {
      let {
        default: t
      } = await Promise.all([n.e("49237"), n.e("99387"), n.e("49368"), n.e("522")]).then(n.bind(n, "200623"));
      return n => (0, l.jsx)(t, {
        ...n,
        channel: e
      })

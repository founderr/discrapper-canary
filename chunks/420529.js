...
function Z(e) {
  ...
  return (0, l.jsx)(l.Fragment, {
    children: I ? (0, l.jsx)(i.MenuItem, {
      ...
      label: function(e, n) {
        if (e === _.ABu.XBOX) return n ? f.Z.Messages.TRANSFER_VOICE_TO_XBOX : f.Z.Messages.JOIN_ON_XBOX;
        if (e === _.ABu.PLAYSTATION) return n ? f.Z.Messages.CONSOLE_PLAYSTATION_TRANSFER_VOICE : f.Z.Messages.CONSOLE_PLAYSTATION_JOIN_VOICE;
        if (e === _.ABu.PLAYSTATION_STAGING) return n ? f.Z.Messages.CONSOLE_PLAYSTATION_STAGING_TRANSFER_VOICE : f.Z.Messages.CONSOLE_PLAYSTATION_STAGING_JOIN_VOICE
      }(e.type, n),
      action: () => g(e),
      icon: (0, N.Z)(e.type),
      disabled: S

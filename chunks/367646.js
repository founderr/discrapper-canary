...
var f = function() {
  ...
  function u(e, t, n) {
    ...
    ! function(e, t) {
      ...
      if (!(null == e || o.isNodeInDocument(e))) o.clearCurrentDragSourceNode() && o.monitor.isDragging() && o.actions.endDrag()
      ...
      if (!e.defaultPrevented) {
        ...
        if (o.monitor.isDragging()) {
          if (r && "function" == typeof r.setDragImage) {
            var u = o.monitor.getSourceId(),
              c = o.sourceNodes.get(u),
              l = o.sourcePreviewNodes.get(u) || c;
            if (l) {
      ...
      if (o.dragEnterTargetIds = [], !!o.monitor.isDragging()) o.altKeyPressed = e.altKey, t.length > 0 && o.actions.hover(t, {
      ...
      if (o.isDraggingNativeItem() && e.preventDefault(), !!o.enterLeaveCounter.leave(e.target)) o.isDraggingNativeItem() && setTimeout(function() {

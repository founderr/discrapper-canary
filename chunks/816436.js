...
l = i()(n).map(e => e.isCategory() ? e.id : e.parent_id).filter(o.lm).uniq().map(e => s.Z.getChannel(e)).filter(o.lm).sortBy('position').value(),
...
function u(e, t) {
  ...
  return (0, a.Wu)([s.Z], () => {
let r = Array.from(t).map(e => s.Z.getChannel(e)).filter(o.lm);
return l(e, t, r, n);
  });
}
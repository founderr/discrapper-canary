...
let t = T()().diff(T()(e), 's'),
  I = E(),
  n = T()(e).format('LL');
return n = t < A ? I.today : t < r ? I.yesterday : I.days.format({
...
let _ = T()().diff(T()(e), 's'),
  t = E(),
  I = T()(e).format('LL');
return I = _ < 60 ? t.seconds : _ < s ? t.minutes.format({
  count: Math.floor(_ / 60)
}) : _ < A ? t.hours.format({
  count: Math.floor(_ / s)
}) : _ < r ? t.yesterday : _ < a ? t.days.format({
  count: Math.floor(_ / A)
}) : t.date.format({
  date: I
});
  },

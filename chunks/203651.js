...
let a = n(606419), o = n(164390), s = n(339768), l = n(615252), u = n(517024), c = u.isObject, d = u.mixin, _ = u.hasOwn, E = n(509337), f = n(675246);
function h() {
}
...
d(S.prototype, E.prototype), S.prototype._parseBody = function (e) {
    ...
    let e = this.req, t = e.method, n = e.url, r = Error(`cannot ${ t } ${ n } (${ this.status })`);
    ...
    let e = this;
    this.xhr = p.getXHR();
    let t = this.xhr, n = this._formData || this._data;
    ...
    if (this._withCredentials && (t.withCredentials = !0), !this._formData && 'GET' !== this.method && 'HEAD' !== this.method && 'string' != typeof n && !this._isHost(n)) {
        let e = this._header['content-type'], t = this._serializer || p.serialize[e ? e.split(';')[0] : ''];

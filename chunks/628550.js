...
var X = () => {
  let {
    ...
    scrollPosition: N.ProfileCustomizationScrollPositions.TRY_IT_OUT,
    analyticsLocations: e
  }), et = () => {
    l.default.open(p.UserSettingsSections.VOICE, N.SOUNDBOARD_SUBSECTION, {
    ...
    clientThemes: {
      ...
      onCtaClick: () => {
        l.default.open(p.UserSettingsSections.APPEARANCE, null, {
          openWithoutBackstack: !0,
          analyticsLocations: e
        })
      },
    ...
    clips: Z ? {
      ...
      pillText: g.default.Messages.EARLY_ACCESS,
      onCtaClick: $ ? () => {
        l.default.open(p.UserSettingsSections.CLIPS, null, {
          openWithoutBackstack: !0,
          analyticsLocations: e
        })
      } : () => {
    ...
    earlyAccess: Z ? {
      ...
      subtitle: g.default.Messages.Q4_DROP_WHATS_NEW_EARLY_ACCESS_CARD_SUBTITLE_V2,
    ...
    serverBoosts: {
      ...
      descriptionCta: g.default.Messages.TAKE_ME_THERE,
      onCtaClick: () => {
        l.default.open(p.UserSettingsSections.GUILD_BOOSTING, null, {
          openWithoutBackstack: !0,
          analyticsLocations: e
        })
      },
    ...
    specialMemberPricing: Z ? {
      ...
      subtitle: g.default.Messages.Q4_DROP_WHATS_NEW_SPECIAL_PRICING_CARD_SUBTITLE_V2,
    ...
    customAppIcons: {
      ...
      onCtaClick: () => {
        l.default.open(p.UserSettingsSections.APPEARANCE, null, {
          scrollPosition: N.AppearanceScrollPositions.CUSTOM_APP_ICONS
        })
      }
    },
    moreEmojiPower: {

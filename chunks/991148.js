...
function d(e, t) {
  ...
  let d = (0, l.useIsEligibleForGuildShopPreview)(t),
    ...
    g = [u.GuildFeatures.CREATOR_MONETIZABLE, u.GuildFeatures.CREATOR_MONETIZABLE_PROVISIONAL, u.GuildFeatures.ROLE_SUBSCRIPTIONS_ENABLED].some(t => (null == e ? void 0 : e.hasFeature(t)) === !0);
  return null != e && f && !_ && g && d && h && !c
}
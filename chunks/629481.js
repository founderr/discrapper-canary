...
}), (l = i || (i = {})).GET_STARTED_CLICK = "get_started_click", l.DISMISS_FULL_PREVIEW = "dismiss_full_preview", l.DISMISS_TAB_PREVIEW = "dismiss_tab_preview", l.DISMISS_CHANNEL_ROW = "dismiss_channel_row", (s = r || (r = {})).CHANNEL_ROW_CONTEXT_MENU = "channel_row_context_menu", s.SHOP_HEADER_BUTTON = "shop_header_button";

...
function D(e) {
    ...
    I.some(O.k5) && (L.log('Found expired attachment link, clearing messages'), _.Z.clear(n), (I = _.Z.getOrCreate(n))),
        null != I.jumpTargetId &&
            null == i &&
            ((I = I.mutate({
                jumpTargetId: null,
...
class K extends d.Z {
    ...
    constructor(...e) {
        super(...e),
            y(this, 'fetchMessages', D),
            y(this, 'loadSelectedChannelIfNecessary', U),
            y(this, 'stores', new Map().set(I.ZP, k)),
            y(this, 'actions', {
                APP_STATE_UPDATE: W,

...
theme: W
  } = (0, T.z)(), D = s.useContext(_.AnalyticsContext), j = t.isNonUserBot() && !t.isClyde(), B = m.ZP.isPremiumAtLeast(null == a ? void 0 : a.premiumType, M.p9.TIER_2), F = s.useMemo(() => (0, E.W)(t, R), [
t,
R
  ]), {
...
children: (0, n.jsx)(x, {
  ...
  }), Q = (0, o.EQ)(U).with(h.y0.POPOUT, () => (0, I.zW)({
...
hasBanner: d,
hasProfileEffect: G
  })).with(h.y0.POMELO_POPOUT, () => P.avatarPositionPomelo).with(h.y0.PANEL, () => P.avatarPositionPanel).with(h.y0.BITE_SIZE, () => P.avatarPositionBiteSize).exhaustive();
...
children: (0, n.jsxs)(l.Clickable, {
  ...
  children: [
    ...
    !z && function() {
      ...
      return (0, n.jsx)(c.ZP, {
        mask: null == g || g === O.Skl.UNKNOWN || F ? c.ZP.Masks.AVATAR_DEFAULT : (0, o.EQ)([
          e,
          A
        ]).with([
          !0,
          !0
        ], () => c.ZP.Masks.AVATAR_DECORATION_PROFILE_STATUS_MOBILE_SQUARE_80).with([
          !0,
          !1
        ], () => c.ZP.Masks.AVATAR_DECORATION_PROFILE_STATUS_SQUARE_80).with([
          !1,
          !0
        ], () => c.ZP.Masks.AVATAR_STATUS_MOBILE_80).with([
          !1,
          !1
        ], () => c.ZP.Masks.AVATAR_STATUS_ROUND_80).exhaustive(),

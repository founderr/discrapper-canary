...
var n = a(735250), l = a(470079), i = a(481060), r = a(673462), o = a(826078), s = a(917042), u = a(20437), d = a(162989);
function c(e) {
    let {
            isLoading: t,
            onDoneLoading: a,
    ...
    return l.useEffect(() => {
        function e(e) {
            var t, a;
            if ((null === (t = document.activeElement) || void 0 === t ? void 0 : t.tagName) === 'INPUT')
                return;
            let n = v.current;
            if (null == n)
                return;
            ...
            if (null == l)
                return;
            let i = (0, s.Z)(l.duration, e.shiftKey), r = !1;
            switch (e.key) {
            case ' ':
        ...
        children: [
            ...
            ].includes(p) ? (0, n.jsx)(o.Z, { sourceURL: c }) : null
        ]
    });
}

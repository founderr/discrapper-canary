...
function i(e) {
    let {hqStreamingDidEnable: t} = r.getState();
    r.setState({
...
function a(e) {
    r.setState({ hqStreamingFrameAnimationPlayed: e });
}
function o(e) {
    r.setState({ hqStreamingPopoutDismissed: e });
}
function s(e) {
    r.setState({ hqStreamingOptInPopoutDismissed: e });
}
function l(e) {
    r.setState({ hqStreamingOptOutPopoutShouldShow: e });
}

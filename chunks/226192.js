...
var _ = t(735250);
t(470079);
var E = t(481060), r = t(273504), i = t(689938);
function u(n) {
    return {
        [r.jj.BLOCK_MESSAGE]: (n, e) => new Promise(n => {
            (0, E.openModalLazy)(async () => {
                let {default: E} = await t.e('94005').then(t.bind(t, 144462));
                return t => {
                    var r;
                    return (0, _.jsx)(E, {
        ...
        [r.jj.FLAG_TO_CHANNEL]: (e, i) => new Promise(u => {
            (0, E.openModalLazy)(async () => {
                let {default: E} = await t.e('74543').then(t.bind(t, 643611)), A = e.actions.find(n => n.type === r.jj.FLAG_TO_CHANNEL);
                return t => (0, _.jsx)(E, {
                    action: i,
                    isEdit: null != A,
        ...
        [r.jj.USER_COMMUNICATION_DISABLED]: (n, e) => new Promise(i => {
            (0, E.openModalLazy)(async () => {
                let {default: E} = await t.e('78273').then(t.bind(t, 41767)), u = n.actions.find(n => n.type === r.jj.USER_COMMUNICATION_DISABLED);
                return t => (0, _.jsx)(E, {
                    action: e,
                    isEdit: null != u,
...
function A(n, e, r, i) {
    (0, E.openModalLazy)(async () => {
        let {default: E} = await t.e('37483').then(t.bind(t, 241046));
        return t => (0, _.jsx)(E, {
            ...t,
            automodDecision: {
                messageId: n,
...
function a(n, e) {
    (0, E.openModalLazy)(async () => {
        let {default: E} = await t.e('28382').then(t.bind(t, 537623));
        return t => (0, _.jsx)(E, {
            ...t,
            messageId: n,
            guildId: e

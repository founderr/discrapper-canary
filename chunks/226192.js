...
function r(e) {
  return {
    ...
    [u.AutomodActionType.FLAG_TO_CHANNEL]: (t, a) => new Promise(r => {
      (0, _.openModalLazy)(async () => {
        let {
          default: _
        ...
        return n => (0, o.jsx)(_, {
          ...
          guildId: e,
          onEditChannel: e => {
            a.metadata.channelId = e, t.exemptChannels.add(e), r(a), n.onClose()
          },
          ...n,
    ...
    [u.AutomodActionType.USER_COMMUNICATION_DISABLED]: (e, t) => new Promise(a => {
      (0, _.openModalLazy)(async () => {
        let {
          default: _
        } = await Promise.all([n.e("99387"), n.e("78273")]).then(n.bind(n, "41767")), r = e.actions.find(e => e.type === u.AutomodActionType.USER_COMMUNICATION_DISABLED);
        return n => (0, o.jsx)(_, {
          action: t,
          isEdit: null != r,

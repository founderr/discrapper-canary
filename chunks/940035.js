...
let O = {
  ...
  [N.GlobalKeybindActions.TOGGLE_OVERLAY_INPUT_LOCK]: {
    onTrigger(e) {
      let t = (0, g.default)();
      null != t && (e ? l.default.setUILocked(!m.default.isUILocked(t), t) : l.default.setInputLocked(!p.default.isInputLocked(t), t))
    },
    keyEvents: {
      keyup: !0,
      keydown: !0
  ...
  [N.GlobalKeybindActions.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET]: {
    onTrigger() {
      let e = p.default.getFocusedPID(),
        t = null != e;
      null != e && t && m.default.isPinned(N.OverlayWidgets.TEXT) && p.default.isReady(e) && p.default.isInputLocked(e) && l.default.activateRegion(N.OverlayActiveRegions.TEXT_WIDGET)
    },
    keyEvents: {
      keyup: !0,
      keydown: !1

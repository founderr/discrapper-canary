n(47120);
var i, s, a, r, l, o = n(442837), c = n(433517), d = n(846519), u = n(570140), _ = n(278323), E = n(581567), h = n(594190), I = n(581883), m = n(70956), g = n(780570), p = n(314897), T = n(77498), S = n(283595), C = n(19780), f = n(944486), N = n(981631);
let A = 'ActivityTrackingStore', Z = 30 * m.Z.Millis.MINUTE, v = 5 * m.Z.Millis.MINUTE, L = null !== (i = c.K.get(A)) && void 0 !== i ? i : {}, O = {}, R = !1;
function x(e) {
...
function P(e) {
    ...
    i > Z + v && (i = 0);
    let s = (0, g.OT)(e.applicationId, S.Z), a = f.Z.getVoiceChannelId(), r = p.default.getSessionId(), l = C.Z.getMediaSessionId();
    _.Z.updateActivity({
    ...
    null == o && (o = O[e.applicationId] = new d.Xp()).start(Z, () => P(e)), !t && (L[e.applicationId] = e, c.K.set(A, L));
}
function b() {

...
function P(e) {
  ...
  i > Z + L && (i = 0);
  let s = (0, p.OT)(e.applicationId, C.Z),
...
function b() {
  ...
  for (let t of Object.keys(v)) !n.has(t) && x(v[t], e)
}

function M() {
  for (let e of Object.keys(v)) x(v[e]);
  R = !1
}
class D extends(s = o.ZP.Store) {
  initialize() {
    this.waitFor(h.ZP, I.Z, C.Z), this.syncWith([I.Z], b)
  }
  getActivities() {
    return v
  }

...
function P(e) {
  ...
  null != n && (n.stop(), delete v[e.applicationId]), delete R[e.applicationId], u.Storage.set(A, R)
}
...
function M(e) {
  ...
  null == i && (i = v[e.applicationId] = new d.Interval).start(N, () => M(e)), !t && (R[e.applicationId] = e, u.Storage.set(A, R))
}

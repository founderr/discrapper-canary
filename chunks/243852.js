...
function x(e) {
    ...
    null != n && (n.stop(), delete O[e.applicationId]), delete Z[e.applicationId], c.K.set(A, Z);
}
function b(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
        n = Date.now(),
    ...
    null == o && (o = O[e.applicationId] = new d.Xp()).start(v, () => b(e)), !t && ((Z[e.applicationId] = e), c.K.set(A, Z));
}
function P() {
...
class D extends (a = o.ZP.Store) {
    initialize() {
        this.waitFor(h.ZP, m.Z, f.Z), this.syncWith([m.Z], P);
    }
    getActivities() {
        return Z;
    }

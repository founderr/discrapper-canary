var r = n(478497), i = n(995769), a = n(606956), o = Object.prototype.hasOwnProperty, s = {
        brackets: function (e) {
            return e + '[]';
        },
        comma: 'comma',
    ...
    }, f = {}, h = function e(t, n, a, o, s, u, d, _, h, p, m, I, T, g, S, A, N, v) {
        ...
        if (void 0 === C)
            return M;
        if ('comma' === a && l(C))
            A && h && (C = i.maybeMap(C, h)), R = [{ value: C.length > 0 ? C.join(',') || null : void 0 }];
        else if (l(p))
            R = p;
        else {
            var P = Object.keys(C);
        ...
        var U = _ ? n.replace(/\./g, '%2E') : n, w = o && l(C) && 1 === C.length ? U + '[]' : U;
        if (s && l(C) && 0 === C.length)
            return w + '[]';
        for (var x = 0; x < R.length; ++x) {
            var G = R[x], k = 'object' == typeof G && void 0 !== G.value ? G.value : C[G];
            if (!d || null !== k) {
                var B = I && _ ? G.replace(/\./g, '%2E') : G, F = l(C) ? 'function' == typeof a ? a(w, B) : w : w + (I ? '.' + B : '[' + B + ']');
                v.set(t, D);
                var V = r();
        ...
        var i = a.formatters[r], u = E.filter;
...
e.exports = function (e, t) {
    ...
    if ('object' != typeof a || null === a)
        return '';
    var d = s[o.arrayFormat], _ = 'comma' === d && o.commaRoundTrip;
    ...
    var I = u.join(o.delimiter), T = !0 === o.addQueryPrefix ? '?' : '';

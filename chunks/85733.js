var r = n(478497),
    ...
    p = {},
    h = function e(t, n, a, s, o, u, d, f, h, m, g, E, v, b, I, S, T, y) {
        ...
        if (
            ...
            if (u) return h && !S ? h(n, _.encoder, T, 'key', b) : n;
            C = '';
        }
        if ('string' == typeof (A = C) || 'number' == typeof A || 'boolean' == typeof A || 'symbol' == typeof A || 'bigint' == typeof A || i.isBuffer(C)) return h ? [I(S ? n : h(n, _.encoder, T, 'key', b)) + '=' + I(h(C, _.encoder, T, 'value', b))] : [I(n) + '=' + I(String(C))];
        var x = [];

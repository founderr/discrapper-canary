e = n.nmd(e), n("424973"), n("70102"), n("511434"), n("313619"), n("654714"), n("287168"), n("956660"), n("222007"), n("781738"), ! function() {
  var t = function(e) {
    "use strict";
    e = e || {};
    var t, n, r, o, i, a, c, s, l, d, p, u, h, f, y, w, g = {
      bgColor: "#d00",
      textColor: "#fff",
    ...
    x.ready = function() {
      ...
      s && (m = [], l = !1, d = !1, a.clearRect(0, 0, o, r), a.drawImage(c, 0, 0, o, r), C.setIcon(i), window.clearTimeout(f), window.clearTimeout(y))
    }, x.start = function() {
      if (s && !d) {
        var e = function() {
    ...
    var T = {};
    return T.duration = 40, T.types = {}, T.types.fade = [{
      x: .4,
      y: .4,
      w: .6,
      h: .6,
      ...
      var a = T.types[w.hidden || w.msHidden || w.webkitHidden || w.mozHidden ? "none" : t.animation];
      if (o = !0 === r ? void 0 !== o ? o : a.length - 1 : void 0 !== o ? o : 0, n = n || function() {}, o < a.length && o >= 0) b[t.type](_(e, a[o])), f = setTimeout(function() {
      ...
      (t = _(g, e)).bgColor = R(t.bgColor), t.textColor = R(t.textColor), t.position = t.position.toLowerCase(), t.animation = T.types["" + t.animation] ? t.animation : g.animation, w = t.win.document;
      ...
      if (s || l)
        for (var d = 0; d < T.types["" + t.animation].length; d++) {
          ...
          s && (p.y < .6 ? p.y = p.y - .4 : p.y = p.y - 2 * p.y + (1 - p.w)), l && (p.x < .6 ? p.x = p.x - .4 : p.x = p.x - 2 * p.x + (1 - p.h)), T.types["" + t.animation][d] = p
        }
        ...
        t = ("string" == typeof t ? {
          ...
          try {
            if ("number" == typeof e ? e > 0 : "" !== e) {
              ...
              if ("animation" in t && T.types["" + t.animation] && (n.options.animation = "" + t.animation), "type" in t && b["" + t.type] && (n.options.type = "" + t.type), ["bgColor", "textColor"].forEach(function(e) {

...
u && Object.keys(u).length && (e.contexts = {
  ...u,
  ...e.contexts
}), _ && (e.level = _), E && 'transaction' !== e.type && (e.transaction = E);
  }(e, t), _ && function(e, t) {
e.contexts = {
  trace: (0, i.wy)(t),
  ...e.contexts
...
span: A
  ...
  s(e, 'extra', r), s(e, 'tags', n), s(e, 'user', a), s(e, 'contexts', o), s(e, 'sdkProcessingMetadata', _), i && (e.level = i), R && (e.transactionName = R), A && (e.span = A), E.length && (e.breadcrumbs = [
...e.breadcrumbs,
...E
  ]), c.length && (e.fingerprint = [
...e.fingerprint,
...c
  ]), I.length && (e.eventProcessors = [
...e.eventProcessors,
...I
  ]), u.length && (e.attachments = [
...e.attachments,
...u

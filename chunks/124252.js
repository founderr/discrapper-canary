...
var a = n(470079), s = n(399606), r = n(541716), l = n(117530), i = n(154135), o = n(337077);
function c(e, t) {
    var n, c;
    let {
            mediaAttachments: d,
            ...
            let [t, n] = a.useState(null), o = (0, s.Wu)([l.Z], () => {
                    let t = l.Z.getUploads(e.id, r.I.CREATE_FORUM_POST.drafts.type), n = t.find(e => e.isThumbnail);
        ...
        }(e), m = Math.max(i.Yh - (null !== (n = null == d ? void 0 : d.length) && void 0 !== n ? n : 0), 0), {embeds: h} = (0, o.M)(u, m, t), _ = a.useMemo(() => null == h ? void 0 : h.flatMap(e => {
            let t = (0, i.Vh)(e);
            return null == t ? [] : {
                id: t,
                src: t,

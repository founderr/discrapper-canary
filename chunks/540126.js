...
let Y = 'placeholder-channel-id', j = 2;
...
let k = 0, W = 1, J = 3, K = 4, X = new Set([String(F.f.GUILD_DIRECTORY)]);
class q {
    getGuild(e, t) {
        var n;
...
class Q {
    ...
    getSectionRowsFromChannel(e) {
        ...
        if (l >= 0 && t.push({
            ...
            return [{ section: d().findIndex(this.getSortedNamedCategories(), e => e.id === (null == n ? void 0 : n.id)) + K }];
        let r = this.getCategory(n), a = r instanceof ee ? J : this.getSortedNamedCategories().indexOf(r) + K, o = r.getShownChannelIds().indexOf(n.id);
        if (a >= 0 && o >= 0) {
    ...
    nonPositionalChannelUpdate(e) {
        let t = this.initializationData, n = this.getCategory(e).updateChannel(e, t);
    ...
    getSlicedChannels(e, t) {
        ...
        let n = e[0], i = e[e.length - 1], s = !0, l = !1, a = [], d = [];
    ...
    constructor(e, t) {
        ...
        let s = N.Z.getMutableGuildChannelsForGuild(this.id), l = Z.Z.getGuild(this.id), a = {}, o = [], h = {};
        for (let e in s) {
            let t = s[e];
            t.type === B.d4z.GUILD_CATEGORY && (a[t.id] = t, h[t.id] = []);
        }
        let u = [], c = [], g = [], p = this.initializationData;
        for (let e in s) {
            let t = s[e];
...
class en extends $ {
    updateChannel(e, t) {
        let n = e.id in this.channels && O.ZP.isFavorite(e.guild_id, e.id), i = I.Z.getSuggestedChannelId(e.guild_id);
        return (e.id === i && !n && (t = {
            ...t,
    ...
    constructor(e, t) {
        ...
        let i = I.Z.getSuggestedChannelId(e.id), s = N.Z.getChannel(i);
...
class ei extends $ {
    ...
    updateChannel(e, t) {
        ...
        if (!(0, w.vc)(e.type))
            return !1;
        let n = super.updateChannel(e, t), i = this.channels[e.id];
...
class es extends $ {
    ...
    updateChannel(e, t) {
        ...
        if (this.guild.optInEnabled) {
            let n = this.channels[e.id], i = eI(this.guild, e, t);
            if (i && null == n)
    ...
    getShownChannelIds() {
        if (null == this.shownChannelIds) {
            let e = d()(this.channels).values().filter(e => 4 === e.renderLevel || 3 === e.renderLevel).filter(e => !e.record.isGuildVocal()), t = e.sortBy(e => {
                    let {record: t} = e;
                    return t.position;
                }).take(5).value(), n = new Set([
...
class ed extends ea {
    computeState(e) {
        ...
        let r = this.record.parent_id, a = this.category.guild;
        if (ef(a, this.record))
            return {
                renderLevel: 1,
                threadIds: []
            };
        let o = (null == n ? void 0 : n.id) === this.id || i === this.id, h = null != n && n.isThread() && n.parent_id === this.id, u = null !== (t = o || h || !this.category.isCollapsed && !this.isMuted ? s[this.id] : l[this.id]) && void 0 !== t ? t : {}, C = eg(this.record, u, n, i, a.hideMutedChannels);
...
class ec extends ed {
    ...
    computeState(e) {
        let t = super.computeState(e), n = this.getRenderLevel(t.renderLevel);
...
function eC(e, t, n) {
    if (e.type === B.d4z.GUILD_VOICE) {
        ...
        let r = o.ZP.getEmbeddedActivitiesForChannel(e.id), a = (null != r ? r : []).map(e => {
                var t;
...
function eg(e, t, n, i, s) {
    let l = null != n && (n.id === e.id || i === e.id), r = null != n && n.isThread() && n.parent_id === e.id;
    if (w.uC.has(e.type)) {

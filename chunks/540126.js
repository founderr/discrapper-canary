...
class Q {
  ...
  getSectionRowsFromChannel(e) {
    ...
    let i = n.isThread();
    if (i && (n = N.Z.getChannel(n.parent_id)), null == n) return t;
    ...
    if (l >= 0 && t.push({
        ...
        row: l
      }), n.type === B.d4z.GUILD_CATEGORY) return [{
  ...
  constructor(e, t) {
    ...
    for (let e in this.categories = {}, h) this.categories[e] = new et(this, a[e], h[e], p);
...
class et extends $ {
  ...
  constructor(e, t, n, i) {
    for (let s of (super(e), z(this, "id", void 0), z(this, "record", void 0), this.record = t, this.id = t.id, this.isCollapsed = !0 === e.collapsedCategoryIds[t.id], this.isMuted = e.mutedChannelIds.has(t.id), this.channels = {}, n)) this.channels[s.id] = new ed(this, s, i)
  }
}
class en extends $ {
  updateChannel(e, t) {
...
class ei extends $ {
  ...
  constructor(e, t, n) {
    if (super(e), z(this, "enabled", !1), this.isCollapsed = E.Z.isCollapsed(e.id), this.enabled = function() {
      ...
      for (let e of Object.values(t))(0, w.vc)(e.type) && !(0, w.Q5)(e.type) && (this.channels[e.id] = new eu(this, e, n))
  }
}
z(ei, "MIN_READABLE_CHANNELS", 7), z(ei, "MAX_RECENT_CHANNELS", 10), z(ei, "MAX_TIMESTAMP_DELTA", 6048e5);
class es extends $ {
  updateAllChannels(e) {
    let t = !1;
...
class el extends $ {
  ...
  getShownChannelIds() {
    ...
    if (null == this.shownChannelIds) {
      let t = d()(this.channels).filter(e => 4 === e.renderLevel).orderBy([e => (function(e, t) {
        ...
        return -1
      })(e, this.categoriesById), e => e.record.type === B.d4z.GUILD_CATEGORY ? -1 : e.record.position], ["asc", "asc"]).value();
  ...
  constructor(e, t, n, i) {
    if (super(e), z(this, "categoriesById", void 0), z(this, "hiddenChannelIds", void 0), this.categoriesById = n, this.hiddenChannelIds = null, !e.optInEnabled) return;
...
class ed extends ea {
  computeState(e) {
    ...
    if (!A.Z.can(x.Pl.VIEW_CHANNEL, this.record)) {
      ...
      if (!c.Z.isChannelGatedAndVisible(this.record.guild_id, this.record.id)) return {
        renderLevel: 1,
        threadIds: []
      }
    }

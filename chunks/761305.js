n(47120);
var s, r = n(735250), i = n(470079), a = n(593473), l = n(442837), o = n(544891), c = n(108427), u = n(601964), d = n(896797), h = n(129293), _ = n(388905), E = n(981631), g = n(689938), p = n(331651);
function f(e, t, n) {
...
class I extends (s = i.PureComponent) {
    componentDidMount() {
        let e = (0, h.Z)(this.props.location), t = (0, a.parse)(this.props.location.search);
        o.tn.post({
...
f(I, 'defaultProps', { transitionTo: e => n.g.location.assign(e) }), t.Z = l.ZP.connectStores([d.Z], () => ({ defaultRoute: d.Z.defaultRoute }))(I);

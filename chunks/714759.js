...
t.Z = e => {
    ...
    return (0, i.jsx)(s.Tooltip, {
        text: a.Z.Messages.APPLICATION_INSTALLATION_SPACE_USED.format({ used: c }),
        children: e => (0, i.jsxs)('div', {
            className: r.wrapper,
            role: 'progressbar',
            'aria-label': a.Z.Messages.APPLICATION_INSTALLATION_SPACE_USED.format({ used: c }),
            ...e,
            children: [
                (0, i.jsxs)('svg', {
                    viewBox: '25 25 50 50',
                    ...
                    children: [
                        ...
                        (0, i.jsx)('circle', {
                            ...
                            r: 20,
                            stroke: function (e) {
                                let t = Math.round(-85 * e + 199), n = Math.round(-71 * e + 208), i = Math.round(-22 * e + 240);

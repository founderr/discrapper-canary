...
let x = new Set([T.ChannelTypes.ANNOUNCEMENT_THREAD, T.ChannelTypes.PUBLIC_THREAD, T.ChannelTypes.PRIVATE_THREAD]),
  V = new Set([T.ChannelTypes.GUILD_TEXT, T.ChannelTypes.GUILD_ANNOUNCEMENT, T.ChannelTypes.GUILD_FORUM, T.ChannelTypes.GUILD_MEDIA]);
...
let j = new Set([T.ChannelTypes.GUILD_TEXT, T.ChannelTypes.GUILD_ANNOUNCEMENT, T.ChannelTypes.GUILD_STORE, T.ChannelTypes.GUILD_VOICE, T.ChannelTypes.GUILD_STAGE_VOICE, T.ChannelTypes.ANNOUNCEMENT_THREAD, T.ChannelTypes.PUBLIC_THREAD, T.ChannelTypes.PRIVATE_THREAD, T.ChannelTypes.GUILD_DIRECTORY, T.ChannelTypes.GUILD_FORUM, T.ChannelTypes.GUILD_MEDIA]),
  ...
  X = new Set([T.ChannelTypes.GUILD_TEXT, T.ChannelTypes.GUILD_FORUM, T.ChannelTypes.GUILD_MEDIA, T.ChannelTypes.ANNOUNCEMENT_THREAD, T.ChannelTypes.PUBLIC_THREAD, T.ChannelTypes.PRIVATE_THREAD, T.ChannelTypes.GUILD_VOICE, T.ChannelTypes.GUILD_STAGE_VOICE]),
...
let es = u.combine(T.Permissions.CONNECT, T.Permissions.VIEW_CHANNEL),
  ea = T.BasicPermissions.CONNECT | T.BasicPermissions.VIEW_CHANNEL;

function eo(e) {
  return L(e) ? es : T.Permissions.VIEW_CHANNEL
}

function el(e) {
  return L(e) ? ea : T.BasicPermissions.VIEW_CHANNEL
}
class eu {
  constructor(e) {
    var t, n, i;
...
class eE extends ec {
  static fromServer(e, t) {
    ...
    return (0, d.dangerouslyCast)(s, eE)
  }
  constructor(e) {
...
class ef extends ec {
  static fromServer(e, t) {
    ...
    return (0, d.dangerouslyCast)(a, ef)
  }
  constructor(e) {
    var t, n;
...
class eS {
  ...
  constructor(e = 100) {
    S(this, "cache", void 0), this.cache = new(a())(e)
  }
}
let eh = new eS,
  eA = new eS;

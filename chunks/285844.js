var r = n(957578).Buffer, i = r.alloc(16, 0);
function a(e) {
...
o.prototype.ghash = function (e) {
    ...
    for (var e, t, n, r = [
        ...
        for ((this.state[~~(o / 8)] & 1 << 7 - o % 8) != 0 && (i[0] ^= r[0], i[1] ^= r[1], i[2] ^= r[2], i[3] ^= r[3]), n = (1 & r[3]) != 0, t = 3; t > 0; t--)

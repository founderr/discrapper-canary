...
function A(e) {
  let {
    channel: t
  } = e, n = t.getRecipientId(), l = (0, d.gc)(n), s = Array(l.length).fill(null), {
    analyticsLocations: h
  } = (0, u.ZP)(c.Z.AKA), p = function(e) {
    let {
      userId: t,
      channelId: n,
  ...
  return 0 === p.getNicknameGuildPairs().length && 0 === l.length ? (0, i.jsx)("div", {
    ...
    value: h,
    children: [(0, i.jsx)(E.iz, {}), (0, i.jsx)(o.TextBadge, {
      ...
      max: 3,
      className: v.avatars
    }) : null, p.getNicknameGuildPairs().length > 0 ? (0, i.jsx)(f.Z, {
      position: "bottom",

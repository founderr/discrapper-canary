...
async function V(e) {
  ...
  try {
    ...
    let {
      duration: e,
      clipStats: t
    } = await (null != u ? s.saveClipForUser(u, r, l) : s.saveClip(r, l)), i = x(_, t);
...
async function F(e) {
  ...
  try {
    ...
    D.ClipsLogger.error("Clip Failed to Save", e), null == R || R.stop(), (0, p.playSound)("clip_error", .5), a.default.dispatch({

...
function D(e) {
    ...
    _.hW.updateAsync(
        ...
        T.default.track(L.rMx.CLIPS_SETTINGS_UPDATED, { allow_voice_recording: t });
}
async function b(e) {
...
function G(e) {
    ...
    s.Z.dispatch({
        ...
        n && T.default.track(L.rMx.CLIPS_SETTINGS_UPDATED, { viewer_clips_enabled: t });
}
function k(e, t) {
...
async function B(e) {
    ...
    try {
        ...
        let { duration: e, clipStats: t } = await (null != u ? a.saveClipForUser(u, i, l) : a.saveClip(i, l)),
            r = k(d, t);
        (r.clip_save_time_ms = t.clipSaveTimeMs), (r.clip_size_bytes = t.clipSizeBytes), null != t.viewerDecodeFps && ((r.decode_fps_during_clip = t.viewerDecodeFps), (r.encode_fps_during_clip = t.viewerEncodeFps), (r.target_fps = null)), T.default.track(L.rMx.CLIP_SAVED, r);
        let s = await (0, C.R)(o.Z.clips.getClipProtocolURLFromPath(i), 0);
        return (
            (n.thumbnail = s),
            (n.length = e),
            y.jF.info('Clip save succeeded with '.concat(e, 'ms and thumbnail ').concat(null !== (_ = null == s ? void 0 : s.length) && void 0 !== _ ? _ : 0, ' bytes thumbnail.')),
        ...
        if (
            ...
            throw (T.default.track(L.rMx.CLIP_SAVE_FAILURE, d), r);
        let t = k(d, r);
        throw ((t.error_at = r.errorAt), (t.error_message = r.errorMessage), T.default.track(L.rMx.CLIP_SAVE_FAILURE, t), r.errorMessage);
    }
}
async function F(e) {
    var t;
    ...
    let E = f.Z.getCurrentUserActiveStream(),
        ...
        S = (() => {
            ...
            return e === h.default.getId() ? y.X9.STREAMER : null != e ? y.X9.VIEWER : y.X9.DECOUPLED;
        })(),
        N = await (async () => {
            if (null == T) return;
    ...
    try {
        ...
        y.jF.error('Clip Failed to Save', e), null == O || O.stop(), (0, g.GN)('clip_error', 0.5), s.Z.dispatch({ type: 'CLIPS_SAVE_CLIP_ERROR' });
    }
    y.jF.info(''.concat(A.Z.getSettings().clipsLength / 1000, 's clip save took ').concat(Math.round(performance.now() - R), 'ms'));
}
function V(e, t) {
    s.Z.dispatch({
...
async function H(e, t) {
    ...
    null != (await (0, R.w)(r)) &&
        ...
        T.default.track(L.rMx.CLIP_EDITED, { clip_id: r.id }),
        s.Z.dispatch({

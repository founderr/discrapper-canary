...
var t = r(735250), o = r(470079), a = r(120356), l = r.n(a), i = r(920906), s = r(399606), c = r(692547), u = r(780384), d = r(481060), m = r(596454), h = r(410030), v = r(339085), p = r(14263), g = r(689938), x = r(106125);
function f(e) {
    let {
            guildId: n,
            option: r,
            ...
            hideMemberCount: C,
            canBeNew: b
        } = e, O = (0, u.wj)((0, h.ZP)()), [N, j] = o.useState(!1), _ = N && !C, M = o.useRef(null), {reducedMotion: k} = o.useContext(d.AccessibilityPreferencesContext), Z = (0, s.e7)([v.Z], () => {
            var e, n, t, o;
            ...
            from: { color: w.spring() },
            color: R.spring({ opacity: O ? 0.5 : 0.25 }),
            config: { duration: 300 },
            delay: 500
                ...
                children: [
                    ...
                    A((e, n) => S > 0 && n && (0, t.jsx)(i.animated.div, {
                        ...
                        children: (0, t.jsx)(d.Text, {
                            variant: 'text-xs/normal',
                            color: 'always-white',
                            children: g.Z.Messages.ONBOARDING_OPTION_ROLE_COUNTS.format({ memberCount: S })
                        })
                    })),

...
function f(e) {
  ...
  }), T = (0, p.Z)(n, 1e3), S = null == T || null == r.roleIds ? 0 : Math.max(...r.roleIds.map(e => T[e])), y = b && !a && r.isUnseen, I = (0, i.useSpring)({
  ...
  o.useEffect(() => {
    if (_) return M.current = setTimeout(() => {
      j(!1), M.current = null
    }, 3e3), () => {
  ...
  return (0, t.jsx)(t.Fragment, {
    children: (0, t.jsx)(i.animated.div, {
      ...
      children: (0, t.jsxs)(d.Clickable, {
        ...
        onMouseDown: () => B(!0),
        onMouseUp: () => B(!1),
        children: [null != r.emoji && (null != r.emoji.id || null != r.emoji.name) ? (0, t.jsx)(m.Z, {

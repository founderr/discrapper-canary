...
var r = n(392711), i = n.n(r), a = n(149765), o = n(50244), s = n(686660), l = n(131704), u = n(314897), c = n(592125), d = n(984933), _ = n(650774), E = n(271383), f = n(430824), h = n(131951), p = n(496675), m = n(158776), I = n(19780), T = n(306680), g = n(944486), S = n(914010), A = n(9156), N = n(979651), v = n(626135), O = n(70956), R = n(700785), C = n(546416), y = n(981631), D = n(176505);
function L(e) {
    let t = 0;
    for (let n in e)
        t += 1;
...
function b(e) {
    ...
    if (null == n)
        return null;
    let r = f.Z.getRoles(n.id), i = u.default.getId(), a = E.ZP.getMember(e, i), o = d.ZP.getChannels(e), s = o[d.sH].length, l = o[d.Zb].length, c = N.Z.getVoiceStates(e);
    return {
        guild_id: n.id,
...
function U(e) {
    ...
    if (null == t)
        return null;
    let n = h.Z.isVideoEnabled(), r = I.Z.getMediaSessionId();
    return {
        channel_id: t.id,
        channel_type: t.type,
...
function w(e) {
    var t, n, r, i, a;
    let o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, s = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
    if (v.default.isThrottled(e))
        return;
    let l = !('location' in o) || o.location !== y.Sbl.GUILD_CREATE_INVITE_SUGGESTION, u = 'guild_id' in o ? o.guild_id : l ? S.Z.getGuildId() : null, d = 'channel_id' in o ? o.channel_id : l ? g.Z.getChannelId(u) : null, _ = c.Z.getChannel(d);
...
function G(e, t, n) {
    ...
    return i()(N.Z.getVoiceStates(e)).filter(e => e.channelId === t).filter(e => e.userId !== u.default.getId()).forEach(e => {
        r.voice_state_count++, (e.selfVideo || e.selfStream) && r.video_stream_count++;
    }), r;
}
function k(e, t) {
    let n = { custom_status_count: 0 };
    return i()(N.Z.getVoiceStates(e)).forEach(e => {

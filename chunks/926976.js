...
var a = r(735250), n = r(470079), i = r(120356), o = r.n(i), l = r(913527), c = r.n(l), s = r(442837), d = r(481060), u = r(129861), h = r(594174), m = r(502568), g = r(55935), p = r(120816), b = r(31336), f = r(257785), y = r(484036), x = r(681619), k = r(621060), v = r(689938), _ = r(206884), C = r(719556);
let w = [
    {
        key: 'event',
                    ...
                    children: [
                        ...
                        (0, a.jsx)(j, {
                            children: Object.entries(r).map(e => {
                                ...
                                return (0, a.jsx)(N, {
                                    name: ''.concat(t, ':'),
                                    children: null != r ? (0, a.jsx)('code', { children: JSON.stringify(r) }) : (0, a.jsx)('code', {
...
function I() {
    let e = n.useRef(null), t = (0, s.e7)([p.Z], () => p.Z.loggedEvents), [r, i] = n.useState(Object.keys(T)), l = t.filter(e => {
            for (let t of r)
                if (T[t].filter(e))
                    return !0;
            return !1;
        }), [c, u] = n.useState(void 0), h = l.find(e => e.key === c), {
            TabBar: m,
            renderSelectedTab: g
        } = (0, k.Z)({ tabs: S }, []);
    return (0, a.jsxs)('div', {

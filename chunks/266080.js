...
guildId: t,
reportId: n
  } = e, [_, E] = i.useState(!1), f = u.Z.getGuild(t), h = null != f;
  i.useEffect(() => {
E(!h);
  }, [h]);
  let p = i.useCallback(() => {
E(!0), s.ZP.trackWithMetadata(c.rMx.IAR_LEAVE_GUILD_BUTTON_CLICKED, {
  guild_id: t,
  report_id: n
}), o.Z.leaveGuild(t);
  }, [
...
description: d.Z.Messages.IAR_UPSELLS_LEAVE_SERVER_DESCRIPTION.format({

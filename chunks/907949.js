var n = r(8400), i = r(887109), o = r(118658), a = r(808570), u = r(924125), s = r(488959), c = r(581079), l = r(660610), f = o.isBrowser('IE');
function p(t, e) {
    for (var r = t, n = r; r;) {
...
function g(t, e, r, o) {
    ...
    if (r > h(e) && (i.logSelectionStateFailure({
        ...
        }), n.handleExtensionCausedError()), a.setStart(e, r), f)
        try {
            t.addRange(a);
        } catch (t) {
        }
...
t.exports = {
    setDraftEditorSelection: function (t, e, r, n, i) {
        ...
        if (!!a(o.documentElement, e)) {
            var u = o.defaultView.getSelection(), c = t.getAnchorKey(), l = t.getAnchorOffset(), f = t.getFocusKey(), p = t.getFocusOffset(), h = t.getIsBackward();
            if (!u.extend && h) {
                var y = c, v = l;
                c = f, l = p, f = y, p = v, h = !1;
            }
            var m = c === r && n <= l && i >= l, _ = f === r && n <= p && i >= p;
            if (m && _) {
            ...
            if (h) {
                if (_ && (u.removeAllRanges(), g(u, e, p - n, t)), m) {
                    var b = u.focusNode, S = u.focusOffset;
                    u.removeAllRanges(), g(u, e, l - n, t), d(u, b, S, t);
                }
            } else
                m && (u.removeAllRanges(), g(u, e, l - n, t)), _ && d(u, e, p - n, t);
        }
    },

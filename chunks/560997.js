...
var r = n(442837), i = n(570140), a = n(238514), o = n(675478), s = n(581883), l = n(526761);
function u(e, t, n, i) {
    let a = () => {
        var r;
    ...
    return {
        getSetting: a,
        updateSetting: _(a, n => o.hW.updateAsync(e, e => {
            e[t] = i(n, e[t]);
        }, l.fy.INFREQUENT_USER_ACTION)),
        useSetting: () => (0, r.e7)([s.Z], a)
    };
}
function c(e, t, n) {
    let o = () => {
    ...
    return {
        getSetting: o,
        useSetting: () => {
            let i = e.useSetting(), o = (0, r.e7)([a.Z], () => {

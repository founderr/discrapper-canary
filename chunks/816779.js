n(47120), n(653041);
var i, l = n(735250), r = n(470079), a = n(120356), s = n.n(a), o = n(954955), c = n.n(o), u = n(748780), d = n(902704), h = n(481060), p = n(740933);
function _(e, t, n) {
...
class m extends r.Component {
    ...
    componentDidUpdate(e) {
        let {hide: t} = e, {hide: n} = this.props;
    ...
    getAnimatedStyle() {
        let {translateY: e} = this.state, {reverse: t} = this.props;
        return {
            transform: [{
...
class g extends (i = r.PureComponent) {
    ...
    render() {
        let {
                ...
                hide: c,
                animate: u
            } = this.props, {reducedMotion: d} = this.context;
        return (0, l.jsx)('div', {
    ...
    constructor(...e) {
        super(...e), _(this, 'state', {
            ...
            let {
                    unread: t,
                    mention: n
                } = this.state, {onJumpTo: i} = this.props, l = null != n ? n : t;
            null != l && i(l, [
                n,
                t
            ]);

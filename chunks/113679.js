...
function I(e) {
  let {
guild: t
  } = e, n = a.useId(), I = (0, i.e7)([o.Z], () => null != t && o.Z.can(d.Plq.MANAGE_GUILD, t), [t]), E = t.hasFeature(d.oNc.COMMUNITY), [T, m] = a.useState(t.hasFeature(d.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY)), N = a.useCallback(async e => {

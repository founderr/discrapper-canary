...
function y(e, t, n) {
  return null != e.guild_id && n && !((0, _.Q5)(e.type) || A.ZP.isChannelRecordOrParentOptedIn(e)) && 0 === t
}

function U(e) {
  let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
    n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
  return !(null == e || e.isGuildVocal() && 0 === t || e.hasFlag(O.zZ.IS_GUILD_RESOURCE_CHANNEL) || (0 === t || n) && (e.isThread() ? l.Z.isMuted(e.id) || A.ZP.isGuildOrCategoryOrChannelMuted(e.guild_id, e.parent_id) : A.ZP.isGuildOrCategoryOrChannelMuted(e.guild_id, e.id)) || !e.isPrivate() && (y(e, t, (0, o.r1)(e.guild_id)) || !T.Z.can(e.accessPermissions, e))) && (t > 0 || A.ZP.resolveUnreadSetting(e) === p.i.ALL_MESSAGES)
}
...
function G(e, t) {
  ...
  if (t === p.W.GUILD_EVENT) return !(A.ZP.isMuted(e) || A.ZP.isMuteScheduledEventsEnabled(e)) && n;
  return n
}
...
function k(e, t, n) {
  return x(t), t.mentionCount = r()(t.mentionCounts).values().sum(), (t.unread !== n.unread || t.mentionCount !== n.mentionCount) && (C[null != e ? e : g] = t, null != e && (t.unread ? v.add(e) : v.delete(e)), L++, P(null != e ? e : g), B(t, n), !0)
}
...
function V(e, t) {
  ...
  if (t.forEach(e => {
    ...
    }), r.unreadByType[p.W.CHANNEL] = s, r.unreadByType[p.W.CHANNEL] !== i.unreadByType[p.W.CHANNEL] && !r.unreadByType[p.W.CHANNEL]) {
    let e = E.Z.getChannel(i.unreadChannelId);
    if (!(null != e && !t.includes(e.id) && h.ZP.hasUnread(e.id) && U(e))) return H(n);
    null != n && v.add(n), r.unreadByType[p.W.CHANNEL] = !0
  }
  return k(n, r, i)
}
...
function Z(e, t) {
  ...
  let n = M(e),
    i = w(e, n);
  return i.unreadByType[p.W.GUILD_EVENT] = G(e, t), k(e, i, n)
}
...
function H(e, t) {
  ...
  if (null == n) {
    ...
    let e = A.ZP.isMuted(n);
    if (e && !1 === t) return !1;
    let r = A.ZP.getMutedChannels(n),
      s = A.ZP.getChannelOverrides(n),
      u = (0, o.r1)(n),
      c = E.Z.getMutableBasicGuildChannelsForGuild(n);
    for (let t in c) {
      let n = c[t],
        o = e || r.has(t) || null != n.parent_id && r.has(n.parent_id),
        a = i.unreadByType[p.W.CHANNEL],
        {
          mentionCount: l,
          unread: d
      ...
      (I || E) && function(e, t, n) {
        ...
        return !("flags" in e && e.hasFlag(O.zZ.IS_GUILD_RESOURCE_CHANNEL)) && (t > 0 || A.ZP.resolveUnreadSetting(e) === p.i.ALL_MESSAGES)
      }(n, l, u) && (I && (i.unreadByType[p.W.CHANNEL] = !0, i.unreadChannelId = t), E && (i.mentionCount += Math.max(l - 0, 0), i.mentionCounts[n.id] = Math.max(l - 0, 0)))
    }
    let d = a.Z.getActiveJoinedThreadsForGuild(n);
    for (let t in d)
      for (let n in d[t]) {
        !i.unreadByType[p.W.CHANNEL] && h.ZP.hasUnread(n) && !l.Z.isMuted(n) && !e && (i.unreadByType[p.W.CHANNEL] = !0, i.unreadChannelId = n);
        let t = h.ZP.getMentionCount(n);
        t > 0 && (i.mentionCount += t, i.mentionCounts[n] = t)
      }!i.unreadByType[p.W.GUILD_EVENT] && G(n, p.W.GUILD_EVENT) && (i.unreadByType[p.W.GUILD_EVENT] = !0)
  }
  x(i);
  let r = M(n);
  return (i.unread !== r.unread || i.mentionCount !== r.mentionCount) && (C[null != n ? n : g] = i, null != n && (i.unread ? v.add(n) : v.delete(n)), L++, P(null != n ? n : g), B(i, r), !0)
}
...
function Y(e) {
  ...
  for (let e of (i && n.entries.forEach(e => {
      if (null != e.mention_count && e.mention_count > 0) {
        if (null == e.read_state_type || e.read_state_type === p.W.CHANNEL) {
          var t;
...
function q() {
  let e = E.Z.getChannel(f.Z.getChannelId());
...
function J(e) {
  ...
  if (null != n.guild_id) {
    let e = M(n.guild_id);
    if (((n.isThread() ? !l.Z.hasJoined(n.id) || l.Z.isMuted(n.id) : A.ZP.isGuildOrCategoryOrChannelMuted(n.guild_id, n.id)) || e.unreadByType[p.W.CHANNEL]) && 0 === h.ZP.getMentionCount(t)) return !1
  }
...
function er(e) {
  ...
  return Z(t.guild_id, p.W.GUILD_EVENT)
}
...
class ef extends S.Z {
  initialize() {
    this.waitFor(E.Z, f.Z, h.ZP, T.Z, d.default, N.default, A.ZP, a.Z, l.Z, s.Z)
  }
  loadCache() {
  ...
  getGuildHasUnreadIgnoreMuted(e) {
    ...
    for (let e in n)
      ...
      } return !!h.ZP.hasUnreadOrMentions(e, p.W.GUILD_EVENT) || !1
  }
...
R(ef, "displayName", "GuildReadStateStore"), R(ef, "LATEST_SNAPSHOT_VERSION", 1), t.default = new ef
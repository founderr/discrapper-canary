...
function Z(e, t) {
    ...
    let n = O(e),
        r = P(e, n);
    return (r.unreadByType[S.W.GUILD_EVENT] = M(e, t)), G(e, r, n);
}
function F(e, t) {
    let n = w(e),
        r = R(n);
        ...
        for (let t in d) {
            ...
            (m || _) &&
                (function (e, t, n) {
                    ...
                    return !('flags' in e && e.hasFlag(b.zZ.IS_GUILD_RESOURCE_CHANNEL)) && (t > 0 || E.ZP.resolveUnreadSetting(e) === S.i.ALL_MESSAGES);
                })(n, o, c) &&

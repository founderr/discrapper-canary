...
function J(e) {
  ...
  return n !== m.FAVORITES && null != t && x(n, [t])
}
...
function ei(e) {
  ...
  return V(t.guild_id, p.ReadStateTypes.GUILD_EVENT)
}
...
function eo(e) {
  return (0, l.doesThreadMembersActionAffectMe)(e) && x(e.guildId, [e.id])
}
...
function el(e) {
  ...
  return x(n, t.filter(e => o.default.hasJoined(e.id)).map(e => e.id))
}

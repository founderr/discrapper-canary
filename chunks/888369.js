...
n(57132), n(140155);
var a = n(398758), o = n(601070), s = n(569471), l = n(195663), u = n(131704), c = n(709054), d = n(314897), _ = n(592125), E = n(430824), f = n(496675), h = n(306680), p = n(944486), m = n(412788), I = n(9156), T = n(594174), g = n(981631), S = n(176505), A = n(490897);
function N(e, t, n) {
...
function U(e, t) {
    ...
    if (t === A.W.GUILD_EVENT)
        return !(I.ZP.isMuted(e) || I.ZP.isMuteScheduledEventsEnabled(e)) && n;
    return n;
}
function w(e, t) {
    let n = y(e);
...
function B(e, t) {
    ...
    if (t.forEach(e => {
        ...
        }), i.unreadByType[A.W.CHANNEL] = a, i.unreadByType[A.W.CHANNEL] !== r.unreadByType[A.W.CHANNEL] && !i.unreadByType[A.W.CHANNEL]) {
        let e = _.Z.getChannel(r.unreadChannelId);
        if (!(null != e && !t.includes(e.id) && h.ZP.hasUnread(e.id) && M(e)))
            return V(n);
...
function V(e, t) {
    ...
    if (null == n) {
        ...
        for (let t in e) {
            let n = e[t], i = h.ZP.getMentionCount(t);
        ...
        if (e && !1 === t)
            return !1;
        let i = I.ZP.getMutedChannels(n), l = I.ZP.getChannelOverrides(n), c = (0, a.r1)(n), d = _.Z.getMutableBasicGuildChannelsForGuild(n);
        for (let t in d) {
            let n = d[t], a = e || i.has(t) || null != n.parent_id && i.has(n.parent_id), o = r.unreadByType[A.W.CHANNEL], {
                    mentionCount: s,
                    unread: _
                } = h.ZP.getGuildChannelUnreadState(n, c, l, a, o), E = s > 0;
            if (!E && a)
                continue;
            let p = !o && (!a || E) && _;
            (p || E) && function (e, t, n) {
                if ((0, u.bw)(e.type) && 0 === t || !f.Z.canBasicChannel((0, u.Gz)(e.type), e) || b(e, t, n))
                    return !1;
                return !('flags' in e && e.hasFlag(S.zZ.IS_GUILD_RESOURCE_CHANNEL)) && (t > 0 || I.ZP.resolveUnreadSetting(e) === A.i.ALL_MESSAGES);
            }(n, s, c) && (p && (r.unreadByType[A.W.CHANNEL] = !0, r.unreadChannelId = t), E && (r.mentionCount += s, r.mentionCounts[n.id] = s));
        }
        let E = o.Z.getActiveJoinedThreadsForGuild(n);
        for (let t in E)
            for (let n in E[t]) {
                !r.unreadByType[A.W.CHANNEL] && h.ZP.hasUnread(n) && !s.Z.isMuted(n) && !e && (r.unreadByType[A.W.CHANNEL] = !0, r.unreadChannelId = n);
...
function Z(e) {
    ...
    O = {}, C = 0, R = new Set();
    let r = n.entries.length < 500, i = new Set();
...
function Y() {
    for (let e of (O = {}, R = new Set(), V(null), Object.values(E.Z.getGuildIds())))
        V(e);
}
function j(e) {
    let {guild: t} = e;
...
function Q(e) {
    let {channelId: t} = e, n = _.Z.getChannel(t);
...
function X(e) {
    ...
    if (null != n.guild_id) {
        let e = D(n.guild_id);
        if (((n.isThread() ? !s.Z.hasJoined(n.id) || s.Z.isMuted(n.id) : I.ZP.isGuildOrCategoryOrChannelMuted(n.guild_id, n.id)) || e.unreadByType[A.W.CHANNEL]) && 0 === h.ZP.getMentionCount(t))
            return !1;
    }
...
function ee(e) {
    let {channels: t} = e;
    return i()(t).groupBy(e => e.getGuildId()).reduce((e, t, n) => B(n, t.map(e => e.id)) || e, !1);
}
function et(e) {
    let {channels: t} = e;
    return i()(t).map(e => {
...
function el(e) {
    ...
    return B(n, t.filter(e => s.Z.hasJoined(e.id)).map(e => e.id));
}
function eu(e) {
    return !!(e.channels.length > 0) && B(e.guildId, e.channels.map(e => e.id));
}
function ec(e) {
    let {guildId: t} = e;
    return V(t);
...
function e_(e) {
    let {userGuildSettings: t} = e, n = new Set(t.map(e => {
            var t;
...
class eh extends m.Z {
    initialize() {
        this.waitFor(_.Z, p.Z, h.ZP, f.Z, d.default, T.default, I.ZP, o.Z, s.Z);
    }
    loadCache() {
    ...
    getGuildHasUnreadIgnoreMuted(e) {
        ...
        for (let e in t) {
            let n = t[e];
            if (null != n) {
                if ((!n.isGuildVocal() || 0 !== h.ZP.getMentionCount(e)) && f.Z.can(n.accessPermissions, n) && h.ZP.hasUnreadOrMentions(e))
                    return !0;
            }
        }

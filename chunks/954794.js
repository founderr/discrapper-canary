...
function S(e) {
  let {
    onBackClick: s
  } = e, t = (0, i.e7)([d.Z], () => d.Z.getAllUnlockedAchievements()), S = a.useMemo(() => Object.values(t).sort((e, s) => s.dateUnlocked - e.dateUnlocked), [t]), I = a.useMemo(() => Object.values(_.LG).filter(c.lm).filter(e => null == t[e.id]).sort((e, s) => e.rarity - s.rarity), [t]);
  return (0, n.jsxs)(n.Fragment, {
    ...
    }), S.length > 0 && (0, n.jsx)(o.FormSection, {
      className: T.divider,
    ...
    }), I.length > 0 && (0, n.jsxs)(o.FormSection, {
      className: T.divider,
      children: [(0, n.jsx)("div", {
        className: T.headerTextContainer,

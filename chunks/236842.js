...
var r = n(836560), i = n(259443), a = n(436620);
function o(e, t, n) {
...
class l extends r.EventEmitter {
    ...
    setStream(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = this.pc, r = 'closed' === this.iceConnectionState, i = !1;
        null != this.stream && !r && (this.senders.forEach(e => n.removeTrack(e)), i = !0), this.stream = e, this.senders = [], null != e && !r && (this.senders = [
            ...e.getAudioTracks().map(t => n.addTrack(t, e)),
            ...e.getVideoTracks().map(t => n.addTrack(t, e))
        ], i = !0), i && !t && this.negotiationNeeded();
    }
    createOffer() {
        let e = this.pc;
        return e.createOffer(this.makeOfferAnswerOptions()).then(t => e.setLocalDescription(this.mungeLocalDescription(t))).then(() => {
            ...
            if ('have-remote-offer' === e.signalingState)
                return s.error(t), this.createOffer();
            throw t;
        });
    }
    createAnswer() {

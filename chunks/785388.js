...
class X extends s.PureComponent {
    ...
    loadMore() {
        let {
                ...
                reaction: t,
                reactionType: n
            } = this.props, {lastId: i} = this.state;
        this.setState({ loadingMore: !0 }), C.U0({
    ...
    constructor(...e) {
        super(...e), z(this, 'scrollerRef', s.createRef()), z(this, 'state', {
            ...
            if (1 === t)
                return 0 === n ? (0, i.jsx)(h.Spinner, { className: G.spinnerMore }, 'hasMore') : null;
            return 0 === r.length && this.state.loadingMore ? (0, i.jsx)(h.Spinner, { className: G.spinner }, 'loadingMore') : null != d && (0, i.jsx)(q, {
                message: s,
                emoji: l.emoji,
                guildId: o,
                channel: a,
...
let $ = u.ZP.connectStores([M.Z], e => {
    ...
    let o = Object.values(s), a = (i === E.O.BURST ? n.burst_count : n.count) > o.length;
    return {
        reactors: o,
        hasMore: a
    };
...
function Q(e) {
    ...
    let I = (t = T, s.useMemo(() => {
            ...
            T,
            C
        ]), j = (0, u.e7)([f.Z], () => f.Z.saturation), M = (0, u.e7)([N.Z], () => (0, d.wj)(N.Z.theme));
    if (s.useEffect(() => {

...
function U(e) {
  ...
  if (r.useEffect(() => {
      a(x)
    }, [a, x]), null != x) return (0, s.jsx)(c.FormErrorBlock, {
    children: x.message
  });
  ...
  if (null == T || null == A || O) return (0, s.jsx)(c.Spinner, {
    className: j.spinner
  });
...
function F(e) {
  ...
  return (r.useEffect(() => {
    u(g)
  }, [u, g]), null != g) ? (0, s.jsx)(c.FormErrorBlock, {
    children: g.message
  }) : (null != h && (a = {
    amount: h.total,
    currency: h.currency,
...
function B(e) {
  ...
  if (null != d) return (0, s.jsx)(c.FormErrorBlock, {
    children: d.message
  });

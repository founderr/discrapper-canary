e = n.nmd(e), n("781738"), n("424973"), n("843762"), (function() {
  ...
  var x = function e(t) {
    ...
    var d = c.navigator || {},
      p = d.userAgent || "";
    t || (t = p);
    var x = l ? !!d.likeChrome : /\bChrome\b/.test(t) && !/internal|\n/i.test(f.toString()),
      w = "Object",
      S = l ? w : "ScriptBridgingProxyObject",
      k = l ? w : "Environment",
      E = l && c.java ? "JavaPackage" : g(c.java),
      _ = l ? w : "RuntimeObject",
      M = /\bJava/.test(E) && c.java,
      D = M && g(c.environment) == k,
      C = c.document || {},
      P = c.operamini || c.opera,
      T = u.test(T = l && P ? P["[[Class]]"] : g(P)) ? T : P = null,
      A = t,
      R = [],
      I = null,
      O = t == p,
    ...
    if (j && (s = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(j) || /(?:alpha|beta)(?: ?\d)?/i.exec(t + ";" + (O && d.appMinorVersion)) || /\bMinefield\b/i.test(t) && "a") && (I = /b/i.test(s) ? "beta" : "alpha", j = j.replace(RegExp(s + "\\+?$"), "") + ("beta" == I ? M ? "b" : "β" : M ? "a" : "α") + (/\d+\+?/.exec(s) || "")), "Fennec" == N || "Firefox" == N && /\b(?:Android|Firefox OS)\b/.test(z)) N = "Firefox Mobile";
    ...
    }), (s = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(A)) && !/\bi686\b/i.test(A) ? (z && (z.architecture = 64, z.family = z.family.replace(RegExp(" *" + s), "")), N && (/\bWOW64\b/i.test(t) || O && /\w(?:86|32)$/.test(d.cpuClass || d.platform) && !/\bWin64; x64\b/i.test(t)) && R.unshift("32-bit")) : z && /^OS X/.test(z.family) && "Chrome" == N && parseFloat(j) >= 39 && (z.architecture = 64), t || (t = null);
    var V = {};

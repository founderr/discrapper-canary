...
setSearchQuery: t,
placeholder: l
  } = e, r = a.useRef(null), [s, c] = a.useState(!1), u = a.useMemo(() => o().debounce(e => {
...
c(!0), (0, h.yw)(k.rMx.APP_LAUNCHER_SEARCH_FOCUSED, {
  source: L.Z.entrypoint(),
  location: I.Vh.APP_LAUNCHER_HOME
});
  }, []), _ = a.useCallback(() => {
...
frecentApps: o,
loading: r
  } = (0, R.f)(n), s = t === b._b.VOICE, c = a.useMemo(() => {
let e = [];
for (let n of o)
...
o,
s
  ]), d = D.Z.Messages.APP_LAUNCHER_HOME_RECENT_APPS_HEADER, u = d;
  s && (u = D.Z.Messages.APP_LAUNCHER_HOME_RECENT_APPS_HEADER_ACTIVITIES);
  let {
items: m,
handleViewMore: p
  } = ee(u, t === b._b.VOICE ? M.U4.LARGE_BANNER : M.U4.ROW, c, 8, b.L3.RECENT_APPS);
  a.useEffect(() => {
if (!0 !== r.current)
  0 !== m.length && (0, h.yw)(k.rMx.APP_LAUNCHER_FRECENTS_SEEN, {
    num: m.length,
...
d
  ]), p = (0, g.h)(m), _ = b.L3.APPS_IN_THIS_SERVER, C = a.useMemo(() => o().compact(p.map(e => {
let {
  application: n
} = e;
return n;
...
channel: n,
recommendationsSections: s
  }), p = o === E.M.FETCHING, f = !p && 0 === s.length;
  return (a.useEffect(() => {
l(f);
  }, [
f,

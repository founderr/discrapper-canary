...
function V(e) {
    let {
            ...
            setSearchQuery: r,
            setScroller: s
        } = e, o = (0, m.NX)(n.id, !0, 'AppLauncherHomeScreen'), c = t === T._b.TEXT, d = t === T._b.TEXT, _ = t === T._b.TEXT, E = t === T._b.VOICE, A = t === T._b.TEXT, [N, h] = Q(c), [C, f] = Q(d), [I, x] = Q(_), [v, P] = Q(_), g = N && C && I && v, M = (_ || d) && !g;
    l.useEffect(() => {
        o && (0, p.w1)({

...
function Q(e) {
    ...
    let a = (0, E.Z)({
            guildId: n.getGuildId(),
            channel: n
        }), r = y.U4.LARGE_BANNER, {trackSectionImpressionRef: s} = (0, b.Z)({
...
function J(e) {
    ...
    return (l.useEffect(() => {
        ...
        children: [
            ...
            (0, i.jsx)('div', {
                className: V.sectionContentContainer,
                children: N ? F.map(e => (0, i.jsx)(j.Z, { look: y.U4.NO_BANNER }, e)) : A.map((e, n) => {
                    let {
                        application: t,
                        isPartner: l
                    } = e;
...
function $(e) {
    let {
            ...
            let {sectionDescriptors: a} = P.wi(n, { commandType: d.yU.CHAT }, {
                    placeholderCount: 0,
                    limit: B.tn,
                    includeFrecency: !0
                }), r = l.useCallback(e => !(0, M.ye)({ application: e }) && !(null != a.find(n => n.id === e.id)), [a]), {
                    fetchState: s,
...
function K(e) {
    let {
            ...
            items: d,
            handleViewMore: m
        } = en(r, s, c, 8, u), {trackSectionImpressionRef: p} = (0, b.Z)({
            sectionName: u,
            numItems: c.length,

...
var o, s = n(756647), l = n(442837), u = n(544891), c = n(761609);
function d(e, t, n) {
...
let _ = 1500, E = null !== (o = window.requestIdleCallback) && void 0 !== o ? o : e => setImmediate(() => e()), f = new c.R(), h = {
    ...
    }, p = [], m = () => Promise.resolve({ sessionId: void 0 }), I = e => {
        let {
            dispatcher: t,
            actionHandler: n,
            getFingerprint: o,

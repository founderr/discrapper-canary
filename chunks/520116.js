...
function M(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), I = m.MessageDisplayCompact.useSetting(), x = (0, o.useStateFromStores)([S.default], () => S.default.can(C.Permissions.CREATE_INSTANT_INVITE, s)), M = (0, h.isSpamSupported)(s), L = !1, b = 0 === l.messages.length || i()(l.messages[0].timestamp).isSame(i()(), "day"), O = null !== (n = null === (t = g.default.getUser(p.default.getId())) || void 0 === t ? void 0 : t.hasFlag(C.UserFlags.SPAMMER)) && void 0 !== n && n, y = [];
  if (!l.collapsed) {
    let e = null,
      t = null,

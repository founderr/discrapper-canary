...
function A(e) {
    var t;
    let { user: n, displayProfile: a, guildId: T, pendingBanner: A, children: N, className: R, avatarSize: O, avatarOffsetX: v, avatarOffsetY: C, bannerWidth: L, bannerHeight: D, themePadding: y, animateOnHover: b = !1 } = e,
        M = (0, E.Dt)(),
        [P, U] = i.useState(!1),

...
var a = t(120356),
    ...
    N = t(113207);
function C() {
    let { enabled: e, autoToggle: s, hideInstantInvites: a, hidePersonalInformation: C, disableSounds: A, disableNotifications: m, enableContentProtection: g } = (0, r.cj)([_.Z], () => ({ ..._.Z.getSettings() })),
        h = (e, s) => {
            l.Z.update({ [e]: s });
        };

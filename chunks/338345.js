...
var n = s(735250);
s(470079);
var a = s(120356), i = s.n(a), r = s(442837), o = s(481060), l = s(223245), c = s(230711), d = s(921801), _ = s(246946), E = s(358085), u = s(726985), T = s(981631), I = s(689938), S = s(701784), N = s(331651);
function C() {
    let {
            enabled: e,
            autoToggle: t,
        ...
        } = (0, r.cj)([_.Z], () => ({ ..._.Z.getSettings() })), g = (e, t) => {
            l.Z.update({ [e]: t });
        };

...
emojiId: v,
emojiName: L
  } = n, R = null != m, [M, O] = l.useState(!1), b = (0, c.e7)([I.ZP], () => null != v ? I.ZP.getUsableCustomEmojiById(v) : null), D = R || null != T, U = (!R || !M) && (null != v || null != L), Z = 0 === r, P = l.useRef(null), y = (0, c.e7)([E.Z], () => E.Z.keyboardModeEnabled), x = e => {
let r = g.Sb.getSetting();
p.wS && r && (0, _.jW)(e, async () => {
  let {
    default: e
...
onMouseLeave: () => R && O(!1)
  ...
  return D ? (0, o.jsx)(d.Clickable, {
...w,
innerRef: P,
focusProps: {
  ringTarget: P
},
'aria-label': null != N ? N : S.Z.Messages.FORUM_TAG_A11Y_FILTER_BY_TAG.format({
  tagName: h
}),
role: 'button',
'aria-pressed': A,

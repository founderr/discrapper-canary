...
n(724522);
var a = n(442837), o = n(570140), s = n(749210), l = n(821849), u = n(232567), c = n(864106), d = n(710845), _ = n(292419), E = n(566006), f = n(952537), h = n(218543), p = n(48481), m = n(131704), I = n(209747), T = n(598077), g = n(592125), S = n(271383), A = n(819640), N = n(594174), v = n(979651), O = n(509545), R = n(78839), C = n(936101), y = n(868158), D = n(483012), L = n(955132);
let b = new d.Z('ConnectionStore'), M = new D.Z(L.Wb, (e, t) => {
        var n;
        e = null != e ? e : {
            type: 'CHANNEL_UPDATES',
            channels: []
        };
        let r = (0, m.q_)(t), i = g.Z.getChannel(t.id), a = null == i ? void 0 : i.merge({
                ...r,
                recipients: i.recipients,
                bitrate: null !== (n = r.bitrate) && void 0 !== n ? n : i.bitrate
            });
        return e.channels.push(null != a ? a : r), e;
    }, e => 'CHANNEL_UPDATE' !== e), P = new D.Z(L.Wb, (e, t) => ((e = null == e ? {
    ...
    }), e), e => 'SOUNDBOARD_SOUNDS' !== e), U = new D.Z(L.Wb, (e, t) => ((e = null != e ? e : {
        type: 'GUILD_MEMBERS_CHUNK_BATCH',
        chunks: []
    }).chunks.push(t), e), e => 'GUILD_MEMBERS_CHUNK' !== e), w = new D.Z(L.Wb, (e, t) => ((e = null == e ? {
        type: 'PRESENCE_UPDATES',
        updates: []
    } : e).updates.push(t), e), e => 'PRESENCE_UPDATE' !== e && 'GUILD_MEMBERS_CHUNK' !== e), x = {};
function G(e, t) {
    for (let n of e)
        x[n] = {
            preload: () => null,
...
function H(e) {
    ...
    null != t && null != i && V(i, r, t), null != n && n.forEach(e => {
...
k(['INITIAL_GUILD'], e => 'full' === e.data_mode ? null : g.o.loadGuildIds([e.id]), e => {
    h.Z.initialGuild.measure(() => {
        a.ZP.Emitter.batched(() => {
            ...
            null != N.default.getCurrentUser() && (F({
                type: 'GUILD_CREATE',
                guild: t
            }), F({
    ...
    h.Z.readySupplemental.measure(() => {
        a.ZP.Emitter.batched(() => {
            ...
            let a = e.presences ? r(e.presences) : [], o = (null !== (t = e.lazy_private_channels) && void 0 !== t ? t : []).map(e => (0, m.q_)(e)), s = null !== (n = e.game_invites) && void 0 !== n ? n : [];
    ...
    var t;
    let n = y.Eb(), r = e.guilds.filter(e => {
            var t, n;
    ...
    return Promise.all([
        n,
        null !== (t = g.o.loadGuildIds(r)) && void 0 !== t ? t : Promise.resolve()
    ]).then(e => {
        let [t] = e;
        return t;
    });
    ...
    h.Z.ready.measure(() => {
        a.ZP.Emitter.batched(() => {
            let t = (e = h.Z.hydrateReady.measure(() => y.IM(e, L.Wb.identifyStartTime, n))).private_channels.map(e => (0, m.q_)(e)), r = e.guilds.filter(e => !0 === e.unavailable && !0 !== e.geo_restricted).map(e => e.id), i = e.guilds.filter(e => !0 !== e.unavailable), a = e.guilds.filter(e => !0 === e.geo_restricted);
            i.forEach(e => {
                e.presences = [];
            });
...
}), k(['MESSAGE_CREATE'], e => g.o.loadGuildIds([e.guild_id]), e => {
    H(e), null != e.author && F({
        type: 'MESSAGE_CREATE',
        guildId: e.guild_id,
        channelId: e.channel_id,
...
}), k(['MESSAGE_UPDATE'], e => g.o.loadGuildIds([e.guild_id]), e => {
    H(e), F({
        type: 'MESSAGE_UPDATE',
        guildId: e.guild_id,
        message: e
    });
}), k(['MESSAGE_DELETE'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
        type: 'MESSAGE_DELETE',
        guildId: e.guild_id,
        id: e.id,
...
}), k(['MESSAGE_DELETE_BULK'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
...
}), k(['MESSAGE_ACK'], e => g.o.loadGuildFromChannelId(e.channel_id), e => {
    F({
        type: 'MESSAGE_ACK',
        channelId: e.channel_id,
        messageId: e.message_id,
...
}), k(['CHANNEL_PINS_ACK'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
...
}), k(['CHANNEL_PINS_UPDATE'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
    ...
    'CHANNEL_CREATE',
    'CHANNEL_DELETE'
], e => g.o.loadGuildIds([e.guild_id]), (e, t) => {
    F({
        type: t,
        channel: (0, m.q_)(e)
    });
...
}), k(['CHANNEL_UPDATE'], e => g.o.loadGuildIds([e.guild_id]), e => {
    M.add(e);
}), k([
    'THREAD_CREATE',
    'THREAD_UPDATE',
...
}), k(['THREAD_LIST_SYNC'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
...
}), k(['GUILD_CREATE'], e => 'full' === e.data_mode ? null : g.o.loadGuildIds([e.id]), e => {
    if (e.unavailable)
        F({
...
}), k(['GUILD_ROLE_DELETE'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
    ...
    if (null != t) {
        if ('string' == typeof t)
            throw console.error('Invalid proto: |'.concat(t, '| |').concat(e.settings.proto, '|')), console.error({
                parsed: t,
...
}), k(['EMBEDDED_ACTIVITY_UPDATE'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
...
}), k(['EMBEDDED_ACTIVITY_UPDATE_V2'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({
...
}), k(['PASSIVE_UPDATE_V2'], e => g.o.loadGuildIds([e.guild_id]), e => {
    F({

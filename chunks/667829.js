...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(392711), l = n.n(s), u = n(218887), c = n.n(u), d = n(729594), _ = n(873546), E = n(430742), f = n(166459), h = n(911969), p = n(476326), m = n(998698), I = n(710845), T = n(117530), g = n(459273), S = n(403182), A = n(541716), N = n(752305), v = n(30465), O = n(140963), R = n(4484), C = n(925994), y = n(981631), D = n(689938), L = n(573809);
function b(e, t, n) {
...
class U extends i.Component {
    ...
    componentDidUpdate(e) {
        if (this.fixFocus(e), this.props.useSlate !== e.useSlate) {
            var t, n;
            let e;
            e = this.props.useSlate ? this.props.textValue : (0, C.sk)(this.props.richValue, { mode: 'plain' }), null === (t = (n = this.props).onChange) || void 0 === t || t.call(n, null, e, (0, N.JM)(e));
        } else
    ...
    insertEmoji(e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], {textValue: r} = this.props, i = this.ref.current;
        null != e && null != i && (n && !r.endsWith(' ') && i.insertText(' ', void 0, !1), i.insertEmoji(e, t), t && this.focus());
    }
    insertGIF(e) {
        let {textValue: t} = this.props, n = this.ref.current;
    ...
    constructor(e) {
        ...
        super(e), t = this, b(this, 'ref', i.createRef()), b(this, '_focusBlurQueue', Promise.resolve()), b(this, '_unsubscribe', void 0), b(this, 'handleSelectionChange', () => {
            ...
            let {onFocus: t} = this.props, {focused: n} = this.state;
            null == t || t(e), !n && this.setState({ focused: !0 });
        }), b(this, 'handleBlur', e => {
            let {onBlur: t} = this.props, {focused: n} = this.state;
            ...
            if (null == i || !t.isPrivate() && !n || t.isPrivate() && t.isManaged())
                return !1;
            let {files: s} = function (e, t) {
                let n = [], r = [], i = null, a = null;
            ...
            return M('onPaste', [...e.clipboardData.items].map(e => {
                ...
                let l = null !== (r = o.drafts.commandType) && void 0 !== r ? r : o.drafts.type, u = null, c = m.Z.getActiveOption(t.id);

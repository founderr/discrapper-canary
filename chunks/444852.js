...
var r = n(392711), i = n.n(r), a = n(46973), o = n(570140), s = n(861687), l = n(437263), u = n(924557), c = n(435064), d = n(811660), _ = n(581567), E = n(594190), f = n(695346), h = n(314897), p = n(592125), m = n(131951), I = n(866960), T = n(19780), g = n(936349), S = n(704806), A = n(626135), N = n(756315), v = n(569545), O = n(297733), R = n(981631), C = n(65154);
function y(e, t, n) {
...
class L extends s.Z {
    ...
    getVideoStats() {
        let {ownerId: e} = this._streamContext, t = this._videoQuality;
        if (null != t) {
            var n;
            let {
                duration: r,
            ...
            if (t === this._connection) {
                ...
                if (null != e) {
                    ...
                    if (this._bandwidthSamples.push(e), this._bandwidthSamples.length > 15 && this._bandwidthSamples.shift(), 15 === this._bandwidthSamples.length) {
                        let e = i().mean(this._bandwidthSamples), t = null !== (a = null === (r = this._goLiveQualityManager) || void 0 === r ? void 0 : r.isDowngraded()) && void 0 !== a && a;
                        t && e > 2000000 ? null === (o = this._goLiveQualityManager) || void 0 === o || o.setGoLiveStreamDowngraded(!1) : !t && e < 1000000 && (null === (s = this._goLiveQualityManager) || void 0 === s || s.setGoLiveStreamDowngraded(!0));
                    }
                    break;
                }
            }
    ...
    _initializeEvents() {
        ...
        this.on(l.z.State, (e, t, n) => {
            if (o.Z.wait(() => o.Z.dispatch({
                ...
                var r;
                null === (r = this._connection) || void 0 === r || r.on(a.Sh.ScreenshareFinish, (e, t, n, r, i, a, o, s, l, u, c, d, f, h, p, m) => {
                    let I = this.getMediaSessionId(), T = this.getRTCConnectionId(), g = this.getGoLiveSource();
                    (0, S.q)().then(S => {
                        var N, v, O;
                        let y = null;
                        if (null != S) {
                        ...
                        let D = (null != e ? e : 0) + (null != t ? t : 0) + (null != n ? n : 0) + (null != r ? r : 0) + (null != i ? i : 0) + (null != a ? a : 0) + (null != u ? u : 0) + (null != m ? m : 0) + (null != p ? p : 0), L = (null == g ? void 0 : null === (N = g.desktopSource) || void 0 === N ? void 0 : N.sourcePid) != null ? E.ZP.getGameForPID(g.desktopSource.sourcePid) : null, {
                                gameName: b,
                                gameId: M,
                                exe: P,
                                distributor: U
            ...
            let o = (0, v.my)(this._streamKey);
            if (o.guildId === t && o.channelId === n && o.ownerId === r)
    ...
    _getStreamAnalyticsProperties() {
        let {
                ...
                ownerId: a,
                guildId: o
            } = this._streamContext, s = g.Z.getRegion(T.Z.getHostname()), l = f.xd.getSetting(), {
                gameName: u,
                gameId: c,
                exe: d,
                distributor: E
    ...
    _trackVideoEndStats(e) {
        let t = p.Z.getChannel(this.channelId), n = null != t ? t.type : null, {ownerId: r} = this._streamContext, i = null, a = null, o = this._videoQuality;
        if (null == o)
            return;
        i = o.getNetworkStats(), a = this.isOwner ? o.getCodecUsageStats('streamer', this.userId) : o.getCodecUsageStats('receiver', r);
        let s = (0, u.ln)(), l = c.Z.getSettings(), _ = this.isOwner ? {
                clips_enabled: l.clipsEnabled && s,
        ...
        o.getOutboundStats().forEach(t => {
            ...
            var r;
            let s = o.getInboundStats(t);
            (null !== (r = null == s ? void 0 : s.num_frames) && void 0 !== r ? r : 0) > 0 && A.default.track(R.rMx.VIDEO_STREAM_ENDED, {
                ...s,
                ...a,
                ...i,
                ...this._videoStreamStats.getStats(),
    ...
    _getExtraConnectionOptions() {
        return { streamUserId: (0, v.my)(this._streamKey).ownerId };
    }
    constructor({
        sessionId: e,
        streamKey: t,

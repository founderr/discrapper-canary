...
class M extends a.Z {
  ...
  _getExtraConnectionOptions() {
    return {
      streamUserId: (0, R.my)(this._streamKey).ownerId
    }
  }
  constructor({
    sessionId: e,

...
tagUserId: a,
location: s
  } = e, c = o.default.getId(), _ = l.ZP.getMember(t, o.default.getId()), E = (null == _ ? void 0 : _.joinedAt) != null;
...
function T(e) {
  u.default.track(d.rMx.CLAN_SETTINGS_SAVED, {
guild_id: e
  });
}

function g(e) {
  u.default.track(d.rMx.CLAN_CONVERT_SUCCESS_MODAL_VIEWED, {
guild_id: e
  });
}
...
function D(e) {
  u.default.track(d.rMx.MEMBER_VERIFICATION_APPLICATION_VIEWED, {
guild_id: e
  });
}
...
joinRequestStatus: a,
joinRequestUserId: s
  } = e, c = o.default.getId(), _ = (null === (t = l.ZP.getMember(n, c)) || void 0 === t ? void 0 : t.joinedAt) != null;
...
autoTrackExposure: !1
  }), a = i.Z.getCurrentRecommendationId(), o = r ? _.Br.GLOBAL_DISCOVERY_TOP_PICKS : _.Br.TOP_PICKS;

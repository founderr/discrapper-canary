t(47120);
var i, l, E, a, r = t(392711), o = t.n(r), _ = t(442837), u = t(570140), d = t(317381), s = t(430198), c = t(924301), C = t(601070), S = t(569471), A = t(581883), T = t(314897), I = t(680089), L = t(592125), D = t(58468), N = t(77498), U = t(496675), h = t(306680), P = t(944486), R = t(9156), f = t(823379), g = t(709054), O = t(540126), G = t(526761);
let m = null, H = null, Z = new O.ZP();
function p() {
    let e = P.Z.getChannelId(), n = P.Z.getVoiceChannelId();
...
function y() {
    let e = P.Z.getChannelId(), n = P.Z.getVoiceChannelId(), t = m !== e || H !== n;
    return !!t && (o()([
        m,
        H,
        e,
...
a = 'ChannelListStore', (E = 'displayName') in (l = K) ? Object.defineProperty(l, E, {
    ...
    USER_SETTINGS_PROTO_UPDATE: function (e) {
        ...
        if (t.type !== G.yP.PRELOADED_USER_SETTINGS)
            return !1;
        let i = null === (n = t.proto.guilds) || void 0 === n ? void 0 : n.guilds, l = !1;
    ...
    VOICE_STATE_UPDATES: function (e) {
        let {voiceStates: n} = e, t = y(), i = new Set();
        for (let {
                    channelId: e,
                    oldChannelId: l
                } of n)

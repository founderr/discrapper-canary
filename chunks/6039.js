...
t.default = e => {
  ...
  let {
    guildId: v,
    inviteCode: R
  } = e, [L, O] = s.useState(g.WaveStates.INITIAL), y = (0, l.useStateFromStores)([h.default], () => h.default.get(v)), M = (0, l.useStateFromStores)([C.default], () => C.default.getRequest(v)), P = (0, l.useStateFromStores)([o.default], () => o.default.getGuild(v)), {

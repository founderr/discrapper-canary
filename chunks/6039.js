...
t.Z = (e) => {
    ...
    let U =
            ((n = f.Z.Messages.MEMBER_VERIFICATION_WITHDRAW_APPLICATION_CONFIRMATION.format({ name: null == P ? void 0 : P.toString() })),
            (A = () => {
                R(Math.max(L, C.hO.FILLING)), _.Z.removeGuildJoinRequest(v), (0, o.uL)(S.Z5c.ME);
            }),
            () => {
                (0, r.openModal)((e) =>

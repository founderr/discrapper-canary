...
t.Z = (e) => {
    ...
    let { guildId: v, inviteCode: L } = e,
        [Z, R] = a.useState(S.hO.INITIAL),
        O = (0, s.e7)([E.Z], () => E.Z.get(v)),
    ...
    let D = a.useCallback((e) => {
        ...
        y = async (e) => {
            await h.ZP.submitVerificationForm(v, e);
        },
        j = () => {
    ...
    let U =
            ...
            (A = () => {
                R(Math.max(Z, S.hO.FILLING)), _.Z.removeGuildJoinRequest(v), (0, o.uL)(f.Z5c.ME);
            }),
            () => {
                (0, r.openModal)((e) =>

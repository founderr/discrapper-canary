...
function C(e) {
  let {
    ...
    content: s,
    onChange: n
  } = e, i = (0, I.hasBit)(t, o.DismissibleContent[s]);
...
function h() {
  ...
  let t = (0, f.default)(e => e.recentlyShown),
    ...
    D = h.filter(e => e.toLowerCase().includes(_.toLowerCase())).filter(e => !M.includes(e)),
    x = Object.keys(o.DismissibleContent).filter(e => !M.includes(e)).filter(e => !h.includes(e)).filter(e => e.toLowerCase().includes(_.toLowerCase())).sort((e, t) => e.localeCompare(t));
  return (0, a.jsxs)(a.Fragment, {
    children: [(0, a.jsxs)(u.FormSection, {
      ...
      children: [(0, a.jsx)(T.default, {
      ...
      }) : null, D.length > 0 ? (0, a.jsxs)(a.Fragment, {
        children: [(0, a.jsx)("div", {
          className: A.marginBottom20,
          children: (0, a.jsx)(u.FormTitle, {
        ...
        className: l()(A.marginBottom20, A.marginTop20),
        children: (0, a.jsx)(u.FormTitle, {

...
i.prototype.reset = function () {
    ...
    if (0 === this.size())
        return null;
    var t = this.centroids.lowerBound({ mean: e }), n = null === t.data() ? t.prev() : t.data();
    if (n.mean === e || this.discrete)
        return n;
    var r = t.prev();
    ...
    var n = this.centroids.min(), r = this.centroids.max(), i = this.find_nearest(e);
    if (i && i.mean === e)
        this._addweight(i, e, t);
    else if (i === n)
        this._new_centroid(e, t, 0);
    else if (i === r)
        this._new_centroid(e, t, this.n);
    ...
    var t = this.centroids.upperBound({ mean: e }), n = t.prev(), r = n.mean === e ? n : t.next();
    return [
        n,
        r
    ];
    ...
    if (0 !== this.size()) {
        if (e < this.centroids.min().mean)
            return 0;
        if (e > this.centroids.max().mean)
            return 1;
        this._cumulate(!0);
        var t = this.bound_mean(e), n = t[0], r = t[1];
        if (this.discrete)
            return n.cumn / this.n;
        var i = n.mean_cumn;
    ...
    var n = t.prev(), r = n && n.mean_cumn === e ? n : t.next();
    return [
        n,
        r
    ];
    ...
    if (0 !== this.size()) {
        ...
        var t = this.n * e, n = this.bound_mean_cumn(t), r = n[0], i = n[1];
        if (i === r || null === r || null === i)
            return (r || i).mean;
        if (!this.discrete)
            return r.mean + (t - r.mean_cumn) * (i.mean - r.mean) / (i.mean_cumn - r.mean_cumn);
        if (t <= r.cumn)
            return r.mean;
        else
            return i.mean;
...
i.prototype.compress = function () {
    if (!this.compressing) {
        ...
        for (this.reset(), this.compressing = !0; e.length > 0;)
            this.push_centroid(function (e) {
                var t = Math.floor(Math.random() * e.length);
                return e.splice(t, 1)[0];
            }(e));
        this._cumulate(!0), this.compressing = !1;
    }
}, s.prototype = Object.create(i.prototype), s.prototype.constructor = s, s.prototype.push = function (e) {

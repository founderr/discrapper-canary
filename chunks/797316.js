...
function M(e, t) {
  ...
  D.forEach(r => {
    var s;
    r !== v.Z.getGuildId() && r !== p.Z.getGuildId() && r !== (null === (s = N.Z.getChannel(C.Z.getChannelId())) || void 0 === s ? void 0 : s.getGuildId()) && !(0, T.h)(r).shouldPrioritizeSubscription && (null == i || i.guildId !== r) && (D.clearWithoutFlushing(r, e), t && (n[r] = D.get(r)))
...
class B extends(r = _.ZP.Store) {
  initialize() {
    this.waitFor(N.Z, R.Z, v.Z, C.Z, p.Z, f.default, A.ZP, E.Z, I.Z), this.syncWith([h.Z], w), this.syncWith([A.ZP], G)
  }

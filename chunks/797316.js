...
function M(e) {
    ...
    return !T.Z.isUnavailable(t) && L(t, n);
}
function P() {
    return L(R.Z.getGuildId(), O.Z.getChannelId());
}
function U() {
...
class w extends (i = c.ZP.Store) {
    initialize() {
        this.waitFor(m.Z, S.Z, R.Z, O.Z, A.Z, h.default, I.ZP, E.Z), this.syncWith([f.Z], U), this.syncWith([I.ZP], P);
    }

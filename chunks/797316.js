let r;
n(47120);
var i, a, o, s, l = n(392711), u = n.n(l), c = n(442837), d = n(570140), _ = n(177523), E = n(353926), f = n(768419), h = n(314897), p = n(439170), m = n(433355), I = n(592125), T = n(486472), g = n(271383), S = n(430824), A = n(19780), N = n(699516), v = n(944486), O = n(914010), R = n(981631);
let C = new _.ZP(e => {
    for (let t in e)
        null == S.Z.getGuild(t) && !T.Z.isUnavailable(t) && delete e[t];
    d.Z.dispatch({
...
function U() {
    ...
    if (null == e)
        null != r && (C.unsubscribeUser(r.guildId, r.userId), r = null);
    else {
        let {userId: t} = e;
        if (null != r && r.userId === t || N.Z.isFriend(t))
            return !1;

...
var r = n(648709), i = n(470079), a = n(466324);
let o = 'row-header-column-' + Math.random().toString(36).slice(2), s = 'row-header-column-' + Math.random().toString(36).slice(2);
for (; o === s;)
...
function l(e, t) {
        ...
        for (; t;) {
            ...
            if (r.has(n)) {
                ...
                for (let n = t; n < a.length; n++)
                    e.splice(n, 0, null);
                for (let t = a.length; t < e.length; t++)
                    e[t] && r.has(e[t]) && (r.get(e[t]).index = t);
            } else
                n.colspan = 1, a.push(n), r.set(n, {
                    column: a,
                    index: a.length - 1
                });
            t = n.parentKey;
    ...
    for (let e of n) {
        ...
        for (let n of e) {
            if (n) {
                let e = a[t], r = e.reduce((e, t) => e + t.colspan, 0);
                if (r < o) {
                    let i = {
                        type: 'placeholder',
    ...
    getTextValue(e) {
        ...
        if (n) {
            ...
            for (let r of t.childNodes) {
                ...
                if (n.has(t.key) && r.textValue && e.push(r.textValue), e.length === n.size)
                    break;
            }
            return e.join(' ');
        }

...
(s = l || (l = {})).LOAD = "LOAD", s.PRELOAD = "PRELOAD", s.CLICK = "CLICK", (i = class e extends o.Component {
    ...
    switch ((P || null != T) && (D.onClick = this.onClick), l && (D.original = null != o && "" !== o ? o : D.src), M) {
      ...
      case _.ImageReadyStates.READY:
        if (e.isAnimated(this.props)) {
          ...
          let t = (s || k || L) && (null == p || p) && e.visibilityObserver.isVisible(this);
          t ? (D.src = this.getSrc(b), D.renderAccessory = I) : (D.src = this.getSrc(b, !m || !s), D.renderAccessory = this.renderAccessory), null != f && (D.children = e => {
            let {
              src: n,
              size: i,
              alt: l,
  ...
  constructor(t) {
    ...
    }, (0, m.isImageLoaded)(this.getSrc(this.getRatio(), e.isAnimated(this.props))) && (this.state.readyState = _.ImageReadyStates.READY), this.imageLoadAnalyticsEnabled = A.getCurrentConfig({
      location: "lazy_image"
    }).enabled
  }

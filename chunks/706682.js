...
n(867330);
let s = i.createContext(null), l = null;
function u(e) {
    let {
            children: t,
            contain: n,
            restoreFocus: a,
            autoFocus: o
        } = e, u = (0, i.useRef)(null), c = (0, i.useRef)(null), d = (0, i.useRef)([]), {parentNode: _} = (0, i.useContext)(s) || {}, h = (0, i.useMemo)(() => new R({ scopeRef: d }), [d]);
    (0, r.bt)(() => {
        let e = _ || C.root;
        ...
        (0, r.bt)(() => {
            if (t || n)
                return;
            let i = e.current, a = (0, r.r3)(i ? i[0] : void 0), o = t => {
                    let n = t.target;
                    if (p(n, e.current))
                        l = e;
                    else if (!m(n))
        ...
        (0, r.bt)(() => {
            ...
            let o = (0, r.r3)(i ? i[0] : void 0), s = t => {
                    ...
                    a.current && cancelAnimationFrame(a.current), a.current = requestAnimationFrame(() => {
                        if (o.activeElement && f(e) && !m(o.activeElement, e)) {
                            if (l = e, o.body.contains(t.target)) {
                                var r;
            ...
            return o.addEventListener('keydown', s, !1), o.addEventListener('focusin', u, !1), null == i || i.forEach(e => e.addEventListener('focusin', u, !1)), null == i || i.forEach(e => e.addEventListener('focusout', c, !1)), () => {
                o.removeEventListener('keydown', s, !1), o.removeEventListener('focusin', u, !1), null == i || i.forEach(e => e.removeEventListener('focusin', u, !1)), null == i || i.forEach(e => e.removeEventListener('focusout', c, !1));
            };
        }, [
            e,
            t
        ...
        (0, r.bt)(() => {
            let i = e.current, a = (0, r.r3)(i ? i[0] : void 0);
            if (!t || n)
                return;
            let o = () => {
            ...
            let a = t => {
                ...
                if (!r)
                    return;
                let a = r.nodeToRestore, o = A(i.body, { tabbable: !0 });
                o.currentNode = n;
                let s = t.shiftKey ? o.previousNode() : o.nextNode();
                if ((!a || !i.body.contains(a) || a === i.body) && (a = void 0, r.nodeToRestore = void 0), (!s || !p(s, e.current)) && a) {
                    o.currentNode = a;
                    do
            ...
            if (o)
                return o.nodeToRestore = null !== (n = a.current) && void 0 !== n ? n : void 0, () => {
        ...
        let e = (0, r.r3)(d.current ? d.current[0] : void 0).activeElement, t = null;
        if (p(e, d.current)) {
            ...
            return {
                focusNext(t = {}) {
                    let n = e.current, {
                            ...
                            wrap: o,
                            accept: s
                        } = t, l = i || (0, r.r3)(n[0]).activeElement, u = n[0].previousElementSibling, c = A(E(n), {
                            tabbable: a,
                            accept: s
                        }, n);
                    c.currentNode = p(l, n) ? l : u;
                    let d = c.nextNode();
                    return !d && o && (c.currentNode = u, d = c.nextNode()), d && g(d, !0), d;
                },
                focusPrevious(t = {}) {
                    let n = e.current, {
                            from: i,
                            ...
                            wrap: o,
                            accept: s
                        } = t, l = i || (0, r.r3)(n[0]).activeElement, u = n[n.length - 1].nextElementSibling, c = A(E(n), {
                            tabbable: a,
                            accept: s
                        }, n);
                    c.currentNode = p(l, n) ? l : u;
                    let d = c.previousNode();
                    return !d && o && (c.currentNode = u, d = c.previousNode()), d && g(d, !0), d;
                },
                focusFirst(t = {}) {
                    let n = e.current, {
                            tabbable: r,
    ...
    return i.createElement(s.Provider, { value: N }, i.createElement('span', {
...
function m(e, t = null) {
    if (e instanceof Element && e.closest('[data-react-aria-top-layer]'))
        return !0;
    for (let {scopeRef: n} of C.traverse(C.getTreeNode(t)))
        if (n && p(e, n.current))
            return !0;
    return !1;
}
...
function S(e, t = !0) {
    let n = e[0].previousElementSibling, r = E(e), i = A(r, { tabbable: t }, e);
    i.currentNode = n;
    let a = i.nextNode();
    t && !a && ((i = A(r = E(e), { tabbable: !1 }, e)).currentNode = n, a = i.nextNode()), g(a);
}
function A(e, t, n) {
    let i = (null == t ? void 0 : t.tabbable) ? _ : d, a = (0, r.r3)(e).createTreeWalker(e, NodeFilter.SHOW_ELEMENT, {
            acceptNode(e) {
                var a;
...
function N(e, t = {}) {
    return {
        focusNext(n = {}) {
            ...
            let d = c.nextNode();
            return !d && s && (c.currentNode = i, d = c.nextNode()), d && g(d, !0), d;
        },
        focusPrevious(n = t) {
            let i = e.current;
            if (!i)
...
function y(e = {}) {
    let {
        ...
        }), [s, l] = (0, i.useState)(!1), [u, c] = (0, i.useState)(() => o.current.isFocused && o.current.isFocusVisible), d = (0, i.useCallback)(() => c(o.current.isFocused && o.current.isFocusVisible), []), _ = (0, i.useCallback)(e => {
...
function L(e, t) {
    let {focusProps: n} = (0, a.KK)(e), {keyboardProps: s} = (0, a.v5)(e), l = (0, r.dG)(n, s), u = function (e) {
...
function b(e, t) {
    let n = null == t ? void 0 : t.isDisabled, [a, o] = (0, i.useState)(!1);
    return (0, r.bt)(() => {
        if ((null == e ? void 0 : e.current) && !n) {
            let t = () => {
                e.current && o(!!A(e.current, { tabbable: !0 }).nextNode());
            };
            t();

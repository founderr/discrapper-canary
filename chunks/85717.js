let r, i, a;
n(47120);
var o = n(493683), s = n(45114), l = n(872810), u = n(147913), c = n(594190), d = n(569545), _ = n(695346), E = n(314897), f = n(592125), h = n(77498), p = n(944486), m = n(885110), I = n(67212), T = n(770471), g = n(757454), S = n(158631), A = n(981631);
let N = [];
class v extends u.Z {
    handleRunningGamesChange() {
        ...
        if (null == e)
            return;
        let {canBroadcast: t} = T.Z.getCurrentConfig({ location: 'handle_running_games_change' }, { autoTrackExposure: !1 }), n = m.Z.getBroadcast(), r = (0, I.Ds)(e), i = null != h.Z.getGameByName(r), a = (0, S.dD)();
    ...
    handleStreamStop(e) {
        ...
        if (null == n || null == o || n !== E.default.getId())
            return;
        let s = f.Z.getChannel(o), l = null != s && s.isBroadcastChannel();
    ...
    handleCallCreate(e) {
        ...
        if (null == t || null == r && null == i && null == a)
            return;
        let n = E.default.getId(), o = f.Z.getChannel(t);
    ...
    handleRTCConnectionState(e) {
        ...
        if (n !== A.hes.DISCONNECTED)
            return;
        let r = p.Z.getChannelId(), i = f.Z.getChannel(t);
    ...
    handleChannelDelete(e) {
        let {channel: t} = e, n = m.Z.getBroadcast();

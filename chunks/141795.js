...
var r, i, a = n(392711), o = n.n(a), s = n(261470), l = n(544891), u = n(710845), c = n(432877), d = n(549464), _ = n(740492), E = n(866960), f = n(626135), h = n(510990), p = n(70956), m = n(960048), I = n(861990), T = n(476326), g = n(983544), S = n(981631);
function A(e, t, n) {
...
let N = new u.Z('CloudUpload.tsx'), v = n(224497).Z;
...
class R extends T.ZP {
    ...
    async uploadFileToCloudAsChunks(e) {
        ...
        for (let a = 0; a < i; a++) {
            ...
            let o = a * e, s = Math.min(o + e, n), l = await this.getChunk(o, s, r);
            try {
    ...
    async upload() {
        ...
        let r = await v.getUploadPayload(this), i = (0, g.F)(this.item.target);
    ...
    async reactNativeCompressAndExtractData() {
        ...
        if (null == t || null == t.file)
            return this;
        let n = t.uri, r = t.file.name, i = t.file.type;

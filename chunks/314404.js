...
function V(e) {
    ...
    let e_ = !ep && (el || (!eT && !eN)) && eC && q,
        ...
        eR = 'HR' === eZ && null != eA && eA.currency === G.pK.EUR,
        ew = (0, j.Ap)(eP.paymentSourceId),
        eM = l.useMemo(() => {
            if ((null == eS ? void 0 : eS.interval) === D.rV.DAY) return (null == eS ? void 0 : eS.interval_count) > 7 ? B.intl.string(B.t.Z1V2cn) : B.intl.string(B.t.MI1rHh);
        ...
        eG = eU ? W.bodyColumnLeft : W.bodyColumnMiddle,
        eB = () => {
            if (ep && null != es)
                return eU
                    ? (0, i.jsx)(w.q, {
        ...
        eW = () => eF(eE, eT, eN),
        eV = () => (eR ? (0, i.jsx)(d.Z, { message: B.intl.formatToPlainString(B.t['9hnZoK'], { kunaPriceWithCurrency: (0, y.T4)(7.5345 * eA.amount, G.pK.HRK) }) }) : null);
    return (0, i.jsx)(i.Fragment, {
        children: (0, i.jsxs)('div', {
            className: s()(ep ? W.stepBodyCustomGift : W.stepBody, { [W.paddingForHalloweenBanner]: eh }),
            children: [
                (0, i.jsxs)('div', {
                    className: ep ? eG : void 0,
                    children: [
                        (0, i.jsx)(O.Z, {
                ...
                (0, i.jsxs)('div', {
                    ...
                    children: [
                        ...
                        !eU && eV(),
                        !el && !eL && q && (0, i.jsx)(d.Z, { message: B.intl.format(B.t.Om31w8, { documentationLink: g.Z.getArticleURL(U.BhN.LOCALIZED_PRICING) }) }),

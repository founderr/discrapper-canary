...
function H(e) {
  ...
  } = (0, f.useGiftContext)(), ec = (0, P.getGiftExperience)(el), ed = ea && (0, P.shouldShowCustomGiftExperience)(el), {
    confirmUpsellEnabled: em
  } = (0, d.default)({
    location: "PremiumSwitchPlanSelectBody"
  });
  H = null != H ? H : et, j = null != j ? j : $, l()(void 0 !== j, "should not be undefined");
  let [ef, ep] = (0, r.useStateFromStoresArray)([I.default], () => [null != j ? I.default.get(j.planId) : null, null != W ? I.default.get(W) : null]), e_ = (0, y.usePremiumTrialOffer)(z), eS = null == e_ ? void 0 : e_.subscription_trial, eI = (0, C.usePremiumDiscountOffer)(), eE = (0, C.usePremiumAnnualDiscountOffer)(), eP = null == eI ? void 0 : null === (t = eI.discount) || void 0 === t ? void 0 : t.plan_ids, eT = null != ep ? ep : en, eN = s.useCallback(e => {
    null != Y ? Y(e) : ee(e)
  }, [Y, ee]), ev = null != K ? K : ei;
  l()(null != ev, "Price option has to be set");
  let eh = null != e_ && (0, U.SubscriptionTrials)[e_.trial_id].skus.includes(H),
    ex = null != eI && V.some(e => null == eP ? void 0 : eP.includes(e)) && null != eI.discount,
    eA = null == e_ && (null == eE ? void 0 : eE.discount) != null && (null == es ? void 0 : es.invoiceItems) != null && V.some(e => {
      var t, n;
      return null == eE ? void 0 : null === (n = eE.discount) || void 0 === n ? void 0 : null === (t = n.plan_ids) || void 0 === t ? void 0 : t.includes(e)
    }),
    eC = (0, v.getPrice)(U.SubscriptionPlans.PREMIUM_MONTH_TIER_2, !1, ea, ev),
    ey = (0, v.getPrice)(U.SubscriptionPlans.PREMIUM_YEAR_TIER_2, !1, ea, ev);
  s.useEffect(() => {
  ...
  let eM = !ed && (ea || !eh && !ex && !eA) && eg && X,
    eR = (0, u.useRadioGroup)(),
    eb = (null == eT ? void 0 : eT.id) != null ? (0, v.getPrice)(eT.id, !1, ea, ev) : void 0,
    {
      ipCountryCode: eL
    } = (0, A.default)(),
    ...
    eD = !ea && (ex || eA || null != eS && eh && null != J),
    eU = null == q ? void 0 : null === (_ = q.find(e => e.subscriptionPlanId === U.SubscriptionPlans.PREMIUM_MONTH_TIER_2)) || void 0 === _ ? void 0 : null === (a = _.discounts) || void 0 === a ? void 0 : null === (n = a.find(e => e.type === c.InvoiceDiscountTypes.SUBSCRIPTION_PLAN)) || void 0 === n ? void 0 : n.amount,
    eF = null == es ? void 0 : null === (O = es.invoiceItems) || void 0 === O ? void 0 : null === (N = O.find(e => e.subscriptionPlanId === U.SubscriptionPlans.PREMIUM_YEAR_TIER_2)) || void 0 === N ? void 0 : null === (E = N.discounts) || void 0 === E ? void 0 : null === (S = E.find(e => e.type === c.InvoiceDiscountTypes.SUBSCRIPTION_PLAN)) || void 0 === S ? void 0 : S.amount;
    ...
    children: (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(D.SendGiftToUser, {
          ...
          if (ec === P.GiftExperience.CUSTOM_MESSAGE_EMOJI_SOUNDBOARD && null != eo) return (0, i.jsx)(b.default, {
            sectionTitle: B.default.Messages.GIFT_OPTIONAL_MESSAGE,
            onTextChange: e => eo(e),
            pendingText: eu,
            currentText: eu
          })
        })(), null != ef && !ea && null == eF && (0, i.jsx)("div", {
          ...
          children: V.map(e => (0, i.jsx)(G.default, {
            planId: e,
            premiumSubscription: ea ? null : null != j ? j : null,
            selectPlan: eN,
          ...
          children: eM && null != eT && null != eb ? (0, i.jsxs)("div", {
            children: [(0, i.jsx)("div", {
              ...
              value: (0, i.jsx)(R.default, {
                ...
                intervalType: ea ? null : eT.interval,
...
function Y(e) {
  ...
  var f = l ? B.default.Messages.NEXT : B.default.Messages.SELECT,

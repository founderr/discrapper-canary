...
return;
  ...
  let [r, n, i = '', _ = '', s = '', c = ''] = t.slice(1), I = '', u = c, l = u.split('/');
...
function s(e) {
  ...
  if ([
      ...
      'host',
      'projectId'
    ].find(t => !e[t] && (a.kg.error(`Invalid Sentry Dsn: ${ t } missing`), !0)))
    return !1;
  if (!o.match(/^\d+$/))
    return a.kg.error(`Invalid Sentry Dsn: Invalid projectId ${ o }`), !1;

...
var i, s, a, o = n(735250), r = n(470079), l = n(120356), c = n.n(l), d = n(902704), u = n(434529), h = n(981631), p = n(320188);
function f(e, t, n) {
...
class C extends (s = r.Component) {
    shouldComponentUpdate(e, t) {
        return !(0, d.Z)(t, this.state) || !(0, d.Z)(e, this.props, [
            'anchor',
            'size',
            'minSize',
            'container'
        ]) || !(0, d.Z)(e.anchor, this.props.anchor) || !(0, d.Z)(e.size, this.props.size) || !(0, d.Z)(e.minSize, this.props.minSize) || !(0, d.Z)(e.container, this.props.container);
    }
    ...
    handleDragMove(e, t) {
        ...
        let {
                width: _,
                height: g
            } = I(n, this.size), m = t - p, E = e - h, Z = (0, u.ou)((0, u.PY)({
                top: m,
                left: E,
                bottom: null,
                right: null
            }, s, a, _, g)), C = d ? (0, u.R)(Z) : S('RESIZE_SOUTH_EAST', Z);
    ...
    handleResizeMove(e, t) {
        ...
        if (null != d) {
            ...
            f = Math.max(f + g, i.width), _ = Math.max(_ + m, i.height), this.setDOMSize({
                width: f,
                height: _
            }), !u && (null != l && l(), this.setState({ operationStarted: !0 })), null != c && c(n, d, this.anchor, this.size);
        }
    }
    setDOMPositions(e) {
        let {
    ...
    constructor(e) {
        super(e), f(this, 'anchor', void 0), f(this, 'size', void 0), f(this, 'ref', r.createRef()), f(this, 'dragState', {
            startX: 0,
            startY: 0,
            offsetX: 0,
            offsetY: 0,
            ...
            e.stopPropagation();
            let {dragAnywhere: t} = this.props, {current: n} = this.ref;
            ...
            let {
                    width: r,
                    height: l
                } = I(i, this.size), c = (0, u.PY)(this.anchor, a, o, r, l);
            if ('MOVE' === e) {
                let {
                    x: e,
                    y: i
            ...
            let {
                    operation: e,
                    operationStarted: t
                } = this.state, {onDragEnd: n} = this.props;
            ...
            if (t) {
                let {
                        ...
                        width: i,
                        height: s
                    } = I(this.ref.current, this.size), a = (0, u.PY)(this.anchor, e, t, i, s), o = (0, u.R)(a);
        ...
        }), this.anchor = E(e.anchor), this.size = m(e.size, e.minSize.width, e.minSize.height);
    }
}

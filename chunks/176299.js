...
function ew(e) {
    ...
    let p = (0, u.e7)([C.Z], () => C.Z.isFullscreenInContext()),
    ...
    let f = a.useRef(null),
        S = a.useCallback((e, t) => {
            ...
            let a = t - e;
            null === (n = f.current) || void 0 === n || n.style.setProperty('--custom-overdrag', ''.concat(1 + Math.min(Math.abs(a / 76), 0.25))), i && eG(76);
        }, []),
        N = a.useCallback(() => {
        ...
        A = a.useCallback((e) => {
            var t;
            document.body.classList.remove(eh.dragging), document.body.classList.remove(eh.collapsing), null === (t = f.current) || void 0 === t || t.style.setProperty('--custom-overdrag', '0px'), _.K.set(em, e);
        }, []),
        v = (0, I.Z)({
            minDimension: 240,
            maxDimension: 416,

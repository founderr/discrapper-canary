...
let eh = 'resizable-sidebar-width',
    ...
    ej = (e) => {
        ...
        switch (t.params.feature) {
            case 'addFriends':
                return (0, i.jsx)(V.Z, { initialSection: ed.pJs.ADD_FRIEND });
            case 'pendingFriends':
                return (0, i.jsx)(V.Z, { initialSection: ed.pJs.PENDING });
...
function eG(e) {
    ...
    let S = a.useRef(null),
        C = a.useCallback((e, t) => {
            ...
            let a = t - e;
            null === (n = S.current) || void 0 === n || n.style.setProperty('--custom-overdrag', ''.concat(1 + Math.min(Math.abs(a / 76), 0.25))), i && eU(76);
        }, []),
        N = a.useCallback(() => {

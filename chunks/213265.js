var e, i, u = r(926515), o = r(581031), a = r(714050), c = r(572609), s = r(489412), f = r(972277), l = r(803938), h = r(644659).get, v = r(973326), p = r(440196), d = f('native-string-replace', String.prototype.replace), x = RegExp.prototype.exec, g = x, I = o(''.charAt), y = o(''.indexOf), E = o(''.replace), b = o(''.slice);
var R = (i = /b*/g, u(x, e = /a/, 'a'), u(x, i, 'a'), 0 !== e.lastIndex || 0 !== i.lastIndex), $ = s.BROKEN_CARET, A = void 0 !== /()??/.exec('')[1];
(R || A || $ || v || p) && (g = function (n) {
    var t, r, e, i, o, s, f, v = h(this), p = a(n), k = v.raw;
    if (k)
        return k.lastIndex = this.lastIndex, t = u(g, k, p), this.lastIndex = k.lastIndex, t;
    var m = v.groups, C = $ && this.sticky, S = u(c, this), w = this.source, T = 0, O = p;

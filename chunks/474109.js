...
let g = 'app-download-item', m = 'add-server-item';
function C() {
    return !1;
}
function I(e) {
    ...
    return e === _.x8Z.SERVER_DISCOVERY_BADGE && !u.Z.hasViewed(_.x8Z.SERVER_DISCOVERY_BADGE) || e !== g && e !== m && (null === (t = n[null != e ? e : 'null']) || void 0 === t ? void 0 : t.mentionCount) > 0;
}
let E = (0, p.oH)((e, t, n) => [
    'null',
    ...t,

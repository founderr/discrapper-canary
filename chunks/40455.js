n(47120);
var r = n(592125), i = n(650774), a = n(944486), o = n(412788), s = n(368321), l = n(553245), u = n(143806), c = n(814074), d = n(582142), _ = n(989263), E = n(872261);
function f(e, t, n) {
...
let h = null, p = new l.b(750, 500), m = new u.S(15), I = !1;
class T extends o.Z {
    initialize() {
    ...
    static mergeSnapshot(e) {
        let t = p, n = m;
        for (let n of (p = new l.b(p.primaryCapacity, p.extendedCapacity), m = new u.S(m.capacity), h = null != h ? h : e.lastChannel, [
                e.channels,
                t.values()
            ]))
            for (let e of n)
                !e.fallback && p.put(e.channelId, e);
        for (let t of [
                e.penalized,
                n.keys()
            ])
    ...
    static deleteGuild(e) {
        for (let t of p.allValues())
            t.guildId === e && p.delete(t.channelId);
    }
    ...
    static deleteUnreadableGuildChannels(e) {
        for (let t of p.values())
            e === t.guildId && !(0, _.$)(t.channelId) && T.deleteChannel(t.channelId);
    }
    static replaceLru(e) {
        p = e;
    }
...
function A(e) {
    let t = e.id, n = (0, _.v)(e), r = a.Z.getChannelId();

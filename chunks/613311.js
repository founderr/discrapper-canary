...
class e_ extends r.PureComponent {
  ...
  renderDescription(e, t, s) {
    ...
    return (0, a.jsxs)(r.Fragment, {
      ...
      }), (0, a.jsx)(R.default, {}), (0, a.jsx)(J.default, {
        applicationId: e.id,
        blurb: t.summary,
        description: i,
  ...
  constructor(...e) {
    super(...e), ec(this, "showCopyLinkTextTimeout", new o.Timeout), ec(this, "_trackedViewed", !1), ec(this, "_analyticsSource", null), ec(this, "_extraAnalyticsProperties", null), ec(this, "state", {
      ...
      null != e && null != t && (0, d.openModalLazy)(async () => {
        let {
          default: r
        } = await Promise.all([s.e("49237"), s.e("99387"), s.e("7654"), s.e("43643"), s.e("92893")]).then(s.bind(s, "560114"));
        return s => (0, a.jsx)(r, {
          ...s,
          guild: t,
          channel: e,
...
t.default = (0, f.default)((0, S.default)(l.default.connectStores([x.default, O.default, P.default, j.default, D.default, v.default, U.default, m.default, A.default, L.default, M.default, b.default], e => {
  let t, s, a, {
    inputSkuId: r,
    applicationId: i,
    storeListingId: n,
  ...
  if (null == i) {
    ...
    t = r, null != (i = null != (s = v.default.get(r)) ? s.applicationId : null) && (a = A.default.getApplication(i))
  } else if (null == r) {
    if (null == i) throw Error("Needs applicationId or skuId");
    null != (a = A.default.getApplication(i)) && (t = a.destinationSkuId), s = null != t ? v.default.get(t) : null

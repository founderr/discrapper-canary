...
t.prototype.clear = function () {
    ...
    for (var a = n._ancestors.length - 1; a >= 0; --a)
        if (0 > r(e, (t = n._ancestors[a]).data))
            return n._cursor = t, n._ancestors.length = a, n;
    return n._ancestors.length = 0, n;
}, t.prototype.upperBound = function (e) {
    for (var t = this.lowerBound(e), n = this._comparator; null !== t.data() && 0 === n(t.data(), e);)
        t.next();
    return t;
    ...
    for (var t, n = this.iterator(); null !== (t = n.next());)
        e(t);
}, t.prototype.reach = function (e) {
    for (var t, n = this.iterator(); null !== (t = n.prev());)
        e(t);
    ...
    for (; null !== e.left;)
        this._ancestors.push(e), e = e.left;
    this._cursor = e;
}, n.prototype._maxNode = function (e) {
    for (; null !== e.right;)
        this._ancestors.push(e), e = e.right;
    this._cursor = e;
}, e.exports = t;

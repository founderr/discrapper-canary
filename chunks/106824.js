...
var r = n(836560), i = n(555573), a = n(376918), o = n(695346), s = n(590921), l = n(152089);
function u(e, t, n) {
...
class d extends r.EventEmitter {
    ...
    updateResults() {
        var e, t;
        let n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
        if (null == this.props.editorRef.current)
            return;
        let i = (0, l.FW)(this.props), u = (0, l.fZ)({
        ...
        let T = !0 === p.isLoading, g = this.shouldShow(I, T, _), S = this.state.selectedIndex;

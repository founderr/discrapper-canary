...
var i = t(735250), r = t(470079), o = t(658722), l = t.n(o), u = t(392711), s = t.n(u), a = t(149765), c = t(442837), d = t(481060), _ = t(271383), f = t(430824), E = t(594174), I = t(700785), g = t(709054), p = t(962086), S = t(160404), C = t(225675), m = t(981631), T = t(689938), h = t(821492);
function A(e) {
    var n;
    return (0, i.jsx)('span', {
...
function N(e) {
    ...
    let Z = null != o && null != t && null != L ? s()(u).filter(e => -1 !== L.roles.indexOf(e.id)).sortBy(e => -e.position).first() : void 0, D = r.useMemo(() => null != o && null != t ? Object.values(u).filter(e => e.id !== o.id).filter(e => {
            var n;
        ...
        children: (0, i.jsx)(d.Combobox, {
            ...
            children: e => {
                let n = D.reduce((n, t) => (l()(e.toLowerCase(), t.name.toLowerCase()) && n.push((0, i.jsxs)(d.ComboboxItem, {
                        value: t.id,
                        children: [
                            (0, i.jsx)(d.ComboboxItem.Label, { children: A(t) }),
                ...
                return null != t && n.push((0, i.jsxs)(d.ComboboxItem, {
                    ...
                    children: [
                        (0, i.jsx)(d.ComboboxItem.Label, { children: A(t) }),
                        (0, i.jsx)(d.ComboboxItem.Checkbox, { checked: !0 })
                    ]
                }, t.id)), n;
            }
        })

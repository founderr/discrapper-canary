...
var a, r, s, i, o, l, u, c, d, E, S, m, p = n(735250),
  D = n(470079),
  I = n(120356),
  _ = n.n(I),
  h = n(338545),
...
return (0, p.jsxs)('div', {
  ...
  constructor(...e) {
super(...e), O(this, 'backgroundAnimation', new N.Z.ValueXY({
  x: 0,
  y: 0
})), O(this, 'foregroundAnimation', new N.Z.ValueXY({
  x: 0,
  y: 0
})), O(this, 'didUnmount', !1), O(this, 'animateIdleLoopBackground', () => {
  if (!this.didUnmount)
    this.backgroundAnimation.x.setValue(0), N.Z.timing(this.backgroundAnimation.x, {
  ...
  if (!this.didUnmount)
    this.foregroundAnimation.x.setValue(0), N.Z.timing(this.foregroundAnimation.x, {
      toValue: B.IDLE_LOOP.toValue,

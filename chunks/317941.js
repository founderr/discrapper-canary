s(47120), s(411104);
var n = s(735250), a = s(470079), i = s(913527), r = s.n(i), o = s(442837), l = s(846519), c = s(481060), d = s(533307), _ = s(812206), E = s(981632), u = s(314897), T = s(82142), I = s(246946), S = s(509545), N = s(55563), C = s(15887), m = s(285952), A = s(366695), h = s(259580), g = s(572004), O = s(669079), p = s(296848), R = s(474936), x = s(689938), M = s(756369);
function D(e, t, s) {
...
class f extends a.PureComponent {
    ...
    render() {
        let {
                hideCode: e,
                giftCode: t
            } = this.props, {copyMode: s} = this.state;
        return (0, n.jsxs)(m.Z, {
                ...
                (0, n.jsxs)('div', {
                    ...
                    children: [
                        null != t.expiresAt ? (0, n.jsxs)(a.Fragment, {
                            children: [
                                x.Z.Messages.GIFT_INVENTORY_EXPIRES_IN.format({ hours: t.expiresAt.diff(r()(), 'h') }),
                                ' ',
                                '\u2014\xA0'
                            ]
                        }) : null,
...
class P extends a.PureComponent {
    ...
    constructor(...e) {
        super(...e), D(this, '_loadedAt', null), D(this, 'state', {
            ...
            this.setState({ isCreating: !0 }), await d.Z.createGiftCode(t, s, n), this.setState({
                isCreating: !1,
                isOpen: !0
            });
            ...
            (null == s || null == this._loadedAt || s < this._loadedAt) && n && d.Z.fetchUserGiftCodesForSKU(e, t), this.setState({ isOpen: !this.state.isOpen });
        });
    }
}

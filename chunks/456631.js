...
var i, a, o, s, l = n(392711), u = n(442837), c = n(780384), d = n(570140), _ = n(70956), E = n(963838), f = n(354459);
let h = [], p = {}, m = [], I = e => {
        null != e && d.Z.dispatch({
            type: 'VOICE_CHANNEL_EFFECT_CLEAR',
            userId: e
        });
    }, T = [], g = 10 * _.Z.Millis.SECOND, S = (0, l.debounce)(() => {
        let e = (0, E.cX)(m);
...
s = 'VoiceChannelEffectsStore', (o = 'displayName') in (a = A) ? Object.defineProperty(a, o, {
    ...
    VOICE_CHANNEL_EFFECT_RECENT_EMOJI: e => {
        let {emoji: t} = e;
        if (null != t)
            h.unshift(t), (h = (0, l.uniqBy)(h, 'name')).length > f.e5 + 1 && h.pop();
    },
    ...
    VOICE_CHANNEL_EFFECT_SENT_LOCAL: () => {
        ...
        if ((T = [
            ...
            let t = T[T.length - 1], n = e.getTime() - t.getTime();

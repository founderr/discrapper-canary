  ...
  let _ = s.map(n => {
      let s = n.options.map(n => {
        ...
        let s = null == n.roleIds ? n.roleIds : n.roleIds.filter(n => null != d.Z.getRole(e.id, n)),
          ...
          a = (null == n ? void 0 : null === (t = n.emoji) || void 0 === t ? void 0 : t.id) == null || null == r.Z.getCustomEmojiById(n.emoji.id) ? void 0 : n.emoji.id;
        return {
          ...n,
          roleIds: s,
          channelIds: l,
    ...
    for (let s of n)
      if (s.id !== t.id) {
        for (let n of s.options)
          if (null != n.roleIds && n.roleIds.some(n => e.has(n))) return E.Z.Messages.ONBOARDING_PROMPT_SINGLE_SELECT_UNIQUE_ROLES
      }
  }

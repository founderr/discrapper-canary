...
var s = t(544891), l = t(570140), a = t(668781), i = t(881052), r = t(339085), o = t(107862), c = t(592125), d = t(430824), I = t(823379), N = t(208665), _ = t(981631), u = t(290511), E = t(689938);
function T() {
...
async function D(e, n) {
    ...
    let _ = s.map(n => {
            let s = n.options.map(n => {
                var t;
                let s = null == n.roleIds ? n.roleIds : n.roleIds.filter(n => null != d.Z.getRole(e.id, n)), l = null == n.channelIds ? n.channelIds : n.channelIds.filter(e => null != c.Z.getChannel(e)), a = (null == n ? void 0 : null === (t = n.emoji) || void 0 === t ? void 0 : t.id) == null || null == r.Z.getCustomEmojiById(n.emoji.id) ? void 0 : n.emoji.id;
                return {
                    ...n,
                    roleIds: s,
                    channelIds: l,
        ...
        }), T = _.filter(e => e.inOnboarding), m = _.filter(e => !0 !== e.inOnboarding), O = _.map(n => h(e, _, n));
    ...
    if (T.length > u.b3)
        throw a.Z.show({
            ...
            body: E.Z.Messages.ONBOARDING_PROMPT_SAVE_TOO_MANY_PROMPTS_IN_ONBOARDING.format({ numQuestions: u.b3 })
        }), l.Z.dispatch({
            type: 'GUILD_SETTINGS_ONBOARDING_PROMPTS_SAVE_FAILED',
            errors: O
    ...
    try {
        await A(e.id, { prompts: S.map(u.dr) }), l.Z.dispatch({
        ...
        }), l.Z.dispatch({ type: 'GUILD_SETTINGS_ONBOARDING_PROMPTS_SAVE_FAILED' }), Error('failed to save prompts');
    }
}
...
function L(e, n, t, s) {
    ...
    let r = (null !== (a = s.roleIds) && void 0 !== a ? a : []).filter(n => null != d.Z.getRole(e.id, n)), o = (null !== (i = s.channelIds) && void 0 !== i ? i : []).filter(e => null != c.Z.getChannel(e));

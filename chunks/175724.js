...
var i = t(374470), l = t(475179), o = t(904245), E = t(45114), r = t(40851), u = t(358221), a = t(623292), s = t(807092), d = t(6025), _ = t(897473), c = t(913663), C = t(268350), I = t(433355), A = t(592125), S = t(703558), T = t(323873), L = t(375954), N = t(306680), O = t(944486), D = t(914010), g = t(574254), h = t(451478), R = t(585483), f = t(981631);
let p = {
    binds: [
        'esc',
        'shift+pagedown'
    ...
    action(e) {
        ...
        let n = D.Z.getGuildId(), t = O.Z.getChannelId(n), o = A.Z.getChannel(t), E = I.ZP.getSection(t, null == o ? void 0 : o.isDM()) === f.ULH.SIDEBAR_CHAT ? I.ZP.getSidebarState(t) : null, a = (null == E ? void 0 : E.type) === _.tI.VIEW_THREAD || (null == E ? void 0 : E.type) === _.tI.VIEW_CHANNEL ? E.channelId : null;
        if (!1 === P(t) || !1 === P(a))
            return !1;

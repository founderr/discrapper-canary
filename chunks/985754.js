...
let o = (0, r.q9)(e);
if (n === i.pK.EUR)
  return a ? _.Z.Messages.LOCALIZED_PRICING_NOTICE_GENERALIZED_PAYMENT_METHODS_PROMO.format({
    country: o
  }) : _.Z.Messages.LOCALIZED_PRICING_NOTICE_NO_LOWERED_PRICE.format({
    currencyISOCode: n.toUpperCase()
  });
return t ? _.Z.Messages.NOTICE_NITRO_PRICE_CHANGED.format({
  countryName: o
}) : _.Z.Messages.LOCALIZED_PRICING_NOTICE.format({
  country: o
});
  },
  c = e => {
...
} = n, R = 0 !== y.length, O = P(c), f = (0, s.T4)(N, p, {
  style: 'currency',
  currency: p,
...
if (A.has(p) && (g = _.Z.Messages.LOCALIZED_PRICING_BANNER_BODY_EXISTING_CURRENCY.format({
    helpCenterLink: o.Z.getArticleURL(l.BhN.LOCALIZED_PRICING),
    localizedPriceWithCurrencySymbol: f
  })), C.has(p) && (g = _.Z.Messages.LOCALIZED_PRICING_BANNER_BODY_NEW_CURRENCY_WITH_AMBIGUOUS_SYMBOL.format({
    helpCenterLink: o.Z.getArticleURL(l.BhN.LOCALIZED_PRICING),
    currencyISOCode: p.toUpperCase(),
    localizedPriceWithCurrencySymbol: f
  })), null != a && !a.hasPremiumNitroMonthly && (g = _.Z.Messages.LOCALIZED_PRICING_BANNER_BODY_WITHOUT_PRICE.format({
    helpCenterLink: o.Z.getArticleURL(l.BhN.LOCALIZED_PRICING),
    currencyISOCode: p.toUpperCase()
  })), p === i.pK.EUR && (g = t ? _.Z.Messages.LOCALIZED_PRICING_BANNER_NO_LOWERED_PRICE_SINGLE_STRING.format({
    country: (0, r.q9)(c),
    currencyISOCode: p.toUpperCase(),
    helpCenterLink: o.Z.getArticleURL(l.BhN.LOCALIZED_PRICING)
...
return {
  localizedPricingBannerHeader: _.Z.Messages.LOCALIZED_PRICING_BANNER_HEADER.format({
    country: (0, r.q9)(c)
  }),
  localizedPricingBannerBody: g,
  localizedPricingBannerLinkOnly: _.Z.Messages.LOCALIZED_PRICING_BANNER_LINK_ONLY.format({
    helpCenterLink: o.Z.getArticleURL(l.BhN.LOCALIZED_PRICING)
  }),

...
onSelect: r,
position: d
  } = e, c = (0, o.e7)([Z.Z], () => Z.Z.getRoles(t.id)), u = (0, o.Wu)([R.ZP], () => R.ZP.getMemberIds(t.id));
  return (0, n.jsx)(S.Z, {
...
onFilterResults: (e, t) => 0 === t ? i()(c).filter(t => null == l[t.id] && e(t.name)).sortBy(e => -e.position).value() : i()(u).map(O.default.getUser).filter(A.lm).filter(e => !e.isClyde()).filter(t => null == l[t.id] && e(t.username.toLowerCase())).sortBy(e => e.username.toLowerCase()).value(),
onQueryChange: e => {
  L.Z.requestMembers(t.id, e, 20);
},
onSelect: e => {
  if (null != e)
    W(e) ? r(e.id, p.BN.ROLE) : e instanceof C.Z && r(e.id, p.BN.MEMBER);
},
onClose: a,
position: d
  });
...
return {
  ...
  }, [r]), T = (0, F.Z)(r, t), S = (0, N.ZP)(), f = (0, o.e7)([_.Z], () => _.Z.roleStyle);
...
v = i()(T).sortBy(e => e.username.toLowerCase()).map(e => {

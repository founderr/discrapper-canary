...
var n = s(735250), l = s(470079), a = s(392711), i = s.n(a), r = s(149765), o = s(442837), d = s(780384), c = s(481060), u = s(668781), h = s(493683), m = s(741361), g = s(668390), E = s(144991), T = s(852860), p = s(911969), N = s(410030), _ = s(607070), S = s(146085), x = s(598077), f = s(277053), C = s(388610), I = s(271383), M = s(430824), R = s(496675), Z = s(594174), v = s(568987), O = s(442313), A = s(823379), L = s(892880), b = s(63063), j = s(5192), D = s(233608), y = s(700785), w = s(51144), P = s(257017), F = s(188857), B = s(981631), U = s(689938), H = s(438254);
...
function k(e) {
    let {overwrite: t} = e, s = (0, o.e7)([f.Z], () => f.Z.channel), l = (0, o.e7)([M.Z], () => null != s ? M.Z.getGuild(s.getGuildId()) : null), a = (0, o.e7)([M.Z], () => null != l ? M.Z.getRoles(l.id) : void 0);
    ...
    let {
            ...
            if (null == M.Z.getGuild(i) || null == a)
                return '';
            let t = a[g], s = Z.default.getUser(g), n = null !== (e = null == s ? void 0 : s.username) && void 0 !== e ? e : '';
...
function z(e) {
    ...
    return (0, n.jsx)(v.Z, {
        ...
        onRenderResult: e => {
            if (W(e)) {
                let t;
                return null != e.colorString && (t = { color: e.colorString }), (0, n.jsx)('span', {
                    style: t,
                    children: e.name
                });
            }
...
function Y() {
    let {
            ...
            let e = null != r ? M.Z.getGuild(r) : void 0, t = null != e ? M.Z.getRoles(e.id) : void 0;
            return {
                guild: e,
                guildRoles: t
            };
    ...
    let R = i()(t).filter(e => e.type === p.BN.ROLE).map(e => E[e.id]).filter(A.lm).sortBy(e => -e.position).map(e => (0, n.jsx)(g.Z, {
            ...
            'aria-label': e.name,
            children: e.name
        }, ''.concat(a, '-').concat(e.id))).value(), Z = i()(T).sortBy(e => e.username.toLowerCase()).map(e => {

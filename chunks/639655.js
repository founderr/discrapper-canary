...
var r = n(710845), i = n(374023), a = n(420491), o = n(988348);
function s(e, t, n) {
...
u.push(class extends c {
    ...
    feed(e) {
        ...
        if (!(e instanceof ArrayBuffer))
            throw Error('Expected array buffer, but got ' + typeof e);
        let t = new DataView(e), n = t.byteLength >= 4 && 65535 === t.getUint32(t.byteLength - 4, !1);
    ...
    handleFlushEnd(e) {
        let t;
        let n = this._pako, i = this._inflate;
        if (null == i) {
    ...
    feed(e) {
        let t = this._pako;
        if (e instanceof ArrayBuffer && this._gatewayEncoding.wantsString() && (e = t.inflate(e, { to: 'string' })), null == this._onDataReady)
            throw Error('Cannot feed unless a data ready callback is registered.');
        this._onDataReady(e);
    }
    close() {

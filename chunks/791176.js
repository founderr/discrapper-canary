...
t.default = l.memo(function(e) {
  let {
    member: t,
    onNavigate: n
  } = e, s = (0, r.useStateFromStores)([h.default], () => h.default.getGuild(t.guildId), [t.guildId]), u = (0, E.useUserPermissionsAndRoles)(t.userId, t.guildId, E.MOD_PERMISSIONS), c = (0, E.useUserPermissionsAndRoles)(t.userId, t.guildId, E.ALL_PERMISSIONS), f = Object.keys(u).length, I = Object.keys(c).length, A = l.useMemo(() => null != s ? m.default.getGuildPermissionSpecMap(s) : null, [s]), x = l.useMemo(() => null != s ? m.default.generateGuildPermissionSpec(s) : null, [s]), v = l.useMemo(() => {

...
var n = t(735250), r = t(470079), s = t(772848), l = t(544891), o = t(481060), i = t(355467), c = t(311821), u = t(285952), d = t(591759), E = t(987209), _ = t(598), p = t(737143), m = t(362755), A = t(981631), N = t(474936), h = t(689938), T = t(168269);
let I = e => {
        let {
                ...
                contextMetadata: S
            } = (0, _.usePaymentContext)(), {isGift: C} = (0, E.wD)(), [b, P] = r.useState(!1);
        return r.useEffect(() => {
            let e = setTimeout(() => {
                var e;
                if (!b)
                    P(!0), (0, i.r5)(S.loadId), !function (e, a, t, n) {
                        let r = A.ANM.BILLING_STANDALONE_CHECKOUT_PAGE(e, a, t), o = new URL(d.Z.makeUrl(A.Z5c.BILLING_LOGIN_HANDOFF)), i = (0, s.Z)();

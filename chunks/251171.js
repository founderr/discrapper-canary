...
!function (e) {
    ...
    function i(e) {
        for (var t = 0, n = Math.min(65536, e.length + 1), r = new Uint16Array(n), i = [], a = 0;;) {
            var o = t < e.length;
            if (!o || a >= n - 1) {
                if (i.push(String.fromCharCode.apply(null, r.subarray(0, a))), !o)
                    return i.join('');
            ...
            if (0 == (128 & (o = e[t++])))
                ...
                240 == (248 & o) && (s = 63 & e[t++], l = 63 & e[t++], 65535 < (o = (7 & o) << 18 | s << 12 | l << 6 | 63 & e[t++]) && (o -= 65536, r[a++] = o >>> 10 & 1023 | 55296, o = 56320 | 1023 & o), r[a++] = o);
        }
    }
    if (!e.TextEncoder || !e.TextDecoder) {
        ...
        Object.defineProperty(t.prototype, 'encoding', { value: 'utf-8' }), t.prototype.encode = function (e, t) {
            ...
            for (var n = e.length, r = 0, i = Math.max(32, n + (n >>> 1) + 7), a = new Uint8Array(i >>> 3 << 3); t < n;) {
                ...
                if (r + 4 > a.length && (i += 8, i *= 1 + t / e.length * 2, (s = new Uint8Array(i = i >>> 3 << 3)).set(a), a = s), 0 == (4294967168 & o))
                    a[r++] = o;
                else {
                    if (0 == (4294965248 & o))
                        a[r++] = o >>> 6 & 31 | 192;
        ...
        }, Object.defineProperty(n.prototype, 'encoding', { value: 'utf-8' }), Object.defineProperty(n.prototype, 'fatal', { value: !1 }), Object.defineProperty(n.prototype, 'ignoreBOM', { value: !1 });
        var o = i;

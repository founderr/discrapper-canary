...
if (t = void 0 === t ? {
    fatal: !1
  } : t, -1 === a.indexOf((e = void 0 === e ? 'utf-8' : e).toLowerCase()))
...
for (var t = 0, n = Math.min(65536, e.length + 1), r = new Uint16Array(n), i = [], a = 0;;) {
  var s = t < e.length;
  if (!s || a >= n - 1) {
    if (i.push(String.fromCharCode.apply(null, r.subarray(0, a))), !s)
      return i.join('');
  ...
  if (0 == (128 & (s = e[t++])))
    ...
    240 == (248 & s) && (o = 63 & e[t++], l = 63 & e[t++], 65535 < (s = (7 & s) << 18 | o << 12 | l << 6 | 63 & e[t++]) && (s -= 65536, r[a++] = s >>> 10 & 1023 | 55296, s = 56320 | 1023 & s), r[a++] = s);
}
  }
...
Object.defineProperty(t.prototype, 'encoding', {
  ...
  for (var n = e.length, r = 0, i = Math.max(32, n + (n >>> 1) + 7), a = new Uint8Array(i >>> 3 << 3); t < n;) {
    ...
    if (r + 4 > a.length && (i += 8, i *= 1 + t / e.length * 2, (o = new Uint8Array(i = i >>> 3 << 3)).set(a), a = o), 0 == (4294967168 & s))
      a[r++] = s;
    else {
      if (0 == (4294965248 & s))
        a[r++] = s >>> 6 & 31 | 192;
...
var s = i;
'function' == typeof r && r.from ? s = function(e) {

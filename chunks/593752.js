...
class C {
  ...
  updateUserId(e) {
    ...
    let [t, n, a] = this.findOldState(e), [l, s, i] = this.calculateNewState(e, r.default.getChannel(this.parentId));
    return (t !== l || n !== s || a !== i) && (this.removeUserId(e, t), this.addUser(e, l, s, i), !0)
  }
  addUserId(e) {
    let [t, n, a] = this.calculateNewState(e, r.default.getChannel(this.parentId));
...
var x = new v(i.default, {
  ...
  THREAD_MEMBER_LIST_UPDATE: function(e) {
    let {
      ...
      guildId: n,
      members: a
    } = e, l = r.default.getChannel(t), s = null == l ? void 0 : l.parent_id;
  ...
  PRESENCES_REPLACE: function(e) {
    ...
    }).filter(h.isNotNullish).uniq().value(), a = !1;

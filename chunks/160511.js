...
onClose: f,
isSlideReady: m
  } = e, [S, _] = l.useState(!1), [g, x] = l.useState(null), [E, C] = l.useState(!1), [p, v] = l.useState(null), [j, Z] = l.useState(''), M = l.useRef(null);
  l.useEffect(() => {
_(!0), r.tn.post({
...
if (m) {
  ...
  let A = null == g ? u.Z.Messages.TWO_FA_ENTER_SMS_TOKEN_SENDING : u.Z.Messages.TWO_FA_ENTER_SMS_TOKEN_SENT.format({
phoneNumber: g
  });

n(47120);
var r = n(846519), i = n(147913), a = n(77498), o = n(19780), s = n(626135), l = n(70956), u = n(581567), c = n(594190), d = n(981631);
function _(e, t, n) {
...
class f extends i.Z {
    ...
    constructor(...e) {
        super(...e), _(this, 'heartbeatInterval', new r.Xp()), _(this, 'runningGameKeys', new Set()), _(this, 'actions', {
            ...
            let e = c.ZP.getRunningGames(), t = {
                    rtc_connection_id: o.Z.getRTCConnectionId(),
                    media_session_id: o.Z.getMediaSessionId()
                }, n = new Set();
            e.forEach(e => {
                var r, i;
                let o = (0, c.rH)(e), l = !this.runningGameKeys.has(o), _ = null !== (i = e.id) && void 0 !== i ? i : null === (r = a.Z.getGameByName(e.name)) || void 0 === r ? void 0 : r.id;

...
function R(e) {
    ...
    if ((0, d.e7)([S.Z, v.Z], () => n || v.Z.getGuildId() === T.I_8 || (!S.Z.can(T.Plq.MANAGE_CHANNELS, t) && !S.Z.can(T.Plq.MANAGE_ROLES, t) && !S.Z.can(T.Plq.MANAGE_WEBHOOKS, t)) || ((0, I.r8)(t.type) && !S.Z.can(T.Plq.VIEW_CHANNEL, t)) || (t.isGuildVocal() && !S.Z.can(T.Plq.CONNECT, t)) || !I.dF.has(t.type))) return null;
    function a() {
        p.ZP.open(t.id);
    }
...
function L(e) {
    let { channel: t, isDefaultChannel: i = !1, locked: l, tabIndex: r, forceShowButtons: a, hasChannelInfo: o = !1 } = e,
        ...
        v = (0, d.e7)([S.Z], () => (S.Z.can(T.Plq.CREATE_INSTANT_INVITE, t) ? Z.Z.Messages.CREATE_INSTANT_INVITE : Z.Z.Messages.INVITE_TO_SERVER));
    if (l || !I) return null;
    function x() {
        if (null != c) {

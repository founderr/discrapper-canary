...
var i, l, r, a, s = n(735250), o = n(470079), c = n(120356), u = n.n(c), d = n(442837), h = n(481060), p = n(787014), _ = n(924301), f = n(159300), m = n(152376), g = n(427679), C = n(155409), I = n(131704), E = n(199902), N = n(430824), x = n(496675), S = n(914010), Z = n(281029), v = n(981631), T = n(689938), L = n(47705);
function A(e, t, n) {
...
function R(e) {
    let {
            ...
            forceShowButtons: a,
            hasChannelInfo: o = !1
        } = e, c = (0, d.e7)([N.Z], () => N.Z.getGuild(t.getGuildId())), p = (0, d.e7)([g.Z], () => g.Z.getStageInstanceByChannel(t.id), [t.id]), m = (0, d.e7)([_.ZP], () => _.ZP.getActiveEventByChannel(t.id), [t.id]), I = (0, d.e7)([x.Z], () => (0, f.b)(x.Z, c, t, p)), S = (0, d.e7)([x.Z], () => x.Z.can(v.Plq.CREATE_INSTANT_INVITE, t) ? T.Z.Messages.CREATE_INSTANT_INVITE : T.Z.Messages.INVITE_TO_SERVER);
    if (l || !I)
        return null;
    function Z() {
        if (null != c) {
...
function O(e) {
    let {channel: t} = e, n = () => {
            (0, m.dM)(t.guild_id, t.id, !0, { section: v.jXE.CHANNEL_LIST });
        };
    return (0, s.jsx)(h.Tooltip, {
...
r = { isDefaultChannel: !1 }, (l = 'defaultProps') in (i = P) ? Object.defineProperty(i, l, {
    value: r,
    enumerable: !0,
    configurable: !0,
    writable: !0

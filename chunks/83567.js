    ...
    handler: e => {
      ...
      return new Promise(async (e, t) => {
        ...
        if (null == i) {
          ...
          a.default.subscribe("USER_CONNECTIONS_UPDATE", d), o.ComponentDispatch.subscribe(E.ComponentActions.CONNECTIONS_CALLBACK_ERROR, c), (0, l.default)({
            platformType: f.type,
            location: E.AnalyticsLocations.ACTIVITY_RPC
          })
        } else try {
          let t = await s.default.refreshAccessToken(f.type, i.id);

...
var r, i, a = n(498607), o = n.n(a), s = n(759174), l = n(493892), u = n(594174), c = n(815790), d = n(588215), _ = n(44715), E = n(331551);
function f(e, t, n) {
...
class T {
    ...
    enhanceNewMember(e, t) {
        var n;
        let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = (0, c.Dw)(e.joinedAt), {
                ...
                inviterId: _,
                integrationType: f
            } = this._computeMemberSupplementals(e.userId, e.unusualDMActivityUntil), h = u.default.getUser(e.userId);
        return {
            hasUnusualDmActivity: a,
            hasUnusualAccountActivity: o,
            sourceInviteCode: s,

...
function d(B) {
  ...
  let f, N, _ = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
    ...
    h = (0, n.default)("user_channel_emoji_overrides"),
    {
      emoji: m,
      color: v
    } = function(B) {
      ...
      let a = (0, E.useStateFromStores)([F.default], () => {
          ...
          return null != B ? null == l ? void 0 : null === (E = l[B.guild_id]) || void 0 === E ? void 0 : null === (t = E.channels) || void 0 === t ? void 0 : t[B.id] : null
        }),
    ...
    }(B),
    {
      ...
      return {
        emoji: null != l ? {
          id: null !== (t = l.id) && void 0 !== t ? t : null,
          name: null !== (E = l.name) && void 0 !== E ? E : null
        } : null,

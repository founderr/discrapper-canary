...
d = "DispatchManagerStore", (u = "displayName") in(l = K) ? Object.defineProperty(l, u, {
  ...
  DISPATCH_APPLICATION_STATE_UPDATE: function(e) {
    ...
    v = v.filter(e => {
      ...
      if (null != s && s.type === C.LocalDispatchApplicationStates.UP_TO_DATE && s.buildId === s.targetBuildId && s.buildId === a && c().isEqual(s.manifestIds, s.targetManifestIds) && c().isEqual(s.manifestIds, o)) {
        if (D.push(t), b.has(t)) {
          switch (b.get(t)) {
            case "Install":

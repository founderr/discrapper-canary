...
function M(e) {
    let { user: t, currentUser: n, displayProfile: M, channel: b, isHovering: R, onOpenProfile: L } = e,
        { newActivityCardsEnabled: j } = (0, u.z)({ location: 'UserProfilePanelBody' }),
        { activeInviteToCallCtaEnabled: O } = (0, c.l)({ location: 'UserProfilePanelBody' }),

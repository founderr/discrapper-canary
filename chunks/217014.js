...
var a = t("37983"),
  ...
  _ = e => {
    ...
    return r(!m, "FamilyCenterDeclineLinkModal should only be rendered for teens."), (0, a.jsx)(o.ModalRoot, {
      transitionState: n,
      children: (0, a.jsxs)("form", {
        onSubmit: e => {
          e.preventDefault(), f(t)
        },
        children: [h ? (0, a.jsx)(o.FormErrorBlock, {
          className: N.error,
          onDismiss: x,
          children: L.default.Messages.FAMILY_CENTER_DECLINE_LINK_MODAL_ERROR
        }) : null, (0, a.jsx)(o.ModalContent, {

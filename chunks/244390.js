...
function d(e) {
  return (0, l.useStateFromStoresObject)([s.default, o.default, i.default, r.default, a.default], () => (function(e) {
    ...
    } = e, m = null != n ? d.getVoiceState(n.getGuildId(), l.getId()) : null, p = c.isSelfMute() || c.isSelfMutedTemporarily(), E = null == n ? void 0 : n.getGuildId(), g = h.isViewingRoles(E) && !f.can(u.Permissions.SPEAK, n);
    return {
      selfMute: p,

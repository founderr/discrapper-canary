...
var l = s(512722), t = s.n(l), i = s(792986), r = s(639119), a = s(3409), c = s(626135), o = s(987209), u = s(598), d = s(409813), _ = s(45572), m = s(189877), E = s(981631), I = s(474936);
function p(e) {
    let {
            analyticsData: n,
            initialPlanId: s,
            ...
            previousStepRef: j,
            setPurchaseState: L
        } = (0, u.usePaymentContext)(), {isGift: y} = (0, o.wD)(), Z = {
            ...(0, a.fL)(),
            paymentSources: P,
            paymentSourceId: f,
            setPaymentSourceId: A,
    ...
    return (0, a.vP)({
        ...
        onReturn: G,
        onComplete: e => {
            e === d.h8.AWAITING_BROWSER_CHECKOUT ? (L(_.A.COMPLETED), p(d.h8.CONFIRM, { trackedFromStep: e })) : p(d.h8.REVIEW, { trackedFromStep: e });
        },
        onStepChange: e => {
            let {
                    currentStep: s,

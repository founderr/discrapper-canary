...
function L(e) {
  ...
  }), d = h.ZP.getName(l, null == a ? void 0 : a.id, null == c ? void 0 : c[0]);
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(o.Text, {
      ...
      variant: "text-xs/normal",
      children: c.length > 1 ? b.Z.Messages.EMBEDDED_ACTIVITIES_USERNAME_AND_OTHERS.format({
        username: d,
        count: c.length - 1
...
function O(e) {
  ...
  }), F = (0, r.e7)([T.Z, v.Z], () => T.Z.inDevModeForApplication(n.application.id) || v.Z.inTestModeForApplication(n.application.id), [n.application.id]), {
    application: U
  } = n, Y = a.useCallback(e => e && (null == f ? void 0 : f({
    applicationId: n.application.id
  })), [n.application.id, f]), w = (0, d.O)(Y, .8, !0), [G, W] = a.useState(!1), [z, q] = a.useState(G);
  a.useEffect(() => {
    G && q(!0)
  }, [G]);
  let J = () => W(!0),

...
function b(e) {
    ...
    let b = l.default.getCurrentUser();
    if (!f.ZP.canUseEmojisEverywhere(b) && !m) {
    ...
    return !t.animated || f.ZP.canUseAnimatedEmojis(b) || (0, a.yH)(t) ? null : p.Z5.PREMIUM_LOCKED;
}
function I(e, t) {
    let n = 0,
        r = 0,

...
width: a,
ref: C
  } = (0, E.Z)(), t = (0, V.e7)([p.Z], () => p.Z.useReducedMotion), i = (0, V.e7)([W.Z], () => W.Z.isAcknowledged(en.ES.FREE)), [r, l] = n.useState(!1), [d, M] = n.useState(!1), [I, h] = n.useState(!1), T = (0, c.k6)(), m = (0, c.TH)(), g = (0, V.e7)([D.Z], () => D.Z.getState().theme), [N] = n.useState((0, Q.c)(W.Z) > 0), {
...
revealDate: d,
enabled: M
  } = e, _ = (0, V.e7)([p.Z], () => p.Z.useReducedMotion), E = (0, V.e7)([N.default], () => N.default.locale), {
analyticsLocations: h
  } = (0, f.ZP)(u.Z.ACTIVITIES_PAGE_WHATS_NEW_TILE), [T, m] = n.useState(!1), g = (0, I.Z)(T), x = (0, V.e7)([W.Z], () => {
if (!M)
  return 0;
...
children: (0, s.jsxs)('div', {
  ...
  children: [
    ...
    (0, s.jsx)(eG, {
      ...
      isAppLink: r,
      onOpen: () => {
        m(!0), F.E(l), B.default.track(el.rMx.ACTIVITIES_WHATS_NEW_OPENED, {
          section_id: l
        }), setTimeout(() => {
          m(!1);
        }, 500);
...
if (e[a].activityItem.application.id !== L[a].activityItem.application.id || e[a].channel.id !== L[a].channel.id || e[a].users.length !== L[a].users.length)
  return !1;
  return !0;
}
...
analyticsLocations: e
  } = (0, f.ZP)(u.Z.ACTIVITIES_HAPPENING_NOW), L = (0, V.e7)([
U.ZP,
g.Z,
v.Z,
b.default,
  ...
  (0, s.jsxs)('div', {
    ...
    children: [
      (0, s.jsxs)(Z.Clickable, {
        ...
        onClick: () => B.default.track(el.rMx.ACTIVITIES_PAGE_CELEBRATE_TILE_CLICKED, {
          section: 'share_nitro'
        }),
        children: [
          (0, s.jsx)('img', {
      ...
      (0, s.jsxs)(Z.Clickable, {
        ...
        className: eH.celebrateCardContainer,
        onClick: () => {
          B.default.track(el.rMx.ACTIVITIES_PAGE_CELEBRATE_TILE_CLICKED, {

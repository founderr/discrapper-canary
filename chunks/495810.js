...
function ej() {
    ...
    let { width: a, ref: C } = (0, E.Z)(),
        ...
        { analyticsLocations: v } = (0, f.ZP)([...(null !== (L = null == m ? void 0 : null === (e = m.state) || void 0 === e ? void 0 : e.analyticsLocations) && void 0 !== L ? L : []), p.Z.ACTIVITIES_PAGE]),
        S = n.useRef(new Date());
    return (
        n.useEffect(() => {
            setTimeout(() => {
            ...
            () => (
                ...
                x &&
                    ...
                    T.replace(el.Z5c.ACTIVITIES, {
                        analyticsLocations: [...v, p.Z.ACTIVITIES_PAGE_NOTIFICATION_DOT]
                    }),
                () => {
                    let e = S.current,
        ...
        (0, r.jsx)(f.Gt, {
            ...
            children: (0, r.jsxs)('div', {
                ...
                children: [
                    (0, r.jsxs)(D.ZP, {
                        children: [
                            (0, r.jsx)(R.Z, { className: o()(eH.activitiesBirthdayIcon, { [eH.activitiesBirthdayIconLight]: 'light' === g }) }),
                            (0, r.jsx)(Z.Heading, {
            ...
            children: [
                ...
                (0, r.jsx)(eG, {
                    ...
                    onOpen: () => {
                        m(!0),
                            F.E(l),
                            O.default.track(el.rMx.ACTIVITIES_WHATS_NEW_OPENED, { section_id: l }),
                            setTimeout(() => {
                                m(!1);
                            }, 500);
                    },
    ...
    return (0, r.jsx)(Z.ThemeProvider, {
        ...
        children: (e) =>
            (0, r.jsxs)(Z.Clickable, {
                onClick: s,
                className: o()(e, eH.happeningNowCard, { [eH.happeningNowCardReducedMotion]: t }),
                children: [
                    (0, r.jsx)('img', {
                        src: i.url,

...
function ej() {
  ...
  let {
    width: a,
    ref: C
  } = (0, E.Z)(), t = (0, V.e7)([p.Z], () => p.Z.useReducedMotion), i = (0, V.e7)([G.Z], () => G.Z.isAcknowledged(en.ES.FREE)), [r, l] = n.useState(!1), [d, M] = n.useState(!1), [I, h] = n.useState(!1), T = (0, c.k6)(), m = (0, c.TH)(), g = (0, V.e7)([N.Z], () => N.Z.getState().theme), [x] = n.useState((0, q.c)(G.Z) > 0), {
    analyticsLocations: D
  } = (0, f.ZP)([...null !== (L = null == m ? void 0 : null === (e = m.state) || void 0 === e ? void 0 : e.analyticsLocations) && void 0 !== L ? L : [], u.Z.ACTIVITIES_PAGE]), v = n.useRef(new Date);
  return n.useEffect(() => {
    setTimeout(() => {
      !i && W.Z(en.ES.FREE)
    }, 500)
    ...
    analyticsLocations: [...D, u.Z.ACTIVITIES_PAGE_NOTIFICATION_DOT]
  }), () => {
    let e = v.current,
      ...
      children: [(0, s.jsxs)(j.ZP, {
        ...
        children: (0, s.jsxs)("div", {
          ...
          children: [(0, s.jsxs)("div", {
            ...
            }) : null, !t && d ? (0, s.jsx)("div", {
              className: eH.heroConfetti02Wrapper,
              children: (0, s.jsx)(H.Z, {
                colors: ey
              })
            }) : null, !t && I ? (0, s.jsx)("div", {
            ...
            controls: t
          }) : null, (0, s.jsx)(eB, {}), (0, s.jsx)(eF, {}), (0, s.jsx)(eJ, {}), (0, s.jsx)(eQ, {}), (0, s.jsx)(e$, {}), (0, s.jsx)(e6, {})]
        })
      })]
    })
  })
...
function eR(e) {
  let {
    width: L,
    containerRef: a
  } = e, C = (0, V.e7)([p.Z], () => p.Z.useReducedMotion);
  return (0, s.jsxs)("div", {
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsx)("div", {
      ...
      children: eo.Z.Messages.EMBEDDED_ACTIVITIES_BIRTHDAY_HERO_TEXT_WITH_2_LINKS.format({
        ...
        linkToSurprises: e => (0, s.jsxs)(Z.Anchor, {
          href: eA,
...
function eF() {
  ...
  return t.length <= 0 ? null : (0, s.jsx)("div", {
...
function eW(e) {
  let {
    ...
    revealDate: d,
    enabled: M
  } = e, _ = (0, V.e7)([p.Z], () => p.Z.useReducedMotion), E = (0, V.e7)([x.default], () => x.default.locale), {
    analyticsLocations: h
  } = (0, f.ZP)(u.Z.ACTIVITIES_PAGE_WHATS_NEW_TILE), [T, m] = n.useState(!1), g = (0, I.Z)(T), N = (0, V.e7)([G.Z], () => {
    if (!M) return 0;
  ...
  return (0, s.jsx)(f.Gt, {
    ...
    children: (0, s.jsxs)("div", {
      ...
      children: [_ || 2 !== N || T || !g ? null : (0, s.jsx)("div", {
        ...
        isAppLink: r,
        onOpen: () => {
          m(!0), W.E(l), O.default.track(el.rMx.ACTIVITIES_WHATS_NEW_OPENED, {
            section_id: l
          }), setTimeout(() => {
            m(!1)
          }, 500)
...
function eG(e) {
  ...
  } = (0, f.ZP)(), n = (0, V.e7)([p.Z], () => p.Z.useReducedMotion);
  switch (L) {
    case 0:
      return (0, s.jsx)("div", {
...
function eX(e, L) {
  ...
  for (let a = 0; a < e.length; a++)
    if (e[a].activityItem.application.id !== L[a].activityItem.application.id || e[a].channel.id !== L[a].channel.id || e[a].users.length !== L[a].users.length) return !1;
  return !0
}
...
function eJ() {
  ...
  } = (0, f.ZP)(u.Z.ACTIVITIES_HAPPENING_NOW), L = (0, V.e7)([Y.ZP, g.Z, D.Z, S.default, A.ZP], () => {
    let e = [],
      L = S.default.getCurrentUser();
    if (null == L) return e;
    let a = Y.ZP.getShelfActivities(null),
      C = a.map(e => g.Z.getApplication(e.application_id)).filter(k.lm);
...
function ez(e) {
  ...
  return (0, s.jsxs)(Z.Clickable, {
    onClick: r,
    className: o()((0, F.Q)(el.BRd.DARK), eH.happeningNowCard, {
    ...
    children: [(0, s.jsx)("img", {
      ...
      children: [(0, s.jsx)(Z.Heading, {
        ...
        children: C.length > 1 ? eo.Z.Messages.EMBEDDED_ACTIVITIES_USERNAME_AND_OTHERS.format({
          username: n,
          count: C.length - 1
...
function eq(e) {
  ...
  let M = () => H(!0),
    _ = () => H(!1),
    E = null == a.application.maxParticipants || -1 === a.application.maxParticipants ? eo.Z.Messages.EMBEDDED_ACTIVITIES_UNLIMITED_PARTICIPANTS : eo.Z.Messages.EMBEDDED_ACTIVITIES_ONE_TO_N_PARTICIPANTS.format({
  ...
  return (0, s.jsxs)(er.o, {
    ...
    children: [(0, s.jsxs)("div", {
      ...
      children: [(0, s.jsxs)("div", {
      ...
      }), a.application.tags.length > 0 ? (0, s.jsx)("div", {
        className: eH.activityCardTagContainer,
        children: a.application.tags.slice(0, 3).map(e => (0, s.jsx)("div", {
        ...
        }), (0, s.jsx)(Z.ChevronSmallRightIcon, {
          size: "xs",
          color: "currentColor"
        })]
      })]
...
function e$() {
  return (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsx)(Z.Heading, {
      ...
      children: [(0, s.jsxs)(Z.Clickable, {
        tag: "a",
        href: eS,
        target: "_blank",
        className: eH.celebrateCardContainer,
        onClick: () => O.default.track(el.rMx.ACTIVITIES_PAGE_CELEBRATE_TILE_CLICKED, {
          section: "share_nitro"
        }),
        children: [(0, s.jsx)("img", {
          src: eu,
          ...
          children: eo.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_THREE_TRIALS.format({
            nitroLink: eS
          })
        }), (0, s.jsx)("div", {
          className: eH.celebrateCardFiller
        }), (0, s.jsx)("img", {
          className: eH.celebrateCardImage,
          src: ef,
          alt: eo.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_NITRO_TRIAL_ALT
        })]
      }), (0, s.jsxs)(Z.Clickable, {
        tag: "a",
        href: ew,
        target: "_blank",
        className: eH.celebrateCardContainer,
        onClick: () => {
          O.default.track(el.rMx.ACTIVITIES_PAGE_CELEBRATE_TILE_CLICKED, {
        ...
        children: [(0, s.jsx)(Z.Heading, {
          ...
          variant: "heading-sm/normal",
          className: eH.celebrateCardSubheader,
          children: eo.Z.Messages.EMBEDDED_ACTIVITIES_VISIT_OUR_MERCH_STORE.format({
            merchStoreLink: ew
          })
        }), (0, s.jsx)("div", {
          className: eH.celebrateCardFiller

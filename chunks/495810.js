    ...
    return t.length <= 0 ? null : (0, s.jsx)('div', {
        ...
        children: (0, s.jsx)(m.Z, {
            ...
            children: (0, s.jsx)('ul', {
                ...
                children: t.map(e => (0, s.jsx)(eW, { ...e }, e.id))
            })
        })
    });
}
...
function eG(e) {
    let {
        ...
        } = e, {analyticsLocations: r} = (0, f.ZP)(), n = (0, V.e7)([p.Z], () => p.Z.useReducedMotion);
    switch (L) {
    case 0:
...
function eJ() {
    ...
    }, { trackOnInitialLoad: !0 }), L.length <= 0) ? null : (0, s.jsx)(f.Gt, {
        value: e,
    ...
    return n.useEffect(() => {
        ...
        children: [
            ...
            (0, s.jsx)('div', {
                ...
                children: e.map(e => (0, s.jsx)(eq, { activityItem: e }, e.application.id))
            })
        ]
    });
}
                ...
                children: [
                    (0, s.jsxs)(Z.Clickable, {
                        ...
                        children: [
                            ...
                            (0, s.jsx)('div', { className: eH.celebrateCardFiller }),
                            (0, s.jsx)('img', {

n(47120), n(724458);
var r, i, a, o, s = n(442837), l = n(570140), u = n(271383), c = n(430824), d = n(594174), _ = n(981631);
let E = [], f = {}, h = null, p = null;
function m(e) {
    let t = E.indexOf(e);
    if (t > -1) {
        let n = [...E];
...
class T extends (r = s.ZP.Store) {
    ...
    isLurking(e) {
        var t;
        let n = u.ZP.isCurrentUserGuest(e), r = null === (t = c.Z.getGuild(e)) || void 0 === t ? void 0 : t.isLurker();
        return !!(!n && r);
    }
    getLurkingSource() {
        return p;
...
o = 'LurkingStore', (a = 'displayName') in (i = T) ? Object.defineProperty(i, a, {
    ...
    GUILD_STOP_LURKING: function (e) {
        let {ignoredGuildIds: t} = e, n = function (e) {

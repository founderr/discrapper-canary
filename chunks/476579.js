...
if (u) {
    ...
    if (
        ...
        for (var tr, tn = w(B), te = 0; tn.length > te; ) !((tr = tn[te++]) in C) && a(C, tr, B[tr]);
        S.constructor = C;
    ...
    (S = (C = function (t) {
        ...
        (V = (P = function (t, r, n) {
            ...
            if (((n = void 0 === n ? o - u : v(n)), u + n > o)) throw j('Wrong length');
            L(this, {
                type: O,
                buffer: t,
                byteLength: n,
        ...
        i && (X(C, 'byteLength', U), X(P, 'buffer', _), X(P, 'byteLength', _), X(P, 'byteOffset', _)),
        s(V, {
            getInt8: function (t) {

...
class U extends (i = l.PureComponent) {
    ...
    constructor(...e) {
        super(...e),
            ...
            B(this, 'renderEmbed', () => {
                let e;
                let { activity: t, partyId: n, myPartyId: i, application: l, partyMembers: a, isPreview: o, isLaunching: s, isSender: c, activityActionType: u, className: d, channelId: m, message: h, hideParty: f, isSyncable: g, isLaunchable: _, guildId: C } = this.props;
                if (null != l) e = l.name;
                else if (null != n) {
                    let [t] = n.split(':');
                    e = w[t];

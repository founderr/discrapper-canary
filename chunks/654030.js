...
B(F, "defaultProps", {
  isPreview: !1
}), t.default = i.default.connectStores([N.default, g.default, R.default, O.default, I.default, P.default, h.default, v.default, L.default, M.default], e => {
  let {
    activity: t,

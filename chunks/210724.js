...
function R(e) {
  ...
  let {
    ...
    location: S.QuestsExperimentLocations.QUESTS_BAR
  }), M = (0, o.useStateFromStores)([d.default], () => d.default.useReducedMotion), O = (0, o.useStateFromStores)([c.default], () => c.default.hasLayers()), L = (null === (t = _.userStatus) || void 0 === t ? void 0 : t.enrolledAt) != null, y = (0, u.default)(L), b = (null === (s = _.userStatus) || void 0 === s ? void 0 : s.completedAt) != null, D = (0, u.default)(b), j = (null === (l = _.userStatus) || void 0 === l ? void 0 : l.claimedAt) != null, U = null != _.userStatus && (0, C.isDismissed)(_.userStatus, h.QuestContent.QUEST_BAR), P = (0, f.useIsQuestExpired)(_), {
    hasError: B,
    isLoading: V
...
t.default = function(e) {
  let {
    ...
    var e;
    return null !== (e = null != t ? t : _.default.questDeliveryOverride) && void 0 !== e ? e : (0, C.getQuestForTargetedContent)(_.default.quests, h.QuestContent.QUEST_BAR)
  });

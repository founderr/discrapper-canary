...
var s = n(735250), a = n(470079), r = n(469035), i = n(120356), l = n.n(i), o = n(338545), c = n(442837), d = n(110924), _ = n(607070), u = n(819640), E = n(617136), T = n(113434), I = n(569984), R = n(497505), C = n(918701), p = n(977156), g = n(5881), A = n(602667), m = n(78826), N = n(693900), f = n(617889), S = n(46140), h = n(981631), M = n(487383);
function x(e) {
    var t, n, i;
    let {quest: I} = e, x = (0, g.T)({
            quest: I,
            location: S.dr.QUESTS_BAR
        }), b = (0, p.Zy)({ location: S.dr.QUESTS_BAR }), O = (0, c.e7)([_.Z], () => _.Z.useReducedMotion), L = (0, c.e7)([u.Z], () => u.Z.hasLayers()), P = (null === (t = I.userStatus) || void 0 === t ? void 0 : t.enrolledAt) != null, v = (0, d.Z)(P), Z = (null === (n = I.userStatus) || void 0 === n ? void 0 : n.completedAt) != null, D = (0, d.Z)(Z), B = (null === (i = I.userStatus) || void 0 === i ? void 0 : i.claimedAt) != null, j = null != I.userStatus && (0, C.zE)(I.userStatus, R.jn.QUEST_BAR), U = (0, T.tP)(I), {
            hasError: G,
            isLoading: y
    ...
    let eT = P ? S.XZ : S.R4, [{expansionSpring: eI}, eR] = (0, o.useSpring)(() => ({
        ...
        })), [{height: eC}, ep] = (0, o.useSpring)(() => ({
            from: { height: w.collapsedHeight },
            config: eT,
            immediate: O
        }));
    a.useLayoutEffect(() => {
        eR({ expansionSpring: Y ? 1 : 0 }), ep({ height: Y ? $ : w.collapsedHeight });
    }, [
        Y,
        $,
        eR,
    ...
    let {visibilitySpring: eg} = (0, o.useSpring)({
...
t.Z = 12633 == n.j ? function (e) {
    let {overrideQuest: t} = e, n = (0, c.e7)([I.Z], () => {
            var e;

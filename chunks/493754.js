...
function E(e) {
    var t, a;
    let { stream: l, applicationId: E, channel: g, exitFullScreen: C, appContext: I, analyticsLocation: x, className: T, ...N } = e,
    ...
    if (((t = Z), (a = g), !(null != t && null != a && m.Z.can(p.Plq.CREATE_INSTANT_INVITE, a)))) return null;

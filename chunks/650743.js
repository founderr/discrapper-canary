...
soundboardSound: t,
closePicker: A
  } = e, N = (0, d.Iu)(e => e.searchQuery), v = (0, i.e7)([m.Z], () => null != t && m.Z.isFavoriteSound(t.soundId)), O = (0, i.e7)([E.Z], () => E.Z.getGuild(null == t ? void 0 : t.guildId)), R = (0, i.e7)([l.Z], () => l.Z.useReducedMotion, []), C = (0, i.e7)([h.Z], () => h.Z.isFocused()), y = (0, i.e7)([f.Z], () => f.Z.getKeybindForAction(T.kg4.SOUNDBOARD_HOLD));
  if (null != t && N.length > 0)
return (0, r.jsx)(_.Z, {
  graphicPrimary: null != t.emojiId || null != t.emojiName ? (0, r.jsx)(o.Z, {
    emojiId: t.emojiId,
...
b = null != y && (0, p.isWindows)() && !L ? g.Z.Messages.SOUNDBOARD_KEYBIND_HINT_NO_POPOUT_WHEEL_SUPPORT.format({
  ...
  openSettingsHook: (e, t) => (0, r.jsx)(s.Anchor, {
    onClick: D,
    children: e
  }, t)
}) : null;

...
function y(e) {
  let {
resource: n
  } = e, l = (0, s.e7)([Z.Z], () => Z.Z.getChannel(n.channelId)), i = (0, s.e7)([v.Z], () => v.Z.getMessages(n.channelId)), u = (0, s.e7)([p.Z], () => p.Z.can(A.Plq.VIEW_CHANNEL, l)), m = i.first(), g = (0, E.Z)(m), C = (0, c.zy)(m, !1), x = (null == C ? void 0 : C.length) > 0 ? C[0] : null, I = null != l && null == i.first() && !i.loadingMore && !i.ready && !i.hasFetched && u;
  r.useEffect(() => {
I && o.Z.fetchMessages({

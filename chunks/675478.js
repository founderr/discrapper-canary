...
var r = n(512722), i = n.n(r), a = n(259443), o = n(544891), s = n(704215), l = n(377108), u = n(524437), c = n(433517), d = n(570140), _ = n(70956), E = n(915486), f = n(262847), h = n(581883), p = n(48481), m = n(526761), I = n(981631);
function T(e, t, n) {
...
let g = 'UserSettingsProtoLastWriteTimes', S = Date.now();
...
class A {
    ...
    async updateAsync(e, t, n) {
        ...
        let i = r.T(), a = this.getCurrentValue()[e], o = null != a ? i.fromBinary(i.toBinary(a), p.Uc) : i.create();
        if (!1 === t(o))
            return;
    ...
    markDirty(e, t) {
        ...
        let {editInfo: r} = this.getEditInfo(), a = { timeout: r.timeout };
        if (!r.loaded)
        ...
        null != t.cleanup && (a.cleanupFuncs = [
            ...r.cleanupFuncs,
            ...t.cleanup
        ]), null == r.protoToSave ? a.protoToSave = e : a.protoToSave = (0, p.re)(this.ProtoClass, r.protoToSave, e), this.dispatchChanges(a);
    }
    dispatchChanges(e) {
        d.Z.dispatch({
    ...
    async loadIfNecessary(e) {
        ...
        if (e || !t.loaded && !t.loading) {
            ...
            try {
                let {
                        body: {settings: t}
                    } = await o.tn.get({ url: I.ANM.USER_SETTINGS_PROTO(this.type) }), n = (0, p.d5)(this.ProtoClass, t);
                if (null == n) {
    ...
    scheduleSaveFromOfflineEdit() {
        ...
        let t = 5000 + Math.floor(5000 * Math.random()), n = setTimeout(this.persistChanges, t);
        this.dispatchChanges({
            timeout: n,
            timeoutDelay: t
        });
    ...
    constructor(e, t) {
        T(this, 'ProtoClass', void 0), T(this, 'type', void 0), T(this, 'logger', void 0), T(this, 'beforeSendCallbacks', void 0), T(this, 'lastSendTime', void 0), T(this, 'persistChanges', void 0), this.ProtoClass = e, this.type = t, this.beforeSendCallbacks = [], this.lastSendTime = 0, this.persistChanges = async () => {
            ...
            try {
                ...
                } else if (400 === e.status && (null === (n = e.body) || void 0 === n ? void 0 : n.code) === I.evJ.INVALID_USER_SETTINGS_DATA)
                    throw this.logger.log('Reloading do to invalid data'), this.loadIfNecessary(!0), e;
                else
                    throw this.logger.log('Unknown user settings error'), e;
            }
        }, this.logger = new a.Y(this.ProtoClass.typeName);
    }
}
let N = new A(u.o8, m.yP.PRELOADED_USER_SETTINGS), v = new A(l.ji, m.yP.FRECENCY_AND_FAVORITES_SETTINGS), O = {

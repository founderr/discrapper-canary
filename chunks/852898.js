...
function I(e) {
    ...
    return a.useMemo(() => function (e, t) {
        ...
        if (!e.managed)
            return null;
        let E = null === (n = e.tags) || void 0 === n ? void 0 : n.bot_id, T = null === (a = e.tags) || void 0 === a ? void 0 : a.integration_id, m = (null === (i = e.tags) || void 0 === i ? void 0 : i.premium_subscriber) !== void 0, N = (null === (d = e.tags) || void 0 === d ? void 0 : d.guild_connections) !== void 0;
        if (null != E ? I = null == t ? void 0 : t.find(e => {
                var t;
                let {application: n} = e;
                return (null == n ? void 0 : null === (t = n.bot) || void 0 === t ? void 0 : t.id) === E;
            }) : null != T && (I = null == t ? void 0 : t.find(e => {
                let {id: t} = e;
                return t === T;
            })), null != I && null != I.application && null != I.name) {
            let e = I.application.id, t = I.name;
            [
                u.ABu.TWITCH,
                u.ABu.YOUTUBE
            ].includes(I.type) && (t = ''.concat(l.Z.get(I.type).name, ' - ').concat(t));
            let n = () => {

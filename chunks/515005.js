...
let A = (0, l.Mg)(S.__invalid_stickerPickerPreviewDimensions), N = (0, l.Mg)(S.__invalid_stickerPickerPreviewPadding), v = i.memo(function (e) {
        let {
            ...
            } = e, {location: V} = (0, d.O)(), H = w + 2 * U, Z = i.useMemo(() => ({
                gridColumnGap: O,
        ...
        return (0, r.jsx)('div', {
            ...
            children: P.map(e => {
                var d;
                let A = e.visibleRowIndex === (null == R ? void 0 : R.rowIndex) && e.columnIndex === (null == R ? void 0 : R.columnIndex), N = e.type === h.al.STICKER && G && A, v = (0, s.throttle)(() => {
                ...
                case h.al.CREATE_STICKER:
                    return (0, r.jsx)('div', {
                        ...
                        children: (0, r.jsxs)(u.Clickable, {
                            'aria-label': e.name,
                            className: o()(S.createSticker, M, { [S.createInspected]: A }),
                            innerRef: O,
                            tabIndex: P,
                            onFocus: null != U ? U : v,
                            onMouseMove: v,
                ...
                case h.al.STICKER: {
                        ...
                        return (0, i.createElement)('div', {
                            ...
                            className: o()(S.sticker, M, { [S.stickerInspected]: A }),
                            innerRef: O,
                            tabIndex: P,
                            onFocus: null != U ? U : v,
                            onMouseMove: v,

...
var a = t(735250), r = t(470079), i = t(692547), s = t(481060), o = t(496675), l = t(484455), c = t(981631), d = t(689938), u = t(237261);
function m(e) {
    switch (e) {
    case c.sFg.LOW:
...
n.ZP = function (e) {
    let {guild: n} = e, i = o.Z.can(c.Plq.MANAGE_GUILD, n), C = n.verificationLevel, _ = C === c.sFg.VERY_HIGH ? s.MobilePhoneIcon : s.EnvelopeIcon, h = r.useMemo(() => m(C), [C]), x = f[C], g = (0, a.jsx)('div', {
        ...
        }), p = C === c.sFg.VERY_HIGH ? d.Z.Messages.MEMBER_VERIFICATION_FORM_ITEM_PHONE_VERIFICATION_SETTINGS_LABEL : d.Z.Messages.MEMBER_VERIFICATION_FORM_ITEM_EMAIL_VERIFICATION_SETTINGS_LABEL;
    return (0, a.jsx)(l.Z, {
        title: g,

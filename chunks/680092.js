...
var r = {
  ...
  "creditCard.holderName.invalid": "Digite o nome conforme mostrado no cart\xe3o",
  ...
  "creditCard.cvcField.title": "C\xf3digo de seguran\xe7a",
  ...
  "sr.wechatpay.timetopay": "Voc\xea tem %#minutos%# e %#segundos%# para pagar",
  ...
  gender: "G\xeanero",
  "gender.notselected": "Selecione um g\xeanero",
  male: "Masculino",
  female: "Feminino",
  ...
  cityTown: "Cidade",
  address: "Endere\xe7o",
  "address.placeholder": "Encontre seu endere\xe7o",
  "address.errors.incomplete": "Insira um endere\xe7o para continuar",
  "address.enterManually": "Inserir endere\xe7o manualmente",
  state: "Estado",
  "field.title.optional": "(opcional)",
  "creditCard.cvcField.title.optional": "C\xf3digo de seguran\xe7a (opcional)",
  ...
  "error.va.sf-cc-num.01": "Digite um n\xfamero de cart\xe3o v\xe1lido",
  "error.va.sf-cc-num.02": "Digite o n\xfamero do cart\xe3o",
  "error.va.sf-cc-num.03": "Digite uma bandeira de cart\xe3o aceita",
  "error.va.sf-cc-num.04": "Digite o n\xfamero completo do cart\xe3o",
  "error.va.sf-cc-dat.01": "Digite uma data v\xe1lida",
  "error.va.sf-cc-dat.02": "Digite uma data v\xe1lida",
  "error.va.sf-cc-dat.03": "Cart\xe3o de cr\xe9dito prestes a vencer",
  "error.va.sf-cc-dat.04": "Digite a data de validade",
  "error.va.sf-cc-dat.05": "Digite a data de validade completa",
  "error.va.sf-cc-mth.01": "Digite o m\xeas de validade",
  "error.va.sf-cc-yr.01": "Digite o ano de validade",
  "error.va.sf-cc-yr.02": "Digite o ano de validade completo",
  "error.va.sf-cc-cvc.01": "Digite o c\xf3digo de seguran\xe7a",
  "error.va.sf-cc-cvc.02": "Digite o c\xf3digo de seguran\xe7a completo",
  ...
  "creditCard.encryptedCardNumber.aria.iframeTitle": "Iframe para n\xfamero do cart\xe3o",
  ...
  "creditCard.encryptedExpiryMonth.aria.iframeTitle": "Iframe para m\xeas de validade",
  ...
  "creditCard.encryptedSecurityCode.aria.iframeTitle": "Iframe para c\xf3digo de seguran\xe7a",
  ...
  "giftcard.encryptedCardNumber.aria.iframeTitle": "Iframe para n\xfamero do cart\xe3o",
  "giftcard.encryptedCardNumber.aria.label": "N\xfamero do cart\xe3o",
  ...
  "ach.encryptedBankAccountNumber.aria.iframeTitle": "Iframe para n\xfamero da conta banc\xe1ria",
  "ach.encryptedBankAccountNumber.aria.label": "N\xfamero da conta",
  "ach.encryptedBankLocationId.aria.iframeTitle": "Iframe para n\xfamero de identifica\xe7\xe3o do banco",
  "ach.encryptedBankLocationId.aria.label": "N\xfamero de roteamento ABA",
  ...
  "onlineBankingPL.termsAndConditions": "Ao continuar, voc\xea concorda com as %#condi\xe7\xf5es%# e as %#informa\xe7\xf5es obrigat\xf3rias%# da Przelewy24",
  ...
  "companyDetails.registrationNumber.invalid": "Digite o n\xfamero de registro",
  "consent.checkbox.invalid": "Voc\xea precisa concordar com os termos e condi\xe7\xf5es",
  "form.instruction": "Todos os campos s\xe3o obrigat\xf3rios, a menos que marcados em contr\xe1rio.",
  "trustly.descriptor": "Pagamento instant\xe2neo",
  "trustly.description1": "Pague diretamente de qualquer conta, com a seguran\xe7a do seu banco",
  "trustly.description2": "Sem cart\xe3o, sem download de aplicativo, sem cadastro"
}
...
if (null == n || o >= r.length)
  return {
    type: null
  };
let _ = a.Z.getActiveCommand(u.id);
(null == _ ? void 0 : _.inputType) === s.iw.BUILT_IN_INTEGRATION && i.ZP.trackWithMetadata(p.rMx.APPLICATION_COMMAND_USED, {
  command_id: _.id,
  application_id: _.applicationId,
  command_type: _.type
});
let E = r[o];
return l.sendSticker(E.sticker, d.V0.BUILT_IN_INTEGRATION), E.sticker.type === d.n0.GUILD && (t = E.sticker.guild_id), i.ZP.trackWithMetadata(p.rMx.SEARCH_RESULT_SELECTED, {

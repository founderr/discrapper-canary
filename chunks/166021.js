n(47120);
var s = n(735250), a = n(470079), r = n(120356), i = n.n(r), l = n(920906), o = n(481060), c = n(320319), d = n(846280);
t.Z = e => {
    let {
            cards: t,
            className: n,
        ...
        children: (0, s.jsxs)('div', {
            ...
            children: [
                ...
                p > T && (0, s.jsx)('div', {
                    ...
                    children: t.map((e, t) => {
                        if (!(t > p - T))
                            return (0, s.jsx)('div', { className: t === u ? d.selectedDot : d.dot }, 'progress_bar_dot_'.concat(t));
                    })
                })
            ]
        })

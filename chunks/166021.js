...
t.default = e => {
  let {
    ...
    className: s,
    cardType: i
  } = e, E = () => window.innerWidth < 890 ? 1 : window.innerWidth < 1080 ? 2 : 3, [R, T] = r.useState(0), [S, f] = r.useState(E()), [I, m] = r.useState(!1), p = t.length;
  r.useEffect(() => {
    let e = () => {
      f(E())
    };
    ...
    p > S && R > p - S ? T(p - S) : p <= S && T(0)
  }, [p, S]);
  let A = r.useCallback(e => ({
      x: (e - R) * 100
    }), [R]),
    [N, M] = (0, l.useSprings)(t.length, A);
  return r.useEffect(() => {
    M(A)
  }, [M, A]), (0, a.jsx)("div", {
    className: s,
    children: (0, a.jsxs)("div", {
      ...
      children: [p > S && (0, a.jsx)(c.Clickable, {
        onClick: I ? () => {
          T(e => 0 === e ? p - S : e - 1)
        } : void 0,
        className: n()({

...
class eT extends s.PureComponent {
    ...
    renderGuildHeaderNotices(e) {
        let {
                ...
                anyLayerOpen: s
            } = this.props, {shouldShowSubscribeTooltip: a} = this.state;
        if (n)
            return (0, i.jsx)('div', {
    ...
    setAnimatedValue(e) {
        let {guild: t} = this.props, n = null != this.getGuildBannerHash(), i = null == t ? void 0 : t.hasCommunityInfoSubheader();
        if (null != t && (!!n || !!i))
    ...
    setAnimatedValueForGuildInfo(e) {
        ...
        (e >= 20 && t || e < 20 && !t) && (t = !t), t !== this.state.communityInfoVisible && this.setState({ communityInfoVisible: t }), n.update({
    ...
    renderChannelList() {
        ...
        if (e || null == t)
            return (0, i.jsx)(eo.Z, { withBannerPadding: null != t && null != this.getGuildBannerHash() });
    ...
    render() {
        ...
        return (0, i.jsxs)('nav', {
            ...
            'aria-label': eh.Z.Messages.GUILD_SIDEBAR_A11Y_LABEL.format({ guildName: null != e ? e.toString() : '' }),
            children: [
    ...
    constructor(...e) {
        super(...e), eI(this, 'historyUnlisten', () => {
        }), eI(this, 'showTimeout', new d.V7()), eI(this, 'state', {
            ...
            var e;
            let t = (0, Z.un)(c.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP), n = null === (e = this.props.guild) || void 0 === e ? void 0 : e.hasFeature(ec.oNc.HUB);
            !t && n && (0, Z.EW)(c.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP, { dismissAction: eu.L.AUTO });
            ...
            return t => {
                let {closePopout: n} = t, {guild: s} = this.props;
...
function eS(e) {
    ...
    (0, I.J_)(n);
    let _ = (0, v.Z)(n), h = (0, o.e7)([Y.Z], () => Y.Z.getGuildDimensions(n).scrollTo), E = (0, o.e7)([$.Z], () => $.Z.getChannelId()), [f, L, P] = (0, o.Wu)([X.Z], () => [
            X.Z.can(ec.Plq.MANAGE_GUILD, d),
            X.Z.can(ec.Plq.MANAGE_ROLES, d),
            X.Z.can(ec.Plq.MANAGE_THREADS, d)
        ]), y = (0, o.e7)([W.Z], () => W.Z.isUnavailable(n)), G = (0, o.e7)([ee.default], () => ee.default.getCurrentUser()), w = (0, o.e7)([V.Z], () => V.Z.darkSidebar ? ec.BRd.DARK : V.Z.theme), {enableStudyGroup: H} = (0, D.s)(d), z = (0, A.ZP)(e => e.currentlyShown.has(c.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION)), [ei, es] = s.useState(!z), ea = (0, m.Z)(n), {analyticsLocations: er} = (0, p.ZP)(g.Z.GUILD_HEADER), {analyticsLocations: el} = (0, p.ZP)(g.Z.GUILD_CHANNEL_LIST_FOOTER);
    s.useEffect(() => {
        n !== ea && es(!z);
    }, [
        n,
    ...
    let [eo, e_] = (0, A.ZP)(e => [
            ...
            M.Z,
            Q.Z
        ], () => null != d && null != G && f && !Q.Z.hasLayers() && M.Z.shouldShowGuildTemplateDirtyTooltip(n)), ex = (0, o.e7)([F.Z], () => F.Z.getChannel(l)), {isPopoutOpen: eb} = (0, O.y)(), eP = null !== (t = null == d ? void 0 : d.hasFeature(ec.oNc.COMMUNITY)) && void 0 !== t && t, eM = (0, o.e7)([k.Z], () => !r().isEmpty(k.Z.getThreadsForGuild(n))), eD = et.ZP.isNewUser(G), ey = ei && !eD, ej = (0, C.Z)(G);
    (0, R.Z)(d);
    let eU = (0, Z.wE)(c.z.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP), eG = (0, j.Z)(n), ek = (0, x.Z)(n), ew = (0, o.e7)([$.Z], () => $.Z.getChannelId()), eB = (0, o.e7)([J.Z], () => J.Z.desyncedVoiceStatesCount), eH = U.Y.useExperiment({ location: 'GuildSidebar' }, { autoTrackExposure: !0 }).enabled;
    return (0, i.jsx)(eT, {
        guildId: n,
        hideSelectedChannel: a,
        guild: d,

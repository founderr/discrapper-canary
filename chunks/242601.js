...
(e >= em && i || e < em && !i) && (i = !i), (e >= 88 && !t || e < 88 && t) && (t = !t), a = Math.max(88 - e, 0), n = i, (t !== this.state.renderBanner || i !== this.state.bannerVisible || a !== this.state.bannerVisibleHeight || n !== this.state.communityInfoVisible) && this.setState({
  renderBanner: t,
  bannerVisible: i,
  bannerVisibleHeight: a,
  communityInfoVisible: n
...
return (0, i.jsxs)('nav', {
  ...
  'aria-label': eE.Z.Messages.GUILD_SIDEBAR_A11Y_LABEL.format({
...
super(...e), eI(this, 'historyUnlisten', () => {}), eI(this, 'showTimeout', new d.V7()), eI(this, 'state', {
  ...
  !t && n && (0, v.EW)(c.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP, {
  ...
  let {
    ...
    showRoleSubscriptionUpsell: a,
    showDiscoveryTooltip: s,
  ...
  if (null == I)
    return this.renderGuildHeaderDropdownButton(e);
  let g = [];
  return (o && g.push(c.z.STUDENT_HUB_PRIVACY_SETTINGS_TOOLTIP), d && g.push(c.z.GUILD_HEADER_ACTIVE_THREADS_NOTICE), t && g.push(c.z.GUILD_HEADER_PREMIUM_GUILD_PROGRESS), n && g.push(c.z.GUILD_HEADER_PROGRESS_BAR_SIZE_COACH_MARK), a && g.push(c.z.GUILD_HEADER_ROLE_SUBSCRIPTION_UPSELL), u && g.push(c.z.GUILD_HEADER_SOUNDBOARD_PERMISSION), r && g.push(c.z.GUILD_HEADER_INVITE_SPLASH), s && g.push(c.z.GUILD_HEADER_SERVER_DISCOVERY_TOOLTIP), l && g.push(c.z.GUILD_DISCOVERY_LANDING_PAGE_SETTINGS_UPSELL), 0 === g.length) ? this.renderGuildHeaderDropdownButton(e) : (_ && g.push(c.z.MEDIA_CHANNEL_UPSELL), E && g.push(c.z.SERVER_SUBSCRIPTION_TIER_TEMPLATE_UPSELL), h && g.push(c.z.PREMIUM_CUSTOM_NOTIFICATION_SOUNDS_COACHMARK), (0, i.jsx)(er.Z, {
    contentTypes: g,
    theme: m,
    guild: I,
    renderGuildHeaderDropdownButton: () => this.renderGuildHeaderDropdownButton(e)
  }));
}), eI(this, 'renderGuildHeaderDropdownButton', e => (0, i.jsx)(h.Z, {
  open: e,
...
e.currentlyShownGroup.has(eu.R.GUILD_HEADER_TOOLTIPS)
  ]), eE = (0, f.Z)(d), eh = (0, u.useModalsStore)(u.hasAnyModalOpenSelector), eI = (0, o.e7)([Q.Z], () => Q.Z.hasLayers()), em = (0, o.e7)([B.Z], () => B.Z.shouldShow(eg)), ep = S && (null == d ? void 0 : d.premiumProgressBarEnabled) === !1 && !en.s.isDisallowPopupsSet(), ef = (0, o.e7)([K.Z], () => K.Z.getMemberCount(n)), eS = S && null != ef && ef >= 30 && (null == d ? void 0 : d.premiumProgressBarEnabled) === !1 && !en.s.isDisallowPopupsSet(), eC = Z && null != d && (d.hasFeature(ec.oNc.COMMUNITY) || null != ef && ef > 50), eN = (0, b.Z)(n), eA = (0, N._)(n), ev = (null == d ? void 0 : d.hasFeature(ec.oNc.HUB)) === !0, eZ = S && (null == d ? void 0 : d.hasFeature(ec.oNc.DISCOVERABLE)) === !0, eL = (0, T.Q)(), eO = (S || (null == d ? void 0 : d.premiumTier) === ec.Eu4.NONE) && !en.s.isDisallowPopupsSet() && !eL, eR = (0, o.e7)([
M.Z,
Q.Z

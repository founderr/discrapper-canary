...
function eS(e) {
    ...
    (0, I.J_)(n);
    let _ = (0, v.Z)(n), h = (0, o.e7)([Y.Z], () => Y.Z.getGuildDimensions(n).scrollTo), E = (0, o.e7)([$.Z], () => $.Z.getChannelId()), [C, L, P] = (0, o.Wu)([X.Z], () => [
    ...
    let [eo, e_] = (0, A.ZP)(e => [
            ...
            M.Z,
            Q.Z
        ], () => null != d && null != G && C && !Q.Z.hasLayers() && M.Z.shouldShowGuildTemplateDirtyTooltip(n)), ex = (0, o.e7)([F.Z], () => F.Z.getChannel(l)), {isPopoutOpen: eb} = (0, O.y)(), eP = null !== (t = null == d ? void 0 : d.hasFeature(ec.oNc.COMMUNITY)) && void 0 !== t && t, eM = (0, o.e7)([k.Z], () => !r().isEmpty(k.Z.getThreadsForGuild(n))), eD = et.ZP.isNewUser(G), ey = ei && !eD, ej = (0, f.Z)(G);
    (0, R.Z)(d);

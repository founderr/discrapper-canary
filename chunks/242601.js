...
class eT extends s.PureComponent {
    ...
    constructor(...e) {
        super(...e), eI(this, 'historyUnlisten', () => {
            ...
            null != e && t && b.Z.hideGuildTemplateDirtyTooltip(e.id);
...
function eS(e) {
    ...
    (0, R.Z)(d);
    let eU = (0, Z.wE)(c.z.PREMIUM_TUTORIAL_SERVER_MENU_TOOLTIP), eG = (0, j.Z)(n), ew = (0, x.Z)(n), ek = (0, o.e7)([$.Z], () => $.Z.getChannelId()), eB = (0, o.e7)([J.Z], () => J.Z.desyncedVoiceStatesCount), eH = U.Y.useExperiment({ location: 'GuildSidebar' }, { autoTrackExposure: !0 }).enabled;
    return (0, i.jsx)(eT, {
        guildId: n,
        hideSelectedChannel: a,
        guild: d,

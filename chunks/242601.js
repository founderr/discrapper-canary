...
function eS(e) {
    ...
    let [eo, e_] = (0, A.ZP)((e) => [ed.XN.some((t) => e.currentlyShown.has(t.dismissibleContentType)), e.currentlyShownGroup.has(eu.R.GUILD_HEADER_TOOLTIPS)]),
        ...
        ef = L && null != d && (d.hasFeature(ec.oNc.COMMUNITY) || (null != eS && eS > 50)),
        eN = (0, b.Z)(n),
        eA = (0, N._)(n),
        ev = (null == d ? void 0 : d.hasFeature(ec.oNc.HUB)) === !0,
        eL = C && (null == d ? void 0 : d.hasFeature(ec.oNc.DISCOVERABLE)) === !0,
        eZ = (0, T.Q)(),
        eR = (C || (null == d ? void 0 : d.premiumTier) === ec.Eu4.NONE) && !en.s.isDisallowPopupsSet() && !eZ,

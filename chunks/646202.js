...
var a, l, n = s(735250), r = s(470079), i = s(120356), c = s.n(i), o = s(108131), d = s.n(o), u = s(920906), m = s(481060), x = s(442837), h = s(607070), p = s(594174), C = s(153124), N = s(626135), j = s(792125), v = s(547280), T = s(678513), k = s(445507), E = s(981631), g = s(689938), y = s(352852);
...
function _(e) {
    let {
            ...
            isSelected: a,
            onOptionSelected: l
        } = e, [i, o] = r.useState(!1), d = (0, m.useToken)(m.tokens.colors.BACKGROUND_TERTIARY).hsl({ opacity: i && !a ? 0.9 : 0.8 }), u = r.useCallback(() => {
            l(t);
        }, [
            l,
            t
...
function P(e) {
    let {
            ...
            data: l
        } = e, i = (0, x.e7)([h.Z], () => h.Z.useReducedMotion), [{state: c}, o] = (0, u.useSpring)(() => ({ state: 0 }), []), C = (0, x.e7)([p.default], () => p.default.getCurrentUser()), N = c.to({
            range: [
                0,
                1
            ],
...
function O(e) {
    let {
            ...
            transitionState: a,
            onClose: l
        } = e, i = (0, C.Dt)(), o = r.useRef({ guildId: s }), [d, u] = r.useState(null), h = (0, x.e7)([T.Z], () => T.Z.hasCompletedTarget(t.key)) ? 1 : 0;
    r.useEffect(() => {
    ...
    let p = r.useCallback(e => {
            ...
            u,
            o
        ]), j = 'url('.concat(t.backgroundAssetUrl, ') black top / cover no-repeat'), k = null;
    switch (h) {
    case 0:
        k = (0, n.jsx)(P, {
            target: t,

...
let E = (window.innerWidth - h.CHANNEL_SIDEBAR_WIDTH) / 2,
  _ = null,
  m = {};
class S extends u.default.DeviceSettingsStore {
  initialize(e) {
    var t;
  ...
  get expressionPickerWidth() {
    var e;
    return null !== (e = m.expressionPickerWidth) && void 0 !== e ? e : f.ExpressionPickerWidths.MIN
  }
  get messageRequestSidebarWidth() {
    var e;
    return null !== (e = m.messageRequestSidebarWidth) && void 0 !== e ? e : h.DEFAULT_MESSAGE_REQUEST_SIDEBAR_WIDTH
  }
  get threadSidebarWidth() {
    var e;
    return null !== (e = m.threadSidebarWidth) && void 0 !== e ? e : h.DEFAULT_CHAT_SIDEBAR_WIDTH
  }
  ...
  get callChatSidebarWidth() {
    var e;
    return null !== (e = m.callChatSidebarWidth) && void 0 !== e ? e : h.DEFAULT_CHAT_SIDEBAR_WIDTH
  }
  get homeSidebarWidth() {
    var e;
    return null !== (e = m.homeSidebarWidth) && void 0 !== e ? e : (null == _ && (_ = Math.max((window.innerWidth - h.CHANNEL_SIDEBAR_WIDTH) * .4, h.DEFAULT_CHAT_SIDEBAR_WIDTH)), _)
  }
  ...
  get useSystemTheme() {
    var e;
    return null !== (e = m.useSystemTheme) && void 0 !== e ? e : p.SystemThemeState.UNSET
  }
...
S.displayName = "UnsyncedUserSettingsStore", S.persistKey = "UnsyncedUserSettingsStore", S.migrations = [() => {

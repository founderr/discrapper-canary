...
function _(e) {
  ...
  if (null != k) _ = l = k.url;
    ...
    for (;
      (0, s.k)(C);)(0, s.k)(C, HTMLImageElement) && null != C.src && (_ = C.src), (0, s.k)(C, HTMLAnchorElement) && null != C.href && (l = C.href, f = C.textContent), C = C.parentNode;

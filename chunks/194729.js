...
class J extends a.PureComponent {
    componentDidMount() {
        ...
        u > 0 && (null === (n = this._scroller.current) || void 0 === n || n.scrollTo({ to: u })), (0, L.e)('guild_discovery'), (0, f.k)({ selectedCategoryId: o });
    }
    componentDidUpdate(e) {
        ...
        e.currentCategoryId !== r && D.Az(this.loadId, Array.from(this._guildIdsSeen)), e.currentCategoryId !== r && (0, f.k)({ selectedCategoryId: r }), e.mostRecentQuery.length > 0 && a.length < 1 && s !== r && (0, m.uY)(null != s ? s : Y.Hk);
    }
    componentWillUnmount() {
        let { currentCategoryId: e, recommendationsLoadId: t, recommendationsGuilds: n } = this.props;
        e === Y.Hk ? null != n && null != t && D.Az(t, this.getOrderedGuildIdsSeen(n.map((e) => e.id)), 'Game Recommendations') : D.Az(this.loadId, Array.from(this._guildIdsSeen));
    }
            ...
            children: [
                ...
                (0, i.jsx)(h.AdvancedScrollerAuto, {
                    ...
                    children: (0, i.jsx)('div', {
                        className: r()(K.viewWrapper, { [K.searchPage]: d }),
                        children: d
    ...
    constructor(...e) {
        super(...e),
            X(this, '_scroller', a.createRef()),
            X(this, '_guildIdsSeen', new Set()),
            X(this, 'loadId', (0, j.P)()),
            X(this, 'state', {
            ...
            X(this, 'handleTagSearch', (e, t, n) => {
                ...
                if (null == i) return;
                let s = { approximate_member_count: D.sq };
                (0, m.G7)(e, s),
                    (0, m.bR)(e, {
                        filters: s,
                        categoryId: i,
...
t.Z = function (e) {
    let { searchRoute: t } = e,
        ...
        l = (0, _.e7)([b.ZP], () => b.ZP.getCurrentCategoryId()),
        o = (0, _.e7)([b.ZP], () => b.ZP.getIsReady()),
        c = (0, A.XT)();
    return (a.useEffect(() => {

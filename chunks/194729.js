n(390547), n(47120);
var i = n(735250), s = n(470079), a = n(120356), r = n.n(a), l = n(392711), o = n.n(l), c = n(664751), d = n(748780), u = n(873546), _ = n(442837), h = n(481060), E = n(570140), I = n(212093), m = n(827837), g = n(785570), p = n(100527), T = n(963202), S = n(252618), C = n(440190), f = n(665149), N = n(5955), A = n(121711), Z = n(709158), L = n(703656), v = n(108427), O = n(706454), R = n(210887), x = n(480294), b = n(683301), P = n(430824), M = n(230307), D = n(900849), y = n(879484), j = n(117496), U = n(296386), G = n(150192), k = n(769727), w = n(584885), B = n(59222), H = n(749436), V = n(26580), F = n(731455), Y = n(981631), W = n(689938), z = n(468918), K = n(368179), q = n(52518);
function Q(e, t, n) {
...
class X extends s.PureComponent {
    ...
    renderSearchBar() {
        ...
        let {shouldDisplayRecommendedSearchTags: d} = y.w.getCurrentConfig({ location: '54961b_2' }, { autoTrackExposure: !1 }), u = d ? l === F.Hk ? W.Z.Messages.GUILD_DISCOVERY_SEARCH_PLACEHOLDER_TAGS : W.Z.Messages.GUILD_DISCOVERY_CATEGORY_SEARCH_PLACEHOLDER_TAGS.format({ categoryName: c }) : l === F.Hk ? W.Z.Messages.GUILD_DISCOVERY_SEARCH_PLACEHOLDER : W.Z.Messages.GUILD_DISCOVERY_CATEGORY_SEARCH_PLACEHOLDER.format({ categoryName: c }), _ = null !== (t = null === (e = s[n]) || void 0 === e ? void 0 : e[l]) && void 0 !== t ? t : b.xk;
        return (0, i.jsx)(H.Z, {
            loadId: this.loadId,
            searchResults: _,
            mostRecentQuery: n,
    ...
    renderSearchResults() {
        ...
        let {
            ...
            } = this.props, {loadingGuildId: u} = this.state, _ = c === F.Hk ? W.Z.Messages.GUILD_DISCOVERY_SEARCH_PLACEHOLDER : W.Z.Messages.GUILD_DISCOVERY_CATEGORY_SEARCH_PLACEHOLDER.format({ categoryName: d }), h = null !== (t = null === (e = s[n]) || void 0 === e ? void 0 : e[c]) && void 0 !== t ? t : b.xk;
        return (0, i.jsx)(B.Z, {
            loadId: this.loadId,
            availableLanguages: a,
            defaultLanguage: r,
    ...
    renderRecommendedGuildsSection() {
        let {
                guilds: e,
                theme: t
            } = this.props, {loadingGuildId: n} = this.state;
        return (0, i.jsx)(w.Z, {
            loadId: this.loadId,
    ...
    renderPopularGuildsSection() {
        let {
                ...
                theme: t,
                currentCategoryId: n
            } = this.props, {loadingGuildId: s} = this.state;
        return (0, i.jsx)(w.Z, {
            loadId: this.loadId,
    ...
    render() {
        ...
        if (l === F.U)
            return (0, i.jsx)(N.Z, { loadId: this.loadId });
        ...
        return (0, i.jsxs)('div', {
            ...
            children: [
                ...
                u.tq && (0, i.jsx)(f.ZP, { children: (0, i.jsx)(s.Fragment, {}) }),
    ...
    constructor(...e) {
        super(...e), Q(this, '_scroller', s.createRef()), Q(this, '_guildIdsSeen', new Set()), Q(this, 'loadId', (0, j.P)()), Q(this, 'state', {
            ...
            var e, t;
            let {animatedValue: n} = this.state, i = null !== (t = null === (e = this._scroller.current) || void 0 === e ? void 0 : e.getScrollerState().scrollTop) && void 0 !== t ? t : 0;
            n.setValue(Math.min(1, i / 200));
        }), Q(this, 'handleViewGuild', async (e, t, n, i) => {
            var s, a;
            let {currentCategoryId: r} = this.props, {loadingGuildId: l} = this.state;
            if (e === l)
                return;
            let o = null !== (a = null === (s = this._scroller.current) || void 0 === s ? void 0 : s.getScrollerState().scrollTop) && void 0 !== a ? a : 0, {location: c} = (0, L.s1)();
            (0, L.dL)({
                ...c,
                state: o
            ...
            if (null == i)
                return;
            let a = { approximate_member_count: D.sq };
            (0, I.G7)(e, a), (0, I.bR)(e, {
                filters: a,
                categoryId: i,
...
let J = _.ZP.connectStores([
    ...
    var e;
    let t = F.dU, n = O.default.locale, i = null !== (e = o().find(t, { code: n })) && void 0 !== e ? e : t[0], s = Object.keys(M.Z.applicationStatistics), a = x.Z.hasConsented(Y.pjP.PERSONALIZATION) && s.length > 0, r = b.ZP.getCurrentCategoryId(), l = b.ZP.getCurrentHomepageCategoryId();
    return {
...
t.Z = function (e) {
    let {searchRoute: t} = e, {guilds: n} = (0, T.C3)({
            ...
            includeConverted: !0
        }), s = n.length > 0, {clanDiscoveryEnabled: a} = (0, T.nk)('guild_discovery'), r = (0, _.e7)([b.ZP], () => b.ZP.getCurrentCategoryId()), l = (0, _.e7)([b.ZP], () => b.ZP.getIsReady()), o = (0, Z.Z)(p.Z.QUEST_HOME_PAGE);
    return (s || a) && (!l || r === F.Gj.Clans) ? (0, i.jsx)(k.Z, {}) : o && r === F.Gj.Quests ? (0, i.jsx)(A.Z, {}) : (0, i.jsx)($, { searchRoute: t });
};

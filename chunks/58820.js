...
function K(e) {
  ...
  }), R = d(n.currentPeriodEnd), A = null != n.paymentSourceId, M = null !== (t = null == C ? void 0 : C.total) && void 0 !== t ? t : 0, h = null == l ? void 0 : l.invalid, L = !A && M > 0 && (7 >= R.diff(d(), "days") || n.status === b.SubscriptionStatusTypes.PAST_DUE) && !P && !n.isPurchasedExternally, x = h && n.status === b.SubscriptionStatusTypes.PAST_DUE && !P && !n.isPurchasedExternally, D = (0, y.useIsPrepaidPaymentPastDue)(), U = !P && D, j = (null == n ? void 0 : n.status) === b.SubscriptionStatusTypes.PAST_DUE ? d().diff(d(n.currentPeriodStart), "days") : 0, [w] = (0, g.useGetSubscriptionInvoice)({
    subscriptionId: n.id,
    preventFetch: !U
  });
  return null == N || null == C ? (0, a.jsx)(f.Spinner, {}) : (null != n.renewalMutations && (n.renewalMutations.planId !== n.planId && !(0, S.isNoneSubscription)(n.renewalMutations.planId) || n.hasExternalPlanChange) && (s = (0, a.jsx)(O.default, {
    subscription: n,

n(47120);
var i, l = n(735250), r = n(470079), a = n(120356), s = n.n(a), o = n(748780), c = n(846519), u = n(481060), d = n(585483), h = n(981631), p = n(689938), _ = n(225404);
function f(e, t, n) {
...
class g extends (i = r.PureComponent) {
    ...
    render() {
        let {hasQuery: e} = this.props, {shown: t} = this.state;
        return (0, l.jsxs)('div', {
            ref: this.rootRef,
        ...
        super(...e), f(this, 'state', {
            ...
            this.focusTimeout.start(1, () => {
                if (this.props.hasQuery && null != t && null != this.rootRef.current) {
                    let {top: e} = this.rootRef.current.getBoundingClientRect(), {top: n} = t.getBoundingClientRect(), i = Math.abs(e - n);

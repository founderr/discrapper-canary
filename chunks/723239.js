...
var v = (function (e) {
    ...
    function r() {
        ...
        return E(p((e = n.call.apply(n, [this].concat(a)))), 'priority', 70), E(p(e), 'incompatibleTokens', ['H', 'K', 'k', 't', 'T']), e;
    }
    return (
        c(r, [
            {
            ...
            },
            {
                ...
                value: function (e, n, r) {
                    ...
                    return i && r < 12 ? e.setUTCHours(r + 12, 0, 0, 0) : i || 12 !== r ? e.setUTCHours(r, 0, 0, 0) : e.setUTCHours(0, 0, 0, 0), e;
                }
            }
        ]),
        r

...
var r, i, a, o, s, l, u, c, d = n(392711), _ = n.n(d), E = n(913527), f = n.n(E), h = n(137920), p = n(689938);
let m = 200, I = 4, T = 'ClanSetupModal', g = 'ClanSettingsModal', S = 20, A = 30, N = 24, v = 12, O = 300, R = 3, C = 5;
...
let M = '700136079562375258', P = '762434991303950386', U = [
        'Server: NA',
        'Server: EU',
        'Server: LATAM',
        'Server: KR',
...
let j = [
    ...
    ], W = j[0].primary, K = j[0].secondary, z = Object.fromEntries(j.map(e => [
        e.name,
        {
            primary: e.primary,

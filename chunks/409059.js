var r, i, a, o, s = n(442837), l = n(570140), u = n(741847), c = n(58346);
let d = {}, _ = null;
function E(e, t) {
    var n;
    let r = null !== (n = d[e]) && void 0 !== n ? n : {
        code: e,
...
class m extends (o = s.ZP.Store) {
    ...
    getForGuild(e) {
        for (let t in d) {
            let n = d[t];
            if ('sourceGuildId' in n && n.sourceGuildId === e && n.state !== c.Rj.EXPIRED)
                return n;
        }
    }
...
a = 'GuildTemplateStore', (i = 'displayName') in (r = m) ? Object.defineProperty(r, i, {
    value: a,
    enumerable: !0,
    configurable: !0,
    writable: !0

...
function f(e) {
    ...
    if (_[D.zm] > 0)
        ...
        case u.f.GUILD_ROLE_SUBSCRIPTIONS:
...
function P(e, _, E, s) {
    let T = (0, L.wE)(a.z.CHANNEL_BROWSER_NUX), I = (0, t.cj)([G.Z], () => {
            let _ = {}, E = G.Z.getMutableGuildChannelsForGuild(e);
            for (let e in E) {
                let {parent_id: T} = E[e];
                if (null != T) {
                    var s;
...
function p(e) {
    var _, E;
    let s = (0, t.e7)([O.Z], () => O.Z.getCategories(e)), T = s._categories.length, I = s._categories[s._categories.length - 1];
    if (null == I)
        return 0;
...
function H(e) {
    var _;
    return C.Z.Messages.CHANNEL_BROWSER_ACTIVE_TEXT.format({ timeAgo: A()(M.default.extractTimestamp(null !== (_ = i.ZP.lastMessageId(e)) && void 0 !== _ ? _ : e)).fromNow() });
}

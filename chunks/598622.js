...
let I = e => ({
  ...
  renderComponent: () => (0, s.jsx)(l.Z, {
    guild: e
  }, 'raid-alerts'),
  enabled: !e.hasFeature(u.oNc.RAID_ALERTS_DISABLED)
},
{
  renderComponent: () => (0, s.jsx)(o.Z, {
...
},
{
  ...
  renderComponent: () => (0, s.jsx)(d.Z, {
    guild: e
  }, 'verification-level'),
  enabled: !0
},
{
  renderComponent: () => (0, s.jsx)(c.Z, {
    guild: e
  }, 'member-verification'),
...
{
  renderComponent: () => (0, s.jsx)(o.Z, {
    title: _.Z.Messages.GUILD_SETTINGS_SAFETY_SPAM_SUSPICIOUS_LINKS
  }, 'outbound-links-warn'),
  enabled: !0
},
{
  renderComponent: () => (0, s.jsx)(o.Z, {
    title: _.Z.Messages.GUILD_SETTINGS_SAFETY_SPAM_DM_SUSPCIOUS_MESSAGES
  }, 'delete-spam'),
  enabled: !0
}
  ],
  [a.u.PERMISSIONS]: [{
  renderComponent: () => (0, s.jsx)(i.Z, {
    guild: e
  }, 'guild-mfa'),
  enabled: e.mfaLevel === u.BpS.ELEVATED
},
{
  renderComponent: () => (0, s.jsx)(r.Z, {
    guild: e
  }, 'disable-risky-perms'),

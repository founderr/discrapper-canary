...
let E = 365,
    ...
    g = [s.Ci.SU.weekday, s.Ci.MO.weekday],
...
function F(e) {
    let t = y(e.toDate().getDay()),
        n = y(e.toDate().getUTCDay());
    return n.weekday - t.weekday > 0 ? m : n.weekday - t.weekday < 0 ? I : p;
}
function V(e) {
    let t = y(e.toDate().getDay()),
        n = y(e.toDate().getUTCDay());
    return n.weekday - t.weekday > 0 ? g : n.weekday - t.weekday < 0 ? S : T;
}
function H(e, t) {
    let n = (function (e, t) {
        let n = F(t),
            r = V(t),
            i = y(t.toDate().getUTCDay()),
...
function Z(e, t) {
    ...
    switch (n.options.freq) {
        ...
        case s.Ci.DAILY:
            ...
            if ((0, r.isEqual)(n.options.byweekday, V(e))) return c.z.WEEKEND_ONLY;
            return c.z.NONE;
        default:
            return c.z.NONE;
    }

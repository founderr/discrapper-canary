...
'aria-label': m,
onCopy: f
  } = e, [S, h] = i.useState(0), [M, x] = i.useState(!1), [b, O] = i.useState(!1);
  if (i.useEffect(() => (s = new c.V7(), a = new c.V7(), function() {
  s.stop(), a.stop();
}), []), !u.wS || N)
...
U = e => {
  null == f || f(), (0, u.JG)(l), _.default.track(E.rMx.TEXT_COPIED, {
    type: R
  }), 'function' == typeof e && e(), !b && h(S + 1), O(!0), x(!0), s.start(1000, () => O(!1)), a.start(2000, () => h(0));
};
  return (0, r.jsx)(d.Tooltip, {
delay: g,
color: B,
forceOpen: b,
text: M ? (0, r.jsx)(d.Shaker, {
  isShaking: Z,
  children: L
}) : C,
onAnimationRest: (e, t) => {

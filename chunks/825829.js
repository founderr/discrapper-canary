...
function L(n, e) {
  ...
  if (null != u) {
    if (u.type === c.hBH.AUTO_MODERATION_MESSAGE) return null == u ? void 0 : null === (E = u.fields) || void 0 === E ? void 0 : null === (_ = E.find(n => {
      let {
        rawName: t
      } = n;
      return t === e
    })) || void 0 === _ ? void 0 : _.rawValue;
    if (u.type === c.hBH.AUTO_MODERATION_NOTIFICATION) return null == u ? void 0 : null === (i = u.fields) || void 0 === i ? void 0 : null === (r = i.find(n => {
      let {
        rawName: t
      } = n;
      return t === e
...
function S(n, e) {
  var t, _;
  let A = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : c.VqG,
    ...
    S = L(n, u.G.INTERACTION_CALLBACK_TYPE),
    C = L(n, u.G.APPLICATION_NAME);
  if (null != M) {
  ...
  let R = (t = e, U ? null !== (_ = null == t ? void 0 : t.name) && void 0 !== _ ? _ : D.Z.Messages.UNKNOWN_CHANNEL_PLACEHOLDER : D.Z.Messages.NO_ACCESS),
    f = null != e && U ? A : c.VqG,
    G = function(n, e, t) {
  ...
  if (null != G) return G;
  if (null != C) return S === i.y.MODAL && null != T ? d !== r.P.BLOCKED ? D.Z.Messages.GUILD_AUTOMOD_LAUNCH_MODAL_HEADER_ACTION_APP_FLAGGED.format({
    applicationName: C,
...
function U(n) {
  var e, t;
  let _ = L(n, A.D.NOTIFICATION_TYPE),
    E = L(n, A.D.JOIN_ATTEMPTS),
    r = L(n, A.D.RAID_DATETIME),
    i = L(n, A.D.DMS_SENT),
    u = L(n, A.D.RAID_TYPE),
    a = L(n, A.D.RESOLVED_REASON),
    o = L(n, A.D.DECISION_ID),
    O = L(n, A.D.SUSPICIOUS_MENTION_ACTIVITY_UNTIL);
  return {
...
function R(n) {
  let e = L(n, u.G.CHANNEL_ID),
    t = L(n, u.G.ALERT_ACTIONS_EXECUTION),
    _ = (0, l.t)(t);
  return {
    content: function(n) {
      var e, t;
...
function f(n) {
  let e = _.useMemo(() => R(n), [n]),
    t = (0, T.e7)([N.Z], () => N.Z.getChannel(e.embedChannelId), [e.embedChannelId]);
  return {
    ...e,
    embedChannel: t
  }
...
function G(n) {
  ...
  let {
    alertActionsExecution: e
  } = R(n);
  return null != e ? e : null
}

function P(n) {
  if (null == n) return D.Z.Messages.GUILD_AUTOMOD_NOTIFICATION_MARK_AS_RESOLVED;
  switch (n) {

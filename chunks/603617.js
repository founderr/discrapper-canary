...
let r = i(0, () => a.Z.Messages.MAX_USES.format({
    maxUses: 0
  })),
  o = i(1, () => a.Z.Messages.MAX_USES.format({
    maxUses: 1
  })),
  l = i(5, () => a.Z.Messages.MAX_USES.format({
    maxUses: 5
  })),
  c = i(10, () => a.Z.Messages.MAX_USES.format({
    maxUses: 10
  })),
  s = i(25, () => a.Z.Messages.MAX_USES.format({
    maxUses: 25
  })),
  u = i(50, () => a.Z.Messages.MAX_USES.format({
    maxUses: 50
  })),
  d = i(100, () => a.Z.Messages.MAX_USES.format({
    maxUses: 100
  })),
  _ = [r, o, l, c, s, u, d],
  I = i(1800, () => a.Z.Messages.DURATION_MINUTES.format({
    minutes: 30
  })),
  f = i(3600, () => a.Z.Messages.DURATION_HOURS.format({
    hours: 1
  })),
  E = i(21600, () => a.Z.Messages.DURATION_HOURS.format({
    hours: 6
  })),
  N = i(43200, () => a.Z.Messages.DURATION_HOURS.format({
    hours: 12
  })),
  T = i(86400, () => a.Z.Messages.DURATION_DAYS.format({
    days: 1
  })),
  S = i(604800, () => a.Z.Messages.DURATION_DAYS.format({
    days: 7
  })),

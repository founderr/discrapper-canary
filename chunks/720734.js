...
class eU extends s.PureComponent {
  ...
  render() {
    ...
    return null == e ? null : (0, i.jsxs)("div", {
      ...
      children: [this.renderNameZone(), (0, i.jsxs)(ep.Z, {
        grow: 0,
        children: [(0, i.jsx)(ek, {
          selfMute: n,
          serverMute: a,
  ...
  constructor(...e) {
    super(...e), eD(this, "copiedTimeout", new c.V7), eD(this, "copiedDecayTimeout", new c.V7), eD(this, "speakingWhileMutedTooltipTimeout", new c.V7), eD(this, "state", {
      ...
      null != t && (0, I.jW)(e, async () => {
        let {
          default: e
        } = await Promise.all([n.e("96427"), n.e("77298"), n.e("23357"), n.e("19503"), n.e("15972"), n.e("12013"), n.e("6416"), n.e("39612"), n.e("32776"), n.e("95900"), n.e("33053"), n.e("8016"), n.e("68136"), n.e("50654"), n.e("76540"), n.e("22646"), n.e("87624"), n.e("5528"), n.e("3746"), n.e("43331"), n.e("30419"), n.e("18824"), n.e("80229"), n.e("62566")]).then(n.bind(n, 923422));
        return n => (0, i.jsx)(e, {
          ...n,
          user: t,
...
function eG() {
  ...
  let n = (0, l.e7)([eI.default], () => eI.default.getCurrentUser()),
    ...
    y = (0, E.useModalsStore)(E.hasAnyModalOpenSelector) || M || eL.s.isDisallowPopupsSet(),
    w = (0, F.b)(),
  ...
  let eg = (0, l.e7)([ee.Z], () => ee.Z.hasHadOtherUserPlaySoundInSession()),
    eT = function() {
      let e = (0, D.wE)(o.z.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2),
        ...
        [i, a] = (0, l.Wu)([em.ZP], () => [em.ZP.hasFetchedMostRecentPremiumTypeSubscription(), em.ZP.getMostRecentPremiumTypeSubscription()]),
        {
          enabled: r
        } = z.Z.useExperiment({
          location: "08bd40_1"
...
function ek(e) {
  let {
    ...
    play: g,
    events: T
  } = (0, u.O)(m ? "unmute" : "mute"), C = n || a ? E.MicrophoneDenyIcon : p;
  return s.useEffect(() => () => g(), [m, g]), (0, i.jsx)(eT.Z, {
    tooltipText: l,
    tooltipColor: o,
    tooltipForceOpen: c,
    onMouseEnter: () => {
...
function eB(e) {
  ...
  return s.useEffect(() => () => _(), [c, _]), (0, i.jsx)(eT.Z, {

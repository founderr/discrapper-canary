...
class eK extends s.PureComponent {
  ...
  renderCopiableNameTag() {
    ...
    return eD.SUPPORTS_COPY && (s = eF.default.Messages.ACCOUNT_CLICK_TO_COPY, a && (s = this.renderCopiedSuccess(), l = this.isCopiedStreakGodlike ? m.TooltipColors.RED : m.TooltipColors.GREEN)), (0, n.jsx)(m.Tooltip, {
      text: s,
      forceOpen: t,
              ...
              case o.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP:
                return (0, n.jsx)(m.Popout, {
                  ...
                  renderPopout: () => (0, n.jsx)(V.default, {
                    markAsDismissed: a,
                    partnerGame: eB.PartnerGame.FORTNITE
                  }),
                  children: this.renderSettingsGear
                });
...
function ez() {
  var e, t;
  let a = (0, r.useStateFromStores)([ep.default], () => ep.default.getCurrentUser()),
    l = (0, B.useShowEligibilityEnrollmentTooltip)(eB.PartnerGame.FORTNITE),
  ...
  let U = (0, r.useStateFromStores)([W.default], () => null != W.default.getAwaitingRemoteSessionInfo()),
    ...
    Y = (0, r.useStateFromStores)([F.default], () => F.default.isCurrentQuestCompleted),
    q = (0, r.useStateFromStores)([F.default], () => F.default.currentDropQuestGameTitle),
  ...
  let eT = (0, r.useStateFromStores)([es.default], () => es.default.hasHadOtherUserPlaySoundInSession()),
    eg = function() {
      let e = (0, w.useIsDismissibleContentDismissed)(o.DismissibleContent.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2),
        ...
        [n, l] = (0, r.useStateFromStoresArray)([eI.default], () => [eI.default.hasFetchedMostRecentPremiumTypeSubscription(), eI.default.getMostRecentPremiumTypeSubscription()]),
        {
          enabled: i
  ...
  return !D && (eg && eA.settings.push(o.DismissibleContent.PROFILE_THEMES_FEATURE_EDUCATION_TOOLTIP_TAKE_2), l && (eA.settings.push(o.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP), Y && q === (null === (t = (0, H.getDrop)(eB.PartnerGame.FORTNITE)) || void 0 === t ? void 0 : t.title) && eA.settings.push(o.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP)), J && et && eA.settings.push(o.DismissibleContent.USER_SAFETY_SAFE_DIRECT_MESSAGING), ea && (1 === en ? eA.settings.push(o.DismissibleContent.USER_SAFETY_CONSUMER_EDUCATION_MUTE) : eA.settings.push(o.DismissibleContent.USER_SAFETY_CONSUMER_EDUCATION_BLOCK)), eT && eA.settings.push(o.DismissibleContent.SOUNDBOARD_VOLUME_EDUCATION), el && eA.settings.push(o.DismissibleContent.USER_SAFETY_CONSUMER_EDUCATION_REPORTING), ei && eA.settings.push(o.DismissibleContent.PER_GUILD_COLLECTIBLES_CUSTOMIZATION_COACHMARK), eo && eA.avatar.push(o.DismissibleContent.PREMIUM_SUBSCRIPTION_APRIL_MARKETING_DECO_TOOLTIP)), (0, n.jsx)(eK, {
    currentUser: a,
...
function eq(e) {
  ...
  return i ? o = null != t ? E.SettingsInfoIcon : a ? f.SettingsCircleIcon : u.Component : null != t ? r = (0, n.jsx)(eL.default, {
    ...
    onClick: s,
    onContextMenu: l,
    innerClassName: null != t || a ? eH.buildOverrideButton : null,
    icon: o,
    ...u.events,
    children: r
  })

    ...
    return null == e ? null : (0, a.jsxs)("div", {
      ...
      children: [this.renderNameZone(), (0, a.jsxs)(eg.default, {
        ...
        children: [(0, a.jsx)(eQ, {
          ...
          suppress: r,
          awaitingRemote: s,
          tooltipText: d ? eB.default.Messages.ACCOUNT_SPEAKING_WHILE_MUTED : (0, P.default)(n, l, r, s),
...
function ez() {
  ...
  let n = (0, r.useStateFromStores)([ep.default], () => ep.default.getCurrentUser()),
    ...
    M = (0, r.useStateFromStores)([eI.default], () => eI.default.getPremiumTypeSubscription()),

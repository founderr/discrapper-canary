...
var a = i(735250), r = i(470079), o = i(120356), n = i.n(o), t = i(442837), s = i(780384), d = i(481060), c = i(239091), u = i(749210), f = i(410030), m = i(726542), v = i(367907), p = i(598077), h = i(314897), N = i(271383), R = i(430824), _ = i(153124), x = i(602623), C = i(626135), b = i(63063), j = i(134433), g = i(225104), k = i(981631), Z = i(689938), E = i(801118), I = i(171553);
            ...
            (0, a.jsxs)(d.ModalContent, {
                ...
                children: [
                    ...
                    (0, a.jsx)('div', {
                        ...
                        children: H.map(e => {
                            let o = L.roles.includes(e.id), t = function (e) {
                                    let i = M.find(l => {
                                        let {role_id: i} = l;
                                        return i === e;
                                    });
                                    ...
                                    for (let e of i.rules.flat()) {
                                        ...
                                        if (null != t)
                                            r[''.concat(e.connection_type, ':').concat(e.application_id)] = t;
                                    }
                            ...
                            return (0, a.jsxs)(d.Clickable, {
                                ...
                                onClick: o ? void 0 : () => {
                                    ...
                                    return r = e, o = l, void (0, d.openModalLazy)(async () => {
                                        let {default: e} = await i.e('38413').then(i.bind(i, 107807));
                                        return l => (0, a.jsx)(e, {
                                            role: r,
                                            guildId: o,
                                            ...l
                                ...
                                onContextMenu: o ? r => {
                                    var o, n, t;
                                    return o = l, n = e.id, t = r, void (0, c.jW)(t, async () => {

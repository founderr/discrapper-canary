...
class s {
    format(e) {
        let t = '';
        if (((t = i || null == this.options.signDisplay ? this.numberFormatter.format(e) : u(this.numberFormatter, this.options.signDisplay, e)), 'unit' === this.options.style && !a)) {
            var n;
    ...
    if (!e.includes('-nu-') && !r.isValidPartialNumber(n)) {
        for (let i of d)
            if (i !== r.options.numberingSystem) {
                let r = h(e + (e.includes('-u-') ? '-nu-' : '-u-nu-') + i, t);
...
function h(e, t) {
    let n =
            ...
            (t
                ...
                : ''),
        r = E.get(n);
    return !r && ((r = new p(e, t)), E.set(n, r)), r;
}
class p {
    parse(e) {
        ...
        if ('percent' === this.options.style) {
            ...
            return new _(this.locale, e).parse(new s(this.locale, e).format(n));
        }
    ...
    constructor(e, t = {}) {
        var n, r;
        (this.locale = e), (this.formatter = new Intl.NumberFormat(e, t)), (this.options = this.formatter.resolvedOptions()), (this.symbols = T(e, this.formatter, this.options, t)), 'percent' === this.options.style && ((null !== (n = this.options.minimumFractionDigits) && void 0 !== n ? n : 0) > 18 || (null !== (r = this.options.maximumFractionDigits) && void 0 !== r ? r : 0) > 18) && console.warn('NumberParser cannot handle percentages with greater than 18 decimal places, please reduce the number in your options.');
    }
}
let m = new Set(['decimal', 'fraction', 'integer', 'minusSign', 'plusSign', 'group']),
    I = [0, 4, 2, 1, 11, 20, 3, 7, 100, 21, 0.1, 1.1];
function T(e, t, n, r) {
    var i, a, o, s, l;
    ...
    let h =
            null ===
                ...
                ? void 0
                : o.value,
        p = null === (s = c.find((e) => 'group' === e.type)) || void 0 === s ? void 0 : s.value,
        T = [...new Set([...c.filter((e) => !m.has(e.type)).map((e) => S(e.value)), ..._.flatMap((e) => e.filter((e) => !m.has(e.type)).map((e) => S(e.value)))])].sort((e, t) => t.length - e.length),
        g = 0 === T.length ? RegExp('[\\p{White_Space}]', 'gu') : RegExp(`${T.join('|')}|[\\p{White_Space}]`, 'gu'),

...
function E(e, t) {
    let n = e + (t ? Object.entries(t).sort((e, t) => e[0] < t[0] ? -1 : 1).join() : ''), r = d.get(n);
...
class f {
    parse(e) {
        ...
        if (this.symbols.group && (t = m(t, this.symbols.group, '')), this.symbols.decimal && (t = t.replace(this.symbols.decimal, '.')), this.symbols.minusSign && (t = t.replace(this.symbols.minusSign, '-')), t = t.replace(this.symbols.numeral, this.symbols.index), 'percent' === this.options.style) {
            let e = t.indexOf('-'), n = (t = t.replace('-', '')).indexOf('.');
    ...
    constructor(e, t = {}) {
        ...
        this.locale = e, this.formatter = new Intl.NumberFormat(e, t), this.options = this.formatter.resolvedOptions(), this.symbols = function (e, t, n, r) {
            ...
            let u = new Intl.NumberFormat(e, {
                ...
                }), c = u.formatToParts(-10000.111), d = u.formatToParts(10000.111), _ = p.map(e => u.formatToParts(e)), E = null !== (l = null === (i = c.find(e => 'minusSign' === e.type)) || void 0 === i ? void 0 : i.value) && void 0 !== l ? l : '-', f = null === (a = d.find(e => 'plusSign' === e.type)) || void 0 === a ? void 0 : a.value;
            ...
            let m = null === (o = new Intl.NumberFormat(e, {
                ...
                }).formatToParts(0.001).find(e => 'decimal' === e.type)) || void 0 === o ? void 0 : o.value, T = null === (s = c.find(e => 'group' === e.type)) || void 0 === s ? void 0 : s.value, g = [...new Set([
                        ...c.filter(e => !h.has(e.type)).map(e => I(e.value)),
                        ..._.flatMap(e => e.filter(e => !h.has(e.type)).map(e => I(e.value)))
                    ])].sort((e, t) => t.length - e.length), S = 0 === g.length ? RegExp('[\\p{White_Space}]', 'gu') : RegExp(`${ g.join('|') }|[\\p{White_Space}]`, 'gu'), A = [...new Intl.NumberFormat(n.locale, { useGrouping: !1 }).format(9876543210)].reverse(), N = new Map(A.map((e, t) => [
                    e,
                    t
                ])), v = RegExp(`[${ A.join('') }]`, 'g');
            return {

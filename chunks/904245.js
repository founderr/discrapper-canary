...
var r = n(278074), i = n(544891), a = n(780384), o = n(570140), s = n(89892), l = n(673750), u = n(367907), c = n(287328), d = n(86670), _ = n(685736), E = n(849521), f = n(421474), h = n(970606), p = n(960904), m = n(830121), I = n(710845), T = n(163268), g = n(38618), S = n(687516), A = n(539573), N = n(826581), v = n(409059), O = n(264229), R = n(366980), C = n(779832), y = n(459618), D = n(893233), L = n(541288), b = n(3148), M = n(48854), P = n(785359), U = n(646504), w = n(64078), x = n(351780), G = n(79390), k = n(643266), B = n(617136);
n(807092);
var F = n(869765), V = n(926491), H = n(467798), Z = n(346479), Y = n(218543), j = n(199902), W = n(314897), K = n(592125);
n(323873);
var z = n(701190), q = n(375954), Q = n(496675), X = n(158776), $ = n(306680), J = n(300429), ee = n(594174);
n(626135);
var et = n(70956), en = n(630388), er = n(669079), ei = n(63063), ea = n(74538), eo = n(709054), es = n(668781), el = n(981631), eu = n(176505), ec = n(58346), ed = n(689938);
let e_ = new I.Z('MessageActionCreators'), eE = new I.Z('MessageQueue'), ef = !1;
class eh {
    markComplete() {
        this.completed = !0;
    }
...
let em = {
        ...
        sendClydeError(e) {
            let t, n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = K.Z.getChannel(e);
            if (null != i)
                r === el.evJ.SLOWMODE_RATE_LIMITED ? (t = ed.Z.Messages.CHANNEL_SLOWMODE_DESC.format({ seconds: i.rateLimitPerUser }), n = 'SLOWMODE_RATE_LIMITED') : r === el.evJ.INVALID_MESSAGE_SEND_USER ? (t = ed.Z.Messages.BOT_DM_SEND_FAILED_WITH_HELP_LINK.format({ helpUrl: ei.Z.getArticleURL(el.BhN.DM_COULD_NOT_BE_DELIVERED) }), n = 'INVALID_MESSAGE_SEND_USER') : r === el.evJ.TOO_MANY_THREADS ? (t = i.isForumLikeChannel() || i.isForumPost() ? ed.Z.Messages.BOT_DM_TOO_MANY_POSTS : ed.Z.Messages.BOT_DM_TOO_MANY_THREADS, n = 'TOO_MANY_THREADS') : r === el.evJ.TOO_MANY_ANNOUNCEMENT_THREADS ? (t = ed.Z.Messages.BOT_DM_TOO_MANY_ANNOUNCEMENT_THREADS, n = 'TOO_MANY_ANNOUNCEMENT_THREADS') : r === el.evJ.HARMFUL_LINK_MESSAGE_BLOCKED ? (t = ed.Z.Messages.HARMFUL_LINK_MESSAGE_BLOCKED_ERROR.format({ helpUrl: el.EYA.HARMFUL_LINKS }), n = 'HARMFUL_LINK_MESSAGE_BLOCKED') : r in em ? (n = em[r].messageName, t = em[r].messageGetter()) : (t = ed.Z.Messages.BOT_DM_SEND_FAILED_WITH_HELP_LINK.format({ helpUrl: ei.Z.getArticleURL(el.BhN.DM_COULD_NOT_BE_DELIVERED) }), n = 'SEND_FAILED ('.concat(r, ')')), eI.sendBotMessage(e, t, n);
        },
        ...
        fetchMessages(e) {
            ...
            s.Z.commit(m), o.Z.dispatch({ type: 'LOAD_MESSAGES' });
            let I = null == p ? void 0 : p.messageId, T = new eh();
            return !d && this.fetchLocalMessages(t, n, r, a, T), i.tn.get({
                ...
                let i = e.body, s = null != n, u = null != r, c = null == n && null == r, d = null != I || i.length === a && (s || c), E = null != I || u && i.length === a;
                if (null != I) {
                    let e = Math.floor(a / 2), n = [
                            I,
                            ...i.map(e => {
                                let {id: t} = e;
                                return t;
        ...
        async fetchLocalMessages(e, t, n, r, i) {
            let a = K.Z.getBasicChannel(e), l = s.Z.getOrCreate(e), u = c.Z.database();
        ...
        async fetchNewLocalMessages(e, t) {
            var n;
            let r = K.Z.getBasicChannel(e), i = c.Z.database();
            if (null == i || null == r)
                return;
            ...
            if (null == l)
                return;
            let u = null === (n = (a = s.Z.getOrCreate(e)).last()) || void 0 === n ? void 0 : n.id, E = null == u ? l.messages : l.messages.filter(e => eo.default.compare(e.id, u) > 0);
        ...
        _tryFetchMessagesCached(e) {
            ...
            if ((null == a ? void 0 : a.messageId) != null || (null == s ? void 0 : s.messageId) != null) {
                ...
                let e = (null == a ? void 0 : a.messageId) != null ? eo.default.extractTimestamp(null == a ? void 0 : a.messageId) : 0, n = u.first(), r = u.last();
        ...
        async sendMessage(e, t) {
            var n;
            let r = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
            if (t.reaction)
                return Promise.resolve();
            let a = await (0, k.Z)(e);
            if (null != a)
                return eI.sendMessage(a, t, r, i);
            let o = C.ZP.backgroundify(() => eI._sendMessage(e, t, i), void 0), s = null !== (n = i.nonce) && void 0 !== n ? n : (0, M.r)();
            return (i = {
                ...i,
                nonce: s
        ...
        sendStickers(e, t) {
            let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : '', r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4];
        ...
        _sendMessage(e, t, n) {
            ...
            let c = t.content, {
                    ...
                    allowedMentions: C,
                    poll: U
                } = n, F = null !== (i = n.flags) && void 0 !== i ? i : 0, [Z, Y] = (0, H.Z)(c);
            ...
            if ('' === c && null == T && null == O && null == U && !j)
                return Promise.resolve();
            let z = null != R ? el.uaV.REPLY : el.uaV.DEFAULT, q = null !== (a = n.nonce) && void 0 !== a ? a : (0, M.r)();
            ...
            if (!ef && null != d && d.length > 0) {
                ...
                d.some(e => e.animated) && !ea.ZP.canUseAnimatedEmojis(r) ? (t = ed.Z.Messages.INVALID_ANIMATED_EMOJI_BODY_UPGRADE, n = 'INVALID_ANIMATED_EMOJI_BODY') : Q.Z.canWithPartialContext(el.Plq.USE_EXTERNAL_EMOJIS, { channelId: e }) ? (t = ed.Z.Messages.INVALID_EXTERNAL_EMOJI_BODY_UPGRADE, n = 'INVALID_EXTERNAL_EMOJI_BODY_UPGRADE') : (t = ed.Z.Messages.INVALID_EXTERNAL_EMOJI_BODY, n = 'INVALID_EXTERNAL_EMOJI_BODY'), eI.sendBotMessage(e, t, n);
            }
            let X = {
                type: l.$V.SEND,
                message: {
            ...
            return null != U && (X.message.poll = U), null != O && (X.message.sticker_ids = O), x.Z.isEnabled() && (X.message.has_poggermode_enabled = !0), new Promise((t, r) => {
                let i = Date.now(), a = l.ZP.length, s = Math.floor(10000 * Math.random());
                eE.info('Queueing message to be sent LogId:'.concat(s)), l.ZP.enqueue(X, s => {
                    ...
                    if (s.ok) {
                        ...
                        let r = eo.default.cast(e), i = N.Z.getRequest(r);
                        if (null != i) {
                            let {
                                guildId: t,
                                userId: n,
                        ...
                        if (s.hasErr)
                            ...
                            if (s.body.code === el.evJ.SLOWMODE_RATE_LIMITED) {
                                ...
                                }) : s.body.code === el.evJ.POGGERMODE_TEMPORARILY_DISABLED ? o.Z.dispatch({ type: 'POGGERMODE_TEMPORARILY_DISABLED' }) : null != U || j || eI.sendClydeError(e, s.body.code);
                        }
                        ...
                        }), D.i.getCurrentConfig({ location: 'MessageActionCreators' }).enabled && l.ZP.cancelPendingSendRequests(e).forEach(e => {
        ...
        crosspostMessage: (e, t) => i.tn.post({
            ...
            let t;
            t = 429 === e.status ? ed.Z.Messages.PUBLISH_FOLLOWED_NEWS_FAIL_BODY.format({ retryAfter: Math.floor(e.body.retry_after / 60) }) : ed.Z.Messages.PUBLISH_FOLLOWED_NEWS_GENERIC_BODY, es.Z.show({

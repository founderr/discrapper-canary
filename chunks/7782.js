...
let A = e => {
    let {
      ...
      let s = t === (l.length > 3 ? 3 : l.length) - 1,
        r = (0, i.jsx)("img", {
          src: a,
          alt: "",
          className: Z.avatar
        }, t);
      return s ? r : (0, i.jsx)(C.ZP, {
  ...
  M = e => {
    ...
    let {
      ...
      userId: a,
      showingBanner: l
    } = e, s = null === (t = g.default.getUser(a)) || void 0 === t ? void 0 : t.bot, c = () => {
      o.Z.addRelationship({
        userId: a,
        context: {
...
t.Z = e => {
  let {
    ...
    channelId: r
  } = (0, d._)(), o = (0, s.e7)([c.Z], () => null != r && c.Z.isSpam(r), [r]), u = (0, s.e7)([E.Z], () => E.Z.getRelationshipType(t), [t]), p = n.id === r;

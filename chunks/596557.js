...
function g(e) {
    ...
    let g = (0, s.SE)(e),
        ...
        E = (0, d.FT)(a.C.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, null !== (t = null == e ? void 0 : e.id) && void 0 !== t ? t : u.lds),
        I = g && (f || _) && !E,
        C = r.useCallback(() => {
            var t;
            (0, d.Qd)(a.C.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, null !== (t = null == e ? void 0 : e.id) && void 0 !== t ? t : u.lds, !0, h.L.DISMISS);
        }, [e]),
        v = r.useRef(!1);
    r.useEffect(() => {
        if (I && !v.current) {

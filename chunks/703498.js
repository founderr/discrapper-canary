...
class c {
    ...
    static clone(t) {
        let e = new c();
        return t && (e._breadcrumbs = [...t._breadcrumbs], e._tags = { ...t._tags }, e._extra = { ...t._extra }, e._contexts = { ...t._contexts }, e._user = t._user, e._level = t._level, e._span = t._span, e._session = t._session, e._transactionName = t._transactionName, e._fingerprint = t._fingerprint, e._eventProcessors = [...t._eventProcessors], e._requestSession = t._requestSession, e._attachments = [...t._attachments], e._sdkProcessingMetadata = { ...t._sdkProcessingMetadata }, e._propagationContext = { ...t._propagationContext }), e;
    }
    addScopeListener(t) {
    ...
    setUser(t) {
        return this._user = t || {}, this._session && (0, s.CT)(this._session, { user: t }), this._notifyScopeListeners(), this;
    }
    getUser() {
        return this._user;
    }
    ...
    update(t) {
        ...
        return t instanceof c ? (this._tags = {
            ...
            ...this._contexts,
            ...t._contexts
        }, t._user && Object.keys(t._user).length && (this._user = t._user), t._level && (this._level = t._level), t._fingerprint && (this._fingerprint = t._fingerprint), t._requestSession && (this._requestSession = t._requestSession), t._propagationContext && (this._propagationContext = t._propagationContext)) : (0, n.PO)(t) && (this._tags = {
            ...this._tags,
            ...t.tags
        }, this._extra = {
            ...this._extra,
    ...
    applyToEvent(t, e = {}) {
        ...
        return this._applyFingerprint(t), t.breadcrumbs = [
            ...t.breadcrumbs || [],
            ...this._breadcrumbs
        ], t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0, t.sdkProcessingMetadata = {
            ...t.sdkProcessingMetadata,
    ...
    _notifyEventProcessors(t, e, r, _ = 0) {
        return new a.cW((a, o) => {
            let E = t[_];
            if (null === e || 'function' != typeof E)
                ...
                let s = E({ ...e }, r);
                ('undefined' == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && E.id && null === s && i.kg.log(`Event processor "${ E.id }" dropped event`), (0, n.J8)(s) ? s.then(e => this._notifyEventProcessors(t, e, r, _ + 1).then(a)).then(null, o) : this._notifyEventProcessors(t, s, r, _ + 1).then(a).then(null, o);
            }
        });
    }
...
function I() {
    return (0, E.YO)('globalEventProcessors', () => []);
}
function R(t) {
    I().push(t);
}

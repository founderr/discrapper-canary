...
function H(e, t) {
  ...
  function s() {
    [
      'interactive',
      'complete'
    ].includes(N.m9.document.readyState) && e.emit('idleSpanEnableAutoFinish', _);
  }
  return r && N.m9.document && (N.m9.document.addEventListener('readystatechange', () => {
    s();
  }), s()), _;
}
return {
  ...
  afterAllSetup(e) {
    ...
    e.on('startNavigationSpan', t => {
      if ((0, s.s3)() === e)
        r && !(0, c.XU)(r).timestamp && (d.X && u.kg.log(`[Tracing] Finishing current root span with op: ${ (0, c.XU)(r).op }`), r.end()), r = H(e, {
          op: 'navigation',
          ...t
        });
      ...
      let a = n.sentryTrace || h('sentry-trace'),
        ...
        i = (0, l.pT)(a, o);
      (0, s.nZ)().setPropagationContext(i), r = H(e, {
        op: 'pageload',
        ...t
      });
    }), e.on('spanEnd', e => {
      let t = (0, c.XU)(e).op;
      if (e !== (0, c.Gx)(e) || 'navigation' !== t && 'pageload' !== t)
        return;
      let r = (0, s.nZ)(),
    ...
    })), P && (0, p.j)(), T && function(e, t, r, n) {
      let a;
      N.m9.document && addEventListener('click', () => {

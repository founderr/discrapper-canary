...
function s(e) {
  n && clearTimeout(n), 'number' != typeof(n = setTimeout(async () => {
    n = void 0;
    let e = await _.shift();
    e && (t('Attempting to send previously queued event'), e[0].sent_at = new Date().toISOString(), I(e, !0).catch(e => {
...
async function I(e, n = !1) {
  if (!n && (0, a.R)(e, [
    ...
    return await _.push(e), s(100), {};
  try {
    let t = await i.send(e),
      r = 100;
    if (t) {
      if (t.headers && t.headers['retry-after'])
        r = (0, o.JY)(t.headers['retry-after']);
    ...
    var I, u, l;
    if (await (I = e, u = o, l = E, !(0, a.R)(I, ['client_report']) && (!r.shouldStore || r.shouldStore(I, u, l))))
      return n ? await _.unshift(e) : await _.push(e), c(), t('Error sending. Event queued.', o), {};
    throw o;
  }
}
return r.flushAtStartup && c(), {
  send: I,
  flush: e => i.flush(e)
};
  };

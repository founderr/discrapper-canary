...
function b(e) {
    var t;
    let { channel: n, isChannelSelected: b, isChannelCollapsed: A, voiceStates: R, enableConnectedUserLimit: M, enableActivities: L, isSubscriptionGated: P, needSubscriptionToAccess: O, isNewChannel: y, muted: j, resolvedUnreadSetting: D } = e,
    ...
    if (!j && D === v.i.ALL_MESSAGES && n.isForumLikeChannel() && null != V && V > 0)
        return (0, i.jsx)(a.Text, {
            ...
            color: 'text-brand',
            children: T.Z.Messages.CHANNEL_NEW_POSTS_LABEL.format({ count: (0, a.getBadgeCountString)(V) })
        });

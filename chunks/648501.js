...
function A(e) {
    var t;
    let { channel: n, isChannelSelected: A, isChannelCollapsed: b, voiceStates: R, enableConnectedUserLimit: M, enableActivities: L, isSubscriptionGated: P, needSubscriptionToAccess: O, isNewChannel: y, muted: D, resolvedUnreadSetting: j } = e,
    ...
    if (!D && j === v.i.ALL_MESSAGES && n.isForumLikeChannel() && null != H && H > 0)
        return (0, i.jsx)(a.Text, {
            variant: 'text-xs/semibold',
            color: 'text-brand',
            children: T.Z.Messages.CHANNEL_NEW_POSTS_LABEL.format({ count: (0, a.getBadgeCountString)(H) })
        });
    ...
    let z = null !== (t = null == R ? void 0 : R.length) && void 0 !== t ? t : 0;
    return null != M && M && V
        ? (0, i.jsx)(N.Z, {
              userCount: z,
              video: k || B,

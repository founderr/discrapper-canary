...
function R(e) {
  ...
  let {
    ...
    video: H || V,
    selected: R
  }), W = (0, a.useStateFromStores)([c.default], () => c.default.getNewThreadCount(n.guild_id, n.id)), Y = (0, o.useUnreadThreadsCountForParent)(n.guild_id, n.id), K = (0, a.useStateFromStores)([f.default], () => {
    var e, t;
  ...
  if (!G && U === L.UnreadSetting.ALL_MESSAGES && n.isForumLikeChannel() && null != W && W > 0) return (0, l.jsx)(i.Text, {
    variant: "text-xs/semibold",
    color: "text-brand",
    children: x.default.Messages.CHANNEL_NEW_POSTS_LABEL.format({
      count: (0, C.getBadgeCountString)(W)
    })
  });
  if (!G && n.isForumLikeChannel() && null != Y && Y > 0) return (0, l.jsx)(i.Text, {
    variant: "text-xs/semibold",
    color: "text-muted",

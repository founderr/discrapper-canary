var i = n(192379),
    ...
    d = n(440493);
t.Z = (e) => {
    let t = (0, l.e7)([a.Z], () => ((null == e ? void 0 : e.hasFeature(c.oNc.HUB)) ? a.Z.hasViewedPrompt(d.r.REAL_NAME_PROMPT, e.id) : null)),
    ...
    return (
        i.useEffect(() => {
            h && null != e && !1 === t && r.Z.viewPrompt(d.r.REAL_NAME_PROMPT, e.id);
        }, [h, e, t]),
        !1 === t && !h
    );
};

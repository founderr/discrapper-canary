...
function L(e) {
  ...
  return r.useEffect(() => {
  ...
  }, [H, R, b, U, k, B, S]), L = null != j ? j(T, G, v) : R ? (0, n.jsx)(u.PremiumSubscriptionGiftPurchaseConfirmation, {
    planId: T.id,
    onClose: G
  }) : O.current === T.id ? (0, n.jsx)(u.default, {
    planId: T.id,
    postSuccessGuild: P,
    onClose: G,
    ...
    planId: T.id,
    onClose: G,
    isDowngrade: null != g && (0, p.subscriptionCanDowngrade)(g, T.id, E),

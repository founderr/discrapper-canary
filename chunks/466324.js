...
var r = n(275857), i = n(470079), a = n(721535);
function o(e) {
    let {
            collection: t,
            focusMode: n
    ...
    return (0, i.useEffect)(() => {
        if (null != o.focusedKey && !t.getItem(o.focusedKey)) {
            let e;
            let n = c.current.getItem(o.focusedKey), i = null != n.parentKey && ('cell' === n.type || 'rowheader' === n.type || 'column' === n.type) ? c.current.getItem(n.parentKey) : n, a = c.current.rows, s = t.rows, l = a.length - s.length, d = Math.min(l > 1 ? Math.max(i.index - l + 1, 0) : i.index, s.length - 1);
            for (; d >= 0;) {
            ...
            if (e) {
                let a = e.hasChildNodes ? [...(0, r._P)(e, t)] : [], s = e.hasChildNodes && i !== n && n.index < a.length ? a[n.index].key : e.key;
                o.setFocusedKey(s);
            } else

    ...
    bR: function () {
        return function e(t, n) {
            ...
            i && !function (e) {
                ...
                (!(null != d && d.length > 0 && d.startsWith('?')) || d.startsWith('?') && d.split('?')[1] !== u) && (0, c.uL)(p.Z5c.GUILD_DISCOVERY, { search: u });
            }({
                query: t,
                preferredLocale: r,
                offset: d,
...
async function E(e) {
    ...
    try {
        let {guilds: t} = (await s.tn.get({
            url: p.ANM.GUILD_DISCOVERY,
            query: a.stringify({ categories: [e] }),
            oldFormErrors: !0
        })).body;
        o.Z.dispatch({

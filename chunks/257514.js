...
var a, n, i = s(735250), C = s(470079), _ = s(481060), o = s(355467), l = s(100527), r = s(906732), I = s(740492), N = s(153124), c = s(626135), A = s(171246), d = s(225715), S = s(635840), O = s(981631), E = s(689938), T = s(250965);
let u = e => {
...
function L(e) {
    let {
            ...
            guild: o,
            onClose: L
        } = e, P = (0, N.Dt)(), {analyticsLocations: R} = (0, r.ZP)(l.Z.APPLICATION_SUBSCRIPTION_CANCELLATION_MODAL), {
                                    ...
                                    (0, i.jsxs)(d.q$, {
                                        children: [
                                            ...
                                            (0, i.jsx)(d.K9, {
                                                ...
                                                description: M ? E.Z.Messages.APPLICATION_CANCEL_USER_SUBSCRIPTION_MODAL_DESCRIPTION.format({ timestamp: n.currentPeriodEnd.getTime() }) : E.Z.Messages.APPLICATION_CANCEL_GUILD_SUBSCRIPTION_MODAL_DESCRIPTION.format({

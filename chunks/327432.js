...
var g = () => {
    var e = {
        ...
        onChange: () => {},
        apply: (t) => {
            for (var n of J.pathRefs(e)) el.transform(n, t);
            for (var r of J.pointRefs(e)) ef.transform(r, t);
            for (var i of J.rangeRefs(e)) em.transform(i, t);
            var a,
                s,
                o = l.get(e) || [],
                d = u.get(e) || new Set(),
            ...
            if (eo.operationCanTransformPath(t)) for (var _ of ((a = []), (s = new Set()), o)) f(eo.transform(_, t));
            else (a = o), (s = d);
        ...
        deleteForward: (t) => {
            var { selection: n } = e;
            n && eh.isCollapsed(n) && eG.delete(e, { unit: t });
        },
        deleteFragment: (t) => {
            var { selection: n } = e;
            n && eh.isExpanded(n) && eG.delete(e, { reverse: 'backward' === t });
        },
        getFragment: () => {
            var { selection: t } = e;
        ...
        insertBreak: () => {
            eG.splitNodes(e, { always: !0 });
        },
        insertSoftBreak: () => {
            eG.splitNodes(e, { always: !0 });
        },
        insertFragment: (t) => {
            eG.insertFragment(e, t);
        },
        insertNode: (t) => {
            eG.insertNodes(e, t);
        },
        ...
        normalizeNode: (t) => {
            ...
            if (!ey.isText(n)) {
                ...
                for (var i = !J.isEditor(n) && W.isElement(n) && (e.isInline(n) || 0 === n.children.length || ey.isText(n.children[0]) || e.isInline(n.children[0])), a = 0, s = 0; s < n.children.length; s++, a++) {
                    var o = er.get(e, r);
                    if (!ey.isText(o)) {
                        var l = n.children[s],
                            u = o.children[a - 1],
        ...
        for (var c of r) {
            ...
            if (
                ...
                ((function (e, t) {
                    ...
                    !(l = n ? V(e.substring(0, o)) : V(e.substring(0, e.length - o)))) ||
                    ((function (e, t) {
                        return (e & t) != 0;
                    })(a, i.RI) &&
                        (function (e, t) {
                    ...
                    (a !== i.None &&
                        s !== i.None &&
                        (function (e, t) {
                            return -1 === Z.findIndex((n) => (e & n[0]) != 0 && (t & n[1]) != 0);
                        })(a, s)))
            )
                break;
            o += c.length;
...
var X = new WeakMap(),
    J = {
        ...
        hasBlocks: (e, t) => t.children.some((t) => W.isElement(t) && J.isBlock(e, t)),
        hasInlines: (e, t) => t.children.some((t) => ey.isText(t) || J.isInline(e, t)),
        ...
        *levels(e) {
            ...
            if ((null == a && (a = () => !0), !!n)) {
                ...
                for (var [l, u] of er.levels(e, o)) {
                    if (!!a(l, u)) {
                        if ((s.push([l, u]), !i && W.isElement(l) && J.isVoid(e, l))) break;
                    }
                }
                r && s.reverse(), yield* s;
            }
        ...
        marks(e) {
            ...
            if (t) return t;
            if (eh.isExpanded(n)) {
                var [r] = J.nodes(e, { match: ey.isText });
                if (!r) return {};
                var [i] = r;
                return E(i, K);
            }
            ...
            if (0 === a.offset) {
                ...
                if (!J.above(e, { match: (t) => W.isElement(t) && J.isVoid(e, t) && e.markableVoid(t) })) {
                    var u = J.above(e, { match: (t) => W.isElement(t) && J.isBlock(e, t) });
                    if (l && u) {
                        var [c, d] = l,
                            [, f] = u;
                        eo.isAncestor(f, d) && (o = c);
                    }
                }
            }
            return E(o, z);
        ...
        *nodes(e) {
            ...
            if ((!c && (c = () => !0), !!a)) {
                ...
                var _ = er.nodes(e, {
                        ...
                        pass: (t) => {
                            var [n] = t;
                            return !u && W.isElement(n) && J.isVoid(e, n);
                        }
                    }),
                    p = [];
                for (var [h, m] of _) {
        ...
        point(e, t) {
            ...
            if (eo.isPath(t)) {
                ...
                var o = er.get(e, i);
                if (!ey.isText(o)) throw Error('Cannot get the '.concat(r, ' point in the node at path [').concat(t, '] because it has no ').concat(r, ' text node.'));
                return {
                    path: i,
        ...
        *positions(e) {
            ...
            if (!!n) {
                ...
                for (var [h, m] of J.nodes(e, {
                    ...
                    if (W.isElement(h)) {
                        ...
                        if (J.hasInlines(e, h)) {
                            var g = eo.isAncestor(m, l.path) ? l : J.end(e, m),
                                E = eo.isAncestor(m, o.path) ? o : J.start(e, m);
                            (d = J.string(
                                e,
                                {
                                    anchor: E,
        ...
        void(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return J.above(e, Q(Q({}, t), {}, { match: (t) => W.isElement(t) && J.isVoid(e, t) }));
        },
    ...
    er = {
        ancestor(e, t) {
            var n = er.get(e, t);
            if (ey.isText(n)) throw Error('Cannot get the ancestor node at path ['.concat(t, '] because it refers to a text node instead: ').concat(eE.stringify(n)));
            return n;
        },
        *ancestors(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        ...
        child(e, t) {
            if (ey.isText(e)) throw Error('Cannot get the child of a text node: '.concat(eE.stringify(e)));
            var n = e.children[t];
            if (null == n) throw Error('Cannot get child at index `'.concat(t, '` in node: ').concat(eE.stringify(e)));
            return n;
        },
        *children(e, t) {
        ...
        descendant(e, t) {
            var n = er.get(e, t);
            if (J.isEditor(n)) throw Error('Cannot get the descendant node at path ['.concat(t, '] because it refers to the root editor node instead: ').concat(eE.stringify(n)));
            return n;
        },
        *descendants(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        ...
        *elements(e) {
        ...
        first(e, t) {
            for (var n = t.slice(), r = er.get(e, n); r && !ey.isText(r) && 0 !== r.children.length; ) {
                (r = r.children[0]), n.push(0);
            }
            return [r, n];
        },
        fragment(e, t) {
            if (ey.isText(e)) throw Error('Cannot get a fragment starting from a root text node: '.concat(eE.stringify(e)));
        ...
        get(e, t) {
            for (var n = e, r = 0; r < t.length; r++) {
                var i = t[r];
                if (ey.isText(n) || !n.children[i]) throw Error('Cannot find a descendant at path ['.concat(t, '] in node: ').concat(eE.stringify(e)));
                n = n.children[i];
            }
            return n;
        },
        ...
        isNode: (e) => ey.isText(e) || W.isElement(e) || J.isEditor(e),
        isNodeList(e) {
        ...
        leaf(e, t) {
            var n = er.get(e, t);
            if (!ey.isText(n)) throw Error('Cannot get the leaf node at path ['.concat(t, '] because it refers to a non-leaf node: ').concat(eE.stringify(n)));
            return n;
        },
        *levels(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        ...
        matches: (e, t) => (W.isElement(e) && W.isElementProps(t) && W.matches(e, t)) || (ey.isText(e) && ey.isTextProps(t) && ey.matches(e, t)),
        *nodes(e) {
            for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, { pass: n, reverse: r = !1 } = t, { from: i = [], to: a } = t, s = new Set(), o = [], l = e; !(a && (r ? eo.isBefore(o, a) : eo.isAfter(o, a))); ) {
                if ((!s.has(l) && (yield [l, o]), !s.has(l) && !ey.isText(l) && 0 !== l.children.length && (null == n || !1 === n([l, o])))) {
                    s.add(l);
        ...
        parent(e, t) {
            var n = eo.parent(t),
                r = er.get(e, n);
            if (ey.isText(r)) throw Error('Cannot get the parent of path ['.concat(t, '] because it does not exist in the root.'));
            return r;
        },
        string: (e) => (ey.isText(e) ? e.text : e.children.map(er.string).join('')),
        *texts(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            for (var [n, r] of er.nodes(e, t)) ey.isText(n) && (yield [n, r]);
        }
    };
function ei(e, t) {
    var n = Object.keys(e);
            ...
            switch (t.type) {
                ...
                case 'move_node':
                    ...
                    if (eo.isAncestor(d, r) || eo.equals(d, r)) {
                        var _ = f.slice();
                        return eo.endsBefore(d, f) && d.length < f.length && (_[d.length - 1] -= 1), _.concat(r.slice(d.length));
                    }
                    eo.isSibling(d, f) && (eo.isAncestor(f, r) || eo.equals(f, r)) ? (eo.endsBefore(d, r) ? (r[d.length - 1] -= 1) : (r[d.length - 1] += 1)) : eo.endsBefore(f, r) || eo.equals(f, r) || eo.isAncestor(f, r) ? (eo.endsBefore(d, r) && (r[d.length - 1] -= 1), (r[f.length - 1] += 1)) : eo.endsBefore(d, r) && (eo.equals(f, r) && (r[f.length - 1] += 1), (r[d.length - 1] -= 1));
            }
            return r;
        }
    },
    ...
    decorations(e, t) {
        ...
        for (var r of t) {
            ...
            for (var d of n) {
                ...
                if (u > _) {
                    var v = u - _;
                    (h = eS(eS({}, p), {}, { text: p.text.slice(0, v) })), (p = eS(eS({}, p), {}, { text: p.text.slice(v) }));
                }
        ...
        switch (n.type) {
            ...
            case 'insert_text':
                ...
                var f = er.leaf(e, u),
                    _ = f.text.slice(0, c),
                    p = f.text.slice(c);
                if (((f.text = _ + d + p), t)) for (var [h, m] of eh.points(t)) t[m] = ed.transform(h, n);
                break;
            case 'merge_node':
                var { path: g } = n,
                    E = er.get(e, g),
                ...
                if ((T.children.splice(b, 1), t)) for (var [S, y] of eh.points(t)) t[y] = ed.transform(S, n);
                break;
            case 'move_node':
                var { path: A, newPath: N } = n;
                if (eo.isAncestor(A, N)) throw Error('Cannot move a path ['.concat(A, '] to new path [').concat(N, '] because the destination is inside itself.'));
                var C = er.get(e, A),
                    R = er.parent(e, A),
                    O = A[A.length - 1];
                R.children.splice(O, 1);
                var D = eo.transform(A, n),
                    L = er.get(e, eo.parent(D)),
                    x = D[D.length - 1];
                if ((L.children.splice(x, 0, C), t)) for (var [w, P] of eh.points(t)) t[P] = ed.transform(w, n);
                break;
            case 'remove_node':
                var { path: M } = n,
                    k = M[M.length - 1];
                if ((er.parent(e, M).children.splice(k, 1), t))
                    for (var [U, B] of eh.points(t)) {
                        var G = ed.transform(U, n);
                        if (null != t && null != G) t[B] = G;
                        else {
                            var Z = void 0,
                                F = void 0;
                            for (var [V, j] of er.texts(e))
                                if (-1 === eo.compare(j, M)) Z = [V, j];
                                else {
                                    F = [V, j];
                                    break;
                                }
                            var H = !1;
                            Z && F && (H = eo.equals(F[1], M) ? !eo.hasPrevious(F[1]) : eo.common(Z[1], M).length < eo.common(F[1], M).length), Z && !H ? ((U.path = Z[1]), (U.offset = Z[0].text.length)) : F ? ((U.path = F[1]), (U.offset = 0)) : (t = null);
                        }
                    }
                break;
            case 'remove_text':
                ...
                if (((z.text = q + Q), t)) for (var [X, J] of eh.points(t)) t[J] = ed.transform(X, n);
                break;
            case 'set_node':
            ...
            case 'set_selection':
                ...
                if (null == el) t = el;
                    ...
                    if (null == t) {
                        if (!eh.isRange(el)) throw Error('Cannot apply an incomplete "set_selection" operation properties '.concat(eE.stringify(el), ' when there is no current selection.'));
                        t = eN({}, el);
                    }
                    for (var eu in el) {
                        var ec = el[eu];
...
var ex = (e, t) => {
        if (W.isElement(t)) return !!J.isVoid(e, t) || (1 === t.children.length && ex(e, t.children[0]));
    ...
    ew = (e, t) => {
        ...
        var [, n] = eh.edges(t),
            r = J.pointRef(e, n);
        return eG.delete(e, { at: t }), r.unref();
    },
    eP = (e, t) => {
        var [n] = J.node(e, t);
        return (e) => e === n;
            ...
            ),
            {
                insertNodes(e, t) {
                    ...
                    J.withoutNormalizing(e, () => {
                        ...
                        var [u] = t;
                        if ((!s && ((s = e.selection ? e.selection : e.children.length > 0 ? J.end(e, []) : [0]), (l = !0)), null == l && (l = !1), eh.isRange(s))) {
                            if ((!r && (s = J.unhangRange(e, s, { voids: i })), eh.isCollapsed(s))) s = s.anchor;
                            else {
                                var [, c] = eh.edges(s),
                                    d = J.pointRef(e, c);
                                eG.delete(e, { at: s }), (s = d.unref());
                            }
                        }
                        if (ed.isPoint(s)) {
                            null == o && (o = ey.isText(u) ? (e) => ey.isText(e) : e.isInline(u) ? (t) => ey.isText(t) || J.isInline(e, t) : (t) => W.isElement(t) && J.isBlock(e, t));
                            var [f] = J.nodes(e, {
                                at: s.path,
                                match: o,
                                mode: a,
                ...
                liftNodes(e) {
                    ...
                    J.withoutNormalizing(e, () => {
                        var { at: n = e.selection, mode: r = 'lowest', voids: i = !1 } = t,
                            { match: a } = t;
                        if ((null == a && (a = eo.isPath(n) ? eP(e, n) : (t) => W.isElement(t) && J.isBlock(e, t)), !!n))
                    ...
                    J.withoutNormalizing(e, () => {
                        ...
                        if (null == i) {
                            if (eo.isPath(a)) {
                                var [u] = J.parent(e, a);
                                i = (e) => u.children.includes(e);
                            } else i = (t) => W.isElement(t) && J.isBlock(e, t);
                        }
                        if ((!s && eh.isRange(a) && (a = J.unhangRange(e, a, { voids: o })), eh.isRange(a))) {
                            if (eh.isCollapsed(a)) a = a.anchor;
                            else {
                                var [, c] = eh.edges(a),
                                    d = J.pointRef(e, c);
                                eG.delete(e, { at: a }), (a = d.unref()), null == t.at && eG.select(e, a);
                            }
                        }
                        var [f] = J.nodes(e, {
                                at: a,
                        ...
                        if (0 !== h.length && 0 !== g.length) {
                            var v = eo.next(g),
                                I = eo.common(h, g),
                                T = eo.isSibling(h, g),
                                b = Array.from(J.levels(e, { at: h }), (e) => {
                                    var [t] = e;
                                    return t;
                                })
                                    .slice(I.length)
                                ...
                                y = S && J.pathRef(e, S[1]);
                            if (ey.isText(p) && ey.isText(m)) {
                                var A = E(p, eR);
                                (r = m.text.length), (n = A);
                            } else if (W.isElement(p) && W.isElement(m)) {
                                var A = E(p, eO);
                            ...
                            !T &&
                                ...
                                (W.isElement(m) && J.isEmpty(e, m)) || (ey.isText(m) && '' === m.text && 0 !== g[g.length - 1])
                                    ? eG.removeNodes(e, {
                                          at: g,
                                          voids: o
                                      })
                ...
                moveNodes(e, t) {
                    J.withoutNormalizing(e, () => {
                        var { to: n, at: r = e.selection, mode: i = 'lowest', voids: a = !1 } = t,
                            { match: s } = t;
                        if (!!r) {
                            null == s && (s = eo.isPath(r) ? eP(e, r) : (t) => W.isElement(t) && J.isBlock(e, t));
                            var o = J.pathRef(e, n);
                ...
                removeNodes(e) {
                    ...
                    J.withoutNormalizing(e, () => {
                        ...
                        if (!!a)
                            for (var o of (null == s && (s = eo.isPath(a) ? eP(e, a) : (t) => W.isElement(t) && J.isBlock(e, t)),
                            !n && eh.isRange(a) && (a = J.unhangRange(e, a, { voids: r })),
                            Array.from(
                                J.nodes(e, {
                                    at: a,
                                    match: s,
                ...
                setNodes(e, t) {
                    ...
                    J.withoutNormalizing(e, () => {
                        ...
                        if (!!i) {
                            if ((null == r && (r = eo.isPath(i) ? eP(e, i) : (t) => W.isElement(t) && J.isBlock(e, t)), !o && eh.isRange(i) && (i = J.unhangRange(e, i, { voids: c })), u && eh.isRange(i))) {
                                if (eh.isCollapsed(i) && J.leaf(e, i.anchor)[0].text.length > 0) return;
                            ...
                            J.nodes(e, {
                                ...
                                if (0 !== E.length) {
                                    var T = !1;
                                    for (var b in t) {
                                        if ('children' !== b && 'text' !== b) a(t[b], g[b]) && ((T = !0), g.hasOwnProperty(b) && (v[b] = g[b]), s ? null != t[b] && (I[b] = s(g[b], t[b])) : null != t[b] && (I[b] = t[b]));
                                    }
                                    T &&
                                        e.apply({
                                            type: 'set_node',
                ...
                splitNodes(e) {
                    ...
                    J.withoutNormalizing(e, () => {
                        ...
                        if ((null == s && (s = (t) => W.isElement(t) && J.isBlock(e, t)), eh.isRange(o) && (o = ew(e, o)), eo.isPath(o))) {
                            var c = o,
                                d = J.point(e, c),
                                [f] = J.parent(e, c);
                        ...
                        if (!!o) {
                            var _ = J.pointRef(e, o, { affinity: 'backward' });
                            try {
                                var [p] = J.nodes(e, {
                                    at: o,
                                    match: s,
                                ...
                                for (var [y, A] of J.levels(e, {
                                    ...
                                    var N = !1;
                                    if (A.length < T.length || 0 === A.length || (!a && W.isElement(y) && J.isVoid(e, y))) break;
                                    var C = _.current,
                                        R = J.isEnd(e, C, A);
                                    if (u || !_ || !J.isEdge(e, C, A)) {
                                        N = !0;
                                        var O = er.extractProps(y);
                                        e.apply({
                                            type: 'split_node',
                                            path: A,
                                            position: S,
                ...
                unwrapNodes(e) {
                    ...
                    J.withoutNormalizing(e, () => {
                        var { mode: n = 'lowest', split: r = !1, voids: i = !1 } = t,
                            { at: a = e.selection, match: s } = t;
                        if (!!a) {
                            null == s && (s = eo.isPath(a) ? eP(e, a) : (t) => W.isElement(t) && J.isBlock(e, t)), eo.isPath(a) && (a = J.range(e, a));
                            var o = eh.isRange(a) ? J.rangeRef(e, a) : null,
                                l = Array.from(
                                    J.nodes(e, {
                                        at: a,
                                        match: s,
                ...
                wrapNodes(e, t) {
                    ...
                    J.withoutNormalizing(e, () => {
                        ...
                        if (!!o) {
                            if ((null == s && (s = eo.isPath(o) ? eP(e, o) : e.isInline(t) ? (t) => (W.isElement(t) && J.isInline(e, t)) || ey.isText(t) : (t) => W.isElement(t) && J.isBlock(e, t)), i && eh.isRange(o))) {
                                var [l, u] = eh.edges(o),
                                ...
                                eG.splitNodes(e, {
                                    ...
                                    (o = c.unref()),
                                    null == n.at && eG.select(e, o);
                            }
                            for (var [, d] of Array.from(
                                J.nodes(e, {
                                    at: o,
                                    match: e.isInline(t) ? (t) => W.isElement(t) && J.isBlock(e, t) : (e) => J.isEditor(e),
                                    mode: 'lowest',
                                    voids: a
                                })
                            )) {
                                var f = eh.isRange(o) ? eh.intersection(o, J.range(e, d)) : o;
                                if (!!f) {
                                    var _ = Array.from(
                                        J.nodes(e, {
                                            at: f,
        ...
        ),
        {
            collapse(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    { selection: r } = e;
                if (!!r) {
                    if ('anchor' === n) eG.select(e, r.anchor);
                    else if ('focus' === n) eG.select(e, r.focus);
                    else if ('start' === n) {
                        var [i] = eh.edges(r);
                        eG.select(e, i);
                    } else if ('end' === n) {
            ...
            move(e) {
                ...
                if (!!n) {
                    ...
                    if (null == s || 'focus' === s) {
                        var f = a ? J.before(e, l, u) : J.after(e, l, u);
                        f && (c.focus = f);
                    }
                    eG.setSelection(e, c);
                }
            ...
            select(e, t) {
                ...
                if (!eh.isRange(t)) throw Error('When setting the selection and the current selection is `null` you must provide at least an `anchor` and `focus`, but you passed: '.concat(eE.stringify(t)));
                e.apply({
                    type: 'set_selection',
                    properties: n,
                    newProperties: t
            ...
            setPoint(e, t) {
                ...
                if (!!r) {
                    ...
                    var { anchor: a, focus: s } = r,
                        o = 'anchor' === i ? a : s;
                    eG.setSelection(e, { ['anchor' === i ? 'anchor' : 'focus']: ek(ek({}, o), t) });
                }
            },
            setSelection(e, t) {
                var { selection: n } = e,
            ...
            J.withoutNormalizing(e, () => {
                ...
                if ((eh.isRange(o) && eh.isCollapsed(o) && ((u = !0), (o = o.anchor)), ed.isPoint(o))) {
                    ...
                    if (!s && c) {
                        ...
                        var f = {
                            ...
                            _ = r ? J.before(e, o, f) || J.start(e, []) : J.after(e, o, f) || J.end(e, []);
                        (o = {
                            anchor: o,
                            focus: _
                        }),
                ...
                if (!eh.isCollapsed(o)) {
                    if (!l) {
                        var [, p] = eh.edges(o),
                            h = J.end(e, []);
                        !ed.equals(p, h) && (o = J.unhangRange(e, o, { voids: s }));
                    }
                    var [m, g] = eh.edges(o),
                        E = J.above(e, {
                            match: (t) => W.isElement(t) && J.isBlock(e, t),
                    ...
                    for (var C of J.nodes(e, {
                        ...
                        var [R, O] = C;
                        if (!n || 0 !== eo.compare(O, n)) ((!s && W.isElement(R) && J.isVoid(e, R)) || (!eo.isCommon(O, m.path) && !eo.isCommon(O, g.path))) && (N.push(C), (n = O));
                    }
                    ...
                    !T &&
                        ...
                        u && r && 'character' === i && w.length > 1 && w.match(/[\u0E00-\u0E7F]+/) && eG.insertText(e, w.slice(0, w.length - a));
                    var H = L.unref(),
                        Y = x.unref(),
                        K = r ? H || Y : Y || H;
                    null == t.at && K && eG.select(e, K);
                }
            });
        },
        insertFragment(e, t) {
            ...
            J.withoutNormalizing(e, () => {
                ...
                if (!s) return;
                if (eh.isRange(s)) {
                    if ((!i && (s = J.unhangRange(e, s, { voids: a })), eh.isCollapsed(s))) s = s.anchor;
                    else {
                        var [, o] = eh.edges(s);
                        if (!a && J.void(e, { at: o })) return;
                        var l = J.pointRef(e, o);
                        eG.delete(e, { at: s }), (s = l.unref());
                    }
                } else eo.isPath(s) && (s = J.start(e, s));
                if (!(!a && J.void(e, { at: s }))) {
                    var u = J.above(e, {
                        at: s,
                        match: (t) => W.isElement(t) && J.isInline(e, t),
                        mode: 'highest',
                        voids: a
                    });
                    if (u) {
                    ...
                    for (var T of er.nodes({ children: t }, { pass: I })) I(T) && v.push(T);
                    var b = [],
                        S = [],
                        y = [],
                        A = !0,
                        N = !1;
                    for (var [C] of v) W.isElement(C) && !e.isInline(C) ? ((A = !1), (N = !0), S.push(C)) : A ? b.push(C) : y.push(C);
                    var [R] = J.nodes(e, {
                            at: s,
                        ...
                        D = J.isStart(e, s, O),
                        L = J.isEnd(e, s, O),
                        x = J.pathRef(e, _ && !y.length ? eo.next(d) : d),
                        w = J.pathRef(e, L ? eo.next(O) : O);
                    eG.splitNodes(e, {
                        at: s,
                    ...
                    var P = J.pathRef(e, !D || (D && L) ? eo.next(O) : O);
                    if (
                        (eG.insertNodes(e, b, {
                            at: P.current,
                            match: (t) => ey.isText(t) || J.isInline(e, t),
                        ...
                        !n.at && (y.length > 0 && w.current ? (r = eo.previous(w.current)) : S.length > 0 && x.current ? (r = eo.previous(x.current)) : P.current && (r = eo.previous(P.current)), r))
                    ) {
                        var M = J.end(e, r);
                        eG.select(e, M);
                    }
        ...
        insertText(e, t) {
            ...
            J.withoutNormalizing(e, () => {
                var { voids: r = !1 } = n,
                    { at: i = e.selection } = n;
                if (!i) return;
                if ((eo.isPath(i) && (i = J.range(e, i)), eh.isRange(i))) {

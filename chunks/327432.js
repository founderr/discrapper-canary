...
var I = () => {
    var e = {
        ...
        onChange: () => {},
        apply: (t) => {
            for (var n of $.pathRefs(e)) el.transform(n, t);
            for (var r of $.pointRefs(e)) e_.transform(r, t);
            for (var i of $.rangeRefs(e)) ep.transform(i, t);
            var a,
                s,
                o = l.get(e) || [],
                d = u.get(e) || new Set(),
            ...
            if (eo.operationCanTransformPath(t)) for (var E of ((a = []), (s = new Set()), o)) _(eo.transform(E, t));
            else (a = o), (s = d);
        ...
        normalizeNode: (t) => {
            ...
            if (!eO.isText(n)) {
                ...
                for (var i = !$.isEditor(n) && W.isElement(n) && (e.isInline(n) || 0 === n.children.length || eO.isText(n.children[0]) || e.isInline(n.children[0])), a = 0, s = 0; s < n.children.length; s++, a++) {
                    var o = er.get(e, r);
                    if (!eO.isText(o)) {
                        var l = n.children[s],
                            u = o.children[a - 1],
                            c = s === n.children.length - 1;
                        if ((eO.isText(l) || (W.isElement(l) && e.isInline(l))) !== i)
                            eB.removeNodes(e, {
                                at: r.concat(a),
                                voids: !0
                            }),
        ...
        getDirtyPaths: (e) => {
            switch (e.type) {
                ...
                case 'move_node':
                    ...
                    if (eo.equals(a, s)) return [];
                    var o = [],
                        l = [];
                    for (var u of eo.ancestors(a)) {
                        var c = eo.transform(u, e);
                        o.push(c);
                    }
                    for (var d of eo.ancestors(s)) {
                        var _ = eo.transform(d, e);
                        l.push(_);
                    }
                    var E = l[l.length - 1],
                        f = s[s.length - 1];
                    return [...o, ...l, E.concat(f)];
                case 'remove_node':
                    var { path: h } = e;
        ...
        for (var c of r) {
            ...
            if (
                ...
                ((function (e, t) {
                    ...
                    !(l = n ? H(e.substring(0, o)) : H(e.substring(0, e.length - o)))) ||
                    ((function (e, t) {
                        return (e & t) != 0;
                    })(a, i.RI) &&
                        (function (e, t) {
                        ...
                        !(u = null !== u ? !u : !!n || Y(e.substring(0, e.length - o)))) ||
                    (a !== i.None &&
                        s !== i.None &&
                        (function (e, t) {
...
var y = /^(?:[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0902\u093A\u093C\u0941-\u0948\u094D\u0951-\u0957\u0962\u0963\u0981\u09BC\u09BE\u09C1-\u09C4\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01\u0A02\u0A3C\u0A41\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81\u0A82\u0ABC\u0AC1-\u0AC5\u0AC7\u0AC8\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01\u0B3C\u0B3E\u0B3F\u0B41-\u0B44\u0B4D\u0B55-\u0B57\u0B62\u0B63\u0B82\u0BBE\u0BC0\u0BCD\u0BD7\u0C00\u0C04\u0C3E-\u0C40\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81\u0CBC\u0CBF\u0CC2\u0CC6\u0CCC\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00\u0D01\u0D3B\u0D3C\u0D3E\u0D41-\u0D44\u0D4D\u0D57\u0D62\u0D63\u0D81\u0DCA\u0DCF\u0DD2-\u0DD4\u0DD6\u0DDF\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F71-\u0F7E\u0F80-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102D-\u1030\u1032-\u1037\u1039\u103A\u103D\u103E\u1058\u1059\u105E-\u1060\u1071-\u1074\u1082\u1085\u1086\u108D\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4\u17B5\u17B7-\u17BD\u17C6\u17C9-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193B\u1A17\u1A18\u1A1B\u1A56\u1A58-\u1A5E\u1A60\u1A62\u1A65-\u1A6C\u1A73-\u1A7C\u1A7F\u1AB0-\u1AC0\u1B00-\u1B03\u1B34-\u1B3A\u1B3C\u1B42\u1B6B-\u1B73\u1B80\u1B81\u1BA2-\u1BA5\u1BA8\u1BA9\u1BAB-\u1BAD\u1BE6\u1BE8\u1BE9\u1BED\u1BEF-\u1BF1\u1C2C-\u1C33\u1C36\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE0\u1CE2-\u1CE8\u1CED\u1CF4\u1CF8\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u200C\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA825\uA826\uA82C\uA8C4\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA951\uA980-\uA982\uA9B3\uA9B6-\uA9B9\uA9BC\uA9BD\uA9E5\uAA29-\uAA2E\uAA31\uAA32\uAA35\uAA36\uAA43\uAA4C\uAA7C\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEC\uAAED\uAAF6\uABE5\uABE8\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F\uFF9E\uFF9F]|\uD800[\uDDFD\uDEE0\uDF76-\uDF7A]|\uD802[\uDE01-\uDE03\uDE05\uDE06\uDE0C-\uDE0F\uDE38-\uDE3A\uDE3F\uDEE5\uDEE6]|\uD803[\uDD24-\uDD27\uDEAB\uDEAC\uDF46-\uDF50]|\uD804[\uDC01\uDC38-\uDC46\uDC7F-\uDC81\uDCB3-\uDCB6\uDCB9\uDCBA\uDD00-\uDD02\uDD27-\uDD2B\uDD2D-\uDD34\uDD73\uDD80\uDD81\uDDB6-\uDDBE\uDDC9-\uDDCC\uDDCF\uDE2F-\uDE31\uDE34\uDE36\uDE37\uDE3E\uDEDF\uDEE3-\uDEEA\uDF00\uDF01\uDF3B\uDF3C\uDF3E\uDF40\uDF57\uDF66-\uDF6C\uDF70-\uDF74]|\uD805[\uDC38-\uDC3F\uDC42-\uDC44\uDC46\uDC5E\uDCB0\uDCB3-\uDCB8\uDCBA\uDCBD\uDCBF\uDCC0\uDCC2\uDCC3\uDDAF\uDDB2-\uDDB5\uDDBC\uDDBD\uDDBF\uDDC0\uDDDC\uDDDD\uDE33-\uDE3A\uDE3D\uDE3F\uDE40\uDEAB\uDEAD\uDEB0-\uDEB5\uDEB7\uDF1D-\uDF1F\uDF22-\uDF25\uDF27-\uDF2B]|\uD806[\uDC2F-\uDC37\uDC39\uDC3A\uDD30\uDD3B\uDD3C\uDD3E\uDD43\uDDD4-\uDDD7\uDDDA\uDDDB\uDDE0\uDE01-\uDE0A\uDE33-\uDE38\uDE3B-\uDE3E\uDE47\uDE51-\uDE56\uDE59-\uDE5B\uDE8A-\uDE96\uDE98\uDE99]|\uD807[\uDC30-\uDC36\uDC38-\uDC3D\uDC3F\uDC92-\uDCA7\uDCAA-\uDCB0\uDCB2\uDCB3\uDCB5\uDCB6\uDD31-\uDD36\uDD3A\uDD3C\uDD3D\uDD3F-\uDD45\uDD47\uDD90\uDD91\uDD95\uDD97\uDEF3\uDEF4]|\uD81A[\uDEF0-\uDEF4\uDF30-\uDF36]|\uD81B[\uDF4F\uDF8F-\uDF92\uDFE4]|\uD82F[\uDC9D\uDC9E]|\uD834[\uDD65\uDD67-\uDD69\uDD6E-\uDD72\uDD7B-\uDD82\uDD85-\uDD8B\uDDAA-\uDDAD\uDE42-\uDE44]|\uD836[\uDE00-\uDE36\uDE3B-\uDE6C\uDE75\uDE84\uDE9B-\uDE9F\uDEA1-\uDEAF]|\uD838[\uDC00-\uDC06\uDC08-\uDC18\uDC1B-\uDC21\uDC23\uDC24\uDC26-\uDC2A\uDD30-\uDD36\uDEEC-\uDEEF]|\uD83A[\uDCD0-\uDCD6\uDD44-\uDD4A]|\uD83C[\uDFFB-\uDFFF]|\uDB40[\uDC20-\uDC7F\uDD00-\uDDEF])$/,
    D = /^(?:[\u0600-\u0605\u06DD\u070F\u0890\u0891\u08E2\u0D4E]|\uD804[\uDCBD\uDCCD\uDDC2\uDDC3]|\uD806[\uDD3F\uDD41\uDE3A\uDE84-\uDE89]|\uD807\uDD46)$/,
    b = /^(?:[\u0903\u093B\u093E-\u0940\u0949-\u094C\u094E\u094F\u0982\u0983\u09BF\u09C0\u09C7\u09C8\u09CB\u09CC\u0A03\u0A3E-\u0A40\u0A83\u0ABE-\u0AC0\u0AC9\u0ACB\u0ACC\u0B02\u0B03\u0B40\u0B47\u0B48\u0B4B\u0B4C\u0BBF\u0BC1\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCC\u0C01-\u0C03\u0C41-\u0C44\u0C82\u0C83\u0CBE\u0CC0\u0CC1\u0CC3\u0CC4\u0CC7\u0CC8\u0CCA\u0CCB\u0D02\u0D03\u0D3F\u0D40\u0D46-\u0D48\u0D4A-\u0D4C\u0D82\u0D83\u0DD0\u0DD1\u0DD8-\u0DDE\u0DF2\u0DF3\u0E33\u0EB3\u0F3E\u0F3F\u0F7F\u1031\u103B\u103C\u1056\u1057\u1084\u1715\u1734\u17B6\u17BE-\u17C5\u17C7\u17C8\u1923-\u1926\u1929-\u192B\u1930\u1931\u1933-\u1938\u1A19\u1A1A\u1A55\u1A57\u1A6D-\u1A72\u1B04\u1B3B\u1B3D-\u1B41\u1B43\u1B44\u1B82\u1BA1\u1BA6\u1BA7\u1BAA\u1BE7\u1BEA-\u1BEC\u1BEE\u1BF2\u1BF3\u1C24-\u1C2B\u1C34\u1C35\u1CE1\u1CF7\uA823\uA824\uA827\uA880\uA881\uA8B4-\uA8C3\uA952\uA953\uA983\uA9B4\uA9B5\uA9BA\uA9BB\uA9BE-\uA9C0\uAA2F\uAA30\uAA33\uAA34\uAA4D\uAAEB\uAAEE\uAAEF\uAAF5\uABE3\uABE4\uABE6\uABE7\uABE9\uABEA\uABEC]|\uD804[\uDC00\uDC02\uDC82\uDCB0-\uDCB2\uDCB7\uDCB8\uDD2C\uDD45\uDD46\uDD82\uDDB3-\uDDB5\uDDBF\uDDC0\uDDCE\uDE2C-\uDE2E\uDE32\uDE33\uDE35\uDEE0-\uDEE2\uDF02\uDF03\uDF3F\uDF41-\uDF44\uDF47\uDF48\uDF4B-\uDF4D\uDF62\uDF63]|\uD805[\uDC35-\uDC37\uDC40\uDC41\uDC45\uDCB1\uDCB2\uDCB9\uDCBB\uDCBC\uDCBE\uDCC1\uDDB0\uDDB1\uDDB8-\uDDBB\uDDBE\uDE30-\uDE32\uDE3B\uDE3C\uDE3E\uDEAC\uDEAE\uDEAF\uDEB6\uDF26]|\uD806[\uDC2C-\uDC2E\uDC38\uDD31-\uDD35\uDD37\uDD38\uDD3D\uDD40\uDD42\uDDD1-\uDDD3\uDDDC-\uDDDF\uDDE4\uDE39\uDE57\uDE58\uDE97]|\uD807[\uDC2F\uDC3E\uDCA9\uDCB1\uDCB4\uDD8A-\uDD8E\uDD93\uDD94\uDD96\uDEF5\uDEF6]|\uD81B[\uDF51-\uDF87\uDFF0\uDFF1]|\uD834[\uDD66\uDD6D])$/,
    M = /^[\u1100-\u115F\uA960-\uA97C]$/,
    P = /^[\u1160-\u11A7\uD7B0-\uD7C6]$/,
    U = /^[\u11A8-\u11FF\uD7CB-\uD7FB]$/,
    ...
    k = (e, t) => {
        var n = i.Any;
        return -1 !== e.search(y) && (n |= i.Extend), 8205 === t && (n |= i.ZWJ), t >= 127462 && t <= 127487 && (n |= i.RI), -1 !== e.search(D) && (n |= i.Prepend), -1 !== e.search(b) && (n |= i.SpacingMark), -1 !== e.search(M) && (n |= i.L), -1 !== e.search(P) && (n |= i.V), -1 !== e.search(U) && (n |= i.T), -1 !== e.search(w) && (n |= i.LV), -1 !== e.search(x) && (n |= i.LVT), -1 !== e.search(G) && (n |= i.ExtPict), n;
    };
function B(e, t) {
    return (e & t) != 0;
}
var F = [
    ...
    j = (e) => (0, a.P)(e) && er.isNodeList(e.children) && !$.isEditor(e),
    W = {
...
var X = new WeakMap(),
    $ = {
        above(e) {
            ...
            if (!!i) {
                ...
                for (var [o, l] of $.levels(e, {
                    ...
                    if (!eO.isText(o)) {
                        if (eh.isRange(i)) {
                            if (eo.isAncestor(l, i.anchor.path) && eo.isAncestor(l, i.focus.path)) return [o, l];
                        } else if (!eo.equals(s, l)) return [o, l];
                    }
            }
        },
        addMark(e, t, n) {
        ...
        after(e, t) {
            var n,
                ...
                i = $.point(e, t, { edge: 'end' }),
                a = $.end(e, []),
                { distance: s = 1 } = r,
                o = 0;
            for (var l of $.positions(
                e,
                Q(
                    Q({}, r),
                    {},
        ...
        hasInlines: (e, t) => t.children.some((t) => eO.isText(t) || $.isInline(e, t)),
        ...
        isEmpty(e, t) {
            var { children: n } = t,
                [r] = n;
            return 0 === n.length || (1 === n.length && eO.isText(r) && '' === r.text && !e.isVoid(t));
        },
        ...
        *levels(e) {
            ...
            if ((null == a && (a = () => !0), !!n)) {
                var s = [],
                    o = $.path(e, n);
                for (var [l, u] of er.levels(e, o)) {
                    if (!!a(l, u)) {
                        if ((s.push([l, u]), !i && W.isElement(l) && $.isVoid(e, l))) break;
                    }
                }
                r && s.reverse(), yield* s;
            }
        ...
        *nodes(e) {
            ...
            if ((!c && (c = () => !0), !!a)) {
                ...
                for (var [h, p] of E) {
                    ...
                    if ('highest' !== s || !I) {
                        ...
                        var m = 'lowest' === s ? r : [h, p];
                        m && (o ? f.push(m) : yield m), (r = [h, p]);
                    }
                }
                'lowest' === s && r && (o ? f.push(r) : yield r), o && (yield* f);
            }
        },
        normalize(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            if (!$.isNormalizing(e)) return;
            if (n) {
                var o = Array.from(er.nodes(e), (e) => {
                        var [, t] = e;
                        return t;
                    }),
                    c = new Set(o.map((e) => e.join(',')));
                l.set(e, o), u.set(e, c);
            }
            if (0 !== i(e).length)
        ...
        path(e, t) {
            ...
            return eh.isRange(t) && (t = 'start' === i ? eh.start(t) : 'end' === i ? eh.end(t) : eo.common(t.anchor.path, t.focus.path)), ed.isPoint(t) && (t = t.path), null != r && (t = t.slice(0, r)), t;
        },
        ...
        point(e, t) {
            ...
            if (eo.isPath(t)) {
                ...
                var o = er.get(e, i);
                if (!eO.isText(o)) throw Error('Cannot get the '.concat(r, ' point in the node at path [').concat(t, '] because it has no ').concat(r, ' text node.'));
                return {
                    path: i,
        ...
        *positions(e) {
            ...
            if (!!n) {
                ...
                for (var [h, p] of $.nodes(e, {
                    ...
                    if (eO.isText(h)) {
                        var S = eo.equals(p, u.path);
                        for (
                            S ? ((E = i ? u.offset : h.text.length - u.offset), (f = u.offset)) : ((E = h.text.length), (f = i ? E : 0)),
                                (S || c || 'offset' === r) &&
                                    (yield {
                                        path: p,
                                        offset: f
        ...
        string(e, t) {
            ...
            for (var [l, u] of $.nodes(e, {
                ...
                var c = l.text;
                eo.equals(u, s.path) && (c = c.slice(0, s.offset)), eo.equals(u, a.path) && (c = c.slice(a.offset)), (o += c);
            }
            return o;
        },
        unhangRange(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                { voids: r = !1 } = n,
                [i, a] = eh.edges(t);
            if (0 !== i.offset || 0 !== a.offset || eh.isCollapsed(t) || eo.hasPrevious(a.path)) return t;
            var s = $.above(e, {
                    at: a,
    ...
    er = {
        ancestor(e, t) {
            var n = er.get(e, t);
            if (eO.isText(n)) throw Error('Cannot get the ancestor node at path ['.concat(t, '] because it refers to a text node instead: ').concat(em.stringify(n)));
            return n;
        },
        *ancestors(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        ...
        child(e, t) {
            if (eO.isText(e)) throw Error('Cannot get the child of a text node: '.concat(em.stringify(e)));
            var n = e.children[t];
            if (null == n) throw Error('Cannot get child at index `'.concat(t, '` in node: ').concat(em.stringify(e)));
            return n;
        },
        *children(e, t) {
            for (var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, { reverse: r = !1 } = n, i = er.ancestor(e, t), { children: a } = i, s = r ? a.length - 1 : 0; r ? s >= 0 : s < a.length; ) {
                var o = er.child(i, s),
                    l = t.concat(s);
        ...
        descendant(e, t) {
            var n = er.get(e, t);
            if ($.isEditor(n)) throw Error('Cannot get the descendant node at path ['.concat(t, '] because it refers to the root editor node instead: ').concat(em.stringify(n)));
            return n;
        },
        *descendants(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        ...
        *elements(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            for (var [n, r] of er.nodes(e, t)) W.isElement(n) && (yield [n, r]);
        },
        extractProps(e) {
            if (W.isAncestor(e)) {
                var t = m(e, ee);
        ...
        first(e, t) {
            for (var n = t.slice(), r = er.get(e, n); r && !eO.isText(r) && 0 !== r.children.length; ) {
                (r = r.children[0]), n.push(0);
            }
            return [r, n];
        },
        fragment(e, t) {
            if (eO.isText(e)) throw Error('Cannot get a fragment starting from a root text node: '.concat(em.stringify(e)));
        ...
        get(e, t) {
            for (var n = e, r = 0; r < t.length; r++) {
                var i = t[r];
                if (eO.isText(n) || !n.children[i]) throw Error('Cannot find a descendant at path ['.concat(t, '] in node: ').concat(em.stringify(e)));
                n = n.children[i];
            }
            return n;
        },
        has(e, t) {
            for (var n = e, r = 0; r < t.length; r++) {
                var i = t[r];
                if (eO.isText(n) || !n.children[i]) return !1;
                n = n.children[i];
            }
            return !0;
        },
        isNode: (e) => eO.isText(e) || W.isElement(e) || $.isEditor(e),
        isNodeList(e) {
        ...
        leaf(e, t) {
            var n = er.get(e, t);
            if (!eO.isText(n)) throw Error('Cannot get the leaf node at path ['.concat(t, '] because it refers to a non-leaf node: ').concat(em.stringify(n)));
            return n;
        },
        *levels(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
        ...
        *nodes(e) {
            for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, { pass: n, reverse: r = !1 } = t, { from: i = [], to: a } = t, s = new Set(), o = [], l = e; !(a && (r ? eo.isBefore(o, a) : eo.isAfter(o, a))); ) {
                if ((!s.has(l) && (yield [l, o]), !s.has(l) && !eO.isText(l) && 0 !== l.children.length && (null == n || !1 === n([l, o])))) {
                    s.add(l);
                    var u = r ? l.children.length - 1 : 0;
                    eo.isAncestor(o, i) && (u = i[o.length]), (o = o.concat(u)), (l = er.get(e, o));
                    continue;
                }
                if (0 === o.length) break;
                if (!r) {
                ...
                if (r && 0 !== o[o.length - 1]) {
                    (o = eo.previous(o)), (l = er.get(e, o));
                    continue;
                }
                (o = eo.parent(o)), (l = er.get(e, o)), s.add(l);
            }
        },
        parent(e, t) {
            var n = eo.parent(t),
                r = er.get(e, n);
            if (eO.isText(r)) throw Error('Cannot get the parent of path ['.concat(t, '] because it does not exist in the root.'));
            return r;
        },
        string: (e) => (eO.isText(e) ? e.text : e.children.map(er.string).join('')),
        *texts(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            for (var [n, r] of er.nodes(e, t)) eO.isText(n) && (yield [n, r]);
        }
    };
function ei(e, t) {
    var n = Object.keys(e);
...
var es = {
        ...
        isOperation(e) {
            ...
            switch (e.type) {
                ...
                case 'merge_node':
                    return 'number' == typeof e.position && eo.isPath(e.path) && (0, a.P)(e.properties);
                case 'move_node':
                    return eo.isPath(e.path) && eo.isPath(e.newPath);
                case 'set_node':
                    return eo.isPath(e.path) && (0, a.P)(e.properties) && (0, a.P)(e.newProperties);
                case 'set_selection':
                ...
                case 'split_node':
                    return eo.isPath(e.path) && 'number' == typeof e.position && (0, a.P)(e.properties);
                default:
                    return !1;
            }
        },
    ...
    eo = {
        ...
        transform(e, t) {
            ...
            switch (t.type) {
                ...
                case 'remove_node':
                    var { path: s } = t;
                    if (eo.equals(s, r) || eo.isAncestor(s, r)) return null;
                    eo.endsBefore(s, r) && (r[s.length - 1] -= 1);
                    break;
                case 'merge_node':
                    var { path: o, position: l } = t;
                    eo.equals(o, r) || eo.endsBefore(o, r) ? (r[o.length - 1] -= 1) : eo.isAncestor(o, r) && ((r[o.length - 1] -= 1), (r[o.length] += l));
                    break;
                case 'split_node':
                    ...
                    } else eo.endsBefore(u, r) ? (r[u.length - 1] += 1) : eo.isAncestor(u, r) && e[u.length] >= c && ((r[u.length - 1] += 1), (r[u.length] -= c));
                    break;
                case 'move_node':
                    ...
                    if (eo.isAncestor(d, r) || eo.equals(d, r)) {
                        var E = _.slice();
                        return eo.endsBefore(d, _) && d.length < _.length && (E[d.length - 1] -= 1), E.concat(r.slice(d.length));
                    }
                    eo.isSibling(d, _) && (eo.isAncestor(_, r) || eo.equals(_, r)) ? (eo.endsBefore(d, r) ? (r[d.length - 1] -= 1) : (r[d.length - 1] += 1)) : eo.endsBefore(_, r) || eo.equals(_, r) || eo.isAncestor(_, r) ? (eo.endsBefore(d, r) && (r[d.length - 1] -= 1), (r[_.length - 1] += 1)) : eo.endsBefore(d, r) && (eo.equals(_, r) && (r[_.length - 1] += 1), (r[d.length - 1] -= 1));
            }
            return r;
        }
    },
...
var ed = {
        ...
        isPoint: (e) => (0, a.P)(e) && 'number' == typeof e.offset && eo.isPath(e.path),
        transform(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            return (0, s.Uy)(e, (e) => {
                ...
                switch (t.type) {
                    ...
                    case 'move_node':
                        ...
                        break;
                    case 'insert_text':
                        eo.equals(t.path, i) && (t.offset < a || (t.offset === a && 'forward' === r)) && (e.offset += t.text.length);
                        break;
                    case 'merge_node':
                    ...
                    case 'split_node':
                        if (eo.equals(t.path, i)) {
                            ...
                            (t.position < a || (t.position === a && 'forward' === r)) && ((e.offset -= t.position), (e.path = eo.transform(i, t, ec(ec({}, n), {}, { affinity: 'forward' }))));
...
var eh = {
        ...
        intersection(e, t) {
            var n = m(e, eE),
                ...
                u = ed.isBefore(i, s) ? i : s;
            return ed.isBefore(u, l)
                ? null
                : (function (e) {
                      for (var t = 1; t < arguments.length; t++) {
                          var n = null != arguments[t] ? arguments[t] : {};
        ...
        transform(e, t) {
            ...
            return (0, s.Uy)(e, (e) => {
                ...
                var r,
                    ...
                    { affinity: a = 'inward' } = n;
                if ('inward' === a) {
                    var s = eh.isCollapsed(e);
                    eh.isForward(e) ? ((r = 'forward'), (i = s ? r : 'backward')) : ((r = 'backward'), (i = s ? r : 'forward'));
                } else 'outward' === a ? (eh.isForward(e) ? ((r = 'backward'), (i = 'forward')) : ((r = 'forward'), (i = 'backward'))) : ((r = a), (i = a));
                var o = ed.transform(e.anchor, t, { affinity: r }),
                    l = ed.transform(e.focus, t, { affinity: i });
                if (!o || !l) return null;
    ...
    eT = (e, t) => {
        for (var n in e) {
            ...
            if ((0, a.P)(r) && (0, a.P)(i)) {
                ...
                for (var s = 0; s < r.length; s++) if (r[s] !== i[s]) return !1;
...
var eO = {
    equals(e, t) {
        ...
        return eT(r ? m(e, eS) : e, r ? m(t, eS) : t);
    },
    ...
    decorations(e, t) {
        ...
        for (var r of t) {
            ...
            for (var d of n) {
                ...
                if (c < l) {
                    var I = c - E;
                    (p = eN(eN({}, f), {}, { text: f.text.slice(I) })), (f = eN(eN({}, f), {}, { text: f.text.slice(0, I) }));
                }
                if (u > E) {
                    var T = u - E;
                    (h = eN(eN({}, f), {}, { text: f.text.slice(0, T) })), (f = eN(eN({}, f), {}, { text: f.text.slice(T) }));
                }
                Object.assign(f, i), h && o.push(h), o.push(f), p && o.push(p);
            }
            n = o;
        }
        return n;
...
var eC = (e, t, n) => {
        switch (n.type) {
            case 'insert_node':
                ...
                if ((a.children.splice(s, 0, i), t)) for (var [o, l] of eh.points(t)) t[l] = ed.transform(o, n);
                break;
            case 'insert_text':
                ...
                var _ = er.leaf(e, u),
                    E = _.text.slice(0, c),
                    f = _.text.slice(c);
                if (((_.text = E + d + f), t)) for (var [h, p] of eh.points(t)) t[p] = ed.transform(h, n);
                break;
            case 'merge_node':
                var { path: I } = n,
                    m = er.get(e, I),
                    ...
                    g = er.parent(e, I),
                    A = I[I.length - 1];
                if (eO.isText(m) && eO.isText(S)) S.text += m.text;
                else if (eO.isText(m) || eO.isText(S)) throw Error('Cannot apply a "merge_node" operation at path ['.concat(I, '] to nodes of different interfaces: ').concat(em.stringify(m), ' ').concat(em.stringify(S)));
                else S.children.push(...m.children);
                if ((g.children.splice(A, 1), t)) for (var [N, O] of eh.points(t)) t[O] = ed.transform(N, n);
                break;
            case 'move_node':
                var { path: R, newPath: v } = n;
                if (eo.isAncestor(R, v)) throw Error('Cannot move a path ['.concat(R, '] to new path [').concat(v, '] because the destination is inside itself.'));
                var C = er.get(e, R),
                    L = er.parent(e, R),
                    y = R[R.length - 1];
                L.children.splice(y, 1);
                var D = eo.transform(R, n),
                    b = er.get(e, eo.parent(D)),
                    M = D[D.length - 1];
                if ((b.children.splice(M, 0, C), t)) for (var [P, U] of eh.points(t)) t[U] = ed.transform(P, n);
                break;
            case 'remove_node':
                var { path: w } = n,
                    x = w[w.length - 1];
                    ...
                    for (var [G, k] of eh.points(t)) {
                        ...
                        if (null != t && null != B) t[k] = B;
                            ...
                            for (var [H, Z] of er.texts(e))
                                if (-1 === eo.compare(Z, w)) F = [H, Z];
                                else {
                                    V = [H, Z];
                                    break;
                                }
                            var Y = !1;
                            F && V && (Y = eo.equals(V[1], w) ? !eo.hasPrevious(V[1]) : eo.common(F[1], w).length < eo.common(V[1], w).length), F && !Y ? ((G.path = F[1]), (G.offset = F[0].text.length)) : V ? ((G.path = V[1]), (G.offset = 0)) : (t = null);
                        }
                    }
                break;
            case 'remove_text':
                ...
                if (((z.text = q + Q), t)) for (var [X, $] of eh.points(t)) t[$] = ed.transform(X, n);
                break;
            case 'set_node':
            ...
            case 'set_selection':
                ...
                if (null == el) t = el;
                    ...
                    if (null == t) {
                        if (!eh.isRange(el)) throw Error('Cannot apply an incomplete "set_selection" operation properties '.concat(em.stringify(el), ' when there is no current selection.'));
                        t = ev({}, el);
                    }
                    for (var eu in el) {
                        var ec = el[eu];
            ...
            case 'split_node':
                var e_,
                    { path: eE, position: ef, properties: ep } = n;
                if (0 === eE.length) throw Error('Cannot apply a "split_node" operation at path ['.concat(eE, '] because the root node cannot be split.'));
                var eI = er.get(e, eE),
                    eT = er.parent(e, eE),
                    eS = eE[eE.length - 1];
                if (eO.isText(eI)) {
                    var eg = eI.text.slice(0, ef),
                        eA = eI.text.slice(ef);
                    (eI.text = eg), (e_ = ev(ev({}, ep), {}, { text: eA }));
                } else {
                    var eN = eI.children.slice(0, ef),
                        eR = eI.children.slice(ef);
                    (eI.children = eN), (e_ = ev(ev({}, ep), {}, { children: eR }));
                }
                if ((eT.children.splice(eS + 1, 0, e_), t)) for (var [eC, eL] of eh.points(t)) t[eL] = ed.transform(eC, n);
        }
        return t;
    },
    eL = ['text'],
...
var eM = (e, t) => {
        if (W.isElement(t)) return !!$.isVoid(e, t) || (1 === t.children.length && eM(e, t.children[0]));
        if ($.isEditor(t)) return !1;
        return !0;
    },
    eP = (e, t) => {
            ...
            ek(
                {},
                {
                    transform(e, t) {
                        ...
                        var n = e.selection && (0, s.P2)(e.selection);
                        try {
                            n = eC(e, n, t);
                        } finally {
                            (e.children = (0, s._x)(e.children)), n ? (e.selection = (0, s.mv)(n) ? (0, s._x)(n) : n) : (e.selection = null);
                        }
                    }
                }
            ),
            {
                insertNodes(e, t) {
                    ...
                    $.withoutNormalizing(e, () => {
                        ...
                        if ((er.isNode(t) && (t = [t]), 0 === t.length)) return;
                        var [u] = t;
                        if ((!s && ((s = e.selection ? e.selection : e.children.length > 0 ? $.end(e, []) : [0]), (l = !0)), null == l && (l = !1), eh.isRange(s))) {
                            if ((!r && (s = $.unhangRange(e, s, { voids: i })), eh.isCollapsed(s))) s = s.anchor;
                            else {
                                var [, c] = eh.edges(s),
                                    d = $.pointRef(e, c);
                                eB.delete(e, { at: s }), (s = d.unref());
                            }
                        }
                        if (ed.isPoint(s)) {
                            null == o && (o = eO.isText(u) ? (e) => eO.isText(e) : e.isInline(u) ? (t) => eO.isText(t) || $.isInline(e, t) : (t) => W.isElement(t) && $.isBlock(e, t));
                            var [_] = $.nodes(e, {
                                at: s.path,
                                match: o,
                                mode: a,
                ...
                liftNodes(e) {
                    ...
                    $.withoutNormalizing(e, () => {
                        var { at: n = e.selection, mode: r = 'lowest', voids: i = !1 } = t,
                            { match: a } = t;
                        if ((null == a && (a = eo.isPath(n) ? eU(e, n) : (t) => W.isElement(t) && $.isBlock(e, t)), !!n))
                    ...
                    $.withoutNormalizing(e, () => {
                        ...
                        if (null == i) {
                            if (eo.isPath(a)) {
                                var [u] = $.parent(e, a);
                                i = (e) => u.children.includes(e);
                            } else i = (t) => W.isElement(t) && $.isBlock(e, t);
                        }
                        if ((!s && eh.isRange(a) && (a = $.unhangRange(e, a, { voids: o })), eh.isRange(a))) {
                        ...
                        if (0 !== h.length && 0 !== I.length) {
                            var T = eo.next(I),
                                ...
                                O = N && $.pathRef(e, N[1]);
                            if (eO.isText(f) && eO.isText(p)) {
                                var R = m(f, eL);
                                (r = p.text.length), (n = R);
                            } else if (W.isElement(f) && W.isElement(p)) {
                                var R = m(f, ey);
                                (r = p.children.length), (n = R);
                            } else throw Error('Cannot merge the node at path ['.concat(h, '] with the previous sibling because it is not the same kind: ').concat(em.stringify(f), ' ').concat(em.stringify(p)));
                            !g &&
                                eB.moveNodes(e, {
                                    at: h,
                                    to: T,
                                ...
                                (W.isElement(p) && $.isEmpty(e, p)) || (eO.isText(p) && '' === p.text && 0 !== I[I.length - 1])
                                    ? eB.removeNodes(e, {
                                          at: I,
                                          voids: o
                                      })
                ...
                moveNodes(e, t) {
                    $.withoutNormalizing(e, () => {
                        var { to: n, at: r = e.selection, mode: i = 'lowest', voids: a = !1 } = t,
                            { match: s } = t;
                        if (!!r) {
                            null == s && (s = eo.isPath(r) ? eU(e, r) : (t) => W.isElement(t) && $.isBlock(e, t));
                            var o = $.pathRef(e, n);
                            for (var l of Array.from(
                                ...
                                0 !== u.length &&
                                    ...
                                    o.current && eo.isSibling(c, u) && eo.isAfter(c, u) && (o.current = eo.next(o.current));
                            }
                            o.unref();
                        }
                    });
                ...
                removeNodes(e) {
                    ...
                    $.withoutNormalizing(e, () => {
                        ...
                        if (!!a)
                            for (var o of (null == s && (s = eo.isPath(a) ? eU(e, a) : (t) => W.isElement(t) && $.isBlock(e, t)),
                            !n && eh.isRange(a) && (a = $.unhangRange(e, a, { voids: r })),
                            Array.from(
                                $.nodes(e, {
                                    at: a,
                                    match: s,
                ...
                setNodes(e, t) {
                    ...
                    $.withoutNormalizing(e, () => {
                        ...
                        if (!!i) {
                            if ((null == r && (r = eo.isPath(i) ? eU(e, i) : (t) => W.isElement(t) && $.isBlock(e, t)), !o && eh.isRange(i) && (i = $.unhangRange(e, i, { voids: c })), u && eh.isRange(i))) {
                                if (eh.isCollapsed(i) && $.leaf(e, i.anchor)[0].text.length > 0) return;
                                ...
                                eB.splitNodes(e, {
                                    ...
                                    (i = d.unref()),
                                    null == n.at && eB.select(e, i);
                            }
                            for (var [I, m] of (!a && (a = (e, t) => e !== t),
                            $.nodes(e, {
                                at: i,
                                match: r,
                                mode: l,
                                ...
                                if (0 !== m.length) {
                                    var g = !1;
                                    for (var A in t) {
                                        if ('children' !== A && 'text' !== A) a(t[A], I[A]) && ((g = !0), I.hasOwnProperty(A) && (T[A] = I[A]), s ? null != t[A] && (S[A] = s(I[A], t[A])) : null != t[A] && (S[A] = t[A]));
                                    }
                                    g &&
                                        e.apply({
                                            type: 'set_node',
                ...
                splitNodes(e) {
                    ...
                    $.withoutNormalizing(e, () => {
                        ...
                        if ((null == s && (s = (t) => W.isElement(t) && $.isBlock(e, t)), eh.isRange(o) && (o = eP(e, o)), eo.isPath(o))) {
                            var c = o,
                                d = $.point(e, c),
                                [_] = $.parent(e, c);
                        ...
                        if (!!o) {
                            var E = $.pointRef(e, o, { affinity: 'backward' });
                            try {
                                var [f] = $.nodes(e, {
                                    at: o,
                                    match: s,
                                ...
                                var S = o.path.length - l,
                                    [, g] = f,
                                    A = o.path.slice(0, S),
                                    N = 0 === l ? o.offset : o.path[S] + 0;
                                for (var [O, R] of $.levels(e, {
                                    at: A,
                                    reverse: !0,
                                    voids: a
                                })) {
                                    var v = !1;
                                    if (R.length < g.length || 0 === R.length || (!a && W.isElement(O) && $.isVoid(e, O))) break;
                                    var C = E.current,
                                        L = $.isEnd(e, C, R);
                                    if (u || !E || !$.isEdge(e, C, R)) {
                                        v = !0;
                                        var y = er.extractProps(O);
                                        e.apply({
                                            type: 'split_node',
                                            path: R,
                                            position: N,
                ...
                unwrapNodes(e) {
                    ...
                    $.withoutNormalizing(e, () => {
                        var { mode: n = 'lowest', split: r = !1, voids: i = !1 } = t,
                            { at: a = e.selection, match: s } = t;
                        if (!!a) {
                            null == s && (s = eo.isPath(a) ? eU(e, a) : (t) => W.isElement(t) && $.isBlock(e, t)), eo.isPath(a) && (a = $.range(e, a));
                            var o = eh.isRange(a) ? $.rangeRef(e, a) : null,
                                l = Array.from(
                                    $.nodes(e, {
                                        at: a,
                                        match: s,
                            ...
                            for (var u of l)
                                !(function (t) {
                                    var n = t.unref(),
                                        [a] = $.node(e, n),
                                        s = $.range(e, n);
                                    r && o && (s = eh.intersection(o.current, s)),
                                        eB.liftNodes(e, {
                                            at: s,
                ...
                wrapNodes(e, t) {
                    ...
                    $.withoutNormalizing(e, () => {
                        ...
                        if (!!o) {
                            if ((null == s && (s = eo.isPath(o) ? eU(e, o) : e.isInline(t) ? (t) => (W.isElement(t) && $.isInline(e, t)) || eO.isText(t) : (t) => W.isElement(t) && $.isBlock(e, t)), i && eh.isRange(o))) {
                                var [l, u] = eh.edges(o),
                            ...
                            for (var [, d] of Array.from(
                                ...
                                var _ = eh.isRange(o) ? eh.intersection(o, $.range(e, d)) : o;
                                if (!!_) {
                                    var E = Array.from(
                                        $.nodes(e, {
                                            at: _,
                                    ...
                                    if (
                                        ...
                                        'continue' ===
                                            (function () {
                                                ...
                                                var o = eo.equals(i, s) ? eo.parent(i) : eo.common(i, s),
                                                    l = $.range(e, i, s),
                                                    [u] = $.node(e, o),
                                                    c = o.length + 1,
                                                    d = eo.next(s.slice(0, c)),
                                                    _ = eb(eb({}, t), {}, { children: [] });
                                                eB.insertNodes(e, _, {
                                                    at: d,
                                                    voids: a
        ...
        ),
        {
            collapse(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    { selection: r } = e;
                if (!!r) {
                    if ('anchor' === n) eB.select(e, r.anchor);
                    else if ('focus' === n) eB.select(e, r.focus);
                    else if ('start' === n) {
                        var [i] = eh.edges(r);
                        eB.select(e, i);
                    } else if ('end' === n) {
            ...
            move(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    { edge: s = null } = t;
                if (!!n) {
                    'start' === s && (s = eh.isBackward(n) ? 'focus' : 'anchor'), 'end' === s && (s = eh.isBackward(n) ? 'anchor' : 'focus');
            ...
            select(e, t) {
                ...
                if (!eh.isRange(t)) throw Error('When setting the selection and the current selection is `null` you must provide at least an `anchor` and `focus`, but you passed: '.concat(em.stringify(t)));
                e.apply({
                    type: 'set_selection',
                    properties: n,
                    newProperties: t
            ...
            setPoint(e, t) {
                ...
                if (!!r) {
                    ...
                    var { anchor: a, focus: s } = r,
                        o = 'anchor' === i ? a : s;
                    eB.setSelection(e, { ['anchor' === i ? 'anchor' : 'focus']: ex(ex({}, o), t) });
                }
            },
            setSelection(e, t) {
                var { selection: n } = e,
    ...
    ),
    {
        delete(e) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (!o) return;
                var u = !1;
                if ((eh.isRange(o) && eh.isCollapsed(o) && ((u = !0), (o = o.anchor)), ed.isPoint(o))) {
                    var c = $.void(e, {
                        at: o,
                        mode: 'highest'
                    });
                    if (!s && c) {
                        ...
                        var _ = {
                            ...
                            E = r ? $.before(e, o, _) || $.start(e, []) : $.after(e, o, _) || $.end(e, []);
                        (o = {
                            anchor: o,
                            focus: E
                        }),
                ...
                if (!eh.isCollapsed(o)) {
                    if (!l) {
                        var [, f] = eh.edges(o),
                            h = $.end(e, []);
                        !ed.equals(f, h) && (o = $.unhangRange(e, o, { voids: s }));
                    }
                    var [p, I] = eh.edges(o),
                        m = $.above(e, {
                            match: (t) => W.isElement(t) && $.isBlock(e, t),
                        ...
                        S = m && T && !eo.equals(m[1], T[1]),
                        g = eo.equals(p.path, I.path),
                        A = s
                            ? null
                            : $.void(e, {
                                  at: p,
                    ...
                    if (A) {
                        var O = $.before(e, p);
                        O && m && eo.isAncestor(m[1], O.path) && (p = O);
                    }
                    if (N) {
                        var R = $.after(e, I);
                        R && T && eo.isAncestor(T[1], R.path) && (I = R);
                    }
                    var v = [];
                    for (var C of $.nodes(e, {
                        ...
                        var [L, y] = C;
                        if (!n || 0 !== eo.compare(y, n)) ((!s && W.isElement(L) && $.isVoid(e, L)) || (!eo.isCommon(y, p.path) && !eo.isCommon(y, I.path))) && (v.push(C), (n = y));
                    }
        ...
        insertFragment(e, t) {
            ...
            $.withoutNormalizing(e, () => {
                ...
                if (!s) return;
                if (eh.isRange(s)) {
                    if ((!i && (s = $.unhangRange(e, s, { voids: a })), eh.isCollapsed(s))) s = s.anchor;
                    else {
                        var [, o] = eh.edges(s);
                        if (!a && $.void(e, { at: o })) return;
                        var l = $.pointRef(e, o);
                        eB.delete(e, { at: s }), (s = l.unref());
                    }
                } else eo.isPath(s) && (s = $.start(e, s));
                if (!(!a && $.void(e, { at: s }))) {
                    var u = $.above(e, {
                        at: s,
                    ...
                    var [, d] = $.above(e, {
                        ...
                        h = !_ || (_ && E),
                        p = !E,
                        [, I] = er.first({ children: t }, []),
                        [, m] = er.last({ children: t }, []),
                        T = [],
                        S = (t) => {
                            var [n, r] = t;
                    ...
                    for (var g of er.nodes({ children: t }, { pass: S })) S(g) && T.push(g);
                    var A = [],
                        N = [],
                        O = [],
                        R = !0,
                        v = !1;
                    for (var [C] of T) W.isElement(C) && !e.isInline(C) ? ((R = !1), (v = !0), N.push(C)) : R ? A.push(C) : O.push(C);
                    var [L] = $.nodes(e, {
                            at: s,
                            match: (t) => eO.isText(t) || $.isInline(e, t),
                            mode: 'highest',
                            voids: a
                        }),
                        [, y] = L,
                        D = $.isStart(e, s, y),
                        b = $.isEnd(e, s, y),
                        M = $.pathRef(e, E && !O.length ? eo.next(d) : d),
                        P = $.pathRef(e, b ? eo.next(y) : y);
                    eB.splitNodes(e, {
                        at: s,
                        match: (t) => (v ? W.isElement(t) && $.isBlock(e, t) : eO.isText(t) || $.isInline(e, t)),
                        mode: v ? 'lowest' : 'highest',
                        always: v && (!_ || A.length > 0) && (!E || O.length > 0),
                        voids: a
                    });
                    var U = $.pathRef(e, !D || (D && b) ? eo.next(y) : y);
                    if (
                        (eB.insertNodes(e, A, {
                            at: U.current,
                            match: (t) => eO.isText(t) || $.isInline(e, t),
                        ...
                        !n.at && (O.length > 0 && P.current ? (r = eo.previous(P.current)) : N.length > 0 && M.current ? (r = eo.previous(M.current)) : U.current && (r = eo.previous(U.current)), r))
                    ) {
                        var w = $.end(e, r);
                        eB.select(e, w);
                    }
        ...
        insertText(e, t) {
            ...
            $.withoutNormalizing(e, () => {
                var { voids: r = !1 } = n,
                    { at: i = e.selection } = n;
                if (!i) return;
                if ((eo.isPath(i) && (i = $.range(e, i)), eh.isRange(i))) {

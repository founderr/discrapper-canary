            ...
            J.withoutNormalizing(e, () => {
                ...
                if (!(!a && J.void(e, { at: s }))) {
                    ...
                    var T = [],
                        ...
                        A = !0,
                        N = !1;
                    for (var [C] of v) W.isElement(C) && !e.isInline(C) ? ((A = !1), (N = !0), S.push(C)) : A ? T.push(C) : y.push(C);
                    var [R] = J.nodes(e, {
                            at: s,
                    ...
                    if (
                        ...
                        !n.at && (y.length > 0 && w.current ? (r = eo.previous(w.current)) : S.length > 0 && x.current ? (r = eo.previous(x.current)) : M.current && (r = eo.previous(M.current)), r))
                    ) {
                        var P = J.end(e, r);
                        eG.select(e, P);
                    }

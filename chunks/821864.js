...
var r = n(544891), a = n(570140), i = n(555573), E = n(581364), _ = n(981631);
function u() {
...
function l(e, t) {
    r.tn.get(_.ANM.GUILD_COMMANDS_FOR_APPLICATION(e, t)).then(n => {
        a.Z.dispatch({
...
async function O(e) {
    let {
        ...
        }(u, s, r, _) : s, o = await i.dh(t, u, n, l);
    o.ok && a.Z.dispatch({
        type: 'INTEGRATION_PERMISSION_SETTINGS_COMMAND_UPDATE',
        applicationId: t,
        commandId: n,

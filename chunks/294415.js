...
function d(e, t) {
  ...
  this._alg = e, this._key = t, t.length > n ? t = ('rmd160' === e ? new l() : u(e)).update(t).digest() : t.length < n && (t = s.concat([
t,
c
  ], n));
  for (var r = this._ipad = s.allocUnsafe(n), i = this._opad = s.allocUnsafe(n), o = 0; o < n; o++)

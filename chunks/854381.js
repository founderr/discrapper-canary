...
function l(e) {
  ...
  let f = (0, a.useStateFromStores)([n.default], () => {
    ...
    E = null !== (r = null !== (t = m.find(e => e === (null == l ? void 0 : l.currency))) && void 0 !== t ? t : m[0]) && void 0 !== r ? r : s.CurrencyCodes.USD;
  return {
    ...(0, u.useCurrencyWithPaymentSourceChange)(E, null == f ? void 0 : f.id, c, d, o),
    currencies: m
  }
}
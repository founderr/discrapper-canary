...
let ec = a.memo(e => {
  let {
    ...
    application: D,
    speaking: w
  } = e, H = null, W = null, z = null, K = null, J = (0, et.isVideoCompact)(S), q = (0, et.isNamesCompact)(S), Q = (0, r.useStateFromStores)([P.default], () => null != j && P.default.isLocalVideoAutoDisabled(j, (0, g.default)(R)), [j, R]), $ = (0, h.useRedesignIconContext)().enabled;
  if (!M) {
    ...
    else if (a || R !== ea.ParticipantTypes.STREAM || !C || J || N) {
      if ($) {
        let e;
  ...
  return _ && P.default.supports(ei.Features.VIDEO) || !C ? _ && C && I && !Q && (W = (0, l.jsx)(V.default, {
    ...
    children: [(0, l.jsx)("div", {
      ...
      children: Q || x === el.VideoToggleState.AUTO_PROBING ? p ? (0, l.jsx)("div", {
        className: eo.status,
        children: (0, l.jsx)(V.default, {})
      }) : (0, l.jsxs)("div", {

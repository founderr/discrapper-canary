  ...
  return function(e) {
    ...
    return _.map(e => function(e) {
      if (e === A.$.IS_GUEST_INVITE)
        return v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_INVITE_GUEST_INVITE;
      return null;
    }(e)).filter(f.lm);
  }({
    newValue: _
...
[H.zUn.IS_CANCELED]: e => {
  if (null != e.oldValue || !0 === e.newValue) {
    if (!e.oldValue && e.newValue)
      return v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_IS_CANCELED_CANCELED;
    if (e.oldValue && !e.newValue)
      return v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_IS_CANCELED_RESTORED;
  }
  return '';
},
...B()
...
case H.rsA.STAGE_INSTANCE_DELETE:
  if (null != e.userId)
    return v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_STAGE_INSTANCE_DELETE;
...
case H.rsA.AUTO_MODERATION_FLAG_TO_CHANNEL:
  ...
  if ((null === (s = e.options) || void 0 === s ? void 0 : s.auto_moderation_rule_trigger_type) === h.fX.USER_PROFILE.toString())
    return v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTO_MODERATION_FLAGGED_USER_PROFILE;
...
let s = function(e, _) {
    switch (e.targetType) {
      ...
      case H.KFR.CHANNEL_OVERWRITE:
        return eD(e, H.zUn.NAME, e => u.Z.getChannel(e), e => (0, l.F6)(e, C.default, c.Z, !0));
      case H.KFR.USER:
        return eD(e, H.zUn.NICK, e => C.default.getUser(e), e => e);
      case H.KFR.ROLE:
        return eD(e, H.zUn.NAME, e => R.Z.getRole(_.id, e), e => e.name);
      case H.KFR.ONBOARDING_PROMPT:
        let E = eD(e, H.zUn.ID, e => U.Z.getOnboardingPrompt(e), e => e.title);
      ...
      case H.KFR.INTEGRATION:
        return eD(e, H.zUn.TYPE, e => O.Z.integrations.find(_ => _.id === e), e => e.name);
      case H.KFR.WEBHOOK:
        return eD(e, H.zUn.NAME, e => O.Z.webhooks.find(_ => _.id === e), e => e.name);
      case H.KFR.EMOJI:
        return eD(e, H.zUn.NAME, e => S.ZP.getGuildEmoji(_.id).find(_ => _.id === e), e => e.name);
      case H.KFR.STICKER:
        return eD(e, H.zUn.NAME, e => i.Z.getStickerById(e), e => e.name);
      case H.KFR.STAGE_INSTANCE:
        return eD(e, H.zUn.TOPIC, e => {
          var E;
      ...
      case H.KFR.GUILD_SCHEDULED_EVENT_EXCEPTION:
        return eD(e, H.zUn.NAME, e => O.Z.guildScheduledEvents.find(_ => _.id === e), e => e.name);
      case H.KFR.THREAD:
        return eD(e, H.zUn.NAME, e => O.Z.threads.find(_ => _.id === e), e => e.name);
      case H.KFR.APPLICATION_COMMAND:
        ...
        return eD(e, H.zUn.NAME, e => O.Z.applicationCommands.find(_ => _.id === e), e => {
      ...
      case H.KFR.AUTO_MODERATION_RULE:
        return eD(e, H.zUn.NAME, e => O.Z.automodRules.find(_ => _.id === e), e => e.name);
      case H.KFR.GUILD_SOUNDBOARD:
        return eD(e, H.zUn.NAME, H.VqG);
      case H.KFR.HOME_SETTINGS:
        return eD(e, H.zUn.GUILD_ID, e => G.Z.getSettings(e), () => v.Z.Messages.SERVER_GUIDE, _.id);
      case H.KFR.VOICE_CHANNEL_STATUS:
        return eD(e, H.zUn.STATUS, e => u.Z.getChannel(e), e => (0, l.F6)(e, C.default, c.Z, !0));
      default:
...
if (null != s || !![
  ...
  if (null != (e = (e = (e = e.set('user', I)).set('target', s)).set('options', function(e) {
      if (null != e.options) {
        ...
        if (null != e.options.channel_id && (E.channel = eD(e, '', e => u.Z.getChannel(e), e => e, e.options.channel_id)), null != e.options.members_removed && 0 !== e.options.members_removed && (E.count = e.options.members_removed), null != e.options.event_exception_id) {
          var _;
    ...
    e.changes.forEach(s => {
      let I = function(e, _, E) {
        if (_.action === H.rsA.APPLICATION_COMMAND_PERMISSION_UPDATE) {
          ...
          switch (_.type) {
            case H.ecB.ROLE:
              e.subtarget = eU(_.id, e => R.Z.getRole(E.id, e), e => e.name);
              break;
            case H.ecB.USER:
              e.subtarget = eU(_.id, e => C.default.getUser(e), e => e.tag);
              break;
            case H.ecB.CHANNEL:
              _.id === T()(E.id).subtract(1).toString() ? e.subtarget = v.Z.Messages.ALL_CHANNELS : e.subtarget = eU(_.id, e => u.Z.getChannel(e), e => (0, l.F6)(e, C.default, c.Z, !0));
          }
          return e;
        }
        switch (e.key) {
          ...
          case H.zUn.PUBLIC_UPDATES_CHANNEL_ID:
            return eS(e, e => u.Z.getChannel(e), e => (0, l.F6)(e, C.default, c.Z, !0));
          ...
          case H.zUn.AUTO_MODERATION_ACTIONS:
            if (_.targetType === H.KFR.AUTO_MODERATION_RULE)
              return eS(e, e => e.map(e => e.type), e => e.map(D.ZF).join(', '));
            break;
            ...
            if (_.targetType === H.KFR.AUTO_MODERATION_RULE)
              return eS(e, e => {
                if (null != e && 'object' == typeof e)
                  return null != e.keyword_filter && Array.isArray(e.keyword_filter) ? v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_TRIGGER_METADATA_KEYWORDS_UPDATE.plainFormat({
          ...
          case H.zUn.AUTO_MODERATION_EXEMPT_CHANNELS:
            if (_.targetType === H.KFR.AUTO_MODERATION_RULE)
              return eS(e, e => e.map(u.Z.getChannel).filter(e => null != e).map(e => (0, l.F6)(e, C.default, c.Z, !0)), e => null != e && e.length > 0 ? e.join(', ') : v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NONE);
            break;
          case H.zUn.AUTO_MODERATION_EXEMPT_ROLES:
            if (_.targetType === H.KFR.AUTO_MODERATION_RULE)
              return eS(e, e => e.map(e => R.Z.getRole(E.id, e)).filter(e => null != e).map(e => e.name), e => null != e && e.length > 0 ? e.join(', ') : v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NONE);
            break;
          case H.zUn.AVAILABLE_TAGS:
            return function(e) {
              ...
              if (s.forEach(e => {
                ...
                for (let e in n)
                  if (null == I[e])
                    return new M.ms(H.zUn.AVAILABLE_TAG_ADD, null, eL(n[e]));
              }
              if (s.length > T.length) {
                for (let e in I)
                  if (null == n[e])
                    return new M.ms(H.zUn.AVAILABLE_TAG_DELETE, null, eL(I[e]));
              }
              for (let e in I) {
                let _ = I[e],
                  E = n[e];
                if ((null == E ? void 0 : E.name) !== _.name || (null == E ? void 0 : E.emoji_id) !== _.emoji_id || (null == E ? void 0 : E.emoji_name) !== _.emoji_name)
                  return new M.ms(H.zUn.AVAILABLE_TAG_EDIT, eL(_), eL(E));
              }
              return e;
            }(e);

    ...
    [y.AuditLogChangeKeys.FLAGS]: e => {
      ...
      return function(e) {
        ...
        return t.map(e => (function(e) {
          if (e === n.GuildInviteFlags.IS_GUEST_INVITE) return v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_INVITE_GUEST_INVITE;
          return null
...
function eA(e) {
  switch (e.action) {
    ...
    case y.AuditLogActions.GUILD_HOME_FEATURE_ITEM:
      let s = null != e.changes ? e.changes.find(e => e.key === y.AuditLogChangeKeys.ENTITY_TYPE) : null;
...
function eu(e, t) {
  switch (e) {
    ...
    case y.Permissions.USE_EXTERNAL_APPS:
      return v.default.Messages.ROLE_PERMISSIONS_USE_EXTERNAL_APPS
  }
  return null
}
...
function ei(e, t) {
  ...
  return e.forEach(e => {
    ...
    if (null != _ || [y.AuditLogActions.MEMBER_PRUNE, y.AuditLogActions.MEMBER_DISCONNECT, y.AuditLogActions.MEMBER_MOVE, y.AuditLogActions.CREATOR_MONETIZATION_REQUEST_CREATED, y.AuditLogActions.CREATOR_MONETIZATION_TERMS_ACCEPTED].includes(e.action)) {
          ...
          let T = function(e, t, E) {
            ...
            switch (e.key) {
              ...
              case y.AuditLogChangeKeys.PERMISSIONS: {
                ...
                if (_.length > 0) {
                  let e = new G.AuditLogChange(y.AuditLogChangeKeys.PERMISSIONS_DENIED, null, _);
                  t.push(e)
                }
                return t
              }
              ...
              case y.AuditLogChangeKeys.PERMISSIONS_DENIED: {
                ...
                if (_.length > 0) {
                  let e = new G.AuditLogChange(y.AuditLogChangeKeys.PERMISSIONS_RESET, _, _);
                  t.push(e)
                }
                return t
              }
                ...
                let t = [],
                  {
                    ...
                    for (let e in P.ChannelFlags) {
                      ...
                      R.hasFlag(s, t) && a.push(t), R.hasFlag(T, t) && A.push(t)
                    }
                    return {
                      added: a,
                      removed: A
              ...
              case y.AuditLogChangeKeys.SYSTEM_CHANNEL_FLAGS:
                return function(e) {
                  let t = {
                    ...
                    E = [];
                  return Object.values(y.SystemChannelFlags).forEach(_ => {
              ...
              case y.AuditLogChangeKeys.AVAILABLE_TAGS:
                return function(e) {
                  ...
                  if (_.forEach(e => {
                    ...
                    for (let e in a)
                      if (null == T[e]) return new G.AuditLogChange(y.AuditLogChangeKeys.AVAILABLE_TAG_ADD, null, el(a[e]))
                  }
                  if (_.length > s.length) {
                    for (let e in T)
                      if (null == a[e]) return new G.AuditLogChange(y.AuditLogChangeKeys.AVAILABLE_TAG_DELETE, null, el(T[e]))
                  }
                  for (let e in T) {
                    let t = T[e],
                      E = a[e];
...
function eL(e, t) {
  let E = I.deserialize("string" == typeof e ? e : 0),
    _ = I.deserialize("string" == typeof t ? t : 0),
    s = I.remove(_, E),
    T = I.remove(E, _),
    a = [],
    A = [];
  for (let e in y.Permissions) {
    ...
    I.has(s, t) && a.push(t), I.has(T, t) && A.push(t)
  }
  return {
    added: a,
    removed: A

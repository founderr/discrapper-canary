    ...
    [p.zUn.FLAGS]: e => {
      ...
      return function(e) {
        ...
        return _.map(e => (function(e) {
          if (e === t.$.IS_GUEST_INVITE) return F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_INVITE_GUEST_INVITE;
          return null
        })(e)).filter(f.lm)
      }({
        newValue: _
  ...
  $ = () => ({
    ...
    [p.zUn.IS_CANCELED]: e => {
      if (null != e.oldValue || !0 === e.newValue) {
        if (!e.oldValue && e.newValue) return F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_IS_CANCELED_CANCELED;
        if (e.oldValue && !e.newValue) return F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_IS_CANCELED_RESTORED
      }
      return ""
    },
    ...B()
...
function eA(e) {
  switch (e.action) {
    ...
    case p.rsA.STAGE_INSTANCE_DELETE:
      if (null != e.userId) return F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_STAGE_INSTANCE_DELETE;
    ...
    case p.rsA.AUTO_MODERATION_FLAG_TO_CHANNEL:
      var s;
      if ((null === (s = e.options) || void 0 === s ? void 0 : s.auto_moderation_rule_trigger_type) === h.fX.USER_PROFILE.toString()) return F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTO_MODERATION_FLAGGED_USER_PROFILE;
    ...
    case p.rsA.GUILD_HOME_FEATURE_ITEM:
      ...
      if (null == T) return F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_HOME_FEATURE_ITEM;
      switch (T.newValue) {
        case A.w.MESSAGE:
...
function er(e, _) {
  switch (e) {
    ...
    case p.Plq.MANAGE_CHANNELS:
      if (_.targetType === p.KFR.CHANNEL || _.targetType === p.KFR.CHANNEL_OVERWRITE) return F.Z.Messages.MANAGE_CHANNEL;
          ...
          let I = function(e, _, E) {
            ...
            switch (e.key) {
              ...
              case p.zUn.AUTO_MODERATION_ACTIONS:
                if (_.targetType === p.KFR.AUTO_MODERATION_RULE) return eD(e, e => e.map(e => e.type), e => e.map(l.ZF).join(", "));
                break;
              ...
              case p.zUn.AUTO_MODERATION_TRIGGER_METADATA:
                if (_.targetType === p.KFR.AUTO_MODERATION_RULE) return eD(e, e => {
                  if (null != e && "object" == typeof e) return null != e.keyword_filter && Array.isArray(e.keyword_filter) ? F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_TRIGGER_METADATA_KEYWORDS_UPDATE.plainFormat({
              ...
              case p.zUn.AUTO_MODERATION_EXEMPT_CHANNELS:
                if (_.targetType === p.KFR.AUTO_MODERATION_RULE) return eD(e, e => e.map(o.Z.getChannel).filter(e => null != e).map(e => (0, L.F6)(e, C.default, c.Z, !0)), e => null != e && e.length > 0 ? e.join(", ") : F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NONE);
                break;
              case p.zUn.AUTO_MODERATION_EXEMPT_ROLES:
                if (_.targetType === p.KFR.AUTO_MODERATION_RULE) return eD(e, e => e.map(e => u.Z.getRole(E.id, e)).filter(e => null != e).map(e => e.name), e => null != e && e.length > 0 ? e.join(", ") : F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NONE);
                break;
              case p.zUn.AVAILABLE_TAGS:
                return function(e) {
                  ...
                  if (s.forEach(e => {
                    ...
                    for (let e in n)
                      if (null == I[e]) return new R.ms(p.zUn.AVAILABLE_TAG_ADD, null, eS(n[e]))
                  }
                  if (s.length > T.length) {
                    for (let e in I)
                      if (null == n[e]) return new R.ms(p.zUn.AVAILABLE_TAG_DELETE, null, eS(I[e]))
                  }
                  for (let e in I) {
                    let _ = I[e],
                      E = n[e];
                    if ((null == E ? void 0 : E.name) !== _.name || (null == E ? void 0 : E.emoji_id) !== _.emoji_id || (null == E ? void 0 : E.emoji_name) !== _.emoji_name) return new R.ms(p.zUn.AVAILABLE_TAG_EDIT, eS(_), eS(E))
                  }
                  return e
                }(e);

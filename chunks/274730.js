...
let v = new S.Z('AuditLogUtils'), V = -1, B = () => ({ [p.zUn.REASON]: F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMON_REASON }), b = () => ({
        ...
        [p.zUn.DESCRIPTION]: e => {
            ...
            return null != _ ? (0 === _.length && (_ = F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_PROMPT_EMPTY_VALUE), F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_PROMPT_DESCRIPTION_CHANGE.format({
                oldValue: _,
                newValue: E
            })) : F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_PROMPT_DESCRIPTION_CREATE.format({ newValue: E });
        },
        ...
        [p.zUn.DEFAULT_CHANNEL_IDS]: e => {
            let {newValue: _} = e;
            return F.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_DEFAULT_CHANNEL_IDS.format({ count: _.length });
        },
...
function eN(e, _) {
    ...
    return e.forEach(e => {
        let s = function (e, _) {
            ...
            }(e, _), I = C.default.getUser(e.userId);
        if (null != s || !![
                p.rsA.MEMBER_PRUNE,
            ...
            if (null != (e = (e = (e = e.set('user', I)).set('target', s)).set('options', function (e) {
                    if (null != e.options) {
                        ...
                        if (null != e.options.channel_id && (E.channel = el(e, '', e => o.Z.getChannel(e), e => e, e.options.channel_id)), null != e.options.members_removed && 0 !== e.options.members_removed && (E.count = e.options.members_removed), null != e.options.event_exception_id) {
                            var _;
                            let s = O.Z.guildScheduledEvents.find(_ => _.id === e.targetId), T = null == s ? void 0 : s.guild_scheduled_event_exceptions.find(_ => _.event_exception_id === e.options.event_exception_id);
                    ...
                    let I = function (e, _, E) {
                        ...
                        case p.zUn.FLAGS: {
                                let _ = [], {
                                        ...
                                        let E = 'number' == typeof e ? e : 0, s = 'number' == typeof _ ? _ : 0, T = d.Ge(s, E), I = d.Ge(E, s), n = [], A = [];
                                        for (let e in H.zZ) {
                                            let _ = H.zZ[e];
...
function eL(e, _) {
    let E = a.vB('string' == typeof e ? e : 0), s = a.vB('string' == typeof _ ? _ : 0), T = a.Od(s, E), I = a.Od(E, s), n = [], A = [];
    for (let e in p.Plq) {
        let _ = p.Plq[e];

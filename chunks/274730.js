...
let V = new L.default("AuditLogUtils"),
  ...
  F = () => ({
    ...
    [P.AuditLogChangeKeys.DESCRIPTION]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DESCRIPTION_CLEAR, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DESCRIPTION_CHANGE),
    ...
    [P.AuditLogChangeKeys.BANNER_HASH]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_BANNER_HASH_REMOVE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_BANNER_HASH_CHANGE),
    ...
    [P.AuditLogChangeKeys.AFK_CHANNEL_ID]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_CHANNEL_ID_CLEAR, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_CHANNEL_ID_CHANGE),
    [P.AuditLogChangeKeys.AFK_TIMEOUT]: v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_TIMEOUT_CHANGE,
    [P.AuditLogChangeKeys.SYSTEM_CHANNEL_ID]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_DISABLE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_CHANGE),
    [P.AuditLogChangeKeys.RULES_CHANNEL_ID]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_RULES_CHANNEL_ID_CLEAR, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_RULES_CHANNEL_ID_CHANGE),
    [P.AuditLogChangeKeys.PUBLIC_UPDATES_CHANNEL_ID]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CLEAR, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CHANGE),
    ...
    [P.AuditLogChangeKeys.WIDGET_CHANNEL_ID]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_DELETE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_CHANGE),
    ...
    [P.AuditLogChangeKeys.VANITY_URL_CODE]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_VANITY_URL_CODE_DELETE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_VANITY_URL_CODE_CHANGE),
  ...
  x = () => ({
    [P.AuditLogChangeKeys.NAME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_NAME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_NAME_CHANGE),
    [P.AuditLogChangeKeys.POSITION]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_POSITION_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_POSITION_CHANGE),
    ...
    [P.AuditLogChangeKeys.BITRATE]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_BITRATE_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_BITRATE_CHANGE),
    ...
    [P.AuditLogChangeKeys.USER_LIMIT]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_USER_LIMIT_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_USER_LIMIT_CHANGE),
    [P.AuditLogChangeKeys.RATE_LIMIT_PER_USER]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE),
    ...
    [P.AuditLogChangeKeys.TYPE]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TYPE_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TYPE_CHANGE),
    [P.AuditLogChangeKeys.VIDEO_QUALITY_MODE]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CHANGE),
    [P.AuditLogChangeKeys.DEFAULT_AUTO_ARCHIVE_DURATION]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CHANGE),
  ...
  j = () => ({
    [P.AuditLogChangeKeys.NAME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_NAME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_NAME_CHANGE),
    [P.AuditLogChangeKeys.DESCRIPTION]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CHANGE),
  ...
  J = () => ({
    [P.AuditLogChangeKeys.CHANNEL_ID]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_CHANNEL_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_CHANNEL_CHANGE),
    [P.AuditLogChangeKeys.NAME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_NAME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_NAME_CHANGE),
    [P.AuditLogChangeKeys.AVATAR_HASH]: v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_AVATAR,
    [P.AuditLogChangeKeys.REASON]: v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMON_REASON
  }),
  X = () => ({
    [P.AuditLogChangeKeys.NAME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_EMOJI_NAME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_EMOJI_NAME_CHANGE),
    ...K()
  }),
  Z = () => ({
    [P.AuditLogChangeKeys.NAME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_NAME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_NAME_CHANGE),
    [P.AuditLogChangeKeys.TAGS]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_TAGS_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_TAGS_CHANGE),
    [P.AuditLogChangeKeys.DESCRIPTION]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CHANGE),
    ...K()
  }),
  z = () => ({
  ...
  Q = () => ({
    [P.AuditLogChangeKeys.TOPIC]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CHANGE),
  ...
  q = () => ({
    ...
    [P.AuditLogChangeKeys.CHANNEL_ID]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_CHANNEL_CLEAR, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_CHANNEL),
    [P.AuditLogChangeKeys.LOCATION]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION_CLEAR, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION),
    [P.AuditLogChangeKeys.IMAGE_HASH]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_REMOVE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_CHANGE),
    ...K()
  }),
  $ = () => ({
    [P.AuditLogChangeKeys.SCHEDULED_START_TIME]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_REMOVED, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_CHANGE),
    [P.AuditLogChangeKeys.SCHEDULED_END_TIME]: eN(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_REMOVED, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_CHANGE),
  ...
  ee = () => ({
    [P.AuditLogChangeKeys.NAME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_NAME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_NAME_CHANGE),
    ...
    [P.AuditLogChangeKeys.AUTO_ARCHIVE_DURATION]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CHANGE),
    [P.AuditLogChangeKeys.RATE_LIMIT_PER_USER]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE),
  ...
  eE = () => ({
    [P.AuditLogChangeKeys.NAME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_NAME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_NAME_CHANGE),
    [P.AuditLogChangeKeys.VOLUME]: eS(v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_VOLUME_CREATE, v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_VOLUME_CHANGE),
    ...
    let E = function(e, t) {
        switch (e.targetType) {
          ...
          case P.AuditLogTargetTypes.CHANNEL_OVERWRITE:
            return er(e, P.AuditLogChangeKeys.NAME, e => G.default.getChannel(e), e => (0, I.computeChannelName)(e, C.default, U.default, !0));
          ...
          case P.AuditLogTargetTypes.ROLE:
            return er(e, P.AuditLogChangeKeys.NAME, e => O.default.getRole(t.id, e), e => e.name);
          ...
          case P.AuditLogTargetTypes.INTEGRATION:
            return er(e, P.AuditLogChangeKeys.TYPE, e => N.default.integrations.find(t => t.id === e), e => e.name);
          case P.AuditLogTargetTypes.WEBHOOK:
            return er(e, P.AuditLogChangeKeys.NAME, e => N.default.webhooks.find(t => t.id === e), e => e.name);
          ...
          case P.AuditLogTargetTypes.GUILD_SCHEDULED_EVENT_EXCEPTION:
            return er(e, P.AuditLogChangeKeys.NAME, e => N.default.guildScheduledEvents.find(t => t.id === e), e => e.name);
          case P.AuditLogTargetTypes.THREAD:
            return er(e, P.AuditLogChangeKeys.NAME, e => N.default.threads.find(t => t.id === e), e => e.name);
          case P.AuditLogTargetTypes.APPLICATION_COMMAND:
            ...
            return er(e, P.AuditLogChangeKeys.NAME, e => N.default.applicationCommands.find(t => t.id === e), e => {
          ...
          case P.AuditLogTargetTypes.AUTO_MODERATION_RULE:
            return er(e, P.AuditLogChangeKeys.NAME, e => N.default.automodRules.find(t => t.id === e), e => e.name);
          ...
          case P.AuditLogTargetTypes.HOME_SETTINGS:
            return er(e, P.AuditLogChangeKeys.GUILD_ID, e => S.default.getSettings(e), () => v.default.Messages.SERVER_GUIDE, t.id);
          case P.AuditLogTargetTypes.VOICE_CHANNEL_STATUS:
            return er(e, P.AuditLogChangeKeys.STATUS, e => G.default.getChannel(e), e => (0, I.computeChannelName)(e, C.default, U.default, !0));
          default:
          ...
          let a = function(e, t, s) {
            ...
            switch (e.key) {
              ...
              case P.AuditLogChangeKeys.PERMISSIONS: {
                ...
                if (s.length > 0) {
                  let e = new c.AuditLogChange(P.AuditLogChangeKeys.PERMISSIONS_GRANTED, null, s);
                  t.push(e)
                }
                if (E.length > 0) {
                  let e = new c.AuditLogChange(P.AuditLogChangeKeys.PERMISSIONS_DENIED, null, E);
                  t.push(e)
                }
                return t
              }
              ...
              case P.AuditLogChangeKeys.PERMISSIONS_DENIED: {
                ...
                if (E.length > 0) {
                  let e = new c.AuditLogChange(P.AuditLogChangeKeys.PERMISSIONS_RESET, E, E);
                  t.push(e)
                }
                return t
              }
              ...
              case P.AuditLogChangeKeys.AUTO_MODERATION_EXEMPT_CHANNELS:
                if (t.targetType === P.AuditLogTargetTypes.AUTO_MODERATION_RULE) return eo(e, e => e.map(G.default.getChannel).filter(e => null != e).map(e => (0, I.computeChannelName)(e, C.default, U.default, !0)), e => null != e && e.length > 0 ? e.join(", ") : v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NONE);
                break;
              case P.AuditLogChangeKeys.AUTO_MODERATION_EXEMPT_ROLES:
                if (t.targetType === P.AuditLogTargetTypes.AUTO_MODERATION_RULE) return eo(e, e => e.map(e => O.default.getRole(s.id, e)).filter(e => null != e).map(e => e.name), e => null != e && e.length > 0 ? e.join(", ") : v.default.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NONE);
                break;
              case P.AuditLogChangeKeys.AVAILABLE_TAGS:
                return function(e) {
                  ...
                  if (E.forEach(e => {
                    ...
                    for (let e in n)
                      if (null == a[e]) return new c.AuditLogChange(P.AuditLogChangeKeys.AVAILABLE_TAG_ADD, null, eL(n[e]))
                  }
                  if (E.length > _.length) {
                    for (let e in a)
                      if (null == n[e]) return new c.AuditLogChange(P.AuditLogChangeKeys.AVAILABLE_TAG_DELETE, null, eL(a[e]))
                  }
                  for (let e in a) {
                    let t = a[e],
                      s = n[e];
                    if ((null == s ? void 0 : s.name) !== t.name || (null == s ? void 0 : s.emoji_id) !== t.emoji_id || (null == s ? void 0 : s.emoji_name) !== t.emoji_name) return new c.AuditLogChange(P.AuditLogChangeKeys.AVAILABLE_TAG_EDIT, eL(t), eL(s))
                  }
                  return e
                }(e);

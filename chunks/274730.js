...
function eu(e, t) {
  switch (e) {
    ...
    case P.Permissions.USE_EXTERNAL_APPS:
...
function ei(e, t) {
  ...
  return e.forEach(e => {
    ...
    if (null != s || [P.AuditLogActions.MEMBER_PRUNE, P.AuditLogActions.MEMBER_DISCONNECT, P.AuditLogActions.MEMBER_MOVE, P.AuditLogActions.CREATOR_MONETIZATION_REQUEST_CREATED, P.AuditLogActions.CREATOR_MONETIZATION_TERMS_ACCEPTED].includes(e.action)) {
      if (null != (e = (e = (e = e.set("user", T)).set("target", s)).set("options", function(e) {
          if (null != e.options) {
            ...
            if (null != e.options.channel_id && (E.channel = er(e, "", e => O.default.getChannel(e), e => e, e.options.channel_id)), null != e.options.members_removed && 0 !== e.options.members_removed && (E.count = e.options.members_removed), null != e.options.event_exception_id) {
              ...
              E.subtarget = (0, M.dateFormat)(a()(p.default.extractTimestamp(null !== (t = null == _ ? void 0 : _.event_exception_id) && void 0 !== t ? t : "0")), "LL")
            }
            return E
          }
          return e.options
          ...
          let T = function(e, t, E) {
            ...
            switch (e.key) {
              ...
              case P.AuditLogChangeKeys.PERMISSIONS: {
                ...
                if (s.length > 0) {
                  let e = new G.AuditLogChange(P.AuditLogChangeKeys.PERMISSIONS_DENIED, null, s);
                  t.push(e)
                }
                return t
              }
              ...
              case P.AuditLogChangeKeys.PERMISSIONS_DENIED: {
                ...
                if (s.length > 0) {
                  let e = new G.AuditLogChange(P.AuditLogChangeKeys.PERMISSIONS_RESET, s, s);
                  t.push(e)
                }
                return t
              }
                ...
                let t = [],
                  {
                    ...
                    for (let e in y.ChannelFlags) {
                      ...
                      R.hasFlag(_, t) && a.push(t), R.hasFlag(T, t) && A.push(t)
                    }
                    return {
                      added: a,
                      removed: A
              ...
              case P.AuditLogChangeKeys.SYSTEM_CHANNEL_FLAGS:
                return function(e) {
                  let t = {
                    ...
                    E = [];
                  return Object.values(P.SystemChannelFlags).forEach(s => {
                    let _ = (e.oldValue & s) === s,
                      T = (e.newValue & s) === s;
                    if (_ === T) return;
                    let a = new G.AuditLogChange(t[s], !_, !T);
                    E.push(a)
                  }), E
                }(e);
...
function el(e, t) {
  ...
  for (let e in P.Permissions) {
    ...
    I.has(_, t) && a.push(t), I.has(T, t) && A.push(t)
  }
  return {
    added: a,
    removed: A

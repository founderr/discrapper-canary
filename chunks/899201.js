...
properties: {
  ...
  let [p] = (0, g.Z)([a]), b = (0, d.e7)([v.default], () => v.default.getCurrentUser()), [A, Z] = n.useState(''), [R, j] = n.useState([]), [O, k] = n.useState(null), [z, W] = n.useState(null);
  n.useEffect(() => {
(async () => {
...
M.Z,
w.Z
  ], () => M.Z.getInviteSuggestionRows().filter(e => e.type === D.bm.FRIEND || e.type === D.bm.DM || w.Z.can(B.Plq.ATTACH_FILES, e.item)));
  n.useEffect(() => {
(0, I.x)({
  omitUserIds: new Set(),
  applicationId: a,
...
Q = n.useCallback(async () => {
  ...
  async function n(n) {
    ...
    _.Z.uploadFiles({
      channelId: s,
      uploads: l,
      parsedMessage: null != p ? C.ZP.parse(r, G.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_MOMENT_FROM_APP.format({
  ...
  try {
    await Promise.all(s), null != p && (0, u.showToast)((0, u.createToast)(G.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_MOMENT_FROM_APP.format({
...
J = e => {
  let a = async () => {
    ...
    if (t.includes(e.item.id))
      E.Z.clearAll(a, N.d.ChannelMessage), t = t.filter(a => a !== e.item.id);
    else {
      if (t.length >= 10)
        return;
      null != O && (E.Z.addFile({
  ...
  return null == z ? (0, i.jsx)(u.Spinner, {}) : (0, i.jsxs)(u.ModalRoot, {
transitionState: r,
...m,
...
children: [
  ...
  (0, i.jsxs)(u.ModalContent, {
    ...
    children: [
      ...
      Y.map((e, a) => (0, i.jsxs)(n.Fragment, {
        children: [
          0 === a ? null : (0, i.jsx)('div', {
...
mediaUrl: t,
activitySessionId: s
  } = e, [l, r] = n.useState(!1), o = (0, d.e7)([v.default], () => v.default.getCurrentUser());
  async function c() {

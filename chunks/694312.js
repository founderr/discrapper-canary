...
function f(e) {
  let t = (0, l.e7)([u.default], u.default.getCurrentUser),
    n = (0, l.Wu)([c.ZP], () => c.ZP.getShelfActivities(e)),
    f = (0, l.e7)([a.Z], () => a.Z.testModeEmbeddedApplicationId),
    s = n.map(e => e.application_id),
    v = null != f ? [f, ...s] : s,
    Z = (0, o.Z)(v),
    g = i.useMemo(() => Z.filter(r.lm), [Z]),
    m = i.useMemo(() => null != f && g.length > 0 && g[0].id === f && null != g[0].embeddedActivityConfig ? [{
  ...
  }), [null == t ? void 0 : t.nsfwAllowed, h, m])
}
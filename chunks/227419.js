...
var r = n(735250);
n(470079);
var i = n(392711), a = n.n(i), o = n(481060), s = n(493683), l = n(904245), u = n(911969), c = n(933557), d = n(699516), _ = n(594174), E = n(895924), f = n(689079), h = n(981631), p = n(689938);
function m(e) {
    switch (e) {
...
let I = [
    ...
    })).value(),
    {
        ...
        execute: (e, t) => {
            var n, i;
            let {channel: a} = t, u = (0, c.F6)(a, _.default, d.Z), E = p.Z.Messages.LEAVE_GROUP_DM_TITLE.format({ name: u }), f = p.Z.Messages.LEAVE_GROUP_DM_BODY.format({ name: u }), h = null !== (i = null === (n = e.find(e => 'silent' === e.name)) || void 0 === n ? void 0 : n.value) && void 0 !== i && i;
            async function m() {
                try {
            ...
            a.isManaged() && (E = p.Z.Messages.LEAVE_GROUP_DM_MANAGED_TITLE.format({ name: u }), f = p.Z.Messages.LEAVE_GROUP_DM_MANAGED_BODY.format({ name: u })), (0, o.openModal)(e => (0, r.jsx)(o.ConfirmModal, {
                header: E,

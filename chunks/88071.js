...
var i = r(680643), o = r(581079), a = function (t, e) {
...
t.exports = {
    fromRawTreeStateToRawState: function (t) {
        ...
        return (Array.isArray(e) || o(!1), Array.isArray(e) && e.length) ? (a(e, function (t) {
            var e = n({}, t);
            if (!u(t) || (e.depth = e.depth || 0, s(t), null == t.children || !(t.children.length > 0)))
                delete e.children, r.push(e);
        }), t.blocks = r, n({}, t, { blocks: r })) : t;
    },
    fromRawStateToRawTreeState: function (t) {
        var e = [], r = [];
        return t.blocks.forEach(function (t) {
            var o = u(t), a = t.depth || 0, s = n({}, t, { children: [] });
            if (!o) {
                e.push(s);
                return;
            }

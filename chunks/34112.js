...
function Z(e) {
  ...
  let m = a.useRef(!1);
  a.useEffect(() => {
    if (!m.current && "" !== u.trimStart()) C.default.track(A.rMx.SEARCH_STARTED, {
      search_type: "Roles"
    }), m.current = !0
  }, [u]);
...
function U(e) {
  ...
  }, [E, d]), W = (0, m.useHasGuildRoleItems)(E, d);
  if (F) return (0, s.jsx)("div", {
    ref: k,
  ...
  return (0, s.jsxs)(u.Clickable, {
    ...
    children: [(0, s.jsx)("div", {
      className: r()(v.dragIcon, D.dragSpacing, {
        [v.dragIconHidden]: U || L
      }),
      onMouseEnter: () => B(!0),
      onMouseLeave: () => B(!1),
      ...
      children: [(null === (t = d.tags) || void 0 === t ? void 0 : t.guild_connections) === null ? (0, s.jsx)(I.Z, {
      ...
      children: [(0, s.jsx)(u.CircleIconButton, {

...
var i = n(470079), a = n(399606), s = n(230711), r = n(906732), l = n(18438), o = n(314897), c = n(271383), d = n(430824), u = n(496675), _ = n(914010), E = n(715903), I = n(981631), m = n(372897), T = n(526761), h = n(689938);
function N(e) {
    return (0, a.e7)([
        o.default,
        c.ZP
...
function f(e) {
    let {
        ...
        } = e, {analyticsLocations: E} = (0, r.ZP)(), m = (0, a.e7)([d.Z], () => d.Z.getGuild(t), [t]), h = (0, a.e7)([u.Z], () => null != m && u.Z.can(I.Plq.CHANGE_NICKNAME, m), [m]);
    return [
        i.useCallback(() => {
            if (null == m)
                return;

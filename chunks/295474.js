...
var i = n(470079), a = n(399606), s = n(230711), r = n(906732), l = n(18438), o = n(314897), c = n(271383), d = n(430824), u = n(496675), _ = n(914010), E = n(715903), m = n(981631), I = n(372897), T = n(526761), h = n(689938);
function N(e) {
    return (0, a.e7)([
        o.default,
        c.ZP
...
function p(e) {
    return (0, a.cj)([
        ...
        if (null == a || null == i)
            return t;
        let s = o.default.getId(), r = c.ZP.getMember(i, s), l = (0, E.Ow)(null == r ? void 0 : r.flags);
        if (0 === l.size)
            return t;
...
function f(e) {
    let {
        ...
        } = e, {analyticsLocations: E} = (0, r.ZP)(), I = (0, a.e7)([d.Z], () => d.Z.getGuild(t), [t]), h = (0, a.e7)([u.Z], () => null != I && u.Z.can(m.Plq.CHANGE_NICKNAME, I), [I]);
    return [
        i.useCallback(() => {
            if (null == I)
                return;
            let e = m.oAB.PROFILE_CUSTOMIZATION, t = T.NB.GUILD;
            h ? (0, l.Fq)(I, null != c ? c : E) : t = T.NB.USER_PROFILE, s.Z.open(e, t, {
                scrollPosition: n,
                analyticsLocation: o,
                analyticsLocations: c,
                openWithoutBackstack: _

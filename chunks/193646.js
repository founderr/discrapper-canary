...
var s = o(735250);
o(470079);
var a = o(481060), c = o(493683), E = o(239091), i = o(108843), r = o(100527), t = o(299206), u = o(87620), l = o(505737), O = o(389052), _ = o(822972), N = o(622724), I = o(981631), S = o(689938);
e.default = (0, i.Z)(function (n) {
    let {
            ...
            onBlock: () => Z({ action: 'BLOCK' }),
            onUnblock: () => Z({ action: 'UNBLOCK' })
        }), A = (0, _.Z)({
            user: e,
            color: 'danger',
            location: r.Z.USER_PROFILE_ACTIONS_MENU,
            onAction: () => Z({ action: 'REMOVE_FRIEND' })
        }), T = (0, N.Z)({
            user: e,
            guildId: i,
            color: 'danger',
            location: r.Z.USER_PROFILE_ACTIONS_MENU,
            onAction: () => Z({ action: 'REPORT' })
        }), L = (0, t.Z)({
            id: e.id,
            label: S.Z.Messages.COPY_ID_USER,
            onSuccess: () => {
                Z({ action: 'COPY_USER_ID' }), (0, E.Zy)();
            }
        }), f = (0, s.jsx)(a.MenuItem, {
            id: 'user-message',
            label: S.Z.Messages.USER_POPOUT_MESSAGE,
            action: () => {
                Z({ action: 'SEND_MESSAGE' }), c.Z.openPrivateChannel(e.id, !1, !1, r.Z.USER_PROFILE_ACTIONS_MENU), M();
            }
        }), b = [];
    if (!p && !o)
        switch (U) {
    ...
    return (0, s.jsxs)(a.Menu, {
        ...
        children: [
            ...
            (0, s.jsx)(a.MenuGroup, { children: b }),
            null != L ? (0, s.jsx)(a.MenuGroup, { children: L }) : null
        ]
    });
}, [
    r.Z.CONTEXT_MENU,

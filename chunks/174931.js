      ...
      (0, i.jsxs)('div', {
        ...
        children: [
          ...
          (() => {
            ...
            if (P)
              return (0, i.jsx)(A, {
                children: (null == b ? void 0 : b.status) === p.O0b.CANCELED ? C.Z.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CANCELED_LABEL : C.Z.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CURRENT_TIER_LABEL
              });
            if (D)

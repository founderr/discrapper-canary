...
class v extends s.PureComponent {
  componentDidUpdate(e) {
    this.props.locked && !e.locked && null != this.state.lastLayoutUpdate && (r.Z.track(I.rMx.OVERLAY_LAYOUT_UPDATED, this.state.lastLayoutUpdate), this.setState({
  ...
  constructor(...e) {
    super(...e), S(this, "state", {
      ...
      null != e && (e.pinned && r.Z.setPreviewInGameMode(!0), this.setState({
        dragging: !0
      }))
      ...
      null != e && (e.pinned && r.Z.setPreviewInGameMode(!1), this.setState({
        dragging: !1
      }))
    })
  }
}
let x = a.ZP.connectStores([c.Z, d.Z], e => {
  let {
    widgetId: t
...
t.Z = a.ZP.connectStores([c.Z, u.Z], () => ({

...
function A(e) {
  ...
  l < 1 && (c = Math.round(n * l), E = Math.round(i * l)), null != a && (c = Math.min(c, a)), null != s && (E = Math.min(E, s));
  let I = (0, d.default)();
  return c *= I,
    function(e) {
      let {
      ...
      return null != l && (_.format = l), null != u && (_.quality = u), (a !== n || s !== i) && (_.width = 0 | a, _.height = 0 | s), !r().isEmpty(_) && (d += "?" + o.stringify(_)), d
    }({
      src: t,
      sourceWidth: n,
      sourceHeight: i,

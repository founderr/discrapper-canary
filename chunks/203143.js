...
async function G(e) {
  let {
    ...
    channelId: t,
    messageId: n
  }), l = i().difference(a, s), r = i().difference(s, a), d = N.default.getId(), c = [...l.map(e => ({
...
async function w(e) {
  ...
  try {
    if (null != u && u.length > 0) {
      var _;
      let e = null !== (_ = N.default.getToken()) && void 0 !== _ ? _ : "";
...
t.default = {
  handlePollAnswerTapped: function(e) {
    ...
    (0, v.updatePollState)(i, r, e => {
      ...
      } = x(null === (t = o.poll) || void 0 === t ? void 0 : t.answers, l);
      return _.default.trackWithMetadata(P.AnalyticEvents.POLL_VOTE_SELECTED, {
        channel_id: i,
        message_id: r,

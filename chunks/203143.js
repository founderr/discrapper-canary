...
async function y(e) {
  let {
    ...
    channelId: t,
    messageId: n
  }), s = l().difference(a, i), r = l().difference(i, a), d = f.default.getId(), u = [...s.map(e => ({
      ...
      ! function(e) {
        ...
        (0, M.eu)(t, n, e => {
          ...
          let s = null == e || !e.showResults,
            l = S.Z.getMessage(t, n),
            r = null != l ? l.reactions.reduce((e, t) => {
              var n, i;
...
async function F(e) {
  ...
  try {
    ...
    if ("poll" === (e instanceof E.Hx ? e : new E.Hx(e)).getAnyErrorMessage() && null != e.text) throw {
      ...e,

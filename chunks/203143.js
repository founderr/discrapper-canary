...
var i = n(512722), a = n.n(i), s = n(392711), r = n.n(s), l = n(263568), o = n(442837), c = n(570140), d = n(668781), u = n(749210), _ = n(904245), E = n(881052), I = n(367907), m = n(41776), T = n(566006), h = n(48854), N = n(869765), p = n(314897), f = n(592125), C = n(703558), g = n(607744), S = n(375954), A = n(117530), x = n(553803), R = n(316758), O = n(467531), M = n(798628), v = n(918088), L = n(981631), Z = n(689938);
function P(e, t) {
    let n = [...t], i = 0, a = 0;
    for (let t of n) {
        var s;
...
function b(e) {
    ...
    d.Z.show({
        ...
        onConfirm: () => {
            u.Z.joinGuild(t, { source: L.vtS.POLL_ALERT });
        }
    });
}
function D(e) {
...
async function y(e) {
    let {
            ...
            channelId: t,
            messageId: n
        }), s = r().difference(a, i), l = r().difference(i, a), d = p.default.getId(), u = [
            ...s.map(e => ({
...
async function G(e) {
    ...
    case 'showVotes':
        !function (e) {
            ...
            (0, M.eu)(t, n, e => {
                var i, a;
                let s = null == e || !e.showResults, r = S.Z.getMessage(t, n), l = null != r ? r.reactions.reduce((e, t) => {
                        var n, i;
...
async function F(e) {
    let {
            ...
            var t, n;
            let i = null == c ? void 0 : c.findIndex(t => t.id === e.localCreationAnswerId), a = { attachment_ids: -1 !== i ? [''.concat(i)] : void 0 };
            ...
            return null != s && (null != s.id ? a.emoji = {
                id: s.id,
                name: ''
            } : null != s.optionallyDiverseSequence && (a.emoji = { name: s.optionallyDiverseSequence })), { poll_media: a };
        }), u = {
    ...
    try {
        if (null != c && c.length > 0) {
            var I;
            let e = null !== (I = p.default.getToken()) && void 0 !== I ? I : '';
            await R.sk({
                channel: t,
                items: c,
                token: e,
            ...
            await _.Z.sendPollMessage(t.id, u);
        null == o || o();
    } catch (e) {
...
t.Z = {
    handlePollAnswerTapped: function (e) {
        ...
        let {
            ...
            }(s), {tapShouldOpenVotersModal: c} = null !== (n = (0, v.Tk)(o)) && void 0 !== n ? n : {};
        if (!0 === c) {
            D({
                channelId: r,
                messageId: l,
        ...
        (0, M.eu)(r, l, e => {
            ...
            let a = { ...e }, s = new Set(a.selectedAnswerIds);

...
async function F(e) {
  ...
  if (!C.default.canChatInGuild(s.guild_id)) {
    d.default.show({
      title: P.default.Messages.POLL_GUILD_MEMBER_UNVERIFIED_TITLE,
      body: P.default.Messages.POLL_GUILD_MEMBER_UNVERIFIED_SUBTITLE
    });
    return
  }

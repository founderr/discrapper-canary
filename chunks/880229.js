...
let U = (0, R.hQ)(),
  G = (0, R.hQ)(),
  P = (0, O.Mg)(I.Z.IMPORT_BENEFITS_MODAL_ROLE_ICON_SIZE);
...
function F(e) {
  ...
  return s.length > 0 ? (0, i.jsxs)(T.FormSection, {
    title: t,
    className: b.section,
    children: [s.length - a.size > 1 && (0, i.jsx)("div", {
      className: b.list,
      children: (0, i.jsx)(y, {
...
function k(e) {
  let {
    ...
    onSubmit: l,
    onClose: o
  } = e, c = n.role_benefits.benefits, [d, u] = r.useState(() => new Set(c)), _ = r.useMemo(() => c.filter(A.rC), [c]), I = (0, v.Z)(_), m = r.useMemo(() => c.filter(A.lL), [c]), N = r.useMemo(() => new Set(I.filter(e => s.some(t => t.ref_id === e.ref_id))), [I, s]), S = r.useMemo(() => new Set(m.filter(e => a.some(t => (0, E.Z)(e, t)))), [a, m]), h = (0, R.Dt)();
...
function Y(e) {
  ...
  return (0, i.jsxs)("form", {
    ...
    children: [(0, i.jsxs)(T.ModalHeader, {
      ...
      className: b.modalContent,
      children: [_.length > 1 && (0, i.jsx)("div", {
        className: b.list,
        children: (0, i.jsx)(y, {
          icon: (0, i.jsx)(T.ChannelListPlusIcon, {
            size: "md",

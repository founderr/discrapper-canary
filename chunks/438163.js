...
function y(e) {
    ...
    let {
            ...
            animate: y = !0,
            onClose: D
        } = e, {analyticsLocations: L} = (0, f.ZP)(E.Z.PROFILE_CUSTOM_STATUS), {trackUserProfileAction: b} = (0, I.KZ)(), M = (0, l.e7)([_.Z], () => _.Z.useReducedMotion), [P] = i.useState(() => new u.V7()), [U, w] = i.useState(!0), x = i.useRef(null), G = i.useRef(null), k = i.useRef(null), B = i.useRef(null), {
            emoji: F,
            state: V
    ...
    i.useLayoutEffect(() => {
        ...
        if (et(j || e <= K), A) {
            var t, n, r, i;
            let e = null !== (r = null === (t = x.current) || void 0 === t ? void 0 : t.getBoundingClientRect().height) && void 0 !== r ? r : z, a = null !== (i = null === (n = k.current) || void 0 === n ? void 0 : n.getBoundingClientRect().height) && void 0 !== i ? i : q;
    ...
    let el = e => {
        ...
        }, eE = o()(v.background, { [v.editable]: $ }), ef = o()({
            [v.statusBubbleShape]: !Z && Y || !ee,
            [v.statusBubbleSingleLineWithTextShape]: ee && Z || X
        }), eh = o()(v.statusBubbleOuter, e_, ef, { [v.statusBubbleOuterAddStatusCursor]: X }), ep = o()(v.statusBubble, ef, {
        ...
        children: (0, r.jsxs)('div', {
            children: [
                ...
                (0, r.jsxs)(c.ClickableContainer, {
                    ...
                    focusProps: { ringClassName: ef },
                    onClick: X ? () => {
                        b({ action: 'PRESS_ADD_CUSTOM_STATUS' }), null == D || D(), (0, c.openModalLazy)(async () => {
                    ...
                    onMouseOver: () => {
                        b({ action: 'HOVER_CUSTOM_STATUS' }), ea(!0), el(!0);
                    },
                    onMouseLeave: () => {
                        ea(!1), el(!1);
                    },

n(47120);
var r, i, a, o, s = n(442837), l = n(570140), u = n(786761), c = n(797316), d = n(594174), _ = n(709054);
let E = {};
function f(e) {
    let {
        threads: t,
...
function p(e) {
    ...
    if (null == l || null == l.firstMessage || r !== l.firstMessage.id)
        return !1;
    let u = d.default.getCurrentUser(), c = null != u && u.id === i;
    if (o && !c)
        return !1;
    E[n] = { ...l }, 'MESSAGE_REACTION_ADD' === t ? E[n].firstMessage = l.firstMessage.addReaction(a, c, e.colors, s) : E[n].firstMessage = l.firstMessage.removeReaction(a, c, s);
}
...
o = 'ForumPostMessagesStore', (a = 'displayName') in (i = m) ? Object.defineProperty(i, a, {
    ...
    MESSAGE_REACTION_ADD_MANY: function (e) {
        ...
        if (null == i || null == i.firstMessage || n !== i.firstMessage.id)
            return !1;
        let a = d.default.getCurrentUser(), o = i.firstMessage.addReactionBatch(r, null == a ? void 0 : a.id);
        E[t] = {
            ...i,
            firstMessage: o
        };

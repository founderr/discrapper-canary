...
function Y(e) {
  ...
  } = (0, c.useStateFromStoresObject)([x.default], () => x.default.getState()), es = (0, c.useStateFromStores)([v.default, I.default], () => I.default.getChannel(v.default.getVoiceChannelId())), ei = (0, c.useStateFromStores)([N.default, M.default], () => (0, b.isWindows)() ? (0, w.default)(N.default, M.default) : null), er = (0, c.useStateFromStores)([L.default], () => {
  ...
  let ef = (0, j.useUID)();
  let [em, eS] = i.useState((Y = q, Q = Z, Y ? 0 : Q ? 1 : 2)), [eE, e_] = i.useState(null), [eh, eN] = i.useState(!1), [eC, eg] = i.useState(null), [ep, eA] = i.useState(null), [ex, eI] = i.useState(null), [eR, eT] = i.useState(et), [ev, eL] = i.useState(el), [eM, eO] = i.useState(ea), [ej, eD] = i.useState(en), [eb, eP] = i.useState(null != J ? J : null), eU = null !== (n = null == es ? void 0 : es.id) && void 0 !== n ? n : eC;
  async function eG() {
    var e, t, l;
    ...
    let f = (0, V.default)(ei, ep, N.default.getRunningGames()),
  ...
  i.useEffect(() => {
    let e = (0, b.isWindows)() ? (0, w.default)(N.default, M.default) : null,
  ...
  async function ek(e) {
    ...
    let t = (0, V.default)(ei, ep, N.default.getRunningGames()),

...
y(b, "defaultProps", {
  ...
  let n = e.channel.id,
    ...
    r = (0, o.useStateFromStores)([m.default], () => m.default.getAllApplicationStreamsForChannel(n).length > 0),
    ...
    I = !1,
    S = !1;
  return C && (I = i === R.ChannelModes.VOICE, S = i === R.ChannelModes.VIDEO), (0, a.jsx)(b, {
    ...e,
    ref: t,
    channelName: l,
    unread: d > 0,

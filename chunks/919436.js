n(411104), n(47120);
var i, l = n(735250), r = n(470079), a = n(920906), s = n(91192), o = n(442837), c = n(481060), u = n(239091), d = n(358221), h = n(43267), p = n(933557), _ = n(93687), f = n(266076), m = n(199902), g = n(19780), C = n(306680), I = n(944486), E = n(594174), N = n(451478), x = n(880080), S = n(682662), v = n(662146), Z = n(674552), T = n(981631), L = n(453528);
function A(e, t, n) {
...
class R extends (i = r.PureComponent) {
    componentWillEnter(e) {
        ...
        e(), t.update({
            ...
            scale: 1,
            config: M
        }).start().then(() => this.setState({ animating: !1 }));
    }
    ...
    componentWillLeave(e) {
        let {controller: t} = this.state;
        this.setState({ animating: !0 }, () => t.update({
            immediate: !N.Z.isFocused(),
            height: 0,
            opacity: 0,
            scale: 0,
    ...
    getChannelIcon() {
        let {channel: e} = this.props, t = e.type === T.d4z.DM ? E.default.getUser(e.getRecipientId()) : null;
    ...
    constructor(...e) {
        super(...e), A(this, 'state', {
            ...
            let {channel: t} = this.props, i = t.type === T.d4z.DM ? E.default.getUser(t.getRecipientId()) : null;

...
function E(e, t) {
  ...
  return (0, a.default)([u.default, o.default, l.default], () => {
    var e, t;
    return null != n && null != E && h && n.hasFeature(c.GuildFeatures.GUILD_SERVER_GUIDE) && !r.hasFlag(null !== (t = null === (e = l.default.getSelfMember(n.id)) || void 0 === e ? void 0 : e.flags) && void 0 !== t ? t : 0, f.GuildMemberFlags.COMPLETED_HOME_ACTIONS) && o.default.hasMemberAction(n.id, E.id) && !u.default.hasCompletedActionForChannel(n.id, E.id)
  })
}
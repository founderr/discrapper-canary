  ...
  if (0 !== s) {
    let r = function(t, n) {
      ...
      for (let a = 0; a < v; a++) {
        ...
        I > A && I > c && null != i && N > t.length && l.push({
    ...
    if (null == n)
      for (let e of d)
        e.stickers.length > 0 ? (p++, r(e.stickers, e.type, (null == t ? void 0 : t.has(e.id)) === !0)) : e.type === m.Ih.EMPTY_GUILD_UPSELL && (f[I] = 0, I++);
    else
      n.sendable.length > 0 && r(n.sendable, m.Ih.SEARCH_RESULTS), n.sendableWithPremium.length > 0 && r(n.sendableWithPremium, m.Ih.SEARCH_RESULTS);
  }
  return {
    rowCount: p,
    rowCountBySection: f,
...
return (0, i.e7)([I.Z], () => {
  for (let n of I.Z.getAllStickersIterator())
    if ((0, f.kl)(n, t, e))
      return !0;
  return !1;
}, [

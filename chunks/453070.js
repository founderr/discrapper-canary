...
var r = n(470079), i = n(442837), a = n(889161), o = n(695346), s = n(516373), l = n(430824), u = n(914010), c = n(771845), d = n(594174), _ = n(267642), E = n(700785), f = n(285651), h = n(268350), p = n(822179), m = n(926491), I = n(373228), T = n(378233), g = n(981631), S = n(689938);
let A = e => {
        R();
        ...
        return r.useMemo(() => {
            let e = Math.floor((o - i + s) / (c + s)), r = Math.floor(Math.max(s, (o - i - c * e) / (e - 1))), E = [], f = [], h = [], p = 0, m = 0, g = 0;
            if (0 !== o) {
                let r = function (t, n) {
                    let r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = (0, T.J8)(t[0]) ? l.Z.getGuild(t[0].guild_id) : void 0, {canCreateExpressions: o} = (0, a.Gw)(i), s = u.Z.getGuildId(), c = d.findIndex(e => e.type === I.Ih.FAVORITE), A = d.findIndex(e => e.type === I.Ih.RECENT), N = t.length;
                    null != i && s === i.id && o && t.length < (0, _.A3)(i.premiumTier) && N++;
                    let v = Math.ceil(N / e);
                    f[m] = r ? 0 : v;
                    for (let a = 0; a < v; a++) {
                        let o = a * e, s = o + e, l = t.slice(o, s).map((e, t) => ({
                                type: I.al.STICKER,
                                sticker: e,
        ...
        let t = (0, i.e7)([m.Z], () => m.Z.getAllGuildStickers()), n = (0, i.Wu)([
                c.ZP,
                l.Z
            ], () => {
                let e = c.ZP.getFlattenedGuildIds(), t = [];
                return e.forEach(e => {
        ...
        return r.useMemo(() => {
            ...
            if ((null == e ? void 0 : e.getGuildId()) != null) {
                let t = l.Z.getGuild(e.getGuildId()), {canManageAllExpressions: n} = (0, a.Gw)(t), i = r.findIndex(t => t.id === e.getGuildId());
...
let M = e => {
        let t = L(), {
            ...
            }), []), o = (0, i.e7)([d.default], () => d.default.getCurrentUser()), s = C(e);
        return r.useMemo(() => {
            var r;
            let i = n.map(T.z), l = {
                    type: I.Ih.FAVORITE,
        ...
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = (0, i.e7)([m.Z], () => m.Z.getStickerById(e.id)), [a, o] = r.useState(!0), [s, l] = r.useState(!1), u = (0, T.J8)(e) || (0, T.jl)(e);
        return (r.useEffect(() => {
            (async () => {
                if (t && !u && null == n && a && !s) {
                    o(!1);

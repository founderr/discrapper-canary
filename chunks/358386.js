...
function s(e, t) {
  let s = (0, u.useStateFromStores)([o.default], () => o.default.getCurrentUser()),
    c = (0, u.useStateFromStores)([i.default], () => i.default.getGuild(t));
  return null == c || null == s || e.id === c.ownerId || e.bot || !c.isOwnerWithRequiredMfaLevel(s) ? null : (0, l.jsx)(a.MenuItem, {

...
class v extends s.Z {
    ...
    setClipsSource(e) {
        ...
        let { frameRate: r, resolution: i } = e.quality,
            { id: a, soundshareId: s, useLoopback: l, useVideoHook: u, useGraphicsCapture: c, useQuartzCapturer: f, allowScreenCaptureKit: _, hdrCaptureMode: p } = e.desktopDescription;
    ...
    setSidechainCompressionStrength(e) {
        var t, n, r, i, a, s;
        let o = 100 - e;
        let l = ((r = o), (i = p.Zq), i + ((p.WA - i) * r) / 100);
        let u = ((a = o), (s = p.QO), s + ((p.JA - s) * a) / 100);

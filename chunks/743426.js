...
var r = n(264344), i = n.n(r), a = n(259443), o = n(47770), s = n(46973), l = n(734298), u = n(997545), c = n(501950), d = n(801334), _ = n(992774), E = n(656795), f = n(650886), h = n(149396);
function p(e, t, n) {
...
class I extends o.Z {
    ...
    async setVideoInputDevice(e) {
        let t = (await this.getVideoInputDevices()).find(t => t.id === e), n = null != t ? t.id : h.Av;
    ...
    setH264Enabled(e) {
        (0, _.zS)().setTransportOptions({ h264Enabled: e });
    }
    setAv1Enabled(e) {
        (0, _.zS)().setTransportOptions({ av1Enabled: e });
    }
    setH265Enabled(e) {
        (0, _.zS)().setTransportOptions({ h265Enabled: e });
    }
    getCodecSurvey() {
    ...
    writeAudioDebugState() {
        return new Promise((e, t) => {
            let {writeAudioDebugState: n} = (0, _.zS)();
    ...
    setMaxSyncDelayOverride(e) {
        let {setMaxSyncDelayOverride: t} = (0, _.zS)();
        null != t && t(e);
    }
    ...
    startLocalAudioRecording(e) {
        return new Promise((t, n) => {
            let {startLocalAudioRecording: r} = (0, _.zS)();
            null != r ? r(e, e => {
    ...
    constructor() {
        ...
        super(), e = this, p(this, 'Video', f.Z), p(this, 'Camera', E.Z), p(this, 'videoInputDeviceId', h.Av), p(this, 'connections', new Set()), p(this, 'speedTesters', new Set()), p(this, 'lastVoiceActivity', -1), p(this, 'audioSubsystem', 'standard'), p(this, 'audioLayer', ''), p(this, 'deviceChangeGeneration', 0), p(this, 'consecutiveWatchdogFailures', 0), p(this, 'codecSurvey', null), p(this, 'logger', new a.Y('MediaEngineNative')), p(this, 'handleDeviceChange', function () {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [];

...
class Y extends a.PureComponent {
  ...
  renderCustomNotificationSoundOptions() {
    ...
    if (!!e) return (0, l.jsxs)(l.Fragment, {
  ...
  render() {
    return (0, l.jsxs)(E.ModalRoot, {
      ...
      children: [this.renderHeader(), (0, l.jsxs)(E.ModalContent, {

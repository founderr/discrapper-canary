...
var n, i, l = t(735250), a = t(470079), r = t(392711), o = t.n(r), d = t(913527), c = t.n(d), u = t(699581), h = t(374470), N = t(442837), S = t(692547), E = t(481060), m = t(92114), g = t(798140), _ = t(740504), T = t(933557), x = t(471445), I = t(423589), O = t(74888), C = t(444899), M = t(11352), p = t(610617), v = t(777861), L = t(131704), j = t(592125), Z = t(324067), A = t(650774), R = t(430824), f = t(699516), b = t(9156), U = t(594174), G = t(285952), P = t(823379), F = t(63063), D = t(621600), k = t(981631), B = t(969943), w = t(689938), H = t(329007);
function y(e, s, t) {
...
class Y extends a.PureComponent {
    ...
    componentDidUpdate(e, s) {
        let {lastSelected: t} = this.state, n = null != t ? this._channelRefs[t] : null;
        ...
        if (this.props.channelOverrides !== e.channelOverrides) {
            ...
            e = new Set(e), (0, I.OD)(this.props.channelOverrides).forEach(s => e.add(s)), this.setState({ overrides: e });
        }
    }
    handleCheckboxChange(e, s, t) {
        m.Z.updateGuildNotificationSettings(this.props.guildId, { [e]: s }, t);
    }
    handleRadioChange(e, s, t) {
        let {value: n} = s;
        m.Z.updateGuildNotificationSettings(this.props.guildId, { [e]: n }, t);
    }
    renderHeader() {
    ...
    renderNotificationOptions() {
        ...
        return (0, l.jsxs)(E.FormItem, {
            ...
            children: [
                ...
                (0, l.jsx)(E.FormSwitch, {
                    onChange: e => {
                        m.Z.updateGuildNotificationSettings(r, { notify_highlights: e ? k.gLR.DISABLED : k.gLR.ENABLED }, D.UE.highlights(!e));
                    },
    ...
    renderChannelNotifications() {
        let {
                ...
                categories: i,
                checkboxColor: a
            } = this.props, {overrides: r} = this.state, o = t.map(t => {
                let {channel: o} = t;
    ...
    constructor(...e) {
        super(...e), y(this, '_scroller', null), y(this, '_channelRefs', {}), y(this, 'state', {
            ...
            if (null == s)
                return e.label;
            let t = j.Z.getChannel(s.parent_id), n = null != t ? t.name : null;
...
function V(e) {
    let {
        ...
        }), i = M.Y.useExperiment({ location: 'connected_notification_settings' }, { autoTrackExposure: !0 }).enabled, a = (0, E.useToken)(S.Z.unsafe_rawColors.GREEN_360).hex();
    return (0, l.jsx)(Y, {
        ...n,
        ...t,

var r = n(470079), i = n(844303), a = n(818966);
t.Z = function (e) {
    var t = e.onClick, n = e.hsl, o = (0, i.default)({
            default: {
    ...
    return r.createElement('div', { style: o.swatches }, r.createElement('div', { style: o.swatch }, r.createElement(a.Z, {
        hsl: n,
        offset: '.80',
        active: 0.1 > Math.abs(n.l - 0.8) && 0.1 > Math.abs(n.s - 0.5),
        onClick: t,
        first: !0
    })), r.createElement('div', { style: o.swatch }, r.createElement(a.Z, {
        hsl: n,
        offset: '.65',

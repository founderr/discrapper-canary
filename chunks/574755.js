...
var n = s(735250), a = s(470079), i = s(442837), r = s(704215), o = s(481060), l = s(906732), c = s(605236), d = s(441167), _ = s(695346), E = s(131951), u = s(924557), T = s(435064), I = s(779618), S = s(39604), N = s(703288), C = s(491758), m = s(183632), A = s(689938), h = s(6679), g = s(885582), O = s(549856);
function p(e) {
    let {
            className: t,
            showHeader: s = !0
        } = e, p = _.tU.useSetting(), {enableViewerClipping: R} = d.Z.useExperiment({ location: 'Clips Settings' }, { autoTrackExposure: !1 }), {analyticsLocations: x} = (0, l.ZP)(), M = (0, u.Go)(), {viewerClipsEnabled: f} = (0, i.cj)([T.Z], () => T.Z.getSettings()), D = (0, I.Z)(E.Z);
    return a.useEffect(() => {

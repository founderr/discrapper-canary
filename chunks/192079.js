...
var i = t(19780), c = t(5192), a = t(700785), r = t(427679), l = t(157925), u = t(981631), d = t(71080), o = t(689938);
function _(n, e, t, i) {
    let a = e[0], r = c.ZP.getName(n, t, a), l = null != i ? i : e.length;
    return 1 === l && null != a ? r : null == a ? o.Z.Messages.SPEAKING_COUNT.format({ count: l }) : o.Z.Messages.USER_SUMMARY_WITH_OTHERS.format({
        name: r,
        count: l - 1
    });
}

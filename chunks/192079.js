...
var i = t(19780), u = t(5192), l = t(700785), r = t(427679), a = t(157925), s = t(981631), d = t(71080), c = t(689938);
function o(n, e, t, i) {
    let l = e[0], r = u.ZP.getName(n, t, l), a = null != i ? i : e.length;
    return 1 === a && null != l ? r : null == l ? c.Z.Messages.SPEAKING_COUNT.format({ count: a }) : c.Z.Messages.USER_SUMMARY_WITH_OTHERS.format({
        name: r,
        count: a - 1
    });
}

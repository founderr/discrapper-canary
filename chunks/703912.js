...
async function A(e, t, n) {
    ...
    let k = [];
    if (('string' == typeof x ? (k = x.split(' ').filter((e) => e.length > 0)) : Array.isArray(x) && (k = x), null == g.default.getCurrentUser())) throw new S.Z({ errorCode: f.lTL.OAUTH2_ERROR }, 'Client is not logged in');
    ...
    let B = null != w && (0, p.yE)(w.flags, f.udG.EMBEDDED) && (null === (i = w.integrationTypesConfig) || void 0 === i ? void 0 : i[a.Y.USER_INSTALL]) != null;

...
async function S(e, t, n) {
  ...
  let v = [];
  if ("string" == typeof S ? v = S.split(" ").filter(e => e.length > 0) : Array.isArray(S) && (v = S), null == f.default.getCurrentUser()) throw new _.default({
    errorCode: C.RPCErrors.OAUTH2_ERROR
  ...
  return t(i, a, v, R, r, o, u, h, m, T, p, g, A)
}

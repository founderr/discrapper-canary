...
async function A(e, t, n) {
    ...
    let w = [];
    if (('string' == typeof x ? (w = x.split(' ').filter((e) => e.length > 0)) : Array.isArray(x) && (w = x), null == p.default.getCurrentUser())) throw new S.Z({ errorCode: f.lTL.OAUTH2_ERROR }, 'Client is not logged in');
    ...
    let B = null != k && (0, g.yE)(k.flags, f.udG.EMBEDDED) && (null === (i = k.integrationTypesConfig) || void 0 === i ? void 0 : i[a.Y.USER_INSTALL]) != null;

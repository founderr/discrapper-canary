...
var i = n(664751), s = n(373793), a = n(243814), r = n(149765), l = n(544891), o = n(45792), c = n(433517), d = n(570140), u = n(979200), _ = n(489863), h = n(166148), E = n(307643), I = n(973616), m = n(594174), g = n(630388), p = n(700785), T = n(996106), S = n(186901), f = n(981631);
let C = 'CachedTokens';
async function N(e, t, n) {
    ...
    if (null == S)
        throw new T.Z({ errorCode: f.lTL.OAUTH2_ERROR }, 'No Client ID provided');
    if (null != N)
        throw new T.Z({ errorCode: f.lTL.OAUTH2_ERROR }, 'Redirect URI cannot be used in the RPC OAuth2 Authorization flow');
    let y = [];
    ...
    let j = I.Z.createFromServer(await (0, E.UM)(S)), U = null != j && (0, g.yE)(j.flags, f.udG.EMBEDDED) && (null === (i = j.integrationTypesConfig) || void 0 === i ? void 0 : i[s.Y.USER_INSTALL]) != null;
...
function A(e, t) {
    ...
    if (e.authorization.authing)
        throw new T.Z({ errorCode: f.lTL.INVALID_COMMAND }, 'Already authenticating');
        ...
        [f.Etm.AUTHENTICATE]: (0, o.S)(f.Etm.AUTHENTICATE, {
            handler(n) {
                ...
                if (null == r && s.transport === S.He.IPC) {
                    ...
                    if (null == n)
                        throw new T.Z({ errorCode: f.lTL.INVALID_COMMAND }, 'No application.');
                    let l = a.x.IDENTIFY, o = () => N({
                            ...
                            if (null != a.error) {
                                var r;
                                throw new T.Z({ errorCode: f.lTL.OAUTH2_ERROR }, 'OAuth2 Error: '.concat(a.error, ': ').concat(null !== (r = a.error_description) && void 0 !== r ? r : 'unknown error'));
                            }
                ...
                if (null == r)
                    throw new T.Z({ errorCode: f.lTL.INVALID_TOKEN }, 'No access token provided');
                return A(s, r);
            }
        }),
        [f.Etm.AUTHORIZE]: {
            handler(n) {
                ...
                if (!r)
                    throw new T.Z({ errorCode: f.lTL.INVALID_CLIENTID }, 'No client id provided');
                if (null != s.authorization.accessToken)
                    throw new T.Z({ errorCode: f.lTL.INVALID_COMMAND }, 'Already authenticated');
                if (s.authorization.authing)
                    throw new T.Z({ errorCode: f.lTL.INVALID_COMMAND }, 'Already authing');

...
if (o()(null != e, 'Missing channel in Channel.renderChat'), s)
  return (o()(null != n, 'premium channels must exist within a guild'), null == e ? void 0 : e.isRoleSubscriptionTemplatePreviewChannel()) ? (0, i.jsx)(F.Z, {
    guildId: n.id
  }) : (0, i.jsx)(G.l, {
    guildId: n.id,
...
else if (l === eJ.ULH.SEARCH && null != e)
  return (0, i.jsx)(ep.Z, {
    searchId: e
  });
return null;
...
return (0, i.jsxs)(i.Fragment, {
  children: [
    ...
    (0, i.jsxs)('div', {
      className: l()(e3.chat, {
        [e3.threadSidebarOpen]: p || _,
        [e3.threadSidebarFloating]: p && h
      }),
      children: [
        f ? (0, i.jsx)(I.Z, {
          style: {
        ...
        (0, i.jsxs)('div', {
          className: l()(e3.content, {
            [e3.noChat]: s === eJ.AEg.NO_CHAT
          }),
          children: [
            this.renderChat(),
            this.renderSidebar()
...
super(...e), e5(this, 'state', {
  ...
  switch (e.type) {
    ...
    case eJ.d4z.GUILD_VOICE:
      break;
    case eJ.d4z.DM:
      l.push(this.renderClipsEnabledIndicatorToolbarItem()), l.push(this.renderStreamQualityLiveIndicatorToolbarItem()), l.push((0, i.jsx)(ee.Z, {
        channel: e
      }, 'calls')), l.push((0, i.jsx)(q.Z, {
        channel: e
      }, 'pins')), l.push((0, i.jsx)(et.Z, {
        channel: e,
        tooltip: e4.Z.Messages.GROUP_DM_ADD_FRIENDS
      }, 'invite')), l.push((0, i.jsx)(en.Z, {
        channel: e,
        showCallOrActivityPanel: a || s
      }, 'profile')), l.push((0, i.jsx)(ei.Z, {
        channel: e
      }, 'safety_tools'));
      break;
    case eJ.d4z.GROUP_DM:
      if (l.push(this.renderJoinRequestInterviewButtons()), l.push(this.renderClipsEnabledIndicatorToolbarItem()), l.push(this.renderStreamQualityLiveIndicatorToolbarItem()), l.push((0, i.jsx)(ee.Z, {
          channel: e
        }, 'calls')), l.push((0, i.jsx)(q.Z, {
          channel: e
        }, 'pins')), !e.isManaged()) {
    ...
    case eJ.d4z.PRIVATE_THREAD:
    case eJ.d4z.PUBLIC_THREAD:
      null != t && !t.isForumLikeChannel() && l.push((0, i.jsx)(eI.Z, {
        channel: t
      }, 'browser')), e.isVocalThread() && l.push((0, i.jsx)(ea.Z, {
        channel: e
      }, 'thread-call')), l.push((0, i.jsx)(ex.Z, {
        channel: e
      }, 'notifications')), l.push((0, i.jsx)(q.Z, {
        channel: e
    ...
    case eJ.d4z.GUILD_TEXT:
      l.push((0, i.jsx)(D.Z, {
        channel: e
      }, 'favorites')), l.push((0, i.jsx)(eI.Z, {
        channel: e
      }, 'browser')), !n && l.push((0, i.jsx)(K.Z, {
        channel: e
      }, 'notifications')), l.push((0, i.jsx)(q.Z, {
        channel: e
    ...
    case eJ.d4z.GUILD_FORUM:
    case eJ.d4z.GUILD_MEDIA:
      !n && (l.push((0, i.jsx)(Q.Z, {
        channel: e
      }, 'forum-onboarding')), l.push((0, i.jsx)(K.Z, {
        channel: e
      }, 'notifications'))), !__OVERLAY__ && l.push((0, i.jsx)(Y.Z, {
        channelId: e.id
      }, 'members'));
      break;
    case eJ.d4z.GUILD_DIRECTORY:
...
t.Z = a.memo(function(e) {
  ...
  let {
providedChannel: n
  } = e, [s, l] = a.useState(null), r = (0, m.e7)([eU.Z], () => eU.Z.getChannelId()), o = (0, m.e7)([eU.Z], () => eU.Z.getVoiceChannelId()), c = (0, m.e7)([ej.Z], () => null != n ? n : ej.Z.getChannel(r), [
r,
n
  ]), f = (0, m.e7)([ej.Z], () => ej.Z.getChannel(o), [o]), E = null == c ? void 0 : c.parent_id, g = (0, m.e7)([ej.Z], () => ej.Z.getChannel(E), [E]), C = (0, m.e7)([ey.Z], () => ey.Z.getGuild(null == c ? void 0 : c.guild_id), [c]), {
...
return S.ZP.getSelfEmbeddedActivityForChannel(null !== (e = null == c ? void 0 : c.id) && void 0 !== e ? e : eJ.lds);
  }), Z = (0, m.e7)([S.ZP], () => S.ZP.getActivityPanelMode()), b = null != T && !(0, A.Z)(null == c ? void 0 : c.id) && Z === e$.Ez.PANEL, R = (0, m.e7)([eH.Z], () => null != c && c.isVocalThread() && !u().isEmpty(eH.Z.getVoiceStatesForChannel(c.id)), [c]), j = null != c && c.isPrivate() && !b && x, L = (null == c ? void 0 : c.isGuildVocal()) || j || R, {
welcomeModalChannelId: P
  } = (0, d.TH)(), O = (0, m.e7)([er.Z], () => null != c && er.Z.isLurking(c.guild_id), [c]), D = (0, m.e7)([eM.Z], () => eM.Z.hasSeen(null == c ? void 0 : c.guild_id, O), [
c,
O
  ]), k = (0, m.e7)([
M.Z,
S.ZP
  ], () => null != S.ZP.getConnectedActivityChannelId() && S.ZP.getActivityPanelMode() === e$.Ez.PANEL ? S.ZP.getFocusedLayout() === e$.MI.NO_CHAT ? eJ.AEg.NO_CHAT : eJ.AEg.NORMAL : null != r ? M.Z.getLayout(r) : eJ.AEg.NORMAL, [r]), U = (0, m.e7)([M.Z], () => null != c ? M.Z.getSelectedParticipant(c.id) : null), w = (0, m.e7)([eB.default], () => eB.default.getCurrentUser()), B = (0, es.Z)(C), H = (0, eb.Z)(P, null == C ? void 0 : C.id), {
section: G,
...
r,
c
  ]), W = null == C ? void 0 : C.id, z = (0, m.e7)([eR.ZP], () => eR.ZP.getGuildSidebarState(W), [W]), Y = (0, m.e7)([ew.Z], () => ew.Z.getGuildId()) === eJ.I_8, K = (0, eV.So)(h.q.STREAM_HIGH_QUALITY), q = (0, ec.o)(U, w), X = (0, eo.lL)('Channel', !0, w, q), Q = (0, eW.ZP)(c), J = (0, eW.ZP)(c, !0), $ = null != c && o === c.id, ee = null != c && c.isGuildStageVoice();
  a.useEffect(() => {
var e, t, n;
let i = (0, ed.s1)();
if ((null == i ? void 0 : null === (e = i.location) || void 0 === e ? void 0 : e.state) === e7.Df) {
  let {
    channelId: e
  } = null !== (n = (0, el.Qj)(null == i ? void 0 : null === (t = i.location) || void 0 === t ? void 0 : t.pathname)) && void 0 !== n ? n : {};
  null != e && l(e);
}
  }, []), a.useEffect(() => {
null != s && null != c && ee && c.id === s && !$ && ((0, eE.Cq)(c), l(null));
  }, [
s,
ee
  ]);
...
showCall: !I && L,
showActivityPanel: b,
nsfwAgree: (0, m.e7)([eO.Z], () => eO.Z.didAgree(null == c ? void 0 : c.guild_id)),
isMobile: (0, m.e7)([eD.Z], () => (null == c ? void 0 : c.type) === eJ.d4z.DM && eD.Z.isMobileOnline(c.getRecipientId()), [c]),
isUnavailable: (0, m.e7)([eP.Z], () => (null == c ? void 0 : c.guild_id) != null && eP.Z.isUnavailable(c.guild_id), [c]),
showRealNameModal: B,

...
class e5 extends l.PureComponent {
  ...
  renderSidebar() {
    ...
    else if (i === eq.ChannelSections.PROFILE && t.isPrivate() && !r && !u) return (0, a.jsx)(ex.default, {
      location: "Channel",
      channel: t

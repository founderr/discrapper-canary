...
if (o()(null != e, 'Missing channel in Channel.renderChat'), s)
  return (o()(null != n, 'premium channels must exist within a guild'), null == e ? void 0 : e.isRoleSubscriptionTemplatePreviewChannel()) ? (0, i.jsx)(W.Z, {
    guildId: n.id
  }) : (0, i.jsx)(V.l, {
    guildId: n.id,
...
if (e.isGuildVocal())
  return null;
if (e.isDirectory())
  return o()(null != n, 'directory channels must exist within a guild'), (0, i.jsx)(y.Z, {
    channel: e,
    guild: n
  });
  ...
  children: [
    ...
    (0, i.jsxs)('div', {
      ...
      children: [
        ...
        (0, i.jsxs)('div', {
          className: l()(e5.content, {
            [e5.noChat]: s === e$.AEg.NO_CHAT
          }),
          children: [
            this.renderChat(),
            this.renderSidebar()
...
super(...e), e6(this, 'state', {
  ...
  o()(null == e ? void 0 : e.isPrivate(), 'Missing private channel in Channel.openUserProfile'), (0, eZ.openUserProfileModal)({
    userId: e.getRecipientId(),
    guildId: e.guild_id,
    channelId: e.id,
    analyticsLocation: {
      section: e$.jXE.CHANNEL_HEADER
    }
  });
  ...
  return (null == e ? void 0 : e.hasFlag(eJ.zZ.IS_JOIN_REQUEST_INTERVIEW_CHANNEL)) ? (0, i.jsx)(G.Z, {
    channelId: e.id,
  ...
  return (null == e ? void 0 : e.type) !== e1.fO.STREAM ? null : (0, i.jsx)(w.Z, {
  ...
  switch (e.type) {
    ...
    case e$.d4z.GUILD_VOICE:
      break;
    case e$.d4z.DM:
      l.push(this.renderClipsEnabledIndicatorToolbarItem()), l.push(this.renderStreamQualityLiveIndicatorToolbarItem()), l.push((0, i.jsx)(et.Z, {
        channel: e
      }, 'calls')), l.push((0, i.jsx)(X.Z, {
        channel: e
      }, 'pins')), l.push((0, i.jsx)(en.Z, {
        channel: e,
        tooltip: e3.Z.Messages.GROUP_DM_ADD_FRIENDS
      }, 'invite')), l.push((0, i.jsx)(ei.Z, {
        channel: e,
        showCallOrActivityPanel: a || s
      }, 'profile')), l.push((0, i.jsx)(ea.Z, {
        channel: e
      }, 'safety_tools'));
      break;
    case e$.d4z.GROUP_DM:
      if (l.push(this.renderJoinRequestInterviewButtons()), l.push(this.renderClipsEnabledIndicatorToolbarItem()), l.push(this.renderStreamQualityLiveIndicatorToolbarItem()), l.push((0, i.jsx)(et.Z, {
          channel: e
        }, 'calls')), l.push((0, i.jsx)(X.Z, {
          channel: e
        }, 'pins')), !e.isManaged()) {
    ...
    case e$.d4z.PRIVATE_THREAD:
    case e$.d4z.PUBLIC_THREAD:
      null != t && !t.isForumLikeChannel() && l.push((0, i.jsx)(ex.Z, {
        channel: t
      }, 'browser')), e.isVocalThread() && l.push((0, i.jsx)(es.Z, {
        channel: e
      }, 'thread-call')), l.push((0, i.jsx)(eT.Z, {
        channel: e
      }, 'notifications')), l.push((0, i.jsx)(X.Z, {
        channel: e
      }, 'pins')), !e.isArchivedThread() && l.push((0, i.jsx)(K.Z, {
        channelId: e.id
      }, 'members')), null != t && (0, N.Lp)(e) && l.push((0, i.jsx)(Q.Z, {
        channel: e
      }, 'summaries')), l.push((0, i.jsx)(eN.Z, {
        channel: e
      }, 'threads-overflow'));
      break;
    case e$.d4z.GUILD_ANNOUNCEMENT:
    case e$.d4z.GUILD_TEXT:
      l.push((0, i.jsx)(k.Z, {
        channel: e
      }, 'favorites')), l.push((0, i.jsx)(ex.Z, {
        channel: e
      }, 'browser')), !n && l.push((0, i.jsx)(q.Z, {
        channel: e
      }, 'notifications')), l.push((0, i.jsx)(X.Z, {
        channel: e
      }, 'pins')), l.push((0, i.jsx)(K.Z, {
        channelId: e.id
      }, 'members')), (0, N.Lp)(e) && l.push((0, i.jsx)(Q.Z, {
        channel: e
      }, 'summaries'));
      break;
    case e$.d4z.GUILD_FORUM:
    case e$.d4z.GUILD_MEDIA:
      !n && (l.push((0, i.jsx)(J.Z, {
        channel: e
      }, 'forum-onboarding')), l.push((0, i.jsx)(q.Z, {
        channel: e
      }, 'notifications'))), !__OVERLAY__ && l.push((0, i.jsx)(K.Z, {
        channelId: e.id
      }, 'members'));
      break;
    case e$.d4z.GUILD_DIRECTORY:
  ...
  switch (e.type) {
    ...
    case e$.d4z.PRIVATE_THREAD:
    case e$.d4z.PUBLIC_THREAD:
      !e.isArchivedThread() && t.push((0, i.jsx)(K.Z, {
        channelId: e.id
      }, 'members'));
      break;
    case e$.d4z.GUILD_ANNOUNCEMENT:
  ...
  return (0, i.jsxs)('div', {
    ...
    children: [
      (0, i.jsxs)($.Z, {
        ...
        channelId: e.id,
        channelType: e.type,
        hideSearch: e.isDirectory() || h && !(0, em.X)(),
        showDivider: h && !(0, em.X)(),
...
t.Z = a.memo(function(e) {
  ...
  let {
providedChannel: n
  } = e, [s, l] = a.useState(null), r = (0, p.e7)([ew.Z], () => ew.Z.getChannelId()), o = (0, p.e7)([ew.Z], () => ew.Z.getVoiceChannelId()), c = (0, p.e7)([eL.Z], () => null != n ? n : eL.Z.getChannel(r), [
r,
n
  ]), f = (0, p.e7)([eL.Z], () => eL.Z.getChannel(o), [o]), E = null == c ? void 0 : c.parent_id, g = (0, p.e7)([eL.Z], () => eL.Z.getChannel(E), [E]), C = (0, p.e7)([eD.Z], () => eD.Z.getGuild(null == c ? void 0 : c.guild_id), [c]), {
needSubscriptionToAccess: I
  } = (0, F.Z)(null !== (t = null == c ? void 0 : c.id) && void 0 !== t ? t : void 0), x = (0, p.e7)([b.Z], () => {
...
return S.ZP.getSelfEmbeddedActivityForChannel(null !== (e = null == c ? void 0 : c.id) && void 0 !== e ? e : e$.lds);
  }), Z = (0, p.e7)([S.ZP], () => S.ZP.getActivityPanelMode()), R = null != T && !(0, A.Z)(null == c ? void 0 : c.id) && Z === e0.Ez.PANEL, j = (0, p.e7)([eG.Z], () => null != c && c.isVocalThread() && !u().isEmpty(eG.Z.getVoiceStatesForChannel(c.id)), [c]), L = null != c && c.isPrivate() && !R && x, P = (null == c ? void 0 : c.isGuildVocal()) || L || j, {
welcomeModalChannelId: O
  } = (0, d.TH)(), y = (0, p.e7)([eo.Z], () => null != c && eo.Z.isLurking(c.guild_id), [c]), k = (0, p.e7)([eb.Z], () => eb.Z.hasSeen(null == c ? void 0 : c.guild_id, y), [
c,
y
  ]), U = (0, p.e7)([
b.Z,
S.ZP
  ], () => null != S.ZP.getConnectedActivityChannelId() && S.ZP.getActivityPanelMode() === e0.Ez.PANEL ? S.ZP.getFocusedLayout() === e0.MI.NO_CHAT ? e$.AEg.NO_CHAT : e$.AEg.NORMAL : null != r ? b.Z.getLayout(r) : e$.AEg.NORMAL, [r]), w = (0, p.e7)([b.Z], () => null != c ? b.Z.getSelectedParticipant(c.id) : null), B = (0, p.e7)([eH.default], () => eH.default.getCurrentUser()), H = (0, el.Z)(C), G = (0, eR.Z)(O, null == C ? void 0 : C.id), {
section: V,
...
r,
c
  ]), z = null == C ? void 0 : C.id, Y = (0, p.e7)([ej.ZP], () => ej.ZP.getGuildSidebarState(z), [z]), K = (0, p.e7)([eB.Z], () => eB.Z.getGuildId()) === e$.I_8, q = (0, eV.So)(h.q.STREAM_HIGH_QUALITY), X = (0, eu.o)(w, B), Q = (0, ec.lL)('Channel', !0, B, X), J = (0, eW.ZP)(c), $ = (0, eW.ZP)(c, !0), ee = null != c && o === c.id, et = null != c && c.isGuildStageVoice();
  (0, M.Z)({
onTransition: void 0
  }), a.useEffect(() => {
var e, t, n;
...
if ((null == i ? void 0 : null === (e = i.location) || void 0 === e ? void 0 : e.state) === e4.Df) {
  let {
    channelId: e
  } = null !== (n = (0, er.Qj)(null == i ? void 0 : null === (t = i.location) || void 0 === t ? void 0 : t.pathname)) && void 0 !== n ? n : {};
  null != e && l(e);
}
  }, []), a.useEffect(() => {
...
(e || t) && (0, D.EW)(m.z.ACTIVITY_GDM_CALL_TOOLTIP, {
...
guildSidebarState: Y,
guild: C,
searchId: (0, p.e7)([eU.Z], () => eU.Z.getCurrentSearchId()),
showCall: !I && P,
showActivityPanel: R,
nsfwAgree: (0, p.e7)([ey.Z], () => ey.Z.didAgree(null == c ? void 0 : c.guild_id)),
isMobile: (0, p.e7)([ek.Z], () => (null == c ? void 0 : c.type) === e$.d4z.DM && ek.Z.isMobileOnline(c.getRecipientId()), [c]),
isUnavailable: (0, p.e7)([eO.Z], () => (null == c ? void 0 : c.guild_id) != null && eO.Z.isUnavailable(c.guild_id), [c]),
showRealNameModal: H,

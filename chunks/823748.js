...
class e9 extends a.PureComponent {
  ...
  renderSidebar() {
    ...
    else if (s === eJ.ULH.PROFILE && t.isPrivate() && !r && !c) return (0, i.jsx)(eZ.Z, {
      location: "Channel",
      channel: t
    ...
    } else if (s === eJ.ULH.SEARCH && null != e) return (0, i.jsx)(em.Z, {
      searchId: e
    });
    return null
  }
  ...
  constructor(...e) {
    super(...e), e5(this, "state", {
      ...
      return (0, i.jsxs)("div", {
        ...
        }, "header-".concat(e.id)), (0, i.jsx)(eu.Z, {
          channelId: e.id
        })]
      })
    })

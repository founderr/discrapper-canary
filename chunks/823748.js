	...
	renderCall() {
		...
		switch (e.type) {
			case e$.d4z.GUILD_STAGE_VOICE:
				return (0, i.jsx)(eg.Z, { channel: e }, e.id);
...
t.Z = a.memo(function (e) {
	...
	let { providedChannel: n } = e,
		...
		C = (0, m.e7)([eL.Z], () => eL.Z.getChannel(E), [E]),
		g = (0, m.e7)([eD.Z], () => eD.Z.getGuild(null == c ? void 0 : c.guild_id), [c]),

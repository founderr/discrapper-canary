...
var i = t(371917), r = t(421520), o = t.n(r), l = t(563751), u = t.n(l), s = t(608382), a = t.n(s), c = t(722661), d = t.n(c), _ = t(225389), f = t.n(_), E = t(71716), I = t.n(E), g = t(869045), p = t.n(g), S = t(110599), C = t.n(S), m = t(801539), T = t.n(m), h = t(887868), A = t.n(h);
function N(e, n, t, r) {
    let o = r.getCurrentContent(), l = null;
    null != e && (l = (o = o.createEntity(...e)).getLastCreatedEntityKey());
    let u = o.getFirstBlock(), s = new i.SelectionState({
            anchorKey: u.getKey(),
            anchorOffset: n,
            focusKey: u.getKey(),
            focusOffset: t
        });
    return o = i.Modifier.applyEntity(o, s, l), i.EditorState.set(r, { currentContent: o });
}
function v(e, n, t, r) {
    let o, l;
...
function O(e, n) {
    let t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = n.getCurrentContent(), r = i.getFirstBlock(), o = r.getText(), l = [];
    return r.findEntityRanges(e => null !== e.getEntity(), (e, n) => {
        let t = i.getEntity(r.getEntityAt(e)).getType(), u = o.substring(e, n);
        l.push({
            processed: !1,
            type: t,
            start: e,
...
function Z(e) {
    let n = i.EditorState.push(e, i.ContentState.createFromText('')), t = e.getSelection();
...
function j(e) {
    ...
    if (!function (e, n) {
        ...
        return;
    let i = t.getClientRects()[0], r = e.getClientRects()[0];
    if (null == i || null == r)
        return;

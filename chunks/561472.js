...
t.Z = function (e) {
    let { className: t, style: n, channel: T, draftType: x } = e,
        ...
        P = b ? (C.TPd.GUILD_THREADS_ONLY.has(T.type) ? I.Z.Messages.UPLOAD_TO_NEW_POST : I.Z.Messages.UPLOAD_TO_NEW_THREAD) : S ? I.Z.Messages.UPLOAD_TO.format({ destination: (0, r.F6)(T, m.default, p.Z, !0) }) : I.Z.Messages.UPLOAD_AREA_TITLE_NO_CONFIRMATION;
    return Z || !j
        ? null
        : (0, i.jsx)(E.Z, {
              className: t,

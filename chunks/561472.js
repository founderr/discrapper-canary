...
channel: x,
draftType: T
  } = e, [N, v] = a.useState(!0), S = (0, s.e7)([d.Z], () => d.Z.hasLayers()), Z = (0, s.e7)([h.Z], () => null != x && h.Z.can(g.Plq.ATTACH_FILES, x), [x]), A = null != (0, s.e7)([l.Z], () => l.Z.getActiveCommand(x.id)), M = x.getGuildId(), b = T === o.d.FirstThreadMessage, R = (0, s.e7)([p.default], () => {
var e;

...
t.default = function(e) {
  ...
  }), j = (0, s.useStateFromStores)([u.default], () => u.default.didAgree(y)) && !L, O = l.useMemo(() => !x && (T.isPrivate() && !T.isManaged() || null != y && (!T.isNSFW() || j) && N && d.default.canChatInGuild(y)), [N, j, T, y, x]), P = R ? S.ChannelTypesSets.GUILD_THREADS_ONLY.has(T.type) ? _.default.Messages.UPLOAD_TO_NEW_POST : _.default.Messages.UPLOAD_TO_NEW_THREAD : A ? _.default.Messages.UPLOAD_TO.format({
  ...
  return M || !O ? null : (0, a.jsx)(C.default, {
    ...
    onDrop: e => {
      if (M) return !1;
      O && null != T && ((0, E.promptToUpload)(e, T, I, {
        requireConfirm: A,

...
t.Z = function(e) {
  let {
    ...
    channel: x,
    draftType: T
  } = e, [N, Z] = i.useState(!0), S = (0, s.e7)([d.Z], () => d.Z.hasLayers()), v = (0, s.e7)([h.Z], () => null != x && h.Z.can(_.Plq.ATTACH_FILES, x), [x]), A = null != (0, s.e7)([a.Z], () => a.Z.getActiveCommand(x.id)), M = x.getGuildId(), R = T === o.d.FirstThreadMessage, j = (0, s.e7)([E.default], () => {
    var e;
    return !0 == !(null === (e = E.default.getCurrentUser()) || void 0 === e ? void 0 : e.nsfwAllowed)
    ...
    destination: (0, r.F6)(x, E.default, m.Z, !0)
  ...
  return A || !O ? null : (0, l.jsx)(f.Z, {
    ...
    onDrop: e => {
      ...
      }), p.S.dispatchToLastSubscribed(_.CkL.TEXTAREA_FOCUS))
    },
    onDragClear: () => Z(!0),
    onDragOver: e => {
      if (A) return !1;

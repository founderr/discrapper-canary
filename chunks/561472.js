...
t.default = function(e) {
  ...
  }), j = (0, s.useStateFromStores)([u.default], () => u.default.didAgree(R)) && !L, O = l.useMemo(() => !x && (T.isPrivate() && !T.isManaged() || null != R && (!T.isNSFW() || j) && N && d.default.canChatInGuild(R)), [N, j, T, R, x]), P = y ? S.ChannelTypesSets.GUILD_THREADS_ONLY.has(T.type) ? _.default.Messages.UPLOAD_TO_NEW_POST : _.default.Messages.UPLOAD_TO_NEW_THREAD : A ? _.default.Messages.UPLOAD_TO.format({

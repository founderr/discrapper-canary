...
function I(e) {
  ...
  }), O = [Math.min(u.X, C) / u.md * 100, Math.min(u.md, g) / u.md * 100], A = !x && p ? [i.Z.colors.TEXT_POSITIVE.css, i.Z.colors.TEXT_POSITIVE.css] : [i.Z.colors.TEXT_BRAND.css, i.Z.colors.TEXT_MUTED.css];
  return (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsxs)("div", {
      ...
      children: [(0, s.jsx)(r.Text, {
        ...
        color: "text-brand",
        children: _.Z.Messages.DEFAULT_CHANNELS_CHATTABLE_COUNT.format({
          count: C
        })
      }), (0, s.jsx)(r.Text, {
        variant: "text-xs/bold",
      ...
      children: [x ? L : f, (0, s.jsx)(r.Text, {
        variant: "text-xs/normal",
        color: "text-muted",
        children: _.Z.Messages.GUILD_ONBOARDING_DEFAULT_CHANNELS_MIN_CHANNELS.format({
          count: u.md
        })
      })]
    }), (0, s.jsxs)("div", {
      className: E.requiredItem,
      children: [p ? f : L, (0, s.jsx)(r.Text, {
        variant: "text-xs/normal",
        color: "text-muted",
        children: _.Z.Messages.GUILD_ONBOARDING_DEFAULT_CHANNELS_MIN_CHATTABLE_CHANNELS.format({
          count: u.X
        })
      })]

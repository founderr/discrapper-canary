...
var i = t(735250), a = t(470079), s = t(120356), l = t.n(s), o = t(913527), r = t.n(o), c = t(442837), d = t(481060), u = t(139387), I = t(726542), m = t(339085), _ = t(434404), N = t(598077), E = t(430824), T = t(246946), h = t(285952), p = t(259580), g = t(531087), C = t(768581), f = t(709054), x = t(486199), O = t(981631), S = t(689938), A = t(573138), R = t(331651);
function b(e) {
    let n, {
            guild: t,
            integration: s,
            ...
            onDisable: v,
            onEnable: M
        } = e, L = (0, c.e7)([E.Z], () => E.Z.getRoles(t.id)), [j, D] = a.useState(!1), P = (0, c.e7)([T.Z], () => T.Z.hidePersonalInformation), B = a.useCallback(() => {
            D(!0), M(s);
        }, [
            s,
            M
            ...
            return {
                ...
                syncDescriptionText: n = s.revoked && null != a ? S.Z.Messages.SYNC_REVOKED.format({
                    user: s.user,
                    platformName: a.name
                }) : S.Z.Messages.INTEGRATIONS_LAST_SYNC.format({ datetime: r()(s.synced_at).calendar() })
            };
        }, [
            L,
            k,
            ...
            let e = m.Z.getGuildEmoji(t.id), n = Object.values(L).filter(e => null != e.tags && e.tags.integration_id === s.id).map(e => e.id);
    ...
    if (a.useEffect(() => {
        ...
        n = [{
                icon: d.ClockIcon,
                text: P ? S.Z.Messages.INTEGRATION_ADDED_DATE.format({ timestamp: f.default.extractTimestamp(s.id) }) : S.Z.Messages.INTEGRATION_ADDED_USER_DATE.format({
                ...
                return (0, i.jsxs)(h.Z, {
                    ...
                    children: [
                        (0, i.jsx)(d.Checkbox, {
                            ...
                            children: (0, i.jsx)(d.FormText, { children: S.Z.Messages.ENABLE_TWITCH_EMOJI_SYNC })
                        }),
                        (0, i.jsx)(h.Z, {
                            wrap: h.Z.Wrap.WRAP,

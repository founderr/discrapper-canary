...
return e.parseText = function(e, t) {
  ...
  if (s)
    return this._iter(new a.Z('between', o, s));
  var l = this._cacheGet('between', o);
  return !1 === l && (l = this._iter(new i.Z('between', o)), this._cacheAdd('between', l, o)), l;
  ...
  'MINUTELY',
  'SECONDLY'
], e.YEARLY = o.D.YEARLY, e.MONTHLY = o.D.MONTHLY, e.WEEKLY = o.D.WEEKLY, e.DAILY = o.D.DAILY, e.HOURLY = o.D.HOURLY, e.MINUTELY = o.D.MINUTELY, e.SECONDLY = o.D.SECONDLY, e.MO = f.MO, e.TU = f.TU, e.WE = f.WE, e.TH = f.TH, e.FR = f.FR, e.SA = f.SA, e.SU = f.SU, e.parseString = u.B, e.optionsToString = c.N, e;
  }();
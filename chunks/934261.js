...
let {
  ...
  product: c,
  purchase: d
} = e, u = (0, s.e7)([I.default], () => I.default.getCurrentUser()), f = (0, s.e7)([a.Z], () => a.Z.getProduct(null == l ? void 0 : l.skuId)), m = (0, s.e7)([p.default], () => p.default.locale), E = C.ZP.canUseCollectibles(u), _ = (0, o.qS)(d), h = (0, o.G1)(c), g = (null == d ? void 0 : d.expiresAt) != null ? (0, v.TD)(Date.now(), d.expiresAt) : null, A = Z(!E && _, h, E);
...
...null != I ? d.Z.getAllPending() : g.Z.getAllPending()
  })), O = C.ZP.isPremium(n), L = C.ZP.canUsePremiumProfileCustomization(n), y = (0, E.ZP)(n.id), b = !!(null == y ? void 0 : y.getPreviewBio(T).value), B = {
user: n,
guild: I,
pendingGlobalName: v,
pendingNickname: x,

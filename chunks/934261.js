...
let Z = e => {
    ...
    let {
      ...
      product: c,
      purchase: d
    } = e, u = (0, i.e7)([g.default], () => g.default.getCurrentUser()), f = (0, i.e7)([o.Z], () => o.Z.getProduct(null == l ? void 0 : l.skuId)), m = (0, i.e7)([p.default], () => p.default.locale), E = v.ZP.canUseCollectibles(u), _ = (0, a.qS)(d), h = (0, a.G1)(c), I = P(!E && _, h, E);

...
function A(E, S) {
  ...
  let C = [function(E, S, _) {
    ...
    return _.showCreatorMonetizationAnalyticsPermission && O.push(I.Pl.VIEW_CREATOR_MONETIZATION_ANALYTICS), O.push(I.Pl.MANAGE_WEBHOOKS), O.push(I.Pl.MANAGE_GUILD), N({
  ...
  }(r, E), (_ = r, A = E, P = S, n = [I.Pl.SEND_MESSAGES, I.Pl.SEND_MESSAGES_IN_THREADS, I.Pl.CREATE_PUBLIC_THREADS, I.Pl.CREATE_PRIVATE_THREADS, I.Pl.EMBED_LINKS, I.Pl.ATTACH_FILES, I.Pl.ADD_REACTIONS, I.Pl.USE_EXTERNAL_EMOJIS, I.Pl.USE_EXTERNAL_STICKERS, I.Pl.MENTION_EVERYONE, I.Pl.MANAGE_MESSAGES, I.Pl.MANAGE_THREADS, I.Pl.READ_MESSAGE_HISTORY, I.Pl.SEND_TTS_MESSAGES, I.Pl.SEND_VOICE_MESSAGES, I.Pl.USE_CLYDE_AI, I.Pl.SEND_POLLS], !P.showClydeAIPermissions && (n = n.filter(E => E !== I.Pl.USE_CLYDE_AI)), N({
...
function e(E, S, _) {
  ...
  return (!_.showPrivateThreads || !_.showCreateThreads) && (N = N.filter(E => E !== I.Pl.CREATE_PRIVATE_THREADS)), !_.showCreateThreads && (N = N.filter(E => E !== I.Pl.CREATE_PUBLIC_THREADS)), !_.showClydeAIPermissions && (N = N.filter(E => E !== I.Pl.USE_CLYDE_AI)), {
    title: S,

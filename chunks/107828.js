...
var t, r = s(735250), a = s(470079), i = s(481060), l = s(43267), c = s(933557), o = s(471445), d = s(16206), u = s(754688), h = s(430824), E = s(699516), p = s(594174), m = s(51144), C = s(2093), N = s(366695), _ = s(346656), x = s(409216), f = s(689938), I = s(431172);
function g(e, n, s) {
...
class M extends a.PureComponent {
    ...
    constructor(...e) {
        super(...e), g(this, 'node', void 0), g(this, 'handleClick', e => {
            e.preventDefault();
            let {onClick: n} = this.props, {node: s} = this;
            null != s && n(e, s);
        }), g(this, 'handleMouseEnter', e => {
            let {onMouseEnter: n} = this.props, {node: s} = this;
            null != s && n(e, s);
        }), g(this, 'setRef', e => {
            this.node = e;
        });
...
class v extends a.Component {
    ...
    getAccessibilityLabel() {
        let {guild: e} = this.props;
        return f.Z.Messages.QUICK_SWITCHER_RESULTS_GUILD_LABEL.format({ name: e.name });
    }
    render() {
        let {
            onMouseEnter: e,
...
class j extends (t = a.Component) {
    renderIcon() {
        var e;
        let {channel: n} = this.props, s = (0, o.KS)(n);
        if (null == s)
            return null;
    ...
    getAccessibilityLabel() {
        var e;
        let {channel: n} = this.props, s = null === (e = h.Z.getGuild(this.props.channel.guild_id)) || void 0 === e ? void 0 : e.name, t = (0, c.F6)(n, p.default, E.Z), r = (0, d.Z)(n);
...
class Z extends a.Component {
    ...
    getAccessibilityLabel() {
        ...
        return null != n && n > 0 ? f.Z.Messages.QUICK_SWITCHER_RESULTS_GROUP_DM_UNREAD_LABEL.format({
            name: s,
            mentions: n
        }) : f.Z.Messages.QUICK_SWITCHER_RESULTS_GROUP_DM_LABEL.format({ name: s });
    }
    render() {
        let {
            onMouseEnter: e,

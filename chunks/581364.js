...
var r = n(654861), i = n.n(r), a = n(512722), o = n.n(a), s = n(392711), l = n.n(s), u = n(149765), c = n(911969), d = n(367907), _ = n(399860);
n(131704);
var E = n(703558), f = n(895924), h = n(531010), p = n(689079), m = n(981631), I = n(231338);
function T(e) {
    var t, n, r;
    let i, {
            rootCommand: a,
    ...
    let E = (null != l ? l : []).map(e => e.name), h = (null != l ? l : []).map(e => e.displayName);
    return {
        version: a.version,
        guildId: a.guild_id,
        id: [
...
function N(e) {
    let t = e.type === c.jw.STRING, n = e.type === c.jw.CHANNEL, r = e.type === c.jw.USER || e.type === c.jw.MENTIONABLE, i = e.type === c.jw.ROLE || e.type === c.jw.MENTIONABLE;
    return {
...
function b(e) {
    let t = e.id, n = e.options, r = null == n ? void 0 : n.find(e => e.type === c.jw.SUB_COMMAND_GROUP);
    null != r && (t += ''.concat(p.oQ).concat(r.name), n = r.options);
    let i = null == n ? void 0 : n.find(e => e.type === c.jw.SUB_COMMAND);
    return null != i && (t += ''.concat(p.oQ).concat(i.name), n = i.options), {
        commandKey: t,

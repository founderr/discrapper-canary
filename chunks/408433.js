...
var r = n(392711), i = n.n(r), a = n(913527), o = n.n(a), s = n(866442), l = n(709054), u = n(981631), c = n(817384);
let d = /sketchfab/i, _ = /^https:\/\/sketchfab\.com/i, E = /youtube|steam|imgur|vimeo|sketchfab|soundcloud|streamable|twitch|vid\.me|twitter/i, f = /^https?:\/\/(?:canary\.|ptb\.|www\.)?discord(?:app)?\.com\/channels\/([0-9]+)\/shop$/, h = /^https?:\/\/(?:canary\.|ptb\.|www\.)?discord(?:app)?\.com\/channels\/([0-9]+)\/shop\/([0-9]+)$/;
function p(e) {
    let {
        width: t,
        height: n
...
function I(e, t, n) {
    ...
    if (null != n.image && p(n.image) && (r.image = m(n.image)), null != n.video && (null == r.thumbnail && null != n.video.proxy_url && p(n.video) && (r.thumbnail = {
            ...
            if (null != t && d.test(t.name) || _.test(n.url))
                return !1;

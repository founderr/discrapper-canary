n(47120), n(757143);
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(519953), l = n(239091), u = n(358085), c = n(960048), d = n(752305), _ = n(53529), E = n(789952), f = n(436660), h = n(887490), p = n(77224), m = n(135223), I = n(704875), T = n(653309), g = n(214262), S = n(622322);
function A(e, t, n) {
...
class N extends i.PureComponent {
    ...
    handleOnChange() {
        var e, t;
        let {editor: n} = this.props, r = h.bN.isEditorEmpty(n) && null == n.composition;
    ...
    handleBeforeInput(e) {
        var t;
        let {editor: n} = this.props, r = s.F3.findDocumentOrShadowRoot(n).getSelection(), i = null != r && r.rangeCount > 0 ? r.getRangeAt(0) : null, a = null !== (t = e.getTargetRanges()[0]) && void 0 !== t ? t : null;
    ...
    handleCompositionStart() {
        ...
        if (null != (null != n.selection && h.M8.isCollapsed(n.selection) ? h.bN.above(n, {
            ...
            f.Q.insertNodes(n, { text: '\uFEFF' }, { select: !0 }), r.insertedPrefix = !0, n.composition = r;
            return;
        }
        let a = s.F3.findDocumentOrShadowRoot(this.props.editor).getSelection(), o = (null !== (e = null == a ? void 0 : a.rangeCount) && void 0 !== e ? e : 0) > 0 ? null == a ? void 0 : a.getRangeAt(0) : null;
    ...
    handleCompositionEnd(e) {
        ...
        if (n && null != t.selection && h.M8.isCollapsed(t.selection)) {
            let e = t.selection.anchor.path, n = h.aj.leaf(t, e);
    ...
    isSelectionEscaping(e) {
        let t = this.containerRef.current, n = !1, r = !1;
        if (null != e && null != t)
    ...
    handleContextMenu(e) {
        let {editor: t} = this.props, i = e.pageY, a = window.innerHeight;

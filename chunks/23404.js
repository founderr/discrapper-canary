n(47120);
var i = n(735250), s = n(470079), a = n(120356), r = n.n(a), l = n(442837), o = n(663002), c = n(481060), d = n(230711), u = n(210887), _ = n(617136), h = n(272008), E = n(113434), I = n(569984), m = n(497505), g = n(918701), p = n(585500), T = n(566078), S = n(602667), C = n(611855), f = n(670638), N = n(667105), A = n(860151), Z = n(46140), L = n(981631), v = n(689938), O = n(921430);
function R(e) {
    var t;
    let {quest: n} = e, s = (0, E.B6)(n.config.expiresAt), a = (0, E.B6)(T.r.build(n.config).rewardsExpireAt), r = (0, l.e7)([u.Z], () => u.Z.getState().theme), d = (0, o.w)(r) ? L.BRd.DARK : L.BRd.LIGHT, _ = (null === (t = n.userStatus) || void 0 === t ? void 0 : t.completedAt) != null;
    return (0, i.jsxs)('div', {
        className: O.heading,
        children: [
            (0, i.jsx)('img', {
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    (0, i.jsx)(c.Heading, {
                        ...
                        children: _ ? v.Z.Messages.QUESTS_COMPLETION_PROGRESS_COMPLETE_ACTIVITY_PANEL : v.Z.Messages.QUESTS_TITLE.format({ questName: n.config.messages.questName })
                    }),
                    (0, i.jsx)(c.Text, {
                        variant: 'text-xs/normal',
                        color: 'header-secondary',
                        children: _ ? v.Z.Messages.QUESTS_CLAIM_BY_DATE.format({ expirationDate: a }) : v.Z.Messages.QUESTS_AVAILABLE_UNTIL_DATE.format({ expirationDate: s })
                    })
                ]
            })
        ]
...
t.Z = function (e) {
    var t, n, a;
    let {quest: o} = e, u = (0, l.e7)([I.Z], () => I.Z.isEnrolling(o.id), [o]), [T, x] = s.useState(!1), b = s.useCallback(() => x(!0), []), P = s.useCallback(() => x(!1), []), M = s.useCallback(e => {
            e.stopPropagation();
        }, []), D = s.useCallback(() => {
            (0, h.AH)(o.id, {
    ...
    return H || G || B || !(0, g.dl)(o) ? null : (0, i.jsx)(S.A, {
        ...
        children: e => {
            ...
            return (0, i.jsxs)('div', {
                ...
                className: r()(O.wrapper, { [O.wrapperQuestAccepted]: k }),
                onClick: M,
                onKeyPress: M,
                onFocus: b,
                onMouseEnter: b,
                ...
                children: [
                    (0, i.jsxs)('div', {
                        className: O.utils,
                        children: [
                            k ? (0, i.jsx)(R, { quest: o }) : (0, i.jsx)(C.Z, { textOpacity: 0.5 }),
                            (0, i.jsx)(f.r, {
                                quest: o,
                                questContent: m.jn.ACTIVITY_PANEL,

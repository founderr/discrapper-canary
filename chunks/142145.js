...
loopEnd: g,
bannerAdjustment: S
  } = e, A = (0, a.nY)('Profile Effect - Web'), N = i.useRef(null), [v, O] = i.useState(!1), R = !0;
...
f - d.start - t * e > d.duration && (_ === o.Q.INTERMITTENT && !p && null != T && t >= T && m(!0), R = !1);
  ...
  return A ? (null != N.current && v !== R && (!R && N.current.pause(), R && (N.current.currentTime = 0, N.current.play()), O(R)), (0, r.jsx)('video', {
muted: !0,
autoPlay: !0,

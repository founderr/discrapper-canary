...
function h(e) {
    let { width: t, opacity: n, className: a } = e;
    return (0, i.jsx)('div', {
        className: s()(a, { [c.blob]: !0 }),
        style: {
            width: u(t),
...
function p(e) {
    let t,
        { groupStart: n = !1, compact: a = !1, attachmentSpecs: l, usernameWidth: u, usernameOpacity: p, className: m, style: _ } = e,

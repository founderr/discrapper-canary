var n = r(851952), i = r(310176), o = r(297326), a = r(379846), u = r(574369), s = r(531272), c = r(172213), l = r(482789), f = r(563751), p = r(467159), h = !1, d = !1, g = null, y = {
        ...
        resolveComposition: function (t) {
            if (!d) {
                ...
                e.forEach(function (t, e) {
                    var u = o.decode(e), s = u.blockKey, c = u.decoratorKey, l = u.leafKey, p = r.getBlockTree(s).getIn([
                            c,
                            'leaves',
                            l
                        ]), h = p.start, d = p.end, g = r.getSelection().merge({
                            anchorKey: s,
                            focusKey: s,
                            anchorOffset: h,
                            focusOffset: d,
                            isBackward: !1
                        }), y = f(n, g), v = n.getBlockForKey(s).getInlineStyleAt(h);

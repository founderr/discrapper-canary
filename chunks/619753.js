...
function D(e) {
  ...
  let {
    ...
    setFocus: U,
    onSelect: F
  }), k = N.default.getQuery(f), B = N.default.getSearchType(f) === O.SearchTypes.FAVORITES, H = (0, d.createASTHighlighter)(null !== (t = null == k ? void 0 : k.content) && void 0 !== t ? t : ""), G = R.map(e => {
    let {
      channel: t,
      results: n,
      startIndex: l
...
function b(e) {
  ...
  let Q = [B, V, H].filter(e => null != e).join(", ");

        ...
        N = l.useCallback(
            (e) => {
                if (e.blocked)
                    ...
                    d.Z.trackJump(e.channel_id, e.id, 'Search Results', { search_id: j.Z.getAnalyticsId(a) }), (0, _.uL)(L.Z5c.CHANNEL(n, e.channel_id, e.id));
                }
            },
            [a]
        ),
...
function w(e) {
    var t, n, a;
    let { channel: r, results: s, highlighter: c, startIndex: d, resultRefs: u, totalResults: h, scrollTo: p, searchId: _, renderEmbeds: b, offset: j, jumpToMessage: P, listNavigator: R, favoriteSearch: O } = e,
        w = E.cC.useSetting(),
        B = (0, C.p)(),
        U = l.useCallback((e) => {

...
function P(e) {
  ...
  let {
    ...
    return _.reduce((n, i) => {
      ...
      if (!S && null != a && N.Z.isBlockedForMessage(a)) return n;
...
function O(e) {
  ...
  let X = [w, G, B].filter(e => null != e).join(", ");

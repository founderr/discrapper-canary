...
function ee(e) {
	...
	let { subscription: E, planId: f, price: h, includePremiumGuilds: p, hasDiscountApplied: I, activeDiscountInfo: m, renewalInvoicePreview: g } = e,
		S = U.GP[f],
		A = L.ZP.formatPriceString(L.ZP.getDefaultPrice(S.id), S.interval),
		N = eI(E) || (null == E.paymentSourceId && !E.isPurchasedExternally && !(null === (t = T.default.getCurrentUser()) || void 0 === t ? void 0 : t.hasFreePremium())),
		v = null != h,
...
function er(e) {
	...
	void 0 === u && l && !a && (u = U.IW[t]), s && !a && (void 0 === o || (l && U.No.has(o))) && I.k.trackExposure({ location: 'de805e_1' });
	let c = [];
	switch (t) {
		case U.Si.TIER_0:

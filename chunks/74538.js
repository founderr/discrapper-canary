...
var r, i, a, o, s = n(512722), l = n.n(s), u = n(913527), c = n.n(u), d = n(848246);
n(442837);
var _ = n(782568), E = n(710845), f = n(386542), h = n(114064), p = n(803905), m = n(439017), I = n(301766), T = n(594174), g = n(351402), S = n(853872), A = n(509545), N = n(78839), v = n(122289), O = n(55935), R = n(424218), C = n(358085), y = n(380684), D = n(111361), L = n(74538), b = n(937615), M = n(981631), P = n(334431), U = n(474936), w = n(231338), x = n(689938);
let G = {
...
function H(e) {
    var t;
    let n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = null !== (t = S.Z.defaultPaymentSourceId) && void 0 !== t ? t : void 0, a = N.ZP.getPremiumTypeSubscription();
    ...
    if (null != A.Z.get(e)) {
        ...
        let o = function (e) {
            let {
                    ...
                    purchaseType: n,
                    currency: r
                } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { purchaseType: M.tuJ.DEFAULT }, i = Y(e, {
                    paymentSourceId: t,
                    purchaseType: n
                });
...
(a = r || (r = {})).BUNDLE = 'bundle', a.TIER_0 = 'tier_0', a.TIER_1 = 'tier_1', a.TIER_2 = 'tier_2', a.PREMIUM_GUILD = 'premium_guild', (o = i || (i = {})).MID = 'mid', o.HIGH = 'high';
function Y(e) {
    let {
            paymentSourceId: t,
            purchaseType: n
        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { purchaseType: M.tuJ.DEFAULT }, r = function (e, t) {
            let n = A.Z.get(e);
            if (null == n) {
...
function W(e, t, n) {
    let r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1, i = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : U.p9.TIER_2;
    if (t || n)
        switch (e) {
        case U.rV.MONTH:
            let o = (a === U.p9.TIER_0 ? x.Z.Messages.BASIC_GIFT_DURATION : x.Z.Messages.GIFT_DURATION).format({ timeInterval: x.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_MONTH });
            return i ? o : x.Z.Messages.PAYMENT_MODAL_ONE_MONTH;
        case U.rV.YEAR:
            let s = (a === U.p9.TIER_0 ? x.Z.Messages.BASIC_GIFT_DURATION : x.Z.Messages.GIFT_DURATION).format({ timeInterval: x.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_YEAR });
            return i ? s : x.Z.Messages.PAYMENT_MODAL_ONE_YEAR;
        default:
            throw Error('Unexpected interval');
        }
    switch (e) {
    case U.rV.MONTH:
        if (1 !== r)
            return x.Z.Messages.MULTI_MONTHS.format({ intervalCount: r });
...
function q(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], r = arguments.length > 3 ? arguments[3] : void 0;
    switch (e) {
    ...
    case U.Xh.PREMIUM_6_MONTH_TIER_2:
        ...
        default:
            return m ? f === U.Xh.PREMIUM_YEAR_TIER_2 ? x.Z.Messages.PREMIUM_TIER_CARD_ANNUAL_DISCOUNT_HEADER.format({
                percent: null !== (o = null == I ? void 0 : I.percentage) && void 0 !== o ? o : U.Bo,
                regularPrice: A
            }) : y ? x.Z.Messages.PREMIUM_TIER_CARD_DISCOUNT_HEADER_AFTER_REDEMPTION_GENERIC.format({
                percent: null !== (s = null == I ? void 0 : I.percentage) && void 0 !== s ? s : U.M_,
                regularPrice: A,
...
function et(e) {
    ...
    return l()(null != s, 'Missing plan'), ee({
        subscription: n,
        planId: s.id,
...
function en(e) {
    let {
            ...
            let {planId: t} = e;
            return U.Z1.has(t);
        }), a = (null == i ? void 0 : i.planId) === U.Xh.PREMIUM_MONTH_GUILD ? x.Z.Messages.PREMIUM_GUILD_NUM_MONTH_GUILD_SUBSCRIPTIONS_UNFORMATTED : (null == i ? void 0 : i.planId) === U.Xh.PREMIUM_YEAR_GUILD ? x.Z.Messages.PREMIUM_GUILD_NUM_MONTH_GUILD_SUBSCRIPTIONS_UNFORMATTED : null, o = null == a ? void 0 : a.format({ num: null == i ? void 0 : i.quantity });
    if (null != r && null != o)
...
function er(e) {
    ...
    if (null == t || !n)
        return [];
    let u = void 0 !== s && t === U.GP[s].skuId ? s : void 0;
    void 0 === u && l && !a && (u = U.IW[t]), o && !a && (void 0 === s || l && U.No.has(s)) && m.k.trackExposure({ location: 'de805e_1' });
    let c = [];
    switch (t) {
    case U.Si.TIER_0:
        c = [
...
function ed(e) {
    ...
    if (e.isPurchasedViaGoogle && (null === (n = e.metadata) || void 0 === n ? void 0 : n.google_grace_period_expires_date) != null && (null === (r = e.metadata) || void 0 === r ? void 0 : r.google_original_expires_date) != null) {
        let t = c()(e.metadata.google_grace_period_expires_date), n = c()(e.metadata.google_original_expires_date);
        return {
...
function eE(e) {
    return e.isPurchasedExternally ? e.status === M.O0b.CANCELED : function (e) {
        ...
        return 0 === (null != t ? eo(t.additionalPlans) : null) && 0 !== i ? M.O0b.CANCELED : r;
    }(e) === M.O0b.CANCELED;
}
function ef(e) {
    var t, n, r;
    ...
    let _ = eo(c), E = eT(i.planId, i.paymentSourceId, i.currency, a).amount * _;
    if (null != s) {
        let e = s.invoiceItems.find(e => U.Z1.has(e.subscriptionPlanId));
        null != e && (E = e.amount);
    }
    o = null != o ? o : (0, b.T4)(E, i.currency);
    ...
    if (eE(i))
        return i.isPurchasedViaGoogle ? x.Z.Messages.PREMIUM_GUILD_SUBSCRIPTIONS_RENEWAL_INFO_PENDING_CANCELATION_NO_PRICE.format({ quantity: _ }) : f ? x.Z.Messages.PREMIUM_GUILD_SUBSCRIPTIONS_RENEWAL_INFO_PENDING_CANCELATION.format({
            quantity: _,
            rate: (0, b.og)(o, d.interval, d.intervalCount)
    ...
    default:
        return i.isPurchasedViaGoogle ? x.Z.Messages.PREMIUM_GUILD_SUBSCRIPTIONS_RENEWAL_INFO_NO_PRICE.format({ quantity: _ }) : f ? x.Z.Messages.PREMIUM_GUILD_SUBSCRIPTIONS_RENEWAL_INFO.format({
            quantity: _,
            rate: (0, b.og)(o, d.interval, d.intervalCount)
...
function eh(e, t, n) {
    let r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], i = null != t ? Z(e.id, !1, r, t) : H(e.id, !1, r), a = (0, b.T4)(i.amount, i.currency);
...
function eT(e, t, n, r) {
    ...
    let o = A.Z.getForSkuAndInterval(eG(U.Si.GUILD), a.interval, a.intervalCount);
    if (null == o) {
        let t = Error('Unsupported plan');
        throw (0, v.q2)(t, { tags: { planId: e } }), t;
    }
    return Z(o.id, (0, D.I5)(r), !1, i);
}
function eg(e, t, n) {
    let r = t.id;
    if (null != e)
...
function eS(e) {
    let t = e.invoiceItems[0].subscriptionPlanId, n = A.Z.get(t);
...
function eA(e) {
    ...
    case U.rV.DAY:
        if (n >= 7 && n % 7 == 0)
            return r ? x.Z.Messages.PREMIUM_TRIAL_MARKETING_TRIAL_HEADING_WEEKS.format({ weeks: n / 7 }) : x.Z.Messages.PREMIUM_TRIAL_FREE_DURATION_WEEKS.format({ weeks: n / 7 });
...
function eN(e) {
    ...
    case U.rV.DAY:
        if (n >= 7 && n % 7 == 0)
            return x.Z.Messages.PREMIUM_TRIAL_MARKETING_TRIAL_CTA_WEEKS.format({ weeks: n / 7 });
...
function ev(e) {
    ...
    case U.rV.DAY:
        if (n >= 7 && n % 7 == 0)
            return r ? x.Z.Messages.DURATION_WEEKS_CAPITALIZE.format({ weeks: n / 7 }) : x.Z.Messages.DURATION_WEEKS.format({ weeks: n / 7 });
...
function eC(e, t) {
    var n, r;
    let i = [], a = (null !== (r = null === (n = e.renewalMutations) || void 0 === n ? void 0 : n.items) && void 0 !== r ? r : e.items).find(e => U.dJ.has(e.planId));
...
function eD(e, t, n, r) {
    ...
    let o = !1, s = (null !== (a = null === (i = e.renewalMutations) || void 0 === i ? void 0 : i.items) && void 0 !== a ? a : e.items).map(e => r.has(e.planId) ? (o = !0, {
            ...e,
            quantity: n,
            planId: t
        }) : e);
...
function ex(e) {
    let {
        available: t,
        activated: n,
        hqStreamingState: {hqStreamingDidEnable: r}
    } = (0, f.k)(e);
    return t && n && r;
}
function eG(e) {
...
t.ZP = Object.freeze({
    ...
    getBillingInformationString: function (e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], r = n ? (0, b.T4)(t.invoiceItems.filter(e => U.UD.has(e.subscriptionPlanId)).map(e => e.amount).reduce((e, t) => t + e, 0), t.currency) : (0, b.T4)(t.total, t.currency);
        if (e.status === M.O0b.CANCELED)
            return x.Z.Messages.PREMIUM_SETTINGS_CANCELLED_INFO.format({ endDate: t.subscriptionPeriodStart });
        ...
        if (e.status === M.O0b.PAUSED)
            ...
            }(e) ? x.Z.Messages.PREMIUM_SETTINGS_PREPAID_THROUGH_DATE.format({ prepaidEndDate: e.currentPeriodEnd }) : e.status === M.O0b.UNPAID ? x.Z.Messages.PREMIUM_SETTINGS_PAYMENT_PROCESSING.format({ maxProcessingTimeInDays: U.Rg }) : e.isPurchasedExternally ? x.Z.Messages.PREMIUM_SETTINGS_RENEWAL_INFO_EXTERNAL.format({
    ...
    canStreamQuality: function (e, t) {
        return !!function (e) {
            var t, n;
            let r = h.Z.getPerksDemos(), i = h.Z.getActivated();
    ...
    formatPriceString: function (e, t) {
        let n = (0, b.T4)(e.amount, e.currency), r = K(t);

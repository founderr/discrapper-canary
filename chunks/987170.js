...
var r = n(470079), i = n(180205), a = n(314897), o = n(492435), s = n(353926), l = n(980944), u = n(987338);
function c(e, t, n) {
...
function _(e) {
    ...
    function f(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments.length > 2 ? arguments[2] : void 0, r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
    ...
    function m(t, n) {
        let r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = null != r.disable && r.disable, a = c(e.kind, e.id, t), o = null == a || i ? u.NZ.NOT_ELIGIBLE : a.bucket, l = null == a ? -1 : a.revision;
        function E() {
            let r = c(e.kind, e.id, t), a = null == r || i ? u.NZ.NOT_ELIGIBLE : r.bucket, s = null == r ? -1 : r.revision;
    ...
    return {
        useExperiment: function (t) {
            var n, a, o;
            let s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { autoTrackExposure: !0 }, l = null !== (n = s.disable) && void 0 !== n && n, E = !1 !== s.autoTrackExposure, h = c(e.kind, e.id, t), p = null == s.trackExposureOptions ? void 0 : (0, i.Z)(null !== (a = s.trackExposureOptions) && void 0 !== a ? a : {}), I = null !== (o = null == h ? void 0 : h.triggerDebuggingEnabled) && void 0 !== o && o, [[T, g, S], A] = (0, r.useState)(() => {
        ...
        getCurrentConfig: function (t) {
            let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { autoTrackExposure: !0 }, r = c(e.kind, e.id, t);
            if (null == r || n.disable)

...
function T(e) {
  ...
  let {
    ...
    className: P
  } = e, c = (0, S.useStateFromStores)([I.default], () => I.default.getCurrentUser()), M = u.default.useName(i, null, c), C = (0, o.getRoleIconProps)(E), f = t.useMemo(() => (0, _.createMessageRecord)({
    ...(0, l.default)({
      channelId: "0",
      content: d,
      tts: void 0,

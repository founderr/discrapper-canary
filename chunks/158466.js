...
function a(e) {
    var t, n, r, i, a, s, o, l, u, c, d, _, E, f, h, p, I, m, T, S, g;
...
function l(e, t) {
    var n, i, o, l, u, c, d, _, E, f, h, p, I, m, T, S, g, A, N, R, O, v, C, L, D, y, b;
    let M = e.substreams.find((e) => !e.isRTX && !e.isFlexFEC);
    if (null == M) return;
    let P = e.substreams.reduce((e, t) => e + a(t.rtpStats), 0),
        U = e.substreams.reduce((e, t) => e + s(t.rtpStats), 0);
    return {
        type: 'video',
        ssrc: M.ssrc,
        sinkWant: (0, r.f)(t, M.ssrc, !0),
        sinkWantAsInt: (0, r.F)(t, M.ssrc),
        codec: {
        ...
        bytesSent: P,
        packetsSent: U,
        packetsLost: null !== (S = null === (n = M.rtcpStats) || void 0 === n ? void 0 : n.packetsLost) && void 0 !== S ? S : 0,
        fractionLost: null !== (g = null === (i = M.rtcpStats) || void 0 === i ? void 0 : i.fractionLost) && void 0 !== g ? g : 0,
        ...
        framesSent: M.frameCounts.keyFrames + M.frameCounts.deltaFrames,
        keyFramesEncoded: M.frameCounts.keyFrames,
        framesEncoded: e.framesEncoded,
        frameRateInput: e.inputFrameRate,
        frameRateEncode: e.encodeFrameRate,
        firCount: null !== (A = null === (o = M.rtcpStats) || void 0 === o ? void 0 : o.firPackets) && void 0 !== A ? A : 0,
        nackCount: null !== (N = null === (l = M.rtcpStats) || void 0 === l ? void 0 : l.nackPackets) && void 0 !== N ? N : 0,
        pliCount: null !== (R = null === (u = M.rtcpStats) || void 0 === u ? void 0 : u.pliPackets) && void 0 !== R ? R : 0,
        qpSum: e.qpSum,
        ...
        encoderQualityVmaf: null !== (O = null === (c = M.encoderQualityStats) || void 0 === c ? void 0 : c.imageQualityVmaf_v061) && void 0 !== O ? O : void 0,
        encoderQualityPsnr: null !== (v = null === (d = M.encoderQualityStats) || void 0 === d ? void 0 : d.imageQualityWebrtcPsnrDb) && void 0 !== v ? v : void 0,
        qualityDecodeErrors: null !== (C = null === (_ = M.encoderQualityStats) || void 0 === _ ? void 0 : _.decodeErrors) && void 0 !== C ? C : void 0,
        qualityDecoderReboots: null !== (L = null === (E = M.encoderQualityStats) || void 0 === E ? void 0 : E.decoderReboots) && void 0 !== L ? L : void 0,
        qualityScoreErrors: null !== (D = null === (f = M.encoderQualityStats) || void 0 === f ? void 0 : f.scoreErrors) && void 0 !== D ? D : void 0,
        qualityFrameDrops: null !== (y = null === (h = M.encoderQualityStats) || void 0 === h ? void 0 : h.frameDrops) && void 0 !== y ? y : void 0,
        qualitySizeMismatches: null !== (b = null === (p = M.encoderQualityStats) || void 0 === p ? void 0 : p.sizeMismatches) && void 0 !== b ? b : void 0,
        filter: e.filter,
        ...
        freezeCount: null === (I = M.encoderQualityStats) || void 0 === I ? void 0 : I.freezeCount,
        totalFreezesDuration: null === (m = M.encoderQualityStats) || void 0 === m ? void 0 : m.totalFreezesDuration,
        totalFramesDuration: null === (T = M.encoderQualityStats) || void 0 === T ? void 0 : T.totalFramesDuration
    };
}
function u(e, t, n, i) {
    var l, u;
...
function c(e, t, n, i) {
    ...
    let { transport: T, clips: S } = p,
        g = {};
    null != T && ((g.availableOutgoingBitrate = T.sendBandwidth), (g.ping = T.rtt), (g.decryptionFailures = T.decryptionFailures), null != T.routingFailures && (g.routingFailures = T.routingFailures), (g.localAddress = T.localAddress), (g.pacerDelay = T.pacerDelay), null != T.receiverReports && (g.receiverReports = T.receiverReports), (g.receiverBitrateEstimate = T.receiverBitrateEstimate), (g.outboundBitrateEstimate = T.outboundBitrateEstimate), (g.inboundBitrateEstimate = null !== (s = T.inboundBitrateEstimate) && void 0 !== s ? s : 0), (g.packetsReceived = T.packetsReceived), (g.packetsSent = T.packetsSent), null != T.secureFramesProtocolVersion && (g.secureFramesProtocolVersion = T.secureFramesProtocolVersion)), ((null == T ? void 0 : T.bytesReceived) != null || (null != f && !Number.isNaN(f))) && (g.bytesReceived = null !== (d = null !== (c = null == T ? void 0 : T.bytesReceived) && void 0 !== c ? c : f) && void 0 !== d ? d : void 0), ((null == T ? void 0 : T.bytesSent) != null || (null != h && !Number.isNaN(h))) && (g.bytesSent = null !== (E = null !== (_ = null == T ? void 0 : T.bytesSent) && void 0 !== _ ? _ : h) && void 0 !== E ? E : void 0);

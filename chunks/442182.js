...
function j(e) {
  ...
  return (0, u.$)(_), (0, s.jsx)("div", {
    ...
    children: (0, s.jsx)(o.Popout, {
      ...
      position: "left",
      preload: () => (0, I.W)(t.id, t.avatarURL, {
        guildId: i
      }),
...
function b(e) {
  ...
  } = (0, E.ZP)(_.Z.MEMBER_LIST), T = a.useMemo(() => i.trim().toLowerCase(), [i]);
  (0, x.rY)(t, T);
  let m = a.useMemo(() => d.filter(e => (0, x.eg)(T, e)), [d, T]),
  ...
  return (0, s.jsx)(E.Gt, {
    ...
    children: (0, s.jsx)(o.ListAuto, {
      ...
      renderRow: function(e) {
        ...
        if (0 === N.length) return (0, s.jsx)(Z, {
          handleAddClick: u,
          locked: l
        }, "empty");
        let i = N[a];
...
function G(e) {
  let {
    ...
    S.default.track(O.rMx.OPEN_MODAL, {
      ...
      let {
        default: e
      } = await Promise.all([n.e("7590"), n.e("90591")]).then(n.bind(n, 24722));
      return n => (0, s.jsx)(e, {
        ...n,
        roleId: i.id,
        guildId: t.id

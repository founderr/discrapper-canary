...
function V(e) {
  ...
  let {
    ...
    analyticsLocation: o
  } = e, d = (0, N.useBlockedPaymentsConfig)(), [c, p] = l.useState(!1), [E, I] = l.useState(!1), C = (0, _.default)(), {
  ...
  let y = s.items.some(e => {
    ...
    L = (0, i.jsx)(f.Button, {
      ...
      color: (0, m.isThemeLight)(C) ? f.Button.Colors.PRIMARY : f.Button.Colors.WHITE,
      onClick: r,

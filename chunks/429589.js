...
var r = n(735250), i = n(470079), a = n(442837), o = n(481060), s = n(278323), l = n(224706), u = n(287734), c = n(2052), d = n(906732), _ = n(835473), E = n(592745), f = n(592125), h = n(757266), p = n(650774), m = n(430824), I = n(283595), T = n(496675), g = n(699516), S = n(944486), A = n(594174), N = n(979651), v = n(181106), O = n(417363), R = n(358085), C = n(804739), y = n(566620), D = n(317381), L = n(638880), b = n(255621), M = n(452634), P = n(527805), U = n(620662), w = n(275920), x = n(952561), G = n(513202), k = n(915863), B = n(701488), F = n(981631), V = n(689938);
function H(e) {
    var t, n;
    let {
            activity: H,
            ...
            ...z
        } = e, {analyticsLocations: q} = (0, d.ZP)(), [Q, X] = i.useState(!1), $ = (0, a.e7)([A.default], () => A.default.getCurrentUser()), J = Y.id === (null == $ ? void 0 : $.id), ee = null !== (t = null == Z ? void 0 : Z.applicationId) && void 0 !== t ? t : null == H ? void 0 : H.application_id, et = (0, M.Z)({
    ...
    if (!((0, U.Z)(H, F.xjy.JOIN) || W) || null == ee)
        return null;
    let e_ = !J || W && !el, eE = e_ && (ed || en) && !Q && !er && (!W || es), ef = null;
    e_ ? !ed && !en && null != H && (ef = V.Z.Messages.USER_ACTIVITY_NOT_DETECTED.format({ name: H.name })) : ef = V.Z.Messages.USER_ACTIVITY_CANNOT_JOIN_SELF;
    let eh = null !== (n = null == Z ? void 0 : Z.launchId) && void 0 !== n ? n : null == H ? void 0 : H.session_id, ep = async (e, t) => {
            var n;
            if (null != eh && null != ee)
                await l.Z.join({
                    userId: e.id,

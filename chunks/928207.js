...
var a = n(512969),
    ...
    g = n(689938),
    T = n(537553);
let C = s.ZP.connectStores([m.default], () => ({ user: m.default.getCurrentUser() }))(
    (0, c.Z)(
        (0, o.Z)((e) => {
            let { analyticsLocations: t } = (0, u.ZP)(d.Z.HOME_PAGE_PREMIUM_TAB),
                { isAuthenticated: n, user: s } = e;
            return n
                ? (0, i.jsxs)('div', {
                          ...
                          (0, i.jsx)(l.Z, {
                              ...
                              children: (0, i.jsxs)(E.Z, {
                                  ...
                                  children: [
                                      ...
                                      (0, i.jsx)(E.Z.Title, { children: g.Z.Messages.PREMIUM })
                                  ]
                              })
                          }),
                          (0, i.jsx)(u.Gt, {
                              ...
                              children:
                                  null == s
                                      ...
                                      : (0, i.jsx)(h.Z, { entrypoint: p.EZ.ApplicationStoreHome })
                          })
                      ]
                  })
                : (0, i.jsx)(a.l_, { to: I.Z5c.LOGIN });
        })
    )
);
t.Z = C;

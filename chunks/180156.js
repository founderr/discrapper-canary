...
function I(e) {
  ...
  }), x = s().uniq(s().map(I, "userId")), S = (0, i.useStateFromStoresArray)([o.default], () => x.map(e => o.default.getUser(e))), v = (0, i.useStateFromStores)([u.default], () => Object.keys(u.default.getTypingUsers(a.id)).length > 0, [a.id]), C = I.length < m.MAX_STORED_MESSAGES ? g.default.Messages.ACTIVE_CHANNELS_FEW_MESSAGES.format({
    count: I.length

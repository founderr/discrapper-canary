...
var r = n(735250);
n(470079);
var i = n(120356), a = n.n(i), o = n(920906), s = n(399606), l = n(481060), u = n(607070), c = n(906732), d = n(471885), _ = n(267642), E = n(879892), f = n(198466), h = n(981631), p = n(689938), m = n(197838);
let I = {
    [h.Eu4.NONE]: 0,
    [h.Eu4.TIER_1]: 1 / 3,
    [h.Eu4.TIER_2]: 2 / 3,
...
t.Z = function (e) {
    let {
        ...
        } = e, v = (0, s.e7)([u.Z], () => u.Z.useReducedMotion), {analyticsLocations: O} = (0, c.ZP)(), R = h.oCV[A] - i.premiumSubscriberCount, C = A <= N || T, y = C && A <= i.premiumTier, D = C && A < i.premiumTier, L = C && A === i.premiumTier, {scaleFactor: b} = (0, o.useSpring)({
            from: { scaleFactor: 0 },
            to: { scaleFactor: N >= A || T && N + 1 === A || T && -1 === N && A === h.Eu4.NONE ? 1 : 0 },
            config: {
                tension: 360,
                friction: 12
            },
    ...
    return (0, r.jsx)(l.Tooltip, {
        text: y ? p.Z.Messages.BOOSTING_MARKETING_REDESIGN_EXPERIMENT_PROGRESS_BAR_TOOLTIP_TIER_UNLOCKED.format({ tierName: (0, _.nW)(A, { useLevels: !1 }) }) : p.Z.Messages.BOOSTING_MARKETING_REDESIGN_EXPERIMENT_PROGRESS_BAR_TOOLTIP_REMAINING_FOR_TIER.format({
            numBoostsRequired: R,
            tierName: (0, _.nW)(A, { useLevels: !1 })
        }),
        ...
        children: e => (0, r.jsxs)(P, {
            ...
            style: { left: ''.concat(100 * I[A], '%') },
            ...e,
            ...U,
            children: [
                !y && (0, r.jsx)('div', { className: m.boostedTierIconBackground }),

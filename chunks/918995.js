s.r(n), s(47120);
var a = s(735250), c = s(470079), t = s(481060), i = s(233787), l = s(689938);
function o(e, n, s) {
...
class r extends c.Component {
    render() {
        ...
        return (0, a.jsxs)(i.Z, {
            ...
            children: [
                (0, a.jsx)(i.Z.Header, { children: l.Z.Messages.PREMIUM_NOT_CLAIMED }),
                (0, a.jsx)(i.Z.Content, {
    ...
    constructor(...e) {
        super(...e), o(this, 'cancel', () => {
            ...
            null == e || e(), (0, t.openModalLazy)(async () => {
                let {default: e} = await s.e('60827').then(s.bind(s, 324239));

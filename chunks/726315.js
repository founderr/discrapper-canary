(t.readUInt32BE = function (e, t) {
    ...
    (t.rip = function (e, t, n, r) {
        for (var i = 0, a = 0, o = 0; o < 4; o++) for (var s = 24; s >= 0; s -= 8) (i <<= 1), (i |= (t >>> (s + o)) & 1), (i <<= 1), (i |= (e >>> (s + o)) & 1);
        for (var o = 4; o < 8; o++) for (var s = 24; s >= 0; s -= 8) (a <<= 1), (a |= (t >>> (s + o)) & 1), (a <<= 1), (a |= (e >>> (s + o)) & 1);
        (n[r + 0] = i >>> 0), (n[r + 1] = a >>> 0);
    }),
...
(t.pc2 = function (e, t, r, i) {
    for (var a = 0, o = 0, s = n.length >>> 1, l = 0; l < s; l++) (a <<= 1), (a |= (e >>> n[l]) & 1);
    for (var l = s; l < n.length; l++) (o <<= 1), (o |= (t >>> n[l]) & 1);
    (r[i + 0] = a >>> 0), (r[i + 1] = o >>> 0);
}),
    (t.expand = function (e, t, n) {
        var r = 0,
            i = 0;
        r = ((1 & e) << 5) | (e >>> 27);
        for (var a = 23; a >= 15; a -= 4) (r <<= 6), (r |= (e >>> a) & 63);
...
(t.permute = function (e) {
    ...
    (t.padSplit = function (e, t, n) {
        ...
        for (var i = [], a = 0; a < t; a += n) i.push(r.slice(a, a + n));
        return i.join(' ');
    });

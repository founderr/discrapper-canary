...
var l = n("37983"),
  ...
  L = function(e) {
    ...
    let {
      channelId: L
    } = e, O = (0, r.useStateFromStores)([h.default], () => h.default.getCurrentUser()), {
      isCurrentUserStreamingQuestApplication: y,
      quest: P
    } = (0, r.useStateFromStoresObject)([f.default, d.default, C.default], () => {
    ...
    }, [L, O]), b = (0, r.useStateFromStores)([C.default], () => null != P && C.default.isEnrolling(P.id), [P]), D = (0, r.useStateFromStores)([d.default], () => ((null == O ? void 0 : O.id) == null ? null : d.default.getParticipant(L, O.id)) != null, [L, O]), U = (0, g.useQuestFormattedDate)(null == P ? void 0 : P.config.expiresAt), w = (0, g.useQuestFormattedDate)(null == P ? void 0 : P.config.rewardCodeExpiresAt), F = a.useCallback(() => {
      null != P && (0, E.enrollInQuest)(P.id, {
        questContent: S.QuestContent.QUEST_LIVE_STREAM,
        questContentCTA: p.QuestContentCTA.ACCEPT_QUEST
      })
    }, [P]), k = a.useCallback(() => {
      null != P && ((0, p.trackQuestContentClicked)(P.id, S.QuestContent.QUEST_LIVE_STREAM, p.QuestContentCTA.TRACK_PROGRESS), o.default.open(A.UserSettingsSections.INVENTORY))
    }, [P]), B = a.useCallback(() => {
      null != P && ((0, p.trackQuestContentClicked)(P.id, S.QuestContent.QUEST_LIVE_STREAM, p.QuestContentCTA.LEARN_MORE), o.default.open(A.UserSettingsSections.INVENTORY))
    }, [P]), V = (0, x.useHandleClaimQuestsReward)({
      quest: P,
      location: S.QuestContent.QUEST_LIVE_STREAM
    }), H = (0, g.useIsQuestExpired)(P);
    if (null == P) return null;
    let G = (null === (t = P.userStatus) || void 0 === t ? void 0 : t.enrolledAt) != null,
      W = (null === (n = P.userStatus) || void 0 === n ? void 0 : n.completedAt) != null,
      Y = null != P.userStatus && (0, _.isDismissed)(P.userStatus, S.QuestContent.QUEST_LIVE_STREAM);
    return Y || H || !D ? null : (0, l.jsxs)("div", {
      ...
      children: [!G && (0, l.jsxs)("div", {
        ...
        children: [(0, l.jsxs)("div", {
          ...
          children: [G && y ? (0, l.jsx)("img", {
            ...
            children: [(0, l.jsxs)("div", {
              ...
              children: [(0, l.jsx)(u.Heading, {
                ...
                children: y ? (0, _.getContextualEntrypointHeading)(P) : R.default.Messages.QUESTS_TITLE.format({
          ...
          }), G && !W && y && (0, l.jsx)(I.default, {
            color: u.tokens.colors.BG_BRAND,
            quest: P
          }), G && !W && !y && (0, l.jsx)(u.Button, {
            className: j.cta,

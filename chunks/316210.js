...
questContent: j,
quest: f
  } = e, g = (0, d.zK)(f, m.S7.IN_HOUSE_CONSOLE_QUEST), C = (0, d.Mi)(f, c.jn.GIFT_INVENTORY_FOR_YOU), U = (0, l.tP)(f), h = (null === (t = f.userStatus) || void 0 === t ? void 0 : t.claimedAt) != null, I = j === c.jn.QUEST_BAR || j === c.jn.QUEST_BAR_V2 || C && !U && !h, R = (0, u.Z)(m.dr.QUEST_DISCLOSURE_MODAL), O = a.useMemo(() => (0, d.Fs)({
...
questContent: s,
quest: a
  } = e, n = (0, d.Mi)(a, c.jn.GIFT_INVENTORY_FOR_YOU), r = (0, l.tP)(a), i = (null === (t = a.userStatus) || void 0 === t ? void 0 : t.claimedAt) != null;
  return s !== c.jn.QUEST_BAR && s !== c.jn.QUEST_BAR_V2 && (s !== c.jn.QUEST_HOME_DESKTOP || !n || r || i) ? s === c.jn.ACTIVITY_PANEL || s === c.jn.QUESTS_EMBED || s === c.jn.QUEST_LIVE_STREAM ? (0, o.jsx)(j, {
activity: !0
  }) : null : (0, o.jsx)(j, {
location: !0,
age: !0,

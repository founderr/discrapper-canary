s(47120);
var n = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(512722), l = s.n(o), c = s(442837), d = s(780384), _ = s(481060), E = s(816814), u = s(809206), T = s(497321), I = s(279837), S = s(952306), N = s(346585), C = s(347649), m = s(332473), A = s(303172), h = s(921801), g = s(484459), O = s(430824), p = s(325067), R = s(246946), x = s(594174), M = s(285952), f = s(474333), D = s(499150), P = s(709054), L = s(706454), Z = s(210887), b = s(418632), v = s(730820), j = s(888256), B = s(2719), U = s(194530), G = s(726985), F = s(981631), y = s(801461), V = s(689938), Y = s(363210), w = s(549856);
class k extends a.PureComponent {
    ...
    renderPomeloWarning() {
        return this.props.shouldRenderPomeloWarning ? (0, n.jsxs)(f.Z, {
            className: Y.accountWarningBodyText,
            messageType: f.Q.WARNING,
            children: [
                this.props.forceMigrationExperiment ? V.Z.Messages.POMELO_ACTION_NEEDED_FORCE.format({ date: (0, N.IE)(this.props.locale) }) : V.Z.Messages.POMELO_ACTION_NEEDED.format(),
                ' ',
                '',
                (0, n.jsx)(D.Z, {
    ...
    handleDisableAccount() {
        let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], {currentUser: t} = this.props, s = O.Z.getGuilds();
...
t.Z = () => {
    let e = (0, c.e7)([x.default], () => {
        ...
        }), t = (0, c.e7)([p.Z], () => p.Z.getBackupCodes()), s = (0, c.e7)([R.Z], () => R.Z.hidePersonalInformation), a = (0, c.e7)([Z.Z], () => Z.Z.theme), i = (0, m.b)(), r = (0, C.CC)(), o = (0, c.e7)([L.default], () => L.default.locale);
    return (0, n.jsx)(k, {
        theme: a,
        currentUser: e,
        backupCodes: t,

...
class W extends n.PureComponent {
  ...
  renderPomeloWarning() {
    return this.props.shouldRenderPomeloWarning ? (0, a.jsxs)(M.default, {
      ...
      }) : H.default.Messages.POMELO_ACTION_NEEDED.format(), " ", "", (0, a.jsx)(L.default, {
        className: w.noticeTextButton,
        onClick: () => (0, N.default)(V.PomeloEntrypoints.USER_SETTINGS),
  ...
  handleDisableAccount() {
    ...
    if (D.default.keys(s).filter(e => s[e].ownerId === t.id).length > 0) {
      this.setState({

...
!T.Z.isSupported() || T.Z.isLocalMute(N),
!1,
T.Z.isLocalVideoDisabled(N)
  ], [
O,
N
  ]), U = (0, r.e7)([A.Z], () => A.Z.isPrioritySpeaker(N)), w = (0, c.Z)({
userId: N,
checkSoundSharing: !0
  }), B = (0, r.e7)([x.ZP], () => x.ZP.isGuestOrLurker(l.guild_id, N)), H = (0, r.e7)([u.ZP], () => u.ZP.getEmbeddedActivitiesForChannel(l.id).find(e => {
let {
  userIds: t
} = e;
return t.has(N);
...
v.Z,
S.Z
  ], () => O ? S.Z.getActivities() : v.Z.getActivities(N, l.guild_id)).find(e => null != e.application_id && e.type === L.IIU.PLAYING), W = (0, r.e7)([d.Z], () => (null == F ? void 0 : F.application_id) != null ? d.Z.getApplication(null == F ? void 0 : F.application_id) : void 0);
...
l,
N
  ]), K = (0, r.e7)([Z.Z], () => Z.Z.getSessionById(o)), q = b.ZP.useName(s), X = (0, r.e7)([M.Z], () => M.Z.getVoicePlatformForChannel(l.id, N), [
l.id,
N
  ]), {
enableHangStatus: Q
...
guildId: l.guild_id,
location: 'VoiceUsers'
  }), J = (0, m.Z)(l, !0, s), $ = (0, r.e7)([_.Z], () => O ? _.Z.getHangStatusActivity() : null, [O]), ee = (0, r.e7)([v.Z], () => v.Z.findActivity(N, e => e.type === L.IIU.HANG_STATUS), [N]), et = (0, E.Eu)(l.id, N);
  return (0, i.jsx)(f.Z, {

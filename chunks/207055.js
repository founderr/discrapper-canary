...
let y = s.memo((e) => {
    ...
    let { mute: n, deaf: s, user: a, channel: l, sessionId: o, nick: g } = e,
        ...
        [y, D, k] = (0, r.Wu)([T.Z], () => (O ? [!T.Z.isSupported() || T.Z.isSelfMute() || T.Z.isSelfMutedTemporarily(), T.Z.isSelfDeaf(), !1] : [!T.Z.isSupported() || T.Z.isLocalMute(S), !1, T.Z.isLocalVideoDisabled(S)]), [O, S]),
        U = (0, r.e7)([Z.Z], () => Z.Z.isPrioritySpeaker(S)),
        w = (0, c.Z)({
            userId: S,
            checkSoundSharing: !0
        }),
        B = (0, r.e7)([x.ZP], () => x.ZP.isGuestOrLurker(l.guild_id, S)),
        H = (0, r.e7)(
            [u.ZP],
            () =>
    ...
    return (0, i.jsx)(f.Z, {
        ...
        children: (0, i.jsx)(L.ZP, {
            ...
            isGuest: B,
            showHangStatus: J && Q && (I.default.getId() === a.id || null != ee),
...
let D = [];
t.Z = function (e) {
    let { allowPreviews: t = !0, allowDragging: n = !0, channel: a, voiceStates: c, collapsed: u, collapsedMax: d = 6, tabIndex: m, location: p, numAudience: _, withGuildIcon: f = !1, className: C, children: x } = e,
        [T, N] = s.useState(null),
        [A, Z] = s.useState(!1),
        M = s.useRef(null),
        ...
        U = s.useCallback(
            (e) => {
                t && (R.current.cancel(), T === e && (Z(!1), j.current.delay()));
            },
            [t, T]
        ),
        w = (0, r.Wu)([v.Z], () => {

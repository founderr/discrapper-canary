...
}, t._client = this._client, t._lastEventId = this._lastEventId, (0, a.D)(t, (0, a.Y)(this)), t;
  }
  setClient(t) {
this._client = t;
  }
...
return this._tags = {
  ...
  ...this._contexts,
  ...c
}, u && Object.keys(u).length && (this._user = u), a && (this._level = a), l.length && (this._fingerprint = l), h && (this._propagationContext = h), r && (this._requestSession = r), this;
  }
  clear() {
...
if (!this._client)
  return u.kg.warn('No client configured on scope - will not capture exception!'), n;
...
if (!this._client)
  return u.kg.warn('No client configured on scope - will not capture message!'), r;
let i = Error(t);
...
return this._client ? (this._client.captureEvent(t, {
  ...e,
  event_id: n
}, this), n) : (u.kg.warn('No client configured on scope - will not capture event!'), n);
  }

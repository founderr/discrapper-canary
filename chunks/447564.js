...
function N(e) {
    ...
    (0, a.useEffect)(
        () => (
            null != m && !1 === m.consumed && r && m.type !== g.qc2.DEVELOPER_GIFT && (0, f.Zu)(t.id, E.FX),
            () => {
                S && (0, f.SN)(E.FX);
            }
        ),
    ...
    let T = (0, a.useMemo)(
        ...
        N = (0, a.useMemo)(() => () => (t.isHDStreamSplashed ? 4 : n ? ((null == m ? void 0 : m.type) === g.qc2.DEVELOPER_GIFT ? 1 : x ? 2 : 0) : 3), [t.isHDStreamSplashed, n, null == m ? void 0 : m.type, x]),
        y = (0, a.useMemo)(() => N(), [N]);
    return (0, o.jsx)(w, {
        channel: t,
        buttonState: y,
            ...
            : null == r
              ...
              : (0, o.jsxs)(o.Fragment, {
                    children: [
                        (0, o.jsxs)('div', {
                            className: S.modal,
                            children: [(0, o.jsx)(y, {}), (0, o.jsx)(M, { channel: t })]
                        }),
                        (0, o.jsx)(O, {
                            buttonState: n,
                            price: r,

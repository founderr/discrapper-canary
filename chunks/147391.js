...
source: M
  ...
  if (s === c.bi.BUILT_IN || (null === (t = p.result) || void 0 === t ? void 0 : t.sections[s]) != null || (null === (n = _.result) || void 0 === n ? void 0 : n.sections[s]) != null)
...
(0, o.openOAuth2Modal)({
  ...
  callback: t => {
    ...
    null != n ? ((0, a.yw)(d.rMx.APP_LAUNCHER_OAUTH2_AUTHORIZE_SUCCEEDED, {
      location: g,
      application_id: s,
      section_name: E,
      source: M

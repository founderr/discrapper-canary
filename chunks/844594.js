...
function A(e) {
  let {
    ...
    user: a,
    displayProfile: v,
    pendingAvatar: g === p.UploadTypes.AVATAR ? R : void 0,
    isPreview: !0
  });
  return l.useEffect(() => {
    u.default.track(m.AnalyticEvents.PREMIUM_UPSELL_VIEWED, {
    ...
    children: [(0, n.jsx)(r.default, {
      ...
      disabledInputs: !0,
      pendingAvatar: g === p.UploadTypes.AVATAR ? R : void 0,
      pendingBanner: g === p.UploadTypes.BANNER ? R : void 0,
      ...
      children: [(0, n.jsx)(i.Text, {
        ...
        children: g === p.UploadTypes.AVATAR ? I.default.Messages.PREMIUM_PREVIEW_JOIN_AVATAR : I.default.Messages.PREMIUM_PREVIEW_JOIN_BANNER
      }), (0, n.jsx)(t.default, {

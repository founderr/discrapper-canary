...
var l = t(735250);
t(470079);
var i = t(442837), u = t(481060), s = t(889161), r = t(924301), a = t(894017), d = t(79874), E = t(576749), o = t(689938);
function c(e) {
    let {
            guildEventId: n,
            guild: c,
            ...
            recurrenceId: T,
            isRecurrenceItem: N
        } = e, {canManageGuildEvent: I} = (0, s.XJ)(null != _ ? _ : c), Z = (0, i.e7)([r.ZP], () => r.ZP.getGuildScheduledEvent(n)), f = I(Z), g = (0, E.Z)(), M = (0, a.Z)(T, null == Z ? void 0 : Z.id), D = (0, d.zI)(n, T);
    if (!f || null == D || null == Z)
        return null;
    let v = null != Z.recurrence_rule && !N, S = e => {

...
let eO = Object.freeze({
  ...
  [eS.MessageTypes.CALL]: function(e) {
    let {
      ...
      id: r,
      author: o
    } = t, d = D.default.getId(), c = t.getChannelId(), E = (0, l.useStateFromStores)([y.default], () => y.default.isCallActive(c, r), [c, r]), f = (0, l.useStateFromStores)([k.default], () => k.default.getVoiceState(eS.ME, d)), _ = !E && null != t.call && !t.call.participants.includes(d), T = E && (null == f || f.channelId !== c), m = a.useCallback(() => u.default.selectVoiceChannel(c), [c]), I = (0, ep.useUsernameHook)({
      user: o,
      channelId: c,
      guildId: i.guild_id,
      messageId: t.id

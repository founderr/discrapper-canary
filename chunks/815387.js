...
guild_id: o
  } = n, c = t.getChannelId(), u = (0, s.e7)([j.Z], () => j.Z.getGuild(o), [o]), d = a.useCallback(() => {
if (null != u)
  (0, T.f)({
    guildId: u.id,
    location: {
...
let {
  ...
  author: r
} = t, l = t.getChannelId(), o = (0, s.e7)([k.default], () => k.default.getUser(t.mentions[0]), [t]), c = w.ZP.getName(null, l, o), u = (0, z.l)({
  user: r,
  channelId: l,
  guildId: n.guild_id,
  messageId: t.id
...
let {
  ...
  guildId: l.guild_id,
  messageId: a.id
}), d = (0, s.e7)([U.Z], () => U.Z.can(eC.Plq.MUTE_MEMBERS, l)), _ = (0, s.e7)([O.Z], () => O.Z.getParticipant(l.id, a.author.id)), E = new Date(H.default.extractTimestamp(a.id)).toISOString() === new Date(null !== (n = null == _ ? void 0 : null === (t = _.voiceState) || void 0 === t ? void 0 : t.requestToSpeakTimestamp) && void 0 !== n ? n : 0).toISOString(), I = d && (null == _ ? void 0 : _.rtsState) === x.xO.REQUESTED_TO_SPEAK && E;
return (0, i.jsxs)(i.Fragment, {
  children: [
    (0, i.jsx)(eu.Z, {
      message: a,

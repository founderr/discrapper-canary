...
let ex = Object.freeze({
  ...
  [ep.uaV.RECIPIENT_REMOVE]: function(e) {
    let {
      ...
      author: l
    } = t, r = t.getChannelId(), o = (0, s.e7)([k.default], () => k.default.getUser(t.mentions[0]), [t]), c = (0, ef.l)({
      user: l,
      channelId: r,
      guildId: n.guild_id,
      messageId: t.id
  ...
  [ep.uaV.THREAD_CREATED]: function(e) {
    let {
      ...
      (0, l.openModalLazy)(async () => {
        let {
          default: e
        } = await Promise.all([n.e("91315"), n.e("32627")]).then(n.bind(n, 223901));
        return t => (0, i.jsx)(e, {
          channel: s,
          ...t
        })
  ...
  [ep.uaV.STAGE_START]: function(e) {
    ...
    return (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsx)(es.Z, {
        ...
        compact: a,
        usernameHook: l
      }), null != r && r.name === t.content ? (0, i.jsx)(p.Z, {

...
let {
  ...
  d,
  l
]), E = (0, a.e7)([G.Z], () => G.Z.getVoiceState(eC.ME, u)), I = !_ && null != t.call && !t.call.participants.includes(u), m = _ && (null == E || E.channelId !== d), T = s.useCallback(() => c.default.selectVoiceChannel(d), [d]), h = (0, z.l)({
  user: o,
  channelId: d,
  guildId: r.guild_id,
  messageId: t.id
...
let {
  ...
  messageReference: c
} = t, d = t.getChannelId(), _ = (0, a.e7)([y.Z], () => y.Z.findActivity(o, e => e.type === eC.IIU.PLAYING), [o]), E = (0, a.e7)([b.Z], () => null != c ? b.Z.getChannel(c.channel_id) : null, [c]), I = null == c ? void 0 : c.guild_id, m = (0, z.l)({
  user: l,
  channelId: d,
  guildId: r.guild_id,
  messageId: t.id
...
return (0, m.nY)(t) ? (0, i.jsx)(q.Z, {
  ...
  [eC.uaV.GUILD_INCIDENT_ALERT_MODE_ENABLED]: eM,
  [eC.uaV.GUILD_INCIDENT_ALERT_MODE_DISABLED]: eM,
...
let {
  ...
  guildId: n.guild_id,
  messageId: t.id
}), l = (0, a.e7)([f.ZP], () => f.ZP.getActiveEventByChannel(n.id), [n.id]);
return (0, i.jsxs)(i.Fragment, {
  children: [
    (0, i.jsx)(e_.Z, {
      message: t,
...
let {
  ...
  guildId: l.guild_id,
  messageId: s.id
}), d = (0, a.e7)([U.Z], () => U.Z.can(eC.Plq.MUTE_MEMBERS, l)), _ = (0, a.e7)([O.Z], () => O.Z.getParticipant(l.id, s.author.id)), E = new Date(H.default.extractTimestamp(s.id)).toISOString() === new Date(null !== (n = null == _ ? void 0 : null === (t = _.voiceState) || void 0 === t ? void 0 : t.requestToSpeakTimestamp) && void 0 !== n ? n : 0).toISOString(), I = d && (null == _ ? void 0 : _.rtsState) === x.xO.REQUESTED_TO_SPEAK && E;
return (0, i.jsxs)(i.Fragment, {
  children: [
    (0, i.jsx)(eu.Z, {
      message: s,

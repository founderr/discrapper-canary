var r, i = SyntaxError, a = Function, o = TypeError, s = function (e) {
        try {
        } catch (e) {
        }
...
var u = function () {
    ...
    }() : u, d = n(322499)(), _ = n(79536)(), E = Object.getPrototypeOf || (_ ? function (e) {
        return e.__proto__;
    } : null), f = {}, h = 'undefined' != typeof Uint8Array && E ? E(Uint8Array) : r, p = {
...
var I = function e(t) {
    ...
    }, g = n(390976), S = n(706165), A = g.call(Function.call, Array.prototype.concat), N = g.call(Function.apply, Array.prototype.splice), v = g.call(Function.call, String.prototype.replace), O = g.call(Function.call, String.prototype.slice), R = g.call(Function.call, RegExp.prototype.exec), C = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, y = /\\(\\)?/g, D = function (e) {
...
e.exports = function (e, t) {
    ...
    var n = D(e), r = n.length > 0 ? n[0] : '', a = L('%' + r + '%', t), s = a.name, u = a.value, c = !1, d = a.alias;
    d && (r = d[0], N(n, A([
        0,
        1
    ], d)));
    for (var _ = 1, E = !0; _ < n.length; _ += 1) {
        var f = n[_], h = O(f, 0, 1), m = O(f, -1);
        if (('"' === h || '\'' === h || '`' === h || '"' === m || '\'' === m || '`' === m) && h !== m)

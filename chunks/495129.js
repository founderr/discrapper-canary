...
function g(e) {
  ...
  })) || void 0 === v ? void 0 : v.rawValue, K = null != W ? W.split(",") : [], z = (0, i.useStateFromStoresArray)([I.default], () => K.map(e => I.default.getUser(e)).filter(Boolean)), Q = B && null != k ? A.default.Messages.WAVED_AT_USER.format({
    username: H
  }) : A.default.Messages.WAVED_AT_YOU.format({
    username: w.nick
  }), q = null != j && null != b, J = null;
  J = q ? B || Y ? A.default.Messages.YOU_ARE_IN_CHANNEL.format({
    channelHook: (e, t) => (0, s.jsx)(N.default, {
  ...
  return (0, s.jsxs)("div", {
    children: [(0, s.jsxs)("div", {
      ...
      children: [(0, s.jsxs)(r.Button, {
        ...
        disabled: Y || !q,
        children: [(0, s.jsx)(p.default, {}), A.default.Messages.JOIN_HANGOUT]
      }), (0, s.jsx)(r.Button, {

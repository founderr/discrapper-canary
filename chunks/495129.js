...
function g(e) {
  ...
  let {
    ...
    return "channel_id" === t
  })) || void 0 === g ? void 0 : g.rawValue, j = (0, a.e7)([N.Z], () => N.Z.getGuild(P)), U = (0, a.e7)([T.Z], () => T.Z.getChannel(D)), y = (0, a.e7)([m.default], () => m.default.getCurrentUser()), b = (0, a.e7)([], () => L.author.id === (null == y ? void 0 : y.id)), B = null === (R = Z.recipients) || void 0 === R ? void 0 : R.find(e => e !== L.author.id), k = (0, a.e7)([m.default], () => null != B ? m.default.getUser(B) : null), G = (0, d.ZP)(L), F = (0, C._T)(Z.getGuildId(), Z.id, k), V = (0, a.Wu)([h.ZP], () => null != U ? h.ZP.getVoiceStatesForChannel(U) : [], [U]), w = V.some(e => e.user.id === (null == y ? void 0 : y.id)), H = null === (v = L.embeds[0]) || void 0 === v ? void 0 : null === (x = v.fields) || void 0 === x ? void 0 : null === (M = x.find(e => {
    let {
      rawName: t
    } = e;
    return "voice_user_ids" === t
  })) || void 0 === M ? void 0 : M.rawValue, Y = null != H ? H.split(",") : [], K = (0, a.Wu)([m.default], () => Y.map(e => m.default.getUser(e)).filter(Boolean)), W = b && null != k ? A.Z.Messages.WAVED_AT_USER.format({
    username: F
  }) : A.Z.Messages.WAVED_AT_YOU.format({
    username: G.nick
  }), z = null != j && null != U, Q = null;
  Q = z ? b || w ? A.Z.Messages.YOU_ARE_IN_CHANNEL.format({
    channelHook: (e, t) => (0, s.jsx)(E.Z, {
  ...
  return (0, s.jsxs)("div", {
    children: [(0, s.jsxs)("div", {
      ...
      children: [(0, s.jsxs)(r.Button, {
        ...
        onClick: () => {
          null != D && null != P && ((0, I.uL)(S.Z5c.CHANNEL(P, D)), c.default.selectVoiceChannel(D))
        },
        className: p.button,

...
return 'guild_id' === t;
  })) || void 0 === t ? void 0 : t.rawValue, D = null === (M = Z.embeds[0]) || void 0 === M ? void 0 : null === (A = M.fields) || void 0 === A ? void 0 : null === (S = A.find(e => {
let {
  rawName: t
} = e;
return 'channel_id' === t;
  })) || void 0 === S ? void 0 : S.rawValue, b = (0, r.e7)([T.Z], () => T.Z.getGuild(P)), j = (0, r.e7)([m.Z], () => m.Z.getChannel(D)), U = (0, r.e7)([h.default], () => h.default.getCurrentUser()), y = (0, r.e7)([], () => Z.author.id === (null == U ? void 0 : U.id)), B = null === (R = L.recipients) || void 0 === R ? void 0 : R.find(e => e !== Z.author.id), k = (0, r.e7)([h.default], () => null != B ? h.default.getUser(B) : null), G = (0, d.ZP)(Z), F = (0, f._T)(L.getGuildId(), L.id, k), w = (0, r.Wu)([N.ZP], () => null != j ? N.ZP.getVoiceStatesForChannel(j) : [], [j]), V = w.some(e => e.user.id === (null == U ? void 0 : U.id)), H = null === (v = Z.embeds[0]) || void 0 === v ? void 0 : null === (x = v.fields) || void 0 === x ? void 0 : null === (O = x.find(e => {
let {
  rawName: t
} = e;

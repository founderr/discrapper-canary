...
var i = n(735250), a = n(470079), l = n(392711), s = n.n(l), r = n(566898), o = n(981631), c = n(658977);
function d(e) {
    let {
        compact: t,
        messageGroups: n,
    ...
    let d = l / o.yqN.FONT_SIZE_DEFAULT, u = t ? r.iv : r.pk, h = t ? r.Pb : r.XX, p = 0, m = Array(n).fill(null).map(() => {
            let e = s().random(1, i);

...
class V extends(l = T.default.PersistedStore) {
  ...
  initialize(e) {
    var t;
    i = null === (t = null == e ? void 0 : e.shouldShowTopicsBar) || void 0 === t || t, this.waitFor(N.default, g.default, C.default, p.default, A.default), this.syncWith([m.default], x)
  }
  allSummaries() {
    return y
  }

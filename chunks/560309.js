...
let D = e => e === R.GuildScheduledEventEntityTypes.EXTERNAL,
  ...
  U = e => {
    let {
      ...
      disabled: i,
      entityType: r
    } = e, o = n === O.ChannelTypes.GUILD_STAGE_VOICE, c = (0, p.isChannelPublic)(a, r), E = (0, g.useGetEventChannelsByType)(t, n);
...
function H(e) {
  let {
    ...
    guildEvent: n,
    onChange: s
  } = e, i = (0, r.useStateFromStores)([c.default], () => c.default.getGuild(t), [t]), d = (0, S.default)(t, void 0), o = (0, S.default)(t, O.ChannelTypes.GUILD_VOICE), E = (0, S.default)(t, O.ChannelTypes.GUILD_STAGE_VOICE), f = (0, g.useGetEventChannelsByType)(t, O.ChannelTypes.GUILD_VOICE), I = (0, C.useChannelsUserCanStartStageIn)(i), T = null == i ? void 0 : i.hasFeature(O.GuildFeatures.COMMUNITY), N = (0, m.isGuildScheduledEventActive)(n), p = G(s, n), x = a.useMemo(() => {
    let e = [{
...
function b(e) {
  let {
    ...
    entityType: o
  } = a, f = (0, r.useStateFromStores)([c.default], () => c.default.getGuild(t), [t]), I = (0, C.useChannelsUserCanStartStageIn)(f), _ = (0, r.useStateFromStores)([E.default], () => E.default.can(O.Permissions.MANAGE_CHANNELS, f)), h = null == f ? void 0 : f.hasFeature(O.GuildFeatures.COMMUNITY), T = G(i, a), v = h && !D(o) && 0 === I.length && _ && null != o;
  return (0, l.jsxs)("div", {

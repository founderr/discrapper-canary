...
var R = [],
    v = function () {
        (this.changed = !1), (this.values = R), (this.toValues = null), (this.fromValues = R), (this.to = void 0), (this.from = void 0), (this.config = new N()), (this.immediate = !1), (this.onStart = void 0), (this.onChange = void 0), (this.onRest = []);
    };
function C(e, t) {
...
function k(e, t) {
    ...
    return new Promise(function (t, l) {
        ...
        _ ? h() : ((u = L(r.delay || 0, n)), (d = D(r.pause, n)) ? (i.resumeQueue.add(f), o.pause()) : (o.resume(), f()));
    });
}
var B = function (e, t) {
        return 1 == t.length
                                                        ...
                                                        case 0:
                                                            return (
                                                                ...
                                                                a.is.arr(t)
                                                                    ...
                                                                    : a.is.fun(t) && (N = Promise.resolve(t(g, i.stop.bind(i)))),
                                                                (e.next = 11),
                                                                Promise.all([N.then(p), m])
                                                            );
                                                        case 11:
                                                            (A = V(i, !0)), (e.next = 21);
                                                            break;
    ...
    en = (function (e) {
        ...
        return (
                            ...
                            if (!_) {
                                ...
                                if (a.is.und(s.duration)) {
                                    if (s.decay) {
                                        ...
                                        for (var T, S = s.precision || (h == d ? 0.005 : Math.min(1, 0.001 * Math.abs(d - h))), g = s.restVelocity || S / 10, A = s.clamp ? 0 : s.bounce, N = !a.is.und(A), O = h == d ? u.v0 > 0 : h < d, R = !1, v = Math.ceil(e / 1), C = 0; C < v && !(!(Math.abs(T) > g) && (_ = Math.abs(d - E) <= S)); ++C) {
                                            N && (R = E == d || E > d == O) && ((T = -T * A), (E = d));
                                    ...
                                    var L = s.progress || 0;
                                    s.duration <= 0 ? (L = 1) : (L += (1 - L) * Math.min(1, f / s.duration)), (T = ((E = h + s.easing(L) * (d - h)) - u.lastPosition) / e), (_ = 1 == L);
                                }
            ...
            (r._merge = function (e, t, n) {
                ...
                var N = !a.isEqual(I, f);
                N && this._focus(I);
                var R = a.getFluidConfig(I),
                    v = a.getFluidConfig(T);
                v && (T = v.get());
                ...
                t.config &&
                    !C &&
                    !(function (e, t, n) {
                        for (var r in (n && (O((n = s({}, n)), t), (t = s(s({}, n), t))), O(e, t), Object.assign(e, t), A)) null == e[r] && (e[r] = A[r]);
                        var i = e.mass,
                            o = e.frequency,
                            l = e.damping;
                        !a.is.und(o) && (o < 0.01 && (o = 0.01), l < 0 && (l = 0), (e.tension = Math.pow((2 * Math.PI) / o, 2) * i), (e.friction = (4 * Math.PI * l * i) / o));
                    })(y, L(t.config, r), t.config !== o.config ? L(o.config, r) : void 0);
                ...
                if ((z && this.is(J) && (i.changed && !w ? (K = !0) : !K && this._stop()), !C)) {
                    (K || a.getFluidConfig(f)) && ((i.values = U.getPayload()), (i.toValues = R ? null : W == _.AnimatedString ? [1] : a.toArray(k))), (i.immediate = Z), (i.onStart = ei(c('onStart'), r)), (i.onChange = ei(c('onChange'), r));
                    var Q = i.onRest,
...
function eA(e, t, n) {
    ...
    return r || 3 == arguments.length ? [S, I.start, I.stop] : S;
}
function eN(e, t) {
    var n = a.is.fun(e),
        r = eA(1, n ? e : [e], n ? t || [] : t),
...
function eL(e, t, n) {
    ...
    if (
        ...
        a.each(T, function (e, n) {
            var r = m[n];
            ~e ? ((S = h.indexOf(r)), (h[S] = s(s({}, r), {}, { item: f[e] }))) : t.leave && h.splice(++S, 0, r);
        });
    }
    a.is.fun(u) &&
        h.sort(function (e, t) {
    ...
    a.each(h, function (e, n) {
        ...
        if (((r = L(r, e.item, n)), !(r = a.is.obj(r) ? x(r) : { to: r }).config)) {
            var c = t.config || N.config;
            r.config = L(c, e.item, n);
        }
        var _ = s(
            s({}, N),
            {},
            ...
            function () {
                a.each(O, function (e, t) {
                    var n = e.phase,
                        i = e.springs,
                        a = e.payload;
                    ef(t.ctrl, i), !R.cancel && ((t.phase = n), n == ev && t.ctrl.start({ default: R }), t.ctrl[r ? 'update' : 'start'](a));
                });
            },
            l ? void 0 : n
        );
    var C = function (e) {
        return o.createElement(
            ...
            null,
            h.map(function (t, n) {
                var r = e(s({}, (O.get(t) || t.ctrl).springs), t.item, t, n);
                return r && r.type
                    ? o.createElement(
                          r.type,
                          s({}, r.props, {
...
Object.keys(S).forEach(function (e) {
    ...
    (t.Transition = function (e) {
        var t = e.items,
            n = e.children,
            r = I(e, ['items', 'children']);
        return o.createElement(o.Fragment, null, eL(t, r)(n));
    }),
    (t.config = g),
    (t.inferTo = x),

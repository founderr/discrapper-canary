...
function S() {
    return null != T
        ? Promise.resolve(T)
        : (0, _.isDesktop)()
          ? f.ZP.ensureModule('discord_game_utils').then(() => {
...
t.Z = {
    waitSubscribed: (e, t) => new Promise((n, r) => R(() => s.Z.isSubscribed(e, t), n, r)),
    waitConnected(e) {
    ...
    launchDispatchApplication(e, t, n, i, s) {
        ...
        return (0, r.o)([f])
            .then((e) => {
                ...
                let { liveBuildId: n } = t;
                if (I && n !== p) return Promise.reject(Error('live build id changed'));
            })
            .then(() => d.Z.runLaunchSetup(E, f))
            .then(() => {
                let e = (0, a.Z)(_),
                    r = {

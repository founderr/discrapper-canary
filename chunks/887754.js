...
let x = () => {
  let {
    guild: e
  } = (0, r.useStateFromStoresObject)([f.default], () => f.default.getProps()), t = (0, r.useStateFromStores)([T.default], () => T.default.formState), s = (0, r.useStateFromStores)([T.default], () => T.default.errorMessage);

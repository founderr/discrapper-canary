...
var s, T = E(470079), I = E(392711), n = E.n(I), A = E(442837), t = E(570140), a = E(944163), r = E(709054), N = E(116175), L = E(308083);
function S(e, _, E) {
...
let D = new Map(), l = new Map(), U = !1, G = Object.freeze({
    ...
    initialize(e) {
        null != e && r.default.keys(e.progressByGuild).forEach(_ => {
            ...
            D.set(_, {
                ...
                tag: E.tag,
                verificationForm: null !== (T = E.verificationForm) && void 0 !== T ? T : { ...a.t },
...
S(o, 'displayName', 'ClanSetupStore'), S(o, 'persistKey', 'ClanSetupStore'), _.ZP = new o(t.Z, {

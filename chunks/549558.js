...
let b = e => {
  ...
  }), C = (0, u.useStateFromStores)([m.default], () => m.default.keyboardModeEnabled), S = (0, A.default)(l, null === (t = i.textValue) || void 0 === t ? void 0 : t.trim()), M = n.useMemo(() => S.find(e => e.isThumbnail), [S]), b = null != S && S.length > 0, L = n.useMemo(() => {
    ...
    children: b ? (0, s.jsxs)(s.Fragment, {
      children: [(0, s.jsx)(F, {
        ...
        className: r(j.changeThumbnailLabelContainer, {
          [j.changeThumbnailLabelOverflow]: (null == S ? void 0 : S.length) > 2
        }),

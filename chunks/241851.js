...
let g = e => {
  let {
    ...
    await u.Z.leaveGuild(l), e ? (0, c.uL)(E.Z5c.GUILD_DISCOVERY) : !(0, r.un)(s.z.GUILD_LEAVE_FEEDBACK) && (0, o.openModalLazy)(async () => {
      let {
        default: e
      } = await Promise.all([t.e("49237"), t.e("99387"), t.e("41953")]).then(t.bind(t, 131102));
      return t => (0, a.jsx)(e, {
        ...t,
        guildId: l,
        guildName: n.name
  ...
  return (0, a.jsx)(o.ConfirmModal, {
    ...
    children: (0, a.jsx)(o.Text, {
      ...
      children: n.hasFeature(E.oNc.HUB) ? I.Z.Messages.LEAVE_HUB_BODY.format({
        name: n.name
      }) : I.Z.Messages.LEAVE_SERVER_BODY.format({
        name: n.name
      })
    })
  })

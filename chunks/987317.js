  ...
  p = {
    ...
    selectVoiceChannel(e) {
      ...
      if ((null == s ? void 0 : s.isGuildVocal()) && (null == s ? void 0 : s.isNSFW()) && (!(null === (t = h.default.getCurrentUser()) || void 0 === t ? void 0 : t.nsfwAllowed) || !d.default.didAgree(r))) {
        (0, o.transitionTo)(E.Routes.CHANNEL(r, e));
        return
      }
      c.default.isSupported() && (null != e && c.default.getMediaEngine().interact(), (0, m.selectVoiceChannelAdditional)(e, r, n, i))
    },
    disconnect() {
      ...
      if (null != e && s.remoteDisconnect(e), (0, l.isOldVoiceUIEnabled)()) {
        ...
        if (this.selectVoiceChannel(null), a.close(E.PopoutWindowKeys.CHANNEL_CALL_POPOUT), t) {
          let e = _.default.getGuildId();
          null != e && (0, o.transitionTo)((0, g.previousTextChannelRouteForGuild)(e))
        }

var r = n(735250);
n(470079);
var i = n(952265), a = n(285651), o = n(268350), s = n(926491), l = n(373228), u = n(419922), c = n(430824), d = n(156361), _ = n(483360), E = n(877565), f = n(590921), h = n(665692), p = n(981631), m = n(689938), I = n(611032);
function T(e, t) {
    return (0, r.jsx)(u.ZP, {
        sticker: e,
        isInteracting: t,
...
let g = {
    ...
    queryResults(e, t, n, r, i) {
        let s = r.allowStickers ? 0 : 40, l = p.rnv + s, {
                emojis: {unlocked: u}
    ...
    renderResults(e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
            children: [
                ...
                (t.length > 0 || o.length > 0) && a.length > 0 && (0, r.jsx)(d.ZP.Divider, { className: I.emojiStickersDivider }),
                (0, E.HI)({
                    query: l,
                    selectedIndex: s,
                    autocompletes: a,
    ...
    onSelect(e) {
        ...
        if (i < t.length) {
            ...
            return a.insertText(function (e) {
                ...
                var t;
                let n = e.animated ? 'a' : '';
                return e.managed || null == e.id ? ''.concat(h.Iv).concat(e.name).concat(h.Iv) : '<'.concat(n, ':').concat(null !== (t = e.originalName) && void 0 !== t ? t : e.name, ':').concat(e.id, '>');
            }(e)), {
                type: f.z2.EMOJI,
                metadata: {
                    emojiId: e.id,

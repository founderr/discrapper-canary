...
function y(e, t, n) {
  ...
  let i = n.getGuildId();
  return !(null != i && s.default.isLurking(i) || t.id === e.id || E.default.isBlocked(t.id) || !l && S.default.getStatus() === R.StatusTypes.DND || f.FocusMode.getSetting() || !a && N.default.allowNoMessages(n)) && !0
}
...
function D(e, t) {
  ...
  if (!l) {
    let e = _.default.getChannelId(I.default.getGuildId());
  ...
  if (h.THREAD_CHANNEL_TYPES.has(s.type)) {
    ...
    return t !== O.ThreadMemberFlags.NO_MESSAGES && (t === O.ThreadMemberFlags.ALL_MESSAGES || (0, o.isRawMessageMentioned)({
      rawMessage: e,
      userId: r.id,
      suppressEveryone: !1,
      suppressRoles: !1
...
function b(e, t) {
  var n;
  if (_.default.getChannelId(I.default.getGuildId()) !== t) return !1;
  ...
  return !(null == l || null == a || null == s || l.isManaged() || s.hasFlag(R.UserFlags.SPAMMER) || E.default.isBlocked(s.id) || s.id === a.id || S.default.getStatus() === R.StatusTypes.DND || f.FocusMode.getSetting() || N.default.allowNoMessages(l)) && !0
}
...
function j(e, t) {
  ...
  return !(null == t || null == a || null == s || !y(a, s, t, l, !0) || N.default.isGuildOrCategoryOrChannelMuted(t.guild_id, t.id)) && (!!n || _.default.getChannelId(I.default.getGuildId()) !== t.id) && N.default.getNewForumThreadsCreated(t)
}
...
function P(e, t, n) {
  ...
  switch (e.type) {
    ...
    case R.ChannelTypes.PRIVATE_THREAD:
      ...
      t.type === R.MessageTypes.THREAD_STARTER_MESSAGE && null != c ? d = G(d, c, C.default.getChannel(c.parent_id)) : (0, u.default)(t) ? null != m.default.getGuild(e.getGuildId()) && (d = G(d, e, c)) : d = G(d, e, c);
      break;
    case R.ChannelTypes.GROUP_DM:

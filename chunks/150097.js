...
var i = n(933557), l = n(710845), u = n(978003), a = n(41776), s = n(355298), o = n(957730), r = n(572804), d = n(901461);
n(734934);
var _ = n(569471), E = n(723170), c = n(695346), T = n(131704), I = n(433355), f = n(592125), g = n(430824), N = n(19780), S = n(699516), C = n(944486), A = n(914010), Z = n(885110), O = n(9156), h = n(594174), D = n(630388), v = n(5192), M = n(352736), p = n(51144), R = n(981631), m = n(124368), L = n(689938);
function U(e, t, n) {
...
function y(e, t) {
    var n;
    let i = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], l = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
    ...
    let a = h.default.getCurrentUser(), o = h.default.getUser(null === (n = e.author) || void 0 === n ? void 0 : n.id);
    ...
    }
    {
        ...
        if (O.ZP.allowAllMessages(u) && t)
            return !0;
        let n = O.ZP.isSuppressEveryoneEnabled(u.getGuildId()), i = O.ZP.isSuppressRolesEnabled(u.getGuildId());
        return (0, r.Hl)({
            rawMessage: e,
            userId: a.id,
            suppressEveryone: n,
...
function G(e, t) {
    ...
    let l = h.default.getCurrentUser(), u = h.default.getUser(null === (n = e.author) || void 0 === n ? void 0 : n.id);
...
function P(e, t) {
    let n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], i = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], l = h.default.getCurrentUser(), u = h.default.getUser(e.ownerId);
...
function w(e, t, n) {
    var a, s, r, _, E;
    let c;
    let T = v.ZP.getName(e.getGuildId(), e.id, n), I = T;
    switch (e.type) {
    case R.d4z.GUILD_ANNOUNCEMENT:
    case R.d4z.GUILD_TEXT:
    ...
    if ((0, u.s)(t))
        ...
        c = V(e, L.Z.Messages.NOTIFICATION_MESSAGE_CREATE_GUILD_ACTIVITY_LISTEN, L.Z.Messages.NOTIFICATION_MESSAGE_CREATE_GROUP_DM_ACTIVITY_LISTEN, L.Z.Messages.NOTIFICATION_MESSAGE_CREATE_DM_ACTIVITY_LISTEN).format({ user: T });
    else if (null != A && A.length > 0)
        c = L.Z.Messages.STICKER_NOTIFICATION_BODY.format({ stickerName: A[0].name });
        ...
        c = L.Z.Messages.POLL_SENT_NOTIFICATION.format({ question: t.poll.question.text });
    else if (t.type === R.uaV.POLL_RESULT) {
        let e = null === (_ = t.embeds) || void 0 === _ ? void 0 : null === (r = _[0]) || void 0 === r ? void 0 : null === (s = r.fields) || void 0 === s ? void 0 : s.find(e => 'poll_question_text' === e.name), n = null !== (E = null == e ? void 0 : e.value) && void 0 !== E ? E : '';

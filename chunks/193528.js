...
function N(e) {
  let {
    ...
    colorPickerFooter: m,
    showEyeDropper: h
  } = e, g = i.useRef(null), R = (0, E.useToken)(c.Z.colors.BACKGROUND_PRIMARY).hex(), M = c.Z.colors.BACKGROUND_ACCENT.css, x = (0, T.DP)(a), p = (0, o.Rf)(a), D = p === R ? M : p, L = (0, _.Lq)(x ? S.Ilk.WHITE_500 : S.Ilk.PRIMARY_530), P = (0, d.Z)(O), Z = (0, d.Z)(m), [f, v] = i.useState((0, r.Z)());
  return i.useEffect(() => {
    (P !== O || Z !== m) && v((0, r.Z)())

...
var i = n(836560), s = n(317381), a = n(626135), r = n(585483), l = n(70956), o = n(996106), c = n(631467), d = n(981631);
function u(e, t, n) {
...
class m extends i.EventEmitter {
    routeEvent(e, t, n, i) {
        ...
        case c.Z.HANDSHAKE:
            if (null != e)
                throw new o.Z({ closeCode: d.$VG.CLOSE_UNSUPPORTED }, 'Already connected');
            return this.handleHandshake(t, a, i);
        case c.Z.FRAME:
            if (null == e)
                throw new o.Z({ closeCode: d.$VG.CLOSE_UNSUPPORTED }, 'Not connected');
    ...
    constructor(e, t, i, l) {
        ...
        super(), c = this, u(this, 'validateSocketClient', void 0), u(this, 'logger', void 0), u(this, 'createPostMessageProxySocket', void 0), u(this, 'onFrameHandled', void 0), u(this, 'handshakeFailureTimeoutId', void 0), u(this, 'disconnectSocket', function (e, t) {
            ...
            let s;
            if (e !== t.origin)
                throw new o.Z({ closeCode: d.$VG.INVALID_ORIGIN }, 'Origin has changed');
            try {
            ...
            try {
                a.assert(t, a.object().required().keys({

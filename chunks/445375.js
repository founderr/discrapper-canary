...
function X(e) {
  let {
    ...
    return l.useEffect(() => {
      function n(n) {
        ...
        (0 === s.length || !0 === n) && a((0, g.createState)(s)), t(null !== (l = A.default.getThreadSettings(e.id)) && void 0 !== l ? l : {})
      }
  ...
  }(t, p), I = (0, V.usePrivateThreadMode)(t), {
    nameError: x,
    messageError: N,
    submit: M
  } = function(e) {
...
function Q(e) {
  let {
    ...
    privateThreadMode: s
  } = e, r = (0, V.getIsPrivate)(n, s), o = (0, a.jsx)("div", {
  ...
  return t || s === V.PrivateThreadMode.Disabled ? null : (0, a.jsxs)(u.FormSection, {
    title: o,
...
function q(e) {
  ...
  let {
    ...
    content: o
  }), f = (0, V.getDefaultThreadName)(n, l), h = null != l, m = (0, L.useUID)();

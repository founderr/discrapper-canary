...
class m extends(n = i.PureComponent) {
  render() {
    ...
    return t ? (0, a.jsx)(T.Z, {
      ...
      children: [n > 0 && !i ? (0, a.jsx)(l.FormDivider, {
...
class O extends i.PureComponent {
  renderFooter() {
    ...
    return (0, a.jsxs)(_.Z, {
      ...
      className: C.footer,
      children: [0 === Object.keys(e).length ? (0, a.jsxs)(_.Z.Child, {
  ...
  render() {
    ...
    } = this.props, c = o().values(s).sort((s, t) => s.id === e ? -1 : t.id === e ? 1 : u.default.compare(s.id, t.id)), d = this.state.editingPayment, E = c.findIndex(e => e.id === d), T = c.map((s, o) => (0, a.jsx)(m, {
      locale: t,
      paymentSource: s,
      isDefault: e === s.id,
    ...
    return (0, a.jsxs)("div", {
      ...
      }), T, E !== c.length - 1 ? (0, a.jsx)(l.FormDivider, {
        className: C.__invalid_sourceDivider

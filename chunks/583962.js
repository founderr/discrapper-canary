...
t.default = e => {
  let {
    ...
    id: m
  } = t, _ = (0, S.getGuildTierFromAppliedBoostCount)(u, m), R = (0, S.getNextTier)(_, t.id), O = null == R, M = null != R ? R : _, b = (0, o.useStateFromStores)([N.default], () => {
    var e;
  ...
  return O && (H = (0, S.getShortenedTierName)(M), k = v.default.Messages.PREMIUM_GUILD_SUBSCRIPTIONS_PROGRESS_BAR_COMPLETED_BLURB.format({
    numBoosts: u
  })), (0, l.jsx)(d.Tooltip, {

...
return (0, r.jsxs)(m.ZP, {
  ...
  children: [
    ...
    (0, r.jsx)(m.Dx, {
      children: E.Z.Messages.RESET_PASSWORD_TITLE
    }),
    (0, r.jsxs)(m.gO, {
...
super(e), A(this, 'handleSubmit', async e => {
  ...
  if (null != e && e.preventDefault(), 0 === i.length) {
    this.setState({
      error: E.Z.Messages.PASSWORD_REQUIRED
  ...
  let l = i;
  return (null != s && (l = (0, p.Z)(s)), null == l) ? (d.Z.dispatch({
    type: 'LOGIN_RESET'
  }), Promise.reject()) : h.Z.resetPasswordMFAv2({
    method: e,
    code: t,
    ticket: n,
    password: o,

...
var t = a(735250), l = a(470079), r = a(120356), o = a.n(r), s = a(225857), i = a(290843), c = a(692547), d = a(481060), u = a(881052), f = a(186523), m = a(246364), I = a(915509), C = a(592286), p = a(689938), _ = a(370350);
let E = 'MULTIPLE_CHOICE', x = e => {
        let {
                choice: n,
                index: a,
                onChange: r,
                ...
                hover: (e, n) => {
                    var t;
                    let {index: l} = e, r = null === (t = I.current) || void 0 === t ? void 0 : t.getBoundingClientRect(), o = n.getClientOffset();
                    if (null == r || null == o)
                        return;
                    let s = (r.bottom - r.top) / 2, i = o.y - r.top;
                ...
                (0, t.jsxs)('div', {
                    ...
                    children: [
                        (0, t.jsx)(d.TextInput, {
                            autoFocus: !0,
                            onChange: e => r(e),
                            placeholder: p.Z.Messages.MEMBER_VERIFICATION_MULTIPLE_CHOICE_PLACEHOLDER.format({ index: a + 1 }),
                            value: n
                        }),
                        (0, t.jsx)(d.Button, {

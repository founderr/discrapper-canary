...
e.default = function(i, e, a) {
  var r, n = i.match(/about|over|almost|lessthan/i),
    s = n ? i.replace(n[0], "") : i,
    o = (null == a ? void 0 : a.comparison) !== void 0 && a.comparison > 0,
    d = u[i];
  if (r = "string" == typeof d ? d : 1 === e ? d.one(e, (null == a ? void 0 : a.addSuffix) === !0, s.toLowerCase() + "_one", o) : d.other(e, (null == a ? void 0 : a.addSuffix) === !0, s.toLowerCase() + "_other", o), n && (r = t[n[0].toLowerCase()] + " " + r), null != a && a.addSuffix) return a.comparison && a.comparison > 0 ? "po " + r : "prieš " + r;
  return r
}
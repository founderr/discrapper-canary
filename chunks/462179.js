    ...
    return {
                ...
                ? function (e) {
                      e.stopPropagation(),
                          (0, l.openModalLazy)(async () => {
                              let { default: e } = await Promise.all([t.e('84722'), t.e('63517')]).then(t.bind(t, 296864));
                              return (n) =>
                                  (0, i.jsx)(e, {
                                      ...n,
                                      event: y,
        ...
        onInviteClick: function (e) {
            if ((e.stopPropagation(), null != n)) {
                ...
                (0, l.openModalLazy)(async () => {
                    let { default: e } = await Promise.all([t.e('7654'), t.e('1187'), t.e('32077')]).then(t.bind(t, 560114));
                    return (t) =>
                        (0, i.jsx)(e, {
                            ...t,
                            guild: n,

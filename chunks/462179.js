    ...
    return {
        ...
        onContextMenu: function (e) {
            e.stopPropagation(),
                null != n &&
                    (0, r.jW)(e, async () => {
                        let { default: e } = await Promise.all([i.e('15450'), i.e('37133')]).then(i.bind(i, 215269));
                        return (i) =>
                            (0, l.jsx)(e, {
                                guildEventId: y,
                                recurrenceId: G,
                ...
                ? function (e) {
                      e.stopPropagation(),
                          (0, a.openModalLazy)(async () => {
                              let { default: e } = await Promise.all([i.e('84722'), i.e('66586')]).then(i.bind(i, 296864));
                              return (n) =>
                                  (0, l.jsx)(e, {
                                      ...n,
                                      event: k,
        ...
        onInviteClick: function (e) {
            if ((e.stopPropagation(), null != n)) {
                ...
                (0, a.openModalLazy)(async () => {
                    let { default: e } = await Promise.all([i.e('7654'), i.e('1187'), i.e('90761')]).then(i.bind(i, 560114));
                    return (i) =>
                        (0, l.jsx)(e, {
                            ...i,
                            guild: n,

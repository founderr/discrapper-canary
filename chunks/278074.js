...
let A = d(
        ...
        Object.assign(d(e), {
            ...
            endsWith: (t) =>
                N(
                    h(
                        e,
                        I((e) => S(e) && e.endsWith(t))
                    )
                ),
            minLength: (t) => {
                let n;
                return N(h(e, ((n = t), I((e) => S(e) && e.length >= n))));
            },
            maxLength: (t) => {
                let n;
                return N(h(e, ((n = t), I((e) => S(e) && e.length <= n))));
    ...
    O = N(I(S)),
    R = (e, t) => I((n) => T(n) && e <= n && t >= n),
    v = (e) => I((t) => T(t) && t < e),
    C = (e) => I((t) => T(t) && t > e),
    L = (e) => I((t) => T(t) && t <= e),
    y = (e) => I((t) => T(t) && t >= e),
    D = () => I((e) => T(e) && Number.isInteger(e)),
    b = () => I((e) => T(e) && Number.isFinite(e)),
    M = () => I((e) => T(e) && e > 0),
    P = () => I((e) => T(e) && e < 0),
    U = (e) =>
        Object.assign(d(e), {
            between: (t, n) => U(h(e, R(t, n))),
            lt: (t) => U(h(e, v(t))),
            gt: (t) => U(h(e, C(t))),
            lte: (t) => U(h(e, L(t))),
            gte: (t) => U(h(e, y(t))),

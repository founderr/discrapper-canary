...
let r = Symbol.for('@ts-pattern/matcher'), i = Symbol.for('@ts-pattern/isVariadic'), a = '@ts-pattern/anonymous-select-key', o = e => !!(e && 'object' == typeof e), s = e => e && !!e[r], l = (e, t, n) => {
        if (s(e)) {
            let {
                matched: i,
                selections: a
            ...
            if (Array.isArray(e)) {
                ...
                if (o.length) {
                    ...
                    if (t.length < r.length + a.length)
                        return !1;
                    let e = t.slice(0, r.length), i = 0 === a.length ? [] : t.slice(-a.length), s = t.slice(r.length, 0 === a.length ? 1 / 0 : -a.length);
...
function I(...e) {
    let t = 'string' == typeof e[0] ? e[0] : void 0, n = 2 === e.length ? e[1] : 'string' == typeof e[0] ? void 0 : e[0];
    return d({
        [r]: () => ({
            match: e => {
                let r = { [null != t ? t : a]: e };
...
let A = d(m(function (e) {
    ...
    }), v = N(m(g)), O = (e, t) => m(n => T(n) && e <= n && t >= n), R = e => m(t => T(t) && t < e), C = e => m(t => T(t) && t > e), y = e => m(t => T(t) && t <= e), D = e => m(t => T(t) && t >= e), L = () => m(e => T(e) && Number.isInteger(e)), b = () => m(e => T(e) && Number.isFinite(e)), M = () => m(e => T(e) && e > 0), P = () => m(e => T(e) && e < 0), U = e => Object.assign(d(e), {
        ...
        positive: () => U(h(e, M())),
        negative: () => U(h(e, P()))
    }), w = U(m(T)), x = (e, t) => m(n => S(n) && e <= n && t >= n), G = e => m(t => S(t) && t < e), k = e => m(t => S(t) && t > e), B = e => m(t => S(t) && t <= e), F = e => m(t => S(t) && t >= e), V = () => m(e => S(e) && e > 0), H = () => m(e => S(e) && e < 0), Z = e => Object.assign(d(e), {

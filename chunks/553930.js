...
function E(e) {
  ...
  if (p(E, e => {
      ...
      let i = null !== (a = m.getState().lastSpawned[e.id]) && void 0 !== a ? a : 0,
        r = Date.now();
      if (!(i + 100 > r) && e.state !== o.EmojiHoseState.STOP)(.8 >= Math.random() || i + 300 < r) && m.setState(a => {
        var i, r, u;
    ...
    })(g, N, e)), E.lastUpdatedAt + f.EMOJI_HOSE_PING_DELAY < Date.now() && (0, r.stopRenderedEmojiHose)(v, E), E.state === o.EmojiHoseState.STOP && (a = E, !(Object.keys(null !== (i = m.getState().particles[a.id]) && void 0 !== i ? i : {}).length > 0))) x.push(E);
  g.restore()
}
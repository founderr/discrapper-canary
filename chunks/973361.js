t.parse = function (e, t) {
    ...
    var r = {}, a = e.split(i), o = (t || {}).decode || n;
    return a.forEach(function (e) {
        var t = e.indexOf('=');
        if (!(t < 0)) {
            var n = e.substr(0, t).trim(), i = e.substr(++t, e.length).trim();
...
var n = decodeURIComponent, r = encodeURIComponent, i = /; */, a = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/;

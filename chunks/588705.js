...
t.default = e => {
  ...
  if (null != x) P = null == U ? I.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN : I.default.Messages.AUTH_MESSAGE_INVITED_BY.format({
    ...
    username: m.default.getFormattedName(U)
  }) : I.default.Messages.AUTH_MESSAGE_INVITED_TO_PLAY), D && null == b && (n = (0, s.jsx)(g.GuildIcon, {
    className: S.icon,
    guild: x,
  ...
  return (0, s.jsxs)("div", {
    ...
    }), h, null != b || G || (null == _ ? void 0 : null === (t = _.guild) || void 0 === t ? void 0 : t.id) === T.INVITE_ROUTING_HUB_GUILD_ID ? null : (0, s.jsx)(g.ActivityCount, {

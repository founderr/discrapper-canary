...
var t = n(735250), a = n(470079), l = n(442837), r = n(481060), i = n(388905), u = n(726745), o = n(973616), c = n(131704), m = n(601964), d = n(598077), I = n(594174), N = n(366695), _ = n(940627), p = n(806519), E = n(51144), x = n(981631), T = n(888592), g = n(245335), j = n(689938), A = n(701607);
...
s.Z = e => {
    ...
    if (null == p)
        return null;
    let D = null != p.guild ? new m.ZP(p.guild) : null, L = null != p.channel ? (0, c.jD)(p.channel) : null, Z = null != p.target_application ? new o.Z(p.target_application) : null, C = S || null == p.inviter ? null : new d.Z(p.inviter), b = !(null != p.approximate_member_count && p.approximate_member_count > 100 || null != D && D.hasFeature(x.oNc.COMMUNITY)) && null != C, V = null, B = !1;
    if (null != D)
        V = null == C ? j.Z.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN : j.Z.Messages.AUTH_MESSAGE_INVITED_BY.format({ username: E.ZP.getFormattedName(C) }), p.target_type === g.Iq.STREAM && null != p.target_user && (V = j.Z.Messages.AUTH_MESSAGE_INVITED_TO_STREAM.format({ username: E.ZP.getFormattedName(p.target_user) })), p.target_type === g.Iq.EMBEDDED_APPLICATION && null != p.target_application && (V = null != C ? j.Z.Messages.AUTH_MESSAGE_INVITED_TO_PLAY_USERNAME.format({ username: E.ZP.getFormattedName(C) }) : j.Z.Messages.AUTH_MESSAGE_INVITED_TO_PLAY), b && null == Z && (n = (0, t.jsx)(i.Vj, {
            className: A.icon,
            guild: D,
        ...
        null != L.name && '' !== L.name ? (V = j.Z.Messages.AUTH_MESSAGE_INVITED_BY.format({ username: e }), a = L.name, null != L.icon && (n = (0, t.jsx)(i.MC, {
            channel: L,
            size: r.AvatarSizes.SIZE_32
        }))) : (V = j.Z.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN_GROUP_DM, a = e);
    } else if (null != C) {
        let e = E.ZP.getFormattedName(C, !0);
        a = j.Z.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_CHAT.format({ username: e }), B = !0, N = null != f ? null : (0, t.jsx)(i.DK, {

...
t.default = e => {
  let {
    ...
    interests: n,
    error: s
  } = e, [h, p] = r.useState(""), E = r.useMemo(() => Array.from(n), [n]), T = r.useMemo(() => E.filter(m), [E]), C = r.useMemo(() => [...d.SUGGESTED_TRAITS_SET, ...T], [T]), x = r.useMemo(() => E.filter(e => !d.ALL_TRAITS_SET.has(e) && !d.LANGUAGES_SET.has(e)), [E]), _ = e => {
    let a = new Set(n);
    a.delete(e), t({
      interests: a
    })

n(47120);
var r, i, a = n(626135), o = n(591759), s = n(777754), l = n(754688), u = n(981631);
...
t.Z = {
    ...
    trackLinkClicked: function (e, t) {
        ...
        if (null == e && null == t)
            return;
        let i = o.Z.isDiscordUrl(e, !0) || null != t;
        a.default.track(u.rMx.LINK_CLICKED, {
            is_discord_link: i,
            discord_link_type: i ? (n = e, null == (r = t) && null == n ? 'Unknown' : null == r ? function (e) {
                for (let t of c) {
                    let n = t(e);
                    if (null != n)
                        return n;

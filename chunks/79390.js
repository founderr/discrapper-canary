...
if (1 === e.length)
  return n > 0 ? g.Z.Messages.POLL_VOTES_TOOLTIP_1_N.format({
    a: e[0],
    n: n.toLocaleString()
  }) : e[0];
if (2 === e.length)
  return n > 0 ? g.Z.Messages.POLL_VOTES_TOOLTIP_2_N.format({
    a: e[0],
    b: e[1],
    n: n.toLocaleString()
...
if (3 !== e.length)
  return g.Z.Messages.POLL_VOTES_TOOLTIP_N.format({
    n: n.toLocaleString()
  });
else
  return n > 0 ? g.Z.Messages.POLL_VOTES_TOOLTIP_3_N.format({
    a: e[0],
    b: e[1],
    c: e[2],
    n: n.toLocaleString()

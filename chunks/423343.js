...
var r = n(392711), i = n.n(r), a = n(379649), o = n(126168), s = n(981631);
function l(e, t, n) {
...
class u {
    ...
    getVoiceConnectionSuccessStats() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : (0, a.zO)(), t = this.getStateDurations(e), n = e => i().sumBy(t, t => t.state === e ? t.durationMs : 0);
        return {

...
function w(e) {
  ...
  let {
    ...
    background: "\n    linear-gradient(\n      150deg,\n      transparent 68%,\n      ".concat((0, g.aD)(n.config.colors.primary, .2), " 85%,\n      transparent 100%\n    ),\n    linear-gradient(\n      150deg,\n      transparent 13%,\n      ").concat((0, g.aD)(n.config.colors.primary, .6), " 44%,\n      transparent 76%\n    ),\n    ").concat(l ? "var(--black)" : "var(--white)", "\n    ")
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsxs)("div", {
      ...
      children: [C && (0, s.jsx)(c.CheckmarkSmallIcon, {
        size: "xs",
...
function Z(e) {
  ...
  let {
    ...
    isClaimingRewardCode: h.Z.isClaimingRewardCode(r.id) || h.Z.isClaimingReward(r.id)
  })), G = (0, I.oo)({
    quest: r
  }), [F, H] = o.useState(!1), z = v && (null === (t = r.userStatus) || void 0 === t ? void 0 : t.claimedAt) == null && null == Q, X = o.useCallback((e, t, n) => {
    H(!1), G || 2 === r.config.configVersion ? (0, R.QB)(e, t, n).catch(() => H(!0)) : (0, R.Tj)(e, t, n).catch(() => H(!0))
  }, [G, r.config.configVersion]), K = o.useCallback(e => {
    H(!1), (0, R.pf)(e).catch(() => H(!0))
  }, []);
  o.useEffect(() => {
    var e, t;
    if (null == Q && !F && !k && !W && !z)(null === (e = r.userStatus) || void 0 === e ? void 0 : e.claimedAt) == null && null != j ? X(r.id, j, d) : (null === (t = r.userStatus) || void 0 === t ? void 0 : t.claimedAt) != null && K(r.id)
  }, [r, Q, k, W, F, z, j, d, X, K]);
  let V = null;
  m && null != Q ? V = A.Z.Messages.QUESTS_REWARD_CODE_HEADER : null != Q ? V = A.Z.Messages.QUESTS_REWARD_CODE_CONGRATS : z && (V = A.Z.Messages.QUESTS_REWARD_CODE_PLATFORM_SELECTION_HEADER);
  let Y = null != V ? (0, s.jsx)(c.Heading, {
    ...
    $ = function(e) {
      ...
      if (i) return (0, s.jsx)(c.Text, {
        variant: "text-sm/normal",
        color: "text-normal",
        className: D.bodyCopy,
        children: u ? A.Z.Messages.QUESTS_REWARD_CODE_SELECT_PLATFORM_INSTRUCTIONS_TIERED.format() : A.Z.Messages.QUESTS_REWARD_CODE_SELECT_PLATFORM_INSTRUCTIONS.format({
  ...
  z && (ee = (0, s.jsxs)(c.FormItem, {
    ...
    }), F ? (0, s.jsx)(c.InputError, {
      error: A.Z.Messages.QUESTS_REWARD_CODE_ERROR
    }) : null]
  }));
  let et = null == Q && (W || k),
    en = et && !z ? (0, s.jsx)(c.Spinner, {}) : null,
    es = null;
  null != Q ? es = (0, s.jsx)(c.FormItem, {
    title: A.Z.Messages.QUESTS_REWARD_CODE_HEADER,
    children: (0, s.jsx)(p.Z, {
      value: P ? A.Z.Messages.QUEST_REWARD_CODE_HIDDEN : Q.code,
      delay: 1e3,
      buttonColor: c.Button.Colors.BRAND,
      onCopy: () => {
        P && (0, T.JG)(Q.code), (0, x._3)({
          questId: r.id,
          questContent: d,
          questContentPosition: u,
  ...
  let eo = () => {
      ...
      z && null != j ? (X(r.id, j, d), (0, x._3)({
        ...
        questContentPosition: u
      })) : F ? (null === (e = r.userStatus) || void 0 === e ? void 0 : e.claimedAt) != null ? K(r.id) : null != j && (X(r.id, j, d), (0, x._3)({
        questId: r.id,
        questContent: d,
        questContentCTA: x.jZ.GET_REWARD_CODE,
        questContentPosition: u
    ...
    ea = z && k,
    er = !ea && (z && null == j || et),
    el = A.Z.Messages.QUESTS_REWARD_CODE_DONE;
  z ? el = A.Z.Messages.QUESTS_REWARD_CODE_GET_CODE : !z && F && (el = A.Z.Messages.QUESTS_REWARD_CODE_TRY_AGAIN);
  let ei = !U && null != Q && !m && !F,
    ed = (0, s.jsx)(c.Button, {
      onClick: () => eo(),
      submitting: ea,

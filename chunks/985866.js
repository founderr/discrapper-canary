...
var r = n(735250), s = n(470079), a = n(120356), o = n.n(a), l = n(887024), i = n(442837), d = n(692547), c = n(780384), u = n(481060), p = n(484614), m = n(410030), C = n(607070), _ = n(530618), E = n(454585), S = n(246946), R = n(572004), g = n(302221), T = n(617136), f = n(272008), h = n(569984), A = n(497505), b = n(918701), D = n(566078), x = n(617889), I = n(644646), v = n(78826), O = n(46140), w = n(675654), y = n(689938), j = n(754301);
function N(e) {
    var t;
    let {
            quest: n,
        ...
        }, p = (0, x.B)(n, !1), C = (null === (t = n.userStatus) || void 0 === t ? void 0 : t.claimedAt) != null || null != s, {
            header: _,
            subHeader: E
        } = function (e) {
            var t, n, r, s;
        ...
        children: [
            (0, r.jsxs)('div', {
                ...
                children: [
                    ...
                    S && (0, r.jsx)(u.ImageWarningIcon, { className: j.rewardTileAssetStatusIcon }),
                    (0, r.jsx)(I.Z, {
                        className: o()(j.rewardTileAsset, { [j.rewardTileAssetLoading]: R || S }),
                        quest: n,
...
function L(e) {
    ...
    let {
        ...
        }, []), g = D.r.build(o.config).rewardPlatforms, x = g.length > 1, [I, M] = s.useState(x ? null : g[0]), L = s.useRef(new l.qA()), B = s.useRef(null), [Z, W] = s.useState(null), U = (0, i.e7)([C.Z], () => C.Z.useReducedMotion), k = (0, i.e7)([S.Z], () => S.Z.hidePersonalInformation), {
            rewardCode: P,
        ...
        })), q = (0, b.oo)({ quest: o }), [H, G] = s.useState(!1), z = x && (null === (t = o.userStatus) || void 0 === t ? void 0 : t.claimedAt) == null && null == P, V = s.useCallback((e, t, n) => {
    ...
    s.useEffect(() => {
        var e, t;
        if (null == P && !H && !F && !Q && !z)
            (null === (e = o.userStatus) || void 0 === e ? void 0 : e.claimedAt) == null && null != I ? V(o.id, I, d) : (null === (t = o.userStatus) || void 0 === t ? void 0 : t.claimedAt) != null && $(o.id);
    }, [
        o,
        P,
        F,
    ...
    let Y = null != X ? (0, r.jsx)(u.Heading, {
            ...
            if (i)
                return (0, r.jsx)(u.Text, {
                    ...
                    children: c ? y.Z.Messages.QUESTS_REWARD_CODE_SELECT_PLATFORM_INSTRUCTIONS_TIERED.format() : y.Z.Messages.QUESTS_REWARD_CODE_SELECT_PLATFORM_INSTRUCTIONS.format({ rewardName: p.defaultReward.messages.name })
                });
            let m = null != l ? l : null == d ? void 0 : d.platform, C = c ? (0, b.o9)({
                    quest: o,
                    idx: null !== (s = null == d ? void 0 : d.tier) && void 0 !== s ? s : null === (t = o.userStatus) || void 0 === t ? void 0 : t.claimedTier
                }) : null, _ = null !== (a = null == C ? void 0 : null === (n = C.messages) || void 0 === n ? void 0 : n.redemptionInstructionsByPlatform) && void 0 !== a ? a : p.defaultRewardRedemptionInstructionsByPlatform, S = null != m ? _[m] : void 0;
            return null != d && null != S ? (0, r.jsx)(u.Text, {
                variant: 'text-sm/normal',
                color: 'text-normal',
                className: j.bodyCopy,
                children: E.Z.parse(S, !1, { allowLinks: !0 })
            }) : null;
        }({
            quest: o,
            selectedPlatform: I,
    ...
    z && (ee = (0, r.jsxs)(u.FormItem, {
        ...
        children: [
                ...
                renderOptionLabel: e => {
                    let t = function (e) {
                        ...
                        case A.y$.CROSS_PLATFORM:
                            return (0, r.jsx)(u.ScienceIcon, { className: j.platformSelectionOptionIcon });
                        case A.y$.PC:
                            return (0, r.jsx)(u.ScreenIcon, { className: j.platformSelectionOptionIcon });
                        case A.y$.PLAYSTATION:
                            return (0, r.jsx)(u.PlaystationIcon, { className: j.platformSelectionOptionIcon });
                        case A.y$.SWITCH:
                            return (0, r.jsx)(u.NintendoSwitchNeutralIcon, { className: j.platformSelectionOptionIcon });
                        case A.y$.XBOX:
                            return (0, r.jsx)(u.XboxIcon, { className: j.platformSelectionOptionIcon });
                        }
                    }(e.value);
                    return (0, r.jsxs)('div', {
            ...
            H ? (0, r.jsx)(u.InputError, { error: y.Z.Messages.QUESTS_REWARD_CODE_ERROR }) : null
        ]
    }));
    let et = null == P && (Q || F), en = et && !z ? (0, r.jsx)(u.Spinner, {}) : null, er = null;
    ...
    let es = () => {
            var e;
            z && null != I ? (V(o.id, I, d), (0, T._3)({
                questId: o.id,
                questContent: d,
                questContentCTA: T.jZ.GET_REWARD_CODE,
                questContentPosition: c
            })) : H ? (null === (e = o.userStatus) || void 0 === e ? void 0 : e.claimedAt) != null ? $(o.id) : null != I && (V(o.id, I, d), (0, T._3)({
                questId: o.id,
                questContent: d,
                questContentCTA: T.jZ.GET_REWARD_CODE,
                questContentPosition: c
            })) : a();
        }, ea = z && F, eo = !ea && (z && null == I || et), el = y.Z.Messages.QUESTS_REWARD_CODE_DONE;
    z ? el = y.Z.Messages.QUESTS_REWARD_CODE_GET_CODE : !z && H && (el = y.Z.Messages.QUESTS_REWARD_CODE_TRY_AGAIN);
    let ei = !U && null != P && !m && !H, ed = (0, r.jsx)(u.Button, {
            onClick: () => es(),
            submitting: ea,
            disabled: eo,
            children: el
            ...
            (0, r.jsx)('div', {
                ...
                children: (0, r.jsxs)(u.ModalRoot, {
                    ...
                    children: [
                        ...
                        (0, r.jsx)(u.ModalFooter, { children: ed })
                    ]
                })
            }),
            ei && (0, r.jsx)(_.Z, {

...
function T(e) {
  let {
    ...
    if (null != t) return E.Z.Messages.MEMBER_SAFETY_DATE_OPTION_AFTER_ONLY.format({
      date: t
    });
    if (null != l) return E.Z.Messages.MEMBER_SAFETY_DATE_OPTION_BEFORE_ONLY.format({
      date: l
    });
    return null
  }(), N = s.useCallback(() => {
      ...
      children: H ? (0, o.jsxs)(o.Fragment, {
        children: [(0, o.jsx)(u.MenuItem, {
          ...
          render: e => (0, o.jsxs)("span", {
            ...
            children: [(0, o.jsx)(u.ChevronSmallLeftIcon, {
              size: "custom",
              color: "currentColor",
              width: 16,
              height: 16
        ...
        }), (0, o.jsx)(u.MenuSeparator, {}), (0, o.jsx)(u.MenuItem, {

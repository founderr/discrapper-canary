...
class D extends r.PureComponent {
    componentDidMount() {
        (0, _.e)('guildTemplate'), !R.KO && N.Z.launch('discord://' + A.Z5c.GUILD_TEMPLATE(this.props.code), () => void 0);
    }
    ...
    renderAuthenticatedOrDownload() {
        ...
        return (o()(null != e, 'guild template must not be null'), e.state === j.Rj.RESOLVING)
            ? (0, i.jsx)(u.ZP, {
                  className: P.authBox,
            ...
            case j.Rj.RESOLVED:
                ...
                if (this.props.login)
                    ...
                    return (0, i.jsx)(S.Z, {
                        ...
                        location: s,
                        onRegister: () => {
                            (0, x.c)(T.M5.ORGANIC_REGISTERED_GUILD_TEMPLATE), E.Z.flowStart(Z.MK.ORGANIC_GUILD_TEMPLATES, Z.EW.NUF_STARTED);
                        }
                    });
            case j.Rj.EXPIRED:

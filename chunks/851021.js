...
class k extends(s = l.PureComponent) {
  ...
  constructor(...e) {
    super(...e), F(this, "state", {
      ...
      return null == n ? null : (0, a.jsx)(h.default, {
        ...t,
...
F(k, "defaultProps", {
  isPreview: !1
}), t.default = i.default.connectStores([N.default, g.default, O.default, R.default, m.default, L.default, A.default, x.default, v.default, M.default], e => {
  let {
    activity: t,
    ...
    id: r
  } = null != s ? s : {}, o = null != t && null != t.party && t.party.id === a ? g.default.getParty(t.party.id) : null, u = null != r ? O.default.getApplicationActivity(r) : O.default.findActivity(e => e.type === b.ActivityTypes.LISTENING), d = !1;
  ...
  let c = Array.from(null != o ? o : []).map(e => {
    ...
    f = null != t && N.default.canPlay(t),
    E = N.default.getSyncingWith(),

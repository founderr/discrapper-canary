var i = n(735250), s = n(470079), a = n(120356), r = n.n(a), l = n(442837), o = n(481060), c = n(905405), d = n(255269), u = n(937889), _ = n(695346), E = n(496675), h = n(699516), I = n(68588), m = n(512665), g = n(868807), p = n(981631), T = n(768760), S = n(689938), C = n(608524), N = n(622322);
let f = s.memo(function (e) {
    let {channel: t} = e, {
            loaded: n,
            error: a,
            message: f
        } = (0, g.a)(t), A = (0, c.p)(), Z = (0, l.e7)([h.Z], () => null != f && h.Z.isBlockedForMessage(f), [f]), L = (0, l.e7)([E.Z], () => E.Z.can(p.Plq.MANAGE_MESSAGES, t)), v = _.cC.useSetting(), {content: O} = s.useMemo(() => (null == f ? void 0 : f.content) != null && '' !== f.content ? (0, u.ZP)(f, {
            formatInline: !0,

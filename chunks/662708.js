t.r(s), t(47120);
var a = t(735250), o = t(470079), l = t(481060), r = t(153867), n = t(663993), i = t(771845), h = t(981631), d = t(689938), c = t(792137);
function m(e, s, t) {
    ...
    constructor(...e) {
        ...
        super(...e), m(this, 'state', {
            ...
            let {folderId: s} = this.props, {
                    name: t,
                    color: a
                } = this.state, o = i.ZP.getGuildFolders().map(e => e.folderId === s ? {
                    ...e,
                    folderName: t,
                    folderColor: a
                } : e);

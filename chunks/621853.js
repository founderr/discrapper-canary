...
function D(e) {
  ...
  if (h[e.user.id] = {
    ...
    null != f[e.user.id] ? f[e.user.id][e.guild_member_profile.guild_id] = t : f[e.user.id] = {
...
class x extends c.Z {
  ...
  getGuildMemberProfile(e, t) {
    var n;
    return null == t ? null : null === (n = f[e]) || void 0 === n ? void 0 : n[t]
  }
  getMutualFriends(e) {
    return S[e]
  }

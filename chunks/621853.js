n(47120), n(789020);
var r = n(392711), i = n.n(r), a = n(726542), o = n(706454), s = n(598077), l = n(314897), u = n(430824), c = n(158776), d = n(412788), _ = n(771845);
function E(e, t, n) {
...
let f = new Set(), h = new Set(), p = {}, m = {}, I = {}, T = {}, g = {}, S = !1;
function A() {
...
function D(e) {
    ...
    let y = null !== (d = e.premium_since) && void 0 !== d ? d : null, D = e.application;
    if (p[e.user.id] = {
            userId: e.user.id,
        ...
        null != m[e.user.id] ? m[e.user.id][e.guild_member_profile.guild_id] = t : m[e.user.id] = { [e.guild_member_profile.guild_id]: t };
    }
}
function L(e) {
    let {userId: t} = e;

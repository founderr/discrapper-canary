...
var r, i, a, o, s, l, u = n(729594), c = n(421474);
n(865427);
var d = n(264229);
n(413605);
var _ = n(701190), E = n(226951), f = n(591759), h = n(960904), p = n(981631);
let m = /^\/([a-zA-Z0-9-]+)$/, I = /^\/channels\/([0-9]+|@me)\/([0-9]+)$/, T = /^\/(invite|template)\/([a-zA-Z0-9-]+)\/?$/, g = RegExp('^/events/(\\d+)(?:/)(\\d+)?((?:/)(\\d+))?'), S = /^\/application-directory\/([0-9-]+)\/?$/, A = /^\/application-directory\/([0-9-]+)\/store\/?([0-9-]+)?\/?$/, N = /^\/activities\/([0-9-]+)\/?$/, v = /^\/channels\/([0-9]+)\/shop\/([0-9]+)$/, O = /^\/channels\/([0-9]+)\/shop$/, R = /^\/quests\/([0-9-]+)\/?$/, C = /dev:\/\/[\w-.~:\/?#\[\]@!$&'()*+,;=%]+/i, y = G(window.GLOBAL_ENV.INVITE_HOST), D = G(window.GLOBAL_ENV.GUILD_TEMPLATE_HOST), L = G(null !== (r = window.GLOBAL_ENV.WEBAPP_ENDPOINT) && void 0 !== r ? r : '//canary.'.concat(p.$R1)), b = G('//canary.'.concat(p.$R1)), M = G('//ptb.'.concat(p.$R1)), P = G('discordapp.com'), U = G('discord.com'), w = [
    ...
    ].filter(Boolean), x = RegExp('((https?://[^ ]*)|^|[^/][^/.])('.concat(w.join('|'), ')'), 'g');
function G(e) {
    if (null == e)
        return {
            host: null,
...
function k(e, t) {
    ...
    if ((null === (n = t.host) || void 0 === n ? void 0 : n.replace(/^www[.]/i, '')) !== e.host)
        return null;
    let a = null !== (r = t.pathname) && void 0 !== r ? r : '', o = null !== (i = e.pathPrefix) && void 0 !== i ? i : '';
    if (!a.startsWith(o))
        return null;
...
function F(e) {
    ...
    let o = k(y, a), s = k(D, a), l = null !== (i = null !== (r = null !== (n = null !== (t = k(L, a)) && void 0 !== t ? t : k(b, a)) && void 0 !== n ? n : k(M, a)) && void 0 !== r ? r : k(P, a)) && void 0 !== i ? i : k(U, a);
    return {
        url: a,
...
function V(e) {
    if (null == e)
        return [];
    let t = new Set(), n = [], r = (e = e.replace(x, (e, t, n, r) => null == n ? ''.concat(t, 'http://').concat(r) : e)).match(f.Z.URL_REGEX), i = e.match(C);
...
function H(e) {
    var t, n;
    let r = F(e), i = null == r ? void 0 : null === (t = r.primaryHostRemainingPath) || void 0 === t ? void 0 : t.match(R);

...
var n = s(735250), l = s(470079), a = s(120356), i = s.n(a), r = s(313361), o = s(683860), d = s(442837), c = s(692547), u = s(780384), h = s(481060), m = s(787014), g = s(771340), E = s(410575), T = s(852860), p = s(129865), N = s(902840), _ = s(933557), S = s(541716), x = s(752305), f = s(893718), C = s(907040), I = s(633302), M = s(109434), R = s(162389), Z = s(946458), v = s(968437), O = s(665906), A = s(456077), L = s(747212), b = s(210887), j = s(131704), D = s(314897), y = s(388610), w = s(430824), P = s(496675), F = s(903223), B = s(594174), U = s(285952), H = s(153124), G = s(934415), k = s(70956), V = s(630388), W = s(63063), z = s(129724), Y = s(296146), Q = s(564735), q = s(981631), X = s(176505), K = s(185923), $ = s(710352), J = s(124368), ee = s(689938), et = s(260790), es = s(549856);
function en(e, t, s) {
...
let el = (0, H.hQ)(), ea = (0, H.hQ)(), ei = (0, H.hQ)(), er = (0, H.hQ)(), eo = (0, H.hQ)(), ed = (0, H.hQ)(), ec = (0, H.hQ)(), eu = (0, H.hQ)(), eh = (0, H.hQ)(), em = (0, H.hQ)(), eg = (0, H.hQ)(), eE = (0, j.kt)({
        id: '1',
        type: q.d4z.DM
    }), eT = 'AUTOMATIC_RTC_REGION', ep = d.ZP.connectStores([y.Z], () => {
        let {
            channel: e,
            submitting: t
        } = y.Z.getProps();
...
class e_ extends l.PureComponent {
                ...
                children: [
                    (0, n.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, n.jsx)(Z.Z, { reactionEmoji: e.defaultReactionEmoji })
                        ]
                    }),
                    (0, n.jsx)(h.FormDivider, { className: i()(es.marginTop40, es.marginBottom40) })
                ]
    ...
    renderVoiceBitrate(e, t) {
        ...
        if (!this.showVoiceSettings())
            return null;
        let l = (0, G.g7)(t, e), a = this.getError('bitrate');
        return (0, n.jsxs)(U.Z, {
    ...
    renderUserLimit(e) {
        ...
        if (!this.showVoiceSettings())
            return null;
        let s = this.getError('user_limit'), l = e.isGuildStageVoice() ? q.xGv : q.$pe;
        return (0, n.jsxs)(U.Z, {
            direction: U.Z.Direction.VERTICAL,
            className: es.marginBottom40,
            children: [
    ...
    render() {
        ...
        return null == e || null == t || null == s ? null : (0, n.jsxs)(h.FormSection, {
            ...
            children: [
                ...
                this.showVoiceSettings() ? (0, n.jsx)(h.FormDivider, { className: i()(es.marginTop40, es.marginBottom40) }) : null,
    ...
    constructor(e) {
        ...
        super(e), en(this, 'renderEmojiPicker', e => {
            let {closePopout: t} = e, {channel: s} = this.props;
            return (0, n.jsx)(C.Z, {
            ...
            let {channel: t} = this.props;
            if (null != t)
                t.isThread() ? e = (0, A.Z)(e, !1) : q.TPd.LIMITED_CHANNEL_NAME.has(t.type) && (e = (0, G.Nj)(e)), (0, m.pW)({ name: e });
            ...
            (0, m.pW)({ topic: I.ZP.translateInlineEmojiToSurrogates(e) });
            ...
            (0, m.pW)({ template: I.ZP.translateInlineEmojiToSurrogates(e) });

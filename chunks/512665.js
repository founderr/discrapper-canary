...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(913527), l = n.n(s), u = n(481060), c = n(100527), d = n(906732), _ = n(978003), E = n(39154), f = n(453687), h = n(123145), p = n(223021), m = n(79390), I = n(869765), T = n(403132), g = n(378233), S = n(768581), A = n(55935), N = n(823379), v = n(113039), O = n(768760), R = n(981631), C = n(689938), y = n(250050);
function D(e) {
    let {
        width: t = 12,
        height: n = 8,
...
function b(e, t, n, i, a) {
    ...
    let d = (0, E.Z)(e), {
            ...
            leadingIconClass: h,
            iconSize: p
        } = a, I = null == t || '' === t || Array.isArray(t) && 0 === t.length, T = (0, g.cv)(d).length > 0, S = null != d.interaction, A = d.hasFlag(R.iLy.IS_VOICE_MESSAGE), N = d.isPoll(), O = d.type === R.uaV.POLL_RESULT;
    if ((0, _.Z)(e) && (c = (0, r.jsx)(u.ChatArrowRightIcon, {
        ...
        if (N) {
            ...
            O ? o = (0, m.N4)(d) : T ? o = C.Z.Messages.REPLY_QUOTE_STICKER : S ? o = C.Z.Messages.REPLY_QUOTE_COMMAND : A ? o = C.Z.Messages.REPLY_QUOTE_VOICE_MESSAGE : (o = C.Z.Messages.REPLY_QUOTE_NO_TEXT_CONTENT, l = (0, r.jsx)(u.ImageIcon, {
                size: 'custom',
                color: 'currentColor',
                className: f,
                width: p,
    ...
    return T ? l = (0, r.jsx)(u.StickerSmallIcon, {
        size: 'custom',
        color: 'currentColor',
        className: f,
        width: p,
...
function M(e) {
    ...
    let {
            ...
            referencedMessage: _,
            renderPopout: E
        } = e, m = i.useMemo(() => null != E && _.state === I.Y.LOADED ? e => E(e, _.message) : void 0, [
            _,
            E
        ]), g = function (e, t) {
            let {
                ...
                } = e, {analyticsLocations: p} = (0, d.ZP)(c.Z.AVATAR);
            if (a || n.state !== I.Y.LOADED || s)
                return (0, r.jsx)('div', {
                    className: y.replyBadge,
                    children: (0, r.jsx)(D, { className: y.replyIcon })
                });
            if (n.message.type === R.uaV.USER_JOIN || n.message.type === R.uaV.ROLE_SUBSCRIPTION_PURCHASE || n.message.type === R.uaV.GUILD_DEADCHAT_REVIVE_PROMPT || n.message.type === R.uaV.GUILD_GAMING_STATS_PROMPT)
                return (0, r.jsx)(L, { className: y.userJoinSystemMessageIcon });
            ...
            let m = () => {
                ...
                return e = n.message.author, t = l, a = i.guild_id, s = E, u = f, (0, r.jsx)('img', {
                    alt: '',
                    src: (null == t ? void 0 : t.guildMemberAvatar) != null && null != a ? (0, S.JM)({
                        guildId: a,
                        userId: e.id,
            ...
            let {
                ...
                } = e, c = (null == a ? void 0 : a.state) === I.Y.LOADED ? a.message : void 0;
            return null == c || c.type === R.uaV.USER_JOIN || c.type === R.uaV.ROLE_SUBSCRIPTION_PURCHASE || c.type === R.uaV.GUILD_APPLICATION_PREMIUM_SUBSCRIPTION || c.type === R.uaV.GUILD_DEADCHAT_REVIVE_PROMPT || c.type === R.uaV.GUILD_GAMING_STATS_PROMPT || c.type === R.uaV.POLL_RESULT ? null : (0, r.jsx)(h.Z, {
                message: c,
                channel: i,
                compact: !0,
            ...
            let {
                ...
                } = e, a = n.state !== I.Y.DELETED ? e.onClickReply : void 0;
            switch (n.state) {
            case I.Y.LOADED: {
                    let {
        ...
        }(e), P = i.useMemo(() => e.compact ? (0, p.Z)((0, A.vc)(l()(), 'LT')) : null, [e.compact]);

...
var n = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(442837), l = s(704215), c = s(780384), d = s(481060), _ = s(153867), E = s(230711), u = s(714338), T = s(857595), I = s(607070), S = s(627845), N = s(514361), C = s(605236), m = s(786761), A = s(3148), h = s(739566), g = s(753206), O = s(837741), p = s(804545), R = s(921801), x = s(594174), M = s(285952), D = s(153124), f = s(358085), P = s(210887), L = s(740492), Z = s(695346), b = s(329013), v = s(333859), j = s(726985), B = s(981631), U = s(921944), G = s(959517), F = s(689938), y = s(225731), V = s(331651);
function Y(e, t, s) {
...
class Q extends a.Component {
        ...
        return f.isPlatformEmbedded ? (0, n.jsxs)(d.FormItem, {
            ...
            children: [
                ...
                (0, n.jsx)(d.FormText, {
                    ...
                    children: F.Z.Messages.USER_SETTINGS_APPEARANCE_ZOOM_TIP.format({ modKey: u.Z.modKey })
                })
            ]
        }) : null;
    }
    ...
    renderScalingAndSpacing() {
        return (0, n.jsxs)(n.Fragment, {
            children: [
                ...
                (0, n.jsx)(d.FormDivider, { className: V.marginTop20 })
            ]
        });
    }
    render() {
    ...
    handleSliderValueText(e) {
        return F.Z.Messages.PIXEL_VALUE_A11Y_TEXT.format({ value: e });
    }
...
function q() {
    let e = Z.jU.useSetting(), t = Z.RS.useSetting(), s = Z.NA.useSetting(), i = Z.L1.useSetting(), r = 'UserSettingsAppearance', {enabled: c} = (0, O.J)({ location: r }), {enabled: d} = (0, p._)({ location: r });
    a.useEffect(() => {

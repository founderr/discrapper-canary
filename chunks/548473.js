...
var k = x(735250), r = x(470079), s = x(120356), t = x.n(s), o = x(500923), n = x.n(o), m = x(442837), e = x(481060), p = x(607070), l = x(367907), h = x(626135), d = x(768581), c = x(956664), y = x(45966), f = x(819553), u = x(487533), G = x(279876), A = x(180504), E = x(614725), D = x(535170), B = x(981631), V = x(689938), b = x(745358);
function F(a) {
    let i = (0, m.e7)([p.Z], () => p.Z.useReducedMotion), x = r.useRef(null);
    return r.useEffect(() => {
        let k;
                ...
                children: [
                    ...
                    (0, k.jsxs)('div', {
                        ...
                        children: [
                            ...
                            n ? (0, k.jsx)(e.Spinner, { className: b.__invalid_subtitle }) : s === f.uX.NOT_APPLICABLE ? (0, k.jsx)(e.Heading, {

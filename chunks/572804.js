...
function s(e) {
    var t, n, r, i;
    let { rawMessage: a, userId: o, suppressEveryone: s = !1, suppressRoles: u = !1 } = e;
    return l({
        userId: o,
...
function l(e) {
    let { userId: t, channelId: n, mentionEveryone: o, mentionUsers: s, mentionRoles: l, suppressEveryone: u = !1, suppressRoles: c = !1 } = e;
    if ((o && !u) || s.includes(t)) return !0;

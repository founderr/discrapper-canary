...
function L(e, t, n, y) {
  ...
  var O = {
    ...
    j = [],
    C, H, F, I, N, A, R, z, W, B, U, K, V, J, G, q, $, Q, X, Z = _(P);
  try {
    for (Z.s(); !(X = Z.n()).done;) {
      var ee = function() {
        var t = X.value;

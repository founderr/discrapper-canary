...
class r {
    ...
    requireFrame(t) {
        if (null != this.native)
            !this.renderedFrames.has(t) && (this.paint(t), this.renderedFrames.add(t)), this.renderedFrames.size === this.frameCount && this.drop();
    }
    paint(t) {
        if (null != this.native) {
            var e;
            let i = new ImageData(this.native.get_bgra(t, this.frameWidth, this.frameHeight), this.frameWidth, this.frameHeight), [n, r, s, h] = a(t, this.frameWidth, this.frameHeight, this.cells);
    ...
    constructor(t, e, i, r) {
        ...
        if (this.key = e, this.canvas = function (t, e) {
            ...
            }(s, h), this.context = this.canvas.getContext('2d'), this.cells = a, this.native = t, this.renderedFrames = new Set(), this.frameWidth = i, this.frameHeight = r, this.frameRate = t.fps, this.frameCount = t.frames, null == this.context)

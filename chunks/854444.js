...
var i = t(470079), l = t(392711), o = t.n(l), E = t(524437), r = t(317381), u = t(853856), a = t(846787), s = t(924301), d = t(601070), _ = t(569471), c = t(131704), C = t(680089), I = t(592125), A = t(58468), S = t(77498), T = t(496675), L = t(306680), N = t(944486), O = t(9156), D = t(823379), g = t(540126), h = t(647086), R = t(231338);
let f = 12633 == t.j ? [
    r.ZP,
    u.Z,
    s.ZP,
...
function P() {
    let e = u.Z.getFavoriteChannels(), n = O.ZP.isGuildCollapsed(h._), t = N.Z.getChannelId(), i = I.Z.getChannel(t), l = N.Z.getVoiceChannelId(), r = [], s = {};
    for (let n in e) {
        let t = e[n], i = I.Z.getChannel(t.id);
    ...
    function _(t, E) {
        ...
        return o()(t).map(t => {
            ...
            if (!t.isPrivate() && !T.Z.can(R.Pl.VIEW_CHANNEL, t))
                return null;
            let s = null != i && (i.id === t.id || l === t.id), _ = null != i && i.isThread() && i.parent_id === t.id, C = null !== (a = s || _ || !r ? d.Z.getActiveJoinedRelevantThreadsForParent(t.guild_id, t.id) : d.Z.getActiveJoinedUnreadThreadsForParent(t.guild_id, t.id)) && void 0 !== a ? a : {}, I = (0, g.zR)(t, C, i, l, n), S = A.Z.isCollapsed(t.id), N = O.ZP.isChannelMuted(t.guild_id, t.id), D = {
                    id: t.id,
                    record: t,
                    category: E,

...
var i = t(470079),
  ...
  R = t(647086),
  f = t(231338);
let h = 12633 == t.j ? [r.ZP, u.Z, s.ZP, d.Z, _.Z, C.Z, A.Z, S.Z, T.Z, L.ZP, N.Z, O.ZP] : null;
...
function P() {
  ...
  return {
    ...
    getSections: () => [0, 0, 0, h.channelList.length, ...p.map(e => Math.max(1, e.channelList.length))],

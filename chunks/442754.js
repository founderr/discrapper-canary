...
function f(e) {
  let {
    isFavoritesPerk: t
  } = (0, s.useFavoritesServerExperiment)("useChannelOptInItems"), n = (0, r.useOptInEnabledForGuild)(e.guild_id), f = (0, u.useStateFromStores)([d.default], () => d.default.isChannelOptedIn(e.guild_id, e.id)), _ = (0, u.useStateFromStores)([d.default], () => null != e.parent_id && d.default.isChannelOptedIn(e.guild_id, e.parent_id)), E = (0, u.useStateFromStores)([d.default], () => d.default.isFavorite(e.guild_id, e.id)), p = () => {

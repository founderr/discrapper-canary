...
function _(e) {
  let {
isFavoritesPerk: n
  } = (0, u.z)('useChannelOptInItems'), t = (0, r.DM)(e.guild_id), _ = (0, i.e7)([s.ZP], () => s.ZP.isChannelOptedIn(e.guild_id, e.id)), E = (0, i.e7)([s.ZP], () => null != e.parent_id && s.ZP.isChannelOptedIn(e.guild_id, e.parent_id)), N = (0, i.e7)([s.ZP], () => s.ZP.isFavorite(e.guild_id, e.id)), Z = () => {
(0, o.XQ)(e.guild_id, e.id, !_, {

s(47120), s(757143);
var n = s(735250), i = s(470079), a = s(120356), r = s.n(a), l = s(920906), o = s(399606), u = s(481060), d = s(607070), c = s(745510), E = s(735336), _ = s(131640), m = s(51144), g = s(346585), S = s(81259), I = s(119848), T = s(801461), O = s(228168), N = s(689938), h = s(466576), f = s(733469);
...
t.Z = i.forwardRef(function (e, t) {
    let {
            ...
            username: Z,
            globalName: U
        } = L, G = i.useRef(null), b = i.useRef(null), j = i.useMemo(() => s.merge({ discriminator: '0000' }), [s]), [D, W] = (0, l.useSpring)(() => ({
            opacity: 0,
            y: 5
        }));
    i.useEffect(() => {
    ...
    let k = (0, o.e7)([d.Z], () => d.Z.useReducedMotion), {createMultipleConfettiAt: F} = i.useContext(c.h), w = null == x ? void 0 : x.getLegacyUsername();
    return i.useEffect(() => {
        ...
        className: r()(h.userCardContainer, { [h.shinyCard]: P === T.Wq.PREVIEW }),
        children: [
            (0, n.jsxs)('div', {
                ...
                children: [
                    ...
                    P === T.Wq.PREVIEW && null != w && (0, n.jsx)('div', {
                        ...
                        children: (0, n.jsx)(u.Tooltip, {
                            position: 'top',
                            text: N.Z.Messages.ORIGINALLY_KNOWN_AS.format({ legacyUsername: w }),
                            spacing: 12,
            ...
            P === T.Wq.PREVIEW && (0, n.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, n.jsx)(u.Text, {
                        ...
                        children: N.Z.Messages.CONNECTIONS_PROFILE_MEMBER_SINCE.format({ date: (0, g.K9)(s.id) })
                    })
                ]
            })
        ]

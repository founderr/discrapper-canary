...
t.Z = function(e) {
    ...
    n = (0, l.useCallback)(() => {
      ...
      return (0, i.jsxs)(l.Fragment, {
        children: [o && (0, i.jsxs)("div", {
          ...
          className: E.popoutText,
          children: I.Z.Messages.RTC_CONNECTION_STATE_RTC_CONNECTED_AVERAGE_PING.format({
            averagePing: n.toFixed(0)
          })
        }), null != r ? (0, i.jsx)("div", {
          className: E.popoutText,
          children: I.Z.Messages.RTC_CONNECTION_STATE_RTC_CONNECTED_LAST_PING.format({
            lastPing: r.toFixed(0)
          })
        }) : null, null != s ? (0, i.jsx)("div", {
          className: E.popoutText,
          children: I.Z.Messages.RTC_CONNECTION_STATE_RTC_CONNECTED_LOSS_VALUE.format({
            outboundLossRate: s.toFixed(1)
          })
        }) : null, (0, i.jsxs)("div", {
          className: a()(E.popoutText, E.popoutTextDetails),
          children: [null == s ? I.Z.Messages.RTC_CONNECTION_STATE_RTC_CONNECTED_DETAILS.format({
            badPing: 250
          }) : null, null != s ? I.Z.Messages.RTC_CONNECTION_STATE_RTC_CONNECTED_DETAILS_WITH_LOSS.format({
            badPing: 250,
            badLossRate: 10
          }) : null]
        })]
  ...
  return (0, i.jsxs)(i.Fragment, {
    children: ["function" == typeof x ? x() : (0, i.jsx)("p", {
      className: a()(E.popoutText, E.popoutTextDetails),
      children: x
    }), (0, i.jsx)("hr", {
      ...
      children: [(0, i.jsxs)("span", {
        ...
        children: [(0, i.jsxs)(o.Anchor, {
          ...
          onClick: t,
          children: [I.Z.Messages.DEBUG, (0, i.jsx)(o.WindowLaunchIcon, {
            size: "xxs",
            color: "currentColor",
            className: E.__invalid_icon
          })]
          ...
          children: [I.Z.Messages.COPY_STATS, (0, i.jsx)(o.CopyIcon, {
            size: "xxs",
            color: "currentColor",
            className: E.__invalid_icon
          })]

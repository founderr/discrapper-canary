...
function j(e) {
  ...
  if (null == a || a.type === T.ChannelTypes.DM || x.guildFilter === T.RecentMentionsFilters.THIS_SERVER && a.getGuildId() !== g.default.getGuildId()) return null;
...
function U(e) {
  ...
  x = l.defaults(l.pick(e, ["guildFilter", "roleFilter", "everyoneFilter"]), x), i.default.set(I, x);
...
var B = new G(o.default, {
  LOAD_RECENT_MENTIONS: function(e) {
    ...
    M = !0, null == t && x.guildFilter === T.RecentMentionsFilters.THIS_SERVER && U({
      guildFilter: T.RecentMentionsFilters.ALL_SERVERS
    })
  },
  ...
  CHANNEL_SELECT: function() {
    if (x.guildFilter !== T.RecentMentionsFilters.THIS_SERVER) return !1;
    R = !1
  },
  CONNECTION_OPEN: k,

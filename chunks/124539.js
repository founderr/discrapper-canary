...
function x(e) {
  let {
    ...
    onNext: x,
    onBack: f
  } = e, T = (0, _.useSafetyHubAppealSignal)(), g = (0, o.useStateFromStores)([u.default], () => u.default.getFreeTextAppealReason()), [m, C] = s.useState(""), [p, L] = s.useState(!1);
  s.useEffect(() => {
    C(null != g ? g : ""), L(T === A.AppealIngestionSignal.SOMETHING_ELSE)
  }, [g, T]);
  let h = e => {
      L(e === A.AppealIngestionSignal.SOMETHING_ELSE), e !== A.AppealIngestionSignal.SOMETHING_ELSE && (C(""), r.default.dispatch({

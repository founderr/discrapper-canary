...
let Z = {
  ...
  L = r.memo(function(e) {
    let {
      width: t
    } = e, n = (0, u.e7)([E.Z], () => E.Z.useReducedMotion), i = (0, C.GN)(e => e.mode, o.Z), [s, d] = r.useState(!0), _ = (0, l.useSpring)({
      from: {
        opacity: 0
      },
      to: {
        opacity: i === C.v0.GET_STARTED ? 0 : 1
      },
      config: Z,
      delay: 500,
      immediate: n,
      onRest: () => d(!1)
    }), p = (0, C.GN)(e => e.userUpsellScreen, o.Z), L = (0, C.GN)(e => e.started, o.Z), {
      guilds: v
    } = (0, h.C3)({
    ...
    switch (r.useEffect(() => {
        ...
        let e = v.length > 0;
        if (e && !R && p === C.o2.USER_UPSELL) {
          (0, C.fH)(C.v0.ADMIN_UPSELL);
          return
        }
        if (!e && R && !L) {
          (0, C.fH)(C.v0.GET_STARTED);
          return
        }
        if (R && i === C.v0.ADMIN_UPSELL && 0 === O.length) {
          (0, C.fH)(C.v0.GET_STARTED), C.GN.getState().setUserUpsellScreen(C.o2.USER_UPSELL);
          return
        }
      }, [O.length, v.length, L, R, i, p]), i) {
      case C.v0.ADMIN_UPSELL:
        return (0, a.jsx)(f.$, {});
      case C.v0.GET_STARTED:
        return (0, a.jsx)(f.J, {});
      case C.v0.DISCOVERY:
      case C.v0.GAMES:
      case C.v0.PLAYSTYLE:

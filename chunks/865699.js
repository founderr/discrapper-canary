...
function c(e) {
  let {
    ...
    c(), i.default.open(p, r.GuildSettingsSections.INSTANT_INVITES)
  ...
  }), []), E = n.code !== r.AbortCodes.TOO_MANY_INVITES ? n.getAnyErrorMessage() : o.default.can(r.Permissions.MANAGE_GUILD, t) ? u.default.Messages.TOO_MANY_INVITES_ERROR.format({
    inviteListHook: I,
    inviteHelpHook: h

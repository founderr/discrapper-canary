...
var i = n(470079), a = n(392711), s = n.n(a), l = n(442837), r = n(430824), o = n(159299), c = n(231338), d = n(689938);
let u = [];
function h(e, t) {
    let n = (0, l.e7)([r.Z], () => null != t ? r.Z.getRoles(t.id) : void 0), {
            ...
            return e.push(c.Sk.ONLINE, c.Sk.OFFLINE), e.map(e => {
                var t, i, a, s;
                let l = e === c.Sk.ONLINE ? d.Z.Messages.STATUS_ONLINE : e === c.Sk.OFFLINE ? d.Z.Messages.STATUS_OFFLINE : null !== (a = null == n ? void 0 : null === (t = n[e]) || void 0 === t ? void 0 : t.name) && void 0 !== a ? a : '';
                return {
                    label: l,

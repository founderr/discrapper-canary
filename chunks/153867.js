...
var r = n(524437), i = n(381499), a = n(570140), o = n(514361), s = n(238514), l = n(210887), u = n(695346), c = n(675478), d = n(981631), _ = n(874893);
function E(e) {
    return c.hW.updateAsync('guildFolders', t => {
        t.folders = e.map(e => {
...
function h(e) {
    ...
    if (a.Z.dispatch({
            ...
            settings: { useSystemTheme: 'system' === n ? _.K.ON : _.K.OFF }
        }), a.Z.dispatch({
...
t.ZP = {
    ...
    updateLocale: e => c.hW.updateAsync('localization', t => {

...
function Z(e) {
  let n = function(e) {
    let n = (0, r.n2)(e.guild_id, e.id),
      t = (0, a.e7)([M.ZP, c.Z, l.Z, d.Z], () => {
        if (e.isForumPost()) return M.ZP.isForumPostUnread(e.id);
        if (e.type !== _.d4z.GUILD_CATEGORY) return M.ZP.hasUnreadOrMentions(e.id);
        {
          ...
          for (let e in i)
            if (t.has(e)) {
              for (let n in i[e])
                if (d.Z.hasJoined(n) && !d.Z.isMuted(n) && M.ZP.hasUnreadOrMentions(n)) return !0
            } return !1
        }
      }, [e]);

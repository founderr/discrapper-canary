...
var t = i(735250);
i(470079);
var r = i(442837), a = i(481060), l = i(45114), u = i(456269), s = i(344185), o = i(569471), d = i(131704), c = i(324067), Z = i(306680), h = i(981631), M = i(689938);
function f(n) {
    let e = function (n) {
        let e = (0, u.n2)(n.guild_id, n.id), i = (0, r.e7)([
                Z.ZP,
                c.Z,
                s.Z,
                o.Z
                    ...
                    return Z.ZP.hasUnreadOrMentions(n.id);
                {
                    ...
                    if (e[n.id].some(n => {
                        ...
                        return !0;
                    let i = new Set(e[n.id].map(n => n.channel.id)), t = s.Z.getThreadsForGuild(n.guild_id);
                    for (let n in t)
                        if (i.has(n)) {
                            for (let e in t[n])

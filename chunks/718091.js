...
let ei = e => {
    ...
    return (0, l.jsx)(m.Clickable, {
      onClick: () => {
        (0, L.transitionToGuild)(Q.ME, n.id), a()
      },
...
class eo extends a.PureComponent {
  ...
  constructor(...e) {
    super(...e), this.state = {
      ...
      S.default.addRecipients(e.id, t, Q.AnalyticsLocations.ADD_FRIENDS_TO_DM).then(l => {
        if (n) {
          if (e.isDM() && l !== e.id) {
...
function ed(e) {
  ...
  return (a.useEffect(() => (d && K.ComponentDispatch.subscribe(Q.ComponentActions.TOGGLE_DM_CREATE, p), () => {

...
let h = {
  ...
  C = e => {
    ...
    } = (0, r.default)(), l = (0, I.getAppliedGuildBoostsRequired)(t.id)[S.BoostedGuildTiers.TIER_1] - t.premiumSubscriberCount;
    return (0, a.jsxs)("div", {
  ...
  x = e => {
    let t, s, l, {
      ...
      E = i.length;
    return null == u || r === S.BoostedGuildTiers.TIER_3 || o > 0 ? (0, a.jsx)(a.Fragment, {}) : (E > c ? (t = N.default.Messages.GUILD_SETTINGS_STICKERS_UPSELL_BANNER_TOO_MANY_STICKERS_HEADER.format({
      level: u
    }), s = N.default.Messages.GUILD_SETTINGS_STICKERS_UPSELL_BANNER_TOO_MANY_STICKERS_TEXT.format({
      level: u
    }), l = S.AnalyticsObjects.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = N.default.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_BANNER_HEADER, s = N.default.Messages.GUILD_SETTINGS_STICKERS_UPSELL_BANNER_TEXT.format({
      level: u,
      numAdditional: (0, I.getIncrementalStickerCountForTier)(u)
    }), l = S.AnalyticsObjects.BOOST_UPSELL_BANNER_SLOTS_FULL), (0, a.jsx)(d.default, {
      header: t,
      text: s,
      guild: n,
      analyticsLocation: {

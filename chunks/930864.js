...
function R(e) {
    let { message: t, forwardOptions: n, sendLabel: s, canSend: h, selectedDestinations: f, isSending: m, onSend: S, showPreview: I } = e,
        ...
        b = (0, C.Ad)(),
        [x, M] = a.useState(() => (0, u.H2)()),
        { textValue: R, richValue: P } = x,
        [O, D] = a.useState(!1),
        w = a.useCallback(() => D(!0), []),
        j = a.useCallback(() => D(!1), []),
        G = a.useCallback(
...
function P(e) {
    let { channelId: t, messageId: i, initialSelectedDestinations: c, forwardOptions: u, onClose: d, onRequestSent: E, ...P } = e,
        ...
        [G, k] = a.useState(!1),
        F = (0, r.e7)([m.Z], () => m.Z.getMessage(t, i), [t, i]),
        U = (0, r.e7)([g.Z], () => g.Z.getChannel(t), [t]),
        W = (0, C.ZF)(),
        H = (0, C.mh)(),
        B = a.useRef(0),
        z = a.useRef(0),
    ...
    let eu =
        ...
        ed = V <= 1 ? Z.Z.Messages.SEND : Z.Z.Messages.MESSAGES_SEND_SEPARATELY.format({ count: V });
                                ...
                                children: (0, l.jsx)(o.HeadingLevel, {
                                    ...
                                    children: q
                                        ? (0, l.jsx)(o.Text, {
                                              ...
                                              color: 'text-warning',
                                              children: Z.Z.Messages.MESSAGES_FORWARD_MAX_DESTINATION_COUNT.format({ count: x.G })
                                          })
                                        : (O || D) &&
                                          (0, l.jsx)(o.Heading, {

...
function H(e) {
  ...
  return !!(null != n && (0, p.isEligibleForExplicitMediaRedaction)()) && h.default.getGuildId() === t && B(m.default.keys(n).map(e => n[e].first_message))
}
...
function Y(e) {
  ...
  return !!(null != n && (0, p.isEligibleForExplicitMediaRedaction)()) && h.default.getGuildId() === t && B(n, {
    forceBatchScan: !0
  })
}

...
function A(e) {
  let {
    ...
    hover: (e, l) => {
      ...
      let {
        index: n
      } = e, t = null === (a = M.current) || void 0 === a ? void 0 : a.getBoundingClientRect(), r = l.getClientOffset();
  ...
  if (t.useEffect(() => {
    ...
    }, [l.value, p]), null == a) return null;
  let F = "" !== l.value ? l.value : l.id;
  return (0, n.jsxs)("div", {
    ref: M,
    className: r()(j.draggableInputContainer, {
      [j.dragging]: _
    }),
    "data-dnd-name": F,
  ...
  return (0, n.jsx)(_.Z, {
    ...
    children: (0, n.jsxs)(N.Z, {
      ...
      children: [x.map((e, l) => (0, n.jsx)(A, {
        ...
        children: [(0, n.jsx)(f.CirclePlusIcon, {
          size: "custom",
          height: 17,
          width: 17,
        ...
        children: B.Z.Messages.MEMBER_VERIFICATION_EXAMPLE_RULES_SUBTITLE
      }), (0, n.jsxs)("div", {

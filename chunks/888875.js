...
f.DZ.beforeSendCallbacks.push({
  ...
  processProto: e => {
    if (!!d.Z.hasPendingUsage())
      h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS) && (e.stickerFrecency = a.ls.create(), e.stickerFrecency.stickers = (0, p.tU)(d.Z.stickerFrecencyWithoutFetchingLatest.usageHistory, 100));
  }
}), f.DZ.beforeSendCallbacks.push({
  ...
  processProto: e => {
    if (!!c.Z.hasPendingUsage())
      h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS) && !i().isEmpty(c.Z.playedSoundHistory) && (e.playedSoundFrecency = a.pL.create(), e.playedSoundFrecency.playedSounds = (0, p.tU)(c.Z.playedSoundHistory, 100));
  }
}), f.DZ.beforeSendCallbacks.push({
  hasChanges: () => o.ZP.hasPendingUsage() && h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS),
  processProto: e => {
    if (!!o.ZP.hasPendingUsage())
      h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS) && (e.applicationCommandFrecency = a.YI.create(), e.applicationCommandFrecency.applicationCommands = (0, p.tU)(o.ZP.getCommandFrecencyWithoutLoadingLatest().usageHistory, 500));
  }
}), f.DZ.beforeSendCallbacks.push({
  hasChanges: () => l.Z.hasPendingUsage() && h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS),
  processProto: e => {
    if (!!l.Z.hasPendingUsage())
      h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS) && (e.applicationFrecency = a.UY.create(), e.applicationFrecency.applications = (0, p.tU)(l.Z.getApplicationFrecencyWithoutLoadingLatest().usageHistory, m.yP));
  }
}), f.DZ.beforeSendCallbacks.push({
  hasChanges: () => _.Z.hasPendingUsage() && h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS),
  processProto: e => {
    if (!!_.Z.hasPendingUsage())
      h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS) && (e.guildAndChannelFrecency = a.lG.create(), e.guildAndChannelFrecency.guildAndChannels = (0, p.tU)(_.Z.frecencyWithoutFetchingLatest.usageHistory, _.C));
  }
});
  }
  constructor(...e) {
...
async function C() {
  y(g), !h.Z.hasLoaded(I.yP.FRECENCY_AND_FAVORITES_SETTINGS) && (d.Z.hasPendingUsage() || u.ZP.hasPendingUsage() || o.ZP.hasPendingUsage() || l.Z.hasPendingUsage() || _.Z.hasPendingUsage()) && await f.DZ.loadIfNecessary(), i().forEach(f.aj, e => {

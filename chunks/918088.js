...
var s = n("278074"),
  ...
  S = n("689938");
let C = {
  channelId: N.EMPTY_STRING_SNOWFLAKE_ID,
...
function O(e, t) {
  ...
  let {
    ...
    return {
      ...
      votes: (0, s.match)(L).with(a.PollLayoutTypes.IMAGE_ONLY_ANSWERS, () => "(".concat(E.toLocaleString(), ")")).otherwise(() => S.default.Messages.POLL_VOTES_COUNT.format({

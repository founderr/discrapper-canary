...
function v(e, t) {
  ...
  let E = e.state === C.MessageStates.SENT,
    ...
    T = null == _ && E,
    {
      ...
      editing: h,
      showResults: N
    } = null !== (a = null != t ? t : (0, m.getPollState)(e.getChannelId(), e.id)) && void 0 !== a ? a : g,
    A = e.reactions,
    M = !0;
  if (!O(e)) {
...
function L(e, t) {
  ...
  let {
    ...
    canShowVoteCounts: y,
    canSubmitVote: U,
    expirationLabel: j = A.default.Messages.POLL_EXPIRED,
    hasSelectedAnswer: b,
    hasVoted: G,
    isEditingVote: B,
    isExpired: F,
    ...
    let u = "".concat(e.answer_id),
      ...
      f = H.has(u),
      T = c >= Q && 0 !== c,
      m = G && null !== (r = null == d ? void 0 : d.me_vote) && void 0 !== r && r,
      I = R({
        didSelfVote: m,
        hasVoted: G,
        isExpired: F,
    ...
    enabled: !0,
    type: "showVotes"
  }, $ = m.allow_multiselect, ee = (0, s.match)({
    isInteractive: k,
    isExpired: F,

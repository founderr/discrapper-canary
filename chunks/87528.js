...
var n = i(735250), a = i(470079), r = i(912370), o = i(477690), s = i(153124), l = i(626135), c = i(463571), d = i(744142), u = i(132871), h = i(147890), _ = i(216547), p = i(57716), m = i(981631), f = i(361501);
function g(e) {
    let {
            collection: t,
            collection: {
        ...
        } = e, [x, I] = a.useState(300), [b, N] = a.useState(4), v = parseFloat(o.Z.COLLECTION_LIST_CARD_GAP), A = (0, u.useApplicationDirectoryHistory)(e => e.guildId), E = (0, p.Z)({ collection: t });
    a.useEffect(() => {
        function e() {
            var e;
            let t = null === (e = E.current) || void 0 === e ? void 0 : e.offsetWidth, i = 1;
    ...
    return (0, n.jsx)('div', {
        ...
        children: (0, n.jsx)(_.Z, {
            ...
            tileMargin: v,
            onScroll: e => {
                let {tileIndex: t} = e, n = C.slice(t, t + b).reduce((e, t) => {
                        let {
                            type: i,
                            application: n
                        } = t;

var r, i, a, s, o, l, u;
n(653041), n(411104), r = n.g, i = Date.now ? Date.now() : +new Date(), a = r.performance || {}, s = [], o = {}, l = function(e, t) {
  for (var n = 0, r = s.length, i = []; n < r; n++)
s[n][e] == t && i.push(s[n]);
  return i;
}, u = function(e, t) {
  for (var n, r = s.length; r--;)
(n = s[r]).entryType == e && (void 0 === t || n.name == t) && s.splice(r, 1);
...
throw SyntaxError('Failed to execute \'measure\' on \'Performance\': The mark \'' + t + '\' does not exist.');
  r = o[t] ? o[t].startTime : 0, i = o[n] ? o[n].startTime : a.now(), s.push({
name: e,
entryType: 'measure',
startTime: r,
duration: i - r

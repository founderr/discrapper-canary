...
var r = n(430824), i = n(19780), a = n(594174), o = n(626135), s = n(981631), l = n(37113), u = n(474936), c = n(65154), d = n(689938);
function _(e) {
    if (null == e)
        return;
    let t = e.maxResolution.type === c.uA.SOURCE ? l.LY.RESOLUTION_SOURCE : e.maxResolution.height, n = (0, l.aW)(t);
...
function I(e, t, n) {
    var c, d, _;
    let E = (c = e, d = t, _ = n, l.ND.find(e => (null == e.preset || e.preset === c) && e.resolution === d && e.fps === _)), f = a.default.getCurrentUser(), h = i.Z.getGuildId(), p = null != h ? r.Z.getGuild(h) : null;

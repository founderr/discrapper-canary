...
function g(e) {
  let {
    ...
    disabled: U = !1
  } = e, O = (0, o.useStateFromStores)([I.default], () => I.default.hidePersonalInformation), [b, v] = (0, o.useStateFromStoresArray)([N.default], () => [N.default.paymentSources, N.default.hasFetchedPaymentSources]), B = (0, m.useSubscriptionPlansLoaded)((0, P.getSubscriptionSKUs)(t)), {

...
var r = n(544891), i = n(881052), a = n(981631), o = n(231338);
let s = async (e, t) => {
        try {
        ...
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { includeSoftDeleted: !1 }, n = {
    ...
    }, d = async e => (await r.tn.get({ url: a.ANM.GUILD_ROLE_SUBSCRIPTIONS_SETTINGS(e) })).body, _ = async (e, t) => {
        try {
            return (await r.tn.patch({

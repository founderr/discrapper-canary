...
var i = t(512722), c = t.n(i), a = t(149765), r = t(544891), l = t(493683);
t(749210);
var u = t(911969), d = t(367907), o = t(944486), _ = t(979651), s = t(700785), E = t(922482), T = t(192079), p = t(706058), I = t(590415), S = t(981631);
function g(n, e) {
    let t = n.getGuildId();
    return c()(null != t, 'This channel cannot be guildless.'), e && (0, d.yw)(S.rMx.REQUEST_TO_SPEAK_INITIATED, { ...(0, T.s$)(n) }), r.tn.patch({
...
function f(n, e) {
    ...
    return (0, I.gf)(a) === I.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK && !e && (0, d.yw)(S.rMx.PROMOTED_TO_SPEAKER, { ...(0, T.s$)(n) }), r.tn.patch({
...
function N(n, e, t) {
    ...
    let r = n.permissionOverwrites[i], d = {
            id: i,
            type: u.BN.ROLE,
            allow: s.Hn,
            deny: s.Hn,

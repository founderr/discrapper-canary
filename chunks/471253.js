...
var i = t(512722), u = t.n(i), l = t(149765), r = t(544891), a = t(493683);
t(749210);
var s = t(911969), d = t(367907), c = t(944486), o = t(979651), _ = t(700785), E = t(922482), T = t(192079), f = t(706058), S = t(590415), A = t(981631);
function I(n, e) {
    let t = n.getGuildId();
    return u()(null != t, 'This channel cannot be guildless.'), e && (0, d.yw)(A.rMx.REQUEST_TO_SPEAK_INITIATED, { ...(0, T.s$)(n) }), r.tn.patch({
...
function N(n, e) {
    ...
    return (0, S.gf)(l) === S.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK && !e && (0, d.yw)(A.rMx.PROMOTED_TO_SPEAKER, { ...(0, T.s$)(n) }), r.tn.patch({

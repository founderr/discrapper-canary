...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(442837), l = n(481060), u = n(749210), c = n(906732), d = n(977392), _ = n(706454), E = n(246946), f = n(259580), h = n(785717), p = n(621853), m = n(335191), I = n(171368), T = n(659101), g = n(228168), S = n(981631), A = n(689938), N = n(805151), v = n(655899);
function O(e) {
    var t, n;
    let a, O, {
            userId: R,
            ...
            onClose: L,
            className: b
        } = e, {analyticsLocations: M} = (0, c.ZP)(), {
            messageId: P,
            roleId: U
        } = (0, h.KZ)(), w = (0, d.Z)(y, R, C), [x, G] = i.useState(new Set()), k = (0, s.e7)([p.Z], () => p.Z.getUserProfile(R)), B = null !== (t = null == k ? void 0 : k.connectedAccounts) && void 0 !== t ? t : [], F = null !== (n = null == k ? void 0 : k.applicationRoleConnections) && void 0 !== n ? n : [], V = (0, s.e7)([E.Z], () => E.Z.hidePersonalInformation), H = (0, s.e7)([_.default], () => _.default.locale);
    if (i.useEffect(() => {
            if ((null == y ? void 0 : y.id) != null && (null == w ? void 0 : w.id) != null)
                u.Z.fetchGuildRoleConnectionsEligibility(y.id, w.id).then(e => {
                    let t = new Set();
                    for (let n of e)
                        for (let {connection_type: e} of n)
                            t.add(e);
                    G(t);
                });
        }, [
                    ...
                    (0, r.jsxs)(l.Clickable, {
                        onClick: function () {
                            (0, I.openUserProfileModal)({
                                ...
                                analyticsLocation: { section: S.jXE.PROFILE_POPOUT }
                            }), null == L || L();
                        },

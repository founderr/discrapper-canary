...
[y, D] = i.useState(null),
[L, b] = i.useState(!1),
M = i.useMemo(() => null == y || L ? _ : _.slice(0, y), [
  _,
  y,
  L
]),
...
V = _.length,
H = 0 === V ? v.Z.Messages.ROLE_LIST_EMPTY : v.Z.Messages.ROLES_LIST.format({
  numRoles: V
}),
Z = M.map((e, i) => {
  var s;
...
trackUserProfileAction: s
  } = (0, g.KZ)(), o = (0, c.e7)([h.ZP], () => h.ZP.getMember(a.id, t.id)), l = (0, c.e7)([p.Z], () => p.Z.getRoles(a.id)), u = null == o ? void 0 : o.roles, d = i.useMemo(() => null == u || 0 === u.length ? [] : Object.values(l).filter(e => u.includes(e.id)).sort((e, t) => {
var n, r;

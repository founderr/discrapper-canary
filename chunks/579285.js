...
let C = (0, E.Z)(function (e) {
    ...
    let y = i.useRef({}), D = (e, t) => {
            null != t ? y.current[e] = t : delete y.current[e];
        }, [L, b] = i.useState(null), [M, P] = i.useState(!1), U = i.useMemo(() => null == L || M ? _ : _.slice(0, L), [
            _,
            L,
            M
        ]), [w, x] = i.useState(h), G = _.length > U.length, k = f && null != c, B = i.useRef(null), F = i.useRef(null);
    i.useLayoutEffect(() => {
        var e, t, n, r, i, a, o, s;
        let l = null !== (i = null === (t = B.current) || void 0 === t ? void 0 : null === (e = t.getBoundingClientRect()) || void 0 === e ? void 0 : e.width) && void 0 !== i ? i : 0, u = null !== (a = null === (r = F.current) || void 0 === r ? void 0 : null === (n = r.getBoundingClientRect()) || void 0 === n ? void 0 : n.width) && void 0 !== a ? a : 0, c = h - (l > 0 ? l + 4 : 0) - (u > 0 ? u + 4 : 0), d = 0;
        for (let e = 0; e < 2; e++) {
            let t = 1 === e, n = 0;
            for (let e = d; e < U.length; e++) {
                let r = U[e], i = y.current[r.id];
                if (null == i)
                    continue;
    ...
    let V = i.useMemo(() => 'roles-'.concat((0, s.Z)()), []), H = (0, l.ZP)({
            id: V,
            isEnabled: !0,
            scrollToStart: v.Cyb,
            scrollToEnd: v.Cyb,
            wrap: !0
        }), Z = _.length, Y = 0 === Z ? O.Z.Messages.ROLE_LIST_EMPTY : O.Z.Messages.ROLES_LIST.format({ numRoles: Z }), j = U.map((e, i) => {
            var o;
            return (0, r.jsx)(A.Z, {
                role: e,
                guildId: a.id,
                style: { maxWidth: i === U.length - 1 ? w : h },

let r = n(761655).Reporter, i = n(873994).EncoderBuffer, a = n(873994).DecoderBuffer, o = n(21841), s = [
        'seq',
        'seqof',
        'set',
        'setof',
...
u.prototype.clone = function () {
    ...
    let t = this._baseState, n = e.filter(function (e) {
    ...
    u.prototype[e] = function () {
        let t = this._baseState, n = Array.prototype.slice.call(arguments);
    ...
    if (r.obj && o && (n = e.enterObject()), o) {
        ...
        if (t && t.track && null !== r.tag && t.track(e.path(), n, e.length, 'tagged'), t && t.track && null !== r.tag && t.track(e.path(), e.offset, e.length, 'content'), r.any || (i = null === r.choice ? this._decodeGeneric(r.tag, e, t) : this._decodeChoice(e, t)), e.isError(i))
            return i;
    ...
    let n = this._baseState, r = null, i = !1;
    return (Object.keys(n.choice).some(function (a) {
        let o = e.save(), s = n.choice[a];
        try {
            let n = s._decode(e, t);
            if (e.isError(n))
                return !1;
    ...
    if (i.any)
        ...
        null !== i.use ? a = this._getUse(i.use, n)._encode(e, t) : (o = this._encodePrimitive(i.tag, e), s = !0);
    if (!i.any && null === i.choice) {
        let e = null !== i.implicit ? i.implicit : i.tag, n = null === i.implicit ? 'universal' : 'context';
    ...
    let n = this._baseState, r = n.choice[e.type];

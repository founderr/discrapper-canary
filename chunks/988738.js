...
let p = e => {
  ...
  r.useEffect(() => {
    var e, t;
    let a = (0, s.findDOMNode)(p.current);
    if (null == a) return;
    let r = e => {
      let t = e.target,
        a = (0, s.findDOMNode)(p.current);
  ...
  r.useEffect(() => void(m.current = l)), r.useEffect(() => () => {
    ...
    var e;
    null === (e = p.current) || void 0 === e || e.updatePosition()
  }), (0, c.default)({
  ...
  let T = (0, d.useWindowDispatch)(),
    g = r.useCallback(() => {
      T.dispatch(C.ComponentActions.POPOUT_SHOW)
    }, [T]),
    A = r.useCallback(() => {
...
class m extends r.PureComponent {
  componentDidMount() {
    ...
    if (t.addEventListener("resize", this.closeResize, !0), h.ComponentDispatch.subscribe(C.ComponentActions.CONTEXT_MENU_CLOSE, this.props.closeContextMenu), null != e) {
      let t = setTimeout(() => {
        this.setState({
  ...
  componentWillUnmount() {
    ...
    e.removeEventListener("resize", this.closeResize, !0), h.ComponentDispatch.unsubscribe(C.ComponentActions.CONTEXT_MENU_CLOSE, this.props.closeContextMenu)
  }
  render() {
    var e;
    let {
    ...
    return r && null != l && null != i && null != n && null != u && i.context === t ? (0, a.jsx)(p, {
      rect: l,
      close: this.close,
      onUnmount: i.onClose,
      align: i.align,
      ...
      children: (e, a) => {
        ...
        return u({
          className: _.ContextMenuClassName,
          position: r,
          theme: s,
          onHeightUpdate: a,
          config: i,

...
function C(e) {
  ...
  }), [_, T]), v = (0, S.Go)(), A = (0, l.e7)([g.Z], () => t === d.S.STICKER && null != n ? g.Z.getStickerById(n) : null), m = null != A && v.includes(A.id), R = (0, l.e7)([c.Z], () => {
    if (t === d.S.EMOJI) {
  ...
  if (null != A && t === d.S.STICKER) return (0, b.J8)(A) && !(0, b.V9)(A) ? null : m ? (0, a.jsx)(u.MenuItem, {
    id: "unfavorite",
    action: () => (0, E.hW)(A.id),
  ...
  if (null != R && t === d.S.EMOJI) return j ? (0, a.jsx)(u.MenuItem, {
    id: "unfavorite",
    action: () => (0, s.Xe)(R),
    label: O.Z.Messages.UNFAVORITE_ITEM
  }) : (0, a.jsx)(u.MenuItem, {

...
class S extends a.Component {
  renderTestCase(e, s, t, a, i) {
    ...
    return (0, n.jsxs)(l.FormText, {
      ...
      children: [!0 === a ? "✅" : !0 === i ? "❌" : !0 === t ? "\uD83C\uDFCE️" : "", "speed test, bitrate = ", ((0, E.Hm)(e) / 1e3).toFixed(0), " kbps, framerate =", " ", (0, E.vW)(e).toFixed(0), " fps, duration = ", (0, E.tn)(e).toFixed(1), "s, direction =", " ", (0, E.K4)(e), void 0 !== o && (0, n.jsxs)("div", {
        children: [(0, n.jsxs)("div", {
          className: r()(T.marginTop8, T.marginBottom8),
          children: ["Loss ", 100 * o.loss.toFixed(2), "%, Payload Bandwidth ", o.payloadBandwidth.toFixed(0), " kbps, Network Bandwidth ", o.networkBandwidth.toFixed(0), " kbps"]
        }), (0, n.jsxs)("div", {
          className: r()(T.marginTop8, T.marginBottom8),
          children: ["IAT p50=", o.iatP50.toFixed(2), "ms, p95=", o.iatP95.toFixed(2), "ms, max=", o.iatMax.toFixed(2), "ms"]
        })]
  ...
  renderPing(e, s, t) {
    ...
    return (0, n.jsxs)(l.FormText, {
      className: T.marginBottom20,
      children: [s > u.N7.PINGING ? "✅" : s === u.N7.PINGING ? "\uD83C\uDFCE️" : "", "Ping endpoint", null !== a && (0, n.jsxs)("div", {
        className: r()(T.marginTop8, T.marginBottom8),
        children: ["Pinged ", a.count, " time(s), min=", a.min, "ms, p50=", a.p50, "ms, max=", a.max, "ms"]
      })]
    })
  }
  renderConnect(e, s, t) {
    if (!1 !== e) return (0, n.jsxs)(l.FormText, {
      className: T.marginBottom20,
      children: [s > u.N7.CONNECTING ? "✅" : s === u.N7.CONNECTING ? "\uD83C\uDFCE️" : "", "Connect to ", null != t ? t : "endpoint"]
    })
  }
  renderNotes() {
  ...
  renderAwaitingEndpoint(e, s) {
    if (!1 !== e) return (0, n.jsxs)(l.FormText, {
      className: T.marginBottom20,
      children: [s > u.N7.AWAITING_ENDPOINT ? "✅" : s === u.N7.AWAITING_ENDPOINT ? "\uD83C\uDFCE️" : "", "Select endpoint"]
    })
  }
  renderUpload(e, s) {
    if (!1 !== e) return (0, n.jsxs)(l.FormText, {
      className: T.marginBottom20,
      children: [s > u.N7.UPLOADING ? "✅" : s === u.N7.UPLOADING ? "\uD83C\uDFCE️" : "", "Upload results"]
    })
  }
  renderComplete(e, s) {
    if (!1 !== e && s === u.N7.COMPLETED) return (0, n.jsx)(l.FormText, {
      className: T.marginBottom20,
  ...
  render() {
    ...
    return !1 === e ? (0, n.jsx)(l.FormSection, {
      ...
      tag: l.FormTitleTags.H1,
      title: "Speed Test",
      children: [this.renderNotes(), (0, n.jsx)(l.FormItem, {
        className: T.marginBottom20,
        children: (0, n.jsx)("div", {
      ...
      }), this.renderAwaitingEndpoint(S, i), this.renderConnect(S, i, a), this.renderPing(S, i, _), this.renderTestCases(S, t, r, c, o), this.renderUpload(S, i), this.renderComplete(S, i)]
    })
  }
  constructor(...e) {
    var s, t, n;

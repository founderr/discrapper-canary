...
let a = {
        ...
        ful: '',
        ness: ''
    }, s = '[aeiouy]', o = '([^aeiou][^aeiouy]*)', i = '(' + s + '[aeiou]*)', c = RegExp('^' + o + '?' + i + o), u = RegExp('^' + o + '?' + i + o + i + '?$'), l = RegExp('^' + o + '?(' + i + o + '){2,}'), b = RegExp('^' + o + '?' + s), f = RegExp('^' + o + s + '[^aeiouwxy]$'), d = /ll$/, h = /^(.+?)e$/, p = /^(.+?)y$/, g = /^(.+?(s|t))(ion)$/, y = /^(.+?)(ed|ing)$/, v = /(at|bl|iz)$/, m = /^(.+?)eed$/, O = /^.+?[^s]s$/, w = /^.+?(ss|i)es$/, k = /([^aeiouylsz])\1$/, E = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, x = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, j = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/;
function C(e) {

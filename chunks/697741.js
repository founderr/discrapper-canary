...
let i = {
        ...
        ful: '',
        ness: ''
    }, s = '[aeiouy]', a = '([^aeiou][^aeiouy]*)', o = '(' + s + '[aeiou]*)', r = RegExp('^' + a + '?' + o + a), d = RegExp('^' + a + '?' + o + a + o + '?$'), u = RegExp('^' + a + '?(' + o + a + '){2,}'), c = RegExp('^' + a + '?' + s), _ = RegExp('^' + a + s + '[^aeiouwxy]$'), m = /ll$/, f = /^(.+?)e$/, h = /^(.+?)y$/, g = /^(.+?(s|t))(ion)$/, E = /^(.+?)(ed|ing)$/, A = /(at|bl|iz)$/, p = /^(.+?)eed$/, M = /^.+?[^s]s$/, x = /^.+?(ss|i)es$/, I = /([^aeiouylsz])\1$/, T = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, O = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, R = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/;
function v(e) {

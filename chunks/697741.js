...
function w(e) {
  ...
  let r = !1;
  return 121 === n.codePointAt(0) && (r = !0, n = "Y" + n.slice(1)), R.test(n) ? n = n.slice(0, -2) : C.test(n) && (n = n.slice(0, -1)), (t = v.exec(n)) ? s.test(t[1]) && (n = n.slice(0, -1)) : (t = _.exec(n)) && d.test(t[1]) && (n = t[1], b.test(n) ? n += "e" : I.test(n) ? n = n.slice(0, -1) : h.test(n) && (n += "e")), (t = m.exec(n)) && d.test(t[1]) && (n = t[1] + "i"), (t = S.exec(n)) && s.test(t[1]) && (n = t[1] + i[t[2]]), (t = x.exec(n)) && s.test(t[1]) && (n = t[1] + o[t[2]]), (t = B.exec(n)) ? u.test(t[1]) && (n = t[1]) : (t = p.exec(n)) && u.test(t[1]) && (n = t[1]), (t = f.exec(n)) && (u.test(t[1]) || c.test(t[1]) && !h.test(t[1])) && (n = t[1]), g.test(n) && u.test(n) && (n = n.slice(0, -1)), r && (n = "y" + n.slice(1)), n
}
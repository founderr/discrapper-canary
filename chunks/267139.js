    ...
    return (
        !(function e(t, i, a, s, o) {
            ...
            if (((_ = 0), (s = '' === s ? '.' : s + ':'), g(t)))
                ...
                if ('function' == typeof (h = null === (c = t) || 'object' != typeof c ? null : 'function' == typeof (c = (E && c[E]) || c['@@iterator']) ? c : null)) for (t = h.call(t), f = 0; !(d = t.next()).done; ) (h = s + L((d = d.value), f++)), (_ += e(d, i, a, h, o));

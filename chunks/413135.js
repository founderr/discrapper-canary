...
function c(e, t, n) {
    ...
    if (X(e, ArrayBuffer) || (e && X(e.buffer, ArrayBuffer)) || ('undefined' != typeof SharedArrayBuffer && (X(e, SharedArrayBuffer) || (e && X(e.buffer, SharedArrayBuffer))))) return p(e, t, n);
...
function h(e) {
    for (var t = e.length < 0 ? 0 : 0 | I(e.length), n = l(t), r = 0; r < t; r += 1) n[r] = 255 & e[r];
    return n;
}
function p(e, t, n) {
    var r;
...
function m(e) {
    ...
    if (void 0 !== e.length) return 'number' != typeof e.length || $(e.length) ? l(0) : h(e);
...
function v(e, t, n, r, i) {
    ...
    if (('string' == typeof n ? ((r = n), (n = 0)) : n > 2147483647 ? (n = 2147483647) : n < -2147483648 && (n = -2147483648), $((n = +n)) && (n = i ? 0 : e.length - 1), n < 0 && (n = e.length + n), n >= e.length)) {
        if (i) return -1;
        n = e.length - 1;
    } else if (n < 0) {
        if (!i) return -1;
    ...
    if (('string' == typeof t && (t = u.from(t, r)), u.isBuffer(t))) return 0 === t.length ? -1 : N(e, t, n, r, i);
    if ('number' == typeof t) {
...
(t.kMaxLength = o),
    ...
    (u.prototype.compare = function (e, t, n, r, i) {
        ...
        for (var a = i - r, o = n - t, s = Math.min(a, o), l = this.slice(r, i), c = e.slice(t, n), d = 0; d < s; ++d)
            if (l[d] !== c[d]) {
                (a = l[d]), (o = c[d]);
                break;
            }
...
function V(e, t, n, r, a) {
    return (t = +t), (n >>>= 0), !a && Z(e, t, n, 4, 3.4028234663852886e38, -3.4028234663852886e38), i.write(e, t, n, r, 23, 4), n + 4;
}
function H(e, t, n, r, a) {
    return (t = +t), (n >>>= 0), !a && Z(e, t, n, 8, 1.7976931348623157e308, -1.7976931348623157e308), i.write(e, t, n, r, 52, 8), n + 8;
}

var r = n(250683), i = n(932093), a = 'function' == typeof Symbol && 'function' == typeof Symbol.for ? Symbol.for('nodejs.util.inspect.custom') : null;
...
function l(e, t, n) {
    if ('string' == typeof e)
        return function (e, t) {
            ...
            var n = 0 | f(e, t), r = o(n), i = r.write(e, t);
    ...
    var i = function (e) {
        if (s.isBuffer(e)) {
            var t = 0 | E(e.length), n = o(t);
            return 0 === n.length ? n : (e.copy(n, 0, 0, t), n);
        }
        if (void 0 !== e.length)
            return 'number' != typeof e.length || function (e) {
                return e != e;
            }(e.length) ? o(0) : d(e);
...
function c(e) {
    return u(e), o(e < 0 ? 0 : 0 | E(e));
}
s.alloc = function (e, t, n) {
    var r, i, a;
    return r = e, i = t, a = n, (u(r), r <= 0) ? o(r) : void 0 !== i ? 'string' == typeof a ? o(r).fill(i, a) : o(r).fill(i) : o(r);
...
function d(e) {
    for (var t = e.length < 0 ? 0 : 0 | E(e.length), n = o(t), r = 0; r < t; r += 1)
        n[r] = 255 & e[r];
    return n;
}
function _(e, t, n) {
...
function h(e, t, n) {
    ...
    if ((void 0 === t || t < 0) && (t = 0), t > this.length)
        return '';
    if ((void 0 === n || n > this.length) && (n = this.length), n <= 0 || (n >>>= 0) <= (t >>>= 0))
        return '';
    for (!e && (e = 'utf8');;)
        switch (e) {
        case 'hex':
...
s.isBuffer = function (e) {
    ...
    if (b(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), b(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), !s.isBuffer(e) || !s.isBuffer(t))
    ...
    for (n = 0; n < e.length; ++n) {
        var a = e[n];
        if (b(a, Uint8Array) && (a = s.from(a)), !s.isBuffer(a))
            throw TypeError('"list" argument must be an Array of Buffers');
    ...
    if (b(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), !s.isBuffer(e))
    ...
    if (t >>>= 0, n >>>= 0, r >>>= 0, i >>>= 0, this === e)
        return 0;
    for (var a = i - r, o = n - t, l = Math.min(a, o), u = this.slice(r, i), c = e.slice(t, n), d = 0; d < l; ++d)
        if (u[d] !== c[d]) {
            a = u[d], o = c[d];
            break;
        }
...
s.prototype.write = function (e, t, n, r) {
    ...
    var i, a, o, s, l, u, c, d, _, E, f, h, p, m, I, T, g = this.length - t;
    ...
    for (var S = !1;;)
        ...
        case 'utf-8':
            ;
            return i = this, a = e, o = t, s = n, L(C(a, i.length - o), i, o, s);
        case 'ascii':
            ;
        ...
        case 'binary':
            return function (e, t, n, r) {
                var i, a, o, s;
                return i = e, a = t, o = n, s = r, L(y(a), i, o, s);
            }(this, e, t, n);
        case 'base64':
            ;
...
function g(e, t, n) {
    n = Math.min(e.length, n);
    for (var r = [], i = t; i < n;) {
        var a, o, s, l, u = e[i], c = null, d = u > 239 ? 4 : u > 223 ? 3 : u > 191 ? 2 : 1;
        if (i + d <= n)
            switch (d) {
            case 1:
                u < 128 && (c = u);
            ...
            case 2:
                ...
                break;
            case 3:
                a = e[i + 1], o = e[i + 2], (192 & a) == 128 && (192 & o) == 128 && (l = (15 & u) << 12 | (63 & a) << 6 | 63 & o) > 2047 && (l < 55296 || l > 57343) && (c = l);
                break;
            case 4:
                a = e[i + 1], o = e[i + 2], s = e[i + 3], (192 & a) == 128 && (192 & o) == 128 && (192 & s) == 128 && (l = (15 & u) << 18 | (63 & a) << 12 | (63 & o) << 6 | 63 & s) > 65535 && l < 1114112 && (c = l);
            }
...
function v(e, t, n, r, a) {
    return t = +t, n >>>= 0, !a && N(e, t, n, 4, 3.4028234663852886e+38, -3.4028234663852886e+38), i.write(e, t, n, r, 23, 4), n + 4;
}
function O(e, t, n, r, a) {
    return t = +t, n >>>= 0, !a && N(e, t, n, 8, 1.7976931348623157e+308, -1.7976931348623157e+308), i.write(e, t, n, r, 52, 8), n + 8;
}
s.prototype.slice = function (e, t) {
    ...
    if (!n && (n = 0), !r && 0 !== r && (r = this.length), t >= e.length && (t = e.length), !t && (t = 0), r > 0 && r < n && (r = n), r === n || 0 === e.length || 0 === this.length)
        return 0;
    if (t < 0)
    ...
    if (t >>>= 0, n = void 0 === n ? this.length : n >>> 0, !e && (e = 0), 'number' == typeof e)
        ...
        var o = s.isBuffer(e) ? e : s.from(e, r), l = o.length;
        if (0 === l)

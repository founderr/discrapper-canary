...
class et extends l.Component {
  renderTimePlayed() {
    ...
    return null == n || !(0, S.default)(t) || (0, m.default)(t) ? null : J(e = (0, I.default)(t) ? (0, i.jsx)($, {
      timestamps: n
    }) : (0, i.jsx)(U.default, {
      start: n.start,
      end: n.end,
...
es.Header = ea, es.Body = e => {
  ...
  } = e, E = l.useRef(null), h = (0, O.default)(s, !0);
  return (0, i.jsx)(ee, {
    children: (0, i.jsxs)("div", {
  ...
  let {
    ...
    onPreviewClick: r,
    guildId: o
  } = e, d = (0, u.useStateFromStores)([D.default], () => D.default.getChannel(l.channelId)), [f, E] = (0, v.useCanWatchStream)(d), h = (0, i.jsxs)(c.Clickable, {
    onClick: f ? r : void 0,
  ...
  }), _ = null !== (n = null === (t = (0, T.default)(a, l)) || void 0 === t ? void 0 : t.activityText) && void 0 !== n ? n : z.default.Messages.SHARING_SCREEN;
  return (0, i.jsxs)(ee, {
    children: [(0, i.jsxs)("div", {
  ...
  let {
    ...
    guildId: a,
    participants: s
  } = e, r = (0, g.default)(), [o, d] = l.useState(null), f = t.application_id;
  l.useEffect(() => {

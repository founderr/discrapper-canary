...
let E = e => ''.concat(e).length < 13 ? 1000 * e : e,
  f = e => {
let t = Date.now() / 1000;
return null != e.end ? h(t, E(e.end) / 1000) : null != e.start ? h(E(e.start) / 1000, t) : {
  hours: 0,
  minutes: 0,
  seconds: 0
};
...
return {
  ...
  T = (e, t) => (0, s.Z)(t) ? _.Z.Messages.ACTIVITY_REACTION_IMAGE_ALT_TEXT_SPOTIFY.format({
username: e.username,
song: t.details,
artist: t.state
  }) : t.type === d.IIU.PLAYING ? _.Z.Messages.ACTIVITY_REACTION_IMAGE_ALT_TEXT_PLAYING.format({
username: e.username,
activity: t.name
  }) : t.type === d.IIU.WATCHING ? _.Z.Messages.ACTIVITY_REACTION_IMAGE_ALT_TEXT_WATCHING.format({
username: e.username,
activity: t.name
  }) : t.type === d.IIU.LISTENING ? _.Z.Messages.ACTIVITY_REACTION_IMAGE_ALT_TEXT_LISTENING.format({
username: e.username,
activity: t.name
  }) : (0, l.Z)(t) || t.type === d.IIU.STREAMING ? _.Z.Messages.ACTIVITY_REACTION_IMAGE_ALT_TEXT_STREAMING.format({
username: e.username,
activity: t.name

...
var r = n(866442), i = n(726542), a = n(503438), o = n(802856), s = n(420660), l = n(168631), u = n(621853), c = n(981631), d = n(689938);
let _ = e => ''.concat(e).length < 13 ? 1000 * e : e, E = e => {
        let t = Date.now() / 1000;
        ...
        c.M7m.PS4,
        c.M7m.PS5
    ].includes(e.platform) ? i.Z.get(c.ABu.PLAYSTATION) : e.name === i.Z.get(c.ABu.LEAGUE_OF_LEGENDS).name ? i.Z.get(c.ABu.LEAGUE_OF_LEGENDS) : void (e.type === c.IIU.PLAYING), m = (e, t) => {
        var n;
        let i = u.Z.getUserProfile(e.id), [a, o] = null !== (n = null == i ? void 0 : i.themeColors) && void 0 !== n ? n : [], s = (0, l.V3)(a), c = null != o ? (0, r.Rf)(o) : t;
        return {
            color: c,
            theme: c === t ? 'dark' : s
        };

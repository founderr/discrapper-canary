...
function g(e) {
  let {
tab: t
  } = e, n = (0, u.d)(e => e.selectedPage === t, l.Z), s = a.useMemo(() => function(e) {
switch (e) {
  case E.F$.SERVERS:
  ...
  }(t), [t]), m = a.useMemo(() => (0, _.sm)(t), [t]), g = a.useCallback(() => {
switch ((0, o.j)(() => u.d.setState({
    selectedPage: t
  })), t) {
  case E.F$.QUESTS:

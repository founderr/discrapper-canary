...
function f(e, n) {
  ...
  return null == a || n.ownerId !== a.id || e.id === a.id || (null == n ? void 0 : n.isBroadcastChannel()) ? null : (0, r.jsx)(t.MenuItem, {
id: 'make-dm-owner',
color: 'danger',
label: c.Z.Messages.CHANGE_DM_OWNER,
action: () => {
  var s;
  return s = a, void(0, t.openModal)(a => (0, r.jsxs)(t.ConfirmModal, {

...
if ('stack' in e)
  ...
  let n = e.name || ((0, _.TX)(e) ? 'DOMError' : 'DOMException'),
    a = e.message ? `${ n }: ${ e.message }` : n;
...
synthetic: !0
  }), R) : (R = A(t, e, r, o), (0, i.Db)(R, `${ e }`, void 0), (0, i.EG)(R, {
synthetic: !0
  }), R);
}

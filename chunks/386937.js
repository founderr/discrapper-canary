...
class O extends a.Component {
  ...
  renderProgressBar(e) {
    let {
      ...
      guildId: n
    } = this.props, a = this.getSubscriptionCount();
  ...
  renderSubscribers() {
    ...
    return (0, s.jsxs)("div", {
      ...
      children: [(0, s.jsx)(h.Z, {
        ...
        children: p.Z.Messages.GUILD_SETTINGS_PREMIUM_GUILD_COUNT_SUBSCRIBERS.format({
          count: t
        })
      })]
    })
  ...
  render() {
    ...
    if (null == n) return (0, s.jsx)(u.Spinner, {
    ...
    return (0, s.jsx)("div", {
      children: (0, s.jsxs)("div", {
        className: R.content,
        children: [this.renderProgressBar(i), (0, s.jsxs)("div", {
          className: R.tiers,
          children: [0 === a ? this.renderTierNone() : this.renderSubscribers(), i.map((n, s, a) => t({
            tier: n,
            tiers: a,
            tierIndex: s,
  ...
  constructor(...e) {
    super(...e), f(this, "tierRefs", {}), f(this, "defaultTierRef", a.createRef()), f(this, "state", {
      ...
      for (let [t, a] of Object.entries(this.tierRefs)) {
        ...
        let {
          top: i
        } = a.getBoundingClientRect(), r = e > 0 ? L : 0;
        s[t] = i - n + 32 - r
      }
      this.setState({
        tierPositions: s
...
let A = c.ZP.connectStores([I.Z, N.default, T.Z, m.ZP], () => {

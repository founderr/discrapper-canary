...
var o, a = r(837512), u = r(213912), s = r(546870), c = r(660793), l = r(49287), f = r(946572), p = r(606166), h = r(680643), d = r(490540), g = r(316103), y = r(65183), v = y.List, m = y.Map, _ = y.OrderedSet, b = r(407734), S = r(45623), w = r(822274), k = r(710621), x = g('draft_tree_data_support'), C = RegExp('\r', 'g'), E = RegExp('\n', 'g'), D = RegExp('^\n', 'g'), O = RegExp('&nbsp;', 'g'), K = RegExp('&#13;?', 'g'), T = RegExp('&#8203;?', 'g'), M = [
        'bold',
        'bolder',
        '500',
        '600',
        ...
        'src',
        'width'
    ], L = (i(o = {}, p('public/DraftStyleDefault/depth0'), 0), i(o, p('public/DraftStyleDefault/depth1'), 1), i(o, p('public/DraftStyleDefault/depth2'), 2), i(o, p('public/DraftStyleDefault/depth3'), 3), i(o, p('public/DraftStyleDefault/depth4'), 4), o), R = m({
        b: 'BOLD',
        code: 'CODE',
        del: 'STRIKETHROUGH',
        em: 'ITALIC',
        ...
        return t.mapKeys(function (t, r) {
            ...
            void 0 !== r.aliasedElements && n.push.apply(n, r.aliasedElements), n.forEach(function (r) {
                void 0 === e[r] ? e[r] = t : 'string' == typeof e[r] ? e[r] = [
                    e[r],
                    t
                ] : e[r].push(t);
            });
        ...
        if (!w(t))
            return e;
        var r = t.style.fontWeight, n = t.style.fontStyle, i = t.style.textDecoration;
        ...
        return e.clear = function () {
            ...
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, e = n({
                    key: t.key || h(),
            ...
            for (var r = [], n = 0; n < t.length; n++) {
                var i, o, a = t[n], u = a.nodeName.toLowerCase();
                if ('body' === u || P(u)) {
                    this._trimCurrentText(), '' !== this.currentText && r.push(this._makeBlockConfig());
                    var s = this.currentDepth, c = this.wrapper;
                ...
                if (void 0 !== l) {
                    this._trimCurrentText(), '' !== this.currentText && r.push(this._makeBlockConfig());
                    var f = this.currentDepth, p = this.wrapper;
                    ...
                    var d = h(), g = this._toBlockConfigs(Array.from(a.childNodes), e);
            ...
            var t = this.currentText.length, e = t - this.currentText.trimLeft().length, r = this.currentText.trimRight().length, n = this.characterList.findEntry(function (t) {
            ...
            this._hoistContainersInBlockConfigs(t).forEach(function (t) {
                var r = e._extractTextFromBlockConfigs(t.childConfigs), i = r.text, o = r.characterList;
...
t.exports = function (t) {
    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : d, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : c, n = e(t = t.trim().replace(C, '').replace(O, ' ').replace(K, '').replace(T, ''));
    if (!n)
        return null;
    var i = N(r);

var r = function () {
    ...
    }(), i = n(464942), a = n(1108), o = n(144613), s = function (e) {
        function t(e) {
            !function (e, t) {
                if (!(e instanceof t))
        ...
        return !function (e, t) {
            ...
            },
            {
                key: 'onUpdate',
                value: function () {
                    var e = Date.now(), t = this._fromValue + this._velocity / (1 - this._deceleration) * (1 - Math.exp(-(1 - this._deceleration) * (e - this._startTime)));

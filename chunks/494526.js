        ...
        case 1:
            return (0, a.jsxs)(a.Fragment, {
                children: [
                    ...
                    null != i ? (0, a.jsx)(D, { children: i }) : (0, a.jsx)(x.DK, { children: T.intl.format(T.t['Qq+A6u'], {}) }),
                    (0, a.jsx)(g.Button, {
                        ...
                        onClick: () =>
                            (function (e) {
                                let t =
                                    N.isPlatformEmbedded && S.ZP.supportsFeature(A.eRX.WEBAUTHN)
        ...
        case 2: {
            ...
            return (0, a.jsxs)(a.Fragment, {
                children: [
                    ...
                    (0, a.jsx)(x.DK, { children: T.intl.format(T.t.Cbl5JC, { username: ''.concat(b.ZP.getUserTag(e)) }) }),
                    (0, a.jsx)(g.Button, {
        ...
        i = (0, d.e7)([I.default], () => I.default.getIsPasswordlessActive()),
        {
            ...
            return (
                ...
                o.useEffect(() => {
                    ...
                    let x = () => {
                        g ? ((g = !1), r.send(JSON.stringify({ op: 'heartbeat' }))) : (s('heartbeat timeout, reconnecting.'), r.close(), f());
                    };
                    return (
                        (r.onmessage = async (t) => {
                            let { data: n } = t,

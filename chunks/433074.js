...
function g(e) {
  ...
  }), x = (0, i.useStateFromStores)([E.default], () => E.default.getCurrentUser()), [D, y] = a.useState(!1), U = a.useCallback(e => {
    e && y(!0)
  ...
  }, [D, g, null == x ? void 0 : x.id, M.channel_id, P, M.author.id, v]), a.useEffect(() => {
  ...
  }, [D, P, R, M.author.id, M.channel_id]);
  let b = e => {

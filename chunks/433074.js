...
function g(e) {
  ...
  }), D = (0, i.useStateFromStores)([f.default], () => f.default.getCurrentUser()), [P, y] = l.useState(!1), U = l.useCallback(e => {
    e && y(!0)
  ...
  }, [P, g, null == D ? void 0 : D.id, M.channel_id, L, M.author.id, O]), l.useEffect(() => {

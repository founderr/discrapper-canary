...
var r = n(913527), i = n.n(r), a = n(81825), o = n(630388), s = n(973616), l = n(981631);
function u(e, t, n) {
...
class d extends a.Z {
    static createFromServer(e) {
        ...
        return new d({
            ...
            application: null != e.application ? s.Z.createFromServer(e.application) : null,
    ...
    getPrice() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null, t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], {price: n} = this;
        if (null == n)
            return null;
        if (null != e) {
            var r;

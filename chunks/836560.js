...
(e.exports = o), (e.exports.once = I), (o.EventEmitter = o), (o.prototype._events = void 0), (o.prototype._eventsCount = 0), (o.prototype._maxListeners = void 0);
var s = 10;
function l(e) {
...
function c(e, t, n, r) {
    ...
    else if (('function' == typeof s ? (s = o[t] = r ? [n, s] : [s, n]) : r ? s.unshift(n) : s.push(n), (a = u(e)) > 0 && s.length > a && !s.warned)) {
        s.warned = !0;
        var a,
            o,
            s,
            c = Error('Possible EventEmitter memory leak detected. ' + s.length + ' ' + String(t) + ' listeners added. Use emitter.setMaxListeners() to increase limit');
...
function E(e, t, n) {
    ...
    if (void 0 === r) return [];
    var i = r[t];
    return void 0 === i ? [] : 'function' == typeof i ? (n ? [i.listener || i] : [i]) : n ? m(i) : h(i, i.length);
}
function f(e) {
    var t = this._events;
    if (void 0 !== t) {
...
function I(e, t) {
    return new Promise(function (n, r) {
        ...
        g(e, t, a, { once: !0 }), 'error' !== t && T(e, i, { once: !0 });
    });
}
function T(e, t, n) {
...
Object.defineProperty(o, 'defaultMaxListeners', {
    ...
    (o.prototype.removeListener = function (e, t) {
        ...
        if (n === t || n.listener === t) 0 == --this._eventsCount ? (this._events = Object.create(null)) : (delete r[e], r.removeListener && this.emit('removeListener', e, n.listener || t));
            ...
            if (i < 0) return this;
            0 === i ? n.shift() : p(n, i), 1 === n.length && (r[e] = n[0]), void 0 !== r.removeListener && this.emit('removeListener', e, o || t);
        }
        return this;
    }),

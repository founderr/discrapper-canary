...
function c(e, t, n, r) {
  ...
  else if ("function" == typeof c ? c = o[t] = r ? [n, c] : [c, n] : r ? c.unshift(n) : c.push(n), (a = u(e)) > 0 && c.length > a && !c.warned) {
    c.warned = !0;
    var i, a, o, c, l = Error("Possible EventEmitter memory leak detected. " + c.length + " " + String(t) + " listeners added. Use emitter.setMaxListeners() to increase limit");
    l.name = "MaxListenersExceededWarning", l.emitter = e, l.type = t, l.count = c.length, i = l, console && console.warn && console.warn(i)
  }
  return e
}

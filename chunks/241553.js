...
function x(e) {
  ...
  return !n && o ? (0, i.jsx)(B, {}) : o && _ ? (0, i.jsx)(k, {
    isDark: (0, l.wj)(u),
    style: E
  }) : (0, i.jsx)(w, {
    boxColor: T.box,
...
t.Z = r.memo(function(e) {
  ...
  } = (0, E.ZP)(d.Z.GIFT_BUTTON), [l, c] = r.useState(!1), m = (0, o.e7)([f.Z], () => !(null === f.Z || void 0 === f.Z ? void 0 : f.Z.hasLayers())), O = (0, o.e7)([N.default], () => N.default.getCurrentUser()), R = null != O ? p.default.age(O.id) : 0, y = !t && m && R >= G, {
    enabled: U
  } = S.RO.useExperiment({
  ...
  let [w, k] = (0, T.U)(b), B = null != w, V = (0, g.Ft)(n), Z = null != V;
  if (t) return null;
  let H = () => {
      (0, h.Z)({
        isGift: !0,

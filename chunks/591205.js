...
let i = a(0, () => l.default.Messages.MAX_USES.format({
    maxUses: 0
  })),
  s = a(1, () => l.default.Messages.MAX_USES.format({
    maxUses: 1
  })),
  ...
  f = [i, s, r, u, d, o, c],
  E = a(1800, () => l.default.Messages.DURATION_MINUTES.format({
    minutes: 30
  })),
  I = a(3600, () => l.default.Messages.DURATION_HOURS.format({
    hours: 1
  })),

...
function e(e, t, r) {
  ...
  var i = e.match(S);
  for (var o in (this.at = i ? i[1] : 'unknown', this.query = r.name || '@' + this.at, this.options = r, this.rules = new F((0, n.Z)({}, r, {
      parent: this
    })), t))
...
function e(e, t, r) {
  ...
  var o = r.scoped,
    s = r.sheet,
    a = r.generateId;
  for (var u in (this.id = !1 === o ? this.name : b(a(this, s)), this.rules = new F((0, n.Z)({}, r, {
      parent: this
    })), t))
    this.rules.add(u, t[u], (0, n.Z)({}, r, {
      parent: this
    }));
  this.rules.process();
}

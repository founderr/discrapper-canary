...
return;
  let m = R.ZP.getShelfActivities(E),
I = (0, C.Z)({
  applicationId: i,
  activityConfigs: m
}),
...
participants: E,
embeddedActivity: f
  } = e, I = h.default.getId(), S = E.find(e => e.userId === I), A = p.Z.getChannel(s);
...
super(...e), x(this, 'handleSelectedChannelUpdate', () => {
  ...
  if (void 0 === o || f.tx.has(null == o ? void 0 : o.type) && I.Z.getVoiceChannelId() !== i)
    return;

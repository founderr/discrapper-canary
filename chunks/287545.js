  ...
  constructor(...e) {
    super(...e), B(this, "handleSelectedChannelUpdate", () => {
      ...
      for (let {
        ...
        of C.default.getSelfEmbeddedActivities().values())(0, U.default)(t) && t !== e && this.leaveActivity({
        channelId: t,
        applicationId: n
      });
      if (null != e) {

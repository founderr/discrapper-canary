...
}), F(this, 'handleConnectionInterrupted', e => {
  e.code === k.$VG.CLOSE_ABNORMAL && y.ZP.getSelfEmbeddedActivities().forEach(e => {
    let {
      channelId: t,
      applicationId: n
    } = e;

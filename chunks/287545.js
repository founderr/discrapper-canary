...
var i = n(512722), a = n.n(i), o = n(772848), s = n(544891), l = n(570140), u = n(475179), c = n(317770), d = n(728345), _ = n(812206), E = n(358221), f = n(42352), h = n(131704), p = n(314897), m = n(592125), I = n(19780), T = n(944486), g = n(594174), S = n(626135), A = n(585483), N = n(358085), v = n(24933), O = n(566620), R = n(317381), C = n(969345), y = n(148720), D = n(146936), L = n(782769), b = n(964517), M = n(761122), P = n(983695), U = n(917107), w = n(701488), x = n(981631), G = n(689938);
function k(e, t, n) {
...
function V(e) {
    var t;
    return { releasePhase: null == e ? void 0 : null === (t = e.activity) || void 0 === t ? void 0 : t.client_platform_config[(0, M.Z)((0, N.getOS)())].release_phase };
}
async function H(e) {
    let {
            channelId: t,
    ...
    if (null == i || null == o)
        return;
    let s = R.ZP.getShelfActivities(a), l = v.Z.getState().shelfOrder, u = 0 === R.ZP.getEmbeddedActivitiesForChannel(t).filter(e => e.applicationId === n).length, c = (0, C.Z)({
            applicationId: n,
            activityConfigs: s
        }), d = 1 + l.findIndex(e => e === n), {releasePhase: _} = V(c), h = await (0, f.Z)();
    F[n] = e => {
        var t, a, s;
...
async function Z(e) {
    ...
    if (null != a && null != o && null != E && await s.tn.post({
        ...
        return;
    let h = R.ZP.getShelfActivities(_), I = (0, C.Z)({
            applicationId: i,
            activityConfigs: h
        }), {releasePhase: T} = V(I), A = await (0, f.Z)();
...
function W(e, t, n, r, i, a) {
    var s, l;
    let c = R.ZP.getEmbeddedActivitiesForChannel(e), d = m.Z.getChannel(e);
    if (a && null !== (l = null == d ? void 0 : d.isPrivate()) && void 0 !== l && l && c.length <= 1 && null == i && u.Z.selectParticipant(e, null), null == i)
        return;
    let _ = I.Z.getMediaSessionId(), E = 'activity_id' in t ? (0, b.C)(t) : (0, b.Z)(t), f = null == _ && (null == d ? void 0 : d.isVocal()) === !0 && (null == d ? void 0 : d.isPrivate()) === !1;
...
function K(e) {
    ...
    if (null != n) {
        let e = R.ZP.getSelfEmbeddedActivityForChannel(n), r = null == e ? void 0 : e.applicationId, i = null == e ? void 0 : e.launchId, s = (0, b.Z)(e);
...
class q extends c.Z {
    ...
    constructor(...e) {
        super(...e), k(this, 'handleSelectedChannelUpdate', () => {
            ...
            if (null != e) {
                let t = R.ZP.getEmbeddedActivitiesForChannel(e), n = p.default.getId();
                t.forEach(e => {
                    if (e.userIds.has(n)) {
            ...
            let {channelId: t} = e, n = T.Z.getVoiceChannelId();
            ...
            let f = null !== (n = null == l ? void 0 : l.getGuildId()) && void 0 !== n ? n : void 0, {
                    activityConfigs: p,
                    applications: I
                } = await (0, O.w1)({ guildId: f }), g = (0, C.Z)({
                    applicationId: o,
                    activityConfigs: p,
                    applications: I
                });
            ...
            let S = R.ZP.getEmbeddedActivitiesForChannel(a).find(e => e.applicationId === o), A = null !== (r = null == S ? void 0 : S.userIds.size) && void 0 !== r ? r : 0;
            A > 0 ? (0, y.k)({
                channelId: a,
                applicationId: o,

...
var s = i(735250), l = i(470079), o = i(442837), t = i(481060), r = i(410575), a = i(727637), d = i(58540), c = i(420660), u = i(100527), I = i(906732), _ = i(580552), f = i(680295), E = i(199902), m = i(314897), S = i(158776), Z = i(594174), x = i(785717), v = i(621853), h = i(318661), p = i(726059), T = i(162267), g = i(502762), N = i(62154), C = i(293259), j = i(725954), A = i(228168), R = i(981631), O = i(689938), U = i(376234);
function M(e) {
    var n, i;
    let {
            user: l,
        ...
        children: (0, s.jsxs)(t.TabBar, {
            ...
            children: [
                ...
                l.bot || r ? null : (0, s.jsx)(t.TabBar.Item, {
                    ...
                    children: null == I ? O.Z.Messages.USER_PROFILE_MUTUAL_FRIENDS_PLACEHOLDER : O.Z.Messages.MUTUAL_FRIENDS_WITH_END_COUNT.format({ count: ''.concat(I) })
                }),
                r || l.isClyde() || (0, _.Z)(l.id) ? null : (0, s.jsx)(t.TabBar.Item, {
                    className: U.tabBarItem,
                    id: A.oh.MUTUAL_GUILDS,
                    children: null == f ? O.Z.Messages.USER_PROFILE_MUTUAL_GUILDS_PLACEHOLDER : O.Z.Messages.MUTUAL_GUILDS_WITH_END_COUNT.format({ count: ''.concat(f) })
                }),
...
function L(e) {
    ...
    let {
            ...
            onClose: G
        } = e, w = null !== (n = (0, o.e7)([Z.default], () => Z.default.getUser(v.id))) && void 0 !== n ? n : v, k = (0, h.ZP)(null !== (i = w.id) && void 0 !== i ? i : ''), {analyticsLocations: V} = (0, I.ZP)([
            ...B,
            u.Z.PROFILE_MODAL
        ]), Y = (0, x.Q1)({
            layout: 'MODAL',
    ...
    (0, d.$)({ [p]: [w.id] });
    let H = (0, o.e7)([E.Z], () => null != E.Z.getAnyStreamForUser(w.id)), W = (0, o.e7)([S.Z], () => S.Z.findActivity(w.id, e => e.type !== R.IIU.CUSTOM_STATUS)), [z, K] = l.useState(!1), [q, Q] = l.useState(!w.isNonUserBot() || w.isClyde() || (0, _.Z)(w.id) ? y : A.oh.MUTUAL_GUILDS), J = (0, o.e7)([m.default], () => m.default.getId() === w.id), X = null != W || H, $ = !J || X, ee = l.createRef(), en = (0, a.Z)(ee);

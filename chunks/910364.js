...
function U(e) {
  ...
  return (0, t.jsx)("div", {
    ...
    children: (0, t.jsxs)(l.TabBar, {
      ...
      onItemSelect: c,
      className: P.tabBar,
      children: [!o.isNonUserBot() || o.isClyde() || (0, E.Z)(o.id) ? (0, t.jsx)(l.TabBar.Item, {
        className: P.tabBarItem,
        id: M.oh.USER_INFO,
        children: j.Z.Messages.USER_INFO
      }) : null, !o.bot && d ? (0, t.jsx)(l.TabBar.Item, {
        className: P.tabBarItem,
        id: M.oh.ACTIVITY,
        children: j.Z.Messages.USER_PROFILE_ACTIVITY
      }) : null, o.bot || a ? null : (0, t.jsx)(l.TabBar.Item, {
        className: P.tabBarItem,
        ...
        children: null == _ ? j.Z.Messages.USER_PROFILE_MUTUAL_GUILDS_PLACEHOLDER : j.Z.Messages.MUTUAL_GUILDS_WITH_END_COUNT.format({
          count: "".concat(_)
        })
...
function L(e) {
  ...
  let {
    ...
    onClose: G
  } = e, k = null !== (n = (0, s.e7)([S.default], () => S.default.getUser(x.id))) && void 0 !== n ? n : x, w = (0, h.ZP)(null !== (i = k.id) && void 0 !== i ? i : ""), {
    analyticsLocations: Y
  } = (0, I.ZP)([...F, u.Z.PROFILE_MODAL]), V = (0, v.Q1)({
    layout: "MODAL",
    userId: k.id,
    showGuildProfile: !1,
    guildId: N,
  ...
  let H = (0, s.e7)([f.Z], () => null != f.Z.getAnyStreamForUser(k.id)),
    W = (0, s.e7)([m.Z], () => m.Z.findActivity(k.id, e => e.type !== A.IIU.CUSTOM_STATUS)),
    [z, K] = o.useState(!1),
    [Q, q] = o.useState(!k.isNonUserBot() || k.isClyde() || (0, E.Z)(k.id) ? y : M.oh.MUTUAL_GUILDS),
    J = (0, s.e7)([Z.default], () => Z.default.getId() === k.id),
    X = null != W || H,
    $ = !J || X,
    ee = o.createRef(),
    en = (0, r.Z)(ee);

...
function g() {
  ...
  return (a.useEffect(() => {
    ...
    t && (o.default.track(A.rMx.SAFETY_HUB_VIEWED, {
      account_standing: n.state
    }), r.Z.increment({
      name: s.V.SAFETY_HUB_VIEW
    }))
  }, [t]), e) ? (0, i.jsx)("div", {
    children: (0, i.jsx)(l.Spinner, {})
  }) : null != g ? (0, i.jsxs)(l.Notice, {
    color: l.NoticeColors.DANGER,
    className: N.nagbar,
    children: [I.Z.Messages.SAFETY_HUB_ERROR_MESSAGE, (0, i.jsx)(l.NoticeButton, {
      onClick: () => c.yq(),

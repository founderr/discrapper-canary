...
function S() {
  ...
  let T = window.GLOBAL_ENV.RELEASE_CHANNEL,
    _ = "300354",
    I = (e = "6d1076933a3c25c44216239deade6359b3b1a725", e.substring(0, 7)),
    ...
    A = [T, _, "(".concat(I, ")")];
  return null != N && (A.push("Host ".concat(N)), null != f && A.push(f.toLowerCase()), null != g && A.push("(".concat(g, ")"))), A.push("Build Override: ".concat(null != m ? m.id : "N/A")), null != C && A.push(C), (0, a.jsx)(d.CopiableField, {
    copyValue: A.join(" "),
    disableCopy: !1,

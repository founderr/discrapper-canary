    ...
    let S = (0, r.e7)(
            ...
            () =>
                !!l()(m.Z.getMessages(n.id).toArray())
                    .reverse()
                    .find((e) => e.author.id !== p.default.getId() && e.state === g.yb.SENT && !(0, C.Z)(e))
        ),
        v = (0, r.e7)([_.default], () => _.default.getUser(n.isPrivate() ? n.getRecipientId() : null)),
        Z = null !== (t = E.ZP.useName(v)) && void 0 !== t ? t : I.Z.Messages.WAVE_DEFAULT_RECIPIENT,

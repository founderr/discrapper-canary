...
var n = s(735250), a = s(470079), i = s(442837), r = s(481060), o = s(660216), l = s(40908), c = s(592125), d = s(984933), _ = s(430824), E = s(914010), u = s(285952), T = s(107828), I = s(727785), S = s(689938), N = s(284921);
function C() {
}
...
function h(e) {
    let {height: t} = e;
    return (0, n.jsx)('div', { style: { height: t } });
}
function g() {
    return (0, n.jsx)(h, { height: 16 }, 'footer');
}
function O() {
    return (0, n.jsx)(h, { height: 8 }, 'header');
}
function p() {
    return (0, n.jsx)('div', {
        ...
        children: (0, n.jsxs)(u.Z, {
            ...
            children: [
                (0, n.jsx)('div', {
                    ...
                    children: (0, n.jsx)(M, { channelId: c })
                }),
                (0, n.jsx)(u.Z.Child, {
                    grow: 0,
                    shrink: 0,
...
function x(e) {
    let {
            ...
            let e = a.useRef(!1), t = a.useCallback(() => {
                    e.current = !0;
                }, []), s = a.useCallback(() => {
                    e.current = !1;
                }, []);
            ...
            children: [
                ...
                (b > 0 || '' === M) && (0, n.jsx)(r.ListThin, {
                    ...
                    renderRow: function (e) {
                        ...
                        if (null == a)
                            return null;
                        let i = null != a.parent_id ? c.Z.getChannel(a.parent_id) : void 0, r = _.Z.getGuild(a.guild_id);
                        return (0, n.jsx)(T.$W, {
                            id: a.id,
                            channel: a,
                            category: i,

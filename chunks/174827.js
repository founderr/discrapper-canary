...
function G(e) {
  ...
  let {
    ...
    autoTrackExposure: !1
  }), eC = (0, a.useStateFromStores)([h.default], () => h.default.getCurrentUser()), ed = !er && null != Q && Q === B.PremiumSubscriptionSKUs.TIER_2 && null != eC && eC.hasHadPremium() && z && null == J && (0, C.isPaymentSourceEligibleForMultiMonthPlans)(eo), ec = (0, x.usePremiumTrialOffer)(K);
  ...
  let ep = !er && null != ec && null != Q && (0, B.SubscriptionTrials)[ec.trial_id].skus.includes(Q),
    ...
    eL = i.useMemo(() => (0, j.getPremiumPlanOptions)({
      ...
      defaultPlanId: et,
      defaultToMonthlyPlan: em
    }), [Q, en, eu, J, ed, er, ep, et, em]),
    eS = ex && eL.includes(B.SubscriptionPlans.PREMIUM_MONTH_TIER_2) ? B.SubscriptionPlans.PREMIUM_MONTH_TIER_2 : eL[0],
  ...
  let eg = eR && null == eA,
    ...
    eO = eE && null == eN || eg,
    eb = eE && null != eN || eR && null != eA,
    eU = eO && null == J && !!eE && (null == eM ? void 0 : eM.subscriptionPeriodEnd) == null || eg && (null == ej ? void 0 : ej.subscriptionPeriodEnd) == null,
    {
      enabled: ev
    ...
    eB = (0, m.useIsEligibleForBogoPromotion)() && !er && (null == eI ? void 0 : eI.skuId) === B.PremiumSubscriptionSKUs.TIER_2,
    eF = null;
  return (ek ? eF = (0, n.jsx)(L.default, {}) : eB && (eF = (0, n.jsx)(E.default, {})), eU) ? (0, n.jsx)(O.default, {}) : (l()(null != ee, "Step should be set"), l()(eL.length > 0, "Premium plan options should be set"), (0, n.jsxs)(n.Fragment, {

...
let M = () => {
    let e = (0, E.default)(),
      ...
      l = (0, c.useAgeSpecificText)(m.default.Messages.FAMILY_CENTER_ACCEPTED_REQUESTS_TITLE_TEEN.format(s), m.default.Messages.FAMILY_CENTER_ACCEPTED_REQUESTS_TITLE_PARENT.format(s));

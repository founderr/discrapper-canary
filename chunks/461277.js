...
Object.defineProperty(e, '__esModule', {
  value: !0
}), e.IntlManager = e.DEFAULT_LOCALE = void 0, e.createLoader = function(t, e) {
...
this.onLocaleChange = function(t) {
  return n._localeSubscriptions.add(t),
    function() {
      return n._localeSubscriptions.delete(t);
    };
}, this.defaultLocale = t, this.currentLocale = t, this.intl = (0, o.createIntl)({
  formats: a.IntlMessageFormat.formats,
  defaultLocale: t,
  locale: t
}), this.defaultRichTextElements = r, this._localeSubscriptions = new Set();
  }
  return t.prototype.setLocale = function(t) {
this.currentLocale = t, this.intl = (0, o.createIntl)({
...
var e, r;
try {
  for (var n = i(this._localeSubscriptions), o = n.next(); !o.done; o = n.next())
    (0, o.value)(t);
} catch (t) {
  e = {
    error: t
...
if ('string' == typeof t)
  return [t];
var r, o, s = 'function' == typeof t ? t(this.currentLocale) : t;
if ('string' == typeof s)
  return [s];

...
n.Z = {
  stringify: function(e, n) {
    ...
    switch (e.type) {
      ...
      case T.uaV.RECIPIENT_REMOVE:
        if (null == R) return;
        let G = e.author;
        if (null == G || G.id === R.id) return (0, s.Rp)(d.Z.Messages.SYSTEM_MESSAGE_RECIPIENT_REMOVE_SELF.astFormat({
          username: g,
          usernameOnClick: T.dG4
        }));
      ...
      case T.uaV.CALL:
        ...
        if (null != f && -1 === f.participants.indexOf(N.default.getId())) return (0, s.Rp)(d.Z.Messages.SYSTEM_MESSAGE_CALL_STARTED.astFormat({
          username: g,
          usernameOnClick: T.dG4
        }));
        return;
  ...
  getSystemMessageBotJoin: function(e) {
    return null == C[e] ? null : d.Z.Messages.SYSTEM_MESSAGE_GUILD_BOT_JOIN.format({
      learnOnClick: {

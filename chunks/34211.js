...
var n, i = a(735250), r = a(470079), l = a(948789), o = a(66037), s = a(248108), c = a(231338), d = a(330711);
function u(e, t, a) {
...
let p = c.j_.MAIN_NAVIGATION_MENU, h = (e, t) => [
        {
            route: c.am.DOWNLOAD,
...
class m extends (n = r.PureComponent) {
    render() {
        let e = (0, l.fQ)(this.context.router), {
                ...
                TrackClick: u,
                avoidRouter: m
            } = this.props, {sectionShown: N} = this.state;
    ...
    constructor(...e) {
        super(...e), u(this, 'state', { sectionShown: null }), u(this, 'closeSubNav', () => {

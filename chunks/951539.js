...
function h(e) {
    let [n, t, i, d] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [o.ZP, r.Z, c.Z, l.Z];
    if ((0, u.Z2)(e)) return !1;
    let { guild_id: g, channel_id: h } = e,
        f = e.entity_type === _.WX.EXTERNAL ? n.getDefaultChannel(e.guild_id) : t.getChannel(h),
        I = i.getGuild(g),
        m = d.getStageInstanceByChannel(h);
    return !!(0, a.b)(s.Z, I, f, m) && null != f && v(e, [t]);
}
function f(e) {
    return (0, i.e7)([o.ZP, r.Z, c.Z, l.Z], () => h(e, [o.ZP, r.Z, c.Z, l.Z]), [e]);
}

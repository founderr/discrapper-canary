...
function w(e) {
  let {
    showAnimations: t
  } = e, r = (0, l.useStateFromStores)([u.default], () => u.default.useReducedMotion), s = g();
  if (null == s) return;
  let {
...
let L = e => {
  ...
  y = () => {
    ...
    return s.useCallback(() => {
      null != e && !0 === e.showNotification && (r === a.DismissibleContent.TENURE_REWARD_REDEEMABLE || r === a.DismissibleContent.TENURE_REWARD_PENDING) && ((0, d.markDismissibleContentAsDismissed)(r), r === a.DismissibleContent.TENURE_REWARD_PENDING && !1 === n.current && (E.default.track(A.AnalyticEvents.USER_NITRO_TENURE_REWARD_ACKNOWLEDGED, {

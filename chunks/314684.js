...
function x(e) {
    ...
    let { redeemableInDays: a = 0, tenureRewardSkuId: r } = s,
        ...
        d = (100 * l) / o;
    return {
        initialPercentage: t && !n ? (100 * Math.max(l - 0.25 * o, 0)) / o : d,
        percentage: d
    };
}
let b = new Set();
    ...
    Z = () => {
        ...
        return s.useCallback(() => {
            null != e &&
                ...
                (n === o.z.TENURE_REWARD_REDEEMABLE || n === o.z.TENURE_REWARD_PENDING) &&
                ((0, d.EW)(n),
...
function D() {
    let { hasFetchedPremiumApplicationEntitlements: e, isFetchingPremiumApplicationEntitlements: t } = (0, i.cj)([I.Z], () => ({
        ...
        a = s.useRef(!1);
    s.useEffect(() => {
        !1 === e && !1 === t && !0 === n && !1 === a.current && (l.yD(A.CL), (a.current = !0));
    }, [e, t, n]);
}
function B() {
    var e;

...
var s = n(470079), a = n(913527), r = n.n(a), i = n(442837), l = n(704215), o = n(496929), c = n(607070), d = n(605236), _ = n(706140), u = n(243778), E = n(594174), T = n(314884), I = n(580130), R = n(626135), C = n(823379), p = n(111361), g = n(595878), A = n(944880), m = n(513785), N = n(106255), f = n(474936), S = n(735825), h = n(981631);
function M() {
    let e = function () {
            var e;
    ...
    return s.useMemo(() => {
        ...
        if (!(null != e && (0, N.u7)(e)))
            ...
            if (null == e.redeemable_at || null == e.next_tenure_reward_id)
                return null;
            let t = r()(e.redeemable_at).diff(r().utc(), 'days'), s = null != e.redeemable_in_ms ? Math.ceil(r().duration(e.redeemable_in_ms).asDays()) : t;
            if (t < 0)
                return null;
            let a = !1, i = !1;
...
function x(e) {
    let {showAnimations: t} = e, n = (0, i.e7)([c.Z], () => c.Z.useReducedMotion), s = M();
    if (null == s)
        return;
    let {
...
function B() {
    var e;
    D();
    let t = M(), n = null !== (e = null == t ? void 0 : t.showCard) && void 0 !== e && e;
    s.useEffect(() => {

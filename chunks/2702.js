...
var a = s(735250), n = s(470079), l = s(120356), i = s.n(l), o = s(512722), r = s.n(o), u = s(954955), c = s.n(u), d = s(278074), m = s(442837), _ = s(481060), E = s(809206), p = s(219496), x = s(575681), b = s(807369), h = s(180529), I = s(25990), N = s(594174), R = s(154921), S = s(74538), f = s(981631), M = s(689938), C = s(823800), g = s(838009);
let v = e => {
    let {
        usernameStatus: t,
        showHint: s
            ...
            (0, a.jsxs)(_.ModalHeader, {
                ...
                children: [
                    ...
                    (0, a.jsx)(_.Text, {
                        ...
                        children: M.Z.Messages.USER_SETTINGS_ACCOUNT_CHANGE_USERNAME_PROMPT_DESKTOP
                    }),
                            ...
                            (0, a.jsx)(_.FormItem, {
                                ...
                                children: (0, a.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, a.jsx)(_.TextInput, {
                                            name: 'username',
                                            'aria-label': M.Z.Messages.USER_SETTINGS_LABEL_USERNAME,
                                            value: A,
                                            maxLength: f.l$U,
                                            onChange: L,
                                            onFocus: () => W(!0),
                                            ...
                                            inputClassName: i()(C.multiInputField, { [C.lowercase]: o.isPomelo() })
                                        }),
                                        !o.isPomelo() && (0, a.jsx)(_.TextInput, {
                                            name: 'discriminator',
                                            'aria-label': M.Z.Messages.USER_SETTINGS_LABEL_DISCRIMINATOR,
                                            maxLength: 4,
                                            value: j,
                                            onChange: B,
                                            onFocus: () => W(!0),

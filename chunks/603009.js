...
function b(e) {
  ...
  let {
    ...
    onConfirm: o,
    onDismiss: p
  } = e, [m, _] = a.useState(!1), E = a.useRef(null), C = (0, g.Cc)(n.id), T = (0, d.ZP)(), S = (0, u.e7)([h.Z], () => h.Z.useReducedMotion), Z = (0, I.nP)(null == C ? void 0 : null === (t = C.branding) || void 0 === t ? void 0 : t.primaryColor, [c.tokens.colors.BG_BRAND, .5]), b = c.tokens.colors.BG_SURFACE_OVERLAY.resolve({
    theme: T,
    saturation: 1
  }).hex(), R = (0, I.nj)(Z, b, "top left", .3, "30%"), j = (0, u.e7)([f.default], () => {
    var e;
  ...
  let L = a.useCallback(e => {
    ...
    U = y ? A.Z.Messages.CLAN_USER_ADOPT_TAG_NEW_IDENTITY_ARIA_LABEL.format({
      guildName: n.name

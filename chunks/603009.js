...
function b(e) {
  ...
  let {
    ...
    onConfirm: o,
    onDismiss: p
  } = e, [m, _] = a.useState(!1), E = a.useRef(null), g = (0, C.Cc)(n.id), T = (0, d.ZP)(), S = (0, u.e7)([h.Z], () => h.Z.useReducedMotion), Z = (0, I.nP)(null == g ? void 0 : null === (t = g.branding) || void 0 === t ? void 0 : t.primaryColor, [c.tokens.colors.BG_BRAND, .5]), b = c.tokens.colors.BG_SURFACE_OVERLAY.resolve({
    theme: T,
    saturation: 1

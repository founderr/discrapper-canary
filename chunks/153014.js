...
function et(e) {
  let {
    stageInstance: t,
    channel: n
  } = e, a = (0, r.useStateFromStoresArray)([h.default], () => [...new Set(h.default.getMutableParticipants(n.id, _.StageChannelParticipantNamedIndex.SPEAKER).map(e => e.user))], [n.id]), s = (0, r.useStateFromStores)([h.default], () => h.default.getParticipantCount(n.id, _.StageChannelParticipantNamedIndex.AUDIENCE), [n.id]), l = K.default.Messages.LISTENING_COUNT.format({
    count: "".concat(s)
  });
  return (0, i.jsx)(q, {
    onClickCloseIcon: () => (0, x.hideLiveChannelNotice)({
    ...
    locationIcon: (0, i.jsx)(v.default, {
      width: 16,
      height: 16,
      className: z.stageIcon
    }),
...
function en(e) {
  let {
    ...
    speakers: n,
    voiceType: a
  } = e, s = t.getGuildId(), u = l.useMemo(() => n.slice(0, 3), [n]), d = (0, r.useStateFromStores)([m.default], () => m.default.can(W.Permissions.CONNECT, t)), c = (0, S.default)(t.id), f = K.default.Messages.JOIN;
  switch (a) {
    case 1:
...
var ea = l.memo(function(e) {
  ...
  } = (0, d.useChannelNoticeRedesignExperiment)(!0), a = (0, w.useActiveEventOrStageInstanceChannel)(t.id), s = (0, F.useGuildActiveEvent)(t.id), l = (0, F.useGuildUpcomingEventsNotice)(t.id), {
  ...
  null == s || E ? _ && (h = (0, i.jsx)(et, {
    stageInstance: u,
    channel: a
  })) : s.entity_type === Y.GuildScheduledEventEntityTypes.STAGE_INSTANCE && _ ? h = (0, i.jsx)(et, {
    stageInstance: u,
    channel: a
  }) : s.entity_type === Y.GuildScheduledEventEntityTypes.EXTERNAL ? h = (0, i.jsx)(J, {
    guildEvent: s
  }) : s.entity_type === Y.GuildScheduledEventEntityTypes.VOICE && null != a && (h = (0, i.jsx)(Q, {
    guildEvent: s,
    channel: a
  }));

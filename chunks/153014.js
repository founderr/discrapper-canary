...
function en(e) {
  let {
    ...
    speakers: n,
    voiceType: a
  } = e, s = t.getGuildId(), u = i.useMemo(() => n.slice(0, 3), [n]), d = (0, r.useStateFromStores)([m.default], () => m.default.can(W.Permissions.CONNECT, t)), c = (0, I.default)(t.id), f = K.default.Messages.JOIN;
  switch (a) {
    case 1:

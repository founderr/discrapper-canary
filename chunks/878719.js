...
return 'code' in t && (l.tags = {
  ...l.tags,
  'DOMException.code': `${ t.code }`
}), l;
  }
  return (0, o.VZ)(t) ? c(e, t) : (0, o.PO)(t) || (0, o.cO)(t) ? (l = function(e, t, r, i) {
let _ = (0, n.s3)(),
...
if (r) {
  let t = I(e, r);
  t.length && (R.exception.values[0].stacktrace = {
    frames: t
  });
}
return R;
...
synthetic: !0
  }), l) : (l = T(e, t, r, _), (0, i.Db)(l, `${ t }`, void 0), (0, i.EG)(l, {
synthetic: !0
  }), l);
}

...
var r, i, a = n(470079), o = n(399606), s = n(597688), l = n(1870), u = n(884697), c = n(594174), d = n(74538), _ = n(689938);
(i = r || (r = {})).PURCHASE = 'purchase', i.PREMIUM_PURCHASE = 'premium_purchase', i.PREVIEW = 'preview', i.PREMIUM_PREVIEW = 'premium_preview';
let E = { id: 'None' }, f = { id: 'Shop' };
t.ZP = () => {
    let e = (0, o.e7)([c.default], () => c.default.getCurrentUser()), t = d.ZP.canUseCollectibles(e), n = (0, o.e7)([l.Z], () => l.Z.purchases), [r, i] = (0, o.Wu)([s.Z], () => [
            s.Z.categories,
            s.Z.products
        ]);
    return (0, a.useMemo)(() => {
        let e = (0, u.iC)(n, r).reduce((e, r) => {
            let a = n.get(r.skuId), o = (0, u.qS)(a);

...
var r, i, a, o, s, l, u = n(512722), c = n.n(u), d = n(442837), _ = n(759174), E = n(570140), f = n(308636);
function h(e) {
...
let T = new _.h(e => [
    ...
    ], e => e.id), S = {}, A = new Set(), N = {}, v = {}, O = {}, R = {}, C = new Map();
function y(e) {
    return T.values(h(e));
}
function D(e) {
    var t;
    for (let n of (T.set(e.id, e), C.set(e.guild_id, e.application_id), null !== (t = e.subscription_listings) && void 0 !== t ? t : []))
        L(n);
}
function L(e) {
    g.set(e.id, e);
...
l = 'GuildRoleSubscriptionsStore', (s = 'displayName') in (o = M) ? Object.defineProperty(o, s, {
    ...
    GUILD_ROLE_SUBSCRIPTIONS_FETCH_LISTINGS: function (e) {
        let {guildId: t} = e;
        for (let e of (S[t] = 1, y(t)))
            for (let t of (T.delete(e.id), e.subscription_listings_ids))
                g.delete(t);
    },
    GUILD_ROLE_SUBSCRIPTIONS_FETCH_LISTINGS_SUCCESS: function (e) {
        ...
        for (let e of (S[t] = 2, n))
            D(e);
        for (let e of (N[t] = r, i))
            v[e.id] = e;
    },

...
function M(e) {
  let {
    ...
    switch (e.field_type) {
      case o.VerificationFormFieldTypes.TERMS:
        return (0, l.jsx)(E.TermsFormField, {
          channelId: r,
          formField: e,
          onChange: (e, s) => d(t, s)
        }, t);
      case o.VerificationFormFieldTypes.TEXT_INPUT:
        return (0, l.jsx)(f.TextInputFormField, {
          formField: e,
          onChange: e => u(t, e)
        }, t);
      case o.VerificationFormFieldTypes.PARAGRAPH:
        return (0, l.jsx)(I.ParagraphFormField, {
          formField: e,
          onChange: e => u(t, e)
        }, t);
      case o.VerificationFormFieldTypes.MULTIPLE_CHOICE:
...
function R(e) {
  let {
    ...
    formFields: s,
    updateFormFields: n
  } = e, a = (0, i.useStateFromStores)([r.default], () => r.default.getCurrentUser()), o = (0, d.useIsPhoneVerificationLevel)({
    guildId: t
  }) ? m.PreviewPhoneRequirementFormField : u.PreviewEmailRequirementFormField;
  return null == a ? null : (0, l.jsxs)(l.Fragment, {
    children: [(0, l.jsx)(o, {}), (0, l.jsx)(M, {
      guildId: t,
      formFields: s,
      updateFormFields: n
    })]
...
function _(e) {
  let {
    ...
    formFields: s,
    updateFormFields: a
  } = e, o = (0, i.useStateFromStores)([r.default], () => r.default.getCurrentUser()), {
  ...
  return null == o ? null : (0, l.jsxs)(l.Fragment, {

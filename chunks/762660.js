...
var a = n(735250), t = n(470079), r = n(120356), l = n.n(r), i = n(913527), o = n.n(i), c = n(481060), d = n(239091), u = n(598077), I = n(768581), E = n(693546), _ = n(246364), T = n(689938), N = n(425415);
function C(e) {
    let {
        icon: s,
        onClick: n,
...
function R(e) {
    ...
    let P = t.useMemo(() => new u.Z(h), [h]), g = I.ZP.getUserAvatarURL(P), b = s === _.wB.SUBMITTED, j = t.useCallback(async (e, s) => {
            let {
                guildId: n,
                userId: a
            } = e;
    ...
    return (0, a.jsxs)(c.Clickable, {
        ...
        children: [
            ...
            (0, a.jsx)(c.Clickable, {
                className: l()(N.overflowMenuContainer, { [N.disabled]: null != A }),
                onClick: e => {
                    (0, d.jW)(e, async () => {
...
function M() {
    let e = ''.concat(Math.floor(50 * Math.random()) + 100, 'px'), s = ''.concat(Math.floor(25 * Math.random()) + 50, 'px');
    return (0, a.jsxs)('div', {

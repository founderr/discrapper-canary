...
function u(e, t) {
  ...
  return null != i && new Date().getTime() - i.getTime() < s.default.Millis.WEEK && !(0, o.hasFlag)(null != t ? t : 0, l.GuildMemberFlags.COMPLETED_HOME_ACTIONS)
}
...
function d(e) {
  return (0, i.useStateFromStores)([a.default, r.default], () => {
    ...
    let i = a.default.getSelfMember(e);

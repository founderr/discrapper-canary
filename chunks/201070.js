...
async function b(e) {
  var t, n, r, i, a;
  let o = g.Z.getSearchStateByGuildId(e),
...
[_, E] = function(e, t, n) {
  ...
  let u = function(e, t) {
      ...
      } = C(A(e)), s = t.currentPage, l = null !== (n = null == o ? void 0 : o.currentPage) && void 0 !== n ? n : 0, u = g.Z.getElasticSearchPaginationByGuildId(e);
      switch (!0) {
        case null == u:
        case r === a && 0 === r:
          return 0;
  ...
  o && (c.unusual_dm_activity_until = {
    range: {
      gte: Date.now() - I.rL
    }
  }), s && (c.communication_disabled_until = {
    range: {
      gte: Date.now()
    }
...
await (0, T.D)(e, D.query, {
  signal: null !== (r = null === (n = D.abortController) || void 0 === n ? void 0 : n.signal) && void 0 !== r ? r : void 0
});
  } catch (e) {
if (-1 === e.code)
  return;

...
[_, E] = function(e, t, n) {
  ...
  let u = function(e, t) {
      ...
      } = C(A(e)), o = t.currentPage, l = null !== (n = null == s ? void 0 : s.currentPage) && void 0 !== n ? n : 0, u = g.Z.getElasticSearchPaginationByGuildId(e);
      switch (!0) {
        case null == u:
        case r === a && 0 === r:
          return 0;
...
v = null !== (t = s.selectedSort) && void 0 !== t ? t : I.d$.ORDER_BY_GUILD_JOINED_AT_DESC;
  if (function(e, t) {
  let n = C(e);
  return l()(n.query, t);

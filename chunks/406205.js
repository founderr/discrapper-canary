...
var n = t(735250), i = t(470079), l = t(120356), a = t.n(l), r = t(399606), o = t(481060), d = t(92114), c = t(9156), u = t(621600), h = t(113449), N = t(748756), S = t(732760), E = t(686660), m = t(981631), g = t(490897), _ = t(526761), T = t(689938), x = t(147960), I = t(650455);
let O = () => [
    {
...
function C(e) {
    let {guildId: s} = e, t = (0, r.e7)([c.ZP], () => c.ZP.getGuildFlags(s)), l = (0, r.e7)([c.ZP], () => {
            let e = c.ZP.getGuildUnreadSetting(s), t = c.ZP.getMessageNotifications(s);
            return e === g.i.UNSET ? t === m.bL.ALL_MESSAGES ? g.i.ALL_MESSAGES : g.i.ONLY_MENTIONS : e;
        }), a = (0, r.e7)([c.ZP], () => c.ZP.getMessageNotifications(s)), [I, C] = (0, i.useState)(!1), v = I ? E.s8.CUSTOM : (0, E.gs)(l, a), L = e => {
            if (e === E.s8.CUSTOM) {
                C(!0);
                return;
            }
                    ...
                    (0, n.jsxs)('div', {
                        ...
                        children: [
                            (0, n.jsx)(o.SingleSelect, {
                                ...
                                className: x.input,
                                onChange: e => {
                                    C(!1), d.Z.updateGuildNotificationSettings(s, { flags: (0, h.Q4)(t, e === g.i.ALL_MESSAGES ? _.vc.UNREADS_ALL_MESSAGES : _.vc.UNREADS_ONLY_MENTIONS) }, u.UE.unreads(e));
                                },
                                options: (0, S.y)({ notificationSetting: a }),
                                renderOptionLabel: e => {
                                    let s = e.disabled && e.value === g.i.ONLY_MENTIONS && l !== g.i.ONLY_MENTIONS;
                            ...
                            (0, n.jsx)(o.SingleSelect, {
                                ...
                                onChange: e => {
                                    ...
                                    e === m.bL.ALL_MESSAGES && l !== g.i.ALL_MESSAGES && (t.flags = (0, h.Q4)(c.ZP.getGuildFlags(s), _.vc.UNREADS_ALL_MESSAGES)), d.Z.updateGuildNotificationSettings(s, t, u.UE.notifications(e));
                                },
                                options: (0, S.d)({ notificationSetting: a }),
                                renderOptionLabel: e => {
                                    let s = e.value === m.bL.ALL_MESSAGES && l !== g.i.ALL_MESSAGES && a !== m.bL.ALL_MESSAGES;
                                    return (0, n.jsxs)(n.Fragment, {
                                        children: [
                                            (0, n.jsx)(o.Text, {
                                                variant: 'text-md/normal',
...
function M(e) {
    ...
    return s === g.i.ALL_MESSAGES && (t[1].muted = !1), (0, n.jsx)('div', {
...
function p(e) {
    return (0, n.jsxs)('div', {
        ...
        children: [
            e.notificationSetting === m.bL.NO_MESSAGES && (0, n.jsx)('div', { className: x.mockMessageDisabled }),
            (0, n.jsx)('div', {
            ...
            (0, n.jsxs)('div', {
                children: [
                    ...
                    e.notificationSetting === m.bL.ALL_MESSAGES && (0, n.jsx)(o.Text, {
                        variant: 'text-xs/normal',
                        color: 'text-muted',
                        children: T.Z.Messages.NOTIFICATION_SETTINGS_PRESETS_NOTIFICATION_MESSAGE
                    }),
                    e.notificationSetting !== m.bL.ALL_MESSAGES && (0, n.jsxs)(n.Fragment, {
                        children: [
                            (0, n.jsxs)(o.Text, {
                                variant: 'text-xs/normal',
                                color: 'text-link',

...
t = 0, n = function () {
    var e, t, n, r, i, a, o, s, l = /\r\n?/g, u = /\t/g, c = /\f/g, d = function (e) {
            ...
            r.sort(function (t, n) {
                var r = e[t], i = e[n], a = r.order, o = i.order;
                if (a !== o)
                    return a - o;
                var s = r.quality ? 0 : 1, l = i.quality ? 0 : 1;
                if (s !== l)
                    return s - l;
                if (t < n)
                    return -1;
            ...
            for (var i = new Map(), a = [], o = 0; o < r.length; o++) {
                var s = r[o], l = e[s].requiredFirstCharacters;
                null == l ? a.push(s) : l.map(e => {
            ...
            var u = function (t, o) {
                    var s = [];
                    for (n = o = o || n; t;) {
                        for (var l = null, c = null, d = null, _ = -100000, E = 100000, f = [
                                    i.get(t.charCodeAt(0)),
                                    a
                                ], h = 0; h < f.length; h++) {
                            var p = f[h];
                            if (null != p)
                                for (var m = 0; m < p.length; m++) {
                                    var I = p[m], T = e[I], g = T.order;
                                    if (g > E)
                                        break;
                                    var S = null == o.prevCapture ? '' : o.prevCapture[0], A = T.match(t, o, S);
                                    if (A) {
                                        var N = T.quality ? T.quality(A, o, S) : 0;
                        ...
                        var v = c.parse(d, u, o);
                        Array.isArray(v) ? Array.prototype.push.apply(s, v) : (null == v.type && (v.type = l), s.push(v)), o.prevCapture = d, t = t.substring(o.prevCapture[0].length);
                    }
                    return s;
                }, c = function (e, r) {
            ...
            return t.regex = e, t;
        }, m = 'function' == typeof Symbol && Symbol.for && Symbol.for('react.element') || 60103, I = function (e, t, n) {
            return {
                $$typeof: m,
                type: e,
                key: null == t ? void 0 : t,
            ...
            for (var a in n = n || {}) {
                var o = n[a];
                Object.prototype.hasOwnProperty.call(n, a) && o && (i += ' ' + v(a) + '="' + v(o) + '"');
            }
            var s = '<' + e + i + '>';
            return r ? s + t + '</' + e + '>' : s;
        }, g = {}, S = function (e) {
            ...
            return {};
        }, L = '(?:[*+-]|\\d+\\.)', b = '( *)(' + L + ') +', M = RegExp('^' + b), P = RegExp(b + '[^\\n]*(?:\\n(?!\\1' + L + ' )[^\\n]*)*(\n|$)', 'gm'), U = /\n{2,}$/, w = /^ (?= *`)|(` *) $/g, x = / *\n+$/, G = RegExp('^( *)(' + L + ') [\\s\\S]+?(?:\n{2,}(?! )(?!\\1' + L + ' )\\n*|\\s*\n*$)'), k = /(?:^|\n)( *)$/;
    var B = (e = /^ *\| *| *\| *$/g, t = / *$/, n = /^ *-+: *$/, r = /^ *:-+: *$/, i = /^ *:-+ *$/, a = function (e) {
            if (n.test(e))
                return 'right';
            if (r.test(e))
                return 'center';
            ...
            parseTable: (s = function (t) {
                return function (n, r, i) {
                    i.inline = !0;
                    var s, l, u, c, d, _, E, f = o(n[1], r, i, t);
                    var h = (s = n[2], l = 0, u = 0, t && (s = s.replace(e, '')), s.trim().split('|').map(a));
                    var p = (c = n[3], d = r, _ = i, E = t, c.trim().split('\n').map(function (e) {
                        return o(e, d, _, E);
                    }));
                    return i.inline = !1, {
                        type: 'table',
            ...
            TABLE_REGEX: /^ *(\|.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/,
            NPTABLE_REGEX: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/
        }), F = '(?:\\[[^\\]]*\\]|[^\\[\\]]|\\](?=[^\\[]*\\]))*', V = '\\s*<?((?:\\([^)]*\\)|[^\\s\\\\]|\\\\.)*?)>?(?:\\s+[\'"]([\\s\\S]*?)[\'"])?\\s*', H = /mailto:/i, Z = function (e, t, n) {
    ...
    var j = 0, W = {
                    ...
                    for (var r = n.key, i = [], a = 0, o = 0; a < e.length; a++, o++) {
                        ...
                        if ('text' === s.type)
                            for (s = {
                                    type: 'text',
                                    content: s.content
                                }; a + 1 < e.length && 'text' === e[a + 1].type; a++)
                    ...
                    for (var r = '', i = 0; i < e.length; i++) {
                        ...
                        if ('text' === a.type)
                            for (a = {
                                    type: 'text',
                                    content: a.content
                                }; i + 1 < e.length && 'text' === e[i + 1].type; i++)
            ...
            codeBlock: {
                ...
                html: function (e, t, n) {
                    var r = e.lang ? 'markdown-code-' + e.lang : void 0, i = T('code', v(e.content), { class: r });
                    return T('pre', i);
                }
            },
            fence: {
            ...
            list: {
                order: j++,
                match: function (e, t) {
                    var n = null == t.prevCapture ? '' : t.prevCapture[0], r = k.exec(n), i = t._list || !t.inline;
                    return r && i ? (e = r[1] + e, G.exec(e)) : null;
                },
                parse: function (e, t, n) {
                    var r = e[2], i = r.length > 1, a = i ? +r : void 0, o = e[0].replace(U, '\n').match(P), s = !1;
                    return {
                        ordered: i,
                        start: a,
                        items: o.map(function (e, r) {
                            var i, a = M.exec(e), l = RegExp('^ {1,' + (a ? a[0].length : 0) + '}', 'gm'), u = e.replace(l, '').replace(M, ''), c = r === o.length - 1, d = -1 !== u.indexOf('\n\n') || c && s;
                            s = d;
                            var _ = n.inline, E = n._list;
            ...
            def: {
                ...
                match: h(/^ *\[([^\]]+)\]: *<?([^\s>]*)>?(?: +["(]([^\n]+)[")])? *\n(?: *\n)*/),
                parse: function (e, t, n) {
                    var r = e[1].replace(/\s+/g, ' ').toLowerCase(), i = e[2], a = e[3];
            ...
            table: {
                ...
                react: function (e, t, n) {
                    ...
                    return I('table', n.key, {
                        children: [
                            I('thead', 'thead', { children: I('tr', null, { children: i }) }),
                            I('tbody', 'tbody', { children: a })
                        ]
                    });
                },
                html: function (e, t, n) {
                    var r = function (t) {
                        ...
                        }).join(''), a = e.cells.map(function (e) {
                            var i = e.map(function (e, i) {
                                return T('td', t(e, n), { style: r(i) });
                            }).join('');
                            return T('tr', i);
                        }).join(''), o = T('thead', T('tr', i)), s = T('tbody', a);
                    return T('table', o + s);
                }
            },
            newline: {
            ...
            if (!t)
                throw Error('simple-markdown: outputFor: `property` must be defined. if you just upgraded, you probably need to replace `outputFor` with `reactFor`');
            var r, i = (e.Array || W.Array)[t];
            if (!i)
                throw Error('simple-markdown: outputFor: to join nodes of type `' + t + '` you must provide an `Array:` joiner rule with that type, Please see the docs for details on specifying an Array rule.');
            var a = function (n, o) {
        ...
        }, z = E(W), q = function (e, t) {
            return (t = t || {}).inline = !1, z(e, t);
        }, Q = function (e, t) {
            var n = U.test(e);
            return (t = t || {}).inline = !n, z(e, t);
        }, X = K(W, 'react'), $ = K(W, 'html'), J = function (e, t) {
            return X(q(e, t), t);
        };
    return {
        defaultRules: W,
        ...
        ruleOutput: function (e, t) {
            return !t && 'undefined' != typeof console && console.warn('simple-markdown ruleOutput should take \'react\' or \'html\' as the second argument.'), function (n, r, i) {

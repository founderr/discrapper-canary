...
let L = function (e, t) {
            ...
            return (
                ...
                l.ZP.categories.reduce((t, r) => {
                    if (r === A.UX.TOP_GUILD_EMOJI) {
                        ...
                        let { emojisDisabled: n, emojisUnfiltered: i } = c(e === R.Hz.REACTION && (_ || p) ? o : a, !0);
    ...
    b = (e, t, n, r, i) => {
        o.ZP.trackWithMetadata(N.rMx.SEARCH_RESULT_VIEWED, {
            search_type: null != i && i === R.Hz.REACTION ? N.aib.EMOJI_REACTION : N.aib.EMOJI,
            total_results: e,
    ...
    M = (e) => {
        ...
        let { emoji: i, emojiSuggestions: s, searchQuery: l, isLocked: u, location: c, intention: d, index: _ } = e,
            ...
            f = (0, a.EQ)(d)
                .with(R.Hz.REACTION, () => N.aib.EMOJI_REACTION)
                .with(R.Hz.AUTO_SUGGESTION, () => N.aib.EMOJI_AUTO_SUGGESTION)
...
function W(e, t) {
    return e === R.Hz.REACTION ? (t ? C.Z.Messages.SEARCH_FOR_SUPER_REACTION : C.Z.Messages.SEARCH_FOR_REACTION) : C.Z.Messages.SEARCH_FOR_EMOJI;
}

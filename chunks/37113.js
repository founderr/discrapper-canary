...
p(1440)
  ...
  T = e => 0 === e ? d.Z.Messages.SCREENSHARE_SOURCE : d.Z.Messages.SCREENSHARE_RESOLUTION_ABBREVIATED.format({
resolution: e
  }),
  g = [
p(480, () => T(480)),
...
p(60)
  ...
  A = [
p(15, () => d.Z.Messages.STREAM_FPS_OPTION.format({
  value: 15
})),
p(30, () => d.Z.Messages.STREAM_FPS_OPTION.format({
  value: 30
})),
p(60, () => d.Z.Messages.STREAM_FPS_OPTION.format({
  value: 60
}))
  ];
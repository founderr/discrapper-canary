...
o = "StickersStore", (s = "displayName") in(r = w) ? Object.defineProperty(r, s, {
  ...
  BACKGROUND_SYNC: () => {
    R = null, O = new Map, v = new Map, N = 0
  },
  CONNECTION_OPEN: e => {
    let {
      guilds: t
    } = e;
    R = null, O = new Map, v = new Map, t.forEach(G), N = t.every(e => null != e.stickers) ? 1 : 0
  },
  ...
  LOGOUT: () => {
    N = 0, p = [], O.clear(), m.clear(), R = null, v.clear(), v = new Map(v), C = !1, g = null
  },

var i = n(735250);
n(470079);
var l = n(120356), r = n.n(l), a = n(442837), s = n(481060), o = n(717881), c = n(503438), u = n(850827), d = n(952164), h = n(131704), p = n(314897), _ = n(594174), f = n(409216), g = n(768581), m = n(51144), C = n(754231), I = n(550299);
function E(e) {
    let {
            guildId: t,
            member: n,
...
t.Z = e => {
    let {
            ...
            embeddedApp: r,
            onAction: s
        } = e, f = null != r, g = f ? Array.from(r.embeddedActivity.userIds) : [], m = (0, a.e7)([
            _.default,
            p.default
        ], () => {
            if (f)
                return _.default.getUser(g[0]);
            if (null != l) {
                var e, t;
    ...
    if (null == m)
        return null;
    let E = f || (0, c.Z)(n), x = (0, h.vd)(t.type);
    return (0, i.jsxs)('div', {

...
let E = a.memo(function(e) {
  let {
    ...
    referencedMessage: f,
    compact: E = !1
  } = e, _ = f.state === r.ReferencedMessageState.LOADED ? f.message : void 0, T = (0, i.useActiveKeywordFiltersCacheKey)(), m = a.useMemo(() => (null == _ ? void 0 : _.content) != null && "" !== _.content ? (0, d.default)(_, {
    formatInline: !0,

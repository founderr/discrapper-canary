...
var r = n(836560), i = n(264344), a = n.n(i), o = n(649318);
function s(e, t, n) {
...
class l extends r.EventEmitter {
    addStream(e, t, n) {
        ...
        !this.streams.some(e => e.ssrc === t) && this.streams.push({
            ...
            [e]: n
        }, r = !0)) : null != this.activeVideoSSRCs[e] && (r = !0, this.activeVideoSSRCs = { ...this.activeVideoSSRCs }, delete this.activeVideoSSRCs[e])), r && this.negotiationNeeded();
    }
    removeStream(e) {
        let t = !1;
    ...
    getSSRCs(e) {
        let t = this.streams.map((e, t) => {
            ...
            return [
                ...
                n,
                i,
                a === r || s === r ? this.direction : o.Ns.INACTIVE,
                l
            ];
        });
        if ('Firefox' !== a().name)
            ...
            return n.concat(t);
        {
            ...
            return n.slice(0, e).concat(t).slice(0, n.length).map((e, t) => {
                ...
                return [
                    ...
                    r,
                    i,
                    (0, o.Mg)(this.outboundStreams[t].direction),
    ...
    generateSessionDescription(e) {
        let t = this.audioCodec, n = this.audioPayloadType, r = this.videoCodec, i = this.videoPayloadType, a = this.rtxPayloadType, s = this.sdp;
        if (null == t || null == n || null == r || null == i || null == a || null == s || null == this.direction)
            throw Error('Invalid payload: audioCodec: '.concat(t, ', audioPayloadType: ').concat(null == n ? 'null' : n, ', videoCodec: ').concat(r, ', videoCodecPayloadType: ').concat(null == i ? 'null' : i, ', rtxPayloadType: ').concat(null == a ? 'null' : a, ', sdp: ').concat(s));
        let l = (0, o.MP)({
            type: e,
            baseSDP: s,

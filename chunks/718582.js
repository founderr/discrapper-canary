...
let i;
let o = eo(e),
  s = a.useMemo(() => o.map(e => G.default.getUser(e)).filter(V.lm), [o]),
  l = s.slice(0, 6),
...
let t = [...e],
  ...
  s = t.findIndex(e => e.category === j.L.HANGOUT && e.videoUserIds.length > 0),
...
o = a.length;
  if (o > 0)
return 1 === o || i ? z.Z.Messages.USER_SUMMARY_ONE.format({
  first: a[0]
...
o = U.Z.can(W.Plq.VIEW_CHANNEL, a);
  if (null != a && o)

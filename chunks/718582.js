...
function ei(e) {
    let t = e.id,
        ...
        h = (0, l.Wu)([k.Z], () => k.Z.getBlockedOrIgnoredIDs()),
        ...
        b = (0, l.e7)([R.Z], () => R.Z.getUserAffinities()),
        S = v && b.length > 0,
        T = [...E, ..._];
    return (
        i !== T.length &&
    ...
    switch (r) {
        ...
        case Y.L.GAMING:
            return () => {
                ...
                ec(e, t, n, 'card'), a ? (0, S.XU)(t, r) : ((0, S.XU)(t), c.Z.channelListScrollTo(t, r));
            };

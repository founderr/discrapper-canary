...
let h = e => {
    ...
    return r.useEffect(() => {
      !0 !== u && !o && (y(), M(0)), !o && b && U.current && (y(), M(0)), s && o && !U.current && (P(), h.animationType === _.AnimationTypes.PERSISTENT ? M(I === _.RestartMethod.FromStart ? 0 : C) : M(0))
    }, [o, b, C, s, y, P, U, h.animationType, u, I]), (0, i.jsx)("div", {
      ref: N,

...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(442837), l = n(607070), u = n(451478), c = n(119837), d = n(802433), _ = n(658312), E = n(729436), f = n(710867), h = n(312904), p = n(186917), m = n(453925);
let I = e => {
        let {
        ...
        (0, h.Z)(I);
        let [v, O] = i.useState(0), [R, C] = i.useState(0), {accessibilityLabel: y} = I, [D, L] = i.useState(-g), {
                stop: b,
                reset: M,
                ticking: P
            } = (0, _.Z)(e => {
        ...
        return i.useEffect(() => {
            ...
            ref: S,
            className: o()(m.profileEffects, { [m.hovered]: s && l }),
            children: (0, r.jsx)('div', {
                ...
                children: A.map((e, i) => {
                    ...
                    if (I.animationType === d.Q.PERSISTENT && !U && null != n && D >= R && w(!0), e.loop && void 0 !== e.loopDelay && e.loopDelay > 0) {
                        let t = e.duration + e.loopDelay, a = Math.floor((D - e.start) / t);
...
t.Z = e => {
    let t = (0, s.e7)([u.Z], () => u.Z.isFocused()), n = (0, s.e7)([l.Z], () => l.Z.useReducedMotion), [a, o] = i.useState(!1), {preset: c} = (0, p.Z)(e.profileEffectId, () => o(!1));

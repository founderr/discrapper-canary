...
t.default = a.memo(function(e) {
  ...
  let {
    ...
    allowLinks: !0,
    previewLinkTarget: !0
  }), K = n.type === v.MessageTypes.REPLY ? n.messageReference : void 0, W = (0, o.useStateFromStores)([c.default], () => c.default.getMessageByReference(K)), z = (0, r.useListItem)(n.id), Q = (0, N.default)(n), q = (0, o.useStateFromStores)([E.default], () => n.hasFlag(v.MessageFlags.HAS_THREAD) && E.default.getChannel(m.default.castMessageIdAsChannelId(n.id))), X = (0, u.useRoleIcon)({
    guildId: U.guild_id,
    roleId: Q.iconRoleId

...
t.Z = s.memo(function (e) {
    var t, n;
    let { message: s, compact: a = !1, className: L, onContextMenu: Z, onClick: P, hideSimpleEmbedContent: b = !0, channel: D, isGroupStart: j, animateAvatar: U, subscribeToComponentDispatch: y, renderThreadAccessory: B, trackAnnouncementViews: k = !1, ...G } = e,
        F = s.type === M.uaV.POLL_RESULT || (null !== (t = e.disableInteraction) && void 0 !== t && t),
    ...
    return (0, i.jsx)(N.Z, {
        ...
        childrenExecutedCommand: (0, x.Z)(s, D, a),

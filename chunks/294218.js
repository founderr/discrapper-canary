...
t.default = a.memo(function(e) {
  ...
  let {
    ...
    allowLinks: !0,
    previewLinkTarget: !0
  }), W = n.type === v.MessageTypes.REPLY ? n.messageReference : void 0, K = (0, o.useStateFromStores)([c.default], () => c.default.getMessageByReference(W)), z = (0, r.useListItem)(n.id), Q = (0, p.default)(n), q = (0, o.useStateFromStores)([E.default], () => n.hasFlag(v.MessageFlags.HAS_THREAD) && E.default.getChannel(I.default.castMessageIdAsChannelId(n.id))), J = (0, u.useRoleIcon)({
    guildId: U.guild_id,
    roleId: Q.iconRoleId
  ...
  let $ = (0, N.getMessageAriaLabelledBy)(n),
    ee = (0, N.getMessageAriaDescribedBy)(n);

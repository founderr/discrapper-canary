...
let U = (e) => {
	let t,
		n,
		i,
		{ selected: a, route: U, locationState: G, ...k } = e,
		...
		{ enabled: ee } = T._.useExperiment({ location: j }, { autoTrackExposure: !1 }),
		et = ee && (null == F ? void 0 : F.trial_id) === b.a7,
		en = (0, p.N9)({
			location: 'NitroTabButton',
			showTabForOtherReasons: $
		});
	if (!($ = $ || (null != w && null != J && Date.now() - J.getTime() > en))) return null;
	z
		? ((n = (0, s.jsx)(C.Z, {})), (i = 0))
		: null != q
			? ((n = (0, s.jsx)(R.Z, { copy: q })), (i = 1))
			: K
				? ((n = (0, s.jsx)(R.Z, {})), (i = 2))
				: null != Y
					? ((n = (0, s.jsx)(Z.GN, {
					...
					: null == F || et
						? Q
							? ((n = (0, s.jsx)(L.Z, {
								...
								(i = 6))
							: W && ((n = (0, s.jsx)(A.k, { entryPoint: A.U.PrivateMessages })), !a && (t = y.localizeBadge), (i = 5))
						: ((n = (0, s.jsx)(Z.$H, {
								trialOffer: F,
								isTabSelected: a
							})),
	...
	return Q ? (0, s.jsx)(L.E, { children: ei }) : ei;
};

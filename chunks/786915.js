...
function E(e) {
  ...
  let {
    ...
    ...A
  } = e, v = (0, u.useAppContext)(), x = null == C ? void 0 : C.getGuildId(), N = (0, i.useStateFromStores)([d.default], () => null != x ? d.default.getGuild(x) : null, [x]);
  return (t = N, l = C, null != t && null != l && c.default.can(m.Permissions.CREATE_INSTANT_INVITE, l)) ? (0, a.jsx)(h.default, {
    onClick: () => {
      s()(null != N, "guild cannot be null"), s()(null != C, "channel cannot be null"), ! function(e) {
        let {
          guild: t,
          channel: l,
          streamUserId: s,

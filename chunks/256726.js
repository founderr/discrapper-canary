...
let u = e => {
  ...
  d = e => {
    ...
    return [{
      iconPath: r.RECORD_PLAYER_ICON_PATH,
      text: t
    }]
  },
  c = async e => {
    let {
      ...
      avatarSrc: c,
      mediaImageSrc: t
    }), C = n.replaceAll(/[^a-zA-Z0-9 ]/g, "").replaceAll(" ", "-");
    return await (0, s.generateImageFromCanvas)({
      ...
      drawImage: e => {
        ...
        e.setSize({
          ...
          y: 26
        }, !0), e.setColor("white"), e.drawRoundedImage("MediaImage", {
          x: r.imagePadding,
          y: r.imagePadding
        }, {
        ...
        }) === l.DrawResultStatus.Failure && e.drawPath(a.ACTIVITY_IMAGE_FALLBACK_PATH, {
          x: r.imagePadding,
          y: r.imagePadding

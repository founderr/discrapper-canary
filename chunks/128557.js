...
function j(e) {
  ...
  return a.useEffect(() => {
    null != m && o !== m && (p(!0), setTimeout(() => p(!1), 1e3))
  }, [o, m]), (0, i.jsxs)(d.Clickable, {
    className: s()(t, R.card, {
      [R.completed]: o
    }),
    onClick: c,
    children: [null != l ? l : (0, i.jsx)("div", {
      className: R.icon,
      style: {
      ...
      children: (0, i.jsxs)("div", {
        ...
        children: [(0, i.jsxs)(o.Z.div, {
          ...
          children: [(0, i.jsx)(d.Heading, {
            ...
            variant: "text-sm/normal",
            children: [q, " ", K.length > 0 ? b.Z.Messages.WELCOME_CTA_SUBTITLE_ACTION_WITH_GUIDE.format({
              guideURL: X
            }) : null]
          })]
        }), K]

...
var r = n(470079), i = n(990547), a = n(570140), o = n(565384), s = n(569611), l = n(97145), u = n(857192), c = n(747161), d = n(848479), _ = n(960048), E = n(981631), f = n(94752), h = n(689938);
let p = r.createContext({ location: {} }), m = {}, I = performance.now(), T = [];
function g(e) {
    T.push(e);
}
let S = {
    ...
    [E.rMx.MEDIA_VIEWER_SESSION_COMPLETED]: { throttlePercent: 0.01 },
...
function A(e) {
    return 'string' == typeof e ? { location: e } : {
        location: e.page,
...
let N = () => f.E.NONE, v = (0, i.trackMaker)({

...
let Y = 5 * F.default.Millis.SECOND,
  K = 8 * F.default.Millis.SECOND,
  Z = 30 * F.default.Millis.SECOND,
  X = Object.freeze({
    priority: 0,
    duration: Y,
...
u = "OverlayNotificationsStore", (d = "displayName") in(r = ei) ? Object.defineProperty(r, d, {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if ((null === (n = l.activity) || void 0 === n ? void 0 : n.type) === G.ActivityActionTypes.JOIN || (null === (i = l.activity) || void 0 === i ? void 0 : i.type) === G.ActivityActionTypes.JOIN_REQUEST) {
      if (!(0, U.shouldNotify)(l, a, !0, !0)) return !1;
    ...
    if ((!V.default.isInstanceUILocked() || V.default.isPinned(G.OverlayWidgets.TEXT)) && a === b.default.getChannelId() || V.default.getTextChatNotificationMode() === G.OverlayNotificationTextChatTypes.DISABLED || w.default.disableNotifications || !(0, U.shouldNotify)(l, a)) return !1;

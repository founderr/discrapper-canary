...
function Q(e) {
  ...
  if (-1 === n) return !1;
  let i = J[n];
  clearTimeout(i.timerId), J = [...J], t === W.OverlayNotificationStatus.DISMISSED ? J.splice(n, 1) : J[n] = {
    ...i,
    status: t
  }
}
...
function en(e) {
  ...
  if (null == a || !a.isPrivate() || j.default.getStatus() === W.StatusTypes.DND || x.FocusMode.getSetting()) return !1;
  let l = J.find(e => 1 === e.type && e.channelId === t && e.messageType === W.MessageTypes.CALL);
...
class ei extends(l = p.default.Store) {
  initialize() {
    this.waitFor(L.default, w.default)
  }
  getNotifications() {
    return J
  }
...
u = "OverlayNotificationsStore", (d = "displayName") in(r = ei) ? Object.defineProperty(r, d, {
  ...
  OVERLAY_SET_INPUT_LOCKED: function(e) {
    ...
    if (t) return !1;
    J = J.map(e => e.status === W.OverlayNotificationStatus.ACTIVE ? (clearTimeout(e.timerId), {
      ...e,
  ...
  MESSAGE_CREATE: function(e) {
    ...
    let {
      channelId: a,
      message: l
    } = e, s = L.default.getChannel(a), o = w.default.getUser(null === (t = l.author) || void 0 === t ? void 0 : t.id);
    ...
    if ((!V.default.isInstanceUILocked() || V.default.isPinned(W.OverlayWidgets.TEXT)) && a === b.default.getChannelId() || V.default.getTextChatNotificationMode() === W.OverlayNotificationTextChatTypes.DISABLED || P.default.disableNotifications || !(0, B.shouldNotify)(l, a)) return !1;
    let r = !M.default.isSoundDisabled(k.MESSAGE_SOUND);
  ...
  ACTIVITY_USER_ACTION: function(e) {
    ...
    if (n === W.ActivityActionTypes.JOIN) t = (0, S.default)(i, l);
    if (null == t) return !1;
    et(t, {
      priority: 2,
      type: 0

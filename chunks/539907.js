...
var r, i = n(735250), a = n(470079), o = n(120356), s = n.n(o), l = n(512722), u = n.n(l), c = n(84735), d = n(801787), _ = n(585483), E = n(792125), f = n(872801), h = n(302901), p = n(981631), m = n(636492);
function I(e, t, n) {
...
function N(e, t, n) {
    if (null != e && e < 0 && ('top' === n.position || 'bottom' === n.position) && null != t && Math.abs(e) < (null == t ? void 0 : t.offsetHeight) && null != n.style) {
        let t = 'top' === n.position ? 'bottom' : 'top', r = n.style[t];
        return {
            ...n,
            style: {
                ...n.style,
...
class O extends (r = a.Component) {
    ...
    nudgeLeftAlignment(e, t, n) {
        ...
        if (!r)
            return e;
        let i = n.offsetWidth, a = e + t.offsetWidth - i + 12;
    ...
    getHorizontalAlignmentStyle(e, t, n, r) {
        ...
        switch (i) {
        case 'left': {
                let i = this.formatDimension(this.nudgeLeftAlignment(e.left, t, n)), a = this.formatDimension(e.left) - i;
                return {
                    style: {
                        ...r,
                        left: i
        ...
        case 'center': {
                let i = e.left + (e.width - t.offsetWidth) / 2, a = this.formatDimension(this.nudgeLeftAlignment(i, t, n)), o = this.formatDimension(i) - a;
                return {
                    style: {
                        ...r,
                        left: a
    ...
    nudgeTopAlignment(e, t, n) {
        ...
        if (e < 0)
            return 0;
        let i = t.getBoundingClientRect().height, a = n.offsetHeight, o = e + i - a + 12;
        return o > 0 ? Math.max(12, e - o) : e;
    }
    nudgeBottomAlignment(e, t, n) {
        let {nudgeAlignIntoViewport: r} = this.props, i = n.offsetHeight, a = i - e;
        if (!r)
            return a;
    ...
    getVerticalAlignmentStyle(e, t, n, r) {
        ...
        switch (i) {
        case 'top': {
                let i = this.formatDimension(this.nudgeTopAlignment(e.top, t, n)), a = this.formatDimension(e.top) - i;
                return {
                    style: {
                        ...r,
                        top: i
        ...
        case 'bottom': {
                let i = this.formatDimension(this.nudgeBottomAlignment(e.bottom, t, n)), a = this.formatDimension(e.bottom) - i;
                return {
                    style: {
                        ...r,
                        bottom: i
        ...
        case 'center': {
                let i = e.top + (e.height - t.offsetHeight) / 2, a = this.formatDimension(this.nudgeTopAlignment(i, t, n)), o = this.formatDimension(i) - a;
                return {
                    style: {
                        ...r,
                        top: a
    ...
    calculatePositionStyle(e, t, n) {
        ...
        switch (e) {
        case 'top':
            return this.getHorizontalAlignmentStyle(u, t, n, { bottom: n.offsetHeight - u.top + o });
        case 'bottom':
            return this.getHorizontalAlignmentStyle(u, t, n, { top: u.bottom + o });
        case 'left':
            return this.getVerticalAlignmentStyle(u, t, n, { right: n.offsetWidth - u.left + o });
        case 'right':
            return this.getVerticalAlignmentStyle(u, t, n, { left: u.right + o });
        case 'center':
            return this.getVerticalAlignmentStyle(u, t, n, { left: u.left + u.width / 2 - t.offsetWidth / 2 + o });
        case 'window_center':
            return this.getVerticalAlignmentStyle(u, t, n, { left: Math.max((window.innerWidth - t.offsetWidth) / 2, 0) });
        default:
            throw Error('Unexpected position: '.concat(e));
        }
    }
    calculateState() {
        ...
        let r = (0, h.wL)(n), {
                style: i,
                nudge: a
            } = this.calculatePositionStyle(e, n, r), o = null, s = null;
        if (t && (o = A(e, i, n, r)) < 0) {
            let t = function (e) {
                    switch (e) {
                    case 'top':

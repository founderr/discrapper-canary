...
function p(e) {
  ...
  supports(e) {
    ...
    switch (e) {
      case m.Features.LEGACY_AUDIO_SUBSYSTEM:
        return (0, E.supportsFeature)(m.NativeFeatures.VOICE_LEGACY_SUBSYSTEM);
      case m.Features.EXPERIMENTAL_AUDIO_SUBSYSTEM:
        return (0, E.supportsFeature)(m.NativeFeatures.VOICE_EXPERIMENTAL_SUBSYSTEM);
      case m.Features.DEBUG_LOGGING:
        return (0, E.supportsFeature)(m.NativeFeatures.DEBUG_LOGGING);
      case m.Features.SOUNDSHARE:
        return (0, E.supportsFeature)(m.NativeFeatures.SOUNDSHARE);
      case m.Features.SCREEN_SOUNDSHARE:
        return (0, E.supportsFeature)(m.NativeFeatures.SCREEN_SOUNDSHARE);
      case m.Features.ELEVATED_HOOK:
        return (0, E.supportsFeature)(m.NativeFeatures.ELEVATED_HOOK);
      case m.Features.LOOPBACK:
        return (0, E.supportsFeature)(m.NativeFeatures.LOOPBACK);
      case m.Features.WUMPUS_VIDEO:
        return (0, E.supportsFeature)(m.NativeFeatures.WUMPUS_VIDEO);
      case m.Features.HYBRID_VIDEO:
        return (0, E.supportsFeature)(m.NativeFeatures.HYBRID_VIDEO);
      ...
      case m.Features.EXPERIMENTAL_SOUNDSHARE:
        return (0, E.supportsFeature)(m.NativeFeatures.SOUNDSHARE_LOOPBACK);
      ...
      case m.Features.EXPERIMENTAL_ENCODERS:
        return (0, E.supportsFeature)(m.NativeFeatures.EXPERIMENTAL_ENCODERS);
      case m.Features.REMOTE_LOCUS_NETWORK_CONTROL:
        return (0, E.supportsFeature)(m.NativeFeatures.REMOTE_LOCUS_NETWORK_CONTROL);
      case m.Features.SCREEN_PREVIEWS:
        return (0, E.supportsFeature)(m.NativeFeatures.SCREEN_PREVIEWS);
      case m.Features.CLIPS:
        return (0, E.supportsFeature)(m.NativeFeatures.CLIPS);
      case m.Features.WINDOW_PREVIEWS:
        return (0, E.supportsFeature)(m.NativeFeatures.WINDOW_PREVIEWS);
      case m.Features.AUDIO_DEBUG_STATE:
        return (0, E.supportsFeature)(m.NativeFeatures.AUDIO_DEBUG_STATE);
      case m.Features.CONNECTION_REPLAY:
        return (0, E.supportsFeature)(m.NativeFeatures.CONNECTION_REPLAY);
      case m.Features.SIMULCAST:
        return (0, E.supportsFeature)(m.NativeFeatures.SIMULCAST) && (0, E.supportsFeature)(m.NativeFeatures.SIMULCAST_BUGFIX);
      case m.Features.RTC_REGION_RANKING:
        return (0, E.supportsFeature)(m.NativeFeatures.RTC_REGION_RANKING);
      case m.Features.DIRECT_VIDEO:
        return (0, E.supportsFeature)(m.NativeFeatures.DIRECT_VIDEO) && null != window.createDiscordStream;
      case m.Features.ELECTRON_VIDEO:
        return (0, E.supportsFeature)(m.NativeFeatures.ELECTRON_VIDEO);
      case m.Features.MEDIAPIPE:
        return (0, E.supportsFeature)(m.NativeFeatures.MEDIAPIPE);
      case m.Features.FIXED_KEYFRAME_INTERVAL:
        return (0, E.supportsFeature)(m.NativeFeatures.FIXED_KEYFRAME_INTERVAL);
      case m.Features.FIRST_FRAME_CALLBACK:
        return (0, E.supportsFeature)(m.NativeFeatures.FIRST_FRAME_CALLBACK);
      case m.Features.REMOTE_USER_MULTI_STREAM:
        return (0, E.supportsFeature)(m.NativeFeatures.REMOTE_USER_MULTI_STREAM);
      case m.Features.SPEED_TEST:
        return (0, E.supportsFeature)(m.NativeFeatures.SPEED_TEST);
      case m.Features.IMAGE_QUALITY_MEASUREMENT:
        return (0, E.supportsFeature)(m.NativeFeatures.IMAGE_QUALITY_MEASUREMENT);
      case m.Features.AMD_EXPERIMENTAL_RATE_CONTROL:
        return (0, E.supportsFeature)(m.NativeFeatures.AMD_EXPERIMENTAL_RATE_CONTROL);
      case m.Features.GO_LIVE_HARDWARE:
        return (0, E.supportsFeature)(m.NativeFeatures.GO_LIVE_HARDWARE);
      case m.Features.SCREEN_CAPTURE_KIT:
        return (0, E.supportsFeature)(m.NativeFeatures.SCREEN_CAPTURE_KIT);
      case m.Features.CAPTURE_TIMEOUT_EXPERIMENTS:
        return (0, E.supportsFeature)(m.NativeFeatures.CAPTURE_TIMEOUT_EXPERIMENTS);
  ...
  connect(e, t, n) {
    let i = (0, E.supportsFeature)(m.NativeFeatures.EXPERIMENT_CONFIG);
    !i && (n.experiments = void 0);
    let s = c.default.create(e, t, n);
    return s.on(u.BaseConnectionEvent.Destroy, e => {
      this.connections.delete(e), this.connectionsEmpty() && (0, E.setProcessPriority)(m.ProcessPriority.NORMAL)
    ...
    }), this.connections.add(s), (0, E.setProcessPriority)(m.ProcessPriority.HIGH), this.emit(u.MediaEngineEvent.Connection, s), s
  }
  ...
  setInputVolume(e) {
    (0, E.getVoiceEngine)().setInputVolume(p(e))
  }
  setOutputVolume(e) {
  ...
  async setVideoInputDevice(e) {
    ...
    if (i !== this.videoInputDeviceId) {
      if (this.videoInputDeviceId = i, (0, E.supportsFeature)(m.NativeFeatures.SET_VIDEO_DEVICE_BY_ID)) {
        let e = null != n ? null != n.originalId && "" !== n.originalId ? n.originalId : n.id : m.DISABLED_DEVICE_ID;
        (0, E.getVoiceEngine)().setVideoInputDevice(e)
      } else(0, E.getVoiceEngine)().setVideoInputDevice(null != n ? n.index : -1);
      this.connections.forEach(e => e.setVideoBroadcast(this.shouldConnectionBroadcastVideo(e)))
    }
  }
  getSupportedVideoCodecs(e) {
    (0, E.getVoiceEngine)().getSupportedVideoCodecs(e)
  }
  getCodecCapabilities(e) {
    (0, E.getVoiceEngine)().getCodecCapabilities(e)
  }
  setGoLiveSource(e, t) {
    if (null == e) {
  ...
  setClipsSource(e) {
    if (null == (0, E.getVoiceEngine)().setClipsSource || null == (0, E.getVoiceEngine)().setOnClipsRecordingEvent || null == (0, E.getVoiceEngine)().applyClipsSettings) return;
    if (null == e) {
  ...
  getDesktopSources() {
    return new Promise(e => {
      null != (0, E.getVoiceEngine)().getDesktopSources ? (0, E.getVoiceEngine)().getDesktopSources(t => e(t)) : e([])
    })
  }
  getScreenPreviews(e, t) {
    return new Promise(n => {
      null != (0, E.getVoiceEngine)().getScreenPreviews ? (0, E.getVoiceEngine)().getScreenPreviews(e, t, e => {
        n(e.map((e, t) => ({
          ...e,
          name: "Screen " + (t + 1)
        })))
  ...
  setClipBufferLength(e) {
    var t, n;
    null === (t = (n = (0, E.getVoiceEngine)()).setClipBufferLength) || void 0 === t || t.call(n, e)
  }
  saveClip(e, t) {
    let n = (0, E.getVoiceEngine)();
  ...
  getWindowPreviews(e, t) {
    return new Promise(n => {
      null != (0, E.getVoiceEngine)().getWindowPreviews ? (0, E.getVoiceEngine)().getWindowPreviews(e, t, e => {
        n(e)
      }) : n([])
    })
  }
  setAudioSubsystem(e) {
    null != (0, E.getVoiceEngine)().setAudioSubsystem ? (0, E.getVoiceEngine)().setAudioSubsystem(e) : (0, E.getVoiceEngine)().setUseLegacyAudioDevice(e === m.AudioSubsystems.LEGACY)
  }
  getAudioSubsystem() {
  ...
  getDebugLogging() {
    return !!this.supports(m.Features.DEBUG_LOGGING) && (0, E.getVoiceEngine)().getDebugLogging()
  }
  setDebugLogging(e) {
    this.supports(m.Features.DEBUG_LOGGING) && (0, E.getVoiceEngine)().setDebugLogging(e)
  }
  ...
  setLoopback(e, t) {
    null != (0, E.getVoiceEngine)().setLoopback && (0, E.getVoiceEngine)().setLoopback(e, {
    ...
    }), null != (0, E.getVoiceEngine)().setEmitVADLevel2 ? (0, E.getVoiceEngine)().setEmitVADLevel2(e || this.listenerCount(u.MediaEngineEvent.VoiceActivity) > 0) : (0, E.getVoiceEngine)().setEmitVADLevel(e || this.listenerCount(u.MediaEngineEvent.VoiceActivity) > 0, e, {
      echoCancellation: t.echoCancellation,
      noiseSuppression: t.noiseSuppression,
      automaticGainControl: t.automaticGainControl,
      noiseCancellation: t.noiseCancellation
  ...
  setAecDump(e) {
    var t, n;
    null === (t = (n = (0, E.getVoiceEngine)()).setAecDump) || void 0 === t || t.call(n, e)
  }
  rankRtcRegions(e) {
  ...
  createReplayConnection(e, t) {
    ...
    return null == n ? null : (n.on(u.BaseConnectionEvent.Destroy, e => {
      this.connections.delete(e), this.connectionsEmpty() && (0, E.setProcessPriority)(m.ProcessPriority.NORMAL)
    }), this.connections.add(n), (0, E.setProcessPriority)(m.ProcessPriority.HIGH), this.emit(u.MediaEngineEvent.Connection, n), n)
  }
  setUseDirectVideo(e) {
  ...
  stopLocalAudioRecording(e) {
    var t, n;
    null === (t = (n = (0, E.getVoiceEngine)()).stopLocalAudioRecording) || void 0 === t || t.call(n, (t, n) => {
      e(t, n)
    }), this.listenerCount(u.MediaEngineEvent.VoiceActivity) > 0 && null != (0, E.getVoiceEngine)().setEmitVADLevel2 && (0, E.getVoiceEngine)().setEmitVADLevel2(!0)
  }
  speedTester(e, t) {
  ...
  setHasFullbandPerformance(e) {
    null != (0, E.getVoiceEngine)().setHasFullbandPerformance && (0, E.getVoiceEngine)().setHasFullbandPerformance(e)
  }
  getSupportedSecureFramesProtocolVersion() {
    var e;
    return null !== (e = (0, E.getVoiceEngine)().SupportedSecureFramesProtocolVersion) && void 0 !== e ? e : 0
  }
  getSupportedBandwidthEstimationExperiments(e) {
    null != (0, E.getVoiceEngine)().getSupportedBandwidthEstimationExperiments && (0, E.getVoiceEngine)().getSupportedBandwidthEstimationExperiments(e)
  }
  watchdogTick() {
    let e = !1;
    (0, E.getVoiceEngine)().pingVoiceThread(() => {
  ...
  constructor() {
    ...
    super(), t = this, this.Video = g.default, this.Camera = h.default, this.videoInputDeviceId = m.DISABLED_DEVICE_ID, this.connections = new Set, this.speedTesters = new Set, this.lastVoiceActivity = -1, this.audioSubsystem = "standard", this.audioLayer = "", this.deviceChangeGeneration = 0, this.consecutiveWatchdogFailures = 0, this.codecSurvey = null, this.logger = new o.Logger("MediaEngineNative"), this.handleDeviceChange = function() {
      ...
      switch (e) {
        case u.MediaEngineEvent.VoiceActivity:
          null != (0, E.getVoiceEngine)().setEmitVADLevel2 ? (0, E.getVoiceEngine)().setEmitVADLevel2(!0) : (0, E.getVoiceEngine)().setEmitVADLevel(!0, !1, {});
          break;
      ...
      e === u.MediaEngineEvent.VoiceActivity && (null != (0, E.getVoiceEngine)().setEmitVADLevel2 ? (0, E.getVoiceEngine)().setEmitVADLevel2(this.listenerCount(u.MediaEngineEvent.VoiceActivity) > 0) : (0, E.getVoiceEngine)().setEmitVADLevel(this.listenerCount(u.MediaEngineEvent.VoiceActivity) > 0, !1, {}))
    ...
    if (i.setDeviceChangeCallback(this.handleDeviceChange), i.setVolumeChangeCallback(this.handleVolumeChange), i.setOnVoiceCallback(this.handleVoiceActivity), null === (n = i.setVideoInputInitializationCallback) || void 0 === n || n.call(i, this.handleVideoInputInitialization), i.setTransportOptions({
        ...
        ducking: !1
      }), this.on("removeListener", this.handleRemoveListener), this.on("newListener", this.handleNewListener), null != (0, E.getVoiceEngine)().getAudioSubsystem ? (0, E.getVoiceEngine)().getAudioSubsystem((e, t) => {
        this.audioSubsystem = e, this.audioLayer = t
      }) : null != (0, E.getVoiceEngine)().getUseLegacyAudioDevice && (this.audioSubsystem = (0, E.getVoiceEngine)().getUseLegacyAudioDevice() ? m.AudioSubsystems.LEGACY : m.AudioSubsystems.STANDARD), null != i.pingVoiceThread && "undefined" != typeof window && "canary" === window.GLOBAL_ENV.RELEASE_CHANNEL && this.watchdogTick(), this.getDebugLogging() && !e.installedLogHooks)
      for (let t of (e.installedLogHooks = !0, ["trace", "debug", "info", "warn", "error", "log"])) {
        ...
        null != n && (e[t] = function() {
          ...
          try {
            ...
            (0, E.getVoiceEngine)().consoleLog(t, JSON.stringify(e))
          } catch (e) {}
        })
      }

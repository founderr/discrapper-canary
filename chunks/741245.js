...
var e, t, s, r = h(735250), i = h(470079), c = h(120356), n = h.n(c), o = h(748780), d = h(692547), M = h(780384), A = h(481060), C = h(672752), E = h(302221), m = h(474936), p = h(877426);
function L(a, l, h) {
...
class Z extends (t = i.PureComponent) {
    ...
    getContainerStyle() {
        let {flashColor: a} = this.props, l = H.FLASH_TIME_PERCENT, h = H.FLASH_DURATION_PERCENT, e = (0, E.Cj)(a, 0);
        return {
...
function u(a) {
    let {
            theme: l,
            ...h
        } = a, e = (0, A.useToken)(d.Z.unsafe_rawColors.WHITE_500).hex(), t = (0, A.useToken)(d.Z.unsafe_rawColors.BRAND_500).hex(), s = (0, M.wj)(l) ? e : t;
    return (0, r.jsx)(Z, {
        ...h,
        theme: l,
        flashColor: s

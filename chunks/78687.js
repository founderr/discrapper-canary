...
e.exports = function (e) {
    ...
    var o = function () {
            ...
            t.style.cssText = u([
                ...
                'margin: 0',
                'padding: 0'
            ]), t.appendChild(e), document.body.insertBefore(t, document.body.firstChild);
    ...
    function l(e) {
        (function (e, t, n) {
            if (!e.getElementById(t)) {
                var r, i, a, o = n + '_animation', s = '/* Created by the element-resize-detector library. */\n';
    ...
    return {
        makeDetectable: function (e, l, d) {
            ...
            function R(e, t, n) {
                var r = _(e), i = E(e), a = t + 10 + A(), o = n + 10 + N(), s = 2 * t + A(), l = 2 * n + N();
            ...
            function y() {
                    ...
                    if ('static' === n.position) {
                        ...
                        var r = function (e, t, n, r) {
                            ...
                            if ('auto' !== i && '0' !== i.replace(/[^-\d\.]/g, ''))
                                e.warn('An element that is positioned static has style.' + r + '=' + i + ' which is ignored due to the static positioning. The element will need to be positioned relative, so the style.' + r + ' will be set to 0. Element: ', t), t.style[r] = 0;
                        };
                ...
                var p = u([
                        ...
                        'width: 200%',
                        'height: 200%'
                    ]), A = document.createElement('div'), N = document.createElement('div'), v = document.createElement('div'), O = document.createElement('div'), R = document.createElement('div'), y = document.createElement('div');
                function D() {
                    var e = i(l);
            ...
            function D() {
                function o(t, n, r) {
                    var i = _(t).childNodes[0], a = n + 10 + A(), o = r + 10 + N();
                    i.style.setProperty('width', a + 'px', e.important ? 'important' : ''), i.style.setProperty('height', o + 'px', e.important ? 'important' : '');
                }
                function s(r) {
                    var s = l.offsetWidth, c = l.offsetHeight, d = s !== i(l).lastWidth || c !== i(l).lastHeight;
                ...
                function c() {
                    ...
                    var e = i(l);
                    return void 0 === i(l).lastNotifiedWidth && e.lastWidth === e.startSize.width && e.lastHeight === e.startSize.height ? m('Not notifying: Size is the same as the start size, and there has been no notification yet.') : e.lastWidth === e.lastNotifiedWidth && e.lastHeight === e.lastNotifiedHeight ? m('Not notifying: Size already notified') : void (m('Current size not notified, notifying...'), e.lastNotifiedWidth = e.lastWidth, e.lastNotifiedHeight = e.lastHeight, r(i(l).listeners, function (e) {
                        e(l);
                    }));
                }
                function d() {
            ...
            function M() {
                var e;
                m('Installing...'), i(l).listeners = [], e = T(), i(l).startSize = {
                    width: e.width,
                    height: e.height
                }, m('Element start size', i(l).startSize), n.add(0, g), n.add(1, y), n.add(2, D), n.add(3, L), n.add(4, b);
            }
            if (m('Making detectable...'), (p = (h = f = l).getRootNode && h.getRootNode().contains(h), (h === h.ownerDocument.body || h.ownerDocument.body.contains(h) || p) && null !== window.getComputedStyle(f)) ? 1 : 0)
                M();
            else
                m('Element is detached'), C(), m('Waiting until element is attached...'), i(l).onRendered = function () {
                    m('Element is now attached'), M();
                };
        },
        addListener: function (e, t) {
            if (!i(e).listeners.push)
                throw Error('Cannot add listener to an element that is not detectable.');
            i(e).listeners.push(t);
        },
        uninstall: function (e) {
            var t = i(e);
            if (!!t)
                t.onExpandScroll && d(_(e), 'scroll', t.onExpandScroll), t.onShrinkScroll && d(E(e), 'scroll', t.onShrinkScroll), t.onAnimationStart && d(t.container, 'animationstart', t.onAnimationStart), t.container && e.removeChild(t.container);
        },
        initDocument: l
    };
};

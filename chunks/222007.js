...
t.default = {
  show: function(e) {
    ...
    (0, i.openModalLazy)((t = function() {
      ...
      return function(e, t) {
        ...
        switch (o.label) {
          case 0:
            return [4, Promise.all([n.e("99387"), n.e("74358")]).then(n.bind(n, "876397"))];
          case 1:
  ...
  getBlockedDomains: function() {
    if ((0, a.isDesktop)()) {
      var e = o.Storage.get("BlockedDomainsV2");
      return Promise.resolve(null == e ? [] : e.split("\n"))
    }
    return Promise.resolve([])
  },
  saveBlockedDomains: function(e) {
    (0, a.isDesktop)() && o.Storage.set("BlockedDomainsV2", e.join("\n"))
  }
}
...
var i = t(735250), a = t(470079), l = t(399606), s = t(481060), r = t(100527), o = t(906732), c = t(592125), d = t(810090), u = t(566620), g = t(146936), p = t(678173), v = t(636508), m = t(696068), x = t(361213), I = t(952561), f = t(778569), _ = t(182906), h = t(513202), C = t(412019), T = t(431136), E = t(226799), S = t(689938), j = t(795633);
function N(e) {
    var n;
    let {
            applicationId: t,
    ...
    let _ = (0, f.Z)({
            ...
            size: 2048
        }), h = (0, l.e7)([c.Z], () => c.Z.getChannel(v)), C = (0, p.T)(null != g ? g : null, t, h);
    if (null == C)
        return null;
    let T = null != C.activity.activity_preview_video_asset_id ? (0, x.Z)(t, C.activity.activity_preview_video_asset_id) : null, N = E.o[t], M = (null == N ? void 0 : N.playersSuggestionMin) != null && (null == N ? void 0 : N.playersSuggestionMax) != null ? ''.concat(N.playersSuggestionMin, ' - ').concat(N.playersSuggestionMax) : void 0;
    return (0, i.jsx)(o.Gt, {
        value: I,
                        ...
                        children: [
                                            ...
                                            null != M ? (0, i.jsxs)('div', {
                                                ...
                                                children: [
                                                    ...
                                                    (0, i.jsx)(s.Text, {
                                                        ...
                                                        children: S.Z.Messages.EMBEDDED_ACTIVITIES_NUMBER_OF_PLAYERS.format({ nPlayers: M })
                                                    })
                                                ]
                                            }) : null,
                            ...
                            (0, i.jsx)('div', {
                                ...
                                children: (null !== (n = null == N ? void 0 : N.gameplayImageUrls) && void 0 !== n ? n : []).map(e => (0, i.jsx)('img', {
                                    src: e,
                                    alt: S.Z.Messages.EMBEDDED_ACTIVITIES_GAMEPLAY_ALT.format({ activityName: C.application.name }),
...
function b(e) {
    ...
    let {
            ...
            size: 2048
        }), {analyticsLocations: E} = (0, o.ZP)(), N = (0, I.Z)(), [b, M] = a.useState(null !== (n = (0, v.$)({ allowGdmActivityChannelSuggestion: !0 })) && void 0 !== n ? n : void 0), [A, Z] = a.useState(null !== (r = (0, m.d)({
            guildId: b,
                ...
                children: [
                    (0, i.jsx)(s.Select, {
                        ...
                        renderOptionValue: e => {
                            ...
                            return null == n ? null : (0, i.jsx)(T.m, { guildId: n.value });
                        },
                        renderOptionLabel: e => {
                            let {value: n} = e;
                            return (0, i.jsx)(T.m, { guildId: n });
                        },
                        isSelected: e => e === b,
                        select: e => {
                            var n;
                            M(e), Z(null !== (n = (0, m.d)({ guildId: e })) && void 0 !== n ? n : void 0);
                        },
                        serialize: e => e
                    }),
                    (0, i.jsx)(s.Select, {

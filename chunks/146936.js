...
async function g(e) {
  ...
  if (null == v) return c.S.dispatch(p.CkL.SHOW_ACTIVITIES_CHANNEL_SELECTOR, {
    applicationId: n
  }), !1;
  ...
  if (G !== f.jy.CAN_LAUNCH) return G === f.jy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION ? (0, s.w)() : G === f.jy.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS && i.Z.show({
    title: R.Z.Messages.EMBEDDED_ACTIVITIES_LAUNCH_FAIL_GENERIC,
    body: R.Z.Messages.EMBEDDED_ACTIVITIES_NOT_AVAILABLE_ON_OS,
    hideActionSheet: !1
  }), !1;
  if (!await (0, T.p)({
      applicationId: U.id,

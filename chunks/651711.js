  ...
  return s.useMemo(() => {
    ...
    let {
      ...
      description: d.Z.Messages.GUILD_ROLE_SUBSCRIPTION_SETTINGS_ELIGIBILITY_REQUIREMENT_VIOLATIONS_DESCRIPTION.format({
        communityGuidelinesUrl: r.Z.getArticleURL(c.BhN.PUBLIC_GUILD_GUILDLINES)
      }),
    ...
    if (null != t && null != e.meetsOwnerAgeRequirement && o.push({
      ...
      }), null != s && null != e.hasSufficientMembers && o.push({
      ...
      let t = !e.hasEnabled2FA && !_ && (null == n ? void 0 : n.onEnableMFAClick) != null,
        s = !e.hasEnabled2FA && !E && (null == n ? void 0 : n.onRequireModeratorMFAClick) != null,
        a = t || s;
      o.push({
        key: "2fa_requirement",

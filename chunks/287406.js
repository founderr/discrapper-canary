...
if (t = 'string' == typeof n.dictionary ? a.string2buf(n.dictionary) : '[object ArrayBuffer]' === l.call(n.dictionary) ? new Uint8Array(n.dictionary) : n.dictionary, 0 !== (c = r.deflateSetDictionary(this.strm, t)))
  throw Error(s[c]);
this._dict_set = !0;
  }
}
...
return !1;
  ...
  do {
if (0 === o.avail_out && (o.output = new i.Buf8(u), o.next_out = 0, o.avail_out = u), 1 !== (n = r.deflate(o, s)) && 0 !== n)
...
t.Deflate = u, t.deflate = c, t.deflateRaw = function(e, t) {

...
function h(e, t) {
  let n = (0, u.Z)(t),
    h = (0, a.e7)([o.default, r.Z, s.ZP], () => (function(e) {
      let [t, n, i] = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [o.default, r.Z, s.ZP];
      if (null == e) return !1;
      let a = n.getGuild(e);
    ...
    })(e, [o.default, r.Z, s.ZP]), [e]),
    p = (0, l.FT)(i.C.ADOPT_CLAN_IDENTITY_NOTICE, null != e ? e : d.lds);
  return n && h && !p
}
...
var a = n(735250), l = n(470079), s = n(120356), r = n.n(s), o = n(442837), i = n(481060), d = n(129861), c = n(700582), u = n(410030), m = n(566006), f = n(222677), b = n(592125), _ = n(594174), h = n(514342), v = n(768581), x = n(176354), p = n(5192), j = n(91047), g = n(79390), T = n(918088), S = n(22864), L = n(981631), M = n(689938), E = n(240270), N = n(144452);
let C = m.O.VOTE;
function O() {
    let e = (0, u.ZP)();
...
function A(e) {
    ...
    return (0, a.jsx)(i.TabBar, {
        ...
        children: t.answers.map(e => {
            var t;
            let s = String(e.answer_id), o = null !== (t = n[s]) && void 0 !== t ? t : 0, {
                    emoji: d,
                    text: c
                } = e.poll_media, u = M.Z.Messages.POLL_ANSWER_VOTES_MODAL_VOTE_TAB.format({
                    numVotes: o,
                    option: c
                }), m = l === s;
...
function P(e) {
    ...
    let _ = l.useCallback(() => {
            ...
            if (1 === t)
                return 0 === n ? (0, a.jsx)(i.Spinner, { className: E.spinnerMore }, 'hasMore') : null;
            return 0 === r.length && u ? (0, a.jsx)(i.Spinner, { className: E.spinner }, 'loadingMore') : null != l && (0, a.jsx)(I, {
                channel: s,
                user: l
            }, l.id);
        }, [
...
function w(e) {
    ...
    let {
            ...
            for (let l of e) {
                var n, a;
                let e = null !== (a = null === (n = l.count_details) || void 0 === n ? void 0 : n.vote) && void 0 !== a ? a : 0, s = l.emoji.id;
                null != s && (t[s] = e);
            }
            return t;
                    ...
                    (0, a.jsxs)('div', {
                        children: [
                            ...
                            (0, a.jsx)(i.Text, {
                                ...
                                color: 'text-normal',
                                children: M.Z.Messages.POLL_VOTES_COUNT.format({ count: _.toLocaleString() })
                            })
                        ]
                    }),

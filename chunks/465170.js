...
e.exports = t, t.Node = n, t.create = t, t.prototype.removeNode = function (e) {
    ...
    n = n || this;
    for (var r = new t(), i = this.head; null !== i;)
        r.push(e.call(n, i.value, this)), i = i.next;
    return r;
}, t.prototype.mapReverse = function (e, n) {
    n = n || this;
    for (var r = new t(), i = this.tail; null !== i;)
        r.push(e.call(n, i.value, this)), i = i.prev;
    return r;
    ...
    for (var e = Array(this.length), t = 0, n = this.head; null !== n; t++)
        e[t] = n.value, n = n.next;
    return e;
}, t.prototype.toArrayReverse = function () {
    for (var e = Array(this.length), t = 0, n = this.tail; null !== n; t++)
    ...
    for (var i = 0, a = this.head; null !== a && i < e; i++)
        a = a.next;
    for (; null !== a && i < n; i++, a = a.next)
        r.push(a.value);
    return r;
    ...
    if (n < e || n < 0)
        return r;
    e < 0 && (e = 0), n > this.length && (n = this.length);
    for (var i = this.length, a = this.tail; null !== a && i > n; i--)
        a = a.prev;
    for (; null !== a && i > e; i--, a = a.prev)
        r.push(a.value);
    return r;

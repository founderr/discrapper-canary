...
var e, a = (e = 'undefined' != typeof document && document.currentScript ? document.currentScript.src : void 0, function (t) {
        var n, a, u, i, o, f, c, s, l, m, h, g, y, p, _, d, v, w, b, A = void 0 !== (t = t || {}) ? t : {};
        ...
        var D = {};
        for (i in A)
            A.hasOwnProperty(i) && (D[i] = A[i]);
        var M = [], S = './this.program', F = function (t, n) {
                throw n;
            }, R = '';
        ...
        var E = A.print || console.log.bind(console), Y = A.printErr || console.warn.bind(console);
        for (i in D)
            D.hasOwnProperty(i) && (A[i] = D[i]);
        D = null, A.arguments && (M = A.arguments), A.thisProgram && (S = A.thisProgram), A.quit && A.quit;
        var O = 0, k = function (t) {
                O = t;
            };
        ...
        function x(t, n, r) {
            ...
            for (var u = ''; n < a;) {
                ...
                var f = 63 & t[n++];
                if ((i = (240 & i) == 224 ? (15 & i) << 12 | o << 6 | f : (7 & i) << 18 | o << 12 | f << 6 | 63 & t[n++]) < 65536)
                    u += String.fromCharCode(i);
                else {
                    var c = i - 65536;
        ...
        var Q = 0, $ = 4, tt = 8, tn = 12, tr = 13, te = 16;
        function ta(t) {
            this.excPtr = t, this.ptr = t - te, this.set_type = function (t) {
                p[this.ptr + tt >> 2] = t;
        ...
        var tu = 0, ti = {
                ...
                printChar: function (t, n) {
                    var r = ti.buffers[t];
                    0 === n || 10 === n ? ((1 === t ? E : Y)(x(r, 0)), r.length = 0) : r.push(n);
                },
                varargs: void 0,
                get: function () {
        ...
        function th(t, n) {
            for (var r = new Date(t.getTime()); n > 0;) {
                var e = tc(r.getFullYear()), a = r.getMonth(), u = (e ? tl : tm)[a];
                if (n > u - r.getDate())
                    n -= u - r.getDate() + 1, r.setDate(1), a < 11 ? r.setMonth(a + 1) : (r.setMonth(0), r.setFullYear(r.getFullYear() + 1));
                else {
        ...
        var tg = {
            ...
            s: function (t, n) {
                var r = 0;
                return tf().forEach(function (e, a) {
                    var u = n + r;
                    p[t + 4 * a >> 2] = u, !function (t, n, r) {
            ...
            u: function (t, n, r, e) {
                var a = ti.getStreamFromFD(t), u = ti.doReadv(a, n, r);
                return p[e >> 2] = u, 0;
            },
            ...
            r: function (t, n, r, e) {
                return function (t, n, r, e) {
                    ...
                    function g(t, n, r) {
                        for (var e = 'number' == typeof t ? t.toString() : t || ''; e.length < n;)
                            e = r[0] + e;
                        return e;
                    }
                    function y(t, n) {
                    ...
                    function v(t) {
                        var n = th(new Date(t.tm_year + 1900, 0, 1), t.tm_yday), r = new Date(n.getFullYear(), 0, 4), e = new Date(n.getFullYear() + 1, 0, 4), a = d(r), u = d(e);
                        return 0 >= _(a, n) ? 0 >= _(u, n) ? n.getFullYear() + 1 : n.getFullYear() : n.getFullYear() - 1;
                    }
                    var w = {
                        '%a': function (t) {
                        ...
                        '%j': function (t) {
                            return y(t.tm_mday + ts(tc(t.tm_year + 1900) ? tl : tm, t.tm_mon - 1), 3);
                        },
                        '%m': function (t) {
                        ...
                        '%U': function (t) {
                            var n = new Date(t.tm_year + 1900, 0, 1), r = 0 === n.getDay() ? n : th(n, 7 - n.getDay()), e = new Date(t.tm_year + 1900, t.tm_mon, t.tm_mday);
                            if (0 > _(r, e)) {
                                var a = ts(tc(e.getFullYear()) ? tl : tm, e.getMonth() - 1) - 31;
                                return y(Math.ceil((31 - r.getDate() + a + e.getDate()) / 7), 2);
                            }
                            return 0 === _(r, n) ? '01' : '00';
                        },
                        '%V': function (t) {
                            var n, r = new Date(t.tm_year + 1900, 0, 4), e = new Date(t.tm_year + 1901, 0, 4), a = d(r), u = d(e), i = th(new Date(t.tm_year + 1900, 0, 1), t.tm_yday);
                        ...
                        '%W': function (t) {
                            var n = new Date(t.tm_year, 0, 1), r = 1 === n.getDay() ? n : th(n, 0 === n.getDay() ? 1 : 7 - n.getDay() + 1), e = new Date(t.tm_year + 1900, t.tm_mon, t.tm_mday);
                            if (0 > _(r, e)) {
                                var a = ts(tc(e.getFullYear()) ? tl : tm, e.getMonth() - 1) - 31;
                                return y(Math.ceil((31 - r.getDate() + a + e.getDate()) / 7), 2);
                            }
                    ...
                    for (var s in w)
                        f.indexOf(s) >= 0 && (f = f.replace(RegExp(s, 'g'), w[s](o)));
        ...
        !function () {
            ...
            function r(t, n) {
                var r = t.exports;
                A.asm = r, U((s = A.asm.x).buffer), w = A.asm.z, !function (t) {
            ...
            t = 0, G++, A.monitorRunDependencies && A.monitorRunDependencies(G);
            ...
            (f || 'function' != typeof WebAssembly.instantiateStreaming || V(X) || 'function' != typeof fetch ? a(e) : fetch(X, { credentials: 'same-origin' }).then(function (t) {
                return WebAssembly.instantiateStreaming(t, n).then(e, function (t) {
                    return Y('wasm streaming compile failed: ' + t), Y('falling back to ArrayBuffer instantiation'), a(e);
                });
            })).catch(u);
        }();
        var ty = A.___wasm_call_ctors = function () {
                return (ty = A.___wasm_call_ctors = A.asm.y).apply(null, arguments);
                ...
                return (A._lottie_draw_into_rgba = A.asm.D).apply(null, arguments);
            }, tw = A._lottie_draw_into_bgra = function () {
                return (A._lottie_draw_into_bgra = A.asm.E).apply(null, arguments);
        ...
        function tY(t) {
            if (t = t || M, !(G > 0))
                !function () {
                    ...
                    Z(j);
                }(), !(G > 0) && (A.setStatus ? (A.setStatus('Running...'), setTimeout(function () {
                    setTimeout(function () {
                        A.setStatus('');
                    }, 1), n();
                }, 1)) : n());
            function n() {
                if (!b)
                    b = !0, A.calledRun = !0, !C && (Z(B), Z(z), a(A), A.onRuntimeInitialized && A.onRuntimeInitialized(), !function () {
                        if (A.postRun)
                    ...
                    return function (t, n, r, e, a) {
                        ...
                        if (e)
                            for (var s = 0; s < e.length; s++) {
                                var l = i[r[s]];
                                l ? (0 === c && (c = tS()), f[s] = l(e[s])) : f[s] = e[s];
                            }
                        var g = o.apply(null, f);
                        return u = g, g = 'string' === n ? P(u) : 'boolean' === n ? !!u : u, 0 !== c && tF(c), g;
                    }(t, n, r, arguments, 0);
                };
            }, q = function t() {
                !b && tY(), !b && (q = t);

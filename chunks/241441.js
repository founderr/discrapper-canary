...
var e, a = (e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, function(t) {
  ...
  var tg = {
    a: function(t, n, r, e) {
      J("Assertion failed: " + P(t) + ", at: " + [n ? P(n) : "unknown filename", r, e ? P(e) : "unknown function"])
    },
    g: function(t) {
      return tp(t + te) + te
    },
    ...
    q: function(t) {
      ...
      for (var r = 1; r <= 4; r *= 2) {
        ...
        if (u = Math.min(u, t + 100663296), function(t) {
          ...
          }(Math.min(67108864, (a = 65536, (e = Math.max(16777216, t, u)) % 65536 > 0 && (e += a - e % a), e)))) return !0
      }
      return !1
    },
    s: function(t, n) {
  ...
  ! function() {
    ...
    function a(t) {
      return (f || "function" != typeof fetch ? Promise.resolve().then(function() {
        ...
        if (!t.ok) throw "failed to load wasm binary file at '" + X + "'";
  ...
  function tY(t) {
    if (t = t || M, !(G > 0)) ! function() {
      if (A.preRun)
        for ("function" == typeof A.preRun && (A.preRun = [A.preRun]); A.preRun.length;)(function(t) {
          j.unshift(t)
        })(A.preRun.shift());
      Z(j)
    ...
    function n() {
      if (!b) b = !0, A.calledRun = !0, !C && (Z(B), Z(z), a(A), A.onRuntimeInitialized && A.onRuntimeInitialized(), ! function() {
        if (A.postRun)
          for ("function" == typeof A.postRun && (A.postRun = [A.postRun]); A.postRun.length;)(function(t) {
            L.unshift(t)
          })(A.postRun.shift());
        Z(L)
      }())

...
a(l, o),
    ...
    (u.prototype._projDbl = function () {
        ...
        } else (r = s.redAdd(l)), (i = this.curve._mulC(this.z).redSqr()), (a = r.redSub(i).redSub(i)), (e = this.curve._mulC(o.redISub(r)).redMul(a)), (t = this.curve._mulC(r).redMul(s.redISub(l))), (n = r.redMul(a));

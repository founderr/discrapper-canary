...
a(l, s), e.exports = l, l.prototype._mulA = function(e) {
...
i = this.c2.redMul(this.one.redAdd(this.d.redMul(t).redMul(n)));
  return 0 === r.cmp(i);
}, a(u, s.BasePoint), l.prototype.pointFromJSON = function(e) {
...
d = s.redMul(a);
  ...
  var e, t, n, r, i, a, s = this.x.redAdd(this.y).redSqr(),
o = this.x.redSqr(),
l = this.y.redSqr();
...
r = o.redAdd(l), i = this.curve._mulC(this.z).redSqr(), a = r.redSub(i).redSub(i), e = this.curve._mulC(s.redISub(r)).redMul(a), t = this.curve._mulC(r).redMul(o.redISub(l)), n = r.redMul(a);

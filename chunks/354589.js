...
n.default = (0, l.Z)((0, t.Z)(function(e) {
  ...
  let {
    ...
    user: r
  }), B = (0, O.Z)(r.id), Y = (0, R.Z)(r.id, t.id), X = (0, U.Z)(r.id), q = (0, f.P)({
    userId: r.id,
    channelId: t.id,
    location: "GroupDMUserContextMenu"
  }), J = (0, C.Z)(r.id, t.id), Q = (0, N.Z)({
    user: r
  }), $ = (0, o.Z)(null, r), ee = (0, g.Z)(r), en = (0, x.Z)({
    user: r
  }), er = (0, M.Z)({
    id: r.id,
  ...
  return (0, i.jsxs)(s.Menu, {
    ...
    onSelect: w,
    children: [!eu && (0, i.jsxs)(i.Fragment, {
      children: [(0, i.jsx)(s.MenuGroup, {
        children: et
      }), (0, i.jsxs)(s.MenuGroup, {
        children: [L && y, u && V, D, W, !ec && z, L && H, L && K, ei]
      }), G && (0, i.jsx)(s.MenuGroup, {
        children: B
        ...
        children: [G && X, G && q, G && J, ed, L && Q, ee, L && en, G && el]

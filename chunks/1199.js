let r = n(689118), i = n(814033), a = n(873994).DecoderBuffer, o = n(206424), s = n(375990);
function l(e) {
...
function c(e, t) {
    ...
    if (e.isError(n))
        return n;
    let r = s.tagClass[n >> 6], i = (32 & n) == 0;
    if ((31 & n) == 31) {
        let r = n;
        for (n = 0; (128 & r) == 128;) {
            if (r = e.readUInt8(t), e.isError(r))
                return r;
            n <<= 7, n |= 127 & r;
        }
    } else
...
e.exports = l, l.prototype.decode = function (e, t) {
    ...
    if (e.isEmpty())
        return !1;
    let r = e.save(), i = c(e, 'Failed to peek tag: "' + t + '"');
    ...
    let a = e.save(), o = this._skipUntilEnd(e, 'Failed to skip indefinite length body: "' + this.tag + '"');

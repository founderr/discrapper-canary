...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(512722), l = n.n(s), u = n(913527), c = n.n(u), d = n(442837), _ = n(952265), E = n(780384), f = n(481060), h = n(410030), p = n(607070), m = n(238302), I = n(703656), T = n(483444), g = n(599250), S = n(424218), A = n(380684), N = n(74538), v = n(960048), O = n(861990), R = n(98278), C = n(639119), y = n(197115), D = n(823188), L = n(474936), b = n(981631), M = n(689938), P = n(927523), U = n(867250);
function w(e) {
    if (null == e)
        return null;
    ...
    if (n > 1)
        return M.Z.Messages.PREMIUM_TRIAL_OFFER_ENDS_HOURS.format({ numHours: n });
        ...
        children: [
            (0, r.jsxs)('div', {
                ...
                children: [
                    ...
                    E === L.Si.TIER_0 && (0, r.jsx)(g.Z, { className: P.logoWordmark }),
                    E === L.Si.TIER_2 && (0, r.jsx)(T.Z, { className: P.logoWordmark })
                ]
            }),
            (0, r.jsx)(f.Text, {
...
function G(e) {
    ...
    let {
            ...
            trialOffer: u,
            discountOffer: c
        } = e, [d, _] = i.useState(!1), E = null != c ? M.Z.Messages.PREMIUM_DISCOUNT_CTA.format({ percent: c.discount.amount }) : (0, N.Rt)({
...
function k(e) {
    var t, n;
    let i = null === (t = (0, C.N)()) || void 0 === t ? void 0 : t.subscription_trial, a = null !== (n = null == i ? void 0 : i.sku_id) && void 0 !== n ? n : L.Si.TIER_2;
...
function H(e) {
    let {
            ...
            trialOffer: g,
            discountOffer: R
        } = e, C = (0, d.e7)([p.Z], () => p.Z.useReducedMotion), y = (0, h.ZP)(), D = (0, A.Xv)() ? O.Ld : O.zz, w = (0, S.BU)(D / S.XD, { useKibibytes: !0 });
    switch (u) {
    ...
    case L.cd.MESSAGE_LENGTH_IN_EDITOR_UPSELL:
        return (0, r.jsxs)('div', {
            className: o()(P.messageLengthUpsellContainer, { [P.messageLengthUpsellAppearAnimation]: !C }),
            children: [
                (0, r.jsx)(f.Text, {

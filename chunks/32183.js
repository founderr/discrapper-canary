...
e = n.nmd(e), n("424973"), n("70102"), n("808653"), n("781738"), n("843762"), r = this, a = function(e) {
  ...
  function A(e, t, n, r, a) {
    ...
    return o && _(o, o.next) && (G(o), o = o.next), o
  }
  ...
  function L(e, t) {
    ...
    var n, r = e;
    do
      if (n = !1, r.steiner || !_(r, r.next) && 0 !== V(r.prev, r, r.next)) r = r.next;
      else {
      ...
      for (var s, c, l = e; e.prev !== e.next;)
        if (s = e.prev, c = e.next, i ? function(e, t, n, r) {
            ...
            for (var o = a.x < e.x ? a.x < i.x ? a.x : i.x : e.x < i.x ? e.x : i.x, s = a.y < e.y ? a.y < i.y ? a.y : i.y : e.y < i.y ? e.y : i.y, c = a.x > e.x ? a.x > i.x ? a.x : i.x : e.x > i.x ? e.x : i.x, l = a.y > e.y ? a.y > i.y ? a.y : i.y : e.y > i.y ? e.y : i.y, u = j(o, s, t, n, r), d = j(c, l, t, n, r), p = e.nextZ; p && p.z <= d;) {
              if (p !== e.prev && p !== e.next && K(a.x, a.y, e.x, e.y, i.x, i.y, p.x, p.y) && V(p.prev, p, p.next) >= 0) return !1;
              p = p.nextZ
            }
            ...
            var t = e.prev,
              n = e.next;
            if (V(t, e, n) >= 0) return !1;
            for (var r = e.next.next; r !== e.prev;) {
              if (K(t.x, t.y, e.x, e.y, n.x, n.y, r.x, r.y) && V(r.prev, r, r.next) >= 0) return !1;
              r = r.next
            }
            return !0
        ...
        o ? 1 === o ? N(e = function(e, t, n) {
          ...
          do {
            var a = r.prev,
              i = r.next.next;
            !_(a, i) && z(a, r, r.next, i) && B(a, i) && B(i, a) && (t.push(a.i / n), t.push(r.i / n), t.push(i.i / n), G(r), G(r.next), r = e = i), r = r.next
          } while (r !== e);
          return r
  ...
  function B(e, t) {
    return 0 > V(e.prev, e, e.next) ? V(e, t, e.next) >= 0 && V(e, e.prev, t) >= 0 : 0 > V(e, t, e.prev) || 0 > V(e, e.next, t)
  }

  function U(e, t) {
    var n = new q(e.i, e.x, e.y),
      r = new q(t.i, t.x, t.y),
      a = e.next,
      i = t.prev;
  ...
  var es = {
    ...
    ep = function(e, t, n, r, a, i, s, c, l) {
      ...
      z /= B;
      for (var U = 0; U < B; U++) V.push(function(e, t) {
  ...
  var eO = function(e) {
    ...
    ez = (e_(eV).right, function(e, t) {
      var n, r, a, i;
      return function(e, t) {
        for (var n = e.objects.triangles.geometries, r = e_(function(e) {
            return e.area
  ...
  e.interpolate = function(e, t, n) {
    ...
    return i ? (e.every(function(e) {
      ...
      return "string" == typeof e
    }) && (s = t.slice(0))) : (o = e.slice(0), s = t.slice(0)), X(l, u, {
      string: a,
      single: i,
      t0: o,
      t1: s,

...
var t = {
    ...
    'creditCard.cvcField.title': 'Sicherheitscode',
    'creditCard.cvcField.placeholder': '123',
    'creditCard.storeDetailsButton': 'Für das nächste Mal speichern',
    ...
    'sr.wechatpay.timetopay': 'Sie haben %#Minuten%# %#Sekunden%# Zeit, um zu bezahlen',
    ...
    firstName: 'Vorname',
    'firstName.invalid': 'Geben Sie Ihren Vornamen ein',
    infix: 'Vorwahl',
    lastName: 'Nachname',
    'lastName.invalid': 'Geben Sie Ihren Nachnamen ein',
    mobileNumber: 'Handynummer',
    'mobileNumber.invalid': 'Ungültige Handynummer',
    city: 'Stadt',
    ...
    'address.placeholder': 'Suchen Sie Ihre Adresse',
    'address.errors.incomplete': 'Geben Sie eine Adresse ein, um fortzufahren',
    'address.enterManually': 'Geben Sie die Adresse manuell ein',
    state: 'Bundesstaat',
    ...
    'ach.accountHolderNameField.placeholder': 'A. Müller',
    'ach.accountHolderNameField.invalid': 'Ungültiger Kontoinhabername',
    'ach.accountNumberField.title': 'Kontonummer',
    'ach.accountNumberField.invalid': 'Ungültige Kontonummer',
    ...
    'error.va.gen.02': 'Feld ungültig',
    'error.va.sf-cc-num.01': 'Geben Sie eine gültige Kartennummer ein',
    'error.va.sf-cc-num.02': 'Geben Sie die Kartennummer ein',
    'error.va.sf-cc-num.03': 'Geben Sie eine unterstützte Kartenmarke ein',
    'error.va.sf-cc-num.04': 'Geben Sie die vollständige Kartennummer ein',
    'error.va.sf-cc-dat.01': 'Geben Sie ein gültiges Ablaufdatum ein',
    'error.va.sf-cc-dat.02': 'Geben Sie ein gültiges Ablaufdatum ein',
    'error.va.sf-cc-dat.03': 'Kreditkarte läuft bald ab',
    'error.va.sf-cc-dat.04': 'Geben Sie das Ablaufdatum ein',
    'error.va.sf-cc-dat.05': 'Geben Sie das vollständige Ablaufdatum ein',
    'error.va.sf-cc-mth.01': 'Geben Sie den Ablaufmonat ein',
    'error.va.sf-cc-yr.01': 'Geben Sie das Ablaufjahr ein',
    'error.va.sf-cc-yr.02': 'Geben Sie das vollständige Ablaufjahr ein',
    'error.va.sf-cc-cvc.01': 'Geben Sie den Sicherheitscode ein',
    'error.va.sf-cc-cvc.02': 'Geben Sie den vollständigen Sicherheitscode ein',
    'error.va.sf-ach-num.01': 'Das Feld für die Bankkontonummer ist leer',
    'error.va.sf-ach-num.02': 'Die Bankkontonummer hat die falsche Länge',
    'error.va.sf-ach-loc.01': 'Das Feld für die Bankleitzahl ist leer',
    'error.va.sf-ach-loc.02': 'Die Bankleitzahl hat die falsche Länge',
    'error.va.sf-kcp-pwd.01': 'Das Passwortfeld ist leer',
    'error.va.sf-kcp-pwd.02': 'Das Passwort hat die falsche Länge',
    ...
    'error.giftcard.currency-error': 'Geschenkkarten sind nur in der Währung gültig, in der sie ausgestellt wurden',
    'amazonpay.signout': 'Von Amazon abmelden',
    'amazonpay.changePaymentDetails': 'Zahlungsinformationen ändern',
    'partialPayment.warning': 'Wählen Sie eine andere Zahlungsmethode zur Zahlung des Restbetrags',
    'partialPayment.remainingBalance': 'Es verbleibt ein Restbetrag von %{amount}',
    'bankTransfer.beneficiary': 'Empfänger',
    ...
    'creditCard.encryptedCardNumber.aria.iframeTitle': 'Iframe für Kartennummer',
    'creditCard.encryptedCardNumber.aria.label': 'Kartennummer',
    'creditCard.encryptedExpiryDate.aria.iframeTitle': 'Iframe für Ablaufdatum',
    'creditCard.encryptedExpiryDate.aria.label': 'Ablaufdatum',
    'creditCard.encryptedExpiryMonth.aria.iframeTitle': 'Iframe für Ablaufmonat',
    'creditCard.encryptedExpiryMonth.aria.label': 'Monat des Ablaufdatums',
    'creditCard.encryptedExpiryYear.aria.iframeTitle': 'Iframe für Ablaufjahr',
    'creditCard.encryptedExpiryYear.aria.label': 'Jahr des Ablaufdatums',
    'creditCard.encryptedSecurityCode.aria.iframeTitle': 'Iframe für Sicherheitscode',
    'creditCard.encryptedSecurityCode.aria.label': 'Sicherheitscode',
    'creditCard.encryptedPassword.aria.iframeTitle': 'Iframe für Passwort',
    'creditCard.encryptedPassword.aria.label': 'Die ersten zwei Ziffern des Kartenpassworts',
    'giftcard.encryptedCardNumber.aria.iframeTitle': 'Iframe für Kartennummer',
    'giftcard.encryptedCardNumber.aria.label': 'Kartennummer',
    'giftcard.encryptedSecurityCode.aria.iframeTitle': 'Iframe für Stift',
    ...
    'ach.encryptedBankAccountNumber.aria.label': 'Kontonummer',
    'ach.encryptedBankLocationId.aria.iframeTitle': 'Iframe für Bankleitzahl',
    'ach.encryptedBankLocationId.aria.label': 'ABA-Nummer',
    'twint.saved': 'hinterlegt',
    orPayWith: 'oder bezahlen Sie mit',
    invalidFormatExpects: 'Ungültiges Format. Erwartetes Format: %{format}',
    ...
    'ctp.cards.subtitle': 'Wählen Sie die Karte aus, die Sie verwenden möchten.',
    ...
    'ctp.infoPopup.benefit1': 'Click to Pay nutzt Verschlüsselung zum Schutz Ihrer Daten',

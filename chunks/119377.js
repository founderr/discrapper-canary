...
var t = {
  ...
  gender: "Geschlecht",
  "gender.notselected": "W\xe4hlen Sie ein Geschlecht aus",
  male: "M\xe4nnlich",
  female: "Weiblich",
  ...
  "error.va.sf-cc-num.01": "Geben Sie eine g\xfcltige Kartennummer ein",
  "error.va.sf-cc-num.02": "Geben Sie die Kartennummer ein",
  "error.va.sf-cc-num.03": "Geben Sie eine unterst\xfctzte Kartenmarke ein",
  "error.va.sf-cc-num.04": "Geben Sie die vollst\xe4ndige Kartennummer ein",
  "error.va.sf-cc-dat.01": "Geben Sie ein g\xfcltiges Ablaufdatum ein",
  "error.va.sf-cc-dat.02": "Geben Sie ein g\xfcltiges Ablaufdatum ein",
  "error.va.sf-cc-dat.03": "Kreditkarte l\xe4uft bald ab",
  "error.va.sf-cc-dat.04": "Geben Sie das Ablaufdatum ein",
  "error.va.sf-cc-dat.05": "Geben Sie das vollst\xe4ndige Ablaufdatum ein",
  "error.va.sf-cc-mth.01": "Geben Sie den Ablaufmonat ein",
  "error.va.sf-cc-yr.01": "Geben Sie das Ablaufjahr ein",
  "error.va.sf-cc-yr.02": "Geben Sie das vollst\xe4ndige Ablaufjahr ein",
  "error.va.sf-cc-cvc.01": "Geben Sie den Sicherheitscode ein",
  "error.va.sf-cc-cvc.02": "Geben Sie den vollst\xe4ndigen Sicherheitscode ein",
  ...
  "creditCard.encryptedCardNumber.aria.iframeTitle": "Iframe f\xfcr Kartennummer",
  "creditCard.encryptedCardNumber.aria.label": "Kartennummer",
  "creditCard.encryptedExpiryDate.aria.iframeTitle": "Iframe f\xfcr Ablaufdatum",
  "creditCard.encryptedExpiryDate.aria.label": "Ablaufdatum",
  "creditCard.encryptedExpiryMonth.aria.iframeTitle": "Iframe f\xfcr Ablaufmonat",
  "creditCard.encryptedExpiryMonth.aria.label": "Monat des Ablaufdatums",
  "creditCard.encryptedExpiryYear.aria.iframeTitle": "Iframe f\xfcr Ablaufjahr",
  "creditCard.encryptedExpiryYear.aria.label": "Jahr des Ablaufdatums",
  "creditCard.encryptedSecurityCode.aria.iframeTitle": "Iframe f\xfcr Sicherheitscode",
  "creditCard.encryptedSecurityCode.aria.label": "Sicherheitscode",
  "creditCard.encryptedPassword.aria.iframeTitle": "Iframe f\xfcr Passwort",
  "creditCard.encryptedPassword.aria.label": "Die ersten zwei Ziffern des Kartenpassworts",
  "giftcard.encryptedCardNumber.aria.iframeTitle": "Iframe f\xfcr Kartennummer",
  "giftcard.encryptedCardNumber.aria.label": "Kartennummer",
  "giftcard.encryptedSecurityCode.aria.iframeTitle": "Iframe f\xfcr Stift",
  ...
  "ach.encryptedBankAccountNumber.aria.iframeTitle": "Iframe f\xfcr Bankkontonummer",
  "ach.encryptedBankAccountNumber.aria.label": "Kontonummer",
  "ach.encryptedBankLocationId.aria.iframeTitle": "Iframe f\xfcr Bankleitzahl",
  ...
  "consent.checkbox.invalid": "Sie m\xfcssen den Gesch\xe4ftsbedingungen zustimmen",
  "form.instruction": "Alle Felder sind Pflichtfelder, sofern nicht anders gekennzeichnet.",
  "trustly.descriptor": "Online Direkt\xfcberweisung",

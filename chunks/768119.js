...
a = i.indexOf(r); -
  1 !== a ? (i.splice(a, 1), i.unshift(r)) : null != i[0] && '' !== i[0] && r.startsWith(i[0]) ? i[0] = r : a < 0 && i.unshift(r), i.length > 5 && i.splice(5, i.length), d.K.set(N, {
history: O
  });
}
...
null == t ? (d.K.remove(N), O = {}) : (delete O[t], d.K.set(N, {
  history: O
}));
  },
...
null != O[t] && (O[t] = O[t].filter(e => e !== n), d.K.set(N, {
  history: O
}));
  },

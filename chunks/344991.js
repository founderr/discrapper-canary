...
function v(e) {
  let {
    ...
    maxValues: h,
    disabled: T
  } = n, [x, y] = u.useState(!1), [g, O] = u.useState(!1), [I, j] = u.useState(new Map(null == o ? void 0 : o.map(e => [e.value, e]))), [_, L] = u.useState(new Set(I.keys())), [M, R] = u.useState(() => (null != o ? o : []).map(e => e.value)), [A, b] = u.useState(0);
  u.useEffect(() => {

...
function h(e) {
  let {
    ...
    maxValues: I,
    disabled: g
  } = l, [x, S] = a.useState(!1), [j, T] = a.useState(!1), [_, L] = a.useState(new Map(null == s ? void 0 : s.map(e => [e.value, e]))), [Z, M] = a.useState(new Set(_.keys())), [O, A] = a.useState(() => (null != s ? s : []).map(e => e.value)), [R, y] = a.useState(0);
  a.useEffect(() => {
    let e = (null != s ? s : []).map(e => e.value);
    if (e.every(e => O.includes(e)) && O.every(l => e.includes(l))) return;
    A(e);
    let l = new Map(null == s ? void 0 : s.map(e => [e.value, e]));
  ...
  a.useEffect(() => {
    if (!(x || j || _.size === Z.size && Array.from(_.keys()).every(e => Z.has(e)))) B()
  }, [x, j, Z, _, B]);
  let V = 0 === _.size || x,
    z = {
      isDisabled: g || w,
  ...
  return (0, r.jsxs)(a.Fragment, {
    children: [(0, r.jsxs)("div", {
      ...
      children: [I > 1 ? (0, r.jsx)(o.SearchableSelect, {
        className: v.badges,
        value: Array.from(_.values()),
        onChange: e => {
          !x && T(!0), L(new Map(e.map(e => [e.value, e])))
        },
        multi: !0,
        inputClassNames: u()({

...
var n = t(544891), r = t(570140), s = t(618541), l = t(751767), o = t(358085), i = t(355467), c = t(981631);
function u() {
    (0, l.S)().then(e => {
        e.client.create({ authorization: c.Ai1.BRAINTREE.KEY }).then(e => {
            r.Z.dispatch({
...
function E() {
    ...
    (0, l.S)().then(a => {
        a.paypal.create({ client: e }).then(e => {
...
function _() {
    ...
    (0, o.isDesktop)() && (a = (0, i.EH)(c.HeQ.PAYPAL)), a.then(() => e.tokenize({ flow: 'vault' })).then(e => {
        let {
            email: a,
            firstName: t,
            lastName: n,
        ...
        t === c.U66.PAYPAL_POPUP_CLOSED || null == t ? r.Z.dispatch({ type: 'BRAINTREE_TOKENIZE_PAYPAL_FAIL_WINDOW_CLOSED' }) : r.Z.dispatch({
...
function p() {
    ...
    r.Z.dispatch({ type: 'BRAINTREE_TOKENIZE_VENMO_START' }), e.tokenize().then(e => {
        ...
        t === c.U66.VENMO_APP_CANCELED || t === c.U66.VENMO_CANCELED ? r.Z.dispatch({ type: 'BRAINTREE_TOKENIZE_VENMO_FAIL_CANCELED' }) : r.Z.dispatch({
...
function A() {
    return m(s.Z.getPayPalClient(), { type: 'BRAINTREE_TEARDOWN_PAYPAL_CLIENT' });
}
function N() {
    return m(s.Z.getVenmoClient(), { type: 'BRAINTREE_TEARDOWN_VENMO_CLIENT' });
}
function h() {
    return Promise.all([
        A(),
...
function T() {
    ...
    null == e ? _() : (r.Z.dispatch({ type: 'BRAINTREE_TOKENIZE_PAYPAL_START' }), window.open(e));
}
function I() {
    p();
}

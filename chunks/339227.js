...
var r = n(512722), i = n.n(r), a = n(31775), o = n.n(a), s = n(302454), l = n(25209), u = n(710845), c = n(772096), d = n(428595), _ = n(594199), E = n(364458), f = n(70956), h = n(40786), p = n(362092);
let m = {
        link: { type: 'skip' },
        highlight: { type: 'skip' },
...
function L(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], i = p.rN(e);
            ...
            '' !== l && function (e, t, n) {
                ...
                let l = function (e) {
                    ...
                    for (let n = 1; n < e.length; n++) {
                        let r = t[t.length - 1], i = r.start + r.text.length, a = e[n];
...
function P(e, t, n, r, a) {
    if (n.length > 0) {
        let o = t.indexOf(n, r), s = t.substring(r, o + n.length);
...
function U(e) {
    ...
    let c = s + r.length, d = n.substring(i, c);
    return t.push({
        text: d,
        attributes: a.slice(),
        start: i,

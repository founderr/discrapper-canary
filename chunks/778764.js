    ...
    let { transitionState: s, onClose: r, ticket: l, challenge: c } = e,
        ...
        P = async () => {
            ...
            try {
                ...
                T.Z.captureException(e), L(C.Z.Messages.MFA_V2_WEBAUTHN_GENERIC_ERROR), x(m.x.INIT);
                return;
            }
            f(e), x(m.x.NAME);
        };
            ...
            (0, n.jsxs)(o.ModalHeader, {
                ...
                children: [
                    (0, n.jsxs)(o.Heading, {
                        ...
                        children: [R === m.x.INIT && C.Z.Messages.TWO_FA_WEBAUTHN_REGISTER, R === m.x.REGISTER && C.Z.Messages.TWO_FA_WEBAUTHN_INTERACT, R === m.x.NAME && C.Z.Messages.TWO_FA_WEBAUTHN_NAME]
                    }),
                            ...
                            onSubmit: (e) => {
                                e.preventDefault(),
                                    (0, I.Sr)(N, l, M)
                                        ...
                                        .then(() => r())
                                        .catch(() => {
                                            L(C.Z.Messages.ERROR_OCCURRED_TRY_AGAIN), x(m.x.INIT);
                                        });
                            },
                            children: [
                                (0, n.jsxs)(o.ModalContent, {

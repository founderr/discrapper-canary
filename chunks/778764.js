...
var n = s(735250), a = s(470079), i = s(849055), r = s(442837), o = s(481060), l = s(239091), c = s(202858), d = s(153124), _ = s(360048), E = s(287880), u = s(358085), T = s(960048), I = s(998502), S = s(365007), N = s(15980), C = s(755733), m = s(981631), A = s(689938), h = s(277605);
function g(e) {
    let {
            transitionState: t,
            onClose: r,
            ...
            (0, n.jsx)(o.MenuItem, {
                ...
                action: () => {
                    (0, o.openModalLazy)(async () => {
                        let {default: e} = await s.e('804').then(s.bind(s, 89616));
                        return t => (0, n.jsx)(e, {
                            credential: a,
                            ...t
                        });

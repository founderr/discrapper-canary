...
var t = E("811022"),
  o = E("377678");
let I = new t.default("Flux"),
  T = e => e();
var r = new class e {
  destroy() {
    this.changedStores.clear(), this.reactChangedStores.clear(), T = e => e()
  }
  ...
  emit() {
    !this.isBatchEmitting && !this.isPaused && T(() => {
      try {
        this.isBatchEmitting = !0, this.changeSentinel++;
        let e = 0;
        for (; this.changedStores.size > 0;) {
          if (++e > 100) throw I.error("LastFewActions", o.serialize()), Error("change emit loop detected, aborting");
          this.emitNonReactOnce()
        }
        for (; this.reactChangedStores.size > 0;) {
          if (++e > 100) throw I.error("LastFewActions", o.serialize()), Error("react change emit loop detected, aborting");
          this.emitReactOnce()
        }
      } finally {
  ...
  emitNonReactOnce() {
    ...
    let E = Date.now();
    E - e > 100 && I.verbose("Slow batch emitChanges took ".concat(E - e, "ms recentActions:"), o.serialize())
  }
  emitReactOnce() {
    let e = Date.now(),
    ...
    let E = Date.now();
    E - e > 100 && I.verbose("Slow batch emitReactChanges took ".concat(E - e, "ms recentActions:"), o.serialize())
  }
  constructor() {

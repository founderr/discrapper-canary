...
function T(e, t, n) {
    ...
    if (null == r) return !1;
    let i = r;
    (i = null == n ? r.removeGuildAvatarHash(t) : r.addGuildAvatarHash(t, n)), (p[r.id] = i);
    let a = r !== i;
    return a && I++, a;
}
function S(e, t) {
    let n = p[e];
    return !(null == n || (0, E.Dd)(n.clan, t.clan)) && (null == n.clan || null != t.clan) && ((n.clan = (0, E.yi)(t.clan)), (p[n.id] = n), I++, !0);
}
function g(e) {
    let t = e.mfa_enabled;
    ...
    let d = e.clan;
    return void 0 !== d && (e.clan = (0, E.yi)(d)), e;
}
function A(e) {
...
function N(e) {
    ...
    if (null == r) void 0 !== (t = (r = new o.Z(e)).premiumType) && i && (r.premiumType = R((0, s.QI)(r), r.premiumType));
    else if (n) {
        var a;
        let n = g(e);
            ...
            (n = (function (e, t) {
                switch (!0) {
                    case null == e.clan && null == t.clan:
                        break;
                    case null != e.clan && null == t.clan:
                    case (0, E.Dd)(e.clan, t.clan):
                        t.clan = e.clan;
                        break;
                    default:
                        t.clan = (0, E.yi)(t.clan);
                }
                return t;
            })(r, n)),
            (r = r.merge(n));
...
function O(e, t) {
    ...
    if (
        ...
        (null === (r = e.interaction) || void 0 === r ? void 0 : r.user) != null && A(null === (i = e.interaction) || void 0 === i ? void 0 : i.user) && N(e.interaction.user, t),
...
function D(e) {
    if (null != e.users)
        for (let t of e.users) {
            if (!(t.id in p && L(t))) p[t.id] = new o.Z(t);
        }
}
function y(e) {
    let { user: t } = e;
    t.id !== c.default.getId() && N(t);
}
function b(e) {
    let { user: t } = e;
    N(t);
...
function P(e) {
    let { messages: t } = e;
    return t.forEach((e) => O(e, !0)), !1;
}
function U(e) {
    let { mostRecentMessages: t } = e;
    return null == t || t.forEach((e) => O(e, !1)), !1;
}
function w(e) {
    let { messages: t } = e;
...
function x(e) {
    ...
    null != t && t.forEach((e) => O(e, !0)), null != n && n.forEach((e) => N(e.user, !0));
}
function G(e) {
    let { threads: t } = e;
    Object.values(t).forEach((e) => {
        let { first_message: t, most_recent_message: n, owner: r } = e;
        null != t && O(t, !0), null != n && O(n, !0), null != r && null != r.user && N(r.user, !0);
    });
}
function k(e) {
...
function H(e) {
    let { message: t } = e;
    if ((O(t, !0), null != t.flags && l.yE(t.flags, _.iLy.URGENT))) {
        let e = p[c.default.getId()];
        return null != e && ((p[c.default.getId()] = e.set('flags', l.mB(e.flags, _.xW$.HAS_UNREAD_URGENT_MESSAGES, !0))), !0);
    }
    return !1;
}
function Z(e) {
...
let j = ['username', 'avatar', 'global_name', 'discriminator', 'bot', 'clan'];
function W(e) {
    let { updates: t } = e;
    return t
        .map((e) => {
...
function ee(e) {
    let t = !1;
    for (let n of e.members) N(n.user) && (t = !0), T(n.user.id, e.guildId, n.avatar) && (t = !0);
    return t;
}
function et(e) {
    var t;
    let n = !1;
    for (let r of null !== (t = e.users) && void 0 !== t ? t : []) !Object.hasOwn(p, r.id) && (n = N(r) || n);
    return n;
}
function en(e) {
    let { members: t } = e,
...
class eg extends d.Z {
    ...
    handleLoadCache(e) {
        ...
        if (null != t) for (let e of t.users) p[e.id] = new o.Z(e);
        if (null != e.users)
            for (let t of e.users) {
                if (!(t.id in p && L(t))) p[t.id] = new o.Z(t);
            }
    ...
    forEach(e) {
        for (let t in p) if (!1 === e(p[t])) break;
    }
    findByTag(e, t) {
        for (let n in p) {
            let r = p[n];
    ...
    constructor() {
        super({
            ...
            FAMILY_CENTER_LINKED_USERS_FETCH_SUCCESS: ef,

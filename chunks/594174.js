...
function p(e, t) {
  return !r()(e.clan, t.clan) && (null == e.clan || null != t.clan) && (e.clan = (0, h.yi)(t.clan), A[e.id] = e, !0)
}
...
function R(e) {
  ...
  let c = e.clan;
  return void 0 !== c && (e.clan = (0, h.yi)(c)), e
}
...
function C(e) {
  ...
  if (null == i) void 0 !== (t = (i = new _.Z(e)).premiumType) && s && (i.premiumType = v((0, u.QI)(i), i.premiumType));
  else if (n) {
    var o;
    let n = R(e);
...
function L(e, t) {
  ...
  if (null != e.author && "SENDING" !== e.state && g(e.author) && C(e.author, t), null === (n = e.mentions) || void 0 === n || n.forEach(e => {
      g(e) && C(e, t)
    }), (null === (i = e.interaction) || void 0 === i ? void 0 : i.user) != null && g(null === (r = e.interaction) || void 0 === r ? void 0 : r.user) && C(e.interaction.user, t), null === (s = e.attachments) || void 0 === s || s.forEach(e => {
      var n;
...
function M(e) {
  ...
  delete t.premium, delete t.banner_color, C(t), n.forEach(e => {
    ...
    e.members.forEach(t => {
      let n = A[t.user.id];
      null != n && (O(n, e.id, t.avatar), p(n, t.user))
    })
  }), null != A[E.default.getId()] && (A[m] = new _.Z({
    id: m,
    username: "Wumpus",
    discriminator: "0",
    globalName: "Wumpus",
...
function U(e) {
  if (null != e.users)
    for (let t of e.users) {
      if (!(t.id in A && y(t))) A[t.id] = new _.Z(t)
    }
}
...
function Z(e) {
  ...
  Object.values(t).forEach(e => {
    ...
    null != t && L(t, !0), null != n && L(n, !0), null != i && null != i.user && C(i.user, !0)
  })
}
...
function W(e) {
  ...
  if (L(t, !0), null != t.flags && c.yE(t.flags, T.iLy.URGENT)) {
    let e = A[E.default.getId()];
    return null != e && (A[E.default.getId()] = e.set("flags", c.mB(e.flags, T.xW$.HAS_UNREAD_URGENT_MESSAGES, !0)), !0)
  }
  return !1
}
...
function er(e) {
  let t = !1;
  for (let n of e.members) C(n.user) && (t = !0), null != A[n.user.id] && O(A[n.user.id], e.guildId, n.avatar) && (t = !0);
  return t
}
...
function es(e) {
  var t;
  let n = !1;
  for (let i of null !== (t = e.users) && void 0 !== t ? t : []) !Object.hasOwn(A, i.id) && (n = C(i) || n);
  return n
}
...
class eC extends I.Z {
  ...
  handleLoadCache(e) {
    let t = this.readSnapshot(eC.LATEST_SNAPSHOT_VERSION);
    if (null != t)
      for (let e of t.users) A[e.id] = new _.Z(e);
    if (null != e.users)
      for (let t of e.users) {
        if (!(t.id in A && y(t))) A[t.id] = new _.Z(t)
      }
    for (let t of [e.privateChannels, e.initialGuildChannels])
      for (let e of t) {
        var n;
        null === (n = e.rawRecipients) || void 0 === n || n.forEach(e => C(e, !1))
      }
  }
  getUserStoreVersion() {
    return N
  ...
  constructor() {
    super({
      ...
      LOAD_MESSAGES_AROUND_SUCCESS: x,
      ...
      FRIEND_SUGGESTION_CREATE: ec,
      LOAD_FRIEND_SUGGESTIONS_SUCCESS: ed,
...
S(eC, "displayName", "UserStore"), S(eC, "LATEST_SNAPSHOT_VERSION", 1), t.default = new eC
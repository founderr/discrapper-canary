...
class W extends s.PureComponent {
  ...
  renderHeader(e) {
    ...
    let p = (0, I.getChannelIconComponent)(i, l);
    return null != i && (t = i.name), (0, a.jsxs)("div", {
      className: G.headerContainer,
      children: [null != i && null !== p ? (0, a.jsx)(p, {
        className: o(G.icon)
  ...
  renderImage(e) {
    ...
    if (p) m = (0, a.jsx)(f.Anchor, {
      ...
      m = (0, a.jsx)(D.default, {
        ...
        children: (0, a.jsx)("img", {
          src: null !== (l = x.default.getGuildIconURL({
            id: t.guildId,
            icon: d.small_image,
  ...
  renderGameImage(e) {
    ...
    return null != e.assets || (0, S.default)(e) || e.type !== k.ActivityTypes.PLAYING || "ActivityFeed" === n || t.bot ? null : null == l && null != i ? (0, a.jsx)("div", {
  ...
  renderTimePlayed(e) {
    ...
    if (!(0, g.default)(e) || (0, C.default)(e)) return null;
    let {
      timestamps: n
    } = e;
    return null == n ? null : (0, S.default)(e) ? (0, a.jsx)(V, {
      timestamps: n
    }) : (0, a.jsx)(j.default, {
      start: n.start,
  ...
  renderState(e, t) {
    ...
    return (!(0, g.default)(e) && (d = u = null == o ? void 0 : o.large_text, (0, C.default)(e) && null != u && (u = F.default.Messages.USER_ACTIVITY_LISTENING_ALBUM.format({
      album: d,
    ...
    }))), null != u && 0 !== u.length && e.type !== k.ActivityTypes.CUSTOM_STATUS || (0, N.isStageActivity)(e)) ? ((null == r ? void 0 : r.size) == null && [(0, w.POKER_NIGHT_APPLICATION_ID)].includes(null !== (n = e.application_id) && void 0 !== n ? n : "") ? i = F.default.Messages.USER_ACTIVITY_STATE_SIZE.format({
      count: "0",
      max: null !== (l = null == t ? void 0 : t.getMaxParticipants()) && void 0 !== l ? l : 0
    }) : (0, N.isStageActivity)(e) && (null == r ? void 0 : r.size) != null ? i = F.default.Messages.USER_ACTIVITY_STAGE_STATE_SIZE.format({
  ...
  render() {
    ...
    let p = this.renderName(s),
      ...
      S = null != n ? n() : null,
      g = this.renderTimeBar(s),
      C = ![e, p, m, h, E, g, S].some(e => null != e);
    return (0, a.jsxs)("div", {
      ...
      children: [this.renderHeader(C), (0, a.jsxs)("div", {
        ...
        children: [e, this.isStreamerOnTypeActivityFeed() ? null : (0, a.jsxs)(L.default.Child, {
          ...
          children: [p, m, h, E, r || c ? null : g, d ? S : null]
        }), u ? S : null]
      }), r ? g : null, r || c ? S : null, (0, a.jsx)(K, {
        activity: s
      })]
    })
  }

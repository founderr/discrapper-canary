...
(e.exports = d),
    ...
    (d.prototype.verify = function (e, t, n, i) {
        ...
        if (!this.curve._maxwellTrick) return !(a = this.g.mulAdd(u, n.getPublic(), d)).isInfinity() && 0 === a.getX().umod(this.n).cmp(o);
    ...
    (d.prototype.recoverPubKey = function (e, t, n, i) {
        ...
        var a = this.n,
            ...
            d = 1 & n,
            _ = n >> 1;
        if (s.cmp(this.curve.p.umod(this.curve.n)) >= 0 && _) throw Error('Unable to find sencond key candinate');

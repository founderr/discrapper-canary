...
return new d(e);
  'string' == typeof e && (l(Object.prototype.hasOwnProperty.call(s, e), 'Unknown curve ' + e), e = s[e]), e instanceof s.PresetCurve && (e = {
curve: e
...
if (!(s.cmp(a) > 0))
  ...
  for (var s = this.n.byteLength(), o = t.getPrivate().toArray('be', s), l = e.toArray('be', s), u = new i({
  hash: this.hash,
  entropy: o,
  nonce: l,
  pers: a.pers,
...
if (0 !== p.cmpn(0)) {
  ...
  var a, s = (t = new c(t, 'hex')).r,
o = t.s;
  if (0 > s.cmpn(1) || s.cmp(this.n) >= 0 || 0 > o.cmpn(1) || o.cmp(this.n) >= 0)
return !1;
  var l = o.invm(this.n),
u = l.mul(e).umod(this.n),
d = l.mul(s).umod(this.n);
  if (!this.curve._maxwellTrick)
return !(a = this.g.mulAdd(u, n.getPublic(), d)).isInfinity() && 0 === a.getX().umod(this.n).cmp(s);
...
d = 1 & n,
_ = n >> 1;
  if (o.cmp(this.curve.p.umod(this.curve.n)) >= 0 && _)

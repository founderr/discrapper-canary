var r = n(814033), i = n(789188), a = n(685053), o = n(609513), s = n(526808), l = a.assert, u = n(175671), c = n(361879);
function d(e) {
    if (!(this instanceof d))
        return new d(e);
    'string' == typeof e && (l(Object.prototype.hasOwnProperty.call(o, e), 'Unknown curve ' + e), e = o[e]), e instanceof o.PresetCurve && (e = { curve: e }), this.curve = e.curve.curve, this.n = this.curve.n, this.nh = this.n.ushrn(1), this.g = this.curve.g, this.g = e.curve.g, this.g.precompute(e.curve.n.bitLength() + 1), this.hash = e.hash || e.curve.hash;
}
e.exports = d, d.prototype.keyPair = function (e) {
    ...
    var a, o = (t = new c(t, 'hex')).r, s = t.s;
    if (0 > o.cmpn(1) || o.cmp(this.n) >= 0 || 0 > s.cmpn(1) || s.cmp(this.n) >= 0)
        return !1;
    var l = s.invm(this.n), u = l.mul(e).umod(this.n), d = l.mul(o).umod(this.n);
    ...
    var a = this.n, o = new r(e), s = t.r, u = t.s, d = 1 & n, _ = n >> 1;
    ...
    var E = t.r.invm(a), f = a.sub(o).mul(E).umod(a), h = u.mul(E).umod(a);

...
function a(e, t) {
    for (var n, r = [], a = 0, o = 0, s = '', u = t && t.delimiter || '/'; null != (n = i.exec(e));) {
        var c = n[0], d = n[1], _ = n.index;
        if (s += e.slice(o, _), o = _ + c.length, d) {
            s += d[1];
            continue;
        }
        var E = e[o], f = n[2], h = n[3], p = n[4], m = n[5], I = n[6], T = n[7];
        s && (r.push(s), s = '');
        var g = null != f && null != E && E !== f, S = '+' === I || '*' === I, A = '?' === I || '*' === I, N = n[2] || u, v = p || m;
        r.push({
            name: h || a++,
            prefix: f || '',
            delimiter: N,
...
function d(e, t, n) {
    ...
    for (var i, a, o = (n = n || {}).strict, s = !1 !== n.end, u = '', d = 0; d < e.length; d++) {
        ...
        if ('string' == typeof _)
            ...
            var E = l(_.prefix), f = '(?:' + _.pattern + ')';
            t.push(_), _.repeat && (f += '(?:' + E + f + ')*'), u += f = _.optional ? _.partial ? E + '(' + f + ')?' : '(?:' + E + '(' + f + '))?' : E + '(' + f + ')';
        }
    }
    var h = l(n.delimiter || '/'), p = u.slice(-h.length) === h;

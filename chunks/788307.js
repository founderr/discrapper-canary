...
t.Z = e => {
  ...
  let {
    ...
    user: M,
    hasQuest: P
  } = e, y = null != n ? n.find(e => e.type === p.IIU.CUSTOM_STATUS) : null, U = (0, a.e7)([S.default], () => S.default.getId() === (null == M ? void 0 : M.id)), b = (0, a.e7)([T.Z], () => U ? T.Z.getHangStatusActivity() : null != n ? n.find(e => e.type === p.IIU.HANG_STATUS) : null), G = (0, a.e7)([O.Z, A.Z], () => {
    var e;
    ...
    autoTrackExposure: !1
  }), B = (0, d.Sl)(p.Ilk.BRAND_345), x = null, k = w && null != b && N.Z.can(p.Plq.CONNECT, G);
  k ? x = (0, i.jsx)(h.Z, {
    className: u,

...
((R = l || (l = {})).ANIMATED_GUILD_BANNER_TOOLTIP = 'animated_guild_banner_tooltip'),
    (R.EMOJI_PICKER_SEARCH = 'emoji_picker_search'),
    (R.EMOJI_PICKER_EMOJI_CLICKED = 'emoji_picker_emoji_clicked'),
    (R.EMOJI_PICKER_STICKER_CLICKED = 'emoji_picker_sticker_clicked'),
    (R.EMOJI_PICKER_REACTION_EMOJI_CLICKED = 'emoji_picker_reaction_emoji_clicked'),
    (R.EMOJI_PICKER_SUPER_REACTION_EMOJI_CLICKED = 'emoji_picker_super_reaction_emoji_clicked'),
    (R.EMOJI_PICKER_STATUS_EMOJI_CLICKED = 'emoji_picker_status_emoji_clicked'),
    (R.EMOJI_PICKER_TOP_SERVER_EMOJI_CLICKED = 'emoji_picker_top_server_emoji_clicked'),
    (R.EMOJI_PICKER_NEWLY_ADDED_EMOJI_CLICKED = 'emoji_picker_newly_added_emoji_clicked'),
    (R.EMOJI_AUTOSUGGEST_CLICKED = 'emoji_autosuggest_clicked'),
    (R.EMOJI_AUTOCOMPLETE_INLINE = 'emoji_autocomplete_inline'),
    (R.EMOJI_AUTOCOMPLETE_MODAL = 'emoji_autocomplete_modal'),
    (R.EMOJI_IN_MESSAGE_HOVER = 'emoji_in_message_hover'),
    (R.EMOJI_IN_REACTION_HOVER = 'emoji_in_reaction_hover'),
    (R.EMOJI_IN_BURST_REACTION_HOVER = 'emoji_in_burst_reaction_hover'),
    (R.EMOJI_IN_BURST_REACTION_HOVER_UPSELL = 'emoji_in_burst_reaction_hover_upsell'),
    (R.EMOJI_PICKER_FLOATING_UPSELL = 'emoji_picker_floating_upsell'),
    (R.STICKER_IN_MESSAGE_HOVER = 'sticker_in_message_hover'),
    (R.EMPTY_STICKER_PICKER_UPSELL = 'empty_sticker_picker_upsell'),
    (R.STREAM_QUALITY_INDICATOR = 'stream_quality_indicator'),
    (R.GIFT_STREAM_QUALITY_INDICATOR = 'gift_stream_quality_indicator'),
    (R.STREAM_QUALITY_UPSELL = 'stream_quality_upsell'),
    (R.MESSAGE_LENGTH_UPSELL = 'message_length_upsell'),
    (R.MESSAGE_LENGTH_IN_EDITOR_UPSELL = 'message_length_in_editor_upsell'),
    (R.CUSTOM_PROFILE_UPSELL = 'custom profiles upsell modal'),
    (R.CUSTOM_PROFILE_TRY_OUT_UPSELL = 'try out custom profile in settings upsell'),
    (R.VIDEO_BACKGROUNDS_MODAL = 'video backgrounds modal'),
    (R.VIDEO_BACKGROUNDS_INLINE = 'video backgrounds inline'),
    (R.GUILD_CAP_INLINE_SERVER_LIST = 'guild_cap_inline_server_list'),
    (R.GUILD_PREMIUM_UPSELL_MODAL = 'premium guild premium upsell modal'),
    (R.GUILD_CAP_INLINE_INVITE_MODAL = 'guild_cap_inline_invite_modal'),
    ...
    (R.INVITE_SPLASH_UPSELL = 'premium_invite_splash_upsell'),
    (R.ANIMATED_USER_AVATAR_MODAL = 'animated user avatar upsell modal'),
    (R.UPLOAD_ERROR_UPSELL = 'upload error upsell'),
    (R.PREMIUM_GUILD_MEMBER_PROFILE_UPSELL_INLINE = 'premium guild member profile upsell inline'),
    (R.CONCURRENT_ACTIVITIES = 'Concurrent Activities'),
    (R.PREMIUM_UNCANCEL_WINBACK_MODAL_VIEWED = 'premium_uncancel_winback_modal_viewed'),
    (R.ANIMATED_VIDEO_BACKGROUND_NEW_PRESET = 'animated_video_background_new_preset'),
    (R.LOW_PRICE_EXPERIMENT_TOOLTIP = 'low_price_experiment_tooltip'),
    (R.PREMIUM_PROFILE_BADGE_UPSELL = 'premium_profile_badge_upsell'),
    (R.AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_EMOJI = 'emoji'),
    (R.AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_PROFILE_CUSTOMIZATION = 'profile customization'),
    (R.AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_HD_STREAMING = 'hd streaming'),
    (R.AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_LARGER_FILE_UPLOADS = 'larger file uploads'),
    (R.AGGREGATE_PREMIUM_UPSELL_MODAL_FEATURE_BOGO = 'bogo'),
    (R.VOICE_CHANNEL_EFFECTS_UPSELL = 'voice_channel_effects_upsell'),
    ...
    (R.PREMIUM_PROFILE_TRY_IT_OUT = 'premium_profile_try_it_out'),
    (R.BURST_REACTION_RAIL_UPSELL = 'burst_reaction_rail_upsell'),
    (R.BURST_REACTION_UPSELL = 'burst_reaction_upsell'),
    (R.BURST_REACTION_QUICK_ACTION_UPSELL = 'burst_reaction_quick_action_upsell'),
    (R.BURST_REACTION_CONTEXT_MENU_UPSELL = 'burst_reaction_context_menu_upsell'),
    (R.PREMIUM_CLIENT_THEME_TRY_IT_OUT = 'premium_client_theme_try_it_out'),
    (R.PREMIUM_CLIENT_THEME_SETTINGS_UPSELL = 'premium_client_theme_settings_upsell'),
    (R.VIDEO_STAGE_LIMIT = 'video_stage_limit'),
    (R.SOUND_PICKER_SOUND_CLICKED = 'sound_picker_sound_clicked'),
    (R.APP_ICON_UPSELL = 'app_icon_upsell'),
    ...
    (R.SOUNDBOARD_EVERYWHERE_UPSELL = 'soundboard_everywhere_upsell'),
    (R.LARGER_FILE_UPLOAD_INLINE_UPSELL = 'larger_file_upload_inline_upsell'),
    (R.LARGER_FILE_UPLOAD_UPSELL = 'larger_file_upload_upsell'),
    (R.ANIMATED_EMOJI_UPSELL = 'animated_emoji_upsell'),
    (R.CLIENT_THEMES_UPSELL = 'client_themes_upsell'),
    (R.APP_ICONS_INLINE_UPSELL = 'app_icons_inline_upsell'),
    (R.APP_ICONS_UPSELL = 'app_icons_upsell'),

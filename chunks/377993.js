...
function y(e) {
    let {
            ...
            status: d,
            activities: u
        } = e, h = (0, l.e7)([E.Z], () => null != E.Z.getTypingUsers(a.id)[t.id]), g = (0, l.e7)([C.default], () => C.default.getCurrentUser()), I = (0, l.e7)([_.Z], () => _.Z.isMobileOnline(t.id)), x = (0, l.e7)([f.Z], () => f.Z.getNickname(t.id)), T = e => {
            (0, o.jW)(e, async () => {
...
function U(e) {
    var t;
    let {channel: s} = e, o = C.default.getCurrentUser(), c = null == o ? void 0 : o.isStaff(), {analyticsLocations: m} = (0, u.ZP)(d.Z.MEMBER_LIST);
    let {listItems: E} = (t = s, (0, l.e7)([
            f.Z,
            C.default,
            _.Z
        ], () => {
            ...
            for (let t of e) {
                ...
                f.Z.isFriend(t.id) || t.id === (null === (i = C.default.getCurrentUser()) || void 0 === i ? void 0 : i.id) ? n[t.id] = {
                    ...
                    activities: null !== (s = _.Z.getActivities(t.id)) && void 0 !== s ? s : P
                } : n[t.id] = {

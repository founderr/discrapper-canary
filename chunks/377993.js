...
function k(e) {
  ...
  }, [s, c]), d = s.application.bot, h = v.ZP.getApplicationIconURL({
    id: s.application.id,
...
function U(e, t) {
  ...
  for (let n = 0; n < e.listItems.length; n++) {
    let i = e.listItems[n],
      a = t.listItems[n];
    if (i.user !== a.user || i.status !== a.status || i.activities !== a.activities || i.lastOnlineTimestamp !== a.lastOnlineTimestamp) return !1
  }
  return !0
}
...
function w(e) {
  let {
    ...
    return (0, s.e7)([E.Z, C.default, f.Z], () => {
      ...
      let c = [R.Skl.OFFLINE, R.Skl.INVISIBLE, null, void 0],
        u = [],
        d = [],
        h = [];
      return o.forEach(e => {
    ...
    children: (0, i.jsx)("div", {
      ...
      children: (0, i.jsxs)(r.Scroller, {
        ...
        children: [(0, i.jsxs)(T.Z, {
          ...
          channel: t
        }, e.user.id)), M && (v.length > 0 || A && S.length > 0) && (0, i.jsxs)(i.Fragment, {
          children: [(0, i.jsx)(T.Z, {
            ...
            integration: e,
            channel: t
          }, e.application.id)), b.length > 0 && (0, i.jsx)(x.Z, {
            className: L.member,
            onClick: () => {

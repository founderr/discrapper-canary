...
status: u,
activities: d
  } = e, h = (0, l.e7)([I.Z], () => null != I.Z.getTypingUsers(a.id)[t.id]), p = (0, l.e7)([x.default], () => x.default.getCurrentUser()), m = (0, l.e7)([C.Z], () => C.Z.isMobileOnline(t.id)), _ = (0, l.e7)([g.Z], () => g.Z.getNickname(t.id)), T = e => {
(0, o.jW)(e, async () => {
  let {
    default: e
  } = await Promise.all([

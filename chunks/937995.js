...
var r = n(735250), i = n(470079), a = n(846519);
...
function l(e) {
    let {
            children: t,
            timeout: n
        } = e, [l, u] = i.useState(!1), c = i.useRef(new Set()), d = i.useRef(null);
    i.useEffect(() => (d.current = new a.sW(n, () => u(!0)), d.current.delay(), () => {
        var e;
    ...
    let _ = i.useCallback(e => {
            ...
            var e;
            if (!(c.current.size > 0))
                null === (e = d.current) || void 0 === e || e.cancel(), u(!0);
        }, [
            d,
            u
        ]), p = i.useMemo(() => ({

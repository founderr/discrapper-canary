n(47120), n(177593);
var r, i = n(392711), a = n.n(i), o = n(525654), s = n.n(o), l = n(579806), u = n(292959), c = n(246946), d = n(626135), _ = n(358085), E = n(557177), f = n(998502), h = n(981631);
function p(e, t, n) {
...
let m = _.isPlatformEmbedded && (0, _.isWindows)(), I = m && 10 > parseFloat(l.Z.os.release), T = !0;
if (m && !I) {
    let [e, , t] = l.Z.os.release.split('.');
    T = parseInt(e) > 10 || parseInt(t) >= 15063;
}
let g = m && T || 'Chrome' === s().name && 47 > parseFloat(s().version) || 'Firefox' === s().name && 52 > parseFloat(s().version), S = a().throttle(E.GN, 1000, { leading: !0 });
function A() {
    f.ZP.flashFrame(!1);
}
...
I && (f.ZP.on('NOTIFICATION_CLICK', (e, t) => {
    ...
    constructor(e, {
        ...
        p(this, 'id', N._id++), p(this, 'title', void 0), p(this, 'body', void 0), p(this, 'icon', void 0), p(this, 'onshow', function () {
        }), p(this, 'onclick', function () {
        }), p(this, 'onclose', function () {
        }), this.title = e, this.body = t, this.icon = n, setImmediate(() => this.onshow()), null[this.id] = this, f.ZP.send('NOTIFICATION_SHOW', {
            id: this.id,
            title: this.title,
            body: this.body,
            icon: this.icon
...
function O(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, n = arguments.length > 2 ? arguments[2] : void 0;

n.r(t), n(411104);
var o = n(735250), r = n(470079), i = n(817080), a = n(442837), u = n(481060), s = n(668781), c = n(239091), d = n(883385), l = n(108843), f = n(100527), p = n(496675), O = n(358085), N = n(998502), w = n(22382), S = n(51078), b = n(710111), y = n(981631), g = n(689938);
t.default = (0, l.Z)((0, d.Z)(function (e) {
    let {
            ...
            let {canManageGuildExpressions: i} = (0, a.cj)([p.Z], () => null == t ? { canManageGuildExpressions: !1 } : p.Z.getGuildPermissionProps(t), [t]), s = r.useCallback(() => {
            ...
            let {soundId: t} = e, n = r.useCallback(async () => {
                    try {
                        let e = (0, w.Z)(t), n = await fetch(e), o = await n.blob(), r = function (e) {
                                switch (e.type) {
                                case 'audio/mpeg':
                                case 'audio/mpeg3':
                                    return 'mp3';

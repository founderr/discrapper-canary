...
function H(e) {
    ...
    let { channel: u, showingBanner: h } = e,
        C = (0, d.ZP)(u),
        { type: _ } = u,
        Z = (0, r.e7)([I.default], () => (u.isPrivate() ? I.default.getUser(u.getRecipientId()) : null)),
        y = E.ZP.useUserTag(Z),
    ...
    if (
        (l.useEffect(() => {
            _ === k.d4z.DM && null == L && null != Z && s.Z.wait(() => (0, g.Z)(u.getRecipientId(), Z.getAvatarURL(null, 80), { withMutualGuilds: !0 }));
        }, [L, _, u, Z]),
        l.useEffect(() => {

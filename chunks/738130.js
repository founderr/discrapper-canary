...
guildId: o,
children: c
  } = e, s = (0, r.jsxs)(i.Fragment, {
children: [
  (0, r.jsx)(E.Z, {
    title: Z.Z.Messages.APP_DIRECTORY
  }),
  t && (0, r.jsx)(u.Anchor, {
    onClick: function() {
...
sessionId: l
  ...
  n > 0 && L.default.track(P.rMx.APP_DIRECTORY_PAGE_SCROLLED, {
...
function j(e) {
  let {
children: n
  } = e, t = i.useRef(null), o = (0, R.Z)(), c = (0, v.useApplicationDirectoryHistory)(e => e.guildId), C = (0, v.useApplicationDirectoryHistory)(e => e.entrypoint), f = (0, v.useApplicationDirectoryHistory)(e => e.trackedOpenedFromExternalEntrypoint), E = (0, v.getCurrentView)(), _ = (0, v.getPreviousView)(), g = i.useRef(), T = (null == E ? void 0 : E.type) !== v.ApplicationDirectoryViews.HOME, D = (null == E ? void 0 : E.type) === v.ApplicationDirectoryViews.APPLICATION ? null == E ? void 0 : E.applicationId : void 0;
  (0, h.Tt)({
location: Z.Z.Messages.APP_DIRECTORY
  });
  let j = (null == E ? void 0 : E.type) !== v.ApplicationDirectoryViews.HOME && null != _;
  i.useEffect(() => {
!f && null == C && (L.default.track(P.rMx.APP_DIRECTORY_OPENED, {

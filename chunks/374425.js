...
var s = n("735250"),
  ...
  p = n("474936"),
  h = n("14949");
let N = (0, f.cssValueToNumber)(a.default.STICKERS_CONSTANTS_STICKER_DIMENSION),
  S = e => {
...
t.default = e => {
  let {
    ...
    channel: n,
    isInteracting: a
  } = e, [o, f] = l.useState(!0), [_, I] = l.useState(String(Date.now())), [p] = (0, E.useStickerForRenderableSticker)(t, a), {

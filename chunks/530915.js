...
(i = r || (r = {})).GO_TO_SLIDE = "GO_TO_SLIDE", i.NEXT = "NEXT", i.PREVIOUS = "PREVIOUS";
let E = e => {
    let {
      currentSlideIndex: t,
      numSlides: n,
    ...
    return (0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)(_.Button, {
        ...
        children: p()(n, e => (0, a.jsx)(_.Button, {
  ...
  v = e => {
    let {
      ...
      trackSlideView: L,
      trackPagination: N
    } = (0, m.X)(t, T), [O, j] = (0, o.useState)(0), [B, R] = (0, o.useState)(!1), [k, A] = (0, o.useState)(!1), P = o.useCallback(() => A(!0), []), y = o.useCallback(() => A(!1), []), Z = (0, g.e7)([C.Z], () => C.Z.isFocused()), M = null != h && !v && !k && Z, w = o.useCallback(e => (n.length + O + e) % n.length, [n, O]), D = o.useCallback(d()((e, t, r) => {
      null != r && (null == s || s(n[e], t, e, r), N(e, O, i(e), i(t))), R("GO_TO_SLIDE" === r), null == l || l(n[e], t, e), j(e)
    }, 200), [n, s, l]);

...
let T = e => {
  ...
  L = e => {
    let {
      ...
      trackSlideView: b,
      trackPagination: v
    } = (0, h.X)(t, N), [O, Z] = (0, i.useState)(0), [A, R] = (0, i.useState)(!1), [j, P] = (0, i.useState)(!1), M = i.useCallback(() => P(!0), []), k = i.useCallback(() => P(!1), []), y = (0, p.e7)([g.Z], () => g.Z.isFocused()), B = null != x && !L && !j && y, D = i.useCallback(e => (s.length + O + e) % s.length, [s, O]), F = i.useCallback(u()((e, t, n) => {
    ...
    return (0, i.useEffect)(() => {
      ...
      if (B) {
        let e = D(1),
          t = setInterval(() => F(e, O), x);
        return () => clearInterval(t)
      }
    }, [B, x, O, D, F]), (0, a.jsxs)("div", {

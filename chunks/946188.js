          ...
          return p(e, function(e) {
            ...
            if (o && s) {
              for (r in i = "<img ".concat('class="', t.className, '" ', 'draggable="false" ', 'alt="', e, '"', ' src="', s, '"'), n = t.attributes(e, o))
                if (n.hasOwnProperty(r) && 0 !== r.indexOf("on") && -1 === i.indexOf(" " + r + "=")) i = i.concat(" ", r, '="', n[r].replace(a, d), '"');
              i = i.concat("/>")
            }
            return i
          })
        } : function(e, t) {
          for (var r, i, a, s, c, d, f, p, h, m, g, _, b, v = function e(t, n) {
              for (var r, i, a = t.childNodes, s = a.length; s--;) 3 === (i = (r = a[s]).nodeType) ? n.push(r) : 1 === i && !("ownerSVGElement" in r) && !o.test(r.nodeName.toLowerCase()) && e(r, n);
              return n
            }(e, []), y = v.length; y--;) {
            for (a = !1, s = document.createDocumentFragment(), d = (c = v[y]).nodeValue, p = 0; f = n.exec(d);) {
              if ((h = f.index) !== p && s.appendChild(u(d.slice(p, h), !0)), _ = l(g = f[0]), p = h + g.length, b = t.callback(_, t), _ && b) {
                for (i in (m = new Image).onerror = t.onerror, m.setAttribute("draggable", "false"), r = t.attributes(g, _)) r.hasOwnProperty(i) && 0 !== i.indexOf("on") && !m.hasAttribute(i) && m.setAttribute(i, r[i]);
                m.className = t.className, m.alt = g, m.src = b, a = !0, s.appendChild(m)
              }!m && s.appendChild(u(g, !1)), m = null
            }
            a && (p < d.length && s.appendChild(u(d.slice(p), !0)), c.parentNode.replaceChild(s, c))
          }
          return e
        })(t, {

...
var r = n(221513), i = n(706454), a = n(474936), o = n(689938);
function s(e, t, n) {
    var a;
...
function l(e, t, n) {
    if (t === a.rV.YEAR)
        return o.Z.Messages.BILLING_PRICE_PER_YEAR.format({ price: e });
    if (t === a.rV.MONTH && 1 === n)
        return o.Z.Messages.BILLING_PRICE_PER_MONTH.format({ price: e });
    if (t === a.rV.MONTH && n > 1)

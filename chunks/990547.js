...
if (null != v) {
    let e;
    let t = v.remoteApp.getVersion(), n = v.process.platform, i = v.os.release, o = v.os.arch, s = v.os.appArch, l = v.remoteApp.getReleaseChannel(), u = (0, _.qf)();
    switch (n) {
    case 'win32':
        e = 'Windows';
        break;
...
function L() {
    ...
    return e.referrer = document.referrer, e.referring_domain = function () {
        ...
        ...function () {
            let e = {}, t = document.referrer, n = function () {
        ...
        e = E.K.get(g), null == e && (e = function () {
            ...
            return e.os = t, e.browser = function () {
                let {
                        userAgent: e,
                        vendor: t = ''
                    } = window.navigator, {opera: n} = window;
                if (n)
...
M(function () {
    ...
    let a = parseInt((n = '306479', '306479'), 10);

...
function h(e) {
  let t = (0, a.useStateFromStores)([r.default], () => r.default.getGuild(e)),
    ...
    h = (0, a.useStateFromStoresArray)([d.default, o.default, i.default, u.default], () => {
      let t = new Set,
        a = d.default.getVoiceStates(e);
      for (let s in a) {
        let r = i.default.getBasicChannel(a[s].channelId);
        if (null == r || r.type === l.ChannelTypes.GUILD_STAGE_VOICE || n === r.id || !u.default.canBasicChannel(f.BasicPermissions.VIEW_CHANNEL, r)) continue;

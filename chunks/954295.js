...
var s = i(735250);
i(470079);
var l = i(481060), o = i(860719), t = i(689938), r = i(744224);
function a(e) {
    let {
        content: n,
        heading: i
...
function d(e) {
    ...
    })), I.push((0, s.jsx)(a, { content: t.Z.Messages.BOTS_DATA_ACCESS_BASELINE.format({ helpCenterUrl: 'https://support.discord.com/hc/articles/7933951485975' }) })), (0, s.jsx)(l.ScrollerThin, {
        className: i,
        children: I
    });
}

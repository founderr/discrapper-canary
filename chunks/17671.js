...
function P(e) {
  let {
    ...
    onClose: i,
    guildId: x
  } = e, R = (0, h.useUID)(), P = (0, s.useStateFromStores)([g.default], () => g.default.getGuild(x)), U = (0, S.default)(null == P ? void 0 : P.id), V = (0, T.default)(x), b = a.useRef(v.default.ackMessageId(x, k.ReadStateTypes.GUILD_EVENT)), O = (0, j.default)();
  return a.useEffect(() => {
    V.forEach(e => p.default.getGuildEventUserCounts(x, e.id, [])), p.default.getGuildEventsForCurrentUser(x)
  }, [V, x]), a.useEffect(() => {
        ...
        children: [(0, l.jsx)("div", {
          ...
          onClick: () => {
            (0, d.openModalLazy)(async () => {
              let {
                default: e
              } = await Promise.all([n.e("49237"), n.e("99387"), n.e("58023"), n.e("49049")]).then(n.bind(n, "779250"));
              return t => (0, l.jsx)(e, {
                ...t,
                guildId: x
              })

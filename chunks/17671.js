...
function S(e) {
  ...
  return t.useEffect(() => {
    ...
    children: [(0, l.jsxs)(o.ModalHeader, {
      className: G.header,
      children: [(0, l.jsx)(o.CalendarIcon, {
        size: "md",
        color: "currentColor",
        className: G.icon
      }), (0, l.jsx)(o.Heading, {
        ...
        children: A.length > 0 ? P.Z.Messages.GUILD_EVENTS_PLURAL.format({
          number: A.length
        ...
        children: [(0, l.jsx)("div", {
          ...
          onClick: () => {
            (0, o.openModalLazy)(async () => {
              let {
                default: e
              } = await Promise.all([i.e("49237"), i.e("99387"), i.e("58023"), i.e("67007")]).then(i.bind(i, 779250));
              return n => (0, l.jsx)(e, {
                ...n,
                guildId: N
              })

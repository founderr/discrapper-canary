...
var l = i(735250), t = i(470079), a = i(392711), r = i.n(a), s = i(442837), o = i(481060), c = i(45114), u = i(597), d = i(147754), E = i(984933), g = i(720202), h = i(430824), v = i(306680), Z = i(153124), C = i(626135), m = i(823379), N = i(981888), x = i(709054), f = i(897285), _ = i(518756), I = i(554747), p = i(710679), T = i(74562), j = i(576749), L = i(765305), M = i(981631), k = i(490897), P = i(689938), G = i(403906);
let D = N.Z;
function S(e) {
    let {
            transitionState: n,
    ...
    return t.useEffect(() => {
        ...
        if (!(null == e ? void 0 : e.hasFeature(M.oNc.HUB)))
            return;
        let {showHubEventsList: n} = d.Z.getCurrentConfig({
            guildId: N,
            location: 'd3755f_1'
        });
        if (!n)
        ...
        children: [
            ...
            (0, l.jsx)(o.ModalContent, {
                className: G.content,
                children: A.length > 0 ? A.map(e => (0, l.jsx)(p.Z, {
                    guildEvent: e,
                    guildId: N,
                    onActionTaken: a,

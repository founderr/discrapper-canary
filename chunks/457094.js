...
let e2 = l.ZP.connectStores([V.Z, eU.Z, eD.default], () => ({
    ...
    e9 = (0, v.e)(A.default, null, { passProps: !1 }),
...
let e5 = [
    ...
    },
    {
        ...
        render: function () {
            return (0, F.h)(() => P.Z.openCreateGuildModal({ location: 'External link' })), (0, i.jsx)(r.l_, { to: eU.Z.defaultRoute });
        }
    },
    {
...
function e7(e) {
    for (let { path: t, isChatRoute: n } of e5) {
        if (!n) continue;
...
class te extends a.PureComponent {
    ...
    componentWillUnmount() {
        eP.Z.terminate(), eu.Z.terminate(), ec.Z.terminate(), Z.Z.terminate(), S.ZP.terminate(), eM.Z.terminate(), T.Z.terminate(), e_.Z.terminate(), eo.Z.terminate(), eR.Z.terminate(), g.Z.terminate(), j.Z.terminate(), ee.Z.terminate(), p.Z.terminate(), eE.Z.terminate(), eg.Z.terminate(), ef.Z.terminate(), er.Z.terminate(), es.Z.terminate(), el.Z.terminate(), x.Z.terminate(), b.Z.terminate(), ed.Z.terminate(), D.Z.terminate(), G.Z.terminate(), R.Z.terminate(), O.Z.terminate(), this.historyUnlisten(), this.rewriterUnlisten();
    }
    handleHistoryChange(e) {
        ...
        !(function (e) {
            ...
            if (null != t)
                null !=
                    (function (e) {
                        for (let { path: t, isSessionRequired: n } of e5) {
                            if (!n) continue;
                            let i = (0, r.LX)(e, { path: t });
                            if (null != i) return i;
                        }
            ...
            !(function (e, t) {
                let n = e7(e);
                if (null == n) return;
                let { guildId: i, channelId: a, messageId: l, threadId: o } = e6(n),
                    c = (0, em.Ss)(i),
                    d = (0, em.cq)(a),
                    E = (0, em.cq)(o),
                    h = eH.Z.getGuildId(),
    ...
    ensureChannelMatchesGuild(e) {
        ...
        let { guildId: i, channelId: a, threadId: s } = e6(n),

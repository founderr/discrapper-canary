...
render: function(e) {
  ...
  return (0, B.h)(() => {
    Y.Z.open(n, (0, W.Z)(eK.pNK, a), void 0, (0, W.Z)(eK.KsC, s));
  }), (0, i.jsx)(r.l_, {
    to: eK.Z5c.CHANNEL(n)
  });
},
...
! function(e) {
  ...
  let {
    ...
    messageId: l,
    threadId: o
  } = e7(n), c = (0, e_.S)(i), d = (0, e_.c)(a), h = (0, e_.c)(o), E = ew.Z.getGuildId(), I = E !== i;
  if (c && I && u.Z.selectGuild(i), c && d) {
    ...
    if (null != o && h) {
      ...
      null != a && !r && em.Z.closeChannelSidebar(a);
    let c = $.Z.getIsOpen();
...
if (null != a && (0, e_.c)(a) && !(0, eq.AB)(a) && r) {
  ...
  if (null != s) {
    ...
    if (null == n)
      ...
      return em.Z.closeChannelSidebar(a), {
        path: eK.Z5c.CHANNEL(i, a),
        state: e.state
      };
  }
}

...
let e9 = [{
  ...
  render: function(e) {
    ...
    return (0, V.addPostConnectionCallback)(() => {
      z.default.open(n, (0, q.default)(eX.GuildSettingsSections, s), void 0, (0, q.default)(eX.GuildSettingsSubsections, i))
    }), (0, a.jsx)(r.Redirect, {
      to: eX.Routes.CHANNEL(n)
    })
  },
...
class te extends s.PureComponent {
  ...
  componentWillUnmount() {
    M.default.terminate(), ex.default.terminate(), ed.default.terminate(), eo.default.terminate(), O.default.terminate(), I.default.terminate(), eP.default.terminate(), g.default.terminate(), ec.default.terminate(), er.default.terminate(), eO.default.terminate(), S.default.terminate(), U.default.terminate(), $.default.terminate(), p.default.terminate(), ef.default.terminate(), em.default.terminate(), eg.default.terminate(), ei.default.terminate(), es.default.terminate(), el.default.terminate(), y.default.terminate(), eu.default.terminate(), D.default.terminate(), G.default.terminate(), this.historyUnlisten(), this.rewriterUnlisten()
  }
  handleHistoryChange(e) {
    ...
    ! function(e) {
      ...
      if (u && _ && f.default.selectGuild(a), u && d) {
        ...
        } else null != s && !l && ep.default.closeChannelSidebar(s);
  ...
  ensureChannelMatchesGuild(e) {
    ...
    let {
      ...
      channelId: s,
      threadId: i
    } = e5(n), l = (0, eh.isValidGuildId)(a) && a !== eX.ME && a !== eX.FAVORITES;
    if (null != s && (0, eh.isValidChannelId)(s) && !(0, eJ.isStaticChannelRoute)(s) && l) {
      ...
      if (null != i) {
        if (!((0, eh.isValidChannelId)(i) && !(0, eJ.isStaticChannelRoute)(s))) return null;
        let n = eU.default.getChannel(i);
        if (null == n) eN.default.loadThread(i).then(() => e8({
          channelId: i,
          guildId: a,
          pathname: t
        }));

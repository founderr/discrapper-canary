...
function b() {
  var e, t, s, n, b, U, y, B;
  let F = (0, i.useStateFromStores)([D.default], () => {
      let e = D.default.getCurrentUser();
      return l()(null != e, "DefaultCustomizationSections: user cannot be undefined"), e
    }),
    G = (0, i.useStateFromStores)([x.default], () => x.default.getUserProfile(F.id)),
    {
      pendingAvatar: k,
      pendingGlobalName: w,
      pendingBanner: H,
    ...
    q = L.default.canUsePremiumProfileCustomization(F),
    Z = (0, E.showRemoveAvatar)(k, F.avatar),
    X = (0, E.showRemoveBanner)(H, null == G ? void 0 : G.banner),
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsx)(_.default, {
      ...
      pendingPronouns: Y,
      currentPronouns: null !== (y = null == G ? void 0 : G.pronouns) && void 0 !== y ? y : ""
      ...
      errors: es,
      onBioChange: e => (0, E.setNewPendingUserBio)(e, null == G ? void 0 : G.bio),
      pendingBio: V,
      currentBio: null !== (B = null == G ? void 0 : G.bio) && void 0 !== B ? B : ""

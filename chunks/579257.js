...
e.exports = function (e) {
    let u = function (e) {
            var u;
            let c = e.regex, d = (e, {after: t}) => {
                    let n = '</' + e[0].slice(1);
                    return -1 !== e.input.indexOf(n, t);
                }, _ = '<>', E = '</>', f = /<[A-Za-z0-9\\._:-]+/, h = /\/[A-Za-z0-9\\._:-]+>|\/>/, p = (e, t) => {
                    let n;
                    ...
                    built_in: l,
                    'variable.language': s
                }, I = '[0-9](_?[0-9])*', T = `\\.(${ I })`, g = '0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*', S = {
                    className: 'number',
                    variants: [
            ...
            let y = [].concat(R, A.contains), D = y.concat([{
                        begin: /\(/,
                        end: /\)/,
                        keywords: m,
    ...
    return Object.assign(u.keywords, E), u.exports.PARAMS_CONTAINS.push(f), u.contains = u.contains.concat([
        f,
        d,
        _
    ]), h(u, 'shebang', e.SHEBANG()), h(u, 'use_strict', {
        className: 'meta',
        relevance: 10,
    }), u.contains.find(e => 'func.def' === e.label).relevance = 0, Object.assign(u, {
        name: 'TypeScript',
        aliases: [
            'ts',
            'tsx'

...
t.default = function (e) {
    ...
    let i = (0, y.u)('CollectiblesShop'),
        { analyticsSource: h, analyticsLocations: x } = (0, o.cj)([L.Z], () => L.Z.getAnalytics()),
        { analyticsLocations: _ } = (0, f.ZP)([...x, p.Z.COLLECTIBLES_SHOP]),
        { sessionId: O, scrollerRef: A, scrollHandler: H } = (0, g._)(J.rMx.COLLECTIBLES_SHOP_SCROLLED, h),
        ...
        { categories: eC, isFetchingCategories: ev, fetchCategoriesError: eb, fetchPurchasesError: ex, claimError: e_, refreshCategories: ek } = (0, P.ZP)({ location: 'CollectiblesShop.web' }),
            ...
            if (W === q.f7.VISIBLE || K === q.f7.VISIBLE) {
                ...
                (t = i ? (K === q.f7.VISIBLE ? ed : h) : h),
                    S.default.track(J.rMx.COLLECTIBLES_SHOP_VIEWED, {
                        ...
                        category: W === q.f7.VISIBLE ? void 0 : null === (e = B.Z.getCategory(eo)) || void 0 === e ? void 0 : e.name
                    });
            }
            !eg &&
    ...
    let eB = a.useCallback(() => {
        ...
        { setCategoryRef: eL, handleScrollToCategory: ey } = (0, R.xV)(A.current),
    ...
    let ew = a.useCallback(
        ...
        eA = (0, o.e7)([B.Z], () => {
            var e;
            return null === (e = B.Z.getCategory(eo)) || void 0 === e ? void 0 : e.name;
        });
    return (0, r.jsx)(f.Gt, {
        value: _,

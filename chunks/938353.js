...
class e1 extends (i = a.Component) {
            ...
            : e.codedLinks.map((t) => {
                  ...
                  if (n === g.g.INVITE)
                      return this.shouldRenderInvite(i)
                          ...
                          : null;
                  if (n === g.g.TEMPLATE) return (0, s.jsx)(k.Z, { code: i }, i);
                  if (n === g.g.EVENT) return (0, s.jsx)(B.Z, { code: i }, i);
                  ...
                  else if (n === g.g.GUILD_PRODUCT) return (0, s.jsx)(y.Z, { code: i }, i);
                  else if (n === g.g.SERVER_SHOP) return (0, s.jsx)(S.Z, { guildId: i }, i);
                  else if (n === g.g.QUESTS_EMBED) return (0, s.jsx)(en.Z, { questId: i }, i);
    ...
    renderAttachments(e) {
        ...
        let { gifAutoPlay: o, canDeleteAttachments: c, inlineAttachmentMedia: u, onMediaItemContextMenu: d, shouldHideMediaOptions: _ } = this.props,
            ...
            T = (0, eC.yE)(n, eV.iLy.IS_VOICE_MESSAGE);
        function N(e, t) {
    ...
    renderEmbeds(e) {
        ...
        return 0 !== e.embeds.length && t
            ? e.embeds.map((t, n) => {
                  if (ew.b.has(t.type) || (0, eh.l3)(t) || ((0, G.b)(t) && !(0, w.M)(e))) return null;
                  let i = {
    ...
    renderComponentAccessories(e) {
        ...
        return (0, s.jsx)(ej.F, {
            ...
            children: (0, s.jsx)(V.ZP, { message: e })
        });
    }
    ...
    renderEphemeralAccessories(e) {
        return (0, eC.yE)(e.flags, eV.iLy.EPHEMERAL)
            ? (0, s.jsx)(eL.Z, {
                  message: e,
                  onDeleteMessage: () => {
    ...
    renderSafetyPolicyNotice(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eV.hBH.SAFETY_POLICY_NOTICE ? (0, s.jsx)(ei.i, { message: e }) : null;
    }
    renderSafetySystemNotification(e) {
        return 1 === e.embeds.length && e.embeds[0].type === eV.hBH.SAFETY_SYSTEM_NOTIFICATION ? (0, s.jsx)(es.g, { embed: e.embeds[0] }) : null;
    }
    ...
    renderMediaObscureNotice(e) {
        ...
        return 0 === t.length && 0 === n.length ? null : (0, s.jsx)(x.Z, { message: e });
    }
    renderPoll(e, t) {
        if (null != t)
            return (0, s.jsx)($.Z, {
    ...
    renderForwardedMessage(e) {
        return 0 === e.messageSnapshots.length ? null : (0, s.jsx)(P.Z, { message: e });
    }
    render() {
        ...
        return null == o && null == d && null == I && null == m && null == T && null == c && null == u && null == N && null == h && null == C && null == f && null == p && null == S && null == g && null == R && null == O && null != A && null == L && null == M && null == Z
            ? null
            : (0, s.jsxs)('div', {
                  id: (0, eb.bX)(t),
...
function e7(e) {
    ...
    let { channel: n, message: i, renderSuppressEmbeds: a, isMessageSnapshot: r } = e,
        ...
        o = ec.x4.useSetting(),
        u = ec.RS.useSetting(),
        d = ec.NA.useSetting() && !(0, eO.Z)(e.message),
        _ = ec.nc.useSetting(),
        E = ec.QK.useSetting(),
        ...
        [, p] = (0, U.AB)(n.guild_id),
        g = (0, el.$R)(n),
        S = (l === i.author.id || C) && i.author.id !== eV.LAt && !1 !== a && !(0, eC.yE)(i.flags, eV.iLy.EPHEMERAL) && g && 1 === (0, eR.Z)(i),
        A = l === i.author.id && g && !r,
        x = i.author.id === l,
        ...
        b = (0, J.Z)(i),
        y = (0, R.V)(n.id, i.author.id),
        B = (0, O.r)(i.id),
        { hasInlineForwardButton: k } = (0, v.yk)({ location: 'MessageAccessories' }),
        F = (0, L.a)(i) && k;
    return (0, s.jsx)(e1, {
        canSuppressEmbeds: S,
...
let e3 = (e) => {
    ...
    let { message: n, channel: i, disableReactionReads: a = !1, renderComponentAccessory: r = !1, renderThreadAccessory: l = !1, disableReactionCreates: o = !0, disableReactionUpdates: c = !0, isSearchResult: u = !1, ...d } = e,
        ...
        N = (0, Q.Z)(null == i ? void 0 : i.id),
        h = (0, R.V)(i.id, n.author.id),
        C = (0, O.r)(n.id),
        f = (0, J.Z)(n);
    return (0, s.jsx)(e1, {
        ...d,

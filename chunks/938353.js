...
class eY extends(s = l.Component) {
  ...
  renderAttachments(e) {
    ...
    let {
      ...
      channel_id: s.id,
      channel_type: s.type
    }, _ = f.length > 1 ? (0, ed.createMediaOnClickOverrides)(f, E) : {}, m = (0, e_.hasFlag)(n, eP.MessageFlags.IS_VOICE_MESSAGE);
  ...
  renderThreadRoleMentionWarning(e) {
    if (!!e.hasFlag(eP.MessageFlags.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) && !!this.props.isCurrentUser) {
      if (!(Date.now() - eT.default.extractTimestamp(e.id) >= ek)) return (0, a.jsx)("div", {
  ...
  constructor(...e) {
    ...
    }), eG(this, "renderEmbedTitle", (e, t) => e.type === eP.MessageEmbedTypes.RICH ? j.default.parseEmbedTitle(t, !0, {
      channelId: this.props.channel.id
    }) : t), eG(this, "renderEmbedDescription", (e, t, n) => e.type === eP.MessageEmbedTypes.RICH ? j.default.parse(t, !0, {
      channelId: this.props.channel.id,
      allowLinks: !0,
      allowEmojiLinks: !0,
...
function eK(e) {
  ...
  } = e, i = (0, u.useStateFromStores)([X.default], () => X.default.getId()), r = Z.InlineAttachmentMedia.useSetting(), o = Z.InlineEmbedMedia.useSetting(), d = Z.RenderEmbeds.useSetting() && !(0, eN.default)(e.message), c = Z.RenderReactions.useSetting(), f = Z.GifAutoPlay.useSetting(), E = (0, u.useStateFromStores)([ee.default], () => null == n.guild_id || ee.default.canChatInGuild(n.guild_id), [n]), _ = (0, u.useStateFromStores)([U.default], () => null != n.guild_id && U.default.isLurking(n.guild_id), [n]), m = (0, u.useStateFromStores)([$.default], () => $.default.isCurrentUserGuest(n.guild_id), [n]), T = (0, u.useStateFromStores)([$.default, en.default], () => {
    var e, t;
  ...
  }), D = (0, b.isMessageNewerThanImprovedMarkdownEpoch)((null !== (t = s.editedTimestamp) && void 0 !== t ? t : s.timestamp).valueOf()), P = (0, B.default)(null == n ? void 0 : n.id), y = (0, k.default)(s), j = (0, A.useShouldRedactExplicitContent)(n.id, s.author.id), G = (0, g.useShouldRenderReportFalsePositiveButton)(s.id);
  return (0, a.jsx)(eY, {
    canSuppressEmbeds: C,
...
let eW = e => {
  ...
  let {
    ...
    ...d
  } = e, c = Z.InlineAttachmentMedia.useSetting(), f = Z.InlineEmbedMedia.useSetting(), E = Z.RenderEmbeds.useSetting(), _ = Z.GifAutoPlay.useSetting(), m = (0, b.isMessageNewerThanImprovedMarkdownEpoch)((null !== (t = n.editedTimestamp) && void 0 !== t ? t : n.timestamp).valueOf()), T = (0, B.default)(null == s ? void 0 : s.id), I = (0, A.useShouldRedactExplicitContent)(s.id, n.author.id), p = (0, g.useShouldRenderReportFalsePositiveButton)(n.id), h = (0, k.default)(n);
  return (0, a.jsx)(eY, {
    ...d,
    message: n,
    channel: s,

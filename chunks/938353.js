...
class e0 extends(i = s.Component) {
  ...
  render() {
    ...
    return null == o && null == u && null == I && null == m && null == T && null == c && null == d && null == h && null == N && null == f && null == p && null == C && null == S && null == g && null == R && null == x && null != A && null == L && null == M && null == Z ? null : (0, a.jsxs)("div", {
      ...
      children: [Z, g, L, o, c, d, R, u, _, I, v, m, f, C, S, A, E, T, h, N, s && this.renderSuppressConfirmModal(), l && this.renderRemoveAttachmentConfirmModal(), p, x, O, M]
    })
  }
  constructor(...e) {
...
function e1(e) {
  ...
  }), [I, n]), p = (0, D.ux)(n.guild_id), [, C] = (0, j.AB)(n.guild_id), g = (0, en.$R)(n), S = (r === i.author.id || f) && i.author.id !== ew.LAt && !1 !== s && !(0, eC.yE)(i.flags, ew.iLy.EPHEMERAL) && g && 1 === (0, eO.Z)(i), A = r === i.author.id && g && !l, O = i.author.id === r, M = i.isFirstMessageInForumPost(n), Z = (0, ev.Z)({
    channel: n,
    canChat: I,
    renderReactions: _,
    canAddNewReactions: N,

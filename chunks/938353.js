...
class e0 extends(i = s.Component) {
  ...
  shouldComponentUpdate(e, t) {
    ...
    return !(0, u.Z)(this.state, t) || !(0, u.Z)(this.props, e, ["message", "channel"]) || a.type !== r.type || c !== l || o.codedLinks !== s.codedLinks || o.flags !== s.flags || o.giftCodes !== s.giftCodes || o.attachments !== s.attachments || o.embeds !== s.embeds || o.components !== s.components || o.activity !== s.activity || (n = o.reactions, n !== (i = s.reactions) && (n.length !== i.length || !!n.some((e, t) => {
      let {
        emoji: n,
        count: a,
        burst_count: s
  ...
  renderCodedLinks(e) {
    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
      ...
      if (n === g.g.INVITE) return this.shouldRenderInvite(i) ? (0, a.jsx)(eb.Z, {
        code: i,
        author: e.author,
        getAcceptInviteContext: this.getAcceptInviteContext
      }, i) : null;
      if (n === g.g.TEMPLATE) return (0, a.jsx)(B.Z, {
        code: i
      }, i);
      if (n === g.g.EVENT) return (0, a.jsx)(y.Z, {
        code: i
      }, i);
      else if (n === g.g.CHANNEL_LINK) return (0, a.jsx)(eL.Z, {
        code: i,
        messageData: e
      }, i);
      else if (n === g.g.APP_DIRECTORY_PROFILE) return (0, a.jsx)(N.Z, {
        code: i,
        message: e
      }, i);
      else if (n === g.g.ACTIVITY_BOOKMARK) return (0, a.jsx)(h.Z, {
        applicationId: i,
        message: e
      }, i);
      else if (n === g.g.GUILD_PRODUCT) return (0, a.jsx)(U.Z, {
        code: i
      }, i);
      else if (n === g.g.SERVER_SHOP) return (0, a.jsx)(S.Z, {
        guildId: i
      }, i);
      else if (n === g.g.QUESTS_EMBED) return (0, a.jsx)(X.Z, {
        questId: i
      }, i);
      else if (n === g.g.APP_DIRECTORY_STOREFRONT) return (0, a.jsx)(p.P, {
        appId: i,
        message: e
      }, i);
  ...
  renderEmbeds(e) {
    ...
    return 0 !== e.embeds.length && t ? e.embeds.map((t, n) => {
      if (eF.b.has(t.type) || (0, ep.l3)(t)) return null;
      let i = {
  ...
  renderThreadAccessories(e) {
    if (e.hasFlag(ew.iLy.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, a.jsx)(ei.Z, {
      message: e,
  ...
  renderVoiceChannelInvite(e, t) {
    if (1 === e.embeds.length && e.embeds[0].type === ew.hBH.VOICE_CHANNEL) return (0, a.jsx)(k.H, {
      message: e,
      channel: t
    })
  }
  renderMediaObscureNotice(e) {
    ...
    return 0 === t.length && 0 === n.length ? null : (0, a.jsx)(x.Z, {
      message: e
    })
  }
  renderPoll(e, t) {
    if (null != t) return (0, a.jsx)(K.Z, {
      message: e,
      poll: t,
  ...
  render() {
    ...
    return null == o && null == u && null == m && null == I && null == T && null == c && null == d && null == h && null == N && null == f && null == p && null == C && null == S && null == g && null == R && null == O && null != A && null == L && null == M && null == Z ? null : (0, a.jsxs)("div", {
      id: (0, ej.bX)(t),
      className: r()(e, eW.container),
      children: [Z, g, L, o, c, d, R, u, _, m, v, I, f, C, S, A, E, T, h, N, s && this.renderSuppressConfirmModal(), l && this.renderRemoveAttachmentConfirmModal(), p, O, x, M]
    })
  }
  constructor(...e) {
    super(...e), eK(this, "state", {
      ...
      } = this.props, _ = (0, eR.BP)(e, s, i, c, d);
...
function e1(e) {
  ...
  }), [m, n]), p = (0, D.ux)(n.guild_id), [, C] = (0, j.AB)(n.guild_id), g = (0, en.$R)(n), S = (r === i.author.id || f) && i.author.id !== ew.LAt && !1 !== s && !(0, eC.yE)(i.flags, ew.iLy.EPHEMERAL) && g && 1 === (0, ex.Z)(i), A = r === i.author.id && g && !l, x = i.author.id === r, M = i.isFirstMessageInForumPost(n), Z = (0, ev.Z)({
    channel: n,
    canChat: m,
    renderReactions: _,
    canAddNewReactions: N,
  ...
  }), P = (0, w.A)((null !== (t = i.editedTimestamp) && void 0 !== t ? t : i.timestamp).valueOf()), b = (0, Y.Z)(null == n ? void 0 : n.id), U = (0, z.Z)(i), y = (0, R.V)(n.id, i.author.id), B = (0, O.r)(i.id), {
...
let e7 = e => {
  ...
  let {
    ...
    ...d
  } = e, u = ea.x4.useSetting(), _ = ea.RS.useSetting(), E = ea.NA.useSetting(), m = ea.QK.useSetting(), I = (0, w.A)((null !== (t = n.editedTimestamp) && void 0 !== t ? t : n.timestamp).valueOf()), T = (0, Y.Z)(null == i ? void 0 : i.id), h = (0, R.V)(i.id, n.author.id), N = (0, O.r)(n.id), f = (0, z.Z)(n);
  return (0, a.jsx)(e0, {
    ...d,
    message: n,
    channel: i,

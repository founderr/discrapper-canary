...
function c(e) {
  let {
    ...
    focused: h,
    canvas: m
  } = e, p = l.useRef(!1), E = (0, a.default)([s.default], () => s.default.getDrawMode()), g = (0, o.default)((0, u.default)(t.id, n, c), f), S = (0, o.default)((0, d.default)(t.id, n, c), f), C = l.useCallback((e, t, n) => {
    if (null == m) return;
    let {
      x: l,
      y: a

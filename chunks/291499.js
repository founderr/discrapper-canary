...
function c(e) {
  let {
    ...
    focused: h,
    canvas: p
  } = e, m = a.useRef(!1), E = (0, l.default)([s.default], () => s.default.getDrawMode()), C = (0, o.default)((0, u.default)(t.id, n, c), f), S = (0, o.default)((0, d.default)(t.id, n, c), f), g = a.useCallback((e, t, n) => {
    if (null == p) return;
    let {
      x: a,
      y: l

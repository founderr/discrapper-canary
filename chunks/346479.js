n(789020);
var r = n(697988), i = n(544891), a = n(570140), o = n(668781), s = n(430742), l = n(367907), u = n(555573), c = n(131704), d = n(314897), _ = n(592125), E = n(496675), f = n(823379), h = n(920303), p = n(569471), m = n(91159), I = n(952537), T = n(981631), g = n(176505), S = n(689938);
function A(e, t) {
    return i.tn.patch({
...
t.Z = {
    ...
    async unarchiveThread(e, t) {
        let n = { archived: !1 }, r = e.isForumPost();
        t && (n.locked = !1);
        try {
            return await A(e, n);
        } catch (e) {
    ...
    async replacePin(e, t) {
        let n = e.merge({ flags: e.flags & ~g.zZ.PINNED }), r = t.merge({ flags: t.flags | g.zZ.PINNED });
        a.Z.dispatch({
            type: 'THREAD_UPDATE',
            channel: n
        }), a.Z.dispatch({

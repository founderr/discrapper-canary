...
let R = new s.Y("OverlayUsageStatsManager");
R.verbose = () => {};
class g {
  increment(e) {
    ++this.actions[e]
...
p(D, "gamesByPid", {}), p(D, "gamesByName", {}), p(D, "desktopMainWindowHasFocus", document.hasFocus());
class H {

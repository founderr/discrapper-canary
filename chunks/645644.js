...
let A = new a.Yd('OverlayUsageStatsManager');
A.verbose = () => {};
class N {
    increment(e) {
        ++this.actions[e];
    ...
    constructor() {
        y(this, 'actionCounters', {
            ...
            y(this, 'groupCounters', {
                [S.bv.Viewed]: C.makeEmptyGroupAnalytics(),
                [S.bv.Clicked]: C.makeEmptyGroupAnalytics()
            }),
            y(this, 'counters', {
                [S.n0.NewsNudge]: new N(),
                [S.n0.WelcomeNudge]: new N(),
                [S.n0.TextChat]: new N(),
                [S.n0.ActivityUserJoin]: new N(),
                [S.n0.ActivityInvite]: new N(),
                [S.n0.IncomingCall]: new N(),
                [S.n0.GoLiveNudge]: new N(),
                [S.n0.GoLiveNonVoiceNudge]: new N(),
                [S.n0.OverlayCrashed]: new N(),
                [S.n0.ClipsReminderNotification]: new N(),
                [S.n0.ClipsNotification]: new N(),
                [S.n0.KeybindIndicatorsNotification]: new N(),
                [S.n0.SendGameInvitesNotification]: new N()
            });
    }
}
...
class D {
    ...
    async getAnalytics() {
        ...
        let o = {
                ...
                setting_method: null == this.overlayStatus ? null : S.gl[this.overlayStatus.overlayMethod],

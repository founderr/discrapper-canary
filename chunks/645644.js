n(47120), n(411104);
var r, i, a = n(259443), o = n(379649), s = n(570140), l = n(593472), u = n(147913), c = n(579806), d = n(581567), _ = n(594190), E = n(449224), f = n(808506), h = n(237997), p = n(626135), m = n(998502), I = n(830917), T = n(554174), g = n(938038), S = n(981631), A = n(987650);
function N(e, t, n) {
...
class O {
    ...
    getAnalytics(e, t) {
        let n = this.actions[A.bv.Viewed], r = this.actions[A.bv.Clicked];
        return 0 === n && 0 === r ? null : {
            event_uuid: t,
            notification_type: e,
            viewed_count: n,
...
class R {
    ...
    getAnalytics() {
        let e = this.groupCounters[A.bv.Viewed], t = this.groupCounters[A.bv.Clicked];
        return {
...
class C {
    ...
    getAnalytics() {
        let e = this.types[0], t = this.types[1];
        return {
...
class y {
    update() {
        let e = this.game, t = m.ZP.GetWindowFullscreenTypeByPid(e.pid, e.name, e.fullscreenType);
    ...
    getAnalytics() {
        var e, t;
        let n = e => this.counters[e].elapsed().asMilliseconds(), r = {
                ...
                let [n, r] = e, [i, a] = t;
                return a - r;
            })[0], a = parseInt(i[0], 10), o = isNaN(a) ? l.Jx.UNKNOWN : a;
        isNaN(a) && v.error('ScreenTypeAnalytics: Unknown most used screen type: '.concat(i), r);
        let s = g.c.getGameDisplayMode(null !== (e = this.game.name) && void 0 !== e ? e : this.game.id);
        g.c.setGameDisplayMode(null !== (t = this.game.name) && void 0 !== t ? t : this.game.id, o);
        let u = {
    ...
    constructor(e) {
        ...
        }, this.lastscreenType = void 0, this.update(), this.updateScreenInterval = setInterval(() => this.update(), 10000);
    }
}
class D {
    static get debug() {
    ...
    static async destroy(e) {
        ...
        if (null != n) {
            ...
            for (let e of (p.default.track(S.rMx.OVERLAY_USAGE_STATS, t.usage), t.notifications))
                p.default.track(S.rMx.OVERLAY_USAGE_NOTIFICATION_STATS, e);
    ...
    async getAnalytics() {
        ...
        let s = {
            ...
            }, l = (0, _.jk)(this.game), u = (0, d.G8)(this.game);
        return {
            usage: {
                ...
                hardware_display_count: null !== (o = await (null === c.Z || void 0 === c.Z ? void 0 : null === (t = c.Z.hardware) || void 0 === t ? void 0 : null === (e = t.getDisplayCount) || void 0 === e ? void 0 : e.call(t))) && void 0 !== o ? o : null,
    ...
    static gameSetAllUnfocused() {
        for (let e of Object.values(D.gamesByPid))
            e.gameFocusedTimer.stop();
    }
...
function L(e) {
    ...
    for (let t of e.removed)
        D.destroy(t), v.verbose('handleRunningGamesChange removed', t);
}
function b(e) {
...
function P(e) {
    ...
    if (null != r)
        !r.initialized && (r.initialized = !0, r.pinned = e.pinned), r.pinned !== e.pinned && ++r.pinnedToggledCount, r.pinned = e.pinned, r.visibleDuration.toggle(e.visible);
}
function U(e) {
    if (v.verbose('OVERLAY_FOCUSED', e), D.gameSetAllUnfocused(), null == e.pid)
        return;
    let t = D.getByPid(e.pid);
    if (null == t) {
...
class Z {
    ...
    static handleMessageCreate(e) {
        if (e.message.state !== S.yb.SENDING)
            return;

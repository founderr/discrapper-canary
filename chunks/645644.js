...
function k(e) {
    e.message.state === g.yb.SENDING && D.desktopMessageEvent('created');
}
function B(e) {
    null != (0, T.Z)() && (R.verbose('AUDIO_TOGGLE_SELF_MUTE', e), D.handleMuteToggled());
}
function F(e) {

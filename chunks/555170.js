...
var u = function (e, t) {
    ...
    }, c = n(138772), d = n(413135).Buffer, _ = (void 0 !== n.g ? n.g : 'undefined' != typeof window ? window : 'undefined' != typeof self ? self : {}).Uint8Array || function () {
    }, E = n(260907);
i = E && E.debuglog ? E.debuglog('stream') : function () {
};
var f = n(443551), h = n(887866), p = n(97703).getHighWaterMark, m = n(531478).codes, I = m.ERR_INVALID_ARG_TYPE, T = m.ERR_STREAM_PUSH_AFTER_EOF, g = m.ERR_METHOD_NOT_IMPLEMENTED, S = m.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
n(689118)(O, c);
...
O.prototype.read = function (e) {
    ...
    var t, n = this._readableState, r = e;
...
O.prototype.unpipe = function (e) {
    ...
    var n = c.prototype.on.call(this, e, t), r = this._readableState;

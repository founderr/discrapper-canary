var r,
    ...
    o,
    l = n(444675);
(e.exports = O), (O.ReadableState = R), n(836560).EventEmitter;
var u = function (e, t) {
...
var f = n(443551),
    ...
    g = I.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
n(689118)(O, c);
...
function O(e) {
    if (((r = r || n(827664)), !(this instanceof O))) return new O(e);
    var t = this instanceof r;
    (this._readableState = new R(e, this, t)), (this.readable = !0), e && ('function' == typeof e.read && (this._read = e.read), 'function' == typeof e.destroy && (this._destroy = e.destroy)), c.call(this);
}
function v(e, t, n, r, a) {
    ...
    if (null === t)
        (l.reading = !1),
            (function (e, t) {
                if ((i('onEofChunk'), !t.ended)) {
                    ...
                    (t.ended = !0), t.sync ? y(e) : ((t.needReadable = !1), !t.emittedReadable && ((t.emittedReadable = !0), D(e)));
                }
            })(e, l);
    else if (
        (!a &&
        ...
        if (r) l.endEmitted ? A(e, new g()) : C(e, l, t, !0);
        else if (l.ended) A(e, new T());
        else {
            if (l.destroyed) return !1;
            (l.reading = !1), l.decoder && !n ? ((t = l.decoder.write(t)), l.objectMode || 0 !== t.length ? C(e, l, t, !1) : b(e, l)) : C(e, l, t, !1);
        }
    } else !r && ((l.reading = !1), b(e, l));
    return !l.ended && (l.length < l.highWaterMark || 0 === l.length);
}
function C(e, t, n, r) {
    t.flowing && 0 === t.length && !t.sync ? ((t.awaitDrain = 0), e.emit('data', n)) : ((t.length += t.objectMode ? 1 : n.length), r ? t.buffer.unshift(n) : t.buffer.push(n), t.needReadable && y(e)), b(e, t);
}
...
O.prototype.read = function (e) {
    ...
    var t,
        ...
        r = e;
    if ((0 !== e && (n.emittedReadable = !1), 0 === e && n.needReadable && ((0 !== n.highWaterMark ? n.length >= n.highWaterMark : n.length > 0) || n.ended))) return i('read: emitReadable', n.length, n.ended), 0 === n.length && n.ended ? k(this) : y(this), null;
...
(O.prototype.unpipe = function (e) {
    ...
    (O.prototype.on = function (e, t) {
        var n = c.prototype.on.call(this, e, t),
            r = this._readableState;
        return 'data' === e ? ((r.readableListening = this.listenerCount('readable') > 0), !1 !== r.flowing && this.resume()) : 'readable' === e && !r.endEmitted && !r.readableListening && ((r.readableListening = r.needReadable = !0), (r.flowing = !1), (r.emittedReadable = !1), i('on readable', r.length, r.reading), r.length ? y(this) : !r.reading && l.nextTick(U, this)), n;
    }),
...
(O.prototype.pause = function () {
    ...
    (O.prototype.wrap = function (e) {
        ...
        for (var s = 0; s < N.length; s++) e.on(N[s], this.emit.bind(this, N[s]));
        return (

...
function c(e) {
  ...
  } = (0, d.useManageResourcePermissions)(null != E ? E : c), [T, S] = (0, u.useStateFromStoresArray)([i.default], () => [i.default.isActive(t), i.default.getGuildScheduledEvent(t)]), v = (0, s.default)(n, null == S ? void 0 : S.id), g = null != S && _(S), I = f && (null == v ? void 0 : v.is_canceled) && g;

...
var i = n(200651),
    ...
    u = n(604643);
function m(e) {
    let { label: t, ariaLabel: n, tooltipText: r, tooltipColor: m, icon: h, iconProps: f, onClick: p, onTooltipShow: _, onTooltipHide: g, disabled: E, dangerous: C, separator: I, sparkle: x, showNewBadge: v, buttonClassName: N, children: T, ...S } = e,
        ...
        (0, i.jsx)(a.Tooltip, {
            ...
            children: (e) => {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [
                        (0, i.jsxs)(s.zx, {
                            className: l()(N, { [u.hoverBarButton]: A }),
                            onMouseEnter: r,
                            onMouseLeave: c,
                            onClick: (e) => {
                                null == m || m(), p(e);

...
function v(e) {
  let {
    ...
    ..._,
    section: h ? p.AnalyticsSections.EXPRESSION_PICKER : p.AnalyticsSections.CONTEXT_MENU
  }), [_, h]), C = (0, m.useFavoriteStickerIds)(), R = (0, l.useStateFromStores)([g.default], () => t === f.PickerContextMenuDataTypes.STICKER && null != n ? g.default.getStickerById(n) : null), O = null != R && C.includes(R.id), x = (0, l.useStateFromStores)([o.default], () => {
  ...
  }), N = (0, d.useIsFavoriteEmoji)(null, x);
  ...
  if (null != x && t === f.PickerContextMenuDataTypes.EMOJI) return N ? (0, a.jsx)(s.MenuItem, {
    id: "unfavorite",

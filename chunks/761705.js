...
class L extends i.Component {
  componentWillEnter(t) {
    ...
    n.setValue(e[e.length - 1]), o.setValue(0), t(), u.Z.parallel([u.Z.timing(o, {
      toValue: 1,
...
class N extends(o = i.Component) {
  ...
  render() {
    ...
    } = this.props, s = this.props.items[n], l = this.props.items;
    return (0, r.jsxs)(p.W, {
      component: "div",
      className: a()(C.wrapper, e),
      children: [l.length > 1 ? (0, r.jsx)(f.am, {
        className: C.navPrev,
        onClick: this.gotoPrev
      }) : null, null !== (t = s.component) && void 0 !== t ? t : (0, r.jsx)(L, {
        item: s,
        directionHistory: o,
        className: i
      }, s.src), l.length > 1 ? (0, r.jsx)(f.Pz, {
        className: C.navNext,

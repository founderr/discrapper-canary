...
i.push(t - o), t = (t % (a = this.props.items.length) + a) % a, this.setState({
  currentIndex: t,
  directionHistory: i
...
return (0, i.jsxs)(d.W, {
  ...
  children: [
    l.length > 1 ? (0, i.jsx)(m.am, {
      className: b.navPrev,
      onClick: this.gotoPrev
    }) : null,
    null !== (t = r.component) && void 0 !== t ? t : (0, i.jsx)(_, {
      item: r,
      directionHistory: a,
      className: o
    }, r.src),
    l.length > 1 ? (0, i.jsx)(m.Pz, {
      className: b.navNext,

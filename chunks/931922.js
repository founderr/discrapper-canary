...
function P(e) {
  let {
    channel: t
  } = e, [n, l] = s.useState(!1), r = (0, p.default)(t, !0), P = (0, c.useStateFromStores)([S.default], () => S.default.getGuild(t.guild_id)), b = (0, c.useStateFromStores)([A.default], () => A.default.getUser(null == P ? void 0 : P.ownerId)), F = s.useMemo(() => null != P ? o(P.roles).sortBy(e => -e.position).filter(e => e.id !== P.id).value() : [], [P]), H = s.useMemo(() => o(F).filter(e => {
    if (null == P) return !1;
  ...
  }).value(), [t, P, F]), U = (0, c.useStateFromStoresArray)([A.default], () => {
    let e = {};
  ...
  return (0, a.jsxs)(x.default, {
    ...
    children: [(0, a.jsx)(x.EmptyMessageIcon, {
      ...
      className: j.members,
      children: [function() {
        if (1 !== U.length || H.length > 0) return (0, a.jsx)(y.default, {
          guildId: t.guild_id,
          className: j.avatars,
          maxUsers: 5,
          users: U

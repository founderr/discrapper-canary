...
function b(e) {
  let {
    channel: t
  } = e, [n, l] = a.useState(!1), r = (0, p.default)(t, !0), b = (0, c.useStateFromStores)([_.default], () => _.default.getGuild(t.guild_id)), F = (0, c.useStateFromStores)([A.default], () => A.default.getUser(null == b ? void 0 : b.ownerId)), H = a.useMemo(() => null != b ? o(b.roles).sortBy(e => -e.position).filter(e => !(0, m.isEveryoneRoleId)(b.id, e.id)).value() : [], [b]), U = a.useMemo(() => o(H).filter(e => {
    if (null == b) return !1;
  ...
  }, [t, F]), B = T.default.can(D.Permissions.MANAGE_CHANNELS, t) || T.default.can(D.Permissions.MANAGE_ROLES, t);
  ...
  return (0, s.jsxs)(y.default, {
    channelId: t.id,
    children: [(0, s.jsx)(y.EmptyMessageIcon, {
      locked: !0,
      channelType: t.type
    }), (0, s.jsx)(y.EmptyMessageHeader, {
      children: P.default.Messages.BEGINNING_CHANNEL_WELCOME.format({
        channelName: r
      })
    }), (0, s.jsx)(y.EmptyMessageBody, {
      ...
      className: j.members,
      children: [function() {
        if (1 !== k.length || U.length > 0) return (0, s.jsx)(O.default, {
          guildId: t.guild_id,
          className: j.avatars,
          maxUsers: 5,
          users: k

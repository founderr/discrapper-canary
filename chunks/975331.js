...
function S() {
  ...
  let {
    editStateId: t
  } = (0, u.N)(), [n, i] = _.TT(t), [S, h] = _.F2(t), g = (0, c.oC)(t), {
    options: C
  } = (0, I.Z)(null !== (e = null == g ? void 0 : g.active_trial) && void 0 !== e ? e : null), x = (0, E.Z)(), p = null != n, R = a.useCallback(e => {
    let t = C.find(e => e.isDefault);
    r()(null != t, "Missing default trial duartion option"), i(e ? t.value : null)
  }, [i, C]), f = (0, d.mY)(), L = (0, o.Dt)(), O = (0, o.Dt)();
  return (0, s.jsxs)(T.Z, {

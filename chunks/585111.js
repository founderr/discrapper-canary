s(47120);
var n = s(735250), i = s(470079), o = s(120356), l = s.n(o), a = s(772848), r = s(990547), h = s(481060), d = s(985513), u = s(285952), c = s(968405), p = s(689938), m = s(609810), C = s(483085), f = s(549856);
function g(e, t, s) {
...
class y extends i.PureComponent {
    ...
    render() {
        ...
        return e = null != i && '' !== i ? (0, n.jsx)('div', {
            ...
            children: [
                (0, n.jsx)(d.Z, { onSubmit: this.handleVerifyPhone }),
                (0, n.jsx)(h.Button, {
    ...
    constructor(e) {
        super(e), g(this, '_animItem', null), g(this, '_lottieRef', void 0), g(this, 'headerId', (0, a.Z)()), g(this, 'setLottieRef', e => {
            ...
            this.state.animated || null == this._animItem ? this.setState({ phone: e }) : (this._animItem.play(), this.setState({
                animated: !0,
                phone: e
            }));

...
if (this.ackMessageId = null !== (t = null != e ? e : this._ackMessageId) && void 0 !== t ? t : this.guessAckMessageId(), this.isManualAck = null != e, this.oldestUnreadMessageId = null, this.estimated = !1, this.unreadCount = 0, r && (this.mentionCount = 0), this.hasUnread()) {
  let e = ee.default.getCurrentUser(),
    ...
    a = !1,
    o = null,
    s = q.Z.getMessages(this.channelId);
  s.forAll(n => {
    if (i) {
      var s;
...
let i = 0,
  a = null,
  o = null !== (n = r._ackMessageId) && void 0 !== n ? n : V.default.fromTimestamp(r.getAckTimestamp());
...
o = K.Z.getGuild(null != e ? e : null == a ? void 0 : a.guild_id),
s = (null == a ? void 0 : a.isForumPost()) ? 0 : ew(o),
...
} = e, n = t.guild_id, r = eL.get(t.guild_id, eo.W.GUILD_EVENT);

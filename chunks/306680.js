...
class eb {
    ...
    canBeUnread() {
        return !((this._isThread && !this._isJoinedThread) || (0, R.h3)(this.channelId, [v.Z, C.Z]) || (!this._isThread && (0, L.r1)(this._guildId) && (this._lastMessageTimestamp < eS || (!ee.ZP.isChannelOrParentOptedIn(this._guildId, this.channelId) && !this.hasRecentlyVisitedAndRead() && !this.hasMentions())))) && this.canTrackUnreads();
    }
    canHaveMentions() {
        return !(0 === this.mentionCount || (this._isThread && !this._isJoinedThread) || (0, R.h3)(this.channelId, [v.Z, C.Z]) || ((0, L.r1)(this._guildId) && this._lastMessageTimestamp < eS)) && this.canTrackUnreads();
    }
...
function eM(e) {
    e.forEach((e) => {
        if ((0, x.Em)(e.type)) {
            let t = eb.get(e.id);
            (t._guildId = e.guild_id), (t.lastMessageId = e.lastMessageId), (t.lastPinTimestamp = ev(e.lastPinTimestamp)), (t._isResourceChannel = e.hasFlag(ea.zZ.IS_GUILD_RESOURCE_CHANNEL)), x.Ec.has(e.type) && t.syncThreadSettings();
        }
    });
}
function eP(e) {
    e.forEach((e) => {
        if ((0, x.Em)(e.type)) {
            var t;
            let n = eb.get(e.id);
            (n.lastMessageId = e.last_message_id), (n.lastPinTimestamp = ev(e.last_pin_timestamp)), (n._isResourceChannel = (0, B.yE)(null !== (t = e.flags) && void 0 !== t ? t : 0, ea.zZ.IS_GUILD_RESOURCE_CHANNEL)), x.Ec.has(e.type) && n.syncThreadSettings();
        }
    });
}
function eU(e) {
    (function (e) {
        ...
        null === (t = e.threads) ||
            ...
            t.forEach((t) => {
                ...
                let n = eb.get(t.id);
                (n.lastMessageId = t.lastMessageId), (n.lastPinTimestamp = ev(t.lastPinTimestamp)), (n._isThread = !0), (n._isActiveThread = !0), (n._isJoinedThread = null != t.member), null == n.ackMessageId && (n.ackMessageId = H.default.fromTimestamp(ew(e.id, t.id))), null == n.ackPinTimestamp && (n.ackPinTimestamp = ew(e.id, t.id));
            });
    })(e),
        (function (e) {
            var t, n;
...
class eJ extends (a = _.ZP.Store) {
    initialize() {
        let e = [W.Z, et.default, z.Z, K.Z, j.Z, J.Z, Q.Z, X.Z, m.Z, M.Z, P.Z, Y.ZP, N.ZP, A.Z, g.Z, ee.ZP, en.Z, D.Z, v.Z, w.Z, C.Z];
...
let e0 = new eJ(p.Z, {
    ...
    CONNECTION_OPEN: function (e) {
        ...
        eO(),
            ...
            s.entries.forEach((e) => {
                ...
                null != s && (0, x.Q5)(s.type) && (null == e.last_message_id || 0 === e.last_message_id) ? (a.ackMessageId = H.default.fromTimestamp(ew(s.guild_id, s.id))) : a.ackedWhileCached ? -1 === H.default.compare(a.ackMessageId, e.last_message_id) && (a.ackMessageId = e.last_message_id) : (a.ackMessageId = e.last_message_id), (a.ackedWhileCached = void 0), (a.ackPinTimestamp = ev(e.last_pin_timestamp)), eb._mentionChannels.delete(a.channelId), a._mentionCount > 0 && a.canHaveMentions() && eb._mentionChannels.add(a.channelId);
            }),
    ...
    THREAD_CREATE: function (e) {
        ...
        (function (e) {
            ...
            let t = eb.get(e.id);
            (t.lastMessageId = e.lastMessageId), (t.lastPinTimestamp = ev(e.lastPinTimestamp)), t.syncThreadSettings(), e.ownerId === Z.default.getId() && (t.loadedMessages = !0);
        })(t),
            (function (e) {
                let t = e.parent_id;
    ...
    THREAD_LIST_SYNC: function (e) {
        ...
        t.forEach((e) => {
            ...
            let t = eb.get(e.id);
            if (((t.lastMessageId = e.lastMessageId), (t.lastPinTimestamp = ev(e.lastPinTimestamp)), (t._isThread = !0), (t._isActiveThread = !0), (t._isJoinedThread = P.Z.hasJoined(e.id)), e.isForumPost())) {

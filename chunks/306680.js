...
let eg = 0,
    ...
    eN = null;
function eO() {
    (eg = Date.now() - 7 * k.Z.Millis.DAY),
        (eA = Date.now() - 3 * k.Z.Millis.DAY),
        clearTimeout(eN),
        (eN = setTimeout(() => {
...
function ey(e) {
    ...
    if ((null != I.ZP.getConnectedActivityChannelId() && I.ZP.getActivityPanelMode() === ei.Ez.PANEL && I.ZP.getFocusedLayout() === ei.MI.NO_CHAT) || q.Z.isIdle() || !e.canTrackUnreads()) return !1;
...
class eb {
    ...
    rebuildChannelState(e) {
        ...
        if (((this.ackMessageId = null !== (t = null != e ? e : this._ackMessageId) && void 0 !== t ? t : this.guessAckMessageId()), (this.isManualAck = null != e), (this.oldestUnreadMessageId = null), (this.estimated = !1), (this.unreadCount = 0), r && (this.mentionCount = 0), this.hasUnread())) {
            ...
            o.forAll((n) => {
                ...
                H.default.extractTimestamp(n.id) > t ? (this.unreadCount++, r && ev(n, e) && this.mentionCount++, (s = null != s ? s : n.id)) : (a = !0);
            }),
    ...
    canBeUnread() {
        return !((this._isThread && !this._isJoinedThread) || (0, v.h3)(this.channelId, [R.Z, C.Z]) || (!this._isThread && (0, y.r1)(this._guildId) && (this._lastMessageTimestamp < eg || (!ee.ZP.isChannelOrParentOptedIn(this._guildId, this.channelId) && !this.hasRecentlyVisitedAndRead() && !this.hasMentions())))) && this.canTrackUnreads();
    }
    canHaveMentions() {
        return !(0 === this.mentionCount || (this._isThread && !this._isJoinedThread) || (0, v.h3)(this.channelId, [R.Z, C.Z]) || ((0, y.r1)(this._guildId) && this._lastMessageTimestamp < eg)) && this.canTrackUnreads();
    }
    getGuildChannelUnreadState(e, t, n, r, i) {
        ...
        } else if (S.Z.isChannelGated(this.guildId, this.channelId) && !X.Z.can(er.Plq.VIEW_CHANNEL, e))
            return {
                mentionCount: 0,
                unread: !1
            };
    ...
    _ack(e, t) {
        ...
        eD(() =>
            ...
            null != e &&
                (eE === a && i === Z.default.getId() && (eE = e.body.token),
    ...
    getAckTimestamp() {
        ...
        if (this._isThread) return (this._ackMessageTimestamp = ew(this.guildId, this.channelId)), (this._ackMessageId = H.default.fromTimestamp(this._ackMessageTimestamp)), this._ackMessageTimestamp;
...
function eM(e) {
    e.forEach((e) => {
        if ((0, x.Em)(e.type)) {
            let t = eb.get(e.id);
            (t._guildId = e.guild_id), (t.lastMessageId = e.lastMessageId), (t.lastPinTimestamp = eR(e.lastPinTimestamp)), (t._isResourceChannel = e.hasFlag(ea.zZ.IS_GUILD_RESOURCE_CHANNEL)), x.Ec.has(e.type) && t.syncThreadSettings();
        }
    });
}
function eP(e) {
    e.forEach((e) => {
        if ((0, x.Em)(e.type)) {
            var t;
            let n = eb.get(e.id);
            (n.lastMessageId = e.last_message_id), (n.lastPinTimestamp = eR(e.last_pin_timestamp)), (n._isResourceChannel = (0, B.yE)(null !== (t = e.flags) && void 0 !== t ? t : 0, ea.zZ.IS_GUILD_RESOURCE_CHANNEL)), x.Ec.has(e.type) && n.syncThreadSettings();
        }
    });
}
function eU(e) {
    (function (e) {
        ...
        null === (t = e.threads) ||
            ...
            t.forEach((t) => {
                ...
                let n = eb.get(t.id);
                (n.lastMessageId = t.lastMessageId), (n.lastPinTimestamp = eR(t.lastPinTimestamp)), (n._isThread = !0), (n._isActiveThread = !0), (n._isJoinedThread = null != t.member), null == n.ackMessageId && (n.ackMessageId = H.default.fromTimestamp(ew(e.id, t.id))), null == n.ackPinTimestamp && (n.ackPinTimestamp = ew(e.id, t.id));
            });
    })(e),
        (function (e) {
            var t, n;
            if ((null === (t = e.guild_scheduled_events) || void 0 === t ? void 0 : t.length) === 0 && null == eb.getIfExists(e.id, eo.W.GUILD_EVENT)) return;
...
function e$(e, t, n, r) {
    ...
    return (
        ...
        ((n = null !== (i = null != n ? n : a.lastMessageId) && void 0 !== i ? i : H.default.fromTimestamp(a.getAckTimestamp())),
        a.ack({
            messageId: n,
            local: null == r || r
        }))
...
class eJ extends (a = _.ZP.Store) {
    initialize() {
        let e = [W.Z, et.default, z.Z, K.Z, j.Z, J.Z, Q.Z, X.Z, m.Z, M.Z, P.Z, Y.ZP, N.ZP, A.Z, S.Z, ee.ZP, en.Z, D.Z, R.Z, w.Z, C.Z];
    ...
    isNewForumThread(e, t, n) {
        let r = eb.get(t);
        if (!0 === eb.get(e)._persisted || null == r.ackMessageIdAtChannelSelect || 0 >= H.default.compare(e, r.ackMessageIdAtChannelSelect)) return !1;
        let i = ex(n);
...
let e0 = new eJ(p.Z, {
    BACKGROUND_SYNC_CHANNEL_MESSAGES: function (e) {
        ...
        for (let e in t) {
            ...
            let i = t[e],
                a = eb.getIfExists(e);
            if (null != a) for (let e of [null === (n = i.new_messages) || void 0 === n ? void 0 : n[0]].concat(null !== (r = i.modified_messages) && void 0 !== r ? r : []).filter(F.lm)) 1 === H.default.compare(e.id, a.lastMessageId) && (a.lastMessageId = e.id);
        }
    },
    CONNECTION_OPEN: function (e) {
        ...
        eO(),
            ...
            s.entries.forEach((e) => {
                ...
                null != s && (0, x.Q5)(s.type) && (null == e.last_message_id || 0 === e.last_message_id) ? (a.ackMessageId = H.default.fromTimestamp(ew(s.guild_id, s.id))) : a.ackedWhileCached ? -1 === H.default.compare(a.ackMessageId, e.last_message_id) && (a.ackMessageId = e.last_message_id) : (a.ackMessageId = e.last_message_id), (a.ackedWhileCached = void 0), (a.ackPinTimestamp = eR(e.last_pin_timestamp)), eb._mentionChannels.delete(a.channelId), a._mentionCount > 0 && a.canHaveMentions() && eb._mentionChannels.add(a.channelId);
            }),
            eb.resetGuildSentinels();
        let o = null === (t = et.default.getCurrentUser()) || void 0 === t ? void 0 : t.id;
        for (let e of (null != o && (eb.get(o, eo.W.NOTIFICATION_CENTER).lastMessageId = H.default.fromTimestamp(Date.now())),
        (function (e) {
            let t = et.default.getCurrentUser();
            if (null == t) return 0;
    ...
    OVERLAY_INITIALIZE: function (e) {
        ...
        eO(),
            (eE = null),
            (ed = n),
            (e_ = Y.ZP.getCurrentSidebarChannelId(ed)),
            eb.clearAll(),
            t.forEach((e) => {
    ...
    GUILD_CREATE: function (e) {
        ...
        eb.forEach((e) => {
            ...
            eM(null !== (t = n.channels) && void 0 !== t ? t : []),
            eV(n),
            eU(n);
    },
    ...
    THREAD_CREATE: function (e) {
        let { channel: t } = e;
        (function (e) {
            if (!x.AW.has(e.type)) return 0;
            let t = eb.get(e.id);
            (t.lastMessageId = e.lastMessageId), (t.lastPinTimestamp = eR(e.lastPinTimestamp)), t.syncThreadSettings(), e.ownerId === Z.default.getId() && (t.loadedMessages = !0);
        })(t),
            (function (e) {
                let t = e.parent_id;
    ...
    THREAD_LIST_SYNC: function (e) {
        ...
        t.forEach((e) => {
            ...
            let t = eb.get(e.id);
            if (((t.lastMessageId = e.lastMessageId), (t.lastPinTimestamp = eR(e.lastPinTimestamp)), (t._isThread = !0), (t._isActiveThread = !0), (t._isJoinedThread = P.Z.hasJoined(e.id)), e.isForumPost())) {
    ...
    GUILD_SCHEDULED_EVENT_CREATE: function (e) {
        let { guildScheduledEvent: t } = e,
            n = t.guild_id,
            r = eb.get(t.guild_id, eo.W.GUILD_EVENT);
    ...
    GUILD_SCHEDULED_EVENT_UPDATE: function (e) {
        let { guildScheduledEvent: t } = e,
            n = t.guild_id;
        if (ej(t) || ![es.p1.CANCELED, es.p1.COMPLETED].includes(t.status)) return !1;

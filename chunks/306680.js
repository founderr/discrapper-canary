...
class eL {
    ...
    serialize(e) {
        ...
        return null != I && I > 0 && (T.lastViewed = I), i && ((T._isThread = i), (T._isActiveThread = a), (T._isJoinedThread = s)), T;
    }
    ...
    hasRecentlyVisitedAndRead() {
        return this._lastMessageTimestamp > 0 && null != this._ackMessageId && this.getAckTimestamp() > eT && P.Z.getGuildRecentsDismissedAt(this._guildId) < this.getAckTimestamp();
    }
    isForumPostUnread() {
...
class e$ extends (a = f.ZP.Store) {
    initialize() {
        let e = [W.Z, et.default, z.Z, K.Z, Y.Z, $.Z, Q.Z, X.Z, E.Z, x.Z, w.Z, H.ZP, S.ZP, T.Z, b.Z, ee.ZP, en.Z, O.Z, A.Z, P.Z, C.Z];

...
isResourceChannelView: w
  } = e, P = (0, i.e7)([b.Z], () => b.Z.getChannel(n)), y = (0, i.e7)([v.Z], () => v.Z.getGuild(null == P ? void 0 : P.getGuildId())), k = (0, i.e7)([j.default], () => j.default.getCurrentUser()), H = (0, i.e7)([Z.Z], () => Z.Z.didAgree(null == P ? void 0 : P.guild_id)), D = (null == k ? void 0 : k.nsfwAllowed) === !0, U = (0, S.ZP)(P), W = (0, i.e7)([g.Z], () => (null == y ? void 0 : y.id) != null && g.Z.isLurking(y.id), [y]), G = (0, f.Z)(n), F = (0, i.e7)([_.Z], () => {
var e;
return null === (e = _.Z.getResourceForChannel(null == y ? void 0 : y.id, n)) || void 0 === e ? void 0 : e.title;
  ...
  null != P && !z.current && (z.current = !0, (0, d.yw)(A.rMx.CHANNEL_OPENED, {
    ...(0, d.$H)(P.id),
    channel_view: M
  }), (0, u.a)(A.rMx.CHANNEL_OPENED_CLICKSTREAM, {
    channelId: P.id
  }));
}, [
  P,
...
return null;
  let V = [];
  return (!W && V.push((0, l.jsx)(p.Z, {
channel: P
  }, 'notifications')), V.push((0, l.jsx)(C.ZP.Icon, {
icon: r.XSmallIcon,

...
function N(e) {
  ...
  }), M = (0, s.useStateFromStores)([f.default], () => f.default.hasLayers()), [R, j] = (0, s.useStateFromStoresArray)([u.default], () => [u.default.getMode(t.id), u.default.getLayout(t.id)]), L = (0, r.useModalsStore)(r.hasAnyModalOpenSelector), y = (0, p.default)(), O = y.filter(e => e.twoWayLink), [P, D] = l.useState(!1);
  if (null == N && 0 === y.length || t.isBroadcastChannel()) return null;
  let b = _.ChannelModes.VOICE !== R && [_.ChannelLayouts.NO_CHAT, _.ChannelLayouts.FULL_SCREEN].includes(j) ? "top" : "bottom",
    U = [];
  return O.length > 0 && U.push(i.DismissibleContent.DONUT_DESKTOP_NUX), (0, a.jsx)(o.default, {
    contentTypes: U,
    children: e => {
      let {
        visibleContent: l,

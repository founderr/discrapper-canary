...
var r = function () {
    ...
    }(), i = n(470079), a = u(i), o = u(n(844303)), s = u(n(123763)), l = function (e) {
        if (e && e.__esModule)
            return e;
        var t = {};
        if (null != e)
...
var c = t.Saturation = function (e) {
    ...
    return !function (e, t) {
        ...
        },
        {
            key: 'render',
            value: function () {
                var e = this, t = this.props.style || {}, n = t.color, r = t.white, i = t.black, s = t.pointer, l = t.circle, u = (0, o.default)({
                        default: {
                            color: {

...
try {
  ...
  c = o ? Object.defineProperty : function(e, t, n) {
...
return n;
  ...
  m = (Array.prototype.unshift, Function.prototype.bind || function(e) {
var t = this,
...
f['[[' + m + ']]'] = g, h += S, p++;
  ...
  if (h.length > 2)
var s = s.substring(0, l) + h + s.substring(l);
  return f['[[locale]]'] = s, f;
}
...
if (t < 0 && (c = !0, t = -t), 'percent' === i['[[style]]'] && (t *= 100), n = u.call(i, '[[minimumSignificantDigits]]') && u.call(i, '[[maximumSignificantDigits]]') ? function(e, t, n) {
    ...
    if (r.indexOf('.') >= 0 && n > t) {
      for (var s = n - t; s > 0 && '0' === r.charAt(r.length - 1);)
        r = r.slice(0, -1), s--;
    ...
    for (l && (a = a.slice(0, i).replace('.', ''), a += p.call(Array(l - (a.length - 1) + 1), '0') + '.' + p.call(Array(r + 1), '0'), s = a.length); o > 0 && '0' === a.slice(-1);)
      a = a.slice(0, -1), o--;
    if ('.' === a.slice(-1) && (a = a.slice(0, -1)), s < t)
      var u = p.call(Array(t - s + 1), '0');
    return (u || '') + a;
  }(t, i['[[minimumIntegerDigits]]'], i['[[minimumFractionDigits]]'], i['[[maximumFractionDigits]]']), F[s]) {
...
if (n = n.replace(/\./g, l.decimal), !0 === i['[[useGrouping]]']) {
  ...
  if (E.length > f) {
    var m = new $(),
      ...
      S = g % I,
      A = E.slice(0, S);
    for (A.length && h.call(m, A); S < g;)
      h.call(m, E.slice(S, S + I)), S += I;
...
N = U(n, 'formatMatcher', 'string', new $('basic', 'best fit'), 'best fit');
  for (var p in (S.formats = A, m = 'basic' === N ? function(e, t) {
  return j(e, t);
}(o, A) : function(e, t) {
  return j(e, t, !0);
}(o, A), Z))
...
if (u.call(n, '[[' + f + ']]')) {
  var h, p, I = n['[[' + f + ']]'],
    m = l['[[' + f + ']]'];
  if ('year' === f && m <= 0 ? m = 1 - m : 'month' === f ? m++ : 'hour' === f && !0 === n['[[hour12]]'] && (m %= 12, h = m !== l['[[' + f + ']]'], 0 === m && !0 === n['[[hourNo0]]'] && (m = 12)), 'numeric' === I)
    p = B(a, m);
  else if ('2-digit' === I)
    (p = B(o, m)).length > 2 && (p = p.slice(-2));
  else if (I in S)
    switch (f) {
      case 'month':
...
(function(e, t) {
  ...
  var n, r = [t],
    i = t.split('-');
  for (i.length > 2 && 4 === i[1].length && h.call(r, i[0] + '-' + i[2]); n = I.call(r);)

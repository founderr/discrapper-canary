...
function U(e, t, n) {
    ...
    var S = 'currency' === p ? Math.max(b, m) : 'percent' === p ? Math.max(b, 0) : Math.max(b, 3),
        T = P(n, 'maximumFractionDigits', b, 20, S);
        ...
        if (((n = n.replace(/\./g, l.decimal)), !0 === i['[[useGrouping]]'])) {
            ...
            if (_.length > p) {
                var E = new J(),
                    ...
                    b = I % g,
                    S = _.slice(0, b);
                for (S.length && h.call(E, S); b < I; ) h.call(E, _.slice(b, b + g)), (b += g);

...
function c() {
  let [e, t] = n.useState(!1), [s, r] = n.useState(!1), [o, c] = n.useState(!1);
  n.useEffect(() => {
    let e;
  ...
  return s ? (0, l.jsx)(i.Text, {
    ...
    submitting: e,
    onClick: I,
    children: o ? d.default.Messages.RESEND_EMAIL_SHORT : d.default.Messages.VERIFY
  })
}

function I() {
  return (0, l.jsx)(o.RequirementWithActionRenderer, {
    icon: r.default,

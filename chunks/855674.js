...
l = "WebhooksStore", (i = "displayName") in(s = C) ? Object.defineProperty(s, i, {
  ...
  WEBHOOKS_UPDATE: function(e) {
    ...
    if (null == r) {
      null != s ? (n = s, delete h[p(t, a)]) : null != a && null != m[t] && (n = null, f.default.fetchForChannel(t, a));
      return
    }
    n = null;
    let i = [];
    null != a && (i = c()(E(t)).values().filter(e => e.channel_id !== a).value());
    let l = m[t] = {};
    i.concat(r).forEach(e => l[e.id] = e), delete h[p(t, a)]
  },

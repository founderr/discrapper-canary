...
function H(e) {
    let { application: n, onClick: t, children: i, sectionName: l, resultsPosition: r, sectionOverallPosition: c, tracksImpression: m, disabled: p, containerStyle: h, look: f } = e,
        ...
        { name: v, description: x } = o.useMemo(() => (0, P.sl)(n, { fakeAppIconURL: B }), [n]),
...
function V(e) {
    let { application: n, imageStyle: t, children: i } = e,
        { name: l, iconURL: r } = o.useMemo(() => (0, P.sl)(n, { fakeAppIconURL: B }), [n]);
...
function W(e) {
    let { application: n, look: t, imageStyle: i, enableVideoBanner: l, disableBannerFadeIn: r, children: u } = e,
        { iconURL: m, name: p, description: f } = o.useMemo(() => (0, P.sl)(n, { fakeAppIconURL: B }), [n]),
...
function K(e) {
    ...
    if (!(0, P.BQ)(t)) throw Error('PerformActivityActionAppCard was passed the Built-in App, which is not supported.');
    let m = o.useId(),

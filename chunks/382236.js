...
var M = () => {
  ...
  let [p, M] = l.useState(null), v = l.useCallback(e => {
    M(e), m.default.track(A.AnalyticEvents.MOBILE_WEB_HANDOFF_FAILURE, {
      reason: e,
  ...
  if ("null" === n && null === p && v("deep_link_failed"), null != n && "null" !== n && null == D && null === p && v("nonce_missing"), l.useEffect(() => {
      ...
      null != n && "null" !== n && null != D && null == p && d.default.post({
  ...
  let x = (() => {
      ...
      if (L.has(p)) return h.MOBILE_WEB_HANDOFF_ERROR_NO_TRY_AGAIN;

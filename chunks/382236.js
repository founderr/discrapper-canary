...
var M = () => {
  ...
  let [T, M] = r.useState(null), v = r.useCallback(e => {
  ...
  if ("null" === n && null === T && v("deep_link_failed"), null != n && "null" !== n && null == D && null === T && v("nonce_missing"), r.useEffect(() => {
      if (null != D) {
        let e = c.default.get(R);
        (null == e || Date.now() >= e) && (v("nonce_expired"), L())
      }
    }, [D, v]), r.useEffect(() => {
      null != n && "null" !== n && null != D && null == T && d.default.post({
    ...
    }, [n, D, T, a, v]), null == a) return null;
  let U = (() => {
      if (null == T) return (0, l.jsxs)(l.Fragment, {

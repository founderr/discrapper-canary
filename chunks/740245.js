...
function T() {
    ...
    m.call(this), (this.h = [1779033703, 4089235720, 3144134277, 2227873595, 1013904242, 4271175723, 2773480762, 1595750129, 1359893119, 2917565137, 2600822924, 725511199, 528734635, 4215389547, 1541459225, 327033209]), (this.k = I), (this.W = Array(160));
}
    ...
    (T.prototype._update = function (e, t) {
        ...
        for (var P = 0; P < n.length; P += 2) {
            var U = D,
                ...
                V = n[P],
                H = n[P + 1],
                Y = h(U, w, x, G, k, B, F, Z, V, H),
                j = p(U, w, x, G, k, B, F, Z, V, H);

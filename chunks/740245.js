...
function T() {
    ...
    I.call(this), (this.h = [1779033703, 4089235720, 3144134277, 2227873595, 1013904242, 4271175723, 2773480762, 1595750129, 1359893119, 2917565137, 2600822924, 725511199, 528734635, 4215389547, 1541459225, 327033209]), (this.k = m), (this.W = Array(160));
}
r.inherits(T, I),
    (e.exports = T),
    (T.blockSize = 1024),
    ...
    (T.prototype._update = function (e, t) {
        ...
        for (var C = 0; C < n.length; C += 2) {
            var L = O,
                ...
                x = n[C],
                G = n[C + 1],
                k = h(L, y, D, b, M, P, U, w, x, G),
                B = p(L, y, D, b, M, P, U, w, x, G);
            (L = (function (e, t) {
            ...
            var F = d(
                ...
                V = _(L, y, D, b);
            (O = N), (v = R), (N = g), (R = A), (g = T), (A = S), (T = d(I, m, k, B)), (S = _(m, m, k, B)), (I = E), (m = f), (E = l), (f = u), (l = r), (u = i), (r = d(k, B, F, V)), (i = _(k, B, F, V));
        }
        c(this.h, 0, r, i), c(this.h, 2, l, u), c(this.h, 4, E, f), c(this.h, 6, I, m), c(this.h, 8, T, S), c(this.h, 10, g, A), c(this.h, 12, N, R), c(this.h, 14, O, v);
    }),

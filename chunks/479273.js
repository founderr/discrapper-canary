...
function eM(e) {
  ...
  let {
    ...
    channel: t,
    coords: a
  }, "archived-missing-reading-history-perm"), [en, V, _, H, t, D, P, L, U]), ew = (0, h.useStateFromStores)([B.default], () => B.default.hasHidden(t.id));
  n.useEffect(() => {
    var e, t;
    let a = et ? eW : Q,
  ...
  let ek = (0, Z.useForumActivityExperiment)(t.guild_id),
    {
      ...
      let {
        ...
        isShowingSearchResult: f,
        hasActiveThreads: l
      })(), [l, f]), S = n.useCallback(e => c(e.section, void 0, () => {
  ...
  let e$ = n.useCallback(() => {
    ...
    e0 = (0, h.useStateFromStores)([S.default], () => S.default.keyboardModeEnabled),
    e1 = (0, ed.default)({
      id: "forum-grid-view",
      isEnabled: et && e0,
      setFocus: eJ
...
function eR(e) {
  ...
  let eA = I.length > 0 && !R && (_ || null != N),
    eI = !__OVERLAY__ && !F && !R && O && (0 === w.textValue.trim().length || w.textValue.trim() === eS) && 0 === eC.length;
  n.useLayoutEffect(() => {
    let e = eA || eI;
    if (!e) return V(0);
  ...
  let eR = e => {
    ...
    eD = function() {
      let e = n.useRef(!1),
        t = (0, h.useStateFromStores)([S.default], () => S.default.keyboardModeEnabled),
        a = n.useCallback(t => {

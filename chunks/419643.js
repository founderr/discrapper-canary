...
let u = ['#be0351', '#ff2c52', '#f0f0f0'],
    ...
    p = (e) => {
        let { width: n = 24, height: r = 24, primaryTintColor: p, secondaryTintColor: m, ...g } = e,
            E = a.useMemo(() => 'badge-force-gradient-'.concat((0, s.Z)()), []),
            { primaryColorsTransformed: v, secondaryColorsTransformed: I } = (0, l.s)({
                primaryBaseColors: u,
                primaryTintColor: p,

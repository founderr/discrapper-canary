...
transitionState: t,
onClose: s
  } = e, E = (0, a.e7)([c.Z], () => c.Z.getErrors()), _ = (0, a.e7)([c.Z], () => c.Z.getFormState()), C = (0, a.e7)([m.default], () => m.default.getCurrentUser()), I = (0, a.e7)([u.Z], () => u.Z.getAction()), R = !f.Z.isEmailReverification(I), [v, M] = n.useState(!0), y = _ === g.QZA.SUBMITTING;

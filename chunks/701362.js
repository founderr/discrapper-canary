...
E.Z,
p.Z
  ], () => (0, x.p9)(n, g.Z, f.Z, E.Z, p.Z)), c = (0, r.e7)([m.Z], () => m.Z.getStreamForUser(t.id, n.getGuildId())), d = (0, r.e7)([m.Z], () => m.Z.getActiveStreamForApplicationStream(c)), h = (0, r.e7)([_.default], () => _.default.getId()), I = (0, T.Cf)(c), N = (0, r.e7)([C.Z], () => (0, T.Um)(c, C.Z)), v = a.useMemo(() => ({
[n.guild_id]: [t.id]
  }), [
n.guild_id,
t.id

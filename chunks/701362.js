...
f.Z,
h.Z
  ], () => (0, x.p9)(n, C.Z, _.Z, f.Z, h.Z)), c = (0, r.e7)([m.Z], () => m.Z.getStreamForUser(t.id, n.getGuildId())), d = (0, r.e7)([m.Z], () => m.Z.getActiveStreamForApplicationStream(c)), g = (0, r.e7)([p.default], () => p.default.getId()), I = (0, T.Cf)(c), v = (0, r.e7)([E.Z], () => (0, T.Um)(c, E.Z)), N = a.useMemo(() => ({
[n.guild_id]: [t.id]
  }), [
n.guild_id,
t.id
  ]);
  return (0, u.$)(N), (0, i.jsx)(M, {
...s,
canWatch: l,
unavailableReason: o,
user: t,

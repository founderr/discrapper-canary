...
class tp extends E.default.Store {
  initialize() {
    eI.on(p.MediaEngineEvent.Connection, e => {
      ...
      if (o && eI.setHasFullbandPerformance((0, R.hasPerformanceForKrispFullband)()), (0, y.default)(i)) {
        ...
        let i = eu.default.getGuildId(),
          s = 0;
        null != i && e.context === em.MediaEngineContextTypes.STREAM && (s = k.default.getCurrentConfig({
          guildId: i,
          location: "MediaEngineStore_SetupMediaEngine"
        }, {
          autoTrackExposure: !0
        }).keyFrameIntervalMs), e.setClipsKeyFrameInterval(n && t.viewerClipsEnabled ? em.VIEWERSIDE_CLIP_KFI_MS : s)
      }
      ...
      e.on(p.BaseConnectionEvent.Speaking, (t, n) => {
        ...
        (null == r ? void 0 : r.desktopSource) != null && Q.default.track(ef.AnalyticEvents.SOUNDSHARE_ATTACHED, (0, D.default)(null == r ? void 0 : r.desktopSource))
        ...
        (null == r ? void 0 : r.desktopSource) != null && (Q.default.track(ef.AnalyticEvents.SOUNDSHARE_TRANSMITTING, (0, D.default)(null == r ? void 0 : r.desktopSource)), null != el.default.getHookError(ef.MediaEngineHookTypes.SOUND) && T.default.wait(() => T.default.dispatch({
  ...
  getInputDeviceId() {
    return to(eO, e3().inputDeviceId)
  }
  getOutputDeviceId() {
    return to(eD, e3().outputDeviceId)
  }
  getVideoDeviceId() {
  ...
  getSupportedSecureFramesProtocolVersion(e) {
    let t = eI.getSupportedSecureFramesProtocolVersion(),
      n = x.SecureFramesUserExperiment.getCurrentConfig({
        location: "MediaEngineStore"
      }),
      i = null != e ? x.SecureFramesGuildExperiment.getCurrentConfig({
        guildId: e,
        location: "MediaEngineStore"
      }) : null,
      s = n.canSupportSecureFrames || (null == i ? void 0 : i.canSupportSecureFrames),
      r = !(0, $.isIOS)() && !(0, $.isAndroid)() && (n.canSupportMls || (null == i ? void 0 : i.canSupportMls));
...
var tv = i = new tp(T.default, {
  ...
  MEDIA_ENGINE_DEVICES: function(e) {
    ...
    ! function(e) {
      let t = eO;
      if (eO = ta(e, eE.default.Messages.NO_INPUT_DEVICES), !h.isEqual(eO, t)) {
        let e = e3(),
      ...
      let t = eD;
      if (eD = ta(e, eE.default.Messages.NO_OUTPUT_DEVICES), !h.isEqual(eD, t)) {
        let e = e3(),
      ...
      eF = e.length > 0;
      let t = eP;
      if (eP = ta(e, eE.default.Messages.NO_VIDEO_DEVICES), ek && !h.isEqual(eP, t)) {
        var n;
        let e = void 0 !== eP[ew],
          i = ew === em.DEFAULT_DEVICE_ID && (null === (n = t[em.DEFAULT_DEVICE_ID]) || void 0 === n ? void 0 : n.disabled);
        e8(e || i)
      }
    }(i)
  },
  ...
  OVERLAY_INITIALIZE: function(e) {
    ...
    eC = t.settingsByContext, eO = t.inputDevices, eD = t.outputDevices, e0 = t.appSupported, eW = t.krispModuleLoaded, eR = t.goLiveContext
  },
  ...
  APP_STATE_UPDATE: function(e) {
    ...
    if (t === ef.AppStates.BACKGROUND && ek && !n) eG = !0, e8(!1);
    else {
  ...
  CHANNEL_DELETE: function() {
    if (!ek && null == r || null != eu.default.getRTCConnectionId()) return !1;
    e8(!1, null)
  },
  ...
  CLIPS_SETTINGS_UPDATE: function(e) {
    ...
    void 0 !== t.viewerClipsEnabled && eI.eachConnection(e => e.setClipsKeyFrameInterval(A.default.getSettings().viewerClipsEnabled ? em.VIEWERSIDE_CLIP_KFI_MS : 0), em.MediaEngineContextTypes.STREAM)
  }
})
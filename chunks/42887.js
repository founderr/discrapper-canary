...
async function tS() {
  ...
  try {
    ...
    em.warn("Failed to enable macOS soundshare: ".concat(t)), t_(-1), e = {
      status_code: -1,
      message: "".concat(t)
    }
  } finally {
...
class tm extends S.default.Store {
  initialize() {
    eC.on(m.MediaEngineEvent.Connection, e => {
      ...
      r && e.setExperimentFlag(e_.ExperimentFlags.VIDEOTOOLBOX_RATE_CONTROL, !0);
      {
        ...
        t && e.setExperimentFlag(e_.ExperimentFlags.SIGNAL_H265_DECODE_SUPPORT, !0);
        let {
        ...
        i && e.setExperimentFlag(e_.ExperimentFlags.SIGNAL_H265_SUPPORT, !0)
      }
      let {
        signalAV1Support: a
      ...
      if (o && eC.setHasFullbandPerformance((0, O.hasPerformanceForKrispFullband)()), (0, R.default)(i)) {
      ...
      e.on(m.BaseConnectionEvent.Speaking, (t, n) => {
        ...
        (null == s ? void 0 : s.desktopSource) != null && Q.default.track(ef.AnalyticEvents.SOUNDSHARE_ATTACHED, (0, y.default)(null == s ? void 0 : s.desktopSource))
        ...
        (null == s ? void 0 : s.desktopSource) != null && (Q.default.track(ef.AnalyticEvents.SOUNDSHARE_TRANSMITTING, (0, y.default)(null == s ? void 0 : s.desktopSource)), null != el.default.getHookError(ef.MediaEngineHookTypes.SOUND) && I.default.wait(() => I.default.dispatch({
      ...
      noiseCancellation: !1
    }) : (eY = !0, tp()), (0, $.isMac)() && eC.supports(e_.Features.SOUNDSHARE) ? eC.getSoundshareStatus().then(e => {
      t_(e)
    }).catch(e => {
    ...
    }, this.waitFor(ei.default, es.default, ea.default, el.default, eu.default, ec.default, K.default.storage, X.default, eo.default, A.default)
  }
  supports(e) {
  ...
  getSupportedSecureFramesProtocolVersion(e) {
    ...
    let n = eC.getSupportedSecureFramesProtocolVersion(),
      ...
      a = !(0, $.isIOS)() && !(0, $.isAndroid)() && (i.canSupportMls || (null == r ? void 0 : r.canSupportMls)),
...
var tT = i = new tm(I.default, {
  ...
  AUDIO_SET_ECHO_CANCELLATION: function(e) {
    ...
    eC.eachConnection(e => e.setEchoCancellation(t.echoCancellation)), tf(), td(e.location)
  },
  ...
  AUDIO_SET_NOISE_SUPPRESSION: function(e) {
    ...
    eC.eachConnection(e => e.setNoiseSuppression(t.noiseSuppression)), tf(), td(e.location)
  },
  AUDIO_SET_AUTOMATIC_GAIN_CONTROL: function(e) {
    let t = ti({
      automaticGainControl: e.enabled
    });
    eC.eachConnection(e => e.setAutomaticGainControl(t.automaticGainControl)), tf(), td(e.location)
  },
  AUDIO_SET_NOISE_CANCELLATION: function(e) {
    let t = ti({
      noiseCancellation: e.enabled
    });
    eC.eachConnection(e => e.setNoiseCancellation(t.noiseCancellation)), tf(), td(e.location)
  },

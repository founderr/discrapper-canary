...
if (null != e) {
  ...
  if (null != r)
    return s.ZP.getAnimatableSourceWithFallback(t, t => s.ZP.makeSource(s.ZP.getGuildMemberAvatarURLSimple({
      guildId: e,
      avatar: r,
      userId: this.id,
      canAnimate: t,
...
return s.ZP.getAnimatableSourceWithFallback(t, e => s.ZP.getUserAvatarSource({
  id: this.id,
  avatar: this.avatar,
...
this.avatarDecorationData = (0, a.FG)(e);
  ...
  constructor(e) {
var t, n, i, a, s, o, c, d, E, f, h, p, m, I, T, g, S, A, N, v, O, R, C, y, D, L, b, M, P, U, w;
...
let x = null !== (n = e.premium_type) && void 0 !== n ? n : e.premiumType;
this.id = e.id, this.username = null !== (i = e.username) && void 0 !== i ? i : '', this.discriminator = null !== (a = e.discriminator) && void 0 !== a ? a : l.fo$, this.avatar = null !== (s = e.avatar) && void 0 !== s ? s : null, this.avatarDecoration = null !== (o = e.avatar_decoration_data) && void 0 !== o ? o : e.avatarDecorationData, this.email = null !== (c = e.email) && void 0 !== c ? c : null, this.verified = null !== (d = e.verified) && void 0 !== d && d, this.bot = null !== (E = e.bot) && void 0 !== E && E, this.system = null !== (f = e.system) && void 0 !== f && f, this.mfaEnabled = null !== (p = null !== (h = e.mfa_enabled) && void 0 !== h ? h : e.mfaEnabled) && void 0 !== p && p, this.mobile = null !== (m = e.mobile) && void 0 !== m && m, this.desktop = null !== (I = e.desktop) && void 0 !== I && I, this.premiumType = x === l.WND ? null : x, this.flags = null !== (T = e.flags) && void 0 !== T ? T : 0, this.publicFlags = null !== (S = null !== (g = e.public_flags) && void 0 !== g ? g : e.publicFlags) && void 0 !== S ? S : 0, this.purchasedFlags = null !== (N = null !== (A = e.purchased_flags) && void 0 !== A ? A : e.purchasedFlags) && void 0 !== N ? N : 0, this.premiumUsageFlags = null !== (O = null !== (v = e.premium_usage_flags) && void 0 !== v ? v : e.premiumUsageFlags) && void 0 !== O ? O : 0, this.phone = null !== (R = e.phone) && void 0 !== R ? R : null, this.nsfwAllowed = null !== (C = e.nsfw_allowed) && void 0 !== C ? C : e.nsfwAllowed, this.guildMemberAvatars = null !== (y = e.guildMemberAvatars) && void 0 !== y ? y : {}, this.hasBouncedEmail = null !== (L = null !== (D = e.has_bounced_email) && void 0 !== D ? D : e.hasBouncedEmail) && void 0 !== L && L, this.personalConnectionId = null !== (M = null !== (b = e.personal_connection_id) && void 0 !== b ? b : e.personalConnectionId) && void 0 !== M ? M : null, this.globalName = null !== (P = e.global_name) && void 0 !== P ? P : e.globalName, this.banner = e.banner, this.primaryGuild = (0, u.hW)(null !== (w = null !== (U = e.primary_guild) && void 0 !== U ? U : e.clan) && void 0 !== w ? w : null), Object.defineProperties(this, {
  hasFlag: {
    writable: !1,
    configurable: !1,
    value: e => {

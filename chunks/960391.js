...
class q extends l.PureComponent {
  ...
  renderGenericError() {
    ...
    return null == e || null != z(e) ? null : (0, r.jsx)(h.FormErrorBlock, {
      ...
      children: (0, r.jsx)(h.ModalRoot, {
        ...
        children: (0, r.jsxs)("form", {
          ...
          children: [(0, r.jsxs)(h.ModalHeader, {
            ...
            }), this.renderGenericError(), (0, r.jsx)(g.default, {
              breadcrumbs: a,
              activeId: e
            })]
          }), (0, r.jsx)("div", {
    ...
    super(...e), this.state = {
      ...
      card_info: {
        renderBody: () => {
          let {
            error: e
          } = this.props, t = null != e && (null == e.code || "card_info" === z(e));
          return (0, r.jsxs)(r.Fragment, {
            children: [t ? (0, r.jsx)(h.FormErrorBlock, {
              className: O.errorBlock,
              children: D.default.Messages.BILLING_ERROR_SECTION_CARD
      ...
      paypal: {
        ...
        renderNextButton: () => {
          ...
          return (0, r.jsx)(h.Button, {
            ...
            children: a ? D.default.Messages.NEXT : D.default.Messages.PAYMENT_SOURCE_CONNECT_TO_PAYPAL
          })
        }
      }
...
let W = u.default.connectStores([_.default, C.default, A.default], () => ({
...
function V(e) {
  let {
    ...
    onStepChange: () => {},
    header: (0, r.jsxs)("div", {
      className: d(O.modalTitle, j.flex, j.justifyBetween, j.alignCenter),
      children: [(0, r.jsx)(h.FormTitle, {
        tag: h.FormTitleTags.H4,
        children: D.default.Messages.PAYMENT_SOURCES_ADD
      }), (0, r.jsx)(h.ModalCloseButton, {

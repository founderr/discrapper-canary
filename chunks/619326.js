...
function N(e) {
  ...
  let N = t === _.p6O,
    ...
    C = (0, o.useRadioItem)({
      isSelected: N,
      label: E.Z.Messages.USER_SETTINGS_PROFILE_COLOR_DEFAULT_BUTTON.format({
        colorHex: (0, l.Rf)(_.p6O)
      })
    }),
    x = (0, o.useRadioItem)({
      isSelected: !N,
      label: E.Z.Messages.USER_SETTINGS_PROFILE_COLOR_CUSTOM_BUTTON.format({
        colorHex: (0, l.Rf)(t)
      })
    });
  return (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsx)("div", {
      ...
      children: [(0, s.jsxs)(o.Clickable, {
        ...
        ...x,
        children: [(0, s.jsx)("div", {
          className: r()(I.customSwatch, {
            [I.defaultSwatch]: S === _.p6O
          }),
          style: {

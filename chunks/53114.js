...
let t = Number(this.streamStart),
  ...
  s = e.bitrateHistogram.getReport([
    1,
    5,
    10,
    25,
  ...
  l = e.inboundBitrateEstimateHistogram.getReport([
    1,
    5,
    10,
    25,
...
if (this.updateSendState({
  ...
  ;
  if (s = d, o = E, s.size === o.size && Array.from(s).every(e => o.has(e)))

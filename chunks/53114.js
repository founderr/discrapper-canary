            ...
            (t.rtp.outbound
                ...
                .forEach((t) => {
                    if (null != t) {
                        ...
                        null == m && (console.warn('Unknown outbound video stream with SSRC: '.concat(I)), (m = new _.nt(this.timestampProducer)), (this.outboundStats[I] = m)), null == m.timeToFirstFrame && (t.framesEncoded > 0 || (null !== (r = t.frameRateInput) && void 0 !== r ? r : 0) > 0) && (m.timeToFirstFrame = Math.max(0, e - m.startTime));
                        let T = n.find((e) => e.ssrc === I);
                        var r,
                            i,
                            a,
                            s,
                            ...
                            E,
                            h,
                            p = this.connection.getRemoteVideoSinkWants(I);
                        ...
                        if (!this.videoStopped.value && g) {
                            ...
                            m.appendTargetRates(null == T ? void 0 : T.maxFrameRate, null !== (a = t.bitrateTarget) && void 0 !== a ? a : Math.min(null !== (i = l.availableOutgoingBitrate) && void 0 !== i ? i : 0, null != n ? n : 0), n, l.availableOutgoingBitrate), (m.averageEncodeTime = null !== (s = t.averageEncodeTime) && void 0 !== s ? s : 0), (m.framesDroppedRateLimiter = null !== (o = t.framesDroppedRateLimiter) && void 0 !== o ? o : null), (m.framesDroppedEncoderQueue = null !== (u = t.framesDroppedEncoderQueue) && void 0 !== u ? u : null), (m.framesDroppedCongestionWindow = null !== (c = t.framesDroppedCongestionWindow) && void 0 !== c ? c : null), (this.hqSimulcastStreamEncoded.value = null !== (E = t.hqSimulcastStreamEncoded) && void 0 !== E && E), (this.lqSimulcastStreamEncoded.value = null !== (h = t.lqSimulcastStreamEncoded) && void 0 !== h && h), (this.bothSimulcastStreamsEncoded.value = this.hqSimulcastStreamEncoded.value && this.lqSimulcastStreamEncoded.value);
                        }
                    }
                }),
            !this.paused.value &&

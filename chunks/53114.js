...
return a().forEach(this.outboundStats, (t, n) => {
  ...
  let u = [
    ...
    E = t.targetBitrateHistogram.getReport([
      1,
      5,
      10,
      25,
  ...
  e.push({
    ...
    target_bitrate_max: h > 0 ? Math.round((null !== (s = t.targetBytesMax) && void 0 !== s ? s : 0) * 8 / h) : 0,

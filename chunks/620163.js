...
var s = n(990547),
    ...
    ek = n(388032),
    ew = n(503192);
let eU = () => [r.z.CLIENT_THEMES_SETTINGS_BADGE, r.z.DEKSTOP_CUSTOM_APP_ICON_BADGE],
    eV = ej.Z,
    eG = (e) => {
        let { unseenGiftCount: t, showPrepaidPaymentPastDueWarning: eG, impressionSource: eY, numOfPendingFamilyRequests: eH, isOverlaySupported: ez, isClipsBetaTagShowing: eW = !1, shouldMergeGameSettings: eK, isUserSettingsSearchEnabled: eq, isKeywordFilteringEnabled: eX, isStaff: eQ, isInappropriateConversationWarningEnabled: eJ, paymentsBlocked: e$, isEligibleForQuests: e0, showGiftNitro: e1, isStricterMessageRequestsEnabled: e2, hasLibraryApplication: e6, hasTOTPEnabled: e3, developerMode: e8, isSafetySettingsV2Enabled: e4, isAdultUser: e7, hasSecureFramesVerifiedUserIds: e5, hypeSquadRemoved: e9, stealthRemediationEnabled: te, hasIgnoredUsers: tt, hasBlockedUsers: tn, showAppDMsQuickLauncher: ti } = e;
        return Object.freeze({
            ...
            [eL.s6.PROFILE_CUSTOMIZATION]: {
                ...
                element: O.Z,
                newIndicator: (0, i.jsx)(a.PremiumBadge, { text: ek.intl.string(ek.t.y2b7CA) }),
                notice: {
                    stores: [F.Z, I.Z],
                    element: j.Z
                },
                onSettingsClose: () => {
                    o.Z.wait(() => {
                        (0, f.It)(), (0, u.P6)(), m.Z.clearSubsection(eZ.oAB.PROFILE_CUSTOMIZATION);
                    });
                }
            },
            ...
            [eL.s6.PROFILE_USER_PROFILE]: {
                section: eZ.oAB.PROFILE_CUSTOMIZATION,
                searchableTitles: [ek.intl.string(ek.t['OU3/Pj'])],
                parent: eL.s6.PROFILE_CUSTOMIZATION
            },
            ...
            [eL.s6.PRIVACY_AND_SAFETY]: {
                ...
                label: ek.intl.string(ek.t.sKMrpq),
                searchableTitles: [ek.intl.string(ek.t.sKMrpq)],
                ariaLabel: ek.intl.string(ek.t.sKMrpq),
                element: e_.Z,
                predicate: () => !e4
            },
            ...
            [eL.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t.Hq4ApK), ek.intl.string(ek.t.i27PTE), ek.intl.string(ek.t['8M2an5'])],
                parent: eL.s6.PRIVACY_USER_SETTINGS
            },
            [eL.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_DMS]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t.eCO6Nz)],
            ...
            [eL.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_MESSAGE_REQUESTS]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t.kOa6yM)],
                parent: eL.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS,
                predicate: () => !e2
            },
            ...
            [eL.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t['154/bG'])],
                parent: eL.s6.PRIVACY_AND_SAFETY
            },
            [eL.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_DMS]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t.LoKBGB)],
            ...
            [eL.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_MESSAGE_REQUESTS]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t['5IN9wc'])],
                parent: eL.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS,
                predicate: () => !e2
            },
            ...
            [eL.s6.PRIVACY_DATA_PRIVACY]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t.RcaYGR)],
                parent: eL.s6.PRIVACY_USER_SETTINGS
            },
            ...
            [eL.s6.PRIVACY_STAFF_ONLY]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t.Fwp9SU)],
                parent: eL.s6.PRIVACY_USER_SETTINGS,
                predicate: () => eQ
            },
            ...
            [eL.s6.PRIVACY_ACCOUNT_STANDING]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t['00Sfl5'])],
                parent: eL.s6.PRIVACY_AND_SAFETY
            },
            [eL.s6.PRIVACY_ENCRYPTION]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t.hWMIiY), ek.intl.string(ek.t['9Q/PQk'])],
                parent: eL.s6.PRIVACY_AND_SAFETY
            },
            [eL.s6.PRIVACY_ENCRYPTION_VERIFICATION_CODES]: {
                section: eZ.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [ek.intl.string(ek.t['2Ap8sr'])],
            ...
            [eL.s6.PRIVACY_FAMILY_CENTER]: {
                ...
                searchableTitles: [ek.intl.string(ek.t.gntCQU)],
                label: ek.intl.string(ek.t.gntCQU),
                ariaLabel: ek.intl.string(ek.t.gntCQU),
                element: eu.Z,
                badgeCount: eH,
            ...
            [eL.s6.FRIEND_REQUESTS]: {
                ...
                searchableTitles: [ek.intl.string(ek.t.fyA119)],
                label: ek.intl.string(ek.t.fyA119),
                element: em.Z,
                predicate: () => !e4
            },
            [eL.s6.RESTRICTED_USERS]: {
                section: e4 ? eZ.oAB.CONTENT_AND_SOCIAL : eZ.oAB.ACCOUNT,
                parent: e4 ? eL.s6.PRIVACY_AND_SAFETY_FRIEND_REQUESTS_CATEGORY : eL.s6.ACCOUNT,
            ...
            [eL.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
                section: eZ.oAB.APPEARANCE,
            ...
            [eL.s6.VOICE_AND_VIDEO_SWITCH_CHANNEL_ALERT]: {
                section: eZ.oAB.VOICE,
            ...
            [eL.s6.VOICE_AND_VIDEO_VIDEO_CAMERA]: {
                ...
                predicate: () => Z.Z.supports(eM.AN.VIDEO)
            },
            ...
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_VIDEO_OPENH264]: {
                ...
                predicate: () => Z.Z.supports(eM.AN.OPEN_H264)
            },
            ...
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_QOS]: {
                ...
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED,
                predicate: () => Z.Z.supports(eM.AN.QOS)
            },
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_ATTENUATION]: {
                section: eZ.oAB.VOICE,
                searchableTitles: [ek.intl.string(ek.t.oSdBvb)],
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED,
                predicate: () => Z.Z.supports(eM.AN.ATTENUATION)
            },
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_SUBSYSTEM]: {
                section: eZ.oAB.VOICE,
                searchableTitles: [ek.intl.string(ek.t.wVBHr6)],
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED,
                predicate: () => Z.Z.supports(eM.AN.LEGACY_AUDIO_SUBSYSTEM) || Z.Z.supports(eM.AN.EXPERIMENTAL_AUDIO_SUBSYSTEM)
            },
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
                section: eZ.oAB.VOICE,
                searchableTitles: [ek.intl.string(ek.t.NMCIf3), ek.intl.string(ek.t.FeUKeH)],
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED,
                predicate: () => Z.Z.supportsVideoHook() || Z.Z.supportsExperimentalSoundshare() || (Z.Z.supportsSystemScreensharePicker() && (0, U.isMac)())
            },
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE_VIDEO_HOOK]: {
                section: eZ.oAB.VOICE,
                searchableTitles: [ek.intl.string(ek.t.GmWk2N), ek.intl.string(ek.t['Fj/xn5'])],
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE,
                predicate: () => Z.Z.supportsVideoHook()
            },
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE_EXPERIMENTAL_SOUNDSHARE]: {
                section: eZ.oAB.VOICE,
                searchableTitles: [ek.intl.string(ek.t['4I0qzc'])],
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE,
                predicate: () => Z.Z.supportsExperimentalSoundshare()
            },
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE_SYSTEM_PICKER]: {
                section: eZ.oAB.VOICE,
            ...
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === V.ZP.releaseChannel || 'development' === V.ZP.releaseChannel) && eQ && Z.Z.supports(eM.AN.CONNECTION_REPLAY)
            },
            [eL.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                section: eZ.oAB.VOICE,
                searchableTitles: [ek.intl.string(ek.t['726JHB'])],
                parent: eL.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => U.isPlatformEmbedded && Z.Z.supports(eM.AN.DEBUG_LOGGING) && null != g.Z.fileManager.readLogFiles
            },
            ...
            [eL.s6.SETTINGS_ADVANCED_SHOW_PLAY_AGAIN]: {
                section: eZ.oAB.ADVANCED,
            ...
            [eL.s6.ACTIVITY_PRIVACY_STATUS]: {
                section: eK ? eZ.oAB.GAMES : eZ.oAB.ACTIVITY_PRIVACY,
            ...
            [eL.s6.ACTIVITY_PRIVACY_STATUS_DISPLAY]: {
                section: eZ.oAB.ACTIVITY_PRIVACY,
                searchableTitles: [ek.intl.string(ek.t['4F2KoK'])],
                parent: eL.s6.ACTIVITY_PRIVACY
            },
            ...
            [eL.s6.MERCHANDISE]: {
                ...
                onClick: () => {
                    ...
                    M.default.track(eZ.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, w.q)({
                            href: e,
                            shouldConfirm: !0,
                            onConfirm: () => {
                                M.default.track(eZ.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, p.Z)(e);
                            }
                        });
                },
            ...
            [eL.s6.PAYMENT_COMPONENTS]: {
                section: eZ.oAB.PAYMENT_COMPONENTS_PAGE,
            ...
            [eL.s6.TEXT_PLAYGROUND]: {
                ...
                element: eb.Z,
                predicate: () => (0, J.D)() || B.Z.isDeveloper
            },
            ...
            [eL.s6.DESIGN_SYSTEMS_COMPONENTS]: {
                section: eZ.oAB.DESIGN_SYSTEMS,
            ...
            [eL.s6.QUEST_PREVIEW_TOOL]: {
                ...
                element: D.Z,
                predicate: () => (0, P.X7)({ location: eF.dr.QUEST_PREVIEW_TOOL })
            },

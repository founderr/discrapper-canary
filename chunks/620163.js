...
let ev = () => [i.z.CLIENT_THEMES_SETTINGS_BADGE, i.z.DEKSTOP_CUSTOM_APP_ICON_BADGE],
    ej = eh.Z,
    eB = (e) => {
        let { unseenGiftCount: s, showPrepaidPaymentPastDueWarning: eB, impressionSource: eU, numOfPendingFamilyRequests: eG, isOverlaySupported: eF, isClipsBetaTagShowing: ey = !1, shouldMergeGameSettings: eV, isUserSettingsSearchEnabled: eY, isKeywordFilteringEnabled: ew, isStaff: eH, isInappropriateConversationWarningEnabled: ek, paymentsBlocked: eW, isEligibleForQuests: eK, showGiftNitro: ez, isStricterMessageRequestsEnabled: eQ, hasLibraryApplication: eX, hasTOTPEnabled: eq, canBroadcastActivity: eJ, developerMode: e$, isSafetySettingsV2Enabled: e0 } = e;
        return Object.freeze({
            ...
            [ef.s6.PROFILE_CUSTOMIZATION]: {
                ...
                onSettingsClose: () => {
                    l.Z.wait(() => {
                        (0, O.It)(), (0, d.P6)(), _.Z.clearSubsection(eD.oAB.PROFILE_CUSTOMIZATION);
                    });
                }
            },
            ...
            [ef.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                parent: ef.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === y.ZP.releaseChannel || 'development' === y.ZP.releaseChannel) && eH && v.Z.supports(eL.AN.CONNECTION_REPLAY)
            },
                ...
                onClick: () => {
                    ...
                    B.default.track(eD.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, G.q)({
                            ...
                            shouldConfirm: !0,
                            onConfirm: () => {
                                B.default.track(eD.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, I.Z)(e);
                            }
                        });
                },

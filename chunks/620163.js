    ...
    ew = (e) => {
        ...
        return Object.freeze({
            ...
            [eD.s6.PROFILE_CUSTOMIZATION]: {
                ...
                element: O.Z,
                newIndicator: (0, i.jsx)(a.PremiumBadge, { text: eZ.intl.string(eZ.t.y2b7CA) }),
                notice: {
                    stores: [Z.Z, I.Z],
                    element: j.Z
                },
                onSettingsClose: () => {
                    o.Z.wait(() => {
                        (0, f.It)(), (0, u.P6)(), m.Z.clearSubsection(ey.oAB.PROFILE_CUSTOMIZATION);
                    });
                }
            },
            ...
            [eD.s6.PROFILE_USER_PROFILE]: {
                section: ey.oAB.PROFILE_CUSTOMIZATION,
                searchableTitles: [eZ.intl.string(eZ.t['OU3/Pj'])],
                parent: eD.s6.PROFILE_CUSTOMIZATION
            },
            ...
            [eD.s6.PRIVACY_AND_SAFETY]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                label: eZ.intl.string(eZ.t.sKMrpq),
                searchableTitles: [eZ.intl.string(eZ.t.sKMrpq)],
                ariaLabel: eZ.intl.string(eZ.t.sKMrpq),
                element: eC.Z,
                predicate: () => !e6
            },
            ...
            [eD.s6.PRIVACY_SENSITIVE_MEDIA]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.uEz8JC), eZ.intl.string(eZ.t['N/oRIy']), eZ.intl.string(eZ.t.QVdYsL), eZ.intl.string(eZ.t['aWD+tr']), eZ.intl.string(eZ.t['5mnTa2'])],
            ...
            [eD.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.JzaP4u), eZ.intl.string(eZ.t.H9XOl5), eZ.intl.string(eZ.t.k4W40N)],
                parent: eD.s6.PRIVACY_USER_SETTINGS
            },
            ...
            [eD.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.Hq4ApK), eZ.intl.string(eZ.t.i27PTE), eZ.intl.string(eZ.t['8M2an5'])],
                parent: eD.s6.PRIVACY_USER_SETTINGS
            },
            [eD.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_DMS]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.eCO6Nz)],
            ...
            [eD.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_MESSAGE_REQUESTS]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.kOa6yM)],
                parent: eD.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS,
                predicate: () => !e$
            },
            ...
            [eD.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t['154/bG'])],
                parent: eD.s6.PRIVACY_AND_SAFETY
            },
            [eD.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_DMS]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.LoKBGB)],
            ...
            [eD.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_MESSAGE_REQUESTS]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t['5IN9wc'])],
                parent: eD.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS,
                predicate: () => !e$
            },
            ...
            [eD.s6.PRIVACY_DATA_PRIVACY]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.RcaYGR)],
                parent: eD.s6.PRIVACY_USER_SETTINGS
            },
            ...
            [eD.s6.PRIVACY_STAFF_ONLY]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.Fwp9SU)],
                parent: eD.s6.PRIVACY_USER_SETTINGS,
                predicate: () => eK
            },
            ...
            [eD.s6.PRIVACY_ACCOUNT_STANDING]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t['00Sfl5'])],
                parent: eD.s6.PRIVACY_AND_SAFETY
            },
            [eD.s6.PRIVACY_ENCRYPTION]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t.hWMIiY), eZ.intl.string(eZ.t['9Q/PQk'])],
                parent: eD.s6.PRIVACY_AND_SAFETY
            },
            [eD.s6.PRIVACY_ENCRYPTION_VERIFICATION_CODES]: {
                section: ey.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eZ.intl.string(eZ.t['2Ap8sr'])],
            ...
            [eD.s6.PRIVACY_FAMILY_CENTER]: {
                ...
                searchableTitles: [eZ.intl.string(eZ.t.gntCQU)],
                label: eZ.intl.string(eZ.t.gntCQU),
                ariaLabel: eZ.intl.string(eZ.t.gntCQU),
                element: ec.Z,
                badgeCount: eV,
            ...
            [eD.s6.CLIPS]: {
                ...
                icon: eY ? (0, i.jsx)(T.Z, {}) : void 0,
                element: C.Z,
                predicate: () => !eH
            },
            [eD.s6.FRIEND_REQUESTS]: {
                section: ey.oAB.FRIEND_REQUESTS,
                searchableTitles: [eZ.intl.string(eZ.t.fyA119)],
                label: eZ.intl.string(eZ.t.fyA119),
                element: ed.Z,
                predicate: () => !e6
            },
            [eD.s6.PREMIUM]: {
            ...
            [eD.s6.GIFT_NITRO]: {
                section: ey.oAB.INVENTORY,
                searchableTitles: [eZ.intl.string(eZ.t.Ve9Ge3)],
            ...
            [eD.s6.ACCESSIBILITY_TAGS]: {
                section: ey.oAB.ACCESSIBILITY,
                searchableTitles: [eZ.intl.string(eZ.t.UQt6dX)],
                parent: eD.s6.ACCESSIBILITY
            },
            [eD.s6.ACCESSIBILITY_TAGS_NAMES]: {
                section: ey.oAB.ACCESSIBILITY,
                searchableTitles: [eZ.intl.string(eZ.t.UPwh1N)],
            ...
            [eD.s6.VOICE_AND_VIDEO_DEVICES]: {
                section: ey.oAB.VOICE,
                searchableTitles: [eZ.intl.string(eZ.t.hHMYbW), eZ.intl.string(eZ.t.dl18zc), eZ.intl.string(eZ.t.nuFtHB), eZ.intl.string(eZ.t['3182VF']), eZ.intl.string(eZ.t['DGq/PT'])],
                parent: eD.s6.VOICE_AND_VIDEO
            },
            [eD.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
                section: ey.oAB.VOICE,
                searchableTitles: [eZ.intl.string(eZ.t.OX2Bnp), eZ.intl.string(eZ.t.eATD2N), eZ.intl.string(eZ.t.nuFtHB), eZ.intl.string(eZ.t['3182VF']), eZ.intl.string(eZ.t['DGq/PT'])],
                parent: eD.s6.VOICE_AND_VIDEO
            },
            ...
            [eD.s6.VOICE_AND_VIDEO_VIDEO_CAMERA]: {
                ...
                predicate: () => L.Z.supports(eL.AN.VIDEO)
            },
            ...
            [eD.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_VIDEO_OPENH264]: {
                ...
                predicate: () => L.Z.supports(eL.AN.OPEN_H264)
            },
            ...
            [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                ...
                parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === U.ZP.releaseChannel || 'development' === U.ZP.releaseChannel) && eK && L.Z.supports(eL.AN.CONNECTION_REPLAY)
            },
            [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                section: ey.oAB.VOICE,
                searchableTitles: [eZ.intl.string(eZ.t['726JHB'])],
                parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => w.isPlatformEmbedded && L.Z.supports(eL.AN.DEBUG_LOGGING) && null != g.Z.fileManager.readLogFiles
            },
            ...
            [eD.s6.CHAT_STICKERS_SUGGESTIONS]: {
                section: ey.oAB.TEXT,
                searchableTitles: [eZ.intl.string(eZ.t['479+PT'])],
            ...
            [eD.s6.ACTIVITY_PRIVACY_STATUS]: {
                section: eH ? ey.oAB.GAMES : ey.oAB.ACTIVITY_PRIVACY,
                searchableTitles: [eZ.intl.string(eZ.t['8ka8lp'])],
                parent: eH ? eD.s6.GAMES_ACTIVITY_PRIVACY : eD.s6.ACTIVITY_PRIVACY
            },
            ...
            [eD.s6.MERCHANDISE]: {
                ...
                onClick: () => {
                    ...
                    F.default.track(ey.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, k.q)({
                            href: e,
                            shouldConfirm: !0,
                            onConfirm: () => {
                                F.default.track(ey.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, p.Z)(e);
                            }
                        });
                },
            ...
            [eD.s6.DEVELOPER_OPTIONS_LAYOUT_DEBUGGING_OPTIONS]: {
                ...
                searchableTitles: ['Layout Debugging'],
                parent: eD.s6.DEVELOPER_OPTIONS_FLAGS,
                predicate: () => eK && y.Z.isDeveloper && B.default.layoutDebuggingEnabled
            },
            ...
            [eD.s6.QUEST_PREVIEW_TOOL]: {
                ...
                element: D.Z,
                predicate: () => (0, P.X7)({ location: eB.dr.QUEST_PREVIEW_TOOL })
            },

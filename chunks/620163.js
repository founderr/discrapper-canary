    ...
    eV = (e) => {
        ...
        return Object.freeze({
            ...
            [eB.s6.ACCOUNT_SECURITY_TAB]: {
                ...
                searchableTitles: [eM.intl.string(eM.t.Am9YHh)],
                label: eM.intl.string(eM.t.Am9YHh)
            },
            [eB.s6.ACCOUNT]: {
                section: eL.oAB.ACCOUNT,
                searchableTitles: [eM.intl.string(eM.t['JAIM/v'])],
                label: eM.intl.string(eM.t['JAIM/v']),
                ariaLabel: eM.intl.string(eM.t['JAIM/v']),
                element: $.Z
            },
            [eB.s6.ACCOUNT_PROFILE]: {
                searchableTitles: [eM.intl.string(eM.t.LYju5O)],
                parent: eB.s6.ACCOUNT,
                section: eL.oAB.ACCOUNT
            },
            [eB.s6.ACCOUNT_DISPLAY_NAME]: {
                searchableTitles: [eM.intl.string(eM.t['9AjdkJ'])],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_PROFILE
            },
            [eB.s6.ACCOUNT_PHONE_NUMBER]: {
                searchableTitles: [eM.intl.string(eM.t.Ulqq6O)],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_PROFILE
            },
            [eB.s6.ACCOUNT_USERNAME]: {
                searchableTitles: [eM.intl.string(eM.t['+JkHPz'])],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_PROFILE
            },
            [eB.s6.ACCOUNT_EMAIL]: {
                searchableTitles: [eM.intl.string(eM.t.oP5zGB)],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_PROFILE
            },
            [eB.s6.ACCOUNT_PASSWORD_AND_AUTHENTICATION]: {
                searchableTitles: [eM.intl.string(eM.t.pKSjEh)],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT
            },
            ...
            [eB.s6.ACCOUNT_CONFIRM_PASSWORD]: {
                searchableTitles: [eM.intl.string(eM.t['7qKDrK'])],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_PASSWORD_AND_AUTHENTICATION
            },
            [eB.s6.ACCOUNT_MULTI_FACTOR_AUTHENTICATION]: {
                searchableTitles: [eM.intl.string(eM.t.m0FidH)],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_PASSWORD_AND_AUTHENTICATION
            },
            ...
            [eB.s6.ACCOUNT_SMS_BACKUP]: {
                searchableTitles: [eM.intl.string(eM.t.uHAJ5u)],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_MULTI_FACTOR_AUTHENTICATION
            },
            [eB.s6.ACCOUNT_SECURITY_KEYS]: {
                searchableTitles: [eM.intl.string(eM.t.vrOCCg)],
                section: eL.oAB.ACCOUNT,
                parent: eB.s6.ACCOUNT_MULTI_FACTOR_AUTHENTICATION
            },
            [eB.s6.ACCOUNT_REMOVAL]: {
                section: eL.oAB.ACCOUNT,
                searchableTitles: [eM.intl.string(eM.t.ZKsIkp)],
                parent: eB.s6.ACCOUNT
            },
            [eB.s6.ACCOUNT_DISABLE_ACCOUNT]: {
                section: eL.oAB.ACCOUNT,
                searchableTitles: [eM.intl.string(eM.t.jf5GGR)],
                parent: eB.s6.ACCOUNT_REMOVAL
            },
            [eB.s6.ACCOUNT_DELETE_ACCOUNT]: {
                section: eL.oAB.ACCOUNT,
                searchableTitles: [eM.intl.string(eM.t['8lQ2ra'])],
                parent: eB.s6.ACCOUNT_DISABLE_ACCOUNT
            },
            [eB.s6.GAMES]: {
                section: eL.oAB.GAMES,
                searchableTitles: [eM.intl.string(eM.t.URyqtL)],
                label: eM.intl.string(eM.t.URyqtL),
                ariaLabel: eM.intl.string(eM.t.URyqtL),
                element: eP.Z,
                predicate: () => eW
            },
            [eB.s6.GAMES_MY_GAMES]: {
                section: eL.oAB.GAMES,
                searchableTitles: [eM.intl.string(eM.t['5DMgp6'])],
                parent: eB.s6.GAMES
            },
            [eB.s6.GAMES_CLIPS]: {
                section: eL.oAB.GAMES,
            ...
            [eB.s6.GAMES_OVERLAY]: {
                section: eL.oAB.GAMES,
                searchableTitles: [eM.intl.string(eM.t['9cb1U1'])],
                parent: eB.s6.GAMES
            },
            ...
            [eB.s6.PROFILE_CUSTOMIZATION]: {
                ...
                type: h.bT.WIDE,
                searchableTitles: [eM.intl.string(eM.t['vi7f+v'])],
                label: eM.intl.string(eM.t['vi7f+v']),
                ariaLabel: eM.intl.string(eM.t['vi7f+v']),
                element: O.Z,
            ...
            [eB.s6.PROFILE_USER_PROFILE]: {
                section: eL.oAB.PROFILE_CUSTOMIZATION,
                searchableTitles: [eM.intl.string(eM.t['OU3/Pj'])],
                parent: eB.s6.PROFILE_CUSTOMIZATION
            },
            [eB.s6.PROFILE_SERVER_PROFILES]: {
                section: eL.oAB.PROFILE_CUSTOMIZATION,
                searchableTitles: [eM.intl.string(eM.t.kPHroa)],
                parent: eB.s6.PROFILE_CUSTOMIZATION
            },
            [eB.s6.PRIVACY_AND_SAFETY]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                label: eM.intl.string(eM.t.sKMrpq),
            ...
            [eB.s6.PRIVACY_USER_SETTINGS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.sKMrpq)],
                parent: eB.s6.PRIVACY_AND_SAFETY
            },
            [eB.s6.CONTENT_SOCIAL]: {
                section: eL.oAB.CONTENT_AND_SOCIAL,
                label: eM.intl.string(eM.t['+o1pDQ']),
            ...
            [eB.s6.DATA_PRIVACY]: {
                ...
                label: eM.intl.string(eM.t.OAuOHB),
            ...
            [eB.s6.PRIVACY_AND_SAFETY_SOCIAL_PERMISSIONS_CATEGORY]: {
                section: eL.oAB.CONTENT_AND_SOCIAL,
                searchableTitles: [eM.intl.string(eM.t['y62Z/f'])],
                parent: eB.s6.CONTENT_SOCIAL
            },
            [eB.s6.PRIVACY_AND_SAFETY_DISCORD_DATA_USAGE_CATEGORY]: {
                section: eL.oAB.DATA_AND_PRIVACY,
                searchableTitles: [eM.intl.string(eM.t.SRZyHh)],
                parent: eB.s6.DATA_PRIVACY
            },
            [eB.s6.PRIVACY_SENSITIVE_MEDIA]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.uEz8JC), eM.intl.string(eM.t['N/oRIy']), eM.intl.string(eM.t.QVdYsL), eM.intl.string(eM.t['aWD+tr']), eM.intl.string(eM.t['5mnTa2'])],
                parent: eB.s6.PRIVACY_USER_SETTINGS
            },
            ...
            [eB.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.JzaP4u), eM.intl.string(eM.t.H9XOl5), eM.intl.string(eM.t.k4W40N)],
                parent: eB.s6.PRIVACY_USER_SETTINGS
            },
            ...
            [eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.Hq4ApK), eM.intl.string(eM.t.i27PTE), eM.intl.string(eM.t['8M2an5'])],
                parent: eB.s6.PRIVACY_USER_SETTINGS
            },
            [eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_DMS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.eCO6Nz)],
                parent: eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS
            },
            [eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_AGE_RESTRICTED_IOS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t['L+yTsb'])],
                parent: eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS
            },
            ...
            [eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_MESSAGE_REQUESTS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.kOa6yM)],
                parent: eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS,
                predicate: () => !e1
            },
            [eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS_AGE_RESTRICTED_APPS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.XahVjo)],
                parent: eB.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS
            },
            ...
            [eB.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t['154/bG'])],
                parent: eB.s6.PRIVACY_AND_SAFETY
            },
            [eB.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_DMS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.LoKBGB)],
                parent: eB.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS
            },
            [eB.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_DMS_V2]: {
                section: eL.oAB.CONTENT_AND_SOCIAL,
                searchableTitles: [eM.intl.string(eM.t.RAQUSE), eM.intl.string(eM.t.wbYDfX)],
                parent: eB.s6.PRIVACY_AND_SAFETY_SERVER_SELECTOR
            },
            [eB.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_MESSAGE_REQUESTS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t['5IN9wc'])],
                parent: eB.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS,
                predicate: () => !e1
            },
            [eB.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_MESSAGE_REQUESTS_V2]: {
                section: eL.oAB.CONTENT_AND_SOCIAL,
                searchableTitles: [eM.intl.string(eM.t['3o2ojo'])],
                parent: eB.s6.PRIVACY_AND_SAFETY_SERVER_SELECTOR,
                predicate: () => !e1
            },
            [eB.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_ACTIVITY_STATUS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.OLwZDQ)],
                parent: eB.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS
            },
            ...
            [eB.s6.PRIVACY_SERVER_SPECIFIC_PRIVACY_ACTIVITY_JOINING]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.wBkwu7)],
                parent: eB.s6.PRIVACY_SERVER_SPECIFIC_SETTINGS
            },
            ...
            [eB.s6.PRIVACY_DATA_PRIVACY]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.RcaYGR)],
                parent: eB.s6.PRIVACY_USER_SETTINGS
            },
            [eB.s6.PRIVACY_DATA_IMPROVE_DISCORD]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.XuADY2)],
                parent: eB.s6.PRIVACY_DATA_PRIVACY
            },
            ...
            [eB.s6.PRIVACY_DATA_PERSONALIZE]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.MNKzys)],
                parent: eB.s6.PRIVACY_DATA_PRIVACY
            },
            ...
            [eB.s6.PRIVACY_DATA_QUESTS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.VkS7YW)],
                parent: eB.s6.PRIVACY_DATA_PRIVACY
            },
            ...
            [eB.s6.PRIVACY_DATA_BASIC_SERVICE]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                parent: eB.s6.PRIVACY_DATA_PRIVACY,
            ...
            [eB.s6.PRIVACY_DATA_REQUEST]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.dmBSKi)],
                parent: eB.s6.PRIVACY_DATA_PRIVACY
            },
            ...
            [eB.s6.PRIVACY_STAFF_ONLY]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.Fwp9SU)],
                parent: eB.s6.PRIVACY_USER_SETTINGS,
                predicate: () => eQ
            },
            [eB.s6.PRIVACY_KEYWORD_FILTER]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t['1UaUy8']), eM.intl.string(eM.t['xIk/iI'])],
                parent: eB.s6.PRIVACY_USER_SETTINGS,
                predicate: () => eq
            },
            ...
            [eB.s6.PRIVACY_TERMS_POLICY]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                parent: eB.s6.PRIVACY_USER_SETTINGS,
                searchableTitles: [eB.CF]
            },
            [eB.s6.PRIVACY_SAFETY_ALERTS]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
            ...
            [eB.s6.PRIVACY_ACCOUNT_STANDING]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t['00Sfl5'])],
                parent: eB.s6.PRIVACY_AND_SAFETY
            },
            [eB.s6.PRIVACY_ENCRYPTION]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t.hWMIiY), eM.intl.string(eM.t['9Q/PQk'])],
                parent: eB.s6.PRIVACY_AND_SAFETY
            },
            [eB.s6.PRIVACY_ENCRYPTION_VERIFICATION_CODES]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
                searchableTitles: [eM.intl.string(eM.t['2Ap8sr'])],
                parent: eB.s6.PRIVACY_ENCRYPTION
            },
            [eB.s6.PRIVACY_ENCRYPTION_VERIFIED_DEVICES]: {
                section: eL.oAB.PRIVACY_AND_SAFETY,
            ...
            [eB.s6.PRIVACY_FAMILY_CENTER]: {
                ...
                searchableTitles: [eM.intl.string(eM.t.gntCQU)],
                label: eM.intl.string(eM.t.gntCQU),
                ariaLabel: eM.intl.string(eM.t.gntCQU),
                element: ed.Z,
                badgeCount: eY,
            ...
            [eB.s6.PRIVACY_AND_SAFETY_RECEIVE_DISCORD_DATA_CATEGORY]: {
                section: eL.oAB.DATA_AND_PRIVACY,
                searchableTitles: [eM.intl.string(eM.t.BG7Qsb)],
                parent: eB.s6.DATA_PRIVACY
            },
            [eB.s6.AUTHORIZED_APPS]: {
                section: eL.oAB.AUTHORIZED_APPS,
                searchableTitles: [eM.intl.string(eM.t['f6kk+v'])],
                label: eM.intl.string(eM.t['f6kk+v']),
                element: ei.Z
            },
            [eB.s6.SESSIONS]: {
            ...
            [eB.s6.CONNECTIONS]: {
                ...
                searchableTitles: [eM.intl.string(eM.t['3fe7U1'])],
                label: eM.intl.string(eM.t['3fe7U1']),
                ariaLabel: eM.intl.string(eM.t['3fe7U1']),
                element: er.Z,
            ...
            [eB.s6.THIRD_PARTY_ACCESS]: {
                section: eL.oAB.CONNECTIONS,
                searchableTitles: [eM.intl.string(eM.t['Ig/XFR']), eM.intl.string(eM.t['3fe7U1']), eM.intl.string(eM.t['f6kk+v'])],
                label: eM.intl.string(eM.t['Ig/XFR']),
                parent: eB.s6.CONNECTIONS,
                element: eb.Z
            },
            [eB.s6.CONNECTIONS_CONNECTED_ACCOUNTS]: {
                section: eL.oAB.CONNECTIONS,
                searchableTitles: [eM.intl.string(eM.t['+/hZMz'])],
                parent: eB.s6.CONNECTIONS,
                element: er.Z
            },
            [eB.s6.CLIPS]: {
                ...
                icon: ez ? (0, i.jsx)(T.Z, {}) : void 0,
                element: C.Z,
                predicate: () => !eW
            },
            [eB.s6.FRIEND_REQUESTS]: {
            ...
            [eB.s6.PREMIUM]: {
                ...
                ariaLabel: eM.intl.string(eM.t.Ipxkoq),
                searchableTitles: [eM.intl.string(eM.t.Ipxkoq)],
                label: eM.intl.string(eM.t.Ipxkoq),
                element: K.Z,
            ...
            [eB.s6.SUBSCRIPTIONS]: {
                ...
                ariaLabel: eM.intl.string(eM.t.trSpHR),
                searchableTitles: [eM.intl.string(eM.t.trSpHR)],
                label: eM.intl.string(eM.t.trSpHR),
                element: v.Z,
                icon: eV
            ...
            [eB.s6.SUBSCRIPTIONS_CREDITS]: {
                section: eL.oAB.SUBSCRIPTIONS,
                searchableTitles: [eM.intl.string(eM.t['2GKrvr'])],
                parent: eB.s6.SUBSCRIPTIONS
            },
            [eB.s6.GIFT_INVENTORY]: {
                section: eL.oAB.INVENTORY,
                searchableTitles: [eM.intl.string(eM.t['jcSP+v'])],
                label: eM.intl.string(eM.t['jcSP+v']),
                element: eg.Z,
                ariaLabel: eM.intl.string(eM.t['jcSP+v']),
                badgeCount: t
            },
            [eB.s6.GIFT_NITRO]: {
                section: eL.oAB.INVENTORY,
            ...
            [eB.s6.GIFT_INVENTORY_QUESTS]: {
                section: eL.oAB.INVENTORY,
                searchableTitles: [eM.intl.string(eM.t.JALI2N)],
                parent: eB.s6.GIFT_INVENTORY,
                predicate: () => e$
            },
            ...
            [eB.s6.BILLING]: {
                ...
                searchableTitles: [eM.intl.string(eM.t.oeUm2t)],
                label: eM.intl.string(eM.t.oeUm2t),
                ariaLabel: eM.intl.string(eM.t.oeUm2t),
                element: es.Z
            },
            [eB.s6.BILLING_PAYMENT_METHODS]: {
                section: eL.oAB.BILLING,
                searchableTitles: [eM.intl.string(eM.t.W26xGR)],
                parent: eB.s6.BILLING
            },
            [eB.s6.BILLING_TRANSACTION_HISTORY]: {
                section: eL.oAB.BILLING,
                searchableTitles: [eM.intl.string(eM.t.obLrcH)],
                parent: eB.s6.BILLING
            },
            [eB.s6.APPEARANCE]: {
                section: eL.oAB.APPEARANCE,
                searchableTitles: [eM.intl.string(eM.t['iHH+k5'])],
                label: eM.intl.string(eM.t['iHH+k5']),
                ariaLabel: eM.intl.string(eM.t['iHH+k5']),
                element: en.Z,
                newIndicator: (0, i.jsx)(a.PremiumBadge, { text: eM.intl.string(eM.t.y2b7CA) }),
                newIndicatorDismissibleContentTypes: ew()
            },
            [eB.s6.APPEARANCE_THEME]: {
                section: eL.oAB.APPEARANCE,
                searchableTitles: [eM.intl.string(eM.t.Ksh3io)],
            ...
            [eB.s6.APPEARANCE_ICON]: {
                section: eL.oAB.APPEARANCE,
                searchableTitles: [eM.intl.string(eM.t.RPh2oq)],
                parent: eB.s6.APPEARANCE_THEME
            },
            [eB.s6.APPEARANCE_MESSAGE_DISPLAY_COMPACT]: {
                section: eL.oAB.APPEARANCE,
                searchableTitles: [eM.intl.string(eM.t.ZEoGMT)],
                parent: eB.s6.APPEARANCE
            },
            ...
            [eB.s6.APPEARANCE_TIMESTAMP_HOUR_CYCLE]: {
                section: eL.oAB.APPEARANCE,
                searchableTitles: [eM.intl.string(eM.t.dyamEB), eM.intl.string(eM.t.p8NOws), eM.intl.string(eM.t['+o/sOj'])],
                parent: eB.s6.APPEARANCE,
            ...
            [eB.s6.ACCESSIBILITY]: {
                ...
                searchableTitles: [eM.intl.string(eM.t.G0neg4)],
                label: eM.intl.string(eM.t.G0neg4),
                ariaLabel: eM.intl.string(eM.t.G0neg4),
                element: J.Z
            },
            [eB.s6.ACCESSIBILITY_SATURATION]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t['5PWWCQ'])],
                parent: eB.s6.ACCESSIBILITY
            },
            [eB.s6.ACCESSIBILITY_SATURATION_CUSTOM_COLOR]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.bQCodH)],
                parent: eB.s6.ACCESSIBILITY_SATURATION
            },
            [eB.s6.ACCESSIBILITY_LINK_DECORATIONS]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.OLZFBw)],
                parent: eB.s6.ACCESSIBILITY
            },
            [eB.s6.ACCESSIBILITY_ROLE_STYLE]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.uSOPWl)],
                parent: eB.s6.ACCESSIBILITY
            },
            [eB.s6.ACCESSIBILITY_TAGS]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.UQt6dX)],
                parent: eB.s6.ACCESSIBILITY
            },
            [eB.s6.ACCESSIBILITY_TAGS_NAMES]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.UPwh1N)],
                parent: eB.s6.ACCESSIBILITY_TAGS
            },
            ...
            [eB.s6.ACCESSIBILITY_MESSAGES_LEGACY_CHAT_INPUT]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.TZ2hZG)],
                parent: eB.s6.ACCESSIBILITY_MESSAGES
            },
            [eB.s6.ACCESSIBILITY_TEXT_TO_SPEECH]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.VpSKeH)],
                parent: eB.s6.ACCESSIBILITY
            },
            [eB.s6.ACCESSIBILITY_TEXT_TO_SPEECH_TTS_COMMAND]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.qvTIwc)],
                parent: eB.s6.ACCESSIBILITY_TEXT_TO_SPEECH
            },
            [eB.s6.ACCESSIBILITY_TEXT_TO_SPEECH_RATE]: {
                section: eL.oAB.ACCESSIBILITY,
                searchableTitles: [eM.intl.string(eM.t.lsW5Eh)],
                parent: eB.s6.ACCESSIBILITY
            },
            ...
            [eB.s6.VOICE_AND_VIDEO]: {
                ...
                searchableTitles: [eM.intl.string(eM.t.B1fFpa)],
                label: eM.intl.string(eM.t.B1fFpa),
                ariaLabel: eM.intl.string(eM.t.B1fFpa),
                element: ey.Z,
                predicate: () => Z.Z.isSupported()
            },
            [eB.s6.VOICE_AND_VIDEO_DEVICES]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.hHMYbW), eM.intl.string(eM.t.dl18zc), eM.intl.string(eM.t.nuFtHB), eM.intl.string(eM.t['3182VF']), eM.intl.string(eM.t['DGq/PT'])],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.OX2Bnp), eM.intl.string(eM.t.eATD2N), eM.intl.string(eM.t.nuFtHB), eM.intl.string(eM.t['3182VF']), eM.intl.string(eM.t['DGq/PT'])],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_MIC_TEST]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.gyljWF), eM.intl.string(eM.t.nuFtHB)],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_INPUT_MODE]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t['pS+K2N']), eM.intl.string(eM.t.nuFtHB)],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_SENSITIVITY]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t['sqUm+v']), eM.intl.string(eM.t.nuFtHB)],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_SWITCH_CHANNEL_ALERT]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.e7LIiY)],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_SOUNDS]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.nzUc3N)],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_SOUNDBOARD]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.ABjMWF)],
            ...
            [eB.s6.VOICE_AND_VIDEO_VIDEO]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.LKzQSE)],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_VIDEO_CAMERA]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.F122Gx)],
                parent: eB.s6.VOICE_AND_VIDEO_VIDEO,
                predicate: () => Z.Z.supports(eF.AN.VIDEO)
            },
            [eB.s6.VOICE_AND_VIDEO_ADVANCED]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t['8/udY2'])],
                parent: eB.s6.VOICE_AND_VIDEO
            },
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_AUDIO]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.DSGme3)],
                parent: eB.s6.VOICE_AND_VIDEO_ADVANCED
            },
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_VIDEO]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.Tceiq6)],
                parent: eB.s6.VOICE_AND_VIDEO_ADVANCED
            },
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_VIDEO_OPENH264]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t['71Ve19'])],
            ...
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.NMCIf3), eM.intl.string(eM.t.FeUKeH)],
                parent: eB.s6.VOICE_AND_VIDEO_ADVANCED,
            ...
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_SCREENSHARE_VIDEO_HOOK]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.GmWk2N), eM.intl.string(eM.t['Fj/xn5'])],
            ...
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_AEC_DUMP]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t['r6K+TE'])],
                parent: eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => Z.Z.isAecDumpSupported()
            },
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t.U4FgFB)],
                parent: eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => ('canary' === V.ZP.releaseChannel || 'development' === V.ZP.releaseChannel) && eQ && Z.Z.supports(eF.AN.CONNECTION_REPLAY)
            },
            [eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t['726JHB'])],
                parent: eB.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
                predicate: () => U.isPlatformEmbedded && Z.Z.supports(eF.AN.DEBUG_LOGGING) && null != g.Z.fileManager.readLogFiles
            },
            [eB.s6.VOICE_AND_VIDEO_RESET_VOICE_SETTINGS]: {
                section: eL.oAB.VOICE,
                searchableTitles: [eM.intl.string(eM.t['/RXu6+'])],
                parent: eB.s6.VOICE_AND_VIDEO_ADVANCED
            },
            [eB.s6.POGGERMODE]: {
                section: eL.oAB.POGGERMODE,
                searchableTitles: [eM.intl.string(eM.t.AtCukJ)],
                label: eM.intl.string(eM.t.AtCukJ),
                ariaLabel: eM.intl.string(eM.t.AtCukJ),
                element: b.Z,
            ...
            [eB.s6.CHAT_INLINE_MEDIA]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.U68Dgo)],
                parent: eB.s6.CHAT
            },
            [eB.s6.CHAT_INLINE_MEDIA_LINKS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.U47N1t)],
                parent: eB.s6.CHAT_INLINE_MEDIA
            },
            [eB.s6.CHAT_INLINE_MEDIA_UPLOADS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.VP11Nj)],
                parent: eB.s6.CHAT_INLINE_MEDIA
            },
            [eB.s6.CHAT_INLINE_MEDIA_IMAGE_DESCRIPTIONS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t['5S2AKy'])],
                parent: eB.s6.CHAT_INLINE_MEDIA
            },
            [eB.s6.CHAT_EMBEDS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.PWZOn5)],
                parent: eB.s6.CHAT
            },
            [eB.s6.CHAT_EMBEDS_LINK_PREVIEWS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.xX0ZTE)],
                parent: eB.s6.CHAT_EMBEDS
            },
            [eB.s6.CHAT_EMOJI]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.sMOuub)],
                parent: eB.s6.CHAT
            },
            [eB.s6.CHAT_EMOJI_REACTIONS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.Iv24sr)],
                parent: eB.s6.CHAT_EMOJI
            },
            [eB.s6.CHAT_EMOJI_EMOTICONS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t['79qal5'])],
                parent: eB.s6.CHAT_EMOJI
            },
            [eB.s6.CHAT_STICKERS]: {
                section: eL.oAB.TEXT,
            ...
            [eB.s6.CHAT_STICKERS_SUGGESTIONS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t['479+PT'])],
                parent: eB.s6.CHAT_STICKERS
            },
            [eB.s6.CHAT_STICKERS_AUTOCOMPLETE]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t['29xPVV'])],
                parent: eB.s6.CHAT_STICKERS
            },
            [eB.s6.CHAT_TEXT_BOX]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.afR0pK)],
                parent: eB.s6.CHAT
            },
            [eB.s6.CHAT_TEXT_BOX_PREVIEW]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.AqGrEB)],
                parent: eB.s6.CHAT_TEXT_BOX
            },
            [eB.s6.CHAT_THREADS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.B2panJ)],
                parent: eB.s6.CHAT
            },
            [eB.s6.CHAT_THREADS_SPLIT_VIEW]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.AInv5u)],
                parent: eB.s6.CHAT_THREADS
            },
            [eB.s6.CHAT_SPOILERS]: {
                section: eL.oAB.TEXT,
                searchableTitles: [eM.intl.string(eM.t.QgwmV1)],
                parent: eB.s6.CHAT
            },
            [eB.s6.NOTIFICATIONS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.HcoRu7)],
                label: eM.intl.string(eM.t.HcoRu7),
                ariaLabel: eM.intl.string(eM.t.HcoRu7),
                element: eS.Z
            },
            [eB.s6.NOTIFICATIONS_ENABLE_DESKTOP]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t['/0WClp'])],
            ...
            [eB.s6.NOTIFICATIONS_UNREAD_MESSAGE_BADGE]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.VH8AIC)],
                parent: eB.s6.NOTIFICATIONS
            },
            [eB.s6.NOTIFICATIONS_ENABLE_TASKBAR_FLASHING]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.xSmFQE)],
                parent: eB.s6.NOTIFICATIONS,
                predicate: () => (0, U.isWindows)()
            },
            [eB.s6.NOTIFICATIONS_UNREAD_SETTINGS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.z21l8P)],
                parent: eB.s6.NOTIFICATIONS
            },
            ...
            [eB.s6.NOTIFICATIONS_PUSH_INACTIVE_TIMEOUT]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.TTvjd3)],
                parent: eB.s6.NOTIFICATIONS
            },
            ...
            [eB.s6.NOTIFICATIONS_COMMUNITY_ACTIVITY_ALERTS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.D9yVAA)],
                parent: eB.s6.NOTIFICATIONS
            },
            [eB.s6.NOTIFICATIONS_COMMUNITY_IN_APP_ALERTS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.u6dc5O)],
                parent: eB.s6.NOTIFICATIONS_COMMUNITY_ACTIVITY_ALERTS
            },
            [eB.s6.NOTIFICATIONS_COMMUNITY_PUSH_NOTIFICATIONS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.P8MG6u)],
                parent: eB.s6.NOTIFICATIONS_COMMUNITY_ACTIVITY_ALERTS
            },
            [eB.s6.NOTIFICATIONS_SOUNDS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.MKWyKS)],
                parent: eB.s6.NOTIFICATIONS
            },
            [eB.s6.NOTIFICATIONS_EMAILS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.TPchzM)],
                parent: eB.s6.NOTIFICATIONS
            },
            [eB.s6.NOTIFICATIONS_EMAILS_COMMUNICATION]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t['B75+xc'])],
                parent: eB.s6.NOTIFICATIONS_EMAILS
            },
            [eB.s6.NOTIFICATIONS_EMAILS_SOCIAL]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.sxn7lZ)],
                parent: eB.s6.NOTIFICATIONS_EMAILS
            },
            [eB.s6.NOTIFICATIONS_EMAILS_ANNOUNCEMENTS_AND_UPDATES]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.EkxXhY)],
                parent: eB.s6.NOTIFICATIONS_EMAILS
            },
            [eB.s6.NOTIFICATIONS_EMAILS_TIPS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.jNrkrK)],
                parent: eB.s6.NOTIFICATIONS_EMAILS
            },
            [eB.s6.NOTIFICATIONS_EMAILS_RECOMMENDATIONS_AND_EVENTS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.E8g1l5)],
                parent: eB.s6.NOTIFICATIONS_EMAILS
            },
            [eB.s6.NOTIFICATIONS_EMAILS_UNSUBSCRIBE_FROM_ALL_MARKETING_EMAILS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.Ra9Pws)],
                parent: eB.s6.NOTIFICATIONS_EMAILS
            },
            [eB.s6.NOTIFICATIONS_REACTIONS]: {
                section: eL.oAB.NOTIFICATIONS,
                searchableTitles: [eM.intl.string(eM.t.Rq0NFh)],
                parent: eB.s6.NOTIFICATIONS
            },
            [eB.s6.KEYBINDS]: {
                section: eL.oAB.KEYBINDS,
                searchableTitles: [eM.intl.string(eM.t.T9DA2N)],
                label: eM.intl.string(eM.t.T9DA2N),
                element: ep.Z
            },
            [eB.s6.LANGUAGE]: {
                section: eL.oAB.LOCALE,
                searchableTitles: [eM.intl.string(eM.t.IHMsPj)],
                label: eM.intl.string(eM.t.IHMsPj),
                element: ex.Z
            },
            [eB.s6.WINDOW_SETTINGS]: {
                section: eL.oAB.WINDOWS,
                searchableTitles: [eM.intl.string(eM.t.ZkDZoq)],
                label: eM.intl.string(eM.t.ZkDZoq),
                element: ev.Z,
                predicate: () => U.isPlatformEmbedded && (0, U.isWindows)()
            },
            [eB.s6.LINUX_SETTINGS]: {
                section: eL.oAB.LINUX,
                searchableTitles: [eM.intl.string(eM.t['7pPjTU'])],
                label: eM.intl.string(eM.t['7pPjTU']),
                element: eU,
            ...
            [eB.s6.STREAMER_MODE_INTEGRATIONS]: {
                section: eL.oAB.STREAMER_MODE,
                searchableTitles: [eM.intl.string(eM.t.bxGbHB)],
                parent: eB.s6.STREAMER_MODE
            },
            [eB.s6.STREAMER_MODE_ENABLE]: {
                section: eL.oAB.STREAMER_MODE,
                searchableTitles: [eM.intl.string(eM.t.p9ZAJS)],
                parent: eB.s6.STREAMER_MODE
            },
            [eB.s6.STREAMER_MODE_HIDE_PERSONAL_INFORMATION]: {
                section: eL.oAB.STREAMER_MODE,
                searchableTitles: [eM.intl.string(eM.t.UpQziI)],
                parent: eB.s6.STREAMER_MODE
            },
            [eB.s6.STREAMER_MODE_HIDE_INVITE_LINKS]: {
                section: eL.oAB.STREAMER_MODE,
                searchableTitles: [eM.intl.string(eM.t.q7WNGh)],
                parent: eB.s6.STREAMER_MODE
            },
            [eB.s6.STREAMER_MODE_DISABLE_SOUNDS]: {
                section: eL.oAB.STREAMER_MODE,
                searchableTitles: [eM.intl.string(eM.t['1CWknJ'])],
                parent: eB.s6.STREAMER_MODE
            },
            [eB.s6.STREAMER_MODE_DISABLE_NOTIFICATIONS]: {
                section: eL.oAB.STREAMER_MODE,
                searchableTitles: [eM.intl.string(eM.t.qmYiYW)],
                parent: eB.s6.STREAMER_MODE
            },
            [eB.s6.STREAMER_MODE_HIDE_DISCORD_WINDOW_FROM_SCREEN_CAPTURE]: {
                section: eL.oAB.STREAMER_MODE,
                searchableTitles: [eM.intl.string(eM.t['iA81+f'])],
                parent: eB.s6.STREAMER_MODE,
                predicate: () => {
                    var e, t, n;
            ...
            [eB.s6.SETTINGS_ADVANCED]: {
                ...
                searchableTitles: [eM.intl.string(eM.t['8/udY2'])],
                label: eM.intl.string(eM.t['8/udY2']),
                ariaLabel: eM.intl.string(eM.t['8/udY2']),
                element: et.Z
            },
            [eB.s6.SETTINGS_ADVANCED_DEVELOPER_MODE]: {
                section: eL.oAB.ADVANCED,
                searchableTitles: [eM.intl.string(eM.t.ObIb1d)],
                parent: eB.s6.SETTINGS_ADVANCED,
                predicate: () => k.wS
            },
            [eB.s6.SETTINGS_ADVANCED_HARDWARE_ACCELERATION]: {
                section: eL.oAB.ADVANCED,
                searchableTitles: [eM.intl.string(eM.t['eOC/Fx'])],
                parent: eB.s6.SETTINGS_ADVANCED,
                predicate: () => U.isPlatformEmbedded
            },
            ...
            [eB.s6.ACTIVITY_PRIVACY_STATUS]: {
                section: eW ? eL.oAB.GAMES : eL.oAB.ACTIVITY_PRIVACY,
                searchableTitles: [eM.intl.string(eM.t['8ka8lp'])],
                parent: eW ? eB.s6.GAMES_ACTIVITY_PRIVACY : eB.s6.ACTIVITY_PRIVACY
            },
            [eB.s6.ACTIVITY_PRIVACY_RICH_PRESENCE]: {
                section: eW ? eL.oAB.GAMES : eL.oAB.ACTIVITY_PRIVACY,
                searchableTitles: [eM.intl.string(eM.t.VOszPD)],
                parent: eW ? eB.s6.GAMES_ACTIVITY_PRIVACY : eB.s6.ACTIVITY_PRIVACY
            },
            ...
            [eB.s6.ACTIVITY_PRIVACY_STATUS_DISPLAY]: {
                section: eL.oAB.ACTIVITY_PRIVACY,
                searchableTitles: [eM.intl.string(eM.t['4F2KoK'])],
                parent: eB.s6.ACTIVITY_PRIVACY
            },
            [eB.s6.REGISTERED_GAMES]: {
                section: eL.oAB.REGISTERED_GAMES,
                searchableTitles: [eM.intl.string(eM.t.AVDyEh)],
                label: eM.intl.string(eM.t.AVDyEh),
                element: em.Z,
                predicate: () => !eW && (0, eR.Jw)()
            },
            [eB.s6.OVERLAY]: {
                section: eL.oAB.OVERLAY,
                searchableTitles: [eM.intl.string(eM.t['9cb1U1'])],
                label: eM.intl.string(eM.t['9cb1U1']),
                element: eT.Z,
                predicate: () => !eW && eH
            },
            [eB.s6.CHANGELOG]: {
                section: 'changelog',
                onClick: () => (0, S.Z)(!0),
                searchableTitles: [eM.intl.string(eM.t.LRmNAg)],
                label: eM.intl.string(eM.t.LRmNAg)
            },
            [eB.s6.MERCHANDISE]: {
                section: 'merchandise',
                onClick: () => {
                    let e = 'https://discordmerch.com/Dsktopprm';
                    M.default.track(eL.rMx.USER_SETTINGS_MERCH_LINK_CLICKED),
                        (0, w.q)({
                            href: e,
                            shouldConfirm: !0,
                            onConfirm: () => {
                                M.default.track(eL.rMx.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, p.Z)(e);
                            }
                        });
                },
                searchableTitles: [eM.intl.string(eM.t.sMEktb)],
                label: eM.intl.string(eM.t.sMEktb),
                ariaLabel: eM.intl.string(eM.t.sMEktb)
            },
            [eB.s6.HYPESQUAD]: {
            ...
            [eB.s6.DEVELOPER_OPTIONS_TRACING_REQUESTS]: {
                ...
                parent: eB.s6.DEVELOPER_OPTIONS_FLAGS,
                predicate: () => B.Z.isDeveloper
            },
            ...
            [eB.s6.DISMISSIBLE_CONTENT_OPTIONS]: {
            ...
            [eB.s6.PROFILE_EFFECTS_PREVIEW_TOOL]: {
                ...
                onClick: () => {
                    (0, a.openModal)((e) =>
                        (0, i.jsx)(a.ConfirmModal, {
                            header: eM.intl.string(eM.t['2jxGen']),
                            confirmText: eM.intl.string(eM.t['2jxGen']),
                            ...
                            children: (0, i.jsx)(a.Text, {
                                ...
                                children: eM.intl.string(eM.t.SUnWBA)
                            })
                        })
                    );
                },
                label: eM.intl.string(eM.t['2jxGen']),
                ariaLabel: eM.intl.string(eM.t['2jxGen']),

...
let eG = () => {
  ...
  eB = e => {
    ...
    return Object.freeze({
      ...
      [eL.WebSetting.VOICE_AND_VIDEO_ADVANCED_DEBUGGING]: {
        section: eP.UserSettingsSections.VOICE,
        searchableTitle: eU.default.Messages.FORM_LABEL_DEBUG,
        parent: eL.WebSetting.VOICE_AND_VIDEO_ADVANCED,
        predicate: () => V.isPlatformEmbedded && U.default.supports(ev.Features.DEBUG_LOGGING) && null != E.default.fileManager.readLogFiles
      },
      [eL.WebSetting.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_AEC_DUMP]: {
        section: eP.UserSettingsSections.VOICE,
        searchableTitle: eU.default.Messages.FORM_CHECKBOX_AEC_DUMP,
        parent: eL.WebSetting.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
        predicate: () => U.default.isAecDumpSupported()
      },
      [eL.WebSetting.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
        section: eP.UserSettingsSections.VOICE,
      ...
      [eL.WebSetting.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_LOGGING]: {
        section: eP.UserSettingsSections.VOICE,
        searchableTitle: eU.default.Messages.FORM_CHECKBOX_DEBUG_LOGGING,
        parent: eL.WebSetting.VOICE_AND_VIDEO_ADVANCED_DEBUGGING
      },
      ...
      [eL.WebSetting.MERCHANDISE]: {
        ...
        onClick: () => {
          ...
          B.default.track(eP.AnalyticEvents.USER_SETTINGS_MERCH_LINK_CLICKED), (0, y.handleClick)({
            href: e,
            shouldConfirm: !0,
            onConfirm: () => {
              B.default.track(eP.AnalyticEvents.USER_SETTINGS_MERCH_LINK_CONFIRMED), (0, T.default)(e)
            }
          })
        },

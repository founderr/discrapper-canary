...
return Object.freeze({
  ...
  [eD.s6.PRIVACY_SENSITIVE_MEDIA]: {
    section: eP.oAB.PRIVACY_AND_SAFETY,
    searchableTitles: [
      eZ.Z.Messages.OBSCURED_CONTENT_SETTINGS_HEADER,
      eZ.Z.Messages.OBSCURED_CONTENT_SEARCH_TERM_FILTER,
      eZ.Z.Messages.OBSCURED_CONTENT_SEARCH_TERM_BLUR,
      eZ.Z.Messages.OBSCURED_CONTENT_SEARCH_TERM_SENSITIVE_CONTENT,
      eZ.Z.Messages.OBSCURED_CONTENT_SEARCH_TERM_EXPLICIT
    ],
  ...
  [eD.s6.PRIVACY_DIRECT_MESSAGE_SPAM_FILTER]: {
    section: eP.oAB.PRIVACY_AND_SAFETY,
    searchableTitles: [
      eZ.Z.Messages.SETTINGS_DM_SPAM_FILTER,
      eZ.Z.Messages.SETTINGS_DM_SPAM_FILTER_SEARCH_TERM_MESSAGES,
      eZ.Z.Messages.SETTINGS_DM_SPAM_FILTER_SEARCH_TERM_INBOX
    ],
    parent: eD.s6.PRIVACY_USER_SETTINGS
  },
  [eD.s6.PRIVACY_SERVER_PRIVACY_DEFAULTS]: {
    section: eP.oAB.PRIVACY_AND_SAFETY,
    searchableTitles: [
      eZ.Z.Messages.USER_DM_SETTINGS,
      eZ.Z.Messages.USER_DM_SEARCH_TERM_DIRECT_MESSAGES,
      eZ.Z.Messages.USER_DM_SEARCH_TERM_DM
    ],
    parent: eD.s6.PRIVACY_USER_SETTINGS
  },
  ...
  [eD.s6.PRIVACY_KEYWORD_FILTER]: {
    section: eP.oAB.PRIVACY_AND_SAFETY,
    searchableTitles: [
      eZ.Z.Messages.USER_KEYWORD_FILTERS_DESCRIPTION_SEARCHABLE,
      eZ.Z.Messages.USER_KEYWORD_FILTERS_SEARCH_TERM_KEYWORD
    ],
    parent: eD.s6.PRIVACY_USER_SETTINGS,
    predicate: () => ew
  },
  ...
  [eD.s6.PRIVACY_ENCRYPTION]: {
    section: eP.oAB.PRIVACY_AND_SAFETY,
    searchableTitles: [
      eZ.Z.Messages.E2EE_ENCRYPTION,
      eZ.Z.Messages.E2EE_END_TO_END_ENCRYPTION
    ],
    parent: eD.s6.PRIVACY_AND_SAFETY
  },
  ...
  [eD.s6.VOICE_AND_VIDEO_DEVICES]: {
    section: eP.oAB.VOICE,
    searchableTitles: [
      eZ.Z.Messages.FORM_LABEL_INPUT_DEVICE,
      eZ.Z.Messages.FORM_LABEL_OUTPUT_DEVICE,
      eZ.Z.Messages.INPUT_SEARCH_TERM_MICROPHONE,
      eZ.Z.Messages.OUTPUT_SEARCH_TERM_SPEAKERS,
      eZ.Z.Messages.OUTPUT_SEARCH_TERM_HEADPHONES
    ],
  ...
  [eD.s6.VOICE_AND_VIDEO_VOLUME_CONTROLS]: {
    section: eP.oAB.VOICE,
    searchableTitles: [
      eZ.Z.Messages.FORM_LABEL_INPUT_VOLUME,
      eZ.Z.Messages.FORM_LABEL_OUTPUT_VOLUME,
      eZ.Z.Messages.INPUT_SEARCH_TERM_MICROPHONE,
      eZ.Z.Messages.OUTPUT_SEARCH_TERM_SPEAKERS,
      eZ.Z.Messages.OUTPUT_SEARCH_TERM_HEADPHONES
    ],
  ...
  [eD.s6.VOICE_AND_VIDEO_MIC_TEST]: {
    section: eP.oAB.VOICE,
    searchableTitles: [
      eZ.Z.Messages.USER_SETTINGS_VOICE_MIC_TEST_TITLE,
      eZ.Z.Messages.INPUT_SEARCH_TERM_MICROPHONE
    ],
    parent: eD.s6.VOICE_AND_VIDEO
  },
  [eD.s6.VOICE_AND_VIDEO_INPUT_MODE]: {
    section: eP.oAB.VOICE,
    searchableTitles: [
      eZ.Z.Messages.FORM_LABEL_INPUT_MODE,
      eZ.Z.Messages.INPUT_SEARCH_TERM_MICROPHONE
    ],
    parent: eD.s6.VOICE_AND_VIDEO
  },
  [eD.s6.VOICE_AND_VIDEO_SENSITIVITY]: {
    section: eP.oAB.VOICE,
    searchableTitles: [
      eZ.Z.Messages.FORM_LABEL_INPUT_SENSITIVTY,
      eZ.Z.Messages.INPUT_SEARCH_TERM_MICROPHONE
    ],
    parent: eD.s6.VOICE_AND_VIDEO
  },
  ...
  [eD.s6.VOICE_AND_VIDEO_VIDEO_CAMERA]: {
    ...
    predicate: () => j.Z.supports(eb.AN.VIDEO)
  },
  ...
  [eD.s6.VOICE_AND_VIDEO_ADVANCED_CODECS_VIDEO_OPENH264]: {
    ...
    predicate: () => j.Z.supports(eb.AN.OPEN_H264)
  },
  ...
  [eD.s6.VOICE_AND_VIDEO_ADVANCED_PROCESSING_NOISE_SUPPRESSION]: {
    section: eP.oAB.VOICE,
    searchableTitles: [
      eZ.Z.Messages.NOISE_SUPPRESSION,
      eZ.Z.Messages.NOISE_CANCELLATION_SEARCH_TERM_KRISP
    ],
    parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_PROCESSING,
  ...
  [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING]: {
    ...
    parent: eD.s6.VOICE_AND_VIDEO_ADVANCED,
    predicate: () => y.isPlatformEmbedded && j.Z.supports(eb.AN.DEBUG_LOGGING) && null != u.Z.fileManager.readLogFiles
  },
  ...
  [eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING_CONNECTION_REPLAY]: {
    ...
    parent: eD.s6.VOICE_AND_VIDEO_ADVANCED_DEBUGGING,
    predicate: () => ('canary' === V.ZP.releaseChannel || 'development' === V.ZP.releaseChannel) && ek && j.Z.supports(eb.AN.CONNECTION_REPLAY)
  },
  ...
  [eD.s6.SPEED_TEST]: {
    ...
    label: 'Speed Test',
    element: Q.Z,
    predicate: () => Z.Z.isSupported() && w.Z.getCurrentConfig({
      location: '9f7d84_2'
    }).showSettings
  },
  ...
  [eD.s6.ACTIVITY_PRIVACY_STATUS]: {
    ...
    parent: eV ? eD.s6.GAMES_ACTIVITY_PRIVACY : eD.s6.ACTIVITY_PRIVACY
  },

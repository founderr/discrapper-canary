...
var a = t(735250), n = t(470079), l = t(442837), s = t(481060), r = t(700582), c = t(933557), d = t(266076), o = t(592125), u = t(430824), A = t(158776), I = t(699516), _ = t(594174), S = t(104175), E = t(51144), f = t(912332), h = t(689938), g = t(666106);
function p(e) {
    let {
        icon: i,
        label: t
...
function b(e) {
    let {user: i} = e, t = E.ZP.useName(i), n = (0, l.e7)([I.Z], () => I.Z.getNickname(i.id)), c = (0, l.e7)([A.Z], () => A.Z.getStatus(i.id));
    return (0, a.jsx)(p, {
        icon: (0, a.jsx)(r.Z, {
            'aria-hidden': !0,
            size: s.AvatarSizes.SIZE_32,
...
function N(e) {
    let {channel: i} = e, t = (0, l.e7)([u.Z], () => u.Z.getGuild(null == i ? void 0 : i.guild_id)), n = (0, c.ZP)(i);
    return (0, a.jsx)(p, {
        icon: (0, a.jsx)(S.Z, {
            size: S.E.SMALL_32,
            guild: t,
...
function x(e) {
    ...
    if (null != n)
        return (0, a.jsx)(b, { user: n });
    if (null != t)
        return (0, a.jsx)(N, { channel: t });
    return null;
}
function T(e) {
    let {

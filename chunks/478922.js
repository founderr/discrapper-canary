...
function d(e, t, n) {
    ...
    return (0, i.forwardRef)(function (n, E) {
        var f;
        let { onScroll: h, dir: p = 'ltr', sections: I, columns: m, getItemKey: T, getItemHeight: g, getSectionHeight: S, chunkSize: A, renderSection: N, renderItem: O, getSectionProps: R, itemGutter: v, removeEdgeItemGutters: C, sectionGutter: y, padding: D, paddingVertical: L, paddingHorizontal: b, fade: M = !1, className: P, style: U, maxContentWidth: w, renderAccessory: x, onItemVisibilityChange: G, ...k } = n,
            B = i.useRef(null),
            F = i.useRef(null),
            V = i.useRef({}),
            [H, Z] = i.useState(!1),

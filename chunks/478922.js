...
function d(e, t, n) {
    ...
    return (0, i.forwardRef)(function (n, _) {
        var p;
        let { onScroll: h, dir: m = 'ltr', sections: g, columns: E, getItemKey: v, getItemHeight: b, getSectionHeight: I, chunkSize: S, renderSection: T, renderItem: y, getSectionProps: A, itemGutter: N, removeEdgeItemGutters: C, sectionGutter: R, padding: O, paddingVertical: D, paddingHorizontal: L, fade: x = !1, className: w, style: M, maxContentWidth: P, renderAccessory: k, onItemVisibilityChange: U, ...B } = n,
            G = i.useRef(null),
            Z = i.useRef(null),
            F = i.useRef({}),
            [V, j] = i.useState(!1),

...
class ea extends (i = s.PureComponent) {
    ...
    async handleRegister() {
        let { email: e, username: t, globalName: n, password: i, consent: r, parsedDateOfBirth: s } = this.state,
            ...
            m = E.MD.getState(),
            f = (0, H.Ew)(u) ? null : t === u,
            p = Q.a ? await (0, j.K)(t) : t,
            x = Q.a ? await (0, j.K)(n) : n;
    ...
    renderFull(e, t) {
        let { email: n, username: i, globalName: l, password: o, consent: c, parsedDateOfBirth: u, globalNameFocused: d, emailClientError: h, usernameClientError: m, passwordClientError: f, dateOfBirthClientError: p } = this.state,
            {
                registering: _,
                consentRequired: E,
                ...
                authBoxClassName: C,
                apiErrors: { email: b, username: A, global_name: j, password: T, date_of_birth: Z } = {},
            ...
            M = async () => {
                this.setState({ usernameFocused: !0 }), v && l.length > 0 && !D.Z.wasRegistrationSuggestionFetched(l) && (await O.Z.fetchSuggestionsRegistration(l));
            },
        ...
        return t
            ? (0, r.jsx)(J.Z, {
                  onSubmit: this.handleSubmit,
                  tag: 'form',
                  className: a()(C, en.horizontalAuthBox),
                  children: () => [
                      G,
                      (0, r.jsxs)(
                          'div',
...
function eo(e) {
    let t = (0, d.cj)([U.Z, G.default, f.Z, P.Z, R.Z], () => ({

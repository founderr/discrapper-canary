...
let V = () => ({ [m.zUn.REASON]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMON_REASON) }),
    j = () => ({
        [m.zUn.NAME]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_NAME_CHANGE),
        [m.zUn.DESCRIPTION]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DESCRIPTION_CLEAR, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DESCRIPTION_CHANGE),
        [m.zUn.ICON_HASH]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_ICON_HASH_CHANGE)),
        [m.zUn.SPLASH_HASH]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SPLASH_HASH_CHANGE)),
        [m.zUn.DISCOVERY_SPLASH_HASH]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DISCOVERY_SPLASH_HASH_CHANGE)),
        [m.zUn.BANNER_HASH]: eg(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_BANNER_HASH_REMOVE), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_BANNER_HASH_CHANGE)),
        [m.zUn.OWNER_ID]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_OWNER_ID_CHANGE),
        [m.zUn.REGION]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_REGION_CHANGE),
        [m.zUn.PREFERRED_LOCALE]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_PREFERRED_LOCALE_CHANGE),
        [m.zUn.AFK_CHANNEL_ID]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_CHANNEL_ID_CLEAR, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_CHANNEL_ID_CHANGE),
        [m.zUn.AFK_TIMEOUT]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_TIMEOUT_CHANGE),
        [m.zUn.SYSTEM_CHANNEL_ID]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_DISABLE, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_CHANGE),
        [m.zUn.RULES_CHANNEL_ID]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_RULES_CHANNEL_ID_CLEAR, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_RULES_CHANNEL_ID_CHANGE),
        [m.zUn.PUBLIC_UPDATES_CHANNEL_ID]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CLEAR, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CHANGE),
        [m.zUn.MFA_LEVEL]: ep({
        ...
        [m.zUn.WIDGET_ENABLED]: ef(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_ENABLED, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_DISABLED),
        [m.zUn.WIDGET_CHANNEL_ID]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_DELETE, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_CHANGE),
        ...
        [m.zUn.VANITY_URL_CODE]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_VANITY_URL_CODE_DELETE, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_VANITY_URL_CODE_CHANGE),
        ...
        [m.zUn.PREMIUM_PROGRESS_BAR_ENABLED]: ef(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_PREMIUM_PROGRESS_BAR_ENABLED_ENABLED, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_PREMIUM_PROGRESS_BAR_ENABLED_DISABLED),
        [m.zUn.AUTO_MODERATION_TRIGGERED_RULE_NAME]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTO_MODERATION_TRIGGERED_RULE_NAME_CHANGE),
        [m.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATIONS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_JOIN_NOTIFICATIONS),
        [m.zUn.SYSTEM_CHANNEL_FLAG_PREMIUM_SUBSCRIPTIONS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_PREMIUM_SUBSCRIPTIONS),
        [m.zUn.SYSTEM_CHANNEL_FLAG_REMINDER_NOTIFICATIONS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_REMINDER_NOTIFICATIONS),
        [m.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATION_REPLIES]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_JOIN_NOTIFICATION_REPLIES),
        ...V()
    }),
    y = () => ({
        ...
        [m.zUn.AVAILABLE_TAG_DELETE]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_AVAILABLE_TAGS_DELETE),
        [m.zUn.LINKED_LOBBY]: eg(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_LOBBY_LINK_DELETE, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_LOBBY_LINK_CREATE)
    }),
    k = () => ({
        [m.zUn.NICK]: eC(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_CHANGE, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_CREATE, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_DELETE),
        [m.zUn.DEAF]: ef(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_DEAF_ON, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_DEAF_OFF),
        [m.zUn.MUTE]: ef(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_MUTE_ON, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_MUTE_OFF),
        [m.zUn.ROLES_REMOVE]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_ROLES_REMOVE),
        [m.zUn.ROLES_ADD]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_ROLES_ADD),
        [m.zUn.PRUNE_DELETE_DAYS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_PRUNE_DELETE_DAYS),
        [m.zUn.COMMUNICATION_DISABLED_UNTIL]: eC(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL, B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL_REMOVED)),
        [m.zUn.BYPASSES_VERIFICATION]: ef(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_BYPASSES_VERIFICATION_ON), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_BYPASSES_VERIFICATION_OFF)),
        [m.zUn.AUTO_MODERATION_TRIGGERED_RULE_NAME]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTO_MODERATION_TRIGGERED_RULE_NAME_CHANGE),
        ...V()
    }),
    z = () => ({
        ...
        [m.zUn.HOIST]: ef(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_HOIST_ON), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_HOIST_OFF)),
        [m.zUn.MENTIONABLE]: ef(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_MENTIONABLE_ON), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_MENTIONABLE_OFF)),
        [m.zUn.ICON_HASH]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_ICON_HASH_CHANGE)),
        [m.zUn.UNICODE_EMOJI]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_UNICODE_EMOJI_CHANGE)),
        ...V()
    }),
    K = () => ({
        ...V(),
    ...
    w = () => ({
        ...V(),
        [m.zUn.DEFAULT_CHANNEL_IDS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_DEFAULT_CHANNEL_IDS),
        [m.zUn.ENABLE_DEFAULT_CHANNELS]: ef(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_ENABLE_DEFAULT_CHANNELS), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_DISABLE_DEFAULT_CHANNELS)),
        [m.zUn.ENABLE_ONBOARDING_PROMPTS]: ef(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_ENABLE_PROMPTS), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_DISABLE_PROMPTS)),
        [m.zUn.ENABLED]: ef(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_ENABLE), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_DISABLE))
    }),
    W = () => ({
        ...V(),
        [m.zUn.WELCOME_MESSAGE]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_HOME_SETTINGS_CHANGED_WELCOME_MESSAGE)),
        [m.zUn.NEW_MEMBER_ACTIONS]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_HOME_SETTINGS_CHANGED_NEW_MEMBER_ACTIONS)),
        [m.zUn.RESOURCE_CHANNELS]: x(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_HOME_SETTINGS_CHANGED_RESOURCE_CHANNELS))
    }),
    Y = () => ({
        [m.zUn.CODE]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_CODE_CREATE),
        [m.zUn.CHANNEL_ID]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_CHANNEL_CREATE),
        [m.zUn.MAX_USES]: eh({ 0: b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_MAX_USES_CREATE_INFINITE }, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_MAX_USES_CREATE),
        [m.zUn.MAX_AGE]: eh({ [b.Z.Messages.MAX_AGE_NEVER]: b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_MAX_AGE_CREATE_INFINITE }, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_MAX_AGE_CREATE),
        [m.zUn.TEMPORARY]: ef(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_TEMPORARY_ON, b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_TEMPORARY_OFF),
        [m.zUn.FLAGS]: ep({ [a.$.IS_GUEST_INVITE]: b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_INVITE_GUEST_INVITE }),
        ...V()
    }),
    q = () => ({
    ...
    Q = () => ({
        [m.zUn.ENABLE_EMOTICONS]: ef(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INTEGRATION_ENABLE_EMOTICONS_ON), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INTEGRATION_ENABLE_EMOTICONS_OFF)),
        ...
        [m.zUn.EXPIRE_GRACE_PERIOD]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INTEGRATION_EXPIRE_GRACE_PERIOD),
        ...V()
    }),
    $ = () => ({
    ...
    ee = () => ({
        [m.zUn.NAME]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_NAME_CREATE),
        [m.zUn.DESCRIPTION]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_DESCRIPTION_CREATE),
        [m.zUn.PRIVACY_LEVEL]: ep({
            [v.j8.GUILD_ONLY]: b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_STAGE_INSTANCE_PRIVACY_LEVEL_GUILD_ONLY,
            [v.j8.PUBLIC]: b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_STAGE_INSTANCE_PRIVACY_LEVEL_PUBLIC
        }),
        ...
        [m.zUn.CHANNEL_ID]: eg(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_CHANNEL_CLEAR), b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_CHANNEL),
        [m.zUn.LOCATION]: eg(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION_CLEAR), b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION),
        [m.zUn.IMAGE_HASH]: eg(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_REMOVE), B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_CHANGE)),
        ...V()
    }),
    e_ = () => ({
        [m.zUn.SCHEDULED_START_TIME]: eg(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_REMOVED), b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_CHANGE),
        [m.zUn.SCHEDULED_END_TIME]: eg(B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_REMOVED), b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_CHANGE),
        [m.zUn.IS_CANCELED]: (e) => {
            if (null != e.oldValue || !0 === e.newValue) {
                if (!e.oldValue && e.newValue) return B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_IS_CANCELED_CANCELED);
                if (e.oldValue && !e.newValue) return B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_IS_CANCELED_RESTORED);
            }
            return B('');
        },
        ...V()
    ...
    es = (e) => {
        ...
        return (
            null == e ||
                e.forEach((e) => {
                    e.newValue ? (e.newValue.permission ? (_[e.key] = x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_GRANTED)) : (_[e.key] = x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_DENIED))) : (_[e.key] = x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_REMOVED));
                }),
            _
        );
    },
    en = () => ({
        [m.zUn.NAME]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NAME_UPDATE),
        [m.zUn.AUTO_MODERATION_TRIGGER_TYPE]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_TRIGGER_TYPE_UPDATE),
        [m.zUn.AUTO_MODERATION_EVENT_TYPE]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_EVENT_TYPE_UPDATE),
        [m.zUn.AUTO_MODERATION_ACTIONS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_ACTIONS_UPDATE),
        [m.zUn.AUTO_MODERATION_ENABLED]: (e) => {
            var _;
            return !0 === (null !== (_ = e.newValue) && void 0 !== _ ? _ : e.oldValue) ? B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_ENABLED_UPDATE) : B(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_DISABLED_UPDATE);
        },
        [m.zUn.AUTO_MODERATION_EXEMPT_ROLES]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_EXEMPT_ROLES_UPDATE),
        [m.zUn.AUTO_MODERATION_EXEMPT_CHANNELS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_EXEMPT_CHANNELS_UPDATE),
        [m.zUn.AUTO_MODERATION_TRIGGER_METADATA]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_TRIGGER_METADATA_UPDATE),
        [m.zUn.AUTO_MODERATION_ADD_KEYWORDS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_ADD_KEYWORDS),
        [m.zUn.AUTO_MODERATION_REMOVE_KEYWORDS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_REMOVE_KEYWORDS),
        [m.zUn.AUTO_MODERATION_ADD_REGEX_PATTERNS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_ADD_REGEX_PATTERNS),
        [m.zUn.AUTO_MODERATION_REMOVE_REGEX_PATTERNS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_REMOVE_REGEX_PATTERNS),
        [m.zUn.AUTO_MODERATION_ADD_ALLOW_LIST]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_ADD_ALLOW_LIST),
        [m.zUn.AUTO_MODERATION_REMOVE_ALLOW_LIST]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_REMOVE_ALLOW_LIST),
        ...V()
    }),
    et = () => ({
    ...
    er = () => ({
        [m.zUn.STATUS]: x(b.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_VOICE_CHANNEL_STATUS_STATUS_CREATE),
        ...V()
    }),
    eT = {
        [m.KFR.CHANNEL]: {
...
function eo(e) {
    ...
    return null != eI(m.zUn.COMMUNICATION_DISABLED_UNTIL, e) ? b.Z.Messages.MEMBER_SAFETY_COMMUNICATION_DISABLED : null !== (_ = null == E ? void 0 : E.label) && void 0 !== _ ? _ : null;
}
let eA = {
                        ...
                        let t = (function (e, _, E) {
                            ...
                            switch (e.key) {
                                ...
                                case m.zUn.AFK_TIMEOUT:
                                    return eG(e, (e) => e / 60);
                                case m.zUn.BITRATE:
                                    return eG(e, (e) => e / 1000);
                                case m.zUn.COLOR:
                                    return eG(e, (e) => (0, l.Rf)(e).toUpperCase());
                                case m.zUn.THEME_COLORS:
                                    return eG(e, (e) => ''.concat((0, l.Rf)(e[0]).toUpperCase(), ', ').concat((0, l.Rf)(e[1]).toUpperCase()));
                                case m.zUn.MAX_AGE:
                                    return eG(e, (e) => {
                                ...
                                case m.zUn.VIDEO_QUALITY_MODE:
                                    return eG(e, (e) => (e === m.Ucd.FULL ? b.Z.Messages.VIDEO_QUALITY_MODE_FULL : b.Z.Messages.VIDEO_QUALITY_MODE_AUTO));
                                ...
                                case m.zUn.AUTO_MODERATION_EVENT_TYPE:
                                    if (_.targetType === m.KFR.AUTO_MODERATION_RULE) return eG(e, L.YN);
                                    break;
                                case m.zUn.AUTO_MODERATION_TRIGGER_TYPE:
                                    if (_.targetType === m.KFR.AUTO_MODERATION_RULE) return eG(e, L.Ar);
                                    break;
                                ...
                                case m.zUn.AUTO_MODERATION_REMOVE_ALLOW_LIST:
                                    if (_.targetType === m.KFR.AUTO_MODERATION_RULE) return eG(e, (e) => (null != e && Array.isArray(e) ? e.map((e) => "'".concat(e, "'")).join(', ') : JSON.stringify(e)));
                                    break;
                                ...
                                case m.zUn.AVAILABLE_TAGS:
                                    return (function (e) {
                                        ...
                                        if (
                                            ...
                                            for (let e in r) if (null == t[e]) return new U.ms(m.zUn.AVAILABLE_TAG_ADD, null, eU(r[e]));
                                        }
                                        if (s.length > n.length) {
                                            for (let e in t) if (null == r[e]) return new U.ms(m.zUn.AVAILABLE_TAG_DELETE, null, eU(t[e]));
                                        }
                                        for (let e in t) {
                                            let _ = t[e],
                                                E = r[e];
                                            if ((null == E ? void 0 : E.name) !== _.name || (null == E ? void 0 : E.emoji_id) !== _.emoji_id || (null == E ? void 0 : E.emoji_name) !== _.emoji_name) return new U.ms(m.zUn.AVAILABLE_TAG_EDIT, eU(_), eU(E));
                                        }
                                        return e;
                                    })(e);
                                case m.zUn.SCHEDULED_START_TIME:
                                case m.zUn.SCHEDULED_END_TIME:
                                    return eG(e, (e) => (0, g.vc)(r()(new Date(e)), 'LLLL'));
                            }
                            return e;
                        })(s, e, _);

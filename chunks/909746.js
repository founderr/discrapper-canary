...
let F = new N.Z('AuditLogUtils'),
    ...
    V = () => ({ [P.zUn.REASON]: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMON_REASON }),
    j = () => ({
        [P.zUn.NAME]: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_NAME_CHANGE,
        [P.zUn.DESCRIPTION]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DESCRIPTION_CLEAR, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DESCRIPTION_CHANGE),
        ...
        [P.zUn.BANNER_HASH]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_BANNER_HASH_REMOVE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_BANNER_HASH_CHANGE),
        ...
        [P.zUn.AFK_CHANNEL_ID]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_CHANNEL_ID_CLEAR, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_CHANNEL_ID_CHANGE),
        [P.zUn.AFK_TIMEOUT]: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_AFK_TIMEOUT_CHANGE,
        [P.zUn.SYSTEM_CHANNEL_ID]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_DISABLE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_CHANGE),
        [P.zUn.RULES_CHANNEL_ID]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_RULES_CHANNEL_ID_CLEAR, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_RULES_CHANNEL_ID_CHANGE),
        [P.zUn.PUBLIC_UPDATES_CHANNEL_ID]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CLEAR, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CHANGE),
        [P.zUn.MFA_LEVEL]: {
        ...
        [P.zUn.WIDGET_CHANNEL_ID]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_DELETE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_CHANGE),
        ...
        [P.zUn.VANITY_URL_CODE]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_VANITY_URL_CODE_DELETE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_VANITY_URL_CODE_CHANGE),
        ...
        [P.zUn.PREMIUM_PROGRESS_BAR_ENABLED]: {
            true: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_PREMIUM_PROGRESS_BAR_ENABLED_ENABLED,
            false: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_PREMIUM_PROGRESS_BAR_ENABLED_DISABLED
        },
    ...
    y = () => ({
        [P.zUn.NAME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_NAME_CHANGE),
        [P.zUn.POSITION]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_POSITION_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_POSITION_CHANGE),
        [P.zUn.TOPIC]: eC(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CHANGE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CLEAR),
        [P.zUn.BITRATE]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_BITRATE_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_BITRATE_CHANGE),
        [P.zUn.RTC_REGION_OVERRIDE]: eC(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CHANGE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_DELETE),
        [P.zUn.USER_LIMIT]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_USER_LIMIT_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_USER_LIMIT_CHANGE),
        [P.zUn.RATE_LIMIT_PER_USER]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE),
        ...
        [P.zUn.TYPE]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TYPE_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TYPE_CHANGE),
        [P.zUn.VIDEO_QUALITY_MODE]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CHANGE),
        [P.zUn.DEFAULT_AUTO_ARCHIVE_DURATION]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CHANGE),
        ...
        [P.zUn.LINKED_LOBBY]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_LOBBY_LINK_DELETE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_LOBBY_LINK_CREATE)
    }),
    k = () => ({
        [P.zUn.NICK]: eC(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_CHANGE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_NICK_DELETE),
        [P.zUn.DEAF]: {
        ...
        [P.zUn.COMMUNICATION_DISABLED_UNTIL]: eC(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL_REMOVED),
        [P.zUn.BYPASSES_VERIFICATION]: {
            true: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_BYPASSES_VERIFICATION_ON,
            false: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_MEMBER_BYPASSES_VERIFICATION_OFF
        },
        [P.zUn.AUTO_MODERATION_TRIGGERED_RULE_NAME]: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTO_MODERATION_TRIGGERED_RULE_NAME_CHANGE,
        ...V()
    }),
    z = () => ({
        [P.zUn.NAME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_NAME_CHANGE),
        [P.zUn.DESCRIPTION]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CHANGE),
    ...
    K = () => ({
        ...
        [P.zUn.SINGLE_SELECT]: {
            true: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_PROMPT_SINGLE_SELECT,
            false: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ROLE_PROMPT_MULTI_SELECT
        },
        [P.zUn.REQUIRED]: {
    ...
    w = () => ({
        ...
        [P.zUn.ENABLE_DEFAULT_CHANNELS]: {
            true: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_ENABLE_DEFAULT_CHANNELS,
            false: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_DISABLE_DEFAULT_CHANNELS
        },
        [P.zUn.ENABLE_ONBOARDING_PROMPTS]: {
            true: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_ENABLE_PROMPTS,
            false: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_DISABLE_PROMPTS
        },
        [P.zUn.ENABLED]: {
    ...
    Y = () => ({
        ...
        [P.zUn.MAX_USES]: {
            0: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_MAX_USES_CREATE_INFINITE,
            [B]: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_MAX_USES_CREATE
        },
        [P.zUn.MAX_AGE]: {
            0: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INVITE_MAX_AGE_CREATE_INFINITE,
    ...
    q = () => ({
        [P.zUn.CHANNEL_ID]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_CHANNEL_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_CHANNEL_CHANGE),
        [P.zUn.NAME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_NAME_CHANGE),
        [P.zUn.AVATAR_HASH]: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_WEBHOOK_AVATAR,
        [P.zUn.REASON]: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMON_REASON
    }),
    X = () => ({
        [P.zUn.NAME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_EMOJI_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_EMOJI_NAME_CHANGE),
        ...V()
    }),
    J = () => ({
        [P.zUn.NAME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_NAME_CHANGE),
        [P.zUn.TAGS]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_TAGS_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_TAGS_CHANGE),
        [P.zUn.DESCRIPTION]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_DESCRIPTION_CHANGE),
        ...V()
    }),
    Q = () => ({
        [P.zUn.ENABLE_EMOTICONS]: {
            true: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INTEGRATION_ENABLE_EMOTICONS_ON,
            false: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_INTEGRATION_ENABLE_EMOTICONS_OFF
        },
    ...
    $ = () => ({
        [P.zUn.TOPIC]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_TOPIC_CHANGE),
        [P.zUn.PRIVACY_LEVEL]: {
    ...
    ee = () => ({
        ...
        [P.zUn.CHANNEL_ID]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_CHANNEL_CLEAR, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_CHANNEL),
        [P.zUn.LOCATION]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION_CLEAR, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION),
        [P.zUn.IMAGE_HASH]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_REMOVE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_CHANGE),
        ...V()
    }),
    e_ = () => ({
        [P.zUn.SCHEDULED_START_TIME]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_REMOVED, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_CHANGE),
        [P.zUn.SCHEDULED_END_TIME]: eg(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_REMOVED, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_CHANGE),
        [P.zUn.IS_CANCELED]: (e) => {
    ...
    eE = () => ({
        [P.zUn.NAME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_NAME_CHANGE),
        [P.zUn.ARCHIVED]: {
        ...
        [P.zUn.INVITABLE]: {
            true: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_INVITABLE_ENABLED,
            false: H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_INVITABLE_DISABLED
        },
        [P.zUn.AUTO_ARCHIVE_DURATION]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CHANGE),
        [P.zUn.RATE_LIMIT_PER_USER]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE),
    ...
    et = () => ({
        [P.zUn.NAME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_NAME_CHANGE),
        [P.zUn.VOLUME]: eR(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_VOLUME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_VOLUME_CHANGE),
        [P.zUn.EMOJI_NAME]: eC(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_NAME_REPLACE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_NAME_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_NAME_REMOVE),
        [P.zUn.EMOJI_ID]: eC(H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_ID_REPLACE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_ID_CREATE, H.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_ID_REMOVE),
        ...V()
    }),
    er = () => ({
...
function eo(e) {
    ...
    return null != eI(P.zUn.COMMUNICATION_DISABLED_UNTIL, e) ? H.Z.Messages.MEMBER_SAFETY_COMMUNICATION_DISABLED : null !== (_ = null == E ? void 0 : E.label) && void 0 !== _ ? _ : null;
}
let eA = {
                        ...
                        let t = (function (e, _, E) {
                            ...
                            switch (e.key) {
                                ...
                                case P.zUn.THEME_COLORS:
                                    return ed(e, (e) => ''.concat((0, l.Rf)(e[0]).toUpperCase(), ', ').concat((0, l.Rf)(e[1]).toUpperCase()));
                                case P.zUn.MAX_AGE:
                                    return ed(e, (e) => {
                                ...
                                case P.zUn.VIDEO_QUALITY_MODE:
                                    return ed(e, (e) => (e === P.Ucd.FULL ? H.Z.Messages.VIDEO_QUALITY_MODE_FULL : H.Z.Messages.VIDEO_QUALITY_MODE_AUTO));
                                ...
                                case P.zUn.AUTO_MODERATION_EVENT_TYPE:
                                    if (_.targetType === P.KFR.AUTO_MODERATION_RULE) return ed(e, L.YN);
                                    break;
                                case P.zUn.AUTO_MODERATION_TRIGGER_TYPE:
                                    if (_.targetType === P.KFR.AUTO_MODERATION_RULE) return ed(e, L.Ar);
                                    break;
                                ...
                                case P.zUn.AUTO_MODERATION_REMOVE_ALLOW_LIST:
                                    if (_.targetType === P.KFR.AUTO_MODERATION_RULE) return ed(e, (e) => (null != e && Array.isArray(e) ? e.map((e) => "'".concat(e, "'")).join(', ') : JSON.stringify(e)));
                                    break;
                                ...
                                case P.zUn.AVAILABLE_TAGS:
                                    return (function (e) {
                                        ...
                                        if (
                                            ...
                                            for (let e in r) if (null == t[e]) return new U.ms(P.zUn.AVAILABLE_TAG_ADD, null, eU(r[e]));
                                        }
                                        if (s.length > n.length) {
                                            for (let e in t) if (null == r[e]) return new U.ms(P.zUn.AVAILABLE_TAG_DELETE, null, eU(t[e]));
                                        }
                                        for (let e in t) {
                                            let _ = t[e],
                                                E = r[e];
                                            if ((null == E ? void 0 : E.name) !== _.name || (null == E ? void 0 : E.emoji_id) !== _.emoji_id || (null == E ? void 0 : E.emoji_name) !== _.emoji_name) return new U.ms(P.zUn.AVAILABLE_TAG_EDIT, eU(_), eU(E));
                                        }
                                        return e;
                                    })(e);
                                case P.zUn.SCHEDULED_START_TIME:
                                case P.zUn.SCHEDULED_END_TIME:
                                    return ed(e, (e) => (0, g.vc)(r()(new Date(e)), 'LLLL'));
                            }
                            return e;
                        })(s, e, _);

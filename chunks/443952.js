...
async function P(e, t, n, i) {
    ...
    if (null == l || null == l.secrets || !(0, b.t9)(i, l.party, l.secrets)) throw new A.Z({ errorCode: R.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure an activity includes a party and appropriate secret.');
    let a = (0, p.Z)(l, I.Z);
    if (a) {
        let { lock: t } = (0, y.jU)(e);
        return (0, o.h7)(l, a).then(() => {
            throw (t(), new A.Z({ errorCode: R.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure user does have have privacy enabled.'));
        });
    }
...
t.Z = {
    [R.Etm.SEND_ACTIVITY_JOIN_INVITE]: {
        ...
        handler(e) {
            let {
                ...
                r = t.application.id;
            if (null == r) throw new A.Z({ errorCode: R.lTL.INVALID_COMMAND }, 'No application.');
            return P(i, r, n, R.mFx.JOIN);
        }
    },
    ...
    [R.Etm.ACTIVITY_INVITE_USER]: {
        ...
        handler(e) {
            let {
                ...
                a = t.application.id;
            if (null == a) throw new A.Z({ errorCode: R.lTL.INVALID_COMMAND }, 'No application.');
            return P(l, a, i, n, r);
        }
    },
    [R.Etm.ACCEPT_ACTIVITY_INVITE]: {
        ...
        handler(e) {
            let {
                ...
                s = t.application.id;
            if (null == s) throw new A.Z({ errorCode: R.lTL.INVALID_COMMAND }, 'No application.');
            ...
            return o.then((e) => {
                if (!e) throw new A.Z({ errorCode: R.lTL.INVALID_INVITE }, 'Invite is expired or invalid.');
            });
        }
    },
    ...
    [R.Etm.INITIATE_IMAGE_UPLOAD]: (0, l.S)(R.Etm.INITIATE_IMAGE_UPLOAD, {
        ...
        handler(e) {
            ...
            let { socket: n } = e,
                i = n.application.id;
            if (null == i) throw new A.Z({ errorCode: R.lTL.INVALID_COMMAND }, 'No application.');
            let r = null === (t = (0, Z.Z)()) || void 0 === t ? void 0 : t.id;
            if (null == r) throw new A.Z({ errorCode: R.lTL.UNKNOWN_ERROR }, 'Unable to find selected channel');
            return new Promise((e, t) => {
                !(function (e, t) {
                    var n;
                    let i = C.Z.getLastFocusedWindowId(),
                        r = null == i ? null : null === (n = (0, h.g0)(i)) || void 0 === n ? void 0 : n.renderWindow;
                    if (null == r) throw new A.Z({ errorCode: R.lTL.UNKNOWN_ERROR }, 'No valid window found');
                ...
                var t;
                throw new A.Z({ errorCode: R.lTL.UNKNOWN_ERROR }, null !== (t = null == e ? void 0 : e.message) && void 0 !== t ? t : 'Failed to upload image');
            });
        }
    }),
    [R.Etm.OPEN_SHARE_MOMENT_DIALOG]: (0, l.S)(R.Etm.OPEN_SHARE_MOMENT_DIALOG, {
        ...
        handler(e) {
            ...
            if (null == r) throw new A.Z({ errorCode: R.lTL.INVALID_COMMAND }, 'No application.');
            if (!(0, v.yE)(null !== (t = n.application.flags) && void 0 !== t ? t : 0, R.udG.EMBEDDED)) throw new A.Z({ errorCode: R.lTL.INVALID_COMMAND }, 'This application cannot access this API');
            let l = (0, Z.Z)();
            if (null == l) throw new A.Z({ errorCode: R.lTL.INVALID_COMMAND }, 'No channel found');
            if (!N.Z.isDiscordCdnUrl(i)) throw new A.Z({ errorCode: R.lTL.INVALID_PAYLOAD }, 'mediaUrl must be a Discord CDN url');
            (0, g.Z)({
                applicationId: r,
                channelId: l.id,
                mediaUrl: i

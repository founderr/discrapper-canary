...
t.default = {
  ...
  [y.RPCCommands.ACCEPT_ACTIVITY_INVITE]: {
    ...
    handler(e) {
      ...
      if (n === y.ActivityActionTypes.JOIN) o = u.default.join({
        userId: a,
        sessionId: s,
        applicationId: r,
        channelId: l,
  ...
  [y.RPCCommands.OPEN_INVITE_DIALOG]: {
    ...
    handler(e) {
      let {
        ...
        channel: s,
        guild: l
      } = (0, M.validateOpenInviteDialog)(), r = C.default.getWindow(y.PopoutWindowKeys.CHANNEL_CALL_POPOUT);
      ...
      (0, N.exitFullScreen)({}, null == r ? void 0 : r.document), (0, i.openModalLazy)(async () => {
        ...
        contextKey: o === y.AppContext.POPOUT ? i.POPOUT_MODAL_CONTEXT : i.DEFAULT_MODAL_CONTEXT
      })
    }
  },

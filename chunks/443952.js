...
async function M(e, t, n, i) {
    ...
    if (null == a || null == a.secrets || !(0, L.t9)(i, a.party, a.secrets))
        throw new Z.Z({ errorCode: P.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure an activity includes a party and appropriate secret.');
    let r = (0, E.Z)(a, T.Z);
    if (r) {
        let {lock: t} = (0, x.s0)(e);
        return (0, o.h7)(a, r).then(() => {
            throw t(), new Z.Z({ errorCode: P.lTL.NO_ELIGIBLE_ACTIVITY }, 'No eligible activity for application. Ensure user does have have privacy enabled.');
        });
    }
...
t.Z = {
    ...
    [P.Etm.ACCEPT_ACTIVITY_INVITE]: {
        ...
        handler(e) {
            ...
            return o.then(e => {
                if (!e)
                    throw new Z.Z({ errorCode: P.lTL.INVALID_INVITE }, 'Invite is expired or invalid.');
            });
        }
    },
    ...
    [P.Etm.INITIATE_IMAGE_UPLOAD]: (0, a.S)(P.Etm.INITIATE_IMAGE_UPLOAD, {
        ...
        handler(e) {
            ...
            if (null == s)
                throw new Z.Z({ errorCode: P.lTL.UNKNOWN_ERROR }, 'Unable to find selected channel');
            return new Promise((e, t) => {
                !function (e, t) {
                    var n;
                    let i = S.Z.getLastFocusedWindowId(), s = null == i ? null : null === (n = (0, _.g0)(i)) || void 0 === n ? void 0 : n.renderWindow;
                    if (null == s)
                        throw new Z.Z({ errorCode: P.lTL.UNKNOWN_ERROR }, 'No valid window found');
                ...
                var t;
                throw new Z.Z({ errorCode: P.lTL.UNKNOWN_ERROR }, null !== (t = null == e ? void 0 : e.message) && void 0 !== t ? t : 'Failed to upload image');
            });
        }
    }),
    [P.Etm.OPEN_SHARE_MOMENT_DIALOG]: (0, a.S)(P.Etm.OPEN_SHARE_MOMENT_DIALOG, {
        ...
        handler(e) {
            ...
            let a = (0, O.Z)();
            if (null == a)
                throw new Z.Z({ errorCode: P.lTL.INVALID_COMMAND }, 'No channel found');
            if (!N.Z.isDiscordCdnUrl(i))
                throw new Z.Z({ errorCode: P.lTL.INVALID_PAYLOAD }, 'mediaUrl must be a Discord CDN url');
            (0, I.Z)({
                applicationId: s,
                channelId: a.id,
                mediaUrl: i

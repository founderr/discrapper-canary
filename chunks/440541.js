...
r.inherits(c, u),
    ...
    (c.prototype._update = function (e, t) {
        for (var n = this.h[0], r = this.h[1], i = this.h[2], u = this.h[3], c = this.h[4], I = n, T = r, g = i, S = u, A = c, v = 0; v < 80; v++) {
            var N = o(a(l(n, d(v, r, i, u), e[f[v] + t], _(v)), p[v]), c);
            (n = c), (c = u), (u = a(i, 10)), (i = r), (r = N), (N = o(a(l(I, d(79 - v, T, g, S), e[h[v] + t], E(v)), m[v]), A)), (I = A), (A = S), (S = a(g, 10)), (g = T), (T = N);
        }
        (N = s(this.h[1], i, S)), (this.h[1] = s(this.h[2], u, A)), (this.h[2] = s(this.h[3], c, I)), (this.h[3] = s(this.h[4], n, T)), (this.h[4] = s(this.h[0], r, g)), (this.h[0] = N);
    }),

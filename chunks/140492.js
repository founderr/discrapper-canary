...
function I() {
  ...
  null == t ? ! function(e) {
    ...
    let {
      ...
      path: i,
      basePath: l
    } = s.default.getState(), o = c.default.getPrivateChannelIds(), a = __OVERLAY__ ? o : [...S(), ...o];
    let u = (null == n ? (t = null != i ? i : l, S().findIndex(e => t.startsWith(e))) : null != n ? a.indexOf(n) : 0) + e;
    ...
    ((0, l.canSeeGuildHome)(t) || (0, o.canSeeOnboardingHome)(t)) && d.unshift(T.StaticChannelRoute.GUILD_HOME);

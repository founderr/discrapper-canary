...
var i = t(718528), l = t(931261), o = t(355298), E = t(333984), r = t(905423), u = t(695346), a = t(283595), s = t(923834), d = t(55589), _ = t(823379), c = t(475468), C = t(981631), I = t(176505);
let A = () => {
...
function T() {
    ...
    null == n ? !function (e) {
        ...
        let _ = (null == l ? (n = null != o ? o : E, A().findIndex(e => n.startsWith(e))) : null != l ? a.indexOf(l) : 0) + e;
        ...
        var t, o, E, u;
        let a = r.Z.getState().channelId, s = (0, i.Z)(n, { withCurrentVoiceChannel: !0 }).map(e => e.id);

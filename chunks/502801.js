...
var i = t(735250), l = t(470079), E = t(120356), a = t.n(E), r = t(442837), o = t(952265), _ = t(481060), u = t(493683), d = t(700582), s = t(100527), c = t(906732), C = t(933557), S = t(471445), A = t(734307), T = t(359110), I = t(814443), L = t(210887), D = t(131704), N = t(699516), U = t(944486), h = t(914010), P = t(594174), R = t(186523), f = t(553826), g = t(823379), O = t(407316), G = t(937784), m = t(689938), H = t(168167), Z = t(138715), p = t(979770);
function M(e) {
    let {
            channel: n,
            ChannelIcon: t,
...
function v(e) {
    let {
            ...
            selectedChannelId: t,
            onSelectChannelId: E
        } = e, o = (0, r.e7)([U.Z], () => U.Z.getChannelId()), {guildChannels: u} = (0, r.cj)([A.Z], () => A.Z.getGuildWithoutChangingCommunityRows(n)), d = l.useMemo(() => {
            let e = [];
    ...
    return 0 === d.length ? null : (0, i.jsxs)(i.Fragment, {
        children: [
            (0, i.jsx)('div', { className: a()(H.divider, H.bottomDivider) }),
            (0, i.jsx)(_.Text, {
                variant: 'eyebrow',
...
function x(e) {
    ...
    return 0 === u.length ? (0, i.jsxs)(_.EmptyState, {
        ...
        children: [
            ...
            (0, i.jsx)(_.EmptyStateText, { note: m.Z.Messages.FRIEND_REQUEST_NO_RESULTS_FOUND })
        ]
    }) : (0, i.jsx)(_.List, {
        sections: [u.length],
        sectionHeight: 0,
...
function b(e) {
    let {
        ...
        }), [R]), O = (0, r.e7)([h.Z], () => h.Z.getGuildId()), {analyticsLocations: Z} = (0, c.ZP)(s.Z.CLIPS_SHARE_MODAL);
    async function p(e) {
        let i = null != e ? e : D;
        if (null != i) {
            L(!0);
    ...
    return (0, i.jsxs)(_.ModalRoot, {
        ...
        children: [
            ...
            (0, i.jsx)('div', { className: a()(H.divider, H.topDivider) }),
            (0, i.jsx)(x, {
                searchQuery: C,
                friends: f,
                onShareClip: M,

...
function x(e) {
  let {
    ...
    disabled: E,
    onShareClip: o
  } = e, u = l.useMemo(() => 0 === t.length ? n : n.filter(e => e.username.toLowerCase().includes(t.toLowerCase())), [n, t]), s = (0, r.e7)([L.Z], () => L.Z.theme);
  return 0 === u.length ? (0, i.jsxs)(_.EmptyState, {
    theme: s,
    className: H.emptyStateContainer,
    children: [(0, i.jsx)(_.EmptyStateImage, {
      width: 415,
      height: 75,
      lightSrc: p,
      darkSrc: Z
...
function b(e) {
  let {
    ...
    transitionState: E,
    onClose: d
  } = e, [C, S] = l.useState(""), [A, L] = l.useState(!1), [D, U] = l.useState(null), R = (0, r.Wu)([N.Z], () => N.Z.getFriendIDs()), f = (0, r.Wu)([I.Z, P.default], () => R.map(e => P.default.getUser(e)).filter(g.lm).sort((e, n) => {
    var t, i, l, E;

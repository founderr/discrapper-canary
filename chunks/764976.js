...
class l {
    updateVoiceStates(e, t) {
        t === this.channelId ? (this.totalParticipants.add(e), (this.maxVoiceStateCount = Math.max(a.ZP.countVoiceStatesForChannel(t), this.maxVoiceStateCount))) : (null == t && e in this.totalSpeakers && (this.totalSpeakers[e] = o.Dg.NONE), e === this.userId && null != t && this.setChannelId(t));
    }
    getStats() {
        return {
    ...
    constructor(e, t) {
        s(this, 'userId', void 0), s(this, 'channelId', void 0), s(this, 'maxVoiceStateCount', 1), s(this, 'totalParticipants', void 0), s(this, 'speaking', o.Dg.NONE), s(this, 'maxListenerCount', 0), s(this, 'totalListeners', void 0), s(this, 'maxSpeakerCount', 0), s(this, 'totalSpeakers', void 0), (this.userId = e), this.setChannelId(t);
    }
}

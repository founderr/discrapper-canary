...
function m(e) {
  let {
    channel: t,
    showCall: n
  } = e, m = (0, a.useStateFromStores)([o.default], () => o.default.getSection(t.id, null == t ? void 0 : t.isDM())), p = (0, i.default)(t.getRecipientId()), E = (0, u.default)(), S = m === f.ChannelSections.PROFILE && !E;

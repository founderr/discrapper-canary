...
function m(e) {
  let {
    channel: t,
    showCall: n
  } = e, m = (0, a.useStateFromStores)([u.default], () => u.default.getSection(t.id, null == t ? void 0 : t.isDM())), p = (0, i.default)(t.getRecipientId()), E = (0, o.default)(), g = m === f.ChannelSections.PROFILE && !E;

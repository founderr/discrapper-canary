...
class eL extends a.PureComponent {
  ...
  renderEmbeddedActivity() {
    ...
    return (0, l.jsxs)("div", {
      ...
      children: [(0, l.jsx)(en.default, {
        ...
        }), (0, V.isTextChannel)(a.type) ? u : (0, l.jsx)(eA, {
          timestamps: r
        })]
      })]
    })
  ...
  constructor(...e) {
    super(...e), this.state = {
      ...
      o(null != t, "Channel is null during navigation click"), o(null != n, "Activity null during navigation click"), (0, V.isVoiceChannel)(t.type) && C.default.selectParticipant(t.id, n.applicationId), p.default.channelListScrollTo(null !== (e = t.guild_id) && void 0 !== e ? e : eI.ME, t.id), (0, V.isTextChannel)(t.type) && (0, S.updateActivityPanelMode)(eS.ActivityPanelModes.PANEL)
    }
  }
}
var ev = (0, g.default)(function(e) {
  ...
  let {
    guildId: n,
    ...a
  } = e, s = (0, u.useStateFromStores)([k.default], () => k.default.getId()), i = (0, u.useStateFromStores)([J.default, et.default], () => (0, F.default)(J.default, et.default)), r = (0, u.useStateFromStores)([q.default, Y.default], () => Y.default.getChannel(q.default.getVoiceChannelId())), o = (0, u.useStateFromStores)([_.default], () => _.default.getConnectedActivityChannelId()), c = (0, u.useStateFromStores)([Y.default], () => Y.default.getChannel(o)), [f, h] = (0, u.useStateFromStoresArray)([H.default], () => [H.default.getCurrentUserActiveStream(), H.default.getStreamerActiveStreamMetadata()]), C = (0, u.useStateFromStores)([I.default], () => I.default.useReducedMotion), p = (0, u.useStateFromStores)([O.default], () => O.default.getActivityPanelTooltipAction()), {
    partnerGame: m,
    dropsActivityPanelExperienceBlocked: E,
    showDropsSparkles: g
  } = (0, M.useActivityPanelDrop)(e_.PartnerGame.FORTNITE, i, d.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP, d.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP), S = (0, u.useStateFromStores)([_.default], () => null != c ? _.default.getSelfEmbeddedActivityForChannel(c.id) : null), N = (0, u.useStateFromStores)([W.default, z.default, K.default], () => {
  ...
  }()) && void 0 !== t ? t : ""]), v = (0, u.useStateFromStores)([Z.default], () => (0, U.default)(Z.default) && (0, em.isWindows)()), R = (0, u.useStateFromStores)([X.default], () => null != s ? X.default.findActivity(s, e => e.type === eI.ActivityTypes.PLAYING) : null), y = null != f && f.ownerId === s && f.state !== eI.ApplicationStreamStates.ENDED, D = (0, u.useStateFromStores)([$.default], () => $.default.getBroadcast()), b = (0, L.default)() && null != i, j = (0, u.useStateFromStores)([ee.default, Q.default], () => null != c ? (0, x.computeChannelName)(c, ee.default, Q.default) : void 0), P = (0, u.useStateFromStores)([W.default], () => W.default.getGuild(n));
  return (0, l.jsx)(eL, {
    ...a,
    guildId: n,
    canGoLive: v,

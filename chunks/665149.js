...
let _ = (e) => {
    ...
    p = (e) => {
        let { className: t, innerClassName: n, children: a, childrenBottom: d, toolbar: _, onDoubleClick: h, 'aria-label': p, 'aria-labelledby': m, role: g, scrollable: E, transparent: v = !1 } = e,
            I = i.useRef(null),
            S = i.useContext(c.Z);

...
var n = t(735250), a = t(470079), o = t(990547), l = t(442837), r = t(481060), i = t(809206), d = t(594174), c = t(264119), u = t(75788), _ = t(22150), E = t(361833), N = t(526761), C = t(579500), A = t(800010);
function m(e) {
    var s;
    let {
            transitionState: t,
    ...
    a.useEffect(() => () => (0, i.Zy)(), []);
    let M = null == S ? void 0 : S.verified, x = M ? N.Ax.CONFIRM_START : N.Ax.EMAIL_AND_PASSWORD, [I, R] = a.useState(x), [h, v] = a.useState(null), [O, f] = a.useState(null), [p, j] = a.useState(null), [U, L] = a.useState(''), g = { impression_group: o.ImpressionGroups.USER_ACCOUNT_EMAIL_CHANGE_FLOW };

...
function h(e, t) {
  let {
    reducedMotion: n
  } = i.useContext(s.AccessibilityPreferencesContext), h = (0, o.useIsActiveChannelOrUnarchivableThread)(t), v = (0, l.useStateFromStores)([f.default], () => (t.isPrivate() || f.default.can(I.Permissions.ADD_REACTIONS, t)) && h, [t, h]), _ = (0, u.useEmojiInPriorityOrder)(t.getGuildId());
  if (!c.RenderReactions.getSetting() || !v || e.type === I.MessageTypes.GUILD_INVITE_REMINDER) return null;
  ...
  return (0, a.jsx)(s.MenuItem, {
    ...
    action: () => {
      m.ComponentDispatch.dispatchKeyed(I.ComponentActionsKeyed.TOGGLE_REACTION_POPOUT, e.id, {
        emojiPicker: !0
      })
    },
    color: "default",

...
function T(e, n) {
  let [t, a] = (0, u.Wu)([c.ZP], () => [c.ZP.isChannelMuted(e.guild_id, e.id), c.ZP.getChannelMuteConfig(e.guild_id, e.id)]), s = (0, o.U)(a), Z = (0, _.ZP)(e, !0);

  function T(n) {
    n && e.type === E.d4z.GUILD_CATEGORY && (0, l.c4)(e.id), d.Z.updateChannelOverrideSettings(e.guild_id, e.id, {
      muted: n
    }, M.UE.muted(n))
  }
  ...
  switch (e.type) {
    ...
    case E.d4z.GROUP_DM:
      ...
      break;
    case E.d4z.DM:
      A = N.Z.Messages.MUTE_CHANNEL.format({
        name: Z
      }), U = N.Z.Messages.UNMUTE_CHANNEL.format({
        name: Z
      });
      break;
    default:

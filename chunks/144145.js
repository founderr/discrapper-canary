        ...
        b = (function (e) {
            ...
            return n || !r
                ...
                : (0, i.jsx)(a.MenuItem, {
                      ...
                      label: N.intl.formatToPlainString(N.t.XWSHTU, { platform: A })
                  });
        })(e),
        x = (function (e) {
            let { currentActivities: t } = e,
            ...
            Z.push(
                (function (e, t) {
                    ...
                    return (0, i.jsx)(a.MenuItem, {
                        ...
                        label: t ? N.intl.formatToPlainString(N.t.wFAvxM, { name: l.toString() }) : N.intl.string(N.t.OKsSCQ),
                        action: c
                    });
                })(e, n),
                (function (e, t) {
                    ...
                    let u = c ? N.intl.formatToPlainString(N.t['gBme//'], { name: r.name }) : d ? N.intl.formatToPlainString(N.t.WtSQwM, { name: r.name }) : void 0;
                    return (0, i.jsx)(a.MenuItem, {
                        ...
                        label: t ? N.intl.formatToPlainString(N.t.ZDZEJC, { name: r.name }) : N.intl.string(N.t.XKUw8v),
                        subtext: u
                    });
                })(e, n)
            );

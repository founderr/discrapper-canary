n(47120), n(411104);
var r, i = n(512722), a = n.n(i), o = n(392711), s = n.n(o), l = n(202226), u = n(442837), c = n(570140), d = n(710845), _ = n(358085), E = n(998502), f = n(228488), h = n(981631);
function p(e, t, n) {
...
let m = {}, I = {}, T = {}, g = {}, S = {}, A = new Set(), N = () => b.emitChange(), v = s().debounce(N, 150);
function O(e) {
    let t = T[e];
    null != t && !t.closed && (m[e] = {
        x: t.screenX,
...
function R(e, t, n) {
    let r = e.document, i = ''.concat(window.location.protocol, '//').concat(window.location.host);
    if (!t.startsWith(i))
        return;

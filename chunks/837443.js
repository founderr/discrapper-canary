...
class p extends a.PureComponent {
  ...
  moveStaggered(e) {
    ...
    let d = e.clientX - i,
      c = r[s] + 100 * (d / (u - l));
    if (this.props.equidistant) t = m(c, r);
    else {
  ...
  constructor(e) {
    super(e), this.containerRef = a.createRef(), this.grabberRef = a.createRef(), this.moveGrabber = e => {
      ...
      let {
        left: _,
        width: h
      } = f.getBoundingClientRect(), g = (d - _) / h;
      if (o) {
        let {
          nextClosestMarkerIndex: e
        } = u.reduce((e, t, n) => {
          let i = Math.abs(t / 100 - g);

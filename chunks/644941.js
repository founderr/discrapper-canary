...
var n = s(735250), t = s(470079), r = s(120356), l = s.n(r), i = s(512722), E = s.n(i), c = s(758713), _ = s(442837), o = s(433517), I = s(481060), A = s(224706), d = s(812206), u = s(168551), O = s(485267), R = s(26033), N = s(561308), T = s(669764), m = s(962250), P = s(706454), g = s(768581), L = s(814225), M = s(810568), S = s(998058), G = s(839392), C = s(567409), p = s(774073), f = s(383895), h = s(183391), x = s(689938), v = s(421377);
let Z = 'GameProfileModal', K = e => {
        let {
                game: a,
                onClose: s,
                trackClick: t
            ...
            children: e => {
                ...
                return (0, n.jsx)(I.Clickable, {
                    ...
                    children: (0, n.jsx)('img', {
                        ...
                        alt: x.Z.Messages.GAME_PROFILE_GAME_LOGO_ALT.format({ game: null !== (i = null == r ? void 0 : r.name) && void 0 !== i ? i : null == a ? void 0 : a.name })
                    })
                });
            }
        });
    ...
    }, U = e => e.filter(p.z6).slice(0, 5), F = e => {
        var a, r, i;
        let {
                applicationId: c,
                source: D,
                ...
                transitionState: B,
                onClose: w
            } = e, {clientThemesClassName: b} = (0, u.ZP)(), {
                width: Q,
                height: H
        ...
        let $ = (0, _.Wu)([G.Z], () => {
            ...
            }), ee = (0, _.Wu)([T.Z], () => $.map(e => T.Z.getGame(e)).filter(p.W1).slice(0, 5)), ea = t.useRef([]);
        t.useEffect(() => {
            ea.current = $;
        }, [$]);
        let {entries: es} = (0, C.Z)(), en = t.useMemo(() => {
                var e;
        ...
        let et = d.Z.getApplication(c), er = (0, _.e7)([T.Z], () => T.Z.getGame(c)), el = t.useMemo(() => null == er ? void 0 : er.genres.map(L.P3).join(', '), [er]), ei = t.useMemo(() => {
                if (null == er)
                    return 0;
                let {
                    artwork: e,
                ...
                var e, a;
                let s = (null !== (e = null == er ? void 0 : er.artwork) && void 0 !== e ? e : []).map(e => ({ src: e }));
                return [
                    ...s,
                    ...(null !== (a = null == er ? void 0 : er.screenshots) && void 0 !== a ? a : []).map(e => ({ src: e }))
                ];
            }, [
            ...
            }, {shouldOpenGameProfile: e_} = (0, p.ZP)({
        ...
        if (E()(e_, 'Game Profile was opened when it thinks it shouldn\'t have been.  Make sure to use `useShouldOpenGameProfileModal` before calling `openGameProfileModal`'), null == er)
            return null;
        let eo = null !== (r = er.name) && void 0 !== r ? r : null == et ? void 0 : et.name, eI = null == et ? void 0 : et.getIconURL(160, g.$k ? 'webp' : 'png'), eA = null !== (i = er.coverImageUrl) && void 0 !== i ? i : eI, {
                summary: ed,
                websites: eu,
                publishers: eO,
                platforms: eR
            ...
            children: [
                (0, n.jsxs)('div', {
                    ...
                    children: [
                        ...
                        (0, n.jsx)('div', { className: v.gameHeroGradient })
                    ]
                }),
                (0, n.jsxs)('div', {
                    ...
                    children: [
                        (0, n.jsx)('div', {
                            ...
                            children: null != eA && (0, n.jsx)('img', {
                                className: v.logo,
                                src: eA,
                                alt: x.Z.Messages.GAME_PROFILE_GAME_LOGO_ALT.format({ game: eo })
                            })
                        }),
                        (0, n.jsxs)('div', {
                                                ...
                                                null != eI && (0, n.jsxs)(n.Fragment, {
                                                    children: [
                                                        ...
                                                        (0, n.jsx)('img', {
                                                            src: eI,
                                                            height: 16,
                                                            alt: x.Z.Messages.GAME_PROFILE_GAME_ICON_ALT.format({ game: eo })
                                                        })
                                                    ]
                                                })
                                            ]
                                ...
                                (0, n.jsx)('div', {
                                    children: (0, n.jsx)(I.Tooltip, {
                                        ...
                                        children: e => (0, n.jsxs)(I.Button, {
                                            ...
                                            children: [
                                                eN ? (0, n.jsx)(I.BellSlashIcon, { color: 'white' }) : (0, n.jsx)(I.BellIcon, { color: 'white' }),
                                                ...
                                                children: eE.map((e, a) => (0, n.jsx)(I.Clickable, {
                                                    ...
                                                    onClick: () => {
                                                        ec(M.as.ClickImage), (0, I.openModalLazy)(async () => {
                                                            let {default: e} = await s.e('99857').then(s.bind(s, 895023));
                                                            return s => {
                                                                let {...t} = s;
                                                                return (0, n.jsx)(e, {
                                                    ...
                                                    children: (0, n.jsx)('img', {
                                                        ...
                                                        alt: x.Z.Messages.GAME_PROFILE_GAME_ARTWORK_ALT.format({ game: eo })
                                                    })
                                                }, e.src))
                                            })
                                        ]

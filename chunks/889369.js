t(47120);
var s, l, a, i, r = t(392711), o = t.n(r), c = t(442837), d = t(570140), I = t(45966), N = t(999382), _ = t(981631);
let u = !1, E = null, T = new Set();
function m() {
    (function () {
        u = !1, E = null;
...
class O extends (s = c.ZP.Store) {
    ...
    hasChanges() {
        if (null == E)
            return !1;
        let e = I.Z.getDefaultChannelIds(E).sort(), n = Array.from(T).sort();
...
i = 'GuildSettingsDefaultChannelsStore', (a = 'displayName') in (l = O) ? Object.defineProperty(l, a, {
    value: i,
    enumerable: !0,
    configurable: !0,
    writable: !0

  ...
  let t = C[e],
    n = t.map(e => {
      let t = new I(e),
        n = t.surrogates,
        i = t.uniqueName;
      if (t.setSpriteSheetIndex(t.hasDiversity ? h++ : g++), f[n] = i, 0 > n.indexOf("‍")) {
        let e = n.replace("️", "");
        e !== n && (f[e] = i)
      }
...
var P = {
  ...
  convertShortcutToName: function(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1],
      n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
      i = n;
    return Object.prototype.hasOwnProperty.call(v, e) && (i = v[e]), t ? ":".concat(i, ":") : i
  },

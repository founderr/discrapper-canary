...
t(444675),
    ...
    (i.decode = function (e) {
        ...
        for (; t < r.length; ) {
            ...
            else if ('gAMA' == p) f.tabs[p] = n.readUint(r, t) / 100000;
    ...
    (i.decode._filterZero = function (e, r, t, n, a) {
        ...
        for (var l = 0; l < a; l++) {
            ...
            if (0 == d) for (var v = 0; v < f; v++) e[c + v] = e[u + v];
                ...
                if (3 == d) for (var v = o; v < f; v++) e[c + v] = (e[u + v] + (e[c + v - o] >> 1)) & 255;
                if (4 == d) for (var v = o; v < f; v++) e[c + v] = (e[u + v] + s(e[c + v - o], 0, 0)) & 255;
            } else {
                if (2 == d) for (var v = 0; v < f; v++) e[c + v] = (e[u + v] + e[c + v - f]) & 255;
                if (3 == d) {
        ...
        for (var I = [], u = 0; u < e.length; u++) {
            ...
            if (U <= 256 && !1 == o) {
                for (var H = new Uint8Array((j = Math.ceil((s * T) / 8)) * M), G = 0; G < M; G++) {
                    ...
                    else if (4 == s) for (var F = 0; F < T; F++) H[h + (F >> 1)] |= g[_[K + F]] << (4 - (1 & F) * 4);
                    else if (2 == s) for (var F = 0; F < T; F++) H[h + (F >> 2)] |= g[_[K + F]] << (6 - (3 & F) * 2);
                    else if (1 == s) for (var F = 0; F < T; F++) H[h + (F >> 3)] |= g[_[K + F]] << (7 - (7 & F) * 1);
                }
                (R = H), (f = 3), (l = 1);
    ...
    (i.encode._filterZero = function (e, r, t, n, a) {
        ...
        for (var c, u = 1000000000, d = 0; d < f.length; d++) f[d].length < u && ((c = d), (u = f[d].length));
        return f[c];
    }),
    (i.encode._filterLine = function (e, r, t, n, a, o) {
        var f = t * n,
            s = f + t,
            l = i.decode._paeth;
        if (((e[s] = o), s++, 0 == o)) for (var c = 0; c < n; c++) e[s + c] = r[f + c];
        else if (1 == o) {
            ...
            if (3 == o) for (var c = a; c < n; c++) e[s + c] = (r[f + c] - (r[f + c - a] >> 1) + 256) & 255;
            if (4 == o) for (var c = a; c < n; c++) e[s + c] = (r[f + c] - l(r[f + c - a], 0, 0) + 256) & 255;
        } else {
            if (2 == o) for (var c = 0; c < n; c++) e[s + c] = (r[f + c] + 256 - r[f + c - n]) & 255;
            if (3 == o) {

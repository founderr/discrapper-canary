...
t(444675), a = {}, e.exports = a, n = t(457854), i = a, o = n, i.toRGBA8 = function (e) {
    ...
    for (var a, o = new Uint8Array(r * t * 4), f = 0; f < e.frames.length; f++) {
        var s = e.frames[f], c = s.rect.x, l = s.rect.y, u = s.rect.width, d = s.rect.height, v = i.toRGBA8.decodeImage(s.data, u, d, e);
        if (0 == f ? a = v : 0 == s.blend ? i._copyTile(v, u, d, a, r, t, c, l, 0) : 1 == s.blend && i._copyTile(v, u, d, a, r, t, c, l, 1), n.push(a.buffer), a = a.slice(0), 0 == s.dispose);
            ...
            i._copyTile(o, u, d, a, r, t, c, l, 0);
        else if (2 == s.dispose) {
            for (var h = f - 1; 2 == e.frames[h].dispose;)
                h--;
    ...
    var a = r * t, o = Math.ceil(r * i.decode._getBPP(n) / 8), f = new Uint8Array(4 * a), s = new Uint32Array(f.buffer), c = n.ctype, l = n.depth, u = i._bin.readUshort;
    if (6 == c) {
        var d = a << 2;
        if (8 == l)
            for (var v = 0; v < d; v++)
        ...
        var m = n.tabs.PLTE, A = n.tabs.tRNS, U = A ? A.length : 0;
        if (1 == l)
            for (var I = 0; I < t; I++) {
                for (var R = I * o, S = I * r, v = 0; v < r; v++) {
                    var y = S + v << 2, _ = e[R + (v >> 3)] >> 7 - ((7 & v) << 0) & 1, N = 3 * _;
        ...
        if (2 == l)
            for (var I = 0; I < t; I++) {
                for (var R = I * o, S = I * r, v = 0; v < r; v++) {
                    var y = S + v << 2, _ = e[R + (v >> 2)] >> 6 - ((3 & v) << 1) & 3, N = 3 * _;
                    f[y] = m[N], f[y + 1] = m[N + 1], f[y + 2] = m[N + 2], f[y + 3] = _ < U ? A[_] : 255;
                }
            }
        if (4 == l)
            for (var I = 0; I < t; I++) {
                for (var R = I * o, S = I * r, v = 0; v < r; v++) {
                    var y = S + v << 2, _ = e[R + (v >> 1)] >> 4 - ((1 & v) << 2) & 15, N = 3 * _;
                    f[y] = m[N], f[y + 1] = m[N + 1], f[y + 2] = m[N + 2], f[y + 3] = _ < U ? A[_] : 255;
                }
            }
        if (8 == l)
            for (var v = 0; v < a; v++) {
                var y = v << 2, _ = e[v], N = 3 * _;
                f[y] = m[N], f[y + 1] = m[N + 1], f[y + 2] = m[N + 2], f[y + 3] = _ < U ? A[_] : 255;
            }
    } else if (4 == c) {
        if (8 == l)
            for (var v = 0; v < a; v++) {
                var y = v << 2, T = v << 1, M = e[T];
                f[y] = M, f[y + 1] = M, f[y + 2] = M, f[y + 3] = e[T + 1];
            }
        if (16 == l)
            for (var v = 0; v < a; v++) {
                var y = v << 2, T = v << 2, M = e[T];
        ...
        if (1 == l)
            for (var v = 0; v < a; v++) {
                var M = 255 * (e[v >> 3] >> 7 - (7 & v) & 1), q = M == 255 * p ? 0 : 255;
                s[v] = q << 24 | M << 16 | M << 8 | M;
            }
        if (2 == l)
            for (var v = 0; v < a; v++) {
                var M = 85 * (e[v >> 2] >> 6 - ((3 & v) << 1) & 3), q = M == 85 * p ? 0 : 255;
                s[v] = q << 24 | M << 16 | M << 8 | M;
            }
        if (4 == l)
            for (var v = 0; v < a; v++) {
                var M = 17 * (e[v >> 1] >> 4 - ((1 & v) << 2) & 15), q = M == 17 * p ? 0 : 255;
                s[v] = q << 24 | M << 16 | M << 8 | M;
            }
        if (8 == l)
            for (var v = 0; v < a; v++) {
                var M = e[v], q = M == p ? 0 : 255;
                s[v] = q << 24 | M << 16 | M << 8 | M;
            }
        if (16 == l)
            for (var v = 0; v < a; v++) {
                var M = e[v << 1], q = u(e, v << 1) == p ? 0 : 255;
                s[v] = q << 24 | M << 16 | M << 8 | M;
            }
    }
    return f;
    ...
    for (var r = new Uint8Array(e), t = 8, n = i._bin, a = n.readUshort, o = n.readUint, f = {
                tabs: {},
                frames: []
            }, s = new Uint8Array(r.length), c = 0, l, u = 0, d = [
                137,
                80,
                78,
                71,
    ...
    for (; t < r.length;) {
        ...
        if (t += 4, 'IHDR' == p)
            ...
            var b = {
                    ...
                    rect: b,
                    delay: Math.round(1000 * (y = a(r, t + 20) / (0 == y ? 100 : y))),
                    dispose: r[t + 24],
                    blend: r[t + 25]
                };
            f.frames.push(w);
            ...
            var m = n.nextZero(r, t), A = n.readASCII(r, t, m - t), U = n.readASCII(r, m + 1, t + h - m - 1);
            f.tabs[p][A] = U;
        } else if ('iTXt' == p) {
            null == f.tabs[p] && (f.tabs[p] = {});
            var m = 0, I = t;
            ...
            f.tabs[p] = [];
            for (var v = 0; v < R; v++)
                f.tabs[p].push(a(r, t + 2 * v));
        } else if ('tRNS' == p)
            3 == f.ctype ? f.tabs[p] = n.readBytes(r, t, h) : 0 == f.ctype ? f.tabs[p] = a(r, t) : 2 == f.ctype && (f.tabs[p] = [
                a(r, t),
                a(r, t + 2),
                a(r, t + 4)
            ]);
        else if ('gAMA' == p)
            f.tabs[p] = n.readUint(r, t) / 100000;
        else if ('sRGB' == p)
            f.tabs[p] = r[t];
        else if ('bKGD' == p)
            0 == f.ctype || 4 == f.ctype ? f.tabs[p] = [a(r, t)] : 2 == f.ctype || 6 == f.ctype ? f.tabs[p] = [
                a(r, t),
                a(r, t + 2),
                a(r, t + 4)
    ...
    for (var t = r.width, n = r.height, a = i.decode._getBPP(r), o = a >> 3, f = Math.ceil(t * a / 8), s = new Uint8Array(n * f), c = 0, l = [
                0,
                0,
                4,
                0,
        ...
        for (var p = d[h], g = v[h], b = 0, y = 0, w = l[h]; w < n;)
            w += p, y++;
        for (var m = u[h]; m < t;)
            m += g, b++;
    ...
    var o = i.decode._getBPP(r), f = Math.ceil(n * o / 8), s = i.decode._paeth;
    o = Math.ceil(o / 8);
    for (var c = 0; c < a; c++) {
        var l = t + c * f, u = l + c + 1, d = e[u - 1];
        if (0 == d)
            for (var v = 0; v < f; v++)
                e[l + v] = e[u + v];
        else if (1 == d) {
            ...
            if (3 == d)
                for (var v = o; v < f; v++)
                    e[l + v] = e[u + v] + (e[l + v - o] >> 1) & 255;
            if (4 == d)
                for (var v = o; v < f; v++)
                    e[l + v] = e[u + v] + s(e[l + v - o], 0, 0) & 255;
        } else {
            if (2 == d)
                for (var v = 0; v < f; v++)
                    e[l + v] = e[u + v] + e[l + v - f] & 255;
            if (3 == d) {
                for (var v = 0; v < o; v++)
                    e[l + v] = e[u + v] + (e[l + v - f] >> 1) & 255;
                for (var v = o; v < f; v++)
                    e[l + v] = e[u + v] + (e[l + v - f] + e[l + v - o] >> 1) & 255;
            }
            if (4 == d) {
                for (var v = 0; v < o; v++)
                    e[l + v] = e[u + v] + s(0, e[l + v - f], 0) & 255;
                for (var v = o; v < f; v++)
                    e[l + v] = e[u + v] + s(e[l + v - o], e[l + v - f], e[l + v - o - f]) & 255;
            }
        }
    }
    return e;
}, i.decode._paeth = function (e, r, t) {
    var n = e + r - t, a = Math.abs(n - e), i = Math.abs(n - r), o = Math.abs(n - t);
    ...
    for (var c = Math.min(r, a), l = Math.min(t, i), u = 0, d = 0, v = 0; v < l; v++)
        for (var h = 0; h < c; h++)
            if (o >= 0 && f >= 0 ? (u = v * r + h << 2, d = (f + v) * a + o + h << 2) : (u = (-f + v) * r - o + h << 2, d = v * a + h << 2), 0 == s)
                n[d] = e[u], n[d + 1] = e[u + 1], n[d + 2] = e[u + 2], n[d + 3] = e[u + 3];
            else if (1 == s) {
                var p = e[u + 3] * (1 / 255), g = e[u] * p, b = e[u + 1] * p, y = e[u + 2] * p, w = n[d + 3] * (1 / 255), m = n[d] * w, A = n[d + 1] * w, U = n[d + 2] * w, I = 1 - p, R = p + w * I, S = 0 == R ? 0 : 1 / R;
                n[d + 3] = 255 * R, n[d + 0] = (g + m * I) * S, n[d + 1] = (b + A * I) * S, n[d + 2] = (y + U * I) * S;
            } else if (2 == s) {
                var p = e[u + 3], g = e[u], b = e[u + 1], y = e[u + 2], w = n[d + 3], m = n[d], A = n[d + 1], U = n[d + 2];
    ...
    for (var f = new Uint8Array(e[0].byteLength * e.length + 100), s = [
                137,
                80,
                78,
                71,
        ...
        f[c] = s[c];
    var l = 8, u = i._bin, d = i.crc.crc, v = u.writeUint, h = u.writeUshort, p = u.writeASCII, g = i.encode.compressPNG(e, r, t, n, o);
    ...
    if (b && (v(f, l, 8), p(f, l += 4, 'acTL'), v(f, l += 4, e.length), v(f, l += 4, 0), v(f, l += 4, d(f, l - 12, 12)), l += 4), 3 == g.ctype) {
        ...
        for (var c = 0; c < y; c++) {
            var w = 3 * c, m = g.plte[c], A = 255 & m, U = m >> 8 & 255, I = m >> 16 & 255;
            f[l + w + 0] = A, f[l + w + 1] = U, f[l + w + 2] = I;
        }
        if (v(f, l += 3 * y, d(f, l - 3 * y - 4, 3 * y + 4)), l += 4, g.gotAlpha) {
            v(f, l, y), p(f, l += 4, 'tRNS'), l += 4;
            for (var c = 0; c < y; c++)
                f[l + c] = g.plte[c] >> 24 & 255;
            v(f, l += y, d(f, l - y - 4, y + 4)), l += 4;
        }
    }
    for (var R = 0, S = 0; S < g.frames.length; S++) {
        var _ = g.frames[S];
        b && (v(f, l, 26), p(f, l += 4, 'fcTL'), v(f, l += 4, R++), v(f, l += 4, _.rect.width), v(f, l += 4, _.rect.height), v(f, l += 4, _.rect.x), v(f, l += 4, _.rect.y), h(f, l += 4, a[S]), h(f, l += 2, 1000), f[l += 2] = _.dispose, f[++l] = _.blend, v(f, ++l, d(f, l - 30, 30)), l += 4);
        var N = _.cimg, y = N.length;
        v(f, l, y + (0 == S ? 0 : 4));
        var T = l += 4;
    ...
    for (var o = i.encode.compress(e, r, t, n, !1, a), f = 0; f < e.length; f++) {
        var s = o.frames[f], c = (s.rect.width, s.rect.height), l = s.bpl, u = s.bpp, d = new Uint8Array(c * l + c);
    ...
    for (var f = 6, s = 8, c = 4, l = 255, u = 0; u < e.length; u++) {
        for (var d = new Uint8Array(e[u]), v = d.length, h = 0; h < v; h += 4)
            l &= d[h + 3];
    }
    var p = 255 != l, g = {}, b = [];
    if (0 != e.length && (g[0] = 0, b.push(0), 0 != n && n--), 0 != n) {
        ...
        for (var u = 0; u < e.length; u++) {
            for (var m = new Uint32Array(e[u]), v = m.length, h = 0; h < v; h++) {
                var w = m[h];
                if ((h < r || w != m[h - 1] && w != m[h - r]) && null == g[w] && (g[w] = b.length, b.push(w), b.length >= 300))
                    break;
            }
        }
    var A = !!p && a, U = b.length;
    U <= 256 && !1 == o && (s = U <= 2 ? 1 : U <= 4 ? 2 : U <= 16 ? 4 : 8, a && (s = 8), p = !0);
    for (var I = [], u = 0; u < e.length; u++) {
        var R = new Uint8Array(e[u]), S = new Uint32Array(R.buffer), _ = 0, N = 0, T = r, M = t, q = 0;
        if (0 != u && !A) {
            for (var x = a || 1 == u || 2 == I[I.length - 2].dispose ? 1 : 2, E = 0, D = 1000000000, C = 0; C < x; C++) {
        ...
        if (U <= 256 && !1 == o) {
            for (var H = new Uint8Array((j = Math.ceil(s * T / 8)) * M), G = 0; G < M; G++) {
                ...
                if (8 == s)
                    ...
                    for (var F = 0; F < T; F++)
                        H[h + (F >> 1)] |= g[S[K + F]] << 4 - (1 & F) * 4;
                else if (2 == s)
                    for (var F = 0; F < T; F++)
                        H[h + (F >> 2)] |= g[S[K + F]] << 6 - (3 & F) * 2;
                else if (1 == s)
                    for (var F = 0; F < T; F++)
                        H[h + (F >> 3)] |= g[S[K + F]] << 7 - (7 & F) * 1;
            }
            R = H, f = 3, c = 1;
    ...
    for (var f = [], s = 0; s < 5; s++)
        if (!(r * n > 500000) || 2 != s && 3 != s && 4 != s) {
            for (var c = 0; c < r; c++)
                i.encode._filterLine(a, e, c, n, t, s);
            if (f.push(o.deflate(a)), 1 == t)
                break;
        }
    for (var l, u = 1000000000, d = 0; d < f.length; d++)
        f[d].length < u && (l = d, u = f[d].length);
    return f[l];
}, i.encode._filterLine = function (e, r, t, n, a, o) {
    var f = t * n, s = f + t, c = i.decode._paeth;
    if (e[s] = o, s++, 0 == o)
        for (var l = 0; l < n; l++)
            e[s + l] = r[f + l];
    else if (1 == o) {
        ...
        if (3 == o)
            for (var l = a; l < n; l++)
                e[s + l] = r[f + l] - (r[f + l - a] >> 1) + 256 & 255;
        if (4 == o)
            for (var l = a; l < n; l++)
                e[s + l] = r[f + l] - c(r[f + l - a], 0, 0) + 256 & 255;
    } else {
        if (2 == o)
            for (var l = 0; l < n; l++)
                e[s + l] = r[f + l] + 256 - r[f + l - n] & 255;
        if (3 == o) {
            for (var l = 0; l < a; l++)
                e[s + l] = r[f + l] + 256 - (r[f + l - n] >> 1) & 255;
            for (var l = a; l < n; l++)
                e[s + l] = r[f + l] + 256 - (r[f + l - n] + r[f + l - a] >> 1) & 255;
        }
        if (4 == o) {
            for (var l = 0; l < a; l++)
                e[s + l] = r[f + l] + 256 - c(0, r[f + l - n], 0) & 255;
            for (var l = a; l < n; l++)
                e[s + l] = r[f + l] + 256 - c(r[f + l - a], r[f + l - n], r[f + l - a - n]) & 255;
        }
    }
}, i.crc = {
    table: function () {
    ...
    for (var n = [], a = 0, o = 0; o < e.length; o++)
        n.push(i.encode.alphaMul(new Uint8Array(e[o]), t)), a += e[o].byteLength;
    for (var f = new Uint8Array(a), s = new Uint32Array(f.buffer), c = 0, o = 0; o < n.length; o++) {
        for (var l = n[o], u = l.length, d = 0; d < u; d++)
            f[c + d] = l[d];
        c += u;
    }
    var v = {
    ...
    for (var h = [v]; h.length < r;) {
        ...
        if (p < 0.001)
            break;
        var b = h[g], y = i.quantize.splitPixels(f, s, b.i0, b.i1, b.est.e, b.est.eMq255), w = {
                i0: b.i0,
                i1: y,
                bst: null,
                est: null,
        ...
        for (var o = 0; o < 16; o++)
            m.bst.R[o] = b.bst.R[o] - w.bst.R[o];
        for (var o = 0; o < 4; o++)
            m.bst.m[o] = b.bst.m[o] - w.bst.m[o];
    ...
    for (var A = 0; A < n.length; A++) {
        for (var U = i.quantize.planeDst, I = new Uint8Array(n[A].buffer), R = new Uint32Array(n[A].buffer), S = I.length, o = 0; o < S; o += 4) {
            for (var _ = I[o] * (1 / 255), N = I[o + 1] * (1 / 255), T = I[o + 2] * (1 / 255), M = I[o + 3] * (1 / 255), q = v; q.left;)
                q = 0 >= U(q.est, _, N, T, M) ? q.left : q.right;
            R[o >> 2] = q.est.rgba;
        }
        n[A] = R.buffer;
    }
    ...
    var o = i.quantize.planeDst(e.est, r, t, n, a), f = e.left, s = e.right;
    ...
    var i = r - e[0], o = t - e[1], f = n - e[2], s = a - e[3];
    ...
    for (var n = [
        ...
        var o = e[i] * (1 / 255), f = e[i + 1] * (1 / 255), s = e[i + 2] * (1 / 255), c = e[i + 3] * (1 / 255);
    ...
    var r = e.R, t = e.m, n = e.N, a = t[0], o = t[1], f = t[2], s = t[3], c = 0 == n ? 0 : 1 / n, l = [
            r[0] - a * a * c,
            r[1] - a * o * c,
            r[2] - a * f * c,
            r[3] - a * s * c,
    ...
    var g = [
            ...
            f * c,
            s * c
        ], b = u.dot(u.sml(255, g), d), y = g[3] < 0.001 ? 0 : 1 / g[3];
    return {
        Cov: l,
        q: g,
        e: d,

...
function U(e) {
  !M.has(e) && (M.add(e), _()(f.Z.getMutableGuildChannelsForGuild(e)).values().forEach(e => {
    w(e) && D.set(e.id, e)
  }))
}
...
function G(e) {
  let t = P[e];
  return null == t && (t = new g.ZP(e), P[e] = t, t.rebuild()), t
}
...
class K extends(i = c.ZP.Store) {
  initialize() {
    this.waitFor(h.default, O.default, f.Z, m.Z, R.Z, A.Z, p.ZP, S.Z, C.ZP, N.Z, v.Z, T.Z)
  }
  ...
  getChannels(e) {
    return U(null != e ? e : L), D.values(null != e ? e : L)
  }
  getChannelsVersion() {
    return D.version
  }

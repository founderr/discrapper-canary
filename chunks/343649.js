...
function en(e) {
    let n, {
            ...
            blockedPayments: eu
        } = (0, N.usePaymentContext)(), ed = (0, d.e7)([k.ZP], () => k.ZP.hasFetchedSubscriptions()), ep = null != ec ? ec.paymentSourceId : null, e_ = (0, d.e7)([U.Z], () => null != ec ? (0, w.oE)(ec.planId) : null), eE = (0, d.e7)([U.Z], () => null == ec || null != U.Z.get(ec.planId)), ef = (0, d.e7)([U.Z], () => null == e_ ? U.Z.get(q) : e_), eI = (0, d.e7)([x.Z], () => x.Z.theme), eS = l.useRef((0, j.vx)(v.Z.boostSlots)).current, eC = (0, d.e7)([Z.Z], () => Z.Z.defaultPaymentSourceId), eP = (0, O.fL)(null != ep ? ep : ed ? eC : null), {
            paymentSources: eh,
            setPurchaseError: em,
            paymentSourceId: eN,
        ...
        } = eP, ex = Object.keys(eh).length > 0, [ey, ev] = l.useState(el - eS.length), [eb, eZ] = l.useState(!1), eU = (0, d.e7)([b.Z], () => b.Z.popupCallbackCalled), ek = (0, h.V)(), eD = l.useMemo(() => null != ec && eE && ek ? (0, R.g)(ec, ey) : [{
            ...
            (0, u.Z)(),
            Date.now()
        ]), {analyticsLocations: eG} = (0, P.ZP)(f, C.Z.GUILD_BOOST_PURCHASE_MODAL), eY = l.useMemo(() => {
            var e, n;
            return {
                load_id: eB,
    ...
    if (eu)
        ...
        if (null == ec ? void 0 : ec.isPausedOrPausePending)
                ...
                i()(null != er, 'Missing guildId'), i()(null != ef, 'Missing nextPremiumSubscriptionPlan'), e = (0, o.jsx)(F.CP, {
                    ...
                    children: [
                        (0, o.jsx)(_.FormErrorBlock, {
                            ...
                            children: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_EXTERNAL.format({ paymentGatewayName: V.Vz[ec.paymentGateway] })
                        }),
                        e
                    ]
                })), r = (0, o.jsx)(_.Button, {
            ...
            case A.h8.AWAITING_AUTHENTICATION:
                e = (0, o.jsx)(I.F, { className: X.__invalid_body });
                break;
            case A.h8.REVIEW:
                i()(null != ef, 'Missing nextPremiumSubscriptionPlan'), e = (0, o.jsx)(F.Gq, {
                    ...
                    children: e => (0, o.jsx)(_.Button, {
                        ...
                        color: _.Button.Colors.GREEN,
                        onClick: () => {
                            null != e0.current && (e0.current.scrollIntoView({ behavior: 'smooth' }), e7(!0));
                        },
                        type: 'submit',
                        children: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_SUBMIT
                    })
...
function et(e) {
    let n = (0, d.e7)([k.ZP], () => k.ZP.getPremiumTypeSubscription()), {analyticsLocations: t} = (0, P.ZP)(C.Z.GUILD_BOOST_PURCHASE_MODAL);
    return (0, o.jsx)(P.Gt, {
        value: t,

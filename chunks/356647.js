...
function m(e, t) {
    let n = (function (e, t) {
        ...
        if (null == e.applicationId || !t.isDM() || e.author.id === s.default.getId() || (0, a.yE)(null !== (n = t.recipientFlags) && void 0 !== n ? n : 0, i.V.DISMISSED_IN_GAME_MESSAGE_NUX) || d.has(t.id)) return null;
        let c = l.Z.getApplication(e.applicationId);
        if (null == c || !(0, a.yE)(c.flags, u.udG.SOCIAL_LAYER_INTEGRATION)) return null;
        let m = h(e, t.id);
        d.set(t.id, e.id);
        let p = (0, a.mB)(null !== (o = t.recipientFlags) && void 0 !== o ? o : 0, i.V.DISMISSED_IN_GAME_MESSAGE_NUX, !0);

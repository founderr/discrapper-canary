...
var i = function (e) {
        ...
        function t() {
            ...
            return (t = e.call.apply(e, [this].concat(o)) || this).container = void 0, t.timer = void 0, t.state = {
                ...
                var e;
                t.props.inject && (e = a, !Array.from(document.scripts).reduce(function (t, n) {
                    return t || e.test(n.src);
                }, !1)) && i('https://recaptcha.net/recaptcha/api.js?render=explicit' + (t.props.hl ? '&hl=' + t.props.hl : ''));
            }, t._prepare = function () {
                var e = t.props, n = e.explicit, r = e.onLoad;
                ...
                return new Promise(function (e, n) {
                    if (t.state.rendered)
                        return n(Error('This recaptcha instance has been already rendered.'));
                    if (!t.state.ready || !t.container)
                        return n(Error('Recaptcha is not ready for rendering yet.'));

...
function F(e) {
  ...
  let {
    ...
    setPopout: H
  } = (0, C.default)(F.id, j.DEFAULT_POPOUTS), V = (0, S.useContextMenuMessage)(F, k, H, !0), Y = g.GifAutoPlay.useSetting(), W = (0, D.useIsWindowFocused)(), [K, z] = a.useState(!1), [Q, q] = a.useState((null == w ? void 0 : w.coverImage) == null), J = (0, c.useStateFromStores)([f.default], () => f.default.useReducedMotion), Z = (0, c.useStateFromStores)([M.default, O.default], () => {
    var e;
    ...
    null != w && ((0, T.trackWithMetadata)(U.AnalyticEvents.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
      ...
      is_member: Z
    }), w.canAccess ? (0, p.default)(U.Routes.CHANNEL(w.guildId, w.threadId, w.messageId)) : Z ? (0, p.default)(U.Routes.CHANNEL(w.guildId, w.parentChannelId)) : await P.startLurking(w.guildId, {}, {
      channelId: w.parentChannelId
    }))
  }, [w, k, Z]), ei = a.useCallback(() => (o()((null == w ? void 0 : w.authorId) != null, "Author Id cannot be null when loading user profile"), (0, A.default)(w.authorId, w.avatarUrl, {
    guildId: w.guildId,
    channelId: k.id
  })), [w, k]);
  ...
  let er = (e, t) => (o()(null != w.authorId, "Author Id cannot be null when rendering user popout"), (0, s.jsx)(h.default, {
    ...
    ec = w.coverImage,
    eE = null != ec && (0, N.isAnimatedImageUrl)(ec);
  return (0, s.jsxs)("div", {

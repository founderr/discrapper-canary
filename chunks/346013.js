...
function y(e) {
  ...
  let {
    ...
    setPopout: G
  } = (0, C.Z)(y.id, b.d$), F = (0, p.qo)(y, B, G, !0), w = A.QK.useSetting(), V = (0, v.n)(), [H, Y] = a.useState(!1), [W, z] = a.useState((null == k ? void 0 : k.coverImage) == null), K = (0, u.e7)([E.Z], () => E.Z.useReducedMotion), Q = (0, u.e7)([R.ZP, O.default], () => {
    var e;
  ...
  }, [k, B, Q]), es = a.useCallback(() => (o()((null == k ? void 0 : k.authorId) != null, "Author Id cannot be null when loading user profile"), (0, g.W)(k.authorId, k.avatarUrl, {
    guildId: k.guildId,
    channelId: B.id
  })), [k, B]);
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [null != eo && (0, i.jsx)(_.Popout, {
          ...
          children: [(0, i.jsxs)("div", {
            ...
            children: [null != k.channelName && (0, i.jsx)(_.ImageSparkleIcon, {
              size: "md",
              color: "currentColor",

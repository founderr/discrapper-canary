...
function k(e) {
  ...
  let {
    ...
    setPopout: H
  } = (0, C.default)(k.id, j.DEFAULT_POPOUTS), V = (0, S.useContextMenuMessage)(k, F, H, !0), Y = g.GifAutoPlay.useSetting(), K = (0, D.useIsWindowFocused)(), [W, z] = l.useState(!1), [Q, q] = l.useState((null == w ? void 0 : w.coverImage) == null), J = (0, c.useStateFromStores)([f.default], () => f.default.useReducedMotion), Z = (0, c.useStateFromStores)([M.default, O.default], () => {
    var e;
    ...
    reducedMotion: ee
  } = l.useContext(E.AccessibilityPreferencesContext), [et, en] = l.useState(!1), es = l.useCallback(() => {
    z(!0)
  }, [z]), el = l.useCallback(() => {
    z(!1)
  }, [z]), ea = l.useCallback(async () => {
  ...
  }, [w, F, Z]), ei = l.useCallback(() => (o()((null == w ? void 0 : w.authorId) != null, "Author Id cannot be null when loading user profile"), (0, A.default)(w.authorId, w.avatarUrl, {
    guildId: w.guildId,
    channelId: F.id
  })), [w, F]);
          ...
          children: [(0, s.jsxs)("div", {
            ...
            children: [null != w.channelName && (0, s.jsx)(v.default, {
              ...
              children: (0, s.jsx)(E.Heading, {
                ...
                children: null !== (a = w.channelName) && void 0 !== a ? a : w.guildName
              })
            })]

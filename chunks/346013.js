...
function y(e) {
    ...
    let {
            ...
            message: y,
            channel: B
        } = e, k = (0, Z.J)(l, y), {setPopout: G} = (0, C.Z)(y.id, b.d$), F = (0, p.qo)(y, B, G, !0), w = A.QK.useSetting(), V = (0, v.n)(), [H, Y] = a.useState(!1), [W, z] = a.useState((null == k ? void 0 : k.coverImage) == null), K = (0, u.e7)([E.Z], () => E.Z.useReducedMotion), Q = (0, u.e7)([
            x.ZP,
            R.default
        ], () => {
            var e;
        ...
        }, [q]), {reducedMotion: $} = a.useContext(_.AccessibilityPreferencesContext), [ee, et] = a.useState(!1), en = a.useCallback(() => {
            Y(!0);
        }, [Y]), ei = a.useCallback(() => {
            Y(!1);
            ...
            null != k && ((0, m.yw)(P.rMx.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
                ...
                is_member: Q
            }), k.canAccess ? (0, N.Z)(P.Z5c.CHANNEL(k.guildId, k.threadId, k.messageId)) : Q ? (0, N.Z)(P.Z5c.CHANNEL(k.guildId, k.parentChannelId)) : await M.Ub(k.guildId, {}, { channelId: k.parentChannelId }));
        }, [
            k,
            B,
            Q

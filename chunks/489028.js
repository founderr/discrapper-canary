...
function M(e) {
  ...
  } = (0, N.JH)(), I = (0, S.mY)(), T = a.useMemo(() => n.map(e => ({
    label: e.name,
    value: e.id
  })), [n]), m = async () => {
...
t.Z = e => {
  let {
    guild: t
  } = e, n = (0, i.e7)([E.default], () => E.default.getCurrentUser()), c = t.isOwner(n), N = (0, o.Ob)(t), S = (0, i.e7)([I.Z], () => I.Z.isFocused()), {
    teams: h,
    loading: x
  } = (0, _.Z)({
  ...
  }), [h, n]), v = R.length > 0, D = a.useCallback(async () => {
    ...
    (0, l.Z)(e)
  }, [t, c, N, v]), j = a.useCallback(e => c ? (0, s.jsx)(T.Z, {
    onClick: D,
    children: e
  }) : e, [D, c]);
  return x ? (0, s.jsx)(r.Spinner, {}) : (0, s.jsxs)(s.Fragment, {
    children: [!c && (0, s.jsx)(g.Z, {

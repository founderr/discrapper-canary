...
function l(e) {
    ...
    let { defaultFilter: h, menuTrigger: p = 'input', allowsEmptyCollection: m = !1, allowsCustomValue: g, shouldCloseOnBlur: E = !0 } = e,
        ...
        k = (t, n) => {
            ...
            (m || L.size > 0 || (r && T.size > 0) || e.items) && (r && !P.isOpen && void 0 === e.items && I(!0), (M.current = n), P.open(t));
        },
        U = (0, a.useCallback)(
            (e) => {
    ...
    let H = () => {
        ...
        Y = () => {
            if (g) {
                var e, t;
                O === (null !== (t = null === (e = T.getItem(A)) || void 0 === e ? void 0 : e.textValue) && void 0 !== t ? t : '') ? j() : H();
            } else j();
        },
    ...
    return {
        ...
        toggle: (t, n) => {
            let r = 'manual' === n || ('focus' === n && 'focus' === p);
            (m || L.size > 0 || (r && T.size > 0) || e.items || P.isOpen) && (r && !P.isOpen && void 0 === e.items && I(!0), !P.isOpen && (M.current = n), U(t));
        },
        open: k,
        close: Y,
        selectionManager: y,
        ...
        isFocused: S,
        setFocused: (e) => {
            e ? 'focus' === p && k(null, 'focus') : E && Y(), b(e);
        },
        selectedItem: C,
        collection: W,
        inputValue: O,
        setInputValue: D,
        commit: () => {
            P.isOpen && null != y.focusedKey ? (A === y.focusedKey ? j() : N(y.focusedKey)) : Y();
        },
        revert: () => {
            g && null == A ? H() : j();
        }

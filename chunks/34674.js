...
size: (0, a.oO)(parseFloat(l.Z.APPLICATION_DIRECTORY_CONTENT_MAX_WIDTH) * (0, a.x_)()).toString()
  }).toString(), r = o.$k ? 'webp' : 'png';
  return null != p ? ''.concat(location.protocol, '//').concat(p, '/app-assets/application-directory/collection-items/').concat(t, '/').concat(n, '.').concat(r, '?').concat(i) : ''.concat(location.protocol).concat(h).concat(c.ANM.APPLICATION_DIRECTORY_COLLECTION_ITEM_IMAGE(t, n, r), '?').concat(i);
}

...
t.ZP = s.memo(function(e) {
  let {
    ...
    let s = (0, h.e7)([N.ZP], () => N.ZP.getCurrentSidebarChannelId(i.parent_id) === i.id),
      {
        firstMessage: o
      } = (0, B.cl)(i),
      {
...
function eo(e) {
  ...
  return (0, i.jsxs)("div", {
    className: $.footer,
    children: [a || null == s ? null : (0, i.jsx)(el, {
      firstMessage: s,
      channel: t

let r, i, a;
n(47120);
var o, s, l, u, c = n(392711), d = n(442837), _ = n(570140);
let E = new Map(), f = E, h = !1;
...
u = 'CollectiblesPurchaseStore', (l = 'displayName') in (s = p) ? Object.defineProperty(s, l, {
    ...
    COLLECTIBLES_PURCHASES_FETCH_SUCCESS: e => {
        0 === e.purchases.length ? f = E : !(0, c.isEqual)([...f.values()], e.purchases) && (f = new Map(e.purchases.map(e => [
            e.skuId,
            e
        ]))), h = !1, i = void 0;
    },
    ...
    COLLECTIBLES_CLAIM_SUCCESS: e => {
        null == e.purchases || 0 === e.purchases.length ? f = E : !(0, c.isEqual)([...f.values()], e.purchases) && (f = new Map(e.purchases.map(e => [
            e.skuId,
            e
        ]))), r = void 0, a = void 0;
    },

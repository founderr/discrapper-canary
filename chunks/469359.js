...
t = u(e, !0);
  s.m.document.addEventListener('click', t, !1), s.m.document.addEventListener('keypress', t, !1), [
'EventTarget',
'Node'
  ].forEach(t => {
...
if (i = r.type, c = I, 'keypress' === i && (!c || !c.tagName || 'INPUT' !== c.tagName && 'TEXTAREA' !== c.tagName && !c.isContentEditable))
  return;
...
! function(e) {
  ...
  name: u,
  global: t
}), a = r.type, o = I ? I._sentryId : void 0), clearTimeout(n), n = s.m.setTimeout(() => {
  o = void 0, a = void 0;
}, 1000);
  };
}
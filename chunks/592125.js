...
function W(e) {
    if ((v.fileOnly('Deleting guild channels for '.concat(e)), null != L[e])) {
        for (let t of S.default.keys(L[e])) delete y[t];
        delete L[e];
    }
}
function K(e) {
...
class el extends (r = c.ZP.Store) {
    ...
    getChannelIds(e) {
        var t, n;
        return (Y(e, 0, 'getChannelIds'), null == e) ? S.default.keys(D) : S.default.keys(null !== (n = null !== (t = h.Z.getGuildBasicChannels(e)) && void 0 !== t ? t : L[e]) && void 0 !== n ? n : C);
    }

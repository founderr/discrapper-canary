...
function Y(e, t, n) {
    ...
    let [a, s] = i;
    for (let n of ((0, p.ZP)(a), 0 !== t && (H += 1), G.add(e), h.Z.restored(e), u.Z.mark('\u2757', 'loaded guild channels (guild: '.concat(e, ')'), s), a)) !Object.hasOwn(y, n.id) && $((0, T._H)(n));
    v.verbose('hydration complete (guild: '.concat(e, ', channels: ').concat(a.length, ', guilds_loaded: ').concat(H, ')'));
}
function j(e, t, n) {
    if (!Object.hasOwn(y, e) && !Object.hasOwn(D, e) && !Object.hasOwn(M, e) && !Object.hasOwn(x, e) && 1 === t) {
        let r = h.Z.getBasicChannel(e);
        (null == r ? void 0 : r.guild_id) != null && Y(r.guild_id, t, n);
    }
}
function W(e) {
    if ((v.fileOnly('Deleting guild channels for '.concat(e)), null != L[e])) {
        for (let t of g.default.keys(L[e])) delete y[t];
        delete L[e];
    }
}
function K(e) {
    var t, n, r, i;
    return j(e, 0, 'getBasicChannel'), null !== (i = null !== (r = null !== (n = null !== (t = y[e]) && void 0 !== t ? t : D[e]) && void 0 !== n ? n : M[e]) && void 0 !== r ? r : x[e]) && void 0 !== i ? i : h.Z.getBasicChannel(e);
}
function z(e) {
    var t, n, r, i;
    return j(e, 1, 'getChannel'), null !== (i = null !== (r = null !== (n = null !== (t = y[e]) && void 0 !== t ? t : D[e]) && void 0 !== n ? n : M[e]) && void 0 !== r ? r : x[e]) && void 0 !== i ? i : F[e];
}
function q(e) {
    e.isPrivate()
        ? (delete F[e.id], Q(e))
...
function $(e) {
    ...
    (y[r] = e), (L[i] = null !== (t = L[i]) && void 0 !== t ? t : {}), (L[i][r] = e), (w[i] = (null !== (n = w[i]) && void 0 !== n ? n : 0) + 1);
}
function J(e) {
    ...
    if (null != e.channelUpdates) {
        ...
        for (let n of ((t.writes.length > 0 || t.deletes.length > 0) && h.Z.invalidate(e.id), t.deletes)) en(y[n]);
...
function en(e) {
    ...
    e.id in D && delete D[e.id],
        ...
        null != t && null != L[t] && e.id in L[t] && delete L[t][e.id],
        !(function (e) {
...
function er(e) {
    var t, n;
    let { channel: r } = e,
        i = null !== (n = null !== (t = y[r.id]) && void 0 !== t ? t : D[r.id]) && void 0 !== n ? n : M[r.id];
    if (null == i) return !1;
    en(i),
        !(function (e) {
...
class el extends (r = c.ZP.Store) {
    ...
    getChannelIds(e) {
        var t, n;
        return (Y(e, 0, 'getChannelIds'), null == e) ? g.default.keys(D) : g.default.keys(null !== (n = null !== (t = h.Z.getGuildBasicChannels(e)) && void 0 !== t ? t : L[e]) && void 0 !== n ? n : C);
    }
    ...
    getMutableBasicGuildChannelsForGuild(e) {
        var t, n;
        return Y(e, 0, 'getMutableBasicGuildChannelsForGuild'), null !== (n = null !== (t = h.Z.getGuildBasicChannels(e)) && void 0 !== t ? t : L[e]) && void 0 !== n ? n : C;
    }
    getMutableGuildChannelsForGuild(e) {
        var t;
        return Y(e, 1, 'getMutableGuildChannelsForGuild'), null !== (t = L[e]) && void 0 !== t ? t : C;
    }
...
(s = 'ChannelStore'),
    ...
    (t.Z = new el(d.Z, {
        ...
        CONNECTION_OPEN: function (e) {
            let t = L;
            for (let n of ((P = {}), (y = {}), (L = {}), (M = {}), (w = {}), (F = {}), (k = {}), (B = Date.now()), (b = e.initialPrivateChannels), e.initialPrivateChannels.forEach(Q), e.guilds)) 'partial' === n.dataMode && (l().forEach(t[n.id], $), v.fileOnly('Restoring guild channels for '.concat(n.id, ' #:').concat(eu(n.id)))), J(n);
            eo();
        },
        ...
        LOAD_CHANNELS: function (e) {
            for (let { guildId: t, channels: n } of e.channels) for (let e of (v.fileOnly('Lazy loaded guild channels for '.concat(t)), (0, p.ZP)(n), G.add(t), h.Z.restored(t), n)) !Object.hasOwn(y, e.id) && $((0, T._H)(e));
            return !1;
        },
        ...
        LOGOUT: function () {
            v.fileOnly('initializeClear()'), (P = {}), (y = {}), (L = {}), (w = {}), (D = {}), (F = {}), (M = {}), (G = new Set()), (k = {}), (B = Date.now());
        },

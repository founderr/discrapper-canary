...
var r, i, a, o, s = n(392711), l = n.n(s), u = n(956067), c = n(442837), d = n(570140), _ = n(287328), E = n(86670), f = n(591526), h = n(458772), p = n(38217), m = n(710845), I = n(853856), T = n(131704), g = n(823379), S = n(709054), A = n(314897), N = n(430824), v = n(594174), O = n(981631);
let R = new m.Z('ChannelStore'), C = {}, y = {}, D = {}, L = {}, b = null, M = {}, P = {}, U = 0, w = {}, x = {}, G = new Set(), k = {}, B = 0, F = {}, V = 0, H = 0;
class Z {
    ...
    static loadGuildIds(e) {
        ...
        return (0, E.gs)('loadChannels', async () => {
            let e = t.map(e => {
                ...
                }).filter(g.lm), i = e.map(e => e.promise);
            try {
...
function er(e) {
    var t, n;
    let {channel: r} = e, i = null !== (n = null !== (t = y[r.id]) && void 0 !== t ? t : L[r.id]) && void 0 !== n ? n : M[r.id];
    if (null == i)
        return !1;
    en(i), !function (e) {
...
function ea(e) {
    ...
    n.forEach(eo), null == r || r.forEach(e => {
        let t = (0, T.q_)(e), n = null != z(e.id), r = null != F[e.id];
...
o = 'ChannelStore', (a = 'displayName') in (i = el) ? Object.defineProperty(i, a, {
    ...
    CHANNEL_RECIPIENT_ADD: function (e) {
        let t = z(e.channelId), n = A.default.getId();

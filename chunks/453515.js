...
function A(e) {
  ...
  null != n && (n.stop(), delete p[e.applicationId]), delete S[e.applicationId], i.default.set(C, S)
}
...
function g(e) {
  ...
  null == s && (s = p[e.applicationId] = new l.Interval).start(I, () => g(e)), !t && (S[e.applicationId] = e, i.default.set(C, S))
}

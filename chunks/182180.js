...
function x(e) {
    ...
    let { channel: f, message: g, compact: E } = e,
        ...
        v = (null === (t = g.roleSubscriptionData) || void 0 === t ? void 0 : t.total_months_subscribed) != null && (null === (l = g.roleSubscriptionData) || void 0 === l ? void 0 : l.total_months_subscribed) <= 1;
    return null == x
        ? null
        : (0, i.jsxs)(i.Fragment, {
              children: [

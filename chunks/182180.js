...
function S(e) {
  ...
  return (0, s.jsxs)("div", {
    ...
    role: "img",
    "aria-label": m.Z.Messages.ROLE_SUBSCRIPTION_WELCOME_CARD_ARIA_LABEL.format({
      username: i
    }),
...
function A(e) {
  ...
  let {
    ...
    let {
      ...
      (0, u.uL)(T.Z5c.CHANNEL(l, N.oC.ROLE_SUBSCRIPTIONS), null, null, d), (null == _ ? void 0 : _.role_subscription_listing_id) != null && (0, E.y8)(l, n.id, s.id, _.role_subscription_listing_id)
    }, [l, n, s, _, d]);
    ...
    message: m,
    author: C
  }), p = (null === (t = m.roleSubscriptionData) || void 0 === t ? void 0 : t.total_months_subscribed) != null && (null === (l = m.roleSubscriptionData) || void 0 === l ? void 0 : l.total_months_subscribed) <= 1;

...
function d(e) {
  ...
  return (0, a.jsxs)(a.Fragment, {
    children: [!n && (0, a.jsx)(u.MenuItem, {
      ...
      action: () => (0, r.markAsInappropriateConversation)(e.id, i.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_1)
    }), !d && (0, a.jsx)(u.MenuItem, {
      id: "mark-as-tier-2-inappro",
      label: s.default.Messages.INAPPROPRIATE_CONVERSATION_MARK_AS_TIER_2,
      action: () => (0, r.markAsInappropriateConversation)(e.id, i.SafetyWarningTypes.INAPPROPRIATE_CONVERSATION_TIER_2)
    })]
  })
}
...
function v() {
    ...
    let {shouldMergeGameSettings: j} = p.b.useExperiment({ location: 'settings' }), B = (0, M.eA)({ location: 'settings' }), U = (0, E.Xo)({ location: 'settings' }), G = null !== (t = null === (e = O.default.getCurrentUser()) || void 0 === e ? void 0 : e.isStaff()) && void 0 !== t && t, F = (0, m.y0)({ location: 'settings' }), y = (0, l.Q)(), V = (0, C.Zy)({ location: L.dr.USER_SETTINGS_SEARCH_GIFT_INVENTORY }), {enabled: Y} = I.Z.useExperiment({ location: 'UserSettingsInventory' }, { autoTrackExposure: !0 }), w = (0, a.e7)([h.Z], () => h.Z.hasLibraryApplication()), k = (0, a.e7)([A.default], () => A.default.hasTOTPEnabled()), {canBroadcast: H} = c.Z.useExperiment({ location: 'user_settings_activity_privacy' }, { autoTrackExposure: !0 }), W = R.Sb.useSetting(), K = (0, u.Z)();
    return (0, x.i)({
        unseenGiftCount: s,
...
function B(e, t) {
    let s = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = arguments.length > 3 ? arguments[3] : void 0, a = [], i = F(t), o = function (e, t) {
            let s = new Map();
...
function U() {
    let e = v(), {shouldMergeGameSettings: t} = p.b.useExperiment({ location: 'settings' }), s = n.useMemo(() => b(t), [t]);
...
function G(e) {
    let t = v(), s = function () {
            let {shouldMergeGameSettings: e} = p.b.useExperiment({ location: 'settings' }), t = b(e);
            return n.useMemo(() => [{

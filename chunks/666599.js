...
var r = s(735250);
s(470079);
var n = s(920906), l = s(692547), t = s(481060), i = s(153124), c = s(154921), o = s(731455), d = s(689938), _ = s(766438);
let I = e => {
    let {
            currentNumber: a,
            thresholdNumber: s,
            currentLabel: i,
            isPercent: o = !1
        } = e, I = null != s ? Math.floor(a / s * 100) : 0, T = d.Z.Messages.NUMBERS_ONLY.format({ count: a }), m = null != s ? d.Z.Messages.NUMBERS_ONLY.format({ count: s }) : '--', S = (0, t.useToken)(l.Z.unsafe_rawColors.RED_400).hex(), E = (0, t.useToken)(l.Z.unsafe_rawColors.YELLOW_300).hex();
...
a.default = e => {
    ...
    if (!E && null != C && C < o.b0 && (s = (0, r.jsxs)('div', {
        ...
        })), !E && null != h && h < o.md && (n = (0, r.jsxs)('div', {
            className: _.failingBlock,
            children: [
                (0, r.jsx)(t.Heading, {
                    className: _.marginAfter,

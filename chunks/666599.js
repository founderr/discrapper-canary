...
let I = e => {
  let {
    ...
    count: a
  }), m = null != s ? d.Z.Messages.NUMBERS_ONLY.format({
    count: s
  }) : "--", S = (0, t.useToken)(l.Z.unsafe_rawColors.RED_400).hex(), E = (0, t.useToken)(l.Z.unsafe_rawColors.YELLOW_300).hex();
...
a.default = e => {
  ...
  return (0, r.jsxs)(t.ModalRoot, {
    ...
    "aria-labelledby": m,
    children: [(0, r.jsxs)(t.ModalContent, {
      className: _.content,
      children: [(0, r.jsx)(t.Heading, {

...
var r = n(392711), i = n.n(r), a = n(131704), o = n(680089), s = n(592125), l = n(480294), u = n(580005), c = n(496675), d = n(9156), _ = n(70956), E = n(630388), f = n(823379), h = n(789662), p = n(981631), m = n(526761);
function I(e, t, n, r, E) {
    ...
    let m = [], I = Object.values(s.Z.getMutableGuildChannelsForGuild(e.id)).filter(e => c.Z.can(p.Plq.VIEW_CHANNEL, e));
    return m.push(...function (e, t) {
        ...
        let t = [], [n, r] = i()(e).filter(e => e.type === p.d4z.GUILD_ANNOUNCEMENT).partition(e => d.ZP.isChannelMuted(e.guild_id, e.id) || null != e.parent_id && d.ZP.isChannelMuted(e.guild_id, e.parent_id)).value();
        ...
        if (d.ZP.isMuted(e.id) && !d.ZP.isTemporarilyMuted(e.id))
            return [];
        let o = new Set(t.map(e => e.id)), s = r.filter(e => o.has(e.channel_id)), l = i().keyBy(s, 'channel_id'), u = Math.max(n.messages === h.XR.High ? a.frecency.yearMinOpensLargeServer : a.frecency.yearMinOpensSmallServer, s.reduce((e, t) => {
                var n;
                return e + Number(null !== (n = t.num_year_opens) && void 0 !== n ? n : 0);
            }, 0) * a.frecency.totalOpensPercent), c = Math.max(a.frecency.monthMinOpens, s.reduce((e, t) => {
                var n;
                return e + Number(null !== (n = t.num_three_month_opens) && void 0 !== n ? n : 0);
            }, 0) * a.frecency.totalOpensPercent), _ = [], E = [];
        t.forEach(e => {
            var t, n, r, i;
        ...
        if (d.ZP.isMuted(e.id) && !d.ZP.isTemporarilyMuted(e.id))
            return [];
        let n = [], r = new Set(t.map(e => e.id)), i = Date.now() - _.Z.Millis.DAYS_30, o = u.Z.getFrequentlyWithoutFetchingLatest().filter(e => e instanceof a.Sf && r.has(e.id)).filter(e => {
                var t, n;

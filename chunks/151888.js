s(47120);
var n, l = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(153066), d = s(805766);
function c(e, t, s) {
...
class m extends (n = a.PureComponent) {
    render() {
        let {
                ...
                className: n,
                ...a
            } = this.props, {hovered: i} = this.state, c = this.getMode();
    ...
    constructor(...e) {
        super(...e), c(this, 'state', { hovered: !1 }), c(this, 'getMode', () => null != this.props.srcHover ? h.STATIC : h.DEFAULT), c(this, 'handleHover', e => {

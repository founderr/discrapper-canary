...
function L(e) {
  let {
    ...
    (0, h.transitionTo)(S.Routes.CHANNEL(t.id, x ? I.StaticChannelRoute.CUSTOMIZE_COMMUNITY : I.StaticChannelRoute.CHANNEL_BROWSER))
  }, [t.id, x]), b = a.useCallback(e => {
  ...
  return (!v || M || y) && !L && !O && (j = (0, l.jsx)(C.TextBadge, {
    ...
    text: x ? T.default.Messages.CHANNELS_AND_ROLES : T.default.Messages.CHANNEL_BROWSER_TITLE,
    selected: L,
    onClick: D,
    onContextMenu: b,
    trailing: j

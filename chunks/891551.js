...
t.Z = a.ZP.connectStores([c.Z], (e) => {
    ...
    let { className: t, iconClassName: n, sliderClassName: l, userId: a, currentVolume: c, muted: m, context: f, currentWindow: g = window } = e;
    return (0, i.jsx)(h.Z, {
        children: (0, i.jsx)(o.Z, {
            ...
            onValueChange: (e) => {
                var t, n, i, l;
                return (t = e), (n = a), (i = m), (l = f), void (t > 0 && i && s.Z.toggleLocalMute(n, l), s.Z.setLocalVolume(n, (0, d.A)(t), l));
            },
            onToggleMute: () => {
                var e, t;

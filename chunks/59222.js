...
var i = n(735250), s = n(470079), a = n(392711), r = n.n(a), l = n(664751), o = n(442837), c = n(481060), d = n(212093), u = n(703656), _ = n(683301), h = n(671533), E = n(900849), I = n(119317), m = n(749436), g = n(650394), p = n(731455), T = n(689938), S = n(178698);
let C = 12, f = () => {
        ...
        let {
                ...
                categoryName: n,
                onClick: s
            } = e, a = t === p.Hk, r = a ? T.Z.Messages.GUILD_DISCOVERY_SEARCH_EMPTY_HEADER : T.Z.Messages.GUILD_DISCOVERY_SEARCH_EMPTY_CATEGORY_HEADER.format({ categoryName: n }), l = a ? T.Z.Messages.GUILD_DISCOVERY_SEARCH_EMPTY_BODY : T.Z.Messages.GUILD_DISCOVERY_SEARCH_EMPTY_CATEGORY_BODY.format({ onClick: s });
        return (0, i.jsxs)('div', {
...
t.Z = e => {
    let {
            ...
            loading: U,
            total: G
        } = n, [k, w] = s.useState(!1), {tag: B} = f(), [H, V] = s.useState(B), F = (0, o.e7)([_.ZP], () => _.ZP.hasSearchError()), Y = (e, t, n) => {
            d.bR(a, {
                categoryId: n ? p.Hk : R,
                preferredLocale: l.code,
                offset: e,
                length: t,
                filters: { approximate_member_count: E.sq }
            }), w(!1);
        }, W = () => {

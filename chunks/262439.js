...
function d(e, t, n, l) {
  ...
  let d = t.reduce((e, t) => {
    ...
    c = d.reduce((t, r) => (t[r.soundId] = function(e, t, n, l) {
      ...
      return e === d && (u += 8), m.includes(e) && (u += 7), d.startsWith(e) && (u += 6), m.some(t => t.startsWith(e)) && (u += 5), d.endsWith(e) && (u += 4), m.some(t => t.endsWith(e)) && (u += 3), i(e, t.name.toLocaleLowerCase()) && (u += 2), m.some(t => i(e, t)) && (u += 1), u > 0 && (0, o.canUseSoundboardSound)(n, t, l) && (u += 100), u

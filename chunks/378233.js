...
let { API_ENDPOINT: E, MEDIA_PROXY_ENDPOINT: f, PROJECT_ENV: h, ASSET_ENDPOINT: p, CDN_HOST: m } = window.GLOBAL_ENV,
    ...
    O = (e) => (null == e ? null : ''.concat(e.name, '.').concat(N(e.format_type))),
    R = function (e) {
        let { isPreview: t = !1, size: n = d.lE } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        ...
        if ('development' !== h) {
            if (e.format_type === c.u3.LOTTIE) return ''.concat(location.protocol).concat(p).concat(s);
            ...
            (n =
                null != m
                    ...
                    : ''
                          .concat(location.protocol)
                          .concat(E)
                          .concat(_.ANM.STORE_ASSET(d.Ks, r, a))),
            null != t && (n += '?size='.concat((0, i.oO)(t))),
            n
        );
    },
    y = (e) => e.match('development' !== h ? g : S),
    D = (e) =>
        e.stickers.some((e) => {
            let { format_type: t } = e;
    ...
    b = (e, t) => (e === d.yr.ANIMATE_ON_INTERACTION ? t : e !== d.yr.NEVER_ANIMATE),
    M = (e, t, n, i) => {
    ...
    P = (e) => e.type === c.n0.GUILD,
    U = (e) => e.type === c.n0.STANDARD,
    w = (e) => (e.stickerItems.length > 0 ? e.stickerItems : e.stickers.length > 0 ? e.stickers : []),
    x = (e) => {
        if (null === e) return !1;
        let t = e.guild_id;

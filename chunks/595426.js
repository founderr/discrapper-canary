...
var a = s("37983"),
  ...
  B = function(e) {
    let {
      ...
      enabled: y
    } = (0, M.default)(), k = (0, i.useStateFromStores)([N.default], () => N.default.hasFetchedSubscriptions()), K = (0, i.useStateFromStores)([p.default], () => p.default.getCurrentUser()), H = (0, v.usePremiumTrialOffer)(), F = (0, x.usePremiumDiscountOffer)(), W = (0, S.useSubscriptionPlansLoaded)(), [w, V] = n.useState(!0), Y = n.useRef(0), z = (0, A.isPremiumExactly)(K, U.PremiumTypes.TIER_2), X = (0, L.useLocalizedPromoQuery)(), Q = null == X ? void 0 : X.countryCode, Z = (0, i.useStateFromStores)([P.default], () => P.default.hasFetched);
    n.useEffect(() => {
      ...
      !w && g.default.track(D.AnalyticEvents.PREMIUM_MARKETING_PAGE_VIEWED, {
        location_stack: B,
        load_duration_ms: Y.current
      })
    }, [B, w]);
    let J = (0, i.useStateFromStores)([m.default], () => m.default.enabled);

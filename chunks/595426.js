...
var a = s("37983"),
  ...
  k = function(e) {
    let {
      ...
      enabled: y
    } = (0, O.default)(), B = (0, l.useStateFromStores)([N.default], () => N.default.hasFetchedSubscriptions()), H = (0, l.useStateFromStores)([A.default], () => A.default.getCurrentUser()), K = (0, x.usePremiumTrialOffer)(), W = (0, L.usePremiumDiscountOffer)(), F = (0, S.useSubscriptionPlansLoaded)(), [w, V] = r.useState(!0), Y = r.useRef(0), z = (0, g.isPremiumExactly)(H, b.PremiumTypes.TIER_2), Q = (0, h.useLocalizedPromoQuery)(), X = null == Q ? void 0 : Q.countryCode, J = (0, l.useStateFromStores)([P.default], () => P.default.hasFetched);
    r.useEffect(() => {
      ...
      if (s && (null != K || null != W)) {
        ...
        e ? (0, C.acknowledgeUserOffer)(K, W) : null != K && null == K.expires_at && M.default.acknowledgeUserTrialOffer(K)
      }
    }, [s, K, W]), r.useEffect(() => {

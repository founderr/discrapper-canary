...
var o, r, s = n(990547), a = n(544891), i = n(570140), l = n(314897), d = n(573261), c = n(815660), E = n(981631);
(o = r || (r = {})).USER_ACTION_REQUIRED = 'user_action_required', o.USER_SETTINGS_UPDATE = 'user_settings_update', o.GUILD_PHONE_REQUIRED = 'guild_phone_required', o.MFA_PHONE_UPDATE = 'mfa_phone_update', o.CONTACT_SYNC = 'contact_sync', t.Z = {
    setCountryCode(e) {
        i.Z.dispatch({
    ...
    resendCode(e) {
        let t = {}, n = l.default.getFingerprint();
    ...
    async verifyPhone(e, t) {
        let n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], o = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], r = {}, a = l.default.getFingerprint();

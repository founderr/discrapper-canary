...
class eh extends(l = a.PureComponent) {
  componentDidMount() {
    ...
    if (h && k.default.track(en.rMx.INVITE_SUGGESTION_OPENED, {
      ...
      let e = j.Z.getStreamForUser(i, t.id),
        n = (0, f.L2)(e, b.Z);
    ...
    } else(null == d ? void 0 : d.id) != null || k.default.track(en.rMx.OPEN_MODAL, {
  ...
  renderFooter() {
    ...
    } else !n && (c = (0, s.jsxs)(F.Z, {
      justify: F.Z.Justify.BETWEEN,
      className: ea.marginTop20,
      children: [(0, s.jsx)(_.Checkbox, {
        size: 18,
...
eo(eh, "defaultProps", {
  ...
  let {
    ...
    page: Z,
    analyticsLocation: j
  } = e, [b, P] = a.useState(Z === ee.RV.GUEST ? I.$.IS_GUEST_INVITE : 0), {
    analyticsLocations: F
  } = (0, S.ZP)(v.Z.INSTANT_INVITE_MODAL), k = (0, g.e7)([L.Z, B.Z], () => {
    let e = B.Z.getVoiceChannelId();
    if (null == e) return null;
    let n = L.Z.getChannel(e);
    return (null == n ? void 0 : n.guild_id) === d.id ? n : null
  }), K = null != k && !(0, x.Z)(k) && [en.t4x.GUILD_CONTEXT_MENU, en.t4x.GUILD_HEADER].includes(u), W = (0, R.Z)(d.id), z = (0, g.e7)([B.Z, L.Z, O.ZP], () => {
    if (K && ((0, H.yE)(b, I.$.IS_GUEST_INVITE) || Z === ee.RV.GUEST)) return k;
    if (Z === ee.RV.GUEST) return 1 === W.length ? W[0] : void 0;
    if (null != o) return o;
    let e = B.Z.getChannelId(),
      n = null == e || (0, et.AB)(e) ? void 0 : L.Z.getChannel(e);
  ...
  }, [K, b, Z, o, d.id, k, W]), [q, X] = a.useState(null), $ = null != q ? q : z, Q = null;
  ...
  let J = null != o ? o.getGuildId() : null != d ? d.id : null,
    ...
    [es, ea, ei, er, eo] = (0, g.Wu)([G.Z, w.ZP, y.ZP], () => {
      let e = null != $ ? $.id : null;
      return [G.Z.getInviteSuggestionRows(), G.Z.getTotalSuggestionsCount() >= 1, G.Z.getInitialCounts(), null != o && null != $ ? w.ZP.getVoiceStatesForChannel($) : null, null != J ? y.ZP.getProps(J, e) : null]
    }, [$, o, J]),
    eI = (0, g.e7)([U.Z], () => null != $ && U.Z.can(en.Plq.CREATE_INSTANT_INVITE, $), [$]),
    eg = null === el || !eI,
    [eE] = a.useState(() => {
      let e = new Set;
    ...
    em = (0, g.e7)([V.Z], () => V.Z.getStageInstanceByChannel(e_), [e_]);
  a.useEffect(() => {
    (0, T.x)({
      omitUserIds: eE,
      guild: d,
  ...
  }, [eV.currentPage, ey]), eO = (eA || K) && Z !== ee.RV.GUEST && !eZ && !eg && !eR, {
    enabled: eD
  } = A.o.useExperiment({
  ...
  }, [eZ, $, u, null == eT ? void 0 : eT.id, Q, h, eG, eU, eb, b, ey, eB]), eF = (0, N.Z)($), ek = (0, N.Z)(b), eH = eF !== $, eK = ek !== b;
  return a.useEffect(() => {
    (eH || eK) && ew()
  }, [ew, eH, eK]), (0, s.jsx)(S.Gt, {
    value: F,
    children: (0, s.jsx)(eh, {
      ref: n,
      canCreateInvites: eI,

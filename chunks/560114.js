t.r(n), t(47120);
var l, s = t(735250), a = t(470079), i = t(120356), r = t.n(i), o = t(512722), d = t.n(o), u = t(392711), c = t.n(u), h = t(990547), I = t(533800), g = t(442837), E = t(692547), _ = t(481060), m = t(447543), T = t(247272), N = t(110924), v = t(100527), S = t(906732), p = t(835473), x = t(447003), M = t(471445), C = t(259473), f = t(687516), Z = t(111810), A = t(301935), R = t(268939), V = t(427679), j = t(199902), y = t(439170), L = t(592125), O = t(984933), D = t(341165), G = t(751771), U = t(496675), b = t(158776), B = t(944486), P = t(594174), w = t(938475), F = t(285952), k = t(626135), H = t(630388), K = t(971130), W = t(264229), Y = t(751499), z = t(181852), q = t(366980), X = t(444260), $ = t(585385), Q = t(603236), J = t(462376), ee = t(245335), en = t(981631), et = t(176505), el = t(689938), es = t(165932), ea = t(331651), ei = t(238753), er = t(622577);
function eo(e, n, t) {
...
class eh extends (l = a.PureComponent) {
    componentDidMount() {
        ...
        if (s) {
            ...
            if (null == t)
                return;
            g({ networkError: void 0 }), m.Z.createInvite(t, {
        ...
        if (h && k.default.track(en.rMx.INVITE_SUGGESTION_OPENED, {
            ...
            let e = j.Z.getStreamForUser(i, t.id), n = (0, f.L2)(e, b.Z);
    ...
    getInviteKey() {
        let {
                ...
                modalState: l
            } = this.props, {showVanityURL: s} = l, a = s ? n : null != e ? e : n;
    ...
    renderHeader() {
        ...
        let {
                ...
                modalState: u,
                handleDone: c
            } = this.props, {query: h} = u, I = null, g = null;
    ...
    renderFriendsBody() {
        let {rows: e} = this.props, n = this.getInviteKey();
        return 0 === e.length ? (0, s.jsx)(_.ModalContent, {
            className: r()(es.inviteRowEmptyState),
            children: (0, s.jsx)(_.EmptyStateText, { children: el.Z.Messages.INVITE_FRIEND_MODAL_NO_RESULTS })
        }) : null == n ? (0, s.jsx)(_.ModalContent, {
            className: r()(es.inviteRowEmptyState),
            children: (0, s.jsx)(_.EmptyStateText, { children: el.Z.Messages.INVITE_FRIEND_MODAL_LOADING })
    ...
    renderBody() {
        ...
        let i = (0, q.Z)(null !== (e = this.getInviteKey()) && void 0 !== e ? e : ''), r = P.default.getCurrentUser();
    ...
    renderFooter() {
        ...
        let {
                ...
                inviteChannel: o,
                modalState: d
            } = this.props, {maxAge: u} = d, c = null, h = (0, q.Z)(null !== (e = this.getInviteKey()) && void 0 !== e ? e : '');
        if (t) {
    ...
    constructor(...e) {
        super(...e), eo(this, '_scroller', null), eo(this, '_headerId', c().uniqueId()), eo(this, 'openSettings', () => {
            ...
            null === (n = this._scroller) || void 0 === n || n.scrollTo({ to: 0 }), (0, T.C)(e), t({ query: e });
            ...
            if (n > 0)
                return null;
            let {analyticsLocation: l} = this.props, a = this.getInviteKey(), i = this.props.rows[t], r = ''.concat(i.type, '-').concat(i.item.id);
            switch (i.type) {
            case K.bm.GROUP_DM:
            case K.bm.CHANNEL:
                return (0, s.jsx)(J.d, {
...
eo(eh, 'defaultProps', {
    ...
    let {
            ...
            page: Z,
            analyticsLocation: j
        } = e, [b, P] = a.useState(Z === ee.RV.GUEST ? I.$.IS_GUEST_INVITE : 0), {analyticsLocations: F} = (0, S.ZP)(v.Z.INSTANT_INVITE_MODAL), k = (0, g.e7)([
            L.Z,
            B.Z
        ], () => {
            ...
            en.t4x.GUILD_HEADER
        ].includes(u), W = (0, R.Z)(d.id), z = (0, g.e7)([
            B.Z,
            L.Z,
            O.ZP
        ], () => {
            if (K && ((0, H.yE)(b, I.$.IS_GUEST_INVITE) || Z === ee.RV.GUEST))
                return k;
            if (Z === ee.RV.GUEST)
                return 1 === W.length ? W[0] : void 0;
            if (null != o)
                return o;
            let e = B.Z.getChannelId(), n = null == e || (0, et.AB)(e) ? void 0 : L.Z.getChannel(e);
            return (null == n ? void 0 : n.isThread()) && (n = L.Z.getChannel(n.parent_id)), null != n ? n : O.ZP.getDefaultChannel(d.id, !0, en.Plq.CREATE_INSTANT_INVITE);
        }, [
            K,
            b,
            Z,
    ...
    let J = null != o ? o.getGuildId() : null != d ? d.id : null, el = (0, g.e7)([D.Z], () => {
            let e = null != $ ? $.id : null;
            ...
            return [
                ...
                null != o && null != $ ? w.ZP.getVoiceStatesForChannel($) : null,
                null != J ? y.ZP.getProps(J, e) : null
            ];
        }, [
            $,
            o,
            J
        ]), eI = (0, g.e7)([U.Z], () => null != $ && U.Z.can(en.Plq.CREATE_INSTANT_INVITE, $), [$]), eg = null === el || !eI, [eE] = a.useState(() => {
            let e = new Set();
            return null != h && null != er ? er.forEach(n => {
                let {user: t} = n;
                e.add(t.id);
            }) : null != J && null != eo && Q !== ee.Iq.EMBEDDED_APPLICATION && eo.rows.forEach(n => {
                n.type === y.so.MEMBER && e.add(n.userId);
            }), e;
        }), e_ = null == o ? void 0 : o.id, em = (0, g.e7)([V.Z], () => V.Z.getStageInstanceByChannel(e_), [e_]);
    a.useEffect(() => {
        (0, T.x)({
            omitUserIds: eE,
            guild: d,
    ...
    let [eT] = (0, p.Z)(null != E ? [E] : []), eN = (0, C.Z)({ guildId: J }), ev = null != el ? el.code : void 0, eS = null == el ? void 0 : el.maxAge, ep = null == el ? void 0 : el.maxUses, ex = null == el ? void 0 : el.temporary, eM = d.vanityURLCode, eC = null != eM && eM.length > 0, {enabled: ef} = Y.Z.useExperiment({
            guildId: null !== (i = null !== (l = null !== (t = d.id) && void 0 !== t ? t : null == el ? void 0 : el.guild.id) && void 0 !== l ? l : J) && void 0 !== i ? i : en.lds,
            location: 'acc417_2'
        }, { autoTrackExposure: eC }), eZ = ef && !(null == $ ? void 0 : $.isGuildVocal()) && eC, eA = (null == $ ? void 0 : $.type) === en.d4z.GUILD_VOICE, eR = (0, x.Z)($);
    ...
    let [eV, ej] = a.useState({
            ...
            eV.currentPage,
            ey
        ]), eO = (eA || K) && Z !== ee.RV.GUEST && !eZ && !eg && !eR, {enabled: eD} = A.o.useExperiment({
            ...
            0 === eU && 0 === eG && !eb && eZ ? ey({
                ...
                networkError: e,
                showVanityURL: eZ
            }))), eG !== ed.value && eB !== ed.value && ey({ savedMaxAge: ed.value });
        }, [
            eZ,
            $,
            u,
            ...
            ey,
            eB
        ]), eF = (0, N.Z)($), ek = (0, N.Z)(b), eH = eF !== $, eK = ek !== b;
    return a.useEffect(() => {
        (eH || eK) && ew();
    }, [
        ew,

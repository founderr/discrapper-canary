...
function p(e) {
    var t;
    let {isOnHubVerificationRoute: n} = e, p = (0, l.LX)(null !== (t = window.location.pathname) && void 0 !== t ? t : '', { path: d.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(':guildId', ':inviteCode') }), _ = (0, r.e7)([o.Z], () => {
            if (null == p)
                return null;
    ...
    return n ? null != f && null != _ ? (0, i.jsx)(c.Z, {
        guild: f,
        invite: _
    }) : (0, i.jsx)(u.Z, {

...
var r = n(735250), i = n(470079), s = n(979554), l = n(442837), o = n(481060), a = n(100527), c = n(906732), d = n(335131), u = n(884697), f = n(449217), m = n(566111), E = n(197115), p = n(150039), _ = n(594174), h = n(626135), I = n(74538), g = n(934261), v = n(52268), C = n(981631), x = n(474936), P = n(689938), Z = n(460423);
function A(e) {
    let {
            user: t,
            product: n,
    ...
    return (0, r.jsx)(o.ModalFooter, {
        ...
        children: (0, r.jsxs)('div', {
            ...
            children: [
                ...
                null != s && (!(0, u.qS)(s) || m) || null === p ? (0, r.jsx)(o.Button, {
                    onClick: l,
                    disabled: f,
...
function T(e) {
    let {
        ...
        } = e, {pendingProfileEffectId: E} = (0, p.bd)(n), [_, h] = i.useMemo(() => {
            let e = (0, u.bl)(s, l);
            return [
                e.purchased,
                e.shopPreviews
            ...
            s,
            l
        ]), [C, x] = i.useState(() => null != c ? c : void 0 !== E ? E : null == d ? null : null != d ? d : null), [T, N] = i.useMemo(() => {
            var e;
            ...
            product: S,
            purchase: j
        } = (0, f.Z)(null == T ? void 0 : T.skuId), R = i.useRef(null), M = I.ZP.canUseCollectibles(t), O = C === (void 0 === E ? null != d ? d : null : E), b = i.useCallback(e => {
            x(e);
        }, [x]);
...
function N(e) {
    let {
            ...
            categories: g,
            purchases: v
        } = (0, m.Z)(), x = (0, l.e7)([_.default], () => _.default.getCurrentUser()), {analyticsLocations: P} = (0, c.ZP)(n, a.Z.EDIT_PROFILE_EFFECT_MODAL), A = (0, p.Kg)(x, f);
    return i.useEffect(() => {

...
let U = {
  ...
  B = {
    name: e => ({
      ...
      renderInput: e => (0, d.jsx)(S.TextInput, {
        ...e
      })
    }),
    country: e => ({
      ...
      renderInput(e, t) {
        ...
        return (0, d.jsx)(S.SearchableSelect, {
          ...n,
          autoFocus: !0,
          maxVisibleItems: 8,
    ...
    postalCode: e => {
      ...
      return {
        ...
        renderInput: e => "modalUSReduced" === e.layout ? (0, d.jsx)(S.TextInput, {
          style: {
            minHeight: "45px"
          },
          ...e
    ...
    state: e => {
      ...
      return {
        ...
        renderInput(t) {
          ...
          return [h, y].includes(e) && n ? (0, d.jsx)(S.SearchableSelect, {
            ...r,
...
class Y extends(r = c.PureComponent) {
  ...
  validateForm(e) {
    let {
      values: t,
      dirtyFields: a
    } = this.state, n = {}, s = (0, _.reducedPaymentInfoExperiment)({
      autoTrackExposure: !1
    }).enabled;

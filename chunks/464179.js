...
let Y = {
  ...
  B = {
    name: e => ({
      name: "name",
      id: b,
      title: () => N.default.Messages.BILLING_ADDRESS_NAME,
      autoComplete: "name",
    ...
    line1: e => ({
      name: "line1",
      id: g,
      title: () => N.default.Messages.BILLING_ADDRESS_ADDRESS,
      autoComplete: "address-line1",
      placeholder: () => N.default.Messages.BILLING_ADDRESS_ADDRESS_PLACEHOLDER,
      getClassNameForLayout: e => ["modalUS", "modalInternational", "modalUSWithName", "modalInternationalWithName", "settingsUSMobile", "settingsInternationalMobile", "settingsInternationalWithoutNameMobile"].includes(e) ? y.width100 : y.width60,
      renderInput: e => (0, c.jsx)(S.TextInput, {
        ...e
      })
    ...
    line2: e => ({
      name: "line2",
      id: L,
      title: () => N.default.Messages.BILLING_ADDRESS_ADDRESS2,
      placeholder: () => N.default.Messages.BILLING_ADDRESS_ADDRESS2_PLACEHOLDER,
    ...
    city: e => ({
      name: "city",
      id: D,
      title: () => N.default.Messages.BILLING_ADDRESS_CITY,
      autoComplete: "address-level2",
      placeholder: () => N.default.Messages.BILLING_ADDRESS_CITY_PLACEHOLDER,
      getClassNameForLayout: e => {
        switch (e) {
          case "modalInternational":
          case "modalUS":
    ...
    state: e => {
      ...
      switch (e) {
        case P:
          t = N.default.Messages.BILLING_ADDRESS_STATE;
          break;
        case h:
          t = N.default.Messages.BILLING_ADDRESS_PROVINCE;
          break;
        default:
          t = N.default.Messages.BILLING_ADDRESS_REGION
      }
      return {
        name: "state",
        id: x,
        ...
        renderInput(t) {
          ...
          return [P, h].includes(e) && n ? (0, c.jsx)(S.SearchableSelect, {
            ...l,
...
class k extends(l = d.PureComponent) {
  componentDidMount() {
  ...
  validateForm(e) {
    ...
    (!e || a.name) && !this.hasValue(t.name) && "edit" === this.props.mode && (n.name = N.default.Messages.BILLING_ADDRESS_NAME_ERROR_REQUIRED), (!e || a.country) && !this.hasValue(t.country) && (n.country = N.default.Messages.BILLING_ADDRESS_COUNTRY_ERROR_REQUIRED), (!e || a.line1) && !this.hasValue(t.line1) && !s && (n.line1 = N.default.Messages.BILLING_ADDRESS_ADDRESS_ERROR_REQUIRED), (!e || a.city) && !this.hasValue(t.city) && !s && (n.city = N.default.Messages.BILLING_ADDRESS_CITY_ERROR_REQUIRED);
    let r = t.country;
    switch (r) {
      case P:
        if (!e || a.postalCode) {
          let e = t.postalCode;
          this.hasValue(e) ? e.length !== I ? n.postalCode = N.default.Messages.BILLING_ADDRESS_ZIP_CODE_ERROR_LENGTH : !/^\d{5}$/.test(e) && (n.postalCode = N.default.Messages.BILLING_ADDRESS_ZIP_CODE_INVALID) : n.postalCode = N.default.Messages.BILLING_ADDRESS_ZIP_CODE_ERROR_REQUIRED
        }(!e || a.state) && !this.hasValue(t.state) && !s && (n.state = N.default.Messages.BILLING_ADDRESS_STATE_ERROR_REQUIRED);
        break;
      case h:
        (!e || a.postalCode) && !this.hasValue(t.postalCode) && (n.postalCode = N.default.Messages.BILLING_ADDRESS_POSTAL_CODE_ERROR_REQUIRED), (!e || a.state) && !this.hasValue(t.state) && !s && (n.state = N.default.Messages.BILLING_ADDRESS_PROVINCE_ERROR_REQUIRED);
        break;
      default:
        (!e || a.postalCode) && !this.hasValue(t.postalCode) && !R.includes(null != r ? r : "") && (n.postalCode = N.default.Messages.BILLING_ADDRESS_POSTAL_CODE_ERROR_REQUIRED)
    }
    return n
  }
  handleInfoChange() {
...
C(k, "Layouts", s), C(k, "Modes", r), C(k, "defaultProps", {
  name: "",
  country: "",
  line1: "",
  line2: "",

...
class p extends s.Component {
  ...
  renderUserOrChannel() {
    ...
    if (null != s) n = s.getAvatarURL(null == a ? void 0 : a.guild_id, 32), t = m.ZP.getName(s);
    ...
    if (null == n || null == t) return null != e ? (0, l.jsx)(i.Text, {
    ...
    return e = r ? (0, l.jsx)(i.Button, {
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: [this.renderUserOrChannel(), (0, l.jsxs)("div", {
          ...
          children: [m.ZP.getName(n), null != t ? (0, d.F6)(t, g.default, I.Z, !0) : null]
        })]
      }), e]
    })
  }
  constructor(...e) {
    super(...e), v(this, "state", {
      ...
      if (null != t) null != n ? (this.setState({
        sending: !0
      }), r.Z.enqueue({
        type: r.m.GROUP_DM,
        channel: n,

...
t.Z = {
    [u.Etm.SET_USER_VOICE_SETTINGS]: {
        ...
        handler(e) {
            ...
            if (null == l.default.getUser(t) || (null == c ? void 0 : c.id) === t) throw new s.Z({ errorCode: u.lTL.INVALID_USER }, 'Invalid user id: '.concat(t));
    ...
    [u.Etm.SET_VOICE_SETTINGS]: {
        ...
        handler(e) {
            let {
                args: { input: t, output: n, mode: i, automatic_gain_control: l, echo_cancellation: s, noise_suppression: o, qos: d, silence_warning: u, deaf: h, mute: m }
            } = e;
            ...
            if ((null != l && r.Z.setAutomaticGainControl(l), null != s && r.Z.setEchoCancellation(s), null != o && r.Z.setNoiseSuppression(o), null != d && r.Z.setQoS(d), null != u && r.Z.setSilenceWarning(u), null != h)) {

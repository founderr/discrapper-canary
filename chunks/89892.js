...
class g {
    ...
    loadComplete(e) {
        ...
        return (C = C.mutate({
            ...
            hasMoreBefore: null == S && I ? C.hasMoreBefore : T,
            hasMoreAfter: null == S && b ? C.hasMoreAfter : y,
            cached: A,

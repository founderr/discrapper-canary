...
class f {
  ...
  loadComplete(e) {
    ...
    return v = v.mutate({
      ...
      hasMoreBefore: null == O && m ? v.hasMoreBefore : p,
      hasMoreAfter: null == O && A ? v.hasMoreAfter : R,
      cached: g,

...
class g {
    ...
    loadComplete(e) {
        ...
        return (C = C.mutate({
            ...
            hasMoreBefore: null == T && I ? C.hasMoreBefore : S,
            hasMoreAfter: null == T && b ? C.hasMoreAfter : y,
            cached: A,

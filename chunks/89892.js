...
var r = n(392711), i = n.n(r), a = n(612002), o = n(593472), s = n(513418), l = n(710845), u = n(786761), c = n(709054), d = n(697479), _ = n(981631);
function E(e, t, n) {
...
class p {
    ...
    extract(e) {
        ...
        if (this._isCacheBefore) {
            let n = Math.max(this.length - e, 0), r = this.length;
...
class m {
    ...
    mutate(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = new m(this.channelId);
    ...
    get(e) {
        var t;
        let n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], r = this._map[e];
    ...
    truncateTop(e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = this._array.length - e;
    ...
    jumpToPresent(e) {
        return this.mutate(t => {
            ...
            t.hasMoreAfter = !1;
            let r = Math.max(n.length - e, 0), i = n.slice(r);
    ...
    jumpToMessage(e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = arguments.length > 2 ? arguments[2] : void 0, r = arguments.length > 3 ? arguments[3] : void 0, i = arguments.length > 4 ? arguments[4] : void 0;
    ...
    receiveMessage(e) {
        var t, n;
        let r = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], i = null == e.nonce ? null : this.get(e.nonce, !0);
        ...
        if (this.hasMoreAfter)
            ...
            let t = a.Z.getCurrentConfig({ location: '2ecb25_1' }, { autoTrackExposure: !1 }).enabled ? (0, u.e5)(e) : h(this, e), n = this.merge([t]);
    ...
    loadComplete(e) {
        ...
        let T = [...e.newMessages], g = null !== (t = e.isBefore) && void 0 !== t && t, S = null !== (n = e.isAfter) && void 0 !== n && n, A = null !== (r = e.jump) && void 0 !== r ? r : null, N = null !== (s = e.hasMoreBefore) && void 0 !== s && s, v = null !== (l = e.hasMoreAfter) && void 0 !== l && l, O = null !== (c = e.cached) && void 0 !== c && c, R = i()(T).reverse().map(a.Z.getCurrentConfig({ location: '2ecb25_2' }, { autoTrackExposure: !1 }).enabled ? e => (0, u.e5)(e) : e => h(this, e)).value(), C = null;
        if ((g || S) && null == A && this.ready)
            C = this.merge(R, g, !0);
        else {
            let e = this._array.filter(e => e.state === _.yb.SENDING), t = this._array.filter(e => e.state === _.yb.SEND_FAILED), n = e.length > 0 || t.length > 0;

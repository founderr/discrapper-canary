...
function p(e) {
  ...
  let {
    ...
    className: i,
    onClickInviter: L
  } = e, o = (0, A.useStateFromStores)([l.default], () => null == a ? null : l.default.getMember(E, a.id), [a, E]), r = _.useCallback(e => {
...
function P(e) {
  ...
  return E && null != a ? (0, s.jsx)(n.Tooltip, {
...
function H(e) {
  ...
  switch (!0) {
    ...
    case null != L:
      return (0, s.jsxs)("div", {
        className: T()(A && M.footerAlignment),
        children: [(0, s.jsxs)(n.Clickable, {
          className: M.inviteContainer,
          ...l,
          ...
          tabIndex: 0,
          onClick: r,
          children: [null == L ? void 0 : L.icon, (0, s.jsx)(n.Text, {
            variant: "text-sm/medium",
...
t.default = _.memo(function(e) {
  ...
  let {
    ...
    onClickInviter: u
  } = e, l = (0, A.useStateFromStores)([O.default], () => O.default.getEnhancedMember(T, a), [T, a]), r = null !== (t = null == l ? void 0 : l.inviterId) && void 0 !== t ? t : null, d = (0, A.useStateFromStores)([o.default], () => o.default.getUser(r), [r]);
  _.useEffect(() => {
  ...
  return (g === U.JoinSourceType.INVITE || g === U.JoinSourceType.VANITY_URL || g === U.JoinSourceType.MANUAL_MEMBER_VERIFICATION && null != S) && N ? (0, s.jsx)(f, {}) : (0, s.jsx)(P, {
    hasTooltip: c && !n,

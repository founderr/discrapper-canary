var n = r(546870), i = r(195961), o = r(65183);
o.List;
var a = o.Map, u = function (t, e, r) {
        if (!t)
            return;
        var n = e.get(t);
        if (!!n)
...
t.exports = function (t, e) {
    if (e.isCollapsed())
        return t;
    var r, o, h, d, g, y = t.getBlockMap(), v = e.getStartKey(), m = e.getStartOffset(), _ = e.getEndKey(), b = e.getEndOffset(), S = y.get(v), w = y.get(_), k = S instanceof n, x = [];
    if (k) {
        var C = w.getChildKeys(), E = s(_, y);
    ...
    if (k && S !== w) {
        ...
        r = K, o = S, h = w, d = y, K = r.withMutations(function (t) {
            if (u(o.getKey(), t, function (e) {
                ...
                var n = e ? r.get(e) : null, i = n ? n.getParentKey() : null;

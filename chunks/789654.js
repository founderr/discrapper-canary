...
function Z() {
    let e = (0, y.Fg)(), [{
            ...
            rawPalette: p.b,
            semanticTokens: j
        }), [g, b] = n.useState(''), [v, w] = n.useState({}), [S, T] = n.useState({}), I = n.useMemo(() => Object.keys(t).reduce((e, t) => [
            ...e,
            {
                value: t,
                label: t
            }
        ], []), [t]), Z = n.useCallback((e, a, n, o) => {
            let l = d().cloneDeep(r);
            l[e][a] = {
                color: n,
                opacity: o
            ...
            return c()(_(), Object.keys(e).map(n => {
                ...
                let i = e[n], o = i.light, l = i.dark, c = i.midnight, s = [
                        [
                            'dark',
                            l
                        ],
            ...
            (0, a.jsx)(f.ScrollerThin, {
                children: (0, a.jsx)('div', {
                    ...
                    children: Object.keys(j).filter(e => '' === g || e.toLowerCase().includes(g)).map(t => {
                        var i;
                        let o = j[t][e], l = null == r[t] ? { ...o } : r[t][e], c = l.color !== o.color || l.opacity !== o.opacity;

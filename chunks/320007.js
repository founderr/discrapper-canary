...
function _(e) {
  ...
  })), x = null != A && A.newClipIds.length > 0, M = (0, m.useClipsButtonStore)(e => e.clipsButtonRef), L = (0, m.useClipsButtonStore)(e => e.setClipsButtonRef), b = (0, s.useStateFromStores)([o.default], () => o.default.hasLayers()), {
    preventIdle: O,
    allowIdle: y
  ...
  return (l.useEffect(() => (R ? O() : y(), () => y()), [R, O, y]), I && N && T) ? (0, a.jsxs)(a.Fragment, {
    children: [null != M && t && v && x && !(0, i.hasAnyModalOpen)() && !b && (0, a.jsx)(p.default, {
      clipIconRef: M,
      lastClipsSession: A,

...
function N(e) {
  ...
  })), O = null != S && S.newClipIds.length > 0, x = (0, I.n)(e => e.clipsButtonRef), M = (0, I.n)(e => e.setClipsButtonRef), v = (0, s.e7)([o.Z], () => o.Z.hasLayers()), {
    preventIdle: L,
    allowIdle: Z
  } = (0, r.Y)("animation");
  ...
  function P() {
    (0, l.openModalLazy)(async () => {
      let {
        default: e
      } = await Promise.all([n.e("2668"), n.e("56874")]).then(n.bind(n, 542055));
      return t => (0, i.jsx)(e, {
        ...t
      })
    }, {
  ...
  return (a.useEffect(() => (R ? L() : Z(), () => Z()), [R, L, Z]), p && f && C) ? (0, i.jsxs)(i.Fragment, {
    children: [null != x && t && A && O && !(0, l.hasAnyModalOpen)() && !v && (0, i.jsx)(m.Z, {
      clipIconRef: x,
      lastClipsSession: S,

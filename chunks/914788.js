...
var t = _(133080), T = _(412788), I = _(594174), n = _(709054), s = _(280570), A = _(735079), r = _(546791), a = _(292352);
function i(e, E, _) {
...
let C = null, N = null, o = {}, u = c(), S = O(), M = null, R = function () {
        var e, E, _, t;
...
function f() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], E = arguments.length > 1 ? arguments[1] : void 0;
    return o = e.length > 0 ? e.reduce((e, E) => ({
        ...e,
        [E.user_id]: E
    }), {}) : {};
}
...
class Q extends T.Z {
    ...
    loadCache() {
        ...
        if (null != e)
            f(e.linkedUsers), g(e.guilds), U(e.teenActivity), S = e.teenActivityTotals.reduce((e, E) => {
                let [_, t] = E.split(':'), T = (0, r.jV)(_);
                return void 0 === T ? e : {
                    ...e,
                    [T]: parseInt(t, 10)
                };

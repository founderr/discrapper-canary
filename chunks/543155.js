...
function I(e) {
  ...
  constructor(e) {
    super(e), this.draggableRef = d.createRef(), this._dragStart = {
      ...
      2 === r && p !== this.state.horizontalOrientation && (this._offsetX = A - this._offsetX, m = !0), 2 === l && S !== this.state.verticalOrientation && (this._offsetY = g - this._offsetY, m = !0), this.setDOMPositions(O), !T && (null == o || o(O, a)), null == u || u(O, a), m && (null == d || d([S, p])), this.setState({
        dragging: I,
        verticalOrientation: S,
        horizontalOrientation: p,
        atTopEdge: 0 === O.top

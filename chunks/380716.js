...
function G(e) {
  ...
  }], [null == z ? void 0 : z.type, W]), [K, Y] = o.useState(f()), [q, Q] = o.useState(null !== (l = null == U ? void 0 : U.title) && void 0 !== l ? l : ""), X = (0, s.e7)([g.Z], () => {
  ...
  let [J, $] = o.useState((x = F, null == (G = U) ? null : null !== (b = x.find(e => e.value === G.actionType)) && void 0 !== b ? b : null)), [ee, el] = o.useState(null !== (n = null == U ? void 0 : U.emoji) && void 0 !== n ? n : null), en = (0, s.e7)([g.Z], () => {
    ...
    let e = {
      ...
      l = null != ea || null != ee;
    k(e, ea, l), Z()
  }, [k, Z, q, J, V, ee, en, ea]), er = o.useCallback(() => {
    null == P || P(), Z()
  }, [P, Z]), eu = o.useCallback(e => {
    Q(e), Y(M({
  ...
  }, [$, Y, V, q, ee]), eI = o.useCallback(e => Promise.resolve(N.ZP.getSelectableChannels(B).filter(l => !X.has(l.channel.id) && (0, I.kb)(l.channel) && i()(e, l.channel.name)).map(e => ({
    value: e.channel.id,
    label: e.channel.name
  }))), [B, X]), em = o.useCallback(e => {
    ...
    if (null != en && null != V) return p.ZP.getNewMemberActionIconURL({
      channelId: V.value,
      icon: en
    });
    else return null
  }, [V, en, ea, ee])(), eh = o.useCallback(e => {
    null != e && e_(e, null)
  }, [e_]), ev = e => (l, n) => {
    var a, o;
    if (null == l) return;
    ...
    children: [(0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)(r.ModalCloseButton, {
        ...
        children: [(0, a.jsxs)(r.Heading, {
          ...
          children: [A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_TITLE, (0, a.jsx)(E.Z, {})]
        }), (0, a.jsx)(r.TextInput, {
          value: q,
        ...
        children: [(0, a.jsxs)(r.Heading, {
          variant: "heading-md/semibold",
          color: "header-primary",
          children: [A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_CHANNEL, (0, a.jsx)(E.Z, {})]
        ...
        children: [(0, a.jsxs)(r.Heading, {
          variant: "heading-md/semibold",
          color: "header-primary",
          children: [A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_TYPE, (0, a.jsx)(E.Z, {})]

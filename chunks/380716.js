...
var a = n(735250), o = n(470079), t = n(658722), i = n.n(t), s = n(399606), r = n(481060), u = n(596454), d = n(471445), c = n(907040), I = n(734893), m = n(813197), _ = n(592125), N = n(984933), h = n(430824), v = n(153124), p = n(768581), T = n(823379), x = n(700785), g = n(969632), E = n(580357), O = n(981631), C = n(185923), A = n(689938), j = n(525480);
function S(e, l) {
    switch (e) {
    case I.oi.VIEW:
...
function M(e) {
    let l = f(), n = _.Z.getChannel(e.channelId);
    return (null == e.title || e.title.length < I.Wz) && l.title.push(A.Z.Messages.NEW_MEMBER_ACTION_VALIDATION_ERROR_TITLE_REQUIRED.format({ minLength: I.Wz })), null != e.actionType && null != n && !S(e.actionType, n) && l.actionType.push(function (e) {
        switch (e) {
        case I.oi.VIEW:
...
function G(e) {
    ...
    let {
            ...
            W
        ]), [K, Y] = o.useState(f()), [q, Q] = o.useState(null !== (l = null == U ? void 0 : U.title) && void 0 !== l ? l : ''), X = (0, s.e7)([g.Z], () => {
    ...
    let [J, $] = o.useState((x = F, null == (G = U) ? null : null !== (b = x.find(e => e.value === G.actionType)) && void 0 !== b ? b : null)), [ee, el] = o.useState(null !== (n = null == U ? void 0 : U.emoji) && void 0 !== n ? n : null), en = (0, s.e7)([g.Z], () => {
            var e;
            return null === (e = g.Z.getNewMemberAction(null == U ? void 0 : U.channelId)) || void 0 === e ? void 0 : e.icon;
        }), [ea, eo] = o.useState(null), et = null == q || 0 === q.length || null == J || null == V, ei = Object.values(K).flat().length > 0, es = o.useCallback(() => {
            if (null == V || null == J || q.length <= 0)
                return;
            let e = {
                    channelId: V.value,
                    title: q,
            ...
            if (null == e || null == B)
                return null;
            let l = _.Z.getChannel(e.value), n = h.Z.getGuild(B);
            if (null == l || null == n)
                return null;
            let o = (0, d.KS)(l, n);
            ...
            e_(null, t = null == l.id ? {
                ...
                id: l.id,
                name: null !== (o = l.originalName) && void 0 !== o ? o : l.name,
                animated: l.animated
            }), n && e();
        }, ep = null;
    return ep = null != eN ? (0, a.jsxs)(a.Fragment, {
        children: [
            (0, a.jsx)('img', {
                src: eN,
                alt: '',
        ...
        children: [
            (0, a.jsx)(u.Z, {
                animated: null !== (t = ee.animated) && void 0 !== t && t,
                emojiId: ee.id,
                emojiName: ee.name
            }),
            (0, a.jsx)('div', {
                    ...
                    (0, a.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, a.jsx)(r.Text, {
                                ...
                                color: 'text-muted',
                                children: A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_CHANNEL_EXPLAINER
                            })
                        ]
                    }),
                    (0, a.jsx)('div', { className: j.separator }),
                            ...
                            (0, a.jsxs)('div', {
                                children: [
                                    (0, a.jsx)(r.Heading, {
                                        variant: 'heading-md/semibold',
                                        color: 'header-primary',
                                        children: A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_ICON
                                    }),
                                    (0, a.jsx)(r.Text, {
                                        variant: 'text-xs/medium',
                                        color: 'text-muted',
                                        children: A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_ICON_EXPLAINER
                                    })
                                ]
                            }),
                            (0, a.jsx)('div', {
                                ...
                                children: (0, a.jsx)(r.Popout, {
                                    position: 'bottom',
                                    renderPopout: e => {
                                        let l = e.closePopout, n = (0, a.jsxs)(a.Fragment, {
                                                children: [
                                                    (0, a.jsx)(m.ZP, {
                                                        onChange: e => {
                                                            eh(e), l();
                                                    ...
                                                    (0, a.jsx)(r.Text, {
                                                        ...
                                                        color: 'none',
                                                        children: A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_ICON_UPLOAD
                                                    })
                                                ]
                                            }), o = (0, a.jsx)(r.Popout, {
                                                position: 'top',
                                                ...
                                                children: e => (0, a.jsx)(r.Text, {
                                                    ...
                                                    variant: 'text-sm/medium',
                                                    color: 'none',
                                                    children: A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_ICON_EMOJI
                                                })
                                            });
                                        return (0, a.jsxs)(r.Menu, {
                                            ...
                                            children: [
                                                ...
                                                (0, a.jsx)(r.MenuItem, {
                                                    id: 'clear',
                                                    color: 'danger',
                                                    label: A.Z.Messages.GUILD_SETTINGS_ONBOARDING_ACTION_ICON_REMOVE,
                                                    icon: r.TrashIcon,
                                                    action: () => {
                                                        e_(null);
                                                    }
                    ...
                    (0, a.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, a.jsx)(r.RadioGroup, {
                                ...
                                onChange: ec,
                                options: (L = F, null == (R = z) ? L : L.map(e => ({
                                    ...e,
                                    disabled: !S(e.value, R)
                                })))
                            }),
                            null != J && K.actionType.length > 0 ? K.actionType.map(e => (0, a.jsx)(r.Text, {

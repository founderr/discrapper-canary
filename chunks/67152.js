...
let j = (e, t, n, i) => {
        ...
        switch (e) {
            case N.x_.OPEN:
                return (0, l.jsxs)(l.Fragment, {
                    children: [null != s ? T.intl.formatToPlainString(T.t.I6YOjY, { payoutDate: s }) : T.intl.string(T.t.G5ATX1), (0, l.jsx)(_.Z, { className: b.statusScheduledIcon })]
                });
            case N.x_.CANCELED:
                return (0, l.jsxs)(l.Fragment, {
                    children: [
            ...
            case N.x_.PAYOUT_DEFERRED:
                ...
                return (0, l.jsxs)(l.Fragment, {
                    children: [T.intl.string(T.t.OtZ5k5), (0, l.jsx)(I.Z, { className: b.statusDeferredIcon })]
                });
        }
        switch (t) {
            case N.jw.MANUAL:
            ...
            case N.jw.ERROR:
                return (0, l.jsxs)(l.Fragment, {
                    children: [null != s ? T.intl.formatToPlainString(T.t.I6YOjY, { payoutDate: s }) : T.intl.string(T.t.ubdQTk), (0, l.jsx)(_.Z, { className: b.statusScheduledIcon })]
                });
            case N.jw.PAID:
                return (0, l.jsxs)(l.Fragment, {
                    children: [
    ...
    O = [
        {
            key: 'dropdown',
            cellClassName: b.toggleExpandColumn,
            renderHeader: () => null,
            render(e, t) {
                let { expandedRows: n, onToggleExpandRow: i } = t,
                    r = n.has(e.key);
                return (0, l.jsx)(m.Clickable, {
                    className: o()(b.cell, b.toggleExpandCell),
                    onClick: () => i(e.key),
                    children: (0, l.jsx)(m.ChevronSmallRightIcon, {
                        size: 'md',
                        color: 'currentColor',
                        className: o()(b.caretIcon, { [b.caretDownIcon]: r })
                    })
                });
            }
        },
        ...
        {
            key: 'amount',
            cellClassName: o()(b.amountColumn, b.cellAlignRight),

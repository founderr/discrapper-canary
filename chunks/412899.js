...
tabIndex: g,
...f
  } = (0, a.JA)(O.id), Z = (0, C.p9)({
roleId: O.id,
size: 16,
guildId: u
  }), P = (0, L.e7)([o.Z], () => o.Z.roleStyle), H = (null === (I = O.tags) || void 0 === I ? void 0 : I.guild_connections) === null, p = T.useCallback(e => {
(0, U.jW)(e, async () => {
  let {
    default: e
  } = await E.e('5396').then(E.bind(E, 731646));
  return _ => (0, s.jsx)(e, {
    ..._,
    id: O.id,
  ...
  }, [O.id]), h = (0, D.useToken)(S.Z.unsafe_rawColors.PRIMARY_300).hsl(), F = null !== (t = O.colorString) && void 0 !== t ? t : h, V = null !== (A = (0, l.wK)(F, 0.6)) && void 0 !== A ? A : void 0, B = S.Z.unsafe_rawColors.WHITE_500.css, b = (0, l._i)(F);
  null != b && 0.3 > (0, l.Bd)(b) && (B = S.Z.unsafe_rawColors.PRIMARY_630.css), r = H ? (0, s.jsx)(M.Z, {
className: v.roleFlowerStar,
iconClassName: N ? v.roleVerifiedIcon : void 0,
color: F,
size: 14
  }) : 'dot' === P ? (0, s.jsx)(D.RoleDot, {
className: v.roleDot,
color: F,
background: !1,
tooltip: !1
  }) : (0, s.jsx)(D.RoleCircle, {
color: F
  });
  let x = T.useMemo(() => {
var _;
...
numRolesHidden: E,
roleClassName: T
  } = e, I = (0, a.JA)('overflow-more-roles-'.concat(_.id));
...
position: 'top',
align: 'center',
children: e => (0, s.jsx)(D.FocusRing, {
...
addButtonIconClassName: A
  } = e, r = (0, a.JA)('overflow-add-roles-'.concat(E.id)), N = (0, L.e7)([o.Z], () => o.Z.roleStyle), l = Z.Z.getHighestRole(_), S = g.ZP.getMember(_.id, E.id), U = e => (0, i.Gy)(_.id, e.id) && !e.managed && Z.Z.isRoleHigher(_, l, e) && (null == S || -1 === S.roles.indexOf(e.id));
  return (0, s.jsx)(D.Popout, {
renderPopout: e => {
  let {
    closePopout: E
...
disableBorderColor: o
  } = e, i = T.useRef({}), M = T.useCallback(e => {
var _;
...
I.id,
E.id
  ]), [R, c] = T.useState(null), C = (0, L.e7)([f.Z], () => f.Z.getRoles(I.id)), g = T.useMemo(() => {
let e = Object.values(C).filter(e => t.includes(e.id)).sort((e, _) => {
  var E, s;

...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(512722), l = n.n(s), u = n(772848), c = n(91192), d = n(924826), _ = n(866442), E = n(442837), f = n(692547), h = n(481060), p = n(239091), m = n(749210), I = n(112724), T = n(607070), g = n(605436), S = n(134433), A = n(518738), N = n(434404), v = n(271383), O = n(430824), R = n(496675), C = n(594174), y = n(285952), D = n(153124), L = n(176278), b = n(700785), M = n(944613), P = n(981631), U = n(689938), w = n(371173);
            ...
            (0, r.jsxs)(y.Z, {
                ...
                children: [
                    ...
                    (0, r.jsx)('div', {
                        ...
                        id: a,
                        children: U.Z.Messages.ROLES_LIST.format({ numRoles: t.length })
                    })
                ]
            }),
            (0, r.jsx)(V, {
        ...
        children: (0, r.jsxs)('div', {
            ...
            children: [
                (0, r.jsxs)(h.Clickable, {
                    ...
                    'aria-hidden': !d,
                    'aria-label': U.Z.Messages.GUILD_SETTINGS_MEMBERS_REMOVE_ROLE.format({ roleName: I.name }),
                    children: [
                        u,
...
function V(e) {
    ...
    i.useLayoutEffect(() => {
        ...
        let e = 0, t = 0, n = f - 30 - 4;
        for (let r = 0; r < L.length; r++) {
            let i = L[r], a = g.current[i.id];
            if (null != a) {
    ...
    let V = !p && R.Z.can(P.Plq.MANAGE_ROLES, a), H = b.e9(a, G.id), Z = i.useMemo(() => 'roles-'.concat((0, u.Z)()), []), Y = (0, d.ZP)({
            id: Z,
            isEnabled: !0,
            scrollToStart: x,
            scrollToEnd: x,
        ...
        children: (0, r.jsx)(c.SJ, {
            children: e => {
                ...
                return (0, r.jsxs)('div', {
                    ...
                    'aria-label': U.Z.Messages.ROLES_LIST.format({ numRoles: s.length }),
                    ref: n,
                    ...i,
                    children: [
                        j,
...
function Z(e) {
    ...
    }), !1 === e.wrap ? (0, r.jsx)(H, { ...e }) : (0, r.jsx)(V, { ...e });
}

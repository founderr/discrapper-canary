...
function V(e) {
  ...
  } = e, u = (0, _.JA)("overflow-add-roles-".concat(n.id)), c = (0, E.e7)([N.Z], () => N.Z.roleStyle), d = C.Z.getHighestRole(t), I = p.ZP.getMember(t.id, n.id), h = e => (0, A.Gy)(t.id, e.id) && !e.managed && C.Z.isRoleHigher(t, d, e) && (null == I || -1 === I.roles.indexOf(e.id));
  return (0, i.jsx)(T.Popout, {
    renderPopout: e => {
      let {
        closePopout: n

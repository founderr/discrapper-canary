        ...
        children: (0, r.jsxs)('div', {
            ...
            children: [
                (0, r.jsxs)(T.Clickable, {
                    ...
                    'aria-hidden': !c,
                    'aria-label': P.intl.formatToPlainString(P.t.QrxwhY, { roleName: N.name }),
                    children: [
                        E,
                        c
        ...
        K = L.map((e) => {
            ...
            return (0, r.jsx)(
                y,
                {
                    className: N,
                    role: e,
                    canRemove: (z && v.r6(i, j.id, H, e)) || ((null === (t = e.tags) || void 0 === t ? void 0 : t.guild_connections) === null && n.id === j.id),
                    onRemove: () => O(e),
                    ref: (t) => {
                        var n, r;

...
e.exports = function (e) {
    let n = e.regex, r = n.either(n.concat(/([2-9]|[1-2]\d|[3][0-5])\^\^/, /(\w*\.\w+|\w+\.\w*|\w+)/), /(\d*\.\d+|\d+\.\d*|\d+)/), i = n.either(/``[+-]?(\d*\.\d+|\d+\.\d*|\d+)/, /`([+-]?(\d*\.\d+|\d+\.\d*|\d+))?/), a = n.concat(r, n.optional(i), n.optional(/\*\^[+-]?\d+/)), o = /[a-zA-Z$][a-zA-Z0-9$]*/, s = new Set(t), l = {

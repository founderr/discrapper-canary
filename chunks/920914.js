...
let w = e => {
    ...
    let a, {integration: i} = e, {
        ...
        }), [i.id]), d = null != (0, o.e7)([R.Z], () => R.Z.getGuild(i.guild.id), [i.guild.id]);
...
function k(e) {
    ...
    function $() {
        let e = C.Z.get(T.type), t = y.Z.Messages.DISCONNECT_ACCOUNT_BODY;
    ...
    return (0, n.jsxs)('div', {
        ...
        children: [
            ...
            function (e) {
                var t;
                let s = null !== (t = e.metadata) && void 0 !== t ? t : {}, a = null, i = (0, A.FI)(s[G.PC.CREATED_AT], N);
                switch (e.type) {
                case U.ABu.REDDIT:
                ...
                let r = z.includes(e.id), o = y.Z.Messages.REFRESH;
            ...
            (s = q, U.BFP.has(T.type) && (r = (0, n.jsx)(_.FormSwitch, {
                ...
                children: (0, n.jsx)(_.Text, {
                    variant: 'text-sm/semibold',
                    children: y.Z.Messages.DISPLAY_ACTIVITY.format({ platform: s.name })
                })
...
function W(e) {
    let t = C.Z.get(e);
    (0, h.Z)({ platformType: t.type }), P.default.track(U.rMx.ACCOUNT_LINK_STEP, {
...
function K() {
    ...
    let t = (0, m.fq)(), s = (0, _.useRedesignIconContext)().enabled ? 24 : 18;
    return (0, n.jsxs)('div', {
...
t.Z = () => {
    let e = (0, o.e7)([M.Z], () => M.Z.hidePersonalInformation), t = (0, o.e7)([p.Z], () => p.Z.isFetching()), s = (0, o.e7)([p.Z], () => p.Z.getAccounts()), i = (0, N.ZP)();

...
M(t), u.Z.setVisibility(T.type, T.id, t);
  }
...
children: [
  ...
  (s = T).twoWayLink ? null : s.type === U.ABu.XBOX ? (0, n.jsx)('div', {
  ...
  (t = q, U.BFP.has(T.type) && (r = (0, n.jsx)(_.FormSwitch, {
...
children: [
  s.slice(0, 10).map(e => (0, n.jsx)(I.Z, {
    type: e.type,

...
function F(e) {
  let {
    ...
    type: R,
    contentType: W
  } = n, [z, X] = l.useState(!1), U = (0, d.default)(t.getChannelId()), q = l.useMemo(() => null != W && -1 !== W.indexOf("/") ? W.split("/") : ["unknown", "unknown"], [W]), K = l.useCallback(() => {
    u(n)
  }, [n, u]), Y = l.useCallback(() => {
    if (F === A.MediaLayoutType.MOSAIC) {
      let e = !U && ["VIDEO", "CLIP", "AUDIO"].includes(R) || "OTHER" === R;
      if (w) {
        ...
        if (!V && (e * H < A.MINIMUM_MEDIA_MOSAIC_DIM || e * k < A.MINIMUM_MEDIA_MOSAIC_DIM)) return null
      }
      return !z && (0, i.jsx)(j, {

...
A = (0, a.useMemo)(() => h(n.calendar), [
  h,
  n.calendar
]),
[N, v] = (0, i.zk)(e.value, e.defaultValue, e.onChange),
O = (0, a.useMemo)(() => N ? (0, r.Mw)((0, r.WG)(N), A) : null, [
  N,
  A
]),
...
C = (0, a.useMemo)(() => e.focusedValue ? d((0, r.Mw)((0, r.WG)(e.focusedValue), A), I, m) : void 0, [
  e.focusedValue,
  A,
  I,
  m
]),
y = (0, a.useMemo)(() => d(e.defaultFocusedValue ? (0, r.Mw)((0, r.WG)(e.defaultFocusedValue), A) : O || (0, r.Mw)((0, r.Lg)(R), A), I, m), [
...
L(e = d(e, I, m));
  ...
  function B(t) {
!e.isDisabled && !e.isReadOnly && (t = _(t = d(t, I, m), b, g)) && (t = (0, r.Mw)(t, (null == N ? void 0 : N.calendar) || new r.IQ()), N && 'hour' in N ? v(N.set(t)) : v(t));
  }
  s(D, I, m) ? L(d(D, I, m)) : 0 > D.compare(b) ? M(u(D, p, E, I, m)) : D.compare(w) > 0 && M(l(D, p, E, I, m));
  let F = (0, a.useMemo)(() => !!O && (!!(g && g(O)) || s(O, I, m)), [
  O,
  g,
  I,
  m
...
focusNextRow() {
  p.days ? this.focusNextPage() : (p.weeks || p.months || p.years) && k(D.add({
    weeks: 1
  }));
},
focusPreviousRow() {
  p.days ? this.focusPreviousPage() : (p.weeks || p.months || p.years) && k(D.subtract({
    weeks: 1
  }));
},
focusNextPage() {
...
focusNextSection(e) {
  ...
  p.days ? this.focusNextPage() : p.weeks ? k(D.add({
    months: 1
  })) : (p.months || p.years) && k(D.add({
    years: 1
  }));
},
focusPreviousSection(e) {
  ...
  p.days ? this.focusPreviousPage() : p.weeks ? k(D.subtract({
    months: 1
  })) : (p.months || p.years) && k(D.subtract({
    years: 1
  }));
},
selectFocusedDate() {
...
D = (0, a.useMemo)(() => (0, r.l7)(h, null == C ? void 0 : C.start), [
  h,
  C
]),

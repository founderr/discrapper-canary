...
var S = () => {
  let e = (0, r.useStateFromStores)([I.default], () => I.default.isAuthenticated()),
    t = (0, r.useStateFromStores)([_.default], () => _.default.hasLoadedExperiments),
  ...
  return a.useEffect(() => {
    ...
    children: [(0, s.jsx)(h.Title, {
      ...
      children: T.default.Messages.URF_LANDING_PAGE_SUBTITLE.format({
        supportURL: p.default.getArticleURL(m.HelpdeskArticles.COPYRIGHT_AND_IP_POLICY)
      })
    }), (0, s.jsxs)("div", {

...
applicationId: e
  ...
  return {
application: l.Z.getApplication(e)
  };
})(function(t) {
  let {
application: e,
  ...
  (0, a.jsxs)(n.ModalHeader, {
    ...
    children: [
      (0, a.jsx)(n.FormTitle, {
        ...
        children: null != e ? N.Z.Messages.MISSING_ENTITLEMENT_MODAL_HEADER.format({
  ...
  (0, a.jsxs)(n.ModalContent, {
    children: [
      ...
      (0, a.jsx)(n.Text, {
        ...
        children: null != e ? N.Z.Messages.MISSING_ENTITLEMENT_MODAL_BODY.format({
          applicationName: e.name,
          supportArticleURL: M

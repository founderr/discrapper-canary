...
var a = class e {
  ...
  update(e) {
    ...
    if (this.speedUp > 0 ? (this.speedUp = Math.max(0, this.speedUp - e), this.count += e * (10 * Math.min(this.speedUp, 1) + .4)) : this.count += .4 * e, t = (0, i.applySpringForce)(this.targetX, this.x, this.velX, this.spring), n = (0, i.applySpringForce)(this.targetY, this.y, this.velY, this.spring), this.velX += t * e, this.velY += n * e, this.oscillate) {
      let s = this.targetX + this.waveRange * Math.cos(this.angle) * Math.sin(this.count),
        r = this.targetY + this.waveRange * Math.sin(this.angle) * Math.sin(this.count);
      t = (0, i.applySpringForce)(s, this.x, this.velX, this.spring), n = (0, i.applySpringForce)(r, this.y, this.velY, this.spring), this.velX += t * e, this.velY += n * e
    }
  ...
  constructor(e) {
    this.x = -40, this.y = -40, this.targetX = 0, this.targetY = 0, this.oscillate = !0, this.velX = 0, this.velY = 0, this.angle = 0, this.speedUp = 1.5, this.waveRange = 60, this.spring = {
      friction: 15,
      tension: s.POINT_TENSION_DEFAULT
    }, this.index = e, this.spring.tension = s.POINT_TENSION_DEFAULT * Math.max(.1, e / 7) + s.POINT_TENSION_DEFAULT, this.count = r * e
  }
}
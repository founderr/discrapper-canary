...
var i = n(120356),
    ...
    d = n(926506);
let _ = (e) => {
        let { className: t, graphicPrimary: n, graphicSecondary: i, titlePrimary: s, titleSecondary: l, isFavorite: _ = !1, emojiSubCategory: f = u.t0.NONE } = e;
        return (0, r.jsxs)('div', {
                            ...
                            children: [
                                _
                                    ? (0, r.jsx)(o.StarIcon, {
                                          size: 'custom',
                                          color: 'currentColor',
                                          'aria-label': _ ? c.Z.Messages.EMOJI_IS_FAVORITE_ARIA_LABEL.format({ names: s }) : void 0,
                                          width: 15,
                                          height: 15,

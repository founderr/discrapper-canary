var i = n(200651),
    ...
    v = n(396602);
t.Z = (0, s.Z)((e) => {
    let { participants: t, filteredParticipants: n, selectedParticipant: a, participantsVersion: s, layout: _, onSelectParticipant: I, onContextMenuParticipant: E, onFullscreenParticipant: b, channel: Z, hasConnectPermission: N, className: S, inCall: T, showParticipants: j = !0, paused: A = !1, width: y, height: P, idle: M, mode: L, popoutWindow: R, awaitingRemoteSessionInfo: k, callContainerDimensions: O } = e;
    l.useEffect(() => {

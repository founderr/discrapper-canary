...
function m(e, t, n) {
  ...
  return null != window.GLOBAL_ENV.CDN_HOST ? "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/app-assets/").concat(e, "/").concat(t, ".png").concat(r) : "".concat((0, a.getAPIBaseURL)(), "/applications/").concat(e, "/app-assets/").concat(t, ".png").concat(r)
}
async function N(e) {
  let t = await

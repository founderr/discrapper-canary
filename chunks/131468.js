...
class o extends s.Z {
  ...
  constructor(...e) {
    super(...e), l(this, "_playSound", function(e) {
      ...
      if (null != t && i !== a.default.getId()) return this._playSound(t, n, i, s)

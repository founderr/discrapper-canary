n(47120);
var a, l, i = n(735250), s = n(470079), o = n(120356), r = n.n(o), c = n(913527), d = n.n(c), u = n(442837), m = n(846519), p = n(212605), C = n(481060), v = n(100527), g = n(906732), h = n(318374), x = n(717680), E = n(594174), f = n(863840), L = n(962399), I = n(810090), S = n(626135), M = n(823379), _ = n(709054), N = n(39604), Z = n(572720), T = n(981631), j = n(689938), A = n(827312), b = n(487204);
...
function P(e) {
    let {
            ...
            let e = t.length, n = !1, a = null != t.editMetadata ? t.editMetadata.end - t.editMetadata.start : null;
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    ...
                    !l && (0, i.jsxs)('div', {
                        ...
                        children: [
                            o ? (0, i.jsx)(L.Z, { className: A.clipDurationEditIcon }) : null,
                            (0, i.jsx)(C.Text, {
                                variant: 'text-md/medium',
                                color: 'always-white',
...
function R(e) {
    ...
    let {
            ...
            x(!0), await (0, N.Tm)(n.id, { name: '' === v ? void 0 : v }), x(!1), m(!1);
        };
    return (s.useEffect(() => {
        if (o !== n.name) {
            var e;
...
function y(e) {
    let {
            ...
            e.stopPropagation(), e.shiftKey ? (l(), (0, N.sS)(t.filepath)) : o(t, l), S.default.track(T.rMx.CLIP_GALLERY_CARD_BUTTON_CLICKED, { type: 'delete' });
        }, [
            o,
            l,
            t
        ]), p = s.useCallback(e => {
            e.stopPropagation(), r(t), S.default.track(T.rMx.CLIP_GALLERY_CARD_BUTTON_CLICKED, { type: 'edit' });
        }, [
            r,
            t
        ]), v = s.useCallback(e => {
            e.stopPropagation(), c(t), S.default.track(T.rMx.CLIP_GALLERY_CARD_BUTTON_CLICKED, { type: 'share' });
        }, [
            c,
            t
        ]);
        ...
        children: [
            ...
            (0, i.jsx)(C.Tooltip, {
                ...
                children: e => (0, i.jsx)(C.Button, {
                    ...
                    size: C.Button.Sizes.NONE,
                    look: C.Button.Looks.FILLED,
                    children: (0, i.jsx)(L.Z, { className: A.miniIcon })
                })
            }),
            (0, i.jsx)(C.Tooltip, {
...
t.Z = function (e) {
    ...
    let {
            ...
            onEdit: x,
            onShare: L
        } = e, I = (0, u.Wu)([E.default], () => l.users.map(e => E.default.getUser(e)).filter(M.lm)), {analyticsLocations: N} = (0, g.ZP)(v.Z.CLIPS_GALLERY_ITEM), [Z, b] = s.useState(!1), k = s.useRef(null), B = (0, f.Z)(null !== (a = null === (t = l.editMetadata) || void 0 === t ? void 0 : t.start) && void 0 !== a ? a : 0), D = s.useRef(new m.sW(500, () => {
            var e;
            let t = k.current;
    ...
    return (0, i.jsx)(g.Gt, {
        ...
        children: (0, i.jsxs)(C.ClickableContainer, {
            ...
            className: r()(A.clipItem, { [A.disabled]: c }),
            onBlur: Y,
            onFocus: V,
            onMouseOver: V,
            onMouseLeave: w,
                        ...
                        (0, i.jsxs)('div', {
                            ...
                            children: [
                                (0, i.jsx)(h.Z, {
                                    ...
                                    onFocus: e => {
                                        var t, n, a, l;
                                        let i = e.relatedTarget, s = null === (n = e.currentTarget.parentElement) || void 0 === n ? void 0 : null === (t = n.parentElement) || void 0 === t ? void 0 : t.parentElement;

...
return null != l && 1000 * l < t.length && (e = 1000 * l, a = !0), [
  a,
  d().duration(e)
];
  }, [
...
focused: l,
onFocus: n
  } = e, [o, c] = i.useState(a.name), d = !a.name, [u, m] = i.useState(!1), [v, h] = i.useState(null !== (t = a.name) && void 0 !== t ? t : ''), [x, g] = i.useState(!1), L = async () => {
g(!0), await (0, _.Tm)(a.id, {
  name: '' === v ? void 0 : v
}), g(!1), m(!1);
  };
  return (i.useEffect(() => {
...
onShare: c,
onBlur: d
  } = e, u = (0, f.Z)(), m = i.useCallback(e => {
e.stopPropagation(), e.shiftKey ? (n(), (0, _.sS)(t.filepath)) : o(t, n), S.default.track(M.rMx.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
  type: 'delete'
});
  }, [
o,
...
e.stopPropagation(), r(t), S.default.track(M.rMx.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
  type: 'edit'
});
  }, [
r,
...
e.stopPropagation(), c(t), S.default.track(M.rMx.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
  type: 'share'
});
  }, [
c,
...
onEdit: x,
onShare: f
  } = e, N = (0, u.Wu)([E.default], () => n.users.map(e => E.default.getUser(e)).filter(I.lm)), {
analyticsLocations: _
  } = (0, h.ZP)(v.Z.CLIPS_GALLERY_ITEM), [j, k] = i.useState(!1), R = i.useRef(null), A = (0, g.Z)(null !== (l = null === (t = n.editMetadata) || void 0 === t ? void 0 : t.start) && void 0 !== l ? l : 0), B = i.useRef(new m.sW(500, () => {
var e;
let t = R.current;
...
null === (e = B.current) || void 0 === e || e.cancel(), null != l && (l.pause(), l.currentTime = null !== (a = null === (t = n.editMetadata) || void 0 === t ? void 0 : t.start) && void 0 !== a ? a : 0);
  }, [null === (a = n.editMetadata) || void 0 === a ? void 0 : a.start]), O = i.useCallback(e => {
var t, a;
(null === (a = e.relatedTarget) || void 0 === a ? void 0 : null === (t = a.parentElement) || void 0 === t ? void 0 : t.parentElement) !== e.currentTarget.parentElement && V();
  }, [V]), z = new Date(Z.default.extractTimestamp(n.id)), F = z.toLocaleDateString(), G = z.toLocaleTimeString([], {
hour: '2-digit',
minute: '2-digit'
  }), Y = ''.concat(F, ' \u2022 ').concat(G);
  return (0, s.jsx)(h.Gt, {
            ...
            (0, s.jsx)(L.Z, {
              ...
              onFocus: e => {
                ...
                if ((null == s ? void 0 : s.parentElement) !== i)
                  (null == s ? void 0 : null === (n = s.parentElement) || void 0 === n ? void 0 : null === (l = n.parentElement) || void 0 === l ? void 0 : l.parentElement) !== i && w();
              }
            }),
            j && (0, s.jsx)(D, {
              clip: n,

...
var r = n(512722), i = n.n(r), a = n(457854), o = n(261470), s = n(956067), l = n(286379), u = n(442837), c = n(544891), d = n(570140), _ = n(406966), E = n(795513), f = n(266750), h = n(250407), p = n(710845), m = n(797614), I = n(218543), T = n(857192), g = n(626135), S = n(12647), A = n(70956), N = n(358085), v = n(960048), O = n(138859), R = n(14639), C = n(639655), y = n(610308), D = n(91247), L = n(508569), b = n(183139), M = n(420491), P = n(645436), U = n(833508), w = n(981631);
function x(e, t, n) {
...
let G = new p.Z('GatewaySocket'), k = new y.Z();
function B() {
}
let F = 30 * A.Z.Millis.SECOND, V = 3 * A.Z.Millis.MINUTE, H = 1 * A.Z.Millis.MINUTE;
function Z(e) {
...
class j extends b.Z {
    ...
    _connect() {
        ...
        let e = this.compressionHandler.getAlgorithm(), t = k.getName(), n = this._getGatewayUrl(), r = window.GLOBAL_ENV.API_VERSION;
    ...
    _tryDetectInvalidIOSToken(e, t, n) {
        (0, N.isIOS)() && null != this.token && 1001 === e && 'Stream end encountered' === t && (this.iosGoingAwayEventCount += 1, 3 === this.iosGoingAwayEventCount && c.tn.get({
            ...
            let {status: t} = e;
            g.default.track(w.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, { api_status_code: t });
        }, e => {
            let {status: t} = e;
            401 === t && (this.connectionState = O.Z.CLOSED, G.warn('[WS CLOSED] because of manual authentication failure, marking as closed.'), this._reset(n, 4004, 'invalid token manually detected')), g.default.track(w.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, { api_status_code: t });
        }));
    }
    _reset(e, t, n) {
    ...
    resetSocketOnError(e) {
        ...
        }, !0), !1 !== e.sentry && v.Z.captureException(n, { tags: { socketCrashedAction: t } }), g.default.track(w.rMx.GATEWAY_SOCKET_RESET, {
        ...
        0 === this.dispatchExceptionBackoff._fails ? (G.verbose('Triggering fast reconnect'), this.dispatchExceptionBackoff.fail(() => {

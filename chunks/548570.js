...
if (this._tryDetectInvalidIOSToken(t, n, e), this.connectionState = R.Z.WILL_RECONNECT, this.nextReconnectIsImmediate)
...
(0, v.isIOS)() && null != this.token && 1001 === e && 'Stream end encountered' === t && (this.iosGoingAwayEventCount += 1, 3 === this.iosGoingAwayEventCount && c.tn.get({
  ...
  S.default.track(x.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, {
    api_status_code: t
  });
}, e => {
  let {
  ...
  401 === t && (this.connectionState = R.Z.CLOSED, k.warn('[WS CLOSED] because of manual authentication failure, marking as closed.'), this._reset(n, 4004, 'invalid token manually detected')), S.default.track(x.rMx.IOS_INVALID_TOKEN_WORKAROUND_TRIGGERED, {
    api_status_code: t
  });
}));
  }
...
0 === this.dispatchExceptionBackoff._fails ? (k.verbose('Triggering fast reconnect'), this.dispatchExceptionBackoff.fail(() => {}), setTimeout(() => this._connect(), 0)) : this.dispatchExceptionBackoff.fail(() => this._connect()), i && (this.didForceClearGuildHashes = !0, d.Z.dispatch({
  type: 'CLEAR_CACHES',
  ...
  if (!n || this.isSessionEstablished())
    try {
      if (null != this.webSocket)
        ...
        null != t && null != n && (O.Z.addBreadcrumb({

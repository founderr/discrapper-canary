...
var r = n(512722), i = n.n(r), a = n(457854), o = n(261470), s = n(956067), l = n(286379), u = n(442837), c = n(544891), d = n(570140), _ = n(317381), E = n(406966), f = n(795513), h = n(266750), p = n(250407), m = n(710845), I = n(797614), T = n(218543), g = n(857192), S = n(626135), A = n(12647), N = n(70956), v = n(358085), O = n(960048), R = n(138859), C = n(14639), y = n(639655), D = n(610308), L = n(91247), b = n(508569), M = n(183139), P = n(420491), U = n(645436), w = n(833508), x = n(981631);
function G(e, t, n) {
...
let k = new m.Z('GatewaySocket'), B = new D.Z();
function F() {
}
let V = 30 * N.Z.Millis.SECOND, H = 3 * N.Z.Millis.MINUTE, Z = 1 * N.Z.Millis.MINUTE;
function Y(e) {
...
class W extends M.Z {
    ...
    _connect() {
        ...
        let e = this.compressionHandler.getAlgorithm(), t = B.getName(), n = this._getGatewayUrl(), r = window.GLOBAL_ENV.API_VERSION;
        s.Z.mark('\uD83C\uDF10', 'Socket._connect'), k.info('[CONNECT] '.concat(n, ', ') + 'encoding: '.concat(t, ', ') + 'version: '.concat(r, ', ') + 'compression: '.concat(null != e ? e : 'none')), null !== this.webSocket && (k.error('_connect called with already existing websocket'), this._cleanup(e => e.close(4000))), this.connectionStartTime = Date.now(), this.helloTimeout = setTimeout(() => {
        ...
        i.searchParams.append('encoding', t), i.searchParams.append('v', r.toString()), null != e && i.searchParams.append('compress', e), !function (e) {
            let t, {
                    ...
                    onError: o,
                    onClose: s
                } = e, l = window._ws, u = !1, c = !1, d = null, _ = null;
            if (window._ws = null, null != l) {
                if (t = l.ws, l.state.gateway !== n)
                    k.verbose('[FAST CONNECT] gatewayURL mismatch: '.concat(l.state.gateway, ' !== ').concat(n)), t.close(1000), t = null;
                else {
                    var E;
                    let e = { ...l.state };
            ...
            null == t && ((t = (0, w.Z)(n)).binaryType = 'arraybuffer'), r(t), u && i(c, _), null != d && d.forEach(a), t.onopen = () => i(c, _), t.onmessage = a, t.onclose = s, t.onerror = o;
        }({
            ...
            onOpen: e => {
                s.Z.mark('\uD83C\uDF10', 'GatewaySocket.onOpen '.concat(e)), P.Z.enableFailureTracking();
            ...
            onMessage: function (e, t, n) {
                ...
                if (r !== M.j.DISPATCH && s.Z.mark('\uD83C\uDF10', 'GatewaySocket.onMessage '.concat(r, ' ').concat(M.j[r])), g.default.isLoggingGatewayEvents) {
                    let e = [r];
                    r === M.j.DISPATCH && e.push(a), e.push(o), k.verboseDangerously('<~', ...e);
                }
                let l = Date.now() - n;
                switch ('READY' === a ? T.Z.parseReady.set(n, l) : 'READY_SUPPLEMENTAL' === a ? T.Z.parseReadySupplemental.set(n, l) : l > 10 && s.Z.mark('\uD83C\uDF10', 'Parse ' + a, l), null != i && (this.seq = i), r) {
                case M.j.HELLO:
    ...
    _handleHello(e) {
        let t = this.heartbeatInterval = e.heartbeat_interval, n = Date.now() - this.connectionStartTime;
    ...
    _handleDispatch(e, t, n) {
        ...
        if ('READY' === t) {
            ...
            this.sessionId = t;
            let n = (0, L.TO)(e);
            s.Z.setServerTrace(n), k.info('[READY] took '.concat(r, 'ms, as ').concat(t)), k.verbose(''.concat(n)), this.connectionState = R.Z.SESSION_ESTABLISHED, this.gatewayBackoff.succeed(), this.iosGoingAwayEventCount = 0, this.setResumeUrl(e.resume_gateway_url);
        } else
            'READY_SUPPLEMENTAL' === t ? (k.info('[READY_SUPPLEMENTAL] took '.concat(r, 'ms')), this.connectionState = R.Z.SESSION_ESTABLISHED, this.gatewayBackoff.succeed(), this.iosGoingAwayEventCount = 0) : 'RESUMED' === t && (k.verbose((0, L.TO)(e)), this.connectionState = R.Z.SESSION_ESTABLISHED, this.gatewayBackoff.succeed(), this.iosGoingAwayEventCount = 0);
    ...
    _handleClose(e, t, n) {
        ...
        if (this._tryDetectInvalidIOSToken(t, n, e), _.ZP.getSelfEmbeddedActivities().size > 0) {
            var r;
            let [i, a] = null !== (r = Array.from(_.ZP.getSelfEmbeddedActivities().entries())[0]) && void 0 !== r ? r : [];
            null != i && null != a && (O.Z.addBreadcrumb({
            ...
            }), S.default.track(x.rMx.ACTIVITIES_GATEWAY_CLOSED, {
                application_id: i,
                channel_id: a.channelId,
                guild_id: a.guildId,
                code: t,
        ...
        if (this.connectionState = R.Z.WILL_RECONNECT, this.nextReconnectIsImmediate)
            k.info('[WS CLOSED] ('.concat(e.toString(), ', ').concat(t, ', ').concat(n, ') retrying immediately.')), this._connect();
        else {
            let r = this.gatewayBackoff.fail(() => this._connect());
            k.info('[WS CLOSED] ('.concat(e.toString(), ', ').concat(t, ', ').concat(n, ') retrying in ').concat((r / 1000).toFixed(2), ' seconds.')), this.gatewayBackoff.fails > 4 && this._reset(e, t, n);
        }
    }
    _tryDetectInvalidIOSToken(e, t, n) {
        (0, v.isIOS)() && null != this.token && 1001 === e && 'Stream end encountered' === t && (this.iosGoingAwayEventCount += 1, 3 === this.iosGoingAwayEventCount && c.tn.get({
            url: x.ANM.ME,
    ...
    _doResume() {
        var e;
        this.connectionState = R.Z.RESUMING, this.dispatcher.resumeAnalytics = (0, L.zH)(Date.now() - this.connectionStartTime), k.info('[RESUME] resuming session '.concat(null !== (e = this.sessionId) && void 0 !== e ? e : '', ', seq: ').concat(this.seq)), this.send(M.j.RESUME, {
            token: this.token,
    ...
    async _doIdentify() {
        ...
        this.token = s, k.verbose('[IDENTIFY]');
        let c = {
                token: s,
                capabilities: C.Z,
                properties: l,
    ...
    resetSocketOnError(e) {
        ...
        }, !0), !1 !== e.sentry && O.Z.captureException(n, { tags: { socketCrashedAction: t } }), S.default.track(x.rMx.GATEWAY_SOCKET_RESET, {
            error_message: n.message,
            error_stack: n.stack,
            action: t
        }), this._cleanup(e => e.close()), this._reset(!0, 1000, 'Resetting socket due to error.'), this.dispatcher.clear(), this.connectionState = R.Z.WILL_RECONNECT, this.dispatchExceptionBackoff.cancel();
        let i = e.clearCache || this.dispatchExceptionBackoff._fails > 0;
        0 === this.dispatchExceptionBackoff._fails ? (k.verbose('Triggering fast reconnect'), this.dispatchExceptionBackoff.fail(() => {
        }), setTimeout(() => this._connect(), 0)) : this.dispatchExceptionBackoff.fail(() => this._connect()), i && (this.didForceClearGuildHashes = !0, d.Z.dispatch({
            type: 'CLEAR_CACHES',
            reason: 'Socket reset during '.concat(t)
        })), clearTimeout(this.dispatchSuccessTimer), this.dispatchSuccessTimer = setTimeout(() => this.dispatchExceptionBackoff.succeed(), 2 * Z);
    }
    ...
    close() {
        ...
        let t = e ? 4000 : void 0;
        this._cleanup(e => e.close(t)), this.connectionState = R.Z.CLOSED, !e && setImmediate(() => {
    ...
    expeditedHeartbeat(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '', n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], r = !(arguments.length > 3) || void 0 === arguments[3] || arguments[3];
        if (!this.isClosed()) {
            if (this.isConnected()) {
    ...
    constructor() {
        super(), G(this, 'gatewayBackoff', void 0), G(this, 'handleIdentify', void 0), G(this, 'dispatchExceptionBackoff', new o.Z(1000, Z)), G(this, 'dispatchSuccessTimer', 0), G(this, 'connectionState_', void 0), G(this, 'webSocket', void 0), G(this, 'seq', void 0), G(this, 'sessionId', void 0), G(this, 'token', void 0), G(this, 'initialHeartbeatTimeout', void 0), G(this, 'expeditedHeartbeatTimeout', void 0), G(this, 'heartbeatInterval', void 0), G(this, 'helloTimeout', void 0), G(this, 'heartbeater', void 0), G(this, 'lastHeartbeatTime', void 0), G(this, 'lastHeartbeatAckTime', void 0), G(this, 'heartbeatAck', void 0), G(this, 'connectionStartTime', void 0), G(this, 'identifyStartTime', void 0), G(this, 'nextReconnectIsImmediate', void 0), G(this, 'compressionHandler', void 0), G(this, 'hasConnectedOnce', void 0), G(this, 'isFastConnect', void 0), G(this, 'didForceClearGuildHashes', !1), G(this, 'identifyUncompressedByteSize', 0), G(this, 'identifyCompressedByteSize', 0), G(this, 'analytics', {}), G(this, 'identifyCount', 0), G(this, 'resumeUrl', null), G(this, 'iosGoingAwayEventCount', 0), G(this, 'dispatcher', void 0), G(this, 'send', (e, t, n) => {
            ...
            if (!n || this.isSessionEstablished())
                try {
                    null != this.webSocket ? this.webSocket.send(r) : k.warn('Attempted to send without a websocket that exists. Opcode: '.concat(e));
                } catch (e) {
                }
            else
                k.warn('Attempted to send while not being in a connected state opcode: '.concat(e));
        }), this.dispatcher = new b.Z(this), this.gatewayBackoff = new o.Z(1000, 60000), this.connectionState_ = R.Z.CLOSED, this.webSocket = null, this.seq = 0, this.sessionId = null, this.token = null, this.initialHeartbeatTimeout = null, this.expeditedHeartbeatTimeout = null, this.lastHeartbeatTime = null, this.lastHeartbeatAckTime = null, this.helloTimeout = null, this.heartbeatInterval = null, this.heartbeater = null, this.heartbeatAck = !0, this.connectionStartTime = 0, this.identifyStartTime = 0, this.nextReconnectIsImmediate = !1, this.compressionHandler = (0, y.I)(B), this.hasConnectedOnce = !1, this.isFastConnect = !1, this.identifyCount = 0, this.iosGoingAwayEventCount = 0;
    }
}

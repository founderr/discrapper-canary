...
var s = n(594174), r = n(63063), i = n(74538), a = n(981631), l = n(689938);
function o(e) {
    switch (e) {
    case a.evJ.TOO_MANY_USER_GUILDS:
        let t = s.default.getCurrentUser(), n = i.ZP.canUseIncreasedGuildCap(t) || (null == t ? void 0 : t.isStaff()) ? a.tHP : a.DZw;
        return {
...
function c(e) {
    ...
    case a.evJ.INVITES_DISABLED:
        return l.Z.Messages.INVITES_DISABLED_MODAL_DESCRIPTION.format({ articleLink: r.Z.getArticleURL(a.BhN.INVITE_DISABLED) });
    default:

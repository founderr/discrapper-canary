...
function f(e, t, n) {
  ...
  return (0, a.e7)([l.ZP, r.default, s.Z], () => {
    let a = {},
      d = l.ZP.getMember(t, e),
      h = r.default.getUser(e);
    if (null == u || null == d || null == h) return a;
    let p = s.Z.getRole(u.id, u.getEveryoneRoleId()),
      m = o.uB({
        user: h,
        context: u
      });
    for (let e of n) {
      ...
      if (!!i.e$(m, t)) {
        for (let n of (a[e] = [], d.roles)) {
          ...
          if (null != l)(i.e$(l.permissions, c.Plq.ADMINISTRATOR) || i.Db(l.permissions, t)) && a[e].push(l.id)
        }

    ...
    [k.SearchAutocompleteGroups.HISTORY]: {
      ...
      component: function(e) {
        let {
          ...
          var e;
          return e = s.text, j.tokenizeQuery(e).map((e, t, n) => j.filterHasAnswer(e, n[t + 1]) ? e : new g.Token(e.getFullMatch(), g.NON_TOKEN_TYPE))
        }, [s.text]).map(e => {
    ...
    super(...e), t = this, B(this, "state", {
      ...
      if (s.type !== r.mode.type) this.setSelectedIndex(-1);
        ...
        let e = j.getFlattenedStringArray(r.autocompletes, r.mode.type)[t.selectedIndex - 1],
          n = j.getFlattenedStringArray(i, s.type).indexOf(e); - 1 !== n ? this.setSelectedIndex(n) : t.selectedIndex >= l && this.setSelectedIndex(l - 1)
      }
      ...
      t < -1 || !a && t < 0 ? t = j.getTotalResults(n) - 1 : a && t >= j.getTotalResults(n) ? t = -1 : !a && t >= j.getTotalResults(n) && (t = 0), this.setSelectedIndex(t)
      ...
      if (j.showDatePicker(a.filter)) return;
      let l = j.getFlattenedStringArray(n, a.type);
      ...
      F.ComponentDispatch.dispatch(k.ComponentActions.SET_SEARCH_QUERY, {
        query: e,
        anchor: s,
        focus: i,
        performSearch: n
      ...
      return e.type !== k.SearchPopoutModes.FILTER && e.type !== k.SearchPopoutModes.EMPTY && !j.showDatePicker(e.filter)
      ...
      F.ComponentDispatch.dispatch(k.ComponentActions.PERFORM_SEARCH, null != e ? e : {})
      ...
      if (j.showDatePicker(s.filter)) return this.renderDatePicker();
      let i = -1;
      return l.map(l => {
        var r, o, u;
        let d, c;
...
t.default = l.forwardRef((e, t) => {
  let [n, l, s] = (0, E.useStateFromStoresArray)([R.default, M.default, v.default], () => {
    ...
    let a = v.default.getState(n),
      l = j.getTotalResults(a.autocompletes);
    return [n, a, l]
  });
  return (0, a.jsx)(X, {
    ...e,

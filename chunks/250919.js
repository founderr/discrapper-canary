...
t.forEach((t, n) => {
  if (null == t)
    throw Error(''.concat(e, ' tried to load a non-existent store. Either it isn\'t defined or there is a circular dependency. Loaded ').concat(n, ' stores before error.'));

var i = n(735250), s = n(470079), a = n(703656), r = n(970731), l = n(626135), o = n(63063), c = n(973005), d = n(981631), u = n(921944), _ = n(689938), E = n(854966);
t.Z = e => {
    ...
    return s.useEffect(() => {
        ...
        onSecondaryClick: () => {
            (0, a.uL)(d.Z5c.SETTINGS('privacy-and-safety')), l.default.track(d.rMx.DM_SAFETY_COACHMARK_ACTION, { action: c.Rv.CHANGE_SETTING });
        },
        markAsDismissed: t,

...
function Y(e) {
  ...
  let eL = u.useCallback(() => {
    ...
    eU = u.useMemo(() => () => null == g ? void 0 : g(et === R.PurchaseState.COMPLETED, el), [g, et, el]);
  (0, m.usePaymentStepForAuthentication)(ec, eo, ex), (0, C.usePurchaseStateForStep)(ec, et, en), (0, S.usePurchaseTokenAuthStep)(ec, ef, ex), (0, _.default)(eU), (0, P.useUnsupportedExternalSubscriptionModalHandler)(e_, () => g(!1), eA), (0, m.usePaymentAuthenticationPoller)(eo);
...
function j(e) {
  let {
    ...
    autoTrackExposure: !1
  }), [x, U] = u.useState(!0), D = (0, r.default)([M.default], () => M.default.applicationIdsFetched.has(b.PREMIUM_SUBSCRIPTION_APPLICATION));
  return (u.useEffect(() => {
    U(!p || !m || S)

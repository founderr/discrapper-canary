...
let g = [
	{
		...
		handler: (e) =>
			(0, a.openModalLazy)(async () => {
				let { default: t } = await Promise.all([n.e('22347'), n.e('56236'), n.e('2938')]).then(n.bind(n, 17671));
				return (n) =>
					(0, i.jsx)(t, {
						...n,
						guildId: e.id
	...
	},
	{
		...
		handler: (e, t) =>
			(0, a.openModalLazy)(async () => {
				let { default: l } = await Promise.all([n.e('7654'), n.e('66633')]).then(n.bind(n, 560114));
				return (n) =>
					(0, i.jsx)(l, {
						...n,
						guild: e,

...
var n = r(442853), _ = r(177668);
function a(t) {
    let e = t.protocol ? `${ t.protocol }:` : '', r = t.port ? `:${ t.port }` : '';
    return `${ e }//${ t.host }${ r }${ t.path ? `/${ t.path }` : '' }/api/`;
}
function i(t, e = {}) {
    var r, _, i;
    let o = 'string' == typeof e ? e : e.tunnel, E = 'string' != typeof e && e._metadata ? e._metadata.sdk : void 0;
...
function o(t, e) {
    ...
    if (!r)
        return '';
    let n = `${ a(r) }embed/error-page/`, i = `dsn=${ (0, _.RA)(r) }`;
    for (let t in e) {
        if ('dsn' !== t)
            if ('user' === t) {
                let t = e.user;

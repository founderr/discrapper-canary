...
channel: _,
context: f
  } = e, N = c.Z.getGuild(i), A = (0, s.e7)([Z.Z], () => null != N ? Z.Z.can(M.Plq.MANAGE_GUILD, N) : null), I = (0, d.em)(_, !0, !0), g = (0, d.PL)(!0, !0), {
isUserApp: v,
isGuildApp: b
  } = t.useMemo(() => {
var e, i, l, t;
...
u.Z.open(M.oAB.AUTHORIZED_APPS);
  ...
  if (!(null == n ? void 0 : n.bot) || !A || D || !b && !v)
return null;
  let T = [];
  return b && T.push((0, l.jsx)(a.MenuItem, {
id: 'manage-integration',
label: E.Z.Messages.MANAGE_INTEGRATION,
action: m
  }, 'manage-integration')), v && T.push((0, l.jsx)(a.MenuItem, {
id: 'manage-authorized-app',
label: E.Z.Messages.MANAGE_AUTHORIZED_APP,
action: p
  }, 'manage-authorized-app')), T;
}
...
function T(e) {
  let {
    ...
    let u = Object.values(null !== (i = null === (e = f.result) || void 0 === e ? void 0 : e.sections) && void 0 !== i ? i : {}),
      l = Object.values(null !== (r = null === (t = p.result) || void 0 === t ? void 0 : t.sections) && void 0 !== r ? r : {});
    return {
      isGuildApp: u.some(e => {
        var t;
  ...
  }, [f, p, null == n ? void 0 : n.id]), Z = r.useCallback(() => {
    if ((null == S ? void 0 : S.id) != null) s.Z.open(S.id, _.pNK.INTEGRATIONS), a.Z.setSection(_.b4C.APPLICATION, null == n ? void 0 : n.id)
  }, [null == n ? void 0 : n.id, null == S ? void 0 : S.id]), h = r.useCallback(() => {
    o.Z.open(_.oAB.AUTHORIZED_APPS)
  }, []), R = N === _.IlC.POPOUT;
  if (!(null == n ? void 0 : n.bot) || !A || R || !M && !O) return null;
  let C = [];

...
function y() {
    let e = (function () {
        ...
        if (null == u || !p.oz(b.Plq.VIEW_CHANNEL, u)) return null;
        let c = f.Z.getGuild(u.getGuildId());
        if (null == c || !c.hasFeature(b.oNc.DISCOVERABLE)) return null;
        let _ = (0, E.Lw)(u, l),
        ...
        return {
            ...
            type: (0, I.xJ)(u.id) ? b.IIU.WATCHING : b.IIU.LISTENING,
...
(a = 'StageChannelSelfRichPresenceStore'),
    ...
    (t.Z = new A(c.Z, {
        ...
        RTC_CONNECTION_STATE: function (e) {
            ...
            return i === b.hes.RTC_CONNECTED && !(a > 0) && y();
        },

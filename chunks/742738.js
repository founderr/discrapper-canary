...
function p() {
  let e = function() {
    ...
    let E = (0, f.Lw)(u, l),
      p = (null == R ? void 0 : null === (e = R.party) || void 0 === e ? void 0 : e.id) === E ? R : null,
      g = h.Z.getMutableParticipants(u.id, S.pV.SPEAKER),
      C = g.filter(e => e.type === S.Ui.STREAM).length,
      v = g.length - C,
      L = h.Z.getParticipantCount(a) - C,
      D = (null == p ? void 0 : null === (t = p.party) || void 0 === t ? void 0 : t.size) != null ? p.party.size[1] : 0;
    return {
      application_id: m.gD,
      name: null !== (r = null !== (i = l.topic) && void 0 !== i ? i : u.topic) && void 0 !== r ? r : u.name,
      type: (0, A.xJ)(u.id) ? O.IIU.WATCHING : O.IIU.LISTENING,
      timestamps: {
        start: null !== (s = null == p ? void 0 : null === (n = p.timestamps) || void 0 === n ? void 0 : n.start) && void 0 !== s ? s : new Date().getTime()
      },
      assets: {
...
s = "StageChannelSelfRichPresenceStore", (r = "displayName") in(i = g) ? Object.defineProperty(i, r, {
  ...
  RTC_CONNECTION_STATE: function(e) {
    ...
    return r === O.hes.RTC_CONNECTED && !(s > 0) && p()
  },
  VOICE_STATE_UPDATES: function(e) {
    ...
    if (null == R) return;
    let n = (0, f.rq)(R);
    null != n && null != t.find(e => e.channelId === n.channelId) && p()
  }
})
...
var s = o(735250), r = o(470079), a = o(120356), n = o.n(a), t = o(149765), i = o(442837), d = o(481060), c = o(741361), u = o(911969), _ = o(605436), N = o(430824), h = o(700785), O = o(993259), R = o(689938), M = o(715564);
function S(e) {
    return l => null != l && !(0, _.pM)(e, l);
}
let m = (e, l, o) => {
        let s = h.Uu(o, l), [a, n] = r.useState(s);
        return {
...
l.default = e => {
    let {
        ...
        } = m(l, o, a), C = r.useRef(null), L = function (e) {
            let l = (0, i.e7)([N.Z], () => N.Z.getRoles(e.id));
            return r.useMemo(() => (0, O.KV)(e, l).filter(l => S(e.id)(l.id)), [
                e,
                l
            ]);
        }(l), A = L.reduce((e, l) => (e.set(l.id, l), e), new Map()), w = L.map(e => ({
            key: e.key,
            label: e.name,
            value: e.id
        })), [g, j] = r.useState(E.map(e => e.id).filter(S(l.id))), [H, B] = r.useState(!1), [b, D] = r.useState(!1), y = g.length > 0 || x, Z = function (e, l) {
            let o = (0, i.e7)([N.Z], () => N.Z.getRoles(e.id));
            return r.useCallback((s, r) => {
                let a = (0, O.KV)(e, o), n = new Set(r), i = { ...l.permissionOverwrites }, d = [], N = [];
                return a.forEach(l => {
                    var o, r, a, c, O, R, M, S, m, v;
                    let f = l.id, p = n.has(f);
                    p ? d.push({
                        id: f,
                        type: u.BN.ROLE,
    ...
    return H ? (0, s.jsx)(d.Spinner, {}) : (0, s.jsxs)(d.ModalRoot, {
        transitionState: p,

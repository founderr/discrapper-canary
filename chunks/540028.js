...
var r = n(735250);
n(470079);
var i = n(442837), a = n(692547), o = n(481060), s = n(475179), l = n(519938), u = n(317381), c = n(812206), d = n(358221), _ = n(199902), E = n(366050), f = n(594174), h = n(981631), p = n(354459), m = n(689938), I = n(910310);
function T(e) {
    let {
        closePopout: t,
        idle: n,
    ...
    n && t();
    let T = (0, i.e7)([u.ZP], () => u.ZP.getSelfEmbeddedActivityForChannel(f)), g = (0, i.e7)([E.Z], () => E.Z.pipWindow), S = (0, i.e7)([d.Z], () => d.Z.getSelectedParticipant(f)), A = (0, i.e7)([d.Z], () => d.Z.getStreamParticipants(f));
    return (0, r.jsx)(o.Menu, {
        ...
        onSelect: I,
        children: function () {
            let e = a.find(e => e.component === h.NYg.EMBED_IFRAME), t = a.find(e => e.component === h.NYg.VIDEO), n = [];
            return null != e && (null == g ? void 0 : g.id) !== e.id && n.push({ pipWindow: e }), null != t && A.forEach(e => {
                let r = _.Z.getActiveStreamForApplicationStream(e.stream), i = e.id === (null == S ? void 0 : S.id) && (null == g ? void 0 : g.id) === t.id;
                null != r && !i && n.push({
                    pipWindow: t,
                    participant: e,
                    stream: r
            ...
            var t;
            let n = e.pipWindow.id, i = null === (t = e.participant) || void 0 === t ? void 0 : t.id, a = function (e) {

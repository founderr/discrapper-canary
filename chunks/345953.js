...
let S = i().debounce(() => {
    ...
    T = i().debounce(u.On, 500, { maxWait: 500 });
function y() {
    g.hW.updateAsync(
        'audioContextSettings',
        (e) => {
                ...
                (0, h.$E)((n, r, i) => {
                    let a = (function (e, t, n, r) {
                        ...
                        if (
                            ...
                            (o = f), (l = t), (u = n), o[l].volume !== b(u) || o[l].muted || o[l].soundboardMuted || delete o[l];
                        }
                        return (
                            !(function (e) {
...
function N(e) {
    ...
    if (n !== f.default.getId()) {
        var r, i, a;
        (r = t), (i = n), (a = _.Z.isLocalMute(n, t)), (0, h.RF)(r, i, { muted: a }), S.cancel(), y();
    }
}
function C(e) {
    let { context: t, userId: n } = e;
    if (n !== f.default.getId()) {
        var r, i, a;
        (r = t), (i = n), (a = d.Z.isLocalSoundboardMuted(n)), (0, h.RF)(r, i, { soundboardMuted: a }), S.cancel(), y();
    }
}
class R extends l.Z {
    constructor(...e) {

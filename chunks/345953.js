n(47120);
var r = n(392711), i = n.n(r), a = n(51407), o = n(524437), s = n(433517), l = n(147913), u = n(254238), c = n(258609), d = n(763296), _ = n(314897), E = n(131951), f = n(709054), h = n(815016), p = n(725380), m = n(340332), I = n(675478), T = n(65154);
let g = e => 'AudioContextSettingsMigrated:'.concat(e), S = e => e === T.Yn.STREAM ? a.h.STREAM : a.h.USER;
function A() {
...
let N = i().debounce(() => {
        O();
    }, 2000), v = i().debounce(u.On, 500, { maxWait: 500 });
function O() {
    I.hW.updateAsync('audioContextSettings', e => {
        ...
        return (0, p.$E)((n, r, i) => {
            let a = function (e, t, n, r) {
                var i, a, s, l, u;
                let c = !(arguments.length > 4) || void 0 === arguments[4] || arguments[4], d = (0, m.z)(n);
                if (null == d)
                    return !1;
                let _ = e[d];
                ...
                return !function (e) {
                    let t = f.default.entries(e), n = t.length;
                    if (n <= 300)
                        return;
                    let r = t.sort((e, t) => {
                            let [n, {modifiedAt: r}] = e, [i, {modifiedAt: a}] = t;
...
function R(e) {
    ...
    null != s && v(s, a, i, {
        ...
        volume: o
    }), t = i, n = a, r = o, (0, p.RF)(t, n, { volume: r }), N();
}
function C(e) {
    let {
        context: t,
    ...
    if (n !== _.default.getId()) {
        if ((0, h.R)()) {
            var r, i, a;
            r = t, i = n, a = E.Z.isLocalMute(n, t), (0, p.RF)(r, i, { muted: a }), N.cancel(), O();
        }
    }
}
function y(e) {
    ...
    if (n !== _.default.getId()) {
        if ((0, h.R)()) {
            var r, i, a;
            r = t, i = n, a = d.Z.isLocalSoundboardMuted(n), (0, p.RF)(r, i, { soundboardMuted: a }), N.cancel(), O();
        }
    }
}
class D extends l.Z {

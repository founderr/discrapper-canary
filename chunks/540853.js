...
function h(e) {
  let t = e.channel.getRecipientId(),
    ...
    h = (0, a.useStateFromStores)([o.default], () => o.default.getUser(t)),
    C = (0, a.useStateFromStores)([i.default], () => i.default.getStatus(t)),
    p = (0, a.useStateFromStores)([i.default], () => i.default.isMobileOnline(t)),
    m = (0, a.useStateFromStores)([r.default], () => r.default.getNickname(t)),

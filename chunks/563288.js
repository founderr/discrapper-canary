...
transitionState: n,
onClose: L
  } = e, D = (0, c.Dt)(), v = (0, a.e7)([l.Z], () => l.Z.useReducedMotion), j = (0, a.e7)([u.Z], () => u.Z.getGuild(t));
  return (s.useEffect(() => {
h.default.track(I.rMx.DISMISSIBLE_CONTENT_SHOWN, {
  type: o.z[o.z.GUILD_ONBOARDING_UPSELL_MODAL_V2],
  guild_id: t
});
  }, [t]), null == j) ? null : (0, i.jsxs)(r.ModalRoot, {
transitionState: n,
'aria-labelledby': D,
          ...
          (0, i.jsx)(r.Button, {
            onClick: () => {
              h.default.track(I.rMx.UPSELL_CLICKED, {
                type: o.z[o.z.GUILD_ONBOARDING_UPSELL_MODAL_V2],
                action: 'primary'
              }), m.Z.open(t, I.pNK.ONBOARDING), L(C.L.PRIMARY), (0, _.G)(j.id, o.z.GUILD_ONBOARDING_UPSELL_MODAL_V2);
            },

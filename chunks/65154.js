...
var i, r, s, o, a, l, u, _, c, d, E, I, T, h, f, S, A, N, m, O, p, R, g, C, v, L, D, M, P, y, U, b, G, w, x, B, k = n(268146);
(i = m || (m = {})).DEFAULT = "default", i.STREAM = "stream", (r = O || (O = {})).AUDIO_INPUT = "audioinput", r.AUDIO_OUTPUT = "audiooutput", r.VIDEO_INPUT = "videoinput", (s = p || (p = {})).PUSH_TO_TALK = "PUSH_TO_TALK", s.VOICE_ACTIVITY = "VOICE_ACTIVITY", (o = R || (R = {})).DISCONNECTED = "DISCONNECTED", o.CONNECTING = "CONNECTING", o.CONNECTED = "CONNECTED", o.NO_ROUTE = "NO_ROUTE", o.ICE_CHECKING = "ICE_CHECKING", o.DTLS_CONNECTING = "DTLS_CONNECTING", (a = g || (g = {}))[a.TRANSPORT = 1] = "TRANSPORT", a[a.OUTBOUND = 2] = "OUTBOUND", a[a.INBOUND = 4] = "INBOUND", a[a.ALL = 7] = "ALL", (l = C || (C = {})).MANUAL_DISABLE = "video_manual_disable", l.MANUAL_ENABLE = "video_manual_enable", l.MANUAL_REENABLE = "video_manual_reenable", l.AUTO_DISABLE = "video_auto_disable", l.AUTO_ENABLE = "video_auto_enable", l.AUTO_DOWNGRADE = "video_auto_downgrade", l.AUTO_UPGRADE = "video_auto_upgrade,", (u = v || (v = {})).NO_OVERRIDE = "no_override", u.HIGH = "high", u.LOW = "low";
let V = 100,
  Z = 18,
  H = 64e3,
  F = 128e3,

(function () {
    ...
    i.date = function (e, t) {
        var n = void 0 === t ? new Date() : new Date(t instanceof Date ? t : 1000 * t), r = /\\?([a-z])/gi, s = function (e, t) {
                return c[e] ? c[e]() : t;
            }, l = [
                'Sunday',
                'Monday',
                ...
                B: function () {
                    var e = n.getTime() / 1000, t = e % 86400 + 3600;
                    t < 0 && (t += 86400);
                    var r = t / 86.4 % 1000;
        ...
        var i = e < 0 ? '-' : '', a = parseInt((e = Math.abs(+e || 0)).toFixed(t), 10) + '', o = a.length > 3 ? a.length % 3 : 0;
        ...
        var n = new Date(), r = new Date(n.getFullYear(), n.getMonth(), n.getDate()).getTime() / 1000;
        if (e < r && e >= r - 86400)
            return 'yesterday';
        if (e >= r && e < r + 86400)
            return 'today';
        if (e >= r + 86400 && e < r + 172800)
            return 'tomorrow';
        return i.date(t, e);
        ...
        if (n < 2 && n > -2)
            return (n >= 0 ? 'just ' : '') + 'now';
        if (n < 60 && n > -60)
            return n >= 0 ? Math.floor(n) + ' seconds ago' : 'in ' + Math.floor(-n) + ' seconds';
        if (n < 120 && n > -120)
            return n >= 0 ? 'about a minute ago' : 'in about a minute';
        if (n < 3600 && n > -3600)
            return n >= 0 ? Math.floor(n / 60) + ' minutes ago' : 'in ' + Math.floor(-n / 60) + ' minutes';
        if (n < 7200 && n > -7200)
            return n >= 0 ? 'about an hour ago' : 'in about an hour';
        if (n < 86400 && n > -86400)
            return n >= 0 ? Math.floor(n / 3600) + ' hours ago' : 'in ' + Math.floor(-n / 3600) + ' hours';
        if (n < 172800 && n > -172800)
            return n >= 0 ? '1 day ago' : 'in 1 day';
        if (n < 2505600 && n > -2505600)
            return n >= 0 ? Math.floor(n / 86400) + ' days ago' : 'in ' + Math.floor(-n / 86400) + ' days';
        if (n < 5184000 && n > -5184000)
            return n >= 0 ? 'about a month ago' : 'in about a month';
        var r = parseInt(i.date('Y', t), 10), a = parseInt(i.date('Y', e), 10), o = 12 * r + parseInt(i.date('n', t), 10) - (12 * a + parseInt(i.date('n', e), 10));
        if (o < 12 && o > -12)
        ...
        var t = (e = isNaN(e = parseInt(e, 10)) ? 0 : e) < 0 ? '-' : '', n = (e = Math.abs(e)) % 100;

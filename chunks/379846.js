...
var i = r(736302), o = r(770209), a = r(362242), u = r(114080), s = r(65183), c = s.OrderedSet, l = s.Record, f = s.Stack, p = l({
        allowUndo: !0,
        currentContent: null,
        decorator: null,
        directionMap: null,
        ...
        e.createEmpty = function (t) {
            ...
            var r = t.currentContent, i = t.decorator;
            ...
            return new e(t.getImmutable().withMutations(function (e) {
                ...
                a !== t.getCurrentContent() && e.set('treeMap', function (t, e, r, n) {
                    var o = t.getCurrentContent().set('entityMap', r), a = o.getBlockMap();
        ...
        return t.toJS = function () {
            ...
            if (null != t)
                return t;
            var e = this.getCurrentContent(), r = this.getSelection();
            return r.isCollapsed() ? function (t, e) {
                var r = e.getStartKey(), n = e.getStartOffset(), i = t.getBlockForKey(r);
            ...
            var t = this.getCurrentContent().getBlockMap().last(), e = t.getLength();
            ...
            var r = t.getCurrentContent().getLastBlock(), n = r.getKey(), i = r.getLength();
            ...
            var u = t.getSelection(), s = t.getCurrentContent(), c = t.getUndoStack(), l = r;
            ...
            if (!t.getAllowUndo())
                return t;
            var r = t.getUndoStack(), n = r.peek();
            if (!n)
                return t;
            var i = t.getCurrentContent(), o = a.getDirectionMap(n, t.getDirectionMap());
            return e.set(t, {
                currentContent: n,
                directionMap: o,
                undoStack: r.shift(),

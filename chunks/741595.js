var a = t(735250), r = t(470079), i = t(120356), s = t.n(i), o = t(481060), l = t(308083), c = t(360884);
n.Z = e => {
    let {
            title: n,
            description: t,
        ...
        children: [
            ...
            (0, a.jsx)('div', {
                ...
                children: f.map(e => (0, a.jsxs)(o.Clickable, {
                    className: s()(c.playstyleOption, c.selectableOption, { [c.selectedOption]: e.type === d }),
                    onClick: () => i(e.type),
                    children: [
                        (0, a.jsx)(o.Heading, {
                            variant: 'heading-xxl/medium',

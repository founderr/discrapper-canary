...
function g(e, t) {
  let {
    reducedMotion: n
  } = i.useContext(s.AccessibilityPreferencesContext), g = (0, o.useIsActiveChannelOrUnarchivableThread)(t), p = (0, l.useStateFromStores)([c.default], () => c.default.can(m.Permissions.MANAGE_MESSAGES, t) && g, [t, g]), S = e.reactions.reduce((e, t) => {
    var n;

...
function F(e) {
  ...
  let J = (0, o.e7)([I.Z], () => I.Z.can(w.Plq.MANAGE_MESSAGES, n)),
    Q = f.QK.useSetting(),
    $ = f.cC.useSetting(),
    ee = (0, x.Z)($, J),
    et = (0, v.aU)(k, E, !1),
...
function U(e) {
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsxs)("div", {
      ...
      className: D.controlsGroup,
      children: [l || null == s ? null : (0, a.jsx)(M.kZ, {
        firstMessage: s,
        channel: t
...
function z(e) {
  let {
    ...
    width: c,
    height: u
  }), [c, u]), g = o ? D.textContentUnread : D.textContentRead;
  return (0, a.jsx)(a.Fragment, {
    children: (0, a.jsxs)("div", {
      ...
      children: [(0, a.jsxs)("div", {
        className: D.content,
        children: [r && null == n && (0, a.jsx)(d.Text, {

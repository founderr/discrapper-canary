...
function G(e) {
	let { text: t, icon: n, pillClassName: s, iconClassName: r, textClassName: l } = e;
	return (0, a.jsxs)('div', {
		className: s,
		children: [
			(0, a.jsx)(n, {
...
function z(e) {
	let { channel: t, firstMessage: n, isFirstMessageLoaded: r, containerWidth: i, hasUnreads: o } = e,
		[c, u] = (0, A.rI)(i - 2 * A.LT),
		{ content: m } = (0, N.mX)({
			firstMessage: n,
			formatInline: !1,

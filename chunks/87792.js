...
function b(e) {
  ...
  }, []), l = (0, A.default)(), r = (0, C.useActionsForDisplayType)(t), u = (0, C.useActionTotalsForDisplayType)(t), {
    loadMore: d,
    isMoreLoading: c
  } = (0, m.useFamilyCenterActions)({
    onError: s
  }), _ = M.ACTION_TO_TEXT.get(t), [T, g] = n.useState(M.FAMILY_CENTER_ITEMS_SHOWN_INCREMENTS), p = (0, h.useIsEligibleForFamilyCenterVCJoin)({
  ...
  let R = _.sectionHeader(u),
    v = n.useCallback(e => {
      ...
      return (0, f.isUserAction)(s) ? (0, a.jsx)(S.default, {
        userId: s.entity_id,
        timestamp: E.default.extractTimestamp(s.event_id),
        timestampFormatter: _.timestampFormatter
      }, s.event_id) : (0, f.isGuildAction)(s) ? (0, a.jsx)(I.default, {
        guildId: s.entity_id
      }, s.event_id) : void 0
...
let j = () => {
    let e = (0, A.default)(),
      ...
      s = (0, T.useAgeSpecificText)(O.default.Messages.FAMILY_CENTER_ACTIVITY_OVERVIEW_PREFACE_TEEN.format({
...
t.default = e => {
  let {
    user: t
  } = e, s = Array.from(M.ACTION_TO_TEXT.entries()), n = (0, C.useHasActionForAnyDisplayType)(), l = (0, f.getEmptyActivityFormatter)(), i = (0, p.useActivityWindowTimeStamp)(l);
  return (0, a.jsxs)("div", {

...
function D(e) {
  let {
    ...
    onError: n
  }), E = O.ACTION_TO_TEXT.get(t), [C, p] = s.useState(O.FAMILY_CENTER_ITEMS_SHOWN_INCREMENTS), I = (0, _.useIsEligibleForFamilyCenterVCJoin)({
...
let b = () => {
  ...
  j = () => {
    let e = (0, I.useUserForLinkStatus)(O.UserLinkStatus.ACTIVE),

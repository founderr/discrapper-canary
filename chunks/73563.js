...
function h(e) {
    let { screenMessage: t, onDoubleClick: n, onActive: i, onForceIdle: a, idle: l, children: o, renderChatButton: h, renderChatToasts: p, renderVoiceChannelEffects: m, style: _, ...f } = e;
    return (0, s.jsxs)('div', {

...
var l = s(735250), t = s(470079), i = s(512722), r = s.n(i), a = s(742280), c = s(442837), o = s(692547), u = s(481060), d = s(190947), _ = s(224550), m = s(275850), E = s(672971), I = s(128069), p = s(987209), N = s(598), T = s(45572), x = s(919778), S = s(614223), h = s(246946), P = s(351402), f = s(509545), A = s(669079), v = s(74538), M = s(937615), g = s(479446), C = s(374649), O = s(104494), R = s(642530), j = s(653798), L = s(314182), y = s(981632), Z = s(314404), b = s(42818), D = s(459965), G = s(251660), U = s(474936), F = s(981631), B = s(231338), w = s(689938), H = s(711978);
function k(e) {
    var n, s, i, k;
    let W, Y, K, {
            selectedPlanId: V,
        ...
        } = (0, p.wD)(), eA = (0, O.Ng)(), ev = null == eA ? void 0 : null === (n = eA.discount) || void 0 === n ? void 0 : n.plan_ids.some(e => U.GP[e].skuId === eI), eM = !eh && null != eA && null != eI && ev, eg = (0, c.e7)([f.Z], () => f.Z.get(V));
    r()(null != eg, 'Missing plan');
    let eC = [{
                planId: eg.id,
                quantity: 1
            }], eO = ea === T.A.PURCHASING || ea === T.A.COMPLETED, eR = eh || eO, [ej, eL] = (0, C.ED)({
            items: eC,
            renewal: !1,
            preventFetch: eR,
            applyEntitlements: !0,
    ...
    let eF = eh && (0, A.pO)(eP), eB = null !== (k = null !== (i = null != eL ? eL : eZ) && void 0 !== i ? i : eD) && void 0 !== k ? k : eU, ew = (0, c.e7)([h.Z], () => h.Z.enabled), eH = X.paymentSourceId, {
            hasEntitlements: ek,
            entitlements: eW
        } = (0, D.H)(eg.id, eh), eY = (0, v.Ap)(X.paymentSourceId), eK = (0, x.sE)(el, eH, V), eV = (0, S.Kp)({
            isTrial: eu,
            isGift: eh,
            selectedSkuId: eI,
    ...
    if (null != eB) {
        let e = eB.message;
        eB.code === I.SM.INVALID_CURRENCY_FOR_PAYMENT_SOURCE && (e = w.Z.Messages.BILLING_ERROR_UNSUPPORTED_CURRENCY), Y = (0, l.jsx)(u.FormErrorBlock, { children: e });
    } else if (eh && null != eG)
        K = (0, l.jsx)(b.e9, {
            plan: eg,
            className: H.invoice,
                        ...
                        (0, l.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, l.jsx)(u.Text, {
                                    ...
                                    children: w.Z.Messages.BILLING_TRIAL_PRICE_NOW.format({ price: (0, M.T4)(0, ej.currency, { maximumFractionDigits: 0 }) })
                                })
                            ]
                        }),
                        (0, l.jsx)('div', {
        ...
        eu && ej.subscriptionPeriodEnd !== ey.subscriptionPeriodEnd && (W = ej.subscriptionPeriodEnd), K = (0, l.jsxs)(j.PO, {
            className: H.invoice,
            children: [
                (0, l.jsx)(j.q9, { children: w.Z.Messages.BILLING_SWITCH_PLAN_PURCHASE_DETAILS }),
                (0, l.jsx)(b.Lu, {
                    invoice: ej,
                    newPlan: eg,
                    isPrepaidPaymentSource: eY,
    ...
    let eQ = a.M.EEA_COUNTRIES.has(P.Z.ipCountryCodeWithFallback), {
        ...
        }(null != eu && eu, ey, W), e9 = w.Z.Messages.BILLING_SELECT_PLAN_GUILD_SUBSCRIPTION.format({ planName: eg.name });
            ...
            (0, l.jsxs)('div', {
                ...
                children: [
                    ...
                    ek && null == eH ? (0, l.jsx)('div', {
                        ...
                        children: w.Z.Messages.ATTACH_PAYMENT_SOURCE_OPTIONAL_WITH_ENTITLEMENTS_WARNING.format({ months: eW.length })
                    }) : null,

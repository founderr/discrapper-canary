...
function K(e) {
  ...
  let eM = [{
    ...
    eb = er === P.PurchaseState.PURCHASING || er === P.PurchaseState.COMPLETED,
    eR = eN || eb,
    ...
    children: [null != el && (0, i.jsxs)("div", {
      ...
      children: (0, i.jsx)(p.default, {
        ...
        finePrint: null != es ? es : (0, i.jsx)(m.default, {
          ...
          isEmbeddedIAP: ef,
          basePrice: (0, C.getPrice)(eg.id, !1, eN, J)
        }),

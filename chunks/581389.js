...
function eI(e) {
  let {
    ...
    hasPermission: r,
    disabled: o
  } = e, u = (0, S.useAppContext)(), d = (0, f.useStateFromStoresArray)([J.default], () => J.default.getAllActiveStreams()), c = d.find(e => e.ownerId === n.id), m = t.getGuildId(), p = i.useCallback(() => {
    if (null == l || l(), !a) return (0, em.default)();
    (0, ep.default)(m, t.id, eg.AnalyticsPages.GUILD_CHANNEL)
  }, [m, t.id, a, l]), g = (0, f.useStateFromStores)([et.default, ea.default], () => (0, w.default)(et.default, ea.default)), C = (0, N.default)(), _ = (0, x.default)() && null != g, I = () => {
    _ && (null == c ? (0, E.createBroadcastChannelOrStartStream)({
      channelId: t.id,
      pid: null == g ? void 0 : g.pid
    }) : (0, v.startBroadcastForStream)((0, D.encodeStreamKey)(c), null == g ? void 0 : g.pid))
  }, T = () => {
    if (_) {
...
let ev = i.memo(function(e) {
  let {
    ...
    reducedMotion: o
  } = i.useContext(h.AccessibilityPreferencesContext), [u, d] = i.useState(!1), m = null == r ? void 0 : r.id, g = (0, f.useStateFromStores)([J.default], () => null != m ? J.default.getActiveStreamForStreamKey(m) : null, [m]), S = (null == r ? void 0 : r.type) === eS.ParticipantTypes.STREAM && null != g && g.ownerId !== (null == n ? void 0 : n.id), C = (0, f.useStateFromStoresArray)([J.default], () => J.default.getAllActiveStreamsForChannel(a.id).filter(e => {
    let {
      ownerId: t
    } = e;
  ...
  let j = i.useCallback(() => {
      if (null != g)(0, E.stopStream)((0, D.encodeStreamKey)(g));
      else

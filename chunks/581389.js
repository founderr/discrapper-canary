...
function eI(e) {
  let {
    ...
    hasPermission: r,
    disabled: o
  } = e, u = (0, S.useAppContext)(), d = (0, f.useStateFromStoresArray)([Q.default], () => Q.default.getAllActiveStreams()), c = d.find(e => e.ownerId === n.id), m = t.getGuildId(), p = i.useCallback(() => {
    if (null == a || a(), !l) return (0, em.default)();
    (0, ep.default)(m, t.id, eg.AnalyticsPages.GUILD_CHANNEL)
  }, [m, t.id, l, a]), g = (0, f.useStateFromStores)([et.default, el.default], () => (0, w.default)(et.default, el.default)), C = (0, N.default)(), _ = (0, x.default)() && null != g, I = () => {
...
let ev = i.memo(function(e) {
  let {
    ...
    reducedMotion: o
  } = i.useContext(h.AccessibilityPreferencesContext), [u, d] = i.useState(!1), m = null == r ? void 0 : r.id, g = (0, f.useStateFromStores)([Q.default], () => null != m ? Q.default.getActiveStreamForStreamKey(m) : null, [m]), S = (null == r ? void 0 : r.type) === eS.ParticipantTypes.STREAM && null != g && g.ownerId !== (null == n ? void 0 : n.id), C = (0, f.useStateFromStoresArray)([Q.default], () => Q.default.getAllActiveStreamsForChannel(l.id).filter(e => {
    let {
      ownerId: t
    } = e;

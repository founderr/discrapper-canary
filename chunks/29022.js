...
var a, s, o = t(735250), i = t(470079), l = t(149765), r = t(442837), c = t(704215), _ = t(692547), I = t(481060), d = t(388905), E = t(434404), N = t(764260), S = t(422559), u = t(430824), T = t(768581), O = t(700785), m = t(645041), p = t(981631), A = t(921944), L = t(135899), M = t(689938), C = t(894050);
function h(e) {
    let {
            guild: n,
            headerText: a,
...
function R(e) {
    let {guild: n} = e, t = (0, r.e7)([u.Z], () => u.Z.getRole(n.id, n.getEveryoneRoleId()));
    if (null == t)
        return null;
    let {
        name: a,
...
function f(e) {
    ...
    return 0 === a.length && 2 !== t ? null : (0, o.jsxs)('div', {
        className: C.table,
        children: [
            2 !== t ? (0, o.jsx)(D, {
                permissions: a,
...
function b(e) {
    let {
            ...
            transitionState: s,
            onClose: r
        } = e, [_, d] = i.useState(0), S = i.useMemo(() => {
            let e = [], t = [];
            return L.$X.map(a => {

...
function f(e) {
  let {
    ...
    reducedMotion: r
  } = a.useContext(c.AccessibilityPreferencesContext), o = r.enabled ? 3 : n, [f, E] = a.useState(null != t), [_] = a.useState(() => new u.Timeout);
  return a.useEffect(() => () => _.stop(), [_]), a.useEffect(() => {
    null != t && _.start(10, () => E(!0))
  }, [t, _]), (0, s.jsx)("div", {
    className: l(null != t ? h[t] : null, {
      [p[o]]: null != t,
      [d.didRender]: f
    }),
    children: i

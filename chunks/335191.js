...
y = null == b ? void 0 : null === (n = b.getPlatformUserUrl) || void 0 === n ? void 0 : n.call(b, N);
  null != S && S ? u = (0, c.jsx)(s.EyeSlashIcon, {
size: 'md',
color: 'currentColor',
className: l()(v.__invalid_connectedAccountOpenIconContainer, v.connectedAccountHideIcon)
  }) : null != y && (u = (0, c.jsx)(s.Anchor, {
href: y,
onClick: e => {
  var n, t;
  n = N.type, t = P, (0, E.yw)(h.rMx.CONNECTED_ACCOUNT_VIEWED, {
    platform_type: n,
    other_user_id: t
  }), (0, p.q)({
    href: y,
    ...
    children: [
      ...
      (0, c.jsxs)('div', {
        ...
        children: [
          ...
          null != g ? (0, c.jsx)(s.Text, {
            variant: 'text-xs/normal',
            color: 'header-secondary',
            children: x.Z.Messages.CONNECTIONS_PROFILE_MEMBER_SINCE.format({
              date: g
            })
          }) : null
        ]
...
selectedGuildId: r
  } = e, i = (0, O.rm)(n, void 0, a), T = () => {
null == o || o(), (0, d.goToAppDirectory)({
  view: N.ApplicationDirectoryViews.APPLICATION,
  applicationId: n.application.id,
  guildId: r,
  entrypoint: {
    name: N.ApplicationDirectoryEntrypointNames.APPLICATION_DIRECTORY_URL
  }
});
  };
  return (0, c.jsxs)('div', {
...
children: [
  (0, c.jsx)('div', {
    ...
    children: (0, c.jsxs)(s.Clickable, {
      ...
      onClick: T,
      children: [
        null != n.platform_name ? (0, c.jsx)(s.Text, {
          variant: 'eyebrow',
          color: 'interactive-normal',
          children: n.platform_name
        }) : null,
        null != n.platform_username ? (0, c.jsx)('div', {
          className: v.connectedAccountName,
      ...
      children: (0, c.jsx)(s.Text, {
        ...
        children: x.Z.Messages.CONNECTIONS_PROFILE_POWERED_BY.format({
          applicationHook: () => (0, c.jsxs)('div', {
            ...
            children: [
              null != n.application.bot ? (0, c.jsx)(u.Z, {
...
return null;
  let s = t.filter(e => T.Z.isSupported(e.type)).map(e => (0, c.jsx)(P, {
  connectedAccount: e,
  theme: a,
  locale: o,
  userId: i

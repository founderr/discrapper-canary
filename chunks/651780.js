...
var s = n(735250), a = n(470079), i = n(442837), r = n(481060), l = n(570140), o = n(355467), c = n(821849), d = n(774078), u = n(15640), _ = n(774380), E = n(404270), I = n(386937), T = n(316350), m = n(899667), N = n(474333), S = n(626135), h = n(267642), g = n(63063), C = n(999382), x = n(981631), p = n(689938), R = n(925024);
function f(e) {
    let {
            endsAt: t,
    ...
    return n <= 0 ? null : (0, s.jsx)(s.Fragment, {
        children: 0 === i && 0 === r ? p.Z.Messages.PREMIUM_GUILD_GRACE_PERIOD_COOLDOWN_SOON.format({
            tierName: a,
...
function L(e) {
    let {
            ...
            guildId: n
        } = e, a = (0, h.gZ)(t, n), i = (0, h.nW)((0, h.rF)(t.length, n));
    if (null == a || null == i)
        return null;
    let r = (0, h._k)(t, n);
    return (0, s.jsxs)(N.Z, {
...
function A() {
    ...
    let e = (0, i.e7)([C.Z], () => C.Z.getGuild()), t = (0, i.e7)([m.Z], () => null != e ? m.Z.getAppliedGuildBoostsForGuild(e.id) : null), n = (0, u.V)();

...
function I(e) {
  ...
  } = e, I = (0, i.useStateFromStores)([f.default], () => f.default.getGuildProduct(n)), N = (0, i.useStateFromStores)([u.default], () => u.default.getGuild(t), [t]), p = (0, i.useStateFromStores)([o.default], () => o.default.useReducedMotion), S = (0, c.useIsWindowFocused)();
  if (l()(null != N, "guild cannot be null"), l()(null != I, "guildProductListing cannot be null"), (0, E.useCanManageGuildProduct)(N)) return (0, s.jsx)(r.Tooltip, {

...
function F(e) {
    let {
        ...
        }), [g]), F = (0, d.e7)([R.default], () => R.default.getCurrentUser()), W = (0, D.Z)(n), z = (0, O.So)(c.q.STREAM_HIGH_QUALITY), Y = (0, E.o)(L, F), K = (0, f.lL)('CallHeader', !0, F, Y), {
            preventIdle: q,
            allowIdle: X
        } = (0, x.Y)('popup'), Q = [];
    if (W) {
    ...
    }, 'live-indicator'))), b && Q.push((0, i.jsx)(u.Popout, {
        position: 'bottom',

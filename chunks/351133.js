var r = n(911969), i = n(465343), a = n(706454), o = n(117530), s = n(174212), l = n(456007), u = n(581364), c = n(689079), d = n(689938);
let _ = {
        ...
        [r.jw.INTEGER]: (e, t, n) => {
            ...
            if (0 === i.length)
                return { success: !1 };
            if (null != t.choices)
                return t.choices.map(e => e.displayName).includes(i) ? { success: !0 } : { success: !1 };
        ...
        [r.jw.USER]: (e, t, n, r) => {
            if ('text' !== e.type)
                return { success: 'userMention' === e.type };
            {
                if ((0, u.BH)(e.text))
                    return { success: !0 };
        ...
        [r.jw.MENTIONABLE]: (e, t, n, r) => {
            if ('text' !== e.type)
                return { success: 'userMention' === e.type || E(e) };
            {
                if ((0, u.BH)(e.text))
                    return { success: !0 };
                let t = (0, i.K)(e.text, r, n);

...
[r.jw.BOOLEAN]: e => {
  ...
  let t = e.text.trim();
  return {
    success: c.ak.map(e => e.displayName.toLowerCase()).includes(t.toLowerCase())
  };
},
[r.jw.INTEGER]: (e, t, n) => {
  if ('text' !== e.type || t.type !== r.jw.INTEGER)
    return {
      success: !1
    };
  let i = e.text.trim();
  ...
  if (null != t.choices)
    return t.choices.map(e => e.displayName).includes(i) ? {
      success: !0
    } : {
      success: !1
    };
  ...
  return !isNaN(u) && Number.isInteger(u) && Number.isSafeInteger(u) ? f(u, t, d.Z.Messages.COMMAND_VALIDATION_NUMBER_RANGE_ERROR, d.Z.Messages.COMMAND_VALIDATION_NUMBER_MINIMUM_ERROR, d.Z.Messages.COMMAND_VALIDATION_NUMBER_MAXIMUM_ERROR) : {
    success: !1
  };
},
[r.jw.NUMBER]: (e, t, n) => {
  if ('text' !== e.type || t.type !== r.jw.NUMBER)
    return {
      success: !1
    };
  let i = e.text.trim();
  ...
  return isNaN(u) || u > Number.MAX_SAFE_INTEGER || u < Number.MIN_SAFE_INTEGER ? {
    success: !1
  } : f(u, t, d.Z.Messages.COMMAND_VALIDATION_NUMBER_RANGE_ERROR, d.Z.Messages.COMMAND_VALIDATION_NUMBER_MINIMUM_ERROR, d.Z.Messages.COMMAND_VALIDATION_NUMBER_MAXIMUM_ERROR);
},
[r.jw.USER]: (e, t, n, r) => {
  if ('text' !== e.type)
    return {

...
let c = {
    ...
    [i.jw.STRING]: (e, t, n) => {
      ...
      if (t.autocomplete) {
        let e = a.Z.getAutocompleteLastChoices(n, t.name);
        null != e && (l = String(null !== (o = null === (s = e.find(e => e.name === l)) || void 0 === s ? void 0 : s.value) && void 0 !== o ? o : l))
      }
      return null == t.choices || null != l && t.choices.map(e => e.displayName).includes(l) ? t.type === i.jw.STRING && (void 0 !== t.minLength || void 0 !== t.maxLength) ? void 0 !== l ? function(e, t, n) {
    ...
    [i.jw.BOOLEAN]: e => {
      ...
      let t = e.text.trim();
      return {
        success: _.ak.map(e => e.displayName.toLowerCase()).includes(t.toLowerCase())
      }
    },
    [i.jw.INTEGER]: (e, t, n) => {
      if ("text" !== e.type || t.type !== i.jw.INTEGER) return {
        success: !1
      };
      let r = e.text.trim();
      ...
      let o = a.Z.getAutocompleteLastChoices(n, t.name);
      if (null != o && o.map(e => e.displayName).includes(r)) return {
        success: !0
      };
    ...
    [i.jw.NUMBER]: (e, t, n) => {
      if ("text" !== e.type || t.type !== i.jw.NUMBER) return {
        success: !1
      };
      let r = e.text.trim();
      if (0 === r.length) return {
    ...
    [i.jw.USER]: (e, t, n, i) => {
      ...
      {
        if ((0, u.BH)(e.text)) return {
          success: !0
        };
        let t = (0, r.K)(e.text, i, n, {
          allowRoles: !1
        });
        return {
    ...
    [i.jw.ATTACHMENT]: (e, t, n, i, r) => {
      if ("text" !== e.type) return {
        success: !1
      };
      let s = o.Z.getUpload(n, t.name, (0, u.D7)(r));
      return {

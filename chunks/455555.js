...
let eA = l.memo(function() {
  ...
  let eM = function(e) {
    let {
      enabled: t
    } = (0, Y.default)(!0, e !== eE.NoticeTypes.PREMIUM_TIER_2_TRIAL_ENDING);
  ...
  switch (ec.type) {
    ...
    case eE.NoticeTypes.OUTBOUND_PROMOTION:
      return (0, s.jsxs)(ei.default, {
        ...
        children: [(0, s.jsx)(ei.NoticeCloseButton, {
          ...
          noticeType: eE.NoticeTypes.OUTBOUND_PROMOTION,
          onClick: () => {
            er.default.track(eE.AnalyticEvents.OUTBOUND_PROMOTION_NOTICE_CLICKED), C.default.open(eE.UserSettingsSections.INVENTORY), W.default.dismissOutboundPromotionNotice()
          },
    ...
    case eE.NoticeTypes.ESLATAM_LANGUAGE_LAUNCH:
      return (0, s.jsxs)(ei.default, {
        color: ei.NoticeColors.BRAND,
        children: [(0, s.jsx)(ei.NoticeCloseButton, {
          noticeType: eE.NoticeTypes.ESLATAM_LANGUAGE_LAUNCH,
          onClick: () => eS()
        }), eI.default.Messages.ESLATAM_LANGUAGE_LAUNCH_NOTICE, (0, s.jsx)(ei.PrimaryCTANoticeButton, {
          noticeType: eE.NoticeTypes.ESLATAM_LANGUAGE_LAUNCH,
          onClick: () => {
            C.default.open(eE.UserSettingsSections.LOCALE), eS()
          },
          children: eI.default.Messages.ESLATAM_LANGUAGE_LAUNCH_NOTICE_CTA
        })]
      });
    case eE.NoticeTypes.HABITUAL_DND:
      return (0, s.jsxs)(ei.default, {
        color: ei.NoticeColors.BRAND,
        children: [(0, s.jsx)(ei.NoticeCloseButton, {
          noticeType: eE.NoticeTypes.HABITUAL_DND,
          onClick: () => {
            eS(), (0, H.dismissDNDNotice)()
          }
        }), eI.default.Messages.QUIET_MODE_HABITUAL_DND_NOTICE, (0, s.jsx)(ei.PrimaryCTANoticeButton, {
          noticeType: eE.NoticeTypes.HABITUAL_DND,
          onClick: () => {
            C.default.open(eE.UserSettingsSections.NOTIFICATIONS), eS(), (0, H.dismissDNDNotice)()
          },
          children: eI.default.Messages.CHECK_IT_OUT
        })]
      });
    default:
      return null

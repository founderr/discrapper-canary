n(47120);
var r = n(443296), i = n(873741), a = n(866960), o = n(626135), s = n(981631);
function l(e) {
    if (Math.random() > 0.1)
        return;
    let t = null == e.apiResponseTimestamp ? null : e.apiResponseTimestamp - e.initialSendTimestamp, n = (0, i.d)();
...
t.Z = new class e {
    ...
    recordQuestRequestApiResponse(e, t) {
        let {wasSuccessful: n} = t, r = this.pendingRequests.get(e);
        null != r && (l({
            ...r,

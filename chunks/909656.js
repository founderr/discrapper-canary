...
function b(e) {
  ...
  let {
    ...
    format: r
  } = (0, f.Z)(n.id), l = (0, x.YB)(n.id), c = a.useCallback(() => {
    var e;
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [null != F && (0, s.jsxs)(s.Fragment, {
    ...
    }) : null, $.length > 0 && (0, s.jsxs)(s.Fragment, {
      children: [(0, s.jsx)(I.FormDivider, {
        className: v.divider
      }), (0, s.jsxs)(I.FormSection, {

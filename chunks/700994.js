...
function M(e) {
  ...
  let a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : f.MediaEngineContextTypes.DEFAULT,
    ...
    m = a === f.MediaEngineContextTypes.STREAM;
  return E ? null : (0, l.jsx)(u.MenuControlItem, {
    id: "user-volume",
    label: m ? c.default.Messages.STREAM_VOLUME : c.default.Messages.USER_VOLUME,
    control: (t, n) => (0, l.jsx)(u.MenuSliderControl, {
      ...
      "aria-label": m ? c.default.Messages.STREAM_VOLUME : c.default.Messages.USER_VOLUME
    })
  })
}
...
function A(e) {
  let {
  ...
  } = (0, d.default)(u.default.NOTIFICATION_CENTER), [L, b] = l.useState(!1), [O, y] = function() {
    ...
    b(!L), L ? null == n || n() : null == t || t()
  }, [n, t, L]), U = l.useCallback(() => {
    P(), y(r.InboxTab.UNREADS)
  }, [y, P]);
  l.useEffect(() => (p.ComponentDispatch.subscribe(T.ComponentActions.TOGGLE_INBOX_UNREADS_TAB, U), () => void p.ComponentDispatch.unsubscribe(T.ComponentActions.TOGGLE_INBOX_UNREADS_TAB, U)), [U]);
  let {
    showReminders: k
  ...
  l.useEffect(() => {
    !k && O === r.InboxTab.TODOS && y(r.InboxTab.MENTIONS)
  });
    ...
    children: (0, a.jsx)(o.Popout, {
      ...
      renderPopout: function() {
        return (0, a.jsx)(o.Dialog, {
          ...
          children: O === r.InboxTab.FOR_YOU && w ? (0, a.jsx)(S.default, {
            setTab: y,
            badgeState: v,
            closePopout: F
          }) : O === r.InboxTab.MENTIONS ? (0, a.jsx)(_.default, {
            setTab: y,
            onJump: B,
            badgeState: v,
            closePopout: F
          }) : G && O === r.InboxTab.GAME_INVITES ? (0, a.jsx)(I.default, {
            setTab: y,
            badgeState: v,
            closePopout: F
          }) : k && O === r.InboxTab.TODOS ? (0, a.jsx)(g.default, {
            setTab: y,
            onJump: B,
            closePopout: F
          }) : (0, a.jsx)(s.ErrorBoundary, {
            fallback: (0, a.jsx)(N.UnreadsCrashed, {
              setTab: y,
              closePopout: F,
              badgeState: v
            }),

...
class M extends s.PureComponent {
  ...
  constructor(e) {
    super(e), y(this, "videoRef", null), y(this, "_noProblemsTimeout", null), y(this, "_problemsTimeout", null), y(this, "_connectedSound", this.createSound()), y(this, "_loadingText", function() {
      ...
      return m.default.locale.startsWith("en-") && e.push(L.default.Messages.POLLS_MARKETING_EASTER_EGG_LOADING_LINE), e[o().random(e.length - 1)]
...
t.default = d.default.connectStores([h.default, p.default, S.default, C.default], () => ({
  ...
  reducedMotion: C.default.useReducedMotion
}))(e => {
  let {
    isTryingToConnect: t,
    connected: n,

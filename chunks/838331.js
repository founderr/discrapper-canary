...
function v(e) {
    ...
    i.useLayoutEffect(() => {
        let e = document.querySelector('['.concat(I, '="').concat(L, '"]')), t = P.current;
        null != t && null != e && t.scrollIntoViewNode({
            node: e,
            padding: 12
        });
    }, [L]);
    let U = n(C), w = 0 === U.length, x = i.useId(), G = i.useCallback(() => new Promise(e => {
            let t = P.current;
            if (null == t)
                return e();
            ...
            b(t);
            let n = document.querySelector(e), r = P.current;
                        ...
                        (0, r.jsx)('div', {
                            children: D && (w ? (0, r.jsxs)('div', {
                                ...
                                children: (0, r.jsx)(V, {
                                    ...
                                    id: M,
                                    ref: P,
                                    className: o()(m.list, h, { [m.scroller]: R }),
                                    sections: [U.length],
                                    sectionHeight: 0,
                                    rowHeight: 40,
                                    renderRow: e => {
...
function R(e) {
    ...
    let {
            ...
            setSelected: f,
            itemToString: h
        } = i.useContext(N), p = h(n), g = _ === p, S = null !== (t = null == d ? void 0 : d.selected) && void 0 !== t ? t : E.has(n), A = (0, l.JA)(p);
    return (0, r.jsx)(c.P, {
        tag: 'li',
        id: p,
        onClick: () => s ? null : f(n),
...
R.Colors = T, R.Label = function (e) {
    ...
    let {checked: t} = e, {selected: n} = i.useContext(N), a = i.useContext(O);
    return (0, r.jsx)('span', {
        className: m.itemCheckbox,
    ...
    let {selected: e} = i.useContext(N), t = i.useContext(O);

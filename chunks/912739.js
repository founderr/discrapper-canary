...
class h extends s.Component {
  render() {
    ...
    if (e.type === c.AzA.RECENT_RELEASE_DATE) return (0, i.jsx)(E, {
      className: t,
      circle: (0, i.jsx)(_, {
    ...
    if (e.type === c.AzA.RELEASE_DATE) return (0, i.jsx)(E, {
      className: t,
      circle: (0, i.jsx)(_, {
        IconComponent: l.CalendarIcon
      }),
    ...
    if (e.type === c.AzA.EARLY_ACCESS) return null != e.releaseDate ? (0, i.jsx)(E, {
      className: t,
      circle: (0, i.jsx)(_, {

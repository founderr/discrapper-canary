...
function T(e, t, n) {
  ...
  e.parent_id !== a && !(0, C.isGuildHomeChannel)(a) && (0, m.transitionToChannel)(e.parent_id), (0, f.transitionTo)(S.Routes.CHANNEL_THREAD_VIEW((0, c.getGuildIdForGenericRedirect)(e), (0, C.isGuildHomeChannel)(a) ? C.StaticChannelRoute.GUILD_HOME : e.parent_id, e.id), void 0, e.isForumPost() ? g.OpenThreadAnalyticsLocations.FORUM : void 0), setTimeout(() => {
...
function _(e, t, n) {
  l(!e.isForumLikeChannel(), "cannot open thread creation sidebar in forums"), l(!__OVERLAY__, "Cannot create threads in the overlay."), (0, d.trackWithMetadata)(S.AnalyticEvents.THREAD_CREATION_STARTED, {
    ...
    channel_id: e.id,
    guild_id: e.guild_id
  }), u.MainWindowDispatch.dispatch(S.ComponentActions.POPOUT_CLOSE), x.default.getChannelId() !== e.id && (0, m.transitionToChannel)(e.id);

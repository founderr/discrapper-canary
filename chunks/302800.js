...
var a, s, l, i, r = n("278074"),
  ...
  S = n("376477"),
  p = n("224941");
(l = a || (a = {}))[l.NONE = 0] = "NONE", l[l.TOOLTIP = 1] = "TOOLTIP", l[l.COACHTIP = 2] = "COACHTIP", (i = s || (s = {})).NONE = "NONE", i.SHY = "SHY", i.LOFI_VIBES = "LOFI_VIBES", i.GALAXY = "GALAXY", i.RETRO_AND_PIRATES = "RETRO_AND_PIRATES", i.ARCADE = "ARCADE";
let I = {
    ...
    [u.DismissibleContent.COLLECTIBLES_SHOP_ARCADE_COACHTIP]: {
      type: 2,
  ...
  T = e => (0, r.match)(e).with(o.CollectiblesCategorySkuId.SHY, () => ({
  ...
  A = e => (0, r.match)(e).with("1220513977683935373", () => g.SHY).with("1220432647453409384", () => g.SHY).with("1220432697718083614", () => g.SHY).otherwise(() => null)
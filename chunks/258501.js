...
let T = e => {
  ...
  v = e => {
    let {
      ...
      listing: n,
      guildId: a
    } = e, s = (0, i.useStateFromStores)([c.default], () => c.default.getGuild(a), [a]), o = (0, E.default)(a), d = o.filter(e => e.roles.includes(n.role_id)), f = n.role_benefits.benefits.filter(m.isChannelBenefit).slice(0, null === d.length ? 4 : 3), h = (0, g.default)(f).slice(0, null === d.length ? 4 : 3);
    return (0, l.jsxs)("div", {

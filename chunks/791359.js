...
let x = 15 * T.Z.Millis.MINUTE,
  P = (0, Z.Z)(function(e) {
    let {
      ...
      currentActivities: E,
      voiceChannels: h
    } = t, I = u.length, m = _.length, p = E.length, T = h.length > 0, C = s.useCallback(() => {
      let e = E.filter(e => {
        var t, n;
...
function M() {
  ...
  s.useEffect(() => (u.Z.wait(() => C.L()), () => u.Z.wait(() => C.v())), [null == r ? void 0 : r.id]), s.useEffect(() => {
    n && !a && b()
  }, [n, a]);
  let o = s.useMemo(() => {
      let t = new Map,

...
var r = n(481060), i = n(281956), a = n(271383), o = n(430824), s = n(607744), l = n(594174), u = n(447003), c = n(176505), d = n(981631), _ = n(689938);
function E(e, t, n, r) {
    if (null == e)
        return null;
    if (e.id === (null == t ? void 0 : t.rulesChannelId))
        return _.Z.Messages.CHANNEL_TOOLTIP_RULES;
    switch (e.type) {
    case d.d4z.GUILD_TEXT:
        if (r)
            return _.Z.Messages.CHANNEL_TOOLTIP_TEXT_ACTIVE_THREADS;
        if (e.isNSFW())
    ...
    case d.d4z.GUILD_FORUM:
        ...
        if (e.isNSFW())
            return i ? _.Z.Messages.CHANNEL_TOOLTIP_MEDIA_NSFW : _.Z.Messages.CHANNEL_TOOLTIP_FORUM_NSFW;
        if ((0, u.Z)(e))
    ...
    case d.d4z.GUILD_MEDIA:
        if (e.isNSFW())
            return _.Z.Messages.CHANNEL_TOOLTIP_MEDIA_NSFW;
        if ((0, u.Z)(e))
            return _.Z.Messages.CHANNEL_TOOLTIP_MEDIA_LIMITED;
        return _.Z.Messages.MEDIA_CHANNEL;
    case d.d4z.GUILD_STAGE_VOICE:
        if (n)
            return _.Z.Messages.CHANNEL_TOOLTIP_STAGE_LOCKED;
        if ((0, u.Z)(e))
            return _.Z.Messages.CHANNEL_TOOLTIP_STAGE_LIMITED;
        return _.Z.Messages.CHANNEL_TOOLTIP_STAGE;
    case d.d4z.GUILD_VOICE:
        if (n)
            return _.Z.Messages.CHANNEL_TOOLTIP_VOICE_LOCKED;
        if ((0, u.Z)(e))
            return _.Z.Messages.CHANNEL_TOOLTIP_VOICE_LIMITED;
        return _.Z.Messages.CHANNEL_TOOLTIP_VOICE;
    case d.d4z.GUILD_ANNOUNCEMENT:
        if (e.isNSFW())
            return _.Z.Messages.CHANNEL_TOOLTIP_ANNOUNCEMENTS_NSFW;
        if ((0, u.Z)(e))
            return _.Z.Messages.CHANNEL_TOOLTIP_ANNOUNCEMENTS_LIMITED;
...
function f(e, t) {
    ...
    if ((null == e ? void 0 : e.id) === (null == t ? void 0 : t.rulesChannelId))
        return r.BookCheckIcon;
    switch (e.type) {
    case d.d4z.GUILD_ANNOUNCEMENT:
        if (h) {
            if (e.isNSFW())
                return r.AnnouncementsWarningIcon;
            if ((0, u.Z)(e))
                return r.AnnouncementsLockIcon;
            else
    ...
    case d.d4z.GUILD_VOICE:
        ...
        if ((0, u.Z)(e))
            ...
            return E ? r.VideoIcon : r.VoiceNormalIcon;
    case d.d4z.GUILD_DIRECTORY:
        return r.HubIcon;
    ...
    default:
        if (c.EC.has(e.id)) {
            if (e.id === c.HY.GUILD_HOME || e.id === c.HY.SERVER_GUIDE)
                return r.SignPostIcon;
            if (e.id === c.HY.CHANNEL_BROWSER || e.id === c.HY.CUSTOMIZE_COMMUNITY)
                return r.ChannelListMagnifyingGlassIcon;
        }
        return null;
    }
}

...
class l {
    ...
    getRange(e, t, n) {
        let r = (0, i.m)(this.prefix, e), a = (0, i.m)(this.prefix, t);
        return this.database.execute({
            type: 'kv.get_range',
            table: this.tableId,
            range: [
    ...
    deleteRange(e, t) {
        let n = (0, i.m)(this.prefix, e), r = (0, i.m)(this.prefix, t);
        return this.database.execute({
    ...
    deleteGeneration() {
        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 ? arguments[1] : void 0, n = arguments.length > 2 ? arguments[2] : void 0;
        return this.database.execute({

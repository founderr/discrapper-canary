...
let S = (e) => {
    ...
    switch (r) {
        case g.n_.ACTIVITY:
            let s = T.intl.formatToPlainString(T.t.EUFEJi, { username: n }),
                o = '\n> '.concat(i);
            return null != i ? ''.concat(h.jd).concat(s, '*').concat(o, '\n').concat(a) : ''.concat(h.jd).concat(s, '*\n').concat(a);
        case g.n_.AVATAR:
            let l = T.intl.formatToPlainString(T.t.E6H15u, { username: n });
            return ''.concat(h.jd).concat(l, '*\n').concat(a);
        case g.n_.STATUS:
            let c = T.intl.formatToPlainString(T.t.XPQgLy, { username: n }),
                d = '\n> '.concat(i);
...
function y(e) {
    let { user: t, guildId: n, sourceType: u, sourceDetails: h, setPopoutRef: T, onClose: y, entry: A } = e,
        ...
        w = i.useRef(null);
    i.useEffect(() => {
        null == T || T(null == w ? void 0 : w.current);
    }, [w, T]),
        i.useEffect(() => {
            let e = (e) => {
    ...
    return (0, r.jsx)(o.Z, {
        headerClassName: x ? b.noBoxShadowMargin : void 0,
        guildId: null != n ? n : void 0,
        closePopout: I.dG,
        onSelectEmoji: async (e, t) => {
            await P(e), t && (R(), null == y || y());
        },

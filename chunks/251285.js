...
var i = n(442837), a = n(963374), s = n(735020), l = n(905405), r = n(786761), o = n(937889), c = n(699516), d = n(768119);
function u(e) {
    let t = (0, l.p)(), n = (0, i.e7)([
            d.Z,
            s.Z
        ], () => {
            var n;
            let i = d.Z.getQuery(e), l = d.Z.getRawResults(e);
            if (null == i || null == l)
                return [];
            let c = (0, a.nC)(null !== (n = i.content) && void 0 !== n ? n : '');
            return l.map(e => e.map(e => {
                let n = s.Z.getMessage(e.id, e.channel_id), i = (0, r.e5)(e);

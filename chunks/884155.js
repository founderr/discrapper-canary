...
let b = a.memo(e => {
  ...
  let {
    ...
    sessionId: u,
    nick: _
  } = e, A = s.id, P = (0, r.useStateFromStores)([g.default], () => g.default.getId() === A, [A]), [b, D, U] = (0, r.useStateFromStoresArray)([S.default], () => P ? [!S.default.isSupported() || S.default.isSelfMute() || S.default.isSelfMutedTemporarily(), S.default.isSelfDeaf(), !1] : [!S.default.isSupported() || S.default.isLocalMute(A), !1, S.default.isLocalVideoDisabled(A)], [P, A]), w = (0, r.useStateFromStores)([x.default], () => x.default.isPrioritySpeaker(A)), F = (0, o.default)({
    userId: A,
    checkSoundSharing: !0
  }), k = (0, r.useStateFromStores)([C.default], () => C.default.isGuestOrLurker(i.guild_id, A)), B = (0, r.useStateFromStores)([d.default], () => d.default.getEmbeddedActivitiesForChannel(i.id).find(e => {
    let {
      userIds: t
    } = e;
    return t.has(A)
...
var D = function(e) {
  ...
  return null == w && null == S ? null : (0, l.jsxs)(A.VoiceUserList, {

...
t.default = e => {
  let {
    location: t
  } = e, n = (0, l.useStateFromStores)([E.default], () => E.default.isAuthenticated()), N = (0, l.useStateFromStores)([_.default], () => _.default.hasLoadedExperiments), g = (0, c.useIsUnauthenticatedReportFormEnabled)("RSL - Landing Page"), [m, A] = a.useState(!1), [S, v] = a.useState(h.default.Messages.AUTHORIZING), [O, C] = a.useState(!0), R = e => {
    switch (e) {

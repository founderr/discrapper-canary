...
t.Z = e => {
  let {
location: t
  } = e, n = (0, i.e7)([g.default], () => g.default.isAuthenticated()), f = (0, i.e7)([d.Z], () => d.Z.hasLoadedExperiments), N = (0, h.oK)('RSL - Landing Page'), [T, x] = r.useState(!1), [A, C] = r.useState(I.Z.Messages.AUTHORIZING), [v, Z] = r.useState(!0), S = e => {
switch (e) {

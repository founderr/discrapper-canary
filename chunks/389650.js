...
var n = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(392711), l = s.n(o), c = s(442837), d = s(692547), _ = s(481060), E = s(660216), u = s(225433), T = s(825209), I = s(721383), S = s(612226), N = s(714338), C = s(924557), m = s(74299), A = s(131951), h = s(556296), g = s(808506), O = s(285952), p = s(474333), R = s(63063), x = s(358085), M = s(13140), D = s(210887), f = s(659947), P = s(981631), L = s(420212), Z = s(689938), b = s(649560), v = s(5973), j = s(331651);
function B(e, t, s) {
...
class y extends a.PureComponent {
    renderMessage() {
        ...
        return N.Z.hasBind(t) ? (0, n.jsx)(_.FormText, {
            ...
            type: _.FormTextTypes.DESCRIPTION,
            style: { color: d.Z.unsafe_rawColors.RED_400.css },
            children: Z.Z.Messages.KEYBIND_NAVIGATION_CONFLICT.format({ keyboardNavArticle: R.Z.getArticleURL(P.BhN.KEYBOARD_NAVIGATION) })
        }) : (0, n.jsx)(_.FormText, {
            className: b.keybindMessage,
            type: _.FormTextTypes.DESCRIPTION,
    ...
    render() {
        ...
        return (0, n.jsxs)(O.Z, {
            ...
            children: [
                ...
                (0, n.jsx)(O.Z.Child, { children: this.renderMessage() }),
...
class V extends a.PureComponent {
    ...
    render() {
        let e = this.props.enableClips, t = l()(this.props.keybinds).reject(e => e.managed && ![
            ...
            children: [
                (0, n.jsx)(_.FormSection, {
                    ...
                    children: x.isPlatformEmbedded ? (0, n.jsxs)(n.Fragment, {
                        ...
                        children: Z.Z.Messages.KEYBIND_IN_BROSWER_NOTICE.format({ downloadLink: P.EYA.DOWNLOAD })
                    })
                }),
                (0, n.jsx)(_.FormDivider, {}),
                (0, n.jsxs)(_.FormSection, {
                    ...
                    children: [
                        ...
                        (0, n.jsx)(U, {
                            children: e => (0, n.jsx)(n.Fragment, {
                                children: e.map((e, t) => {
                                    let s = (0, S.UD)(e), i = (0, S.U6)(e), o = G[e];
                                    return (0, n.jsxs)('div', {
...
function Y() {
    let e = (0, c.e7)([h.Z], () => h.Z.getState()), t = (0, c.e7)([A.Z], () => (0, m.Z)(A.Z)), s = (0, c.e7)([g.Z], () => g.Z.isSupported()), a = (0, C.Go)();
    return (0, n.jsx)(V, {
        keybinds: e,
        canGoLive: t,
        overlaySupported: s,

...
t.default = a.memo(function(e) {
  ...
  let v, {
    ...
    } = (0, d.default)(),
    {
      onCopy: y,
      copyRef: U
    } = (0, c.default)(L, null == x ? void 0 : null === (t = x.application_command) || void 0 === t ? void 0 : t.id),
    j = (0, r.useStateFromStores)([I.default], () => I.default.getGuild(L.guild_id), [L.guild_id]);
  if (a.useEffect(() => {
      (null == x || x.type === u.ApplicationCommandType.CHAT && void 0 === x.application_command) && E.fetchMessageInteractionData(L.id, P)
    }, [L.id, P, x]), null == x) v = (0, s.jsx)(o.Spinner, {
    type: o.Spinner.Type.SPINNING_CIRCLE,
    className: A.spinner
  });
  else {
    let e = [],
      t = Object.fromEntries((null !== (i = null === (n = x.application_command) || void 0 === n ? void 0 : n.options) && void 0 !== i ? i : []).map(e => [e.name, e]));
    for (let n of null !== (O = x.options) && void 0 !== O ? O : []) e = e.concat(function e(t) {
      var n, l, i, r, d, c, E;
      let A, {
          option: O,
          channel: R,
      ...
      if (O.type === u.ApplicationCommandOptionType.SUB_COMMAND || O.type === u.ApplicationCommandOptionType.SUB_COMMAND_GROUP) {
        let t = [(0, s.jsxs)(a.Fragment, {
            children: [" ", (0, s.jsx)(o.Text, {
              ...h,
              children: null !== (l = null == x ? void 0 : x.name_localized) && void 0 !== l ? l : O.name
            })]
          }, y)],
          u = Object.fromEntries(null === (n = null !== (i = null == x ? void 0 : x.options) && void 0 !== i ? i : []) || void 0 === n ? void 0 : n.map(e => [e.name, e]));
      ...
      if (null != O.value) switch (O.type) {
        ...
        case u.ApplicationCommandOptionType.ATTACHMENT:
          ...
          break;
        default: {
          let e = null == x ? void 0 : null === (d = x.choices) || void 0 === d ? void 0 : d.find(e => e.value === O.value);
      ...
      return null == A && (A = M(null == U ? void 0 : U.toString())), [(0, s.jsxs)(a.Fragment, {
        children: [(0, s.jsxs)(o.Text, {
          ...h,
          children: [" ", null !== (E = null == x ? void 0 : x.name_localized) && void 0 !== E ? E : O.name, ": "]
        }), A]
      }, y)]
    }({
      option: n,
    ...
    v = (0, s.jsxs)(s.Fragment, {
      children: [(0, s.jsxs)(o.Text, {
        ...h,
        children: ["/", null !== (R = null === (l = x.application_command) || void 0 === l ? void 0 : l.name_localized) && void 0 !== R ? R : x.name]
      }), e]
    })
  }
  return (0, s.jsxs)("div", {

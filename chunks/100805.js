...
(0, E.FE)(H, {
  ...
  }, [H]), es = F.features.has(y.S7.POST_ENROLLMENT_CTA), eo = (0, C.Rf)(H), er = (0, C.Jf)(H), ea = null != er ? er.progress > 0 : eo.progressSeconds > 0, el = (null === (n = H.userStatus) || void 0 === n ? void 0 : n.enrolledAt) != null, ei = (null === (r = H.userStatus) || void 0 === r ? void 0 : r.completedAt) != null, ec = o.useMemo(() => (0, E.Xv)(H.config), [H.config]), ed = Z && P, eu = (0, E.ph)(H), ep = (0, S.D)({
quest: H,
taskDetails: eo,
...
className: a()(U, O.contentExpanded, {

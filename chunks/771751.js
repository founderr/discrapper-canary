...
function S(e) {
    ...
    let { id: N, expires_at: T, redeemed_at: E, trial_id: I, subscription_trial: Z } = c,
        R =
            null !==
                (r =
                    null ===
...
function N(e) {
    ...
    let { id: v, expires_at: w, applied_at: j, discount_id: S, discount: N } = i,
        T =
            null !==
                (r =
                    null ===
        ...
        Z = async () => {
            f(!0), E ? await C(v, 'discount') : await (0, d.a)(void 0, i), c(), f(!1);
        };
    n.useEffect(() => {
        if (u) {
            let e = setTimeout(() => {

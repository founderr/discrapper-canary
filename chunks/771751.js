...
function _(e) {
  ...
  let {
    ...
    offerOptions: u,
    forceRefetch: h
  } = e, [b, x] = i.useState(!1), [v, S] = i.useState(!1), [j, N] = i.useState(!1), [C, _] = i.useState(!1);
  i.useEffect(() => {
    j && _(!0);
    let e = setTimeout(() => {
      _(!1)
...
function I(e) {
  ...
  let {
    ...
    return t === _
  })) || void 0 === t ? void 0 : t.label) && void 0 !== r ? r : "Unknown", P = null != N, O = null != N && new Date(N).getTime() < Date.now(), A = async () => {

...
offerOptions: u,
forceRefetch: h
  } = e, [p, b] = n.useState(!1), [y, k] = n.useState(!1), [v, w] = n.useState(!1), [C, N] = n.useState(!1);
  n.useEffect(() => {
v && N(!0);
let e = setTimeout(() => {
  N(!1);
...
return r === I;
  })) || void 0 === r ? void 0 : r.label) && void 0 !== t ? t : 'Unknown', O = null != T, B = null != T && new Date(T).getTime() < Date.now(), P = (null == Z ? void 0 : Z.sku_id) === f.Si.TIER_0, A = async () => {

...
function y(e) {
    ...
    let { id: w, expires_at: k, redeemed_at: E, trial_id: I, subscription_trial: R } = c,
        Z =
            null !==
                (n =
                    null ===
...
function w(e) {
    ...
    let { id: j, expires_at: S, applied_at: N, discount_id: y, discount: w } = l,
        k =
            null !==
                (n =
                    null ===
        ...
        R = async () => {
            g(!0), E ? await T(j, 'discount') : await (0, u.a)(void 0, l), c(), g(!1);
        };
    a.useEffect(() => {
        if (d) {
            let e = setTimeout(() => {

...
function N(e) {
	...
	let { id: S, expires_at: T, redeemed_at: I, trial_id: E, subscription_trial: Z } = c,
		R =
			null !==
				(t =
					null ===
		...
		P = (null == Z ? void 0 : Z.sku_id) === f.Si.TIER_0,
		L = async () => {
...
function S(e) {
	...
	let { id: v, expires_at: C, applied_at: j, discount_id: N, discount: S } = i,
		T =
			null !==
				(t =
					null ===
				...
				: 'Unknown',
		I = null != C,
		E = null != C && new Date(C).getTime() < Date.now(),
		Z = async () => {

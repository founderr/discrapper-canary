var r = n(735250), i = n(470079), a = n(392711), o = n.n(a), s = n(481060), l = n(85235), u = n(367907), c = n(998698), d = n(895924), _ = n(718745), E = n(156361), f = n(285952), h = n(590921), p = n(665692), m = n(981631), I = n(689938), T = n(827838);
let g = {
    results: {
        command: null,
        integrations: [],
...
function S(e, t, n) {
    var r, i;
    let a;
    return n.commands === h.L8.OLD_BUILT_INS ? (a = t.split(' ')[0].substring(p.GI.length), t = t.substring((null !== (r = a.length) && void 0 !== r ? r : 0) + p.GI.length)) : a = null === (i = c.Z.getActiveCommand(e.id)) || void 0 === i ? void 0 : i.name, {
        command: a,
        query: t.trim()
    };
}
    ...
    renderResults(e) {
        ...
        if (null != t) {
            ...
            let e = !1, n = t.map((t, n) => {
                ...
                }), s = u.commands === h.L8.OLD_BUILT_INS ? p : null !== (N = null === (A = c.Z.getActiveCommand(o.id)) || void 0 === A ? void 0 : A.integrationTitle) && void 0 !== N ? N : p, l = g.length > 0 && null != s ? I.Z.Messages.CONTENT_MATCHING.format({
                    query: g,
                    command: s
                }) : null != s ? s : p;

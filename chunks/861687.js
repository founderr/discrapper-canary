...
class ea extends d.Z {
  ...
  connect(e, t) {
    ...
    if (this.endpoint = e, this.token = t, (n !== this.endpoint || i !== t) && (this._cleanupSocket(), this._mediaSessionId = null, null != n && (this._rtcConnectionId = (0, u.Z)(), I.Z.dispatch({
  ...
  setSimulcastDebugOverride(e, t, n) {
    var i, r;
    if (t === this.context) t === ei.Yn.DEFAULT ? null === (i = this._localMediaSinkWantsManager) || void 0 === i || i.setSimulcastDebugOverride(e, n) : null === (r = this._goLiveQualityManager) || void 0 === r || r.setSimulcastDebugOverride(n)
  }
  set channelId(e) {
  ...
  _handleDisconnect(e, t, n, i) {
    var r, s, o, a, l, u;
    this.logger.info("Disconnected from RTC server, clean: ".concat(t, ", code: ").concat(n, ", reason: ").concat(i, ", state: ").concat(this.state)), !t && this._connecting && !this._encountered_socket_failure && (V.default.track(et.rMx.VOICE_CONNECTION_SOCKET_FAILURE, {
    ...
    if (this.state !== et.hes.DISCONNECTED) {
      ...
      null != e && this.context === ei.Yn.DEFAULT && (e.stop(), this._sentVideo && e.getOutboundStats().forEach(t => {
        var n;
        (null !== (n = t.num_frames) && void 0 !== n ? n : 0) > 0 && V.default.track(et.rMx.VIDEO_STREAM_ENDED, {
          ...this._getAnalyticsProperties(),
        ...
        (null !== (n = null == r ? void 0 : r.num_frames) && void 0 !== n ? n : 0) > 0 && V.default.track(et.rMx.VIDEO_STREAM_ENDED, {
          ...this._getAnalyticsProperties(),
          media_session_id: this.getMediaSessionId(),
          sender_user_id: t,
          reason: i,
      ...
      for (let [e, t, n] of(G.Z.getMediaEngine().getCodecSurvey().then(e => {
          ...
          this.logger.warn(e)
        }), Object.values(this._mlsFailures))) V.default.track(et.rMx.MLS_FAILURES, {
        ...this._getAnalyticsProperties(),
        media_session_id: s,
        parent_media_session_id: this.parentMediaSessionId,
        failure_source: e,
  ...
  _handleReady(e, t, n, i, r, s, o) {
    this.setState(et.hes.RTC_CONNECTING), this.port = n, null != o && this._chooseExperiments(o), 0 === s.length && s.push({
      type: ei.Tr.VIDEO,
      rid: "100",
      ssrc: r + 1,
      rtxSsrc: r + 2,
    ...
    let a = G.Z.getMediaEngine(),
      l = a.connect(this.context, this.userId, {
        ssrc: r,
        address: t,
        port: n,
        modes: i,
    ...
    if (l.setUseElectronVideo(a.supports(ei.AN.ELECTRON_VIDEO)), G.Z.supports(ei.AN.IMAGE_QUALITY_MEASUREMENT)) {
      let {
        enabled: e,
        measurement: t
      } = P.Z.getConfig(!0);
    ...
    let u = ["unk"];
    if (G.Z.supports(ei.AN.AMD_EXPERIMENTAL_RATE_CONTROL) && u.push("amdRelaxRc"), this.context === ei.Yn.STREAM) {
      let {
        nvMediumVbvSizeMs: e
    ...
    l.setVideoEncoderExperiments(u.join(",")), l.on(c.Sh.Speaking, (e, t, n) => {
      this.userId === e && this.sendSpeaking(t, n), this.emit(W.z.Speaking, e, t)
    }), l.on(c.Sh.ToggleMuteFromNative, () => {
      let {
      ...
      e && this.context === ei.Yn.DEFAULT && T.Z.toggleSelfMute({
        playSoundEffect: !1
      })
    }), l.on(c.Sh.NativeMuteChanged, e => {
      this.context === ei.Yn.DEFAULT && S.Z.nativeMuteChanged(e)
    }), l.on(c.Sh.Video, (e, t, n, i, r, s) => {
    ...
    }), l.on(c.Sh.VideoEncoderFallback, t => {
    ...
    }), l.on(c.Sh.ConnectionStateChange, t => {
      ...
      if (n === et.hes.RTC_CONNECTING && this.state === et.hes.RTC_DISCONNECTED ? this.reconnect() : this.state === et.hes.NO_ROUTE && this._backoff.fail(this.reconnect), this.state === et.hes.RTC_CONNECTED) {
        ...
        }), null === (i = this._localMediaSinkWantsManager) || void 0 === i || i.setConnection(l), null === (r = this._goLiveQualityManager) || void 0 === r || r.update(), this._connectCompletedTime = (0, E.zO)(), this._connected = !0, this._connecting = !1, this._encountered_socket_failure = !1
      } else n === et.hes.RTC_CONNECTED && this.stateHistory.reset(this.state)
    }), l.on(c.Sh.SecureFramesUpdate, e => {
      this._secureFramesState = e, this.emit(W.z.SecureFramesUpdate, e)
    }), l.on(c.Sh.Ping, this._handlePing.bind(this)), l.on(c.Sh.PingTimeout, this._handlePingTimeout.bind(this)), l.on(c.Sh.OutboundLossRate, this._handleOutboundLossRate.bind(this)), l.on(c.Sh.SoundshareTrace, this._handleSoundshareTrace.bind(this)), l.on(c.Sh.LocalVideoDisabled, this._handleLocalVideoDisabled.bind(this)), l.on(c.Sh.Stats, j.Z.create()), l.on(c.Sh.RemoteStreamsReady, this._handleRemoteStreamsReady.bind(this)), l.on(c.Sh.NoiseCancellationError, e => {
      this._noiseCancellationError = e
    }), l.on(c.Sh.MLSFailure, (e, t) => {
      ...
      if (!s) return;
      let o = (0, F.I5)(r, en.p9.TIER_1),
        a = 0 === t && n >= 10 || t > 720 || n > 30;
      if (o && a) {
        let {
          bucket: e
  ...
  _handleSpeaking(e, t, n, i) {
    ...
    if (null != r && this.userId !== t) {
      var s;
      i !== ei.Dg.NONE && (r.createUser(t, n), I.Z.dispatch({
  ...
  getOrCreateVideoQuality() {
    if (null != this._connection && null == this._videoQuality) {
      ...
      if (e) {
        this._videoHealthManager = new Q.y(t, n, i, r), null != this._localMediaSinkWantsManager && (this._localMediaSinkWantsManager.videoHealthManager = this._videoHealthManager);
  ...
  _handleVideoStreamId(e) {
    ...
    if (this.emit(W.z.Video, this.guildId, this.channelId, s, o, this.rtcServerId), null != o && null == this.getOrCreateVideoQuality() && this.logger.error("_handleVideoStreamId: Unable to create videoQuality."), null != this._videoQuality && this.userId === s && l.forEach(e => {
        var t, n;
        let i = null !== (t = e.ssrc) && void 0 !== t ? t : 0;
        i > 0 && !0 === e.active && (null === (n = this._videoQuality) || void 0 === n || n.setOutboundSsrc(i))
      }), this.userId !== s) {
      let e = 0 === a && null === o;
      (!e || e && (null === (t = this._videoQuality) || void 0 === t ? void 0 : t.getInboundParticipants().includes(s))) && (null === (n = this._videoQuality) || void 0 === n || n.setInboundUser(s, a), null === (i = this._videoHealthManager) || void 0 === i || i.createUser(s))
    }
    null != this._connection && this.userId !== s && (null === (r = this._localMediaSinkWantsManager) || void 0 === r || r.setStreamId(s, o))
  }
  ...
  _handleRemoteStreamsReady(e) {
    ...
    V.default.track(et.rMx.VOICE_CONNECTION_REMOTE_STREAMS_CREATED, {
      ...this._getAnalyticsProperties(),
      number_of_users: e,
      duration_ms: t
    })
  ...
  _handleClientDisconnect(e) {
    ...
    if (null != r && this.context === ei.Yn.DEFAULT) {
      let t = r.getInboundStats(e),
        s = null !== (n = null == t ? void 0 : t.num_frames) && void 0 !== n ? n : 0;
      null != t && s > 0 && (V.default.track(et.rMx.VIDEO_STREAM_ENDED, {
        ...this._getAnalyticsProperties(),
        media_session_id: this.getMediaSessionId(),
        sender_user_id: e,
    ...
    null != s && s.destroyUser(e), null === (t = this._localMediaSinkWantsManager) || void 0 === t || t.destroyUser(e), this.emit(W.z.ClientDisconnect, e)
  }
  _handleCodecs(e, t) {
  ...
  _trackSecureFrameTransition(e, t) {
    V.default.track(et.rMx.SECURE_FRAMES_TRANSITION, {
      ...this._getAnalyticsProperties(),
      media_session_id: this.getMediaSessionId(),
      parent_media_session_id: this.parentMediaSessionId,
      sender_user_id: this.userId,
  ...
  constructor({
    ...
    super(), er(this, "context", void 0), er(this, "userId", void 0), er(this, "sessionId", void 0), er(this, "guildId", void 0), er(this, "parentMediaSessionId", void 0), er(this, "hostname", void 0), er(this, "state", void 0), er(this, "_videoQuality", void 0), er(this, "_soundshareStats", void 0), er(this, "logger", void 0), er(this, "rtcServerId", void 0), er(this, "_channelId", void 0), er(this, "channelIds", void 0), er(this, "_endpoint", void 0), er(this, "port", void 0), er(this, "token", void 0), er(this, "protocol", void 0), er(this, "voiceVersion", void 0), er(this, "rtcWorkerVersion", void 0), er(this, "_socket", void 0), er(this, "_backoff", void 0), er(this, "_destroyed", void 0), er(this, "_pings", void 0), er(this, "_pingBadCount", void 0), er(this, "_pingTimeouts", void 0), er(this, "_mediaSessionId", void 0), er(this, "_voiceQuality", void 0), er(this, "_voiceQualityPeriodicStatsInterval", void 0), er(this, "_voiceQualityPeriodicStatsSequenceId", void 0), er(this, "_noiseCancellationError", void 0), er(this, "_voiceDuration", void 0), er(this, "_videoHealthManager", void 0), er(this, "_sentVideo", void 0), er(this, "_outboundLossRate", void 0), er(this, "_recordingEnabled", void 0), er(this, "_selectedExperiments", void 0), er(this, "_localMediaSinkWantsManager", void 0), er(this, "_goLiveQualityManager", void 0), er(this, "_remoteVideoSinkWants", void 0), er(this, "_connection", void 0), er(this, "_createdTime", void 0), er(this, "_connectStartTime", void 0), er(this, "_connectCompletedTime", void 0), er(this, "_rtcConnectionId", void 0), er(this, "_connectCount", void 0), er(this, "_connected", void 0), er(this, "_connecting", void 0), er(this, "_encountered_socket_failure", void 0), er(this, "_inputDetected", void 0), er(this, "_encryptionMode", void 0), er(this, "stateHistory", void 0), er(this, "_supportedBandwidthEstimationExperiments", void 0), er(this, "_bandwidthEstimationExperiment", void 0), er(this, "_secureFramesState", void 0), er(this, "_mlsFailures", void 0), er(this, "powerMonitorListener", void 0), er(this, "reconnect", () => {
      ...
      if (null != this._voiceQuality) {
        ...
        if (this.shouldReportPeriodicStats(e))
          for (let t of e) V.default.track(et.rMx.VOICE_QUALITY_PERIODIC_STATS, {
            ...this._getAnalyticsProperties(),
            media_session_id: this.getMediaSessionId(),
      ...
      let e = b.Z.getChannel(this.channelId),
        t = null != e ? e.type : null;
      V.default.track(et.rMx.VOICE_CONNECTION_CONNECTING, {
        guild_id: this.guildId,
        channel_id: this.channelId,
        rtc_connection_id: this.getRTCConnectionId(),
        hostname: this.hostname,
    ...
    }), this.context = r, this.logger = new f.Z("RTCConnection(".concat(null !== (a = null != s ? s : n) && void 0 !== a ? a : i, ", ").concat(this.context, ")")), this.userId = e, this.sessionId = t, this.guildId = n, this._channelId = i, this.channelIds = new Set([i]), this.rtcServerId = s, this.parentMediaSessionId = o, this._endpoint = null, this.hostname = null, this.port = null, this.token = null, this.voiceVersion = null, this.rtcWorkerVersion = null, this.state = et.hes.AWAITING_ENDPOINT, this.stateHistory = new K.K(this.state), this._socket = null, this._backoff = new _.Z(1e3, 1e4), this._destroyed = !1, this._pings = [], this._pingBadCount = 0, this._pingTimeouts = [], this._mediaSessionId = null, this._voiceQuality = null, this._voiceQualityPeriodicStatsInterval = null, this._voiceQualityPeriodicStatsSequenceId = 0, this._noiseCancellationError = 0, this._voiceDuration = null, this._videoQuality = null, this._videoHealthManager = null, this._sentVideo = !1, this._outboundLossRate = null, this._createdTime = (0, E.zO)(), this._connectStartTime = 0, this._connectCompletedTime = 0, this._rtcConnectionId = (0, u.Z)(), this._connectCount = 0, this._connected = !1, this._connecting = !1, this._encountered_socket_failure = !1, this._inputDetected = !1, this._selectedExperiments = [], this._secureFramesState = null;
    let d = G.Z.supports(ei.AN.FIRST_FRAME_CALLBACK) && G.Z.supports(ei.AN.REMOTE_USER_MULTI_STREAM);
    if (r === ei.Yn.DEFAULT) {
      let t = (null === (l = b.Z.getChannel(this.channelId)) || void 0 === l ? void 0 : l.type) === et.d4z.GUILD_STAGE_VOICE;
    ...
    } else r === ei.Yn.STREAM && (this._goLiveQualityManager = new m.Z(d), this._goLiveQualityManager.on(m.y.RequestedSSRCsUpdate, (e, t, n) => {
      var i;
      null === (i = this._connection) || void 0 === i || i.createUser(e, t, n)
    }), this._goLiveQualityManager.on(m.y.RequestedStreamsUpdate, e => {
      if (this.state === et.hes.RTC_CONNECTED && null != this._socket) {
        var t;

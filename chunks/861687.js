...
var r, i = n(654861), a = n.n(i), o = n(108131), s = n.n(o), l = n(729594), u = n(772848), c = n(261470), d = n(47770), _ = n(46973), E = n(379649), f = n(570140), h = n(668781), p = n(846027), m = n(304680), I = n(547727), T = n(710845), g = n(811660), S = n(42352), A = n(148959), N = n(227196), v = n(926951), O = n(868616), R = n(848886), C = n(583215), y = n(576574), D = n(307320), L = n(420363);
n(527702);
var b = n(214890), M = n(592125), P = n(131951), U = n(19780), w = n(226961), x = n(936349), G = n(594174), k = n(626135), B = n(931619), F = n(358085), V = n(579806), H = n(859401), Z = n(437263), Y = n(423343), j = n(685756), W = n(655306), K = n(583794), z = n(824096), q = n(53114), Q = n(174532), X = n(895066), $ = n(981631), J = n(65154);
function ee(e, t, n) {
...
class er extends d.Z {
    ...
    _handleDisconnect(e, t, n, r) {
        ...
        if (this.state !== $.hes.DISCONNECTED) {
            ...
            let t = x.Z.shouldIncludePreferredRegion() ? x.Z.getPreferredRegion() : null, n = P.Z.getSettings(), i = M.Z.getChannel(this.channelId);
        ...
        this.setState($.hes.DISCONNECTED, { willReconnect: c });
    }
    _handleResuming(e) {
        var t, n;
    ...
    _handleReady(e, t, n, r, i, a, o) {
        ...
        let s = P.Z.getMediaEngine(), l = s.connect(this.context, this.userId, {
                ssrc: i,
                address: t,
                port: n,
                modes: r,
        ...
        if (P.Z.supports(J.AN.AMD_EXPERIMENTAL_RATE_CONTROL) && u.push('amdRelaxRc'), this.context === J.Yn.STREAM) {
            ...
            if (null != this.guildId) {
                let {enableAdaptiveKeyFrame: e} = R.Z.getCurrentConfig({
                    guildId: this.guildId,
                    location: 'handleReady'
                }, { autoTrackExposure: !0 });
        ...
        l.setVideoEncoderExperiments(u.join(',')), l.on(_.Sh.Speaking, (e, t, n) => {
            ...
            let {airpodsMuteSupported: e} = N.Z.getCurrentConfig({ location: 'RTCConnection ToggleMuteFromNative' }, { autoTrackExposure: !0 });
            e && this.context === J.Yn.DEFAULT && p.Z.toggleSelfMute({ playSoundEffect: !1 });
            ...
            this._secureFramesState = e, this.emit(Z.z.SecureFramesUpdate, e);
    ...
    _getAnalyticsProperties() {
        let e = M.Z.getChannel(this.channelId), t = null != e ? e.type : null;
        return {
    ...
    shouldReportPeriodicStats(e) {
        ...
        let {
            ...
            percentageOfCalls: n
        } = b.Z.getCurrentConfig({ location: '104dee_3' }, { autoTrackExposure: !1 });
        if (!t)
            return !1;

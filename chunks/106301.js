let r, i, a;
n(47120);
var o, s = n(392711), l = n.n(s), u = n(442837), c = n(570140), d = n(981631);
function _(e, t, n) {
...
_(h, 'displayName', 'HangStatusStore'), _(h, 'persistKey', 'HangStatusStore'), t.Z = new h(c.Z, {
    ...
    UPDATE_HANG_STATUS_CUSTOM: function (e) {
        ...
        let s = [...E.recentCustomStatuses], u = s.findIndex(e => e.status === t && l().isEqual(e.emoji, n));
    ...
    DELETE_INVALID_HANG_STATUSES: function (e) {
        let {statuses: t} = e, n = [...E.recentCustomStatuses];
        t.forEach(e => {
            let {
                    status: t,
                    emoji: o

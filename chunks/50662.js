...
function m(e) {
  ...
  let {
    ...
    rejectRequest: b,
    submitting: j
  } = (0, N.s)(S, P), v = null === (s = t.actionedByUser) || void 0 === s ? void 0 : s.id, p = (0, l.e7)([E.default], () => E.default.getUser(v)), f = (0, l.e7)([I.ZP], () => null != v ? I.ZP.getMember(S, v) : null, [v, S]), Z = (0, l.e7)([u.Z], () => u.Z.getMemberCount(S)), B = (null != Z ? Z : 0) >= m.maxMembers, O = R.Z.Messages.GUILD_SETTINGS_MEMBER_VERIFICATION_PENDING, L = (0, a.jsx)(o.ClockIcon, {
    size: "custom",
    color: "currentColor",
    width: 24,
    height: 24,
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsxs)("div", {
      ...
      children: [(0, a.jsxs)("div", {
        ...
        className: M.inline,
        children: [t.applicationStatus === T.wB.SUBMITTED && (0, a.jsxs)("div", {
          className: M.buttons,

...
function N(e) {
  let {
    channel: t,
    baseChannelId: n
  } = e, N = (0, I.default)(t), O = (0, c.useListHasSingleMessageRequest)(), v = (0, c.useListHasSingleSpamMessageRequest)(), R = (0, l.useStateFromStores)([u.default], () => u.default.isMessageRequest(t.id)), L = (0, l.useStateFromStores)([d.default], () => d.default.isSpam(t.id)), P = (0, E.useLongestChannelMessageBeforeReply)(t.id, t.getRecipientId()), M = s.useCallback(() => {
    _.default.closeChannelSidebar(C.MESSAGE_REQUESTS_BASE_CHANNEL_ID), R && O && (0, h.transitionToChannel)(t.id), L && v && (0, h.transitionToChannel)(t.id)
  }, [t.id, L, v, R, O]), y = s.useCallback(() => {

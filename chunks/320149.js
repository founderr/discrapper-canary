...
function N(e) {
  let {
    channel: t,
    baseChannelId: n
  } = e, N = (0, S.default)(t), v = (0, c.useListHasSingleMessageRequest)(), R = (0, c.useListHasSingleSpamMessageRequest)(), O = (0, i.useStateFromStores)([u.default], () => u.default.isMessageRequest(t.id)), L = (0, i.useStateFromStores)([d.default], () => d.default.isSpam(t.id)), M = (0, E.useLongestChannelMessageBeforeReply)(t.id, t.getRecipientId()), y = s.useCallback(() => {

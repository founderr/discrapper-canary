  ...
  return S(el), (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)("div", {
      ...
      children: [(0, i.jsx)(B.Z, {
        ...
        children: [X.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_UNUSED_SLOT_NOTICE.format({
          slotCount: m.length
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [(0, i.jsx)(_.NumberInputStepper, {
          value: r,
          onChange: e => o(e),
        ...
        children: el ? (0, i.jsx)(_.Spinner, {}) : e_ ? (0, F.T4)(ec.amount, ec.currency) : function(e) {
          ...
          if (i === K.rV.YEAR) return X.Z.Messages.BILLING_PRICE_PER_YEAR_EACH.format({
            price: t
          });
          if (i === K.rV.MONTH && 1 === l) return X.Z.Messages.BILLING_PRICE_PER_MONTH_EACH.format({
            price: t
          });
          if (i === K.rV.MONTH && l > 1) return X.Z.Messages.BILLING_PRICE_PER_MULTI_MONTH_EACH.format({
            price: t
          });
          return null
        }({
...
function $(e) {
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [null != D && null != f ? (0, i.jsx)(Q, {

...
function p(e) {
  ...
  if ((null == r ? void 0 : r.id) != null) {
    let e = f.default.canUseEmojisEverywhere(c.default.getCurrentUser()) && null != d.default.getUsableCustomEmojiById(r.id);
    v = e ? r : null
  ...
  return (0, n.jsxs)(o.ModalRoot, {
    ...
    children: [(0, n.jsxs)(o.ModalContent, {
      ...
      children: [(0, n.jsxs)("div", {
        ...
        onClick: () => {
          let e = p.trim();
          "" !== e && null != C && ((0, j.updateCustomHangStatus)(e, C, !0), i())
        },

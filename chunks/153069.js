...
let {
  country: t
} = this.props, s = !this.hasError('email') && this.hasError('password'), o = (0, n.jsxs)(r.Fragment, {
  children: [
    (0, n.jsx)(h.Dx, {
...
super(e), M(this, 'loginRef', void 0), M(this, 'passwordRef', void 0), M(this, 'codeRef', void 0), M(this, 'handleAuthToken', async e => {
  ...
  try {
    A.S.dispatch(I.CkL.WAVE_EMPHASIZE), await c.Z.forgotPassword(s), (0, d.openModal)(e => (0, n.jsx)(d.ConfirmModal, {
      ...
      children: (0, n.jsx)(d.Text, {
        variant: 'text-md/normal',
        children: R.Z.Messages.EMAIL_VERIFICATION_INSTRUCTIONS_BODY.format({
          email: s
        })
      })
    }));
  ...
  try {
    let {
      token: t
    } = await p.Z.verifyPhone(this.getFullLogin(), e, !1, !0);
    this.setState({

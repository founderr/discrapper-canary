...
t.default = (0, d.default)(e => {
  ...
  let {
    ...
    disclosures: I,
    integrationType: g
  } = e, T = "OAuth2Authorize_".concat(a, "_").concat(C, "_").concat(m), A = null != g ? null == o ? void 0 : o.get(g) : void 0, N = null !== (t = null == A ? void 0 : A.application) && void 0 !== t ? t : i.default.getApplication(a);

...
t.Z = (0, E.Z)(
    (e) => {
        var t;
        let { clientId: n, authorizations: c, scopes: d, parsedPermissions: u, responseType: E, redirectUri: I, codeChallenge: g, codeChallengeMethod: p, state: T, guildId: f, channelId: S, prompt: C, disableGuildSelect: N, disclosures: A, integrationType: v, pid: L } = e,
            Z = 'OAuth2Authorize_'.concat(n, '_').concat(f, '_').concat(S),
        ...
        return new Promise((e, t) => {
            ...
            if (l.context === m.IlC.OVERLAY) {
                s.Z.subscribe('OVERLAY_OAUTH2_AUTHORIZE_MODAL_CLOSE', O),
                    s.Z.dispatch({
            ...
            (0, a.openModal)(
                ...
                null != R && (0, r.Z)(R, S) ? a.POPOUT_MODAL_CONTEXT : a.DEFAULT_MODAL_CONTEXT
            );
        });
    },
    function (e, t, n) {

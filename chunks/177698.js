...
t.Z = (0, h.Z)(
    (e) => {
        var t;
        let { clientId: n, authorizations: c, scopes: d, parsedPermissions: u, responseType: h, redirectUri: I, codeChallenge: g, codeChallengeMethod: p, state: T, guildId: S, channelId: C, prompt: f, disableGuildSelect: N, disclosures: A, integrationType: v, pid: L } = e,

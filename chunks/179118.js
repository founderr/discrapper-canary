...
giftMessageError: T,
isSendingMessage: N
  } = e, [p, A] = a.useState(u.CopyInput.Modes.DEFAULT), Z = (0, c.e7)([L.Z], () => L.Z.enabled), U = d || null != o && null != m, v = (null == i ? void 0 : i.productLine) === x.POd.COLLECTIBLES, b = () => null != l ? l.skuId : null != i ? i.id : null, F = () => {
let e;
let s = null != o && f.V4.includes(o);
return null != T ? g.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_FAILURE_GENERIC_BLURB : null == l ? null : (e = l.interval === f.rV.MONTH ? U ? s ? g.Z.Messages.APPLICATION_STORE_SEASONAL_GIFT_PURCHASE_AND_MESSAGE_CONFIRM_SUBSCRIPTION_MONTHLY : g.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_AND_MESSAGE_CONFIRM_SUBSCRIPTION_MONTHLY : g.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_CONFIRM_SUBSCRIPTION_MONTHLY : U ? s ? g.Z.Messages.APPLICATION_STORE_SEASONAL_GIFT_PURCHASE_AND_MESSAGE_CONFIRM_SUBSCRIPTION_YEARLY : g.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_AND_MESSAGE_CONFIRM_SUBSCRIPTION_YEARLY : g.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_CONFIRM_SUBSCRIPTION_YEARLY).format({
  skuName: (0, R.aq)(l.id),
  intervalCount: l.intervalCount
});
  }, y = (e, s) => {
null != i && (0, P.dM)(new S.Z({
  code: s,
  maxUses: 1
}), i);
try {
...
return (0, t.jsxs)('div', {
  ...
  children: [
    (0, t.jsx)(u.FormTitle, {
      children: g.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_PRIVATE_LINK
    }),
...
children: [
  ...
  d && null != m && null == T || U ? (0, t.jsxs)(t.Fragment, {
    children: [
      (0, t.jsx)(I.Z, {
        user: m,
...
d.Z.fetchRelationships(), (0, T.W)();
  ...
  let [i, r] = a.useState(), [l, E] = a.useState(!1), [C, S] = a.useState(!1), {
userAffinities: L,
isLoading: O
  } = (0, c.cj)([N.Z], () => ({
userAffinities: N.Z.getUserAffinitiesUserIds(),
isLoading: N.Z.getFetching()
  })), P = Array.from(L.values()), R = (0, c.e7)([p.Z], () => p.Z.getFriendIDs()), x = o().difference(R, P), f = [
...P,
...x
...
children: [
  (0, t.jsx)(u.FormTitle, {
    children: g.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_GIFT_RECIPIENT_SECTION_LABEL
  }),
  (0, t.jsxs)('div', {
    className: h.giftRecipient,
    children: [
      (0, t.jsx)(u.SearchableSelect, {
        ...
        renderLeading: () => O ? (0, t.jsx)(u.Spinner, {
          type: u.SpinnerTypes.PULSING_ELLIPSIS
        }) : null,
        value: i,
        onChange: e => {

...
function p() {
    var e;
    let t = null === (e = s.Z.getVoiceStateForUser(r.default.getId())) || void 0 === e ? void 0 : e.channelId;
    if (null == t) return !1;
    let n = i.Z.getChannel(t);
    if (null == n) return !1;
    let o = a.Z.getGuild(n.guild_id);
    return null != o && o.premiumTier >= E.Eu4.TIER_2;
}
function m() {

...
var l = t(735250), a = t(470079), s = t(120356), r = t.n(s), i = t(442837), o = t(481060), d = t(570140), c = t(528963), h = t(933557), u = t(471445), g = t(592125), m = t(984933), p = t(430824), M = t(496675), _ = t(699516), O = t(944486), x = t(594174), L = t(346656), b = t(153124), C = t(626135), N = t(709054), F = t(981631), Z = t(689938), f = t(582692);
function j(e, n, t) {
...
class I extends a.PureComponent {
    ...
    renderFooter() {
        let {
                ...
                selectedChannelId: n,
                submitting: t
            } = this.state, {onClose: s} = this.props;
    ...
    constructor(e) {
        super(e), j(this, 'handleGuildSelect', e => {
            let {guilds: n} = this.props, {selectedGuildId: t} = this.state, l = n[e].channels, a = this.getDefaultChannelId(l);
            t !== e && this.setState({
                selectedGuildId: e,
                selectedChannelId: a,
                channels: l
            ...
            null != a && (this.setState({ submitting: !0 }), c.Z.createChannelFollower(a, e.id).then(() => {
                d.Z.dispatch({
                    type: 'CHANNEL_FOLLOWER_CREATED',
                    channelId: a,
                    guildId: s
                }), n(), (0, o.openModalLazy)(async () => {
                    let {default: e} = await t.e('14760').then(t.bind(t, 897140));
...
n.default = i.ZP.connectStores([
    ...
    let {channel: n} = e, t = p.Z.getGuild(n.guild_id), l = Object.values(p.Z.getGuilds()).reduce((e, n) => {

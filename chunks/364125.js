...
function c(e) {
  let {
    ...
    focused: h,
    canvas: m
  } = e, p = a.useRef(!1), E = (0, l.useStateFromStores)([s.default], () => s.default.getDrawMode()), g = (0, o.default)((0, u.default)(t.id, n, c), f), C = (0, o.default)((0, d.default)(t.id, n, c), f), S = a.useCallback((e, t, n) => {
    if (null == m) return;
    let {
      x: a,
      y: l

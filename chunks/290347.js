...
var i = n(735250), s = n(470079), a = n(120356), r = n.n(a), l = n(330711), o = n(442837), c = n(481060), d = n(607070), u = n(605236), _ = n(524444), h = n(529815), E = n(250496), I = n(153124), m = n(810090), g = n(626135), p = n(565216), T = n(981631), S = n(921944), C = n(757601);
let f = e => {
        let {
            tagText: t,
            className: n
...
function A(e) {
    ...
    function ee() {
        let e = Date.now(), t = e - q.current, n = Q.current, i = X.current;
    ...
    return s.useEffect(() => {
        ...
        null != A && (0, u.kk)(A);
        let e = Date.now();
        return g.default.track(T.rMx.CHANGE_LOG_OPENED, { change_log_id: b }), () => {
            g.default.track(T.rMx.CHANGE_LOG_CLOSED, {
                change_log_id: b,
                seconds_open: Math.round((Date.now() - e) / 1000)
            }), null != A && (0, u.EW)(A, { dismissAction: S.L.DISMISS });
        };
    }, [
        A,
        b
        ...
        children: [
            ...
            (0, i.jsx)(p.Z, { className: C.splash }),
            null == Z ? void 0 : Z(),
            (0, i.jsxs)(c.ModalContent, {
                ...
                children: [
                    ...
                    (() => {
                        if ('video' === a.type) {
                            ...
                            return (0, i.jsx)(m.Z, {
                                ...
                                poster: a.poster,
                                onPlay: e => {
                                    g.default.track(T.rMx.CHANGE_LOG_VIDEO_INTERACTED, { change_log_id: b }), w(Date.now()), W(!0), K(e.currentTarget.muted);
                                },
                                onEnded: e => {
                        ...
                        return 'embed' === a.type ? (0, i.jsx)(h.BC, {
                            ...
                            onPlay: () => {
                                g.default.track(T.rMx.CHANGE_LOG_VIDEO_INTERACTED, { change_log_id: b });
                            }
                    ...
                    (0, i.jsx)('div', {
                        className: r()(C.featureCardGroup, { [C.wideStyle]: U }),

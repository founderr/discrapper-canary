...
var l = t(735250), s = t(470079), u = t(120356), i = t.n(u);
if (12633 == t.j)
    var r = t(91192);
var I = t(442837), a = t(481060), _ = t(43267), o = t(933557), E = t(471445), N = t(727429), d = t(430824), T = t(158776), S = t(111583), c = t(594174), O = t(104175), f = t(499150), M = t(514342), m = t(998502), U = t(981631), P = t(490897), g = t(359123);
let D = {
...
function V(e) {
    let {channel: n} = e, t = (0, I.e7)([c.default], () => c.default.getUser(null == n ? void 0 : n.recipients[0])), s = (0, I.e7)([S.Z], () => !(null == t || null == n || n.isMultiUserDM()) && null != S.Z.getTypingUsers(null == n ? void 0 : n.id)[null == t ? void 0 : t.id]), {
            status: u,
            isMobile: i
...
let p = e => {
    ...
    let T = r ? null == _ ? void 0 : _.name : (0, E.bT)(t, _, s, u), S = r && null != _ ? ''.concat(_.name, ' - ').concat(T, ' icon') : ''.concat(T, ' icon');
...
function v(e) {
    ...
    return (0, l.jsx)(a.FocusRing, {
        ...
        children: (0, l.jsxs)('div', {
            ...
            onMouseLeave: x,
            children: [
                I || !d ? null : (0, l.jsx)('div', { className: i()(g.unread, w ? g.unreadImportant : void 0) }),

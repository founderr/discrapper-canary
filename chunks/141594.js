...
t.Z = () => {
    ...
    let E = (0, a.e7)([c.default], () => c.default.getCurrentUser()),
        ...
        [S, T] = (0, o.US)(v, void 0, !0),
        [N, A] = (0, o.XR)(C && (null == I ? void 0 : I.type) === l.Z.COACHTIP ? s.z.COLLECTIBLES_SHOP_ENTRY_MARKETING : null, null !== (e = null == I ? void 0 : I.version) && void 0 !== e ? e : 0, void 0, !0),
        b = null;
    if ((null != S || null != N) && null != I && I.type === l.Z.COACHTIP) {
        b = {
            type: h.k2.COACHTIP,
            title: () => I.title,
            body: () => I.body,

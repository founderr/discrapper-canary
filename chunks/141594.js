  ...
  let e = (0, s.useStateFromStores)([r.default], () => r.default.getCurrentUser()),
    ...
    n = a.useMemo(() => {
      if ((0, o.ageEligibleForPremiumUpsell)(e)) {
        if (t === d.ShopCoachtipEditions.RETRO_AND_PIRATES) return [i.DismissibleContent.COLLECTIBLES_SHOP_RETRO_AND_PIRATES_COACHTIP];
        if (t === d.ShopCoachtipEditions.GALAXY) return [i.DismissibleContent.COLLECTIBLES_SHOP_GALAXY_COACHTIP]
      }
      return []
    }, [e, t]),
    [f, E] = (0, l.useSelectedDismissibleContent)(n, void 0, !0),

...
function M(e) {
  ...
  }), R = (0, d.default)(t), L = (0, c.default)(t), y = (0, f.default)(t, "Toolbar Overflow"), j = (0, p.default)(t), O = (0, h.default)(t), P = (0, g.default)(t), D = _.UseThreadSidebar.useSetting(), b = (0, r.useStateFromStores)([T.default], () => !i().isEmpty(T.default.getVoiceStatesForChannel(t.id)));

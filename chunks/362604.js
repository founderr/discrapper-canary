    ...
    children: [(0, s.jsx)(_.default, {
      ...
      children: (0, s.jsx)("div", {
        ...
        children: (0, s.jsx)("div", {
          ...
          children: "" !== t.content ? t.content : N.default.Messages.DEADCHAT_PROMPT_1
        })
      })
    }), (0, s.jsxs)("div", {
      className: S.actions,
      children: [(0, s.jsx)(o.TooltipContainer, {
        text: N.default.Messages.CHANNEL_PROMPT_UPLOAD_IMAGE_CTA,
        children: (0, s.jsx)(o.Button, {
          ...
          onClick: () => {
            ...
            }), I.ComponentDispatch.dispatch(p.ComponentActions.UPLOAD_FILE), (0, u.createPendingReply)({
              message: t,
              channel: l,
              shouldMention: !0
            })
        ...
        text: N.default.Messages.CHANNEL_PROMPT_RANDOM_STICKER_CTA,
        children: (0, s.jsx)(o.Button, {
          color: o.Button.Colors.PRIMARY,
          onClick: () => {
            T.default.track(p.AnalyticEvents.CHANNEL_PROMPT_ACTION_CLICKED, {

  ...
  return (a.useEffect(() => {
    ...
    children: [(0, s.jsx)(_.default, {
      ...
      children: (0, s.jsx)("div", {
        className: i()(h.__invalid_content, {
          [h.compact]: S
        }),
        children: (0, s.jsx)("div", {
          className: i()(h.__invalid_messageContent, {
            [h.compact]: S
          }),
      ...
      children: [(0, s.jsx)(o.TooltipContainer, {
        ...
        children: (0, s.jsx)(o.Button, {
          ...
          onClick: () => {
            ...
            }), m.ComponentDispatch.dispatch(N.ComponentActions.UPLOAD_FILE), (0, u.createPendingReply)({
              message: t,
              channel: l,
              shouldMention: !0
            })

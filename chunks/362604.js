...
function C(e) {
  let {
    ...
    channel: l,
    compact: C
  } = e, S = (0, r.Wu)([u.Z], () => Array.from(u.Z.getAllGuildStickers().values()).flat()).slice(0, 20), [A, g] = i.useState(null);
  return (i.useEffect(() => {
    let e = setInterval(() => {
      S.length > 0 && g(S[Math.floor(Math.random() * S.length)])
    }, 500);
      ...
      children: [(0, s.jsx)(o.TooltipContainer, {
        ...
        children: (0, s.jsx)(o.Button, {
          ...
          onClick: () => {
            ...
            }), I.S.dispatch(m.CkL.UPLOAD_FILE), (0, c.fE)({
              message: t,
              channel: l,
              shouldMention: !0
            })

...
var i = n(735250), a = n(470079), s = n(120356), l = n.n(s), r = n(442837), o = n(481060), c = n(623292), d = n(926491), u = n(419922), _ = n(702346), E = n(626135), m = n(585483), I = n(115610), T = n(981631), h = n(689938), N = n(666603);
function f(e) {
    let {
            message: t,
            channel: s,
            compact: f
        } = e, p = (0, r.Wu)([d.Z], () => Array.from(d.Z.getAllGuildStickers().values()).flat()).slice(0, 20), [C, g] = a.useState(null);
    return (a.useEffect(() => {
        let e = setInterval(() => {
        ...
        children: [
            (0, i.jsx)(_.Z, {
                className: l()(N.mainContainer, { [N.compact]: f }),
                icon: n(570111),
                compact: f,
                children: (0, i.jsx)('div', {
                    className: l()(N.__invalid_content, { [N.compact]: f }),
                    children: (0, i.jsx)('div', {
                        className: l()(N.__invalid_messageContent, { [N.compact]: f }),

...
return e.prototype.withDebugValues = function(t, e) {
  this._debugKeyMap = t, this._localeFileMap = e;
}, e.prototype.get = function(t, e) {
  var r, n = null !== (r = this.getMessageValue(t, e)) && void 0 !== r ? r : this.getMessageValue(t, this.defaultLocale);
  if (null != n)
    return n;
      ...
      switch (i.label) {
        case 0:
          ...
          if (null != this.messages[t])
            return [2];
          return e = this.localeImportMap[t](), this._localeLoadingPromises[t] = e, r = this.messages, n = t, [
            4,
            e
          ];
        case 1:

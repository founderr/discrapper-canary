...
class _ {
    fromJulianDay(e) {
        let t = e - 1721426, n = Math.floor(t / 146097), r = o(t, 146097), i = Math.floor(r / 36524), a = o(r, 36524), u = Math.floor(a / 1461), d = Math.floor(o(a, 1461) / 365), [_, E] = c(400 * n + 100 * i + 4 * u + d + (4 !== i && 4 !== d ? 1 : 0)), f = e - s(_, E, 1, 1), h = 2;
        e < s(_, E, 3, 1) ? h = 0 : l(E) && (h = 1);
        let p = Math.floor(((f + h) * 12 + 373) / 367), m = e - s(_, E, p, 1) + 1;
...
function M(e, t) {
    let n = e.copy(), r = 'hour' in n ? function (e, t) {
            var n;
            let r;
    ...
    P(n, t.years || 0), n.calendar.balanceYearMonth && n.calendar.balanceYearMonth(n, e), n.month += t.months || 0, U(n), w(n), n.day += 7 * (t.weeks || 0), n.day += t.days || 0, n.day += r, function (e) {
        for (; e.day < 1;)
...
class ee extends _ {
    fromJulianDay(e) {
        let t = super.fromJulianDay(e), n = $(t);
    ...
    getYearsInEra(e) {
        let t = X.indexOf(e.era), n = z[t], r = z[t + 1];
        if (null == r)
            return 9999 - n[0] + 1;
        let i = r[0] - n[0];
...
class eo extends _ {
    fromJulianDay(e) {
        let t = super.fromJulianDay(e), [n, r] = ea(u(t.era, t.year));
...
function el(e, t, n) {
    let r = e > 0 ? e - 474 : e - 473, i = o(r, 2820) + 474;
    return 1948320 + 1029983 * Math.floor(r / 2820) + 365 * (i - 1) + Math.floor((31 * i - 5) / 128) + (t <= 7 ? 31 * (t - 1) : 30 * (t - 1) + 6) + n;
}
class eu {
    fromJulianDay(e) {
        let t = e - el(475, 1, 1), n = Math.floor(t / 1029983), r = o(t, 1029983), i = 474 + 2820 * n + (1029982 === r ? 2820 : Math.floor((128 * r + 46878) / 46751));
        i <= 0 && i--;
        let a = e - el(i, 1, 1) + 1, s = a <= 186 ? Math.ceil(a / 31) : Math.ceil((a - 6) / 31), l = e - el(i, s, 1) + 1;
...
class ec extends _ {
    fromJulianDay(e) {
        let t, n, r, i = super.fromJulianDay(e), a = i.year - 78, o = e - s(i.era, i.year, 1, 1);
...
function e_(e, t, n) {
    let r = Math.floor((30 * (n - t) + 10646) / 10631), i = Math.min(12, Math.ceil((n - (29 + ed(t, r, 1, 1))) / 29.5) + 1), a = n - ed(t, r, i, 1) + 1;
...
class eg extends ef {
    fromJulianDay(e) {
        let t = e - 1948440, n = ep(1300), r = ep(1600);
        if (t < n || t > r)
...
let eS = 25920, eA = 29 * eS + 13753;
function eN(e) {
    return 7 > o(7 * e + 1, 19);
}
function ev(e) {
    let t = Math.floor((235 * e - 234) / 19), n = 29 * t + Math.floor((12084 + 13753 * t) / 25920);
...
class ey {
    fromJulianDay(e) {
        let t = e - 347997, n = Math.floor((t * eS / eA * 19 + 234) / 235) + 1, r = eO(n), i = Math.floor(t - r);
        for (; i < 1;)
...
function eL(e, t) {
    let n = Math.floor(4 * (t - e) / 1461), r = 1 + Math.floor((t - eD(e, n, 1, 1)) / 30), i = t + 1 - eD(e, n, r, 1);
    return [
        n,
        r,
        i

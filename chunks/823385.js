...
function Y() {
  w = N.default.getGuildCount() >= 3 || a().size(S.default.getMutablePrivateChannels()) >= 20, F = []
}
...
function W(e) {
  ...
  let {
    query: n,
    queryMode: r
  } = e, s = (0, c.isSplitMessagesTabAndOnMessagesTab)() ? void 0 : null !== (t = R.default.getGuildId()) && void 0 !== t ? t : void 0, a = new Set(["user:".concat(f.default.getId())]);
...
let X = new Z(u.default, {
  ...
  QUICKSWITCHER_SEARCH: function(e) {
    ...
    if (null == i) return !1;
    let a = null !== (t = R.default.getGuildId()) && void 0 !== t ? t : null;
    if (k !== s) {

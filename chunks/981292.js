...
function u(e) {
    ...
    let [, d] = o.useState(s), _ = o.useRef(null), E = o.useMemo(() => {
            var e;
            let i = new Set(null === (e = _.current) || void 0 === e ? void 0 : e.keys()), a = new Map(_.current);
            for (let e of t) {
                let t = r(e), o = a.get(t);
                if (null == o) {
                    let r = null != _.current ? 1 : 0, i = () => {
                            var e, n;
                    ...
                    let {cleanUp: r} = o, i = 2 === o.state ? 1 : o.state, a = n(t, e, i, o.cleanUp);
                    o = {
                        item: e,
                        children: a,
                        state: i,
    ...
    for (let [, e] of E)
        f.push(e.children);
    return (0, a.jsx)(a.Fragment, { children: f.length > 0 ? i(f) : null });
}

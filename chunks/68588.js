...
var r, i, a, o = n(735250), s = n(470079), l = n(120356), u = n.n(l), c = n(692547), d = n(481060), _ = n(169525), E = n(823379), f = n(689938), h = n(339692);
function p(e, t, n) {
...
class A extends (i = s.PureComponent) {
    ...
    renderObscuredAttachment() {
        let {
            ...
            } = this.props, {visible: c} = this.state, E = (0, o.jsx)(S.Consumer, {
                children: E => {
                    let f = E || c || !i;
                    return [
    ...
    renderObscuredEmbed() {
        let {
                ...
                obscurityControlClassName: i,
                reason: a = _.wk.SPOILER
            } = this.props, {visible: s} = this.state;
    ...
    renderObscuredText() {
        let {
                ...
                renderTextElement: t,
                className: n
            } = this.props, {visible: r} = this.state, i = (0, o.jsx)(S.Consumer, {
                children: i => {
                    let a = i || r, l = s.Children.toArray(e(a)), c = s.Children.map(l, e => s.isValidElement(e) && null != t ? t(e, a) : e);
    ...
    constructor(...e) {
        super(...e), p(this, 'state', { visible: !1 }), p(this, 'removeObscurity', e => {

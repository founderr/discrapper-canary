...
class R extends(r = o.PureComponent) {
  ...
  renderObscuredAttachment() {
    let {
      ...
      visible: d
    } = this.state, _ = (0, a.jsx)(C.Consumer, {
      children: _ => {
        let I = _ || d || !r;
  ...
  renderObscuredText() {
    let {
      ...
      visible: i
    } = this.state, r = (0, a.jsx)(C.Consumer, {
      children: r => {
        let s = r || i,
...
A(R, "Types", i), A(R, "Reasons", E.ObscureReason), t.default = R
...
function L(e) {
  ...
  }).catch(e => h.default.captureException(e)) : s.HTTP.put({
    url: R.Endpoints.GUILD_ONBOARDING_RESPONSES(e),
    body: {
      onboarding_responses: r.map(e => e.id),
      onboarding_prompts_seen: o,
...
t.default = {
  ...
  completeOnboarding(e, t) {
    let n = t.length > 0 ? t[t.length - 1] : null,
      ...
      h = [...s, ...a],
      D = h.map(e => E.default.getChannel(e)).filter(A.isNotNullish),
      v = (0, p.getFlattenedChannels)(e, new Set(h), D, !0).length,
    ...
    if (f.default.track(R.AnalyticEvents.GUILD_ONBOARDING_STEP_COMPLETED, {
      ...
      (0, d.updateImpersonatedChannels)(e, h, []), (0, d.updateImpersonatedData)(e, {
        optInEnabled: !0

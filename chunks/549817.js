...
var r = n(392711), i = n.n(r), a = n(544891), o = n(570140), s = n(45114), l = n(367907), u = n(781792), c = n(962086), d = n(160404), _ = n(152376), E = n(592125), f = n(271383), h = n(594174), p = n(626135), m = n(630388), I = n(823379), T = n(960048), g = n(709054), S = n(45966), A = n(637853), N = n(816436), v = n(981631), O = n(372897), R = n(490897);
function C(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
    if (d.Z.isFullServerPreview(e))
        return;
    let n = t ? S.Z.getOnboardingPromptsForOnboarding(e) : S.Z.getOnboardingPrompts(e), r = S.Z.getOnboardingResponses(e), i = n.map(e => e.options.filter(e => r.includes(e.id))).flat(), s = {}, l = {};
    return (n.forEach(e => {
...
t.Z = {
    ...
    completeOnboarding(e, t) {
        let n = t.length > 0 ? t[t.length - 1] : null, r = S.Z.getSelectedOptions(e), i = (0, A.L6)(r), a = (0, A.dX)(r), o = S.Z.getEnabled(e) ? S.Z.getDefaultChannelIds(e) : [], [u, _] = (0, A.Ee)(e, t, o), T = [
                ...a,
                ...o
            ], y = T.map(e => E.Z.getChannel(e)).filter(I.lm), D = (0, N.v)(e, new Set(T), y, !0).length, L = null == n ? [] : n.options.map(e => e.id);
        if (p.default.track(v.rMx.GUILD_ONBOARDING_STEP_COMPLETED, {
            ...
            (0, c.zS)(e, T, []), (0, c.aq)(e, { optInEnabled: !0 }), (0, c.og)(e, Array.from(i));

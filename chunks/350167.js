...
var r = n(259443), i = n(198584), a = n(444675);
function o(e, t, n) {
...
let s = '1' === a.env.KV_STORAGE_LOGGING, l = new r.Y('Runtime');
class u {
    static nextId() {
        return ++this.counter;
    }
    ...
    static onResponse(e, t) {
        let n = performance.now(), r = this.pending.get(e.id);

...
function T(e) {
    return 'manager' in e ? [{ dragDropManager: e.manager }, !1] : [g(e.backend, e.context, e.options, e.debugMode), !e.context];
}
function g(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : S(),
        ...
        i = t;
    return !i[m] && (i[m] = { dragDropManager: (0, a.i)(e, t, n, r) }), i[m];
}
function S() {

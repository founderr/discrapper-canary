...
function R(e) {
  ...
  ! function(e, t) {
    let n = i.useRef(new Set),
      l = i.useRef(new o.V7),
      {
        shouldSubscribeToGuildMemberUpdates: a
      } = T.ZP.useExperiment({
  ...
  let a = (0, L.Z)(e),
    ...
    R = (0, u.NX)(null === (t = A[0]) || void 0 === t ? void 0 : t.channelId, !1, "GuildMediaState"),
    {
      ...
      let i = x.Z.getVoiceChannelId(),
        l = null === (t = E.Z.getGuild(e)) || void 0 === t ? void 0 : t.afkChannelId,
        r = Z.Z.getUsersWithVideo(e),
        a = Z.Z.getVoiceStates(e),
        s = (() => {
          if (n) return !1;
          for (let e in a)
            if (M(C.Z.getBasicChannel(a[e].channelId), null != l ? l : void 0, N.Z)) return !0;
          return !1
        })();
      return {
        guildHasVoice: s,
    ...
    j = g.default.getId();
  return (0, s.cj)([x.Z, m.Z, _.Z, C.Z, N.Z, d.ZP], () => {
    var t, i, r;
    ...
    let S = v.default.keys(_.Z.getStageInstancesByGuild(e)).some(e => {
      ...
      Z = o && null !== (r = null === (i = C.Z.getChannel(s)) || void 0 === i ? void 0 : i.isGuildStageVoice()) && void 0 !== r && r,

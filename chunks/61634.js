...
function M(e) {
  ...
  let i = (0, x.default)(e),
    ...
    M = (0, d.useIsActivitiesInTextEnabled)(null === (t = R[0]) || void 0 === t ? void 0 : t.channelId, "GuildMediaState"),
    {
      guildHasVoice: D,
      guildHasVideo: b,
    ...
    G = g.default.getId();
  return (0, r.useStateFromStoresObject)([N.default, m.default, C.default, E.default, I.default, c.default], () => {
    var t, l, s;
    ...
    let T = L.default.keys(C.default.getStageInstancesByGuild(e)).some(e => {
    ...
    return o ? (u = !0, d = (null == a ? void 0 : a.channel_id) === r, f = A, g = O, S = v, _ = U) : (u = D, d = null != a, f = T, g = b, S = x, _ = y), {
      audio: u,
      video: g,
      screenshare: S,
      liveStage: f,

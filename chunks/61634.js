...
function y(e) {
    ...
    let a = (0, M.Z)(e),
        ...
        y = (0, s.e7)([d.ZP, Z.Z], () => {
            ...
            return R ? t.filter((e) => !(0, h.Wu)([...e.userIds], Z.Z.getBlockedIDs())) : t;
        }),
        j = (0, u.NX)(null === (t = y[0]) || void 0 === t ? void 0 : t.channelId),
        {
            ...
            () => {
                ...
                let i = v.Z.getVoiceChannelId(),
                    ...
                    s = (() => {
                        if (n) return !1;
                        for (let e in a) if (P(E.Z.getBasicChannel(a[e].channelId), null != l ? l : void 0, S.Z)) return !0;
                        return !1;
                    })();
                return {
                    guildHasVoice: s,
                    guildHasVideo: (() => {
                        if (n) return !1;
                        for (let e of r) if (P(E.Z.getBasicChannel(a[e].channelId), null != l ? l : void 0, S.Z)) return !0;
                        return !1;
                    })(),
    ...
    return (0, s.cj)(
        ...
        () => {
            ...
            let x = A.default.keys(g.Z.getStageInstancesByGuild(e)).some((e) => {
                ...
                Z = o && null !== (r = null === (i = E.Z.getChannel(s)) || void 0 === i ? void 0 : i.isGuildStageVoice()) && void 0 !== r && r,
            ...
            return (
                o ? ((c = !0), (u = (null == l ? void 0 : l.channel_id) === s), (p = Z), (_ = b), (I = T), (N = O)) : ((c = D), (u = null != l), (p = x), (_ = w), (I = L), (N = M)),
                {
                    audio: c,
                    video: _,
                    screenshare: I,

...
function R(e) {
    ...
    let a = (0, L.Z)(e), A = (0, s.e7)([d.ZP], () => d.ZP.getEmbeddedActivitiesForGuild(e)), R = (0, u.NX)(null === (t = A[0]) || void 0 === t ? void 0 : t.channelId, !1), {
            ...
            var t;
            let i = x.Z.getVoiceChannelId(), l = null === (t = E.Z.getGuild(e)) || void 0 === t ? void 0 : t.afkChannelId, r = v.Z.getUsersWithVideo(e), a = v.Z.getVoiceStates(e), s = (() => {
                    if (n)
                        return !1;
                    for (let e in a)
    ...
    return (0, s.cj)([
        ...
        let S = Z.default.keys(_.Z.getStageInstancesByGuild(e)).some(e => {
                let t = C.Z.getChannel(e);
                return null != t && N.Z.can(p.gl, t);
            }), v = o && null !== (r = null === (i = C.Z.getChannel(s)) || void 0 === i ? void 0 : i.isGuildStageVoice()) && void 0 !== r && r, T = !!o && null != m.Z.getActiveStreamForUser(j, e), L = m.Z.getAllApplicationStreams().some(t => t.guildId === e), b = o && P, M = (() => {
                if (R)
                    return A.length > 0;
                for (let e of A) {
        ...
        return o ? (c = !0, u = (null == l ? void 0 : l.channel_id) === s, h = v, g = b, I = T, E = D) : (c = O, u = null != l, h = S, g = y, I = L, E = M), {
            audio: c,
            video: g,
            screenshare: I,
            liveStage: h,

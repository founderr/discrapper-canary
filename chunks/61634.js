...
function M(e) {
  ...
  let i = (0, x.default)(e),
    ...
    G = g.default.getId();
  return (0, r.useStateFromStoresObject)([N.default, m.default, p.default, E.default, I.default, c.default], () => {
    var t, l, s;
    ...
    return o ? (u = !0, d = (null == a ? void 0 : a.channel_id) === r, f = A, g = y, S = v, _ = U) : (u = D, d = null != a, f = T, g = b, S = x, _ = O), {
      audio: u,
      video: g,
      screenshare: S,
      liveStage: f,

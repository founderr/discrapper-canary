        ...
        w = (0, u.NX)(null === (t = L[0]) || void 0 === t ? void 0 : t.channelId),
        {
            ...
            () => {
                ...
                let i = S.Z.getVoiceChannelId(),
                    ...
                    o = (() => {
                        if (n) return !1;
                        for (let e in a) if (M(v.Z.getBasicChannel(a[e].channelId), null != l ? l : void 0, N.Z)) return !0;
                        return !1;
                    })();
                return {
                    guildHasVoice: o,
                    guildHasVideo: (() => {
                        if (n) return !1;
                        for (let e of r) if (M(v.Z.getBasicChannel(a[e].channelId), null != l ? l : void 0, N.Z)) return !0;
                        return !1;
                    })(),
    ...
    return (0, o.cj)(
        ...
        () => {
            ...
            let b = T.default.keys(g.Z.getStageInstancesByGuild(e)).some((e) => {
                ...
                E = s && null !== (r = null === (i = v.Z.getChannel(o)) || void 0 === i ? void 0 : i.isGuildStageVoice()) && void 0 !== r && r,
            ...
            return (
                s ? ((c = !0), (u = (null == l ? void 0 : l.channel_id) === o), (p = E), (f = j), (x = Z), (I = R)) : ((c = D), (u = null != l), (p = b), (f = O), (x = y), (I = A)),
                {
                    audio: c,
                    video: f,
                    screenshare: x,

...
var r, i, a = n(658722), o = n.n(a), s = n(392711), l = n.n(s), u = n(913527), c = n.n(u), d = n(346610), _ = n(984933), E = n(699516), f = n(768119), h = n(944486), p = n(914010), m = n(246946), I = n(594174), T = n(483360), g = n(226951), S = n(51144), A = n(981631), N = n(689938);
function v() {
...
let b = RegExp('(?:\\s*('.concat('([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})', '|').concat('([0-9]{4})-([0-9]{1,2})', '|').concat('\\d{4}', '|').concat('([^\\d\\s]+)', '))'), 'i'), M = RegExp('\\s*(true|false)', 'i');
function P(e) {
    return ''.concat(e, ':');
}
function U(e) {
...
function w(e) {
    let t;
    let n = e.getMatch(1), r = e => null != e ? null == e ? void 0 : e.id : null;
...
function x(e, t) {
    let n, r;
    let i = e.getFullMatch().trim().toLowerCase(), a = L()[i];
...
function G(e) {
    let t = e.getMatch(1), n = p.Z.getGuildId(), r = _.ZP.getChannels(n)[_.sH].concat(_.ZP.getChannels(n)[_.Zb]), i = _.ZP.getTextChannelNameDisambiguations(n), a = l().chain(r).map(e => {
            let {channel: t} = e;
            return t;
        }).find(e => {
            var n, r;
...
function H(e, t, n) {
    ...
    return l()(n).filter(e => o()(r, e.toLocaleLowerCase())).take(t).map(e => ({ text: e })).value();
}
function Z(e, t) {
    let n, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10, i = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], a = f.Z.getSearchType(t), o = {
            query: e = e.split('#')[0],
            limit: r,
            request: i
        };
...
function z() {
    Object.assign(K, function () {
        let {canForwardMessages: e} = d.w.getCurrentConfig({ location: 'SearchTokens' }, { autoTrackExposure: !1 }), t = e ? [N.Z.Messages.SEARCH_ANSWER_HAS_SNAPSHOT] : [], n = [
        ...
        return {
            ...
            [A.dCx.FILTER_IN]: {
                ...
                getAutocompletions(e, t, n) {
                    ...
                    if ('' === e.trim()) {
                        let e = h.Z.getChannelId(t), n = r.find(t => t.id === e);

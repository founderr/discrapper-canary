...
function T(e) {
  ...
  let T, h, {
    ...
    k = null != A && A.benefits.length > 0 ? C.Z.Messages.APPLICATION_SUBSCRIPTION_PURCHASE_MODAL_CONFIRMATION_LITE_BENEFITS_SUBTITLE.format({
      benefitCount: A.benefits.length
    }) : null;
  return b ? v ? T = (0, i.jsx)(d.h, {
    title: C.Z.Messages.APPLICATION_SUBSCRIPTION_PURCHASE_MODAL_CONFIRMATION_LITE_TITLE_V2.format({
      tierName: M
    }),
    subtitle: null != A && A.benefits.length > 0 ? C.Z.Messages.APPLICATION_SUBSCRIPTION_PURCHASE_MODAL_CONFIRMATION_LITE_SUBTITLE.format({
      benefits: k
    }) : null,
    onConfirm: L,
    ...
    application: x,
    title: C.Z.Messages.APPLICATION_SUBSCRIPTION_PURCHASE_MODAL_CONFIRMATION_TITLE_V2.format({
      tier: M
    }),
    subtitle: C.Z.Messages.APPLICATION_SUBSCRIPTION_PURCHASE_MODAL_CONFIRMATION_BENEFITS_PREVIEW,
    description: y ? C.Z.Messages.APPLICATION_USER_SUBSCRIPTION_PURCHASE_MODAL_CONFIRMATION_SUBTITLE.format({
      applicationName: null == x ? void 0 : x.name
    }) : C.Z.Messages.APPLICATION_GUILD_SUBSCRIPTION_PURCHASE_MODAL_CONFIRMATION_SUBTITLE.format({
      tier: M
    })
  ...
  }, [R, B]), (0, i.jsxs)(i.Fragment, {
    children: [(0, i.jsxs)(I.C3, {
      children: [(0, i.jsx)(m.Z, {}), T]
    }), null != h && (0, i.jsx)(I.O3, {
      children: h
    })]
  })

...
function m(e) {
  ...
  } = e, p = (0, l.useStateFromStores)([u.default], () => u.default.getId()), N = (null === (t = n.inviter) || void 0 === t ? void 0 : t.id) === p, S = n.state === _.InviteStates.ACCEPTING, C = (0, l.useStateFromStores)([c.default], () => {
    var e;
  ...
  C ? (M = T.default.Messages.INVITE_BUTTON_ALREADY_FRIENDS, O = E.default.Button.Colors.PRIMARY) : N && (M = T.default.Messages.INVITE_BUTTON_ADD_FRIEND, O = E.default.Button.Colors.PRIMARY);
  let R = N ? T.default.Messages.INVITE_BUTTON_TITLE_INVITER_FRIEND : T.default.Messages.INVITE_BUTTON_TITLE_INVITED_FRIEND,

...
var i = n("37983"),
  ...
  g = l.memo(l.forwardRef(function(e, t) {
    ...
    }), [_, I, T] = (0, c.useExpressionPickerStore)(e => [e.activeView, e.activeViewType, e.pickerId], r.default), v = l.useRef(0), N = l.useCallback(() => {
    ...
    if (n) return null;
    let k = _ === x.ExpressionPickerViewType.GIF && I === a;

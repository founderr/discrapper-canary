...
var _ = function(e, t) {
  let n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2],
    ...
    c = d(),
    _ = (e, t) => {
      let i = f(e, r, n ? c : void 0);
      return null == i ? null : "string" == typeof i ? i : i.format({
        count: t
      })
    };
  if (i < 60) {
    let e = (null == r ? void 0 : r.seconds) != null ? _("seconds", i) : _("minutes", 1);
    if (null != e) return e
  }
  if (i < a) {
    let e = _("minutes", Math.floor(i / 60));
    if (null != e) return e
  }
  if (i < o) {
    let e = _("hours", Math.floor(i / a));
    if (null != e) return e
  }
  if (i < l) {
    let e = _("days", Math.floor(i / o));
    if (null != e) return e
  }
  if (i < u) {
    let e = _("months", Math.floor(i / l));
    if (null != e) return e
  }
  if (i >= u && (null == r ? void 0 : r.years) != null) {
    let e = _("years", Math.floor(i / u));
    if (null != e) return e
  }

...
function h(e) {
  ...
  s.useLayoutEffect(() => {
    ...
    let e = _.current;
    if (null != e) return e.addEventListener("focusin", n), e.addEventListener("focusout", a), e.addEventListener("focus", s), e.addEventListener("scroll", r, {
      passive: !0
    }), () => {
    ...
    function a(e) {
      if (!e.currentTarget.contains(e.relatedTarget)) I(!1), requestAnimationFrame(() => {
        let e = c.current;
...
function C(e) {
  let {
    ...
    id: _,
    setFocus: x
  } = s.useContext(g), C = s.useCallback(() => x(t), [t, x]);

...
function O(e) {
  ...
  }, []), k = l.useRef(null), H = (0, r.useStateFromStores)([I.default], () => I.default.getFocusedLayout()), G = H !== M.FocusedActivityLayouts.NO_CHAT, [B, W] = l.useState(null !== (s = c.default.activityPanelHeight) && void 0 !== s ? s : O), Y = l.useCallback(e => {

...
function F(e) {
  ...
  return (0, i.jsxs)(d.Clickable, {
    ...
    onClick: t,
    children: [(0, i.jsx)(d.InventoryIcon, {
      size: "md",
      color: "currentColor",
...
class w extends a.PureComponent {
  ...
  constructor(...e) {
    super(...e), G(this, "renderMedia", () => (0, i.jsx)("div", {
      className: l()(k.invalidPoop, {
        [k.invalidPoopHorizontal]: this.isHorizontal
      })
    })), G(this, "renderTitle", () => this.props.isSelfGift ? B.Z.Messages.GIFT_EMBED_INVALID_TITLE_SELF : B.Z.Messages.GIFT_EMBED_INVALID_TITLE_OTHER), G(this, "renderActions", () => this.props.isSelfGift ? (0, i.jsx)(d.Button, {
...
class V extends a.Component {
  ...
  renderBody(e) {
    ...
    let r = i.isPreorder() ? B.Z.Messages.PREORDER_SKU_NAME.format({
      name: i.name
    }) : i.name;
    if (e.redeemed) return e.isSubscription || (0, T.mO)(e) ? B.Z.Messages.GIFT_EMBED_BODY_CLAIMED_SELF_SUBSCRIPTION : B.Z.Messages.GIFT_EMBED_BODY_CLAIMED_SELF.format({
      skuName: r,
    ...
    if (!l.verified) return B.Z.Messages.GIFT_EMBED_BODY_REQUIRES_VERIFICATION.format({
    ...
    if (e.hasMultipleCopies) return null != a ? e.isSubscription ? B.Z.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_GIVEAWAY.format({
    ...
    if (e.isSubscription) return null == s ? B.Z.Messages.LOADING : null != a ? (s.interval === y.rV.MONTH ? B.Z.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_DEFAULT_MONTHS : B.Z.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_DEFAULT_YEARS).format({
      username: D.ZP.getUserTag(a),
      skuName: r,
  ...
  render() {
    ...
    if (null != e && null != e.promotion) return (0, i.jsx)(j.$, {
      skuId: e.skuId,
    ...
    if (null == e || e.revoked) return t ? (0, i.jsx)(w, {
      isSelfGift: a,
      width: n
    }) : (0, i.jsx)(_.OR, {
      isHorizontal: n >= _.aL
  ...
  constructor(...e) {
    super(...e), G(this, "handleViewLibrary", e => {
      ...
      return (0, i.jsxs)("div", {
        className: s,
        children: [!t && y.eZ.includes(e.giftStyle) && (0, i.jsx)(v.Z, {
          className: k.snow,
          wind: 5
        }), a && (0, i.jsx)(M.Z, {

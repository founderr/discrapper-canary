...
var i = n("714617"),
  ...
  _ = n("102985"),
  h = n("49111");
let g = 1 * c.default.Millis.MINUTE,
  m = e => "https://youtube.com/watch?v=".concat(e),
  E = 5 * c.default.Millis.MINUTE,
  p = /live_user_(.*)-\{width\}/,
  v = null,
  S = 0,
  T = null,
...
let N = new class e {
  ...
  stop() {
    this._started = !1, T = null, S = 0, null != this._nextCheck && clearTimeout(this._nextCheck), o.default.dispatch({
  ...
  async _checkTwitch(e) {
    ...
    try {
      ...
      }, m = await y(f, t), E = u.default.get(h.PlatformTypes.TWITCH);
      let v = null !== (r = c, s = null === (a = p.exec(r)) || void 0 === a ? void 0 : a[1]) && void 0 !== s ? s : e.name;
      return {
  ...
  _check() {
    ...
    let t = [h.PlatformTypes.TWITCH],
      n = Date.now();
    S <= n && (t.push(h.PlatformTypes.YOUTUBE), S = n + E);
...
var O = new D(o.default, {
  STREAMING_UPDATE: function(e) {
    ...
    v = null !== (t = e.stream) && void 0 !== t ? t : null
  },

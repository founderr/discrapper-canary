...
let y = e => {
        ...
        }, [n.pack_id]), u || null == c) ? (0, i.jsx)(m.SE, { className: Z.popoutLoader }) : (0, i.jsxs)(m.W_, {
        ...
        let Y = n.guild_id === s.getGuildId(), W = null != S, z = !1, K = 'Custom Sticker Popout';
        ...
        return (a.useEffect(() => {
            ...
            children: [
                ...
                (null != y || null != S) && (() => {
                    ...
                    if (!W && !B)
                        return;
                    let t = (null !== (e = null == S ? void 0 : S.stickers) && void 0 !== e ? e : []).slice(0, 13).filter(e => e.id !== n.id).slice(0, 12), a = null != S ? u.Z.createFromDiscoverableGuild(S) : u.Z.createFromGuildRecord(y);
                    return (0, i.jsxs)('div', {
        ...
        }) : (0, i.jsx)(m.SE, { className: Z.popoutLoader });
    };
function k(e) {
    let {
        channel: t,

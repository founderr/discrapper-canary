...
class d extends r.Z {
  static createFromServer(e) {
    ...
    return new d({
      ...
      bot: null != e.bot ? new a.Z(e.bot) : null,
  ...
  getIconURL(e, t) {
    return null != this.icon ? s.ZP.getGameAssetURL({
      id: this.id,
      hash: this.icon,
      size: e,
      format: t
  ...
  getIconSource(e, t) {
    return null != this.icon ? s.ZP.getGameAssetSource({
      id: this.id,
      hash: this.icon,
      size: e,
      format: t
  ...
  getSplashURL(e, t) {
    return null != this.splash ? s.ZP.getGameAssetURL({
      id: this.id,
      hash: this.splash,
      size: e,
      keepAspectRatio: !0,
  ...
  getCoverImageURL(e) {
    return null != this.coverImage ? s.ZP.getApplicationIconURL({
      id: this.id,
  ...
  get supportsOutOfProcessOverlay() {
    return d.supportsOutOfProcessOverlay(this.overlayMethods)
  }

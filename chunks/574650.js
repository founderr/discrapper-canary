...
t.Z = () => {
    ...
    switch (A) {
        case E.wB.SUBMITTED:
            (R = N.Z.Messages.MEMBER_VERIFICATION_APPLICATION_CONFIRMATION_TITLE),
            ...
            break;
        case E.wB.REJECTED:
            (R = N.Z.Messages.MEMBER_VERIFICATION_REJECTED_TITLE),
            ...
            break;
        default:
            (R = N.Z.Messages.MEMBER_VERIFICATION_NOTICE_TEXT),

...
t.default = () => {
  ...
  switch (M) {
    case _.GuildJoinRequestApplicationStatuses.SUBMITTED:
      v = p.default.Messages.MEMBER_VERIFICATION_APPLICATION_CONFIRMATION_TITLE, R = p.default.Messages.MEMBER_VERIFICATION_CANCEL_APPLICATION, O = () => {
    ...
    case _.GuildJoinRequestApplicationStatuses.REJECTED:
      v = p.default.Messages.MEMBER_VERIFICATION_REJECTED_TITLE, R = p.default.Messages.MEMBER_VERIFICATION_LEARN_MORE, O = () => {
      ...
      break;
    default:
      v = p.default.Messages.MEMBER_VERIFICATION_NOTICE_TEXT, R = p.default.Messages.MEMBER_VERIFICATION_NOTICE_CTA, O = () => {

...
x = [
  ...
  switch (A) {
case E.wB.SUBMITTED:
  M = h.Z.Messages.MEMBER_VERIFICATION_APPLICATION_CONFIRMATION_TITLE, R = h.Z.Messages.MEMBER_VERIFICATION_CANCEL_APPLICATION, O = () => {
  ...
  break;
case E.wB.REJECTED:
  M = h.Z.Messages.MEMBER_VERIFICATION_REJECTED_TITLE, R = h.Z.Messages.MEMBER_VERIFICATION_LEARN_MORE, O = () => {
  ...
  break;
default:
  M = h.Z.Messages.MEMBER_VERIFICATION_NOTICE_TEXT, R = h.Z.Messages.MEMBER_VERIFICATION_NOTICE_CTA, O = () => {
    (0, _.hk)(C.id);
  };
  }
  return (0, i.jsxs)('div', {

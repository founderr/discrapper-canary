...
function ea(e) {
  ...
  if (null == s || s.type !== O.tI.VIEW_MESSAGE_REQUEST || null == a || !a.isPrivate()) return null;
  let r = t - J.R7I;
  return (0, i.jsx)(T.Z, {
  ...
  el = e => {
    ...
    return s.useEffect(() => {
      ...
      children: s => {
        ...
        if (r === d.z.MESSAGE_REQUEST_SETTINGS_COACH_MARK) return (0, i.jsx)(u.Popout, {
  ...
  return (0, S.Tt)({
    ...
    children: [(0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)(A.Z, {
        ...
        }), (0, i.jsx)(A.Z.Divider, {}), (0, i.jsxs)(u.TabBar, {

        ...
        if (l && (0, f.Z)(t.name))
            return (function (e, t, n) {
                ...
                if (null != s && null != o) o.cancel(), S.play(), delete b[s], (0, c.Ym)(s.split(':')[0], t, n, e);
                    ...
                    (0, c._g)(e, t, n), I.play();
                    let r = new a.sW(p, () => {
                        delete b[t], (0, c.Gd)(t, n);
                    });
                    (b[t] = r), r.delay();
                }
            })(t.name, r, n);
        r === s && ((v = [...v, t.name].slice(-1 * m)), i().isEqual(v, h) ? (I.play(), E.stop(), (v = []), (0, c.ME)(!l)) : E.start(_, () => (v = [])));
    }
}
function y(e) {
    ...
    (b[i] = new a.sW(550, () => {
        delete b[i], (0, c.hu)(t, n, r);
    })),
        b[i].delay();
}
class A extends s.Z {
    _terminate() {
        Object.values(b).forEach((e) => e.cancel()), (b = {});
    }
    constructor(...e) {
        var t, n, r;
        super(...e),

    ...
    if (null != t) {
        if (l && (0, _.Z)(t.name))
            return (function (e, t, n) {
                ...
                let [s, o] =
                    null !==
                        (r = Object.entries(g).find((e) => {
                            let [t] = e;
                            return t !== i;
                        })) && void 0 !== r
                        ? r
                        : [];
                if (null != s && null != o) o.cancel(), A.play(), delete g[s], (0, c.Ym)(s.split(':')[0], t, n, e);
                else {
                    (0, c._g)(e, t, n), S.play();
                    let r = new a.sW(f, () => {
        ...
        r === s && ((T = [...T, t.name].slice(-1 * p)), i().isEqual(T, h) ? (S.play(), I.stop(), (T = []), (0, c.ME)(!l)) : I.start(E, () => (T = [])));
    }
}
function v(e) {
    let { completingUserId: t, waitingUserId: n, channelId: r } = e,
        i = m(''.concat(t).concat(n), r, !0);
    (g[i] = new a.sW(550, () => {

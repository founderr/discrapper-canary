  ...
  return e.onChange = () => {
    if (null != t) {
      let o = l.Z.getState(t.id),
        _ = a.Hf(t);
      if (N.bN.richValue(e) !== w || !N.Ew.equals(e.selection, B) || o.activeCommand !== x || null == V || _.some((e, t) => V[t] !== e)) {
        let l = f.T.withMergedEntry(e, () => {
          ...
          return function(e) {
            ...
            if (!c && (null == p ? void 0 : null === (t = p.integration_types) || void 0 === t ? void 0 : t.includes(i.Y.GUILD_INSTALL)) || E && (null == p ? void 0 : p.inputType) !== u.iw.BUILT_IN_TEXT && (null == p ? void 0 : p.inputType) !== u.iw.BUILT_IN_INTEGRATION) return null != f && L(o, _.id, p, !0), null;
            if (null != f) {
              if (N.bN.isEditorEmpty(o) || null == p) return L(o, _.id, p, !1), null;
              let e = "".concat(R.GI).concat(f.displayName);
              ...
              if (null != p && I) {
                let e = function(e, t, n) {
                    ...
                    let c = (null !== (s = null === (i = _.options) || void 0 === i ? void 0 : i.length) && void 0 !== s ? s : 0) > 0 ? h.zb(e, _) : null,
                      ...
                      f = "".concat(R.GI).concat(_.name).toLocaleLowerCase();
                    ...
                    let L = null;
                    return null != p ? (A.Q.selectCommandOption(e, p.optionName), L = p.optionName) : null != C ? (A.Q.selectCommandOption(e, C.optionName, !1), L = C.optionName) : A.Q.resetSelectionToEnd(e), null == C && D(e, _), L
                  }(o, _, l),
                  t = h.tM(o, p, _.id);
                return M({
                  guildId: _.guild_id,
            ...
            commandChanged: (null === (l = o.activeCommand) || void 0 === l ? void 0 : l.id) !== (null == x ? void 0 : x.id),
        ...
        w = N.bN.richValue(e), B = e.selection, x = o.activeCommand, V = _
      }
    }
    O()
  }, e
...
function D(e, t) {
  ...
  return !(!n.text.startsWith("".concat(R.GI).concat(t.displayName, " ").toLocaleLowerCase()) || N.Jz.equals(r, s)) && (A.Q.textToInline(e, {
    type: "applicationCommandOption",
    optionName: i.name,
    optionDisplayName: i.displayName,
    optionType: i.type,

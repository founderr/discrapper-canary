...
t.prototype.toArray = function () {
    ...
    var t = arguments.length, n = this._length;
    if (t > 1) {
    ...
    var e = this._length;
    if (0 !== e) {
        var t = this._front + e - 1 & this._capacity - 1, n = this[t];
        return this[t] = void 0, this._length = e - 1, n;
    }
}, t.prototype.shift = function () {
    var e = this._length;
    if (0 !== e) {
        var t = this._front, n = this[t];
        return this[t] = void 0, this._front = t + 1 & this._capacity - 1, this._length = e - 1, n;
    }
}, t.prototype.unshift = function (e) {
    var t = this._length, n = arguments.length;
    if (n > 1) {
        var r = this._capacity;
        if (t + n > r) {
            for (var i = n - 1; i >= 0; i--) {
                this._checkCapacity(t + 1);
                var r = this._capacity, a = (this._front - 1 & r - 1 ^ r) - r;
    ...
    if (0 === n)
        return t;
    this._checkCapacity(t + 1);
    var r = this._capacity, i = (this._front - 1 & r - 1 ^ r) - r;
    ...
    for (var e = this._capacity, t = 0; t < e; ++t)
        this[t] = void 0;
    ...
    var t = this._front, n = this._capacity, i = Array(n), a = this._length;

n(47120);
var r, i, a, o, s = n(392711), l = n.n(s), u = n(149765), c = n(442837), d = n(570140), _ = n(160404), E = n(41776), f = n(427679), h = n(569471), p = n(195663), m = n(131704), I = n(601964), T = n(598077), g = n(386438), S = n(700785), A = n(592125), N = n(683301), v = n(271383), O = n(430824), R = n(594174), C = n(981631), y = n(478743);
let D = {}, L = {}, b = {}, M = 0;
function P(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = D[e];
    if (null != n)
        return n;
...
function U(e) {
    var t;
    let n = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], r = R.default.getCurrentUser();
    if (null == r)
        return S.Hn;
    let i = A.Z.getChannel(e);
    if (null == i)
        return S.Hn;
    let a = i.getGuildId(), o = null != a && (E.Z.isLurking(a) || (null === (t = v.ZP.getMember(a, r.id)) || void 0 === t ? void 0 : t.isPending));
...
function w(e) {
    let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = L[e];
...
function Y(e) {
    let {instance: t} = e, n = A.Z.getChannel(t.channel_id);
    if (null == n)
        return !1;
    let r = R.default.getCurrentUser(), i = S.uB({
            user: r,
            context: n
        });
    if (i === L[n.id])
...
class K extends (r = c.ZP.Store) {
    ...
    canManageUser(e, t, n) {
        ...
        if (!this.can(e, n))
            return !1;
        let a = null != i ? S.e9(n, i.id) : void 0, o = S.e9(n, r);
    ...
    isRoleHigher(e, t, n) {
        let r = R.default.getCurrentUser(), i = _.Z.isViewingRoles(e.id);
        return S.r6(e, i ? void 0 : null == r ? void 0 : r.id, t, n);
    }
    canImpersonateRole(e, t) {
        let n = this.getHighestRole(e), r = this.can(C.Plq.MANAGE_GUILD, e) && this.can(C.Plq.MANAGE_ROLES, e), i = this.isRoleHigher(e, n, t);

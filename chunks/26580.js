...
let _ = ["egirl", "egirls", "waifu", "dating", "nsfw", "sex", "playboy", "stupid", "harem", "playgirl", "shitcoin", "shitpost", "porno", "nudes", "sexy", "horny", "fart", "tits", "balls", "cum"],
  ...
  p = e => {
    let {
      ...
      ref: p,
      width: g
    } = (0, o.Z)(), [T, C] = s.useState(null), S = t.filter(e => !_.includes(e.toLowerCase()));
    return s.useLayoutEffect(() => {
      if (null == p.current || null == g || 0 === g) return;
      let e = 0,
        t = 0,
        n = g - 40 - 4;
      for (let i = 0; i < S.length && (t += p.current.children[i].clientWidth + 4, i === S.length - 1 ? !(t > n + 40) : !(t > n)); i++) {
        ;
        e++
      }
      C(t => e <= S.length ? e : t)
      ...
      children: [S.map((e, t) => (0, i.jsx)(E, {
        className: l,
        onClick: () => n(e),
        hide: null != T && t >= T,
        text: e
      }, e)), !c && null != T && T < S.length && (0, i.jsx)(I, {
        className: l,
        onTagClick: n,
        tags: S.slice(T),
        count: S.length - T,

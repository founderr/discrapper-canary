...
if (N.actionType === U.vB8.DELETE && (null != t || null != r)) {
  ...
  (N.targetType === U.KFR.CHANNEL || N.targetType === U.KFR.CHANNEL_OVERWRITE) && null !== a && (0, L.r8)(a.oldValue) && (e = '#'.concat(e)), null == v[N.targetType] ? v[N.targetType] = {
    [N.targetId]: e
  } : v[N.targetType][N.targetId] = e;
}
E = 0, _.unshift(N);
  }), _;
}

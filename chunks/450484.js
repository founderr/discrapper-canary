...
let h = ["open.spotify.com", "www.spotify.com"],
  g = "https://api.spotify.com/v1",
  m = e => "?utm_source=discord&utm_medium=".concat(e),
  E = Object.freeze({
    PROFILE: "".concat(g, "/me"),
    NOTIFICATIONS_PLAYER: "".concat(g, "/me/notifications/player"),
    PLAYER: "".concat(g, "/me/player"),
    PLAYER_DEVICES: "".concat(g, "/me/player/devices"),
    PLAYER_PLAY: "".concat(g, "/me/player/play"),
    PLAYER_PAUSE: "".concat(g, "/me/player/pause"),
    PLAYER_REPEAT: "".concat(g, "/me/player/repeat"),
    ...
    PLAYER_OPEN: function(e, t) {
      ...
      return "".concat(d, ":").concat(encodeURIComponent(e), ":").concat(encodeURIComponent(t)).concat(n ? m(i) : "")
    },

    ...
    for (; c.length > 0; ) {
        switch (c.charAt(0)) {
            ...
            case 'd':
                ...
                continue;
            case 'e':
                (u.day = !0), d('(_day + 7 - ' + +r.week.dow + ') % 7'), f(1);
                continue;
            case 'E':

...
function s(e) {
    var t, n;
    let r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function () {
            var e;
            let {
                months: t,
                monthsShort: n,
    ...
    let l = [], u = {
            ...
            if (/^LLLL/.test(e))
                return n.longDateFormat.LLLL;
            if (/^LLL/.test(e))
                return n.longDateFormat.LLL + e.slice(3);
            if (/^LL/.test(e))
                return n.longDateFormat.LL + e.slice(2);
            else if (/^LTS/.test(e))
                return n.longDateFormat.LTS + e.slice(3);
            else if (/^LT/.test(e))
                return n.longDateFormat.LT + e.slice(2);
            else if (/^L/.test(e) && '[' !== t[r - 1])
    ...
    for (; c.length > 0;) {
        ...
        case 'S':
            if (u.millis = !0, /^SSS/.test(c)) {
                ...
                let e = /^S{3,9}/.exec(c);
                if (null == e)
                    throw Error('ms len regex failed');
                let t = e[0].length;

...
n = r && r.getOptions();
  if (!n)
return u.X && _.kg.log('[Profiling] Profiling disabled, no options found.'), !1;
...
function m(e, t, r, n) {
  var o;
  return ((o = r).samples.length < 2 ? (u.X && _.kg.log('[Profiling] Discarding profile because it contains less than 2 samples'), !1) : !!o.frames.length || (u.X && _.kg.log('[Profiling] Discarding profile because it contains no frames'), !1)) ? function(e, t, r, n) {
    ...
    return 'thread_metadata' in e ? e : function(e) {
      ...
      return e.samples.forEach((a, i) => {
        ...
        for (; E;) {
          ...
          t && void 0 === n.frames[E.frameId] && (n.frames[E.frameId] = {
            function: t.name,

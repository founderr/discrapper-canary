...
function m(e) {
  return e < h.PAGE_WIDTH_THRESHOLD ? h.PageSizes.SMALL : h.PageSizes.LARGE
}
...
class M extends a.PureComponent {
  componentDidMount() {
    ...
    }), this.props.isAuthenticated && (0, o.fetchPaymentSources)(), f.default.disable(), f.default.setLayout(T.APPLICATION_STORE_LAYOUT), f.default.enable(), (0, O.trackAppUIViewed)("application_store")
  }

n(47120), n(757143);
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(481060), l = n(239091), u = n(555573), c = n(998698), d = n(459273), _ = n(358085), E = n(62883), f = n(752305), h = n(981631);
function p(e, t, n) {
...
class I extends i.PureComponent {
    componentDidMount() {
        ...
        }), this.focus()), null != c.Z.getActiveCommand(this.props.channel.id) && u.Po({
    ...
    getCurrentWord() {
        ...
        let n = e.selectionStart, r = e.selectionEnd;
    ...
    insertAutocomplete(e, t) {
        let n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], {word: r} = this.getCurrentWord();
        if (null == r)
            this.insertText(e, t, n);
        else {
            let t = this._ref;
            if (null == t)
                return;
            let i = t.value.slice(0, t.selectionStart - r.length), a = t.value.slice(t.selectionEnd);
            this._insertText(e, i, a, n);
        }
    }
    insertText(e, t) {
        let n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], r = this._ref;
        if (null == r)
            return;
    ...
    _insertText(e, t, n, r) {
        if (null == this._ref)
            return;
        r && (e += ' ');
        let i = t + e + n, {onChange: a} = this.props;
    ...
    constructor(...e) {
        super(...e), p(this, '_ref', void 0), p(this, 'state', { nextSelection: -1 }), p(this, 'focus', () => {
            let {_ref: e} = this;
            null != e && e.focus();
            ...
            if (e.which === h.yXg.ENTER) {
                if (!e.shiftKey && !this.hasOpenCodeBlock() && (!this.props.disableEnterToSubmit || e.ctrlKey))
                    return e.preventDefault(), this.props.onSubmit(this.props.value);
            }

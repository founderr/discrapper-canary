var o = n(230371), r = n(400361), i = n(473452), a = n(184826), u = n(992278), s = n.n(u), l = /[A-Z]|^ms/g, c = (0, o.Z)(function (e) {
...
var m = function () {
    ...
    return t.inject = function () {
        ...
        if (0 !== this.ctr)
            throw Error('cannot change speedy now');
        this.isSpeedy = !!e;
...
t.Z = function (e, t) {
    ...
    void 0 === t && (t = {});
    var n, o, r, u, l = t.key || 'css', h = s()(function (e) {
            n += e, f && g.insert(e, b);
        });
    ...
    var x = /label:\s*([^\s;\n{]+)\s*;/g, A = function (e) {
            ...
            for (var l = arguments.length, c = Array(l > 1 ? l - 1 : 0), p = 1; p < l; p++)
                c[p - 1] = arguments[p];
    ...
    var w = function () {
        var e = A.apply(this, arguments), t = l + '-' + r;
    ...
    var I = {
        ...
        keyframes: function () {
            var e = A.apply(this, arguments), t = 'animation-' + r;

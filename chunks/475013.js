...
let R = () => {
  let {
    guild: e
  } = (0, l.cj)([m.Z], () => m.Z.getProps()), t = (0, l.e7)([T.Z], () => T.Z.formState), n = (0, l.e7)([T.Z], () => T.Z.errorMessage);
  return (0, s.jsx)(c.Z, {
    errorMessage: n,
    onSave: () => {
      if (null == e) return;
      let {
        id: t
      } = e, n = T.Z.editedRoleIds.map(e => T.Z.getRole(e)).filter(_.lm), s = T.Z.getSortDeltas(), a = null, i = null;
...
function f(e) {
  ...
  let _ = a.useMemo(() => i.filter(e => !(0, d.pM)(n.id, e.id)), [i, n]),
    E = (0, l.e7)([m.Z], () => m.Z.getSelectedRoleId()),
    [I, x] = a.useState(_.length > 0);
  a.useEffect(() => {
    x(I || _.length > 0)
  }, [I, _.length]), a.useEffect(() => {

...
function R(e) {
  let {
    ...
    onClose: I,
    onCancel: A
  } = e, B = (0, C.useLastChannelMessage)(s), h = o.useCallback(() => {
    r.default.addRelationship({
      userId: t,
      context: {
        location: c.LOCATION_CONTEXT_WEB
      },
      type: O.RelationshipTypes.BLOCKED
    }), (0, l.showToast)((0, l.createToast)(_.default.Messages.STRANGER_DANGER_BLOCK_CONFIRM, l.ToastType.SUCCESS))
  }, [t]), E = o.useCallback(() => {
    h(), T(), I()
  }, [h, T, I]), f = o.useCallback(() => {
    h(), (0, u.showReportModalForInappropriateConversationSafetyAlert)(B), M(), I()
  }, [B, h, M, I]), L = (0, n.useStateFromStores)([d.default], () => d.default.getUser(t)), S = i.default.useName(L);

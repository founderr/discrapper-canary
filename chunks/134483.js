...
t.default = function(e) {
  ...
  let {
    ...
    return {
      isCurrentUserStreamingQuestApplication: null != t && null != Z && function(e, t, n, s) {
        for (let i of e) {
          var a;
          if (i.type === y.ParticipantTypes.STREAM && i.user.id === n.id && O.SharedQuestFields.build(t.config).application.id === (null === (a = (0, f.getStreamerApplication)(i.stream, s)) || void 0 === a ? void 0 : a.id)) return !0
        }
        return !1
      }(e, t, Z, I.default),
      quest: t
    }
  }, [H, Z, w]), $ = null != X ? O.SharedQuestFields.build(X.config) : null, ee = null == $ ? void 0 : $.application.id, et = (0, r.useStateFromStoresObject)([E.default], () => {
    ...
    null != X && (0, N.enrollInQuest)(X.id, {
      questContent: L.QuestContent.QUEST_LIVE_STREAM,
    ...
    quest: X,
    location: L.QuestContent.QUEST_LIVE_STREAM
  ...
  let ef = (null === (t = X.userStatus) || void 0 === t ? void 0 : t.enrolledAt) != null,
    ...
    eT = null != X.userStatus && (0, v.isDismissed)(X.userStatus, L.QuestContent.QUEST_LIVE_STREAM),
    eI = null != X.userStatus && (0, v.isDismissed)(X.userStatus, L.QuestContent.QUEST_BAR),
    eS = (0, v.isTargetedForContent)(X, L.QuestContent.QUEST_BAR) && !eI;
  ec.info({
  ...
  let eC = null != w && (null === (i = X.userStatus) || void 0 === i ? void 0 : i.claimedAt) == null;
  if (!eC && (eT || eE || eS) || !eC && !ea) return null;
  let em = (0, s.jsx)(U.default, {
    className: F.rewardTile,
    autoplay: Q,
    quest: X,
    questContent: L.QuestContent.QUEST_LIVE_STREAM
  });
  return (0, s.jsx)(M.QuestContentImpressionTracker, {
    questOrQuests: X,
      ...
      return (0, s.jsxs)("div", {
        ...
        children: [!ef && (0, s.jsxs)("div", {
          ...
          children: [(0, s.jsxs)("div", {
            className: F.heading,
            children: [ef && en ? em : (0, s.jsx)("img", {
              className: F.gameTile,
              alt: X.config.messages.gameTitle,
              src: (0, v.getGameTileAssetUrl)(X, K)
            }), (0, s.jsxs)("div", {

...
return null != t && ((0, E.hv)(t.type) || d.TPd.GUILD_VOCAL.has(t.type) ? a.ZP.getMentionCount(n) > 0 || u.Z.getVoiceChannelId() === n : (!s.ZP.isChannelMuted(e, n) || a.ZP.getMentionCount(n) > 0) && (0, l.d)(t));
  },
  C = (e, n) => {
if (n === _.W.GUILD_EVENT)
  return !s.ZP.isMuteScheduledEventsEnabled(e) && a.ZP.hasUnread(e, n);

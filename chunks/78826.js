...
var r = n(735250), i = n(470079), a = n(374470), o = n(626135), s = n(960048), l = n(981631);
...
function _(e) {
    ...
    let S = i.useCallback(e => {
            ...
            !n && null != _ && (o.default.track(l.rMx.QUEST_ASSET_LOADING_FAILURE, {
                ...
                quest_id: E,
                asset_id: d(t)
            }), s.Z.captureException(Error(''.concat(i, ': ').concat(null != a ? ''.concat(a, ', ') : '').concat(d(t), ', ').concat(r)), { tags: { source: _ } }), h(!0));
        }, [
            n,
            _,
            E

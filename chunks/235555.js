...
class T extends s.PureComponent {
  ...
  constructor(...e) {
    super(...e), g(this, "handleUserContextMenu", (e, t) => {
      ...
      return (0, i.jsx)(c.Z, {
        party: e,
        header: p.Z.Messages.SPOTIFY_LISTEN_ALONG_LISTENING_ALONG_COUNT.format({
          count: e.length
        })
      })
    })
...
t.Z = l.ZP.connectStores([u.Z, h.default, E.Z, _.Z], () => {
  ...
  if (null != n ? (e = h.default.getUser(n.userId), t = n.partyId) : null != i && null != i.party && null != i.party.id && (e = s, t = i.party.id), null != t) {
    var l;
    a = r()(Array.from(null !== (l = _.Z.getParty(t)) && void 0 !== l ? l : [])).map(e => h.default.getUser(e)).filter(m.lm).orderBy([t => null == e || e.id === t.id, e => E.Z.isFriend(e.id)], ["desc", "desc"]).value()
  }
  return {
    currentUser: s,
    host: e,

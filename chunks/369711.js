...
class a {
    static create(e) {
        ...
        if (null == r)
            return null;
        let i = e.getAttribLocation(r, 'position'), o = e.getAttribLocation(r, 'texcoord');
        if (-1 === i || -1 === o)
            return null;
        let s = e.getUniformLocation(r, 'transform'), l = e.getUniformLocation(r, 'texture');
        if (null == s || null == l)
            return null;
    ...
    render(e) {
        if (null == e)
            return;
        let t = e.width, n = e.height, r = this.gl;

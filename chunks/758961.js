...
function A(e) {
  ...
  let {
    ...
    transitionState: M,
    showGuildPicker: C = !1
  } = e, [j, I] = i.useState(null !== (t = null !== (n = null == o ? void 0 : o.name) && void 0 !== n ? n : null == A ? void 0 : A.name) && void 0 !== t ? t : ""), [w, U] = i.useState(null !== (l = null == A ? void 0 : A.volume) && void 0 !== l ? l : 1), [L, Z] = i.useState(null == A ? void 0 : A.emojiId), [R, P] = i.useState(null == A ? void 0 : A.emojiName), {
    file: T,
    loadAudioFromFile: B,
    maxVolume: k,
    setMaxVolume: F
  } = (0, _.p)(), [G, H] = i.useState(!1), [z, V] = i.useState(null), [q, W] = i.useState(null), [Y, J] = i.useState("ready"), [K, X] = i.useState(r);
  async function $(e) {
    try {
  ...
  return (0, s.jsxs)(d.ModalRoot, {
    ...
    children: [(0, s.jsx)(d.ModalCloseButton, {
      ...
      children: [null != z && !z.hasFieldErrors() && (0, s.jsx)(d.FormErrorBlock, {
        className: y.section,
        children: z.message
      }), C ? (0, s.jsx)(d.FormItem, {
        required: !0,
        className: y.section,

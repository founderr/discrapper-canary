n(47120);
var r = n(512722), i = n.n(r), a = n(846519), o = n(668781), s = n(846027), l = n(147913), u = n(710845), c = n(314897), d = n(131951), _ = n(19780), E = n(797258), f = n(979651), h = n(823379), p = n(254238), m = n(607214), I = n(258609), T = n(565473), g = n(444092), S = n(927923), A = n(65154), N = n(689938);
function v(e, t, n) {
    ...
    constructor(...e) {
        super(...e), v(this, 'rollbackCommandTimeout', new a.V7()), v(this, 'awaitRemoteTimeout', new a.V7()), v(this, 'actions', {
            ...
            let t = function (e) {
                ...
                return e.find(e => {
                    let n = S.al.has(e.clientInfo.os), r = null != f.Z.getVoiceStateForSession(c.default.getId(), e.sessionId), i = null == t || (0, T.y)(t.type) === e.clientInfo.os;
                    return n && i && r;
                });
            }(e);
            if (null == t)
            ...
            if (!t || n !== A.Yn.DEFAULT)
                return;
            let r = d.Z.isSelfDeaf(), i = d.Z.isSelfMute(), a = c.default.getId(), o = I.Z.getRemoteSessionId();
            if (null == o)
                return;
            let s = f.Z.getVoiceStateForSession(a, o);
            if (null != s)
                (s.selfDeaf !== r || s.selfMute !== i) && ((0, p.Vv)(o, {
                    selfDeaf: r,
                    selfMute: i
            ...
            let t = e.voiceStates, n = I.Z.getRemoteSessionId();
            if (null == n) {
                let e = t.map(e => {
                    let {sessionId: t} = e;
            ...
            if ((null == a ? void 0 : a.commandId) !== n)
                return;
            let o = I.Z.getDevice(a.type, null !== (t = a.deviceId) && void 0 !== t ? t : ''), s = (0, g.Z)(null != o ? o : {
                    id: 'id',
                    platform: N.Z.Messages.STATUS_UNKNOWN,
                    name: N.Z.Messages.STATUS_UNKNOWN
                }, r, i);
            null != s && m.Z.showSelfDismissableAlert({
                title: s.title,
                body: s.body,

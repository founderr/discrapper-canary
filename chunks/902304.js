        ...
        super(...e),
            ...
            y(this, 'maybeConnect', (e) => {
                let t = (function (e) {
                    ...
                    return e.find((e) => {
                        let n = I.al.has(e.clientInfo.os),
            ...
            y(this, 'handleWaitForRemoteSession', () => {
                this.awaitRemoteTimeout.start(60000, () => {
                    (0, m.s6)(),
                        s.Z.show({
                            title: S.intl.string(S.t.wGMxr6),
                            body: S.intl.string(S.t.i5k8b2)
                        });
                });
            }),
            y(this, 'handleConsoleCommandUpdate', (e) => {
                ...
                let s = E.Z.getDevice(a.type, null !== (t = a.deviceId) && void 0 !== t ? t : ''),
                    o = (0, b.Z)(
                        null != s
                            ...
                            : {
                                  id: 'id',
                                  platform: S.intl.string(S.t['UQMV/P']),
                                  name: S.intl.string(S.t['UQMV/P'])
                              },
                        r,
                        i
                    );
                null != o &&
                    ...
                    I.e8.has(i.code) && this.awaitRemoteTimeout.isStarted() ? this.awaitRemoteTimeout.start(180000, () => (0, m.s6)(), !0) : 'failed' === r && (0, m.s6)();
            }),

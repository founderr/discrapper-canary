var a = n(735250);
n(470079);
var s = n(120356), r = n.n(s), l = n(913527), i = n.n(l), o = n(481060), c = n(70956), d = n(689938), u = n(781303);
t.Z = e => {
    let {
            rateLimitPerUser: t,
    ...
    if (t >= c.Z.Seconds.HOUR) {
        let e = Math.floor(t / c.Z.Seconds.HOUR), n = Math.floor((t - e * c.Z.Seconds.HOUR) / c.Z.Seconds.MINUTE), a = t - e * c.Z.Seconds.HOUR - n * c.Z.Seconds.MINUTE;
        ...
        h = d.Z.Messages.FORUM_SLOWMODE_DESC.format({ seconds: t });
    if (!s && n > 0) {
        let e = i().duration(n);
        if (n > c.Z.Millis.HOUR) {
            let t = ''.concat(e.minutes()).padStart(2, '0'), n = ''.concat(e.seconds()).padStart(2, '0');

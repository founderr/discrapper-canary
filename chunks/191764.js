...
return o.Z.getChannel(null === (e = u.Z.getVoiceStateForUser(t.id)) || void 0 === e ? void 0 : e.channelId);
  ...
  return (null == n ? void 0 : n.type) !== _.IIU.HANG_STATUS || null == m ? null : (0, r.jsx)(d.tG, {
text: E.Z.Messages.PROFILE_JOIN_VOICE_CHANNEL,
disabled: I,
fullWidth: !0,
onClick: e => {
  null == f || f(e), a.default.selectVoiceChannel(m.id), c.default.track(_.rMx.HANG_STATUS_CTA_CLICKED, {
    channel_id: m.id,
    guild_id: m.guild_id,
    source: p
  }), null == h || h();

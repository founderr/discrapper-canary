...
function J(e) {
  let {
    member: t
  } = e, l = (0, C.default)([H.default], () => H.default.getGuild(t.guildId), [t.guildId]), s = n.useMemo(() => {
    var e;
    if (null == l) return [];
...
let X = n.memo(function(e) {
  ...
  $ = n.memo(function(e) {
    ...
    } = (0, M.default)(), _ = null !== (t = null == x ? void 0 : x[0]) && void 0 !== t ? t : null, p = (0, V.useCanAccessBulkBanningFeature)(l.guildId, _, !0), S = (0, V.useCanBulkBanUser)(l.guildId, p, l.userId), L = n.useCallback(e => {
      e.stopPropagation(), e.preventDefault(), null != l && S && (E.has(l.userId) ? T(l.userId) : h([l.userId]))
    }, [h, S, l, T, E]);
    return (0, a.jsxs)(a.Fragment, {
      children: [p && (0, a.jsx)(f.Tooltip, {

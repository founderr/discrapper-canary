...
var r, o, a, i, s, c, l, u, d = {}, p = [], h = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function f(e, t) {
    for (var n in t)
        e[n] = t[n];
    return e;
...
function _(e, t) {
    if (null == t)
        return e.__ ? _(e.__, e.__.__k.indexOf(e) + 1) : null;
...
function C() {
    ...
    for (i.sort(l); e = i.shift();)
        e.__d && (t = i.length, r = void 0, o = void 0, s = (a = (n = e).__v).__e, (c = n.__P) && (r = [], (o = f({}, a)).__v = a.__v + 1, A(c, a, o, n.__n, void 0 !== c.ownerSVGElement, null != a.__h ? [s] : null, r, null == s ? _(a) : s, a.__h), R(r, a), a.__e != s && function e(t) {
            var n, r;
...
function Z(e, t, n, r, a, i, s, c, l, u) {
    var h, f, y, b, k, C, Z, S = r && r.__k || p, N = S.length;
        ...
        if (null != (b = n.__k[h] = null == (b = t[h]) || 'boolean' == typeof b || 'function' == typeof b ? null : 'string' == typeof b || 'number' == typeof b || 'bigint' == typeof b ? v(null, b, null, null, b) : Array.isArray(b) ? v(g, { children: b }, null, null, null) : b.__b > 0 ? v(b.type, b.props, b.key, b.ref ? b.ref : null, b.__v) : b)) {
            ...
            A(e, b, y = y || d, a, i, s, c, l, u), k = b.__e, (f = b.ref) && y.ref != f && (Z || (Z = []), y.ref && Z.push(y.ref, null, b), Z.push(f, b.__c || k, b)), null != k ? (null == C && (C = k), 'function' == typeof b.type && b.__k === y.__k ? b.__d = l = function e(t, n, r) {
                for (var o, a = t.__k, i = 0; a && i < a.length; i++)
                    (o = a[i]) && (o.__ = t, n = 'function' == typeof o.type ? e(o, n, r) : w(r, o, o, a, o.__e, n));
                return n;
            }(b, l, e) : l = w(e, b, y, S, k, l), 'function' == typeof n.type && (n.__d = l)) : l && y.__e == l && l.parentNode != e && (l = _(y));
        }
    for (n.__e = C, h = N; h--;)
        null != S[h] && ('function' == typeof n.type && null != S[h].__e && S[h].__e == n.__d && (n.__d = function e(t) {
            var n, r, o;
    ...
    if (void 0 !== t.__d)
        ...
        e:
            if (null == a || a.parentNode !== e)
                ...
                for (s = a, c = 0; (s = s.nextSibling) && c < r.length; c += 1)
                    if (s == o)
                        break e;
...
function N(e, t, n, r, o) {
    ...
    e:
        if ('style' === t) {
            ...
            a = t !== (t = t.replace(/Capture$/, '')), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + a] = n, n ? r || e.addEventListener(t, a ? P : x, a) : e.removeEventListener(t, a ? P : x, a);
        ...
        e:
            if ('function' == typeof M) {
                if (S = t.props, x = (p = M.contextType) && a[p.__c], P = p ? x ? x.props.value : p.__ : a, n.__c ? w = (h = t.__c = n.__c).__ = h.__E : ('prototype' in M && M.prototype.render ? t.__c = h = new M(S, P) : (t.__c = h = new b(S, P), h.constructor = M, h.render = O), x && x.sub(h), h.props = S, h.state || (h.state = {}), h.context = P, h.__n = a, y = h.__d = !0, h.__h = [], h._sb = []), null == h.__s && (h.__s = h.state), null != M.getDerivedStateFromProps && (h.__s == h.state && (h.__s = f({}, h.__s)), f(h.__s, M.getDerivedStateFromProps(S, h.__s))), v = h.props, k = h.state, h.__v = t, y)
                    null == M.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), null != h.componentDidMount && h.__h.push(h.componentDidMount);
                else {
                ...
                if (h.context = P, h.props = S, h.__P = e, R = o.__r, F = 0, 'prototype' in M && M.prototype.render) {
                    for (h.state = h.__s, h.__d = !1, R && R(t), p = h.render(h.props, h.state, h.context), E = 0; E < h._sb.length; E++)
                        h.__h.push(h._sb[E]);
                    h._sb = [];
                } else
                    do
                        h.__d = !1, R && R(t), p = h.render(h.props, h.state, h.context), h.state = h.__s;
                    while (h.__d && ++F < 25);
                ...
                null == s && t.__v === n.__v ? (t.__k = n.__k, t.__e = n.__e) : t.__e = function (e, t, n, o, a, i, s, c) {
                    var l, u, p, h = n.props, f = t.props, y = t.type, v = 0;
                    if ('svg' === y && (a = !0), null != i) {
                        for (; v < i.length; v++)
                    ...
                    if (null === y)
                        ...
                        if (function (e, t, n, r, o) {
                                var a;
                                for (a in n)
                                    'children' === a || 'key' === a || a in t || N(e, a, null, n[a], r);
                                for (a in t)
                                    o && 'function' != typeof t[a] || 'children' === a || 'key' === a || 'value' === a || 'checked' === a || n[a] === t[a] || N(e, a, t[a], n[a], r);
                            }(e, f, h, a, c), p)
                            t.__k = [];
...
r = p.slice, o = {
    __e: function (e, t, n, r) {
        for (var o, a, i; t = t.__;)
            if ((o = t.__c) && !o.__)
                try {
                    if ((a = o.constructor) && null != a.getDerivedStateFromError && (o.setState(a.getDerivedStateFromError(e)), i = o.__d), null != o.componentDidCatch && (o.componentDidCatch(e, r || {}), i = o.__d), i)
                        return o.__E = o;
                } catch (t) {
                    e = t;
                }

var r = n(445346), i = n(570140), a = n(710845), o = n(70956), s = n(287328);
let l = new a.Z('FileSystemStore'), u = 10 * o.Z.Millis.MINUTE;
class c extends r.y {
    ...
    async refresh() {
        ...
        if (null != n) {
            let e = n.fs.available < 268435456 || n.fs.available < 3 * n.database.used || n.fs.available < 2 * n.database.total, t = n.fs.available > 805306368 && n.fs.available > 4 * n.database.used && n.fs.available > 4 * n.database.total, r = !!e || !t && null;

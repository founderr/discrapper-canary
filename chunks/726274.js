...
function d(e, t) {
  var n;
  let a = (0, o.default)(e),
    l = (0, s.useStateFromStores)([i.default], () => i.default.getNewMemberActions(e), [e]),
    u = (0, s.useStateFromStores)([r.default], () => r.default.getCompletedActions(e));
  if (!a) return {};
...
function c(e, t) {
  let n = (0, s.useStateFromStores)([i.default], () => i.default.getNewMemberActions(e)),
    a = (0, s.useStateFromStores)([r.default], () => r.default.getCompletedActions(e)),
...
function f(e) {
  var t;
  let n = (0, s.useStateFromStores)([a.default], () => a.default.getSelfMember(e));

...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(519953), l = n(481060), u = n(40851), c = n(153850), d = n(5967), _ = n(53529), E = n(50659), f = n(436660), h = n(887490), p = n(447525), m = n(632946);
function I(e) {
    var t;
    let {
            editorRef: n,
    ...
    return null == u ? null : (0, r.jsxs)('div', {
        ...
        children: [
            ...
            (0, r.jsx)('div', { className: o()(m.divider, s) }),
...
function S(e) {
    var t;
    let {slateEditor: n} = e, [r, a] = null !== (t = h.bN.getSelectedVoid(n)) && void 0 !== t ? t : [
            null,
            null
        ], o = i.useCallback(e => {
    ...
    return null == r ? null : (0, p.Z)(r, { replace: o });
}
t.Z = i.forwardRef(function (e, t) {
            ...
            if (e.target instanceof t.Element) {
                if (0 !== e.button)
                    ...
                    clearTimeout(p.current), p.current = setTimeout(() => {
                        var t;
                        let n = null === (t = (0, d.uB)(e)) || void 0 === t ? void 0 : t.activeElement, i = o.current;
    ...
    i.useImperativeHandle(t, () => ({ hide: g }), [g]), i.useEffect(() => {
    ...
    let {
            ...
            let l = s.F3.findDocumentOrShadowRoot(i), u = l.getSelection();
            ...
            let d = c.getBoundingClientRect(), _ = l.createRange();
            _.setStart(u.anchorNode, u.anchorOffset), _.setEnd(u.anchorNode, u.anchorOffset);
            let f = _.getBoundingClientRect(), p = l.createRange();
            p.setStart(u.anchorNode, u.anchorOffset), p.setEnd(u.focusNode, u.focusOffset);
            let m = p.getBoundingClientRect(), I = d.x === f.x, T = I ? m.x : Math.min(d.x, f.x), g = I ? m.x + m.width : Math.max(d.x, f.x), S = null !== (r = null === (n = o.current) || void 0 === n ? void 0 : null === (t = n.getBoundingClientRect()) || void 0 === t ? void 0 : t.y) && void 0 !== r ? r : 0;
            return {
                x: T + (g - T) / 2,

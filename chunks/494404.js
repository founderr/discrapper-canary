...
function j(e) {
    let { analyticsName: t, items: n, hasMore: s, loading: l, loadMore: _, renderHeader: E, renderEmptyState: T, renderItem: h, getProTip: C, scrollerClassName: f, className: p, listName: v } = e,
        Z = a.useRef(null),
        P = (0, I.Z)(v, Z),

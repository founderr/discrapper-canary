...
function A(e) {
    let { badges: t, className: n, badgeClassName: a, onClose: I } = e,
                ...
                o.TooltipContainer,
                {
                    ...
                    children: (0, r.jsxs)(o.Anchor, {
                        onClick: (t) => {
                            ...
                            if (null != n) return null == I || I(), n(t);
                        },
                        onMouseEnter: () => {
                            e.id === g.i && _.default.track(b.rMx.QUEST_CONTENT_VIEWED, { ...(0, d.mH)(f.jn.QUEST_BADGE) }),

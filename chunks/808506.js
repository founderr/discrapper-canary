...
class eL extends (s = f.ZP.Store) {
    initialize() {
        if (!(!B.iP || __OVERLAY__)) this.waitFor(S.ZP, R.default, N.Z), b.sr(eD, eO), R.default.addChangeListener(eb), em(y.v.enabled, y.v.legacyEnabled, y.v.global), _.Z.addInterceptor(eC);
    }
    isInputLocked(e) {
    ...
    __OVERLAY__
        ...
        : {
              ...
              RPC_SERVER_READY: function (e) {
                  ...
                  n.append('build_id', '80927b21ae1af5e3904b1371c1cfe52be800a497'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
              },

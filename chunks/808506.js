...
function eY(e) {
    ...
    r.append('build_id', '6b2ab23ead26accfb528b0b8d59274d6ec4df430'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {

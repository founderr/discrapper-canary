...
function e0(e) {
    ...
    r.append('build_id', 'ecda70670e7eba8970789c2cf8b26decaaa93b33'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

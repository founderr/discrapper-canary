...
function eY(e) {
    ...
    r.append('build_id', '127ddb00924a38c86865bf32e7b493d43bb40597'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {

...
function eX(e) {
    ...
    n.append('build_id', '3f0fb2e93e9342d9fd97b597a7b51fffaa902bc9'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
function eY(e) {
    ...
    r.append('build_id', '3b2fd95145f020ccd75d2372ac322656306ac441'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {

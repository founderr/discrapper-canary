...
n.append('build_id', '1b569bf78dbfdd1a871e15323b786dd0f5387ecc'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

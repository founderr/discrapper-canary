...
function eX(e) {
    ...
    n.append('build_id', 'f779895c55db9770fe4a49cfee122db2414c5d6e'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

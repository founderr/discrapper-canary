...
function e0(e) {
    ...
    r.append('build_id', '79661ad765736f6556ac92c15873e4ad205a7c82'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

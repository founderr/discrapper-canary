...
function e0(e) {
    ...
    r.append('build_id', 'c76587a7397d5bbec674180dfd70476015868750'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

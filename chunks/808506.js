...
function eX(e) {
    ...
    n.append('build_id', '56e90c7160c27c832d6abdbf98a6d2792e1f3c92'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
n.append('build_id', 'e9e5056a74923480a7fa7c73413283ff83076eab'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

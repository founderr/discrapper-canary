...
n.append('build_id', 'c7fbd1dcc00ed5fc8b1df6bea7c3c17ec6c37088'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
function e0(e) {
    ...
    r.append('build_id', 'b0e96baffa7e4361d485156054e1658cc302c91d'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

...
function e0(e) {
    ...
    r.append('build_id', '3ff28d86494c4095e24815c8632212eefa7af65e'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

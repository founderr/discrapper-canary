...
function e0(e) {
    ...
    r.append('build_id', '961879229e448d9ca233dec30901488c00d70c4b'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

...
n.append('build_id', '997ae0adec7d0a4fd0fb2d271d165ca2d39cbabf'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

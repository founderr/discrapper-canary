...
function e0(e) {
    ...
    r.append('build_id', '813bc5ec56f5eacc42e7d7986ad368b4c9946ae0'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

...
n.append('build_id', 'd825078e86bc6edb9baeb6769b8833ba28ccd90c'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
n.append('build_id', '69aed1a02e48deefa8fa4089af57ff1ce23c3b9f'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

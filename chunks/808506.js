...
function eY(e) {
    ...
    r.append('build_id', 'f0a62969e36f5553190a17896465ba2a9ded6f58'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {

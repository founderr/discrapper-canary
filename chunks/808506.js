...
n.append('build_id', 'a658c4533540ea160fcd2e0bce8df6342c18ddce'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

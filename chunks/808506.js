...
function e0(e) {
    ...
    r.append('build_id', 'aae6b267c7e5e74a6e0a70fa5f59551472d8f8cf'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

...
function eX(e) {
    ...
    n.append('build_id', 'ead1e558643b0f16333867c709b55229163410b1'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

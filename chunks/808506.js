...
function e0(e) {
    ...
    r.append('build_id', '4d27c4bcb595f7361c7beba84ef4900fe0149c66'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

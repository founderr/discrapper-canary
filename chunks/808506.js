...
n.append('build_id', 'e311d83be1e454d75e19ef550a9011b0fd5437d5'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
function eT(e) {
    if (e) {
        ...
        (null == n ? void 0 : n.overlayMethod) === G.gl.OutOfProcess ? eb(e) : setTimeout(() => eb(e), 200);
    } else eb(e);
}
let ey = null;
function eA(e, t, n) {
...
class eL extends (s = f.ZP.Store) {
    initialize() {
        if (!(!G.iP || __OVERLAY__)) this.waitFor(T.ZP, R.default, N.Z), S.sr(eD, eO), R.default.addChangeListener(eS), em(y.v.enabled, y.v.legacyEnabled, y.v.global), _.Z.addInterceptor(eC);
    }
    isInputLocked(e) {
    ...
    __OVERLAY__
        ...
        : {
              ...
              RPC_SERVER_READY: function (e) {
                  ...
                  n.append('build_id', '166618ada9e4ca76d1b8c309be341a2b7dc2efa8'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
              },

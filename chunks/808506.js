...
function e0(e) {
    ...
    r.append('build_id', 'fce96d6860114d4123211659ca00614e2e8fff65'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

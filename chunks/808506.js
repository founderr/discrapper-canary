...
function e0(e) {
    ...
    r.append('build_id', '7857b939c62832b17d74c6a00f4e5df49a6c8738'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

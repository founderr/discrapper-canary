...
var a, o, s, l, u, c, d = n(807864), _ = n(442837), E = n(570140), f = n(26151), h = n(224706), p = n(765250), m = n(13245), I = n(287734), T = n(579806), g = n(887278), S = n(490029), A = n(710845), N = n(594190), v = n(454991), O = n(633565), R = n(48481), C = n(314897), y = n(77498), D = n(355863), L = n(449224), b = n(626135), M = n(866119), P = n(671999), U = n(998502), w = n(145597), x = n(981631), G = n(987650);
...
let k = {}, B = new Map(), F = !1, V = new Set(), H = !1, Z = !1, Y = !1, j = null, W = null, K = '', z = new Set(), q = !1, Q = new Set([
        'CONNECTION_OPEN',
        'CONNECTION_RESUMED',
        'CONNECTION_CLOSED',
        'WINDOW_INIT',
    ...
    ]), X = new Set(), $ = new A.Z('OverlayBridgeStore'), J = 'none', ee = (0, d.H)({
...
function en(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, r = B.get(e);
    if ((null === n || r === n) && r !== t) {
...
let eu = (() => {
    ...
    async function t() {
        ...
        try {
            return await U.ZP.ensureModule('discord_overlay2'), function (e) {
                for (let t of [
                        'createHostProcess',
                        'connectProcess',
                        'disconnectProcess',
...
let eh = et('setOverlayEnabled', async (e, t) => {
    ...
    let n = await eu(), {OutOfProcess: r} = n;
...
function eI(e, t, n) {
    var r;
    let i = null === (r = N.ZP.getGameForPID(e)) || void 0 === r ? void 0 : r.name, a = y.Z.getGameByName(i), o = {
            game_name: i,
...
function eT() {
    let e = C.default.getToken(), t = C.default.getId();
    if (null != e)
        S.lW({
            type: x.BmY.DISPATCH,
            pid: null,
...
function eS(e) {
    if (e) {
        let t = N.ZP.getVisibleGame(), n = null == t ? null : N.ZP.getGameOverlayStatus(t);
...
let eL = new eD(E.Z, __OVERLAY__ ? {
    OVERLAY_RELAY_CLICK_ZONE_CLICKED: function (e) {
        ...
        setTimeout(() => {
            let e = Math.ceil(t * window.innerWidth), r = Math.ceil(n * window.innerHeight), i = (0, P.B)('click', e, r);
            (0, P.J)(i, e, r);
        }, 50);
    },
    ...
    RPC_SERVER_READY: function (e) {
        ...
        n.append('build_id', 'cb6e309d60fdefff13d04d1941b1c093fdc265f3'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
    },

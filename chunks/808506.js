...
n.append('build_id', '0707d07d74dc53f81a9135a0ef5115b5aee5b2fe'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

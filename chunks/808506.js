...
function eX(e) {
    ...
    n.append('build_id', 'b7b91fd9f42c60e00f7196e1887ba6da9856e565'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

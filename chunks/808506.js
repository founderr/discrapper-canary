...
n.append('build_id', 'b866378aafb641c2319c7b679276cb84b83aed36'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
function eX(e) {
    ...
    n.append('build_id', '7e5d8fe3fe796c5521716a5cd3a4d4dad6675ea4'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
function e0(e) {
    ...
    r.append('build_id', '207a36459feccf2c6da76e53194a3fa9016215f9'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

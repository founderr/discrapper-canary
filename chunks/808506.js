...
function eX(e) {
    ...
    n.append('build_id', '4bcdea99db08cfb137f75e81cc9a447115acdf92'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
function eX(e) {
    ...
    n.append('build_id', '7471feb2cfa34687c058762435a93467374ee06d'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

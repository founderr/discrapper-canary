...
function e0(e) {
    ...
    r.append('build_id', 'a60bcd116e95b3afcfc3802ee90e9ce2db79986d'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

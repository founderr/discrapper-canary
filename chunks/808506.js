...
function eX(e) {
    ...
    n.append('build_id', '299f5ac746fd2539c4a190707287289f7f4e4253'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

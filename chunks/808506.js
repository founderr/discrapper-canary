...
n.append('build_id', '156b03dc95cf8af084aac0ee7fa367f9e01b8540'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

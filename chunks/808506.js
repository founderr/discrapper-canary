...
n.append('build_id', '3c528dc2e4d011d8d3ca21f837e6275d5dd96a66'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

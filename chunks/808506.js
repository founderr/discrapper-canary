...
n.append('build_id', '0dcbf54df1b14cbd9e69e5ff148de503bd0a3e99'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

	...
	__OVERLAY__
		...
		: {
				...
				RPC_SERVER_READY: function (e) {
					...
					n.append('build_id', '40bbfccc66cf96fd637707a8c362b732146e9ef2'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
				},

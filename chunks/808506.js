...
n.append('build_id', '2c3c92485c5588e4fa5a2b3d6feedaba891c4def'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

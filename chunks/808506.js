...
function eY(e) {
    ...
    r.append('build_id', '88ce261a6ba9d4bbef76f1246a27f4be049a36f8'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {

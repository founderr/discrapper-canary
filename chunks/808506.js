...
function e0(e) {
    ...
    r.append('build_id', 'b9364a2ce6a6ad7ce318e7d180ead43aacf3cdf1'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

...
n.append('build_id', '6593c8b866bb7563ac2d483c8322fd08dd50cdcc'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
n.append('build_id', '3833b6528bde75cdd376d21e54d3adfc49c89705'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

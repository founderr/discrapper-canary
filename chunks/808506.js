...
let eL = new eD(E.Z, __OVERLAY__ ? {
    ...
    RPC_SERVER_READY: function (e) {
        ...
        n.append('build_id', '73b8ae05f60c10d982f55a83970b6c92ea295c3b'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
    },

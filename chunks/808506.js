...
function eX(e) {
    ...
    n.append('build_id', 'dc000dab3e4e05d4976fc7456daefc6aa3fe000e'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
function eX(e) {
    ...
    n.append('build_id', '2438076022c155feb5f36d726fc92e5e8d67120f'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

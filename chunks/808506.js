...
n.append('build_id', 'ffc27156afb551dd571c330bc079f40c1de1456b'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
function eY(e) {
    ...
    r.append('build_id', 'e1bb2f3532797fe8b422fa45870994675e04144c'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {

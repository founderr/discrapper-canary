...
n.append('build_id', '335b54c77b73d0e398b0fb4ee799fc152419fab2'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

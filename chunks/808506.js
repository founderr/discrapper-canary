...
function e0(e) {
    ...
    r.append('build_id', '2d2af7f287d0dc03fcb2c747b91cece19f40524b'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

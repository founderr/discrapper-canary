...
n.append('build_id', '6822a9ba46402b09a21bbf8aa6454a969407a557'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

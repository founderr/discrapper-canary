...
n.append('build_id', 'c35c5510bc840c5f0058a80dcd3df09c318b36dc'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
function e0(e) {
    ...
    r.append('build_id', 'b789c56a3fe0a6f4fedff84f5ff482ecf4896134'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

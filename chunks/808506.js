...
n.append('build_id', 'ebda222930d29d50484d682a958cccbfbf9e72fe'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

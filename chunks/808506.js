...
n.append('build_id', '96dc87e0534572fb7b7f285c43c3f96deef659e4'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
function e0(e) {
    ...
    r.append('build_id', 'e2a77173265eef37897c761aaa43e20fcda748bf'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

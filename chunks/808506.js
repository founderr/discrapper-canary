...
function eX(e) {
    ...
    n.append('build_id', '173e07a582fcd793f7e7fd8cca292f5d5f13a456'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

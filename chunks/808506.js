...
function e0(e) {
    ...
    r.append('build_id', '6780883528d67a54dbfd0e7cf1c108e9965d6c4b'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

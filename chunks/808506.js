...
function e0(e) {
    ...
    r.append('build_id', 'cb77f867e0ee459cd66ba8dc2e9eac5ccdc64276'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

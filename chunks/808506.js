...
function eX(e) {
    ...
    n.append('build_id', '0bfd036cc3b1861b93b5b070a245d7b170f4aad4'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
settings: {
  ...
  }), V.add(e), null == i && (i = setTimeout(eC, 1)), !1);
}
...
class eL extends(s = _.ZP.Store) {
  initialize() {
if (!(!G.iP || __OVERLAY__))
  this.waitFor(N.ZP, C.default), S.sr(eD, ey), C.default.addChangeListener(eg), eh(v.v.enabled, v.v.legacyEnabled), E.Z.addInterceptor(eR);
  }
  isInputLocked(e) {
return !z.has(e);
  }
...
c = 'OverlayBridgeStore', (u = 'displayName') in(l = eL) ? Object.defineProperty(l, u, {
  value: c,
  enumerable: !0,
  configurable: !0,
  writable: !0
}) : l[u] = c;
let eb = new eL(E.Z, __OVERLAY__ ? {
...
n.append('build_id', 'aee2aab1e109f06198b1890c24a1df89f7a0cb2b'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

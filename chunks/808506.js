...
function eX(e) {
    ...
    n.append('build_id', '8b62961cf5fe622741d655fe0b889f581f7b76eb'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
function e0(e) {
    ...
    r.append('build_id', 'fba1d442f03c6734a1c981cf35a84fef4c8f900c'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

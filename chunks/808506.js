...
n.append('build_id', '6e2869e7f759ccaaa0cef491f4a8d7d0c1f523de'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

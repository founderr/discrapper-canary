...
function eX(e) {
    ...
    n.append('build_id', '21734bf90c28317e49565bb98b86248a91e407c5'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

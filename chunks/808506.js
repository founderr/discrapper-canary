...
n.append('build_id', '90b38990febd595376c6e6a4934b02329b7fdba0'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

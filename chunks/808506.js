...
function e0(e) {
    ...
    r.append('build_id', 'f39302a12dcf71dc31b4665b1b7dd28bab9221ec'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

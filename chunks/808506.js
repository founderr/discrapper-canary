...
class eD extends (s = _.ZP.Store) {
    initialize() {
        if (!(!G.iP || __OVERLAY__)) this.waitFor(N.ZP, C.default), g.sr(eL, ey), C.default.addChangeListener(eS), eh(O.v.enabled, O.v.legacyEnabled), E.Z.addInterceptor(ev);
    }
    isInputLocked(e) {
        return !z.has(e);
    }
    ...
    __OVERLAY__
        ...
        : {
              ...
              RPC_SERVER_READY: function (e) {
                  ...
                  n.append('build_id', '184e3fda8b0abc37543fe24181b5954e83b07a6e'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
              },

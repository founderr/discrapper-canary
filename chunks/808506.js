...
async function eo(e) {
    ...
    for (let n of null !== (t = e.added) && void 0 !== t ? t : []) {
        let t = T.ZP.getGameOverlayStatus(n);
...
function eI(e, t, n) {
    var r;
    let i = null === (r = T.ZP.getGameForPID(e)) || void 0 === r ? void 0 : r.name,
...
function eT(e) {
    if (e) {
        let t = T.ZP.getVisibleGame(),
            n = null == t ? null : T.ZP.getGameOverlayStatus(t);
        (null == n ? void 0 : n.overlayMethod) === B.gl.OutOfProcess ? eS(e) : setTimeout(() => eS(e), 200);
    } else eS(e);
}
let ey = null;
function eA(e, t, n) {
...
class eL extends (s = f.ZP.Store) {
    initialize() {
        if (!(!B.iP || __OVERLAY__)) this.waitFor(T.ZP, R.default, N.Z), b.sr(eD, eO), R.default.addChangeListener(eb), em(y.v.enabled, y.v.legacyEnabled, y.v.global), _.Z.addInterceptor(eC);
    }
    isInputLocked(e) {
    ...
    __OVERLAY__
        ...
        : {
              ...
              RPC_SERVER_READY: function (e) {
                  ...
                  n.append('build_id', 'ac2e4820fe206cf4b50dc7e52840e698a408c5e2'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
              },

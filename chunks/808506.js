...
function eX(e) {
    ...
    n.append('build_id', '399e9de60f02198627f539d4c0ecd052c2e4501f'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

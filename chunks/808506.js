...
function eX(e) {
    ...
    n.append('build_id', 'dc5daed46037d7cafa57bf1855ba229dea133bcd'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

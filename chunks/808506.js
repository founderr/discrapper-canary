...
function e0(e) {
    ...
    r.append('build_id', 'ec438ca69378cdf8ad056e52c82651321b8d7854'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

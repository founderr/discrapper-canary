...
n.append('build_id', '00e8c93f2b75ab68b5d576618806a0adc4cd59ae'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

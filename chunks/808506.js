...
n.append('build_id', 'db1b0c5d936da4e7780b632e86fadaac02837589'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
n.append('build_id', 'dde84ef58d55c3bdef05b8cea3f51ead884f455f'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
n.append('build_id', '1c681c6e95e62eef6e5fd8fefd3d102f57b92978'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

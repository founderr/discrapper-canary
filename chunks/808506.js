...
function eX(e) {
    ...
    n.append('build_id', '101bc928827717b9dc9e2e2914c6bc8c24626a2e'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

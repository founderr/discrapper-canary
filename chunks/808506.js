...
n.append('build_id', 'dc2fd5fcc015511ed4bface4835a84e0853e79d2'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
function eX(e) {
    ...
    n.append('build_id', 'a5089855ef1ee5acc36d0b40a720c5d078e96924'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
n.append('build_id', '92add1330993a41d929426620fc1ad45b2958d9f'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

...
n.append('build_id', 'b1709da8fc8823cdf02c194f8574b1e44610c795'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

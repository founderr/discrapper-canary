...
let eE = (() => {
    ...
    async function t() {
        ...
        try {
            ...
            return null == r || null === (e = r.init) || void 0 === e || e.call(r), r.setClickZoneCallback(eR), r.setHostWindowCallbacks(ec, ed, e_), r.setFocusCallback(ep), null === (t = r.setFocusLostCallback) || void 0 === t || t.call(r, eI), null === (n = r.setSuccessfullyShownCallback) || void 0 === n || n.call(r, em), r;
        } catch (e) {
...
class ey extends (s = _.ZP.Store) {
    initialize() {
        if (!(!G.iP || __OVERLAY__)) this.waitFor(N.ZP, C.default), g.sr(eD, eL), C.default.addChangeListener(eS), eh(R.v.enabled, R.v.legacyEnabled), E.Z.addInterceptor(ev);
    }
    isInputLocked(e) {
        return !z.has(e);
    }
    ...
    __OVERLAY__
        ...
        : {
              ...
              RPC_SERVER_READY: function (e) {
                  ...
                  n.append('build_id', '4d287dd3eac81837fd2dbf077d2138fc716ce12d'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
              },

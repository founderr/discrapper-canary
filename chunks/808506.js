...
function eX(e) {
    ...
    n.append('build_id', '1e20d526d31944f1cfb06867684b1b5583cd7026'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

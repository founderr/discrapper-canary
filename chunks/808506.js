...
function em(e) {
  if (e) {
    ...
    (null == n ? void 0 : n.overlayMethod) === x.gl.OutOfProcess ? eA(e) : setTimeout(() => eA(e), 200)
  } else eA(e)
}
let eO = null;
...
class eD extends(o = d.ZP.Store) {
  initialize() {
    if (!(!x.iP || __OVERLAY__)) this.waitFor(p.ZP, v.default), m.sr(eL, ev), v.default.addChangeListener(eN), eT(R.v.enabled, R.v.legacyEnabled), E.Z.addInterceptor(eg)
  }
  isInputLocked(e) {
    return !z.has(e)
  }
...
let eM = new eD(E.Z, __OVERLAY__ ? {
  ...
  RPC_SERVER_READY: function(e) {
    ...
    n.append("build_id", "a9808c1077fe98fed6f09fe8ac4da35ad5661eb6"), n.append("rpc", String(t)), n.append("rpc_auth_token", K), i = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
  },

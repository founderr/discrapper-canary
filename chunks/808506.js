...
function e0(e) {
    ...
    r.append('build_id', '02dd1fe6f21ed8c2a0e3664891493ac03048cb18'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

...
function eX(e) {
    ...
    n.append('build_id', 'a17bd915cd0f8aaf0e421175599898e7973d769f'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

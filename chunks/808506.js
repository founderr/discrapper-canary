...
function e0(e) {
    ...
    r.append('build_id', 'b7aba8a4d833d138f648a6effc14cfa05c11c114'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

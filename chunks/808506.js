...
function eY(e) {
    ...
    r.append('build_id', '15264a065f9ccb86420edc7321cce63bafed43a2'), r.append('rpc', String(n)), r.append('rpc_auth_token', ef), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function eW(e) {

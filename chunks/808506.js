...
function en(e, t) {
  ...
  if ((null === n || i === n) && i !== t) {
    ...
    Z.delete(e), J.info("pid=".concat(e, " status transition ").concat(null != i ? i : "DISCONNECTED", " -> ").concat(null != t ? t : "DISCONNECTED"), V), x !== (x = Array.from(V.values()).some(e => "READY" === e)) && b.default.setBackgroundThrottling(!x)
  }
}
async function ei(e) {
...
let eT = et("setOverlayEnabled", async (e, t) => {
  ...
  H = e, Y = t, C.OverlayStoredSettings.update({
    enabled: e,
    legacyEnabled: t
  }), eM.emitChange();
  let n = await eu(),
...
function eR(e) {
  return !(X || !x || Q.has(e.type)) && ("USER_SETTINGS_PROTO_UPDATE" === e.type && (e = {
    ...e,
    settings: {
      type: e.settings.type,
      proto: (0, g.protoToB64WithType)(e.settings.type, e.settings.proto)
    }
  }), F.add(e), null == r && (r = setTimeout(eg, 1)), !1)
}

function eg() {
  if (null != r && (clearTimeout(r), r = null), !x) {
    F.clear();
    return
  }
  F.size > 0 && (N.send({
...
function ev(e) {
  switch (0, e.type) {
    case w.OverlayEventTypes.CONNECT:
      ...
      if (null == t) break;
      (0, f.createLayout)(G.OVERLAY_LAYOUT_ID, D.default.getDefaultLayout(G.OVERLAY_LAYOUT_ID)), Promise.all([(0, R.default)(t, e.pid), c.default.PersistedStore.getAllStates()]).then(t => {
        let [n, i] = t, {
          pid: r,
          token: s
        } = e;
    ...
    case w.OverlayEventTypes.DISPATCH:
      if (null != e.payloads) {
        var n;
        n = e.payloads, X = !0, n.forEach(e => E.default.dispatch(e)), X = !1
      }
      break;
...
class eD extends(a = c.default.Store) {
  initialize() {
    !(!k.OVERLAY_SUPPORTED || __OVERLAY__) && (this.waitFor(O.default, L.default), N.setReceiveCommandHandler(ev, eL), L.default.addChangeListener(eA), eT(C.OverlayStoredSettings.enabled, C.OverlayStoredSettings.legacyEnabled), E.default.addInterceptor(eR))
  }
  isInputLocked(e) {
    return !Z.has(e)
  }
...
d = "OverlayBridgeStore", (u = "displayName") in(l = eD) ? Object.defineProperty(l, u, {
  value: d,
  enumerable: !0,
  configurable: !0,
  writable: !0
}) : l[u] = d;
let eM = new eD(E.default, __OVERLAY__ ? {
  ...
  OVERLAY_SET_INPUT_LOCKED: function(e) {
    ...
    if (t || "READY" === i || "CRASHED" === i) {
      if (t ? Z.delete(n) : Z.add(n), q.clear(), null != ep && (clearTimeout(ep), ep = null, t)) return;
  ...
  RPC_SERVER_READY: function(e) {
    ...
    n.append("build_id", "f2ab599173ac12dc9cb95130b46bf2b42a0f2e1f"), n.append("rpc", String(t)), n.append("rpc_auth_token", z), i = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(n.toString())
  },
  ...
  OVERLAY_SET_ASSOCIATED_GAME: function(e) {
    ...
    null != i && (V.delete(e.previousAssociatedGamePID), V.set(e.associatedGamePID, i)), Z.delete(e.previousAssociatedGamePID), K = e.associatedGamePID
  },

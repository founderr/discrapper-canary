...
function eX(e) {
    ...
    n.append('build_id', '06c377844f57c941efcca268321f506a24c0ab41'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
function eX(e) {
    ...
    n.append('build_id', '18a409a9570151471101ad41c7ba4184b2d5a54b'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

...
function e0(e) {
    ...
    r.append('build_id', '19c3671349532d56f4853a18c0f6a121b543072d'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

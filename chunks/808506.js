...
function eX(e) {
    ...
    n.append('build_id', '7264ebaf82f1d55725af102aa58e88580670f463'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

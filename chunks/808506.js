...
function eX(e) {
    ...
    n.append('build_id', '59666de10820b681cf2193f4a4cf9b4c1e186b76'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

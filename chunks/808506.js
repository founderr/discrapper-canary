...
function eS(e) {
    if (e) {
        ...
        (null == n ? void 0 : n.overlayMethod) === B.gl.OutOfProcess ? eb(e) : setTimeout(() => eb(e), 200);
    } else eb(e);
}
let ey = null;
function eA(e, t, n) {
...
class eL extends (s = f.ZP.Store) {
    initialize() {
        if (!(!B.iP || __OVERLAY__)) this.waitFor(S.ZP, R.default, N.Z), T.sr(eD, eO), R.default.addChangeListener(eT), em(y.v.enabled, y.v.legacyEnabled, y.v.global), _.Z.addInterceptor(eC);
    }
    isInputLocked(e) {
    ...
    __OVERLAY__
        ...
        : {
              ...
              RPC_SERVER_READY: function (e) {
                  ...
                  n.append('build_id', '334253fe34fb2705ad0b1feb07ab7bce6f8ce1c0'), n.append('rpc', String(t)), n.append('rpc_auth_token', z), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
              },

...
class eD extends (s = _.ZP.Store) {
    initialize() {
        if (!(!G.iP || __OVERLAY__)) this.waitFor(N.ZP, C.default), g.sr(ey, eL), C.default.addChangeListener(eS), eh(R.v.enabled, R.v.legacyEnabled), E.Z.addInterceptor(ev);
    }
    isInputLocked(e) {
        return !z.has(e);
    }
    ...
    __OVERLAY__
        ...
        : {
              ...
              RPC_SERVER_READY: function (e) {
                  ...
                  n.append('build_id', 'f7d770516782b2c7652db907b51b0d89c8196aab'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
              },

...
function e0(e) {
    ...
    r.append('build_id', '933915fa3adb179594283da5526f5af13bbd4ed3'), r.append('rpc', String(n)), r.append('rpc_auth_token', ec), (i = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(r.toString()));
}
function e1(e) {

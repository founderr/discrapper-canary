...
n.append('build_id', '6eb0bd5001165001a6d7bce1eab378e347b45835'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },

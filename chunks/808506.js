...
function eX(e) {
    ...
    n.append('build_id', '9ff7ca40e54cb620224d698dcacbd19eea2013fc'), n.append('rpc', String(t)), n.append('rpc_auth_token', el), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
}
function e$(e) {

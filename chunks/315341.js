...
let g = [{
  ...
  run(e) {
    ...
    for (let t in d) {
      ...
      null != i && (a = !0, (0, E.i7)(e, null !== (n = i.guild_id) && void 0 !== n ? n : "0", i.id, e => {
  ...
  run(e) {
    let t = !1;
    return (!0 === r.K.get("HAS_SEEN_HUB_UPSELL") || c.qc.hasHiddenHotspot(c.v6.HUB_SECOND_EMAIL_CONNECTION_UPSELL)) && (t = I(e, s.z.HUB_WAITLIST_UPSELL)), t
  },
  cleanup() {
  ...
  version: 9,
  run: e => (c.qc.hasHiddenHotspot(c.v6.MULTI_ACCOUNT_TOOLTIP) && r.K.set(_.Ip, "true"), m(e, c.v6.MULTI_ACCOUNT_TOOLTIP, s.z.ACCOUNT_MULTIACCOUNT_TOOLTIP)),
  cleanup() {}
}, {
  version: 10,
  run(e) {
    ...
    let n = m(e, c.v6.HUB_LINK_CHANNEL_NOTICE, s.z.CHANNEL_NOTICE_HUBLINK),
      i = null !== (t = r.K.get("channelNotices")) && void 0 !== t ? t : {};
  ...
  run(e) {
    let t = !1;
    return r.K.get("hideNag") && I(e, s.z.NAGBAR_NOTICE_DOWNLOAD) && (t = !0), r.K.get("hideConnectSpotify") && I(e, s.z.NAGBAR_NOTICE_CONNECT_SPOTIFY) && (t = !0), r.K.get("hideConnectPlayStation") && I(e, s.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION) && (t = !0), r.K.get("hideMFASMSNotice") && I(e, s.z.NAGBAR_NOTICE_MFA_SMS_BACKUP) && (t = !0), t
  },
  cleanup() {
  ...
  run(e) {
    let t = !1;
    return r.K.get("hidePremiumPromo") && I(e, s.z.NAGBAR_NOTICE_PREMIUM_PROMO) && (t = !0), r.K.get("hidePremiumTier2TrialEnding") && I(e, s.z.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING) && (t = !0), r.K.get("hidePremiumReactivateNotice") && I(e, s.z.NAGBAR_NOTICE_PREMIUM_REACTIVATE) && (t = !0), m(e, c.v6.INVITE_SPLASH_GUILD_HEADER_TOOLTIP, s.z.GUILD_HEADER_INVITE_SPLASH) && (t = !0), t
  },
  cleanup() {
  ...
  run(e) {
    var t;
    let n = !1;
    return null !== (t = r.K.get("forumHelperCardStorageKey")) && void 0 !== t && t && (n = I(e, s.z.FORUM_CHANNEL_HELPER_CARD)), n
  },
  cleanup() {

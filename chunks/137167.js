...
function p(e) {
  let {
    ...
    onClose: I,
    onSave: M
  } = e, A = (0, f.jp)(), [w, N] = l.useState(A), [Z, j] = l.useState(""), L = u.Uc.useSetting(), [U, D] = l.useState(null == L || L), y = u.xd.useSetting(), [O, G] = l.useState(y), [B, k] = l.useState(!1), [P, F] = l.useState(!1), H = (0, g._n)(), z = (0, T.Z)(null == H ? void 0 : H.channelId), $ = null != H, K = l.useMemo(() => L !== U || !(0, s.isEqual)(A, w) || y !== O, [L, U, A, w, y, O]), Q = null != M, W = l.useMemo(() => U || Object.keys(w[E.aC.USER]).length > 0 || Object.keys(w[E.aC.GUILD]).length > 0, [U, w]), q = !W && $ || !W && Q || !K && !Q, V = l.useMemo(() => "@" === Z.trim().charAt(0), [Z]), Y = (0, r.Wu)([h.Z], () => h.Z.getGuildIds()), J = (0, f.Kw)(Y), X = l.useMemo(() => J.map(e => e.id), [J]), [ee, et] = (0, f.BT)(V, function(e) {
    var t;

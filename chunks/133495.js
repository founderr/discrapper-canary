...
e.exports = function e(t, n, a) {
    ...
    var o, s, l, u = n.readable || !1 !== n.readable && t.readable, c = n.writable || !1 !== n.writable && t.writable, d = function () {
            !t.writable && E();
        }, _ = t._writableState && t._writableState.finished, E = function () {
            c = !1, _ = !0, !u && a.call(t);
        }, f = t._readableState && t._readableState.endEmitted, h = function () {
            u = !1, f = !0, !c && a.call(t);
        }, p = function (e) {
            a.call(t, e);
        }, m = function () {
    ...
    return t.on('end', h), t.on('finish', E), !1 !== n.error && t.on('error', p), t.on('close', m), function () {

...
className: u,
...f
  } = e, h = i.useRef(null), p = i.useRef(null), I = i.useRef({
width: 0,
height: 0
  }), m = i.useRef({
streamId: t,
...
if (null != e) {
  ...
  t.style.display = 'block', t.style.width = '100%', t.style.height = '100%', t.autoplay = !0, t.muted = !0, t.addEventListener('pause', function() {
    ...
    let {
      width: s,
      height: o
    } = I.current, l = null !== (n = null === (e = p.current) || void 0 === e ? void 0 : e.videoWidth) && void 0 !== n ? n : 0, u = null !== (r = null === (t = p.current) || void 0 === t ? void 0 : t.videoHeight) && void 0 !== r ? r : 0;
    if (s !== l || o !== u) {
      let e = {
        width: l,
        height: u
  ...
  }), c.info('create video element for '.concat(m.current.streamId, ', readyState=').concat(t.readyState)), t.readyState > 3 && c.error('video element for '.concat(m.current.streamId, ' was ready before attached')), e.appendChild(t), p.current = t;
}
  }, []), i.useEffect(() => {

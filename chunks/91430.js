            ...
            (0, n.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, n.jsxs)('div', {
                        ...
                        children: [
                            (0, n.jsx)('div', { className: r()(j.guildBoostingWordmark, { [j.canceled]: E }) }),
                            (0, n.jsx)('div', {
                                children: (0, R.bt)({
                                    subscription: s,
                                    renewalInvoicePreview: a,
...
function U() {
    return a.useEffect(() => {
        O.default.track(b.rMx.TOOLTIP_VIEWED, { type: 'subscription_settings_missing_payment_method' });
    }, []), (0, n.jsxs)('div', {
...
function G() {
    return a.useEffect(() => {
        O.default.track(b.rMx.TOOLTIP_VIEWED, { type: 'subscription_settings_invalid_payment_method' });
    }, []), (0, n.jsxs)('div', {
        className: j.paymentBanner,
        children: [
            (0, n.jsx)(u.CircleExclamationPointIcon, {
...
function F(e) {
    let {
            ...
            subscription: s,
            openInvoiceId: i
        } = e, {analyticsLocations: r} = (0, S.ZP)(I.Z.PAST_DUE_ONE_TIME_PAYMENT_METHOD_BANNER);
    return a.useEffect(() => {
        O.default.track(b.rMx.TOOLTIP_VIEWED, { type: 'subscription_settings_invalid_payment_method' });
    }, []), (0, n.jsxs)('div', {
        className: j.paymentBanner,
...
function y(e) {
    ...
    return (0, n.jsxs)('div', {
        ...
        children: [
            ...
            (0, n.jsx)('div', { children: R.ZP.getBillingInformationString(t, s) })
        ]
    });
}
function V(e) {
...
function Y(e) {
    let {
        ...
        } = e, {analyticsLocations: E} = (0, S.ZP)(I.Z.SUBSCRIPTION_DETAILS), T = null != d ? {} : {
            subscriptionId: t.id,
            renewal: !0,
                            ...
                            t.isPurchasedExternally || (null == a ? void 0 : a.id) === t.paymentSourceId ? (0, n.jsxs)('div', {
                                ...
                                children: [
                                    (0, n.jsx)(u.FormTitle, {
                                        tag: 'h3',
                                        className: j.detailBlockHeader,
                                        children: t.isPurchasedExternally && null != t.paymentGateway ? v.Z.Messages.BILLING_MANAGED_BY_PAYMENT_GATEWAY.format({ paymentGatewayName: b.Vzj[t.paymentGateway] }) : v.Z.Messages.BILLING_PAY_FOR_IT_WITH
                                    }),
                                    (0, n.jsx)(L.Z, {
                                        subscription: t,
...
function k() {
    return a.useEffect(() => {
        O.default.track(b.rMx.TOOLTIP_VIEWED, { type: 'subscription_settings_duplicate_subscriptions' });
    }, []), (0, n.jsxs)('div', {
        ...
        children: [
            ...
            (0, n.jsx)(u.Text, {
                ...
                variant: 'text-sm/normal',
                children: v.Z.Messages.DUPLICATE_SUBSCRIPTIONS_BANNER.format({ helpCenterLink: p.Z.getArticleURL(b.BhN.NITRO) })
            })
        ]
    });
}
function H(e) {
    ...
    let {analyticsLocations: T} = (0, S.ZP)(I.Z.SUBSCRIPTION_DETAILS), N = null != i ? i.slice(1) : [], [C] = (0, M.ED)({
            subscriptionId: a.id,
            renewal: !0,

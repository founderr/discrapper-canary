...
function H(e) {
  ...
  } = (0, _.default)(E.default.SUBSCRIPTION_DETAILS), m = null != d ? {} : {
    subscriptionId: t.id,
    renewal: !0,
    analyticsLocations: p,
    analyticsLocation: s
  }, [S] = (0, g.useSubscriptionInvoicePreview)(m);
  S = null != d ? d : S;
  let I = null != c ? {} : {
      subscriptionId: t.id,
      renewal: !0,
...
function K(e) {
  ...
  } = (0, _.default)(E.default.SUBSCRIPTION_DETAILS), S = null != i ? i.slice(1) : [], [I] = (0, g.useSubscriptionInvoicePreview)({
    subscriptionId: n.id,
    renewal: !0,
    analyticsLocations: m,
    analyticsLocation: p

var r, i = n(442837), a = n(433517), o = n(780384), s = n(570140), l = n(695346), u = n(581883), c = n(12647), d = n(981631), _ = n(959517);
function E(e, t, n) {
...
E(m, 'displayName', 'AccessibilityStore'), E(m, 'persistKey', 'AccessibilityStore'), E(m, 'migrations', [
    () => {
        let e = 'a11yFontScale', t = 'a11yZoom', n = 'a11yColorblindMode', r = a.K.get(e) || 100, i = a.K.get(t) || d.yqN.ZOOM_DEFAULT, o = a.K.get(n) || !1;
...
let I = new m(s.Z, {
    ...
    ACCESSIBILITY_RESET_TO_DEFAULT: function () {
        let e = h.fontSize !== d.yqN.FONT_SIZE_DEFAULT, t = h.zoom !== d.yqN.ZOOM_DEFAULT;
        if (!e && !t)
            return !1;

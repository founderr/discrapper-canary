...
var t = n(735250), a = n(470079), i = n(442837), r = n(481060), s = n(91176), u = n(749210), d = n(58540), o = n(251794), c = n(386696), E = n(71619), M = n(910693), Z = n(592125), I = n(271383), g = n(430824), m = n(496675), _ = n(594174), C = n(979651), f = n(630388), R = n(5192), v = n(813872), N = n(981631), O = n(590433), S = n(372897), P = n(689938);
function A(e, l, A, h) {
    let U = a.useMemo(() => ({ [l]: [e.id] }), [
            l,
            e.id
        ]), T = null != h ? [h] : [];
    (0, d.$)(U), (0, i.e7)([m.Z], () => m.Z.getGuildVersion(l), [l]);
    let b = (0, i.e7)([g.Z], () => g.Z.getGuild(l), [l]), L = (0, i.e7)([_.default], () => {
            var l;
            return (null === (l = _.default.getCurrentUser()) || void 0 === l ? void 0 : l.id) === e.id;
        }, [e.id]), x = (0, i.e7)([I.ZP], () => I.ZP.isGuestOrLurker(l, e.id), [
            l,
            e.id
        ]), j = (0, i.e7)([Z.Z], () => Z.Z.getChannel(A), [A]), [, p] = (0, E.ZP)(e.id, l), D = null == j ? void 0 : j.isGuildStageVoice(), {
            muted: B,
            deafened: G,
            suppressed: q,
            voiceChannelId: y
        ...
        }), V = (0, i.e7)([I.ZP], () => I.ZP.getMember(l, e.id)), k = (0, v.Z)({
            userId: e.id,
            guildId: l,
            channelId: A,
            location: h
            ...
            location: h,
            targetUserId: e.id
        }), K = (0, c.Z)(l, e.id), w = null != y && null != A && m.Z.canWithPartialContext(N.Plq.VIEW_CHANNEL, { channelId: y }) && !x ? [
            (!D || D && !q) && m.Z.canWithPartialContext(N.Plq.MUTE_MEMBERS, { channelId: A }) ? (0, t.jsx)(r.MenuCheckboxItem, {
                id: 'voice-mute',
            ...
            (!D || D && !q) && m.Z.canWithPartialContext(N.Plq.DEAFEN_MEMBERS, { channelId: A }) ? (0, t.jsx)(r.MenuCheckboxItem, {
                id: 'voice-deafen',
            ...
            !L && null != b && m.Z.canWithPartialContext(N.Plq.MOVE_MEMBERS, { channelId: A }) ? (0, t.jsx)(r.MenuItem, {
                id: 'voice-disconnect',
        ...
        }, H = null, W = null != b && m.Z.canManageUser(N.Plq.MODERATE_MEMBERS, e, b) && m.Z.canManageUser(N.Plq.KICK_MEMBERS, e, b) && m.Z.canManageUser(N.Plq.BAN_MEMBERS, e, b), z = null != b && (m.Z.canManageUser(N.Plq.MANAGE_GUILD, e, b) || m.Z.canManageUser(N.Plq.MANAGE_ROLES, e, b));
    if (!L && null != b && null != V && null != V.joinedAt && (W || z) && b.hasFeature(N.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
        var Q;
        H = (0, f.yE)(null !== (Q = V.flags) && void 0 !== Q ? Q : 0, S.q.BYPASSES_VERIFICATION) ? (0, t.jsx)(r.MenuItem, {
            id: 'verify',
    ...
    return [
        ...
        ...L || null == b ? [] : [
            ...
            }, 'removetimeout') : (0, t.jsx)(r.MenuItem, {
                id: 'timeout',
            ...
            m.Z.canManageUser(N.Plq.KICK_MEMBERS, e, b) && !e.isClyde() ? (0, t.jsx)(r.MenuItem, {
                id: 'kick',
            ...
            m.Z.canManageUser(N.Plq.BAN_MEMBERS, e, b) ? (0, t.jsx)(r.MenuItem, {
                id: 'ban',

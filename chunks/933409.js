...
x = (0, i.e7)([I.ZP], () => I.ZP.isGuestOrLurker(l, e.id), [
  l,
  e.id
]),
...
w = null != y && null != A && m.Z.canWithPartialContext(N.Plq.VIEW_CHANNEL, {
  ...
  (!D || D && !q) && m.Z.canWithPartialContext(N.Plq.MUTE_MEMBERS, {
    channelId: A
  ...
  (!D || D && !q) && m.Z.canWithPartialContext(N.Plq.DEAFEN_MEMBERS, {
    channelId: A
  }) ? (0, t.jsx)(r.MenuCheckboxItem, {
    id: 'voice-deafen',
  ...
  !L && null != b && m.Z.canWithPartialContext(N.Plq.MOVE_MEMBERS, {
    channelId: A
  }) ? (0, t.jsx)(r.MenuItem, {
    id: 'voice-disconnect',

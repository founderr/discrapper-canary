...
function A(e, l, A, h) {
  ...
  let b = (0, i.e7)([g.Z], () => g.Z.getGuild(l), [l]),
    ...
    K = (0, c.Z)(l, e.id),
    w = null != y && null != A && m.Z.canWithPartialContext(N.Plq.VIEW_CHANNEL, {
      channelId: y
    }) && !x ? [(!D || D && !q) && m.Z.canWithPartialContext(N.Plq.MUTE_MEMBERS, {
      channelId: A
    }) ? (0, t.jsx)(r.MenuCheckboxItem, {
      id: "voice-mute",
    ...
    }, "voice-mute") : null, (!D || D && !q) && m.Z.canWithPartialContext(N.Plq.DEAFEN_MEMBERS, {
      channelId: A
    }) ? (0, t.jsx)(r.MenuCheckboxItem, {
      id: "voice-deafen",
    ...
    }, "voice-deafen") : null, !L && null != b && m.Z.canWithPartialContext(N.Plq.MOVE_MEMBERS, {
      channelId: A
    }) ? (0, t.jsx)(r.MenuItem, {
      id: "voice-disconnect",
    ...
    Y = async (l, n, t) => {
      if (l.ctrlKey || l.metaKey) try {
        var a;
        await s.Z.setCommunicationDisabledDuration(n, t, O.UK.DURATION_60_SEC, null, h), F(M.jQ.TIMEOUT), (0, r.showToast)((0, r.createToast)(P.Z.Messages.GUILD_COMMUNICATION_DISABLED_SUCCESS.format({
  ...
  return [...w, ...L || null == b ? [] : [k, H, K && !x ? p ? (0, t.jsx)(r.MenuItem, {
    id: "removetimeout",
    label: P.Z.Messages.ENABLE_GUILD_COMMUNICATION_FOR_USER.format({
      user: e.username
    }),
    color: "danger",
    action: () => {
    ...
    id: "timeout",
    label: P.Z.Messages.DISABLE_GUILD_COMMUNICATION_FOR_USER.format({
      user: e.username
    }),
    color: "danger",
    action: n => {
  ...
  }, "timeout") : null, m.Z.canManageUser(N.Plq.KICK_MEMBERS, e, b) && !e.isClyde() ? (0, t.jsx)(r.MenuItem, {
    id: "kick",
  ...
  }, "kick") : null, m.Z.canManageUser(N.Plq.BAN_MEMBERS, e, b) ? (0, t.jsx)(r.MenuItem, {
    id: "ban",

...
let i = Symbol.for('react-aria.i18n.locale'), a = Symbol.for('react-aria.i18n.strings');
class o {
...
class u {
    ...
    plural(e, t, n = 'cardinal') {
        ...
        let i = this.locale + ':' + n, a = s.get(i);
        return !a && (a = new Intl.PluralRules(this.locale, { type: n }), s.set(i, a)), 'function' == typeof (r = t[a.select(e)] || t.other) ? r() : r;
    }
    number(e) {

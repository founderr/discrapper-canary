...
t.Z = e => {
  let {
    markAsDismissed: t
  } = e, n = (0, i.e7)([l.Z], () => l.Z.useReducedMotion);
  return (0, o.D)() ? (0, s.jsx)(a.ZP, {
    asset: (0, s.jsx)(r.Z, {
      className: d.video,
    ...
    header: u.Z.Messages.SAFETY_CONSUMER_EDUCATION_BLOCK_HEADER,
    content: u.Z.Messages.SAFETY_CONSUMER_EDUCATION_BLOCK_CONTENT,

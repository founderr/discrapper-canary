...
requestCooldownDuration: function(e) {
  ...
  let i = 1440,
    ...
    c = e => Math.round(o / e);
  return t = o >= 43200 ? a.Z.Messages.DURATION_MONTHS.format({
    months: c(l)
  }) : o >= r ? a.Z.Messages.DURATION_WEEKS.format({
    weeks: c(r)
  }) : o >= i ? a.Z.Messages.DURATION_DAYS.format({
    days: c(i)
  }) : o >= 60 ? a.Z.Messages.DURATION_HOURS.format({
    hours: c(60)
  }) : a.Z.Messages.DURATION_MINUTES.format({
    minutes: o
  });

...
function p(e) {
    let { email: t, phoneToken: n, username: i, globalName: f, consent: p, password: _, guildTemplateCode: x, birthday: E, invite: v = null, giftCodeSKUId: I = null, multiStep: b = !1, promoEmailConsent: N = null, usedUsernameSuggestion: C = null } = e;
    return (
        a.Z.dispatch({
            type: 'REGISTER',
            birthday: b ? E : null

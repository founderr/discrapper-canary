...
O = {
  ...
  if ('scroll' === N && (u.isLegacyOpera() ? (m.warn('Scroll strategy is not supported on legacy Opera. Changing to object strategy.'), N = 'object') : u.isIE(9) && (m.warn('Scroll strategy is not supported on IE9. Changing to object strategy.'), N = 'object')), 'scroll' === N)
n = E(O);
  else if ('object' === N)
n = _(O);
  else
  ...
  r(i, function(e) {
    ...
    if (_ && m.log('Attaching listener to element', E, e), !A.isDetectable(e)) {
      if (_ && m.log(E, 'Not detectable.'), A.isBusy(e)) {
        _ && m.log(E, 'System busy making it detectable'), o(u, e, a), R[E] = R[E] || [], R[E].push(function() {
          ++l === i.length && c();
        });
        return;
      }
      return _ && m.log(E, 'Making detectable...'), A.markBusy(e, !0), n.makeDetectable({
        debug: _,
        important: v
      }, e, function(e) {
        if (_ && m.log(E, 'onElementDetectable'), d.getState(e)) {
          ...
          _ && m.log(E, 'Element uninstalled before being detectable.');

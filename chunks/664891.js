...
eo = a.useMemo(() => (0, b.V7)({
  ...
  t = V || el ? L.Z.Messages.BILLING_PURCHASE_DETAILS_HEADER : (0, b.PV)(O) ? (0, b.W_)(r, et) : L.Z.Messages.BILLING_SELECT_PLAN_GUILD_SUBSCRIPTION.format({
planName: et.name
  });
  let ec = null;
...
analyticsLocations: p
  } = (0, I.ZP)(), x = (0, b.al)(n, t.id, 1, new Set(s)), [S, T] = (0, P.ED)({
subscriptionId: n.id,
items: x,
renewal: !1,
applyEntitlements: !0,
...
return (0, i.jsx)(c.FormErrorBlock, {
  children: v.message
});
  let y = (0, N.Kp)({
  isTrial: !1,
...
o,
v
  ]), null != v) ? (0, i.jsx)(c.FormErrorBlock, {
children: v.message
  }) : (null != g && (r = {
amount: g.total,
currency: g.currency,

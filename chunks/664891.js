...
function D(e) {
    ...
    let s, {
        ...
        } = (0, N.usePaymentContext)(), {isGift: ee} = (0, p.wD)(), en = I.paymentSourceId, es = (0, c.e7)([P.Z], () => P.Z.get(j));
    r()(null != es, 'Missing newPlan');
    let el = (0, c.e7)([S.Z], () => S.Z.hidePersonalInformation), et = a.M.EEA_COUNTRIES.has(h.Z.ipCountryCodeWithFallback), ei = z === T.A.PURCHASING || z === T.A.COMPLETED, er = (0, x.Kp)({
            isTrial: !1,
            isGift: ee,
            selectedSkuId: J,
            startedPaymentFlowWithPaymentSources: $.current
        }), ea = (null == i ? void 0 : i.status) === L.O0b.PAUSED, ec = t.useMemo(() => (0, f.V7)({
            skuId: J,
            isPremium: Q,
            multiMonthPlans: [],
    ...
    s = V || ea ? y.Z.Messages.BILLING_PURCHASE_DETAILS_HEADER : (0, f.PV)(j) ? (0, f.W_)(i, es) : y.Z.Messages.BILLING_SELECT_PLAN_GUILD_SUBSCRIPTION.format({ planName: es.name });
    let eo = null;
...
function U(e) {
    let {
        ...
        } = (0, N.usePaymentContext)(), {isGift: _} = (0, p.wD)(), {analyticsLocations: m} = (0, I.ZP)(), T = (0, f.al)(n, s.id, 1, new Set(r)), [S, h] = (0, v.ED)({
            subscriptionId: n.id,
            items: T,
            renewal: !1,
            applyEntitlements: !0,
    ...
    if (null == S || null == P || O)
        return (0, l.jsx)(o.Spinner, { className: b.__invalid_spinner });
    ...
    return (0, l.jsxs)(l.Fragment, {
        children: [
            ...
            (0, l.jsxs)(g.PO, {
                className: b.invoice,
                children: [
                    (0, l.jsx)(g.q9, { children: y.Z.Messages.BILLING_SWITCH_PLAN_PURCHASE_DETAILS }),
                    (0, l.jsx)(j.Lu, {
                        invoice: S,
                        newPlan: s,
...
function w(e) {
    ...
    return (0, l.jsxs)('div', {
        ...
        children: [
            (0, l.jsx)('div', {
                className: Z.renewalInvoiceDate,
                children: y.Z.Messages.BILLING_SWITCH_PLAN_CHANGE_DATE.format({ renewalDate: u.subscriptionPeriodStart })
            }),
            (0, l.jsxs)(g.PO, {
                className: b.invoice,
                children: [
                    (0, l.jsx)(g.q9, { children: y.Z.Messages.PREMIUM_SUBSCRIPTION_UPDATES }),
                    (0, l.jsx)(g.R$, {
                        label: n,
                        value: (0, f.PK)(t, r, !0)
                    }),
                    (0, l.jsx)(C.Z, { invoice: u }),
                    (0, l.jsx)(g.KU, {}),
                    (0, l.jsx)(j.nd, {
                        premiumSubscription: s,
                        renewalInvoice: u,

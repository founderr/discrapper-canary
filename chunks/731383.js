var r = n(728804), i = n(505388), a = n(363406), o = Object.prototype.hasOwnProperty, s = {
        brackets: function (e) {
            return e + '[]';
        },
        comma: 'comma',
    ...
    }, l = Array.isArray, u = Array.prototype.push, c = function (e, t) {
        u.apply(e, l(t) ? t : [t]);
    }, d = Date.prototype.toISOString, _ = a.default, E = {
        addQueryPrefix: !1,
        allowDots: !1,
        charset: 'utf-8',
        charsetSentinel: !1,
    ...
    }, f = {}, h = function e(t, n, a, o, s, u, d, _, h, p, m, I, T, g, S, A) {
        ...
        if (void 0 === O)
            return L;
        if ('comma' === a && l(O))
            g && d && (O = i.maybeMap(O, d)), v = [{ value: O.length > 0 ? O.join(',') || null : void 0 }];
        else if (l(_))
            v = _;
        else {
            var b = Object.keys(O);
        ...
        for (var M = o && l(O) && 1 === O.length ? n + '[]' : n, P = 0; P < v.length; ++P) {
            var U = v[P], w = 'object' == typeof U && void 0 !== U.value ? U.value : O[U];
            if (!u || null !== w) {
                var x = l(O) ? 'function' == typeof a ? a(M, U) : M : M + (p ? '.' + U : '[' + U + ']');
                A.set(t, C);
                var G = r();
                G.set(f, A), c(L, e(w, x, a, o, s, u, 'comma' === a && g && l(O) ? null : d, _, h, p, m, I, T, g, S, G));
            }
        }
        return L;
    }, p = function (e) {
        ...
        var r = a.formatters[n], i = E.filter;
...
e.exports = function (e, t) {
    ...
    for (var f = r(), m = 0; m < n.length; ++m) {
        var I = n[m];
        if (!u.skipNulls || null !== o[I])
            c(d, h(o[I], I, _, E, u.strictNullHandling, u.skipNulls, u.encode ? u.encoder : null, u.filter, u.sort, u.allowDots, u.serializeDate, u.format, u.formatter, u.encodeValuesOnly, u.charset, f));
    }
    var T = d.join(u.delimiter), g = !0 === u.addQueryPrefix ? '?' : '';

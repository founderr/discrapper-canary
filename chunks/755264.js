...
let h = [
    ...
    },
    {
        ...
        run(e) {
            ...
            let {state: n} = a.ZP.PersistedStore.migrateAndReadStoreState('StickersPersistedStore', [
    ...
    },
    {
        version: 4,
        run(e) {
            let {state: t} = a.ZP.PersistedStore.migrateAndReadStoreState('EmojiStore', [() => ({ usageHistory: l.K.get('EmojiUsageHistory') || {} })]);
            if (null == t)
                return !1;
            let n = !1;
    ...
    },
    {
        ...
        run(e) {
            ...
            let n = r.wK.toBinary(e.favoriteGifs).length, i = 0;
            for (let {
                        url: s,
                        favorite: a
                    } of t) {

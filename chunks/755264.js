...
let h = [{
  ...
  run(e) {
    ...
    if (null == n) return !1;
    let a = !1;
    return n.favorites.length > 0 && (e.favoriteStickers = l.FavoriteStickers.create(), e.favoriteStickers.stickerIds = s().uniq(n.favorites).slice(0, d.MAX_FAVORITES), a = !0), s().size(n.usageHistory) > 0 && (e.stickerFrecency = l.StickerFrecency.create(), e.stickerFrecency.stickers = (0, u.serializeUsageHistory)(n.usageHistory, 100), a = !0), a
  },
  cleanup() {
  ...
  run(e) {
    ...
    if (null == t) return !1;
    let n = !1;
    return null != t.favorites && t.favorites.length > 0 && (e.favoriteEmojis = l.FavoriteEmojis.create(), e.favoriteEmojis.emojis = s().uniq(t.favorites).slice(0, d.MAX_FAVORITES), n = !0), s().size(t.usageHistory) > 0 && (e.emojiFrecency = l.EmojiFrecency.create(), e.emojiFrecency.emojis = (0, u.serializeUsageHistory)(t.usageHistory, 100), n = !0), n
  },
  cleanup() {
  ...
  run(e) {
    ...
    for (let {
      ...
      !(n + r > d.MAX_FAVORITE_GIFS_SIZE) && (n += r, e.favoriteGifs.gifs[s] = i)
    }
    for (n = l.FavoriteGIFs.toBinary(e.favoriteGifs).length; n > d.MAX_FAVORITE_GIFS_SIZE;) {
      let t = 0;
  ...
  run(e) {
    ...
    if (null == t) return !1;
    let n = !1;
    return s().size(t.usageHistory) > 0 && (e.applicationCommandFrecency = l.ApplicationCommandFrecency.create(), e.applicationCommandFrecency.applicationCommands = (0, u.serializeUsageHistory)(t.usageHistory, 500), n = !0), n
  },
  cleanup() {
  ...
  run(e) {
    ...
    if (null == t) return !1;
    let n = !1;
    return s().size(t.favoriteSounds) > 0 && (e.favoriteSoundboardSounds = l.FavoriteSoundboardSounds.create(), o.default.keys(t.favoriteSounds).forEach(n => {
  ...
  run(e) {
    ...
    return e.guildAndChannelFrecency = l.GuildAndChannelFrecency.create(), e.guildAndChannelFrecency.guildAndChannels = (0, u.serializeUsageHistory)(t, 100), !0
  },
  cleanup() {
    r.Storage.remove(f)
  }

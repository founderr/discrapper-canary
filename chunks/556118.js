...
function Y(e) {
  ...
  }), ef = (0, y.default)(A, _, er), eh = (0, v.default)(m), eC = (0, x.getMessageAriaLabelledBy)(m, P), ep = (0, x.getMessageAriaDescribedBy)(m), em = (0, U.default)(e, ed, !1), eE = a.useCallback(() => (0, g.transitionToGuild)(N, _, A), [N, _, A]), eg = (0, p.useRoleIcon)({
    guildId: N,
...
var q = a.memo(function(e) {
  ...
  let ee = V.MessageTypesWithLazyLoadedReferences.has(N.type) ? N.messageReference : void 0,
    ...
    eb = (0, x.getMessageAriaLabelledBy)(N, Q),
    eP = (0, x.getMessageAriaDescribedBy)(N),
    ...
    eU = null != eH;
  r = N.type === V.MessageTypes.CUSTOM_GIFT ? "" : !eS && eU ? (0, P.default)(e, eL) : (0, U.default)(e, eL, eS);
  let ek = N.id === Q,

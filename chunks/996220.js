...
function c(e) {
  ...
  let {
    ...
    application: c,
    onClose: M
  } = e, A = (0, I.useUID)(), [L, O] = t.useState(null == c ? void 0 : null === (a = c.team) || void 0 === a ? void 0 : a.id), {
    teams: C
  } = (0, i.default)(), m = t.useMemo(() => C.filter(e => e.payout_account_status === S.PayoutAccountStatuses.ACTIVE).map(e => ({
    label: e.name,
    value: e.id
  })), [C]), R = (null == c ? void 0 : null === (s = c.team) || void 0 === s ? void 0 : s.id) !== L, [g, {
    loading: f,
    error: h
  }] = (0, n.default)(d.default.transferApplication), x = async () => {
  ...
  return (0, l.jsxs)(T.ModalRoot, {
    ...
    children: [(0, l.jsxs)(T.ModalHeader, {
      ...
      }), null != h ? (0, l.jsx)(T.FormErrorBlock, {
        children: h.message

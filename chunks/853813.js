...
function O(e) {
  ...
  let j = (0, l.e7)([_.Z], () => _.Z.getHighestRole(M), [M]),
    Z = (0, l.e7)([_.Z], () => !_.Z.isRoleHigher(M, j, v)),
    b = a.useRef(null),
  ...
  if (a.useEffect(() => {
    ...
    }, [O, M.id, null == v ? void 0 : v.id]), a.useEffect(() => {
      if ((null == v ? void 0 : v.id) != null)(0, u.sE)(M.id, v.id)
    }, [M.id, null == v ? void 0 : v.id]), null == v) return null;
  switch (O) {
    case R.ZI.DISPLAY:
      t = (0, s.jsx)(g.ZP, {
        guild: M,

...
var r, i, a, o, s, l, u = n(735250), c = n(470079), d = n(120356), _ = n.n(d), E = n(748780), f = n(215569), h = n(186325), p = n(238456);
function m(e, t, n) {
...
class I extends (a = c.PureComponent) {
    ...
    componentWillEnter(e) {
        let {duration: t} = this.props, {animationProgress: n} = this.state;
        this.setState({ animationState: 0 }), this.props.setHeight(this.state.targetHeight), E.Z.timing(n, {
            toValue: 2,
            duration: t,
            delay: t / 2
        }).start(e);
    ...
    componentWillLeave(e) {
        ...
        this.direction = r(), this.setState({ animationState: 1 }), E.Z.timing(t, {
            toValue: 0,
            duration: n
        }).start(e);
    }
    ...
    render() {
        let {
                ...
                staticClassName: r
            } = this.props, {animationState: i} = this.state;
        return e ? (0, u.jsx)('div', {
            ref: this._measureRef,
            className: _()(p.measurementFill, t, { [_()(p.measurementFillStatic, r)]: 3 === i }),
...
m(I, 'contextType', h.S), m(I, 'defaultProps', { duration: 300 });

...
function em(e) {
  ...
  return (0, t.jsx)(e_, {
    ...
    renderVisual: () => null != a && a.length > 0 || !l && null != i && i.length > 0 ? (0, t.jsxs)("div", {
      ...
      children: [a.map(e => null == e.id ? e.url : y.ZP.getEmojiURL({
        id: e.id,
        ...
        alt: "",
        src: e
      }) : null), l ? null : i.map(e => (0, t.jsx)(R.ZP, {
        disableAnimation: n,
        sticker: e,
        size: 58,
...
function eC(e) {
  ...
  let i = (0, d.e7)([p.Z], () => p.Z.useReducedMotion),
    [l, o] = (0, d.Wu)([Z.Z, P.Z], () => {
      ...
      let n = null,
        t = 0;
      return s.size > 0 && ([n, t] = Array.from(s.entries()).reduce((e, s) => s[1] > e[1] ? s : e)), [P.Z.getGuild(n), t]
    }),
    c = null != l && o > 0,

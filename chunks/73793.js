var r = n(781212), i = n(919499);
n(476400);
var a = n(470079), o = n(699581), s = n(956060), l = n(717588), u = 'unmounted', c = 'exited', d = 'entering', _ = 'entered', E = 'exiting', f = function (e) {
        function t(t, n) {
        ...
        return n.componentDidMount = function () {
            ...
            var n = this, r = this.props.enter, i = this.context ? this.context.isMounting : t, a = this.getTimeouts(), o = i ? a.appear : a.enter;
            if (!t && !r || s.Z.disabled) {
            ...
            this.props.onEnter(e, i), this.safeSetState({ status: d }, function () {
            ...
            this.props.onExit(e), this.safeSetState({ status: E }, function () {
            ...
            if (e === u)
                return null;
            var t = this.props, n = t.children, i = (0, r.Z)(t, ['children']);
            if (delete i.in, delete i.mountOnEnter, delete i.unmountOnExit, delete i.appear, delete i.enter, delete i.exit, delete i.timeout, delete i.addEndListener, delete i.onEnter, delete i.onEntering, delete i.onEntered, delete i.onExit, delete i.onExiting, delete i.onExited, 'function' == typeof n)
                return a.createElement(l.Z.Provider, { value: null }, n(e, i));
            var o = a.Children.only(n);
            return a.createElement(l.Z.Provider, { value: null }, a.cloneElement(o, i));
        }, t;
    }(a.Component);
function h() {
}

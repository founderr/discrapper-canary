var i = n(735250);
n(470079);
var a = n(442837), s = n(654030), r = n(906732), l = n(973616), o = n(789407), c = n(314897), d = n(158776), u = n(981631), _ = n(616922), E = n(778973);
t.Z = e => {
    var t;
    let {
            channel: n,
            message: m,
            hideParty: I
        } = e, {analyticsLocations: T} = (0, r.ZP)(), h = (0, a.e7)([c.default], () => c.default.getId()), N = (0, a.e7)([d.Z], () => {
    ...
    return (0, i.jsx)(s.Z, {
        ...
        userId: m.author.id,
        application: null != (t = m).application ? l.Z.createFromServer(t.application) : null != t.activity && null != t.activity.party_id && (0, _.Ps)(t.activity.party_id) ? o.r9 : void 0,
        message: m,
        channelId: n.id,

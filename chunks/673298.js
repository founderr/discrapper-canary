...
r.inherits(f, l), e.exports = f, f.blockSize = 512, f.outSize = 160, f.hmacStrength = 80, f.padLength = 64, f.prototype._update = function(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var h = ~~(r / 20),
      v = c(s(i, 5), u(h, o, l, f), p, n[r], d[h]);
    p = f, f = l, l = s(o, 30), o = i, i = v
  }
  this.h[0] = a(this.h[0], i), this.h[1] = a(this.h[1], o), this.h[2] = a(this.h[2], l), this.h[3] = a(this.h[3], f), this.h[4] = a(this.h[4], p)

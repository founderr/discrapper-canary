...
var r = n(956067), i = n(930145), a = n(350167), o = n(503461);
function s(e, t, n) {
...
class l {
    ...
    close() {
        var e;
        this.lastState = o.hi.Closed, null === (e = this.raw) || void 0 === e || e.close(), this.raw = null, a.r.removeCompletionCallback(this.databaseStateCallback);
    }
    disable(e) {
    ...
    execute(e, t) {
        ...
        let n = 'key' in e ? e.key[0] : e.table, i = () => a.r.executeAsync(null != t ? t : e.type, t => {
                this.raw.execute(t, {
                    ...e,
                    handle: 0
                });

...
let b = e => {
  ...
  y = e => {
    let {
      guildId: t,
      listingId: n
    } = e, a = (0, L.default)(t), [i] = N.useTierEmojiIds(n, t), l = a.filter(e => i.has(e.id));
  ...
  G = e => {
    let {
      ...
      guildId: n,
      className: a
    } = e, i = (0, v.default)(n, t), [r] = N.useChannelBenefits(t), o = (0, h.default)(r), [d] = N.useIntangibleBenefits(t), c = N.useRole(t, n), [f] = N.useTierEmojiIds(t, n);
...
t.default = e => {
  ...
  } = (0, U.default)(T, i, f, _), O = (0, r.useStateFromStores)([c.default], () => c.default.isSyncing), {
    activeSubscription: M,
    activeSubscriptionListing: b
  } = (0, R.default)(f), y = (null == b ? void 0 : b.id) === n, H = (null == M ? void 0 : M.status) === P.SubscriptionStatusTypes.CANCELED, [w, k] = a.useState(!1), [Q, V] = a.useState(!1), W = a.useCallback(e => {
    let t = !1;
    null != e && (t = e.scrollHeight - e.clientHeight > 1), V(t)
  }, []), [q] = N.useName(n), [Y] = N.useDescription(n), [Z] = N.useTrialInterval(n), [z] = N.useTrialLimit(n), K = (0, g.default)(i, n), J = null != Z && null == M && K, X = (0, o.default)(D.RESPONSIVE_MOBILE_WIDTH_SIZE_QUERY), [$, ee] = a.useState(!1), et = $ || !X, en = (0, r.useStateFromStores)([d.default], () => d.default.isViewingServerShop(i)), es = (null == T ? void 0 : T.published) === !0, ea = (null == T ? void 0 : T.soft_deleted) === !0, ei = j.default.Messages.GUILD_ROLE_SUBSCRIPTION_TIER_SHOW_MORE_DESCRIPTION;
      ...
      children: [(0, s.jsxs)("div", {
        ...
        children: [X ? (0, s.jsx)(x.GuildRoleSubscriptionCollapsibleCardBasicInfo, {
          ...
          children: [X && (0, s.jsx)("div", {
            ...
            text: L ? null : v,
            "aria-label": null !== (t = L && v) && void 0 !== t && t,

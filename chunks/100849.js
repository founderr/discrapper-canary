...
function v(e) {
  let {
    ...
    showActions: s,
    onClose: v
  } = e, x = (0, a.e7)([u.Z], () => null != u.Z.getAnyStreamForUser(n.id)), h = (0, a.e7)([I.Z], () => I.Z.getActivities(n.id)), N = o.useMemo(() => h.filter(e => e.type !== Z.IIU.CUSTOM_STATUS), [h]), g = o.useMemo(() => x ? N.find(e => e.type === Z.IIU.PLAYING) : null, [N, x]), C = o.useMemo(() => N.filter(e => e !== g), [g, N]), {

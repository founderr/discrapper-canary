let r;
n(47120), n(757143);
var i, a = n(442837), o = n(570140), s = n(579806), l = n(358085), u = n(417363), c = n(689938);
function d(e, t, n) {
...
let _ = {}, E = (0, l.isWindows)() ? ''.concat(s.Z.process.env.LOCALAPPDATA, '\\DiscordGames') : (0, l.isMac)() ? '/Applications/DiscordGames' : '/tmp';
function f(e, t) {
    var n;
    _ = {
        ..._,
...
function h(e) {
    ...
    null == r.installations[t] && (r.installations[t] = {}), r.installations[t][n] = { installationPath: i }, !r.installationPaths.has(i) && m({
        path: i,
        metadata: {}
    });
}
...
d(I, 'displayName', 'InstallationManagerStore'), d(I, 'persistKey', 'InstallationManagerStore'), t.Z = new I(o.Z, {
    ...
    INSTALLATION_LOCATION_REMOVE: function (e) {
        ...
        i.delete(n), r.installationPaths = i, t = n, _ = { ..._ }, delete _[t], !function (e) {

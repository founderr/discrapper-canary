...
var o = n(735250);
n(470079);
var l = n(481060), a = n(390885), r = n(626135), s = n(299402), i = n(675999), c = n(981631), u = n(630724);
function _(e, t, n, l) {
    return (0, o.jsx)(s.Z, {
        onSuccess: t => {
        ...
        onSlideChange: e => function (e, t) {
            ...
            case i._m.GUILD_TEMPLATES:
                a.Z.flowStepOrStart(u.MK.CREATE_GUILD, u.X2.GUILD_TEMPLATES), r.default.track(c.rMx.OPEN_MODAL, {
                    type: 'Create Guild Templates',
                    location: t
                });
                break;
            case i._m.CUSTOMIZE_GUILD:
                a.Z.flowStep(u.MK.CREATE_GUILD, u.X2.GUILD_CREATE), r.default.track(c.rMx.OPEN_MODAL, {
            ...
            case i._m.JOIN_GUILD:
                a.Z.flowStep(u.MK.CREATE_GUILD, u.X2.JOIN_GUILD), r.default.track(c.rMx.OPEN_MODAL, {
                    type: 'Join Guild',
                    location: t
                });
            }

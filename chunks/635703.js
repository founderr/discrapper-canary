...
onSlideChange: e => function(e, t) {
  switch (e) {
    case i._m.GUILD_TEMPLATES:
      a.Z.flowStepOrStart(u.MK.CREATE_GUILD, u.X2.GUILD_TEMPLATES), s.default.track(c.rMx.OPEN_MODAL, {
        type: 'Create Guild Templates',
        location: t
      });
      break;
    case i._m.CUSTOMIZE_GUILD:
      a.Z.flowStep(u.MK.CREATE_GUILD, u.X2.GUILD_CREATE), s.default.track(c.rMx.OPEN_MODAL, {
    ...
    case i._m.JOIN_GUILD:
      a.Z.flowStep(u.MK.CREATE_GUILD, u.X2.JOIN_GUILD), s.default.track(c.rMx.OPEN_MODAL, {
        type: 'Join Guild',
        location: t
      });
  }

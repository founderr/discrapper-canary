...
var i = n(735250);
n(470079);
var l = n(120356), r = n.n(l), a = n(442837), s = n(846519), o = n(481060), c = n(475179), u = n(239091), d = n(146773), h = n(888651), p = n(619915), _ = n(339340), f = n(201895), m = n(718589), g = n(933557), C = n(557135), I = n(873696), E = n(446226), N = n(305325), x = n(281956), S = n(66999), v = n(554747), Z = n(506936), T = n(574176), L = n(359110), A = n(557494), b = n(695346), M = n(592125), R = n(430824), O = n(607744), y = n(496675), P = n(306680), j = n(9156), D = n(979651), U = n(934415), G = n(98597), w = n(648501), k = n(473403), B = n(830993), V = n(653577), H = n(207055), F = n(981631), W = n(647086), Y = n(689938), z = n(704672);
function K(e, t, n) {
...
class q extends G.ZP {
    ...
    renderSubtitle() {
        ...
        let {
                ...
                enableHangStatus: l,
                allowChannelTopic: r
            } = this.props, a = null === (e = (0, I.D)(this.props.subtitle)) || void 0 === e ? void 0 : e.subtitle, {hovered: s} = this.state;
        return (0, i.jsx)(V.Z, {
    ...
    render() {
        let {
            ...
            } = this.state, b = this.getVoiceStatesCount(), M = (0, i.jsxs)('li', {
                className: r()(this.getModeClass(), { [z.disabled]: this.isDisabled() }),
    ...
    constructor(...e) {
        super(...e), K(this, 'state', {
            ...
            hovered: !1
        }), K(this, 'activitiesHideTimeout', new s.V7()), K(this, 'closeGuildVerificationPopout', () => {
            ...
            i && this.setState({ shouldShowGuildVerificationPopout: !0 }), C.Z.handleVoiceConnect({
                channel: n,
                connected: t,
                needSubscriptionToAccess: l,
                locked: e
            ...
            let {channel: t} = this.props, l = R.Z.getGuild(t.getGuildId());
                ...
                return (0, i.jsx)(o.Tooltip, {
                    ...
                    children: t => {
                        ...
                        return (0, i.jsx)(o.Clickable, {
                            className: r()(z.iconItem, n ? z.alwaysShown : null),
                            onClick: () => {
...
function J(e) {
    let {
            ...
            let e = M.Z.getChannel(n.parent_id), i = O.Z.getCheck(n.guild_id);
            return {

...
class q extends G.ZP {
  ...
  renderSubtitle() {
    ...
    let {
      ...
      enableHangStatus: l,
      allowChannelTopic: r
    } = this.props, a = null === (e = (0, I.D)(this.props.subtitle)) || void 0 === e ? void 0 : e.subtitle, {
      hovered: s
    } = this.state;
    return (0, i.jsx)(V.Z, {
  ...
  constructor(...e) {
    super(...e), K(this, "state", {
      ...
      let {
        channel: t
      } = this.props, l = R.Z.getGuild(t.getGuildId());

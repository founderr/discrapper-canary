...
var n = a(735250), l = a(470079), i = a(990547), r = a(481060), o = a(240872), s = a(579806), u = a(100527), d = a(906732), c = a(39604), m = a(212039), p = a(259612), v = a(572720), f = a(362693), b = a(674908), h = a(20437), x = a(689938), g = a(162989);
function C(e) {
    var t, a, C, _, j, S, I, E;
    let {
            clip: T,
            ...
            transitionState: w,
            onClose: N
        } = e, [L, k] = l.useState(!0), [R, M] = l.useState(null), [P, Z] = l.useState(null), {analyticsLocations: A} = (0, d.ZP)(u.Z.CLIPS_EDITOR);
    l.useEffect(() => {
        (async function e() {
            let e;
            try {
            ...
            let t = e.data.buffer, a = await (0, m.w)(t), n = URL.createObjectURL(new Blob([a], { type: 'audio/mp4' })), l = URL.createObjectURL(new Blob([e.data], { type: 'video/mp4' }));
            Z(n), M(l);
        }());
    }, [
        T.filepath,
    ...
    l.useEffect(() => {
        async function e() {
            let e = {};
            null != G && (e = { thumbnail: await (0, p.R)(G, V.current.editMetadata.start) }), (0, c.Tm)(T.id, {
                ...V.current,
                ...e
            });
        }
    ...
    let K = l.useRef(null), Y = l.useMemo(() => ({
            videoPlayerRef: K,

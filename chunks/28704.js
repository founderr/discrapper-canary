! function(e, t) {
  ...
  function u(e, t, n, i) {
    for (var a = 0, o = 0, s = Math.min(e.length, n), u = t; u < s; u++) {
      var c = e.charCodeAt(u) - 48;
      a *= i, o = c >= 49 ? c - 49 + 10 : c >= 17 ? c - 17 + 10 : c, r(c >= 0 && o < i, "Invalid character"), a += o
    }
    return a
  }
  ...
  a.prototype.toString = function(e, t) {
    if (t = 0 | t || 1, 16 === (e = e || 10) || "hex" === e) {
      ...
      for (var n, i = 0, a = 0, o = 0; o < this.length; o++) {
        ...
        a = s >>> 24 - i & 16777215, (i += 2) >= 26 && (i -= 26, o--), n = 0 !== a || o !== this.length - 1 ? f[6 - u.length] + u + n : u + n
      }
    ...
    if (e === (0 | e) && e >= 2 && e <= 36) {
      ...
      for (d.negative = 0; !d.isZero();) {
        ...
        n = (d = d.idivn(l)).isZero() ? m + n : f[c - m.length] + m + n
      }
  ...
  a.prototype.toArrayLike = function(e, t, n) {
    ...
    var u = (i = e, a = s, i.allocUnsafe ? i.allocUnsafe(a) : new i(a));
    return this["_toArrayLike" + ("le" === t ? "LE" : "BE")](u, o), u
  ...
  function v(e, t) {
    this.x = e, this.y = t
  }!Math.imul && (g = m), a.prototype.mulTo = function(e, t) {
    var n, r, i = this.length + e.length;
    if (10 === this.length && 10 === e.length) r = g(this, e, t);
    else if (i < 63) r = m(this, e, t);
    else if (i < 1024) r = _(this, e, t);
    else {
      ;
      n = this, r = _(n, e, t)
    }
    ...
    return r
  }, v.prototype.permute = function(e, t, n, r, i, a) {
    for (var o = 0; o < a; o++) r[o] = t[e[o]], i[o] = n[e[o]]
  }, v.prototype.transform = function(e, t, n, r, i, a) {
    ...
    return e
  }, v.prototype.convert13b = function(e, t, n, i) {
    ...
    return this.conjugate(s, u, r), this.transform(s, u, f, a, r, i), this.conjugate(f, a, r), this.normalize13b(f, r), n.negative = e.negative ^ t.negative, n.length = e.length + t.length, n._strip()
  }, a.prototype.mul = function(e) {
    var t = new a(null);
    return t.words = Array(this.length + e.length), this.mulTo(e, t)
  }, a.prototype.mulf = function(e) {
    var t, n = new a(null);
    return n.words = Array(this.length + e.length), t = this, _(t, e, n)
    ...
    var t = e < 0;
    t && (e = -e), r(e <= 67108863);
    for (var n = 67108864 % e, i = 0, a = this.length - 1; a >= 0; a--) i = (n * i + (0 | this.words[a])) % e;
    return t ? -i : i
  ...
  function D(e) {
    C.call(this, e), this.shift = this.m.bitLength(), this.shift % 26 != 0 && (this.shift += 26 - this.shift % 26), this.r = new a(1).iushln(this.shift), this.r2 = this.imod(this.r.sqr()), this.rinv = this.r._invmp(this.m), this.minv = this.rinv.mul(this.r).isubn(1).div(this.m), this.minv = this.minv.umod(this.r), this.minv = this.r.sub(this.minv)
  }
  E.prototype._tmp = function() {
  ...
  }, i(S, E), S.prototype.split = function(e, t) {
  ...
  }, i(x, E), i(w, E), i(T, E), T.prototype.imulK = function(e) {
    for (var t = 0, n = 0; n < e.length; n++) {
    ...
    return new D(e)
  }, i(D, C), D.prototype.convertTo = function(e) {

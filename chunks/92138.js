...
new p.Z().log('[BUILD INFO] Release Channel: '.concat(T, ', Build Number: ').concat('327234', ', Version Hash: ').concat('7bf6426800df7e2ed2d05599e58a35193c9c80fe')), i.Z.setTags({ appContext: I.e3s }), E.Z.initBasic(), f.Z.init(), c.d.init(), h.S1();

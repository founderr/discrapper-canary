...
new p.Z().log('[BUILD INFO] Release Channel: '.concat(T, ', Build Number: ').concat('322046', ', Version Hash: ').concat('c94bfb1aa1b7761b3dde52a2bfa8d5ddd58f99e9')), i.Z.setTags({ appContext: I.e3s }), E.Z.initBasic(), f.Z.init(), c.d.init(), h.S1();

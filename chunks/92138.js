...
new p.Z().log('[BUILD INFO] Release Channel: '.concat(T, ', Build Number: ').concat('323234', ', Version Hash: ').concat('25f8d58d55fdf3918a2f4edbb969f7c907d15ee3')), i.Z.setTags({ appContext: I.e3s }), E.Z.initBasic(), f.Z.init(), c.d.init(), h.S1();

...
new p.Z().log('[BUILD INFO] Release Channel: '.concat(T, ', Build Number: ').concat('322960', ', Version Hash: ').concat('fd6de3a2bba84a1550da95fc35e90eb6ed5f20b8')), i.Z.setTags({ appContext: I.e3s }), E.Z.initBasic(), f.Z.init(), c.d.init(), h.S1();

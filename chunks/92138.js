...
new h.Z().log('[BUILD INFO] Release Channel: '.concat(I, ', Build Number: ').concat('309567', ', Version Hash: ').concat('2c1de47a73231628c74c6f23483760a11676c660')), r.Z.setTags({
  appContext: p.e3s
}), _.Z.initBasic(), E.Z.init(), u.d.init(), f.S1();
...
function g(e) {
  ...
  let {
    onClose: n,
    markAsDismissed: g
  } = e, L = (0, a.useStateFromStores)([E.default], () => E.default.getCurrentUser());
  let v = (t = null == L ? void 0 : L.premiumType) === C.PremiumTypes.TIER_2 ? N.default.Messages.CALL_SOUNDS_UPSELL_DESCRIPTION_TIER_2 : null == t ? N.default.Messages.CALL_SOUNDS_UPSELL_DESCRIPTION_NON_SUB : N.default.Messages.CALL_SOUNDS_UPSELL_DESCRIPTION_NON_TIER_2,
    h = T.default.canUseCustomCallSounds(L);
  return (0, s.jsxs)(c.default, {
    ...
    children: [null != g ? (0, s.jsx)(u.Clickable, {
      ...
      onClick: function() {
        o.default.open(I.UserSettingsSections.VOICE, m.SOUNDBOARD_SUBSECTION), null == n || n(), null == g || g(S.ContentDismissActionType.PRIMARY)
      },

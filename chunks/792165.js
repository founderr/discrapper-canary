...
function p(e) {
  ...
  let v = (t = null == g ? void 0 : g.premiumType) === m.PremiumTypes.TIER_2 ? N.default.Messages.CALL_SOUNDS_UPSELL_DESCRIPTION_TIER_2 : null == t ? N.default.Messages.CALL_SOUNDS_UPSELL_DESCRIPTION_NON_SUB : N.default.Messages.CALL_SOUNDS_UPSELL_DESCRIPTION_NON_TIER_2,
  ...
  return (0, i.jsxs)(c.default, {
    ...
    children: [null != p ? (0, i.jsx)(u.Clickable, {
      className: R.close,
      onClick: () => null == p ? void 0 : p(S.ContentDismissActionType.DISMISS),
      ...
      onClick: function() {
        o.default.open(I.UserSettingsSections.VOICE, C.SOUNDBOARD_SUBSECTION), null == n || n(), null == p || p(S.ContentDismissActionType.PRIMARY)
      },
      ...
      onSubscribeModalClose: () => null == p ? void 0 : p(S.ContentDismissActionType.PRIMARY)
    })]
  })
}
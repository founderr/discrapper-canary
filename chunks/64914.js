...
function m() {
  let [e] = a.useState(() => E.ZP.getEnableHardwareAcceleration()), s = u.bm.useSetting(), t = u.Sb.useSetting(), m = u.xU.useSetting(), A = (0, i.e7)([d.Z], () => d.Z.testModeApplicationId), g = a.useCallback(e => {

...
var r, i, a = n(278074), o = n(873546), s = n(442837), l = n(34756), u = n(100159), c = n(912788), d = n(594174), _ = n(626135), E = n(823379), f = n(358085), h = n(74538), p = n(226951), m = n(73346), I = n(981631), T = n(474936), g = n(689938);
let S = p.Z.escape(window.GLOBAL_ENV.GIFT_CODE_HOST), A = [
        S,
        ...[
            'discordapp.com/gifts',
            'discord.com/gifts'
        ].map(e => p.Z.escape(e))
    ].join('|'), N = RegExp('(?: |^|https?://)(?:'.concat(A, ')/([a-z0-9-]+)'), 'gi'), v = [...[
            'discord.com/billing/promotions',
            'promos.discord.gg'
        ].map(e => p.Z.escape(e))].join('|'), O = RegExp('(?: |^|https?://)(?:'.concat(v, ')/([a-z0-9-]+)'), 'gi'), R = (e, t) => Array(t).fill(void 0).map(() => '['.concat('abcdefghjkmnpqrstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ23456789', ']{').concat(e, '}')).join('-?'), C = R(4, 4), y = R(4, 6), D = R(5, 3), L = [
        C,
        y,
        D,
        '[a-zA-Z]{4}-?[0-9a-zA-Z]{4}-?[a-zA-Z]{4}'
    ].join('|'), b = new RegExp('^('.concat('WUMP-?', ')?(').concat(L, ')$'));
...
let M = (e, t) => o.tq || o.Em ? 0 : null != e || t ? 2 : 1, P = e => 0 !== M(e);
function U(e) {
...
let G = e => (null == e ? void 0 : e.type) === I.uaV.CUSTOM_GIFT && (null == e ? void 0 : e.embeds.length) === 1 && (null == e ? void 0 : e.embeds[0].type) === I.hBH.GIFT, k = e => {
        let t;
        if (null == e)
            return [];
        let n = new Set();
        for (; null != (t = N.exec(e)) && n.size < 3;)
            n.add(x(t[1]));
        for (; null != (t = O.exec(e)) && n.size < 3;)
            n.add(x(t[1]));
        return Array.from(n);
    };
function B() {
    let e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '', n = window.GLOBAL_ENV.GIFT_CODE_HOST;
...
async function F(e) {
    ...
    try {
        ...
        return _.default.track(I.rMx.GIFT_CODE_RESOLVED, {
            resolved: !0,
            gift_code: r.code,
        ...
        throw _.default.track(I.rMx.GIFT_CODE_RESOLVED, {
            resolved: !1,
            gift_code: e
        }), new l.Z(t);
    }
...
function Y(e, t, n) {
    ...
    case I.wZ8.SUCCESS:
        if (__OVERLAY__)
            return g.Z.Messages.GIFT_CONFIRMATION_BUTTON_NOICE;
        if (t.isSubscription)
            return g.Z.Messages.GIFT_CONFIRMATION_BUTTON_SUBSCRIPTION_SUCCESS;
    ...
    default:
        if (null != n && n)
            return g.Z.Messages.GIFT_CODE_AUTH_ACCEPT;
        if (null != t.giftStyle)
            return t.isClaimed ? g.Z.Messages.GIFT_CONFIRMATION_BUTTON_CONFIRM : g.Z.Messages.GIFT_CONFIRMATION_BUTTON_CONFIRM_MOBILE;
...
function j(e) {
    ...
    case I.wZ8.SUCCESS:
        if (null != u) {
            var c;
            return c = u, (0, a.EQ)(c).with({
                interval: T.rV.MONTH,
                premiumSubscriptionType: T.p9.TIER_2
            }, () => g.Z.Messages.PREMIUM_FEATURES_TIER_2.format({ timeInterval: g.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_MONTH })).with({
                interval: T.rV.YEAR,
                premiumSubscriptionType: T.p9.TIER_2
            }, () => g.Z.Messages.PREMIUM_FEATURES_TIER_2.format({ timeInterval: g.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_YEAR })).with({
                interval: T.rV.MONTH,
                premiumSubscriptionType: T.p9.TIER_1
            }, () => g.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_PREMIUM_TIER_1_MONTHLY.format({ intervalCount: c.intervalCount })).with({
                interval: T.rV.YEAR,
                premiumSubscriptionType: T.p9.TIER_1
            }, () => g.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_PREMIUM_TIER_1_YEARLY.format({ intervalCount: c.intervalCount })).otherwise(() => g.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_GENERIC);
        }
...
function W(e, t, n, r, i) {
    ...
    return null != (n || r ? void 0 : e) ? a : null == t ? null : function (e, t) {
        switch (e.code) {
...
function K(e, t, n) {
    let r = t.applicationId, i = e.length > 0 ? e : [r], a = i.map(e => n.getLibraryApplication(r, e, !0)).filter(E.lm);

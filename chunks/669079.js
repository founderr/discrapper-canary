...
'promos.discord.gg'
  ].map(e => p.Z.escape(e))].join('|'),
  O = RegExp('(?: |^|https?://)(?:'.concat(v, ')/([a-z0-9-]+)'), 'gi'),
  R = (e, t) => Array(t).fill(void 0).map(() => '['.concat('abcdefghjkmnpqrstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ23456789', ']{').concat(e, '}')).join('-?'),
  C = R(4, 4),
  y = R(4, 6),
  D = R(5, 3),
  L = [
...
let G = e => (null == e ? void 0 : e.type) === m.uaV.CUSTOM_GIFT && (null == e ? void 0 : e.embeds.length) === 1 && (null == e ? void 0 : e.embeds[0].type) === m.hBH.GIFT,
  k = e => {
let t;
if (null == e)
  return [];
...
return _.default.track(m.rMx.GIFT_CODE_RESOLVED, {
  resolved: !0,
  gift_code: r.code,
...
throw _.default.track(m.rMx.GIFT_CODE_RESOLVED, {
  resolved: !1,
  gift_code: e
}), new l.Z(t);
  }
...
case m.wZ8.SUCCESS:
  return t.isSubscription ? g.Z.Messages.GIFT_CONFIRMATION_HEADER_SUCCESS_NITRO.format({
    skuName: n.name
  }) : g.Z.Messages.GIFT_CONFIRMATION_HEADER_SUCCESS;
case m.wZ8.CONFIRM:
default:
  return t.isSubscription ? g.Z.Messages.GIFT_CONFIRMATION_HEADER_CONFIRM_NITRO.format({
    skuName: n.name
...
case m.wZ8.SUCCESS:
  ...
  return g.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS.format({
    skuName: n.name
  });
case m.wZ8.CONFIRM:
default:
  ...
  return g.Z.Messages.GIFT_CONFIRMATION_BODY_CONFIRM.format({
    skuName: n.name
  });
  }
}
...
function W(e, t, n, r, i) {
  let a = g.Z.Messages.GIFT_CONFIRMATION_BODY_OWNED.format({
onGoToLibrary: i
  });

...
t.default = e => {
  let {
    guildId: t,
    onClose: n
  } = e, h = (0, r.useStateFromStores)([u.default], () => null == u.default.getStateForGuild(t).progress), C = (0, r.useStateFromStores)([o.default], () => o.default.useReducedMotion), m = (0, l.useSpring)({
    from: {
      opacity: C ? 1 : 0,

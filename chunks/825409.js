...
var r = n(836560), i = n(400053), a = n.n(i), o = n(142494);
function s(e, t, n) {
...
class E extends r.EventEmitter {
    ...
    getDefaultLocale() {
        var e, t, n;
        let r = null !== (e = u()) && void 0 !== e ? e : l, i = this._languages.filter(e => {
                let {enabled: t} = e;
                return t;
            }).map(e => {
                let {code: t} = e;
    ...
    constructor({
        ...
        super(), s(this, 'Messages', void 0), s(this, 'loadPromise', Promise.resolve()), s(this, 'initialLanguageLoad', void 0), s(this, 'resolveLanguageLoaded', () => {
        }), s(this, '_languages', []), s(this, '_provider', void 0), s(this, '_chosenLocale', ''), s(this, '_requestedLocale', void 0), s(this, '_getMessages', void 0), s(this, '_getParsedMessages', (e, t, n) => {
            let {
                    messages: r,
                    defaultMessages: i,
                    locale: a

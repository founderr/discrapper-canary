...
class d extends _ {
  ...
  constructor(...e) {
    var t;
    super(...e), t = this, a(this, "_refresh", function(e) {
...
class c extends _ {
  ...
  constructor(e) {
    var t;
    super(e), t = this, a(this, "_createProxy", function() {
...
class E extends i.EventEmitter {
  ...
  constructor({
    ...
    super(), a(this, "Messages", void 0), a(this, "loadPromise", Promise.resolve()), a(this, "initialLanguageLoad", void 0), a(this, "resolveLanguageLoaded", () => {}), a(this, "_languages", []), a(this, "_provider", void 0), a(this, "_chosenLocale", ""), a(this, "_requestedLocale", void 0), a(this, "_getMessages", void 0), a(this, "_getParsedMessages", (e, t, n) => {
      let {
        messages: i,
        defaultMessages: r,
        locale: s
      } = e, a = i[t] || r[t];
      if ("object" == typeof a) return n({
        messages: a,
        defaultMessages: r[t],
        locale: s
      });
      try {
        ...
        if (console.warn("Failed parsing intl key '".concat(String(t), "' in locale '").concat(s, "' defaulting to English"), e), "string" == typeof(a = r[t])) return (0, o.FC)(a, s)
      }
      return ""
    }), a(this, "_handleNewListener", e => {

...
class T extends(i = l.ZP.Store) {
  getChannelStatus(e) {
    ...
    if (null != e && null != e.guild_id) {
      if (e.type === a.d.GUILD_VOICE) return !c.has(e.guild_id) && (c.add(e.guild_id), _.Z.getSocket().requestChannelStatuses(e.guild_id)), null === (t = d[e.guild_id]) || void 0 === t ? void 0 : t[e.id]
    }
  }
}

t(47120);
var a = t(470079), r = t(399606), i = t(544891), s = t(570140), o = t(367907), l = t(430824), c = t(496675), d = t(626135), u = t(70956), m = t(997787), f = t(981631);
let C = 1 * u.Z.Millis.DAY, _ = new Map();
n.Z = {
    useShouldShowChannelNotice(e) {
        ...
        a.useEffect(() => {
            n && !function (e) {
                var n;
                let t = Date.now(), a = null !== (n = _.get(e)) && void 0 !== n ? n : 0;
                if (!(t < a + C))
                    _.set(e, t), i.tn.post({ url: f.ANM.GUILD_MIGRATE_COMMAND_SCOPE(e) }).then(n => {
                        var t, a;
                        s.Z.dispatch({

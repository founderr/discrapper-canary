...
var n = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(442837), l = s(481060), c = s(570140), d = s(355467), _ = s(179360), E = s(821849), u = s(15640), T = s(314684), I = s(899667), S = s(853872), N = s(78839), C = s(783739), m = s(981631), A = s(618395);
function h() {
    a.useEffect(() => {
        c.Z.wait(() => {

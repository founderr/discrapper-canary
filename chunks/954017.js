...
let T = async (e) => {
        ...
        return await (0, c.f)({
            ...
            drawImage: (e) => {
                ...
                e.setFont({ truncate: u.GX.Truncate }),
                    null != i ? y(e, n, t) : (0, l.Z)(n) ? v(e, n, t) : (0, o.Z)(n) && n.name === s.Z.get(I.ABu.LEAGUE_OF_LEGENDS).name ? C(e, n, t) : n.type === I.IIU.HANG_STATUS ? R(e, n, t) : O(e, n, t),
    ...
    O = (e, t, n) => {
        ...
        let { color: s, theme: o } = (0, p.j3)(n, 'black');
        e.setColor(s),
            e.drawRoundedRect(
                {
                    x: 0,
    ...
    R = (e, t, r) => {
        ...
        let { color: s, theme: o } = (0, p.j3)(r, 'black');
        e.setColor(s),
            e.drawRoundedRect(
                {
                    x: 0,
    ...
    C = (e, t, n) => {
        ...
        let { color: i, theme: a } = (0, p.j3)(n, 'black');
        e.setColor(i),
            e.drawRoundedRect(
                {
                    x: 0,

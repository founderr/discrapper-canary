...
let P = {
    ...
    v = a.memo((e) => {
        ...
        return (a.useEffect(() => {
            D && U && (G(!0), R.default.track(h.rMx.PREMIUM_MARKETING_PERK_CARD_FLIPPED, { card_type: t }), null != r && Q(b.L.TAKE_ACTION));
        }, [D, U, r, t, Q]),
        (0, u.Z)(
            {
                ...
                : es
                  ...
                  : (0, s.jsx)('div', {
                        ...
                        children: (0, s.jsxs)(d.Clickable, {
                            ...
                            onTransitionEnd: (e) => {
                                if (!!U && 'transform' === e.propertyName && !!e.target.classList.contains(O.flipCard)) G(!0), R.default.track(h.rMx.PREMIUM_MARKETING_PERK_CARD_FLIPPED, { card_type: t }), null != r && Q(b.L.TAKE_ACTION);
                            },
                            children: [
                                (0, s.jsx)('div', {
...
let L = a.forwardRef((e, t) => {
    var n;
    let { title: r, titleClassName: l = '', subtitle: o = '', description: c = '', descriptionCta: _ = '', isPremiumGetCta: E, onCtaClick: u, onMouseEnter: T, className: I, perkComponent: R, cardVariant: N, cardType: C, onClick: A, backgroundImage: S, pillText: h, perkImage: b } = e,
        x = C === f.R0.CARD_CAROUSEL_FIRST_ROW || C === f.R0.CARD_CAROUSEL_SECOND_ROW || C === f.R0.CARD_CAROUSEL_THIRD_ROW,

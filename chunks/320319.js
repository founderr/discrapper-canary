...
let {
  ...
  cardType: f,
  confettiCanvas: S
} = e, Z = null == e ? void 0 : e.onCtaClick, D = (0, c.e7)([u.Z], () => u.Z.useReducedMotion), [B, j] = a.useState(!1), [U, G] = a.useState(!1), y = (0, C.yQ)(), k = (0, C.IB)(), [H, w] = a.useState(!1), [F, V] = a.useState(t === N.u.FREE_BOOST && k && (null == y ? void 0 : y.nitroTenureStatus) === h.EB.REDEEMABLE);
a.useEffect(() => {
  t === N.u.FREE_BOOST && k && (null == y ? void 0 : y.nitroTenureStatus) === h.EB.REDEEMABLE && V(!0);
}, [
  k,
  t,
  y
...
return (a.useEffect(() => {
  ...
  disableTrack: t !== N.u.FREE_BOOST || null == y
}), (0, E.Z)({
  type: o.ImpressionTypes.VIEW,

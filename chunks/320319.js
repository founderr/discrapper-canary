...
pillText: M,
perkImage: x
  } = e, b = N === m.R0.CARD_CAROUSEL_FIRST_ROW || N === m.R0.CARD_CAROUSEL_SECOND_ROW || N === m.R0.CARD_CAROUSEL_THIRD_ROW, P = 0 !== c.length || 0 !== d.length || 0 !== o.length && g === m.zW.REWARD, v = (0, C.IB)(), [L, Z] = a.useState(v);
  a.useEffect(() => {
v && Z(!0);
  }, [v]);
  let D = (0, p._)(g);

...
let x = {
  ...
  v = r.memo(e => {
    ...
    return (r.useEffect(() => {
      b && U && (y(!0), R.default.track(O.AnalyticEvents.PREMIUM_MARKETING_PERK_CARD_FLIPPED, {
        card_type: t

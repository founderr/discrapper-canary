...
let L = a.forwardRef((e, t) => {
    var n;
    let { title: r, titleClassName: l = '', subtitle: o = '', description: c = '', descriptionCta: d = '', isPremiumGetCta: E, onCtaClick: u, onMouseEnter: T, className: I, perkComponent: R, cardVariant: N, cardType: C, onClick: f, backgroundImage: S, pillText: h, perkImage: b } = e,
        x = C === p.R0.CARD_CAROUSEL_FIRST_ROW || C === p.R0.CARD_CAROUSEL_SECOND_ROW || C === p.R0.CARD_CAROUSEL_THIRD_ROW,

...
let P = {
    ...
    v = a.memo((e) => {
        let { name: t, canReveal: n = !0, dismissibleContentType: r, forceShadow: m, cardType: A, confettiCanvas: M } = e,
            ...
            y = (0, g.IB)(),
            [H, k] = a.useState(!1),
            [F, V] = a.useState(t === f.u.FREE_BOOST && y && (null == w ? void 0 : w.nitroTenureStatus) === S.EB.REDEEMABLE);
        a.useEffect(() => {
            t === f.u.FREE_BOOST && y && (null == w ? void 0 : w.nitroTenureStatus) === S.EB.REDEEMABLE && V(!0);
        }, [y, t, w]);
        let W = a.useCallback(() => {
                k(!0);
            }, []),
            K = A === p.R0.CARD_CAROUSEL_FIRST_ROW || A === p.R0.CARD_CAROUSEL_SECOND_ROW || A === p.R0.CARD_CAROUSEL_THIRD_ROW,
            Y = (0, f.Z)(),
        ...
        let { easterEggLevel: X, isEasterEggTriggered: J, onHover: q, onUnhover: $ } = (0, C.Z)(5),
            ee = (0, l.debounce)(() => {
...
let L = a.forwardRef((e, t) => {
    var n;
    let { title: r, titleClassName: l = '', subtitle: o = '', description: c = '', descriptionCta: d = '', isPremiumGetCta: E, onCtaClick: u, onMouseEnter: T, className: I, perkComponent: R, cardVariant: N, cardType: C, onClick: f, backgroundImage: S, pillText: h, perkImage: x } = e,
        b = C === p.R0.CARD_CAROUSEL_FIRST_ROW || C === p.R0.CARD_CAROUSEL_SECOND_ROW || C === p.R0.CARD_CAROUSEL_THIRD_ROW,

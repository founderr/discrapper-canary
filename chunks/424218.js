...
return t.useSpace ? r.Z.Messages.FILE_SIZE_MB.format({
  ...
  let o = s / i;
  return o = t.showDecimalForGB ? Math.round(10 * o) / 10 : Math.round(o), t.useSpace ? r.Z.Messages.FILE_SIZE_GB.format({
size: o
...
l = e / n;
  return l / o >= 1 ? s(l, t) : t.useSpace ? r.Z.Messages.FILE_SIZE_KB.format({
size: Math.ceil(l)

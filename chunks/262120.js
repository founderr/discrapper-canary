  ...
  value: function(e, n, r) {
    ...
    return function(a, s) {
      ...
      for (r.method = a, r.arg = s;;) {
        ...
        if (o) {
          var l = function e(n, r) {
            var i = r.method,
              a = n.iterator[i];
            if (a === t)
              return r.delegate = null, 'throw' === i && n.iterator.return && (r.method = 'return', r.arg = t, e(n, r), 'throw' === r.method) || 'return' !== i && (r.method = 'throw', r.arg = TypeError('The iterator does not provide a \'' + i + '\' method')), m;
            var s = f(a, n.iterator, r.arg);
            if ('throw' === s.type)
              return r.method = 'throw', r.arg = s.arg, r.delegate = null, m;
            var o = s.arg;
        ...
        var u = f(e, n, r);
        if ('normal' === u.type) {
          if (i = r.done ? I : 'suspendedYield', u.arg === m)
            continue;
          return {
            value: u.arg,
            done: r.done
...
throw TypeError(r(e) + ' is not iterable');
  ...
  return g.prototype = S, o(O, 'constructor', {
value: S,
configurable: !0
  }), o(S, 'constructor', {
value: g,
...
reset: function(e) {
  if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = 'next', this.arg = t, this.tryEntries.forEach(D), !e)
    for (var n in this)
      't' === n.charAt(0) && s.call(this, n) && !isNaN(+n.slice(1)) && (this[n] = t);
},
stop: function() {
  this.done = !0;

...
function i() {
    ...
    var A = (T.prototype = v.prototype = Object.create(b));
    function N(e) {
    ...
    return (
        ...
        (n.mark = function (e) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(e, T) : ((e.__proto__ = T), f(e, d, 'GeneratorFunction')), (e.prototype = Object.create(A)), e;
        }),
        (n.awrap = function (e) {
            return { __await: e };
        }),

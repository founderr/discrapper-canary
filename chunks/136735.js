...
var t = s(735250), n = s(470079), i = s(120356), a = s.n(i), o = s(772848), r = s(442837), u = s(780384), d = s(481060), c = s(339085), I = s(349709), m = s(763610), _ = s(197712), E = s(210887), f = s(430824), g = s(594174), L = s(285952), T = s(626135), v = s(424218), D = s(63063), p = s(956664), x = s(268350), C = s(373228), R = s(378233), S = s(419922), j = s(611480), h = s(981631), N = s(689938), U = s(521792), Z = s(434227), P = s(600126);
let O = new Set([
        'application/json',
        'image/png',
        'image/apng',
...
async function b(e) {
    let l = await (0, p.fD)(e), s = new Image();
...
function B(e) {
    ...
    let {
            ...
            if (t.size > V) {
                er({
                    message: N.Z.Messages.GUILD_STICKER_FILE_TOO_BIG.format({ maxSize: (0, v.IC)(V, { useKibibytes: !0 }) }),
            ...
            if (n === C.u3.LOTTIE) {
                if (!ed) {
                    er({
                        message: N.Z.Messages.GUILD_STICKER_UNSUPPORTED_MIME_TYPE.format({ articleURL: D.Z.getArticleURL(h.BhN.STICKERS_UPLOAD) }),
                        isBlocking: !0
                    });
                    return;
                }
            ...
            try {
                if (ea(!0), ec)
                    ...
                    ;
                    let e = new FormData();
                    e.append('name', Y), e.append('tags', o), e.append('description', et), (null == X ? void 0 : X.file) != null && e.append('file', X.file), a = null !== (i = null === (n = X.file) || void 0 === n ? void 0 : n.type) && void 0 !== i ? i : '', T.default.track(h.rMx.STICKER_UPLOAD_STARTED, { filetype: a }), await (0, x.lY)(w, e), A(!0);
                }
                y();
            } catch (e) {
                er({

...
function B(e) {
  ...
  let {
    ...
    try {
      if (ea(!0), ec) await (0, x.Jf)(w, null !== (t = null == F ? void 0 : F.id) && void 0 !== t ? t : "", {
        name: Y,
        tags: o,
        description: et
      });
    ...
    children: [(0, t.jsx)(d.ModalCloseButton, {
      ...
      children: [(0, t.jsxs)(d.ModalContent, {
        ...
        children: [(0, t.jsxs)(d.ModalHeader, {
          ...
          className: U.formItem,
          children: [(0, t.jsxs)(d.FormTitle, {
            children: [N.Z.Messages.GUILD_STICKER_UPLOAD_DESCRIPTION_TITLE, (0, t.jsx)(d.Tooltip, {

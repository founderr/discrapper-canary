...
function I(e) {
  let {
    user: t,
    displayProfile: l
  } = e, i = (0, n.useStateFromStores)([d.default], () => d.default.findActivity(t.id, e => e.type === f.ActivityTypes.CUSTOM_STATUS)), I = c.default.getName(t);
  return (0, s.jsxs)("div", {
    className: E.container,
    children: [null == I && (0, s.jsx)(r.default, {
      user: t,
      className: E.nameTag,
      ...
      children: [(0, s.jsx)(o.Text, {
        ...
        discriminatorClass: E.discriminator,
        className: a()(E.nameTag, E.nameTagSmall)
      })]
      ...
      children: e => (0, s.jsx)(o.Text, {
        ...
        className: a()(E.pronouns, E.nameTagSmall),
        children: l.pronouns
      })
    }), null != i ? (0, s.jsx)("div", {

...
function A(n) {
  let e = (0, a.e7)([d.ZP], () => d.ZP.getRunningVerifiedApplicationIds().includes(n.id), [n.id]),
    t = (0, a.e7)([u.Z], () => u.Z.isInstalled(n.id, n.branchId), [n.branchId, n.id]),
    A = (0, a.e7)([s.Z], () => s.Z.getTargetManifests(n.id, n.branchId), [n.branchId, n.id]);
  if (t) return e ? null : (0, i.jsx)(l.MenuItem, {
    id: "uninstall",

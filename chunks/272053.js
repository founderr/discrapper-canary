...
var r, i = n(348327), a = n.n(i), o = n(442837), s = n(544891), l = n(570140), u = n(457330), c = n(726542), d = n(81063), _ = n(70956), E = n(553795), f = n(246946), h = n(981631);
function p(e, t, n) {
...
let m = 1 * _.Z.Millis.MINUTE, I = e => 'https://youtube.com/watch?v='.concat(e), T = 5 * _.Z.Millis.MINUTE, g = /live_user_(.*)-\{width\}/, S = null, A = 0, N = null, v = new Set(), O = {};
function R(e, t, n) {
    return s.tn.get({
...
async function C(e, t) {
    ...
    let {
            body: {data: r}
        } = await R('/games', { id: e }, t), i = r[0].name;
    return O[e] = i, i;
}
let y = new class e {
    start() {
    ...
    async _checkTwitch(e) {
        ...
        try {
            ...
            let {
                    ...
                    game_id: _,
                    title: E
                } = l, f = { large_image: null != u && null !== (r = (0, d.getAssetFromImageURL)(h.ABu.TWITCH, u)) && void 0 !== r ? r : void 0 }, p = await C(_, t), m = c.Z.get(h.ABu.TWITCH);
    ...
    async _checkYouTube(e) {
        ...
        try {
            ...
            let {
                ...
                } = r[0], l = { large_image: null !== (n = (0, d.getAssetFromImageURL)(h.ABu.YOUTUBE, o.high.url)) && void 0 !== n ? n : void 0 };
            return N = {
                url: I(i),

s.r(o), s(47120);
var r = s(735250), t = s(470079), n = s(120356), a = s.n(n), i = s(512722), c = s.n(i), l = s(481060), d = s(277390), C = s(626135), _ = s(985002), u = s(880257), f = s(631885), m = s(292352), E = s(981631), x = s(689938), N = s(425597), h = s(331651);
o.default = e => {
    let {
            transitionState: o,
            onClose: s
    ...
    let O = () => {
        R(e => (C.default.track(E.rMx.FAMILY_CENTER_ACTION, { action: i ? m.YC.HideQRCode : m.YC.RevealQRCode }), !e)), !i && setTimeout(() => {
            s();
        }, m.f2);
    };
    t.useEffect(() => {
            ...
            (0, r.jsxs)(l.ModalContent, {
                ...
                children: [
                    ...
                    (0, r.jsx)(l.Text, {
                        ...
                        children: x.Z.Messages.FAMILY_CENTER_QR_CODE_MODAL_DESCRIPTION.format({ link: 'https://support.discord.com/hc/articles/14155060633623' })
                    }),
                    (0, r.jsx)('div', {
                        className: N.qrCode,
                        children: (0, r.jsx)(l.Clickable, {
                            className: a()(N.qrCodeObscure, { [N.visible]: v }),
                            onClick: O,

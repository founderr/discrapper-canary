...
function s(e) {
    let t = function (e) {
            let {enableFastMonetizationOnboardingForGuild: t} = r.z.useExperiment({
                    ...
                    location: 'e3bb71_3'
                }, { autoTrackExposure: !0 }), {enableFastMonetizationOnboardingForUser: n} = r.AC.useExperiment({ location: 'e3bb71_4' }, { autoTrackExposure: !1 });
            return null != e && t && n;
        }(null == e ? void 0 : e.id), n = function (e) {

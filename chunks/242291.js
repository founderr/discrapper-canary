...
function y(e, t) {
    return (null == t ? void 0 : t.guild_id) == null || d.Z.can(S.Plq.USE_EXTERNAL_SOUNDS, t) || e.guildId === I.X8 || e.guildId === (null == t ? void 0 : t.guild_id);
}
function A(e, t, n) {
...
function x(e) {
    let { location: t } = e;
    _.default.track(S.rMx.USER_CUSTOM_CALL_SOUND_SETTING_GUILD_REMOVED, { location_stack: t });
}

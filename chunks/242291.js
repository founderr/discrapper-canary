...
function y(e, t) {
    return (null == t ? void 0 : t.guild_id) == null || d.Z.can(b.Plq.USE_EXTERNAL_SOUNDS, t) || e.guildId === S.X8 || e.guildId === (null == t ? void 0 : t.guild_id);
}
function A(e, t, n) {
    let r = !(arguments.length > 3) || void 0 === arguments[3] || arguments[3];
    return (h.ZP.canUseSoundboardEverywhere(e) || t.guildId === (null == n ? void 0 : n.guild_id) || t.guildId === S.X8) && y(t, n) && (!r || t.available);
}
function N(e, t, n) {
...
async function C(e) {
    let t = f.default.getCurrentUser(),
        n = (0, a.Z)(),
        r = (0, I.k9)(e);
    if (null == n || c.Lr.has(n.type) || null == r || !h.ZP.canUseCustomCallSounds(t) || !(0, v.D)()) return;
    await (0, m.w)();
...
function R(e) {
    ...
    if (!a && !Object.values(null !== (n = null === (t = l.Z.settings.guilds) || void 0 === t ? void 0 : t.guilds) && void 0 !== n ? n : {}).some((e) => null != e.joinSound)) {
        ...
        let e = (0, p.Fc)(s);
        (h.ZP.canUseCustomCallSounds(s) || e) && o.push(i.z.CUSTOM_CALL_SOUNDS_PICKER_UPSELL);
    }
    return o;
}
function O(e, t) {
...
function L(e) {
    ...
    _.default.track(b.rMx.USER_CUSTOM_CALL_SOUND_SETTING_UPDATED, {
        location_stack: a,
...
function x(e) {
    let { location: t } = e;
    _.default.track(b.rMx.USER_CUSTOM_CALL_SOUND_SETTING_GUILD_REMOVED, { location_stack: t });
}

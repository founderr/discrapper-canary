...
class A extends a.Z {
    handleRTCConnectionState(e) {
        ...
        if (!(0, h.ln)() || n !== g.hes.RTC_CONNECTED) return;
    ...
    handlePostConnectionOpen() {
        if (!!(0, I.Z)(c.Z)) {
            ...
            (null == p.Z.getHardwareClassification() || null == p.Z.getHardwareClassificationForDecoupled() || p.Z.getHardwareClassificationVersion() !== T.WM) &&
    ...
    async classifyHardwareAndTrack() {
        try {
            ...
            return (
                E.default.track(g.rMx.CLIPS_HARDWARE_CLASSIFICATION, {
                    classification: t,
                    version: T.WM,

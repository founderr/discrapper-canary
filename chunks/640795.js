...
var r = n(956067), i = n(544891), a = n(570140), o = n(710845), s = n(873741), l = n(139674);
let {WEBAPP_ENDPOINT: u} = window.GLOBAL_ENV, c = 'https:'.concat(u, '/bad-hash-delta'), d = new o.Z('FetchBlockedDomain');
function _() {
...
async function E() {
    ...
    try {
        let e;
        let t = parseInt((await i.tn.get('https://cdn.discordapp.com/bad-domains/current_revision.txt')).text), n = l.Z.getCurrentRevision();

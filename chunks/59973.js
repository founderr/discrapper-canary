...
var r = n(573654), i = n(158545), a = n(144459), o = n(964742), s = {
        type: o.TL,
        payload: {
            clientOffset: null,
...
function l(e) {
    return function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { publishSource: !0 }, l = n.publishSource, u = n.clientOffset, c = n.getSourceClientOffset, d = e.getMonitor(), _ = e.getRegistry();
        e.dispatch((0, i.T)(u)), function (e, t, n) {

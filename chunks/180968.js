...
function _(e, t, n) {
  return function(e, t, n, l) {
    let {
      addtionalQuery: a,
      shouldDispatch: i = !1
    } = l, r = s.useMemo(() => m(e, t, n, a), [e, t, n, a]), E = g(r), _ = (0, u.default)(r), [I, T] = s.useState({});
    return s.useEffect(() => {
      if (_ !== r) {
        let l = C(e, n, a),
...
function T(e, t, n) {
  ...
  let [v, x] = s.useState({});
  return {
    messagesCount: null !== (l = null == o ? void 0 : o.messageCount) && void 0 !== l ? l : h,

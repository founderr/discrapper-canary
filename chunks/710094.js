...
function M(e) {
  ...
  l()(null != en, "Step should be set");
  let ef = s.useRef(null),
    [ep, e_] = (0, r.default)(!1, 500);
  ...
  let eN = s.useCallback((e, t) => {
      H(e), null != t && er(t), M(E.Step.CONFIRM, {
        fulfillment: {
          subscription: e,
          entitlements: t
        }
    ...
    ev = null != K ? V[K] : null,
    eh = null != X && C.MULTI_MONTH_PLANS.has(X.id) && null != ev && !(0, u.isPaymentSourceEligibleForMultiMonthPlans)(ev) ? Error(g.default.Messages.BILLING_ERROR_INVALID_PLAN_FOR_PAYMENT_SOURCE) : null,
    ex = s.useRef(null),
    [eA, eC] = s.useState(null),
    ey = !ec && null != eE && null != q && (0, C.SubscriptionTrials)[eE.trial_id].skus.includes(q),
    eg = null == eP ? void 0 : null === (t = eP.discount) || void 0 === t ? void 0 : t.plan_ids,
    eM = !ec && null != eP && null != eg && null != X && eg.includes(X.id),
    eR = ec && (0, _.shouldShowCustomGiftExperience)(em),
    eb = null == F && null == w && el === y.PurchaseTypes.SUBSCRIPTION,
    ...
    eO = ec && el === y.PurchaseTypes.ONE_TIME,
    ej = eO || (eL ? eb && es : es),
    eG = s.useCallback(() => {
      if (eL) {
        M(E.Step.SKU_SELECT);
    ...
    eD = !1;
  return el === y.PurchaseTypes.ONE_TIME ? a = (0, i.jsx)(v.default, {
  ...
  }) : (eD = ec ? null == eo : null != ev && el === y.PurchaseTypes.SUBSCRIPTION && ey && !ev.canRedeemTrial(), null == k || ec ? (l()(null != X, "Expected plan to be selected"), a = (0, i.jsx)(m.default, {
    selectedPlanId: X.id,
    paymentSources: V,
    onPaymentSourceChange: e => $(null != e ? e.id : null),
    priceOptions: Z,
    ...
    purchaseState: ei,
    referralTrialOfferId: U,
    isTrial: ey || null != R && null != b,
    isDiscount: eM,
    handleClose: B
  })) : (l()(null != X, "Expected plan to be selected"), a = (0, i.jsx)(f.default, {

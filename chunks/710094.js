...
function L(e) {
  ...
  let eA = s.useCallback((e, t) => {
    ...
    eC = null != z ? J[z] : null,
    ey = null != $ && M.MULTI_MONTH_PLANS.has($.id) && null != eC && !(0, u.isPaymentSourceEligibleForMultiMonthPlans)(eC) ? Error(R.default.Messages.BILLING_ERROR_INVALID_PLAN_FOR_PAYMENT_SOURCE) : null,
    eg = s.useRef(null),
    [eM, eb] = s.useState(null),
    eR = !ep && null != ev && null != ee && (0, M.SubscriptionTrials)[ev.trial_id].skus.includes(ee),
  ...
  null != eG && ef(eG);
  let eD = ep && (0, _.shouldShowCustomGiftExperience)(e_),
    eU = null == k && null == H && eo === b.PurchaseTypes.SUBSCRIPTION,
    ...
    ew = ep && eo === b.PurchaseTypes.ONE_TIME,
    eB = ew || (eF ? eU && er : er),
    ek = s.useCallback(() => {
      if (eF) {
        L(E.Step.SKU_SELECT);
    ...
    eH = !1;
  return eo === b.PurchaseTypes.ONE_TIME ? l = (0, i.jsx)(x.default, {
  ...
  }) : (eH = ep ? null == em : null != eC && eo === b.PurchaseTypes.SUBSCRIPTION && eR && !eC.canRedeemTrial(), null == Y || ep ? (a()(null != $, "Expected plan to be selected"), l = (0, i.jsx)(m.default, {
    selectedPlanId: $.id,
    paymentSources: J,
    onPaymentSourceChange: e => en(null != e ? e.id : null),
    priceOptions: X,

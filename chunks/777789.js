...
let S = e => {
    ...
    if (0 === s)
        return null;
    let t = Math.max(l.premiumSubscriberCount + s, 0), r = (0, c.rF)(t, l.id), a = r - (0, c.rF)(l.premiumSubscriberCount, l.id);
    return 0 === a ? null : (0, n.jsxs)(n.Fragment, {
        children: [
            (0, n.jsx)(u.Z, { className: a > 0 ? C.levelUpIcon : C.levelDownIcon }),
            (0, n.jsx)(m, { tier: r })
        ]
    });
};

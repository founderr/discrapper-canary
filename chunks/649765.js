		...
		(0, i.jsxs)('div', {
			...
			children: [
				(0, i.jsx)(s.Heading, {
					...
					children: o.Z.Messages.REFERRAL_INCENTIVE_SHARE_NITRO_GET_DISCOUNT.format({ discountRate: '40%' })
				}),
				(0, i.jsx)(s.Text, {
					variant: 'text-sm/medium',
					children: o.Z.Messages.REFERRAL_INCENTIVE_GET_DISCOUNT_OFF_YOUR_NEXT_MONTH.format({ discountRate: '40%' })
				})
			]
		}),
	E = (e) => {

var r = n(21841), i = n(689118), a = n(726315), o = n(449348);
function s() {
    this.tmp = [
        ,
        ,
...
l.prototype.deriveKeys = function (e, t) {
    ...
    var i = this._desState, o = a.readUInt32BE(e, t), s = a.readUInt32BE(e, t + 4);
    ...
    for (var o = t, s = n, l = 0; l < e.keys.length; l += 2) {
        var u = e.keys[l], c = e.keys[l + 1];
        a.expand(s, e.tmp, 0), u ^= e.tmp[0], c ^= e.tmp[1];
        var d = a.substitute(u, c), _ = a.permute(d), E = s;
        s = (o ^ _) >>> 0, o = E;
    }
    a.rip(s, o, r, i);
    ...
    for (var o = n, s = t, l = e.keys.length - 2; l >= 0; l -= 2) {
        ...
        var d = a.substitute(u, c), _ = a.permute(d), E = o;
        o = (s ^ _) >>> 0, s = E;
    }
    a.rip(o, s, r, i);
};

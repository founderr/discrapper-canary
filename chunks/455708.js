n(47120);
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(442837), l = n(481060), u = n(570140), c = n(68405), d = n(28546), _ = n(656733), E = n(285952), f = n(985375), h = n(653235), p = n(215016), m = n(981631), I = n(149203), T = n(689938), g = n(155938);
function S(e, t, n) {
...
class N extends i.PureComponent {
    ...
    search(e, t, n) {
        c.yC(e, t, n), '' === e ? this.setState({ resultType: null }) : this.state.resultType !== m.wI2.SEARCH && this.setState({ resultType: m.wI2.SEARCH });
    }
    renderHeaderContent() {
        let {query: e} = this.props, {resultType: t} = this.state;
        switch (t) {
    ...
    renderHeader() {
        let {resultType: e} = this.state, t = null;
    ...
    renderContent() {
        let {
                ...
                suggestions: l,
                hideFavorites: u
            } = this.props, {resultType: c} = this.state;
    ...
    constructor(...e) {
        super(...e), S(this, 'state', { resultType: null }), S(this, 'searchBarRef', i.createRef()), S(this, 'backToFrontPage', e => {
            ...
            (0, d.ql)(''), c.v2(), this.setState({ resultType: null }), null != e && e.focus();

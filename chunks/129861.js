...
t.Z = e => {
  let {
    ...
    forcePomelo: d,
    ...E
  } = e, h = (0, o.e7)([l.Z], () => l.Z.hidePersonalInformation), f = h || t || n.isNonUserBot(), S = n.toString(), N = c.ZP.getName(n), A = s ? S : null != r ? r : N, m = n.isPomelo() || d;
  if (m || A !== S) {
    let e = A === S && m && s ? c.ZP.getUserTag(n, {
        forcePomelo: d
      }) : A,
  ...
  return (0, i.jsx)(_.Z, {
    ...
    botType: I(n),
    botVerified: n.isVerifiedBot(),
    discriminator: f || A !== S ? null : null != u ? u : n.discriminator,
    ...E
  })
}
...
function W(e) {
  let {
    ...
    animateOnHover: !(s || G)
  }), J = (0, f.useStateFromStores)([x.default], () => x.default.isChannelMuted(t.getGuildId(), t.id)), q = (0, f.useStateFromStores)([L.default], () => L.default.getMentionCount(t.id) > 0), $ = (0, I.default)(t), ee = (0, f.useStateFromStores)([S.default], () => S.default.isFavorite(t.id)), et = () => {
    K(!0)
  }, en = () => {
    K(!1)
  }, el = function(e) {

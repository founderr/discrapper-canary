...
function _(e, t) {
  l.default.show({
    title: g.default.Messages.ERROR,
    body: e
...
function T(e, t, n) {
    ...
    d = async () => {
      try {
        ...
        r.default.track(M.AnalyticEvents.CONTEXT_MENU_IMAGE_SAVE_FAILED, {
          ...(0, E.getNativeContextMenuChannelAnalytics)()
        }), _(g.default.Messages.ERROR_SAVING_IMAGE, e)
      }
    }, T = async () => {
      try {
        ...
        _(g.default.Messages.ERROR_COPYING_IMAGE, e), r.default.track(M.AnalyticEvents.CONTEXT_MENU_IMAGE_COPY_FAILED, {
          ...(0, E.getNativeContextMenuChannelAnalytics)()
        })
      }
    };
  return [f.default.canCopyImage() && function(e) {
    ...
    id: "copy-image",
    label: g.default.Messages.COPY_IMAGE_MENU_ITEM,
    action: T
  }, "copy-image") : null, (0, a.jsx)(i.MenuItem, {
    id: "save-image",
    label: g.default.Messages.SAVE_IMAGE_MENU_ITEM,
    action: d
  }, "save-image")]
}
...
'png'
  ...
  g = e => {
var t, n, i, a;
return null === (a = d.Z.toURLSafe(e)) || void 0 === a ? void 0 : null === (i = a.pathname) || void 0 === i ? void 0 : null === (n = i.split('.')) || void 0 === n ? void 0 : null === (t = n.pop()) || void 0 === t ? void 0 : t.toLowerCase();
  };
...
u = async () => {
  try {
    await _.ZP.saveImage(s), o.default.track(I.rMx.CONTEXT_MENU_IMAGE_SAVED, {
      ...(0, E.v)()
    });
  } catch (e) {
  ...
  try {
    await _.ZP.copyImage(s), o.default.track(I.rMx.CONTEXT_MENU_IMAGE_COPIED, {
      ...(0, E.v)()
    });
  } catch (e) {

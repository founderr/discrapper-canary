...
var o = function (e, t) {
    ...
    for (var g = n.visualViewport ? n.visualViewport.width : innerWidth, E = n.visualViewport ? n.visualViewport.height : innerHeight, v = window.scrollX || pageXOffset, I = window.scrollY || pageYOffset, b = e.getBoundingClientRect(), S = b.height, T = b.width, y = b.top, A = b.right, N = b.bottom, C = b.left, R = 'start' === o || 'nearest' === o ? y : 'end' === o ? N : y + S / 2, O = 'center' === l ? C + T / 2 : 'end' === l ? A : C, D = [], L = 0; L < h.length; L++) {
        ...
        if (p === x) (Y = 'start' === o ? R : 'end' === o ? R - E : 'nearest' === o ? s(I, I + E, E, V, H, I + R, I + R + S, S) : R - E / 2), (W = 'start' === l ? O : 'center' === l ? O - g / 2 : 'end' === l ? O - g : s(v, v + g, g, F, j, v + O, v + O + T, T)), (Y = Math.max(0, Y + I)), (W = Math.max(0, W + v));
        else {

...
class m extends i.EventEmitter {
  ...
  connect() {
    if (null == g) {
      ...
      try {
        g = new WebSocket("ws://127.0.0.1:".concat(this.port, "/?v=").concat(d.RPC_VERSION))
      } catch (e) {
        this.disconnect({
  ...
  request(e, t, n) {
    return new Promise((i, s) => {
      ...
      this.once(f(e, r), (e, t) => null != e ? s(e) : i(t)), null == g || g.send(a)
    })
  }
  requestOnce(e, t, n) {

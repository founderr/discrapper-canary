...
var n = r(735250), i = r(470079), o = r(956707), s = r.n(o), a = r(699581), u = r(89106), l = r(591490), c = r.n(l), f = r(565925), d = r.n(f), h = function () {
        ...
        var o, s, a = Math.round(600 * Math.random() + 200), u = Math.round(Math.random() * (v.length - 1)), l = t - Math.round(1000 * Math.random()), f = 0.1 > Math.random();
        var b = (o = u, !d()(v[o], m) && g()), x = f ? c()(0.25 * Math.random(), 2) : 0, w = -1 * x, k = c()(Math.abs(p(Math.abs(y(e.degree, 90) - 180), 0, 180, -1, 1)), 4), S = c()(0.5 * Math.random(), 4), R = c()(Math.random() * r * (g() ? 1 : -1), 4), P = c()(Math.max(p(Math.abs(e.degree - 180), 0, 180, r, -r), 0), 4);
        ...
        var t = e.particles, r = e.duration, n = e.height, i = e.width, o = e.force, s = e.particleSize, a = t.reduce(function (e, t, n) {
...
function P(e) {
    var t = e.particleCount, r = e.duration, o = void 0 === r ? 2200 : r, s = e.colors, u = e.particleSize, l = e.force, c = e.height, f = e.width, d = e.zIndex, p = e.onComplete, y = function (e, t) {
            var r = {};
            for (var n in e)
            ...
            'zIndex',
            'onComplete'
        ]), g = i.useState(), m = g[0], v = g[1], b = R(void 0 === t ? 100 : t, void 0 === s ? S : s), x = k({
            particles: b,
            duration: o,
            particleSize: void 0 === u ? 12 : u,
            force: void 0 === l ? 0.5 : l,
            width: void 0 === f ? 1000 : f,
    ...
    return i.useEffect(function () {
        ...
        children: m && (0, a.createPortal)((0, n.jsx)('div', h({ className: x.screen }, d ? { style: { zIndex: d } } : null, {

...
function L(e) {
  let {
onClose: s
  } = e, t = (0, o.e7)([u.ZP], () => u.ZP.getCandidateGames()), [i, l] = a.useState(null), _ = t.map(e => ({
key: e.pid,
value: e,
...
u.ZP,
N.Z
  ], () => (0, u.FZ)(t)), [A, g] = a.useState(!1), [R, f] = a.useState(null !== (s = m.name) && void 0 !== s ? s : '???'), D = r()(x.flexCenter, {
[p.game]: !i,
[p.activeGame]: i,
[M.card]: !i,
...
C.default.track(O.rMx.USER_SETTINGS_REPORT_INCORRECT_GAME_DETECTION, {
...
overrideExePaths: j(...u.ZP.getOverrides())
  ...
  return a.useEffect(() => ((0, I.Ky)(), I.P7), []), (0, n.jsxs)(c.FormSection, {
tag: 'h1',

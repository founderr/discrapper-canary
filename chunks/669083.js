...
var i, s, a = n(735250), o = n(470079), r = n(442837), l = n(481060), c = n(13245), d = n(906467), u = n(556296), h = n(237997), p = n(285952), f = n(739563), _ = n(998502), g = n(13140), m = n(658785), E = n(981631), Z = n(689938), I = n(793365), S = n(331651);
function C(e, t, n) {
...
function N() {
    let e = h.Z.getNotificationPositionMode(), t = e !== E._vf.DISABLED, n = u.Z.getOverlayKeybind(), i = u.Z.getOverlayChatKeybind();
...
class O extends o.PureComponent {
    ...
    renderTabBar() {
        let {selectedSection: e} = this.state, t = d.Z.isDeveloper ? (0, a.jsx)(l.TabBar.Item, {
                id: 'DEVELOPER',
    ...
    constructor(...e) {
        super(...e), C(this, 'state', { selectedSection: 'GENERAL' }), C(this, 'handleSelectSection', e => {
...
function A(e) {
    let {onClose: t} = e, {
        ...
        })), {showKeybindIndicators: d} = m.Z.useExperiment({ location: 'Overlay Settings' });
    return (0, a.jsx)(O, {
        onClose: t,
        avatarSizeMode: n,
        displayNameMode: i,

...
function v(e) {
  ...
  let {
    ...
    onDelete: T,
    onIconUpload: O
  } = e, G = (0, m.useUID)(), [p, A] = s.useState(null !== (l = null == f ? void 0 : f.title) && void 0 !== l ? l : ""), [D, U] = s.useState(null !== (a = null == f ? void 0 : f.description) && void 0 !== a ? a : ""), [B, M] = s.useState(function(e) {
  ...
  }(f)), b = (0, i.useStateFromStores)([x.default], () => {
    var e;
    ...
    var e, l;
    return (null !== (l = null === (e = x.default.getSettings()) || void 0 === e ? void 0 : e.resourceChannels) && void 0 !== l ? l : []).map(e => e.channelId)
    ...
    M(e)
  }, [M]), z = s.useCallback(e => Promise.resolve(N.default.getSelectableChannels(L).filter(l => (0, o.isChannelValidForResourceChannel)(l.channel) && !k.includes(l.channel.id) && d()(e, l.channel.name)).map(e => ({
    value: e.channel.id,
    label: e.channel.name
  }))), [L, k]), F = s.useCallback(e => {

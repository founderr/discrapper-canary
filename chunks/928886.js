...
function g(e) {
    ...
    let { renderHeader: n, referralTrialOfferId: a, handleClose: g } = e,
        { selectedSkuId: A, step: v, selectedPlan: R, purchaseState: x, purchaseType: P, selectedSku: I } = (0, S.usePaymentContext)(),
    ...
    return l.useMemo(() => {
        ...
        return e;
    }, [b, g, x, n, R, A, v, w, U, O, k, D, P, M, y, W]);
}

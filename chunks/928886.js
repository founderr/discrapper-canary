...
function y(e) {
  ...
  return l.useMemo(() => {
    ...
    else if (b) e = n(null != N ? N : null, y, v);
    ...
    return e
  }, [U, y, h, n, N, R, v, D, H, k, x, b, C, L, g, B])
}
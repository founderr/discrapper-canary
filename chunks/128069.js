...
var i, r, a, s, o, l, u, d, _ = n("544891"),
  c = n("812169"),
  E = n("34756"),
  I = n("689938");
...
function N(e) {
  ...
  if ("string" != typeof e && (null == e ? void 0 : null === (t = e.body) || void 0 === t ? void 0 : t.code) === _.INVALID_FORM_BODY_ERROR_CODE) {
    ...
    }(null === (a = e.body) || void 0 === a ? void 0 : a.errors) != null && (e.body = (0, _.convertSkemaError)(e.body.errors))
  }
  return new p(e)
}
...
T(p, "ErrorCodes", i), T(p, "Fields", r), T(p, "Sections", s), T(p, "CARD_ERRORS", h), T(p, "ADDRESS_ERRORS", m), t.default = p
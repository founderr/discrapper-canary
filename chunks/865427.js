...
var r = n(973361), i = n(729594), a = n(544891), o = n(358085), s = n(591759), l = n(908442);
n(981631);
let u = void 0, c = (0, o.isAndroid)() ? u.Version.split(' - ')[0] : (0, o.isIOS)() ? u.Version : void 0;
function d(e) {
    ...
    if (T(e))
        return Promise.resolve(function (e) {
            ...
            if (null == t || 2 !== t.length)
                return null;
            let n = (0, o.getNativePlatform)(), r = t[1];
            return {
                targetBuildOverride: {
                    ['discord_'.concat(n)]: {
                        type: 'branch',

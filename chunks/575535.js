...
function c(e) {
  let {
    ...
    null == o || o(s()(e), t)
  }, [o]), f = r.useMemo(() => t.toDate(), [t]), S = r.useMemo(() => null == a ? void 0 : a.toDate(), [a]), h = r.useMemo(() => null == n ? void 0 : n.toDate(), [n]), A = (0, u.useStateFromStores)([d.default], () => d.default.locale), m = r.useRef(null), N = r.useCallback(e => {

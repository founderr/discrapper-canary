n(653041), n(47120);
var a = n(735250), s = n(470079), r = n(120356), l = n.n(r), i = n(913527), o = n.n(i), c = n(920906), d = n(831209), u = n(149765), m = n(442837), h = n(481060), _ = n(787014), g = n(412899), x = n(607070), C = n(447003), f = n(605436), p = n(621516), T = n(430824), I = n(186523), E = n(585483), N = n(70956), b = n(709054), v = n(961675), S = n(883429), M = n(993259), A = n(109434), j = n(456269), R = n(228392), O = n(432771), Z = n(538366), L = n(470623), P = n(710352), w = n(981631), y = n(689938), D = n(152505);
function F(e, t, n) {
...
let G = e => {
        ...
        return (0, a.jsx)('div', {
            ...
            'aria-label': y.Z.Messages.ROLES_LIST.format({ numRoles: n.length }),
        ...
        let {
                ...
                let i = null == e ? void 0 : e.id, o = (0, m.e7)([T.Z], () => null != i ? T.Z.getRoles(i) : void 0);
                return s.useMemo(() => {
                    let s = new B(), i = (null == t ? void 0 : t.isMediaChannel()) === !0;
                    return null != e && null != t && !i && null != o && s.addStep(function (e, t, s, r) {
                        let l = (0, C.Z)(s) ? u.$e(w.Plq.VIEW_CHANNEL, w.Plq.SEND_MESSAGES) : w.Plq.SEND_MESSAGES, i = null != e ? (0, M.E$)(e, t, s, l).filter(t => s.permissionOverwrites.hasOwnProperty(t.id) || (0, f.pM)(e.id, t.id)) : [], o = i.length > 0, c = i.some(t => (0, f.pM)(e.id, t.id));
                        return {
...
t.Z = e => {
    let {
            hasAnyThread: t,
            channel: n
        } = e, {onboardingExpanded: r} = (0, L.xH)(e => {
            let {onboardingExpanded: t} = e;
            return { onboardingExpanded: t };
        }), {tagFilter: i} = (0, A.H)(n.id), o = (0, m.e7)([T.Z], () => T.Z.getGuild(n.getGuildId())), u = (0, j.r_)(n), {
            transitions: _,
            setVisible: g
    ...
    return (J(v, S, f), Q({
        ...
        (!t || !S) && O(!0);
    }, []), null == o) ? null : S && u ? R ? t ? null : (0, a.jsx)(p.Z, { channel: n }) : (0, a.jsx)(a.Fragment, {
                    ...
                    x((e, t) => t ? (0, a.jsx)(c.animated.div, {
                        ...
                        children: (0, a.jsx)('ol', {
                            ...
                            children: E.getSteps().map(e => (0, a.jsxs)(h.Clickable, {
                                ...
                                'aria-label': e.name,
                                onClick: () => C(e),
                                className: l()(D.stepContainer, { [D.completed]: e.isDone }),
                                children: [

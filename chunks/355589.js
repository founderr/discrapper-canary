...
let G = e => {
  ...
  q = (e, t) => s.useCallback(() => (t(!1), S.Z.hideAdminOnboarding(e, !0)), [e, t]),
  K = e => {
  ...
  X = (e, t, n, a) => {
    ...
    s.useEffect(() => (n || !e || t ? clearTimeout(r.current) : r.current = setTimeout(() => {
      a()
    }, 60 * N.Z.Millis.SECOND), () => clearTimeout(r.current)), [e, t, a, n])
  },
  J = (e, t, n) => {
    s.useEffect(() => {
      e && t && n()
        ...
        children: [(0, a.jsx)("div", {
          ...
          children: (0, a.jsxs)(h.HeadingLevel, {
            ...
            children: [(0, a.jsx)(h.Heading, {
              ...
              children: [(0, a.jsx)(h.CircleInformationIcon, {
                size: "xxs",
                color: "currentColor",
                className: D.icon
          ...
          children: (0, a.jsx)("ol", {
            ...
            children: E.getSteps().map(e => (0, a.jsxs)(h.Clickable, {
              ...
              children: [e.shouldWarn ? (0, a.jsx)(h.CircleExclamationPointIcon, {
                size: "custom",
                width: 20,
                height: 20,

!function (r) {
    var e, n = Object.prototype, o = n.hasOwnProperty, i = 'function' == typeof Symbol ? Symbol : {}, a = i.iterator || '@@iterator', c = i.asyncIterator || '@@asyncIterator', u = i.toStringTag || '@@toStringTag', s = r.regeneratorRuntime;
    if (s) {
        t.exports = s;
        return;
    }
    function f(t, r, n, o) {
        var i = Object.create((r && r.prototype instanceof d ? r : d).prototype), a = new O(o || []);
    ...
    var l = 'suspendedStart', p = 'executing', y = 'completed', v = {};
    function d() {
    }
    function g() {
    }

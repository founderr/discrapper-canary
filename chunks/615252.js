var r = n(444675);
let i = n(620633), a = n(517024), o = a.isObject, s = a.hasOwn;
function l() {
}
...
l.prototype._shouldRetry = function (e, t) {
    ...
    if (null == t)
        throw Error('.field(name, val) val can not be empty');
    ...
    let t = o(e), n = this._header['content-type'];
    if (this._formData)
    ...
    if (t && o(this._data))
        ...
        'string' == typeof e ? (!n && this.type('form'), (n = this._header['content-type']) && (n = n.toLowerCase().trim()), 'application/x-www-form-urlencoded' === n ? this._data = this._data ? `${ this._data }&${ e }` : e : this._data = (this._data || '') + e) : this._data = e;

var r = n(210887), i = n(626135), a = n(607070), o = n(94752);
let s = o.E.NONE, l = window.matchMedia('(prefers-color-scheme: dark)'), u = window.matchMedia('(prefers-color-scheme: light)'), c = window.matchMedia('(inverted-colors: inverted)'), d = window.matchMedia('(prefers-contrast: more)'), _ = window.matchMedia('(forced-colors: active)');
function E(e, t) {
    t ? s |= e : s &= ~e;
}
t.Z = {

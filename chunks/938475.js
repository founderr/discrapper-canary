...
var r, i = n(392711), a = n.n(i), o = n(442837), s = n(759174), l = n(570140), u = n(598077), c = n(314897), d = n(592125), _ = n(271383), E = n(594174), f = n(979651), h = n(709054), p = n(51144), m = n(981631);
function I(e, t, n) {
...
function O(e, t, n) {
    var r;
    let i = E.default.getUser(n), a = null == i;
    null == i && (i = new u.Z({
        id: n,
        username: '...',
...
class R {
    updateVoiceState(e) {
        ...
        let t = f.Z.getVoiceState(this.guildId, e), n = this._voiceStates.get(e), r = E.default.getUser(e);
        if (null != t && null != r) {
            if (null == n)
                return this._voiceStates.set(e, O(t, this.guildId, e)), !0;
            if (n.voiceState !== t) {
                var i;
                let a = A(this.guildId, r), o = null !== (i = null == a ? void 0 : a.nick) && void 0 !== i ? i : p.ZP.getName(r);
    ...
    updateMember(e) {
        if (null != this._pending)
            return this._pending.add(e), !1;
        let t = this._voiceStates.get(e), n = E.default.getUser(e);
        if (null != t && null != n) {
            var r, i;
...
I(D, 'displayName', 'SortedVoiceStateStore'), t.ZP = new D(l.Z, {
    ...
    VOICE_CHANNEL_SELECT: function (e) {
        let {guildId: t} = e, n = c.default.getId();
    ...
    PASSIVE_UPDATE_V2: function (e) {
        var t, n;
        let r = !1, i = new Set(null === (t = g[e.guildId]) || void 0 === t ? void 0 : t.getUserIds()), a = new Set(null === (n = e.voiceStates) || void 0 === n ? void 0 : n.map(e => e.userId)), o = new Set(e.removedVoiceStateUsers);

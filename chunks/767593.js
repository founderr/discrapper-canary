...
var o = t(735250), r = t(470079), a = t(920906), i = t(481060), s = t(442837), l = t(607070), c = t(963202), u = t(863249), d = t(944163), m = t(246364), f = t(983736), p = t(937111), h = t(200305), _ = t(271383), x = t(594174), b = t(153124), C = t(231467), I = t(981631), N = t(308083), E = t(689938), g = t(786698);
let v = {
        mass: 1,
        tension: 600,
        friction: 60
...
function T(e) {
    ...
    let _ = r.useMemo(() => {
        ...
        if (d > 0) {
            let n = f - a, t = s > 0 ? 1 - Math.min(s, d) / s : 1;
...
n.default = function (e) {
    ...
    let {
        ...
        }), D = null == k ? void 0 : k.verified, Z = null == k ? void 0 : k.isPhoneVerified(), [w, H] = r.useState(''), {enableApplication: V} = (0, c.Fg)('discovery');
    r.useEffect(() => {
    ...
    let Y = r.useCallback(async e => {
            ...
            M,
            O
        ]), z = !((null == M ? void 0 : null === (n = M.guild) || void 0 === n ? void 0 : n.verification_level) === I.sFg.VERY_HIGH ? Z : D || Z) || O.some(e => !(0, f.OA)(e)), G = (null !== (R = null == M ? void 0 : null === (t = M.guild) || void 0 === t ? void 0 : t.approximate_member_count) && void 0 !== R ? R : 0) >= N.Du, K = (0, s.e7)([l.Z], () => l.Z.useReducedMotion), Q = (0, a.useSpring)({
            from: {
                opacity: 0,

...
var i = n(512722), a = n.n(i), o = n(392711), s = n.n(o), l = n(544891), u = n(992774), c = n(649754), d = n(376398), _ = n(846519), E = n(570140), f = n(710845), h = n(314897), p = n(358085), m = n(998502), I = n(569545), T = n(70722), g = n(981631), S = n(65154);
let A = {}, N = new _.V7(), v = !1, O = window.document.createElement('canvas');
        ...
        try {
            let n = await function (e, t) {
                ...
                return (p.isPlatformEmbedded ? function (e, t) {
                    let n = (0, u.zS)(), i = (null == n ? void 0 : n.getNextVideoOutputFrame) != null;
            ...
            await function (e) {
                let t = 512 / e.width, n = Math.min(t, 288 / e.height), r = e.width * n, i = e.height * n;
                O.width = r, O.height = i;
                let a = window.document.createElement('canvas'), o = a.getContext('2d');
            ...
            if (E.Z.dispatch({
                ...
                a()(null != e, 'Auth token was null while sending screenshot.'), await m.ZP.makeChunkedRequest(g.ANM.STREAM_PREVIEW(t), { thumbnail: i }, {
                    method: 'POST',
                    token: e
                });
            } else

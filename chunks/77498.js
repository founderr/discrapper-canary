...
function T(e) {
    ...
    for (let n of (p.set(e.id, t), (m[e.name.toLowerCase()] = t), e.aliases)) m[n.toLowerCase()] = t;
...
_(b, 'displayName', 'GameStore'),
    _(b, 'persistKey', 'GameStore'),
    _(b, 'migrations', [
        (e) => {
            var t, n;
            if (null == e)

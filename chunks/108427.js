...
let o = new class e {
    ...
    requestIdleCallback(() => {
      a.default.track(e, {
        ... function() {
          var e, t, n;
          let s = "--campaign-id=";
          for (let a of null !== (n = null === r.default || void 0 === r.default ? void 0 : null === (t = r.default.processUtils) || void 0 === t ? void 0 : null === (e = t.getMainArgvSync) || void 0 === e ? void 0 : e.call(t)) && void 0 !== n ? n : [])
            if (a.startsWith(s)) return {
              referrer: a.substr(s.length)
            };
          return {}
        }(),
        ... function() {
  ...
  constructor() {
    l(this, "loadId", (0, s.v4)()), l(this, "appUIViewed", !1)
  }
};

...
var o = n(735250), t = n(470079), r = n(120356), a = n.n(r), l = n(481060), s = n(100527), c = n(906732), d = n(455708), u = n(153124), _ = n(626135), g = n(488499), E = n(58384), f = n(981631), T = n(689938), N = n(483273);
function I(e) {
    let {
            transitionState: i,
            onClose: r,
            ...
            showUpsellHeader: p,
            analyticsPage: R
        } = e, [m, x] = t.useState(!1), B = (0, l.useModalContext)(), b = (0, u.Dt)(), {analyticsLocations: A} = (0, c.ZP)(s.Z.GIF_PICKER);
    async function C(e) {
        let {gifSrc: i} = e;
        if (null == i || m)
            return;
        x(!0);
        let t = (0, E.Q)(i), a = await fetch(t), s = await a.blob();
        r(), (0, l.openModalLazy)(async () => {
            let {default: e} = await n.e('75409').then(n.bind(n, 850085));
            return i => (0, o.jsx)(e, {
                imgURI: t,

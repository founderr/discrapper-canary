...
var i = n(199902), l = n(158776), r = n(699516), o = n(626135), a = n(981631);
let s = e => {
        let {
            displayProfile: t,
            isMobile: n,
        ...
        if (null == e)
            return {};
        let n = e.userId, o = null != i.Z.getAnyStreamForUser(n), s = l.Z.findActivity(n, e => {
                let {type: t} = e;
                return o ? t === a.IIU.PLAYING : t !== a.IIU.CUSTOM_STATUS;
            }), c = null == s ? void 0 : s.assets, u = r.Z.isFriend(n);
        return {

...
function c(e) {
  ...
  let g = r.find(e => e.reName.test(h));
  if (null == g && null != c && (g = r.find(e => e.reName.test(c))), null != g && null != c) {
    let e = g.name(d).split(".").pop(),
      t = c.lastIndexOf(".");
    l = -1 !== t ? "".concat(c.substr(0, t), ".").concat(e) : "".concat(c, ".").concat(e)
  } else l = null != g ? g.name(d) : null != c ? c : "unknown";
  return {
    uri: u,
    filename: l,
    type: null !== (s = null != f ? f : null == g ? void 0 : g.type) && void 0 !== s ? s : "unknown",
    isVideo: -1 !== (null !== (a = null != f ? f : null == g ? void 0 : g.name(d)) && void 0 !== a ? a : "").indexOf("video"),
    isImage: -1 !== (null !== (o = null != f ? f : null == g ? void 0 : g.name(d)) && void 0 !== o ? o : "").indexOf("image")
  }
}
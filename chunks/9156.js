...
class J extends (r = s.ZP.PersistedStore) {
    ...
    resolveUnreadSetting(e) {
        if (f.Ec.has(e.type) || (0, f.hv)(e.type) || !X()) return b.i.ALL_MESSAGES;
    ...
    getGuildFavorites(e) {
        ...
        if (null == y[e]) {
            let t = a().filter(this.getChannelOverrides(e), (t) => {
                var n, r;
                return _.yE(null !== (r = t.flags) && void 0 !== r ? r : 0, I.ic.FAVORITED) && (null === (n = h.Z.getChannel(t.channel_id)) || void 0 === n ? void 0 : n.guild_id) === e;
            });
    ...
    isMessagesFavorite(e) {
        ...
        return _.yE(r, I.ic.FAVORITED);
    }
    isAddedToMessages(e) {
        var t, n;
        let r = null !== (n = null === (t = this.getChannelOverrides(null)[e]) || void 0 === t ? void 0 : t.flags) && void 0 !== n ? n : 0;
        return _.yE(r, I.ic.OPT_IN_ENABLED);
    }
    getAddedToMessages() {
        var e;
    ...
    getGuildUnreadSetting(e) {
        if (!X()) return b.i.ALL_MESSAGES;
        let t = this.getGuildFlags(e);
        return _.yE(t, I.vc.UNREADS_ALL_MESSAGES) ? b.i.ALL_MESSAGES : _.yE(t, I.vc.UNREADS_ONLY_MENTIONS) ? b.i.ONLY_MENTIONS : b.i.UNSET;
    }
    resolveGuildUnreadSetting(e) {
        let t = this.getGuildFlags(e.id);
        return !X() || _.yE(t, I.vc.UNREADS_ALL_MESSAGES) ? b.i.ALL_MESSAGES : _.yE(t, I.vc.UNREADS_ONLY_MENTIONS) ? b.i.ONLY_MENTIONS : e.defaultMessageNotifications === E.bL.ALL_MESSAGES ? b.i.ALL_MESSAGES : b.i.ONLY_MENTIONS;
    }
        ...
        null != e.userGuildSettings &&
            ...
            e.userGuildSettings.forEach((e) => {
                ...
                for (let t in e.channel_overrides) {
                    ...
                    (0, l.m$)(a) && n.add(t), _.yE(null !== (i = a.flags) && void 0 !== i ? i : 0, I.ic.OPT_IN_ENABLED) && r.add(t);
                }
                (x[t] = n), (w[t] = r);
            }));
    },

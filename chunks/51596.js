...
var l = n(570140), a = n(493683), i = n(475179), s = n(925549), r = n(287734), c = n(212819), o = n(336197), u = n(359110), d = n(769654), _ = n(131704), f = n(592125), E = n(283595), h = n(944486), S = n(914010), g = n(626135), I = n(777754), A = n(823385), p = n(981631), m = n(176505);
...
function y() {
    ...
    !function (e) {
        ...
        if (A.Z.isOpen())
            return;
        let n = S.Z.getGuildId(), l = h.Z.getChannelId(n);
        if (null != l) {
...
function M(e) {
    ...
    switch (_) {
    case c.h8.GUILD:
        (0, d.X)(h.id, { navigationReplace: !0 });
        break;
    case c.h8.TEXT_CHANNEL:
    ...
    case c.h8.USER:
        ...
        break;
    case c.h8.GROUP_DM:
        (0, u.Kh)(h.id, { navigationReplace: !0 }), s.Z.channelListScrollTo(p.ME, h.id);
        break;
    case c.h8.APPLICATION:
        ...
        break;
    case c.h8.LINK:
        (0, o.Z)(h.path, { navigationReplace: !0 });
    }
    l.Z.dispatch({

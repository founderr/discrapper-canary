...
function w(e) {
    ...
    switch (h) {
        ...
        case o.h8.VOICE_CHANNEL:
            ...
            break;
        case o.h8.USER:
            i.Z.openPrivateChannel([g.id], !1, !1, 'Quickswitcher'), r.Z.channelListScrollTo(A.ME, f.Z.getDMFromUserId(g.id));
            break;
        case o.h8.GROUP_DM:
            (0, u.Kh)(g.id, { navigationReplace: !0 }), r.Z.channelListScrollTo(A.ME, g.id);
            break;

...
function P(e) {
    ...
    switch (h) {
        ...
        case o.h8.VOICE_CHANNEL:
            ...
            break;
        case o.h8.USER:
            a.Z.openPrivateChannel([E.id], !1, !1, 'Quickswitcher'), i.Z.channelListScrollTo(I.ME, _.Z.getDMFromUserId(E.id));
            break;
        case o.h8.GROUP_DM:
            (0, u.Kh)(E.id, { navigationReplace: !0 }), i.Z.channelListScrollTo(I.ME, E.id);
            break;

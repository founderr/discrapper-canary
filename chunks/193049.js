...
var n = s(735250), i = s(470079), a = s(512722), r = s.n(a), l = s(990547), o = s(399606), u = s(481060), d = s(232567), c = s(809206), E = s(479531), _ = s(484459), m = s(594174), g = s(626135), S = s(51144), I = s(986197), T = s(135200), O = s(346585), N = s(347649), h = s(361117), f = s(108793), M = s(635774), L = s(387955), x = s(801461), C = s(448624), R = s(981631), A = s(689938), P = s(245280);
function v(e) {
    let t, {
            source: s,
            transitionState: a,
            onClose: v,
            oneClickFlow: y = !1
        } = e, [Z, U] = i.useState(y ? C.A.SUGGESTIONS : C.A.INFO), [G, b] = i.useState(!1), [j, D] = i.useState(null), [W, k] = i.useState(y ? x.Wq.SUGGESTION : x.Wq.NONE), [F, w] = i.useState(!1), [B, q] = i.useState(!1), H = i.useRef(null), X = (0, o.e7)([T.Z], () => T.Z.isCurrentUsernameInvalid()), V = (0, o.e7)([m.default], () => {
    ...
    let [Q, $] = i.useState({
            ...
            try {
                D(null), b(!0), await (0, c.S2)({ global_name: Q.globalName }), k(x.Wq.EDIT_USERNAME);
            } catch (t) {
            ...
            try {
                D(null), b(!0), await I.Z.createPomelo({ username: (0, O.R_)(Q.username) }, y), await (0, d.In)(V.id), k(x.Wq.PREVIEW);
            } catch (s) {
                let e = new E.Z(s), t = (null == e ? void 0 : e.status) != null && e.status >= 400 && e.status < 500 ? e.getAnyErrorMessage() : A.Z.Messages.ERROR_GENERIC_TITLE;
    ...
    return !F && null == j && (W === x.Wq.EDIT_USERNAME ? t = A.Z.Messages.POMELO_SUGGESTION_ORIGIN_NOTICE.format({ source: V.username }) : W === x.Wq.SUGGESTION && (K || null != Y) && (t = A.Z.Messages.POMELO_SUGGESTIONS_OCF)), (0, n.jsxs)(u.ModalRoot, {

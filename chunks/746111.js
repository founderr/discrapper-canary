...
function W(e, t, n, r) {
  let a = (0, V.useLocalizedStringFormatter)(U(H), "@react-aria/calendar"),
    i = q(e) || q(t),
    o = (0, V.useDateFormatter)({
      month: "long",
      year: "numeric",
      era: i,
...
function Y(e, t) {
  var n;
  let r, a, i, o, s, c = (0, V.useLocalizedStringFormatter)(U(H), "@react-aria/calendar"),
    l = (0, K.filterDOMProps)(e),
    u = W(t.visibleRange.start, t.visibleRange.end, t.timeZone, !1),
    d = W(t.visibleRange.start, t.visibleRange.end, t.timeZone, !0);
  (0, K.useUpdateEffect)(() => {
    !t.isFocused && (0, j.announce)(d)
  }, [d]);
  let p = (n = t, i = (0, V.useLocalizedStringFormatter)(U(H), "@react-aria/calendar"), "highlightedRange" in n ? {
    start: r,
    end: a
  } = n.highlightedRange || {} : r = a = n.value, o = (0, V.useDateFormatter)({
    weekday: "long",
    month: "long",
    year: "numeric",
    day: "numeric",
    era: q(r) || q(a),
    timeZone: n.timeZone
  }), s = "anchorDate" in n ? n.anchorDate : null, (0, _.useMemo)(() => {
    if (!s && r && a) {
  ...
  let [m, h] = (0, _.useState)(!1), v = e.isDisabled || t.isNextVisibleRangeInvalid();
  v && m && (h(!1), t.setFocused(!0));
  let [g, y] = (0, _.useState)(!1), b = e.isDisabled || t.isPreviousVisibleRangeInvalid();
...
function X(e, t, n) {
  let r = Y(e, t),
    a = (0, _.useRef)(!1),
    i = (0, _.useRef)("undefined" != typeof window ? window : null);
...
function Q(e, t, n) {
  ...
  } = G.get(t), s = (0, V.useLocalizedStringFormatter)(U(H), "@react-aria/calendar"), c = (0, V.useDateFormatter)({
    weekday: "long",
    day: "numeric",
    month: "long",
    year: "numeric",
  ...
  let m = (0, _.useMemo)(() => r.toDate(t.timeZone), [r, t.timeZone]),
  ...
  let y = (0, K.useDescription)(g),
    ...
    C = null;
  !a && (C = (0, z.isSameDay)(r, t.focusedDate) ? 0 : -1), (0, _.useEffect)(() => {
  ...
  let k = (0, V.useDateFormatter)({
      day: "numeric",
      timeZone: t.timeZone,
      calendar: r.calendar.identifier
    }),
    P = (0, _.useMemo)(() => k.formatToParts(m).find(e => "day" === e.type).value, [k, m]);
  return {
    cellProps: {
      role: "gridcell",

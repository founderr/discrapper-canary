...
e.default = (0, c.Z)((0, o.Z)(function(n) {
  ...
  } = (0, _.ZP)(d.Z.CONTEXT_MENU), y = (0, s.O)(), P = null !== (e = null == v ? void 0 : v[0]) && void 0 !== e ? e : j[0], m = (0, f.sE)(o, {
    location: P,
    targetUserId: t.id
  }), G = (0, r.e7)([Z.Z], () => {
    var n;
    return null !== (n = Z.Z.getUserVoiceChannelId(o, t.id)) && void 0 !== n ? n : void 0
  }, [o, t.id]), k = u.useCallback(() => {
    m(f.jQ.COPY_ID)
  }, [m]), w = (0, r.e7)([T.ZP], () => T.ZP.isMember(o, t.id), [o, t.id]), B = (0, S.Z)(t.id, o), F = (0, C.Z)(t.id, g), Y = (0, M.Z)({
    guildId: o,
    userId: t.id,
  ...
  return (0, l.jsxs)(i.Menu, {
    ...
    children: [!Q && (0, l.jsxs)(l.Fragment, {
      ...
      }), null != N ? q : null, R && null != z ? (0, l.jsx)(i.MenuGroup, {
        children: z
      }) : null]
    }), (0, l.jsx)(i.MenuGroup, {
      children: K

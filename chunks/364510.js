var a = r(33608), n = r(405458), s = Object.hasOwnProperty, o = Object.create(null);
for (var i in a)
    s.call(a, i) && (o[a[i]] = i);
var c = e.exports = {
    to: {},
...
c.get = function (e) {
    ...
    var e = n(arguments), t = Math.round(e[0] / 255 * 100), r = Math.round(e[1] / 255 * 100), a = Math.round(e[2] / 255 * 100);

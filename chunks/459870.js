...
function C(e, t) {
  ...
  let T = l.filter(t => {
    ...
    return l.id !== C.id && (N ? M.default.can(h.Permissions.CONNECT, l) && !(0, g.isChannelFull)(l, I.default, E.default) : M.default.can(h.Permissions.MOVE_MEMBERS, l) && (M.default.can(h.Permissions.CONNECT, l) || _.default.can({

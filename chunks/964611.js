...
var W = e => {
  let {
    ...
    intention: r,
    channel: u
  } = e, c = h.EmojiPickerStore.useStore(e => e.activeCategoryIndex), g = (0, y.useCategorySelectHandler)({
    sectionDescriptors: a,
    emojiListRef: n
    ...
    let n = v[t];
    if (n.type === x.EmojiCategoryTypes.RECENT) return B;

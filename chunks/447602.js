...
var E = (function (e) {
    ...
    function r() {
        ...
        return g(h((e = n.call.apply(n, [this].concat(a)))), 'priority', 30), g(h(e), 'incompatibleTokens', ['t', 'T']), e;
    }
    return (
        u(r, [
            {
                ...
                value: function (e, n) {
                    var r = function (e) {
                        return Math.floor(e * Math.pow(10, -n.length + 3));
                    };
                    return (0, a.jg)((0, a.ZL)(n.length, e), r);
                }
            },
            {
                key: 'set',

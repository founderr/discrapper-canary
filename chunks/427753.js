...
return function e(a, s) {
  ...
  if (a && s && 'object' == typeof a && 'object' == typeof s) {
    var o, l, u, c;
    if (a.constructor !== s.constructor)
      return !1;
    if (Array.isArray(a)) {
    ...
    if (n && a instanceof Map && s instanceof Map) {
      ...
      for (c = a.entries(); !(l = c.next()).done;)
        if (!s.has(l.value[0]))
          return !1;
      for (c = a.entries(); !(l = c.next()).done;)
        if (!e(l.value[1], s.get(l.value[0])))
          return !1;
      return !0;
    }
    ...
    if (a.toString !== Object.prototype.toString && 'function' == typeof a.toString && 'function' == typeof s.toString)
      return a.toString() === s.toString();
    if ((o = (u = Object.keys(a)).length) !== Object.keys(s).length)
      return !1;
    for (l = o; 0 != l--;)

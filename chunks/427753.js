...
return function e(a, o) {
  ...
  if (a && o && 'object' == typeof a && 'object' == typeof o) {
    var s, l, u, c;
    if (a.constructor !== o.constructor)
      return !1;
    if (Array.isArray(a)) {
    ...
    if (n && a instanceof Map && o instanceof Map) {
      ...
      for (c = a.entries(); !(l = c.next()).done;)
        if (!o.has(l.value[0]))
          return !1;
      for (c = a.entries(); !(l = c.next()).done;)
        if (!e(l.value[1], o.get(l.value[0])))
          return !1;
      return !0;
    }
    ...
    if (a.valueOf !== Object.prototype.valueOf && 'function' == typeof a.valueOf && 'function' == typeof o.valueOf)
      return a.valueOf() === o.valueOf();
    if (a.toString !== Object.prototype.toString && 'function' == typeof a.toString && 'function' == typeof o.toString)

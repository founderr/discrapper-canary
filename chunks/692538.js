var r = n(995769), i = Object.prototype.hasOwnProperty, a = Array.isArray, o = {
        allowDots: !1,
        allowEmptyArrays: !1,
        allowPrototypes: !1,
        allowSparse: !1,
        ...
        for (var i = r ? t : s(t, n), a = e.length - 1; a >= 0; --a) {
            var o, l = e[a];
            if ('[]' === l && n.parseArrays)
                o = n.allowEmptyArrays && '' === i ? [] : [].concat(i);
            else {
                o = n.plainObjects ? Object.create(null) : {};
                var u = '[' === l.charAt(0) && ']' === l.charAt(l.length - 1) ? l.slice(1, -1) : l, c = n.decodeDotInKeys ? u.replace(/%2E/g, '.') : u, d = parseInt(c, 10);
                n.parseArrays || '' !== c ? !isNaN(d) && l !== c && String(d) === c && d >= 0 && n.parseArrays && d <= n.arrayLimit ? (o = [])[d] = i : '__proto__' !== c && (o[c] = i) : o = { 0: i };
            }
            i = o;
        }
        return i;
        ...
        var t = void 0 === e.charset ? o.charset : e.charset, n = void 0 === e.duplicates ? o.duplicates : e.duplicates;

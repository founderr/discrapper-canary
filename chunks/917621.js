...
return (0, i.jsx)(o.Popout, {
  ...
  position: 'left',
  preload: () => (0, d.Z)(e.user.id, e.user.getAvatarURL(n, 80), {
    guildId: n
  }),
  children: a => {
    var s;
...
let {
  ...
  name: n,
  activity: a
} = this.props, s = this.isActionType(C.mFx.JOIN) || this.isActionType(C.mFx.JOIN_REQUEST), u = this.isDeadInvite(), d = null;
null == t || null == a || s ? !s && u && (d = (0, i.jsx)('div', {

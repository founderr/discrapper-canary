n(47120), n(653041);
var i = n(735250), a = n(470079), s = n(120356), r = n.n(s), l = n(692547), o = n(481060), c = n(484459), d = n(598077), u = n(285952), _ = n(936195), E = n(409216), I = n(63063), m = n(153066), T = n(51144), h = n(620662), N = n(994339), f = n(503438), p = n(981631), C = n(616922), g = n(689938), S = n(599723);
function A(e, t, n) {
...
class x extends a.PureComponent {
    render() {
        ...
        return (0, i.jsx)(o.Popout, {
            ...
            position: 'left',
            preload: () => (0, c.W)(e.user.id, e.user.getAvatarURL(n, 80), { guildId: n }),
            children: a => {
                var s;
...
class R extends a.PureComponent {
    ...
    renderParty() {
        ...
        if (null == e || this.isDeadInvite() || !l || n)
            return null;
        let o = [...t], c = Math.min(s, 6);
        for (; o.length < c;)
            o.push({
                user: new d.Z({ discriminator: '0005' }),
                unknownUser: !0
            });
    ...
    render() {
        ...
        let _ = null != a && null != d && null != a.assets && null != a.assets.large_text && '' !== a.assets.large_text && !c && (0, f.Z)(a) ? a.assets.large_text : null, E = null != _ ? (0, i.jsx)(o.Tooltip, {
                text: _,
                children: e => {
                    let {
                        onMouseEnter: t,
    ...
    constructor(...e) {
        super(...e), A(this, 'handleJoin', () => {
            ...
            return null != e ? (0, i.jsx)(x, {
                ...
                className: t,
                guildId: s
            }, n) : (0, i.jsx)('div', { className: r()(S.partyMemberEmpty, t) }, n);
        });
    }
}
t.Z = R;

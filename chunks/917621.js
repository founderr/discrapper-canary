...
class x extends a.PureComponent {
    ...
    renderActionButton() {
        ...
        return null != _
            ? _
            : !this.isDeadInvite() && this.isActionType(f.mFx.LISTEN) && null != s && null != l && null != r && (0, p.Ps)(s)
              ? c({
                    ...d,
                    activity: r,
                    user: l.author
    ...
    render() {
        ...
        let _ = null != a && null != d && null != a.assets && null != a.assets.large_text && '' !== a.assets.large_text && !u && (0, C.Z)(a) ? a.assets.large_text : null,
            E =
                null != _
                    ? (0, i.jsx)(o.Tooltip, {
                          text: _,

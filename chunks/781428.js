...
function Y() {
    return (0, r.jsx)(I.ZP, { children: (0, r.jsx)(h.Spinner, {}) });
}
class q extends (s = i.PureComponent) {
    ...
    componentDidMount() {
        ...
        e && !t ? (0, g.is)() : t && this.loginOrSSO(t, r, !0), j.default.track(w.rMx.LOGIN_VIEWED, {
            ...
            authenticated: t,
            ...null != n ? (0, N.Z)(n, !1, !1) : {}
        }, { flush: !0 }), null == p.Z && null != window.PublicKeyCredential && null != PublicKeyCredential.isConditionalMediationAvailable && PublicKeyCredential.isConditionalMediationAvailable().then(e => {
            e && (0, b.us)().then(e => {
                let {
                        challenge: t,
                        ticket: n
                    } = e, s = (0, a.wz)(JSON.parse(t));
                return s.signal = this.state.conditionalMediationAbortController.signal, (0, a.U2)(s).then(e => (_.Z.dispatch({ type: 'PASSWORDLESS_START' }), E.Z.loginWebAuthn({
                    ticket: n,
    ...
    componentDidUpdate(e) {
        let {
                authenticated: t,
                location: n
            } = this.props, {checkingHandoff: s} = this.state;
    ...
    loginOrSSO(e, t) {
        ...
        if (!!e && null != t)
            this.setState({ redirecting: !0 }), n ? E.Z.verifySSOToken().then(() => this.transitionSSO(t)) : this.transitionSSO(t);
    }
    transitionSSO(e) {
        let {
                transitionTo: t,
        ...
        if (delete r.redirect_to, null != n)
            ...
            let e = window.location.protocol + window.GLOBAL_ENV.API_ENDPOINT + w.ANM.SSO, t = {
                    ...r,
    ...
    renderHandOffAvailable() {
        ...
        return (0, r.jsxs)(I.ZP, {
            ...
            children: [
                ...
                (0, r.jsx)(I.DK, { children: V.Z.Messages.AUTH_BROWSER_HANDOFF_DETECTING_DESCRIPTION })
            ]
        });
    }
    ...
    renderDisabledAccount() {
        let {authBoxClassName: e} = this.props, t = this.props.loginStatus === w.u34.ACCOUNT_DISABLED, n = t ? V.Z.Messages.ACCOUNT_DISABLED_TITLE : V.Z.Messages.ACCOUNT_SCHEDULED_FOR_DELETION_TITLE, s = t ? V.Z.Messages.ACCOUNT_DISABLED_DESCRIPTION : V.Z.Messages.ACCOUNT_SCHEDULED_FOR_DELETION_DESCRIPTION;
        return (0, r.jsx)(I.ZP, {
            tag: 'form',
    ...
    renderDefaultForm(e) {
        ...
        return n = null == s || _ ? null != i ? (0, r.jsx)(B.Z, { giftCode: i }) : (0, r.jsxs)('div', {
            className: z.header,
            children: [
                (0, r.jsx)(I.Dx, {
                    className: K.marginBottom8,
                ...
                !1 === (0, G.isAndroidWeb)() ? (0, r.jsx)(I.DK, { children: V.Z.Messages.AUTH_LOGIN_BODY }, 'subtitle') : null
            ]
        }) : (0, r.jsx)(U.Z, { invite: s }), (0, r.jsxs)(P.Z, {
    ...
    renderGuildTemplate(e) {
        return (0, r.jsx)(F.Z, {
            ...
            children: () => [
                (0, r.jsx)(T.Z, { guildTemplate: e }, 'template'),

...
let A = s.memo(function(e) {
    ...
    }, [i]), S = s.useRef(null), [v, A] = s.useState(!1), [N, R] = s.useState(0), O = s.useCallback(() => {
      if (null != S.current) {
    ...
    }, [r, c, l, t.id, m, p, h, E]), k = s.useMemo(() => {
    ...
    let L = s.useMemo(() => {
      if (g.length > 0 && N > 1) {
        let [e, ...t] = g;
        return g.length > 1 && 2 === N ? _.default.Messages.USER_PROFILE_MUTUAL_FRIENDS_MANY_SHORT.format({
          usernameOne: x.default.getName(null, null, e),
          count: t.length
  ...
  N = s.memo(function(e) {
    ...
    }, [i]), N = s.useMemo(() => _.default.Messages.USER_PROFILE_MUTUAL_FRIENDS_SHORT.format({
      count: v.length
    }), [v]), R = s.useMemo(() => _.default.Messages.USER_PROFILE_MUTUAL_GUILDS_SHORT.format({
      count: A.length
    }), [A]), O = s.useRef(null), [M, k] = s.useState(!1), [L, P] = s.useState(!1), b = s.useCallback(() => {
      if (null != O.current) {
        var e;
...
var R = s.memo(function(e) {
  ...
  } = (0, c.default)(), m = null !== (n = null !== (t = null == r ? void 0 : r[0]) && void 0 !== t ? t : null == f ? void 0 : f[0]) && void 0 !== n ? n : null, h = (0, u.useStateFromStores)([p.default], () => p.default.getId()), x = i.id === h, y = i.bot || x, {
    compact: C,
    enabled: T

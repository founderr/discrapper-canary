let r;
var i, a, o, s, l = n(259443), u = n(442837), c = n(570140), d = n(818083), _ = n(353926), E = n(988348), f = n(987338);
let h = (0, d.B)({
...
function A() {
    ...
    let e = h.getCurrentConfig({ location: 'GatewayZstdStore' }), t = e.useZstd;
...
o = 'GatewayZstdStore', (a = 'displayName') in (i = v) ? Object.defineProperty(i, a, {
    ...
    CONNECTION_INTERRUPTED: function (e) {
        let {code: t} = e;
        if (!!S() && !!g && 1000 !== t)
            (T += 1) > 3 && (m.error('Disabling zstd due to consecutive errors'), N(!1), I = !0);
    },

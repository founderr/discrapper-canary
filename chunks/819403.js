...
function S(n) {
  ...
  let t = (0, E.Z)(),
    ...
    A = (0, u.e7)([r.Z], () => r.Z.getGuild(f), [f]),
    I = (0, u.e7)([s.Z], () => null != S ? s.Z.getVoiceStateForChannel(S, n.id) : null, [S, n.id]),
    N = (null === (e = a.default.getCurrentUser()) || void 0 === e ? void 0 : e.id) === n.id,
    M = (0, _.Z)(),
    O = (0, u.e7)([c.ZP], () => c.ZP.getPermissionsForUser(n.id, S), [S, n.id]),
    Z = (0, o.B)(S);
  if (null == t || null == A || null == I || O.speaker) return null;
  let g = () => {

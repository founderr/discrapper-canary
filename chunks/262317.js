    ...
    constructor(...e) {
        super(...e),
            ...
            O(this, 'handleWatchStream', () => {
                ...
                S.default.getId() !== e.id && p.default.selectVoiceChannel(t.id), n ? ((0, I.Z)(l), u.Z.selectParticipant(l.channelId, (0, v.V9)(l))) : (0, m.iV)(l), null == i || i(e.id);
            }),

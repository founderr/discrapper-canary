      ...
      switch (i.label) {
        case 0:
          ...
          if (null != this.messages[t])
            return [2];
          return e = performance.now(), r = this.localeImportMap[t](), this._localeLoadingPromises[t] = r, n = this.messages, o = t, [
            4,
            r
          ];
        case 1:
          return n[o] = i.sent().default, delete this._localeLoadingPromises[t], a = performance.now(), console.warn('[INTL] Took '.concat(a - e, 'ms to load ').concat(t, ' with ').concat(Object.keys(this.messages[t]).length, ' keys')), this.emitChange(), [2];
      }
    });
  });

...
var i, s = n(470079), a = n(392711), o = n.n(a), r = n(699581), l = n(374470), c = n(902704), d = n(846519), u = n(13245), h = n(671999), p = n(358085), f = n(998502), _ = n(145597);
function g(e, t, n) {
...
function S(e, t) {
    if (null == t)
        I.delete(e), 0 === I.size && (window.removeEventListener('mousemove', Z), E = !1);
    else {
        let n = I.get(e);
        if (null != n && (0, c.Z)(n.zone, t.zone))
            return;
        0 === I.size && window.addEventListener('mousemove', Z), I.set(e, t);
    }
    p.isPlatformEmbedded && ((0, _.W2)() ? u.Z.setClickZones(Array.from(I.values()).map(e => {
        let {zone: t} = e;
        return {
            name: t.name,

...
function F(e) {
  let {
    ...
    notFriend: t.type === y.ChannelTypes.DM && null != g && !v.default.isFriend(g),
    isBlocked: t.type === y.ChannelTypes.DM && null != g && v.default.isBlocked(g)

...
var r, i, a, o, s = n(442837), l = n(570140), u = n(740504), c = n(853856), d = n(314897), _ = n(592125), E = n(984933), f = n(430824), h = n(981631);
let p = null, m = {}, I = null;
function T() {
    return {
        _categories: [],
...
function A(e) {
    let t = E.ZP.getChannels(e), n = T(), r = e => {
            var t;
            let {channel: r} = e;
    ...
    return t[h.d4z.GUILD_CATEGORY].forEach(e => {
        let {channel: t} = e;
        n._categories.push({
            channel: t,
            index: -1

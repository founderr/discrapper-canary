...
function C(e, n) {
  ...
  if (!T && !M.Z.can(N.Plq.MOVE_MEMBERS, C)) return null;
  let v = t.filter(n => {
    let {
      channel: t
    } = n;
    return t.id !== C.id && (T ? M.Z.can(N.Plq.CONNECT, t) && !(0, I.rY)(t, g.Z, E.Z) : M.Z.can(N.Plq.MOVE_MEMBERS, t) && (M.Z.can(N.Plq.CONNECT, t) || m.BT({

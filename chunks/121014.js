...
r.prototype = {
    ...
    removeNode: function (e) {
        this.hasNode(e) && (delete this.nodes[e], delete this.outgoingEdges[e], delete this.incomingEdges[e], [
            this.incomingEdges,
            this.outgoingEdges
        ].forEach(function (t) {
    ...
    addDependency: function (e, t) {
        if (!this.hasNode(e))
            throw Error('Node does not exist: ' + e);
        if (!this.hasNode(t))
            throw Error('Node does not exist: ' + t);
    ...
    overallOrder: function (e) {
        var t = this, r = [], i = Object.keys(this.nodes);
        if (0 === i.length)
            return r;

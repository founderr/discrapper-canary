...
var r = n(278074), i = n(979554), a = n(922347), o = n(587177), s = n(311850), l = n(803358), u = n(212161), c = n(981631);
function d(e, t, n) {
...
class _ extends l.Z {
    static fromServer(e) {
        ...
        return new _({
            ...
            categorySkuId: l,
            prices: (0, s.l)(d),
            items: f.items.reduce((e, t) => (0, r.EQ)(t).with({ type: i.Z.AVATAR_DECORATION }, t => (e.push(a.Z.fromServer(t)), e)).with({ type: i.Z.PROFILE_EFFECT }, t => (e.push(u.Z.fromServer(t)), e)).otherwise(() => e), []),

...
var r, i = n(264344), a = n.n(i), o = n(259443), s = n(46973), l = n(912095), u = n(886848), c = n(649318), d = n(65154), _ = n(436620);
function E(e, t, n) {
...
class p extends l.Z {
    ...
    setCodecs(e, t, n) {
        var r, i, a;
        let o;
        if (this.audioCodec !== e || this.videoCodec !== t)
            o = this.codecs.find(t => t.name === e), this.audioCodec = e, this.audioPayloadType = null !== (r = null == o ? void 0 : o.payloadType) && void 0 !== r ? r : 0, o = this.codecs.find(e => e.name === t), this.videoCodec = t, this.videoPayloadType = null !== (i = null == o ? void 0 : o.payloadType) && void 0 !== i ? i : 0, this.rtxPayloadType = null !== (a = null == o ? void 0 : o.rtxPayloadType) && void 0 !== a ? a : 0, this.logger.info('Renegotiating: Codecs changed'), this.handleNegotiationNeeded();
    }
    setStream(e) {
    ...
    createUser(e, t, n) {
        ...
        let i = !1, a = this.users.get(e);
        if (null == a && (a = {}), a.audioSSRC !== t) {
            a.audioSSRC = t, i = !0, this.unassignedStreams.audio.push({
                cname: e,
                ssrc: t
            });
            let n = this.inactiveTransceivers.audio.length, r = this.unassignedStreams.audio.length;
        ...
        if (this.videoSupported && void 0 !== n && (!f || void 0 === a.videoSSRC)) {
            ...
            if (t > 0) {
                if (a.videoSSRC !== t) {
                    a.videoSSRC = t, i = !0, this.unassignedStreams.video.push({
                        cname: e,
                        ssrc: t
                    });
                    let n = this.inactiveTransceivers.video.length, r = this.unassignedStreams.video.length;
                    this.addTransceivers('video', 'recvonly', 10 + r - n);
                }
            } else
                null != a.videoSSRC && (a.videoSSRC = void 0, i = !0);
        }
        if (i) {
    ...
    setTransceiverEncodingParameters(e, t) {
        if (null == e || 0 === t.length)
            return;
        let n = e.sender, r = n.getParameters();
        if (null == r.encodings)
            return;
        let i = !1;
        for (let e of r.encodings)
            for (let {
                ...
                e[n] !== r && (this.logger.info('UnifiedConnection.setTransceiverEncodingParameters: '.concat(n, ': from \'').concat(e[n], '\' to \'').concat(r, '\'')), i = !0, e[n] = r);
        if (!i)
            return;
        let a = e => {
            this.logger.error('UnifiedConnection.setTransceiverEncodingProperty: setParameters failed: "'.concat(e, '" (').concat(JSON.stringify(t), ')"'));
        };
        n.setParameters(r).then(() => {
        }, e => a(e)).catch(e => a(e));
    }
    setAudioEncoderParameters(e) {
        let t = { [l.p.AUDIO_BITRATE]: 'maxBitrate' }, n = [];
        for (let {
                    parameter: r,
                    value: i
                } of e) {
    ...
    parseLocalDescription() {
        ...
        if (null == e)
            throw Error('localDescription is null');
        let t = e.sdp, {
                outboundStreams: n,
                codecs: r,
                audioSSRC: i,
        ...
        return this.outboundStreams = n, this.codecs = r, this.extensions = (0, c.nX)(t), this.audioSSRC = i, this.videoReady = a > 0 && o > 0, (this.videoStreamParameters[0].ssrc !== a || this.videoStreamParameters[0].rtxSsrc !== o || this.videoReady) && (this.videoStreamParameters[0].ssrc = 0 === a ? this.videoStreamParameters[0].ssrc : a, this.videoStreamParameters[0].rtxSsrc = 0 === o ? this.videoStreamParameters[0].rtxSsrc : o, this.videoStreamParameters[0].active = this.videoReady, this.emit(s.Sh.Video, this.userId, this.input.getVideoStreamId(), this.audioSSRC, a, o, this.videoStreamParameters)), t;
    }
    addTransceivers(e, t, n, r) {
        let i = this.pc, a = i.getTransceivers().length;
        for (let o = a; o < a + n; o++)
            'video' === e && null != r ? i.addTransceiver(e, {
                direction: t,
                streams: [r]
            }) : i.addTransceiver(e, { direction: t }), this.inactiveTransceivers[e].push(o.toString());
    }
    buildSSRCsFromOutboundStreams() {
        return this.outboundStreams.map(e => {
            ...
            if (null != i) {
                let e = this.users.get(i.cname), r = 'audio' === n ? null == e ? void 0 : e.audioSSRC : null == e ? void 0 : e.videoSSRC;
                i.ssrc !== r && (i = void 0, this.assignedStreams.delete(t));
            }
            let a = this.unassignedStreams[n], o = this.inactiveTransceivers[n], s = o.indexOf(t);
            return null == i && a.length > 0 && -1 !== s && (i = a.pop(), o.splice(s, 1), this.assignedStreams.set(t, i)), null == i && (i = {
                ssrc: -1,
                cname: ''
            }), {
                ssrc: i.ssrc,
    ...
    generateSDPAnswer() {
        var e, t;
        let n = this.audioCodec, r = this.audioPayloadType, i = this.videoCodec, a = this.videoPayloadType, o = this.videoSupported && (null === (t = this.videoTransceiver) || void 0 === t ? void 0 : null === (e = t.sender) || void 0 === e ? void 0 : e.track) != null, s = this.rtxPayloadType, l = this.sdp;
        if (null == n || null == r || null == i || null == a || null == s || null == l)
            throw Error('Invalid payload: audioCodec: '.concat(n, ', audioPayloadType: ').concat(null == r ? 'null' : r, ', videoCodec: ').concat(i, ', videoCodecPayloadType: ').concat(null == a ? 'null' : a, ', rtxPayloadType: ').concat(null == s ? 'null' : s, ', sdp: ').concat(null == l ? 'null' : l));
    ...
    async setRemoteAnswer() {
        let e = this.pc, t = this.generateSDPAnswer();
    ...
    setConnected() {
        this.input.reset(), this.setConnectionState(d.$j.CONNECTED), this.on(s.Sh.Stats, this.handleStats), this.input.on(u.G.VoiceActivity, this.handleVoiceActivity);
    }
    async handleNegotiationNeeded() {
        ...
        let t = this.pc, n = await t.createOffer(this.makeOfferAnswerOptions());
        await t.setLocalDescription(n);
        let r = this.parseLocalDescription();
        null == this.sdp ? this.emit(s.Sh.Connected, 'webrtc', (0, c.sc)(r)) : this.setRemoteAnswer();
    }
    constructor(e, t, n, r) {
        super(e, t, n, r), E(this, 'pc', void 0), E(this, 'sdp', null), E(this, 'negotiating', !1), E(this, 'negotiationNeeded', !1), E(this, 'audioTransceiver', void 0), E(this, 'videoTransceiver', void 0), E(this, 'users', new Map()), E(this, 'userIdsBySsrc', new Map()), E(this, 'assignedStreams', new Map()), E(this, 'unassignedStreams', {
            audio: [],
            video: []
            ...
            let t = e.streams[0].id, n = e.track;
            if (!/^default/.test(n.id)) {
                var r, i, a, o;
                let [e, s] = t.split('-');
                this.trackUserIds[n.id] = e;
                let l = this.users.get(e);
                if ((null == l ? void 0 : null === (i = l.videoSSRC) || void 0 === i ? void 0 : null === (r = i.toString) || void 0 === r ? void 0 : r.call(i)) !== s && (null == l ? void 0 : null === (o = l.audioSSRC) || void 0 === o ? void 0 : null === (a = o.toString) || void 0 === a ? void 0 : a.call(o)) !== s) {
        ...
        }), this.logger = new o.Y('UnifiedConnection('.concat(e, ')')), this.videoSupported = _.U8;
        let i = this.pc = new RTCPeerConnection({
            bundlePolicy: 'max-bundle',
            sdpSemantics: 'unified-plan'
        });
        _.X6 ? (i.onconnectionstatechange = this.handlePeerConnectionStateChange, i.oniceconnectionstatechange = this.handlePeerConnectionStateChange) : i.oniceconnectionstatechange = this.handleIceConnectionStateChange, i.onsignalingstatechange = this.handleSignalingStateChange, i.onicegatheringstatechange = this.handleIceGatheringStateChange, i.ontrack = this.handleTrack, i.addTransceiver('audio', {
            direction: 'recvonly',
            sendEncodings: [{ maxBitrate: this.voiceBitrate }]
        }), this.audioTransceiver = i.getTransceivers()[0], this.videoSupported && (this.addTransceivers('video', 'recvonly', 1, this.input.getVideoStream()), this.videoTransceiver = i.getTransceivers()[1]), this.addTransceivers('audio', 'recvonly', 10), this.videoSupported && this.addTransceivers('video', 'recvonly', 10), this.setStream(this.input.stream), this.logger.info('Renegotiating: Initial negotiation'), this.handleNegotiationNeeded(!0);
    }
}

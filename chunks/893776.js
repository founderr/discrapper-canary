...
var i, a, o = n(990547), s = n(213919), l = n(544891), u = n(433517), c = n(570140), d = n(881052), _ = n(882037), E = n(710845), f = n(57132), h = n(703656), p = n(365007), m = n(314897), I = n(480294), T = n(573261), g = n(572691), S = n(981631), A = n(792101);
let N = new E.Z('AuthenticationActionCreators'), v = null;
function O(e) {
    let t = {
        type: 'LOGOUT',
        ...e
...
(a = i || (i = {})).MFA = 'MFA', a.SUCCESS = 'SUCCESS', t.Z = {
    ...
    login(e) {
        ...
        c.Z.dispatch({
            ...
            }) : o === S.evJ.PHONE_VERIFICATION_REQUIRED ? c.Z.dispatch({ type: 'LOGIN_PHONE_IP_AUTHORIZATION_REQUIRED' }) : c.Z.dispatch({
                type: 'LOGIN_FAILURE',
                error: new d.yZ(e)
            });
        });
    ...
    loginMFAv2(e) {
        ...
        return T.Z.post({
            ...
            retries: 2,
            oldFormErrors: !0,
            trackedActionData: { event: o.NetworkActionNames.USER_LOGIN_MFA }
        }).then(e => {
    ...
    authenticatePasswordless(e) {
        ...
        return null == n || n.abort('Starting non-conditional mediation'), c.Z.dispatch({ type: 'PASSWORDLESS_START' }), (0, p.d$)().then(e => {
            let {
                challenge: n,
                ticket: a
            } = e;
    ...
    loginWebAuthn(e) {
        ...
        return T.Z.post({
            ...
            retries: 1,
            trackedActionData: { event: o.NetworkActionNames.USER_LOGIN_PASSWORDLESS }
        }).then(e => {
            let {
                body: {
                    token: t,
    ...
    loginToken(e) {
        ...
        return c.Z.dispatch({ type: 'LOGIN' }), new Promise(n => {
            setImmediate(() => {
                c.Z.dispatch({
                    type: 'LOGIN_SUCCESS',
                    token: e
    ...
    logout() {
        var e;
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : S.Z5c.DEFAULT_LOGGED_OUT, n = arguments.length > 1 ? arguments[1] : void 0;
        return T.Z.post({
            url: S.ANM.LOGOUT,
            body: {
                provider: (0, A.xJ)(),
            ...
            oldFormErrors: !0,
            trackedActionData: { event: o.NetworkActionNames.USER_LOGOUT },
            ...null != n && { headers: { authorization: null !== (e = s.getToken(n)) && void 0 !== e ? e : '' } }
        }).finally(() => {
            (null == n || n === m.default.getId()) && R(t);
        });
    },
    switchAccountToken(e) {
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = m.default.getToken();
    ...
    verify(e) {
        null != e ? T.Z.post({
            ...
            body: { token: e },
            oldFormErrors: !0,
            trackedActionData: { event: o.NetworkActionNames.USER_VERIFY }
        }).then(e => {
            c.Z.dispatch({
                type: 'LOGIN_SUCCESS',
                token: e.body.token
    ...
    async authorizePayment(e) {
        try {
            await T.Z.post({
                ...
                body: { token: e },
                oldFormErrors: !0,
                trackedActionData: { event: o.NetworkActionNames.AUTHORIZE_PAYMENT }
    ...
    async authorizeIPAddress(e) {
        ...
        try {
            await T.Z.post({
                ...
                body: { token: e },
                oldFormErrors: !0,
                trackedActionData: { event: o.NetworkActionNames.AUTHORIZE_IP }
            }), c.Z.dispatch({ type: 'VERIFY_SUCCESS' });
        } catch (e) {
            c.Z.dispatch({
                type: 'VERIFY_FAILURE',
    ...
    verifyResend: () => T.Z.post({
        ...
        oldFormErrors: !0,
        trackedActionData: { event: o.NetworkActionNames.USER_VERIFY_RESEND }
    }),
    async resetPassword(e, t, n) {
        ...
        try {
            let {
                ...
                body: r,
                oldFormErrors: !0,
                trackedActionData: { event: o.NetworkActionNames.USER_RESET_PASSWORD }
            });
            return {
    ...
    async resetPasswordMFAv2(e) {
        ...
        return c.Z.dispatch({ type: 'LOGIN_MFA' }), (await T.Z.post({
            url: S.ANM.RESET_PASSWORD,
            body: {
                code: n,
                ticket: r,
    ...
    async forgotPassword(e) {
        ...
        try {
            await T.Z.post({
                ...
                body: { login: e },
                oldFormErrors: !0,
                trackedActionData: { event: o.NetworkActionNames.FORGOT_PASSWORD }
            }), c.Z.dispatch({ type: 'FORGOT_PASSWORD_SENT' });
        } catch (t) {
            let e = new d.yZ(t);
            throw e.code === S.evJ.PHONE_VERIFICATION_REQUIRED ? c.Z.dispatch({ type: 'LOGIN_PASSWORD_RECOVERY_PHONE_VERIFICATION' }) : c.Z.dispatch({
                type: 'LOGIN_FAILURE',
                error: e
            }), t;
        }

...
function R(e) {
  let {
    channel: t,
    onSelect: n
  } = e, o = (0, I.default)(t), l = (0, g.default)(t), s = (0, f.useAddToFavoritesItem)(t), c = (0, f.useRemoveFromFavoritesItem)(t), _ = (0, h.default)(t), v = (0, p.default)(t), x = (0, E.default)(t), O = (0, N.default)(t), P = (0, b.default)(t), S = (0, C.default)(t), A = (0, d.default)({
    id: t.id,
...
function T(e) {
  let {
    ...
    guild: n,
    onSelect: o
  } = e, l = (0, I.default)(t), u = (0, g.default)(t), s = (0, f.useAddToFavoritesItem)(t), c = (0, f.useRemoveFromFavoritesItem)(t), h = (0, S.default)(t), p = (0, N.default)(t), E = (0, C.default)(t), A = (0, O.default)(t, n), R = (0, _.default)(t, n), T = (0, v.default)(t, n), L = (0, x.default)(t), U = (0, d.default)({
    id: t.id,
    label: M.default.Messages.COPY_ID_CHANNEL
  ...
  return (0, r.jsxs)(i.Menu, {
    ...
    children: [(0, r.jsxs)(i.MenuGroup, {
      children: [l, s]
    }, "mark-as-read-or-favorite"), (0, r.jsxs)(i.MenuGroup, {
      children: [A, h, u, F]

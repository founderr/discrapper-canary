...
function R(e) {
    ...
    let L = a.useMemo(() => A(t, t.avatar), [t]),
        j = a.useCallback(() => {
            let e = ''.concat((0, o.K0)(!1)).concat(O.ANM.WEBHOOK_INTEGRATION(t.id, t.token));
            (0, h.JG)(e);
        }, [t]),
        D = a.useCallback(() => {
            (0, d.openModal)((e) =>
                        ...
                        children: [
                            ...
                            (0, i.jsxs)(m.Z, {
                                ...
                                children: [
                                    ...
                                    (0, i.jsx)(d.FormDivider, { className: C.bottomDivider }),
                                    (0, i.jsxs)(m.Z, {
                                        children: [
                                            (0, i.jsx)(d.Tooltip, {
                                                ...
                                                children: (e) => {
                                                    let { onClick: n, onMouseEnter: a, onMouseLeave: s, onBlur: l, onFocus: o, ...r } = e;

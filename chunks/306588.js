...
class k extends s.PureComponent {
  ...
  render() {
    ...
    if (e && !p) I.message = H.default.Messages.FOLLOW_NEWS_CHAT_INPUT_MESSAGE, null != E && E >= 1e3 && (I.subtitle = H.default.Messages.FOLLOW_NEWS_CHAT_INPUT_SUBTITLE.format({
    ...
    else if (l) I.message = H.default.Messages.GUILD_VERIFICATION_TEXT_NOT_CLAIMED, I.buttonText = H.default.Messages.CLAIM_ACCOUNT, I.onButtonClick = _ ? this.handleShowMemberVerification : this.handleClaimAccount, I.imageSrc = n("524939");
...
function w(e) {
  ...
  let {
    channel: s,
    children: l
  } = e, i = s.getGuildId(), o = (0, r.useStateFromStores)([y.default], () => y.default.getGuild(i)), u = (0, r.useStateFromStores)([x.default], () => x.default.getCheck(i)), d = s.type === b.ChannelTypes.GUILD_ANNOUNCEMENT && null != o && o.hasFeature(b.GuildFeatures.NEWS), c = (0, r.useStateFromStores)([L.default], () => d ? L.default.getFollowerStatsForChannel(s.id) : null), h = (0, r.useStateFromStores)([T.default], () => T.default.isLurking(i)), C = (0, r.useStateFromStores)([D.default], () => D.default.getCurrentUser()), p = null !== (t = null == C ? void 0 : C.isStaff()) && void 0 !== t && t, E = (0, r.useStateFromStores)([R.default], () => {
    var e, t;
    return null != C && null !== (t = null === (e = R.default.getMember(i, C.id)) || void 0 === e ? void 0 : e.isPending) && void 0 !== t && t
  }), _ = !!(null == o ? void 0 : o.hasVerificationGate()), A = (E || u.notClaimed) && _, M = (0, r.useStateFromStores)([S.default], () => S.default.shouldShowPopout(i)), N = (0, r.useStateFromStores)([O.default], () => O.default.can(b.Permissions.SEND_MESSAGES, s)), I = (0, r.useStateFromStores)([g.default], () => g.default.getRequest(i)), j = {
    ...u,
    guild: o,
    isLurking: h,
    isFollowable: d,
    ...
    showMemberVerificationModal: A,
    guildJoinRequestStatus: null !== (n = null == I ? void 0 : I.applicationStatus) && void 0 !== n ? n : m.GuildJoinRequestApplicationStatuses.STARTED,
    guildJoinRequest: I,

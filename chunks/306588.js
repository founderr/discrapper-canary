...
class k extends a.PureComponent {
  ...
  render() {
    ...
    else if (l) N.message = H.default.Messages.GUILD_VERIFICATION_TEXT_NOT_CLAIMED, N.buttonText = H.default.Messages.CLAIM_ACCOUNT, N.onButtonClick = S ? this.handleShowMemberVerification : this.handleClaimAccount, N.imageSrc = n("524939");
  ...
  constructor(...e) {
    super(...e), this.state = {
      ...
      return i(null != n, "This guildID cannot be null"), (0, s.jsx)(A.default, {
        onClose: t,
        guild: n
      })

...
function w(e) {
  ...
  }), S = !!(null == o ? void 0 : o.hasVerificationGate()), T = (m || u.notClaimed) && S, M = (0, r.useStateFromStores)([A.default], () => A.default.shouldShowPopout(i)), I = (0, r.useStateFromStores)([O.default], () => O.default.can(P.Permissions.SEND_MESSAGES, a)), N = (0, r.useStateFromStores)([E.default], () => E.default.getRequest(i)), b = {
    ...u,
    guild: o,
    isLurking: h,
    isFollowable: d,

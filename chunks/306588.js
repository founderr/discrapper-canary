...
class k extends s.PureComponent {
  ...
  render() {
    ...
    if (e && !p) I.message = F.default.Messages.FOLLOW_NEWS_CHAT_INPUT_MESSAGE, null != E && E >= 1e3 && (I.subtitle = F.default.Messages.FOLLOW_NEWS_CHAT_INPUT_SUBTITLE.format({
...
function w(e) {
  ...
  }), S = !!(null == o ? void 0 : o.hasVerificationGate()), A = (E || u.notClaimed) && S, M = (0, r.useStateFromStores)([_.default], () => _.default.shouldShowPopout(i)), N = (0, r.useStateFromStores)([O.default], () => O.default.can(b.Permissions.SEND_MESSAGES, s)), I = (0, r.useStateFromStores)([g.default], () => g.default.getRequest(i)), j = {
    ...u,
    guild: o,
    isLurking: h,
    isFollowable: d,

...
t.default = e => {
  ...
  let {
    ...
    Y()
  }, Q = (0, i.useStateFromStores)([c.default], () => c.default.locale), q = x === p.QuestContent.QUESTS_EMBED, J = x === p.QuestContent.QUEST_INVENTORY_CARD, Z = J && B, X = j && !b, $ = (0, s.jsx)(A.default, {
    autoplay: U,
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [(0, s.jsx)(o.Tooltip, {
      text: X ? O.default.Messages.QUESTS_REWARD_TILE_EXPIRED_QUEST : null,

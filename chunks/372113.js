...
var a = n(120356),
  ...
  x = n(817024),
  v = n(789002);
let Z = (e, t, n) => (0, S.uq)(e) && !n && 'lg' === t ? 'text-lg/medium' : 'lg' === t ? 'text-md/medium' : 'sm' === t ? 'text-sm/medium' : 'text-xs/medium';
...
inGiftInventory: u
  } = e, d = n >= E.OH.COMPLETED, _ = (0, r.e7)([o.Z], () => o.Z.useReducedMotion), m = (0, r.e7)([I.Z], () => I.Z.isEnrolling(t.id)), h = (0, T.zK)(t, M.S7.IN_HOUSE_CONSOLE_QUEST), N = (0, C.Ks)({
progressState: n,
quest: t,
isInHouseQuest: h,
location: s,
...
questContentPosition: c,
inGiftInventory: u
  }), f = h && u && d, p = f ? x.inHouseButton : l.ButtonColors.BRAND, g = d && !_ ? l.ShinyButton : l.Button;
  return (0, i.jsx)(l.Tooltip, {
text: N.tooltipText,
tooltipContentClassName: x.ctaTooltipText,
children: e => {
  var t;
  return (0, i.jsx)(g, {
    ...e,
    ...
    children: (0, i.jsxs)('div', {
      className: x.ctaButtonInner,
      children: [
        f && (0, i.jsx)('img', {
          src: v,
          alt: '',
          className: x.inHouseIcon
        }),
        N.text
      ]
    })
...
isAnimating: v,
contentPosition: D
  } = e, b = (0, E._Q)(t), j = b >= E.OH.ACCEPTED, U = b >= E.OH.COMPLETED, y = b >= E.OH.CLAIMED, B = (0, T.Xv)(t.config), k = (0, S.uq)(n), G = n === m.jn.QUESTS_EMBED, F = C || v, w = j && !y && k, V = (0, E.t5)(t, M.dr.QUESTS_CARD, n), {
...
autoplay: o,
className: s()(x.gridImg, {
  [x.questRewardGiftInventory]: k && 'lg' === a,
  [x.questRewardEmbed]: G && 'lg' === a,
  [x.questRewardEmbedSm]: 'sm' === a,
  [x.questRewardEmbedXs]: 'xs' === a
}),
...
children: [
  (0, i.jsxs)('div', {
    className: s()(x.outerContainer, {
      [x.outerContainerSm]: 'sm' === a,
      [x.outerContainerXs]: 'xs' === a,
      [x.outerContainerNoProgress]: !w
    }),
    style: {
    ...
    children: [
      ...
      (0, i.jsxs)('div', {
        className: s()(x.gridText, x.taskDetails),
        children: [
          (0, i.jsx)(l.Text, {
            variant: Z(n, a, j),
          ...
          (0, i.jsx)(l.Text, {
            ...
            children: function(e) {
              ...
              let {
                ...
                locale: c,
                isQuestExpired: _
              } = e, I = (null === (t = l.userStatus) || void 0 === t ? void 0 : t.completedAt) != null, m = I && (null === (n = l.userStatus) || void 0 === n ? void 0 : n.claimedAt) != null, N = (0, T.zK)(l, M.S7.IN_HOUSE_CONSOLE_QUEST), f = (0, S.uq)(o), C = (0, E.B6)(null === (i = l.userStatus) || void 0 === i ? void 0 : i.completedAt, {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
              }), p = (0, T.oo)({
                quest: l
              }), g = h.r.build(l.config).defaultReward.messages.nameWithArticle, A = (0, T.Kr)(l.config), x = (0, T.b7)(l);
              if (I && N && f)
              ...
              return _ ? O.Z.Messages.QUESTS_EXPIRED_QUEST_CARD_SUBHEADING.format({
                ...
                helpCenterLink: u.Z.getArticleURL(R.BhN.QUESTS_LEARN_MORE)
              }) : null != A ? O.Z.Messages.QUEST_REWARD_WITH_EXPIRATION.format({
                reward: g,
                duration: A
              }) : null != x ? x.description : O.Z.Messages.QUEST_REWARD.format({
                reward: g
              });
            }({
              quest: t,
      ...
      (0, i.jsxs)('div', {
        className: s()(x.ctaButtonContainer, x.gridCtaButtons),
        children: [
          !k && (0, i.jsx)(L, {
            containerSize: a,
            onClick: () => {
              (0, p.navigateToQuestHome)(M.dr.QUESTS_CARD, t.id), (0, _._3)({
                questId: t.id,
                questContent: n,
                questContentPosition: D,
  ...
  Q && (0, i.jsxs)('div', {
    className: x.microphoneContainer,
    children: [
      (0, i.jsx)('div', {

...
var a = t(512722),
    ...
    _ = t(981631);
function p(e) {
    let { initialPlanId: n, activeSubscription: a, analyticsObject: r, analyticsLocation: s, analyticsLocations: l, analyticsSubscriptionType: c, renderHeader: d, planGroup: p, skuId: m, guildId: I, reviewWarningMessage: f, applicationId: g, showBenefitsFirst: h, eligibleApplicationSubscriptionGuilds: C, onComplete: v, forcesTransitionToGuild: E } = e;
    (0, o.openModalLazy)(
        async () => {
...
let m = async (e, n) => {
    let t = (await (0, s.yD)(e)).filter((e) => null == e.ends_at || new Date(e.ends_at) > new Date()).find((e) => e.sku_id === n);
    r()(null == t, 'User already has an active subscription to this SKU');
};
async function I(e) {
    var n;
    let { applicationId: t, skuId: i, initialPlanId: a, analyticsLocationObject: o, analyticsLocations: s, renderHeader: u } = e,
        I = d.Z.get(i),
        f = c.Z.getForSKU(i);

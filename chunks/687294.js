...
var r = n(259443), i = n(510990), a = n(141795), o = n(983544), s = n(596956), l = n(865275), u = n(981631), c = n(959517), d = n(689938);
...
class E extends l.Z {
    ...
    async compressAndCheckFileSize() {
        ...
        return this.files.length > n.getMaxAttachmentsCount() ? (_.log('Too many attachments for '.concat(this.id)), this._handleError({ code: u.evJ.TOO_MANY_ATTACHMENTS }), !1) : !(this._fileSize() > n.getMaxTotalAttachmentSize()) || (this._handleError({
    ...
    setUploadingTextForUI() {
        let e = 1 === this.files.length && null != this.files[0].filename ? this.files[0].filename : d.Z.Messages.UPLOADING_FILES.format({ count: this.files.length }), t = this.files.some(e => e.isImage), n = this.files.some(e => e.isVideo), r = this._fileSize();
...
async function f(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = arguments.length > 2 ? arguments[2] : void 0, r = e.map(e => new Promise((r, i) => {
            switch (e.status) {

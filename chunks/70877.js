...
var l = t(735250);
t(470079);
var i = t(360963), u = t.n(i), s = t(913527), r = t.n(s), a = t(593473), d = t(442837), E = t(481060), o = t(579806), c = t(957730), _ = t(430824), T = t(358085), N = t(924301), I = t(79874), Z = t(236373), f = t(854698), g = t(765305), M = t(981631), D = t(689938);
let v = 'YYYYMMDDTHHmmss', S = 'YYYY-MM-DDTHH:mm:ss', O = /RRULE:.*/;
function A(e, n, t, i) {
    var s, A, m;
    let C;
    let h = (0, d.e7)([N.ZP], () => N.ZP.isActive(e)), P = (0, I.zI)(null != e ? e : '', i), R = (0, d.e7)([N.ZP], () => N.ZP.getGuildScheduledEvent(e), [e]), L = (0, d.e7)([_.Z], () => _.Z.getGuild(n), [n]);
    if (h || null == P || null == R)
        return null;
    ...
    let p = r()(R.scheduled_start_time), V = null != R.scheduled_end_time ? r()(R.scheduled_end_time) : p, U = null != R.description && '' !== R.description ? c.ZP.unparse(R.description, null !== (s = null == t ? void 0 : t.id) && void 0 !== s ? s : M.lds, !0) : '', G = (0, Z.KV)(R.recurrence_rule), b = null != G ? (0, f.Ho)(G) : null, {
            startTime: x,
            endTime: y
        } = P, w = null !== (A = r()(x)) && void 0 !== A ? A : p, j = null !== (m = r()(null != y ? y : x)) && void 0 !== m ? m : p, H = () => {
            let e = u()();
            e.createEvent({
                start: p,
                end: V,
    ...
    return (0, l.jsxs)(E.MenuItem, {
        ...
        children: [
            (0, l.jsx)(E.MenuItem, {
                ...
                action: () => {
                    var e;
                    let n = null == b ? void 0 : b.toString(), t = {
                            text: R.name,

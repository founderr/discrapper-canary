...
var r = n(735250);
n(470079);
var i = n(481060), a = n(100527), o = n(906732), s = n(299206), l = n(389052), u = n(622724), c = n(785717), d = n(993409), _ = n(689938);
function E(e) {
    let {
            user: t,
            guildId: n,
            viewProfileItem: E
        } = e, {trackUserProfileAction: f} = (0, c.KZ)(), {
    ...
    return T.every(e => e.every(e => null == e)) ? null : (0, r.jsx)(o.Gt, {
        ...
        children: (0, r.jsx)(i.Popout, {
            ...
            children: e => {
                ...
                return (0, r.jsx)(d.Z, {
                    variant: 'banner',
                    text: _.Z.Messages.MORE,
                    icon: i.MoreHorizontalIcon,
                    onClick: e => {
                        f({ action: 'PRESS_OPTIONS' }), t(e);
                    },
                    ...n
                });
            }

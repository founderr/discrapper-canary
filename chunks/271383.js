...
function q(e) {
    ...
    (b = !0), (R[e.guildId] = null !== (t = R[e.guildId]) && void 0 !== t ? t : {});
    let r = !1;
    for (let t of ((b = !0), (R[e.guildId] = null !== (n = R[e.guildId]) && void 0 !== n ? n : {}), e.members)) null == R[e.guildId][t.userId] && ((r = !0), (R[e.guildId][t.userId] = t));
    return r;
}
function Q(e) {
    var t;

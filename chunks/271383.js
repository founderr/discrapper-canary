...
function w(e, t) {
    ...
    let n = B(e, t.userId);
    L[n] !== t.communicationDisabledUntil && (0, h.b)(t) && ((L[n] = t.communicationDisabledUntil), G(n));
}
function x(e, t) {
    if (null != t) {
        let n = B(e, t);
        null != L[n] && G(n), k(B(e, t));
    } else for (let t in L) V(t) === e && (G(t), k(t));
}
function G(e) {
    (D += 1), (M[e] = D);
}
function k(e) {
    F(e) === g.default.getId() && (0, p.l)(V(e)), delete L[e];
}
function B(e, t) {
    let n = [];
...
function Y(e) {
    ...
    if (null == h) return R.warn('Guild '.concat(n, ' not found during GUILD_MEMBER_UPDATE.')), !1;
    (f[r.id] = Z({
        userId: r.id,
        nick: i,
        guildId: n,

...
function Z(e) {
    V(e) === b.default.getId() && (0, g.l)(j(e)), delete D[e];
}
function F(e, t) {
    let n = [];
...
class er extends (i = f.ZP.Store) {
    initialize() {
        this.waitFor(y.Z, b.default, E.Z);
    }
    ...
    getMember(e, t) {
        ...
        if (null != n && t === b.default.getId() && (E.Z.isViewingRoles(e) || E.Z.isFullServerPreview(e))) {
            var r;

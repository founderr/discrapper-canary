...
class g extends a.default.Store {
  ...
  hasChanges() {
    ...
    if (S === _.GuildSettingsOnboardingPage.DEFAULT_CHANNELS) return e ? u.default.hasChanges() || E.default.hasChanges() : u.default.hasChanges();
    if (S === _.GuildSettingsOnboardingPage.CUSTOMIZATION_QUESTIONS) return E.default.hasChanges();
    if (S === _.GuildSettingsOnboardingPage.HOME_SETTINGS) return c.default.hasChanges();
    return !1
  }
  hasConfiguredAnythingForCurrentStep() {
    if (null == m) return !1;
    if (S === _.GuildSettingsOnboardingPage.SAFETY_CHECK) return !0;
    if (S === _.GuildSettingsOnboardingPage.DEFAULT_CHANNELS) return u.default.editedDefaultChannelIds.size > 0;
    if (S === _.GuildSettingsOnboardingPage.CUSTOMIZATION_QUESTIONS) return E.default.editedOnboardingPrompts.length > 0;
    else if (S === _.GuildSettingsOnboardingPage.HOME_SETTINGS) return !(0, i.isSettingsEmpty)(c.default.getSettings());
    return !1
  }
  hasErrors() {
    return S === _.GuildSettingsOnboardingPage.CUSTOMIZATION_QUESTIONS && null != E.default.errors.find(e => null != e)
  }
  showNotice() {
    if (null == m) return !1;
    if ((0, I.isOnboardingWizardCompleted)(m)) return this.hasChanges();
    let e = o.default.getCurrentPage();
    return (S !== _.GuildSettingsOnboardingPage.SAFETY_CHECK || e === d.GuildSettingsSafetyPage.OVERVIEW) && null != S && S !== _.GuildSettingsOnboardingPage.LANDING
  }
  canCloseEarly() {

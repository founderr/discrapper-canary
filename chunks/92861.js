...
var r = n(573654), i = n(778010), a = n(112457), o = n(603565);
function s(e, t) {
...
var l = function () {
    ...
    function l(e, t) {
        ...
        }(this, l), this.store = e, this.registry = t;
    }
    return e = l, t = [
        {
            key: 'subscribeToStateChange',
            value: function (e) {
                var t = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { handlerIds: void 0 }, i = n.handlerIds;
                ...
                return this.store.subscribe(function () {
                    var n = t.store.getState(), r = n.stateId;
                    try {
        ...
        },
        {
            ...
            value: function (e) {
                ...
                if ((0, r.k)(t, 'Expected to find a valid target. targetId='.concat(e)), !this.isDragging() || this.didDrop())
                    return !1;
                var n = this.registry.getTargetType(e), a = this.getItemType();
        ...
        },
        {
            ...
            value: function (e) {
                ...
                if (!this.isDragging())
                    return !1;
                var r = this.registry.getTargetType(e), a = this.getItemType();
                if (a && !(0, i.s)(r, a))
                    return !1;

...
function f() {
  ...
  let {
    guild: t
  } = (0, n.useStateFromStores)([E.default], () => E.default.getProps(), [], l.isEqual), s = null !== (e = null == t ? void 0 : t.id) && void 0 !== e ? e : _.EMPTY_STRING_SNOWFLAKE_ID, i = (0, r.useCanAccessMemberSafetyPage)(s);

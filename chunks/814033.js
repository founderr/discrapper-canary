!(function (e, t) {
    ...
    (a.prototype.toString = function (e, t) {
        ...
        if (e === (0 | e) && e >= 2 && e <= 36) {
            ...
            for (h.negative = 0; !h.isZero(); ) {
                var p = h.modn(_).toString(e);
                n = (h = h.idivn(_)).isZero() ? p + n : c[u - p.length] + p + n;
            }
    ...
    function _(e, t, n) {
        ...
        for (var u = 1; u < r; u++) {
            for (var c = l >>> 26, d = 67108863 & l, f = Math.min(u, t.length - 1), _ = Math.max(0, u - e.length + 1); _ <= f; _++) {
                var h = (u - _) | 0;
                (i = 0 | e.words[h]), (c += ((s = i * (a = 0 | t.words[_]) + d) / 67108864) | 0), (d = 67108863 & s);
            }
            (n.words[u] = 0 | d), (l = 0 | c);
        }
    ...
    var h = function (e, t, n) {
        var r,
            ...
            eh = 8191 & e_,
            ep = e_ >>> 13;
        (n.negative = e.negative ^ t.negative), (n.length = 19), (r = Math.imul(d, F)), (i = ((i = Math.imul(d, V)) + Math.imul(f, F)) | 0);
        var em = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = Math.imul(f, V)) + (i >>> 13)) | 0) + (em >>> 26)) | 0), (em &= 67108863), (r = Math.imul(h, F)), (i = ((i = Math.imul(h, V)) + Math.imul(p, F)) | 0), (a = Math.imul(p, V)), (r = (r + Math.imul(d, j)) | 0), (i = ((i = (i + Math.imul(d, Y)) | 0) + Math.imul(f, j)) | 0);
        var eg = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, Y)) | 0) + (i >>> 13)) | 0) + (eg >>> 26)) | 0), (eg &= 67108863), (r = Math.imul(g, F)), (i = ((i = Math.imul(g, V)) + Math.imul(E, F)) | 0), (a = Math.imul(E, V)), (r = (r + Math.imul(h, j)) | 0), (i = ((i = (i + Math.imul(h, Y)) | 0) + Math.imul(p, j)) | 0), (a = (a + Math.imul(p, Y)) | 0), (r = (r + Math.imul(d, K)) | 0), (i = ((i = (i + Math.imul(d, z)) | 0) + Math.imul(f, K)) | 0);
        var eE = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, z)) | 0) + (i >>> 13)) | 0) + (eE >>> 26)) | 0), (eE &= 67108863), (r = Math.imul(I, F)), (i = ((i = Math.imul(I, V)) + Math.imul(S, F)) | 0), (a = Math.imul(S, V)), (r = (r + Math.imul(g, j)) | 0), (i = ((i = (i + Math.imul(g, Y)) | 0) + Math.imul(E, j)) | 0), (a = (a + Math.imul(E, Y)) | 0), (r = (r + Math.imul(h, K)) | 0), (i = ((i = (i + Math.imul(h, z)) | 0) + Math.imul(p, K)) | 0), (a = (a + Math.imul(p, z)) | 0), (r = (r + Math.imul(d, Q)) | 0), (i = ((i = (i + Math.imul(d, X)) | 0) + Math.imul(f, Q)) | 0);
        var ev = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, X)) | 0) + (i >>> 13)) | 0) + (ev >>> 26)) | 0), (ev &= 67108863), (r = Math.imul(T, F)), (i = ((i = Math.imul(T, V)) + Math.imul(y, F)) | 0), (a = Math.imul(y, V)), (r = (r + Math.imul(I, j)) | 0), (i = ((i = (i + Math.imul(I, Y)) | 0) + Math.imul(S, j)) | 0), (a = (a + Math.imul(S, Y)) | 0), (r = (r + Math.imul(g, K)) | 0), (i = ((i = (i + Math.imul(g, z)) | 0) + Math.imul(E, K)) | 0), (a = (a + Math.imul(E, z)) | 0), (r = (r + Math.imul(h, Q)) | 0), (i = ((i = (i + Math.imul(h, X)) | 0) + Math.imul(p, Q)) | 0), (a = (a + Math.imul(p, X)) | 0), (r = (r + Math.imul(d, $)) | 0), (i = ((i = (i + Math.imul(d, ee)) | 0) + Math.imul(f, $)) | 0);
        var eI = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, ee)) | 0) + (i >>> 13)) | 0) + (eI >>> 26)) | 0), (eI &= 67108863), (r = Math.imul(N, F)), (i = ((i = Math.imul(N, V)) + Math.imul(C, F)) | 0), (a = Math.imul(C, V)), (r = (r + Math.imul(T, j)) | 0), (i = ((i = (i + Math.imul(T, Y)) | 0) + Math.imul(y, j)) | 0), (a = (a + Math.imul(y, Y)) | 0), (r = (r + Math.imul(I, K)) | 0), (i = ((i = (i + Math.imul(I, z)) | 0) + Math.imul(S, K)) | 0), (a = (a + Math.imul(S, z)) | 0), (r = (r + Math.imul(g, Q)) | 0), (i = ((i = (i + Math.imul(g, X)) | 0) + Math.imul(E, Q)) | 0), (a = (a + Math.imul(E, X)) | 0), (r = (r + Math.imul(h, $)) | 0), (i = ((i = (i + Math.imul(h, ee)) | 0) + Math.imul(p, $)) | 0), (a = (a + Math.imul(p, ee)) | 0), (r = (r + Math.imul(d, en)) | 0), (i = ((i = (i + Math.imul(d, er)) | 0) + Math.imul(f, en)) | 0);
        var eS = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, er)) | 0) + (i >>> 13)) | 0) + (eS >>> 26)) | 0), (eS &= 67108863), (r = Math.imul(O, F)), (i = ((i = Math.imul(O, V)) + Math.imul(D, F)) | 0), (a = Math.imul(D, V)), (r = (r + Math.imul(N, j)) | 0), (i = ((i = (i + Math.imul(N, Y)) | 0) + Math.imul(C, j)) | 0), (a = (a + Math.imul(C, Y)) | 0), (r = (r + Math.imul(T, K)) | 0), (i = ((i = (i + Math.imul(T, z)) | 0) + Math.imul(y, K)) | 0), (a = (a + Math.imul(y, z)) | 0), (r = (r + Math.imul(I, Q)) | 0), (i = ((i = (i + Math.imul(I, X)) | 0) + Math.imul(S, Q)) | 0), (a = (a + Math.imul(S, X)) | 0), (r = (r + Math.imul(g, $)) | 0), (i = ((i = (i + Math.imul(g, ee)) | 0) + Math.imul(E, $)) | 0), (a = (a + Math.imul(E, ee)) | 0), (r = (r + Math.imul(h, en)) | 0), (i = ((i = (i + Math.imul(h, er)) | 0) + Math.imul(p, en)) | 0), (a = (a + Math.imul(p, er)) | 0), (r = (r + Math.imul(d, ea)) | 0), (i = ((i = (i + Math.imul(d, es)) | 0) + Math.imul(f, ea)) | 0);
        var eb = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, es)) | 0) + (i >>> 13)) | 0) + (eb >>> 26)) | 0), (eb &= 67108863), (r = Math.imul(x, F)), (i = ((i = Math.imul(x, V)) + Math.imul(w, F)) | 0), (a = Math.imul(w, V)), (r = (r + Math.imul(O, j)) | 0), (i = ((i = (i + Math.imul(O, Y)) | 0) + Math.imul(D, j)) | 0), (a = (a + Math.imul(D, Y)) | 0), (r = (r + Math.imul(N, K)) | 0), (i = ((i = (i + Math.imul(N, z)) | 0) + Math.imul(C, K)) | 0), (a = (a + Math.imul(C, z)) | 0), (r = (r + Math.imul(T, Q)) | 0), (i = ((i = (i + Math.imul(T, X)) | 0) + Math.imul(y, Q)) | 0), (a = (a + Math.imul(y, X)) | 0), (r = (r + Math.imul(I, $)) | 0), (i = ((i = (i + Math.imul(I, ee)) | 0) + Math.imul(S, $)) | 0), (a = (a + Math.imul(S, ee)) | 0), (r = (r + Math.imul(g, en)) | 0), (i = ((i = (i + Math.imul(g, er)) | 0) + Math.imul(E, en)) | 0), (a = (a + Math.imul(E, er)) | 0), (r = (r + Math.imul(h, ea)) | 0), (i = ((i = (i + Math.imul(h, es)) | 0) + Math.imul(p, ea)) | 0), (a = (a + Math.imul(p, es)) | 0), (r = (r + Math.imul(d, el)) | 0), (i = ((i = (i + Math.imul(d, eu)) | 0) + Math.imul(f, el)) | 0);
        var eT = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, eu)) | 0) + (i >>> 13)) | 0) + (eT >>> 26)) | 0), (eT &= 67108863), (r = Math.imul(P, F)), (i = ((i = Math.imul(P, V)) + Math.imul(k, F)) | 0), (a = Math.imul(k, V)), (r = (r + Math.imul(x, j)) | 0), (i = ((i = (i + Math.imul(x, Y)) | 0) + Math.imul(w, j)) | 0), (a = (a + Math.imul(w, Y)) | 0), (r = (r + Math.imul(O, K)) | 0), (i = ((i = (i + Math.imul(O, z)) | 0) + Math.imul(D, K)) | 0), (a = (a + Math.imul(D, z)) | 0), (r = (r + Math.imul(N, Q)) | 0), (i = ((i = (i + Math.imul(N, X)) | 0) + Math.imul(C, Q)) | 0), (a = (a + Math.imul(C, X)) | 0), (r = (r + Math.imul(T, $)) | 0), (i = ((i = (i + Math.imul(T, ee)) | 0) + Math.imul(y, $)) | 0), (a = (a + Math.imul(y, ee)) | 0), (r = (r + Math.imul(I, en)) | 0), (i = ((i = (i + Math.imul(I, er)) | 0) + Math.imul(S, en)) | 0), (a = (a + Math.imul(S, er)) | 0), (r = (r + Math.imul(g, ea)) | 0), (i = ((i = (i + Math.imul(g, es)) | 0) + Math.imul(E, ea)) | 0), (a = (a + Math.imul(E, es)) | 0), (r = (r + Math.imul(h, el)) | 0), (i = ((i = (i + Math.imul(h, eu)) | 0) + Math.imul(p, el)) | 0), (a = (a + Math.imul(p, eu)) | 0), (r = (r + Math.imul(d, ed)) | 0), (i = ((i = (i + Math.imul(d, ef)) | 0) + Math.imul(f, ed)) | 0);
        var ey = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, ef)) | 0) + (i >>> 13)) | 0) + (ey >>> 26)) | 0), (ey &= 67108863), (r = Math.imul(G, F)), (i = ((i = Math.imul(G, V)) + Math.imul(B, F)) | 0), (a = Math.imul(B, V)), (r = (r + Math.imul(P, j)) | 0), (i = ((i = (i + Math.imul(P, Y)) | 0) + Math.imul(k, j)) | 0), (a = (a + Math.imul(k, Y)) | 0), (r = (r + Math.imul(x, K)) | 0), (i = ((i = (i + Math.imul(x, z)) | 0) + Math.imul(w, K)) | 0), (a = (a + Math.imul(w, z)) | 0), (r = (r + Math.imul(O, Q)) | 0), (i = ((i = (i + Math.imul(O, X)) | 0) + Math.imul(D, Q)) | 0), (a = (a + Math.imul(D, X)) | 0), (r = (r + Math.imul(N, $)) | 0), (i = ((i = (i + Math.imul(N, ee)) | 0) + Math.imul(C, $)) | 0), (a = (a + Math.imul(C, ee)) | 0), (r = (r + Math.imul(T, en)) | 0), (i = ((i = (i + Math.imul(T, er)) | 0) + Math.imul(y, en)) | 0), (a = (a + Math.imul(y, er)) | 0), (r = (r + Math.imul(I, ea)) | 0), (i = ((i = (i + Math.imul(I, es)) | 0) + Math.imul(S, ea)) | 0), (a = (a + Math.imul(S, es)) | 0), (r = (r + Math.imul(g, el)) | 0), (i = ((i = (i + Math.imul(g, eu)) | 0) + Math.imul(E, el)) | 0), (a = (a + Math.imul(E, eu)) | 0), (r = (r + Math.imul(h, ed)) | 0), (i = ((i = (i + Math.imul(h, ef)) | 0) + Math.imul(p, ed)) | 0), (a = (a + Math.imul(p, ef)) | 0), (r = (r + Math.imul(d, eh)) | 0), (i = ((i = (i + Math.imul(d, ep)) | 0) + Math.imul(f, eh)) | 0);
        var eA = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(f, ep)) | 0) + (i >>> 13)) | 0) + (eA >>> 26)) | 0), (eA &= 67108863), (r = Math.imul(G, j)), (i = ((i = Math.imul(G, Y)) + Math.imul(B, j)) | 0), (a = Math.imul(B, Y)), (r = (r + Math.imul(P, K)) | 0), (i = ((i = (i + Math.imul(P, z)) | 0) + Math.imul(k, K)) | 0), (a = (a + Math.imul(k, z)) | 0), (r = (r + Math.imul(x, Q)) | 0), (i = ((i = (i + Math.imul(x, X)) | 0) + Math.imul(w, Q)) | 0), (a = (a + Math.imul(w, X)) | 0), (r = (r + Math.imul(O, $)) | 0), (i = ((i = (i + Math.imul(O, ee)) | 0) + Math.imul(D, $)) | 0), (a = (a + Math.imul(D, ee)) | 0), (r = (r + Math.imul(N, en)) | 0), (i = ((i = (i + Math.imul(N, er)) | 0) + Math.imul(C, en)) | 0), (a = (a + Math.imul(C, er)) | 0), (r = (r + Math.imul(T, ea)) | 0), (i = ((i = (i + Math.imul(T, es)) | 0) + Math.imul(y, ea)) | 0), (a = (a + Math.imul(y, es)) | 0), (r = (r + Math.imul(I, el)) | 0), (i = ((i = (i + Math.imul(I, eu)) | 0) + Math.imul(S, el)) | 0), (a = (a + Math.imul(S, eu)) | 0), (r = (r + Math.imul(g, ed)) | 0), (i = ((i = (i + Math.imul(g, ef)) | 0) + Math.imul(E, ed)) | 0), (a = (a + Math.imul(E, ef)) | 0), (r = (r + Math.imul(h, eh)) | 0), (i = ((i = (i + Math.imul(h, ep)) | 0) + Math.imul(p, eh)) | 0);
        var eN = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(p, ep)) | 0) + (i >>> 13)) | 0) + (eN >>> 26)) | 0), (eN &= 67108863), (r = Math.imul(G, K)), (i = ((i = Math.imul(G, z)) + Math.imul(B, K)) | 0), (a = Math.imul(B, z)), (r = (r + Math.imul(P, Q)) | 0), (i = ((i = (i + Math.imul(P, X)) | 0) + Math.imul(k, Q)) | 0), (a = (a + Math.imul(k, X)) | 0), (r = (r + Math.imul(x, $)) | 0), (i = ((i = (i + Math.imul(x, ee)) | 0) + Math.imul(w, $)) | 0), (a = (a + Math.imul(w, ee)) | 0), (r = (r + Math.imul(O, en)) | 0), (i = ((i = (i + Math.imul(O, er)) | 0) + Math.imul(D, en)) | 0), (a = (a + Math.imul(D, er)) | 0), (r = (r + Math.imul(N, ea)) | 0), (i = ((i = (i + Math.imul(N, es)) | 0) + Math.imul(C, ea)) | 0), (a = (a + Math.imul(C, es)) | 0), (r = (r + Math.imul(T, el)) | 0), (i = ((i = (i + Math.imul(T, eu)) | 0) + Math.imul(y, el)) | 0), (a = (a + Math.imul(y, eu)) | 0), (r = (r + Math.imul(I, ed)) | 0), (i = ((i = (i + Math.imul(I, ef)) | 0) + Math.imul(S, ed)) | 0), (a = (a + Math.imul(S, ef)) | 0), (r = (r + Math.imul(g, eh)) | 0), (i = ((i = (i + Math.imul(g, ep)) | 0) + Math.imul(E, eh)) | 0);
        var eC = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(E, ep)) | 0) + (i >>> 13)) | 0) + (eC >>> 26)) | 0), (eC &= 67108863), (r = Math.imul(G, Q)), (i = ((i = Math.imul(G, X)) + Math.imul(B, Q)) | 0), (a = Math.imul(B, X)), (r = (r + Math.imul(P, $)) | 0), (i = ((i = (i + Math.imul(P, ee)) | 0) + Math.imul(k, $)) | 0), (a = (a + Math.imul(k, ee)) | 0), (r = (r + Math.imul(x, en)) | 0), (i = ((i = (i + Math.imul(x, er)) | 0) + Math.imul(w, en)) | 0), (a = (a + Math.imul(w, er)) | 0), (r = (r + Math.imul(O, ea)) | 0), (i = ((i = (i + Math.imul(O, es)) | 0) + Math.imul(D, ea)) | 0), (a = (a + Math.imul(D, es)) | 0), (r = (r + Math.imul(N, el)) | 0), (i = ((i = (i + Math.imul(N, eu)) | 0) + Math.imul(C, el)) | 0), (a = (a + Math.imul(C, eu)) | 0), (r = (r + Math.imul(T, ed)) | 0), (i = ((i = (i + Math.imul(T, ef)) | 0) + Math.imul(y, ed)) | 0), (a = (a + Math.imul(y, ef)) | 0), (r = (r + Math.imul(I, eh)) | 0), (i = ((i = (i + Math.imul(I, ep)) | 0) + Math.imul(S, eh)) | 0);
        var eR = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(S, ep)) | 0) + (i >>> 13)) | 0) + (eR >>> 26)) | 0), (eR &= 67108863), (r = Math.imul(G, $)), (i = ((i = Math.imul(G, ee)) + Math.imul(B, $)) | 0), (a = Math.imul(B, ee)), (r = (r + Math.imul(P, en)) | 0), (i = ((i = (i + Math.imul(P, er)) | 0) + Math.imul(k, en)) | 0), (a = (a + Math.imul(k, er)) | 0), (r = (r + Math.imul(x, ea)) | 0), (i = ((i = (i + Math.imul(x, es)) | 0) + Math.imul(w, ea)) | 0), (a = (a + Math.imul(w, es)) | 0), (r = (r + Math.imul(O, el)) | 0), (i = ((i = (i + Math.imul(O, eu)) | 0) + Math.imul(D, el)) | 0), (a = (a + Math.imul(D, eu)) | 0), (r = (r + Math.imul(N, ed)) | 0), (i = ((i = (i + Math.imul(N, ef)) | 0) + Math.imul(C, ed)) | 0), (a = (a + Math.imul(C, ef)) | 0), (r = (r + Math.imul(T, eh)) | 0), (i = ((i = (i + Math.imul(T, ep)) | 0) + Math.imul(y, eh)) | 0);
        var eO = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(y, ep)) | 0) + (i >>> 13)) | 0) + (eO >>> 26)) | 0), (eO &= 67108863), (r = Math.imul(G, en)), (i = ((i = Math.imul(G, er)) + Math.imul(B, en)) | 0), (a = Math.imul(B, er)), (r = (r + Math.imul(P, ea)) | 0), (i = ((i = (i + Math.imul(P, es)) | 0) + Math.imul(k, ea)) | 0), (a = (a + Math.imul(k, es)) | 0), (r = (r + Math.imul(x, el)) | 0), (i = ((i = (i + Math.imul(x, eu)) | 0) + Math.imul(w, el)) | 0), (a = (a + Math.imul(w, eu)) | 0), (r = (r + Math.imul(O, ed)) | 0), (i = ((i = (i + Math.imul(O, ef)) | 0) + Math.imul(D, ed)) | 0), (a = (a + Math.imul(D, ef)) | 0), (r = (r + Math.imul(N, eh)) | 0), (i = ((i = (i + Math.imul(N, ep)) | 0) + Math.imul(C, eh)) | 0);
        var eD = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(C, ep)) | 0) + (i >>> 13)) | 0) + (eD >>> 26)) | 0), (eD &= 67108863), (r = Math.imul(G, ea)), (i = ((i = Math.imul(G, es)) + Math.imul(B, ea)) | 0), (a = Math.imul(B, es)), (r = (r + Math.imul(P, el)) | 0), (i = ((i = (i + Math.imul(P, eu)) | 0) + Math.imul(k, el)) | 0), (a = (a + Math.imul(k, eu)) | 0), (r = (r + Math.imul(x, ed)) | 0), (i = ((i = (i + Math.imul(x, ef)) | 0) + Math.imul(w, ed)) | 0), (a = (a + Math.imul(w, ef)) | 0), (r = (r + Math.imul(O, eh)) | 0), (i = ((i = (i + Math.imul(O, ep)) | 0) + Math.imul(D, eh)) | 0);
        var eL = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(D, ep)) | 0) + (i >>> 13)) | 0) + (eL >>> 26)) | 0), (eL &= 67108863), (r = Math.imul(G, el)), (i = ((i = Math.imul(G, eu)) + Math.imul(B, el)) | 0), (a = Math.imul(B, eu)), (r = (r + Math.imul(P, ed)) | 0), (i = ((i = (i + Math.imul(P, ef)) | 0) + Math.imul(k, ed)) | 0), (a = (a + Math.imul(k, ef)) | 0), (r = (r + Math.imul(x, eh)) | 0), (i = ((i = (i + Math.imul(x, ep)) | 0) + Math.imul(w, eh)) | 0);
        var ex = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(w, ep)) | 0) + (i >>> 13)) | 0) + (ex >>> 26)) | 0), (ex &= 67108863), (r = Math.imul(G, ed)), (i = ((i = Math.imul(G, ef)) + Math.imul(B, ed)) | 0), (a = Math.imul(B, ef)), (r = (r + Math.imul(P, eh)) | 0), (i = ((i = (i + Math.imul(P, ep)) | 0) + Math.imul(k, eh)) | 0);
        var ew = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        (u = ((((a = (a + Math.imul(k, ep)) | 0) + (i >>> 13)) | 0) + (ew >>> 26)) | 0), (ew &= 67108863), (r = Math.imul(G, eh)), (i = ((i = Math.imul(G, ep)) + Math.imul(B, eh)) | 0);
        var eM = (((u + r) | 0) + ((8191 & i) << 13)) | 0;
        return (u = ((((a = Math.imul(B, ep)) + (i >>> 13)) | 0) + (eM >>> 26)) | 0), (eM &= 67108863), (l[0] = em), (l[1] = eg), (l[2] = eE), (l[3] = ev), (l[4] = eI), (l[5] = eS), (l[6] = eb), (l[7] = eT), (l[8] = ey), (l[9] = eA), (l[10] = eN), (l[11] = eC), (l[12] = eR), (l[13] = eO), (l[14] = eD), (l[15] = eL), (l[16] = ex), (l[17] = ew), (l[18] = eM), 0 !== u && ((l[19] = u), n.length++), n;
    };
    !Math.imul && (h = _);
    function p(e, t, n) {
    ...
    (a.prototype.mulTo = function (e, t) {
                          ...
                          for (var r = 0, i = 0, a = 0; a < n.length - 1; a++) {
                              ...
                              for (var o = 67108863 & r, l = Math.min(a, t.length - 1), u = Math.max(0, a - e.length + 1); u <= l; u++) {
                                  var c = a - u,
                                      ...
                                      f = 67108863 & d;
                                  (s = (s + ((d / 67108864) | 0)) | 0), (o = 67108863 & (f = (f + o) | 0)), (i += (s = (s + (f >>> 26)) | 0) >>> 26), (s &= 67108863);
                              }
                              (n.words[a] = o), (r = s), (s = i);
                          }
                ...
                for (var o = s << 1, l = Math.cos((2 * Math.PI) / o), u = Math.sin((2 * Math.PI) / o), c = 0; c < i; c += o) {
                    for (var d = l, f = u, _ = 0; _ < s; _++) {
                        var h = n[c + _],
                            ...
                            g = r[c + _ + s],
                            E = d * m - f * g;
                        (g = d * g + f * m), (m = E), (n[c + _] = h + m), (r[c + _] = p + g), (n[c + _ + s] = h - m), (r[c + _ + s] = p - g), _ !== o && ((E = l * d - u * f), (f = l * f + u * d), (d = E));
                    }
                }
            }
        }),
        ...
        (m.prototype.mulp = function (e, t, n) {
            var r = 2 * this.guessLen13b(e.length, t.length),
                ...
                d = Array(r),
                f = n.words;
            (f.length = r), this.convert13b(e.words, e.length, s, r), this.convert13b(t.words, t.length, u, r), this.transform(s, a, o, l, r, i), this.transform(u, a, c, d, r, i);
            for (var _ = 0; _ < r; _++) {
                var h = o[_] * c[_] - l[_] * d[_];
                (l[_] = o[_] * d[_] + l[_] * c[_]), (o[_] = h);
            }
            return this.conjugate(o, l, r), this.transform(o, l, f, a, r, i), this.conjugate(f, a, r), this.normalize13b(f, r), (n.negative = e.negative ^ t.negative), (n.length = e.length + t.length), n.strip();
        }),
        ...
        (a.prototype._wordDiv = function (e, t) {
            ...
            for (var d = l - 1; d >= 0; d--) {
                var f = (0 | i.words[s.length + d]) * 67108864 + (0 | i.words[s.length + d - 1]);
                for (f = Math.min((f / o) | 0, 67108863), i._ishlnsubmul(s, f, d); 0 !== i.negative; ) f--, (i.negative = 0), i._ishlnsubmul(s, 1, d), !i.isZero() && (i.negative ^= 1);
                n && (n.words[d] = f);
            }
            return (
                n && n.strip(),
        ...
        (a.prototype.egcd = function (e) {
            ...
            for (var c = n.clone(), d = t.clone(); !t.isZero(); ) {
                ...
                if (f > 0) for (t.iushrn(f); f-- > 0; ) (i.isOdd() || s.isOdd()) && (i.iadd(c), s.isub(d)), i.iushrn(1), s.iushrn(1);
                for (var h = 0, p = 1; (n.words[0] & p) == 0 && h < 26; ++h, p <<= 1);
                if (h > 0) for (n.iushrn(h); h-- > 0; ) (o.isOdd() || l.isOdd()) && (o.iadd(c), l.isub(d)), o.iushrn(1), l.iushrn(1);
    ...
    function y(e) {
        T.call(this, e), (this.shift = this.m.bitLength()), this.shift % 26 != 0 && (this.shift += 26 - (this.shift % 26)), (this.r = new a(1).iushln(this.shift)), (this.r2 = this.imod(this.r.sqr())), (this.rinv = this.r._invmp(this.m)), (this.minv = this.rinv.mul(this.r).isubn(1).div(this.m)), (this.minv = this.minv.umod(this.r)), (this.minv = this.r.sub(this.minv));
    }
    (E.prototype._tmp = function () {
        ...
        (a._prime = function (e) {
            ...
            if (g[e]) return g[e];
            if ('k256' === e) t = new v();
            else if ('p224' === e) t = new I();
            else if ('p192' === e) t = new S();
            else if ('p25519' === e) t = new b();
        ...
        (T.prototype.sqrt = function (e) {
            ...
            for (var d = this.pow(c, i), f = this.pow(e, i.addn(1).iushrn(1)), _ = this.pow(e, i), h = s; 0 !== _.cmp(o); ) {
                for (var p = _, m = 0; 0 !== p.cmp(o); m++) p = p.redSqr();
                r(m < h);
                var g = this.pow(d, new a(1).iushln(h - m - 1));
                (f = f.redMul(g)), (d = g.redSqr()), (_ = _.redMul(d)), (h = m);
            }
            return f;
        }),
        ...
        i(y, T),
        (y.prototype.convertTo = function (e) {

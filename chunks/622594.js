...
(a = l || (l = {}))[a.START = 0] = "START", a[a.PLAYHEAD = 1] = "PLAYHEAD", a[a.END = 2] = "END", n.Z = i.memo(function(e) {
  let {
    ...
    audio: N
  } = (0, d.p)(), _ = null != N, v = i.useRef(null), D = i.useRef(null), O = i.useRef(null), [S, x] = i.useState(0), [y, E] = i.useState(0), [A, b] = i.useState(0), [M, C] = i.useState(!1), [j, I] = i.useState(!1), [w, U] = i.useState(!1), [L, Z] = i.useState(0), [R, P] = i.useState(-1), T = i.useMemo(() => L / p.fineTuningScale, [p.fineTuningScale, L]);
  i.useEffect(() => {
    if (null == N) return;
  ...
  }, [p.fineTuningDelay, w, A, R, j, y, M, S]), (0, s.jsxs)("div", {

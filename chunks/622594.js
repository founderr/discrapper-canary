...
(a = l || (l = {}))[a.START = 0] = "START", a[a.PLAYHEAD = 1] = "PLAYHEAD", a[a.END = 2] = "END", n.Z = s.memo(function(e) {
  let {
    ...
    audio: N
  } = (0, d.p)(), _ = null != N, v = s.useRef(null), D = s.useRef(null), O = s.useRef(null), [S, x] = s.useState(0), [y, E] = s.useState(0), [A, b] = s.useState(0), [M, C] = s.useState(!1), [j, I] = s.useState(!1), [w, U] = s.useState(!1), [L, Z] = s.useState(0), [R, P] = s.useState(-1), T = s.useMemo(() => L / p.fineTuningScale, [p.fineTuningScale, L]);
  s.useEffect(() => {
    if (null == N) return;
  ...
  }, [p.fineTuningDelay, w, A, R, j, y, M, S]), (0, i.jsxs)("div", {

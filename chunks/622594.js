...
(a = l || (l = {}))[a.START = 0] = 'START', a[a.PLAYHEAD = 1] = 'PLAYHEAD', a[a.END = 2] = 'END', n.Z = s.memo(function (e) {
    let {
            ...
            onChangePosition: a,
            disabled: r = !1
        } = e, p = { ...h.nl }, {audio: N} = (0, d.p)(), _ = null != N, v = s.useRef(null), D = s.useRef(null), O = s.useRef(null), [S, x] = s.useState(0), [y, E] = s.useState(0), [A, b] = s.useState(0), [M, C] = s.useState(!1), [j, I] = s.useState(!1), [w, U] = s.useState(!1), [L, Z] = s.useState(0), [R, P] = s.useState(-1), T = s.useMemo(() => L / p.fineTuningScale, [
            p.fineTuningScale,
            L
        ]);
    s.useEffect(() => {
    ...
    let B = s.useCallback((e, n) => {
            ...
            if (null == N || !M)
                return;
            let n = parseInt(e.target.value), t = n > A ? A : n;
            l((0, f.my)(t)), x(t), E(t);
        }, [
            N,
            l,
            ...
            if (null == N || !w)
                return;
            let n = parseInt(e.target.value), t = n > S ? n : S;
            l((0, f.my)(S)), E(S), b(t);
        }, [
            N,
            l,
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, i.jsx)('div', {
                        ...
                        children: (0, i.jsx)('div', {
                            className: u()(g.playhead, { [g.dragging]: j || M || w || n }),

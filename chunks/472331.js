e = n.nmd(e), n("70102"), n("424973"), n("274635"), n("843762"), n("781738"), n("854508"), ! function(t) {
  ...
  function p(e, t) {
    var n, r, o, s, a, c, u, l, d = e.constructor,
      f = d.precision;
    if (!e.s || !t.s) return !t.s && (t = new d(e)), i ? k(t, f) : t;
    if (u = e.d, l = t.d, a = e.e, o = t.e, u = u.slice(), s = a - o) {
      for (s < 0 ? (r = u, s = -s, c = l.length) : (r = l, o = a, c = u.length), s > (c = (a = Math.ceil(f / 7)) > c ? a + 1 : c + 1) && (s = c, r.length = 1), r.reverse(); s--;) r.push(0);
      r.reverse()
    }
    for (c = u.length, c - (s = l.length) < 0 && (s = c, r = l, l = u, u = r), n = 0; s;) n = (u[--s] = u[s] + l[s] + n) / 1e7 | 0, u[s] %= 1e7;
  ...
  f.absoluteValue = f.abs = function() {
    ...
    var e, t, n, r, s, a, u, l = this.constructor;
    if (this.s < 1) {
      if (!this.s) return new l(0);
      throw Error(o + "NaN")
    }
    for (e = m(this), i = !1, 0 == (s = Math.sqrt(+this)) || s == 1 / 0 ? (((t = v(this.d)).length + e) % 2 == 0 && (t += "0"), s = Math.sqrt(t), e = c((e + 1) / 2) - (e < 0 || e % 2), r = new l(t = s == 1 / 0 ? "1e" + e : (t = s.toExponential()).slice(0, t.indexOf("e") + 1) + e)) : r = new l(s.toString()), s = u = (n = l.precision) + 3;;)
    ...
    var t, n, r, o, s, a, c, u, l, d = this.constructor,
      f = this.d,
      p = (e = new d(e)).d;
    if (!this.s || !e.s) return new d(0);
    for (e.s *= this.s, n = this.e + e.e, u = f.length, u < (l = p.length) && (s = f, f = p, p = s, a = u, u = l, l = a), s = [], r = a = u + l; r--;) s.push(0);
    for (r = l; --r >= 0;) {
      for (t = 0, o = u + r; o > r;) c = s[o] + p[r] * f[o - r - 1] + t, s[o--] = c % 1e7 | 0, t = c / 1e7 | 0;
      s[o] = (s[o] + t) % 1e7 | 0
    }
    for (; !s[--a];) s.pop();
    return t ? ++n : s.shift(), e.d = s, e.e = n, i ? k(e, d.precision) : e
    ...
    if (d.eq(n)) return d;
    if (s = f.precision, e.eq(n)) return k(d, s);
    if (t = e.e, l = t >= (r = e.d.length - 1), u = d.s, l) {
      if ((r = p < 0 ? -p : p) <= 9007199254740991) {
        for (a = new f(n), t = Math.ceil(s / 7 + 4), i = !1; r % 2 && M((a = a.times(d)).d, t), 0 !== (r = c(r / 2));) {
          ;
          M((d = d.times(d)).d, t)
        }
    ...
    return u = u < 0 && 1 & e.d[Math.max(t, r)] ? -1 : 1, d.s = 1, i = !1, a = e.times(w(d, s + 12)), i = !0, (a = b(a)).s = u, a
  ...
  var g = function() {
    ...
    return function(r, i, s, a) {
      var c, u, l, d, f, p, h, v, g, b, y, x, w, S, E, _, M, D, C = r.constructor,
        P = r.s == i.s ? 1 : -1,
        T = r.d,
        A = i.d;
      if (!r.s) return new C(r);
      if (!i.s) throw Error(o + "Division by zero");
      for (l = 0, u = r.e - i.e, M = A.length, E = T.length, v = (h = new C(P)).d = []; A[l] == (T[l] || 0);) ++l;
      if (A[l] > (T[l] || 0) && --u, (x = null == s ? s = C.precision : a ? s + (m(r) - m(i)) + 1 : s) < 0) return new C(0);
      if (x = x / 7 + 2 | 0, l = 0, 1 == M)
        for (d = 0, A = A[0], x++;
          (l < E || d) && x--; l++) w = 1e7 * d + (T[l] || 0), v[l] = w / A | 0, d = w % A | 0;
      else {
        for ((d = 1e7 / (A[0] + 1) | 0) > 1 && (A = e(A, d), T = e(T, d), M = A.length, E = T.length), S = M, b = (g = T.slice(0, M)).length; b < M;) g[b++] = 0;
        (D = A.slice()).unshift(0), _ = A[0], A[1] >= 1e7 / 2 && ++_;
        do d = 0, (c = t(A, g, M, b)) < 0 ? (y = g[0], M != b && (y = 1e7 * y + (g[1] || 0)), (d = y / _ | 0) > 1 ? (d >= 1e7 && (d = 1e7 - 1), p = (f = e(A, d)).length, b = g.length, 1 == (c = t(f, g, p, b)) && (d--, n(f, M < p ? D : A, p))) : (0 == d && (c = d = 1), f = A.slice()), (p = f.length) < b && f.unshift(0), n(g, f, b), -1 == c && (b = g.length, (c = t(A, g, M, b)) < 1 && (d++, n(g, M < b ? D : A, b))), b = g.length) : 0 === c && (d++, g = [0]), v[l++] = d, c && g[0] ? g[b++] = T[S] || 0 : (g = [T[S]], b = 1); while ((S++ < E || void 0 !== g[0]) && x--)
      }
  ...
  function b(e, t) {
    ...
    for (null == t ? (i = !1, l = h) : l = t, c = new p(.03125); e.abs().gte(.1);) e = e.times(c), f += 5;
    for (l += Math.log(u(2, f)) / Math.LN10 * 2 + 5 | 0, r = o = s = new p(n), p.precision = l;;) {
      if (o = k(o.times(e), l), r = r.times(++d), v((c = s.plus(g(o, r, l))).d).slice(0, l) === v(s.d).slice(0, l)) {
        for (; f--;) s = k(s.times(s), l);
  ...
  function w(e, t) {
    ...
    if (f += 10, S.precision = f, s = (r = v(x)).charAt(0), !(15e14 > Math.abs(c = m(b)))) return d = y(S, f + 2, E).times(c + ""), b = w(new S(s + "." + r.slice(1)), f - 10).plus(d), S.precision = E, null == t ? (i = !0, k(b, E)) : b;
    for (; s < 7 && 1 != s || 1 == s && r.charAt(1) > 3;) s = (r = v((b = b.times(e)).d)).charAt(0), h++;
    c = m(b), s > 1 ? (b = new S("0." + r), c++) : b = new S(s + "." + r.slice(1));
    for (l = u = b = g(b.minus(n), b.plus(n), f), p = k(b.times(b), f), a = 3;;) {
      if (u = k(u.times(p), f), v((d = l.plus(g(u, new S(a), f))).d).slice(0, f) === v(l.d).slice(0, f)) return l = l.times(2), 0 !== c && (l = l.plus(y(S, f + 2, E).times(c + ""))), l = g(l, new S(h), f), S.precision = E, null == t ? (i = !0, k(l, E)) : l;
      l = d, a += 2
    }
  }
  ...
  function S(e, t) {
    ...
    if (t = t.slice(r, o)) {
      ...
      for (; r--;) t += "0";
      if (e.d.push(+t), i && (e.e > d || e.e < -d)) throw Error(a + n)
    } else e.s = 0, e.e = 0, e.d = [0];
    return e
  }

  function k(e, t, n) {
    var r, o, s, l, f, p, h, v, g = e.d;
    for (l = 1, s = g[0]; s >= 10; s /= 10) l++;
    if ((r = t - l) < 0) r += 7, o = t, h = g[v = 0];
    else {
      if ((v = Math.ceil((r + 1) / 7)) >= (s = g.length)) return e;
      for (l = 1, h = s = g[v]; s >= 10; s /= 10) l++;
      r %= 7, o = r - 7 + l
    }
    if (void 0 !== n && (f = h / (s = u(10, l - o - 1)) % 10 | 0, p = t < 0 || void 0 !== g[v + 1] || h % s, p = n < 4 ? (f || p) && (0 == n || n == (e.s < 0 ? 3 : 2)) : f > 5 || 5 == f && (4 == n || p || 6 == n && (r > 0 ? o > 0 ? h / u(10, l - o) : 0 : g[v - 1]) % 10 & 1 || n == (e.s < 0 ? 8 : 7))), t < 1 || !g[0]) return p ? (s = m(e), g.length = 1, t = t - s - 1, g[0] = u(10, (7 - t % 7) % 7), e.e = c(-t / 7) || 0) : (g.length = 1, g[0] = e.e = e.s = 0), e;
    if (0 == r ? (g.length = v, s = 1, v--) : (g.length = v + 1, s = u(10, 7 - r), g[v] = o > 0 ? (h / u(10, l - o) % u(10, o) | 0) * s : 0), p)
      for (;;)
        if (0 == v) {
          1e7 == (g[0] += s) && (g[0] = 1, ++e.e);
          break
    ...
    if (i && (e.e > d || e.e < -d)) throw Error(a + m(e));
    return e
  }

  function E(e, t) {
    var n, r, o, s, a, c, u, l, d, f, p = e.constructor,
      h = p.precision;
    if (!e.s || !t.s) return t.s ? t.s = -t.s : t = new p(e), i ? k(t, h) : t;
    if (u = e.d, f = t.d, r = t.e, l = e.e, u = u.slice(), a = l - r) {
      for ((d = a < 0) ? (n = u, a = -a, c = f.length) : (n = f, r = l, c = u.length), a > (o = Math.max(Math.ceil(h / 7), c) + 2) && (a = o, n.length = 1), n.reverse(), o = a; o--;) n.push(0);
      n.reverse()
    } else {
      for (o = u.length, (d = o < (c = f.length)) && (c = o), o = 0; o < c; o++)
        if (u[o] != f[o]) {
          d = u[o] < f[o];
          break
        } a = 0
    }
    for (d && (n = u, u = f, f = n, t.s = -t.s), c = u.length, o = f.length - c; o > 0; --o) u[c++] = 0;
    for (o = f.length; o > a;) {
      if (u[--o] < f[o]) {

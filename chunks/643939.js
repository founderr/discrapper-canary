...
let T = a.memo(function (e) {
    let { message: s, handleClick: t, handleClose: i, buttonText: T, useInitialGlow: S, useGlowOnHover: I, handleImageClick: N, className: m, analyticsLocations: A, upsellType: C } = e,
        [g, h] = a.useState(S);
    return (
        a.useEffect(() => {
            setTimeout(() => h(!1), 3000);

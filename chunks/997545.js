...
class C extends _.Z {
    ...
    initialize(e) {
        ...
        if (null != n.createOwnStreamConnectionWithOptions) s = this.context === T.Yn.STREAM && this.streamUserId === this.userId ? n.createOwnStreamConnectionWithOptions : n.createVoiceConnectionWithOptions;
        else if (null != n.createOwnStreamConnection) {
            var i,
                a,
                s,
                o = this.context === T.Yn.STREAM && this.streamUserId === this.userId ? n.createOwnStreamConnection : n.createVoiceConnection;
        ...
        null ===
            (i = (t = this.conn =
                s(this.userId, e, (i, a) => {
                    ...
                    if (null != i && '' !== i) {
                        this.setConnectionState(T.$j.NO_ROUTE), this.emit(m.Sh.Error, i);
                        return;
                    }
    ...
    setClipRecordUser(e, t, n) {
        if (!this.destroyed) {
            var r, i;
            null === (r = (i = this.conn).setClipRecordUser) || void 0 === r || r.call(i, e, (this.context === T.Yn.STREAM ? 'application' : 'user').concat('audio' === t ? 'Audio' : 'Video'), n);
        }
    }
    ...
    getLocalVolume(e) {
        ...
        return null == n && (n = this.context === T.Yn.DEFAULT ? T.Qx : T.Yh), (null != (t = n) ? t : T.Qx) / T.Qx;
    }
    setLocalVolume(e, t) {
    ...
    setDesktopEncodingOptions(e, t, n) {
        if (this.destroyed) return;
        let r = (0 === t && n >= 10) || t > 720 || n > 30 ? S.yf : S.YE,
            i = {
                width: e,
                height: t,
                framerate: n
    ...
    setRemoteVideoSinkWants(e) {
        (this.remoteVideoSinkWants = e), this.updateVideoQuality(S.XR);
    }
    ...
    getCodecOptions(e, t, n) {
        ...
        for (o of this.codecs) {
            ...
            this.experimentFlags.has(S.V8.RESET_DECODER_ON_ERRORS) && (n.params['reset-on-errors'] = '1'),
                this.experimentFlags.has(S.V8.SOFTWARE_FALLBACK_ON_ERRORS) && (n.params['fallback-after-errors'] = '3'),
                this.experimentFlags.has(S.V8.SOFTWARE_FALLBACK_ON_CONSECUTIVE_ERRORS) && (n.params['fallback-on-consecutive-errors'] = '1'),
                this.experimentFlags.has(S.V8.SIGNAL_AV1_HARDWARE_DECODE) && (n.params['hardware-av1-decode'] = '1'),
                c.push(n),
                o.name === t &&
                    ((d = {
                        ...n,
                    ...
                    this.experimentFlags.has(S.V8.VIDEOTOOLBOX_RATE_CONTROL) && (d.params['fixed-rate-presentation-timestamps'] = '1'));
        }
        return {
            videoEncoder: d,
            videoDecoders: c,
    ...
    getConnectionTransportOptions() {
        ...
        return (0, v.eJ)(T.eR.VIDEO_EFFECTS) && this.context === T.Yn.STREAM && (e.enableVideoEffects = !0), this.experimentFlags.has(S.V8.MUTE_BEFORE_PROCESSING) && (e.muteBeforeProcessing = !0), this.experimentFlags.has(S.V8.PTT_BEFORE_PROCESSING) && (e.pttBeforeProcessing = !0), this.experimentFlags.has(S.V8.SKIP_ENCODE) && (e.skipEncode = !0), e;
    }
    setStream(e) {
    ...
    constructor(e, t, n) {
        super(e, t),
            ...
            y(this, 'inputMode', T.pM.VOICE_ACTIVITY),
            ...
            y(this, 'handleRTCPMessage', (e, t) => {
                if (e === S.ym.REMB && this.context === T.Yn.STREAM) {
                    let e = JSON.parse(t);
                    e.ssrcs.forEach((t) => {
                        var n, r, a, s;
                ...
                if (null != e) {
                    if (null != this.stats) {
                        ...
                        if (null != s && null != o && null != s.framesCaptured && null != o.framesCaptured) {
                            ...
                            this.inputMode === T.pM.VOICE_ACTIVITY && this.vadAutoThreshold && this.vadUseKrisp && e > 50 && null != s.voiceActivityDetectorProcessTime && null != o.voiceActivityDetectorProcessTime && (s.voiceActivityDetectorProcessTime - o.voiceActivityDetectorProcessTime) / e > 4 && this.emit(m.Sh.VoiceActivityDetectorError, T.H3.VAD_CPU_OVERUSE);
                        }
                    }
                    this.stats = e;
                }

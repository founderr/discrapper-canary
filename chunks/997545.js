...
var r = n(595182), i = n.n(r), a = n(117806), o = n.n(a), s = n(565925), l = n.n(s), u = n(971793), c = n.n(u), d = n(420994), _ = n(259443), E = n(839548), f = n(198274), h = n(701597), p = n(46973), m = n(829839), I = n(916057), T = n(992774), g = n(158466), S = n(650886), A = n(65154), N = n(149396);
function v(e, t, n) {
...
class C extends E.Z {
    ...
    initialize(e) {
        ...
        let n = (0, T.zS)(), r = null != n.getCodecCapabilities ? n.getCodecCapabilities : n.getSupportedVideoCodecs;
    ...
    createUser(e, t, n) {
        ...
        let r = this.remoteAudioSSRCs[e], i = this.remoteVideoSSRCs[e];
        ...
        if (this.remoteAudioSSRCs[e] = t, this.remoteVideoSSRCs[e] = null != n ? n : [], this.userId !== e && (a || o)) {
            let r = void 0 !== n && n.length > 0 ? n[0] : 0, i = {
                    id: e,
                    ssrc: t,
                    videoSsrc: r,
                    videoSsrcs: n,
    ...
    setDesktopEncodingOptions(e, t, n) {
        if (this.destroyed)
            return;
        let r = 0 === t && n >= 10 || t > 720 || n > 30 ? A.yf : A.YE, i = {
                width: e,
                height: t,
                framerate: n
            ...
            if (null != e) {
                if (null != this.stats) {
                    let t = c()(e.rtp.outbound, (e, t) => {
                            ...
                            lost: 0,
                            sent: 0
                        }), r = t.sent - n.sent, a = t.lost - n.lost;
                    if (0 === r)
                    ...
                    let o = e.rtp.outbound.filter(e => 'audio' === e.type)[0], s = this.stats.rtp.outbound.filter(e => 'audio' === e.type)[0];
                    if (null != o && null != s && null != o.framesCaptured && null != s.framesCaptured) {
                        let e = o.framesCaptured - s.framesCaptured, t = null != o.noiseCancellerFrames ? null != s.noiseCancellerFrames ? o.noiseCancellerFrames - s.noiseCancellerFrames : 0 : e;

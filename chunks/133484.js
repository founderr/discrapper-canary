...
var n = s(735250), a = s(470079), i = s(481060), r = s(410030), o = s(100527), l = s(906732), c = s(197115), d = s(626135), _ = s(74538), E = s(981631), u = s(474936), T = s(689938), I = s(455802), S = s(699623), N = s(820350);
function C(e) {
    let {
            user: t,
            showOverlay: s,
            children: C
        } = e, m = (0, r.ZP)(), {analyticsLocations: A} = (0, l.ZP)(o.Z.PREMIUM_UPSELL_OVERLAY);
    return (a.useEffect(() => {

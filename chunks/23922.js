...
function O(e) {
  ...
  }), i = m.default.supports(A.Features.GO_LIVE_HARDWARE), [o, f] = n.useState(null), [S, E] = n.useState(null), [g, N] = n.useState(null), p = null != g && g.length > 0, [L, M] = n.useState(u.DesktopSources.WINDOW), [O, j] = n.useState(!1), D = n.useRef(null), P = n.useRef(new d.Interval);
  n.useEffect(() => {
    let e = P.current;
    return T().then(e => {
      let {

...
function w() {
    ...
    return (
        u.useEffect(() => {
            if ('cache-only' !== e.fetchPolicy) ('cache-and-network' === e.fetchPolicy || ('cache-or-network' === e.fetchPolicy && 0 === a)) && s && !t && !i && (n(!0), (0, N.xw)(), (0, y.Z)({ location: M.dr.USE_QUESTS }) && (0, N.w)(O.Ok.DESKTOP_ACCOUNT_PANEL_AREA));

...
var r, i, a, o, s = n(470079), l = n(846519), u = n(442837), c = n(583434), d = n(706454), _ = n(553795), E = n(70956), f = n(617136), h = n(272008), p = n(569984), m = n(497505), I = n(918701), T = n(796111), g = n(977156), S = n(31055), A = n(566078), N = n(46140), v = n(981631), O = n(689938);
function R() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : { fetchPolicy: 'cache-only' }, [t, n] = s.useState(!1), r = (0, u.Wu)([p.Z], () => [...p.Z.quests.values()]), {
        ...
        })), o = (0, g.cB)({ location: N.dr.USE_QUESTS });
    return s.useEffect(() => {
...
function y(e) {
    let {
        ...
        } = R({ fetchPolicy: 'cache-and-network' }), r = new Map(t.map(e => [
            e.id,
            e
        ])), i = function (e) {
            ...
            return s.useMemo(() => {
                ...
                let e = t.sort((e, t) => {
                    var n, r, i, a, o, s;
                    let l = !(0, I.zi)(e), u = !(0, I.zi)(t), c = (0, I.Mi)(e, m.jn.QUEST_BAR) || (0, I.Mi)(e, m.jn.QUEST_BAR_V2), d = (0, I.Mi)(t, m.jn.QUEST_BAR) || (0, I.Mi)(t, m.jn.QUEST_BAR_V2), _ = (0, I.Mi)(e, m.jn.GIFT_INVENTORY_FOR_YOU), E = (0, I.Mi)(t, m.jn.GIFT_INVENTORY_FOR_YOU), f = (null === (n = e.userStatus) || void 0 === n ? void 0 : n.enrolledAt) != null, h = (null === (r = t.userStatus) || void 0 === r ? void 0 : r.enrolledAt) != null;
...
function D() {
    let {
        ...
        } = R({ fetchPolicy: 'cache-only' }), [n, r] = s.useState(() => new Map(e.map(e => [
            e.id,
            (0, I.zi)(e)
        ])));
    return s.useEffect(() => {
...
let U = e => {
    let t = s.useCallback(() => (0, I.il)(e), [e]), [n, r] = s.useState(t()), i = s.useCallback(() => r(t()), [t]), a = P(e);
    return s.useEffect(() => {
        var t, n, r;
...
function k() {
    let {
            quests: e,
            isFetchingCurrentQuests: t
        } = R({ fetchPolicy: 'cache-or-network' }), n = D();
    return s.useMemo(() => {
        let r = [];
        if (t || 0 === e.length)
            return r;
        for (let t of e) {
            ...
            let e = null != t.userStatus.claimedAt, a = (0, I.zE)(t.userStatus, m.jn.GIFT_INVENTORY_SETTINGS_BADGE);
            if (!e && !a) {
                r.push(t);
                continue;
            }
...
function F(e) {
    let t = (0, S.z)({ location: N.dr.MEMBERS_LIST }), n = (0, u.e7)([p.Z], () => t ? p.Z.quests : null), r = s.useMemo(() => (0, I.Jg)(n, e), [
            e,
            n
        ]);
    return L(r) ? null : r;
...
function Z() {
    let {
            ...
            let e = t.filter(e => !1 === e.revoked), n = e.filter(e => e.type === v.ABu.XBOX), r = e.filter(e => e.type === v.ABu.PLAYSTATION), i = n.concat(r);
            return {
                xboxAccounts: n,
                playstationAccounts: r,
                xboxAndPlaystationAccounts: i

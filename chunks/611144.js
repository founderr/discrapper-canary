...
function l(e, t) {
    ...
    case a.Us.NAVIGATE_RIGHT:
        return function (e, t) {
            let n = e.focusedY !== e.columnCounts.length - 1 && e.focusedX + 1 === e.columnCounts[e.focusedY], r = n ? 0 : s(e.focusedX + 1, e.columnCounts[e.focusedY] - 1), i = n ? e.focusedY + 1 : e.focusedY;
            return {
                ...e,
                focusedX: r,
                focusedY: i
    ...
    case a.Us.NAVIGATE_LEFT:
        return function (e, t) {
            let n = 0 !== e.focusedY && 0 === e.focusedX, r = n ? e.focusedY - 1 : e.focusedY, i = n ? e.columnCounts[r] - 1 : o(0, e.focusedX - 1);
            return {
                ...e,
                focusedX: i,
                focusedY: r
    ...
    case 'UPDATE_COLUMN_COUNTS':
        return function (e, t) {
            let {columnCounts: n} = t, r = s(o(0, n.length - 1), e.focusedY);
            return {
                ...e,
                columnCounts: n,

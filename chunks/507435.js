...
function M(e) {
  ...
  let {
    message: n,
    compact: s
  } = e, a = n.embeds[0], r = i.useMemo(() => (0, m.default)(a), [a]), o = (0, u.truncateText)(null !== (t = null == r ? void 0 : r.questionText) && void 0 !== t ? t : "", N.POLL_RESULT_MESSAGE_POLL_TITLE_MAX_VISIBLE_CHARS), c = n.messageReference, f = i.useCallback(() => {

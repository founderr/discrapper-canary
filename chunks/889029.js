...
var s = n(120356),
    ...
    S = n(232186);
function T() {
    let { enabled: e, autoToggle: t, hideInstantInvites: s, hidePersonalInformation: T, disableSounds: E, disableNotifications: C, enableContentProtection: _ } = (0, l.cj)([u.Z], () => ({ ...u.Z.getSettings() })),
        f = (e, t) => {
            o.Z.update({ [e]: t });
        };

t(47120), t(653041);
var i = t(735250), a = t(470079), s = t(392711), l = t.n(s), o = t(442837), r = t(481060), c = t(139387), d = t(503089), u = t(231757), I = t(106976), m = t(488915), _ = t(984933), N = t(496675), E = t(285952), T = t(585483), h = t(63063), p = t(919196), g = t(731072), C = t(494118), f = t(351644), x = t(720764), O = t(981631), S = t(689938), A = t(619381);
function R(e, n) {
    switch (e) {
    ...
    case O.b4C.YOUTUBE:
        null != q[O.ABu.YOUTUBE] && (Q = (0, i.jsx)(g.Z, {
            ...
            helpText: S.Z.Messages.INTEGRATIONS_YOUTUBE_HELP.format({
                connectAction: () => (0, u.Z)({ platformType: O.ABu.YOUTUBE }),

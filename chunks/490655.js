...
errors: P,
hasChanges: B
  } = e, y = (0, r.e7)([N.ZP], () => null != s ? N.ZP.getDefaultChannel(s.id) : null), G = (0, r.cj)([N.ZP], () => N.ZP.getChannels(null == s ? void 0 : s.id)), k = (0, r.cj)([E.Z], () => l().keyBy(G.SELECTABLE.map(e => e.channel).filter(e => E.Z.can(x.Plq.MANAGE_WEBHOOKS, e)), 'id')), U = (0, r.cj)([E.Z], () => l().keyBy(G.VOCAL.map(e => e.channel).filter(e => e.isGuildVocal() && E.Z.can(x.Plq.MANAGE_WEBHOOKS, e)), 'id')), H = null != b ? b : y, w = n === x.b4C.APPLICATION ? t : null, [W, F] = a.useState(c.$x), V = a.useCallback(() => B() ? (T.S.dispatch(x.CkL.SHAKE_APP, {
duration: 300,
intensity: W
  }), F(Math.min(W + c.d7, c.w6)), T.S.dispatch(x.CkL.EMPHASIZE_NOTICE), !1) : (F(c.$x), !0), [
B,
W
...
for (let n of M) {
  if (n.channel_id in k || n.channel_id in U)
    null != n.application_id && n.application_id in e ? e[n.application_id].webhooks.push(n) : n.type === x.ylB.CHANNEL_FOLLOWER ? a.push(n) : i.push(n);
}
return {
...
if ((null == s ? void 0 : s.id) != null)
  ...
  switch (n) {
case x.b4C.TWITCH:
  null != q[x.ABu.TWITCH] && (Q = (0, i.jsx)(p.Z, {
    guild: s,
  ...
  break;
case x.b4C.YOUTUBE:
  null != q[x.ABu.YOUTUBE] && (Q = (0, i.jsx)(p.Z, {
    guild: s,

...
n.Z = a.memo(function (e) {
    let { section: n, sectionId: t, guild: s, channel: b, integrations: Z, editedIntegration: v, webhooks: M, editedWebhook: L, isFetching: j, refToScroller: D, errors: P, hasChanges: B } = e,
        y = (0, o.e7)([N.ZP], () => (null != s ? N.ZP.getDefaultChannel(s.id) : null)),
        G = (0, o.cj)([N.ZP], () => N.ZP.getChannels(null == s ? void 0 : s.id)),
        k = (0, o.cj)([E.Z], () =>
            l().keyBy(
                G.SELECTABLE.map((e) => e.channel).filter((e) => E.Z.can(C.Plq.MANAGE_WEBHOOKS, e)),
                'id'
            )
        ),
        U = (0, o.cj)([E.Z], () =>
            l().keyBy(
                G.VOCAL.map((e) => e.channel).filter((e) => e.isGuildVocal() && E.Z.can(C.Plq.MANAGE_WEBHOOKS, e)),
                'id'
            )
        ),
        w = null != b ? b : y,
        ...
        K = a.useCallback((e) => !!V() && (d.Z.setSection(e), !0), [V]),
        {
            ...
            for (let n of M) {
                if (n.channel_id in k || n.channel_id in U) null != n.application_id && n.application_id in e ? e[n.application_id].webhooks.push(n) : n.type === C.ylB.CHANNEL_FOLLOWER ? a.push(n) : i.push(n);
            }
            return {
        ...
        if (!j)
            switch (n) {
                ...
                case C.b4C.YOUTUBE:
                    ...
                    break;
                case C.b4C.APPLICATION:
                    (null == H || !(H in z || H in Y)) && d.Z.setSection(C.b4C.OVERVIEW);
            }
    }, [Y, z, q, H, n, j]),
        a.useEffect(() => {
    ...
    switch (n) {
        ...
        case C.b4C.APPLICATION:
            var $;
            let ee = null != H ? (null !== ($ = Y[z[H]]) && void 0 !== $ ? $ : Y[H]) : null;
            null != ee &&
                (Q = (0, i.jsx)(g.Z, {
                    guild: s,

...
async function j(e, t, n, a, s) {
  ...
  null !== l && (null == P && U(), t ? await (0, N.stopSpeaking)() : null == x || x.removeEventListener("end", N.stopSpeaking), l.addEventListener("end", N.stopSpeaking), null != a && l.addEventListener("start", a), null != s && l.addEventListener("end", s), x = l, i.speakUtterance(l, P))
}
...
function k() {
  return null !== x && x.removeEventListener("end", N.stopSpeaking), i.cancelAll(), x = null, !0
}
...
function F(e) {
  ...
  let T = I.default.getChannelId(),
    ...
    x = S.default.getTTSType(),
    P = (null === (t = u.author) || void 0 === t ? void 0 : t.id) !== f.default.getId() && (x === O.TTSNotificationTypes.ALL_CHANNELS || x === O.TTSNotificationTypes.SELECTED_CHANNEL && v);

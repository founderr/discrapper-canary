...
function I(e) {
    var t, n, a;
    let o,
        { command: u, activeOptionName: c, channel: E, showOptions: h, showImage: I, optionStates: m, onOptionClick: T, section: S, isSelectable: g = !0 } = e,
        A = i.useMemo(() => {
            var e;
    ...
    let R = I && null != S ? (0, d.ky)(S) : null;
    return (0, r.jsxs)('div', {
        className: s()(f.wrapper, g ? null : f.disabled),
        children: [
            null != R
                ? (0, r.jsx)(R, {
                      className: f.image,

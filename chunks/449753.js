...
function N(e, t) {
  ...
  null != n && n !== u.default.getRegion(_.default.getHostname(_.default.getActiveStreamKey())) && (0, s.changeStreamRegion)(e, n)
}
t.default = {
  init() {
    let e = (e, t) => {
    ...
    r.default.subscribe("STREAM_WATCH", t => {
      ...
      t.forEach(e => {
        ...
        if (t !== o.default.getId() && null != n) {
          if (r && m(n, t)) return;
          let e = a.default.getActiveStreamForUser(t, i);
          if (null != e && e.channelId === n && (!r && e.state !== I.ApplicationStreamStates.ENDED && T.start(18e4, () => (0, s.closeStream)((0, E.encodeStreamKey)(e), !1)), r && e.state === I.ApplicationStreamStates.ENDED)) {
            T.stop();
            let e = a.default.getStreamForUser(t, i);
            if (null == e) return;
            (0, s.watchStream)(e)
          }
        }

    ...
    constructor(...e) {
        super(...e), D(this, 'getSortedBans', (0, S.oH)((e, t) => {
            ...
            if (n > 0)
                return null;
            if (null == i && 0 === a)
                return (0, s.jsx)(c.Spinner, {
                    className: M.spinner,
                    type: c.Spinner.Type.SPINNING_CIRCLE
                }, 'spinner');
            let d = this.getSortedBans(i, o)[a], u = null == i ? void 0 : i.get(null !== (t = null == d ? void 0 : d.id) && void 0 !== t ? t : '');
            if (null != d && null != u)
                return (0, s.jsx)(Z, {
                    user: d,
                    ban: u,
...
function G() {
    var e;
    let {guild: t} = (0, o.e7)([p.Z], () => p.Z.getProps(), [], l.isEqual), {enabled: n} = x.T.useExperiment({

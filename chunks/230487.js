...
var i = n(735250);
n(470079);
var s = n(481060), a = n(740492), r = n(626135), l = n(358085), o = n(998502), c = n(258220), d = n(981631);
...
function _(e) {
    !a.ZP.disableActivityHardwareAccelerationPrompt && l.isPlatformEmbedded && !o.ZP.getEnableHardwareAcceleration() && (0, s.openModalLazy)(async () => {
        ...
        modalKey: u,
        onCloseRequest: () => {
            r.default.track(d.rMx.MODAL_DISMISSED, { type: c.ACTIVITY_ENCOURAGES_HW_ACCELERATION }), (0, s.closeModal)(u);
        }
    });
}

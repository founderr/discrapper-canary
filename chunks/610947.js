...
let f = 1000 / 60;
function E(e, t, n, E) {
    let C = (0, s.useToken)(l.Z.unsafe_rawColors.BRAND_500).hex(), g = (0, s.useToken)(l.Z.unsafe_rawColors.BLACK_500).hex(), I = (0, s.useToken)(l.Z.unsafe_rawColors.WHITE_500).hex(), x = i.useRef({}), T = i.useRef(new a.Xp()), v = i.useCallback(t => {

...
let f = 1000 / 60;
function E(e, t, n, E) {
    let C = (0, l.useToken)(s.Z.unsafe_rawColors.BRAND_500).hex(), g = (0, l.useToken)(s.Z.unsafe_rawColors.BLACK_500).hex(), I = (0, l.useToken)(s.Z.unsafe_rawColors.WHITE_500).hex(), x = i.useRef({}), T = i.useRef(new a.Xp()), v = i.useCallback(t => {
    ...
    let N = i.useCallback(() => {
        let t = d.Z.getDrawables(n), i = p.U.getState().particles, a = t.length > 0 || Object.keys(i).length > 0;

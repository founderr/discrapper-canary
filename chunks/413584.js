...
let G = "WELCOME_CHANNEL",
  P = e => {
    ...
    let i, {
      ...
      [f, L] = a.useState(!1),
      A = a.useRef(null),
      v = (0, u.e7)([p.Z], () => p.Z.getChannel(o.channel_id)),
      D = (0, u.e7)([S.Z], () => null != o.emoji_id ? S.Z.getUsableCustomEmojiById(o.emoji_id) : null),
      P = null != v && M.Uu(j.Plq.VIEW_CHANNEL, v),
      B = null !== (t = (0, N.KS)(v)) && void 0 !== t ? t : _.TextIcon,
      y = (0, m.ZP)(v, !1),
      {
    ...
    return a.useLayoutEffect(() => (k(w(A)), () => {
      k(null), w(null)
    }), [k, w]), i = P ? null != D || null != o.emoji_name ? (0, s.jsx)(I.Z, {
...
t.Z = e => {
  ...
  let {
    ...
    if (null != i) p !== c.description && ((0, g.Es)(i.id, {
      description: null == p ? void 0 : p.trim()
    }), N(!0))
  }, F = e => {
    if (null != i) !o()(e, c.channels) && ((0, g.Es)(i.id, {
      channels: e
    }), N(!0))
  }, k = e => {
    if (null != i) e !== c.enabled && ((0, g.Es)(i.id, {
      enabled: e
    }), x(!d), N(!0))
  }, w = e => {
    if (null == e) return;
  ...
  }, [m, M, p, G, i, Y]), a.useEffect(() => () => (0, g.sm)(), []);
  let W = a.useCallback(() => {
    ...
    children: [B && (0, s.jsx)("div", {
      ...
      children: [(0, s.jsxs)("div", {
        ...
        children: [(0, s.jsx)(_.FormTitle, {
          ...
          isDropHovered: t === E,
          index: t
        }, t)), (null == M || M.length < 5) && (0, s.jsx)(_.Button, {
          onClick: () => (0, _.openModalLazy)(async () => {
            let {
              default: e
            } = await n.e("39143").then(n.bind(n, 737868));

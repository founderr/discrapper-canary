...
function W(e) {
  let {
    ...
    parentMessageId: n,
    location: a
  } = e, l = (0, r.e7)([S.Z], () => S.Z.getChannel(t)), {
  ...
  let {
    ...
    return {
      ...
      submit: a.useCallback(async (e, a, l) => {
        ...
        if (c(m ? (0, y.V_)() : null), d(_ ? (0, y.T4)() : null), m || _) return {
          shouldClear: !1,
          shouldRefocus: !0
        };
        if (null == n) {
...
function K(e) {
  ...
  let {
    ...
    error: r
  } = e, c = null !== (t = l.name) && void 0 !== t ? t : "", d = (0, y.Op)(r, {
    content: c
  }), h = (0, D.Od)(n, a), p = null != a, m = (0, R.Dt)();
...
function q(e) {
  ...
  let x = (0, r.e7)([M.Z], () => M.Z.can(B.Plq.ATTACH_FILES, t)),
    T = (0, y.Op)(h, {
      content: n.textValue
    });

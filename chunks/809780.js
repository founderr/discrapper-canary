        ...
        super(),
            ...
            (this.toggle = (e) => {
                let { channelId: t, guildId: n } = e,
                    { channels: i, collapsedChannels: s, loadState: a } = this.state,
...
function W(e, t, n, i) {
    ...
    if (null == s || (!x.Ec.has(s.type) && j.ZP.isGuildOrCategoryOrChannelMuted(n, s.id))) return;
    if (s.isPrivate()) {
    ...
    s.isNSFW() && !v.Z.didAgree(s.guild_id)
        ? t.push({
              ...u,
              type: 'nsfw'
          })

...
function E(e) {
    ...
    let {
            ...
            if (0 === t && 0 === e)
                return null;
            if (t > 0 && 0 === n)
                return h.Z.Messages.APP_DIRECTORY_MUTUAL_GUILD_COUNT.format({ mutualGuildCount: t });
            let l = t > 0 ? h.Z.Messages.APP_DIRECTORY_GUILD_COUNT_WITH_MUTUALS : h.Z.Messages.APP_DIRECTORY_GUILD_COUNT, r = new Intl.NumberFormat('en-US', {
        ...
        children: [
            (0, r.jsx)('div', {
                ...
                children: I.length > 0 ? (0, r.jsxs)(r.Fragment, {
                    children: [
                        I.map((e, t) => {
                            let n = t === I.length - 1 && 0 === T, i = C.ZP.getGuildIconURL({
                                    id: e.id,
                                    icon: e.icon,
                                    size: g,
                                    canAnimate: !1
                            ...
                            return n ? (0, r.jsx)(o.Fragment, { children: l }, e.id) : (0, r.jsx)(d.ZP, {
                        ...
                        T > 0 ? (0, r.jsx)(u.Tooltip, {
                            text: h.Z.Messages.APP_DIRECTORY_GUILD_COUNT_PLUS_MUTUALS_TOOLTIP.format({ appNames: Z.format(S.map(e => e.name)) }),
                            position: 'top',

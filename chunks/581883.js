...
h(C, "displayName", "UserSettingsProtoStore"), h(C, "persistKey", "UserSettingsProtoStore-Cache"), t.Z = new C(d.Z, {
  ...
  CONNECTION_OPEN: function(e) {
    ...
    i && R(f), f.proto = n, s()("string" != typeof f.proto, "UserSettingsProto cannot be a string"), f.editInfo.triggeredMigrations = i, f.editInfo.cleanupFuncs = r, f.editInfo.loaded = !0, Object.values(A).forEach(e => {

...
function C(e) {
    ...
    g = !o;
    let s = T[n];
    i && O(s), r ? ((s.proto = (0, f.re)(s.ProtoClass, s.proto, t)), a()('string' != typeof s.proto, 'UserSettingsProto cannot be a string')) : ((s.proto = t), a()('string' != typeof s.proto, 'UserSettingsProto cannot be a string'), (s.editInfo.loaded = !0), (s.editInfo.loading = !1));
}
function y(e) {
    let {

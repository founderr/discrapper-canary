var r, i = n(512722), a = n.n(i), o = n(392711), s = n.n(o), l = n(442837), u = n(377108), c = n(524437), d = n(835913), _ = n(570140), E = n(262847), f = n(48481), h = n(526761);
function p(e, t, n) {
...
function O(e) {
    null != e && s().forEach(T, (t, n) => {
        ...
        if (null == o)
            return;
        let s = null !== (r = null == o ? void 0 : o.proto) && void 0 !== r ? r : '', l = (0, f.d5)(t.ProtoClass, s);
        if (null == l)
            return;
...
class R extends (r = l.ZP.PersistedStore) {
    ...
    getGuildFolders() {
        ...
        return null == t ? null : t.map(e => {
            var t, n, r;
            let i = null === (t = e.id) || void 0 === t ? void 0 : t.value, a = null === (n = e.color) || void 0 === n ? void 0 : n.value;
            return {
                guildIds: e.guildIds,
...
p(R, 'displayName', 'UserSettingsProtoStore'), p(R, 'persistKey', 'UserSettingsProtoStore-Cache'), t.Z = new R(_.Z, {

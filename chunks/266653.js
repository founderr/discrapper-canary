...
var o, n, r = s(735250), a = s(470079), i = s(990547), l = s(442837), d = s(481060), c = s(570140), u = s(213609), h = s(594174), f = s(474333), _ = s(726745), p = s(475062), m = s(760213), C = s(71509), g = s(981631), T = s(689938), N = s(868846);
    ...
    a.useEffect(() => {
        if (R)
            L((0, r.jsx)(f.Z, {
                ...
                children: T.Z.Messages.MULTI_ACCOUNT_MAX_ACCOUNTS_ERROR.format({ maxNumAccounts: C.$H })
            })), M(g.lds);
        else if (null != S) {
            ...
            null != e && L((0, r.jsx)(f.Z, {
                ...
                className: N.infoMessage,
                children: T.Z.Messages.MULTI_ACCOUNT_LOGGED_OUT.format({ username: e.username })
            })), O(!1);
        }
    }, [
        S,

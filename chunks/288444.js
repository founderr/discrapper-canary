n(47120);
var r = n(846519), i = n(904245), a = n(287734), o = n(147913), s = n(317381), l = n(592125), u = n(885110), c = n(979651), d = n(938475), _ = n(689938);
function E(e, t, n) {
...
function p() {
    ...
    let e = c.Z.getCurrentClientVoiceChannelId(null);
    if (null != e)
        i.Z.sendBotMessage(e, _.Z.Messages.BOT_CALL_IDLE_DISCONNECT_2.format({ number: 3 })), a.default.selectVoiceChannel(null);
}
class m extends o.Z {
    constructor(...e) {

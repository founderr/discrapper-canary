!(function (t) {
    ...
    var p = (function () {
        ...
        return function (r, i, s, o) {
            ...
            if ((b[c] > (D[c] || 0) && --u, (g = null == s ? (s = y.precision) : o ? s + (m(r) - m(i)) + 1 : s) < 0)) return new y(0);
            if (((g = (g / 7 + 2) | 0), (c = 0), 1 == v)) for (d = 0, b = b[0], g++; (c < O || d) && g--; c++) (S = 10000000 * d + (D[c] || 0)), (h[c] = (S / b) | 0), (d = S % b | 0);
            else {

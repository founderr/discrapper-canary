!(function (t) {
    ...
    function h(e) {
        var t,
            ...
            s = e[0];
        if (i > 0) {
            for (a += s, t = 1; t < i; t++) (n = 7 - (r = e[t] + '').length) && (a += g(n)), (a += r);
    ...
    (_.absoluteValue = _.abs =
        ...
        (_.toPower = _.pow =
            function (e) {
                ...
                return (u = u < 0 && 1 & e.d[Math.max(t, r)] ? -1 : 1), (d.s = 1), (i = !1), (o = e.times(S(d, s + 12))), (i = !0), ((o = I(o)).s = u), o;
            }),
    ...
    var p = (function () {
        ...
        return function (r, i, s, o) {
            ...
            if ((b[c] > (L[c] || 0) && --u, (g = null == s ? (s = y.precision) : o ? s + (m(r) - m(i)) + 1 : s) < 0)) return new y(0);
            if (((g = (g / 7 + 2) | 0), (c = 0), 1 == v)) for (d = 0, b = b[0], g++; (c < O || d) && g--; c++) (S = 10000000 * d + (L[c] || 0)), (h[c] = (S / b) | 0), (d = S % b | 0);
            else {
    ...
    function S(e, t) {
        ...
        if (((_ += 10), (A.precision = _), (s = (r = h(g)).charAt(0)), !(1500000000000000 > Math.abs((l = m(I)))))) return (d = T(A, _ + 2, O).times(l + '')), (I = S(new A(s + '.' + r.slice(1)), _ - 10).plus(d)), (A.precision = O), null == t ? ((i = !0), N(I, O)) : I;

!(function (t) {
    ...
    (f.absoluteValue = f.abs =
        ...
        (f.logarithm = f.log =
            function (e) {
                ...
                return this.eq(n) ? new r(0) : ((i = !1), (t = m(I(this, o), I(e, o), o)), (i = !0), T(t, s));
            }),
        (f.minus = f.sub =
            function (e) {
    ...
    function I(e, t) {
        ...
        if (((f += 10), (S.precision = f), (s = (r = h(b)).charAt(0)), !(1500000000000000 > Math.abs((l = E(g)))))) return (d = v(S, f + 2, y).times(l + '')), (g = I(new S(s + '.' + r.slice(1)), f - 10).plus(d)), (S.precision = y), null == t ? ((i = !0), T(g, y)) : g;

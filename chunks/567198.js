!(function (t) {
    ...
    (f.absoluteValue = f.abs =
        ...
        (f.logarithm = f.log =
            function (e) {
                ...
                return this.eq(n) ? new r(0) : ((i = !1), (t = m(S(this, o), S(e, o), o)), (i = !0), T(t, s));
            }),
        (f.minus = f.sub =
            function (e) {
        ...
        (f.toDecimalPlaces = f.todp =
            function (e, t) {
                var n = this,
                    r = n.constructor;
                return ((n = new r(n)), void 0 === e) ? n : (h(e, 0, 1000000000), void 0 === t ? (t = r.rounding) : h(t, 0, 8), T(n, e + E(n) + 1, t));
            }),
        (f.toExponential = function (e, t) {
            var n,
                r = this,
                i = r.constructor;
            return void 0 === e ? (n = A(r, !0)) : (h(e, 0, 1000000000), void 0 === t ? (t = i.rounding) : h(t, 0, 8), (n = A((r = T(new i(r), e + 1, t)), !0, e + 1))), n;
        }),
        (f.toFixed = function (e, t) {
            var n,
                r,
                i = this.constructor;
            return void 0 === e ? A(this) : (h(e, 0, 1000000000), void 0 === t ? (t = i.rounding) : h(t, 0, 8), (n = A((r = T(new i(this), e + E(this) + 1, t)).abs(), !1, e + E(r) + 1)), this.isneg() && !this.isZero() ? '-' + n : n);
        }),
        (f.toInteger = f.toint =
            function () {
        ...
        (f.toPrecision = function (e, t) {
            var n,
                ...
                i = this,
                a = i.constructor;
            return void 0 === e ? ((n = E(i)), (r = A(i, n <= a.toExpNeg || n >= a.toExpPos))) : (h(e, 1, 1000000000), void 0 === t ? (t = a.rounding) : h(t, 0, 8), (n = E((i = T(new a(i), e, t)))), (r = A(i, e <= n || n <= a.toExpNeg, e))), r;
        }),
        (f.toSignificantDigits = f.tosd =
            function (e, t) {
                var n = this.constructor;
                return void 0 === e ? ((e = n.precision), (t = n.rounding)) : (h(e, 1, 1000000000), void 0 === t ? (t = n.rounding) : h(t, 0, 8)), T(new n(this), e, t);
            }),
        (f.toString =
            f.valueOf =
            f.val =
    ...
    var m = (function () {
        ...
        return function (r, i, s, o) {
            ...
            if (((I = (I / 7 + 2) | 0), (c = 0), 1 == N)) for (d = 0, L = L[0], I++; (c < y || d) && I--; c++) (S = 10000000 * d + (D[c] || 0)), (p[c] = (S / L) | 0), (d = S % L | 0);
                ...
                do (d = 0), (l = t(L, m, N, g)) < 0 ? ((v = m[0]), N != g && (v = 10000000 * v + (m[1] || 0)), (d = (v / A) | 0) > 1 ? (d >= 10000000 && (d = 10000000 - 1), (_ = (f = e(L, d)).length), (g = m.length), 1 == (l = t(f, m, _, g)) && (d--, n(f, N < _ ? C : L, _))) : (0 == d && (l = d = 1), (f = L.slice())), (_ = f.length) < g && f.unshift(0), n(m, f, g), -1 == l && ((g = m.length), (l = t(L, m, N, g)) < 1 && (d++, n(m, N < g ? C : L, g))), (g = m.length)) : 0 === l && (d++, (m = [0])), (p[c++] = d), l && m[0] ? (m[g++] = D[b] || 0) : ((m = [D[b]]), (g = 1));
                while ((b++ < y || void 0 !== m[0]) && I--);
            }
            return !p[0] && p.shift(), (h.e = u), T(h, o ? s + E(h) + 1 : s);
        };
    })();
    function g(e, t) {
        var r,
        ...
        for (c += ((Math.log(u(2, f)) / Math.LN10) * 2 + 5) | 0, r = a = s = new _(n), _.precision = c; ; ) {
            if (((a = T(a.times(e), c)), (r = r.times(++d)), p((l = s.plus(m(a, r, c))).d).slice(0, c) === p(s.d).slice(0, c))) {
                for (; f--; ) s = T(s.times(s), c);
                return (_.precision = h), null == t ? ((i = !0), T(s, h)) : s;
            }
            s = l;
        }
    }
    ...
    function S(e, t) {
        ...
        if (((f += 10), (b.precision = f), (s = (r = p(I)).charAt(0)), !(1500000000000000 > Math.abs((l = E(g)))))) return (d = v(b, f + 2, y).times(l + '')), (g = S(new b(s + '.' + r.slice(1)), f - 10).plus(d)), (b.precision = y), null == t ? ((i = !0), T(g, y)) : g;
        ...
        for (c = u = g = m(g.minus(n), g.plus(n), f), _ = T(g.times(g), f), o = 3; ; ) {
            if (((u = T(u.times(_), f)), p((d = c.plus(m(u, new b(o), f))).d).slice(0, f) === p(c.d).slice(0, f))) return (c = c.times(2)), 0 !== l && (c = c.plus(v(b, f + 2, y).times(l + ''))), (c = m(c, new b(h), f)), (b.precision = y), null == t ? ((i = !0), T(c, y)) : c;
            (c = d), (o += 2);
        }
    }
    function b(e, t) {
    ...
    function y(e, t) {
        var n,
            ...
            _ = e.constructor,
            h = _.precision;
        if (!e.s || !t.s) return t.s ? (t.s = -t.s) : (t = new _(e)), i ? T(t, h) : t;
        ...
        for (; 0 === u[--l]; ) u.pop();
        for (; 0 === u[0]; u.shift()) --r;
        return u[0] ? ((t.d = u), (t.e = r), i ? T(t, h) : t) : new _(0);
    }
    function A(e, t, n) {
        var r,
            i = E(e),

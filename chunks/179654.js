...
class o {
    getStats() {
        let e = this.cpuHistogram.getReport(), t = this.memoryHistogram.getReport(), n = r.Z.getCumulativeCPUUsage(), i = null == this.startCPU || null == n ? void 0 : (n.usage - this.startCPU.usage) * 100 / ((n.sampleTime - this.startCPU.sampleTime) / 1000);
        return {
    ...
    takeSample() {
        let e = r.Z.getCumulativeCPUUsage(), t = r.Z.getCurrentMemoryUsageKB();
        if (null != e) {
            let t = !0;

...
function c(e) {
  let {
    ...
    disabled: c,
    isFocused: d,
    showDefaultFocus: p = !1,
    menuItemProps: h,
    onClose: f
  } = e, E = r.useRef(null), _ = r.useRef(null);
  r.useLayoutEffect(() => {
    var e, t, n;
    d ? ((0, o.ensureItemVisible)(E), null === (e = _.current) || void 0 === e || e.focus()) : null === (n = _.current) || void 0 === n || null === (t = n.blur) || void 0 === t || t.call(n)
  }, [d]);
  let m = r.useCallback(() => {
      var e, t;

...
var s = n("37983"),
  ...
  G = a.memo(function(e) {
    ...
    let w, {
      ...
      ea = (0, r.useStateFromStores)([I.default], () => I.default.hasLayers()),
    ...
    let eC = (0, T.useCanStartPublicThread)(V),
      ...
      em = !M.UseLegacyChatInput.useSetting() && !(0, O.isAndroidWeb)() && null != window.ResizeObserver,

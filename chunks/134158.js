...
t.Z = class e {
    ...
    getHeight() {
        let e = this.paddingTop + this.getListHeaderHeight(), {length: t} = this.sections;
        for (let n = 0; n < t; n++) {
    ...
    compute(e, t) {
        let n = this.paddingTop, r = n, i = n, a = 0, o = 0, s = [], l = a => (i = n, (n += a) < e) ? (r += a, !1) : !(i > t) && !0;
    ...
    computeScrollPosition(e, t) {
        let {paddingTop: n} = this, r = n + this.getListHeaderHeight(), i = 0, a = !1;
        for (; i <= e;) {

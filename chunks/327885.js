...
var n = s(735250);
s(470079);
var a = s(512722), i = s.n(a), r = s(392711), o = s.n(r), l = s(442837), c = s(481060), d = s(660216), _ = s(13245), E = s(825209), u = s(887278), T = s(630699), I = s(658785), S = s(556296), N = s(808506), C = s(237997), m = s(739563), A = s(626135);
s(63063);
var h = s(13140), g = s(981631), O = s(689938), p = s(564939);
let R = x(null);
function x(e) {
    var t;
    let s = C.Z.getNotificationPositionMode(), n = s !== g._vf.DISABLED, a = S.Z.getOverlayKeybind(), i = S.Z.getOverlayChatKeybind();
    return {
        enabled: N.Z.enabled,
...
function D(e) {
    let {
        ...
        })), b = (0, l.e7)([S.Z], () => S.Z.getOverlayKeybind()), {showKeybindIndicators: v} = I.Z.useExperiment({ location: 'overlay_user_settings' }), j = (0, u.$1)();
    function B(e) {

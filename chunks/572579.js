...
function W(e) {
  let {
    channel: t,
    className: n
  } = e, l = (0, I.getChannelIconComponent)(t);
  return (0, o.jsxs)("div", {
  ...
  if (null != c) switch (a) {
    ...
    switch (a) {
      case z.OperatorTypes.EQUAL:
        e = X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_MUST_BE, n === Q.PlatformTypes.PAYPAL && l === z.MetadataFields.PAYPAL_VERIFIED && (e = X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_MUST_HAVE_A);
        break;
      case z.OperatorTypes.NOT_EQUAL:
        e = X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_MUST_NOT_BE;
        break;
      case z.OperatorTypes.LESS_THAN:
        e = X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_MUST_HAVE_AT_MOST;
        break;
      case z.OperatorTypes.GREATER_THAN:
        e = X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_MUST_HAVE_AT_LEAST;
        break;
      case void 0:
      case null:
        return null
...
function $(e) {
  ...
  } = e, [a, i] = s.useState({}), [r, u] = s.useState(0), [N, T] = s.useState(null), [E, f] = s.useState(null), h = s.useMemo(() => C.flatten(t), [t]), m = s.useMemo(() => C.groupBy(h, e => "".concat(e.connection_type).concat(null != e.application_id ? ":".concat(e.application_id) : "")), [h]);
  s.useEffect(() => u(Date.now()), [h]), s.useEffect(() => {
    if (null == N) return;
  ...
  return (0, o.jsx)(o.Fragment, {
    children: Object.keys(m).sort((e, t) => {
      ...
      let _ = m[e],
        ...
        j = B.officialApplicationIds.includes(null !== (t = null == v ? void 0 : v.id) && void 0 !== t ? t : "");
      j ? u = (0, o.jsx)(H.default, {
        className: Z.botTag,
        color: A,
        size: 16
      ...
      let y = a[null !== (l = null == M ? void 0 : M.type) && void 0 !== l ? l : z.GUILD_ROLE_CONNECTION_APPLICATION_CONNECTION_TYPE],
        R = !x && null != y && y <= r;
      ...
      }), (null == M ? void 0 : M.type) === Q.PlatformTypes.STEAM && (N = X.default.Messages.CONNECTIONS_STEAM_TOOLTIP), (0, o.jsxs)(O.Clickable, {
        className: c(Z.connectionsChecksGroup, x ? Z.connectionsChecksGroupPassed : null),
        onClick: x ? void 0 : () => {
          var e, t, l;
          return t = null !== (e = null == M ? void 0 : M.type) && void 0 !== e ? e : z.GUILD_ROLE_CONNECTION_APPLICATION_CONNECTION_TYPE, l = v, void((0, Y.default)(t, "Verified Roles Connect Accounts Modal", null == l ? void 0 : l.role_connections_verification_url), i({
            ...a,
            [t]: Date.now()
          }), T(t), f(null != l ? l : null), n())
        },
        children: [!x && R ? (0, o.jsx)("div", {
          className: Z.connectionsChecksGroupRequirementsNotMet,
          children: (0, o.jsx)(O.Text, {
            variant: "text-xs/normal",
            color: "always-white",
            children: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_REQUIREMENTS_NOT_MET
          })
          ...
          children: [(0, o.jsxs)("div", {
            ...
            return d(null != n, "connectionMetadataField is null"), d(null != l, "operator is null"), d(null != a, "value is null"), (0, o.jsx)(J, {
              connectionType: t,
...
function ee(e) {
  ...
  return Q.FRIEND_SYNC_PLATFORM_TYPES.has(a.type) && (t = (0, o.jsx)(O.FormSwitch, {
  ...
  })), Q.ACTIVITY_PLATFORM_TYPES.has(a.type) && (n = (0, o.jsx)(O.FormSwitch, {
    className: Z.accountConnectedPrivacyOptionsSwitchItem,
    hideBorder: !0,
    value: u,
    onChange: e => {
  ...
  })), !0 === h.hasMetadata && (l = (0, o.jsx)(O.FormSwitch, {
    className: Z.accountConnectedPrivacyOptionsSwitchItem,
    hideBorder: !0,
    value: N,
    disabled: !T,
    onChange: e => {
      c(e), _(e), E.default.setMetadataVisibility(a.type, a.id, e ? 1 : 0)
    },
    children: (0, o.jsx)(O.Text, {
      variant: "text-sm/semibold",
...
function et(e) {
  let {
    ...
    guildId: l,
    role: a
  } = e, [i, c] = s.useState(0), [r, u] = s.useState(null), [C, _] = s.useState(!1), [T, E] = s.useState(!0), [S, I] = s.useState(!1), [L, D] = s.useState(!0), [P, G] = s.useState(!1), k = (0, N.useStateFromStores)([y.default], () => y.default.getAccounts()), B = (0, N.useStateFromStores)([g.default], () => g.default.getId()), [H, Y] = s.useState(null), [z, q] = s.useState(null), [J, et] = s.useState(null), en = (0, m.default)(), el = (0, N.useStateFromStores)([v.default], () => v.default.locale), ea = (0, N.useStateFromStores)([R.default], () => R.default.getMember(l, B)), eo = (0, N.useStateFromStores)([j.default], () => j.default.getMutableGuildChannelsForGuild(l)), es = Object.values(eo).filter(e => U.default.can(Q.Permissions.VIEW_CHANNEL, e) && U.default.can(Q.Permissions.SEND_MESSAGES, e) && (0, x.default)(e).includes(a));
  ...
  function eC(e) {
    ...
    Y(e), q(t), c(1), null != t && (0, w.fetchUserApplicationRoleConnections)().then(e => {
      et(e)
    }).catch(() => {})
  }
  return s.useEffect(() => {
  ...
  }, [l, a.id, k]), s.useEffect(() => {
    F.default.track(Q.AnalyticEvents.PASSPORT_CHALLENGE_VIEWED, {
      role_id: a.id,
      ...(0, A.collectGuildAnalyticsMetadata)(l)
    })
  }, [l, a.id]), s.useEffect(() => {
    S && null != ea && ea.roles.includes(a.id) && (I(!1), es.length > 0 ? c(2) : null == n || n(), F.default.track(Q.AnalyticEvents.PASSPORT_CHALLENGE_FINISHED, {
      role_id: a.id,
      ...(0, A.collectGuildAnalyticsMetadata)(l)
    }))
  }, [S, es.length, ea, l, a.id, n]), (0, o.jsxs)(O.ModalRoot, {
        ...
        case 1: {
          ...
          return (0, o.jsxs)(O.ModalHeader, {
            ...
            children: [(0, o.jsx)(O.Heading, {
              variant: "heading-xl/extrabold",
              className: Z.headerText,
              children: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_ACCOUNT_CONNECTED.format({
                platformName: n
              })
            }), (0, o.jsx)(O.ModalCloseButton, {
              onClick: () => ei()
        ...
        case 2:
          return (0, o.jsxs)(O.ModalHeader, {
            ...
            children: [(0, o.jsx)(O.Heading, {
              variant: "heading-xl/extrabold",
              className: Z.headerText,
              children: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_ROLE_GRANTED
            }), (0, o.jsx)(O.ModalCloseButton, {
              onClick: () => ei(!0)
            })]
          });
        ...
        switch (i) {
          case 0: {
            ...
            return (0, o.jsx)(O.ModalContent, {
              children: T || null == r ? (0, o.jsx)(O.Spinner, {
                className: Z.connectionsChecksGroups
              }) : (0, o.jsxs)(o.Fragment, {
                children: [(0, o.jsx)(O.Text, {
                  variant: "text-md/medium",
                  color: "header-secondary",
                  children: e ? X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_HEADER_TEXT_ANY.format() : X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_HEADER_TEXT_ALL.format()
                  ...
                  color: "header-secondary",
                  children: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_USAGE_SETTINGS.format({
                  ...
                  children: [null != e ? (0, o.jsxs)(o.Fragment, {
                    children: [(0, o.jsxs)("div", {
                      ...
                      children: [(0, o.jsx)(O.Text, {
                        variant: "eyebrow",
                        color: "header-secondary",
                        children: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_ACCOUNT_CONNECTED_PREVIEW
                      ...
                      children: [(0, o.jsx)(O.Text, {
                        variant: "eyebrow",
                        color: "header-secondary",
                        children: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_ACCOUNT_CONNECTED_PRIVACY
                      }), (0, o.jsx)(ee, {
                        account: e,
                    ...
                    children: [(0, o.jsxs)("div", {
                      ...
                      children: [(0, o.jsx)(O.Text, {
                        ...
                        text: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_ACCOUNT_CONNECTED_TOOLTIP,
          ...
          return (0, o.jsxs)(O.ModalFooter, {
            children: [(0, o.jsx)(O.Button, {
              ...
              children: (0, o.jsx)(O.Button, {
                ...
                onClick: er,
                children: X.default.Messages.CONNECTIONS_CONNECT_ACCOUNTS_MODAL_MANAGE_CONNECTIONS
              })
            }) : null]
          });
        case 1:

...
var l = n(735250), u = n(470079), i = n(512722), r = n.n(i), a = n(442837), o = n(570140), d = n(911969), s = n(71619), c = n(282397), E = n(622449), T = n(188597), _ = n(41776), I = n(665906), S = n(592125), C = n(271383), f = n(607744), p = n(594174), N = n(280501), m = n(892902), g = n(359232);
let O = e => {
        switch (e.type) {
        case d.re.BUTTON:
        ...
        let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], l = N.gH.NORMAL;
        ...
        let t = S.Z.getChannel(e), n = (0, a.e7)([f.Z], () => (null == t ? void 0 : t.guild_id) == null || f.Z.canChatInGuild(t.guild_id), [t]), l = (0, a.e7)([_.Z], () => (null == t ? void 0 : t.guild_id) != null && _.Z.isLurking(t.guild_id), [t]), u = (0, a.e7)([
                C.ZP,
                p.default
            ], () => {
                var e, n;
            ...
            }), [, i] = (0, s.AB)(null == t ? void 0 : t.guild_id), r = (0, I.tc)(t);
        return !!(!n || l || u || (null == t ? void 0 : t.isLockedThread()) || (null == t ? void 0 : t.isArchivedThread()) && !r) || !!i || !1;
    };
function R(e, t) {
    let n = u.useContext(L), [l, i] = u.useState(null), r = u.useCallback(t => {
            let n = (0, g.Z)(e, t);
            return i(n), null == n;
        }, [e]);
    return u.useEffect(() => {
...
function h(e, t, n) {
    var l;
    let i = (0, a.e7)([m.Z], () => m.Z.getInteractionComponentState(e.id, t.id)), r = (0, a.e7)([c.Z], () => c.Z.getInteraction(e), [e]), o = A(e.channel_id), {
            error: d,
            validate: s
        } = R(t, i), E = null !== (l = e.applicationId) && void 0 !== l ? l : e.author.id;
    return {
        state: i,
        executeStateUpdate: u.useCallback(n => {
            ...
            return null != l && null != t.customId && (0, T.tM)({
...
function v(e, t, n) {
    let l = (0, a.e7)([m.Z], () => m.Z.getInteractionComponentState(e.customId, t.id)), {
            error: i,
            validate: r
        } = R(t, l), d = u.useCallback(n => null == n || (o.Z.dispatch({

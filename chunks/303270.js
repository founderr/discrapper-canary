...
var L = n.forwardRef(function(e, t) {
  let {
    ...
    username: U,
    globalName: G
  } = L, b = n.useRef(null), D = n.useRef(null), j = n.useMemo(() => a.merge({
    discriminator: "0000"
  }), [a]), [k, F] = (0, r.useSpring)(() => ({
    opacity: 0,
    y: 5
  ...
  let w = (0, o.default)([d.default], () => d.default.useReducedMotion),
    {
      createMultipleConfettiAt: B
    } = n.useContext(c.ConfettiCannonContext),
    H = null == R ? void 0 : R.getLegacyUsername();
  return n.useEffect(() => {
    if (!w && x === I.EditState.PREVIEW) a.username.includes(I.POMELO_KEYWORD) && (B(window.innerWidth / 2 + 150, 0, {
      velocity: {
        type: "static-random",
        minValue: {
          x: 0,
    ...
    children: [(0, s.jsxs)("div", {
      ...
      children: [(0, s.jsx)(E.default, {
        ...
        profileType: T.UserProfileTypes.POMELO_POPOUT,
        animateOnHover: !1
      }), x === I.EditState.PREVIEW && null != H && (0, s.jsx)("div", {
    ...
    }), x !== I.EditState.PREVIEW && (0, s.jsxs)(r.animated.div, {
      style: {
        opacity: k.opacity,
        y: k.y
      },
      className: O.inputContainer,
      children: [x === I.EditState.EDIT_DISPLAY_NAME && (0, s.jsxs)(s.Fragment, {
        ...
        children: (() => {
          ...
          if (null != p) {
            if (x !== I.EditState.SUGGESTION) return (0, s.jsx)(u.Text, {
          ...
          return null == p && null == i && (x === I.EditState.EDIT_USERNAME || x === I.EditState.SUGGESTION) ? (0, s.jsx)(_.default, {
            username: U,
            oneClickFlow: y
          }) : null
        })()
      })]
    }), x === I.EditState.PREVIEW && (0, s.jsxs)("div", {

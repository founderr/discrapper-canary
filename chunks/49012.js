...
var r = n(302454), i = n.n(r), a = n(668781), o = n(45986), s = n(782568), l = n(704133), u = n(139674), c = n(702321), d = n(900460), _ = n(627714), E = n(364640), f = n(772096), h = n(982806), p = n(540709), m = n(881706), I = n(592125), T = n(430824), g = n(20303), S = n(902676), A = n(375954), N = n(699516), v = n(944486), O = n(626135), R = n(981631), C = n(689938);
function y(e, t) {
    var n;
...
function D(e, t) {
    ...
    let P = null, U = !1, w = L, x = b, G = null;
    if (null != L && null != b) {
        var k, B, F;
        let e = A.Z.getMessage(b, L), t = I.Z.getBasicChannel(b);
        P = null !== (F = null == t ? void 0 : t.guild_id) && void 0 !== F ? F : null;
        let n = T.Z.getGuild(P), r = (null == e ? void 0 : null === (k = e.messageReference) || void 0 === k ? void 0 : k.guild_id) != null && (null == e ? void 0 : e.webhookId) != null && (null == e ? void 0 : e.hasFlag(R.iLy.IS_CROSSPOST)) && null != P;
        ...
        let i = (null == t ? void 0 : t.type) === R.d4z.GUILD_ANNOUNCEMENT && (null == n ? void 0 : n.hasFeature(R.oNc.COMMUNITY)) === !0, a = (null == e ? void 0 : e.hasFlag(R.iLy.EPHEMERAL)) === !0;
        U = null != e && !a && (r || i);
    }
    if (null != b) {
        let e = I.Z.getChannel(b), t = T.Z.getGuild(null == e ? void 0 : e.getGuildId());
    ...
    let H = 'function' == typeof N ? N() : N, Z = (0, S.E)(M), Y = !('http:' === Z || 'https:' === Z);
    ...
    if (null != t && t.preventDefault(), Y)
        ...
        let e = (0, f.yw)(M), t = null != e ? e.displayTarget : M;
        h.Z.show({
            url: t,
            trustUrl: o.o,
            onConfirm: V,

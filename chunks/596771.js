...
return 'number' == typeof t && isFinite(t) && Math.floor(t) === t && 9007199254740991 >= Math.abs(t);
  ...
  T = !0;
try {
  var A = L('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu');
  T = (null === (n = A.exec('a')) || void 0 === n ? void 0 : n[0]) === 'a';
} catch (t) {
  T = !1;
}
var _ = m ? function(t, e, r) {
return t.startsWith(e, r);
  } : function(t, e, r) {
return t.slice(r, r + e.length) === e;
  },
  H = d ? String.fromCodePoint : function() {
...
return n;
  ...
  I = v ? Object.fromEntries : function(t) {
...
if (T) {
  var R = L('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu');
  i = function(t, e) {
var r;
return R.lastIndex = e, null !== (r = R.exec(t)[1]) && void 0 !== r ? r : '';
  };
} else
  i = function(t, e) {
for (var r = [];;) {
  var n = S(t, e);
  if (void 0 === n || M(n) || function(t) {
...
for (var n = []; !this.isEOF();) {
  ...
  if (123 === i) {
    ...
    if (!r)
      return this.error(a.o.UNMATCHED_CLOSING_TAG, p(this.clonePosition(), this.clonePosition()));
    break;
  }
}
return {
...
return n !== this.parseTagName() ? this.error(a.o.UNMATCHED_CLOSING_TAG, p(c, this.clonePosition())) : (this.bumpSpace(), this.bumpIf('>')) ? {
  val: {
    type: s.wD.tag,
    value: n,
    children: o,
...
var t = this.offset();
for (this.bump(); !this.isEOF() && function(t) {
...
return !this.isEOF() && 60 === this.char() && (this.ignoreTag || ! function(t) {
  return P(t) || 47 === t;
}(this.peek() || 0)) ? (this.bump(), '<') : null;
...
if (this.isEOF())
  return null;
var r = this.char();
return 60 === r || 123 === r || 35 === r && ('plural' === e || 'selectordinal' === e) || 125 === r && t > 0 ? null : (this.bump(), H(r));
  }, t.prototype.parseArgument = function(t, e) {
var r = this.clonePosition();
if (this.bump(), this.bumpSpace(), this.isEOF())
  return this.error(a.o.EXPECT_ARGUMENT_CLOSING_BRACE, p(r, this.clonePosition()));
if (125 === this.char())
  return this.bump(), this.error(a.o.EMPTY_ARGUMENT, p(r, this.clonePosition()));
...
switch (l) {
  ...
  case 'time':
    ...
    if (this.bumpIf(',')) {
      ...
      var g = N(v.val);
      if (0 === g.length)
        return this.error(a.o.EXPECT_ARGUMENT_STYLE, p(this.clonePosition(), this.clonePosition()));
      m = {
        style: g,
    ...
    if (m && _(null == m ? void 0 : m.style, '::', 0)) {
      var y = B(m.style.slice(2));
      if ('number' === l) {
        var v = this.parseNumberSkeletonFromString(y, m.styleLocation);
        if (v.err)
          return v;
        return {
          val: {
      ...
      if (0 === y.length)
        return this.error(a.o.EXPECT_DATE_TIME_SKELETON, E);
      var T = y;
      this.locale && (T = (0, h.T)(y, this.locale));
      var g = {
        type: s.aV.dateTime,
        pattern: T,
  ...
  case 'select':
    ...
    if (this.bumpSpace(), !this.bumpIf(','))
      return this.error(a.o.EXPECT_SELECT_ARGUMENT_OPTIONS, p(A, (0, o.pi)({}, A)));
    this.bumpSpace();
    var H = this.parseIdentifierIfPossible(),
      S = 0;
    if ('select' !== l && 'offset' === H.value) {
      if (!this.bumpIf(':'))
        return this.error(a.o.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, p(this.clonePosition(), this.clonePosition()));
      this.bumpSpace();
      var v = this.tryParseDecimalInteger(a.o.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, a.o.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);
      if (v.err)
        return v;
      this.bumpSpace(), H = this.parseIdentifierIfPossible(), S = v.val;
    }
    var L = this.tryParsePluralOrSelectOptions(t, l, e, H);
    if (L.err)
      return L;
    var b = this.tryParseArgumentClose(n);
    if (b.err)
...
return this.isEOF() || 125 !== this.char() ? this.error(a.o.EXPECT_ARGUMENT_CLOSING_BRACE, p(t, this.clonePosition())) : (this.bump(), {
  val: !0,
  err: null
});
...
for (var t = 0, e = this.clonePosition(); !this.isEOF();)
  switch (this.char()) {
    case 39:
      ...
      var r = this.clonePosition();
      if (!this.bumpUntil('\''))
        return this.error(a.o.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, p(r, this.clonePosition()));
      this.bump();
      break;
    case 123:
      t += 1, this.bump();
...
for (var i, o = !1, s = [], u = new Set(), c = n.value, h = n.location;;) {
  if (0 === c.length) {
  ...
  if (u.has(c))
    return this.error('select' === e ? a.o.DUPLICATE_SELECT_ARGUMENT_SELECTOR : a.o.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, h);
  'other' === c && (o = !0), this.bumpSpace();
  var m = this.clonePosition();
  if (!this.bumpIf('{'))
    return this.error('select' === e ? a.o.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : a.o.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, p(this.clonePosition(), this.clonePosition()));
...
return 0 === s.length ? this.error('select' === e ? a.o.EXPECT_SELECT_ARGUMENT_SELECTOR : a.o.EXPECT_PLURAL_ARGUMENT_SELECTOR, p(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !o ? this.error(a.o.MISSING_OTHER_CLAUSE, p(this.clonePosition(), this.clonePosition())) : {
  val: s,
  err: null
};

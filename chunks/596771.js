...
var A = m ? function(t, e, r) {
return t.startsWith(e, r);
  } : function(t, e, r) {
return t.slice(r, r + e.length) === e;
  },
  I = d ? String.fromCodePoint : function() {
...
return n;
  ...
  S = v ? Object.fromEntries : function(t) {
...
if (T) {
  var N = B('([^\\p{White_Space}\\p{Pattern_Syntax}]*)', 'yu');
  i = function(t, e) {
var r;
return N.lastIndex = e, null !== (r = N.exec(t)[1]) && void 0 !== r ? r : '';
  };
} else
  i = function(t, e) {
for (var r = [];;) {
...
switch (h) {
  ...
  case 'select':
    ...
    if (this.bumpSpace(), !this.bumpIf(','))
      return this.error(a.o.EXPECT_SELECT_ARGUMENT_OPTIONS, p(_, (0, o.pi)({}, _)));
    this.bumpSpace();
    ...
    if ('select' !== h && 'offset' === I.value) {
      ...
      if (v.err)
        return v;
      this.bumpSpace(), I = this.parseIdentifierIfPossible(), H = v.val;
    }
...
for (var i, o = !1, s = [], u = new Set(), c = n.value, l = n.location;;) {
  ...
  if (u.has(c))
    return this.error('select' === e ? a.o.DUPLICATE_SELECT_ARGUMENT_SELECTOR : a.o.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, l);

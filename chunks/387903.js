...
class q extends (l = s.PureComponent) {
    ...
    renderHeader(e) {
        ...
        if (null != i) {
            var u;
            t = (0, P.yE)(null !== (u = null == s ? void 0 : s.flags) && void 0 !== u ? u : 0, H.xjy.EMBEDDED) ? (s.type === H.IIU.WATCHING ? F.intl.formatToPlainString(F.t['M/L8oq'], { guildName: i.name }) : F.intl.formatToPlainString(F.t['4chKQk'], { guildName: i.name })) : F.intl.formatToPlainString(F.t.sddlGB, { server: i.name });
        }
        return (
            (null == s ? void 0 : s.type) === H.IIU.HANG_STATUS && (t = F.intl.string(F.t['74vS//'])),
            (0, a.jsxs)('div', {
                ...
                children: [
                    (0, a.jsx)(m.Heading, {
                        ...
                        children: (0, a.jsx)(v.Z, { children: t })
                    }),
                    null == r ? void 0 : r()
                ]
            })
    ...
    renderState(e, t) {
        ...
        (null != c && '' !== c && e.type !== H.IIU.CUSTOM_STATUS) || (0, A.dS)(e))
            ? ((null == s ? void 0 : s.size) == null && [B.Zc].includes(null !== (n = e.application_id) && void 0 !== n ? n : '')

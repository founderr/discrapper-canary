var i = n(735250);
n(470079);
var s = n(481060), a = n(570140), r = n(317770), l = n(603113), o = n(812206), c = n(158776), d = n(699516), u = n(594174), _ = n(626135), h = n(621853), E = n(981631), I = n(616922);
let m = null;
async function g(e) {
    var t, a, r, g;
    let {
    ...
    if (null == L)
        return;
    let v = h.Z.getUserProfile(p), O = c.Z.getPrimaryActivity(p), R = c.Z.getStatus(p), x = c.Z.isMobileOnline(p), {
            party: b,
            assets: P,
            application_id: M
        } = null != O ? O : {}, D = null != M ? o.Z.getApplication(M) : null, y = x ? E.j28.ONLINE_MOBILE : E.j28.ONLINE_DESKTOP, j = R === E.Skl.ONLINE ? y : R;

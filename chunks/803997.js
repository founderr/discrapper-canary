...
function I(e) {
  let {
    channelId: t,
    ...n
  } = e, s = l.useRef(null), I = (0, o.useStateFromStores)([E.default], () => E.default.getFocusedLayout() === g.FocusedActivityLayouts.RESIZABLE), T = l.useCallback(() => {
    let e = I ? g.FocusedActivityLayouts.NO_CHAT : g.FocusedActivityLayouts.RESIZABLE;
  ...
  return (0, a.jsxs)("div", {
    ...
    children: [(0, a.jsx)(d.default, {
      ...
      themeable: !0,
      className: i(_.circularButton, R === g.FocusedActivityLayouts.NO_CHAT ? _.upArrow : _.downArrow),
      ...n
    }), L ? (0, a.jsx)(u.default, {
      hasMentions: x > 0,

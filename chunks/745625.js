var a = n(15393), r = n(919499), i = n(470079), o = n(520250), c = 'hcaptcha-api-script-id', s = 'hcaptchaOnLoad', p = [], d = function (e) {
        void 0 === e && (e = {});
        var t = (0, o.as)(e.scriptLocation);
        delete e.scriptLocation;
        var n = (0, o.$h)(t), a = p.find(function (e) {
                return e.scope === n.window;
            });
        if (n.document.getElementById(c) && a)
            return a.promise;
        ...
        return n.componentDidMount = function () {
            var e = this, t = (0, o.as)(this.props.scriptLocation), n = (0, o.$h)(t);
            ...
            var e = this.state.captchaId, t = this._hcaptcha;
            if (!!this.isReady())
                t.reset(e), t.remove(e);
            ...
            if (!this.apiScriptRequested) {
                var e = this.props, t = e.apihost, n = e.assethost, a = e.endpoint, r = e.host, i = e.imghost, o = e.languageOverride, c = e.reCaptchaCompat, s = e.reportapi, p = e.sentry, h = e.custom, l = e.loadAsync, u = e.scriptLocation;
                d({
                    apihost: t,
                    assethost: n,
                    endpoint: a,
            ...
            var t = this.state.captchaId, n = this._hcaptcha;
            if (!!this.isReady())
            ...
            var e = this;
            this.setState({ isApiReady: !0 }, function () {
                var t = (0, o.as)(e.props.scriptLocation), n = (0, o.$h)(t);
            ...
            var t = this.props.onVerify, n = this.state, a = n.isRemoved, r = n.captchaId, i = this._hcaptcha;
            if (void 0 !== i && !a) {
                var o = i.getResponse(r), c = i.getRespKey(r);
                t && t(o, c);
            }
        }, n.handleExpire = function () {
            var e = this.props.onExpire, t = this.state.captchaId, n = this._hcaptcha;
            if (!!this.isReady())
                n.reset(t), e && e();
        }, n.handleError = function (e) {
            var t = this.props.onError, n = this.state.captchaId, a = this._hcaptcha;
            this.isReady() && a.reset(n), t && t(e);
        }, n.isReady = function () {
            var e = this.state, t = e.isApiReady, n = e.isRemoved;
            return t && !n;

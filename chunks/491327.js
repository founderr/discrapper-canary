...
t.Z = {
  [S.Etm.GET_CHANNEL]: {
    ...
    handler(e) {
      ...
      return (0, T.T5)(s, (0, T.zM)(s, n.application.id, n.authorization.scopes))
    }
  },
  [S.Etm.GET_CHANNELS]: {
    scope: l.x.RPC,
  ...
  [S.Etm.SELECT_VOICE_CHANNEL]: {
    ...
    handler(e) {
      ...
      if (!s) return r.default.selectVoiceChannel(null), null;
      let g = h.Z.getVoiceChannelId();
      if (null != g && g !== s && !1 === l) throw new m.Z({
        errorCode: S.lTL.SELECT_VOICE_FORCE_REQUIRED
      }, "User is already joined to a voice channel.");
      return t.storeWait(n, () => u.Z.getChannel(s), i).catch(() => {
        throw new m.Z({
        ...
        if (null == e) throw new m.Z({
          errorCode: S.lTL.INVALID_CHANNEL
        }, "Invalid channel id: ".concat(s));
        if (!(0, c.vd)(e.type)) throw new m.Z({
          errorCode: S.lTL.INVALID_CHANNEL
        }, "Channel is not a voice channel");
        return Promise.all([Promise.resolve(e), (0, T.T5)(e, (0, T.zM)(e, n.application.id, n.authorization.scopes))])
      }).then(e => {
        let [t, n] = e;
        if (n.guild_id) {
  ...
  [S.Etm.GET_SELECTED_VOICE_CHANNEL]: {
    ...
    handler(e) {
      let {
        socket: t
      } = e, n = h.Z.getVoiceChannelId(), s = null != n ? u.Z.getChannel(n) : null;
      return null != s ? (0, T.T5)(s, (0, T.zM)(s, t.application.id, t.authorization.scopes)) : null
    }
  },
  [S.Etm.SELECT_TEXT_CHANNEL]: {
    ...
    handler(e) {
      ...
      return s ? t.storeWait(n, () => u.Z.getChannel(s), i).catch(() => {
        throw new m.Z({
          errorCode: S.lTL.SELECT_CHANNEL_TIMED_OUT

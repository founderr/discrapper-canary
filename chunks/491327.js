...
t.default = {
  [T.RPCCommands.GET_CHANNEL]: {
    scope: {
      [I.RPC_SCOPE_CONFIG.ANY]: [T.OAuth2Scopes.RPC, T.OAuth2Scopes.GUILDS]
    },
    handler(e) {
      let {
        args: {
      ...
      if (a.isPrivate()) {
        ...
        if (!e.includes(T.OAuth2Scopes.RPC) && !e.includes(T.OAuth2Scopes.DM_CHANNELS_READ)) throw new h.default({
          errorCode: T.RPCErrors.INVALID_PERMISSIONS
        }, "Invalid scope")
      }
      return (0, C.transformChannel)(a, (0, C.hasMessageReadPermission)(a, n.application.id, n.authorization.scopes))
    }
  },
  [T.RPCCommands.GET_CHANNELS]: {
    ...
    handler(e) {
      ...
      return {
        channels: n.filter(e => c.default.can(T.Permissions.VIEW_CHANNEL, e)).map(e => {
          let {
            id: t,
            name: n,
            type: a
  ...
  [T.RPCCommands.GET_CHANNEL_PERMISSIONS]: {
    scope: T.OAuth2Scopes.GUILDS_MEMBERS_READ,
    handler(e) {
      let t = (0, S.default)();
  ...
  [T.RPCCommands.SELECT_VOICE_CHANNEL]: {
    scope: T.OAuth2Scopes.RPC,
    ...
    handler(e) {
      ...
      if (null != S && S !== a && !1 === l) throw new h.default({
        errorCode: T.RPCErrors.SELECT_VOICE_FORCE_REQUIRED
      }, "User is already joined to a voice channel.");
      return t.storeWait(n, () => u.default.getChannel(a), s).catch(() => {
        throw new h.default({
          errorCode: T.RPCErrors.SELECT_CHANNEL_TIMED_OUT
        ...
        if (n.guild_id) {
          ...
          if (!c.default.can(T.Permissions.CONNECT, t)) throw new h.default({
            errorCode: T.RPCErrors.INVALID_PERMISSIONS
          }, "Connect permission required to join channel")
        }
        return i.default.selectVoiceChannel(t.id), m && (0, r.replaceWith)(T.Routes.CHANNEL(t.guild_id, t.id)), n
      })
    }
  },
  [T.RPCCommands.GET_SELECTED_VOICE_CHANNEL]: {
    scope: {
  ...
  [T.RPCCommands.SELECT_TEXT_CHANNEL]: {
    scope: T.OAuth2Scopes.RPC,
    validation: e => (0, m.default)(e).required().keys({
      channel_id: e.string().allow(null),
      timeout: e.number().min(0).max(60)
    ...
    handler(e) {
      ...
      return a ? t.storeWait(n, () => u.default.getChannel(a), s).catch(() => {
        ...
        let [t, n] = e;
        if (n.guild_id && !c.default.can(T.Permissions.VIEW_CHANNEL, t)) throw new h.default({
          errorCode: T.RPCErrors.INVALID_CHANNEL
        }, "No permission to see channel");
        return n.guild_id ? (0, r.replaceWith)(T.Routes.CHANNEL(n.guild_id, t.id)) : i.default.selectPrivateChannel(t.id), n
      }) : ((0, r.transitionTo)(T.Routes.ME), null)
    }
  },
  [T.RPCCommands.CREATE_CHANNEL_INVITE]: {
    scope: T.OAuth2Scopes.RPC,
    handler(e) {
      let {
        args: {

...
t.Z = {
  ...
  [C.Etm.GET_CHANNELS]: {
    ...
    handler(e) {
      ...
      return {
        channels: n.filter(e => E.Z.can(C.Plq.VIEW_CHANNEL, e)).map(e => {
          let {
            id: t,
            name: n,
            type: i
    ...
    handler(e) {
      ...
      return t.storeWait(n, () => u.Z.getChannel(i), s).catch(() => {
        ...
        if (n.guild_id) {
          ...
          if (!E.Z.can(C.Plq.CONNECT, t)) throw new m.Z({
            errorCode: C.lTL.INVALID_PERMISSIONS
          }, "Connect permission required to join channel")
        }
        return r.default.selectVoiceChannel(t.id), a && (0, o.dL)(C.Z5c.CHANNEL(t.guild_id, t.id)), n
      })
    }
  },
  ...
  [C.Etm.SELECT_TEXT_CHANNEL]: {
    ...
    handler(e) {
      ...
      return i ? t.storeWait(n, () => u.Z.getChannel(i), s).catch(() => {
        ...
        let [t, n] = e;
        if (n.guild_id && !E.Z.can(C.Plq.VIEW_CHANNEL, t)) throw new m.Z({
          errorCode: C.lTL.INVALID_CHANNEL
        }, "No permission to see channel");
        return n.guild_id ? (0, o.dL)(C.Z5c.CHANNEL(n.guild_id, t.id)) : r.default.selectPrivateChannel(t.id), n

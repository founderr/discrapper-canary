...
t.default = {
  ...
  [T.RPCCommands.GET_CHANNELS]: {
    ...
    handler(e) {
      ...
      return {
        channels: n.filter(e => f.default.can(T.Permissions.VIEW_CHANNEL, e)).map(e => {
          let {
            id: t,
            name: n,
            type: a
    ...
    handler(e) {
      ...
      return t.storeWait(n, () => d.default.getChannel(a), s).catch(() => {
        ...
        if (n.guild_id) {
          ...
          if (!f.default.can(T.Permissions.CONNECT, t)) throw new C.default({
            errorCode: T.RPCErrors.INVALID_PERMISSIONS
          }, "Connect permission required to join channel")
        }
        return r.default.selectVoiceChannel(t.id), i && (0, o.replaceWith)(T.Routes.CHANNEL(t.guild_id, t.id)), n
      })
    }
  },
  ...
  [T.RPCCommands.SELECT_TEXT_CHANNEL]: {
    ...
    handler(e) {
      ...
      return a ? t.storeWait(n, () => d.default.getChannel(a), s).catch(() => {
        ...
        let [t, n] = e;
        if (n.guild_id && !f.default.can(T.Permissions.VIEW_CHANNEL, t)) throw new C.default({
          errorCode: T.RPCErrors.INVALID_CHANNEL
        }, "No permission to see channel");
        return n.guild_id ? (0, o.replaceWith)(T.Routes.CHANNEL(n.guild_id, t.id)) : r.default.selectPrivateChannel(t.id), n
      }) : ((0, o.transitionTo)(T.Routes.ME), null)
    }
  },

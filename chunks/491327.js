  ...
  [T.RPCCommands.GET_CHANNEL]: {
    ...
    handler(e) {
      ...
      if (a.isPrivate()) {
        ...
        if (!e.includes(T.OAuth2Scopes.RPC) && !e.includes(T.OAuth2Scopes.DM_CHANNELS_READ)) throw new _.default({
    ...
    handler(e) {
      ...
      return t.storeWait(n, () => u.default.getChannel(a), s).catch(() => {
        ...
        if (n.guild_id) {
          ...
          if (!c.default.can(T.Permissions.CONNECT, t)) throw new _.default({
            errorCode: T.RPCErrors.INVALID_PERMISSIONS
  ...
  [T.RPCCommands.SELECT_TEXT_CHANNEL]: {
    ...
    handler(e) {
      ...
      return a ? t.storeWait(n, () => u.default.getChannel(a), s).catch(() => {
        ...
        let [t, n] = e;
        if (n.guild_id && !c.default.can(T.Permissions.VIEW_CHANNEL, t)) throw new _.default({
          errorCode: T.RPCErrors.INVALID_CHANNEL

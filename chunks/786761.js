...
function O(e) {
  ...
  return e.type === N.uaV.PREMIUM_REFERRAL && (V = ""), R = 0, new _.ZP({
    ...
    blocked: E.Z.isBlockedForMessage(e) || null != k && E.Z.isBlocked(k),
...
function p(e, t) {
  ...
  let n = e;
  if (null != t.call && (n = n.set("call", C(t.call, e.timestamp))), null != t.attachments && (n = n.set("attachments", g(t))), null != t.content && "" !== t.content && (n = n.set("content", t.content)), null != t.embeds && (n = n.set("embeds", v(t))), null != t.message_snapshots && (n = n.set("messageSnapshots", D(t))), t.pinned !== n.pinned && (n = n.set("pinned", t.pinned)), null != n.webhookId && null != t.author && (n = n.set("author", new c.Z(t.author))), null != t.flags && t.flags !== n.flags && (n = n.set("flags", t.flags)), null != t.components && (n = n.set("components", (0, o.uZ)(t.components, {
      includeEmojiSrc: !1

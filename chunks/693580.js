...
class o extends n.Component {
  componentDidMount() {
    ...
    "Firefox" !== E().name && (l.default.animate(e, {
      loop: !0,
      toValueMin: -74,
      toValueMax: 95,
      overshootClamping: !0,
  ...
  render() {
    return (0, a.jsxs)("div", {
      className: _.searchIndexAnimation,
      children: [(0, a.jsx)("div", {
        className: _.searchIndexBackground
      }), (0, a.jsxs)("svg", {
        className: _.searchIndexForeground,
        width: "320",
        height: "280",
        children: [(0, a.jsx)("defs", {
          ...
          children: [(0, a.jsxs)("g", {
            ...
            children: [(0, a.jsx)("mask", {
              ...
              fill: "#fff",
              children: (0, a.jsx)(l.default.use, {
                style: u(this.state),
                className: _.mask,
          ...
          }), (0, a.jsxs)(l.default.g, {
            className: _.magnifyingGlass,
            style: u(this.state),
            children: [(0, a.jsx)("path", {
              fill: "#C9D2F0",
  ...
  constructor(...e) {
    super(...e), r(this, "state", {
      x: new l.default.Value(0),
      y: new l.default.Value(0)

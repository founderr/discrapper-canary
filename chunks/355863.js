...
var a, o, s, l = n(392711), u = n.n(l), c = n(772848), d = n(442837), _ = n(433517), E = n(570140), f = n(131792), h = n(252982), p = n(434529), m = n(981631);
function I(e, t, n) {
...
class N extends (o = d.ZP.PersistedStore) {
    initialize(e) {
        ...
        u().forEach(g, (e, t) => {
            ...
            let o = this.getWidgetsForLayout(a), s = !1;
            for (let e of n) {
...
I(N, 'displayName', 'LayoutStore'), I(N, 'persistKey', 'LayoutStore'), I(N, 'migrations', [
    () => {
        ...
        if (5 === r && e) {
            let r = [], i = e.map(e => {
                    let i = null != t ? t[e] : null, a = null != n ? n[e] : null, o = {
                            id: e,
                            layoutId: T,
                            type: e,
                            anchor: i || {
    ...
    LAYOUT_DELETE_WIDGET: function (e) {
        let {widgetId: t} = e;
        i = { ...i }, delete i[t], u().forEach(r, (e, n) => {
            if (n === T)
                return;
    ...
    LAYOUT_CREATE_WIDGETS: function (e) {
        ...
        t.forEach(e => {
            let t = new h.Z(e), n = r[t.layoutId];
            if (null == n)

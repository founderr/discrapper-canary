...
i = {
    ...
    selectedCount: (e, n) =>
        `${n.plural(e.count, {
            ...
            one: () => `\u{5E4}\u{5E8}\u{5D9}\u{5D8} ${n.number(e.count)} \u{5E0}\u{5D1}\u{5D7}\u{5E8}`,
            other: () => `${n.number(e.count)} \u{5E4}\u{5E8}\u{5D9}\u{5D8}\u{5D9}\u{5DD} \u{5E0}\u{5D1}\u{5D7}\u{5E8}\u{5D5}`
        })}.`,

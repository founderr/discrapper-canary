...
var r = n(392711), i = n.n(r), a = n(302454), o = n.n(a), s = n(797610), l = n(633302), u = n(763296), c = n(592125), d = n(430824), _ = n(594174), E = n(5192), f = n(51144), h = n(298552), p = n(444758), m = n(723454), I = n(772096), T = n(800927), g = n(945884), S = n(594199), A = n(97734), N = n(660199), v = n(364458), O = n(981631), R = n(689079), C = n(377668), y = n(689938);
let D = /^( *>>> +([\s\S]*))|^( *>(?!>>) +[^\n]*(\n *>(?!>>) +[^\n]*)*\n?)/, L = /^$|\n *$/, b = /^ *>>> ?/, M = /^ *> ?/gm;
function P(e) {
    let t = (0, I.yw)(e[1]);
    if (null == t)
...
let U = e => {
    ...
    }, w = e => null != e.guildId ? d.Z.getGuild(e.guildId) : null != e.channelId ? d.Z.getGuild(U(e.channelId)) : null, x = {
        ...
        blockQuote: {
            ...
            parse(e, t, n) {
                let r = e[0], i = !!b.exec(r), a = i ? b : M, o = r.replace(a, ''), s = n.inQuote || !1, l = n.inline || !1;
        ...
        roleMention: {
            ...
            parse(e, t, n) {
                ...
                let a = w(n), o = null != a ? d.Z.getRole(a.id, i) : null;
                return null == o ? {
                    type: 'text',
        ...
        mention: {
            ...
            parse(e, t, n) {
                ...
                let a = _.default.getUser(e[1]), o = c.Z.getChannel(n.channelId);
                ...
                let u = e[1], d = null != u && O.Xyh.test(u.trim()), h = d && n.unknownUserMentionPlaceholder ? '@'.concat(y.Z.Messages.UNKNOWN_USER_MENTION_PLACEHOLDER) : e[0];
                return {
                    userId: i,
                    channelId: n.channelId,
        ...
        soundboard: {
            ...
            parse(e, t, n) {
                var r;
                let i = e[1], a = u.Z.getSoundById(i), o = null !== (r = null == a ? void 0 : a.name) && void 0 !== r ? r : i;
                return {
                    type: 'soundboard',
                    id: i,
                    soundId: i,
...
let K = (0, v.Z)([
    {
        highlightWord: {
            ...
            match(e, t) {
                ...
                if (-1 === n)
                    return null;
                let i = e.substring(0, n), a = e.substring(n + t.highlightWord.length);
                return [
                    e,
                    t.highlightWord,
                    i,
            ...
            parse(e, t, n) {
                var r;
                let i = null !== (r = n.parseDepth) && void 0 !== r ? r : 0, a = {
                        ...n,
                        parseDepth: i + 1
                    }, o = t(e[2], a), s = t(e[3], a);
                return [

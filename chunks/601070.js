  ...
  for (let e in t)
    for (let n in t[e]) {
      ...
      if (null != t) {
        ...
        j(N, e, n, !1), j(R, e, r ? n : null, !1), j(p, e, i ? n : null, !1), s && H(e, !0)
      } else {
        j(O, e, e, !1);
...
function G(e, t, n) {
  ...
  if (null != i && S.default.isActive(e, t, n)) {
    if (null != r) {
      ...
      j(N, i, e, !0), j(R, i, n ? e : null, !0), j(p, i, t ? e : null, !0), j(O, i, null, !0), j(C, i, null, !0), H(i, s)
    } else {
  ...
  for (let e in p = {}, R = {}, N)
    for (let t in N[e])
      for (let n in N[e][t]) {
        ...
        r && j(p, i.channel, i, !1), s && j(R, i.channel, i, !1), H(i.channel, a)
      }
  for (let e in C = {}, O)
    for (let t in O[e])
      for (let n in O[e][t]) {

    ...
    for (let e in t)
        for (let n in t[e]) {
            ...
            if (null != t) {
                ...
                j(S, e, n, !1), j(A, e, i ? n : null, !1), j(b, e, r ? n : null, !1), a && V(e, !0);
            } else {
                j(T, e, e, !1);
...
function P(e, t, n) {
    ...
    if (null != r && g.Z.isActive(e, t, n)) {
        if (null != i) {
            ...
            j(S, r, e, !0), j(A, r, n ? e : null, !0), j(b, r, t ? e : null, !0), j(T, r, null, !0), j(y, r, null, !0), V(r, a);
        } else {
            let e = h.ZP.isForumPostUnread(r.id);
            j(S, r, null, !0), j(b, r, null, !0), j(A, r, null, !0), j(T, r, r, !0), j(y, r, e ? r : null, !0), H(r.id);
        }
        M(e, t);
    } else Y(S, e, t, n), Y(A, e, t, n), Y(b, e, t, n), Y(T, e, t, n), Y(y, e, t, n), H(n), M(e, t);
}
function k(e) {
    ...
    for (let e in ((b = {}), (A = {}), S))
        for (let t in S[e])
            for (let n in S[e][t]) {
                ...
                i && j(b, r.channel, r, !1), a && j(A, r.channel, r, !1), V(r.channel, s);
            }
    for (let e in ((y = {}), T))
        for (let t in T[e])
            for (let n in T[e][t]) {
...
(s = 'ActiveJoinedThreadsStore'),
    ...
    (t.Z = new $(c.Z, {
        ...
        CHANNEL_DELETE: function (e) {
            let { channel: t } = e,
                n = !1;
            return null != t.guild_id && null != t.parent_id && (t.guild_id in S && t.parent_id in S[t.guild_id] && (delete S[t.guild_id][t.parent_id], (n = !0)), t.guild_id in b && t.parent_id in b[t.guild_id] && (delete b[t.guild_id][t.parent_id], (n = !0)), t.guild_id in A && t.parent_id in A[t.guild_id] && (m.default.keys(A[t.guild_id][t.parent_id]).forEach(H), delete A[t.guild_id][t.parent_id], (n = !0)), t.guild_id in T && t.parent_id in T[t.guild_id] && (delete T[t.guild_id][t.parent_id], (n = !0)), t.guild_id in y && t.parent_id in y[t.guild_id] && (delete y[t.guild_id][t.parent_id], (n = !0)), n && M(t.guild_id, t.parent_id)), n;
        },

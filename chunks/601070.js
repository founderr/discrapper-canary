n(47120), n(653041);
var r, i, a, o, s = n(392711), l = n.n(s), u = n(442837), c = n(570140), d = n(131704), _ = n(592125), E = n(430824), f = n(306680), h = n(944486), p = n(709054), m = n(344185), I = n(569471), T = n(819168), g = n(176505);
let S = {}, A = {}, N = {}, v = {}, O = {}, R = {}, C = null, y = {};
function D() {
...
function w(e, t, n) {
    if (null == t)
        return !1;
    let r = _.Z.getChannel(n), i = I.Z.joinTimestamp(n);
...
function k(e) {
    ...
    if (null == t)
        ...
        if (W(S, t)) {
            ...
            if (n === o && i === s)
                return !1;
            let l = S[e][r][t.id], u = n ? l : null, c = i ? l : null;
            Y(A, t, u, !0), Y(O, t, c, !0), U(e, r);
        } else {
            let e = W(v, t), n = f.ZP.isForumPostUnread(t.id);
            if (n === e)
                return !1;
            Y(v, t, n ? t : null, !0);
        }
...
function V(e) {
    let t = f.ZP.getMentionCount(e.id) > 0, n = f.ZP.hasUnread(e.id) && !I.Z.isMuted(e.id), r = e.hasFlag(g.zZ.PINNED), i = e.isActiveThread(), a = i && (0, T.Z)(e) > Date.now();
    return {
        isUnread: (i || r) && n || t,
        isRelevant: a || r || n || t,
        isTimedRelevant: a
    ...
    CHANNEL_UPDATES: function (e) {
        ...
        for (let e of t)
            if (e.isNSFW() !== function (e, t) {
                    if (null == t)
                        return !1;
                    let n = S[e], r = null == n ? null : n[t];
                    if (null != r) {
                        for (let e in r)
                            if (r[e].channel.isNSFW())
                                return !0;
                    }
                    let i = N[e], a = null == i ? null : i[t];
                    if (null != a) {
                        for (let e in a)
                            if (a[e].isNSFW())
                                return !0;

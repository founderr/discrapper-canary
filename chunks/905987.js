...
var t = a(735250), n = a(470079), i = a(120356), l = a.n(i), r = a(442837), c = a(481060), d = a(430824), o = a(771845), _ = a(259580), I = a(186523), N = a(553826), x = a(689938), m = a(731612), T = a(485621);
function h(e) {
    let {count: s} = e, [a, i] = n.useState('server');
...
function O(e) {
    let {hidden: s} = e, [a, i] = n.useState(0);
    return n.useEffect(() => {
        if (s)
            return;
        let e = 0, a = [

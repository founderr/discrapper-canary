...
class o {
  ...
  constructor({
    ...
    r()(null != d, "couldn't get canvas 2d context."), this.canvas = t, this.canvasContext = d, this.animation = null, this.dropped = !1, this.currentFrame = 0, this.currentFrameTime = 0, this.frameDuration = 1e3, this.animate = l, this.visible = o, this.requestAnimationFrameId = null, this.hasInitialFrame = !1, this.onInitialDraw = u, this.onError = c, this.key = "".concat(e, ":").concat(t.width, ":").concat(t.height), a.default.create(this.key, t.width, t.height, i, n).then(t => {

l(47120);
var n = l(735250), a = l(470079), o = l(120356), s = l.n(o), i = l(392711), r = l(498607), C = l.n(r), c = l(399606), d = l(692547), u = l(481060), m = l(700582), _ = l(745735), E = l(906732), h = l(715903), M = l(69882), x = l(189357), b = l(493892), T = l(433355), L = l(430824), g = l(496675), I = l(594174), p = l(373791), H = l(203893), f = l(777288), A = l(5192), N = l(709054), R = l(51144), S = l(815790), Z = l(588215), j = l(241559), v = l(893966), D = l(685244), O = l(16829), B = l(256003), V = l(472596), U = l(285173), w = l(981631), k = l(689938), F = l(405811);
let y = a.memo(function (e) {
    let {member: t} = e, l = a.useMemo(() => (0, M.J)(t.communicationDisabledUntil), [t.communicationDisabledUntil]), o = a.useMemo(() => null == t.communicationDisabledUntil ? new Date() : new Date(t.communicationDisabledUntil), [t.communicationDisabledUntil]);
    return (0, n.jsxs)('div', {
        className: s()(F.flagContainer),
        children: [
            t.hasUnusualDmActivity && (0, n.jsx)(u.Tooltip, {
            ...
            (0, b.He)(t.userId) && (0, n.jsx)(u.Tooltip, {
...
function P(e) {
    let {member: t} = e, l = (0, c.e7)([L.Z], () => L.Z.getRoles(t.guildId)), o = a.useMemo(() => null == t.highestRoleId ? t.roles : t.roles.filter(e => null != e && e !== t.highestRoleId).sort((e, t) => {
            var n, a, o, s;
...
let Y = a.memo(function (e) {
        let {
                member: t,
                highestRole: l
            } = e, o = (0, c.e7)([L.Z], () => L.Z.getGuild(t.guildId), [t.guildId]), [i, r] = a.useState(!1), C = t.roles.length - 1, d = a.useMemo(() => new Intl.NumberFormat(k.Z.getLocale()).format(C), [C]), m = (0, V.qr)(t), _ = (0, c.e7)([g.Z], () => g.Z.can(w.Plq.MANAGE_ROLES, o), [o]), E = a.useCallback(e => () => {
                r(!0), null == e || e();
            }, []), h = a.useCallback(e => () => {
                r(!1), null == e || e();
            }, []);
        ...
        let {
                member: l,
                user: o
            } = e, {analyticsLocations: i} = (0, E.ZP)(), r = a.useCallback(e => {
                if (null != l)
                    e.stopPropagation(), e.preventDefault(), (0, V.RE)(l, i);
            }, [
                l,
                i
            ]);
        return null == o || null == l ? null : (0, n.jsxs)('div', {
...
function q(e) {
    let {
            ...
            showLongDate: l,
            isSortedBy: o
        } = e, [i, r] = a.useState(null);
    a.useEffect(() => {
        r(z(t.joinedAtTimestamp));
    }, [t.joinedAtTimestamp]), (0, _.Z)(() => {
        r(z(t.joinedAtTimestamp));
    }, 10000);
    let C = o ? 'text-brand' : 'text-normal';
    return (null == i ? void 0 : i.short) == null ? null : l ? (0, n.jsx)('div', {
...
let W = a.memo(function (e) {
        let {
                ...
                let e = N.default.extractTimestamp(t.userId), l = (0, S.fv)(e, S.jq.ACCOUNT_AGE);
                return {
                    accountCreationDateShort: l,
                    accountCreationDateLong: new Date(e).toLocaleDateString(k.Z.getLocale(), S.I)
                };
            }, [t.userId]), r = o ? 'text-brand' : 'text-normal';
        return l ? (0, n.jsx)(u.Text, {
            variant: 'text-sm/medium',
            color: r,
            children: i
        }) : (0, n.jsx)(u.Tooltip, {
        ...
        let {
                ...
                g.Z,
                L.Z
            ], () => g.Z.can(w.Plq.MANAGE_GUILD, L.Z.getGuild(t.guildId)), [t.guildId]), {
                selectedUserIds: E,
                addUsers: h,
                removeUser: M
            } = (0, B.Z)(t.guildId), b = (0, j.xC)(t.guildId), T = (0, j.hB)(t.guildId, b, t.userId), I = (0, x.ms)(t.guildId), p = (0, c.e7)([v.Z], () => {
                var e;
                return null !== (e = v.Z.getSearchStateByGuildId(t.guildId).selectedSort) && void 0 !== e ? e : Z.d$.ORDER_BY_UNSPECIFIED;
            }, [t.guildId], C()), H = a.useCallback(e => {
            ...
            children: [
                ...
                (0, n.jsx)('td', {
                    ...
                    children: (0, n.jsxs)('div', {
                        ...
                        children: [
                            (0, n.jsx)(u.Tooltip, {
                                text: I ? k.Z.Messages.MEMBER_SAFETY_TABLE_MOD_VIEW_TOOLTIP : k.Z.Messages.MEMBER_SAFETY_TABLE_PROFILE_TOOLTIP,
                                children: e => {
                                    let {
                                        onMouseEnter: t,
                                        onMouseLeave: l
...
t.Z = a.memo(function (e) {
    let {
            ...
            compact: _ = !1
        } = e, E = (0, c.e7)([T.ZP], () => T.ZP.getGuildSidebarState(l), [l]), h = (null == E ? void 0 : E.details.userId) === t, M = (0, c.e7)([v.Z], () => v.Z.getEnhancedMember(l, t), [
            l,
            t
        ]), x = (0, V.zq)(M), b = (0, c.e7)([I.default], () => I.default.getUser(t), [t]), L = (0, V.RN)(null != M ? M : void 0), g = a.useCallback(e => {
    ...
    return null == M ? null : (0, n.jsx)(D.Z, {
        role: 'row',
        value: M,
        style: o,

...
class F extends (r = i.ZP.PersistedStore) {
    initialize(e) {
        if (
            ...
            null != t && (null == (P = M(t)).textChatNotifications && (P.textChatNotifications = T.textChatNotifications), null == P.textWidgetOpacity && (P.textWidgetOpacity = T.textWidgetOpacity));
        }
    }
    getState() {
        return A;
...
S(F, 'displayName', 'OverlayStore'),
    S(F, 'persistKey', 'OverlayStoreV2'),
    S(F, 'migrations', [
        () => {

...
class F extends (r = i.ZP.PersistedStore) {
    initialize(e) {
        if (
            ...
            null != t && (null == (P = M(t)).textChatNotifications && (P.textChatNotifications = S.textChatNotifications), null == P.textWidgetOpacity && (P.textWidgetOpacity = S.textWidgetOpacity));
        }
    }
    getState() {
        return A;

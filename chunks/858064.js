...
var i = n(735250);
n(470079);
var l = n(442837), r = n(481060), a = n(230711), s = n(314897), o = n(626135), c = n(730417), u = n(524347), d = n(702512), h = n(981631), p = n(689938), _ = n(201032);
let f = (e, t, n) => {
...
function m(e) {
    let {
        ...
        } = e, a = (0, l.e7)([u.Z], () => u.Z.currentDropQuestStreamProgress), s = Math.floor(a / 100 * t).toString();
    return (0, i.jsxs)('div', {
        children: [
            (0, i.jsx)(r.Text, {
            ...
            (0, i.jsxs)(r.Text, {
                ...
                children: [
                    '*',
                    p.Z.Messages.DROPS_REQUIRE_NUM_VIEWERS.format({ numViewers: n }),
                    '*'
                ]
            })
        ]
...
function g(e) {
    ...
    return (0, i.jsxs)('div', {
        ...
        children: [
            ...
            n === d._e.LOADING_INITIAL_PROGRESS ? (0, i.jsx)(r.Spinner, { className: _.spinner }) : (0, i.jsx)(r.Heading, {
                className: _.title,

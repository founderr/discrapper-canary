...
e.exports = function(e) {
  ...
  return {
    ...
    contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, s.CSS_NUMBER_MODE, {
      ...
      relevance: 0,
      contains: [s.BLOCK_COMMENT, c, s.HEXCOLOR, s.CSS_NUMBER_MODE, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, s.IMPORTANT, s.FUNCTION_DISPATCH]
    }, {
      ...
      contains: [{
        ...
        begin: /[a-z-]+(?=:)/,
        className: "attribute"
      }, c, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, s.HEXCOLOR, s.CSS_NUMBER_MODE]
    }, s.FUNCTION_DISPATCH]
  }
}
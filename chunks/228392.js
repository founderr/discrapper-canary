...
channelId: u
  ...
  if (null == c)
return;
  let d = s.Z.getThreadSettings(u),
f = null === (t = c.template) || void 0 === t ? void 0 : t.trim(),
h = s.Z.getDraft(u, s.d.FirstThreadMessage),
...
onboardingCTA: t
  ...
  r.ZP.trackWithMetadata(E.rMx.FORUM_CHANNEL_ONBOARDING_CLICKED, {
...
forumDemoId: t
  ...
  r.ZP.trackWithMetadata(E.rMx.FORUM_UPSELL_MODAL_CLICKED, {
forum_demo_id: t
  });
}
...
added: t
  ...
  r.ZP.trackWithMetadata(E.rMx.FORUM_ADD_MEDIA_TO_ORIGINAL_POST_CLICKED, {
added: t
  });
}
...
readGuideCta: t
  ...
  r.ZP.trackWithMetadata(E.rMx.FORUM_CHANNEL_HELPER_CARD_CLICKED, {
read_guide_cta: t
  });
}
...
isMobile: t
  ...
  r.ZP.trackWithMetadata(E.rMx.FORUM_CHANNEL_MEDIA_UPLOADER_CLICKED, {
is_mobile: t
  });
}
...
platform: (0, u.getPlatform)()
  }), (0, a.a)(E.rMx.CHANNEL_OPENED_CLICKSTREAM, {
channelId: e.id
  });
}

...
function T(e) {
  ...
  let {
    ...
    image: U,
    recurrence_rule: b
  } = i, V = (0, x.DK)(i), O = (0, t.e7)([h.ZP], () => h.ZP.isInterestedInEventRecurrence(P, V), [P, V]), H = (0, t.e7)([r.Z], () => r.Z.isLurking(G), [G]), w = (0, t.e7)([o.Z], () => o.Z.getStageInstanceByChannel(D), [D]), z = (0, t.e7)([c.Z], () => c.Z.getChannel(D), [D]), B = (0, t.e7)([E.default], () => E.default.getUser(S), [S]), {
    speakers: J
  } = (0, Z.Z)({
    id: D,
    data: {

...
var l = t(735250);
t(470079);
var s = t(120356), a = t.n(s), i = t(481060), r = t(933557), o = t(471445), u = t(602623), c = t(5192), d = t(689938), m = t(365644);
function E(e) {
    let {
            channel: n,
            users: t,
    ...
    null != t && t.length > 0 && (_ = (0, l.jsx)(u.Z, {
        ...
        renderUser: e => {
            if (null == e)
                return null;
            let t = c.ZP.getName(n.guild_id, n.id, e), s = e.getAvatarURL(n.guild_id, 24);

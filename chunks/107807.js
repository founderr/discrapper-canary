...
var o, c, a = t(735250), s = t(470079), l = t(120356), i = t.n(l), r = t(512722), d = t.n(r), C = t(392711), u = t.n(C), N = t(442837), _ = t(692547), h = t(780384), T = t(481060), O = t(457330), E = t(749210), m = t(230711), x = t(99690), p = t(410030), S = t(726542), A = t(367907), I = t(277800), v = t(471445), M = t(335191), f = t(706454), g = t(598077), j = t(314897), L = t(592125), k = t(553795), y = t(271383), G = t(496675), R = t(467679), Z = t(259580), U = t(626135), D = t(228643), P = t(275759), b = t(231757), B = t(753194), w = t(225104), F = t(458034), H = t(856651), V = t(981631), Y = t(689938), z = t(935527);
function K(e) {
    let {
            platformType: n,
            className: t
...
function q(e) {
    ...
    return (0, a.jsxs)('div', {
        ...
        children: [
            null != o ? (0, a.jsx)(o, { className: z.channelNameIcon }) : null,
            (0, a.jsx)(T.Heading, {
...
function W(e) {
    ...
    return (0, a.jsx)(a.Fragment, {
        children: Object.keys(p).sort((e, n) => {
            let t = p[e].every(e => e.result), o = p[n].every(e => e.result);
            return !0 === t && !1 === o ? 1 : !1 === t && !0 === o ? -1 : 0;
        }).map(e => {
            var n, o, s;
            let C, u, N;
            let _ = p[e], O = _.find(e => null == e.operator), m = _.filter(e => null != e.operator), I = (null == O || O.result) && m.every(e => e.result), v = _.find(e => null != e.application), M = S.Z.get(e), f = null == M || M.enabled, j = null == v ? void 0 : v.application, L = (null == j ? void 0 : j.bot) != null ? new g.Z(j.bot) : null;
            ...
            let k = c[null !== (o = null == M ? void 0 : M.type) && void 0 !== o ? o : H.Kt], y = !I && null != k && k <= r;
            return u = I ? (0, a.jsx)(T.CheckmarkLargeIcon, {
                ...
                children: [
                    ...
                    null != M ? (0, a.jsx)(K, { platformType: M.type }) : null,
                    null != L ? (0, a.jsx)(x.Z, { user: L }) : null,
                    (0, a.jsxs)('div', {
...
function X(e) {
    let n, t, o, {
        ...
        } = e, [r, d] = s.useState(c.friendSync), [C, u] = s.useState(c.showActivity), [N, _] = s.useState(1 === c.metadataVisibility), [h, E] = s.useState(1 === c.visibility);
    s.useEffect(() => {
        l(!h), i(N);
    }, []);
    ...
    return V.BFP.has(c.type) && (n = (0, a.jsx)(T.FormSwitch, {
        ...
        children: (0, a.jsx)(T.Text, {
            variant: 'text-sm/semibold',
            children: Y.Z.Messages.DISPLAY_ACTIVITY.format({ platform: m.name })
        })
                ...
                children: function () {
                    ...
                    case 0: {
                            ...
                            return (0, a.jsx)(T.ModalContent, {
                                children: h || null == r ? (0, a.jsx)(T.Spinner, { className: z.connectionsChecksGroups }) : (0, a.jsxs)(a.Fragment, {
                                    children: [
                                        (0, a.jsx)(T.Text, {
                                            variant: 'text-md/medium',
                            ...
                            return (0, a.jsxs)(T.ModalContent, {
                                children: [
                                    ...
                                    (0, a.jsx)('div', {
                                        ...
                                        children: null == e && null == n ? (0, a.jsx)(T.Spinner, { className: z.accountConnectedLoading }) : (0, a.jsxs)(a.Fragment, {
                                            children: [
                        ...
                        return (0, a.jsxs)(T.ModalContent, {
                            children: [
                                ...
                                (0, a.jsx)(T.ScrollerThin, {
                                    ...
                                    children: ec.map(e => (0, a.jsx)(q, { channel: e }, e.id))
                                })
                            ]
                        });
                    default:

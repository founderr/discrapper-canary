...
var r, i, a, o, s, l = n(392711), u = n.n(l), c = n(442837), d = n(570140), _ = n(579806), E = n(632243), f = n(314897), h = n(283595), p = n(129542), m = n(70956), I = n(780570), T = n(358085), g = n(804739), S = n(941128), A = n(391690), N = n(981631);
let v = 1 * m.Z.Millis.MINUTE;
(r || (r = {})).DISPATCH_APPLICATION_PROGRESS = 'dispatch_application_progress';
let O = {}, R = 'file://', C = !1, y = 0, D = 0, L = 0, b = [], M = [], P = [], U = !1;
function w(e) {
...
let k = u().throttle(function (e) {
    ...
    }, 200), B = u().throttle(function (e) {
        let t = Date.now(), n = t - v;
        b = (b = [
            {
                bytes: e,
                timestamp: t
...
s = 'DispatchApplicationStore', (o = 'displayName') in (a = H) ? Object.defineProperty(a, o, {
    ...
    DISPATCH_APPLICATION_STATE_UPDATE: function (e) {
        let {state: t} = e;
        C = !0;
        let n = {}, r = t.applications, i = null != t.currentTask ? t.currentTask.branchId : null, a = !1;
        for (let e in r)
            for (let t in r[e]) {
                let o = (0, I.Tu)(e, t);
                if (n[o] = function (e) {
                        ...
                        case N.DJE.COMPLETE: {
                                ...
                                if (f)
                                    ...
                                    let e = _.Z.fileManager.join(d, 'content'), t = (0, p.D)();

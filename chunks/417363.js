...
class V extends (i = c.ZP.Store) {
    ...
    isInstalled(e, t) {
        let n = A[(0, E.Tu)(e, t)];
        return null != n ? n.type !== T.vxO.UNINSTALLING : S.Z.shouldBeInstalled(e, t);
    }
                            ...
                            switch ((null == h && (h = !0), e.state.type)) {
                                ...
                                case T.DJE.TRANSITION: {
                                    ...
                                    let { stage: l, disk_progress: u, network_progress: c, reader_progress: f, progress: m, total: g, paused: E } = e.state,
                                        v = l.type;
                                    return {
                                        type: (o = v === T.f07.UNINSTALLING ? T.vxO.UNINSTALLING : p ? T.vxO.REPAIRING : null == t ? T.vxO.INSTALLING : T.vxO.UPDATING),
                                        stage: v,
                                        applicationId: a,
                                        branchId: s,
                                        buildId: t,

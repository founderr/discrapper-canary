var r = n(970661), i = n(854160), a = n(896933), o = n(983584);
function s(e, t, n) {
    ...
    var a = this._findPluralRuleFunction(this._locale), o = this._compilePattern(r, t, n, a), l = this;
...
t.default = s, i.defineProperty(s, 'formats', {
...
}), i.defineProperty(s, '__localeData__', { value: i.objCreate(null) }), i.defineProperty(s, '__addLocaleData', {
    value: function (e) {
        if (!(e && e.locale))
...
}), i.defineProperty(s, '__parse', { value: o.default.parse }), i.defineProperty(s, 'defaultLocale', {
    enumerable: !0,
    writable: !0,
    value: void 0
    ...
    for (n = 0, i = e.length; n < i; n += 1) {
        ...
        if (o = a.id, !(t && r.hop.call(t, o)))
            throw Error('A value must be provided for: ' + o);
    ...
    for (n in e) {
        if (!!r.hop.call(e, n))
            o[n] = a = i.objCreate(e[n]), t && r.hop.call(t, n) && r.extend(a, t[n]);
    }
    return o;

...
function x(e) {
  ...
  let {
    onClose: A,
    event: R
  } = e, L = null == R ? void 0 : R.guild_id, O = (0, a.useStateFromStores)([c.default], () => {
    var e;
    return null != L ? null === (e = c.default.getDefaultChannel(L)) || void 0 === e ? void 0 : e.id : null
  }, [L]), M = (0, a.useStateFromStores)([E.default], () => E.default.getGuild(L), [L]), D = (null == M ? void 0 : M.vanityURLCode) != null && (null == M ? void 0 : M.vanityURLCode.length) > 0, {
    enabled: y

...
class S extends(l = u.PureComponent) {
  ...
  constructor(e) {
    super(e), c(this, "draggableRef", u.createRef()), c(this, "_dragStart", {
      ...
      2 === r && I !== this.state.horizontalOrientation && (this._offsetX = T - this._offsetX, g = !0), 2 === i && p !== this.state.verticalOrientation && (this._offsetY = A - this._offsetY, g = !0), this.setDOMPositions(v), !S && (null == o || o(v, n)), null == u || u(v, n), g && (null == d || d([p, I])), this.setState({
        dragging: m,
        verticalOrientation: p,
        horizontalOrientation: I,
        atTopEdge: 0 === v.top

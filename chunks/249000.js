...
class S extends(l = u.PureComponent) {
  ...
  constructor(e) {
    super(e), c(this, "draggableRef", u.createRef()), c(this, "_dragStart", {
      ...
      2 === r && p !== this.state.horizontalOrientation && (this._offsetX = g - this._offsetX, T = !0), 2 === i && I !== this.state.verticalOrientation && (this._offsetY = A - this._offsetY, T = !0), this.setDOMPositions(R), !S && (null == o || o(R, a)), null == u || u(R, a), T && (null == d || d([I, p])), this.setState({
        dragging: m,
        verticalOrientation: I,
        horizontalOrientation: p,
        atTopEdge: 0 === R.top

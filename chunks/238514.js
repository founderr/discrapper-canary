var r, i = n(392711), a = n.n(i), o = n(442837), s = n(433517), l = n(570140), u = n(981631);
function c(e, t, n) {
...
c(_, 'displayName', 'SelectivelySyncedUserSettingsStore'), c(_, 'persistKey', 'SelectivelySyncedUserSettingsStore'), c(_, 'migrations', [
    () => {
        var e, t;
        let n = null !== (e = s.K.get('UserSettingsSync')) && void 0 !== e ? e : {}, r = null !== (t = s.K.get('UserSettingsStore')) && void 0 !== t ? t : {};
        ...
        }), !1 === n[u.oAB.APPEARANCE] && (i.appearance = {
            shouldSync: !1,
            settings: a().pick(r, [
                'theme',
                'clientThemeSettings',

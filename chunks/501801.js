...
var s = E(735250), T = E(470079), I = E(120356), n = E.n(I), A = E(392711), t = E.n(A), a = E(913527), r = E.n(a), N = E(481060), L = E(596454), S = E(479099), D = E(592125), l = E(430824), U = E(594174), G = E(274730), O = E(934415), i = E(823379), M = E(624138), R = E(981631), o = E(689938), u = E(364467);
function c(e, _) {
...
class d extends T.PureComponent {
    render() {
        ...
        return (0, s.jsx)('div', { className: a });
    }
}
function f(e) {
    let {
            ...
            if (null == _.changes)
                return null;
            let T = 0, a = t().flatten(_.changes.map(I => {
                    let {
                            oldValue: n,
                            newValue: A
                        } = I, a = null;
                    if (_.action === R.rsA.MEMBER_ROLE_UPDATE ? a = function (e) {
                        ...
                        }(I)), (_.action === R.rsA.CHANNEL_UPDATE || _.action === R.rsA.CHANNEL_CREATE) && I.key === R.zUn.TYPE && (null != n && (n = (0, O.a5)({ type: n })), null != A && (A = (0, O.a5)({ type: A }))), _.action === R.rsA.MEMBER_UPDATE && I.key === R.zUn.COMMUNICATION_DISABLED_UNTIL) {
                    ...
                    (_.action === R.rsA.ONBOARDING_PROMPT_UPDATE || _.action === R.rsA.ONBOARDING_PROMPT_CREATE) && I.key === R.zUn.OPTIONS && (a = function (e, _, E) {
                                        ...
                                        (0, s.jsxs)('div', {
                                            ...
                                            children: [
                                                ...
                                                (0, s.jsx)(N.Text, {
                                                    ...
                                                    children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_UPDATED_OPTION.format({ title: T })
                                                })
                                            ]
                                        }),
                                        (0, s.jsxs)('div', {
                                            ...
                                            children: [
                                                ...
                                                l.length > 0 && (0, s.jsx)(N.Text, {
                                                    variant: 'text-md/normal',
                                                    children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_REMOVE_ROLES.format({ roles: l.join(', ') })
                                                }),
                                                U.length > 0 && (0, s.jsx)(N.Text, {
                                                    variant: 'text-md/normal',
                                                    children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_ADD_CHANNELS.format({ channels: U.join(', ') })
                                                }),
                                                G.length > 0 && (0, s.jsx)(N.Text, {
                                                    variant: 'text-md/normal',
                                                    children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_REMOVE_CHANNELS.format({ channels: G.join(', ') })
                                                }),
                                        ...
                                        children: [
                                            (0, s.jsxs)('div', {
                                                ...
                                                children: [
                                                    ...
                                                    (0, s.jsx)(N.Text, {
                                                        variant: 'text-md/normal',
                                                        children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_CREATED_OPTION.format({ title: I })
                                                    })
                                                ]
                                            }),
                                            (0, s.jsxs)('div', {
                                                ...
                                                children: [
                                                    a.length > 0 && (0, s.jsx)(N.Text, {
                                                        variant: 'text-md/normal',
                                                        children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_WITH_ROLES.format({ roles: a.join(', ') })
                                                    }),
                                                    r.length > 0 && (0, s.jsx)(N.Text, {
                                                        variant: 'text-md/normal',
                                                        children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_WITH_CHANNELS.format({ channels: r.join(', ') })
                                                    })
                                                ]
                                            })
                                        ]
                                ...
                                U.map(e => (0, s.jsx)('li', {
                                    children: (0, s.jsxs)('div', {
                                        ...
                                        children: [
                                            ...
                                            (0, s.jsx)(N.Text, {
                                                variant: 'text-md/normal',
                                                children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_ONBOARDING_PROMPT_DELETED_OPTION.format({ title: e.title })
                                            })
                                        ]
                                    })
                                }, e.id)),
                        ...
                        case R.zUn.WELCOME_MESSAGE:
                            return ((e, _) => {
                                var E, T, I, n, A;
                                let t = U.default.getUser(null == _ ? void 0 : null === (E = _.author_ids) || void 0 === E ? void 0 : E[0]), a = U.default.getUser(null === (T = e.author_ids) || void 0 === T ? void 0 : T[0]), r = (null == t ? void 0 : t.id) !== (null == a ? void 0 : a.id) ? (0, s.jsx)('li', {
                                    ...
                                    }) : null, L = (null == _ ? void 0 : _.message) !== e.message ? (0, s.jsx)('li', {
                                        children: (0, s.jsx)('div', {
                                            className: u.onboardingChangeLogItemTitle,
                                            children: (0, s.jsx)(N.Text, {
                                                variant: 'text-md/normal',
                        ...
                        case R.zUn.NEW_MEMBER_ACTIONS:
                            return ((e, _) => {
                                let E = e.map(e => e.channel_id), T = _.map(e => e.channel_id), I = t().difference(T, E), a = t().difference(E, T), r = _.filter(e => I.includes(e.channel_id)), L = e.filter(e => a.includes(e.channel_id));
                                return (0, s.jsxs)('ul', {
                                    children: [
                                        r.map(e => (0, s.jsx)('li', {
                                            children: (0, s.jsxs)('div', {
                                                ...
                                                children: [
                                                    ...
                                                    (0, s.jsx)(N.Text, {
                                                        variant: 'text-md/normal',
                                                        children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_HOME_SETTINGS_NEW_MEMBER_ACTION_ADDED.format({ name: e.title })
                                                    })
                                                ]
                                            })
                                        }, e.channel_id)),
                                        L.map(e => (0, s.jsx)('li', {
                                            children: (0, s.jsxs)('div', {
                                                ...
                                                children: [
                                                    ...
                                                    (0, s.jsx)(N.Text, {
                                                        variant: 'text-md/normal',
                                                        children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_HOME_SETTINGS_NEW_MEMBER_ACTION_REMOVED.format({ name: e.title })
                                                    })
                                                ]
                                            })
                                        }, e.channel_id))
                                        ...
                                        r.map(e => (0, s.jsx)('li', {
                                            children: (0, s.jsxs)('div', {
                                                ...
                                                children: [
                                                    ...
                                                    (0, s.jsx)(N.Text, {
                                                        variant: 'text-md/normal',
                                                        children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_HOME_SETTINGS_RESOURCE_CHANNEL_ADDED.format({ name: e.title })
                                                    })
                                                ]
                                            })
                                        }, e.channel_id)),
                                        L.map(e => (0, s.jsx)('li', {
                                            children: (0, s.jsxs)('div', {
                                                ...
                                                children: [
                                                    ...
                                                    (0, s.jsx)(N.Text, {
                                                        variant: 'text-md/normal',
                                                        children: o.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_HOME_SETTINGS_RESOURCE_CHANNEL_REMOVED.format({ name: e.title })
                                                    })
                                                ]
                                            })
                                        }, e.channel_id))

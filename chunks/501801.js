...
if (null != _ && null != _.format) {
  ...
  r = _.format({
    ...
    oldTagHook: (e, _) => (0, s.jsx)(L.Z, {
      tag: n,
      size: L.Z.Sizes.SMALL
    }, _),
    newTagHook: (e, _) => (0, s.jsx)(L.Z, {
      tag: t,
      size: L.Z.Sizes.SMALL
    }, _),
  ...
  return null == r ? (console.warn('No change string for', A), null) : '' === r ? null : (0, s.jsxs)('div', {
className: R.detail,
style: {
  position: 'relative',
  top: 1
...
let {
  ...
  action: I,
  themeOverride: t
} = this.props, A = null != t ? R['themeOverride'.concat((0, i.De)(t))] : null;
let r = n()(R.icon, C[E], (e = T, (_ = I) === M.rsA.MESSAGE_DELETE ? R.targetMessage : _ === M.rsA.AUTO_MODERATION_BLOCK_MESSAGE || _ === M.rsA.AUTO_MODERATION_FLAG_TO_CHANNEL || _ === M.rsA.AUTO_MODERATION_USER_COMMUNICATION_DISABLED || _ === M.rsA.AUTO_MODERATION_QUARANTINE_USER ? R.autoModerationBlockMessage : {
...
if (null == _.changes)
  return null;
let T = 0,
  r = A().flatten(_.changes.map(I => {
    let {
      oldValue: n,
      newValue: t
    } = I, r = null;
    if (_.action === M.rsA.MEMBER_ROLE_UPDATE ? r = function(e) {
        let {
          newValue: _
        } = e;
      ...
      }(I) : _.targetType === M.KFR.ROLE || _.action === M.rsA.CHANNEL_OVERWRITE_CREATE || _.action === M.rsA.CHANNEL_OVERWRITE_UPDATE ? r = function(e, _) {
        let {
          newValue: E
        } = e;
      ...
      }(I, _) : (_.action === M.rsA.CHANNEL_UPDATE || _.action === M.rsA.THREAD_UPDATE) && I.key === M.zUn.FLAGS && (r = function(e) {
        let {
          newValue: _,
          oldValue: E
        } = e, T = [];
      ...
      }(I)), (_.action === M.rsA.CHANNEL_UPDATE || _.action === M.rsA.CHANNEL_CREATE) && I.key === M.zUn.TYPE && (null != n && (n = (0, O.a5)({
        type: n
      })), null != t && (t = (0, O.a5)({
        type: t
      }))), _.action === M.rsA.MEMBER_UPDATE && I.key === M.zUn.COMMUNICATION_DISABLED_UNTIL) {
      if (null == (t = a()(t)) || !t.isValid())
        return null;
      t = t.calendar();
    }
    (_.action === M.rsA.ONBOARDING_PROMPT_UPDATE || _.action === M.rsA.ONBOARDING_PROMPT_CREATE) && I.key === M.zUn.OPTIONS && (r = function(e, _, E) {
      let {
        newValue: T,
        oldValue: I
      } = e, n = e => {
        ...
        let {
          title: T,
          id: I
        } = E, r = e.role_ids.map(n).filter(o.lm), a = e.channel_ids.map(t).filter(o.lm), l = E.role_ids.map(n).filter(o.lm), L = E.channel_ids.map(t).filter(o.lm), S = A().difference(l, r), D = A().difference(r, l), U = A().difference(L, a), G = A().difference(a, L), O = [];
        return (!A().isEqual(e.title, E.title) && O.push('title'), !A().isEqual(e.description, E.description) && O.push('description'), 0 === S.length && 0 === D.length && 0 === U.length && 0 === G.length && 0 === O.length) ? null : (0, s.jsxs)('li', {
          children: [
            (0, s.jsxs)('div', {
      ...
      }, a = A().keyBy(null != I ? I : [], 'id'), l = A().keyBy(null != T ? T : [], 'id'), L = A().difference(Object.keys(l), Object.keys(a)).map(e => l[e]), U = A().difference(Object.keys(a), Object.keys(l)).map(e => a[e]), G = A().intersection(Object.keys(l), Object.keys(a));
      return (0, s.jsxs)('ul', {
        ...
        children: [
          L.map(e => {
            let {
              ...
              title: I,
              id: A
            } = e, r = (null != E ? E : []).map(n).filter(o.lm), a = (null != T ? T : []).map(t).filter(o.lm);
            return (0, s.jsxs)('li', {
              children: [
                (0, s.jsxs)('div', {
                  className: R.onboardingChangeLogItemTitle,
    ...
    }(I, _, E)), (_.action === M.rsA.HOME_SETTINGS_CREATE || _.action === M.rsA.HOME_SETTINGS_UPDATE) && (r = function(e, _) {
      let {
        oldValue: E,
        newValue: T,
        key: I
        ...
        case M.zUn.WELCOME_MESSAGE:
          return ((e, _) => {
            ...
            let A = U.default.getUser(null == _ ? void 0 : null === (E = _.author_ids) || void 0 === E ? void 0 : E[0]),
              ...
              a = (null == A ? void 0 : A.id) !== (null == r ? void 0 : r.id) ? (0, s.jsx)('li', {
    ...
    let l = e[I.key];
    return c(_, I) ? null : ('function' == typeof l && (l = l(I)), Array.isArray(l)) ? l.map(e => (T++, d({
      changeItem: e,
      subChanges: r,
      changeNumber: T,
      log: _,

                            ...
                            _.changes.map((t) => {
                                ...
                                if (
                                    (_.action === d.rsA.MEMBER_ROLE_UPDATE
                                        ...
                                        : _.targetType === d.KFR.ROLE || _.action === d.rsA.CHANNEL_OVERWRITE_CREATE || _.action === d.rsA.CHANNEL_OVERWRITE_UPDATE
                                          ? (I = (function (e, _) {
                                                let { newValue: E } = e;
                                          ...
                                          : (_.action === d.rsA.CHANNEL_UPDATE || _.action === d.rsA.THREAD_UPDATE) &&
                                            t.key === d.zUn.FLAGS &&
                                            (I = (function (e) {

...
var o = r(642512), a = r(297326), u = r(470079), s = r(1231), c = r(292489), l = r(746117), f = r(856084), p = r(606166), h = r(675411), d = r(685536), g = r(126502), y = r(581079), v = r(822274), m = r(467159), _ = function (t, e) {
        return t.getAnchorKey() === e || t.getFocusKey() === e;
    }, b = function (t) {
        function e() {
            for (var e, r, n, i, o = arguments.length, a = Array(o), u = 0; u < o; u++)
                a[u] = arguments[u];
            return r = function (t) {
                if (void 0 === t)
        ...
        return b.shouldComponentUpdate = function (t) {
            ...
            if (this.props.preventScroll)
                return;
            var t, e = this.props.selection, r = e.getEndKey();
            if (!e.getHasFocus() || r !== this.props.block.getKey())
                return;
            var n = this._node;
            if (null != n) {
                var i = c.getScrollParent(n), o = d(i);
                if (i === window) {
                    var a = h(n), u = a.y + a.height;
            ...
            var t = this, e = this.props.block, r = e.getKey(), n = e.getText(), s = this.props.tree.size - 1, c = _(this.props.selection, r);
            return this.props.tree.map(function (p, h) {
                var d = p.get('leaves');
                if (0 === d.size)
                    return null;
                var g = d.size - 1, y = d.map(function (i, l) {
                        var f = a.encode(r, h, l), p = i.get('start'), d = i.get('end');
                    ...
                    }).toArray(), v = p.get('decoratorKey');
                if (null == v || !t.props.decorator)
                    return y;
                var _ = m(t.props.decorator), b = _.getComponentForKey(v);
                if (!b)
                    return y;
                var S = _.getPropsForKey(v), w = a.encode(r, h, 0), k = d.first().get('start'), x = d.last().get('end'), C = n.slice(k, x), E = e.getEntityAt(p.get('start')), D = f.getHTMLDirIfDifferent(l.getDirection(C), t.props.direction), O = {
            ...
            var t = this, e = this.props, r = e.direction, n = e.offsetKey, i = p({

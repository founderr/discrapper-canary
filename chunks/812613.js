...
var l = t(512722), a = t.n(l), i = t(304809), s = t(70956), r = t(208049), u = t(419202);
...
async function m(e) {
    let n = [], t = function (e) {
            ...
            if (2 === e.length) {
                ...
                for (let e = 0; e < n.length; e++)
                    l.push(n[e]), l.push(t[e]);
                let a = new Float32Array(l.length);
                return a.set(l), a;
            }
            throw Error('Only handles up to 2 channels');
        }(function (e) {
            let {numberOfChannels: n} = e, t = [];
            for (let l = 0; l < n; l++)
                t.push(e.getChannelData(l));
            return t;
        }(e)), l = new AudioData({
            format: 'f32',
            ...
            output: function (t) {
                ...
                let l = t.duration / 1000000 * e.sampleRate, i = new Uint8Array(t.byteLength);
                t.copyTo(i), n.push({
                    buffer: i,
                    numSamples: l
                });
    ...
    return i.configure({
        ...
        sampleRate: e.sampleRate,
        numberOfChannels: e.numberOfChannels
    }), i.encode(l), await i.flush(), new Blob([(0, u.Z)(n, {
...
async function h(e, n) {
    let t = function (e, n) {
        let {
                ...
                numberOfChannels: i,
                duration: r
            } = e, u = r * s.Z.Millis.SECOND, c = Math.min(l, u);
        if (0 === t && c === u)
            return e;
        let d = Math.floor(t / u * e.length), f = Math.floor(c / u * e.length), m = o.createBuffer(i, f - d, a);
        for (let n = 0; n < i; n++) {
            let t = m.getChannelData(n), l = e.getChannelData(n), a = 0;
            for (let e = d; e <= f; e++)
                t[a] = l[e], a++;
        }
        return m;

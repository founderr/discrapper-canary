var r = n(481060), i = n(570140), a = n(594190), o = n(199902), s = n(131951), l = n(924557), u = n(474639), c = n(435064), d = n(779618), _ = n(39604), E = n(356659), f = n(689938);
class h extends u.Z {
    showClipsToast() {
        (0, r.showToast)({
    ...
    applyNativeClipsSettings(e) {
        if (!(0, d.Z)(s.Z))
            return;
        let t = (0, l.ln)(), n = c.Z.getSettings(), r = (n.clipsEnabled || n.decoupledClipsEnabled) && t, i = s.Z.getMediaEngine();
    ...
    fireClipsInitEvent() {
        if (!(0, d.Z)(s.Z))
            return;
        let e = (0, l.ln)(), t = c.Z.getSettings();

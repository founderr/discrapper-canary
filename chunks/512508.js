...
function k(e) {
  ...
  })(a, o, m), [a, o, m]), b = c.useMemo(() => Object.keys(x), [x]), [T, L] = c.useState(""), [p, H] = c.useState(!1), [f, A] = c.useState(!1), [j, V] = c.useState(!1), U = c.useRef(null), {
    sections: k,
    sectionCounts: F
  } = c.useMemo(() => {

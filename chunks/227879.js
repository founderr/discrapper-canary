...
for (let e of this.dirtyNodes)
  e instanceof es && e.parentNode && e.updateNode();
...
[eT]: a,
...s
  } = r, o = (0, w.B3)((0, w.lq)(t, i)), l = (0, w.dG)(s, e);
...
}, x.createElement('tr', null, s.map((e, t) => x.cloneElement(n(e), {
  key: t
}))));
  }),
...
return x.createElement('tbody', {
  ...
  key: e
}, a.getDatesInWeek(e, s).map((e, t) => e ? x.cloneElement(n(e), {
  key: t
}) : x.createElement('td', {
  key: t
})))));
...
items: null
  ...
  let i = (0, Y.n_)(e);
  return x.createElement(x.Fragment, null, n, x.createElement(e4, {
state: i,
props: e,
listBoxRef: t
  }));
...
style: {
  ...
  }, t.renderEmptyState())), x.createElement(s.MT, null, x.createElement('div', {
...(0, w.zL)(t),
...
}, n, t),
{
  ...
  r && (E = {}, f = _.isFocused);
  let p = null;
  s && i && (p = i.useDraggableItem({
key: e.key
  }, s));
  let I = null;
  l && i && (I = i.useDroppableItem({
target: {
  type: 'item',
  key: e.key,
  dropPosition: 'on'
...
isDropTarget: s
  ...
  return a ? null : x.createElement(e8, {
...e,
dropIndicatorProps: i,
isDropTarget: s,
ref: t
...
offset: null !== (r = n.offset) && void 0 !== r ? r : 8
  }, e), l = n.popoverRef, u = eO(l, !!o), c = eA({
...n,
...
...i.style
  ...
  return x.createElement(I.aV, null, !n.isNonModal && x.createElement('div', {
...a,
style: {
  position: 'fixed',
  inset: 0
...
'data-exiting': t || void 0
  }, !n.isNonModal && x.createElement(I.U4, {
onDismiss: e.close
  }), x.createElement(e9.Provider, {
value: {
  arrowProps: s,
  placement: o
}
  }, c.children), x.createElement(I.U4, {
onDismiss: e.close
  })));
}
...
let r = (0, x.useContext)(to),
  ...
  l = eR(s, i.isOpen),
  u = o || l;
return i.isOpen || u ? x.createElement(tc, {
  ...e,
  state: i,
  isExiting: u,
  overlayRef: a,
...
l = {
  ...
  return x.createElement(I.aV, null, x.createElement('div', {
...(0, w.dG)((0, w.zL)(e), i),
...s,
style: l,
ref: e.overlayRef,
...
isDismissable: i,
state: a
  } = (0, x.useContext)(tl), s = (0, x.useMemo)(() => (0, w.lq)(e.modalRef, n), [
e.modalRef,
n
  ]), o = (0, w.B3)(s), l = eO(o), u = eA({
...e,
...
dragState: r,
dropState: i
  } = (0, x.useContext)(tI), l = (0, w.B3)(e.props.ref), {
rowProps: u,
gridCellProps: c,
descriptionProps: d,
...E
...
dragAndDropHooks: n,
dropState: r
  } = (0, x.useContext)(tI), i = (0, x.useRef)(null), {
dropIndicatorProps: a,
isHidden: s,
isDropTarget: o
  } = n.useDropIndicator(e, r, i);
  return s ? null : x.createElement(tg, {
...e,
dropIndicatorProps: a,
isDropTarget: o,
buttonRef: i,
...
dragAndDropHooks: e,
dropState: t
  } = (0, x.useContext)(tI), n = (0, x.useRef)(null), {
...
let {
  portal: a,
  collection: l
} = eE(e, (0, x.useMemo)(() => new tF(), [])), u = (0, ee.oy)({
  ...e,
  collection: l,
  children: void 0
}), {
  ...
  dragAndDropHooks: d
} = e, _ = u.selectionManager, E = !!(null == d ? void 0 : d.useDraggableCollectionState), f = !!(null == d ? void 0 : d.useDroppableCollectionState), h = (0, x.useRef)(E), I = (0, x.useRef)(f);
...
}, x.createElement(s.MT, null, x.createElement('table', {
  ...(0, w.zL)(e),
  ...v,
...
dragAndDropHooks: n,
dropState: r
  } = (0, x.useContext)(tH), i = (0, x.useRef)(null), {
dropIndicatorProps: a,
isHidden: s,
isDropTarget: o
  } = n.useDropIndicator(e, r, i);
  return s ? null : x.createElement(t3, {
...e,
dropIndicatorProps: a,
isDropTarget: o,
buttonRef: i,
...
dragAndDropHooks: t,
dropState: n
  } = (0, x.useContext)(tH), r = (0, x.useRef)(null), {
dropIndicatorProps: i
  } = t.useDropIndicator({
target: {
  type: 'root'
...
values: {
  ...
  return delete I.id, x.createElement('div', {
...(0, o.dG)(I, i, d, f, p),
ref: r,
...
triggerRef: n,
tooltipProps: r
  } = (0, x.useContext)(ne), i = (0, x.useRef)(null), {
overlayProps: a,
arrowProps: s,
placement: l
  } = (0, I.tN)({

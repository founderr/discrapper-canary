...
class E extends(r = l.PureComponent) {
  renderUsers() {
    let {
      ...
      renderMoreUsers: r
    } = this.props, i = [], l = e.length === n ? e.length : n - 1, o = 0;
    for (; o < l && o < e.length;) {
      let n = o === e.length - 1;
  ...
  constructor(...e) {
    super(...e), f(this, "_ref", void 0), f(this, "defaultRenderUser", (e, n, t, r) => {
      let {
        onClick: l,
        size: o,
        guildId: f
      } = this.props, E = e instanceof a.Z ? e : null != e ? e.user : null;
      return null == E ? (0, i.jsx)("div", {
        className: u()(c.emptyUser, n)
      }, t) : (0, i.jsx)(s.Avatar, {
        tabIndex: 0,
        src: E.getAvatarURL(f, (0, s.getAvatarSize)(o)),
        size: o,

...
function O(e) {
  ...
  } = e, [r, c] = i.useState(""), [o, d] = i.useState(null), [u, m] = i.useState(null), [x, h] = i.useState(!1), [j, v] = i.useState(!1), y = i.useCallback(e => {
    let {
      value: t
    } = e;
    null != l.current && (l.current.playstyle = t, m(t), s(6))
  }, [l, m, s]), k = i.useCallback(() => {
    if (null != l.current) {
      let e = !x;
      h(e), l.current.acknowledgeCap = e, e && j && s(8)
    }
  }, [j, x, h, l, s]), C = i.useCallback(() => {
    if (null != l.current) {
      let e = !j;
      v(e), l.current.acknowledgeScreen = e, e && x && s(8)
    }
  }, [x, j, v, l, s]), S = i.useCallback(e => {
  ...
  return null == t ? null : "email" === t.type ? (0, n.jsxs)("div", {
    ...
    children: [(0, n.jsxs)("div", {
      ...
      children: [(0, n.jsxs)("div", {
        ...
        className: b.options,
        children: (0, N.getClanOptions)(E.default).map(e => (0, n.jsx)(M, {
          option: e,
...
function M(e) {
  let {
    ...
    isSelected: l,
    onOptionSelected: s
  } = e, [r, o] = i.useState(!1), d = (0, p.useToken)(p.tokens.colors.BACKGROUND_TERTIARY), u = d.hsl({
    opacity: r && !l ? .9 : .8
  }), m = i.useCallback(() => {
    s(t)
  }, [s, t]);
  return (0, n.jsxs)(p.Clickable, {
    className: c(b.option, {
      [b.selectedOption]: l
    }),
    onMouseEnter: () => o(!0),
    onMouseLeave: () => o(!1),
...
function G(e) {
  let {
    ...
    data: s
  } = e, r = (0, h.useStateFromStores)([j.default], () => j.default.useReducedMotion), [{
    state: c
  }, o] = (0, u.useSpring)(() => ({
    state: 0
  }), []), m = (0, h.useStateFromStores)([v.default], () => v.default.getCurrentUser()), x = c.to({
    range: [0, 1],
    output: [1, 0]
  }), y = c.to({
    range: [0, 1],
  ...
  return null == m ? null : (0, n.jsxs)(n.Fragment, {
    children: [(0, n.jsxs)(u.animated.div, {
      ...
      children: [(0, n.jsx)(p.Text, {
        ...
        })(t.options, m.id).map(e => (0, n.jsx)(P, {
          option: e,
          selectedOption: a,
          setSelectedOption: C
        }, e.key))
...
function U(e) {
  let {
    ...
    transitionState: l,
    onClose: s
  } = e, r = (0, y.useUID)(), o = i.useRef({
    guildId: a
  }), [d, u] = i.useState(null), m = (0, h.useStateFromStores)([g.default], () => g.default.hasCompletedTarget(t.key)), x = m ? 1 : 0;
  i.useEffect(() => {

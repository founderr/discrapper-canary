...
function er(e) {
  let {
    ...
    return [e, e.version]
  }), u = (0, h.useStateFromStores)([L.default], () => L.default.lurkingGuildIds()), f = a.useMemo(() => n ? [] : u, [u, n]), p = (0, h.useStateFromStoresArray)([M.default, O.default], () => b.default.keys(M.default.getGuilds()).filter(e => O.default.isCurrentUserGuest(e))), g = f.concat(p), E = (0, h.useStateFromStores)([S.default], () => S.default.isFullscreenInContext()), et = (0, h.useStateFromStores)([M.default], () => M.default.getGeoRestrictedGuilds()), [en, el] = a.useState(!1), ea = a.useCallback(() => el(!0), []), es = a.useCallback(() => el(!1), []), er = a.useRef(!1), [eo] = a.useState(() => new C.Timeout), eu = a.useRef(null), ed = a.useRef(null), {
    ref: ec,
    ...ef
    ...
    pathname: eE
  } = (0, d.useLocation)(), e_ = eE.startsWith(J.Routes.GUILD_DISCOVERY), eI = eE.startsWith(J.Routes.GUILD_MEMBER_VERIFICATION_FOR_HUB(""));
  a.useLayoutEffect(() => {
    if (!er.current) {
      if (0 !== o.size) {
        if (e_) em.scrollToGuild(null, !1);
        else {
          let {
            scrollTop: e
      ...
      children: (0, l.jsxs)("ul", {
        ...
        children: [(0, l.jsx)(P.default, {
          ...
          children: [(0, l.jsx)(Y.HomeButton, {}), eT ? (0, l.jsx)(T.default, {}) : null, (0, l.jsx)(B.default, {}), (0, l.jsx)(K.default, {
            ...
            guildId: e
          }, e)), (0, l.jsx)(Q.default, {}), !n && eS ? (0, l.jsx)(k.default, {

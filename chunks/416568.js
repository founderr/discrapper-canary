...
pathname: eO
  } = (0, u.TH)(), ey = eO.startsWith(ee.Z5c.GUILD_DISCOVERY) || eO.startsWith(ee.Z5c.GLOBAL_DISCOVERY), eP = eO.startsWith(ee.Z5c.GUILD_MEMBER_VERIFICATION_FOR_HUB(''));
  l.useLayoutEffect(() => {
if (!ec.current) {
  if (0 !== o.size) {
    if (ey)

...
var t = a(735250), s = a(470079), r = a(120356), l = a.n(r), i = a(512722), o = a.n(i), c = a(442837), u = a(481060), d = a(911969), _ = a(100527), I = a(906732), E = a(509545), T = a(259580), A = a(63063), N = a(74538), P = a(937615), M = a(374649), p = a(591548), R = a(639119), L = a(653798), f = a(585602), C = a(474936), m = a(981631), S = a(689938), b = a(187912);
let v = (e, n) => {
        var a;
...
function h(e) {
    ...
    let M = function (e, n, a, t) {
        ...
        case C.Xh.PREMIUM_MONTH_GUILD:
            return S.Z.Messages.PREMIUM_GUILD_NUM_MONTH_GUILD_SUBSCRIPTIONS.format({ num: e.quantity });
        case C.Xh.PREMIUM_YEAR_GUILD:
            return S.Z.Messages.PREMIUM_GUILD_NUM_YEAR_GUILD_SUBSCRIPTIONS.format({ num: e.quantity });
        }
        switch (n.interval) {
        case C.rV.MONTH:
            if (1 === n.intervalCount)
                return S.Z.Messages.MONTHLY_GUILD_SUBSCRIPTION.format({ planName: n.name });
            return S.Z.Messages.MULTI_MONTHS_GUILD_SUBSCRIPTION.format({
                planName: n.name,
                intervalCount: n.intervalCount
            });
        case C.rV.YEAR:
            return S.Z.Messages.YEARLY_GUILD_SUBSCRIPTION.format({ planName: n.name });
        }
    ...
    let p = (0, P.T4)(null != s ? s : a.amount, l), f = _ ? p : (0, P.og)(p, T.interval, T.intervalCount);
    return (0, t.jsx)(L.i$, {
        label: M,
        value: f,
...
function y(e) {
    ...
    let c = l.find(e => !(0, N.Z8)(e.subscriptionPlanId) && e.amount < 0), u = l.find(e => null == e.subscriptionPlanId && null != e.discounts && e.discounts.find(e => e.type === d.eW.PREMIUM_LEGACY_UPGRADE_PROMOTION)), _ = v(i, d.eW.PREMIUM_TRIAL), I = g(i, d.eW.SUBSCRIPTION_PLAN), E = i.quantity * I, T = i.amount + (null != c ? c.amount : 0) - E + (null != u ? u.amount : 0), A = l.filter(e => e.subscriptionPlanId === C.Xh.PREMIUM_MONTH_GUILD || e.subscriptionPlanId === C.Xh.PREMIUM_YEAR_GUILD).reduce((e, n) => e + n.amount, 0);
    return (0, t.jsxs)(t.Fragment, {
        children: [
            (0, t.jsx)(h, {
                invoiceItem: i,
            ...
            0 === T || _ ? null : (0, t.jsx)(L.R$, {
                label: (0, t.jsx)(O, {
                    label: S.Z.Messages.PREMIUM_SUBSCRIPTION_PLAN_ADJUSTMENT.format({ planName: (0, N.PV)(a.id) ? (0, N.aq)(a.id) : a.name }),
...
function x(e) {
    let n = e.slice();
    return n.sort((e, n) => {
        let a = (0, N.uZ)(e.subscriptionPlanId), t = (0, N.uZ)(n.subscriptionPlanId);
...
function Z(e) {
    ...
    return s !== l || r !== i || n.subscriptionPeriodEnd.getTime() === a.subscriptionPeriodStart.getTime() ? null : (0, t.jsx)('div', {
        ...
        children: S.Z.Messages.PREMIUM_SUBSCRIPTION_PERIOD_RESET_NOTICE.format({ renewalDate: n.subscriptionPeriodEnd })
    });
}
function D(e) {
    let {
    ...
    return (0, t.jsxs)(t.Fragment, {
        children: [
            (0, t.jsx)(L.KU, { extended: !0 }),
            null != a ? (0, t.jsxs)(t.Fragment, {
                children: [
                    (0, t.jsx)(L.q9, { children: S.Z.Messages.PREMIUM_SUBSCRIPTION_CURRENT_LABEL }),
                    B(x((0, p.j)(a.invoiceItems))).map(e => (0, t.jsx)(h, {
                        invoiceItem: e,
                        currency: a.currency
                    }, e.id)),
                    (0, t.jsx)(L.KU, { extended: !0 })
            ...
            (0, t.jsx)(L.q9, { children: S.Z.Messages.PREMIUM_SUBSCRIPTION_NEW_LABEL }),
            B(x((0, p.j)(s.invoiceItems))).map(e => {
                ...
                return (0, t.jsx)(h, {
                    ...
                    className: l()({ [b.subscriptionAddedInvoiceItem]: !n || a })
                }, e.id);
            }),
            (0, t.jsx)(f.Z, { invoice: s }),
            (0, t.jsx)(L.KU, {}),
            (0, t.jsx)(L.R$, {
...
function Y(e) {
    let {
            ...
            hasAnnualInvoicePreview: N = !1
        } = e, {analyticsLocations: P} = (0, I.ZP)(), p = {
            ...
            ...c
        }, [R] = (0, M.ED)(p), [f, C] = s.useState(!1);
    return (0, t.jsxs)(t.Fragment, {
        children: [
            d || N ? null : (0, t.jsx)(L.HE, {
                children: (0, t.jsx)(G, {
                    proratedInvoice: a,
                    renewalInvoice: r,
                    isTrial: o,
            ...
            !A && (0, t.jsxs)(t.Fragment, {
                children: [
                    (0, t.jsxs)(u.Clickable, {
                        ...
                        children: [
                            f ? S.Z.Messages.PREMIUM_SUBSCRIPTION_HIDE_DETAILS : S.Z.Messages.PREMIUM_SUBSCRIPTION_SHOW_DETAILS,
                            (0, t.jsx)(T.Z, {
                                direction: f ? T.Z.Directions.UP : T.Z.Directions.DOWN,
...
function j(e) {
    let n, {
            ...
            taxInclusive: c,
            currency: d
        } = i, _ = i.total, I = _ - o, E = (0, P.T4)(I, d), T = (0, P.T4)(_, d);
    return n = l ? (0, N.L7)(a.interval, !0, void 0, void 0, !0, (0, N.Rd)(a.id)) : S.Z.Messages.BILLING_INVOICE_GIFT_PLAN.format({ planName: (0, N.Gf)(a.id, !1, r) }), (0, t.jsxs)('div', {
        className: s,
        children: [
            (0, t.jsx)(u.FormTitle, { children: S.Z.Messages.PREMIUM_GIFTING_BUTTON }),
            o >= 0 && !1 === c ? (0, t.jsxs)(t.Fragment, {
                children: [
                    ...
                    (0, t.jsxs)(L.PO, {
                        className: s,
                        children: [
                            (0, t.jsx)(L.q9, { children: S.Z.Messages.ONE_TIME_PURCHASE_REVIEW_STEP_PURCHASE_DETAILS_LABEL }),
                            (0, t.jsx)(L.R$, {
                                label: n,
                                value: E
                            }),
                            (0, t.jsx)(f.Z, { invoice: i }),
                            (0, t.jsx)(L.KU, {}),
                            (0, t.jsx)(L.R$, {
...
function k(e) {
    let n, {
            invoice: a,
            plan: s
        } = e, r = (0, p.j)(a.invoiceItems).find(e => e.subscriptionPlanId === s.id);
    return o()(null != r, 'newPlanInvoiceItem can not be null'), s.interval === C.rV.MONTH ? n = a.taxInclusive ? S.Z.Messages.BILLING_TRIAL_MONTHLY_PRICE_AFTER_TRIAL : S.Z.Messages.BILLING_TRIAL_MONTHLY_PRICE_AFTER_TRIAL_TAX_EXCLUSIVE : s.interval === C.rV.YEAR ? n = a.taxInclusive ? S.Z.Messages.BILLING_TRIAL_YEARLY_PRICE_AFTER_TRIAL : S.Z.Messages.BILLING_TRIAL_YEARLY_PRICE_AFTER_TRIAL_TAX_EXCLUSIVE : o()(!1, 'Invalid interval type'), (0, t.jsx)(u.Text, {
        variant: 'text-md/normal',
        children: n.format({ price: (0, P.T4)(r.subscriptionPlanPrice, a.currency) })
    });
}

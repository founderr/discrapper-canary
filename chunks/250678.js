!function e(t, n, r) {
    ...
    2: [
        function (e, t, n) {
            Object.defineProperty(n, '__esModule', { value: !0 }), n.adapterFactory = function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = e.window, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {
                        shimChrome: !0,
                        shimFirefox: !0,
                        shimEdge: !0,
                        shimSafari: !0
                    }, u = r.log, c = r.detectBrowser(t), d = {
                        browserDetails: c,
                        commonShim: l,
                ...
                case 'firefox':
                    ...
                    u('adapter.js shimming firefox.'), d.browserShim = o, o.shimGetUserMedia(t), o.shimPeerConnection(t), o.shimOnTrack(t), o.shimRemoveStream(t), o.shimSenderGetStats(t), o.shimReceiverGetStats(t), o.shimRTCDataChannel(t), o.shimAddTransceiver(t), o.shimCreateOffer(t), o.shimCreateAnswer(t), l.shimRTCIceCandidate(t), l.shimConnectionState(t), l.shimMaxMessageSize(t), l.shimSendThrowTypeError(t);
                    break;
                case 'edge':
            ...
            var r = u(e('./utils')), i = u(e('./chrome/chrome_shim')), a = u(e('./edge/edge_shim')), o = u(e('./firefox/firefox_shim')), s = u(e('./safari/safari_shim')), l = u(e('./common_shim'));
            function u(e) {
                if (e && e.__esModule)
                    return e;
                var t = {};
    ...
    3: [
        function (e, t, n) {
            ...
            Object.defineProperty(n, 'shimGetDisplayMedia', {
                ...
                if (!!e.RTCPeerConnection) {
                    ...
                    e.RTCPeerConnection.prototype.getStats = function () {
                        var e = this, n = Array.prototype.slice.call(arguments), r = n[0], i = n[1], a = n[2];
                ...
                if (!!('getStats' in e.RTCRtpSender.prototype && 'getStats' in e.RTCRtpReceiver.prototype)) {
                    ...
                    e.RTCPeerConnection.prototype.getStats = function () {
                        if (arguments.length > 0 && arguments[0] instanceof e.MediaStreamTrack) {
                            var t = arguments[0], n = void 0, r = void 0, i = void 0;
            ...
            }, n.shimAddTrackRemoveTrackWithNative = l, n.shimAddTrackRemoveTrack = function (e) {
                if (!!e.RTCPeerConnection) {
                    ...
                    e.RTCPeerConnection.prototype.removeStream = function (e) {
                        ...
                        if (a)
                            a.addTrack(t), Promise.resolve().then(function () {
                    ...
                    [
                        ...
                        var n = e.RTCPeerConnection.prototype[t], r = s({}, t, function () {
                                var e = this, t = arguments, r = arguments.length && 'function' == typeof arguments[0];
                    ...
                    e.RTCPeerConnection.prototype.setLocalDescription = function () {
                        ...
                        if (!arguments.length || !arguments[0].type)
                            return a.apply(this, arguments);
                        return arguments[0] = (e = this, t = arguments[0], n = t.sdp, Object.keys(e._reverseStreams || []).forEach(function (t) {
    ...
    4: [
        function (e, t, n) {
            Object.defineProperty(n, '__esModule', { value: !0 }), n.shimGetDisplayMedia = function (e, t) {
                if ((!e.navigator.mediaDevices || !('getDisplayMedia' in e.navigator.mediaDevices)) && !!e.navigator.mediaDevices) {
                    ...
                    e.navigator.mediaDevices.getDisplayMedia = function (n) {
                        return t(n).then(function (t) {
                            var r = n.video && n.video.width, i = n.video && n.video.height, a = n.video && n.video.frameRate;
                            return n.video = {
                                mandatory: {
    ...
    5: [
        function (e, t, n) {
            ...
            n.shimGetUserMedia = function (e) {
                var t = e && e.navigator;
                if (!!t.mediaDevices) {
                    var n = i.detectBrowser(e), o = function (e) {
                            ...
                            if (e && 'object' === r(e.video)) {
                                ...
                                if (l && ('user' === l.exact || 'environment' === l.exact || 'user' === l.ideal || 'environment' === l.ideal) && !(t.mediaDevices.getSupportedConstraints && t.mediaDevices.getSupportedConstraints().facingMode && !u)) {
                                    ...
                                    var c = void 0;
                                    if ('environment' === l.exact || 'environment' === l.ideal ? c = [
                                            'back',
                                            'rear'
                                        ] : ('user' === l.exact || 'user' === l.ideal) && (c = ['front']), c)
                                        return t.mediaDevices.enumerateDevices().then(function (t) {
                                            ...
                                            return !n && t.length && c.includes('back') && (n = t[t.length - 1]), n && (e.video.deviceId = l.exact ? { exact: n.deviceId } : { ideal: n.deviceId }), e.video = o(e.video), a('chrome: ' + JSON.stringify(e)), i(e);
                                        });
                                }
                                e.video = o(e.video);
                            }
                ...
                if (!!e.RTCPeerConnection) {
                    ...
                    e.RTCPeerConnection.prototype.setRemoteDescription = function () {
                        if (this._sctp = null, 'chrome' === t.browser && t.version >= 76 && 'plan-b' === this.getConfiguration().sdpSemantics && Object.defineProperty(this, 'sctp', {
                            ...
                            var e = r(arguments[0]), i = o(e), a = s(arguments[0], e), u = void 0;
                            u = 0 === i && 0 === a ? Number.POSITIVE_INFINITY : 0 === i || 0 === a ? Math.max(i, a) : Math.min(i, a);
                            var c = {};
        ...
        function (e, t, n) {
            ...
            Object.defineProperty(n, 'shimGetDisplayMedia', {
                ...
                if ((void 0 === e ? 'undefined' : r(e)) === 'object' && !!(e.RTCPeerConnection || e.mozRTCPeerConnection)) {
                    if (!e.RTCPeerConnection && e.mozRTCPeerConnection && (e.RTCPeerConnection = e.mozRTCPeerConnection), t.version < 53 && [
                            'setLocalDescription',
                            'setRemoteDescription',
                            'addIceCandidate'
                        ].forEach(function (t) {
                    ...
                    e.RTCPeerConnection.prototype.getStats = function () {
                        var e = Array.prototype.slice.call(arguments), n = e[0], r = e[1], o = e[2];
                ...
                if (!!((void 0 === e ? 'undefined' : r(e)) === 'object' && e.RTCPeerConnection)) {
                    ...
                    t && (e.RTCPeerConnection.prototype.addTransceiver = function () {
                        ...
                        var r = t.apply(this, arguments);
                        if (n) {
                            var i = r.sender, a = i.getParameters();
    ...
    9: [
        function (e, t, n) {
            ...
            n.shimGetUserMedia = function (e) {
                var t = i.detectBrowser(e), n = e && e.navigator, a = e && e.MediaStreamTrack;
                if (n.getUserMedia = function (e, t, r) {
                    ...
                    if (a && a.prototype.applyConstraints) {
                        ...
                        a.prototype.applyConstraints = function (e) {
                            return 'audio' === this.kind && (void 0 === e ? 'undefined' : r(e)) === 'object' && (o(e = JSON.parse(JSON.stringify(e)), 'autoGainControl', 'mozAutoGainControl'), o(e, 'noiseSuppression', 'mozNoiseSuppression')), u.apply(this, [e]);
                        };
                    }
                }
            };
    ...
    10: [
        function (e, t, n) {
            ...
            n.shimLocalStreamsAPI = function (e) {
                if ((void 0 === e ? 'undefined' : r(e)) === 'object' && !!e.RTCPeerConnection) {
                    if (!('getLocalStreams' in e.RTCPeerConnection.prototype) && (e.RTCPeerConnection.prototype.getLocalStreams = function () {
                        ...
                        e.RTCPeerConnection.prototype.addStream = function (e) {
                            ...
                            for (var n = this, r = arguments.length, i = Array(r > 1 ? r - 1 : 0), a = 1; a < r; a++)
                                i[a - 1] = arguments[a];
                ...
                if ((void 0 === e ? 'undefined' : r(e)) === 'object' && !!e.RTCPeerConnection) {
                    if (!('getRemoteStreams' in e.RTCPeerConnection.prototype) && (e.RTCPeerConnection.prototype.getRemoteStreams = function () {
                ...
                if ((void 0 === e ? 'undefined' : r(e)) === 'object' && !!e.RTCPeerConnection) {
                    var t = e.RTCPeerConnection.prototype, n = t.createOffer, i = t.createAnswer, a = t.setLocalDescription, o = t.setRemoteDescription, s = t.addIceCandidate;
                    t.createOffer = function (e, t) {
                        var r = arguments.length >= 2 ? arguments[2] : arguments[0], i = n.apply(this, [r]);
                        return t ? (i.then(e, t), Promise.resolve()) : i;
                    }, t.createAnswer = function (e, t) {
                        var n = arguments.length >= 2 ? arguments[2] : arguments[0], r = i.apply(this, [n]);
                ...
                if (t.mediaDevices && t.mediaDevices.getUserMedia) {
                    var n = t.mediaDevices, r = n.getUserMedia.bind(n);
                    t.mediaDevices.getUserMedia = function (e) {
                        return r(a(e));
                    };
                }
    ...
    11: [
        function (e, t, n) {
            ...
            n.extractVersion = o, n.wrapPeerConnectionEvent = function (e, t, n) {
                if (!!e.RTCPeerConnection) {
                    ...
                    r.addEventListener = function (e, r) {
                        ...
                        return this._eventMap = this._eventMap || {}, this._eventMap[r] = a, i.apply(this, [
                            e,
                            a
                        ]);
                    };
                    ...
                    r.removeEventListener = function (e, n) {
                        ...
                        return delete this._eventMap[n], a.apply(this, [
                            e,
                            r
                        ]);
                ...
                if (('undefined' == typeof window ? 'undefined' : r(window)) === 'object') {
                    if (!i)
                ...
                return s(t) ? Object.keys(t).reduce(function (n, r) {
                    var i, a, o, l = s(t[r]), u = l ? e(t[r]) : t[r], c = l && !Object.keys(u).length;
                    if (void 0 === u || c)
                        return n;
                    return Object.assign(n, (i = {}, a = r, o = u, a in i ? Object.defineProperty(i, a, {
                        value: o,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            }, n.walkStats = l, n.filterStats = function (e, t, n) {
            ...
            function l(e, t, n) {
                if (!(!t || n.has(t.id)))
                    n.set(t.id, t), Object.keys(t).forEach(function (r) {
        ...
        function (e, t, n) {
            ...
            r.generateIdentifier = function () {
                ...
                for (var t = {
                    ...
                    if (o) {
                        var s = r.parseRtpMap(o), l = r.matchPrefix(e, 'a=fmtp:' + a + ' ');
                ...
                var t, n = [], i = r.parseRtpParameters(e), a = -1 !== i.fecMechanisms.indexOf('RED'), o = -1 !== i.fecMechanisms.indexOf('ULPFEC'), s = r.matchPrefix(e, 'a=ssrc:').map(function (e) {
                        return r.parseSsrcMedia(e);
                    }).filter(function (e) {
                        return 'cname' === e.attribute;
                    }), l = s.length > 0 && s[0].ssrc, u = r.matchPrefix(e, 'a=ssrc-group:FID').map(function (e) {
                ...
                u.length > 0 && u[0].length > 1 && u[0][0] === l && (t = u[0][1]), i.codecs.forEach(function (e) {
                    if ('RTX' === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        l && t && (r.rtx = { ssrc: t }), n.push(r), a && ((r = JSON.parse(JSON.stringify(r))).fec = {
                            ssrc: l,
                ...
                return c.length && (c = 0 === c[0].indexOf('b=TIAS:') ? parseInt(c[0].substr(7), 10) : 0 === c[0].indexOf('b=AS:') ? 950 * parseInt(c[0].substr(5), 10) - 16000 : void 0, n.forEach(function (e) {
                    e.maxBitrate = c;
                })), n;

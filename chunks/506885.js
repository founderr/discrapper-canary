...
async function d(e, t) {
  ...
  let C = o.default.getUserProfile(e),
    ...
    R = T ? c.default : void 0,
    g = !1;
  if (null != p) {
    let t = o.default.getGuildMemberProfile(e, p);
    g = null == t
  }!(!A && !g && (L || Date.now() - (null !== (f = null == C ? void 0 : C.lastFetched) && void 0 !== f ? f : 0) < 6e4)) && (N ? await r.default.wait(() => (0, i.fetchProfile)(e, {
    withMutualGuilds: _,
    withMutualFriendsCount: E,
    friendToken: S,
    guildId: p,
    connectionsRoleId: I
  }, R)) : await (0, i.fetchProfile)(e, {
    withMutualGuilds: _,
    withMutualFriendsCount: E,
    friendToken: S,
    guildId: p,

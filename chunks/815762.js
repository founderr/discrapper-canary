...
var N = e => {
  let {
    location: t
  } = e, n = (0, l.useStateFromStores)([E.default], () => E.default.isAuthenticated()), N = (0, l.useStateFromStores)([_.default], () => _.default.hasLoadedExperiments), m = (0, c.useIsUnauthenticatedReportFormEnabled)("RSL - Landing Page"), [A, g] = a.useState(!1), [S, v] = a.useState(p.default.Messages.AUTHORIZING), [O, C] = a.useState(!0), R = e => {
    switch (e) {

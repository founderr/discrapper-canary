...
e.exports = d, d.prototype.keyPair = function(e) {
  ...
  for (var s = this.n.byteLength(), a = t.getPrivate().toArray("be", s), c = e.toArray("be", s), u = new i({
    ...
    if (0 !== g.cmpn(0)) {
      ...
      if (0 !== (b = b.umod(this.n)).cmpn(0)) {
        ...
        return o.canonical && b.cmp(this.nh) > 0 && (b = this.n.sub(b), m ^= 1), new l({
          r: g,
          s: b,
          recoveryParam: m
        })
  ...
  var o, s = (t = new l(t, "hex")).r,
    a = t.s;
  if (0 > s.cmpn(1) || s.cmp(this.n) >= 0 || 0 > a.cmpn(1) || a.cmp(this.n) >= 0) return !1;
  var c = a.invm(this.n),
    u = c.mul(e).umod(this.n),
    d = c.mul(s).umod(this.n);
  if (!this.curve._maxwellTrick) return !(o = this.g.mulAdd(u, n.getPublic(), d)).isInfinity() && 0 === o.getX().umod(this.n).cmp(s);
  return !(o = this.g.jmulAdd(u, n.getPublic(), d)).isInfinity() && o.eqXToP(s)
}, d.prototype.recoverPubKey = function(e, t, n, i) {
  c((3 & n) === n, "The recovery param is more than two bits"), t = new l(t, i);
  var o = this.n,
    s = new r(e),
    a = t.r,
    u = t.s,

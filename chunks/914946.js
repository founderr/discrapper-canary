...
let x = null !== (i = s.parse(window.GLOBAL_ENV.API_ENDPOINT, !1, !0).host) && void 0 !== i ? i : "localhost",
  ...
  b = new RegExp("^".concat(Z.Z.escape("https://"), "(?:[a-z]+\\.)?(").concat(Z.Z.escape(P), "|discordapp.com|discord.com)$")),
...
function G(e, t) {
  let n = [],
    i = e.getGuildId();
  return ![R.d4z.GUILD_CATEGORY, ...h.tx].includes(e.type) && n.push(new Promise(t => {
...
function B(e, t, n) {
  ...
  return {
    ...
    presence: {
      ...
      activity: null != n ? C.Z.getApplicationActivity(t, n) : C.Z.getPrimaryActivity(t)
    }
  }
}
...
function J(e) {
  if (e !== O.He.POST_MESSAGE) throw new L.Z({

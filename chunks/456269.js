...
function K(e, t, n) {
  ...
  u.useEffect(() => {
    ...
    let u = x.default.getThreadIds(e.id, t, n),
      r = L.default.getThreadIdsMissingCounts(e.guild_id, u).filter(e => (0, j.canDisplayPostUnreadMessageCount)(e, [A.default])).slice(0, 180).map(e => ({
        threadId: e,
...
function $(e) {
  ...
  let n = (0, i.useStateFromStores)([N.default], () => N.default.getUser(e.ownerId)),
    l = (0, i.useStateFromStores)([P.default], () => {
      var t;
      return null === (t = P.default.getMessage(e.id)) || void 0 === t ? void 0 : t.firstMessage
    }),

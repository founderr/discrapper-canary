...
function V(e, t, u) {
  ...
  n.useEffect(() => {
    ...
    let n = U.default.getThreadIds(e.id, t, u),
      r = D.default.getThreadIdsMissingCounts(e.guild_id, n).filter(e => (0, L.canDisplayPostUnreadMessageCount)(e, [M.default])).slice(0, 180).map(e => ({
        threadId: e,
...
function Z(e) {
  let t = (0, i.useStateFromStores)([h.default], () => {
    ...
    n = (0, i.useStateFromStores)([M.default], () => (0, L.canDisplayPostUnreadMessageCount)(e.id, [M.default])),
...
function et(e) {
  return (0, i.useStateFromStoresArray)([I.default, N.default, p.default], () => {
    let t = N.default.getCurrentUser();
    return r()(I.default.getTypingUsers(e.id)).keys().filter(e => e !== (null == t ? void 0 : t.id)).reject(e => p.default.isBlocked(e)).map(e => N.default.getUser(e)).filter(O.isNotNullish).map(e => e.id).value()
  })
}
...
function en(e) {
  return (0, i.useStateFromStores)([F.default], () => F.default.can(k.Permissions.MANAGE_CHANNELS, e))
}
let el = {
  isNew: !1,
  hasUnreads: !1
...
function er(e) {
  return (0, i.useStateFromStoresObject)([C.default, M.default], () => {
    var t;
    let u = C.default.getGuild(null !== (t = e.getGuildId()) && void 0 !== t ? t : k.EMPTY_STRING_SNOWFLAKE_ID);
    return null == u ? el : (0, L.getForumPostReadStates)(e, u, [M.default])
  })
}
...
function ei(e) {
  let t = (0, i.useStateFromStores)([F.default], () => F.default.can(k.Permissions.MANAGE_THREADS, e));
  return n.useMemo(() => {
    var u;
...
function eo(e, t) {
  let u = ei((0, i.useStateFromStores)([v.default], () => v.default.getChannel(null == e ? void 0 : e.parent_id), [e]));
  return n.useMemo(() => t.filter(e => u.includes(e)), [t, u])
}

function ed(e) {
  return (0, i.useStateFromStores)([F.default], () => F.default.can(k.Permissions.READ_MESSAGE_HISTORY, e))
}
...
function ef(e) {
  ...
  return (0, i.useStateFromStoresObject)([w.default], () => ({
    isSearchLoading: w.default.getSearchLoading(t),
    searchQuery: w.default.getSearchQuery(t),
    searchResults: w.default.getSearchResults(t)
  }))
}
...
function em(e, t) {
  return (0, i.useStateFromStores)([S.default, M.default, v.default], () => {
    let u = v.default.getChannel(t);
    ...
    for (let e in n) {
      let t = n[e],
        u = M.default.lastMessageId(t.channel.id);
      null != u && u > r && a++
    }
    for (let e in l) {
      let t = l[e],
        u = M.default.lastMessageId(t.id);
      null != u && u > r && a++
    }
    return a
  })
...
function eg(e) {
  ...
  } = e, a = (0, i.useStateFromStoresArray)([U.default], () => U.default.getThreadIds(t.id, u, l)), o = em(t.guild_id, t.id), s = (0, i.useStateFromStores)([U.default], () => r && (o > 0 || U.default.getCanAckThreads()), [r, o]);
  return n.useEffect(() => {
    s && (0, d.ackChannel)(t)
  }, [t, s]), a
}
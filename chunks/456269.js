...
var u = t(470079), l = t(392711), r = t.n(l), i = t(683860), o = t(442837), a = t(570140), d = t(45114), c = t(339085), s = t(987170), f = t(905405), g = t(937889), m = t(739566), Z = t(601070), E = t(344185), v = t(723774), h = t(144140), T = t(91159), _ = t(592125), S = t(720202), I = t(430824), M = t(496675), p = t(306680), C = t(699516), N = t(111583), O = t(594174), A = t(823379), P = t(709054), R = t(883429), w = t(238349), b = t(368844), U = t(660189), y = t(581036), L = t(208970), k = t(882252), j = t(710352), D = t(981631), F = t(176505), G = t(124368);
let Y = (0, s.Z)({
...
function H(e) {
    return function (e) {
        ...
        return Y.useExperiment({
            guildId: e,
            location: '553713_1'
        }, { autoTrackExposure: !1 }).enabled || !!((null == n ? void 0 : n.hasFeature(D.oNc.COMMUNITY)) || (null == n ? void 0 : n.hasFeature(D.oNc.INTERNAL_EMPLOYEE_ONLY)));
    }(e);
}
function W(e, n, t) {
    ...
    u.useEffect(() => {
        if (!l)
            return;
        let u = w.Z.getThreadIds(e.id, n, t), r = y.Z.getThreadIdsMissingCounts(e.guild_id, u).filter(e => (0, k.nU)(e, [p.ZP])).slice(0, 180).map(e => ({
                threadId: e,
                ackMessageId: p.ZP.getTrackedAckMessageId(e)
            }));
        r.length > 0 && a.Z.dispatch({
...
function V(e, n) {
    let t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : j.R6.DURATION_AGO, l = u.useMemo(() => P.default.extractTimestamp(e.id), [e.id]), r = (0, T.Ok)(e), o = u.useMemo(() => (0, k.Uw)(n, t), [
            n,
            t
        ]);
    return u.useMemo(() => n === i.z.CREATION_DATE ? (0, T.Ye)(l, o) : (0, T.Ye)(r, o), [
        r,
        n,
        l,
        o
...
function X(e) {
    let n = null == e ? void 0 : e.defaultReactionEmoji, t = (0, o.e7)([c.Z], () => (null == n ? void 0 : n.emojiId) != null ? c.Z.getUsableCustomEmojiById(n.emojiId) : null);
...
function K(e) {
    let n = (0, o.e7)([h.Z], () => {
        ...
        }), t = (0, v.lE)(n, e.id), u = (0, o.e7)([p.ZP], () => (0, k.nU)(e.id, [p.ZP])), l = (0, o.e7)([y.Z], () => {
            if (!u)
                return null;
...
function $(e) {
    var n;
    let t = (0, o.e7)([O.default], () => O.default.getUser(e.ownerId)), l = (0, o.e7)([U.Z], () => {
            var n;
...
function ee(e) {
    var n, t;
    let u = O.default.getUser(e.ownerId), l = null === (n = U.Z.getMessage(e.id)) || void 0 === n ? void 0 : n.firstMessage, r = (0, m.ij)(null !== (t = null == l ? void 0 : l.author) && void 0 !== t ? t : u, e);
    return {
        user: u,
        author: r
    };
...
function eo(e) {
    ...
    return u.useMemo(() => {
        ...
        n,
        null == e ? void 0 : e.availableTags
    ]);
}
function ea(e, n) {
    let t = eo((0, o.e7)([_.Z], () => _.Z.getChannel(null == e ? void 0 : e.parent_id), [e]));
    return u.useMemo(() => n.filter(e => t.includes(e)), [
        n,
        t
    ]);
}
...
function ef(e, n) {
    let t = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], {
            isSearchLoading: l,
            searchQuery: r
        } = es({ channelId: e.id }), i = ed(e), o = u.useRef(null), a = u.useRef(new Set());
    u.useEffect(() => {
        if (null == r && null != o.current) {
            R.Z.clearForumSearch(e.id), o.current = null;
            return;
        }
        if (null == r || 0 === r.length || t)
            return;
        if (!i) {
            R.Z.clearForumSearch(e.id);
            return;
        }
        if (o.current === r && a.current === n || l)
            return;
...
function eg(e, n) {
    return (0, o.e7)([
        ...
        if (!(null == t ? void 0 : t.isForumLikeChannel()))
            return 0;
        let u = Z.Z.getActiveJoinedUnreadThreadsForParent(e, n), l = Z.Z.getActiveUnjoinedUnreadThreadsForParent(e, n), r = p.ZP.ackMessageId(n), i = 0;
        if (null == r)
            return i;
        for (let e in u) {
            let n = u[e], t = p.ZP.lastMessageId(n.channel.id);
            null != t && t > r && i++;
        }
        for (let e in l) {
            let n = l[e], t = p.ZP.lastMessageId(n.id);
            null != t && t > r && i++;
        }
        return i;
    });
...
function em(e) {
    let {
        ...
        } = e, i = (0, o.Wu)([w.Z], () => w.Z.getThreadIds(n.id, t, l)), a = eg(n.guild_id, n.id), c = (0, o.e7)([w.Z], () => r && (a > 0 || w.Z.getCanAckThreads()), [
            r,
            a
        ]);
    return u.useEffect(() => {

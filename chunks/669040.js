...
let {
  ...
  upsellGlowOpacity: M
} = e, P = (0, f.O)(), H = i.useRef(F.xAR), Z = i.useMemo(() => '' !== n ? d.Z.convert.toCodePoint(n) : '', [n]), X = i.useCallback(e => {
  let t = E[e],
    n = E[e + 1];
...
}, [E]), J = i.useCallback(function(e) {
  let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
    r = new Set(t),
    i = t.has(e);
  i ? r.delete(e) : r.add(e), null != n && L.default.track(F.rMx.EXPRESSION_PICKER_CATEGORY_COLLAPSE_TOGGLED, {
    location: P.location,
    tab: V.X1.EMOJI,
    collapsed: !i,
    guild_id: n.id
...
let er = i.useMemo(() => l().memoize(e => {
    ...
    if (o === B.En.SEARCH_RESULTS)
      return;
    let u = o === B.En.GUILD ? null != i ? (0, r.jsx)(x.Z, {
        guild: i,
        height: 16,
        width: 16
      }) : null : null != a ? (0, r.jsx)(w.Z, {
        categoryId: a,
        height: 16,
        width: 16,
        size: 'custom'
  ...
  es = i.useCallback(e => $(e) ? 41 : X(e) ? 33 : 0, [
    $,
    X
  ]),
  eo = i.useCallback(e => {
...
let eg = i.useCallback(e => {
  ...
  eS = d.length > 0;
return i.useEffect(() => {
  en && L.default.track(F.rMx.PREMIUM_UPSELL_VIEWED, {
  ...
  children: [
    ...
    q || u.tq ? null : (0, r.jsx)(O.p, {
      ...
      upsellText: function() {
        if (!eu)
          return Z.Z.Messages.EMOJI_PICKER_PREMIUM_UPSELL_TITLE;
        {

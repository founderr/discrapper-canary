...
let q = (0, G.Mg)(E.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_TOP),
  Q = (0, G.Mg)(E.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_RIGHT),
  X = (0, G.Mg)(E.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_BOTTOM),
  $ = (0, G.Mg)(E.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_SEARCH_RESULTS_PADDING_TOP),
  J = (0, G.Mg)(E.Z.EXPRESSION_PICKER_CONSTANTS_EXPRESSION_PICKER_LIST_SECTION_HEADING_HEIGHT),
  ee = (0, G.Mg)(E.Z.EMOJI_PICKER_CONSTANTS_EMOJI_SECTION_MARGIN_BOTTOM),
  et = (0, G.Mg)(E.Z.EMOJI_PICKER_CONSTANTS_EMOJI_CONTAINER_PADDING_VERTICAL),
  en = e => e + 2 * et,
  er = e => {
let {
  collapsedSections: t,
...
let er = i.useMemo(() => l().memoize(e => {
  ...
  ea = i.useCallback(e => G(e) ? (0, r.jsx)(C.Z, {
    glowOpacity: b
  }) : x(e) ? (0, r.jsx)('div', {
...
} = e, j = i.useRef(!1), q = T.kJ.useStore(e => e.activeCategoryIndex), Q = (0, g.Iu)(e => e.searchQuery), X = L.Yk.useSetting(), $ = (0, d.e7)([b.default], () => b.default.getCurrentUser()), J = (0, w.I5)($), {
  location: ee
} = (0, p.O)(), {

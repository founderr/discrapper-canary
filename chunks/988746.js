...
if (!this.connection.hasDesktopSource()) {
  ...
  this.framerateReductionTimeout = setTimeout(() => {
    if (!this.connection.destroyed)
      o.info('BaseConnection.userSpeakingChange: Reduced framerate after '.concat(a.u$, ' ms.')), this.framerateReductionTimeout = void 0, this.sinkWants.isMuted = !0, this.updateRemoteWantsFramerate();
  }, a.u$);
}
  }

...
let eO = (0, I.Mt)((0, I.jj)()),
  ...
  eL = eI.Yn.STREAM,
  eb = {
[eI.w5]: tc(em.Z.Messages.NO_INPUT_DEVICES)
  },
  eM = {
[eI.w5]: tc(em.Z.Messages.NO_OUTPUT_DEVICES)
  },
  eP = {
[eI.w5]: tc(em.Z.Messages.NO_VIDEO_DEVICES)
  },
  eU = !1,
  ew = !1,
  ex = !1,
...
function ta() {
  return (0, et.isMac)() && eO.supports(eI.AN.SCREEN_CAPTURE_KIT) && h().satisfies(null === S.Z || void 0 === S.Z ? void 0 : S.Z.os.release, ef.C7);
}
...
!this.started && (this.started = !0, eO.on(I.aB.Silence, this.handleSilence));
  ...
  stop() {
this.started && (this.started = !1, null != this.stateChangeTimeout && (clearTimeout(this.stateChangeTimeout), this.stateChangeTimeout = null), eO.removeListener(I.aB.Silence, this.handleSilence), g.Z.dispatch({
...
eO.on(I.aB.Connection, e => {
  ...
  (0, et.isWindows)() ? (null == e4 ? void 0 : e4.startsWith('NVIDIA')) ? e.setExperimentFlag(eI.V8.SIGNAL_AV1, !0): (null == e4 ? void 0 : e4.startsWith('AMD')) && U.Z.getCurrentConfig({
    location: 'setupMediaEngine'
  }, {
    autoTrackExposure: !0
  }).signalAV1Support ? e.setExperimentFlag(eI.V8.SIGNAL_AV1, !0) : e.setExperimentFlag(eI.V8.SIGNAL_AV1_DECODE, !0): ((0, et.isMac)() || (0, et.isLinux)()) && e.setExperimentFlag(eI.V8.SIGNAL_AV1_DECODE, !0), (0, et.isWindows)() && e.setExperimentFlag(eI.V8.SIGNAL_AV1_HARDWARE_DECODE, !0);
  let {
  ...
  }), e.context === eI.Yn.DEFAULT && (eV = !1, e.on(I.Sh.SpeakingWhileMuted, () => {
    eV = !0, r.emitChange();
  ...
  null != t && (m.K.set(eS, {
      [eI.Yn.DEFAULT]: t
    }), m.K.remove('audio')), eR = null !== (e = m.K.get(eS)) && void 0 !== e ? e : {}, E().each(eR, e => {
...
}(), ((0, et.isWindows)() || (0, et.isLinux)() || (0, et.isMac)() && h().satisfies(null === S.Z || void 0 === S.Z ? void 0 : S.Z.os.release, '>=21.0.0')) && !__OVERLAY__ && !ez && !eq ? (ez = !0, tS()) : (0, et.isWeb)() && eO.supports(eI.AN.NOISE_CANCELLATION) ? (eq = !0, r.emitChange()) : (0, et.isWeb)() && tl({
  noiseCancellation: !1
}), tp(), e3 = {
...
return eO.supports(eI.AN.EXPERIMENTAL_SOUNDSHARE) && h().satisfies(null === S.Z || void 0 === S.Z ? void 0 : S.Z.os.release, ef.I9);
  }
  getOpenH264() {
return e7().openH264;
  }
...
return (0, et.isMac)() && eO.supports(eI.AN.SOUNDSHARE) && h().satisfies(null === S.Z || void 0 === S.Z ? void 0 : S.Z.os.release, ef.yG) && ta() || (0, et.isWindows)() && eO.supports(eI.AN.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare();
  }
...
return this.isSimulcastSupported() && (e === eI.Yn.DEFAULT || ts()) && t.push({
  rid: '50',
  type: e === eI.Yn.DEFAULT ? eI.Tr.VIDEO : eI.Tr.SCREEN,
  quality: 50
}), t;
...
i = e.sessionId, eU = !1, eG = !1, Y.Z.subscribe({
  ...
  !e.sidechainAvailable && t.sidechainCompression ? (tl({
    sidechainCompressionSettingVersion: 0
  }), tm(!1)) : e.sidechainAvailable && t.sidechainCompressionSettingVersion < 1 && (tl({
    sidechainCompressionSettingVersion: 1
  }), tm(e.sidechainEnabled));
}), tE();
  },
...
if (t === eI.Yn.DEFAULT && (q.Z.requestPermission(eh.Eu.AUDIO), ex))
  return !1;
!(r = !i && !r) && (i = !1), n && (eF = !0), tl({
  mute: r,
  deaf: i
...
if (N[u] === eE.ZUi.AUTO_PROBING && c === eE.ZUi.AUTO_ENABLED && (0, z.Z)(u, f ? eI.fC.AUTO_DISABLE : eI.fC.AUTO_ENABLE, m), N[u] = c, tl({
    videoToggleStateMap: N
  ...
  A && (I && !f ? (eg.info('disallowing auto-disable for this session because of manual override by user'), e1 = !1, null === (o = ec.Z.getRTCConnection()) || void 0 === o || null === (s = o.getVideoHealthManager()) || void 0 === s || s.disable(), (0, z.Z)(u, eI.fC.MANUAL_REENABLE, m)) : (0, z.Z)(u, f ? eI.fC.MANUAL_DISABLE : eI.fC.MANUAL_ENABLE, m));

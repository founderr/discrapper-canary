...
class tA extends (l = I.ZP.Store) {
    ...
    getInputDeviceId() {
        return tu(eC, e5().inputDeviceId);
    }
    getOutputDeviceId() {
        return tu(eL, e5().outputDeviceId);
    }
    getVideoDeviceId() {
        return tu(eD, e5().videoDeviceId);
    }
    getInputDevices() {
        return eC;
    }
...
eh(tA, 'displayName', 'MediaEngineStore'),
    (r = new tA(g.Z, {
        ...
        AUDIO_TOGGLE_SELF_DEAF: function (e) {
            let { context: t } = e;
            ta({ deaf: !e5(t).deaf }, t), eg.eachConnection(e8);
        },

...
[em.w5]: tc(eI.Z.Messages.NO_VIDEO_DEVICES)
  ...
  e$ = !1,
  eJ = !1;
z.Z.hasPermission(eh.Eu.AUDIO, {
  showAuthorizationError: !1
}), z.Z.hasPermission(eh.Eu.CAMERA, {
  showAuthorizationError: !1
});
let e0 = new Set(),
  e1 = !1,
...
function te(e) {
  let t = e7(e.context),
n = !ey || t.mute || t.deaf;
  e.context === em.Yn.DEFAULT ? n = n || eU || ew || ex || !z.Z.didHavePermission(eh.Eu.AUDIO) : e.context === em.Yn.STREAM && (n = !0), e.setSelfMute(n), e.setSelfDeaf(t.deaf), e.context === em.Yn.DEFAULT && N.Z.updateNativeMute();
}
...
eO.on(m.aB.Connection, e => {
  ...
  null != t && (I.K.set(eS, {
    ...
    function() {
      var e, t, n;
      let r = e7();
      eO.setAudioInputDevice(r.inputDeviceId), eO.setAudioOutputDevice(r.outputDeviceId), tt(), eO.setInputVolume(r.inputVolume), eO.setOutputVolume(r.outputVolume), eO.setH264Enabled(null === (e = r.hardwareEncoding) || void 0 === e || e || r.openH264), eO.setAv1Enabled(null === (t = r.hardwareEncoding) || void 0 === t || t), eO.setH265Enabled(null === (n = r.hardwareEncoding) || void 0 === n || n), eO.setAecDump(r.aecDumpEnabled);
    }();
}(), ((0, et.isWindows)() || (0, et.isLinux)() || (0, et.isMac)() && h().satisfies(null === S.Z || void 0 === S.Z ? void 0 : S.Z.os.release, '>=21.0.0')) && !__OVERLAY__ && !ez && !eq ? (ez = !0, tg()) : (0, et.isWeb)() && eO.supports(em.AN.NOISE_CANCELLATION) ? (eq = !0, r.emitChange()) : (0, et.isWeb)() && tl({
  noiseCancellation: !1
}), tp(), e3 = {
...
return e === em.Yn.DEFAULT && ew;
  ...
  isSelfMute() {
let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : em.Yn.DEFAULT;
return !this.isEnabled() || e7(e).mute || !z.Z.didHavePermission(eh.Eu.AUDIO) || this.isSelfDeaf(e) || e === em.Yn.DEFAULT && ex;
  }
...
eT(tA, 'displayName', 'MediaEngineStore'), r = new tA(g.Z, {
...
if (t === em.Yn.DEFAULT && (z.Z.requestPermission(eh.Eu.AUDIO), ex))
  return !1;
!(r = !i && !r) && (i = !1), n && (eF = !0), tl({
  mute: r,
  deaf: i
...
if (N[u] === eE.ZUi.AUTO_PROBING && c === eE.ZUi.AUTO_ENABLED && (0, K.Z)(u, f ? em.fC.AUTO_DISABLE : em.fC.AUTO_ENABLE, I), N[u] = c, tl({
    videoToggleStateMap: N
  ...
  if (!f && !m || f && !e1)
    return;
  (0, K.Z)(u, f ? em.fC.AUTO_DISABLE : em.fC.AUTO_ENABLE, I), f ? e0.add(u) : e0.delete(u);
} else
  A && (m && !f ? (eg.info('disallowing auto-disable for this session because of manual override by user'), e1 = !1, null === (o = ec.Z.getRTCConnection()) || void 0 === o || null === (s = o.getVideoHealthManager()) || void 0 === s || s.disable(), (0, K.Z)(u, em.fC.MANUAL_REENABLE, I)) : (0, K.Z)(u, f ? em.fC.MANUAL_DISABLE : em.fC.MANUAL_ENABLE, I));
...
eO.eachConnection(e => e.setEchoCancellation(t.echoCancellation)), tI(), tm(e.location);
  },
...
eO.eachConnection(e => e.setNoiseSuppression(t.noiseSuppression)), tI(), tm(e.location);
  },
  AUDIO_SET_AUTOMATIC_GAIN_CONTROL: function(e) {
let t = tl({
  automaticGainControl: e.enabled
});
eO.eachConnection(e => e.setAutomaticGainControl(t.automaticGainControl)), tI(), tm(e.location);
  },
  AUDIO_SET_NOISE_CANCELLATION: function(e) {
let t = tl({
  noiseCancellation: e.enabled
});
eO.eachConnection(e => e.setNoiseCancellation(t.noiseCancellation)), tI(), tm(e.location);
  },
...
z.Z.requestPermission(eh.Eu.CAMERA), tt(t);
  },
...
if (!(0, q.R)() || t !== ep.yP.PRELOADED_USER_SETTINGS || n || null != r)
  return !1;
tE(!0);
  },

...
function ta() {
    return (0, q.isWindows)() && p().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ec.nz);
}
function ts() {
    return (0, q.isMac)() && eb.supports(e_.AN.SCREEN_CAPTURE_KIT) && p().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ec.C7);
}
let to = new (class {
    start() {
...
function tb(e) {
    e === e_.iA.AUTOMATIC ? (tl({ automaticAudioSubsystem: !0 }), tT()) : (tl({ automaticAudioSubsystem: !1 }), eb.setAudioSubsystem(e));
}
function tT() {
...
class tA extends (l = g.ZP.Store) {
    initialize() {
        eb.on(E.aB.Connection, (e) => {
            ...
            if (((0, q.isWindows)() ? ((null == e3 ? void 0 : e3.startsWith('NVIDIA')) ? e.setExperimentFlag(e_.V8.SIGNAL_AV1, !0) : (null == e3 ? void 0 : e3.startsWith('AMD')) && w.Z.getCurrentConfig({ location: 'setupMediaEngine' }, { autoTrackExposure: !0 }).signalAV1Support ? e.setExperimentFlag(e_.V8.SIGNAL_AV1, !0) : e.setExperimentFlag(e_.V8.SIGNAL_AV1_DECODE, !0)) : ((0, q.isMac)() || (0, q.isLinux)()) && e.setExperimentFlag(e_.V8.SIGNAL_AV1_DECODE, !0), (0, q.isWindows)() && e.setExperimentFlag(e_.V8.SIGNAL_AV1_HARDWARE_DECODE, !0), eb.setHasFullbandPerformance((0, R.b)()), e.setRemoteAudioHistory(0), (0, N.Z)(r))) {
            ...
            ((0, q.isWindows)() || (0, q.isLinux)() || ((0, q.isMac)() && p().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, '>=21.0.0'))) && !__OVERLAY__ && !eK && !ez ? ((eK = !0), tS()) : (0, q.isWeb)() && eb.supports(e_.AN.NOISE_CANCELLATION) ? ((ez = !0), r.emitChange()) : (0, q.isWeb)() && tl({ noiseCancellation: !1 }),
            tm(),
            (e2 = {
    ...
    supportsExperimentalSoundshare() {
        return eb.supports(e_.AN.EXPERIMENTAL_SOUNDSHARE) && p().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ec.I9);
    }
    ...
    supportsScreenSoundshare() {
        return ((0, q.isMac)() && eb.supports(e_.AN.SOUNDSHARE) && p().satisfies(null === b.Z || void 0 === b.Z ? void 0 : b.Z.os.release, ec.yG) && ts()) || ((0, q.isWindows)() && eb.supports(e_.AN.SCREEN_SOUNDSHARE) && this.getExperimentalSoundshare());
    }
...
ep(tA, 'displayName', 'MediaEngineStore'),
    (r = new tA(S.Z, {
        ...
        VOICE_STATE_UPDATES: function (e) {
            let { voiceStates: t } = e;
            return t.reduce((e, t) => (i === t.sessionId ? ((eL = t.mute || t.suppress), (eM = t.deaf), eb.eachConnection(tt), tn(!(null != t.guildId && null != t.channelId && null != eq && eq !== t.channelId) && eP), (eq = t.channelId), !0) : (!__OVERLAY__ && t.userId === ee.default.getId() && null == ea.Z.getChannelId() && tn(!1, null), e)), !1);
        },
        CONNECTION_OPEN: function (e) {
            ...
            let t = e8();
            eb.supports(e_.AN.AUTOMATIC_AUDIO_SUBSYSTEM) ? (t.automaticAudioSubsystem && tT(), (0, q.isWindows)() && t.audioSubsystemSettingVersion < 2 && (tl({ audioSubsystemSettingVersion: 2 }), !t.automaticAudioSubsystem && eb.getAudioSubsystem() === e_.iA.STANDARD && tb(e_.iA.AUTOMATIC))) : tl({ automaticAudioSubsystem: !1 }), t_();
        },
        ...
        AUDIO_SET_LOCAL_VIDEO_DISABLED: function (e) {
            ...
            let v = h !== m,
                ...
                S = _ && v && I,
                b = f && v && I;
            em.info('changed='.concat(v, ' isDefaultContext=').concat(I, ' isUpdateCausedByVideoHealthManager=').concat(S, ' isManualToggleByUser=').concat(b));
            let { videoToggleStateMap: T } = e8(l);
            if ((T[u] === eu.ZUi.AUTO_PROBING && c === eu.ZUi.AUTO_ENABLED && (0, V.Z)(u, h ? e_.fC.AUTO_DISABLE : e_.fC.AUTO_ENABLE, E), (T[u] = c), tl({ videoToggleStateMap: T }, l, f), c === eu.ZUi.AUTO_PROBING ? null === (n = ea.Z.getRTCConnection()) || void 0 === n || n.pauseStatsCollectionForUser(u, !0) : null === (r = ea.Z.getRTCConnection()) || void 0 === r || r.pauseStatsCollectionForUser(u, !1), !e0 && (em.info('isAutoDisableAllowed='.concat(e0, ' - disabling VideoHealthManager')), null === (a = ea.Z.getRTCConnection()) || void 0 === a || null === (i = a.getVideoHealthManager()) || void 0 === i || i.disable()), S)) {
                if ((!h && !g) || (h && !e0)) return;
                (0, V.Z)(u, h ? e_.fC.AUTO_DISABLE : e_.fC.AUTO_ENABLE, E), h ? e$.add(u) : e$.delete(u);
            } else b && (g && !h ? (em.info('disallowing auto-disable for this session because of manual override by user'), (e0 = !1), null === (o = ea.Z.getRTCConnection()) || void 0 === o || null === (s = o.getVideoHealthManager()) || void 0 === s || s.disable(), (0, V.Z)(u, e_.fC.MANUAL_REENABLE, E)) : (0, V.Z)(u, h ? e_.fC.MANUAL_DISABLE : e_.fC.MANUAL_ENABLE, E));
            I && !h && e$.delete(u),
                h ? (p[u] = !0) : delete p[u],
        ...
        CLIPS_INIT: function (e) {
            ...
            null != s && s.desktopSource.id !== d.desktopSource.id && (eb.setClipsSource(null), (0, q.isWindows)() && null != s.desktopSource.soundshareId && T.pn(s.desktopSource.soundshareId)), null != l && tp(l, u), (s = d);
            let f = e7(),
                _ = e8().videoHook;
            eb.setClipsSource({
                desktopDescription: {

e.exports = Object.freeze({
    ...
    FOR_LATER_TAB_REMINDERS: 'Reminders',
    FOR_LATER_TAB_REMINDERS_COUNT: 'Reminders ({count, number})',
    FOR_LATER_TUTORIAL_MESSAGE: 'Hey fren! \uD83D\uDC4B\u2728 You can now save messages, set reminders in Discord, and find them all here in For Later! Happy Saving! \uD83D\uDCBE \u2764',
    FOR_LATER_DIRECT_MESSAGE_WITH: 'Direct message with !!{username}!!',
    FOR_LATER_BOOKMARK_DELETED: 'A message you saved was deleted.',
    FOR_LATER_REMINDER_DELETED: 'A message you set a reminder for was deleted.',
    FOR_LATER_REMOVE: 'Remove',
    FOR_LATER_OPTIONS: 'Options',
    FOR_LATER_MANAGE_MESSAGES: 'Manage Saved Messages',
    FOR_LATER_TOO_MANY_TITLE: 'Limit Reached',
    FOR_LATER_TOO_MANY_BODY: "You've reached the limit for saved messages and reminders ({max, number} total). The message could not be saved. Please remove some to continue saving more.",
    FOR_LATER_PREMIUM_UPSELL: 'Save messages and create reminders with {nitroTierName}',
    FOR_LATER_PREMIUM_UPSELL_CTA: 'Get Nitro',
    FOR_LATER_UPSELL_MODAL_TITLE: 'Get access to Saved Messages with Nitro',
    FOR_LATER_UPSELL_MODAL_BODY: 'Upgrade to Nitro to bookmark and organize important messages.',
    ...
    MESSAGE_REMINDERS_SNOOZE: 'Snooze Reminder',
    MESSAGE_REMINDERS_IN_THIRTY_MIN: 'in 30m',
    MESSAGE_REMINDERS_IN_ONE_HOUR: 'in 1h',
    MESSAGE_REMINDERS_IN_TWO_HOURS: 'in 2h',
    MESSAGE_REMINDERS_IN_FOUR_HOURS: 'in 4h',
    MESSAGE_REMINDERS_IN_ONE_DAY: 'in 1d',
    MESSAGE_REMINDERS_IN_ONE_WEEK: 'in 1w',
    MESSAGE_REMINDERS_CUSTOM_DUE: 'Custom...',
    MESSAGE_REMINDERS_NEVER: 'never',
    MESSAGE_REMINDERS_DUE_IN: 'Due in {duration}',
    MESSAGE_REMINDERS_OVERDUE: 'Due {duration} ago',
    MESSAGE_REMINDERS_CREATE_SUCCESS: 'Reminder Added!',
    MESSAGE_REMINDERS_CREATE_FAIL: 'Failed to save reminder!',
    MESSAGE_REMINDERS_DELETE_SUCCESS: 'Reminder Removed!',
    MESSAGE_REMINDERS_DELETE_FAIL: 'Failed to remove reminder!',
    MESSAGE_BOOKMARKS_HEADER: 'Bookmarks',
    MESSAGE_BOOKMARKS_CREATE: 'Save Message',
    MESSAGE_BOOKMARKS_REMOVE: 'Unsave Message',
    MESSAGE_BOOKMARKS_SAVED: 'Saved for later',
    ...
    MESSAGE_BOOKMARKS_CREATE_SUCCESS_LONG: 'Message saved for later. Only you can see it.',
    MESSAGE_BOOKMARKS_CREATE_SUCCESS: 'Message Saved!',
    MESSAGE_BOOKMARKS_CREATE_FAIL: 'Failed to save message!',
    MESSAGE_BOOKMARKS_DELETE_SUCCESS: 'Message Unsaved!',
    MESSAGE_BOOKMARKS_DELETE_FAIL: 'Failed to unsave message!',
    ...
    CLAN_DISCOVERY_PREFERENCES_DESCRIPTION: 'We will prioritize Guilds that match the criteria you selected.',
    ...
    CLAN_DISCOVERY_UPSELL_USER_CTA: 'Pick My Games',

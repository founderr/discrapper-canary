e.exports = Object.freeze({
    ...
    RAPIDASH_CHANNEL_LIST_USER_UPSELL_2_TITLE: 'We DOUBLED the Guilds',
    RAPIDASH_CHANNEL_LIST_USER_UPSELL_2_MESSAGE: 'More groups for games you love, looking for players like you!',
    ...
    RAPIDASH_GUILD_LIST_USER_UPSELL_TITLE: 'Join an exclusive gaming Guild',
    RAPIDASH_GUILD_LIST_USER_UPSELL_MESSAGE: 'Check out small Guilds looking to recruit players and make new friends.',
    ...
    CLAN_SETUP_UTILITY_TRAITS_CATEGORY_IDENTITY: 'Characteristics',
    ...
    RAPIDASH_ONBOARDING_ACTION_ITEM: 'Adopt the tag',
    ...
    CLAN_DISCOVERY_OTHER_GUILDS_TITLE: 'More Guilds For You',
    ...
    CLAN_DISCOVERY_SAVED_GUILDS: 'Saved Guilds',
    CLAN_DISCOVERY_ALL_GUILDS: 'All Guilds',
    CLAN_DISCOVERY_PREFERENCES: 'Preferences',
    CLAN_DISCOVERY_ESC: 'ESC',
    CLAN_DISCOVERY_PREFERENCES_TITLE: 'Preferences',
    CLAN_DISCOVERY_PREFERENCES_DESCRIPTION: 'Add your favorite games to find more Guilds. We will prioritize Guilds that match the criteria you selected.',
    CLAN_DISCOVERY_UNSAVED_CHANGES: 'Careful \u2014 You have unsaved changes!',
    CLAN_DISCOVERY_TRAITS: 'Traits',
    CLAN_DISCOVERY_PLAYSTYLE: 'Playstyle',
    CLAN_DISCOVERY_CLEAR_SELECTIONS: 'Clear',
    CLAN_DISCOVERY_UPSELL_BROWSE: 'Browse Guilds',
    CLAN_GAMEPLAY_ACTIVITY_HIGH: 'Very Active',
    CLANS: 'Guilds',
    ...
    CLAN_DISCOVERY_EMPTY_LIST_TITLE: 'No Guilds Found',
    CLAN_DISCOVERY_EMPTY_LIST_DESCRIPTION: 'Try changing your filters or check back later.',
    CLAN_DISCOVERY_ERROR_TITLE: 'We rolled a critical fail.',
    CLAN_DISCOVERY_ERROR_DESCRIPTION: 'Oops! Guild Discovery is down right now. Try again later.',
    ...
    CLAN_DISCOVERY_UPSELL_USER_CTA: 'Find Your Perfect Guild',
    CLAN_DISCOVERY_UPSELL_ADMIN_LIST_SERVER: 'List My Server',
    CLAN_DISCOVERY_UPSELL_ADMIN_DISMISS_NOTICE: 'Dismiss Notice',
    ...
    DISCOVERY_PLUS_HEADER_TITLE: 'Make \n\n$[!!{gameName}!!](gameNameHook)\n\nfriends',
    DISCOVERY_PLUS_HEADER_TITLE_GENERIC: 'Make {descriptor}\n\n$[!!{gameName}!!](gameNameHook)\n\nfriends',
    DISCOVERY_PLUS_HEADER_SUBTITLE: 'Join an exclusive Guild that plays the same games as you.',
    DISCOVERY_PLUS_HEADER_SEARCH_PLACEHOLDER: 'Add a game',
    ...
    ICYMI_END_TITLE: "That's all for now!",
    ...
    ICYMI_TOPICS_TITLE: 'What are some topics you\u2019re interested in?',
    ICYMI_TOPICS_SUBTITLE: 'Select at least one topic for improved server recommendations.',
    ICYMI_COMPLETE: 'Complete',
    ICYMI_JOIN_GUILDS_TITLE: 'Choose 3 or more featured servers you\u2019re interested in.',
    ICYMI_JOIN_GUILDS_SUBTITLE: 'The more servers you join, the more interesting content you\u2019ll find.',
    ICYMI_SELECTED: 'Selected',
    ...
    ICYMI_ITEM_HEADER_SUBTITLE_INTERESTING: ' sent a message you might like.',
    ICYMI_ITEM_HEADER_SUBTITLE_ANNOUNCEMENT: ' posted an announcement.',
    ICYMI_ITEM_HEADER_SUBTITLE_ANNOUNCEMENT_EVERYONE: ' posted an announcement that mentioned everyone.',
    ICYMI_ITEM_HEADER_SUBTITLE_FILE: ' uploaded a file:',
    ICYMI_ITEM_HEADER_SUBTITLE_GUILD_EVENT_CREATED: ' created an event.',
    ICYMI_ITEM_HEADER_SUBTITLE_GUILD_EVENT_HOSTING: ' is hosting an event.',
    ICYMI_ITEM_HEADER_SUBTITLE_GUILD_EVENT_NO_USER: 'An event was created',
    ICYMI_ITEM_HEADER_SUBTITLE_CHANGED_STATUS: ' changed their status',
    ICYMI_PRE_ALPHA: 'ALPHA',
    ICYMI_FORWARD: 'Forward',
    ICYMI_REPLY: 'Reply',
    ICYMI_CONVO_CATCH_UP: 'Catch up',
    ICYMI_REPLY_REACT: 'React or Reply to {activity}',
    ICYMI_REACT_STATUS: 'React to Status',
    ICYMI_REACT_ACTIVITY: 'React to Activity',
    ICYMI_JOIN_THE_CONVERSATION: 'Join in',
    ICYMI_ACTIVE_CONVO: 'Active Conversation',
    ICYMI_RECENT_CONVO: 'Recent Conversation',
    ICYMI_LOADING_COMMENTS: 'Loading comments...',
    ...
    ICYMI_SHARE_EVENT: 'Share Event',
    ICYMI_SHARE_ACTIVITY: 'Share Activity',
    ...
    ICYMI_ERROR: 'Something went wrong. Please try again later.',
    ...
    ICYMI_FEATURED_SERVERS_TITLE: 'Featured servers you might like',
    ICYMI_FEATURED_SERVERS_SUBTITLE: 'The more servers you join, the more interesting content you\u2019ll find.',
    ...
    QUESTS_NITRO_REWARD_MODAL_BACKGROUND_IMAGE_ALT: 'Rocket Ships fly over a starry galaxy.',
    QUESTS_NITRO_ENROLL_FAILURE_TOAST: 'Something went wrong. You may not be eligible to enroll in this Quest.',
    QUESTS_VIEW_MEDIA_CTA: 'Watch ({remainTime} left)',
    QUESTS_VIEW_MEDIA_CONTINUE_CTA: 'Resume ({remainTime} left)',
    QUESTS_WATCH_AGAIN: 'Watch again',
    QUESTS_VIDEO_QUEST_PAUSE_MESSAGE: 'We paused the video while you were away. Resume to continue progress.',
    QUESTS_VIDEO_INSTRUCTIONS_TO_WIN_REWARD: 'Watch the {videoTitle} to win {rewardNameWithArticle}!',
    QUESTS_VIDEO_INSTRUCTIONS_TO_WIN_REWARD_GENERIC: 'Watch the video to win {rewardNameWithArticle}!',
    QUESTS_VIDEO_QUESTBAR_SUBTITLE: 'Watch to earn rewards!',
    QUESTS_VIDEO_END_PANEL_LEARN_TITLE: 'Learn more',
    QUESTS_VIDEO_END_PANEL_LEARN_SUBTITLE: 'Find out more about the video!',
    QUESTS_VIDEO_END_PANEL_REWARD_TITLE: 'More Rewards',
    QUESTS_VIDEO_END_PANEL_REWARD_SUBTITLE: 'Explore more rewards to earn!',
    QUESTS_VIDEO_CONTROL_BTN_TOOLTIP_REWIND: 'Rewind 10 seconds',
    QUESTS_VIDEO_CONTROL_BTN_TOOLTIP_SKIP: 'Skip ahead 10 seconds',
    QUESTS_VIDEO_CONTROL_BTN_TOOLTIP_SKIP_FORBIDDEN: "Can't skip unwatched sections yet",
    QUESTS_VIDEO_CONTROL_BTN_TOOLTIP_TOGGLE_TRANSCRIPT: 'Toggle transcript',
    QUESTS_VIDEO_CONTROL_BTN_TOOLTIP_TOGGLE_CAPTION: 'Toggle captions',
    QUESTS_VIDEO_CONTROL_BTN_TOOLTIP_TOGGLE_FULLSCREEN: 'Toggle full screen',
    QUESTS_VIDEO_CONTROL_BTN_TOOLTIP_CHANGE_VOLUME: 'Change volume',
    QUESTS_VIDEO_REWARD_TOOLTIP: 'Reward: {rewardName}',
    ...
    LEADERBOARD_POPOUT_TITLE: '$[!!{leaderboardName}!!](leaderboardNameHook) standings',
    LEADERBOARD_TABLE_HEADER_PLAYER: 'Player',
    MEMBER_LIST_CONTENT_FEED_LEADERBOARD_MENU_REFRESH_MY_DATA: 'Refresh my game data',
    LEADERBOARD_INTERVAL_END_DAYS_LEFT: '{count, number}d Left',
    LEADERBOARD_INTERVAL_END_HOURS_LEFT: '{count, number}h Left',
    LEADERBOARD_INTERVAL_END_MINUTES_LEFT: '{count, number}m Left',
    LEADERBOARD_LAST_WEEKS_CHAMPION: "Last Week's Champion",
    LEADERBOARD_LAST_MONTHS_CHAMPION: "Last Month's Champion",
    LEADERBOARD_YESTERDAYS_CHAMPION: "Yesterday's Champion",
    LEADERBOARD_LAST_CHAMPION: 'Last Champion',
    LEADERBOARD_CURRENT_CHAMPION: 'Current Champion',
    LEADERBOARD_POPOUT_PREVIEW_SHOW_FULL_LEADERBOARD: 'View Full Leaderboard',
    LEADERBOARD_RANK_CHANGE_CURRENT_USER: "You're now #{rank}",
    LEADERBOARD_RANK_CHANGE_OTHER_USER: 'New #{rank}: !!{username}!!',
    LEADERBOARD_START_PLAYING_CTA: 'Play and win to take the crown',
    MEMBER_LIST_CONTENT_FEED_LEADERBOARD_CARD_EMPTY_STATE_TITLE: 'Play to Take the Crown',
    MEMBER_LIST_CONTENT_FEED_LEADERBOARD_CARD_EMPTY_STATE_SUBTITLE: 'Compete for Wins',
    LEADERBOARD_MODAL_TITLE: 'League of Legends Leaderboard',
    LEADERBOARD_MODAL_SUBTITLE: 'The top score for wins gets to wear the crown.',
    LEADERBOARD_MODAL_CONNECT_RIOT: 'Connect your Riot Account',
    LEADERBOARD_SHARE_STATS: 'Share my stats with this server',
    JOIN_LEADERBOARD: 'Join Leaderboard',
    LEAVE_LEADERBOARD: 'Leave Leaderboard',
    LEADERBOARD_UPDATED_AGO_TIMESTAMP_MINUTES: 'Updated {count}m ago',
    LEADERBOARD_UPDATED_AGO_TIMESTAMP_HOURS: 'Updated {count}h ago',
    LEADERBOARD_UPDATED_AGO_TIMESTAMP_DAYS: 'Updated {count} days ago',
    LEADERBOARD_UPDATED_AGO_TIMESTAMP_MONTHS: 'Updated {count} months ago',
    LEADERBOARD_UPDATED_AGO_TIMESTAMP_YEARS: 'Updated {count} years ago',
    LEADERBOARD_UPDATED_YESTERDAY: 'Updated yesterday',
    LEADERBOARD_UPDATED_JUST_NOW: 'Updated just now',
    LEADERBOARD_UPDATE_IN_PROGRESS: 'Update in progress',
    MEMBER_LIST_CONTENT_FEED_LEADERBOARD_STATISTIC_VALUE: '{value, number} {statisticName}',
    LEADERBOARD_STATISTIC_NAME_LOL_TOTAL_KILLS: 'Kills',
    LEADERBOARD_STATISTIC_NAME_LOL_TOTAL_DEATHS: 'Deaths',
    LEADERBOARD_STATISTIC_NAME_LOL_TOTAL_ASSISTS: 'Assists',
    LEADERBOARD_STATISTIC_NAME_LOL_TOTAL_DAMAGE_DEALT: 'Damage Dealt',
    LEADERBOARD_STATISTIC_NAME_LOL_TOTAL_DAMAGE_TAKEN: 'Damage Taken',
    LEADERBOARD_STATISTIC_NAME_LOL_TOTAL_WINS: 'Wins',
    LEADERBOARD_STATISTIC_NAME_LOL_MAX_CREEP_SCORE: 'Creep Score',
    LEADERBOARD_STATISTIC_NAME_UNKNOWN: 'Unknown Statistic',
    LEADERBOARD_STATISTIC_NAME_MOST_VALUE: 'Most {statisticName}',
    LEADERBOARD_STATISTIC_NAME_LEAST_VALUE: 'Least {statisticName}',
    LEADERBOARD_STATISTIC_NAME_MAX_VALUE: 'Max {statisticName}',
    LEADERBOARD_STATISTIC_NAME_MIN_VALUE: 'Min {statisticName}',
    LEADERBOARD_SETTINGS_MODAL_LEARN_MORE_LINK: 'Learn more about the [Leaderboards]({link})',
    LEADERBOARD_SETTINGS_SIGN_IN_TO_CONNECTION: 'Sign In',
    LEADERBOARD_CONTEXT_MENU_SETTINGS_LABEL: 'Settings',
    LEADERBOARD_GUILD_SETTINGS_MODAL_TITLE: 'Leaderboard Settings',
    LEADERBOARD_GUILD_SETTINGS_MODAL_COMPETITION_SECTION_TITLE: 'The Competition',
    LEADERBOARD_GUILD_SETTINGS_MODAL_COMPETITION_SECTION_LABEL: 'Changes will affect the next round starting on Tuesday at 11am PT.',
    LEADERBOARD_GUILD_SETTINGS_MODAL_STATISTIC_LABEL: 'Competition Statistic',
    LEADERBOARD_GUILD_SETTINGS_MODAL_REWARD_SECTION_TITLE: 'The Reward',
    LEADERBOARD_GUILD_SETTINGS_MODAL_ENABLE_CROWN_LABEL: 'Enable a role icon for the crown',
    QUESTS_WATCH_AGAIN: 'Watch again',
    QUESTS_VIEW_MEDIA_CTA: 'Watch ({remainTime} left)',
    QUESTS_VIEW_MEDIA_CONTINUE_CTA: 'Resume ({remainTime} left)',
    FRACTIONAL_PREMIUM_DURATION_DAYS_SHORT: '{days, plural, =1 {{days} day} other {{days} days}}',
    FRACTIONAL_PREMIUM_DURATION_HOURS_SHORT: '{hours, plural, =1 {{hours} hour} other {{hours} hours}}',
    FRACTIONAL_PREMIUM_DURATION_MINUTES_SHORT: '{minutes, plural, =1 {{minutes} minute} other {{minutes} minutes}}',
    FRACTIONAL_PREMIUM_DURATION_LEFT_DAYS_SHORT: '{days, number}D LEFT',
    FRACTIONAL_PREMIUM_DURATION_LEFT_HOURS_SHORT: '{hours, number}H LEFT',
    FRACTIONAL_PREMIUM_DURATION_LEFT_MINUTES_SHORT: '{minutes, plural, other {}}< 1H LEFT',
    FRACTIONAL_PREMIUM_DURATION_LEFT_DAYS: '{days, plural, =1 {{days} day} other {{days} days}} left',
    FRACTIONAL_PREMIUM_DURATION_LEFT_HOURS: '{hours, plural, =1 {{hours} hour} other {{hours} hours}} left',
    FRACTIONAL_PREMIUM_DURATION_LEFT_MINUTES: '{minutes, plural, =1 {{minutes} minute} other {{minutes} minutes}} left',
    ...
    FRACTIONAL_PREMIUM_CREDIT_HEADER: 'Nitro Credit',
    FRACTIONAL_PREMIUM_CREDIT_DESCRIPTION: 'Credits are stored here and automatically applied. If you have Nitro, credits activate between billing cycles, and your paid subscription will renew once credits are used. [Learn more]({helpCenterLink}).',
    FRACTIONAL_PREMIUM_CREDIT_FROM_QUEST: 'Nitro Credit: {questName} Quest',
    FRACTIONAL_PREMIUM_CREDIT: 'Nitro Credit',
    FRACTIONAL_PREMIUM_TIME_REMAINING: 'Total Time Remaining',
    FRACTIONAL_PREMIUM_ACTIVE: 'Active',
    FRACTIONAL_CREDITS_ACTIVATED: 'Nitro credits activated',
    FRACTIONAL_CREDITS_SUBSCRIPTION_RESUME_INFO: 'Your billing cycle will resume on **{resumeDate, date, medium}**',
    FRACTIONAL_PREMIUM_SETTINGS_HERO_SUBHEADER: 'You have Nitro through **Nitro credits**.\n\n[Learn more.]({helpCenterLink} "Learn more about Nitro credits")',
    FRACTIONAL_PREMIUM_CREDITS_ACTIVATED: 'Nitro Credits Activated',
    FRACTIONAL_PREMIUM_BOOSTING_UNAVAILABLE: 'Boosting is unavailable while Nitro credits are active',
    APP_DIRECTORY_SEARCH_PLACEHOLDER_V2: 'Search Apps',
    APP_DIRECTORY_ABOUT: 'About',
    APP_DIRECTORY_STORE: 'Store',
    NITRO_HOME_REQUIRES_SUBSCRIPTION: 'REQUIRES SUBSCRIPTION',
    PREMIUM_MARKETING_PERKS_DISCOVERABILITY_FRACTIONAL_PREMIUM_BOOSTS_DESCRIPTION: 'TBD text for unavailable boost text lorem ipsum with [text link]({link})'
});

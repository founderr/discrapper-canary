e.exports = Object.freeze({
    ...
    FOR_LATER_TOO_MANY_BODY: "You've reached the limit for saved messages and reminders ({max} total). The message could not be saved. Please remove some to continue saving more.",

...
class o {
    ...
    putAll(e, t, n) {
        let i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : r.Sn.Replace, a = n.map(n => l(e, t, n));
...
class s {
    ...
    trimChannel(e, t, n) {
        this.transaction.messages.trimChannel([
            e,
            t
        ], n);
    }

...
var C = new class e {
  async getAsync(e) {
    let t = performance.now(),
      ...
      r = new Set(i);
    return this.synced = r, h.verbose("loaded in ".concat(s, "ms (guilds: ").concat(n.length, ", synced: ").concat(r.size, " unsynced: ").concat(l.length, ")")), {
      all: n,
      stale: l,
      channels: n.filter(e => {
        let [t, n] = e;
  ...
  onGuildUpdate(e, t, n, a) {
    (n.length > 0 || t.some(e => _(o.default.getBasicChannel(e.id), e))) && this.unsync(e, a)
  }
  onGuildSync(e, t) {
    this.unsync(e, t)
  }

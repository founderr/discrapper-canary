...
function _(e) {
  let {
    ...
    if (!T && !!e) h.default.track(E.rMx.PREMIUM_UPSELL_VIEWED, {
      type: S.cd.CUSTOM_NOTIFICATION_SOUNDS_SETTINGS_UPSELL,
      location: t.location,
      location_stack: _
    }), x(!0)
  }, [t.location, _, T]), O = (0, o.O)(I, .8, !0);
  return (0, n.jsxs)("div", {
    ref: O,
    ...
    children: [(0, n.jsx)(l.NitroWheelIcon, {
      ...
      children: [m.Z.Messages.PREMIUM_CUSTOM_NOTIFICATION_SOUND_NOTIFICATION_SETTINGS_UPSELL, " ", (0, n.jsx)(u.Z, {
        onClick: () => {

...
onClose: t,
handleStartFlow: a
  } = e, s = (0, c.CC)(), g = (0, r.e7)([u.default], () => u.default.locale);
  return (0, n.jsxs)('div', {
className: m.infoContainer,
children: [
  (0, n.jsx)(o.Heading, {
    className: i()(m.finishTitle, {
      [m.finishTitlePadding]: s
    }),
    color: 'header-primary',
    variant: 'heading-xl/bold',
    children: s ? _.Z.Messages.UU_FORCE_MIGRATION_EXISTING_FLOW_REMINDER_BODY_1.format({
      date: (0, d.IE)(g)
  ...
  (0, n.jsx)(o.Text, {
    ...
    children: s ? _.Z.Messages.UU_FORCE_MIGRATION_EXISTING_FLOW_REMINDER_BODY_2.format({
      date: (0, d.IE)(g)

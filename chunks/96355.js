    ...
    (function (e) {
        ...
        var eo = {
            ...
            e_ = function (e, t, n, r, i, a, o, l, u) {
                ...
                var k = ((c = e), (d = t), (_ = n), (E = r), (f = i), (h = a), (p = o), (I = l), (m = P), (g = ((T = U) * (c - _)) / 2 + (m * (d - E)) / 2), (S = (-m * (c - _)) / 2 + (T * (d - E)) / 2), (A = p * p), (N = I * I), (O = g * g), (R = A * N - A * (v = S * S) - N * O) < 0 && (R = 0), (R /= A * v + N * O), (C = (((R = Math.sqrt(R) * (f === h ? -1 : 1)) * p) / I) * S), (y = (-(R * I) / p) * g), (b = s(1, 0, (D = (g - C) / p), (L = (S - y) / I))), (M = s(D, L, (-g - C) / p, (-S - y) / I)), 0 === h && M > 0 && (M -= ed), 1 === h && M < 0 && (M += ed), [T * C - m * y + (c + _) / 2, m * C + T * y + (d + E) / 2, b, M]),
                    B = [],
                    F = k[2],
                    V = k[3],
        ...
        var eg = [
            ...
            eO = function (e, t, n, r, i, a, s, o, l) {
                ...
                var k = ((u = e), (c = t), (d = o), (_ = l), (E = a), (f = s), (h = n), (p = r), (I = P), (g = ((T = U) * (u - d)) / 2 + (I * (c - _)) / 2), (S = (-I * (u - d)) / 2 + (T * (c - _)) / 2), (A = h * h), (N = p * p), (O = g * g), (R = A * N - A * (v = S * S) - N * O) < 0 && (R = 0), (R /= A * v + N * O), (C = (((R = Math.sqrt(R) * (E === f ? -1 : 1)) * h) / p) * S), (y = (-(R * p) / h) * g), (b = m(1, 0, (D = (g - C) / h), (L = (S - y) / p))), (M = m(D, L, (-g - C) / h, (-S - y) / p)), 0 === f && M > 0 && (M -= eN), 1 === f && M < 0 && (M += eN), [T * C - I * y + (u + d) / 2, I * C + T * y + (c + _) / 2, b, M]),
                    B = [],
                    F = k[2],
                    V = k[3],

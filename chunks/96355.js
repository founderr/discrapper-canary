    ...
    (function (e) {
                                ...
                                if (
                                    (t = (function (e, t) {
                                        ...
                                        var l,
                                            ...
                                            d = n.y,
                                            f = 1 / 0;
                                        for (r = n.next; r !== u; ) i >= r.x && r.x >= c && G(a < d ? i : s, a, c, d, a < d ? s : i, a, r.x, r.y) && ((l = Math.abs(a - r.y) / (i - r.x)) < f || (l === f && r.x > n.x)) && V(r, e) && ((n = r), (f = l)), (r = r.next);
                                        return n;
                                    })(e, t))
                                ) {
                                    var n = j(t, e);
                        ...
                        a
                            ? (function (e, t, n, r) {
                                  ...
                                  for (var s = i.x < e.x ? (i.x < a.x ? i.x : a.x) : e.x < a.x ? e.x : a.x, o = i.y < e.y ? (i.y < a.y ? i.y : a.y) : e.y < a.y ? e.y : a.y, l = i.x > e.x ? (i.x > a.x ? i.x : a.x) : e.x > a.x ? e.x : a.x, u = i.y > e.y ? (i.y > a.y ? i.y : a.y) : e.y > a.y ? e.y : a.y, c = U(s, o, t, n, r), d = U(l, u, t, n, r), f = e.nextZ; f && f.z <= d; ) {
                                      if (f !== e.prev && f !== e.next && G(i.x, i.y, e.x, e.y, a.x, a.y, f.x, f.y) && B(f.prev, f, f.next) >= 0) return !1;
                                      f = f.nextZ;
                                  }
                            ...
                            : (function (e) {
                                  ...
                                  for (var r = e.next.next; r !== e.prev; ) {
                                      if (G(t.x, t.y, e.x, e.y, n.x, n.y, r.x, r.y) && B(r.prev, r, r.next) >= 0) return !1;
                                      r = r.next;
                                  }
                                  return !0;
                              })(e))
        ...
        var eo = {
            ...
            ef = function (e, t, n, r, i, a, o, l, u) {
                ...
                var G = ((c = e), (d = t), (f = n), (_ = r), (p = i), (h = a), (m = o), (g = l), (E = w), (b = ((v = M) * (c - f)) / 2 + (E * (d - _)) / 2), (I = (-E * (c - f)) / 2 + (v * (d - _)) / 2), (S = m * m), (T = g * g), (y = b * b), (N = S * T - S * (A = I * I) - T * y) < 0 && (N = 0), (N /= S * A + T * y), (C = (((N = Math.sqrt(N) * (p === h ? -1 : 1)) * m) / g) * I), (R = (-(N * g) / m) * b), (L = s(1, 0, (O = (b - C) / m), (D = (I - R) / g))), (x = s(O, D, (-b - C) / m, (-I - R) / g)), 0 === h && x > 0 && (x -= ed), 1 === h && x < 0 && (x += ed), [v * C - E * R + (c + f) / 2, E * C + v * R + (d + _) / 2, L, x]),
                    B = [],
                    Z = G[2],
                    F = G[3],
        ...
        var eb = [
            ...
            ey = function (e, t, n, r, i, a, s, o, l) {
                ...
                var G = ((u = e), (c = t), (d = o), (f = l), (_ = a), (p = s), (h = n), (m = r), (g = w), (b = ((v = M) * (u - d)) / 2 + (g * (c - f)) / 2), (I = (-g * (u - d)) / 2 + (v * (c - f)) / 2), (S = h * h), (T = m * m), (y = b * b), (N = S * T - S * (A = I * I) - T * y) < 0 && (N = 0), (N /= S * A + T * y), (C = (((N = Math.sqrt(N) * (_ === p ? -1 : 1)) * h) / m) * I), (R = (-(N * m) / h) * b), (L = E(1, 0, (O = (b - C) / h), (D = (I - R) / m))), (x = E(O, D, (-b - C) / h, (-I - R) / m)), 0 === p && x > 0 && (x -= eT), 1 === p && x < 0 && (x += eT), [v * C - g * R + (u + d) / 2, g * C + v * R + (c + f) / 2, L, x]),
                    B = [],
                    Z = G[2],
                    F = G[3],

    ...
    (function (e) {
        ...
        function D(e, t) {
            ...
            return (
                ...
                !i &&
                    ...
                    (function (e, t) {
                        void 0 === t && (t = 1 / 0);
                        for (var n = 0; n < e.length; n++) for (var r = e[n], i = n === e.length - 1 ? e[0] : e[n + 1]; b(r, i) > t; ) (i = S(r, i, 0.5)), e.splice(n + 1, 0, i);
                    })(r, t),
                r
            );
        }
        ...
        var eo = {
            ...
            ef = function (e, t, n, r, i, a, o, l, u) {
                ...
                var B = ((c = e), (d = t), (f = n), (_ = r), (p = i), (h = a), (m = o), (g = l), (E = w), (I = ((v = M) * (c - f)) / 2 + (E * (d - _)) / 2), (b = (-E * (c - f)) / 2 + (v * (d - _)) / 2), (S = m * m), (T = g * g), (y = I * I), (N = S * T - S * (A = b * b) - T * y) < 0 && (N = 0), (N /= S * A + T * y), (C = (((N = Math.sqrt(N) * (p === h ? -1 : 1)) * m) / g) * b), (R = (-(N * g) / m) * I), (L = s(1, 0, (O = (I - C) / m), (D = (b - R) / g))), (x = s(O, D, (-I - C) / m, (-b - R) / g)), 0 === h && x > 0 && (x -= ed), 1 === h && x < 0 && (x += ed), [v * C - E * R + (c + f) / 2, E * C + v * R + (d + _) / 2, L, x]),
                    G = [],
                    Z = B[2],
                    F = B[3],
        ...
        var eI = [
            ...
            ey = function (e, t, n, r, i, a, s, o, l) {
                ...
                var B = ((u = e), (c = t), (d = o), (f = l), (_ = a), (p = s), (h = n), (m = r), (g = w), (I = ((v = M) * (u - d)) / 2 + (g * (c - f)) / 2), (b = (-g * (u - d)) / 2 + (v * (c - f)) / 2), (S = h * h), (T = m * m), (y = I * I), (N = S * T - S * (A = b * b) - T * y) < 0 && (N = 0), (N /= S * A + T * y), (C = (((N = Math.sqrt(N) * (_ === p ? -1 : 1)) * h) / m) * b), (R = (-(N * m) / h) * I), (L = E(1, 0, (O = (I - C) / h), (D = (b - R) / m))), (x = E(O, D, (-I - C) / h, (-b - R) / m)), 0 === p && x > 0 && (x -= eT), 1 === p && x < 0 && (x += eT), [v * C - g * R + (u + d) / 2, g * C + v * R + (c + f) / 2, L, x]),
                    G = [],
                    Z = B[2],
                    F = B[3],
        ...
        (I.prototype.getTotalLength = function () {
            ...
            (I.prototype.getPointAtLength = function (e) {
            ...
            (I.prototype.getTangentAtLength = function () {
            ...
            (I.prototype.getPropertiesAtLength = function (e) {

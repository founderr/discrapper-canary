    ...
    (function (e) {
        ...
        var eo = {
            ...
            e_ = function (e, t, n, r, i, a, o, l, u) {
                ...
                var k = ((c = e), (d = t), (_ = n), (E = r), (f = i), (h = a), (p = o), (I = l), (m = P), (S = ((T = U) * (c - _)) / 2 + (m * (d - E)) / 2), (g = (-m * (c - _)) / 2 + (T * (d - E)) / 2), (A = p * p), (N = I * I), (O = S * S), (v = A * N - A * (R = g * g) - N * O) < 0 && (v = 0), (v /= A * R + N * O), (C = (((v = Math.sqrt(v) * (f === h ? -1 : 1)) * p) / I) * g), (L = (-(v * I) / p) * S), (b = s(1, 0, (D = (S - C) / p), (y = (g - L) / I))), (M = s(D, y, (-S - C) / p, (-g - L) / I)), 0 === h && M > 0 && (M -= ed), 1 === h && M < 0 && (M += ed), [T * C - m * L + (c + _) / 2, m * C + T * L + (d + E) / 2, b, M]),
                    B = [],
                    F = k[2],
                    V = k[3],
        ...
        var eS = [
            ...
            eO = function (e, t, n, r, i, a, s, o, l) {
                ...
                var k = ((u = e), (c = t), (d = o), (_ = l), (E = a), (f = s), (h = n), (p = r), (I = P), (S = ((T = U) * (u - d)) / 2 + (I * (c - _)) / 2), (g = (-I * (u - d)) / 2 + (T * (c - _)) / 2), (A = h * h), (N = p * p), (O = S * S), (v = A * N - A * (R = g * g) - N * O) < 0 && (v = 0), (v /= A * R + N * O), (C = (((v = Math.sqrt(v) * (E === f ? -1 : 1)) * h) / p) * g), (L = (-(v * p) / h) * S), (b = m(1, 0, (D = (S - C) / h), (y = (g - L) / p))), (M = m(D, y, (-S - C) / h, (-g - L) / p)), 0 === f && M > 0 && (M -= eN), 1 === f && M < 0 && (M += eN), [T * C - I * L + (u + d) / 2, I * C + T * L + (c + _) / 2, b, M]),
                    B = [],
                    F = k[2],
                    V = k[3],

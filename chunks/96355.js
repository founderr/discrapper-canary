    ...
    (function (e) {
        ...
        var eo = {
            ...
            e_ = function (e, t, n, r, i, a, o, l, u) {
                ...
                var k = ((c = e), (d = t), (_ = n), (E = r), (f = i), (h = a), (p = o), (I = l), (m = P), (S = ((T = U) * (c - _)) / 2 + (m * (d - E)) / 2), (g = (-m * (c - _)) / 2 + (T * (d - E)) / 2), (A = p * p), (N = I * I), (O = S * S), (v = A * N - A * (R = g * g) - N * O) < 0 && (v = 0), (v /= A * R + N * O), (C = (((v = Math.sqrt(v) * (f === h ? -1 : 1)) * p) / I) * g), (y = (-(v * I) / p) * S), (b = s(1, 0, (L = (S - C) / p), (D = (g - y) / I))), (M = s(L, D, (-S - C) / p, (-g - y) / I)), 0 === h && M > 0 && (M -= ed), 1 === h && M < 0 && (M += ed), [T * C - m * y + (c + _) / 2, m * C + T * y + (d + E) / 2, b, M]),
                    B = [],
                    F = k[2],
                    V = k[3],
        ...
        var eS = [
            ...
            eO = function (e, t, n, r, i, a, s, o, l) {
                ...
                var k = ((u = e), (c = t), (d = o), (_ = l), (E = a), (f = s), (h = n), (p = r), (I = P), (S = ((T = U) * (u - d)) / 2 + (I * (c - _)) / 2), (g = (-I * (u - d)) / 2 + (T * (c - _)) / 2), (A = h * h), (N = p * p), (O = S * S), (v = A * N - A * (R = g * g) - N * O) < 0 && (v = 0), (v /= A * R + N * O), (C = (((v = Math.sqrt(v) * (E === f ? -1 : 1)) * h) / p) * g), (y = (-(v * p) / h) * S), (b = m(1, 0, (L = (S - C) / h), (D = (g - y) / p))), (M = m(L, D, (-S - C) / h, (-g - y) / p)), 0 === f && M > 0 && (M -= eN), 1 === f && M < 0 && (M += eN), [T * C - I * y + (u + d) / 2, I * C + T * y + (c + _) / 2, b, M]),
                    B = [],
                    F = k[2],
                    V = k[3],

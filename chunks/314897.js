...
var a,
    ...
    L = n(981631),
    D = n(723359);
let b = new g.Z('AuthenticationStore'),
    M = 'fingerprint',
    P = 'email_cache',
    U = 'user_id_cache',
    w = null,
...
function eI(e) {
    ...
    !(null !== (t = null == e ? void 0 : e.isSwitchingAccount) && void 0 !== t && t) && (n && eE(), ed()),
        ...
        y.Z.clearAll();
    S.ZH(), v.Z.clearUser(), h.K.remove(U), (w = null), (Z = (null == e ? void 0 : e.isSwitchingAccount) ? L.u34.LOGGING_IN : L.u34.NONE), (Y = L.$ib.NONE), (K = ''), ($ = ''), (q = null), (z = !1), (J = !1), (ee = !1), (et = {}), (en = {}), (eo = !1), (el = !1);
}
        ...
        p.Z,
        {
            ...
            CONNECTION_CLOSED: function (e) {
                ...
                if (4004 === t) {
                    ...
                    O.default.track(L.rMx.APP_USER_DEAUTHENTICATED, { user_id: h.K.get(U) }), eI(), setImmediate(() => (0, A.uL)(L.Z5c.DEFAULT_LOGGED_OUT));
                }
            },
            ...
            LOGIN: function (e) {
                (en = {}), (Z = L.u34.LOGGING_IN), ($ = ''), (i = null), null != e.login && (ea = e.login), el || (el = e.loginMethod === L.nnr.PASSWORD);
            },
            LOGIN_SUCCESS: function (e) {
                let { token: t } = e;
                (Z = L.u34.NONE), ef(t), eE(), (K = ''), (z = !1), (q = null), (eo = !1), ($ = '');
            },
                ...
                (K = ''),
                    ...
                    (Z =
                        ...
                        (en = (function (e) {
                            ...
                            ? L.u34.LOGIN_AGE_GATE
                            : L.u34.NONE);
            },
            LOGIN_MFA_STEP: function (e) {
                let { ticket: t, sms: n, webauthn: r, backup: i, totp: a } = e;
                null != t && ((K = t), (z = n), ($ = ''), (q = null != r ? r : null), (X = i), (Q = a)), (en = {}), (Z = L.u34.MFA_STEP);
            },
            LOGIN_MFA: function () {
                Z = L.u34.LOGGING_IN_MFA;
            },
            LOGIN_MFA_FAILURE: function (e) {
                let { message: t } = e;
                (Z = L.u34.MFA_STEP), (en = { code: t });
            },
            LOGIN_MFA_SMS: function () {
                Z = L.u34.LOGGING_IN_MFA_SMS;
            },
            LOGIN_MFA_SMS_REQUEST_SUCCESS: function (e) {
                let { phone: t } = e;
                (Z = L.u34.MFA_SMS_STEP), ($ = t);
            },
            LOGIN_MFA_SMS_FAILURE: function (e) {
                let { message: t } = e;
                (Z = L.u34.MFA_SMS_STEP), (en = { code: t });
            },
            LOGIN_ACCOUNT_SCHEDULED_FOR_DELETION: function (e) {
                (Z = L.u34.ACCOUNT_SCHEDULED_FOR_DELETION), (r = e.credentials);
            },
            LOGIN_ACCOUNT_DISABLED: function (e) {
                (Z = L.u34.ACCOUNT_DISABLED), (r = e.credentials);
            },
            LOGIN_PASSWORD_RECOVERY_PHONE_VERIFICATION: function () {
                Z = L.u34.PASSWORD_RECOVERY_PHONE_VERIFICATION;
            },
            LOGIN_PHONE_IP_AUTHORIZATION_REQUIRED: function () {
                Z = L.u34.PHONE_IP_AUTHORIZATION;
            },
            LOGIN_RESET: function (e) {
                let { isMultiAccount: t } = e;
                if (((en = {}), (Z = L.u34.NONE), (K = ''), (z = !1), (q = null), (i = null), (r = null), !t)) eh(), ed(!1);
            },
            ...
            LOGIN_SUSPENDED_USER: function (e) {
                ...
                (eo = !1), (es = t), setImmediate(() => (0, A.uL)(L.Z5c.ACCOUNT_STANDING));
            },
            ...
            REGISTER_SUCCESS: function (e) {
                let { token: t } = e;
                (Y = L.$ib.NONE), (i = null), ef(t), eE();
            },
            REGISTER_FAILURE: function (e) {
                let { error: t } = e;
                (en = eu(t)), (Y = null != t.getFieldErrors('date_of_birth') ? L.$ib.REGISTER_AGE_GATE : L.$ib.REGISTER_WITH_ERROR);
            },
            ...
            CLOSE_SUSPENDED_USER: function () {
                (es = null), (Z = L.u34.NONE), eI(), setImmediate(() => (0, A.uL)(L.Z5c.DEFAULT_LOGGED_OUT));
            },
            PASSWORDLESS_FAILURE: function (e) {
                let { error: t } = e;
                (K = ''), (z = !1), (q = null), (eo = !1), (Z = null != (en = eu(t)).date_of_birth ? L.u34.LOGIN_AGE_GATE : L.u34.NONE);
            },

...
var a, o, s, l, u = n(512722), c = n.n(u), d = n(213919), _ = n(756647), E = n(442837), f = n(544891), h = n(433517), p = n(570140), m = n(911969), I = n(109728), T = n(670890), g = n(569611), S = n(710845), A = n(703656), N = n(786213), v = n(626135), O = n(449934), R = n(960048), C = n(117240), y = n(412788), D = n(981631), L = n(723359);
let b = n(952265).nf, M = new S.Z('AuthenticationStore'), P = 'fingerprint', U = 'email_cache', w = 'user_id_cache', x = null, G = null, k = null, B = null, F = null, V = null, H = null, Z = null, Y = D.u34.NONE, j = D.$ib.NONE, W = !1, K = [], z = '', q = !1, Q = null, X = !1, $ = !1, J = '', ee = !1, et = !1, en = {}, er = {}, ei = null, ea = null, eo = null, es = null, el = !1;
function eu(e) {
    let t = {};
...
function ec(e) {
    let t = null != d.getToken(), n = null != h.K.get(D.B1h);
    M.verbose(e, {
...
function ed() {
    ...
    if (!(!(0, A.m1)() || !e && null != t || C.Z.isHandoffAvailable()))
        e_({ withGuildExperiments: !0 });
}
function e_(e) {
    let {withGuildExperiments: t} = e, n = {}, r = v.default.getSuperPropertiesBase64();
    null != r && (n['X-Super-Properties'] = r), null != V && (n['X-Fingerprint'] = V), ea = f.tn.get({
        ...
        ea = null, p.Z.dispatch({ type: 'EXPERIMENTS_FETCH_FAILURE' });
    });
}
function eE() {
...
class eI extends (a = E.ZP.Store) {
    ...
    getMFAMethods() {
        ...
        }), $ && e.push({ type: 'backup' }), q && e.push({ type: 'sms' }), e;
    }
    hasTOTPEnabled() {
...
l = 'AuthenticationStore', (s = 'displayName') in (o = eI) ? Object.defineProperty(o, s, {
    ...
    CONNECTION_CLOSED: function (e) {
        ...
        if (ec('handleConnectionClosed called with code '.concat(t, '.')), 4004 === t) {
            ...
            v.default.track(D.rMx.APP_USER_DEAUTHENTICATED, { user_id: h.K.get(w) }), em(), setImmediate(() => (0, A.uL)(D.Z5c.DEFAULT_LOGGED_OUT));
        }
    },
    ...
    LOGIN_MFA_SMS_FAILURE: function (e) {
        let {message: t} = e;
        Y = D.u34.MFA_SMS_STEP, er = { code: t };
    },

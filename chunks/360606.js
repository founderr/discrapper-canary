...
function v(e) {
    ...
    if (((p = null != i && _.Z.can(T.Plq.MANAGE_WEBHOOKS, i) ? N.Z.getWebhooksForGuild(i.id) : []), !e && null != f)) {
        let e = L(f.id);
        null != e && (f = e);
    }
    if (null != x) {
...
let M = d().debounce(() => {
    R && (null != f ? d().isEqual(f, L(f.id)) && (R = !1) : null != x && d().isEqual(x, j(x.id)) && (R = !1), !R && P.emitChange());
}, 500);
function L(e) {
    return h.find((n) => {
        let { id: t } = n;
    ...
    __OVERLAY__
        ...
        : {
              ...
              INTEGRATION_SETTINGS_UPDATE_WEBHOOK: function (e) {
                  let { settings: n } = e;
                  if (null == x) return !1;
                  (x = { ...x }), null != n.name && x.name !== n.name && ((x.name = n.name), (R = !0)), void 0 !== n.avatar && x.avatar !== n.avatar && ((x.avatar = n.avatar), (R = !0)), null != n.channelId && x.channel_id !== n.channelId && ((x.channel_id = n.channelId), (R = !0)), R && M();
              },
              INTEGRATION_SETTINGS_START_EDITING_WEBHOOK: function (e) {
                  let { webhookId: n } = e,
                      t = j(n);
                  if (null == t) return !1;
                  (x = t), (g = null), (f = null), (A = {}), (R = !1);
              },
              INTEGRATION_SETTINGS_STOP_EDITING_WEBHOOK: function () {
                  (x = null), (A = {}), (R = !1);
              },
              GUILD_SETTINGS_CLOSE: function () {
                  (i = null), (h = []), (p = []), (g = null), (f = null), (x = null), (S = T.QZA.CLOSED), (R = !1);
              },
              GUILD_SETTINGS_LOADED_INTEGRATIONS: function (e) {
                  let { guildId: n, integrations: t } = e;
                  if (null == i || n !== i.id || S === T.QZA.SUBMITTING) return !1;
                  for (let e of ((O = !1), t))
                      if (
                          null ==
                          h.find((n) => {
                  ...
                  for (let e = h.length - 1; e >= 0; e--) {
                      ...
                      } else (null == f ? void 0 : f.id) === n.id && (f = null), h.splice(e, 1);
                  }
                  (h = [...h]), M();
              },
              WEBHOOKS_UPDATE: function (e) {
                  let { guildId: n, channelId: t, webhooks: a } = e;
                  if (null == i || n !== i.id || null == a || S === T.QZA.SUBMITTING) return !1;
                  C = !1;
                  for (let e = p.length - 1; e >= 0; e--) {
                      ...
                      if (null != i) {
                          ...
                          (p[e] = t), !R && (null == x ? void 0 : x.id) === t.id && (x = t);
                      } else (null == x ? void 0 : x.id) === n.id && (x = null), p.splice(e, 1);
                  }
                  for (let e of a)
                      null ==
                          p.find((n) => {

var r, i = n(735250), a = n(470079), o = n(120356), s = n.n(o), l = n(692547), u = n(477690), c = n(481060), d = n(585483), _ = n(624138), E = n(890056), f = n(636879), h = n(810847), p = n(898625), m = n(981631), I = n(382167);
function T(e, t, n) {
...
let g = (0, _.Mg)(u.Z.WAVE_SPLASH_RESPONSIVE_WIDTH_MOBILE), S = 1 / 120;
class A extends (r = a.Component) {
    ...
    renderAnimation() {
        let {canvasFillStyle: e} = this.props, {canvasContext: t} = this;
        if (null != t)
        ...
        return (0, i.jsx)(c.AccessibilityPreferencesContext.Consumer, {
            children: r => {
                ...
                return a.enabled ? (0, i.jsx)('div', {
                    ...
                    className: s()(I.canvas, { [I.embedded]: n }),
                    ref: this.setCanvas
                });
            }
        });
    ...
    constructor(e) {
        super(e), T(this, 'width', 0), T(this, 'height', 0), T(this, 'canvas', void 0), T(this, 'canvasContext', void 0), T(this, 'children', []), T(this, 'wave', void 0), T(this, 'ratio', 0), T(this, '_lastTick', 0), T(this, '_isPlaying', !1), T(this, '_reqAnimId', null), T(this, '_pauseTimeout', void 0), T(this, 'setCanvas', e => {
            var t;
            if (null == e)
                return;
            this.canvas = e, this.canvasContext = this.canvas.getContext('2d');
            let n = null !== (t = window.devicePixelRatio) && void 0 !== t ? t : 1, r = this.canvasContext.webkitBackingStorePixelRatio || this.canvasContext.mozBackingStorePixelRatio || this.canvasContext.msBackingStorePixelRatio || this.canvasContext.oBackingStorePixelRatio || this.canvasContext.backingStorePixelRatio || 1;

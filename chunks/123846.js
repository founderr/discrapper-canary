...
var n = l(735250), a = l(470079), o = l(120356), s = l.n(o), i = l(954955), r = l.n(i), C = l(498607), c = l.n(C), d = l(399606), u = l(481060), m = l(430824), _ = l(246946), E = l(669405), h = l(553826), M = l(893966), x = l(527379), b = l(327999), T = l(734557), L = l(981631), g = l(689938), I = l(289265), p = l(639897);
let H = [
    b.gq.DISCOVERY,
    b.gq.VANITY_URL,
    b.gq.BOT,
...
function f(e) {
    let {
            ...
            vanityUrl: o,
            isFocused: i
        } = e, r = null != a ? a : 16, C = function (e, t) {
            switch (e) {
            case b.gq.BOT:
...
function A(e) {
    let {
            guildId: t,
            onClose: l
        } = e, o = (0, d.e7)([M.Z], () => M.Z.getSearchStateByGuildId(t), [t], c()), {inviteCodes: i} = (0, T.s)(t), C = (0, d.e7)([m.Z], () => m.Z.getGuild(t)), E = null == C ? void 0 : C.vanityURLCode, [A, N] = a.useState(!1), {
    ...
    let v = a.useCallback(e => {
            ...
            t,
            S
        ]), O = a.useCallback(r()(v, 300), [v]), B = a.useCallback(e => {
            O(e);
        }, [O]);
    return (0, n.jsx)(u.Menu, {
        ...
        children: A ? (0, n.jsxs)(u.MenuGroup, {
            children: [
                ...
                H.map(e => (0, n.jsx)(u.MenuRadioItem, {
            ...
            children: [
                ...
                i.map(e => (0, n.jsx)(u.MenuRadioItem, {
                    id: 'join-source-type-option-'.concat(e),
                    label: t => (0, n.jsx)(f, {
                        ...t,
                        type: b.gq.INVITE,

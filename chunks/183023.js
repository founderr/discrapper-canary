...
let W = () => ({
    ...
    Q = (e) => {
        var t, n, a;
        let { node: u, sourceType: I, expressionSourceApplication: S, expressionSourceGuild: N, joinedEmojiSourceGuildRecord: O, closePopout: y, onToggleShowMoreEmojis: b, guildEmoji: M, demoMode: x = !1, nonce: G } = e,

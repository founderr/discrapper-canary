...
class F extends(s = l.Component) {
  ...
  renderFreeButton(e, t) {
    ...
    if (null != r && 0 === r.amount && (!e.premium || (0, D.hasFlag)(e.flags, j.SKUFlags.PREMIUM_AND_DISTRIBUTION))) return (0, U.canUserInstall)(e) && !n ? this.renderButton(b.default.Messages.GAME_ACTION_BUTTON_INSTALL) : this.renderButton(b.default.Messages.GAME_ACTION_BUTTON_ADD_TO_LIBRARY)
  }
  render() {
    let {
      isAuthenticated: e,
  ...
  constructor(...e) {
    super(...e), B(this, "handleViewInStore", e => {
      ...
      if (!s.premium || _ || i || u || m) {
        ...
        var N;
        N = this.analyticsLocation, x.default.track(j.AnalyticEvents.PREMIUM_PROMOTION_OPENED, {
          location: N

...
var a = r(735250), n = r(470079), i = r(120356), o = r.n(i), l = r(392711), c = r.n(l), s = r(876215), d = r(442837), u = r(481060), h = r(570140), m = r(812206), g = r(681619), p = r(810568), b = r(168524), f = r(77498), y = r(71585), x = r(146282), k = r(650613), v = r(789086), _ = r(206583), C = r(262737), w = r(979756);
let j = [
    {
        key: 'type',
    ...
    },
    {
        ...
        render(e) {
            let {type: t} = e;
            return (0, a.jsx)(N, { type: t });
        }
    }
];
function N(e) {
    var t, r;
    let {type: n} = e, i = (0, d.e7)([x.Z], () => x.Z.getFilters()), o = null !== (r = null == i ? void 0 : null === (t = i.types) || void 0 === t ? void 0 : t.has(n)) && void 0 !== r && r;
...
function S() {
    var e;
    let t = (0, d.e7)([x.Z], () => x.Z.getFeed(_.YN.GLOBAL_FEED)), r = (0, d.e7)([x.Z], () => x.Z.getDebugImpressionCappingDisabled()), i = (0, d.e7)([y.Z], () => y.Z.getDebugFastImpressionCappingEnabled()), l = function (e) {
        ...
        }(null == t ? void 0 : null === (e = t.entries) || void 0 === e ? void 0 : e.map(e => e.content)), s = (0, d.e7)([x.Z], () => {
            var e;
            return (null === (e = x.Z.getFeedState(_.YN.GLOBAL_FEED)) || void 0 === e ? void 0 : e.loading) === !0;
        }), [N, S] = n.useState(''), T = (0, d.e7)([
            f.Z,
            m.Z
        ], () => {
            var e, t, r;
        ...
        children: (0, a.jsxs)(u.ScrollerThin, {
            ...
            children: [
                (0, a.jsxs)(u.FormSection, {
                    children: [
                        (0, a.jsx)(u.FormTitle, { children: 'Inventory' }),
                        l.length > 0 && (0, a.jsx)(g.Z, {
                            columns: j,
                            data: l
                        }),
                        (0, a.jsx)(u.Spacer, { size: 8 }),
                        (0, a.jsx)(v.Z, {}),
                        (0, a.jsx)(u.Button, {
                            fullWidth: !0,
                            onClick: function () {
                ...
                (0, a.jsxs)(u.FormSection, {
                    children: [
                        (0, a.jsx)(u.FormTitle, { children: 'Impression Capping' }),
                        (0, a.jsx)(u.Button, {
                            fullWidth: !0,
                            onClick: function () {
                ...
                (0, a.jsxs)(u.FormSection, {
                    children: [
                        (0, a.jsx)(u.FormTitle, { children: 'Game Profile' }),
                        (0, a.jsx)(u.TextInput, {
                            ...
                            style: null != I ? { border: '1px solid green' } : {}
                        })
                    ]
                })
            ]

...
function u(e) {
    let { selfMute: t, serverMute: n, suppress: u, centerButton: h = !1, awaitingRemote: p, onMouseEnter: m, onMouseLeave: f, ...g } = e,
        { mode: C } = (0, c.ZP)({ location: 'MicButton' }),
        x = t || n || u,
        v = h ? d.d : d.Z,
        _ = (0, s.Z)(t, n, u, p, C === c.BK.GroupedButtonsRedMic),
        { Component: I, play: E, events: b } = (0, a.O)(x ? 'unmute' : 'mute');
    l.useEffect(() => () => E(), [E, x]);
    let Z = C === c.BK.GroupedButtonsRedMic && x ? (0, o.Lq)(r.I.RED_400) : void 0,
        N = C !== c.BK.GroupedButtonsRedMic;
    return (0, i.jsx)(v, {
        isActive: !!N && !x,
        iconComponent: I,
        iconColor: Z,

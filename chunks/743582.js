...
var n = s(735250), _ = s(470079), l = s(512722), i = s.n(l), t = s(481060), E = s(935369), o = s(728345), T = s(577275), c = s(153124), r = s(829857), I = s(689938), d = s(857674);
function S(e) {
    var a, s;
    let {
            transitionState: l,
            application: S,
            onClose: N
        } = e, M = (0, c.Dt)(), [A, L] = _.useState(null == S ? void 0 : null === (a = S.team) || void 0 === a ? void 0 : a.id), {teams: C} = (0, T.Z)(), O = _.useMemo(() => C.filter(e => e.payout_account_status === r.C.ACTIVE).map(e => ({
            label: e.name,
            value: e.id
        })), [C]), u = (null == S ? void 0 : null === (s = S.team) || void 0 === s ? void 0 : s.id) !== A, [g, {
                loading: m,
                error: R
            }] = (0, E.Z)(o.Z.transferApplication), x = async () => {
            i()(null != S, 'no application'), i()(null != A, 'no team selected'), null != await g({
                applicationId: S.id,
                teamId: A
            }) && N();

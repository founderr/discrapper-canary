  ...
  INVITE_MODAL_OPEN: function(e) {
    ...
    if (!(t.state === I.InviteStates.EXPIRED || t.state === I.InviteStates.BANNED || t.state === I.InviteStates.ERROR)) {
      ...
      if ((0, f.isMultiUserDM)(e.type)) {
        if (null != p.default.getChannel(e.id)) return (0, c.transitionToGuild)(I.ME, e.id), S.default.focus(), !1
      } else {
        if (null == n) return !1;
        if (null != m.default.getGuild(n.id) && !(0, d.isStreamInvite)(t)) {
          let e = function(e) {
            if ((0, d.isRoleSubscriptionInvite)(e)) return _.StaticChannelRoute.ROLE_SUBSCRIPTIONS;
            let {
              channel: t
            } = e;
            if (null != t) {

...
function ei(e) {
  ...
  let {
    ...
    subsection: s,
    location: u
  } = e, _ = v.default.getGuild(n);
  if (null == _) return er();
  a = o = _, x = U.FormStates.OPEN, V = {}, l = M.default.castGuildIdAsEveryoneGuildRoleId(n), W = o.mfaLevel, X = Q, d = null, K = u, es({
...
function er() {
  B = !1, x = U.FormStates.CLOSED, a = o = null, F = !1, H = null, Y = null, j = 0, q = null, ee = null, et = null, i = null, r = null, s = null, W = U.MFALevels.NONE, u = void 0
}
...
function es(e) {
  ...
  if (i = e.section, r = e.subsection, i === U.GuildSettingsSections.BANS) {
    ...
    !e && O.default.fetchGuildBans(o.id)
  ...
  }) : i === U.GuildSettingsSections.SAFETY && p.default.dispatch({
...
function ea(e) {
  ...
  return new g.default({
    ...
    channel: (0, C.createChannelRecordFromInvite)(e.channel),
    guild: null != e.guild ? new R.default(e.guild) : null,
    uses: e.uses,
    maxUses: e.max_uses,
    maxAge: e.max_age,
...
function eo(e) {
  if (null == o || x !== U.FormStates.OPEN || "GUILD_INTEGRATIONS_UPDATE" === e.type && e.guildId !== o.id) return !1;
  (0, P.fetchGuildIntegrationsApplications)(o.id)
}
class el extends(_ = A.default.Store) {
  initialize() {
    this.waitFor(v.default, D.default)
  }
  getMetadata() {
    return X
  }
  hasChanges() {
    return !f().isEqual(o, a) || !f().isEqual(X, Q)
  }
  isOpen() {
    return B
  }
  ...
  isSubmitting() {
    return x === U.FormStates.SUBMITTING
  }
...
I = "GuildSettingsStore", (E = "displayName") in(c = el) ? Object.defineProperty(c, E, {
  ...
  GUILD_SETTINGS_SUBMIT_FAILURE: function(e) {
    var t;
    x = U.FormStates.OPEN, i = null != i ? i : U.GuildSettingsSections.OVERVIEW, r = null, V = null !== (t = e.errors) && void 0 !== t ? t : {}
  },
  ...
  GUILD_UPDATE_DISCOVERY_METADATA: function(e) {
    ...
    null != o && t === o.id && (X = {
      ...
      reasonsToJoin: null != a ? a : X.reasonsToJoin,

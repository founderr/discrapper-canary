...
var r = n(182823), i = n(470079), a = n(651512), o = n(410914), s = n(846135), l = n(230012);
let u = 'default', c = '', d = new WeakMap();
function _(e) {
    if ((0, r.gn)()) {
        if ('default' === u) {
            let t = (0, r.r3)(e);
    ...
    let {
            ...
            let e = D.current, t = {
                    ...
                    onClick(t) {
                        if ((!t || t.currentTarget.contains(t.target)) && t && 0 === t.button && !e.isTriggeringEvent && !r.nG.isOpening) {
                            ...
                            if (l && t.preventDefault(), !e.ignoreClickAfterPress && !e.ignoreEmulatedMouseEvents && !e.isPressed && ('virtual' === e.pointerType || (0, r.Zj)(t.nativeEvent))) {
                                ...
                                let e = M(t, 'virtual'), i = U(t, 'virtual'), a = P(t, 'virtual');
                                n = e && i && a;
                            }
                    ...
                    if (e.isPressed && e.target && g(t, e.target)) {
                        O(t.target, t.key) && t.preventDefault();
                        let n = t.target, a = P(A(e.target, t), 'keyboard', e.target.contains(n));
            ...
            if ('undefined' != typeof PointerEvent) {
                ...
                t.onTouchStart = t => {
                    ...
                    let n = S(t.nativeEvent, e.activePointerId), r = !0;
...
let M = null, P = new Set(), U = !1, w = !1, x = !1, G = {
        Tab: !0,
        Escape: !0
    };
function k(e, t) {
...
function X(e) {
    let {
        ...
        } = e, o = (0, i.useRef)({ isFocusWithin: !1 }), s = (0, i.useCallback)(e => {
    ...
    let {
            ...
            onPressStart(e) {
                if (e.continuePropagation(), ('mouse' === e.pointerType || 'touch' === e.pointerType) && (n && n({
                        ...
                        e.target.dispatchEvent(new PointerEvent('pointercancel', { bubbles: !0 })), o && o({
                            ...e,
                            type: 'longpress'
                        }), u.current = void 0;
                    ...
                    c(e.target, 'contextmenu', t, { once: !0 }), c(window, 'pointerup', () => {
                        setTimeout(() => {

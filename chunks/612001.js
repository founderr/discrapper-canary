...
if ('undefined' != typeof PointerEvent) {
  t.onPointerDown = t => {
    ...
    let s = !0;
    !e.isPressed && (e.isPressed = !0, e.isOverTarget = !0, e.activePointerId = t.pointerId, e.target = t.currentTarget, !l && !c && (0, r.Ao)(t.currentTarget), !h && _(e.target), s = M(t, e.pointerType), L((0, r.r3)(t.currentTarget), 'pointermove', n, !1), L((0, r.r3)(t.currentTarget), 'pointerup', i, !1), L((0, r.r3)(t.currentTarget), 'pointercancel', a, !1)), s && t.stopPropagation();
  }, t.onMouseDown = e => {
...
function N(e, t) {
  var n, r, i;
  let a, s, o = t.getBoundingClientRect();
  let l = (a = 0, s = 0, void 0 !== (n = e).width ? a = n.width / 2 : void 0 !== n.radiusX && (a = n.radiusX), void 0 !== n.height ? s = n.height / 2 : void 0 !== n.radiusY && (s = n.radiusY), {
top: n.clientY - s,
right: n.clientX + a,
bottom: n.clientY + s,
left: n.clientX - a
...
let t = (t, r) => {
  var i, a, s, o;
  if (i = !!(null == n ? void 0 : n.isTextInput), a = t, s = r, !((i = i || (null == s ? void 0 : s.target) instanceof HTMLInputElement && !q.has(null == s ? void 0 : null === (o = s.target) || void 0 === o ? void 0 : o.type) || (null == s ? void 0 : s.target) instanceof HTMLTextAreaElement || (null == s ? void 0 : s.target) instanceof HTMLElement && (null == s ? void 0 : s.target.isContentEditable)) && 'keyboard' === a && s instanceof KeyboardEvent) || G[s.key])
    e(j());
};
return P.add(t), () => {
  P.delete(t);
...
onHoverEnd: r,
isDisabled: a
  } = e, [s, o] = (0, i.useState)(!1), l = (0, i.useRef)({
isHovered: !1,
ignoreEmulatedMouseEvents: !1,
pointerType: '',
target: null
...
(0 !== i || 0 !== a) && (!s.current.didMove && (s.current.didMove = !0, null == t || t({
  type: 'movestart',
  pointerType: r,
  shiftKey: e.shiftKey,
  metaKey: e.metaKey,
  ...
  if ('undefined' == typeof PointerEvent) {
    ...
    e.onMouseDown = e => {
      0 === e.button && (t(), e.stopPropagation(), e.preventDefault(), s.current.lastPosition = {
        pageX: e.pageX,
        pageY: e.pageY
      }, o(window, 'mousemove', n, !1), o(window, 'mouseup', r, !1));
    };
    let i = e => {
        ...
        if (t >= 0) {
          ...
          u(e, 'touch', o - (null !== (i = null === (n = s.current.lastPosition) || void 0 === n ? void 0 : n.pageX) && void 0 !== i ? i : 0), l - (null !== (a = null === (r = s.current.lastPosition) || void 0 === r ? void 0 : r.pageY) && void 0 !== a ? a : 0)), s.current.lastPosition = {
            pageX: o,
            pageY: l
          };
        }
      ...
      a = e => {
        [...e.changedTouches].findIndex(({
          identifier: e
        }) => e === s.current.id) >= 0 && (c(e, 'touch'), s.current.id = null, l(window, 'touchmove', i), l(window, 'touchend', a), l(window, 'touchcancel', a));
      };
    e.onTouchStart = e => {
      ...
      t(), e.stopPropagation(), e.preventDefault(), s.current.lastPosition = {
        pageX: n,
        pageY: r
      }, s.current.id = l, o(window, 'touchmove', i, !1), o(window, 'touchend', a, !1), o(window, 'touchcancel', a, !1);
    };
  } else {
    let n = e => {
        if (e.pointerId === s.current.id) {
          ...
          u(e, a, e.pageX - (null !== (r = null === (t = s.current.lastPosition) || void 0 === t ? void 0 : t.pageX) && void 0 !== r ? r : 0), e.pageY - (null !== (i = null === (n = s.current.lastPosition) || void 0 === n ? void 0 : n.pageY) && void 0 !== i ? i : 0)), s.current.lastPosition = {
            pageX: e.pageX,
            pageY: e.pageY
          };
        }
    ...
    e.onPointerDown = e => {
      0 === e.button && null == s.current.id && (t(), e.stopPropagation(), e.preventDefault(), s.current.lastPosition = {
        pageX: e.pageX,
        pageY: e.pageY
      }, s.current.id = e.pointerId, o(window, 'pointermove', n, !1), o(window, 'pointerup', r, !1), o(window, 'pointercancel', r, !1));
    };
  }
  let n = (e, n, r) => {

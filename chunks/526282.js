...
t.default = s.memo(function(e) {
  let {
    selectedGame: t,
    onClick: n
  } = e, S = (0, i.useStateFromStores)([o.default], () => o.default.useReducedMotion), p = s.useRef(null), I = s.useRef(null), g = s.useRef(null), T = s.useRef(null), A = s.useRef(null), N = s.useRef(null), v = (0, l.useSpring)({
    ref: p,
    ...m
  }), R = (0, l.useSpring)({
    ref: I,
  ...
  (0, l.useChain)([p, I, g, T, A, N], [.1, .2, .3, .4, .5, 1]), s.useEffect(() => {

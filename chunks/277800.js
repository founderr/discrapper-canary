...
var r = n(149765), i = n(430824), a = n(981631);
let o = [
        a.d4z.GUILD_TEXT,
        a.d4z.GUILD_VOICE,
...
function l(e) {
    if (null == e || !o.includes(e.type))
        return [];
    let t = i.Z.getGuild(e.guild_id);
    return null == t ? [] : Object.values(e.permissionOverwrites).filter(e => {
        var n, a;
        return 0 === e.type && (null === (a = i.Z.getRoles(t.id)[e.id]) || void 0 === a ? void 0 : null === (n = a.tags) || void 0 === n ? void 0 : n.guild_connections) === null && !r.Db(e.deny, s);

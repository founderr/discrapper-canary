...
class T extends o.PureComponent {
  ...
  renderConflict() {
    ...
    return (0, i.jsxs)(r.ModalContent, {
      ...
      }), this.renderConflictButton(A.Z.Messages.CLOUD_SYNC_MODAL_CONFLICT_CHOICE_DOWNLOAD, e.remote.timestamp, O.conflictDownloadArt, this.handleChooseDownload), (0, i.jsxs)(h.Z, {
...
let L = s.ZP.connectStores([p.Z, u.Z], t => {
  let {

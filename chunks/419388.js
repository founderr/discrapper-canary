...
class b {
    ...
    mergePropsAndUpdate_(e) {
        ...
        let r = e.messages.last(),
            s = t.last();
        if (null != r && r.state === _.yb.SENDING && (null == s ? void 0 : s.id) !== r.id) {
    ...
    setScrollToBottom() {
        ...
        if (t.hasMoreAfter) {
            var i, l;
            (i = n), o.Z.jumpToPresent(i.id, _.AQB), (0, h.XU)(null !== (l = i.getGuildId()) && void 0 !== l ? l : _.ME, i.id);
        } else
    ...
    constructor(e) {
        ...
        if (
            ...
            v(this, 'updateVisibleMessagesDebounced', a().debounce(p.JR, 300)),
            ...
            v(this, 'updateStoreDimensionsDebounced', a().debounce(this.updateStoreDimensions, 200)),
            (this.props = e),

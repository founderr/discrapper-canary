...
var n = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(392711), l = s.n(o), c = s(442837), d = s(481060), _ = s(230711), E = s(419363), u = s(857595), T = s(607070), I = s(627845), S = s(786761), N = s(3148), C = s(739566), m = s(753206), A = s(440849), h = s(921801), g = s(196051), O = s(441729), p = s(285952), R = s(153124), x = s(626135), M = s(63063), D = s(695346), f = s(263937), P = s(996073), L = s(526761), Z = s(726985), b = s(981631), v = s(611480), j = s(653477), B = s(689938), U = s(542065), G = s(331651), F = s(328756);
...
function q() {
    let e = (0, c.e7)([T.Z], () => T.Z.syncProfileThemeWithUserTheme), t = a.useRef(null);
...
function J() {
    ...
    let r = B.Z.Messages.ACCESSIBILITY_SETTINGS_SYNC_FORCED_COLORS_DESCRIPTION.format({ learnMoreLink: M.Z.getArticleURL(b.BhN.FORCED_COLORS) });
    return (0, n.jsx)(d.FormItem, {
    ...
    return (0, n.jsxs)(d.FormItem, {
        ...
        children: [
            (0, n.jsx)(d.FormText, {
                type: d.FormText.Types.DESCRIPTION,
                className: G.marginBottom8,
                children: B.Z.Messages.ACCESSIBILITY_PREFERS_REDUCED_MOTION_DESCRIPTION.format({ helpdeskArticle: M.Z.getArticleURL(b.BhN.REDUCED_MOTION) })
            }),
            (0, n.jsx)(d.Checkbox, {
                className: G.marginTop20,
                value: 'auto' === i,
            ...
            (0, n.jsxs)(d.FormItem, {
                ...
                children: [
                    ...
                    (0, n.jsx)(d.Slider, {
                        ...
                        }) : 1 === e ? (0, n.jsx)('span', { children: 'x1.0' }) : e % 1 == 0 ? '' : void 0,
                        'aria-labelledby': Y
                    })
                ]
            })

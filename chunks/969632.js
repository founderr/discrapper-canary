...
let u = { enabled: !1 }, _ = null, I = Object.assign({}, u), E = !1, T = {};
function m() {
    (function () {
        _ = null, I = Object.assign({}, u), E = !1;
    }(), _ = c.Z.getGuildId(), I = i().cloneDeep(Object.assign({}, o.Z.getSettings(_))));
}
function N(e, t) {
    if (null == I.newMemberActions)
        return !1;
...
d(g, 'displayName', 'GuildSettingsOnboardingHomeSettingsStore'), d(g, 'persistKey', 'GuildSettingsOnboardingHomeSettingsStore'), t.Z = new g(l.Z, {
    ...
    GUILD_SETTINGS_ONBOARDING_ADD_NEW_MEMBER_ACTION: function (e) {
        var t;
        let {action: n} = e;
        I.newMemberActions = null !== (t = I.newMemberActions) && void 0 !== t ? t : [], I.newMemberActions = [
            ...I.newMemberActions,
            n
        ];
    },
    ...
    GUILD_SETTINGS_ONBOARDING_ADD_RESOURCE_CHANNEL: function (e) {
        ...
        I.resourceChannels = (null !== (t = I.resourceChannels) && void 0 !== t ? t : []).filter(e => e.channelId !== n.channelId), I.resourceChannels = [
            ...I.resourceChannels,
            n
        ];
    },

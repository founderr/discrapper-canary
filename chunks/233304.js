...
var s, a = n(735250), r = n(470079), i = n(120356), l = n.n(i), o = n(692547), c = n(477690), d = n(624138), _ = n(162168), u = n(937459);
function E(e, t, n) {
...
let T = (0, d.Mg)(c.Z.GRADIENT_PROGRESS_NOTCH_WIDTH), I = Object.freeze({
        BLACK: u.black,
        GRAY: u.gray
    });
class R extends (s = r.Component) {
    ...
    getProgressStyles() {
        let {progress: e} = this.props, t = Math.max(0, Math.min(100, e)), {barWidth: n} = this.state, s = Math.abs(this.roundToNearestStep(n * (100 - t) / 100) - n);
    ...
    getGradientStyles() {
        let {
                ...
                gradientStart: t,
                progress: n
            } = this.props, {barWidth: s} = this.state;
        return {
            width: ''.concat(s, 'px'),
    ...
    render() {
        let {
                className: e,
                notchBackground: t
            } = this.props, {barWidth: n} = this.state;
        return (0, a.jsx)('div', {
            className: u.wrapper,
            ref: this.sizerRef,
    ...
    constructor(...e) {
        super(...e), E(this, 'state', { barWidth: 0 }), E(this, 'sizerRef', r.createRef()), E(this, 'computeBars', () => {

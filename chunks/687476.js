n(47120);
var r, i, a, o, s = n(149765), l = n(442837), u = n(570140), c = n(271383), d = n(430824), _ = n(594174), E = n(973542), f = n(981631);
let h = new Set(), p = new Map(), m = new Map(), I = new Map(), T = new Map(), g = null;
function S(e) {
    let t = _.default.getCurrentUser(), n = d.Z.getGuild(e);
    if (null == n || null == t)
        return !1;
    let r = new Set(), i = new Set(), a = new Set();
    if (T.set(e, n.isOwner(t)), n.hasFeature(f.oNc.ROLE_SUBSCRIPTIONS_ENABLED)) {
        var o, l;
        let u = c.ZP.getMember(e, t.id), _ = new Set(null !== (o = null == u ? void 0 : u.roles) && void 0 !== o ? o : []), h = d.Z.getRoles(n.id);
        for (let t in h) {
            ;
            let n = h[t];

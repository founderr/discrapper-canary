...
function S(e) {
  let {
    ...
    enableHangStatus: I,
    allowChannelTopic: N
  } = e, T = (0, r.useStateFromStores)([u.default], () => u.default.getChannelStatus(t)), A = null != T && T.length > 0, L = (0, r.useStateFromStores)([c.default], () => (!I || !!N) && c.default.can(m.Permissions.SET_VOICE_CHANNEL_STATUS, t)), v = null != S && S.length > 0;
  a.useEffect(() => {

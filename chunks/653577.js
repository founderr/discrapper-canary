...
function _(e) {
  let {
    ...
    enableHangStatus: S,
    allowChannelTopic: N
  } = e, T = (0, r.useStateFromStores)([u.default], () => u.default.getChannelStatus(t)), A = null != T && T.length > 0, L = (0, r.useStateFromStores)([c.default], () => (!S || !!N) && c.default.can(C.Permissions.SET_VOICE_CHANNEL_STATUS, t)), v = null != _ && _.length > 0;
  a.useEffect(() => {

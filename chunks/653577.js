...
function _(e) {
  let {
    ...
    enableHangStatus: I,
    allowChannelTopic: N
  } = e, T = (0, r.useStateFromStores)([u.default], () => u.default.getChannelStatus(t)), A = null != T && T.length > 0, L = (0, r.useStateFromStores)([c.default], () => (!I || !!N) && c.default.can(C.Permissions.SET_VOICE_CHANNEL_STATUS, t)), v = null != _ && _.length > 0;
  a.useEffect(() => {

...
function s(e) {
  var t, s = e.stickerPack,
    l = e.sourceSticker,
    c = e.analyticsLocations,
    f = e.analyticsLocation;
  return i.default.track(a.AnalyticEvents.STICKER_PACK_VIEW_ALL, {
    sticker_id: null == l ? void 0 : l.id,
    sticker_pack_id: s.id,
    location: f,
    location_stack: c
    ...
    return function(e, t) {
      ...
      switch (t.label) {
        case 0:
          return [4, Promise.all([n.e("49237"), n.e("99387"), n.e("29234")]).then(n.bind(n, "345266"))];
        case 1:

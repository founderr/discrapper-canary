...
var r = n(106351), i = n(442837), a = n(424602), o = n(592125), s = n(496675), l = n(231338);
function u(e) {
    var t;
    if (null == e || void 0 === e)
        return !1;
...
function c(e, t) {
    if (null == e)
        return !1;
    let n = u(e), r = s.Z.can(l.Pl.USE_EMBEDDED_ACTIVITIES, e), i = r && s.Z.can(l.Pl.SEND_MESSAGES | l.Pl.USE_APPLICATION_COMMANDS, e);
...
function _(e, t) {
    let n = (0, i.e7)([o.Z], () => o.Z.getChannel(e)), r = (0, i.e7)([s.Z], () => s.Z.can(l.Pl.USE_EMBEDDED_ACTIVITIES, n)), c = u(n), d = null == n ? void 0 : n.guild_id;

...
return !1;
  let n = u(e),
r = s.Z.can(l.Pl.USE_EMBEDDED_ACTIVITIES, e),
i = r && s.Z.can(l.Pl.SEND_MESSAGES | l.Pl.USE_APPLICATION_COMMANDS, e);
...
let n = o.Z.getChannel(e),
  r = s.Z.can(l.Pl.USE_EMBEDDED_ACTIVITIES, n),
  i = r && s.Z.can(l.Pl.SEND_MESSAGES | l.Pl.USE_APPLICATION_COMMANDS, n);
return {
...
d = null == n ? void 0 : n.guild_id;
  return !a.T.useExperiment({
location: t
  }, {
autoTrackExposure: !1
  }).enabled && (null != d ? r && c : c);
}
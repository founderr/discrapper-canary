...
var a, r, s, i, o, l, u, c, d, E, S, m, p = n(735250), D = n(470079), I = n(120356), _ = n.n(I), h = n(920906), N = n(748780), A = n(481060), T = n(704833);
function O(e, t, n) {
...
function M(e) {
    let {animate: t} = e, [n, a] = D.useState(0), r = (0, h.useSprings)(C.length, C.map((e, r) => {
            let s = r > 0 ? j.DELAY_STAGGER * r + Math.random() * (j.DELAY_MAX - j.DELAY_MIN) + j.DELAY_MIN : 0, i = Math.random() * (j.SIZE_MAX - j.SIZE_MIN) + j.SIZE_MIN;
            return {
                from: {

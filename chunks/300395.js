...
class P extends(l = D.PureComponent) {
  ...
  animateEntry(e) {
    N.Z.parallel([N.Z.timing(this.foregroundAnimation.y, {
      toValue: e.toValue,
      duration: e.duration,
      delay: e.delay || 0
  ...
  constructor(...e) {
    super(...e), O(this, "backgroundAnimation", new N.Z.ValueXY({
      ...
      if (!this.didUnmount) this.backgroundAnimation.x.setValue(0), N.Z.timing(this.backgroundAnimation.x, {
      ...
      if (!this.didUnmount) this.foregroundAnimation.x.setValue(0), N.Z.timing(this.foregroundAnimation.x, {
        toValue: B.IDLE_LOOP.toValue,
...
let b = {
  ...
  j = Object.freeze({
    ...
    SIZE_MIN: 7,
    SIZE_MAX: 15,
    EASING_MIDDLE: N.Z.Easing.bezier(.3, .01, 0, .99),
    EASING_END: N.Z.Easing.bezier(0, -.01, .99, 0)
  });
...
class V extends(c = D.PureComponent) {
  ...
  render() {
    ...
    return (0, p.jsxs)("div", {
      ...
      children: [(0, p.jsx)(A.SequencedLottieAnimation, {

...
t.default = function(e) {
  ...
  }, [g.id, g.guild_id, _]), I = h.filter(e => e.type === m.StageChannelParticipantTypes.VOICE), A = 4 === I.length ? 2 : 3, x = (0, s.useStateFromStoresArray)([o.default], () => I.map(e => o.default.getParticipant(g.id, e.id)).filter(f.isNotNullish), [g.id, I]);
  return (0, a.jsxs)("div", {

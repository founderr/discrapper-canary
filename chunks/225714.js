...
function S(e) {
  ...
  } = (0, I.KZ)(), T = (0, l.e7)([u.ZP], () => !u.ZP.disableCallUserConfirmationPrompt), M = (0, _.Z)({
    user: o,
    onClose: C
  });
  if (n || S === f.OGo.BLOCKED) return null;
  let A = () => {
      R({
        action: "SEND_MESSAGE"
      }), r.Z.openPrivateChannel(o.id, !1, !1, p), C()
    },
    j = () => {
      R({
        action: "VOICE_CALL"
      }), r.Z.openPrivateChannel(o.id, !0), C()
    },
    P = N ? (0, t.jsx)(E.Z, {
      variant: "icon",
  ...
  if (h) {
    if (S === f.OGo.FRIEND && g && null != M) return (0, t.jsxs)("div", {
    ...
    if (S === f.OGo.FRIEND || o.bot) return (0, t.jsxs)("div", {
      className: m.multipleButtons,
      children: [P, (0, t.jsx)(E.Z, {
        variant: "text",
        text: Z.Z.Messages.SEND_DM,
        icon: a.ChatIcon,
        color: s()(a.Button.Colors.PRIMARY, m.color),
    ...
    if (S === f.OGo.PENDING_OUTGOING) return g && null != M ? (0, t.jsxs)("div", {
      className: m.multipleButtons,
      children: [(0, t.jsx)(E.Z, {
        variant: "icon",
    ...
    if (S === f.OGo.PENDING_INCOMING) return g && null != M ? (0, t.jsxs)("div", {
      className: m.multipleButtons,
      children: [(0, t.jsx)(E.Z, {
        variant: "icon",
        text: Z.Z.Messages.FRIENDS_SECTION_PENDING,
  ...
  if (S === f.OGo.FRIEND || o.bot) return x ? (0, t.jsx)(E.Z, {
    variant: "text",
    text: Z.Z.Messages.SEND_DM,
    color: s()(a.Button.Colors.PRIMARY, m.color),
    onClick: A
  ...
  if (S === f.OGo.PENDING_OUTGOING) return (0, t.jsx)(E.Z, {
    variant: "text",
    text: Z.Z.Messages.ADD_FRIEND_BUTTON_AFTER,
    color: a.Button.Colors.GREEN,
    disabled: !0
  });
  if (S === f.OGo.PENDING_INCOMING) return x ? (0, t.jsx)(E.Z, {
    variant: "text",
    text: Z.Z.Messages.SEND_DM,
    color: s()(a.Button.Colors.PRIMARY, m.color),
    onClick: A

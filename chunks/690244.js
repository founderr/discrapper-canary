var r, i = n(401801), a = n(104509), o = n(333567), s = n(284456), l = n(429675), u = n(815329), c = n(102099), d = Function, _ = function (e) {
        try {
        } catch (e) {
        }
...
var f = function () {
    ...
    }() : f, p = n(322499)(), m = n(79536)(), I = Object.getPrototypeOf || (m ? function (e) {
        return e.__proto__;
    } : null), T = {}, g = 'undefined' != typeof Uint8Array && I ? I(Uint8Array) : r, S = {
        __proto__: null,
...
var N = function e(t) {
    ...
    }, O = n(390976), R = n(706165), C = O.call(Function.call, Array.prototype.concat), y = O.call(Function.apply, Array.prototype.splice), D = O.call(Function.call, String.prototype.replace), L = O.call(Function.call, String.prototype.slice), b = O.call(Function.call, RegExp.prototype.exec), M = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, P = /\\(\\)?/g, U = function (e) {
...
e.exports = function (e, t) {
    ...
    var n = U(e), r = n.length > 0 ? n[0] : '', i = w('%' + r + '%', t), a = i.name, o = i.value, s = !1, c = i.alias;
    c && (r = c[0], y(n, C([
        0,
        1
    ], c)));
    for (var d = 1, _ = !0; d < n.length; d += 1) {
        var f = n[d], h = L(f, 0, 1), p = L(f, -1);
        if (('"' === h || '\'' === h || '`' === h || '"' === p || '\'' === p || '`' === p) && h !== p)

...
var N = function e(t) {
    ...
    v = n(390976),
    R = n(706165),
    C = v.call(Function.call, Array.prototype.concat),
...
e.exports = function (e, t) {
    ...
    if (null === b(/^%?[^%]*%?$/, e)) throw new l('`%` may not be present anywhere but at the beginning and end of the intrinsic name');
    var n = U(e),
        r = n.length > 0 ? n[0] : '',
        i = w('%' + r + '%', t),
        a = i.name,
    ...
    for (var d = 1, _ = !0; d < n.length; d += 1) {
        ...
        if ((('constructor' === f || !_) && (o = !0), (r += '.' + f), R(S, (a = '%' + r + '%')))) s = S[a];
        else if (null != s) {
            if (!(f in s)) {

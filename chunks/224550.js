...
null != N && (n = N.interval, t = N.intervalCount);
  let C = (0, r.K)({
...
h = '';
  if (A) {
if (null != T && (null == L ? void 0 : L.subscriptionPeriodEnd) != null)
  O = _.Z.Messages.EMBEDDED_ACTIVITIES_IAP_NON_REFUNDABLE_SUBSCRIPTION_RATE_AND_RENEWAL_V2.format({
    subtotalRate: d
  });
else
  switch (n) {
    case I.rV.MONTH:
      O = 1 === t ? _.Z.Messages.EMBEDDED_ACTIVITIES_IAP_NON_REFUNDABLE_SUBSCRIPTION_MONTHLY_V2.format({}) : _.Z.Messages.EMBEDDED_ACTIVITIES_IAP_NON_REFUNDABLE_SUBSCRIPTION_MULTI_MONTH_V2.format({
        intervalCount: t
      });
      break;
    case I.rV.YEAR:
...
switch (M && (h = _.Z.Messages.BILLING_LEGAL_MUMBO_JUMBO_TERMS_LABEL_V2.format({
    primaryText: C,
    paidURL: u.EYA.PAID_TERMS
  })), n) {
  case I.rV.MONTH:
    O = M ? _.Z.Messages.PREMIUM_PAYMENT_GIFT_SUBTEXT_MONTHLY : _.Z.Messages.SUBSCRIPTION_PAYMENT_LEGALESE_MONTHLY, O = M ? _.Z.Messages.PREMIUM_PAYMENT_GIFT_SUBTEXT_MONTHLY : 1 === t ? _.Z.Messages.SUBSCRIPTION_PAYMENT_LEGALESE_MONTHLY : _.Z.Messages.SUBSCRIPTION_PAYMENT_LEGALESE_MULTI_MONTH.format({
      intervalCount: t
    });
    break;
  case I.rV.YEAR:
...
O = (null == p ? void 0 : p.isPaused) ? _.Z.Messages.SUBSCRIPTION_PAYMENT_LEGALESE_RESUME.format({
  primaryText: s,
  rate: e,
  paidURL: u.EYA.PAID_TERMS,
  contactLink: u.EYA.CONTACT,
  helpdeskArticle: i.Z.getArticleURL(u.BhN.BILLING)
}) : null != p && (0, o.GY)(p, N.id, v) ? _.Z.Messages.SUBSCRIPTION_PAYMENT_LEGALESE_PLAN_CHANGE_V2.format({
  primaryText: s,
  rate: e,
  paidURL: u.EYA.PAID_TERMS,
  contactLink: u.EYA.CONTACT,

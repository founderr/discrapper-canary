...
class O extends(a = r.default.PersistedStore) {
  initialize(e) {
    N = null != e ? e : I, this.syncWith([f.default], M)
  }
  getState() {
    return N
  }
...
m(O, "displayName", "SurveyStore"), m(O, "persistKey", "SurveyStore"), m(O, "migrations", [e => {
  ...
  CONNECTION_OPEN: function() {
    var e;
    if (!(null != N.lastFetched && Date.now() - (null !== (e = N.lastFetched) && void 0 !== e ? e : 0) < C) || null != N.surveyOverride)(0, u.surveyFetch)(N.surveyOverride, !0)
  },
  SURVEY_FETCHED: g,
  SURVEY_HIDE: function(e) {
    ...
    N.hiddenSurveys[t] = !0, S = null, p = null != p ? p : {}, delete p[t]
  },

    ...
    return (0, s.jsxs)('div', {
        children: [
            (null === (a = u.default.getCurrentUser()) || void 0 === a ? void 0 : a.nsfwAllowed) ? (0, s.jsxs)('div', {
                ...
                children: [
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.visa, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.mastercard, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.discover, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.amex, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.jcb, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.dinersclub, m.cardFormHeader) })
                ]
            }) : (0, s.jsxs)('div', {
                className: m.cardBrands,
                children: [
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.visa_monochrome, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.mastercard_monochrome, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.discover_monochrome, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.amex_monochrome, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.jcb_monochrome, m.cardFormHeader) }),
                    (0, s.jsx)('div', { className: i()(d.Uy.SMALL, m.dinersclub_monochrome, m.cardFormHeader) })
                ]
            }),
            (0, s.jsx)(E.Z, {
                form: [

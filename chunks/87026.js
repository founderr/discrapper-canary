...
var a = t(735250), l = t(470079), i = t(120356), n = t.n(i), o = t(149765), r = t(442837), c = t(692547), d = t(780384), _ = t(481060), E = t(785697), N = t(933557), I = t(434404), T = t(764260), M = t(999382), m = t(416162), x = t(422559), u = t(210887), L = t(984933), O = t(430824), C = t(699516), h = t(594174), p = t(153124), A = t(626135), S = t(63063), f = t(700785), g = t(245315), v = t(135899), b = t(981631), D = t(689938), j = t(613991), R = t(289575), U = t(371411), B = t(112847), P = t(516954), Z = t(674889), F = t(162752), Y = t(438825);
let y = e => {
        let {
                guild: s,
...
function w(e) {
    let {guild: s} = e, t = (0, r.e7)([O.Z], () => O.Z.getRole(s.id, s.getEveryoneRoleId()));
    if (null == t)
        return null;
    let {
        name: l,
...
s.default = e => {
    ...
    l.useEffect(() => {
        A.default.track(b.rMx.OPEN_MODAL, { type: v.tA });
    }, []);
    let {guild: n} = (0, r.cj)([M.Z], () => M.Z.getProps()), c = (0, r.e7)([u.Z], () => u.Z.theme), [d, _] = l.useState(!1), [x, S] = l.useState(!v.$X.some(e => f.oz(e, n))), [g, R] = l.useState(v.b4), [U, B] = l.useState(v.b4), [P] = l.useState(null == n ? void 0 : n.defaultMessageNotifications), [Z] = l.useState(null == n ? void 0 : n.verificationLevel), [F] = l.useState(null == n ? void 0 : n.explicitContentFilter), [w] = l.useState(x), H = (0, r.e7)([O.Z], () => null != n ? O.Z.getRole(n.id, n.getEveryoneRoleId()) : void 0), V = (0, r.e7)([L.ZP], () => null != n ? L.ZP.getChannels(n.id) : null), q = (0, p.Dt)(), {enabled: W} = (0, E.D2)(null !== (s = null == n ? void 0 : n.id) && void 0 !== s ? s : b.lds);
    if (null == n)
        return null;
    let X = [{
            value: v.b4,
    ...
    let Q = Z !== b.sFg.NONE, K = F === b.lxg.ALL_MEMBERS, $ = P === b.bL.ONLY_MENTIONS, J = async () => {
            if (null == H || !d)
                return;
            let e = new Set(n.features);
            e.add(b.oNc.COMMUNITY);
            let s = x ? o.Od(H.permissions, v.mu) : H.permissions, t = {
                    ...H,
                    permissions: s
                };
            ...
            onAcceptVerificationLevel: (e, s) => {
                if (!s) {
                    I.Z.updateGuild({ verificationLevel: Z });
                    return;
                }
                s && I.Z.updateGuild({ verificationLevel: b.sFg.LOW });
            },
            onAcceptContentFilter: (e, s) => {
                if (!s) {
                    I.Z.updateGuild({ explicitContentFilter: F });
                    return;
                }
                I.Z.updateGuild({ explicitContentFilter: b.lxg.ALL_MEMBERS });
            },
            headerId: q,
            theme: c
        }), es = (0, a.jsx)(G, {
            ...
            onAcceptPolicy: (e, s) => {
                if (s) {
                    _(!0), !$ && I.Z.updateGuild({ defaultMessageNotifications: b.bL.ONLY_MENTIONS }), !x && null != H && S(!0);
                    return;
                }
                _(!1), $ && I.Z.updateGuild({ defaultMessageNotifications: P }), x && null != H && S(!1);
            },
            headerId: q,
            theme: c
        }) : (0, a.jsx)(k, {
            ...
            onAcceptDefaultNotifications: (e, s) => {
                if (!s) {
                    I.Z.updateGuild({ defaultMessageNotifications: P });
                    return;
                }
                I.Z.updateGuild({ defaultMessageNotifications: b.bL.ONLY_MENTIONS });
            },
    ...
    return (0, a.jsx)(m.Z, {
        ...
        transitionState: t,
        onClose: () => {
            i(), A.default.track(b.rMx.MODAL_DISMISSED, { type: v.tA });
        },

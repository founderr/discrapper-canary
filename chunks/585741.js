var r = n(546299), i = n(261638), a = n(411108), o = n(21841), s = r.sum32, l = r.sum32_4, u = r.sum32_5, c = a.ch32, d = a.maj32, _ = a.s0_256, E = a.s1_256, f = a.g0_256, h = a.g1_256, p = i.BlockHash, m = [
        1116352408,
        1899447441,
        3049323471,
        3921009573,
...
r.inherits(I, p), e.exports = I, I.blockSize = 512, I.outSize = 256, I.hmacStrength = 192, I.padLength = 64, I.prototype._update = function (e, t) {
    ...
    var i = this.h[0], a = this.h[1], p = this.h[2], m = this.h[3], I = this.h[4], T = this.h[5], g = this.h[6], S = this.h[7];
    for (o(this.k.length === n.length), r = 0; r < n.length; r++) {
        var A = u(S, E(I), c(I, T, g), this.k[r], n[r]), N = s(_(i), d(i, a, p));

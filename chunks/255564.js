...
class c {
    ...
    get canUsePremiumProfileCustomization() {
        return o.ZP.isPremiumAtLeast(this.premiumType, s.p9.TIER_2);
    }
    get canEditThemes() {

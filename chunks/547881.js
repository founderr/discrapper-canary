...
o = { disableScroll: !1 }, (a = 'defaultProps') in (s = C) ? Object.defineProperty(s, a, {
    value: o,
    enumerable: !0,
    configurable: !0,
    writable: !0
...
v.Background = e => {
    ...
    return (0, r.jsx)(Z.Consumer, {
        children: e => {
            let {opacity: s} = e, a = { backgroundColor: 'rgba(54, 57, 63, '.concat('' + (null != n ? n : s), ')') };

...
setPopout: M
  } = e, b = v.state === m.Y.LOADED ? v.message : void 0, R = (0, E.Uj)(b), j = (0, c.p)(), L = (0, u.A)((null !== (t = n.editedTimestamp) && void 0 !== t ? t : n.timestamp).valueOf()), P = a.useMemo(() => {
if (null == b)
  return null;
let e = (0, r.Z)(b);
...
L,
j
  ]), O = (0, s.e7)([p.Z], () => null != b && p.Z.isBlockedForMessage(b), [b]), y = (0, I.wq)(null == b ? void 0 : b.author.id, N.id), D = (0, I.$3)(n, b, O), k = (0, I.Wl)(b, N, Z, M), U = (0, I.rY)(A, M), w = a.useCallback(() => M({
...
referencedAvatarProfile: u
  } = n, d = l.type === x.uaV.REPLY && null != a && (0, i.jsx)(v, {
baseMessage: l,
replyReference: a,
referencedMessage: s,
channel: r,

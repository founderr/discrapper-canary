...
class N extends (u = d.ZP.Store) {
    initialize() {
        !1 !== f.K.get(I) && (T = E.isPlatformEmbedded && 'stable' === window.GLOBAL_ENV.RELEASE_CHANNEL);
    }
    isHandoffAvailable() {
        return !v.s.isDisallowPopupsSet() && T;
    }
    get user() {
        return a;
    }

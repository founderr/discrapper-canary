...
onError: t,
onSuccess: n
  } = null != e ? e : {}, [o, c] = s.useState(!1), [d, _] = s.useState(!1), [u, E] = s.useState(!1), [T, I] = s.useState(!1), [R, C] = s.useState(!1), [g, p] = s.useState(!1), [A, N] = s.useState(!1), [m, f] = s.useState(!1), S = o || d || u || T || g || m, h = s.useCallback(async e => {
if (!S) {
  c(!0);
  try {

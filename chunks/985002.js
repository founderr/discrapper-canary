...
function o(e) {
  let {
    onError: t,
    onSuccess: n
  } = null != e ? e : {}, [o, c] = s.useState(!1), [d, _] = s.useState(!1), [E, u] = s.useState(!1), [T, I] = s.useState(!1), [R, C] = s.useState(!1), [g, p] = s.useState(!1), [A, N] = s.useState(!1), [m, S] = s.useState(!1), f = o || d || E || T || g || m, h = s.useCallback(async e => {
    if (!f) {
      c(!0);
      try {

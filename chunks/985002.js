...
function o(e) {
  let {
    onError: t,
    onSuccess: s
  } = null != e ? e : {}, [o, u] = n.useState(!1), [d, c] = n.useState(!1), [E, _] = n.useState(!1), [f, h] = n.useState(!1), [C, m] = n.useState(!1), [T, g] = n.useState(!1), [A, p] = n.useState(!1), [N, S] = n.useState(!1), I = o || d || E || f || T || N, x = n.useCallback(async e => {
    if (!I) {
      u(!0);
      try {

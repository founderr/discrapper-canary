...
x = r.useMemo(() => P.find(e => e.id === L), [
  P,
  L
]);
  let Z = (n = p, t = x, l = null, n && null != t && !t.canRedeemTrial() ? l = d.Z.Messages.PAYMENT_SOURCE_REDEMPTION_INVALID : n && null != t && t.hasFlag(T.Cw.NEW) && (l = d.Z.Messages.BILLING_PAYMENT_AUTHORIZATION_CHARGE.format({

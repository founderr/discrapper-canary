...
class c extends l.Z {
  ...
  constructor({
    ...
    if (super(a.He.POST_MESSAGE, s, l), o(this, "origin", void 0), o(this, "frameId", void 0), o(this, "postMessageToRPCClient", void 0), o(this, "logger", void 0), o(this, "postClose", void 0), o(this, "onSendingToRPCClient", void 0), o(this, "closed", void 0), -1 === ["etf", "json"].indexOf(l)) throw new i.Z({
      closeCode: r.$VG.INVALID_ENCODING
    }, "Invalid Encoding: ".concat(l));
    if ("etf" === l) throw new i.Z({
      closeCode: r.$VG.INVALID_ENCODING

...
var r = n(956067);
n(17089);
var i = n(218543), a = n(594174), o = n(626135), s = n(981631);
function l(e, t, n, a, l) {
    ...
    let _ = function (e) {
        ...
        try {
            let e = JSON.parse(t);
            null != e[0] && '' !== e[0] && e[0].startsWith('gateway-') && (n.identify_total_server_duration_ms = Math.floor(e[1].micros / 1000)), function e(t, n) {
    ...
    i.Z.attachReadyPayloadProperties(E), o.default.track(s.rMx.READY_PAYLOAD_RECEIVED, E, { logEventProperties: !0 });
}
function u(e) {
    try {
        var t;

...
var r = n(564334), i = n(302221), a = n(563114);
let o = e => {
        var t, n;
        let {
            colors: a,
        ...
        if (null == a || a.length < 1)
            return null;
        let s = (0, i.YD)(a), l = r.Z.parseString('#ffffff');
        if (null == l)
            return null;
        ...
        if (null == c)
            return null;
        let d = (0, i.AZ)(c.red, c.blue, c.green), _ = null !== (t = (0, i.k8)({
                colors: [
                    (0, i.j)(c, 0.6, !0),
                    l
                ],

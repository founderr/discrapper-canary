r.r(t), r(47120);
var n = r(735250), u = r(470079), s = r(855095);
let d = window.GLOBAL_ENV.PUBLIC_PATH;
d.endsWith('/') && (d = d.substring(0, d.length - 1)), s.OGVLoader.base = d, t.default = u.forwardRef(function (e, t) {
    let {
            className: r,
            src: d,
            playing: a,
    ...
    return u.useImperativeHandle(t, () => p, [p]), u.useEffect(() => {
        ...
        if (null != f)
            return p.addEventListener('ended', f), () => {
        ...
        if (null != i)
            return p.addEventListener('loadedmetadata', i), () => {
        ...
        if (null != o)
            return p.addEventListener('error', o), () => {

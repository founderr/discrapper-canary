var r = n(266067), i = n(544891), a = n(570140), o = n(38618), s = n(131704), l = n(592125), u = n(944486), c = n(981631), d = n(176505);
let _ = {}, E = !1;
function f(e) {
    ...
    if (E || (E = !0, a.Z.subscribe('CONNECTION_OPEN', () => {
            _ = {};
            let e = u.Z.getChannelId(), t = l.Z.getChannel(e);
            null != e && null == t && f(e);
        })), !o.Z.isConnected())
        return Promise.resolve();
    let t = _[e];
    ...
    let n = (0, r.LX)(location.pathname, {
            ...
            let {body: r} = t;
            if (_[e] = { type: 'LOADED' }, s.Ec.has(r.type)) {
                var i;
                a.Z.dispatch({
                    type: 'THREAD_CREATE',
                    channel: (0, s.q_)(r),
            ...
            var t;
            _[e] = { type: 'NOT_FOUND' }, a.Z.dispatch({
                type: 'CHANNEL_DELETE',
                channel: {
                    id: e,

...
var i = n(470079), a = n(392711), s = n.n(a), l = n(442837), r = n(159300), o = n(901461), c = n(314897), d = n(592125), u = n(984933), h = n(650774), p = n(430824), m = n(819640), _ = n(375954), f = n(496675), E = n(709054), C = n(981631);
function g(e, t) {
    return (0, l.cj)([f.Z], () => ({
...
function I(e) {
    ...
    return {
        guildPopulated: function (e) {
            let t = (0, l.e7)([d.Z], () => d.Z.getChannel(null == e ? void 0 : e.systemChannelId)), n = (0, l.Wu)([_.Z], () => null != t ? _.Z.getMessages(t.id).toArray() : []);
            return (0, l.e7)([h.Z], () => {
                var t;
        ...
        guildPersonalized: function (e) {
            let t = (0, l.e7)([m.Z], () => m.Z.hasLayers()), n = (0, l.e7)([p.Z], () => p.Z.getGuild(null == e ? void 0 : e.id));
            return (null == n ? void 0 : n.icon) != null && !t;
        }(e),
        guildChannelCreated: (t = e, (0, l.e7)([u.ZP], () => {
            let e = u.ZP.getChannels(null == t ? void 0 : t.id), n = e[u.Zb];
            function i(e) {

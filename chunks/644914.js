...
var i = n(470079), a = n(392711), l = n.n(a), s = n(442837), r = n(159300), o = n(901461), c = n(314897), d = n(592125), u = n(984933), h = n(650774), p = n(430824), m = n(819640), _ = n(375954), f = n(496675), E = n(709054), C = n(981631);
function g(e, t) {
    return (0, s.cj)([f.Z], () => ({
...
function I(e) {
    ...
    return {
        guildPopulated: function (e) {
            let t = (0, s.e7)([d.Z], () => d.Z.getChannel(null == e ? void 0 : e.systemChannelId)), n = (0, s.Wu)([_.Z], () => null != t ? _.Z.getMessages(t.id).toArray() : []);
            return (0, s.e7)([h.Z], () => {
                var t;

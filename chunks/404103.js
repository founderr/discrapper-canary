...
class N extends s.default {
  ...
  handleReaction(e) {
    ...
    (0, E.trackFeedItemInteracted)({
      ...
      action_type: "MESSAGE_REACTION_ADD" === t ? v.FeedItemInteractionType.REACTION_ADDED : v.FeedItemInteractionType.REACTION_REMOVED,
      guild_id: s,
  ...
  handleMessageCreate(e) {
    ...
    if (null != m) {
      if (n.type === C.MessageTypes.DEFAULT) t = v.FeedItemInteractionType.MESSAGED_IN_SIDEBAR, a = c;
      else if (n.type === C.MessageTypes.REPLY) {
        var h, _;
        a = null === (h = n.message_reference) || void 0 === h ? void 0 : h.message_id, t = (null === (_ = n.message_reference) || void 0 === _ ? void 0 : _.message_id) === c ? v.FeedItemInteractionType.REPLIED_TO_MESSAGE : v.FeedItemInteractionType.REPLIED_IN_SIDEBAR
      }

var n = r(546870), i = r(195961), o = r(65183), a = r(581079), u = o.OrderedMap, s = o.List, c = function (t, e, r) {
        if (!t)
            return;
        var n = e.get(t);
        if (!!n)
        ...
        if (!i)
            return t;
        var o = 'after' === n, a = e.getKey(), u = r.getKey(), l = e.getParentKey(), f = e.getNextSiblingKey(), p = e.getPrevSiblingKey(), h = r.getParentKey(), d = o ? r.getNextSiblingKey() : u, g = o ? u : r.getPrevSiblingKey();
        return t.withMutations(function (t) {
            c(l, t, function (t) {
                ...
                var e = t.getChildKeys(), r = e.indexOf(u), n = e.toArray();
...
t.exports = function (t, e, r, o) {
    'replace' !== o || a(!1);
    var s = r.getKey(), c = e.getKey();
    c !== s || a(!1);
    var f = t.getBlockMap(), p = e instanceof n, h = [e], d = f.delete(c);
    p && (h = [], d = f.withMutations(function (t) {
        var r = e.getNextSiblingKey(), n = i(e, t);
        t.toSeq().skipUntil(function (t) {
            return t.getKey() === c;
        }).takeWhile(function (t) {
            var e = t.getKey(), i = e === c, o = !r && t.getParentKey() && (!n || e !== n);
            return !!(i || r && e !== r || o);
        }).forEach(function (e) {

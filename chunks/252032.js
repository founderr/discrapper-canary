...
var i = n(735250), a = n(470079), l = n(442837), s = n(904245), r = n(257559), o = n(541716), c = n(893718), d = n(314897), u = n(323873), h = n(430824), p = n(496675), m = n(585483), _ = n(630388), f = n(838440), E = n(930282), C = n(955384), g = n(981631), I = n(848509);
function x(e) {
    let {
        value: t,
        channel: n
...
function T(e) {
    let {
            channel: t,
            message: n
        } = e, {id: o} = t, {id: c} = n, m = t.getGuildId(), f = (0, l.e7)([h.Z], () => h.Z.getGuild(m), [m]), E = t.type === g.d4z.GUILD_ANNOUNCEMENT, T = null != f && f.hasFeature(g.oNc.NEWS), N = E && T, {
            editingMessage: S,
            editingTextValue: Z,
            editingRichValue: A
        } = (0, l.cj)([u.Z], () => ({
            ...
            return N && (o === M || l) && null != S && (0, _.yE)(S.flags, g.iLy.CROSSPOSTED) ? r.Z.confirmEdit(e, n, a) : s.Z.editMessage(e, n, { content: a }), Promise.resolve();
        }, [
            S,
            N,
            M,

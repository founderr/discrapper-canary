...
function L(e) {
    let { handleStepChange: s, handleClose: n } = e,
        r = (0, o.ZP)(),
        { activeSubscription: L, selectedSkuId: f, setSelectedPlanId: I, startedPaymentFlowWithPaymentSourcesRef: E } = (0, c.usePaymentContext)(),
        { isGift: M } = (0, u.wD)(),
    ...
    return (
        ...
        (0, t.jsx)(C.Z, {
            ...
            subtitleText: x.Z.Messages.PREMIUM_DOWNGRADE_WHAT_YOU_LOSE_SUBTITLE.format({ subscriptionName: j }),
            footer: (0, t.jsxs)('div', {
                className: h.whatYouLoseButtonContainer,
                children: [
                    (0, t.jsx)(a.Button, {
                        onClick: () => {
                            T ? (I((0, p.nA)(f, L)), s(_.h8.REVIEW)) : s(_.h8.PLAN_SELECT);
                        },

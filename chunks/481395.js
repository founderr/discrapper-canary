...
async function x(e, t, n, a, i) {
  ...
  null !== l && (null == v && y(), t ? await (0, m.stopSpeaking)() : null == L || L.removeEventListener("end", m.stopSpeaking), l.addEventListener("end", m.stopSpeaking), null != a && l.addEventListener("start", a), null != i && l.addEventListener("end", i), L = l, s.speakUtterance(l, v))
}

function b(e, t, n, a, s) {
  x(e, t, s, () => {
    (0, m.speakingMessage)(n, a)
  })
}
...
function G() {
  return null !== L && L.removeEventListener("end", m.stopSpeaking), s.cancelAll(), L = null, !0
}
...
function w(e) {
  ...
  if ((M || y) && ((null === (n = S.author) || void 0 === n ? void 0 : n.id) == null || !C.default.isBlocked(S.author.id))) {
    ...
    let t = null !== (l = null !== (i = f.default.getNick(e, null === (a = S.author) || void 0 === a ? void 0 : a.id)) && void 0 !== i ? i : p.default.getName(S.author)) && void 0 !== l ? l : "",

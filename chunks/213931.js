...
var i = t(381499), a = t(675478), l = t(592125), r = t(626135), u = t(981631);
function s(e, n, t, l) {
    if (n !== t)
        (0, a.PS)(e, e => {
            e.customNotificationSoundConfig = { notificationSoundPackId: i.Gm.create({ value: t }) };
        }, a.fy.INFREQUENT_USER_ACTION), r.default.track(u.rMx.CUSTOM_NOTIFICATION_SOUND_SETTINGS_UPDATED, {
            guild_id: e,
            location: l,
            soundpack: t
        });

...
function j(e) {
  let {
    ...
    guildId: a,
    markAsDismissed: j
  } = e, D = (0, S.useUID)(), v = (0, n.useStateFromStores)([f.default], () => f.default.getGuild(a));
    ...
    children: [(0, r.jsxs)(i.ModalHeader, {
      ...
      children: [(0, r.jsx)(i.ModalCloseButton, {
        ...
        onClick: () => {
          ...
          let e = "".concat(x.default.getCreatorSupportArticleURL(y.HelpdeskArticles.SERVER_SUBSCRIPTION_AND_PRODUCTS), "#docs-internal-guid-918e991a-7fff-03d5-8326-5d065e5edeb1");
          (0, d.default)(e, !0)
        },
        children: "Learn more"
      })]
      ...
      children: [(0, r.jsx)(i.Button, {
        onClick: () => {
          _.some(e => v.hasFeature(e)) ? p.default.open(a, y.GuildSettingsSections.GUILD_PRODUCTS) : p.default.open(a, y.GuildSettingsSections.ROLE_SUBSCRIPTIONS), j(N.ContentDismissActionType.PRIMARY), t()
        },

n(47120), n(773603);
var r = n(735250), i = n(470079), a = n(481060), o = n(285952), s = n(185625), l = n(273389), u = n(596891), c = n(15667), d = n(76264), _ = n(822686), E = n(356110), f = n(730719), h = n(996701), p = n(320596), m = n(273514), I = n(995712), T = n(234937), g = n(473121), S = n(449413), A = n(266080), N = n(316617), v = n(15682), O = n(905434), R = n(196627), C = n(739319), y = n(842401), D = n(375790), L = n(981631), b = n(689938), M = n(359282);
function P(e, t) {
    let {elements: n} = e;
    return n.find(e => {
        let {type: n} = e;
...
t.Z = e => {
    let {
            ...
            let n = !(arguments.length > 2) || void 0 === arguments[2] || arguments[2], r = { ...et };
            r[e] = {
                value: t,
                isValid: n
    ...
    return i.useEffect(() => {
        ...
        children: [
            (0, r.jsxs)(a.ModalHeader, {
                ...
                className: M.header,
                children: [
                    (0, r.jsx)(R.Z, { element: P(t, 'success') }),
                    (0, r.jsx)(g.Z, { node: t }),
                    (0, r.jsx)(S.Z, { node: t })
                ]
            }),
            (0, r.jsxs)(a.ModalContent, {
                className: M.body,
                children: [
                    null != Z ? (0, r.jsx)(C.Z, { element: Z }) : null,
                    null != P(t, 'breadcrumbs') && (0, r.jsx)(c.Z, { history: w }),
                    null != P(t, 'message_preview') && ('message' === n.name || 'first_dm' === n.name) && (0, r.jsx)(N.Z, { message: n.record }),
                    null != P(t, 'user_preview') && 'user' === n.name ? (0, r.jsx)(y.Z, { user: n.record }) : null,
                    function (e) {
                        let {elements: t} = e;
                        return t.some(e => {
                            let {type: t} = e;
                    ...
                    null != P(t, 'channel_preview') && 'stage_channel' === n.name && (0, r.jsx)(O.Z, { stageInstance: n.record }),
                    null != P(t, 'guild_scheduled_event_preview') && 'guild_scheduled_event' === n.name && (0, r.jsx)(T.Z, { event: n.record }),
                    null != P(t, 'guild_directory_entry_preview') && 'guild_directory_entry' === n.name && (0, r.jsx)(m.Z, { entry: n.record }),
                    null != P(t, 'guild_discovery_preview') && 'guild_discovery' === n.name && (0, r.jsx)(I.Z, { entry: n.record }),
                    null != H && (0, r.jsx)(v.Z, {
                        element: H,
                        onChange: (e, t) => {
                            let n = { ...J };
                    ...
                    null != Y && Y.length > 0 ? (0, r.jsx)(h.Z, { elements: Y }) : null,
                    (0, r.jsx)(f.Z, {
                        errorMessage: X,
                        onClose: () => {
                            $('');

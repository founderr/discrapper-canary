n(47120);
var r, i, a = n(754700), o = n(147913), s = n(317381), l = n(594190), u = n(569545), c = n(199902), d = n(314897), _ = n(77498), E = n(938475), f = n(70956), h = n(272008), p = n(569984), m = n(918701), I = n(432945), T = n(5881), g = n(566078), S = n(46140), A = n(70722);
function N(e, t, n) {
...
let v = 1 * f.Z.Millis.MINUTE, O = 1 * f.Z.Millis.SECOND, R = (0, T.T)({ location: S.dr.QUESTS_MANAGER }), C = e => (0, u.V9)({
    ...
    constructor(...e) {
        super(...e), N(this, 'streamKeyToHeartbeatState', new Map()), N(this, 'initiateHeartbeat', e => {
            ...
            let i = () => {
                let e = function (e) {
                    ...
                    let {
                            ...
                            streamKey: r,
                            applicationId: i
                        } = e, {channelId: a} = (0, u.my)(r), o = D(a), s = p.Z.quests.get(n);
                    if (null == s || !L(s))
                        return 'STOP';
                    let d = null === (t = y()) || void 0 === t ? void 0 : t.config, _ = null != c.Z.getRTCStream(r) && null != d && g.r.build(d).application.id === i && o, {
                            quest: E,
                            activity: f
                        } = b(), h = null == E ? void 0 : E.config, I = null != h && (null == E ? void 0 : E.id) === n && g.r.build(h).application.id === i && o && (null == f ? void 0 : f.channelId) === a, T = l.ZP.getRunningGames().map(e => e.id), S = (0, m.$H)(s) && T.includes(i);
            ...
            let {
                    progressSeconds: n,
                    targetSeconds: r
                } = (0, m.il)(t, a.T.DESKTOP), i = Math.max(0, (r - n) * f.Z.Millis.SECOND);
            return i <= v ? i + O : v;
            ...
            if (null != r) {
                ...
                window.clearTimeout(i), this.streamKeyToHeartbeatState.delete(t), n && (0, h.m0)({
                    questId: e,
                    streamKey: t,
                    terminal: !0
                });
            ...
            let {
                ...
                } = e, n = c.Z.getCurrentUserActiveStream(), r = y();
            ...
            R.log('~ handleSendHeartbeatSuccess -> Heartbeat succeeded:', t), null != n.completedAt && this.terminateHeartbeat({
                streamKey: t,
            ...
            t.forEach(e => {
                if (L(e) && (0, m.$H)(e)) {
                    let t = C(e.id), r = n.includes(g.r.build(e.config).application.id), i = !this.streamKeyToHeartbeatState.has(t) && r;
            ...
            R.log('~ handleRunningGamesChange -> Games detected:', {
                ...
                if (null == t || !L(t))
                    return;
                let n = C(t.id);
                (0, m.$H)(t) && !this.streamKeyToHeartbeatState.has(n) && (R.log('handleRunningGamesChange - initiating heartbeat for playtime task'), this.initiateHeartbeat({
                    streamKey: n,
                    applicationId: g.r.build(t.config).application.id,
                    questId: t.id
                }));
                ...
                if (null == t || !L(t))
                    return;
                let n = C(t.id);
                (0, m.$H)(t) && this.streamKeyToHeartbeatState.has(n) && this.terminateHeartbeat({
                    streamKey: n,
                    sendTerminalHeartbeat: !0
                });
            });
        }), N(this, 'handleVoiceStateChange', () => {
            let e = c.Z.getCurrentUserActiveStream(), t = y();
            ...
            let {
                    ...
                    channelId: n,
                    quest: r
                } = e, i = null == r || !D(n), a = D(n) && !this.streamKeyToHeartbeatState.has(t) && null != r && L(r) && !(0, m.$H)(r);
            ...
            D(n) && L(i) && !(0, m.$H)(i) && !this.streamKeyToHeartbeatState.has(t) && (R.log('handleStreamCreate - initiating heartbeat for stream task'), this.initiateHeartbeat({
                streamKey: t,
                applicationId: g.r.build(i.config).application.id,
                questId: i.id
            }));
            ...
            null == i ? this.terminateHeartbeat({
                streamKey: a,
                sendTerminalHeartbeat: !0
            }) : D(r) && L(i) && !(0, m.$H)(i) && !this.streamKeyToHeartbeatState.has(a) && (R.log('handleStreamStart - initiating heartbeat for stream task'), this.initiateHeartbeat({
                streamKey: a,
                applicationId: g.r.build(i.config).application.id,
                questId: i.id
            }));

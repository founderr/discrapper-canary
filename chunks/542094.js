...
function y(e) {
  let {
    ...
    assetNames: g = ["embedded_cover"],
    backgroundResolution: h = 250
  } = e, {
    ...
    size: h,
    names: g
  }), D = null != I.activity_preview_video_asset_id ? (0, p.default)(b.id, I.activity_preview_video_asset_id) : null, L = (0, v.default)(), w = (0, E.default)(), O = (0, s.default)(i).find(e => {
    let {
      embeddedActivity: t
    } = e;
  ...
  null != i && (null == L ? void 0 : L.channelId) === i.id && (null == w ? void 0 : w.id) === b.id ? (F = 2, M = () => {

...
function A(e, t) {
    ...
    switch (e) {
        case T.h8.GUILD:
            ...
            break;
        case T.h8.USER:
            s = i.filter((e) => e instanceof l.Sf && e.type === b.d4z.DM);
            break;
        case T.h8.GROUP_DM:
            s = i.filter((e) => e instanceof l.Sf && e.isMultiUserDM());
            break;
        case T.h8.TEXT_CHANNEL:
            s = i.filter((e) => e instanceof l.Sf && (0, l.r8)(e.type));
            break;
        case T.h8.VOICE_CHANNEL:
    ...
    for (let t of s) {
        let { id: n } = t,
            r = f.Z.getScoreWithoutFetchingLatest(n);
        if (e === T.h8.USER && t instanceof l.mn) {
            if (t.type === b.d4z.DM) o[(n = t.getRecipientId())] = 1 + r / a;
...
class N {
    ...
    setResultTypes(e) {
        (this.resultTypes = null != e ? new Set(e) : null), (this._userResults = this._include(T.h8.USER) ? this._userResults : []), (this._groupDMResults = this._include(T.h8.GROUP_DM) ? this._groupDMResults : []), (this._textChannelResults = this._include(T.h8.TEXT_CHANNEL) ? this._textChannelResults : []), (this._voiceChannelResults = this._include(T.h8.VOICE_CHANNEL) ? this._voiceChannelResults : []), (this._guildResults = this._include(T.h8.GUILD) ? this._guildResults : []), (this._applicationResults = this._include(T.h8.APPLICATION) ? this._applicationResults : []), (this._linkResults = this._include(T.h8.LINK) ? this._linkResults : []), (this._inAppNavigations = this._include(T.h8.IN_APP_NAVIGATION) ? this._inAppNavigations : []);
    }
    _include(e) {
        return null == this.resultTypes || this.resultTypes.has(e);
    }
    _isAsyncSearch() {
        return this._include(T.h8.USER);
    }
    setOptions(e) {
    ...
    queryTextChannels(e, t) {
        if (!this._include(T.h8.TEXT_CHANNEL)) return [];
        let n = A(T.h8.TEXT_CHANNEL, this.options),
    ...
    queryVoiceChannels(e, t) {
        if (!this._include(T.h8.VOICE_CHANNEL)) return [];
        let { voiceChannelGuildFilter: n } = this.options,
            r = A(T.h8.VOICE_CHANNEL, this.options);
        return m.ZP.queryChannels({
            query: e,
            guildId: n,
            limit: t,
    ...
    queryGuilds(e, t) {
        if (!this._include(T.h8.GUILD)) return [];
        let n = A(T.h8.GUILD, this.options),
            { blacklist: r } = this.options,
    ...
    queryUsers(e, t, n) {
        ...
        if (null == r || !this._include(T.h8.USER)) return;
        let { userFilters: i } = this.options;
        void 0 !== t && g.Z.requestMembers(t, e, 100), r.setLimit(n), r.setQuery(e, i, this._userBlacklist, A(T.h8.USER, this.options));
    }
    queryGroupDMs(e, t) {
        if (!this._include(T.h8.GROUP_DM)) return [];
        let { blacklist: n } = this.options,
            r = A(T.h8.GROUP_DM, this.options),
    ...
    queryApplications(e, t) {
        return this._include(T.h8.APPLICATION)
    ...
    queryLink(e, t) {
        let n;
        if (!this._include(T.h8.LINK)) return [];
    ...
    queryInAppNavigations(e, t) {
        return this._include(T.h8.IN_APP_NAVIGATION)

var n = r(581079), i = /\./, o = /\|\|/, a = /\s+\-\s+/, u = /^(<=|<|=|>=|~>|~|>|)?\s*(.+)/, s = /^(\d*)(.*)/;
function c(t, e) {
    if ('' === (t = t.trim()))
        return !0;
    var r = e.split(i), n = p(t), o = n.modifier, a = n.rangeComponents;
    switch (o) {
    case '<':
        return function (t, e) {
            return -1 === v(t, e);
    ...
    case '~>':
        return function (t, e) {
            var r = e.slice(), n = e.slice();
            n.length > 1 && n.pop();
            var i = n.length - 1, o = parseInt(n[i], 10);
...
function v(t, e) {
    for (var r = function (t, e) {
        ...
        var a = function (t, e) {
            var r = t.match(s)[1], n = e.match(s)[1], i = parseInt(r, 10), o = parseInt(n, 10);

var n = r(381538), i = r(185330), o = r(470079), a = r(581079), u = r(45623), s = r(907949).setDraftEditorSelection, c = function (t) {
        function e() {
        ...
        return l._setSelection = function () {
            ...
            if (null == e || !e.getHasFocus())
                return;
            var r = this.props, n = r.block, i = r.start, o = r.text, c = n.getKey(), l = i + o.length;
            ...
            var t = this, e = this.props.block, r = this.props.text;
            r.endsWith('\n') && this.props.isLast && (r += '\n');
            var a = this.props, u = a.customStyleMap, s = a.customStyleFn, c = a.offsetKey, l = a.styleSet, f = l.reduce(function (t, e) {
                    var r = {}, i = u[e];
                    return void 0 !== i && t.textDecoration !== i.textDecoration && (r.textDecoration = [
                        t.textDecoration,
                        i.textDecoration
                    ].join(' ').trim()), n(t, i, r);
                }, {});

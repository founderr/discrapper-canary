...
function m() {
    let e = I.Y.useExperiment({ location: 'guild_context_menu' }, { autoTrackExposure: !0 }),
...
function R(e, n, r, O) {
    ...
    let R = (0, T.OR)(e),
        ...
        P = I.Y.useExperiment({ location: 'guild_context_menu' }, { autoTrackExposure: !0 }).enabled,
        [y, D] = a.useState(!1),
        { playSound: b } = (0, A.Z)(),
        [L, F] = (0, o.cv)([r]),
        V = L === r;
            ...
            e !== Z.aIL
                ? () =>
                      (0, u.openModalLazy)(async () => {
                          let { default: n } = await Promise.all([t.e('5863'), t.e('48258')]).then(t.bind(t, 751212));
                          return (t) =>
                              (0, i.jsx)(n, {
                                  ...t,
                                  guildId: e

...
t.Z = r.forwardRef(function(e, t) {
  ...
  let {
    ...
    ...e,
    guild: y
  }, t, U), B = (null === (n = L.autocomplete) || void 0 === n ? void 0 : n.forceChatLayer) ? f.ZP : h.ZP, x = (0, I.DJ)(b.selectedIndex);
  (0, d.KR)(P, b.isVisible, x), S.Z.trackExposure({
    location: "6e9811_1"
  });
  let {
  ...
  let Y = {
    ...
    j = 490;
  null != V && (j = (null === (p = L.autocomplete) || void 0 === p ? void 0 : p.small) ? 200 : (null === (g = b.query) || void 0 === g ? void 0 : g.type) === A.eq.EMOJIS_AND_STICKERS ? 490 : 245), j = Math.min(window.innerHeight - 175, j);
  let W = (0, i.jsx)(I.ZP, {
    id: P,

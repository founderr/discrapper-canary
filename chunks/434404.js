var r = n(990547), i = n(544891), a = n(570140), o = n(37234), s = n(710845), l = n(655006), u = n(408987), c = n(962086), d = n(160404), _ = n(41776), E = n(314897), f = n(271383), h = n(430824), p = n(546796), m = n(573261), I = n(999382), T = n(981631), g = n(308083), S = n(689938);
let A = new s.Z('GuildSettingsActionCreators'), N = {
        init(e, t, n, r) {
            a.Z.dispatch({
        ...
        saveGuild(e, t) {
            ...
            return a.Z.dispatch({ type: 'GUILD_SETTINGS_SUBMIT' }), i.tn.patch({
                url: T.ANM.GUILD(e),
                ...
                if (a.Z.dispatch({
                        type: 'GUILD_SETTINGS_SUBMIT_FAILURE',
                        errors: e.body
                    }), A.error('Failed to save guild settings', { errors: e.body }), D.throwErr)
                    throw e.body;
            });
        },
        ...
        transferOwnership(e, t) {
            let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
        ...
        async leaveGuild(e) {
            await i.tn.del({
                ...
                body: { lurking: _.Z.isLurking(e) || f.ZP.isCurrentUserGuest(e) },
                oldFormErrors: !0
            }), N.close();
        },

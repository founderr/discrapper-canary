...
var i = n(735250), s = n(470079), a = n(120356), r = n.n(a), l = n(186325), o = n(780384), c = n(481060), d = n(410030), u = n(810090), _ = n(113434), E = n(497505), h = n(918701), I = n(78826), m = n(670638), g = n(981631), p = n(689938), T = n(211549);
function S(e) {
    let {
            quest: t,
            isHovering: n,
            ...
            onCtxMenuOpen: S,
            onCtxMenuSelect: C
        } = e, N = (0, h.ph)(t), f = (0, d.ZP)(), A = (0, o.wj)(f) ? g.BRd.DARK : g.BRd.LIGHT, Z = A === g.BRd.DARK, L = s.useMemo(() => (0, h.nP)(t.config.assets.questBarHero), [t]), v = s.useContext(l.S).reducedMotion.enabled, O = (0, h.Mi)(t, E.jn.GIFT_INVENTORY_FOR_YOU), R = (0, _.tP)(t), x = s.useRef(n), P = s.useRef(null);
    return s.useEffect(() => {
        if (L && null != P.current)

...
n = [],
{
  ...
  let r = Math.min(e /= 255, t /= 255, n /= 255),
    ...
    o = 0,
    l = 0;
  return (s = Math.round(60 * (s = 0 === a ? 0 : i === e ? (t - n) / a % 6 : i === t ? (n - e) / a + 2 : (e - t) / a + 4))) < 0 && (s += 360), l = (i + r) / 2, o = +(100 * (o = 0 === a ? 0 : a / (1 - Math.abs(2 * l - 1)))).toFixed(1), {
    h: s,
    s: o,
    l: l = +(100 * l).toFixed(1)
  };
...
let i = function(e, t, n) {
  ...
  l = 2 * n - o;
r = i(l, o, e + 1 / 3), a = i(l, o, e), s = i(l, o, e - 1 / 3);
  }
  return new i.Z(Math.round(255 * r), Math.round(255 * a), Math.round(255 * s), 1);
}
...
u = Math.round(r + (s - r) * n).toString(16).padStart(2, '0'),
c = Math.round(i + (o - i) * n).toString(16).padStart(2, '0'),

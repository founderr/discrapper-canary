...
class F extends r.PureComponent {
  ...
  renderTotp() {
    ...
    return (0, o.jsxs)(l.ModalRoot, {
      transitionState: e,
      className: S.modal,
      children: [this.renderHeader(A.Z.Messages.MFA_SMS_ENABLE_SHOULD_DO.format()), (0, o.jsxs)(l.ModalContent, {
        className: S.modalInner,
        children: [this.renderSMSSection(), (0, o.jsx)(l.FormDivider, {
          className: S.divider
  ...
  renderWebAuthn() {
    ...
    return (0, o.jsxs)(l.ModalRoot, {
      transitionState: e,
      className: S.modal,
      children: [this.renderHeader(A.Z.Messages.TWO_FA_WEBAUTHN_SHOULD_DO.format()), (0, o.jsx)(l.ModalContent, {
        className: S.modalInner,
...
t.default = i.ZP.connectStores([R.default, p.Z], () => {

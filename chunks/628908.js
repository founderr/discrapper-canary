n.r(t), n(47120);
var o = n(735250), r = n(470079), s = n(512722), a = n.n(s), i = n(442837), l = n(481060), d = n(570140), c = n(816814), E = n(23645), u = n(454585), _ = n(144114), h = n(607018), p = n(325067), R = n(594174), f = n(285952), I = n(279837), N = n(981631), M = n(815660), A = n(689938), S = n(418142);
function O(e, t, n) {
...
class F extends r.PureComponent {
    renderSMSSection() {
        let {currentUser: e} = this.props, t = null != this.props.currentUser.phone, n = e.hasFlag(N.xW$.MFA_SMS), r = e.hasFlag(N.xW$.PARTNER) || e.hasFlag(N.xW$.STAFF);
        return t ? (0, o.jsxs)(C, {
    ...
    renderTotp() {
        let {transitionState: e} = this.props, {showConfirmModal: t} = this.state;
    ...
    constructor(...e) {
        super(...e), O(this, 'state', { showConfirmModal: !1 }), O(this, 'handleCloseModal', () => {
            let {
                onClose: e,

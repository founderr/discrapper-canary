...
var s = n(735250), a = n(470079), t = n(658722), r = n.n(t), o = n(399606), u = n(481060), i = n(734893), d = n(271383), c = n(430824), _ = n(594174), m = n(153124), E = n(700785), I = n(580357), g = n(981631), h = n(689938), f = n(525480);
function M(e) {
    var l, n, t;
    let {
            transitionState: M,
            ...
            welcomeMessage: p,
            onSave: T
        } = e, v = (0, m.Dt)(), [N, O] = a.useState({ ...p }), A = (0, o.e7)([c.Z], () => c.Z.getGuild(S)), b = a.useCallback(e => {
            let l = {};
            ...
            if (null == e.authorIds || 0 === e.authorIds.length)
                return e.message.length < i.ZR ? h.Z.Messages.WELCOME_MESSAGE_VALIDATION_ERROR_AUTHOR_AND_MESSAGE.format({ minLength: i.ZR }) : h.Z.Messages.WELCOME_MESSAGE_VALIDATION_ERROR_AUTHOR;
            return e.message.length < i.ZR ? h.Z.Messages.WELCOME_MESSAGE_VALIDATION_ERROR_MESSAGE.format({ minLength: i.ZR }) : null;
        }(N);

...
function M(e) {
  ...
  let {
    ...
    T(null), x()
  }, [T, x]), B = null !== (l = N.authorIds[0]) && void 0 !== l ? l : "", j = (0, o.e7)([d.ZP], () => null != S ? d.ZP.getMember(S, B) : null), Z = (0, o.e7)([_.default], () => null != j ? _.default.getUser(j.userId) : null), k = null !== (t = null !== (n = null == j ? void 0 : j.nick) && void 0 !== n ? n : null == Z ? void 0 : Z.username) && void 0 !== t ? t : "", D = function(e) {
    if (null == e.message || 0 === e.message.length) return null;
    if (null == e.authorIds || 0 === e.authorIds.length) return e.message.length < i.ZR ? h.Z.Messages.WELCOME_MESSAGE_VALIDATION_ERROR_AUTHOR_AND_MESSAGE.format({
      minLength: i.ZR

...
var a = t(120356),
    ...
    N = t(96923);
function m(e) {
    let { user: s, pendingAvatar: t, pendingColors: a, onThemeColorsChange: r, preventDisabled: m, guildId: A, className: C, showPremiumIcon: g = !0, showResetThemeButton: h = !1, forcedDivider: O } = e,
        p = (0, _.ZP)(s.id, A),
        ...
        M = null != t ? t : s.getAvatarURL(A, 80),

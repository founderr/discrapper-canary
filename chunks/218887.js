...
if (47 === n) {
  if (a === o - 1 || 1 === s);
    ...
    r.length > 0 ? r += '/' + e.slice(a + 1, o) : r = e.slice(a + 1, o), i = o - a - 1;
  a = o, s = 0;
} else
  46 === n && -1 !== s ? ++s : s = -1;
  }
...
for (var e, t, n = '', s = !1, o = arguments.length - 1; o >= -1 && !s; o--) {
  if (o >= 0 ? t = arguments[o] : (void 0 === e && (e = r.cwd()), t = e), i(t), 0 !== t.length)
    n = t + '/' + n, s = 47 === t.charCodeAt(0);
}
if (n = a(n, !s), s)
  return n.length > 0 ? '/' + n : '/';
if (n.length > 0)
...
if (i(e), i(t), e === t)
  return '';
if (e = s.resolve(e), e === (t = s.resolve(t)))
  return '';
...
if (void 0 !== t && t.length > 0 && t.length <= e.length) {
  ...
  for (n = e.length - 1; n >= 0; --n) {
    ...
    if (47 === u) {
      ...
      -
      1 === l && (s = !1, l = n + 1), o >= 0 && (u === t.charCodeAt(o) ? -1 == --o && (a = n) : (o = -1, a = l));
  }

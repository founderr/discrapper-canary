...
class g extends(s = a.PureComponent) {
  ...
  renderDropdown() {
    ...
    return null != e && null != e.launchOptions && Object.keys(e.launchOptions).length > 1 ? (0, l.jsxs)(u.Clickable, {
  ...
  render() {
    ...
    if (!a) return c ? null : this.renderDisabledButton(S.default.Messages.GAME_ACTION_BUTTON_PLAY, p.isPlatformEmbedded ? S.default.Messages.GAME_ACTION_BUTTON_GAME_NOT_DETECTED : S.default.Messages.GAME_ACTION_BUTTON_PLAY_DISABLED_DESKTOP_APP);
...
function M(e) {
  ...
  } = e, s = (0, c.useAnalyticsContext)(), [a, i] = (0, o.useStateFromStoresArray)([_.default, E.default, m.default], () => [_.default.isConnected(t) || E.default.isLaunchable(t) || null != n && m.default.isLaunchable(n.id, n.branchId), E.default.launchingGames.has(t)], [t, n]), r = (0, o.useStateFromStores)([f.default], () => new Set(f.default.getRunningVerifiedApplicationIds()).has(t), [t]), u = (0, o.useStateFromStores)([m.default], () => null != n ? m.default.getState(n.id, n.branchId) : null, [n]);
  return (0, l.jsx)(g, {
    ...e,
    analyticsContext: s,
    isLaunchable: a,

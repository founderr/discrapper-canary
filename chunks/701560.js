...
class g extends(s = l.PureComponent) {
  ...
  render() {
    ...
    if (!l) return c ? null : this.renderDisabledButton(C.default.Messages.GAME_ACTION_BUTTON_PLAY, p.isPlatformEmbedded ? C.default.Messages.GAME_ACTION_BUTTON_GAME_NOT_DETECTED : C.default.Messages.GAME_ACTION_BUTTON_PLAY_DISABLED_DESKTOP_APP);

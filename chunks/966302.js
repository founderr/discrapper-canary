...
function H(e) {
    let {header: t} = e, n = R.Z.getCameraComponent(), a = (0, l.e7)([R.Z], () => R.Z.getVideoDeviceId()), o = (0, T.Z)();
    return i.useEffect(() => {
        let e = C.default.getCurrentUser();
        if (o && null != e) {
            let t = (0, m.P)(e);
            (0, I.FU)(t, a, { track: !1 }).catch(P.dG4);
        }
    }, [
        o,
        a
    ...
    return (0, r.jsxs)('div', {
        ...
        children: [
            ...
            t && (0, r.jsx)(u.Popout, {
                renderPopout: e => {
                    let {closePopout: t} = e;
                    return (0, r.jsx)(M.Z, { onClose: t });
                },
                position: 'top',
                align: 'center',
                animation: u.Popout.Animation.FADE,
                children: (e, t) => {
                    let {onClick: o} = e, {isShown: u} = t;
                    return (0, r.jsx)(O.C, {
                        join: !0,
                        enabled: s,
                        color: 'green',
    ...
    return (0, r.jsx)(E.Z, {
        ...
        children: (0, r.jsx)(r.Fragment, {
            children: (0, r.jsxs)(s.animated.div, {
                ...
                children: [
                    p ? (0, r.jsx)(H, { header: M }) : (0, r.jsx)('div', {

...
transitionState: j,
onClose: P
  } = e, Z = (0, u.Dt)(), D = (0, s.e7)([m.Z], () => m.Z.getChannel(l), [l]), S = (0, s.e7)([g.Z], () => g.Z.getGuild(null == D ? void 0 : D.getGuildId()), [D]), N = (0, s.e7)([m.Z], () => m.Z.getChannel(null == D ? void 0 : D.parent_id), [D]), U = null === (t = C[0]) || void 0 === t ? void 0 : t.item, [y, z] = n.useState(null);
  n.useEffect(() => {

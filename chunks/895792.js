...
function E(e) {
  ...
  let {
    ...
    onClose: I,
    entry: g
  } = e, [h, D] = l.useState(null !== (a = g.description) && void 0 !== a ? a : ""), [m, _] = l.useState(null !== (t = g.primaryCategoryId) && void 0 !== t ? t : o.DirectoryEntryCategories.UNCATEGORIZED), [C, f] = l.useState(!1), [T, x] = l.useState(null), p = async () => {
    if (x(null), h !== g.description || m !== g.primaryCategoryId) {
      f(!0);
      try {
        await (0, d.updateDirectoryEntry)(g.channelId, g.guildId, h, m), f(!1), I()
      } catch (e) {
  ...
  return (0, s.jsxs)(r.ModalRoot, {
    ...
    children: [(0, s.jsxs)(r.ModalHeader, {
      ...
      children: [(0, s.jsx)(r.Heading, {
        ...
        children: c.default.Messages.HUB_ENTRY_UPDATE_DESCRIPTION_TITLE.format({
          guildName: g.name
        })
      }), (0, s.jsx)(r.Text, {
      ...
      }), null != I && (0, s.jsx)(r.ModalCloseButton, {
      ...
      children: [(0, s.jsx)(r.FormItem, {
        ...
        children: (0, s.jsx)(r.TextArea, {
          value: h,
          maxLength: 200,
          placeholder: c.default.Messages.HUB_ADD_GUILD_DESCRIPTION_PLACEHOLDER,
          onChange: D,

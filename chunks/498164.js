    ...
    (t.Z = {
        [x.Etm.INVITE_BROWSER]: {
            ...
            async handler(e) {
                ...
                if (null == n) throw new b.Z({ errorCode: x.lTL.INVALID_INVITE }, 'Invalid invite id: '.concat(t));
                return (
        ...
        [x.Etm.GUILD_TEMPLATE_BROWSER]: {
            ...
            async handler(e) {
                ...
                if (null == i) throw new b.Z({ errorCode: x.lTL.INVALID_GUILD_TEMPLATE }, 'Invalid guild template id: '.concat(t));
                return (
                    T.ZP.focus(),
                ...
                return new Promise((e, i) => {
                    o.Z.wait(() => {
                        h.Z.resolveGiftCode(t, !0, !0)
                            ...
                            .catch(() => i(new b.Z({ errorCode: x.lTL.INVALID_GIFT_CODE }, 'Invalid gift code: '.concat(t))));
                    });
                });
            }
        },
            ...
            handler(e) {
                ...
                switch ((T.ZP.focus(), t)) {
                    case A.jE.USER_SETTINGS:
                        ...
                        break;
                    case A.jE.CHANGELOG:
                        null != n && ((0, _.dL)(S.Z.formatPathWithQuery(x.Z5c.CHANGELOGS(n.date), n.query)), Z(n.fingerprint, 'changelog'));
                        break;
                    case A.jE.LIBRARY:
        ...
        [x.Etm.CONNECTIONS_CALLBACK]: {
            ...
            handler: async (e) => {
                ...
                if (!p.g.getCurrentConfig({ location: 'private.CONNECTIONS_CALLBACK' }).enabled && !I.Z.hasPendingAuthorizedState(l)) throw new b.Z({ errorCode: x.lTL.INVALID_CONNECTION_CALLBACK_STATE }, 'Provider authorization did not originate from this discord client');
                try {
                    return (
                    ...
                    if ((null == e ? void 0 : e.status) === 400) throw new b.Z({ errorCode: x.lTL.BAD_REQUEST_FOR_PROVIDER }, 'Bad request for provider');

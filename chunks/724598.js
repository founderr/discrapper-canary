...
function m(e) {
  let {
    ...
    [E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_ROLE_ACCESS, E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_GAME_TUTORIALS],
    [E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_DOPE_WALLPAPERS, E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_PFP_ART],
    [E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_FILTER_PRESETS, E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_SONG_DROPS],
    [E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_COSPLAY_PICS, E.Z.Messages.GUILD_STORE_PREVIEW_CHIP_3D_MODELS]
  ];
  return (0, s.jsx)("div", {
    className: i()({
      [I.responsive]: a
      ...
      children: [(0, s.jsxs)("div", {
        ...
        children: [(0, s.jsx)("div", {
          ...
          children: [(0, s.jsx)(r.Text, {
            ...
            children: [E.Z.Messages.GUILD_SHOP_PREVIEW_CTA_BUTTON, (0, s.jsx)(r.ArrowSmallRightIcon, {
              size: "md",
              color: "currentColor",

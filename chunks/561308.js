...
let d = n => {
  ...
  N = (n, t) => {
    let e = u()(c.default.extractTimestamp(n.id)),
      r = e.isSame(u()(), "day"),
      i = u()().diff(e, "s");
    if (i < T.Z.Seconds.MINUTE) return s.Z.Messages.MEMBER_LIST_CONTENT_FEED_TIMESTAMP_SECONDS_AGO.format({
      count: i
    });
    ...
    } else if (i < T.Z.Seconds.WEEK && r) return e.toDate().toLocaleTimeString(t, {
      hour: "numeric"
    });
    else if (i < T.Z.Seconds.WEEK && !r) return e.toDate().toLocaleTimeString(t, {
      weekday: "short",
...
function y(n) {
  let t = (0, E.e7)([_.Z], () => _.Z.getMatchingActivity(n)),
    [e, r] = (0, l.Z)([null == t ? void 0 : t.application_id, n.extra.application_id]);
  return {
    activity: t,

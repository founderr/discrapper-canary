...
function T(e, t) {
  let {
reducedMotion: n
  } = s.useContext(r.AccessibilityPreferencesContext), T = (0, u.$R)(t), h = (0, a.e7)([d.Z], () => d.Z.can(I.Plq.MANAGE_MESSAGES, t) && T, [
t,
T
  ...
  return (0, i.jsx)(r.MenuItem, {
    ...
    imageUrl: t => {
      ...
      return null != e.id ? _.ZP.getEmojiURL({
        id: e.id,
        animated: e.animated && (!n.enabled || s),
        size: 18
      }) : E.ZP.getURL(null !== (i = e.name) && void 0 !== i ? i : '');
    },
    dontCloseOnActionIfHoldingShiftKey: !0
  }, null !== (s = e.name) && void 0 !== s ? s : e.id);
})
  });
}
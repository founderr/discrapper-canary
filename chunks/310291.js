n(47120);
var s = n(470079), a = n(392711), i = n.n(a), r = n(232473);
let l = e => {
    let t = {};
    for (let n of e) {
...
t.Z = (e, t) => {
    let {
            groupType: n,
            teamId: a
        } = t, [i, o] = s.useState(!0), [c, d] = s.useState([]), u = s.useCallback(async () => {
            if (d([]), null == e) {
                o(!1);
                return;
            }
    ...
    return s.useEffect(() => {
        ...
        payoutsByPeriod: s.useMemo(() => l(null != a ? c.filter(e => e.user_id === a) : c), [
            c,
            a
        ]),
        loading: i

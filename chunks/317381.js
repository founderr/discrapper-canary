...
var i, a = n(442837), o = n(570140), s = n(911969), l = n(314897), u = n(592125), c = n(944486), d = n(594174), _ = n(585483), E = n(358085), f = n(139143), h = n(155268), p = n(613611), m = n(761122), I = n(917107), T = n(918559), g = n(981631);
function S(e, t, n) {
...
let A = {
    ...
    }, N = [], v = new Map(), O = new Map(), R = new Map(), C = new Map(), y = !1, D = new Map(), L = new Map(), b = new Map(), M = new Map(), P = new Map(), U = new Map(), w = new Map();
let x = T.Ez.DISCONNECTED, G = T.MI.RESIZABLE;
function k(e) {
    return null != e ? e : '0';
}
function B(e) {
    ...
    if (null == m)
        return;
    let I = d.map(e => e.userId), T = l.default.getId(), S = I.some(e => e === T), A = null === (t = d.find(e => e.userId === T)) || void 0 === t ? void 0 : t.sessionId, N = d.some(e => (0, p.J)(e)), y = null == c, D = v.get(s), L = {
    ...
    null != D && a === D.channelId && s === (null == D ? void 0 : D.applicationId) && (!S && Array.from(D.userIds).some(e => e === T) || !y && !N) ? C.get(a) === s ? C.delete(a) : (v.delete(s), _.S.dispatch(g.CkL.RELEASE_ACTIVITY_WEB_VIEW)) : S && (null == D || D.applicationId !== s || D.channelId !== a) && (A === l.default.getSessionId() && !y || (0, f.$)('EmbeddedActivitiesStore')) && (V({
        ...
        launchId: u,
        compositeInstanceId: c
    }), _.S.dispatch(g.CkL.OPEN_EMBEDDED_ACTIVITY, { channelId: a }));
    let b = (null !== (n = R.get(a)) && void 0 !== n ? n : []).filter(e => e.applicationId !== s), M = k(i), P = (null !== (r = O.get(M)) && void 0 !== r ? r : []).filter(e => !(e.applicationId === s && e.channelId === a));
...
function F(e) {
    e.embedded_activities.forEach(t => {
        ...
        B({
            ...
            participants: i.map(e => ({ userId: e.user_id })),
...
function V(e) {
    ...
    if (null == _ || null == E || (null === (t = v.get(a)) || void 0 === t ? void 0 : t.channelId) === i)
        return !1;
    let f = u.Z.getChannel(i), p = null == f ? void 0 : f.getGuildId(), m = d.default.getCurrentUser();
...
class Y extends (i = a.ZP.PersistedStore) {
    ...
    shouldFetchShelf(e) {
        var t, n;
        let r = k(e), i = null !== (t = L.get(r)) && void 0 !== t ? t : { isFetching: !1 }, a = Date.now() - (null !== (n = null == i ? void 0 : i.lastFetchTimestampMs) && void 0 !== n ? n : 0) > 21600000;
...
let j = new Y(o.Z, {
        ...
        !function (e, t) {
            t.forEach(e => {
                ...
                B({
                    ...
                    compositeInstanceId: void 0,
                    participants: r.map(e => ({ userId: e.user_id })),
    ...
    CHANNEL_DELETE: function (e) {
        ...
        if (null != n) {
            var r;
            let e = k(n), i = (null !== (r = O.get(e)) && void 0 !== r ? r : []).filter(e => e.channelId !== t.id);
            O.set(e, i);
        }
    },
    ...
    EMBEDDED_ACTIVITY_LAUNCH_SUCCESS: function (e) {
        ...
        A.everLaunchedActivities.add(t), function () {
            y = !1;
        }();
    },
    ...
    EMBEDDED_ACTIVITY_CLOSE: function (e) {
        let {applicationId: t} = e, n = v.get(t);
    ...
    EMBEDDED_ACTIVITY_FETCH_SHELF: function (e) {
        let {guildId: t} = e, n = k(t), r = L.get(n);
        L.set(n, {
            isFetching: !0,
    ...
    EMBEDDED_ACTIVITY_FETCH_SHELF_SUCCESS: function (e) {
        ...
        !function (e) {
            ...
            t.forEach(e => {
                let t = e.application_id, r = e.client_platform_config[(0, m.Z)((0, E.getOS)())];
                if (null == r.label_until)
                    return;
                let i = new Date(r.label_until).getTime();
                if (i < n)
                    return;
                let a = A.seenNewActivities[t], o = Object.hasOwn(A.seenNewActivities, t), l = new Date(a).getTime() < i;
                r.label_type === s.ww.NEW && (!o || l) && (A.shouldShowNewActivityIndicator = !0, A.seenNewActivities[t] = r.label_until);
                let u = A.seenUpdatedActivities[t], c = Object.hasOwn(A.seenUpdatedActivities, t), d = new Date(u).getTime() < i;
    ...
    CHANNEL_CALL_POPOUT_WINDOW_OPEN: function (e) {
        let {channel: t} = e, n = Array.from(v.values()).find(e => {
                let {channelId: n} = e;
                return t.id === n;
            });

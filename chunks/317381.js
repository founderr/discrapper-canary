...
function V(e) {
  ...
  if (null == h) return;
  let A = u.default.getBasicChannel(a);
  ...
  N.some(e => e === p) && null != M && (D || O === v) && C.set(M.applicationId, {
    ...M,
    ...y
  }), null != M && a === M.channelId && !N.some(e => e === p) && Array.from(M.userIds).some(e => e === p) ? L.get(a) === o ? L.delete(a) : C.delete(o) : N.some(e => e === p) && (null == M || M.applicationId !== o || M.channelId !== a) && (v === l.default.getSessionId() && !D || (0, T.shouldMountActivityIFrameFromGatewayUpdateWithoutSessionIdCheck)("EmbeddedActivitiesStore")) && (F({
    channelId: a,
    applicationId: o,
    launchId: _
  ...
  let P = (null !== (n = g.get(a)) && void 0 !== n ? n : []).filter(e => e.applicationId !== o),
    U = k(r),
    b = (null !== (i = R.get(U)) && void 0 !== i ? i : []).filter(e => !(e.applicationId === o && e.channelId === a));
  N.length > 0 && (P.push(y), b.push(y)), g.set(a, P), R.set(U, b)
}
...
function F(e) {
  ...
  let {
    ...
    applicationId: a,
    launchId: s
  } = e, o = (0, f.default)(a), d = l.default.getSessionId();
  if (null == o || null == d || (null === (t = C.get(a)) || void 0 === t ? void 0 : t.channelId) === r) return !1;
  ...
  i = r, C.set(a, {
    ...
    launchId: s
  }), w = i !== _.default.getChannelId() || (0, h.default)(r) ? A.ActivityPanelModes.PIP : A.ActivityPanelModes.PANEL, G.set(Y(r, a), Date.now())
}
...
class j extends(r = a.default.PersistedStore) {
  initialize(e) {
    var t, n;
  ...
  shouldFetchShelf(e) {
    ...
    let i = k(e),
      ...
      a = Date.now() - (null !== (n = null == r ? void 0 : r.lastFetchTimestampMs) && void 0 !== n ? n : 0) > 216e5;
    ...
    ! function(e) {
      ...
      t.forEach(e => {
        ...
        let a = p.seenNewActivities[t],
          s = Object.hasOwn(p.seenNewActivities, t),
          l = new Date(a).getTime() < r;
        i.label_type === o.EmbeddedActivityLabelTypes.NEW && (!s || l) && (p.shouldShowNewActivityIndicator = !0, p.seenNewActivities[t] = i.label_until);

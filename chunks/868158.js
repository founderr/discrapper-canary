...
var i = n(512722),
  ...
  S = n(306680),
  A = n(411198);
let N = new E.Z("ReadyPayloadUtils"),
  m = {},
  O = null,
  R = {};
...
function C(e, t, n) {
  ...
  let N = null !== (i = null == d ? void 0 : d.map((e, t) => !0 === e.unavailable ? e : (e.members = D(R, null == _ ? void 0 : _[t]), P(e)))) && void 0 !== i ? i : [],
    O = v(t, d, e => P(e));
  return null != O && N.push(O), {
    ...E,
    users: s,
    presences: [],
    relationships: h,
...
function P(e) {
  ...
  if (null == E) throw N.log("no cache entry for partial guild (guild: ".concat(e.id, ", type: ready)")), Error("Guild data was missing from store, but hash was still available.");
  return {
    id: e.id,
    dataMode: e.data_mode,
    channels: null,

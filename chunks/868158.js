...
var r = n(512722),
    ...
    E = n(306680),
    v = n(411198);
let b = new _.Z('ReadyPayloadUtils'),
    I = {},
    T = null,
    S = {};
function y(e, t) {
            ...
            null !==
                (n =
                    null == r
                        ? void 0
                        : r.map((e, t) => {
                              let n = O(S, null == a ? void 0 : a.guilds[t]),
                                  r = O(S, null == i ? void 0 : i[t]);
                              return {
                                  ...e,
...
function N(e, t, n) {
    ...
    let m = O((S = s().keyBy(a, (e) => e.id)), l);
    null == u ||
        u.forEach((e) => {
            let t = e.recipient_ids;
            null != t && (e.recipients = t.map((e) => (i()(null != S[e], 'Missing user in compressed ready payload'), S[e]))), delete e.recipient_ids;
        });
    let b = null !== (r = null == f ? void 0 : f.map((e, t) => (!0 === e.unavailable ? e : ((e.members = O(S, null == c ? void 0 : c[t])), L(e))))) && void 0 !== r ? r : [],
        T = C(t, f, (e) => L(e));
    return (
        null != T && b.push(T),
        {
...
function L(e) {
    ...
    if (null == _) throw (b.log('no cache entry for partial guild (guild: '.concat(e.id, ', type: ready)')), Error('Guild data was missing from store, but hash was still available.'));
    return {
        id: e.id,
        dataMode: e.data_mode,
        channels: null,
...
function x(e, t) {
    ...
    if (null == t) throw (b.log('no cache entry for partial guild (guild: '.concat(e.id, ', type: post_ready)')), Error('Guild data was missing from store, but hash was still available.'));
    return {
        id: e.id,
        channels: null,
        channelUpdates: {

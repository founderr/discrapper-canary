...
let L = {
    ...
    handler(e) {
      ...
      return e => {
        ...
        if (n) {
          ...
          e.forEach(e => a((0, S.transformVoiceState)(i, l.id, e)))
        }
        return r
      }
    }
  ...
  [A.RPCEvents.VOICE_STATE_DELETE]: {
    ...
    handler(e) {
      ...
      return e => {
        ...
        return o.forEach(e => a((0, S.transformVoiceState)(i, l.id, e))), r
      }
    }
  },
  ...
  [A.RPCEvents.ACTIVITY_INSTANCE_PARTICIPANTS_UPDATE]: I.activityInstanceConnectedParticipantsUpdateEvent,

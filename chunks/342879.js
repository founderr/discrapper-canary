...
function O(e) {
  if (T.has(e) || e === h.YN.GAME_PROFILE_FEED && (!(0, s._J)('ContentInventoryManager') || void 0 !== f.Z.getFeed(e)))
return !1;
  if (e === m) {
if (!(0, d.sA)('ContentInventoryManager') || E.Z.hidden && null != f.Z.getFeed(e) || !c.Z.isFocused() || !o.Z.isConnected())
  return !1;
let t = u.Z.getIdleSince();
if (null != t && Date.now() - t > 900000)
  return !1;
  }
  return !0;
}
...
return;
  let e = f.Z.getFeed(m);
  if ((null == e ? void 0 : e.refresh_stale_inbox_after_ms) != null && null == S)
return;
...
S = new Date(Date.now() + (null != t ? t : n.refresh_stale_inbox_after_ms)).toUTCString(), C();
}
...
(null === (t = l.Z.getAccount(n, p.ABu.SPOTIFY)) || void 0 === t ? void 0 : t.showActivity) && A(n, r);
}

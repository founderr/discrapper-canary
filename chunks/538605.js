			...
			r(t, [
				{
					...
					value: function (e, t, n) {
						...
						var i = function () {
							0 === r._duration ? (r._onUpdate(r._toValue), r.__debouncedOnEnd({ finished: !0 })) : ((r._startTime = Date.now()), (r._animationFrame = s.current(r.onUpdate.bind(r))));
						};
				...
				},
				{
					key: 'stop',
					value: function () {
						(this.__active = !1), clearTimeout(this._timeout), o.current(this._animationFrame), this.__debouncedOnEnd({ finished: !1 });
					}
				}
			]),
			t

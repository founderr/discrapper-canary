			...
			() =>
				null != l
					? (0, i.jsxs)(o.Clickable, {
							...
							children: [(0, i.jsx)('div', { className: I.tooltipHoverBridge }), l]
						})
					: null,
			[l, c, T]
		),
...
function p() {
	...
	return (0, i.jsx)(g, {
		icon: h,
		text: m.Z.Messages.CLAN_DISCOVERY_GAME_FILTER.format({ count: t.length }),
		tooltip: _,
		onClick: n,
		isActive: t.length > 0,
		ariaLabel: s,
...
function Z(e) {
	let { className: t } = e,
		n = (0, E.GN)((e) => e.mode, l.Z),
		s = (0, E.GN)((e) => e.started, l.Z),
		o = a.useCallback(() => {
			if (n !== E.v0.SAVED_GUILDS) return (0, E.fH)(E.v0.SAVED_GUILDS);
		}, [n]),
		c = a.useCallback(() => (s ? (0, E.fH)(E.v0.DISCOVERY) : (0, E.fH)(E.v0.GET_STARTED)), [s]);
	return n === E.v0.SAVED_GUILDS
		? (0, i.jsx)(v, {
				className: t,
				onNavigateBack: c
			})
...
t.Z = function (e) {
	...
	return (0, c.iN)('discovery_toolbar')
		? (0, i.jsx)(Z, { className: t })
		: n === E.v0.SAVED_GUILDS
			? (0, i.jsx)(v, { className: t })
			: (0, i.jsxs)('div', {
					className: r()(I.toolbar, t),
					children: [
						(0, i.jsx)('div', {
						...
						(0, i.jsxs)('div', {
							...
							children: [(0, i.jsx)(p, {}), (0, i.jsx)(T, {}), (0, i.jsx)(S, {})]
						}),
						(0, i.jsx)('div', { className: I.actions })
					]
				});

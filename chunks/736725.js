...
var u = n(11065);
((r = a || (t.RichTextNodeType = a = {})).Text = 'text'), (r.Strong = 'strong'), (r.Emphasis = 'em'), (r.Strikethrough = 's'), (r.Code = 'inlineCode'), (r.Link = 'link'), (r.Paragraph = 'paragraph'), (r.Object = 'object');
var c = {
        $_: function () {
            return {
                type: a.Text,

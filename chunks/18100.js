...
var a = t(735250), r = t(470079), i = t(120356), s = t.n(i), o = t(442837), l = t(481060), c = t(231467), d = t(430824), u = t(214715), m = t(308083), f = t(689938), C = t(309479);
function _(e) {
    let {
            trait: n,
            selected: t,
    ...
    return (0, a.jsx)(u.Z, {
        ...
        className: s()(C.trait, { [C.strikethrough]: o }),
        text: n,
        selected: t,
    ...
    return (0, a.jsxs)('div', {
        children: [
            (0, a.jsxs)('div', {
                ...
                children: [
                    (0, a.jsx)('div', { className: h ? C.descriptionMask : void 0 }),
                    (0, a.jsx)(l.Heading, {
            ...
            (0, a.jsxs)('div', {
                ...
                children: [
                    (0, a.jsx)('div', { className: x ? C.traitsMask : void 0 }),
                    (0, a.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, a.jsx)(l.Text, {
                                variant: 'text-xs/semibold',
                                color: 'text-muted',
                                children: f.Z.Messages.CLAN_SETUP_NUM_TRAITS.format({ n: y.length })
                            })
                        ]
                    }),
                    (0, a.jsx)('div', {

...
let s = a(411496), o = n(a(210646)), d = a(613919), l = a(613919);
...
e.default = class t {
    ...
    prodId(t) {
        ...
        if ('string' == typeof t)
            throw Error('`prodId` isn\'t formated correctly. See https://sebbo2002.github.io/ical-generator/develop/reference/classes/icalcalendar.html#prodid');
        if ('object' != typeof t)
            throw Error('`prodid` needs to be a valid formed string or an object!');
        if (!t.company)
            throw Error('`prodid.company` is a mandatory item!');
        if (!t.product)
            throw Error('`prodid.product` is a mandatory item!');
    ...
    x(t, e) {
        if (void 0 === t)
            return (0, s.addOrGetCustomAttributes)(this.data);

var o = r(58615), n = r(860377), i = r(939059), a = r(746272), u = r(669013);
function s(t, e) {
...
l.addData = function (t) {
    ...
    for (var t = 8; t < this.moduleCount - 8; t++) {
        if (null == this.modules[t][6])
            this.modules[t][6] = t % 2 == 0;
    }
    for (var e = 8; e < this.moduleCount - 8; e++) {
        if (null == this.modules[6][e])
    ...
    for (var t = a.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
        for (var r = 0; r < t.length; r++) {
            ...
            if (null == this.modules[o][n])
                for (var i = -2; i <= 2; i++)
                    for (var u = -2; u <= 2; u++)
                        -2 == i || 2 == i || -2 == u || 2 == u || 0 == i && 0 == u ? this.modules[o + i][n + u] = !0 : this.modules[o + i][n + u] = !1;
        }
    ...
    for (u.getLengthInBits() + 4 <= 8 * h && u.put(0, 4); u.getLengthInBits() % 8 != 0;)
        u.putBit(!1);
    for (; !(u.getLengthInBits() >= 8 * h);) {
        ;
        if (u.put(s.PAD0, 8), u.getLengthInBits() >= 8 * h)
            break;
        u.put(s.PAD1, 8);
    }
    ...
    for (var r = 0, o = 0, n = 0, i = Array(e.length), s = Array(e.length), l = 0; l < e.length; l++) {
        var f = e[l].dataCount, h = e[l].totalCount - f;
        o = Math.max(o, f), n = Math.max(n, h), i[l] = Array(f);
        for (var g = 0; g < i[l].length; g++)
            i[l][g] = 255 & t.buffer[g + r];
        r += f;
        var c = a.getErrorCorrectPolynomial(h), d = new u(i[l], c.getLength() - 1).mod(c);

...
function S() {
  let [e, t] = n.useState(""), r = n.useRef(null), i = (0, u.Wu)([b.Z], () => b.Z.loggedTriggers), l = n.useMemo(() => i.filter(t => 0 === e.length || c()(e, t.experimentId)).sort((e, t) => t.timestamp.getTime() - e.timestamp.getTime()), [i, e]), [s, d] = n.useState(void 0), g = l.find(e => e.key === s), {
    TabBar: p,
    renderSelectedTab: y
  } = (0, v.Z)({
    tabs: N

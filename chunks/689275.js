...
function h(e) {
  null != e.threads && e.threads.length > 0 && (d[e.id] = {}, e.threads.filter(e => o.ALL_CHANNEL_TYPES.has(e.type)).forEach(t => E(e.id, t))), e.hasThreadsSubscription && c.add(e.id)
}

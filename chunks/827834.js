t.default = function () {
    ...
    return !function (e, t) {
        ...
        SyntaxError: e,
        parse: function (t) {
            var n, r, i, a, o, s, l, u = arguments.length > 1 ? arguments[1] : {}, c = {}, d = { start: ea }, _ = ea, E = function (e) {
                    var t, n, r, i, a, o = '';
            ...
            if ('startRule' in u) {
                if (!(u.startRule in d))
                    throw Error('Can\'t start parsing from rule "' + u.startRule + '".');
                _ = d[u.startRule];
            }
            function ei(e) {
                if (!($ < et))
                    ...
                    if (e = $, 123 === t.charCodeAt($) ? (n = '{', $++) : (n = c, 0 === er && ei(p)), n !== c) {
                        if (ed() !== c) {
                            if ((r = function () {
                                    var e, n, r;
                                    if ((e = ef()) === c) {
                                        if (e = $, n = [], f.test(t.charAt($)) ? (r = t.charAt($), $++) : (r = c, 0 === er && ei(h)), r !== c)
                                            for (; r !== c;)
                                                n.push(r), f.test(t.charAt($)) ? (r = t.charAt($), $++) : (r = c, 0 === er && ei(h));
                                        else
                                            n = c;
            ...
            function ec() {
                var e, n;
                if (er++, e = [], w.test(t.charAt($)) ? (n = t.charAt($), $++) : (n = c, 0 === er && ei(x)), n !== c)
                    for (; n !== c;)
                        e.push(n), w.test(t.charAt($)) ? (n = t.charAt($), $++) : (n = c, 0 === er && ei(x));
                else
                    e = c;

...
var r = n(470079), i = n(691324), a = n(442837), o = n(780384), s = n(813852), l = n(514361), u = n(629935);
let c = 'data-client-themes', d = 'custom-theme-background', _ = () => {
        let e = (0, a.e7)([l.Z], () => l.Z.gradientPreset), {enabled: t} = s.U.useExperiment({ location: 'useBackgroundGradientCSS' });
        return (0, r.useMemo)(() => {
            if (null == e)
                return null;

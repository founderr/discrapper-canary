...
function c(e) {
  ...
  function g(t, n) {
    ...
    function E() {
      ...
      (r !== a || _ !== o) && (n(d(e, r, c, i), r, o), a = r, _ = o)
    }
    return n(f, a, _), o.default.addReactChangeListener(E), () => {
  ...
  return {
    ...
    getCurrentConfig: function(t) {
      ...
      if (!1 !== n.autoTrackExposure || i.triggerDebuggingEnabled) {
        ...
        f(t, n.trackExposureOptions, e, i)
      }

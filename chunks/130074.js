...
var a = n("77078"),
  ...
  j = (0, s.default)((0, l.default)(function(e) {
    let {
      ...
      onSelect: B,
      onHeightUpdate: Y
    } = e, W = (0, F.default)(t.id, null), Z = (0, M.default)(t, k), K = (0, R.default)({
      user: t,
      context: k
    }), z = (0, m.default)(t), X = (0, x.default)(t.id), Q = (0, y.default)(n.id, l), q = (0, L.default)(t), J = (0, o.default)(null, t), $ = (0, b.default)(t.id), ee = (0, D.default)(t.id, n.id), et = (0, v.default)(t), en = (0, P.default)(t.id), ei = (0, U.default)(t.id, n.id), ea = (0, G.default)(t), er = (0, I.default)(n), el = (0, T.default)({
      id: t.id,

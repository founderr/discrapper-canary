...
var n = l(735250), a = l(470079), o = l(120356), s = l.n(o), i = l(399606), r = l(481060), C = l(823596), c = l(201070), d = l(893966), u = l(527379), m = l(689938), _ = l(388797);
function E(e) {
    let {
            guildId: t,
            onPageChange: l
        ...
        })), []), T = new Intl.NumberFormat(m.Z.getLocale()).format(h), L = m.Z.Messages.MEMBER_SAFETY_TABLE_PAGINATION_LABEL.format({ count: x ? '...' : T }), g = h > M.pageSize || x, I = h > C.LU['0'];
    return (0, n.jsxs)('div', {

...
function E(e) {
  let t, {
    ...
    C = null != g && !(0, c.default)(g.channelId) && S === h.ActivityPanelModes.PANEL;
  if (C) t = window;
  else {
    var _;
  ...
  return l.useEffect(() => (t.addEventListener("resize", T), o.ComponentDispatch.subscribe(m.ComponentActions.REMEASURE_TARGET, T), () => {

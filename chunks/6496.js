...
var r = n(683860), i = n(344185), a = n(569471), o = n(260483), s = n(144140), l = n(592125), u = n(703558), c = n(496675), d = n(117530), _ = n(709054), E = n(660189), f = n(559241), h = n(474387), p = n(702225), m = n(981631), I = n(176505), T = n(124368);
function g(e) {
...
function N(e) {
    ...
    if (null == r)
        return [];
    let i = l.Z.getChannel(r.parent_id), a = null == i ? void 0 : i.availableTags;
    if (null == i || null == a)
        return [];
    let o = null !== (n = null === (t = u.Z.getThreadSettings(e)) || void 0 === t ? void 0 : t.appliedTags) && void 0 !== n ? n : new Set(), s = new Set(a.map(e => e.id));

...
class B extends a.PureComponent {
    ...
    fixScroll() {
        ...
        if (null == e)
            return;
        let t = this.getRects(), n = this._prevRects;
        if (null == t.expanded || null == t.lastExpanded || null == n.expanded || t.expanded.top < t.lastExpanded.top)
            return;
        let s = n.expanded.height - t.lastExpanded.height, a = e.getScrollerState().scrollTop - s;
        e.scrollTo({ to: a });
    }
    getRects() {
        let e = {
    ...
    constructor(...e) {
        super(...e), U(this, '_clickedInside', !1), U(this, '_scrollerRef', null), U(this, '_expandedRef', void 0), U(this, '_lastExpandedRef', void 0), U(this, '_prevRects', this.getRects()), U(this, '_contentRef', a.createRef()), U(this, 'state', {
            ...
            var n;
            let {actionFilter: a} = this.props, i = (0, N.Pw)(e.value), r = (0, N.p5)(e.value), l = e.value === a;
...
t.Z = d.ZP.connectStores([
    ...
    let e = O.Z.getGuildId(), t = g.Z.getGuild(e), n = L.Z.logs;
    return {
        guildId: e,
        guild: t,

...
function T(e) {
  let {
action: t
  } = e, n = (0, o.e7)([m.Z], () => m.Z.getChannel(t.channelId)), a = (0, d.ZP)(n, !0);
...
emojiId: a,
emojiName: s
  } = e, l = (0, o.e7)([m.Z], () => m.Z.getChannel(n));
  if (null == l)
return null;
...
channelAction: C,
completed: g
  } = (0, E.P3)(h, m), v = (0, E.K_)(h, null == C ? void 0 : C.channelId), S = (0, o.e7)([u.Z], () => u.Z.useReducedMotion), Z = (null == C ? void 0 : C.actionType) === f.oi.VIEW, A = (0, c.useToken)(c.tokens.colors.WHITE), [M, b] = a.useState(!1), [R] = a.useState(new r.Z.Value(0)), [j] = a.useState(new r.Z.Value(0));
  a.useEffect(() => {
g ? r.Z.timing(R, {
  toValue: 0,
  duration: S ? 1 : 350,

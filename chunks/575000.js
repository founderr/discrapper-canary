...
var s, a = n(735250), i = n(470079), r = n(120356), l = n.n(r), o = n(920906), c = n(772848), d = n(374470), u = n(477690), _ = n(481060), E = n(624138), I = n(981631), T = n(689938), m = n(336334);
function N(e, t, n) {
...
class p extends (s = i.Component) {
    ...
    getProgressHeight(e) {
        ...
        if (null == a || n === s.numRequired)
            return s.y;
        let i = a.y - s.y, r = a.numRequired - s.numRequired, l = n - s.numRequired;
        return s.y + l / r * i;
    }
    getCurrentTierIndex() {
        let {
    ...
    renderForegroundTooltip() {
        ...
        if (!n || null == this.foregroundTooltipElementRef.current)
            return null;
        let i = t[this.getCurrentTierIndex() + 1], r = null != i ? i.numRequired : null, l = null != r ? r - e : null;
    ...
    constructor(...e) {
        super(...e), N(this, 'state', {
            ...
            if (!(0, d.k)(e.target))
                return;
            let t = e.target.getBoundingClientRect(), n = e.clientY - t.top;
            ...
            let {height: t} = e, {
                ...
                } = this.props, {tierMarkerActive: i} = this.state;
            for (let e = n.length - 1; e > 0; e--) {
                let r = n[e], l = i === e;
                if (t + 20 >= r.y && s >= r.numRequired) {
                    !l && (this.setState({ tierMarkerActive: e }), null != a && a(r));
                    return;
                }
            }

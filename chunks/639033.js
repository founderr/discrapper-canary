...
var i = n(735250);
n(470079);
var s = n(481060), a = n(570140), r = n(317770), l = n(314897), o = n(592125), c = n(797258), d = n(590415), u = n(981631);
...
class E extends r.Z {
    ...
    constructor(...e) {
        ...
        super(...e), t = this, a = 'handleVoiceStateUpdates', r = e => {
            var t;
            let {voiceStates: a} = e, r = l.default.getId(), E = null === (t = c.Z.getSession()) || void 0 === t ? void 0 : t.sessionId, h = a.find(e => e.userId === r && e.sessionId === E);
            if (null == h)
                return;
            let I = h.channelId;
            if (null == I) {

...
'undefined' != typeof window && window.Proxy && window.Reflect && (u = new Proxy(u, {
  get: (e, t, r) => ('map' === t && console.error(I), Reflect.get(e, t, r))
...
for (var S = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', D = 'undefined' == typeof Uint8Array ? [] : new Uint8Array(256), L = 0; L < S.length; L++)
  D[S.charCodeAt(L)] = L;
var h = function(e) {
...
a = '';
  for (t = 0; t < n; t += 3)
a += S[r[t] >> 2] + S[(3 & r[t]) << 4 | r[t + 1] >> 4] + S[(15 & r[t + 1]) << 2 | r[t + 2] >> 6] + S[63 & r[t + 2]];
...
return -1 === E && (E = _.length, _.push(e)), E;
  ...
  M = (e, t, r) => e.map(e => function e(t, r, n) {
...
'WebGLVertexArrayObjectOES'
  ].filter(e => 'function' == typeof t[e]).find(r => e instanceof t[r]);
...
let i = R(e.HTMLCanvasElement.prototype, 'getContext', function(e) {
  return function(o, ...i) {
    if (!A(this, t, r, n, !0)) {
      ...
      if (!('__context' in this) && (this.__context = e), a && [
          'webgl',
          'webgl2'
        ].includes(e)) {
...
this.pendingCanvasMutations.clear(), this.restoreHandlers.forEach(e => {
...
}), this.restoreHandlers = [], this.windowsSet = new WeakSet(), this.windows = [], this.shadowDoms = new Set(), (0, _.x)([
  this,
  'access',
  e => e.worker,
  'optionalAccess',
  ...
  'call',
  e => e()
]), this.worker = null, this.snapshotInProgressMap = new Map(), (this.options.recordCanvas && 'number' == typeof this.options.sampling || this.options.enableManualSnapshot) && (this.worker = this.initFPSWorker());
  }
  freeze() {
this.frozen = !0;
  }
...
if (this.mutationCb = e.mutationCb, this.mirror = e.mirror, this.options = e, c)
  n = c;
if ((E && 'number' == typeof t || e.enableManualSnapshot) && (this.worker = this.initFPSWorker()), this.addWindow(r), e.enableManualSnapshot)
  return;
f(() => {
  E && 'all' === t && (this.startRAFTimestamping(), this.startPendingCanvasMutationFlusher()), E && 'number' == typeof t && this.initCanvasFPSObserver(t, a, o, i, _, {
    dataURLOptions: s
  });
})();
  }
...
return e.onmessage = e => {
  ...
  if (this.snapshotInProgressMap.set(r, !1), !('base64' in t))
    return;
  let {
    base64: n,
    type: a,
...
let a = m(e, t, r, n, !1),
    ...
    for (let i of Object.getOwnPropertyNames(t.CanvasRenderingContext2D.prototype))
      try {
        ...
        let _ = R(t.CanvasRenderingContext2D.prototype, i, function(o) {
          return function(..._) {
            return !A(this.canvas, r, n, a, !0) && p(() => {
              let r = M(_, t, this);
              e(this.canvas, {
                type: O['2D'],
                property: i,
  ...
  i = function(e, t, r, n, a, o) {
    let i = [];
    return i.push(...U(t.WebGLRenderingContext.prototype, O.WebGL, e, r, n, a, o, t)), void 0 !== t.WebGL2RenderingContext && i.push(...U(t.WebGL2RenderingContext.prototype, O.WebGL2, e, r, n, a, o, t)), () => {
      i.forEach(e => e());
    };
    ...
    if (!!this.windows.length) {
      ...
      I = t, u(E).forEach(t => {
        ...
        if (!this.snapshotInProgressMap.get(r)) {
          if (t.width && t.height) {
            if (this.snapshotInProgressMap.set(r, !0), !e && [
                'webgl',
                'webgl2'

...
analyticsLocations: N
  ...
  return t.useEffect(() => {
0 !== I.length && f.default.track(O.rMx.VIEW_PREMIUM_APP_STOREFRONT, {
  application_id: n.id,
  sku_ids: I,
  location_stack: N
});
...
children: [
  ...
  (0, l.jsx)(d.Text, {
    ...
    children: null != n.termsOfServiceUrl && null != n.privacyPolicyUrl ? M.Z.Messages.STOREFRONT_VIEW_TOS_PP.format({
...
benefitItems: null != p ? p.map(e => (0, l.jsx)(a.G, {
  name: e.title,
  icon: e.icon
}, e.id)) : void 0,
...
analyticsLocations: g
  } = (0, p.ZP)(c.Z.APP_STOREFRONT), x = (0, o.e7)([S.Z], () => S.Z.getForSKU(a), [a]), f = (0, o.e7)([h.Z], () => h.Z.get(a), [a]), j = (0, N.M)(a);
  if (null == f)
return null;
...
y = f.type === O.epS.DURABLE ? L ? M.Z.Messages.STOREFRONT_DURABLE_AVAILABILITY_NONE : M.Z.Messages.STOREFRONT_DURABLE_AVAILABILITY : void 0,
{
  ...
  return null == E ? null : (0, l.jsx)(r.I, {
title: R,
description: k,
headerImage: Z,
availabilityLabel: y,

...
function L(n) {
  let {
    ...
    return null != e && null !== (n = b.Z.toURLSafe(e)) && void 0 !== n ? n : void 0
  }, [x]), _ = (0, o.e7)([u.Z], () => u.Z.useReducedMotion), I = t.useMemo(() => [...a.map(n => n.id), ...m.map(n => n.id)], [a, m]), {
...
function E(n) {
  ...
  }, [e, r.store_listing_benefits]), m = t.useMemo(() => {
    var n;
    return null != r.image_asset && null !== (n = b.Z.toURLSafe((0, _._W)(e, r.image_asset, 256))) && void 0 !== n ? n : void 0
  }, [e, r.image_asset]), v = r.subscription_plans.length > 0 ? r.subscription_plans[0] : null;
...
function y(n) {
  ...
  } = (0, p.ZP)(c.Z.APP_STOREFRONT), x = (0, o.e7)([f.Z], () => f.Z.getForSKU(a), [a]), S = (0, o.e7)([h.Z], () => h.Z.get(a), [a]), j = (0, N.M)(a);
  if (null == S) return null;
  let R = null !== (i = S.name) && void 0 !== i ? i : "",
    k = null !== (t = null == x ? void 0 : null === (e = x.description) || void 0 === e ? void 0 : e.trim()) && void 0 !== t ? t : void 0,
    Z = (null == x ? void 0 : x.headerBackground) != null && null !== (s = b.Z.toURLSafe((0, _._W)(u, x.headerBackground, 256))) && void 0 !== s ? s : void 0,
    L = S.type === O.epS.DURABLE && j,
    E = S.type === O.epS.DURABLE ? L ? M.Z.Messages.STOREFRONT_DURABLE_AVAILABILITY_NONE : M.Z.Messages.STOREFRONT_DURABLE_AVAILABILITY : void 0,
    {
      price: y
    } = S;

...
function Y(e) {
    ...
    let h = !l.isClaimed(), g = E && !l.isPomelo() && !l.hasVerifiedEmailOrPhone() || h, O = g ? F.Z.Messages.POMELO_UPDATE_DISABLED_MESSAGE : void 0;
    return (0, n.jsxs)('div', {
                    ...
                    (0, n.jsx)(_.Button, {
                        ...
                        onClick: function () {
                            (0, _.openModalLazy)(async () => {
                                let {default: e} = await Promise.resolve().then(s.bind(s, 607018));
                                return t => (0, n.jsx)(e, {

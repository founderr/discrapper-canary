...
let _ = r && r.event_id,
  a = (0, i.pt)(t) ? this.eventFromMessage(String(t), e, r) : this.eventFromException(t, r);
...
'string' != typeof t.release ? ('undefined' == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__) && _.kg.warn('Discarded session because of missing or non-string release') : (this.sendSession(t), (0, T.CT)(t, {
  init: !1
}));
  }
  getDsn() {

...
function C(e) {
  for (let [t, n] of Object.entries(e)) {
    ...
    if (null != n.action && r.call(T, i, O(t, n.action)), null != n.keyup && r.call(T, i, O(t, n.keyup), "keyup"), null != n.keydown) {
      let e = i.indexOf("any-character"); - 1 !== e && (! function(e, t) {
        let n = e => t(e, e.key);
        document.addEventListener(e, n), N.push(() => document.removeEventListener(e, n))
      }("keydown", n.keydown), i.splice(e, 1)), i.length > 0 && r.call(T, i, O(t, n.keydown), "keydown")
    }
    null != n.keypress && r.call(T, i, O(t, n.keypress), "keypress")
  }
  ...
  checkDupes(e) {
    let t = new Set,
      n = [];
    for (let i of p(e)) t.has(i) && n.push(i), t.add(i);

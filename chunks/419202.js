...
(s = l || (l = {}))[s.NONE = 0] = "NONE", s[s.CONTINUATION = 1] = "CONTINUATION", s[s.BEGINNING_OF_STREAM = 2] = "BEGINNING_OF_STREAM", s[s.END_OF_STREAM = 4] = "END_OF_STREAM";
class u {
  appendBytes(e) {
  ...
  addPage(e) {
    ...
    this._buffer.set([255 & i, i >> 8 & 255, i >> 16 & 255, i >> 24 & 255], s), this._pageSequenceNumber++
  }
  finalize(e) {
    this.addPage({
      pageType: 4,
...
function o(e, n) {
  ...
  for (let n of (a.addPage({
    ...
    let e = function(e) {
      ...
      for (let l = 0; l <= n; l++) {
        let a = 0 === l ? 0 : 255 * l,
          s = l === n ? e.length : (l + 1) * 255;
        t.push(e.slice(a, s))
      }
      return t
    }(n.buffer);
    s += n.numSamples, a.addPage({
      pageType: 0,
      granulePosition: s,
      segments: e
    })

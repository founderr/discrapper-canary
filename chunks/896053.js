...
function _(e) {
    let t = (0, d.Z)(e.id), n = (0, r.W)(e.id), _ = (0, u.j0)(e.id), f = (0, l.u)(e), g = (0, o.g)(e.id), m = (0, i.e7)([s.Z], () => s.Z.getNewMemberActions(e.id), [e.id]), C = (0, c.Z)(e.id), I = (0, a.n2)(e.id), E = [], N = e.hasFeature(p.oNc.HUB), x = e.hasFeature(p.oNc.COMMUNITY), S = e.hasFeature(p.oNc.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY);

...
function y() {
  return O([C.default, I.default, g.default, u.default], () => {
...
function U() {
  return O([g.default, h.default, _.default, A.default, C.default], () => {
    let e, t;
...
function j() {
  return O([g.default, o.default, _.default], () => {
    let e = g.default.getVoiceChannelId(),

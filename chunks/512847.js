...
function P() {
  return L([C.default, T.default, p.default, u.default], () => {
    let e = C.default.getChannel(p.default.getVoiceChannelId()),
...
function U() {
  return L([p.default, _.default, h.default, A.default, C.default], () => {
    let e, t;
    ...
    let o = null;
    return (null == (o = 1 === r.length ? r[0] : _.default.getCurrentUserActiveStream()) ? void 0 : o.state) === O.ApplicationStreamStates.CONNECTING && (o = null), null != o && (l = (0, d.encodeStreamKey)(o), i = _.default.getViewerIds(l).filter(e => e !== a).length), {
      channelType: e,
      voiceChannelId: n,
...
function j() {
  return L([p.default, o.default, h.default], () => {
    let e = p.default.getVoiceChannelId(),
      t = h.default.getId(),
...
function w() {
  return (0, a.jsxs)(a.Fragment, {
    children: [(0, a.jsx)(M, {}), (0, a.jsx)(P, {}), (0, a.jsx)(y, {}), (0, a.jsx)(D, {}), (0, a.jsx)(x, {}), (0, a.jsx)(U, {}), (0, a.jsx)(b, {}), (0, a.jsx)(j, {}), (0, a.jsx)(G, {})]
  })
}
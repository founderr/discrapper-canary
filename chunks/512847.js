  ...
  s.useEffect(() => {
    let s = t(),
      i = new r.BatchedStoreListener(e, () => {
        let e = t(),
          i = n(s, e);
        null != i && !S.default.isSoundDisabled(i) && (0, R.playSound)(i, null != a ? a : .4), s = e
      });
...
function M() {
  return L([p.default, I.default], () => ({
    ...
    shouldSkipMuteUnmuteSound: p.default.shouldSkipMuteUnmuteSound()
  }), (e, t) => {
    let {
      inVoiceChannel: n,
      selfMute: a,
    ...
    if (!!i) {
      if ((n || e.audioPermissionReady) && e.selfMute !== a) {
        if (l) {
          p.default.notifyMuteUnmuteSoundWasSkipped();
          return
        }
...
function y() {
  return L([C.default, g.default, I.default, u.default], () => {
    ...
    if (u && !a) {
      if (i || l || null != r && E.SILENT_JOIN_LEAVE_CHANNEL_TYPES.has(r)) return;
      return "disconnect"
    }
  }), null
}
...
function P() {
  return L([T.default], () => T.default.isCurrentUserSpeaking(), (e, t) => {
    if (e !== t) {
      ...
      if (p.default.getMode() === O.InputModes.PUSH_TO_TALK && !e) return t ? "ptt_start" : "ptt_stop"
    }
  }), null
}

function x() {
  return L([p.default], () => p.default.isSelfMutedTemporarily(), (e, t) => {
    if (e !== t) {
      let e = p.default.isSelfMute();
      if (p.default.getMode() === O.InputModes.VOICE_ACTIVITY && !e) return t ? "ptt_stop" : "ptt_start"
    }
  }), null
}
...
function U() {
  return L([I.default, h.default, _.default, A.default, C.default], () => {
    let e, t;
...
function j() {
  return L([I.default, o.default, _.default], () => {
    let e = I.default.getVoiceChannelId(),
      ...
      i = (0, v.isNotNullish)(e) ? o.default.getEmbeddedActivitiesForChannel(e) : o.NO_ACTIVITIES,
      l = (0, v.isNotNullish)(n) ? o.default.getEmbeddedActivitiesForChannel(n) : o.NO_ACTIVITIES;
    return {
      voiceChannelId: e,
      currentUserId: a,
      channelActivities: s,
    ...
    if (!u) {
      e.connectedChannelActivities.length < l.length && e.channelActivities.length < i.length && (n = "activity_launch");
...
function k() {
  return (0, a.jsxs)(a.Fragment, {
    children: [(0, a.jsx)(M, {}), (0, a.jsx)(y, {}), (0, a.jsx)(P, {}), (0, a.jsx)(x, {}), (0, a.jsx)(D, {}), (0, a.jsx)(U, {}), (0, a.jsx)(b, {}), (0, a.jsx)(j, {}), (0, a.jsx)(G, {})]
  })
}
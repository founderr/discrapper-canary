...
function y() {
  return O([g.default], () => g.default.isCurrentUserSpeaking(), (e, t) => {
    if (e !== t) {
      ...
      if (m.default.getMode() === L.InputModes.PUSH_TO_TALK && !e) return t ? "ptt_start" : "ptt_stop"
    }
  }), null
}

function x() {
  return O([m.default], () => m.default.isSelfMutedTemporarily(), (e, t) => {
    if (e !== t) {
      let e = m.default.isSelfMute();
      if (m.default.getMode() === L.InputModes.VOICE_ACTIVITY && !e) return t ? "ptt_stop" : "ptt_start"
    }
  }), null
}
...
function U() {
  return O([T.default, h.default, _.default, A.default, C.default], () => {
    ...
    let o = null;
    return (null == (o = 1 === r.length ? r[0] : h.default.getCurrentUserActiveStream()) ? void 0 : o.state) === L.ApplicationStreamStates.CONNECTING && (o = null), null != o && (l = (0, d.encodeStreamKey)(o), i = h.default.getViewerIds(l).filter(e => e !== a).length), {
      channelType: e,
      voiceChannelId: n,
...
function w() {
  return (0, a.jsxs)(a.Fragment, {
    children: [(0, a.jsx)(M, {}), (0, a.jsx)(P, {}), (0, a.jsx)(y, {}), (0, a.jsx)(x, {}), (0, a.jsx)(D, {}), (0, a.jsx)(U, {}), (0, a.jsx)(b, {}), (0, a.jsx)(j, {}), (0, a.jsx)(G, {})]
  })
}
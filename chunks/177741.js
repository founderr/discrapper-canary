...
g = I ? 'video/mp4' : 'video/webm';
  S && !e && a && null === t && !1 === i && v(I), r.useEffect(() => {
function t() {
  !e && T.Z.canPlayWowMoment && (s(!0), n = setTimeout(() => {
    s(!1), b(!0), _.default.track(f.rMx.PREMIUM_WOW_MOMENT_VIEWED, {
      wow_moment_type: 'gradient_highlight'
    });
  }, 2000));
}
return E.S.subscribe(f.CkL.PREMIUM_SUBSCRIPTION_CREATED, t), () => {
...
S
  ...
  let [y, b] = r.useState(!1), [x, U] = r.useState(!1), C = (0, M.useSpring)({
opacity: y ? 0.2 : 0,
config: {
  duration: 100
}
...
children: [
  H && (0, c.jsx)(l.Z, {
    ...
    onPlay: () => {
      clearTimeout(n), _.default.track(f.rMx.PREMIUM_WOW_MOMENT_VIEWED, {

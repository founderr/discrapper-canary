...
var a, o, r = i(735250), s = i(470079), c = i(120356), u = i.n(c), d = i(920906), m = i(442837), l = i(570140), p = i(607070), M = i(810090), w = i(626135), _ = i(526167), h = i(585483), W = i(138464), E = i(438820), T = i(831474), g = i(631274), f = i(194077), S = i(724688), I = i(981631), b = i(951507), P = i(422138), y = i(113386), x = i(48547);
async function C(e) {
    try {
        l.Z.dispatch({
...
t.default = function () {
    let e = (0, m.e7)([p.Z], () => p.Z.useReducedMotion), {
        ...
        })), [o, c] = s.useState(!1), l = (0, _.vu)(), g = (0, _.rO)(), f = l > 52 || -1 === l || g, S = g ? 'video/mp4' : 'video/webm';
    f && !e && a && null === t && !1 === i && C(g), s.useEffect(() => {
        function t() {
            let {enabled: t} = T.o.getCurrentConfig({ location: 'PremumSubscriptionWowMoment.tsx' });
            t && !e && E.Z.canPlayWowMoment && (c(!0), n = setTimeout(() => {
                c(!1), y(!0), w.default.track(I.rMx.PREMIUM_WOW_MOMENT_VIEWED, { wow_moment_type: 'gradient_highlight' });
            }, 2000));
        }

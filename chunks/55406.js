let r;
n(757143);
var i = n(302454), a = n.n(i), o = n(800927), s = n(945884), l = n(594199);
let u = a().defaultRules.lheading, c = a().defaultRules.heading, d = a().defaultRules.link, _ = a().defaultRules.image, E = a().defaultRules.list, f = a().defaultRules.blockQuote, h = a().defaultRules.paragraph, p = /\{(.+?)}/, m = /^\$(\w+?)\$/;
r = n(235375);
let I = e => {
        let {
        ...
        return (e, n, r) => {
            let i = p.exec(e[1]), o = e[1].replace(p, '');

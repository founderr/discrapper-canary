...
var n = s(735250), l = s(470079), a = s(120356), i = s.n(a), r = s(780384), o = s(481060), d = s(239091), c = s(741247), u = s(151888), h = s(689938), m = s(384027);
function g(e) {
    let {
            role: t,
            guild: a
        } = e, [r, u] = l.useState(!1);
    return (0, c.useHasGuildRoleItems)(a, t) ? (0, n.jsx)(o.Clickable, {
        onClick: e => {
            u(!0), (0, d.jW)(e, async () => {
...
function E(e) {
    ...
    return T ? (0, n.jsx)('div', { className: m.dragged }) : (0, n.jsx)(o.TabBar.Item, {
        className: m.role,
        id: a,
        selectedItem: p,
        onItemSelect: N,

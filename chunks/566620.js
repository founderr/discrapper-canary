...
guildId: l
  } = e, u = A.default.getSessionId(), c = R.default.getCurrentUser();
  if (null == i)
return !1;
  let d = null !== (t = p.Z.getApplication(i)) && void 0 !== t ? t : await (0, G.Z)(i, a);
  if (null == a)
return y.S.dispatch(Z.CkL.SHOW_ACTIVITIES_CHANNEL_SELECTOR, {
  applicationId: i
}), !1;
  let _ = N.Z.getChannel(a);
  if (null == _ || null == c || null == d)
return !1;
  let E = null != a ? (0, k.e4)({
channelId: a,
ChannelStore: N.Z,
...
return E === k.jy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION ? (0, g.w)() : E === k.jy.ACTIVITIES_FEATURE_NOT_ENABLED_FOR_OS && s.Z.show({
  ...
  if ((null == f ? void 0 : f.applicationId) != null && (n = p.Z.getApplication(null == f ? void 0 : f.applicationId)), !await (0, x.p)({
  applicationId: i,
  application: d,
  channel: _,
...
applicationId: i,
showFeedback: s = !0
  } = e, o = P.ZP.getSelfEmbeddedActivityForChannel(r);
  a.Z.dispatch({
...
guildId: o,
force: l = !1
  } = e, u = P.ZP.getShelfActivities(o), c = u.map(e => p.Z.getApplication(e.application_id)).filter(L.lm);

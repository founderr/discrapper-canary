s(47120);
var n = s(735250), a = s(470079), i = s(481060), r = s(484614), o = s(430492), l = s(153124), c = s(518638), d = s(689938), _ = s(925457);
t.Z = function (e) {
    let {
            onClose: t,
            onClaim: s,
    ...
    return a.useEffect(() => {
        ...
        children: null != I ? (0, n.jsx)(o.L1, {
            onClose: t,
            errorCode: I
        }) : null == E ? (0, n.jsx)(i.ModalContent, { children: (0, n.jsx)(i.Spinner, { className: _.loading }) }) : (0, n.jsxs)(n.Fragment, {
            children: [

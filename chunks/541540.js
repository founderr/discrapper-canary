...
var n = s(735250), a = s(470079), i = s(442837), r = s(481060), o = s(533307), l = s(930114), c = s(246946), d = s(285952), _ = s(626135), E = s(669079), u = s(981631), T = s(689938), I = s(817271);
function S(e, t, s) {
    ...
    constructor(...e) {
        super(...e), S(this, 'state', {
            ...
            try {
                ...
                }), (0, l.V)({ processedCode: s }), this.setState({ codeInput: '' });
            } catch (e) {
                this.setState({ hasError: !0 });
            } finally {
...
function C() {
    let e = a.useContext(_.AnalyticsContext), t = (0, i.e7)([c.Z], () => c.Z.enabled);
    return (0, n.jsx)(N, {
        analyticsContext: e,
        obscureInput: t
    });

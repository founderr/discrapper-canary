...
function en(e) {
  return I.default.findActivity(e, e => null != e.party && null != e.party.id && (0, P.isSpotifyParty)(e.party.id))
}
...
class es {
  ...
  handleOpen() {
    Y.info("WS Connected"), this.backoff.succeed(), this.pingInterval.start(U, () => this.ping()), (0, O.getProfile)(this.accountId, this.accessToken), (0, O.getDevices)(this.accountId, this.accessToken)
  }
  handleMessage(e) {
    let {
      data: t
    ...
    switch (n) {
      case B.MESSAGE:
        if ("string" == typeof i && i.startsWith(M)) this.connectionId = decodeURIComponent(i.split(M)[1]), (0, O.subscribePlayerStateNotifications)(this.accountId, this.accessToken, this.connectionId);
  ...
  constructor(e, t) {
    this._requestedDisconnect = !1, this._requestedConnect = !1, this.handleDeviceStateChange = u.throttle(() => {
      (0, O.getDevices)(this.accountId, this.accessToken), eh(this.accountId, this.accessToken)
...
function el(e, t, n) {
  ...
  let d = null != u && null != u.start ? u.start : Date.now(),
    ...
    f = !1,
    _ = Z[r.accountId];
  null != _ && !1 === _.repeat && (f = null), (0, O.play)(r.accountId, r.accessToken, o, {
    position: +c,
    deviceId: a.id,
    repeat: f
  }), s = {
  ...
  n && (h = "started", N.default.track(b.AnalyticEvents.SPOTIFY_LISTEN_ALONG_STARTED, {
    party_id: l.id,
    other_user_id: e
...
function eu() {
  ...
  null != i && i.track.id === e && (0, O.pause)(n.accountId, n.accessToken)
}
...
function ec() {
  ...
  J = !0, (0, O.pause)(t.accountId, t.accessToken), N.default.track(b.AnalyticEvents.SPOTIFY_AUTO_PAUSED), Y.info("Playback auto paused")
}
...
function e_(e, t, n) {
  ...
  if (null != r && !0 !== r.is_active && (r = {
    ...
    s = null != n && null != n.context && n.context.uri === d.uri ? Promise.resolve(n.context) : d.type === P.SpotifyResourceTypes.ALBUM ? Promise.resolve(d) : O.SpotifyAPI.get(e, t, {
      url: d.href
    }).then(e => {
      let {
        body: t
...
class eg extends c.default.Store {
  initialize() {
    this.waitFor(S.default, A.default), this.syncWith([I.default], () => (function() {
      if (null == s) return !1;
      let e = ee();
      if (null == e) return !1;
      let {
  ...
  shouldShowActivity() {
    return null != i && i.account.showActivity && !T.default.isIdle()
  }
  getActivity() {
    let e, t, n;
    ...
    let h = {},
      g = null != a.image ? (0, R.getAssetFromImageURL)(b.PlatformTypes.SPOTIFY, a.image.url) : null;
    ...
    return !d && (E.sync_id = l, E.flags = b.ActivityFlags.PLAY | b.ActivityFlags.SYNC, E.metadata = {
      context_uri: t,
      album_id: a.id,
      artist_ids: _.map(e => {
        let {
...
eg.displayName = "SpotifyStore";
let em = new eg(h.default, {
  ...
  SPOTIFY_PLAYER_STATE: function(e) {
    ...
    let h = Z[t],
      ...
      m = null != l && null != s && 0 === o && !n;
    !m && (Z[t] = g);
    let p = i;
    if (i = u.values(Z).find(e => null != e), ef(v.default.getId()), null == a || m ? z.stop() : z.start(a.duration - o + V, () => et(_.id)), null != s && (!n && o > 0 || null == l || null != g && s.trackId !== g.track.id) ? (Y.info("Listen along active but playback stopped or track changed. Stopping listen along in ".concat(V, "ms")), q.start(V, () => {
        Y.info("Stopping listening along"), (0, E.default)(), et(_.id)
      })) : q.isStarted() && (Y.info("Listen along stop cancelled as playback of track resumed"), q.stop()), p === i || null == h && null == g || null != h && null != g && h.track.id === g.track.id && h.startTime === g.startTime) return c;
    null != a && N.default.track(b.AnalyticEvents.ACTIVITY_UPDATED, {
  ...
  ACTIVITY_PLAY: function(e) {
    ...
    null != i && (t = i.context_uri), null != s && eu(), (0, O.play)(a.accountId, a.accessToken, l, {
      contextUri: t,
      deviceId: o.id

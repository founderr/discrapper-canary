...
super(...e), A = this, C(this, 'state', {
  isDragging: !1,
  isOverZone: !1
}), C(this, 'dragOverTimeout', null), C(this, 'elementDOMRef', n.createRef()), C(this, 'isAllDropFiles', e => {
  ...
  return !n && !r || (e.stopPropagation(), e.preventDefault(), a.effectAllowed = 'none', a.dropEffect = 'none', t && (A.setState({
    isDragging: !1
  }), (0, i.openUploadError)({

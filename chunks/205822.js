t(47120);
var n = t(735250), a = t(470079), r = t(120356), s = t.n(r), o = t(481060), l = t(310752), i = t(531643), d = t(689938), c = t(214932), u = t(120393);
function C(e, A, t) {
...
function g() {
    return (0, n.jsxs)('div', {
        children: [
            (0, n.jsx)('div', { className: s()(u.sparkleWhite, c.sparkleOne) }),
            (0, n.jsx)('div', { className: s()(u.sparkleWhite, c.sparkleTwo) }),
            (0, n.jsx)('div', { className: s()(u.lightWhite, c.lightOne) }),
            (0, n.jsx)('div', { className: s()(u.lightWhite, c.lightTwo) }),
            (0, n.jsx)('div', { className: s()(u.crossWhite, c.crossOne) }),
            (0, n.jsx)('div', { className: s()(u.crossWhite, c.crossTwo) }),
            (0, n.jsx)('div', { className: s()(u.popWhite, c.popOne) })
        ]
    });
}
class T extends a.Component {
                    ...
                    (0, n.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, n.jsx)('div', {
                                ...
                                children: (0, n.jsx)('pre', { children: A })
                            })
                        ]
                    })
                ]
    ...
    constructor(...e) {
        ...
        super(...e), A = this, C(this, 'state', {
            ...
            let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = e.dataTransfer;
            if (null == n)
                return !0;
            let a = Array.isArray(n.types) && -1 !== n.types.indexOf('text/uri-list') && -1 === n.types.indexOf('application/json'), r = null != n.items && !A.isAllDropFiles(n.items);
            return !a && !r || (e.stopPropagation(), e.preventDefault(), n.effectAllowed = 'none', n.dropEffect = 'none', t && (A.setState({ isDragging: !1 }), (0, i.openUploadError)({

...
class r extends _.Component {
  ...
  constructor(...e) {
    ...
    super(...e), t = this, L(this, "state", {
      ...
      if (null != _) {
        if (_.dropEffect = "copy", (0, A.hasModalOpen)(I.UPLOAD_ERROR_MODAL_KEY) && (0, A.closeModal)(I.UPLOAD_ERROR_MODAL_KEY), e.stopPropagation(), e.preventDefault(), null === (t = (E = this.props).onDragOver) || void 0 === t || t.call(E, e), !this.state.isDragging) {

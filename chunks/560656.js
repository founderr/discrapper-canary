...
var i = n(698091), a = r(n(624482)), o = r(n(102386)), s = r(n(248766)), l = n(239189), u = n(470079), c = n(672268), d = Symbol.for('Animated:node'), _ = function (e) {
        return !!e && e[d] === e;
    }, E = function (e, t) {
        ...
        a(t, e), t.create = function (e, n) {
            if (void 0 === n && (n = e), i.is.str(e) && i.is.str(n))
                return new t(e, n);
        ...
        return n.getValue = function () {
            ...
            if (i.is.num(t)) {
                if (!e.prototype.setValue.call(this, t))
                    return !1;
                else
                    this._string = null;
            } else
        ...
        return u.forwardRef(function (n, r) {
            var a = u.useRef(null), o = !i.is.fun(e) || e.prototype && e.prototype.isReactComponent, l = i.useForceUpdate(), d = new S(function () {
                    var e = a.current;
                    if (!o || !!e)
    ...
    }, N = Symbol.for('AnimatedComponent'), v = function (e) {
...
t.Animated = h, t.AnimatedArray = g, t.AnimatedObject = T, t.AnimatedProps = S, t.AnimatedString = m, t.AnimatedValue = p, t.createHost = function (e, t) {
    var n = void 0 === t ? {} : t, r = n.applyAnimatedValues, a = n.createAnimatedStyle, o = void 0 === a ? function (e) {
            return new T(e);
        } : a, s = n.getComponentProps, l = {
    ...
    return e && e[d];
}, t.getPayload = f, t.isAnimated = _, t.setAnimated = E;

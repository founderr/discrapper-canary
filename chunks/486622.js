...
function C(e) {
  let {
    ...
    onRejectSuccess: l,
    onError: C
  } = e, g = (0, m.default)(), [S, _] = a.useState(!1), [T, I] = a.useState(!1), [A, v] = a.useState(!1), [x, N] = a.useState(!1), [M, R] = a.useState(!1), L = S || T || A, y = a.useCallback(async e => {
    if (!L) {
      _(!0);
      try {

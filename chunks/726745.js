...
var a, o, s, l = n(213919), u = n(442837), c = n(570140), d = n(990492), _ = n(988965), E = n(71509);
function f(e, t, n) {
...
f(T, 'displayName', 'MultiAccountStore'), f(T, 'persistKey', 'MultiAccountStore'), f(T, 'migrations', [e => {
    ...
    CURRENT_USER_UPDATE: function (e) {
        let {user: t} = e, n = h.slice(), r = n.find(e => {
                let {id: n} = e;
                return n === t.id;
            });

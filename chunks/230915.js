...
var r, i = 'https://js.stripe.com/v3', a = /^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/, o = 'loadStripe.setLoadParameters was called but an existing Stripe.js script already exists in the document; existing script parameters will be used', s = function () {
        ...
        if (!r)
            throw Error('Expected document.body not to be null. Stripe.js requires a <body> element.');
    ...
    }, c = null, d = null, _ = null, E = function (e, t, n) {
        if (null === e)
            return null;
        ...
        return (e = r, null !== c ? c : (c = new Promise(function (t, n) {
            ...
            try {
                ...
                }, c.addEventListener('load', _), c.addEventListener('error', d);
            } catch (e) {
                n(e);
                return;
            }
...
p.setLoadParameters = function (e) {
    if (!(h && r && Object.keys(f(e)).reduce(function (t, n) {
            var i;
            return t && e[n] === (null === (i = r) || void 0 === i ? void 0 : i[n]);
        }, !0))) {
        if (h)
            throw Error('You cannot change load parameters after calling loadStripe');
        r = f(e);
    }
}, t.loadStripe = p;

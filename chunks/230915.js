...
var r, i = "https://js.stripe.com/v3",
  ...
  g = function() {
    ...
    return (e = r, null !== l ? l : (l = new Promise(function(t, n) {
      ...
      try {
        var r, i, a, c, l = s();
        l && e ? console.warn(o) : l ? l && null !== f && null !== d && (l.removeEventListener("load", f), l.removeEventListener("error", d), null === (c = l.parentNode) || void 0 === c || c.removeChild(l), l = u(e)) : l = u(e), r = t, i = n, f = function() {
...
g.setLoadParameters = function(e) {
  if (!(m && r && Object.keys(h(e)).reduce(function(t, n) {
      var i;

...
var a = s("37983"),
  ...
  F = e => {
    ...
    let {
      isFullscreen: s
    } = e, l = n.useRef(null), [F, W] = n.useState(!1), [w, V] = n.useState(!1), [Y, z] = n.useState(!1), [X, Q] = n.useState(!1), Z = (0, i.useStateFromStores)([E.default], () => E.default.getPremiumTypeSubscription()), J = null != Z ? (0, T.getPremiumPlanItem)(Z) : null, q = null != J ? T.default.getSkuIdForPlan(J.planId) : null, $ = null !== q && q !== G.PremiumSubscriptionSKUs.TIER_2 ? G.PremiumSubscriptionSKUs.TIER_2 : null, ee = (0, m.useLocalizedPromoQuery)(), et = null != ee, es = (0, p.usePremiumDiscountOffer)(), ea = (0, N.usePremiumTrialOffer)(), en = null == ea ? void 0 : null === (t = ea.subscription_trial) || void 0 === t ? void 0 : t.sku_id, el = (0, S.useIsInPremiumOfferExperience)(), er = (0, C.useIsEligibleForBogoPromotion)(), {
      enabled: ei
    } = (0, R.default)(), {
      ...
      children: [(0, a.jsx)(M.default, {
        ...
        children: [(0, a.jsx)(g.default, {
          ...
          children: (0, a.jsx)(O.default, {
            showWumpus: !0,
            tier0CTAButton: en === G.PremiumSubscriptionSKUs.TIER_2 || er || null != es ? (0, a.jsx)(D.default, {
              forceInverted: !0,
              showIcon: !1,
        ...
        }), (0, a.jsx)(v.default, {}), el ? (0, a.jsx)(j.default, {
          className: y.pdSparklesTop,
          variant: j.SparkleVariants.TOP
        }) : null, el ? (0, a.jsx)(j.default, {
        ...
        onChange: e => {
          e && !Y && (f.default.track(B.AnalyticEvents.PREMIUM_MARKETING_SURFACE_REACHED_BOTTOM, {
            location_stack: eu
          }), z(!0))
        },

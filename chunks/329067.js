...
function v(e) {
  ...
  } = (0, C.ZP)(), [B, D] = r.useState(!1), F = r.useRef(null), U = k[v], H = null != U ? U[I.id] : null, w = null != H ? (0, g.T4)(null == H ? void 0 : H.amount, null == H ? void 0 : H.currency) : null, G = r.useMemo(() => ({
    ...Z,
    load_id: b,

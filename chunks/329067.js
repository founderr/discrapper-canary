...
function _(e) {
  ...
  } = (0, f.default)(), [D, w] = l.useState(!1), F = l.useRef(null), H = B[_], U = null != H ? H[x.id] : null, W = null != U ? (0, g.formatPrice)(null == U ? void 0 : U.amount, null == U ? void 0 : U.currency) : null, G = l.useMemo(() => ({
    ...j,
    load_id: N,
  ...
  return (0, C.usePaymentStepForAuthentication)(A, P, K), (0, s.jsxs)("div", {

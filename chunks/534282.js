...
var u = r(428374), s = r(297326), c = r(470079), l = r(1231), f = r(292489), p = r(675411), h = r(685536), d = r(126502), g = r(65183), y = r(581079), v = r(822274);
g.List;
var m = function (t, e) {
        ...
        var p = n.reverse(), h = p[0].key;
        return r.push(c.cloneElement(t, {
            key: ''.concat(h, '-wrap'),
            'data-offset-key': s.encode(h, 0, 0)
        }, p)), r;
    }, S = function (t, e) {
        var r = e.get(t.getType()) || e.get('unstyled'), n = r.wrapper;
        return {
        ...
        return g.shouldComponentUpdate = function (t) {
            var e = this.props, r = e.block, n = e.direction, i = e.tree, o = !r.getChildKeys().isEmpty(), a = r !== t.block || i !== t.tree || n !== t.direction || m(t.selection, t.block.getKey()) && t.forceSelection;
            return o || a;
            ...
            if (!!n) {
                var i = f.getScrollParent(n), o = h(i);
                if (i === window) {
                    var a = p(n), u = a.y + a.height;
            ...
            var t = this, r = this.props, n = r.block, a = r.blockRenderMap, l = r.blockRendererFn, f = r.blockStyleFn, p = r.contentState, h = r.decorator, d = r.editorKey, g = r.editorState, y = r.customStyleFn, v = r.customStyleMap, x = r.direction, C = r.forceSelection, E = r.selection, D = r.tree, O = null;
            n.children.size && (O = n.children.reduce(function (r, n) {
                var i = s.encode(n, 0, 0), u = p.getBlockForKey(n), h = w(u, l), y = h.CustomComponent || e, v = S(u, a), m = v.Element, x = v.wrapperTemplate, C = k(u, d, i, f, h, null), E = o({}, t.props, {
            ...
            var K = n.getKey(), T = s.encode(K, 0, 0), M = w(n, l), A = M.CustomComponent, I = null != A ? c.createElement(A, i({}, this.props, {
            ...
            if (n.getParentKey())
                return I;
            var B = S(n, a).Element, L = k(n, d, T, f, M, this.wrapperRef);

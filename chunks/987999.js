...
function c(e) {
  ...
  return (0, n.jsxs)(t.Menu, {
    ...
    onSelect: a,
    children: [(null == L ? void 0 : L.applicationStatus) === M.wB.REJECTED && (0, n.jsx)(t.MenuItem, {
      id: "reapply",
      ...
      action: () => {
        (0, t.openModal)(e => (0, n.jsx)(t.ConfirmModal, {
          ...
          children: (0, n.jsx)(t.Text, {
            ...
            children: A.Z.Messages.MEMBER_VERIFICATION_WITHDRAW_APPLICATION_CONFIRMATION.format({
              name: s.name
            })
          })
        }))

...
var n = a(735250);
a(470079);
var I = a(442837), t = a(481060), i = a(239091), r = a(100527), o = a(970606), E = a(299206), l = a(693546), M = a(246364), u = a(937111), d = a(703656), _ = a(914010), C = a(981631), A = a(689938);
function c(e) {
    let {
            guild: s,
            onSelect: a
        ...
        }), L = (0, I.e7)([u.Z], () => u.Z.getRequest(c)), R = () => {
    ...
    return (0, n.jsxs)(t.Menu, {
        ...
        onSelect: a,
        children: [
            (null == L ? void 0 : L.applicationStatus) === M.wB.REJECTED && (0, n.jsx)(t.MenuItem, {
                id: 'reapply',
                label: A.Z.Messages.MEMBER_VERIFICATION_PENDING_APPLICATION_MODAL_REAPPLY,
                action: () => {
                    s.hasFeature(C.oNc.CLAN) && (0, o.Vr)({
                        guildId: c,
            ...
            (0, n.jsx)(t.MenuItem, {
                ...
                action: () => {
                    (0, t.openModal)(e => (0, n.jsx)(t.ConfirmModal, {

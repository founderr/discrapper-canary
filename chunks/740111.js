...
class d extends i.MessageType {
  ...
  internalBinaryWrite(e, t, n) {
    ...
    e.button && u.internalBinaryWrite(e.button, t.tag(6, i.WireType.LengthDelimited).fork(), n).join(), "" !== e.dismissKey && t.tag(7, i.WireType.LengthDelimited).string(e.dismissKey), "" !== e.heroArtVideoLinkLightTheme && t.tag(8, i.WireType.LengthDelimited).string(e.heroArtVideoLinkLightTheme), "" !== e.heroArtImageLinkDarkTheme && t.tag(9, i.WireType.LengthDelimited).string(e.heroArtImageLinkDarkTheme), "" !== e.heroArtImageLinkLightTheme && t.tag(10, i.WireType.LengthDelimited).string(e.heroArtImageLinkLightTheme), "" !== e.modalTopPill && t.tag(11, i.WireType.LengthDelimited).string(e.modalTopPill);
    let a = n.writeUnknownFields;
    return !1 !== a && (!0 == a ? i.UnknownFieldHandler.onWrite : a)(this.typeName, e, t), t
  }
  constructor() {

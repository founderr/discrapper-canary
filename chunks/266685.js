...
let P = s.forwardRef(function(e, t) {
  ...
  }, [G]), z = G.config.variants.includes(L.QuestVariants.POST_ENROLLMENT_CTA), q = s.useMemo(() => (0, S.calculatePercentComplete)(G) > 0, [G]), Q = (null === (n = G.userStatus) || void 0 === n ? void 0 : n.enrolledAt) != null, Z = (null === (i = G.userStatus) || void 0 === i ? void 0 : i.completedAt) != null, X = s.useMemo(() => (0, S.hasQuestCollectibleRewards)(G.config), [G.config]), J = P && D, $ = (0, S.getQuestBarHeroAssetUrl)(G), ee = (0, S.getQuestsInstructionsToWinReward)({
    quest: G,

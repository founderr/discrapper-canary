...
quest: H,
useReducedMotion: V
  } = e, z = (0, i.e7)([C.Z], () => C.Z.isEnrolling(H.id), [H]), G = (0, _.B6)(H.config.expiresAt), F = v.r.build(H.config), Y = (0, _.B6)(F.rewardsExpireAt), K = o.useMemo(() => (0, E.nP)(H.config.assets.questBarHero), [H]), X = (0, R.tP)(F.application.id), J = F.features.has(y.S7.START_QUEST_CTA) ? g.jZ.START_QUEST : g.jZ.ACCEPT_QUEST, $ = F.features.has(y.S7.START_QUEST_CTA) ? M.Z.Messages.QUESTS_START_QUEST : M.Z.Messages.QUESTS_ACCEPT_QUEST, ee = o.useCallback(() => {
(0, f.AH)(H.id, {
...
(0, E.FE)(H, {
  ...
  }, [H]), es = F.features.has(y.S7.POST_ENROLLMENT_CTA), eo = (0, _.Rf)(H), ea = (0, _.Jf)(H), er = null != ea ? ea.progress > 0 : eo.progressSeconds > 0, el = (null === (n = H.userStatus) || void 0 === n ? void 0 : n.enrolledAt) != null, ei = (null === (a = H.userStatus) || void 0 === a ? void 0 : a.completedAt) != null, ec = o.useMemo(() => (0, E.Xv)(H.config), [H.config]), ed = Z && P, eu = (0, E.ph)(H), ep = (0, S.D)({
quest: H,
taskDetails: eo,

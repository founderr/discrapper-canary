...
} = (0, l.ZP)(), a = (0, E.vn)(t.id)[N.Eu4.TIER_1] - t.premiumSubscriberCount;
return (0, s.jsxs)('div', {
...
let t, n, a, {
  ...
  u = (0, E.A3)(l),
  _ = r.length;
return null == d || l === N.Eu4.TIER_3 || o > 0 ? (0, s.jsx)(s.Fragment, {}) : (_ > u ? (t = h.Z.Messages.GUILD_SETTINGS_STICKERS_UPSELL_BANNER_TOO_MANY_STICKERS_HEADER.format({
  level: d
}), n = h.Z.Messages.GUILD_SETTINGS_STICKERS_UPSELL_BANNER_TOO_MANY_STICKERS_TEXT.format({
  level: d
}), a = N.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = h.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_BANNER_HEADER, n = h.Z.Messages.GUILD_SETTINGS_STICKERS_UPSELL_BANNER_TEXT.format({
  level: d,

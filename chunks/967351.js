...
class C extends a.EventEmitter {
    handleConnection(e) {
        I(e, !1),
            ...
            e.once('handshake', (t) => {
                ...
                E.info('Socket Opened: '.concat(n.id)),
                    e.on('error', (e) => E.error('Socket Error: '.concat(e.message))),
                    e.on('close', () => {
    ...
    constructor() {
        ...
        e.on('error', (e) => E.error('Error: '.concat(e.message))),
            h.getAvailableSocket(p).then((t) => {
                e.listen(t, () => {

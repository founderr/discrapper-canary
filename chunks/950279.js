...
matchSorterOptions: x
  } = (0, c.P)(), p = r.useMemo(() => Array.from(n), [n]), g = r.useCallback(e => {
if (!(e.length < l))
  i(new Set(e));
  }, [
l,
    ...
    (0, a.jsxs)('div', {
      ...
      children: [
        ...
        (0, a.jsx)('div', {
          ...
          children: p.map(e => (0, a.jsx)(o.Tooltip, {
...
function h(e) {
  let {
guildId: n,
selectedGameApplicationIds: t,
onUpdateGames: i
  } = e, {
topGames: s,
tryFetchTopGames: c
  } = (0, l.B)(), u = s.get(n), [f, C] = r.useState(!1);
  r.useEffect(() => {
C(!0), c(n).finally(() => {
  C(!1);
});
...
x = r.useCallback(e => {
  ...
  return f && null == u ? (0, a.jsx)(o.Spinner, {
className: _.loadingSpinner
  }) : null == h || 0 === h.length ? null : (0, a.jsxs)(a.Fragment, {
children: [
  (0, a.jsx)('hr', {

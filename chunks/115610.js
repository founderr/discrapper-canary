...
var i = n(904245), a = n(339085), s = n(957730), r = n(285651), l = n(268350), o = n(926491), c = n(373228), d = n(430824), u = n(594174), _ = n(176354), E = n(709054), I = n(981631), m = n(185923);
function T(e) {
...
async function h(e, t) {
    ...
    if (null == f)
        return;
    await (0, l.$p)();
    let p = Array.from(o.Z.getAllStickersIterator()), C = p.filter(e => e.type === c.n0.GUILD).filter(e => T(e.guild_id) && (0, r.kl)(e, f, t)).sort((e, t) => -E.default.compare(e.id, t.id));
    if (C.length > 5) {

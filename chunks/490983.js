...
let V = {
    ...
    Z = (0, L.oH)((e) => e.filter((e) => null != e.libraryApplication && R.Z.isLaunchable(e.libraryApplication.id, e.libraryApplication.branchId))),
        ...
        i = Object.values(g.Z.getAllLibraryApplications())
            .map((r) =>
                (function (e, t, n, r, i) {
                    ...
                    let l = K(o, n);
                    if ((t.add(e.id), !(0, y.Je)(e) && !R.Z.isInstalled(e.id, e.branchId))) return null;
                    return {
                        key: ''.concat(e.id, '-').concat(e.branchId),
                        application: o,
                        libraryApplication: e,
                        lastPlayed: l,
                        supportsCloudSync: null != e && R.Z.supportsCloudSync(e.id, e.branchId),
                        ...
                        shouldShowInLibrary: (0, y.d0)(o, e, A.Z),

...
class O extends (i = s.PureComponent) {
    ...
    render() {
        ...
        let { guild: t, className: n, theme: i, onTagClick: s } = this.props,
            ...
            { name: L, description: Z, presenceCount: O, memberCount: R, keywords: x } = t,
        ...
        p.w.trackExposure({ location: 'de1ef6_1' });
        ...
        return (0, a.jsx)(o.$, {
            ...
            children: A
                                          ...
                                          children: [
                                              (0, a.jsx)('div', {
                                                  ...
                                                  children: (0, a.jsx)('img', {
                                                      src: M,
                                                      alt: '',
                                                      className: l()(N.splashImage, { [N.splashImageHeight]: !b }),
                                                  ...
                                                  children: [
                                                      ...
                                                      null != R &&
                                                          (0, a.jsxs)('div', {
                                                              className: N.memberCount,
                                                              children: [
                                                                  (0, a.jsx)('div', { className: N.dotOffline }),
                                                                  (0, a.jsx)(c.Text, {
                                                                      className: N.memberCountText,
                                                                      variant: 'text-xs/normal',
                                                                      color: 'header-secondary',
                ...
                : (0, a.jsx)('div', { className: l()(N.card, { [N.cardWithTags]: y }) })
        });
    }
    constructor(...e) {
        super(...e),
...
Z(O, 'Placeholder', (e) => (0, a.jsx)('div', { className: l()(e.className, N.cardPlaceholder) })), (t.Z = O);

...
var i = n(735250), s = n(470079), a = n(120356), o = n.n(a), r = n(442837), l = n(481060), c = n(13245), d = n(287734), u = n(933557), h = n(984370), p = n(910611), f = n(131704), _ = n(523746), g = n(592125), m = n(430824), E = n(699516), Z = n(944486), I = n(547881), S = n(707878), C = n(689938), v = n(906009);
function x(e, t, n) {
...
class T extends s.Component {
    ...
    renderCallButton() {
        ...
        if (!(0, f.hv)(n.type))
            return null;
        let r = l.PhoneCallIcon, c = !1;
        return s ? a ? (e = C.Z.Messages.LEAVE_CALL, r = l.PhoneHangUpIcon) : e = C.Z.Messages.JOIN_CALL : o ? (e = C.Z.Messages.CALL_UNAVAILABLE_BLOCKED_USERS, t = l.Tooltip.Colors.RED, c = !0) : e = C.Z.Messages.START_VOICE_CALL, (0, i.jsx)(h.Z.Icon, {
            icon: r,
            tooltip: e,
    ...
    render() {
        let {
            ...
            } = this.props, {showOpacitySlider: _} = this.state;
    ...
    constructor(...e) {
        super(...e), x(this, 'state', { showOpacitySlider: !1 }), x(this, 'handleClickCall', e => {
            let {
                channel: t,
            ...
            if (i)
                n ? d.default.selectVoiceChannel(null) : c.Z.callPrivateChannel(t.id, !1);
            else {
                let n = !i && !e.shiftKey;
            ...
            let {
                    ...
                    handlePin: t,
                    pinned: n
                } = this.props, a = n ? C.Z.Messages.OVERLAY_WIDGET_HIDE_IN_GAME : C.Z.Messages.OVERLAY_WIDGET_SHOW_IN_GAME;
...
function N(e) {
    let {
        ...
        }), a = (0, r.e7)([m.Z], () => m.Z.getGuild(t.guild_id)), o = (0, r.e7)([_.Z], () => _.Z.isCallActive(t.id)), l = (0, u.ZP)(t), c = (0, r.e7)([E.Z], () => !!t.isDM() && null != t.getRecipientId() && E.Z.isBlocked(t.getRecipientId()));
    return (0, i.jsx)(T, {
        channel: t,
        channelName: l,
        guild: a,

...
let v = e => {
    let {
      ...
      step: a,
      guildId: l
    } = e, u = (0, T.useSubscriptionsSettings)(l), c = (0, o.default)(m.RESPONSIVE_MOBILE_HEIGHT_SMALL_QUERY), _ = (() => {
      var e;
      if (c) return null;
  ...
  g = e => {
    let {
      ...
      listing: n,
      guildId: a
    } = e, s = (0, l.useStateFromStores)([c.default], () => c.default.getGuild(a), [a]), o = (0, I.default)(a).filter(e => e.roles.includes(n.role_id)), d = n.role_benefits.benefits.filter(_.isChannelBenefit).slice(0, null === o.length ? 4 : 3), f = (0, S.default)(d).slice(0, null === o.length ? 4 : 3);
    return (0, i.jsxs)("div", {

...
}), e(47120), e(315314), e(610138), e(216116), e(78328), e(815648), e(653041), e(411104);
var n = e(772848), r = e(647425), a = e(170830);
function o(i, t, e) {
...
let l = Math.min(4, Math.ceil(navigator.hardwareConcurrency / 2)), h = 'undefined' != typeof OffscreenCanvas, d = [], u = new Map(), v = new Map(), I = (0, a.G)(async () => {
        for (let i = 0; i < l; i++) {
...
class w {
    ...
    async drop() {
        ...
        if (await this.initializationPromise, h) {
            ...
            if (null == s)
                throw Error('No worker index assigned for asset '.concat(this.canvasId));
            u.delete(this.canvasId), d[s].numActive--;
        } else
            null === (s = this.lottieView) || void 0 === s || s.drop();
    ...
    constructor({
        ...
        o(this, 'assetUrl', void 0), o(this, 'assetData', void 0), o(this, 'canvasId', void 0), o(this, 'lottieView', void 0), o(this, 'observer', void 0), o(this, 'isVisible', !1), o(this, 'isInitialized', !1), o(this, 'initializationPromise', void 0), o(this, 'shouldAnimate', !1), o(this, 'onInitialDraw', void 0), o(this, 'onError', void 0), o(this, 'handleVisibilityChange', i => {
            ...
            if (t !== this.isVisible) {
                var e, s;
                if (this.isVisible = t, !this.isInitialized)
                    return;
        ...
        }), this.canvasId = (0, n.Z)(), this.assetUrl = e, this.assetData = a, this.onInitialDraw = l, this.onError = d, this.observer = new IntersectionObserver(this.handleVisibilityChange), this.observer.observe(i), h ? this.initializationPromise = I().then(() => {
            var s, n, o;

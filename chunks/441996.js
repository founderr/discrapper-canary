...
super(...e), d(this, 'dataChangedAt', void 0), d(this, 'fillColor', void 0), d(this, 'maxValue', void 0), d(this, 'canvas', a.createRef()), d(this, 'animationFrameRequestId', void 0), d(this, 'updateAnimation', e => {
  ...
  s.forEach((e, i) => {
    t = {
      x: f,
      y: I * e / E
    }, 0 === i ? h.moveTo(t.x, t.y) : h.bezierCurveTo(n.x + T, n.y, t.x - T, t.y, t.x, t.y), n = t, f += p;
  }), h.stroke(), h.lineTo(f - p, 0), h.lineTo(0, 0), h.fill(), d && _ < 1 && (this.animationFrameRequestId = window.requestAnimationFrame(this.updateAnimation));
});
  }
}
d(u, 'defaultProps', {

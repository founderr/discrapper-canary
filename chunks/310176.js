var n = r(837512), i = r(963107), o = r(221366), a = r(149808), u = r(624001), s = r(65183), c = r(360870), l = r(867864), f = r(581079), p = r(896775), h = r(351612), d = r(958594), g = r(81368), y = s.OrderedSet, v = {
        replaceText: function (t, e, r, i, o) {
            var a = d(h(t, e), e), u = n.create({
                    style: i || y(),
                    entity: o || null
                });
        ...
        moveText: function (t, e, r) {
            var n = u(t, e), i = v.removeRange(t, e, 'backward');
            return v.replaceWithFragment(i, r, n);
        },
        replaceWithFragment: function (t, e, r) {
            var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 'REPLACE_WITH_NEW_DATA', i = d(h(t, e), e);
        ...
        removeRange: function (t, e, r) {
            ...
            var n, i, o, u, s = e.getStartOffset(), c = e.getEndOffset(), l = o.getEntityAt(s), f = u.getEntityAt(c - 1);
            if (n === i && l && l === f) {

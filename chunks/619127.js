...
function s(e, t, n, r, i) {
  for (var o, s, a, c, u = n[0], l = n[1], d = n[2], f = n[3], p = e[0] ^ t[0], h = e[1] ^ t[1], v = e[2] ^ t[2], g = e[3] ^ t[3], b = 4, m = 1; m < i; m++) o = u[p >>> 24] ^ l[h >>> 16 & 255] ^ d[v >>> 8 & 255] ^ f[255 & g] ^ t[b++], s = u[h >>> 24] ^ l[v >>> 16 & 255] ^ d[g >>> 8 & 255] ^ f[255 & p] ^ t[b++], a = u[v >>> 24] ^ l[g >>> 16 & 255] ^ d[p >>> 8 & 255] ^ f[255 & h] ^ t[b++], c = u[g >>> 24] ^ l[p >>> 16 & 255] ^ d[h >>> 8 & 255] ^ f[255 & v] ^ t[b++], p = o, h = s, v = a, g = c;
...
var a = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
  c = function() {
    ...
    for (var n = [], r = [], i = [
      ...
      i[0][s] = p << 24 | p >>> 8, i[1][s] = p << 16 | p >>> 16, i[2][s] = p << 8 | p >>> 24, i[3][s] = p, p = 16843009 * f ^ 65537 * d ^ 257 * l ^ 16843008 * s, o[0][u] = p << 24 | p >>> 8, o[1][u] = p << 16 | p >>> 16, o[2][u] = p << 8 | p >>> 24, o[3][u] = p, 0 === s ? s = a = 1 : (s = l ^ e[e[e[f ^ l]]], a ^= e[e[a]])
    }
    return {
      SBOX: n,
      INV_SBOX: r,
...
u.blockSize = 16, u.keySize = 32, u.prototype.blockSize = u.blockSize, u.prototype.keySize = u.keySize, u.prototype._reset = function() {
  ...
  for (var u = [], l = 0; l < r; l++) {
    var d = r - l,
      f = i[d - (l % 4 ? 0 : 4)];
    l < 4 || d <= 4 ? u[l] = f : u[l] = c.INV_SUB_MIX[0][c.SBOX[f >>> 24]] ^ c.INV_SUB_MIX[1][c.SBOX[f >>> 16 & 255]] ^ c.INV_SUB_MIX[2][c.SBOX[f >>> 8 & 255]] ^ c.INV_SUB_MIX[3][c.SBOX[255 & f]]
  }

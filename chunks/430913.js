...
function T(e) {
  ...
  } = e, [T, P] = a.useState(null), x = [], S = null !== (i = null == r ? void 0 : null === (t = r.directory_entry) || void 0 === t ? void 0 : t.external_urls) && void 0 !== i ? i : [];
  a.useEffect(() => {
    var e;
    if ((null === (e = r.directory_entry) || void 0 === e ? void 0 : e.supported_locales) !== void 0) {
      let e = new Set(r.directory_entry.supported_locales);
      P(C.filter(t => e.has(t.value)).map(e => e.localizedName))
    }
  }, [r.directory_entry]);
  let j = (e, t) => {
  ...
  })), null != T && T.length > 0 && x.push((0, l.jsxs)(l.Fragment, {
    children: [(0, l.jsx)(o.Heading, {
      className: E.sectionHeader,
      variant: "eyebrow",

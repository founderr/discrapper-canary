...
function T(e) {
  ...
  let {
    ...
    url: s,
    children: o
  } = e, c = (0, d.default)(), f = u.default.getByUrl(s), m = (0, r.isThemeDark)(c) ? null == f ? void 0 : null === (t = f.icon) || void 0 === t ? void 0 : t.darkSVG : null == f ? void 0 : null === (i = f.icon) || void 0 === i ? void 0 : i.lightSVG;
  return (0, l.jsx)(C, {
    icon: void 0 === m ? p.default : void 0,
    imageSrc: m,
    onClick: n,
    url: s,
    type: null !== (a = null == f ? void 0 : f.name) && void 0 !== a ? a : "website",
    children: o
  })
}
...
function C(e) {
  let {
    ...
    children: d,
    onClick: u
  } = e, p = (0, h.default)(), f = null;
  null != t ? f = (0, l.jsx)(t, {
    className: E.listIcon,
    color: a,
    width: 20,
    height: 20
  }) : null != i && (f = (0, l.jsx)("img", {
...
function P(e) {
  ...
  } = e, [P, N] = a.useState(null), x = [], S = null !== (i = null == r ? void 0 : null === (t = r.directory_entry) || void 0 === t ? void 0 : t.external_urls) && void 0 !== i ? i : [];
  a.useEffect(() => {
    var e;
  ...
  return null != r.categories && r.categories.length > 0 && x.push((0, l.jsxs)(l.Fragment, {
  ...
  })), null != P && P.length > 0 && x.push((0, l.jsxs)(l.Fragment, {
    children: [(0, l.jsx)(o.Heading, {
      className: E.sectionHeader,
      variant: "eyebrow",
      children: A.default.Messages.APP_DIRECTORY_PROFILE_LANGUAGES_HEADING
    }), (0, l.jsx)(g.default, {
      supportedLanguages: P
    })]
  })), (null != r.terms_of_service_url || null != r.privacy_policy_url || S.length > 0) && x.push((0, l.jsxs)(l.Fragment, {
    children: [(0, l.jsx)(o.Heading, {
      className: E.sectionHeader,
      variant: "eyebrow",
  ...
  })), null != r.guild && r.guild.features.includes(v.GuildFeatures.DISCOVERABLE) && x.push((0, l.jsxs)(l.Fragment, {
    children: [(0, l.jsx)(o.Heading, {
      className: E.sectionHeader,
      variant: "eyebrow",
    ...
    children: x.length > 0 ? (0, l.jsx)(l.Fragment, {

...
function P(e) {
  ...
  return (0, t.jsx)(c.Z, {
    href: a,
    className: s()(v.listItem, v.linkItem),
    onClick: () => (u(a, r), !1),
    trusted: !p,
...
function C(e) {
  ...
  } = e, [C, T] = l.useState(null), x = [], N = null !== (i = null == r ? void 0 : null === (n = r.directory_entry) || void 0 === n ? void 0 : n.external_urls) && void 0 !== i ? i : [];
  l.useEffect(() => {
    var e;
    if ((null === (e = r.directory_entry) || void 0 === e ? void 0 : e.supported_locales) !== void 0) {
      let e = new Set(r.directory_entry.supported_locales);
      T(A.filter(n => e.has(n.value)).map(e => e.localizedName))
    }
  }, [r.directory_entry]);
  let f = (e, n) => {
  ...
  return null != r.categories && r.categories.length > 0 && x.push((0, t.jsxs)(t.Fragment, {
  ...
  })), null != C && C.length > 0 && x.push((0, t.jsxs)(t.Fragment, {
    children: [(0, t.jsx)(o.Heading, {
      className: v.sectionHeader,
      variant: "eyebrow",
  ...
  })), (null != r.terms_of_service_url || null != r.privacy_policy_url || N.length > 0) && x.push((0, t.jsxs)(t.Fragment, {
    children: [(0, t.jsx)(o.Heading, {
      className: v.sectionHeader,
      variant: "eyebrow",
  ...
  })), null != r.guild && r.guild.features.includes(g.oNc.DISCOVERABLE) && x.push((0, t.jsxs)(t.Fragment, {
    children: [(0, t.jsx)(o.Heading, {
      className: v.sectionHeader,
      variant: "eyebrow",
    ...
    className: s()(v.sidebar, d),
    children: x.length > 0 ? (0, t.jsx)(t.Fragment, {
      children: x.map((e, n) => (0, t.jsx)("div", {
        className: v.section,
        children: e
      }, n))
    }) : null

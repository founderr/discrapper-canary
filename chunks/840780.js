...
return (null != u || null == d) && (s || r && null != u) ? (s ? (e = !1, t = this.handleClickStopStreamingButton, n = h.ScreenXIcon, l = eN.Z.Messages.STOP_STREAMING) : c ? (e = !1, t = this.handleClickGoLiveButton, n = h.ScreenArrowIcon, l = null != u ? eN.Z.Messages.ACTIVITY_PANEL_GO_LIVE_STREAM_GAME.format({
  game: u.name
}) : eN.Z.Messages.ACTIVITY_PANEL_GO_LIVE) : (e = !0, t = null, n = h.ScreenArrowIcon, l = null != o && (0, X.vd)(o.type) ? eN.Z.Messages.ACTIVITY_PANEL_GO_LIVE_TOOLTIP_NO_PERMISSION_IN_VOICE : null != a ? eN.Z.Messages.ACTIVITY_PANEL_GO_LIVE_TOOLTIP_NO_PERMISSION_IN_GUILD : eN.Z.Messages.ACTIVITY_PANEL_GO_LIVE_TOOLTIP_NOT_IN_GUILD), (0, i.jsx)('div', {
...
return this.isJoinableActivity() && null == e ? (0, i.jsx)(ep.Z, {
...
return null == e || null == t ? null : (0, i.jsx)(ep.Z, {
...
return l || (this.isJoinableActivity() || e) && (null != n || null != t) ? (0, i.jsx)('div', {
  ...
  constructor(...e) {
super(...e), eS(this, 'modalKey', void 0), eS(this, 'state', {
  isDropsActivityPanelTooltipOpen: !1,
  ...
  let {
    ...
    channel: t,
    runningGame: n
  } = this.props, i = null != t && (0, X.vd)(t.type) ? t : null;
  ...
  let {
    ...
    channel: t,
    canStartBroadcast: l
  } = this.props, r = null != t && (0, X.vd)(t.type) ? t : null, a = null != r ? r.getGuildId() : e;
  ...
  o()(null != e, 'Received null activity'), ed.default.track(eC.rMx.OPEN_MODAL, {
  ...
  if (null == e)
    return;
  let i = (0, y.BS)(e);
  null != i && (ed.default.track(eC.rMx.DROPS_ACTIVITY_PANEL_BUTTON_CLICK, {
    user_id: n,
...
guildId: n,
...l
  } = e, r = (0, c.e7)([$.default], () => $.default.getId()), a = (0, c.e7)([
w.ZP,
eu.Z
  ], () => (0, z.Z)(w.ZP, eu.Z)), s = (0, c.e7)([
es.Z,
ee.Z
...
if (null != x)
  ...
  }()) && void 0 !== t ? t : '']), L = (0, c.e7)([ei.Z], () => (0, V.Z)(ei.Z) && (0, eh.isWindows)()), b = (0, c.e7)([er.Z], () => null != r ? er.Z.findActivity(r, e => e.type === eC.IIU.PLAYING) : null), M = null != p && p.ownerId === r && p.state !== eC.jm8.ENDED, R = (0, c.e7)([eo.Z], () => eo.Z.getBroadcast()), y = (0, T.Z)() && null != a, j = (0, c.e7)([
ec.default,
ea.Z
  ], () => null != d ? (0, A.F6)(d, ec.default, ea.Z) : void 0), D = (0, q.Z)(null == s ? void 0 : s.id, r);
  return (0, i.jsx)(eZ, {
...l,
guildId: n,
canGoLive: L,

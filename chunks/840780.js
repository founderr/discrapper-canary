    ...
    constructor(...e) {
        ...
        super(...e),
            ...
            (i = () => {
                ...
                s()(null != t, 'Channel is null during navigation click'), s()(null != n, 'Activity null during navigation click'), p.Z.channelListScrollTo(null !== (e = t.guild_id) && void 0 !== e ? e : $.ME, t.id), (0, C.R)() ? u.Z.dispatch({ type: 'ACTIVITY_POPOUT_WINDOW_OPEN' }) : ((0, L.vd)(t.type) && h.Z.selectParticipant(t.id, n.applicationId), (0, L.Qm)(t.type) && (0, _.tg)(ee.Ez.PANEL));
            }),
            n in t
...
t.Z = (0, f.Z)(function (e) {
    ...
    let { guildId: n, ...l } = e,
        ...
        w = (0, c.e7)([z.default, F.Z], () => (null != d ? (0, b.F6)(d, z.default, F.Z) : void 0)),
        L = (0, M.Z)();
    return (0, i.jsx)(ei, {
        ...l,
        guildId: n,

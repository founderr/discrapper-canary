...
super(...e), ex(this, 'modalKey', void 0), ex(this, 'state', {
  ...
  o()(null != e, 'Received null activity'), eu.default.track(eg.rMx.OPEN_MODAL, {
  ...
  if (null == e)
    return;
  let i = (0, y.BS)(e);
  null != i && (eu.default.track(eg.rMx.DROPS_ACTIVITY_PANEL_BUTTON_CLICK, {
    user_id: n,
  ...
  o()(null != t, 'Channel is null during navigation click'), o()(null != n, 'Activity null during navigation click'), (0, Q.vd)(t.type) && _.Z.selectParticipant(t.id, n.applicationId), f.Z.channelListScrollTo(null !== (e = t.guild_id) && void 0 !== e ? e : eg.ME, t.id), (0, Q.Qm)(t.type) && (0, E.tg)(eC.Ez.PANEL);
});
  }
}
...
guildId: n,
...l
  } = e, r = (0, c.e7)([X.default], () => X.default.getId()), a = (0, c.e7)([
D.ZP,
ec.Z
  ], () => (0, W.Z)(D.ZP, ec.Z)), s = (0, c.e7)([
ea.Z,
$.Z
  ], () => $.Z.getChannel(ea.Z.getVoiceChannelId())), o = (0, c.e7)([N.ZP], () => N.ZP.getConnectedActivityChannelId()), d = (0, c.e7)([$.Z], () => $.Z.getChannel(o)), h = (0, c.e7)([et.Z], () => et.Z.getGuild(null == d ? void 0 : d.guild_id)), [p, _] = (0, c.Wu)([J.Z], () => [
J.Z.getCurrentUserActiveStream(),
J.Z.getStreamerActiveStreamMetadata()
  ]), f = (0, c.e7)([I.Z], () => I.Z.useReducedMotion), m = (0, c.e7)([O.Z], () => O.Z.getActivityPanelTooltipAction()), {
partnerGame: g,
dropsActivityPanelExperienceBlocked: C,
showDropsSparkles: E
  } = (0, R.c)(eI.X2.FORTNITE, a, u.z.QUEST_2_ENROLLMENT_TOOLTIP, u.z.QUEST_2_COMPLETION_TOOLTIP), x = (0, c.e7)([N.ZP], () => null != d ? N.ZP.getSelfEmbeddedActivityForChannel(d.id) : null), Z = (0, c.e7)([
et.Z,
ei.Z,
ee.ZP
...
if (null != x)
  ...
  }()) && void 0 !== t ? t : '']), A = (0, c.e7)([en.Z], () => (0, H.Z)(en.Z) && (0, ed.isWindows)()), b = (0, c.e7)([el.Z], () => null != r ? el.Z.findActivity(r, e => e.type === eg.IIU.PLAYING) : null), M = null != p && p.ownerId === r && p.state !== eg.jm8.ENDED, y = (0, c.e7)([es.Z], () => es.Z.getBroadcast()), P = (0, v.Z)() && null != a, j = (0, c.e7)([
eo.default,
er.Z
  ], () => null != d ? (0, L.F6)(d, eo.default, er.Z) : void 0), U = (0, K.Z)(null == s ? void 0 : s.id, r);
  return (0, i.jsx)(eZ, {
...l,
guildId: n,
canGoLive: A,

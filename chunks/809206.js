...
n = t.body;
  if (n.token) {
let t = n.token;
delete n.token, s.Z.dispatch({
  type: 'UPDATE_TOKEN',
  token: t,
  userId: n.id
}), (null == e ? void 0 : e.password) != null && (null == e ? void 0 : e.new_password) != null && s.Z.dispatch({
...
checkEnabled: !1,
modalProps: {
  title: f.Z.Messages.TWO_FA_CHANGE_ACCOUNT
},
hooks: {
...
let t = e.body;
return l.default.track(_.rMx.USER_AVATAR_UPDATED, {

e = n.nmd(e), function () {
    var r = {
            function: !0,
            object: !0
        }, i = r[typeof window] && window || this, a = r[typeof t] && t, o = r.object && e && !e.nodeType && e, s = a && o && 'object' == typeof n.g && n.g;
    s && (s.global === s || s.window === s || s.self === s) && (i = s);
    var l = 9007199254740991, u = /\bOpera/, c = Object.prototype, d = c.hasOwnProperty, _ = c.toString;
    function E(e) {
    ...
    var g = function e(t) {
        var n, r, a, o, s, l = i, c = t && 'object' == typeof t && 'String' != p(t);
        c && (l = t, t = null);
        var d = l.navigator || {}, E = d.userAgent || '';
        t || (t = E);
        var g = c ? !!d.likeChrome : /\bChrome\b/.test(t) && !/internal|\n/i.test(_.toString()), S = 'Object', A = c ? S : 'ScriptBridgingProxyObject', N = c ? S : 'Environment', v = c && l.java ? 'JavaPackage' : p(l.java), O = c ? S : 'RuntimeObject', R = /\bJava/.test(v) && l.java, C = R && p(l.environment) == N, y = R ? 'a' : 'α', D = R ? 'b' : 'β', L = l.document || {}, b = l.operamini || l.opera, M = u.test(M = c && b ? b['[[Class]]'] : p(b)) ? M : b = null, P = t, U = [], w = null, x = t == E, G = x && b && 'function' == typeof b.version && b.version(), k = function (e) {

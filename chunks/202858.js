...
function u(e) {
    ...
    return (0, n.jsx)(r, {
        ...
        onError: (e) => {
            var n;
            if (('object' == typeof (n = e) && null != n && (0, i.nr)(n, 'code') && 'number' == typeof n.code ? n.code : 0) === c.evJ.MFA_INVALID_SECRET) t(u), l.onClose();
            else s(e);
        },
        onPasswordChange: _,
...
function _(e, s) {
    return new Promise((a) => {
        (0, r.openModalLazy)(async () => {
            let { default: i } = await Promise.all([t.e('72426'), t.e('23746')]).then(t.bind(t, 837651));
            return (t) =>
                (0, n.jsx)(i, {
                    ...t,
                    password: e,
...
function E() {
    ...
    return new Promise((s) => {
        (0, r.openModalLazy)(
            async () => {
                let { default: s } = await Promise.all([t.e('76540'), t.e('92539')]).then(t.bind(t, 628908));
                return (t) =>
                    (0, n.jsx)(s, {
                        ...t,
                        isTotp: e
...
async function T() {
    ...
    if ((0, l.j)()) {
        ...
        await _(e, null == a ? void 0 : a.token);
    } else await _(e);
    await E();
}
s.ZP = { enableMFA: T };

...
function c(e) {
  let n = (0, t.e7)([_.ZP], () => _.ZP.resolveUnreadSetting(e)),
    i = (0, t.e7)([_.ZP], () => _.ZP.resolvedMessageNotifications(e));
  return {
    unread: n,
    notification: i,
    preset: (0, d.gs)(n, i)
...
function N(e) {
  let n = (0, t.Wu)([_.ZP], () => (0, r.OD)(_.ZP.getChannelOverrides(e.guild_id), {
    ...
    [i, s] = (0, t.Wu)([_.ZP, a.Z], () => {
      ...
      return null != i && n.includes(i.id) ? ["parent", (0, d.p1)((0, d.gs)(_.ZP.resolveUnreadSetting(i), _.ZP.resolvedMessageNotifications(i)))] : ["guild", (0, d.p1)((0, d.gs)(_.ZP.getGuildUnreadSetting(e.guild_id), _.ZP.getMessageNotifications(e.guild_id)))]
...
function O(e, n, i) {
  let t = _.ZP.getChannelIdFlags(e, n);
  s.Z.updateChannelOverrideSettings(e, n, {
    flags: (0, o.pq)(t, i === l.i.ALL_MESSAGES ? E.ic.UNREADS_ALL_MESSAGES : E.ic.UNREADS_ONLY_MENTIONS)
  }, S.UE.unreads(i))
}

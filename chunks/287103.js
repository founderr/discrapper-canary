...
function H(e) {
  ...
  return e.reverse().forEach(e => {
    ...
    if (o.actionType === l.AuditLogActionTypes.DELETE && (null != I || null != i)) {
      let e = null !== (T = null == I ? void 0 : I.oldValue) && void 0 !== T ? T : null == i ? void 0 : i.oldValue;
...
function m(e) {
  ...
  N = s(E).filter(e => e.roles.some(t => {
    if (null != _) {
      ...
      let E = _.roles[t];
      return null != E && L.some(e => a.default.has(E.permissions, e))
    }
...
var V = new v(n.default, {
  ...
  AUDIT_LOG_FETCH_NEXT_PAGE_SUCCESS: function(e) {
    ...
    if (C = !1, d = E, S = _, g = s, D = a, G = T, O = n, (0 === t.length || t.length < l.AUDIT_LOG_PAGE_LIMIT) && (M = !1), t.length > 0) {
      let e = H(t);
      r = [...r, ...e]
    }
  },

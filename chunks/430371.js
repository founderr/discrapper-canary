...
function A(e) {
    var t;
    let n,
        { onSelectParticipant: a, onContextMenuParticipant: A, onFullscreenParticipant: Z, participants: M, filteredParticipants: b, popoutWindow: R, inCall: L, channel: P, selectedParticipant: j, showParticipants: O = !0, className: y, paused: D, width: k, height: U, layout: w, idle: B } = e,
        H = null != R,
    ...
    let er = s.useMemo(() => (X && Q ? k / (U - 2 * el) : J && null != F && F.width > 0 && F.height > 0 ? F.width / F.height : v), [J, F, X, k, U, el, Q]),
        eo = U - 2 * el,
        ec = X && Q ? k : eo * er,
    ...
    return (0, i.jsxs)('div', {
        className: l()(S.root, T.flexCenter, y),
        children: [
            (0, i.jsxs)('div', {

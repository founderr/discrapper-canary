...
function S(e) {
  let t, {
    ...
    en = (0, m.Z)(et, 100),
    ei = 0;
  (K || J) && (ei += 72), K && !J && (et ? ei += 48 : ei += 8), J && (ei += .5 * v + 8);
  let ea = a.useMemo(() => K && q ? y / (D - 2 * ei) : X && null != G && G.width > 0 && G.height > 0 ? G.width / G.height : N, [X, G, K, y, D, ei, q]),
    el = D - 2 * ei,
    es = K && q ? y : el * ea,

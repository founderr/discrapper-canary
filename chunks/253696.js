...
function T(e) {
  ...
  let {
    ...
    isBurstReaction: T,
    analyticsObject: h
  } = e, f = o.Z.getChannel(a.Z.getChannelId()), S = null == f ? void 0 : f.getGuildId(), N = s.Z.emojiFrecencyWithoutFetchingLatest.frequently.slice(), A = null != f ? s.Z.getDisambiguatedEmojiContext(f.getGuildId()).favoriteEmojisWithoutFetchingLatest : [], m = N.slice(0, s.Z.emojiFrecencyWithoutFetchingLatest.numFrequentlyItems), O = null != S ? s.Z.getGuildEmoji(S) : [], p = Object.values(null !== (t = s.Z.getDisambiguatedEmojiContext(null == f ? void 0 : f.getGuildId()).groupedCustomEmojis) && void 0 !== t ? t : {}).reduce((e, t) => e += t.length, 0), {
    topEmojis: R,
    newlyAddedEmojis: g
  } = (0, _._)({

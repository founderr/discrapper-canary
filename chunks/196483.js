...
if (o !== h)
  0 === a.stack.length && (a.stack = [s(e)], a.index = 0), r.T.isSaving(e) && (function(e, t, n) {
    let i;
    let {
      selection: a
    } = e, s = r.T.currentEntry(e), o = !0, l = !0;
    ...
    }(s, i) ? r.T.insertOrMergeEntry(e, i, l) : r.T.insertEntry(e, i, l);
  }(e, t, E), E = t), f = t, h = o;
  }, e.deleteBackward = t => {

...
function h(e) {
  ...
  } = e, g = (0, s.e7)([u.default], () => u.default.getCurrentUser()), C = (0, s.e7)([r.Z, i.ZP, o.Z], () => (0, d.h_)(i.ZP.getChannels(n), r.Z, o.Z)), I = (0, s.e7)([c.ZP], () => c.ZP.getVoiceStates(n)), Z = C.map(e => {
    var n;
    return {
      name: (0, l.jsx)(m.Z, {
        channel: e,
        users: null === (n = I[e.id]) || void 0 === n ? void 0 : n.filter(e => {
          let {
            user: t
          } = e;

...
function _(e) {
  ...
  } = e, C = (0, s.useStateFromStores)([o.default], () => o.default.getCurrentUser()), N = (0, s.useStateFromStores)([r.default, i.default, u.default], () => (0, c.getStreamEligibleChannels)(i.default.getChannels(l), r.default, u.default)), g = (0, s.useStateFromStores)([d.default], () => d.default.getVoiceStates(l)), h = N.map(e => {
    var l;
    return {

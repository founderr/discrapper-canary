...
function h(e) {
  ...
  } = e, g = (0, s.e7)([u.default], () => u.default.getCurrentUser()), C = (0, s.e7)([r.Z, i.ZP, o.Z], () => (0, d.h_)(i.ZP.getChannels(t), r.Z, o.Z)), I = (0, s.e7)([c.ZP], () => c.ZP.getVoiceStates(t)), Z = C.map(e => {
    var t;
    return {
      name: (0, l.jsx)(m.Z, {
        channel: e,
        users: null === (t = I[e.id]) || void 0 === t ? void 0 : t.filter(e => {
          let {
            user: n
          } = e;

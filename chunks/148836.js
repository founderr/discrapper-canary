...
function E(e) {
    ...
    l
        ? ((U.onPressStart = (e) => {
              (D.current = e.pointerType), (b.current = L), 'keyboard' === e.pointerType && (!y || h()) && S(e);
          }),
          I
              ? ((U.onPressUp = v
                    ? null
        ...
        : ((U.onPressStart = (e) => {
              (D.current = e.pointerType), (b.current = L), (M.current = v), O && (('mouse' === e.pointerType && !v) || ('keyboard' === e.pointerType && (!R || h()))) && S(e);
          }),
          (U.onPress = (e) => {

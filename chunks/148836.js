...
function E(e) {
    ...
    l
        ? ((U.onPressStart = (e) => {
              (L.current = e.pointerType), (b.current = D), 'keyboard' === e.pointerType && (!y || h()) && S(e);
          }),
          I
              ? ((U.onPressUp = v
                    ? null
        ...
        : ((U.onPressStart = (e) => {
              (L.current = e.pointerType), (b.current = D), (M.current = v), O && (('mouse' === e.pointerType && !v) || ('keyboard' === e.pointerType && (!R || h()))) && S(e);
          }),
          (U.onPress = (e) => {
              ('touch' === e.pointerType || 'pen' === e.pointerType || 'virtual' === e.pointerType || ('keyboard' === e.pointerType && y && f()) || ('mouse' === e.pointerType && M.current)) && (y ? P(e) : O && S(e));
          })),
        (g['data-key'] = n),

...
function p(e) {
  ...
  let {
    ...
    dropdownsAllowed: D
  } = (0, _.Ug)(n.id), j = (0, l.e7)([T.Z], () => T.Z.editedDefaultChannelIds), Z = D ? h.qm : h.M$, {
    drag: b,
        ...
        children: [(0, s.jsxs)("div", {
          ...
          children: [(0, s.jsx)(o.Checkbox, {
            ...
            children: (0, s.jsx)(o.Text, {
              variant: "text-sm/normal",
              color: "interactive-normal",
              children: L ? g.Z.Messages.ONBOARDING_PROMPT_REQUIRED_LABEL_WITH_COUNT.format({
                count: W
...
function f(e) {
  let {
    ...
    dropdownsAllowed: l
  } = (0, _.Ug)(t.id), o = l ? h.qm : h.M$, {
    handleDragStart: c,
    handleDragReset: u,
    handleDragComplete: E
  } = (0, d.Z)(n.options, e => (0, m.Kk)(t, n.id, {
    options: e
  }));
  return (0, s.jsxs)("div", {
    className: C.options,
    children: [n.options.map((e, l) => (0, s.jsx)(S.Z, {
      guild: t,
      prompt: n,
      promptIndex: a,
      singleColumn: i,
    ...
    }, e.id)), n.options.length < o ? (0, s.jsx)(S.B, {
      guild: t,
      prompt: n,
      promptIndex: a,
      singleColumn: i

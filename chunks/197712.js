...
var r = n(392711), a = n(486324);
function i(e, t, n, r) {
    let a = e.naturalWidth / e.width, i = t.width / 2, l = t.height / 2, s = (e.width / 2 - i - n.x) * a, o = (e.height / 2 - l - n.y) * a, u = t.width * a, c = t.height * a, h = Math.min(u, r.width), d = Math.min(c, r.height);
    return {
        x: s,
        y: o,
        scaledCropWidth: u,
...
function g(e, t, n) {
    let r = e.naturalWidth / e.naturalHeight, a = t, i = n;

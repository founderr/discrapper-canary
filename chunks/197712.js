...
scaledCropWidth: o,
scaledCropHeight: h
  } = (0, i.eu)(t, r, s, l), d = await e.arrayBuffer(), A = new Worker(new URL('/assets/' + n.u('86047'), n.b)), E = new Promise((e, t) => {
A.onmessage = n => {
  let {
    data: r
  } = n;
  if (r.type === a.u.CROP_GIF_COMPLETE) {
    ...
    r.type === a.u.CROP_GIF_ERROR && (t(Error('Error cropping GIF')), A.terminate());
};
  });

...
var s = t(735250);
t(470079);
var i = t(442837), a = t(481060), l = t(92114), u = t(778123), o = t(122074), r = t(9156), d = t(621600), c = t(981631), E = t(689938);
function _() {
    return [
        {
...
function M(e) {
    ...
    let N = function (e) {
                    ...
                    (0, s.jsx)(a.MenuGroup, {
                        children: _().map(e => {
                            ...
                            return (0, s.jsx)(a.MenuRadioItem, {
                                ...
                                id: ''.concat(n),
                                label: t,
                                action: () => L({ message_notifications: n }, d.UE.notifications(n)),
                                checked: n === N
                            }, n);
                        })
                    }),
                    ...
                    (0, s.jsxs)(a.MenuGroup, {
                        children: [
                            (0, s.jsx)(a.MenuCheckboxItem, {
                                ...
                                action: () => L({ suppress_everyone: !n }, d.UE.suppressEveryone(!n)),
                                checked: n
                            }),
                            (0, s.jsx)(a.MenuCheckboxItem, {
                                id: 'suppress-roles',
                                label: E.Z.Messages.FORM_LABEL_SUPPRESS_ROLES,
                                action: () => L({ suppress_roles: !t }, d.UE.suppressRoles(!t)),
                                checked: t
                            }),
                            (0, s.jsx)(a.MenuCheckboxItem, {
                                ...
                                action: () => {
                                    L({ notify_highlights: S ? c.gLR.ENABLED : c.gLR.DISABLED }, d.UE.highlights(S));
                                },
                                checked: S
                            }),
                            g
        ...
        }(e), I = (0, i.e7)([r.ZP], () => r.ZP.getMessageNotifications(e.id), [e.id]), S = null === (M = _()) || void 0 === M ? void 0 : null === (n = M.find(e => {
            let {setting: n} = e;
            return n === I;
        })) || void 0 === n ? void 0 : n.label, g = (0, o.U)();

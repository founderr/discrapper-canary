...
function f(e) {
  ...
  let E = function(e) {
      ...
      return (0, n.jsxs)(n.Fragment, {
        children: [(0, n.jsx)(a.MenuGroup, {
          ...
          children: [(0, n.jsx)(a.MenuCheckboxItem, {
            ...
            action: () => {
              M({
                notify_highlights: N ? r.HighlightSettings.ENABLED : r.HighlightSettings.DISABLED
              }, d.NotificationLabel.highlights(N))
            },
            checked: N
          }), _]
        }), (0, n.jsx)(a.MenuGroup, {
    ...
    g = (0, s.useStateFromStores)([o.default], () => o.default.getMessageNotifications(e.id), [e.id]),
    N = null === (f = S()) || void 0 === f ? void 0 : null === (t = f.find(e => {
      let {
        setting: t
      } = e;
      return t === g
    })) || void 0 === t ? void 0 : t.label;
  return null != E ? (0, n.jsx)(a.MenuItem, {
    ...
    action: () => (0, a.openModalLazy)(async () => {
      let {
        default: t
      } = await Promise.all([i.e("99387"), i.e("70205"), i.e("5863"), i.e("73572")]).then(i.bind(i, "751212"));
      return i => (0, n.jsx)(t, {
        ...i,
        guildId: e.id
      })

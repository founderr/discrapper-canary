      ...
      for (var f, h, m, b, C, O = 0, x = 0, A = 0, S = 0, I = 0, L = 0, T = m = f = 0, N = 0, R = 0, B = 0, _ = 0, U = s.length, j = U - 1, H = "", W = "", z = "", G = ""; N < U;) {
        if (h = s.charCodeAt(N), N === j && 0 !== x + S + A + O && (0 !== x && (h = 47 === x ? 10 : 47), S = A = O = 0, U++, j++), 0 === x + S + A + O) {
          ...
          switch (h) {
                ...
                switch (h = s.charCodeAt(N)) {
                  ...
                  case 47:
                    switch (h = s.charCodeAt(N + 1)) {
                      ...
                      case 47:
                        e: {
                          for (T = N + 1; T < j; ++T) switch (s.charCodeAt(T)) {
                            case 47:
            ...
            case 125:
            case 59:
              if (1 < (_ = (H = (0 < R ? H.replace(c, "") : H).trim()).length)) switch (0 === T && (45 === (f = H.charCodeAt(0)) || 96 < f && 123 > f) && (_ = (H = H.replace(" ", ":")).length), 0 < P && void 0 !== (C = a(1, H, u, n, k, w, W.length, p, d, p)) && 0 === (_ = (H = C.trim()).length) && (H = "\0\0"), f = H.charCodeAt(0), h = H.charCodeAt(1), f) {
                case 0:
                  break;
                case 64:
                  if (105 === h || 99 === h) {

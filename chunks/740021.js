...
function T(e) {
  let {
    ...
    location: "SimplifiedUserProfileModalHeader"
  }), G = (0, o.e7)([u.Z], () => u.Z.getRelationshipType(n.id)), k = (0, o.e7)([c.default], () => c.default.getId() === n.id), [w, Y] = (0, o.Wu)([d.Z], () => {
    let e = d.Z.isMobileOnline(n.id);
    return (0, r.W)(n, T) ? [C.Sk.UNKNOWN, e] : (0, a.Z)(s) ? [C.Sk.STREAMING, e] : [d.Z.getStatus(n.id), e]
  });

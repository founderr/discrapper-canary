var r, i, a, o, s = n(442837), l = n(570140), u = n(786761), c = n(592125), d = n(594174), _ = n(823379), E = n(709054);
let f = {};
function h(e) {
    var t;
...
function T(e) {
    ...
    t.forEach(e => p(e.id, null)), null == n || n.filter(_.lm).forEach(e => {
        p(e.channel_id, e);
    });
}
...
a = 'ForumPostRecentMessageStore', (i = 'displayName') in (r = g) ? Object.defineProperty(r, i, {
    value: a,
    enumerable: !0,
    configurable: !0,
    writable: !0
    ...
    MESSAGE_CREATE: function (e) {
        if (e.isPushNotification || !h(e.message))
            return !1;
    ...
    MESSAGE_UPDATE: function (e) {
        if (!h(e.message) || e.message.channel_id === e.message.id)
            return !1;
        !function (e, t) {
            let n = function (e) {
                    return f[e];

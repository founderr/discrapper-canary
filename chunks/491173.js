...
let I = (0, d.Mg)(a.Z.EXPRESSION_PICKER_CONSTANTS_EXPRESSION_PICKER_INSPECTOR_BAR_GRAPHIC_PRIMARY_DIMENSIONS), T = (0, d.Mg)(a.Z.EXPRESSION_PICKER_CONSTANTS_EXPRESSION_PICKER_INSPECTOR_BAR_GRAPHIC_SECONDARY_DIMENSIONS), g = e => {
        ...
        if (!(0, f.jl)(e) && !(0, f.J8)(e) || (0, f.J8)(e)) {
            ...
            null != i && (t = p.Z.Messages.STICKER_FROM_SOURCE.format({ source: i.name }), n = (0, r.jsx)(h.ZP, {
                size: T,
                sticker: (0, f.Zt)(i),
                disableAnimation: !0
            }));
        ...
        let {stickersGrid: t} = e, n = l.ZN.useStore(e => e.inspectedExpressionPosition), a = i.useMemo(() => {
                var e;
                let {
                        rowIndex: r,
                        columnIndex: i
                    } = n, a = null === (e = t[r]) || void 0 === e ? void 0 : e[i];
                return (null == a ? void 0 : a.type) === E.al.CREATE_STICKER ? {
                    guild_id: a.guild_id,
                    name: a.name
                } : (null == a ? void 0 : a.type) !== E.al.STICKER ? null : a.sticker;
            }, [
                t,
                n
            ]);

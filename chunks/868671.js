...
function x(e) {
    let {
        ...
        [N, S] = i.useState(!1),
        { requestId: v, entries: Z, impressionCappedEntryIds: A } = (0, m.Z)(x),
        ...
        [P, y, D, k] = i.useMemo(() => {
            let e;
            if (null == Z || 0 === Z.length || null == v || !O) return [t, n, I];
            let i = N ? Z.length : 3,
                a = Z.slice(0, i);
            e = M
        ...
        w = i.useRef(Z),
        B = i.useRef(),
        H = i.useRef({ impressionCappedEntryIds: A }),
        G = i.useCallback(
            (e) => {
                var t;
    ...
    return (
        ...
        i.useEffect(
            () => (
                ...
                () => {
                    var e, t;
                    if (null == v || null == B.current || Date.now() - B.current < 3000) return;

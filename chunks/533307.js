...
async function E(e) {
  ...
  try {
    let s = await (0, d.bT)(e, t, n);
    if (null != s.application_id && s.application_id !== _.RQ) {
      let e = a.Z.getApplication(s.application_id);
      if (null == e) try {
        await r.Z.fetchApplication(s.application_id)
      } catch (e) {}
    }
    if (s.application_id === u.XAJ) try {
      await (0, c.jr)(s.sku_id)
    } catch (e) {}
    return l.Z.dispatch({

...
function H(e) {
  ...
  }), ea = null !== (t = null == ee ? void 0 : ee.getGuildId()) && void 0 !== t ? t : K, en = (0, d.useStateFromStores)([p.default], () => {
    var e;
    return null != ea ? null === (e = p.default.getGuild(ea)) || void 0 === e ? void 0 : e.premiumTier : null
  ...
  function ej() {
    ! function() {
      ...
      let o = (0, k.default)(et, eC, h.default.getRunningGames()),
  ...
  async function eP(e) {
    ...
    let t = (0, k.default)(et, eC, h.default.getRunningGames()),

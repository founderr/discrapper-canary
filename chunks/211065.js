...
class v extends n.PureComponent {
  ...
  get clearAfterOptions() {
    return [{
      ...
      key: 2,
      value: g.F.HOURS_4,
      label: j.Z.Messages.CUSTOM_STATUS_HOURS.format({
        hours: 4
      })
    }, {
      key: 3,
      ...
      label: j.Z.Messages.CUSTOM_STATUS_MINUTES.format({
        minutes: 30
      })
    }, {
      key: 5,
  ...
  constructor(...e) {
    super(...e), b(this, "state", {
      ...
      clearAfter: function() {
        ...
        if (null == s || "" === s.expiresAtMs) return g.F.TODAY;
        let n = Number(s.expiresAtMs);
        if (isNaN(n)) return g.F.TODAY;
        let l = new Date,
          o = new Date(n);
        if (t = l, a = o, t.getFullYear() !== a.getFullYear() || t.getMonth() !== a.getMonth() || t.getDate() !== a.getDate()) return g.F.TODAY;
...
t.default = r.ZP.connectStores([m.Z, p.default], () => {

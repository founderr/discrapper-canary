...
t.default = () => {
  ...
  let [p, L] = l.useState(null), x = l.useCallback(e => {
  ...
  }, [L, a]), M = c.Storage.get(I);
  if ("null" === n && null === p && x("deep_link_failed"), null != n && "null" !== n && null == M && null === p && x("nonce_missing"), l.useEffect(() => {
      if (null != M) {

...
e
  ...
  let [m, R] = a.useState(null), O = a.useCallback(e => {
R(e), I.default.track(N.rMx.MOBILE_WEB_HANDOFF_FAILURE, {
  reason: e,
  fingerprint: (0, o.K)(r)
}, {
  fingerprint: r
...
r
  ...
  if ('null' === n && null === m && O('deep_link_failed'), null != n && 'null' !== n && null == b && null === m && O('nonce_missing'), a.useEffect(() => {
  if (null != b) {
    let e = d.K.get(A);
  ...
  null != n && 'null' !== n && null != b && null == m && u.tn.post({
...
if (v.has(m))
  ...
  return null != m && Z.has(m) ? (0, i.jsx)('div', {
...
children: [
  ...
  (0, i.jsx)(_.Button, {
    ...
    onClick: () => {
      ...
      s.set('redirect', encodeURIComponent(window.location.pathname + n.toString())), s.set('key', e), s.set('fingerprint', r), t.search = s.toString(), I.default.track(N.rMx.DEEP_LINK_CLICKED, {
        fingerprint: (0, o.K)(r),

...
t.Z = () => {
    let e = (0, c.e7)([p.default], () => p.default.getFingerprint()), {
            fingerprint: t,
            handoff_token: n
        } = (0, l.parse)(window.location.search), s = Array.isArray(t) ? t.length > 1 ? t[0] : null : t, r = null != s ? s : null !== e ? e : void 0;
    a.useEffect(() => {
    ...
    if ('null' === n && null === I && R('deep_link_failed'), null != n && 'null' !== n && null == b && null === I && R('nonce_missing'), a.useEffect(() => {
            ...
            null != n && 'null' !== n && null != b && null == I && u.tn.post({
                ...
                let e = new URL(window.location.href), t = new URLSearchParams(e.search);
        ...
        children: [
            ...
            (0, i.jsx)(h.Button, {
                ...
                onClick: () => {
                    ...
                    let t = new URL(N.x0X), n = new URLSearchParams(window.location.search);

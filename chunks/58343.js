...
function el(e) {
  let t, {
    ...
    g = (0, h.useAppContext)(),
    S = (0, o.useStateFromStores)([O.default], () => O.default.getVoiceChannelId() === n.id, [n.id]),
  ...
  return t = M ? (0, a.jsx)(Y.default, {
    ...
    renderChatToasts: () => !j || p || x ? null : (0, a.jsx)(E.default, {
  ...
  return (0, a.jsxs)(E.ChannelCallChatLayerProvider, {
    children: [(0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)("div", {
        ...
        children: T && (!_ || _ && I === Z.AppContext.POPOUT) && (0, a.jsx)(g.default, {
          channel: t,
          guild: v,
          maxWidth: x - 550
        })

...
function L() {
    let e = s.useRef(null), t = (0, p.Z)(), n = (0, T.w)(), a = (0, I.V)(), L = (0, d.N)(), v = (0, u.Z)('message-requests-spam-list'), {channelId: O} = (0, g._)(), R = s.useCallback(() => {
        ...
        }, []), {rejectAll: x} = (0, m.m)({ onError: R }), b = s.useCallback(() => {
    ...
    s.useEffect(() => {
        E.default.track(N.rMx.SPAM_MESSAGE_REQUESTS_VIEWED, { num_spam_message_requests: n }), _.Z.increment({ name: o.V.SPAM_MESSAGE_REQUEST_VIEW });
    }, []);

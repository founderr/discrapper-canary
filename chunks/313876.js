...
function u(e) {
  ...
  let {
    author: u,
    inviteError: d
  } = e, c = (0, l.useStateFromStores)([a.default], () => a.default.getId()) === u.id ? o.default.Messages.INVITE_BUTTON_TITLE_INVITER_INVALID : o.default.Messages.INVITE_BUTTON_TITLE_INVITED_INVALID, f = (0, r.getDescriptiveInviteError)(null == d ? void 0 : d.code);

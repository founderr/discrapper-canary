...
function J(e) {
  ...
  let {
    ...
    return [...e, ...t]
  }, [d]), m = (0, C.default)(d), h = l.useMemo(() => m.map(e => e.id), [m]), x = (0, u.useStateFromStores)([k.default], () => k.default.getVoiceStates(d), [d]), E = o.flatMap(p, e => {
    var t;

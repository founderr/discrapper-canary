n(47120);
var r = n(846519), i = n(147913), a = n(603113), o = n(594190), s = n(592125), l = n(131951), u = n(19780), c = n(885110), d = n(606304), _ = n(938475), E = n(70956), f = n(367907), h = n(981631);
function p(e, t, n) {
...
class I extends i.Z {
    ...
    _trackStartSpeaking() {
        if (this._currentUserSpeaking) {
            let e = u.Z.getChannelId(), t = u.Z.getGuildId(), n = s.Z.getChannel(e), r = null == n ? void 0 : n.isBroadcastChannel();
    ...
    getGameMetadata() {
        let e = c.Z.findActivity(e => e.type === h.IIU.PLAYING), t = o.ZP.getCurrentGameForAnalytics();
        return {

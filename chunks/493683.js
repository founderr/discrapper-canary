...
return null == r ? null : (null == t || t(), null != (0, u.PP)() ? (0, _.Kh)(r.id, {
  navigationReplace: !0
}) : T.default.selectPrivateChannel(r.id), r);
  },
...
return a.Z.dispatch({
  type: 'CHANNEL_CREATE',
  channel: t
}), null != (0, u.PP)() ? (0, _.Kh)(t.id, {
  navigationReplace: !0
}) : T.default.selectPrivateChannel(t.id), t;
  },
  closePrivateChannel(e) {
let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
  n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
return (0, o.Z)(e) && p.default.track(g.rMx.CHANGE_LOG_DM_REMOVED, {
  ...
  silent: n
}), t && !__OVERLAY__ && (0, d.uL)(g.Z5c.FRIENDS), r.tn.del({
  url: g.ANM.CHANNEL(e),
  query: {
    silent: n
  },
...
return r.tn.put({
  ...
  oldFormErrors: !0
}).then(t => (i.uv.announce(S.Z.Messages.A11Y_ANNOUNCEMENT_USER_ADDED_TO_GROUP_DM), null == a || a(), 201 === t.status) ? this._openPrivateChannel(t.body).id : e).catch(() => (i.uv.announce(S.Z.Messages.A11Y_ANNOUNCEMENT_USER_ADDED_TO_GROUP_DM_FAILED), e));
  },

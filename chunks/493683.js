n(47120);
var r = n(544891), i = n(780384), a = n(570140), o = n(802098), s = n(702321), l = n(408987), u = n(57132), c = n(895886), d = n(703656), _ = n(131704), E = n(592125), f = n(306680), h = n(626135), p = n(73346), m = n(26151), I = n(287734), T = n(981631), g = n(689938);
t.Z = {
    async openPrivateChannel(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = arguments.length > 3 ? arguments[3] : void 0, a = arguments.length > 4 ? arguments[4] : void 0, o = this._getRecipients(e), s = e => {
    ...
    async createBroadcastPrivateChannel() {
        try {
            let e = await r.tn.post({ url: T.ANM.BROADCAST_PRIVATE_CHANNEL }), t = (0, _.q_)(e.body);
    ...
    _openCachedDMChannel(e, t) {
        let n = E.Z.getDMFromUserId(e), r = null != n ? E.Z.getChannel(n) : null;
        return null != r ? (null == t || t(), null != (0, u.PP)() ? (0, d.uL)(T.Z5c.CHANNEL(T.ME, r.id), { navigationReplace: !0 }) : I.default.selectPrivateChannel(r.id), r) : null;
    },
    async ensurePrivateChannel(e) {
        let t = this._getRecipients(e), n = await r.tn.post({
                url: T.ANM.USER_CHANNELS,
                body: { recipients: t },
                oldFormErrors: !0
            }), i = (0, _.q_)(n.body);
    ...
    async getDMChannel(e) {
        let t = await r.tn.get(T.ANM.DM_CHANNEL(e)), n = (0, _.q_)(t.body);
        return a.Z.dispatch({
            type: 'CHANNEL_CREATE',
            channel: n
        }), n.id;
    ...
    _openPrivateChannel(e) {
        ...
        return a.Z.dispatch({
            type: 'CHANNEL_CREATE',
            channel: t
        }), null != (0, u.PP)() ? (0, d.uL)(T.Z5c.CHANNEL(T.ME, t.id), { navigationReplace: !0 }) : I.default.selectPrivateChannel(t.id), t;
    },
    ...
    async setName(e, t) {
        let n = E.Z.getChannel(e), i = await r.tn.patch({
                url: T.ANM.CHANNEL(e),
                body: { name: t },
                oldFormErrors: !0

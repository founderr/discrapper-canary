...
'aria-controls': S,
focusProps: A
  } = e, [N, v] = i.useState(!1), [O, R] = i.useState(50), C = (0, l.e7)([_.ZP], () => _.ZP.inReverseTrial()), y = N || T, D = (0, E.l)(p, 'emojiButton', y ? 'Hovered' : 'Normal');
  let L = (t = O, {
...
children: e => (0, r.jsx)(u.Button, {
  ...
  children: null != c ? c() : (0, r.jsx)(u.Spring, {
    config: m,
    to: {
      value: y ? 1 : 0
    },
    children: e => {
      ...
      return (0, r.jsxs)(o.animated.div, {
        ...
        children: [
          (0, r.jsx)('div', {
            className: s()(p.sprite, C ? p.spritePremiumColored : p.spriteColored, y ? p.active : p.inactive)
          }),
          (0, r.jsx)('div', {
            className: s()(p.sprite, C ? p.spritePremiumColored : p.spriteGreyscale, y ? p.inactive : p.active)
          })
        ]
      });
    }

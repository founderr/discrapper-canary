...
function W(e) {
  ...
  let {
    message: n,
    compact: l
  } = e, i = x.default.getUser((0, C.getUserIdOfAutomodAction)(n)), r = null === (t = v.default.getBasicChannel(n.channel_id)) || void 0 === t ? void 0 : t.guild_id, u = null != r && null != i ? L.default.getMember(r, i.id) : null, {
    avatarSrc: d,
      ...
      children: [(0, s.jsx)("div", {
        ...
        children: null != u && null != i && (0, s.jsxs)(a.Fragment, {
          children: [(0, s.jsx)(m.Text, {
            ...
            children: e => (0, s.jsxs)(m.Clickable, {
...
function z(e) {
  ...
  let {
    ...
    raidType: I,
    resolvedReason: h
  } = (0, C.extractAutomodNotificationFields)(l), g = (0, E.useStateFromStores)([v.default], () => v.default.getChannel(l.channel_id), [l.channel_id]), O = null !== (t = null == g ? void 0 : g.guild_id) && void 0 !== t ? t : null, {
    incidentData: R,
    shouldShowIncidentActions: L
  } = (0, N.useGuildIncidentsState)(O), x = (0, M.useContextMenuRaidAlert)(l.author.id, l.channel_id), P = a.useCallback(() => {
  ...
  return (0, s.jsx)(q, {
    ...
    subheader: (0, s.jsxs)("div", {
      ...
      children: [null != r && (0, s.jsx)(m.Text, {
        ...
        children: [(0, s.jsx)(H, {}), (0, s.jsx)(m.Text, {
          variant: "text-xs/medium",
          color: "text-normal",
      ...
      children: [(0, s.jsx)(m.Button, {
        onClick: function() {
          null != i && null != u && (0, h.removeMentionRaidRestrictionWithFeedback)(i, u, () => {
            (0, I.dismissCurrentNotice)(d), (0, h.clearMentionRaidDetected)(i)
          })
        },
        color: m.Button.Colors.LINK,
        look: m.Button.Looks.LINK,

...
'multiple' === t.selectionManager.selectionMode && (0 === u.length || 'all' === i || i.size > 1 || 'all' === a.current || (null === (e = a.current) || void 0 === e ? void 0 : e.size) > 1) && u.push('all' === i ? r.format('selectedAll') : r.format('selectedCount', {
  count: i.size
})), u.length > 0 && (0, Y.xQ)(u.join(' ')), a.current = i;
  }, [i]);
}
...
}, t.isKeyboardNavigationDisabled ? g : h, 0 === t.collection.size && {
  tabIndex: S ? -1 : 0
}, m);

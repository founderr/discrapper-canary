...
function h(e) {
  let {
    guild: t
  } = e, n = (0, d.h6)(t), h = () => (0, c.sB)(t.id), I = s.useMemo(() => new Set(n.map(e => e.applicationId)), [n]), m = (0, a.Wu)([r.Z], () => {
    let e = [];
    for (let t of I) {
  ...
  let p = "";
  return p = 1 === m.length ? _.Z.Messages.ONE_APPLICATION_SUBSCRIPTION_EXPIRATION_CHANNEL_NOTICE_CONTENT.format({
    a: m[0].name

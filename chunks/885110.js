...
function x() {
    var e;
    if (((y = null !== (e = T.Z.getIdleSince()) && void 0 !== e ? e : 0), (D = T.Z.isAFK()), b)) v = C;
    else if (R) v = O.Skl.INVISIBLE;
    else {
        let e = h.co.getSetting();
        v = e !== O.Skl.UNKNOWN ? e : O.Skl.ONLINE;
    }
    v === O.Skl.ONLINE && y > 0 && (v = O.Skl.IDLE);
    let t = !1,
        n = b || v === O.Skl.INVISIBLE ? [] : g.Z.getActivities().filter(w);
    !l()(L, n) && ((L = n), (t = !0));
    let r = N.Z.getRemoteActivities();
    if ((M !== r && ((M = r), (t = !0)), t)) {
        let e = L.find((e) => e.type === O.IIU.CUSTOM_STATUS);
        P =
            L.filter((e) => e.type !== O.IIU.CUSTOM_STATUS).length > 0
                ? L
                : null != e
                  ? [
                        e,

var r = n(585559), i = n(771378), a = n(778247), o = n(780177), s = n(585754), l = n(957578).Buffer;
function u(e) {
    'object' == typeof e && !l.isBuffer(e) && (t = e.passphrase, e = e.key), 'string' == typeof e && (e = l.from(e));
    var t, n, u, c = a(e, t), d = c.tag, _ = c.data;
    switch (d) {
    case 'CERTIFICATE':
    ...
    case 'ENCRYPTED PRIVATE KEY':
        _ = function (e, t) {
            var n = e.algorithm.decrypt.kde.kdeparams.salt, r = parseInt(e.algorithm.decrypt.kde.kdeparams.iters.toString(), 10), a = i[e.algorithm.decrypt.cipher.algo.join('.')], u = e.algorithm.decrypt.cipher.iv, c = e.subjectPrivateKey, d = parseInt(a.split('-')[1], 10) / 8, _ = s.pbkdf2Sync(t, n, r, d, 'sha1'), E = o.createDecipheriv(a, _, u), f = [];

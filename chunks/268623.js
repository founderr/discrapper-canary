...
function E(e) {
    let { enabled: n } = s.Z.useExperiment({ location: 'LongPressMessageActionSheet' }),
        ...
        v = (function (e) {
            ...
            return (null == t ? void 0 : t.saveData.dueAt) == null
                ? (0, i.jsx)(a.MenuGroup, {
                      label: I.intl.string(I.t.roMu1N),
                      children: c
                  })
                : (0, i.jsxs)(a.MenuGroup, {
                      ...
                      children: [
                          (0, i.jsx)(a.MenuItem, {
                              id: 'mark-complete',
                              label: I.intl.string(I.t.yjGtdH),
                          ...
                          (0, i.jsx)(a.MenuItem, {
                              id: 'edit-reminder',
                              label: I.intl.string(I.t.vrbqs7),
                              children: c
                          })
                      ]
                  });
    ...
    return n || t
        ? null != E || (0, g.Z)()
            ? (0, i.jsxs)(a.MenuItem, {
                  id: 'save-for-later',
                  label: I.intl.string(I.t.tpxJtr),
                  action: () =>
                      null == E
                          ? (0, u.z)({
                  ...
                  children: [
                      null != E
                          ? (0, i.jsx)(a.MenuItem, {
                                ...
                                label: I.intl.string(I.t.SvXS1d),
                                icon: a.BookmarkIcon,
                                action: () =>
                                    (0, u.x)({
                                        channelId: e.channel_id,
                          ...
                          : (0, i.jsx)(a.MenuItem, {
                                id: 'create-bookmark',
                                label: I.intl.string(I.t['9p3D9v']),

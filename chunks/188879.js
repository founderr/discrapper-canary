var A = I(735250), O = I(470079), T = I(286379), S = I(692547), C = I(481060), N = I(442837), D = I(797614), R = I(706454), e = I(626135), V = I(219230), i = I(531441), n = I(788080), P = I(451284), t = I(613734), a = I(846488), L = I(384725), l = I(97568), s = I(800530), o = I(981631), M = I(689938), r = I(490758);
let U = E => {
        let {
                ...
                return T && null != I ? (null == I ? void 0 : I.member_type) === i.wO.OWNER ? M.Z.Messages.SAFETY_HUB_CLASSIFICATION_DETAIL_HEADER_GUILD.format({
                    ...E,
        ...
        let {
            ...
            } = E, O = (0, N.e7)([R.default], () => R.default.locale);
        return 0 === _.filter(E => E.descriptions.length > 0).length && null == I ? null : (0, A.jsxs)('div', {
            ...
            children: [
                ...
                (0, A.jsxs)('ul', {
                    ...
                    children: [
                        _.map(E => (0, A.jsx)(Y, { action: E }, E.id)),
                        null != I ? (0, A.jsx)('li', {
        ...
        children: M.Z.Messages.SAFETY_HUB_CLASSIFICATION_DETAIL_ACTION_APPEAL_V2.format({
            letUsKnowHook: (_, I) => (0, A.jsx)(C.Anchor, {
                ...
                appealComponent: (0, A.jsx)(u, {
                    ...
                    onLetUsKnowClick: () => {
                        e.default.track(o.rMx.SAFETY_HUB_ACTION, {
                            ...
                            is_dsa_eligible: M,
                            violation_type: Y
                        }), V && (D.Z.increment({ name: T.V.APPEAL_INGESTION_VIEW }), L.Z.open(I));
                    },
                    isAppealEligible: V
                })
            })

...
t.default = e => {
  ...
  let {
    ...
    isAppealEligible: m,
    isDsaEligible: T
  } = (0, h.useSafetyHubClassification)(i), v = (0, A.useSafetyHubAccountStanding)(), L = null != r && null != r.flagged_content && r.flagged_content.length > 0, N = (0, f.useSafetyHubInitialized)();
  return (n.useEffect(() => {
  ...
  }, [N]), null == r && c === _.ClassificationRequestState.FAILED) ? (o(), null) : null == r ? null : (0, a.jsxs)("div", {

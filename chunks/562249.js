...
var o = function (e) {
    ...
    }(n(476400)), r = u(n(470079)), i = u(n(699581)), a = n(823189);
function u(e) {
...
var f = function (e) {
    function t(t, n) {
        ...
        var o, r, i = n.transitionGroup, a = i && !i.isMounting ? t.enter : t.appear;
    ...
    return a.getChildContext = function () {
        ...
        var n = this, o = this.props.enter, r = this.context.transitionGroup ? this.context.transitionGroup.isMounting : t, i = this.getTimeouts(), a = r ? i.appear : i.enter;
        if (!t && !o) {
        ...
        this.props.onEnter(e, r), this.safeSetState({ status: c }, function () {
        ...
        this.props.onExit(e), this.safeSetState({ status: d }, function () {
        ...
        if (delete o.in, delete o.mountOnEnter, delete o.unmountOnExit, delete o.appear, delete o.enter, delete o.exit, delete o.timeout, delete o.addEndListener, delete o.onEnter, delete o.onEntering, delete o.onEntered, delete o.onExit, delete o.onExiting, delete o.onExited, 'function' == typeof n)
            return n(e, o);
...
f.contextTypes = { transitionGroup: o.object }, f.childContextTypes = {

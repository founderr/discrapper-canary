...
async function _() {
    ...
    let n = await t(),
        { didCrashReporterSeeCrash: r, didCrashOrUncleanExit: a } = E(i.K.get(d, {}), n),
        o = h(r, a, n);
    s.default.track(u.rMx.APP_NATIVE_CRASH, o), i.K.set(d, { lastId: null == n ? void 0 : n.id }), a && setTimeout(async () => await f(), 10000);
}
function E(e, t) {
    var n;
...
function h(e, t, n) {
    ...
    let O = {
        ...
        had_rtc_connection: v(r.X4.HasRTCConnection),
        was_sending_video: v(r.X4.IsSendingVideo),
        was_sending_stream: v(r.X4.IsSendingStream),
        was_receiving_video: v(r.X4.IsReceivingVideo),
        was_receiving_stream: v(r.X4.IsReceivingStream),
        video_media_session_id: N(r.X4.VideoMediaSessionId),
        stream_media_session_id: N(r.X4.StreamMediaSessionId),

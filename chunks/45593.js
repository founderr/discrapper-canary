...
function _(e, t) {
  let _ = (0, i.useStateFromStores)([r.default], () => r.default.can(c.Permissions.MANAGE_CHANNELS, t)),
    E = (0, i.useStateFromStores)([r.default], () => r.default.can(c.Permissions.SET_VOICE_CHANNEL_STATUS, e)),
    N = (0, d.useIsConnectedToVoiceChannel)(e),
    S = (0, i.useStateFromStores)([o.default], () => o.default.getChannelStatus(e)),
    T = null != S && S.length > 0;
  return e.isGuildVoice() && (_ || E) ? !N && _ && T ? (0, a.jsx)(l.MenuItem, {
    id: "clear-status",
    label: f.default.Messages.VOICE_CHANNEL_CLEAR_STATUS,
    action: () => {
      u.default.updateVoiceChannelStatus(e.id, "")
    }
  }) : N && E ? (0, a.jsx)(l.MenuItem, {
    id: "set-status",

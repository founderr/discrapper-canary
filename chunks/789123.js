...
function D() {
  ...
  let t = (0, d.useStateFromStores)([p], () => p.error),
    [s, n] = l.useState(!0),
    {
      ...
      let a = (0, d.useStateFromStores)([S.default], () => S.default.getForGuild(e), [e]);
      return {
        loading: t,
        guildTemplate: a
      }
  ...
  if (l.useEffect(() => {
      if (s && !i) {
        if (null != r) {
          var e, t;
          p.setName(null !== (e = r.name) && void 0 !== e ? e : ""), p.setDescription(null !== (t = r.description) && void 0 !== t ? t : "")
        }
        n(!1)
      }
    }, [s, r, i]), l.useEffect(() => () => {

...
var r, i, a = n(230367), o = n(320215), s = n(240773), l = n(495852), u = n(835913);
...
class c extends l.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let n of Object.keys(e.metadata))
            t.tag(1, a.TD.LengthDelimited).fork().tag(1, a.TD.LengthDelimited).string(n).tag(2, a.TD.LengthDelimited).string(e.metadata[n]).join();
...
class E extends l.C {
    ...
    internalBinaryWrite(e, t, n) {
        for (let r = 0; r < e.ackedDisclosures.length; r++)
            _.internalBinaryWrite(e.ackedDisclosures[r], t.tag(1, a.TD.LengthDelimited).fork(), n).join();
        let r = n.writeUnknownFields;
        return !1 !== r && (!0 == r ? a.z.onWrite : r)(this.typeName, e, t), t;
    }
    constructor() {

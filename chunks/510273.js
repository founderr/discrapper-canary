...
var s = n(735250), a = n(470079), r = n(120356), i = n.n(r), l = n(481060), o = n(955204), c = n(818765), d = n(674680), _ = n(693797);
let u = e => {
    let {color: t} = e;
    return (0, s.jsxs)('svg', {
        width: '48',
...
function E(e) {
    ...
    let p = null != R && n, g = p ? l.Clickable : 'div';
    return (0, s.jsxs)(g, {
        className: i()(_.container, p && _.actionable),
        onClick: () => {
            p && R();
        },
        children: [

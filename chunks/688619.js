...
e = 0, r = function () {
    ...
    var a = function (t) {
            ...
            format: {},
            autodetect: []
        }, s = o.last, c = o.clip_rgb, I = o.type, R = function () {
    ...
    var u = function () {
        for (var t = [], e = arguments.length; e--;)
            t[e] = arguments[e];
        return new (Function.prototype.bind.apply(u.Color, [null].concat(t)))();
    };
    u.Color = R, u.version = '2.4.2';
    var T = o.unpack, l = Math.max, A = o.unpack, N = o.unpack, d = o.type, O = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = T(t, 'rgb'), n = r[0], _ = r[1], a = r[2], i = 1 - l(n /= 255, l(_ /= 255, a /= 255)), o = i < 1 ? 1 / (1 - i) : 0;
            return [
                (1 - n - i) * o,
                (1 - _ - i) * o,
                (1 - a - i) * o,
    ...
    R.prototype.cmyk = function () {
        ...
        for (var t = [], e = arguments.length; e--;)
            t[e] = arguments[e];
        var r = (t = A(t, 'cmyk'))[0], n = t[1], _ = t[2], a = t[3], i = t.length > 4 ? t[4] : 1;
        return 1 === a ? [
            0,
            0,
            0,
    ...
    var p = o.unpack, S = o.last, D = function (t) {
            return Math.round(100 * t) / 100;
        }, f = o.unpack, L = function () {
            for (var t, e, r = [], n = arguments.length; n--;)
                r[n] = arguments[n];
            var _ = (r = f(r, 'rgba'))[0], a = r[1], i = r[2], o = Math.min(_ /= 255, a /= 255, i /= 255), E = Math.max(_, a, i), s = (E + o) / 2;
            ...
            if (0 === o)
                ...
                var s = [
                        ...
                        0,
                        0
                    ], I = E < 0.5 ? E * (1 + o) : E + o - E * o, R = 2 * E - I, u = i / 360;
                s[0] = u + 1 / 3, s[1] = u, s[2] = u - 1 / 3;
                for (var T = 0; T < 3; T++)
                    s[T] < 0 && (s[T] += 1), s[T] > 1 && (s[T] -= 1), 6 * s[T] < 1 ? c[T] = R + (I - R) * 6 * s[T] : 2 * s[T] < 1 ? c[T] = I : 3 * s[T] < 2 ? c[T] = R + (I - R) * (2 / 3 - s[T]) * 6 : c[T] = R;
                e = (t = [
                    U(255 * c[0]),
                    U(255 * c[1]),
                    U(255 * c[2])
        ...
        }, m = /^rgb\(\s*(-?\d+),\s*(-?\d+)\s*,\s*(-?\d+)\s*\)$/, y = /^rgba\(\s*(-?\d+),\s*(-?\d+)\s*,\s*(-?\d+)\s*,\s*([01]|[01]?\.\d+)\)$/, b = /^rgb\(\s*(-?\d+(?:\.\d+)?)%,\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*\)$/, v = /^rgba\(\s*(-?\d+(?:\.\d+)?)%,\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)$/, B = /^hsl\(\s*(-?\d+(?:\.\d+)?),\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*\)$/, w = /^hsla\(\s*(-?\d+(?:\.\d+)?),\s*(-?\d+(?:\.\d+)?)%\s*,\s*(-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)$/, H = Math.round, Y = function (t) {
    ...
    var K = o.type, k = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = h(t, 'rgba'), n = C(t) || 'rgb';
    ...
    var x = o.unpack, F = o.unpack, W = Math.floor, X = o.unpack, j = o.type, z = function () {
            for (var t, e = [], r = arguments.length; r--;)
                e[r] = arguments[r];
            var n = x(e, 'rgb'), _ = n[0], a = n[1], i = n[2], o = Math.min(_, a, i), E = Math.max(_, a, i), s = E - o;
    ...
    R.prototype.hcg = function () {
        ...
        if (0 === R)
            ...
            var l = W(I /= 60), A = I - l, N = u * (1 - R), d = N + T * (1 - A), O = N + T * A, p = N + T;
            switch (l) {
            case 0:
                i = (t = [
                    p,
    ...
    var $ = o.unpack, q = o.last, Z = Math.round, J = function () {
        ...
        }, Q = /^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, tt = /^#?([A-Fa-f0-9]{8}|[A-Fa-f0-9]{4})$/, te = function (t) {
            if (t.match(Q)) {
            ...
            if (t.match(tt)) {
                ...
                var r = parseInt(t, 16), n = Math.round((255 & r) / 255 * 100) / 100;
                return [
                    r >> 24 & 255,
                    r >> 16 & 255,
                    r >> 8 & 255,
    ...
    var tn = o.unpack, t_ = o.TWOPI, ta = Math.min, ti = Math.sqrt, to = Math.acos, tE = o.unpack, ts = o.limit, tc = o.TWOPI, tI = o.PITHIRD, tR = Math.cos, tu = o.unpack, tT = o.type, tl = function () {
            for (var t, e = [], r = arguments.length; r--;)
                e[r] = arguments[r];
            var n = tn(e, 'rgb'), _ = n[0], a = n[1], i = n[2], o = ta(_ /= 255, a /= 255, i /= 255), E = (_ + a + i) / 3, s = E > 0 ? 1 - o / E : 0;
    ...
    R.prototype.hsi = function () {
        ...
        for (var t, e, r, n = [], _ = arguments.length; _--;)
            n[_] = arguments[_];
        var a = (n = tE(n, 'hsi'))[0], i = n[1], o = n[2];
        ...
        test: function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            if ('array' === tT(t = tu(t, 'hsi')) && 3 === t.length)
                return 'hsi';
        }
    });
    var tA = o.unpack, tN = o.type;
    ...
    var td = o.unpack, tO = Math.min, tp = Math.max, tS = o.unpack, tD = Math.floor, tf = o.unpack, tL = o.type, th = function () {
            for (var t, e, r, n = [], _ = arguments.length; _--;)
                n[_] = arguments[_];
            var a = (n = td(n, 'rgb'))[0], i = n[1], o = n[2], E = tO(a, i, o), s = tp(a, i, o), c = s - E;
    ...
    R.prototype.hsv = function () {
        ...
        for (var t, e, r, n, _, a, i, o, E, s = [], c = arguments.length; c--;)
            s[c] = arguments[c];
        var I = (s = tS(s, 'hsv'))[0], R = s[1], u = s[2];
        if (u *= 255, 0 === R)
            i = o = E = u;
        else {
            360 === I && (I = 0), I > 360 && (I -= 360), I < 0 && (I += 360);
            var T = tD(I /= 60), l = I - T, A = u * (1 - R), N = u * (1 - R * l), d = u * (1 - R * (1 - l));
            switch (T) {
            case 0:
                i = (t = [
                    u,
    ...
    var tC = {
            ...
            t2: 0.12841855,
            t3: 0.008856452
        }, tg = o.unpack, tP = Math.pow, tM = function (t) {
            ...
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = tg(t, 'rgb'), n = tG(r[0], r[1], r[2]), _ = n[0], a = n[1], i = n[2], o = 116 * a - 16;
            return [
                o < 0 ? 0 : o,
                500 * (_ - a),
                200 * (a - i)
            ];
        }, ty = o.unpack, tb = Math.pow, tv = function (t) {
            ...
            for (var t, e, r, n, _, a = [], i = arguments.length; i--;)
                a[i] = arguments[i];
            var o = (a = ty(a, 'lab'))[0], E = a[1], s = a[2];
    ...
    var tK = o.unpack, tk = o.RAD2DEG, tV = Math.sqrt, tx = Math.atan2, tF = Math.round, tW = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = tK(t, 'lab'), n = r[0], _ = r[1], a = r[2], i = tV(_ * _ + a * a), o = (tx(a, _) * tk + 360) % 360;
            ...
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = tZ((t = tJ(t, 'lch'))[0], t[1], t[2]), n = tw(r[0], r[1], r[2]);
            return [
                n[0],
                n[1],
                n[2],
        ...
        }, t0 = o.unpack, t1 = o.unpack, t2 = o.type, t3 = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = tX(t, 'rgb'), n = tm(r[0], r[1], r[2]);
    ...
    var t4 = o.unpack, t8 = o.type, t7 = o.type, t9 = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = t4(t, 'rgb');
    ...
    var et = o.unpack, ee = o.type, er = Math.round;
    ...
    var en = Math.log, e_ = function (t) {
        ...
        }, ea = o.unpack, ei = Math.round, eo = function () {
            for (var t, e = [], r = arguments.length; r--;)
                e[r] = arguments[r];
    ...
    var eE = o.unpack, es = Math.cbrt, ec = Math.pow, eI = Math.sign, eR = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = eE(t, 'rgb'), n = r[0], _ = r[1], a = r[2], i = [
                    eu(n / 255),
                    eu(_ / 255),
                    eu(a / 255)
                ], o = i[0], E = i[1], s = i[2], c = es(0.4122214708 * o + 0.5363325363 * E + 0.0514459929 * s), I = es(0.2119034982 * o + 0.6806995451 * E + 0.1073969566 * s), R = es(0.0883024619 * o + 0.2817188376 * E + 0.6299787005 * s);
            return [
    ...
    var eT = o.unpack, el = Math.pow, eA = Math.sign, eN = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = (t = eT(t, 'lab'))[0], n = t[1], _ = t[2], a = el(r + 0.3963377774 * n + 0.2158037573 * _, 3), i = el(r - 0.1055613458 * n - 0.0638541728 * _, 3), o = el(r - 0.0894841775 * n - 1.291485548 * _, 3);
            return [
    ...
    R.prototype.oklab = function () {
        ...
        test: function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            if ('array' === ep(t = eO(t, 'oklab')) && 3 === t.length)
                return 'oklab';
        }
    });
    var eS = o.unpack, eD = o.unpack, ef = o.unpack, eL = o.type, eh = function () {
            for (var t = [], e = arguments.length; e--;)
                t[e] = arguments[e];
            var r = eS(t, 'rgb'), n = eR(r[0], r[1], r[2]);
            return tW(n[0], n[1], n[2]);
        };
    R.prototype.oklch = function () {
        ...
        for (var t = [], e = arguments.length; e--;)
            t[e] = arguments[e];
        var r = tZ((t = eD(t, 'lch'))[0], t[1], t[2]), n = eN(r[0], r[1], r[2]);
        return [
            n[0],
            n[1],
            n[2],
    ...
    R.prototype.get = function (t) {
        var e = t.split('.'), r = e[0], n = e[1], _ = this[r]();
        if (!n)
            return _;
    ...
    R.prototype.luminance = function (t) {
        if (void 0 !== t && 'number' === eg(t)) {
            ...
            var e = this.luminance(), r = 20, n = function (e, _) {
                    var a = e.interpolate(_, 0.5, 'rgb'), i = a.luminance();
    ...
    var eM = function (t, e, r) {
        ...
        }, eG = {}, em = o.type, ey = function (t, e, r) {
            void 0 === r && (r = 0.5);
    ...
    R.prototype.set = function (t, e, r) {
        void 0 === r && (r = !1);
        var n = t.split('.'), _ = n[0], a = n[1], i = this[_]();
        if (!a)
            return i;
    ...
    eG.rgb = function (t, e, r) {
        var n = t._rgb, _ = e._rgb;
        return new R(n[0] + r * (_[0] - n[0]), n[1] + r * (_[1] - n[1]), n[2] + r * (_[2] - n[2]), 'rgb');
    };
    var ev = Math.sqrt, eB = Math.pow;
    eG.lrgb = function (t, e, r) {
        var n = t._rgb, _ = n[0], a = n[1], i = n[2], o = e._rgb, E = o[0], s = o[1], c = o[2];
    ...
    var ew = function (t, e, r, n) {
            var _, a, i, o, E, s, c, I, u, T, l, A, N, d;
            return 'hsl' === n ? (i = t.hsl(), o = e.hsl()) : 'hsv' === n ? (i = t.hsv(), o = e.hsv()) : 'hcg' === n ? (i = t.hcg(), o = e.hcg()) : 'hsi' === n ? (i = t.hsi(), o = e.hsi()) : 'lch' === n || 'hcl' === n ? (n = 'hcl', i = t.hcl(), o = e.hcl()) : 'oklch' === n && (i = t.oklch().reverse(), o = e.oklch().reverse()), ('h' === n.substr(0, 1) || 'oklch' === n) && (E = (_ = i)[0], c = _[1], u = _[2], s = (a = o)[0], I = a[1], T = a[2]), isNaN(E) || isNaN(s) ? isNaN(E) ? isNaN(s) ? A = Number.NaN : (A = s, (1 == u || 0 == u) && 'hsv' != n && (l = I)) : (A = E, (1 == T || 0 == T) && 'hsv' != n && (l = c)) : (d = s > E && s - E > 180 ? s - (E + 360) : s < E && E - s > 180 ? s + 360 - E : s - E, A = E + r * d), void 0 === l && (l = c + r * (I - c)), N = u + r * (T - u), 'oklch' === n ? new R([
                N,
                l,
                A
            ], n) : new R([
    ...
    eG.oklab = function (t, e, r) {
        var n = t.oklab(), _ = e.oklab();
        return new R(n[0] + r * (_[0] - n[0]), n[1] + r * (_[1] - n[1]), n[2] + r * (_[2] - n[2]), 'oklab');
    };
    eG.oklch = function (t, e, r) {
        return ew(t, e, r, 'oklch');
    };
    var eY = o.clip_rgb, eK = Math.pow, ek = Math.sqrt, eV = Math.PI, ex = Math.cos, eF = Math.sin, eW = Math.atan2, eX = function (t, e) {
            ...
            var e = 'rgb', r = u('#ccc'), n = 0, _ = [
                    0,
                    1
                ], a = [], i = [
                    0,
                    0
                ], o = !1, E = [], s = !1, c = 0, I = 1, R = !1, T = {}, l = !0, A = 1, N = function (t) {
                    if (t = t || [
                            '#fff',
                            '#000'
                        ], 'string' === ej(t) && u.brewer && u.brewer[t.toLowerCase()] && (t = u.brewer[t.toLowerCase()]), 'array' === ej(t)) {
                        1 === t.length && (t = [
                            t[0],
                            t[0]
                        ]), t = t.slice(0);
                    ...
                    if (l && T[R])
                        ...
                        if ('array' === ej(E))
                            for (var N = 0; N < a.length; N++) {
                                var S = a[N];
                                if (s <= S || s >= S && N === a.length - 1) {
                                    _ = E[N];
                                    break;
                                }
                                if (s > S && s < a[N + 1]) {
                                    s = (s - S) / (a[N + 1] - S), _ = u.interpolate(E[N], E[N + 1], s, e);
                                    break;
                                }
                            }
                        else
            ...
            return f.classes = function (t) {
                ...
                return null == t && (t = !0), R = t, D(), O = R ? function (t) {
                    for (var e = S(0, !0).lab()[0], r = S(1, !0).lab()[0], n = e > r, _ = S(t, !0).lab()[0], a = e + (r - e) * t, i = _ - a, o = 0, E = 1, s = 20; Math.abs(i) > 0.01 && s-- > 0;)
                        n && (i *= -1), i < 0 ? (o = t, t += (E - t) * 0.5) : (E = t, t += (o - t) * 0.5), i = (_ = S(t, !0).lab()[0]) - a;
                    return t;
                } : function (t) {
                    return t;
                }, f;
    ...
    for (var e1 = o.type, e2 = o.clip_rgb, e3 = o.TWOPI, e5 = Math.pow, e6 = Math.sin, e4 = Math.cos, e8 = Math.floor, e7 = Math.random, e9 = Math.log, rt = Math.pow, re = Math.floor, rr = Math.abs, rn = function (t, e) {
                ...
                var n = t.min, _ = t.max, i = t.values.sort(function (t, e) {
                        return t - e;
                    });
                if (1 === r)
                    return [
                ...
                if ('c' === e.substr(0, 1) && (o.push(n), o.push(_)), 'e' === e.substr(0, 1)) {
                    ...
                    var s = Math.LOG10E * e9(n), c = Math.LOG10E * e9(_);
                    o.push(n);
                    for (var I = 1; I < r; I++)
                    ...
                    o.push(n);
                    for (var R = 1; R < r; R++) {
                        var u = (i.length - 1) * R / r, T = re(u);
                        if (T === u)
                            o.push(i[T]);
                        else {
                            var l = u - T;
                            o.push(i[T] * (1 - l) + i[T + 1] * l);
                        }
                    }
                    o.push(_);
                } else if ('k' === e.substr(0, 1)) {
                    var A, N = i.length, d = Array(N), O = Array(r), p = !0, S = 0, D = null;
                    (D = []).push(n);
                    for (var f = 1; f < r; f++)
                        D.push(n + f / r * (_ - n));
                    for (D.push(_); p;) {
                ...
                return o;
            }, ra = rn, ri = r_, ro = Math.sqrt, rE = Math.pow, rs = Math.min, rc = Math.max, rI = Math.atan2, rR = Math.abs, ru = Math.cos, rT = Math.sin, rl = Math.exp, rA = Math.PI, rN = {
                OrRd: [
                    '#fff7ec',
                    '#fee8c8',
                    '#fdd49e',
    ...
    return u.average = function (t, e, r) {
        ...
        for (var T = 0; T < i.length; T++)
            if ('h' === e.charAt(T)) {
                for (var l = eW(s / o[T], E / o[T]) / eV * 180; l < 0;)
                    l += 360;
                for (; l >= 360;)
                    l -= 360;
                i[T] = l;
                ...
                i[T] = i[T] / o[T];
        return u /= n, new R(i, e).alpha(u > 0.99999 ? 1 : u, !0);
    }, u.bezier = function (t) {
        var e = eZ(t);
        return e.scale = function () {
            return e$(e);
        }, e;
    }, u.blend = eJ, u.cubehelix = function (t, e, r, n, _) {
    ...
    }, u.mix = u.interpolate = ey, u.random = function () {
        for (var t = '#', e = 0; e < 6; e++)
            t += '0123456789abcdef'.charAt(e8(16 * e7()));
        return new R(t, 'hex');
    }, u.scale = e$, u.analyze = ra, u.contrast = function (t, e) {
        t = new R(t), e = new R(e);
        var r = t.luminance(), n = e.luminance();
        return r > n ? (r + 0.05) / (n + 0.05) : (n + 0.05) / (r + 0.05);
    }, u.deltaE = function (t, e, r, n, _) {
        ...
        t = new R(t), e = new R(e);
        var o = Array.from(t.lab()), E = o[0], s = o[1], c = o[2], I = Array.from(e.lab()), u = I[0], T = I[1], l = I[2], A = (E + u) / 2, N = (ro(rE(s, 2) + rE(c, 2)) + ro(rE(T, 2) + rE(l, 2))) / 2, d = 0.5 * (1 - ro(rE(N, 7) / (rE(N, 7) + rE(25, 7)))), O = s * (1 + d), p = T * (1 + d), S = ro(rE(O, 2) + rE(c, 2)), D = ro(rE(p, 2) + rE(l, 2)), f = (S + D) / 2, L = a(rI(c, O)), h = a(rI(l, p)), C = L >= 0 ? L : L + 360, g = h >= 0 ? h : h + 360, P = rR(C - g) > 180 ? (C + g + 360) / 2 : (C + g) / 2, M = 1 - 0.17 * ru(i(P - 30)) + 0.24 * ru(i(2 * P)) + 0.32 * ru(i(3 * P + 6)) - 0.2 * ru(i(4 * P - 63)), U = g - C;
        U = 180 >= rR(U) ? U : g <= C ? U + 360 : U - 360, U = 2 * ro(S * D) * rT(i(U) / 2);
        var G = D - S, m = 1 + 0.015 * rE(A - 50, 2) / ro(20 + rE(A - 50, 2)), y = 1 + 0.045 * f, b = 1 + 0.015 * f * M, v = 30 * rl(-rE((P - 275) / 25, 2)), B = -(2 * ro(rE(f, 7) / (rE(f, 7) + rE(25, 7)))) * rT(2 * i(v));
        return rc(0, rs(100, ro(rE((u - E) / (r * m), 2) + rE(G / (n * y), 2) + rE(U / (_ * b), 2) + G / (n * y) * B * (U / (_ * b)))));
    }, u.distance = function (t, e, r) {
        void 0 === r && (r = 'lab'), t = new R(t), e = new R(e);
        var n = t.get(r), _ = e.get(r), a = 0;
        for (var i in n) {
            var o = (n[i] || 0) - (_[i] || 0);
            a += o * o;
        }
        return Math.sqrt(a);
    }, u.limits = ri, u.valid = function () {
        for (var t = [], e = arguments.length; e--;)
            t[e] = arguments[e];
        try {

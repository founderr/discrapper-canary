...
function b(e) {
  ...
  let {
    ...
    decoration: I,
    onUseNow: T
  } = e, S = r.useRef(null), [f, N] = r.useState(null), A = r.useRef(new a.qA), O = (0, u.e7)([d.Z], () => d.Z.useReducedMotion), C = (0, u.e7)([m.default], () => m.default.getCurrentUser()), L = (0, g.j8)(l), M = (null === (t = l.userStatus) || void 0 === t ? void 0 : t.claimedAt) != null, [y, U] = r.useState(M ? "claimed" : "loading");
  r.useEffect(() => {
...
function G(e) {
  let {
    ...
    onClose: c,
    onConfirm: d
  } = e, E = (0, g.zK)(t, L.S7.IN_HOUSE_CONSOLE_QUEST), T = C.r.build(t.config).defaultRewardRedemptionInstructionsByPlatform[p.y$.CROSS_PLATFORM], h = (0, g.Kr)(t.config), f = null == h ? M.Z.Messages.QUESTS_REWARD_AVATAR_DECORATION_BODY.format({
    decorationName: s

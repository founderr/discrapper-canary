...
var s = n(113434), a = n(918701), r = n(566078), i = n(46140), o = n(689938);
function u(e) {
    let {
            quest: t,
            taskDetails: n,
            ...
            expiryDate: E
        } = e, I = t.config.messages.gameTitle, c = r.r.build(t.config).defaultReward.messages.nameWithArticle, {targetMinutes: d} = n, R = (0, a.zK)(t, i.S7.IN_HOUSE_CONSOLE_QUEST), m = (0, a.Kr)(t.config), S = (0, a.$J)(t) && (0, a.$H)(t), g = (0, s.uA)({
            quest: t,
            location: u,
            questContent: _
        });
    if (R && null != m)
        return function (e, t, n) {
            var s;
            let i = r.r.build(e.config).defaultReward.messages.nameWithArticle, u = (null === (s = e.userStatus) || void 0 === s ? void 0 : s.enrolledAt) != null, _ = (0, a.Kr)(e.config), {targetMinutes: l} = t;
    ...
    if (S)
        return function (e) {
            ...
            let {
                    ...
                    expiryDate: u
                } = e, _ = r.r.build(n.config).defaultReward.messages.nameWithArticle, l = (null === (t = n.userStatus) || void 0 === t ? void 0 : t.enrolledAt) != null, T = (0, a.Kr)(n.config), {targetMinutes: E} = s, I = n.config.messages.gameTitle;
            if (null != T)
    ...
    if ((0, a.$J)(t))
        return function (e, t, n) {
            let s = r.r.build(e.config).defaultReward.messages.nameWithArticle, i = (0, a.Kr)(e.config), {targetMinutes: u} = t, _ = e.config.messages.gameTitle;
        ...
        return function (e, t, n, s) {
            let {targetMinutes: a} = n, r = t.config.messages.gameTitle;

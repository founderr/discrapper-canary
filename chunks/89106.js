...
var n, i = r(599295), o = r(781212), s = r(470079);
r(26095);
var a = r(959818), u = r(176375), l = r(544364), c = r(471161);
r(417898), r(233631);
var f = r(851438), d = Number.MIN_SAFE_INTEGER || -1000000000, h = (0, s.createContext)({
        classNamePrefix: '',
        disableStylesGeneration: !1,
        isSSR: !u.Z
    }), p = new Map(), y = function (e, t) {
        var r = e.managers;
        if (r)
        ...
        var t = e.sheet, r = e.context, n = e.index, i = e.theme;
        if (!!t)
            y(r, n).manage(i), r.registry && r.registry.add(t);
    }, m = function (e) {
        if (!!e.sheet)
            y(e.context, e.index).unmanage(e.theme);
    }, v = (0, l.Ue)((0, c.Z)()), b = new WeakMap(), x = function (e) {
        return b.get(e);
    }, w = function (e, t) {
        b.set(e, t);
    }, k = function (e) {
        ...
        if (!e.context.disableStylesGeneration) {
            var t, r, n, o, s, a = y(e.context, e.index), u = a.get(e.theme);
            if (u)
                return u;
            var c = e.context.jss || v, f = k(e), d = (0, l._$)(f);
...
var O = {}, A = function (e, t) {
        void 0 === t && (t = {});
        var r = t, n = r.index, i = void 0 === n ? d++ : n, u = r.theming, l = r.name, c = (0, o.Z)(r, [
                'index',
                'theming',
                'name'
            ]), f = u && u.context || a.Ni, p = {};
        return function (t) {
            var r, n = (0, s.useRef)(!0), o = (0, s.useContext)(h);
            var a = (r = t && t.theme, 'function' == typeof e && (r || (0, s.useContext)(f)) || O), u = (0, s.useMemo)(function () {
                    var r = S({
                        context: o,
                        styles: e,
                        name: l,

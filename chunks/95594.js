...
var r = n(470079), i = n(663507), a = n(924428), o = n(151973);
let s = Object.freeze({
    coordsMap: {},
    visibleSections: {},
    totalHeight: 0,
...
function l(e) {
    ...
    return A.current = (0, r.useMemo)(() => C > 0 ? A.current : (N.mergeProps({
        sections: t,
        columns: n,
        getItemKey: l,
        getItemHeight: u,
        ...
        marginLeft: R / 2,
        dir: g
    }), N.computeVisibleSections(Math.max(0, y * d), D * d), N.getState()), [
        C,
        N,
        t,
        n,

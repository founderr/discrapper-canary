...
function w(e) {
  ...
  let {
    flaggedContent: n
  } = e, l = (0, s.useStateFromStores)([S.default], () => S.default.getCurrentUser()), [r, c] = a.useState({}), [d, f] = a.useState(!0), p = n[0], A = L(p, r), g = (0, E.default)(A, {
  ...
  }, [p.attachments]), "" === A.content && 0 === A.attachments.length) ? null : (0, i.jsx)("div", {
    className: N.classificationEvidenceCard,
    children: d ? (0, i.jsx)(o.Spinner, {}) : (0, i.jsx)(m.default, {
      compact: !1,

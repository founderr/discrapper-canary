...
let y = e => {
  ...
  D = e => {
    ...
    let o = null !== (s = null != l ? l : null == a ? void 0 : a.formFields) && void 0 !== s ? s : [],
      u = r ? j.W : j.r;
    return (0, i.jsx)(u, {
      guildId: n,
      formFields: o,
...
s.Z = e => {
  ...
  })), [q, W] = r.useState(null !== (s = null == P ? void 0 : P.formFields) && void 0 !== s ? s : []), [X, K] = r.useState(!1), [$, ee] = r.useState(null), [es, en] = r.useState(G ? 0 : 2), [el, et] = r.useState(""), [ei, er] = r.useState(""), [ea, eo] = r.useState(null), [ed, eu] = r.useState(null), ec = null == P ? void 0 : P.guild, eI = r.useMemo(() => null != b ? b : null != ec ? new m.ZP(ec) : null, [b, ec]), eE = null !== (n = null == eI ? void 0 : eI.hasFeature(L.oNc.CLAN)) && void 0 !== n && n, {
    emojisToRender: eM,
    remainingEmojis: em,
    numGuildEmoji: e_
  } = r.useMemo(() => {
  ...
  }, [ec, z]), eN = null != J ? J : null == ec ? void 0 : ec.approximate_member_count, ex = null != Q ? Q : null == ec ? void 0 : ec.approximate_presence_count;
  ...
  let eR = r.useMemo(() => !(((null == eI ? void 0 : eI.verificationLevel) !== L.sFg.VERY_HIGH || (null == k ? void 0 : k.isStaff())) && H || Y) || q.some(e => !(0, O.OA)(e)), [q, eI, Y, H, k]),

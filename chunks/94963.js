t(47120);
var a = t(735250), r = t(470079), i = t(688619), s = t.n(i), o = t(120356), l = t.n(o), c = t(866442), d = t(442837), u = t(481060), m = t(231467), f = t(650774), C = t(430824), _ = t(175557), h = t(688298), x = t(995119), g = t(116175), p = t(308083), T = t(689938), I = t(275548), E = t(360884);
let b = [
        {
            name: 'Night Sky',
        ...
        return (0, a.jsxs)(a.Fragment, {
            children: [
                i ? (0, a.jsx)(u.PaintPaletteIcon, { size: 'md' }) : (0, a.jsx)('div', {
...
n.Z = e => {
    ...
    let {
            ...
            let e = b[Math.floor(Math.random() * b.length)].bannerKind, n = s().random().hex();
            v({
                banner: e,
                brandPrimaryColor: n,
                                            ...
                                            children: [
                                                (0, a.jsx)(h.Z, {
                                                    ...
                                                    onPrimaryColorChange: e => {
                                                        v({ brandPrimaryColor: (0, c.Rf)(e) });
                                                    },
                                                    onSecondaryColorChange: e => {
                                                        v({ brandSecondaryColor: (0, c.Rf)(e) });
                                                    },
                                                    shouldShow: P,
                                                    onRequestClose: () => w(!1),
                                                    children: e => (0, a.jsx)(u.Clickable, {
                                                        ...
                                                        className: l()(I.brandItemContainer, { [I.brandItemContainerSelected]: 0 === D }),
                                                        children: (0, a.jsx)(N, {
                                                ...
                                                (0, a.jsx)(u.Clickable, {
                                                    ...
                                                    className: l()(I.brandItemContainer, { [I.brandItemContainerSelected]: 1 === D }),
                                                    children: (0, a.jsx)(N, {
                                                ...
                                                p.ym.map((e, n) => (0, a.jsx)(u.Clickable, {
                                                    ...
                                                    className: l()(I.brandItemContainer, { [I.brandItemContainerSelected]: D === n + 2 }),
                                                    children: (0, a.jsx)(N, {
                                                        name: e.name,
                                    ...
                                    children: [
                                        ...
                                        (0, a.jsx)('div', {
                                            ...
                                            children: b.map((e, n) => (0, a.jsxs)(u.Clickable, {
                                                'aria-label': e.name,
                                                onClick: () => {
                                                    v({ banner: e.bannerKind });
                                                },
                                                className: l()(I.bannerItemContainer, { [I.bannerItemContainerSelected]: e.bannerKind === A }),
                                                children: [
                                                    (0, a.jsx)(e.icon, {
                                                        size: 'md',
                                                        color: 'currentColor'

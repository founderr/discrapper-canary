...
function W(e) {
  ...
  } = e, h = (0, c.useAppContext)(), E = (0, r.useStateFromStores)([f.default], () => f.default.getChatOpen(n.id)), C = (0, b.useCanModerateRequestToSpeak)(n.id), A = (0, j.useStageParticipantsCount)(n.id, P.StageChannelParticipantNamedIndex.REQUESTED_TO_SPEAK_ONLY), {
    preventIdle: v,
    allowIdle: N
    ...
    children: [K, (0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)(z, {}), (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsx)(u.Text, {
          ...
          children: b ? G.default.Messages.STAGE_FULL_MODERATOR_TITLE : G.default.Messages.STAGE_FULL_MODERATOR_MAX_TITLE
        }), (0, a.jsx)(u.Text, {
          variant: "text-xs/medium",
          color: "text-normal",
          children: b ? G.default.Messages.STAGE_FULL_MODERATOR_BODY : G.default.Messages.STAGE_FULL_MAX_BODY
        })]
      }), (0, a.jsx)("div", {
        className: V.buttons,

...
function i(e, t, n) {
    for (let r = 0; r < 28; r += 7) {
        let i = e >>> r, a = !(i >>> 7 == 0 && 0 == t), o = (a ? 128 | i : i) & 255;
        if (n.push(o), !a)
            return;
    }
    let r = e >>> 28 & 15 | (7 & t) << 4, i = t >> 3 != 0;
    if (n.push((i ? 128 | r : r) & 255), !!i) {
        for (let e = 3; e < 31; e += 7) {
            let r = t >>> e, i = r >>> 7 != 0, a = (i ? 128 | r : r) & 255;
            if (n.push(a), !i)
                return;
        }
        n.push(t >>> 31 & 1);
...
function a(e) {
    ...
    return i(-24, -18), i(-18, -12), i(-12, -6), i(-6), [
        t,
        n,
        r
    ];
...
function o(e, t) {
    ...
    let n = (e >>> 24 | t << 8) >>> 0 & 16777215, r = t >> 16 & 65535, i = (16777215 & e) + 6777216 * n + 6710656 * r, a = n + 8147497 * r, o = 2 * r;
    function s(e, t) {
        let n = e ? String(e) : '';
...
function l() {
    ...
    if (t |= (127 & (e = this.buf[this.pos++])) << 7, (128 & e) == 0)
        return this.assertBounds(), t;
    if (t |= (127 & (e = this.buf[this.pos++])) << 14, (128 & e) == 0)
        return this.assertBounds(), t;
    if (t |= (127 & (e = this.buf[this.pos++])) << 21, (128 & e) == 0)
        return this.assertBounds(), t;

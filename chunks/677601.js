...
class eD extends l.PureComponent {
    ...
    render() {
        ...
        return (0, i.jsxs)('div', {
            className: r()(eR.wrapper, ek[e], eO[s], {
    ...
    constructor(...e) {
        super(...e),
            ...
            eL(this, 'handleSelectParticipant', (e, t) => {
                ...
                (0, ey._5)(e) && (0, w.p9)(n, ep.Z, eo.Z, ec.Z, L.Z)[0] && (g.default.selectVoiceChannel(n.id), 0 === l.filter((t) => (0, D.V9)(t) === e.id && t.state !== eP.jm8.ENDED).length && (0, C.rn)((0, D.my)(e.id), { forceMultiple: t.shiftKey })), a && r === eP.WtW.VIDEO && ((null == i ? void 0 : i.id) === e.id ? m.Z.selectParticipant(n.id, null) : m.Z.selectParticipant(n.id, e.id));
            }),

...
class eD extends s.PureComponent {
    ...
    renderContent(e) {
        var t;
        let { selectedParticipant: n, inCall: s, hasConnectPermission: a, mode: l, popoutWindow: r, participantsOpen: o, participants: c, filteredParticipants: u, participantsVersion: d, channel: h, guild: m, layout: p, forceShowControls: _, awaitingRemoteSessionInfo: f, currentChannelActivities: E, callContainerDimensions: g } = this.props,
            C = p === eR.AEg.MINIMUM,
            I = C || p === eR.AEg.NORMAL,
            x = s && l === eR.WtW.VIDEO,
    ...
    render() {
        let { layout: e, channel: t, guild: n, mode: s, chatOpen: a, appContext: r, maxSidebarWidth: o, maxHeight: c, inCall: u } = this.props,
            ...
            m = s === eR.WtW.VIDEO,
            p = e !== eR.AEg.NO_CHAT && e !== eR.AEg.FULL_SCREEN && null != c;
        return (0, i.jsxs)('div', {
            className: l()(ej.wrapper, eO[e], ey[r], {
                [ej.poppedOut]: this.popoutOpen && !this.inPopout && e !== eR.AEg.NO_CHAT && t.isPrivate(),
                [ej.video]: m,
                [ej.chatSidebarOpen]: a
            }),
            ref: (e) => {
    ...
    constructor(...e) {
        super(...e),
            eP(this, '_prevLayout', eR.AEg.MINIMUM),
            eP(this, '_wrapperRef', s.createRef()),
            eP(this, '_callContainerRef', s.createRef()),
            eP(this, '_channelChatRef', s.createRef()),
            eP(this, '_contentRef', s.createRef()),
            ...
            eP(this, 'handleChangeLayout', (e) => {
                ...
                i !== e && (p.Z.updateLayout(t.id, e, n), e === eR.AEg.FULL_SCREEN && t.isPrivate() && e_.S.dispatch(eR.CkL.TEXTAREA_BLUR));
            }),
                            ...
                            switch (l.type) {
                                case eR.d4z.DM:
                                    return (0, _.jW)(
                                        t,
                                        async () => {
                                            let { default: e } = await Promise.all([n.e('79695'), n.e('90286'), n.e('22036'), n.e('56826'), n.e('97741')]).then(n.bind(n, 131404));
                                            return (t) =>
                                                (0, i.jsx)(e, {
                                                    ...t,
                                ...
                                case eR.d4z.GROUP_DM:
                                    return (0, _.jW)(
                                        t,
                                        async () => {
                                            let { default: e } = await Promise.all([n.e('79695'), n.e('90286'), n.e('18283')]).then(n.bind(n, 354589));
                                            return (t) =>
                                                (0, i.jsx)(e, {
                                                    ...t,
                                                    showChannelCallItems: !0,
            ...
            eP(this, 'handleSelectParticipant', (e, t) => {
                ...
                (0, eb._5)(e) && (0, k.p9)(n, eh.Z, er.Z, eo.Z, P.Z)[0] && (f.default.selectVoiceChannel(n.id), 0 === s.filter((t) => (0, D.V9)(t) === e.id && t.state !== eR.jm8.ENDED).length && (0, E.rn)((0, D.my)(e.id), { forceMultiple: t.shiftKey })), a && l === eR.WtW.VIDEO && ((null == i ? void 0 : i.id) === e.id ? p.Z.selectParticipant(n.id, null) : p.Z.selectParticipant(n.id, e.id));
            }),
            ...
            eP(this, 'renderBottomLeft', () => {
                ...
                let d = e === eR.AEg.NO_CHAT ? q.Z.Directions.UP : q.Z.Directions.DOWN,
                    m = [eR.AEg.FULL_SCREEN, eR.AEg.NO_CHAT].includes(e),
                    p = u.some((e) => e.type === eb.fO.STREAM),
                    _ =
...
t.Z = function (e) {
    ...
    let { channel: n, renderExternalHeader: a, maxHeight: l } = e,
        ...
        { width: d = 0, height: m = 0, ref: p } = (0, x.Z)(),
        { ref: _ } = (0, x.Z)(),
        f = (0, v.bp)(),
        E = (0, O.Z)(),
        C = (0, c.e7)([eu.Z], () => {

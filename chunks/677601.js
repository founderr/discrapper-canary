...
this.currentDocument.addEventListener(eg.NO, this.handleFullScreenChange), em.default.track(ej.rMx.VIDEO_LAYOUT_TOGGLED, {
...
if (null != s && e.mode === ej.WtW.VIDEO && i === ej.WtW.VOICE && (0, eg.rB)(s, this.currentDocument) && (0, eg.Pr)(s, this.currentDocument), e.participantsOpen !== t || a !== e.layout) {
  var l;
...
return ef.isPlatformEmbedded && eC.ZP.supportsFeature(ej.eRX.POPOUT_WINDOWS);
  }
  get popoutSupported() {
...
return this.popoutOpen && !this.inPopout && this.props.inCall ? {
  mainText: eL.Z.Messages.POPOUT_PLAYER_OPENED
} : null;
  }
  get paused() {
...
let {
  ...
  channel: n,
  inCall: i
} = this.props, a = t === ej.WtW.VIDEO && i && !(this.popoutOpen && !this.inPopout), s = t === ej.WtW.VIDEO && i && this.popoutSupported, l = t !== ej.WtW.VOICE && n.isPrivate() && !this.inPopout && i, r = n.type === ej.d4z.GUILD_VOICE, o = e === ej.AEg.MINIMUM || e === ej.AEg.NORMAL, c = this.inPopout && this.nativePopoutSupported, u = {
  renderHeader: !0,
  useTheme: !1,
  useExternalHeader: o,
  canInvite: r,
...
} = this.props, C = p === ej.AEg.MINIMUM, g = C || p === ej.AEg.NORMAL, I = a && l === ej.WtW.VIDEO, x = (null !== (t = null == E ? void 0 : E.length) && void 0 !== t ? t : 0) > 0 && h.isPrivate();
...
let {
  ...
  resizedHeight: d
} = this.state, h = a === ej.WtW.VIDEO, m = e !== ej.AEg.NO_CHAT && e !== ej.AEg.FULL_SCREEN && null != c;
return (0, i.jsxs)('div', {
  ...
  children: [
    (0, i.jsx)('div', {
      className: l()(eP.callContainer, {
        [(0, eE.Q)(ej.BRd.DARK)]: h
      }),
      ref: e => {
    ...
    (0, i.jsx)('div', {
      ...
      children: s && (!u || !this.popoutOpen || this.inPopout) && (0, i.jsx)(ev.Z, {
        channel: t,
        guild: n,
        maxWidth: o
      })
  ...
  constructor(...e) {
super(...e), eO(this, '_prevLayout', ej.AEg.MINIMUM), eO(this, '_wrapperRef', a.createRef()), eO(this, '_callContainerRef', a.createRef()), eO(this, '_channelChatRef', a.createRef()), eO(this, '_contentRef', a.createRef()), eO(this, '_videoBackgroundTooltipTimeout', new d.V7()), eO(this, '_lastIdleProps', null), eO(this, 'state', {
  resizedHeight: H.ZP.callHeaderHeight
}), eO(this, 'handleFullScreenChange', () => {
  let e = this.getRootNode();
  null != e && !(0, eg.rB)(e, this.currentDocument) && this.props.layout === ej.AEg.FULL_SCREEN && this.handleFullScreen();
}), eO(this, 'handleFullScreen', () => {
  let e = this.getRootNode();
  null != e && (this.props.layout !== ej.AEg.FULL_SCREEN ? (this._prevLayout = this.props.layout, this.handleChangeLayout(ej.AEg.FULL_SCREEN), (0, eg.Dj)(e)) : this.maybeLeaveFullScreen());
}), eO(this, 'maybeLeaveFullScreen', () => {
  let e = this.getRootNode();
  if (null != e)
    this.props.layout === ej.AEg.FULL_SCREEN && (this.handleChangeLayout(this._prevLayout), (0, eg.Pr)(e, this.currentDocument));
  ...
  (0, eR._5)(e) && (0, k.p9)(n, eh.Z, er.Z, eo.Z, P.Z)[0] && (f.default.selectVoiceChannel(n.id), 0 === a.filter(t => (0, D.V9)(t) === e.id && t.state !== ej.jm8.ENDED).length && (0, E.rn)((0, D.my)(e.id), {
    forceMultiple: t.shiftKey
  })), s && l === ej.WtW.VIDEO && ((null == i ? void 0 : i.id) === e.id ? p.Z.selectParticipant(n.id, null) : p.Z.selectParticipant(n.id, e.id));
  ...
  let {
    layout: n,
    selectedParticipant: i
  } = this.props, a = n === ej.AEg.FULL_SCREEN;
  ...
  return !this.inPopout && a !== ej.AEg.FULL_SCREEN && null != t && !n.isManaged() && (e = (0, i.jsx)(g.Z, {
    call: t
  })), (0, i.jsx)(j.Z, {
  ...
  return t || n === ej.AEg.MINIMUM || n === ej.AEg.NORMAL ? (0, i.jsx)(G.ZP, {
    exitFullScreen: this.maybeLeaveFullScreen,
    channel: e,
    ...
    children: [
      ...
      f ? (0, i.jsxs)(j.Z, {
        ...
        children: [
          ...
          m && t > 0 ? (0, i.jsx)(h.NumberBadge, {
            className: eP.badge,
            count: t
          }) : null
        ]
      }) : null,
      (null == r ? void 0 : r.type) !== eR.fO.STREAM && (null == r ? void 0 : r.type) !== eR.fO.ACTIVITY || o ? null : (0, i.jsx)(z.Z, {
  ...
  return (0, i.jsxs)(i.Fragment, {
    children: [
      null != a && a.type !== eR.fO.ACTIVITY && a.user.id !== n ? (0, i.jsx)(et.Z, {
  ...
  return s || this.popoutOpen && !this.inPopout && l ? null : (0, i.jsx)(X.T, {
    channelId: a.id,
    className: t,
    showingClassName: n
  });
  ...
  return c ? (0, i.jsxs)(z.Z, {
    children: [
      (0, i.jsx)('div', {
        ...
        children: r ? null == e ? void 0 : e() : (0, i.jsx)(eS.Z, {
          channel: t,
          guild: n,
          appContext: a,
          inCall: l,
...
ref: f
  } = (0, x.Z)(), E = (0, N.bp)(), g = (0, O.Z)(), A = (0, c.e7)([eu.Z], () => {
var e;
...
return e && i !== ej.AEg.FULL_SCREEN && (i = ej.AEg.NO_CHAT), {
  mode: t,
  layout: i,
...
selectedStream: null != V ? ei.Z.getActiveStreamForStreamKey(V.id) : null
  }), [V]), z = (0, c.e7)([er.Z], () => er.Z.getGuild(n.getGuildId())), Y = (0, c.e7)([el.Z], () => el.Z.getCall(n.id), [n.id]), K = (0, c.e7)([ec.ZP], () => ec.ZP.getMentionCount(n.id), [n.id]), q = (0, c.e7)([ea.default], () => ea.default.getId()), {
popoutWindow: X,
...
popoutWindowAlwaysOnTop: w.Z.getIsAlwaysOnTop(ej.KJ3.CHANNEL_CALL_POPOUT)
  })), J = (0, c.e7)([eo.Z], () => eo.Z.can(ej.Plq.CONNECT, n)), $ = (0, c.e7)([es.Z], () => es.Z.getToastsEnabled(n.id)), ee = (0, c.e7)([P.Z], () => P.Z.getAwaitingRemoteSessionInfo()), et = (0, c.e7)([H.ZP], () => H.ZP.callHeaderHeight), en = a.useCallback(e => {
C.ZP.updatedUnsyncedSettings({
  callHeaderHeight: e
});
  }, []), ed = null !== (t = null == z ? void 0 : z.id) && void 0 !== t ? t : null, eh = (0, Z.Z)(ed, n.id), em = (0, c.e7)([v.Z], () => v.Z.getFetchState(), []), ep = (0, T.Z)(em);
  a.useEffect(() => {
...
let e = !1,
  t = null;
return (async () => {
  A && k === ej.WtW.VIDEO && (t = await eC.ZP.blockDisplaySleep(), e && null != t && eC.ZP.unblockDisplaySleep(t));
})(), () => {

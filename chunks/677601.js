...
this.currentDocument.addEventListener(eI.NO, this.handleFullScreenChange), ep.default.track(eL.rMx.VIDEO_LAYOUT_TOGGLED, {
...
} = this.props, C = p === eL.AEg.MINIMUM, g = C || p === eL.AEg.NORMAL, I = a && l === eL.WtW.VIDEO, x = (null !== (t = null == E ? void 0 : E.length) && void 0 !== t ? t : 0) > 0 && h.isPrivate();
...
let {
  ...
  resizedHeight: d
} = this.state, h = a === eL.WtW.VIDEO, m = e !== eL.AEg.NO_CHAT && e !== eL.AEg.FULL_SCREEN && null != c;
return (0, i.jsxs)('div', {
...
super(...e), ey(this, '_prevLayout', eL.AEg.MINIMUM), ey(this, '_wrapperRef', a.createRef()), ey(this, '_callContainerRef', a.createRef()), ey(this, '_channelChatRef', a.createRef()), ey(this, '_contentRef', a.createRef()), ey(this, '_videoBackgroundTooltipTimeout', new d.V7()), ey(this, '_lastIdleProps', null), ey(this, 'state', {
  ...
  i !== e && (p.Z.updateLayout(t.id, e, n), e === eL.AEg.FULL_SCREEN && t.isPrivate() && ef.S.dispatch(eL.CkL.TEXTAREA_BLUR));
  ...
  })), s && l === eL.WtW.VIDEO && ((null == i ? void 0 : i.id) === e.id ? p.Z.selectParticipant(n.id, null) : p.Z.selectParticipant(n.id, e.id));
  ...
  let d = e === eL.AEg.NO_CHAT ? q.Z.Directions.UP : q.Z.Directions.DOWN,
    ...
    p = u.some(e => e.type === ej.fO.STREAM),
...
ref: f
  } = (0, x.Z)(), E = (0, v.bp)(), g = (0, O.Z)(), M = (0, c.e7)([eu.Z], () => {
var e;
...
selectedStream: null != F ? ei.Z.getActiveStreamForStreamKey(F.id) : null
  }), [F]), Y = (0, c.e7)([er.Z], () => er.Z.getGuild(n.getGuildId())), K = (0, c.e7)([el.Z], () => el.Z.getCall(n.id), [n.id]), q = (0, c.e7)([ec.ZP], () => ec.ZP.getMentionCount(n.id), [n.id]), X = (0, c.e7)([ea.default], () => ea.default.getId()), {
popoutWindow: Q,
...
popoutWindowAlwaysOnTop: w.Z.getIsAlwaysOnTop(eL.KJ3.CHANNEL_CALL_POPOUT)
  })), $ = (0, c.e7)([eo.Z], () => eo.Z.can(eL.Plq.CONNECT, n)), ee = (0, c.e7)([es.Z], () => es.Z.getToastsEnabled(n.id)), et = (0, c.e7)([P.Z], () => P.Z.getAwaitingRemoteSessionInfo()), en = (0, c.e7)([H.ZP], () => H.ZP.callHeaderHeight), ed = a.useCallback(e => {
C.ZP.updatedUnsyncedSettings({
  callHeaderHeight: e
});
  }, []), eh = null !== (t = null == Y ? void 0 : Y.id) && void 0 !== t ? t : null, em = (0, Z.Z)(eh, n.id), ep = (0, c.e7)([N.Z], () => N.Z.getFetchState(), []), e_ = (0, T.Z)(ep);
  a.useEffect(() => {
'errored' === ep && 'errored' !== e_ && (0, h.showToast)((0, h.createToast)(eP.Z.Messages.EMBEDDED_ACTIVITIES_DEVELOPER_ACTIVITY_SHELF_FETCH_ERROR, h.ToastType.FAILURE));
  }, [
ep,
e_
  ]);
  ...
  a.useEffect(() => {
M && !R && null != ef && p.Z.selectParticipant(n.id, ef.applicationId);
  }, [
M,
R,
ef,

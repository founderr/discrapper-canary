...
class ew extends l.PureComponent {
    ...
    componentDidUpdate(e) {
        let { participantsOpen: t, inCall: n, mode: i, layout: l } = this.props,
            a = this.getRootNode();
        if ((null != a && e.mode === eM.WtW.VIDEO && i === eM.WtW.VOICE && (0, e_.rB)(a, this.currentDocument) && (0, e_.Pr)(a, this.currentDocument), e.participantsOpen !== t || l !== e.layout)) {
            var r;
    ...
    get nativePopoutSupported() {
        return ex.isPlatformEmbedded && ev.ZP.supportsFeature(eM.eRX.POPOUT_WINDOWS);
    }
    get popoutSupported() {
    ...
    get viewProperties() {
        let { layout: e, mode: t, channel: n, inCall: i } = this.props,
            ...
            a = t === eM.WtW.VIDEO && i && this.popoutSupported,
            r = t !== eM.WtW.VOICE && n.isPrivate() && !this.inPopout && i,
        ...
        return (0, i.jsxs)('div', {
            ...
            children: [
                (0, i.jsx)(h.ThemeProvider, {
                    ...
                    children: (e) =>
                        (0, i.jsx)('div', {
                            className: r()(eL.callContainer, e),
                            ref: (e) => {
    ...
    constructor(...e) {
        super(...e),
            ...
            ek(this, 'handleFullScreenChange', () => {
                ...
                null != e && !(0, e_.rB)(e, this.currentDocument) && this.props.layout === eM.AEg.FULL_SCREEN && this.handleFullScreen();
            }),
            ek(this, 'handleFullScreen', () => {
                let e = this.getRootNode();
                null != e && (this.props.layout !== eM.AEg.FULL_SCREEN ? ((this._prevLayout = this.props.layout), this.handleChangeLayout(eM.AEg.FULL_SCREEN), (0, e_.Dj)(e)) : this.maybeLeaveFullScreen());
            }),
            ek(this, 'maybeLeaveFullScreen', () => {
                let e = this.getRootNode();
                if (null != e) this.props.layout === eM.AEg.FULL_SCREEN && (this.handleChangeLayout(this._prevLayout), (0, e_.Pr)(e, this.currentDocument));
            }),
            ...
            ek(this, 'handleSelectParticipant', (e, t) => {
                ...
                (0, eP._5)(e) && (0, B.p9)(n, em.Z, ec.Z, ed.Z, k.Z)[0] && (g.default.selectVoiceChannel(n.id), 0 === l.filter((t) => (0, w.V9)(t) === e.id && t.state !== eM.jm8.ENDED).length && (0, C.rn)((0, w.my)(e.id), { forceMultiple: t.shiftKey })), a && r === eM.WtW.VIDEO && ((null == i ? void 0 : i.id) === e.id ? m.Z.selectParticipant(n.id, null) : m.Z.selectParticipant(n.id, e.id));
            }),
            ...
            ek(this, 'renderRegionSelect', () => {
                ...
                return (
                    !this.inPopout && l !== eM.AEg.FULL_SCREEN && null != t && !n.isManaged() && (e = (0, i.jsx)(v.Z, { call: t })),
                    (0, i.jsx)(R.Z, {
                        ...
                        ((null == s ? void 0 : s.type) !== eP.fO.STREAM && (null == s ? void 0 : s.type) !== eP.fO.ACTIVITY) || o
                            ...
                            : (0, i.jsx)(Y.Z, {
                                  children: (0, i.jsx)(eT.Z, {
                                      className: r()(eL.leftTrayIcon, eL.viewersButton),
                                      participant: s,
                                      maxVisibleUsers: 4,
...
t.Z = function (e) {
    ...
    let { channel: n, renderExternalHeader: a, maxHeight: r } = e,
        ...
        U = (0, c.Wu)([ea.Z], () => ea.Z.getAllActiveStreams()),
        { selectedStream: G } = (0, c.cj)([ea.Z], () => ({ selectedStream: null != B ? ea.Z.getActiveStreamForStreamKey(B.id) : null }), [B]),
    ...
    l.useEffect(() => {
        ...
        return (
            (async () => {
                v && M === eM.WtW.VIDEO && ((t = await ev.ZP.blockDisplaySleep()), e && null != t && ev.ZP.unblockDisplaySleep(t));
            })(),
            () => {

...
class eU extends a.PureComponent {
  ...
  constructor(...e) {
    super(...e), ey(this, "_prevLayout", eL.AEg.MINIMUM), ey(this, "_wrapperRef", a.createRef()), ey(this, "_callContainerRef", a.createRef()), ey(this, "_channelChatRef", a.createRef()), ey(this, "_contentRef", a.createRef()), ey(this, "_videoBackgroundTooltipTimeout", new d.V7), ey(this, "_lastIdleProps", null), ey(this, "state", {
      ...
      let e = this.getRootNode();
      if (null != e) this.props.layout === eL.AEg.FULL_SCREEN && (this.handleChangeLayout(this._prevLayout), (0, eI.Pr)(e, this.currentDocument))
      ...
      return (0, i.jsxs)(i.Fragment, {
        ...
        }) : null, (null == r ? void 0 : r.type) !== ej.fO.STREAM && (null == r ? void 0 : r.type) !== ej.fO.ACTIVITY || o ? null : (0, i.jsx)(z.Z, {
      ...
      return (0, i.jsxs)(i.Fragment, {
        children: [null != a && a.type !== ej.fO.ACTIVITY && a.user.id !== n ? (0, i.jsx)(et.Z, {
...
t.Z = function(e) {
  ...
  }, [E, n.id]), W = (0, c.Wu)([ei.Z], () => ei.Z.getAllActiveStreams()), {
    selectedStream: z
  } = (0, c.cj)([ei.Z], () => ({

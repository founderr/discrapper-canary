...
this.currentDocument.addEventListener(eC.NO, this.handleFullScreenChange), ep.default.track(ej.rMx.VIDEO_LAYOUT_TOGGLED, {
...
} = this.props, g = m === ej.AEg.MINIMUM, C = g || m === ej.AEg.NORMAL, I = a && l === ej.WtW.VIDEO, x = (null !== (t = null == E ? void 0 : E.length) && void 0 !== t ? t : 0) > 0 && h.isPrivate();
...
let {
  ...
  resizedHeight: d
} = this.state, h = a === ej.WtW.VIDEO, p = e !== ej.AEg.NO_CHAT && e !== ej.AEg.FULL_SCREEN && null != c;
return (0, i.jsxs)('div', {
...
super(...e), eO(this, '_prevLayout', ej.AEg.MINIMUM), eO(this, '_wrapperRef', a.createRef()), eO(this, '_callContainerRef', a.createRef()), eO(this, '_channelChatRef', a.createRef()), eO(this, '_contentRef', a.createRef()), eO(this, '_videoBackgroundTooltipTimeout', new d.V7()), eO(this, '_lastIdleProps', null), eO(this, 'state', {
  ...
  let e = this.getRootNode();
  if (null != e)
    this.props.layout === ej.AEg.FULL_SCREEN && (this.handleChangeLayout(this._prevLayout), (0, eC.Pr)(e, this.currentDocument));
  ...
  i !== e && (m.Z.updateLayout(t.id, e, n), e === ej.AEg.FULL_SCREEN && t.isPrivate() && e_.S.dispatch(ej.CkL.TEXTAREA_BLUR));
  ...
  })), s && l === ej.WtW.VIDEO && ((null == i ? void 0 : i.id) === e.id ? m.Z.selectParticipant(n.id, null) : m.Z.selectParticipant(n.id, e.id));
  ...
  return !this.inPopout && a !== ej.AEg.FULL_SCREEN && null != t && !n.isManaged() && (e = (0, i.jsx)(C.Z, {
    call: t
  })), (0, i.jsx)(j.Z, {
...
ref: f
  } = (0, x.Z)(), E = (0, N.bp)(), C = (0, O.Z)(), A = (0, c.e7)([eu.Z], () => {
var e;
...
g.ZP.updatedUnsyncedSettings({
  ...
  }, []), ed = null !== (t = null == z ? void 0 : z.id) && void 0 !== t ? t : null, eh = (0, Z.Z)(ed, n.id), ep = (0, c.e7)([v.Z], () => v.Z.getFetchState(), []), em = (0, T.Z)(ep);
  a.useEffect(() => {

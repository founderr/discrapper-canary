...
function d(e) {
    ...
    let A = (0, r.e7)([a.default], () => a.default.getUser(e.author_id)),
        { activity: N, activityApplication: O, fallbackApplication: v } = (0, u.qy)(e),
        R = (0, o.wh)('useRichActivityDataForEntry'),
        { coverImageUrl: C } = (0, i.$)(null === (t = null != v ? v : O) || void 0 === t ? void 0 : t.id),
        y = null !== (f = null === (n = null != v ? v : O) || void 0 === n ? void 0 : n.getIconURL(c.Si.LARGE)) && void 0 !== f ? f : void 0;
    if (!R || null == N)
        return {
            isRich: !1,
            richIcon: void 0,
    ...
    let D = null !== (h = null === (d = N.assets) || void 0 === d ? void 0 : d.large_image) && void 0 !== h ? h : null === (_ = N.assets) || void 0 === _ ? void 0 : _.small_image,
        L = null != O && null != D ? (0, s.getAssetImage)(O.id, D, [c.Si.LARGE, c.Si.LARGE]) : void 0;

...
function l(e) {
    ...
    let d = (0, r.e7)([i.default], () => i.default.getUser(e.author_id)),
        ...
        h = (0, a.wh)('useRichActivityDataForEntry');
    if (!h || null == f)
        return {
            isRich: !1,
    ...
    let p = (null === (t = f.assets) || void 0 === t ? void 0 : t.large_image) != null || (null === (n = f.assets) || void 0 === n ? void 0 : n.small_image) != null,
        ...
        I = f.party;
    return {
        isRich: p || m || null != E || null != v || null != I,
        user: d,
        activity: f,
        state: v,
        details: E,

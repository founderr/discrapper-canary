s(47120), s(724458);
var n = s(735250), l = s(470079), a = s(120356), i = s.n(a), r = s(442837), o = s(481060), d = s(668781), c = s(493683), u = s(787014), h = s(741361), m = s(911969), g = s(134433), E = s(156699), T = s(693196), p = s(434404), N = s(200498), _ = s(146085), S = s(192079), x = s(277053), f = s(271383), C = s(430824), I = s(496675), M = s(594174), R = s(467679), Z = s(285952), v = s(474333), O = s(903386), A = s(700785), L = s(605436), b = s(27544), j = s(415236), D = s(182905), y = s(71080), w = s(981631), P = s(231338), F = s(689938), B = s(193920);
function U(e) {
    let {
        channel: t,
        roles: s,
    ...
    return (0, n.jsx)(o.List, {
                        ...
                        children: (0, n.jsx)(o.Clickable, {
                            onClick: () => {
                                ...
                                return f && null != E && (e = E.id, s = E.name, n = E.rowType, void d.Z.show({
                                    ...
                                    body: F.Z.Messages.SETTINGS_PERMISSIONS_DELETE_BODY.format({ name: s }),
                            ...
                            children: (0, n.jsx)(o.CircleXIcon, {
                                size: 'md',
                                color: 'currentColor',
                                className: i()(B.removeIcon, { [B.disabledRemoveIcon]: S || a })
                            })
                        })
                    })
                ]
        ...
        renderSection: function (e) {
            ...
            switch (t) {
            case y.m$.ROLES:
                return (0, n.jsx)(k, { title: F.Z.Messages.ROLES }, 'roles-title');
            case y.m$.MEMBERS:
                return (0, n.jsx)(k, { title: F.Z.Messages.MEMBERS }, 'members-title');
            }
        },
        sectionHeight: 49
    });
...
function G(e) {
    ...
    async function g() {
        let e = l.accessPermissions, i = M.default.getCurrentUser();
...
t.Z = r.ZP.connectStores([
    ...
    let e;
    let t = x.Z.channel, s = x.Z.category, n = [], l = [], a = {}, i = !1;
    if (null != t) {
        ...
        if (null != a)
            (0, o.openModalLazy)(async () => {
                ...
                return t => (0, n.jsx)(e, {
                    ...
                    category: a,
                    onConfirm: async () => {
                        let {guild_id: e} = a, t = { ...a.permissionOverwrites };
                        null != e && null == t[e] && (t[e] = A.we(e)), await (0, E.u)(i, t[e].deny, t[e].allow) && (0, u.wk)(i.id, { permissionOverwrites: Object.values(t) });
                    }
                });
            });
    }
    ...
    return i.isCategory() && (S.title = F.Z.Messages.CATEGORY_SETTINGS, S.subtitle = F.Z.Messages.CATEGORY_PERMISSIONS_SUBTITLE), (0, n.jsxs)(n.Fragment, {
        children: [
            ...
            null != a && t ? m ? (0, n.jsx)(D.Z, {
                canSync: !1,
                icon: o.RefreshIcon,
                noticeText: F.Z.Messages.CHANNEL_LOCKED_TO_CATEGORY.format({ categoryName: a.name })
            }) : (0, n.jsx)(D.Z, {
                buttonText: F.Z.Messages.SYNC_NOW,
                canSync: !0,
                icon: (0, o.makeIconCompat)(O.Z),
                noticeText: F.Z.Messages.PERMISSIONS_UNSYNCED.format({ categoryName: a.name }),
                onClick: _
            }) : null,

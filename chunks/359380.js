...
n.Z = e => {
  ...
  }, [_, null == C ? void 0 : C.interests]), I = r.useMemo(() => Array.from(T), [T]), E = r.useMemo(() => I.filter(e => c.gh.has(e)), [I]), b = r.useCallback(e => {
    f(new Set([...I.filter(e => !c.gh.has(e)), ...e]))
  }, [f, I]), N = r.useMemo(() => I.filter(e => c.WZ.has(e) || c.gh.has(e)), [I]), v = r.useCallback(e => {
    let n = new Set(T);
    n.delete(e), f(n)
  }, [f, T]);
  return (0, a.jsxs)("div", {

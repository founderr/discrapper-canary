...
function B(e) {
  ...
  }, [Y, J, n, z, X, Q]), ei = Object.values(s).length, ea = a.useMemo(() => {
    let e = ei > 100 ? D : r();
  ...
  }, [s, ei, V]), es = (0, c.e7)([R.Z], () => {
    if (null != n) return ea.find(e => R.Z.canShowOverviewTooltip(n.id, e.integration.id))
  }, [ea, n]), el = a.useMemo(() => void 0 !== es ? [es, ...ea.filter(e => e.integration.id !== es.integration.id)] : ea, [ea, es]), eo = (0, u.useModalsStore)(u.hasAnyModalOpenSelector), [er, ec] = a.useState(!1), ed = a.useRef(0), eu = () => {
  ...
  return en && eE.push(function(e, n, t) {
    ...
    children: [(0, i.jsx)(u.FormText, {
      ...
      children: [eE, J ? (0, i.jsxs)(i.Fragment, {
        children: [eE.length > 0 ? (0, i.jsx)(u.FormDivider, {
          className: v.divider

...
var i = t(735250), a = t(470079), s = t(442837), l = t(481060), o = t(668781), r = t(434404), c = t(590157), d = t(270144), u = t(288594), I = t(588822), m = t(496675), _ = t(285952), N = t(768581), E = t(709054), T = t(51144), h = t(486199), p = t(366598), g = t(125657), C = t(725875), f = t(981631), x = t(689938), O = t(653181);
function S(e) {
    let {
        application: n,
        guild: t,
    ...
    return (0, i.jsx)(l.ConfirmModal, {
        ...s,
        header: x.Z.Messages.INTEGRATIONS_APPLICATION_REMOVE_TITLE.format({ applicationName: n.name }),
        ...
        children: (0, i.jsx)(l.Text, {
            ...
            children: x.Z.Messages.INTEGRATIONS_APPLICATION_REMOVE_BODY.format({ applicationName: n.name })
        })
    });
}
function A(e) {
    ...
    let {
            ...
            let e = [{
                    icon: l.ClockIcon,
                    text: x.Z.Messages.INTEGRATION_ADDED_DATE.format({ timestamp: E.default.extractTimestamp(v.id) })
                }];
            return null != v.user && e.push({
                icon: l.UserIcon,
                text: x.Z.Messages.INTEGRATION_ADDED_USER.format({ user: T.ZP.getUserTag(v.user) })
            }), e;
        }, [
            v.id,
            v.user
            ...
            o,
            t
        ]), {applicationSubscriptionListingsShown: G} = (0, d.ZP)({
            applicationId: Z.id,

...
t.Z = (e) => {
    ...
    let n,
        r,
        { title: _, titleClassName: p, buttonClassName: h, perkImage: E, isCarousel: b, onCtaClick: x, perkComponent: C, subtitle: v = '', descriptionCta: T = '', cardVariant: N, subtitleClassName: I, imageOverlayText: S } = e,
        R = (0, o._)(N),
        A = (0, l.yQ)(),

    ...
    I0: function () {
        return function e(t) {
            ...
            if (i instanceof _.Sf) {
                var c;
                if (i.isScheduledForDeletion()) return S;
                if (_.Ec.has(i.type)) {
...
let S = a.vB(0),
    ...
    O = a.$e(T.Plq.VIEW_CHANNEL, T.Plq.SEND_MESSAGES, T.Plq.CONNECT, T.Plq.SPEAK, T.Plq.STREAM, T.Plq.USE_EMBEDDED_ACTIVITIES, T.Plq.USE_EXTERNAL_APPS, T.Plq.USE_EXTERNAL_EMOJIS, T.Plq.USE_EXTERNAL_SOUNDS, T.Plq.USE_EXTERNAL_STICKERS, T.Plq.USE_SOUNDBOARD, T.Plq.USE_VAD),
    R = a.$e(T.Plq.VIEW_CHANNEL, T.Plq.READ_MESSAGE_HISTORY),
    v = a.$e(T.Plq.VIEW_CHANNEL, T.Plq.READ_MESSAGE_HISTORY, T.Plq.CHANGE_NICKNAME),
...
function D(e, t, n, r) {
    ...
    if ((null != i && ((n = a.Od(n, i.deny)), (n = a.IH(n, i.allow))), null != t)) {
        ...
        (0, o.EY)(t) && !u && (n = a.hX(n, v)), (0, l.b)(t) && !u && (n = a.hX(n, R));
    }
    return n;
}
function y(e) {
    ...
    return (_ = a.e$(_, T.Plq.ADMINISTRATOR) ? g : D(r.id, n, _, i)), (c.Z.isLurking(r.id) || (null == n ? void 0 : n.isPending)) && (_ = a.hX(_, u)), h.ZP.isCurrentUserGuest(r.id) && (_ = a.hX(_, O)), L(_, r, t, o);
}
function b(e) {
    var t, n, r;
    let i,
    ...
    if (s instanceof _.Sf) {
        if (s.isScheduledForDeletion()) return S;
        if (_.Ec.has(s.type)) {
    ...
    if (null == i) return S;
    if (!(m === (null === (t = I.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && u.Z.isViewingRoles(i.id)) && i.isOwner(m)) return L(g, i, m, c);
...
function M(e, t, n) {
    return e.type !== T.d4z.PRIVATE_THREAD || n || a.e$(t, T.Plq.MANAGE_THREADS) ? (a.e$(t, T.Plq.SEND_MESSAGES_IN_THREADS) ? (e.isLockedThread() && !a.e$(t, T.Plq.MANAGE_THREADS) ? a.Od(t, T.Plq.SEND_MESSAGES) : a.$e(t, T.Plq.SEND_MESSAGES)) : a.Od(t, T.Plq.SEND_MESSAGES)) : S;
}
function P(e, t) {
...
function F(e, t) {
    ...
    if (t instanceof _.Sf) {
        if (t.type === T.d4z.PRIVATE_THREAD || (_.Ec.has(t.type) && null == (t = f.Z.getChannel(t.parent_id)))) return !1;

...
let N = s.vB(0),
  ...
  R = s.$e(A.Plq.VIEW_CHANNEL, A.Plq.READ_MESSAGE_HISTORY),
  p = s.$e(A.Plq.VIEW_CHANNEL, A.Plq.SEND_MESSAGES, A.Plq.CONNECT, A.Plq.SPEAK, A.Plq.STREAM, A.Plq.USE_EMBEDDED_ACTIVITIES, A.Plq.USE_EXTERNAL_APPS, A.Plq.USE_EXTERNAL_EMOJIS, A.Plq.USE_EXTERNAL_SOUNDS, A.Plq.USE_EXTERNAL_STICKERS, A.Plq.USE_SOUNDBOARD, A.Plq.USE_VAD),
...
function M(e) {
  ...
  return d = s.e$(d, A.Plq.ADMINISTRATOR) ? m : D(i.id, n, d, r), (_.Z.isLurking(i.id) || (null == n ? void 0 : n.isPending)) && (d = s.hX(d, u)), T.ZP.isCurrentUserGuest(i.id) && (d = s.hX(d, p)), L(d, i, t, a)
}

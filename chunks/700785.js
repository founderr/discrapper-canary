...
function D(e, t, n, i) {
  ...
  if (null != r && (n = s.remove(n, r.deny), n = s.add(n, r.allow)), null != t) {
    ...
    (0, o.hasAutomodQuarantinedProfile)(t) && !u && (n = s.filter(n, g)), (0, l.isMemberCommunicationDisabled)(t) && !u && (n = s.filter(n, R))
  }
  return n
}
...
function M(e) {
  ...
  return c = s.has(c, A.Permissions.ADMINISTRATOR) ? N : D(i.id, n, c, r), (d.default.isLurking(i.id) || (null == n ? void 0 : n.isPending)) && (c = s.filter(c, u)), T.default.isCurrentUserGuest(i.id) && (c = s.filter(c, C)), v(c, i, t, o)
}

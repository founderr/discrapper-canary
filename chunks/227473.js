...
function g() {
  ...
  return (0, a.jsxs)(o.FormSection, {
    ...
    children: [(0, a.jsx)(S.default, {
      ...
      let s = t.experiment.type === T.ExperimentTypes.GUILD ? N : h;
      return (0, a.jsx)(s, {
...
function h(e) {
  ...
  let {
    ...
    E(e => !e)
  }, []), N = (0, r.useStateFromStores)([u.default], () => u.default.getUserExperimentDescriptor(l)), I = (0, r.useStateFromStores)([u.default], () => u.default.getLoadedUserExperiment(l)), p = (0, r.useStateFromStores)([u.default], () => i.sortBy(u.default.getRecentExposures(T.ExperimentTypes.USER, l), e => {
    let [t, s] = e;
    return -s
  }).map(e => {
    let [t, s] = e;
    ...
    children: [(0, a.jsxs)(o.FormSection, {
      children: [C, (0, a.jsxs)("div", {
        ...
        children: [(0, a.jsxs)(o.FormText, {
          type: o.FormTextTypes.DESCRIPTION,
          children: ["Current assigned to bucket ", null !== (t = null == N ? void 0 : N.bucket) && void 0 !== t ? t : T.ExperimentBuckets.NOT_ELIGIBLE]
...
function N(e) {
  let {
    ...
    E(e => !e)
  }, []), N = (0, r.useStateFromStores)([u.default], () => u.default.getLoadedGuildExperiment(s)), I = (0, r.useStateFromStores)([u.default], () => i.sortBy(u.default.getRecentExposures(T.ExperimentTypes.GUILD, s), e => {
    let [t, s] = e;
    return -s
  }).map(e => {
    let [t, s] = e;

...
var r, i = n(470079), a = n(772848), o = n(324404);
function s(e, t, n) {
...
let l = (0, a.Z)(), u = new Map(), c = new Map();
class d extends (r = i.Component) {
    ...
    componentDidUpdate(e) {
        let t = this.getVisibilityObserver(), n = t.isVisible(this);
    ...
    getVisibilityObserver() {
        let e = this.getVisibilityObserverId(), t = c.get(e);
        if (!t)

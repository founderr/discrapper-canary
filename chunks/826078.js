a(47120);
var n = a(735250), l = a(470079), i = a(120356), r = a.n(i), o = a(392711), s = a(399606), u = a(84735), d = a(481060), c = a(393238), m = a(98650), p = a(451478), v = a(810090), f = a(917042), b = a(20437), h = a(356659), x = a(689938), g = a(625115);
function C(e) {
    ((e = Math.round(100 * e) / 100) < 0 || 0.01 > Math.abs(e)) && (e = 0);
    let t = Math.floor(e / 60), a = Math.floor(e % 60), n = Math.floor(e % 1 * 100);
    return t = t < 10 ? '0' + t : t, a = a < 10 ? '0' + a : a, n = n < 10 ? '0' + n : n, ''.concat(t, ':').concat(a, '.').concat(n);
}
function _(e) {
    let t = Math.floor(e / 60), a = x.Z.Messages.DURATION_MINUTES.format({ minutes: t }), n = x.Z.Messages.DURATION_SECONDS.format({ seconds: e % 60 });
...
t.Z = function (e) {
    ...
    l.useEffect(() => {
        var e;
        let t = null === (e = T.current) || void 0 === e ? void 0 : e.videoElement, a = A.current, n = F.current;
        if (null == t || null == a || null == n)
            return;
        let l = (0, o.debounce)(L, h.HW), i = () => {
    ...
    let Q = l.useRef(null), X = l.useRef({}), q = l.useCallback(e => {
            var t;
            ...
            if (null == U)
                return null;
            let l = ((0, o.clamp)(e, U.left, U.right) - U.left) / U.width * P, i = (0, o.clamp)(l, 0, P), r = R;
            ...
            if (null == a)
                return;
            let n = (0, f.Z)(a.duration, e.shiftKey), l = !1;
            switch (e.key) {
            case 'ArrowLeft':
                l = !0, q(y.start - n);
                break;
    ...
    l.useEffect(() => (document.addEventListener('mousemove', en), document.addEventListener('mouseup', el), () => {
        ...
        (async function e() {
            ...
            let l = Math.ceil(K * (a.videoWidth / a.videoHeight)), i = Math.ceil(G / l), r = Q.current;
            if (null == r)
                return;
    ...
    let ei = D - y.start, er = null === (i = T.current) || void 0 === i ? void 0 : i.videoElement;
    return (0, n.jsx)('div', {
                            ...
                            children: [
                                ...
                                (0, n.jsx)(u.t, {
                                    children: (0, n.jsx)('button', {
                                        className: r()(g.dragHandleLeft, { [g.dragging]: 'start' === R }),
                                        onMouseDown: ea,
                                        onKeyDown: ee,
                                        role: 'slider',
                                        tabIndex: 0,
                                        ...
                                        children: (0, n.jsx)('div', { className: g.cropLeftArrow })
                                    })
                                }),
                                (0, n.jsx)(u.t, {
                                    children: (0, n.jsx)('button', {
                                        className: r()(g.dragHandleRight, { [g.dragging]: 'end' === R }),
                                        onMouseDown: ea,
                                        onKeyDown: et,
                                        role: 'slider',
                                        tabIndex: 0,

...
let b = [],
    ...
    ee = [];
function et(e) {
    return Date.now() - M > 2 * N.Z.Millis.HOUR && e.length + y.length + j.length >= v.Lb;
}
function en(e, t, n, i) {
...
function ei() {
    (function () {
        let e = g.Z.getGuildIds(),
            t = [];
        for (let i of e) {
            if (null != H[i] && H[i] < 0) continue;
        ...
        let i = [],
            a = [];
        t.forEach((e) => {
            (w[e.id] = e), null != L.Z.getReadTimestamp(e.id) ? a.push(e) : i.push(e);
        }),
            (y = i),
        ...
        (function () {
            ...
            d.sort((e, t) => e.rank - t.rank),
                d.forEach((e) => {
                    ...
                    n.add(e.content.id), (w[t.id] = t), null != L.Z.getReadTimestamp(t.id) ? r.push(t) : s.push(t);
                }),
                (j = s),
...
function es(e) {
    ...
    if ((ei(), null != G.load_id && P !== G.load_id)) {
        var t;
...
function er(e) {
    ...
    return (
        e.forEach((e) => {
            let a = null != L.Z.getReadTimestamp(e.id);
            e.type === v.Rr.MESSAGE ? (a = a || !(0, Z.$U)(e.data.channel_id, e.data.message_id)) : e.type === v.Rr.SUMMARY && (a = a || !(0, Z.$U)(e.data.channel_id, e.data.summary_id)), a ? t.push(e) : e.type === v.Rr.MESSAGE && e.data.has_mention ? i.push(e) : n.push(e);
        }),
...
function el(e, t) {
    ...
    for (let a of e) {
        if (!(a.type === v.Rr.RECOMMENDED_GUILDS || i.has(a.id)) && null == L.Z.getReadTimestamp(a.id) && (a.type !== v.Rr.MESSAGE || (!!(0, Z.$U)(a.data.channel_id, a.data.message_id) && a.data.channel_id !== t)) && (a.type !== v.Rr.SUMMARY || (!!(0, Z.$U)(a.data.channel_id, a.data.summary_id) && a.data.channel_id !== t))) n.push(a);
    }
    return n;
}
function eo(e, t) {
...
function ec(e, t) {
    if ((0, Z.jv)(t) === Z.aL.MUTED) (b = eo(b, e)), (X = eo(X, e)), (J = eo(J, e)), (D = eo(D, e)), (U = eo(U, e));
}
function ed(e, t) {
    return e.filter((e) => (e.type !== v.Rr.MESSAGE && e.type !== v.Rr.SUMMARY && e.type !== v.Rr.GUILD_EVENT) || e.data.guild_id !== t);
}
function eu(e, t) {
    if ((0, Z.jv)(t) === Z.aL.MUTED) (b = ed(b, e)), (X = ed(X, e)), (J = ed(J, e)), (D = ed(D, e)), (U = ed(U, e));
}
function e_(e) {
...
function eh(e) {
    ...
    let a = W,
        [s, r] = er(D);
    if (((U = el(s, t)), (W = z ? a && U.length >= v.Lb : a && et(i)), 0 === n.length && a === W)) return !1;
    if (0 !== n.length) (X = i), (J = [...J, ...n]);
}
class eE extends (i = s.ZP.PersistedStore) {
    initialize(e) {
        if ((this.waitFor(p.Z, m.Z, T.ZP, d.Z, S.ZP, E.default, L.Z, l.Z), null != e)) {
            var t, n, i, a, s;
            (b = null !== (t = e.dehydratedItems) && void 0 !== t ? t : []).forEach((e) => {
                w[e.id] = e;
            }),
                (H = null !== (n = e.customGuildScores) && void 0 !== n ? n : {}),
                (V = null !== (i = e.customChannelScoresByGuild) && void 0 !== i ? i : {}),
                (Q = null !== (a = e.numOpens) && void 0 !== a ? a : 0),
                (M = null !== (s = e.lastOpened) && void 0 !== s ? s : 0);
        }
    }
    getVersion() {
        return F;
    ...
    getCustomChannelScore(e, t) {
        return null == V[e] || null == V[e][t] ? Z.aL.UNKNOWN : (0, Z.jv)(V[e][t]);
    }
    ...
    getState() {
        return {
            ...
            numOpens: Q,
            customGuildScores: H,
            customChannelScoresByGuild: V,
            lastOpened: M
        };
    }
}
x(eE, 'displayName', 'GravityStore'),
    x(eE, 'persistKey', 'GravityStore'),
    (t.Z = new eE(r.Z, {
        POST_CONNECTION_OPEN: function () {
            if (b.length > 0 && (!z || 0 === F)) {
                let [e, t] = er(b);
                (X = e), (J = t), ei(), ($ = 0), (0, Z.em)([...X, ...J], 0, v.xy);
            }
        },
        LOGOUT: function () {
            return !1;
            ...
            (D = t.filter((e) => v.zd.has(e.type))),
                !(function () {
                    ...
                    D.forEach((t) => {
                        ...
                        D.forEach((e) => {
                            (w[e.id] = e), e.type === v.Rr.CUSTOM_STATUS && (f.Z.isBlocked(e.data.user_id) ? (B[e.id] = !0) : (k[e.id] = (0, Z.mV)(e)));
                        });
                })(),
                (G = {
                    load_id: n,
        ...
        LOAD_GRAVITY_HYDRATED: function (e) {
            ...
            a.forEach((e) => {
                ...
                null != p.Z.getMessage(t.channel_id, t.message.id)
                    ? (k[t.message.id] = {
                          ...n,
                          message: p.Z.getMessage(t.channel_id, t.message.id)
                      })
                    : (k[t.message.id] = {
                          ...n,
        ...
        LOAD_GRAVITY_CUSTOM_SCORES: function (e) {
            let { scores: t } = e;
            for (let e of t) for (let t of ((H[e.guild_id] = e.guild_score), eu(e.guild_id, e.guild_score), Object.keys(e.custom_channel_scores))) null == V[e.guild_id] && (V[e.guild_id] = {}), (V[e.guild_id][t] = e.custom_channel_scores[t]), ec(t, e.custom_channel_scores[t]);
            (H = { ...H }), (V = { ...V });
        },
        LOAD_GRAVITY_RECOMMENDED_GUILDS: function (e) {
            let { guilds: t } = e;
            (ee = t.map((e) => new h.ZP((0, A.PP)(e.guild)))), ea();
        },
        GRAVITY_CUSTOM_SCORES_UPDATED: function (e) {
            let { channelScores: t, guildId: n, guildScore: i } = e;
            null != i && ((H[n] = i), eu(n, i), (H = { ...H })),
                null == t ||
                    t.forEach((e) => {
                        let { channelId: t, score: i } = e;
                        null == V[n] && (V[n] = {}), (V[n][t] = i), ec(t, i), (V = { ...V });
                    });
        },
        ...
        GRAVITY_TAB_OPENED: function () {
            (z = !0), (M = Date.now()), Y && ((Y = !1), (W = !1)), Q < 5 && Q++;
        },

...
function F() {
  ...
  if (null != C.load_id && g.length > 0) {
    ...
    }), p = null !== (t = C.load_id) && void 0 !== t ? t : null, C = {}
  }(0, N.em)([...V, ...Z], 0, S.xy)
}
...
function Y(e) {
  let t = [],
    n = [];
  return e.forEach(e => {
    let i = null != A.Z.getReadTimestamp(e.id);
    e.type === S.Rr.MESSAGE ? i = i || !(0, N.$U)(e.data.channel_id, e.data.message_id) : e.type === S.Rr.SUMMARY && (i = i || !(0, N.$U)(e.data.channel_id, e.data.summary_id)), i ? t.push(e) : n.push(e)
  }), [n, t.sort((e, t) => A.Z.compare(e.id, t.id))]
}
...
function W(e) {
  ...
  V = i.sort((e, t) => A.Z.compare(e.id, t.id)), Z = [...Z, ...n]
}
class K extends(i = o.ZP.PersistedStore) {
  initialize(e) {
    if (this.waitFor(d.Z, c.Z, E.ZP, l.Z, I.ZP, _.default, A.Z), this.syncWith([E.ZP], () => (function() {
        if (!(0, N.rK)("GravityStore-recomputeMentionStates")) return !1;
        R.forEach(e => {
      ...
      var t, n, i;
      R = null !== (t = e.dehydratedItems) && void 0 !== t ? t : [], v = null !== (n = e.locallyAddedItems) && void 0 !== n ? n : {}, k = null !== (i = e.numOpens) && void 0 !== i ? i : 0
    }
  }
  getVersion() {
    return w
  ...
  getMentionCount(e) {
    var t;
    return (0, N.rK)("GravityStore-getMentionCount") ? null !== (t = U[e]) && void 0 !== t ? t : 0 : 0
  }
  getMentionedGuilds() {
    return b
  }
...
O(K, "displayName", "GravityStore"), O(K, "persistKey", "GravityStore"), t.Z = new K(a.Z, {
  ...
  MESSAGE_CREATE: function(e) {
    ...
    if (!(0, N.rK)("GravityStore-handleMessageCreate") || null == i || (null === (t = n.author) || void 0 === t ? void 0 : t.id) === _.default.getId()) return !1;
  ...
  LOAD_GRAVITY_DEHYDRATED: function(e) {
    ...
    if (g = function(e) {
      ...
      if (g.length > 0 && (0 === R.length || R[0].id !== g[0].id)) {
        B = !0;
        let [e, t] = Y(g);
        V = e, Z = t, (0, N.em)([...V, ...Z], 0, S.xy)
      } else F()
    } else {
      let [e, t] = Y(g);
      (0, N.em)([...e, ...t], 0, S.xy)
  ...
  LOAD_GRAVITY_HYDRATED: function(e) {
    ...
    _.forEach(e => {
      ...
      let n = (0, N.wV)(e, t.data.guild_id);
  ...
  GRAVITY_CUSTOM_SCORES_UPDATED: function(e) {
    ...
    null != i && (P[n] = i, i < 0 && (R = R.filter(e => e.type === S.Rr.MESSAGE && e.data.guild_id !== n), V = V.filter(e => e.type === S.Rr.MESSAGE && e.data.guild_id !== n), Z = Z.filter(e => e.type === S.Rr.MESSAGE && e.data.guild_id !== n), g = g.filter(e => e.type === S.Rr.MESSAGE && e.data.guild_id !== n))), null == t || t.forEach(e => {
      let {
        channelId: t,
        score: i
      } = e;

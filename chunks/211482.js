...
r.inherits(l, u), t.ripemd160 = l, l.blockSize = 512, l.outSize = 160, l.hmacStrength = 192, l.padLength = 64, l.prototype._update = function(e, t) {
  for (var n = this.h[0], r = this.h[1], i = this.h[2], u = this.h[3], l = this.h[4], g = n, b = r, m = i, y = u, x = l, w = 0; w < 80; w++) {
    var S = s(o(c(n, d(w, r, i, u), e[f[w] + t], function(e) {
      if (e <= 15) return 0;
    ...
    n = l, l = u, u = o(i, 10), i = r, r = S, S = s(o(c(g, d(79 - w, b, m, y), e[p[w] + t], function(e) {
  ...
  S = a(this.h[1], i, y), this.h[1] = a(this.h[2], u, x), this.h[2] = a(this.h[3], l, g), this.h[3] = a(this.h[4], n, b), this.h[4] = a(this.h[0], r, m), this.h[0] = S

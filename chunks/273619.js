...
function N(e) {
  ...
  null != j && j instanceof d.BillingError && (j.code === E.ErrorCodes.CARD_DECLINED && y && (b += " ".concat(C.default.Messages.BILLING_ERROR_TRY_ANOTHER)), j.code === E.ErrorCodes.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED && (b = C.default.Messages.GIFT_CODE_SMITE_REJECT_HELP_TEXT), j.code === A.AbortCodes.BILLING_NON_REFUNDABLE_PAYMENT_SOURCE && (b = C.default.Messages.GIFT_CODE_PAYMENT_SOURCE_INVALID));
  let {
    stripe: B

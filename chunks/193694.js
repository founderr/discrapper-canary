...
function h(e) {
  let {
    className: t
  } = e, s = (0, d.useStateFromStores)([E.default], () => E.default.useReducedMotion), [a, n] = i.useState(!1), [r, h] = i.useState(0), [N, I] = i.useState(""), [p] = i.useState(new u.Timeout), [C, A] = i.useState((0, f.randomBetween)(5, 95)), O = function(e, t) {
    switch (e) {
      case 0:
    ...
    T.default.track(_.AnalyticEvents.EASTER_EGG_INTERACTED, {
      ...
      position: r
    }), r < 6 ? h(r + 1) : h(0), A((0, f.randomBetween)(5, 95))
  };
  return i.useEffect(() => {

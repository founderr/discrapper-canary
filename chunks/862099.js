...
function Z(e) {
  ...
  let {
    ...
    upcomingEvent: C,
    diffMinutes: _
  } = (0, F.getEventTimeData)(f.toISOString(), null == E ? void 0 : E.toISOString()), m = C ? _ > 0 ? W.default.Messages.STARTING_IN_MINUTES.format({
    minutes: _
...
function ee(e) {
  let {
    stageInstance: t,
    channel: n
  } = e, a = (0, r.useStateFromStoresArray)([h.default], () => [...new Set(h.default.getMutableParticipants(n.id, C.StageChannelParticipantNamedIndex.SPEAKER).map(e => e.user))], [n.id]), s = (0, r.useStateFromStores)([h.default], () => h.default.getParticipantCount(n.id, C.StageChannelParticipantNamedIndex.AUDIENCE), [n.id]), i = W.default.Messages.LISTENING_COUNT.format({
    count: "".concat(s)
  });
  return (0, l.jsx)(z, {
    onClickCloseIcon: () => (0, x.hideLiveChannelNotice)({
...
function et(e) {
  ...
  let C = t.hasFeature(Y.GuildFeatures.COMMUNITY) || t.hasFeature(Y.GuildFeatures.HUB);
  if (null == E && null != i && !C) {
    let {
      upcomingEvent: e,
      noticeType: t

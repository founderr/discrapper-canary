...
upcomingEvent: m,
diffMinutes: g
  } = (0, j.ub)(h.toISOString(), null == E ? void 0 : E.toISOString()), p = m ? g > 0 ? k.Z.Messages.STARTING_IN_MINUTES.format({
minutes: g
...
stageInstance: t,
channel: n
  } = e, i = (0, c.Wu)([g.Z], () => [...new Set(g.Z.getMutableParticipants(n.id, p.pV.SPEAKER).map(e => e.user))], [n.id]), s = (0, c.e7)([g.Z], () => g.Z.getParticipantCount(n.id, p.pV.AUDIENCE), [n.id]), r = k.Z.Messages.LISTENING_COUNT.format({
count: ''.concat(s)
  });
  return (0, a.jsx)(H, {
onClickCloseIcon: () => (0, O.ji)({
...
speakers: n,
voiceType: i
  } = e, s = t.getGuildId(), l = r.useMemo(() => n.slice(0, 3), [n]), _ = (0, c.e7)([C.Z], () => C.Z.can(w.Plq.CONNECT, t)), h = (0, S.Z)(t.id), E = k.Z.Messages.JOIN;
  switch (i) {
case 1:
  E = k.Z.Messages.JOIN;
  break;
...
showRedesignedLiveChannelNotice: n
  } = (0, h.o)(!0), i = (0, P.y)(t.id), s = (0, D.k5)(t.id), r = (0, D.Vm)(t.id), l = (0, c.e7)([f.Z], () => f.Z.getStageInstanceByChannel(null == i ? void 0 : i.id), [i]), {

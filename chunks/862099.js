...
function Q(e) {
  let {
    guildEvent: t,
    noticeType: n
  } = e, a = (0, B.getNextRecurrenceIdInEvent)(t), s = (0, r.useStateFromStores)([x.default], () => x.default.isInterestedInEventRecurrence(t.id, a), [t.id, a]), l = (0, r.useStateFromStores)([U.default], () => U.default.getUpcomingNoticeSeenTime(t.id), [t.id]);
  return !s && null == l && (0, D.markUpcomingEventNoticeAsSeen)(t.id), (0, i.jsxs)(o.Button, {
    fullWidth: !0,
...
function X(e) {
  ...
  return null == n ? null : (0, i.jsx)(z, {
    ...
    locationIcon: (0, i.jsx)(R.default, {
      width: 16,
      height: 16,
      className: K.stageIcon
    }),
...
function ee(e) {
  let {
    stageInstance: t,
    channel: n
  } = e, a = (0, r.useStateFromStoresArray)([h.default], () => [...new Set(h.default.getMutableParticipants(n.id, _.StageChannelParticipantNamedIndex.SPEAKER).map(e => e.user))], [n.id]), s = (0, r.useStateFromStores)([h.default], () => h.default.getParticipantCount(n.id, _.StageChannelParticipantNamedIndex.AUDIENCE), [n.id]), l = W.default.Messages.LISTENING_COUNT.format({
    count: "".concat(s)
  });
  return (0, i.jsx)(z, {
    onClickCloseIcon: () => (0, D.hideLiveChannelNotice)({
...
function et(e) {
  let {
    ...
    speakers: n,
    voiceType: a
  } = e, s = t.getGuildId(), u = l.useMemo(() => n.slice(0, 3), [n]), d = (0, r.useStateFromStores)([p.default], () => p.default.can(Y.Permissions.CONNECT, t)), c = (0, S.default)(t.id), f = W.default.Messages.JOIN;
  switch (a) {
    case 1:
  ...
  return null == s ? null : (0, i.jsxs)(i.Fragment, {
    ...
    }) : null, d && null == c && (0, i.jsx)($, {
      channel: t,
      label: f
    })]
  })
}(s = a || (a = {}))[s.VOICE = 1] = "VOICE", s[s.STAGE = 2] = "STAGE", s[s.STUDY_ROOM = 3] = "STUDY_ROOM", t.default = l.memo(function(e) {
  let {
    guild: t
  } = e, {
    showRedesignedLiveChannelNotice: n
  } = (0, d.useChannelNoticeRedesignExperiment)(!0), a = (0, G.useActiveEventOrStageInstanceChannel)(t.id), s = (0, w.useGuildActiveEvent)(t.id), l = (0, w.useGuildUpcomingEventsNotice)(t.id), o = (0, r.useStateFromStores)([m.default], () => m.default.getStageInstanceByChannel(null == a ? void 0 : a.id), [a]), {
  ...
  null == s || f ? h && (E = (0, i.jsx)(ee, {
    stageInstance: o,
    channel: a
  })) : s.entity_type === V.GuildScheduledEventEntityTypes.STAGE_INSTANCE && h ? E = (0, i.jsx)(ee, {
    stageInstance: o,
    channel: a
  }) : s.entity_type === V.GuildScheduledEventEntityTypes.EXTERNAL ? E = (0, i.jsx)(X, {
    guildEvent: s
  }) : s.entity_type === V.GuildScheduledEventEntityTypes.VOICE && null != a && (E = (0, i.jsx)(q, {
    guildEvent: s,
    channel: a
  }));

...
function Q(e) {
  let {
    guildEvent: t,
    noticeType: n
  } = e, a = (0, F.getNextRecurrenceIdInEvent)(t), s = (0, r.useStateFromStores)([x.default], () => x.default.isInterestedInEventRecurrence(t.id, a), [t.id, a]), l = (0, r.useStateFromStores)([U.default], () => U.default.getUpcomingNoticeSeenTime(t.id), [t.id]);
...
function et(e) {
  let {
    ...
    speakers: n,
    voiceType: a
  } = e, s = t.getGuildId(), u = l.useMemo(() => n.slice(0, 3), [n]), d = (0, r.useStateFromStores)([S.default], () => S.default.can(Y.Permissions.CONNECT, t)), c = (0, p.default)(t.id), f = W.default.Messages.JOIN;
  switch (a) {
    case 1:

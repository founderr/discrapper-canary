...
stageInstance: t,
channel: n
  } = e, i = (0, c.Wu)([g.Z], () => [...new Set(g.Z.getMutableParticipants(n.id, p.pV.SPEAKER).map(e => e.user))], [n.id]), a = (0, c.e7)([g.Z], () => g.Z.getParticipantCount(n.id, p.pV.AUDIENCE), [n.id]), r = k.Z.Messages.LISTENING_COUNT.format({
count: ''.concat(a)
  });
  return (0, s.jsx)(H, {
onClickCloseIcon: () => (0, O.ji)({
...
speakers: n,
voiceType: i
  } = e, a = t.getGuildId(), l = r.useMemo(() => n.slice(0, 3), [n]), _ = (0, c.e7)([C.Z], () => C.Z.can(w.Plq.CONNECT, t)), h = (0, f.Z)(t.id), E = k.Z.Messages.JOIN;
  switch (i) {
case 1:
  E = k.Z.Messages.JOIN;
  break;

...
function Q(e) {
  let {
    guildEvent: t,
    noticeType: a
  } = e, n = (0, B.getNextRecurrenceIdInEvent)(t), s = (0, r.useStateFromStores)([y.default], () => y.default.isInterestedInEventRecurrence(t.id, n), [t.id, n]), i = (0, r.useStateFromStores)([U.default], () => U.default.getUpcomingNoticeSeenTime(t.id), [t.id]);
...
function Z(e) {
  ...
  let {
    guildEvent: a,
    noticeType: n
  } = e, s = (0, F.getLocationFromEvent)(a), r = null != s ? (0, j.guildEventDetailsParser)(s, !0) : null, d = (0, F.getChannelFromEvent)(a), c = (0, u.getChannelIconComponent)(d), {
    startTime: f,
    endTime: E
  } = (0, w.default)(a.id), {
...
function X(e) {
  let {
    guildEvent: t
  } = e, a = (0, F.getLocationFromEvent)(t);

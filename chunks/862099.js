...
upcomingEvent: m,
diffMinutes: g
  } = (0, j.ub)(E.toISOString(), null == h ? void 0 : h.toISOString()), p = m ? g > 0 ? w.Z.Messages.STARTING_IN_MINUTES.format({
minutes: g
...
speakers: n,
voiceType: i
  } = e, a = t.getGuildId(), l = r.useMemo(() => n.slice(0, 3), [n]), _ = (0, c.e7)([C.Z], () => C.Z.can(k.Plq.CONNECT, t)), E = (0, S.Z)(t.id), h = w.Z.Messages.JOIN;
  switch (i) {
case 1:
  h = w.Z.Messages.JOIN;
  break;
...
showRedesignedLiveChannelNotice: n
  } = (0, E.o)(!0), i = (0, P.y)(t.id), a = (0, D.k5)(t.id), r = (0, D.Vm)(t.id), l = (0, c.e7)([f.Z], () => f.Z.getStageInstanceByChannel(null == i ? void 0 : i.id), [i]), {

...
t.length > 0 && (e.sdk = e.sdk || {}, e.sdk.integrations = [
  ...
  }(p, O), A && A.emit('applyFrameMetadata', t), void 0 === t.type && function(e, t) {
let r;
...
...D.eventProcessors
  ...
  return (0, c.R)(h, p, r).then(e => (e && function(e) {
let t = {};
try {
  e.exception.values.forEach(e => {
    e.stacktrace.frames.forEach(e => {
...
Object.entries(t).forEach(([e, t]) => {
  ...
  }(e), 'number' == typeof d && d > 0) ? function(e, t, r) {
if (!e)
  return null;
let n = {
  ...e,
  ...e.breadcrumbs && {
    breadcrumbs: e.breadcrumbs.map(e => ({
      ...e,
      ...e.data && {
        data: (0, _.Fv)(e.data, t, r)
      }
    }))
  },
  ...e.user && {
    user: (0, _.Fv)(e.user, t, r)
  },
  ...e.contexts && {
    contexts: (0, _.Fv)(e.contexts, t, r)
  },
  ...e.extra && {
    extra: (0, _.Fv)(e.extra, t, r)
  }
};
return e.contexts && e.contexts.trace && n.contexts && (n.contexts.trace = e.contexts.trace, e.contexts.trace.data && (n.contexts.trace.data = (0, _.Fv)(e.contexts.trace.data, t, r))), e.spans && (n.spans = e.spans.map(e => ({
  ...e,
  ...e.data && {
    data: (0, _.Fv)(e.data, t, r)
  }

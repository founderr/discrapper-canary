...
function l(e, t, r, l, A, T) {
    ...
    let L = A ? A.getEventProcessors() : [],
        S = (0, c.lW)().getScopeData();
    if (T) {
    ...
    let D = [...(r.attachments || []), ...S.attachments];
    D.length && (r.attachments = D), (0, u.gi)(O, S);
    let h = [...L, ...S.eventProcessors];
    return (0, s.R)(h, O, r).then((e) =>
        (e &&
            (function (e) {
                let t = {};
                try {

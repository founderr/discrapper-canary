...
function A(e) {
	...
	return (0, s.jsxs)('li', {
		className: r()(v.stepWrapper, { [v.stepWrapperComplete]: n }, { [v.stepWrapperWithNextStep]: o }),
		children: [
			(0, s.jsxs)('div', {
		...
		children: [
			(0, s.jsxs)('div', {
				...
				children: [
					...
					(0, s.jsx)(c.Clickable, {
						className: r()(v.microphoneUnitRefreshIconWrapper, { [v.disabled]: A }),
						onClick: () => j(),
						children: d.render()
					})
				]
			...
			(0, s.jsxs)('div', {
				...
				children: [b(), 0 === h.length ? null : (0, s.jsx)(N, { children: i })]
			})
		]
	});
}

                ...
                for (let i = 0; i < H.length; i++) {
                    ...
                    if (o <= R) n = o;
                        ...
                        let o = [],
                            ...
                            g = 0,
                            E = s + u >= R && s <= e;
                        for (null != f && (S || E) && o.push(f(i)), !E && !S && (n += u); m + u + p < l - h; ) {
                            let r = k(i, g, t),
                                a = s + m + u,
                                l = a + r;
                            if (l <= R) n = l - (S ? u : 0);

...
i.prototype.parse = function (e, t, n) {
    ...
    if (n || b || E.match(/^\/\/[^@/]+@[^@/]+/)) {
        var T = '//' === E.substr(0, 2);
        T && !(b && p[b]) && ((E = E.substr(2)), (this.slashes = !0));
    }
    if (!p[b] && (T || (b && !h[b]))) {
        for (var S, y, A = -1, N = 0; N < c.length; N++) {
            var C = E.indexOf(c[N]);
            -1 !== C && (-1 === A || C < A) && (A = C);
        }
        -1 !== (y = -1 === A ? E.lastIndexOf('@') : E.lastIndexOf('@', A)) && ((S = E.slice(0, y)), (E = E.slice(y + 1)), (this.auth = decodeURIComponent(S))), (A = -1);
...
(i.prototype.resolveObject = function (e) {
    ...
    if ((S && ((n.hostname = ''), (n.port = null), n.host && ('' === T[0] ? (T[0] = n.host) : T.unshift(n.host)), (n.host = ''), e.protocol && ((e.hostname = null), (e.port = null), e.host && ('' === _[0] ? (_[0] = e.host) : _.unshift(e.host)), (e.host = null)), (b = b && ('' === _[0] || '' === T[0]))), v)) (n.host = e.host || '' === e.host ? e.host : n.host), (n.hostname = e.hostname || '' === e.hostname ? e.hostname : n.hostname), (n.search = e.search), (n.query = e.query), (T = _);
    ...
    return (b = b || (n.host && T.length)) && !O && T.unshift(''), T.length > 0 ? (n.pathname = T.join('/')) : ((n.pathname = null), (n.path = null)), (null !== n.pathname || null !== n.search) && (n.path = (n.pathname ? n.pathname : '') + (n.search ? n.search : '')), (n.auth = e.auth || n.auth), (n.slashes = n.slashes || e.slashes), (n.href = n.format()), n;
}),

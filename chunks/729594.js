...
var a = /^([a-z0-9.+-]+:)/i, o = /:[0-9]*$/, s = /^(\/\/?(?!\/)[^?\s]*)(\?[^\s]*)?$/, l = ['\''].concat([
        '{',
        '}',
        '|',
        '\\',
        ...
        '?',
        '#'
    ], d = /^[+a-z0-9A-Z_-]{0,63}$/, _ = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, E = {
        javascript: !0,
        'javascript:': !0
    }, f = {
        javascript: !0,
...
i.prototype.parse = function (e, t, n) {
    ...
    var i = e.indexOf('?'), o = -1 !== i && i < e.indexOf('#') ? '?' : '#', m = e.split(o);
    m[0] = m[0].replace(/\\/g, '/');
    var I = e = m.join(o);
            ...
            for (var D = this.hostname.split(/\./), R = 0, L = D.length; R < L; R++) {
                ...
                if (!!b) {
                    if (!b.match(d)) {
                        ...
                        if (!M.match(d)) {
                            var w = D.slice(0, R), x = D.slice(R + 1), G = b.match(_);
    ...
    if (-1 !== Z ? (this.search = I.substr(Z), this.query = I.substr(Z + 1), t && (this.query = p.parse(this.query)), I = I.slice(0, Z)) : t && (this.search = '', this.query = {}), I && (this.pathname = I), h[S] && this.hostname && !this.pathname && (this.pathname = '/'), this.pathname || this.search) {
        var k = this.pathname || '', Y = this.search || '';
        this.path = k + Y;
    }
...
i.prototype.resolveObject = function (e) {
    ...
    if (e.protocol && e.protocol !== n.protocol) {
        ...
        if (n.search = e.search, n.query = e.query, n.host = e.host || '', n.auth = e.auth, n.hostname = e.hostname || e.host, n.port = e.port, n.pathname || n.search) {
            var p = n.pathname || '', m = n.search || '';
            n.path = p + m;
        }
        return n.slashes = n.slashes || e.slashes, n.href = n.format(), n;
    }
    var I = n.pathname && '/' === n.pathname.charAt(0), T = e.host || e.pathname && '/' === e.pathname.charAt(0), g = T || I || n.host && e.pathname, S = g, A = n.pathname && n.pathname.split('/') || [], E = e.pathname && e.pathname.split('/') || [], N = n.protocol && !h[n.protocol];

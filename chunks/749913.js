...
function er(e) {
  let {
    ...
    return s.useCallback(async (t, s, l) => {
      ...
      if (i(T ? (0, H.V_)() : null), o(I ? (0, H.T4)() : null), T || I) return {
        shouldClear: !1,
        shouldRefocus: !0
      };
      try {
  ...
  return s.useLayoutEffect(r, [u, d, T, r]), (0, a.jsx)(a.Fragment, {
    children: (0, a.jsx)("div", {
      "aria-label": i ? en.Z.Messages.NEW_FORUM_POST : en.Z.Messages.SEARCH,
      className: l()(ea.container, {
        [ea.collapsed]: !u
      }),
...
let el = s.memo(function(e) {
    ...
    }, [m, t.id, t.guild_id, r]), f = s.useMemo(() => {
      if (n && !l) return (0, a.jsx)(eC, {});
      if (!n && !l && (0 === o.textValue.trim().length || o.textValue.trim() === h)) return (0, a.jsx)(_.MagnifyingGlassIcon, {
        size: "md",
        color: "currentColor",
        className: ea.searchIcon
      });
      if (!l && (i.trim().length > 0 || o.textValue.trim().length > 0 && o.textValue.trim() !== h || y.Z.getUploads(t.id, L.d.FirstThreadMessage).length > 0) && d) return (0, a.jsx)(_.PencilIcon, {
        size: "md",
        color: "currentColor",
        className: ea.pencilIcon
      });
      else return u ? (0, a.jsx)(_.CircleXIcon, {
        size: "md",
        color: "currentColor",
  ...
  ei = s.memo(function(e) {
    ...
    return (0, a.jsxs)("div", {
      ...
      onPaste: I,
      children: [i && g ? (0, a.jsx)(_.Heading, {
...
let eh = s.memo(function(e) {
  let {
    ...
    rateLimitPerUser: c
  } = t, d = c > 0, u = (0, h.e7)([w.Z], () => w.Z.getSlowmodeCooldownGuess(t.id, w.S.CreateThread)), m = (0, h.e7)([P.Z], () => P.Z.can(ee.Plq.MANAGE_THREADS, t) || P.Z.can(ee.Plq.MANAGE_CHANNELS, t)), g = t.hasFlag(et.zZ.REQUIRE_TAG) && 0 === i.size && o.length > 0 && l.textValue.length > 0, x = (0, Y.AF)(), C = s.useCallback(() => {
    x.getState().setBodyFocused(!1)
  }, [x]), p = s.useMemo(() => "" !== o.trim() && "" !== l.textValue.trim(), [o, l.textValue]);
  return s.useEffect(() => {
...
function ex(e) {
  ...
  }, [T, f, g, x]), 0 === T.length) ? null : (0, a.jsx)(a.Fragment, {
    children: (0, a.jsxs)("div", {
      ...
      children: [(0, a.jsx)(_.TagIcon, {
        ...
        children: e => (0, a.jsxs)(_.Button, {
          ...
          children: [en.Z.Messages.FORUM_TAG_SEE_MORE_A11Y_LABEL, (0, a.jsx)(_.ChevronSmallDownIcon, {
            size: "custom",
            color: "currentColor",
            width: 16
          })]

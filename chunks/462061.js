...
streamId: w,
speaking: B
  } = t, H = U.id === k, G = (0, v.ZP)(t), V = (0, r.e7)([g.Z], () => g.Z.isFocused()), F = (0, r.e7)([m.Z], () => m.Z.getWindowFocused(N.KJ3.CHANNEL_CALL_POPOUT)), W = (0, r.e7)([C.Z], () => null != U.id && C.Z.isLocalVideoDisabled(U.id, (0, h.Z)(t.type)), [
U.id,
t.type

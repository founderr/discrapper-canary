...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(278074), l = n(442837), u = n(524437), c = n(481060), d = n(153867), _ = n(230711), E = n(351773), f = n(607070), h = n(100527), p = n(906732), m = n(639119), I = n(197115), T = n(587446), g = n(594174), S = n(626135), A = n(74538), N = n(238302), v = n(514361), O = n(572397), R = n(705262), C = n(981631), y = n(921944), D = n(474936), L = n(689938), b = n(219734);
let M = () => (0, r.jsx)('div', {
        ...
        let {markAsDismissed: t} = e, n = (0, O.q)();
        return (0, r.jsxs)('div', {
            className: b.editorHeader,
            children: [
                (0, r.jsx)(c.Clickable, {
        ...
        let {
                ...
                markAsDismissed: o
            } = e, {analyticsLocations: s} = (0, p.ZP)(h.Z.CLIENT_THEMES_EDITOR), [_, E] = (0, l.Wu)([
                g.default,
                v.Z
            ], () => [
                v.Z.gradientPreset,
        ...
        let {markAsDismissed: t} = e, {
            ...
            }).with({ isCoachmark: !0 }, { forceShowCloseButton: !0 }, () => L.Z.Messages.CLOSE).with({ isPreview: !0 }, () => L.Z.Messages.CLIENT_THEMES_EDITOR_EXIT_PREVIEW).otherwise(() => L.Z.Messages.CLIENT_THEMES_EDITOR_RETURN_TO_SETTINGS);
        return (0, r.jsxs)('div', {
...
function x(e) {
    let {markAsDismissed: t} = e, {analyticsLocations: n} = (0, p.ZP)(h.Z.CLIENT_THEMES_EDITOR), {
            isPreview: a,
            isCoachmark: s,
            isEditorOpen: u,
    ...
    i.useEffect(() => _(C.rMx.CLIENT_THEME_PREVIEW_VIEWED), [_]), i.useEffect(() => {
        if (!!a)
    ...
    let m = (0, O.J)(), I = (0, E.Z)(null, a ? m : C.dG4);
    return i.useEffect(() => {
        if (!!a && !u)
            return m;
    }, [
        ...
        children: (0, r.jsx)('div', {
            ...
            children: (0, r.jsxs)(c.HeadingLevel, {
                children: [
                    s ? (0, r.jsx)(M, {}) : (0, r.jsx)(P, { markAsDismissed: t }),
                    (0, r.jsx)(c.Scroller, {

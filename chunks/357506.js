...
class eh extends l.Component {
  ...
  componentDidMount() {
    S.default.startSession(), M.default.initialize(), _.default.initialize(), L.default.initialize()
  }
  ...
  componentWillUnmount() {
    window.removeEventListener("resize", this.handleWindowResize), window.removeEventListener("keydown", this.onKeyDownGlobal, !0), window.removeEventListener("keyup", this.onKeyUpGlobal, !0), this.props.locked && window.removeEventListener("contextmenu", ed, !1), M.default.terminate(), _.default.terminate(), L.default.terminate()
  }
...
function ep() {
  ...
  })), s = (0, p.useStateFromStores)([G.default], () => G.default.windowSize()), o = (0, p.useStateFromStores)([B.default], () => B.default.getOverlayKeybind()), r = (0, p.useStateFromStores)([w.default], () => w.default.getVoiceChannelId()), d = (0, p.useStateFromStores)([P.default], () => P.default.getChannel(r)), u = (0, p.useStateFromStores)([b.default], () => null != d ? b.default.getGuild(d.guild_id) : null), c = (0, p.useStateFromStores)([A.default, U.default], () => (0, R.default)(A.default, U.default)), f = (0, p.useStateFromStores)([k.default], () => (0, x.default)(k.default)), {
    canBroadcast: h
  } = O.default.useExperiment({
    location: "overlay"
  }, {
    autoTrackExposure: !1
  }), g = (0, C.default)() && null != c, m = (0, p.useStateFromStores)([D.default], () => null != D.default.getCurrentUserActiveStream()), {

...
class eh extends l.Component {
  handleLock() {
    !(0, E.hasAnyModalOpen)() && !F.default.isOpen() && S.default.setLocked(!0, (0, X.getPID)())
  }
  handleDeactivate() {
    S.default.deactivateAllRegions()
  }
  componentDidMount() {
    S.default.startSession(), R.default.initialize(), _.default.initialize(), M.default.initialize()
  }
  componentDidUpdate(e) {
    ...
    if (t) {
      ...
      if (!e.locked && this.props.locked) {
        ...
        y.default.disable(), this.activeKeyEventShapes = [], H.default.isPinned(el.OverlayWidgets.TEXT) && (y.default.setLayout(I.OVERLAY_LOCKED_LAYOUT), y.default.enable())
      } else e.locked && !this.props.locked && (window.removeEventListener("contextmenu", ed, !1), null == er && (er = Date.now(), S.default.track(el.AnalyticEvents.OVERLAY_UNLOCKED)), y.default.disable(), this.activeKeyEventShapes = [], y.default.setLayout(I.OVERLAY_LAYOUT), y.default.enable());
  ...
  initialSetup() {
    ...
    if (d ? h = {
        ...
        game: s
      }), S.default.overlayMounted(h), window.addEventListener("resize", this.handleWindowResize), t && window.addEventListener("contextmenu", ed, !1), W.isPlatformEmbedded) {
      ...
      void 0 !== e.setPerfInfoCallback && (e.setPerfInfoCallback(e => {
        ...
        H.default.getDisableExternalLinkAlert() || t === V.default.getLastURL() ? K.default.send("OPEN_EXTERNAL_URL", t) : g.default.show({
  ...
  componentWillUnmount() {
    window.removeEventListener("resize", this.handleWindowResize), window.removeEventListener("keydown", this.onKeyDownGlobal, !0), window.removeEventListener("keyup", this.onKeyUpGlobal, !0), this.props.locked && window.removeEventListener("contextmenu", ed, !1), R.default.terminate(), _.default.terminate(), M.default.terminate()
  }
  ...
  constructor(e) {
    ...
    y.default.setLayout(t ? I.OVERLAY_LOCKED_LAYOUT : I.OVERLAY_LAYOUT), t && y.default.enable()
  }
}
...
function ep() {
  ...
  })), s = (0, p.useStateFromStores)([G.default], () => G.default.windowSize()), o = (0, p.useStateFromStores)([B.default], () => B.default.getOverlayKeybind()), r = (0, p.useStateFromStores)([w.default], () => w.default.getVoiceChannelId()), d = (0, p.useStateFromStores)([j.default], () => j.default.getChannel(r)), u = (0, p.useStateFromStores)([P.default], () => null != d ? P.default.getGuild(d.guild_id) : null), c = (0, p.useStateFromStores)([k.default, U.default], () => (0, x.default)(k.default, U.default)), f = (0, p.useStateFromStores)([b.default], () => (0, A.default)(b.default)), {
    canBroadcast: h
  } = O.default.useExperiment({
    location: "overlay"
  }, {
    autoTrackExposure: !1
  }), g = (0, C.default)() && null != c, m = (0, p.useStateFromStores)([L.default], () => null != L.default.getCurrentUserActiveStream()), {

...
var i = n(735250), a = n(470079), s = n(481060), l = n(911969), r = n(689938), o = n(758183);
function c(e) {
    let {
            name: t,
            labelType: n,
            collapsed: c = !1,
            showTooltip: d = !1
        } = e, u = n === l.ww.NEW ? r.Z.Messages.NEW : r.Z.Messages.UPDATED, h = n === l.ww.NEW ? o.activityNewBadge : o.activityUpdatedBadge, [p, m] = a.useState(c ? '' : u);
    if (a.useEffect(() => {

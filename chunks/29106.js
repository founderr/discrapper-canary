...
function v(e) {
  let {
  ...
  }, [p, y, b, P]), k = null != s ? s : t, [H, U] = a.useMemo(() => {
    let e = {},
      t = {};
    ...
    if (0 !== t.length) {
      let e = t[0],
        n = v[e];
      if (n.type === u.ApplicationCommandPermissionType.USER) a = _.InvalidAction.REMOVE_SELF;
      else {
        let e = n.id;
        if (a = _.InvalidAction.REMOVE_ROLE, (0, f.isEveryoneRoleId)(p, e)) s = "@everyone";
        else {
      ...
      let t = Object.values(e)[0],
        l = t.id;
      if (a = _.InvalidAction.DENY_ROLE, (0, f.isEveryoneRoleId)(p, l)) s = "@everyone";
      else {
    ...
    return r.default.equals(t, c.DISABLED_BY_DEFAULT_PERMISSION_FLAG) && (t = C.Permissions.ADMINISTRATOR), l => (0, n.jsx)(e, {
      ...l,

...
class F extends P.ZP {
    ...
    render() {
        let {
            ...
            } = this.props, {shouldShowGuildVerificationPopout: N} = this.state, x = this.getVoiceStatesCount(), S = (0, i.jsxs)('li', {
    ...
    constructor(...e) {
        super(...e), H(this, 'state', { shouldShowGuildVerificationPopout: !1 }), H(this, 'closeGuildVerificationPopout', () => {
            ...
            null != l && (0, _.n)(l) && (0, p.hk)(l), i && this.setState({ shouldShowGuildVerificationPopout: !0 }), !t && !n && !e.isRoleSubscriptionTemplatePreviewChannel() && (0, C.Cq)(e), !__OVERLAY__ && (0, g.Kh)(e.id);
            ...
            let {channel: t} = this.props, l = T.Z.getGuild(t.getGuildId());
            if (null != l)
                (0, c.jW)(e, async () => {
            ...
            let {channel: e} = this.props, {shouldShowGuildVerificationPopout: t} = this.state;
            if (t)
                return (0, i.jsx)(m.Z, {
                    type: m.R.VOICE,
                    guildId: e.guild_id,
            ...
            return null == t ? null : (0, i.jsx)(y.Z, { children: t });
        });
    }
}
let W = (0, u.B)((0, d.Q)(F));
function Y(e) {
    let {
            ...
            let e = v.Z.getChannel(n.parent_id), i = L.Z.getCheck(n.guild_id);
            return {
        ...
        }), h = (0, a.e7)([Z.Z], () => Z.Z.isCollapsed(n.parent_id)), p = (0, S.ZP)(n.id), _ = (0, a.e7)([N.Z], () => N.Z.getStageInstanceByChannel(n.id), [n.id]), m = (0, I.Rk)(n.id, E.pV.AUDIENCE), {

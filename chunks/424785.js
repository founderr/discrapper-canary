...
function z(e) {
  let {
  ...
  }), f = (0, i.useStateFromStores)([A.default], () => A.default.isCollapsed(n.parent_id)), h = (0, T.default)(n.id), p = (0, i.useStateFromStores)([I.default], () => I.default.getStageInstanceByChannel(n.id), [n.id]), m = (0, _.useStageParticipantsCount)(n.id, S.StageChannelParticipantNamedIndex.AUDIENCE), {
    isSubscriptionGated: g,
    needSubscriptionToAccess: E
  } = (0, C.default)(n.id), v = (0, i.useStateFromStores)([y.default], () => y.default.isFavorite(t.id, n.id)), O = (0, N.getStageHasMedia)(n.id), D = (0, U.default)({
    channel: n,
    isChannelSelected: !1,
    ...
    isSubscriptionGated: g,
    needSubscriptionToAccess: E,
    enableConnectedUserLimit: O || n.userLimit > 0 && n.userLimit < F.MAX_STAGE_VOICE_USER_LIMIT

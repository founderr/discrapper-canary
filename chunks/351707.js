...
scrollToEnd: h.Cyb,
wrap: !0
  }), j = c.length, T = 0 === j ? S.Z.Messages.ROLE_LIST_EMPTY : S.Z.Messages.ROLES_LIST.format({
numRoles: j
  }), N = c.map(e => {
var l;
return (0, s.jsx)(E.Z, {
...
trackUserProfileAction: a
  } = (0, m.KZ)(), E = (0, r.e7)([u.ZP], () => u.ZP.getMember(t.id, i.id)), v = (0, r.e7)([I.Z], () => I.Z.getRoles(t.id)), Z = null == E ? void 0 : E.roles, g = l.useMemo(() => null == Z || 0 === Z.length ? [] : Object.values(v).filter(e => Z.includes(e.id)).sort((e, i) => {
var n, s;
...
let l = null !== (s = null == Z ? void 0 : Z.filter(i => i !== e.id)) && void 0 !== s ? s : [];

...
onAddRole: _,
onRemoveRole: m
  } = e, x = I && null != d, p = l.useMemo(() => 'roles-'.concat((0, t.Z)()), []), j = (0, o.ZP)({
id: p,
isEnabled: !0,
scrollToStart: Z.Cyb,
scrollToEnd: Z.Cyb,
wrap: !0
  }), T = c.length, g = 0 === T ? S.Z.Messages.ROLE_LIST_EMPTY : S.Z.Messages.ROLES_LIST.format({
numRoles: T
  }), N = c.map(e => {
var l;
return (0, n.jsx)(E.Z, {
...
trackUserProfileAction: a
  } = (0, m.KZ)(), E = (0, r.e7)([u.ZP], () => u.ZP.getMember(t.id, s.id)), v = (0, r.e7)([I.Z], () => I.Z.getRoles(t.id)), h = null == E ? void 0 : E.roles, j = l.useMemo(() => null == h || 0 === h.length ? [] : Object.values(v).filter(e => h.includes(e.id)).sort((e, s) => {
var i, n;
...
a
  ...
  return 0 !== j.length || A ? (0, n.jsx)(x.Z, {
title: S.Z.Messages.ROLES,
scrollIntoView: o,
children: (0, n.jsx)(p, {
  user: s,
  currentUser: i,

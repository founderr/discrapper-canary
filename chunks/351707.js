...
function A(e) {
  let {
    ...
    onAddRole: v,
    onRemoveRole: A
  } = e, x = (0, r.useStateFromStores)([f.default], () => f.default.getRoles(o.id)), U = a.useMemo(() => Object.values(x).filter(e => c.includes(e.id)).sort((e, t) => {
    var s, l;
    ...
    children: (0, l.jsx)(n.ListNavigatorContainer, {
      children: e => {
        ...
        return (0, l.jsxs)("div", {
          ...
          ref: t,
          ...s,
          children: [M, N && (0, l.jsx)(I.default, {
            guild: o,
            guildMember: d,
            highestRole: S,
            onAddRole: v,

...
onAddRole: I,
onRemoveRole: E
  } = e, x = _ && null != d, h = l.useMemo(() => 'roles-'.concat((0, t.Z)()), []), T = (0, o.ZP)({
id: h,
isEnabled: !0,
scrollToStart: v.Cyb,
scrollToEnd: v.Cyb,
...
return (0, i.jsx)(m.Z, {
  ...
  onRemove: () => E(e),
  canRemove: _ ? f.r6(a, n.id, u, e) : (null === (l = e.tags) || void 0 === l ? void 0 : l.guild_connections) === null && s.id === n.id
}, e.id);
  });
  return (0, i.jsx)(r.bG, {
navigator: T,
...
trackUserProfileAction: r
  } = (0, E.KZ)(), m = (0, a.e7)([u.ZP], () => u.ZP.getMember(t.id, s.id)), S = (0, a.e7)([_.Z], () => _.Z.getRoles(t.id)), p = null == m ? void 0 : m.roles, T = l.useMemo(() => null == p || 0 === p.length ? [] : Object.values(S).filter(e => p.includes(e.id)).sort((e, s) => {
var n, i;

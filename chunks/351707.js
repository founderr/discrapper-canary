...
function T(e) {
  ...
  }), d = null == o || 0 === o.length, S = v.getHighestRole(i, s.id), [A] = (0, r.useStateFromStoresArray)([m.default], () => [m.default.can(x.Permissions.MANAGE_ROLES, i), null != i ? m.default.getGuildVersion(i.id) : null]), T = a.useCallback(e => {
    var s, l;
    n({
      action: "REMOVE_ROLE"
    });

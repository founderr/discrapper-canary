...
var a = r(693598), n = r(692378), s = r(922474), o = r(319604), i = r(690094), c = r.n(i), u = r(417181), l = r.n(u), b = r(960465);
function f(e, t) {
    var r = Object.keys(e);
...
var h = o.default, p = Object.keys(h), y = function (e) {
        ...
        for (var r = arguments.length, n = Array(r > 2 ? r - 2 : 0), s = 2; s < r; s++)
            n[s - 2] = arguments[s];
        if (null === t)
            return e;
        !Array.isArray(t) && (t = [t]);
        var o = t.map(function (t) {
            ...
            return 'string' == typeof t ? e.className = [
                e.className,
                t
            ].filter(Boolean).join(' ') : 'object' === (0, a.Z)(t) ? e.style = d(d({}, e.style), t) : 'function' == typeof t && (e = d(d({}, e), t.apply(void 0, [e].concat(n)))), e;
        }, {
            className: '',
            style: {}
        });
        ...
        if (e && E(e) && e.extend && (e = e.extend), 'string' == typeof e) {
            var r = e.split(':'), a = (0, s.Z)(r, 2), n = a[0], i = a[1];
        ...
        if (e && E(e) && e.extend)
            return 'string' == typeof e.extend ? d(d({}, e), {}, { extend: ''.concat(e.extend, ':inverted') }) : d(d({}, e), {}, { extend: w(e.extend) });
        return e ? w(e) : e;
    };

...
var i = n(735250), a = n(470079), l = n(442837), s = n(904245), r = n(966390), o = n(902840), c = n(607070), d = n(367907), u = n(600084), h = n(62764), p = n(79712), m = n(736052), _ = n(359110), f = n(359119), E = n(13279), C = n(248789), g = n(88101), I = n(576954), x = n(280006), T = n(347102), v = n(765104), N = n(122707), S = n(779836), Z = n(23750), A = n(496675), M = n(306680), b = n(944486), R = n(594174), j = n(130208), L = n(55935), P = n(70956), O = n(709054), y = n(534091), D = n(900164), k = n(554838), U = n(481369), w = n(186877), B = n(294218), H = n(534469), G = n(993397), V = n(511010), F = n(524444), W = n(977391), z = n(921235), Y = n(97352), K = n(226027), q = n(959517), X = n(981631), Q = n(134612), J = n(689938);
function $(e) {
...
function et(e) {
    ...
    let n, a, {
            ...
            hideSummaries: ec
        } = e, ed = R.default.getCurrentUser(), eu = () => el.isInitialized() || j.ready, eh = (0, w.$)(r), ep = j.length > 0 && (null === (t = j.first()) || void 0 === t ? void 0 : t.isFirstMessageInForumPost(r)), em = (0, o.ts)(r), e_ = (0, l.e7)([v.Z], () => v.Z.shouldShowTopicsBar() && !ec), ef = (0, g.P)(r.id, Q.zr), eE = (0, E.z)(r.id, Q.zr), eC = (0, U.Z)(), eg = function (e, t) {
            return e.isDM() && null != t ? t.type === f.pj.STRANGER_DANGER ? (0, i.jsx)(I.M, {
                ...
                warningId: t.id,
                senderId: e.getRecipientId()
            }) : e.isGroupDM() && (0, x.f)({ location: 'blocked_user_banner' }) ? (0, i.jsx)(T.e, { channel: e }) : null;
        }(r, null != ef ? ef : eE), eI = r.isForumPost() && !ep ? (0, i.jsx)(h.Z, { postId: r.id }) : null, ex = (0, m.Z)(r.id);
    (0, Y.Z)();
    let eT = null, ev = [], eN = ei.map((e, t) => {
            ...
            let s = e.groupId === (null == eT ? void 0 : eT.groupId) ? eT.content.id : e.groupId, o = e.type === X.ys_.THREAD_STARTER_MESSAGE ? H.Ru : H.ZP;
            return (0, i.jsx)(o, {
                compact: en,
                channel: r,
                message: e.content,
    ...
    if ((!j.hasMoreBefore || null != er) && ev.unshift((0, i.jsx)(u.Z, {
            ...
            compact: en,
            ...es
        }, 'has-more-after')), !eo && eh && eu() && ev.push((0, i.jsx)(z.Z, { channel: r })), B > 0 && et && eu()) {
        let e, t;
        let a = M.ZP.getOldestUnreadTimestamp(r.id), l = 0 !== a ? a : O.default.extractTimestamp(r.id), s = (0, L.KC)(new Date(), new Date(l));
        if (M.ZP.isEstimated(r.id) ? (e = s ? J.Z.Messages.NEW_MESSAGES_ESTIMATED : J.Z.Messages.NEW_MESSAGES_ESTIMATED_WITH_DATE, t = J.Z.Messages.NEW_MESSAGES_ESTIMATED_SUMMARIES) : (e = s ? J.Z.Messages.NEW_MESSAGES : J.Z.Messages.NEW_MESSAGES_WITH_DATE, t = J.Z.Messages.NEW_MESSAGES_SUMMARIES), em && (0, o.tW)(r) && eC.includes(K.E.SUMMARIES)) {
            let a = M.ZP.ackMessageId(r.id), s = (0, N.q)(r.id, M.ZP.getOldestUnreadMessageId(r.id));
            if ((0, d.yw)(X.rMx.SUMMARIES_UNREAD_BAR_VIEWED, {
                ...
                let a = e_ ? t.format({ count: B }) : e.format({
                    count: B,
                    timestamp: l
                });
                if (e_) {
                    let e = s > 0 ? (0, i.jsxs)('div', {
                        ...
                        children: [
                            ...
                            J.Z.Messages.NEW_SUMMARIES.format({ count: s })
                        ]
                    }) : (0, i.jsx)('div', {
                        style: {
                            display: 'flex',

...
function $(e) {
  ...
  let ex = null,
    ...
    eN = en.map((e, t) => {
      ...
      if (e.type === K.ys_.FORUM_POST_ACTION_BAR) return (0, i.jsx)(h.Z, {
      ...
      if (null != es && es > e.content.timestamp.getTime() * j.Z.Millis.SECOND) return;
      let l = S.Z.can(K.Plq.CREATE_INSTANT_INVITE, b);
      if ((0, O.Z)(e.content, l)) return;
      e.type === K.ys_.MESSAGE && null == ex && (ex = e);
      let s = e.groupId === (null == ex ? void 0 : ex.groupId) ? ex.content.id : e.groupId,
  ...
  if ((!U.hasMoreBefore || null != es) && eT.unshift((0, i.jsx)(d.Z, {
      ...
      compact: et,
      ...el
    }, "has-more-after")), !er && ed && eu() && eT.push((0, i.jsx)(F.Z, {
      channel: b
    })), $ > 0 && ee && eu()) {
    let e, t;
    let n = Z.ZP.getOldestUnreadTimestamp(b.id),
      l = 0 !== n ? n : L.default.extractTimestamp(b.id),
      s = (0, R.KC)(new Date, new Date(l));
    if (Z.ZP.isEstimated(b.id) ? (e = s ? X.Z.Messages.NEW_MESSAGES_ESTIMATED : X.Z.Messages.NEW_MESSAGES_ESTIMATED_WITH_DATE, t = X.Z.Messages.NEW_MESSAGES_ESTIMATED_SUMMARIES) : (e = s ? X.Z.Messages.NEW_MESSAGES : X.Z.Messages.NEW_MESSAGES_WITH_DATE, t = X.Z.Messages.NEW_MESSAGES_SUMMARIES), ep && (0, o.tW)(b) && eE.includes(z.E.SUMMARIES)) {
      let n = Z.ZP.ackMessageId(b.id),
        s = (0, T.q)(b.id, Z.ZP.getOldestUnreadMessageId(b.id));
    ...
    } else eE.includes(z.E.NEW_MESSAGES) && (a = (0, i.jsx)(G.LE, {
      content: e.format({
        count: $,
        timestamp: l
      }),

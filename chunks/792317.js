var n = r(73009), i = r(837512), o = r(198392), a = r(310176), u = r(768784), s = r(379846), c = r(639256), l = r(563751), f = r(952616), p = r(121868), h = r(158971);
function d(t, e, r) {
...
t.exports = function (t, e) {
    ...
    if (!r.isRichText()) {
        var g = r.getFiles(), y = r.getText();
        if (g.length > 0) {
            if (t.props.handlePastedFiles && p(t.props.handlePastedFiles(g)))
                return;
            f(g, function (e) {
                if (!!(e = e || y)) {
                    var r = t._latestEditorState, o = h(e), f = i.create({
                            style: r.getCurrentInlineStyle(),
                            entity: l(r.getCurrentContent(), r.getSelection())
                        }), p = c.getCurrentBlockType(r), d = u.processText(o, f, p), g = n.createFromArray(d), v = a.replaceWithFragment(r.getCurrentContent(), r.getSelection(), g);
    ...
    var v = [], m = r.getText(), _ = r.getHTML(), b = t._latestEditorState;
    if (!(t.props.handlePastedText && p(t.props.handlePastedText(m, _, b)))) {
        if (m && (v = h(m)), !t.props.stripPastedStyles) {
            ...
            if (_) {
                ...
                if (w) {
                    var k = w.contentBlocks, x = w.entityMap;
                    if (k) {
        ...
        if (v.length) {
            var E = i.create({
                ...
                }), D = c.getCurrentBlockType(b), O = u.processText(v, E, D), K = n.createFromArray(O);

...
let y = a.memo(function(e) {
    ...
    let {
      ...
      if (!E && (0, I.markNotificationCenterItemAcked)(i), null != i.item_enum && i.item_enum === N.ItemEnum.FIND_FRIENDS) {
      ...
      if (null != i.deeplink) {
        ...
        _.default.track(M.AnalyticEvents.NOTIFICATION_CENTER_ACTION, {
          action_type: N.NotificationCenterActionTypes.CLICKED,
    ...
    i.type === N.NotificationCenterLocalItems.INCOMING_FRIEND_REQUESTS && null != i.other_user && (v = (0, s.jsx)(A.default, {
    ...
    return (0, s.jsxs)("div", {
      ...
      children: [(0, s.jsxs)(l.ClickableContainer, {
        ...
        children: [E ? null : (0, s.jsx)("div", {
          ...
          className: O.body,
          children: ["lifecycle_item" === i.type && null != i.item_enum && (0, s.jsx)(D, {
            item: i
          }), (0, s.jsx)(l.Text, {
            ...
            item: i
          }) : null, null != i.callout ? (0, s.jsx)(P, {
            item: i
          }) : null, (0, s.jsx)(l.Text, {
            variant: "text-xs/medium",
            color: E ? "text-muted" : "header-secondary",
            children: (0, p.getRelativeTimestamp)(T.default.extractTimestamp(i.id))
          }), v]
        })]

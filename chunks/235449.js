...
var a = t(470079), s = t(392711), l = t.n(s), r = t(442837), i = t(883429), o = t(592125), c = t(496675), d = t(306680), u = t(823379), h = t(709054), m = t(344185), g = t(920303), E = t(569471), f = t(346479), Z = t(91159), x = t(231338);
function T() {
    a.useEffect(() => {
        (0, Z.A_)();
    }, []);
...
function v(e) {
    let n = function (e) {
        ...
        }(e), [t, s] = (0, r.e7)([E.Z], () => l().partition(n, e => E.Z.hasJoined(e)), [n], r.pF);
    return {
        joinedThreadIds: t,
        unjoinedThreadIds: s
    };

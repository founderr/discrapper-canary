...
function v(e) {
  let n = function(e) {
      let n = (0, r.Wu)([c.Z, m.Z, o.Z], () => l()(m.Z.getThreadsForParent(e.guild_id, e.id)).values().map(e => {
        let {
          id: n
        } = e;
        return o.Z.getChannel(n)
      }).filter(u.lm).filter(e => c.Z.can(x.Pl.VIEW_CHANNEL, e)).map(e => e.id).value(), [e.guild_id, e.id]);
...
function _(e) {
  let n = (0, r.Wu)([c.Z, m.Z, o.Z], () => l()(m.Z.getThreadsForGuild(e)).values().map(e => l().values(e)).flatten().map(e => {
    let {
      id: n
    } = e;
    return o.Z.getChannel(n)
...
function R(e, n, t) {
  ...
  return a.useEffect(() => {
    ...
    threadIds: (0, r.Wu)([g.Z, o.Z, c.Z], () => l()(g.Z.getThreads(e.id, n, t)).filter(e => {

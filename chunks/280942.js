...
var n = s(735250);
s(470079);
var a = s(481060), i = s(230711), r = s(267642), o = s(981631), l = s(689938), c = s(257797);
function d(e) {
    let {
            guildBoostSlot: t,
            onClose: d,
    ...
    return (0, n.jsxs)(a.Menu, {
        ...
        children: [
            (0, n.jsx)(a.MenuItem, {
                ...
                action: function () {
                    (0, a.openModalLazy)(async () => {
                        let {default: e} = await Promise.resolve().then(s.bind(s, 760558));
                        return s => (0, n.jsx)(e, {
                            ...s,
                            guildBoostSlots: [t],
            ...
            (0, r.tl)(t) ? (0, n.jsx)(a.MenuItem, {
                ...
                action: function () {
                    (0, a.openModalLazy)(async () => {
                        let {default: e} = await Promise.resolve().then(s.bind(s, 450468));
                        return s => (0, n.jsx)(e, {
                            ...s,
                ...
                action: function () {
                    (0, a.openModalLazy)(async () => {
                        let {default: e} = await Promise.resolve().then(s.bind(s, 401786));
                        return s => (0, n.jsx)(e, {
                            ...s,
                            guildBoostSlot: t
                        });

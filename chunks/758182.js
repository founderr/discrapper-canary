...
async function Y(e, t, n) {
  ...
  let o = null !== (a = O.default.getGuildId()) && void 0 !== a ? a : null,
    ...
    k = performance.now() - f;
  if (b.verbose("cache loaded in ".concat(k, "ms (channel_history ").concat(R, "ms)")), null == y) return (0, x.default)("database:history_cache_null"), b.verbose("finished without dispatching CACHE_LOADED"), [!1, null, 0];
  {
    let a = Object.fromEntries(y.members.map(e => [e.userId, e])),
...
async function K(e, t) {
  ...
  let i = await (0, f.tryLoadAsync)(() => h.default.getOneAsync(e, s));
  return null != i ? [i] : []
}
...
async function q(e, t, n, a) {
  ...
  let [s, i, l] = await v.default.fetchLazyCache.measureAsync(() => Promise.all([(0, f.tryLoadAsync)(() => null != e ? r.default.timeAsync("\uD83D\uDCBE", "cache: cache_version", () => _.default.okAsync(e)) : Promise.resolve(!0)), (0, f.tryLoadAsync)(() => null == e || W ? Promise.resolve([]) : r.default.timeAsync("\uD83D\uDCBE", "cache: lazy guilds", () => h.default.getAsync(e))), (0, f.tryLoadAsync)(() => null != e ? r.default.timeAsync("\uD83D\uDCBE", "cache: basic_channels", () => E.default.getAsync(e)) : Promise.resolve({
    all: [],
    stale: [],
    channels: []
  ...
  Q(() => {
    ...
    if (null == s && (i.length > 0 || l.all.length > 0)) {
    ...
    v.default.deserializeCache.measure(() => (function(e) {
      ...
      null != e.channels && (0, P.default)(e.channels), null != e.privateChannels && (0, P.default)(e.privateChannels), null != e.guildChannels && (0, P.deserializeChannelEntries)(e.guildChannels)
    ...
    let E = u.reduce((e, t) => {
      ...
      C = l.channels.reduce((e, t) => {
        let [n, a] = t;
        return e + a.length
      }, 0),
      m = _ - C,
      S = 0 === l.stale.length ? "" : " \xb7 ".concat(l.stale.join(", "));
    b.verbose("lazy_cache_summary: (\n        ok: true\n        meta:\n          auth_user_id: ".concat(t, "\n          initial_guild: ").concat(n, "\n          database: ").concat(null != e, "\n            ok: ").concat(s, "\n            name: ").concat(null == e ? void 0 : e.name, "\n        data:\n          database:\n            guilds: ").concat(i.length, "\n            basic_channels:\n              total: ").concat(_, " (").concat(l.channels.length, " guilds)\n              stale: ").concat(m, " (").concat(l.stale.length, " guilds").concat(S, ")\n              unstale: ").concat(C, "\n            full_channels (guilds_with_stale_basic_channels):\n              total: ").concat(E, " (").concat(u.length, " guilds)\n      )")), v.default.setCacheInfo({
      guilds: i.length,
      privateChannels: a,
      basicChannels: _,
...
class Z extends(a = u.default.Store) {
  ...
  canWriteCaches(e) {
    return (0, y.isAuthenticated)() ? j ? (b.log("Not writing cache because caches cleared"), !1) : !!e || !!B || (b.log("Not writing cache because never connected"), !1) : (b.log("Not writing cache because not authenticated"), !1)
  }
  async loadCacheAsync(e, t) {
    ...
    try {
      let t = R.default.getId(),
        ...
        [s, i, l] = await v.default.loadMiniCache.measureAsync(() => Y(a, t, e));
      s ? (n(), await q(a, t, i, l)) : (n(), await (Q(() => c.default.dispatch({
        type: "CACHE_LOADED_LAZY_NO_CACHE"
      })), Promise.resolve()))
    } catch (e) {
...
l = "CacheStore", (i = "displayName") in(s = Z) ? Object.defineProperty(s, i, {
  value: l,
  enumerable: !0,
  configurable: !0,
  writable: !0
}) : s[i] = l, new Z(c.default, U ? {
  ...
  WRITE_CACHES: function() {
    b.verbose("Writing cache now"), k = Date.now(), w = !0, d.Storage.remove(D.CACHE_STORE_KEY), d.Storage.remove(D.CACHE_STORE_CHANNELS_LAZY_KEY), d.Storage.remove(D.CACHE_STORE_LAZY_KEY)
  }
} : {})
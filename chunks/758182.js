...
async function Y(e, t, n) {
  ...
  let o = null !== (a = L.default.getGuildId()) && void 0 !== a ? a : null,
    ...
    C = null != e ? r.default.timeAsync("\uD83D\uDCBE", "cache: private_channels", () => p.default.getAsync(e, null)) : Promise.resolve([]),
    m = null == e ? Promise.resolve({}) : r.default.timeAsync("\uD83D\uDCBE", "cache: user_settings", () => T.default.getAll(e)),
    ...
    [
      [O, P], M, y, x, U, j, G
    ] = await Promise.all([E, _, h, C, m, g, N]),
    w = performance.now() - f;
...
async function z(e, t) {
  ...
  let a = n;
  return {
    channels: await (0, f.tryLoadAsync)(() => p.default.getAsync(e, a)),
    guildId: n
  }
}
async function q(e, t, n, a) {
  ...
  let [s, l, i] = await R.default.fetchLazyCache.measureAsync(() => Promise.all([(0, f.tryLoadAsync)(() => null != e ? r.default.timeAsync("\uD83D\uDCBE", "cache: cache_version", () => h.default.okAsync(e)) : Promise.resolve(!0)), (0, f.tryLoadAsync)(() => null == e || W ? Promise.resolve([]) : r.default.timeAsync("\uD83D\uDCBE", "cache: lazy guilds", () => _.default.getAsync(e))), (0, f.tryLoadAsync)(() => null != e ? r.default.timeAsync("\uD83D\uDCBE", "cache: basic_channels", () => E.default.getAsync(e)) : Promise.resolve({
    ...
    var t, n;
    return t = e, n = i.stale, b.verbose("loading stale guild channels (count: ".concat(n.length, ", ids: ").concat(n.join(", "), ")")), Promise.all(n.map(e => p.default.getAsync(t, e).then(t => [e, t])))
  }) : Promise.resolve([]));

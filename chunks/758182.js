...
async function w(e, t, s) {
  ...
  {
    let n = await C.default.startupLoad(e, t, s, b.MAX_MESSAGES_PER_CHANNEL);
...
async function Q(e, t, s) {
  ...
  let o = null !== (a = O.default.getGuildId()) && void 0 !== a ? a : null,
    ...
    V = performance.now() - E;
  if (j.verbose("cache loaded in ".concat(V, "ms (channel_history ").concat(v, "ms)")), null == M) return (0, D.default)("database:history_cache_null"), j.verbose("finished without dispatching CACHE_LOADED"), [!1, null, 0];
  {

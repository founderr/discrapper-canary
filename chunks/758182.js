...
async function Y(e, t, n) {
  ...
  let o = null !== (a = L.default.getGuildId()) && void 0 !== a ? a : null,
    ...
    w = performance.now() - f;
  if (x.verbose("cache loaded in ".concat(w, "ms (channel_history ").concat(v, "ms)")), null == P) return (0, D.default)("database:history_cache_null"), x.verbose("finished without dispatching CACHE_LOADED"), [!1, null, 0];
  {
...
async function q(e, t, n, a) {
  ...
  Q(() => {
    ...
    })(f)), O.default.dispatchLazyCache.measure(() => c.default.dispatch(f)), x.verbose("late lazy cache loaded (ok: true, took: ".concat(performance.now() - r, "ms)")), d.addAnalytics({
...
function Q(e) {
  ...
  u.default.Emitter.batched(() => {
    try {
      ...
      n = !0, O.default.loadLazyCache.recordEnd(), x.verbose("Processing First Queued Dispatch"), t.dispatcher.processFirstQueuedDispatch(new Set(["READY", "INITIAL_GUILD"])), setTimeout(() => {
        x.verbose("Unpausing Dispatch Queue"), t.dispatcher.unpauseDispatchQueue()
      }, 100)
    } catch (e) {

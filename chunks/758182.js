...
class J extends (i = c.ZP.Store) {
    ...
    canWriteCaches(e) {
        return (0, j.$8)() ? (y ? (B.log('Not writing cache because caches cleared'), !1) : !!e || !!H || (B.log('Not writing cache because never connected'), !1)) : (B.log('Not writing cache because not authenticated'), !1);
    }

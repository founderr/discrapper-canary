...
n(724522);
var o = n(149765), c = n(442837), d = n(433517), _ = n(570140), u = n(86670), E = n(261375), T = n(17567), I = n(795513), R = n(685736), C = n(266750), p = n(768910), g = n(632093), A = n(347994), m = n(591526), N = n(261875), f = n(710845), S = n(38618), h = n(218543), M = n(314897), x = n(944486), O = n(914010), b = n(449934), P = n(576376), L = n(38217), v = n(864631), Z = n(981631);
let D = new f.Z('CacheStore'), B = !1, j = !1, U = 'initializing', G = 0, y = !1, H = !1, k = !1;
function w(e) {
...
async function V(e, t, n) {
    ...
    let i = S.Z.getSocket();
    i.connect();
    let o = null !== (s = O.Z.getGuildId()) && void 0 !== s ? s : null, d = null !== (a = x.Z.getChannelId()) && void 0 !== a ? a : null, u = performance.now(), E = h.Z.loadCachedMessages.measureAsyncWithoutNesting(() => F(e, o, d)), T = h.Z.fetchGuildCache.measureAsync(() => K(e, n)), I = h.Z.fetchGuildCache.measureAsync(() => Y(e, n)), R = null != e ? l.Z.timeAsync('\uD83D\uDCBE', 'cache: private_channels', () => m.Z.getAsync(e, null)) : Promise.resolve([]), C = null == e ? Promise.resolve({}) : l.Z.timeAsync('\uD83D\uDCBE', 'cache: user_settings', () => A.Z.getAll(e)), N = null == e ? Promise.resolve([]) : l.Z.timeAsync('\uD83D\uDCBE', 'cache: read_states', () => p.Z.getAll(e)), f = null == e ? Promise.resolve([]) : l.Z.timeAsync('\uD83D\uDCBE', 'cache: user_guild_settings', () => g.Z.getAll(e)), [[M, b], P, L, Z, B, j, U] = await Promise.all([
            E,
            T,
            I,
            R,
    ...
    if (D.verbose('cache loaded in '.concat(G, 'ms (channel_history ').concat(M, 'ms)')), null == b)
        return (0, v.Z)('database:history_cache_null'), D.verbose('finished without dispatching CACHE_LOADED'), [
            !1,
            null,
            0
        ];
    {
        let s = Object.fromEntries(b.members.map(e => [
                e.userId,
                e
            ])), a = null != L.guildId && null != L.channels, u = L.guildId;
        return c.ZP.Emitter.batched(() => {
            l.Z.time('\uD83D\uDCBE', 'Dispatch Mini Cache', () => {
                ...
                return _.Z.dispatch({
                    ...
                    users: [...b.users],
                    messages: null == b.channelId ? {} : { [b.channelId]: b.messages },
...
async function z(e, t, n, s) {
    ...
    let [a, r, i] = await h.Z.fetchLazyCache.measureAsync(() => Promise.all([
    ...
    Q(() => {
        ...
        if (H) {
            (0, v.Z)('already_connected'), D.log('Skipping lazy cache; already connected.'), _.Z.dispatch({ type: 'CACHE_LOADED_LAZY_NO_CACHE' });
            return;
        }
        ...
        }(u)), h.Z.dispatchLazyCache.measure(() => _.Z.dispatch(u)), D.verbose('late lazy cache loaded (ok: true, took: '.concat(performance.now() - l, 'ms)')), d.addAnalytics({ usedCacheAtStartup: !0 });
        let E = c.reduce((e, t) => {
                let [n, s] = t;
                return e + s.length;
            }, 0), T = c.length, I = i.all.reduce((e, t) => {
                let [n, s] = t;
                return e + s.length;
            }, 0), R = i.channels.reduce((e, t) => {
                let [n, s] = t;
                return e + s.length;
            }, 0), C = I - R, p = 0 === i.stale.length ? '' : ' \xB7 '.concat(i.stale.join(', '));
        D.verbose('lazy_cache_summary: (\n        ok: true\n        meta:\n          auth_user_id: '.concat(t, '\n          initial_guild: ').concat(n, '\n          database: ').concat(null != e, '\n            ok: ').concat(a, '\n            name: ').concat(null == e ? void 0 : e.name, '\n        data:\n          database:\n            guilds: ').concat(r.length, '\n            basic_channels:\n              total: ').concat(I, ' (').concat(i.channels.length, ' guilds)\n              stale: ').concat(C, ' (').concat(i.stale.length, ' guilds').concat(p, ')\n              unstale: ').concat(R, '\n            full_channels (guilds_with_stale_basic_channels):\n              total: ').concat(E, ' (').concat(c.length, ' guilds)\n      )')), h.Z.setCacheInfo({
            guilds: r.length,
            privateChannels: s,
            basicChannels: I,
...
function Q(e) {
    ...
    c.ZP.Emitter.batched(() => {
        try {
            ...
            n = !0, h.Z.loadLazyCache.recordEnd(), D.verbose('Processing First Queued Dispatch'), t.dispatcher.processFirstQueuedDispatch(new Set([
                'READY',
                'INITIAL_GUILD'
            ])), setTimeout(() => {
                D.verbose('Unpausing Dispatch Queue'), t.dispatcher.unpauseDispatchQueue();
...
class J extends (s = c.ZP.Store) {
    ...
    canWriteCaches(e) {
        return (0, b.$8)() ? j ? (D.log('Not writing cache because caches cleared'), !1) : !!e || !!k || (D.log('Not writing cache because never connected'), !1) : (D.log('Not writing cache because not authenticated'), !1);
    }
    async loadCacheAsync(e, t) {
        ...
        if ('initializing' !== U) {
            (0, v.Z)('cache:lazy_cache_not_initializing'), n(), setTimeout(() => {
                var e, t;
                return null === (t = S.Z.getSocket()) || void 0 === t ? void 0 : null === (e = t.dispatcher) || void 0 === e ? void 0 : e.unpauseDispatchQueue();
            }, 0);
            return;
        }
        try {
            let t = M.default.getId(), s = N.Z.carefullyOpenDatabase(t), [a, r, i] = await h.Z.loadMiniCache.measureAsync(() => V(s, t, e));
            a ? (n(), await z(s, t, r, i)) : (n(), await (Q(() => _.Z.dispatch({ type: 'CACHE_LOADED_LAZY_NO_CACHE' })), Promise.resolve()));
        } catch (e) {
...
i = 'CacheStore', (r = 'displayName') in (a = J) ? Object.defineProperty(a, r, {
    value: i,
    enumerable: !0,
    configurable: !0,
    writable: !0

let r, i;
n(47120), n(411104);
var a = n(570140), o = n(330516), s = n(710845), l = n(594174), u = n(436181), c = n(626135), d = n(358085), _ = n(998502), E = n(981631), f = n(186901);
...
t.Z = {
    init(e) {
        ...
        if (null == i)
            (null != r ? Promise.resolve(r) : (0, d.isDesktop)() ? Promise.all([
                _.ZP.ensureModule('discord_dispatch'),
                _.ZP.ensureModule('discord_modules')
            ]).then(() => {
    ...
    pause() {
        let e = p();
        if (null != e)
            e.command(JSON.stringify({ command: 'Pause' }), I);
    },
    resume() {
        let e = p();
        if (null != e)
            e.command(JSON.stringify({ command: 'Resume' }), I);
    },
    queryDirectory(e, t) {
        let n = p();
        if (null != n)
    ...
    runLaunchSetup: (e, t) => u.Z.isRunning() ? Promise.reject(Error('Already running launch setup.')) : (a.Z.dispatch({ type: 'DISPATCH_APPLICATION_LAUNCH_SETUP_START' }), new Promise((n, r) => {
        let i = p();
        if (null == i) {

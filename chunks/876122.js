...
let r = this._lastEventId = e && e.event_id ? e.event_id : (0, n.DM)(),
  _ = Error('Sentry syntheticException');
...
let _ = this._lastEventId = r && r.event_id ? r.event_id : (0, n.DM)(),
  a = Error(t);
...
return c && 'ok' === c.status && (0, s.CT)(c, {
  status: 'exited'
}), this.endSession(), e.setSession(E), E;
  }

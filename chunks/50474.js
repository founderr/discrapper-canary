...
function M(e) {
  let {
    ...
    onClose: A,
    transitionState: E
  } = e, [I, j] = n.useState(null), [N, P] = n.useState(!1), {
    originalApplicationPermissions: k,
    originalCommandPermissions: S,
    editedTargetPermissions: g,
    hasChanges: b,
    selectedPermissionCount: R
  } = (0, C.default)(M, s, u.id), O = n.useCallback(async () => {
    var e, i, o, n, t;
    if (!b) {
      A();
      return
    }
    let l = a().difference(Object.keys(null !== (o = u.permissions) && void 0 !== o ? o : {}), Object.keys(g)),
      d = a().omit({
        ...g
      }, l),
      C = (0, m.allChannelsSentinel)(M),
      f = (0, h.toPermissionKey)(M, c.ApplicationCommandPermissionType.ROLE),
      x = (0, h.toPermissionKey)(C, c.ApplicationCommandPermissionType.CHANNEL),
      y = null === (n = null === (e = k[f]) || void 0 === e ? void 0 : e.permission) || void 0 === n || n,
      v = null === (t = null === (i = k[x]) || void 0 === i ? void 0 : i.permission) || void 0 === t || t,
  ...
  n.useEffect(() => () => {
    p.resetPermissions(u.id), d.default.stopEditingCommandPermissions(u.id)
  }, [u.id]);
  let B = (0, h.commandName)(u.type, u.displayName);
  return (0, o.jsxs)(l.ModalRoot, {
    "aria-label": x.default.Messages.INTEGRATIONS_APPLICATION_COMMAND_PERMISSIONS_MODIFY,
    ...
    children: [(0, o.jsxs)(l.ModalHeader, {
      ...
      children: [null == I || I.hasFieldErrors() ? null : (0, o.jsx)(l.FormErrorBlock, {
      ...
      children: [(0, o.jsx)(l.Button, {
        ...
        disabled: N,
        onClick: O,
        color: !0 === b ? l.Button.Colors.GREEN : l.Button.Colors.PRIMARY,
...
function v(e) {
  let {
    icon: i,
    id: s
  } = e, n = u.default.getApplicationIconURL({
    id: s,
    icon: i,
    size: 40
  });

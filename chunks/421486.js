...
let C = a.memo(function(e) {
  let {
    ...
    messageId: R,
    roleId: g
  } = (0, S.useUserProfileAnalyticsContext)(), L = a.useMemo(() => {
    var e;
    ...
    count: L.length
  }), [L]), M = a.useMemo(() => p.default.Messages.USER_PROFILE_MUTUAL_GUILDS_SHORT.format({
    count: v.length
  }), [v]), y = a.useRef(null), [P, U] = a.useState(!1), [b, G] = a.useState(!1), w = a.useCallback(() => {
    if (null != y.current) {
      var e;
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [B && (() => {
      ...
      return f ? (0, s.jsx)(d.TooltipContainer, {
...
t.default = a.memo(function(e) {
  ...
  return !N || m || (null == g || 0 === g.length) && (null == R || 0 === R.length) ? null : (0, s.jsxs)("div", {

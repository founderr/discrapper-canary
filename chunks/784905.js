...
function b(e) {
  ...
  } = e, n = (0, r.useStateFromStoresArray)([f.default, T.default], () => {
...
function G(e) {
  let {
    channel: t,
    categories: s
  } = e, a = (0, o.useToken)(d.default.unsafe_rawColors.GREEN_360).hex(), c = (0, r.useStateFromStores)([f.default], () => f.default.getChannel(null == t ? void 0 : t.parent_id)), E = (0, C.useChannelPresetSettings)(t), [T, x] = n.useState(!1);
      ...
      children: [(0, i.jsxs)("div", {
        ...
        children: [null != p ? (0, i.jsx)(p, {
          ...
          children: [(0, i.jsx)(o.Text, {
            ...
            children: (0, N.computeChannelName)(t, _.default, m.default)
          }), (0, i.jsx)(o.Text, {
          ...
          children: (0, i.jsx)(o.Checkbox, {
            onClick: e => {
              (0, u.openContextMenu)(e, () => (0, i.jsx)(o.Menu, {
                ...
                onClose: () => {},
                onSelect: () => {},
                children: (0, S.useChannelNotificationCustomSettingsItem)(t, () => x(!1))
              }))
            },
            color: a,
            shape: o.Checkbox.Shapes.ROUND,

...
var r = n(512722), i = n.n(r), a = n(264344), o = n.n(a), s = n(259443), l = n(47770), u = n(174498), c = n.n(u), d = n(839548), _ = n(46973), E = n(734298), f = n(970838), h = n(68721), p = n(997653), m = n(384136), I = n(740197), T = n(548820), g = n(579237), S = n(582168), A = n(825040), N = n(65154), v = n(436620);
function O(e, t, n) {
...
class C extends l.Z {
    ...
    async getDesktopSource(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = await m.Z.get(e, t);
    ...
    setGoLiveSource(e, t) {
        if (null == e)
            ...
            let n = !1, r = this.pendingDesktopInputs[e.desktopDescription.id];

...
r.headers = function(e, t, r, n, E) {
  ...
  }, A = E ? (0, c.Hb)(E) : (0, a.$p)(s, I, u), T = (0, o.IQ)(l || (E ? (0, R.jC)(E) : (0, R._l)(s, t))), d = n.headers || ('undefined' != typeof Request && (0, i.V9)(e, Request) ? e.headers : void 0);
  if (!d)
    return {
      'sentry-trace': A,
      baggage: T
  ...
  if (Array.isArray(d)) {
    ...
    let e = 'baggage' in d ? d.baggage : void 0,
      t = [];
    return Array.isArray(e) ? t.push(...e) : e && t.push(e), T && t.push(T), {
      ...d,
      'sentry-trace': A,

...
var r = n(920478), i = n(31775), a = n.n(i), o = n(70956), s = n(364964), l = n(53529), u = n(925994), c = n(436660), d = n(887490), _ = n(42530);
let E = new Set(['line']), f = r.Z.listLanguages(), h = {};
for (let e of f) {
    e = e.toLowerCase();
            ...
            d.bN.withoutNormalizing(e, () => function (e) {
                let t = function (e) {
                    ...
                    for (let r of d.bN.blocks(e)) {
                        let i = null != n && (n.isInCodeBlock || n.opensCodeBlock), a = null != n && (n.isStyledCodeBlockLine || n.opensCodeBlockOnOwnLine);
                        n = function (e, t, n, r, i) {
                            ...
                            let o = function (e) {
                                    ...
                                    return i;
                                }(t), s = o[0], l = o[o.length - 1], u = null;
                            if (null != l) {
                                let [t] = d.bN.node(e, l.path);
                                u = t.text.substring(l.offset + 3);
                            }
                            let c = n && null != s, _ = n && 0 === o.length, f = r && 0 === o.length, p = (c ? o.slice(1) : o).length % 2 == 1, I = p && (null == u || '' === u || null != u.match(m)), T = I && null != u && null !== (a = h[u.toLowerCase()]) && void 0 !== a ? a : null;
                            return {
                                blockEntry: t,
                                wasInCodeBlock: n,
                                isInCodeBlock: _,
                        ...
                        for (let i of e) {
                            ...
                            if ((i.closesCodeBlock || a) && (n && a && !i.closesCodeBlock && t.push(i), n = !1, t.length > 0)) {
                                ...
                                if (null != n && null != r.Z.getLanguage(n)) {
                                    let r = function (e, t) {
                                        let n = ''.concat(e, '-').concat(t), r = S.get(n);
                                        if (null != r)
                                            return r;
                                    ...
                                    if (null != r && r.length === t.length) {
                                        ...
                                        for (let n = 0; n < t.length; n++) {
                                            let i;
                                            let a = r[n].replace(/&amp;/g, '&').replace(/&lt;/g, '<').replace(/&gt;/g, '>').replace(/&quot;/g, '"').replace(/&#x27;/g, '\''), o = [], s = 0, l = 0;
                                            for (; null != (i = T.exec(a));) {
                                                let t = i.index + i[0].length, n = i.index - l;
                ...
                (function (e, t) {
                    for (let n of t) {
                        ...
                        (null == t ? void 0 : t.codeBlockState) != i && c.Q.setNodes(e, { codeBlockState: i }, { at: r });
                    }
                }(e, t));
            }(e));

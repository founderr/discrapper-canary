...
function y(e) {
  ...
  let {
    ...
    channelId: g,
    streamKey: y
  } = n, [P, x] = s.useState(!1), D = (0, i.useStateFromStores)([C.default], () => C.default.getUser(l)), [b] = (0, c.default)([S]), U = null !== (t = I.default.getGlobalName(D)) && void 0 !== t ? t : I.default.getUserTag(D), j = (0, N.default)(), G = (0, i.useStateFromStores)([E.default], () => E.default.getPreviewURL(null, g, l)), k = (0, i.useStateFromStores)([_.default], () => _.default.getVoiceChannelId()), w = (0, A.default)(), B = (0, T.default)(g);
  if (s.useEffect(() => {
      P && k === g && x(!1)

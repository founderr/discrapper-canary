...
var i = n(735250), s = n(470079), a = n(442837), r = n(692547), l = n(481060), o = n(287734), c = n(872810), d = n(367907), u = n(835473), _ = n(871118), E = n(543882), h = n(314897), I = n(944486), m = n(594174), g = n(366695), p = n(602623), T = n(51144), S = n(498058), C = n(158631), f = n(143614), N = n(981631), A = n(70722), Z = n(689938), L = n(106963);
function v(e) {
    let {users: t} = e;
    return (0, i.jsxs)('div', {
        className: L.viewers,
...
function O(e) {
    ...
    let {broadcast: n} = e, {
            ...
            channelId: O,
            streamKey: R
        } = n, [x, P] = s.useState(!1), b = (0, a.e7)([m.default], () => m.default.getUser(r)), [M] = (0, u.Z)([p]), D = null !== (t = T.ZP.getGlobalName(b)) && void 0 !== t ? t : T.ZP.getUserTag(b), y = (0, f.Z)(), j = (0, a.e7)([E.Z], () => E.Z.getPreviewURL(null, O, r)), U = (0, a.e7)([I.Z], () => I.Z.getVoiceChannelId()), G = (0, C.ZP)(), w = (0, S.Z)(O);
    if (s.useEffect(() => {
            x && U === O && P(!1);
        }, [
            U,
    ...
    let {
        ...
        let n = h.default.getId(), i = t.some(e => e.id === n) || e === n, s = t.length >= N.keq;
        return {
                        ...
                        children: [
                            ...
                            (0, i.jsxs)(l.Button, {
                                onClick: () => {
                                    ...
                                    P(!0), (0, c.W1)(O, R), d.ZP.trackWithMetadata(N.rMx.BROADCAST_VIEWED, {

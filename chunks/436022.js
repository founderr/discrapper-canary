...
function o(e) {
    let s, {
            ...
            onClose: i,
            ...O
        } = e, [u, I] = E.useState(null), [S, c] = E.useState(!1), [d, L] = E.useState(null);
        ...
        children: [
            ...
            (0, r.jsxs)(t.Text, {
                ...
                children: [
                    ...
                    ' ',
                    _.isPremiumSubscription || _.isPremiumGuildSubscription || _.isPremiumGift ? a.Z.Messages.BILLING_REFUND_ONE_TIME_REFUND_NOTICE : null
                ]
            })
        ]
    });

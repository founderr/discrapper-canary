...
class U extends (l = s.Component) {
    static getDerivedStateFromProps(e) {
        ...
        {
            let e = t.filter(e => null != e), i = e.length;
            return {
    ...
    scrollToChannel(e) {
        if (null == this._list)
            return;
        let {padding: t} = this.props, {preRenderedChildren: n} = this.state, i = null != e ? this.props.privateChannelIds.indexOf(e) : -1, l = 0;
        i < 0 || null == e ? this._list.scrollTo({ to: l }) : (l += 44 * (i + n) + t, this._list.scrollIntoViewRect({
    ...
    render() {
        let {
                privateChannelIds: e,
                padding: t
            } = this.props, {preRenderedChildren: n} = this.state;
        return (0, a.jsx)(u.SJ, {
            children: i => {
                let {
                    ref: l,
    ...
    constructor(...e) {
        super(...e), j(this, 'state', {
            ...
            if (null == t)
                return;
            let r = Math.round((t.offsetHeight - 44 * l) / 44), a = r > n.length ? n.slice(0, r + 1) : n, o = a.map(e => null != i[e] ? i[e].getRecipientId() : null), c = n.some(e => (0, E.Z)(e)), u = {
                    num_users_visible: a.length,
                    num_users_visible_with_mobile_indicator: o.filter(e => null != e && L.Z.isMobileOnline(e)).length
                };
            this.hasReportedAnalytics = !0, g.ZP.trackWithMetadata(O.rMx.DM_LIST_VIEWED, {
                ...u,
                ...(0, C.X)(),
...
t.Z = e => {
    let {
            ...
            children: i,
            showDMHeader: l
        } = e, r = s.Children.count(i), o = T.Z.getMutablePrivateChannels(), c = (0, S.k1)(o), p = (0, h.Wu)([
            A.Z,
            x.Z,
            v.Z
        ], () => {
            let e = A.Z.getPrivateChannelIds(), t = (0, S.tU)(e, [
                    x.Z,
                    v.Z
                ]);
            return (0, I.Ce)(t);
            ...
            theme: Z.Z.darkSidebar ? O.BRd.DARK : n,

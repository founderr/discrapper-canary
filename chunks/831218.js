...
class U extends(i = a.Component) {
  ...
  render() {
    ...
    return (0, r.jsx)(c.SJ, {
      children: l => {
        ...
        return (0, r.jsx)(g.FocusJumpSection, {
          children: l => (0, r.jsx)(g.List, {
            fade: !0,
            innerRole: s,
            innerAriaLabel: b.Z.Messages.DIRECT_MESSAGES,
            innerTag: "ul",
            ref: e => {
              var t;
  ...
  constructor(...e) {
    super(...e), y(this, "state", {
      ...
      totalRowCount: 0,
      nonNullChildren: []
    }), y(this, "_list", null), y(this, "hasReportedAnalytics", !1), y(this, "reportAnalytics", () => {
      var e;
    ...
    }), y(this, "getSectionHeight", e => {
      let {
        showDMHeader: t
      } = this.props;
      return 0 === e ? 0 : t ? 40 : 0
    }), y(this, "handleScroll", u()(() => {
      if (null != this._list) {
        let e = this._list.getScrollerNode();
        null != e && m.Z.updateChannelListScroll(P.ME, e.scrollTop)
      }
    }, 100)), y(this, "renderDM", (e, t) => {
      let {
        privateChannelIds: n,
        channels: l,
        selectedChannelId: i
      ...
      return 0 === t ? this.renderChild(n) : 0 === n && 0 === l.length ? (0, r.jsx)(D, {}, "no-private-channels") : this.renderDM(t, n)
      ...
      return 0 !== t && n ? (0, r.jsxs)(R.Z, {
        ...
        children: [(0, r.jsx)("span", {
          ...
          children: b.Z.Messages.DIRECT_MESSAGES
        }), (0, r.jsx)(N.Z, {
          tooltip: b.Z.Messages.CREATE_DM,
          tooltipPosition: "top",
          popoutAlign: "left",
          iconClassName: j.privateChannelRecipientsInviteButtonIcon,
          icon: g.PlusSmallIcon,
...
t.Z = e => {
  let {
    ...
    children: l,
    showDMHeader: i
  } = e, s = a.Children.count(l), o = T.Z.getMutablePrivateChannels(), u = (0, S.k1)(o), p = (0, h.Wu)([A.Z, Z.Z, x.Z], () => {
    let e = A.Z.getPrivateChannelIds(),
      t = (0, S.tU)(e, [Z.Z, x.Z]);
    return (0, _.Ce)(t)
  }, []), g = (0, h.cj)([C.Z, L.Z, T.Z], () => ({
    ...
    isEnabled: g.keyboardModeEnabled,
    scrollToStart: f,
    scrollToEnd: I,

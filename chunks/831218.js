...
t.Z = e => {
  let {
    ...
    children: i,
    showDMHeader: l
  } = e, r = s.Children.count(i), o = T.Z.getMutablePrivateChannels(), c = (0, S.k1)(o), p = (0, h.Wu)([A.Z, x.Z, Z.Z], () => {
    let e = A.Z.getPrivateChannelIds(),
      t = (0, S.tU)(e, [x.Z, Z.Z]);
    return (0, I.Ce)(t)
  }, []), f = (0, h.cj)([g.Z, v.Z, T.Z], () => ({
  ...
  })), _ = s.useRef(null), m = s.useCallback(e => {
    let t = _.current,

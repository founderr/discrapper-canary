...
function v(e) {
  let {
    ...
    null === (n = j.current) || void 0 === n || null === (t = n.getScrollerNode()) || void 0 === t || t.scrollTo({
      top: Math.max((s - 2) * 34, 0)
    })
  }, [o]);
  a.useEffect(() => {
    Z(n)

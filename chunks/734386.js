...
function j(e) {
    let { channel: t } = e,
        ...
        r = (0, _.ZP)(t, !0),
        j = t.guild_id,
        O = (0, d.e7)([T.Z], () => (null != j ? T.Z.getRoles(j) : void 0)),
        y = (0, d.e7)([v.default, T.Z], () => {
            var e;
            return v.default.getUser(null === (e = T.Z.getGuild(j)) || void 0 === e ? void 0 : e.ownerId);
        }),
        D = s.useMemo(
            () =>
                null != j
                    ...
                    k.map((e, n) => {
                        ...
                        return w
                            ? (0, i.jsx)(
                                  g.Z,
                                  {
                                      className: l()(P.role, { [P.last]: n === k.length - 1 }),
                                      roleName: e.name,
                                      roleColor: r,
                                      disabled: !w,
                                      verified: o,

...
function g(e) {
    ...
    let {
            ...
            analyticsLocation: S,
            isLightTheme: f
        } = e, C = 'AnnouncementModalVariant1_'.concat(s.z[Number(g.dismissKey)]), {onClose: N} = p, A = null != g.button && '' !== g.button.copy ? g.button.copy : E.Z.Messages.BILLING_SUBSCRIBE_TO_PLAN, Z = (null === (t = g.button) || void 0 === t ? void 0 : t.buttonAction) === a.Wc.OPEN_MARKETING_PAGE ? 'jump_to_mkt_button' : 'get_nitro_button', L = (null === (n = g.button) || void 0 === n ? void 0 : n.buttonAction) === a.Wc.OPEN_MARKETING_PAGE ? () => {
    ...
    let R = f ? u.VE.PREMIUM_TIER_2_OLD_GRADIENT_FILL : u.VE.PREMIUM_TIER_2_WHITE_FILL, x = '' !== g.modalTopPill ? () => (0, i.jsx)(u.Cy, {
            text: g.modalTopPill,

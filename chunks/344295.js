...
class K extends r.PureComponent {
    componentDidMount() {
        ...
        if ((j.default.track(y.rMx.INVITE_VIEWED, { invite_code: n }, { flush: !0 }), (0, C.e)('invite'), !B.KO)) {
    ...
    render() {
        ...
        switch (e.state) {
            ...
            case y.r2o.RESOLVED:
                var l;
                if (n && (0, T.yE)(null !== (l = e.flags) && void 0 !== l ? l : 0, a.$.IS_GUEST_INVITE)) return d.Z.openApp(e.code), u.x.set(E.J, e.code), this.renderAppOpened(() => r(y.Z5c.APP));

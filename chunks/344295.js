...
class z extends r.PureComponent {
  componentDidMount() {
    ...
    if (S.default.track(U.rMx.INVITE_VIEWED, {
        invite_code: n
      }, {
        flush: !0
      }), (0, A.e)("invite"), !y.KO) {
  ...
  componentDidUpdate(e) {
    ...
    if (n !== e.nativeAppState && n === U.kEZ.OPEN && this.track(U.rMx.INVITE_APP_INVOKED, !1), this.getMode() === w.REGISTER && s && !e.authenticated) {
      let {
        channel: e
      } = t;
  ...
  getMode() {
    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.props;
    return G.a ? w.REGISTER : e.login ? w.LOGIN : w.REGISTER
  }
  track(e, t) {
  ...
  renderAuthenticatedHeader() {
    ...
    return null != e.stage_instance && null != e.guild ? (0, s.jsx)(N.Z, {
  ...
  render() {
    ...
    switch (e.state) {
      ...
      case U.r2o.RESOLVED:
        var l;
        if (n && (0, C.yE)(null !== (l = e.flags) && void 0 !== l ? l : 0, a.$.IS_GUEST_INVITE)) return d.Z.openApp(e.code), u.x.set(m.J, e.code), this.renderAppOpened(() => r(U.Z5c.APP));
        if (n || !y.KO) return this.renderAuthenticatedOrDownload();
        else if (this.getMode() === w.LOGIN) return (0, s.jsx)(L.Z, {
          invite: e,
          transitionTo: r,
          location: i
        });
...
t.Z = c.ZP.connectStores([O.Z, v.Z, x.default, g.Z, _.Z], e => {
  var t;
  let {
    inviteKey: n
  } = e;

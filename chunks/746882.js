...
function C(e) {
  let {
    transitionState: t,
    source: a
  } = e, r = (0, d.e7)([p.default], () => p.default.getCurrentUser()), s = (0, d.e7)([f.Z, E.Z], () => E.Z.getChannel(f.Z.getChannelId())), [c, C] = l.useState(null), [N, O] = l.useState(null), [k, S] = l.useState(!1), [D, Z] = l.useState(0), I = l.createRef(), B = l.createRef(), j = (0, m.Dt)(), w = null != c ? u()().diff(c, "years") : null;
  ...
  return 0 === D ? function() {
    ...
    return (0, o.jsxs)(_.ModalRoot, {
      ...
      "aria-labelledby": j,
      children: [(0, o.jsxs)(_.ModalContent, {
    ...
    size: _.ModalSize.SMALL,
    "aria-labelledby": j,
    children: [(0, o.jsx)(_.ModalContent, {
      children: (0, o.jsxs)("div", {

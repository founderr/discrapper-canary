...
t.Z = a.memo(function (e) {
    let {
            ...
            let t = e.getGuildId(), n = (0, o.e7)([I.Z], () => null == t || I.Z.canChatInGuild(t), [t]), {
                    canManageMessages: i,
                    permissionVersion: a
                } = (0, o.cj)([T.Z], () => ({
            ...
            let e = E.jU.useSetting(), t = E.cC.useSetting(), {
            ...
            var t, n;
            let i = (0, o.e7)([x.Z], () => x.Z.getMessages(e.id), [e.id]), l = (0, o.e7)([v.ZP], () => {
                    var t;

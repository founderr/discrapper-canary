...
l.Z = e => {
  let {
    ...
    style: t = {},
    onClose: r
  } = e, O = E.default.getUser(l.author_id), M = j.ZP.getName(null == n ? void 0 : n.guild_id, null == n ? void 0 : n.id, O), T = null == O ? void 0 : O.getAvatarURL(null == n ? void 0 : n.guild_id, 48, !1), [_, f] = a.useState(null), [S, C] = a.useState(!1);
  return (0, s.jsxs)("div", {

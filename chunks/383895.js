s(47120);
var n = s(735250), t = s(470079), r = s(120356), l = s.n(r), i = s(512722), E = s.n(i), c = s(442837), _ = s(481060), o = s(493683), I = s(220779), A = s(142550), d = s(201133), u = s(693824), O = s(919394), R = s(91140), N = s(297781), T = s(359110), m = s(592125), P = s(944486), g = s(594174), L = s(5192), M = s(810568), S = s(689938), G = s(340672), C = s(421377);
let p = e => {
    let {
            entry: a,
            setGeneratedImage: s,
    ...
    return t.useEffect(() => {
        (async () => {
            let e = await o.Z.getOrEnsurePrivateChannel(a.author_id), n = m.Z.getChannel(e);
            E()(null != n, 'DM channel cannot be null');
            let t = await (0, O.QC)(a, n, u.kH.Base64), r = await (0, O.QC)(a, n, u.kH.CloudUpload);
            c(t), s(r);
        })();
    }, [
        a,
        ...
        children: [
            (0, n.jsx)('div', { className: l()(G.placeholderImage, null != i && G.in) }),
            null != i && (0, n.jsx)('img', {
            ...
            (0, n.jsxs)('div', {
                ...
                children: [
                    (0, n.jsx)('img', {
                        className: G.avatar,
                        src: h,
                        alt: S.Z.Messages.GAME_PROFILE_USER_AVATAR_ALT.format({ userName: f })
                    }),
                    (0, n.jsx)('div', {
                        ...
                        children: (0, n.jsxs)('div', {
                            ...
                            children: [
                                ...
                                (0, n.jsx)(N.Gk, {
                                    location: N.Gt.CARD,
                                    children: R.W.slice(0, 2).map((e, s) => (0, n.jsx)(e, { entry: a }, s))
                                })
                            ]
                        })
                    })
            ...
            (0, n.jsx)('div', {
                ...
                children: (0, n.jsx)(I.ZP, {
                    ...
                    popoutProps: {
                        ...
                        replyHeaderText: '',
                        replyPlaceholder: S.Z.Messages.QUICK_DM_USER.format({ name: f })
                    }
                })
            })
        ]

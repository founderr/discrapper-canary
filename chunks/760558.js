...
s.default = e => {
  ...
  let f = [null == n ? "UNUSED_QUANTITY_SELECT" : null, null == t ? "GUILD_SELECT" : null, "CONFIRM", "SUCCESS"].filter(e => null != e),
    ...
    A = a.useMemo(() => null == Z ? [] : Z.map(e => {
      let {
        premiumGuildSubscription: s
      } = e;
    ...
    k = () => {
      g("SUCCESS" === D), I.default.track(U.rMx.MODAL_DISMISSED, {
    ...
    H = {
      UNUSED_QUANTITY_SELECT: {
        body: () => (o()(!(null == n && 0 === L.length), "Cannot provide no slots if there are no other available slots"), (0, r.jsxs)("div", {
          ...
          children: [(0, r.jsx)(u.Heading, {
            ...
            children: [(0, r.jsx)(u.NumberInputStepper, {
              value: Z.length,
      ...
      GUILD_SELECT: {
        header: () => (0, r.jsx)(x.GuildSelectModalHeader, {
          isTransfer: F,
          query: B,
          setQuery: v
        }),
        bodyClass: h.selectContent,
        body: () => (0, r.jsx)(x.GuildSelectModalBody, {
          onClose: k,
          onSelectGuild: e => {
            O(e), G("CONFIRM")
          },
      ...
      CONFIRM: {
        body() {
          ...
          let e = Z.filter(e => (0, M.tl)(e)).length,
            s = Z.length,
            l = A.length;
          return F ? (0, r.jsx)(_.Z.TransferBody, {
            fromGuilds: A,
            toGuild: P,
        ...
        footer() {
          ...
          return (0, r.jsx)(_.Z.Footer, {
            confirmation: F ? R.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_TRANSFER_CONFIRM_CONFIRMATION.format({
              slotCount: e
            }) : R.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_CONFIRMATION.format({
              slotCount: e
            }),
            confirmationLabel: F ? R.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_TRANSFER_CONFIRM_CONFIRMATION_LABEL.format({
              slotCount: e
  ...
  return (0, r.jsxs)(u.ModalRoot, {
    ...
    children: [null === (s = w.header) || void 0 === s ? void 0 : s.call(w), (0, r.jsx)(u.ModalContent, {
    ...
    }), null === (l = w.footer) || void 0 === l ? void 0 : l.call(w), (0, r.jsx)(u.ModalCloseButton, {

...
s.default = e => {
    ...
    let f = [
            ...
            'CONFIRM',
            'SUCCESS'
        ].filter(e => null != e), [p, j] = (0, d.Wu)([C.Z], () => [
            C.Z.isModifyingAppliedBoost,
            C.Z.applyBoostError
        ]), [B, v] = a.useState(''), [D, G] = a.useState(f[0]), [T, b] = a.useState(!1), [P, O] = a.useState(t), [Z, y] = a.useState(null != n ? n : L.slice(0, 1)), A = a.useMemo(() => null == Z ? [] : Z.map(e => {
            let {premiumGuildSubscription: s} = e;
            return m.Z.getGuild(null == s ? void 0 : s.guildId);
        }).filter(e => null != e), [Z]), F = a.useMemo(() => {
            var e;
            ...
            CONFIRM: {
                body() {
                    if (null == P)
                        return null;
                    let e = Z.filter(e => (0, M.tl)(e)).length, s = Z.length, l = A.length;
                ...
                footer() {
                    let e = Z.length, s = 'CONFIRM' === f[0] ? k : () => G(f[f.indexOf(D) - 1]), l = async () => {

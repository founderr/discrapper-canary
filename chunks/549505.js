...
var s = t(735250);
t(470079);
var n = t(481060), o = t(547972), r = t(63063), d = t(981631), i = t(332325), l = t(689938), c = t(709788), E = t(83173);
function _(e) {
    let {
        transitionState: a,
        onClose: t
...
let m = () => {
    let e = [
        ...
        {
            icon: (0, s.jsx)(n.GameControllerIcon, { className: c.icon }),
            text: l.Z.Messages.CONTENT_INVENTORY_MEMBERLIST_LEARN_MORE_PLAYED_NOTE
        },
        {
            icon: (0, s.jsx)(n.ChatIcon, { className: c.icon }),

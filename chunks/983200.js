...
var a = n(470079), s = n(31775), r = n.n(s);
let l = 0, i = 4, o = 4, c = 'absolute', d = (e, t, n, a) => {
        if (0 === n)
            return [];
        if (1 === n)
            return [{
        ...
        if (3 === n) {
            let n = Math.ceil((e - a) / 2), s = Math.ceil((t - a) / 2);
            return [
                {
                    top: 0,
                    left: 0,
...
function m(e) {
    ...
    return a.useMemo(() => function (e) {
        ...
        let i = (t = s, n = r, a = l, ''.concat(t, '-').concat(n, '-').concat(a)), o = u.get(i);
        if (null != o)
            return o;
        {
            let e = d(r, l, s, 4);

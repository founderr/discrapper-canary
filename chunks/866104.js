...
function L(e) {
  ...
  let {
    nickname: N,
    nickcolor: S
  } = (l = I, (0, r.useStateFromStoresObject)([f.default, _.default], () => {
    var e, t;
  ...
  } = (0, C.useExpandableTextContainer)(), P = (null !== (n = null == E ? void 0 : null === (t = E.description) || void 0 === t ? void 0 : t.trim().length) && void 0 !== n ? n : 0) > 0, [D, y] = a.useState(1), U = (0, u.default)("(max-width: ".concat(O.twoColumnWidth, ")")), {
    selectedTab: j,
    isPhantomPreview: b
  } = (0, A.useGuildShopDisplayContext)(), G = j === h.GuildShopTab.GUILD_PRODUCTS_PREVIEW ? M.default.Messages.GUILD_STORE_HERO_PREVIEW_TAB_DESCRIPTION : M.default.Messages.GUILD_STORE_HERO_PREVIEW_PAGE_DESCRIPTION, B = P ? (0, s.jsxs)(s.Fragment, {
    children: [(0, s.jsx)(x, {
      lineClamp: U || 2 === D ? 2 : 3,
      children: (0, s.jsx)(o.Text, {

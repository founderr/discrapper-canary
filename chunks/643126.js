...
class A extends s.PureComponent {
  ...
  renderTitle() {
    return (0, i.jsxs)("div", {
      children: [(0, i.jsx)(g.Z, {
        children: this.isHost() ? C.Z.Messages.SPOTIFY_LISTEN_ALONG_TITLE_HOST.format({
          count: this.props.party.length
        }) : C.Z.Messages.SPOTIFY_LISTEN_ALONG_TITLE_LISTENER
      }), (0, i.jsx)(p.Z, {
        children: C.Z.Messages.SPOTIFY_LISTEN_ALONG_SUBTITLE_LISTENER
      })]
    })
  }
  ...
  constructor(...e) {
    super(...e), S(this, "renderPartyMember", (e, t) => {
      ...
      return n = (null == a ? void 0 : a.id) === e.id ? C.Z.Messages.SPOTIFY_LISTEN_ALONG_HOST : C.Z.Messages.SPOTIFY_LISTEN_ALONG_LISTENER, (0, i.jsx)(c.Popout, {

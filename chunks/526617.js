...
var r = n(735250), i = n(470079), a = n(120356), o = n.n(a), s = n(442837), l = n(481060), u = n(239091), c = n(788911), d = n(906732), _ = n(880949), E = n(806966), f = n(28546), h = n(468954), p = n(631771), m = n(609218), I = n(695346), T = n(594174), g = n(979651), S = n(153124), A = n(259580), N = n(626135), v = n(74538), O = n(135869), R = n(763296), C = n(697426), y = n(242291), D = n(22382), L = n(747071), b = n(421673), M = n(663215), P = n(409673), U = n(347072), w = n(835648), x = n(650743), G = n(394740), k = n(343747), B = n(981631), F = n(689938), V = n(14338);
let H = [
    8,
    0,
    8,
...
function Y(e) {
    ...
    return (0, r.jsx)('div', {
        ...
        children: (0, r.jsx)(l.Clickable, {
            className: o()(V.sectionHeader, { [V.notFirstSectionHeader]: 0 !== a }),
            onClick: i,
            'aria-expanded': !n,
                ...
                children: [
                    function () {
                        ...
                        case C.bg.FREQUENTLY_USED:
                            return (0, r.jsx)(l.AnalyticsIcon, { className: V.headerIcon });
                        case C.bg.GUILD:
                            return (0, r.jsx)(_.Z, {
                                guild: t.guild,
                                height: 16,
...
function j() {
    return (0, r.jsx)(c.Z, { message: F.Z.Messages.SOUNDBOARD_SEARCH_EMPTY_STATE_BODY });
}
function W(e) {
    let {
            descriptors: t,
...
function K(e) {
    let {
        ...
        } = e, {currentPreviewRef: X} = i.useContext(O.Z), {analyticsLocations: $} = (0, d.ZP)(), [J, ee] = i.useState(null), et = (0, s.e7)([T.default], () => T.default.getCurrentUser()), en = (0, s.e7)([g.Z], () => {
            var e;
            return g.Z.getVoiceState(t, null !== (e = null == et ? void 0 : et.id) && void 0 !== e ? e : B.lds);
        }), er = (null == en ? void 0 : en.selfDeaf) || (null == en ? void 0 : en.mute) || (null == en ? void 0 : en.suppress), ei = (0, f.Iu)(e => e.searchQuery), ea = (0, S.Dt)(), {categories: eo} = (0, M.ZP)(a, void 0, Q), [es, el] = i.useState([]), eu = (0, M.FS)(eo, es, ei), ec = I.T4.useSetting(), ed = i.useMemo(() => new Set(ec), [ec]), e_ = null == a, eE = v.ZP.canUseCustomCallSounds(et), ef = i.useCallback(e => {
        ...
        } = p.Qs.useExperiment({ location: 'Premium Soundboard Roadblock' }, { autoTrackExposure: !0 }), eR = i.useCallback(() => {
            var e;
            let t = R.Z.getSoundById('3'), n = new Audio((0, D.Z)('3'));

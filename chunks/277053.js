...
return !1;
  let e = A.getGuildId();
  N = C = R(A), null == C[Z] && (Z = e), s = null != v, i = E.o4(A, v), L = null, S = !1, f = g.QZA.CLOSED, T.clear();
}
...
a = {
  ...
  ...C,
  [t]: a
}, T.add(t), f = g.QZA.OPEN, S = !d().isEqual(C, N), i = E.o4(A, v);
  },
...
for (let e of t)
  !1 !== function(e) {
    ...
    return T.forEach(e => {
      ...
      ...n
    })[Z] ? Z = t : null != L && null != C[L] && (Z = L, L = null), i = E.o4(A, v), !0;
  }(e.id) && (n = !0);
return n;
  },

...
function M() {
  ...
  let e = N.getGuildId();
  A = g = P(N), null == g[R] && (R = e), s = null != O, a = h.areChannelsLocked(N, O), v = null, T = !1, p = S.FormStates.CLOSED, I.clear()
}
...
o = "ChannelSettingsPermissionsStore", (r = "displayName") in(i = y) ? Object.defineProperty(i, r, {
  ...
  CHANNEL_SETTINGS_PERMISSIONS_UPDATE_PERMISSION: function(e) {
    ...
    l = {
      ...
      ...g,
      [t]: l
    }, I.add(t), p = S.FormStates.OPEN, T = !d().isEqual(g, A), a = h.areChannelsLocked(N, O)
  },
  ...
  CHANNEL_SETTINGS_CLOSE: function() {
    p = S.FormStates.CLOSED, g = null, A = null, N = null, O = null, T = !1, I.clear(), R = null, v = null
  },
  CHANNEL_UPDATES: function(e) {
    ...
    for (let e of t) !1 !== function(e) {
      ...
      return I.forEach(e => {
        ...
        ...n
      })[R] ? R = t : null != v && null != g[v] && (R = v, v = null), a = h.areChannelsLocked(N, O), !0
    }(e.id) && (n = !0);
    return n
  },

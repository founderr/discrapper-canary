...
function x() {
  ...
  let e = A.getGuildId();
  N = f = R(A), null == f[L] && (L = e), s = null != Z, i = h.o4(A, Z), v = null, S = !1, C = p.QZA.CLOSED, T.clear()
}
...
o = "ChannelSettingsPermissionsStore", (l = "displayName") in(r = P) ? Object.defineProperty(r, l, {
  ...
  CHANNEL_SETTINGS_PERMISSIONS_UPDATE_PERMISSION: function(e) {
    ...
    a = {
      ...
      ...f,
      [t]: a
    }, T.add(t), C = p.QZA.OPEN, S = !d().isEqual(f, N), i = h.o4(A, Z)
  },
  ...
  CHANNEL_SETTINGS_CLOSE: function() {
    C = p.QZA.CLOSED, f = null, N = null, A = null, Z = null, S = !1, T.clear(), L = null, v = null
  },

...
var r = n(470079), i = n(392711), a = n.n(i), o = n(442837), s = n(726542), l = n(487576), u = n(553795), c = n(594174), d = n(70956), _ = n(930090), E = n(981631), f = n(420212);
let h = { [E.ABu.INSTAGRAM]: ['1036753656588017764'] }, p = new Map([[
            E.ABu.INSTAGRAM,
            new Date(2023, 1, 18).getTime()
        ]]), m = 30 * d.Z.Millis.DAY;
function I(e) {
    let {forUserProfile: t} = e, n = (0, o.e7)([c.default], () => c.default.getCurrentUser()), r = l.c.useExperiment({ location: 'f2f7ef_1' }, { autoTrackExposure: !1 }).allowPlayStationStaging, {enabled: i} = _.E.useExperiment({ location: 'ConnectionsHooks' });
    return e => {
        var a;
...
function T() {
    let e = (0, o.e7)([u.Z], () => u.Z.getAccounts()), t = I({ forUserProfile: !1 }), n = r.useMemo(() => {
            let t = new Set();

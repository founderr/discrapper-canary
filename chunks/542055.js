...
var a = n(735250), l = n(470079), i = n(658722), s = n.n(i), o = n(392711), r = n.n(o), c = n(990547), d = n(442837), u = n(952265), m = n(481060), p = n(100527), C = n(906732), v = n(213609), g = n(709054), h = n(435064), x = n(39604), E = n(680056), f = n(10217), L = n(410426), I = n(207346), S = n(356659), M = n(502637);
function _(e) {
    let {
            channelId: t,
            onClose: i,
            transitionState: o
        } = e, [_, N] = l.useState(''), [Z, T] = l.useState('descending'), [j, A] = l.useState(!0), [b, P] = l.useState(null), R = l.useDeferredValue(_), k = (0, d.e7)([h.Z], () => h.Z.getClips()), y = (0, d.e7)([h.Z], () => h.Z.getPendingClips()), B = (0, d.e7)([h.Z], () => h.Z.getSettings().storageLocation), D = (0, d.Wu)([h.Z], () => h.Z.getNewClipIds()), {analyticsLocations: H} = (0, C.ZP)(p.Z.CLIPS_GALLERY), V = l.useMemo(() => [
            ...y,
            ...k
        ], [
            k,

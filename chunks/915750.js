...
var d = this;
E(this, 'id', void 0), E(this, 'quests', void 0), E(this, 'questContent', void 0), E(this, 'questContentPosition', void 0), E(this, 'trackGuildAndChannelMetadata', void 0), E(this, 'triggeredByStatusChange', void 0), E(this, 'beatTimeout', void 0), E(this, 'lastBeatTime', void 0), E(this, 'minViewTimeReachedTimeout', void 0), E(this, 'minViewTimeSecond', void 0), E(this, 'minViewportPercentage', void 0), E(this, 'questContentRowIndex', void 0), E(this, 'onMinViewTimeReached', () => {
  this.quests.forEach(e => {
    f.info('trackQuestEvent - '.concat(e.config.messages.questName, ' Quest')), (0, u.dA)({
      questId: e.id,
...
let r = s && t,
  i = (n || o || u) && r,
  a = (n || o) && !r || u;
(i || a) && null != l.current && l.current.stop(), i && (l.current = new h({

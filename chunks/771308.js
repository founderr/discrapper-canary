...
var s = n(544891), r = n(570140), i = n(959776), a = n(626135), l = n(723359), o = n(981631);
function c(e, t) {
...
function u(e) {
    r.Z.dispatch({ type: 'AGE_GATE_PREVENT_UNDERAGE_REGISTRATION' }), a.default.track(o.rMx.AGE_GATE_ACTION, {
        source: e,
        action: l.Al.AGE_GATE_PREVENT_UNDERAGE_REGISTRATION
    });
}
function d(e) {
    r.Z.dispatch({ type: 'AGE_GATE_LOGOUT_UNDERAGE_NEW_USER' }), a.default.track(o.rMx.AGE_GATE_ACTION, {
        source: e,

...
function E(e, t) {
  let [a, s] = l.useState(null), E = l.useCallback(a => {
    ...
    let L = (l = m, E = _, A = t, l ? null != E && o.POLLS_SUPPORTED_EXPRESSION_PICKER_VIEW_TYPES.has(E) ? E : A === n.PollLayoutTypes.DEFAULT ? u.ExpressionPickerViewType.EMOJI : u.ExpressionPickerViewType.GIF : u.ExpressionPickerViewType.EMOJI);
    s(e => (e === a ? (0, r.toggleExpressionPicker)(L, d) : (0, r.openExpressionPicker)(L, d), a))
  }, [e, t]);
  return {

...
function _(e) {
  let {
    ...
    guildId: n,
    channelId: s
  } = e, i = a.useMemo(() => Object.keys(t).filter(e => f.default.isMember(n, e)), [t, n]), d = i.length > 0 ? t[i[0]] : null, c = null == d ? void 0 : d.activity.application_id, h = (0, r.useStateFromStores)([o.default], () => null != c ? o.default.getApplication(c) : null != d ? o.default.getApplicationByName(d.activity.name) : null);

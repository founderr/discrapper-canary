...
function h(e) {
  ...
  } = e, O = (0, l.useStateFromStores)([o.default], () => o.default.getGuild(n), [n]), x = (0, l.useStateFromStores)([o.default], () => {
    var e;
    return o.default.getRole(n, null !== (e = null == t ? void 0 : t.role_id) && void 0 !== e ? e : p.EMPTY_STRING_SNOWFLAKE_ID)
  }), L = (0, a.useListingThumbnailUrl)(t, 600), D = (0, _.useProductType)(t), P = (0, d.useCanManageGuildProduct)(O), {

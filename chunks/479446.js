...
var r, l, i = t(512722), s = t.n(i), a = t(493683), o = t(904245), u = t(957730), c = t(592125), d = t(669079);
...
let m = async (e, n) => {
    ...
    return o.Z.sendMessage(t.id, u.ZP.parse(t, r), void 0, { isGiftLinkSentOnBehalfOfUser: !0 });
};

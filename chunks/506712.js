...
var r = n(392711), i = n.n(r), a = n(131704), o = n(592125), s = n(580005), l = n(650774), u = n(70956), c = n(789662);
function d(e, t, n, r, i) {
    var a, s, u, d;
    let E = o.Z.getMutableGuildChannelsForGuild(e.id), f = r.filter(e => e.channel_id in E), h = null !== (a = n.filter(t => t.guild_id === e.id)[0]) && void 0 !== a ? a : {}, p = l.Z.getMemberCount(e.id), m = _('year', r, f, e => {
            var t;
...
function _(e, t, n, r) {
    let a = t.reduce((e, t) => e + r(t), 0), o = n.reduce((e, t) => e + r(t), 0), s = i().sortBy(n, r).reverse()[0], l = null == s ? 0 : r(s), u = (l / o * 100).toFixed(1);
    return {
        label: e,
...
function E(e, t) {
    var n, r;
    let i = null !== (n = t.filter(t => t.guild_id === e.id)[0]) && void 0 !== n ? n : {}, o = null !== (r = l.Z.getMemberCount(e.id)) && void 0 !== r ? r : 0, d = Date.now() - u.Z.Millis.DAYS_30, _ = s.Z.getFrequentlyWithoutFetchingLatest().filter(t => t instanceof a.Sf && t.guild_id === e.id), E = _.filter(e => {
            var t, n;

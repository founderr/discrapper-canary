...
var i = n(735250), a = n(470079), l = n(442837), s = n(570140), r = n(519938), o = n(928518), c = n(585483), u = n(317381), d = n(917107), h = n(716600), p = n(918559), m = n(981631);
let _ = (e, t) => {
    s.Z.wait(() => {
        (0, r.Cz)(e, t);
    });
...
function f(e) {
    let t, {
            ...
            className: s,
            style: r
        } = e, f = (0, l.e7)([o.Z], () => o.Z.getWindow(m.KJ3.CHANNEL_CALL_POPOUT)), E = (0, h.Z)(), C = (0, l.e7)([u.ZP], () => u.ZP.getActivityPanelMode());
    ...
    let I = a.useRef(null), x = a.useMemo(() => {
            let e = null;
            return () => {

...
class V extends a.PureComponent {
  ...
  render() {
    ...
    if (e && !_) {
      if (S.message = B.Z.Messages.FOLLOW_NEWS_CHAT_INPUT_MESSAGE, null != f && f >= 1e3) {
    ...
    } else if (l) S.message = B.Z.Messages.GUILD_VERIFICATION_TEXT_NOT_CLAIMED, S.buttonText = B.Z.Messages.CLAIM_ACCOUNT, S.onButtonClick = g ? this.handleShowMemberVerification : this.handleClaimAccount, S.imageSrc = n(102811);
    else if (g) switch (null == T ? void 0 : T.applicationStatus) {
      case I.wB.SUBMITTED:
    ...
    return (0, i.jsx)(o.Popout, {
      ...
      children: e => (0, i.jsx)(k.Z, {
        ...
        children: (0, i.jsxs)(a.Fragment, {
          children: [this.renderMemberVerificationSuccessModal(), E ? (0, i.jsx)(o.Popout, {
  ...
  constructor(...e) {
    super(...e), G(this, "state", {
      ...
      if (null != e)(0, o.openModal)(t => (0, i.jsx)(o.ConfirmModal, {
...
function F(e) {
  ...
  let {
    channel: l,
    children: s
  } = e, o = l.getGuildId(), c = (0, r.e7)([L.Z], () => L.Z.getGuild(o)), u = (0, r.e7)([P.Z], () => P.Z.getCheck(o)), d = l.type === U.d4z.GUILD_ANNOUNCEMENT && null != c && c.hasFeature(U.oNc.NEWS), p = (0, r.e7)([R.Z], () => d ? R.Z.getFollowerStatsForChannel(l.id) : null), f = (0, r.e7)([v.Z], () => v.Z.isLurking(o)), E = (0, r.e7)([y.default], () => y.default.getCurrentUser()), C = null !== (t = null == E ? void 0 : E.isStaff()) && void 0 !== t && t, T = (0, r.e7)([j.ZP], () => {
    var e, t;
    return null != E && null !== (t = null === (e = j.ZP.getMember(o, E.id)) || void 0 === e ? void 0 : e.isPending) && void 0 !== t && t
  }), S = !!(null == c ? void 0 : c.hasVerificationGate()), Z = (T || u.notClaimed) && S, A = (0, r.e7)([N.Z], () => N.Z.shouldShowPopout(o)), M = (0, r.e7)([O.Z], () => O.Z.can(U.Plq.SEND_MESSAGES, l)), k = (0, r.e7)([x.Z], () => x.Z.getRequest(o)), [w, B] = (0, m.L_)(o), H = (0, m.Cc)(o), G = (null == k ? void 0 : k.applicationStatus) === I.wB.APPROVED;
  a.useEffect(() => {

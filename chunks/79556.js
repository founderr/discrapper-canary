...
function G(e) {
  let {
    ...
    return {
      ...
      canReorderChannel: !0 !== a && (n.id === O.FAVORITES_RAW_GUILD_ID || (null != e ? _.default.can(y.Permissions.MANAGE_CHANNELS, e) : _.default.can(y.Permissions.MANAGE_CHANNELS, n)))
    }

...
class b extends L.ZP {
  ...
  render() {
    let {
      ...
      withGuildIcon: S,
      enableActivities: x
    } = this.props, L = x && null != N && N.length > 0, T = (0, g.D)(_), A = (0, l.jsx)("li", {
...
function y(e) {
  ...
  }, [t]), P = (0, d.NX)(t.id, !1, "webGuildTextChannel"), b = (0, T.Z)({
    channel: t,

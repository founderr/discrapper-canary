...
var n = s(735250), o = s(470079), a = s(481060), l = s(365007), c = s(689938), r = s(614213);
function d(e) {
    let {
            transitionState: t,
            onClose: s,
            credential: d
        } = e, [i, u] = o.useState(!1), [h, _] = o.useState(''), [E, M] = o.useState(void 0), m = o.useRef(null);
    async function N(e) {

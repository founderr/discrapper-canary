...
function a(e, t, n) {
    ...
    var r, i = (r = e, document.createTreeWalker(r, NodeFilter.SHOW_ELEMENT, {
        ...
        })), a = t.compareDocumentPosition(e), o = null;
...
i.prototype.add = function (e, t) {
    ...
    var n = this.current(), r = null != n && n.uid === e;
    ...
    var t = this;
    return this.listeners.push(e), e(this.isActive(), this.locks), function () {
        return t.listeners = t.listeners.filter(function (t) {
            return t !== e;
        });
    };
}, i.prototype.emit = function () {
    var e = this, t = this.isActive();
    this.listeners.forEach(function (n) {
        return n(t, e.locks);
    });
};
var o = new i(), s = 0, l = (0, r.memo)(function () {
        var e, t = (0, r.useState)(!1), n = t[0];
...
function u(e, t) {
    void 0 === t && (t = {});
    var n, i, l, u, c, d = t.disableReturnRef, _ = t.attachTo;
    void 0 === _ && (_ = document);
    var E = t.disable, f = (i = (0, r.useState)(function () {
            return 'lock-' + s++;
    ...
    (0, r.useEffect)(function () {
        ...
        return null == t || null == document.activeElement || t.contains(document.activeElement) || null != t.querySelector('[autofocus]') || a(t, document.activeElement, !0), _.addEventListener('focusin', n, { capture: !0 }), _.addEventListener('focusout', r, { capture: !0 }), function () {
            _.removeEventListener('focusin', n, { capture: !0 }), _.removeEventListener('focusout', r, { capture: !0 });
        };
    }, [e]), u = d, c = (0, r.useState)(function () {
        return document.activeElement;
    })[0], (0, r.useLayoutEffect)(function () {
        return function () {
            null != u && u.current || requestAnimationFrame(function () {
                null != c && c.focus();
            });
        };
    }, []);

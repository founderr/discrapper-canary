...
function u(e, t) {
  void 0 === t && (t = {});
  var n, i, l, u, c, d = t.disableReturnRef,
_ = t.attachTo;
  void 0 === _ && (_ = document);
  var E = t.disable,
...
return null == t || null == document.activeElement || t.contains(document.activeElement) || null != t.querySelector('[autofocus]') || a(t, document.activeElement, !0), _.addEventListener('focusin', n, {
    capture: !0
  }), _.addEventListener('focusout', r, {
    capture: !0
  }),
  function() {
    _.removeEventListener('focusin', n, {
      capture: !0

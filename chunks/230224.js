...
let m = 100,
  ...
  A = e => {
    var t;
    return (null === (t = e.channel) || void 0 === t ? void 0 : t.type) === h.ChannelTypes.GROUP_DM
  },
  ...
  O = e => e.state === h.InviteStates.ACCEPTED,
  C = e => {
    let {
...
function D(e) {
  ...
  return null == r || R(n) || (null == n ? void 0 : null === (t = n.guild) || void 0 === t ? void 0 : t.id) === _.INVITE_ROUTING_HUB_GUILD_ID ? null : (0, s.jsx)(d.ActivityCount, {
    className: l()(T.activityCount, i),
...
function P(e) {
  let {
    invite: t,
    showBigUserIcon: n
  } = e, i = a.useMemo(() => n ? null : g(t) && null != t.target_user ? f.default.getUserAvatarURL(t.target_user) : R(t) && null != t.inviter ? f.default.getUserAvatarURL(t.inviter) : null, [t, n]), l = p.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN;
  if (A(t)) {
    var u, o;
    l = (null === (u = t.channel) || void 0 === u ? void 0 : u.name) != null && (null === (o = t.inviter) || void 0 === o ? void 0 : o.username) != null ? p.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN_GROUP_DM_BY_USER.format({
      username: t.inviter.username
    }) : p.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN_GROUP_DM
  } else g(t) && null != t.target_user ? l = p.default.Messages.AUTH_MESSAGE_INVITED_TO_STREAM.format({
    username: t.target_user.username
  }) : O(t) ? l = p.default.Messages.INSTANT_INVITE_YOU_ARE_ALREADY_A_MEMBER_OF : R(t) && null != t.inviter && (l = p.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN_BY_USER.format({
...
function L(e) {
  ...
  if (null != l) I && null == f && (t = (0, s.jsx)(d.GuildIcon, {
    guild: l,
    size: d.GuildIcon.Sizes.SMALL
  })), n = l.name, null != f && (n = f.name, a = (0, s.jsxs)("div", {
    className: T.inviteJoinContainer,
    ...
    let e = E.default.getFormattedName(i);
  ...
  return (0, s.jsxs)(s.Fragment, {
    children: [(0, s.jsxs)(d.Title, {
      className: T.title,
      children: [null != l ? (0, s.jsx)(o.default, {
        guild: l,

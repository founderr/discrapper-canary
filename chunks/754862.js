...
var l = {
    ...
    }, d = 'undefined' != typeof window && !!window.navigator && /MSIE |Trident\/|Edge\//.test(window.navigator.userAgent), f = function () {
        ...
        return !function (e, t) {
            ...
            },
            {
                ...
                value: function () {
                    ...
                    if (!!e)
                        p(e, this.sizer), this.placeHolderSizer && p(e, this.placeHolderSizer);
                }
            },
            {
            ...
            },
            {
                ...
                value: function () {
                    ...
                    var r = o({
                        ...
                        }, this.props.inputStyle), i = function (e, t) {
                            var n = {};
                            for (var o in e) {
                                if (!(t.indexOf(o) >= 0))
                    ...
                    return e = i, c.forEach(function (t) {
                        ...
                        style: n
                    }, this.renderStyles(), a.default.createElement('input', o({}, i, { ref: this.inputRef })), a.default.createElement('div', {
                        ref: this.sizerRef,
                        style: l

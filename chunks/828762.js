...
var n = t(470079), a = t(399606), r = t(780384), s = t(570140), o = t(881052), l = t(141795), i = t(476326), d = t(983544), c = t(9874), u = t(710845), C = t(430824), g = t(277985), T = t(240864), p = t(863663), h = t(981631), m = t(689938);
function I(e, A, t) {
...
class f {
    addAttachment(e, A) {
        ...
        if (this.uploads.length >= t)
            throw r.uv.announce(m.Z.Messages.GUILD_PRODUCT_A11Y_TOO_MANY_ATTACHMENTS.format({ maxAttachmentsCount: t })), Error('Too many attachments');
        ...
        n.upload(), n.on('error', t => {
            ...
            let s = 'number' == typeof t && t > 0 ? -t : -1, o = (0, p.kg)(s), l = null === (a = e.file) || void 0 === a ? void 0 : a.name;
            null != l ? r.uv.announce(m.Z.Messages.GUILD_PRODUCT_A11Y_NAMED_UPLOAD_FAILED.format({
                filename: l,
                reason: o
            })) : r.uv.announce(m.Z.Messages.GUILD_PRODUCT_A11Y_UPLOAD_FAILED.format({ reason: o })), A(e => ({
                ...e,
                [n.id]: s
            }));
        }), n.on('progress', (e, t) => {
    ...
    async saveProductWithAttachments(e) {
        ...
        let o = this.uploads.filter(e => !this.existingAttachmentIds.has(e.id)), i = this.uploads.filter(e => this.existingAttachmentIds.has(e.id)).map(e => {
                var A;
                return {
    ...
    constructor({
        ...
        I(this, 'guildId', void 0), I(this, 'isEdit', void 0), I(this, 'target', new g.Z()), I(this, 'createCloudUploader', void 0), I(this, 'onFileSizeError', void 0), I(this, 'existingAttachmentIds', new Set()), I(this, 'uploads', []), I(this, 'generateInitialProgresses', () => {
            let e = {};
            for (let A of this.uploads)
                e[A.id] = 1;
            return e;
        }), this.isEdit = null != A;
        let a = null == A ? h.ANM.GUILD_PRODUCTS(e) : h.ANM.GUILD_PRODUCT_LISTINGS(e, A), r = null == A ? 'POST' : 'PATCH';
...
function v(e, A) {
    ...
    let {
            ...
            e,
            i
        ]), [u, g] = n.useState(c.generateInitialProgresses), [, T] = n.useState(null);
    n.useLayoutEffect(() => {
    ...
    let {uploads: D} = c, O = !D.every(e => c.existingAttachmentIds.has(e.id)) || D.length !== c.existingAttachmentIds.size;
    return {
        addAttachment: q,

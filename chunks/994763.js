...
function eW(e) {
  ...
  return [{
    ...
    decoration: function(e, t) {
      ...
      if (v.Z.getEnabled(e)) return eH.Z.Messages.GUILD_ONBOARDING_ON.toUpperCase();
      if ((0, eI.C)(e)) return eH.Z.Messages.GUILD_ONBOARDING_OFF.toUpperCase();
      let s = eE.ug.filter(e => !!n || e !== eE.PG.HOME_SETTINGS || !1),
        a = s.findIndex(e => e === t);
      if (-1 !== a) return eH.Z.Messages.GUILD_ONBOARDING_SETUP_STEP_COUNTER.format({
        count: a + 1,
        total: s.length
      })
    }(a.id, X)
    ...
    onClick() {
      ...
      let t = a.toString(),
        i = {
          header: eH.Z.Messages.DELETE_SERVER_TITLE.format({
            name: t
          }),
...
function eQ() {
  ...
  } = (0, I.ZP)(_.Z.GUILD_SETTINGS), u = (0, r.e7)([Y.Z], () => Y.Z.theme), E = (0, r.e7)([Y.Z], () => Y.Z.darkSidebar ? ey.BRd.DARK : void 0), T = (0, r.e7)([X.ZP], () => null != n ? X.ZP.getChannels(n.id).SELECTABLE : null, [n]), m = (0, r.cj)([J.Z], () => null != n ? J.Z.getGuildPermissionProps(n) : eq), N = null == n ? void 0 : n.id, S = (0, r.e7)([J.Z], () => null != n && J.Z.canAccessGuildSettings(n)), h = null != n && (0, en.Fv)(n.id), g = h || S, C = h || m.canViewGuildAnalytics, {
  ...
  } = (0, Z.kZ)(null != N ? N : ey.lds);
  a.useEffect(() => {
    null != N && O && (0, j.cP)(N)
  }, [O, N]);
  let {
    showAccessRate: A
  } = (0, en.eA)(null == n ? void 0 : n.id, !R || !C || !g), D = m.isGuildAdmin && (null == n ? void 0 : n.hasFeature(ey.oNc.CLAN)), b = (0, r.e7)([w.Z], () => {
    var e;
  ...
  }, [N, m.canManageGuild]), a.useEffect(() => {
    !g && ea.Z.close()
  }, [g]);
  let P = (0, r.e7)([e_.Z], () => e_.Z.getCurrentPage()),
    B = (0, r.e7)([v.Z], () => null != N && v.Z.getEnabled(N)),

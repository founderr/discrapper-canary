...
var r = n(735250);
n(470079);
var i = n(693789), a = n(952265), o = n(911969), s = n(555573), l = n(254711), u = n(213459), c = n(10718), d = n(367790), _ = n(998698), E = n(895924), f = n(581364), h = n(826298), p = n(496675), m = n(156361), I = n(226951), T = n(877565), g = n(590921), S = n(665692), A = n(689079), N = n(689938), v = n(310746);
...
let C = {
    ...
    queryResults(e, t, n, r, i) {
        ...
        if (r.commands === g.L8.OLD_BUILT_INS) {
            let r = (0, l.Kh)(o.yU.CHAT, !1, !1), i = RegExp('^'.concat(I.Z.escape(n)), 'i'), a = (0, f.Dd)(r, i, {
                    channel: e,
                    guild: t
                }, g.AQ), s = l.Tm[A.bi.BUILT_IN];
            return 0 === a.length ? O : {
                results: {
                    entries: a.map(e => ({
                        command: e,
    ...
    renderResults(e) {
        let {
                ...
                onHover: l,
                onClick: u
            } = e, c = (0, h.hV)(a, o), d = s.commands === g.L8.OLD_BUILT_INS;
        return (0, T.HI)({
            query: c.text,
            selectedIndex: n,
            autocompletes: t,
    ...
    onSelect(e) {
        ...
        if (i.commands === g.L8.OLD_BUILT_INS)
            ...
            let e = o;
            null == e && (e = l ? E.Vh.QUERY : E.Vh.DISCOVERY), s.Po({
                channelId: a.id,
                command: u,

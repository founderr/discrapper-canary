...
class W extends r.PureComponent {
    ...
    componentDidUpdate(e) {
        var t, n, i;
        let { voiceChannelId: r, voiceChannelGuildId: l, voiceChannelType: s, voiceChannelBitrate: E, videoEnabled: I, isScreenSharing: N, runningGame: A, runningGamePid: L, selectedChannelId: O, selectedGuildId: M, connected: w, homeLink: k, friendsTabSection: W, isNSFWChannel: Y, isMemberPending: K, hasPreviewEnabled: q, postableChannelCount: X, isTextInVoice: Q, numMessageRequests: J } = this.props;
...
function Y() {
    let [e, t] = (0, l.Wu)([O.Z], () => [O.Z.getVoiceChannelId(), O.Z.getChannelId()], []),
        ...
        x = (0, I.Z)(c),
        P = (0, l.e7)([N.Z], () => N.Z.getMessageRequestsCount(), []),
        y = {
            selectedChannelId: t,
            isNSFWChannel: a,
            selectedGuildId: c,

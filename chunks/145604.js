            ...
            if (
                (setTimeout(() => {
                    ...
                    let n = V.ZP.GetWindowFullscreenTypeByPid(Z.pid, Z.name, Z.fullscreenType),
                        { gameName: i, gameId: r, exe: _, distributor: h } = (0, I.G8)(Z);

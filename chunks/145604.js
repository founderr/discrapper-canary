  ...
  componentDidUpdate(e) {
    ...
    if (e.voiceChannelId !== s && null != e.voiceChannelId) {
      let t = p.ZP.getCurrentGameForAnalytics(),
        ...
        s = C.ZP.getActiveEventByChannel(e.voiceChannelId);
    ...
    if (e.voiceChannelId !== s && null != s) {
      let e = p.ZP.getCurrentGameForAnalytics(),
        ...
        i = C.ZP.getActiveEventByChannel(s);
    ...
    if (e.runningGame !== v && null != v && !v.isLauncher) {
      ...
      if (setTimeout(() => {
        ...
        }, 1e4), null != v.name && null != R && L.Z.shouldReport(v.name)) {
        let e = v.name;
    ...
    } else U && null == j && G === F.Z5c.FRIENDS && (!e.connected || W !== e.friendsTabSection || G !== e.homeLink) ? (0, _.Z)({
      tab_opened: W

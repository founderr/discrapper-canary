...
function z() {
    let [e, t] = (0, a.Wu)([b.Z], () => [
            ...
            R.Z.isVideoEnabled(),
            R.Z.isScreenSharing()
        ], []), N = (0, a.e7)([D.Z], () => D.Z.getPrimaryActivity(), []), A = (0, a.e7)([g.ZP], () => g.ZP.getCurrentGameForAnalytics(), []), L = (0, T.Z)(c), x = (0, a.e7)([f.Z], () => f.Z.getMessageRequestsCount(), []), P = {
            selectedChannelId: t,
            isNSFWChannel: r,
            selectedGuildId: c,
            friendsTabSection: E,

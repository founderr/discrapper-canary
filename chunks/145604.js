...
class Y extends r.PureComponent {
    ...
    componentDidUpdate(e) {
        var t, n, i;
        let { voiceChannelId: r, voiceChannelGuildId: l, voiceChannelType: o, voiceChannelBitrate: E, videoEnabled: I, isScreenSharing: S, runningGame: b, runningGamePid: y, selectedChannelId: R, selectedGuildId: M, connected: w, homeLink: k, friendsTabSection: Y, isNSFWChannel: W, isMemberPending: K, hasPreviewEnabled: q, postableChannelCount: X, isTextInVoice: Q, numMessageRequests: J } = this.props;
        ...
        if (w && null != R && (!e.connected || R !== e.selectedChannelId || M !== e.selectedGuildId)) {
            ...
            let l = (0, d.K)(x.Z.getChannel(R), !0);

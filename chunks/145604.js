...
class z extends a.PureComponent {
    ...
    componentDidUpdate(e) {
        var t, n, i;
        let { voiceChannelId: a, voiceChannelGuildId: s, voiceChannelType: o, voiceChannelBitrate: p, videoEnabled: T, isScreenSharing: C, runningGame: Z, runningGamePid: O, selectedChannelId: P, selectedGuildId: j, connected: U, homeLink: G, friendsTabSection: z, isNSFWChannel: W, isMemberPending: K, hasPreviewEnabled: q, postableChannelCount: Q, isTextInVoice: X, numMessageRequests: J } = this.props;
        if (e.voiceChannelId !== a && null != e.voiceChannelId) {
            let t = g.ZP.getCurrentGameForAnalytics(),
                ...
                a = f.ZP.getActiveEventByChannel(e.voiceChannelId);
        ...
        if (e.voiceChannelId !== a && null != a) {
            let e = g.ZP.getCurrentGameForAnalytics(),
                ...
                i = f.ZP.getActiveEventByChannel(a);
        ...
        if (e.runningGame !== Z && null != Z && !Z.isLauncher) {
            let e = L.Z.getGameByName(Z.name),
                t = g.ZP.getOverrideForGame(Z),
                n = R.Z.getGuildIds(),
                i = A.SE.getSetting(),
            ...
            if (
                (setTimeout(() => {
                    ...
                    w.default.track(F.rMx.LAUNCH_GAME, {
                        ...
                        elevated: Z.elevated,
                        is_launcher: null !== (t = null == Z ? void 0 : Z.isLauncher) && void 0 !== t && t,
                        ...
                        game_detection_enabled: (0, g.ik)(Z),
                        executable_path: _,
                        voice_channel_id: a,
                ...
                null != Z.name && null != O && L.Z.shouldReport(Z.name))
            ) {
                let e = Z.name;
        ...
        } else U && null == j && G === F.Z5c.FRIENDS && (!e.connected || z !== e.friendsTabSection || G !== e.homeLink) ? (0, _.Z)({ tab_opened: z }) : U && null == j && G === F.Z5c.MESSAGE_REQUESTS && (!e.connected || G !== e.homeLink) && !this.isMessageRequestsInitialized && ((this.isMessageRequestsInitialized = !0), w.default.track(F.rMx.MESSAGE_REQUESTS_INITIALIZED, { num_message_requests: J }));
...
function W() {
    let [e, t] = (0, s.Wu)([P.Z], () => [P.Z.getVoiceChannelId(), P.Z.getChannelId()], []),
        ...
        _ = (0, s.e7)(
            ...
            () => {
                var e, t;
                return null != u && null != c && null !== (t = null === (e = Z.ZP.getMember(c, u.id)) || void 0 === e ? void 0 : e.isPending) && void 0 !== t && t;
            },
            [u, c]
        ),
        ...
        [f, S] = (0, s.Wu)([O.Z], () => [O.Z.isVideoEnabled(), O.Z.isScreenSharing()], []),

...
var i = n(735250), s = n(470079), a = n(442837), r = n(224706), l = n(593472), o = n(603113), c = n(367907), d = n(731429), u = n(188471), _ = n(176881), E = n(318885), h = n(358221), I = n(710845), m = n(581567), p = n(594190), g = n(38618), T = n(501640), S = n(924301), C = n(734307), N = n(355298), f = n(427679), A = n(695346), Z = n(592125), L = n(77498), v = n(271383), O = n(430824), R = n(131951), x = n(375954), P = n(19780), b = n(944486), M = n(914010), D = n(885110), y = n(9156), j = n(594174), U = n(774343), G = n(974042), w = n(808506), k = n(626135), B = n(630388), H = n(823379), V = n(998502), F = n(981631), Y = n(987650);
class W extends s.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        if (e.voiceChannelId !== s && null != e.voiceChannelId) {
            let t = p.ZP.getCurrentGameForAnalytics(), n = null != t ? t.name : '', i = f.Z.getStageInstanceByChannel(e.voiceChannelId), s = S.ZP.getActiveEventByChannel(e.voiceChannelId);
        ...
        if (e.voiceChannelId !== s && null != s) {
            let e = p.ZP.getCurrentGameForAnalytics(), t = null != e ? e.name : '', n = f.Z.getStageInstanceByChannel(s), i = S.ZP.getActiveEventByChannel(s);
            (0, c.yw)(F.rMx.CHANNEL_OPENED, { ...(0, c.$H)(s) }), (0, u.a)(F.rMx.CHANNEL_OPENED_CLICKSTREAM, { channelId: s }), k.default.track(F.rMx.JOIN_VOICE_CHANNEL, {
                channel_id: s,
                channel_type: o,
                channel_bitrate: g,
                guild_id: a,
        ...
        if (e.runningGame !== v && null != v && !v.isLauncher) {
            let e = L.Z.getGameByName(v.name), t = p.ZP.getOverrideForGame(v), n = O.Z.getGuildIds(), i = A.SE.getSetting(), s = n.filter(e => !i.includes(e)).slice(0, 200), a = null;
            ...
            if (setTimeout(() => {
                    ...
                    k.default.track(F.rMx.LAUNCH_GAME, {
                        ...
                        game_detection_enabled: (0, p.ik)(v),
                        executable_path: c
                    });
        ...
        if ((e.videoEnabled !== T || e.isScreenSharing !== N) && null != s) {
            ...
            N ? (e = 'screen', n = (0, E.t)()) : T && (e = 'camera'), k.default.track(F.rMx.VIDEO_INPUT_TOGGLED, {
                video_input_type: e,
        ...
        if (U && null != j && (j !== e.selectedGuildId || !e.connected || K && !e.isMemberPending)) {
            ...
            U && null == j && G === F.Z5c.FRIENDS && (!e.connected || W !== e.friendsTabSection || G !== e.homeLink) ? (0, _.Z)({ tab_opened: W }) : U && null == j && G === F.Z5c.MESSAGE_REQUESTS && (!e.connected || G !== e.homeLink) && !this.isMessageRequestsInitialized && (this.isMessageRequestsInitialized = !0, k.default.track(F.rMx.MESSAGE_REQUESTS_INITIALIZED, { num_message_requests: J }));
        if (U && null != b && (!e.connected || b !== e.selectedChannelId || j !== e.selectedGuildId)) {
            let t = e.selectedChannelId, n = Z.Z.getChannel(t), s = O.Z.getGuild(null == n ? void 0 : n.getGuildId());
            if (null != t && null != n && null != s && s.publicUpdatesChannelId === t) {
                let e = x.Z.getMessages(t), a = e.toArray().reverse().find(e => {
                        var t;
            ...
            let a = (0, d.K)(Z.Z.getChannel(b), !0);
            (0, c.yw)(F.rMx.CHANNEL_OPENED, {
                ...a,
                ...(0, c.$H)(b)
            }), (0, u.a)(F.rMx.CHANNEL_OPENED_CLICKSTREAM, { channelId: b }), X && (0, c.yw)(F.rMx.TEXT_IN_VOICE_OPENED, { channel_is_nsfw: z });
        }
    }
    getGameMetadata() {
        return {
...
function z() {
    let [e, t] = (0, a.Wu)([b.Z], () => [
            b.Z.getVoiceChannelId(),
            b.Z.getChannelId()
        ], []), n = (0, a.e7)([Z.Z], () => Z.Z.getChannel(t), [t]), s = (0, a.e7)([h.Z], () => (null == n ? void 0 : n.id) != null && h.Z.getChatOpen(n.id), [n]), r = null == n ? void 0 : n.nsfw, l = (0, a.e7)([Z.Z], () => Z.Z.getChannel(e), [e]), c = (0, a.e7)([M.Z], () => M.Z.getGuildId(), []), d = (0, a.e7)([O.Z], () => O.Z.getGuild(c), [c]), u = (0, a.e7)([j.default], () => j.default.getCurrentUser(), []), _ = (0, a.e7)([v.ZP], () => {
            var e, t;
            return null != u && null != c && null !== (t = null === (e = v.ZP.getMember(c, u.id)) || void 0 === e ? void 0 : e.isPending) && void 0 !== t && t;
        }, [
            u,
            c
        ]), E = (0, a.e7)([G.ZP], () => G.ZP.getState().section, []), I = (0, a.e7)([U.Z], () => U.Z.getHomeLink(), []), m = (0, a.e7)([g.Z], () => g.Z.isConnected(), []), [S, C] = (0, a.Wu)([R.Z], () => [
            R.Z.isVideoEnabled(),
            R.Z.isScreenSharing()
        ], []), f = (0, a.e7)([D.Z], () => D.Z.getPrimaryActivity(), []), A = (0, a.e7)([p.ZP], () => p.ZP.getCurrentGameForAnalytics(), []), L = (0, T.Z)(c), x = (0, a.e7)([N.Z], () => N.Z.getMessageRequestsCount(), []), P = {
            selectedChannelId: t,
            isNSFWChannel: r,
            selectedGuildId: c,
            friendsTabSection: E,
            ...
            gamePlatform: (0, o.Z)(f),
            gameName: null != f ? f.name : null,
            gameId: null != f ? f.application_id : null,

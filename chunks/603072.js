...
function B(e) {
    ...
    a.useEffect(() => {
        (0, h.EW)(o.z.CHANNEL_BROWSER_NEW_BADGE_NUX, { dismissAction: S.L.DISMISS });
    });
    let r = i ? R.Z.Messages.CHANNELS_AND_ROLES_HTML_TITLE.format({ guildName: n.name }) : R.Z.Messages.CHANNEL_BROWSER_HTML_TITLE.format({ guildName: n.name }), s = i ? R.Z.Messages.CHANNELS_AND_ROLES : R.Z.Messages.CHANNEL_BROWSER_TITLE;
    return (0, u.Tt)({ location: r }), (0, l.jsxs)(_.Z, {
        className: A.header,
...
function L(e) {
    ...
    return null == i ? null : (0, l.jsxs)(l.Fragment, {
        children: [
            (0, l.jsxs)('div', {
                className: r()(O.chat, { [O.threadSidebarOpen]: x }),
                children: [
                    (0, l.jsx)(B, {
                        guild: i,
                        previousChannel: E

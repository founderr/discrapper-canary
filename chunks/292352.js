...
var t, T, I, n, s, A, r, a, i, C, N, o, u, S, M, R, l, L, d, D, Y, c, O = _(860911),
  f = _(70956),
  F = _(689938);
...
3,
{
  ...
  sectionHeader: e => F.Z.Messages.FAMILY_CENTER_ACTIVITY_USER_INTERACTION_SECTION_HEADER.format({
    count: e
  }),
...
5,
{
  ...
  sectionHeader: e => F.Z.Messages.FAMILY_CENTER_ACTIVITY_USER_CALLED_SECTION_HEADER.format({
    count: e
  }),
...
1,
{
  ...
  sectionHeader: e => F.Z.Messages.FAMILY_CENTER_ACTIVITY_ADD_FRIENDS_SECTION_HEADER.format({
    count: e
  }),
...
2,
{
  ...
  sectionHeader: e => F.Z.Messages.FAMILY_CENTER_ACTIVITY_GUILD_JOIN_SECTION_HEADER.format({
    count: e
  }),
...
4,
{
  ...
  sectionHeader: e => F.Z.Messages.FAMILY_CENTER_ACTIVITY_GUILD_INTERACTION_SECTION_HEADER.format({
    count: e
  }),

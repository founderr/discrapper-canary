n(47120);
var r = n(735250), i = n(470079), a = n(481060), o = n(904245), s = n(367907), l = n(592125), u = n(496675), c = n(981631), d = n(689938), _ = n(648917);
t.Z = e => {
    let {
            message: t,
            reportId: n
        } = e, [E, f] = i.useState(!1), h = i.useCallback(() => {
            f(!0), s.ZP.trackWithMetadata(c.rMx.IAR_DELETE_MESSAGE_BUTTON_CLICKED, { report_id: n }), o.Z.deleteMessage(t.getChannelId(), t.id);
        }, [
            t,
            n
        ]), p = i.useMemo(() => {

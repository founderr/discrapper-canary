!function () {
    var t = function (e) {
        ...
        return O.duration = 40, O.types = {}, O.types.fade = [
            ...
            if (o = !0 === r ? void 0 !== o ? o : a.length - 1 : void 0 !== o ? o : 0, n = n || function () {
                }, o < a.length && o >= 0)
                x[t.type](T(e, a[o])), p = setTimeout(function () {
            ...
            var s = t.position.indexOf('up') > -1, u = t.position.indexOf('left') > -1;
            if (s || u)
            ...
            badge: function (e, t) {
                t = ('string' == typeof t ? { animation: t } : t) || {}, d = function () {
                    try {
                        if ('number' == typeof e ? e > 0 : '' !== e) {
                            ...
                            if ('animation' in t && O.types['' + t.animation] && (n.options.animation = '' + t.animation), 'type' in t && x['' + t.type] && (n.options.type = '' + t.type), [
                                    'bgColor',
                                    'textColor'
                                ].forEach(function (e) {
            ...
            image: function (e) {
                d = function () {
                    try {
                        var t = e.width, n = e.height, c = document.createElement('img'), s = t / o < n / r ? t / o : n / r;

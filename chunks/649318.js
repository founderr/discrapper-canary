...
function p(e) {
  ...
  if (h.type = n, h.protocol = N, h.payloads = a, h.setup = i, h.mid = t, h.rtcpMux = "rtcp-mux", h.direction = r, h.ssrcs = _, _.length > 0 && (null != d && (h.ssrcGroups = l()(_, 4).map(e => {
      let t = e[0].id;
      return {
        semantics: "FID",
  ...
  switch (n) {
    case "audio":
      "Firefox" === I().name ? h.ext = c.filter(e => "urn:ietf:params:rtp-hdrext:ssrc-audio-level" === e.uri) : (h.ext = c.filter(e => "urn:ietf:params:rtp-hdrext:ssrc-audio-level" === e.uri || "http://www.ietf.org/id/draft-holmer-rmcat-transport-wide-cc-extensions-01" === e.uri), h.rtcpFb = [{
        type: "transport-cc",
        payload: a
      }]), h.rtp.push({
        codec: o,
        ...
        payload: a,
        rate: 48e3
      }), o === f.ad.OPUS && h.fmtp.push({
        config: "minptime=10;useinbandfec=1;usedtx=".concat(E ? "0" : "1"),
        payload: a
      }), h.maxptime = 60;
      break;
    case "video":
      h.ext = c.filter(e => "urn:ietf:params:rtp-hdrext:toffset" === e.uri || "http://www.webrtc.org/experiments/rtp-hdrext/abs-send-time" === e.uri || "urn:3gpp:video-orientation" === e.uri || "http://www.ietf.org/id/draft-holmer-rmcat-transport-wide-cc-extensions-01" === e.uri || "http://www.webrtc.org/experiments/rtp-hdrext/playout-delay" === e.uri), h.rtp.push({
        codec: o,
        payload: a,
        rate: 9e4
      });
      let A = "x-google-max-bitrate=".concat(u);
      o === f.ad.H264 && (A += ";level-asymmetry-allowed=1;packetization-mode=1;profile-level-id=42e01f"), h.fmtp.push({
        config: A,
        payload: a
      }), h.rtcpFb = [{
        type: "ccm",
        ...
        config: "apt=".concat(a),
        payload: d
      }), h.payloads = "".concat(h.payloads, " ").concat(d))
  }
  return h
}
...
function g(e) {
  ...
  if (A.info("generateSessionDescription: ".concat(JSON.stringify(c))), "Firefox" === I().name) {
    let e = "answer" === t ? "passive" : "active";
    c.forEach(t => {
      let [i, c, I, T, h] = t;
      if ("video" !== I || 0 !== l && 0 !== _) E.push(p({
        mid: h,
        type: I,
        setup: e,
        direction: T,
...
function C(e) {
  ...
  return c.forEach(e => {
    ...
    "" !== T ? t = O(T, c, "audio" === h ? "a" : "v") : (t = [], "sendonly" === f ? f = "inactive" : "sendrecv" === f && (f = "recvonly"));
    E.push(p({
      mid: S,
      type: h,
      setup: I,
...
function L(e) {
    ...
    switch (e.outboundStreams.push({
      ...
      case "video":
        [f.ad.H264, f.ad.VP8, f.ad.VP9].forEach((t, n) => {
          let s = v(r, o, i, t, n);
          null != s && e.codecs.push(s)
        }), "sendrecv" === a && (null != (n = null == s ? void 0 : s.find(e => "cname" === e.attribute)) && (e.videoSSRC = n.id), null != (n = null == s ? void 0 : s.findLast(e => "cname" === e.attribute)) && (n.id === e.videoSSRC && A.warn("Unable to find a unique rtx SSRC!"), e.rtxSSRC = n.id))
    }
    return e
  }, {
    outboundStreams: [],
  ...
  return t.codecs = d()(t.codecs, _()), t
}
...
function D(e) {
  ...
  let {
    codecs: n
  } = L(e), i = n.find(e => e.name === f.ad.VP8), r = RegExp("^a=ice|a=extmap|a=fingerprint|opus|VP8|".concat(null !== (t = null == i ? void 0 : i.rtxPayloadType) && void 0 !== t ? t : 0, " rtx"), "i");
  return {

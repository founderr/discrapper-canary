...
media: [p]
  ...
  if (p.type = n, p.protocol = g, p.payloads = o, p.setup = r, p.mid = t, p.rtcpMux = 'rtcp-mux', p.direction = i, p.ssrcs = c, c.length > 0 && (null != _ && (p.ssrcGroups = l()(c, 4).map(e => {
  let t = e[0].id;
  return {
    semantics: 'FID',
...
case 'video':
  ...
  s === I.ad.H264 && (T += ';level-asymmetry-allowed=1;packetization-mode=1;profile-level-id=42e01f'), p.fmtp.push({
    config: T,
    payload: o
  }), p.rtcpFb = [{
      type: 'ccm',
...
o = null;
  if (null != s) {
let t = e.find(e => e.codec === I.ad.RTX && e.payload === s.payload);
null != t && (o = t.payload);
  }
  return {
type: n,
...
function D(e) {
  ...
  let {
codecs: n
  } = y(e), r = n.find(e => e.name === I.ad.VP8), i = RegExp('^a=ice|a=extmap|a=fingerprint|opus|VP8|'.concat(null !== (t = null == r ? void 0 : r.rtxPayloadType) && void 0 !== t ? t : 0, ' rtx'), 'i');
  return {

...
var r, i, a, o, s = n(403644), l = n.n(s), u = n(565925), c = n.n(u), d = n(21690), _ = n.n(d), E = n(264344), f = n.n(E), h = n(988367), p = n(259443), m = n(65154), I = n(436620);
let T = new p.Y('SDP');
...
function A(e, t, n) {
    let r = ''.concat(e, '-').concat(t), i = ''.concat(n).concat(r);
    return [
        {
            attribute: 'cname',
            id: t,
...
function O(e) {
    ...
    if (T.info('generateSessionDescription: '.concat(JSON.stringify(d))), 'Firefox' === f().name) {
        ...
        let e = 'answer' === t ? 'passive' : 'actpass', f = d.filter(e => {
                let [t, n, r, i, a] = e;
...
function C(e, t, n, r, i) {
    ...
    if (null == a)
        return null;
    let o = t.find(e => RegExp('^apt='.concat(a.payload)).test(e.config)), s = null;
    if (null != o) {
...
function D(e) {
    var t;
    let {codecs: n} = y(e), r = n.find(e => e.name === m.ad.VP8), i = RegExp('^a=ice|a=extmap|a=fingerprint|opus|VP8|'.concat(null !== (t = null == r ? void 0 : r.rtxPayloadType) && void 0 !== t ? t : 0, ' rtx'), 'i');
    return {

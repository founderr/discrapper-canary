...
let T = {
  [d.AEg.NORMAL]: E.normal,
  [d.AEg.MINIMUM]: E.minimum,
  [d.AEg.NO_CHAT]: E.noChat,
  [d.AEg.FULL_SCREEN]: E.fullScreen
};
...
class f extends(i = s.PureComponent) {
  ...
  renderContents() {
    ...
    return (0, r.jsx)(c.Z, {
      ...
      children: (0, r.jsxs)(c.Z, {
        ...
        direction: c.Z.Direction.VERTICAL,
        children: [this.renderBackground(), (0, r.jsxs)(c.Z, {
  ...
  constructor(e) {
    super(e), I(this, "_timeout", new u.V7), I(this, "handleMouseEvent", () => {
      ...
      if (e === d.AEg.FULL_SCREEN || e === d.AEg.NO_CHAT) this._timeout.start(3e3, () => this.setState({
        idle: !0

...
function Z() {
    let e = (0, d.e7)([O], () => O.name), t = (0, d.e7)([O], () => O.description), n = (0, d.e7)([O], () => O.error);
    return (0, a.jsxs)(a.Fragment, {
        children: [
            (0, a.jsx)(_.FormItem, {
                className: R.marginBottom20,
...
function b(e) {
    ...
    return null == n ? (0, a.jsx)(U, { guild: t }) : (0, a.jsxs)(a.Fragment, {
        children: [
            (0, a.jsx)(_.FormItem, {
...
function U(e) {
    var t;
    let {guild: n} = e, s = (0, d.e7)([O], () => O.name), [r, l] = i.useState(!1), o = async () => {
            O.setError(null), l(!0);
            try {

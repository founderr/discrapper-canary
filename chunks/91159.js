...
function S(e, t) {
    ...
    let a = e.getGuildId(),
        ...
        l = (0, _.I)(a, s),
        E = (e) => {
            if ((0, d.yE)(e, p.iN.ALL_MESSAGES)) return _.$R[m.bL.ALL_MESSAGES];
            if ((0, d.yE)(e, p.iN.ONLY_MENTIONS)) return _.$R[m.bL.ONLY_MENTIONS];
            if ((0, d.yE)(e, p.iN.NO_MESSAGES)) return _.$R[m.bL.NO_MESSAGES];
            return _.$R[m.bL.NULL];
        },
        h = null !== (n = f.Z.flags(e.id)) && void 0 !== n ? n : 0,
        I = E(h),
        T = f.Z.isMuted(e.id),
        g = (0, _.sK)(f.Z.getMuteConfig(e.id)),

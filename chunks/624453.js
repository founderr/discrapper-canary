...
a = "ChannelPinsStore", (i = "displayName") in(l = S) ? Object.defineProperty(l, i, {
  ...
  MESSAGE_UPDATE: function(e) {
    ...
    if (null == s) return !1;
    let t = I[s];
    if (null == t && !e.message.pinned) return !1;
    if (null == e.message.author) {
      if (null != t) {
        let l = o().findIndex(t.messages, e => e.id === n);
        if (l >= 0) {
          let n = t.messages[l],
            i = (0, E.wi)(n, e.message);
          if (i !== n) {
    ...
    if (e.message.pinned) {
      ...
      let l = o().findIndex(t.messages, e => e.id === n); - 1 === l ? t.messages.unshift((0, E.e5)(e.message)) : t.messages[l] = (0, E.wi)(t.messages[l], e.message), I[s] = t
    } else {
      if (null == t) return;
  ...
  MESSAGE_DELETE: function(e) {
    ...
    if (null == t || 0 === o().remove(t.messages, e => e.id === n).length) return !1;
  ...
  MESSAGE_DELETE_BULK: function(e) {
    ...
    if (null != t) t.messages = t.messages.filter(e => -1 === n.indexOf(e.id))
  },
  ...
  MESSAGE_EXPLICIT_CONTENT_SCAN_TIMEOUT: function(e) {
    ...
    if (null == t) return;
    let l = o().findIndex(t.messages, e => e.id === n);
    if (-1 !== l) t.messages = t.messages.slice(), t.messages[l] = (0, c.Cm)(t.messages[l]), I[s] = t
  }
})
...
let R = String(0),
  ...
  N = '',
  d = I.m9.navigator && I.m9.navigator.language || I.m9.navigator && I.m9.navigator.languages && I.m9.navigator.languages['0'] || '',
...
let n = function(t) {
  ...
  s = function(t) {
    return 'thread_metadata' in t ? t : function(t) {
      ...
      if (!t.samples.length)
        return n;
      let _ = t.samples[0].timestamp,
        a = 'number' == typeof performance.timeOrigin ? performance.timeOrigin : E.Z1 || 0,
        i = a - (E.Z1 || a);
  ...
  O = 'number' == typeof t.start_timestamp ? 1000 * t.start_timestamp : Date.now(),
  S = 'number' == typeof t.timestamp ? 1000 * t.timestamp : Date.now();
return {
  event_id: r,

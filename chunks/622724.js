...
color: o,
onAction: l,
location: f = s.Z.CONTEXT_MENU
  } = e, h = (0, c.oV)(f), p = (0, i.e7)([d.default], () => d.default.getId() === t.id);
...
color: s,
onAction: c
  } = e, d = (0, i.e7)([l.ZP], () => l.ZP.get('iar_testing')), E = (0, o.x)();
  return t.id === E.id || t.isNonUserBot() || !E.isStaff() || !d ? null : (0, r.jsx)(a.MenuItem, {

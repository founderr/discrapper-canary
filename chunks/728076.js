...
var t = n(470079), r = n(263568), l = n(935369), s = n(398805), o = n(524100), i = n(316758), c = n(203143), u = n(79390), d = n(489887), _ = n(689938);
function m(e, a, n) {
    let m = e.id, A = t.useRef();
    ...
    let [f, C] = t.useState(A.current), [L, h] = t.useState(''), [R, I] = t.useState(r.C.DEFAULT), [x, p] = t.useState(!1), [O, g] = t.useState(d.lc.ONE_DAY), [T, N] = t.useState({}), [P, v] = t.useState(!1), j = f.filter(e => (0, u.cS)(e, R)), D = f.filter(e => (0, u.uY)(e, R)), M = L.length > 0 && j.length >= d.gY && 0 === D.length, [w, {
            ...
            var t;
            let r = f[a], l = null === (t = r.image) || void 0 === t ? void 0 : t.mediaAttachmentState;
            ...
            let t = f[a].localCreationAnswerId, r = URL.createObjectURL(n);

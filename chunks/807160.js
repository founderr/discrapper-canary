...
let es = e => 'https://'.concat(X.xr4, '/hc/').concat(e.toLowerCase(), '/requests/new?ticket_form_id=360000118612'), en = [
...
function ed(e) {
    ...
    let {
        ...
        } = e, i = (0, g.hO)(n, a, { requireCurrentGuild: !1 }), o = (0, S.e7)([O.Z], () => O.Z.getGuildProductFetchState(a) === O.M.FETCHING), l = null == i ? void 0 : i.role_id, c = (0, S.e7)([b.Z], () => null != l ? b.Z.getRole(n, l) : void 0, [
            n,
            l
    ...
    return o ? (0, r.jsx)('div', {
        ...
        children: [
            ...
            _ && (0, r.jsxs)(r.Fragment, {
                children: [
                    d && (0, r.jsx)('div', { className: ee.divider }),
                    (0, r.jsx)(N.Text, {
                        variant: 'text-xs/semibold',
                        color: 'header-secondary',
                        className: ee.guildProductBenefitLabel,
...
class e_ extends (a = o.PureComponent) {
    get daysSincePurchase() {
        let {payment: e} = this.props, t = null != e.sku ? e.sku.releaseDate : null, s = null != t && t.isAfter(e.createdAt) ? t : e.createdAt;
    ...
    renderPrice() {
        let {payment: e} = this.props, t = e.amount - e.amountRefunded;
        return (0, r.jsx)('span', {
            className: ee.price,
    ...
    renderPaymentIdField() {
        ...
        return (0, r.jsx)('li', {
            ...
            children: (0, r.jsxs)('div', {
                ...
                children: [
                    (0, r.jsx)('div', { children: $.Z.Messages.BILLING_PAYMENT_ID }),
                    (0, r.jsx)(eo, {
                        value: e.id,
    ...
    renderRefundDetails() {
        ...
        if (n.includes('PAYMENT_GATEWAY') || n.includes('PAYMENT_STATUS') || n.includes('ALREADY_REFUNDED') || n.includes('SKU_STICKER_PACK') || n.includes('SUBSCRIPTION_TYPE') || n.includes('GUILD_PRODUCT'))
            return null;
        let a = 0 === n.length, i = es(t), l = this.isPremium ? 5 : 14;
        return e = n.includes('SKU_TYPE') ? $.Z.Messages.BILLING_APPLICATION_CONSUMABLE_REFUND_TEXT_UNABLE.format({ supportURL: i }) : a ? s.isPremiumSubscription || s.isPremiumGuildSubscription ? $.Z.Messages.BILLING_PREMIUM_REFUND_TEXT.format({
            dateLimit: l,
            supportURL: i
    ...
    renderRefundActions(e) {
        ...
        let o = (null !== (t = a.premiumRefundDisqualificationReasons) && void 0 !== t ? t : [Q.d$.OTHER])[0], l = null != o || 0 !== e.length || a.isPurchasedExternally;
        return (0, r.jsxs)('div', {
            className: ee.refundActions,
            children: [
                (0, r.jsx)(N.Tooltip, {
                    ...
                    children: e => (0, r.jsx)(N.Button, {
                        ...
                        onClick: () => (0, N.openModalLazy)(async () => {
                            let {default: e} = await s.e('69473').then(s.bind(s, 436022));
                            return t => (0, r.jsx)(e, {
                                payment: a,
    ...
    renderDescription() {
        ...
        let {
                ...
                guild: i,
                stickerPack: l
            } = this.props, {expanded: c} = this.state, d = n.sku, E = n.subscription, T = null != n.paymentSource && X.Uk1.has(n.paymentSource.type);
        if (null != E && 0 !== E.items.length) {
            ...
            if (E.type === X.NYc.PREMIUM)
                ...
                s.push(t.format({ planName: e.name })), n = e.skuId;
            } else if (E.type === X.NYc.APPLICATION) {
                let e = j.Z.get(E.items[0].planId);
                _()(null != e, 'Application subscription plan should already have been loaded'), null != a ? s.push($.Z.Messages.MONTHLY_APPLICATION_SUBSCRIPTION_V2.format({ tier: null == d ? void 0 : d.name })) : s.push($.Z.Messages.APPLICATION_SUBSCRIPTION_FROM_DELETED_APPLICATION), n = e.skuId;
            }
    ...
    renderGuildProductBenefits() {
        ...
        return e.isGuildProductPurchase ? (0, r.jsxs)(r.Fragment, {
            children: [
                (0, r.jsx)('div', { className: ee.sectionDivider }),
    ...
    render() {
        let {
                ...
                className: t,
                compactMode: s
            } = this.props, {expanded: n} = this.state;
        return (0, r.jsx)(T.mh, {
            id: e.id,
            children: e => (0, r.jsxs)(N.Clickable, {
                onClick: this.handleExpandInfo,
                className: c()(n ? ee.payment : ee.hoverablePayment, t, { [ee.compact]: s }),
                focusProps: { offset: 4 },
                ...e,
                children: [
                    (0, r.jsxs)(U.Z, {
    ...
    constructor(...e) {
        super(...e), et(this, 'state', { expanded: !1 }), et(this, 'refundRules', [
            {
                rule: 'PURCHASE_DATE',
                canRefund: () => {
                    let {payment: e} = this.props, t = e.isPremiumSubscription || e.isPremiumGuildSubscription || e.isPremiumGift ? 5 : 14;
...
function eE(e) {
    ...
    let C = (0, S.e7)([b.Z], () => b.Z.getGuild(null == T ? void 0 : T.guildId)), m = c ? T : void 0;
    return (0, r.jsx)(e_, {
        applicationStatistics: u,
        application: E ? N : m,
        guild: C,
...
et(e_, 'defaultProps', { compactMode: !1 });

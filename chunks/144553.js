...
let A = s.memo(function(e) {
  ...
  let {
    ...
    return null
  }, [x, y, I, O, D]), P = (0, l.useStateFromStores)([f.default], () => null != x && f.default.isBlocked(x.author.id), [x]), b = (0, g.useContextMenuUser)(null == x ? void 0 : x.author.id, I.id), F = (0, g.useClickReply)(T, x, P), H = (0, g.useClickReferencedMessageAuthorUsername)(x, I, v, R), U = (0, g.useClickReferencedMessageAuthorAvatar)(L, R), k = s.useCallback(() => R({
    referencedUsernameProfile: !1,
    referencedAvatarProfile: !1
  }), [R]), w = (0, m.useNullableMessageAuthor)(T);

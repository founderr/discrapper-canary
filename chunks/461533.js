...
function M(e) {
  let {
    ...
    (0, n.trackReportRaidViewed)(s, c), (0, n.handleReportRaid)(s), M()
  }, [s, M, c]), I = S.useCallback(e => () => {
    i(s => s.includes(e) ? s.filter(s => s !== e) : [...s, e])
  }, []), d = S.useCallback(() => {
    open(_.COMMUNITY_PORTAL_SERVER_SAFETY_PAGE)
  }, []);
  return (0, a.jsxs)(r.ModalRoot, {
    ...
    children: [(0, a.jsx)(r.ModalHeader, {
      ...
      children: [(0, a.jsx)(r.Text, {
        ...
        children: _.REPORT_RAID_OPTIONS.map(e => (0, a.jsxs)(r.Clickable, {
          ...
          children: [(0, a.jsx)(r.Checkbox, {
            ...
            variant: "text-sm/normal",
            children: (0, _.getReportRaidTypeLabel)(e)
          })]
        }, e))
      })]

...
buttons: E = [],
header: x
  } = e, [N, v] = a.useState(!1), [S, Z] = a.useState(null), A = (0, c.e7)([w.Z], () => w.Z.can(eo.Plq.SEND_MESSAGES, t)), M = (0, $.a)({
location: 'PopoutReactor'
  }), [b, O] = a.useState(!1), [y, G] = a.useState(!1), {
voiceBar: z,
joinVoiceButton: K
  } = function(e) {
let {
...
} = (0, j.Z)(t.id), _ = (0, c.e7)([U.Z], () => null != r ? U.Z.getGuild(r.guild_id) : void 0), f = (0, c.Wu)([F.ZP], () => null != r ? F.ZP.getVoiceStatesForChannel(r) : [], [r]), E = (0, c.e7)([V.Z], () => V.Z.isInChannel(null == r ? void 0 : r.id)), C = a.useMemo(() => {
  for (let e of f) {
...
let g = null != l,
  x = () => {
    p.Z.updateChatOpen(r.id, !0), (0, P.Kh)(r.id), (0, ee.L)(er.xP.VOICE_CHANNEL_PREVIEWED, {
      entry: n,
      channelId: t.id,
      guildId: t.guild_id,
      requestId: s,
...
entry: _,
requestId: f
  }), q = null != K && 0 === E.length ? [K] : E, Q = q.length > 0, et = q.length >= 2, [ea, es] = a.useState(!Q), ed = '#'.concat(t.name), eh = Y.ZP.getName(t.guild_id, t.id, n), em = N ? ec.Z.Messages.CONTENT_INVENTORY_SWITCH_SEND_MESSAGE_TO_USER : ec.Z.Messages.CONTENT_INVENTORY_SWITCH_SHARE_TO_CHANNEL, ep = async e => {
if (null != e) {
  if (W.default.track(eo.rMx.CONTENT_POPOUT_EMOJI_CLICKED, {
    ...
    let a;
    if ((0, T.EW)(u.z.CONTENT_INVENTORY_ONE_CLICK_REPLY_COACHTIP), O(!0), G(!1), N)
      a = t;
    else {
      var i;
...
let i;
if (M && (0, T.EW)(u.z.CONTENT_INVENTORY_ONE_CLICK_REPLY_COACHTIP), N)
  i = t;
else {
...
o = (0, N.wC)(t.guild_id).slice(0, 5).map(e => null == e.id ? {
  emoji: e,
  url: e.url
} : {
  emoji: e,
...
numOtherParticipants: d
  } = (0, Q.Z)(a, 3), m = (0, c.e7)([G.default], () => G.default.getUser(a.author_id)), {
streamPreviewUrl: p
  } = (0, J.Z)(a), _ = [
o,
u
...
onClickSubtitle: E,
...C
  } = e, g = (0, c.e7)([k.Z], () => k.Z.getChannel(null == r ? void 0 : r.channelId)), [I] = a.useMemo(() => (0, M.p9)(g, V.Z, U.Z, w.Z, S.Z), [g]), {
entry: x
  } = C, T = (0, q.dX)(x), N = (0, A.Z)({
location: 'ContentPopout',

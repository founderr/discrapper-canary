var n = r(73009), i = r(837512), o = r(213912), a = r(546870), u = r(49287), s = r(114080), c = r(680643), l = r(316103), f = r(65183), p = r(856520), h = f.List, d = f.Record, g = f.Repeat, y = function (t) {
        function e() {
        ...
        return d.getEntityMap = function () {
            ...
            var i = Array.isArray(t) ? t : t.contentBlocks, o = n.createFromArray(i), a = o.isEmpty() ? new s() : s.createEmpty(o.first().getKey());
            return new e({
                blockMap: o,
                entityMap: r || u,
                selectionBefore: a,

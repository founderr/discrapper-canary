t(789020), t(47120);
var i = t(735250), s = t(470079), l = t(120356), a = t.n(l), r = t(481060), o = t(332148), u = t(904245), d = t(933557), c = t(372900), E = t(726521), f = t(294218), g = t(699516), m = t(594174), M = t(387204), _ = t(630388), N = t(970257), h = t(981631), I = t(689938), Z = t(421476);
function p(e, n, t) {
...
class A extends s.PureComponent {
    ...
    constructor(...e) {
        super(...e), p(this, 'state', { report: !1 }), p(this, 'handleDelete', () => {
...
n.Z = {
    confirmPin: function (e, n) {
        (0, r.openModal)(t => {
            ...
            return s = e.isPrivate() ? I.Z.Messages.PIN_MESSAGE_BODY_PRIVATE_CHANNEL : I.Z.Messages.PIN_MESSAGE_BODY.format({ channelName: l }), (0, i.jsx)(c.Z.Provider, {
                value: e.guild_id,
                children: (0, i.jsxs)(r.ConfirmModal, {
        ...
        (0, r.openModal)(t => (0, i.jsx)(c.Z.Provider, {
            ...
            children: (0, i.jsxs)(r.ConfirmModal, {
                ...
                children: [
                    ...
                    (0, i.jsx)(M.Z, { children: I.Z.Messages.UNPIN_MESSAGE_CONTEXT_MENU_HINT.format() })
                ]
            })
        }));
    },

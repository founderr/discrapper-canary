...
let {
  ...
  ...o
} = this.props, c = a.type === f.d4z.GUILD_ANNOUNCEMENT && (0, h.yE)(s.flags, f.iLy.CROSSPOSTED);
return r && (e = (0, i.jsx)(T.Z, {
  className: p.spacingTop,
  children: C.Z.Messages.DELETE_MESSAGE_CONTEXT_MENU_HINT.format()
})), (0, N.vc)(s) && (t = (0, i.jsx)(l.FormSwitch, {
  value: n,
...
(0, l.openModal)(n => {
  let a;
  let s = (0, u.F6)(e, m.default, I.Z);
  return a = e.isPrivate() ? C.Z.Messages.PIN_MESSAGE_BODY_PRIVATE_CHANNEL : C.Z.Messages.PIN_MESSAGE_BODY.format({
    channelName: s
  }), (0, i.jsx)(d.Z.Provider, {
    value: e.guild_id,
    children: (0, i.jsxs)(l.ConfirmModal, {
...
(0, l.openModal)(a => (0, i.jsx)(l.ConfirmModal, {

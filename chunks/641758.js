...
function S(e) {
	let { transitionState: s, applicationId: t, viewId: a, background: n, onClose: r } = e,
					...
					children: [
						...
						(0, o.jsxs)('div', {
							...
							children: [
								...
								(0, o.jsx)('div', {
									className: E()(I.answers, { [I.gridFour]: Z.length % 4 == 0 }),
									children: Z.map((e) => {
										let { key: s, text: t, isChecked: a, Icon: n, disabled: _ } = e;
										return (0, o.jsxs)(
											C.Checkbox,
											{

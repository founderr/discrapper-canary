...
var r, i, a, o, s = n(512722), l = n.n(s), u = n(261470), c = n(544891), d = n(911969), _ = n(367907), E = n(710845), f = n(432877);
n(893233);
var h = n(873741), p = n(314897), m = n(866960), I = n(70956), T = n(403182), g = n(651655), S = n(861990), A = n(141795), N = n(981631);
function v(e, t, n) {
...
let R = e => 0 === e.type, C = e => 1 === e.type, y = e => R(e) ? e.message.nonce : C(e) ? e.message.messageId : e.message.data.id, D = [
        1 * I.Z.Millis.MINUTE,
        5 * I.Z.Millis.MINUTE
    ];
class L extends g.Z {
    ...
    cancelPendingSendRequests(e) {
        ...
        for (; this.queue.length > 0;) {
            let r = this.queue.shift(), {message: i} = r;
    ...
    handleSend(e, t) {
        ...
        null != O && (O.isInstanceUILocked() ? n = { location: 'overlay_locked_activated' } : !O.isInstanceUILocked() && (n = O.isPinned(N.Odu.TEXT) ? { location: 'overlay_unlocked_pinned' } : { location: 'overlay_unlocked' }));
        let d = this.createResponseHandler(e.nonce, t), _ = new AbortController();

...
class u {
  ...
  updateFps(e, t, n) {
    if (!this.disabled) {
      if (!this.streamDisabledUsers.has(e)) {
        ...
        this.perUserFpsWindow[e].length > this.windowLength && this.perUserFpsWindow[e].shift(), this.perUserFpsWindow[e].filter(e => e < this.fpsThreshold).length >= this.fpsWindowBorderlineCount ? (this.logger.info("".concat(e, ": detected poor network quality, turning off video")), this.streamDisabledUsers.add(e), this.currentVideoAutoToggleState[e] = a.ZUi.DISABLED, (0, s.Z)(e, a.ZUi.DISABLED), this.startReenableBackoffTimer(e)) : this.currentVideoAutoToggleState[e] === a.ZUi.AUTO_PROBING && (this.currentVideoAutoToggleState[e] = a.ZUi.AUTO_ENABLED, this.logger.info("acceptable conditions reached, will reset and send a AUTO_ENABLED for user ".concat(e)), (0, s.Z)(e, a.ZUi.AUTO_ENABLED)), this.probingUserId === e && (this.probingUserId = void 0, this.tryReenableQueue())
      }
    }
  }
  startReenableBackoffTimer(e) {
    ...
    null === t || n > 16 || this.elapsedSeconds((0, r.zO)(), t) > 600 ? n = 1 : n *= 2, this.retryBackoffCache[e] = {
      lastBackoffTime: (0, r.zO)(),
      expBackoffFactor: n
    };
    let i = n * this.backoffTimeSec * o.Z.Millis.SECOND;
  ...
  reenableVideo(e) {
    return e in this.perUserFpsWindow && (this.logger.info("reenableVideo called for user ".concat(e, " - time = ").concat((0, r.zO)())), this.stateCleanupBeforeEnable(e), this.currentVideoAutoToggleState[e] = a.ZUi.AUTO_PROBING, this.probingUserId = e, (0, s.Z)(e, a.ZUi.AUTO_PROBING), !0)
  }
  elapsedSeconds(e, t) {
    return (e - t) / 1e3
  }
  ...
  createUser(e) {
    this.logger.info("VideoHealthManager::createUser ".concat(e)), !(e in this.perUserFpsWindow) && (this.perUserFpsWindow[e] = [], this.prevFramesCodec[e] = -1, this.currentVideoAutoToggleState[e] = a.ZUi.NONE, this.retryBackoffCache[e] = {

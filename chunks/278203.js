var n = r(733359), i = r(488959), o = r(75032), a = r(581079);
function u(t, e) {
    for (var r = 1 / 0, n = 1 / 0, i = -1 / 0, o = -1 / 0, a = 0; a < t.length; a++) {
        var u = t[a];
        if (0 !== u.width && 1 !== u.width)
            r = Math.min(r, u.top), n = Math.min(n, u.bottom), i = Math.max(i, u.top), o = Math.max(o, u.bottom);
    }
    ...
    for (var y = d, v = g - 1;;) {
        for (var m = y.nodeValue, _ = v; _ >= 0; _--) {
            if (!(null != m && _ > 0 && n.isSurrogatePair(m, _ - 1)))
                if (t.setStart(y, _), u(o(t), h))
                    d = y, g = _;
                else
                    break;
        }
        if (-1 === _ || 0 === y.childNodes.length)
            break;
        v = function (t) {
            switch (t.nodeType) {

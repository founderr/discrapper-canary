...
var r = n(250327), i = n(951516), a = n(217224);
function o(e, t) {
    (0, i.Z)(1, arguments);
    var n, o, h, p = (0, a.Z)(null !== (n = null == t ? void 0 : t.additionalDigits) && void 0 !== n ? n : 2);
    if (2 !== p && 1 !== p && 0 !== p)
        throw RangeError('additionalDigits must be 0, 1 or 2');
    if (!('string' == typeof e || '[object String]' === Object.prototype.toString.call(e)))
        return new Date(NaN);
    var m = function (e) {
        var t, n = {}, r = e.split(s.dateTimeDelimiter);
        if (r.length > 2)
            return n;
    ...
    if (m.date) {
        var I = function (e, t) {
            var n = RegExp('^(?:(\\d{4}|[+-]\\d{' + (4 + t) + '})|(\\d{2}|[+-]\\d{' + (2 + t) + '})$)'), r = e.match(n);
            if (!r)
                return {
                    year: NaN,
                    restDateString: ''
        ...
        o = function (e, t) {
            ...
            if (!n)
                return new Date(NaN);
            var r = !!n[4], i = d(n[1]), a = d(n[2]) - 1, o = d(n[3]), s = d(n[4]), u = d(n[5]) - 1;
            if (r)
                return !function (e, t, n) {
                    return t >= 1 && t <= 53 && n >= 0 && n <= 6;
                }(t, s, u) ? new Date(NaN) : function (e, t, n) {
                    var r = new Date(0);
            ...
            }(t, i) ? new Date(NaN) : (c.setUTCFullYear(t, a, Math.max(i, o)), c);
    ...
    if (m.timezone) {
        if (isNaN(h = function (e) {
                ...
                if (!t)
                    return 0;
                var n = '+' === t[1] ? -1 : 1, i = parseInt(t[2]), a = t[3] && parseInt(t[3]) || 0;
                return !function (e, t) {
                    return t >= 0 && t <= 59;
        ...
        var S = new Date(T + g), A = new Date(0);
...
var s = {
        ...
        timezone: /([Z+-].*)$/
    }, l = /^-?(?:(\d{3})|(\d{2})(?:-?(\d{2}))?|W(\d{2})(?:-?(\d{1}))?|)$/, u = /^(\d{2}(?:[.,]\d*)?)(?::?(\d{2}(?:[.,]\d*)?))?(?::?(\d{2}(?:[.,]\d*)?))?$/, c = /^([+-])(\d{2})(?::?(\d{2}))?$/;
function d(e) {

...
onChannelContextMenu: _
  } = e, h = r.useRef(null), E = (0, Z.ZP)(s, !0);
  return (0, a.jsx)(J, {
children: (0, a.jsxs)('div', {
...
onPreviewClick: l,
guildId: o
  } = e, d = (0, c.e7)([M.Z], () => M.Z.getChannel(r.channelId)), [_, h] = (0, O.wq)(d), E = (0, a.jsxs)(u.Clickable, {
onClick: _ ? l : void 0,
...
if (null != _)
  ...
  D.default,
  P.default
], () => Array.from(s).map(e => P.default.getId() === e ? null : D.default.getUser(e)).filter(B.lm)),
m = (0, h.O)(),
{
...
f = (0, k.getAssetImage)(p.id, o, 300);
  return (0, a.jsxs)(J, {
children: [
  (0, a.jsxs)('div', {

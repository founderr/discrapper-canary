...
es.Header = ea, es.Body = e => {
  ...
  } = e, E = i.useRef(null), _ = (0, R.default)(s, !0);
  return (0, l.jsx)(ee, {
    children: (0, l.jsxs)("div", {
  ...
  let {
    ...
    onPreviewClick: r,
    guildId: o
  } = e, d = (0, u.useStateFromStores)([y.default], () => y.default.getChannel(i.channelId)), [f, E] = (0, O.useCanWatchStream)(d), _ = (0, l.jsxs)(c.Clickable, {
    onClick: f ? r : void 0,
  ...
  let _ = (0, u.useStateFromStoresArray)([D.default, P.default], () => Array.from(s).map(e => P.default.getId() === e ? null : D.default.getUser(e)).filter(V.isNotNullish)),
  ...
  let I = null != t.created_at && t.created_at > 0 ? {
    ...
    T = (0, H.getAssetImage)(S.id, o, 300);
  return (0, l.jsxs)(ee, {
    children: [(0, l.jsxs)("div", {

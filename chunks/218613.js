...
function ee(e) {
  ...
  return (l.useEffect(() => {
    t(i)
  }, [i, t]), null == d) ? null : (0, r.jsx)(p.ModalContent, {
...
class et extends l.PureComponent {
  ...
  componentDidUpdate(e, t) {
    ...
    }), !t.isPrivate && this.state.isPrivate && T.ZP.trackWithMetadata(V.rMx.OPEN_MODAL, {
  ...
  renderName() {
    ...
    let i = l === V.d4z.GUILD_CATEGORY,
      o = i ? q.Z.Messages.CATEGORY_NAME : q.Z.Messages.FORM_LABEL_CHANNEL_NAME,
      d = null != t ? (0, r.jsx)(p.FormText, {
        className: Q.channelNameNote,
        type: p.FormText.Types.DESCRIPTION,
        children: q.Z.Messages.CLONE_CHANNEL_HELP.format({
          name: (0, L.F6)(t, B.default, y.Z, !0)
        })
        ...
        options: function(e) {
          ...
          return o.push({
            ...
            description: (0, r.jsxs)(p.Text, {
              ...
              children: [q.Z.Messages.FORUM_CHANNEL_DESCRIPTION, (0, r.jsx)("br", {}), q.Z.Messages.LEARN_MORE_CLICK.format({
                onClick: () => {
                  open(W.V8)
                }
              })]
            ...
            description: (0, r.jsxs)(p.Text, {
              ...
              color: "header-secondary",
              className: Q.radioLabelDescription,
              children: [q.Z.Messages.CREATE_MEDIA_CHANNEL_DESCRIPTION, (0, r.jsx)("br", {}), q.Z.Messages.LEARN_MORE_CLICK.format({
                onClick: () => {
  ...
  renderChannelTypeDescription(e) {
    let t;
    return (e === V.d4z.GUILD_ANNOUNCEMENT && (t = q.Z.Messages.FORM_HELP_NEWS.format({
      documentationLink: Y.Z.getArticleURL(V.BhN.ANNOUNCEMENT_CHANNELS)
    })), null == t) ? null : (0, r.jsx)(p.FormText, {
  ...
  renderStoreOptions() {
    ...
    return (0, r.jsxs)("div", {
      children: [(0, r.jsx)(p.FormTitle, {
      ...
      }) : null, null != t && i ? (0, r.jsxs)(p.FormSwitch, {
        hideBorder: !0,
        ...
        children: [(0, r.jsx)(p.KeyIcon, {
          size: "md",
          color: "currentColor",
          className: Q.switchIcon
        }), q.Z.Messages.CREATE_STORE_CHANNEL_BETA_TITLE]
      }) : null, null != t ? (0, r.jsxs)(l.Fragment, {
        children: [a ? (0, r.jsx)(p.FormTitle, {
          tag: "h5",
  ...
  renderAddMemberSlideContent() {
    ...
    return (0, r.jsxs)(r.Fragment, {
      children: [(0, r.jsxs)(p.ModalHeader, {
        separator: !1,
        children: [(0, r.jsxs)("div", {
          className: Q.header,
          children: [(0, r.jsx)(p.Heading, {
  ...
  constructor(e) {
    super(e), $(this, "headerId", (0, F.hQ)()), $(this, "_input", void 0), $(this, "setInputRef", e => {
      ...
      if (null != g) {
        ...
        else if (N === V.d4z.GUILD_ANNOUNCEMENT) t = (0, w.rt)(g);
        else {
          if (_) {
            t = (0, w.oQ)(g, N, [], !0);
            let e = (0, S.Tj)(E, N);
        ...
        try {
          ...
          null != e.body && "object" == typeof e.body ? this.setState({
            ...
            errors: {
              message: q.Z.Messages.ERROR_OCCURRED_TRY_AGAIN
            }
          })
        }
      }
...
t.default = l.forwardRef(function(e, t) {
  let {
    ...
    guildId: n,
    cloneChannelId: a
  } = e, l = (0, C.cj)([H.Z, B.default, U.Z, G.Z, M.Z, f.ZP], () => {
    var e, t, r;
    let l = H.Z.getGuild(n),
      i = B.default.getCurrentUser();
    c()(null != i, "CreateChannel: user cannot be undefined");
    let o = null != l && null != l.ownerId ? B.default.getUser(l.ownerId) : null,
      d = new Set(null !== (t = null === (e = f.ZP.getMember(n, i.id)) || void 0 === e ? void 0 : e.roles) && void 0 !== t ? t : []),
      h = U.Z.can(V.Plq.ADMINISTRATOR, l),
      u = G.Z.getChannel(a);
    return {
      guild: l,

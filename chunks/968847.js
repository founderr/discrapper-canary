...
function O(e) {
  ...
  let {
guildChannels: l
  } = v.Z.getGuildWithoutChangingGuildActionRows(e), r = l.getChannels(null !== (t = b[e]) && void 0 !== t ? t : []);
...
return !!(null != i && i.hasFeature(Z.oNc.COMMUNITY)) && null != n && !u().isEqual(b[t], n) && (b[t] = n, O(t));
  },
  BULK_ACK: function(e) {
let {
  channels: t

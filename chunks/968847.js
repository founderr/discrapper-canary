...
function M(e) {
    ...
    if (h || d)
        for (let e = g.length - 1; e >= 0; e--) {
            let t = g[e];
            (A(t.id) || u().some(t.threadIds, A)) && (null == o && (o = t.id), (I = !0)), (P(t.id) || u().some(t.threadIds, P)) && (null == a && (a = t.id), (v += x.ZP.getMentionCount(t.id) + u().sumBy(t.threadIds, x.ZP.getMentionCount)));
        }
    if (h || d)
        for (let e = 0; e < _.length; e++) {
            let t = _[e];
            if (!h && !d) break;
            (A(t.id) || u().some(t.threadIds, A)) && (null == c && (c = t.id), (N = !0)), (P(t.id) || u().some(t.threadIds, P)) && (null == s && (s = t.id), (b += x.ZP.getMentionCount(t.id) + u().sumBy(t.threadIds, x.ZP.getMentionCount)));
        }
    let S = null,
        y = null,
    ...
    let L = null != y && (null == S || ('mentions' !== S.mode && 'mentions' === y.mode)),
...
function k(e) {
    ...
    if (null == n) return !1;
    let i = _.Z.getGuild(n.guild_id);
    return !!(null != i && i.hasFeature(S.oNc.COMMUNITY)) && v.Z.getGuildId() === n.guild_id && L(n.guild_id);
}
function G(e) {
    let { guildId: t } = e;
    return null != t && L(t);
    ...
    (t.Z = new U(h.Z, {
        UPDATE_CHANNEL_LIST_DIMENSIONS: function (e) {
            let { guildId: t, channelIds: n } = e,
                i = _.Z.getGuild(t);
            return !!(null != i && i.hasFeature(S.oNc.COMMUNITY)) && null != n && !u().isEqual(j[t], n) && ((j[t] = n), M(t));
        },
        BULK_ACK: function (e) {
            let { channels: t } = e,
                n = !1;
            return (
                u()(t)
                    ...
                    .forEach((e) => {
                        ...
                        null != t && t.hasFeature(S.oNc.COMMUNITY) && L(e) && (n = !0);
                    }),
                n
            );
        },
        ...
        PASSIVE_UPDATE_V2: function (e) {
            ...
            return !!(e.channels.length > 0 && null != t && t.hasFeature(S.oNc.COMMUNITY)) && L(e.guildId);
        },
        RESORT_THREADS: k,
        THREAD_CREATE: O,
        THREAD_DELETE: O,

...
var i, l, r, a, s, o, c = n(392711), u = n.n(c), d = n(442837), h = n(570140), p = n(220444), _ = n(565799), f = n(501655), g = n(569471), m = n(592125), C = n(430824), I = n(306680), E = n(914010), N = n(9156), x = n(938475), S = n(823379), Z = n(734307), v = n(981631);
...
function O(e) {
    ...
    if (null == r || 0 === r.length)
        return !1;
    let a = null, s = null, o = null, c = null, d = !0, h = !0, p = !1, _ = l.getCategoryFromSection(l.voiceChannelsSectionNumber), f = null !== (n = null == _ ? void 0 : _.getShownChannelIds()) && void 0 !== n ? n : [], [g, m, C] = l.getSlicedChannels(r);
...
function U(e) {
    let {channel: t} = e, n = m.Z.getChannel(t.id);
    if (null == n)
        return !1;
...
function G(e) {
    let {channelId: t} = e, n = m.Z.getChannel(t);
    if (null == n)
        return !1;
    let i = C.Z.getGuild(n.guild_id);

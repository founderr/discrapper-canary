...
function P(e) {
    ...
    let O = null != b && (null == Z || ('mentions' !== Z.mode && 'mentions' === b.mode)),
    ...
    (t.Z = new k(h.Z, {
        UPDATE_CHANNEL_LIST_DIMENSIONS: function (e) {
            let { guildId: t, channelIds: n } = e,
                i = C.Z.getGuild(t);
            return !!(null != i && i.hasFeature(Z.oNc.COMMUNITY)) && null != n && !u().isEqual(M[t], n) && ((M[t] = n), P(t));
        },
        BULK_ACK: function (e) {
            let { channels: t } = e,
                n = !1;
            return (
                u()(t)
                    ...
                    .forEach((e) => {
                        ...
                        null != t && t.hasFeature(Z.oNc.COMMUNITY) && O(e) && (n = !0);
                    }),
                n
            );
        },

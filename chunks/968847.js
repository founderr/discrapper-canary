...
var i, l, r, a, s, o, c = n(392711), u = n.n(c), d = n(442837), h = n(570140), p = n(220444), _ = n(565799), f = n(501655), m = n(569471), g = n(592125), C = n(430824), I = n(306680), E = n(914010), N = n(9156), x = n(938475), S = n(823379), v = n(734307), Z = n(981631);
...
function y(e) {
    var t, n, i;
    let {guildChannels: l} = v.Z.getGuildWithoutChangingCommunityRows(e), r = l.getChannels(null !== (t = b[e]) && void 0 !== t ? t : []);
    ...
    let Z = null, L = null, y = null !== (i = null == _ ? void 0 : _.getChannelRecords()) && void 0 !== i ? i : [];
    d && x > 0 ? Z = {
        mode: 'mentions',
        mentionCount: x,
        targetChannelId: o
    ...
    let P = null != L && (null == Z || 'mentions' !== Z.mode && 'mentions' === L.mode), j = null != Z && ('mentions' === Z.mode || !P);
    return A[e] = {
        topBar: P && null != L ? L : T,
        bottomBar: j && null != Z ? Z : T
    }, !0;
}
let P = u().throttle(y, 200);
function j(e) {
    let {guildId: t} = e, n = C.Z.getGuild(t);
    return !!(null != n && n.hasFeature(Z.oNc.COMMUNITY)) && P(t);
}
function D(e) {
    ...
    return !!(null != i && i.hasFeature(Z.oNc.COMMUNITY)) && P(n.guild_id);
}
function U(e) {
...
function w(e) {
    ...
    if (null == n)
        return !1;
    let i = C.Z.getGuild(n.guild_id);
    return !!(null != i && i.hasFeature(Z.oNc.COMMUNITY)) && E.Z.getGuildId() === n.guild_id && P(n.guild_id);
}
function G(e) {
    let {guildId: t} = e;
    return null != t && P(t);
...
o = 'ChannelListUnreadsStore', (s = 'displayName') in (a = k) ? Object.defineProperty(a, s, {
    ...
    UPDATE_CHANNEL_LIST_DIMENSIONS: function (e) {
        ...
        return !!(null != i && i.hasFeature(Z.oNc.COMMUNITY)) && null != n && !u().isEqual(b[t], n) && (b[t] = n, y(t));
    },
    BULK_ACK: function (e) {
        ...
        return u()(t).map(e => {
            ...
            null != t && t.hasFeature(Z.oNc.COMMUNITY) && P(e) && (n = !0);
        }), n;
    },
    CHANNEL_ACK: w,
    CHANNEL_DELETE: U,
    ...
    PASSIVE_UPDATE_V2: function (e) {
        ...
        return !!(e.channels.length > 0 && null != t && t.hasFeature(Z.oNc.COMMUNITY)) && P(e.guildId);
    },
    RESORT_THREADS: w,
    THREAD_CREATE: U,
    THREAD_DELETE: U,

...
function y(e) {
  ...
  let {
    guildChannels: l
  } = Z.Z.getGuildWithoutChangingCommunityRows(e), r = l.getChannels(null !== (t = b[e]) && void 0 !== t ? t : []);
  ...
  for (let e = 0; e < m.length; e++) {
    let t = m[e];
    if ((M(t.id) || u().some(t.threadIds, M)) && (h = !1), (R(t.id) || u().some(t.threadIds, R)) && (d = !1), f.includes(t.id) && (p = !0), !h && !d && p) break
  }
  let E = 0,
    N = !1,
    x = 0,
  ...
  let P = null != L && (null == v || "mentions" !== v.mode && "mentions" === L.mode),
    j = null != v && ("mentions" === v.mode || !P);
  return A[e] = {
    topBar: P && null != L ? L : T,
...
o = "ChannelListUnreadsStore", (s = "displayName") in(a = k) ? Object.defineProperty(a, s, {
  ...
  UPDATE_CHANNEL_LIST_DIMENSIONS: function(e) {
    ...
    return !!(null != i && i.hasFeature(v.oNc.COMMUNITY)) && null != n && !u().isEqual(b[t], n) && (b[t] = n, y(t))
  },
  BULK_ACK: function(e) {
    let {
      channels: t
  ...
  USER_GUILD_SETTINGS_FULL_UPDATE: function(e) {
    ...
    for (let e of t) null != e.guild_id && P(e.guild_id)
  },

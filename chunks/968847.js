...
function y(e) {
  ...
  let {
guildChannels: l
  } = v.Z.getGuildWithoutChangingCommunityRows(e), r = l.getChannels(null !== (t = b[e]) && void 0 !== t ? t : []);
...
for (let e = 0; e < C.length; e++) {
  ...
  let Z = null,
L = null,
y = null !== (i = null == _ ? void 0 : _.getChannelRecords()) && void 0 !== i ? i : [];
  d && x > 0 ? Z = {
mode: 'mentions',
mentionCount: x,
targetChannelId: o
...
targetChannelId: s
  ...
  let P = null != L && (null == Z || 'mentions' !== Z.mode && 'mentions' === L.mode),
j = null != Z && ('mentions' === Z.mode || !P);
  return A[e] = {
topBar: P && null != L ? L : T,

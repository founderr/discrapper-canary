...
function x(e) {
  let {
    ...
    appContext: l,
    onSelect: x
  } = e, v = (0, i.useStateFromStores)([u.default], () => u.default.getSelectedParticipant(t)), N = (null == v ? void 0 : v.type) === I.ParticipantTypes.STREAM ? v.stream : null, M = (0, h.default)(t);

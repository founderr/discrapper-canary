...
let M = e => {
  ...
  y = e => {
    let {
      currentStatus: t
    } = e, s = l.useRef(_.default.getRecentCustomStatuses()), r = l.useRef((0, h.isDismissibleContentDismissed)(d.DismissibleContent.HANG_STATUS_NEW_BADGE)).current, y = (0, T.getHangStatusOptions)(), [R, L] = l.useState(null != t ? t : null), O = (0, u.useStateFromStores)([m.default], () => m.default.getCurrentUser()), j = () => {

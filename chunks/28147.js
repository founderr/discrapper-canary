                    ...
                    return (0, i.jsx)(P.Z, {
                        ...
                        onClick: () => {
                            ...
                            _.y(A.ti.DISMISSED), (0, m.Mo)({
                                ...
                                searchResultsPosition: n,
                                source: e
                            }), p.S.dispatch(g.CkL.FOCUS_CHANNEL_TEXT_AREA, { channelId: t.id });
                        }
                    }, l.id);
                })
            })
...
function Z(e) {
    let {trackSearchResultsItemImpressionRef: n} = (0, C.Z)({
...
function H(e) {
    ...
    return a ? (0, i.jsxs)('div', {
        children: [
            (0, i.jsx)(I.Z, { title: R.Z.Messages.APPS }),
            (0, i.jsxs)('div', {
                className: S.sectionContentContainer,
                children: [
                    n.map((e, n) => {
        ...
        children: [
            (0, i.jsx)(I.Z, { title: R.Z.Messages.EMBEDDED_ACTIVITIES_SHELF_TITLE }),
            (0, i.jsxs)('div', {
...
function D() {
    return (0, i.jsxs)('div', {
        children: [
            (0, i.jsx)(I.Z, { title: R.Z.Messages.COMMANDS }),
            (0, i.jsx)('div', {
                className: S.sectionContentContainer,

...
var i = t(735250),
  ...
  b = t(689938),
  S = t(429032);
let T = Array(6).fill(0).map((e, n) => n),
  M = [, , , ].fill(0).map((e, n) => n);
...
P = g.length > 0,
L = p && !P && !I;
  return u ? (0, i.jsx)(k, {}) : L ? (0, i.jsx)(x.A, {
type: h.LG.SEARCH_EMPTY,
searchQuery: t,
textContent: l === h._b.TEXT ? b.Z.Messages.APP_LAUNCHER_SEARCH_EMPTY_STATE_BODY : b.Z.Messages.APP_LAUNCHER_SEARCH_EMPTY_STATE_ACTIVITIES_BODY
  }) : (0, i.jsxs)('div', {
children: [
  C && (0, i.jsx)(Z, {
    channel: n,
...
o,
m
  ]), [E, v] = a.useState(!1), x = null !== (n = (0, s.Z)(E)) && void 0 !== n ? n : E, P = a.useCallback(() => v(e => !e), []), T = (null !== (t = (0, s.Z)(r)) && void 0 !== t ? t : r)[0] !== r[0], M = E && !T;

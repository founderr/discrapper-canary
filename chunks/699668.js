  ...
  let u = (0, l.useStateFromStoresArray)([p.default], () => Object.values(p.default.getGuilds())),
    d = a.useCallback(() => {
      ...
      for (let i of u) a[i.id] = function(e, t, n, a, i) {
        var s;
        let [l, o, r] = m.default.hasConsented(P.Consents.PERSONALIZATION) ? (0, A.guessGuildModeWithRemoteData)(e, t, n, a, !0) : (0, A.guessGuildModeWithLocalData)(e, n), u = null !== (s = n.filter(t => t.guild_id === e.id)[0]) && void 0 !== s ? s : {}, d = (0, M.default)(e, null != i ? i : l, u, a, t);
        return {
          guildId: e.id,
          mode: l,
          debugReason: r,
...
function x(e, t) {
  return Object.values(p.default.getGuilds()).some(n => {
    let [a] = m.default.hasConsented(P.Consents.PERSONALIZATION) ? (0, A.guessGuildModeWithRemoteData)(n, b.defaultThresholds, e, t, !1) : (0, A.guessGuildModeWithLocalData)(n, e);

...
var r, i, a = n(735250), o = n(470079), s = n(120356), l = n.n(s), u = n(266067), c = n(729594), d = n(373793), _ = n(243814), E = n(149765), f = n(442837), h = n(693789), p = n(952265), m = n(21340), I = n(922770), T = n(481060), g = n(893776), S = n(434650), A = n(367907), N = n(702493), v = n(728345), O = n(979200), R = n(560067), C = n(353926), y = n(341298), D = n(703656), L = n(973616), b = n(598077), M = n(314897), P = n(700785), U = n(591759), w = n(807675), x = n(489863), G = n(228763), k = n(422559), B = n(713938), F = n(166148), V = n(807989), H = n(260430), Z = n(668185), Y = n(407546), j = n(41259), W = n(28752), K = n(787025), z = n(397394), q = n(574384), Q = n(981631), X = n(689938), $ = n(248702);
let J = 'oauth2-authorize-header-id';
function ee() {
    let e = (0, u.TH)(), t = o.useMemo(() => (0, w.y)(e.search), [e.search]);
...
function et(e) {
    ...
    return (0, a.jsx)(K.j, {
        ...
        children: (0, a.jsx)('div', {
            className: l()($.authorize, { [$.inApp]: n.inApp }),
...
function en(e) {
    ...
    return t ? (0, a.jsxs)('div', {
        ...
        className: l()($.authorize, { [$.inApp]: n.inApp }),
        children: (0, a.jsx)('div', { children: c })
    });
}
function er(e) {
    var t, n, r, i, s;
    let l, p, m, N, R, y, {
            ...
            onClose: eA,
            disclosures: eN
        } = e, ev = null != e_ ? null == es ? void 0 : es.get(e_) : void 0, eO = (0, u.TH)(), eR = (0, f.e7)([C.Z], () => C.Z.hasLoadedExperiments);
    o.useEffect(() => {
    ...
    let eX = o.useMemo(() => {
            ...
            let e = ez ? null == eX ? void 0 : eX.scopes : el, t = (0, w.K)(null != e ? e : []), n = B.Qe.filter(e => t.includes(e));
            return {
                requestedScopes: t,
                accountScopes: n
            };
            ...
            eu,
            ez
        ]), e1 = o.useRef(!1), [e2, e3] = o.useState(null != eN ? eN : []), [e4, e5] = o.useState(null != eN && eN.length > 0);
    o.useEffect(() => {
        if (e1.current)
            return;
        let e = async () => {
    ...
    let e6 = o.useCallback(async e => {
            ...
            eF,
            e2
        ]), e7 = o.useRef(!1), e8 = o.useCallback(async () => {
            if (!M.default.isAuthenticated()) {
                (0, x.c$)(eO);
                return;
            }
            if (!e1.current) {
                if (!e7.current) {
                    ...
                    try {
                        ...
                        ey((0, G.d)(e)), eo === F.s.NONE && e.authorized && !e4 && e6(!0), (0, A.yw)(Q.rMx.OAUTH2_AUTHORIZE_VIEWED, { application_id: e.application.id });
                    } catch (n) {
                        let {
                            status: e,
                            body: t
    ...
    if (eb instanceof Error)
        return { body: (0, a.jsx)(z.Lk, { message: eb.message }) };
    let tn = !1, tr = !0, ti = !0, ta = !0;
    switch (eD) {
    case null:
    ...
    case 1:
        if (null == eC || null == eY || null == eW)
            return { body: (0, a.jsx)(I.$, {}) };
        let to = null == eb || eb instanceof Error ? {} : eb, ts = null == eG ? void 0 : eG.sort((e, t) => e.name.toLowerCase().localeCompare(t.name.toLowerCase())), tl = eW === d.Y.GUILD_INSTALL && e$.includes(_.x.WEBHOOK_INCOMING), tu = tl || eW === d.Y.GUILD_INSTALL && (e$.includes(_.x.BOT) || e$.includes(_.x.APPLICATIONS_COMMANDS));

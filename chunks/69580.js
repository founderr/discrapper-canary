...
function e_(e) {
    ...
    let d,
        ...
        R,
        L,
        { clientId: x, responseType: M, redirectUri: G, codeChallenge: en, codeChallengeMethod: eo, state: ed, nonce: ef, prompt: e_, authorizations: ep, scopes: eh, permissions: em, guildId: eg, channelId: eE, integrationType: ev, disableGuildSelect: eI = !1, showLogout: eb = !1, cancelCompletesFlow: eS = !0, isTrustedName: eT = !1, isEmbeddedFlow: ey = !1, callback: eA, callbackWithoutPost: eN, onClose: eC, disclosures: eR } = e,
        eO = null != ev ? (null == ep ? void 0 : ep.get(ev)) : void 0,
        eD = (0, u.TH)(),
        eL = (0, h.e7)([w.Z], () => w.Z.hasLoadedExperiments);
    s.useEffect(() => {
        B.default.isAuthenticated() && !eL && S.Z.getExperiments();
    }, [eL]);
    ...
    let tt = s.useCallback(
            ...
            [eN, eS, eA, null == ex ? void 0 : ex.application, eQ, eC, x, e3, M, G, en, eo, ed, ef, e6, eK, ej, eX, eY, e7]
        ),
        tn = s.useRef(!1),

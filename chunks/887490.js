...
var r = n(512722), i = n.n(r), a = n(327432), o = n(519953), s = n(339227), l = n(42530);
n(789952);
let u = !1;
{
...
let c = {
        ...
        getSelectedVoid(e) {
            ...
            if (p.isExpanded(e.selection)) {
                let [n, r] = p.edges(e.selection), i = c.after(e, n, { unit: 'offset' }), a = c.before(e, r, { unit: 'offset' });
        ...
        getTextFromRange(e, t) {
            ...
            for (let [e, t] of i) {
                let i = f.equals(t, n.path) ? n.offset : 0, o = f.equals(t, r.path) ? r.offset : 0;
        ...
        areStylesDisabled(e) {
            ...
            if (!e.previewMarkdown)
                return !0;
            let n = c.richValue(e), r = n[0], i = (null == r ? void 0 : r.type) === 'line' ? r.children[0] : null;
            if (null == i || !E.isText(i))
                return !1;
            let a = e.chatInputType, o = i.text;
        ...
        getSelectionOverlap(e, t) {
            ...
            if (f.isPath(t)) {
                let n = c.range(e, t), [r] = c.node(e, t);
                if (_.isElement(r)) {
                    let r = c.before(e, t), i = c.after(e, t);
                    t = {
        ...
        markdown(e, t, n) {
            var r;
            let i = 'line' === e.type && (null === (r = e.codeBlockState) || void 0 === r ? void 0 : r.wasInCodeBlock) === !0, a = e.children.map(e => {
                    var t;
        ...
        let r = c.toDOMRange(e, t).getBoundingClientRect(), i = c.toDOMRange(e, n).getBoundingClientRect();
        return I(r, i) && I(i, r);
    }, g = (e, t, n, r) => {
        let i = {
                anchor: t,
                focus: t
            }, a = 0, o = n.length, s = Math.floor((a + o) / 2);
        for (; s !== a;)
            if (T(e, {
                    anchor: n[s],
                    focus: n[s]
        ...
        getLineStart(e, t, n) {
            ...
            let o = {
                    anchor: r,
                    focus: t
                }, s = Array.from(c.positions(e, { at: o })), l = g(e, t, s, !0);
        ...
        getLineEnd(e, t, n) {
            ...
            let o = {
                    anchor: t,
                    focus: r
                }, s = Array.from(c.positions(e, { at: o })), l = g(e, t, s, !1);
            if (n && h.equals(t, l) && !h.isAtEnd(t, i)) {
                let n = c.after(e, t);
                if (null == n)
                    return l;

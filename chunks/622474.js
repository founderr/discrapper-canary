s(47120), s(653041);
var n = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(913527), l = s.n(o), c = s(374470), d = s(399606), _ = s(481060), E = s(570140), u = s(37234), T = s(960359), I = s(853197), S = s(430492), N = s(688465), C = s(594174), m = s(55935), A = s(702512), h = s(689938), g = s(612011);
                                ...
                                (0, n.jsxs)('div', {
                                    children: [
                                        ...
                                        (0, n.jsx)(_.Text, {
                                            ...
                                            children: h.Z.Messages.DROPS_CARD_REDEEM_UNTIL.format({ endDate: l()(S, 'YYYY-MM-DD HH:mm').format('MMMM Do, YYYY') })
                                        })
                                    ]
                                })
                            ]
            ...
            (0, n.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, n.jsx)(_.Text, {
                        ...
                        children: h.Z.Messages.DROPS_LEARN_MORE.format({ faqUrl: m })
                    })
                ]
            })
        ]
...
function R(e) {
    let {
            ...
            code: s,
            platform: i
        } = e, [o, c] = a.useState(!1), d = void 0 !== s, E = (0, m.vc)(l()(t.endDate), 'LL'), u = h.Z.Messages.DROPS_CARD_REDEEM_UNTIL.format({ endDate: E }), T = d ? h.Z.Messages.OUTBOUND_PROMOTION_SEE_CODE : h.Z.Messages.PROMOTION_CARD_ACTION_CLAIM, I = a.useCallback(() => c(!1), []);
...
t.Z = function (e) {
    ...
    for (let e of Object.keys(a)) {
        ...
        if (null == t)
            continue;
        let s = a[e], n = (0, I.x8)(e);
        if (null == n)
            continue;
        let d = (0, I.Xt)(n), _ = s.eligible && d, E = (0, I.A5)(n);
        if (null == E)
            continue;
        ...
        if (!E.getCurrentConfig({ location: '076035_3' }, { autoTrackExposure: !1 }).dropsEnabled)
            continue;
        c = !0;
        let T = l()(t.endDate, O), S = l()();
    ...
    return c && 0 === i.length && 0 === r.length && s ? (0, n.jsxs)(_.FormSection, {
        children: [
            ...
            (0, n.jsx)('div', {
                ...
                children: h.Z.Messages.DROPS_READ_BLOG_TO_ENABLE.format({ blogURL: A.n4 })
            })
        ]
        ...
        children: [
            ...
            (0, n.jsx)(_.FormDivider, { className: g.divider }),
            i.map(e => {
                let t = (0, I.EW)(e.dropsQuestId), s = null != e.dropsStatus.enrolled_at, a = null != e.dropsStatus.completed_at;
            ...
            'string' == typeof (null == o ? void 0 : o.id) && r.length > 0 ? (0, n.jsx)('div', {
                ...
                children: h.Z.Messages.DROPS_REQUEST_FEEDBACK_SUCCESS.format({ feedbackURL: 'https://survey.alchemer.com/s3/7043098/Discord-Drops-CSAT?user_id='.concat(null !== (t = null == o ? void 0 : o.id) && void 0 !== t ? t : '') })
            }) : null
        ]
    });
};

  ...
  (0, n.jsx)('div', {
    ...
    children: (0, n.jsxs)('div', {
      ...
      children: [
        ...
        (0, n.jsx)(_.Tooltip, {
          text: t && !i ? h.Z.Messages.DROPS_GIFT_INVENTORY_REDEMPTION_TOOLTIP : null,
          ...
          children: e => (0, n.jsx)(_.Button, {
            ...
            disabled: t && !i,
            ...e,
            children: t ? h.Z.Messages.REDEEM : h.Z.Messages.DROPS_GIFT_INVENTORY_ENROLL
          })
        })
      ]
    })
...
code: t,
platform: i
  } = e, [o, c] = a.useState(!1), d = void 0 !== t, E = (0, m.vc)(l()(s.endDate), 'LL'), u = h.Z.Messages.DROPS_CARD_REDEEM_UNTIL.format({
endDate: E
...
let T = l()(s.endDate, O),
  S = l()();
_ && null == t.completed_at || null != t.enrolled_at && null == t.completed_at && t.eligible ? S < T && i.push({
  dropsQuestId: e,
  dropsStatus: t,
  showUnenroll: u,
  experiment: E
}) : (null != t.code || null != t.completed_at) && S < l()(s.finalClaimDate, O) && r.push({
  dropsQuestId: e,
  dropsStatus: t,
  showUnenroll: u,
  experiment: E

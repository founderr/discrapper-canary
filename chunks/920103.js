...
class a {
    ...
    getUpdates(e, t) {
        let n = -this.tension * (t - this.target), r = (n + -this.friction * e) / this.mass;
        return Math.abs(e += r * i) > this.maxVelocity && (e = this.maxVelocity * (e > 0 ? 1 : -1)), {
            from: t += e * i,
            vel: e,
            accel: r
        };
    ...
    constructor({
        ...
        r(this, 'tension', void 0), r(this, 'friction', void 0), r(this, 'threshold', void 0), r(this, 'mass', void 0), r(this, 'maxVelocity', void 0), r(this, 'clamp', void 0), r(this, 'callback', void 0), r(this, 'accumulator', 0), r(this, 'from', 0), r(this, 'target', 0), r(this, 'vel', 0), r(this, 'animating', !1), r(this, 'last', null), r(this, 'nextTick', -1), r(this, 'getNodeWindow', void 0), r(this, 'nodeWindow', null), r(this, 'callbacks', []), r(this, 'mergeTo', e => {
            ...
            for (this.accumulator = Math.min((e - this.last) / 1000 + this.accumulator, 2); this.accumulator > i;) {
                this.accumulator -= i;
                let {
                    vel: e,
                    from: t,
            ...
            if (this.accumulator > 0) {
                let {from: e} = this.getUpdates(this.vel, o), t = (e - o) * (this.accumulator / i);
                o += t;
            }

...
var r = n(146150), i = n(812975), a = n(531171), o = n(695170), s = n(686942), l = n(200734), u = {
        dtstart: null,
        cache: !1,
        unfold: !1,
        forceset: !1,
...
function c(e, t) {
    return void 0 === t && (t = {}), function (e, t) {
        var n, r, o, u, c, E, f, h, p, m = (n = e, r = t, o = [], u = [], c = [], E = [], h = (f = (0, l.o)(n)).dtstart, p = f.tzid, function (e, t) {
                ...
                if (e) {
                    var t, n = function (e) {
                            var t = function (e) {
                                ...
                                }(e), n = t.name, r = t.value, i = n.split(';');
                            if (!i)
                        ...
                        }(e), r = n.name, i = n.parms, a = n.value;
                    ...
                    case 'EXRULE':
                        if (i.length)
                            throw Error('unsupported EXRULE parm: '.concat(i.join(',')));
                        c.push((0, l.B)(a));
                        break;
                    case 'EXDATE':
                        E = E.concat(_(a, i));
                ...
                exrulevals: c,
                exdatevals: E
            }), I = m.rrulevals, T = m.rdatevals, g = m.exrulevals, S = m.exdatevals, A = m.dtstart, N = m.tzid, v = !1 === t.cache;
        ...
        var t = [], n = Object.keys(e), i = Object.keys(u);

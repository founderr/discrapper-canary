...
let P = o.AvatarSizes.SIZE_120,
  O = x.default.getEnableHardwareAcceleration() ? o.AnimatedAvatar : o.Avatar;
...
function F(e) {
  let {
    ...
    hasProfileEffect: b,
    onClose: G
  } = e, k = (0, i.useStateFromStores)([T.default], () => T.default.getRelationshipType(x.id)), w = (0, i.useStateFromStores)([E.default], () => E.default.isMobileOnline(x.id)), V = (0, i.useStateFromStores)([E.default], () => E.default.getStatus(x.id)), H = (0, i.useStateFromStores)([A.default], () => A.default.getUserProfile(x.id)), z = (0, i.useStateFromStores)([m.default], () => m.default.getId() === x.id), {
    profileTheme: Y
  } = (0, h.default)(x, t), {
    avatarSrc: K,
    eventHandlers: Z,
    ...
    user: x,
    size: P
  }), W = l.useMemo(() => (0, S.shouldDisableUserPresenceInChannel)(x, B), [x, B]);
  ...
  return (0, a.jsxs)("header", {
    children: [(0, a.jsx)(I.default, {
      ...
      children: [(0, a.jsx)("div", {
        ...
        children: [(null == H ? void 0 : H.profileFetchFailed) && !x.isClyde() ? (0, a.jsx)(o.Tooltip, {
          ...
          }), z || x.isNonUserBot() ? null : (0, a.jsx)(o.Clickable, {
            focusProps: {
              offset: {
                left: 8
              }

...
function u(e, t, n) {
  return (e = c(e, n), (t = c(t, n)).length > e.length) ? s.NO_MATCH : e === t ? s.CASE_SENSITIVE_EQUAL : (e = e.toLowerCase(), e === (t = t.toLowerCase())) ? s.EQUAL : e.startsWith(t) ? s.STARTS_WITH : e.includes(' ' + t) ? s.WORD_STARTS_WITH : e.includes(t) ? s.CONTAINS : 1 === t.length ? s.NO_MATCH : function(e) {
var t = '';

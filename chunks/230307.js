...
class _ extends (o = s.ZP.Store) {
    ...
    getQuickSwitcherScoreForApplication(e) {
        let t = c[e], n = 0;
        if (null != t) {
            let e = Date.now(), r = Math.floor((e - new Date(t.last_played_at).getTime()) / 86400000), i = Math.floor(1000 * t.total_duration / 3600000);
...
a = 'LibraryApplicationStatisticsStore', (i = 'displayName') in (r = _) ? Object.defineProperty(r, i, {
    value: a,
    enumerable: !0,
    configurable: !0,
    writable: !0

...
class L extends _.PureComponent {
  render() {
    ...
    return (0, s.jsx)(A.ListNavigatorItem, {
      id: E.key,
      children: _ => (0, s.jsx)(n.Clickable, {
        focusProps: {
          enabled: !1
        },
...
function o(e) {
  ...
  return (0, n.useFocusLock)(S), (0, s.jsx)(A.ListNavigatorProvider, {
    navigator: N,
    children: (0, s.jsx)("div", {
      ref: S,
      className: o,

...
if (function(e) {
  ...
  }(t) ? (i = t.anchorNode, a = t.anchorOffset, s = t.focusNode, o = t.focusOffset, l = t.isCollapsed) : (i = t.startContainer, a = t.startOffset, s = t.endContainer, o = t.endOffset, l = t.collapsed), null == i || null == s || null == a || null == o) {
  if (d)
    return null;
...
}(i) || l(i) && 0 === i.childNodes.length || l(i) && 'false' === i.getAttribute('contenteditable')) && (!s || !o);) {
;
if (a >= r.length) {

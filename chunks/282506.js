let i;
var s = n(570140), a = n(519938), r = n(317770), l = n(317381), o = n(928518), c = n(199902), d = n(592125), u = n(819640), _ = n(131951), h = n(366050), E = n(19780), I = n(944486), m = n(914010), g = n(979651), p = n(981631), T = n(65154);
function S() {
    var e;
    let t = i;
...
function f() {
    let e = E.Z.getChannelId(), t = i === e;
    return function () {
        let e = E.Z.getChannelId(), t = I.Z.getChannelId();
        ...
        if (null == n || h.Z.isOpen(e))
            return !1;
        s.Z.wait(() => a.bA(n.id, p.NYg.VIDEO, { channel: n })), null === (t = E.Z.getRTCConnection()) || void 0 === t || t.setPipOpen(!0), i = e;
    }(e));
}
class C extends r.Z {
    _initialize() {

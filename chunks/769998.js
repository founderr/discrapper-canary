...
var s = n(735250);
n(470079);
var a = n(442837), i = n(481060), r = n(430824), l = n(496675), o = n(556012), c = n(273504), d = n(981631), u = n(590433), _ = n(689938), E = n(716054);
function I(e) {
    var t;
    let {
            action: n,
            ...
            toggled: m,
            onToggleAction: N
        } = e, S = e => () => N(e), h = (0, o.c)(n.type, n, I), g = null === (t = n.metadata) || void 0 === t ? void 0 : t.durationSeconds, C = null != g ? (0, u.L9)(g) : null, x = (0, a.e7)([
            l.Z,
            r.Z
        ], () => l.Z.can(d.Plq.MODERATE_MEMBERS, r.Z.getGuild(T)), [T]);
    if (null == h)
        return null;
    let {
        headerText: p,
                        ...
                        children: [
                            function (e, t) {
                                ...
                                if (e === c.fX.MENTION_SPAM)
                                    return _.Z.Messages.GUILD_AUTOMOD_ACTIONS_TIMEOUT_EDIT_HELPER_MENTION_SPAM.format({ friendlyDurationString: t });
                                return _.Z.Messages.GUILD_AUTOMOD_ACTIONS_TIMEOUT_EDIT_HELPER.format({ friendlyDurationString: t });
                            }(I, C),
                            x && (0, s.jsx)(i.Clickable, {
                                onClick: S(!0),

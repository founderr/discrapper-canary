...
function y(e) {
  let {
    ...
    onClose: i,
    guildId: y
  } = e, V = (0, h.useUID)(), P = (0, s.useStateFromStores)([g.default], () => g.default.getGuild(y)), O = (0, I.default)(null == P ? void 0 : P.id), j = (0, T.default)(y), k = u.useRef(S.default.ackMessageId(y, M.ReadStateTypes.GUILD_EVENT)), F = (0, G.default)();
  return u.useEffect(() => {

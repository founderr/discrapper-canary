...
class a {
    ...
    is(e, t, n = !1) {
        ...
        if (null == e || 'object' != typeof e)
            return !1;
        this.prepare();
        let r = Object.keys(e), a = this.data;
        ...
        for (let r of this.fields)
            if (void 0 === r.oneof && !this.field(e[r.localName], r, n, t))
                return !1;
        return !0;
    }
    field(e, t, n, i) {
        ...
        case 'scalar':
            if (void 0 === e)
                return t.opt;
            if (a)
                return this.scalars(e, t.T, i, t.L);
            return this.scalar(e, t.T, t.L);
        case 'enum':
            if (void 0 === e)
                return t.opt;
            if (a)
                return this.scalars(e, r.wx.INT32, i);
            return this.scalar(e, r.wx.INT32);
        case 'message':
            if (void 0 === e)
                break;
            if (a)
                return this.messages(e, t.T(), n, i);

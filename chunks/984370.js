...
var i = n(735250);
n(470079);
var a = n(120356), s = n.n(a), r = n(873546), l = n(442837), o = n(100527), c = n(906732), d = n(320007), u = n(141321), _ = n(208450), E = n(594174), I = n(358085), m = n(998502), T = n(665149), h = n(300986), N = n(314451), f = n(35583), p = n(981631), C = n(176505), g = n(139715);
async function S() {
...
function x(e) {
    let {
            isAuthenticated: t = !0,
            ...n
        } = e, {analyticsLocations: a} = (0, c.ZP)(o.Z.HEADER_BAR), r = s()(n.className, { [g.forumOrHome]: null != n.channelType && p.TPd.GUILD_THREADS_ONLY.has(n.channelType) || n.channelId === C.oC.GUILD_HOME });
    return (0, i.jsx)(c.Gt, {
        value: a,

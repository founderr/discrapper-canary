...
var a = n(735250), s = n(470079), r = n(120356), l = n.n(r), i = n(196434), o = n.n(i), c = n(143927), d = n(91192), u = n(924826), m = n(536895), h = n(313361), _ = n(442837), g = n(704215), x = n(481060), C = n(561472), f = n(393238), p = n(607070), T = n(933557), I = n(243778), E = n(71619), N = n(898188), b = n(256413), v = n(292853), S = n(359110), M = n(344185), A = n(235449), j = n(665906), R = n(488131), O = n(433355), Z = n(592125), L = n(703558), P = n(607744), w = n(117530), y = n(451478), D = n(459273), F = n(961675), U = n(883429), k = n(238349), H = n(109434), B = n(456269), G = n(90372), z = n(985518), V = n(228392), W = n(355589), q = n(542581), K = n(639184), Y = n(404616), X = n(470623), J = n(749913), Q = n(219664), $ = n(895932), ee = n(479099), et = n(510060), en = n(276357), ea = n(81490), es = n(482062), er = n(260503), el = n(981631), ei = n(124368), eo = n(689938), ec = n(101400);
function ed(e) {
    let {
        channel: t,
        guild: n,
...
function ef(e) {
    let {
        ...
        }(t), y = m.length > 0, D = y || g.length > 0, k = (0, b.Z)(t), {tagFilter: q} = (0, H.H)(t.id);
    (0, B.ku)(t, q, u);
    let K = (0, B.jR)(t), J = (0, B.eZ)(t), $ = s.useRef(null), {observePostVisibilityAnalytics: ee} = function (e) {
            let {
                guildId: t,
                channelId: n,
                scrollerRef: a
            ...
            let r = s.useRef(null), l = s.useCallback((e, t) => {
                    for (let n of t) {
            ...
            channelId: t.id,
            guildId: t.guild_id
        }), en = w === h.X.GRID, ed = null != f, e_ = s.useRef(null), {
            containerRef: ef,
            containerWidth: eE
        } = (0, ea.Z)();
    s.useEffect(() => () => {
    ...
    let {columns: eb} = s.useMemo(() => en ? eu.getRenderOptions(eE) : et.eU, [
            en,
            eE
    ...
    s.useEffect(() => {
        var e, t;
        let n = en ? eH : $, a = null === (e = n.current) || void 0 === e ? void 0 : e.getScrollerState();
        null != a && !ew && a.scrollTop > r && (null === (t = n.current) || void 0 === t || t.scrollTo({ to: 0 }));
    }, [ew]);
    let {
            ...
            let {
                    ...
                    if (null == s)
                        return;
                    let r = a.getCoordsMap()[n], l = null != r ? r.height + 20 : 200;
        ...
        s.useEffect(() => {
            if (a) {
                let e = setTimeout(() => {
                    ...
                    let n = r.findIndex(t => t.find(t => t === e)), a = t.current.getCoordsMap(), s = a['__section__'.concat(n)], o = a[ex(n, e)];
    ...
    let eY = s.useCallback(() => {
            ...
            let s = a.scrollTop + a.offsetHeight, r = a.scrollHeight - s;
            ...
            eE,
            I
        ]), eX = (0, _.e7)([p.Z], () => p.Z.keyboardModeEnabled), eJ = (0, es.ZP)({
            id: 'forum-grid-view',
            isEnabled: en && eX,
            setFocus: eK
        }), eQ = (0, er.Z)({
            ...
            ref: e$,
            ...e0
        } = eJ.containerProps, e1 = O.ZP.getSidebarState(t.id), e6 = null != e1 && (0, O.D5)(e1);
    return (0, a.jsx)('div', {
            ...
            children: e => (0, a.jsxs)(a.Fragment, {
                children: [
                    u && (0, a.jsx)(C.Z, {
                        ...
                        style: { right: e6 && (null == n ? void 0 : n.isThreadSidebarFloating) ? n.threadSidebarWidth : 0 }
                    }),
                    (0, a.jsx)(eI, { channel: t }),
                    (0, a.jsx)(x.HiddenVisually, { children: (0, a.jsx)(x.H, { children: eo.Z.Messages.THREADS }) }),
                    k ? (0, a.jsx)('div', {
...
function ep(e) {
    ...
    return (0, a.jsx)('div', {
        ...
        children: (0, a.jsx)(x.Text, {
            ...
            children: eo.Z.Messages.FORUM_CHANNEL_NO_POST_HISTORY.format({ channelName: s })
        })
    });
}
function eT(e) {
    ...
    return (0, a.jsx)('div', {
        ...
        children: (0, a.jsx)(x.Text, {
            color: 'text-muted',
            variant: 'text-md/normal',
            children: eo.Z.Messages.FORUM_CHANNEL_NO_SEARCH_POST_HISTORY.format({ channelName: s })
        })
    });
}
function eI(e) {
    let {channel: t} = e, n = s.useCallback(() => {
            U.Z.resort(t.id);
    ...
    return 0 === r ? null : (0, a.jsx)(x.Clickable, {
        ...
        children: (0, a.jsx)(x.Text, {
            ...
            children: eo.Z.Messages.NEW_FORUM_POST_COUNT.format({ count: r })
        })
    });
}
function eE() {
...
function eN(e) {
    ...
    let eg = (0, _.e7)([w.Z], () => w.Z.getUploads(i.id, L.d.FirstThreadMessage)), ex = (0, B.ql)(i), eC = s.useRef(null), ef = s.useRef(null), [ep, eT] = s.useState(0), {width: eI} = (0, _.e7)([y.Z], () => y.Z.windowSize()), eN = null === (n = eC.current) || void 0 === n ? void 0 : null === (t = n.getBoundingClientRect()) || void 0 === t ? void 0 : t.width, ev = s.useRef(null);
    s.useLayoutEffect(() => {
        var e;
        let t = ef.current, n = null == t ? void 0 : null === (e = t.children) || void 0 === e ? void 0 : e[0];
    ...
    let eS = A.length > 0 && !R && (T || null != b), eM = !__OVERLAY__ && !Z && !R && O && (0 === F.textValue.trim().length || F.textValue.trim() === ex) && 0 === eg.length;
    s.useLayoutEffect(() => {
        let e = eS || eM;
        if (!e)
            return G(0);
    ...
    let eA = e => {
            ...
            onFocus: eO,
            ...eZ
        } = (0, d.JA)('forum-channel-header'), eL = s.useRef(null), eP = function () {
            let e = s.useRef(!1), t = (0, _.e7)([p.Z], () => p.Z.keyboardModeEnabled), n = s.useCallback(t => {
        ...
        children: (0, a.jsxs)(D.I3, {
            children: [
                null != i.guild_id ? (0, a.jsx)(N.Z, {
                    className: l()(ec.newMemberBanner, { [ec.gridViewBanner]: W === h.X.GRID }),
                    guildId: i.guild_id,
                    channel: i
                }) : null,
                (0, a.jsx)('div', {
                    className: l()(ec.mainCard, ec.header, { [ec.headerWithMatchingPosts]: eS || eM }),
                ...
                et && !eu && (0, a.jsx)(I.Z, {
                    ...
                    children: e => {
                        ...
                        return t === g.z.FORUM_CHANNEL_HELPER_CARD ? (0, a.jsx)(K.Z, { onDismiss: n }) : null;
                    }
                })
            ]
        })
...
function eb(e) {
    let {channel: t} = e, n = t.isMediaChannel();

...
return;
  ...
  t ? n.add(l.oNc.INVITES_DISABLED) : n.delete(l.oNc.INVITES_DISABLED), await s.Z.saveGuild(e.id, {
features: n
  }, {
throwErr: !0
  });
...
o = (null == e ? void 0 : null === (t = e.hasFeature) || void 0 === t ? void 0 : t.call(e, l.oNc.INVITES_DISABLED)) || (null == i ? void 0 : i.invitesDisabledUntil) != null && new Date(i.invitesDisabledUntil) > new Date();
  return n && o;
}
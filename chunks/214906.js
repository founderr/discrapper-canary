...
function M(e) {
  let [t, a, u] = (0, s.useStateFromStoresArray)([r.default], () => [r.default.isMuted(e.id), r.default.getMuteConfig(e.id), r.default.hasJoined(e.id)]), M = (0, d.useMutedUntilText)(a);

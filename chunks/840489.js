...
let h = (e, l) => t.useCallback((a, s) => {
    ...
    return t.forEach(l => {
      ...
      S ? d.push({
        ...
        allow: S ? r.default.add(null !== (O = null === (s = i[M]) || void 0 === s ? void 0 : s.allow) && void 0 !== O ? O : N.default.NONE, a) : r.default.remove(null !== (R = null === (t = i[M]) || void 0 === t ? void 0 : t.allow) && void 0 !== R ? R : N.default.NONE, a),
        deny: r.default.remove(null !== (h = null === (n = i[M]) || void 0 === n ? void 0 : n.deny) && void 0 !== h ? h : N.default.NONE, a)
      }) : (0, c.isEveryoneRoleId)(e.id, M) ? d.push({
        id: M,
        type: u.PermissionOverwriteType.ROLE,
        allow: r.default.remove(null !== (_ = null === (E = i[M]) || void 0 === E ? void 0 : E.allow) && void 0 !== _ ? _ : N.default.NONE, a),
        deny: r.default.add(null !== (f = null === (m = i[M]) || void 0 === m ? void 0 : m.deny) && void 0 !== f ? f : N.default.NONE, a)
      }) : M in i && v.push(M)
    }, []), (0, n.saveAndClearPermissionUpdates)(l.id, d, v)
  }, [e, l]),
  E = e => l => null != l && !(0, c.isEveryoneRoleId)(e, l),
  m = e => t.useMemo(() => (0, O.getAllRolesRows)(e).filter(l => E(e.id)(l.id)), [e]),
  _ = (e, l, a) => {
...
var M = e => {
  ...
  } = _(l, a, o), O = t.useRef(null), M = m(l), S = M.reduce((e, l) => (e.set(l.id, l), e), new Map), p = M.map(e => ({
    key: e.key,
    label: e.name,
    value: e.id
  })), [I, x] = t.useState(u.map(e => e.id).filter(E(l.id))), [A, L] = t.useState(!1), [C, w] = t.useState(!1), g = I.length > 0 || c, j = h(l, a), y = async () => {
    if (!g) return;
    L(!0), w(!1);
    let e = [...I];
    if (c) {
  ...
  return A ? (0, s.jsx)(d.Spinner, {}) : (0, s.jsxs)(d.ModalRoot, {
    transitionState: n,

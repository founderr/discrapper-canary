...
function E(e) {
  let {
    ...
    placeholderImg: n,
    placeholderStyle: o
  } = e, a = t === l.zo9.LOADING, [d] = r.useState(() => Date.now()), E = t === l.zo9.READY && Date.now() - d < 200, I = (0, s.useTransition)(a && null != n, E ? c : _);
...
function I(e) {
  let {
    ...
    placeholderStyle: I,
    children: T
  } = e, h = t === l.zo9.LOADING, [S] = r.useState(h), [f, N] = r.useState(!1), A = (0, a.L)(_, c, S);
  r.useEffect(() => {
    let e = setTimeout(() => {
      N(!0)
    }, 2e3);

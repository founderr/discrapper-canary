    ...
    update(e) {
        for (let t in e.rtp.inbound)
            for (let n of e.rtp.inbound[t])
                if ('video' === n.type) {
                    let e = this.getInboundBytesRecevierCalculator(n), t = this.getInboundFrameDecodeRateCalculator(n);
                    n.bitrate = e.calculate(n), n.frameRateDecode = t.calculate(n);
                }
        for (let t of e.rtp.outbound)
            if ('video' === t.type) {
                let e = this.getOutboundBytesSentCalculator(t), n = this.getOutboundEncodeRateCalculator(t);
                t.bitrate = e.calculate(t), t.frameRateEncode = n.calculate(t);
            }
    }
    static getCalculatorOrCreate(e, t, n, r) {
        let i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, a = e[t.ssrc];
...
class l {
    calculate(e) {
        ...
        if (n <= 0 || 'number' != typeof n)
            return;
        let r = t[this.accumulativeMetricKey], i = e[this.accumulativeMetricKey];
        if ('number' != typeof r || 'number' != typeof i)
            return;
        let a = t[this.samplesMetricKey], o = e[this.samplesMetricKey];
    ...
    constructor(e, t, n = 0) {
        for (let l in (a(this, 'accumulativeMetricKey', void 0), a(this, 'samplesMetricKey', void 0), a(this, 'previous', void 0), a(this, 'multiplier', void 0), a(this, 'round', void 0), this.accumulativeMetricKey = e, this.samplesMetricKey = t, this.multiplier = 1, this.round = !1, r)) {
            var i, o;
            let e = Number(l);
            if (!isNaN(e) && (n & e) != 0 && l in s)
                this.multiplier *= null !== (o = null === (i = s[l]) || void 0 === i ? void 0 : i.multiplier) && void 0 !== o ? o : 1;
        }
        this.round = (4 & n) != 0;
    }
}

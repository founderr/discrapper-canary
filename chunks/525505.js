...
let G = e => {
  ...
  k = e => {
    let t, {
      ...
      n = (0, c.default)();
    t = s === h.PremiumTypes.TIER_0 ? (0, u.isThemeDark)(n) ? D : U : (0, u.isThemeDark)(n) ? b : j;
...
var w = e => {
  ...
  let z = (0, c.default)(),
    ...
    Q = (0, l.useStateFromStores)([f.default], () => f.default.getCurrentUser()),
    J = (0, m.isPremiumExactly)(Q, h.PremiumTypes.TIER_2),
  ...
  if (!w || !V) return null;
  let et = m.default.getDefaultPrice(h.SubscriptionPlans.PREMIUM_MONTH_TIER_0),
    es = m.default.getDefaultPrice(h.SubscriptionPlans.PREMIUM_MONTH_TIER_2),
    ea = {
    ...
    en = [{
      ...
      column1: (0, a.jsx)(a.Fragment, {
        children: (0, a.jsx)(H, {
          text: m.default.formatPriceString(et, h.SubscriptionIntervalTypes.MONTH)
        })
      }),
      column2: (0, a.jsx)(a.Fragment, {
        children: (0, a.jsx)(H, {
          text: m.default.formatPriceString(es, h.SubscriptionIntervalTypes.MONTH)
        })
      })
    }, {
      label: (0, a.jsx)(B, {
  ...
  return R ? en.push({
    ...
    colorOptions: q === h.PremiumSubscriptionSKUs.TIER_0 ? X ? P.PremiumPillAndSparklesColorOptions.PREMIUM_TIER_0_GRADIENT_FILL : P.PremiumPillAndSparklesColorOptions.PREMIUM_TIER_0_WHITE_FILL : X ? J ? P.PremiumPillAndSparklesColorOptions.PREMIUM_TIER_2_OLD_GRADIENT_FILL : P.PremiumPillAndSparklesColorOptions.PREMIUM_TIER_2_NEW_GRADIENT_FILL : P.PremiumPillAndSparklesColorOptions.PREMIUM_TIER_2_WHITE_FILL
  }) : ee ? (0, a.jsx)(G, {
    isLightTheme: X
  }) : (0, a.jsx)(y, {}), (0, a.jsx)(j, {
    children: (0, a.jsxs)("div", {
      className: i(v.root, r),
      "data-testid": "v2-marketing-page-comparison-table",
      children: [(0, a.jsx)(o.Heading, {
        className: i(v.titleText, v.textColor),
        variant: "heading-xxl/extrabold",
        children: null != A ? A : x.default.Messages.PREMIUM_TIER_0_DESKTOP_MARKETING_COMPARISON_TABLE_TITLE
      }), (0, a.jsxs)("div", {

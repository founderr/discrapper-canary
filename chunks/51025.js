...
t.showNotification(i.getIconURL(64), p.Z.Messages.GAME_LIBRARY_NOTIFICATION_GAME_INSTALLED_TITLE, p.Z.Messages.GAME_LIBRARY_NOTIFICATION_GAME_INSTALLED_BODY.format({
  name: i.name
}), {

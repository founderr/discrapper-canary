...
var r = n(544891), i = n(570140), a = n(812206), o = n(594190), s = n(703656), l = n(695346), u = n(391690), c = n(626135), d = n(129542), _ = n(877481), E = n(830168), f = n(57513), h = n(981631), p = n(689938);
function m(e, t) {
    E.Z.init({
        userToken: e,
        userId: t,
...
function S(e, t, n, r) {
    ...
    !function (e, t, n, r) {
        ...
        if (null == i)
            throw Error('Missing installation path for application: '.concat(e.id, ' ').concat(t));
        E.Z.setTargetManifest({
            applicationId: e.id,
...
function A(e, t, n) {
    ...
    null != r && (_.Z.removeShortcuts(r.name), c.default.track(h.rMx.LIBRARY_UNINSTALL_INITIATED, {
        application_id: r.id,
        application_name: r.name,
        sku_id: r.primarySkuId,
        location: n
    })), E.Z.uninstall(e, t), i.Z.dispatch({
...
function D(e, t) {
    ...
    r.tn.post({
        ...
        let {default: t} = e;
        t.showNotification(i.getIconURL(64), p.Z.Messages.GAME_LIBRARY_NOTIFICATION_GAME_INSTALLED_TITLE, p.Z.Messages.GAME_LIBRARY_NOTIFICATION_GAME_INSTALLED_BODY.format({ name: i.name }), { notif_type: 'Game Library Game Installed' }, {

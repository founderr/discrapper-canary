...
t.Z = (e) => {
    ...
    if ((c.ZP.isBoostOnlySubscription(a) ? (t = u.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION) : null != N && (t = c.ZP.getDisplayPremiumType(N.planId)), null == t)) return null;
    let p = () => l.Z.open(E.oAB.SUBSCRIPTIONS),

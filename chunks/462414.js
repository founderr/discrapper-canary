n(47120);
var i = n(243814), s = n(846027), a = n(131951), r = n(13140), l = n(996106), o = n(452426), c = n(186901), d = n(981631), u = n(65154);
function _(e) {
    let t = e.application.id;
    if (null == t)
        throw new l.Z({ errorCode: d.lTL.INVALID_COMMAND }, 'No application.');
    return t;
}
t.Z = {
    [d.Etm.SET_VOICE_SETTINGS_2]: {
        ...
        handler(e) {
            ...
            null != n && s.Z.setMode(n.type, { shortcut: (0, r.Kd)(n.shortcut) }, o), null != i && i !== a.Z.isSelfMute(o) && s.Z.toggleSelfMute({ context: o }), null != l && l !== a.Z.isSelfDeaf(o) && s.Z.toggleSelfDeaf({ context: o });
        }
    },

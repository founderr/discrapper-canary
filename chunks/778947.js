  ...
  if (r.useEffect(() => {
    ...
    children: (0, i.jsx)(u.Popout, {
      preload: U ? void 0 : function() {
        return (0, p.maybeFetchUserProfileForPopout)(T.author.id, null != f.guildMemberAvatar && null != s ? M.default.getGuildMemberAvatarURLSimple({
          guildId: s,
          userId: T.author.id,
...
function z(e) {
  let {
    ...
    className: p,
    channel: O
  } = e, M = r.useMemo(() => null != o ? e => o(e, t) : void 0, [o, t]), [, y] = (0, E.default)(t.author.id, e.guildId), b = (0, l.useStateFromStores)([C.default], () => C.default.getGuild(e.guildId), [e.guildId]), x = null != t.author && null != b && g.default.canManageUser(k.Permissions.MODERATE_MEMBERS, t.author, b), F = y && x, W = Y({
    props: e,
    guildId: e.guildId,
  ...
  }, "role-icon-children") : (!a || z) && null != _ ? (0, i.jsx)(D.default, {
    ..._,
    className: V.roleIcon
  ...
  (0, T.shouldShowNitroBadge)(null != _, "Message Username") && J && !a && !ee && Q.push((0, i.jsx)(K, {
  ...
  let ei = H(e, M, en),
    ...
    es = N ? "".concat(er) : "".concat(er, " ").concat(ea),

  ...
  let d = (0, E.jsxs)(E.Fragment, {
      children: [s ? (0, E.jsx)(S.Z, {
        ...
        children: i.terms.format({
          guidelinesURL: D.EYA.GUIDELINES
        })
      })]
    }),
...
function U(e) {
  let {
    channels: s
  } = e, a = L()(s).sortBy(e => null == e.parent_id ? 1e4 * Number(e.id) : 1e4 * Number(e.parent_id) + e.id).map(e => {
    let s = function(e) {
      let {
        type: s
      } = e;
...
function Z(e) {
  let {
    roles: s
  } = e, a = s.slice().reverse().map(e => (0, E.jsx)(g, {
    role: e
  }, e.id));
  return (0, E.jsx)("ul", {
...
function g(e) {
  ...
  let {
    role: a
  } = e, _ = null == a.color ? i.Z.unsafe_rawColors.PRIMARY_300.css : (0, l.Rf)(a.color);
  return (0, E.jsxs)("li", {
    className: O.role,
    style: {
      borderColor: null !== (s = (0, l.wK)(_, .6)) && void 0 !== s ? s : void 0
    },
    children: [(0, E.jsx)(M.RoleCircle, {

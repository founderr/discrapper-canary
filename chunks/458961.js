...
var n, a, r = t(735250), s = t(470079), o = t(120356), l = t.n(o), i = t(512722), d = t.n(i), c = t(831209), u = t(399606), C = t(215569), g = t(481060), T = t(749210), p = t(852860), h = t(607070), m = t(725803), I = t(76535), U = t(215388), f = t(674180), v = t(884858), q = t(695346), E = t(430824), N = t(153124), D = t(937615), O = t(73346), x = t(506071), R = t(587123), L = t(240864), b = t(863663), P = t(923400), V = t(623488), _ = t(152980), S = t(120651), Z = t(871388), j = t(412110), F = t(513669), M = t(972797), G = t(943516), B = t(302463), K = t(981631), W = t(674563), X = t(689938), z = t(791627);
let Q = (0, N.hQ)(), k = (0, N.hQ)(), H = (0, N.hQ)();
function y(e) {
    let {
            text: A,
            onChange: t,
...
function w(e) {
    let {
            ...
            selectedPriceTier: t,
            setPriceTier: n
        } = e, {priceTiers: a} = (0, I.R)(A, K.RG5.GUILD_PRODUCTS), o = s.useMemo(() => (null != a ? a : null != t ? [t] : []).map(e => ({
            value: e,
...
function J(e) {
    ...
    let {
            ...
            transitionState: J,
            onClose: ee
        } = e, [eA, et] = s.useState(Y), en = (0, u.e7)([L.Z], () => null == eA ? null : L.Z.getGuildProduct(eA), [eA]), ea = (null == en ? void 0 : en.published) === !0, {application: er} = (0, m.Z)(N, W.wW.GUILD_ROLE_SUBSCRIPTIONS), es = P.M['0'], eo = (0, u.e7)([h.Z], () => h.Z.useReducedMotion), el = q.QK.useSetting(), ei = (0, x.n)(), ed = s.useCallback(() => {
            var e;
            ...
            ei,
            el
        ]), {shouldRestrictUpdatingCreatorMonetizationSettings: ec} = (0, f.gX)(N);
    s.useEffect(() => {

...
function N(e) {
    let {
            ...
            giftStyle: h,
            children: C
        } = e, {selectedSkuId: N} = (0, u.usePaymentContext)(), [v, p] = l.useState(t), [j, I] = l.useState(), [S, E] = l.useState(!1), g = (0, o.pO)(v), A = (0, s.rK)(), {enabled: O} = s.ZP.useExperiment({ location: 'PaymentContextProvider' }, { autoTrackExposure: g && A }), P = f;

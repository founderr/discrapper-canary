  ...
  this.decodeStrings = !s, this.defaultEncoding = e.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(e) {
    (function(e, t) {
      ...
      if ((n = c).writing = !1, n.writecb = null, n.length -= n.writelen, n.writelen = 0, t) {
        ...
        var f = O(c) || e.destroyed;
        !f && !c.corked && !c.bufferProcessing && c.bufferedRequest && M(e, c), l ? a.nextTick(D, e, c, f, d) : D(e, c, f, d)
      }
    })(t, e)
...
n(689118)(C, u), w.prototype.getBuffer = function() {
  ...
  value: function(e) {
    return !!i.call(this, e) || this === C && e && e._writableState instanceof w
  }
})) : i = function(e) {
...
function M(e, t) {
  ...
  if (e._writev && n && n.next) {
    ...
    r.allBuffers = s, T(e, t, !0, t.length, r, "", i.finish), t.pendingcb++, t.lastBufferedRequest = null, i.next ? (t.corkedRequestsFree = i.next, i.next = null) : t.corkedRequestsFree = new o(t), t.bufferedRequestCount = 0
  } else {
    for (; n;) {
      var u = n.chunk,
        c = n.encoding,
      ...
      if (T(e, t, !1, d, u, c, l), n = n.next, t.bufferedRequestCount--, t.writing) break
    }

...
var s = { deprecate: n(220342) }, l = n(138772), u = n(413135).Buffer, c = (void 0 !== n.g ? n.g : 'undefined' != typeof window ? window : 'undefined' != typeof self ? self : {}).Uint8Array || function () {
    }, d = n(887866), _ = n(97703).getHighWaterMark, E = n(531478).codes, f = E.ERR_INVALID_ARG_TYPE, h = E.ERR_METHOD_NOT_IMPLEMENTED, p = E.ERR_MULTIPLE_CALLBACK, m = E.ERR_STREAM_CANNOT_PIPE, I = E.ERR_STREAM_DESTROYED, T = E.ERR_STREAM_NULL_VALUES, g = E.ERR_STREAM_WRITE_AFTER_END, S = E.ERR_UNKNOWN_ENCODING, A = d.errorOrDestroy;
function N() {
}
function v(e, t, i) {
    ...
    this.decodeStrings = !s, this.defaultEncoding = e.defaultEncoding || 'utf8', this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function (e) {
        (function (e, t) {
            var n, r, i, o, s, l, u = e._writableState, c = u.sync, d = u.writecb;
...
n(689118)(O, l), v.prototype.getBuffer = function () {
...
}(), 'function' == typeof Symbol && Symbol.hasInstance && 'function' == typeof Function.prototype[Symbol.hasInstance] ? (i = Function.prototype[Symbol.hasInstance], Object.defineProperty(O, Symbol.hasInstance, {
    value: function (e) {
...
O.prototype.write = function (e, t, n) {
    var r, i, o, s, l, d, _, E, h, p, m = this._writableState, I = !1;
...
function y(e, t) {
    ...
    if (e._writev && n && n.next) {
        var r = Array(t.bufferedRequestCount), i = t.corkedRequestsFree;
        i.entry = n;
        for (var a = 0, s = !0; n;)
        ...
        for (; n;) {
            var l = n.chunk, u = n.encoding, c = n.callback, d = t.objectMode ? 1 : l.length;
            if (R(e, t, !1, d, l, u, c), n = n.next, t.bufferedRequestCount--, t.writing)
                break;
        }

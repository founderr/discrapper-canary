...
class u {
    fromJulianDay(e) {
        var t;
        let n, r = e - 1721426, s = Math.floor(r / 146097), l = i(r, 146097), u = Math.floor(l / 36524), c = i(l, 36524), d = Math.floor(c / 1461), _ = Math.floor(i(c, 1461) / 365);
        let [E, f] = (n = 'AD', (t = 400 * s + 100 * u + 4 * d + _ + (4 !== u && 4 !== _ ? 1 : 0)) <= 0 && (n = 'BC', t = 1 - t), [
                n,
                t
            ]), h = e - a(E, f, 1, 1), p = 2;
        e < a(E, f, 3, 1) ? p = 0 : o(f) && (p = 1);
        let m = Math.floor(((h + p) * 12 + 373) / 367), I = e - a(E, f, m, 1) + 1;
    ...
    getDaysInMonth(e) {
        return l[o(e.year) ? 'leapyear' : 'standard'][e.month - 1];
    }
    getMonthsInYear(e) {
        return 12;
    }
...
function M(e) {
    return P(s((e = Z(e, new u())).era, e.year), e.month, e.day, e.hour, e.minute, e.second, e.millisecond);
}
...
function U(e, t) {
    ...
    return P(n, r, i, a, o, s, 0) - 1000 * Math.floor(e / 1000);
}
let w = new Map();
function x(e, t) {
    let n = w.get(t);
...
function G(e, t, n = 'compatible') {
    ...
    if (t === S() && 'compatible' === n) {
        l = Z(l, new u());
        let e = new Date(), t = s(l.era, l.year);
        return e.setFullYear(t, l.month - 1, l.day), e.setHours(l.hour, l.minute, l.second, l.millisecond), e.getTime();
    }
    let c = M(l), d = U(c - 86400000, t), _ = U(c + 86400000, t);
    let E = (r = l, i = t, ((a = c - d) == (o = c - _) ? [a] : [
        a,
        o
...
function V(e, t) {
    ...
    return t && ({
        ...
        second: i,
        millisecond: a
    } = t), new em(e.calendar, e.era, e.year, e.month, e.day, n, r, i, a);
}
function H(e) {
...
function Y(e, t, n) {
    if (e instanceof eT)
        return e.timeZone === t ? e : function (e, t) {
            return Z(B(M(e) - e.offset, t), e.calendar);
        }(e, t);
    return B(G(e, t, n), t);
}
function j(e, t) {
    let n = e.copy(), r = 'hour' in n ? en(n, t) : 0;
    W(n, t.years || 0), n.calendar.balanceYearMonth && n.calendar.balanceYearMonth(n, e), n.month += t.months || 0, K(n), z(n), n.day += 7 * (t.weeks || 0), n.day += t.days || 0, n.day += r, function (e) {
        for (; e.day < 1;)
...
class eT {
    ...
    set(e, t) {
        var n, r, i;
        let a, o;
        return n = this, r = e, i = t, 0 === (o = J($(a = V(n), r), r)).compare(a) ? n : Z(B(G(o, n.timeZone, i), n.timeZone), n.calendar);
    }
    cycle(e, t, n) {
        return function (e, t, n, r) {
            ...
            case 'hour': {
                    ...
                    let a = V(e), o = Z(J(a, { hour: t }), new u()), s = [
                            G(o, e.timeZone, 'earlier'),
                            G(o, e.timeZone, 'later')
                        ].filter(t => B(t, e.timeZone).day === o.day)[0], l = Z(J(a, { hour: i }), new u()), c = [
                            G(l, e.timeZone, 'earlier'),
                            G(l, e.timeZone, 'later')
                        ].filter(t => B(t, e.timeZone).day === l.day).pop(), d = M(e) - e.offset, _ = Math.floor(d / 3600000), E = d % 3600000;
                    return Z(B(d = 3600000 * eo(_, n, Math.floor(s / 3600000), Math.floor(c / 3600000), null == r ? void 0 : r.round) + E, e.timeZone), e.calendar);
                }
            case 'minute':
            case 'second':
            case 'millisecond':
    ...
    constructor(...e) {
        ...
        let [t, n, i, a, o] = ed(e), s = e.shift(), l = e.shift();
        this.calendar = t, this.era = n, this.year = i, this.month = a, this.day = o, this.timeZone = s, this.offset = l, this.hour = e.shift() || 0, this.minute = e.shift() || 0, this.second = e.shift() || 0, this.millisecond = e.shift() || 0, q(this);
    }
}
let eg = new Map();
class eS {
    ...
    resolvedOptions() {
        ...
        return function () {
            return null == eO && (eO = 'h12' === new Intl.DateTimeFormat('fr', {
                hour: 'numeric',
                hour12: !1
            }).resolvedOptions().hourCycle), eO;
            ...
            let n = eN(e += (e.includes('-u-') ? '' : '-u') + '-nu-latn', {
                    ...t,
                    timeZone: void 0
                }), r = parseInt(n.formatToParts(new Date(2020, 2, 3, 0)).find(e => 'hour' === e.type).value, 10), i = parseInt(n.formatToParts(new Date(2020, 2, 3, 23)).find(e => 'hour' === e.type).value, 10);
            if (0 === r && 23 === i)
                return 'h23';
            if (24 === r && 23 === i)
                return 'h24';
...
function eN(e, t = {}) {
    if ('boolean' == typeof t.hour12 && function () {
            return null == ev && (ev = '24' === new Intl.DateTimeFormat('en-US', {
                hour: 'numeric',
                hour12: !1
            }).format(new Date(2020, 2, 3, 0))), ev;
        }()) {
        let n = eA[String((t = { ...t }).hour12)][e.split('-')[0]], r = t.hour12 ? 'h12' : 'h23';

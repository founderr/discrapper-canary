...
let [E, f] = (n = 'AD', (t = 400 * o + 100 * u + 4 * d + _ + (4 !== u && 4 !== _ ? 1 : 0)) <= 0 && (n = 'BC', t = 1 - t), [
  n,
  t
]), h = e - a(E, f, 1, 1), p = 2;
  ...
  switch (t) {
    case 'hour': {
      ...
      let a = V(e),
        ...
        o = [
          G(s, e.timeZone, 'earlier'),
          G(s, e.timeZone, 'later')
        ].filter(t => B(t, e.timeZone).day === s.day)[0],
        l = Z(J(a, {
          hour: i
        }), new u()),
        c = [
...
let [t, n, i, a, s] = ed(e), o = e.shift(), l = e.shift();

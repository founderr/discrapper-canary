...
r = 'hour' in n ? en(n, t) : 0;
  W(n, t.years || 0), n.calendar.balanceYearMonth && n.calendar.balanceYearMonth(n, e), n.month += t.months || 0, K(n), z(n), n.day += 7 * (t.weeks || 0), n.day += t.days || 0, n.day += r,
function(e) {
  for (; e.day < 1;)
  ...
  switch (t) {
    case 'hour': {
      ...
      let a = V(e),
        ...
        ].filter(t => B(t, e.timeZone).day === o.day)[0],
        l = Z(J(a, {
          hour: i
        }), new u()),
        c = [
        ...
        ].filter(t => B(t, e.timeZone).day === l.day).pop(),
        d = M(e) - e.offset,

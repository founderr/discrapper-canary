...
class m extends (a = i.PureComponent) {
    ...
    renderHeader() {
        let { columns: e, data: t, sortDirection: r, sortKey: a, headerCellClassName: i, headerClassName: o, sortedHeaderCellClassName: u, stickyHeader: m } = this.props,
            g = e.map((e) => {
                let o = null != e.renderHeader ? e.renderHeader(e, t) : e.key,
                    h = r === s.sHY.ASCENDING ? c.ChevronSmallUpIcon : c.ChevronSmallDownIcon;
                return (0, n.jsx)(
                    c.Clickable,
                    {
    ...
    renderBody() {
        let { columns: e, data: t, sortData: r, sortKey: a, sortDirection: n, bodyCellClassName: o, rowClassName: c, cellProps: u, rowProps: h, rowComponent: m, cellComponent: g } = this.props,
            p = t;
        if (r) {
            let r =
                    null != a
    ...
    constructor(...e) {
        super(...e),
            u(this, 'handleSort', (e) => {
                ...
                if (null != a) a(e, t === e ? (r === s.sHY.ASCENDING ? s.sHY.DESCENDING : s.sHY.ASCENDING) : s.sHY.ASCENDING);
            });
    }
}

...
function _(e) {
  ...
  let {
    channel: _
  } = e, f = (0, u.r_)(_), E = (0, a.e7)([s.Z], () => s.Z.hasHidden(_.id)), C = (0, d.c)(_.id), {
    sortOrder: g,
    tagFilter: I
  } = (0, c.H)(_.id), x = (0, a.e7)([o.Z, h.Z], () => !!(o.Z.getThreadIds(_.id, g, I).length > 0) || !!(h.Z.getThreads(_.id, g, I).length > 0) || !1, [_.id, g, I]), T = _.isMediaChannel();
  if (!f || C || T && x) return null;

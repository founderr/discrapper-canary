...
function v(e) {
  ...
  let {
    ...
    selected: n,
    onChange: i
  } = e, r = null !== (a = (0, x.getChannelIconComponent)(s)) && void 0 !== a ? a : T.default, o = t.useCallback(() => {
    i(s)
  }, [s, i]);
...
function _(e) {
  let {
    ...
    guildId: n,
    startingChannelId: c
  } = e, x = (0, r.useStateFromStoresArray)([E.default], () => {
    var e, a;
    let s = E.default.getChannels(n),
      l = (null !== (e = s[0, E.GUILD_SELECTABLE_CHANNELS_KEY]) && void 0 !== e ? e : []).concat(null !== (a = s[E.GUILD_VOCAL_CHANNELS_KEY]) && void 0 !== a ? a : []);
    return l.filter(e => (0, m.default)(e.channel)).map(e => e.channel)
  }), [h, T] = t.useState(0), _ = x.find(e => e.id === c), [f, L] = t.useState(null != _ ? [_] : []), S = (0, N.useUID)(), g = f.length === x.length, p = t.useCallback(() => {
    T(1)
  }, [T]), b = t.useCallback(e => {
  ...
  return 0 === h ? (0, l.jsx)(d.ModalRoot, {
    transitionState: a,
    "aria-labelledby": S,
      ...
      children: [(0, l.jsxs)("div", {
        ...
        children: (0, l.jsx)(d.Text, {
          ...
          children: j.default.Messages.GUILD_SETTINGS_DEPRIVATE_EXPLAINER_4.format({
            emphasisHook: e => (0, l.jsx)(d.Text, {
              tag: "span",
              variant: "text-xs/medium",
              color: "interactive-active",
              children: e
            }),
            brandHook: e => (0, l.jsx)(d.Text, {
              tag: "span",
              variant: "text-xs/normal",
              color: "text-brand",
              children: e

t(47120), t(411104);
var n = t(735250), r = t(470079), s = t(160612), l = t(780384), o = t(481060), i = t(410030), c = t(231338), u = t(689938), d = t(528241), E = t(744481), _ = t(724641), p = t(811974), m = t(212545), A = t(184229), N = t(504309);
a.Z = function (e) {
    let a = (0, i.ZP)(), t = r.useRef(null), [h, T] = r.useState({});
    switch (r.useLayoutEffect(() => {
            let {current: e} = t;
            if (null == e)
                return;
            let a = window.getComputedStyle(e), n = window.getComputedStyle(e, '::placeholder'), r = a.getPropertyValue('font-family'), s = a.getPropertyValue('font-weight'), l = a.getPropertyValue('color'), o = a.getPropertyValue('font-size');
            T({
                base: {
                    fontFamily: r,
                    fontWeight: s,

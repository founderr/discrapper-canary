...
function h(e) {
	var t, n;
	let { config: a, index: o, handleCTAClick: c, text: l, reducedMotion: f = !1 } = e,
			...
			(0, s.jsxs)('div', {
				...
				children: [
					...
					(0, s.jsxs)('div', {
						...
						style: { color: null !== (t = a.textColor) && void 0 !== t ? t : (0, d.Lq)(_.Ilk.WHITE_100) },
						children: [
							(0, s.jsx)('div', {
...
function b(e) {
	let { categories: t, handleScrollToCategory: n } = e,
		...
		{ analyticsLocations: b } = (0, l.ZP)([...u, c.Z.COLLECTIBLES_SHOP_HEADER_CAROUSEL]),
		x = r.useCallback(
			(e, t) => {
				let s = e.cta;

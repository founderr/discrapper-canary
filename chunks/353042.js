...
class s extends (i = l.Component) {
    ...
    calculateInitialDeltaBytes(e) {
        let {
                ...
                updateInterval: n,
                pointsToSmooth: i
            } = this.props, l = Date.now(), r = 0, a = 0, s = [], o = null != e[0] ? e[0].bytes : 0;
        for (; r < t + i; r++) {
            let t;
            let i = l - (r + 1) * n;
            for (; a < e.length;)
                if ((t = e[a]).timestamp > i)
                    a++;
                else
                    break;
            if (a === e.length)
    ...
    smoothDeltaBytes(e) {
        let {pointsToSmooth: t} = this.props, n = [];
    ...
    constructor(e) {
        super(e), a(this, '_interval', new r.Xp()), a(this, 'update', () => {
            let {
                    onUpdate: e,
                    numUpdatesToShow: t,
                    pointsToSmooth: n,
                    updateInterval: i
                } = this.props, l = this.props.getHistoricalTotalBytes(), r = null != l[0] ? l[0].bytes : 0, a = [
        ...
        let t = this.props.getHistoricalTotalBytes(), n = this.calculateInitialDeltaBytes(t);
        this.state = {
            deltaBytes: n,

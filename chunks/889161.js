...
var r = n(470079), i = n(149765), a = n(442837), o = n(601964);
n(984933);
var s = n(496675), l = n(594174);
n(700785);
var u = n(85243), c = n(231338);
let d = {
        ...
        let [t, n] = e instanceof o.ZP ? [
                c.Pl.CREATE_EVENTS,
                c.Pl.MANAGE_EVENTS
            ] : E(e), [i, u, f, h] = (0, a.Wu)([s.Z], () => [
                s.Z.can(c.Pl.CREATE_GUILD_EXPRESSIONS, e),
                s.Z.can(c.Pl.MANAGE_GUILD_EXPRESSIONS, e),
                s.Z.can(t, e),
                s.Z.can(n, e)
        ...
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : s.Z, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : l.default, [r, i] = e instanceof o.ZP ? [
                c.Pl.CREATE_EVENTS,
                c.Pl.MANAGE_EVENTS
            ] : E(e), a = t.can(c.Pl.CREATE_GUILD_EXPRESSIONS, e), u = t.can(c.Pl.MANAGE_GUILD_EXPRESSIONS, e), f = t.can(r, e), h = t.can(i, e), p = n.getCurrentUser();
        return null == e ? d : {

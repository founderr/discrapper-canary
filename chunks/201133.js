...
var r = n(570140), i = n(493683), a = n(957730), o = n(222677), s = n(995774), l = n(314897), u = n(592125), c = n(703558), d = n(62817);
let _ = e => {
        ...
        var r;
        let i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], o = arguments.length > 3 ? arguments[3] : void 0, s = arguments.length > 4 ? arguments[4] : void 0, d = u.Z.getChannel(t);
        ...
        let {
            ...
            } = e, u = await i.Z.openPrivateChannel(r.id, !1, !1);
        E(t, u, l, a);
        let c = await _(u);
        if (null != c) {
            let e = (0, s.g1)(n);

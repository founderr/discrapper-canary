var n = r(599295), i = r(544364), o = '@global', s = '@global ', a = function () {
        function e(e, t, r) {
            for (var s in (this.type = 'global', this.at = o, this.isProcessed = !1, this.key = e, this.options = r, this.rules = new i.RB((0, n.Z)({}, r, { parent: this })), t))
        ...
        function e(e, t, r) {
            ...
            this.rule = r.jss.createRule(i, t, (0, n.Z)({}, r, { parent: this }));
        }
    ...
    return {
        ...
        onProcessRule: function (e, t) {
            'style' === e.type && t && (!function (e, t) {
                var r = e.options, i = e.style, s = i ? i[o] : null;
                if (s) {
                    for (var a in s)
                        t.addRule(a, s[a], (0, n.Z)({}, r, { selector: c(a, e.selector) }));
                    delete i[o];
                }
            }(e, t), !function (e, t) {
                var r = e.options, i = e.style;
                for (var s in i)
                    if ('@' === s[0] && s.substr(0, o.length) === o) {
                        var a = c(s.substr(o.length), e.selector);
                        t.addRule(a, i[s], (0, n.Z)({}, r, { selector: a })), delete i[s];
                    }
            }(e, t));
        }
    };

    ...
    children: [(0, i.jsxs)(l.F, {
      ...
      children: (0, i.jsxs)(i.Fragment, {
        children: [(0, i.jsx)(o.FormItem, {
          children: (0, i.jsx)(o.FormSwitch, {
            value: !d,
            note: C ? I.Z.Messages.PRIVACY_SETTINGS_MESSAGE_REQUESTS_DESC_HUB.format({
...
function A(e) {
  let {
    ...
    transitionState: t,
    onClose: n
  } = e, a = "".concat(I.Z.Messages.PRIVACY_SETTINGS, "—").concat(null != s ? s.toString() : "??");
...
function m(e) {
  ...
  } = e, n = s.id, a = c.h2.useSetting().includes(n), o = c.zA.useSetting().includes(n), l = c.SE.useSetting().includes(n), _ = c.iH.useSetting().includes(n), S = r.useCallback(e => {

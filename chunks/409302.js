...
case r.Cj.STANDARD_BOX:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('46468').then(n.t.bind(n, 70303, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;
...
case r.Cj.CAKE:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('69806').then(n.t.bind(n, 549883, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;
...
case r.Cj.CHEST:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('40331').then(n.t.bind(n, 669711, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;
...
case r.Cj.COFFEE:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('71244').then(n.t.bind(n, 398161, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;
...
case r.Cj.SEASONAL_STANDARD_BOX:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('62065').then(n.t.bind(n, 402483, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;
...
case r.Cj.SEASONAL_CAKE:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('68822').then(n.t.bind(n, 721670, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;
...
case r.Cj.SEASONAL_CHEST:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('72637').then(n.t.bind(n, 209128, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;
...
case r.Cj.SEASONAL_COFFEE:
  switch (t) {
    ...
    case i.S.LOOP:
      ...
      break;
    default:
      s = () => n.e('12112').then(n.t.bind(n, 335878, 19)).then(e => {
        let {
          default: t
        } = e;
        return t;

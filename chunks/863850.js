        ...
        },
        {
            ...
            value: function () {
                var e = this.props, t = e.getItemString, r = e.nodeTypeIndicator, a = e.nodeType, n = e.data, s = e.hideRoot, o = e.createItemString, i = e.styling, c = e.collectionLimit, u = e.keyPath, d = e.labelRenderer, h = e.expandable, m = this.state.expanded, w = m || s && 0 === this.props.level ? function e(t, r, a) {
                    ...
                    }(O(O({}, this.props), {}, { level: this.props.level + 1 })) : null, k = t(a, n, f.createElement('span', i('nestedNodeItemType', m), r), o(n, c), u), E = [
                        u,
                        a,
                        m,
                        h
                ...
                return s ? f.createElement('li', i.apply(void 0, ['rootNode'].concat(E)), f.createElement('ul', i.apply(void 0, ['rootNodeChildren'].concat(E)), w)) : f.createElement('li', i.apply(void 0, ['nestedNode'].concat(E)), h && f.createElement(p.Z, {
                    ...
                    onClick: this.handleClick
                        ...
                        'label',
                        'nestedNodeLabel'
                    ]].concat(E)), { onClick: this.handleClick }), d.apply(void 0, E)), f.createElement('span', (0, b.Z)({}, i.apply(void 0, ['nestedNodeItemString'].concat(E)), { onClick: this.handleClick }), k), f.createElement('ul', i.apply(void 0, ['nestedNodeChildren'].concat(E)), w));
            }
        }
    ]), h;
}(f.Component);

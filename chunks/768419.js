...
var o, s, l, u = n(392711), c = n.n(u), d = n(261470), _ = n(442837), E = n(902704), f = n(846519), h = n(570140), p = n(586902), m = n(726542), I = n(524331), T = n(710845), g = n(594190), S = n(314897), A = n(553795), N = n(517100), v = n(158776), O = n(606304), R = n(979651), C = n(626135), y = n(81063), D = n(70956), L = n(823379), b = n(781518), M = n(616922), P = n(981631);
function U(e, t, n) {
...
let w = m.Z.get(P.ABu.SPOTIFY), x = 'hm://pusher/v1/connections/', G = 30 * D.Z.Millis.SECOND, k = 30 * D.Z.Millis.SECOND, B = 5 * D.Z.Millis.MINUTE, F = 5 * D.Z.Millis.SECOND, V = 1.5 * D.Z.Millis.SECOND, H = 1 * D.Z.Millis.MINUTE, Z = 3 * D.Z.Millis.SECOND;
(l = o || (o = {})).PLAYER_STATE_CHANGED = 'PLAYER_STATE_CHANGED', l.DEVICE_STATE_CHANGED = 'DEVICE_STATE_CHANGED';
let Y = {
        MESSAGE: 'message',
        PING: 'ping',
        PONG: 'pong'
    }, j = 'single', W = new T.Z('Spotify'), K = new f.V7(), z = new f.V7(), q = new f.V7(), Q = new f.V7(), X = new f.V7(), $ = {}, J = {}, ee = {}, et = !1, en = null;
function er() {
    for (let e in $) {
        let t = $[e];
        if (!t.connected || null == J[e])
            continue;
...
class es {
    ...
    connect() {
        !this.connected && !this._requestedConnect && (W.info('WS Connecting'), this._requestedDisconnect = !1, this._requestedConnect = !0, em(this.accountId, this.accessToken).then(() => {
    ...
    handleMessage(e) {
        ...
        case Y.MESSAGE:
            if ('string' == typeof r && r.startsWith(x))
                this.connectionId = decodeURIComponent(r.split(x)[1]), (0, b.am)(this.accountId, this.accessToken, this.connectionId);
    ...
    constructor(e, t) {
        U(this, 'accessToken', void 0), U(this, 'accountId', void 0), U(this, 'connectionId', void 0), U(this, 'isPremium', void 0), U(this, 'pingInterval', void 0), U(this, 'backoff', void 0), U(this, 'socket', void 0), U(this, '_requestedDisconnect', !1), U(this, '_requestedConnect', !1), U(this, 'handleDeviceStateChange', c().throttle(() => {
            (0, b.PW)(this.accountId, this.accessToken), em(this.accountId, this.accessToken);
        }, Z)), this.accountId = e, this.accessToken = t, this.pingInterval = new f.Xp(), this.backoff = new d.Z(void 0, H), this.connect();
    }
}
function el(e, t) {
    e in $ ? ($[e].accessToken = t, W.info('Updated account access token: '.concat(e))) : ($[e] = new es(e, t), W.info('Added account: '.concat(e)));
}
function eu(e) {
    if (!(e in $))
        return;
...
function ed(e, t, n) {
    ...
    if (null == u || null == c || null == c.id || !(0, M.Ps)(c.id))
        return !1;
    let _ = null != d && null != d.start ? d.start : Date.now(), E = Math.max(0, Date.now() - _), f = !1, h = ee[s.accountId];
    null != h && !1 === h.repeat && (f = null);
    let p = (0, M.c8)(null !== (a = null === (r = t.metadata) || void 0 === r ? void 0 : r.type) && void 0 !== a ? a : M.Hw.TRACK);
    if (null == p)
        return;
    (0, b.hY)(s.accountId, s.accessToken, u, p, {
        position: +E,
        deviceId: l.id,
        repeat: f
    }), i = {
    ...
    n && (m = 'started', C.default.track(P.rMx.SPOTIFY_LISTEN_ALONG_STARTED, {
        party_id: c.id,
        other_user_id: e
    })), W.info('Listen along '.concat(m, ': ').concat(s.accountId, ' to ').concat(e, ' playing ').concat(u, ' on ').concat(l.name));
}
function e_() {
    ...
    if (null == t)
        return;
    let {socket: n} = t, r = ee[n.accountId];
    if (null != r && r.track.id === e)
        (0, b.wO)(n.accountId, n.accessToken);
}
function eE() {
    let e = Object.keys($), t = A.Z.getAccounts().filter(e => {
            let {type: t} = e;
...
function eh(e) {
    if (e === S.default.getId()) {
        let t = R.Z.isCurrentClientInVoiceChannel(), n = (0, p.O)({
                userId: e,
                checkSoundSharing: !0,
...
function ep(e, t, n) {
    var r, i, a, o, s, l, u, c, d, _, E, f, p, m;
    let I, T, {
            device: g,
            progress_ms: S,
            is_playing: A,
    ...
    if (null != g && !0 !== g.is_active && (g = {
        ...
        T = null != n && null != n.context && n.context.uri === O.uri ? Promise.resolve(n.context) : O.type === M.Hw.ALBUM ? Promise.resolve(O) : b.rC.get(e, t, { url: O.href }).then(e => {
            let {body: t} = e;
            return t;
        }).catch(e => {
            if (e && 404 === e.status)
    ...
    return T.then(t => {
        null != t && t.type === M.Hw.PLAYLIST && !t.public && (t = null), h.Z.dispatch({
            type: 'SPOTIFY_PLAYER_STATE',
            accountId: e,
            track: I,
...
class eI extends (s = _.ZP.Store) {
    initialize() {
        this.waitFor(A.Z, O.Z), this.syncWith([v.Z], () => function () {
            if (null == i || null == er())
                return !1;
            let {userId: e} = i, t = ea(e);
            if (null == t)
                return q.start(B, () => {
                    if (null != i && i.userId === e)
                        (0, I.Z)();
                }), !1;
            q.stop();
            let {
            ...
            return o || s ? ed(e, t, !1) : null != a && a.id !== i.partyId && (i.partyId = a.id, !0);
        }()), (0, b.k1)();
    }
    hasConnectedAccount() {
    ...
    getActivity() {
        let e, t, n;
        if (null == r)
            return null != i ? ea(i.userId) : null;
        let {
                track: {
                    artists: a,
                    album: o,
        ...
        a.length > 0 && (e = f.map(e => {
            let {name: t} = e;
            return t.replace(/;/g, '');
        }).join('; '));
        let h = {}, p = null != o.image ? (0, y.getAssetFromImageURL)(P.ABu.SPOTIFY, o.image.url) : null;
        null != o.image && null != p && (h.large_image = p), o.type !== j && (h.large_text = o.name), null != E && (t = E.uri), n = null != i && null != i.partyId ? i.partyId : ''.concat(M.lS).concat(S.default.getId());
        let m = s.length > 128 ? s.substring(0, 125) + '...' : s, I = {
                context_uri: t,
                album_id: o.id,
                artist_ids: f.map(e => {
                    let {id: t} = e;
...
let eT = new eI(h.Z, {
    ...
    SPOTIFY_PLAYER_STATE: function (e) {
        ...
        n ? null == en || en.start(k, ef) : (o = null, null == en || en.stop());
        ...
        let f = ee[t], p = null != o ? {
                ...
                startTime: function (e, t) {
                    let n = Date.now(), r = null != e ? e.startTime : 0, i = n - t;
                    return Math.abs(i - r) > V ? i : r;
                }(f, s),
                context: u,
                repeat: a
            } : null, m = null != l && null != i && 0 === s && !n;
        !m && (ee[t] = p);
        let T = r;
        if (r = c().values(ee).find(e => null != e), eh(S.default.getId()), null == o || m ? Q.stop() : Q.start(o.duration - s + F, () => ei(_.id)), null != i && (!n && s > 0 || null == l || null != p && i.trackId !== p.track.id) ? (W.info('Listen along active but playback stopped or track changed. Stopping listen along in '.concat(F, 'ms')), X.start(F, () => {
                W.info('Stopping listening along'), (0, I.Z)(), ei(_.id);
            })) : X.isStarted() && (W.info('Listen along stop cancelled as playback of track resumed'), X.stop()), T === r || null == f && null == p || null != f && null != p && f.track.id === p.track.id && f.startTime === p.startTime)
            return d;
        null != o && (h.Z.dispatch({
    ...
    ACTIVITY_PLAY: function (e) {
        ...
        return !!(null != u && null != c && null != c.id && (0, M.Ps)(c.id)) && (null != a && (n = a.context_uri), null != i && e_(), null != a && void ((0, b.hY)(s.accountId, s.accessToken, u, null !== (t = a.type) && void 0 !== t ? t : M.Hw.TRACK, {
            contextUri: n,
            deviceId: l.id
        }), W.info('Play started: '.concat(s.accountId, ' playing ').concat(u, ' on ').concat(l.name))));
    },
    ...
    MEDIA_ENGINE_SET_GO_LIVE_SOURCE: function (e) {
        ...
        if ((null == t ? void 0 : t.desktopSettings) != null) {
            ...
            null == t && (null == en || en.stop(), en = null);
    }
});
t.Z = eT;

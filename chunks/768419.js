...
T = null != n && null != n.context && n.context.uri === O.uri ? Promise.resolve(n.context) : O.type === M.Hw.ALBUM ? Promise.resolve(O) : b.rC.get(e, t, {
  url: O.href
}).then(e => {
  let {
    body: t
...
url: M.C7.PLAYER,
query: {
  additional_types: ''.concat(M.Hw.TRACK, ',').concat(M.Hw.EPISODE)
},
...
let h = {},
  p = null != o.image ? (0, y.getAssetFromImageURL)(P.ABu.SPOTIFY, o.image.url) : null;
...
let m = s.length > 128 ? s.substring(0, 125) + '...' : s,
  I = {
    context_uri: t,
    album_id: o.id,
    artist_ids: f.map(e => {

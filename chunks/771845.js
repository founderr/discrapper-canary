...
var i = n(348327), a = n.n(i), o = n(512722), s = n.n(o), l = n(727258), u = n(41776), c = n(581883), d = n(251625), _ = n(823379), E = n(664915), f = n(486472), h = n(271383), p = n(430824), m = n(412788), I = n(9156), T = n(594174);
function g(e, t, n) {
...
function y(e) {
    ...
    if (null == o)
        return !1;
    let u = o.children.map(e => e.id).filter(_.lm), c = new Set(u), d = new Set(n), E = new Set([...u].filter(e => !d.has(e)));
...
function D(e) {
    let {targetId: t} = e, n = S.getNode(t);
...
function b(e) {
    let {folderId: t} = e, n = S.getNode(t), r = E.Z.isFolderExpanded(t);
...
let w = (0, d.oH)((e, t) => e.sortedGuildNodes().map(e => e.id)), x = (0, d.oH)((e, t) => e.getRoots().map(A)), G = (0, d.oH)((e, t) => {
        let n = [];
        return !function e(t) {
            switch (t.type) {
            case l.eD.FOLDER:
...
class B extends m.Z {
    ...
    constructor() {
        super({
            ...
            let e = this.readSnapshot(B.LATEST_SNAPSHOT_VERSION), t = null == e ? void 0 : e.tree;
            if (null != t)

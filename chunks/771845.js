...
function P() {
    for (let e of S.allNodes()) e.type === l.eD.FOLDER && e.expanded && U(e, !1);
}
function U(e, t) {
    let n = S.cloneNode(e);
    ...
    constructor() {
        super({
            ...
            g(this, 'loadCache', () => {
                ...
                if (null != t) for (let e of ((S = new l.g8()).loadSnapshot(t), S.allNodes())) e.type === l.eD.FOLDER && (e.expanded = E.Z.isFolderExpanded(e.id));
            });
    }
}

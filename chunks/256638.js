...
if (null != ec && ec.type === eu.kVF.SURVEY && null != ec.metadata) {
  let {
    metadata: e
  } = ec, t = P.Z.getUserExperimentDescriptor(e.id);
...
let {
  enabled: t
} = (0, H.ZP)(!0, e !== eu.kVF.PREMIUM_TIER_2_TRIAL_ENDING);
...
case eu.kVF.NO_INPUT_DETECTED:
  if (!J.Z.supports(eE.AN.LOOPBACK))
    return (0, i.jsx)(eT, {});
  return (0, i.jsx)(eh, {});
...
case eu.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK:
  ...
  let {
    skuId: eP,
      applicationId: eb
  } = ec.metadata, eD = en.Z.get(eP), ej = O.Z.getApplication(eb);
  if (null == eD || null == ej)
    return null;
  let eU = {
    page: eu.ZY5.IN_APP
...
case eu.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL: {
  ...
  let {
    skuId: e,
    applicationId: t
  } = ec.metadata, n = en.Z.get(e), a = O.Z.getApplication(t);
  if (null == n || null == a)
    return null;
  return (0, i.jsxs)(c.Notice, {
    color: c.NoticeColors.PREMIUM_TIER_1,

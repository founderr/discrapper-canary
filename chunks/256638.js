...
let eC = a.memo(function() {
  ...
  a.useEffect(() => {
    ...
    if (null != ec && ec.type === eE.NoticeTypes.SURVEY && null != ec.metadata) {
      let {
        metadata: e
      } = ec, t = P.default.getUserExperimentDescriptor(e.id);
  ...
  switch (ec.type) {
    ...
    case eE.NoticeTypes.SPOTIFY_AUTO_PAUSED:
      let eP = h.default.get(eE.PlatformTypes.SPOTIFY);
      return (0, s.jsxs)(ei.default, {
        color: ei.NoticeColors.DANGER,
        children: [(0, s.jsx)(ei.NoticeCloseButton, {
          onClick: () => eS(),
    ...
    case eE.NoticeTypes.PREMIUM_UNCANCEL:
      return (0, s.jsxs)(ei.default, {
        ...
        children: [(0, s.jsx)(ei.NoticeCloseButton, {
          ...
          className: eI.premiumIcon
        }), eO === ef.PremiumTypes.TIER_1 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_TIER_1_NOTICE_TEXT.format({
          daysLeft: ec.metadata.daysLeft
        }) : eO === ef.PremiumTypes.TIER_0 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_TIER_0_NOTICE_TEXT.format({
          daysLeft: ec.metadata.daysLeft
          ...
          onClick: () => {
            ...
            eS(null === (t = ec.metadata) || void 0 === t ? void 0 : null === (e = t.premiumSubscription) || void 0 === e ? void 0 : e.currentPeriodEnd), (0, u.openModalLazy)(async () => {
              let {
                default: e
              } = await Promise.all([n.e("49237"), n.e("99387"), n.e("15972"), n.e("6416"), n.e("8016"), n.e("68136"), n.e("22178")]).then(n.bind(n, "561623"));
              return t => (0, s.jsx)(e, {
                ...t,
                daysLeft: ec.metadata.daysLeft,
                premiumType: eO,
          ...
          children: eO === ef.PremiumTypes.TIER_1 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_TIER_1_NOTICE_BUTTON_TEXT : eO === ef.PremiumTypes.TIER_0 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_TIER_0_NOTICE_BUTTON_TEXT : em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_NOTICE_BUTTON_TEXT
        })]
      });
    ...
    case eE.NoticeTypes.PREMIUM_MISSING_PAYMENT:
      return (0, s.jsxs)(ei.default, {
        ...
        children: [(0, s.jsx)(ei.NoticeCloseButton, {
        ...
        }), eO === ef.PremiumTypes.TIER_1 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_MISSING_PAYMENT_TIER_1_NOTICE_TEXT.format({
          daysLeft: ec.metadata.daysLeft
        }) : eO === ef.PremiumTypes.TIER_0 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_MISSING_PAYMENT_TIER_0_NOTICE_TEXT.format({
          daysLeft: ec.metadata.daysLeft
          ...
          children: eO === ef.PremiumTypes.TIER_1 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_MISSING_PAYMENT_TIER_1_NOTICE_BUTTON_TEXT : eO === ef.PremiumTypes.TIER_0 ? em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_MISSING_PAYMENT_TIER_0_NOTICE_BUTTON_TEXT : em.default.Messages.PREMIUM_SUBSCRIPTION_ENDING_MISSING_PAYMENT_NOTICE_BUTTON_TEXT
        })]
      });

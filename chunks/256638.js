  ...
  switch (ec.type) {
    ...
    case ed.kVF.GENERIC:
      return (0, i.jsxs)(c.Notice, {
        ...
        }), ec.message, null != ec.buttonText ? (0, i.jsx)(c.PrimaryCTANoticeButton, {
          onClick: ec.callback,
          noticeType: ed.kVF.GENERIC,
    ...
    case ed.kVF.NO_INPUT_DETECTED:
      if (!X.Z.supports(eE.AN.LOOPBACK)) return (0, i.jsx)(eT, {});
      return (0, i.jsx)(eh, {});
    ...
    case ed.kVF.SURVEY: {
      ...
      return (0, i.jsxs)(c.Notice, {
        ...
        }), n, (0, i.jsx)(c.PrimaryCTANoticeButton, {
          noticeType: ed.kVF.SURVEY,
          onClick: () => {
    ...
    case ed.kVF.DISPATCH_ERROR:
      ...
      return (0, i.jsxs)(c.Notice, {
        ...
        }), null == ey ? void 0 : ey.displayMessage, (0, i.jsx)(c.PrimaryCTANoticeButton, {
          noticeType: ed.kVF.DISPATCH_ERROR,
    ...
    case ed.kVF.APPLICATION_TEST_MODE:
      if (null == ec.metadata) return null;
      if (null != en.Z.testModeEmbeddedApplicationId) return (0, i.jsx)(c.Notice, {
        color: c.NoticeColors.WARNING,
        ...
        children: [(0, i.jsx)(c.NoticeCloseButton, {
          ...
          onClick: () => {
            ...
            eN(null === (t = ec.metadata) || void 0 === t ? void 0 : null === (e = t.premiumSubscription) || void 0 === e ? void 0 : e.currentPeriodEnd), (0, c.openModalLazy)(async () => {
              let {
                default: e
              } = await Promise.all([n.e("15972"), n.e("6416"), n.e("8016"), n.e("68136"), n.e("2628")]).then(n.bind(n, 561623));
              return t => (0, i.jsx)(e, {
                ...t,
                daysLeft: ec.metadata.daysLeft,
                premiumType: eA,

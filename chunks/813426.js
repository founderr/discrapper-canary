...
e.exports = function e(t, r, i, o) {
    var l = r || {};
    if (j(l, 'quoteStyle') && 'single' !== l.quoteStyle && 'double' !== l.quoteStyle) throw TypeError('option "quoteStyle" must be "single" or "double"');
    ...
    var h = !j(l, 'customInspect') || l.customInspect;
    ...
    if (
        ...
        for (var et = '<' + T.call(String(t.nodeName)), en = t.attributes || [], er = 0; er < en.length; er++)
            et +=
                ' ' +
                en[er].name +
                '=' +
        ...
        return (et += '>'), t.childNodes && t.childNodes.length && (et += '...'), (et += '</' + T.call(String(t.nodeName)) + '>');
    }
    if (G(t)) {
    ...
    if (
        (function (e) {
            return '[object Error]' === H(e) && (!L || !('object' == typeof e && L in e));
        })(t)
    ) {
        var ea = X(t, V);
        return 'cause' in Error.prototype || !('cause' in t) || x.call(t, 'cause') ? (0 === ea.length ? '[' + String(t) + ']' : '{ [' + String(t) + '] ' + y.call(ea, ', ') + ' }') : '{ [' + String(t) + '] ' + y.call(S.call('[cause]: ' + V(t.cause), ea), ', ') + ' }';
    }
    if ('object' == typeof t && h) {
        if (U && 'function' == typeof t[U] && M) return M(t, { depth: R - i });
    ...
    if (
        (function (e) {
            return '[object Number]' === H(e) && (!L || !('object' == typeof e && L in e));
        })(t)
    )
        return K(V(Number(t)));
    if (
    ...
    if (
        (function (e) {
            return '[object Boolean]' === H(e) && (!L || !('object' == typeof e && L in e));
        })(t)
    )
        return K(p.call(t));
    if (
        (function (e) {
            return '[object String]' === H(e) && (!L || !('object' == typeof e && L in e));
        })(t)
    )
        return K(V(String(t)));
    ...
    if (
        !(function (e) {
            return '[object Date]' === H(e) && (!L || !('object' == typeof e && L in e));
        })(t) &&
        !Z(t)
    ) {
        var el = X(t, V),
            ...
            ef = (eu || 'function' != typeof t.constructor ? '' : t.constructor.name ? t.constructor.name + ' ' : '') + (ed || ec ? '[' + y.call(S.call([], ed || [], ec || []), ': ') + '] ' : '');
...
function Z(e) {
    return '[object RegExp]' === H(e) && (!L || !('object' == typeof e && L in e));
}
function F(e) {

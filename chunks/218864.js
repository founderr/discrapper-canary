...
var n = i(735250), a = i(470079), r = i(481060), o = i(924489), s = i(950854), l = i(491576), c = i(605113);
function d(e) {
    var t, i, d, u, h;
    let {
            application: _,
            ...
            className: f,
            animatesOnHover: g
        } = e, C = (0, l.Z)({ application: _ }), x = null === (t = _.categories) || void 0 === t ? void 0 : t[0], I = (null !== (u = null === (i = _.directory_entry) || void 0 === i ? void 0 : i.guild_count) && void 0 !== u ? u : 0) > 0 || C.length > 0, b = a.useCallback(() => {
            p({ mutualGuilds: C });
        }, [
            p,
            C

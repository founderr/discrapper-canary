...
var n, l = s(735250), a = s(470079), i = s(120356), r = s.n(i), o = s(442837), d = s(481060), c = s(607070), u = s(251625), h = s(226951), m = s(981631), g = s(689938), E = s(258534);
function T(e, t, s) {
...
class p extends (n = a.Component) {
    ...
    render() {
        let {position: e} = this.props, t = this.getRows(), s = [];
        if (this.isEmpty())
            s.push(1);
        else
            for (let e of t)
    ...
    constructor(...e) {
        super(...e), T(this, 'inputRef', a.createRef()), T(this, 'state', {
            query: null,
            selectedSection: null,
            selectedRow: 0
        }), T(this, 'memoizedGetRows', (0, u.oH)((e, t, s) => {
            let n = RegExp('^'.concat(h.Z.escape(null != e ? e.trim() : '')), 'i'), l = e => n.test(e);
            return s.map((e, s) => t(l, s));
        })), T(this, 'getRows', () => {
            let {
                    onFilterResults: e,
                    sections: t
                } = this.props, {query: s} = this.state;
            return this.memoizedGetRows(s, e, t);
        }), T(this, 'handleChange', e => {
            var t, s;
            let n = e.target.value;
            null === (t = (s = this.props).onQueryChange) || void 0 === t || t.call(s, n), this.setState({
                query: n,
                selectedSection: null,
                selectedRow: 0
            });
            ...
            let {keyboardModeEnabled: t} = this.props, {selectedRow: s} = this.state, n = this.getRows(), l = this.getSelectedSection(n);
            switch (e.keyCode) {
            case m.yXg.TAB:
                if (t)
                    break;
            case m.yXg.ARROW_DOWN:
                e.preventDefault(), this.props.sections.length > l && ++s >= n[l].length && (++l >= this.props.sections.length && (l = 0), s = 0), this.setState({
                    selectedSection: l,
                    selectedRow: s
                });
                break;
            case m.yXg.ARROW_UP:
                e.preventDefault(), --s < 0 && (--l < 0 && (l = this.props.sections.length - 1), s = n[l].length - 1), this.setState({
                    selectedSection: l,
                    selectedRow: s
                });
                break;
        ...
        }), T(this, 'isEmpty', () => 0 === this.getRows().reduce((e, t) => e + t.length, 0)), T(this, 'getSectionHeight', e => {
            let t = this.props.sections[e];
            return this.isEmpty() || null == t ? 0 : 44;
        }), T(this, 'renderSection', e => {
            let {section: t} = e, s = this.props.sections[t];
            ...
            let i = this.getRows(), o = this.getSelectedSection(i), c = null === (t = i[s]) || void 0 === t ? void 0 : t[n];

...
function f(e, t, n) {
  ...
  t.length > c ? t = a(t) : t.length < c && (t = s.concat([t, l], c));
  for (var u = s.allocUnsafe(c + d[e]), f = s.allocUnsafe(c + d[e]), p = 0; p < c; p++) u[p] = 54 ^ t[p], f[p] = 92 ^ t[p];
  var h = s.allocUnsafe(c + n + 4);
  u.copy(h, 0, 0, c), this.ipad1 = h, this.ipad2 = u, this.opad = f, this.alg = e, this.blocksize = c, this.hash = a, this.size = d[e]
}
...
e.exports = function(e, t, n, r, i) {
  ...
  for (var h = 0, v = d[i], g = Math.ceil(r / v), b = 1; b <= g; b++) {

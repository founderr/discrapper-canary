...
t.Z = function (e) {
    let { guild: t, title: n, message: r, image: o, type: m, imageStyles: g, imageMarginX: C, imageMarginTop: _, trackingSource: v, undismissable: x, onDismissed: I, onClick: b, cta: E, ctaColor: S, centerText: N, className: Z } = e;
    l.useEffect(() => {

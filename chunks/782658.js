...
function C(e) {
    ...
    let L =
        ...
        U = (0, a.e7)(
            ...
            () => {
                var e;
                return u.ZP.getGuildScheduledEvent(null === (e = L.guild_scheduled_event) || void 0 === e ? void 0 : e.id);
            },
            [L]
        ),
        w = () => {
            null != L.channel && o.Z.transitionToInviteSync(L);
        },
        x = () => {
            (0, _.yU)()
                ? (0, E.Z)({

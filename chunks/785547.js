...
function x(e) {
  let {
    libraryApplication: t
  } = e, n = (0, E.useAnalyticsContext)(), [s, a] = (0, o.useStateFromStoresArray)([p.default, N.default], () => [(0, I.getDefaultLibraryApplicationAction)(t, p.default, N.default), p.default.getState(t.id, t.branchId)], [t]), l = (0, o.useStateFromStores)([m.default], () => m.default.isSyncing(t.id, t.branchId), [t]), r = (0, o.useStateFromStores)([T.default], () => T.default.hasNoBuild(t.id, t.branchId), [t]);
  return (0, i.jsx)(D, {
    ...e,
    analyticsContext: n,
    actionState: s,

...
class Z extends(a = r.Component) {
  ...
  render() {
    ...
    if ("unsupported_os" === n) return this.renderDisabledButton(n, x.Z.Messages.GAME_ACTION_BUTTON_UNAVAILABLE_TOOLTIP.format({

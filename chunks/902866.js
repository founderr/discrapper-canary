...
var r = n(912860), i = n(873546);
function a(e) {
    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = '' !== e.Messages.XSSDefenses ? e.Messages.XSSDefenses : e.Messages;
...
function o(e, t, n) {
    ...
    if (null != n) {
        if (null != n.window.setDevtoolsCallbacks)
            ...
            r.removeAllListeners('devtools-opened'), r.on('devtools-opened', () => {
                t.hideToken(), a(e);

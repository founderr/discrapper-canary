...
var l = n("37983"),
  ...
  S = function(e) {
    ...
    }, [t]), [S, C] = a.useState(!1), _ = (0, s.useStateFromStores)([c.default], () => c.default.hasUnreadPins(t.id), [t]), I = (0, o.useWindowDispatch)(), T = (0, u.useIsBroadcastingGDM)(t.id), v = a.useCallback(() => {
      !n && C(e => !e)
    }, [n]);
    ...
    return (a.useEffect(() => (p.ComponentDispatch.subscribe(E.ComponentActions.TOGGLE_CHANNEL_PINS, v), () => {
      ...
      children: (e, t) => {
        ...
        return (0, l.jsx)(m.Icon, {
          ...e,
          onClick: v,
          tooltip: a ? null : g.default.Messages.PINNED_MESSAGES,
          icon: h.default,

...
function o(e) {
  let {
    ...
    onTier2Subscriber: T,
    onCustomCriteria: f
  } = e, S = (0, l.usePremiumTrialOffer)(), R = (0, i.usePremiumDiscountOffer)(), m = (0, a.useStateFromStores)([n.default], () => n.default.getPremiumTypeSubscription()), A = r.default.getPremiumTypeFromSubscription(m);
  if (null != f) {
    let e = f();
    if (null != e) return e
  }

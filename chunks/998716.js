...
function R(e) {
  ...
  _getParticipantsForUser(e, t) {
    ...
    let s;
    let r = [],
      a = E.default.getVoiceStateForChannel(this.channelId, e);
    if (null == a) return r;
    let o = m.default.getUser(e);
    if (null == o) return null != this.guildId && S.default.isPublic(this.channelId) && _.default.requestMember(this.guildId, e), r;
    let l = null != t ? t[0] : null,
      u = {
        ...
        speaker: v.default.isSpeaker(e, this.channelId),
        member: null != this.guildId ? h.default.getMember(this.guildId, e) : null,
        blocked: g.default.getRelationships()[o.id] === C.RelationshipTypes.BLOCKED,
        isFriend: g.default.isFriend(o.id),
  ...
  rebuild() {
    ...
    let t = new Set(Object.keys(E.default.getVoiceStatesForChannel(e.id)));

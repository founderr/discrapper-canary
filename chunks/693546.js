var r = n(544891), i = n(570140), a = n(287734), o = n(970606), s = n(131704), l = n(826581), u = n(246364), c = n(937111), d = n(981631);
let _ = async e => {
        let t = await r.tn.get({ url: d.ANM.GUILD_JOIN_REQUEST_BY_ID(e) }), n = (0, c.j)(t.body);
        return i.Z.dispatch({
        ...
        if (!l.Z.isFetching() && E) {
            ...
            try {
                ...
                let e = await r.tn.get({
                    ...
                    }), l = e.body.total, u = (null !== (f = e.body.guild_join_requests) && void 0 !== f ? f : []).map(c.j);
                return i.Z.dispatch({
        ...
        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u.wB.APPROVED, a = arguments.length > 3 ? arguments[3] : void 0;
        (0, o.r2)({
            guildId: e,
            actionType: n,
            applicationUserId: t
        ...
        let t = !(arguments.length > 1) || void 0 === arguments[1] || arguments[1], n = await r.tn.post({ url: d.ANM.GUILD_JOIN_REQUEST_INTERVIEW(e) }), o = (0, s.q_)(n.body);
        return i.Z.dispatch({
            type: 'CHANNEL_CREATE',
            channel: o

...
var r = n(830121), i = n(754688), a = n(430824), o = n(768581), s = n(5192), l = n(154135), u = n(981631), c = n(959517), d = n(689938);
function _(e) {
    var t, n, r, i, a;
    let {
    ...
    if (null == u)
        return null;
    let I = (0, l.EY)(u.thumbnail), T = !m && u.has_media_attachment, g = m ? d.Z.Messages.MEDIA_POST_EMBED_SUBSCRIBED_CTA : d.Z.Messages.MEDIA_POST_EMBED_SUBSCRIBE_CTA, S = null != h ? s.ZP.getName(u.guild_id, u.channel_id, h) : void 0, A = null == h ? void 0 : h.getAvatarURL(null == _ ? void 0 : _.id, 40);
    ...
    let N = function (e) {
        ...
        }(u.thumbnail) && !T, v = (null === (t = u.thumbnail) || void 0 === t ? void 0 : t.filename) != null && (null === (r = u.thumbnail) || void 0 === r ? void 0 : null === (n = r.filename) || void 0 === n ? void 0 : n.startsWith(c._j));
    return {

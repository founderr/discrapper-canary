...
function T(e) {
  ...
  let {
    ...
    channel: T,
    messageData: I
  } = e, m = u.default.getGuildId(), p = o.default.getChannelId(m), N = a.useCallback(() => {
    var e;
  ...
  }, [null === (t = I.author) || void 0 === t ? void 0 : t.id, n.id, T.id, T.type, m, p]), S = (0, s.jsx)(d.default.Channel, {
    channel: T
  });

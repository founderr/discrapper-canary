...
function o(e) {
  let t = (0, l.useStateFromStores)([s.default], () => s.default.can(i.Permissions.MANAGE_CHANNELS, e));
  return __OVERLAY__ ? null : e.id === d.FAVORITES_RAW_GUILD_ID ? (0, n.jsx)(n.Fragment, {

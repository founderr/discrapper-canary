    ...
    children: e => (0, i.jsx)("div", {
      ...
      children: (0, i.jsx)(c.Button, {
        ...
        children: (0, i.jsx)(c.AppsIcon, {
          className: s()(n ? N.iconHovered : N.iconUnhovered)
        })
      })
    })
  })
  ...
  let {
    ...
    let n = e.getGuildId(),
      ...
      }),
      {
        ...
        var n, a;
        let l = e.isPrivate(),
          s = C.Z.computePermissions(e),
          o = r.e$(s, I.Plq.CREATE_PUBLIC_THREADS) || r.e$(s, I.Plq.CREATE_PRIVATE_THREADS),
          c = (!(null === (n = t.permissions) || void 0 === n ? void 0 : n.requireCreateTherads) || o) && (!(null === (a = t.permissions) || void 0 === a ? void 0 : a.requireSendMessages) || r.e$(s, I.Plq.SEND_MESSAGES)),
          u = (0, f.xl)(e);
        return {
          messagesDisabled: i || !l && !c || u
        }
      }, [e, t.permissions.requireCreateTherads, t.permissions.requireSendMessages, i]);
    return a
  }(t, n), {
    activeCommand: c
  } = (0, o.cj)([_.Z], () => {
    var e;
    return {
      activeCommand: (null === (e = n.commands) || void 0 === e ? void 0 : e.enabled) ? _.Z.getActiveCommand(t.id) : null
    }
  }), u = d.T.useExperiment({
    location: "chat_input"
  }, {
    autoTrackExposure: !0
  }).enabled, p = (0, o.e7)([h.Z], () => h.Z.shouldShowPopup(), []);

...
let A = a.forwardRef(function (e, t) {
    let [n, s] = a.useState(!1), r = (0, o.e7)([p.Z], () => p.Z.shouldShowPopup()), h = a.useCallback(() => {
            (0, d.yw)(v.rMx.CHAT_INPUT_COMPONENT_VIEWED, { type: v.K98.APPS_BUTTON }), r ? u.y(m.ti.DISMISSED) : u._(m._b.TEXT);
        }, [r]), _ = () => {
            s(!0);
        }, f = () => {
            s(!1);
        }, C = a.useRef(), g = (0, E.Z)(t, C);
    return a.useEffect(() => T.H.subscribe(e => {
        ...
        children: e => (0, i.jsx)('div', {
            ...
            children: (0, i.jsx)(c.Button, {
                ...
                children: (0, i.jsx)(c.AppsIcon, { className: l()(n ? Z.iconHovered : Z.iconUnhovered) })
            })
        })
    });
});
t.Z = a.memo(a.forwardRef(function (e) {
    let {
        ...
        }), d = h.T.useExperiment({ location: 'chat_input' }, { autoTrackExposure: !0 }).enabled, u = (0, o.e7)([p.Z], () => p.Z.shouldShowPopup(), []);

n(47120);
var i = n(735250), a = n(470079), l = n(120356), s = n.n(l), r = n(149765), o = n(442837), c = n(481060), d = n(367907), u = n(499254), h = n(424602), p = n(541099), m = n(827498), _ = n(663924), f = n(998698), E = n(747127), C = n(665906), g = n(271383), I = n(496675), x = n(594174), T = n(583027), v = n(981631), N = n(314734), S = n(689938), Z = n(979030);
let A = a.forwardRef(function (e, t) {
    let {type: n} = e, [l, r] = a.useState(!1), h = (0, o.e7)([p.Z], () => p.Z.shouldShowPopup()), _ = a.useCallback(() => {
    ...
    return a.useEffect(() => T.HJ.subscribe(e => {
        ...
        children: e => (0, i.jsx)('div', {
            ...
            children: (0, i.jsx)(c.Button, {
                ...
                children: (0, i.jsx)(c.AppsIcon, { className: s()(l ? Z.iconHovered : Z.iconUnhovered) })
            })
        })
    });
});
t.Z = a.memo(a.forwardRef(function (e) {
    let {
            ...
            let n = e.getGuildId(), i = (0, o.e7)([
                    ...
                    var n, a;
                    let l = e.isPrivate(), s = I.Z.computePermissions(e), o = r.e$(s, v.Plq.CREATE_PUBLIC_THREADS) || r.e$(s, v.Plq.CREATE_PRIVATE_THREADS), c = (!(null === (n = t.permissions) || void 0 === n ? void 0 : n.requireCreateTherads) || o) && (!(null === (a = t.permissions) || void 0 === a ? void 0 : a.requireSendMessages) || r.e$(s, v.Plq.SEND_MESSAGES)), d = (0, C.xl)(e);
            ...
            return a;
        }(t, n), {activeCommand: c} = (0, o.cj)([f.Z], () => {
            var e;
            return { activeCommand: (null === (e = n.commands) || void 0 === e ? void 0 : e.enabled) ? f.Z.getActiveCommand(t.id) : null };
        }), d = h.T.useExperiment({ location: 'chat_input' }, { autoTrackExposure: !0 }).enabled, u = (0, o.e7)([p.Z], () => {

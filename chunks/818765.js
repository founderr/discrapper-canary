n(47120), n(653041);
var s = n(570140), a = n(317770), r = n(474873), i = n(314897), l = n(19780), o = n(944486), c = n(111583), d = n(557177), _ = n(351780), u = n(843693), E = n(981631);
let T = (0, d.uk)('poggermode_applause', r.Z.getSoundpack()), I = !1, R = !1, C = [], p = null, g = () => {
        if (!I)
            T.loop(), I = !0;
    }, A = () => {
        T.stop(), I = !1;
...
class h extends a.Z {
    ...
    _terminate() {
        u.ZP.removeChangeListener(this.startAudio), s.Z.unsubscribe('RTC_CONNECTION_STATE', this.setVolume), s.Z.unsubscribe('TYPING_STOP', this.stopAudio), s.Z.unsubscribe('TYPING_STOP_LOCAL', this.stopAudio), s.Z.unsubscribe('CHANNEL_SELECT', this.stopAudio), s.Z.unsubscribe('POGGERMODE_SETTINGS_UPDATE', this.stopAudio), clearTimeout(p);
    }
    setVolume(e) {
        let {state: t} = e;
    ...
    startAudio() {
        ...
        if (null == t)
            return;
        let n = i.default.getId(), s = c.Z.isTyping(t, n), a = u.ZP.getUserCombo(n, t), r = null !== (e = null == a ? void 0 : a.multiplier) && void 0 !== e ? e : 1;
        s && r >= 7 ? g() : A();
    }

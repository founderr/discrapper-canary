...
t.Z = s.memo(function(e) {
  let {
    ...
    searchResult: C,
    searchCriteria: S
  } = (0, _.Qc)(20), f = (0, E.GN)(e => e.selectedTraits, l.Z), N = s.useMemo(() => new Set(S.games), [S.games]), A = s.useCallback(e => {
    var t;
    return (0, i.jsx)(u.ZP, {
      clan: e,
      className: p.card,
  ...
  }, [S, f, N]), Z = s.useMemo(() => null != C && (0, I.Pw)(C) ? T : [], [T, C]), L = s.useCallback(e => {

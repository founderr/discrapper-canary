...
function l(e, t, n, o) {
  ...
  u.fill(1);
  var l = r.alloc(a);
  return l = i(o, l).update(u).update(r.from([0])).update(e).update(c).digest(), u = i(o, l).update(u).digest(), l = i(o, l).update(u).update(r.from([1])).update(e).update(c).digest(), u = i(o, l).update(u).digest(), {
    k: l,
    v: u
  }
}
...
function f(e, t, n) {
  ...
  do {
    ...
    s = d(o, e), t.k = i(n, t.k).update(t.v).update(r.from([0])).digest(), t.v = i(n, t.k).update(t.v).digest()
  } while (-1 !== s.cmp(e));
  return s
}
e.exports = function(e, t, n, i, p) {
  ...
  if ("dsa" === h.type) {
    ...
    return function(e, t, n) {
      for (var i, o = t.params.priv_key, s = t.params.p, c = t.params.q, u = t.params.g, p = new a(0), h = d(e, c).mod(c), v = !1, g = l(o, c, e, n); !1 === v;) p = function(e, t, n, r) {

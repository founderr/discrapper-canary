...
var i = n(735250), a = n(470079), s = n(392711), l = n(442837), r = n(704215), o = n(481060), c = n(570140), d = n(230711), u = n(607070), h = n(367907), p = n(243778), m = n(543241), _ = n(633302), f = n(970731), E = n(594174), C = n(176354), g = n(823379), I = n(74538), x = n(401062), T = n(696900), v = n(456631), N = n(963838), S = n(535879), Z = n(310892), A = n(12168), M = n(353368), b = n(981631), R = n(354459), j = n(185923), L = n(474936), P = n(526761), O = n(689938), y = n(242343);
let D = j.Hz.CHAT, k = {
...
function w(e) {
    ...
    let z = (0, N.Iu)(H), Y = e => {
            ...
            G.current = e, e && h.ZP.trackWithMetadata(b.rMx.VOICE_CHANNEL_EFFECT_EMOJI_PICKER_EXPANDED, {
                channel_id: X,
                guild_id: Q
            });
        }, {
    ...
    let J = j ? [r.z.VOICE_CHANNEL_EFFECTS_REDUCED_MOTION_TOOLTIP] : [], $ = H === M.q.PREMIUM;
    return (0, i.jsx)(p.Z, {
        contentTypes: J,
        children: e => {
            let {
            ...
            return (0, i.jsx)(o.Popout, {
                ...
                renderPopout: () => (0, i.jsx)('div', {
                    ...
                    children: (0, i.jsx)(f.ZP, {
                        ...
                        onClick: () => {
                            d.Z.open(b.oAB.ACCESSIBILITY, null, { scrollPosition: P.rP.REDUCED_MOTION }), _();
                        },
                        markAsDismissed: a,
                ...
                children: () => (0, i.jsx)(A.Z, {
                    ...
                    emojiSearchProps: {
                        accessory: (0, i.jsx)(S.Z, {
                            ...
                            onChange: () => {
                                if (B)
                                    return h.ZP.trackWithMetadata(b.rMx.VOICE_CHANNEL_EFFECT_FANCY_ANIMATION_TOGGLED, {
                                        channel_id: X,
                                        guild_id: Q,
                                        enabled: !$
                                    }), c.Z.dispatch({ type: 'VOICE_CHANNEL_EFFECT_TOGGLE_ANIMATION_TYPE' });
                            },
                            onShowUpsell: () => (0, Z.openEffectsUpsellModal)({
                                analytics: {

...
function O(e) {
    let { children: t, size: n, onClick: i, onMouseDown: a, onKeyDown: o, onContextMenu: u, onMouseEnter: c, onMouseLeave: d, className: _, tabIndex: p, ariaLabel: S, ariaHidden: g, status: A, isMobile: N = !1, isTyping: R = !1, avatarDecoration: O, typingOffset: v, specs: C } = e,
        L = {
            width: (0, h.px)(n),
            height: (0, h.px)(n)
        },
        ...
        M =
            ...
            (0, r.jsx)('svg', {
                width: D + v,
                height: D,
                viewBox: '0 0 '.concat(D + v, ' ').concat(D),
    ...
    return (0, r.jsxs)(
        'div',
        {
            ...
            children: [
                ...
                n && (0, r.jsx)('div', { className: T.avatarSpeaking })
            ]
        },
        t
    );
...
function C(e) {
    let { src: t, status: n, size: i, statusColor: a, isMobile: o = !1, isTyping: l = !1, typingIndicatorRef: _, isSpeaking: I = !1, statusTooltip: m = !1, statusTooltipDelay: S, statusBackdropColor: g, 'aria-hidden': R = !1, 'aria-label': C, imageClassName: L } = e,
        y = n !== p.Skl.UNKNOWN ? n : null,
        D = (0, h.UC)(i),
        b = null != y ? Math.ceil((D.status * h.D6 - D.status) / 2) : 0,
        M = D.size + b,
        P = (0, c.vj)(y, a);
    return (0, r.jsx)(O, {
        ...e,
        ...
        children: (0, r.jsxs)('svg', {
            ...
            children: [
                (0, r.jsx)('foreignObject', {
                    ...
                    mask: 'url(#'.concat(
                        (function (e, t, n, r) {
                            if (null == e) return E.QS.AVATAR_DEFAULT;
                            if (r)
                                switch (t) {
                                    case h.EF.SIZE_16:
                ...
                null != y && null != g ? N(g, o, D, y) : null,
                null != y
                    ? (0, r.jsx)(d.u, {
                          text: m ? (0, f.u5)(y) : null,
                          'aria-label': !1,
                          position: 'top',
...
function L(e) {
    let { fromIsMobile: t = !0, fromStatus: n, fromColor: a, isMobile: l = !1, isTyping: E = !1, typingIndicatorRef: p, isSpeaking: I = !1, size: m, src: A, status: C, statusColor: L, statusTooltip: y = !1, statusTooltipDelay: D, statusBackdropColor: b, 'aria-hidden': M = !1, 'aria-label': P, imageClassName: U } = e,
        w = (0, c.vj)(C, L),
        x = i.useId(),
        G = i.useId(),
        [k] = i.useState(() => ({
                        ...
                        (0, r.jsxs)(r.Fragment, {
                            children: [
                                (0, r.jsxs)('svg', {
                                    ...
                                    className: y ? T.cursorDefault : void 0,
                                    children: [
                                        (0, c.vP)(W, z.status, G),
                                        (0, r.jsx)(o.animated.rect, {
                                            fill: j,
...
let y = i.memo(function (e) {
    ...
    let { statusColor: l, status: u, ...d } = e,
        ...
        m = i.useRef(I),
        T = i.useRef(!1);
    let S = T.current || ((t = E), (n = u), (a = f.current), (s = _), (o = h.current), null != a && null != n && (!!t || n !== a || (n === p.Skl.ONLINE && s !== o) || !1));
    return (
        i.useLayoutEffect(() => {
            (T.current = S), (f.current = u), (h.current = _), (m.current = I);
        }, [u, _, I, S]),
        null != u && null != f.current && S
            ? (0, r.jsx)(L, {
                  ...d,
                  status: u,
                  statusColor: I,

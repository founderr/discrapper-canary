...
let x = l.forwardRef(function (e, t) {
    let { selected: n, className: r, onClick: h } = e,
        ...
        [x, T] = (0, c.US)([a.z.RAPIDASH_MORE_GUILDS_UPSELL], C.R.SIDEBAR, !0),
        Z = x === a.z.RAPIDASH_MORE_GUILDS_UPSELL && _ && g,
        b = l.useCallback(() => {
            null == h || h(), (0, u.k5)({ source: I.JU.GUILDS_BAR_ICON }), v(f), Z && T(C.L.DISMISS);
        }, [h, f, T, Z]),
        A = l.useMemo(
            () => ({
                lowerBadgeSize: {

...
var r,
    ...
    ee = n(185923),
    et = n(74353);
let en = (0, G.Mg)(p.Z.EMOJI_PICKER_CONSTANTS_EMOJI_CONTAINER_PADDING_HORIZONTAL),
    er = (0, G.Mg)(p.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_LEFT),
                        ...
                        case W.ld.EMOJI: {
                            ...
                            u &&
                                ...
                                (0, B.fe)({
                                    ...
                                    newlyAddedHighlight: e.subCategory === X.t0.NEWLY_ADDED_EMOJI && S.Z.isNewerThanLastSeen(l, e.emoji.id)
                                }),
...
t.Z = s.memo(
    s.forwardRef(function (e, t) {
                ...
                emojiSelectAnalytics: (e) => {
                    '' !== ex
                        ...
                        : (0, B.fe)({
                              ...
                              newlyAddedHighlight: e.subCategory === X.t0.NEWLY_ADDED_EMOJI && S.Z.isNewerThanLastSeen(ek, e.emoji.id),
                              isBurstReaction: eU
                          });
                },
        ...
        eo(ea, eM),
            ...
            s.useEffect(() => {
                if (('' === eL.current && '' !== ex && (0, B.PC)(eW, o), 0 === eQ && '' !== ex)) eu(eW, ex);
        ...
        if ((null == eO ? void 0 : eO.type) === W.Bg.PREMIUM) {
            ...
            (null == eO ? void 0 : eO.type) === W.Bg.ROLE_SUBSCRIPTION
                ...
                : eU && !eZ && (i = (0, a.jsx)(V.Z, { onDismiss: () => eG(!1) }));
        let ts = (0, a.jsx)(Y.Z, {
                pickerIntention: o,
                emojiListRef: eM,
                onKeyDown: (e) => {
                ...
                onBurstReactionToggle: () => {
                    var e;
                    eG(!eU), null === (e = eP.current) || void 0 === e || e.focus();
                },
                renderHeader: eb
            }),
            to = [];
            ...
            children: (0, a.jsxs)(ti, {
                ...
                children: [
                    ...
                    ev
                        ? null
                        : (0, a.jsx)(j.Z, {
                              className: l()(et.categoryList, eS),
                              emojiListRef: eM,
                              sectionDescriptors: e2,
                              intention: o,
                              channel: u

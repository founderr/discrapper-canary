...
var _ = function() {
    i.default.track(l.AnalyticEvents.MODAL_DISMISSED, {
...
t.default = {
  openMemberVerificationModal: function(e, t) {
    E(e);
    var i, l = (i = f(function(t) {
      return d(this, function(n) {
        switch (n.label) {
          case 0:
            return [4, a.default.submitVerificationForm(e, t)];
          case 1:
            return n.sent(), [2]
        }
      })
    ...
    (0, o.openModalLazy)(f(function() {
      ...
      return d(this, function(o) {
        switch (o.label) {
          case 0:
            return [4, Promise.all([n.e("49237"), n.e("99387"), n.e("59023"), n.e("34347")]).then(n.bind(n, "9438"))];
          case 1:
      ...
      onCloseRequest: function() {
        _(), u.useMemberVerificationFormNoticeStore.getState().hasUnsubmittedChanges ? (0, u.setShowWarning)(!0) : (0, o.closeModal)(s.IN_APP_MEMBER_VERIFICATION_MODAL_KEY)
      },
      onCloseCallback: t
    })
  },
  closeMemberVerificationModal: function() {
    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
    !e && _(), (0, o.closeModal)(s.IN_APP_MEMBER_VERIFICATION_MODAL_KEY)
  }
}
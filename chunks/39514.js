...
class j extends i.PureComponent {
  ...
  getErrorMessage(e) {
    ...
    return a === L.AbortCodes.INVALID_GIFT_SELF_REDEMPTION ? D.default.Messages.GIFT_CONFIRMATION_BODY_SELF_GIFT_NO_PAYMENT : a === L.AbortCodes.INVALID_GIFT_REDEMPTION_OWNED && (null == n ? void 0 : n.productLine) === L.SKUProductLines.COLLECTIBLES ? D.default.Messages.GIFT_ERROR_OWNED : null != t || a === L.AbortCodes.INVALID_GIFT_REDEMPTION_OWNED ? D.default.Messages.GIFT_CODE_AUTH_HELP_TEXT_OWNED.format({
      libraryLink: L.Routes.APPLICATION_LIBRARY
    }) : e.isClaimed || a === L.AbortCodes.INVALID_GIFT_REDEMPTION_EXHAUSTED ? D.default.Messages.GIFT_CODE_AUTH_HELP_TEXT_CLAIMED : a === L.AbortCodes.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED ? D.default.Messages.GIFT_CODE_SMITE_REJECT_HELP_TEXT : void 0
  }
  renderSpinner(e) {
  ...
  render() {
    ...
    if (e === L.NativeAppStates.OPENING) return this.renderSpinner(D.default.Messages.APP_OPENING);
...
t.default = o.default.connectStores([N.default, g.default, h.default, m.default, T.default, _.default], e => {

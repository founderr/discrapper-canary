...
class L extends a.PureComponent {
    ...
    renderExpiredInvite() {
        ...
        return (0, i.jsxs)(p.ZP, {
            children: [
                ...
                (0, i.jsx)(p.DK, { children: b.Z.Messages.GIFT_CODE_AUTH_INVALID_BODY }),
                (0, i.jsx)(p.zx, {
    ...
    renderVerification(e) {
        ...
        return (0, i.jsxs)(p.ZP, {
            children: [
                ...
                (0, i.jsx)(p.Dx, { children: b.Z.Messages.GIFT_CODE_AUTH_VERIFICATION_TITLE.format({ username: e.username }) }),
                (0, i.jsx)(p.DK, {
    ...
    render() {
        let { nativeAppState: e, sku: t, authenticated: n, giftCode: s, isResolved: r, isAccepting: a, transitionTo: o, location: l } = this.props,

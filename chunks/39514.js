n(47120), n(411104);
var s, r, i = n(735250), a = n(470079), l = n(120356), o = n.n(l), c = n(442837), u = n(570140), d = n(893776), h = n(533307), _ = n(978085), E = n(232567), g = n(388905), p = n(362762), f = n(108427), I = n(314897), m = n(896797), N = n(82142), T = n(283595), x = n(55563), A = n(669079), C = n(63063), S = n(51144), v = n(481153), O = n(781428), Z = n(423527), R = n(981631), b = n(689938), D = n(331651);
function L(e, t, n) {
...
class M extends a.PureComponent {
    ...
    componentDidUpdate(e) {
        ...
        }), t && !e.authenticated && this.handleAuthenticated(), !t && e.authenticated && this.setState({ currentUser: null });
    }
    handleAuthenticated() {
    ...
    render() {
        ...
        if (null == s)
            return r ? this.renderExpiredInvite() : this.renderSpinner(b.Z.Messages.GIFT_CODE_AUTH_RESOLVING);
        if (r) {
            if (n) {
    ...
    constructor(...e) {
        super(...e), L(this, 'state', {
            ...
            this.setState({ fetchingUser: !0 }), E.k({ withAnalyticsToken: !0 }).then(e => this.setState({
                currentUser: e,
                fetchingUser: !1
            ...
            let n = this.getCode();
            try {
                this.setState({ error: null }), await h.Z.redeemGiftCode({ code: n }), e(R.Z5c.APP);
            } catch (e) {
                this.setState({ error: e });
            }
        }), L(this, 'resolveGiftCode', () => {
            let {transitionTo: e} = this.props, t = this.getCode();
...
t.Z = c.ZP.connectStores([
    ...
    let t = e.match.params.giftCode, n = N.Z.get(t), s = null != n ? x.Z.get(n.skuId) : null;
    return {
        giftCode: n,
        sku: s,

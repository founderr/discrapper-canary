...
let eb = {
        ...
        [ex.kVF.CONNECT_PLAYSTATION]: u.z.NAGBAR_NOTICE_CONNECT_PLAYSTATION,
        [ex.kVF.MFA_SMS_BACKUP]: u.z.NAGBAR_NOTICE_MFA_SMS_BACKUP,
        [ex.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: u.z.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING,
        [ex.kVF.PREMIUM_REACTIVATE]: u.z.NAGBAR_NOTICE_PREMIUM_REACTIVATE,
        [ex.kVF.BOUNCED_EMAIL_DETECTED]: u.z.NAGBAR_BOUNCED_EMAIL_NOTICE,
        [ex.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: u.z.NAGBAR_ACTIVATE_SERVER_SUBSCRIPTION,
        [ex.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: u.z.NAGBAR_NOTICE_PREMIUM_TIER_0_TRIAL_ENDING,
        [ex.kVF.POMELO_ELIGIBLE]: u.z.NAGBAR_NOTICE_POMELO,
        [ex.kVF.UU_MIGRATION]: u.z.UU_MIGRATION_NOTICE,
    ...
    ej = new Set([ex.kVF.NO_INPUT_DETECTED, ex.kVF.STREAMER_MODE, ex.kVF.VIDEO_UNSUPPORTED_BROWSER, ex.kVF.SPOTIFY_AUTO_PAUSED, ex.kVF.DISPATCH_ERROR, ex.kVF.DISPATCH_ERROR, ex.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, ex.kVF.BLOCKED_BY_PROXY]),
    eU = {},
    ey = Object.freeze({
        id: null,
        message: null,
    ...
    eH = {
        ...
        [ex.kVF.AUTOMOD_QUARANTINED_USER_PROFILE]: {
            predicate: (e) => {
                ...
                return null != i && !i.isPending && (0, x.EY)(i);
            }
        },
        [ex.kVF.QUARANTINED]: {
            predicate: (e) => {
        ...
        [ex.kVF.VOICE_DISABLED]: { predicate: () => null != er.Z.getRemoteDisconnectVoiceChannelId() },
        [ex.kVF.VOICE_CONNECTED_LAST_SESSION]: { predicate: () => null != er.Z.getLastSessionVoiceChannelId() },
        ...
        [ex.kVF.SPOTIFY_AUTO_PAUSED]: { predicate: () => Y.Z.wasAutoPaused() },
        [ex.kVF.BLOCKED_BY_PROXY]: { predicate: () => !eF(ex.kVF.BLOCKED_BY_PROXY) && w.Z.blockedByProxy && F.Z.getCurrentConfig({ location: 'notice_store' }).eligibleForNotice },
        ...
        [ex.kVF.PENDING_MEMBER]: {
            predicate: (e) => {
                ...
                return null !== (i = null != a && null != s && !(null === (t = en.Z.getGuild(a)) || void 0 === t ? void 0 : t.hasFeature(ex.oNc.GUILD_ONBOARDING)) && (null === (n = et.ZP.getMember(a, s.id)) || void 0 === n ? void 0 : n.isPending)) && void 0 !== i && i;
            }
        },
        [ex.kVF.OUTBOUND_PROMOTION]: { predicate: () => (0, k.tq)() },
        [ex.kVF.CORRUPT_INSTALLATION]: { predicate: () => eg.isPlatformEmbedded && (!d.Z.supported() || eO.Z.isCorruptInstallation()) },
        [ex.kVF.VIDEO_UNSUPPORTED_BROWSER]: {
            predicate: (e) => {
                let { voiceChannelId: t } = e;
                return null != t && em.Z.hasVideo(t) && !ei.Z.supports(eP.AN.VIDEO) && !eF(ex.kVF.VIDEO_UNSUPPORTED_BROWSER);
            }
        },
        ...
        [ex.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
            predicate: () => !eF(ex.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && ee.Z.getDetectedOffPlatformPremiumPerks().length > 0,
            metadata: () => ee.Z.getDetectedOffPlatformPremiumPerks()[0]
        },
        [ex.kVF.STREAMER_MODE]: { predicate: () => eu.Z.enabled },
        [ex.kVF.DOWNLOAD_NAG]: { predicate: () => !eg.isPlatformEmbedded && !eF(ex.kVF.DOWNLOAD_NAG) },
        ...
        [ex.kVF.SERVER_USAGE_SURVEY]: {
            predicate: (e) => {
                let { selectedGuildId: t } = e;
                return null != t && S.Z.getCurrentConfig({ location: 'notice_store' }).showSurvey && !eF(ex.kVF.SERVER_USAGE_SURVEY);
            },
            metadata: (e) => {
        ...
        [ex.kVF.CONNECT_PLAYSTATION]: { predicate: () => $.Z.isSuggestedAccountType(ex.ABu.PLAYSTATION) && null == $.Z.getAccount(null, ex.ABu.PLAYSTATION) && !eF(ex.kVF.CONNECT_PLAYSTATION) },
        [ex.kVF.PREMIUM_TIER_2_TRIAL_ENDING]: { predicate: () => eC.Z.getAlmostExpiringTrialOffers([ev.Si.TIER_2]).length > 0 && !eF(ex.kVF.PREMIUM_TIER_2_TRIAL_ENDING) },
        [ex.kVF.PREMIUM_TIER_0_TRIAL_ENDING]: { predicate: () => eC.Z.getAlmostExpiringTrialOffers([ev.Si.TIER_0]).length > 0 && !eF(ex.kVF.PREMIUM_TIER_0_TRIAL_ENDING) },
        [ex.kVF.PREMIUM_UNCANCEL]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    l = null != t && t.status === ex.O0b.CANCELED && !s && i <= 7 && i >= 0 && (0, eA.M5)(n, ev.p9.TIER_2) && !a && !n.hasFreePremium() && !t.isPurchasedExternally;
                return !eF(ex.kVF.PREMIUM_UNCANCEL) && l;
            },
            metadata: (e) => {
                var t;
        ...
        [ex.kVF.PREMIUM_MISSING_PAYMENT]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    _ = null != t && i <= (a > 14 ? 7 : 2) && i >= 0 && t.status !== ex.O0b.PAST_DUE && !s && l && !u && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
                return !eF(ex.kVF.PREMIUM_MISSING_PAYMENT) && _;
            },
            metadata: (e) => {
                var t;
                let { premiumSubscription: n } = e,
        ...
        [ex.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
            predicate: (e) => {
                ...
                return !eF(ex.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT) && s;
            },
            metadata: (e) => {
        ...
        [ex.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT]: {
            predicate: (e) => {
                ...
                return !eF(ex.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT) && a;
            },
            metadata: (e) => {
                let { premiumSubscription: t } = e;
                return { premiumSubscription: t };
        ...
        [ex.kVF.MFA_SMS_BACKUP]: {
            predicate: (e) => {
                let { currentUser: t } = e;
                return null != t && t.mfaEnabled && !t.hasFlag(ex.xW$.MFA_SMS) && !t.hasFlag(ex.xW$.STAFF) && !t.hasFlag(ex.xW$.PARTNER) && !eF(ex.kVF.MFA_SMS_BACKUP);
            }
        },
        ...
        [ex.kVF.PREMIUM_REACTIVATE]: { predicate: () => !eF(ex.kVF.PREMIUM_REACTIVATE) && j.Z.shouldShowReactivateNotice() },
        [ex.kVF.LOCALIZED_PRICING]: {
            predicate: (e) => {
                let { isLocalizedPromoEnabled: t } = e;
                return !eF(ex.kVF.LOCALIZED_PRICING) && t;
            },
            metadata: (e) => {
                let { premiumSubscription: t } = e;
                return { premiumSubscription: t };
        ...
        [ex.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
            predicate: (e) => {
                let { premiumSubscription: t, currentUser: n } = e,
                    ...
                    l = null != t && t.status === ex.O0b.PAST_DUE && !i && s && !n.hasFreePremium() && !t.isPurchasedExternally;
                return !eF(ex.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT) && l;
            },
            metadata: (e) => {
                let { premiumSubscription: t } = e;
                if (null == t)
        ...
        [ex.kVF.POMELO_ELIGIBLE]: { predicate: () => (0, P.e)() && !eF(ex.kVF.POMELO_ELIGIBLE) && !(0, L.ov)() },
        [ex.kVF.UU_MIGRATION]: { predicate: () => (0, P.e)() && !eF(ex.kVF.UU_MIGRATION) && (0, L.ov)() },
        [ex.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
            predicate: (e) => {
                let { selectedGuildId: t } = e,
                    n = null != t ? en.Z.getGuild(t) : null;
                return (null != t && null != R.Z.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(ex.oNc.COMMUNITY)) && !eF(ex.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION)) || !1;
            },
            metadata: (e) => {
                let { selectedGuildId: t } = e,
        ...
        [ex.kVF.ACTIVATE_SERVER_SUBSCRIPTION]: { predicate: () => !eF(ex.kVF.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== h.Z.getEligibleGuildsForNagActivate().length && (0, N.Lm)() },
        [ex.kVF.SAFETY_USER_SENTIMENT_NAGBAR]: {
            predicate: (e) => {
                let { currentUser: t } = e;
                return H.SI(t);
...
function eW() {
    return !eu.Z.enabled && delete eU[ex.kVF.STREAMER_MODE], eY();
}
class eK extends (i = c.ZP.Store) {
    initialize() {
        this.syncWith([e_.Z, el.Z, ee.Z, ec.Z, G.Z, eC.Z, Q.Z, $.Z, K.Z, O.Z, V.Z, z.Z], eY), this.waitFor(eI.default, ed.Z, en.Z, et.ZP, er.Z, ei.Z, eu.Z, p.Z, ec.Z, eE.Z, Y.Z, f.ZP, el.Z, eS.Z, eM.Z, ef.Z, ea.Z, eh.ZP, eO.Z, ee.Z, eN.Z, es.Z, G.Z, ep.Z, eC.Z, $.Z, Z.Z, h.Z, w.Z, V.Z, z.Z);
    }
    hasNotice() {
...
(l = 'NoticeStore'),
    ...
    (t.Z = new eK(E.Z, {
        ...
        DISPATCH_APPLICATION_ERROR: function () {
            return delete eU[ex.kVF.DISPATCH_ERROR], eY();
        },
        DISPATCH_APPLICATION_LAUNCH_SETUP_START: function () {
            return delete eU[ex.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS], eY();
        },

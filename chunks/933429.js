  ...
  eY = {
    ...
    [eO.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
      predicate: e => {
        let {
          premiumSubscription: t,
          currentUser: n
        } = e, s = null != t && o()(t.currentPeriodEnd).isBefore(o()()), a = null != t && null != t.paymentSourceId ? eI.default.getPaymentSource(t.paymentSourceId) : null, l = null != a && ex.PREPAID_PAYMENT_SOURCES.has(a.type), i = null != t && t.status === eO.SubscriptionStatusTypes.PAST_DUE && !s && l && !n.hasFreePremium() && !t.isPurchasedExternally;
    ...
    [eO.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR]: {
      predicate: e => {
        ...
        return !ew(eO.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR) && null != t && (0, x.shouldShowGuildOnboardingUpsell)(t, c.DismissibleContent.GUILD_ONBOARDING_UPSELL_NAGBAR)
      }
    },
...
class ez extends(s = u.default.Store) {
  initialize() {
    this.syncWith([ec.default, el.default, $.default, eo.default, F.default, eN.default, q.default, J.default, W.default, v.default, H.default, z.default], eK), this.waitFor(ef.default, eu.default, et.default, ee.default, ei.default, en.default, ed.default, A.default, eo.default, eE.default, Y.default, h.default, el.default, eh.default, eg.default, eS.default, es.default, em.default, eM.default, $.default, eI.default, ea.default, F.default, ep.default, eN.default, J.default, y.default, S.default, N.default, w.default, H.default, z.default)
  }
  hasNotice() {

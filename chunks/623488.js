...
function p(e) {
    let { imageUrl: t, name: n, description: r, formattedPrice: c, role: p, ctaComponent: _, shouldShowFullDescriptionButton: g = !0, onShowFullDescription: E, productType: C, onTapCard: I, actionMenu: x, showOpaqueBackground: N = !1, hideRoleTag: v = !1, lineClamp: T = 1, cardWidth: S = 332, cardHeight: A, thumbnailHeight: b = 187, descriptionTextVariant: j = 'text-sm/normal', isDraft: R = !1 } = e,
        Z = (0, o.hQ)(),

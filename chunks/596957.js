...
t.default = function(e) {
  let {
    ...
    let e = {};
    for (let t of Object.values(y.FriendsSections)) e[t] = "";
    return e
  }), w = s.useCallback(e => {
    k({
      ...G,
  ...
  if (0 === B.length && "" === G[t]) return (0, a.jsxs)("div", {
    ...
    children: [t === y.FriendsSections.ONLINE && (0, a.jsx)(_.default, {}), (0, a.jsx)(A.default, {
      type: t,
      onClick: () => {
        u.default.setSection(y.FriendsSections.ADD_FRIEND)
      }
    }, D)]
  });
  let H = 0 === B.length && "" !== G[t],
    V = B.filter(e => e.type === y.RelationshipTypes.PENDING_INCOMING).length,
    Y = t === y.FriendsSections.PENDING && V > 0 && j && V >= O.MINIMUM_PENDING_INCOMING_COUNT_FOR_CLEAR_ALL;
  return (0, a.jsx)(h.AnalyticsLocationProvider, {
    value: i,
    children: (0, a.jsxs)(c.default, {
      section: y.AnalyticsSections.FRIENDS_LIST,

...
t.Z = function (e) {
    let {
            sectionFilter: t,
            titleId: n
        } = e, {analyticsLocations: a} = (0, E.ZP)(h.Z.FRIENDS_LIST), {
            rows: b,
            section: P
    ...
    let B = [w], H = 0 === w.length && '' !== j[t], V = w.filter(e => e.type === O.OGo.PENDING_INCOMING).length, F = t === O.pJs.PENDING && V > 0 && y && V >= v.yf;
    return (0, i.jsx)(E.Gt, {
        value: a,

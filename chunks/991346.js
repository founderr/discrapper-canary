...
function w(e) {
    let { shouldMergeGameSettings: t, showRedesignedThirdPartyAccessSettings: n } = e,
        i = [
            ...
            {
                divider: !0,
                settings: [F.s6.CHANGELOG, F.s6.MERCHANDISE, F.s6.HYPESQUAD, F.s6.TOWNHALL, F.s6.EXPERIMENTS, F.s6.DEVELOPER_OPTIONS, F.s6.HOTSPOT_OPTIONS, F.s6.DISMISSIBLE_CONTENT_OPTIONS, F.s6.PAYMENT_FLOW_MODALS, F.s6.REVENUE_STORYBOOK, F.s6.DESIGN_SYSTEMS, F.s6.TEXT_PLAYGROUND, F.s6.TEXT_COMPONENTS, F.s6.INTL_TESTING, F.s6.PROFILE_EFFECTS_PREVIEW_TOOL, F.s6.WEB_SETTING_TREE_TOOL, F.s6.QUEST_PREVIEW_TOOL]
            },
            {
                divider: !0,

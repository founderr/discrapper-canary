...
function et(e) {
  if (X[e]) return X[e];
  let [t, n] = e.split(" "), r = q[t] || "right", a = Z[r];
  !q[n] && (n = "center");
  let i = Y[r],
    o = Y[a];
  return X[e] = {
...
function en(e, t, n, r, a, i, o, s, c, l) {
  ...
  let g = e[f] - n[h] + c + l,
    y = e[f] + e[h] - c - l;
  if (v[f] = (0, V.clamp)(v[f], g, y), u === p) {
    let n = s ? o[m] : t[J[m]];
    v[W[p]] = Math.floor(n - e[p] + a)
...
function er(e, t, n, r, a, i) {
  ...
  return o === s ? Math.max(0, n[s] - e[s] - e.scroll[s] + t[s] - r[s] - r[W[s]] - a) : Math.max(0, e[c] + e[s] + e.scroll[s] - t[s] - n[s] - n[c] - r[s] - r[W[s]] - a)
}
...
function el(e) {
  ...
  (0, V.useLayoutEffect)(x, b),
  function(e) {
    (0, V.useLayoutEffect)(() => (window.addEventListener("resize", e, !1), () => {
      window.removeEventListener("resize", e, !1)
    }), [e])
  }(x), (0, V.useResizeObserver)({
    ref: a,
    onResize: x
  });
  let S = (0, K.useRef)(!1);
...
function ev() {
  ...
  (0, V.useLayoutEffect)(() => {
    if (!t) return 1 == ++eh && (r = (0, V.isIOS)() ? function() {
      let e, t;
      let n = null,
        r = () => {
          if (n) return;
        ...
        a = (0, V.chain)(ey(document, "touchstart", n => {
          ((e = (0, V.getScrollParent)(n.target, !0)) !== document.documentElement || e !== document.body) && e instanceof HTMLElement && "auto" === window.getComputedStyle(e).overscrollBehavior && (t = eg(e, "overscrollBehavior", "contain"))
        }, {
          passive: !1,
          capture: !0
      ...
      return (0, V.chain)(eg(document.documentElement, "paddingRight", "".concat(window.innerWidth - document.documentElement.clientWidth, "px")), eg(document.documentElement, "overflow", "hidden"))
    }()), () => {
      0 == --eh && r()
    }
  }, [t])
...
function eE(e) {
  ...
  let a = (0, _.useLocalizedStringFormatter)((t = eP) && t.__esModule ? t.default : t, "@react-aria/overlays"),
    i = (0, V.useLabels)(r, a.format("dismiss"));
...
function eI(e, t) {
  ...
  return ev({
    ...
    popoverProps: (0, V.mergeProps)(c, u),
    arrowProps: d,
    underlayProps: l,
    placement: p
  }

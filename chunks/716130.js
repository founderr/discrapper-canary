...
function h(e) {
  ...
  return a.useEffect(() => {
    ...
    children: [!i && u.length < m.b3 ? (0, s.jsxs)(o.Clickable, {
      className: S.addPrompt,
      onClick: () => (0, E.tS)(t, [...c, (0, m.yZ)(!0)], !1),
    ...
    }) : null, n ? null : (0, s.jsxs)(s.Fragment, {
...
function g(e) {
  let {
    ...
    includeCount: i,
    singleColumn: r
  } = e, d = (0, l.e7)([_.Z], () => _.Z.getGuild(t)), g = (0, l.e7)([I.Z], () => I.Z.editedOnboardingPrompts), C = g.filter(e => e.inOnboarding), x = g.filter(e => !0 !== e.inOnboarding), p = [...C.map(e => ({
    id: e.id,
    data: e
  })), {
    id: "separator",
  ...
  return null == d ? null : (0, s.jsxs)(s.Fragment, {
    children: [a ? null : (0, s.jsxs)(s.Fragment, {
      children: [n ? null : (0, s.jsxs)("div", {
      ...
      children: [x.map((e, t) => (0, s.jsx)(T.Z, {
        guild: d,
        prompt: e,
        ...
        onPromptDragReset: f,
        onPromptDragComplete: L
      }, e.id)), g.length < m.YW ? (0, s.jsxs)(o.Clickable, {
        className: S.addPrompt,
        onClick: () => (0, E.tS)(d, [...g, (0, m.yZ)(!1)], !1),
        children: [(0, s.jsx)(o.CirclePlusIcon, {
          size: "custom",
          color: "currentColor",
          className: S.plusIcon,

...
function y(e) {
    let { user: t, closePopout: n, ...y } = e,
        ...
        D = i.useCallback(() => {
            if (null != A) {
                if (R) {
                    ...
                    l.__(u._b.TEXT, r, { applicationId: A.id }), (0, s.closeModal)((0, I.z)(O, C)), null == n || n(), h.default.track(S.rMx.APP_PROFILE_OPEN_APP_BUTTON_CLICKED, { application_id: A.id });
                } else
                    (0, E.LO)({
                        applicationId: A.id,
                        ...A
        ...
        L = R ? T.intl.string(T.t['Cia+Aw']) : T.intl.string(T.t.NgXl3N);

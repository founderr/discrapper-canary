...
class _ extends (l = s.PureComponent) {
    render() {
        let e = (0, u.fQ)(this.context.router), {
                ...
                id: r,
                'aria-label': l
            } = this.props, s = a.map((t, a) => t.divider ? (0, o.jsx)('hr', { className: N.divider }, 'divider-'.concat(a)) : t.external ? (0, o.jsx)('li', {
...
n = _, i = 'contextTypes', r = { router: d().object.isRequired }, i in n ? Object.defineProperty(n, i, {
    value: r,
    enumerable: !0,
    configurable: !0,
    writable: !0

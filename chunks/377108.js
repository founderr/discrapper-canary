...
class _ extends l.C {
    ...
    for (; e.pos < o;) {
      ...
      switch (t) {
        ...
        case 2:
          ...
          break;
        case 3:
          r.favoriteStickers = f.internalBinaryRead(e, e.uint32(), n, r.favoriteStickers);
          break;
        case 4:
          r.stickerFrecency = A.internalBinaryRead(e, e.uint32(), n, r.stickerFrecency);
          break;
        case 5:
          r.favoriteEmojis = m.internalBinaryRead(e, e.uint32(), n, r.favoriteEmojis);
          break;
        case 6:
          r.emojiFrecency = p.internalBinaryRead(e, e.uint32(), n, r.emojiFrecency);
          break;
        case 7:
          r.applicationCommandFrecency = g.internalBinaryRead(e, e.uint32(), n, r.applicationCommandFrecency);
          break;
        case 8:
  ...
  internalBinaryWrite(e, t, n) {
    e.versions && u.L.internalBinaryWrite(e.versions, t.tag(1, s.TD.LengthDelimited).fork(), n).join(), e.favoriteGifs && E.internalBinaryWrite(e.favoriteGifs, t.tag(2, s.TD.LengthDelimited).fork(), n).join(), e.favoriteStickers && f.internalBinaryWrite(e.favoriteStickers, t.tag(3, s.TD.LengthDelimited).fork(), n).join(), e.stickerFrecency && A.internalBinaryWrite(e.stickerFrecency, t.tag(4, s.TD.LengthDelimited).fork(), n).join(), e.favoriteEmojis && m.internalBinaryWrite(e.favoriteEmojis, t.tag(5, s.TD.LengthDelimited).fork(), n).join(), e.emojiFrecency && p.internalBinaryWrite(e.emojiFrecency, t.tag(6, s.TD.LengthDelimited).fork(), n).join(), e.applicationCommandFrecency && g.internalBinaryWrite(e.applicationCommandFrecency, t.tag(7, s.TD.LengthDelimited).fork(), n).join(), e.favoriteSoundboardSounds && D.internalBinaryWrite(e.favoriteSoundboardSounds, t.tag(8, s.TD.LengthDelimited).fork(), n).join(), e.applicationFrecency && G.internalBinaryWrite(e.applicationFrecency, t.tag(9, s.TD.LengthDelimited).fork(), n).join(), e.heardSoundFrecency && P.internalBinaryWrite(e.heardSoundFrecency, t.tag(10, s.TD.LengthDelimited).fork(), n).join(), e.playedSoundFrecency && U.internalBinaryWrite(e.playedSoundFrecency, t.tag(11, s.TD.LengthDelimited).fork(), n).join(), e.guildAndChannelFrecency && x.internalBinaryWrite(e.guildAndChannelFrecency, t.tag(12, s.TD.LengthDelimited).fork(), n).join();
...
class S extends l.C {
  ...
  binaryReadMap1(e, t, n) {
    ...
    e[null != s ? s : "0"] = null != o ? o : v.create()
  }
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.stickers)) t.tag(1, s.TD.LengthDelimited).fork().tag(1, s.TD.Bit64).fixed64(i), t.tag(2, s.TD.LengthDelimited).fork(), v.internalBinaryWrite(e.stickers[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    return !1 !== i && (!0 == i ? s.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class O extends l.C {
  ...
  binaryReadMap1(e, t, n) {
    ...
    e[null != s ? s : ""] = null != o ? o : v.create()
  }
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.emojis)) t.tag(1, s.TD.LengthDelimited).fork().tag(1, s.TD.LengthDelimited).string(i), t.tag(2, s.TD.LengthDelimited).fork(), v.internalBinaryWrite(e.emojis[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    return !1 !== i && (!0 == i ? s.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class R extends l.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.applicationCommands)) t.tag(1, s.TD.LengthDelimited).fork().tag(1, s.TD.LengthDelimited).string(i), t.tag(2, s.TD.LengthDelimited).fork(), v.internalBinaryWrite(e.applicationCommands[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    return !1 !== i && (!0 == i ? s.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class M extends l.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.heardSounds)) t.tag(1, s.TD.LengthDelimited).fork().tag(1, s.TD.LengthDelimited).string(i), t.tag(2, s.TD.LengthDelimited).fork(), v.internalBinaryWrite(e.heardSounds[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    return !1 !== i && (!0 == i ? s.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class y extends l.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.playedSounds)) t.tag(1, s.TD.LengthDelimited).fork().tag(1, s.TD.LengthDelimited).string(i), t.tag(2, s.TD.LengthDelimited).fork(), v.internalBinaryWrite(e.playedSounds[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    return !1 !== i && (!0 == i ? s.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class b extends l.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.applications)) t.tag(1, s.TD.LengthDelimited).fork().tag(1, s.TD.LengthDelimited).string(i), t.tag(2, s.TD.LengthDelimited).fork(), v.internalBinaryWrite(e.applications[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    return !1 !== i && (!0 == i ? s.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {
...
class w extends l.C {
  ...
  internalBinaryWrite(e, t, n) {
    for (let i of Object.keys(e.guildAndChannels)) t.tag(1, s.TD.LengthDelimited).fork().tag(1, s.TD.Bit64).fixed64(i), t.tag(2, s.TD.LengthDelimited).fork(), v.internalBinaryWrite(e.guildAndChannels[i], t, n), t.join().join();
    let i = n.writeUnknownFields;
    return !1 !== i && (!0 == i ? s.z.onWrite : i)(this.typeName, e, t), t
  }
  constructor() {

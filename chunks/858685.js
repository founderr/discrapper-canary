!function (e, t) {
    ...
    i.prototype.THROTTLE_TIMEOUT = 100, i.prototype.POLL_INTERVAL = null, i.prototype.USE_MUTATION_OBSERVER = !0, i.prototype.observe = function (e) {
        ...
        var t = this._rootIsInDom(), n = t ? this._getRootRect() : l();
        this._observationTargets.forEach(function (i) {
            var a = i.element, o = s(a), l = this._rootContainsTarget(a), u = i.entry, c = t && l && this._computeTargetAndRootIntersection(a, n), d = i.entry = new r({
                    time: function () {
        ...
        if ('none' != e.getComputedStyle(n).display) {
            for (var i = s(n), a = c(n), o = !1; !o;) {
                var l = null, u = 1 == a.nodeType ? e.getComputedStyle(a) : {};
                if ('none' == u.display)
                    return;

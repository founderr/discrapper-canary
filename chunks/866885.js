...
function x(e) {
    var t, n, a;
    let { channel: y, isLoading: x } = e,
        [G, k] = i.useState(!1),
        B = (0, o.e7)([N.ZP], () => N.ZP.getSelfEmbeddedActivityForChannel(y.id)),
        F = (0, o.e7)([N.ZP], () => N.ZP.getActivityPanelMode()),
        V = (0, E.q)(null == B ? void 0 : B.applicationId),
        H = null == B ? void 0 : B.launchId,
        Z = (0, o.e7)([g.Z], () => g.Z.getChannelId() === y.id),
    ...
    if (null == B || null == H || (null == K && (0, R.Z)(y.id)) || null == V) return null;
                    ...
                    children: [
                        (0, r.jsx)('div', {
                            ...
                            children:
                                ...
                                (u = J),
                                (c = ei),
                                ee && null != B && ((null == K ? void 0 : K.type) === M.fO.ACTIVITY || u)

  ...
  return e.reverse().forEach(e => {
    ...
    if (null != e.reason && n.push(new I.AuditLogChange(d.AuditLogChangeKeys.REASON, null, e.reason)), null != e.changes)
      for (let t of e.changes) {
        ...
        n.push(e), e.key === d.AuditLogChangeKeys.NAME ? T = e : e.key === d.AuditLogChangeKeys.TYPE ? i = e : e.key === d.AuditLogChangeKeys.TITLE && (u = e)
      }
    ...
    if (l.actionType === d.AuditLogActionTypes.DELETE && (null != T || null != u)) {
      ...
      (l.targetType === d.AuditLogTargetTypes.CHANNEL || l.targetType === d.AuditLogTargetTypes.CHANNEL_OVERWRITE) && null !== i && (0, L.isGuildSelectableChannelType)(i.oldValue) && (e = "#".concat(e)), null == v[l.targetType] ? v[l.targetType] = {
        [l.targetId]: e
...
function K(e) {
  ...
  let s = o.default.getMembers(S),
    E = r.default.getGuild(S),
    _ = null != S ? r.default.getRoles(S) : void 0;
  G = A()(s).filter(e => e.roles.some(t => {
    if (null != E) {
...
class F extends(E = i.default.Store) {
  get logs() {
    return g
  }
  get integrations() {
...
n = "GuildSettingsAuditLogStore", (a = "displayName") in(_ = F) ? Object.defineProperty(_, a, {
  ...
  AUDIT_LOG_FETCH_NEXT_PAGE_SUCCESS: function(e) {
    ...
    if (h = !1, D = s, O = E, c = _, U = a, C = n, M = T, (0 === t.length || t.length < d.AUDIT_LOG_PAGE_LIMIT) && (p = !1), t.length > 0) {
      let e = B(t);
      g = [...g, ...e]
    }
  },
  ...
  GUILD_SETTINGS_CLOSE: function() {
    g = [], G = [], y = d.AuditLogActions.ALL, m = null, H = null, v = {}, V = 0, R = !0, D = [], O = [], c = [], U = [], C = []
  }
})
...
n = "GuildSettingsAuditLogStore", (a = "displayName") in(_ = K) ? Object.defineProperty(_, a, {
  ...
  AUDIT_LOG_FETCH_SUCCESS: function(e) {
    var t;
    V = 0, R = !1, f = !1, p = !0, m = !1, g = B(e.logs), D = e.integrations, G = e.webhooks, O = e.guildScheduledEvents, U = null !== (t = e.automodRules) && void 0 !== t ? t : [], C = e.threads, M = e.applicationCommands, e.logs.length < d.AUDIT_LOG_PAGE_LIMIT && (p = !1)
  },
  ...
  GUILD_SETTINGS_CLOSE: function() {
    g = [], c = [], y = d.AuditLogActions.ALL, P = null, v = null, H = {}, V = 0, R = !0, D = [], G = [], O = [], U = [], C = []
  }
})
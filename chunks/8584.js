...
let f = (e, t, n, s) => {
    ...
    switch (e) {
      case x.x_.OPEN:
        return (0, i.jsxs)(i.Fragment, {
          children: [null != r ? p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_PENDING_OR_SCHEDULED_WITH_DATE.format({
            payoutDate: r
          }) : p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_PENDING, (0, i.jsx)(h.Z, {
            className: R.statusScheduledIcon
          })]
        });
      case x.x_.CANCELED:
        return (0, i.jsxs)(i.Fragment, {
          children: [p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_CANCELLED, (0, i.jsx)(_.CircleXIcon, {
            size: "md",
            color: "currentColor",
      ...
      case x.x_.PAYOUT_DEFERRED:
        if ((null == n ? void 0 : n.includes(x.XL.PAYOUT_SEIZED)) === !0) return (0, i.jsxs)(i.Fragment, {
          children: [p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_CANCELLED, (0, i.jsx)(_.CircleXIcon, {
            size: "md",
            color: "currentColor",
            className: R.statusErrorIcon
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_DEFERRED, (0, i.jsx)(g.Z, {
            className: R.statusDeferredIcon
          })]
        })
    }
    switch (t) {
      ...
      case x.jw.ERROR:
        return (0, i.jsxs)(i.Fragment, {
          children: [null != r ? p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_PENDING_OR_SCHEDULED_WITH_DATE.format({
            payoutDate: r
          }) : p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_SCHEDULED, (0, i.jsx)(h.Z, {
            className: R.statusScheduledIcon
          })]
        });
      case x.jw.PAID:
        return (0, i.jsxs)(i.Fragment, {
          children: [p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_STATUS_PAID, (0, i.jsx)(_.CircleCheckIcon, {
            size: "md",
            color: "currentColor",
      ...
      case x.jw.RISK_REVIEW:
        return (0, i.jsxs)(i.Fragment, {
          children: [S.Z.getStatusErrorText(t), (0, i.jsx)(_.CircleXIcon, {
            size: "md",
            color: "currentColor",
            className: R.statusErrorIcon
          })]
  ...
  v = e => {
    ...
    let {
      listingId: n
    } = e, s = (0, u.e7)([m.Z], () => m.Z.getSubscriptionListing(n)), a = null !== (t = null == s ? void 0 : s.name) && void 0 !== t ? t : "[".concat(p.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EARNINGS_TABLE_TIER_DELETED, "]");
    return (0, i.jsx)(L, {
      children: a
    })
  },
  D = e => {
    ...
    return (0, i.jsxs)(L, {
      ...
      children: [null != t ? t : "-", " ", (0, i.jsx)(_.UserIcon, {
        size: "md",
        color: "currentColor",
  ...
  j = () => {
    let e = (0, i.jsx)(_.Tooltip, {
      ...
      children: e => (0, i.jsx)(_.CircleInformationIcon, {
        size: "xs",
        color: "currentColor",
  ...
  b = [{
    ...
    render(e, t) {
      ...
      if (n.has(e.key))
        for (let t in e.ppgs) s.push((0, i.jsx)(v, {
          listingId: t
        }, t));
      return s
    }

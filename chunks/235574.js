...
function o(e) {
  ...
  }, [f, l, o]), m = (0, a.useMemo)(() => u(e.value), [e.value]), g = (0, a.useMemo)(() => null !== (t = u(e.defaultValue)) && void 0 !== t ? t : [o], [e.defaultValue, o]), _ = c(e.value, e.defaultValue, e.onChange), b = c(e.value, e.defaultValue, e.onChangeEnd), [v, y] = (0, i.zk)(m, g, _), [E, S] = (0, a.useState)(Array(v.length).fill(!1)), x = (0, a.useRef)(Array(v.length).fill(!0)), [w, C] = (0, a.useState)(void 0), T = (0, a.useRef)(v), D = (0, a.useRef)(E), M = e => {
    T.current = e, y(e)
  }, O = e => {
    D.current = e, S(e)
  };
  ...
  function I(e, t) {
    ...
    let i = k(e),
      a = R(e);
    t = (0, r.N4)(t, i, a, f), M(s(T.current, e, t))
  }
  ...
  function P(e) {
    let t = e * (l - o) + o;
    return (0, r.uZ)(Math.round((t - o) / f) * f + o, o, l)
  }
  return {
    values: v,
    getThumbValue: e => v[e],
    ...
    setThumbDragging: function(e, t) {
      if (n || !N(e)) return;
      let r = D.current[e];
      D.current = s(D.current, e, t), O(D.current), b && r && !D.current.some(Boolean) && b(T.current)
    },
    focusedThumb: w,
    setFocusedThumb: C,

n(789020);
var r, i, a, o, s = n(442837), l = n(570140), u = n(264229), c = n(981631);
let d = {}, _ = {}, E = {};
function f(e, t) {
    var n;
    e = null != e ? e : '';
    let r = (0, u.fU)(e), i = d[e], a = null != i ? {
...
o = 'InviteStore', (a = 'displayName') in (i = p) ? Object.defineProperty(i, a, {
    ...
    FRIEND_INVITE_REVOKE_SUCCESS: function (e) {
        e.invites.forEach(e => f(e.code, e => {
    ...
    INVITE_ACCEPT_SUCCESS: function (e) {
        return f(e.code, t => {
            t.state = c.r2o.ACCEPTED, t.guild = e.invite.guild, t.new_member = e.invite.new_member, t.channel = {
                ...t.channel,
                ...e.invite.channel
            };
        });
    ...
    INVITE_ACCEPT_FAILURE: function (e) {
        return _[e.code] = e.error, f(e.code, e => {
            e.state = c.r2o.ERROR;
        });
    },

...
function H(e) {
  ...
  } = e, G = (0, L.default)(), V = (0, r.useStateFromStoresArray)([y.default], () => null != H ? y.default.getEmbeddedActivitiesForChannel(H) : [], [H]), W = (0, r.useStateFromStores)([g.default], () => g.default.getChannel(H)), Y = (0, R.useEmbeddedApps)(V), z = (0, R.useEmbeddedAppsWithPresence)(Y), K = l.useCallback(() => {

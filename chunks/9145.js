...
function w(e) {
  ...
  let es = W.get(null !== (n = null == H ? void 0 : H.id) && void 0 !== n ? n : ""),
    ...
    eo = (0, r.Wu)([g.ZP], () => {
      var e;
      return null == V ? [] : Array.from(null !== (e = null == es ? void 0 : es.embeddedActivity.userIds) && void 0 !== e ? e : []).map(e => g.ZP.getMember(V.guild_id, e))
    }, [es, V]),
    ec = a.useMemo(() => {
      let e = new Map;
      return eo.forEach(t => {
  ...
  return (0, i.jsxs)("div", {
    ...
    ref: Y,
    style: eu,
    children: [null == B ? void 0 : B(), (0, i.jsxs)("div", {
      className: D.activityPanelContainer,
      children: [q ? null : (0, i.jsx)("div", {
        className: D.header,
      ...
      resizableNode: Y,
      onResize: e => {
        T.S.dispatch(O.CkL.MANUAL_IFRAME_RESIZING, {
          resizing: !0
        }), Q(e)
      },
      onResizeEnd: e => {

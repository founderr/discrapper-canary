...
var r = n(525654), i = n.n(r), a = n(990547), o = n(39612), s = n(271579), l = n(756647), u = n(544891), c = n(570140), d = n(479531), _ = n(34756), E = n(867176), f = n(839426), h = n(625128), p = n(972830), m = n(305325), I = n(281956), T = n(931261), g = n(15274), S = n(924301), A = n(82085), N = n(264229), v = n(652898), O = n(895886), R = n(143816), C = n(703656), y = n(922482), D = n(131704), L = n(314897), b = n(592125), M = n(984933), P = n(271383), U = n(430824), w = n(607744), x = n(341165), G = n(496675), k = n(594174), B = n(626135), F = n(70956), V = n(573261), H = n(954824), Z = n(749210), Y = n(872810), j = n(981631), W = n(176505), K = n(70722), z = n(245335), q = n(157925);
let Q = 'invite', X = null;
function $(e) {
    var t, n, r;
    let i = {};
...
function J(e) {
    let {
        ...
        } = e, {type: o} = r, s = b.Z.getChannel(r.id), l = function (e, t, n) {
            var r, i;
            if ((null == n ? void 0 : n.targetType) === z.Iq.ROLE_SUBSCRIPTIONS_PURCHASE)
                return W.oC.ROLE_SUBSCRIPTIONS;
            if ((null == n ? void 0 : n.targetType) == null && !D.tx.has(t.type) && (0, T.s)(e))
                return W.oC.GUILD_HOME;
        ...
        } = null != i ? i : {}, _ = o === j.d4z.GUILD_STAGE_VOICE, h = j.Z5c.CHANNEL(t, l);
    D.tx.has(o) ? (0, p.h)(() => {
        Promise.resolve().then(n.bind(n, 287734)).then(e => {
            let {default: n} = e, o = () => {
                    ...
                    n.selectVoiceChannel(l), c === z.Iq.STREAM && null != u && Y.iV({
    ...
    }) : (0, E.l5)(s) && c === z.Iq.EMBEDDED_APPLICATION && null != d && ((0, C.uL)(j.Z5c.CHANNEL(null != t ? t : j.ME, l)), (0, f.Z)(l, d, a, null == i ? void 0 : i.intent)), function (e, t) {
        let {type: n} = e, {
                transitionTo: r,
                welcomeModalChannelId: i,
                guildScheduledEvent: a
            } = null != t ? t : {}, o = n === j.d4z.GUILD_STAGE_VOICE, s = { navigationReplace: !0 };
        return null != i && (s.welcomeModalChannelId = i), o && (s.state = q.Df), null != a && (s.guildScheduledEventId = a.id), e => null != r ? r(e, s, R.ZP.INVITE_ACCEPT) : (0, C.uL)(e, s, R.ZP.INVITE_ACCEPT);
    }(r, i)(h);
}
let ee = function (e, t) {
        ...
        b.Z.addConditionalChangeListener(() => {
            var r;
            let i = b.Z.getChannel(e), a = k.default.getCurrentUser();
...
t.Z = {
    resolveInvite: function e(t, n, r) {
        return c.Z.isDispatching() ? Promise.resolve().then(() => e(t, n, r)) : (c.Z.dispatch({
            type: 'INVITE_RESOLVE',
            code: t
        }), (0, v.Z)(t, n, r).then(e => {
            let {
    ...
    async mobileCreateInvite(e, t) {
        ...
        if (null != n && !n.isExpired())
            return n.code;
        let r = { max_age: F.Z.Seconds.DAY }, i = await this.createInvite(e.id, r, t).catch(() => c.Z.dispatch({ type: 'NATIVE_APP_INSTANT_INVITE_GDM_SHARE_FAILED' }));
        return null == i ? void 0 : i.code;
    },
    async getAllFriendInvites(e) {
        if (await new Promise(e => c.Z.wait(() => e(null))), x.Z.getFriendInvitesFetching())
            return null != X ? X.then(e => e.body) : Promise.reject(Error('Invalid friend invite fetch request'));
        X = u.tn.get({
        ...
        let {body: t} = await X;
        return X = null, c.Z.dispatch({
            type: 'FRIEND_INVITES_FETCH_RESPONSE',
            receivedAt: new Date(),
            invites: t
        }), t;
    },
    createFriendInvite: (e, t) => (c.Z.dispatch({ type: 'FRIEND_INVITE_CREATE_REQUEST' }), u.tn.post({
        url: j.ANM.FRIEND_INVITES,
        body: null != e ? e : {},
        context: { location: t }
    }).then(e => {
    ...
    revokeFriendInvites: () => (c.Z.dispatch({ type: 'FRIEND_INVITE_REVOKE_REQUEST' }), u.tn.del({
        url: j.ANM.FRIEND_INVITES,
        context: { location }
    }).then(e => {
        let {body: t} = e;
    ...
    acceptInvite(e) {
        ...
        let {
                ...
                callback: s,
                skipOnboarding: l
            } = e, d = (0, N.fU)(a), E = d.baseCode, f = L.default.getSessionId();
        let h = (r = o, i = d, {
                ...r,
                invite_guild_scheduled_event_id: i.guildScheduledEventId
            }), p = k.default.getCurrentUser();
        return null !== (t = null == p ? void 0 : p.hasFlag(j.xW$.QUARANTINED)) && void 0 !== t && t ? ((0, O.default)(), new Promise((e, t) => t(Error()))) : (c.Z.dispatch({
            type: 'INVITE_ACCEPT',
            code: E
        }), u.tn.post({
            url: j.ANM.INVITE(E),
            ...
            let i = S.ZP.getGuildScheduledEvent(d.guildScheduledEventId), a = {
                    ...e.body,
                    guild_scheduled_event: i
                }, o = null !== (r = null == a ? void 0 : a.guild_id) && void 0 !== r ? r : null == a ? void 0 : null === (t = a.guild) || void 0 === t ? void 0 : t.id;
            if (!l && null != o && a.new_member) {
                let {default: e} = await Promise.resolve().then(n.bind(n, 17181));
                await e({ guildId: o });
            }
            return null == s || s(a), e.body;
        }, e => {
            var t, n;
            throw c.Z.dispatch({
    ...
    transitionToInvite(e, t) {
        ...
        if (null != o && (null === (r = o.features) || void 0 === r ? void 0 : r.includes(j.oNc.COMMUNITY)) && (null === (i = o.features) || void 0 === i ? void 0 : i.includes(j.oNc.MEMBER_VERIFICATION_GATE_ENABLED)) && !o.features.includes(j.oNc.PREVIEW_ENABLED)) {
            (0, C.uL)(j.Z5c.GUILD_MEMBER_VERIFICATION(o.id, e.code));
            return;
        }
        if (null == a)
            return;
        let s = $(e);
        null != t && (s.transitionTo = t), J({
    ...
    openApp(e, t, n, r, a) {
        var u, d;
        let _;
        let E = null != e ? (0, N.fU)(e) : null, f = null == E ? void 0 : E.baseCode;
        if (c.Z.dispatch({
        ...
        if ((null === (u = i().os) || void 0 === u ? void 0 : u.family) === 'Android' || (null === (d = i().os) || void 0 === d ? void 0 : d.family) === 'iOS') {
            let e = null != f ? (0, o.z0)(f) : (0, o.Gk)(), t = (0, s.WS)();
            _ = (0, s.ZP)(e, {
            ...
            '#' === (_ = null != t ? j.Z5c.INVITE_PROXY(t) : '')[0] && (_ = _.slice(1)), _ = 'discord://'.concat(_);
        H.Z.launch(_, t => {
            c.Z.dispatch(t ? {

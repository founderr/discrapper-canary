...
type: o
  } = r, s = b.Z.getChannel(r.id), l = function(e, t, n) {
var r, i;
...
}) : (0, E.l5)(s) && c === z.Iq.EMBEDDED_APPLICATION && null != d && ((0, C.uL)(j.Z5c.CHANNEL(null != t ? t : j.ME, l)), (0, f.Z)(l, d, a, null == i ? void 0 : i.intent)),
function(e, t) {
  let {
    type: n
  } = e, {
...
if (null != n && !n.isExpired())
  return n.code;
let r = {
    max_age: F.Z.Seconds.DAY
  },
  i = await this.createInvite(e.id, r, t).catch(() => c.Z.dispatch({
...
return X = null, c.Z.dispatch({
  ...
  createFriendInvite: (e, t) => (c.Z.dispatch({
...
throw c.Z.dispatch({
  ...
  revokeFriendInvites: () => (c.Z.dispatch({

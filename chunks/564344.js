...
function R() {
    ...
    function Z(s) {
        if (M !== s) {
            ...
            s === h.NB.GUILD && null == e && null != R && (0, d.Fq)(R, P), D(s);
        }
    }
    a.useEffect(() => {
        null != f && (0, E.Z)(f.id, f.getAvatarURL(null == R ? void 0 : R.id, 80), { guildId: null == R ? void 0 : R.id });
        ...
        (0, n.jsx)(l.Gt, {
            ...
            children: (0, n.jsxs)(r.HeadingLevel, {
                ...
                children: [
                    ...
                    M === h.NB.GUILD ? (0, n.jsx)(_.Z, { selectedGuild: R }) : (0, n.jsx)(T.Z, {})
                ]
            })
        })
    );

...
function A(e) {
    var t;
    let { clan: n, bannerComponent: a, expanded: c, isMember: p = !1, traitsToHighlight: A, prioritizedGameIds: N, className: C, position: R, showBrandingFooter: O = !1, bannerUrl: D, onlyAnimateIconOnHover: L = !1, hasPendingJoinRequest: x = !1, atMaxMemberCapacity: w = !1, footer: M = null } = e,
        {
            tag: P,
            badge: k,
    ...
    return (0, r.jsxs)('div', {
        className: s()(I.card, { [I.cardStaticHeight]: !c }, C),
        onMouseEnter: z,
        onMouseLeave: q,
        children: [
            (0, r.jsxs)('div', {

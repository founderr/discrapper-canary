...
function U(e) {
  let {
    traits: t,
    traitsToHighlight: n
  } = e, s = r.useMemo(() => null == n ? new Set : new Set(n), [n]), a = r.useCallback(e => (0, i.jsx)(S.Z, {
...
t.ZP = 12633 == n.j ? function(e) {
  let {
    ...
    index: I,
    source: T
  } = o, h = (0, l.e7)([R.default], () => R.default.getCurrentUser()), S = (0, l.e7)([O.ZP], () => O.ZP.isMember(_.id, null == h ? void 0 : h.id), [_, h]), f = (0, l.e7)([A.Z], () => {
    var e;

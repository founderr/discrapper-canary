var r = n(710659), i = n(812975), a = n(686942), o = function (e, t) {
        ...
        function e(e, t, n, i) {
            if (void 0 === t && (t = s), void 0 === n && (n = r.Z), void 0 === i && (i = l), this.text = [], this.language = n || r.Z, this.gettext = t, this.dateFormatter = i, this.rrule = e, this.options = e.options, this.origOptions = e.origOptions, this.origOptions.bymonthday) {
                var o = [].concat(this.options.bymonthday), u = [].concat(this.options.bynmonthday);
                o.sort(function (e, t) {
                    return e - t;
                }), u.sort(function (e, t) {
                    return t - e;
            ...
            if ((0, a.EN)(this.origOptions.byweekday)) {
                var c = (0, a.kJ)(this.origOptions.byweekday) ? this.origOptions.byweekday : [this.origOptions.byweekday], d = String(c);
                this.byweekday = {
        ...
        return e.isFullyConvertible = function (t) {
            ...
            if (this.text = [t('every')], this[i.Ci.FREQUENCIES[this.options.freq]](), this.options.until) {
                ...
                this.options.count && this.add(t('for')).add(this.options.count.toString()).add(t(this.plural(this.options.count) ? 'times' : 'time'));

...
let t = function() {
    return (0, A.to)(({
      ...
      l.X && I.kg.log('[Measurements] Adding FID'), O.fid = {
        value: e.value,
        unit: 'millisecond'
      }, O['mark.fid'] = {
        value: r + n,
  ...
  r = function() {
    return (0, A.PR)(({
      ...
      let t = e.entries[e.entries.length - 1];
      if (!!t)
        l.X && I.kg.log('[Measurements] Adding CLS'), O.cls = {
          value: e.value,
          unit: ''
        }, a = t;
    }, !0);
  ...
  o = function() {
    return (0, A.$A)(({
      ...
      let t = e.entries[e.entries.length - 1];
      if (!!t)
        l.X && I.kg.log('[Measurements] Adding LCP'), O.lcp = {
          value: e.value,
          unit: 'millisecond'
        }, n = t;
    }, !0);
  ...
  i = function() {
    return (0, A._4)(({
      ...
      if (!!e.entries[e.entries.length - 1])
        l.X && I.kg.log('[Measurements] Adding TTFB'), O.ttfb = {
          value: e.value,
          unit: 'millisecond'
        };
    });
...
function h(e) {
  let t = (0, T.QV)();
  if (!t || !R.m.performance.getEntries || !s.Z1)
return;
        ...
        (function(e, t, r) {
          [
            ...
            'connect'
              ...
              C(e, t, n, r);
            }), C(e, t, 'secureConnection', r, 'TLS/SSL', 'connectEnd'), C(e, t, 'fetch', r, 'cache', 'domainLookupStart'), C(e, t, 'domainLookup', r, 'DNS'),
            function(e, t, r) {
              let n = r + (0, T.XL)(t.requestStart),
                a = r + (0, T.XL)(t.responseEnd),
                o = r + (0, T.XL)(t.responseStart);
              t.responseEnd && ((0, T.Y)(e, n, a, {
                op: 'browser',
                name: 'request',
                attributes: {
                  [_.S3]: 'auto.ui.browser.metrics'
      ...
      case 'measure': {
        (function(e, t, r, n, a) {
          let o = (0, d.W)(),
            ...
            E = a + r,
            s = {
              [_.S3]: 'auto.resource.browser.metrics'
            };
          i !== E && (s['sentry.browser.measure_happened_before_request'] = !0, s['sentry.browser.measure_start_time'] = i), (0, T.Y)(e, i, E + n, {
            name: t.name,
            op: t.entryType,
            attributes: s
          });
        ...
        'first-paint' === t.name && i && (l.X && I.kg.log('[Measurements] Adding FP'), O.fp = {
          value: t.startTime,
          unit: 'millisecond'
        }), 'first-contentful-paint' === t.name && i && (l.X && I.kg.log('[Measurements] Adding FCP'), O.fcp = {
          value: t.startTime,
          unit: 'millisecond'
        });
        break;
...
}), p = Math.max(i.length - 1, 0), function(e) {
  let t = R.m.navigator;
  if (!t)
    return;
  let r = t.connection;
  r && (r.effectiveType && e.setAttribute('effectiveConnectionType', r.effectiveType), r.type && e.setAttribute('connectionType', r.type), (0, T.nl)(r.rtt) && (O['connection.rtt'] = {
    value: r.rtt,
    unit: 'millisecond'
  })), (0, T.nl)(t.deviceMemory) && e.setAttribute('deviceMemory', `${ t.deviceMemory } GB`), (0, T.nl)(t.hardwareConcurrency) && e.setAttribute('hardwareConcurrency', String(t.hardwareConcurrency));
}(e), 'pageload' === A) {
(function(e) {
  let t = (0, d.W)();
  if (!t)
  ...
  n <= r && (l.X && I.kg.log('[Measurements] Adding TTFB Request Time'), e['ttfb.requestTime'] = {
    value: r - n,
    unit: 'millisecond'
  });
}(O), [
...
let t = O['mark.fid'];
t && O.fid && ((0, T.Y)(e, t.value, t.value + (0, T.XL)(O.fid.value), {
    name: 'first input delay',
    op: 'ui.action',
    attributes: {
      [_.S3]: 'auto.ui.browser.metrics'
    }
  }), delete O['mark.fid']), !('fcp' in O) && delete O.cls, Object.entries(O).forEach(([e, t]) => {

...
shouldUpsellFromNoneTier: n
  } = e, t = (0, c.e7)([S.default], () => S.default.locale);
  return (0, o.jsxs)('div', {
...
theme: R
  } = (0, s.useThemeContext)(), L = (0, l.ap)(R) ? s.Button.Colors.PRIMARY : s.Button.Colors.WHITE, k = null == t || null == t.premiumSubscriptionType, O = I.ZP.getPrice(x.Xh.PREMIUM_MONTH_TIER_2, !1, !1, v), B = (0, P.T4)(O.amount, O.currency), w = (0, f.N)(), U = null == w ? void 0 : w.trial_id, D = (null == w ? void 0 : null === (n = w.subscription_trial) || void 0 === n ? void 0 : n.sku_id) === x.Si.TIER_2;
  return r.useEffect(() => {
  ...
  (0, o.jsxs)(s.ModalContent, {
    ...
    children: [
      ...
      (0, o.jsx)('div', {
        ...
        children: null != U ? T.Z.Messages.PREMIUM_UPSELL_FEATURE_PRETEXT_TRIAL_VARIANT : T.Z.Messages.PREMIUM_UPSELL_FEATURE_PRETEXT.format({
          monthlyPrice: B
        })
      }),
      (0, o.jsx)(C, {

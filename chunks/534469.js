...
t.ZP = a.memo(function (e) {
    ...
    let et = W.OBS.has(C.type) ? C.messageReference : void 0, {
            ...
            handleFocus: eC,
            handleBlur: eg
        } = (0, j.bb)(en), eI = (0, d.e7)([T.Z], () => T.Z.isEditing(q, S), [
            q,
            S
        ]), ex = (0, d.e7)([h.Z], () => h.Z.keyboardModeEnabled), eT = eo || eI || ex && ef, ev = eT || e_, eN = (0, d.e7)([I.Z], () => C.hasFlag(W.iLy.HAS_THREAD) && I.Z.getChannel(N.default.castMessageIdAsChannelId(C.id))), eS = C.isFirstMessageInForumPost(K), eZ = (0, _.A)((null !== (n = C.editedTimestamp) && void 0 !== n ? n : C.timestamp).valueOf()), eA = (0, d.e7)([x.Z], () => x.Z.isDeveloper), {
            content: eM,
            hasSpoilerEmbeds: eb
        } = (0, O.Z)(C, {
            ...
            allowDevLinks: eA,
            previewLinkTarget: !0
        }), eR = (0, L.Z)(S, q, ex), ej = (0, A.ZP)(C), eL = (0, d.e7)([f.Z], () => f.Z.getPendingReply(q)), eP = function (e) {
            let t = a.useRef(e);
            return a.useEffect(() => void (t.current = null != e ? e : t.current)), null != e ? e : t.current;
        }(J), eO = (0, m.p9)({
            guildId: K.guild_id,
            roleId: ej.iconRoleId
        }), ey = (0, R.iG)(C, $), eD = (0, R.Gx)(C), ek = (0, d.e7)([p.Z], () => p.Z.getMessage(S), [S]), eU = (0, y.Z)({
            message: C,
            channel: K
        }), ew = null != ek;

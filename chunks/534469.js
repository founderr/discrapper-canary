...
selected: q,
setPopout: X
  } = (0, O.Z)(r.id, W.d$), Q = g.RS.useSetting(), J = g.NA.useSetting(), $ = (0, u.e7)([E.Z], () => E.Z.getMessageByReference(S)), ee = (0, _.A)((null !== (n = r.editedTimestamp) && void 0 !== n ? n : r.timestamp).valueOf()), {
handleMouseEnter: et,
handleMouseLeave: en,
isHovered: ei
...
previewLinkTarget: !0,
viewingChannelId: N
  }), ec = (0, P.Z)(o, m, ea), eu = (0, A.ZP)(r), ed = (0, j.iG)(r, T), eh = (0, j.Gx)(r), em = (0, H.Z)(e, er, !1), ep = a.useCallback(() => (0, C.XU)(f, m, o), [
f,
m,
o
  ]), e_ = (0, p.p9)({
...
children: [
  ...
  (0, i.jsx)(b.Z, {
    ...
    className: l()(x, {
      ...
      [K.ephemeral]: (0, v.yE)(r.flags, z.iLy.EPHEMERAL),
...
ev = ec || ex || eT && eE,
eN = ev || ef,
eS = (0, u.e7)([I.Z], () => C.hasFlag(z.iLy.HAS_THREAD) && I.Z.getChannel(N.default.castMessageIdAsChannelId(C.id))),
  ...
  children: (0, i.jsx)('li', {
    ...
    children: (0, i.jsx)(b.Z, {
      ...
      className: l()(J, {
        ...
        [K.ephemeral]: (0, v.yE)(C.flags, z.iLy.EPHEMERAL),

a(47120);
var t = a(735250), r = a(470079), i = a(120356), n = a.n(i), l = a(418435), o = a.n(l), c = a(442837), d = a(481060), E = a(558324), S = a(367907), _ = a(999382), m = a(626135), R = a(938502), x = a(296386), u = a(219369), g = a(981631), h = a(203377), I = a(689938), p = a(536832);
...
s.Z = e => {
    ...
    let {
            ...
            if ((null == a ? void 0 : a.id) == null)
                return;
            let {keywords: s} = i;
            !(s.length >= h.G7) && x.zH(a.id, o()([
                ...s,
                e.toLowerCase()
            ]));
        }, D = e => {
            O(e), m.default.track(g.rMx.DISCOVERY_SETUP_POPULAR_TAG_CLICKED, {
                tag: e,
                primary_category_id: i.primaryCategoryId,
                ...(0, S.hH)(a.id)
            });
        }, f = T ? I.Z.Messages.SERVER_DISCOVERY_TAGS_ERROR_MSG_DASHES_ONLY : v ? I.Z.Messages.SERVER_DISCOVERY_BLOCKED_WORD_LEARN_MORE.format({
            onLearnMoreClick: () => {
                (0, u.lW)({
    ...
    return (0, t.jsxs)('div', {
        ...
        children: [
            (0, t.jsxs)('div', {
                className: p.content,
                children: [
                    (0, t.jsx)('div', { className: n()(p.stepImage, p.tagImage) }),
                    (0, t.jsx)(d.Heading, {
            ...
            (0, t.jsxs)(d.FormSection, {
                ...
                children: [
                    ...
                    (0, t.jsx)(E.Z, {
                        className: n()(p.tags, { [p.error]: null != f }),
                        tags: i.keywords,
                        onRemoveTag: e => {
                            if ((null == a ? void 0 : a.id) == null)
                                return;
            ...
            (0, t.jsx)('div', {
                ...
                children: (0, R.P5)(i.primaryCategoryId).map(e => (0, t.jsx)(d.Anchor, {
                    onClick: () => D(e),
                    className: n()(p.tag, { [p.usedTag]: b.has(e) }),
                    children: e
                }, e))
            })
        ]

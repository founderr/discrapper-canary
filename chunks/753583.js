...
s.default = e => {
  ...
  let {
    ...
    guildMetadata: i,
    headerId: d
  } = e, [h, v] = l.useState(!1), f = (0, o.useStateFromStores)([S.default], () => "keywords" in S.default.getErrors()), D = e => {
    if (T.test(e)) v(!1);
    else {
      v(!0);
      return
    ...
    D(e), R.default.track(C.AnalyticEvents.DISCOVERY_SETUP_POPULAR_TAG_CLICKED, {
      ...
      ...(0, u.collectGuildAnalyticsMetadata)(a.id)
    })
  }, O = h ? I.default.Messages.SERVER_DISCOVERY_TAGS_ERROR_MSG_DASHES_ONLY : f ? I.default.Messages.SERVER_DISCOVERY_BLOCKED_WORD_LEARN_MORE.format({
    onLearnMoreClick: () => {

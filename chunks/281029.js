...
var i = n(740504), l = n(131704), r = n(990492), a = n(981631);
function s(e, t) {
...
function d(e, t, n, i, r) {
    ...
    if (e.type === d)
        return i === t || i < t && e.type === n.type ? u(n) : i > t ? function (e, t, n) {
            var i;
            let {GUILD_CATEGORY: l} = a.d4z, r = n[(null !== (i = c(t, n, !0)) && void 0 !== i ? i : 0) + 1], s = o(-1, t.id, e.type, n);
            return null == s || s.channel.id === e.id ? null : null == r || r.channel.type === l ? {
    ...
    if (i < t)
        return n.type === d ? function (e, t, n) {
            var i;
            let r = n[(null !== (i = c(t, n, !0)) && void 0 !== i ? i : 0) - 1], a = o(1, t.id, e.type, n);
            if (null == r)
                return {
                    referenceId: null,
                    parentId: null
            ...
            var i;
            let r = n[(null !== (i = c(t, n, !0)) && void 0 !== i ? i : 0) - 1], a = o(1, t.id, e.type, n);
            return null != r || e.isGuildVocal() ? (0, l.r8)(e.type) && null != a && ((0, l.r8)(r.channel.type) || r.channel.isCategory()) ? {
                referenceId: a.channel.id,
    ...
    return n.type === d ? function (e, t, n) {
        ...
        var i;
        let l = n[(null !== (i = c(t, n, !0)) && void 0 !== i ? i : 0) + 1], r = o(-1, t.id, e.type, n);
        if (null == r)
            return null;
        if (e.isGuildVocal()) {
...
function h(e, t, n, a) {
    let s, o, u = [], d = [], h = a._categories, p = t => {
            var n, i, l, a;
            let c;
            if (null == s || null == o || (n = e, i = s, l = o, a = t, null != i && null != l && null != a[i] && a[i].channel === n && null != a[l] ? 0 : 1))
                c = [...t];
            else
                c = r.ZP.moveItemFromTo(t, s, o);
            return u = u.concat(r.ZP.calculatePositionDeltas({
                oldOrdering: t,
                newOrdering: c,
                idGetter: e => {
                    let {channel: t} = e;
    ...
    if (e.parent_id !== n) {
        let t = !1;
        u.find(i => i.id === e.id && (i.parent_id = n, t = !0)), !t && u.push({
            id: e.id,
            parent_id: n
        });
    }

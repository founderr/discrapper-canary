...
function d(e, t, n, i, r) {
  ...
  if (e.type === d) return i === t || i < t && e.type === n.type ? u(n) : i > t ? function(e, t, n) {
    var i;
    let {
      GUILD_CATEGORY: l
    } = a.d4z, r = n[(null !== (i = c(t, n, !0)) && void 0 !== i ? i : 0) + 1], s = o(-1, t.id, e.type, n);
  ...
  if (i < t) return n.type === d ? function(e, t, n) {
    var i;
    ...
    if (null != a) {
      if (s(r.channel.type, e.type) || e.isGuildVocal() && (0, l.r8)(r.channel.type)) return {
        referenceId: a.channel.id,
        parentId: r.channel.parent_id
      };
      if (r.channel.isCategory()) return {
        referenceId: a.channel.id,
  ...
  return n.type === d ? function(e, t, n) {
    ...
    if (null != a) {
      ...
      if (s(r.channel.type, e.type) || (0, l.r8)(e.type) && r.channel.isGuildVocal()) return {
        referenceId: a.channel.id,
        parentId: r.channel.parent_id
      };
      if (r.channel.isCategory()) return {
    ...
    if (e.isGuildVocal()) {
      if (null == l || l.channel.isCategory()) return {
        referenceId: r.channel.id,
        parentId: t.parent_id
      };
      if (l.channel.isGuildVocal()) return {
        referenceId: r.channel.id,

  ...
  renderVoiceCallButton() {
    ...
    return (0, i.jsx)(_.Z, {
      ...
      children: e => {
        ...
        if (a === s.z.ACTIVITY_GDM_CALL_TOOLTIP) return (0, i.jsx)(r.Popout, {
          position: "bottom",
          align: "center",
...
function k(e) {
  let {
    channel: t
  } = e, n = (0, f.Z)(), r = (0, l.e7)([p.Z], () => p.Z.getMode(t.id)), o = (0, l.e7)([S.Z], () => S.Z.isInChannel(t.id)), c = (0, l.e7)([d.Z], () => d.Z.useReducedMotion), {
    callActive: m,
    callUnavailable: _
  } = (0, l.cj)([I.Z], () => ({

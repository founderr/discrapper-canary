n(47120), n(789020);
var r = n(544891), i = n(780384), a = n(570140), o = n(149071), s = n(9156), l = n(630388), u = n(621600), c = n(709054), d = n(981631), _ = n(526761), E = n(689938);
t.Z = {
    open(e) {
        a.Z.dispatch({
    ...
    updateGuildAndChannelNotificationSettings(e, t, n, r) {
        let i = c.default.keys(t.channel_overrides), s = (0, u.GA)(e), l = (0, u.wK)(e, i);
        o.Z.saveUserGuildSettings(e, t), a.Z.dispatch({
    ...
    updateGuildNotificationSettingsBulk(e, t, n) {
        let r = c.default.keys(e), i = (0, u.rU)(r);
    ...
    updateChannelOverrideSettings(e, t, n, r, s) {
        let l = (0, u.I)(e, t);
        o.Z.saveUserGuildSettings(e, { channel_overrides: { [t]: n } }), a.Z.dispatch({
    ...
    updateChannelOverrideSettingsBulk(e, t, n, r) {
        let i = c.default.keys(t), s = (0, u.wK)(e, i);
        o.Z.saveUserGuildSettings(e, { channel_overrides: t }), a.Z.dispatch({
    ...
    setForumThreadsCreated(e, t) {
        let n = t ? _.ic.NEW_FORUM_THREADS_ON : _.ic.NEW_FORUM_THREADS_OFF, r = t ? _.ic.NEW_FORUM_THREADS_OFF : _.ic.NEW_FORUM_THREADS_ON, i = s.ZP.getChannelFlags(e);
        this.updateChannelOverrideSettings(e.guild_id, e.id, { flags: i & ~r | n }, u.UE.forumThreadsCreated(t));
    },
    async setAccountFlag(e, t) {
        let n = s.ZP.accountNotificationSettings.flags, i = (0, l.mB)(n, e, t);
        await r.tn.patch({

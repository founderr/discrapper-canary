...
function X(e) {
  ...
  switch (r) {
    case 1:
      t = f.Z.unsafe_rawColors.PREMIUM_TIER_0_PURPLE_FOR_GRADIENTS.css;
      break;
    case 3:
      t = "url(#".concat(Z.l_, ")");
      break;
...
function $(e) {
  ...
  } = e, _ = (0, h.e7)([C.ZP], () => C.ZP.getPremiumTypeSubscription()), d = (0, h.e7)([g.default], () => g.default.getCurrentUser()), E = (0, b.t7)(), I = (0, b.lr)(), f = n === F.p9.TIER_0 ? F.Si.TIER_0 : F.Si.TIER_2, S = (null == _ ? void 0 : _.trialId) != null ? null == d ? void 0 : d.premiumType : E ? F.p9.TIER_2 : null, N = (0, x.N)(), m = (0, w.Ng)(), O = null == N ? void 0 : N.subscription_trial;
  if (!t && null != S && n === S && null != _ && null != _.planIdFromItems) {
  ...
  if (!t && i) {
    ...
    if (0 === r) {
      var p, R, v, L;
      return (0, c.jsx)(A.Heading, {
        variant: "heading-md/normal",
        color: "always-white",
        className: W.trialHeader,
        children: j.Z.Messages.PREMIUM_TIER_CARD_TRIAL_HEADER_BEFORE_REDEMPTION_NEW.format({
          planName: (0, y.aq)(null !== (R = F.IW[null !== (p = null == O ? void 0 : O.sku_id) && void 0 !== p ? p : F.Si.NONE]) && void 0 !== R ? R : F.Xh.PREMIUM_MONTH_TIER_2),
          duration: (0, y.if)({
    ...
    if (null != m) return (0, c.jsx)(A.Heading, {
      variant: "heading-md/normal",
      color: "always-white",
      className: W.trialHeader,
      children: (0, c.jsx)(J, {
...
function et(e) {
  ...
  let {
    ...
    priceOptions: l,
    variant: u
  } = e, _ = (0, h.e7)([C.ZP], () => C.ZP.getPremiumTypeSubscription()), d = (0, h.e7)([g.default], () => g.default.getCurrentUser()), I = (0, x.N)(), T = null == I ? void 0 : null === (t = I.subscription_trial) || void 0 === t ? void 0 : t.sku_id, f = (null == _ ? void 0 : _.trialId) != null, S = (null == _ ? void 0 : _.trialId) != null ? null == d ? void 0 : d.premiumType : null, N = null != T || f;
  return (0, c.jsxs)("div", {
    ...
    }), a || S !== F.p9.TIER_0 ? null : (0, c.jsxs)(c.Fragment, {
      children: [(0, c.jsx)(X, {
...
function en(e) {
  let {
    ...
    isModal: n = !1,
    isGift: i = !1
  } = e, r = (0, h.e7)([R.default], () => R.default.locale), s = (0, h.e7)([U.Z], () => U.Z.affinities), o = n && !i && s.length > 0;
  switch (t) {
    case 1:
      return (0, c.jsxs)(c.Fragment, {
        children: [(0, c.jsx)(Q, {
          Icon: (0, A.makeIconCompat)(v.Z),
...
function ei(e) {
  ...
  let {
    ...
    priceOptions: _,
    variant: d
  } = e, I = (0, h.e7)([C.ZP], () => C.ZP.getPremiumTypeSubscription()), T = (0, h.e7)([g.default], () => g.default.getCurrentUser()), f = (0, x.N)(), m = null == f ? void 0 : null === (t = f.subscription_trial) || void 0 === t ? void 0 : t.sku_id, O = (null == I ? void 0 : I.trialId) != null ? null == T ? void 0 : T.premiumType : null, p = (0, b.Nx)(), R = (0, w.Ng)(), v = (0, b.t7)(), D = null != m || null != O ? 0 : null != R || v ? 1 : null, M = (0, k.Vi)(), P = !l && p, y = (0, k.W1)(), U = (0, S.ap)((0, N.ZP)()), B = U ? 5 : 2, {
    enabled: V
  } = G._.useExperiment({
    location: "Tier2Card"
  }, {
  ...
  V && (null == f ? void 0 : f.trial_id) === F.a7 && (H = j.Z.Messages.REFERRAL_PROGRAM_TWO_WEEK_TRIAL);
  ...
  return (0, c.jsxs)("div", {
    ...
    children: [!l && null != R && (0, w.Wp)(R, F.Si.TIER_2) && void 0 !== R.discount.amount ? (0, c.jsxs)(c.Fragment, {
      children: [(0, c.jsx)(X, {
      ...
      children: [(0, c.jsxs)("div", {
        children: [(0, c.jsx)(L.Z, {
        ...
        }), !l && m !== F.Si.TIER_2 && M && (0, c.jsx)(A.Text, {
          variant: "text-xs/bold",
          ...
          offerType: D,
          offerTierMatchesCard: m === F.Si.TIER_2 || (0, w.Wp)(R, F.Si.TIER_2),
          showYearlyPrice: s,
          priceOptions: _,
          textVariant: i ? "heading-lg/normal" : void 0,
          shouldUseModifiedCopy: i,
    ...
    }), r, l || m !== F.Si.TIER_2 && null == R ? null : (0, c.jsx)(Z.t, {
      tier: F.p9.TIER_2
    })]
  })
}

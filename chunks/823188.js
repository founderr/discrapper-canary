...
let e = null != c.trialEndsAt ? h()(null == c ? void 0 : c.trialEndsAt).diff(h()(), 'd') : 0,
  t = Z.GP[c.planIdFromItems],
  n = M.ZP.formatPriceString(M.ZP.getDefaultPrice(t.id), t.interval);
return (0, d.jsx)(d.Fragment, {
...
children: [
  ...
  (0, d.jsx)(X, {
    ...
    text: j.Z.Messages.PREMIUM_TIER_UPLOAD_ITEM.format({
      maxUploadPremium: (0, M.v9)(Z.p9.TIER_0, {
        useSpace: !1
      })
    }),
    className: W.modifiedItem,
...
priceOptions: c,
variant: _
  } = e, f = (0, p.e7)([R.ZP], () => R.ZP.getPremiumTypeSubscription()), h = (0, p.e7)([O.default], () => O.default.getCurrentUser()), m = (0, G.N)(), S = null == m ? void 0 : null === (t = m.subscription_trial) || void 0 === t ? void 0 : t.sku_id, A = (null == f ? void 0 : f.trialId) != null ? null == h ? void 0 : h.premiumType : null, N = (0, U.Nx)(), v = (0, x.Ng)(), C = (0, U.t7)(), D = null != S || null != A ? 0 : null != v || C ? 1 : null, L = (0, B.Vi)(), b = !l && N, M = (0, B.W1)(), P = (0, I.ap)((0, g.ZP)()), k = P ? 5 : 2, {
enabled: F
  } = w._.useExperiment({
location: 'Tier2Card'
  }, {
...
children: [
  !l && null != v && (0, x.Wp)(v, Z.Si.TIER_2) && void 0 !== v.discount.amount ? (0, d.jsxs)(d.Fragment, {
    children: [
      (0, d.jsx)(Q, {
        text: C ? j.Z.Messages.PREMIUM_TIER_CARD_DISCOUNT_APPLIED : j.Z.Messages.PREMIUM_DISCOUNT_AMOUNT_OFF_BADGE.format({
  ...
  i,
  l || S !== Z.Si.TIER_2 && null == v ? null : (0, d.jsx)(V.t, {
    tier: Z.p9.TIER_2
  })
]
  });

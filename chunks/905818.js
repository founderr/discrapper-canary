...
class X extends n.PureComponent {
  componentDidMount() {
    (0, f.fetchConsents)(), (0, _.getHarvestStatus)().then(e => {
      let t = {
        requestingHarvest: !1,
  ...
  showGuildRestrictionModal(e) {
    z({
      ...
      onCancel: () => {
        k.DefaultGuildsRestricted.updateSetting(e), k.RestrictedGuildIds.updateSetting(e ? F.default.keys(v.default.getGuilds()) : []), this.trackDefaultDmsUpdated(e, !0)
      }
    })
  }
  ...
  showMessageRequestRestrictionModal(e) {
    z({
      ...
      onCancel: () => {
        k.MessageRequestRestrictedDefault.updateSetting(e), k.MessageRequestRestrictedGuildIds.updateSetting(e ? F.default.keys(v.default.getGuilds()) : []), this.trackDefaultMessageRequestUpdated(e, !0)
      }
    })
  }
  ...
  constructor(e) {
    super(e), this.SETTINGS_TABS = {
      ...
      e ? (0, f.setConsents)([w.Consents.USAGE_STATISTICS], []).catch(Q) : z({
        ...
        onConfirm: () => (0, f.setConsents)([], [w.Consents.USAGE_STATISTICS]).catch(Q)
      })
    }, this.handlePersonalizationChange = () => {
      let e = !this.props.personalization;
      e ? (0, f.setConsents)([w.Consents.PERSONALIZATION], []).catch(Q) : z({
...
function q() {
  let e = (0, c.useStateFromStores)([P.default], () => {
    ...
    t = (0, c.useStateFromStoresObject)([D.default], () => ({
      ...
      usageStatistics: D.default.hasConsented(w.Consents.USAGE_STATISTICS),

...
var a = n("37983"),
  ...
  P = function(e) {
    ...
    let k = 0 === w.length && "" !== b[t],
      B = w.filter(e => e.type === O.RelationshipTypes.PENDING_INCOMING).length,
      F = t === O.FriendsSections.PENDING && B > 0,
      H = F && x && B >= v.MINIMUM_PENDING_INCOMING_COUNT_FOR_CLEAR_ALL;

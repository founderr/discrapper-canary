...
function G(e) {
    let { guildId: n, guildEvent: t, guildEventId: i, editBroadcastInfoData: c, isEdit: m, formErrors: g, transitionState: v, loading: j, error: p, onChange: f, onSave: N, onClose: C, createdEvent: E } = e,
        S = (0, h.Dt)(),
        T = a.useRef(t),

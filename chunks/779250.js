...
function P(e) {
  let {
    ...
    valid: !0
  }], [_, E, Z]), V = Object.keys(s).length, G = (0, g.xt)(l), y = e => Math.max(0, Math.min(e, V - 1)), [b, P] = i.useState(G ? 1 : 0), [k, z] = i.useState(!1), H = i.useMemo(() => R.slice(0, b + 1).map(e => e.valid).every(Boolean), [R, b]), F = b >= R.length ? 3 : R[y(b)].slideId, w = 3 === F;

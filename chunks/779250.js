...
var s, a, t = l(735250), i = l(470079), r = l(392711), o = l(442837), d = l(481060), c = l(447543), u = l(607070), E = l(745510), _ = l(433775), I = l(984933), x = l(430824), N = l(47309), m = l(153124), T = l(971130), h = l(981888), g = l(924301), v = l(482241), S = l(951539), C = l(545165), L = l(236373), A = l(230900), Z = l(854698), f = l(334877), j = l(785468), M = l(377329), D = l(311166), p = l(744782), R = l(129526), V = l(765305), G = l(981631), O = l(689938), U = l(836083);
let {
    INVITE_OPTIONS_7_DAYS: y,
    INVITE_OPTIONS_UNLIMITED: b
} = T.ZP;
function B(e) {
    let {modal: n} = e, {createMultipleConfetti: l} = i.useContext(E.h);
    return i.useEffect(() => {
...
function P(e) {
    ...
    let W = (0, o.e7)([u.Z], () => u.Z.useReducedMotion), X = i.useRef(null), Y = e => {
            z(!1), P(y(e));
        };
    i.useEffect(() => {
        null != C && Y(3);
...
function k(e) {
    let {
            ...
            var n;
            let l = (0, S.so)(e), s = null !== (n = e.channel_id) && void 0 !== n ? n : null == N ? void 0 : N.id;
    ...
    return (0, t.jsx)(P, {
        ...
        onChange: e => {
            if (null != e.entityType) {
                var l;
                let s = (0, A.xC)(e.entityType), [a] = (0, C.SU)(n, s);

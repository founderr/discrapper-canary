...
function S(e) {
  let {
    channel: t
  } = e, n = (0, i.useRedesignIconContext)().enabled, [S, C] = (0, s.useStateFromStoresArray)([o.default], () => [o.default.isChannelMuted(t.getGuildId(), t.id), o.default.resolvedMessageNotifications(t)], [t]), [_, I] = l.useState(!1);
  l.useEffect(() => {
    let e = () => I(!0);
  ...
  return (0, a.jsx)(i.Popout, {
    ...
    children: (e, t) => {
      ...
      return (0, a.jsx)(c.default.Icon, {
        ...
        onClick: T,
        tooltip: l ? null : v,
        icon: S || C !== p.UserNotificationSettings.ALL_MESSAGES ? d.default : u.default,

...
function S(e) {
  let {
    channel: t
  } = e, n = (0, i.useRedesignIconContext)().enabled, [S, C] = (0, s.useStateFromStoresArray)([o.default], () => [o.default.isChannelMuted(t.getGuildId(), t.id), o.default.resolvedMessageNotifications(t)], [t]), [_, I] = a.useState(!1);
  a.useEffect(() => {
    let e = () => I(!0);

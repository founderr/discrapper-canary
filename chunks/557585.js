...
function C(e) {
  let {
    ...
    let e = (0, l.useStateFromStores)([m.default], () => m.default.frecentlyPlayedSounds);
    return e
  }(), k = (0, l.useStateFromStoresArray)([m.default], () => m.default.recentlyHeardSoundIds);
  return i.useMemo(() => {
    let e = [];
    return n ? (S(e, E), {
      categories: e,

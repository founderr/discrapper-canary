...
t.ZP = o.memo(function (e) {
    var t, n, i, a, s, r;
    let { width: c, paddingVertical: T = 16, paddingHorizontal: f = 32, variant: L = 'default', onUpdatePage: x } = e,
        ...
        { loaded: D, clans: y, searchResult: j, searchCriteria: U } = (0, C.ML)(M, 'saved_guilds' === L),
    ...
    let z =
        ...
        ee = o.useCallback((e) => (0, l.jsx)(S.Z, { style: { transform: 'translateY(-6px)' } }, e), []),
        et = o.useCallback(
            (e) => {

...
let B = d().throttle(T.OQ, 1e3),
  ...
  k = e => {
    ...
    return t ? (0, s.jsx)(E.Spinner, {
      ...
      theme: r,
      className: G.empty,
      children: [(0, s.jsx)(E.EmptyStateImage, {
        darkSrc: n(458601),
        lightSrc: n(673557),
        width: 272,
        height: 212
  ...
  w = e => {
    ...
    return (0, s.jsxs)(E.FormTitle, {
      ...
      className: G.title,
      children: [t, (0, s.jsxs)("span", {
        children: [" — ", U.Z.Messages.EMOJI_SLOTS_AVAILABLE.format({
          count: n - a
        })]
      })]
    })
  ...
  V = e => {
    ...
    return null == u || d === Z.Eu4.TIER_3 || c > 0 ? null : (c > o ? (t = U.Z.Messages.GUILD_SETTINGS_EMOJIS_UPSELL_BANNER_TOO_MANY_EMOJIS_HEADER.format({
      level: u
    }), n = U.Z.Messages.GUILD_SETTINGS_EMOJIS_UPSELL_BANNER_TOO_MANY_EMOJIS_TEXT.format({
      level: u
    }), a = Z.qAy.BOOST_UPSELL_BANNER_LOST_LEVEL) : (t = U.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_BANNER_HEADER, n = U.Z.Messages.GUILD_SETTINGS_EMOJIS_UPSELL_BANNER_TEXT.format({
      level: u
    }), a = Z.qAy.BOOST_UPSELL_BANNER_SLOTS_FULL), (0, s.jsx)(C.Z, {
      header: t,
      text: n,
      guild: l,
      analyticsLocation: {
...
t.ZP = () => {
  ...
  let [P, y] = a.useMemo(() => {
    let t = null == I ? void 0 : I.filter(t => !(0, x.Kt)(t, e.id)),
      [n, s] = d().partition(t, e => !e.animated);
    return [n, s]
  }, [I, e.id]), F = e.getMaxEmojiSlots(), w = Math.max(F - P.length, F - y.length), H = (n, s, a) => (0, g.G)({
    data: n,
    file: s,
    image: a,
    guildId: e.id,
  ...
  return (0, s.jsxs)("div", {
    ...
    children: [0 === w ? null : (0, s.jsx)(N.Z, {
      ...
      children: [(0, s.jsx)(V, {
        ...
        children: [(0, s.jsx)(E.FormText, {
          type: E.FormTextTypes.DESCRIPTION,
          children: U.Z.Messages.GUILD_SETTINGS_EMOJI_UPLOAD_TO_SERVER_DESCRIPTION.format({
            count: F
          })
        }), K && (0, s.jsx)(E.FormText, {
          type: E.FormTextTypes.DESCRIPTION,
          children: U.Z.Messages.GUILD_ROLE_SUBSCRIPTION_EMOJI_SETTINGS_MANAGE_PREMIUM_TEXT.format({
            onClick: () => v.Z.open(e.id, Z.pNK.ROLE_SUBSCRIPTIONS, void 0, Z.KsC.ROLE_SUBSCRIPTION_EMOJI)
          })
        }), (0, s.jsxs)("div", {
          children: [(0, s.jsx)(E.FormTitle, {
            ...
            children: [(0, s.jsx)("li", {
              ...
              children: (0, s.jsx)(E.FormText, {
                type: E.FormTextTypes.DESCRIPTION,
                children: U.Z.Messages.GUILD_SETTINGS_EMOJI_UPLOAD_REQUIREMENTS_2.format({
                  maxSize: b.xG
                })
              })
            }), (0, s.jsx)("li", {
          ...
          children: [U.Z.Messages.UPLOAD_EMOJI, w > 0 ? (0, s.jsx)(p.Z, {
            disabled: O || 0 === w || !l,
            tabIndex: 0,
            onChange: H,
            setLoading: A,

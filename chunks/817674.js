...
async function W(e, t) {
  ...
  if (s === t) return;
  let a = e.features;
  return t ? a.add(F.GuildFeatures.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY) : a.delete(F.GuildFeatures.ENABLED_MODERATION_EXPERIENCE_FOR_NON_COMMUNITY), await j.default.saveGuild(e.id, {
    features: a
  })
}

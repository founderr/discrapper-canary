...
var a = t(64989), o = t(875380), n = t(147693);
function l(e, r) {
    if (!(0, n.kK)(e))
        return !1;
    if ('range' === r)
...
function d(e) {
    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, t = new o.Z(), d = (0, n.pG)(e), c = r.compute, p = void 0 === c ? 'name' : c, m = r.computedStyleSupportsPseudoElements, f = void 0 === m ? void 0 !== r.getComputedStyle : m, b = r.getComputedStyle, v = void 0 === b ? d.getComputedStyle.bind(d) : b;
    function h(e, r) {
        var t, o, l = '';
        if ((0, n.kK)(e) && f) {
            var i = s(v(e, '::before'));
        ...
        if (((0, n.rO)(e) ? 0 === (o = (t = e).assignedNodes()).length ? (0, a.Z)(t.childNodes) : o : (0, a.Z)(e.childNodes).concat((0, n.SS)(e, 'aria-owns'))).forEach(function (e) {
                var t = C(e, {
    ...
    function C(e, r) {
        ...
        if ((0, n.xO)(e, ['menu']) || function (e, r) {
                if (!(0, n.kK)(e))
                    return !1;
                if (e.hasAttribute('hidden') || 'true' === e.getAttribute('aria-hidden'))
                    return !0;
                var t = r(e);
                return 'none' === t.getPropertyValue('display') || 'hidden' === t.getPropertyValue('visibility');
            }(e, v) && !r.isReferenced)
            return t.add(e), '';
        var o, s, d, c, m = (0, n.SS)(e, 'aria-labelledby');
        ...
        var f = r.recursion && (b = e, (0, n.xO)(b, [
            'button',
            'combobox',
            'listbox',
            'textbox'
        ...
        if (!f) {
            var b, q, x = ((0, n.kK)(e) && e.getAttribute('aria-label') || '').trim();
            if ('' !== x && 'name' === p)
                return t.add(e), x;
            if (q = e, !(0, n.xO)(q, [
                    'none',
                ...
                var P = function (e) {
                    ...
                    if (null !== q && 0 !== q.length)
                        return t.add(e), (0, a.Z)(q).map(function (e) {
                            return C(e, {
                                isEmbeddedInLabel: !0,
                                isReferenced: !1,
                                recursion: !0
        ...
        if (f || r.isEmbeddedInLabel || r.isReferenced) {
            if ((0, n.xO)(e, [
                ...
                t.add(e);
                var y, R, g = (R = e, (0, n.RV)(R) ? R.selectedOptions || i(R, '[selected]') : i(R, '[aria-selected="true"]'));
                return 0 === g.length ? (0, n.LL)(e) ? e.value : '' : (0, a.Z)(g).map(function (e) {
                    return C(e, {
                        isEmbeddedInLabel: r.isEmbeddedInLabel,
                        isReferenced: !1,
                        recursion: !0
            ...
            if (l(e, 'range'))
                return (t.add(e), e.hasAttribute('aria-valuetext')) ? e.getAttribute('aria-valuetext') : e.hasAttribute('aria-valuenow') ? e.getAttribute('aria-valuenow') : e.getAttribute('value') || '';
            if ((0, n.xO)(e, ['textbox'])) {
                ;
        ...
        if (o = e, (0, n.xO)(o, [
                ...
                'tooltip',
                'treeitem'
            ]) || (0, n.kK)(e) && r.isReferenced || (s = e, (0, n.GD)(s)) || (d = 0, 0))
            return t.add(e), h(e, {
                isEmbeddedInLabel: r.isEmbeddedInLabel,
                isReferenced: !1
            });
        if (e.nodeType === e.TEXT_NODE)
            return t.add(e), e.textContent || '';
        if (r.recursion)
            return t.add(e), h(e, {
                isEmbeddedInLabel: r.isEmbeddedInLabel,
                isReferenced: !1

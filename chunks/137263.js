...
(l.prototype._update = function (e) {
    for (var t = this._w, n = 0 | this._a, r = 0 | this._b, i = 0 | this._c, a = 0 | this._d, o = 0 | this._e, l = 0; l < 16; ++l) t[l] = e.readInt32BE(4 * l);
    ...
    for (var u = 0; u < 80; ++u) {
        var c,
            ...
            p,
            m = ~~(u / 20);
        var g = ((((c = n) << 5) | (c >>> 27)) + ((d = m), (f = r), (_ = i), (h = a), 0 === d ? (f & _) | (~f & h) : 2 === d ? (f & _) | (f & h) | (_ & h) : f ^ _ ^ h) + o + t[u] + s[m]) | 0;
        (o = a), (a = i), (i = ((p = r) << 30) | (p >>> 2)), (r = n), (n = g);
    }

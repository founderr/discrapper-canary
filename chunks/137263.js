...
r(l, i),
    ...
    (l.prototype._update = function (e) {
        for (var t = this._w, n = 0 | this._a, r = 0 | this._b, i = 0 | this._c, a = 0 | this._d, s = 0 | this._e, l = 0; l < 16; ++l) t[l] = e.readInt32BE(4 * l);
        for (; l < 80; ++l) t[l] = t[l - 3] ^ t[l - 8] ^ t[l - 14] ^ t[l - 16];
        for (var _ = 0; _ < 80; ++_) {
            var E = ~~(_ / 20),
                f = (u(n) + d(E, r, i, a) + s + t[_] + o[E]) | 0;
            (s = a), (a = i), (i = c(r)), (r = n), (n = f);
        }

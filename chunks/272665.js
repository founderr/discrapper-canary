...
var r = function(e) {
    return e.split("_", 2).includes("a")
  },
  o = function(e, t) {
    return null == e || null == t ? e === t : e.asset === t.asset && e.skuId === t.skuId
  },
  i = function(e) {
    return "object" == typeof e && null != e && "asset" in e && "string" == typeof e.asset ? "sku_id" in e && "string" == typeof e.sku_id ? {
      asset: e.asset,
      skuId: e.sku_id

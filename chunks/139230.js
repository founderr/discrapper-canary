...
function B(e) {
  ...
  let {
    match: f
  } = e, S = null !== (l = (0, u.getLastRouteChangeSourceLocationStack)()) && void 0 !== l ? l : [], {
    analyticsLocations: C
  } = (0, r.default)([...S, c.default.ACTIVITY_DETAIL_PAGE]), {
    applicationId: T
  } = f.params;
  (0, E.useFetchDeveloperActivityShelfItems)(), t.useEffect(() => {
    (0, j.fetchShelf)({
      guildId: null
    })
  }, []);
  ...
  let D = null != y.activity.activity_preview_video_asset_id ? (0, N.default)(T, y.activity.activity_preview_video_asset_id) : null,
    B = b.ACTIVITIES_EXTRA_DETAILS[T],
    ...
    children: (0, i.jsxs)("div", {
      ...
      children: [(0, i.jsxs)(g.default, {
        children: [(0, i.jsxs)("div", {
          ...
          className: k.__invalid_headerBarRightSideFiller
        })]
      }), (0, i.jsx)(d.Scroller, {
...
function R(e) {
  ...
  let {
    ...
    (0, d.openModalLazy)(async () => {
      let {
        default: e
      } = await Promise.all([a.e("99387"), a.e("60133")]).then(a.bind(a, "827940"));
      return l => (0, i.jsx)(e, {
        activityItem: n,
        ...l,
        analyticsLocations: c
  ...
  return (0, i.jsxs)("div", {
    ...
    children: [(0, i.jsx)(d.Text, {
      ...
      optionClassName: k.__invalid_option,
      options: x,
      renderOptionValue: e => {

...
i = class {
  ...
  get canUsePremiumProfileCustomization() {
    return u.default.isPremiumAtLeast(this.premiumType, a.PremiumTypes.TIER_2)
  }
  get canEditThemes() {
  ...
  getPreviewBio(e) {
    var t;
    return (0, l.getProfilePreviewField)(e, null === (t = this._guildMemberProfile) || void 0 === t ? void 0 : t.bio, this._userProfile.bio, null != this.guildId)
  }
  ...
  constructor(e, t) {
    var n, i, l, r;
    this.userId = e.userId, this.guildId = null == t ? void 0 : t.guildId, this.banner = null !== (n = null == t ? void 0 : t.banner) && void 0 !== n ? n : e.banner, this.bio = s(e.bio, null == t ? void 0 : t.bio), this.pronouns = s(e.pronouns, null == t ? void 0 : t.pronouns), this.accentColor = e.accentColor, this.themeColors = null !== (i = null == t ? void 0 : t.themeColors) && void 0 !== i ? i : e.themeColors, this.popoutAnimationParticleType = null !== (l = null == t ? void 0 : t.popoutAnimationParticleType) && void 0 !== l ? l : e.popoutAnimationParticleType, this.profileEffectId = null !== (r = null == t ? void 0 : t.profileEffectId) && void 0 !== r ? r : e.profileEffectId, this._userProfile = e, this._guildMemberProfile = t
  }
}
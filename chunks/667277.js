...
function O(e, t, n, I) {
    ...
    try {
        for (J.s(); !($ = J.n()).done; ) {
            var ee = (function () {
                var t = $.value;
                !(null != I && I.useAdditionalWeekYearTokens) && (0, u.Do)(t) && (0, u.qp)(t, v, e), !(null != I && I.useAdditionalDayOfYearTokens) && (0, u.Iu)(t) && (0, u.qp)(t, v, e);
                var n = t[0],
                    r = E.f[n];
                if (r) {

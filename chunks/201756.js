...
function R(e) {
  ...
  } = e, o = (0, C.e7)([h.Z], () => h.Z.getSearchStateByGuildId(t), [t], r()), i = (0, C.e7)([m.Z, u.Z], () => m.Z.can(I.Plq.MANAGE_GUILD, u.Z.getGuild(t)), [t]), {
    selectedUserIds: R,
    addUsers: S,
    clearSelection: Z
  ...
  }, []), Y = (0, E.xC)(t), G = a.useMemo(() => l.filter(e => (0, E.rX)(t, Y, e)), [Y, l, t]), z = G.length > 0, q = 0 === G.filter(e => !R.has(e)).length, W = a.useCallback(() => {
    z && (q ? Z() : S(G))
  }, [z, q, Z, S, G]);

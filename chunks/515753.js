...
function X(e) {
  let {
    ...
    null != e && (e.preventDefault(), e.stopPropagation()), C.default.closePrivateChannel(t.id, r, n)
  }, ei = () => {
    C.default.preload(V.ME, t.id)
  }, er = e => {
    e.stopPropagation()
  }, eo = e => {
  ...
  }, eh = t.isMultiUserDM(), eC = t.isSystemDM(), ep = (0, T.systemDMRedesignEnabled)();
    ...
    children: e => {
      ...
      return (0, l.jsx)(j.default, {
        ...
        children: (0, l.jsxs)(h.Interactive, {
          ...
          }), en ? (0, l.jsx)(Z, {}) : null, !eC && (0, l.jsx)(W, {

...
function X(e) {
    let { channel: t, isGDMFacepileEnabled: r, selected: o = !1, user: d, activities: E, applicationStream: j, entry: M, isTyping: L, status: w, isMobile: O, 'aria-posinset': G, 'aria-setsize': U } = e,
        [B, Q] = l.useState(!1),
        X = l.useRef(null),
        J = l.useRef(null),
        {

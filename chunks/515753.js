...
function $(e) {
    var t;
    let { channel: r, isGDMFacepileEnabled: o, selected: d = !1, user: T, activities: P, applicationStream: M, entry: L, isTyping: O, status: U, isMobile: G, 'aria-posinset': B, 'aria-setsize': J } = e,
        [$, ee] = l.useState(!1),
        et = l.useRef(null),
        en = l.useRef(null),
        {

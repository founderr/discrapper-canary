...
function ei(e) {
    let {
            ...
            let n = T.Y.useExperiment({ location: 'account popout' }).expiringStatus, s = w.Cr.useSetting(), a = (0, S.p)(), r = C.e.useExperiment({ location: 'account popout' }).allowQuietMode || a, o = w.fv.useSetting(), c = e === q.Skl.DND, u = t => {
        ...
        }(el, ei), {ref: ec} = (0, _.Z)(), ed = (0, h.Z)(ec);
    s.useEffect(() => {
        null == a || a(ec.current);
    }, [
        ec,
                                        ...
                                        (0, i.jsx)(M.Z.Overlay, {
                                            ...
                                            children: (0, i.jsxs)(d.Menu, {
                                                ...
                                                children: [
                                                    ...
                                                    (0, i.jsx)(d.MenuGroup, {
                                                        children: (0, i.jsx)(d.MenuItem, {
                                                            ...
                                                            label: (0, i.jsxs)('div', {
                                                                ...
                                                                children: [
                                                                    (0, Y.u5)(el),
                                                                    eE || eI ? (0, i.jsx)(d.BellSlashIcon, { size: 'xxs' }) : null
                                                                ]
                                                            }),
                                                            focusedClassName: J.menuItemFocused,
                                                            subMenuIconClassName: J.subMenuIcon,
                                                    ...
                                                    !e_ && (0, i.jsx)(d.MenuGroup, { children: eg })
                                                ]
                                            })
                                        }),
                                        (0, i.jsx)(M.Z.Overlay, {
                                            ...
                                            children: (0, i.jsxs)(d.Menu, {
                                                ...
                                                children: [
                                                    ...
                                                    (0, i.jsx)(d.MenuGroup, { children: ep })
                                                ]
                                            })
                                        })
                                    ]

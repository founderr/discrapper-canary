n(47120);
var r = n(442837), i = n(348326), a = n(570140), o = n(710845), s = n(314897), l = n(115522);
function u(e, t, n) {
...
class d extends r.yh {
    ...
    handleConnectionOpen() {
        let e = s.default.getId(), t = this.databases.get(e), n = null == t ? void 0 : t.state();
        null == t && n !== i.hi.Open && this.remove(e), this.carefullyOpenDatabase(e);
    }
    handleAuthenticationStoreChanged() {
        let e = s.default.getId(), t = this.activeUserId;
        if (e !== t) {
            let n = this.databases.get(t);
    ...
    constructor() {
        ...
        }, a.c.Early), u(this, 'databases', new Map()), u(this, 'activeUserId', null), u(this, 'preventWritingCachesAgainThisSession', !1);
    }
}
function _(e) {

...
class o {
    ...
    constructor(e, t, n = 'An unexpected error occurred.') {
        ...
        let { message: r, code: o, retryAfter: s, fields: l, status: u } = a(e, t);
        (this.message = r || n), (this.retryAfter = s), (this.code = o || -1), (this.fields = l || {}), (this.status = u), (this.error = Error(r));
    }
}

...
function h(e) {
  ...
  let N = null != t.guild ? new a.ZP(t.guild) : null,
    ...
    m = h || null == t.inviter ? null : new o.Z(t.inviter),
    T = !(null != t.approximate_member_count && t.approximate_member_count > c.mx || null != N && N.hasFeature(d.oNc.COMMUNITY)) && null != m && (0, c.WT)(t),
    Z = I(t),
    A = {
      invite: t,
      user: m,

n(47120), n(733860);
var s = n(735250), a = n(470079), i = n(392711), r = n.n(i), l = n(149765), o = n(442837), c = n(481060), d = n(497321), u = n(484614), _ = n(933557), E = n(984933), I = n(496675), T = n(699516), m = n(246946), N = n(594174), S = n(434404), h = n(999382), g = n(981631), C = n(689938), x = n(55023);
function p(e, t, n) {
...
let R = 'NO_INSTANT_INVITE', f = l.$e(g.Plq.VIEW_CHANNEL, g.Plq.CREATE_INSTANT_INVITE);
class L extends a.PureComponent {
    static getDerivedStateFromProps(e, t) {
        let {widgetEnabled: n} = e, {widgetEnabledProp: s} = t;
        return n !== s ? {
            internalEnabled: n,
            widgetEnabledProp: n
        } : null;
    ...
    render() {
        ...
        return null == e ? null : this.props.hide ? (0, s.jsx)(d.Z, {}) : (0, s.jsxs)(c.FormSection, {
    ...
    constructor(...e) {
        super(...e), p(this, 'state', {
        ...
        }), p(this, 'renderToggle', () => (0, s.jsx)(c.FormSwitch, {
            className: x.spacing,
            ...
            if (null != t)
                this.setState({ internalEnabled: e }), S.Z.updateEmbed(t.id, e, n);
            ...
            if (null != t)
                S.Z.updateEmbed(t.id, n, e !== R ? e : null);
        });
    }
}

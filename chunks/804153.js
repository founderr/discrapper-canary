...
class L extends a.PureComponent {
  ...
  renderChannelSelect(e) {
    let {
      widgetChannelId: t
    } = this.props, n = E.ZP.getChannels(e.id), a = r()([...n[E.sH], ...n[E.Zb]]).filter(t => {
      let {
        channel: n
      } = t;
    ...
    return a.unshift({
      ...
      children: [(0, s.jsx)(c.SingleSelect, {
        className: x.spacing,
        options: a,
        value: t,
  ...
  render() {
    ...
    return null == e ? null : this.props.hide ? (0, s.jsx)(d.Z, {}) : (0, s.jsxs)(c.FormSection, {
      ...
      children: [this.renderToggle(), this.renderChannelSelect(e), (0, s.jsx)(c.FormDivider, {
        className: x.divider
      }), this.renderAPIInfo(e), (0, s.jsx)(c.FormDivider, {
        className: x.divider
      }), this.renderWidget(e)]
    })
  }

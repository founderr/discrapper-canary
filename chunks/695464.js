...
let u = r.memo(r.forwardRef((e, t) => {
  ...
  let G = r.useCallback(() => {
    ...
    w = r.useCallback((e, t, n) => "function" == typeof f ? f(n, {
      sectionIndex: e,
      sectionRowIndex: t
    }) : f, [f]),
    x = r.useCallback(e => {
  ...
  r.useImperativeHandle(t, () => ({
    ...
    scrollRowIntoView: function(e) {
      ...
      null != r && window.requestAnimationFrame(() => {
        ...
        } = r, u = x(o), _ = a - (O ? u : 0) - i <= U.current, c = l + i >= U.current + M;
        if (_) {
          let r = U.current + u - a,
            s = O ? U.current - r : a;
          null === (t = y.current) || void 0 === t || t.scrollTo({
    ...
    for (let r = 0; r < Y.length; r++) {
      ...
      if (a <= L) n = a;
        ...
        let a = [],
          ...
          f = 0,
          S = o + u >= L && o <= e;
        for (null != d && (O || S) && a.push(d(r)), !S && !O && (n += u); h + u + I < l - T;) {
          let i = w(r, f, t),
            s = o + h + u,
            l = s + i;
          if (l <= L) n = l - (O ? u : 0);
  ...
  }, [w, B, x, k, u, _, c, E, d, L, Y, O, I, G, M]), q = r.useMemo(() => {
    var e, t, n;
    return {
      top: z,

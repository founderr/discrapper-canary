...
var i = n(735250), a = n(470079), l = n(852229), s = n(399606), r = n(481060), o = n(367907), c = n(592125), u = n(934415), d = n(63063), h = n(158222), p = n(410992), m = n(981631), _ = n(689938), f = n(263924);
function E(e) {
    let {threadId: t} = e, n = (0, s.e7)([c.Z], () => c.Z.getChannel(t)), E = (0, s.e7)([c.Z], () => c.Z.getChannel(null == n ? void 0 : n.parent_id)), C = a.useCallback(() => {
            null != n && null != E && ((0, o.yw)(m.rMx.MEDIA_POST_SHARE_PROMPT_CLICKED, { media_post_id: n.id }), (0, l.J)((0, u.EO)(n, E)));
        }, [
            n,
            E
        ]);
            ...
            (0, i.jsxs)('div', {
                ...
                children: [
                    ...
                    (0, i.jsx)(r.Text, {
                        ...
                        color: 'text-normal',
                        children: _.Z.Messages.MEDIA_POST_SHARE_PROMPT_SUBTITLE.format({ helpArticleUrl: d.Z.getCreatorSupportArticleURL(m.BhN.MEDIA_CHANNEL) })
                    }),

...
var i = n(735250), a = n(470079), s = n(442837), l = n(481060), r = n(241159), o = n(558381), c = n(812206), d = n(270144), u = n(307643), _ = n(171246), E = n(359610), m = n(592125), I = n(509545), T = n(238), h = n(55563), N = n(551428), p = n(626135), f = n(572004), C = n(601911), g = n(504211), S = n(381961), A = n(970321), x = n(680005), O = n(981631), R = n(272242), M = n(689938), v = n(947654);
let L = b(function (e) {
        let {
                appId: t,
                message: o
        ...
        a.useEffect(() => {
            f === T.N.NONE && (0, r.k)(t), null == _ && !I && !h && (0, u.UM)(t);
        }, [
            _,
            t,
            h,
        ...
        if ((0, d.FE)(null == S ? void 0 : S.id, null == S ? void 0 : S.primarySkuId), !y || null == S || null == f)
            return null;
        let k = f.type === O.epS.SUBSCRIPTION, G = null != B && (0, _.KW)(B.sku_flags), F = () => {
                (0, l.openModalLazy)(async () => {
                    let {default: e} = await Promise.all([
                        n.e('89131'),
                        n.e('34310')
        ...
        children: [
            (0, i.jsxs)('div', {
                ...
                children: [
                    ...
                    f.wS && (0, i.jsx)(l.Button, {
                        look: l.ButtonLooks.BLANK,
                        size: l.ButtonSizes.ICON,
                        'aria-label': M.Z.Messages.COPY_LINK,
                        onClick: () => {
                            (0, f.JG)(s), (0, l.showToast)((0, l.createToast)(M.Z.Messages.COPIED_LINK, l.ToastType.SUCCESS)), c();
                        },

...
function d(e) {
  let t;
  let n = (0, a.e7)([c.Z], () => c.Z.getClassification(e)),
    s = (0, a.e7)([c.Z], () => c.Z.getClassificationRequestState(e)),
    E = (0, a.e7)([c.Z], () => c.Z.getIsDsaEligible()),
    d = (0, r.A)("classification_detail");
  if ((0, _.FB)(n)) {
    var T;

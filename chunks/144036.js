var r, i = n(735250), a = n(470079), o = n(699581), s = n(748780), l = n(374470), u = n(981631);
function c(e, t, n) {
...
class _ extends (r = a.PureComponent) {
    ...
    animateToPosition(e, t) {
        let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r = arguments.length > 3 ? arguments[3] : void 0, i = !(arguments.length > 4) || void 0 === arguments[4] || arguments[4];
    ...
    constructor(e) {
        super(e), c(this, '_ref', void 0), c(this, '_height', 0), c(this, '_width', 0), c(this, '_dragStart', {
            x: 0,
            y: 0
        }), c(this, '_offsetX', 0), c(this, '_offsetY', 0), c(this, '_removeListeners', () => {
            ...
            if (n)
                return;
            let {position: i} = this.state, a = e.target;
            ...
            if (!i && d(this._dragStart, {
                ...
                this.animateToPosition(e.clientX - this._offsetX, e.clientY - this._offsetY, {
                    tension: 80,
                    friction: 8
                }, null, !1), this.setState({ dragging: i }, () => {
                    !a && (null == t || t(e.clientX, e.clientY)), null == n || n(e.clientX, e.clientY);
                });
        }), c(this, 'handleMouseUp', e => {
            this._removeListeners(), this.state.dragging && this.setState({ dragging: !1 }, () => {
                let {onDragEnd: t} = this.props;
                null == t || t(e.clientX, e.clientY);
            });
        });
        let t = new s.Z.Value(e.initialX), n = new s.Z.Value(e.initialY);
        this.state = {
            dragging: !1,

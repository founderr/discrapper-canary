...
var s = n(735250), l = n(470079), a = n(442837), r = n(481060), i = n(741361), o = n(461745), c = n(131704), d = n(592125), u = n(271383), m = n(430824), h = n(285952), x = n(153124), E = n(626135), S = n(934415), R = n(892880), T = n(226951), M = n(605436), g = n(971628), b = n(71080), f = n(981631), A = n(689938), L = n(992944);
let y = (0, x.hQ)();
function j(e, t) {
...
function p(e) {
    let t, {
            ...
            description: x
        } = e, [E, S] = l.useState(!1), [f, L] = l.useState(''), y = (0, a.e7)([m.Z], () => m.Z.getRoles(n.id));
    function p(e) {
        let t = j(f.trim(), E);
        ...
        onClickRow: function (e) {
            ...
            d(n => {
                ...
                if (t in s)
                    ...
                    let n;
                    e.rowType === b.aC.ROLE || e.rowType === b.aC.ADMINISTRATOR ? n = {
                        type: o.Fj.ROLE,
                        label: e.name,
                        color: e.colorString
                    } : (e.rowType === b.aC.MEMBER || e.rowType === b.aC.OWNER) && (n = {
                        type: o.Fj.MEMBER,
                        label: e.name,
                        avatar: e.avatarURL
                    }), null != n && (s[t] = {
...
function N(e) {
    ...
    return (0, s.jsxs)('div', {
        className: L.content,
        children: [
            (null == (t = T) && E && (t = A.Z.Messages.CHANNEL_PERMISSIONS_MODERATOR_DESCRIPTION), null == t || '' === t) ? null : (0, s.jsx)(r.Text, {

  ...
  let C = M.iI(v, r, n, i, p),
    {
      ...
      return {
        ...
        renderEmptyText: e => A.Z.Messages.PRIVATE_CHANNEL_ADD_MEMBERS_MODAL_NO_RESULT.format({
          query: e
        })
      }
    }();
...
function N(e) {
  ...
  return (0, s.jsxs)("div", {
    className: L.content,
    children: [(null == (t = T) && E && (t = A.Z.Messages.CHANNEL_PERMISSIONS_MODERATOR_DESCRIPTION), null == t || "" === t) ? null : (0, s.jsx)(r.Text, {

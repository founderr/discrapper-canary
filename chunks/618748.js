...
function G(e) {
  let {
    application: s,
    guild: t
  } = e, l = (0, S.YB)(t.id), a = (0, S.qi)(t.id), r = a.some(e => null != e.name && null != e.subscription_plans[0] && null != e.description && null != e.image_asset), o = (0, i.e7)([I.Z], () => I.Z.getRoles(t.id)), c = a.map(e => o[e.role_id]).some(e => null != e && 0 !== e.color), d = a.some(e => e.role_benefits.benefits.length > 0), u = null != s && t.hasFeature(D.oNc.ROLE_SUBSCRIPTIONS_ENABLED), E = [{
...
function P(e) {
  ...
  }), a = [j.C.ACTION_REQUIRED, j.C.BLOCKED, j.C.SUSPENDED];
  return (null == i ? void 0 : i.payout_account_status) != null && a.includes(null == i ? void 0 : i.payout_account_status) ? (0, n.jsxs)(n.Fragment, {
    children: [(0, n.jsx)(l.Spacer, {
      ...
      children: Z.Z.Messages.GUILD_ROLE_SUBSCRIPTION_SETTINGS_PAYOUTS_PROBLEM_WARNING.format({
        url: D.EYA.DEVELOPER_PORTAL_PAYOUT_SETTINGS(i.id)
      })
    }), (0, n.jsx)(l.Spacer, {
      size: 16
    })]
...
function b(e) {
  let s, {
    ...
    o = null != l && t.hasFeature(D.oNc.ROLE_SUBSCRIPTIONS_ENABLED);
  return (0, r.P)(t), s = o ? function(e) {
    if (e === D.KsC.ROLE_SUBSCRIPTION_EMOJI) return M.ue.EMOJIS;
    return M.ue.TIERS
...
function B(e) {
  let s, {
    ...
    c = null != r && t.hasFeature(D.oNc.ROLE_SUBSCRIPTIONS_ENABLED),
    {
      currentTab: _,
      setCurrentTab: S
    } = (0, M.dw)(),
    ...
    b = () => {
      ...
      }), (0, g.be)(t.id), (0, E.uL)(D.Z5c.CHANNEL(t.id, v.oC.ROLE_SUBSCRIPTIONS))
    };

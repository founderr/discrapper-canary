  ...
  return (null == a ? void 0 : a.payout_account_status) != null && r.includes(null == a ? void 0 : a.payout_account_status) ? (0, s.jsxs)(s.Fragment, {
    children: [(0, s.jsx)(i.Spacer, {
      ...
      children: Z.Z.Messages.GUILD_ROLE_SUBSCRIPTION_SETTINGS_PAYOUTS_PROBLEM_WARNING.format({
        url: v.EYA.DEVELOPER_PORTAL_PAYOUT_SETTINGS(a.id)
      })
    }), (0, s.jsx)(i.Spacer, {
      size: 16
    })]
...
function P(e) {
  let t, {
    ...
    o = null != i && n.hasFeature(v.oNc.ROLE_SUBSCRIPTIONS_ENABLED);
  return (0, l.P)(n), t = o ? function(e) {
    if (e === v.KsC.ROLE_SUBSCRIPTION_EMOJI) return A.ue.EMOJIS;
    return A.ue.TIERS
...
function B(e) {
  let t, {
    ...
    c = null != l && n.hasFeature(v.oNc.ROLE_SUBSCRIPTIONS_ENABLED),
    {
      currentTab: E,
      setCurrentTab: S
    } = (0, A.dw)(),

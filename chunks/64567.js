...
var L = function(e) {
  let {
    ...
    onClose: t,
    transitionState: s
  } = e, I = (0, v.useUID)(), N = m.default.getDefaultChannel(a), [L, B] = n.useState("tab-id-role-icon-file-upload"), [g, C] = n.useState(!1), M = (0, d.useLazyValue)(E);
  return n.useEffect(() => {
    C(!1)
  }, [L]), (0, o.jsx)(c.ModalRoot, {
    transitionState: s,
    "aria-labelledby": I,
    ...
    children: (0, o.jsxs)("div", {
      ...
      }), "tab-id-role-icon-file-upload" === L ? (0, o.jsx)(c.ModalContent, {
        children: (0, o.jsxs)("div", {
          ...
          children: [(0, o.jsxs)("div", {
            ...
            children: [b.default.Messages.ROLE_ICON_UPLOAD_BROWSE_FILES, (0, o.jsx)(f.default, {
              onChange: e => {
                C(!1), i(e), t()
              },
              onFileSizeError: () => {
      ...
      }) : null, "tab-id-role-icon-emoji" === L ? (0, o.jsx)(u.default, {
        hasTabWrapper: !0,
        closePopout: () => t(),
        onSelectEmoji: async e => {
          if ((null == e ? void 0 : e.id) != null) {
            if ((null == e ? void 0 : e.type) === p.EmojiTypes.GUILD) {
              let a = await O(e);
              i(a)
            }
          } else if ((null == e ? void 0 : e.surrogates) != null) {
            var a, o;
            let i = null !== (o = null === (a = e.defaultDiversityChild) || void 0 === a ? void 0 : a.surrogates) && void 0 !== o ? o : e.surrogates;
            l(i)
          }
          t()
        },

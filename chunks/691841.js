...
var r = n(470079), i = n(924826), a = n(536895), o = n(40851), s = n(590921);
function l(e) {
    var t, n, l;
    let {
            navId: u,
            ...
            state: d,
            onFocus: _
        } = e, {renderWindow: E} = r.useContext(o.ZP), f = (e, t) => {
            var n;
            if (null === (n = c.current) || void 0 === n || n.scrollToTop(), e && null != d.query) {
                let e = d.query.typeInfo.focusMode, n = !(e === s.QZ.MANUAL || e === s.QZ.AUTO_WHEN_FILTERED && 0 === d.query.queryText.length);

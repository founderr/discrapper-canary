...
var a = n(735250), s = n(470079), r = n(512722), l = n.n(r), i = n(920906), o = n(442837), c = n(481060), d = n(53281), u = n(607070), m = n(541716), h = n(859235), _ = n(898463), g = n(592125), x = n(703558), C = n(117530), f = n(585483), p = n(127654), T = n(228392), I = n(981631), E = n(344479);
let N = {
        scale: 0.95,
        opacity: 0
    }, b = {
...
function M(e) {
    let {
            ...
            onClose: r,
            onMouseEnter: i
        } = e, u = s.useRef(null), m = (0, o.e7)([g.Z], () => g.Z.getChannel(t), [t]);
    return l()(null != m, 'Forum Channel is null'), (0, a.jsxs)(c.Clickable, {
...
function A(e) {
    let {
            channelId: t,
            closePopout: n
        } = e, [r, l] = s.useState(!1), {reducedMotion: d} = s.useContext(c.AccessibilityPreferencesContext), g = (0, i.useSpring)({
            from: d.enabled ? b : N,
            to: v,
            config: S
...
function j(e) {
    let {channelId: t} = e, [n, r] = s.useState(!1), l = (0, o.e7)([C.Z], () => C.Z.getUploads(t, m.I.CREATE_FORUM_POST.drafts.type)), i = l.length, c = i > 0;
    s.useEffect(() => {
        n && !c && r(!1);
    }, [
        n,

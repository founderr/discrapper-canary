...
var s = n(481060), a = n(925221), i = n(236413), r = n(85960), l = n(273504), o = n(689938);
let c = e => {
        switch (e) {
        case l.fX.KEYWORD:
        ...
        if (!!(0, i.Vb)(t)) {
            if ((0, i.DO)(t))
                return t.triggerMetadata.regexPatterns.length > 0 ? o.Z.Messages.GUILD_AUTOMOD_KEYWORD_FILTER_HEADER_WORD_AND_REGEX_COUNT.format({

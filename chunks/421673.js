  ...
  let d = t.reduce((e, t) => {
    ...
    _ = d.reduce((t, o) => (t[o.soundId] = function(e, t, n, i) {
      ...
      let u = 0,
        ...
        _ = null != t.emojiId ? a.default.getCustomEmojiById(t.emojiId) : null,
        c = null != t.emojiName ? s.default.convertSurrogateToName(t.emojiName, !1) : null,
        E = null != c ? s.default.getByName(c) : null,

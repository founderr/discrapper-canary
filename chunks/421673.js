...
var r = n(658722), i = n.n(r), a = n(954955), o = n.n(a), s = n(339085), l = n(633302), u = n(626135), c = n(697426), d = n(242291), _ = n(981631);
let E = [], f = o()(function (e, t) {
        u.default.track(_.rMx.SEARCH_STARTED, {
            channel_id: t,
            search_type: _.aib.SOUNDBOARD,
            location_stack: e
        });
    }, 350), h = o()(function (e, t, n, r) {
...
function p(e, t, n, r, a) {
    ...
    let o = t.reduce((e, t) => {
            ...
            var a;
            let o = 0, u = t.name.toLocaleLowerCase(), c = null != t.emojiId ? s.Z.getCustomEmojiById(t.emojiId) : null, _ = null != t.emojiName ? l.ZP.convertSurrogateToName(t.emojiName, !1) : null, E = null != _ ? l.ZP.getByName(_) : null, f = null != c ? [c.name] : null !== (a = null == E ? void 0 : E.names) && void 0 !== a ? a : [];
        ...
        }(e.toLocaleLowerCase(), o, n, r), t), {}), _ = o.filter(e => u[e.soundId] > 0).sort((e, t) => u[t.soundId] - u[e.soundId]);

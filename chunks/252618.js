...
let a = { base: n(358085).isPlatformEmbedded ? void 0 : 'Discord' }, o = 0, s = {
        count: 3,
        onlyWhenBlurred: !1,
        interval: 1000
    }, l = (0, i.Z)(() => ({
...
function u(e) {
    l.setState({ notificationCount: e });
}
function c(e) {
    let t = {
        ...s,
...
function d(e) {
    l.setState(t => ({ flashQueue: t.flashQueue.filter(t => t.id !== e) }));
}
function _(e) {
    r.useEffect(() => {
        var t;
        return t = e, l.setState(e => ({
            ...
            l.setState(e => ({ titles: e.titles.filter(e => e !== t) }));
        };
    }, [...Object.values(e)]);
}
function E(e) {

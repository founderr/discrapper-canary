var n = r(198392), i = r(310176), o = r(379846), a = r(100066), u = r(488959), s = r(952616), c = r(880353), l = r(519827), f = r(121868), p = r(467159);
function h(t) {
    t._internalDrag = !1;
...
t.exports = {
    ...
    onDrop: function (t, e) {
        var r = new n(e.nativeEvent.dataTransfer), l = t._latestEditorState, g = function (t, e) {
                var r = null, n = null, i = u(t.currentTarget);
        ...
        if (e.preventDefault(), t._dragCount = 0, t.exitCurrentMode(), null != g) {
            var y = r.getFiles();
            if (y.length > 0) {
                if (t.props.handleDroppedFiles && f(t.props.handleDroppedFiles(g, y)))
                    return;
                s(y, function (e) {
                    e && t.update(d(l, g, e));
                });

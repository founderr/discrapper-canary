    ...
    ["43367"], {
        ...
        152584: function(e, t, n) {
            ...
            function p(e) {
                ...
                return o.default.dispatch({
                    ...
                    return null != f.DEVICE_PUSH_VOIP_PROVIDER && null != d && (o.push_voip_provider = f.DEVICE_PUSH_VOIP_PROVIDER, o.push_voip_token = d), h(o)
                }, {
                    checkEnabled: !1,
                    modalProps: {
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: A
                } = (0, E.usePaymentContext)(), v = h.find(e => e.key === S);
                r.useEffect(() => {
                    C(null)
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == v ? void 0 : null === (s = v.options) || void 0 === s ? void 0 : s.renderHeader) || void 0 === d || d ? _ : null, v.renderStep(T), null == S || g ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                P = !0, null == I || I(), !C && ((0, a.setIsPersistentHelperHidden)(!0), (0, a.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: T,
                            analyticsLocations: S,
                            analyticsObject: h,
                    ...
                    onCloseCallback: () => {
                        !P && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: O,
                            location_stack: S
                        }), (0, o.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == _ || _(P), P && (!C && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == T || T())
                    },
        ...
        817963: function(e, t, n) {
            ...
            let E = {
                ...
                I = e => {
                    let [t, n] = e instanceof s.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : _(e), [r, o, d, I] = (0, l.useStateFromStoresArray)([a.default], () => [a.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e), a.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e), a.default.can(t, e), a.default.can(n, e)]), T = (0, l.useStateFromStores)([u.default], () => u.default.getCurrentUser()), S = i.useCallback(e => f(e, T, o, r), [r, o, T]), h = i.useCallback(e => f(e, T, I, d), [I, d, T]);
                    return null == e ? E : {
        ...
        235004: function(e, t, n) {
            ...
            var U = new R(a.default, {
                LOGOUT: function() {
                    S.clear(), h.clear(), v.clear(), g = !1, C = 0, N = 0
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: l
                    } = e, o = (null !== (n = h.get(r)) && void 0 !== n ? n : 0) + 1, s = (null !== (i = v.get(l)) && void 0 !== i ? i : 0) + 1;
                    h.set(r, o), v.set(l, s), l !== (null === (t = c.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (g = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(e) {
                    ...
                    let {
                        soundId: i,
                        userId: r
                    } = e, l = (null !== (t = h.get(i)) && void 0 !== t ? t : 0) - 1, o = (null !== (n = v.get(r)) && void 0 !== n ? n : 0) - 1;
                    l <= 0 ? h.delete(i) : h.set(i, l), o <= 0 ? v.delete(r) : v.set(r, o)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    S.set(_.DEFAULT_SOUND_GUILD_ID, t), N = 2
                },
            ...
            var i = n("37983"),
                ...
                P = e => {
                    ...
                    let {
                        ...
                        onSave: G,
                        onClose: w
                    } = e, b = (0, C.useUID)(), [x, F] = r.useState(null != M ? M.channel_id : null), [V, B] = r.useState(null != M ? M.description : ""), [H, j] = r.useState(null != M ? {
                        id: M.emoji_id,
                        name: M.emoji_name
                    } : null), [k, W] = r.useState(!1), Y = (0, l.useStateFromStores)([_.default], () => (null == H ? void 0 : H.id) != null ? _.default.getUsableCustomEmojiById(H.id) : null), K = (0, l.useStateFromStores)([T.default], () => T.default.getChannels(P)[T.GUILD_SELECTABLE_CHANNELS_KEY], [P]), Z = (0, l.useStateFromStores)([g.default], () => g.default.get(P)), z = null !== (n = null == Z ? void 0 : null === (t = Z.welcome_channels) || void 0 === t ? void 0 : t.map(e => e.channel_id)) && void 0 !== n ? n : [], [X, J] = r.useState(!1);
                    r.useEffect(() => {
                    ...
                    K.forEach(e => {
                        ...
                        v.default.canEveryoneRole(O.Permissions.VIEW_CHANNEL, t) && ((null == M ? void 0 : M.channel_id) === t.id || !z.includes(t.id)) && q.push({
                            value: t.id,
                            label: (0, d.computeChannelName)(t, h.default, S.default)
                        })
                    });
                    let Q = () => {
                            J(!1), w()
                                        ...
                                        children: [(0, i.jsxs)("div", {
                                            ...
                                            children: (0, i.jsx)(s.Popout, {
                                                renderPopout: e => {
                                                    let {
                                                        closePopout: t
                                                    } = e, n = T.default.getDefaultChannel(P);
        ...
        882641: function(e, t, n) {
            ...
            var I = function(e) {
                let {
                    ...
                    "aria-controls": S,
                    focusProps: h
                } = e, [p, N] = r.useState(!1), [C, A] = r.useState(0), v = p || I, g = (0, d.getClass)(f, "emojiButton", v ? "Hovered" : "Normal"), m = function(e) {
        ...
        181114: function(e, t, n) {
            ...
            let S = e => {
                let {
                    ...
                    onlyShineOnHover: I,
                    ...S
                } = e, h = o.createRef(), p = (0, c.default)(h), N = !i && !r && !0 !== s && (!I || p);
                ...
                renderUsers() {
                    ...
                    for (; u < s && u < e.length;) {
                        ...
                        o.push(t ? (0, i.jsx)("div", {
                            ...
                            children: s
                        }, p(null !== (d = e[u]) && void 0 !== d ? d : null, u)) : (0, i.jsx)(T.default, {
        ...
        103603: function(e, t, n) {
            ...
            let T = e => "number" == typeof e ? null : S(e),

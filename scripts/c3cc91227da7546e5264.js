    ...
    [75700], {
        57141: (t, e, n) => {
            ...
            const h = {
                ...
                sendActivityInvite: function(t) {
                    ...
                    var p = o.ZP.parse(d, null != r ? r : "");
                    return u.Z.sendMessage(d.id, p, !1, {
                        activityAction: {
                            type: n,
                            activity: i
                        }
        ...
        875700: (t, e, n) => {
            ...
            function Z(t) {
                var e = t.applicationId,
                    ...
                    i = t.channelId,
                    r = t.intent,
                    o = void 0 === r ? y.Ws.PLAY : r,
                    c = t.embedded,
                    l = void 0 !== c && c,
                    u = t.analyticsLocations;
                D(e, null, i, l, void 0 === u ? [] : u).then((function() {
                    return f.Z.waitConnected(e)
                })).then((function() {
                    return Promise.race([f.Z.waitSubscribed(e, v.zMe.ACTIVITY_JOIN)])
                })).then((function() {
                    a.Z.dispatch({
                        type: "ACTIVITY_JOIN",
                        applicationId: e,
            ...
            function D(t, e, n) {
                ...
                var c = null;
                if (null == e) {
                    var h = d.Z.getActiveLibraryApplication(t);
                    e = null != h ? h.branchId : t
                }
                if (p.Z.isLaunchable(t, e)) {
                    var I = p.Z.getState(t, e),
                        A = d.Z.getActiveLaunchOptionId(t, e);
                    if (null == I) throw new Error("Missing dispatch game when launching");
                    var E = d.Z.getLibraryApplication(t, e);
                    if (null == E) throw new Error("Missing library application when launching");
                    c = P(t).then((function(t) {
                        return f.Z.launchDispatchApplication(I, t, l.default.locale, E.getBranchName(), A)
                    }))
                } else {
                    var y = s.Z.getGame(t);
                    c = null != y ? f.Z.launch(y) : f.Z.launchGame(t)
                }
                ...
                if (null != c) {
                    ...
                    return c.then((function(e) {
                        ...
                        _.Z.show(v.kVF.LAUNCH_GAME_FAILURE, T.Z.Messages.GAME_LAUNCH_FAILED_LAUNCH_TARGET_NOT_FOUND);
                        a.Z.dispatch({
            ...
            const S = {
                ...
                fetchApplication: function(t) {
                    ...
                    return r.ZP.get({
                        url: v.ANM.APPLICATION_PUBLIC(t),
                        query: {
                            with_guild: e
                        },
                        oldFormErrors: !0
                                    ...
                                    if (!e) {
                                        o = function(t) {
                                            var e, n, i = s.Z.getGame(t),
                                                r = (0, h.yE)(null !== (n = null == i ? void 0 : i.flags) && void 0 !== n ? n : 0, v.udG.EMBEDDED) && null == (null == i || null === (e = i.embeddedActivityConfig) || void 0 === e ? void 0 : e.supported_platforms);
                ...
                toggleOverlay: function(t) {
                    ...
                    if (null != e) {
                        var n = d.Z.getActiveLibraryApplication(e.id);
                        if (null != n) {
                            var i = h.x9(n.getFlags(), v.eHb.OVERLAY_DISABLED);
                ...
                getDetectableGames: function() {
                    s.Z.fetching || null != s.Z.lastFetched || a.Z.wait((function() {
                        ...
                        r.ZP.get({
                            ...
                            headers: {
                                "If-None-Match": s.Z.detectableGamesEtag
                            },
                            retries: 1,
                            oldFormErrors: !0
                        }).then((function(t) {
        ...
        639566: (t, e, n) => {
            ...
            function u(t) {
                ...
                return l.useExperiment({
                    ...
                    autoTrackExposure: !1
                }).isActivitiesInTextEnabled && o.wP.includes(null !== (e = null == n ? void 0 : n.type) && void 0 !== e ? e : c.d4z.UNKNOWN)
            }
        },
        873247: (t, e, n) => {
            n.d(e, {
            ...
            function P(t, e, n) {
                var i = y.ZP.getSelfEmbeddedActivityForChannel(t);
                null != i && N({
                    channelId: t,
                    ...
                    return m(this, (function(d) {
                        switch (d.label) {
                            case 0:
                                ...
                                if (null === (c = y.ZP.getSelfEmbeddedActivityForChannel(t))) return [2];
            ...
            function N(t) {
                ...
                var l = d.Z.getSelectedParticipantId(n),
                    u = null === (e = A.default.getCurrentUser()) || void 0 === e ? void 0 : e.id;
                null != y.ZP.getEmbeddedActivitiesForChannel(n).find((function(t) {
            ...
            function H() {
                return (H = Z((function(t) {
                    var e, n, r, o, c, l, u, s, d, h, f, A, T, C, g, Z, P;
                    return m(this, (function(m) {
                        switch (m.label) {
                            case 0:
                                e = t.guildId, n = t.force, r = void 0 !== n && n;
                                o = y.ZP.getShelfActivities(e);
                                c = o.map((function(t) {
                                    return I.Z.getGame(t.application_id)
                                })).filter(E.lm);
                                if (r || y.ZP.shouldFetchShelf(e)) return [3, 3];
                                if (!(null === (l = y.ZP.getShelfFetchStatus(e)) || void 0 === l ? void 0 : l.isFetching)) return [3, 2];
                                ...
                                h = new Promise((function(t) {
                                    d = G.bind(null, e, t);
                                    a.Z.subscribe("EMBEDDED_ACTIVITY_FETCH_SHELF_FAIL", d)
                                }));
                            ...
                            case 1:
                                ...
                                if (null != d) {
                                    a.Z.unsubscribe("EMBEDDED_ACTIVITY_FETCH_SHELF_FAIL", d);
                                    d = null
                                }
                                m.label = 2;
                            case 2:
                            ...
                            case 3:
                                ...
                                if (!(f = void 0 !== e && "" !== e) && !(0, v.f0)()) return [2, {
                                    activityConfigs: [],
                                    applications: []
                                }];
                                A = f ? {
        ...
        269116: (t, e, n) => {
            ...
            function A(t) {
                ...
                return e ? t = t.includes("dosbox.exe") ? t.split("/").slice(-3).join("/") : t.split("/").slice(-2).join("/") : null
            }
                        ...
                        switch (i.label) {
                            ...
                            case 5:
                                if ((0, c.ED)()) {
                                    ...
                                    I(e.PROGRAMDATA);
                                    I("/games/");
                                    I("/steamlibrary/steamapps/common/")
                                }

                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var _ = y(t.minStart),
                                ...
                                b = y(t.minDirection),
                                D = y(t.maxDirection);
                            return new p(new g(T(r.x, n.x), T(_.x, d.x), T(v.x, E.x), T(f.x, h.x), A(b.x, D.x), N(t.easingFunctions)[0]), new g(T(r.y, n.y), T(_.y, d.y), T(v.y, E.y), T(f.y, h.y), A(b.y, D.y), N(t.easingFunctions)[0]))
                    }
                }(E(E({}, t), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var _ = b(t.minStart),
                                ...
                                y = b(t.minDirection),
                                D = b(t.maxDirection);
                            return new h(new g(T(r.x, n.x), T(_.x, d.x), T(v.x, E.x), T(f.x, p.x), A(y.x, D.x), N(t.easingFunctions)[0]), new g(T(r.y, n.y), T(_.y, d.y), T(v.y, E.y), T(f.y, p.y), A(y.y, D.y), N(t.easingFunctions)[0]), new g(T(r.z, n.z), T(_.z, d.z), T(v.z, E.z), T(f.z, p.z), A(y.z, D.z), N(t.easingFunctions)[0]))
                    }
                }(E(E({}, t), {
                    valueType: "Vector3"
                }))
            ...
            var C = n.forwardRef((function(t, e) {
                ...
                var N = n.useCallback((function(t, e) {
                    ...
                    A = n.useCallback((function(t, e, r, n, a) {
                        var o, u = U(null !== (o = t.id) && void 0 !== o ? o : (0, i.v4)(), t, r, n, a);
                        return N(u, e), u
                    }), [N]),
                            ...
                            return function(t, e) {
                                ...
                                switch (t.label) {
                                    case 0:
                                        return [4, R()];
                                    case 1:
                                        return t.sent(), h(), f.current = !0, O(!0), [2]
                                }
                            }))
                        }))
                    }), [O, R, h]);
        ...
        58964: (t, e, r) => {
            ...
            function E(t, e) {
                var r = e.utmSource,
                    ...
                    a = e.iosFallbackLink,
                    o = s(e, ["utmSource", "androidFallbackLink", "iosFallbackLink"]),
                    c = new URL(t);
                for (var l in o) {
                    var d = o[l];
                    null != d && c.searchParams.set(l, d)
                }
                var v, E, f, p, h, R = encodeURIComponent(c.toString()),
                    O = encodeURIComponent(u()),
                    g = (f = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), p = null != (null === i() || void 0 === i() || null === (v = i().ua) || void 0 === v ? void 0 : v.match(f)),
                        h = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !p, "iOS" !== (null === i() || void 0 === i() || null === (E = i().os) || void 0 === E ? void 0 : E.family) || h ? 1 : 0),
                    T = null != n ? encodeURIComponent(n) : null,
                    N = null != a ? encodeURIComponent(a) : null,
                    A = "".concat(_, "/?link=").concat(R, "&utm_source=").concat(r, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(O, "&efr=").concat(g);

    ...
    ["59145"], {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(s, a) {
                        ...
                        var u, o, d, c, f, E, h, I, _, g, p, T, C, v, N, m, S = (u = s, f = Array(32768), u.forEach(function(n) {
                        ...
                        var L = (E = s, h = S, p = 1e6, T = 0, C = 1e6, v = 0, N = 1e6, m = 0, E.forEach(function(t) {
                                I = t[0] >> e, _ = t[1] >> e, g = t[2] >> e, I < p ? p = I : I > T && (T = I), _ < C ? C = _ : _ > v && (v = _), g < N ? N = g : g > m && (m = g)
                            }), new i(p, T, C, v, N, m, h)),
            ...
            class d extends i.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: p,
                        retrySuccess: T
                    } = this.state, C = i.Children.count(l) > 0 ? (0, r.jsx)(a.Card, {
        ...
        310688: function(e, t, n) {
            ...
            class eh extends i.PureComponent {
                componentDidMount() {
                    ...
                    if (f && Y.default.track(ei.AnalyticEvents.INVITE_SUGGESTION_OPENED, {
                        ...
                        let e = D.default.getStreamForUser(s, n.id),
                            t = (0, A.getStreamerApplication)(e, G.default);
                ...
                renderChannelWarning() {
                    ...
                    return (0, N.default)(e) ? (0, r.jsxs)("div", {
                ...
                renderHeader() {
                    ...
                    if (e = u ? null : null != l ? es.default.Messages.INVITE_STREAM_HEADER : null != a ? es.default.Messages.EMBEDDED_ACTIVITIES_INVITE_FRIENDS_TO_ACTIVITY_NAME.format({
                        ...
                        let e = (0, m.getChannelIconComponent)(o, t);
            ...
            var eI = i.forwardRef(function(e, t) {
                ...
                } = (0, C.default)(T.default.INSTANT_INVITE_MODAL), W = (0, E.useStateFromStores)([U.default, V.default], () => {
                    let e = V.default.getVoiceChannelId();
                    if (null == e) return null;
                    let t = U.default.getChannel(e);
                    return (null == t ? void 0 : t.guild_id) === o.id ? t : null
                }), K = null != W && !(0, N.default)(W) && [ei.InstantInviteSources.GUILD_CONTEXT_MENU, ei.InstantInviteSources.GUILD_HEADER].includes(d), Y = (0, O.default)(o.id), Z = (0, E.useStateFromStores)([V.default, U.default, y.default], () => {
                ...
                let [eT] = (0, v.default)(null != I ? [I] : []), eC = (0, S.default)({
                    guildId: ee
                }), ev = null != et ? et.code : void 0, eN = null == et ? void 0 : et.maxAge, em = null == et ? void 0 : et.maxUses, eS = null == et ? void 0 : et.temporary, eA = o.vanityURLCode, eL = null != eA && eA.length > 0, {
                    enabled: eM
                ...
                }), eO = eM && !(null == J ? void 0 : J.isGuildVocal()) && eL, eR = (null == J ? void 0 : J.type) === ei.ChannelTypes.GUILD_VOICE, eD = (0, N.default)(J);
                !ed && (null == ep ? void 0 : ep.invite_code) != null && (ev = ep.invite_code);
                let [ex, eU] = i.useState({
                    query: "",
                    maxAge: null !== (a = null != eN ? eN : eC) && void 0 !== a ? a : ef.value,
                    savedMaxAge: eN === ec.value ? null != eC ? eC : ef.value : ec.value,
                    maxUses: null != em && 0 !== em ? em : eE.value,
                    ...
                    e === er.InstantInviteModalPages.SETTINGS && null != t ? ew(t) : A()
                }, [ew, ex, A]), eH = i.useCallback(() => {
        ...
        825691: function(e, t, n) {
            ...
            function T(e) {
                ...
                let {
                    ...
                    onSelectMaxAge: m,
                    onSelectMaxUses: S
                } = e, A = (0, u.default)(n, 0 === c), L = (0, u.default)(n, !0), M = (0, f.default)(n), O = M.find(e => e.value === c), R = p.find(e => e.value === T), [D, x] = i.useState(!1), U = (0, u.useIsNewCommunity)(n, D);
                return (0, r.jsx)("div", {
        ...
        235004: function(e, t, n) {
            ...
            var R = new O(u.default, {
                LOGOUT: function() {
                    g.clear(), p.clear(), m.clear(), S = !1, v = 0, C = 0
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: i,
                        userId: l
                    } = e, s = (null !== (n = p.get(i)) && void 0 !== n ? n : 0) + 1, a = (null !== (r = m.get(l)) && void 0 !== r ? r : 0) + 1;
                    p.set(i, s), m.set(l, a), l !== (null === (t = c.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (S = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: i
                    } = e, l = (null !== (t = p.get(r)) && void 0 !== t ? t : 0) - 1, s = (null !== (n = m.get(i)) && void 0 !== n ? n : 0) - 1;
                    l <= 0 ? p.delete(r) : p.set(r, l), s <= 0 ? m.delete(i) : m.set(i, s)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    g.set(h.DEFAULT_SOUND_GUILD_ID, t), C = 2
                },
        ...
        19766: function(e, t, n) {
            ...
            function L(e, t, n) {
                let r = n === h.default.getId(),
                    ...
                    l = r ? C.default.getStatus() : T.default.getStatus(n, e),
                    s = r ? C.default.getActivities() : T.default.getActivities(n, e),
            ...
            function M(e) {
                ...
                return null == t ? S : null == t.memberListId ? function(e) {
                    return f.default.canEveryone(N.Permissions.VIEW_CHANNEL, e) ? S : u.v3(s(e.permissionOverwrites).reduce((e, t) => {
                        let {
                            id: n,
                            allow: r,
                            deny: i
                        } = t;
                        return o.default.has(r, N.Permissions.VIEW_CHANNEL) ? e.push("allow:".concat(n)) : o.default.has(i, N.Permissions.VIEW_CHANNEL) && e.push("deny:".concat(n)), e
                    }, []).sort().join(",")).toString()
                }(t) : t.memberListId
            ...
            class O {
                ...
                setGroups(e) {
                    ...
                    this.groups = e.map(e => {
                        ...
                        return t += i + 1, A(this.guildId, e.id, i, r)
                    }), this.rows.length = t
                }
                sync(e, t) {
                    let [n] = e;
                ...
                insert(e, t) {
                    ...
                    if (null != n) this.rows.splice(e, 0, A(this.guildId, n.id, n.count));
                    else if (null != r) {
                ...
                update(e, t) {
                    ...
                    if (null != i && "MEMBER" === i.type && delete this.members[i.user.id], null != n) this.rows[e] = A(this.guildId, n.id, n.count);
                    else if (null != r) {
                        let t = L(this.guildId, this.ownerId, r.user.id);
                        if (null == t) return;
            ...
            class w extends d.default.Store {
                initialize() {
                    this.waitFor(v.default, p.default, I.default, g.default, T.default, C.default, h.default, _.default, E.default), this.syncWith([C.default], y), this.syncWith([E.default], U)
                }
                getProps(e, t) {
                    let n = R.get(e, M(t));
                    return {

    ...
    ["62428"], {
            ...
            var l = function() {
                ...
                return l.prototype = {
                    ...
                    quantize: function(a, s) {
                        ...
                        var o, u, d, c, E, _, I, f, T, h, N, g, A, p, m, S, C = (o = a, E = Array(32768), o.forEach(function(n) {
                        ...
                        var L = (_ = a, I = C, N = 1e6, g = 0, A = 1e6, p = 0, m = 1e6, S = 0, _.forEach(function(t) {
                                f = t[0] >> e, T = t[1] >> e, h = t[2] >> e, f < N ? N = f : f > g && (g = f), T < A ? A = T : T > p && (p = T), h < m ? m = h : h > S && (S = h)
                            }), new l(N, g, A, p, m, S, I)),
        ...
        310688: function(e, t, n) {
            ...
            var ef = l.forwardRef(function(e, t) {
                ...
                } = (0, A.default)(g.default.INSTANT_INVITE_MODAL), W = (0, _.useStateFromStores)([P.default, F.default], () => {
                    let e = F.default.getVoiceChannelId();
                    if (null == e) return null;
                    let t = P.default.getChannel(e);
                    return (null == t ? void 0 : t.guild_id) === u.id ? t : null
                }), K = null != W && !(0, m.default)(W) && [el.InstantInviteSources.GUILD_CONTEXT_MENU, el.InstantInviteSources.GUILD_HEADER].includes(d), Y = (0, R.default)(u.id), X = (0, _.useStateFromStores)([F.default, P.default, G.default], () => {
                    var e;
                ...
                }, [K, V, U, o, u.id, W, Y]), [Z, Q] = l.useState(null), J = null != Z ? Z : X, $ = null;
                ...
                let [eg] = (0, p.default)(null != f ? [f] : []), eA = (0, C.default)({
                    guildId: ee
                }), ep = null != et ? et.code : void 0, em = null == et ? void 0 : et.maxAge, eS = null == et ? void 0 : et.maxUses, eC = null == et ? void 0 : et.temporary, eO = u.vanityURLCode, eL = null != eO && eO.length > 0, {
                    enabled: ev
                ...
                let [eD, eP] = l.useState({
                    query: "",
                    maxAge: null !== (s = null != em ? em : eA) && void 0 !== s ? s : eE.value,
                    savedMaxAge: em === ec.value ? null != eA ? eA : eE.value : ec.value,
        ...
        235004: function(e, t, n) {
            ...
            var M = new R(o.default, {
                LOGOUT: function() {
                    h.clear(), N.clear(), S.clear(), C = !1, p = i.NOT_FETCHED, A = i.NOT_FETCHED
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    h.set(I.DEFAULT_SOUND_GUILD_ID, t), A = i.FETCHED
                },
        ...
        19766: function(e, t, n) {
            ...
            function L(e, t, n) {
                let l = n === I.default.getId(),
                    ...
                    a = l ? A.default.getStatus() : g.default.getStatus(n, e),
                    s = l ? A.default.getActivities() : g.default.getActivities(n, e),
                    o = _.default.getStreamForUser(n, e),
                    u = p.default.getUser(n);
                return null == u ? null : {
                    type: i.MEMBER,
            ...
            class y extends d.default.Store {
                initialize() {
                    this.waitFor(p.default, N.default, f.default, h.default, g.default, A.default, I.default, T.default, _.default), this.syncWith([A.default], G), this.syncWith([_.default], P)
                }
                getProps(e, t) {
                    let n = M.get(e, v(t));
                    return {

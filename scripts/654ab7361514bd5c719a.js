...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [93922], {
        ...
        941248: (e, n, t) => {
            ...
            var g = function() {
                var e = u.Z.getMessageRequestsCount() > 0 || l.Z.getSpamChannelsCount() > 0,
                    n = i.Ci.getCurrentConfig({
                        location: "home"
                    }).canViewShopButton;
                return [C.Z5c.FRIENDS, d.Z.hasLibraryApplication() && !c.bm.getSetting() ? C.Z5c.APPLICATION_LIBRARY : null, C.Z5c.APPLICATION_STORE, e ? C.Z5c.MESSAGE_REQUESTS : null, n ? C.Z5c.COLLECTIBLES_SHOP : null, c.Ex.getSetting() ? C.Z5c.FAMILY_CENTER : null].filter(E.lm)
            };
            ...
            function y(e) {
                var n, t = s.Z.getState(),
                    r = t.channelId,
                    i = t.path,
                    o = t.basePath,
                    a = h.Z.getPrivateChannelIds(),
                    u = __OVERLAY__ ? a : v(g()).concat(v(a)),
                    l = (null == r ? (n = null != i ? i : o, g().findIndex((function(e) {
                        return n.startsWith(e)
                    }))) : null != r ? u.indexOf(r) : 0) + e;
                l >= u.length ? l = 0 : l < 0 && (l = u.length - 1);
                var c, d, E = u[l];
                g().includes(E) ? (c = E, d = f.Z.getCurrentRoute(), c === C.Z5c.APPLICATION_STORE && null != d ? (0, p.z)(d) : (0, p.z)(c)) : I(C.ME, E)
            }

            function A(e, n) {
                var t = s.Z.getState().channelId,
                    i = (0, r.Z)(n).map((function(e) {
                        return e.id
                    }));
                ((0, o.YM)(n) || (0, a.s)(n)) && i.unshift(_.oC.GUILD_HOME);
                var u, l, c = null != t ? i.indexOf(t) : -1;
                I(n, i[(u = c + e, l = i.length, u < 0 ? l - 1 : u >= l ? 0 : u)])
            }

            function O() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                    n = s.Z.getState().guildId;
                null == n ? y(e) : A(e, n)
            }
            var b = t(784426),
                T = t(934870),
                ...
                P = {
                    ...
                    action: function() {
                        var e;
                        if (null != N.Z.getGuildId()) e = C.ME;
                        else {
                            var n = N.Z.getLastSelectedGuildId();
                            if (null != n) {
                                e = n;
                                (0, p.K)(n, L.Z.getChannelId(n))
                            }
                        }
                        null != e && (0, T.X)(e);
                        return !1
        ...
        847294: (e, n, t) => {
            ...
            var r = t(809784),
                ...
                L = {
                    ...
                    action: function(e) {
                        ...
                        if (b.S.hasSubscribers(T.CkL.CALL_DECLINE)) {
                            b.S.dispatch(T.CkL.CALL_DECLINE);
                            return !1
                        }
                        if (A.Z.close()) return !1;
                        if (b.S.hasSubscribers(T.CkL.MEDIA_MODAL_CLOSE)) {
                            b.S.dispatch(T.CkL.MEDIA_MODAL_CLOSE);
                            return !1
                        }
                        if ((0, r.k)(e.target)) {
                            var n = (0, u.J5)(e.target);
                            if (null == n ? void 0 : n.hasSubscribers(T.CkL.POPOUT_CLOSE)) {
                                n.dispatch(T.CkL.POPOUT_CLOSE);
                                return !1
                            }
                        }
                        if (b.S.hasSubscribers(T.CkL.CLOSE_GIF_PICKER)) {
                            b.S.dispatch(T.CkL.CLOSE_GIF_PICKER);
                            return !1
                        }
                        if (b.S.hasSubscribers(T.CkL.MODAL_CLOSE)) {
                            b.S.dispatch(T.CkL.MODAL_CLOSE);
                            return !1
                        }
                        if (b.S.hasSubscribers(T.CkL.SEARCH_RESULTS_CLOSE)) {
                            b.S.dispatch(T.CkL.SEARCH_RESULTS_CLOSE);
                            return !1
                        }
                        var t = y.Z.getGuildId(),
                            o = I.Z.getChannelId(t),
                            a = C.Z.getChannel(o),
                            s = p.ZP.getSection(o, null == a ? void 0 : a.isDM()) === T.ULH.SIDEBAR_CHAT ? p.ZP.getSidebarState(o) : null,
                            c = (null == s ? void 0 : s.type) === f.tI.VIEW_THREAD || (null == s ? void 0 : s.type) === f.tI.VIEW_CHANNEL ? s.channelId : null;
                        if (!1 === N(o)) return !1;
                        if (!1 === N(c)) return !1;
                        if (null != o && (null == s ? void 0 : s.type) === f.tI.CREATE_THREAD) {
                            d.Z.closeChannelSidebar(o);
                            return !1
                        }
                        var h = m(o),
                            E = m(c);
                        if (null != o && !h && !E && null != s) {
                            d.Z.closeChannelSidebar(o);
                            return !1
                        }
                        if (null != o && !h && l.Z.getChatOpen(o)) {
                            i.Z.updateChatOpen(o, !1);
                            return !1
                        }
                        b.S.dispatch(T.CkL.SCROLLTO_PRESENT);
                        return !1
                    }
                };
            ...
            function N(e) {
                if (null != e) {
                    ...
                    if (null != h.Z.getStickerPreview(e, _.d.ChannelMessage)) {
                        (0, E.qB)(e, _.d.ChannelMessage);
                        return !1
                    }
                }
            }
            ...
            function m(e) {
                if (null == e) return !1;
                var n = !1;
                if (v.Z.getMessages(e).hasMoreAfter) {
                    o.Z.jumpToPresent(e, T.AQB);
                    n = !0
                }
                if (g.ZP.hasUnread(e)) {
                    (0, a.In)(e);
            ...
            var r = t(194397),
                ...
                u = {
                    ...
                    action: function() {
                        (0, i.hu)("emoji search");
                        (0, r.x)("emoji search");
                        o.S.dispatchToLastSubscribed(a.CkL.TOGGLE_EMOJI_POPOUT);
                        return !1
                    }
                }
        },
                            ...
                            if ("string" == typeof o) {
                                ...
                                return (0, a.openModalLazy)(v((function() {
                                    ...
                                    return O(this, (function(i) {
                                        switch (i.label) {
                                            case 0:
                                                return [4, Promise.all([t.e(40532), t.e(83064), t.e(35401), t.e(40706), t.e(1441), t.e(26945), t.e(28241), t.e(67368), t.e(16051)]).then(t.bind(t, 389853))];
                                            case 1:
        ...
        344524: (e, n, t) => {
            ...
            var V = t(452006),
                ...
                j = {
                    binds: ["mod+shift+e"],
                    comboKeysBindGlobal: !0,
                    action: t.n(k)().debounce((function() {
                ...
                $ = {
                    ...
                    action: function() {
                        var e = a.Z.getGuildId(),
                            ...
                            t = q.Z.getChannel(n);
                        if (null != n && null != t && t.type === K.d.GUILD_VOICE) {
                            Y.Z.updateChatOpen(n, !W.Z.getChatOpen(n));
                            return !1
                        }
                        if (null != n && null != t && t.type === K.d.DM) {
                            var r = J.ZP.getSection(n, null == t ? void 0 : t.isDM()),
                                i = (0, z.O)(t.getRecipientId()),
                                o = r === l.ULH.PROFILE;
                            (0, X.a)(i, !o);
                            x.Z.toggleProfilePanelSection();
                            return !1
                        }
                        x.Z.toggleMembersSection();
                        return !1
                    }
                };
            var ee = t(805181),
                ne = {
                    ...
                    comboKeysBindGlobal: !0,
                    action: function() {
                        var e = q.Z.getChannel(Q.Z.getChannelId());
                        null == e || e.isManaged() || u.S.dispatch(l.CkL.UPLOAD_FILE);
                        return !1
                    }
                };
            var te, re, ie = t(288457),
                oe = t(473708);
            ...
            function ue(e) {
                switch (e) {
                    case te.NAVIGATION:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_NAVIGATION_SECTION_TITLE;
                    case te.VOICE_AND_VIDEO:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_VOICE_AND_VIDEO_SECTION_TITLE;
                    case te.CHAT:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_CHAT_SECTION_TITLE;
                    case te.MISCELLANEOUS:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_MISCELLANEOUS_SECTION_TITLE;
                    case te.MESSAGE:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_MESSAGE_SECTION_TITLE;
                    case te.DND:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_DND_SECTION_TITLE
                }
            }
            ...
            function le(e) {
                switch (e) {
                    case te.MESSAGE:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_MESSAGE_DESCRIPTION;
                    case te.DND:
                        return oe.Z.Messages.USER_SETTINGS_KEYBINDS_DND_DESCRIPTION;
                    default:
                        return null
                }
            }
            ...
            var ce = (ae(re = {}, l.EkH.SERVER_NEXT, P.nq), ae(re, l.EkH.SERVER_PREV, P.X3), ae(re, l.EkH.CHANNEL_NEXT, i.tQ), ae(re, l.EkH.CHANNEL_PREV, i.x5), ae(re, l.EkH.NAVIGATE_BACK, i.Nx), ae(re, l.EkH.NAVIGATE_FORWARD, i.On), ae(re, l.EkH.UNREAD_NEXT, ee.pd), ae(re, l.EkH.UNREAD_PREV, ee.wk), ae(re, l.EkH.MENTION_CHANNEL_NEXT, ee.Nv), ae(re, l.EkH.MENTION_CHANNEL_PREV, ee.uX), ae(re, l.EkH.TOGGLE_PREVIOUS_GUILD, i.$c), ae(re, l.EkH.JUMP_TO_GUILD, v.u), ae(re, l.EkH.SUBMIT, Z.z), ae(re, l.EkH.TEXTAREA_FOCUS, w.U), ae(re, l.EkH.MARK_CHANNEL_READ, g.f), ae(re, l.EkH.MARK_SERVER_READ, I.l), ae(re, l.EkH.TOGGLE_CHANNEL_PINS, U), ae(re, l.EkH.TOGGLE_INBOX_UNREADS_TAB, F), ae(re, l.EkH.MARK_TOP_INBOX_CHANNEL_READ, j), ae(re, l.EkH.TOGGLE_USERS, $), ae(re, l.EkH.TOGGLE_HELP, B), ae(re, l.EkH.TOGGLE_MUTE, G.iN), ae(re, l.EkH.TOGGLE_DEAFEN, G.oV), ae(re, l.EkH.TOGGLE_CATEGORY_COLLAPSED, M.u), ae(re, l.EkH.SCROLL_UP, N.B2), ae(re, l.EkH.SCROLL_DOWN, N.gN),
                ae(re, l.EkH.QUICKSWITCHER_SHOW, T.$), ae(re, l.EkH.CREATE_DM_GROUP, s), ae(re, l.EkH.SEARCH_EMOJIS, m.S), ae(re, l.EkH.SEARCH_GIFS, R), ae(re, l.EkH.SEARCH_STICKERS, D), ae(re, l.EkH.TOGGLE_HOTKEYS, V._), ae(re, l.EkH.JUMP_TO_FIRST_UNREAD, y.O), ae(re, l.EkH.CREATE_GUILD, h), ae(re, l.EkH.UPLOAD_FILE, ne), ae(re, l.EkH.RETURN_TO_AUDIO_CHANNEL, L.F), ae(re, l.EkH.CALL_ACCEPT, r.IL), ae(re, l.EkH.CALL_START, r.FI), ae(re, l.EkH.FOCUS_SEARCH, C), ae(re, l.EkH.JUMP_TO_CURRENT_CALL, S), ae(re, l.EkH.ZOOM_IN, ie.UF), ae(re, l.EkH.ZOOM_OUT, ie.RC), ae(re, l.EkH.ZOOM_RESET, ie.MY), ae(re, l.EkH.OPEN_APP_DIRECTORY, b), ae(re, l.EkH.BROWSER_DEVTOOLS, p), re);

            function de() {
                return [{
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_NAVIGATE_SERVERS,
                    binds: se(l.EkH.SERVER_PREV, l.EkH.SERVER_NEXT),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_NAVIGATE_CHANNELS,
                    binds: se(l.EkH.CHANNEL_PREV, l.EkH.CHANNEL_NEXT),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_NAVIGATE_BACK_FORWARD,
                    binds: se(l.EkH.NAVIGATE_BACK, l.EkH.NAVIGATE_FORWARD),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_UNREAD_CHANNELS,
                    binds: se(l.EkH.UNREAD_PREV, l.EkH.UNREAD_NEXT),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_UNREAD_MENTION_CHANNELS,
                    binds: se(l.EkH.MENTION_CHANNEL_PREV, l.EkH.MENTION_CHANNEL_NEXT),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_NAVIGATE_TO_CALL,
                    binds: se(l.EkH.JUMP_TO_CURRENT_CALL),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_TOGGLE_PREVIOUS_GUILD,
                    binds: se(l.EkH.TOGGLE_PREVIOUS_GUILD),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_QUICKSWITCHER,
                    binds: se(l.EkH.QUICKSWITCHER_SHOW),
                    group: te.NAVIGATION
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_CREATE_GUILD,
                    binds: se(l.EkH.CREATE_GUILD),
                    group: te.NAVIGATION,
                    groupEnd: !0
                }, {
                    description: oe.Z.Messages.DND_OPERATION_LABEL_START,
                    binds: ["mod+d"],
                    group: te.DND
                }, {
                    description: oe.Z.Messages.DND_OPERATION_LABEL_MOVE,
                    binds: ["up", "down"],
                    group: te.DND
                }, {
                    ...
                    description: oe.Z.Messages.DND_OPERATION_LABEL_CANCEL,
                    binds: ["esc"],
                    group: te.DND,
                    groupEnd: !0
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_MARK_SERVER_READ,
                    binds: se(l.EkH.MARK_SERVER_READ),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_MARK_CHANNEL_READ,
                    binds: se(l.EkH.MARK_CHANNEL_READ),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_CREATE_DM_GROUP,
                    binds: se(l.EkH.CREATE_DM_GROUP),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_TOGGLE_PINS,
                    binds: se(l.EkH.TOGGLE_CHANNEL_PINS),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_TOGGLE_INBOX,
                    binds: se(l.EkH.TOGGLE_INBOX_UNREADS_TAB),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_MARK_TOP_INBOX_CHANNEL_READ,
                    binds: se(l.EkH.MARK_TOP_INBOX_CHANNEL_READ),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_TOGGLE_USERS,
                    binds: se(l.EkH.TOGGLE_USERS),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_SEARCH_EMOJIS,
                    binds: se(l.EkH.SEARCH_EMOJIS),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_SEARCH_GIFS,
                    binds: se(l.EkH.SEARCH_GIFS),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_SEARCH_STICKERS,
                    binds: se(l.EkH.SEARCH_STICKERS),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_SCROLL_CHAT,
                    binds: se(l.EkH.SCROLL_UP, l.EkH.SCROLL_DOWN),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_JUMP_TO_FIRST_UNREAD,
                    binds: se(l.EkH.JUMP_TO_FIRST_UNREAD),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_FOCUS_TEXT_AREA,
                    binds: se(l.EkH.TEXTAREA_FOCUS),
                    group: te.CHAT
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_UPLOAD_FILE,
                    binds: se(l.EkH.UPLOAD_FILE),
                    group: te.CHAT,
                    groupEnd: !0
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_TOGGLE_MUTE,
                    binds: se(l.EkH.TOGGLE_MUTE),
                    group: te.VOICE_AND_VIDEO
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_TOGGLE_DEAFEN,
                    binds: se(l.EkH.TOGGLE_DEAFEN),
                    group: te.VOICE_AND_VIDEO
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_CALL_ACCEPT,
                    binds: se(l.EkH.CALL_ACCEPT),
                    group: te.VOICE_AND_VIDEO
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_CALL_DECLINE,
                    binds: se(l.EkH.MARK_CHANNEL_READ),
                    group: te.VOICE_AND_VIDEO
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_CALL_START,
                    binds: se(l.EkH.CALL_START),
                    group: te.VOICE_AND_VIDEO,
                    groupEnd: !0
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_TOGGLE_HELP,
                    binds: se(l.EkH.TOGGLE_HELP),
                    group: te.MISCELLANEOUS
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_SEARCH,
                    binds: se(l.EkH.FOCUS_SEARCH),
                    group: te.MISCELLANEOUS
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_EASTER_EGG,
                    binds: ["h+h+right+n+k"],
                    group: te.MISCELLANEOUS,
                    groupEnd: !0
                }, {
                    description: oe.Z.Messages.EDIT_MESSAGE,
                    binds: ["e"],
                    group: te.MESSAGE
                }, {
                    description: oe.Z.Messages.DELETE_MESSAGE,
                    binds: ["backspace"],
                    group: te.MESSAGE
                }, {
                    description: oe.Z.Messages.PIN_MESSAGE,
                    binds: ["p"],
                    group: te.MESSAGE
                }, {
                    description: oe.Z.Messages.ADD_REACTION,
                    binds: ["plus"],
                    group: te.MESSAGE
                }, {
                    description: oe.Z.Messages.MESSAGE_ACTION_REPLY,
                    binds: ["r"],
                    group: te.MESSAGE
                }, {
                    description: oe.Z.Messages.COPY_TEXT,
                    binds: ["mod+c"],
                    group: te.MESSAGE
                }, {
                    description: oe.Z.Messages.MARK_UNREAD,
                    binds: ["alt+enter"],
                    group: te.MESSAGE
                }, {
                    description: oe.Z.Messages.KEYBIND_DESCRIPTION_MODAL_FOCUS_TEXT_AREA,
                ...
                r.initialize = function(e) {
                    ...
                    ! function() {
                        ...
                        Object.keys(r).map((function(e) {
                            ...
                            t = (0, c.mB)(t, E.vc.UNREADS_ALL_MESSAGES, !n);
                            u[e] = {
                                flags: t
                            }
                        }));
                    ...
                    if ((0, f.kC)()) {
                        ...
                        Object.values(e).map((function(e) {
                            var t = s.Z.getGuildFlags(e.id),
                                ...
                                i = (0,
                                    c.yE)(t, E.vc.UNREADS_ALL_MESSAGES);
            ...
            const U = new M(u.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, f.hv)(e.type) || L.has(e.id)) && L.set(e.id, m(e))
                    }))
                },
                CHANNEL_CREATE: function(e) {
                    var n = e.channel;

    ...
    [45447, 37055, 67145, 96043, 71402], {
                        ...
                        if (s !== b.evJ.AUTOMOD_MESSAGE_BLOCKED) {
                            if (s !== b.evJ.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS) {
                                ...
                                ! function() {
                                    ...
                                    0 === y.Z.getUploadCount(t, r) && l.Z.setUploads({
                                        channelId: t,
                                        uploads: n,
                                        draftType: r
                                    })
        ...
        444663: (e, t, n) => {
            ...
            function A(e) {
                ...
                t = R ? y.Z.Messages.UPLOAD_AREA_PREMIUM_TIER_UPSELL_BODY_LINE_2.format({
                    premiumPlan: (0, d.Px)(I.p9.TIER_0),
                    premiumMaxSize: y.Z.Messages.FILE_UPLOAD_LIMIT_PREMIUM_TIER_0_CORRECTED
                }) : y.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_2_INCREASE;
                var C = i.useMemo((function() {
                        var e = d.ZP.getUserMaxFileSize(P),
                            t = (0, p.BU)(e / 1024, {
                                useKibibytes: !0
                            }),
                            n = y.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1.format({
                                maxSize: t
                            });
                        switch (null == P ? void 0 : P.premiumType) {
                            case I.p9.TIER_0:
                                n = y.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1_PREMIUM_TIER_0.format({
                                    maxSize: t
                                });
                                break;
                            case I.p9.TIER_1:
                                n = y.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1_PREMIUM_TIER_1.format({
                                    maxSize: t
                                })
                        }
                        return n
                ...
                return (0, r.jsx)(h.Z, function(e) {
                    ...
                    body: U,
                    context: y.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1.format({
                        maxSize: y.Z.Messages.FILE_UPLOAD_LIMIT_NEW_STANDARD
                    }),
                    glowUp: t,
                    analyticsLocation: {
        ...
        396043: (e, t, n) => {
            ...
            function R(e) {
                ...
                return {
                    ...
                    guild_member_perms: String(null !== (n = d.Z.getGuildPermissions(t)) && void 0 !== n ? n : y.ZP.NONE),
            ...
            function C(e) {
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (t = d.Z.getChannelPermissions(e)) && void 0 !== t ? t : y.ZP.NONE),
                    channel_hidden: n
                }
            }
            ...
            function v(e) {
                ...
                i.useEffect((function() {
                    Y || (q ? f.default.track(h.rMx.PREMIUM_GUILD_UPSELL_VIEWED, {
                        type: "".concat(T, " - Tier ").concat(y.boostedGuildTier),
                        guild_id: y.guild.id,
        ...
        531441: (e, t, n) => {
            ...
            var h = function(e) {
                    var t = e.count,
                        ...
                        T = e.className,
                        g = e.style,
                        y = _(e, ["count", "color", "disableColor", "shape", "className", "style"]);

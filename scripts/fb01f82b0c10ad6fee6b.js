    ...
    [77179], {
        605961: (e, r, t) => {
            ...
            function p(e) {
                ...
                return (0, u.jsx)("svg", s(function(e) {
            ...
            function d(e) {
                var r = e.width,
                    ...
                    l = e.className,
                    f = e.foreground,
                    s = h(e, ["width", "height", "color", "className", "foreground"]);
            ...
            function C(e) {
                var r = e.width,
                    ...
                    i = void 0 === c ? "currentColor" : c,
                    l = e.foreground,
                    f = m(e, ["width", "height", "color", "foreground"]);
            ...
            function M() {
                return {
                    id: Z,
                    name: D.Z.Messages.APP_DIRECTORY_ALL_CATEGORY
                }
            }
            ...
            function A(e) {
                var r = e.itemId,
                    ...
                    l = L.$k ? "webp" : "png";
                return null != E ? "".concat(location.protocol, "//").concat(E, "/app-assets/application-directory/collection-items/").concat(r, "/").concat(t, ".").concat(l, "?").concat(i) : "".concat(location.protocol).concat(x).concat(S.ANM.APPLICATION_DIRECTORY_COLLECTION_ITEM_IMAGE(r, t, l), "?").concat(i)
            }
            ...
            function R() {
                ...
                for (var t in e) {
                    var o = e[t];
                    r.searchParams.set(t, o)
                }
                var c = r.pathname + r.search,
                    l = (0, n.U)(c, !1);
                (0, i.uL)(l)
            }
        },
        177179: (e, r, t) => {
            ...
            var n = t(784426),
                ...
                l = function() {
                    ...
                    null != n && (0, c.JT)(n);
                    null != l && (0, c.eJ)(l);
                    t === c.eN.APPLICATION && null == o && (t = c.eN.HOME);
                    switch (t) {
                        case c.eN.HOME:
                            u();
                            break;
                ...
                a = function(e) {
                    ...
                    (0, n.uL)(i.Z5c.APPLICATION_DIRECTORY_PROFILE(r, null == t ? void 0 : t.toLowerCase()), {
                        state: o
                    })
                },
                f = function() {
                ...
                s = function(e) {
                    var r = e.categoryId;
                    f({
                        categoryId: null != r ? r : o.MU
                    })
                },
                O = function(e) {
                    var r = (0, n.s1)().location.state;
                    (0, n.dL)(e, r)
                }
        },
        247729: (e, r, t) => {
        ...
        755284: (e, r, t) => {
            ...
            function u(e) {
                var r = e.width,
                    ...
                    O = e.className,
                    p = e.foreground,
                    b = l(e, ["width", "height", "color", "className", "foreground"]);
                return (0, n.jsx)("svg", i(function(e) {
                    for (var r = 1; r < arguments.length; r++) {
                        var t = null != arguments[r] ? arguments[r] : {},
                            n = Object.keys(t);

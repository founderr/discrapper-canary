        ...
        646356: function(t, e, a) {
            ...
            var T = new I(l.default, {
                ...
                SAFETY_HUB_FETCH_CLASSIFICATION_START: function(t) {
                    u[t.classificationId] = r.ClassificationRequestState.PENDING, o = !0
                },
                SAFETY_HUB_FETCH_CLASSIFICATION_SUCCESS: function(t) {
                    ...
                    c[e.id] = e, u[e.id] = r.ClassificationRequestState.SUCCESS, S = a, o = !1, _ = null, d = n
                },
                SAFETY_HUB_FETCH_CLASSIFICATION_FAILURE: function(t) {
                    ...
                    o = !1, _ = e, u[a] = r.ClassificationRequestState.FAILED
                },
        ...
        966677: function(t, e, a) {
            ...
            let g = t => {
                ...
                h = t => {
                    ...
                    } = e, u = _.default.extractTimestamp(s), S = (0, d.useIsNewClassification)(e), o = new Date(r), E = o.toDateString();
                    return (0, n.jsx)(c.Clickable, {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [S ? (0, n.jsx)(U, {}) : (0, n.jsx)(m, {
                                timestamp: u
                            }), (0, n.jsx)(c.Heading, {
                                variant: "heading-lg/normal",
                                ...
                                children: o > new Date ? C.default.Messages.SAFETY_HUB_VIOLATIONS_CONTAINER_EXPIRATION_DATE_ACTIVE.format({
                                    expirationDate: E
                ...
                R = t => {
                    let {
                        status: e,
                        classifications: a
                    } = t, [i, l] = s.useState(!1), [r, u] = s.useState(3), S = (0, I.useSafetyHubAccountStanding)(), o = s.useMemo(() => a.slice(0, r), [a, r]);
                    s.useEffect(() => {
                        i && E.default.track(f.AnalyticEvents.SAFETY_HUB_ACTION, {
                            ...
                            classification_ids: o.map(t => Number(t.id)),
                            source: N.SafetyHubAnalyticsActionSource.StandingTab
                        })
                    }, [i, S.state, o]);
                    let _ = a.length - o.length > 3 ? 3 : a.length - o.length;
                    return (0, n.jsxs)("div", {
                        ...
                        children: [(0, n.jsx)(g, {
                            ...
                            }), o.length > 0 && o.map(t => (0, n.jsx)(h, {
                                classification: t
                            }, t.id)), o.length < a.length && (0, n.jsxs)(n.Fragment, {
                                children: [(0, n.jsx)(c.TabBar.Separator, {
                                    style: {
                                        height: "1px",
                                        width: "100%"
                            ...
                            }), 0 === o.length && "active" === e && (0, n.jsx)(D, {}), 0 === o.length && "expired" === e && (0, n.jsx)(L, {})]
                        })]
                    })
                },
                H = () => {

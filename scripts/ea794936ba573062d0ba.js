    ...
    ["29257"], {
        ...
        846883: function(e, t, n) {
            ...
            function k(e, t) {
                let {
                ...
                } = (0, r.default)(), w = (0, i.useStateFromStores)([C.default], () => C.default.getCurrentUser()), X = (0, i.useStateFromStores)([U.default], () => U.default.getSelfEmbeddedActivities()), B = (0, i.useStateFromStoresArray)([h.default], () => h.default.getActivities().filter(e => null != e.application_id && !(null == X ? void 0 : X.has(e.application_id)))), z = (0, i.useStateFromStoresArray)([y.default], () => null != t ? y.default.getActivities(t.id, null == e ? void 0 : e.getGuildId()) : [], [t, e]), K = (0, i.useStateFromStoresArray)([U.default], () => {
                    ...
                    VoiceStateStore: L.default,
                    PermissionStore: g.default
                }))], [z, Z, $, w, K, t]), et = (0, i.useStateFromStoresArray)([c.default, A.default], () => z.map(e => e.type === P.ActivityTypes.LISTENING && null != t ? (0, _.default)(c.default, A.default, t, e) : void 0), [t, z]), en = (0, s.useAnalyticsContext)();
                if (!Q) return null;
                let ea = (n, a) => {
                ...
                return null == X || X.forEach(n => {
                    let i = (null == t ? void 0 : t.id) != null && n.connections.has(null == t ? void 0 : t.id),
                        d = g.default.can(P.Permissions.CREATE_INSTANT_INVITE, e);
                    ...
                    e.type === P.ActivityTypes.PLAYING && (0, R.default)(e, P.ActivityFlags.JOIN) ? eu.push((0, a.jsx)(l.MenuItem, {
                        id: "invite-to-join",
                        label: J.default.Messages.USER_ACTIVITY_ACTION_INVITE_TO_JOIN,
                        subtext: e.name,
                        action: () => ea(P.ActivityActionTypes.JOIN, e)
                    }, "self".concat(t))) : e.type === P.ActivityTypes.LISTENING && (0, R.default)(e, P.ActivityFlags.SYNC) && eu.push((0, a.jsx)(l.MenuItem, {
                        id: "invite-to-listen",
                    ...
                    if (n.type === P.ActivityTypes.PLAYING && (0, R.default)(n, P.ActivityFlags.JOIN) && null != n.session_id && null != n.application_id) {
                        if (ee[i]) {
                            let e = q[i];
                    ...
                    } else if (n.type === P.ActivityTypes.LISTENING && (0, R.default)(n, P.ActivityFlags.SYNC) && null != et[i]) {
                        let d = et[i],
                            {
                                notPlayable: u,
                                playingSameTrack: s,
                        ...
                        eu.push((0, a.jsx)(l.MenuItem, {
                            ...
                            action: () => (0, E.default)(d, Y.SpotifyActionTypes.USER_ACTIVITY_PLAY),
                            label: (0, f.default)(d, Y.SpotifyActionTypes.USER_ACTIVITY_PLAY),
                            subtext: _ ? (0, I.default)(d, Y.SpotifyActionTypes.USER_ACTIVITY_PLAY, null != e ? O.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: _
                        }, "spotify-play-".concat(n.session_id)), (0, a.jsx)(l.MenuItem, {
                            id: "spotify-sync-".concat(n.session_id),
                            action: () => (0, S.default)(d, Y.SpotifyActionTypes.USER_ACTIVITY_SYNC),
                            label: J.default.Messages.USER_ACTIVITY_LISTEN_ALONG,
                            subtext: A ? (0, I.default)(d, Y.SpotifyActionTypes.USER_ACTIVITY_SYNC, null != e ? O.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: A
        ...
        58622: function(e, t, n) {
            ...
            function f(e) {
                ...
                }), c = (0, i.useStateFromStores)([s.default], () => (0, d.canViewInviteModal)(s.default, n, a, l)), f = I(t, n, c && null != a ? a : r), S = _(t);
        ...
        483226: function(e, t, n) {
            ...
            function r(e, t, n) {
                ...
                a = (0, d.setFlag)(a, s.ChannelNotificationSettingsFlags.UNREADS_ALL_MESSAGES, n === u.UserUnreadSettings.ALL_MESSAGES), a = (0, d.setFlag)(a, s.ChannelNotificationSettingsFlags.UNREADS_MENTIONS_AND_HIGHLIGHTS, n === u.UserUnreadSettings.MENTIONS_AND_HIGHLIGHTS), i.default.updateChannelOverrideSettings(e, t, {
                    flags: a
                })
            }
            ...
            function o(e, t) {
                ...
                n = (0, d.setFlag)(n, s.GuildNotificationSettingsFlags.UNREADS_MENTIONS_AND_HIGHLIGHTS, t), n = (0, d.setFlag)(n, s.GuildNotificationSettingsFlags.UNREADS_ALL_MESSAGES, !t), i.default.updateGuildNotificationSettings(e, {
                    flags: n
                })
            }

        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: A
                } = (0, f.usePaymentContext)(), v = g.find(e => e.key === I);
                l.useEffect(() => {
                    N(null)
        ...
        460029: function(e, t, n) {
            ...
            var I = l.memo(function(e) {
                ...
                let D = l.useCallback(e => {
                        null != p && (p.pause(), null != e && (p.currentTime = e), N(!1))
                    }, [p]),
                    b = l.useCallback(() => {
                        if (null != p) {
                            if (S) {
                            ...
                            C >= T ? p.currentTime = (0, E.toSeconds)(O) : p.currentTime = (0, E.toSeconds)(C), p.volume = (0, d.default)(r), p.play(), N(!0)
                        }
                    }, [p, T, D, C, S, O, r]),
                    U = l.useCallback(e => {
                        v(e), null == g || g({
        ...
        278175: function(e, t, n) {
            ...
            var h = s.memo(function(e) {
                let {
                    ...
                    audio: m
                } = (0, d.useAudioTrimmerStore)(), I = null != m, g = s.useRef(null), p = s.useRef(null), S = s.useRef(null), [N, A] = s.useState(0), [v, C] = s.useState(0), [T, O] = s.useState(0), [L, R] = s.useState(!1), [M, D] = s.useState(!1), [b, U] = s.useState(!1), [w, y] = s.useState(0), [P, x] = s.useState(-1), F = s.useMemo(() => w / h.fineTuningScale, [h.fineTuningScale, w]);
                s.useEffect(() => {
                    if (null == m) return;
                ...
                return s.useEffect(() => {
                    ...
                    let e = setTimeout(() => {
                        L && N == N && -1 === P ? x(N) : b && T == T && -1 === P ? x(T) : M && v == v && -1 === P && x(v)
                    }, h.fineTuningDelay);
                    return () => {
                        clearTimeout(e)
                    }
                }, [h.fineTuningDelay, b, T, P, M, v, L, N]), (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)("input", {
                                ...
                                type: "range",
                                min: (0, c.getMinValue)(P, F, w),
                                max: (0, c.getMaxValue)(P, F, w),
                                value: N,
                                onChange: B,
                                onMouseDown: e => V(e, 0),
                                onMouseUp: () => G(0),
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            style: {
                                left: "".concat((0, c.getStartHandleValue)(N, P, F, w), "%"),
                                right: "".concat((0, c.getEndHandleValue)(T, P, F, w), "%")
                            },
                            ...
                            children: (0, r.jsx)("div", {
                                ...
                                style: {
                                    left: "".concat((0, c.getStartHandleValue)(v, P, F, w), "%")
                                }
                            })
                        })]
                    }), (0, r.jsx)("div", {
        ...
        477633: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                m = l.memo(function(e) {
                    ...
                    }, [n, m]), N = (0, f.useAudioBufferData)(t), A = (0, f.useAudioWaveformData)(N, p.current, S), v = (0, d.default)(), C = (0, c.useColorValue)((0, o.isThemeDark)(v) ? _.Color.PRIMARY_300 : _.Color.PRIMARY_700), T = null == N || null == A, O = 0 === I.width || 0 === I.height, L = (O || T) && null != t, R = l.useCallback(() => {
                        null != p.current && g({
        ...
        723961: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                h = l.memo(function(e) {
                    ...
                    return l.useEffect(() => {
                        null == g.current && (g.current = (0, c.loadAudioFileFromUrl)(A, t.name).then(N))
        ...
        823749: function(e, t, n) {
            ...
            function O(e) {
                ...
                let {
                    ...
                    transitionState: R,
                    showGuildPicker: M = !1
                } = e, [D, b] = s.useState(null !== (n = null !== (t = null == u ? void 0 : u.name) && void 0 !== t ? t : null == O ? void 0 : O.name) && void 0 !== n ? n : ""), [U, w] = s.useState(null !== (i = null == O ? void 0 : O.volume) && void 0 !== i ? i : 1), [y, P] = s.useState(null == O ? void 0 : O.emojiId), [x, F] = s.useState(null == O ? void 0 : O.emojiName), {
                    file: V,
                    loadAudioFromFile: G,
                    maxVolume: B,
                    setMaxVolume: k
        ...
        876189: function(e, t, n) {
            ...
            function v(e) {
                let {
                    ...
                    return e
                }), v = (0, a.useStateFromStoresObject)([g.default], () => {
                    let e = {};
        ...
        181114: function(e, t, n) {
            ...
            let I = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...I
                } = e, g = s.createRef(), p = (0, c.default)(g), S = !i && !l && !0 !== a && (!h || p);

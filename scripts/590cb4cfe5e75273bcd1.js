(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [19493], {
        ...
        516217: (e, t, n) => {
            ...
            var a = function(e) {
                    ...
                    return {
                        ...
                        hasUnlimited: u.hasUnlimited,
                        hasBurstToggle: u.hasBurstToggle
                    }
                },
                l = (0, r.B)({
                    kind: "user",
                ...
                g = function() {
                    ...
                    t.loadComplete = function(e) {
                        var t, n, r, a, c, s, f, d, p, h, _, E = this,
                            ...
                            S = null !== (s = e.cached) && void 0 !== s && s,
                            A = o()(y).reverse().map(i.getCurrentConfig({
                                location: "2ecb25_2"
                            }, {
                                autoTrackExposure: !1
                            }).enabled ? function(e) {
                            ...
                            R = null;
                        return R = (R = (g || O) && null == b && this.ready ? this.merge(A, g, !0) : this.reset(A)).mutate({
                            ready: !0,
                            loadingMore: !1,
                            jumpType: null !== (f = null == b ? void 0 : b.jumpType) && void 0 !== f ? f : u.S.ANIMATED,
                            jumpFlash: null !== (d = null == b ? void 0 : b.flash) && void 0 !== d && d,
                            jumped: null != b,
                            jumpedToPresent: null !== (p = null == b ? void 0 : b.present) && void 0 !== p && p,
                            ...
                            jumpReturnTargetId: null !== (_ = null == b ? void 0 : b.returnMessageId) && void 0 !== _ ? _ : null,
                            hasMoreBefore: null == b && O ? R.hasMoreBefore : T,
                            hasMoreAfter: null == b && g ? R.hasMoreAfter : I,
                            cached: S,
        ...
        769915: (e, t, n) => {
            ...
            var L = function(e) {
                ...
                U = function(e) {
                    ...
                    }(e) ? e.message.nonce : L(e) ? e.message.messageId : e.message.data.id
                },
                j = [6e4, 3e5];
            const Z = new(function(e) {
                ...
                r.handleSend = function(e, t) {
                    ...
                    if (s.ZP.get("send_fail_100")) {
                        ...
                        var h;
                        null != D && (D.isInstanceUILocked() ? h = {
                            location: P.OVERLAY_LOCKED_ACTIVATED
                        } : D.isInstanceUILocked() || (h = D.isPinned(m.Odu.TEXT) ? {
        ...
        384482: (e, t, n) => {
            ...
            var g = u.parse(location.search.slice(1)),
                O = parseInt(null != g.rpc && "" !== g.rpc ? g.rpc : s.V6Z, 10),
                b = null;
            const T = new(function(e) {
                ...
                r.connect = function() {
                    ...
                    if (null == b)
                        if (O > m) {
                            ...
                            try {
                                b = new WebSocket("ws://127.0.0.1:".concat(this.port, "/?v=").concat(s.X6Q))
                            } catch (e) {
                                this.disconnect({
                                    code: s.$VG.CLOSE_ABNORMAL
                                });
                                return
                            }
                            if (null != b) {
                                b.onmessage = function(t) {
                                    ...
                                    if (r !== s.Etm.DISPATCH) {
                                        ...
                                        if (o === s.zMe.ERROR) {
                                            e.emit("error", new c.Z(u.code, u.message));
                                            e.disconnect();
                                            return
                                        }
                                        e.emit(y(r, o), u)
                ...
                r.disconnect = function(e) {
                    if (null != e && "code" in e && [s.$VG.CLOSE_ABNORMAL, s.$VG.INVALID_CLIENTID].includes(e.code)) {
                        O++;
                        b = null;
                        this.connect()
                    } else if (null != b) {
                ...
                r.subscribe = function(e, t, n) {
                    this.on(y(s.Etm.DISPATCH, e), n);
                    return this.request(s.Etm.SUBSCRIBE, t, e)
                };
                r.unsubscribe = function(e, t, n) {
                    this.removeListener(y(s.Etm.DISPATCH, e), n);
                    return this.request(s.Etm.UNSUBSCRIBE, t, e)
                };
                ...
                r.requestOnce = function(e, t, n) {
                    return l.ZP.post({
                        url: "http://127.0.0.1:".concat(this.port, "/rpc?v=").concat(s.X6Q),
                        body: {
                            cmd: e,
                            args: t,
                            evt: n,
                        ...
                        var t = e.body,
                            n = t.evt,
                            r = t.data;
                        if (n === s.zMe.ERROR) throw new c.Z(r.code, r.message);
                        return r
                    }))
                };
                r.requestRedirect = function(e, t, n) {
                    ...
                    window.open("http://127.0.0.1:".concat(this.port, "/rpc?v=").concat(s.X6Q, "&payload=").concat(r, "&callback=").concat(o), "_self");
        ...
        474717: (e, t, n) => {
            ...
            var E = function(e) {
                ...
                function n(e, r) {
                    ...
                    if (e.platform === d.REACT_NATIVE) {
                        var c;
                        o.id = null !== (c = e.id) && void 0 !== c ? c : e.uri;
                        var s = (0, l.hn)({
                            uri: e.uri,
                        ...
                        var f;
                        o.id = null !== (f = e.id) && void 0 !== f ? f : i().uniqueId("upload");
                        o.classification = a.f3(e.file);
        ...
        861323: (e, t, n) => {
            ...
            var r, o, i, u, a, l, c = n(608575),
                ...
                I = /^\/channels\/([0-9]+)\/shop$/,
                S = /^\/clyde-profiles\/([0-9-]+)\/?$/,
                A = U(window.GLOBAL_ENV.INVITE_HOST),
                ...
                P = U("discordapp.com"),
                M = U("discord.com"),
                D = [p.Z.escape(null !== (o = A.host) && void 0 !== o ? o : ""), p.Z.escape(null !== (i = R.host) && void 0 !== i ? i : ""), p.Z.escape(null !== (u = C.host) && void 0 !== u ? u : ""), p.Z.escape(null !== (a = P.host) && void 0 !== a ? a : ""), p.Z.escape(null !== (l = M.host) && void 0 !== l ? l : "")].filter(Boolean),
                L = new RegExp("((https?://[^ ]*)|^|[^/][^/.])(".concat(D.join("|"), ")"), "g");
            ...
            function G(e) {
                ...
                var t = new Set,
                    n = [];
                e = e.replace(L, (function(e, t, n, r) {
                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, g, D, U, Z = j(A, p),
                                G = j(R, p),
                                V = null !== (U = null !== (D = null !== (g = null !== (E = j(C, p)) && void 0 !== E ? E : j(N, p)) && void 0 !== g ? g : j(w, p)) && void 0 !== D ? D : j(P, p)) && void 0 !== U ? U : j(M, p),
                                k = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
                            ...
                            var Q = null == V ? void 0 : V.match(S);
                            if (null != Q) {
                                var X = Q[1];
                                k(_.g.CLYDE_PROFILE, X)
                            }
                            var $ = null == V ? void 0 : V.match(b),
                            ...
                            var te = null == V ? void 0 : V.match(T);
                            null != te && k(_.g.GUILD_PRODUCT, "".concat(te[1], "-").concat(te[2]));
                            var ne = null == V ? void 0 : V.match(I);
        ...
        108034: (e, t, n) => {
            ...
            var u = function() {
                ...
                var t = e.prototype;
                t.getCreateAttachmentURL = function(e) {
                    return o.ANM.GUILD_PRODUCT_CREATE_ATTACHMENT_UPLOAD(e)
                };
                t.getDeleteUploadURL = function(e) {
                    return o.ANM.MESSAGE_DELETE_UPLOAD(e)
                };
                t.getMaxFileSize = function(e) {
                    return r.ve
                };
        ...
        725165: (e, t, n) => {
            ...
            var r = "guild-product-edit-modal",
                o = 524288e3,
                i = 524288e3,
                u = 10
        },
        269300: (e, t, n) => {
            ...
            const x = new k(a.Z, {
                CONNECTION_OPEN: function(e) {
                    ...
                    P.forEach(A);
                    t.forEach((function(e) {
                        return e.guild_scheduled_events.forEach(A)
                    }));
                    return !0
                },
                ...
                GUILD_SCHEDULED_EVENT_RSVPS_FETCH_SUCESS: function(e) {
                    ...
                    n.forEach((function(e) {
                        e.user_id === c.default.getId() && D(e.guild_scheduled_event_id, t)
                    }));
                    return !0
                },
                ...
                EVENT_DIRECTORY_FETCH_SUCCESS: function(e) {
                    ...
                    try {
                        for (var a, l = n[Symbol.iterator](); !(r = (a = l.next()).done); r = !0) {
                            var c = a.value;
                            A(c);
                            null != c.user_rsvp ? D(c.id, c.guild_id) : L(c.id, c.guild_id)
                        }
                    } catch (e) {
                        i = !0;
                        u = e
        ...
        720637: (e, t, n) => {
            ...
            function U(e) {
                return null == e.author ? L : null != e.webhook_id ? new d.Z(e.author) : null !== (t = S.default.getUser(e.author.id)) && void 0 !== t ? t : new d.Z(e.author);
                var t
            }

            function j(e) {
                var t, n, r, i, a, l, s, f = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    d = f.reactions,
                    p = f.interactionData,
                    h = null !== (i = null === (t = e.mentions) || void 0 === t ? void 0 : t.map((function(e) {
                        return e.id
                    }))) && void 0 !== i ? i : [],
                    _ = null !== (a = e.mention_roles) && void 0 !== a ? a : [],
                    E = null !== (l = e.mention_channels) && void 0 !== l ? l : [],
                    v = e.message_reference,
                    m = o()(new Date(e.timestamp)),
                    y = e.type === w.uaV.THREAD_CREATED ? [] : (0,
                        u.ZP)(e.content),
                    T = U(e),
                    S = null,
                    A = null != e.interaction ? g.createFromServer(e.interaction) : null,
                    N = e.type === w.uaV.THREAD_STARTER_MESSAGE ? null === (n = e.referenced_message) || void 0 === n || null === (r = n.author) || void 0 === r ? void 0 : r.id : void 0,
                    P = e.type === w.uaV.PREMIUM_REFERRAL ? e.content : void 0,
                    L = e.content;
                if (e.type === w.uaV.PREMIUM_REFERRAL) {
                    L = "";
                    0
                }
                return new O.Z(D(M({}, e, S), {
                    author: T,
                    webhookId: e.webhook_id,
                    blocked: I.Z.isBlocked(T.id) || null != N && I.Z.isBlocked(N),
                    timestamp: m,
                    ...
                    embeds: V(e),
                    codedLinks: y,
                    giftCodes: (0, R.Fp)(e) ? (0, R.Q_)(null == e ? void 0 : e.embeds[0].url) : (0, R.Q_)(e.content),
                    content: L,
                    referralTrialOfferId: P,
                    call: B(e.call, m),
                    reactions: k(e.channel_id, null != d ? d : e.reactions),
                    interaction: A,
                    interactionData: null != p ? p : e.interaction_data,
                    roleSubscriptionData: e.role_subscription_data,
                    poll: null == e.poll ? void 0 : c(e.poll)
                }))
            }

            function Z(e, t) {
                return null != t.edited_timestamp ? D(M({}, t), {
            ...
            function F(e, t) {
                if (null != t.edited_timestamp) return j(t, {
                    reactions: e.reactions,
                    interactionData: e.interactionData
                });
                var n = e;
                null != t.call && (n = n.set("call", B(t.call, e.timestamp)));
                null != t.attachments && (n = n.set("attachments", G(t)));
                null != t.content && "" !== t.content && (n = n.set("content", t.content));
                null != t.embeds && (n = n.set("embeds", V(t)));
                ...
                if (null != t.reactions) {
                    var r;
                    n = n.set("reactions", k(e.channel_id, null !== (r = e.reactions) && void 0 !== r ? r : t.reactions))
                }
                return n
            }
            ...
            function G(e) {
                return null == e.attachments ? [] : e.attachments.map((function(e) {
                    return D(M({}, e), {
                        spoiler: e.filename.startsWith(N._j)
                    })
                }))
            }
            ...
            function V(e) {
                ...
                var t = e.embeds.map((function(t) {
                    return (0, A.kC)(e.channel_id, e.id, t)
                }));
                return (0, A.o3)(t)
            }
            ...
            var x = function(e) {
                return 0 === (0, s.cv)(e).length || "" !== e.content
            }
        },
        635012: (e, t, n) => {
            "use strict";
        ...
        513586: (e, t, n) => {
            ...
            var r = n(179936),
                ...
                b = new RegExp("".concat(location.protocol).concat(h, "(").concat(g, ")"), "ig"),
                T = function(e) {
                ...
                N = function(e) {
                    return e.match("development" !== E ? O : b)
                },
                w = function(e) {
        ...
        284610: (e, t, n) => {
                            ...
                            for (var r, o = Object.entries(I)[Symbol.iterator](); !(e = (r = o.next()).done); e = !0) {
                                ...
                                try {
                                    for (var f, d = Object.entries(a)[Symbol.iterator](); !(l = (f = d.next()).done); l = !0) {
                                        var p = y(f.value, 2),
                                            h = p[0],
                                            _ = p[1][b.ChannelMessage];
                                        null != _ && ("" !== _.draft && "" !== _.draft.trim() || R(h, b.ChannelMessage, u))
                                    }
                                } catch (e) {
                                    c = !0;
                                    s = e
            ...
            w.migrations = [function(e) {
                if (null == e) return {};
                for (var t in e) "timestamp" in e[t] && (e[t] = h({}, b.ChannelMessage, e[t]));
                return e
            }, function(e) {
                var t = l.default.getId();
                ...
                THREAD_SETTINGS_DRAFT_CHANGE: function(e) {
                    ...
                    if (null != r) {
                        var o = S(r),
                            i = o[t];
                        null == i && (i = o[t] = {});
                        i[b.ThreadSettings] = E(function(e) {
                            for (var t = 1; t < arguments.length; t++) {
                                var n = null != arguments[t] ? arguments[t] : {},
                                    r = Object.keys(n);
                                "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
        ...
        117112: (e, t, n) => {
            ...
            var B, V, k, x = "migrated",
                Y = (C(k = {}, S.Odu.GUILDS, {
                    ...
                    C(k, S.Odu.GUILDS_TEXT, {
                        ...
                        resizeY: !0,
                        dragAnywhere: !1,
                        layoutPolicy: j.OPTIONAL_DEFAULT,
                        defaultSettings: {
                            anchor: {
                                left: .15,
                                top: .15,
            ...
            var K = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    o().forEach(Y, (function(e, t) {
                        e.layoutPolicy === j.REQUIRED && r.push(t)
                    }));
                    o().forEach(B, (function(e, o) {
                        var u = t.getWidgetsForLayout(o),
                            a = !1,
                            l = !0,
                            c = !1,
                            s = void 0;
                        try {
                            for (var f, d = function() {
                                    ...
                                    a = n = !0;
                                    var l = (0, i.Z)();
                                    r = new T(P(w({}, t.getWidgetDefaultSettings(e)), {
                                        type: e,
                                        id: l,
                                        layoutId: o,
                                        zIndex: u.length
                        ...
                        if (a) {
                            e = e.set("widgets", u.map((function(e) {
                                return e.id
                            })));
                            B = P(w({}, B), C({}, o, e))
                        }
                    }));
                    o().forEach(V, (function(e, t) {
                        var r = B[e.layoutId];
                ...
                r.getDefaultLayout = function(e) {
                    ...
                    o().forEach(this.getRegisteredWidgets(), (function(n, r) {
                        switch (n.layoutPolicy) {
                            case j.REQUIRED:
                            case j.OPTIONAL_DEFAULT:
                                t.push(P(w({}, n.defaultSettings), {
                                    type: r,
                                    id: (0, i.Z)(),
                                    layoutId: e
                                }))
            ...
            K.displayName = "LayoutStore";
            K.persistKey = "LayoutStore";
            K.migrations = [function() {
                var e = w({}, a.Z.get("OverlayStore")),
                    t = e.pinnedWidgets,
                    n = e.positions,
                    r = e.sizes;
                if (5 === e.v && t) {
                ...
                var t = e.layouts,
                    ...
                    u = Array.from(t).filter((function(e) {
                        return L(e, 1)[0] !== x
                    }));
                u.forEach((function(e) {
                    ...
                    r.widgets.find((function(e) {
                        ...
                        null == u && t[1].type === S.Odu.TEXT && (u = t[1].pinned);
                        return null != u && null != a || void 0
                    }));
                    if (!u && null != a) {
                        var l = (0, i.Z)();
                        r.widgets = [a, l];
                        o.push([l, P(w({}, W(S.Odu.GUILDS_TEXT)), {
            ...
            const q = new K(l.Z, {
                LAYOUT_CREATE: function(e) {
                    ...
                    n.forEach((function(e, t) {
                        ...
                        "" === u.id && (u.id = (0, i.Z)());
                        if (null != n) {
                            u.pinned = n.pinned; - 1 !== n.anchor.left && (u.anchor = (0,
                                I.jL)(n.anchor, r)); - 1 !== n.size.width && (u.size = (0, I.Ox)(n.size, r))
                        }
                        V = P(w({}, V), C({}, u.id, new T(u)));
                        o.push(u.id)
                    }));
                    B = P(w({}, B), C({}, t, new _({
                        id: t,
                ...
                LAYOUT_SET_PINNED: function(e) {
                    return H(e.widgetId, (function(e, t) {
                        ! function(e) {
                            V = P(w({}, V), C({}, e.id, e.set("pinned", !e.pinned)))
                        }(e)
                    }))
                },
                ...
                LAYOUT_CREATE_WIDGETS: function(e) {
                    e.widgetConfigs.forEach((function(e) {
                        ...
                        V = P(w({}, V), C({}, t.id, t));
                        var r = U(n.widgets).concat([t.id]);
                        B = P(w({}, B), C({}, n.id, n.set("widgets", r)))
                    }))
                }
            })
        },
        352980: (e, t, n) => {
            ...
            var W = function(e) {
                ...
                r.initialize = function() {
                    this.waitFor(C.default, y.Z, g.Z, b.ZP, E.default, A.Z, R.Z, T.Z, S.Z, O.ZP);
                ...
                r.getMessages = function(e) {
                    if (d.Z.hasViewingRoles()) {
                        ...
                        if (d.Z.isViewingRoles(n) && !I.Z.can(N.Plq.VIEW_CHANNEL, t)) return new a.Z(e)
                    }
        ...
        255592: (e, t, n) => {
            ...
            function I(e, t) {
                var n, r;
                return null !== (r = null === (n = S(e)) || void 0 === n ? void 0 : n.get(t)) && void 0 !== r ? r : T
            }
            ...
            const C = new R(u.Z, {
                UPLOAD_ATTACHMENT_POP_FILE: function(e) {
                    var t = e.channelId,
                        n = y(I(t, f.d.ChannelMessage));
                    n.shift();
                    A(t, f.d.ChannelMessage, n)
                },
                ...
                SIDEBAR_CLOSE: function(e) {
                    A(e.baseChannelId, f.d.FirstThreadMessage, [])
                }
            })
        },
        674482: (e, t, n) => {
            ...
            var $ = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    if (null != e) {
                        ...
                        if (null != t) {
                            null == (H = x(t)).textChatNotifications && (H.textChatNotifications = D.textChatNotifications);
            ...
            $.migrations = [function() {
                ...
                return A({}, D, 5 === t ? n : null)
            }, function(e) {
                var t = s.default.getId();
                return null == e || null == t ? {} : I({}, t, A({}, e))
            }];
            const J = new $(i.Z, {
                LOGOUT: function(e) {
        ...
        644144: (e, t, n) => {
            ...
            var S = function(e, t) {
                ...
                A = p.Z.escape(window.GLOBAL_ENV.GIFT_CODE_HOST),
                R = ["discordapp.com/gifts", "discord.com/gifts"].map((function(e) {
                    return p.Z.escape(e)
                })),
                C = [A].concat(T(R)).join("|"),
                N = new RegExp("(?: |^|https?://)(?:".concat(C, ")/([a-z0-9-]+)"), "gi"),
                w = T(["discord.com/billing/promotions", "promos.discord.gg"].map((function(e) {
                    return p.Z.escape(e)
                }))).join("|"),
                P = new RegExp("(?: |^|https?://)(?:".concat(w, ")/([a-z0-9-]+)"), "gi"),
                M = function(e, t) {
                    return Array(t).fill(void 0).map((function() {
                        return "[".concat("abcdefghjkmnpqrstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ23456789", "]{").concat(e, "}")
                    })).join("-?")
                },
                D = [M(4, 4), M(4, 6), M(5, 3), "[a-zA-Z]{4}-?[0-9a-zA-Z]{4}-?[a-zA-Z]{4}"].join("|"),
            ...
            var G = function(e) {
                    return (null == e ? void 0 : e.type) === _.uaV.CUSTOM_GIFT && 1 === (null == e ? void 0 : e.embeds.length) && (null == e ? void 0 : e.embeds[0].type) === _.hBH.GIFT
                },
                B = function(e) {
                    if (null == e) return [];
                    for (var t, n = new Set; null != (t = N.exec(e)) && n.size < 3;) n.add(F(t[1]));
                    for (; null != (t = P.exec(e)) && n.size < 3;) n.add(F(t[1]));
                    return Array.from(n)
                };
                    ...
                    return S(this, (function(l) {
                        switch (l.label) {
                            ...
                            case 2:
                                r = l.sent();
                                i = r.body;
                                c.default.track(_.rMx.GIFT_CODE_RESOLVED, {
                                    resolved: !0,
                                    gift_code: i.code,
            ...
            function Y(e, t) {
                c.default.track(_.rMx.GIFT_CODE_COPIED, function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            function H(e, t, n, r, o, i, u) {
                return null != n || !r && !o && null != e ? _.wZ8.ERROR : !u || i || r || o ? r && (t.isSubscription || null != e) ? _.wZ8.SUCCESS : _.wZ8.CONFIRM : _.wZ8.OPEN
            }

            function z(e, t, n) {
                switch (e) {
                    case _.wZ8.ERROR:
                        return v.Z.Messages.GIFT_CONFIRMATION_HEADER_FAIL;
                    case _.wZ8.SUCCESS:
                        return t.isSubscription ? v.Z.Messages.GIFT_CONFIRMATION_HEADER_SUCCESS_NITRO.format({
                            skuName: n.name
                        }) : v.Z.Messages.GIFT_CONFIRMATION_HEADER_SUCCESS;
                    case _.wZ8.CONFIRM:
                    default:
                        return t.isSubscription ? v.Z.Messages.GIFT_CONFIRMATION_HEADER_CONFIRM_NITRO.format({
                            skuName: n.name
                        }) : v.Z.Messages.GIFT_CONFIRMATION_HEADER_CONFIRM
                }
            }
            ...
            function W(e, t, n) {
                switch (e) {
                    case _.wZ8.ERROR:
                        return v.Z.Messages.GIFT_CONFIRMATION_BUTTON_FAIL;
                    case _.wZ8.SUCCESS:
                        return __OVERLAY__ ? v.Z.Messages.GIFT_CONFIRMATION_BUTTON_NOICE : t.isSubscription ? v.Z.Messages.GIFT_CONFIRMATION_BUTTON_SUBSCRIPTION_SUCCESS : v.Z.Messages.GIFT_CONFIRMATION_BUTTON_GO_TO_LIBRARY;
                    case _.wZ8.OPEN:
                        return v.Z.Messages.GIFT_OPEN_PROMPT;
                    case _.wZ8.CONFIRM:
                    default:
                        return null != n && n ? v.Z.Messages.GIFT_CODE_AUTH_ACCEPT : null != t.giftStyle ? t.isClaimed ? v.Z.Messages.GIFT_CONFIRMATION_BUTTON_CONFIRM : v.Z.Messages.GIFT_CONFIRMATION_BUTTON_CONFIRM_MOBILE : t.isSubscription ? v.Z.Messages.GIFT_CONFIRMATION_BUTTON_CONFIRM_SUBSCRIPTION : v.Z.Messages.GIFT_CONFIRMATION_BUTTON_CONFIRM
                }
            }
                    ...
                    case _.wZ8.SUCCESS:
                        if (null != c) {
                            if (null != c.premiumSubscriptionType) {
                                if (c.premiumSubscriptionType === E.p9.TIER_2) {
                                    return (c.interval === E.rV.MONTH ? v.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_PREMIUM_TIER_2_MONTHLY : v.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_PREMIUM_TIER_2_YEARLY).format({
                                        intervalCount: c.intervalCount
                                    })
                                }
                                return (c.interval === E.rV.MONTH ? v.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_PREMIUM_TIER_1_MONTHLY : v.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_PREMIUM_TIER_1_YEARLY).format({
                                    intervalCount: c.intervalCount
                                })
                            }
                            return (c.interval === E.rV.MONTH ? v.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_GENERIC_SUBSCRIPTION_MONTHLY : v.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS_GENERIC_SUBSCRIPTION_YEARLY).format({
                                skuName: n.name,
                                intervalCount: c.intervalCount
                            })
                        }
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_SUCCESS.format({
                            skuName: n.name
                        });
                    case _.wZ8.CONFIRM:
                    default:
                        if (null != c) {
                            return (c.interval === E.rV.MONTH ? v.Z.Messages.GIFT_CONFIRMATION_BODY_SUBSCRIPTION_MONTHLY_CONFIRM : v.Z.Messages.GIFT_CONFIRMATION_BODY_SUBSCRIPTION_YEARLY_CONFIRM).format({
                                skuName: n.name,
                                intervalCount: c.intervalCount
                            })
                        }
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_CONFIRM.format({
                            skuName: n.name
                        })
                }
            }
            ...
            function q(e, t, n, r, o) {
                var i = n || r ? void 0 : e,
                    u = v.Z.Messages.GIFT_CONFIRMATION_BODY_OWNED.format({
                        onGoToLibrary: o
                    });
                if (null != i) return u;
                if (null == t) return null;
                switch (t.code) {
                    case _.evJ.INVALID_GIFT_SELF_REDEMPTION:
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_SELF_GIFT_NO_PAYMENT;
                    case _.evJ.INVALID_GIFT_REDEMPTION_EXHAUSTED:
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_CLAIMED;
                    case _.evJ.INVALID_GIFT_REDEMPTION_OWNED:
                        return u;
                    case _.evJ.UNKNOWN_GIFT_CODE:
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_INVALID;
                    case _.evJ.INVALID_GIFT_REDEMPTION_SUBSCRIPTION_INCOMPATIBLE:
                        var a = l.default.getCurrentUser();
                        return v.Z.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_MISMATCH.format({
                            planName: (0, d.M5)(a, E.p9.TIER_2) ? v.Z.Messages.PREMIUM_TIER_2 : v.Z.Messages.PREMIUM_TIER_1
                        });
                    case _.evJ.INVALID_GIFT_REDEMPTION_SUBSCRIPTION_MANAGED:
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_ERROR_SUBSCRIPTION_MANAGED;
                    case _.evJ.INVALID_GIFT_REDEMPTION_INVOICE_OPEN:
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_ERROR_INVOICE_OPEN;
                    case _.evJ.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED:
                        return v.Z.Messages.GIFT_CODE_SMITE_REJECT_HELP_TEXT;
                    case _.evJ.BILLING_NON_REFUNDABLE_PAYMENT_SOURCE:
                        return v.Z.Messages.GIFT_CODE_PAYMENT_SOURCE_INVALID;
                    default:
                        return v.Z.Messages.GIFT_CONFIRMATION_BODY_UNKNOWN_ERROR
                }
            }
        ...
        534681: (e, t, n) => {
            ...
            function P(e, t, n, r) {
                ...
                "webp" !== r || C || (r = "png");
                var a = null !== (i = b.env.API_PROTOCOL) && void 0 !== i ? i : location.protocol;
            ...
            function M() {
                return new Promise((e = I((function(e) {
                        var t;
                        return R(this, (function(n) {
                            switch (n.label) {
                                case 0:

    ...
    [85949, 72758, 38479, 17183, 33928, 72935, 96043, 42643, 17363, 56620], {
        652411: (e, t, n) => {
            ...
            var E = function(e) {
                ...
                T = function(e) {
                    function t(t, n, r, o, i, u) {
                        ...
                        l.min = n, l.max = r, l.duration = o;
                        var c = l.value / (l.max - l.min) * l.duration,
                            a = isNaN(c) ? 0 : c;
                        return l.timePassed = a < 0 ? l.duration - a : a, l.directionMultiplier = i, l.easingFunction = u, l
                    }
                    return d(t, e), t.prototype.update = function(e) {
                    ...
                    switch (e.type) {
                        ...
                        case "linear-random":
                            ...
                            var i = S(e.minAddValue),
                                u = S(e.maxAddValue);
                            return new O(new y(h(n.x, r.x), h(i.x, u.x)), new y(h(n.y, r.y), h(i.x, u.x)));
                        case "oscillating":
                            t = S(e.value);
                            var l = S(e.start),
                                c = S(e.final),
                                a = S(e.duration),
                                s = S(e.direction);
                            return new O(new T(t.x, l.x, c.x, a.x, s.x, e.easingFunction), new T(t.y, l.y, c.y, a.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var f = S(e.minStart),
                                p = S(e.maxStart),
                    ...
                    switch (e.type) {
                        ...
                        case "linear-random":
                            ...
                            var i = m(e.minAddValue),
                                u = m(e.maxAddValue);
                            return new I(new y(h(n.x, r.x), h(i.x, u.x)), new y(h(n.y, r.y), h(i.y, u.y)), new y(h(n.z, r.z), h(i.z, u.z)));
                        case "oscillating":
                            t = m(e.value);
                            var l = m(e.start),
                                c = m(e.final),
                                a = m(e.duration),
                                s = m(e.direction);
                            return new I(new T(t.x, l.x, c.x, a.x, s.x, e.easingFunction), new T(t.y, l.y, c.y, a.z, s.y, e.easingFunction), new T(t.z, l.z, c.z, a.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var f = m(e.minStart),
                                p = m(e.maxStart),
            ...
            var N = r.forwardRef((function(e, t) {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == p || p(t), I.current.forEach((function(n, r) {
                                    var o = n.confetti,
                                        i = n.spriteCanvas;
                                    o.update(u), o.draw(i, t), o.shouldDestroy(e, u) && I.current.delete(r)
                ...
                var v = r.useCallback((function(e, t) {
                    ...
                    g = r.useCallback((function(e, t, n, r, i) {
                        var u, l = A(null !== (u = e.id) && void 0 !== u ? u : (0, o.v4)(), e, n, r, i);
                        return v(l, t), l
                    }), [v]),
            ...
            var w = r.forwardRef((function(e, t) {
                        ...
                        null != t && null != e && (t.clearRect(0, 0, e.width, e.height),
                            _.current.forEach((function(e, n) {
                                var r = function(r, o) {
                                    var i = f * o + 2 * o,
                                        u = p * n + 2 * n;
                                    if (t.drawImage(e.image, i, u, f, p), null != r) {
                                        for (var l = t.getImageData(i, u, f, p), c = function(e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
                                                    r: t >> 16 & 255,
                                            ...
                                            }(r), a = 0; a < l.data.length; a += 4) l.data[a] = c.r, l.data[a + 1] = c.g, l.data[a + 2] = c.b;
                                        t.putImageData(l, i, u)
                                    }
                                };
                                            ...
                                            for (; i && (i = 0, l[0] && (u = 0)), u;) try {
                                                ...
                                                switch (r = 0, o && (l = [2 & l[0], o.value]), l[0]) {
                                                    ...
                                                    case 7:
                                                        ...
                                                        continue;
                                                    default:
                                                        if (!(o = u.trys, (o = o.length > 0 && o[o.length - 1]) || 6 !== l[0] && 2 !== l[0])) {
                                                            u = 0;
                                                            continue
                                                        }
                ...
                return r.useEffect((function() {
                    ...
                    ref: d,
                    className: u()(i, (n = {}, n["SpriteCanvas-module_spriteCanvasHidden__ndzQV"] = !c, n))
                })
            }));
            ...
            function L(e, t) {
                ...
                var l = r.useCallback((function(n, r) {
                        ...
                        if (null != c && null != l && 0 !== l.sprites.length) return null == e ? void 0 : e.createConfetti(n, c, l, i, u)
                    }), [e, t]),
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = i(e),
                    ...
                    E = _.length;
                for (var O in e) !t && !a.call(e, O) || d && ("length" == O || f && ("offset" == O || "parent" == O) || p && ("buffer" == O || "byteLength" == O || "byteOffset" == O) || l(O, E)) || _.push(O);
                return _
            }
        },
        70151: (e, t, n) => {
        ...
        578264: (e, t, n) => {
            ...
            var r = n(555639),
                ...
                i = t && !t.nodeType && t,
                u = i && e && !e.nodeType && e,
                l = u && u.exports === i ? r.Buffer : void 0,
        ...
        72831: (e, t, n) => {
            ...
            var E = function(e) {
                var t, n = e.closeAction,
                    ...
                    E = e.className;
                return (0, o.jsxs)("div", {
                    className: u()(d().container, E),
                    children: [(0, o.jsx)(c.Clickable, {
                        className: u()(d().closeButton, (t = {}, _(t, d().closeButtonBold, i === r.BOLD), _(t, d().closeButtonSolid, i === r.SOLID), t)),
                        onClick: n,
            ...
            function D(e) {
                ...
                if (!T.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== g.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = c.Z.getChannel(i),
                        l = M(u, o),
                        a = C({}, t, P(l), null != o && null != i && (0, S.AB)(i) ? A(0, i) : w(u));
                    T.default.track(e, a, {
                        flush: n
                    })
                }
        ...
        761673: (e, t, n) => {
            ...
            function u(e) {
                ...
                if (u) {
                    var c;
                    l = null !== (c = e instanceof o.Z ? e.premiumSubscriberCount : e.premiumSubscriptionCount) && void 0 !== c ? c : 0
                }
        ...
        491379: (e, t, n) => {
            ...
            var r = n(337509),
                o = n(243399),
                i = n(761673),
                u = new Set([r.Q.PARTNERED, r.Q.VERIFIED, r.Q.VERIFIED_AND_PARTNERED, r.Q.COMMUNITY, r.Q.DISCOVERABLE]);
        ...
        596801: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                O && (0, u.Z)(c.KJ3.CHANNEL_CALL_POPOUT);
        ...
        393299: (e, t, n) => {
            ...
            var I, b = (O(r = {}, d.Eu4.NONE, E().iconBackgroundTierNone), O(r, d.Eu4.TIER_1, E().iconBackgroundTierOne), O(r, d.Eu4.TIER_2, E().iconBackgroundTierTwo), O(r, d.Eu4.TIER_3, E().iconBackgroundTierThree), r),
                y = (O(I = {}, d.Eu4.NONE, E().iconTierNone), O(I, d.Eu4.TIER_1, E().iconTierOne), O(I, d.Eu4.TIER_2, E().iconTierTwo),
            ...
            function T(e) {
                ...
                return (0, o.jsx)(f.Z, {
                    ...
                    children: (0, o.jsx)(p.Z, {
                        tier: t,
                        className: u()(r, E().boostedGuildIconGem, y[t])
                    })
                })
            }
            var h = n(21372),
            ...
            function w(e) {
                ...
                var f = function(e) {
                    ...
                    p = u === d.Eu4.NONE ? C.Z.Messages.PREMIUM_GUILD_HEADER_BADGE_NO_TIER : m.nW(u),
                        ...
                        children: function(e) {
                            return (0, o.jsx)(c.Clickable, N(function(e) {
                                ...
                                children: (0, o.jsx)(T, {
                                    ...
                                    iconClassName: n && u !== d.Eu4.TIER_3 ? P().boostedGuildTierMutedIconWithVisibleBanner : null
                                })
                            }))
                        }
                    })
            ...
            function L(e) {
                ...
                return (0, a.Z)(t) ? (0, o.jsx)("div", {
                    ...
                    children: (0, o.jsx)(S.Z, {
                        ...
                        className: u()(P().guildBadge, A({}, P().disableColor, n)),
                        disableBoostClick: r
                    })
                }) : (0, o.jsx)("div", {
                    className: P().guildIconContainer,
        ...
        17363: (e, t, n) => {
            ...
            const C = function(e) {
                var t = e.file,
                    ...
                    q = Q[0],
                    $ = Q[1],
                    ee = (0, c.Z)(l.Z.IMAGE_CROPPING_MODAL).AnalyticsLocationProvider,
                    te = o.useRef({
                        x: 0,
                        y: 0
                    }),
                    ...
                    pe = (ue = (ie = function() {
                        ...
                        return m(this, (function(c) {
                            switch (c.label) {
                                ...
                                case 2:
                                    o = c.sent(), i = o.result, u = o.cancelFn;
                                    re.current = u;
                                    return [4, i];
                                case 3:
                                    r = c.sent();
                                ...
                                case 4:
                                    c.sent();
                                    null === (l = re.current) || void 0 === l || l.call(re);
                                    re.current = null;
                                ...
                                children: [(0, r.jsx)("img", {
                                    style: g({
                                        ...
                                        var e, t = X.width / X.height,
                                            n = (e = le()).width !== e.height && t > _.MY ? D.height / X.height : 1;
                                        return {
                                            width: X.width * V * n,
                                    ...
                                    asValueChanges: function(e) {
                                        if (null != X) {
                                            var t = X.width,
                                                ...
                                                u = o.x,
                                                l = o.y;
                                            (0, i.inRange)(u, r.right, r.left) && (0, i.inRange)(l, r.top, r.bottom) || ce(u, l, r);
                                            F(e);
                                            G(r)
                                        }
                                    },
        ...
        311260: (e, t, n) => {
            ...
            function f() {
                return (f = u((function(e, t, r, i, u) {
                    var s, f, p, d, _, E, O, I;
                    return l(this, (function(l) {
                        switch (l.label) {
                            case 0:
                                s = a(t, r, i, u), f = s.x, p = s.y, d = s.scaledCropWidth, _ = s.scaledCropHeight;
            ...
            function p(e, t, n, r) {
                ...
                null != d && d.drawImage(e, i, u, l, c, 0, 0, p.width, p.height);
            ...
            function I(e, t, n, r) {
                switch (e) {
                    ...
                    case o.pC.BANNER:
                        ...
                        return {
                            width: u, height: u * (1 / o.MY)
                        };
                    case o.pC.GUILD_BANNER:
                        var l = Math.min(t, o.vJ);
                        return {
                            width: l, height: Math.min(l * (9 / 16), r)
                        };
                    case o.pC.VIDEO_BACKGROUND:
        ...
        338479: (e, t, n) => {
            ...
            function R(e) {
                var t = e.text,
                    ...
                    i = e.textColor,
                    u = void 0 === i ? S.Z.Colors.STANDARD : i,
                    l = e.className,
                    c = e.button,
                    a = e.reducedRightPadding,
                    s = void 0 !== a && a;
                return (0, r.jsxs)("div", {
                    className: h()(s ? C().noticeWithoutRightPadding : C().noticeWithRightPadding, l),
                    children: [(0, r.jsxs)("div", {
                ...
                if (null != t) {
                    ...
                    ! function(e, t) {
                        var n = t.document,
                            ...
                            c = void 0;
                        try {
                            for (var a, s = r[Symbol.iterator](); !(u = (a = s.next()).done); u = !0) {
                                var f = a.value;
                    ...
                    var i = (0, l.s)(r.getElementById(A));
            ...
            const g = new v(o.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(e) {
                    ...
                    u.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == t ? void 0 : t.sku_id) === l.Si.TIER_2 && null == i.Z.getPremiumSubscription(!1) && null == b.tutorialExpirationTime && T()
                }
            })
        },
        156620: (e, t, n) => {
            ...
            const M = function(e) {
                var t = function(e) {
                        ...
                        return (0, r.jsxs)(I.C, N(A({
                            ...
                            color: S === h.Si.TIER_1 ? l.Button.Colors.PRIMARY : l.Button.Colors.GREEN,
                            size: P,
                            className: Y,
                            wrapperClassName: M,
                            pauseAnimation: !J || V
                    ...
                    X = (0, u.e7)([_.default], (function() {
                        return _.default.getCurrentUser()
                    })),
                    J = (0, u.e7)([O.Z], (function() {
                        ...
                        if (null != X) {
                            ...
                            if ((null == Q ? void 0 : Q.status) !== v.O0b.ACCOUNT_HOLD) ! function(e) {
                                ...
                                if (t)
                                    ...
                                    } else(0, l.openModalLazy)(R((function() {
                                        var e, t;
                ...
                if (j) return (0, r.jsxs)(l.Button, N(A({
                    size: P,
                    className: M,
                    innerClassName: m().premiumSubscribeButton,
                ...
                if (o) return (0, r.jsxs)(l.Button, N(A({
                    size: P,
                    className: M,
                ...
                return null != (null == ie ? void 0 : ie.disabledButtonTooltipText) ? (0, r.jsx)(l.Tooltip, {
        ...
        491260: (e, t, n) => {
            ...
            function D(e) {
                ...
                delete P[e];
                if (null != m[e]) {
                    var t = y(u().sortBy(m[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                var t, n, r, o, i, u, a = l.default.getCurrentUser();
                if (null == a) return j();
        ...
        127661: (e, t, n) => {
            ...
            function c(e) {
                var t = e.width,
                    ...
                    p = e.foreground,
                    d = e.backgroundColor,
                    _ = l(e, ["width", "height", "color", "foreground", "backgroundColor"]);
                return (0, r.jsxs)("svg", u(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
            ...
            var I = function(e) {
                ...
                b = function(e) {
                    var t = e.text,
                        n = e.className,
                        o = e.color,
                        l = void 0 === o ? u.Z.STATUS_DANGER : o,
                        a = e.shape,

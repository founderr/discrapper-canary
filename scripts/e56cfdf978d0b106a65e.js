(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [25121, 38479, 41484, 6017, 32694, 72935, 96043, 53686, 17363, 56620], {
        652411: (e, t, n) => {
            "use strict";
            n.d(t, {
                O_: () => N,
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = m(e.minValue),
                                r = m(e.maxValue);
                            return new E(new y(v(n.x, r.x)), new y(v(n.y, r.y)));
                        case "linear":
                            t = m(e.value);
                            var o = m(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var i = m(e.minAddValue),
                                l = m(e.maxAddValue);
                            return new E(new I(v(n.x, r.x), v(i.x, l.x)), new I(v(n.y, r.y), v(i.x, l.x)));
                        case "oscillating":
                            t = m(e.value);
                            var c = m(e.start),
                                u = m(e.final),
            ...
            function R(e) {
                return function(e) {
                    switch (e.type) {
                        case "static":
                            var t = S(e.value);
                            return new b(new y(t.x), new y(t.y), new y(t.z));
                        case "static-random":
                            var n = S(e.minValue),
                                r = S(e.maxValue);
                            return new b(new y(v(n.x, r.x)), new y(v(n.y, r.y)), new y(v(n.z, r.z)));
                        case "linear":
                            t = S(e.value);
                            var o = S(e.addValue);
                            return new b(new I(t.x, o.x), new I(t.y, o.y), new I(t.z, o.z));
                        case "linear-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var i = S(e.minAddValue),
                                l = S(e.maxAddValue);
                            return new b(new I(v(n.x, r.x), v(i.x, l.x)), new I(v(n.y, r.y), v(i.y, l.y)), new I(v(n.z, r.z), v(i.z, l.z)));
                        case "oscillating":
                            t = S(e.value);
                            var c = S(e.start),
                                u = S(e.final),
            ...
            var N = r.forwardRef((function(e, t) {
                    ...
                    v = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == d || d(t), b.current.size > 0 ? y.current = window.requestAnimationFrame(v) : (t.clearRect(0, 0, e.width, e.height), y.current = null);
                                var n = Date.now();
                ...
                var g = r.useCallback((function(e, t) {
                    ...
                    T = r.useCallback((function(e, t, n, r, i) {
                        var l, c = A(null !== (l = e.id) && void 0 !== l ? l : (0, o.Z)(), e, n, r, i);
                        return g(c, t), c
                    }), [g]),
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, y()];
                                    case 1:
                                        return e.sent(), b(), _.current = !0, I(!0), [2]
                                }
                            }))
                        }))
                    }), [I, y, b]);
        ...
        661299: (e, t, n) => {
            ...
            const f = function(e) {
                ...
                return (0, r.jsxs)("svg", {
                    width: "18",
                    height: "18",
                    className: i()(u().button, o, (t = {}, a(t, u().open, n), a(t, u().withHighlight, c), t)),
                    children: [c && (0, r.jsx)("defs", {
                        ...
                        children: [(0, r.jsx)("path", {
                            ...
                            stroke: c ? "url(#".concat(s, ")") : "currentColor",
                            d: "M4.5 4.5l9 9",
                            strokeLinecap: "round"
                        }), (0, r.jsx)("path", {
                            stroke: c ? "url(#".concat(s, ")") : "currentColor",
        ...
        396043: (e, t, n) => {
            ...
            function j(e) {
                ...
                if (!h.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== T.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        o = "guild_id" in t ? t.guild_id : r ? y.Z.getGuildId() : null,
            ...
            function D(e, t, n) {
                ...
                o()(I.Z.getVoiceStates(e)).filter((function(e) {
            ...
            function x(e, t) {
                ...
                o()(I.Z.getVoiceStates(e)).forEach((function(e) {
        ...
        393299: (e, t, n) => {
            ...
            var b, y = (E(r = {}, d.Eu4.NONE, _().iconBackgroundTierNone), E(r, d.Eu4.TIER_1, _().iconBackgroundTierOne), E(r, d.Eu4.TIER_2, _().iconBackgroundTierTwo), E(r, d.Eu4.TIER_3, _().iconBackgroundTierThree), r),
                I = (E(b = {}, d.Eu4.NONE, _().iconTierNone), E(b, d.Eu4.TIER_1, _().iconTierOne), E(b, d.Eu4.TIER_2, _().iconTierTwo), E(b, d.Eu4.TIER_3, _().iconTierThree), b);
            ...
            function h(e) {
                ...
                return (0, o.jsx)(f.Z, {
                    ...
                    children: (0, o.jsx)(p.Z, {
                        tier: t,
                        className: l()(r, _().boostedGuildIconGem, I[t])
                    })
                })
            }
            var v = n(21372),
                        ...
                        children: [w && (0, r.jsx)(a.Z, {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)("img", {
                                    ...
                                    className: q ? I().imageDisabled : I().imageEnabled,
                                    src: n,
                                    alt: "avatar",
                                    ref: ne,
                                    ...
                                    className: A === O.pC.AVATAR ? I().overlayAvatar : I().overlayBanner,
                                    style: {
                                        opacity: null == X ? 0 : 1,
                                        width: j.width,
                                        height: j.height
        ...
        338479: (e, t, n) => {
            ...
            function x(e) {
                var t = e.analyticsSection,
                    ...
                    p = (0, c.Z)(I.Z.PREMIUM_PREVIEW_UPSELL_HEADER).sourceAnalyticsLocations;
                o.useEffect((function() {
            ...
            const T = new g(o.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(e) {
                    ...
                    l.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == t ? void 0 : t.sku_id) === c.Si.TIER_2 && null == i.Z.getPremiumSubscription(!1) && null == y.tutorialExpirationTime && h()
                }
            })
        },
        156620: (e, t, n) => {
        ...
        305082: (e, t, n) => {
            ...
            function P() {
                return e = S, t = m, n = h("useMemoizedValueSyncedWithDismissibleContents"), i = (0, o.e7)([u.Z], (function() {
                    var e;
                                ...
                                if (t)
                                    if (o) {
                                        ...
                                        return L(this, (function(o) {
                                            switch (o.label) {
                                                case 0:
                                                    return [4, Promise.all([n.e(40532), n.e(84441), n.e(27470)]).then(n.bind(n, 283097))];
                                                case 1:
        ...
        491260: (e, t, n) => {
            ...
            function j(e) {
                ...
                delete R[e];
                if (null != S[e]) {
                    var t = I(l().sortBy(S[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
        ...
        223219: (e, t, n) => {
            ...
            const G = new U(l.Z, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(e) {
                    if (y !== u.QZA.SUBMITTING) return !1;
                    y = u.QZA.OPEN;
                    h = u.oAB.ACCOUNT;
                    var t;

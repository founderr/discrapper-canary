    ...
    ["13248"], {
        ...
        752598: function(e, t, n) {
            ...
            let A = (e, t) => {
                ...
                let l = e.state === I.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : i.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    d = e.isCommandType();
                if (s && a === p.InteractionState.QUEUED || d && e.state === I.MessageStates.SENDING && null != t) return r.SENDING;
                if (s && a === p.InteractionState.CREATED || e.hasFlag(I.MessageFlags.LOADING) && !u) return r.CREATED;
                if (null != e.interaction && e.hasFlag(I.MessageFlags.LOADING) && u) return r.TIMED_OUT;
                else if (null != e.interaction && !e.hasFlag(I.MessageFlags.LOADING) && l) return r.TIMED_OUT;
                else if (d && e.state === I.MessageStates.SEND_FAILED) return r.FAILED
            };
        ...
        210721: function(e, t, n) {
            ...
            var r, a, i = n("627445"),
                ...
                c = n("659632"),
                f = n("78345");
            (a = r || (r = {})).ACTION = "action", a.LOOP = "loop", a.IDLE = "idle";
            let h = (e, t) => {
                    let a;
                    switch (e) {
                        case f.PremiumGiftStyles.SNOWGLOBE:
                            a = () => n.el("452661").then(n.t.bind(n, "452661", 19)).then(e => {
                                let {
                                    default: t
                                } = e;
                                return t
                        ...
                        case f.PremiumGiftStyles.BOX:
                            a = () => n.el("726871").then(n.t.bind(n, "726871", 19)).then(e => {
                                let {
                                    default: t
                                } = e;
                                return t
                        ...
                        case f.PremiumGiftStyles.CUP:
                            a = () => n.el("544929").then(n.t.bind(n, "544929", 19)).then(e => {
                                let {
                                    default: t
                                } = e;
                                return t
                        ...
                        case f.PremiumGiftStyles.STANDARD_BOX:
                            switch (t) {
                                case r.IDLE:
                                    a = () => n.el("973372").then(n.t.bind(n, "973372", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case r.LOOP:
                                    a = () => n.el("353540").then(n.t.bind(n, "353540", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    a = () => n.el("303473").then(n.t.bind(n, "303473", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                        ...
                        case f.PremiumGiftStyles.CAKE:
                            switch (t) {
                                case r.IDLE:
                                    a = () => n.el("127891").then(n.t.bind(n, "127891", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case r.LOOP:
                                    a = () => n.el("953820").then(n.t.bind(n, "953820", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    a = () => n.el("311972").then(n.t.bind(n, "311972", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                        ...
                        case f.PremiumGiftStyles.CHEST:
                            switch (t) {
                                case r.IDLE:
                                    a = () => n.el("269055").then(n.t.bind(n, "269055", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case r.LOOP:
                                    a = () => n.el("120467").then(n.t.bind(n, "120467", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    a = () => n.el("451680").then(n.t.bind(n, "451680", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                        ...
                        case f.PremiumGiftStyles.COFFEE:
                            switch (t) {
                                case r.IDLE:
                                    a = () => n.el("863089").then(n.t.bind(n, "863089", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case r.LOOP:
                                    a = () => n.el("949233").then(n.t.bind(n, "949233", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    a = () => n.el("361896").then(n.t.bind(n, "361896", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t

    ...
    ["16814"], {
        ...
        719451: function(e, t, n) {
            ...
            var _ = e => {
                ...
                let R = null != E.guild ? new u.default(E.guild) : null,
                    L = null != E.channel ? (0, d.createChannelRecordFromInvite)(E.channel) : null,
                    D = null != E.target_application ? new o.default(E.target_application) : null,
                    j = I || null == E.inviter ? null : new c.default(E.inviter),
                    b = null != E.approximate_member_count && E.approximate_member_count > 100 || null != R && R.hasFeature(v.GuildFeatures.COMMUNITY),
                    k = !b && null != j,
                    P = null,
                    V = !1;
                if (null != R) P = null == j ? N.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN : N.default.Messages.AUTH_MESSAGE_INVITED_BY.format({
                    ...
                    null != L.name && "" !== L.name ? (P = N.default.Messages.AUTH_MESSAGE_INVITED_BY.format({
                        username: e
        ...
        878624: function(e, t, n) {
            ...
            var T = l.default.connectStores([p.default, h.default, o.default, c.default, g.default, E.default, u.default, d.default, f.default], () => {
                ...
                let i = p.default.getGuildId(),
                    ...
                    y = null != S && null != i && null !== (n = null === (e = u.default.getMember(i, S.id)) || void 0 === e ? void 0 : e.isPending) && void 0 !== n && n;
                return {
                    selectedGuild: i,
                    selectedChannel: l,
        ...
        664980: function(e, t, n) {
            ...
            class P extends a.PureComponent {
                ...
                renderChannelLink(e) {
                    let {
                        guild: t
                    } = this.props, n = (0, g.computeChannelName)(e, S.default, v.default), a = null != t ? "".concat(n, " / ").concat(t.name) : n, l = null != t ? t.id : L.ME;
        ...
        357506: function(e, t, n) {
            ...
            class eu extends l.Component {
                ...
                componentDidMount() {
                    v.default.startSession(), M.default.initialize(), y.default.initialize(), R.default.initialize()
                }
                componentDidUpdate(e) {
                    let {
                        initialized: t
                ...
                componentWillUnmount() {
                    window.removeEventListener("resize", this.handleWindowResize), window.removeEventListener("keydown", this.onKeyDownGlobal, !0), window.removeEventListener("keyup", this.onKeyUpGlobal, !0), this.props.locked && window.removeEventListener("contextmenu", es, !1), M.default.terminate(), y.default.terminate(), R.default.terminate()
                }
            ...
            function ec() {
                let {
                    ...
                    autoTrackExposure: !1
                }), g = (0, O.default)() && null != c, E = (0, p.useStateFromStores)([L.default], () => null != L.default.getCurrentUserActiveStream()), {
                    AnalyticsLocationProvider: m
                } = (0, C.default)(I.default.OVERLAY);
                return (0, a.jsx)(m, {
                    children: (0, a.jsx)(eu, {
                        locked: e,
                        initialized: t,
            ...
            class I extends a.PureComponent {
                ...
                render() {
                    ...
                    let {
                        ...
                        resizeY: S,
                        dragAnywhere: T
                    } = t, N = !a || s, y = (0, v.isWidgetContainerVisible)({
                        locked: a,
                        isPreviewingInGame: l,
                        pinned: o
                    }), I = {
                ...
                constructor(e) {
                    ...
                    super(e), t = this, this.draftDidChange = function() {
                        ...
                        return 0 === t.length ? Promise.resolve({
                            ...
                            return (h.default.sendMessage(n.id, x.default.parse(n, t), !0, r), this.setState((0, _.createEmptyState)()), (0, R.deletePendingReply)(n.id), a) ? (p.default.deactivateAllRegions(), {
                                shouldClear: !1,
                                shouldRefocus: !1
                            }) : {
                                shouldClear: !0,
        ...
        522019: function(e, t, n) {
            ...
            function er(e) {
                let {
                    ...
                    guildId: s,
                    ...o
                } = e, d = ea(t, l, R.default), u = (0, r.useStateFromStores)([O.default], () => O.default.getCurrentUserActiveStream()), c = (0, r.useStateFromStoresArray)([O.default], () => null != u ? O.default.getViewerIds(u) : []), f = (0, g.default)({
                    userId: n.id,
                    context: t
                }), h = (0, r.useStateFromStores)([j.default], () => j.default.isPrioritySpeaker(n.id, t)), p = (0, r.useStateFromStores)([A.default, R.default], () => el(t, l)), E = (0, r.useStateFromStores)([O.default], () => null != O.default.getStreamForUser(n.id, s)), m = a.useMemo(() => null != u && u.ownerId !== n.id && c.includes(n.id), [u, n.id, c]);
                return (0, i.jsx)(es, {
                    ...o,
                    muted: d,
                    context: t,
            ...
            function ed(e) {
                ...
                let n = (0, r.useStateFromStores)([D.default, x.default], () => x.default.getChannel(D.default.getVoiceChannelId())),
                    a = (0, E.default)(n),
                    l = function(e) {
                        let [t] = (0, r.useStateFromStores)([k.default, y.default], () => null == e ? [
                            [], -1
                        ] : e.isGuildStageVoice() ? [y.default.getMutableParticipants(e.id, I.StageChannelParticipantNamedIndex.SPEAKER), y.default.getParticipantsVersion(e.id)] : [k.default.getVoiceStatesForChannel(e), k.default.getVoiceStateVersion(e.getGuildId())], [e], X.isVersionEqual);
                        return t
                    }(n),
                    s = (0, r.useStateFromStores)([O.default], () => O.default.getStreamerActiveStreamMetadata()),
                    o = (0, r.useStateFromStoresObject)([L.default, b.default, O.default, P.default, M.default], () => {
                        let e = (0, T.default)(L.default, b.default),
        ...
        246458: function(e, t, n) {
            ...
            function k(e) {
                ...
                let {
                    ...
                    return t
                }), x = (0, s.useStateFromStores)([y.default], () => y.default.getVoiceChannelId()), R = (0, s.useStateFromStores)([N.default], () => N.default.getGuildVersion(n)), L = (0, s.useStateFromStores)([p.default], () => p.default.version), D = (0, s.useStateFromStores)([S.default], () => S.default.getGuildChangeSentinel(n)), j = (0, o.useEmbeddedAppsByChannel)(null == a ? void 0 : a.id), k = (0, d.useActiveEventsByChannel)(null == a ? void 0 : a.id), P = null !== (t = null == a ? void 0 : a.hasFeature(M.GuildFeatures.COMMUNITY)) && void 0 !== t && t;
                return (0, i.jsx)(b, {
                    guildId: n,
                    guild: a,
                    channels: l,
        ...
        786770: function(e, t, n) {
            ...
            function Y(e) {
                let {
                    channelId: t,
                    ringing: n
                } = e, i = W(t), a = n.includes(I.default.getId());
                if (!a) return G(i);
                if (null != i) return !1;
            ...
            var Z = new K(c.default, __OVERLAY__ ? {
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    let {
                        channelId: a,
                        message: r
                    } = e, d = C.default.getChannel(a), u = R.default.getUser(null === (t = r.author) || void 0 === t ? void 0 : t.id);
                    ...
                    if ((null === (n = r.activity) || void 0 === n ? void 0 : n.type) === P.ActivityActionTypes.JOIN || (null === (i = r.activity) || void 0 === i ? void 0 : i.type) === P.ActivityActionTypes.JOIN_REQUEST) {
                        ...
                        let e = function(e, t, n) {
                            let i, a;
                            if (o(null != t.activity, "received null message activity"), n.id === I.default.getId()) return !1;
                    ...
                    let c = !_.default.isSoundDisabled(L.MESSAGE_SOUND);
                ...
                CLIPS_SAVE_CLIP_START: function() {
                    z((0, y.createClipsNotification)(w.default.Messages.CLIPS_SAVE_START_NOTIFICATION_TITLE))
                },
                CLIPS_SAVE_CLIP: function() {
                    z((0, y.createClipsNotification)(w.default.Messages.CLIPS_NOTIFICATION_TITLE.format({
                        duration: (0, b.getSecondsSliderLabel)(N.default.getSettings().clipsLength / 1e3, !0)
                    })))
                },
                CLIPS_SAVE_CLIP_ERROR: function() {
                    z((0, y.createClipsNotification)(w.default.Messages.CLIPS_SAVE_ERROR_NOTIFICATION_TITLE))
                },
        ...
        287850: function(e, t, n) {
            ...
            function O(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function(e) {
                    ...
                    if (null != a) {
                        ...
                        return I.default.compare(i, t) > 0 ? i : t
                    }
                    return i
                }(e);
                return {
            ...
            class R extends u.default.Store {
                initialize() {
                    this.waitFor(v.default, S.default, y.default, g.default, N.default), this.syncWith([N.default, g.default], A)
                }
            ...
            class T extends s.Component {
                ...
                handleDragMove(e, t) {
                    ...
                    let {
                        width: E,
                        height: m
                    } = v(n, this.size), T = t - p, N = e - h, y = (0, u.fitFullCoordsToContainer)((0, u.getFullCoordsFromAnchorCoords)({
                        top: T,
                        left: N,
                        bottom: null,
                        right: null
                    }, l, s, E, m)), I = f ? (0, u.getAnchorCoordsFromFullCoords)(y) : S(a.RESIZE_SOUTH_EAST, y);
                    this.setDOMPositions(I), !g && (null != d && d(), this.setState({
                        operationStarted: !0

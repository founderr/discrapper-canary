                ...
                try {
                    for (var f, h = i[Symbol.iterator](); !(o = (f = h.next()).done); o = !0) {
                        ...
                        if (t === P.h8.USER && d instanceof s.mn) {
                            if (d.type === I.d4z.DM) u[p = d.getRecipientId()] = 1 + y / r;
            ...
            var T = function() {
                function t(e, n) {
                    var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 100,
                        u = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : k,
                        o = this;
                    C(this, t);
                    this.query = "";
                    this.options = k;
            ...
            var D = function() {
                    ...
                    e.update = function(t, e) {
                        ...
                        if (null != n) this.rows[t] = M(this.guildId, n.id, n.count);
                            ...
                            var u = L(this.guildId, this.ownerId, r.user.id);
                            if (null == u) return;
                            this.rows[t] = u;

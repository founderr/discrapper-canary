(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["95664"], {
        ...
        658457: function(e, t, n) {
            ...
            function f(e) {
                let {
                    ...
                    hover: A,
                    innerClassName: S
                }, M = (0, s.useStateFromStores)([i.default], () => i.default.getActiveLibraryApplication(t.id)), v = null != M ? M.sku.id : null, O = null != v ? v : t.primarySkuId, x = (0, s.useStateFromStores)([r.default], () => null != O && !r.default.didFetchingSkuFail(O));
        ...
        790219: function(e, t, n) {
            ...
            class b extends s.Component {
                ...
                renderFreeButton(e, t) {
                    ...
                    let r = e.getPrice();
                    if (e.premium && !l && (a || s)) return (0, y.canUserInstall)(e) && !n ? this.renderButton(U.default.Messages.GAME_ACTION_BUTTON_INSTALL, t) : this.renderButton(U.default.Messages.GAME_ACTION_BUTTON_ADD_TO_LIBRARY, t);
        ...
        710306: function(e, t, n) {
            ...
            class F extends s.PureComponent {
                ...
                constructor(...e) {
                    ...
                    }), this.renderTitle = () => this.props.isSelfGift ? B.default.Messages.GIFT_EMBED_INVALID_TITLE_SELF : B.default.Messages.GIFT_EMBED_INVALID_TITLE_OTHER, this.renderActions = () => this.props.isSelfGift ? (0, a.jsx)(d.Button, {
                    ...
                    }), this.renderTagline = () => this.props.isSelfGift ? B.default.Messages.GIFT_EMBED_INVALID_TAGLINE_SELF : B.default.Messages.GIFT_EMBED_INVALID_TAGLINE_OTHER
                }
            }
            class w extends s.Component {
                ...
                renderGiftCodeCopiesLeft(e) {
                    let t = e.isSubscription ? B.default.Messages.GIFT_EMBED_SUBSCRIPTIONS_LEFT : B.default.Messages.GIFT_EMBED_COPIES_LEFT;
                    return t.format({
                ...
                renderTitle(e) {
                    ...
                    }) : null == a ? null : e.isSubscription ? n ? B.default.Messages.GIFT_EMBED_TITLE_SUBSCRIPTION_SELF : B.default.Messages.GIFT_EMBED_TITLE_SUBSCRIPTION : n ? B.default.Messages.GIFT_EMBED_TITLE_SELF : B.default.Messages.GIFT_EMBED_TITLE
                }
                renderBody(e) {
                    let {
                        libraryApplication: t,
                    ...
                    if (null == a) return B.default.Messages.LOADING;
                    if (!n && this.isCustomGiftMessage() && !e.redeemed) return;
                    let r = a.isPreorder() ? B.default.Messages.PREORDER_SKU_NAME.format({
                        name: a.name
                    }) : a.name;
                    if (e.redeemed) return e.isSubscription ? B.default.Messages.GIFT_EMBED_BODY_CLAIMED_SELF_SUBSCRIPTION : B.default.Messages.GIFT_EMBED_BODY_CLAIMED_SELF.format({
                        skuName: r,
                    ...
                    if (e.hasMultipleCopies) return null != s ? e.isSubscription ? B.default.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_GIVEAWAY.format({
                        username: j.default.getUserTag(s),
                        maxUses: e.maxUses,
                        skuName: r
                    ...
                    if (e.isSubscription) {
                        if (null == l) return B.default.Messages.LOADING;
                        if (null != s) {
                            let e = l.interval === b.SubscriptionIntervalTypes.MONTH ? B.default.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_DEFAULT_MONTHS : B.default.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_DEFAULT_YEARS;
                            return e.format({
                                username: j.default.getUserTag(s),
                                skuName: r,
                        ...
                        let e = l.interval === b.SubscriptionIntervalTypes.MONTH ? B.default.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_NO_USER_DEFAULT_MONTHS : B.default.Messages.GIFT_EMBED_BODY_SUBSCRIPTION_NO_USER_DEFAULT_YEARS;
                        return e.format({
                            skuName: r,
                            intervalCount: l.intervalCount
                        })
                    }
                    return null != s ? B.default.Messages.GIFT_EMBED_BODY_DEFAULT.format({
                        username: j.default.getUserTag(s)
                ...
                render() {
                    ...
                    return (0, a.jsx)(U.StoreEmbedWithoutDimensions, {
                        skuId: e.skuId,
                ...
                constructor(...e) {
                    super(...e), this.handleViewLibrary = e => {
                        ...
                        e.preventDefault(), e.stopPropagation(), R.default.track(G.AnalyticEvents.OPEN_MODAL, {
                            type: "gift_accept",
                            location: {
                        ...
                        let s = this.isCustomGiftMessage() || null != e.giftStyle,
                            l = i({
                                [k.seasonalGiftEmbedWrapper]: !s,
                                [k.customGiftEmbedWrapper]: s,
                                [k.giftEmbedWrapperHorizontal]: n >= f.HORIZONTAL_EMBED_BREAKPOINT
                            }),
                            r = i({
                                [k.seasonalGiftEmbedBox]: !s,
                                [k.customGiftEmbedBox]: s
                            });
                        return (0, a.jsxs)("div", {
                            className: l,
                            children: [!t && b.AllSeasonalGiftStyles.includes(e.giftStyle) && (0, a.jsx)(L.default, {
                                className: k.snow,
                                wind: 5
                            }), !s && (0, a.jsx)(x.default, {
            ...
            let V = (0, E.default)((0, m.default)(w));
            var Y = u.default.connectStores([C.default, M.default, S.default, A.default, N.default, g.default, _.default], e => {
                let {
                    code: t,
                    author: n,
                    currentUser: a
                } = e, s = C.default.get(t), l = null != s ? M.default.get(s.skuId) : null, i = null != s && null != s.userId ? S.default.getUser(s.userId) : null, r = _.default.useReducedMotion;
                return {
                    sku: l,
                    giftCode: s,
                    gifter: i,
                    currentUser: a,
                    subscriptionPlan: null != s && null != s.subscriptionPlanId ? (0, y.getOrFetchSubscriptionPlan)(s.subscriptionPlanId) : null,
                    isSelfGift: null != s ? g.default.getId() === s.userId : g.default.getId() === n.id,
        ...
        308757: function(e, t, n) {
            ...
            async function R(e) {
                ...
                if (null == c) {
                    ...
                    l(null != a, "Could not find store listing for sku"), a.sku.type === O.SKUTypes.SUBSCRIPTION_GROUP && await (0, E.fetchAllSubscriptionListingsDataForApplication)(t, a.id)
                }(null == (c = null != c ? c : M.default.get(n)) ? void 0 : c.type) === O.SKUTypes.SUBSCRIPTION && !(0, h.getSubscriptionPlansLoaded)([c.id]) && await (0, m.fetchSubscriptionPlansForSKU)(c.id);
                let {
                    enabled: g
        ...
        501076: function(e, t, n) {
            ...
            let x = (0, _.default)((0, E.default)(M));
            var L = i.default.connectStores(v, O)(x);
            let R = (0, E.default)(i.default.connectStores(v, O)(M))
        },
        ...
        627697: function(e, t, n) {
            ...
            function G(e) {
                ...
                } = (0, c.default)(d.default.ACTIVITY_BOOKMARK), H = (0, u.useAnalyticsContext)(), F = b.channel_id, w = (0, l.useStateFromStores)([_.default], () => _.default.getChannel(F), [F]), V = null == w ? void 0 : w.guild_id, Y = null != w && (w.isGuildVoice() || w.isPrivate()), K = (0, l.useStateFromStores)([S.default], () => S.default.getSelfEmbeddedActivityForChannel(F)), W = (null == K ? void 0 : K.application_id) === G, [z, Z] = (0, f.default)([G, null !== (n = null == K ? void 0 : K.application_id) && void 0 !== n ? n : ""]), J = (0, O.default)(null !== (i = null == z ? void 0 : z.maxParticipants) && void 0 !== i ? i : 0), [X] = (0, l.useStateFromStoresArray)([S.default], () => Y ? S.default.getEmbeddedActivitiesForChannel(F).filter(e => e.application_id === G) : [], [G, F, Y]), q = Array.from(null !== (C = null == X ? void 0 : X.connections.keys()) && void 0 !== C ? C : []), Q = (0, l.useStateFromStoresArray)([h.default], () => q.map(e => h.default.getUser(e)).filter(g.isNotNullish), [q]), $ = (0, x.default)({
                    applicationId: G,
                    size: U
                }), ee = m.default.getWindowOpen(D.PopoutWindowKeys.CHANNEL_CALL_POPOUT), et = Q.length > 0 ? y.default.Messages.JOIN : y.default.Messages.START, en = async () => {
                    if (Y) {
                        let {
                            activityConfigs: e,
                            applications: t
                        ...
                        if (null != X && Q.length > 0) await (0, M.default)({
                            ...
                            let e = w.isPrivate() && !E.default.isCallActive(F),
                                t = () => (0, v.default)({
                                    activityItem: n,
                                    currentActivity: Z,
                                    channelId: F,
                ...
                return null != z && (0, T.hasFlag)(z.flags, D.ApplicationFlags.EMBEDDED) ? (0, a.jsx)(k, {
        ...
        527088: function(e, t, n) {
            ...
            function N(e) {
                ...
                }), P = (0, i.default)([f.default], () => f.default.getCurrentUser()), [D, y] = s.useState(!1), j = s.useCallback(e => {
                    e && y(!0)
                ...
                }, [D, N, null == P ? void 0 : P.id, M.channel_id, R, M.author.id, x]), s.useEffect(() => {
                ...
                if (O) return (0, a.jsxs)(m.default, {
                    containerRef: U,
                ...
                if (null == v || x === I.FetchState.FETCHING) return (0, a.jsxs)(m.default, {
                    containerRef: U,
                    children: [(0, a.jsx)(m.default.Header, {
                ...
                let b = new Intl.NumberFormat(L, {
                    ...
                    B = b.format(null !== (n = null === (t = v.directory_entry) || void 0 === t ? void 0 : t.guild_count) && void 0 !== n ? n : 0);
        ...
        315176: function(e, t, n) {
            ...
            async function I(e, t) {
                ...
                let M = (0, i.getInventoryGuildPacksUserExperimentConfig)({
                    ...
                    O = Object.keys(v).filter(p).map(e => l.default.getUsableGuildEmoji(e)).flat().filter(e => null == E.default.getEmojiUnavailableReason({
                        emoji: e,
                        channel: t,
                        guildId: T,
        ...
        634388: function(e, t, n) {
            ...
            function M(e) {
                ...
                let [D, y] = s.useState(l), j = M && !(x && v) || D === T.GuildShopTab.GUILD_PRODUCTS_PREVIEW;
                return s.useEffect(() => {
                    y(l)
        ...
        3081: function(e, t, n) {
            ...
            function L(e) {
                ...
                } = (0, C.useExpandableTextContainer)(), P = (null !== (n = null == f ? void 0 : null === (t = f.description) || void 0 === t ? void 0 : t.trim().length) && void 0 !== n ? n : 0) > 0, [D, y] = s.useState(1), j = (0, u.default)("(max-width: ".concat(v.twoColumnWidth, ")")), {
                    selectedTab: U,
                    isPhantomPreview: G
                } = (0, A.useGuildShopDisplayContext)(), b = U === S.GuildShopTab.GUILD_PRODUCTS_PREVIEW ? M.default.Messages.GUILD_STORE_HERO_PREVIEW_TAB_DESCRIPTION : M.default.Messages.GUILD_STORE_HERO_PREVIEW_PAGE_DESCRIPTION, B = P ? (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsx)(R, {
                        lineClamp: j || 2 === D ? 2 : 3,
                        children: (0, a.jsx)(o.Text, {
                            variant: "text-sm/normal",
        ...
        649486: function(e, t, n) {
            ...
            function L(e) {
                let {
                    ...
                    onClose: n,
                    transitionState: a
                } = e, s = (0, m.useStateFromStores)([I.default], () => I.default.getCurrentUser()), r = (0, m.useStateFromStores)([h.default], () => h.default.theme), o = (0, m.useStateFromStores)([p.default], () => p.default.getFingerprint()), u = null == s || s.isClaimed(), [C, O] = i.useState(function() {
                    var e;
        ...
        492724: function(e, t, n) {
            ...
            function p(e) {
                ...
                return null == C ? (0, a.jsx)("article", {
                    className: l(E.productCard, S ? E.opaqueBackground : E.solidBackground),
                    "aria-labelledby": R,
                    children: P
                }) : (0, a.jsx)("div", {
                    style: {
                    ...
                    children: (0, a.jsx)(i.ClickableContainer, {
                        ...
                        className: l(E.productCard, S ? E.opaqueBackground : E.solidBackground, E.cardClickableContainer),
                        onClick: C,
                        children: P
                    })
                })
        ...
        858291: function(e, t, n) {
            ...
            function I(e) {
                ...
                } = e, x = (0, s.default)([o.default], () => o.default.getGuild(I), [I]), L = null == x ? void 0 : x.roles[null !== (t = null == n ? void 0 : n.role_id) && void 0 !== t ? t : ""], R = (0, l.useListingThumbnailUrl)(n, 600), P = (0, E.useProductType)(n), D = (0, d.useCanManageGuildProduct)(x), {
                ...
                let U = () => (0, h.openGuildProductInfoModal)({
                    ...
                    G = (0, a.jsx)(_.GuildProductListingPopout, {
                        product: n,
                        guildId: I,
                        showEditProduct: D,
        ...
        477558: function(e, t, n) {
            ...
            function I(e) {
                ...
                return s.useEffect(() => {
                    m.default.getGuildEventUserCounts(n, I, null != T ? [T] : []), m.default.getGuildEventsForCurrentUser(n)
                }, [I, n, T]), (0, a.jsx)(h.default, {
                    guild: C,
                    channel: A,
                    guildScheduledEvent: g,
                    isMember: S,
        ...
        801177: function(e, t, n) {
            ...
            function B(e) {
                ...
                let {
                    ...
                    setPopout: F
                } = (0, g.default)(B.id, j.DEFAULT_POPOUTS), w = (0, T.useContextMenuMessage)(B, k, F, !0), V = S.GifAutoPlay.useSetting(), Y = (0, R.useIsWindowFocused)(), [K, W] = s.useState(!1), [z, Z] = s.useState((null == H ? void 0 : H.coverImage) == null), J = (0, c.default)([m.default], () => m.default.useReducedMotion), X = (0, c.default)([N.default, M.default], () => {
                    var e;
                    ...
                    null != H && ((0, E.trackWithMetadata)(y.AnalyticEvents.MEDIA_POST_PREVIEW_EMBED_CLICKED, {
                        ...
                        children: [(0, a.jsxs)("div", {
                            ...
                            children: [null != er && (0, a.jsx)(f.Popout, {
                                ...
                                children: [(0, a.jsxs)("div", {
                                    ...
                                    children: [null != H.channelName && (0, a.jsx)(O.default, {
            ...
            var a = n("37983"),
                ...
                L = s.memo(function(e) {
                    ...
                    let {
                        ...
                        ...H
                    } = e, F = s.isFirstMessageInForumPost(j), w = (0, u.useShowImprovedMarkdownUserExperimentConfig)((null !== (t = s.editedTimestamp) && void 0 !== t ? t : s.timestamp).valueOf()), V = (0, u.useShowImprovedMarkdownGuildExperimentConfig)(j.guild_id, (null !== (n = s.editedTimestamp) && void 0 !== n ? n : s.timestamp).valueOf()), {
                        content: Y,
                        hasSpoilerEmbeds: K
                    } = (0, T.default)(s, {
                    ...
                    }), W = s.type === O.MessageTypes.REPLY ? s.messageReference : void 0, z = (0, o.useStateFromStores)([c.default], () => c.default.getMessageByReference(W)), Z = (0, r.useListItem)(s.id), J = (0, p.default)(s), X = (0, o.useStateFromStores)([f.default], () => s.hasFlag(O.MessageFlags.HAS_THREAD) && f.default.getChannel(s.id)), q = (0, d.useRoleIcon)({
                        guildId: j.guild_id,
                        roleId: J.iconRoleId
                    }), Q = (0, o.useStateFromStores)([m.default], () => m.default.can(O.Permissions.CREATE_INSTANT_INVITE, j)), $ = (0, g.default)({
                        message: s,
                        channel: j,
                        enabled: k
                    });
                    ...
                    return (0, a.jsx)(E.default, {
                        compact: l,
                        className: i(L, {
                            [x.ephemeral]: (0, _.hasFlag)(s.flags, O.MessageFlags.EPHEMERAL),
                        ...
                        onContextMenu: R,
                        onClick: P,
                        hasThread: B && null != X && s.hasFlag(O.MessageFlags.HAS_THREAD),
                        hasReply: s.type === O.MessageTypes.REPLY,
                        "aria-labelledby": ee,
                        "aria-describedby": et,
                        messageRef: $,
                        ...Z,
        ...
        808440: function(e, t, n) {
            ...
            function O(e) {
                ...
                let R = null != x ? x : {
                    ...
                    y = (0, l.useStateFromStores)([E.default], () => E.default.getId()),
        ...
        723931: function(e, t, n) {
                ...
                return (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)("img", {
                        ...
                        children: eA.default.Messages.LARGE_FILE_UPLOAD_POWERED_BY_NITRO.format({
                            onClick: () => (0, G.navigateToPremiumMarketingPage)()
                        })
                    })]
                })
            }
            let ev = new Set([eg.MessageEmbedTypes.AUTO_MODERATION_MESSAGE, eg.MessageEmbedTypes.AUTO_MODERATION_NOTIFICATION, eg.MessageEmbedTypes.APPLICATION_NEWS, eg.MessageEmbedTypes.POST_PREVIEW, eg.MessageEmbedTypes.SAFETY_POLICY_NOTICE]),
            ...
            class eR extends s.Component {
                ...
                renderCodedLinks(e) {
                    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
                        ...
                        if (n === g.CodedLinkType.INVITE) return this.shouldRenderInvite(s) ? (0, a.jsx)(eE.default, {
                            code: s,
                            author: e.author,
                            getAcceptInviteContext: this.getAcceptInviteContext
                        }, s) : null;
                        if (n === g.CodedLinkType.TEMPLATE) return (0, a.jsx)(x.default, {
                            code: s
                        }, s);
                        if (n === g.CodedLinkType.EVENT) return (0, a.jsx)(O.default, {
                            code: s
                        }, s);
                        else if (n === g.CodedLinkType.CHANNEL_LINK) return (0, a.jsx)(ef.default, {
                            code: s,
                            messageData: e
                        }, s);
                        else if (n === g.CodedLinkType.APP_DIRECTORY_PROFILE) return (0, a.jsx)(h.default, {
                            code: s,
                            message: e
                        }, s);
                        else if (n === g.CodedLinkType.CLYDE_PROFILE) return (0, a.jsx)(T.default, {
                            code: s
                        }, s);
                        else if (n === g.CodedLinkType.ACTIVITY_BOOKMARK) return (0, a.jsx)(_.default, {
                            applicationId: s,
                            message: e
                        }, s);
                        else if (n === g.CodedLinkType.GUILD_PRODUCT) return (0, a.jsx)(v.default, {
                            code: s
                        }, s);
                        else if (n === g.CodedLinkType.SERVER_SHOP) return (0, a.jsx)(C.default, {
                            guildId: s
                        }, s);
                ...
                renderReactions(e) {
                    ...
                    return n ? null : (0, a.jsx)(eT.default, {
                        message: e,
                        channel: o,
                        disableReactionCreates: t,
                        disableReactionUpdates: s,
                ...
                renderAttachments(e) {
                    ...
                    let i = t.filter(e => null == e.flags || !(0, es.hasFlag)(e.flags, eg.MessageAttachmentFlags.IS_THUMBNAIL)),
                        {
                            gifAutoPlay: r,
                        ...
                        _ = (0, es.hasFlag)(n, eg.MessageFlags.IS_VOICE_MESSAGE),
                        h = i.map(t => {
                            let n = {
                                    message: e,
                                    attachment: t,
                                    ...
                                    onPlay: (e, n, a) => {
                                        en.default.track(eg.AnalyticEvents.MEDIA_ATTACHMENT_PLAYBACK_STARTED, {
                                            guild_id: s.guild_id,
                                            channel_id: s.id,
                                            channel_type: s.type,
                                            type: t.content_type,
                ...
                renderPublishBump(e) {
                    ...
                    return t.type !== eg.ChannelTypes.GUILD_ANNOUNCEMENT || (0, es.hasFlag)(e.flags, eg.MessageFlags.EPHEMERAL) ? null : (0, a.jsx)(I.default, {
                        channelId: e.channel_id,
                        messageId: e.id
                    })
                }
                renderEphemeralAccessories(e) {
                    return (0, es.hasFlag)(e.flags, eg.MessageFlags.EPHEMERAL) ? (0, a.jsx)($.default, {
                        message: e,
                        onDeleteMessage: () => {
                ...
                renderThreadAccessories(e) {
                    if (e.hasFlag(eg.MessageFlags.HAS_THREAD) && !1 !== this.props.renderThreadAccessory) return (0, a.jsx)(w.default, {
                        message: e,
                        compact: this.props.compact
                    })
                }
                renderThreadRoleMentionWarning(e) {
                    if (!e.hasFlag(eg.MessageFlags.FAILED_TO_MENTION_SOME_ROLES_IN_THREAD) || !this.props.isCurrentUser) return;
                ...
                renderMediaPostEmbeds(e) {
                    return e.embeds.flatMap(t => t.type !== eg.MessageEmbedTypes.POST_PREVIEW || null == t.url ? [] : (0, a.jsx)(y.default, {
                        embedUrl: t.url,
                        message: e,
                ...
                renderSafetyPolicyNotice(e) {
                    return 1 === e.embeds.length && e.embeds[0].type === eg.MessageEmbedTypes.SAFETY_POLICY_NOTICE ? (0, a.jsx)(B.SafetyPolicyNotice, {
                        message: e
                    }) : null
                }
                ...
                render() {
                    ...
                    return null == r && null == d && null == f && null == m && null == E && null == o && null == u && null == _ && null == h && null == p && null == I && null == T && null == g && null == A && null == S && null != C && null == M ? null : (0, a.jsxs)("div", {
                        id: (0, e_.getMessageAccessoriesId)(t),
                        className: i(e, eS.container),
                        children: [g, M, r, o, u, A, d, f, N, m, p, T, C, c, E, _, h, s && this.renderSuppressConfirmModal(), l && this.renderRemoveAttachmentConfirmModal(), I, S]
                    })
                }
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        return e.type === eg.MessageEmbedTypes.GIFT ? null : (0, a.jsx)(q.GIFAccessoryContext.Provider, {
                    ...
                    }, this.renderEmbedTitle = (e, t) => e.type === eg.MessageEmbedTypes.RICH ? P.default.parseEmbedTitle(t, !0, {
                        channelId: this.props.channel.id
                    }) : t, this.renderEmbedDescription = (e, t, n) => e.type === eg.MessageEmbedTypes.RICH ? P.default.parse(t, !0, {
                        channelId: this.props.channel.id,
                        allowLinks: !0,
                        allowEmojiLinks: !0,
            ...
            function eP(e) {
                ...
                let {
                ...
                } = e, u = (0, o.useStateFromStores)([Y.default], () => Y.default.getId()), d = V.InlineAttachmentMedia.useSetting(), c = V.InlineEmbedMedia.useSetting(), f = V.RenderEmbeds.useSetting(), m = f && !(0, ed.default)(e.message), E = V.RenderReactions.useSetting(), _ = V.GifAutoPlay.useSetting(), h = (0, o.useStateFromStores)([W.default], () => null == l.guild_id || W.default.canChatInGuild(l.guild_id), [l]), I = (0, o.useStateFromStores)([R.default], () => null != l.guild_id && R.default.isLurking(l.guild_id), [l]), T = (0, o.useStateFromStores)([K.default], () => K.default.isCurrentUserGuest(l.guild_id), [l]), g = (0, o.useStateFromStores)([K.default, Z.default], () => {
                    var e, t;
                    ...
                    canAddNewReactions: h && z.default.can(eg.Permissions.ADD_REACTIONS, l),
                    canManageMessages: z.default.can(eg.Permissions.MANAGE_MESSAGES, l)
                }), [h, l]), [, N] = (0, M.useCurrentUserCommunicationDisabled)(l.guild_id), v = (0, F.useIsActiveChannelOrUnarchivableThread)(l), O = (u === i.author.id || A) && i.author.id !== eg.LOCAL_BOT_ID && !i.author.isClyde() && !1 !== r && !(0, es.hasFlag)(i.flags, eg.MessageFlags.EPHEMERAL) && v, x = u === i.author.id && v, L = i.author.id === u, P = i.isFirstMessageInForumPost(l), y = (0, ec.default)({
                    channel: l,
                    canChat: h,
                    renderReactions: E,
                    canAddNewReactions: C,
                ...
                }), U = (0, p.useShowImprovedMarkdownUserExperimentConfig)((null !== (t = i.editedTimestamp) && void 0 !== t ? t : i.timestamp).valueOf()), G = (0, p.useShowImprovedMarkdownGuildExperimentConfig)(null !== (n = l.guild_id) && void 0 !== n ? n : "", (null !== (s = i.editedTimestamp) && void 0 !== s ? s : i.timestamp).valueOf()), b = (0, D.default)(null == l ? void 0 : l.id), B = (0, j.default)(i), k = (0, S.useShouldRedactExplicitContent)(l.id, i.author.id);
                return (0, a.jsx)(eR, {
                    canSuppressEmbeds: O,
                    canDeleteAttachments: x,
                    ...y,
                    disableReactionReads: !!P || y.disableReactionReads,
                    ...e,
                    isLurking: I && h,
                    isGuest: T && h,
                    isPendingMember: g && h,
                    ...
                    poll: B,
                    showListsAndHeaders: U.showListsAndHeaders || G.showListsAndHeaders,
                    showMaskedLinks: U.showMaskedLinks || G.showMaskedLinks,
            ...
            class S extends s.PureComponent {
                ...
                render() {
                    ...
                    return y || C ? (0, a.jsxs)(o.default, {
                        ...
                        children: [(0, a.jsx)(_.MessageReactionsGroupWrapper, {
                        ...
                        }), !t && !x && (0, a.jsx)(m.ButtonAddReaction, {
                            ...
                            hasBurstTabUI: M,
                            hasTwoButtonBurstUI: v
                        }), !t && N && v && !x && (0, a.jsx)(m.ButtonAddReaction, {
        ...
        621698: function(e, t, n) {
            ...
            let h = s.memo(function(e) {
                    let t, n, {
                        ...
                        x = (0, m.isMeReaction)(I, T, v),
                        L = (0, d.useEmojiColorPalette)(O && null != C ? C : []),
                        R = s ? _ : E,
                        P = O ? g : p,
                        D = (0, c.getMinCounterWidth)(P, m.REACTION_MIN_WIDTH_DIGITS),
                        y = {};
                    if (O && null != L) {
                        var j;
                        let {
                        ...
                        x && (y.borderColor = a), y.background = l, t = e, n = e
                    }
                    let U = {
                        minWidth: D,
                        color: t,
            ...
            let eM = Object.freeze({
                ...
                [eT.MessageTypes.GUILD_STREAM]: function(e) {
                    let {
                        ...
                        messageReference: u
                    } = t, c = t.getChannelId(), f = (0, l.useStateFromStores)([G.default], () => G.default.findActivity(o, e => e.type === eT.ActivityTypes.PLAYING), [o]), m = (0, l.useStateFromStores)([y.default], () => null != u ? y.default.getChannel(u.channel_id) : null, [u]), E = null == u ? void 0 : u.guild_id, _ = (0, eI.useUsernameHook)(r, c, i.guild_id), h = s.useCallback(() => {
                ...
                [eT.MessageTypes.GUILD_DISCOVERY_DISQUALIFIED]: function(e) {
                    let {
                        message: t,
                        compact: n
                    } = e, s = t.getChannelId(), i = (0, l.useStateFromStores)([y.default], () => y.default.getChannel(s), [s]), r = null != i ? i.getGuildId() : null;
                ...
                [eT.MessageTypes.THREAD_CREATED]: function(e) {
                    let {
                        ...
                        if (null != a) {
                            await x.default.loadThread(a);
                            let t = y.default.getChannel(a);
                        ...
                        var s;
                        let l = y.default.getChannel(null === (s = t.messageReference) || void 0 === s ? void 0 : s.channel_id);
                ...
                [eT.MessageTypes.AUTO_MODERATION_ACTION]: function(e) {
                    ...
                    return (0, h.isAutomodMessageRecord)(t) ? (0, a.jsx)(w.default, {
                        message: t,
                        compact: n,
                        channel: s
                    }) : null
        ...
        380986: function(e, t, n) {
            ...
            function y(e, t, l, r) {
                let {
                    ...
                    id: m,
                    flags: E
                } = e, _ = (0, h.hasFlag)(E, A.MessageFlags.EPHEMERAL), I = (0, g.default)(e), T = (0, u.useAppContext)();
        ...
        430625: function(e, t, n) {
            ...
            let j = (0, x.cssValueToNumber)(d.default.EMBEDDED_APPLICATION_INVITE_IMAGE_WIDTH_LARGE),
                ...
                G = (0, x.cssValueToNumber)(d.default.EMBEDDED_APPLICATION_INVITE_CONTENT_WIDTH);
            ...
            function k(e) {
                ...
                return (ea && Z && (l = D.default.Messages.EMBEDDED_ACTIVITIES_ALREADY_IN_ACTIVITY), !q && (l = D.default.Messages.EMBEDDED_ACTIVITIES_INVALID_PERMISSIONS), r = Z ? D.default.Messages.INVITE_EMBED_JOINED : J || !ea ? D.default.Messages.JOIN : D.default.Messages.START, null == d.code || "" === d.code) ? null : (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)("div", {
                        ...
                        children: [(0, a.jsxs)("div", {
                            ...
                            children: [(0, a.jsx)(c.FormTitle, {
                                children: ea ? D.default.Messages.EMBEDDED_ACTIVITIES_EMBED_TITLE_INVITED_TO_JOIN : D.default.Messages.INVITE_BUTTON_TITLE_INVITED
                            }), (0, a.jsx)(c.Heading, {
                                className: y.heading,
                                variant: "heading-xl/semibold",
        ...
        783940: function(e, t, n) {
            ...
            function h(e) {
                ...
                let O = E.default.Messages.INVITE_BUTTON_TITLE_INVITED_GROUP_DM;
                return T && (O = E.default.Messages.INVITE_BUTTON_TITLE_INVITER_GROUP_DM), (0, a.jsxs)(d.default, {
                ...
                return g = (0, a.jsxs)("span", {
                    ...
                    children: [(0, a.jsx)(o.default.GuildSplash, {
                        ...
                        children: [(0, a.jsxs)("div", {
                            ...
                            children: G ? b ? h.default.Messages.STAGE_CHANNEL_JOIN : h.default.Messages.INVITE_VOICE_CHANNEL_JOIN : j ? h.default.Messages.JOINED_GUILD : h.default.Messages.JOIN_GUILD
                        })]
        ...
        158783: function(e, t, n) {
            ...
            function p(e) {
                ...
                l(x === E.InviteTargetTypes.STREAM && null != L, "invalid streaming invite");
                let R = I === L.id,
                ...
                let y = null != p.channel ? (0, r.createChannelRecordFromInvite)(p.channel) : null,
                    j = v ? g : C;
                D && !O ? s = R ? _.default.Messages.INVITE_BUTTON_STREAM_ENDED_STREAMER : _.default.Messages.INVITE_BUTTON_STREAM_ENDED.format({
                    name: L.username
                ...
                let U = S === T.id && null != y ? (0, a.jsx)(c.default.Channel, {
                    channel: y
        ...
        905206: function(e, t, n) {
            ...
            function T(e, t, n) {
                ...
                if (null == M || !t) return;
                let v = o.default.getCurrentUser();
                if (null == v) return;
                let O = e.state === _.MessageStates.SENT,
                    x = null === (g = r.default.getChannel(e.getChannelId())) || void 0 === g ? void 0 : null === (T = g.getGuildId) || void 0 === T ? void 0 : T.call(g),
                    L = (0, f.getAvatarUrl)(v, x),
                    R = O ? null != N ? N : (0, E.formatExpirationLabel)(M.expiry) : "",
                    P = null == R && O,
                    {
                        selectedAnswerIds: D,
                        submitting: y
                    } = null !== (C = null != n ? n : (0, c.getPollState)(e.getChannelId(), e.id)) && void 0 !== C ? C : p,
                    j = M.answers,
                    U = M.layout_type,
                    G = e.reactions.reduce((e, t) => {
                        var n, a;
                        return e + (null !== (a = null === (n = t.count_details) || void 0 === n ? void 0 : n.vote) && void 0 !== a ? a : 0)
                    }, 0),
                    b = 1 / j.length,
                    B = D.size > 0,
                    k = e.reactions.some(e => !0 === e.me_vote),
                    H = k && B,
                    F = !H && k,
                    w = j.map(t => {
                        var n, r, o;
                        let c = "".concat(t.answer_id),
                            ...
                            _ = D.has(c),
                            p = P ? E >= b : void 0,
                            T = F && null !== (o = null == f ? void 0 : f.me_vote) && void 0 !== o && o,
                            g = I({
                                didSelfVote: T,
                                hasVoted: F,
                                isExpired: P,
                        ...
                        return {
                            ...
                            votes: (0, a.match)(U).with(s.PollLayoutTypes.IMAGE_ONLY_ANSWERS, () => "(".concat(m, ")")).otherwise(() => h.default.Messages.POLL_VOTES_COUNT.format({
                                count: m
                            }))
                        }
                    }),
                    ...
                    K = (0, a.match)({
                        ...
                        hasVoted: !0
                    }, () => h.default.Messages.POLL_ALREADY_VOTED).with({
                        canSubmitVote: !0,
                        isEditingVote: !0
                    }, () => h.default.Messages.POLL_SUBMIT_VOTE_EDIT).with({
                        canSubmitVote: !0
                    }, () => h.default.Messages.POLL_SUBMIT_VOTE).otherwise(() => h.default.Messages.POLL_CHOOSE_SINGLE_ANSWER_PROMPT),
                    W = "normal";
        ...
        426490: function(e, t, n) {
            ...
            function _(e) {
                let {
                    ...
                    channelId: u,
                    messageId: d
                } = (0, m.useMessageIds)(), c = s.useCallback(() => {
            ...
            function h(e) {
                ...
                return (0, a.jsx)(c.default, {
                    ...
                    alt: l,
                    responsive: !0,
                    width: null !== (t = s.width) && void 0 !== t ? t : 1,
                    height: null !== (n = s.height) && void 0 !== n ? n : 1
                })
            }
            ...
            function p(e) {
                let {
                    ...
                    var e, t;
                    return null === (e = d.default.getCustomEmojiById(null !== (t = null == s ? void 0 : s.id) && void 0 !== t ? t : "")) || void 0 === e ? void 0 : e.animated
                }, [s.id]);
                return (0, a.jsx)(u.default, {
                    className: n,
            ...
            function T(e) {
                ...
                let {
                    ...
                    message: d
                } = (0, m.usePollContext)(), c = null !== (t = null != u ? u : n.text) && void 0 !== t ? t : "";
                if (n.attachmentIds.length > 0) {
                    let e = d.attachments.find(e => e.id === n.attachmentIds[0]);
                    if (null != e) return I(l, (0, a.jsx)(h, {
                        className: s,
                        attachment: e,
                        alt: c
                    }))
                }
                return null != n.emoji ? I(l, (0, a.jsx)(p, {
                    className: i(s, r),
                    emoji: n.emoji,
                    alt: c
                })) : void 0 !== o ? (0, a.jsx)(a.Fragment, {
                    children: o
                }) : null
            }
        },
        619544: function(e, t, n) {
            ...
            function f(e) {
                ...
                return (0, a.jsxs)("div", {
                    ...
                    children: [null != s && (0, a.jsx)(i.Avatar, {
            ...
            function m(e) {
                let {
                    ...
                    disabled: s,
                    myAvatarUrl: i
                } = e, m = (0, o.useStyleClass)(t.style);
                return (0, a.jsxs)(r.PollAnswerClickable, {
                    className: l(m, d.answer),
                    answer: t,
                    disabled: s,
                    children: [(0, a.jsx)(r.PollMediaView, {
                        className: d.media,
        ...
        909366: function(e, t, n) {
            ...
            function f(e) {
                let {
                    ...
                    myAvatarUrl: s,
                    disabled: f
                } = e, m = !0 === t.isSelected, E = (0, o.useStyleClass)(t.style);
                return (0, a.jsx)(r.PollAnswerClickable, {
                    answer: t,
                    disabled: f,
                    children: (0, a.jsxs)("div", {
                        className: l(d.answer, E),
                        children: [n && (0, a.jsx)("span", {
                            ...
                            }), (m || t.didSelfVote) && (0, a.jsx)(i.Avatar, {
                                className: d.avatarForSelected,
        ...
        428786: function(e, t, n) {
            ...
            class O extends s.Component {
                ...
                renderActions(e, t, n) {
                    ...
                    }, o = l.id !== s.user_id || (0, T.isPremium)(l) || !l.verified || (0, S.hasUserTrialOfferExpired)(s), u = this.renderExpirationDate(e, t, n);
            ...
            class C extends r.default {
                ...
                constructor(...e) {
                    super(...e), this._premiumPaymentModalCloseResolve = null, this._premiumPaymentModalCloseReject = null, this._maybeFetchPremiumOffer = () => {
                        ...
                        t && null != e && e.verified && (0, m.isPremiumExactly)(e, g.PremiumTypes.TIER_2) && E.default.checkAndFetchReferralsRemaining()
                    ...
                    children: [(0, l.jsx)("nav", {
                        ...
                        children: (0, l.jsxs)("div", {
                            ...
                            children: [(0, l.jsx)(u.Button, {
                                ...
                                "aria-selected": !v,
                                onClick: () => {
                                    (0, E.toggleBurstReactionPicker)(!0), c.default.trackWithMetadata(g.AnalyticEvents.REACTION_PICKER_TAB_CLICKED, {
        ...
        139185: function(e, t, n) {
            ...
            var a = n("37983"),
                ...
                j = n("347826"),
                U = n("154403");
            let G = (e, t) => t ? y.default.Messages.STICKER_POPOUT_PACK_INFO_PREMIUM.format({
            ...
            let H = e => {
                    ...
                    } = e, [u, c, f] = (0, r.useStateFromStoresArray)([O.default], () => [O.default.getStickerPack(n.pack_id), !O.default.hasLoadedStickerPacks, O.default.isPremiumPack(n.pack_id)], [n]), m = b({
                        sticker: n,
                        stickerPack: u
                    });
                ...
                F = e => {
                    let t, {
                        ...
                        G = (0, r.useStateFromStores)([T.default], () => T.default.getGuild(n.guild_id)),
                        b = null != G,
                        [H, F] = s.useState(!1),
                        [w, V] = s.useState(null),
                        Y = s.useMemo(() => ({
                    ...
                    s.useEffect(() => {
                        let e = async () => {
                            let e = null == G || G.hasFeature(P.GuildFeatures.DISCOVERABLE);
                            if (e) {
                    ...
                    return (s.useEffect(() => {
                        ...
                        children: [(() => {
                            ...
                            let t = (null !== (e = null == p ? void 0 : p.stickers) && void 0 !== e ? e : []).slice(0, 13).filter(e => e.id !== n.id).slice(0, 12),
                                s = null != p ? c.default.createFromDiscoverableGuild(p) : c.default.createFromGuildRecord(G);
                            return (0, a.jsxs)("div", {
                                className: U.guildSection,
                                children: [(0, a.jsx)(o.FormTitle, {
                                    className: U.guildTitle,
                                    children: b ? y.default.Messages.STICKER_POPOUT_JOINED_GUILD_EMOJI_DESCRIPTION : y.default.Messages.STICKER_POPOUT_UNJOINED_GUILD_EMOJI_DESCRIPTION
            ...
            var V = e => {
                ...
                if (null != i && (0, x.isStandardSticker)(i)) return (0, a.jsx)(H, {
                    sticker: i,
                    closePopout: s,
                    channel: n,
                    refreshPositionKey: l
                });
                if (null != i && (0, x.isGuildSticker)(i)) return (0, a.jsx)(F, {
                    sticker: i,
                    channel: n,
                    closePopout: s,
                    refreshPositionKey: l
                ...
                else if (r && null == i) return (0, a.jsx)(w, {
                    channel: n,
                    closePopout: s,
                    sticker: t
                });
                    ...
                    O = function(e, t) {
                        ...
                        return (0, a.jsx)(c.Popout, {
                            ...
                            children: e => {
                                ...
                                return s.type === T.MessageTypes.CHAT_INPUT_COMMAND ? (0, a.jsx)(c.Clickable, {
                                    ...n,
                                    tag: "span",
                                    onClick: l,
                                    children: (0, a.jsx)("div", {
        ...
        927632: function(e, t, n) {
            ...
            var M = s.memo(function(e) {
                ...
                if (s.useEffect(() => {
                    ...
                    }, [x.id, L, R]), null == R) O = (0, a.jsx)(o.Spinner, {
                    ...
                    for (let n of null !== (M = R.options) && void 0 !== M ? M : []) e = e.concat(function e(t, n, l, i, r) {
                        ...
                        if (null != t.value) switch (t.type) {
                            ...
                            case u.ApplicationCommandOptionType.MENTIONABLE: {
                                ...
                                if (null != s) x = (0, a.jsxs)(p.default, {
                        ...
                        return null == x && (x = N(null == R ? void 0 : R.toString())), [(0, a.jsxs)(s.Fragment, {
        ...
        994402: function(e, t, n) {
            ...
            function R(e, t) {
                ...
                if (null != t && x.test(n) && null != e.url) return "AUDIO";
            ...
            let P = e => {
                    ...
                    return (null != s && null != l && (t = (0, a.jsx)(r.Tooltip, {
                        ...
                        children: e => (0, a.jsx)(r.Clickable, {
                            ...e,
                            className: i(O.hoverButton, O.removeAttachmentHoverButton),
                            focusProps: {
                                offset: 2
                            },
                            onClick: o,
                        ...
                        className: i(O.hoverButtonGroup, {
                            [O.nonMediaAttachment]: !u
                        }),
                        children: [t, n]
                    })
                },
                D = e => {
                    let {
                        ...
                        description: Y,
                        spoiler: K
                    } = n, W = R(n, l), [z, Z] = s.useState(!1), J = (0, u.default)(t.getChannelId()), {
                        enabled: X
                    } = m.default.useExperiment({
                        location: "MessageAttachment"
                    }, {
                        autoTrackExposure: !1
                    }), q = s.useMemo(() => null != n.content_type && -1 !== n.content_type.indexOf("/") ? n.content_type.split("/") : ["unknown", "unknown"], [n.content_type]), Q = s.useCallback(() => {
                        d(n)
                    }, [n, d]), $ = s.useCallback((e, a, s) => {
                    ...
                    }, [t, n.duration_secs, h]), ee = s.useCallback((e, a) => {
                        var s;
                    ...
                    }, [t, n.duration_secs]), et = s.useCallback(e => {
                        var n;
                        ...
                        if (b === N.MediaLayoutType.MOSAIC) {
                            ...
                            if (F) {
                                ...
                                if (!H && (e * w < N.MINIMUM_MEDIA_MOSAIC_DIM || e * V < N.MINIMUM_MEDIA_MOSAIC_DIM)) return null
                            }
                            return !z && (0, a.jsx)(P, {
                        ...
                        return o && (0, a.jsx)(r.Clickable, {
                            className: K ? O.spoilerRemoveAttachmentButton : O.removeAttachmentButton,
                            focusProps: {
                                offset: {
                                    bottom: 4
                                }
                    ...
                    }, [b, o, K, W, F, z, n, q, Q, w, V, H, d, J]), ea = s.useCallback(() => {
                        var e;
                        return (0, A.hasFlag)(null !== (e = n.flags) && void 0 !== e ? e : 0, M.MessageAttachmentFlags.IS_CLIP) ? (0, a.jsxs)(r.TooltipContainer, {
                            ...
                            children: [(0, a.jsx)(T.default, {}), (0, a.jsx)(r.Text, {
                                variant: "text-xs/semibold",
                                color: "always-white",
            ...
            var y = e => {
                ...
                let {
                    ...
                    width: h,
                    height: I
                } = l, T = (0, o.useShouldRedactExplicitContent)(r.channel_id, r.author.id), g = (0, c.getObscureReason)(l, T), [C, A] = s.useState(void 0 !== g), M = f === N.MediaLayoutType.MOSAIC, v = !M && (null != h && h < 200 || null != I && I < 50), x = R(l, u);
                let P = "IMAGE" === (t = x) || "VIDEO" === t,
                    y = L(R(l, u)),
                    j = function() {
                        ...
                        return (0, a.jsx)(D, {
                            ...
                            hiddenSpoilers: e,
                            canRemoveAttachment: m,
                            className: i(n, O.attachmentContentItem, {
                                [O.obscured]: C && !v,
                                [O.hiddenSpoiler]: C && g === c.ObscureReason.SPOILER,
                                [O.hiddenExplicit]: C && null != g && [c.ObscureReason.EXPLICIT_CONTENT, c.ObscureReason.POTENTIAL_EXPLICIT_CONTENT].includes(g),
                                [O.hiddenAttachment]: C && e,
                                [O.inline]: C && v
                            }),
                            focusable: !e,
                            mediaLayoutType: f,
                            useFullWidth: d,
                            isAttachmentMediaType: y
                        })
                    };
                return (0, a.jsx)("div", {
                    className: i(O.messageAttachment, {
                        [O.messageAttachmentNoJustify]: P,
                        [O.messageAttachmentFullWidth]: d,
                        [O.messageAttachmentMediaMosaic]: M,
                        [O.hideOverflow]: M && y
                    }),
                    children: null != g ? (0, a.jsx)(p.default, {
        ...
        377502: function(e, t, n) {
            ...
            var a = n("37983"),
                ...
                c = n("719347"),
                f = n("655793");
            let m = Math.round((c.MEDIA_MOSAIC_MAX_WIDTH - 8) / 3),
                E = Math.round((c.MEDIA_MOSAIC_MAX_WIDTH - 4) / 2),
                ...
                I = e => {
                    ...
                    if (1 === s) return (0, a.jsx)(T, {
                        attachmentsForLayout: t,
                        getAttachmentKind: n,
                        isSingleImage: !0
                    });
                    if (2 === s) return (0, a.jsx)(g, {
                        attachmentsForLayout: t,
                        getAttachmentKind: n
                    });
                    if (3 === s) return (0, a.jsx)(C, {
                        attachmentsForLayout: t,
                        getAttachmentKind: n
                    });
                    if (4 === s) return (0, a.jsx)(A, {
                        attachmentsForLayout: t,
                        getAttachmentKind: n
                    });
                    let l = s % 3;
                    return (0, a.jsxs)(a.Fragment, {
                        children: [1 === l && (0, a.jsx)(T, {
                ...
                T = e => {
                    ...
                    return (0, a.jsx)("div", {
                        className: i(f.oneByOneGrid, s ? f.oneByOneGridSingle : f.oneByOneGridMosaic),
                        children: (0, a.jsx)(v, {
                            props: l,
                ...
                v = e => {
                    let {
                        props: t,
                        attachmentKind: n,
                        maxWidth: s = c.MEDIA_MOSAIC_MAX_WIDTH,
                    ...
                    return (0, a.jsx)(u.GIFAccessoryContext.Provider, {
            ...
            var O = e => {
                let {
                    attachments: t
                } = e, n = s.useMemo(() => new Map(t.map(e => [e.attachment.id, (0, d.getAttachmentKind)(e.attachment, e.inlineMedia)])), [t]), l = s.useCallback(e => {
                    var t;
                    return null !== (t = n.get(e)) && void 0 !== t ? t : "INVALID"
                }, [n]), [i, r] = s.useMemo(() => o.partition(t, e => (0, d.isMediaAttachment)(l(e.attachment.id))), [t, l]);
                return (0, a.jsxs)(a.Fragment, {
                    children: [i.length > 0 && (0, a.jsx)("div", {
        ...
        292200: function(e, t, n) {
            ...
            function Z(e) {
                let {
                    ...
                    handleFocus: U,
                    handleBlur: K
                } = (0, C.useFocusInside)(O), W = (0, c.useStateFromStores)([m.default], () => m.default.keyboardModeEnabled), Z = (0, c.useStateFromStores)([S.default], () => S.default.can(b.Permissions.MANAGE_MESSAGES, r), [r]), {
                    ruleName: J,
                    embedChannel: X,
                    decisionId: q,
                    ...
                    null != et && null != X && (e.stopPropagation(), e.preventDefault(), (0, I.default)(b.Routes.CHANNEL(null == X ? void 0 : X.guild_id, null == X ? void 0 : X.id, et)))
                ...
                return (0, a.jsx)("div", {
                    ...
                    children: (0, a.jsx)(y.default, {
                        ...
                        iconNode: n ? null : (0, a.jsx)(G.AutomodAvatar, {
                            src: o
                        }),
                        ...
                        children: (0, a.jsxs)("div", {
                            ...
                            children: [(0, a.jsx)(D.BaseMessageHeader, {
                                message: l,
        ...
        119715: function(e, t, n) {
            ...
            function P(e) {
                ...
                } = (0, E.useGuildIncidentsState)(D), U = (0, T.useContextMenuRaidAlert)(l.author.id, l.channel_id), G = s.useCallback(() => {
                    let e = null == P ? void 0 : P.guild_id;
                    null != e && (0, I.openRaidResolveModal)(l.id, e)
                }, [l.id, P]), b = O === m.AutomodRaidAlertTypes.DM_RAID;
                return (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsxs)("div", {
            ...
            function D(e) {
                ...
                return (0, a.jsx)("div", {
                    ...
                    children: (0, a.jsx)(v.default, {
                        ...
                        iconNode: n ? null : (0, a.jsx)(O.AutomodAvatar, {
                            src: r
                        }),
        ...
        703712: function(e, t, n) {
            ...
            function H(e) {
                ...
                }(a, i), T = R.includes(i), g = T && "exit" === a, A = o.useCallback(e => {
                    l(e)
                }, []), S = o.useCallback(() => {
                    "exit" === a && t()
            ...
            function F(e) {
                let t, {
                    ...
                    P = R.nick,
                    D = l(R);
                t = null == u || null == s ? d > 1 ? O.default.Messages.SYSTEM_MESSAGE_GUILD_MEMBER_SUBSCRIBED_MANY_HOOK.format({
                    username: P,
                    usernameHook: D,
                    numSubscriptions: d
                ...
                stringify: function(e, t) {
                    ...
                    switch (e.type) {
                        ...
                        case p.MessageTypes.RECIPIENT_REMOVE:
                            if (null == M) return;
                            let x = e.author;
                            if (null == x || x.id === M.id) return (0, a.astToString)(I.default.Messages.SYSTEM_MESSAGE_RECIPIENT_REMOVE_SELF.astFormat({
                                username: O,
                                usernameOnClick: p.NOOP
                            }));

    ...
    ["71526"], {
            ...
            function i(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: i,
                        round: s
                    } = Math, a = e[0] | e[1] << 8 | e[2] << 16, u = e[3] | e[4] << 8, o = (63 & a) / 63, c = (a >> 6 & 63) / 31.5 - 1, d = (a >> 12 & 63) / 31.5 - 1, f = a >> 23, E = u >> 15, _ = l(3, E ? f ? 5 : 7 : 7 & u), p = l(3, E ? 7 & u : f ? 5 : 7), T = f ? (15 & e[5]) / 15 : 1, m = (e[5] >> 4) / 15, I = f ? 6 : 5, C = 0, S = (t, r, n) => {
                        let l = [];
                        for (let i = 0; i < r; i++)
                            for (let s = i ? 0 : 1; s * r < t * (r - i); s++) l.push(((e[I + (C >> 1)] >> ((1 & C++) << 2) & 15) / 7.5 - 1) * n);
                        return l
                    }, R = S(_, p, (a >> 18 & 31) / 31), M = S(3, 3, 1.25 * ((u >> 3 & 63) / 63)), h = S(3, 3, 1.25 * ((u >> 9 & 63) / 63)), P = f && S(5, 5, m), L = n(e), N = s(L > 1 ? 32 : 32 * L), g = s(L > 1 ? 32 / L : 32), A = new Uint8Array(N * g * 4), v = [], x = [];
                    for (let e = 0, n = 0; e < g; e++)
                        for (let s = 0; s < N; s++, n += 4) {
                            let a = o,
                                ...
                                E = d,
                                m = T;
                            for (let e = 0, r = l(_, f ? 5 : 3); e < r; e++) v[e] = i(t / N * (s + .5) * e);
                            for (let r = 0, n = l(p, f ? 5 : 3); r < n; r++) x[r] = i(t / g * (e + .5) * r);
                            for (let e = 0, t = 0; e < p; e++)
                                for (let r = e ? 0 : 1, n = 2 * x[e]; r * p < _ * (p - e); r++, t++) a += R[t] * v[r] * n;
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let r = e ? 0 : 1, n = 2 * x[e]; r < 5 - e; r++, t++) m += P[t] * v[r] * n;
                            let I = a - 2 / 3 * u,
                                C = (3 * a - I + E) / 2,
                                S = C - E;
                            A[n] = l(0, 255 * r(1, C)), A[n + 1] = l(0, 255 * r(1, S)), A[n + 2] = l(0, 255 * r(1, I)), A[n + 3] = l(0, 255 * r(1, m))
                        }
                    return {
                        w: N,
                        h: g,
            ...
            class p extends u.PureComponent {
                render() {
                    ...
                    return (0, a.jsxs)(d.default, {
                        className: c(f.note, E[t], l),
                        align: d.default.Align.CENTER,
                        children: [(0, a.jsx)(e, {
                            className: c(f.icon, _[n], i)
                        }), (0, a.jsx)("div", {
                            children: r
                        })]
                    })
                ...
                (0, i.openModalLazy)(async () => {
                    ...
                    return r => {
                        ...
                        return (0, n.jsx)(e, {
                            ...
                            onComplete: () => {
                                U = !0, null == p || p(), !R && ((0, u.setIsPersistentHelperHidden)(!0), (0, u.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: T,
                            analyticsLocations: m,
                            analyticsObject: I,
                    ...
                    onCloseCallback: () => {
                        !U && o.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: g,
                            location_stack: m
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == _ || _(U), U && (!R && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == T || T())
                    },
        ...
        843647: function(e, t, r) {
            ...
            function f(e) {
                let {
                    ...
                    experiment: r,
                    location: f
                } = e, E = (0, n.useStateFromStores)([l.default], () => l.default.getCurrentUser()), _ = (0, c.usePremiumTrialOffer)(), p = null != _, T = null != E && (0, s.isPremium)(E);
                ...
                }), M = (0, n.useStateFromStores)([i.default], () => i.default.isLoadedForSKUs([d.PremiumSubscriptionSKUs.TIER_0, d.PremiumSubscriptionSKUs.TIER_2])), h = !T && m && !p && (I ? !R || !M : !R), P = d.PremiumTypes.TIER_2;
                if (p) {
        ...
        273619: function(e, t, r) {
            ...
            var p = r("454589"),
                ...
                C = r("782340"),
                S = r("129429");
            let R = new Set([_.Step.SKU_SELECT, _.Step.AWAITING_AUTHENTICATION, _.Step.AWAITING_PURCHASE_TOKEN_AUTH, _.Step.CONFIRM]);
            ...
            function M(e) {
                let {
                    ...
                    footer: P,
                    isGift: L = !1,
                    giftMessage: N = C.default.Messages.PREMIUM_PAYMENT_IS_GIFT,
                    hideBreadcrumbs: g = !1,
                    isLoading: A = !1,
                    purchaseError: v,
                ...
                null != M && null == (0, _.errorToStep)(M) ? y = M : null != v ? y = v : null != U && (y = U);
                let w = null != y ? y.message : "";
                null != y && y instanceof d.BillingError && (y.code === f.ErrorCodes.CARD_DECLINED && b && (w += " ".concat(C.default.Messages.BILLING_ERROR_TRY_ANOTHER)), y.code === f.ErrorCodes.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED && (w = C.default.Messages.GIFT_CODE_SMITE_REJECT_HELP_TEXT), y.code === I.AbortCodes.BILLING_NON_REFUNDABLE_PAYMENT_SOURCE && (w = C.default.Messages.GIFT_CODE_PAYMENT_SOURCE_INVALID));
                let {
                    stripe: D
                ...
                let H = t.includes(_.Step.PAYMENT_TYPE) ? _.Step.PAYMENT_TYPE : _.Step.ADD_PAYMENT_STEPS;
                return (0, n.jsxs)(i.Elements, {
                    ...
                    children: [h, (0, n.jsxs)("div", {
                        ...
                        children: [L && r !== _.Step.CONFIRM ? (0, n.jsx)(c.default, {
                            ...
                            children: (0, n.jsx)(p.default, {
                                activeId: _.COLLAPSED_PAYMENT_BREADCRUMB_STEPS.has(r) ? H : r,
                                breadcrumbs: t.filter(e => !_.COLLAPSED_PAYMENT_BREADCRUMB_STEPS.has(e) && !R.has(e)).map(e => ({
                                    id: e,
        ...
        122846: function(e, t, r) {
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [(0, n.jsx)(M.default, {
                        ...
                        description: O.default.Messages.STICKER_PREMIUM_TIER_2_UPSELL_PERK_GUILD_SUBSCRIPTION.format({
                            ...
                            discountPercent: (0, v.formatPercent)(t, U.GUILD_BOOST_COST_FOR_PREMIUM_USER_DISCOUNT_PERCENT / 100)
                        })
                    }), (0, n.jsx)(M.default, {
                        icon: N.default,
            ...
            let w = e => {
                    let {
                        ...
                        price: c,
                        onClose: d
                    } = e, f = (0, a.useStateFromStores)([h.default], () => h.default.locale), E = null != t || null != l;
                    return (0, n.jsxs)("div", {
                        className: j.wrapper,
                        children: [(0, n.jsx)(u.ModalCloseButton, {
                            onClick: d,
                            className: j.closeButton
                        }), E && (0, n.jsx)(C.PremiumTrialGradientBadge, {
                            className: j.premiumTrialBadge
                        }), (0, n.jsx)("img", {
                            className: s(j.heroImage, {
                                [j.heroImageWithTrialOffer]: E
                            }),
                            src: r("190389"),
                            alt: ""
                            ...
                            children: [(0, n.jsx)(u.Text, {
                                ...
                                children: null == c ? (0, n.jsx)(u.Spinner, {
                                    ...
                                    planName: (0, A.getTierDisplayName)(U.SubscriptionPlans.PREMIUM_MONTH_TIER_0),
                                    monthlyPrice: (0, v.formatPrice)(c.amount, c.currency)
                                }) : O.default.Messages.STICKER_PREMIUM_TIER_2_UPSELL_ALERT_TITLE.format({
                                    monthlyPrice: (0, v.formatPrice)(c.amount, c.currency)
                                })
                            }), (0, n.jsx)("div", {
                                className: j.perks,
                                children: i ? (0, n.jsx)(y, {}) : (0, n.jsx)(b, {
                                    locale: f
                                })
                            })]
                        })]
            ...
            function B(e) {
                let {
                    onClose: t,
                    ...r
                } = e, i = (0, f.useSubscriptionPlansLoaded)(), s = (0, a.useStateFromStores)([P.default], () => P.default.hasFetchedPaymentSources), C = i && s, S = (0, I.usePremiumTrialOffer)(), M = (0, m.usePremiumDiscountOffer)(), {
                    isLoading: h,
                ...
                let N = L === U.PremiumTypes.TIER_0 && null == M,
                    g = C ? A.default.getDefaultPrice(N ? U.SubscriptionPlans.PREMIUM_MONTH_TIER_0 : U.SubscriptionPlans.PREMIUM_MONTH_TIER_2) : null;
                return (0, n.jsx)(E.PaymentContextProvider, {
                    ...
                    children: (0, n.jsx)(u.ModalRoot, {
                        ...
                        children: (0, n.jsx)(R.default, {
                            ...
                            steps: [_.Step.PREMIUM_UPSELL],
                            currentStep: _.Step.PREMIUM_UPSELL
                        })
                    })
                })
            }
            ...
            class d extends l.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this.renderBreadcrumb = (e, t) => {
                        ...
                        } = this.props, f = e.id === r, E = t === i.length - 1, _ = null != u ? u(e, f) : (0, n.jsx)("span", {

    ...
    ["51077"], {
        ...
        400271: function(e, t, l) {
            ...
            function S(e) {
                ...
                })), A = null != p ? p : _, I = (0, r.useStateFromStores)([i.default], () => i.default.getNick(a, null == l ? void 0 : l.id), [a, l]);
        ...
        393745: function(e, t, l) {
            ...
            function R(e) {
                ...
                let k = r.useMemo(() => l === x.GuildScheduledEventStatus.CANCELED || (null == M ? void 0 : M.is_canceled) ? 5 : l === x.GuildScheduledEventStatus.ACTIVE ? 3 : x.GuildScheduledEventStatusDone.has(l) ? 4 : V ? 2 : b ? 1 : 0, [l, null == M ? void 0 : M.is_canceled, V, b]),
                    P = function(e, t, l, n, a) {
                        switch (e) {
                            case 1:

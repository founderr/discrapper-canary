    ...
    ["67570"], {
        ...
        60297: function(t, n, e) {
            ...
            t.exports = function(t) {
                return null == t ? void 0 === t ? "[object Undefined]" : "[object Null]" : a && a in Object(t) ? u(t) : o(t)
            }
        },
            ...
            function o(t) {
                let n = function(t) {
                    let {
                        ...
                        cos: o,
                        round: a
                    } = Math, i = t[0] | t[1] << 8 | t[2] << 16, c = t[3] | t[4] << 8, f = (63 & i) / 63, s = (i >> 6 & 63) / 31.5 - 1, l = (i >> 12 & 63) / 31.5 - 1, p = i >> 23, h = (c >> 3 & 63) / 63, v = (c >> 9 & 63) / 63, M = c >> 15, d = u(3, M ? p ? 5 : 7 : 7 & c), b = u(3, M ? 7 & c : p ? 5 : 7), I = p ? (15 & t[5]) / 15 : 1, O = (t[5] >> 4) / 15, x = p ? 6 : 5, g = 0, y = (n, e, r) => {
                        let u = [];
                        for (let o = 0; o < e; o++)
                            for (let a = o ? 0 : 1; a * e < n * (e - o); a++) u.push(((t[x + (g >> 1)] >> ((1 & g++) << 2) & 15) / 7.5 - 1) * r);
                        return u
                    }, m = y(d, b, (i >> 18 & 31) / 31), w = y(3, 3, 1.25 * h), j = y(3, 3, 1.25 * v), T = p && y(5, 5, O), P = r(t), C = a(P > 1 ? 32 : 32 * P), E = a(P > 1 ? 32 / P : 32), S = new Uint8Array(C * E * 4), B = [], Q = [];
                    for (let t = 0, r = 0; t < E; t++)
                        for (let a = 0; a < C; a++, r += 4) {
                            let i = f,
                                c = s,
                                h = l,
                                v = I;
                            for (let t = 0, e = u(d, p ? 5 : 3); t < e; t++) B[t] = o(n / C * (a + .5) * t);
                            for (let e = 0, r = u(b, p ? 5 : 3); e < r; e++) Q[e] = o(n / E * (t + .5) * e);
                            for (let t = 0, n = 0; t < b; t++)
                                for (let e = t ? 0 : 1, r = 2 * Q[t]; e * b < d * (b - t); e++, n++) i += m[n] * B[e] * r;
                            for (let t = 0, n = 0; t < 3; t++)
                                for (let e = t ? 0 : 1, r = 2 * Q[t]; e < 3 - t; e++, n++) {
                                    let t = B[e] * r;
                                    c += w[n] * t, h += j[n] * t
                                }
                            if (p)
                                for (let t = 0, n = 0; t < 5; t++)
                                    for (let e = t ? 0 : 1, r = 2 * Q[t]; e < 5 - t; e++, n++) v += T[n] * B[e] * r;
                            let M = i - 2 / 3 * c,
                                O = (3 * i - M + h) / 2,
                                x = O - h;
                            S[r] = u(0, 255 * e(1, O)), S[r + 1] = u(0, 255 * e(1, x)), S[r + 2] = u(0, 255 * e(1, M)), S[r + 3] = u(0, 255 * e(1, v))
                        }
                    return {
                        w: C,
                        h: E,

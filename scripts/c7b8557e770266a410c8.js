    ...
    ["64431"], {
        ...
        679030: function(e, t, n) {
            ...
            class P extends i.PureComponent {
                ...
                getMode() {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.props;
                    return e.login ? s.LOGIN : s.REGISTER
                }
                getErrorMessage(e) {
                    let {
                ...
                render() {
                    ...
                    if (null == a) return i ? this.renderExpiredInvite() : this.renderSpinner(M.default.Messages.GIFT_CODE_AUTH_RESOLVING);
                    if (i) {
                        if (n) {
                            let e = this.state.currentUser;
                            return d || null == e ? this.renderSpinner(M.default.Messages.GIFT_CODE_AUTH_FETCHING_USER) : this.requiresVerification && null != e ? this.renderVerification(e) : this.renderAuthenticated(a, e)
                        }
                        return this.getMode() === s.LOGIN ? (0, l.jsx)(R.default, {
                            giftCodeSKU: t,
                            giftCode: a,
                            transitionTo: u,
                            location: o
        ...
        701662: function(e, t, n) {
            ...
            let L = e => {
                ...
                if (null == e || null == e.state || t) return s.LOADING;
                let n = e.state;
                switch (n) {
            ...
            function P(e) {
                ...
                let n = e => {
                    if (null == t) return null;
                    if (e === s.DETAILS) return (0, l.jsx)(C.GuildInfoCard, {
                        invite: t
                    });
                    return null
                };
            ...
            function j(e) {
                let {
                    invite: t
                } = e, n = null != t && (0, A.isEnhancedCommunityInvite)(t), a = n => {
                    ...
                    [s.DETAILS]: R.inviteCardInner,
                    [s.ERROR]: R.inviteCardInnerError,
                    [s.LOADING]: R.inviteCardInnerLoading
                };
                return (0, l.jsx)(D, {

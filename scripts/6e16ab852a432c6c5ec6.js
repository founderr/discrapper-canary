(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["66308"], {
        ...
        707916: function(e, t, l) {
            ...
            let L = e => null == e || e,
                S = (e, t) => L(e) ? E.default.Messages.GUILD_EVENT_TOOLTIP_COPY_INVITE : L(t) ? E.default.Messages.GUILD_EVENT_TOOLTIP_COPY_INVITE_WITHOUT_PERMISSION : E.default.Messages.GUILD_EVENT_TOOLTIP_COPY_INVITE_PRIVATE_CHANNEL;
        ...
        123030: function(e, t, l) {
            ...
            function S(e) {
                ...
                return (0, n.jsxs)(o.ClickableContainer, {
                    className: u(L.container, {
                        [L.canceled]: M,
                        [L.clickable]: null != S
                    }),
                    onClick: e => {
                        e.stopPropagation(), !M && (null == S || S(_))
                    },
                    onContextMenu: R,
                    "aria-label": "",
        ...
        427554: function(e, t, l) {
            ...
            function g(e) {
                let {
                    ...
                    hideScroller: v = !1,
                    initialStartDate: L
                } = e, [S, _] = s.useState([]), I = (0, o.useStateFromStores)([f.default], () => f.default.getGuildScheduledEvent(u));
                s.useEffect(() => {
                    if (null != l && (null == I ? void 0 : I.scheduled_start_time) != null) {
                        let e = (0, E.getRRule)(l);
                        _((0, E.generateNextRecurrences)(4, e, null != L ? L : new Date(I.scheduled_start_time)))
                    }
                }, [l, L, null == I ? void 0 : I.scheduled_start_time]), s.useEffect(() => {
                    if (null == t) return;
                    let e = S.map(e => a.default.fromTimestamp(Math.floor(e.getTime() / d.default.Millis.SECOND) * d.default.Millis.SECOND));
                    c.default.getGuildEventUserCounts(t, u, e)
                }, [u, t, S]);
                let m = s.useMemo(() => {
                    if (null == l || 0 === S.length || (null == I ? void 0 : I.scheduled_start_time) == null) return !1;
                    let e = new Date;
                    ...
                    let t = S[S.length - 1],
                        ...
                        s = n.after(t);
                    return null != s && !(s > e) && !0
                }, [l, S, null == I ? void 0 : I.scheduled_start_time]);
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(r.Heading, {
                        ...
                        children: [S.map(e => (0, n.jsx)(h.default, {
                            ...
                            onClick: e => {
                                ...
                                let t = (0, E.getRRule)(l),
                                    n = S[S.length - 1];
                                _([...S, ...(0, E.generateNextRecurrences)(4, t, n)])
                            },

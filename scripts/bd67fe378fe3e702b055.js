            ...
            function j(t) {
                ...
                if (!O.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== E.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = L(u, i),
                        c = I({}, e, R(a), null != i && null != o && (0, w.AB)(o) ? C(0, o) : N(u));
                    O.default.track(t, c, {
                        flush: n
                    })
                }
                ...
                q = function(t) {
                    ...
                    function n() {
                        ...
                        t.getDefaultAnimationStatus = function() {
                            return t.step === C.wZ8.OPEN ? I.SR.IDLE : I.SR.ACTION
                        };
                        t.getIdleAnimationStatus = function() {
                            if (t.step !== C.wZ8.OPEN) return I.SR.LOOP
                        };
                        return t
                    }
                    var i = n.prototype;
                        ...
                        get: function() {
                            ...
                            if (e && !r) {
                                ...
                                return A.Z.Messages.GIFT_RECIPIENT_INFO.format({
                                    recipientDisplayName: P.ZP.getName(g.default.getCurrentUser())
                                })
                            }

    ...
    ["69354"], {
        ...
        169626: function(e, t, n) {
            ...
            function O(e) {
                let {
                    ...
                    onSlideChange: p,
                    hasJoinButton: C
                } = e, [D, h] = r.useState(n), L = (0, s.default)(D), [m, g] = r.useState(null), [R, U] = r.useState(null), [M, v] = r.useState(null), [G, P] = r.useState(!1);
                r.useEffect(() => {
                    h(n)
                }, [h, n]), r.useEffect(() => {
                    D !== L && p(D)
                ...
                let y = r.useCallback(e => {
                        h(S.CreateGuildSlideTypes.CREATION_INTENT), U(e), d.default.track(N.AnalyticEvents.GUILD_TEMPLATE_SELECTED, {
                            template_name: e.id,
                            template_code: e.code
                        })
                    }, []),
                    w = r.useCallback(e => {
                        P(e), h(S.CreateGuildSlideTypes.CUSTOMIZE_GUILD)
                    }, []),
                    F = r.useCallback(() => h(S.CreateGuildSlideTypes.JOIN_GUILD), [h]),
                    b = r.useCallback(() => {
                        if (D === S.CreateGuildSlideTypes.CUSTOMIZE_GUILD) {
                            h(S.CreateGuildSlideTypes.CREATION_INTENT);
                            return
                        }
                        h(S.CreateGuildSlideTypes.GUILD_TEMPLATES), U(null)
                    }, [D]),
                    B = r.useCallback(e => {
                        v(e), l(e)
                    }, [l, v]),
        ...
        110337: function(e, t, n) {
            ...
            let D = (i = window.GLOBAL_ENV.INVITE_HOST, r = "", null == i && (i = location.host, r = T.Routes.INVITE("")), "".concat(location.protocol, "//").concat(i).concat(r, "/")),
                h = [p, "".concat(D).concat(p), "".concat(D).concat("cool-people")],
                L = e => {
                    let {
                        onClick: t
                    } = e;
                ...
                return (0, l.jsxs)("div", {
                    children: [(0, l.jsxs)(s.ModalHeader, {
                        ...
                        children: [(0, l.jsx)("form", {
                            ...
                            children: h.map(e => (0, l.jsx)(s.Clickable, {
        ...
        235004: function(e, t, n) {
            ...
            var U = new R(o.default, {
                LOGOUT: function() {
                    S.clear(), N.clear(), D.clear(), h = !1, p = r.NOT_FETCHED, O = r.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    N.set(r, a), D.set(l, u), l !== (null === (t = c.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (h = !0)
                },
        ...
        364685: function(e, t, n) {
            ...
            var F = new w(u.default, {
                ...
                LOGOUT: () => {
                    A = 0, D = [], p.clear(), O.clear(), C = null, m.clear(), m = new Map(m), L = !1, h = null
                },
                ...
                STICKER_PACKS_FETCH_SUCCESS: e => {
                    ...
                    t.forEach(e => G(e, !0)), h = Date.now(), L = !1
                },

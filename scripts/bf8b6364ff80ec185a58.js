...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [84501], {
        184501: (e, n, t) => {
            ...
            function U(e, n) {
                return !n || "object" !== V(n) && "function" != typeof n ? k(e) : n
            }
            ...
            function X(e) {
                switch (e) {
                    case z.PAYMENT_TYPE:
                        return M.Z.Messages.PAYMENT_SOURCE_TYPE;
                    case z.PAYMENT_REQUEST_INFO:
                        return M.Z.Messages.BILLING_STEP_PAYMENT_INFO;
                    case z.CARD_INFO:
                        return M.Z.Messages.PAYMENT_SOURCE_INFORMATION;
                    case z.ADDRESS:
                        return M.Z.Messages.BILLING_ADDRESS;
                    case z.PAYPAL:
                        return M.Z.Messages.PAYMENT_SOURCE_PAYPAL_DETAILS;
                    case z.SOFORT_INFO:
                        return M.Z.Messages.PAYMENT_SOURCE_SOFORT_INFO;
                    case z.PRZELEWY24_INFO:
                        return M.Z.Messages.PAYMENT_SOURCE_PRZELEWY24_INFO
                }
            }
            var K = [z.PAYMENT_TYPE, z.CARD_INFO, z.ADDRESS],
                J = [z.PAYMENT_TYPE, z.SOFORT_INFO, z.ADDRESS],
                $ = [z.PAYMENT_TYPE, z.PAYPAL, z.ADDRESS],
                ee = [z.PAYMENT_TYPE, z.PAYMENT_REQUEST_INFO],
                ne = [z.PAYMENT_TYPE, z.ADDRESS],
                te = [z.PAYMENT_TYPE, z.PRZELEWY24_INFO, z.ADDRESS],
                re = [z.PAYMENT_TYPE, z.ADDRESS];

            function se(e) {
                return e.hasCardError() ? z.CARD_INFO : e.hasAddressError() ? z.ADDRESS : null
            }
            var ae = function(e) {
                    ! function(e, n) {
                    ...
                    function t() {
                        ...
                        e.STEPS_DATA = (L(s = {}, z.PRZELEWY24_INFO, {
                            renderBody: function() {
                                var n = e.props,
                                    t = n.error,
                            ...
                            renderBody: function() {
                                var n = e.props.error,
                                    t = null != n && (null == n.code || se(n) === z.CARD_INFO);
                                return (0, r.jsxs)(r.Fragment, {
                                    children: [t ? (0, r.jsx)(u.FormErrorBlock, {
                                        className: Y().errorBlock,
                                        children: M.Z.Messages.BILLING_ERROR_SECTION_CARD
                                    }) : null, (0, r.jsx)(C.Z, {
                            ...
                            renderNextButton: function() {
                                ...
                                return (0, r.jsx)(u.Button, {
                                    ...
                                    children: a ? M.Z.Messages.NEXT : M.Z.Messages.PAYMENT_SOURCE_CONNECT_TO_PAYPAL
                                })
                            }
                        }), s);
                        ...
                        var i, o = k(e);
                        e.handleStripePaymentRequestSave = (i = j((function(e) {
                            var n, t;
                        ...
                        e.handleSave = function() {
                            ...
                            switch (n) {
                                ...
                                case I.HeQ.PRZELEWY24:
                                    return e.handlePrzelewy24Save();
                                case I.HeQ.PAYSAFE_CARD:
                                case I.HeQ.GRABPAY_MY:
                        ...
                        var p = k(e);
                        e.handlePrzelewy24Save = j((function() {
                        ...
                        var P = k(e);
                        e.handleGiropaySave = j((function() {
                            var e, n, t, r, s, a, i;
                            return q(this, (function(o) {
                                switch (o.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        o.trys.push([1, 3, , 4]);
                                        return [4, d.GV(a, n, I.HeQ.GIROPAY, s)];
                                    case 2:
                                        i = o.sent();
                                        null == r || r(i);
                                        P.handleClose();
                    ...
                    s.getSteps = function(e) {
                        switch (null != e ? e : this.state.type) {
                            ...
                            case I.HeQ.GCASH:
                            case I.HeQ.GRABPAY_MY:
                            case I.HeQ.MOMO_WALLET:
                            case I.HeQ.KAKAOPAY:
                            case I.HeQ.GOPAY_WALLET:
                                return re;
                            default:
                                return K
                        }
                    ...
                    s.renderGenericError = function() {
                        ...
                        return null == e || null != se(e) ? null : (0, r.jsx)(u.FormErrorBlock, {
                            className: Y().errorBlock,
                            children: e.message
                        })
                    };
                    ...
                    s.render = function() {
                        ...
                        return (0, r.jsx)(a.Elements, {
                            ...
                            children: (0, r.jsx)(u.ModalRoot, {
                                ...
                                className: Y().modal,
                                "aria-label": M.Z.Messages.PAYMENT_SOURCES_ADD,
                                    ...
                                    children: [(0, r.jsxs)(u.ModalHeader, {
                                        ...
                                        children: [(0, r.jsxs)(g.Z, {
                                            ...
                                            children: [(0, r.jsx)(u.FormTitle, {
                                                ...
                                                children: M.Z.Messages.PAYMENT_SOURCES_ADD
                                            }), (0, r.jsx)(u.ModalCloseButton, {
                                                onClick: this.handleClose
                                            })]
                                        }), this.renderGenericError(), (0, r.jsx)(b.Z, {
                                            breadcrumbs: i,
                                            activeId: n
                                        })]
                                    }), (0, r.jsx)("div", {
                ...
                ie = l.ZP.connectStores([P.Z, S.Z, E.Z], (function() {
                    return {
            ...
            function oe(e) {
                var n = e.transitionState,
                    ...
                    l = (0, y.vP)({
                        ...
                        header: (0, r.jsxs)("div", {
                            className: o()(Y().modalTitle, x().flex, x().justifyBetween, x().alignCenter),
                            children: [(0, r.jsx)(u.FormTitle, {
                                tag: u.FormTitleTags.H4,
                                children: M.Z.Messages.PAYMENT_SOURCES_ADD
                            }), (0, r.jsx)(u.ModalCloseButton, {
            ...
            function le(e) {
                return (0, r.jsx)(h.PaymentContextProvider, {
                    ...
                    stepConfigs: [],
                    skuIDs: [],
                    children: (0, r.jsx)(oe, H({}, e))
                })
            }
        }
    }
]);
//# sourceMappingURL=bf8b6364ff80ec185a58.js.map
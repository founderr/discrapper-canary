    ...
    ["26114"], {
        ...
        94973: function(e, t, n) {
            ...
            function R(e) {
                let {
                    ...
                    onComplete: _,
                    forcesTransitionToGuild: A
                }), y = t.subscription_plans[0], P = 0 === y.price, G = (null == b ? void 0 : b.id) === t.id, j = (0, u.default)(), U = j && !M || R, B = () => {
        ...
        593916: function(e, t, n) {
            ...
            function A(e) {
                ...
                })), N = a === S.ImpersonateType.ROLE_SUBSCRIPTION, O = (0, c.useStateFromStores)([f.default], () => null != n ? f.default.getTrueMember(t, n.id) : null), [v, R] = (0, d.useMultiSelect)(null == A ? [] : Object.keys(A)), x = i.useRef(s);
                i.useEffect(() => {
                    let e = {},
                        t = x.current;
                    if (null != t && null != a) {
                ...
                let b = null != s && null != n && null != O ? o(s.roles).filter(e => -1 !== O.roles.indexOf(e.id)).sortBy(e => -e.position).first() : void 0,
                ...
                if (null == n || null == s || null == O) return null;
                let M = {};
                O.roles.forEach(e => {
                    let t = s.roles[e];
                    null != t && (M[t.id] = t)
        ...
        977169: function(e, t, n) {
            ...
            function M() {
                ...
                let C = function(e) {
                    ...
                    M = i === O.GuildSettingsSections.ROLE_SUBSCRIPTIONS ? R.default.Messages.VIEWING_AS_SUBSCRIPTION_ROLES_SELECT : R.default.Messages.VIEWING_AS_ROLES_SELECT,
                    L = t === v.StaticChannelRoute.GUILD_ONBOARDING,
                    y = t => {
                        let {
                            backToSettings: n
                        } = t;
                        null != e && (A.default.isFullServerPreview(e) && (0, E.transitionTo)(O.Routes.CHANNEL(e)), c.default.shouldShowOnboarding(e) && (u.default.finishOnboarding(e), (0, d.discardOnboardingPromise)(e)), (0, g.stopImpersonating)(e), n && p.default.open(e, i), i === O.GuildSettingsSections.ROLE_SUBSCRIPTIONS && (0, f.announceDeleteTemplateChannels)(e))
                    };
                return (0, r.jsxs)(T.default, {
                    ...
                    }), s || i === O.GuildSettingsSections.ROLE_SUBSCRIPTIONS ? null : (0, r.jsx)(D, {
                        onClick: () => y({
                            backToSettings: !1
                        })
                    })]

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["24002"], {
        ...
        145079: function(e, t, n) {
            ...
            var C = e => {
                let {
                    ...
                    forcePomelo: f,
                    ...h
                } = e, C = (0, i.useStateFromStores)([u.default], () => u.default.hidePersonalInformation), E = C || t || n.isNonUserBot(), v = n.toString(), g = c.default.getName(n), S = r ? v : null != a ? a : g, _ = n.isPomelo() || f;
                if (_ || S !== v) {
                    let e = S === v && _ && r ? c.default.getUserTag(n, {
                            forcePomelo: f
                        }) : S,
        ...
        997289: function(e, t, n) {
            ...
            var l = n("884691"),
                a = n("599110");
            let r = () => l.useContext(a.AnalyticsContext)
        },
            ...
            var l = n("872717"),
                ...
                u = {
                    async createApplication(e) {
                        ...
                        return null != n && null != r && a.default.dispatch({
                    ...
                    async fetchApplications(e) {
                        ...
                        if (!t && (n = e.filter(e => {
                                ...
                                let l = i.default.getApplication(e),
                                    a = (0, r.hasFlag)(null !== (n = null == l ? void 0 : l.flags) && void 0 !== n ? n : 0, s.ApplicationFlags.EMBEDDED),
                                    u = a && (null == l ? void 0 : null === (t = l.embeddedActivityConfig) || void 0 === t ? void 0 : t.supported_platforms) == null;
            ...
            function A(e, t) {
                switch (e.type) {
                    ...
                    case y.ChannelTypes.GUILD_FORUM:
                        ...
                        if ((0, M.default)(e)) return A ? C.default : f.default;
        ...
        689226: function(e, t, n) {
            ...
            let u = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
                ...
                h = (e, t) => {
                    ...
                    let i = r.SUPPORTS_WEBP ? "webp" : "png",
                        c = "",
                        f = "quality=lossless";
                    return (null != t && (c = "size=" + (0, a.getBestMediaProxySize)(t * (0, a.getDevicePixelRatio)()), f = d ? "" : "&" + f), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(u, "/").concat(n, "/").concat(l, ".").concat(i, "?").concat(c).concat(f) : "".concat(o).concat(s.Endpoints.ROLE_ICON(n, l), "?").concat(c)
                },
        ...
        895026: function(e, t, n) {
            ...
            function h(e, t) {
                ...
                if (!n || null == f.get(l)) {
                    var a, i;
                    return f.set(l, !0), a = e, i = t, r.default.get({
        ...
        650484: function(e, t, n) {
            ...
            function p(e) {
                ...
                let T = null !== (o = null == L ? void 0 : null === (t = L.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== o && o,
                    ...
                    N = void 0 !== m && m ? h.sliderBodyLarge : null == L ? void 0 : null === (r = L.options) || void 0 === r ? void 0 : r.sliderBodyClassName;
        ...
        232268: function(e, t, n) {
            ...
            function i(e) {
                let {
                    children: t,
                    confettiLocation: n
                } = e, i = (0, a.default)([r.default], () => r.default.isEnabled({
                    confettiLocation: n
                }));
        ...
        798592: function(e, t, n) {
            ...
            function s() {
                let {
                ...
                } = l.useContext(r.ConfettiCannonContext), t = (0, a.default)([i.default], () => i.default.getState()), n = l.useCallback(e => ({
                    size: {
                        type: "static-random",
                    ...
                    fire: (l, a, r) => {
                        ...
                        let u = (null == r ? void 0 : r.settings) != null ? {
                            ...
                            o = n(u);
                        e(l, a, o, (null !== (i = null == r ? void 0 : r.count) && void 0 !== i ? i : u.confettiCount) * (null !== (s = null == r ? void 0 : r.countMultiplier) && void 0 !== s ? s : 1), {
        ...
        716849: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), r = (0, a.default)([c.default], () => c.default.shouldFetchPremiumLikelihood()), i = (0, a.default)([u.default], () => u.default.getCurrentUser());
                l.useEffect(() => {
                    v(i, r, t, n)
                }, [i, r, t, n])
            }
        ...
        707443: function(e, t, n) {
            ...
            function S(e) {
                let t = function(e) {
                    ...
                    [n, a] = (0, i.useStateFromStores)([m.default], () => r.partition(t, e => m.default.hasJoined(e)), [t], i.statesWillNeverBeEqual);
                return {
                    joinedThreadIds: n,
                    unjoinedThreadIds: a
                }
            ...
            function I(e, t, n) {
                ...
                let m = (0, i.useStateFromStoresArray)([p.default, u.default, o.default], () => r(p.default.getThreads(e.id, t, n)).filter(e => {
        ...
        442184: function(e, t, n) {
            ...
            function N(e) {
                let {
                    channel: t
                } = e, n = (0, r.useStateFromStores)([S.default], () => S.default.getMostRecentMessage(t.id));
            ...
            function M(e) {
                ...
                let o = (0, r.useStateFromStores)([m.default], () => {
                    ...
                    C = (0, r.useStateFromStores)([p.default], () => p.default.isBlocked(n.author.id)),
                    g = a.useMemo(() => {
            ...
            function y(e) {
                ...
                let {
                    channel: d
                } = e, c = (0, r.useStateFromStores)([h.default], () => h.default.lastMessageId(d.id)), p = null == c ? new Date(null !== (n = null === (t = d.threadMetadata) || void 0 === t ? void 0 : t.archiveTimestamp) && void 0 !== n ? n : Date.now()).getTime() : v.default.extractTimestamp(c);
                (0, u.useSubscribeGuildMembers)({
                    [d.guild_id]: [d.ownerId]
                });
                let E = (0, r.useStateFromStores)([m.default], () => m.default.getUser(d.ownerId)),
                    S = (0, r.useStateFromStores)([f.default], () => f.default.getMember(d.guild_id, d.ownerId)),
                    I = null !== (a = (0, o.default)(d)) && void 0 !== a ? a : C.default;
                        ...
                        children: [(0, l.jsx)(s.default, {
                            ...
                            authorHook(e, t) {
                                ...
                                return (0, l.jsx)(i.NameWithRole, {
                                    ...
                                    name: null !== (a = null == S ? void 0 : S.nick) && void 0 !== a ? a : g.default.getName(E)
                                }, t)
                            }
                        }), (0, l.jsx)("span", {
                            className: T.bullet,
        ...
        811305: function(e, t, n) {
            ...
            class S extends a.PureComponent {
                ...
                renderMoreUsers(e) {
                    ...
                    if (!r) {
                        if (null != n) {
                            if (n >= t) return (0, l.jsx)(a.Fragment, {
                ...
                render() {
                    ...
                    return (0, l.jsx)(o.Popout, {
                        position: "right",
                        preload: null == p ? void 0 : () => (0, d.default)(p.id, p.getAvatarURL(a, 80), {
                            guildId: a
                        }),
        ...
        306160: function(e, t, n) {
            ...
            function s(e) {
                return !!i && (a.isPlatformEmbedded ? (r.default.copy(e), !0) : l.copy(e))
            }
        },

    ...
    [19493], {
        ...
        861323: (e, t, n) => {
            ...
            var r, o, i, u, a, l, c = n(608575),
                ...
                A = M(window.GLOBAL_ENV.GUILD_TEMPLATE_HOST),
                S = M(null !== (r = window.GLOBAL_ENV.WEBAPP_ENDPOINT) && void 0 !== r ? r : "//canary.".concat(E.$R1)),
                ...
                L = new RegExp("((https?://[^ ]*)|^|[^/][^/.])(".concat(w.join("|"), ")"), "g");
                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, y, w, M, U = D(b, p),
                                F = D(A, p),
                                G = null !== (M = null !== (w = null !== (y = null !== (E = D(S, p)) && void 0 !== E ? E : D(R, p)) && void 0 !== y ? y : D(C, p)) && void 0 !== w ? w : D(N, p)) && void 0 !== M ? M : D(P, p),
                                V = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
                            ...
                            if (null != (null == U ? void 0 : U.match(v))) {
                                var B = (0, f.mb)(U.substring(1), p.search);
                                d.Z.getInvite(B);
                                V(_.g.INVITE, B)
                            }
                            null != (null == F ? void 0 : F.match(v)) && V(_.g.TEMPLATE, F.substring(1));
                            var k = null == G ? void 0 : G.match(g);
                            if (null != k) {
                            ...
                            null != (null == G ? void 0 : G.match(m)) && V(_.g.CHANNEL_LINK, G.replace("/channels/", ""));
                            var H = j(p.pathname);
                            null != H && V(_.g.EVENT, "".concat(H.guildId, "-").concat(H.guildEventId));
                            var z = null == G ? void 0 : G.match(O);
                            if (null != z) {
                                var W = z[1];
                                V(_.g.APP_DIRECTORY_PROFILE, W)
                            }
                            ...
                            if (null != K && q) {
                                var Q = K[1];
                                V(_.g.ACTIVITY_BOOKMARK, Q)
                            }
                            var X = null == G ? void 0 : G.match(I);
                            null != X && V(_.g.GUILD_PRODUCT, "".concat(X[1], "-").concat(X[2]))
                        }
                    }
                } catch (e) {
                    i = !0;
        ...
        269300: (e, t, n) => {
            ...
            function M(e) {
                var t, n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : N;
                if (r !== N && (null === (t = w.orphaned) || void 0 === t ? void 0 : t.has(e))) {
                    D(e, r);
                    U(e, N)
                }
            ...
            function Z(e) {
                S.values(I.GUILD_EVENT(e)).forEach((function(t) {
                    return C(t.id, e)
                }))
            }
            ...
            const Y = new x(a.Z, {
                ...
                FETCH_GUILD_EVENTS_FOR_GUILD: function(e) {
                    var t = e.guildId,
                        ...
                        r = S.values(I.GUILD_EVENT(t), !0).map((function(e) {
                            return e.id
                        })),
                        i = n.map((function(e) {
                            return e.id
            ...
            const Q = new q(c.Z, {
                ...
                LAYOUT_CREATE_WIDGETS: function(e) {
                    e.widgetConfigs.forEach((function(e) {
                        ...
                        B = L(w({}, B), N({}, n.id, n.set("widgets", r)))
                    }))
                }
            })
        },
            ...
            const q = new K(u.Z, {
                BACKGROUND_SYNC_CHANNEL_MESSAGES: function(e) {
                    ...
                    for (var n in t) {
                        var r = a.Z.get(n);
                        if (null != r) {
                            r.cached || !0 ? r.mergeDelta(t[n].new_messages, t[n].modified_messages, t[n].deleted_message_ids) : V.log("Skipping background message sync for ".concat(n, " cached:").concat(r.cached, " ") + "ready:".concat(r.ready, " hasMoreAfter:").concat(r.hasMoreAfter, " ") + "isConnected:".concat(false))
                        }
                    }
                },
                CONNECTION_OPEN: B,
                ...
                TRUNCATE_MESSAGES: function(e) {
                    var t = e.channelId,
                        n = e.truncateBottom,
                        r = e.truncateTop;
                    V.log("Truncating messages for ".concat(t, " bottom:").concat(n, " top:").concat(r));
                ...
                MESSAGE_CREATE: function(e) {
                    var t = e.channelId,
                        ...
                        o = a.Z.getOrCreate(t);
                    if (r) {
                        V.log("Inserting message tapped on from a push notification", n);
        ...
        674482: (e, t, n) => {
            ...
            var Q = function(e) {
                ...
                r.getTextChatNotificationMode = function() {
                    return Y.notificationPositionMode === g._vf.DISABLED ? g.Ypu.DISABLED : Y.textChatNotifications
                };

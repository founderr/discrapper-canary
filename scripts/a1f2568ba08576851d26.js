    ...
    ["26021"], {
            ...
            function l(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: l,
                        round: a
                    } = Math, s = e[0] | e[1] << 8 | e[2] << 16, o = e[3] | e[4] << 8, u = (63 & s) / 63, c = (s >> 6 & 63) / 31.5 - 1, d = (s >> 12 & 63) / 31.5 - 1, E = s >> 23, _ = (o >> 3 & 63) / 63, f = (o >> 9 & 63) / 63, I = o >> 15, S = i(3, I ? E ? 5 : 7 : 7 & o), T = i(3, I ? 7 & o : E ? 5 : 7), p = E ? (15 & e[5]) / 15 : 1, N = (e[5] >> 4) / 15, C = E ? 6 : 5, A = 0, h = (t, n, r) => {
                        let i = [];
                        for (let l = 0; l < n; l++)
                            for (let a = l ? 0 : 1; a * n < t * (n - l); a++) i.push(((e[C + (A >> 1)] >> ((1 & A++) << 2) & 15) / 7.5 - 1) * r);
                        return i
                    }, O = h(S, T, (s >> 18 & 31) / 31), R = h(3, 3, 1.25 * _), L = h(3, 3, 1.25 * f), m = E && h(5, 5, N), g = r(e), D = a(g > 1 ? 32 : 32 * g), P = a(g > 1 ? 32 / g : 32), v = new Uint8Array(D * P * 4), U = [], M = [];
                    for (let e = 0, r = 0; e < P; e++)
                        for (let a = 0; a < D; a++, r += 4) {
                            let s = u,
                                o = c,
                                _ = d,
                                f = p;
                            for (let e = 0, n = i(S, E ? 5 : 3); e < n; e++) U[e] = l(t / D * (a + .5) * e);
                            for (let n = 0, r = i(T, E ? 5 : 3); n < r; n++) M[n] = l(t / P * (e + .5) * n);
                            for (let e = 0, t = 0; e < T; e++)
                                for (let n = e ? 0 : 1, r = 2 * M[e]; n * T < S * (T - e); n++, t++) s += O[t] * U[n] * r;
                            ...
                            if (E)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * M[e]; n < 5 - e; n++, t++) f += m[t] * U[n] * r;
                            let I = s - 2 / 3 * o,
                                N = (3 * s - I + _) / 2,
                                C = N - _;
                            v[r] = i(0, 255 * n(1, N)), v[r + 1] = i(0, 255 * n(1, C)), v[r + 2] = i(0, 255 * n(1, I)), v[r + 3] = i(0, 255 * n(1, f))
                        }
                    return {
                        w: D,
                        h: P,
        ...
        677315: function(e, t, n) {
            ...
            function d(e) {
                ...
                let t = (0, r.useStateFromStores)([s.default, i.default], () => null != e && c(e.id, s.default, i.default));
            ...
            function E(e) {
                ...
                return !!(null != t && c(e, s.default, i.default)) && t.hasFeature(u.GuildFeatures.GUILD_HOME_DEPRECATION_OVERRIDE)
            }
        ...
        650484: function(e, t, n) {
            ...
            function f(e) {
                ...
                let {
                    ...
                    setReadySlideId: h
                } = (0, E.usePaymentContext)(), O = p.find(e => e.key === T);
                i.useEffect(() => {
                    A(null)
                }, [T, A]), o(null != O, "Unknown step for current payment flow.");
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [null === (c = null == O ? void 0 : null === (s = O.options) || void 0 === s ? void 0 : s.renderHeader) || void 0 === c || c ? f : null, O.renderStep(S), null == T || R ? null : (0, r.jsxs)(r.Fragment, {
        ...
        909469: function(e, t, n) {
            ...
            let c = new Set([o.CurrencyCodes.ARS, o.CurrencyCodes.CLP, o.CurrencyCodes.COP]),
                ...
                I = e => {
                    ...
                    } = t, C = 0 !== N.length, A = S(I), h = (0, a.formatPrice)(T, p, {
                        style: "currency",
                        currency: p,
                        currencyDisplay: "symbol",
                        localeOverride: A
                    }), O = u.default.Messages.LOCALIZED_PRICING_BANNER_BODY_NEW_CURRENCY.format({
                    ...
                    if (d.has(p) && (O = u.default.Messages.LOCALIZED_PRICING_BANNER_BODY_EXISTING_CURRENCY.format({
                            helpCenterLink: l.default.getArticleURL(s.HelpdeskArticles.LOCALIZED_PRICING),
                            localizedPriceWithCurrencySymbol: h
                        })), c.has(p) && (O = u.default.Messages.LOCALIZED_PRICING_BANNER_BODY_NEW_CURRENCY_WITH_AMBIGUOUS_SYMBOL.format({
                            helpCenterLink: l.default.getArticleURL(s.HelpdeskArticles.LOCALIZED_PRICING),
                            currencyISOCode: p.toUpperCase(),
                            localizedPriceWithCurrencySymbol: h
                        })), null != n && !n.hasPremiumNitroMonthly && (O = u.default.Messages.LOCALIZED_PRICING_BANNER_BODY_WITHOUT_PRICE.format({
                            helpCenterLink: l.default.getArticleURL(s.HelpdeskArticles.LOCALIZED_PRICING),
                            currencyISOCode: p.toUpperCase()
                        })), p === o.CurrencyCodes.EUR && (O = r ? u.default.Messages.LOCALIZED_PRICING_BANNER_NO_LOWERED_PRICE_SINGLE_STRING.format({
                        ...
                        N.length >= 3 && r.push(u.default.Messages.LOCALIZED_PRICING_MORE_NEW_WAYS_TO_PAY);
                        let i = new Intl.ListFormat(f, {
                            style: "short",
                            type: "conjunction"
                        });
                        O = u.default.Messages.LOCALIZED_PRICING_PAYMENT_METHODS_PROMO.format({
                            helpCenterLink: l.default.getArticleURL(s.HelpdeskArticles.LOCALIZED_PRICING),
                    ...
                    return {
                        ...
                        localizedPricingBannerSubNotif: C ? void 0 : u.default.Messages.LOCALIZED_PRICING_BANNER_SUB_NOTIF
                    }
                },
                S = e => {
        ...
        235004: function(e, t, n) {
            ...
            class D extends s.default.Store {
                ...
                hasFetchedAllSounds() {
                    return A === i.FETCHED && C === i.FETCHED
                }
            }
            D.displayName = "SoundboardStore";
            var P = new D(o.default, {
                LOGOUT: function() {
                    T.clear(), p.clear(), O.clear(), R = !1, A = i.NOT_FETCHED, C = i.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: i,
                        userId: l
                    } = e, a = (null !== (n = p.get(i)) && void 0 !== n ? n : 0) + 1, s = (null !== (r = O.get(l)) && void 0 !== r ? r : 0) + 1;
                    p.set(i, a), O.set(l, s), l !== (null === (t = d.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (R = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: i
                    } = e, l = (null !== (t = p.get(r)) && void 0 !== t ? t : 0) - 1, a = (null !== (n = O.get(i)) && void 0 !== n ? n : 0) - 1;
                    l <= 0 ? p.delete(r) : p.set(r, l), a <= 0 ? O.delete(i) : O.set(i, a)
                },
                ...
                USER_SETTINGS_PROTO_UPDATE: function(e) {
                    ...
                    if (n === S.UserSettingsTypes.FRECENCY_AND_FAVORITES_SETTINGS) {
                        var i, l;
                        h = new Set(null !== (l = null == r ? void 0 : null === (i = r.favoriteSoundboardSounds) || void 0 === i ? void 0 : i.soundIds) && void 0 !== l ? l : [])
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    T.set(f.DEFAULT_SOUND_GUILD_ID, t), C = i.FETCHED
                },
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    T = new Map(Object.entries(t.soundboardSounds)), h = new Set(t.favoritedSoundIds), N = new Set(t.localSoundboardMutes)
                },
        ...
        866353: function(e, t, n) {
            ...
            let c = (e, t, n) => {
                    ...
                    if ((0, o.isGuildSticker)(e) && null != n) return e.available ? null != n.guild_id && "" !== n.guild_id && n.guild_id === e.guild_id ? i.SENDABLE : null == n.guild_id || l.default.can({
        ...
        865372: function(e, t, n) {
            ...
            class T extends l.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (E = e), this.syncWith([u.default], I), this.syncWith([o.default], S)
                }
                getState() {
                    return E
                }
        ...
        364685: function(e, t, n) {
            ...
            var B = new x(s.default, {
                BACKGROUND_SYNC: () => {
                    h = null, A = new Map, m = new Map, N = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    h = null, A = new Map, m = new Map, t.forEach(G), N = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    N = 0, O = [], A.clear(), C.clear(), h = null, m.clear(), m = new Map(m), L = !1, R = null
                },
                ...
                GUILD_STICKERS_CREATE_SUCCESS: e => {
                    ...
                    let {
                        guildId: r,
                        sticker: i
                    } = e, l = null !== (t = m.get(r)) && void 0 !== t ? t : [];
                    g(r, [...null !== (n = l.filter(e => e.id !== i.id)) && void 0 !== n ? n : [], i]), v(i)
                },
                ...
                GUILD_STICKERS_UPDATE: e => {
                    ...
                    }, l = null !== (t = m.get(n)) && void 0 !== t ? t : [], a = l.filter(e => null == r.find(t => t.id === e.id));
                    a.forEach(e => {
        ...
        26092: function(e, t, n) {
            ...
            function L(e) {
                ...
                if (null == c) return m();
                d = null !== (t = e.section) && void 0 !== t ? t : d, O = null !== (n = e.section) && void 0 !== n ? n : d, null != e.subsection && null != d && (E[d] = e.subsection), null != e.scrollPosition && null != d && (_[d] = e.scrollPosition), p = !!e.openWithoutBackstack, u = o.FormStates.OPEN, f = {}, S = {
                    ...I = {
                ...
                }, C = null !== (r = e.onClose) && void 0 !== r ? r : null, A = null !== (i = e.analyticsLocation) && void 0 !== i ? i : null, h = null !== (l = e.analyticsLocations) && void 0 !== l ? l : [], R = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }

            function m() {
                u = o.FormStates.CLOSED, T = !1, I = null, O = null, S = null, c = null, d = null, E = {}, _ = {}, C = null, A = null, h = [], R = null
            }
            ...
            class D extends l.default.Store {
                ...
                hasChanges() {
                    return null != S && null != I && (!!this.isOpen() || N === o.DrawerTabTypes.USER_SETTINGS) && !i.isEqual(S, I)
                }
                isOpen() {
                    return T
                }
            ...
            var P = new D(a.default, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return N = e.tab, null == d && N === o.DrawerTabTypes.USER_SETTINGS && L({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        467831: function(e, t, n) {
            ...
            C.Scenes = s, (i = o || (o = {})).NORMAL = "normal", i.SPEED_START = "speed_start", i.SPEED_LOOP = "speed_loop", i.FINISH = "finish", i.IDLE = "idle";
            let A = {
                [o.NORMAL]: {
                    BEG: 0,
                    END: 600,
            ...
            h.Scenes = o, (l = u || (u = {})).IDLE_ENTRY = "idle_entry", l.IDLE_LOOP = "idle_loop", l.BOOST_START = "boost_start", l.BOOST_LOOP = "boost_loop", l.BOOST_END = "boost_end", l.VICTORY = "victory", l.ERROR = "error";
            let O = {
                [u.IDLE_ENTRY]: {
                    BEG: 0,
                    END: 50
            ...
            m.Scenes = u, (a = c || (c = {})).ENTRY = "entry", a.IDLE = "idle", a.STARS = "stars", a.ERROR = "error", a.SUCCESS = "success";
            let g = {
                    [c.ENTRY]: {
                        BEG: 0,
                        END: 180
            ...
            function U(e) {
                let {
                    animate: t
                } = e, [n, r] = E.useState(0), i = (0, I.useSprings)(P.length, P.map((e, i) => {

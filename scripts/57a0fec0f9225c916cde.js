    ...
    [75625], {
        ...
        860123: (e, t, n) => {
                        ...
                        switch (o.label) {
                            ...
                            case 1:
                                ...
                                try {
                                    ...
                                    return [2, N.slice(i.version).reduce((function(e, t) {
                                        return t(e)
                                    }), i)]
                                } catch (e) {
                                    return [2, null]
                ...
                return (B = U((function(e) {
                    ...
                    return F(this, (function(f) {
                        switch (f.label) {
                            ...
                            case 2:
                                f.sent();
                                k()(null != t.boxes, "mp4boxInputFile.boxes should not be null after parsing");
                                o = !0, a = !1, l = void 0;
                                try {
                ...
                return (Q = W((function(e) {
                    ...
                    return J(this, (function(a) {
                        switch (a.label) {
                            ...
                            case 1:
                                a.sent();
                                o && h.default.track(H.rMx.CLIPS_SETTINGS_UPDATED, Y({
                                    clips_enabled: t,
                                    guild_id: n
                                }, !t && {
            ...
            function $(e) {
                ...
                i && h.default.track(H.rMx.CLIPS_SETTINGS_UPDATED, X(Y({}, t && {
                    clips_enabled: !0
                }), {
            ...
            function ne() {
                var e, t = s.default.getId(),
                    ...
                    r = null != n ? f.Z.getRTCConnection((0,
                        a.V9)(n)) : null,
                ...
                return (oe = W((function() {
                    ...
                    return J(this, (function(O) {
                        switch (O.label) {
                            ...
                            case 2:
                                u = O.sent(), c = u.duration, s = u.thumbnail, p = u.clipStats;
                                (f = re(l, p)).clip_save_time_ms = p.clipSaveTimeMs;
                            ...
                            case 5:
                                if (!("errorMessage" in (g = O.sent()))) {
                                    h.default.track(H.rMx.CLIP_SAVE_FAILURE, l);
                                    throw g
                                }(w = re(l, _ = g)).error_at = _.errorAt;
                    ...
                    return J(this, (function(d) {
                        switch (d.label) {
                            case 0:
                                ...
                                if (v.Z.getIsSavingClip()) return [2];
                                n = v.Z.getSettings().clipsEnabled && null != c.Z.getCurrentUserActiveStream();
                                i = t && v.Z.getSettings().decoupledClipsEnabled && null != (null === (e = p.ZP.getVisibleGame()) || void 0 === e ? void 0 : e.windowHandle);
                                if (!n && !i) return [2];
                                r.Z.dispatch({
                                    type: "CLIPS_SAVE_CLIP_START"
                                });
                                o = (0, y.GN)("clip_save", .5);
                                a = performance.now();
                                d.label = 1;
                            case 1:
                                d.trys.push([1, 3, , 4]);
                            ...
                            case 3:
                                s = d.sent();
                                E.jF.error("Clip Failed to Save", s);
                                null == o || o.stop();
                                (0, y.GN)("clip_error", .5);
                                r.Z.dispatch({
                                ...
                                return [3, 4];
                            case 4:
                                E.jF.info("".concat(v.Z.getSettings().clipsLength / 1e3, "s clip save took ").concat(Math.round(performance.now() - a), "ms"));
                                return [2]
                        }
                    }))
                }))).apply(this, arguments)
            ...
            function be() {
                return (be = W((function(e) {
                    var t;
                    return J(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return (0,
                                    b.nI)() && null != (null === (t = i.Z.clips) || void 0 === t ? void 0 : t.deleteClip) ? [4, i.Z.clips.deleteClip(e)] : [2];
                            case 1:
                                n.sent();
                                r.Z.dispatch({
        ...
        796308: (e, t, n) => {
            ...
            const g = i.forwardRef((function(e, t) {
                var n, o, h = e.body,
                    ...
                    D = void 0 !== Z && Z,
                    N = e.shouldUseHorizontalButtons,
                    A = void 0 !== N && N,
                    j = e.showGIFTag,
                    T = void 0 !== j && j,
                    ...
                    H = A ? l.Button.Sizes.LARGE : l.Button.Sizes.MAX,
                    z = m(i.useState(!1), 2),
                    W = z[0],
                    q = z[1],
                    Y = (0, u.Z)(),
                ...
                return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            ref: X,
                            className: W || !A ? b().buttonContainerVertical : b().buttonContainerHorizontal,
                            ...
                            className: a()(b().pointer, (o = {}, v(o, b().bottomPointer, "top" === k), v(o, b().leftPointer, "right" === k), o))
                        })]
                    })
                })
            }))

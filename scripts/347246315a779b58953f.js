    ...
    ["72111"], {
            ...
            class p extends r.PureComponent {
                ...
                render() {
                    ...
                    let {
                        ...
                        maxFileSizeBytes: x,
                        onFileSizeError: O,
                        onOpenImageSelectModal: F,
                        "aria-label": y
                    } = this.props;
                    if (null != (t = null != a && /^data:/.test(a) ? a : _(a)) ? n = 'url("'.concat(t, '")') : null != p && (r = (0, i.jsx)("div", {
                        ...
                        children: (0, i.jsxs)("div", {
                            ...
                            children: [r, v && (0, i.jsx)("div", {
                                className: s(E.imageUploaderIcon, E.imageUploaderIconDisabled, L),
                                children: A
                            })]
                        })
                    });
                    ...
                    let U = null !== (e = null != y ? y : o) && void 0 !== e ? e : h.default.Messages.CHANGE_AVATAR;
                    return (0, i.jsxs)("div", {
                        className: s(E.imageUploader, S),
                        children: [(0, i.jsx)(u.FocusRing, {
                            within: !0,
                            children: (0, i.jsxs)("div", {
                                className: g ? s(E.imageUploaderIconWrapper, N) : void 0,
                                children: [(0, i.jsxs)("div", {
                                    className: s(E.imageUploaderInner, T),
                                    style: {
                                        ...P,
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                O = !0, null == C || C(), !v && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: _,
                            analyticsObject: m,
                    ...
                    onCloseCallback: () => {
                        !O && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: R,
                            location_stack: _
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == E || E(O), O && (!v && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },
        ...
        889793: function(e, t, n) {
            ...
            function O(e) {
                ...
                }, [n, l]), [I, v] = r.useState(() => null != u ? u : void 0 !== d ? d : null == c ? null : null != c ? c : null), [S, A] = r.useMemo(() => {
                    var e;
                ...
                }), [S]), F = r.useRef(null), y = T.default.canUseCollectibles(t), {
                    shopForAllEnabled: U
                } = (0, E.default)({
                    location: "AvatarDecorationModal"
                }), b = I === (void 0 === d ? null != c ? c : null : d), w = r.useCallback(e => {
                    v(e)
                }, [v]);
                    ...
                    children: [(0, i.jsxs)(a.ModalHeader, {
                        ...
                        children: [(0, i.jsx)("div", {
                            ...
                            children: (0, i.jsx)(a.HeadingLevel, {
                                ...
                                children: !y && !U && (0, i.jsx)(a.Heading, {
                        ...
                        user: t,
                        onApply: () => {
                            (0, m.setNewPendingProfileEffectID)(I, c), o()
                        },
                        onClose: o,
                        category: R,
                        purchase: O,
            ...
            function F(e) {
                ...
                let {
                    ...
                    categories: C,
                    purchases: _
                } = (0, p.default)(), m = (0, s.useStateFromStores)([v.default], () => v.default.getCurrentUser()), {
                    AnalyticsLocationProvider: g,
                    analyticsLocations: T
                } = (0, c.default)(o, u.default.EDIT_PROFILE_EFFECT_MODAL), L = (0, I.default)(null !== (t = null == m ? void 0 : m.id) && void 0 !== t ? t : ""), N = null == L ? void 0 : L.profileEffectID;
                return r.useEffect(() => {
        ...
        717262: function(e, t, n) {
            ...
            let S = e => {
                    ...
                    let {
                        ...
                        category: c,
                        purchase: d
                    } = e, f = (0, r.useStateFromStores)([m.default], () => m.default.getCurrentUser()), h = (0, r.useStateFromStores)([a.default], () => a.default.getProduct(null == s ? void 0 : s.skuId)), C = (0, r.useStateFromStores)([E.default], () => E.default.locale), {
                        shopForAllEnabled: p
                    } = (0, o.default)({
                        location: "ProfileEffectPreview"
                    }), _ = I.default.canUseCollectibles(f), S = (0, u.isPremiumCollectiblesPurchase)(d), L = (0, u.isPremiumCollectiblesCategory)(c), N = !_ && S, A = T(N, L, _, p);
                    return null != s ? (0, i.jsx)("div", {
                        className: n ? v.effectDescriptionNoGradient : v.effectDescriptionBorderWithGradient,
                        children: (0, i.jsxs)("div", {
            ...
            var L = e => {
                ...
                }), P = I.default.isPremium(n), M = (0, h.default)(n.id), x = !!(null == M ? void 0 : M.getPreviewBio(g).value), O = C.UseLegacyChatInput.useSetting(), F = O && null != g ? c.default.parse(void 0, g).content : g, y = I.default.canUsePremiumProfileCustomization(n), U = (null == M ? void 0 : M.canUsePremiumProfileCustomization) || y, b = {
                    user: n,
                ...
                return (0, i.jsxs)("div", {
                    className: U ? v.previewContainerWithTheme : v.previewContainerWithoutTheme,
            ...
            let R = () => 80,
                ...
                M = e => {
                    ...
                    let {
                        ...
                        isSelected: c,
                        ...d
                    } = e, C = (0, u.default)([v.default], () => v.default.getProfileEffectById(l.id)), _ = (0, u.default)([f.default], () => {
                        ...
                        title: O
                    } = null !== (t = null == C ? void 0 : C.config) && void 0 !== t ? t : {}, F = g.default.canUseCollectibles(n), y = a === S.Section.PREMIUM_PURCHASE && !F, [U, b] = r.useState(c);
                    return r.useEffect(() => {
                        c && b(!0)
                    }, [c]), (0, i.jsxs)(P, {
                ...
                return (0, i.jsx)("section", {
                    children: (0, i.jsx)(c.MasonryList, {
                        ...
                        renderItem: (e, t, o, d) => {
                            ...
                            return (0, a.match)(p[t]).with(S.NONE_ITEM, () => (0, i.jsxs)(P, {
                                style: {
                                    ...o
                                },
                                isSelected: !h,
        ...
        326054: function(e, t, n) {
            ...
            var _ = () => {
                let e = (0, a.default)([f.default], () => f.default.getCurrentUser()),
                    ...
                    [_, m] = (0, a.useStateFromStoresArray)([o.default], () => [o.default.categories, o.default.categorySkuIdsByProductSkuId]);
                return (0, l.useMemo)(() => {
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: _,
                    ...m
                } = e, I = s.createRef(), g = (0, d.default)(I), v = !i && !a && !0 !== u && (!_ || g);
        ...
        461380: function(e, t, n) {
            ...
            let h = {
                ...
                E = e => {
                    ...
                    if (!0 === m ? v = h.DOWN : !1 === m && (v = h.RIGHT), g) {
                        let e = {

    ...
    ["72960"], {
        ...
        454686: function(e, t, n) {
            ...
            let A = (e, t) => "".concat(e, "-").concat(t, "-new-rule"),
                ...
                T = e => (null == e ? void 0 : e.triggerType) === s.AutomodTriggerType.ML_SPAM,
                c = e => (null == e ? void 0 : e.triggerType) === s.AutomodTriggerType.DEFAULT_KEYWORD_LIST,
                ...
                E = (0, o.default)((e, t) => ({
                    ...
                    updateRule: n => {
                        ...
                        let {
                            ...
                            rules: s
                        } = t(), d = null !== (r = s[u]) && void 0 !== r ? r : {}, A = null !== (o = d[l]) && void 0 !== o ? o : [], E = A.some(e => e.id === i), T = A.filter(e => (!(0, a.isDefaultRuleId)(e.id) || e.triggerType !== l) && !0), c = E ? T.map(e => e.id === i ? n : e) : [...T, n];
                        e({
                            rules: {
                                ...s,
                                [u]: {
        ...
        296839: function(e, t, n) {
            ...
            function f(e) {
                ...
                return l.useMemo(() => Object.keys(T).reduce((e, r) => {
                    let o = T[r],
                        u = o.filter(e => {
                ...
                f = (0, u.default)((e, t) => ({
                    ...
                    saveRule: async (t, n) => {
                        ...
                        try {
                            ...
                            let n = null;
                            return n = (0, s.isBackendPersistedRule)(t) && !(0, T.isDefaultRuleId)(t.id) ? await (0, A.updateAutomodRule)(t) : await (0, A.createAutomodRule)(t), e({
                                ...g
                            }), n
                        } catch (n) {
                            let t = new i.APIError(n);
                            e({
                                ...
                                errorMessage: function(e) {
                                    if (e.code === c.AbortCodes.INVALID_FORM_BODY) {
                                        var t, n;
            ...
            let c = e => {
                ...
                g = e => {
                    switch (e) {
                        ...
                        case A.AutomodActionType.USER_COMMUNICATION_DISABLED:
                            return T.default.Messages.GUILD_AUTOMOD_ACTIONS_DISABLE_GUILD_COMMUNICATION_FOR_USER;
                        case A.AutomodActionType.QUARANTINE_USER:
                        ...
                        case A.AutomodActionType.BLOCK_MESSAGE:
                            switch (t) {
                                case A.AutomodTriggerType.MENTION_SPAM:
                                    return T.default.Messages.GUILD_AUTOMOD_ACTIONS_BLOCK_MESSAGE_DESCRIPTION_MENTION_SPAM;
                                case A.AutomodTriggerType.ML_SPAM:
                                    return T.default.Messages.GUILD_AUTOMOD_ACTIONS_BLOCK_MESSAGE_DESCRIPTION_ML_SPAM;
                                default:
                                    return T.default.Messages.GUILD_AUTOMOD_ACTIONS_BLOCK_MESSAGE_DESCRIPTION
                            }
                        case A.AutomodActionType.FLAG_TO_CHANNEL:
                            return T.default.Messages.GUILD_AUTOMOD_ACTIONS_FLAG_TO_CHANNEL_DESCRIPTION;
                        case A.AutomodActionType.USER_COMMUNICATION_DISABLED:
                            return T.default.Messages.GUILD_AUTOMOD_ACTIONS_DISABLE_GUILD_COMMUNICATION_FOR_USER_DESCRIPTION;
                        case A.AutomodActionType.QUARANTINE_USER:
                            return T.default.Messages.GUILD_AUTOMOD_ACTIONS_QUARANTINE_USER_DESCRIPTION
                    }
                },
                R = (e, t) => {
                    var n, l, a;
                    switch (e) {
                        ...
                        case A.AutomodActionType.FLAG_TO_CHANNEL: {
                            ...
                            return T.default.Messages.GUILD_AUTOMOD_ACTIONS_FLAG_TO_CHANNEL_DISPLAY_HELPER.format({
                                channelName: a
                            })
                        }
                        case A.AutomodActionType.USER_COMMUNICATION_DISABLED: {
                            ...
                            return T.default.Messages.GUILD_AUTOMOD_ACTIONS_USER_DISABLE_COMMUNICATION_DISPLAY_HELPER.format({
                                duration: n
                            })
                        }
                    }

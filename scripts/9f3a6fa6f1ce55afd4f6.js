        ...
        462392: function(e, t, n) {
                ...
                T = (e, t) => {
                    ...
                    switch (e) {
                        ...
                        case C.AutomodActionType.FLAG_TO_CHANNEL: {
                            ...
                            let s = (0, r.computeChannelName)(i, o.default, u.default);
                            return L.default.Messages.GUILD_AUTOMOD_ACTIONS_FLAG_TO_CHANNEL_DISPLAY_HELPER.format({
                                channelName: s
                            })
                        }
                        case C.AutomodActionType.USER_COMMUNICATION_DISABLED: {
                            let e = null !== (s = null == t ? void 0 : null === (i = t.metadata) || void 0 === i ? void 0 : i.durationSeconds) && void 0 !== s ? s : 0,
            ...
            function M(e, t, n) {
                ...
                return f(e) ? {
                    ...
                    descriptionText: null !== (l = I(e, n)) && void 0 !== l ? l : "",
        ...
        489118: function(e, t, n) {
            ...
            let C = e => {
                ...
                let {
                    duration: n,
                    onSelectDuration: l
                } = e, o = (0, s.getDisableCommunicationDurationOptions)(), i = o.find(e => e.value === n);
                return (0, r.jsx)(u.FormItem, {
                    className: c.durationSelector,
                    required: !0,
                    children: (0, r.jsx)(u.SearchableSelect, {
                        value: null !== (t = null == i ? void 0 : i.value) && void 0 !== t ? t : s.DisableCommunicationDuration.DURATION_60_SEC,
                        options: o,
                        onChange: e => {
            ...
            function d(e) {
                let {
                    ...
                    onClose: A,
                    transitionState: f
                } = e, _ = (0, o.useUID)(), [I, T] = l.useState(() => null != t.metadata.durationSeconds && t.metadata.durationSeconds > 0 ? t.metadata.durationSeconds : s.DisableCommunicationDuration.DURATION_60_SEC), N = (0, i.getActionInfo)(t.type, t, n);
                if (null == N) return null;
                let {
                    headerText: M
                } = N;
                return (0, r.jsxs)(u.ModalRoot, {
                    ...
                    children: [(0, r.jsxs)(u.ModalContent, {
                        ...
                        children: [(0, r.jsx)(u.Button, {
                            ...
                            children: d ? a.default.Messages.EDIT : a.default.Messages.SAVE
                        }), (0, r.jsx)(u.Button, {
                            onClick: () => {
                                A()
                            },

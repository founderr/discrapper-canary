        ...
        168507: (e, t, n) => {
            ...
            function T(e) {
                var t = e.width,
                    ...
                    a = void 0 === l ? "currentColor" : l,
                    c = e.foreground,
                    s = A(e, ["width", "height", "color", "foreground"]);
            ...
            const $ = function(e) {
                ...
                return (0, r.jsx)(O, {
                    children: (0, r.jsxs)(d.Clickable, {
                        ...
                        onClick: function() {
                            v(l);
                            H.default.track(V.rMx.CLIP_GALLERY_CARD_CLICKED)
                        },
                        className: G().clipItem,
                        onMouseOver: E,
                        onMouseLeave: N,
                        children: [(0, r.jsx)(J, {
                            clip: l,
                            ...
                            className: G().clipFooter,
                            children: [Z ? (0, r.jsx)(d.Heading, {
                                className: G().clipTitle,
                                color: "text-muted",
                                variant: "heading-lg/medium",
                                children: z.Z.Messages.CLIPS_UNTITLED
                            }) : (0, r.jsx)(d.Heading, {
                                className: G().clipTitle,
                                color: "text-normal",
                                variant: "heading-lg/medium",
            ...
            function J(e) {
                ...
                return (0, r.jsxs)(C.Z, {
                    aspectRatio: 16 / 9,
                    className: G().clipThumbContainer,
                    children: [null != l ? (0, r.jsx)(R.Z, {
                        preload: "metadata",
                        muted: !0,
                        poster: t.thumbnail,
                        src: l,
                        loop: !0,
                        className: G().clipThumb,
                        ref: i
                    }) : (0, r.jsx)("img", {
                        alt: "",
                        src: t.thumbnail,
                        ...
                        className: G().clipBadges,
                        children: [n ? (0, r.jsxs)(d.Text, {
                            className: G().clipNewBadge,
                            variant: "eyebrow",
                            color: "always-white",
                            children: [(0, r.jsx)(I, {
                                className: G().newIcon
                            }), z.Z.Messages.NEW.toUpperCase()]
                        }) : null, (0, r.jsxs)("div", {
                            className: G().clipDurationBadge,
                            children: [c ? (0, r.jsx)(T, {
                                className: G().clipDurationEditIcon
                            }) : null, (0,
                                r.jsx)(d.Text, {
                                variant: "text-md/medium",
                                color: "always-white",
            ...
            function X(e) {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [null != l && (0, r.jsx)(d.Tooltip, {
                        text: z.Z.Messages.DELETE,
                        children: function(e) {
                            return (0, r.jsx)(d.Button, Q(K({}, e), {
                                disabled: o,
                                color: d.Button.Colors.PRIMARY,
                                onClick: function(e) {
                                    e.stopPropagation();
                                    e.shiftKey ? (0, m.sS)(t.filepath) : l(t);
                                    H.default.track(V.rMx.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                                        type: W.DELETE
                                    })
                                },
                                className: G().button,
                                ...
                                children: (0, r.jsx)(D.Z, {
                                    className: G().miniIcon
                                })
                            }))
                        }
                    }), (0, r.jsx)(d.Tooltip, {
                        text: z.Z.Messages.EDIT,
                        children: function(e) {
                            return (0, r.jsx)(d.Button, Q(K({}, e), {
                                disabled: o,
                                color: d.Button.Colors.PRIMARY,
                        ...
                        text: i ? z.Z.Messages.SHARE : z.Z.Messages.CLIPS_CANNOT_ATTACH_FILE_TO_CHANNEL,
                        children: function(e) {
                            return (0, r.jsx)(d.Button, Q(K({}, e), {
                                disabled: o && !n || !i,
                                submitting: n,
            ...
            function se(e) {
                var t = e.isEmptyBecauseQuery,
                    n = e.closePopout,
                    i = (0, ne.ZP)([oe.Z], (function() {
                        return oe.Z.getKeybindForAction(V.kg4.SAVE_CLIP)
                    })),
                    l = (0, ne.ZP)([v.Z], (function() {
                        return v.Z.getSettings().clipsEnabled
                    })),
                    a = t ? ae().noSearchResultsImage : ae().noClipsImage,
                    c = o.useCallback((function() {
                        n();
                        re.Z.open(V.oAB.CLIPS)
                    }), [n]),
                    s = function() {
                        if (!l) return z.Z.Messages.CLIPS_GALLERY_NO_CLIPS_CLIPS_NOT_ENABLED.format({
                            onClick: c
                        });
                        if (t) return z.Z.Messages.CLIPS_GALLERY_NO_CLIPS_MATCH_QUERY;
                        if (null == i) return z.Z.Messages.CLIPS_GALLERY_NO_CLIPS_NO_KEYBIND_SET.format({
                            onClick: c
                        });
                        var e = ie.BB(i.shortcut, !0);
                        return z.Z.Messages.CLIPS_GALLERY_NO_CLIPS.format({
                            keybind: e,
                ...
                return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            variant: "text-md/medium",
                            className: te()(ae().noClipsText, ce({}, ae().noSearchResultsText, t)),
                            children: s
                        })]
                    })
                })
            ...
            function ye(e) {
                ...
                return (0, r.jsxs)(d.ModalHeader, {
                    ...
                    children: [(0, r.jsx)(fe.Z, {
                        ...
                        children: z.Z.Messages.CLIPS
                    }), (0, r.jsx)("div", {
                        className: he().betaTag,
                        children: (0, r.jsx)(pe.Z, {})
                    }), (0, r.jsx)(ue.Z, {
                        autoFocus: !0,
                        size: ue.Z.Sizes.MEDIUM,
                        placeholder: z.Z.Messages.SEARCH,
                        className: he().queryInput,
                        query: t,
                        onChange: n,
                        onClear: function() {
                            return n("")
                        ...
                        placeholder: z.Z.Messages.CLIPS_SORT_PLACEHOLDER,
                        className: he().sortInput,
                        options: [{
                            value: "descending",
                            label: z.Z.Messages.CLIPS_SORT_RECENT
                        }, {
                            value: "ascending",
                            label: z.Z.Messages.CLIPS_SORT_OLDEST
                        }],
            ...
            function Ee(e) {
                var t = e.channelId,
                    ...
                    j = O[0],
                    w = O[1],
                    P = Ce(o.useState("descending"), 2),
                    x = P[0],
                    S = P[1],
                    C = Ce(o.useState(!0), 2),
                    L = C[0],
                    E = C[1],
                    N = Ce(o.useState(null), 2),
                    Z = N[0],
                    I = N[1],
                ...
                var R = o.useCallback((function(e) {
                    ...
                    G = L || 0 !== T.length ? L ? (0, r.jsx)("div", {
                        className: ge().spinnerContainer,
                        children: (0, r.jsx)(d.Spinner, {})
                    }) : (0, r.jsx)(d.List, {
                        className: ge().clipGrid,
                        sections: [T.length],
                        sectionHeight: 0,
                        rowHeight: 328.25,
                        renderRow: F

    ...
    ["74941"], {
        ...
        833843: function(e, t, n) {
            ...
            function P(e) {
                let {
                    ...
                    isMember: u,
                    recurrenceId: d
                } = e, c = (0, _.isGuildScheduledEventActive)(t), f = (0, r.useStateFromStores)([_.default], () => _.default.isInterestedInEventRecurrence(t.id, d), [d, t]), E = (0, h.default)(t), p = (0, r.useStateFromStores)([o.default], () => o.default.isLurking(n.id), [n.id]), v = (0, C.useIsChannelPublic)(null == l ? void 0 : l.id, t.id), T = (0, U.default)({
                    guild: n,
                    channel: l,
            ...
            var x = e => {
                let {
                    ...
                    onClose: C
                } = e, [I, g] = l.useState(h), U = (0, r.useStateFromStores)([_.default], () => _.default.getGuildScheduledEvent(t), [t]), x = null == U ? void 0 : U.id, b = null == U ? void 0 : U.guild_id, {
                    guild: w,
                    isMember: M
                } = (0, p.default)(b, x), D = (0, a.default)(n), j = null == U ? void 0 : U.channel_id, V = (0, r.useStateFromStores)([u.default], () => u.default.getChannel(j), [j]), F = (0, d.useUID)(), [G, k] = l.useState(y.EventDetailSections.EVENT_INFO), B = (0, v.default)(x, I), H = (0, r.useStateFromStores)([_.default], () => _.default.getUserCount(x, I)), [Z, {
                    loading: W,
                    error: Y
                }] = (0, f.default)(() => E.default.getGuildEventUsers(null == U ? void 0 : U.id, I, b));
                l.useEffect(() => {
                    null == U ? C() : c.default.track(L.AnalyticEvents.OPEN_MODAL, {
                ...
                let X = e => {
                    ...
                    J = null != I ? I : (0, T.getNextRecurrenceIdInEvent)(U);
        ...
        965353: function(e, t, n) {
            ...
            function f(e) {
                ...
                return !_ && v.push((0, i.jsx)(a.TabBar.Item, {
                    className: c.tabBarItem,
        ...
        360538: function(e, t, n) {
            ...
            function x(e) {
                let {
                    ...
                    startTime: U,
                    endTime: x
                } = (0, S.default)(t.id, h), b = (0, a.useStateFromStores)([C.default], () => C.default.getUserCount(t.id, h)), w = l.useCallback(e => {
                ...
                return (0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(m.GuildEventTimeStatus, {
                            ...
                            endTime: null == x ? void 0 : x.toISOString(),
                            status: t.status,
        ...
        586403: function(e, t, n) {
            ...
            function c(e) {
                let {
                    ...
                    channel: n,
                    onClose: c
                } = e, f = t.entity_type === u.GuildScheduledEventEntityTypes.EXTERNAL, E = l.useCallback(e => (0, a.createEventLocationClickHandler)(t, c)(e), [t, c]), _ = (0, o.getLocationDataForEvent)(t, n);
                if (null == _) return null;
                let {
                    IconComponent: h,
                    locationName: p
                } = _, v = (0, i.jsxs)(i.Fragment, {
        ...
        403901: function(e, t, n) {
            ...
            function R(e) {
                ...
                let {
                    eventUser: n,
                    onContextMenu: l
                } = e, o = (0, s.useStateFromStores)([p.default], () => p.default.getUser(n.user_id)), d = null === (t = n.member) || void 0 === t ? void 0 : t.guildId, v = (0, s.useStateFromStores)([h.default, _.default, E.default], () => n.user_id === E.default.getId() ? h.default.getStatus() : _.default.getStatus(n.user_id, d), [n.user_id, d]);
            ...
            function O(e) {
                ...
                if (u && 0 === r.length) return (0, i.jsx)(L, {
                    height: c,
                ...
                if (null != d && 0 === r.length) return (0, i.jsx)(L, {
                    height: c,
                    children: (0, i.jsx)(m, {})
                });
                let E = 0;
                return r.length >= T.MAX_RSVP_USER_DISPLAY_COUNT && f > T.MAX_RSVP_USER_DISPLAY_COUNT && (E = Math.max(f - r.length, 0)), 0 === r.length ? (0, i.jsx)(L, {
                    height: c,
                    children: (0, i.jsx)(g, {})
                }) : (0, i.jsx)(y, {
                    children: (0, i.jsx)(U, {
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: N
                } = (0, f.usePaymentContext)(), g = C.find(e => e.key === v);
                l.useEffect(() => {
                    I(null)
                }, [v, I]), o(null != g, "Unknown step for current payment flow.");
                let m = null !== (u = null == g ? void 0 : null === (t = g.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    ...
                    R = void 0 !== h && h ? E.sliderBodyLarge : null == g ? void 0 : null === (r = g.options) || void 0 === r ? void 0 : r.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == g ? void 0 : null === (a = g.options) || void 0 === a ? void 0 : a.renderHeader) || void 0 === d || d ? _ : null, g.renderStep(p), null == v || m ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                P = !0, null == h || h(), !I && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: v,
                            analyticsObject: C,
                    ...
                    onCloseCallback: () => {
                        !P && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: U,
                            location_stack: v
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == _ || _(P), P && (!I && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },
        ...
        865372: function(e, t, n) {
            ...
            class v extends r.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (f = e), this.syncWith([u.default], h), this.syncWith([o.default], p)
                }
                getState() {
                    return f
                }
        ...
        181114: function(e, t, n) {
            ...
            let v = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...v
                } = e, C = s.createRef(), T = (0, c.default)(C), S = !i && !l && !0 !== a && (!h || T);

            ...
            function Ko(e) {
                var t = e.firstMessage,
                    ...
                    a = i.useMemo((function() {
                        return null != (null == t ? void 0 : t.content) && "" !== t.content ? (0, ro.ZP)(t, {
                            formatInline: !0,
                            noStyleAndInteraction: !0,
                            allowHeading: !0,
                            allowList: !0
                    ...
                    return (0, r.jsxs)(p.Clickable, {
                        onClick: function(e) {
                            if (null != u && null != i.parent_id) {
                                ...
                                e.shiftKey ? (0,
                                    _.gt)(i, u.id, To.on.BROWSER) : uo.Z.openThreadAsSidebar({
                                    guildId: i.guild_id,
                                    channelId: i.id,
            ...
            function $o(e) {
                ...
                if (c) v = (0, r.jsx)(p.Text, {
                    ...
                    var b = null == a ? {
                        ...
                        } : (0, Oo.f)(a, h, c, o()(wo().mostRecentMessageContent, Wt().inlineFormat, Wt().smallFontSize), {

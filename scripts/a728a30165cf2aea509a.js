(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["40318"], {
        ...
        244480: function(e, t, l) {
            ...
            function T(e, t) {
                let l = e.getGuildId();
                return a(null != l, "This channel cannot be guildless."), t && (0, r.trackWithMetadata)(E.AnalyticEvents.REQUEST_TO_SPEAK_INITIATED, {
            ...
            function p(e, t) {
                ...
                return u === _.RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK && !t && (0, r.trackWithMetadata)(E.AnalyticEvents.PROMOTED_TO_SPEAKER, {
                    ...(0, g.getStageChannelMetadata)(e)
                }), i.default.patch({
            ...
            function v(e, t) {
                ...
                let l = t.getGuildId();
                return a(null != l, "This channel cannot be guildless."), N(t, e.id, !0), i.default.patch({
            ...
            function x(e, t, l) {
                ...
                l ? (r.allow = s.default.add(r.allow, t), r.deny = s.default.remove(r.deny, t)) : (r.allow = s.default.remove(r.allow, t), r.deny = s.default.add(r.deny, t)), u.default.updatePermissionOverwrite(e.id, r)
            }

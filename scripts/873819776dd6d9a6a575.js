        ...
        344533: (e, t, n) => {
            ...
            function ne(e) {
                var t, n, o, a = e.label,
                    i = e.value,
                    c = e.section,
                    u = null !== (n = X[a]) && void 0 !== n ? n : ee,
                    s = v.Pz[a] && function(e) {
                        return Array.isArray(e) && e.length > 0 && "number" == typeof e[0].value ? (0, r.jsx)(O.Z, {
                            dataPoints: e,
                            width: 300,
                            height: 100
                        }) : "number" == typeof e ? (0, r.jsx)(te, {
                            value: e,
                            width: 300,
                            height: 100
                        }) : void 0
                    }(i),
                    l = Array.isArray(i) ? null === (t = i.at(-1)) || void 0 === t ? void 0 : t.value : i;
                return (0, r.jsx)(M, {
                    label: a,
                    valueRendered: u(l),
                    section: c,
                    renderGraph: s,
                    children: null !== (o = H[a]) && void 0 !== o ? o : a
                })
            }
            var re = n(380203),
                oe = n.n(re);
            ...
            function ie(e, t, n, o) {
                ...
                return null != a ? (0, r.jsx)("div", {
                    className: S()(w().videoWrapper, oe().marginBottom40),
            ...
            function ue(e, t, n, o) {
                return e.map((function(e) {
                    ...
                    try {
                        for (var l, f = function(e) {
                                return Object.keys(e).sort((function(e, t) {
                                    var n = ce[e],
                                        r = ce[t];
                                    return n !== r ? void 0 === n ? 1 : void 0 === r ? -1 : n - r : v.Pz[e] !== v.Pz[t] ? v.Pz[e] ? 1 : -1 : e > t ? 1 : -1
                                }))
                            }(e)[Symbol.iterator](); !(i = (l = f.next()).done); i = !0) {
                            var d = l.value,
                                p = e[d];
                            q[d] || void 0 === p || a.push((0, r.jsx)(ne, {
                                section: n,
                                label: d,
                                value: p
                            }, d))
                    ...
                    return (0, r.jsxs)(s.FormSection, {
                        className: oe().marginBottom40,
                        title: e.type,
                        titleClassName: w().sectionHeader,
                        children: ["video" === e.type && null != t && null != n && null != o && ie(e, t, n, o), ae(a)]
            ...
            function le(e) {
                ...
                var n = c().map(t, (function(e, t) {
                    if (!q[t] && void 0 !== e) return (0, r.jsx)(ne, {
                        label: t,
                        value: e
                    }, t)
                }));
                return (0, r.jsx)(s.FormSection, {
                    ...
                    title: se.Z.Messages.RTC_DEBUG_CAMERA,
                    children: ae(n)
                })
            }
            ...
            function fe(e) {
                ...
                return (0, r.jsx)(s.FormSection, {
                    tag: s.FormTitleTags.H2,
                    title: se.Z.Messages.RTC_DEBUG_CLIPS,
                    children: ae(n)
                })
            }
            ...
            var be = function(e) {
                ...
                n.prototype.render = function() {
                    ...
                    var i = h.Z.getGuildId(),
                        ...
                        u = y.ZP.getNick(i, n),
                        l = null == c ? se.Z.Messages.RTC_DEBUG_RTP_INBOUND : "".concat(se.Z.Messages.RTC_DEBUG_RTP_INBOUND, " — ").concat(null != u ? u : R.ZP.getName(c));
                    return (0, r.jsx)(s.FormSection, {
                        tag: s.FormTitleTags.H2,
                        title: l,
                        children: ue(t, o, n, a)
            ...
            const ge = u.ZP.connectStores([v.ZP], (function(e) {
                var t = e.context,
                    n = e.index,
                    r = e.videoStreams,
            ...
            var xe = function(e) {
                ...
                n.prototype.render = function() {
                    ...
                    return null == e ? (0, r.jsx)(s.Spinner, {
                        ...
                        tag: s.FormTitleTags.H2,
                        title: se.Z.Messages.RTC_DEBUG_RTP_OUTBOUND,
                        children: ue(e)
                    })
                };
                return n
            }(o.PureComponent);
            const Ce = u.ZP.connectStores([v.ZP], (function(e) {
                var t = e.context,
                    n = e.index,
            ...
            function Ze(e, t) {
                Ze = Object.setPrototypeOf || function(e, t) {
                    e.__proto__ = t;
                    return e
                };
                return Ze(e, t)
            ...
            const Ne = function(e) {
                ...
                n.prototype.render = function() {
                    ...
                    return (0, r.jsx)(s.FormSection, {
                        tag: s.FormTitleTags.H2,
                        title: se.Z.Messages.RTC_DEBUG_SCREENSHARE,
                        children: ae(t)
                    })
                };
                return n
                ...
                n.prototype.render = function() {
                    ...
                    var i = ze(function(e) {
                        ...
                        u = c().map(i, (function(e, t) {
                            if ("receiverReports" !== t && (!o || "localAddress" !== t)) return (0, r.jsx)(ne, {
                                label: t,
                                value: e
                            }, t)
                        })),
                        l = c().map(i.receiverReports, (function(e) {
                            var t = (0, r.jsxs)(g.Z, {
                                ...
                                a = ke.ZP.getNickname(Ie.Z.getGuildId(), void 0, o);
                    ...
                    return (0, r.jsxs)(s.FormSection, {
                        tag: s.FormTitleTags.H2,
                        title: se.Z.Messages.RTC_DEBUG_TRANSPORT + (null != n ? " - " + n : ""),
                        className: w().allowSelection,
                        children: [ae(u), 0 === l.length ? null : (0, r.jsx)(s.FormDivider, {
                            className: oe().marginBottom20
                        }), ae(l)]
                    })
                };
                return n
            }(o.PureComponent);
            const Ye = u.ZP.connectStores([v.ZP, h.Z, Be.Z, Ae.Z], (function(e) {
                var t = e.context,
                    n = e.index,
                    r = v.ZP.getAllStats(t)[n],
                    o = t === Me.Yn.STREAM ? Ae.Z.getHostname(Ae.Z.getActiveStreamKey()) : h.Z.getHostname();
                return {
                    hidePersonalInformation: Be.Z.hidePersonalInformation,
                    transport: null != r ? r.transport : null,
                    mediaSessionId: h.Z.getMediaSessionId(),
                    hostname: Le.Z.getShortHostname(o)
                }
            }))(Qe);
            var $e = n(2590);
            ...
            function tt(e, t, n, o, a) {
                ...
                i.push({
                    section: d.ID.HEADER,
                    label: se.Z.Messages.RTC_DEBUG_CONTEXT.format({
                        context: e
                    })
                });
                null != u && i.push({
                    section: (0, v.J$)(e, $e._s_.TRANSPORT, n),
                    label: se.Z.Messages.RTC_DEBUG_TRANSPORT,
                    element: Ye,
                    elementProps: {
                        context: e,
                        index: n
                ...
                null != p && i.push({
                    section: (0, v.J$)(e, $e._s_.OUTBOUND, n),
                    label: se.Z.Messages.RTC_DEBUG_RTP_OUTBOUND,
                    element: Ce,
                    elementProps: {
                        context: e,
                        index: n
                ...
                null != m && i.push({
                    section: (0, v.J$)(e, $e._s_.CAMERA, n),
                    label: se.Z.Messages.RTC_DEBUG_CAMERA,
                    element: le,
                    elementProps: {
                        context: e,
                        index: n,
                ...
                if (null != f && !c().isEmpty(f)) {
                    i.push({
                        section: d.ID.HEADER,
                        label: se.Z.Messages.RTC_DEBUG_RTP_INBOUND
                    });
                    Object.keys(f).forEach((function(t) {
                        ...
                        i.push({
                            section: f,
                            label: null != u ? et(u, s, a) : (c = null != s ? s : t, (0, r.jsx)(g.Z, {
                                align: g.Z.Align.CENTER,
                                children: (0, r.jsx)(g.Z.Child, {
            ...
            function nt() {
                var e, t, n = (0, u.e7)([v.ZP], (function() {
                    ...
                    R = (0, u.e7)([p.Z], (function() {
                        return p.Z.darkSidebar ? $e.BRd.DARK : void 0
                    })),
                    P = (0, u.e7)([v.ZP], (function() {
                    ...
                    S = function(e) {
                        var t = e.defaultStats,
                            ...
                            u = t.flatMap((function(e, t) {
                                return tt(Me.Yn.DEFAULT, e, t, o, null == c ? void 0 : c.getGuildId())
                            })),
                            l = n.flatMap((function(e, t) {
                                return tt(Me.Yn.STREAM, e, t, o, null == c ? void 0 : c.getGuildId())
                            })),
                            f = [],
                            p = [],
                            m = {
                        ...
                        if (null != a) {
                            f.push(m);
                            f.push({
                                section: $e._s_.SCREENSHARE,
                                label: se.Z.Messages.RTC_DEBUG_SCREENSHARE,
                                element: Ne,
                                elementProps: {
                                    screenshare: a
                                }
                        ...
                        if (null != i) {
                            ...
                            p.push({
                                section: $e._s_.CLIPS,
                                label: se.Z.Messages.RTC_DEBUG_CLIPS,
                                element: fe,
                                elementProps: {
                                    clips: i
                                }
            ...
            function rt(e) {
                ...
                return (0, r.jsx)(a.Z, {
                    withTitleBar: !0,
                    windowKey: t,
                    title: se.Z.Messages.RTC_DEBUG_POPOUT_WINDOW_TITLE,
                    children: (0, r.jsx)(nt, {})
                })
            }
        }

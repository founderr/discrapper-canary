(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [10415, 96043, 53686, 71402], {
        ...
        213539: (e, t, n) => {
            ...
            n.r(t);
            n.d(t, {
                GuildProductEditModalContent: () => Cn,
                default: () => Pn
            });
            var r = n(785893),
                i = n(667294),
            ...
            var he = function(e, t) {
                ...
                ge = new ne.Z("ProductAttachmentManager"),
                Ee = function() {
                    function e(t) {
                        var n, r = t.guildId,
                            i = t.editSkuId,
                        ...
                        this.isEdit = null != i;
                        var l = null == i ? _.ANM.GUILD_PRODUCTS(r) : _.ANM.GUILD_PRODUCT_LISTINGS(r, i),
                            u = null == i ? "POST" : "PATCH";
                        ...
                        var s = null === (n = ie.Z.getGuildProduct(null != i ? i : "")) || void 0 === n ? void 0 : n.attachments;
                    ...
                    t.addAttachment = function(e, t) {
                        ...
                        if (this.uploads.length >= r) {
                            z.uv.announce(y.Z.Messages.GUILD_PRODUCT_A11Y_TOO_MANY_ATTACHMENTS.format({
                                maxAttachmentsCount: r
                            }));
                            throw new Error("Too many attachments")
                        }
                        e.target = ee.e.GUILD_PRODUCT_ATTACHMENT;
                        var i = new J.n(e, this.guildId);
                        i.upload();
                        i.on("error", (function(r) {
                            var o;
                            r === _.evJ.ENTITY_TOO_LARGE && n.onFileSizeError();
                            var a = "number" == typeof r && r > 0 ? -r : -1,
                                l = (0, oe.kg)(a),
                                u = null === (o = e.file) || void 0 === o ? void 0 : o.name;
                            null != u ? z.uv.announce(y.Z.Messages.GUILD_PRODUCT_A11Y_NAMED_UPLOAD_FAILED.format({
                                filename: u,
                                reason: l
                            })) : z.uv.announce(y.Z.Messages.GUILD_PRODUCT_A11Y_UPLOAD_FAILED.format({
                                reason: l
                            }));
                            t((function(e) {
                                return Ae(ce({}, e), se({}, i.id, a))
                            }))
                        }));
                        i.on("progress", (function(e, n) {
                            t((function(t) {
                                return Ae(ce({}, t), se({}, i.id, e / n))
                            }))
                        }));
                        this.uploads = pe(this.uploads).concat([i])
                    };
                    ...
                    t.saveProductWithAttachments = function(e) {
                        ...
                        return ue((function() {
                            ...
                            return he(this, (function(c) {
                                switch (c.label) {
                                    case 0:
                                        n = e.priceTier, r = e.createNewRole, i = e.imageName, o = de(e, ["priceTier", "createNewRole", "imageName"]);
                                        if (t.uploads.some((function(e) {
                                                return e.status === J.m.ERROR
                                        ...
                                        return [4, t.createCloudUploader().uploadFiles(l, Ae(ce({}, o), {
                                            price_tier: n,
                                            create_new_role: r,
                                            image_name: i,
                                            unlink_role: a,
                                    ...
                                    case 1:
                                        s = c.sent();
                                        ge.log("Created/updated product:", s);
            ...
            var me = i.createContext(void 0);

            function be() {
                var e = i.useContext(me);
                ...
                var t = e.children,
                    n = function(e, t) {
                        var n = t.editSkuId,
                            ...
                            s = fe(i.useState(u.generateInitialProgresses), 2),
                            c = s[0],
                            A = s[1],
                            d = fe(i.useState(null), 2)[1];
                        i.useLayoutEffect((function() {
                            A(u.generateInitialProgresses())
                        }), [u]);
                        var f, p = fe(i.useState(), 2),
                            O = p[0],
                            h = p[1],
                            g = fe(i.useState(), 2),
                            E = g[0],
                            ...
                            I = i.useCallback((f = ue((function(e) {
                                var t, n;
                                return he(this, (function(i) {
                                    switch (i.label) {
                                        ...
                                        case 2:
                                            n = i.sent();
                                            v(n instanceof Q.Hx ? n : new Q.Hx({
                                                status: 400,
                                                body: {
            ...
            const Ge = (0, Re.hN)((function(e) {
                var t = e.width,
                    ...
                    u = e.foreground,
                    s = Ze(e, ["width", "height", "color", "foreground"]);
                return (0, r.jsxs)("svg", xe(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
                ...
                var t = e.width,
                    ...
                    o = void 0 === i ? 24 : i,
                    a = e.color,
                    l = void 0 === a ? Ue.Z.colors.INTERACTIVE_NORMAL : a,
                    u = e.colorClass,
                    s = void 0 === u ? "" : u,
                    c = Me(e, ["width", "height", "color", "colorClass"]);
                return (0, r.jsx)("svg", je(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            function He(e) {
                ...
                return (0, r.jsx)(d.TooltipContainer, {
                    text: O,
                    children: (0, r.jsxs)("div", {
                        className: a()(Fe().attachedFileCard, (n = {}, ke(n, Fe().attachedFileCardError, A), ke(n, Fe().attachedFileCardUploading, !f), n)),
                        children: [(0, r.jsx)(Ne.Z, {
                            width: 16,
                            height: 16,
                            color: Ce.Z.INTERACTIVE_MUTED
                        }), (0, r.jsx)(k.Z, {
                            size: 10,
                            horizontal: !0
                        }), (0, r.jsx)(d.Text, {
                            ...
                            className: Fe().attachedFileCardSpinner,
                            ...
                            className: Fe().deleteButton,
                            innerClassName: Fe().deleteButtonInner,
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(ye.Z, {
                        ...
                        children: [(0, r.jsx)(Ge, {
                            ...
                            width: 16,
                            height: 16,
                            className: Fe().addFileButtonIcon,
                            "aria-hidden": !0
                        }), (0, r.jsx)(d.Text, {
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            className: Fe().attachedFilesContainer,
            ...
            function at(e, t, i) {
                switch (e.code) {
                    case _.evJ.TOO_MANY_PUBLISHED_PRODUCT_LISTINGS:
                        ot(y.Z.Messages.GUILD_PRODUCT_TOO_MANY_PUBLISHED_PRODUCT_ERROR_TITLE, y.Z.Messages.GUILD_PRODUCT_TOO_MANY_PUBLISHED_PRODUCT_ERROR_BODY, $e.IconVariant.DANGER);
                        break;
                    case _.evJ.TWO_FA_NOT_ENABLED:
                        ot(y.Z.Messages.GUILD_PRODUCT_TWO_FA_NOT_ENABLED_ERROR_TITLE, y.Z.Messages.GUILD_PRODUCT_TWO_FA_NOT_ENABLED_ERROR_BODY, $e.IconVariant.WARNING);
                        break;
                    case _.evJ.GUILD_PRODUCT_LISTING_CANNOT_PUBLISH_WITHOUT_BENEFIT:
                        ot(y.Z.Messages.GUILD_PRODUCT_MISSING_BENEFITS_ERROR_TITLE, y.Z.Messages.GUILD_PRODUCT_MISSING_BENEFITS_ERROR_BODY, $e.IconVariant.WARNING);
                        break;
                    ...
                    case _.evJ.CREATOR_MONETIZATION_PAYMENT_TEAM_REQUIRED:
                        ot(y.Z.Messages.CREATOR_MONETIZATION_PAYMENT_TEAM_REQUIRED_TITLE, y.Z.Messages.CREATOR_MONETIZATION_PAYMENT_TEAM_REQUIRED_BODY, $e.IconVariant.WARNING);
                        break;
                    case _.evJ.CREATOR_MONETIZATION_PAYMENT_ACCOUNT_VERIFICATION_REQUIRED:
                        ...
                        ot(y.Z.Messages.CREATOR_MONETIZATION_PAYMENT_ACCOUNT_VERIFICATION_REQUIRED_TITLE, o, $e.IconVariant.WARNING, a);
                        break;
                    default:
                        ...
                        if (null != s) {
                            ot(y.Z.Messages.GUILD_PRODUCT_GENERIC_ERROR_TITLE, s, $e.IconVariant.WARNING);
                            break
                        }
                }
            }
            ...
            var Et = "custom-image",
                vt = i.forwardRef((function(e, t) {
                    ...
                    return (0, r.jsx)(d.Clickable, ht(Ot({
                        ref: t,
                        className: a()(dt().radioOption, (n = {}, pt(n, dt().selected, f), pt(n, dt().disabled, u), n)),
                        onClick: O,
                        "aria-disabled": u
                    }, p), {
            ...
            function mt(e) {
                var t = e.presetImages,
                    ...
                    O = void 0 !== p && p,
                    h = o === Et,
                    g = gt(i.useState(h ? n : null), 2),
                    E = g[0],
                    v = g[1],
                    m = gt(i.useState(null), 2),
                    b = m[0],
                    I = m[1],
                    T = i.useRef(null),
                    _ = i.useRef(null);
                ...
                return (0, r.jsxs)("div", {
                    className: dt().imageSelectionContainer,
                    children: [(0, r.jsx)(d.FocusRing, {
                        within: !0,
                        children: (0, r.jsxs)("div", {
                            className: a()(dt().uploadButton, (C = {}, pt(C, dt().disabled, O), pt(C, dt().hidden, null != E), C)),
                            "aria-disabled": O,
                        ...
                        className: dt().radioGroup,
                        children: [null != E && (0, r.jsx)(vt, {
                            ref: _,
                            selectedImageName: o,
                            onChange: u,
                            disabled: O,
            ...
            function Nt(e) {
                ...
                return (0, r.jsxs)("div", {
                    className: a()((t = {}, Ct(t, _t().publishable, !o && !u), Ct(t, _t().wasEverPublished, O), t), _t().container),
                    children: [(0, r.jsxs)("div", {
                        className: _t().explanationColumn,
                        ...
                        children: function(e) {
                            var t;
                            return (0, r.jsxs)(d.Button, Pt(function(e) {
                                for (var t = 1; t < arguments.length; t++) {
                                    var n = null != arguments[t] ? arguments[t] : {},
                                        r = Object.keys(n);
                                    "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
                                ...
                                className: a()(_t().button, (t = {}, Ct(t, _t().wasEverPublished, O), Ct(t, _t().publishButton, !u), Ct(t, _t().disabledPublishButton, o), t)),
                                innerClassName: _t().buttonContents,
                                ...
                                onClick: o ? void 0 : A,
                                submitting: c,
                                children: [u ? y.Z.Messages.GUILD_PRODUCT_EDIT_MODAL_UNPUBLISH_BUTTON : y.Z.Messages.GUILD_PRODUCT_EDIT_MODAL_PUBLISH_BUTTON, u ? (0, r.jsx)(It.Z, {
                                    className: _t().buttonIcon,
                                    color: "currentColor",
            ...
            const Zt = (0, Re.hN)((function(e) {
                var t = e.width,
                    ...
                    l = void 0 === a ? "currentColor" : a,
                    u = e.foreground,
                    s = xt(e, ["width", "height", "color", "foreground"]);
                ...
                var t = e.width,
                    ...
                    u = e.colorClass,
                    s = void 0 === u ? "" : u,
                    c = jt(e, ["width", "height", "color", "colorClass"]);
                return (0, r.jsx)("svg", Dt(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            function Xt(e) {
                ...
                return (0, r.jsxs)("div", {
                    className: kt().roleInputContainer,
                    children: [(0, r.jsx)(d.TextInput, {
                        ...
                        maxLength: _.VKK,
                        inputClassName: kt().input
                    }), (0, r.jsxs)("div", {
                        className: kt().roleColorContainer,
                        children: [(0, r.jsx)(d.HiddenVisually, {
                            children: y.Z.Messages.GUILD_PRODUCT_SETTINGS_SELECT_ROLE_COLOR_ARIA.format({
                                color: (0, Rt.Rf)(o)
                            })
                        }), (0, r.jsx)("div", {
                            className: kt().roleColorPreview,
                            style: {
                                backgroundColor: (0, Rt.Rf)(o)
                            }
                        }), (0, r.jsx)(k.Z, {
                            size: 8,
                            horizontal: !0
                            ...
                            renderPopout: function(e) {
                                return (0, r.jsx)(qt.Z$, Kt(Ht({}, e), {
                                    value: o,
                                    onChange: a
                                }))
                            },
                            children: function(e) {
                                return (0, r.jsx)(d.Clickable, Kt(Ht({}, e), {
                                    tag: "span",
                                    "aria-label": y.Z.Messages.GUILD_PRODUCT_SETTINGS_CREATE_ROLE_SELECT_COLOR_ARIA,
                                    className: kt().dropperIconContainer,
                                    children: (0, r.jsx)(Vt.Z, {
                                        width: 16,
                                        height: 16,
                                        className: kt().dropperIcon
                                    })
                                }))
                            }
                        })]
                ...
                t = null != i ? (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(d.HiddenVisually, {
                        children: y.Z.Messages.GUILD_PRODUCT_SETTINGS_ROLE_COLOR_ARIA.format({
                            color: (0, Rt.Rf)(i.color)
                        })
                    }), (0, r.jsx)("div", {
                        className: Yt().attachedRoleColor,
                        style: {
                            backgroundColor: (0, Rt.Rf)(i.color)
                        }
                    }), (0, r.jsx)(k.Z, {
                        size: 8,
                        horizontal: !0
            ...
            function an(e) {
                ...
                if (null === t) return (0, r.jsxs)(d.FormItem, {
                    title: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(nn, {}), (0, r.jsx)(k.Z, {
                            horizontal: !0,
                            size: 4
            ...
            function Tn(e) {
                ...
                return (0, r.jsxs)("label", {
                    className: a()(cn().benefitToggleContainer, pn({}, cn().disabled, o)),
                    htmlFor: u,
                    children: [(0, r.jsx)(d.Text, {
                        variant: "text-sm/medium",
                        color: s,
            ...
            function Cn(e) {
                var t, o, a, l, g, E, v, m = e.guildId,
                    ...
                    P = C[0],
                    S = C[1],
                    N = (0, c.ZP)([ie.Z], (function() {
                        return null == P ? null : ie.Z.getGuildProduct(P)
                    }), [P]),
                    R = !0 === (null == N ? void 0 : N.published),
                    U = (0, h.Z)(m, un.w.GUILD_ROLE_SUBSCRIPTIONS).application,
                    L = Te[0],
                    ...
                    w = i.useCallback((function() {
                        var e;
                        return null == (null == N || null === (e = N.image_asset) || void 0 === e ? void 0 : e.application_id) ? L.data : (0, W._W)(N.image_asset.application_id, N.image_asset, 600, M && j ? void 0 : "webp")
                    }), [L, N, M, j]),
                    Z = gn(i.useState(null !== (a = null == N ? void 0 : N.name) && void 0 !== a ? a : ""), 2),
                    B = Z[0],
                    z = Z[1],
                    Y = gn(i.useState(null !== (l = null == N ? void 0 : N.description) && void 0 !== l ? l : ""), 2),
                    Q = Y[0],
                    J = Y[1],
                    $ = gn(i.useState(null !== (g = null == N ? void 0 : N.price_tier) && void 0 !== g ? g : void 0), 2),
                    ee = $[0],
                    te = $[1],
                    ne = gn(i.useState(w), 2),
                    re = ne[0],
                    ae = ne[1],
                    le = gn(i.useState(null !== (E = null == N || null === (t = N.image_asset) || void 0 === t ? void 0 : t.filename) && void 0 !== E ? E : L.name), 2),
                    ue = le[0],
                    se = le[1],
                    ce = gn(i.useState(!1), 2),
                    Ae = ce[0],
                    de = ce[1],
                    fe = gn(i.useState(), 2),
                    pe = fe[0],
                    ...
                    he = i.useMemo((function() {
                        return null != ee ? (0, K.T4)(ee, _.pKx.USD) : void 0
                    }), [ee]),
                    ge = gn(i.useState(!0), 2),
                    Ee = ge[0],
                    ve = ge[1],
                    me = be(),
                    Ie = me.changesSaving,
                    ye = me.saveError,
                    Ce = me.saveProductWithAttachments,
                    Pe = me.hasUnsavedAttachmentChanges,
                    Se = me.cancelUnusedUploads,
                    Ne = null != (null == N ? void 0 : N.attachments) && (null == N ? void 0 : N.attachments.length) > 0,
                    Re = null != ye ? ye : pe,
                    Ue = null != Ie && "published" in Ie,
                    Le = null != Ie && !Ue,
                    ...
                    we = je[1],
                    xe = null != Me || null != De,
                    Ze = (0, c.ZP)([q.Z], (function() {
                        if (null != De && null !== Me) {
                            var e = q.Z.getGuild(m);
                            return null == e ? void 0 : e.roles[De]
                        }
                        return null != Me ? Me : void 0
                    }), [Me, De, m]),
                    Ge = "";
                xe && Ee ? Ge = y.Z.Messages.GUILD_PRODUCT_CARD_TYPE_DOWNLOADABLE_AND_ROLE : xe ? Ge = y.Z.Messages.GUILD_PRODUCT_CARD_TYPE_ROLE : Ee && (Ge = y.Z.Messages.GUILD_PRODUCT_CARD_TYPE_DOWNLOADABLE);
                var qe = function() {
                        ve(!1);
                        Se()
                    },
                    ...
                    Qe = i.useMemo((function() {
                        return We || null == Fe || Fe === En.PUBLISH || null != Re ? null : (0, r.jsx)(F.Z, {
                            className: cn().successNotice,
                            children: (0, r.jsx)(p.Z, {
                                message: (0, r.jsxs)("div", {
                                    className: cn().successNoticeMessage,
                                    children: [(0, r.jsx)(H.Z, {
                                        color: s.Z.BUTTON_POSITIVE_BACKGROUND,
                                        backgroundColor: s.Z.WHITE
                                    }), (0, r.jsx)(d.Text, {
                                        variant: "text-md/medium",
                                        children: Fe === En.DRAFT ? y.Z.Messages.GUILD_PRODUCT_EDIT_NOTICE_BAR_SAVE_DRAFT_SUCCESS : Fe === En.UPDATE_PUBLISH ? y.Z.Messages.GUILD_PRODUCT_EDIT_NOTICE_BAR_MODAL_UPDATE_PUBLISH_SUCCESS : y.Z.Messages.GUILD_PRODUCT_EDIT_NOTICE_BAR_MODAL_UNPUBLISH_SUCCESS
                                    })]
                                }),
                                onReset: function() {
                                    return ke(void 0)
                ...
                i.useEffect((function() {
                    (0, d.updateModal)(ln.Y, (function(e) {
                        return (0, r.jsx)(Pn, On({
                            guildId: m,
                            productId: P
                        }, e))
                    }), $e)
                }), [m, $e, P]);
                var et, tt = (et = fn((function(e) {
                    var t, n, r;
                ...
                i.useEffect((function() {
                    if (null != Re) {
                        var e;
                        at(Re, m, null == U || null === (e = U.team) || void 0 === e ? void 0 : e.id)
                    }
                }), [Re, m, U]);
                i.useEffect((function() {
                    We && ke(void 0)
                ...
                return (0, r.jsxs)(d.ModalRoot, {
                    ...
                    className: cn().modalRoot,
                    "aria-labelledby": mn,
                    children: [(0, r.jsxs)(d.ModalHeader, {
                        className: cn().modalHeader,
                        separator: !1,
                        children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(d.ScrollerThin, {
                            children: (0, r.jsxs)("div", {
                                className: cn().productFieldsSection,
                                ref: rt,
                                children: [(0, r.jsx)(d.FormItem, {
                                    ...
                                    children: (0, r.jsx)(d.TextArea, {
                                        ...
                                        showRemainingCharacterCount: B.length > 0,
                                        required: !0,
                                        className: B.length > 0 ? cn().nameArea : void 0
                                    })
                                }), (0, r.jsx)(d.FormItem, {
                                    ...
                                    titleClassName: cn().thumbnailLabel,
                                    children: [(0, r.jsx)(d.Text, {
                                        variant: "text-xs/normal",
                                        color: "text-muted",
                                    ...
                                    error: null !== (nt = null == Re ? void 0 : Re.getFirstFieldErrorMessage(oe.NB)) && void 0 !== nt ? nt : void 0,
                                    newRoleParams: Me,
                                    setNewRoleParams: we,
                                    guildId: m,
                                    listingRoleId: De,
                            ...
                            className: cn().horizontalSeparator
                        }), (0, r.jsx)(d.ScrollerThin, {
                            children: (0, r.jsxs)("div", {
                                className: cn().productPreview,
                                children: [(0, r.jsx)(Nt, {
                                    disabled: !Ye,
                                    ...
                                    className: cn().verticalSeparator
                                }), (0, r.jsx)(d.Heading, {
                                    variant: "text-xs/bold",
                                    color: "header-secondary",
                                    className: cn().previewHeading,
                                    ...
                                    imageUrl: re,
                                    name: "" === B ? y.Z.Messages.GUILD_PRODUCT_CARD_EMPTY_NAME : B,
                                    description: "" === Q ? y.Z.Messages.GUILD_PRODUCT_CARD_EMPTY_DESCRIPTION : Q,
                                    formattedPrice: he,
                                    role: Ze,
                                    productType: Ge,
                                    ctaComponent: (0, r.jsx)(V.C, {
                                        shineSize: V.C.ShineSizes.SMALL,
                                        pauseAnimation: D || !M,
                                        className: cn().productPreviewCtaButton,
                        ...
                        children: (0, r.jsxs)("div", {
                            className: cn().footerActionButtons,
                            children: [(0, r.jsxs)("div", {
                                className: cn().footerActionLeftButtons,
                                children: [(0, r.jsx)(Tn, {
                                ...
                                className: cn().footerActionRightButtons,
                        ...
                        component: "div",
                        className: cn().successNoticeContainer,
                        children: Qe
                    })]
                })
            }

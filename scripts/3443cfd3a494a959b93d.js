    ...
    [24501], {
        624501: (e, t, n) => {
            ...
            function Z() {
                return (Z = P((function(e) {
                    ...
                    return w(this, (function(l) {
                        switch (l.label) {
                            case 0:
                                return null != (n = _.Z.getInvite(e.code)) ? [3, 2] : [4, u.Z.resolveInvite(e.code, "Markdown Link")];
                            case 1:
                                r = l.sent(), i = r.invite;
                                n = i;
                                l.label = 2;
                            case 2:
                                return null == n ? [2] : n.state !== T.r2o.EXPIRED && n.state !== T.r2o.BANNED && n.state !== T.r2o.ERROR ? [3, 4] : [4, L(n, e.code)];
                            case 3:
                                l.sent();
                                return [2];
                            case 4:
            ...
            function M(e) {
                ...
                if (null != o && (o.type === s.g.INVITE || o.type === s.g.EMBEDDED_ACTIVITY_INVITE)) return function(e) {
                    null == e || e.preventDefault();
                    D(o);
                    return !0
                };
                if (null != o && o.type === s.g.APP_DIRECTORY_PROFILE) return function(e) {
                    null == e || e.preventDefault();
                    var t, r = o.code,
                        u = null !== (t = S.Z.getGuildId()) && void 0 !== t ? t : void 0;
                    O.default.track(T.rMx.APP_DIRECTORY_PROFILE_EMBED_URL_CLICKED, {
                        application_id: r,
                        device_platform: i.tq ? "mobile_web" : "desktop_web",
                        guild_id: u,
                        channel_id: E.Z.getChannelId()
                    });
                    Promise.all([n.e(77179), n.e(15339)]).then(n.bind(n, 177179)).then((function(e) {
                        (0, e.goToAppDirectory)({
                            ...
                            guildId: u,
                            entrypoint: {
                                name: c.n3.APPLICATION_DIRECTORY_URL
                            }
                        })
                    }));
                    return !0
                };
                if (null != o && o.type === s.g.GUILD_PRODUCT) return function(e) {
                    null == e || e.preventDefault();
                    var t = C(o.code.split("-"), 2),
                        r = t[0],
                        i = t[1];
                ...
                var _ = r.parse(e),
                    ...
                    P = _.host,
                    w = _.query,
                    L = R.Z.isDiscordHostname(A) || window.location.host === P;
                if (L && (null == g ? void 0 : g.startsWith("/application-directory"))) {
                    var N = C(g.split("/"), 4),
                        Z = N[2],
                        M = N[3],
                        G = null != Z && (0, l.BH)(Z) ? Z : void 0;
                    return function(e) {
                        null == e || e.preventDefault();
                        var t, r = n(389740).c,
                            o = n(300272).eN,
                ...
                if (null != g && L) {
                    var x = n(933227),
                        k = x.getOAuth2AuthorizeProps,
                        j = x.openOAuth2Modal,
                        F = k(e);
                    if (null != F) return function(e) {
                        null == e || e.preventDefault();
                        j(F);
                        return !0
                    }
                ...
                var H = (0, b.Ao)(g);
                if (null != g && L && null != H) return function(e) {
                    null == e || e.preventDefault();
                    var t = S.Z.getGuildId();
                    null != H.guildId && "" !== H.guildId && H.guildId !== t && (0, v.Z)(T.Z5c.CHANNEL(H.guildId));
                    var n = p.ZP.getGuildScheduledEvent(H.guildEventId);
                    null != n && (0, d.bO)({
                        eventId: n.id
                    });
                    return !0
                };
                if (L && (null == g ? void 0 : g.startsWith("/settings/"))) {
                    var V = n(421774),
                        Y = V.default,
                        q = Y(g);
                    if (null != q) return function(e) {
                        null == e || e.preventDefault();
                        a.Z.open(q.section, q.subsection, {
                            openWithoutBackstack: !1,
                            impressionSource: q.source
                        });
                        return !0
                    }
                }
                return u || null == (0, I.v)(e) ? void 0 : function(t) {
        ...
        300272: (e, t, n) => {
            ...
            ! function(e) {
                ...
                e.APPLICATION_DIRECTORY_PROFILE_EMBED = "Application Directory Profile Embed";
            ...
            function d() {
                var e = (0, a.s1)().location.state;
                return null == e ? void 0 : e.previousView
            }

            function p() {
                var e, t = (0, a.s1)().location.pathname,
                    n = (0, o.LX)(t, {
                    ...
                    u = (0, o.LX)(t, {
                        path: [c.Z5c.APPLICATION_DIRECTORY_PROFILE(":applicationId"), c.Z5c.APPLICATION_DIRECTORY_PROFILE(":applicationId", ":section")],
                        exact: !0
                    }),
                    s = null !== (e = null == u ? void 0 : u.params) && void 0 !== e ? e : {},
                    f = s.applicationId,
                    d = s.section;
                if (null != n) return {
                    type: r.HOME
                ...
                if (null != u && null != f) {
                    var p, h = null === (p = l.Z.getApplication(f)) || void 0 === p ? void 0 : p.name;
                    return {
                        type: r.APPLICATION,
                        applicationId: f,
                        applicationName: h,
        ...
        362345: (e, t, n) => {
            ...
            function s(e, t) {
                var n, s = (0, l.yV)(t),
                    ...
                    h = (0,
                        u.y)(null == e ? void 0 : e.id, "useGuildShopPreviewVisible"),
        ...
        426089: (e, t, n) => {
            ...
            function M() {
                return (M = C((function(e, t, o) {
                    var l, s, f;
                    return D(this, (function(d) {
                        switch (d.label) {
                            case 0:
                                l = (0, c.Qj)(e);
                                return (s = null != l) ? [4, m(l)] : [3, 2];
                            case 1:
                                s = !d.sent();
                                d.label = 2;
                            case 2:

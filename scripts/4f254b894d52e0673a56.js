        ...
        942456: function(e, t, s) {
            ...
            class eI extends r.PureComponent {
                ...
                renderRefundDetails() {
                    ...
                    if (l.includes(a.PAYMENT_GATEWAY) || l.includes(a.PAYMENT_STATUS) || l.includes(a.ALREADY_REFUNDED) || l.includes(a.SKU_STICKER_PACK) || l.includes(a.SUBSCRIPTION_TYPE) || l.includes(a.GUILD_PRODUCT)) return null;
                    if ((null === (e = n.sku) || void 0 === e ? void 0 : e.productLine) === ee.SKUProductLines.COLLECTIBLES) return (0, i.jsx)("div", {
                    ...
                    return t = l.includes(a.SKU_TYPE) ? ea.default.Messages.BILLING_APPLICATION_CONSUMABLE_REFUND_TEXT_UNABLE.format({
                        supportURL: o
                    }) : u ? n.isPreorder && this.isSkuPreorder ? ea.default.Messages.BILLING_PREORDER_REFUND_TEXT.format({
                        supportURL: o
                    }) : n.isPremiumSubscription || n.isPremiumGuildSubscription ? ea.default.Messages.BILLING_PREMIUM_REFUND_TEXT.format({
                        dateLimit: d,
                        supportURL: o
                    }) : n.isGift ? ea.default.Messages.BILLING_GIFT_REFUND_TEXT.format({
                        dateLimit: d,
                        supportURL: o
                        ...
                        playtimeLimit: 2,
                        supportURL: o
                    }) : n.isGift ? ea.default.Messages.BILLING_GIFT_REFUND_TEXT_UNABLE.format({
                        dateLimit: d
                    }) : n.isPremiumSubscription || n.isPremiumGuildSubscription ? ea.default.Messages.BILLING_PREMIUM_REFUND_TEXT_UNABLE.format({
                        dateLimit: d
                ...
                renderRefundActions(e) {
                    ...
                    if (this.isSkuPreorder || e.includes(a.SKU_TYPE)) return null;
                    let o = (null === (t = u.sku) || void 0 === t ? void 0 : t.productLine) === ee.SKUProductLines.COLLECTIBLES,
                        d = e.includes(a.PURCHASE_DATE) ? Y.default : w.default,
                        c = e.includes(a.TIME_PLAYED) || (null === (n = u.premiumRefundDisqualificationReasons) || void 0 === n ? void 0 : n.includes($.PremiumRefundDisqualificationReason.PAST_REFUNDABLE_DATE)) ? Y.default : w.default;

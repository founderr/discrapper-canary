(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["28706"], {
            ...
            function m(e) {
                return function(e) {
                    switch (e.type) {
                        case "static":
                            var t = v(e.value);
                            return new I(new T(t.x), new T(t.y));
                        case "static-random":
                            var n = v(e.minValue),
                                i = v(e.maxValue);
                            return new I(new T(N(n.x, i.x)), new T(N(n.y, i.y)));
                        case "linear":
                            t = v(e.value);
                            var r = v(e.addValue);
                            return new I(new S(t.x, r.x), new S(t.y, r.y));
                        case "linear-random":
                            n = v(e.minValue), i = v(e.maxValue);
                            var l = v(e.minAddValue),
                                a = v(e.maxAddValue);
                            return new I(new S(N(n.x, i.x), N(l.x, a.x)), new S(N(n.y, i.y), N(l.x, a.x)));
                        case "oscillating":
                            t = v(e.value);
                            var o = v(e.start),
                                u = v(e.final),
                                s = v(e.duration),
                                c = v(e.direction);
                            return new I(new g(t.x, o.x, u.x, s.x, c.x, e.easingFunction), new g(t.y, o.y, u.y, s.x, c.y, e.easingFunction));
                        case "oscillating-random":
                            ...
                            var d = v(e.minStart),
                                ...
                                O = v(e.minDirection),
                                m = v(e.maxDirection);
                            return new I(new g(N(n.x, i.x), N(d.x, E.x), N(_.x, f.x), N(p.x, h.x), A(O.x, m.x), C(e.easingFunctions)[0]), new g(N(n.y, i.y), N(d.y, E.y), N(_.y, f.y), N(p.y, h.y), A(O.y, m.y), C(e.easingFunctions)[0]))
                    }
                }(f(f({}, e), {
                    valueType: "Vector2"
                }))
            ...
            var R = i.forwardRef(function(e, t) {
                var l = e.className,
                    ...
                    M = i.useCallback(function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == p || p(t), L.current.forEach(function(n, i) {
                                    var r = n.confetti,
                                        l = n.spriteCanvas;
                                    r.update(a), r.draw(l, t), r.shouldDestroy(e, a) && L.current.delete(i)
                                }), null == I || I(t), L.current.size > 0 ? U.current = window.requestAnimationFrame(M) : (t.clearRect(0, 0, e.width, e.height), U.current = null);
                                var n = Date.now();
                ...
                var P = i.useCallback(function(e, t) {
                    ...
                    b = i.useCallback(function(e, t, n, i, l) {
                        var a, o, u, d, E, _, p, I, v, R, L, U, y, D, M, b = (a = null !== (M = e.id) && void 0 !== M ? M : (0, r.v4)(), o = e, u = n, d = i, E = l, I = m((p = (_ = o, f(f({
                            id: a
                            ...
                            return C(t.sprites)
                        }(d, u))[0], L = v[1], U = function(e, t, n) {
                            if (!("string" == typeof(i = e) || i.colorize)) return 0;
                            var i, r = null != t ? n.colors.findIndex(function(e) {
                                return e === t
                            }) : -1;
                            return -1 !== r ? r : Math.floor(N(0, n.colors.length - 1))
                        }(null != d ? d : R, E, u), new s({
                            id: a,
                            position: m(p.position),
                            velocity: m(p.velocity),
                            rotation: (y = p.rotation, function(e) {
                                switch (e.type) {
                                    case "static":
                                        var t = O(e.value);
                                    ...
                                    case "static-random":
                                        var n = O(e.minValue),
                                            i = O(e.maxValue);
                                        return new h(new T(N(n.x, i.x)), new T(N(n.y, i.y)), new T(N(n.z, i.z)));
                                    case "linear":
                                        t = O(e.value);
                                        var r = O(e.addValue);
                                    ...
                                    case "linear-random":
                                        ...
                                        var l = O(e.minAddValue),
                                            a = O(e.maxAddValue);
                                        return new h(new S(N(n.x, i.x), N(l.x, a.x)), new S(N(n.y, i.y), N(l.y, a.y)), new S(N(n.z, i.z), N(l.z, a.z)));
                                    case "oscillating":
                                        t = O(e.value);
                                        var o = O(e.start),
                                            u = O(e.final),
                                            s = O(e.duration),
                                            c = O(e.direction);
                                        return new h(new g(t.x, o.x, u.x, s.x, c.x, e.easingFunction), new g(t.y, o.y, u.y, s.z, c.y, e.easingFunction), new g(t.z, o.z, u.z, s.z, c.z, e.easingFunction));
                                    case "oscillating-random":
                                        n = O(e.minValue), i = O(e.maxValue);
                                        var d = O(e.minStart),
                                            E = O(e.maxStart),
                                            ...
                                            v = O(e.minDirection),
                                            m = O(e.maxDirection);
                                        return new h(new g(N(n.x, i.x), N(d.x, E.x), N(_.x, f.x), N(p.x, I.x), A(v.x, m.x), C(e.easingFunctions)[0]), new g(N(n.y, i.y), N(d.y, E.y), N(_.y, f.y), N(p.y, I.y), A(v.y, m.y), C(e.easingFunctions)[0]), new g(N(n.z, i.z), N(d.z, E.z), N(_.z, f.z), N(p.z, I.z), A(v.z, m.z), C(e.easingFunctions)[0]))
                                }
                            }(f(f({}, y), {
                                valueType: "Vector3"
                            }))),
                            dragCoefficient: m(p.dragCoefficient),
                            size: I,
                            opacity: (D = p.opacity, function(e) {
                                switch (e.type) {
                                    case "static":
                                    ...
                                    case "oscillating-random":
                                        return new g(N(e.minValue, e.maxValue), N(e.minStart, e.maxStart), N(e.minFinal, e.maxFinal), N(e.minDuration, e.maxDuration), A(e.minDirection, e.maxDirection), C(e.easingFunctions)[0])
                                }
                            }(f(f({}, D), {
                                valueType: "number"
                            }))),
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, T()];
                                    case 1:
                                        return e.sent(), h(), p.current = !0, S(!0), [2]
                                }
                            })
        ...
        458389: function(e, t, n) {
            ...
            e.exports = function(e, t) {
                var n = l(e),
                    ...
                    p = f.length;
                for (var I in e)(t || s.call(e, I)) && !(_ && ("length" == I || d && ("offset" == I || "parent" == I) || E && ("buffer" == I || "byteLength" == I || "byteOffset" == I) || o(I, p))) && f.push(I);
                return f
            }
        },
            ...
            var r = function() {
                ...
                return r.prototype = {
                    ...
                    quantize: function(a, o) {
                        ...
                        var u, s, c, d, E, _, f, p, I, h, T, S, g, N, C, A, v = (u = a, E = Array(32768), u.forEach(function(n) {
                        ...
                        var m = (_ = a, f = v, T = 1e6, S = 0, g = 1e6, N = 0, C = 1e6, A = 0, _.forEach(function(t) {
                                p = t[0] >> e, I = t[1] >> e, h = t[2] >> e, p < T ? T = p : p > S && (S = p), I < g ? g = I : I > N && (N = I), h < C ? C = h : h > A && (A = h)
                            }), new r(T, S, g, N, C, A, f)),
                        ...
                        L(U, o - U.size());
                        for (var y = new l; U.size();) y.push(U.pop());
                        return y
                    }
                }
            }();
        ...
        506838: function(e, t, n) {
            ...
            let C = d(h(function(e) {
                    return !0
                })),
                A = e => Object.assign(d(e), {
                    startsWith: t => A(p(e, h(e => g(e) && e.startsWith(t)))),
                    endsWith: t => A(p(e, h(e => g(e) && e.endsWith(t)))),
                    minLength: t => {
                        var n;
                        return A(p(e, (n = t, h(e => g(e) && e.length >= n))))
                    },
                    maxLength: t => {
                        var n;
                        return A(p(e, (n = t, h(e => g(e) && e.length <= n))))
                    },
                    includes: t => A(p(e, h(e => g(e) && e.includes(t)))),
                    regex: t => A(p(e, h(e => g(e) && !!e.match(t))))
                }),
                v = A(h(g)),
                O = (e, t) => h(n => S(n) && e <= n && t >= n),
                m = e => h(t => S(t) && t < e),
                R = e => h(t => S(t) && t > e),
                L = e => h(t => S(t) && t <= e),
                U = e => h(t => S(t) && t >= e),
            ...
            var i = n("759843"),
                ...
                E = {
                    createChannel(e) {
                        ...
                        if (null != f && f !== c.BITRATE_DEFAULT && (S.bitrate = f), null != p && p > 0 && (S.user_limit = p), null != I && (S.parent_id = I), n === c.ChannelTypes.GUILD_STORE) {
                            if (null == h) throw Error("Unexpected missing SKU");
                            S.sku_id = h, S.branch_id = T
                        }
        ...
        152584: function(e, t, n) {
            ...
            function S(e) {
                ...
                return a.default.dispatch({
                    ...
                    return null != _.DEVICE_PUSH_VOIP_PROVIDER && null != c && (a.push_voip_provider = _.DEVICE_PUSH_VOIP_PROVIDER, a.push_voip_token = c), T(a)
                }, {
                    checkEnabled: !1,
                    modalProps: {
                    ...
                    saveAccountChanges(e, t) {
                        ...
                        return (0, c.default)(e => {
                            ...
                            return u.default.track(d.AnalyticEvents.USER_AVATAR_UPDATED, {
                                ...
                                user: t,
                                newPassword: I
                            }), null != f && null != I && l.default.dispatch({
                                type: "PASSWORD_UPDATED",
                                userId: t.id
        ...
        137223: function(e, t, n) {
            ...
            let T = e => {
                ...
                return (0, l.jsx)(s.Clickable, {
                    className: u(i, I.iconLayout, a, (0, _.getThemeClass)(r), {
                        [I.clear]: t
                    }),
                    onClick: e => {
            ...
            class S extends a.Component {
                ...
                render() {
                    let {
                        autoFocus: e,
                        query: t,
                        placeholder: n = p.default.Messages.DM_SEARCH_PLACEHOLDER,
                        themeOverride: i,
                        disabled: a,
                        onClear: o,
                        size: E,
                        ...
                        inputProps: N,
                        focusAfterReady: C
                    } = this.props, A = null != t && t.length > 0, v = !1, O = [];
                    return null != h && h.length > 0 && ("string" == typeof h[0] ? h.forEach((e, t) => O.push((0, l.jsxs)(s.Anchor, {
                        focusProps: {
                            offset: 4
                        },
                        className: I.tag,
                    ...
                    }, t))) : (v = !0, h.forEach((e, t) => O.push((0, l.jsxs)(s.Anchor, {
                        ...
                        children: (0, l.jsx)("div", {
                            ...
                            className: u(g, I.container, E, (0, _.getThemeClass)(i), {
                                [I.disabled]: a
                            }),
        ...
        526887: function(e, t, n) {
            ...
            function d(e) {
                ...
                } = e, f = (0, l.useConfettiCannon)(n, u), p = (0, a.default)([o.default], () => o.default.useReducedMotion), I = r.useMemo(() => p ? s : {
                    confettiCanvas: n,
                    cannon: f,
        ...
        424562: function(e, t, n) {
            ...
            var E = n("446674"),
                _ = n("913144"),
                f = n("49111");
            let p = f.FormStates.CLOSED,
                I = {},
                h = !1;

            function T() {
                p = f.FormStates.CLOSED, I = {}, s = null, c = void 0, d = []
            }

            function S() {
                g(), N(), I = {}, p = f.FormStates.OPEN
            }
            ...
            var A = new C(_.default, {
                GUILD_IDENTITY_SETTINGS_INIT: function(e) {
                    s = e.guild, p = f.FormStates.OPEN, I = {}, c = e.source, d = e.analyticsLocations
                },
                ...
                GUILD_IDENTITY_SETTINGS_SUBMIT: function() {
                    p = f.FormStates.SUBMITTING, I = {}
                },
                GUILD_IDENTITY_SETTINGS_SUBMIT_FAILURE: function(e) {
                    var t;
                    if (p !== f.FormStates.SUBMITTING) return !1;
                    p = f.FormStates.OPEN, I = null !== (t = e.errors) && void 0 !== t ? t : {}
                },
                USER_PROFILE_UPDATE_FAILURE: function(e) {
                    p = f.FormStates.OPEN, I = e.errors
                },
        ...
        650484: function(e, t, n) {
            ...
            function f(e) {
                ...
                let {
                    ...
                    setReadySlideId: C
                } = (0, E.usePaymentContext)(), A = T.find(e => e.key === h);
                r.useEffect(() => {
                    N(null)
                }, [h, N]), u(null != A, "Unknown step for current payment flow.");
                let v = null !== (s = null == A ? void 0 : null === (t = A.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== s && s,
                    O = null == A ? void 0 : null === (n = A.options) || void 0 === n ? void 0 : n.bodyClassName,
                    m = void 0 !== p && p ? _.sliderBodyLarge : null == A ? void 0 : null === (l = A.options) || void 0 === l ? void 0 : l.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (c = null == A ? void 0 : null === (o = A.options) || void 0 === o ? void 0 : o.renderHeader) || void 0 === c || c ? f : null, A.renderStep(I), null == h || v ? null : (0, i.jsxs)(i.Fragment, {
                        children: [(0, i.jsx)(d.ModalContent, {
                            className: a(_.body, O),
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: _,
                            onClose: e => {
                                r(), null == f || f(e), e && (null == I || I())
                            },
                            onComplete: () => {
                                D = !0, null == p || p(), !N && ((0, u.setIsPersistentHelperHidden)(!0), (0, u.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: I,
                            analyticsLocations: h,
                            analyticsObject: T,
                    ...
                    onCloseCallback: () => {
                        !D && s.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: R,
                            location_stack: h
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == f || f(D), D && (!N && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == I || I())
                    },
        ...
        716849: function(e, t, n) {
            ...
            function T(e, t, n, i) {
                null != e && !(0, c.isPremium)(e) && n && (t && p(), i && (!s.default.isLoadedForSKU(E.PremiumSubscriptionSKUs.TIER_0) && !s.default.isFetchingForSKU(E.PremiumSubscriptionSKUs.TIER_0) && (0, o.fetchSubscriptionPlansForSKU)(E.PremiumSubscriptionSKUs.TIER_0), !s.default.isLoadedForSKU(E.PremiumSubscriptionSKUs.TIER_2) && !s.default.isFetchingForSKU(E.PremiumSubscriptionSKUs.TIER_2) && (0, o.fetchSubscriptionPlansForSKU)(E.PremiumSubscriptionSKUs.TIER_2)))
            }
        },
        ...
        235004: function(e, t, n) {
            ...
            class L extends o.default.Store {
                ...
                hasFetchedAllSounds() {
                    return N === r.FETCHED && g === r.FETCHED
                }
            }
            L.displayName = "SoundboardStore";
            var U = new L(u.default, {
                LOGOUT: function() {
                    h.clear(), T.clear(), A.clear(), v = !1, N = r.NOT_FETCHED, g = r.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: l
                    } = e, a = (null !== (n = T.get(r)) && void 0 !== n ? n : 0) + 1, o = (null !== (i = A.get(l)) && void 0 !== i ? i : 0) + 1;
                    T.set(r, a), A.set(l, o), l !== (null === (t = d.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (v = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(e) {
                    ...
                    let {
                        soundId: i,
                        userId: r
                    } = e, l = (null !== (t = T.get(i)) && void 0 !== t ? t : 0) - 1, a = (null !== (n = A.get(r)) && void 0 !== n ? n : 0) - 1;
                    l <= 0 ? T.delete(i) : T.set(i, l), a <= 0 ? A.delete(r) : A.set(r, a)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    h.set(f.DEFAULT_SOUND_GUILD_ID, t), g = r.FETCHED
                },
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    h = new Map(Object.entries(t.soundboardSounds)), C = new Set(t.favoritedSoundIds), S = new Set(t.localSoundboardMutes)
                },
        ...
        865372: function(e, t, n) {
            ...
            class h extends l.default.PersistedStore {
                initialize(e) {
                    this.waitFor(s.default), null != e && (E = e), this.syncWith([s.default], p), this.syncWith([u.default], I)
                }
                getState() {
                    return E
                }
        ...
        364685: function(e, t, n) {
                    ...
                    if (null != t) {
                        for (let [e, n] of t)
                            if (f.default.isMember(e) && !m.has(e)) {
                                for (let t of n) y(t, !0, p.default.getGuild(e));
                                R(e, n)
                            }
                    }
                },
            ...
            class G extends a.default.Store {
                initialize() {
                    this.waitFor(u.default, f.default, p.default)
                }
                get isLoaded() {
                    return 0 !== S
                }
            ...
            var w = new G(o.default, {
                BACKGROUND_SYNC: () => {
                    C = null, N = new Map, m = new Map, S = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    C = null, N = new Map, m = new Map, t.forEach(b), S = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    S = 0, A = [], N.clear(), g.clear(), C = null, m.clear(), m = new Map(m), O = !1, v = null
                },
                ...
                STICKER_PACKS_FETCH_SUCCESS: e => {
                    ...
                    t.forEach(e => M(e, !0)), v = Date.now(), O = !1
                },
        ...
        679428: function(e, t, n) {
            ...
            function p() {
                !__OVERLAY__ && (clearTimeout(_), _ = setTimeout(() => I(), 15e3))
            }
            ...
            async function h(e) {
                ...
                for (; a.length > 0;) {
                    ...
                    if (e.guildId !== c.FAVORITES) try {
                        ...
                        E.error(t), e.attempts += 1, e.attempts < 3 && a.push(e), await T(5e3)
                    }
                }
            }
        ...
        26092: function(e, t, n) {
            ...
            function O(e) {
                ...
                if (null == c) return m();
                d = null !== (t = e.section) && void 0 !== t ? t : d, A = null !== (n = e.section) && void 0 !== n ? n : d, null != e.subsection && null != d && (E[d] = e.subsection), null != e.scrollPosition && null != d && (_[d] = e.scrollPosition), T = !!e.openWithoutBackstack, s = u.FormStates.OPEN, f = {}, I = {
                    ...p = {
                ...
                }, g = null !== (i = e.onClose) && void 0 !== i ? i : null, N = null !== (r = e.analyticsLocation) && void 0 !== r ? r : null, C = null !== (l = e.analyticsLocations) && void 0 !== l ? l : [], v = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }

            function m() {
                s = u.FormStates.CLOSED, h = !1, p = null, A = null, I = null, c = null, d = null, E = {}, _ = {}, g = null, N = null, C = [], v = null
            }
            ...
            class L extends l.default.Store {
                ...
                hasChanges() {
                    return null != I && null != p && (!!this.isOpen() || S === u.DrawerTabTypes.USER_SETTINGS) && !r.isEqual(I, p)
                }
                isOpen() {
                    return h
                }
            ...
            var U = new L(a.default, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    var t;
                    c = d, d = e.section, N = null, C = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [], null != e.subsection && (E[d] = e.subsection)
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return S = e.tab, null == d && S === u.DrawerTabTypes.USER_SETTINGS && O({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
            ...
            let d = e => {
                ...
                switch (r) {
                    ...
                    case u.BotTagTypes.OFFICIAL:
                        E = !0, h = s.default.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP, I = s.default.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    ...
                    case u.BotTagTypes.AI:
                        E = !0, h = s.default.Messages.AI_GENERATED_TOOLTIP, I = s.default.Messages.AI_TAG;
                        break;
                    case u.BotTagTypes.REMIX:
                        E = !1, I = s.default.Messages.REMIXING_TAG;
                        break;
                ...
                let N = e => (0, i.jsxs)("span", {
                    ...
                    children: [_ ? null : g, p, (0, i.jsx)("span", {
                        className: c.botText,
                        children: I
                    })]
                });
        ...
        181114: function(e, t, n) {
            ...
            let h = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...T
                } = e, S = a.createRef(), g = (0, d.default)(S), N = !i && !o && !0 !== s && (!h || g);
                return (0, l.jsxs)(c.Button, {
                    ...
                    children: [t, N ? (0, l.jsx)(I, {
                        shinePaused: f,
                        className: u(_.buttonShine, h ? _.onlyShineOnHover : void 0, p),
                        shineSize: E
                    }) : null]
                })
            };
        ...
        461380: function(e, t, n) {
            ...
            let _ = {
                ...
                f = e => {
                    ...
                    if (!0 === T ? N = _.DOWN : !1 === T && (N = _.RIGHT), g) {
                        let e = {

    ...
    ["74724"], {
        ...
        889793: function(e, t, n) {
            ...
            function L(e) {
                ...
                } = (0, c.default)(o, u.default.EDIT_PROFILE_EFFECT_MODAL), [O, M] = r.useMemo(() => {
        ...
        717262: function(e, t, n) {
            ...
            var S = e => {
                ...
                }), L = I.default.isPremium(n), R = (0, E.default)(n.id), O = !!(null == R ? void 0 : R.getPreviewBio(h).value), M = p.UseLegacyChatInput.useSetting(), P = M && null != h ? c.default.parse(void 0, h).content : h, F = I.default.canUsePremiumProfileCustomization(n), y = (null == R ? void 0 : R.canUsePremiumProfileCustomization) || F, x = {
                    user: n,

    ...
    [24570, 33600, 84832, 96043, 71402], {
        ...
        652411: (t, e, n) => {
                ...
                return function(t) {
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            return new O(_(t.minValue, t.maxValue), _(t.minStart, t.maxStart), _(t.minFinal, t.maxFinal), _(t.minDuration, t.maxDuration), S(t.minDirection, t.maxDirection), E(t.easingFunctions)[0])
                    }
                }(h(h({}, t), {
                    valueType: "number"
                }))
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = w(t.minStart),
                                ...
                                I = w(t.minDirection),
                                P = w(t.maxDirection);
                            return new y(new O(_(n.x, r.x), _(f.x, d.x), _(p.x, h.x), _(v.x, g.x), S(I.x, P.x), E(t.easingFunctions)[0]), new O(_(n.y, r.y), _(f.y, d.y), _(p.y, h.y), _(v.y, g.y), S(I.y, P.y), E(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = I(t.minStart),
                                ...
                                w = I(t.minDirection),
                                P = I(t.maxDirection);
                            return new g(new O(_(n.x, r.x), _(f.x, d.x), _(p.x, h.x), _(v.x, y.x), S(w.x, P.x), E(t.easingFunctions)[0]), new O(_(n.y, r.y), _(f.y, d.y), _(p.y, h.y), _(v.y, y.y), S(w.y, P.y), E(t.easingFunctions)[0]), new O(_(n.z, r.z), _(f.z, d.z), _(p.z, h.z), _(v.z, y.z), S(w.z, P.z), E(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector3"
                }))
            ...
            var N = r.forwardRef((function(t, e) {
                ...
                var E = r.useCallback((function(t, e) {
                        g.current.set(t.id, {
                            confetti: t,
                            spriteCanvas: e
                        }), null == m.current && _()
                    }), [_]),
                    S = r.useCallback((function(t, e, n, r, o) {
                        var u, a = C(null !== (u = t.id) && void 0 !== u ? u : (0, i.v4)(), t, n, r, o);
                        return E(a, e), a
                    }), [E]),
                ...
                return r.useEffect((function() {
                    ...
                    return t("click", R, l), t("mousedown", N, c), t("mousemove", A, s), t("mouseup", x, f),
                        function() {
            ...
            function j(t) {
                ...
                if (!O.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = L(u, i),
                        c = P({}, e, R(a), null != i && null != o && (0, w.AB)(o) ? C(0, o) : A(u));
                    O.default.track(t, c, {
                        flush: n
                    })
                }
        ...
        133600: (t, e, n) => {
            ...
            var V = function(t, e) {
                ...
                W = function(t) {
                    ...
                    function n() {
                        ...
                        t.handleGoToLibrary = function() {
                            ...
                            (0, p.uL)(R.Z5c.APPLICATION_LIBRARY, {
                                state: {
                        ...
                        t.getAnimationStatus = function() {
                            return t.step === R.wZ8.OPEN ? I.SR.IDLE : I.SR.ACTION
                        };
                        return t
                    }
                    var i = n.prototype;
                    ...
                    i.render = function() {
                        var t, e, n = this.props,
                            ...
                            S = null != (null == c ? void 0 : c.userId) && null != E && null != (null == E ? void 0 : E.id) && c.userId === E.id;
                        switch (this.step) {
                            case R.wZ8.ERROR:
                                null == p || p(c, !1);
                                break;
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(l.ModalRoot, {
                                ...
                                className: A().modal,
                                "aria-labelledby": s,
                                children: [null != c.giftStyle && !m && (0, r.jsx)(P.Z, {
                                    defaultAnimationState: this.getAnimationStatus(),
                                    giftStyle: c.giftStyle,
                                    className: A().seasonalGiftIcon
                                }), (0, r.jsx)("div", {
                                    className: m ? void 0 : A().backSplash
                                }), (0, r.jsxs)(l.ModalContent, {
                                    className: u()((t = {}, M(t, A().content, !m),
                                        M(t, A().contentCustomGift, m), t)),
                                    children: [(0, r.jsx)(l.ModalCloseButton, {
                                        onClick: a,
                                        className: A().closeButton
                                    }), (null == c.giftStyle || m && b) && (0, r.jsx)(O.Z, {
                                        size: O.Z.Sizes.LARGE,
                                        game: i,
                                        skuId: c.skuId
                                    }), (0, r.jsxs)(l.Heading, {
                                        id: s,
                                        className: u()((e = {}, M(e, A().customGiftHeader, m && !b), M(e, A().header, !m || b), e)),
                                        variant: "heading-sm/semibold",
                                        children: [(0, r.jsx)("div", {
                                            className: u()(M({}, A().customGiftHeaderText, m)),
                                    ...
                                    }), m && null != c.giftStyle && !b && (0, r.jsx)(P.Z, {
                                        defaultAnimationState: this.getAnimationStatus(),
                                        className: A().giftAnimation,
                                        giftStyle: c.giftStyle
                                    }), m && this.state.opened && !this.state.accepted && null != h && "" !== h && !S && (0, r.jsxs)(r.Fragment, {
                                        children: [(0, r.jsx)(l.FormTitle, {
                                            children: C.Z.Messages.GIFT_SENDER_INFO.format({
                                                senderDisplayName: w.ZP.getName(v)
                                            })
                                        }), (0, r.jsx)(l.Heading, {
                                            id: s,
                                            className: A().customMessage,
                    ...
                    ! function(t, e, n) {
                        ...
                        get: function() {
                            ...
                            if (e && !r) {
                                if (n) {
                                    ...
                                    return C.Z.Messages.GIFT_SUBSCRIPTION_INFO.format({
                                        senderDisplayName: w.ZP.getName(a),
                                        timeInterval: (null == u ? void 0 : u.interval) === T.rV.MONTH ? C.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_MONTH : C.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_YEAR
                                    })
                                }
                                return C.Z.Messages.GIFT_RECIPIENT_INFO.format({
                        ...
                        get: function() {
                            ...
                            return C.Z.Messages.GIFT_SENDER_INFO.format({
                                senderDisplayName: w.ZP.getName(t)
                            })
                        }
                    }, {
                        key: "bodyText",
                ...
                q = a.ZP.connectStores([y.Z, b.Z, h.Z, v.Z, m.Z, f.Z], (function(t) {
                    var e = t.giftCode,
                        n = b.Z.get(e.skuId),
                    ...
                    return {
                        ...
                        application: r,
                        subscriptionPlan: null != e.subscriptionPlanId ? (0, S.oE)(e.subscriptionPlanId) : null,
            ...
            const K = function(t) {
                var e = t.channelContext,
                    ...
                    o = F(t, ["channelContext", "code", "customGiftMessage"]),
                    u = (0, _.Dt)(),
                    l = (0, a.e7)([v.Z], (function() {
                        return v.Z.get(n)
                    }));
                return null == l ? null : (0, r.jsx)(q, D(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != N[t] && null != N[t][e]) {
                        ...
                        if (null != r) {
                            ...
                            for (var a in N[t][e]) e === j ? d.ZP.isNewForumThread(a, e, r) && L[t][e]++ : o.default.compare(a, i) > 0 && !d.ZP.hasOpenedThread(a) && L[t][e]++
                        }
                    }
                }
            }
            ...
            var nt = {},
                ...
                at = function(t) {
                    ...
                    r.getActiveUnjoinedThreadsForParent = function(t, e) {
                        var n;
                        return t in N && null !== (n = N[t][e]) && void 0 !== n ? n : ot
                    };
                    ...
                    r.getActiveUnjoinedThreadsForGuild = function(t) {
                        var e;
                        return null !== (e = N[t]) && void 0 !== e ? e : rt
                    };
                    r.getActiveUnjoinedUnreadThreadsForGuild = function(t) {
                        var e;
                        return null !== (e = A[t]) && void 0 !== e ? e : nt
                    };
                    ...
                    r.getActiveThreadCount = function(t, e) {
                        var n, r, o, u;
                        return i().size(null !== (o = null === (n = R[t]) || void 0 === n ? void 0 : n[e]) && void 0 !== o ? o : {}) + i().size(null !== (u = null === (r = N[t]) || void 0 === r ? void 0 : r[e]) && void 0 !== u ? u : {})
                    };
                    return n
                }(u.ZP.Store);
                ...
                CHANNEL_DELETE: function(t) {
                    ...
                    if (null != e.guild_id && null != e.parent_id) {
                        ...
                        if (e.guild_id in x && e.parent_id in x[e.guild_id]) {
                            Object.keys(x[e.guild_id][e.parent_id]).forEach(J);
        ...
        750203: (t, e, n) => {
            ...
            var R = function(t) {
                ...
                if (null == e && null != l) {
                    ...
                    return (0, r.jsx)(s.Z, {
                        className: u()(S().gameIcon, h, p),
                        guild: l,
                        size: m
                    })
                }
                return null == e ? (0, r.jsx)(O, {
                    className: u()(S().gameIcon, y, p)
        ...
        58964: (t, e, n) => {
            ...
            function h(t, e) {
                ...
                var p, h, v, y, g, m = encodeURIComponent(l.toString()),
                    ...
                    S = "".concat(f, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(b, "&efr=").concat(O);

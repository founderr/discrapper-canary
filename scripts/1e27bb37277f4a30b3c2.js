(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [73393, 29202, 91683, 58635, 84832, 88110, 86502, 96043, 71402], {
        737264: e => {
            "use strict";
        ...
        980604: (e, t, n) => {
            ...
            function z() {
                V = T.Z.getGuildCount() >= 3 || i().size(s.Z.getMutablePrivateChannels()) >= 20;
                K = []
            }
            ...
            function X() {
                ...
                if (_.length > 0) {
                    var O;
                    (O = u).push.apply(O, [(0, l.o6)(R.Z.Messages.QUICKSWITCHER_DRAFTS)].concat(D(_)))
                }
                ...
                if (null != n) {
                    var T = v.ZP.getSelectableChannelIds(n).filter((function(e) {
            ...
            function J(e, t) {
                switch (x) {
                    case l.h8.USER:
                        var n = T.Z.getGuild(b.Z.getGuildId());
                ...
                if (t !== Y) {
                    ...
                    F = (0, l.gJ)(l.a8.DOWN, -1, B)
                } else {
                    var r = B[F];
                    null != r && r.type === l.h8.HEADER && (F = (0, l.gJ)(l.a8.DOWN, F, B))
                }
                re.emitChange()
            }
                    ...
                    var s = null == I || I.prevSend > r - 16e3 ? 1500 : 0,
                        f = setTimeout((function() {
                            if (null != I && I.channelId === t && n === u.default.getId() && null != I.timeout) {
                                ...
                                (function(e) {
                                    var t = g(e);
                                    return t === T ? 0 : Object.keys(t).length
                                })(t) > 5 || i.ZP.post({
                                    url: l.ANM.TYPING(t),
                                    oldFormErrors: !0
                                }).then((function(e) {
            ...
            var v = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        USER_AFFINITY_TTL: p,
                        fetching: E,
                        DEFAULT_AFFINITY_STORE_STATE: O,
                        state: h
                    }
                };
                return n
        ...
        796909: (e, t, n) => {
            ...
            function C() {
                ...
                (0, l.cn)() && (0, c.x7)() && O.Z.getAddedToMessages().forEach((function(e) {
            ...
            var U, M, w, D = (U = [], M = [], w = [], function() {
                ...
                j = function(e) {
                    ...
                    var r = n.prototype;
                    r.initialize = function() {
                        this.waitFor(_.Z, p.Z, h.default, s.Z, O.Z);
                        this.syncWith([O.Z, s.Z], C)
                    };
        ...
        786502: (e, t, n) => {
            ...
            var v = function(e, t) {
                ...
                y = function(e) {
                    var t = e.omitUserIds,
                        ...
                        I = void 0;
                    try {
                        for (var y, T = f.Z.getPrivateChannelIds()[Symbol.iterator](); !(O = (y = T.next()).done); O = !0) {
                            var g = y.value;
            ...
            var S, b = "minutes",
                ...
                A = "days",
                P = "never",
                R = (O(S = {}, r.INVITE_OPTIONS_30_MINUTES.value, {
                    value: 30,
                    type: b
                }), O(S, r.INVITE_OPTIONS_1_HOUR.value, {
                    value: 1,
                    type: N
                }), O(S, r.INVITE_OPTIONS_6_HOURS.value, {
                    value: 6,
                    type: N
                }), O(S, r.INVITE_OPTIONS_12_HOURS.value, {
                    value: 12,
                    type: N
                }), O(S, r.INVITE_OPTIONS_1_DAY.value, {
                    value: 1,
                    type: A
                }), O(S, r.INVITE_OPTIONS_7_DAYS.value, {
                    value: 7,
                    type: A
                }), O(S, r.INVITE_OPTIONS_30_DAYS.value, {
                    value: 30,
                    type: A
                }), O(S, r.INVITE_OPTIONS_FOREVER.value, {
                    value: 0,
                    type: P
                }), S);
        ...
        58964: (e, t, n) => {
            ...
            function p(e, t) {
                ...
                var _, p, E, O, h, I = encodeURIComponent(l.toString()),
                    v = encodeURIComponent(a()),
                    y = (E = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), O = null != (null === i() || void 0 === i() || null === (_ = i().ua) || void 0 === _ ? void 0 : _.match(E)), h = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !O, "iOS" !== (null === i() || void 0 === i() || null === (p = i().os) || void 0 === p ? void 0 : p.family) || h ? 1 : 0),

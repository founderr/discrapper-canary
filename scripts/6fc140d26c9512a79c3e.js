        ...
        563816: function(e, t, n) {
            ...
            var s = n("37983"),
                ...
                N = e => {
                    ...
                    }, [x, v, O]), L = a.useMemo(() => (0, c.canUseContextMenuCommands)(l, D.length, r.getCommandTypeCount(l, t, null == I ? void 0 : I.applicationCommandCounts)), [l, t, D.length, null == I ? void 0 : I.applicationCommandCounts]);
                    a.useEffect(() => {
                        if (L !== p.current) {
                            if (L) null == C || C();
                            p.current = L

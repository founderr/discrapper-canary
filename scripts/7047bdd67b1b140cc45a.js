        ...
        942456: function(e, t, s) {
            ...
            class eI extends r.PureComponent {
                ...
                renderRefundDetails() {
                    ...
                    return t = l.includes(n.SKU_TYPE) ? ea.default.Messages.BILLING_APPLICATION_CONSUMABLE_REFUND_TEXT_UNABLE.format({
                        supportURL: o
                    }) : u ? a.isPreorder && this.isSkuPreorder ? ea.default.Messages.BILLING_PREORDER_REFUND_TEXT.format({
                        supportURL: o
                ...
                renderRefundActions(e) {
                    ...
                    let o = (null === (t = u.sku) || void 0 === t ? void 0 : t.productLine) === ee.SKUProductLines.COLLECTIBLES,
                        d = e.includes(n.PURCHASE_DATE) ? Y.default : w.default,
                        c = e.includes(n.TIME_PLAYED) || (null === (a = u.premiumRefundDisqualificationReasons) || void 0 === a ? void 0 : a.includes($.PremiumRefundDisqualificationReason.PAST_REFUNDABLE_DATE)) ? Y.default : w.default;
                    if (!this.isPremium || !(0, Q.userInRefundExperiment)()) return (0, i.jsxs)("div", {
                        className: en.refundActions,
                        children: [(0, i.jsxs)("div", {
                            className: en.refundRules,
                            children: [this.renderRefundCriteria(u.isPreorder ? ea.default.Messages.BILLING_REFUND_RELEASE_DATE_SUBHEADER : ea.default.Messages.BILLING_REFUND_PURCHASE_DATE_SUBHEADER, d, ea.default.Messages.BILLING_REFUND_PURCHASE_DATE.format({
                                daysSincePurchase: this.daysSincePurchase
                            })), u.isSubscription || u.isGift || o ? null : this.renderRefundCriteria(ea.default.Messages.BILLING_REFUND_PLAY_TIME_SUBHEADER, c, null != this.timePlayed ? this.timePlayed.humanize() : ea.default.Messages.BILLING_REFUND_PLAY_TIME_NEVER_PLAYED)]
                        }), (0, i.jsx)(_.Anchor, {
                            href: ei(l),
                            children: ea.default.Messages.BILLING_REFUND_REPORT_A_PROBLEM
                        })]
                    });
                    let f = (null !== (r = u.premiumRefundDisqualificationReasons) && void 0 !== r ? r : [$.PremiumRefundDisqualificationReason.OTHER])[0],
                ...
                renderDescription() {
                    ...
                    let {
                        ...
                        expanded: c
                    } = this.state, E = n.sku, I = n.subscription, p = null != n.paymentSource && ee.PREPAID_PAYMENT_SOURCES.has(n.paymentSource.type);
                    if (null != I && 0 !== I.items.length) {
                        let e = [],
                            a = null;
                        if (I.type === ee.SubscriptionTypes.PREMIUM) I.items.forEach(t => {
                            let {
                                planId: s,
                                quantity: n
                            } = t;
                            (0, q.isPremiumBaseSubscriptionPlan)(s) ? (e.push(q.default.getDisplayName(s, !1, p)), a = et.SubscriptionPlanInfo[s].skuId) : (e.push("".concat(n > 1 ? "".concat(n, "x ") : "").concat(q.default.getDisplayName(s, !1, p))), null == a && (a = et.SubscriptionPlanInfo[s].skuId))
                        });
                        else if (I.type === ee.SubscriptionTypes.GUILD) {
                            let t = O.default.get(I.items[0].planId);
                            d(null != t, "Guild subscription plan should already have been loaded");
                            let s = t.interval === et.SubscriptionIntervalTypes.YEAR ? ea.default.Messages.YEARLY_GUILD_SUBSCRIPTION : ea.default.Messages.MONTHLY_GUILD_SUBSCRIPTION;
                            e.push(s.format({
                                planName: t.name
                            })), a = t.skuId
                        } else if (I.type === ee.SubscriptionTypes.APPLICATION) {
                            let t = O.default.get(I.items[0].planId);
                            d(null != t, "Application subscription plan should already have been loaded"), null != l ? e.push(ea.default.Messages.MONTHLY_APPLICATION_SUBSCRIPTION_V2.format({
                                tier: null == E ? void 0 : E.name
                            })) : e.push(ea.default.Messages.APPLICATION_SUBSCRIPTION_FROM_DELETED_APPLICATION), a = t.skuId
                        }
                        s = e.join(", "), t = (0, i.jsx)(b.default, {
                        ...
                        if (s = n.isPreorder ? ea.default.Messages.PREORDER_SKU_NAME.format({
                                name: E.name
                            }) : n.isGuildProductPurchase && n.isSoftDeletedProduct ? ea.default.Messages.GUILD_PRODUCT_BILLING_DELISTED_PRODUCT : E.name, null != o) {
                        ...
                        } else t = (null === (e = n.sku) || void 0 === e ? void 0 : e.productLine) === ee.SKUProductLines.COLLECTIBLES ? (0, i.jsx)(H.default, {
                ...
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        canRefund: () => {
                            ...
                            return null == e.sku || !(0, Z.hasFlag)(e.sku.flags, I.SKUFlags.GUILD_PRODUCT)
                        }
            ...
            function ep(e) {
                ...
                let {
                    ...
                    compactMode: u,
                    className: o
                } = e, d = null != n.sku && er.includes(n.sku.type), c = null != n.sku && d ? n.sku.applicationId : null, f = null === (t = n.sku) || void 0 === t ? void 0 : t.applicationId, E = (null === (s = n.subscription) || void 0 === s ? void 0 : s.type) === ee.SubscriptionTypes.APPLICATION, {
                    ...
                    return {
                        ...
                        gameApplication: null !== (a = S.default.getApplication(null != c ? c : "")) && void 0 !== a ? a : null === (e = n.sku) || void 0 === e ? void 0 : e.application,
                ...
                let R = (0, p.useStateFromStores)([U.default], () => U.default.getGuild(null == _ ? void 0 : _.guildId)),
                    T = d ? _ : void 0;
                return (0, i.jsx)(eI, {
                    applicationStatistics: I,
                    application: E ? N : T,

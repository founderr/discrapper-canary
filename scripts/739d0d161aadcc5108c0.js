    ...
    [84441], {
        84441: (e, t, n) => {
            ...
            var N, I, T = function(e, t) {
                ...
                C = new l.Z("AuthenticationActionCreators"),
                R = null;
            ! function(e) {
                e.MFA = "MFA";
                e.SUCCESS = "SUCCESS"
            ...
            function M(e) {
                return null == e ? O.Z.Messages.NETWORK_ERROR_REST_REQUEST : null != e.message ? e.message : null != e.code && Array.isArray(e.code) ? e.code[0] : O.Z.Messages.NETWORK_ERROR_REST_REQUEST
            }
            ...
            function w(e) {
                ...
                u.Z.dispatch(t).catch((function(e) {
                    var t;
                    C.error("Error while dispatching LOGOUT", e);
            ...
            const Z = {
                ...
                resetPassword: function(e, t, n) {
                    return A((function() {
                        var o, i, c, l, d, f, p, h, y, E, O, b, A, m;
                        return T(this, (function(g) {
                            switch (g.label) {
                                ...
                                case 2:
                                    d = g.sent(), f = d.body, p = f.mfa, h = f.sms, y = f.webauthn, E = f.ticket, O = f.token, b = f.backup, A = f.totp;
                                    return [2, {
        ...
        154209: (e, t, n) => {
            ...
            function I(e) {
                var t = e.request,
                    ...
                    o = e.showConfirm,
                    i = void 0 !== o && o,
                    s = O(e, ["request", "setSlide", "showConfirm"]),
                    ...
                    children: [(0, r.jsx)(m, {
                        ...
                        children: [(0, r.jsx)(u.Button, {
                            ...
                            onClick: function() {
                                d(!0);
                                y(null);
                                i.U2(JSON.parse(_)).then((function(e) {
                                    return n({
                                        mfaType: "webauthn",
            ...
            function R(e) {
                var t = e.request,
                    ...
                    S = _[1],
                    v = o.useRef(null),
                    O = f.Z.Messages.TWO_FA_ENTER_BACKUP_LABEL,
                    A = f.Z.Messages.TWO_FA_BACKUP_CODE;
            ...
            function M(e) {
                var t = e.request,
                    ...
                    S = _[1],
                    v = o.useRef(null),
                    O = t.methods.find((function(e) {
                        return "totp" === e.type
                    })).backup_codes_allowed,
                    A = O ? f.Z.Messages.TWO_FA_ENTER_TOKEN_LABEL : f.Z.Messages.TWO_FA_ENTER_TOKEN_NO_BACKUP_LABEL,
                    T = O ? f.Z.Messages.TWO_FA_AUTH_CODE : f.Z.Messages.TWO_FA_AUTH_CODE_NO_BACKUP;
                o.useEffect((function() {
                    if (a) {
                        var e;
                        null === (e = v.current) || void 0 === e || e.focus()
            ...
            function w(e) {
                var t = e.request,
                    ...
                    p = l[0],
                    y = l[1],
                    _ = b(o.useState(null), 2),
                    E = _[0],
                    S = _[1],
                    v = b(o.useState(!1), 2),
                    O = v[0],
                    A = v[1],
                    T = b(o.useState(null), 2),
                    C = T[0],
                    R = T[1],
                    M = b(o.useState(""), 2),
                    w = M[0],
                ...
                o.useEffect((function() {
                    ...
                    s.ZP.post({
                        ...
                        var t;
                        R(e.message || (null === (t = e.body) || void 0 === t ? void 0 : t.message))
                    })).finally((function() {
                        y(!1)
                    }))
                }), [t.ticket]);
                ...
                var L = null == E ? f.Z.Messages.TWO_FA_ENTER_SMS_TOKEN_SENDING : f.Z.Messages.TWO_FA_ENTER_SMS_TOKEN_SENT.format({
                    phoneNumber: E
                });
                return (0, r.jsxs)("form", {
                    onSubmit: function(e) {
                        ...
                        n({
                            ...
                            var t, n;
                            R(null !== (n = e.message) && void 0 !== n ? n : null === (t = e.body) || void 0 === t ? void 0 : t.message)
                        })).finally((function() {
                            A(!1)
                        }))
                    },
            ...
            function L(e) {
                var t, n, i, s, a = e.request,
                    c = e.mfaFinish,
                    l = e.onEarlyClose,
                    d = e.onClose,
                    f = e.width,
                    p = void 0 === f ? 440 : f,
                    h = b(o.useState(null !== (n = null === (t = a.methods[0]) || void 0 === t ? void 0 : t.type) && void 0 !== n ? n : "select"), 2),
                    y = h[0],
                    E = h[1],
                    O = b(o.useState(y), 2),
                    m = O[0],
                ...
                return (0, r.jsxs)(u.Slides, {
                    ...
                    children: [(0, r.jsx)(u.Slide, {
                        id: "select",
                        children: (0, r.jsx)(T, S({}, I))
                    }), (0, r.jsx)(u.Slide, {
                        id: "webauthn",
                        children: (0, r.jsx)(C, S({}, I))
                    }), (0, r.jsx)(u.Slide, {
                        id: "totp",
                        children: (0, r.jsx)(M, v(S({}, I), {
                            isSlideReady: "totp" === m
                        }))
                    }), (0, r.jsx)(u.Slide, {
                        id: "sms",
                        children: (0, r.jsx)(w, v(S({}, I), {
                            isSlideReady: "sms" === m
                        }))
                    }), (0, r.jsx)(u.Slide, {
                        id: "backup",
                        children: (0, r.jsx)(R, v(S({}, I), {
                            isSlideReady: "backup" === m
                        }))
                    }), (0, r.jsx)(u.Slide, {
                        id: "password",
                        children: (0, r.jsx)(k, v(S({}, I), {

    ...
    ["70201"], {
        ...
        304582: function(e, t, a) {
            ...
            function s(e) {
                var t;
                let s = e.id,
                    [o, r] = (0, n.useStateFromStoresArray)([d.default], () => [d.default.isFriend(s), null !== (t = d.default.getNickname(s)) && void 0 !== t ? t : null], [s]);
                if (!o) return null;
                let c = null == r ? u.default.Messages.ADD_FRIEND_NICKNAME : u.default.Messages.CHANGE_FRIEND_NICKNAME;
                return (0, i.jsx)(l.MenuItem, {
                    id: null == r ? "add-friend-nickname" : "edit-friend-nickname",
                    label: c,
                    action: () => {

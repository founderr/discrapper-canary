            ...
            var i = n("37983"),
                ...
                O = function(e) {
                    let {
                        ...
                        transitionState: r,
                        onClose: O
                    } = e, y = (0, s.useStateFromStores)([S.default], () => S.default.getGuild(t), [t]), D = (0, s.useStateFromStores)([p.default], () => p.default.getId()), b = (0, s.useStateFromStores)([T.default], () => T.default.getMember(t, D)), [M, G] = l.useState([]), w = (0, f.default)(), x = (0, h.useUID)();
                    if (l.useEffect(() => {

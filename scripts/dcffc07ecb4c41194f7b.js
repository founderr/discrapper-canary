        ...
        803039: (e, t, r) => {
                ...
                a.useEffect((function() {
                    ...
                    null != t && f.isReady && !b && (e = e.map((function(r, n) {
                        return setTimeout((function() {
                            n === e.length - 1 && y(!0);
                            f.createMultipleConfetti(w(t.getBoundingClientRect()), 50)
                        }), 100 * n)
                    })));
                    return function() {
                        var t = !0,
            ...
            var H = function(e) {
                var t, r, l = e.product,
                    ...
                    u = e.confettiCanvas,
                    S = e.category,
                    j = e.analyticsLocations,
                    E = (0, M.Z)(S),
                    I = E.confettiColors,
                    x = E.confettiSprites,
                    w = E.backgroundColors,
                    k = E.buttonColors,
                    L = (0, s.ZP)([C.default], (function() {
                        var e = C.default.getCurrentUser();
                        c()(null != e, "User cannot be undefined");
                        return e
                    })),
                    _ = null !== (t = l.items.find(O.M)) && void 0 !== t ? t : null,
                    B = null !== (r = l.items.find(A.H)) && void 0 !== r ? r : null,
                    Z = (0, p.Z)({
                        user: L,
                    ...
                    H = a.useRef(null),
                    U = (0, y.Z)(R(j).concat([b.Z.COLLECTIBLES_COLLECTED_MODAL])),
                    W = U.analyticsLocations,
                    V = U.AnalyticsLocationProvider;
                return null == _ && null == B ? null : (0, n.jsxs)(V, {
                    children: [(0, n.jsxs)("div", {
                        ...
                        children: [(0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsxs)("div", {
                                ...
                                children: [(0, n.jsx)(f.Heading, {
                                    ...
                                    color: "always-white",
                                    children: T.Z.Messages.COLLECTIBLES_YOU_COLLECTED.format({
                                        itemName: l.name
                                    })
                                }), (0, n.jsx)(f.Text, {
                                    color: "always-white",
                                    variant: "text-sm/normal",
                                    children: T.Z.Messages.COLLECTIBLES_PERMANENT_COLLECTION
                                })]
                            }), (0,
                                n.jsx)(f.Button, {
                                onClick: function() {
                                    ...
                                    (0, d.xf)();
                                    null != _ ? (0, v.ps)({
                                        initialSelectedDecoration: l.items.find(O.M),
                                ...
                                style: (0, P.Ch)(k),
                                children: T.Z.Messages.COLLECTIBLES_USE_NOW
                            })]
                        ...
                        confettiTarget: null != i ? i : H.current,
                        confettiCanvas: u,
                        sprites: x,
                        colors: I
                    })]
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [(0, n.jsx)(i.O_, {
                        ...
                        children: (0, n.jsx)(f.ModalContent, {
                            className: o()(D().modalInner, D().modalContentOverrides),
                            children: (0, n.jsx)(H, {
                                product: r,
                                category: l,
                                onClose: u,
        ...
        584228: (e, t, r) => {
            ...
            const i = function(e) {
                ...
                switch (e.skuId) {
                    ...
                    case n.T.ANIME:
                        return {
                            backgroundColors: ["#4B79B0", "#0F0E3A"],
                                buttonColors: ["#8A45C1", "#136897"], confettiSprites: [r(954512), r(398015)], confettiColors: ["#2C9BD9", "#E46A80", "#FFE500", "#BBA8D5", "#3EDDD3", "#E2B761"]
                        };
                    case n.T.BREAKFAST:
                        return {
                    ...
                    case n.T.DISXCORE:
                        return {
                            backgroundColors: ["#732565", "#111D40"], buttonColors: [a.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE_FOR_GRADIENTS.css, a.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE_FOR_GRADIENTS_2.css], confettiSprites: o, confettiColors: ["#F53273", "#9595FF", "#A7FA4E", "#331EAF"]
                        };
                    default:
                        return t
                }
        ...
        910358: (e, t, r) => {
            ...
            function R(e) {
                var t = e.onClose,
                    ...
                    v = (0, i.Z)(F(p).concat([o.Z.COLLECTIBLES_PAYMENT_MODAL])),
                    ...
                    A = O[0],
                    S = O[1],
                    j = [f.WA, f.s2].concat(F(f.yp), [f.wo, {
                        key: c.h8.CONFIRM,

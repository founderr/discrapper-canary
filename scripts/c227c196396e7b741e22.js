    ...
    ["97203"], {
        ...
        473070: function(e, t, l) {
            ...
            function x(e) {
                ...
                }, [L.filepath, M]), n.useEffect(() => () => {
                    null != R && URL.revokeObjectURL(R)
                }, [R]), n.useEffect(() => () => {
                    null != b && URL.revokeObjectURL(b)
                }, [b]);
                let [y, O] = n.useState(null === (x = null === (t = L.editMetadata) || void 0 === t ? void 0 : t.voiceAudio) || void 0 === x || x), [k, F] = n.useState(null === (g = null === (l = L.editMetadata) || void 0 === l ? void 0 : l.applicationAudio) || void 0 === g || g), [G, B] = n.useState({
                    start: null !== (I = null === (p = L.editMetadata) || void 0 === p ? void 0 : p.start) && void 0 !== I ? I : 0,
                    end: null !== (_ = null === (E = L.editMetadata) || void 0 === E ? void 0 : E.end) && void 0 !== _ ? _ : 0
                }), [V, U] = n.useState(L.name), H = n.useRef({
                    name: V,
                    editMetadata: {
                        start: G.start,
                        end: G.end,

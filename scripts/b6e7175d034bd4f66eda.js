    ...
    ["22961"], {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var l, s, c, d, E, _, f, I, h, A, p, T, N, S, O, v, g = (l = u, E = Array(32768), l.forEach(function(n) {
                        ...
                        var M = (_ = u, f = g, p = 1e6, T = 0, N = 1e6, S = 0, O = 1e6, v = 0, _.forEach(function(e) {
                                I = e[0] >> t, h = e[1] >> t, A = e[2] >> t, I < p ? p = I : I > T && (T = I), h < N ? N = h : h > S && (S = h), A < O ? O = A : A > v && (v = A)
                            }), new i(p, T, N, S, O, v, f)),
                        ...
                        D(m, a - m.size());
                        for (var R = new o; m.size();) R.push(m.pop());
                        return R
                    }
                }
            }();
            ...
            class c extends i.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: p,
                        retrySuccess: T
                    } = this.state, N = i.Children.count(o) > 0 ? (0, r.jsx)(a.Card, {
        ...
        447651: function(t, e, n) {
            ...
            function v(t, e, n) {
                ...
                if (o || (null == n ? void 0 : n.shouldHideMediaOptions) === !0 || !s.isPlatformEmbedded || null == t || ! function(t) {
                        let e = new URL(t),
                            n = S(t);
                        return (h.test(e.hostname) || e.origin === A) && !t.startsWith(p) && !(0, u.isRoleIconAssetUrl)(t) && null != n && T.has(n)
                    }(t)) return null;
                let c = function(t) {
                        let e = new URL(t);
        ...
        235004: function(t, e, n) {
            ...
            var m = new D(l.default, {
                LOGOUT: function() {
                    A.clear(), p.clear(), v.clear(), g = !1, S = 0, N = 0
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(t) {
                    ...
                    let {
                        soundId: i,
                        userId: o
                    } = t, u = (null !== (n = p.get(i)) && void 0 !== n ? n : 0) + 1, a = (null !== (r = v.get(o)) && void 0 !== r ? r : 0) + 1;
                    p.set(i, u), v.set(o, a), o !== (null === (e = d.default.getCurrentUser()) || void 0 === e ? void 0 : e.id) && (g = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(t) {
                    ...
                    let {
                        soundId: r,
                        userId: i
                    } = t, o = (null !== (e = p.get(r)) && void 0 !== e ? e : 0) - 1, u = (null !== (n = v.get(i)) && void 0 !== n ? n : 0) - 1;
                    o <= 0 ? p.delete(r) : p.set(r, o), u <= 0 ? v.delete(i) : v.set(i, u)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(t) {
                    ...
                    A.set(f.DEFAULT_SOUND_GUILD_ID, e), N = 2
                },

    ...
    [84991, 17081], {
                ...
                D = function(t) {
                    ...
                    r.render = function() {
                        var t, e = this.props.className,
                            ...
                            c = this.props.items[r];
                        return (0, o.jsxs)(f.Z, {
                            component: "div",
                            className: a()(P().wrapper, e),
                            children: [(0, o.jsx)(O.am, {
                                className: P().navPrev,
                                onClick: this.gotoPrev
                            }), null !== (t = c.component) && void 0 !== t ? t : (0, o.jsx)(I, {
                                item: c,
                                directionHistory: i
                            }, c.src), (0, o.jsx)(O.Pz, {
                                className: P().navNext,
        ...
        677483: (t, e, n) => {
            ...
            var v, O = {
                ...
                m = (f(v = {}, O.UP, s().up), f(v, O.RIGHT, s().right), f(v, O.DOWN, s().down), f(v, O.LEFT, s().left), v),
                g = function(t) {
                    ! function(t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        t.prototype = Object.create(e && e.prototype, {
        ...
        873308: (t, e, n) => {
            ...
            var y = function(t) {
                var e = t.width,
                    ...
                    b = t.className,
                    v = t.title,
                    O = p(t, ["width", "height", "color", "direction", "foreground", "className", "title"]);
...
//# sourceMappingURL=91ad2850cda358e8dd58.js.map
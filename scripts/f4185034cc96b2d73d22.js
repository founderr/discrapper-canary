(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [53329, 46025, 30527, 96043, 53686, 71402], {
        ...
        101566: (e, t, n) => {
            ...
            var v = new f.Z("UploaderBase.tsx"),
                S = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        e.prototype = Object.create(t && t.prototype, {
                            ...
                            return B(this, (function(a) {
                                switch (a.label) {
                                    case 0:
                                        ...
                                        r = t.files.indexOf(n);
                                        t.files = k(t.files.slice(0, r)).concat(k(t.files.slice(r + 1)));
                                        t._file = D(w({}, t._file), {
                                            items: t.files
                                        });
                                        return [4, (0, i.V)(n)];
                                    ...
                                    return new Promise((function(r, i) {
                                        switch (e.status) {
                                            ...
                                            case o.m.COMPLETED:
                                                ...
                                                break;
                                            case o.m.ERROR:
                                                t && e.error !== A.evJ.ENTITY_TOO_LARGE ? e.upload() : i(new Error("File failed to upload"));
                                                break;
                                            case o.m.CANCELED:

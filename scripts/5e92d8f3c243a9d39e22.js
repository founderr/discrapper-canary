...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [73597], {
        ...
        507711: (e, t, n) => {
            ...
            function v(e) {
                var t, n, r = null != e ? e : {},
                    ...
                    c = a[1],
                    s = l,
                    d = o.useCallback((n = (t = function(e, t, n, r) {
                        var o, a;
            ...
            var h = n(318715),
                ...
                I = function(e) {
                    var t = e.attachment,
                        n = t.url,
                        o = t.description,
                        i = M.XH.test(t.filename);
                    return (0, r.jsx)("div", {
                        className: w().mediaContainer,
                        children: i ? (0, r.jsx)(s.Z, {
                            className: u()(w().video, w().media),
                            controls: !0,
                            src: n
                        }) : (0, r.jsx)("img", {
                            className: u()(w().image, w().media),
                            src: n,
                            alt: o
                        })
                    })
                ...
                var t = e.channelId,
                    ...
                    p = v({
                        onSuccess: o.useCallback((function() {
                            l.Z.pop();
                            (0, a.showToast)((0, a.createToast)(j.Z.Messages.OBSCURED_CONTENT_MARK_FALSE_POSITIVE_SUCCESS, a.ToastType.CUSTOM));
                            s()
                        }), [s]),
                        onError: function() {
                            (0,
                                a.showToast)((0, a.createToast)(j.Z.Messages.ERROR_GENERIC_TITLE, a.ToastType.FAILURE))
                        }
                    }),
                    O = p.reportFalsePositive,
                    b = p.isReportFalsePositiveLoading,
                    y = function() {
                        s()
                    };
                void 0 !== d && 0 !== (null == d ? void 0 : d.length) || y();
                return (0, r.jsxs)(a.ModalRoot, {
                    ...
                    children: [(0, r.jsxs)(a.ModalContent, {
                        children: [(0, r.jsx)(a.ModalCloseButton, {
                            ...
                            className: w().header,
                            children: j.Z.Messages.OBSCURED_CONTENT_MARK_FALSE_POSITIVE_MODAL_HEADER
                        }), (0, r.jsx)(a.Text, {
                            variant: "text-sm/normal",
                            color: "header-secondary",
                            className: w().subheader,
                            children: j.Z.Messages.OBSCURED_CONTENT_MARK_FALSE_POSITIVE_MODAL_DESCRIPTION
                        }), 1 === d.length ? (0, r.jsx)(I, {
                            attachment: d[0]
                        }) : null]
        ...
        573597: (e, t, n) => {
            ...
            function Et(e, t) {
                if (null == t || !(0, dt.KP)(t, (0, dt.HH)(e))) return null;
                return (0, r.jsx)(u.MenuItem, {
        ...
        734777: (e, t, n) => {
            ...
            function M(e) {
                var t = e.type,
                    ...
                    N = (0, c.C1)(null, R);
                return null != T && t === d.S.STICKER ? (0, g.J8)(T) && !(0, g.V9)(T) ? null : P ? (0, r.jsx)(u.MenuItem, {
                    id: "unfavorite",
                    action: function() {
                        return (0, p.hW)(T.id)
                    },

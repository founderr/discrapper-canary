    ...
    [25978], {
        4629: (e, r, t) => {
            ...
            const v = o.memo((function(e) {
                ...
                var r = e.title,
                    ...
                    i = e.href,
                    v = e.children,
                    b = (e.messageId, e.channelId, p(e, ["onClick", "trusted", "title", "href", "children", "messageId", "channelId"])),
                    h = (0, s.Z)(a.Z.MASKED_LINK).analyticsLocations,
                    y = o.useCallback((function(r) {
                        return (0, c.q)(e, r, h)
                    }), [h, e]),
                    ...
                    O = l().sanitizeUrl(i);
                return (0, n.jsx)(u.Anchor, f(function(e) {
        ...
        998137: (e, r, t) => {
            ...
            var s, c, d = function(e, r) {
                ...
                f = "/__development/build_overrides",
                p = "/__development/link";
            s = (c = a((function(e) {
                return d(this, (function(e) {
                    switch (e.label) {
                        case 0:
                            e.trys.push([0, 2, , 3]);
                            return [4, i.Z.flushCookies()];
                        case 1:
                        case 2:
                            e.sent();
                            return [3, 3];
                        ...
                        switch (i.label) {
                            case 0:
                                ...
                                return [4, n.ZP.put({
                                    ...
                                    headers: {
                                        Authorization: null !== (r = o.default.getToken()) && void 0 !== r ? r : ""
                                    },
                                    oldFormErrors: !0
                                })];
                            case 1:
            ...
            function m(e) {
                var r;
                return n.ZP.post({
                    url: (0, l.pU)("/__development/create_build_override_link"),
                    body: e,
                    headers: {
                        Authorization: null !== (r = o.default.getToken()) && void 0 !== r ? r : ""
                    },
        ...
        585730: (e, r, t) => {
            ...
            var O = function(e) {
                ...
                var n = t.prototype;
                n.getCurrentBuildOverride = function() {
                    ! function() {
                        if (h === p.NotResolved) {
                            h = p.Resolving;
                            (0, i.Ce)().then((function(e) {
                                o.Z.dispatch({
            ...
            O.displayName = "BuildOverrideStore";
            const m = new O(o.Z, {
                BUILD_OVERRIDE_RESOLVED: function(e) {
                    var r = e.url,
                        t = e.override,
                        n = null == t ? p.Invalid : p.Resolved;
                    g = c(s({}, g), u({}, r, c(s({}, g[r]), {
                        state: n,
                        override: t
                    })))
        ...
        451030: (e, r, t) => {
            ...
            var l = "recentBuildOverrides";

            function u() {
                var e;
                return (null !== (e = n.Z.get(l)) && void 0 !== e ? e : []).filter((function(e) {
                    return null == e.exp || e.exp > Date.now()
                }))
            }

            function a(e, r) {
                if (null != r && null != e && null != e.targetBuildOverride.discord_web) {
                    var t = {
                        ...
                        o = u(),
                        a = [t].concat(i(o.filter((function(e) {
                            return t.id !== e.id
                        })))).slice(0, 5);
                    n.Z.set(l, a)
                }
        ...
        25978: (e, r, t) => {
            ...
            function P(e) {
                ...
                return C.wS ? (0, n.jsxs)(b.Clickable, {
                    className: f()(x().copyLink, i ? x().copied : null),
                    onClick: a,
                    children: [(0, n.jsx)(y.Z, {
                        className: x().copyLinkIcon
                    }), i ? D.Z.Messages.BUILD_OVERRIDE_LINK_COPIED : D.Z.Messages.BUILD_OVERRIDE_LINK_COPY]
                }) : null
            }
            ...
            function N(e) {
                ...
                return (0, n.jsxs)(o.Fragment, {
                    children: [(0, n.jsxs)("div", {
                        className: x().buildInfo,
                        children: [(0, n.jsx)(b.Text, {
                            variant: "text-sm/medium",
                            className: x().subHead,
                            children: r
                        }), (0, n.jsx)("div", {
                            className: x().buildDetails,
                            children: t
                        })]
                    }), (0, n.jsx)(b.Button, {
                        submitting: d,
                        color: i,
                        onClick: l,
                        className: f()(x().button, s ? x().disabledButtonOverride : null),
                        size: x().buttonSize,
                        disabled: s,
                        children: u
                    })]
            ...
            function Z(e) {
                var r, t = e.currentOverrides,
                    n = e.linkMeta,
                    o = e.applyBuildOverride,
                    i = e.clearBuildOverride,
                    l = e.submitting,
                    u = function(e, r, t) {
                        if (null == e || null == r) return {
                            valid: !1,
                            reason: D.Z.Messages.BUILD_OVERRIDE_INVALID
                        };
                        var n = e.releaseChannel,
                            o = e.expiresAt,
                            i = e.validForUserIds,
                            l = e.allowedVersions,
                            u = e.targetBuildOverride,
                            a = Object.keys(u);
                        if (0 === R().intersection(a, r).length) {
                            var s;
                            return {
                                valid: !1,
                                reason: D.Z.Messages.BUILD_OVERRIDE_INCOMPATIBLE_TARGETS.format({
                                    requestedTargets: a.map((function(e) {
                                        return null !== (s = j.o0[e]) && void 0 !== s ? s : "unknown"
                                    })).join(", ")
                                })
                            }
                        }
                        if (null != n && n !== window.GLOBAL_ENV.RELEASE_CHANNEL) {
                            var c = n === _.R5N.PTB ? n.toUpperCase() : "".concat(n.charAt(0).toUpperCase()).concat(n.slice(1));
                            return {
                                valid: !1,
                                reason: D.Z.Messages.BUILD_OVERRIDE_INCOMPATIBLE_CLIENT.format({
                                    releaseChannel: c
                                })
                            }
                        }
                        if (null != l && (null == t || !l.includes(t))) return {
                            valid: !1,
                            reason: D.Z.Messages.BUILD_OVERRIDE_INCOMPATIBLE_CLIENT.format({
                                releaseChannel: l.join(", ")
                            })
                        };
                        var d = null != o ? new Date(o).getTime() : null;
                        return null != d && d < Date.now() ? {
                            valid: !1,
                            reason: D.Z.Messages.BUILD_OVERRIDE_EXPIRED
                        } : i.length > 0 && !i.includes(w.default.getId()) ? {
                            valid: !1,
                            reason: D.Z.Messages.BUILD_OVERRIDE_INVALID_USER
                        } : {
                            valid: !0
                        }
                    }(n, ["discord_web"]);
                if (!u.valid) return r = u.reason, N({
                    subHead: D.Z.Messages.BUILD_OVERRIDE_ISNT_AVAILABLE,
                    buttonColor: b.Button.Colors.TRANSPARENT,
                    buttonText: "Invalid",
                    buildDetails: r,
                    disabled: !0
                });
                v()(null != n, "BuildOverrideEmbed.renderResolved: linkMeta should never be null if resolved");
                var a, s, c, d = n.targetBuildOverride.discord_web;
                v()(null != d, "BuildOverrideEmbed.renderResolved: linkMeta.targetBuildOverride.discord_web should never be null if resolved");
                if (function(e, r) {
                        return null != r && null != r.discord_web && e.id === r.discord_web.id && e.type === r.discord_web.type
                    }(d, t)) {
                    s = D.Z.Messages.BUILD_OVERRIDE_CLEAR;
                    a = i;
                    c = b.Button.Colors.RED
                } else {
                    s = D.Z.Messages.BUILD_OVERRIDE_APPLY;
                    a = o;
                    c = b.Button.Colors.GREEN
                }
                return N({
                    subHead: D.Z.Messages.BUILD_OVERRIDE_ID,
                    buildDetails: d.id,
                    buttonClick: a,
                    buttonText: s,
                    buttonColor: c,
            ...
            function S(e, r, t) {
                return (0, n.jsxs)(b.Text, {
                    variant: "text-xs/normal",
                    className: x().titleRegion,
                    children: [(0, n.jsx)("strong", {
                        className: x().title,
                        children: null != e && null != e.releaseChannel ? D.Z.Messages.BUILD_OVERRIDE_FOR.format({
                            releaseChannel: e.releaseChannel
                        }) : D.Z.Messages.BUILD_OVERRIDE
                    }), (0, n.jsx)(b.Anchor, {
                        className: x().infoLink,
                        href: E.Z.getArticleURL(_.BhN.BUILD_OVERRIDE_EMBED),
                        target: "_blank",
            ...
            const A = function(e) {
                var r = e.loading,
                    t = void 0 !== r && r,
                    i = e.currentOverrides,
                    l = e.linkMeta,
                    u = e.url,
                    a = e.applyBuildOverride,
                    s = e.clearBuildOverride,
                    c = B(o.useState(!1), 2),
                    d = c[0],
                    p = c[1],
                ...
                return (0, n.jsxs)("div", {
                    className: x().wrapper,
                    children: [S(l, u, t), (0, n.jsxs)("div", {
                        className: x().content,
                        children: [(0, n.jsx)(m, {
                            className: x().icon
                        }), t ? (0, n.jsxs)(o.Fragment, {
                            children: [(0, n.jsxs)("div", {
                                className: x().buildInfo,
                                children: [(0, n.jsx)("div", {
                                    className: f()(x().barLoader, x().barTitle)
                                }), (0, n.jsx)("div", {
                                    className: x().barLoader
                                })]
                            }), (0, n.jsx)("div", {
                                className: x().buttonLoader
                            })]
                        }) : Z({
                            currentOverrides: i,
                            linkMeta: l,
                    ...
                    return V(this, (function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, (0, s.f0)(e)];
                            case 1:
                                if (200 !== r.sent().status) throw new Error("Build override couldn't apply");
            ...
            const z = o.memo((function(e) {
                var r = e.url,
                    t = (0, a.cj)([c.C], (function() {
                        return c.C.getCurrentBuildOverride()
                    })),
                    i = (0, a.e7)([c.C], (function() {
                        return c.C.getBuildOverride(r)
                    })),
                    l = i.payload,
                    u = i.validatedURL,
                    s = t.state === c.Z.Resolving || i.state === c.Z.Resolving,
                    d = o.useCallback((function() {
                        if (null == l) return Promise.reject(new Error("Invalid override payload"));
                        (0, M.Z)(i.override, l);
                        return function(e) {
                            return H.apply(this, arguments)
                        }(l)
                    }), [l, i]);
                return null != u ? (0, n.jsx)(A, {
                    loading: s,
                    linkMeta: i.override,
            ...
            function K(e) {
                return null != e.target && (0, q.r)(e.target, null != e.title && "" !== e.title ? e.title : (0, i.Rp)(e.content))
            }

            function J(e) {
                return {
                    react: function(r, t, a) {
                        if (e.enableBuildOverrides && (0, u._G)(r.target)) return (0, n.jsx)(o.Fragment, {
                            children: (0, n.jsx)(z, {
                                url: r.target
                            }, r.target)
                        }, a.key);
                        var s = t(r.content, a),
                            c = "string" == typeof r.title && 0 !== r.title.length ? r.title : (0, i.Rp)(r.content),
                            d = (null == e ? void 0 : e.mustConfirmExternalLink) ? function(e) {
                        ...
                        if (a.previewLinkTarget && !K(r)) {
                            var f = "\n\n(".concat(r.target, ")");
                            if (c.length + f.length > 1024) {
                                f = "..." + f;
                                c = (c = c.substr(0, 1024 - f.length)).trimEnd()
                            }
                            c += f
                        }
                        return a.noStyleAndInteraction ? (0, n.jsx)("span", {
                            title: c,
                            children: s
                        }, a.key) : (0, n.jsx)(l.Z, {
                            title: c,

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [3021, 50865, 84832, 88110, 96043, 71402, 1459, 56645], {
        737264: e => {
            "use strict";
            ...
            function D(e) {
                ...
                if (!b.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== I.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        c = A({}, t, C(u), null != i && null != o && (0, S.AB)(o) ? R(0, o) : L(a));
                    b.default.track(e, c, {
                        flush: n
                    })
                }
                ...
                ue = function(e) {
                    ...
                    r.computeAllActiveJoinedThreads = function(e) {
                        ...
                        for (var n in C)
                            if (n === e || null == e)
                                for (var r in C[n])
                                    for (var i in C[n][r]) t.push(C[n][r][i].channel);
                        return t
                    };
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, o, a;
                        return i().size(null !== (o = null === (n = C[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== o ? o : {}) + i().size(null !== (a = null === (r = P[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== a ? a : {})
                    };
                    r.__getLocalVars = function() {
                        return {
                            activeJoinedThreads: C,
        ...
        598955: (e, t, n) => {
            ...
            function b(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : E.Yn.DEFAULT,
                    ...
                    N = void 0 !== A && A,
                    C = c.Z.supports(E.AN.DISABLE_VIDEO) && !n ? (0, r.jsx)(o.MenuCheckboxItem, {
                        id: "disable-video",
                ...
                return n ? [(0, r.jsx)(o.MenuCheckboxItem, {
                    ...
                    checked: I
                }, "self-deafen"), C] : [(0, r.jsx)(o.MenuCheckboxItem, {
                    id: "mute",
                    label: v.Z.Messages.SOUND_MUTE,
                    action: function() {
        ...
        877475: (e, t, n) => {
            ...
            const L = new P(i.Z, {
                ...
                VOICE_CHANNEL_SELECT: function(e) {
                    var t = e.channelId;
                    return null == t && null != b ? C(l.Z.getChannel(b), null) : C(l.Z.getChannel(t), t)
                },
                VOICE_STATE_UPDATES: function(e) {
                    return e.voiceStates.reduce((function(e, t) {
                        var n = t.channelId,
                            r = t.sessionId;
                        return u.default.getSessionId() !== r ? e : C(l.Z.getChannel(n), n) || e
                    }), !1)
                }
            })
        },
        ...
        223219: (e, t, n) => {
            ...
            var j = function(e) {
                ...
                r.hasChanges = function() {
                    return null != T && null != S && (!(!this.isOpen() && C !== l.cII.USER_SETTINGS) && !i().isEqual(T, S))
                };
                r.isOpen = function() {
                    return A
                };
            ...
            const G = new j(a.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    C = e.tab;
                    return null == b && C === l.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, h, E, v, m = encodeURIComponent(l.toString()),
                    ...
                    b = (h = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), E = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(h)), v = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !E, "iOS" !== (null === i() || void 0 === i() || null === (_ = i().os) || void 0 === _ ? void 0 : _.family) || v ? 1 : 0),

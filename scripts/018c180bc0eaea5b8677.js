    ...
    ["3839"], {
        ...
        172858: function(e, t, n) {
            ...
            let l = u,
                ...
                i = [n("606863"), l, n("164654"), n("540346"), n("526094"), n("367469"), n("23933"), {
                    src: n("283397"),
                    colorize: !1
                }],
                s = 28,
        ...
        750482: function(e, t, n) {
            ...
            function o(e) {
                let {
                    ...
                    alt: u,
                    ...l
                } = e, i = (0, a.useListingThumbnailUrl)(t, n);
                return (0, r.jsx)("img", {
                    src: i,
                    alt: u,
                    ...l
        ...
        671183: function(e, t, n) {
            ...
            function o(e) {
                ...
                return r.useEffect(() => {
                    l(null != o, "selectedSkuPricePreview cannot be null"), (0, i.openGuildProductPurchaseConfirmationModal)({
                        guildId: u,
        ...
        273093: function(e, t, n) {
            ...
            function d(e) {
                let {
                    ...
                    ...u
                } = e, l = (0, i.useStateFromStores)([s.default], () => s.default.getGuildProduct(n));
                        ...
                        children: (0, r.jsx)(i.PaymentContextProvider, {
                            ...
                            children: (0, r.jsx)(a.GiftContextProvider, {
                                children: (0, r.jsx)(o.PaymentModal, {
                                    initialPlanId: null,
                                    analyticsLocations: f,
                                    renderHeader: S.renderGuildProductPurchaseHeader,
                                    ...c
                                })
                            })
                        })
            ...
            class o extends r.default.PersistedStore {
                ...
                hasHotspot(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        n = !t && s[e];
                    return !(a.CONFERENCE_MODE_ENABLED || l.ProcessArgs.isDisallowPopupsSet()) && (n || !i.has(e))
                }
                hasHiddenHotspot(e) {
                    return i.has(e)
                }
        ...
        809810: function(e, t, n) {
            ...
            var I = new E(a.default, {
                ...
                INTERACTION_FAILURE: function(e) {
                    ...
                    let l = c[n];
                    if (null == l) return !1;
                    null === (t = l.onFailure) || void 0 === t || t.call(l, r, u), l.data.interactionType === i.InteractionTypes.APPLICATION_COMMAND ? p(n) : c[n] = {
                        ...l,
        ...
        752598: function(e, t, n) {
            ...
            let S = async e => {
                ...
                }), null != T && (0, f.queueInteractionComponentState)(n, S, T, i);
                let v = {
                    ...
                    if (!r.hasErr) {
                        ...
                        if (r.status >= 400 && r.status < 500 && r.body) {
                            if (r.body.code === h.AbortCodes.INVALID_FORM_BODY && r.body.errors) {
                                ...
                                null != u && ("INTERACTION_APPLICATION_COMMAND_INVALID_VERSION" === u.code || "INTERACTION_APPLICATION_COMMAND_INVALID" === u.code) && i.default.dispatch({
            ...
            let v = (e, t) => {
                ...
                let a = e.state === h.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : l.default.extractTimestamp(n) + 3e3) < Date.now(),
                    i = (null == t ? void 0 : t.data.interactionType) === o.InteractionTypes.APPLICATION_COMMAND,
                    s = e.isCommandType();
                if (i && r === E.InteractionState.QUEUED || s && e.state === h.MessageStates.SENDING && null != t) return 0;
                if (i && r === E.InteractionState.CREATED || e.hasFlag(h.MessageFlags.LOADING) && !u) return 1;
        ...
        217796: function(e, t, n) {
            ...
            function p(e) {
                let {
                    ...
                    isGift: A
                } = (0, s.useGiftContext)(), [C, v] = u.useState(!0);
                return (u.useEffect(() => {
                    let e = null != h;
                    p && I && e && v(!1)
                }, [p, I, h]), u.useEffect(() => {
                    ...
                    t(c.Step.REVIEW)
                }, [C, l, t, E, A, T, S]), C) ? (0, r.jsx)(d.default, {}) : l ? (0, r.jsx)(i.BlockedPaymentsContentModal, {
                    onClose: n
                }) : null
            }
        },
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, p = (0, l.useStateFromStores)([a.default], () => a.default.useReducedMotion), [E, I] = u.useState(d), h = u.useRef((0, s.getGiftAnimationData)(t, E)), [T, S] = u.useState(null == f), [A, C] = u.useState(!1), [v, N] = u.useState(-1), m = () => {
                    h.current = (0, s.getGiftAnimationData)(t, E), N(e => e + 1)
                }, _ = () => {
                    S(!1), C(!0), N(-1), I(d)
                };
                u.useEffect(() => {
            ...
            class C extends u.PureComponent {
                renderUsers() {
                    let {
                        ...
                        size: u,
                        extraDetail: l
                    } = this.props, a = [], i = e.length === t ? e.length : t - 1, s = this.renderMoreUsers(i), o = 0;
                    for (; o < i && o < e.length;) {
                        var c;
                        ...
                        a.push(t ? (0, r.jsx)("div", {
                            ...
                            children: i
                        }, A(null !== (c = e[o]) && void 0 !== c ? c : null, o)) : (0, r.jsx)(h.default, {
                ...
                render() {
                    let {
                        ...
                        popoutUserId: f
                    } = this.state, E = n.find(e => null != e && e.id === f), I = i && null == p.default.getUser(f);

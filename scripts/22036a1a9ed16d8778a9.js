    ...
    ["3240"], {
        ...
        953143: function(e, t, l) {
            ...
            function T(e) {
                ...
                null != m && (M.add(E.MAX_YEARS_AHEAD_RECURRING_EVENT, "years"), L.add(E.MAX_YEARS_AHEAD_RECURRING_EVENT, "years"));
                let D = e => {
                    a({
                        ...v,
                        endDate: e
        ...
        194250: function(e, t, l) {
            ...
            function x(e) {
                ...
                }, [t, U]), [b, w] = a.useState(null), F = a.useRef(null);
                a.useEffect(() => {
                    if (R) {
                        var e;
                    ...
                    children: [(0, n.jsx)("div", {
                        ...
                        children: [(0, n.jsxs)(i.FormItem, {
                            ...
                            onScheduleChange: e => {
                                ...
                                null != t && null != j && (null == l ? void 0 : l.isBefore(t)) && (n.scheduledEndTime = t.add(1, "hour").toISOString()), null != t && null != b && (n.recurrenceRule = (0, _.recurrenceOptionToRecurrenceRule)(b, t)), O(n)
                            },
                            ...
                            children: [(0, n.jsx)(i.Text, {
                                ...
                                children: [(0, n.jsx)(u.default, {
                                    ...
                                    makeURL: e => {
                                        ...
                                        if (null != x) {
                                            var l;
                                            return null !== (l = (0, I.default)((0, f.convertToFakeGuildEvent)(t, x, s))) && void 0 !== l ? l : null
                                        }
                                    },
                                    onChange: Y,
        ...
        590942: function(e, t, l) {
            ...
            function B(e) {
                let {
                    ...
                    valid: !0
                }], [f, E, D]), V = Object.keys(n).length, G = (0, m.isGuildScheduledEventActive)(l), P = e => Math.max(0, Math.min(e, V - 1)), [B, b] = r.useState(G ? 1 : 0), [w, F] = r.useState(!1), k = r.useMemo(() => y.slice(0, B + 1).map(e => e.valid).every(Boolean), [y, B]), Y = B >= y.length ? 3 : y[P(B)].slideId, z = 3 === Y, X = (0, A.useGuildEventModalStore)(e => e.onUpdateCanCloseModal);
                X(z);
            ...
            function b(e) {
                let {
                    ...
                    transitionState: a,
                    onClose: c
                } = e, E = (0, u.useStateFromStores)([I.default], () => I.default.getGuild(t)), T = (0, u.useStateFromStores)([m.default], () => m.default.getGuildScheduledEvent(n), [n]), N = (0, u.useStateFromStores)([_.default], () => _.default.getDefaultChannel(t), [t]), h = (0, C.getInitialGuildEventData)(T, N), [A, O] = r.useState(h), [R] = r.useState((0, C.isEditingEvent)(T)), [M, L] = r.useState(null), U = e => {
                    var t;

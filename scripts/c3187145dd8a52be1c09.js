    ...
    ["86514"], {
        ...
        75974: function(e, t, l) {
            ...
            function h(e) {
                ...
                } = e, h = (0, f.default)(), g = (0, u.useStateFromStores)([d.default], () => d.default.getInputDevices()), [_, N] = n.useState(function(e, t, l) {
                    if (null != t && null != l) {
                ...
                return null != _ && s(_), (0, a.jsx)(n.Fragment, {
        ...
        636909: function(e, t, l) {
            ...
            function Y(e) {
                let {
                    ...
                    sourceChanged: n,
                    onChangeSource: s
                } = e, r = (0, i.useStateFromStores)([N.default, x.default], () => (0, D.isWindows)() ? (0, b.default)(N.default, x.default) : null), o = (0, i.useStateFromStores)([d.default], () => (null == r ? void 0 : r.id) != null ? d.default.getApplication(r.id) : null), c = (0, i.useStateFromStores)([N.default], () => N.default.getRunningGames()), f = (0, i.useStateFromStoresArray)([d.default], () => c.map(e => null != e.id ? d.default.getApplication(e.id) : null).filter(M.isNotNullish), [c]), m = null;
            ...
            function X(e) {
                let {
                    ...
                    E.NotifyFriendsOnGoLive.updateSetting(t), j.default.track(H.AnalyticEvents.NOTIFY_STREAM_SETTING_UPDATE, {
                        value: t
                    })
                }, []), d = l >= 2 && l <= V.STREAM_NOTIFY_GUILD_MAX_SIZE;
            ...
            function Q(e) {
                let {
                    ...
                    onChangeGuild: O,
                    isAnimationDone: j
                } = e, M = (0, i.useStateFromStores)([p.default, C.default], () => C.default.getChannel(p.default.getVoiceChannelId())), D = (0, i.useStateFromStores)([P.default], () => P.default.GPUDriversOutdated), b = (0, i.useStateFromStores)([_.default], () => _.default.getSoundshareEnabled()), F = (0, i.useStateFromStores)([I.default], () => I.default.getCurrentUser()), B = (0, f.useEnableClips)(), V = (0, f.useShouldSeeClipsPremiumEarlyAccessGoLiveRoadblock)({
                    autoTrackExposure: !B
                }), z = (0, G.default)();
                ...
                let K = B ? (0, a.jsx)(S.default, {
                        guildId: E,
                        isAnimationDone: j
                    }) : V ? (0, a.jsx)(m.default, {}) : void 0,
                    Q = !!(null == t ? void 0 : t.id.startsWith("camera")),
                    q = null != F && F.verified && !F.bot,
                    $ = null != M && !(0, c.isPrivateGuildChannel)(M);
                return (0, a.jsxs)(n.Fragment, {
                    children: [Q ? (0, a.jsx)(U.default, {
                        selectedSource: t,
        ...
        23922: function(e, t, l) {
            ...
            function j(e) {
                ...
                }), i = m.default.supports(A.Features.GO_LIVE_HARDWARE), [o, f] = n.useState(null), [S, E] = n.useState(null), [g, N] = n.useState(null), p = null != g && g.length > 0, [L, O] = n.useState(u.DesktopSources.WINDOW), [j, M] = n.useState(!1), D = n.useRef(null), P = n.useRef(new d.Interval);
                n.useEffect(() => {
                    let e = P.current;
                    return T().then(e => {
                        let {

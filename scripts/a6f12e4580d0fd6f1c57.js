(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [89030], {
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            return new w(x(e.minValue, e.maxValue), x(e.minStart, e.maxStart), x(e.minFinal, e.maxFinal), x(e.minDuration, e.maxDuration), E(e.minDirection, e.maxDirection), O(e.easingFunctions)[0])
                    }
                }(h(h({}, e), {
                    valueType: "number"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = C(e.minStart),
                                ...
                                A = C(e.minDirection),
                                S = C(e.maxDirection);
                            return new y(new w(x(n.x, r.x), x(f.x, d.x), x(p.x, h.x), x(v.x, g.x), E(A.x, S.x), O(e.easingFunctions)[0]), new w(x(n.y, r.y), x(f.y, d.y), x(p.y, h.y), x(v.y, g.y), E(A.y, S.y), O(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var c = A(e.start),
                                ...
                                s = A(e.duration),
                                l = A(e.direction);
                            return new g(new w(t.x, c.x, u.x, s.x, l.x, e.easingFunction), new w(t.y, c.y, u.y, s.z, l.y, e.easingFunction), new w(t.z, c.z, u.z, s.z, l.z, e.easingFunction));
                        case "oscillating-random":
                            n = A(e.minValue), r = A(e.maxValue);
                            var f = A(e.minStart),
                                d = A(e.maxStart),
                                ...
                                C = A(e.minDirection),
                                S = A(e.maxDirection);
                            return new g(new w(x(n.x, r.x), x(f.x, d.x), x(p.x, h.x), x(v.x, y.x), E(C.x, S.x), O(e.easingFunctions)[0]), new w(x(n.y, r.y), x(f.y, d.y), x(p.y, h.y), x(v.y, y.y), E(C.y, S.y), O(e.easingFunctions)[0]), new w(x(n.z, r.z), x(f.z, d.z), x(p.z, h.z), x(v.z, y.z), E(C.z, S.z), O(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var _ = r.forwardRef((function(e, t) {
                ...
                var O = r.useCallback((function(e, t) {
                    ...
                    E = r.useCallback((function(e, t, n, r, o) {
                        var a, c = R(null !== (a = e.id) && void 0 !== a ? a : (0, i.v4)(), e, n, r, o);
                        return O(c, t), c
                    }), [O]),
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", j, u), e("mousedown", _, s), e("mousemove", I, l), e("mouseup", D, f),
                        function() {
                            window.removeEventListener("click", j), window.removeEventListener("mousedown", _), window.removeEventListener("mousemove", I), window.removeEventListener("mouseup", I)
                        }
                }), [j, _, I, D, u, s, l, f]), r.useEffect((function() {
                    var e = y.current,
        ...
        489030: (e, t, n) => {
                ...
                return null == f || null != d && !g ? (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(B, {
                        ...
                        children: [(0, r.jsx)(a.Text, {
                            ...
                            variant: "text-sm/normal",
                            children: g ? T.Z.Messages.CHANGE_DECORATION_MODAL_PREVIEW_STARTER_CHURNED : (0, P.EQ)([v, p]).with([!0, !0], (function() {
            ...
            const ue = function() {
                ...
                return (0, i.useMemo)((function() {
                    ...
                    return [{
                        section: G.PURCHASE,
                        items: r[G.PURCHASE].length > 0 ? [ae, ce].concat(ie(r[G.PURCHASE])) : r[G.PURCHASE],
                        height: 12,
            ...
            var ve = function() {
                ...
                ye = function(e) {
                    var t = e.children,
                        ...
                        o = e.isSelected,
                        c = void 0 !== o && o,
                        u = he(e, ["children", "className", "onSelect", "isSelected"]);
                    return (0,
                        r.jsx)(a.Clickable, pe(de({
                        className: S()(le().decorationGridItem, c ? le().selected : void 0, n)
                    }, u), {
                        onClick: i,
                        children: t
                    }))
            ...
            function Ae(e) {
                var t = e.user,
                    ...
                    S = A.category,
                    P = A.purchase,
                    j = E.ZP.canUseCollectibles(t),
                    R = i.useRef(null),
                    _ = (0, m.Z)(o),
                    I = (0, C.sr)(x, void 0 === h ? null == t ? void 0 : t.avatarDecoration : h),
                    D = function() {
                        v(x);
                        u()
                    },
            ...
            function Se(e) {
                var t = e.transitionState,
                    ...
                    p = d.categories,
                    h = d.isFetching,
                    v = (0, o.e7)([x.default], (function() {
                        return x.default.getCurrentUser()
                    })),
                    y = (0, u.Z)(n, c.Z.EDIT_AVATAR_DECORATION_MODAL),
                    m = y.AnalyticsLocationProvider,
                    b = y.analyticsLocations;
                i.useEffect((function() {
                    O.default.track(be.rMx.OPEN_MODAL, {
                        type: "Edit Avatar Decoration Modal",
                        location_stack: b
                    })
                }), [b]);
                return null == v ? null : (0, r.jsx)(m, {
        ...
        681714: (e, t, n) => {
            ...
            function f() {
                var e, t = (0, c.OE)().canUseCollectiblesIAP,
                    n = function() {
                        var e, t = (0, c.OE)().canUseCollectiblesIAP,
                    ...
                    d = n.error,
                    p = function() {
                        var e = (0, c.OE)().canUseCollectiblesIAP,

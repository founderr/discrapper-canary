    ...
    [11569], {
                    ...
                    return g(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                ...
                                o = (0, s.Z)();
                                e = (0, E.k9)(t);
                                return null != o && !p.Lr.has(o.type) && null != e && C(i) && (0, h.D)() ? [4, (0, m.w)()] : [2];
                            case 1:
                                n.sent();
            ...
            function M(t, i, o) {
                (0, x.PS)(t, (function(e) {
                    var a = i.guildId === O.X8,
                        r = a ? b.H$.DEFAULT : b.H$.CUSTOM,
                        s = null != e.joinSound ? b.MW.UPDATED : b.MW.ADDED;
                    e.joinSound = {
                        soundId: i.soundId,
        ...
        933878: (t, i, o) => {
            ...
            function A(t, i, o) {
                var e, r = T(t),
                    ...
                    d = null !== (e = h.Z.getState().animationType) && void 0 !== e ? e : I.q.BASIC,
                    p = {
                        animation_type: d,
        ...
        986279: (t, i, o) => {
            ...
            const g = new w(s.Z, {
                ...
                VOICE_CHANNEL_EFFECT_RECENT_EMOJI: function(t) {
                    ...
                    if (null != i) {
                        b.unshift(i);
                        (b = (0, e.uniqBy)(b, "name")).length > x.e5 + 1 && b.pop()
                    }
                },
        ...
        285629: (t, i, o) => {
            ...
            var R, j = {
                ...
                M = {
                    BASIC: [r],
                    PREMIUM: [s, n, x, y, d, p, c, l, u, k, f, m, _, b, h, E, O, I, v, w, g]
                },
        ...
        138049: (t, i, o) => {
                        ...
                        if (null != G[o]) {
                            ...
                            ! function(t, i, o, e) {
                                if (m.FB) _.ZP.inputEventRegister(parseInt(t), i, o, e);
                                    ...
                                    e.keyup && r.bindGlobal((0, b.BB)(i), (function() {
                                        return o(!1)
                                    }), "keyup");
                                    e.keydown && r.bindGlobal((0, b.BB)(i), (function() {
                                        return o(!0)
                                    }), "keydown");
                                    M[t] = r
                                }
                            ...
                            l.Z.validateKeybind((0, b.BB)(t.shortcut))
            ...
            function K(t) {
                ...
                if (!__OVERLAY__) {
                    ...
                    i.action === E.kg4.TOGGLE_OVERLAY_INPUT_LOCK ? f.default.track(E.rMx.OVERLAY_SETTINGS_UPDATED, {
                        hotkey: i.action === E.kg4.TOGGLE_OVERLAY_INPUT_LOCK ? (0, b.BB)(i.shortcut) : null
                    }) : i.action === E.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET && f.default.track(E.rMx.OVERLAY_SETTINGS_UPDATED, {
                        text_activation_hotkey: i.action === E.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET ? (0, b.BB)(i.shortcut) : null
                    })
                }
                Y(i)
            }
            ...
            var q = [function() {
                ...
                return d().reduce(k.Z.getShortcuts(), (function(t, i, o) {
                    ...
                    if (null == e) Y(B({
                        ...
                        K({
                            keybind: C(A({}, e), {
                                shortcut: "string" == typeof i ? (0, b.Kd)(i) : i,
                                context: o
                            })
                        })
                    }
                ...
                return !!h.Z.enabled && X(E.kg4.TOGGLE_OVERLAY_INPUT_LOCK, "shift+`")
            }, function() {
                return !!h.Z.enabled && X(E.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET, "]`")
            }, function() {
            ...
            l.Z.setGetKeybindList((function() {
                var t = [];
                for (var i in U) U.hasOwnProperty(i) && t.push((0, b.BB)(U[i].shortcut));
                return t
            }));
            var J = function(t) {
                ! function(t, i) {
                ...
                return d().reduce(e, (function(t, o, e) {
                    ...
                    if (null == i || i < 2)
                        if ("string" == typeof o.shortcut) {
                            ...
                            o.shortcut = (0, b.Kd)(o.shortcut)
                        } else o.shortcut = o.shortcut.map((function(t) {
                            return t.length < 3 ? L(t).concat([(0, b.dU)()]) : t
                        }));
                    t[e] = o;
                    return t
                }), {})
        ...
        887643: (t, i, o) => {
            ...
            function Et() {
                Et = P((function() {
                    var t, i, o, e, a, r, s, n, x, y, d, c, l, u, k, f, m, _, b, h, E, O, v, g, S, A, C, P, N, L, D, R, j, M, U, Z, F, G, H = arguments;
                    return W(this, (function(V) {
                        switch (V.label) {
                            ...
                            case 7:
                                ...
                                null === (y = (x = w.ZP.getDiscordUtils()).globalOverlaySetTrackedGame) || void 0 === y || y.call(x, i.pid, i.windowHandle, _, b, h, E);
                                return [3, 10];
                            case 8:
            ...
            function Rt(t) {
                ...
                "USER_SETTINGS_PROTO_UPDATE" === t.type && (t = M(j({}, t), {
                    settings: {
                        ...
                        proto: (0, b.cv)(t.settings.type, t.settings.proto)
                    }
                }));
                Q.add(t);
            ...
            var Gt = new Ft(r.Z, __OVERLAY__ ? {} : {
                ...
                RPC_SERVER_READY: function(t) {
                    ...
                    a.append("build_id", "52451b9afa199b6ad3fbd2bb28eb7d1aa26d83f8");

                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: S,
                            location_stack: p
                        }), (0, a.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == h || h(y), y && (!R && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == A || A())
                    },
                ...
                M = function(e) {
                    let {
                        ...
                        if (null == M || M(e), (null == W ? void 0 : W.status) === g.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                            ...
                            null != o ? A = g.AnalyticsObjectTypes.TRIAL : r && (A = g.AnalyticsObjectTypes.GIFT), (0, c.default)({
                                isGift: r,
                                initialPlanId: null,
                                subscriptionTier: a,
                                analyticsLocations: E,

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [70232], {
            ...
            var C = function(e, t) {
                ...
                S = function(e) {
                    ...
                    s.renderLegalTerms = function() {
                        ...
                        if (!(!n && t || a) && h) {
                            var f = A.Z.Messages.BILLING_LEGAL_MUMBO_JUMBO_TERMS_LABEL_V2.format({
                                primaryText: A.Z.Messages.PAYMENT_MODAL_BUTTON_PREMIUM_GIFT,
                                paidURL: d.EYA.PAID_TERMS
                            });
                            return (0, r.jsx)("div", {
                                className: i()(P().checkboxLabel, l),
                                children: f
                            })
                        }
                        return !n && t || a ? null : (0, r.jsx)(u.Checkbox, {
                            ...
                            disabled: c,
                            className: i()(P().checkbox, o),
                            children: (0, r.jsx)("div", {
                                className: i()(P().checkboxLabel, l),
                                children: null != s ? s : A.Z.Messages.BILLING_LEGAL_MUMBO_JUMBO_TERMS_LABEL.format({
                ...
                b = function(e) {
                    ...
                    function n() {
                        ...
                        e.handleChange = function(t) {
                            t === y ? u.ZP.showOpenDialog(["openDirectory"]).then((function(t) {
        ...
        910740: (e, t, n) => {
            ...
            var U = function() {
                    return [N.Z.Messages.APPLICATION_STORE_PURCHASE_CONFIRMATION_TITLE_1, N.Z.Messages.APPLICATION_STORE_PURCHASE_CONFIRMATION_TITLE_2, N.Z.Messages.APPLICATION_STORE_PURCHASE_CONFIRMATION_TITLE_3, N.Z.Messages.APPLICATION_STORE_PURCHASE_CONFIRMATION_TITLE_4]
                },
                w = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                    ...
                    function n() {
                        ...
                        e.handleInventoryClick = function() {
                            p.Z.open(E.oAB.INVENTORY);
                            e.props.onClose()
                        };
                        e.handleGoToLibrary = function() {
                            (0, I.uL)(E.Z5c.APPLICATION_LIBRARY);
                            e.props.onClose()
                        };
                        e.handleInstall = function() {
                            ...
                            if (!p && null != a && null != i) {
                                h.LO({
                                    ...
                                    manifestIds: i,
                                    installationPath: c,
                                    analyticsLocation: E.Sbl.APPLICATION_STORE_PAYMENT_MODAL
                                });
                                o();
                                (0, I.uL)(E.Z5c.APPLICATION_LIBRARY)
                            }
                    ...
                    s.getHeaderBlurb = function() {
                        var e = this.props,
                            ...
                            n = e.application,
                            r = e.isIAP;
                        if (t.isPreorder() && null != t.preorderReleaseAt) return N.Z.Messages.APPLICATION_STORE_PREORDER_PURCHASE_CONFIRMATION_BLURB.format({
                            applicationName: n.name,
                            date: t.preorderReleaseAt.format("MMMM DD")
                        });
                        if (r || [E.epS.DURABLE, E.epS.CONSUMABLE].includes(t.type)) return N.Z.Messages.APPLICATION_ADDON_PURCHASE_CONFIRMATION_BLURB.format({
                            applicationName: n.name,
                            itemName: t.name
                        });
                        if (t.type === E.epS.BUNDLE) return N.Z.Messages.APPLICATION_STORE_BUNDLE_PURCHASE_CONFIRMATION_BLURB.format({
                            name: t.name
                        });
                        var a = t.supportedOperatingSystems[0];
                        return N.Z.Messages.APPLICATION_STORE_PURCHASE_CONFIRMATION_UNSUPPORTED_OS.format({
                            name: n.name,
                            operatingSystem: (0, v.XK)(a)
                        })
                    };
                    s.renderInstallationHeader = function() {
                        ...
                        return (0, r.jsx)("div", {
                            className: C().blurb,
                            children: N.Z.Messages.APPLICATION_STORE_PURCHASE_CONFIRMATION_BLURB.format({
                                name: e.name
                            })
                        })
                    };
                    s.renderInstallationBody = function() {
                        ...
                        return (0, r.jsxs)(a.Fragment, {
                            children: [(0, r.jsx)(d.Z, {
                                ...
                                children: N.Z.Messages.APPLICATION_STORE_PURCHASE_INSTALL_GAME
                            })]
                        })
                    };
                    ...
                    s.renderBlurbBody = function() {
                        var e, t = this.props,
                            ...
                            o = t.onClose;
                        if (s.isPreorder()) {
                            e = N.Z.Messages.APPLICATION_PREORDER_PURCHASE_CONFIRMATION_BUTTON;
                            o = this.handleGoToLibrary
                        } else e = n ? N.Z.Messages.APPLICATION_IAP_PURCHASE_RETURN_TO_GAME : N.Z.Messages.OKAY;
            ...
            const x = s.ZP.connectStores([T.Z, _.Z, A.Z, P.Z], (function(e) {

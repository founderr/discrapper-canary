(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [34669, 78367, 88110, 96043, 71402], {
        ...
        971402: (t, e, n) => {
            ...
            function p(t, e, n, r) {
                ...
                if (null == t.currentTarget.contains || t.currentTarget.contains(t.target)) {
                    ...
                    if (0 === p && 0 === _) {
                        var O, d = null === (O = t.target) || void 0 === O ? void 0 : O.getBoundingClientRect(),
                            E = null != d ? d : {},
                            I = E.left,
                            S = void 0 === I ? 0 : I,
                            h = E.top,
                    ...
                    if ((null == n ? void 0 : n.enableSpellCheck) && (0, i.nI)()) var N = (0, u.RD)((function() {
                        N();
                        s(g)
                    }));
                    else {
        ...
        396043: (t, e, n) => {
            ...
            function R(t) {
                ...
                return {
                    ...
                    guild_member_perms: String(null !== (n = O.Z.getGuildPermissions(e)) && void 0 !== n ? n : T.ZP.NONE),
            ...
            function L(t) {
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (e = O.Z.getChannelPermissions(t)) && void 0 !== e ? e : T.ZP.NONE),
                    channel_hidden: n
                }
            }
            ...
            function j(t) {
                ...
                if (!y.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== b.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(i),
                        a = M(u, o),
                        c = m({}, e, R(a), null != o && null != i && (0, g.AB)(i) ? A(0, i) : L(u));
                    y.default.track(t, c, {
                        flush: n
                    })
                }
        ...
        248046: (t, e, n) => {
            ...
            function N(t) {
                ...
                if (null != n.permissions && n.permissions.length > 0)
                    ...
                    } var a, l, p, _ = (null != i ? i : []).map((function(t) {
                        return t.name
                    })),
                    O = (null != i ? i : []).map((function(t) {
            ...
            function m(t) {
                return null == t ? void 0 : t.map((function(t) {
                    ...
                    return t.type === s.jw.CHANNEL && "channel_types" in t ? b(v({}, o), {
                        channelTypes: t.channel_types
                    }) : t.type !== s.jw.NUMBER && t.type !== s.jw.INTEGER || !("min_value" in t) && !("max_value" in t) ? t.type === s.jw.STRING && ("min_length" in t || "max_length" in t) ? b(v({}, o), {
            ...
            function P(t) {
                ...
                if (n.hasOwnProperty("id")) {
                    if (null == n.options || 0 === n.options.length) return [N({
                        rootCommand: e,
                        command: n,
                        applicationId: r,
                        subCommandPath: o,
                ...
                } else if (n.type !== s.jw.SUB_COMMAND && n.type !== s.jw.SUB_COMMAND_GROUP && (null == n.options || 0 === n.options.length)) return [N({
                    rootCommand: e,
                    command: n,
                    applicationId: r,
                    subCommandPath: o,
                ...
                for (var p = n.options.filter((function(t) {
                ...
                0 === a.length && 0 === p.length && u.push(N({
                    rootCommand: e,
                    command: n,
                    applicationId: r,
                    subCommandPath: o,
            ...
            function M(t, e, n, r) {
                return !!j(d.Z, p.Z, !1, t) && (t.isPrivate() && n > 0 || (null !== (o = null == r ? void 0 : r[e]) && void 0 !== o ? o : 0) > 0);
                var o
            }
            var j = function(t, e, n, r) {
                    return !n && (r.isMultiUserDM() ? e.getIntegrations(r.id).length > 0 : r.isDM() ? !r.isSystemDM() && (null != r.rawRecipients.find((function(t) {
                        return t.bot
                    })) || e.getIntegrations(r.id).length > 0) : !r.isArchivedLockedThread() && (!!(0, _.Em)(r.type) && t.can(c.Z.combine(h.Pl.USE_APPLICATION_COMMANDS, h.Pl.SEND_MESSAGES), r)))
                },
                D = c.Z.deserialize(0);
            ...
            function G(t, e, n) {
                var r = n[(0, f.rE)(t.userId, E.Kw.USER)];
            ...
            function x(t) {
                switch (t) {
                    ...
                    case E.bB.APPLICATION_LAUNCHER:
                        return O.d.ApplicationLauncherCommand
                }
            }

            function k(t) {
                if (null != t) return t.id === I.bi.BUILT_IN ? E.ub.BUILT_IN : t.id === I.bi.FRECENCY ? E.ub.FRECENCY : E.ub.APP
            }
        ...
        165586: (t, e, n) => {
            ...
            var E = [d(r.RESOLUTION_720), d(r.RESOLUTION_1080), d(r.RESOLUTION_1440), d(r.RESOLUTION_SOURCE, (function() {
                ...
                y = [d(o.FPS_15), d(o.FPS_30), d(o.FPS_60)],
                T = [d(o.FPS_15, (function() {
        ...
        948832: (t, e, n) => {
            ...
            var E = new Map,
                ...
                T = function(t) {
                    ...
                    r.getIntegrations = function(t) {
                        var e;
                        return null !== (e = E.get(t)) && void 0 !== e ? e : y
                    };
                    r.getIntegration = function(t, e) {
                        var n;
                        return null === (n = E.get(t)) || void 0 === n ? void 0 : n.find((function(t) {
                    ...
                    r.getIntegrationsFetchState = function(t) {
                        var e;
                        return null !== (e = I.get(t)) && void 0 !== e ? e : _.NOT_FETCHED
                    };
            ...
            var b = new T(o.Z, {
                ...
                CHANNEL_SELECT: function(t) {
                    var e = t.channelId;
                    if (null == e || I.get(e) !== _.FETCH_FAILED) return !1;
                    I.set(e, _.NOT_FETCHED)
                },
                ...
                FETCH_PRIVATE_CHANNEL_INTEGRATIONS_FAIL: function(t) {
                    var e = t.channelId;
                    I.set(e, _.FETCH_FAILED)
                },
                PRIVATE_CHANNEL_INTEGRATION_CREATE: function(t) {
                    var e = t.integration,
                        n = E.get(e.channel_id);
                    if (null == n) return !1;
                    E.set(e.channel_id, v(p(n).concat([(0, u.F)(e)])))
                },
        ...
        491260: (t, e, n) => {
            ...
            function j(t) {
                ...
                delete R[t];
                if (null != N[t]) {
                    var e = h(u().sortBy(N[t], (function(t) {
                            return -t.timestamp
                        })), 1),
                        n = e[0];
            ...
            function k(t) {
                var e = !0,
                    ...
                    r = void 0;
                try {
                    for (var o, i = Object.keys(N)[Symbol.iterator](); !(e = (o = i.next()).done); e = !0) {
                        x(t, o.value)
                    }
                } catch (t) {
                    n = !0;
            ...
            var F = function(t) {
                ...
                r.getActivities = function(t) {
                    ...
                    if (null == e) {
                        var n;
                        return null !== (n = P[t]) && void 0 !== n ? n : g
                    }
                    var r = C(t, e);
                ...
                r.getAllApplicationActivities = function(t) {
                    var e = [],
                        ...
                        o = void 0;
                    try {
                        for (var i, u = Object.keys(P)[Symbol.iterator](); !(n = (i = u.next()).done); n = !0) {
                            var a = i.value,
                                l = P[a],
                                c = !0,
                                s = !1,
                                f = void 0;
                            try {
                                for (var p, _ = l[Symbol.iterator](); !(c = (p = _.next()).done); c = !0) {
                                    var O = p.value;
            ...
            const H = new F(l.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(t) {
                    ...
                    if (m[e] === t.status && P[e] === t.activities) return !1;
                    m[e] = t.status;
                    P[e] = t.activities;
                    delete A[e]
                }
        ...
        223219: (t, e, n) => {
            ...
            function j(t) {
                ...
                if (null == c) return D();
                y = null !== (e = t.section) && void 0 !== e ? e : y;
                w = null !== (n = t.section) && void 0 !== n ? n : y;
                null != t.subsection && null != y && (T[y] = t.subsection);
                null != t.scrollPosition && null != y && (v[y] = t.scrollPosition);
                ...
                N = _({}, g);
                A = null !== (r = t.onClose) && void 0 !== r ? r : null;
            ...
            var G = function(t) {
                ...
                r.hasChanges = function() {
                    return null != N && null != g && (!(!this.isOpen() && R !== l.cII.USER_SETTINGS) && !o().isEqual(N, g))
                };
                r.isOpen = function() {
                    return m
                };
            ...
            const x = new G(u.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(t) {
                    ...
                    null != t.subsection && (T[y] = t.subsection)
                },
                USER_SETTINGS_MODAL_CLEAR_SUBSECTION: function(t) {
                    var e = t.forSection;
                    null != e ? delete T[e] : null != y && delete T[y]
                },
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(t) {
                    var e = t.forSection;
                    null != e ? delete v[e] : null != y && delete v[y]
                },
                USER_SETTINGS_MODAL_UPDATE_ACCOUNT: function(t) {
                    var e = t.settings;
                    null == N && (N = {});
                    var n = N[l.oAB.ACCOUNT];
                    N[l.oAB.ACCOUNT] = _({}, n, e)
                },
                ...
                DRAWER_SELECT_TAB: function(t) {
                    R = t.tab;
                    return null == y && R === l.cII.USER_SETTINGS && j({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        449401: (t, e, n) => {
            ...
            const s = (0, o.hN)((function(t) {
                var e = t.width,
                    ...
                    p = t.foreground,
                    _ = c(t, ["width", "height", "color", "foreground"]);
        ...
        349491: (t, e, n) => {
            ...
            const s = (0, o.hN)((function(t) {
                var e = t.width,
                    ...
                    p = t.className,
                    _ = t.foreground,
                    O = c(t, ["width", "height", "color", "className", "foreground"]);
                return (0, r.jsx)("svg", l(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
        ...
        985651: (t, e, n) => {
            ...
            const _ = (0, o.hN)((function(t) {
                var e = t.width,
                    ...
                    c = p(t, ["width", "height", "color"]);
                return (0,
                    r.jsx)("svg", f(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
        ...
        73105: (t, e, n) => {
            ...
            function b(t) {
                ...
                T.error("".concat(t, " is not a valid locale."))
            }
            var g = function() {
                    function t(e) {
                        var n = this;
                        ...
                        this.languageDetector = new _(o, (function(t) {
                            var r = "".concat(t, "-").concat(n.regionPreference);
                            if (-1 !== e.indexOf(r)) n.setLocale(r);
                            else {
                                var i, a = null !== (i = u[t]) && void 0 !== i ? i : O[o];
                    ...
                    e.setLocale = function(t) {
                        ...
                        null === (e = v.setLocale(t)) || void 0 === e || e.then((function(e) {
                            T.info("Switching to ".concat(t), e ? "(available)" : "(unavailable)")
                        }))
                    };

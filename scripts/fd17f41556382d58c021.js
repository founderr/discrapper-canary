        ...
        58964: (e, t, n) => {
            ...
            function p(e, t) {
                ...
                var p, m, _, v, y, S = encodeURIComponent(c.toString()),
                    ...
                    b = (_ = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), v = null != (null === o() || void 0 === o() || null === (p = o().ua) || void 0 === p ? void 0 : p.match(_)), y = "Safari" === (null === o() || void 0 === o() ? void 0 : o().name) && !v, "iOS" !== (null === o() || void 0 === o() || null === (m = o().os) || void 0 === m ? void 0 : m.family) || y ? 1 : 0),
                    E = null != r ? encodeURIComponent(r) : null,
                    g = null != i ? encodeURIComponent(i) : null,
                    O = "".concat(s, "/?link=").concat(S, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(h, "&efr=").concat(b);

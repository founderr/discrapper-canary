    ...
    ["78995"], {
        ...
        888503: function(e, t, l) {
            ...
            var a = l("37983"),
                ...
                N = l("782340"),
                L = l("282730");
            let T = (0, I.cssValueToNumber)(i.default.MEMBER_LIST_ITEM_AVATAR_DECORATION_PADDING);
            var A = function(e) {
                let {
                    selected: t = !1,
                    colorString: l,
                    ...
                    tabIndex: X,
                    itemProps: Q
                } = e, $ = g.default.useName(M), [ee, et] = r.useState(!1), [el, ea] = r.useState(null), {
                    ...
                    ea(e)
                }, eu = () => null != i && i && null == T ? (0, a.jsx)(u.Tooltip, {
                    ...
                    let e = (null == M ? void 0 : M.isClyde()) ? E.BotTagTypes.AI : E.BotTagTypes.BOT;
                ...
                return null == M ? (0, a.jsx)(p.default, {
                    ...
                    name: null == T ? (0, a.jsx)("span", {
                        ...
                        children: e => (0, a.jsx)("span", {
                            ...e,
                            className: s(L.username, L.lostPermission),
                            children: ec()
                        })
                    }),
                    avatar: ((e, t) => {
                        let l = F ? u.AnimatedAvatar : u.Avatar,
                            r = (0, o.default)(P) ? S.StatusTypes.STREAMING : b;
                        return r = t ? void 0 : r, (0, a.jsxs)(a.Fragment, {
                            children: [(0, a.jsx)(l, {
                                ...
                                confettiLocation: j.ConfettiLocation.MEMBER_USER
                            })]
                        })
                    })(M, ef),
                    subText: (() => {
                        let e = null != P ? P.find(e => e.type === S.ActivityTypes.CUSTOM_STATUS) : null,
            ...
            let s = e => {
                ...
                return (0, a.jsxs)("svg", {
                    ...
                    children: [(0, a.jsx)("path", {
                        d: "M5.00007 18C4.44778 18 4.00007 18.4477 4.00007 19C4.00007 20.6569 5.34321 22 7.00007 22L17.0001 22C18.6569 22 20.0001 20.6569 20.0001 19C20.0001 18.4477 19.5524 18 19.0001 18H5.00007Z",
                        fill: "string" == typeof s ? s : s.css,
                        className: i
                    }), (0, a.jsx)("path", {
                        d: "M3.03517 7.76355C2.23911 7.20977 1.19989 7.99951 1.52025 8.91481L3.76569 15.3303C3.90607 15.7314 4.2846 16 4.70955 16H19.256C19.6976 16 20.087 15.7103 20.2139 15.2873L22.148 8.84011C22.4232 7.92303 21.3764 7.18088 20.602 7.74402L16.4899 10.7347L12.9373 5.40589L13.7574 4.58579C14.0809 4.26227 14.0809 3.73773 13.7574 3.41421L12.5859 2.24264C12.2623 1.91912 11.7378 1.91912 11.4143 2.24264L10.2427 3.41421C9.91918 3.73773 9.91918 4.26227 10.2427 4.58579L11.0628 5.40589L7.44561 10.8317L3.03517 7.76355Z",
                        fill: "string" == typeof s ? s : s.css,
                        className: i
                    })]
                })
        ...
        367376: function(e, t, l) {
            ...
            let c = {
                ...
                g = d(i.default.GUILD_EVENT_RULES, [(0, s.default)(c)]),
                C = d(i.default.INLINE_REPLY_RULES, [(0, s.default)({
                    ...c,
                    emoji: {
                        height: 14,
                        width: 14,
                ...
                S = d(i.default.AUTO_MODERATION_SYSTEM_MESSAGE_RULES, [(0, s.default)(c)]),
                E = r.omit(d(i.default.RULES, [(0, s.default)({
                    ...c,
                    emoji: {
                        height: 14,
                        width: 14
            ...
            var j = {
                ...
                parseGuildEventDescription: n.reactParserFor(g),
                parseAutoModerationSystemMessage: n.reactParserFor(S),
                parseForumPostGuidelines: n.reactParserFor(m),
                parseForumPostMostRecentMessage: n.reactParserFor(C),
                parseNotifCenterMessagePreview: n.reactParserFor(E),
                ...
                parseAutoModerationSystemMessageToAST: n.astParserFor(S)
            }
        },
        ...
        643306: function(e, t, l) {
            ...
            function M(e) {
                let {
                    ...
                    children: R,
                    inlinePreview: P = !1
                } = e, y = (0, o.useStateFromStores)([m.default], () => m.default.roleStyle), b = null != t && 0 !== t && !P, F = b && "dot" === y, U = e => (0, a.jsxs)(j.default, {
                ...
                return !w || P || null == s || null == M || null == r && "@everyone" !== p ? U() : (0, a.jsx)(d.Popout, {
                    ...
                    renderPopout: e => {
                        let t = I.default.getChannel(s),
                            n = C.default.getGuild(M),
                            u = g.default.getMembers(n.id),
                            ...
                            m = i(u).filter(e => {
                                ...
                                let r = S.default.getUser(e.userId);
        ...
        470648: function(e, t, l) {
            ...
            function E(e) {
                let {
                    ...
                    channelId: E,
                    inlinePreview: j = !1
                } = e, N = (0, i.useStateFromStores)([v.default], () => v.default.getUser(r)), L = (0, i.useStateFromStores)([m.default], () => m.default.getChannel(E)), T = null != L ? L.getGuildId() : null, A = j || null == N || null == T || null == E ? void 0 : e => {
                ...
                }, _ = C.default.useName(N), M = (0, i.useStateFromStores)([m.default, p.default, x.default], () => g.default.getNickname(T, E, N)), R = h.default.getGuild(T), P = (0, d.useClydeEnabled)(R, L), y = P && r === S.CLYDE_AI_USER_ID ? S.CLYDE_AI_MENTION_COLOR : null, b = e => (0, a.jsx)(I.default, {
                    className: t,
                    onContextMenu: A,
                    color: y,
                    ...e,
                ...
                return j ? b() : (0, a.jsx)(u.Popout, {
                    preload: null == N ? void 0 : () => (0, c.default)(N.id, N.getAvatarURL(T, 80), {
        ...
        11056: function(e, t, l) {
            ...
            let d = r.forwardRef(function(e, t) {
                ...
                j.className = s(j.className, o.container, {
                    [o.selected]: p,
                    [o.highlighted]: S,
                    [null != I ? I : ""]: p,
                    [o.clickable]: !p && (null != x || null != m)
                }), j["aria-selected"] = null !== (l = j["aria-selected"]) && void 0 !== l ? l : p;
                let N = (0, a.jsxs)("div", {
                    className: s(g, o.layout, {
                        [o.muted]: !p && h,
                        [o.wrappedLayout]: C
                    }),

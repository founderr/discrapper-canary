    ...
    ["3050"], {
        ...
        743506: function(e, t, _) {
            ...
            var E, i, a = _("37983"),
                ...
                A = _("782340"),
                c = _("676702");
            (i = E || (E = {}))[i.INITIAL = 0] = "INITIAL", i[i.OTHER_REASON = 1] = "OTHER_REASON";
            ...
            function R(e) {
                let {
                    ...
                    onClose: C,
                    canBulkBan: m = !1
                } = e, [d, U] = n.useState(N), [p, P] = n.useState(""), [g, D] = n.useState(E.INITIAL), [G, f] = n.useState(!1), h = (0, r.useTrackModerationAction)(t, {
                    location: R,
                    ...
                    if (null != M) {
                        ...
                        if (null == i) return;
                        I.default.banUser(t, null == i ? void 0 : i.id, d, p)
                    }
                    h(r.ModerationActionType.BAN), C()
                }, [M, h, C, L, m, G, p, t, d, i]), H = n.useCallback(e => {
                    U(e)
                }, []), b = n.useCallback(e => {
                    let {
                        value: t
                    ...
                    return null == i ? "" : A.default.Messages.BAN_CONFIRM_TITLE.format({
                        username: "@".concat(u.default.getName(t, null, i))
                    })
                })();
                    ...
                    children: [(0, a.jsx)(l.ModalHeader, {
                        ...
                        children: [(0, a.jsxs)(T.default, {
                            ...
                            children: [G && (0, a.jsx)(l.FormErrorBlock, {
                                ...
                                steps: [E.INITIAL, E.OTHER_REASON],
                                step: g,
                                children: (e => {
                                    switch (g) {
                                        case E.INITIAL:

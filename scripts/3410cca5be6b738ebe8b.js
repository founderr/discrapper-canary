        ...
        123398: (e, t, n) => {
            ...
            var te = function(e) {
                ...
                r.getFeaturedItemsFetchStatus = function(e) {
                    var t;
                    return null !== (t = b[e]) && void 0 !== t ? t : M
                };
                r.getPaginationStatus = function(e) {
                    var t;
                    return null !== (t = N[e]) && void 0 !== t ? t : w
                };
                ...
                r.getIsItemFeatured = function(e) {
                    var t, n = (0, f.jR)(e),
                        r = e.guildId;
                    return !!(null === (t = Z[r]) || void 0 === t ? void 0 : t.has(n))
                };
                ...
                r.getFeaturedItemByMessageId = function(e, t) {
                    var n;
                    return Object.values(null !== (n = V[e]) && void 0 !== n ? n : []).find((function(e) {
                        return "message" in e && e.message.id === t
                    }))
                };
                r.__getLocalVars = function() {
                    return {
                        DEFAULT_FETCH_STATUS: M,
                        DEFAULT_PAGINATION_STATUS: w,
                        lastFetchedMillisByGuild: R,
                        fetchStatusByGuild: G,
                        paginationStatusByGuild: N,
                        fetchFeaturedItemsStatusByGuild: b,
                        dataByGuild: L,
                        messageToGuildIdMap: F,
                        messageCache: U,
                        feedItemMapByGuildId: P,
                        KEY_PAD_LENGTH: 5,
                        hidingItems: x,
                        hiddenItems: B,
                        featuredItemIds: Z,
            ...
            const ne = new te(u.Z, {
                ...
                GUILD_FEED_FETCH_SUCCESS: function(e) {
                    ...
                    if (!(i in L) || L[i].load_id === u.load_id) {
                        ...
                        var g = null !== (l = null === (r = N[i]) || void 0 === r ? void 0 : r.offset) && void 0 !== l ? l : 0;
                        N[i] = {
                            offset: g + T,
                ...
                GUILD_FEED_UNFEATURE_ITEM: function(e) {
                    ...
                    ! function(e, t) {
                        var n, r;
                        null === (n = Z[e]) || void 0 === n || n.delete(t);
                        null === (r = V[e]) || void 0 === r || delete r[t]
                    }(t.guildId, (0, f.jR)(t))
                },
                CHANNEL_SELECT: function() {
                    ...
                    try {
                        for (var r, i = Object.keys(x)[Symbol.iterator](); !(e = (r = i.next()).done); e = !0) {
                            var u = r.value;
                            null == B[u] && (B[u] = new Set);
                            B[u] = new Set(h(Array.from(B[u])).concat(h(Array.from(x[u]))));
                            delete x[u]
                        }
                    } catch (e) {
                        t = !0;
                ...
                MESSAGE_UPDATE: function(e) {
                    var t = e.message;
                    return J(t.channel_id, t.id, (function(e) {
                        return (0, a.wi)(e, t)
                    }))
                },
                ...
                MESSAGE_REACTION_ADD_MANY: function(e) {
                    var t = e.channelId,
                        ...
                        r = e.reactions,
                        i = l.default.getId();
                    return J(t, n, (function(e) {
                        return e.addReactionBatch(r, i)
                    }))
                },
                MESSAGE_REACTION_REMOVE: $,
                MESSAGE_REACTION_REMOVE_ALL: function(e) {
                    return J(e.channelId, e.messageId, (function(e) {
            ...
            function h(e, t) {
                switch (e.type) {
                    ...
                    case u.w.MESSAGE_BUNDLE:
                        ...
                        return {
                            type: u.w.MESSAGE_BUNDLE, id: e.id, sortIndex: t, messages: D, featured: !1, highlighted: !1, unreadMention: null !== (A = e.unread_mention) && void 0 !== A && A, seen: e.seen
                        };
...
//# sourceMappingURL=3410cca5be6b738ebe8b.js.map
...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [62439], {
        162439: (e, t, r) => {
            ...
            function b(e) {
                var t, r, d, h, b = e.transitionState,
                    g = e.onClose,
                    v = e.entry,
                    I = y(a.useState(null !== (t = v.description) && void 0 !== t ? t : ""), 2),
                    E = I[0],
                    x = I[1],
                    D = y(a.useState(null !== (r = v.primaryCategoryId) && void 0 !== r ? r : u.AR.UNCATEGORIZED), 2),
                    S = D[0],
                    _ = D[1],
                    C = y(a.useState(!1), 2),
                    A = C[0],
                    T = C[1],
                    w = y(a.useState(null), 2),
                    j = w[0],
                    M = w[1],
                    N = (h = (d = function() {
                        var e;
                        return m(this, (function(t) {
                            switch (t.label) {
                                case 0:
                                    M(null);
                                    if (E === v.description && S === v.primaryCategoryId) return [3, 4];
                                    T(!0);
                                    t.label = 1;
                                case 1:
                                    t.trys.push([1, 3, , 4]);
                                    return [4, (0, s.Dr)(v.channelId, v.guildId, E, S)];
                                case 2:
                                    t.sent();
                                    T(!1);
                                    g();
                ...
                return (0, n.jsxs)(o.ModalRoot, {
                    ...
                    children: [(0, n.jsxs)(o.ModalHeader, {
                        ...
                        }), null != g && (0, n.jsx)(o.ModalCloseButton, {
                            className: f().closeButton,
                            onClick: g
                        })]
                    }), (0, n.jsxs)(o.ModalContent, {
                        className: f().createGuild,
                        paddingFix: !1,
                        children: [(0,
                            n.jsx)(o.FormItem, {

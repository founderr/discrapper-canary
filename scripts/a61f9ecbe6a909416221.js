    ...
    [92358, 29202, 91683, 58635, 84832, 57678, 58621, 96043, 86502, 71402], {
        ...
        980604: (e, t, n) => {
            ...
            function X() {
                ...
                if (null != n) {
                    ...
                    if (g.length > 0) {
                        u.push((0,
                            l.o6)(P.Z.Messages.QUICKSWITCHER_UNREAD_CHANNELS));
                        u = u.concat(g)
                    }
                }
            ...
            function J(e, t) {
                switch (x) {
                    ...
                    case l.h8.VOICE_CHANNEL:
                        ...
                        break;
                    case l.h8.GUILD:
                        e.unshift((0, l.o6)(P.Z.Messages.QUICKSWITCHER_QUERYMODE_GUILDS));
                        B = e;
                        break;
                    case l.h8.APPLICATION:
        ...
        796909: (e, t, n) => {
            ...
            function A(e) {
                ...
                if (null != o) {
                    var u = i()(o).valueOf(),
                        a = h.Z.fromTimestamp(u);
                    return h.Z.compare(r, a) > 0 ? r : a
                }
                return r
            }
            ...
            function R(e) {
                ...
                return {
                    channelId: e.id,
                    lastMessageId: t,
                    isFavorite: p.Z.isMessagesFavorite(e.id) && (0, l.cn)(),
                    isRequest: c.Z.isMessageRequest(e.id) || s.Z.isSpam(e.id)
                }
            }
            ...
            function P() {
                ...
                (0, l.cn)() && p.Z.getAddedToMessages().forEach((function(e) {
                    var t = d.Z.getChannel(e);
                    null != t && (0, f.zi)(t.type) && b.set(t.id, R(t))
                }))
            }

            function C() {
                var e = d.Z.getMutablePrivateChannels();
                for (var t in e) b.set(t, R(e[t]))
            }
            var L, U, M, w = (L = [], U = [], M = [], function() {
                    var e = b.values(S.FAVORITE),
                        t = b.values(S.DEFAULT);
                    if (L !== e || U !== t) {
                        M = [];
                        e.forEach((function(e) {
                            var t = e.channelId;
                ...
                D = function(e) {
                    ...
                    var r = n.prototype;
                    r.initialize = function() {
                        this.waitFor(d.Z, _.Z, I.default, c.Z, p.Z);
                        this.syncWith([p.Z, c.Z], P)
                    };
                    r.getPrivateChannelIds = function() {
                        return w()
                    };
                    r.getSortedChannels = function() {
                        return [b.values(S.FAVORITE), b.values(S.DEFAULT)]
                    };
                    r.serializeForOverlay = function() {
                        var e = {};
                        b.values().forEach((function(t) {
                            var n = t.channelId,
                                r = t.lastMessageId;
                            e[n] = r
                        }));
            ...
            const G = new D(a.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, f.hv)(e.type) || b.has(e.id)) && b.set(e.id, R(e))
                    }))
                },
                CHANNEL_CREATE: function(e) {
                    var t = e.channel;
                    if (!(0, f.hv)(t.type)) return !1;
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && b.set(t, R(r, n.id))
                },
                GUILD_CREATE: function(e) {
                    var t = e.guild.id;
                    return b.delete(t)

    ...
    ["50473"], {
            ...
            function p(e) {
                ...
                let l = (t = e, (0, u.useStateFromStoresArray)([c.default, a.default, s.default], () => {
                    ...
                    d = (0, u.useStateFromStoresObject)([c.default], () => null == l ? {} : l.reduce((e, t) => ({
                        ...e,
                        [t.id]: c.default.hasRsvp(t.id, t.guild_id)
                    }), {}), [l]);
                if (null != l && null != d)
        ...
        473031: function(e, t, n) {
            ...
            function y(e) {
                ...
                let {
                    ...
                    image: R,
                    recurrence_rule: w
                } = n, H = (0, i.useStateFromStores)([S.default], () => S.default.hasRsvp(L, A), [L, A]), b = (0, i.useStateFromStores)([r.default], () => r.default.isLurking(A), [A]), j = (0, i.useStateFromStores)([s.default], () => s.default.getStageInstanceByChannel(U), [U]), B = (0, i.useStateFromStores)([o.default], () => o.default.getChannel(U), [U]), k = (0, i.useStateFromStores)([E.default], () => E.default.getUser(V), [V]), {
                    speakers: W
                } = (0, m.default)({
                    id: U,
                    data: {
        ...
        659707: function(e, t, n) {
            ...
            function V(e) {
                ...
                return u.useEffect(() => {
                    C.default.getGuildEventUserCounts(V), C.default.getGuildEventsForCurrentUser(V)
                }, [V]), u.useEffect(() => {

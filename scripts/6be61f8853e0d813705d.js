        ...
        698211: (e, n, t) => {
            ...
            var te = function(e) {
                var n = e.transitionState,
                    ...
                    i = e.guildId,
                    a = e.children,
                    c = (0, s.e7)([W.Z], (function() {
                        return W.Z.getHardwareClassification()
                    })),
                    d = c === z.x.MEETS_MINIMUM || c === z.x.UNKNOWN,
                    f = c === z.x.BELOW_MINIMUM,
                    m = n === u.ModalTransitionState.ENTERED && o && (d || f) && !t,
                    h = ne((0, k.c)(m ? [G.z$.CLIPS_ONBOARDING_GO_LIVE_COACHMARK] : []), 2),
                    p = h[0],
                    g = h[1],
                    v = p === G.z$.CLIPS_ONBOARDING_GO_LIVE_COACHMARK;
            ...
            function qn(e) {
                var n = e.selectedSource,
                    ...
                    _ = e.transitionState,
                    j = e.isAnimationDone,
                    x = (0, s.e7)([y.Z, g.Z], (function() {
                        return g.Z.getChannel(y.Z.getVoiceChannelId())
                    })),
                    A = (0, s.e7)([ye.Z], (function() {
                        return ye.Z.GPUDriversOutdated
                    })),
                    R = (0, s.e7)([b.Z], (function() {
                        return b.Z.getSoundshareEnabled()
                    })),
                    Z = (0, s.e7)([E.default], (function() {
                        return E.default.getCurrentUser()
                    })),
                    T = (0, D.fH)(c, "go_live_modal", !0),
                    P = b.Z.supports(Ne.AN.SOUNDSHARE) ? (0, N.ED)() && !Oe().satisfies(null === _e.Z || void 0 === _e.Z ? void 0 : _e.Z.os.release, je.I9) ? J.Z.Messages.GO_LIVE_SCREENSHARE_UPDATE_WINDOWS_FOR_SOUNDSHARE : (0,
                ...
                null != n && n.id.startsWith("screen") ? P = J.Z.Messages.GO_LIVE_SCREENSHARE_NO_SOUND : null == P && b.Z.supportsEnableSoundshare() && R !== Y.rtk.ENABLED && (P = J.Z.Messages.GO_LIVE_SCREENSHARE_ENABLE_FOR_SOUNDSHARE.format({
                ...
                var M = Boolean(null == n ? void 0 : n.id.startsWith("camera")),
                    G = null != Z && Z.verified && !Z.bot,
                    U = null != x && !(0, w.Yk)(x),
                    k = G && U;
                return (0, r.jsxs)(l.Fragment, {
                    children: [M ? (0, r.jsx)(Ve, {
                        selectedSource: n,

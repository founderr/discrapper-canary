(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [40056], {
        753074: t => {
            ...
            t.exports = function(t, o, r) {
                if ("string" != typeof o) {
                    var s = Object.getOwnPropertyNames(o);
                    i && (s = s.concat(Object.getOwnPropertySymbols(o)));
                    for (var c = 0; c < s.length; ++c)
                        if (!(e[s[c]] || n[s[c]] || r && r[s[c]])) try {
                            t[s[c]] = o[s[c]]
                        } catch (t) {}
                }
                return t
                    ...
                    o.prototype._checkForIntersections = function() {
                        ...
                        this._observationTargets.forEach((function(o) {
                            var r = o.element,
                                ...
                                a = o.entry,
                                u = e && h && this._computeTargetAndRootIntersection(r, n),
                                l = o.entry = new i({
                            ...
                            a ? e && h ? this._hasCrossedThreshold(a, l) && this._queuedEntries.push(l) : a && a.isIntersecting && this._queuedEntries.push(l) : this._queuedEntries.push(l)
                        }), this);
                        this._queuedEntries.length && this._callback(this.takeRecords(), this)
                    };
                    o.prototype._computeTargetAndRootIntersection = function(n, i) {
                        if ("none" != t.getComputedStyle(n).display) {
                            for (var o, r, s, h, u, l, p, f, d = c(n), v = a(n), b = !1; !b;) {
                                var g = null,
                                ...
                                if (v == this.root || v == e) {
                                    b = !0;
                                    g = i
                                } else v != e.body && v != e.documentElement && "visible" != _.overflow && (g = c(v));
                                if (g && !(d = (o = g, r = d, s = void 0, h = void 0, u = void 0, l = void 0, p = void 0, f = void 0, s = Math.max(o.top, r.top), h = Math.min(o.bottom, r.bottom), u = Math.max(o.left, r.left), l = Math.min(o.right, r.right), f = h - s, (p = l - u) >= 0 && f >= 0 && {
                                        top: s,
                                        bottom: h,
                                        left: u,
                                        right: l,
                        ...
                        this._handleEntries = function(t) {
                            t.forEach((function(t) {
                                ...
                                if (null != t.isIntersecting) e = t.isIntersecting;
                                    ...
                                    var i = n._options.threshold;
                                    e = null == i ? t.intersectionRatio > 0 : Array.isArray(i) ? i.some((function(e) {
                                        return t.intersectionRatio > e
                                    })) : t.intersectionRatio > i
                                }
            ...
            var p = r().v4(),
                ...
                v = function(t) {
                    ...
                    function n(t) {
                        ...
                        var i;
                        (i = e.call(this, t)).isVisible = !1;
                        var o = t.root,
                            c = t.rootMargin,
                            h = t.threshold;
                        o ? f.has(o) ? i.elementId = f.get(o) || "" : f.set(o, r().v4()) : i.elementId = p;
                        var a = i.getVisibilityObserverId();
                        d.has(a) || d.set(a, new s.Z({
                            root: o,
                            rootMargin: c,
                            threshold: h
                        }));

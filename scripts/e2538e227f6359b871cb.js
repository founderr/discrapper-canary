...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [28081], {
        ...
        517454: (e, n, t) => {
            ...
            var O = [{
                className: y().emojiSad,
                rating: g.aZ.BAD,
                classNameSelected: y().selected
            }, {
                className: y().emojiNeutral,
                rating: g.aZ.NEUTRAL,
                classNameSelected: y().selected
            }, {
                className: y().emojiHappy,
                rating: g.aZ.GOOD,
                classNameSelected: y().selected
            }];
            ...
            function _(e) {
                ...
                return (0, r.jsx)(d.Z, {
                    ...
                    className: l()(y().ratingsSelector, n),
                    children: (null != a ? a : O).map((function(e) {
                        var n = e.rating,
                            a = e.className,
            ...
            function x(e) {
                var n = e.header,
                    ...
                    ee = (0,
                        h.Z)(q),
                    ne = null != K && O.includes(K),
                    te = ne || !I;
                a.useEffect((function() {
                    s().isEqual(R, i) || z((0, b.B)(i, x))
                }), [i, R, x]);
                a.useEffect((function() {
                    return function() {
                        X.current({
                ...
                return (0, r.jsxs)(c.ModalRoot, {
                    ...
                    children: [(0, r.jsxs)(c.ModalHeader, {
                        ...
                        className: y().content,
                        children: [null == M || M === g.aZ.GOOD || ne ? null : (0, r.jsx)(c.FormItem, {
                            title: o,
        ...
        228081: (e, n, t) => {
            ...
            var r, a = t(785893),
                ...
                d = t(473708);
            ! function(e) {
                e.COULD_NOT_FIND = "I couldn't find what I was looking for";
                e.CONFUSING_LANGUAGE = "I found the language confusing";
                e.OTHER = "Other"
            }(r || (r = {}));
            var p = t(2590);
            var h = t(630670);
            ...
            var C = [s().CALL_FEEDBACK_OPTION_OTHER];

            function N(e) {
                var n = e.reportId,
                    i = e.reportType,
                    m = v(e, ["reportId", "reportType"]);
                o.useEffect((function() {
                    f.default.track(p.rMx.IAR_FEEDBACK_MODAL_VIEWED, {
                        report_id: n,
                        report_type: i
                    })
                }), [n, i]);
                return (0, a.jsx)(c.Z, E({
                    header: d.Z.Messages.IAR_FEEDBACK_TITLE,
                    body: d.Z.Messages.IAR_FEEDBACK_PROMPT,
                    problemTitle: d.Z.Messages.CALL_FEEDBACK_ISSUE_SECTION_HEADER,
                    problems: [{
                        label: d.Z.Messages.IAR_FEEDBACK_PROBLEM_COULD_NOT_FIND,
                        code: 2,
                        value: r.COULD_NOT_FIND
                    }, {
                        label: d.Z.Messages.IAR_FEEDBACK_PROBLEM_CONFUSING_LANGUAGE,
                        code: 3,
                        value: r.CONFUSING_LANGUAGE
                    }, {
                        label: d.Z.Messages.CALL_FEEDBACK_OPTION_OTHER,
                        code: 1,
                        value: r.OTHER
                    }],
                    feedbackProblems: C,
                    onSubmit: function(e) {
                        var r = e.rating,
                            ...
                            s = e.dontShowAgain,
                            c = e.feedback;
                        s && (0, u.Kw)(h.v.IN_APP_REPORTS_FEEDBACK);
                        ! function(e) {
                            var n = e.problem,
                                t = e.feedback,
                                r = e.reportType,
                                ...
                                i = void 0 === l ? null : l,
                                s = e.dontShowAgain;
                            f.default.track(p.rMx.IAR_FEEDBACK_SUBMITTED, {
                                reason: n,
                                report_type: r,
                                report_id: o,
                                rating: i,
                        ...
                        null != r && null != o && (0, l.openModalLazy)(b((function() {
                            var e, n;
                    ...
                    otherKey: s().CALL_FEEDBACK_OPTION_OTHER
                }, m))
            }
        },
        441093: (e, n, t) => {

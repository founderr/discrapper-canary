    ...
    [24501], {
        624501: (e, t, n) => {
            ...
            function D(e) {
                ...
                if (null != i && i.type === c.g.APP_DIRECTORY_PROFILE) return function(e) {
                    null == e || e.preventDefault();
                    var t, r = i.code,
                        l = null !== (t = _.Z.getGuildId()) && void 0 !== t ? t : void 0;
                    m.default.track(A.rMx.APP_DIRECTORY_PROFILE_EMBED_URL_CLICKED, {
                        application_id: r,
                        device_platform: o.tq ? "mobile_web" : "desktop_web",
                        guild_id: l,
                        channel_id: g.Z.getChannelId()
                    });
                    Promise.all([n.e(77179), n.e(50413)]).then(n.bind(n, 177179)).then((function(e) {
                ...
                if (w && (null == I ? void 0 : I.startsWith("/application-directory"))) {
                    var N = P(I.split("/"), 4),
                        Z = N[2],
                        D = N[3],
                ...
                var j = (0, v.Ao)(I);
                if (null != I && w && null != j) return function(e) {
                    null == e || e.preventDefault();
                    var t = _.Z.getGuildId();
                ...
                if (w && (null == I ? void 0 : I.startsWith("/settings/"))) {
                    var H = n(421774),
                        V = H.default,
                        Y = V(I);
        ...
        362345: (e, t, n) => {
            ...
            function s(e, t) {
                var n, s = (0,
                        a.yV)(t),
                    f = (0, r.ZP)([l.Z, u.default], (function() {
                        if (null == e) return !1;
                        var t = l.Z.can(c.Plq.ADMINISTRATOR, e),
                            n = u.default.getCurrentUser();
                        return null != n && (t || e.isOwner(n))
                    })),
                    d = null !== (n = null == e ? void 0 : e.hasFeature(c.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE)) && void 0 !== n && n,
                    p = [c.oNc.CREATOR_MONETIZABLE, c.oNc.CREATOR_MONETIZABLE_PROVISIONAL, c.oNc.ROLE_SUBSCRIPTIONS_ENABLED].some((function(t) {
                        return !0 === (null == e ? void 0 : e.hasFeature(t))
                    }));
                return null != e && f && !d && p && s && !(0, i.un)(o.z$.SERVER_SHOP_PHANTOM_PREVIEW)
            }
        },
        858503: (e, t, n) => {
            n.d(t, {
            ...
            function u(e) {
                var t = (0, o.pX)(),
                    ...
                    u = (0, i.g)(e, "channel_list"),
                    a = (0, r.uP)(null == e ? void 0 : e.id).shouldHideGuildPurchaseEntryPoints;
                return !(!t || null == e || a) && (e.hasFeature(l.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE) || n && e.hasFeature(l.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE) || u)
            }

            function a(e) {
                var t = (0, o.vw)(),
                    n = (0, o.C4)("channel_list");
                return !(!t || null == e) && (e.hasFeature(l.oNc.PRODUCTS_AVAILABLE_FOR_PURCHASE) || n && e.hasFeature(l.oNc.ROLE_SUBSCRIPTIONS_AVAILABLE_FOR_PURCHASE))
            }
        },
        202176: (e, t, n) => {
            n.d(t, {
        ...
        590204: (e, t, n) => {
            ...
            var r = n(260561),
                ...
                c = ((0, r.B)({
                    ...
                    treatments: [{
                        id: 1,
                        label: "Enable Members Search V2",
                        config: {
                            enabled: !0
                        }
                    }]
                    ...
                    return S(this, (function(i) {
                        switch (i.label) {
                            case 0:
                                ...
                                if (null == (r = g.Z.getGuild(t)) && t !== I.ME) return [2, !1];
                                ...
                                if ((0, m.AB)(n)) switch (n) {
                                    ...
                                    case m.oC.CHANNEL_BROWSER:
                                        return [2, null != r && r.hasFeature(I.oNc.COMMUNITY)];
                    ...
                    return Z(this, (function(d) {
                        switch (d.label) {
                            ...
                            case 2:
                                ...
                                null != f.threadId ? (0, l.uL)(I.Z5c.CHANNEL_THREAD_VIEW(f.guildId, f.channelId, f.threadId, f.messageId), t, i) : (0, l.uL)(I.Z5c.CHANNEL(f.guildId, f.channelId, f.messageId), t, i);
                                return [2]
                        }
                    }))
                }))).apply(this, arguments)

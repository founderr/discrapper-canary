        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, E, h, m, g = encodeURIComponent(l.toString()),
                    ...
                    I = "".concat(f, "/?link=").concat(g, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(O, "&efr=").concat(v);

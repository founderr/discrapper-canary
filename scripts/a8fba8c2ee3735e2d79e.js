(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["68700"], {
        ...
        972701: function(e, t, n) {
            ...
            function T(e, t) {
                return e.type === _.ChannelTypes.GROUP_DM ? t ? E.default.Messages.UNFAVORITE_GDM : E.default.Messages.FAVORITE_GDM : e.type === _.ChannelTypes.DM ? t ? E.default.Messages.UNFAVORITE_DM : E.default.Messages.FAVORITE_DM : t ? E.default.Messages.UNFAVORITE_CHANNEL : E.default.Messages.FAVORITE_CHANNEL
            }
            ...
            function h(e) {
                let t = (0, u.useStateFromStores)([d.default], () => d.default.isFavorite(e.id));
                return __OVERLAY__ || !t ? null : (0, a.jsx)(r.MenuItem, {
                    id: "favorite-channel",
                    label: T(e, !0),
                    color: "danger",
                    action: () => e.type === _.ChannelTypes.GUILD_CATEGORY ? (0, r.openModalLazy)(async () => {
                        let {
                            default: t
        ...
        679428: function(e, t, n) {
            ...
            function f() {
                !__OVERLAY__ && (clearTimeout(d), d = setTimeout(() => c(), 15e3))
            }
            ...
            class T extends l.default {
                constructor(...e) {
                    ...
                    }, this.saveUserGuildSettings = c, this.saveUserGuildSettingsBulk = _
                }
            }
            var S = new T
        },
        ...
        492114: function(e, t, n) {
            ...
            function L(e) {
                a = e.section, l = e.subsection, null != u && a === m.ChannelSettingsSections.INSTANT_INVITES && (v = !0, E.default.get({
                    url: m.Endpoints.INSTANT_INVITES(u.id),
                    oldFormErrors: !0
                }).then(e => {
                    v = !1, T.default.dispatch({

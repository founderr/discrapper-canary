    ...
    ["33925"], {
        ...
        676143: function(e, t, n) {
            ...
            function A(e, t, n, a) {
                ...
                let s = (0, p.useCanSeeOnboardingHome)(e),
                    r = i.useCallback((e, t) => !(s && e.channel.hasFlag(I.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) && e.channel.type !== N.ChannelTypes.GUILD_DIRECTORY && (0 === t.length || l(t, e.channel.name.toLowerCase()) || e.channel.topic.toLowerCase().includes(t)), [s]);
                return i.useMemo(() => {
                    let e = {
                        null: [],
                        _categories: []
        ...
        357506: function(e, t, n) {
            ...
            class eu extends l.Component {
                handleLock() {
                    !(0, E.hasAnyModalOpen)() && !B.default.isOpen() && S.default.setLocked(!0, (0, K.getPID)())
                }
                handleDeactivate() {
        ...
        522019: function(e, t, n) {
            ...
            function eu(e) {
                ...
                let n = (0, r.useStateFromStores)([j.default, R.default], () => R.default.getChannel(j.default.getVoiceChannelId())),
                    a = (0, m.default)(n),
                    l = function(e) {
                        let [t] = (0, r.useStateFromStores)([w.default, C.default], () => null == e ? [
                            [], -1
                        ] : e.isGuildStageVoice() ? [C.default.getMutableParticipants(e.id, T.StageChannelParticipantNamedIndex.SPEAKER), C.default.getParticipantsVersion(e.id)] : [w.default.getVoiceStatesForChannel(e), w.default.getVoiceStateVersion(e.getGuildId())], [e], J.isVersionEqual);
                        return t
                    }(n),
        ...
        786770: function(e, t, n) {
            ...
            function H(e) {
                ...
                if (-1 === n) return !1;
                let i = B[n];
                clearTimeout(i.timerId), B = [...B], t === w.OverlayNotificationStatus.DISMISSED ? B.splice(n, 1) : B[n] = {
                    ...i,
                    status: t
                }
            }
            ...
            function z(e) {
                let {
                    channelId: t,
                    ringing: n
                } = e, i = W(t), a = n.includes(C.default.getId());
                if (!a) return H(i);
                if (null != i) return !1;
                let l = T.default.getChannel(t);
                if (null == l || !l.isPrivate() || x.default.getStatus() === w.StatusTypes.DND) return !1;
                let s = B.find(e => 1 === e.type && e.channelId === t && e.messageType === w.MessageTypes.CALL);
            ...
            var K = new Z(c.default, __OVERLAY__ ? {
                ...
                OVERLAY_SET_INPUT_LOCKED: function(e) {
                    ...
                    if (t) return !1;
                    B = B.map(e => e.status === w.OverlayNotificationStatus.ACTIVE ? (clearTimeout(e.timerId), {
                        ...e,
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    if ((null === (n = l.activity) || void 0 === n ? void 0 : n.type) === w.ActivityActionTypes.JOIN || (null === (i = l.activity) || void 0 === i ? void 0 : i.type) === w.ActivityActionTypes.JOIN_REQUEST) {
                        ...
                        let e = function(e, t, n) {
                            let i, a;
                            if (o(null != t.activity, "received null message activity"), n.id === C.default.getId()) return !1;
                ...
                CLIPS_SAVE_CLIP_START: function() {
                    Y((0, I.createClipsNotification)(V.default.Messages.CLIPS_SAVE_START_NOTIFICATION_TITLE))
                },
                CLIPS_SAVE_CLIP: function() {
                    Y((0, I.createClipsNotification)(V.default.Messages.CLIPS_NOTIFICATION_TITLE.format({
                        duration: (0, P.getSecondsSliderLabel)(N.default.getSettings().clipsLength / 1e3, !0)
                    })))
                },
                CLIPS_SAVE_CLIP_ERROR: function() {
                    Y((0, I.createClipsNotification)(V.default.Messages.CLIPS_SAVE_ERROR_NOTIFICATION_TITLE))
                },
            ...
            class _ extends s.Component {
                ...
                handleDragMove(e, t) {
                    ...
                    let {
                        ...
                        bottom: null,
                        right: null
                    }, a, l, E, g)), I = c ? (0, u.getAnchorCoordsFromFullCoords)(N) : v("RESIZE_SOUTH_EAST", N);

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [96026, 81580, 95305, 97516, 96043, 71402, 1459], {
        737264: e => {
            "use strict";
        ...
        396043: (e, t, n) => {
            ...
            function R(e) {
                ...
                return {
                    ...
                    guild_member_perms: String(null !== (n = p.Z.getGuildPermissions(t)) && void 0 !== n ? n : y.ZP.NONE),
            ...
            function P(e) {
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (t = p.Z.getChannelPermissions(e)) && void 0 !== t ? t : y.ZP.NONE),
                    channel_hidden: n
                }
            }
                        ...
                        return v(this, (function(R) {
                            switch (R.label) {
                                ...
                                case 3:
                                    ...
                                    m = d.Z.getVoiceStateForSession(s.default.getId(), O);
                                    A = (null == m ? void 0 : m.channelId) === t.id;
                                    N = A || f.Z.getChannelId() === d.Z.getCurrentClientVoiceChannelId(t.guild_id);
                                    if (!S && !y && (0, _._)(t)) return [2, new Promise((function(o) {
                                        var u = e;
                                    ...
                                    y || E || o.default.selectVoiceChannel(t.id);
        ...
        866893: (e, t, n) => {
            ...
            function j(e) {
                return function(t, n) {
                    return (0, h.yv)(t) ? -1 : (0, h.yv)(n) ? 1 : e === o.z.LATEST_ACTIVITY ? u.default.compare(k(n), k(t)) : u.default.compare(n, t)
                }
            }
            ...
            function x(e) {
                ...
                if (null != t) {
                    ...
                    if ((null == e ? void 0 : e.refreshThreadIds) || (null == e ? void 0 : e.sortThreadIds)) {
                        G = i().chain(D).sort(j(o.z.LATEST_ACTIVITY));
                        w = i().chain(D).sort(j(o.z.CREATION_DATE))
                    }
                    var n, r = (L === o.z.LATEST_ACTIVITY ? G : w).value(),
            ...
            var Y = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        NO_THREAD_IDS: b,
                        mostRecentUserCreatedThreadId: N,
                        currentChannelId: R,
                        currentTagFilter: C,
                        currentSortOrder: L,
                        newThreadCount: P,
                        ...
                        canAckThreads: M,
                        _all: D,
                        _lazySortedCreation: w,
                        _lazySortedActivity: G,
                        _deleted: Z,
                        _pinned: F
                    }
                };
            ...
            function K() {
                ...
                for (var l in L)
                    for (var c in L[l])
                        for (var s in L[l][c]) {
                            var f = L[l][c][s];
                            d.ZP.isForumPostUnread(s) && Q(P, f, f, !1)
                        }
                k()
            }
                ...
                CHANNEL_UPDATES: function(e) {
                    ...
                    try {
                        for (var o, u = t[Symbol.iterator](); !(n = (o = u.next()).done); n = !0) {
                            var a = o.value;
                            if (a.isNSFW() !== x(a.guild_id, a.parent_id)) {
                                G();
                                return
                            }
                        }
        ...
        52317: (e, t, n) => {
            ...
            const w = new(function(e) {
                ...
                n.prototype.__getLocalVars = function() {
                    return {
                        lastSavedCollapsedCategories: g,
                        logger: S,
                        syncTimer: A,
                        SYNC_DELAY_MS: 15e3
                    }
        ...
        968968: (e, t, n) => {
            ...
            y.displayName = "CategoryCollapseStore";
            y.persistKey = "collapsedCategories";
            const m = new y(i.Z, {

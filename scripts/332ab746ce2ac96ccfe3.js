                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = z(t.minStart),
                                ...
                                j = z(t.minDirection),
                                R = z(t.maxDirection);
                            return new y(new b(x(n.x, r.x), x(f.x, h.x), x(d.x, p.x), x(v.x, g.x), O(j.x, R.x), C(t.easingFunctions)[0]), new b(x(n.y, r.y), x(f.y, h.y), x(d.y, p.y), x(v.y, g.y), O(j.y, R.y), C(t.easingFunctions)[0]))
                    }
                }(p(p({}, t), {
                    valueType: "Vector2"
                }))
            ...
            var S = r.forwardRef(function(t, e) {
                    ...
                    F = r.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                var n = Date.now();
                                0 !== _.current && (k.current = 1e3 / (n - _.current)), _.current = n
                            }
                        }
                    }, [a, y, v]);
                ...
                var D = r.useCallback(function(t, e) {
                    ...
                    M = r.useCallback(function(t, e, n, r, o) {
                        var a, u, c, f, h, d, v, y, z, S, A, E, _, k, F, M = (a = null !== (F = t.id) && void 0 !== F ? F : (0, i.v4)(), u = t, c = n, f = r, h = o, y = R((v = (d = u, p(p({
                            id: a
                        }, l), d))).size), S = (z = function(t, e) {
                            if (null != t) {
                            ...
                            rotation: (_ = v.rotation, function(t) {
                                switch (t.type) {
                                    case "static":
                                        var e = j(t.value);
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var f = j(t.minStart),
                                            ...
                                            z = j(t.minDirection),
                                            R = j(t.maxDirection);
                                        return new g(new b(x(n.x, r.x), x(f.x, h.x), x(d.x, p.x), x(v.x, y.x), O(z.x, R.x), C(t.easingFunctions)[0]), new b(x(n.y, r.y), x(f.y, h.y), x(d.y, p.y), x(v.y, y.y), O(z.y, R.y), C(t.easingFunctions)[0]), new b(x(n.z, r.z), x(f.z, h.z), x(d.z, p.z), x(v.z, y.z), O(z.z, R.z), C(t.easingFunctions)[0]))
                                }
                            }(p(p({}, _), {
                                valueType: "Vector3"
                            }))),
                            ...
                            size: y,
                            opacity: (k = v.opacity, function(t) {
                                switch (t.type) {
                                    case "static":
                                    ...
                                    case "oscillating-random":
                                        return new b(x(t.minValue, t.maxValue), x(t.minStart, t.maxStart), x(t.minFinal, t.maxFinal), x(t.minDuration, t.maxDuration), O(t.minDirection, t.maxDirection), C(t.easingFunctions)[0])
                                }
                            }(p(p({}, k), {
                                valueType: "number"
                            }))),
                ...
                return r.useEffect(function() {
                    ...
                    return t("click", N, c), t("mousedown", T, f), t("mousemove", B, h), t("mouseup", L, d),
                        function() {
                ...
                }, [N, T, B, L, c, f, h, d]), r.useEffect(function() {
                    var t = S.current,
                ...
                if (!("undefined" != typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))) {
                    var e = t.document,
                        ...
                        v = function(e, s, v) {
                            ...
                            f += e.size, c(t.TEMPORARY, f, O(function(t) {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(a, u) {
                        ...
                        var c, s, l, f, h, d, p, v, y, g, m, w, b, x, C, O, z = (c = a, h = Array(32768), c.forEach(function(n) {
                        ...
                        var R = (d = a, p = z, m = 1e6, w = 0, b = 1e6, x = 0, C = 1e6, O = 0, d.forEach(function(e) {
                                v = e[0] >> t, y = e[1] >> t, g = e[2] >> t, v < m ? m = v : v > w && (w = v), y < b ? b = y : y > x && (x = y), g < C ? C = g : g > O && (O = g)
                            }), new i(m, w, b, x, C, O, p)),
                        ...
                        A(E, u - E.size());
                        for (var _ = new o; E.size();) _.push(E.pop());
                        return _
                    }
                }
            }();
        ...
        506838: function(t, e, n) {
            ...
            let C = f(g(function(t) {
                ...
                O = t => Object.assign(f(t), {
                    startsWith: e => O(v(t, g(t => b(t) && t.startsWith(e)))),
                    endsWith: e => O(v(t, g(t => b(t) && t.endsWith(e)))),
                    minLength: e => {
                        var n;
                        return O(v(t, (n = e, g(t => b(t) && t.length >= n))))
                    },
                    maxLength: e => {
                        var n;
                        return O(v(t, (n = e, g(t => b(t) && t.length <= n))))
                    },
                    includes: e => O(v(t, g(t => b(t) && t.includes(e)))),
                    regex: e => O(v(t, g(t => b(t) && !!t.match(e))))
                }),
                z = O(g(b)),
                ...
                A = t => g(e => w(e) && e <= t),
                E = t => g(e => w(e) && e >= t),
                _ = () => g(t => w(t) && Number.isInteger(t)),
                k = () => g(t => w(t) && Number.isFinite(t)),
                F = () => g(t => w(t) && t > 0),
                D = () => g(t => w(t) && t < 0),

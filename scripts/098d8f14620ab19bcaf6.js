(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [43814], {
                ...
                return (0, l.vP)({
                    ...
                    onStepChange: function(e) {
                        var n = e.currentStep,
                            r = e.toStep,
                            a = Date.now();
                        o.default.track(d.rMx.PAYMENT_FLOW_STEP, _(m({}, t), {
                            from_step: n,
                            to_step: r,
        ...
        668900: (e, t, n) => {
            ...
            function b(e, t) {
                return "PL" === e ? t ? _.Z.Messages.LOCALIZED_PRICING_PLN_LEGACY_PRICING_BOOST_WARNING : _.Z.Messages.LOCALIZED_PRICING_PLN_LEGACY_PRICING_WARNING : "TR" === e ? t ? _.Z.Messages.LOCALIZED_PRICING_TRY_LEGACY_PRICING_BOOST_WARNING : _.Z.Messages.LOCALIZED_PRICING_TRY_LEGACY_PRICING_WARNING : t ? _.Z.Messages.LOCALIZED_PRICING_LEGACY_PRICING_BOOST_WARNING : _.Z.Messages.LOCALIZED_PRICING_LEGACY_PRICING_WARNING
            }
            const E = function(e) {
        ...
        311556: (e, t, n) => {
            ...
            var _e = [K.Cj.BOX, K.Cj.CUP, K.Cj.SNOWGLOBE],
                ye = [K.Cj.STANDARD_BOX, K.Cj.CAKE, K.Cj.COFFEE, K.Cj.CHEST],
                Ie = function() {
                    return (0, r.jsxs)("div", {
                ...
                he = function(e) {
                    ...
                    p ? _ = _e : m && (_ = ye);
                    return (0, r.jsxs)("div", {
                        children: [p && (0, r.jsx)(Ie, {}), m && (0, r.jsx)("div", {
            ...
            function Me(e) {
                var t = e.premiumSubscription,
                    ...
                    y = (0, l.e7)([Ne.default], (function() {
                        return Ne.default.locale
                    })),
                    h = (0, l.e7)([_.Z], (function() {
                        return _.Z.get(n)
                    })),
            ...
            function Ue(e) {
                ...
                var $ = De((0, l.Wu)([_.Z], (function() {
                        return [null != n ? _.Z.get(n.planId) : null, null != d ? _.Z.get(d) : null]
                    })), 2),
                    q = $[0],
                    ee = $[1],
                    te = (0, P.N)(L),
            ...
            function Fe(e) {
                var t = e.onStepChange,
                    ...
                    _ = null != u && null != u.paymentSourceId || Object.keys(i).length > 0 || f && !c,
        ...
        16097: (e, t, n) => {
            ...
            function Y(e) {
                var t, n, i = e.selectedPlanId,
                    ...
                    pe = ue.selectedSkuId,
                    me = ue.defaultPlanId,
                    _e = ue.selectedGiftStyle,
                    ye = ue.setSelectedGiftStyle,
                    Ie = ue.isPremium,
                    he = ue.giftRecipient,
                ...
                if (null != Re) {
                    var Xe = Re.message;
                    Re.code === _.SM.INVALID_CURRENCY_FOR_PAYMENT_SOURCE && (Xe = k.Z.Messages.BILLING_ERROR_UNSUPPORTED_CURRENCY);
                ...
                return De ? null : (0, r.jsxs)("div", {
                    ...
                    children: [null != te && (0, r.jsxs)("div", {
                        ...
                        children: et
                    }), xe && null != _e && (0, r.jsxs)(r.Fragment, {
        ...
        682876: (e, t, n) => {
                    ...
                    return x(this, (function(x) {
                        switch (x.label) {
                            ...
                            case 1:
                                ...
                                return [4, (0, _.ZZ)(B.applicationId, B.id, {
                            ...
                            case 14:
                                ...
                                t(g.A.COMPLETED);
                                "subscription" in X ? te = null != X.subscription ? y.Z.createFromServer(X.subscription) : null : "entitlements" in X && (ne = null != X.entitlements ? X.entitlements : void 0);
                                k(te, ne);
                                return [3, 17];
                            case 15:
                                re = x.sent();
            ...
            function q(e) {
                var t = e.premiumSubscription,
                    ...
                    me = te.giftRecipient,
                    _e = null == ne ? void 0 : ne.id,
                    ye = (0, L.sE)(A, re.paymentSourceId, _e),
                    Ie = (0, l.e7)([Z.Z], (function() {
                        return Z.Z.popupCallbackCalled
                    })),
                    he = (0, u.Z)().analyticsLocations,
                    be = null != le ? oe[le] : null,
                    Ee = Q(a.useState(ye), 2),
                    ge = Ee[0],
                    Oe = Ee[1],
                    ve = Q(a.useState(!1), 2),
                    Ne = ve[0],
                    Te = ve[1],
                    Pe = (0, B.H)(_e, T).hasEntitlements,
        ...
        369263: (e, t, n) => {
            ...
            function I(e) {
                var t, n = e.title,
                    ...
                    R = e.showPremiumIcon,
                    j = void 0 !== R && R,
                    C = (0, s.ZP)([o.Z], (function() {
                        var e = o.Z.activeSubstep;
                        return null != e && f.rN[e] === f.QD.PROFILE_CUSTOMIZATION
                    }));
                return (0, r.jsx)("div", {
                    className: i()(m().customizationSection, h, (t = {}, _(t, m().disabled, g), _(t, m().hideDivider, v), _(t, m().showBorder, T), _(t, m().withDivider, x), t)),

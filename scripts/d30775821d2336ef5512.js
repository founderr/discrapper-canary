(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [44906, 29202, 91683, 58635, 84832, 88110, 86502, 96043, 71402], {
        737264: e => {
            "use strict";
            ...
            function w(e) {
                ...
                if (!T.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = M(u, i),
                        c = b({}, t, P(a), null != i && null != o && (0, m.AB)(o) ? R(0, o) : L(u));
                    T.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        980604: (e, t, n) => {
            ...
            function z() {
                V = y.Z.getGuildCount() >= 3 || i().size(s.Z.getMutablePrivateChannels()) >= 20;
                K = []
            }
            ...
            function X() {
                var e, t, n = null !== (e = N.Z.getGuildId()) && void 0 !== e ? e : void 0,
                    r = null !== (t = m.Z.getChannelId()) && void 0 !== t ? t : void 0;
                switch (x) {
                    case l.h8.USER:
                ...
                for (var u = [], a = [], c = 1; c < q.length; c += 1) {
                    var f = Q(q[c]);
                    null != f && ((f.type !== l.h8.TEXT_CHANNEL && f.type !== l.h8.VOICE_CHANNEL || g.Z.can(p.Plq.VIEW_CHANNEL, f.record)) && a.push(f))
                }
                if (a.length > 0) {
                    var d;
                    (d = u).push.apply(d, [(0, l.o6)(R.Z.Messages.QUICKSWITCHER_LAST_CHANNEL)].concat(D(a)))
                }
                var _ = function(e) {
                    var t = [];
                ...
                if (_.length > 0) {
                    var I;
                    (I = u).push.apply(I, [(0, l.o6)(R.Z.Messages.QUICKSWITCHER_DRAFTS)].concat(D(_)))
                }
                ...
                if (T.length > 0) {
                    u.push((0, l.o6)(R.Z.Messages.QUICKSWITCHER_MENTIONS));
                    u = u.concat(T)
                }
                if (null != n) {
                    var y = v.ZP.getSelectableChannelIds(n).filter((function(e) {
                        var t = s.Z.getChannel(e);
                        return !(null == t || e === r || q.includes(e) || b.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && b.Z.isChannelMuted(t.guild_id, t.parent_id)) && S.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return Q(e)
                    })).filter((function(e) {
                        return e
                    }));
                    Object.values(E.Z.getActiveJoinedUnreadThreadsForGuild(n)).forEach((function(e) {
                        for (var t in e) {
                            var n = Q(t);
                            null != n && y.push(n)
                        }
                    ...
                    if (y.length > 0) {
                        u.push((0,
                            l.o6)(R.Z.Messages.QUICKSWITCHER_UNREAD_CHANNELS));
                        u = u.concat(y)
                    }
                }
            ...
            function J(e, t) {
                switch (x) {
                    case l.h8.USER:
                        var n = y.Z.getGuild(N.Z.getGuildId());
                        e.unshift((0, l.o6)(null != n ? R.Z.Messages.QUICKSWITCHER_QUERYMODE_USERS_IN_GUILD.format({
                            name: n.name
                        }) : R.Z.Messages.QUICKSWITCHER_QUERYMODE_USERS));
                        B = e;
                        break;
                    case l.h8.TEXT_CHANNEL:
                        e.unshift((0, l.o6)(R.Z.Messages.QUICKSWITCHER_QUERYMODE_TEXT_CHANNELS));
                        B = e;
                        break;
                    case l.h8.VOICE_CHANNEL:
                        e.unshift((0, l.o6)(R.Z.Messages.QUICKSWITCHER_QUERYMODE_VOICE_CHANNELS));
                        B = e;
                        break;
                    case l.h8.GUILD:
                        e.unshift((0, l.o6)(R.Z.Messages.QUICKSWITCHER_QUERYMODE_GUILDS));
                        B = e;
                        break;
                    case l.h8.APPLICATION:
                        e.unshift((0, l.o6)(R.Z.Messages.QUICKSWITCHER_QUERYMODE_APPLICATIONS));
                        B = e;
                        break;
                    default:
                        B = e
            ...
            function $(e) {
                ...
                Z = null != Z ? Z : new l.ZP(ee, null, null != r ? 100 : 5, {
                    frecencyBoosters: !0,
                    blacklist: o
                });
                Y = null;
            ...
            var ne = function(e) {
                ...
                r.getResultTotals = function(e) {
                    return null == Z ? 0 : null == e ? Z.results.reduce((function(e, t) {
                        return t.type !== l.h8.HEADER ? e + 1 : e
                    }), 0) : Z.results.reduce((function(t, n) {
                ...
                r.getFrequentGuilds = function() {
                    return null != Z ? Z.queryGuilds("", 100) : null
                };
                r.getFrequentGuildsLength = function() {
                    return null != Z ? Z.queryGuilds("", 100).length : 0
                };
            ...
            var re = new ne(a.Z, {
                ...
                QUICKSWITCHER_SEARCH: function(e) {
                    ...
                    if (x !== r) {
                        Z.setResultTypes(null != r ? [r] : null);
                        Z.setLimit(null != r ? 100 : 5);
                        var o, u = null !== (o = N.Z.getGuildId()) && void 0 !== o ? o : void 0;
                        r === l.h8.USER && null != u ? Z.setOptions({
                            userFilters: {
                                guild: u,
                                friends: !0
                            }
                        }, !0) : r === l.h8.VOICE_CHANNEL ? Z.setOptions({
                    ...
                    x = r;
                    Z.search(n, x === l.h8.USER ? i : void 0)
                },
        ...
        491260: (e, t, n) => {
            ...
            var H = function(e) {
                ...
                r.getActivities = function(e) {
                    ...
                    if (null == t) {
                        var n;
                        return null !== (n = A[e]) && void 0 !== n ? n : m
                    }
                    var r = C(e, t);
        ...
        788169: (e, t, n) => {
            ...
            const A = new b(o.Z, {
                ...
                TYPING_START_LOCAL: function(e) {
                    ...
                    var s = null == O || O.prevSend > r - 16e3 ? 1500 : 0,
        ...
        239734: (e, t, n) => {
            ...
            var v = function(e) {
                ...
                r.needsRefresh = function() {
                    return Date.now() - h.lastFetched > p
                };
        ...
        796909: (e, t, n) => {
            ...
            function P(e) {
                ...
                if (null != o) {
                    var u = i()(o).valueOf(),
                        a = O.Z.fromTimestamp(u);
                    return O.Z.compare(r, a) > 0 ? r : a
                }
                return r
            }
            ...
            var U, M, w, D = (U = [], M = [], w = [], function() {
                ...
                G = function(e) {
                    ...
                    var r = n.prototype;
                    r.initialize = function() {
                        this.waitFor(_.Z, p.Z, h.default, s.Z, I.Z);
        ...
        786502: (e, t, n) => {
            ...
            var v = function(e, t) {
                ...
                T = function(e) {
                    var t = e.omitUserIds,
                        ...
                        O = void 0;
                    try {
                        for (var T, y = f.Z.getPrivateChannelIds()[Symbol.iterator](); !(I = (T = y.next()).done); I = !0) {
                            var g = T.value;
                            if (null != n && n > 0 && a.length >= n) break;
                            if (null != p && E >= p) break;
                            var S = u.Z.getChannel(g);
                            if (null != S && S.isPrivate())
                                if (d && S.type === _.d4z.GROUP_DM) {
                                    ...
                                    if (null != l.ZP.lastMessageId(S.id)) {
                                        var m = S.getRecipientId();
                                        if (null != m && !t.has(m) && !o.has(m)) {
                                            var N = s.default.getUser(m);
                                            if (null == N || N.bot || v(r, N.id)) continue;
                                            o.add(N.id);
                                            a.push({
                                                type: i.DM,
                                                item: N,
            ...
            var m, N = "minutes",
                ...
                A = "days",
                P = "never",
                R = (I(m = {}, r.INVITE_OPTIONS_30_MINUTES.value, {
                    value: 30,
                    type: N
                }), I(m, r.INVITE_OPTIONS_1_HOUR.value, {
                    value: 1,
                    type: b
                }), I(m, r.INVITE_OPTIONS_6_HOURS.value, {
                    value: 6,
                    type: b
                }), I(m, r.INVITE_OPTIONS_12_HOURS.value, {
                    value: 12,
                    type: b
                }), I(m, r.INVITE_OPTIONS_1_DAY.value, {
                    value: 1,
                    type: A
                }), I(m, r.INVITE_OPTIONS_7_DAYS.value, {
                    value: 7,
                    type: A
                }), I(m, r.INVITE_OPTIONS_30_DAYS.value, {
                    value: 30,
                    type: A
                }), I(m, r.INVITE_OPTIONS_FOREVER.value, {
                    value: 0,
                    type: P
                }), m);
        ...
        58964: (e, t, n) => {
            ...
            function p(e, t) {
                ...
                var _, p, E, I, h, O = encodeURIComponent(l.toString()),
                    v = encodeURIComponent(a()),
                    T = (E = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), I = null != (null === i() || void 0 === i() || null === (_ = i().ua) || void 0 === _ ? void 0 : _.match(E)), h = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !I, "iOS" !== (null === i() || void 0 === i() || null === (p = i().os) || void 0 === p ? void 0 : p.family) || h ? 1 : 0),
                    y = null != r ? encodeURIComponent(r) : null,
                    g = null != o ? encodeURIComponent(o) : null,
                    S = "".concat(f, "/?link=").concat(O, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(v, "&efr=").concat(T);
                null != y && (S += "&afl=".concat(y));

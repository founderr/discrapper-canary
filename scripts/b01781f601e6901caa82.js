(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [40264, 38479, 33928, 72935, 19887, 57678, 58621, 33973, 96043, 71402, 42643, 17363, 56620], {
        737264: e => {
            "use strict";
        ...
        652411: (e, t, n) => {
            ...
            function R(e) {
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            return new h(T(e.minValue, e.maxValue));
                        case "linear":
                            return new v(e.value, e.addValue);
                        case "linear-random":
                            return new v(T(e.minValue, e.maxValue), T(e.minAddValue, e.maxAddValue));
                        case "oscillating":
                            return new b(e.value, e.start, e.final, e.duration, e.direction, e.easingFunction);
                        case "oscillating-random":
                            return new b(T(e.minValue, e.maxValue), T(e.minStart, e.maxStart), T(e.minFinal, e.maxFinal), T(e.minDuration, e.maxDuration), y(e.minDirection, e.maxDirection), g(e.easingFunctions)[0])
                    }
                }(E(E({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = m(e.minValue),
                                r = m(e.maxValue);
                            return new O(new h(T(n.x, r.x)), new h(T(n.y, r.y)));
                        case "linear":
                            t = m(e.value);
                            var i = m(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = m(e.minAddValue),
                                a = m(e.maxAddValue);
                            return new O(new v(T(n.x, r.x), T(o.x, a.x)), new v(T(n.y, r.y), T(o.x, a.x)));
                        case "oscillating":
                            t = m(e.value);
                            var u = m(e.start),
                                l = m(e.final),
                                c = m(e.duration),
                                s = m(e.direction);
                            return new O(new b(t.x, u.x, l.x, c.x, s.x, e.easingFunction), new b(t.y, u.y, l.y, c.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var f = m(e.minStart),
                                p = m(e.maxStart),
                                ...
                                S = m(e.minDirection),
                                R = m(e.maxDirection);
                            return new O(new b(T(n.x, r.x), T(f.x, p.x), T(d.x, E.x), T(_.x, I.x), y(S.x, R.x), g(e.easingFunctions)[0]), new b(T(n.y, r.y), T(f.y, p.y), T(d.y, E.y), T(_.y, I.y), y(S.y, R.y), g(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = S(e.minValue),
                                r = S(e.maxValue);
                            return new I(new h(T(n.x, r.x)), new h(T(n.y, r.y)), new h(T(n.z, r.z)));
                        case "linear":
                            t = S(e.value);
                            var i = S(e.addValue);
                            return new I(new v(t.x, i.x), new v(t.y, i.y), new v(t.z, i.z));
                        case "linear-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var o = S(e.minAddValue),
                                a = S(e.maxAddValue);
                            return new I(new v(T(n.x, r.x), T(o.x, a.x)), new v(T(n.y, r.y), T(o.y, a.y)), new v(T(n.z, r.z), T(o.z, a.z)));
                        case "oscillating":
                            t = S(e.value);
                            var u = S(e.start),
                                l = S(e.final),
                                c = S(e.duration),
                                s = S(e.direction);
                            return new I(new b(t.x, u.x, l.x, c.x, s.x, e.easingFunction), new b(t.y, u.y, l.y, c.z, s.y, e.easingFunction), new b(t.z, u.z, l.z, c.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var f = S(e.minStart),
                                p = S(e.maxStart),
                                ...
                                m = S(e.minDirection),
                                R = S(e.maxDirection);
                            return new I(new b(T(n.x, r.x), T(f.x, p.x), T(d.x, E.x), T(_.x, O.x), y(m.x, R.x), g(e.easingFunctions)[0]), new b(T(n.y, r.y), T(f.y, p.y), T(d.y, E.y), T(_.y, O.y), y(m.y, R.y), g(e.easingFunctions)[0]), new b(T(n.z, r.z), T(f.z, p.z), T(d.z, E.z), T(_.z, O.z), y(m.z, R.z), g(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var A = r.forwardRef((function(e, t) {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == p || p(t), I.current.forEach((function(n, r) {
                                    var i = n.confetti,
                                        o = n.spriteCanvas;
                                    i.update(a), i.draw(o, t), i.shouldDestroy(e, a) && I.current.delete(r)
                                })), null == d || d(t), I.current.size > 0 ? h.current = window.requestAnimationFrame(T) : (t.clearRect(0, 0, e.width, e.height), h.current = null);
                                var n = Date.now();
                ...
                r.useEffect((function() {
                    null != h.current && (window.cancelAnimationFrame(h.current), h.current = window.requestAnimationFrame(T))
                }), [T]);
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", P, l), e("mousedown", A, c), e("mousemove", L, s), e("mouseup", w, f),
                        function() {
                ...
                }), [P, A, L, w, l, c, s, f]), r.useEffect((function() {
                    var e = O.current,
                            ...
                            E.current.forEach((function(e, n) {
                                var r = function(r, i) {
                                    ...
                                    if (t.drawImage(e.image, o, a, f, p), null != r) {
                                        for (var u = t.getImageData(o, a, f, p), l = function(e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
                                                    r: t >> 16 & 255,
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, h()];
                                    case 1:
                                        return e.sent(), I(), _.current = !0, v(!0), [2]
                                }
                            }))
                        }))
                    }), [v, h, I]);
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = o(e),
                    ...
                    _ = E.length;
                for (var O in e) !t && !c.call(e, O) || d && ("length" == O || f && ("offset" == O || "parent" == O) || p && ("buffer" == O || "byteLength" == O || "byteOffset" == O) || u(O, _)) || E.push(O);
                return E
            }
        },
        70151: (e, t, n) => {
            ...
            var v = function(e, t) {
                ...
                b = function(e) {
                    ...
                    n.render = function() {
                        ...
                        return u.createElement(h, (0, r.Z)({}, t, {
            ...
            function f(e, t, n) {
                ...
                Object.keys(i).forEach((function(o) {
                    ...
                    if ((0, u.isValidElement)(a)) {
                        ...
                        !c || l && !p ? c || !l || p ? c && l && (0, u.isValidElement)(f) && (i[o] = (0, u.cloneElement)(a, {
        ...
        72831: (e, t, n) => {
            ...
            var _ = function(e) {
                var t, n = e.closeAction,
                    ...
                    _ = e.className;
                return (0, i.jsxs)("div", {
                    className: a()(d().container, _),
                    children: [(0, i.jsx)(l.Clickable, {
                        className: a()(d().closeButton, (t = {}, E(t, d().closeButtonBold, o === r.BOLD), E(t, d().closeButtonSolid, o === r.SOLID), t)),
                        onClick: n,
        ...
        396043: (e, t, n) => {
            ...
            function P(e) {
                ...
                return {
                    ...
                    guild_member_perms: String(null !== (n = E.Z.getGuildPermissions(t)) && void 0 !== n ? n : T.ZP.NONE),
            ...
            function L(e) {
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (t = E.Z.getChannelPermissions(e)) && void 0 !== t ? t : T.ZP.NONE),
                    channel_hidden: n
                }
            }
            ...
            function U(e) {
                ...
                if (!b.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== y.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        c = R({}, t, P(u), null != i && null != o && (0, m.AB)(o) ? N(0, o) : L(a));
                    b.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        165586: (e, t, n) => {
            ...
            var O = [_(r.RESOLUTION_720), _(r.RESOLUTION_1080), _(r.RESOLUTION_1440), _(r.RESOLUTION_SOURCE, (function() {
                ...
                b = [_(i.FPS_15), _(i.FPS_30), _(i.FPS_60)],
                T = [_(i.FPS_15, (function() {
        ...
        761673: (e, t, n) => {
            ...
            function a(e) {
                ...
                if (a) {
                    var l;
                    u = null !== (l = e instanceof i.Z ? e.premiumSubscriberCount : e.premiumSubscriptionCount) && void 0 !== l ? l : 0
                }
        ...
        596801: (e, t, n) => {
            ...
            function E(e, t) {
                var c = null != t ? t : "".concat(l.jXE.PREMIUM_GUILD_UPSELL_MODAL);
                ...
                var E = e.openInPopoutEnabled,
                    ...
                    O = o.Z.getWindowOpen(l.KJ3.CHANNEL_CALL_POPOUT) && null != E && E;
                O && (0, a.Z)(l.KJ3.CHANNEL_CALL_POPOUT);
                ...
                (0, i.openModalLazy)(s((function() {
                    ...
                    onCloseCallback: function() {
                        u.default.track(l.rMx.MODAL_DISMISSED, {
                            type: c,
                            location: e.analyticsSourceLocation
                        })
                    },
        ...
        393299: (e, t, n) => {
            ...
            var I, h = (O(r = {}, d.Eu4.NONE, _().iconBackgroundTierNone), O(r, d.Eu4.TIER_1, _().iconBackgroundTierOne), O(r, d.Eu4.TIER_2, _().iconBackgroundTierTwo), O(r, d.Eu4.TIER_3, _().iconBackgroundTierThree), r),
                v = (O(I = {}, d.Eu4.NONE, _().iconTierNone), O(I, d.Eu4.TIER_1, _().iconTierOne), O(I, d.Eu4.TIER_2, _().iconTierTwo), O(I, d.Eu4.TIER_3, _().iconTierThree), I);
            ...
            function b(e) {
                ...
                return (0, i.jsx)(f.Z, {
                    ...
                    children: (0, i.jsx)(p.Z, {
                        tier: t,
                        className: a()(r, _().boostedGuildIconGem, v[t])
                    })
                })
            }
            var T = n(21372),
            ...
            function L(e) {
                var t = e.guild,
                    ...
                    o = (0, u.e7)([g.default, T.ZP], (function() {
                        var e = g.default.getCurrentUser();
                        return T.ZP.isMember(t.id, null == e ? void 0 : e.id)
                    })),
                    a = t.premiumTier,
                    c = t.premiumSubscriberCount;
                if (0 === c && a === d.Eu4.NONE) return null;
                var f = function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                        o && !r && (0, s.f)({
                ...
                return (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsx)(l.Tooltip, {
                        ...
                        "aria-label": null != p ? p : "",
                        children: function(e) {
                            return (0, i.jsx)(l.Clickable, A(function(e) {
                                for (var t = 1; t < arguments.length; t++) {
                                    var n = null != arguments[t] ? arguments[t] : {},
                                        r = Object.keys(n);
                                    "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
        ...
        17363: (e, t, n) => {
            ...
            const R = function(e) {
                var t = e.file,
                    ...
                    q = Q[0],
                    $ = Q[1],
                    ee = (0, l.Z)(u.Z.IMAGE_CROPPING_MODAL).AnalyticsLocationProvider,
                    te = i.useRef({
                        x: 0,
                        y: 0
                    }),
                ...
                var oe, ae, ue = function() {
                    ...
                    le = i.useCallback((function(e, t, n) {
                    ...
                    pe = (ae = (oe = function() {
                        ...
                        return S(this, (function(l) {
                            switch (l.label) {
                                ...
                                case 2:
                                    i = l.sent(), o = i.result, a = i.cancelFn;
                                    re.current = a;
                                    return [4, o];
                                case 3:
                                    r = l.sent();
                                ...
                                children: [(0, r.jsx)("img", {
                                    style: y({
                                        ...
                                        var e, t = X.width / X.height,
                                            n = (e = ue()).width !== e.height && t > E.MY ? U.height / X.height : 1;
                                        return {
                                            width: X.width * V * n,
                                    ...
                                    className: N === E.pC.AVATAR ? v().overlayAvatar : v().overlayBanner,
                                    style: {
                                        opacity: null == X ? 0 : 1,
                                        width: U.width,
                                        height: U.height
                                    ...
                                    asValueChanges: function(e) {
                                        if (null != X) {
                                            var t = X.width,
                                                ...
                                                a = i.x,
                                                u = i.y;
                                            (0, o.inRange)(a, r.right, r.left) && (0, o.inRange)(u, r.top, r.bottom) || le(a, u, r);
                                            F(e);
                                            G(r)
                                        }
                                    },
        ...
        311260: (e, t, n) => {
            ...
            function f() {
                return (f = a((function(e, t, r, o, a) {
                    ...
                    return u(this, (function(u) {
                        switch (u.label) {
                            case 0:
                                s = c(t, r, o, a), f = s.x, p = s.y, d = s.scaledCropWidth, E = s.scaledCropHeight;
            ...
            function p(e, t, n, r) {
                ...
                null != d && d.drawImage(e, o, a, u, l, 0, 0, p.width, p.height);
        ...
        338479: (e, t, n) => {
            ...
            function C(e) {
                var t = e.text,
                    ...
                    s = void 0 !== c && c;
                return (0, r.jsxs)("div", {
                    className: T()(s ? R().noticeWithoutRightPadding : R().noticeWithRightPadding, u),
                    children: [(0, r.jsxs)("div", {
            ...
            function x(e) {
                var t = e.analyticsSection,
                    ...
                    c = L.ZP.canUseAnimatedAvatar(l),
                    s = L.ZP.canUsePremiumProfileCustomization(l),
                ...
                if (null != t) {
                    ...
                    ! function(e, t) {
                        var n = t.document,
                            ...
                            l = void 0;
                        try {
                            for (var c, s = r[Symbol.iterator](); !(a = (c = s.next()).done); a = !0) {
                                var f = c.value;
            ...
            const y = new g(i.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(e) {
                    ...
                    a.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == t ? void 0 : t.sku_id) === u.Si.TIER_2 && null == o.Z.getPremiumSubscription(!1) && null == h.tutorialExpirationTime && b()
                }
            })
        },
        156620: (e, t, n) => {
        ...
        305082: (e, t, n) => {
            ...
            function R() {
                return e = S, t = m, n = b("useMemoizedValueSyncedWithDismissibleContents"), o = (0, i.e7)([l.Z], (function() {
                    var e;
            ...
            const M = function(e) {
                var t = function(e) {
                        ...
                        return (0, r.jsxs)(I.C, A(N({
                            ...
                            color: m === T.Si.TIER_1 ? u.Button.Colors.PRIMARY : u.Button.Colors.GREEN,
                            size: P,
                            wrapperClassName: M,
                            pauseAnimation: !X || V
                        }, Y, e), {
                        ...
                        if (null != z) {
                            ...
                            if ((null == J ? void 0 : J.status) !== g.O0b.ACCOUNT_HOLD) ! function(e) {
                                ...
                                if (t)
                                    if (i) {
                                        var O = g.Qqv.BUY;
                                        null != l ? O = g.Qqv.TRIAL : o && (O = g.Qqv.GIFT);
                                        (0, f.Z)({
                                            isGift: o,
                                            initialPlanId: null,
                                            subscriptionTier: a,
                ...
                var $ = y.Z.Messages.APPLICATION_STORE_GET_PREMIUM,
                    ...
                    ne = m === T.Si.TIER_2 && null != te && [T.p9.TIER_0, T.p9.TIER_1].includes(te);
                ...
                var re = null != J && J.status !== g.O0b.ACCOUNT_HOLD && !(0, d.Q)(J.planId) && !ne,
                    ie = re ? null != K ? K : function(e) {
                        var t = e.ctaSubscriptionSkuId,
                            ...
                            r = null,
                            i = null;
                        if (null != t && t !== T.Si.LEGACY && t !== T.Si.TIER_0 && t !== T.Si.TIER_1 && t !== T.Si.TIER_2) return {
                            disabledButtonText: r,
                            disabledButtonTooltipText: i
                        };
                        var o = null != t ? T.y7[t] : null,
                            a = null != o ? T.$e[o] : null,
                            u = null != n ? T.$e[n] : null;
                        if (null != u && null != a && a < u) {
                            ...
                            i = y.Z.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP
                        } else null == o && null != n && n === T.p9.TIER_2 && (i = y.Z.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP);
                        return {
                            disabledButtonText: r,
                            disabledButtonTooltipText: i
                        }
        ...
        223219: (e, t, n) => {
            ...
            function U(e) {
                ...
                null != e.scrollPosition && null != b && (g[b] = e.scrollPosition);
            ...
            var j = function(e) {
                ...
                r.getProps = function() {
                    return {
                        ...
                        scrollPosition: null != b ? g[b] : null,
                        settings: S,
                        errors: y,
            ...
            const G = new j(a.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    P = e.tab;
                    return null == b && P === l.cII.USER_SETTINGS && U({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        95891: (e, t, n) => {
            ...
            function l(e) {
                var t = e.width,
                    ...
                    E = e.foreground,
                    _ = u(e, ["width", "height", "color", "viewBox", "foreground"]);
                return (0, r.jsx)("svg", a(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
        ...
        585798: (e, t, n) => {
            ...
            var T, g = (0, d.Mg)(s.Z.FULL_SCREEN_LAYER_ANIMATION_DURATION);
            ! function(e) {
...
//# sourceMappingURL=b01781f601e6901caa82.js.map
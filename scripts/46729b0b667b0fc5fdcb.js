...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [93922], {
                            ...
                            if ("string" == typeof o) {
                                ...
                                return (0, a.openModalLazy)(g((function() {
                                    ...
                                    return O(this, (function(i) {
                                        switch (i.label) {
                                            case 0:
                                                return [4, Promise.all([t.e(40532), t.e(83064), t.e(40706), t.e(4750), t.e(89853), t.e(90561)]).then(t.bind(t, 389853))];
                                            case 1:
        ...
        796909: (e, n, t) => {
            ...
            var b = new a.Z((function(e) {
                var n = e.isRequest,
                    t = e.isFavorite;
                return n ? [] : [t ? A.FAVORITE : A.DEFAULT]
            }), (function(e) {
                return -e.lastMessageId
            }));

            function L(e) {
                var n, t, r = null !== (t = null !== (n = E.ZP.lastMessageId(e.id)) && void 0 !== n ? n : e.lastMessageId) && void 0 !== t ? t : e.id,
                    o = e.isMessageRequestTimestamp;
                if (null != o) {
                    var a = i()(o).valueOf(),
                        u = C.Z.fromTimestamp(a);
                    return C.Z.compare(r, u) > 0 ? r : u
                }
                return r
            }

            function N(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : L(e);
                return {
                    channelId: e.id,
                    lastMessageId: n,
                    isFavorite: p.Z.isMessagesFavorite(e.id) && (0, l.cn)(),
                    isRequest: s.Z.isMessageRequest(e.id) || c.Z.isSpam(e.id)
                }
            }

            function m() {
                b.clear();
                Object.values(f.Z.getMutablePrivateChannels()).forEach((function(e) {
                    b.set(e.id, N(e))
                }));
                (0, l.cn)() && p.Z.getAddedToMessages().forEach((function(e) {
                    var n = f.Z.getChannel(e);
                    null != n && (0, d.zi)(n.type) && b.set(n.id, N(n))
                }))
            }

            function R() {
                var e = f.Z.getMutablePrivateChannels();
                for (var n in e) b.set(n, N(e[n]))
            }
            var D, P, Z, w = (D = [], P = [], Z = [], function() {
                    var e = b.values(A.FAVORITE),
                        n = b.values(A.DEFAULT);
                    if (D !== e || P !== n) {
                        Z = [];
                        e.forEach((function(e) {
                            var n = e.channelId;
                ...
                G = function(e) {
                    ...
                    var r = t.prototype;
                    r.initialize = function() {
                        this.waitFor(f.Z, h.Z, _.default, s.Z, p.Z);
                        this.syncWith([p.Z, s.Z], m)
                    };
                    r.getPrivateChannelIds = function() {
                        return w()
                    };
                    r.getSortedChannels = function() {
                        return [b.values(A.FAVORITE), b.values(A.DEFAULT)]
                    };
                    r.serializeForOverlay = function() {
                        var e = {};
                        b.values().forEach((function(n) {
                            var t = n.channelId,
                                r = n.lastMessageId;
                            e[t] = r
                        }));
            ...
            const M = new G(u.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, d.hv)(e.type) || b.has(e.id)) && b.set(e.id, N(e))
                    }))
                },
                CHANNEL_CREATE: function(e) {
                    var n = e.channel;
                    if (!(0, d.hv)(n.type)) return !1;
                    if (n.id === S.V) return !1;
                    b.set(n.id, N(n))
                },
                CHANNEL_DELETE: function(e) {
                    var n = e.channel;
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && b.set(n, N(r, t.id))
                },
...
//# sourceMappingURL=46729b0b667b0fc5fdcb.js.map
            ...
            var l = n("37983"),
                ...
                T = e => {
                    let {
                        ...
                        x: 0,
                        y: 0
                    }), [x, b] = i.useState(null), [G, V] = i.useState(!1), {
                    ...
                    let Z = () => {
                        ...
                        Y = i.useCallback(() => {
                            ...
                            let {
                                ...
                                width: n,
                                height: l
                            } = (0, E.adjustImageDimensionsForAspectRatio)(g, e, t), i = (0, E.calculateOverlaySize)(g, n, l, t);
                            b({
                                width: n,
                                height: l
        ...
        8731: function(e, t, n) {
            ...
            async function s(e, t, l, s, o) {
                let {
                    ...
                    scaledCropWidth: d,
                    scaledCropHeight: c
                } = r(t, l, s, o), E = await e.arrayBuffer(), f = new Worker(new URL(n.p + n.u("39703"), n.b)), h = new Promise((e, t) => {
                    f.onmessage = n => {
                        let {
                            data: l
                        } = n;
            ...
            function o(e, t, n, l) {
                ...
                return null != E && E.drawImage(e, i, s, o, a, 0, 0, c.width, c.height), c.toDataURL("image/png")
            }
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, l.jsx)(e, {
                            ...
                            onComplete: () => {
                                y = !0, null == C || C(), !R && ((0, a.setIsPersistentHelperHidden)(!0), (0, a.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: _,
                            analyticsLocations: p,
                            analyticsObject: A,
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: S,
                            location_stack: p
                        }), (0, s.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == h || h(y), y && (!R && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == _ || _())
                    },
                ...
                M = function(e) {
                    let {
                        ...
                        if (e.preventDefault(), null == k) {
                            (0, E.transitionTo)(m.Routes.LOGIN);
                            return
                        }
                        if (null == M || M(e), (null == W ? void 0 : W.status) === m.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                            (0, d.trackPremiumSettingsPaneOpened)(), a.default.open(m.UserSettingsSections.PREMIUM), null == P || P(!1);
                            return
                        }! function(e) {
                            let {
                                isClaimed: t,
                            ...
                            let _ = m.AnalyticsObjectTypes.BUY;
                            null != a ? _ = m.AnalyticsObjectTypes.TRIAL : r && (_ = m.AnalyticsObjectTypes.GIFT), (0, c.default)({
                                isGift: r,
                                initialPlanId: null,
                                subscriptionTier: s,
                                analyticsLocations: E,
                    ...
                    let $ = null != W && W.status !== m.SubscriptionStatusTypes.ACCOUNT_HOLD && !(0, f.isNoneSubscription)(W.planId) && !q,
            ...
            let p = e => {
                ...
                return (0, r.jsxs)(d.Button, {
                    ...
                    children: [t, I ? (0, r.jsx)(_, {
                        shinePaused: E,
                        className: a(f.buttonShine, C ? f.onlyShineOnHover : void 0, h),
                        shineSize: u
                    }) : null]
                })
            };

    ...
    [52555], {
        ...
        426909: (e, t, n) => {
            ...
            var O, C, A, R = new s.Z("ClientStateStore"),
                D = E.nonce,
                N = E.useGuildVersions,
                P = E.highestLastMessageId,
                w = E.readStateVersion,
                L = E.userGuildSettingsVersion,
                U = null !== (O = E.userSettingsVersion) && void 0 !== O ? O : -1,
                k = E.cacheCreationDate,
                M = E.apiCodeVersion,
                G = null !== (C = E.privateChannelsVersion) && void 0 !== C ? C : "0",
                j = new Set(null !== (A = E.guildIdsRequiringDeletedIdsSync) && void 0 !== A ? A : []),
                B = E.lastSelectedGuildId,
                Z = !1;

            function x(e) {
                null != e && 1 === d.Z.compare(e, P) && (P = e)
            }
            ...
            var H = function(e) {
                ...
                r.persist = function(e) {
                    ...
                    u.default.getId(), t = {
                        ...
                        version: f,
                        useGuildVersions: N,
                        highestLastMessageId: P,
                        readStateVersion: w,
                        userGuildSettingsVersion: L,
                        userSettingsVersion: U,
                        cacheCreationDate: k,
                        privateChannelsVersion: G,
                        apiCodeVersion: M,
                        guildIdsRequiringDeletedIdsSync: Array.from(j),
                ...
                r.getClientState = function() {
                    return {
                        knownGuildVersions: N && (0, m.O)() ? Object.fromEntries(o.Z.getCommittedVersions()) : {},
                        highestLastMessageId: P,
                        readStateVersion: w,
                        userGuildSettingsVersion: L,
                        userSettingsVersion: U,
            ...
            const z = new H(a.Z, {
                BACKGROUND_SYNC: function(e) {
                    ...
                    try {
                        for (var i, a = e.guilds[Symbol.iterator](); !(t = (i = a.next()).done); t = !0) {
                            var o = i.value;
                            "partial" === o.data_mode && o.unableToSyncDeletes && j.add(o.id)
                        }
                    } catch (e) {
                        n = !0;
                        r = e
                ...
                CONNECTION_OPEN: function(e) {
                    ...
                    try {
                        for (var d, f = r[Symbol.iterator](); !(u = (d = f.next()).done); u = !0) {
                            ...
                            m.unableToSyncDeletes && j.add(m.id);
                            m.unableToSyncDeletes && j.add(m.id);
                            null === (_ = m.channels) || void 0 === _ || _.forEach((function(e) {
                                return x(e.lastMessageId)
                            }));
                ...
                CONNECTION_OPEN_SUPPLEMENTAL: function() {
                    ...
                    for (var t in e) {
                        1 === d.Z.compare(t, G) && (G = t);
                        var n = e[t].lastMessageId;
                        null != n && 1 === d.Z.compare(n, G) && (G = n)
                    }
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    if (!a && !o) {
                        x(r);
                        (null === (t = c.Z.getChannel(i)) || void 0 === t ? void 0 : t.isPrivate()) && 1 === d.Z.compare(r, G) && (G = r)
                    }
                },
                GUILD_CREATE: function(e) {
                    var t, n, r, i, a = e.guild;
                    if (!a.unavailable) {
                        a.unableToSyncDeletes && j.add(a.id);
                ...
                MESSAGE_ACK: function(e) {
                    var t = e.version,
                        n = S(e, ["version"]);
                    null != t ? w = t : R.log("Received null read states version", n)
                },
        ...
        228667: (e, t, n) => {
            ...
            function f(e) {
                return !!(0, s.Z)() && (!!l.getCurrentConfig({
                    location: "areClipsEnabledForGuild"
                }, {
                    autoTrackExposure: !1
                }).enableClips || (!!c.getCurrentConfig({
                    guildId: null != e ? e : "",
                    location: "areClipsEnabledForGuild"
                }, {
                    autoTrackExposure: !1
                    ...
                    t = (0, r.ZP)([a.Z], (function() {
                        return e.some((function(e) {
                            return c.getCurrentConfig({
                                guildId: e,
                                location: "useClipsEnabledForAReasonOtherThanNitro"
                            }, {
                                autoTrackExposure: !1
                            }).enableClips
                        }))
            ...
            var E = function() {
                    return !!o.Z.getGuildIds().some((function(e) {
                        return c.getCurrentConfig({
                            guildId: e,
                            location: "areClipsEnabledForUser"
                        }, {
        ...
        652555: (e, t, n) => {
            ...
            function M(e, t) {
                return !t || "object" !== j(t) && "function" != typeof t ? w(e) : t
            }
            ...
            x.push(function(e) {
                ...
                function r(e) {
                    ...
                    })).onEnd = i.handleFlushEnd.bind(w(i));
                    return i
                }
                var i = r.prototype;
                ...
                i.feed = function(e) {
                    ...
                    if (!(e instanceof ArrayBuffer)) throw new Error("Expected array buffer, but got " + (void 0 === e ? "undefined" : j(e)));
            ...
            x.push(H);
            var z = i().find(x, (function(e) {
                return e.canUse()
            }));
            P.s.isDiscordGatewayPlaintextSet() && (z = H);
            const F = z;
            var Y = n(120415),
                W = n(310126);
            var q = function() {
                ...
                K = function() {
                    ...
                    t.unpack = function(e) {
                        if ("string" != typeof e) throw new Error("Expected a string to be passed to JSONEncoding.unpack, got ".concat(null == e ? null : void 0 === e ? "undefined" : (t = e) && "undefined" != typeof Symbol && t.constructor === Symbol ? "symbol" : typeof t));
                        var t;
                        return JSON.parse(e)
                    };
                    t.getName = function() {
                ...
                J = void 0 !== q ? q : K;
            P.s.isDiscordGatewayPlaintextSet() && (J = K);
            const Q = J;
            n(701456);
            var $ = n(473903),
                X = n(652591),
            ...
            function we(e) {
                var t, n, r = e.gatewayURL,
                    ...
                    _ = null;
                window._ws = null;
                Ne.log("newOrTakeoverWebSocket()");
                if (null != c) {
                    t = c.ws;
                    if (c.state.gateway !== r) {
                        Ne.log("[FAST CONNECT] gatewayURL mismatch: ".concat(c.state.gateway, " !== ").concat(r));
                        t.close(1e3);
                        t = null
                    } else {
                        var p = Ie({}, c.state);
                        ...
                        Ne.log("[FAST CONNECT] successfully took over websocket, state:", p);
                        l = c.state.open;
                        d = c.state.identify;
                        f = c.state.messages;
                ...
                Ze = function(e) {
                    ...
                    function n() {
                        ...
                        e.send = function(t, n, r) {
                            0;
                            R.default.isLoggingGatewayEvents && Ne.verbose("~>", t, n);
                            var i = Pe.pack({
                                op: t,
                                d: n
                            });
                            if (!r || e.isSessionEstablished()) try {
                                null != e.webSocket ? e.webSocket.send(i) : Ne.warn("Attempted to send without a websocket that exists. Opcode: ".concat(t))
                            } catch (e) {} else Ne.warn("Attempted to send while not being in a connected state opcode: ".concat(t))
                        };
                    ...
                    r.setResumeUrl = function(e) {
                        ...
                        null !== e && Ne.info("Updating resume url to ".concat(e));
                        this.resumeUrl = e
                    };
                    r._connect = function() {
                        var e = this;
                        if (this.willReconnect())
                            if (Se) Ne.info("Skipping _connect because socket is paused");
                            else {
                                ...
                                Ne.info("[CONNECT] ".concat(r, ", ") + "encoding: ".concat(n, ", ") + "version: ".concat(i, ", ") + "compression: ".concat(null != t ? t : "none"));
                                if (null !== this.webSocket) {
                                    Ne.error("_connect called with already existing websocket");
                                ...
                                we({
                                    ...
                                    onOpen: function(t, n) {
                                        ...
                                        Ne.info("[CONNECTED] ".concat(a.toString(), " in ").concat(r, " ms"));
                                        e.isFastConnect = t;
                                        e.lastIdentifyClientState = n;
                                        t ? e._doFastConnectIdentify() : e._doResumeOrIdentify()
                                    },
                                    onMessage: Ge(this.compressionHandler, (function(t, n) {
                                        var r = Date.now(),
                                            i = Pe.unpack(t),
                                            a = i.op,
                                            o = i.s,
                                        ...
                                        switch (a) {
                                            ...
                                            case Ee.DISPATCH:
                                                ...
                                                e._handleDispatch(u, s, "READY" === s ? {
                                                    ...
                                                    uncompressed_byte_size: je(t),
                                                    compression_algorithm: e.compressionHandler.getAlgorithm(),
                                                    packing_algorithm: Pe.getName(),
                                                    unpack_duration_ms: c
                                                } : null);
                                                break;
                                            default:
                                                Ne.info("Unhandled op ".concat(a))
                                        }
                                    })),
                                    onError: function() {
                                        e.setResumeUrl(null);
                        ...
                        else Ne.info("Skipping _connect because willReconnect is false")
                    };
                    r._handleHello = function(e) {
                        var t = this.heartbeatInterval = e.heartbeat_interval,
                            n = Date.now() - this.connectionStartTime;
                        Ne.info("[HELLO] via ".concat(ae(e), ", ") + "heartbeat interval: ".concat(t, ", ") + "took ".concat(n, " ms"));
                        this._startHeartbeater()
                    };
                    r._handleReconnect = function() {
                        Ne.info("[RECONNECT] gateway requested I reconnect.");
                        this._cleanup((function(e) {
                            return e.close(4e3)
                        }));
                    ...
                    r._handleInvalidSession = function(e) {
                        Ne.info("[INVALID_SESSION]".concat(e ? " can resume)" : ""));
                    ...
                    r._handleDispatchWithoutQueueing = function(e, t, n) {
                        ...
                        if ("READY_SUPPLEMENTAL" === t) {
                            ...
                            Ne.info("[READY_SUPPLEMENTAL] took ".concat(r, "ms"));
                            this.connectionState = Ue.SESSION_ESTABLISHED;
                            this.gatewayBackoff.succeed()
                        } else if ("RESUMED" === t) {
                            a.ZP.Emitter.resume();
                            var i = Date.now() - this.connectionStartTime;
                            Ne.info("[RESUMED] took ".concat(i, "ms, via ").concat(ae(e), ", ") + "replayed ".concat(this.resumeAnalytics.numEvents, " events, new seq: ").concat(this.seq));
                    ...
                    r._handleReady = function(e, t) {
                        ...
                        Ne.info("[READY] took ".concat(r, "ms, as ").concat(i, " via ").concat(o));
                        this.connectionState = Ue.SESSION_ESTABLISHED;
                        this.gatewayBackoff.succeed();
                        var s = function(e) {
                            var t, n, r = Date.now(),
                    ...
                    r._handleGenericDispatch = function(e, t) {
                        R.default.isLoggingGatewayEvents && Ne.verbose("<~", t, e);
                        try {
                    ...
                    r._handleHeartbeatAck = function(e) {
                        ...
                        if (null !== this.expeditedHeartbeatTimeout) {
                            ...
                            Ne.info("Expedited heartbeat succeeded")
                        }
                    };
                    r._handleHeartbeatTimeout = function() {
                        ...
                        Ne.warn("[ACK TIMEOUT] reconnecting in ".concat((t / 1e3).toFixed(2), " seconds."))
                    };
                    r._handleClose = function(e, t, n) {
                        ...
                        if (t === ke) {
                            ...
                            Ne.warn("[WS CLOSED] because of authentication failure, marking as closed.");
                            return this._reset(e, t, n)
                        }
                        this.connectionState = Ue.WILL_RECONNECT;
                        if (this.nextReconnectIsImmediate) {
                            Ne.warn("[WS CLOSED] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ") retrying immediately."));
                            this._connect()
                        } else {
                            var i = this.gatewayBackoff.fail((function() {
                                return r._connect()
                            }));
                            Ne.warn("[WS CLOSED] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ") retrying in ").concat((i / 1e3).toFixed(2), " seconds."));
                    ...
                    r._reset = function(e, t, n) {
                        this.sessionId = null;
                        this.seq = 0;
                        Ne.warn("[RESET] (".concat(e.toString(), ", ").concat(t, ", ").concat(n, ")"));
                    ...
                    r._cleanup = function(e) {
                        ...
                        this.compressionHandler = new F(Pe)
                    };
                    r._doResume = function() {
                        this.connectionState = Ue.RESUMING;
                        this.resumeAnalytics = ue(Date.now() - this.connectionStartTime);
                        var e;
                        Ne.info("[RESUME] resuming session ".concat(null !== (e = this.sessionId) && void 0 !== e ? e : "", ", seq: ").concat(this.seq));
                        this.send(Ee.RESUME, {
                            token: this.token,
                    ...
                    r.connect = function() {
                        if (!this.isClosed()) {
                            Ne.error("Cannot start a new connection, connection state is not closed");
                            return !1
                        }
                        Ne.info(".connect() called, new state is WILL_RECONNECT");
                        this.connectionState = Ue.WILL_RECONNECT;
                        this._connect();
                        return !0
                    };
                    ...
                    r.resetSocketOnError = function(e, t) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {
                            ...
                            r = this;
                        Ne.error("resetSocketOnError", e.stack);
                        ...
                        n.sentry && N.Z.captureException(e);
                        this._cleanup((function(e) {
                            return e.close()
                        }));
                        ...
                        if (0 === this.dispatchExceptionBackoff._fails && n.immediate) {
                            Ne.info("Triggering fast reconnect");
                    ...
                    r.close = function() {
                        var e = this;
                        if (this.isClosed()) Ne.info("close() called, but socket is already closed.");
                        else {
                            Ne.info("Closing connection, current state is ".concat(this.connectionState));
                            this._cleanup((function(e) {
                                return e.close()
                            }));
                            this.connectionState = Ue.CLOSED;
                    ...
                    r.expeditedHeartbeat = function(e) {
                        ...
                        if (!this.isClosed())
                            if (this.isConnected()) {
                                Ne.info("Performing an expedited heartbeat ".concat(null != t && "" !== t ? "reason: " + t : ""));
                                this.heartbeatAck = !1;
                                this._sendHeartbeat();
                            ...
                            } else n ? this.resetBackoff(t, r) : Ne.info("Expedited heartbeat requested, but, connection state is ".concat(this.connectionState, " and reconnectImmediately was not requested ").concat(null != t && "" !== t ? "reason: " + t : ""))
                    };
                    r.resetBackoff = function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                            t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                        Ne.info("Connection has reset backoff".concat(null != e && "" !== e ? " for reason: " + e : ""));
                        this.gatewayBackoff.succeed();
                    ...
                    ! function(e, t, n) {
                        ...
                        set: function(e) {
                            Ne.log("Setting connection state to ".concat(e));
            ...
            var Ke = function() {
                ...
                t.update = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        n = this.getNextState(qe({}, this.state, e));
            ...
            0;
            (0,
                Y.nI)() && Ve.Z.remotePowerMonitor.on("resume", (function() {
            ...
            Ot.on("dispatch", (function(e, t) {
                Nt.push([e, t]);
                if (Lt.has(e)) {
                    null != Pt && clearTimeout(Pt);
                    Ut()
                } else null == Pt && (Pt = setTimeout(Ut, wt))
            }));
            ...
            function Ut() {
                ...
                var e = Date.now(),
                    t = Nt.slice();
                Nt.length = 0;
                if (null == Dt) throw Error("setDispatchSocketMessageFunction needs to be called first!");
                var n = "none";
                try {
                    xe.Z.Emitter.batched((function() {
                        t.forEach((function(e) {
                            var t = Tt(e, 2),
                                r = t[0],
                                i = t[1];
            ...
            function wn(e, t, n) {
                var r = n.roles,
                    ...
                    f = n.unusual_dm_activity_until,
                    _ = zt.ZP.getMember(e, t.id);
                null != _ && _.nick === a && _.avatar === o && i().isEqual(_.roles, r) && _.premiumSince === u && _.isPending === c && _.joinedAt === l && _.communicationDisabledUntil === d && _.flags === s && _.unusualDMActivityUntil === f || Pn({
            ...
            function jn(e) {
                jn = Object.setPrototypeOf ? Object.getPrototypeOf : function(e) {
                    return e.__proto__ || Object.getPrototypeOf(e)
                };
                return jn(e)
            }
            ...
            Dt = function(e, t) {
                ...
                switch (e) {
                    ...
                    case "RESUMED":
                        ...
                        break;
                    case "TYPING_START":
                        null != t.member && wn(t.guild_id, t.member.user, t.member);
                        Pn({
                            type: "TYPING_START",
                            channelId: t.channel_id,
                            userId: t.user_id
                    ...
                    case "USER_PREMIUM_GUILD_SUBSCRIPTION_SLOT_CREATE":
                        Pn({
                            ...
                            guildBoostSlot: Vt.Z.createFromServer(t, qt.Z.getSubscriptionById(t.subscription_id))
                        });
                        break;
            ...
            const $n = new Qn(o.Z, {
                ...
                LOBBY_VOICE_CONNECT: qn,
                LOBBY_VOICE_DISCONNECT: qn,
                RPC_APP_DISCONNECTED: qn,
            ...
            function C() {
                var e = function() {
                    ...
                    var c, g, S, v, b = (0, p.Lw)(a, i),
                        ...
                        D = null != (null == T || null === (t = T.party) || void 0 === t ? void 0 : t.size) ? T.party.size[1] : 0;
                    return {
                        application_id: m.gD,
            ...
            const q = new W(a.Z, {
                ...
                GUILD_CREATE: function(e) {
                    ...
                    if (!d.Z.isLurking(t.id)) {
                        Y(t);
                        1 === w && null == t.stickers && null != t.stickerUpdates && (w = 0)
                    }
                },
                GUILD_DELETE: function(e) {
                    var t, n = e.guild;
        ...
        227172: (e, t, n) => {
            ...
            function L() {
                return (L = h((function(e, t) {
                    ...
                    return b(this, (function(s) {
                        switch (s.label) {
                            case 0:
                                return null != (n = D[e]) ? [2, n] : [4, P("/games", {
                                    id: e
                                }, t)];
                            case 1:
                            ...
                            return b(this, (function(S) {
                                switch (S.label) {
                                    ...
                                    case 3:
                                        ...
                                        g = null !== (y = N(s)) && void 0 !== y ? y : e.name;
                                        return [2, {
            ...
            G.displayName = "ExternalStreamingStore";
            const j = new G(s.Z, {
        ...
        997582: (e, t, n) => {
            ...
            function z() {
                ...
                c.ZP.getSelfEmbeddedActivities().forEach((function(e) {
                    ...
                    if (!u.has(r)) {
                        ...
                        t.push({
                            type: N.IIU.PLAYING,
                            name: null != i ? i : P.Z.Messages.EMBEDDED_ACTIVITIES_LAUNCHING_ACTIVITY,
                            application_id: r,
                            flags: N.xjy.EMBEDDED
                        })
                    }
                }));
                var d = D.ZP.getVisibleGame(),
            ...
            var F = function(e) {
                ...
                var r = n.prototype;
                r.initialize = function() {
                    this.waitFor(D.ZP, c.ZP, A.Z, C.Z, T.Z, O.Z);
                ...
                r.getCustomStatusActivity = function() {
                    return this.findActivity((function(e) {
                        return e.type === N.IIU.CUSTOM_STATUS
                    }))
                };
        ...
        436154: (e, t, n) => {
            ...
            function F() {
                var e;
                G = null !== (e = y.Z.getIdleSince()) && void 0 !== e ? e : 0;
                B = y.Z.isAFK();
                if (Z) {
                    k = M;
                    Y()
                } else k = U ? T.Skl.INVISIBLE : f.co.getSetting();
                k === T.Skl.ONLINE && G > 0 && (k = T.Skl.IDLE);
                var t = !1,
                ...
                if (t) {
                    var a = j.find((function(e) {
                        ...
                        s = j.filter((function(e) {
                            return e.type !== T.IIU.CUSTOM_STATUS
                        }));
                    V = s.length > 0 ? j : null != a ? [a].concat(D(o()(x).filter((function(e) {
                        return e.type !== T.IIU.CUSTOM_STATUS
                    })).uniqBy((function(e) {
                        return "".concat(e.type, ":").concat(e.application_id, ":").concat(e.name)
                    })).value())) : o().uniqBy(x, (function(e) {
                        return "".concat(e.type, ":").concat(e.application_id, ":").concat(e.name)
                    }))
                }
            }
            ...
            function W() {
                ...
                M = T.Skl.UNKNOWN;
                F();
                v.Z.setCurrentUserOnConnectionOpen(k, V)
            }
            var q = function(e) {
                ! function(e, t) {
                    if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
            ...
            q.displayName = "SelfPresenceStore";
            const K = new q(u.Z, {
                START_SESSION: F,
                CONNECTION_OPEN: W,
        ...
        69660: (e, t, n) => {
            ...
            var z = function() {
                ...
                F = function(e) {
                    ...
                    r.destroy = function(e) {
                        ...
                        M(G(n.prototype), "destroy", this).call(this)
                    };
                    ...
                    r._initializeEvents = function() {
                        var e = this,
                            t = !1;
                        this.on(d.z.State, (function(t, n, r) {
                            c.Z.wait((function() {
                                return c.Z.dispatch(B(j({
                        ...
                        this.on(d.z.Video, (function(n, r, i, a, o) {
                            var s = (0, N.my)(e._streamKey);
                        ...
                        this.on(d.z.VideoSourceQualityChanged, (function(e, t, n, r, i, a) {
                            c.Z.wait((function() {
                                return c.Z.dispatch({
                    ...
                    r._trackVideoStartStats = function() {
                        var e = this.isOwner ? P() : null;
                        v.default.track(O.rMx.VIDEO_STREAM_STARTED, B(j({}, this._getStreamAnalyticsProperties(), e), {
                    ...
                    r._trackVideoEndStats = function(e) {
                        ...
                        v.default.track(O.rMx.VIDEO_STREAM_ENDED, B(j({}, i, o, a, null, this._videoStreamStats.getStats(), this._soundshareStats.getStats(), this._getStreamAnalyticsProperties(), d), {
                            channel_type: n,
                            reason: e,
                    ...
                    r._getExtraConnectionOptions = function() {
                        return {
                            streamUserId: (0, N.my)(this._streamKey).ownerId
                        }
                    };
                    ! function(e, t, n) {
                        t && U(e.prototype, t);
            ...
            function he(e) {
                e.filter((function(e) {
                    return e.connection.context === w.Yn.STREAM
                })).forEach((function(e) {
                    var t = e.stats;
                    c.Z.dispatch({
            ...
            function me(e) {
                ...
                if (q.FB || "Chrome" === (null === platform || void 0 === platform ? void 0 : platform.name)) {
            ...
            var ye = function(e) {
                ...
                r.getStatsHistory = function(e, t, n) {
                    ...
                    if (n) {
                        var r = K.Z.getActiveStreamForUser(t, e);
                        if (null == r) return null;
                        if (0 === K.Z.getViewerIds(r).length) return null
                    }
            ...
            const ge = new ye(c.Z, !J.Z.isSupported() || __OVERLAY__ ? {} : {
                ...
                STREAM_CREATE: function(e) {
                    ...
                    if (null == o && null != n) {
                        ...
                        var c = m.Z.getChannel(s.channelId),
                            l = null != c && c.isBroadcastChannel();
                        o = function(e, t, n) {

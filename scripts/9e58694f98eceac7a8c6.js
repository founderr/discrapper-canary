    ...
    ["18036"], {
                ...
                return (0, a.jsx)(l.FocusRing, {
                    ...
                    children: (0, a.jsxs)("div", {
                        ...
                        children: [null != t ? (0, a.jsx)("img", {
                            ...
                            multiple: !1,
                            tabIndex: 0,
                            "aria-label": r.default.Messages.GUILD_CREATE_UPLOAD_ICON_BUTTON_TEXT
                        })]
                    })
                })
            }
                    ...
                    acceptGuildTemplate: (e, t, s) => (l.default.dispatch({
                        ...
                        a.default.post({
                            ...
                            l.default.dispatch({
                                ...
                                code: e,
                                guild: s
                            }), n.default.isConnected() ? i.default.addConditionalChangeListener(() => {
                                if (null != i.default.getGuild(s.id)) return (0, r.transitionToGuild)(s.id), d(s), !1
        ...
        800932: function(e, t, s) {
            ...
            function g(e) {
                ...
                l.useEffect(() => {
                    (async function e() {
                        ...
                        if (null == e) try {
                            e = await (0, _.fetchCurrentUser)()
                        } catch (e) {
                            E.default.verifySSOToken(null)
                        }
                        null != e && n(o.defaultName.format({
                            username: e.username
                        }))
                    })()
                }, [o.defaultName]);
                ...
                return {
                    form: T,
                    preview: M,
                    handleSubmit: () => C.default.acceptGuildTemplate(e.code, s, r).catch(e => d(e))
                }
            }
            ...
            function x(e) {
                let {
                    ...
                    let t = function(e) {
                        ...
                        return t === R.ChannelTypes.GUILD_VOICE ? M.default : t === R.ChannelTypes.GUILD_CATEGORY ? T.default : m.default
                    }(e);
                    return (0, a.jsxs)("div", {
                        className: r(N.channel, {
                            [N.category]: e.type === R.ChannelTypes.GUILD_CATEGORY
                        }),
                        children: [(0, a.jsx)(t, {
            ...
            function h(e) {
                let {
                    roles: t
                } = e, s = t.slice().reverse().map(e => (0, a.jsx)(O, {
                    role: e
                }, e.id));
                return (0, a.jsx)("ul", {
            ...
            function O(e) {
                ...
                let {
                    role: s
                } = e, l = null == s.color ? o.default.unsafe_rawColors.PRIMARY_300.css : (0, d.int2hex)(s.color);
                return (0, a.jsxs)("li", {
                    className: N.role,
                    style: {
        ...
        434824: function(e, t, s) {
            ...
            var l = s("124969"),
                ...
                u = s("685991");
            let d = {
                [i.InternalTemplateCodes.CLASSROOM]: s("251834"),
                [i.InternalTemplateCodes.LOCAL_COMMUNITIES]: s("787762"),
                [i.InternalTemplateCodes.CREATORS_HOBBIES]: s("41668"),
                [i.InternalTemplateCodes.GLOBAL_COMMUNITIES]: s("494323"),
                [i.InternalTemplateCodes.FRIENDS_FAMILY]: s("660389"),
                [i.InternalTemplateCodes.STUDY_GROUPS]: s("508971"),
                [i.InternalTemplateCodes.CREATE_FROM_SCRATCH]: s("800573"),
                [i.InternalTemplateCodes.CAMPUS_CLUBS]: s("97595"),
                [i.InternalTemplateCodes.LEAGUE_CLUBS]: s("556659"),
                [i.InternalTemplateCodes.GITHUB_HACKATHON]: s("212509")
            };
                ...
                if (null != c) {
                    ...
                    return (0, a.jsxs)("div", {
                        children: [(0, a.jsx)("img", {
                            ...
                            children: d
                        }), s.state === i.GuildTemplateStates.RESOLVED ? (0, a.jsx)(r.UsagePill, {
        ...
        473759: function(e, t, s) {
            ...
            function M(e) {
                ...
                return (0, a.jsx)("div", {
                    className: n(L.usagePill, t, L.userText),
                    children: null != l || null != r ? _.default.Messages.GUILD_TEMPLATE_USAGES_BY_CREATOR2.format({
                        usageCount: s,
                        creator: null != r ? r : l,
                        creatorHook: (e, t) => (0, a.jsx)(m, {
                            text: e,
                            verified: null != r
                        }, t)
            ...
            function C(e) {
                ...
                let T = (0, c.default)(s.code).header;
                if (!i) return (0, a.jsxs)("div", {
                    className: L.container,
                    children: [(0, a.jsx)(u.Title, {
                        className: L.title,
                        children: T
                    }), (0, a.jsx)(u.SubTitle, {
                        className: n(L.subtitle, L.userText),
                        children: s.name
                    })]
                });
                return (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)(u.Title, {
                        ...
                        className: n(L.subtitle, f.marginTop2),
                        children: _.default.Messages.GUILD_TEMPLATE_BASED_ON
                    }), (0, a.jsx)(u.Title, {
                        className: n(L.title, L.userText),
                        children: s.name
                    }), null != s.description && "" !== s.description && (0, a.jsx)(u.SubTitle, {
                        className: n(L.subtitle, L.userText, f.marginTop8),
        ...
        843456: function(e, t, s) {
            ...
            function _(e) {
                let {
                    ...
                    preview: L,
                    handleSubmit: f
                } = (0, d.default)(l, !1), T = (0, i.useUID)();
                return (0, a.jsx)("div", {
                    children: (0, a.jsxs)(r.ModalRoot, {
                        size: r.ModalSize.DYNAMIC,
                        transitionState: t,
                        className: n(E.modalRoot),
                        "aria-labelledby": T,
                        children: [(0, a.jsxs)("div", {
                            className: E.modalContainer,
                            children: [(0, a.jsx)("div", {
                                className: n(E.modalSection, E.ctaSection),
                                children: (0, a.jsx)("div", {
                                ...
                                className: n(E.modalSection, E.formSection),
        ...
        124969: function(e, t, s) {
            ...
            let C = e => {
                ...
                p = e => {
                    let {
                        className: t,
                        ...s
                    } = e, l = s.look === r.Button.Looks.LINK;
            ...
            p.Looks = r.Button.Looks, p.Colors = r.Button.Colors, p.Sizes = r.Button.Sizes;
            let R = e => {
                    let {
                        className: t,
                        src: s,
                    ...
                    return (0, a.jsx)(M, {
                        src: s,
                        size: l,
                        className: n(m.inviteLargeIcon, t),
                        "aria-hidden": !0
                    })
                },
                S = e => {
            ...
            let N = e => {
                ...
                return (0, a.jsx)(M, {
                    ...
                    size: l,
                    className: n(m.inviteIcon, t),
                    "aria-hidden": !0
                })
            };
            N.Sizes = r.AvatarSizes;
            let g = e => {
                    let {
                        label: t,
                        error: s,
                ...
                h = e => {
                    ...
                    return (0, a.jsx)(r.Text, {
                        variant: l ? "text-sm/normal" : "text-xs/normal",
                        className: n(m.subText, t),
                        children: s
                    })
                },
                O = e => {
                ...
                D = e => {
                    ...
                    return null == l ? null : (null != s && s > 0 && (t = (0, a.jsxs)("div", {
                        className: n(m.pill, m.pillOnline, d && m.pillFlat),
                        children: [(0, a.jsx)("i", {
                            className: m.pillIconOnline
                        }), (0, a.jsx)(r.Text, {
                            tag: "span",
                            className: n(m.pillMessage, o),
                            variant: "text-sm/normal",
                        ...
                        children: [t, (0, a.jsxs)("div", {
                            className: n(m.pill, d && m.pillFlat),
                            children: [(0, a.jsx)("i", {
                ...
                U = e => {
                    ...
                    return null == t ? null : (0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)(r.Text, {
                            ...
                            variant: "text-md/normal",
                            color: "header-secondary",
                            children: T.default.Messages.MULTI_ACCOUNT_SERVER_INVITE_JOINING_AS
                        }), (0, a.jsx)(R, {
                ...
                v = e => {
                    ...
                    return (0, a.jsxs)(x, {
                        ...
                        children: [(0, a.jsx)(p, {
                            ...
                            children: T.default.Messages.NUF_DOWNLOAD_APP_BUTTON_PLATFORM.format({
                                platform: (0, E.getPlatformReadableName)()
                            })
                        }), (0, a.jsx)(h, {
                            className: m.downloadButtonSubtext,
                            children: T.default.Messages.INCOMPATIBLE_BROWSER.format({
                                supportedBrowserURL: _.default.getArticleURL(f.HelpdeskArticles.SUPPORTED_BROWSERS)
                            })
                        })]
                    })
                };
            var b = e => {
                ...
                return (0, a.jsxs)(l, {
                    ...
                    onSubmit: r,
                    style: o,
                    className: n(u ? m.authBoxExpanded : m.authBox, (0, L.getThemeClass)(d), t),
                    children: [(0, a.jsx)("div", {
                        className: m.discordLogo
                    }), (0, a.jsx)("div", {
                        className: n(m.centeringWrapper, s),
                        children: i
                    })]
                })
            }
        ...
        637888: function(e, t, s) {
            ...
            function I(e) {
                let {
                    ...
                    webmDark: u = m,
                    webmLight: d = A
                } = e, _ = (0, o.getChromeVersion)(), I = [(0, n.jsx)("source", {
                    src: a,
                    type: "video/mp4"
                }, "mp4"), (0, n.jsx)("img", {
                    alt: "",
                    src: r
                }, "png")], p = [(0, n.jsx)("source", {
                    src: l,
                    type: "video/mp4"
                }, "mp4"), (0, n.jsx)("img", {
                    alt: "",
                ...
                return (_ > 52 || -1 === _) && (I.unshift((0, n.jsx)("source", {
                    src: u,
                    type: "video/webm"
                }, "webm")), p.unshift((0, n.jsx)("source", {
                    src: d,
                    type: "video/webm"
                }, "webm"))), (0, o.supportsHEVCAlpha)() && (I.unshift((0, n.jsx)("source", {
                    src: t,
                    type: "video/mp4"
                }, "hevc")), p.unshift((0, n.jsx)("source", {
                    src: s,
                    type: "video/mp4"
                }, "hevc"))), {
                    [L.ThemeTypes.DARK]: I,
                    [L.ThemeTypes.LIGHT]: p
                }
            }
            let p = null === (a = (l = d.default).getAppSpinnerSources) || void 0 === a ? void 0 : a.call(l),
                R = null != p ? I(p) : null,
                S = I({});
            var N = e => {
                var t;
                let {
                    ...
                    reducedMotion: E
                } = r.useContext(u.AccessibilityPreferencesContext), f = S;
                null != R && (f = R);
                let T = (0, i.isThemeDark)(c) ? L.ThemeTypes.DARK : L.ThemeTypes.LIGHT,
                    m = null !== (t = f[T]) && void 0 !== t ? t : f[L.ThemeTypes.DARK];
                return (0, n.jsx)(_.default, {
                    ref: l,
                    onLoadedData: o,
                    className: d,
                    loop: !E.enabled && s,
                    autoPlay: !E.enabled && a,
                    playsInline: !0,

    ...
    [17091], {
                            ...
                            if (_ && a.isGuildStageVoice() && (0, I.xJ)(a.id)) {
                                (0, p.ZD)(Z((function() {
                                    ...
                                    return w(this, (function(r) {
                                        switch (r.label) {
                                            case 0:
                                                return [4, Promise.all([n.e(40532), n.e(42687), n.e(17586), n.e(40056), n.e(19887), n.e(33973), n.e(27499), n.e(45353), n.e(73727), n.e(54602), n.e(52555), n.e(6565), n.e(61953), n.e(16239), n.e(24251), n.e(94302), n.e(69839), n.e(91406), n.e(32437)]).then(n.bind(n, 518197))];
                                            case 1:
        ...
        258104: (e, t, n) => {
            ...
            var z = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        ...
                        handleDismissNewIndicator: W,
                        instance: Q
                    }
                };
                return n
            }(r.ZP.PersistedStore);
            z.displayName = "EmbeddedActivitiesStore";
            z.persistKey = "EmbeddedActivities";
            z.migrations = [function(e) {
                return N(I({}, e), {
            ...
            var Q = new z(i.Z, {
                ...
                EMBEDDED_ACTIVITY_DISMISS_NEW_INDICATOR: W,
        ...
        717091: (e, t, n) => {
            ...
            var ye = function() {
                ...
                Te = te.S7T.VIEW_CHANNEL | te.S7T.READ_MESSAGE_HISTORY,
                Ce = null,
                Ae = null,
                Se = null,
                me = !1,
            ...
            function Pe() {
                return H.Z.fromTimestamp(Date.now() - Ze)
            }
            var Le = 0,
                we = 0,
                Ge = 0,
            ...
            function qe(e) {
                ...
                if (null == Ue[e.channelId]) return !1;
            ...
            var ze = function() {
                ...
                t.canBeUnread = function() {
                    ...
                    if (!this._isThread && (0, m.r1)(this._guildId)) {
                        if (this._lastMessageTimestamp < Le) return !1;
                ...
                t.canHaveMentions = function() {
                    return 0 !== this.mentionCount && (!(this._isThread && !this._isJoinedThread) && (!(0, O.h3)(this.channelId, [N.Z, y.Z]) && (!((0, m.r1)(this._guildId) && this._lastMessageTimestamp < Le) && this.canTrackUnreads())))
                };
                t.getGuildChannelUnreadState = function(e, t, n, r, i, o) {
                    if (M._.getCurrentConfig({
                        ...
                        if (this._ackMessageTimestamp < we) return {
                            mentionCount: 0,
                            hasNotableUnread: !1
                        };
                        if (this._lastMessageTimestamp < Le) return {
                            mentionCount: 0,
                            hasNotableUnread: !1
                        }
                    }
                ...
                t.hasNotableUnread = function() {
                    ...
                    if (M._.getCurrentConfig({
                        ...
                        if (this._lastMessageTimestamp < Le) return !1;
                        if (this._ackMessageTimestamp < we) return !1
                    }
                    return this.getAckTimestamp() < this._lastMessageTimestamp
                };
                t.hasRecentlyVisitedAndRead = function() {
                    return this._lastMessageTimestamp > 0 && null != this._ackMessageId && this.getAckTimestamp() > Ge && D.Z.getGuildRecentsDismissedAt(this._guildId) < this.getAckTimestamp()
                };
                ...
                t._ack = function(e, t) {
                    ...
                    if (null != r) {
                        ...
                        We((function() {
                            ...
                            if (null != r) {
                                Se === o && i === Y.default.getId() && (Se = r.body.token);
                                if (t) {
                ...
                t.recalculateFlags = function() {
                    if (this.type === oe.W.CHANNEL) {
                        var e = j.Z.getChannel(this.channelId);
                        if (null != e) return e.isThread() ? xe.IS_THREAD : null != e.guild_id ? xe.IS_GUILD_CHANNEL : 0
                    }
                };
                ...
                t.shouldDeleteReadState = function(e) {
                    ...
                    return null == t ? !!nt(this, e) : !!Z.AW.has(t.type) && (!(0, Z.Em)(t.type) || !(0, Z.hv)(t.type) && (!(!Z.Ec.has(t.type) || ! function(e, t, n) {
                        var r = e.guildId;
                        return (null == r || !R.Z.isActive(r, t.parent_id, e.channelId)) && nt(e, n)
                ...
                t.getAckTimestamp = function() {
                    ...
                    if (this._isThread) {
                        this._ackMessageTimestamp = et(this.guildId, this.channelId);
                    ...
                    t = null != e ? tt(e) : H.Z.extractTimestamp(this.channelId);
            ...
            ze._guildReadStateSentinels = {};
            ze._readStates = {};
            ze._mentionChannels = new Set;
            ...
            function Qe(e) {
                e.forEach((function(e) {
                    if ((0, Z.Em)(e.type)) {
                        ...
                        t.lastPinTimestamp = Ye(e.lastPinTimestamp);
            ...
            function Je(e) {
                e.forEach((function(e) {
                    if ((0, Z.Em)(e.type)) {
                        ...
                        n.lastPinTimestamp = Ye(e.last_pin_timestamp);
            ...
            function Xe(e) {
                ! function(e) {
                    ...
                    null === (t = e.threads) || void 0 === t || t.forEach((function(t) {
                        if (Z.AW.has(t.type)) {
                            ...
                            n.lastPinTimestamp = Ye(t.lastPinTimestamp);
                            n._isThread = !0;
                            n._isActiveThread = !0;
                            n._isJoinedThread = null != t.member;
                            null == n.ackMessageId && (n.ackMessageId = H.Z.fromTimestamp(et(e.id, t.id)));
                            null == n.ackPinTimestamp && (n.ackPinTimestamp = et(e.id, t.id))
                        }
                    }))
                }(e);
                ! function(e) {
                    var t;
                    if (0 === (null === (t = e.guild_scheduled_events) || void 0 === t ? void 0 : t.length) && null == ze.getIfExists(e.id, oe.W.GUILD_EVENT)) return;
                    var n = ze.get(e.id, oe.W.GUILD_EVENT);
                    n._guildId = e.id;
                    var r, i = 0,
                        o = null,
                ...
                ! function(e) {
                    var t = 24;
                    ze.get(e.id, oe.W.GUILD_HOME).lastMessageId = H.Z.fromTimestamp(u()(Date.now()).subtract(t, "h").valueOf())
                }(e);
                ! function(e) {
                    var t = e.properties.latest_onboarding_question_id;
                    if (null == t) return;
                    var n = ze.get(e.id, oe.W.GUILD_ONBOARDING_QUESTION);
                    n._guildId = e.id;
                    n.lastMessageId = t
                }(e)
            }
            ...
            function $e(e) {
                ! function(e) {
                    ...
                    if (!(0, A.$N)()) return !1;
                    if (null == t) return !1;
                    var n = ze.get(t.id, oe.W.NOTIFICATION_CENTER);
                    e.forEach((function(e) {
            ...
            function et(e, t) {
                var n, r, i, o = j.Z.getChannel(t),
                    ...
                    a = (null == o ? void 0 : o.isForumPost()) ? 0 : tt(u),
                    ...
                    if (t.type === oe.W.CHANNEL) {
                        ...
                        if (null != n && n.isForumPost() && null != n.parent_id) {
                            ...
                            R.Z.hasLoaded(n.guild_id) && Object.keys(R.Z.getThreadsForParent(n.guild_id, r)).every((function(e) {
                                return It.hasOpenedThread(e) || H.Z.compare(e, i.ackMessageId) < 0
                            })) && i.ack({})
                        }
                    }
                }
            ...
            function ot() {
                null != be && clearTimeout(be)
            }

            function ut(e) {
                if (null != e.channelUpdates) {
                    var t;
                    Qe(null === (t = e.channelUpdates) || void 0 === t ? void 0 : t.writes)
                }
                if (null != e.channelTimestampUpdates) {
                    ...
                    try {
                        for (var o, u = e.channelTimestampUpdates[Symbol.iterator](); !(n = (o = u.next()).done); n = !0) {
                            ...
                            null != a.last_pin_timestamp && (s.lastPinTimestamp = Ye(a.last_pin_timestamp))
                        }
                    } catch (e) {
                        r = !0;
                        i = e
            ...
            function ct(e) {
                var t = e.channel;
                return ze.clear(t.id)
            }

            function dt() {
                var e = F.ZP.getCurrentSidebarChannelId(Ce),
                    t = !1;
                if (Ae !== e) {
                    t = _t(Ae);
                    Ae = e
            ...
            function pt(e) {
                return gt(e.id, e.ackType, e.ackedId, e.local)
            }
            ...
            var vt = function(e) {
                ...
                r.getGuildChannelUnreadState = function(e, t, n, r, i, o) {
                    return ze.getValue(e.id, oe.W.CHANNEL, (function(u) {
                ...
                r.lastPinTimestamp = function(e) {
                    return ze.getValue(e, oe.W.CHANNEL, (function(e) {
                ...
                r.isNewForumThread = function(e, t, n) {
                    var r = ze.get(t);
                    if (!0 === ze.get(e)._persisted || null == r.ackMessageIdAtChannelSelect || H.Z.compare(e, r.ackMessageIdAtChannelSelect) <= 0) return !1;
                    var i = tt(n);
                ...
                r.getGuildUnreadsSentinel = function(e) {
                    return ze.getGuildSentinels(e).unreadsSentinel
                };
                r.getMentionChannelIds = function() {
                    return ze.getMentionChannelIds()
                };
                r.__getLocalVars = function() {
                    return {
                        logger: Oe,
                        ...
                        OverlayStore: Ie,
                        isDrawerOpen: ye,
                        CAN_READ_HISTORY_PERMISSIONS: Te,
                        BULK_ACK_CHUNK_SIZE: 100,
                        BULK_ACK_REQ_PER_SEC: 1,
                        currentChannelId: Ce,
                        currentSidebarChannelId: Ae,
                        ackToken: Se,
                        hasCache: me,
                        bulkAckQueue: Me,
                        processingBulkAcks: Re,
                        deleteOldReadStatesTimer: be,
                        autoAckableChannelWindowIds: Ue,
                        mobileAutoAckDisabledChannelIds: De,
                        OLD_THREAD_CUTOFF_MS: Ze,
                        decayedReadStateCutoff: Le,
                        decayedReadStateBasedOnVisitCutoff: we,
                        channelVisitAndReadCutoff: Ge,
                        decayedReadStateTimer: ke,
                        MAX_RETRIES: 3,
                        ReadStateFlags: xe,
                        instance: It
                    }
            ...
            var It = new vt(d.Z, {
                CONNECTION_OPEN: function(e) {
                    ...
                    o.entries.forEach((function(e) {
                        ...
                        var r, i = ze.get(e.id, n);
                        i._persisted = !0;
                        i._mentionCount = null !== (r = e.mention_count) && void 0 !== r ? r : 0;
                        i.flags = e.flags;
                        i.lastViewed = e.last_viewed;
                        var o = j.Z.getBasicChannel(e.id);
                        null == o || !(0, Z.Q5)(o.type) || null != e.last_message_id && 0 !== e.last_message_id ? i.ackMessageId = e.last_message_id : i.ackMessageId = H.Z.fromTimestamp(et(o.guild_id, o.id));
                        i.ackPinTimestamp = Ye(e.last_pin_timestamp);
                        ze._mentionChannels.delete(i.channelId);
                        i._mentionCount > 0 && i.canHaveMentions() && ze._mentionChannels.add(i.channelId)
                    }));
                    ze.resetGuildSentinels();
                    var u = null === (t = $.default.getCurrentUser()) || void 0 === t ? void 0 : t.id;
                    if (null != u) {
                        ze.get(u, oe.W.NOTIFICATION_CENTER).lastMessageId = H.Z.fromTimestamp(Date.now())
                    }
                    $e(r);
                    Qe(i);
                    var a = !0,
                    ...
                    try {
                        for (var c, d = n[Symbol.iterator](); !(a = (c = d.next()).done); a = !0) {
                            var f, _ = c.value;
                            Qe(null !== (f = _.channels) && void 0 !== f ? f : []);
                            ut(_);
                            Xe(_)
                        }
                    } catch (e) {
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    Se = null;
                    Ce = n;
                    Ae = F.ZP.getCurrentSidebarChannelId(Ce);
                    ze.clearAll();
                    t.forEach((function(e) {
                        var t = ze.get(e.channelId);
                ...
                CACHE_LOADED: function(e) {
                    ...
                    t.forEach((function(e) {
                        ...
                        e.type = n;
                        null == ze._readStates[n] && (ze._readStates[n] = {});
                        ze._readStates[n][e.channelId] = (0, c.gh)(e, ze)
                    }))
                },
                GUILD_CREATE: function(e) {
                    var t, n = e.guild,
                    ...
                    Qe(null !== (t = n.channels) && void 0 !== t ? t : []);
                    ut(n);
                    Xe(n)
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    if (!(null != n.author && Q.Z.isBlocked(n.author.id) || n.type === te.uaV.RECIPIENT_REMOVE && (null == s ? void 0 : s.type) === te.d4z.GROUP_DM) && (null != a && (0, T.Hl)({
                        ...
                        i.mentionCount++;
                        if ((0, S.bY)() && null != a) {
                            ze.get(a.id, oe.W.NOTIFICATION_CENTER).lastMessageId = n.id;
                            C.Z.tabFocused && gt(a.id, oe.W.NOTIFICATION_CENTER, void 0, !1)
                        }
                    }
                },
                MESSAGE_DELETE: at,
                MESSAGE_DELETE_BULK: at,
                MESSAGE_ACK: ht,
                ...
                CHANNEL_SELECT: function(e) {
                    ...
                    if (Ce !== t) {
                        u = _t(Ce) || u;
                        u = _t(Ae) || u
                    }(Ce === t || null != (null == r ? void 0 : r.type) && te.TPd.GUILD_THREADS_ONLY.has(r.type)) && (u = rt(t) || u);
                    Ce === t && (u = rt(n) || u);
                    Ce = t;
                    Ae = n;
                    return u
                ...
                THREAD_UPDATE: function(e) {
                    var t = e.channel;
                    return !!Z.AW.has(t.type) && ze.get(t.id).syncThreadSettings()
                },
                THREAD_LIST_SYNC: function(e) {
                    e.threads.forEach((function(e) {
                        if (Z.AW.has(e.type)) {
                            ...
                            if (e.isForumPost()) {
                                var n = ze.get(e.parent_id);
                                H.Z.compare(n.lastMessageId, e.id) < 0 && (n.lastMessageId = e.id)
                            }
                        }
                    }))
                },
                LOAD_THREADS_SUCCESS: st,
                LOAD_ARCHIVED_THREADS_SUCCESS: st,
                SEARCH_FINISH: function(e) {
                    var t = e.messages,
                        n = e.threads,
                        r = !0,
                ...
                THREAD_MEMBER_UPDATE: function(e) {
                    var t = e.id;
                    return ze.get(t).syncThreadSettings()
                },
                THREAD_MEMBERS_UPDATE: function(e) {
                    return (0, U.s)(e) && ze.get(e.id).syncThreadSettings()
                },
                CHANNEL_DELETE: ct,
                THREAD_DELETE: ct,
                WINDOW_FOCUS: function(e) {
                    var t = !1,
                        ...
                        i = void 0;
                    try {
                        for (var o, u = Object.entries(Ue)[Symbol.iterator](); !(n = (o = u.next()).done); n = !0) {
                            var a = Ee(o.value, 2),
                                s = a[0];
                            a[1] === e.windowId && (t = Et(s, e.focused) || t)
                        }
                    } catch (e) {
                        r = !0;
                        i = e
                ...
                BULK_ACK: function(e) {
                    ...
                    ! function(e, t) {
                        ...
                        return null != e.messageId && It.hasUnread(e.channelId, e.readStateType)
                    })), n)
                },
                ENABLE_AUTOMATIC_ACK: function(e) {
                    ...
                    0;
                    if (Ue[t] === n) return !1;
                    i()(void 0 === Ue[t], "handleEnableAutomaticAck: channel already visible in another window");
                    Ue[t] = n;
                    return rt(t)
                },
                ...
                GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
                    ...
                    ze.get(n, oe.W.GUILD_EVENT).handleGuildEventRemoval(n, t.id)
                },
                GUILD_SCHEDULED_EVENT_DELETE: function(e) {
                    var t = e.guildScheduledEvent,
                        n = t.guild_id;
                    if (lt(t)) return !1;
                    ze.get(t.guild_id, oe.W.GUILD_EVENT).handleGuildEventRemoval(n, t.id)
                },
                GUILD_DELETE: function(e) {
                    var t = e.guild;
                    return ze.clear(t.id, oe.W.GUILD_EVENT)
                },
                GUILD_UPDATE: function(e) {
                    var t = e.guild,
                        n = t.latest_onboarding_question_id;
                    if (null != n) {
                        var r = ze.get(t.id, oe.W.GUILD_ONBOARDING_QUESTION);
                        r._guildId = t.id;
                        r.lastMessageId = n
                    }
                },
                ...
                DECAY_READ_STATES: He,
                NOTIFICATION_CENTER_ITEM_CREATE: function(e) {
                    var t, n = e.item;
                    if (!(0, A.$N)()) return !1;
                    var r = null === (t = $.default.getCurrentUser()) || void 0 === t ? void 0 : t.id;
                    if (null == r) return !1;
                    var i = ze.get(r, oe.W.NOTIFICATION_CENTER);
                    i.lastMessageId = n.id;
                    var o = (0, S.bY)();
                    !o && C.Z.active || o && C.Z.tabFocused ? gt(r, oe.W.NOTIFICATION_CENTER, n.id, !1) : i.mentionCount++
                },
                RELATIONSHIP_ADD: function(e) {
                    var t = $.default.getCurrentUser();
                    if (!(0, A.$N)()) return !1;
                    ...
                    if (o < i) {
                        ...
                        !u && C.Z.active || u && C.Z.tabFocused ? gt(t.id, oe.W.NOTIFICATION_CENTER, void 0, !1) : r ? n.mentionCount-- : n.mentionCount++
                    }
                },
                RELATIONSHIP_REMOVE: function(e) {
                    var t = $.default.getCurrentUser();
...
//# sourceMappingURL=babdb2f7e41d54bc46db.js.map
    ...
    [30027], {
        ...
        766281: (e, t, n) => {
            ...
            function D(e, t) {
                var n, r = f.Z.getChannel(e),
                    o = (0, h.$)(e, f.Z, m.Z, E.Z).isSubscriptionGated,
                ...
                Re = {
                    ...
                    commandMention: {
                        ...
                        parse: function(e, t, n) {
                            ...
                            var r, o = (me(r = e[1].split(" ")) || he(r) || Pe(r, i) || be()).slice(1),
        ...
        30027: (e, t, n) => {
            ...
            function X(e) {
                ...
                var l = o()(t.reduce((function(e, t) {
                    ...
                    c = o()(g.ZP.getTextChannelNameDisambiguations(n)).map((function(e) {
                        return {
                            id: e.id,
                            text: e.name
                        }
                    ...
                    f = null != n ? o()(P.k1).filter((function(e) {
                        ...
                        return g.ZP.getChannels(n)[e].map((function(e) {
                            return {
                                id: e.channel.id,
                                text: e.channel.name
                            }
        ...
        770819: (e, t, n) => {
                    ...
                    o = Object.values(v.Z.getAllLibraryApplications()).map((function(r) {
                        return function(e, t, n, r, o) {
                            ...
                            return (0, P.Je)(e) || E.Z.isInstalled(e.id, e.branchId) ? {
                                ...
                                shouldShowInLibrary: (0, P.d0)(i, e, g.Z),
            ...
            var te = function(e) {
                ...
                n.prototype.initialize = function() {
                    this.syncWith([y.Z, f.Z, m.ZP, E.Z, O.Z, v.Z, h.Z, g.Z, p.Z], ee, 200);
        ...
        276433: (e, t, n) => {
            ...
            var w = function(e) {
                ...
                n.prototype.initialize = function() {
                    var e, t = null !== (e = l.Z.get(g)) && void 0 !== e ? e : {};
        ...
        504275: (e, t, n) => {
            ...
            function pe(e) {
                for (var t = e.query, n = e.members, r = e.limit, i = e.filter, l = x.default.getUsers(), a = T.Z.getGuildId(), c = t.toLocaleLowerCase(), s = (0, q.Fv)(c), f = [], d = [], p = n.length, y = 0, v = 0; y < p;) {
                    ...
                    if (g instanceof C.Z) {
                        ...
                        var O;
                        h = null === (O = g.nick) || void 0 === O ? void 0 : O.toLocaleLowerCase();
                        b = l[g.userId]
                    }
            ...
            const be = {
                ...
                queryChannels: function(e) {
                    ...
                    t = null != r ? l()(I.ZP.getChannels(r)[m]).map((function(e) {
                        return e.channel
                    ...
                    try {
                        for (var M, U = t[Symbol.iterator](); !(T = (M = U.next()).done); T = !0) {
                            var q = M.value;
                            if ((A = m, _ = q.type, L = null != r, A === _ || (L || (0, P.Km)(_)) && (A === I.sH ? (0, P.r8)(_) : A === I.Zb && (0, P.bw)(_))) && (!(0, P.Km)(q.type) || N.Z.can(E ? q.accessPermissions : s.Plq.VIEW_CHANNEL, q)) && y(q)) {
                                var F = z(C),
                                    H = q.name.toLocaleLowerCase(),
                                    V = ve(H, F, d);
                                if (0 !== V) {
                                    if (F.length > 0) {
                                        for (var Y = 0, Q = [me(q, Z), ge(q, Z)]; Y < Q.length; Y++) {
                                            var W = Q[Y];
                                            if (null != W && "" !== W) {
                                                var K = ve(W, F, !1);
                                                0 !== K && (V += .5 * K)
                ...
                queryGroupDMs: function(e) {
                    var t = e.query,
                        ...
                        E = void 0;
                    try {
                        for (var O, w = m[Symbol.iterator](); !(h = (O = w.next()).done); h = !0) {
                            var S = O.value;
                ...
                queryApplications: function(e) {
                    var t = e.query,
                        ...
                        v = void 0;
                    try {
                        for (var m, g = f[Symbol.iterator](); !(p = (m = g.next()).done); p = !0) {
                            var h = m.value.application;
                            if (a(h)) {
                ...
                queryMentionResults: function(e) {
                    var t = e.query,
                        ...
                        S = void 0 === w ? s.rnv : w,
                        P = e.request,
                        C = f ? (g && null != n.guild_id ? this.queryGuildUsers({
                            guildId: n.guild_id,
                            query: t,
                            limit: S,
                ...
                queryStaticRouteChannels: function(e) {
                    var t = e.query,
                        ...
                        i = ((0, v.YM)(n.id) || (0, g.s)(n.id)) && !n.hasFeature(s.oNc.HUB),
                                ...
                                i.forEach((function(e, i) {
                                    ...
                                    if (null != p && o(p, (0, h.cO)(p, u, r))) {
                                        var y = !0,
                                            ...
                                            m = void 0;
                                        try {
                                            for (var g, w = e[Symbol.iterator](); !(y = (g = w.next()).done); y = !0) {
                                                var S = g.value,
                                                    P = S.type,
                                                    C = S.value,
                                                    I = ye(P),

    ...
    [7861], {
                ...
                d = function(t) {
                    ...
                    r.render = function() {
                        for (var t = this.props, e = t.blockRenderMap, r = t.blockRendererFn, n = t.blockStyleFn, a = t.customStyleMap, l = t.customStyleFn, d = t.editorState, g = t.editorKey, y = t.preventScroll, v = t.textDirectionality, m = d.getCurrentContent(), _ = d.getSelection(), b = d.mustForceSelection(), S = d.getDecorator(), w = p(d.getDirectionMap()), E = m.getBlocksAsArray(), x = [], k = null, C = null, O = 0; O < E.length; O++) {
                            ...
                            var W = c.createElement(z, H, c.createElement(q, i({}, L, {
                                key: K
                            })));
                            x.push({
                                block: W,
                ...
                if (!((null == a ? void 0 : a.nodeType) !== Node.TEXT_NODE && (null == a ? void 0 : a.nodeType) !== Node.ELEMENT_NODE)) {
                    ...
                    if (g !== O) {
                        var D, K, T, A, M = y.getSelection(),
                            ...
                            N = "MUTABLE" === (null != R ? R.getMutability() : null),
                            L = N ? "spellcheck-change" : "apply-entity",
                            F = n.replaceText(k, I, g, C.getInlineStyleAt(E), N ? C.getEntityAt(E) : null);
                        if (f) {
                            D = r.anchorOffset;
                            K = r.focusOffset;
        ...
        143393: function(t) {
            t.exports = function() {
                ...
                function ut(t) {
                    var e = Array.isArray(t) ? new et(t).fromEntrySeq() : q(t) ? new it(t).fromEntrySeq() : j(t) ? new nt(t).fromEntrySeq() : "object" == typeof t ? new rt(t) : void 0;
                ...
                function lt(t) {
                    return V(t) ? new et(t) : q(t) ? new it(t) : j(t) ? new nt(t) : void 0
                }
                ...
                function pt(t, e, r, n) {
                    ...
                    if (i) {
                        ...
                        return new P((function() {
                            var t = i[r ? o - a : a];
                            return a++ > o ? U() : z(e, n ? t[0] : a - 1, t[1])
                        }))
                    }
                ...
                _t.prototype.__iterator = function(t, e) {
                    var r = this,
                        n = 0;
                    return new P((function() {
                        return n < r.size ? z(t, n++, r._value) : U()
                    }))
                };
                ...
                function At(t) {
                    var e;
                    if (Nt && void 0 !== (e = Rt.get(t))) return e;
                ...
                var Rt, Nt = "function" == typeof WeakMap;
                Nt && (Rt = new WeakMap);
                var Lt = 0,
                ...
                function Re(t, e, r) {
                    ...
                    var n = t._tail,
                        i = t._root,
                        o = w(S);
                    e >= Ue(t._capacity) ? n = Ne(n, t.__ownerID, 0, e, r, o) : i = Ne(i, t.__ownerID, t._level, e, r, o);
                    if (!o.value) return t;
                    if (t.__ownerID) {
                        t._root = i;
                        t._tail = n;
                ...
                function hr(t, e, n) {
                    ...
                    i.__iteratorUncached = function(t, i) {
                        ...
                        return new P((function() {
                            ...
                            return u ? U() : z(t, a++, e.apply(null, r.map((function(t) {
                                return t.value
                            }))))
                        }))
                    };
                ...
                function Nr(t) {
                    return null == t ? Ur() : Lr(t) ? t : Ur().withMutations((function(e) {
                        var r = o(t);
                        qt(r.size);
                        r.forEach((function(t) {
                            return e.add(t)
                ...
                $r(r, {
                    ...
                    toStack: function() {
                        return jr(u(this) ? this.valueSeq() : this)
                    },
                    toList: function() {
                ...
                var a = "function",
                    ...
                    Y = function(t, e) {
                        ...
                        this.getOS = function() {
                            ...
                            t.version = o;
                            V.call(t, n, f.os);
                            !t.name && l && "Unknown" != l.platform && (t.name = l.platform.replace(/chrome os/i, z).replace(/macos/i, U));
                            return t
                        };

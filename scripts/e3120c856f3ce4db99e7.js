            ...
            let c = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
                ...
                E = (e, t) => {
                    ...
                    let r = l.SUPPORTS_WEBP ? "webp" : "png",
                        d = "",
                        f = "quality=lossless";
                    return (null != t && (d = "size=" + (0, u.getBestMediaProxySize)(t * (0, u.getDevicePixelRatio)()), f = s ? "" : "&" + f), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(c, "/").concat(n, "/").concat(i, ".").concat(r, "?").concat(d).concat(f) : "".concat(a).concat(o.Endpoints.ROLE_ICON(n, i), "?").concat(d)
                },
        ...
        716849: function(e, t, n) {
            ...
            function m(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), i = d.default.shouldFetchPremiumLikelihood(), u = c.default.getCurrentUser();
                I(u, i, t, n)
            }
            ...
            function v(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), l = (0, u.default)([d.default], () => d.default.shouldFetchPremiumLikelihood()), r = (0, u.default)([c.default], () => c.default.getCurrentUser());
                i.useEffect(() => {
                    I(r, l, t, n)
                }, [r, l, t, n])
            }
            ...
            var i = n("37983"),
                ...
                c = u.forwardRef(function(e, t) {
                    let {
                        ...
                        !e.repeat && ((e.charCode === o.KeyboardKeys.SPACE || e.charCode === o.KeyboardKeys.ENTER) && (e.preventDefault(), null != n && (0, r.transitionTo)(n), null == a || a()), null == s || s(e))
                    }, [n, s, a]), _ = u.useCallback(e => {

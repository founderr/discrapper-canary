                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var _ = L(e.minStart),
                                ...
                                N = L(e.minDirection),
                                R = L(e.maxDirection);
                            return new f(new m(A(i.x, n.x), A(_.x, d.x), A(E.x, p.x), A(I.x, h.x), O(N.x, R.x), v(e.easingFunctions)[0]), new m(A(i.y, n.y), A(_.y, d.y), A(E.y, p.y), A(I.y, h.y), O(N.y, R.y), v(e.easingFunctions)[0]))
                    }
                }(p(p({}, e), {
                    valueType: "Vector2"
                }))
            ...
            var g = n.forwardRef(function(e, t) {
                ...
                var D = n.useCallback(function(e, t) {
                    ...
                    w = n.useCallback(function(e, t, i, n, a) {
                        var o, l, s, _, d, E, I, f, L, g, M, S, y, U, P, w = (o = null !== (P = e.id) && void 0 !== P ? P : (0, r.v4)(), l = e, s = i, _ = n, d = a, f = R((I = (E = l, p(p({
                            id: o
                            ...
                            rotation: (y = I.rotation, function(e) {
                                switch (e.type) {
                                    ...
                                    case "linear-random":
                                        i = N(e.minValue), n = N(e.maxValue);
                                        var a = N(e.minAddValue),
                                            o = N(e.maxAddValue);
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var _ = N(e.minStart),
                                            ...
                                            L = N(e.minDirection),
                                            R = N(e.maxDirection);
                                        return new h(new m(A(i.x, n.x), A(_.x, d.x), A(E.x, p.x), A(I.x, f.x), O(L.x, R.x), v(e.easingFunctions)[0]), new m(A(i.y, n.y), A(_.y, d.y), A(E.y, p.y), A(I.y, f.y), O(L.y, R.y), v(e.easingFunctions)[0]), new m(A(i.z, n.z), A(_.z, d.z), A(E.z, p.z), A(I.z, f.z), O(L.z, R.z), v(e.easingFunctions)[0]))
                                }
                            }(p(p({}, y), {
                                valueType: "Vector3"
                            }))),
        ...
        374278: function(e, t, i) {
            ...
            function T(e) {
                ...
                let i, {
                    ...
                    N = O ? v < p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED : (null == A ? void 0 : A.premiumTier) !== p.BoostedGuildTiers.TIER_3 && v <= p.MAX_STAGE_VIDEO_USER_LIMIT_TIER2,
                    R = l.default.can(E.MODERATE_STAGE_CHANNEL_PERMISSIONS, T);
                i = O && (null == A ? void 0 : A.premiumTier) === p.BoostedGuildTiers.TIER_3 ? v <= p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED ? f.default.Messages.STAGE_FULL_BOOST_MORE_BODY : f.default.Messages.STAGE_FULL_MAX_BODY : N ? f.default.Messages.STAGE_FULL_BODY : f.default.Messages.STAGE_FULL_MAX_BODY;
                let g = () => {

    ...
    [46007], {
        246007: (e, t, n) => {
            ...
            function G(e) {
                var t, n, i = e.clip,
                    l = (0, D.e7)([Z.Z], (function() {
                        return Z.Z.getGame(null !== (t = i.applicationId) && void 0 !== t ? t : "")
                    })),
                    u = (0, D.e7)([R.default], (function() {
                        return R.default.locale
                    })),
                    c = a.useMemo((function() {
                        return new Date(N.Z.extractTimestamp(i.id))
                    }), [i.id]);
                return (0, r.jsxs)("div", {
                    className: U().root,
            ...
            function q(e) {
                var t = e.clip,
                    n = e.className,
                    i = (0, D.Wu)([P.default], (function() {
                        return t.users.map(P.default.getUser).filter(W.lm)
                    })),
            ...
            function ce(e) {
                var t = e.closePopout,
                    ...
                    i = (0, j.ZP)([T.Z, O.Z, P.default, E.Z], (function() {
                        return T.Z.getFlattenedGuildIds().some((function(e) {
                            var t = E.Z.getGuild(e);
                            return null != t && (0, S.Gw)(t, O.Z, P.default).canCreateExpressions
                        }))
                    }));
                                    ...
                                    (0, o.openModalLazy)(re((function() {
                                        ...
                                        return ue(this, (function(d) {
                                            switch (d.label) {
                                                ...
                                                case 1:
                                                    i = d.sent(), o = i.default;
                                                    l = null != (null == e ? void 0 : e.guild_id) ? E.Z.getGuild(e.guild_id) : null;
                                                    u = null != l && (0,
                                                        S.Gw)(l, O.Z, P.default).canCreateExpressions;
                                                    s = null == c || "" === c ? (0, Q.yl)(N.Z.extractTimestamp(t.id)) : c;
                                                    return [2, function(t) {
                                                        return (0, r.jsx)(o, oe(ie({}, t), {
                                                            showGuildPicker: !0,
                                                            guildId: u ? null == e ? void 0 : e.guild_id : void 0,
                                                            sourceFile: {
                                                                file: new File([a], "".concat(s, ".mp4"), {
                                                                    type: "video/mp4"
                                                                }),
                                                                name: s
                                                            }
                    ...
                    children: [(0,
                        ...
                        children: [(0, r.jsx)(o.FormItem, {
                            ...
                            children: (0, r.jsx)(o.TextInput, {
                                ...
                                minLength: Q.XH,
                                maxLength: Q.MG,
                                placeholder: F.Z.Messages.CLIPS_UNTITLED
                            })
                        }), (0, r.jsxs)("div", {
                        ...
                        try {
                            for (var i, o = Object.values(e.currentTarget.audioTracks)[Symbol.iterator](); !(n = (i = o.next()).done); n = !0) {
                                ...
                                if (l.label.includes(":application")) l.enabled = !0;
                                    ...
                                    l.enabled = !1;
                                    t.includes(l.label) || t.push(l.label)
                                } else l.enabled = !1
                            }
                        } catch (e) {
                            r = !0;
            ...
            function Me(e) {
                var t, n, i, l, u = e.sourceURL,
                    ...
                    s = e.videoPlayerRef,
                    d = e.setCropData,
                    f = Ae(a.useState(null !== (l = !(null === (t = s.current) || void 0 === t || null === (n = t.videoElement) || void 0 === n ? void 0 : n.paused)) && void 0 !== l && l), 2),
                    p = f[0],
                    v = f[1],
                    h = a.useRef(null),
                    m = Ae(a.useState(null), 2),
                    b = m[0],
                    y = m[1],
                    g = Ae(a.useState(), 2),
                    w = g[0],
            ...
            function He(e) {
                var t, n, f, p, v, h = e.clip,
                    ...
                    E = C[0],
                    O = C[1],
                    T = Ue(a.useState(null), 2),
                    P = T[0],
                    I = T[1],
                    L = (0, s.Z)(c.Z.CLIPS_EDITOR).AnalyticsLocationProvider;
                a.useEffect((function() {
                    function e() {
                ...
                var k, A, N, M = Ue(a.useState(null === (v = null === (t = h.editMetadata) || void 0 === t ? void 0 : t.voiceAudio) || void 0 === v || v), 2),
                    D = M[0],
                    R = M[1],
                    Z = Ue(a.useState(null === (k = null === (n = h.editMetadata) || void 0 === n ? void 0 : n.applicationAudio) || void 0 === k || k), 2),
                    _ = Z[0],
                    B = Z[1],
                    U = Ue(a.useState({
                        start: null !== (A = null === (f = h.editMetadata) || void 0 === f ? void 0 : f.start) && void 0 !== A ? A : 0,
                            ...
                            return Ge(this, (function(n) {
                                switch (n.label) {
                                    case 0:
                                        ...
                                        t = {};
                                        return [4, (0, y.R)(E, X.current.editMetadata.start)];
                                    case 1:
                ...
                return (0, r.jsx)(o.ModalRoot, {
                    ...
                    children: (0, r.jsx)(L, {
                        children: (0, r.jsx)(o.ModalContent, {
                            ...
                            children: null == E || null == P ? (0, r.jsx)("div", {

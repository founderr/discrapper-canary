    ...
    [71575], {
        771575: (e, n, t) => {
            ...
            function b(e, n, t, r, i, u, l) {
                ...
                a.done ? n(o) : Promise.resolve(o).then(r, i)
            }
            ...
            function A(e, n) {
                ...
                n && (0, s.yw)(y.rMx.REQUEST_TO_SPEAK_INITIATED, S({}, (0, h.s$)(e)));
                return l.ZP.patch({
                    url: y.ANM.UPDATE_VOICE_STATE(t),
                    body: {
            ...
            function N(e, n) {
                ...
                i()(null != t, "This channel cannot be guildless.");
                return l.ZP.patch({
                    url: y.ANM.UPDATE_VOICE_STATE(t, n),
                    body: {
                        suppress: !1,
            ...
            function I(e, n) {
                ...
                var u = d.Z.getVoiceStateForChannel(e.id),
                    a = (0, E.gf)(u);
                a !== E.xO.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK || n || (0, s.yw)(y.rMx.PROMOTED_TO_SPEAKER, S({}, (0, h.s$)(e)));
                return l.ZP.patch({
                    url: y.ANM.UPDATE_VOICE_STATE(r),
                    body: S({
                        suppress: n,
            ...
            function g(e) {
                var n = null == e ? void 0 : e.getGuildId();
                i()(null != n, "This channel cannot be guildless.");
                return l.ZP.patch({
                    url: y.ANM.UPDATE_VOICE_STATE(n),
                    body: {
                        suppress: !0,
                        channel_id: e.id,
                        self_video: !1,
            ...
            function P(e, n, t) {
                ...
                i()(null != r, "This channel cannot be guildless.");
                return l.ZP.patch({
                    url: y.ANM.UPDATE_VOICE_STATE(r, n),
                    body: {
                        suppress: t,
                        channel_id: e.id
                    }
            ...
            function w(e, n) {
                if (null != n && null != e) {
                    ...
                    P(n, e.id, !0);
                    return l.ZP.patch({
                        url: y.ANM.UPDATE_VOICE_STATE(t, e.id),
                        body: {
                            suppress: !0,
                            channel_id: n.id,
                            self_video: !1,
            ...
            function M(e, n, t) {
                ...
                var l = e.permissionOverwrites[r],
                    s = S({
                        id: r,
                        type: o.BN.ROLE,
                        allow: f.ZP.NONE,
                ...
                if (t) {
                    s.allow = u.Z.add(s.allow, n);
                    s.deny = u.Z.remove(s.deny, n)
                } else {
                    s.allow = u.Z.remove(s.allow, n);
                    s.deny = u.Z.add(s.deny, n)
                }
            ...
            function m() {
                return (m = T((function(e, n, t, r) {
                    var i;
                    return O(this, (function(u) {
                        switch (u.label) {
                            case 0:
                                if ("" === n) return [2];
                                c.Z.getVoiceChannelId() === e.id || (0, p.TM)(e);
                                return [4, (0, _.me)(e.id, n, t, r)];
                            case 1:
                                i = u.sent();
                                I(e, !1, !0);
                                return [2, i]
            ...
            function C() {
                return (C = T((function(e, n, t) {
                    return O(this, (function(r) {
                        switch (r.label) {
                            case 0:
                                return "" === n ? [2] : [4, (0, _.Dk)(e.id, n, t)];
                            case 1:
                                return [2, r.sent()]
                        }
                    }))
        ...
        68537: (e, n, t) => {
            ...
            function d(e, n, t, r) {
                var u = n[0],
                    l = i.ZP.getName(e, t, u),
                    a = null != r ? r : n.length;
                return 1 === a && null != u ? l : null == u ? c.Z.Messages.SPEAKING_COUNT.format({
                    count: a
            ...
            function p(e) {
                var n = l.Z.getStageInstanceByChannel(e.id);
                return {
                    channel_id: e.id,
                    guild_id: e.guild_id,
                    topic: null == n ? void 0 : n.topic,
                    media_session_id: r.Z.getMediaSessionId(),
                    request_to_speak_state: u.ZP.canEveryoneRole(o.Plq.REQUEST_TO_SPEAK, e) ? a.BM.EVERYONE : a.BM.NO_ONE,
        ...
        341971: (e, n, t) => {
                ...
                function a(u) {
                    return function(a) {
                        return function(u) {
                            if (t) throw new TypeError("Generator is already executing.");
                            for (; l;) try {
                                if (t = 1, r && (i = 2 & u[0] ? r.return : u[0] ? r.throw || ((i = r.return) && i.call(r),
            ...
            function f(e) {
                return r.ZP.delete(i.ANM.STAGE_INSTANCE(e))
            }
        }
    }
]);
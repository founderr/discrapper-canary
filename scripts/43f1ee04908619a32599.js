                        ...
                        if (null != E && E.length > 0)
                            if ("string" == typeof E[0]) {
                                E.forEach((function(t, r) {
                                    return A.push((0, n.jsxs)(l.Anchor, {
                                        focusProps: {
                                            offset: 4
                                        },
                                        className: b().tag,
        ...
        739770: (e, t, r) => {
            ...
            function ae(e) {
                var t, o = e.onClose,
                    i = e.guildId,
                    a = e.emojiId,
                    l = (t = (0, z.ZP)(), (0, K.ap)(t) ? r(657796) : r(51918)),
                        ...
                        if (null != i) {
                            ...
                            try {
                                for (var x, R = function() {
                                    ...
                                    }, T = u[Symbol.iterator](); !(_ = (x = T.next()).done); _ = !0) R()
                            } catch (e) {
                                N = !0;
                                A = e
                            } finally {
            ...
            function wn(e) {
                var t = e.checked,
                    r = e.onClick,
                    i = e.id,
                    l = void 0 === i ? "burst-reaction-toggle-button" : i,
                    c = (0, s.e7)([Ne.Z], (function() {
                        return Ne.Z.useReducedMotion
                    })),
            ...
            var si = (0, he.Mg)(d.Z.EMOJI_PICKER_CONSTANTS_EMOJI_LIST_PADDING_TOP),
                ...
                vi = o.memo((function(e) {
                    var t = e.diversitySurrogate,
                        ...
                        _ = S.renderRow,
                        N = S.renderSection,
                        A = S.renderSectionHeader,
                        x = S.renderSectionFooter,
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(p.Clickable, {
                        ...
                        children: [I ? (0, n.jsx)(Te.ZP, {
                            ...
                            buttonText: I ? A ? ne.Z.Messages.PREMIUM_TRIAL_TIER_0_CTA_BUTTON_VARIANT : ne.Z.Messages.PREMIUM_TRIAL_CTA_BUTTON_VARIANT : A ? ne.Z.Messages.PREMIUM_SETTINGS_GET_TIER_0 : ne.Z.Messages.PREMIUM_REQUIRED_GET_NITRO
                        })]
                    })]
                })
            };
            ...
            var Yi = (0, he.Mg)(d.Z.EMOJI_PICKER_CONSTANTS_EMOJI_CONTAINER_PADDING_HORIZONTAL),
                ...
                na = function(e, t) {
                    ...
                    var Be = (0, O.O)().location,
                        ...
                        lt = nt.columnCounts,
                        ct = (0, ve.Z)(Se, l),
                        ut = ct.backfillEmojis,
                        st = ct.newlyAddedEmojis,
                        ft = (0, me.a2)({
                            intention: l,
                            isBurstReaction: z,
                            analyticsObject: He
                    ...
                    o.useEffect((function() {
                        "" === Ee.current && "" !== je && (0, me.PC)(Ke, l);
                        if (0 === qe && "" !== je) ea(Ke, je);
                        else if ("" !== je && Ee.current !== je) {
                            var e;
                            ta(qe, null !== (e = null == Qe ? void 0 : Qe.locked.length) && void 0 !== e ? e : 0, Ke, je, l)
                        }
                        Ee.current = je
                    }), [je, Ke, qe, Qe, l]);
                    var Et = X || !Ye;
        ...
        838956: (e, t, r) => {
            ...
            function O(e, t) {
                ...
                var n = !0,
                    ...
                    i = void 0;
                try {
                    for (var a, l = Object.entries(e)[Symbol.iterator](); !(n = (a = l.next()).done); n = !0) {
                        var c = y(a.value, 2),
                            u = c[0],
                            s = c[1];
                        if (u !== b && null != s && "object" == typeof s) return O(s, null != t ? t : u)
                    }
                } catch (e) {
                    o = !0;
                    i = e
            ...
            var w, P, S = (P = (w = function(e) {
                var t, r, i, a, d, p, y, b, g, O, m;
                return j(this, (function(v) {
                    switch (v.label) {
                        case 0:
                            t = e.componentType, r = e.messageId, i = e.messageFlags, a = e.customId, d = e.indices, p = e.applicationId, y = e.channelId, b = e.guildId, g = e.localState;
                            O = n.default.fromTimestamp(Date.now());
                            return f.Z.canQueueInteraction(r, O) ? [4, c.Z.unarchiveThreadIfNecessary(y)] : [2];
                        case 1:
                            v.sent();
                            (0, s.kz)(O, {
                                messageId: r,
            ...
            var x = function(e, t) {
                var r, o = null == t ? void 0 : t.state,
                    i = e.state === h.yb.SENT && I(e.id) < Date.now(),
                    a = e.state === h.yb.SEND_FAILED && (null == (r = e.id) || "" === r || Number.isNaN(r) ? Date.now() : n.default.extractTimestamp(r) + 3e3) < Date.now(),
                    c = (null == t ? void 0 : t.data.interactionType) === l.B8.APPLICATION_COMMAND,
                    u = e.isCommandType();
                return c && o === d.F.QUEUED || u && e.state === h.yb.SENDING && null != t ? _.SENDING : c && o === d.F.CREATED || e.hasFlag(h.iLy.LOADING) && !i ? _.CREATED : null != e.interaction && e.hasFlag(h.iLy.LOADING) && i || null != e.interaction && !e.hasFlag(h.iLy.LOADING) && a ? _.TIMED_OUT : u && e.state === h.yb.SEND_FAILED ? _.FAILED : void 0
            };
            ...
            var V = function(e) {
                ...
                H = function(e) {
                    ...
                    return null == S ? null : (0, n.jsx)("div", {
                        role: "img",
                        className: f,
                        "aria-label": I ? A.Z.Messages.ERROR_LOADING_STICKER : F(a),
                        ref: p,
                        children: (0, n.jsx)(V, {
                            hasError: I,
                            isLoading: v,
        ...
        575352: (e, t, r) => {
            ...
            const b = (0, a.hN)((function(e) {
                ...
                var t = e.width,
                    ...
                    i = void 0 === o ? 24 : o,
                    a = e.color,
                    d = void 0 === a ? l.Z.colors.INTERACTIVE_NORMAL : a,
                    p = e.colorClass,
                    y = void 0 === p ? "" : p,

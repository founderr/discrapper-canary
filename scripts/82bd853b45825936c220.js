    ...
    ["39963"], {
        ...
        62948: function(e, t, n) {
            ...
            let C = "guildUnreadsEnabledStorageKey",
                _ = "guildUnreadsLastClearedStorageKey",
                g = {
            ...
            class A extends l.default.PersistedStore {
                initialize(e) {
                    this.waitFor(d.default), T = null != e ? e : g, ! function() {
                        var e, t, n;
                        ...
                        u.size > 0 && u.forEach(e => {
                            l[e] = !0
                        }), a.default.remove(C), T.guildUnreadsLastCleared = null !== (n = a.default.get(_)) && void 0 !== n ? n : {}, a.default.remove(_);
                        let d = {};
                        Object.keys(l).map(e => {
                            let t = !0 === l[e],
        ...
        488107: function(e, t, n) {
            ...
            function f(e) {
                let t = d.default.getCurrentUser(),
                    ...
                    C = Date.now(),
                    _ = (0, u.isChannelHighlightsEnabledForGuild)(e),
                    g = i.default.getNotifyHighlights(e),
                    T = g === o.HighlightSettings.ENABLED || g === o.HighlightSettings.NULL;
                return !!n && !!f && !!_ && !!T && ((null == t ? void 0 : t.isStaff()) ? ((null == c || null != c && C - c > 36e5) && l.default.maybeLoadFeedForGuild(e), !1) : null == c || C - c > E && C - S > E)
            }
        },
        952451: function(e, t, n) {
            ...
            function H(e) {
                ...
                return !(!e.isPrivate() && (v(e, t, (0, r.isOptInEnabledForGuild)(e.guild_id)) || !_.default.can(e.accessPermissions, e))) && (t > 0 || N.default.isChannelRelevant(e))
            }
            ...
            function F(e, t) {
                let n = e.guild_id,
                    l = e.id;
                return !(N.default.isGuildOrCategoryOrChannelMuted(n, l) || v(e, g.default.getMentionCount(l), t)) && g.default.hasNotableUnread(e.id)
            }
            ...
            function w(e, t, n) {
                if (V(t), t.mentionCount = a(t.mentionCounts).values().sum(), t.unread !== n.unread || t.mentionCount !== n.mentionCount) return p[null != e ? e : G] = t, null != e && (t.unread ? D.add(e) : D.delete(e)), y++, M(null != e ? e : G), !0;
                return !1
            }
            ...
            function K(e, t) {
                ...
                if (t.forEach(e => {
                        ...
                        let l = g.default.getMentionCount(e);
            ...
            function x(e, t) {
                ...
                if (null == n) {
                    ...
                    for (let t in c) {
                        let n = c[t],
                            ...
                            r = l.unreadByType[U.ReadStateTypes.CHANNEL],
                            {
                                mentionCount: o,
                                hasNotableUnread: E
                            } = g.default.getGuildChannelUnreadState(n, s, f, d, i, r),
                            C = o > 0;
                        if (!C && i) continue;
                        let T = !r && (!i || C) && E;
                        if (T || C) {
                            let e = function(e, t, n, l) {
                                if ((0, S.isGuildVocalChannelType)(e.type) && 0 === t || !_.default.canBasicChannel((0, S.getBasicAccessPermissions)(e.type), e) || v(e, t, l)) return !1;
                    ...
                    for (let t in T)
                        for (let n in T[t]) {
                            !l.unreadByType[U.ReadStateTypes.CHANNEL] && g.default.hasNotableUnread(n) && !E.default.isMuted(n) && !e && (l.unreadByType[U.ReadStateTypes.CHANNEL] = !0, l.unreadChannelId = n);
            ...
            function Q(e) {
                ...
                if (null != n.guild_id) {
                    ...
                    if ((l || e.unreadByType[U.ReadStateTypes.CHANNEL]) && 0 === g.default.getMentionCount(t)) return !1
                }
            ...
            class e_ extends A.default {
                ...
                getGuildHasUnreadIgnoreMuted(e) {
                    ...
                    for (let e in t) {
                        let n = t[e];
                        if (null != n) {
                            if ((!n.isGuildVocal() || 0 !== g.default.getMentionCount(e)) && _.default.can(n.accessPermissions, n) && g.default.hasUnread(e)) return !0
                        }
                    }
                    ...
                    return !!g.default.hasUnread(e, U.ReadStateTypes.GUILD_EVENT) || !1
                }
                ...
                constructor() {
                    ...
                    }), this.waitFor(C.default, T.default, g.default, _.default, c.default, L.default, N.default, o.default, E.default)
                }
            }
        ...
        287850: function(e, t, n) {
            ...
            function p(e) {
                ...
                return {
                    ...
                    isRequest: C.default.isMessageRequest(e.id) || _.default.isSpam(e.id)
                }
            }
            ...
            function D() {
                G.clear(), Object.values(T.default.getMutablePrivateChannels()).forEach(e => {
                    ...
                    null != t && (0, g.isGuildTextChannelType)(t.type) && G.set(t.id, p(t))
                })
            }
            ...
            var M = new O(f.default, {
                ...
                CHANNEL_UPDATES: function(e) {
                    ...
                    t.forEach(e => {
                        ((0, g.isPrivate)(e.type) || G.has(e.id)) && G.set(e.id, p(e))
                    })
                },
                CHANNEL_CREATE: function(e) {
                    ...
                    if (!(0, g.isPrivate)(t.type) || t.id === U.FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) return !1;
                    G.set(t.id, p(t))
                },

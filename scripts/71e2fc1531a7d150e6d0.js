    ...
    ["81784"], {
        666020: function(e, t, n) {
            ...
            function a(e) {
                ...
                let c = a(.5 * u),
                    E = a(i, -c),
                    I = a(i + u, c);
                for (E > 0 && (E = Math.max(d(0), E)), E = Math.floor(E / r.MINIMUM_RANGE) * r.MINIMUM_RANGE; E <= I;) E = d(E);
                o(t, n, s)
            }
        },
        ...
        526887: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, f = (0, u.useConfettiCannon)(n, a), _ = (0, l.default)([o.default], () => o.default.useReducedMotion), T = r.useMemo(() => _ ? s : {
                    confettiCanvas: n,
                    cannon: f,
        ...
        962199: function(e, t, n) {
            ...
            let d = !1,
                ...
                E = {},
                I = {},
                f = e => (I[e.guild_scheduled_event.id] = new a.default(e.guild_scheduled_event.guild), E[e.guild_scheduled_event.id] = e.guild_scheduled_event, {
        ...
        817963: function(e, t, n) {
            ...
            let E = {
                ...
                _ = e => {
                    let [t, n] = e instanceof o.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : f(e), [r, l, d, _] = (0, u.useStateFromStoresArray)([a.default], () => [a.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e), a.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e), a.default.can(t, e), a.default.can(n, e)]), T = (0, u.useStateFromStores)([s.default], () => s.default.getCurrentUser()), S = i.useCallback(e => I(e, T, l, r), [r, l, T]), N = i.useCallback(e => I(e, T, _, d), [_, d, T]);
                    return null == e ? E : {
                ...
                T = function(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : a.default,
                        ...
                        [i, r] = e instanceof o.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : f(e),
                    ...
                    return null == e ? E : {
                        ...
                        canManageAllExpressions: l,
                        canManageAllEvents: _,
                        canManageGuildExpression: e => I(e, T, l, u),

        ...
        698211: (e, n, t) => {
            ...
            const be = (0, ce.hN)((function(e) {
                ...
                var n = e.width,
                    ...
                    o = void 0 === l ? 24 : l,
                    a = e.color,
                    i = void 0 === a ? de.Z.colors.INTERACTIVE_NORMAL : a,
                    s = e.colorClass,
                    u = void 0 === s ? "" : s,
            ...
            function Ve(e) {
                var n, t = e.selectedSource,
                    ...
                    i = (n = b.Z.getVideoDevices(), Object.entries(n).map((function(e) {
                        var n = we(e, 2),
                            t = (n[0], n[1]);
                        return {
                            id: "camera:" + t.id,
            ...
            function pn(e) {
                var n = e.selectedChannelId,
                    ...
                    a = (0, s.e7)([S.Z, He.ZP, We.Z], (function() {
                        return (0, Ke.h_)(He.ZP.getChannels(t), S.Z, We.Z)
                    })),
                    i = (0, s.e7)([ze.ZP], (function() {
            ...
            function Vn(e) {
                ...
                return {
                    content: n,
                    className: M()(o ? Tn().selectorButtonSelected : Tn().selectorButton, wn({}, Tn().selectorButtonPremiumRequired, a)),
                    onClick: t
                }
            }
            ...
            function at(e) {
                let n = function(e) {
                    let {
                        ...
                        cos: l,
                        round: o
                    } = Math, a = e[0] | e[1] << 8 | e[2] << 16, i = e[3] | e[4] << 8, s = (63 & a) / 63, u = (a >> 6 & 63) / 31.5 - 1, c = (a >> 12 & 63) / 31.5 - 1, d = (a >> 18 & 31) / 31, f = a >> 23, m = (i >> 3 & 63) / 63, h = (i >> 9 & 63) / 63, p = i >> 15, g = r(3, p ? f ? 5 : 7 : 7 & i), v = r(3, p ? 7 & i : f ? 5 : 7), S = f ? (15 & e[5]) / 15 : 1, b = (e[5] >> 4) / 15, C = f ? 6 : 5, y = 0, E = (n, t, r) => {
                        let l = [];
                        for (let o = 0; o < t; o++)
                            for (let a = o ? 0 : 1; a * t < n * (t - o); a++) l.push(((e[C + (y >> 1)] >> ((1 & y++) << 2) & 15) / 7.5 - 1) * r);
                        return l
                    ...
                    for (let e = 0, o = 0; e < A; e++)
                        for (let a = 0; a < x; a++, o += 4) {
                            let i = s,
                                d = u,
                                m = c,
                                h = S;
                            for (let e = 0, t = r(g, f ? 5 : 3); e < t; e++) Z[e] = l(n / x * (a + .5) * e);
                            for (let t = 0, o = r(v, f ? 5 : 3); t < o; t++) T[t] = l(n / A * (e + .5) * t);
                            for (let e = 0, n = 0; e < v; e++)
                                for (let t = e ? 0 : 1, r = 2 * T[e]; t * v < g * (v - e); t++, n++) i += O[n] * Z[t] * r;
                    ...
                    children: (0, r.jsxs)(I.Z, {
                        ...
                        children: [(0, r.jsx)(I.Z, {
                            ...
                            children: (0, r.jsx)("div", {
                                ...
                                className: M()(It().sourceThumbnail, _t({}, It().selected, i))
                            })
                        }), (0, r.jsx)(u.Text, {
                            className: M()(It().sourceName, _t({}, It().selected, i)),
                            variant: "text-sm/normal",
                            children: o
                        })]
                    })
                    ...
                    return Tt(this, (function(s) {
                        switch (s.label) {
                            case 0:
                                ...
                                n = (0, st.Z)(b.Z.getMediaEngine(), [it.vA.WINDOW, it.vA.SCREEN], {
                                    width: 176,
                                    height: 99
                                });
                                return [4, wt()];
                            ...
                            case 2:
                                ...
                                l = r.filter((function(e) {
                                    return e.id.startsWith(it.vA.SCREEN)
                                }));
                                o = Pt(r.filter((function(e) {
                                    return e.id.startsWith(it.vA.WINDOW)
                                })), t);
                                ...
                                i = Object.entries(e).filter((function(e) {
                                    ...
                                    var t = Zt(e, 2),
                                        r = (t[0], t[1]),
                                        l = a[n % a.length],
                                        o = at(Uint8Array.from(atob(l), (function(e) {
            ...
            function Ut(e) {
                var n = e.selectedSource,
                    ...
                    i = b.Z.supports(Ne.AN.GO_LIVE_HARDWARE),
                    ...
                    v = p[1],
                    S = null != g && g.length > 0,
                    C = Zt(l.useState(it.vA.WINDOW), 2),
                    y = C[0],
                    E = C[1],
                    O = Zt(l.useState(!1), 2),
                    _ = O[0],
            ...
            function Qt(e) {
                var n, o = e.selectGuild,
                    ...
                    k = function() {
                        ! function() {
                            ...
                            var u = zn(K, he, C.ZP.getRunningGames()),
                                m = !(0, N.ED)() || null == u || (null == he ? void 0 : he.id.startsWith("camera:")) || null == u ? null : u.pid;
                            (0, f.WH)(l, n, {
                                pid: m,
                ...
                var te, re = (0, _.Dt)(),
                    ...
                    oe = le[0],
                    ae = le[1],
                    ie = Kt(l.useState(!1), 2),
                    se = ie[0],
                    ue = ie[1],
                    ce = Kt(l.useState(null), 2),
                    de = ce[0],
                    fe = ce[1],
                    ...
                    ve = ge[0],
                    Se = ge[1],
                    be = Kt(l.useState(V), 2),
                    Ce = be[0],
                    ye = be[1],
                    Ee = Kt(l.useState(H), 2),
                    Oe = Ee[0],
                    Ie = Ee[1],
                    _e = Kt(l.useState(W), 2),
                    je = _e[0],
                    Ne = _e[1],
                    xe = Kt(l.useState(null != w ? w : null), 2),
                    Ae = xe[0],
                    Re = xe[1],
                ...
                var Te = l.useCallback((function(e, n, t) {
                    ...
                    if (!(0, A.Z)(e, n, t, X, Q)) {
                        var i = Kt(Z(R.tI.PRESET_VIDEO, X, Q), 2);
                        n = i[0];
                        t = i[1]
                    }
                    t !== je && Ne(t);
                    n !== Oe && Ie(n);
                    o !== n || a !== t ? ye(R.tI.PRESET_CUSTOM) : e !== Ce && ye(e)
                }), [X, Q, je, Oe, Ce]);

                function Pe() {
                    return (Pe = Vt((function(e) {
                        var n, t, l, o;
                        return Jt(this, (function(a) {
                            switch (a.label) {
                                case 0:
                                    e.preventDefault();
                                    if (oe === Yt.SOURCE) return [2, ae(Yt.CONFIRM)];
                                    n = zn(K, he, C.ZP.getRunningGames());
                                    t = x.ZP.supportsFeature(Y.eRX.ELEVATED_HOOK) && (null == n ? void 0 : n.elevated);
                                    return (0, N.V5)() && null != he ? [4, b.Z.getMediaEngine().getDesktopSources()] : [3, 2];
                                case 1:
                                    l = a.sent();
                ...
                var Me = l.useCallback((function(e) {
                        pe(e);
                        if (null != e) {
                            ae(Yt.CONFIRM);
                            ue(!0)
                    ...
                    Ge = (0, r.jsxs)(u.Slides, {
                        springConfig: zt(Wt({}, i.config.stiff), {
                            clamp: !0
                        }),
                        activeSlide: oe,
                        width: 480,
                    ...
                    ke = oe !== Yt.CONFIRM || null == he && null == K || null == Ze,

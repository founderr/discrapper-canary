            ...
            function i(e) {
                let t = function(e) {
                    let {
                        ...
                        return u
                    }, C = R(f, T, (a >> 18 & 31) / 31), N = R(3, 3, 1.25 * ((o >> 3 & 63) / 63)), O = R(3, 3, 1.25 * ((o >> 9 & 63) / 63)), P = _ && R(5, 5, I), U = r(e), h = l(U > 1 ? 32 : 32 * U), L = l(U > 1 ? 32 / U : 32), M = new Uint8Array(h * L * 4), m = [], D = [];
                ...
                (0, i.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, r.jsx)(e, {
                            ...
                            onComplete: () => {
                                v = !0, null == T || T(), !C && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: S,
                            analyticsLocations: I,
                            analyticsObject: A,
                    ...
                    onCloseCallback: () => {
                        !v && s.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: L,
                            location_stack: I
                        }), (0, l.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == f || f(v), v && (!C && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == S || S())
                    },
        ...
        122846: function(e, t, n) {
            ...
            function H(e) {
                let {
                    onClose: t,
                    ...n
                } = e, i = (0, _.useSubscriptionPlansLoaded)(), l = (0, a.useStateFromStores)([P.default], () => P.default.hasFetchedPaymentSources), p = i && l, R = (0, A.usePremiumTrialOffer)(), N = (0, I.usePremiumDiscountOffer)(), {
                    isLoading: O,

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [20419], {
        720419: (e, t, n) => {
            ...
            var $ = new N.Z("MessageRoundtripTrackerStore");
            ...
            var $e = (Ge(He = {}, B.evJ.EMAIL_VERIFICATION_REQUIRED, {
                ...
                qe = (o().memoize((function(e) {
                    ...
                    jumpToMessage: function(e) {
                        var t = e.channelId,
                            ...
                            f = e.skipLocalFetch,
                            d = e.jumpType;
                        "string" == typeof a && qe.trackJump(t, n, a, l);
                        return qe.fetchMessages({
                            channelId: t,
                            limit: B.Z8P,
                            jump: {
                                messageId: n,
                        ...
                        return Ue((function() {
                            ...
                            return Ye(this, (function(s) {
                                switch (s.label) {
                                    ...
                                    case 1:
                                        if (null != (o = s.sent())) return [2, qe.sendMessage(o, t, n, r)];
                                        i = function() {
                                            return qe._sendMessage(e, t, r)
                                        };
                    ...
                    sendGreetMessage: function(e, t) {
                        ...
                        return a.ZP.post({
                            ...
                            429 !== t.status && qe.sendClydeError(e, t.body.code);
                            l.Z.dispatch({
                                ...
                                if (c.ok) {
                                    ...
                                    if (c.hasErr) "ABORTED" === c.err.code && (p = !0);
                                        ...
                                        if (c.body.code === B.evJ.SLOWMODE_RATE_LIMITED) {
                                            ...
                                            messageId: N,
                                            channelId: e
                                        }) : qe.sendClydeError(e, c.body.code);
                                    if (p) qe.deleteMessage(e, N, !0);
                                    else {
                                        l.Z.dispatch({
                                            type: "MESSAGE_SEND_FAILED",
                                            messageId: N,
                                ...
                                switch (i.label) {
                                    ...
                                    case 1:
                                        ...
                                        c.ZP.enqueue({
                                            ...
                                            qe.endEditMessage(e, n.hasErr ? void 0 : n);
                                            qe.focusMessage({
                                                channelId: e,
                                                messageId: t
                                            })
        ...
        201891: (e, t, n) => {
            ...
            function b(e, t) {
                ...
                return null != n ? n : null == e ? a.Z.Messages.GUILD_AUTOMOD_BLOCKED_MESSAGE_SEND_NOTICE : function(e) {
                    ...
                    return (0,
                        r.Bz)(e) ? a.Z.Messages.GUILD_AUTOMOD_BLOCKED_MESSAGE_EDIT_NOTICE : (null == t ? void 0 : t.isThread()) ? a.Z.Messages.THREAD_AUTOMOD_ERROR : (null == t ? void 0 : t.isForumPost()) || (null == t ? void 0 : t.isForumLikeChannel()) ? a.Z.Messages.FORUM_POST_AUTOMOD_ERROR : a.Z.Messages.GUILD_AUTOMOD_BLOCKED_MESSAGE_SEND_NOTICE
                }(e)
            }
        },
        158434: (e, t, n) => {

    ...
    ["91211"], {
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                x = !0, null == C || C(), !S && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: _,
                            analyticsObject: v,
                    ...
                    onCloseCallback: () => {
                        !x && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: R,
                            location_stack: _
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == E || E(x), x && (!S && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },
        ...
        889793: function(e, t, n) {
            ...
            function x(e) {
                let {
                ...
                } = e, d = (0, s.useStateFromStores)([g.default], () => g.default.getPendingProfileEffectID()), [p, _] = r.useMemo(() => {
                    let e = (0, C.groupProfileEffects)(n, l);
                    return [e.purchased, e.shopPreviews]
                }, [n, l]), [I, S] = r.useState(() => null != u ? u : void 0 !== d ? d : null == c ? null : null != c ? c : null), [m, N] = r.useMemo(() => {
                    var e;
                    ...
                    category: f.default.getCategoryForProduct(null == m ? void 0 : m.skuId),
                    purchase: h.default.getPurchase(null == m ? void 0 : m.skuId)
                }), [m]), y = r.useRef(null), F = T.default.canUseCollectibles(t), {
                    shopForAllEnabled: U
                } = (0, E.default)({
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsxs)(a.ModalHeader, {
                        ...
                        user: t,
                        onApply: () => {
                            (0, v.setNewPendingProfileEffectID)(I, c), o()
                        },
                        onClose: o,
                        category: R,
                        purchase: x,
            ...
            function y(e) {
                ...
                let {
                    ...
                    categories: C,
                    purchases: _
                } = (0, p.default)(), v = (0, s.useStateFromStores)([S.default], () => S.default.getCurrentUser()), {
                    AnalyticsLocationProvider: g,
                    analyticsLocations: T
                } = (0, c.default)(o, u.default.EDIT_PROFILE_EFFECT_MODAL), L = (0, I.default)(null !== (t = null == v ? void 0 : v.id) && void 0 !== t ? t : ""), A = null == L ? void 0 : L.profileEffectID;
                return r.useEffect(() => {
        ...
        717262: function(e, t, n) {
            ...
            let m = e => {
                    ...
                    let {
                        ...
                        category: c,
                        purchase: d
                    } = e, f = (0, r.useStateFromStores)([v.default], () => v.default.getCurrentUser()), h = (0, r.useStateFromStores)([a.default], () => a.default.getProduct(null == s ? void 0 : s.skuId)), C = (0, r.useStateFromStores)([E.default], () => E.default.locale), {
                        shopForAllEnabled: p
                    } = (0, o.default)({
                        location: "ProfileEffectPreview"
                    }), _ = I.default.canUseCollectibles(f), m = (0, u.isPremiumCollectiblesPurchase)(d), L = (0, u.isPremiumCollectiblesCategory)(c), A = !_ && m, N = T(A, L, _, p);
            ...
            var L = e => {
                ...
                }), P = I.default.isPremium(n), M = (0, h.default)(n.id), O = !!(null == M ? void 0 : M.getPreviewBio(g).value), x = C.UseLegacyChatInput.useSetting(), y = x && null != g ? c.default.parse(void 0, g).content : g, F = I.default.canUsePremiumProfileCustomization(n), U = (null == M ? void 0 : M.canUsePremiumProfileCustomization) || F, w = {
                    user: n,
                ...
                return (0, i.jsxs)("div", {
                    className: U ? S.previewContainerWithTheme : S.previewContainerWithoutTheme,
            ...
            let R = () => 80,
                ...
                M = e => {
                    ...
                    let {
                        ...
                        isSelected: c,
                        ...d
                    } = e, C = (0, u.default)([S.default], () => S.default.getProfileEffectById(l.id)), _ = (0, u.default)([f.default], () => {
                        ...
                        title: x
                    } = null !== (t = null == C ? void 0 : C.config) && void 0 !== t ? t : {}, y = g.default.canUseCollectibles(n), F = a === m.Section.PREMIUM_PURCHASE && !y, [U, w] = r.useState(c);
                    return r.useEffect(() => {
                        c && w(!0)
                    }, [c]), (0, i.jsxs)(P, {
                        ...
                        children: [(0, i.jsx)("img", {
                            ...
                            let e = a === m.Section.PURCHASE || a === m.Section.PREMIUM_PURCHASE && y;
                            if (e) return null;
                            let t = !T && !c && !U;
                ...
                return (0, i.jsx)("section", {
                    children: (0, i.jsx)(c.MasonryList, {
                        ...
                        renderItem: (e, t, o, d) => {
                            ...
                            return (0, a.match)(p[t]).with(m.NONE_ITEM, () => (0, i.jsxs)(P, {
                                style: {
                                    ...o
                                },
                                isSelected: !h,
        ...
        326054: function(e, t, n) {
            ...
            var _ = () => {
                let e = (0, a.default)([f.default], () => f.default.getCurrentUser()),
                    ...
                    r = (0, a.default)([u.default], () => u.default.purchases),
                    [_, v] = (0, a.useStateFromStoresArray)([o.default], () => [o.default.categories, o.default.categorySkuIdsByProductSkuId]);
                return (0, l.useMemo)(() => {
                    let e = (0, s.uniqBy)([...(0, d.getProfileEffectsFromPurchases)(r), ...(0, d.getProfileEffectsFromCategories)(_)], "id"),
                        l = e.reduce((e, n) => {
                            let i = r.get(n.skuId),
                                l = (0, d.isPremiumCollectiblesPurchase)(i);
                            if (l) return e.premium_purchase.push(n), e;
                            if (null != i) return e.purchase.push(n), e;
                            let s = _.get(v[n.skuId]);
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: _,
                    ...v
                } = e, I = s.createRef(), g = (0, d.default)(I), S = !i && !a && !0 !== u && (!_ || g);
        ...
        461380: function(e, t, n) {
            ...
            let h = {
                ...
                E = e => {
                    ...
                    if (!0 === v ? S = h.DOWN : !1 === v && (S = h.RIGHT), g) {
                        let e = {

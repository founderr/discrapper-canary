    ...
    [52171], {
        ...
        661098: (e, n, t) => {
            ...
            var ne = new ee(m.Z, {
                ...
                APPLICATION_COMMAND_INDEX_FETCH_SUCCESS: function(e) {
                    ...
                    var p = !0,
                        ...
                        h = void 0;
                    try {
                        for (var A, g = (0, D.nG)(r.application_commands.map((function(e) {
                                return function(e, n) {
                            ...
                            var b = A.value;
                            l[b.applicationId].commands.push(b)
                        }
                    } catch (e) {
                        v = !0;
                        h = e
            ...
            function re(e, n, t, r) {
                ...
                return o.useMemo((function() {
                    ...
                    return 0 === o.length ? {
                        ...
                        descriptors: [T.Tm[j.bi.FRECENCY]].concat(X(l)),
                        commands: o.concat(a),
                        sectionedCommands: [{
                            section: T.Tm[j.bi.FRECENCY],
                            data: o
                        }].concat(X(u)),
                        loading: c
                    }
                                ...
                                for (var ae, ue = $.commands[Symbol.iterator](); !(oe = (ae = ue.next()).done); oe = !0) {
                                    ...
                                    if (!(ce.type !== a || ce.nsfw && !y || null != ce.predicate && !ce.predicate(r) || null != ce.contexts && !ce.contexts.includes(B))) {
                                        ...
                                        if (Z) {
                                            ...
                                            if (null == ye && null == te && null != ce.defaultMemberPermissions && (d.Z.equals(ce.defaultMemberPermissions, D.BO) || !d.Z.has(R, ce.defaultMemberPermissions))) continue
                                        }
                                        var ve = void 0;
                                        if (v && null != O && null != C) {
            ...
            function se(e, n, t) {
                ...
                var o = e[(0, y.rE)((0, D.bD)(t), M.Kw.CHANNEL)];
            ...
            function A(e, n, t) {
                ...
                return r.useMemo((function() {
                    ...
                    if (O) {
                        ...
                        if (null != t) t.data = y(E).concat(y(t.data));
                        else {

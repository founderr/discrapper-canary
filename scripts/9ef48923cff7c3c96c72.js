    ...
    ["15903"], {
        ...
        952999: function(e, t, n) {
            ...
            function P(e) {
                ...
                }(W), Z = (0, u.useStateFromStores)([C.default], () => C.default.getGuildApplications(null == l ? void 0 : l.id)), Y = void 0 !== Z && Z.length > 0;
                if (s.useEffect(() => {
                        var e;
        ...
        194141: function(e, t, n) {
            ...
            function M(e) {
                let {
                    ...
                    onSubmit: R,
                    onClose: x
                } = e, y = (0, d.default)(r), [O, D] = s.useState(!1), [P, b] = s.useState(v), [j, F] = s.useState(null), [U, H] = s.useState(o.shuffle(r)), [k, G] = s.useState(""), B = (0, h.useUID)(), w = (0, C.default)(P), V = (0, C.default)(O), W = (0, C.default)(j), z = (0, C.default)(R), K = (0, C.default)(k), Z = null != j && M.includes(j);
                return s.useEffect(() => {
                    ...
                    children: [(0, a.jsxs)(u.ModalHeader, {
                        ...
                        className: _.content,
                        children: [null == P || P === E.FeedbackRating.GOOD || Z ? null : (0, a.jsx)(u.FormItem, {
                            title: l,
        ...
        554393: function(e, t, n) {
            ...
            function U(e) {
                let {
                    ...
                    isGuest: J,
                    isPendingMember: $
                } = (0, E.default)(K), ee = (0, D.useForumActivityExperiment)(null == K ? void 0 : K.guild_id), et = (0, o.useStateFromStores)([I.default], () => I.default.getChannel(U)), en = (0, x.useDefaultReactionEmoji)(et), ea = (0, o.useStateFromStores)([h.default], () => h.default.shouldDisplayPrompt(t) && !0 === n, [t, n]), es = s.useCallback(e => {
                    let t = e[0];
                    if (null != t && n) {
                ...
                return (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)(c.Clickable, {
                        ...
                        className: i(L, {
                            [Z.message]: !0,
                            [Z.cozyMessage]: !M,
                            [Z.mentioned]: p.mentioned && !(0, v.default)(p),
                            [Z.ephemeral]: (0, N.hasFlag)(p.flags, z.MessageFlags.EPHEMERAL),
                            [Z.systemMessage]: (0, v.default)(p),
                            [Z.groupStart]: p.id === x || p.type === z.MessageTypes.REPLY,
                            [Z.selected]: eu
                        }),
                        zalgo: !0,
                        onKeyDown: eh,
                        ...
                        children: (0, a.jsx)("li", {
                            ...
                            children: (0, a.jsx)(I.default, {
                                ...
                                className: i(J, {
                                    ...
                                    [Z.groupStart]: !en && (ez || L.type === z.MessageTypes.REPLY),
                                    [Z.selected]: eN,
                                    [Z.replying]: (null == ej ? void 0 : ej.message.id) === L.id,
            ...
            function eg(e) {
                ...
                return eb && !ej && [].push(d.DismissibleContent.BURST_REACTION_BUTTON_SPARKLE), (0, a.jsxs)(a.Fragment, {
                    children: [Z ? (0, a.jsxs)(a.Fragment, {
                        ...
                        dangerous: !0,
                        separator: !Z
                    }) : null, Z && r ? null : (0, a.jsx)(c.Popout, {
                        renderPopout: e => {
                            let {
                                updatePosition: s,
                                closePopout: l
            ...
            function $(e) {
                ...
                if (!ep && er) eI.push((0, a.jsx)(h.RedactedMessages, {
                    ...
                    let e = en.map((e, t) => {
                        ...
                        if (e.type === Z.ChannelStreamTypes.FORUM_POST_ACTION_BAR) return (0, a.jsx)(p.default, {
                        ...
                        let i = L.default.can(Z.Permissions.CREATE_INSTANT_INVITE, y);
                        ...
                        let r = e.groupId === (null === (n = eM) || void 0 === n ? void 0 : n.groupId) ? eM.content.id : e.groupId,
                            o = e.type === Z.ChannelStreamTypes.THREAD_STARTER_MESSAGE ? H.ThreadStarterChatMessage : H.default;
                        return (0, a.jsx)(o, {
                            compact: et,
                            channel: y,
                            message: e.content,

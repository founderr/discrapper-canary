...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [30027], {
        ...
        766281: (e, t, n) => {
            ...
            function U(e, t, n, r, o) {
                ...
                return {
                    ...
                    content: [j({
                        name: A.Z.Messages.UNKNOWN_CHANNEL,
                        type: _.d4z.UNKNOWN,
                        iconType: "text"
                    }, "italics")]
                }
            ...
            function G(e, t, n, r) {
                if (!e.canViewChannel) return function(e, t) {
                    var n = {
                        type: "channel",
                        content: [k(e.roleSubscriptionGated ? e.name : A.Z.Messages.NO_ACCESS)],
                        channelType: e.roleSubscriptionGated ? e.type : _.d4z.UNKNOWN,
                        iconType: "locked"
                    };
                    return {
                        type: "channelMention",
                ...
                return null == i ? e.isDm ? Z(N({}, o), {
                    ...
                    return null != e ? M(e) : k("#".concat(A.Z.Messages.UNKNOWN_CHANNEL_PLACEHOLDER))
                ...
                Re = {
                    ...
                    roleMention: {
                        ...
                        parse: function(e, t, n) {
                            ...
                            return null == l ? {
                                type: "text",
                                content: "@".concat(A.Z.Messages.DELETED_ROLE_PLACEHOLDER)
                            } : {
                                type: "mention",
                    ...
                    mention: {
                        ...
                        parse: function(e, t, n) {
                            ...
                            var c = e[1],
                                s = null != c && _.Xyh.test(c.trim()) && n.unknownUserMentionPlaceholder ? "@".concat(A.Z.Messages.UNKNOWN_USER_MENTION_PLACEHOLDER) : e[0];
                            return {
                                userId: o,
                                channelId: n.channelId,
        ...
        30027: (e, t, n) => {
            ...
            function X(e) {
                var t, n = null == e ? void 0 : e.getGuildId(),
                    ...
                    i = E.Z.can(_.Plq.MENTION_EVERYONE, e);
        ...
        166232: (e, t, n) => {
            ...
            _.displayName = "StickersPersistedStore";
            _.persistKey = "StickersPersistedStoreV2";
            const A = new _(l.Z, {
        ...
        504275: (e, t, n) => {
            ...
            function pe(e) {
                for (var t = e.query, n = e.members, r = e.limit, i = e.filter, l = x.default.getUsers(), a = j.Z.getGuildId(), c = t.toLocaleLowerCase(), s = (0, q.Fv)(c), f = [], d = [], p = n.length, y = 0, v = 0; y < p;) {
                    ...
                    if (m instanceof C.Z) {
                        var E;
                        b = m;
                        h = null === (E = _.ZP.getNick(a, b.id)) || void 0 === E ? void 0 : E.toLocaleLowerCase()
                    } else {
                        var O;
                    ...
                    if (null == i || i(b)) {
                        var S = b.username.toLocaleLowerCase(),
                            P = (0, q._I)(S),
                            I = (0, q.Fv)(P),
                            A = null != h ? (0, q._I)(h) : null,
                            L = null != A ? (0, q.Fv)(A) : null,
                            N = null != w ? (0, q._I)(w) : null,
                            Z = null != N ? (0,
                                q.Fv)(N) : null;
                        if (S.substring(0, c.length) === c || P.substring(0, c.length) === c || (null == h ? void 0 : h.substring(0, c.length)) === c || (null == A ? void 0 : A.substring(0, c.length)) === c || (null == w ? void 0 : w.substring(0, c.length)) === c || (null == N ? void 0 : N.substring(0, c.length)) === c) {
                            var R, T;
                            f.push({
                                type: B.h8.USER,
                                record: b,
                                ...
                                sortable: null !== (T = null != N ? N : A) && void 0 !== T ? T : P
                            })
                            ...
                            f.push({
                                ...
                                sortable: null !== (M = null != N ? N : A) && void 0 !== M ? M : P
                            })
                        } else if (v < 50 && (o()(c, P) || o()(s, I) || null != A && o()(c, A) || null != L && o()(s, L) || null != N && o()(c, N) || null != Z && o()(s, Z))) {
                            var k, U;
                            d.push({
                                type: B.h8.USER,
                                record: b,
                                ...
                                sortable: null !== (U = null != N ? N : A) && void 0 !== U ? U : P
                            });
                            v += 1
                        }
                    }
            ...
            function ge(e, t) {
                if (null != e.guild_id) {
                    ...
                    if (null == n) {
                        var r;
                        n = t[e.guild_id] = null === (r = A.Z.getGuild(e.guild_id)) || void 0 === r ? void 0 : r.toString().toLocaleLowerCase()
                    }
                    return n
                }
            }
            ...
            function he(e, t) {
                ...
                return null == e || null == n ? [] : l()(L.Z.getMessages(e).toArray()).reverse().uniqBy((function(e) {
                    ...
                    var t = n.getGuildId();
                    return null == t || de(_.ZP.getMember(t, e.id))
                })).map((function(e) {
                    var t, r = n.getGuildId(),
                        o = null != r ? _.ZP.getMember(r, e.id) : null;
                    return {
                        type: B.h8.USER,
                        record: e,
                        score: 0,
            ...
            const be = {
                ...
                queryChannelUsers: function(e) {
                    ...
                    if (y.isPrivate()) {
                        ...
                        d = _.ZP.getMembers(y.guild_id).filter(de);
                ...
                queryGuildUsers: function(e) {
                    var t = e.guildId,
                        ...
                        a = void 0 === u || u,
                        c = e.filter;
                    if (null == A.Z.getGuild(t)) return [];
                    if (0 === n.length && a) {
                        var s = he(T.Z.getChannelId(t), o);
                        if (s.length > 0) return s
                    }
                    var f = _.ZP.getMembers(t).filter(de);
                ...
                queryChannels: function(e) {
                    ...
                    try {
                        for (var k, U = t[Symbol.iterator](); !(j = (k = U.next()).done); j = !0) {
                            var q = k.value;
                            if ((_ = g, A = q.type, L = null != r, _ === A || (L || (0, P.Km)(A)) && (_ === I.sH ? (0, P.r8)(A) : _ === I.Zb && (0, P.bw)(A))) && (!(0, P.Km)(q.type) || N.Z.can(E ? q.accessPermissions : s.Plq.VIEW_CHANNEL, q)) && y(q)) {
                                var F = z(C),
                ...
                queryGuilds: function(e) {
                    var t = e.query,
                        ...
                        y = [],
                        v = l()(A.Z.getGuilds()).values().value(),
                        g = !0,
                        m = !1,
                        h = void 0;
                    try {
                    ...
                    var t = e.query,
                        ...
                        C = f ? (m && null != n.guild_id ? this.queryGuildUsers({
                            ...
                            return {
                                ...
                                nick: _.ZP.getNick(n.guild_id, t.id),
                        ...
                        for (var p, y = function() {
                                ...
                                i.forEach((function(e, i) {
                                    ...
                                    if (null != p && o(p, (0, h.cO)(p, u, r))) {
                                        ...
                                        try {
                                            for (var m, w = e[Symbol.iterator](); !(y = (m = w.next()).done); y = !0) {
                                                var S = m.value,
                                                    ...
                                                    I = ye(P),
                                                    _ = 0;
                                                if (t) C === n ? _ = ee * I : s.test(C) ? _ = 7 * I : P !== O.MO.GUILD_NAME && P !== O.MO.PACK_NAME && P !== O.MO.STICKER_NAME || !f.test(C) || (_ = 5 * I);
                                                else if (C === n) {
                                                    _ = ee * I;
                                                    d = C
                                                }
                                        ...
                                        var A = b.Z.stickerFrecencyWithoutFetchingLatest.getScore(i);
                                        null != A && (l *= A / 100);
                ...
                hasSameRoleAsUsername: function(e, t) {
                    ...
                    var n, r = A.Z.getGuild(e.getGuildId()),

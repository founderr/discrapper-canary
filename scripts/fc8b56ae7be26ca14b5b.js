        ...
        359067: (e, t, n) => {
            ...
            function L() {
                ...
                var e = !I,
                    ...
                    n = null == t ? null : w(t, C);
                R = i()(f.Z.getAllThreadsForParent(S)).filter((function(e) {
            ...
            var j = [],
                U = function(e) {
                    ...
                    r.isLoading = function(e, t, n) {
                        if (S === e && C === t && (0, p.OL)(T, n)) return M;
                        Z();
                        return !1
                    };
                    r.getThreads = function(e, t, n) {
                        return S === e && C === t && (0, p.OL)(T, n) ? R : j
                    };
                    r.__getLocalVars = function() {
                        return {
                            loading: M,
            ...
            const F = new U(l.Z, {
                ...
                LOAD_ARCHIVED_THREADS: function(e) {
                    e.channelId === S && e.sortOrder === C && (0, p.OL)(e.tagFilter, T) || Z();
                    S = e.channelId;
                    C = e.sortOrder;
                ...
                LOAD_ARCHIVED_THREADS_SUCCESS: function(e) {
                    if (e.channelId !== S || e.sortOrder !== C || !(0, p.OL)(e.tagFilter, T)) return !1;

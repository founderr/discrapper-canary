(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [55581, 97539, 84832, 88110, 96043, 53686, 56645, 71402], {
        737264: e => {
            "use strict";
        ...
        334835: (e, t, n) => {
            ...
            const v = function(e) {
                var t = e.hideDiscriminator,
                    ...
                    S = i.isPomelo() || p;
                if (S || I !== v) {
                    var T = I === v && S && u ? f.ZP.getUserTag(i, {
                            forcePomelo: p
                        }) : I,
                ...
                return (0, r.jsx)(s.Z, E({
                    ...
                    botType: g(i),
                    botVerified: i.isVerifiedBot(),
                    discriminator: O || I !== v ? null : null != d ? d : i.discriminator
                }, _))
            }
        },
        919244: (e, t, n) => {
            ...
            function U(e) {
                ...
                if (!m.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== I.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = w(a, i),
                        c = A({}, t, P(u), null != i && null != o && (0, S.AB)(o) ? R(0, o) : L(a));
                    m.default.track(e, c, {
                        flush: n
                    })
                }
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[e] && null != C[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in C[e][t]) t === U ? d.ZP.isNewForumThread(u, t, r) && w[e][t]++ : o.default.compare(u, i) > 0 && !d.ZP.hasOpenedThread(u) && w[e][t]++
                        }
                    }
                }
            }
        ...
        597539: (e, t, n) => {
            ...
            const V = (0, u.Z)((0, a.Z)((function(e) {
                var t, n = e.user,
                    ...
                    Q = (0, F.Z)(n.id),
                    J = function(e, t) {
                        var n = (0, m.e7)([T.default], (function() {
                                return T.default.getCurrentUser()
                            }), []),
                            o = (0, m.e7)([Z.Z], (function() {
                ...
                return (0, r.jsxs)(i.Menu, {
                    ...
                    children: [!fe && (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsx)(i.MenuGroup, {
                            ...
                            children: [S && X, S && $, C && ee, ne, C && re, S && ce]
        ...
        223219: (e, t, n) => {
            ...
            function U(e) {
                ...
                M = null !== (n = e.section) && void 0 !== n ? n : m;
                null != e.subsection && null != m && (v[m] = e.subsection);
            ...
            var Z = function(e) {
                ...
                r.hasChanges = function() {
                    return null != T && null != S && (!(!this.isOpen() && P !== l.cII.USER_SETTINGS) && !i().isEqual(T, S))
                };
                r.isOpen = function() {
                    return A
                };
            ...
            const x = new Z(a.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    ...
                    null != e.subsection && (v[m] = e.subsection)
                },
                USER_SETTINGS_MODAL_CLEAR_SUBSECTION: function(e) {
                    var t = e.forSection;
                    null != t ? delete v[t] : null != m && delete v[m]
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    P = e.tab;
                    return null == m && P === l.cII.USER_SETTINGS && U({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        609853: (e, t, n) => {
            ...
            var h = function(e) {
                var t = e.invertColor,
                    ...
                    y = void 0 === v ? [] : v,
                    I = null,
                    S = c.Z.Messages.VERIFIED_BOT_TOOLTIP;
                switch (s) {
                    case l.H.SYSTEM_DM:
                    case l.H.OFFICIAL:
                        E = !0;
                        S = c.Z.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP;
                        I = c.Z.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    case l.H.SERVER:
                        I = c.Z.Messages.BOT_TAG_SERVER;
                        break;
                    case l.H.ORIGINAL_POSTER:
                        I = c.Z.Messages.BOT_TAG_FORUM_ORIGINAL_POSTER;
                        break;
                    case l.H.STAFF_ONLY_DM:
                        I = c.Z.Messages.STAFF_BADGE_TOOLTIP;
                        break;
                    case l.H.AI:
                        E = !0;
                        S = c.Z.Messages.AI_GENERATED_TOOLTIP;
                        I = c.Z.Messages.AI_TAG;
                        break;
                    case l.H.REMIX:
                        E = !1;
                        I = c.Z.Messages.REMIXING_TAG;
                        break;
                    case l.H.BOT:
                    default:
                        I = c.Z.Messages.BOT_TAG_BOT
                }
                var T, A = s === l.H.ORIGINAL_POSTER,
                    N = s === l.H.REMIX,
                    P = null;
                E && (P = (0, r.jsx)(a.u, {
                    text: S,
                ...
                T = s === l.H.AI ? f().botTagAI : n ? f().botTagInvert : f().botTagRegular;
                var R = function(e) {
                    var t;
                    return (0, r.jsxs)("span", _(p({}, e), {
                        className: o()(h, T, m ? f().rem : f().px, (t = {}, d(t, f().botTagOP, A), d(t, f().botTagRemix, N), t)),
                        children: [b ? null : P, y, (0, r.jsx)("span", {
                            className: f().botText,
                            children: I
                        })]
                    }))
            ...
            function _(e, t) {
                ...
                var p, _, h, E, O, b = encodeURIComponent(l.toString()),
                    ...
                    m = (h = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), E = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(h)),
                        O = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !E, "iOS" !== (null === i() || void 0 === i() || null === (_ = i().os) || void 0 === _ ? void 0 : _.family) || O ? 1 : 0),
                    v = null != r ? encodeURIComponent(r) : null,
                    y = null != o ? encodeURIComponent(o) : null,
                    I = "".concat(f, "/?link=").concat(b, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(g, "&efr=").concat(m);
                null != v && (I += "&afl=".concat(v));

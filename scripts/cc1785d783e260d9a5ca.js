            ...
            class _ extends r.Component {
                    ...
                    if (0 !== a.length) {
                        switch (e.keyCode) {
                            case h.KeyboardKeys.BACKSPACE:
                                (null == n || 0 === n.length) && null != s && s.length > 0 && (e.preventDefault(), e.stopPropagation(), null == o || o(s.length - 1));
                                break;
                ...
                handleKeyDownList(e) {
                    ...
                    if (null != u) switch (e.keyCode) {
                        case h.KeyboardKeys.BACKSPACE:
                            if ((null == r || 0 === r.length) && null != i && i.length > 0) {
                                var d, c;
                                e.preventDefault(), e.stopPropagation(), null === (d = (c = this.props).onRemoveTag) || void 0 === d || d.call(c, i.length - 1)
                            }
                            break;
                        case h.KeyboardKeys.ARROW_DOWN:
                        ...
                        case h.KeyboardKeys.ENTER:
                            ...
                            break;
                        case h.KeyboardKeys.ESCAPE:
                            e.preventDefault(), o && e.stopPropagation(), null == n || n(null, null, e), u.blur()
                    }
                }
                render() {
                    let {
                        ...
                        inputProps: R,
                        focusAfterReady: p
                    } = this.props, I = null != t && t.length > 0, v = !1, m = [];
                    return null != h && h.length > 0 && ("string" == typeof h[0] ? h.forEach((e, t) => m.push((0, s.jsxs)(u.Anchor, {
                    ...
                    }, t))) : (v = !0, h.forEach((e, t) => m.push((0, s.jsxs)(u.Anchor, {
                        ...
                        children: (0, s.jsx)("div", {
                            ...
                            className: o(_, g.container, i, (0, S.getThemeClass)(a), {
                                [g.disabled]: n
                            }),
        ...
        355313: function(e, t, l) {
            ...
            function D(e) {
                let {
                    ...
                    maxCount: G,
                    hideRowLabel: j = !1
                } = e, P = n.useRef(null), k = n.useRef(null), F = [C.length, N.length, y.length, x.length], [K, H] = n.useState(!1), [V, z] = n.useState(0), [W, Y] = n.useState(-1);
                n.useEffect(() => {
                    var e;
                ...
                let X = n.useCallback(function(e, t) {
                    ...
                    J = n.useMemo(() => N.some(e => !e.disabled) || C.some(e => !e.disabled) || y.some(e => !e.disabled) || x.some(e => !e.disabled), [N, C, y, x]),
                    $ = J || "" === s.trim();
                        ...
                        renderRow: e => {
                            ...
                            switch (s) {
                                    ...
                                    c = (n = I(u = C[i])) in l || u.disabled, S = u.disabled || T, g = V === E.AudienceSelectorSections.ROLES && W === i, t = (0, a.jsxs)("div", {
                                        ...
                                        children: [(0, a.jsx)("div", {
                                            ...
                                            children: [(0, a.jsx)(o.Text, {
                                                ...
                                                children: u.name
                                            }), u.disabled && null != L ? (0, a.jsx)(o.Text, {
                                                color: "header-secondary",
                                                variant: "text-xs/normal",
                                                children: L
                                            }) : null]
                                ...
                                case E.AudienceSelectorSections.GUILDS:
                                    c = (n = I(u = x[i])) in l || u.disabled, S = u.disabled || T, g = V === E.AudienceSelectorSections.GUILDS && W === i, t = (0, a.jsxs)("div", {
                                        className: _.rowBody,

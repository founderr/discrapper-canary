    ...
    ["32540"], {
        ...
        991630: function(e, t, n) {
            ...
            function I(e) {
                let {
                    ...
                    onMouseLeave: S,
                    ..._
                } = e, [h, m] = a.useState(!1), O = a.useCallback(() => {
                    m(!0), null == E || E()
                }, [E]), A = a.useCallback(() => {
                    m(!1), null == f || f()
                }, [f]), v = a.useCallback(() => {
        ...
        355263: function(e, t, n) {
            ...
            var i = n("524768"),
                ...
                l = n("943161"),
                s = n("317041");
            let r = e => e.type === i.ApplicationCommandSectionType.BUILT_IN ? l.default : a.default;
            ...
            function d(e, t) {
                ...
                let l = t.split(" ", s.MAX_SUBCOMMAND_LEVEL + 1);
                return l.length > s.MAX_SUBCOMMAND_LEVEL && (i = !0, l.pop()), t = l.join(" "), (n.length > t.length || t.endsWith(" ")) && (i = !0, t = t.trimEnd()), {
                    text: t,
                    parts: l,
        ...
        823026: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    channel: E,
                    context: f
                } = e, N = c.default.getGuild(n), S = (0, l.useStateFromStores)([I.default], () => null != N ? I.default.can(p.Permissions.MANAGE_GUILD, N) : null), _ = (0, d.useContextIndexState)(E, !0, !0), h = (0, d.useUserIndexState)(!0, !0), {
                    isUserApp: m,
                    isGuildApp: O
                } = a.useMemo(() => {
                    var e, n, i, a;
                    ...
                    let l = Object.values(null !== (i = null === (e = _.result) || void 0 === e ? void 0 : e.sections) && void 0 !== i ? i : {}),
                        s = Object.values(null !== (a = null === (n = h.result) || void 0 === n ? void 0 : n.sections) && void 0 !== a ? a : {});
                    return {
                        isGuildApp: l.some(e => {
                            var n;
                ...
                }, [_, h, null == t ? void 0 : t.id]), A = a.useCallback(() => {
                ...
                }, [null == t ? void 0 : t.id, null == N ? void 0 : N.id]), v = a.useCallback(() => {
                    u.default.open(p.UserSettingsSections.AUTHORIZED_APPS)
                }, []), C = f === p.AppContext.POPOUT;
                if (!(null == t ? void 0 : t.bot) || !S || C || !O && !m) return null;
                let G = [];
                return O && G.push((0, i.jsx)(s.MenuItem, {
                    id: "manage-integration",
                    label: T.default.Messages.MANAGE_INTEGRATION,
                    action: A
                }, "manage-integration")), m && G.push((0, i.jsx)(s.MenuItem, {
        ...
        482391: function(e, t, n) {
            ...
            async function c(e, t, n) {
                let l = [];
                try {
                    let a = await i.default.get(r.Endpoints.APPLICATION_BOT_GUILD_COMMAND_PERMISSIONS(e, t, n));
            ...
            async function T(e) {
                ...
                }(u, d, i, r) : d, c = await l.updateApplicationGuildCommandPermissions(t, u, n, o);
            ...
            var i = n("37983"),
                ...
                _ = e => {
                    let t, {
                        ...
                        v = (0, r.useStateFromStores)([E.default], () => E.default.getUser(l)),
                        C = (0, p.default)({
                            user: v,
                    ...
                    return R.current ? t = (0, i.jsx)(u.MenuItem, {
                        ...
                        disabled: !0
                    }, "menu-commands-placeholder") : (t = 0 === G.length ? (0, i.jsx)(u.MenuItem, {
                        id: "menu-commands-empty",
                        label: N.default.Messages.APPLICATION_COMMAND_NO_COMMANDS,
                        disabled: !0
                    }, "menu-commands-empty") : G.map(P), null != C && (t = (0, i.jsxs)(i.Fragment, {
                        children: [t, (0, i.jsx)(u.MenuSeparator, {}, "separator"), C]
                    }))), (0, i.jsx)(u.MenuItem, {
                        id: "apps",
        ...
        555158: function(e, t, n) {
            ...
            var s = n("414456"),
                ...
                I = n("423487"),
                p = n("557296");
            (i = a || (a = {}))[i.WARNING = 0] = "WARNING", i[i.INFO = 1] = "INFO", i[i.ERROR = 2] = "ERROR", i[i.POSITIVE = 3] = "POSITIVE";
            var T = function(e) {
                let {
                    children: t,
                    messageType: n,

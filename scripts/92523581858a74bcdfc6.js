(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [60575], {
        ...
        749978: (e, t, n) => {
            ...
            function ae(e) {
                var t = e.transitionState,
                    ...
                    Ne = Object.values(we).filter((function(e) {
        ...
        901654: (e, t, n) => {
            ...
            Promise.resolve().then(n.bind(n, 652591)).then((function(e) {
        ...
        609853: (e, t, n) => {
            ...
            var O = function(e) {
                var t = e.invertColor,
                    ...
                    m = void 0 === E ? [] : E,
                    S = null,
                    C = a.Z.Messages.VERIFIED_BOT_TOOLTIP;
                switch (s) {
                    case l.H.SYSTEM_DM:
                    case l.H.OFFICIAL:
                        y = !0;
                        C = a.Z.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP;
                        S = a.Z.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    case l.H.SERVER:
                        S = a.Z.Messages.BOT_TAG_SERVER;
                        break;
                    case l.H.ORIGINAL_POSTER:
                        S = a.Z.Messages.BOT_TAG_FORUM_ORIGINAL_POSTER;
                        break;
                    case l.H.STAFF_ONLY_DM:
                        S = a.Z.Messages.STAFF_BADGE_TOOLTIP;
                        break;
                    case l.H.AI:
                        y = !0;
                        C = a.Z.Messages.AI_GENERATED_TOOLTIP;
                        S = a.Z.Messages.AI_TAG;
                        break;
                    case l.H.REMIX:
                        y = !1;
                        S = a.Z.Messages.REMIXING_TAG;
                        break;
                    case l.H.BOT:
                    default:
                        S = a.Z.Messages.BOT_TAG_BOT
                }
                var w, N = s === l.H.ORIGINAL_POSTER,
                    T = s === l.H.REMIX,
                    j = null;
                y && (j = (0, r.jsx)(c.u, {
                    text: C,
                ...
                w = s === l.H.AI ? f().botTagAI : n ? f().botTagInvert : f().botTagRegular;
                var P = function(e) {
                    var t;
                    return (0, r.jsxs)("span", h(d({}, e), {
                        className: i()(O, w, _ ? f().rem : f().px, (t = {}, p(t, f().botTagOP, N), p(t, f().botTagRemix, T), t)),
                        children: [v ? null : j, m, (0, r.jsx)("span", {
                            className: f().botText,
                            children: S
                        })]
                    }))
        ...
        859917: (e, t, n) => {
            ...
            const p = function(e) {
                var t = e.width,
                    ...
                    p = e.foreground,
                    d = f(e, ["width", "height", "color", "foreground"]);
                return (0,
            ...
            function g(e) {
                var t = e.children,
                    ...
                    i = void 0 === n ? 16 : n,
                    l = e.className,
                    a = e.flowerStarClassName,
                    s = v(e, ["children", "size", "className", "flowerStarClassName"]),
                    f = o.Children.only(t),
                    d = {
                        width: i,
                        height: i
                ...
                return (0, r.jsxs)("div", {
                    className: c()(h().flowerStarContainer, l),
                    style: d,
                    children: [(0, r.jsx)(p, b(y({}, s), {
                        className: c()(a, h().flowerStar)
                    })), (0, r.jsx)("div", {
                        className: c()(h().childContainer, O({}, h().redesignIconChildContainer, g)),
                        children: f
                    })]
                })
            }

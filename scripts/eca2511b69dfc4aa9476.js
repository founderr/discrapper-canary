        ...
        948832: (e, t, n) => {
            ...
            var N = new h(o.Z, {
                ...
                PRIVATE_CHANNEL_INTEGRATION_CREATE: function(e) {
                    ...
                    if (null == n) return !1;
                    I.set(t.channel_id, b(_(n).concat([(0, u.F)(t)])))
                },
        ...
        223219: (e, t, n) => {
            ...
            var x = function(e) {
                ...
                r.hasChanges = function() {
                    return null != m && null != R && (!(!this.isOpen() && A !== a.cII.USER_SETTINGS) && !o().isEqual(m, R))
                };
                r.isOpen = function() {
                    return P
                };

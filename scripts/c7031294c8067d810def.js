        ...
        594203: function(e, t, r) {
            ...
            var c = e => {
                ...
                return o.useLayoutEffect(() => {
                    ...
                    let t = (0, s.throttle)(l, c),
                        o = a => {
                            if (null == r.current) return null;
                            let n = e(a),
                                l = 1 === d(u) ? "width" : "height";
        ...
        383925: function(e, t, r) {
            ...
            function O() {
                ...
                let [{
                    ...
                    semanticTokens: A
                }), [L, R] = l.useState(""), [P, M] = l.useState({}), [O, B] = l.useState({}), D = l.useMemo(() => {
                    let e = Object.keys(a);
                ...
                }, []), U = l.useCallback(e => d(E(), Object.keys(e).map(t => '"'.concat(t, '": {hex: "').concat(e[t].hex, '"}'))), []), V = l.useCallback(e => {
                    let t = {};
            ...
            function h(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    r = (0, a.useStateFromStores)([n.default], () => {
                        var t, r;
                        return null !== (r = null === (t = n.default.getGuild(e)) || void 0 === t ? void 0 : t.hasFeature(o.GuildFeatures.AUTOMOD_TRIGGER_USER_PROFILE)) && void 0 !== r && r
                    }, [e]),
                    l = (0, i.useIsUserProfileRuleExperimentEnabled)(e, t);
                return l || r
            }

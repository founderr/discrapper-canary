    ...
    ["68577"], {
            ...
            async function E(e, t, n, d, E) {
                ...
                try {
                    let a = {
                        ...
                        o = {};
                    null != t && (o.country_code = t), null != n && (o.payment_source_id = n), null != d && (o.include_unpublished = d), null != E && (o.revenue_surface = E), a.query = o, !r.default.ipCountryCodeLoaded && await (0, u.fetchIpCountryCode)();
                    ...
                    saveAccountChanges(e, t) {
                        ...
                        return (0, d.default)(e => {
                            ...
                            return u.default.track(E.AnalyticEvents.USER_AVATAR_UPDATED, {
                                ...
                                user: t,
                                newPassword: I
                            }), null != S && null != I && a.default.dispatch({
                                type: "PASSWORD_UPDATED",
                                userId: t.id
            ...
            class d extends l.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: A,
                        retrySuccess: O
                    } = this.state, p = l.Children.count(a) > 0 ? (0, i.jsx)(o.Card, {
                    ...
                    return (0, i.jsx)(o.ModalRoot, {
                        ...
                        children: (0, i.jsxs)("form", {
                            ...
                            children: [(0, i.jsx)(o.ModalHeader, {
                                ...
                                children: [null != S ? (0, i.jsx)(o.Text, {
                                    color: "text-normal",
                                    variant: "text-md/normal",
                                    className: s.spacing,
                                    children: S
        ...
        321135: function(e, t, n) {
            ...
            function _(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : d.MediaEngineContextTypes.DEFAULT,
                    ...
                    S = (0, l.useStateFromStores)([r.default], () => r.default.disableHideSelfStreamAndVideoConfirmationAlert);
            ...
            let u = (0, l.createExperiment)({
                ...
                E = function() {
                    ...
                    let {
                        ...
                        autoTrackExposure: !0
                    }, l = (0, i.default)([a.default], () => a.default.getCurrentUser()), r = u.useExperiment({
        ...
        244480: function(e, t, n) {
            ...
            function p(e, t) {
                ...
                let a = E.default.getVoiceStateForChannel(e.id),
                    o = (0, I.getAudienceRequestToSpeakState)(a);
            ...
            async function g(e, t, n, i) {
                ...
                let a = await (0, T.startStageInstance)(e.id, t, n, i);
                return p(e, !1, !0), a
            }
            async function U(e, t, n) {
                if ("" === t) return;
                let i = await (0, T.updateStageInstance)(e.id, t, n);
                return i
            }
            async function L(e) {
        ...
        230324: function(e, t, n) {
            ...
            function E(e, t, n, i) {
                let a = t[0],
                    ...
                    o = null != i ? i : t.length;
                return 1 === o && null != a ? r : null == a ? d.default.Messages.SPEAKING_COUNT.format({
                    count: o
        ...
        726750: function(e, t, n) {
            ...
            function T(e) {
                ...
                let n = (0, c.default)(),
                    ...
                    A = (0, l.useStateFromStores)([u.default], () => null != T ? u.default.getVoiceStateForChannel(T, e.id) : null, [T, e.id]),
                    O = (null === (t = o.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === e.id,
                    p = (0, _.default)(),
                    N = (0, l.useStateFromStores)([E.default], () => E.default.getPermissionsForUser(e.id, T), [T, e.id]),
                    R = (0, d.useCanModerateRequestToSpeak)(T);
                ...
                return R ? (0, i.jsx)(a.MenuItem, {
                    id: "invite-speaker",
                    label: O ? S.default.Messages.STAGE_CHANNEL_USER_SET_MYSELF_TO_SPEAKER : S.default.Messages.STAGE_CHANNEL_USER_INVITE_TO_SPEAK,
                    action: C
        ...
        865372: function(e, t, n) {
            ...
            class f extends a.default.PersistedStore {
                initialize(e) {
                    this.waitFor(s.default), null != e && (_ = e), this.syncWith([s.default], T), this.syncWith([u.default], I)
                }
                getState() {
                    return _
                }
        ...
        364685: function(e, t, n) {
            ...
            let O = 2,
                ...
                h = () => {
                    ...
                    if (null != t) {
                        for (let [e, n] of t)
                            if (S.default.isMember(e) && !U.has(e)) {
            ...
            class b extends r.default.Store {
                initialize() {
                    this.waitFor(u.default, S.default, T.default)
                }
                get isLoaded() {
                    return 0 !== O
                }
        ...
        692986: function(e, t, n) {
            ...
            function O(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : I.MediaEngineContextTypes.DEFAULT,
                    ...
                    O = (0, l.useStateFromStores)([u.default], () => u.default.isLocalSoundboardMuted(e)),
                    {
                        muted: p,
                        deafened: N = !1,
                        ...
                        action: () => {
                            if (C) {
                                r.default.show({
                                    ...
                                    onConfirm: () => o.default.setDisableLocalVideo(e, T.VideoToggleState.MANUAL_ENABLED)
                                });
                                return
                            }
                            let n = R ? T.VideoToggleState.MANUAL_ENABLED : T.VideoToggleState.DISABLED;
                    ...
                    g = n ? null : (0, i.jsx)(a.MenuCheckboxItem, {
                        ...
                        action: () => {
                            ...
                            S.default.track(T.AnalyticEvents.AUDIO_LOCAL_SOUNDBOARD_MUTE_TOGGLED, {
        ...
        816106: function(e, t, n) {
            ...
            function c(e) {
                ...
                let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : E.MediaEngineContextTypes.DEFAULT,
                    ...
                    S = e === (null === (t = u.default.getCurrentUser()) || void 0 === t ? void 0 : t.id),
                    T = n === E.MediaEngineContextTypes.STREAM;
                return S ? null : (0, i.jsx)(a.MenuControlItem, {
                    id: "user-volume",
                    label: T ? _.default.Messages.STREAM_VOLUME : _.default.Messages.USER_VOLUME,
                    control: (t, l) => (0, i.jsx)(a.MenuSliderControl, {
                        ...
                        "aria-label": T ? _.default.Messages.STREAM_VOLUME : _.default.Messages.USER_VOLUME
                    })
                })
            }
        },
        ...
        26092: function(e, t, n) {
            ...
            function g(e) {
                ...
                if (null == d) return U();
                E = null !== (t = e.section) && void 0 !== t ? t : E, C = null !== (n = e.section) && void 0 !== n ? n : E, null != e.subsection && null != E && (_[E] = e.subsection), null != e.scrollPosition && null != E && (c[E] = e.scrollPosition), A = !!e.openWithoutBackstack, s = u.FormStates.OPEN, S = {}, I = {
                    ...T = {
            ...
            function U() {
                s = u.FormStates.CLOSED, f = !1, T = null, C = null, I = null, d = null, E = null, _ = {}, c = {}, p = null, N = null, R = [], m = null
            }

            function L() {
                s = u.FormStates.OPEN, S = {}
            }
            class M extends a.default.Store {
                ...
                hasChanges() {
                    return null != I && null != T && (!!this.isOpen() || O === u.DrawerTabTypes.USER_SETTINGS) && !l.isEqual(I, T)
                }
                isOpen() {
                    return f
                }
            ...
            var h = new M(r.default, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(e) {
                    ...
                    s = u.FormStates.OPEN, E = u.UserSettingsSections.ACCOUNT, S = null !== (t = e.errors) && void 0 !== t ? t : {}
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return O = e.tab, null == E && O === u.DrawerTabTypes.USER_SETTINGS && g({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

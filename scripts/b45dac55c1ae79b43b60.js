(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["33533"], {
        ...
        698609: function(t, e, n) {
            ...
            function o(t) {
                let [e, n] = i.useState(!1), s = (0, a.useStateFromStores)([l.default], () => l.default.getClassification(t));
                return i.useEffect(() => {
        ...
        573240: function(t, e, n) {
            ...
            let x = {
                    ...
                    [f.ActionType.LIMITED_ACCESS]: [r.default, L.warningIcon],
                    [f.ActionType.REQUIRE_VERIFICATION]: [d.default, L.warningIcon],
                    [f.ActionType.TEMP_BAN]: [r.default, L.warningIcon],
                    ...
                    [f.ActionType.USER_WARNING]: [l.default, L.warningIcon]
                },
                p = d.default,
                h = t => {
                    let {
                ...
                R = t => {
                    let {
                        action: e
                    } = t, [n, a] = e.action_type in x ? x[e.action_type] : [p, L.warningIcon];
            ...
            var i = n("37983"),
                ...
                I = t => {
                    let {
                        ...
                        classificationId: I,
                        source: _
                    } = t, T = (0, o.default)(), C = (0, r.useSafetyHubInitialized)();
                    return a.useEffect(() => {
                        !C && l.getSafetyHubData()

    ...
    [3404], {
                    ...
                    return O(this, (function(O) {
                        switch (O.label) {
                            case 0:
                                ...
                                _ = (null !== (I = s.Z.getSearchResults({
                                    query: e,
                                    guildId: n,
                                    page: l,
                                    categoryId: f
                                })) && void 0 !== I ? I : {}).lastFetchTimeMs;
                                if (y === s.M.FETCHING) return [2];
                                if (null != _ && _ + h > p) return [2];
                                i.Z.dispatch({
                            ...
                            case 2:
                                ...
                                i.Z.dispatch({
                                    ...
                                    categoryId: f,
                                    result: {
                                        results: b.body.results,
                                        countsByCategory: b.body.counts_by_category,
                                        totalCount: b.body.result_count,
                                        totalPages: b.body.num_pages,
                                        type: b.body.type,
                                        loadId: b.body.load_id
                                    }
                                });
                                null == u || u(b.body.result_count);
                                return [3, 4];
                            case 3:
                                O.sent();
                                i.Z.dispatch({
        ...
        675556: (t, e, n) => {
            ...
            const g = new(function(t) {
                ...
                r.__getLocalVars = function() {
                    return {
                        collections: _,
                        collectionsFetchStates: h,
                        collectionsLastFetchTimeMs: b
                    }
                };
                return n
            }(i.ZP.Store))(c.Z, {
        ...
        807219: (t, e, n) => {
            ...
            var E = function(t) {
                ...
                r.__getLocalVars = function() {
                    return {
                        MAX_CACHE_SIZE: 20,
                        searchResultsCache: h,
                        searchResultsFetchStates: b
                    }
                };
                return n
            }(i.ZP.Store);
            ...
            var E = function(t) {
                ...
                r.__getLocalVars = function() {
                    return {
                        ...
                        similarApplicationsFetchStates: b
                    }
                };
                return n
            }(i.ZP.Store);
        ...
        204313: (t, e, n) => {
            ...
            const I = new(function(t) {
                ...
                r.__getLocalVars = function() {
                    return {
                        MESSAGE_TRACKING_SESSION_THRESHOLD_MS: y,
                        MESSAGE_TRACKING_MINIMUM_VIEW_TIME_MS: 1e3,
                        MAX_BUFFER_SIZE: 10,
                        BUFFER_TIME_MS: 2e3,
                        MAX_RECENT_VIEW_LRU_SIZE: 500
                    }
                };
                return n
            }(i.Z))
            ...
            var y = Object.freeze({
                ...
                I = function(t) {
                    var e, n = t.id,
                        ...
                        C = t.uppercase;
                    return (0, r.jsx)(c.H, {
                        role: null != g ? "button" : void 0,
                        onClick: g,
                        onContextMenu: v,
                        id: n,
                        className: i()(s, (e = {}, f(e, a().base, !0), f(e, O, !0), f(e, a().selectable, h), f(e, a().muted, u), f(e, a().uppercase, C), e)),
                        title: S,
                        style: null != E ? d(p({}, T), {
                            color: E
                        }) : T,
        ...
        646161: (t, e, n) => {
            ...
            function g() {
                ...
                return null == t ? _ : -1 !== t.indexOf(s) || -1 !== t.indexOf(f) || -1 !== t.indexOf(p) || -1 !== t.indexOf(d) || -1 !== t.indexOf(y) || -1 !== t.indexOf(I) ? b : -1 !== t.indexOf(O) ? h : _
            }

            function v(t) {
                var e;
                return (l(e = {}, _, "Windows"), l(e, h, "Mac"), l(e, b, "Linux"), e)[g(t)]
            }

        ...
        161283: (e, n, t) => {
            ...
            function w(e, n) {
                ...
                for (var u, l = p.ZP.unparse(null !== (u = null == o ? void 0 : o.content) && void 0 !== u ? u : "", e.id, !0), s = (0, I.Z)(l.split("\n")[0], !0), c = [];;) {
                    var d = s.match(/(?:\s|[!@#$%^&*()_\-+={}[\]:";'<>?,./])+/);
                    if (null == d || null == d.index) {
                        c.push(s);
                        break
                    }
                    c.push(s.substring(0, d.index));
                    c.push(d[0]);
                    s = s.substring(d.index + d[0].length)
                }
                for (var f = c[0], y = 1; y < c.length; y++) {
                    var m = f + c[y];
                    if (m.length > 40) break;
                    f = m
                }
                f.length > 40 && (f = f.substring(0, 40) + "...");
                return f
            }

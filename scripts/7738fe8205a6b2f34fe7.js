    ...
    ["80683"], {
        ...
        685807: function(e, t, s) {
            ...
            function E(e) {
                ...
                })), [M, O] = l.useState(!1), [I, x] = l.useState(""), [R, L] = l.useState(null);
                l.useEffect(() => {
                    if (M) L((0, r.jsx)(m.default, {
                        ...
                        children: A.default.Messages.MULTI_ACCOUNT_MAX_ACCOUNTS_ERROR.format({
                            maxNumAccounts: g.MAX_ACCOUNTS
                        })
                    })), x("");
                    else if (null != I) {
                        let e = f.default.getUser(I);
                        null != e && L((0, r.jsx)(m.default, {
                ...
                return (0, r.jsx)(u.ModalRoot, {
                    ...
                    children: (0, r.jsxs)(u.Sequencer, {
                        step: a,
                        steps: [0, 1],
                        children: [j && (0, r.jsx)(u.ModalCloseButton, {
                            onClick: s,

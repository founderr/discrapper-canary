    ...
    ["10697"], {
                    ...
                    async fetchApplications(t) {
                        ...
                        if (!e && (n = t.filter(t => {
                                ...
                                let r = u.default.getApplication(t),
                                    i = (0, l.hasFlag)(null !== (n = null == r ? void 0 : r.flags) && void 0 !== n ? n : 0, a.ApplicationFlags.EMBEDDED),
                                    o = i && (null == r ? void 0 : null === (e = r.embeddedActivityConfig) || void 0 === e ? void 0 : e.supported_platforms) == null;
                                return !(null != r && !o) && !u.default.isFetchingApplication(t) && !u.default.didFetchingApplicationFail(t) && t.length > 0
                            })), n.length > 0) {
                            let t;
                            i.default.dispatch({
        ...
        526887: function(t, e, n) {
            ...
            function d(t) {
                ...
                } = t, _ = (0, l.useConfettiCannon)(n, o), I = (0, u.default)([a.default], () => a.default.useReducedMotion), T = i.useMemo(() => I ? s : {
                    confettiCanvas: n,
                    cannon: _,
        ...
        384830: function(t, e, n) {
            ...
            function o(t) {
                ...
                if (null != r || null != n) {
                    if (null == e) return i(null != n, "emojiName must be defined if emojiId is not defined"), a.default.convertSurrogateToName(n, !1);
        ...
        208548: function(t, e, n) {
            ...
            function N(t) {
                let {
                    ...
                    emojiId: N,
                    emojiName: h
                }), g = (0, a.useStateFromStores)([E.default], () => null != n ? E.default.getDefaultChannel(n) : null), L = i.createRef(), U = (0, d.default)(L), O = () => {
                    R(void 0), A(void 0)
                }, m = t => (e, n) => {
            ...
            let o = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
                ...
                E = (t, e) => {
                    ...
                    let u = l.SUPPORTS_WEBP ? "webp" : "png",
                        d = "",
                        f = "quality=lossless";
                    return (null != e && (d = "size=" + (0, i.getBestMediaProxySize)(e * (0, i.getDevicePixelRatio)()), f = c ? "" : "&" + f), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(o, "/").concat(n, "/").concat(r, ".").concat(u, "?").concat(d).concat(f) : "".concat(s).concat(a.Endpoints.ROLE_ICON(n, r), "?").concat(d)
                },
                _ = t => t.startsWith(o) || t.startsWith("".concat(s, "/roles")) && t.includes("/icons/"),
                I = (t, e) => {
                    var n;
        ...
        424562: function(t, e, n) {
            ...
            function C() {
                i = void 0, l = void 0, u = void 0, o = void 0
            }
            class v extends f.default.Store {
                ...
                showNotice() {
                    return void 0 !== r || void 0 !== i || void 0 !== l || void 0 !== u || void 0 !== a || void 0 !== o
                }
                getPendingAvatar() {
                    return r
                }
        ...
        269596: function(t, e, n) {
            ...
            class s extends r.default.PersistedStore {
                ...
                hasHotspot(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        n = !e && o[t];
                    return !(u.CONFERENCE_MODE_ENABLED || l.ProcessArgs.isDisallowPopupsSet()) && (n || !a.has(t))
                }
                hasHiddenHotspot(t) {
                    return a.has(t)
                }
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, r.jsx)(t, {
                            ...
                            onComplete: () => {
                                D = !0, null == I || I(), !C && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: T,
                            analyticsLocations: p,
                            analyticsObject: S,
                    ...
                    onCloseCallback: () => {
                        !D && s.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: L,
                            location_stack: p
                        }), (0, u.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == _ || _(D), D && (!C && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == T || T())
                    },
        ...
        38766: function(t, e, n) {
            ...
            function s(t) {
                let {
                    ...
                    null != e && (0, u.initGuildIdentitySettings)(e, null != c ? c : f), i.default.open(a.UserSettingsSections.PROFILE_CUSTOMIZATION, null != e ? o.ProfileCustomizationSubsection.GUILD : o.ProfileCustomizationSubsection.USER_PROFILE, {
                        scrollPosition: n,
                        analyticsLocation: s,
                        analyticsLocations: c,
        ...
        931138: function(t, e, n) {
            ...
            function c(t) {
                let {
                    ...
                    ...d
                } = t, f = i.Children.only(e), E = (0, a.useRedesignIconContext)().enabled;
                return (0, r.jsxs)("div", {
            ...
            var r = n("37983"),
                ...
                o = i.forwardRef(function(t, e) {
                    let {
                        ...
                        !t.repeat && ((t.charCode === a.KeyboardKeys.SPACE || t.charCode === a.KeyboardKeys.ENTER) && (t.preventDefault(), null != n && (0, u.transitionTo)(n), null == s || s()), null == c || c(t))
            ...
            class h extends i.PureComponent {
                renderUsers() {
                    let {
                        ...
                        size: i,
                        extraDetail: l
                    } = this.props, u = [], a = t.length === e ? t.length : e - 1, o = this.renderMoreUsers(a), s = 0;
                    for (; s < a && s < t.length;) {
                        var c;
                        let e = null == o && null == l && s === t.length - 1,
                            a = n(t[s], e, s);
                    ...
                    return null != l ? u.push(l) : null != o && u.push(o), u
                }
                renderMoreUsers(t) {
                    let {
                        max: e,
                        ...
                        renderMoreUsers: u,
                        users: a
                    } = this.props, o = Math.min(t, a.length);
                    if (!l) {
                        if (null != n) {
                ...
                render() {
                    let {
                        ...
                        popoutUserId: f
                    } = this.state, _ = n.find(t => null != t && t.id === f), I = a && null == E.default.getUser(f);
                    return (0, r.jsx)(s.Popout, {
                        ...
                        fixed: !0,
                        renderPopout: t => (o(null != f, "UserSummaryItem.render - renderPopout: popoutUserId cannot be null"), (0, r.jsx)(d.default, {
                            ...this.props,

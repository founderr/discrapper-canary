    ...
    ["8366"], {
        458389: function(t, e, n) {
            ...
            t.exports = function(t, e) {
                var n = a(t),
                    ...
                    f = !n && !c && !d && o(t),
                    E = n || c || d || f,
                    I = E ? r(t.length, String) : [],
                    T = I.length;
                for (var _ in t)(e || s.call(t, _)) && !(E && ("length" == _ || d && ("offset" == _ || "parent" == _) || f && ("buffer" == _ || "byteLength" == _ || "byteOffset" == _) || l(_, T))) && I.push(_);
                return I
            }
        },
        ...
        376507: function(t, e, n) {
            ...
            var d = {
                ...
                T = {
                    ...
                    clientExtensionResults: o(E, t => t.getClientExtensionResults())
                },
                _ = {
                    mediation: c(a),
                    publicKey: s({
        ...
        991630: function(t, e, n) {
            ...
            function f(t) {
                let {
                    ...
                    onMouseLeave: p,
                    ...N
                } = t, [A, h] = i.useState(!1), C = i.useCallback(() => {
                    h(!0), null == T || T()
                }, [T]), m = i.useCallback(() => {
                    h(!1), null == _ || _()
                }, [_]), O = i.useCallback(() => {
        ...
        497660: function(t, e, n) {
            ...
            function I(t, e, n) {
                let I = s.default.getGuild(e),
                    ...
                    S = n === d.AppContext.POPOUT;
                return t.bot && T && !S ? (0, r.jsx)(u.MenuItem, {
        ...
        130037: function(t, e, n) {
            ...
            function I(t) {
                let e = l.useCallback(e => {
                    ! function(t) {
                        ...
                        E(f.AnalyticEvents.MOD_DASH_SEARCH_MEMBERS, e)
                    }(t)
                }, [t]);
                return e
            }
            ...
            function S(t, e) {
                let {
                    ...
                    E(f.AnalyticEvents.MODERATION_ACTION, a)
                }, [t, n, r, i]);
                return a
        ...
        809810: function(t, e, n) {
            ...
            var T = new I(u.default, {
                ...
                INTERACTION_SUCCESS: function(t) {
                    ...
                    let r = c[n];
                    if (null == r) return !1;
                    null === (e = r.onSuccess) || void 0 === e || e.call(r), E(n)
                },
                INTERACTION_FAILURE: function(t) {
                    ...
                    let a = c[n];
                    if (null == a) return !1;
                    null === (e = a.onFailure) || void 0 === e || e.call(a, r, i), a.data.interactionType === l.InteractionTypes.APPLICATION_COMMAND ? E(n) : c[n] = {
                        ...a,
                ...
                MESSAGE_CREATE: function(t) {
                    ...
                    if (null == e.nonce) return !1;
                    {
                        ...
                        let t = c[e.nonce];
                        if (null == t) return !1;
                        null === (n = t.onSuccess) || void 0 === n || n.call(t), E(e.nonce)
                    }
                },
                CHANNEL_SELECT: function(t) {
                    ...
                    if (null == n) return !1;
                    for (let [t, e] of Object.entries(c)) e.state === s.InteractionState.FAILED && E(t)
                },
        ...
        752598: function(t, e, n) {
            ...
            let p = async t => {
                let {
                    ...
                    guildId: T,
                    localState: S
                } = t, p = a.default.fromTimestamp(Date.now());
                if (!E.default.canQueueInteraction(n, p)) return;
                await c.default.unarchiveThreadIfNecessary(I), (0, f.addQueued)(p, {
                    messageId: n,
                    data: {
                        ...
                        if (r.status >= 400 && r.status < 500 && r.body) {
                            if (r.body.code === _.AbortCodes.INVALID_FORM_BODY && r.body.errors) {
                                ...
                                null != i && ("INTERACTION_APPLICATION_COMMAND_INVALID_VERSION" === i.code || "INTERACTION_APPLICATION_COMMAND_INVALID" === i.code) && l.default.dispatch({
                                    ...
                                    channelId: e,
                                    guildId: n
                                }), (0, f.setFailed)(t, void 0, null == i ? void 0 : i.message);
                                return
                            }(0, f.setFailed)(t, void 0, r.body.message);
                            return
                        }(0, f.setFailed)(t, null === (i = r.body) || void 0 === i ? void 0 : i.code);
                        return
                    }(0, f.setFailed)(t)
                }
            };
            ...
            let h = (t, e) => {
                ...
                let r = null == e ? void 0 : e.state,
                    u = t.state === _.MessageStates.SENT && S(t.id) < Date.now();
        ...
        252063: function(t, e, n) {
            ...
            function s(t) {
                ...
                r.useEffect(() => {
                    n && ((d === o.FetchState.NOT_FETCHED || d === o.FetchState.FETCH_FAILED) && (0, l.fetchPrivateChannelIntegrations)(e), (f === o.FetchState.NOT_FETCHED || f === o.FetchState.FETCH_FAILED) && (0, l.fetchApplicationsShelf)())
                }, [n, e, d, f]);
                let E = new Set(s.map(t => t.application.id)),
                    I = c.filter(t => !E.has(t.id));
                return {
                    installedIntegrations: s,
        ...
        38766: function(t, e, n) {
            ...
            function s(t) {
                ...
                } = (0, a.default)(), E = (0, r.useCallback)(() => {
                    null != e && (0, u.initGuildIdentitySettings)(e, null != c ? c : f), i.default.open(l.UserSettingsSections.PROFILE_CUSTOMIZATION, null != e ? o.ProfileCustomizationSubsection.GUILD : o.ProfileCustomizationSubsection.USER_PROFILE, {
                        scrollPosition: n,
                        analyticsLocation: s,
                        analyticsLocations: c,
        ...
        85166: function(t, e, n) {
            ...
            function I(t, e, n) {
                ...
                let T = u.default.getChannel(n),
                    ...
                    S = (0, i.useStateFromStores)([d.default], () => d.default.getPermissionsForUser(t.id, n), [n, t.id]),
                    p = (null === (I = s.default.getCurrentUser()) || void 0 === I ? void 0 : I.id) === t.id,
                    N = (0, i.useStateFromStores)([o.default], () => null != n && o.default.canWithPartialContext(f.Permissions.MUTE_MEMBERS, {
                        channelId: n
                    }), [n]);
                return null != T && null != _ && (N || p) && S.speaker ? (0, r.jsx)(a.MenuItem, {
                    id: "audience",
                    label: p ? E.default.Messages.STAGE_CHANNEL_USER_MOVE_TO_AUDIENCE : E.default.Messages.STAGE_CHANNEL_USER_MOVE_TO_AUDIENCE_OTHER,
                    action: () => {
                        p ? (0, c.moveSelfToAudience)(T) : (0, c.moveUserToAudience)(t, T)
                    }
                }) : null
            }
        },
        834247: function(t, e, n) {
            ...
            var i = n("77078"),
                ...
                x = n("49111"),
                j = n("782340"),
                B = (0, l.default)((0, u.default)(function(t) {
                    let {
                        user: e,
                        guildId: n,
                        channel: u,
                        ...
                        onSelect: V,
                        onHeightUpdate: Y
                    } = t, K = (0, L.default)(e.id, n, u.id), W = (0, G.default)(e, n, k), Q = (0, R.default)(e.id, k), X = (0, F.default)(e.id), Z = (0, M.default)(e, k), q = (0, C.default)({
                        user: e,
                        guildId: n,
                        context: k
                    }), z = (0, h.default)(e), J = (0, P.default)(e.id), $ = (0, b.default)(e.id), tt = (0, _.default)({
                        guildId: n,
                        userId: e.id,
                        analyticsLocation: {
                        ...
                        context: k
                    }), te = (0, g.default)(e, n), tn = (0, s.default)(null, e), tr = (0, A.default)(e), ti = (0, y.default)(e), ta = (0, m.default)(e, n, u.id), tu = (0, U.default)(e.id, n), tl = (0, v.default)(e, n), to = (0, T.default)({
                        id: e.id,
                        label: j.default.Messages.COPY_ID_USER
                    }), ts = (0, D.default)(e.id, u.id), tc = (0, f.default)(e.id), td = (0, d.default)(u.id), tf = (0, p.default)(e), tE = (0, N.default)(e, n, u.id), tI = (0, O.default)({
                        commandType: o.ApplicationCommandType.USER,
                        commandTargetId: e.id,
                        channel: u,
                        guildId: n,
                        onShow: Y
                    }), tT = (0, E.default)(e.id), t_ = (0, S.default)(e, n, k), tS = e.isNonUserBot(), tp = e.isClyde(), tN = (0, I.useIsDMsToClydeEnabled)();
                    return (0, r.jsxs)(i.Menu, {
                        navId: "user-context",
                        onClose: a.closeContextMenu,
                        "aria-label": j.default.Messages.USER_ACTIONS_MENU_LABEL,
                        onSelect: V,
                        children: [!tS && (0, r.jsxs)(r.Fragment, {
                            children: [(0, r.jsxs)(i.MenuGroup, {
                                children: [tf, H && tE]
                            }), (0, r.jsxs)(i.MenuGroup, {
                                children: [w && K, c && W, Q, Z, w && q, w && z, X]
                            }), l && (0, r.jsx)(i.MenuGroup, {
                                children: J
                            }), (0, r.jsx)(i.MenuGroup, {
                                children: w && tn
                            }), (0, r.jsxs)(i.MenuGroup, {
                                children: [l && $, l && ts, w && tt, tI, t_, w && te, tr, w && ti, B && tT]
                            }), (0, r.jsx)(i.MenuGroup, {
                                children: ta
                            }), (0, r.jsxs)(i.MenuGroup, {
                                children: [tu, tl]
            ...
            var r = n("37983"),
                ...
                N = t => {
                    let {
                        ...
                        guildId: N,
                        onShow: A
                    } = t, h = i.useRef(!1), C = i.useRef(0), m = (0, l.useStateFromStores)([T.default], () => T.default.getGuild(null != N ? N : a.guild_id)), {
                        hasMoreAfter: O,
                        scrollDown: y,
                    ...
                    }, [D, M, g]), v = i.useMemo(() => (0, d.canUseContextMenuCommands)(a, G.length, s.getCommandTypeCount(a, e, null == m ? void 0 : m.applicationCommandCounts)), [a, e, G.length, null == m ? void 0 : m.applicationCommandCounts]);
                    i.useEffect(() => {
                        if (v !== h.current) {
                            if (v) null == A || A();
                            h.current = v
                    ...
                    let b = i.useCallback(t => {
                            O && t + 500 > 34 * G.length - 40 && y(), C.current = t
                        }, [O, y, G]),
                        L = i.useCallback(t => {
                            ...
                            let e = R[t.applicationId],
                                i = null != e ? (0, E.getIconComponent)(e) : void 0;
            ...
            function T(t, e, n) {
                let [u, c] = (0, i.useStateFromStoresArray)([s.default, l.default, o.default], () => {
                    let t = s.default.getChannelId(e),
                        ...
                        r = null != n && (n.isMultiUserDM() || o.default.can(f.Permissions.SEND_MESSAGES, n));
                    return [t, r]
                }, [e]), d = n === f.AppContext.POPOUT;
        ...
        459870: function(t, e, n) {
            ...
            function C(t, e) {
                let n = (0, i.useStateFromStores)([d.default], () => d.default.getChannels(e)[d.GUILD_VOCAL_CHANNELS_KEY], [e]),
                    C = (0, i.useStateFromStores)([S.default, c.default], () => {
                        let n = S.default.getUserVoiceChannelId(e, t.id);
                        return c.default.getChannel(n)
                    }, [e, t.id]),
                    m = (0, i.useStateFromStores)([f.default], () => f.default.isGuestOrLurker(e, t.id), [e, t.id]);
                if (m || null == C) return null;
                let O = t.id === s.default.getId();
                if (!O && !I.default.can(A.Permissions.MOVE_MEMBERS, C)) return null;
                let y = n.filter(e => {
                    let {
                        channel: n
                    } = e;
                    return n.id !== C.id && (O ? I.default.can(A.Permissions.CONNECT, n) && !(0, p.isChannelFull)(n, S.default, E.default) : I.default.can(A.Permissions.MOVE_MEMBERS, n) && (I.default.can(A.Permissions.CONNECT, n) || N.default.can({
                        permission: A.Permissions.CONNECT,
                        user: t,
                        context: n
                    })) && !(0, p.isChannelFull)(n, S.default, E.default))
                });
                return 0 === y.length ? null : (0, r.jsx)(a.MenuItem, {
                    id: "voice-move",

        ...
        278175: function(e, t, n) {
            ...
            var h = s.memo(function(e) {
                let {
                    ...
                    audio: m
                } = (0, d.useAudioTrimmerStore)(), I = null != m, p = s.useRef(null), g = s.useRef(null), S = s.useRef(null), [N, A] = s.useState(0), [v, C] = s.useState(0), [T, O] = s.useState(0), [L, R] = s.useState(!1), [M, D] = s.useState(!1), [b, U] = s.useState(!1), [y, P] = s.useState(0), [w, x] = s.useState(-1), F = s.useMemo(() => y / h.fineTuningScale, [h.fineTuningScale, y]);
                s.useEffect(() => {
                    if (null == m) return;
                ...
                return s.useEffect(() => {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            style: {
                                left: "".concat((0, c.getStartHandleValue)(N, w, F, y), "%"),
        ...
        527246: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                m = l.memo(function(e) {
                    ...
                    }, [n, m]), N = (0, f.useAudioBufferData)(t), A = (0, f.useAudioWaveformData)(N, g.current, S), v = (0, d.default)(), C = (0, c.useColorValue)((0, o.isThemeDark)(v) ? _.Color.PRIMARY_300 : _.Color.PRIMARY_700), T = null == N || null == A, O = 0 === I.width || 0 === I.height, L = (O || T) && null != t, R = l.useCallback(() => {
                        null != g.current && p({

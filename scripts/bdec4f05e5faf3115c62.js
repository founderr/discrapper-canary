    ...
    ["95664"], {
        ...
        527088: function(e, t, n) {
            ...
            function N(e) {
                ...
                let {
                    code: N,
                    message: M
                } = e, [v, O, x] = (0, i.useStateFromStoresArray)([p.default], () => [p.default.getApplication(N), p.default.isInvalidApplication(N), p.default.getApplicationFetchState(N)], [N]), L = (0, i.default)([u.default], () => u.default.locale), R = (0, i.default)([c.default], () => {
                    var e;
                ...
                if (null == v || x === p.FetchState.FETCHING) return (0, a.jsxs)(m.default, {
                    containerRef: U,
                    children: [(0, a.jsx)(m.default.Header, {
        ...
        315176: function(e, t, n) {
            ...
            async function p(e, t) {
                ...
                let M = (0, i.getInventoryGuildPacksUserExperimentConfig)({
                    ...
                    O = Object.keys(v).filter(I).map(e => l.default.getUsableGuildEmoji(e)).flat().filter(e => null == E.default.getEmojiUnavailableReason({
                        emoji: e,
                        channel: t,
                        guildId: T,
        ...
        649486: function(e, t, n) {
            ...
            function L(e) {
                let {
                    ...
                    onClose: n,
                    transitionState: a
                } = e, s = (0, m.useStateFromStores)([p.default], () => p.default.getCurrentUser()), r = (0, m.useStateFromStores)([h.default], () => h.default.theme), o = (0, m.useStateFromStores)([I.default], () => I.default.getFingerprint()), u = null == s || s.isClaimed(), [C, O] = i.useState(function() {
                    var e;
        ...
        858291: function(e, t, n) {
            ...
            function p(e) {
                ...
                } = e, x = (0, s.default)([o.default], () => o.default.getGuild(p), [p]), L = null == x ? void 0 : x.roles[null !== (t = null == n ? void 0 : n.role_id) && void 0 !== t ? t : ""], R = (0, l.useListingThumbnailUrl)(n, 600), P = (0, E.useProductType)(n), D = (0, d.useCanManageGuildProduct)(x), {
        ...
        699473: function(e, t, n) {
            ...
            var a = n("37983"),
                ...
                L = s.memo(function(e) {
                    ...
                    }), W = s.type === O.MessageTypes.REPLY ? s.messageReference : void 0, z = (0, o.useStateFromStores)([c.default], () => c.default.getMessageByReference(W)), Z = (0, r.useListItem)(s.id), J = (0, I.default)(s), X = (0, o.useStateFromStores)([f.default], () => s.hasFlag(O.MessageFlags.HAS_THREAD) && f.default.getChannel(s.id)), q = (0, d.useRoleIcon)({
                        guildId: j.guild_id,
                        roleId: J.iconRoleId
        ...
        723931: function(e, t, n) {
            ...
            class eL extends s.Component {
                ...
                renderCodedLinks(e) {
                    return 0 === e.codedLinks.length ? null : e.codedLinks.map(t => {
                        ...
                        if (n === g.CodedLinkType.INVITE) return this.shouldRenderInvite(s) ? (0, a.jsx)(em.default, {
                            code: s,
                            author: e.author,
                ...
                renderAttachments(e) {
                    ...
                    let l = t.filter(e => null == e.flags || !(0, ea.hasFlag)(e.flags, eT.MessageAttachmentFlags.IS_THUMBNAIL)),
                        ...
                        E = f.length > 1 ? (0, ee.createMediaOnClickOverrides)(f, m) : {},
            ...
            function eR(e) {
                ...
                } = e, u = (0, o.useStateFromStores)([V.default], () => V.default.getId()), d = w.InlineAttachmentMedia.useSetting(), c = w.InlineEmbedMedia.useSetting(), f = w.RenderEmbeds.useSetting(), m = f && !(0, eu.default)(e.message), E = w.RenderReactions.useSetting(), _ = w.GifAutoPlay.useSetting(), h = (0, o.useStateFromStores)([K.default], () => null == l.guild_id || K.default.canChatInGuild(l.guild_id), [l]), p = (0, o.useStateFromStores)([L.default], () => null != l.guild_id && L.default.isLurking(l.guild_id), [l]), T = (0, o.useStateFromStores)([Y.default], () => Y.default.isCurrentUserGuest(l.guild_id), [l]), g = (0, o.useStateFromStores)([Y.default, z.default], () => {
                    var e, t;
                ...
                }), [h, l]), [, S] = (0, N.useCurrentUserCommunicationDisabled)(l.guild_id), M = (0, H.useIsActiveChannelOrUnarchivableThread)(l), v = (u === i.author.id || A) && i.author.id !== eT.LOCAL_BOT_ID && !i.author.isClyde() && !1 !== r && !(0, ea.hasFlag)(i.flags, eT.MessageFlags.EPHEMERAL) && M, O = u === i.author.id && M, x = i.author.id === u, R = i.isFirstMessageInForumPost(l), D = (0, ed.default)({
                    channel: l,
                    canChat: h,
                    renderReactions: E,
                    canAddNewReactions: C,
            ...
            let eP = e => {
                ...
                let {
                    ...
                    ...f
                } = e, m = w.InlineAttachmentMedia.useSetting(), E = w.InlineEmbedMedia.useSetting(), _ = w.RenderEmbeds.useSetting() && !l.author.isClyde(), h = w.GifAutoPlay.useSetting(), p = (0, I.useShowImprovedMarkdownUserExperimentConfig)((null !== (t = l.editedTimestamp) && void 0 !== t ? t : l.timestamp).valueOf()), T = (0, I.useShowImprovedMarkdownGuildExperimentConfig)(null !== (n = i.guild_id) && void 0 !== n ? n : "", (null !== (s = l.editedTimestamp) && void 0 !== s ? s : l.timestamp).valueOf()), g = (0, P.default)(null == i ? void 0 : i.id);
                return (0, a.jsx)(eL, {
                    ...f,
                    message: l,
                    channel: i,
        ...
        994402: function(e, t, n) {
                ...
                P = e => {
                    let {
                        ...
                        if (t.hasFlag(N.MessageFlags.IS_VOICE_MESSAGE)) {
                            var l;
                            (0, m.logVoiceMessagePlaybackStarted)(t.id, null !== (l = n.duration_secs) && void 0 !== l ? l : null, a, t.author.id)
                        } else null == h || h(e, a, s)
                    }, [t, n.duration_secs, h]), ee = s.useCallback((e, a) => {
                        var s;
                        t.hasFlag(N.MessageFlags.IS_VOICE_MESSAGE) && (0, m.logVoiceMessagePlaybackEnded)(t.id, null !== (s = n.duration_secs) && void 0 !== s ? s : null, e, t.author.id, a)
                    }, [t, n.duration_secs]), et = s.useCallback(e => {
                        var n;
                        t.hasFlag(N.MessageFlags.IS_VOICE_MESSAGE) && (0, m.logVoiceMessagePlaybackFailed)(t.id, null !== (n = null == e ? void 0 : e.message) && void 0 !== n ? n : null)
                    }, [t]), en = s.useCallback(() => {
                    ...
                    }, [b, u, K, W, F, z, n, q, Q, w, V, H, d, J]), ea = s.useCallback(() => {
                        var e;
            ...
            var D = e => {
                ...
                let {
                    ...
                    width: _,
                    height: I
                } = l, p = (0, d.getObscureReason)(l, r), [T, g] = s.useState(void 0 !== p), C = c === S.MediaLayoutType.MOSAIC, N = !C && (null != _ && _ < 200 || null != I && I < 50), M = L(l, o);

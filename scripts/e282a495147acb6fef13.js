(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["38429"], {
                ...
                constructor(e = 36e5) {
                    ...
                    this.updateAvailable = !1, this.hasNativeUpdate = !1, this._callbacks = [], this._bootstrapper = null, this.checkForUpdates = function() {
                        ...
                        this._handleCheckingForUpdates(), a.default.get({
                            ...
                            if (null == e.body || "bee183f9a13bd3d69c74f7ebf248bb19477b6a76" === e.body.hash) return this._handleUpdateNotAvailable();
        ...
        180273: function(e, t, n) {
            ...
            var R = new C(r.default, {
                ...
                STREAM_START: function(e) {
                    ...
                    null != T[h.dropsQuestId] && T[h.dropsQuestId].isEnrolled || N ? g(h, _, i) : r.default.wait(async () => {
                        var e;
            ...
            var l = n("37983"),
                ...
                b = a.memo(function e(t) {
                    ...
                    return ea ? (0, l.jsx)(e, {
                        ...
                        channel: K,
                        hasThread: !1
                    }) : (_.default.isBlocked(x.author.id) ? h = P.default.Messages.BLOCKED_MESSAGE_COUNT : (0, p.isSpam)(x) && H && (h = P.default.Messages.HIDDEN_SPAM_MESSAGE_COUNT), void 0 !== h) ? (0, l.jsx)(F, {
                        className: j,
                        compact: b,
                        count: 1,
                        collapsedReason: h
        ...
        80649: function(e, t, n) {
            ...
            function v(e, t, n) {
                let l = t ? p.default.guildFilter : null,
                    a = t ? p.default.roleFilter : null,
                    s = t ? p.default.everyoneFilter : null,
                    i = null;
                null != e && null != l && (i = l === R.RecentMentionsFilters.ALL_SERVERS ? null : e.getGuildId()), r.default.fetchRecentMentions(n, R.MAX_MENTIONS_PER_FETCH, i, a, s)
            }
            ...
            function D(e) {
                let {
                    ...
                    badgeState: f,
                    closePopout: E
                } = e, S = (0, s.useStateFromStores)([_.default, h.default], () => _.default.getChannel(h.default.getChannelId())), {
                    messages: T,
                    hasMore: N,
                    loading: I,
                    guildFilter: A,
                    ...
                    messages: p.default.getMentions(),
                    hasMore: p.default.hasMore,
                    loading: p.default.loading,
                    guildFilter: p.default.guildFilter,
                    roleFilter: p.default.roleFilter,
                    everyoneFilter: p.default.everyoneFilter
                })), D = (0, u.default)(A), y = (0, u.default)(g), x = (0, u.default)(L);
                a.useEffect(() => {
                    if (!p.default.hasLoadedEver) {
                        v(S, !0);
                        return
                    }(null != D && A !== D || null != y && g !== y || null != x && L !== x) && v(S, !0)
                }, [D, A, y, g, x, L, S, !0]);
                a.useEffect(() => {
                    d.AttachmentLinkRefreshExperiment.getCurrentConfig({
                        location: "mentions"
                    }).enabled && (null == T ? void 0 : T.some(c.messageHasExpiredAttachmentUrl)) && (r.default.clearMentions(), v(S, !0))
                }, []), a.useEffect(() => () => {
                    r.default.truncateMentions(R.MAX_MENTIONS_PER_FETCH)
                }, []);
                let b = a.useCallback(() => (0, l.jsx)(C.default, {
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsxs)(o.TabBar, {
                            ...
                            children: [(0, l.jsxs)(o.TabBar.Item, {
                                ...
                                children: [p.default.Messages.FOR_YOU, (null == h ? void 0 : h.badgeForYou) ? (0, l.jsx)(T.CircleBadge, {
        ...
        609023: function(e, t, n) {
            ...
            function L(e) {
                ...
                let {
                    ...
                    autoTrackExposure: !1
                }), m = h.MessageDisplayCompact.useSetting(), M = (0, o.useStateFromStores)([T.default], () => T.default.can(g.Permissions.CREATE_INSTANT_INVITE, s)), L = (0, E.isSpamSupported)(s), v = !1, D = 0 === a.messages.length || a.messages[0].timestamp.isSame(i(), "day"), y = null !== (n = null === (t = N.default.getUser(S.default.getId())) || void 0 === t ? void 0 : t.hasFlag(g.UserFlags.SPAMMER)) && void 0 !== n && n, P = [];
                if (!a.collapsed) {
                    let e = null,
                        t = null,
        ...
        385730: function(e, t, n) {
            ...
            function O(e) {
                let {
                    ...
                    closePopout: O,
                    badgeState: v
                } = e, D = a.useRef(null), [y, P] = (0, g.default)(D), {
                    loadState: x,
                    channels: U
                } = y, {
                    maybeLoadMore: b,
        ...
        833150: function(e, t, n) {
            ...
            function p(e) {
                ...
                }), c = (0, S.dateFormat)(i(t.created_at), "LT"), f = a.useRef(null), p = (0, d.default)(f);
                return a.useEffect(() => {
        ...
        788072: function(e, t, n) {
            ...
            function T(e) {
                let {
                    ...
                    badgeState: n,
                    closePopout: s
                } = e, T = (0, r.useStateFromStores)([d.default], () => d.default.getInvites()), [N, p] = a.useMemo(() => i.partition(T, e => {
                ...
                return (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsx)(f.default, {
                        ...
                        children: (0, l.jsxs)("div", {
                            ...
                            children: [N.length > 0 && (0, l.jsxs)(l.Fragment, {
                    ...
                    [j.SearchAutocompleteGroups.HISTORY]: {
                        ...
                        component: function(e) {
                            let {
                                ...
                                let t = b.tokenizeQuery(e).map((e, t, n) => b.filterHasAnswer(e, n[t + 1]) ? e : new N.Token(e.getFullMatch(), N.NON_TOKEN_TYPE));
                                return t
        ...
        600133: function(e, t, n) {
            ...
            let eU = [ep.NoticeTypes.QUARANTINED, ep.NoticeTypes.AUTOMOD_QUARANTINED_USER_PROFILE, ep.NoticeTypes.VIEWING_ROLES, ep.NoticeTypes.INVITED_TO_SPEAK, ep.NoticeTypes.LURKING_GUILD, ep.NoticeTypes.VOICE_DISABLED, ep.NoticeTypes.NO_INPUT_DETECTED, ep.NoticeTypes.HARDWARE_MUTE, ep.NoticeTypes.H264_DISABLED, ep.NoticeTypes.DISPATCH_ERROR, ep.NoticeTypes.DISPATCH_INSTALL_SCRIPT_PROGRESS, ep.NoticeTypes.SPOTIFY_AUTO_PAUSED, ep.NoticeTypes.DROPS_PROGRESS_INTERRUPTION, ep.NoticeTypes.WIN32_DEPRECATED_MESSAGE, ep.NoticeTypes.BLOCKED_BY_PROXY, ep.NoticeTypes.VOICE_CONNECTED_LAST_SESSION, ep.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION, ep.NoticeTypes.GUILD_RAID_NOTIFICATION, ep.NoticeTypes.ESLATAM_LANGUAGE_LAUNCH, ep.NoticeTypes.UNCLAIMED_ACCOUNT, ep.NoticeTypes.POMELO_ELIGIBLE, ep.NoticeTypes.PENDING_MEMBER, ep.NoticeTypes.OUTBOUND_PROMOTION, ep.NoticeTypes.CORRUPT_INSTALLATION, ep.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER, ep.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK, ep.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, ep.NoticeTypes.STREAMER_MODE, ep.NoticeTypes.SCHEDULED_MAINTENANCE, ep.NoticeTypes.BOUNCED_EMAIL_DETECTED, ep.NoticeTypes.UNVERIFIED_ACCOUNT, ep.NoticeTypes.PREMIUM_TIER_2_TRIAL_ENDING, ep.NoticeTypes.PREMIUM_TIER_0_TRIAL_ENDING, ep.NoticeTypes.PREMIUM_UNCANCEL, ep.NoticeTypes.PREMIUM_MISSING_PAYMENT, ep.NoticeTypes.PREMIUM_PAST_DUE_INVALID_PAYMENT, ep.NoticeTypes.PREMIUM_PAST_DUE_MISSING_PAYMENT, ep.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, ep.NoticeTypes.PREMIUM_REACTIVATE, ep.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION, ep.NoticeTypes.MFA_SMS_BACKUP, ep.NoticeTypes.APPLICATION_TEST_MODE, ep.NoticeTypes.LOCALIZED_PRICING, ep.NoticeTypes.DOWNLOAD_NAG, ep.NoticeTypes.CONNECT_SPOTIFY, ep.NoticeTypes.CONNECT_PLAYSTATION, ep.NoticeTypes.SURVEY, ep.NoticeTypes.SERVER_USAGE_SURVEY, ep.NoticeTypes.SAFETY_USER_SENTIMENT_NAGBAR, ep.NoticeTypes.DROPS_GO_LIVE_BANNER, ep.NoticeTypes.DROPS_ENDED_INCOMPLETE, ep.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR],
                ...
                eF = {
                    [ep.NoticeTypes.GUILD_RAID_NOTIFICATION]: {
                        predicate: () => (0, A.shouldShowRaidNotificationNagbar)().show && !ex(ep.NoticeTypes.GUILD_RAID_NOTIFICATION),
                        metadata: () => {
                            let e = {
                    ...
                    [ep.NoticeTypes.BLOCKED_BY_PROXY]: {
                        predicate: () => !ex(ep.NoticeTypes.BLOCKED_BY_PROXY) && b.default.blockedByProxy && U.default.getCurrentConfig({
                    ...
                    [ep.NoticeTypes.DOWNLOAD_NAG]: {
                        predicate: () => !e_.isPlatformEmbedded && !ex(ep.NoticeTypes.DOWNLOAD_NAG)
                    },
                    ...
                    [ep.NoticeTypes.CONNECT_SPOTIFY]: {
                        predicate: () => !j.default.hasConnectedAccount() && $.default.isObservedAppRunning(f.default.get(ep.PlatformTypes.SPOTIFY).name) && !ex(ep.NoticeTypes.CONNECT_SPOTIFY)
                    },
                    ...
                    [ep.NoticeTypes.PREMIUM_REACTIVATE]: {
                        predicate: () => !ex(ep.NoticeTypes.PREMIUM_REACTIVATE) && D.default.shouldShowReactivateNotice()
                    },
                    ...
                    [ep.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
                        ...
                        metadata: e => {
                            let {
                                premiumSubscription: t
                            } = e, n = (null == t ? void 0 : t.status) === ep.SubscriptionStatusTypes.PAST_DUE ? a().diff(a(t.currentPeriodStart), "days") : 0, l = a(null == t ? void 0 : t.currentPeriodStart).add((0, eh.getBillingGracePeriodDays)(t), "days").toDate();
                            return {
                                daysPastDue: n,
                                dismissUntil: l
                            }
                    ...
                    [ep.NoticeTypes.DROPS_GO_LIVE_BANNER]: {
                        predicate: () => !ex(ep.NoticeTypes.DROPS_GO_LIVE_BANNER) && (0, S.isDismissibleContentDismissed)(r.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP) && !(0, S.isDismissibleContentDismissed)(r.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP) && (0, N.getShowDropsNoticeBanner)(em.PartnerGame.FORTNITE),
                        metadata: () => ({
                    ...
                    [ep.NoticeTypes.POMELO_ELIGIBLE]: {
                        predicate: () => (0, v.isEligibleForPomelo)() && !ex(ep.NoticeTypes.POMELO_ELIGIBLE)
                    },
                    [ep.NoticeTypes.DROPS_ENDED_INCOMPLETE]: {
                        predicate: () => !ex(ep.NoticeTypes.DROPS_ENDED_INCOMPLETE) && (0, S.isDismissibleContentDismissed)(r.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP) && !(0, S.isDismissibleContentDismissed)(r.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP) && (0, N.getShowDropsEndedIncompleteBanner)(em.PartnerGame.FORTNITE),
                        metadata: () => ({
                            partnerGame: em.PartnerGame.FORTNITE
                        })
                    },
                    [ep.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
                        predicate: e => {
                            ...
                            return null != t && null != R.default.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(ep.GuildFeatures.COMMUNITY)) && !ex(ep.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
                        },
                        metadata: e => {
                            let {
                                selectedGuildId: t
                    ...
                    [ep.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION]: {
                        predicate: () => !ex(ep.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== h.default.getEligibleGuildsForNagActivate().length && (0, _.isCreatorMonetizationNagActivateEnabled)()
                    },
                    [ep.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR]: {
                        predicate: e => {
                            let {
                            ...
                            return !ex(ep.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR) && null != t && (0, M.shouldShowGuildOnboardingUpsell)(t, r.DismissibleContent.GUILD_ONBOARDING_UPSELL_NAGBAR)
                        }
                    },
                    ...
                    [ep.NoticeTypes.ESLATAM_LANGUAGE_LAUNCH]: {
                        predicate: () => d.ESLatamLaunchExperiment.getCurrentConfig({
                            location: "notice_store"
                        }).enabled && !ex(ep.NoticeTypes.ESLATAM_LANGUAGE_LAUNCH)
                    }
                };
            ...
            class ek extends s.default.Store {
                initialize() {
                    this.syncWith([ea.default, Z.default, K.default, et.default, x.default, ec.default, B.default, Y.default, k.default, g.default], ej), this.waitFor(ei.default, en.default, z.default, Q.default, J.default, W.default, el.default, p.default, et.default, es.default, j.default, $.default, Z.default, eS.default, eT.default, eE.default, q.default, ed.default, eN.default, K.default, eu.default, X.default, x.default, ef.default, ec.default, Y.default, L.default, T.default, h.default, b.default)
                }
                hasNotice() {

    ...
    ["6843"], {
        ...
        752598: function(e, t, n) {
            ...
            let I = async e => {
                ...
                await d.default.unarchiveThreadIfNecessary(E), (0, f.addQueued)(I, {
                    messageId: n,
                    data: {
            ...
            let _ = (e, t) => {
                ...
                let i = null == t ? void 0 : t.state,
                    s = e.state === S.MessageStates.SENT && h(e.id) < Date.now();
        ...
        307367: function(e, t, n) {
            ...
            function h(e) {
                let {
                    ...
                    contextMetadata: T
                } = (0, u.usePaymentContext)(), [_, A] = r.useState(!1);
                return r.useEffect(() => {
                    var e;
                    !_ && (A(!0), (0, l.startBrowserCheckout)(T.loadId), ! function(e, t, n, i) {
                    ...
                    }(null !== (e = null == n ? void 0 : n.id) && void 0 !== e ? e : S.SubscriptionPlans.PREMIUM_MONTH_TIER_2, h, T.loadId, () => t(d.Step.ADD_PAYMENT_STEPS)))
                }, [n, h, _, A, T, t]), r.useEffect(() => {
                    C === T.loadId && I === f.BrowserCheckoutState.DONE && t(d.Step.CONFIRM)
                }, [I, C, T, t]), (0, i.jsxs)(i.Fragment, {
        ...
        992049: function(e, t, n) {
            ...
            function m(e) {
                ...
                s(null != P, "Expected plan to selected"), s(null != N, "Expected selectedSkuId"), s(null != v, "Step should be set");
                let O = r.useCallback(() => {
                        m(), null == h || h()
                    }, [m, h]),
                    {
                    ...
                    [F, w] = r.useState();
                return r.useEffect(() => {
                    if (!A || null == L || null == b || D || U || (0, d.isCustomGiftEnabled)(L)) return;
                    let e = o.AutomatedGiftCodeMessageExperiment.getCurrentConfig({
                        location: "36b986_1"
                    }).enabled;
                    e && (k(!0), (0, l.sendGiftMessage)(L, b).then(() => {
                        k(!1), null == h || h(), j(!0)
                    }).catch(e => {
                        k(!1), w(e), j(!0)
                    }))
                }, [A, L, b, D, j, k, U, w, h]), a = null != I ? I(P, O, M) : A ? (0, i.jsx)(u.PremiumSubscriptionGiftPurchaseConfirmation, {
                    planId: P.id,
                    selectedGiftStyle: x,
                    onClose: O,
                    hasSentMessage: D,
                    giftMessageError: F,
                    isSendingMessage: U
                }) : R.current === P.id ? (0, i.jsx)(u.default, {
                    planId: P.id,
                    postSuccessGuild: C,
                    onClose: O,
                    ...
                    planId: P.id,
                    onClose: O,
                    isDowngrade: null != _ && (0, c.subscriptionCanDowngrade)(_, P.id, S),
        ...
        646139: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                R = n("646718"),
                O = n("782340");
            let L = [m.Step.PLAN_SELECT, m.Step.ADD_PAYMENT_STEPS, m.Step.REVIEW, m.Step.CONFIRM];
            ...
            function b(e) {
                ...
                let {
                    giftRecipient: B,
                    step: G
                } = (0, E.usePaymentContext)(), H = (0, p.isCustomGiftEnabled)(B) && G === m.Step.PLAN_SELECT;
            ...
            function j(e) {
                let {
                    ...
                    selectedSkuId: s,
                    isGift: l
                } = (0, E.usePaymentContext)(), o = (0, M.default)({
                    isGift: l,
                    skuId: s,
                    referralTrialOfferId: r
                }), u = D(o);
            ...
            let U = [{
                ...
                options: {
                    ...
                    useBreadcrumbLabel: e => {
                        let t = D(e);
                        return t ? null : O.default.Messages.BILLING_STEP_SELECT_PLAN
                    }
                }
            }, {
                ...
                options: {
                    ...
                    useBreadcrumbLabel: e => {
                        let t = D(e);
                        return t ? null : O.default.Messages.BILLING_STEP_PAYMENT
                    }
                }
            }, {
                ...
                key: m.Step.REVIEW,
                renderStep: e => (0, i.jsx)(_.PaymentModalReviewStep, {
                    ...e
                }),
                options: {
                    renderHeader: !0,
                    useBreadcrumbLabel: e => {
                        let t = D(e);
                        return t ? O.default.Messages.BILLING_STEP_PLAN_AND_PAYMENT : O.default.Messages.BILLING_STEP_REVIEW
                    }
                }
            }, {
                key: m.Step.CONFIRM,
            ...
            function k(e) {
                ...
                if (null != r && !Object.values(R.PremiumSubscriptionSKUs).includes(r)) throw Error("subscriptionTier must be a premium subscription");
                return (0, i.jsx)(n, {
        ...
        97461: function(e, t, n) {
            ...
            function j(e) {
                ...
                let eu = el && eo && X && J === L.PremiumSubscriptionSKUs.TIER_2,
                    ed = null != Q ? q[Q] : null,
                    {
                        newPlans: ec
                    ...
                    ef = (0, l.default)([I.default], () => I.default.getCurrentUser()),
                    ep = !X && null != J && J === L.PremiumSubscriptionSKUs.TIER_2 && null != ef && ef.hasHadPremium() && z && null == Z && (0, d.isPaymentSourceEligibleForMultiMonthPlans)(ed),
                    eE = (0, m.usePremiumTrialOffer)(B),
                    em = !X && null != eE && null != J && (0, L.SubscriptionTrials)[eE.trial_id].skus.includes(J),
                    eS = (0, E.usePremiumDiscountOffer)(),
                    eh = null == eS ? void 0 : null === (t = eS.discount) || void 0 === t ? void 0 : t.plan_ids.some(e => L.SubscriptionPlanInfo[e].skuId === J),
                    eI = !X && null != eS && null != J && eh,
                    eC = null !== (n = em || eI) && void 0 !== n && n,
                    {
                        defaultToMonthlyPlan: eT
                    } = p.TrialRedemptionDefaultPlanExperiment.useExperiment({
                        location: "d17fd6_4"
                    }, {
                        autoTrackExposure: !1
                    }),
                    e_ = r.useMemo(() => (0, y.getPremiumPlanOptions)({
                        skuId: J,
                        isPremium: ei,
                        ...
                        defaultPlanId: et,
                        defaultToMonthlyPlan: eT
                    }), [J, ei, ec, Z, ep, X, em, et, eT]),
                    eA = eI && e_.includes(L.SubscriptionPlans.PREMIUM_MONTH_TIER_2) ? L.SubscriptionPlans.PREMIUM_MONTH_TIER_2 : e_[0],
                    ey = (0, l.default)([C.default], () => C.default.get(eA)),
                    eg = [{
                        planId: null == ey ? void 0 : ey.id,
                        quantity: 1
                    }],
                    [eP, eN] = r.useState(eC),
                    [ev, eM] = (0, c.useSubscriptionInvoicePreview)({
                        items: eg,
                        renewal: !1,
                        preventFetch: !eC,
                        applyEntitlements: !0,
                ...
                r.useEffect(() => {
                    if (eC) eN((null == ev ? void 0 : ev.subscriptionPeriodEnd) == null)
                }, [ev, eC]), (0, u.default)("Payment Modal Plan Select Step", eP, 5, {
                ...
                let ex = null !== (a = null == eM ? void 0 : eM.message) && void 0 !== a ? a : b.default.Messages.ERROR_GENERIC_TITLE,
                    eR = eC && null == eM,
                    eO = eC && null != eM;
                return eR && (null == ev ? void 0 : ev.subscriptionPeriodEnd) == null ? (0, i.jsx)(v.default, {}) : (s(null != ee, "Step should be set"), s(e_.length > 0, "Premium plan options should be set"), (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsx)(x.GiftNote, {
                        giftMessage: j
                    }), !(0, _.isCustomGiftEnabled)(es) && (0, i.jsx)(N.default, {
                        isEligibleForTrial: em
                    }), (0, i.jsxs)(M.PaymentPortalBody, {
                        children: [eR && (0, i.jsx)("hr", {
                            className: D.planSelectSeparatorUpper
                        }), (0, i.jsx)(S.default, {
                            isGift: X,
                            plan: $
                        }), (0, i.jsx)(R.default, {}), eO ? (0, i.jsx)(o.FormErrorBlock, {
                            children: ex
                        }) : (0, i.jsx)(h.PremiumSwitchPlanSelectBody, {
                            isGift: X,
                            selectedGiftStyle: er,
                            setSelectedGiftStyle: ea,
                            planOptions: e_,
                            ...
                            setEmojiConfetti: Y,
                            setSoundEffect: K,
                            discountInvoiceItems: eI ? null == ev ? void 0 : ev.invoiceItems : void 0
                            ...
                            children: [(0, i.jsx)("hr", {
                                ...
                                children: b.default.Messages.BILLING_TRIAL_CANCEL_ANYTIME_LINK.format({
                                    link: A.default.getArticleURL(O.HelpdeskArticles.PREMIUM_DETAILS_CANCEL_SUB)
                                })
                            })]
                        })]
                        ...
                        children: (0, i.jsx)(o.ModalFooter, {
                            ...
                            children: (0, i.jsx)(h.PremiumSwitchPlanSelectFooter, {
                                onStepChange: U,
                                isGift: X,
                                onBackClick: () => U(P.Step.SKU_SELECT),
                                showBackButton: null == k && null == F,
                                planOptions: e_,
        ...
        403365: function(e, t, n) {
            ...
            function S(e) {
                let {
                    ...
                    setSelectedPlanId: S
                } = (0, u.usePaymentContext)(), I = (0, a.usePremiumTrialOffer)(r);
                return (0, i.jsx)(h, {
        ...
        498475: function(e, t, n) {
            ...
            function S(e) {
                let {
                    ...
                    isGift: C,
                    startedPaymentFlowWithPaymentSourcesRef: T
                } = (0, c.usePaymentContext)(), _ = null != S ? (0, d.getPremiumPlanItem)(S) : null, A = null != _ ? (0, d.getDisplayPremiumType)(_.planId) : null, y = null != _ ? (0, d.getPremiumType)(_.planId) : null, g = (0, p.inOneStepSubscriptionCheckout)({
                    isTrial: !1,
                    isGift: C,
                    selectedSkuId: h,
                    startedPaymentFlowWithPaymentSources: T.current
                ...
                return a(null != y, "Expected premium type"), (0, i.jsx)(u.default, {
                    ...
                    footer: (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(l.Button, {
                            onClick: () => {
                                if (g) {
                                    let e = (0, p.getDefaultPlanOneStepCheckout)(h, S);
                                    I(e), t(f.Step.REVIEW)
        ...
        967241: function(e, t, n) {
            ...
            function A(e, t, n) {
                ...
                let i = !s.isEmpty(h.default.getVoiceStatesForChannel(e.id));
            ...
            class p extends r.PureComponent {
                ...
                renderInput(e) {
                    ...
                    return (0, i.jsx)("input", {
                        className: s((0, o.getClass)(c, "input", r), {
                            [c.inputHidden]: e
                        }),
                        ref: this.inputRef,
                        type: "text",
                        ...
                        children: (0, i.jsx)("div", {
                            ...
                            children: (0, i.jsxs)(u.default, {
                                ...
                                children: [(0, i.jsxs)(u.default, {
                                    ...
                                    children: [this.renderInput(E), E ? (0, i.jsx)("div", {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["27405"], {
        ...
        523360: function(e, t, _) {
            ...
            function s(e) {
                ...
                let {
                    ...
                    transitionState: s,
                    onClose: u
                } = e, A = (0, a.useStateFromStores)([r.default], () => r.default.getEULA(_));
                i.useEffect(() => {
                    (0, l.fetchEULA)(_)
                }, [_]);
                ...
                return (0, E.jsxs)(n.ModalRoot, {
                    ...
                    "aria-label": O,
                    children: [(0, E.jsxs)(n.ModalHeader, {
        ...
        784736: function(e, t, _) {
            ...
            n.displayName = "EULAStore";
            var l = new n(i.default, {
                            ...
                            return (0, i.jsx)(I.LazyLibrary, {
                                ...
                                render: t => {
                                    if (!(e.lang && t.hasLanguage(e.lang)) || "string" != typeof e.content) return a();
                                    {
                                        ...
                                        return null == _ ? a() : (0, i.jsx)("pre", {
                                            children: (0, i.jsx)("code", {
                                                className: l(A.scrollbarGhostHairline, "hljs", _.language),
            ...
            class m extends a.PureComponent {
                render() {
                    let {
                        ...
                        parser: E,
                        output: a
                    } = this.props, n = "".concat(t, "\n\n"), r = E(n, {
                        inline: !1,
                        ..._
                    }), o = a(r);
                    return (0, i.jsx)("div", {
                        className: l(u.markdown, e),
                        children: o
                    })
                }
            }
        ...
        306160: function(e, t, _) {
            ...
            function l(e) {
                return !!n && (i.isPlatformEmbedded ? (a.default.copy(e), !0) : E.copy(e))
            }
        },

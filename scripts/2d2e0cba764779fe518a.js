    ...
    [41609, 97264, 30527], {
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = i(e),
                    ...
                    y = h.length;
                for (var b in e) !t && !s.call(e, b) || d && ("length" == b || f && ("offset" == b || "parent" == b) || p && ("buffer" == b || "byteLength" == b || "byteOffset" == b) || l(b, y)) || h.push(b);
                return h
            }
        },
        70151: (e, t, n) => {
        ...
        444663: (e, t, n) => {
            ...
            function x(e) {
                ...
                t = C ? E.Z.Messages.UPLOAD_AREA_PREMIUM_TIER_UPSELL_BODY_LINE_2.format({
                ...
                var P = o.useMemo((function() {
                        var e = h.ZP.getUserMaxFileSize(w),
                            t = (0, d.BU)(e / 1024, {
                                useKibibytes: !0
                            }),
                        ...
                        switch (null == w ? void 0 : w.premiumType) {
                            case _.p9.TIER_0:
                ...
                return (0, r.jsx)(g.Z, function(e) {
                    ...
                    onClose: n,
                    subscriptionTier: C ? _.Si.TIER_0 : _.Si.TIER_2,
                    isLoading: x
                }, l))
            }
            var S = n(443812),
            ...
            function P(e) {
                ...
                return o ? (0, r.jsx)(x, {
                    ...
                    transitionState: i,
                    children: (0, r.jsx)("div", {
                        className: a()(w().uploadDropModal, w().error),
        ...
        755550: (e, t, n) => {
            ...
            var A = function(e) {
                ...
                r.hasPendingChanges = function() {
                    return void 0 !== f || void 0 !== p || void 0 !== d || void 0 !== h || void 0 !== y
                };
        ...
        597264: (e, t, n) => {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(Z, {
                        ...
                        children: [A(t) && (0, r.jsx)(a.TooltipContainer, {
                            ...
                            text: S.Z.Messages.PROFILE_CUSTOMIZATION_NITRO_ICON_TOOLTIP,
                            children: o && (0, r.jsx)(_.Z, {
                                className: w().nitroWheelFlair
                            })
                        }), S.Z.Messages.SELECT_IMAGE_MODAL_CHOOSE_GIF]
                    })]
                })
            }
            ...
            function G(e) {
                var t = e.transitionState,
                    ...
                    G = e.modalTitle,
                    H = void 0 === G ? S.Z.Messages.SELECT_IMAGE_MODAL_TITLE : G,
                    V = e.uploadOptionTitle,
                    Y = void 0 === V ? S.Z.Messages.UPLOAD_IMAGE : V,
                    z = function(e, t) {
                ...
                o.useEffect((function() {
                    ee && v.default.track(E.rMx.PREMIUM_UPSELL_VIEWED, {
            ...
            var r = n(318715),
                ...
                f = function() {
                    var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
                        ...
                        h = p.showTryPacksModalAndV2Copy,
                        y = p.collectEnabled,
                        b = d && y && null != o && !1 !== (null == o || null === (e = o.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible);
                    return {
                        viewAndUseEnabled: d,
                        collectEnabled: b,
        ...
        245325: (e, t, n) => {
            ...
            function f(e) {
                ...
                var b = n.useExperiment({
                    ...
                    j = s.p9.TIER_2;
                if (h) {
                    var x = d.subscription_trial;
                    (null == x ? void 0 : x.sku_id) === s.Si.TIER_0 ? j = s.p9.TIER_0 : (null == x ? void 0 : x.sku_id) === s.Si.TIER_2 && (j = s.p9.TIER_2)
                } else if (!y && !A && g)
                    if (_) {
                        j = function(e, t, n) {
        ...
        442212: (e, t, n) => {
            ...
            function A(e) {
                ...
                o.useEffect((function() {
                    Y || (X ? f.default.track(g.rMx.PREMIUM_GUILD_UPSELL_VIEWED, {
                        type: "".concat(v, " - Tier ").concat(E.boostedGuildTier),
                        guild_id: E.guild.id,
                ...
                var Q, ee = B ? a()(m().artContainer, m().artContainerBoxShadow, I) : a()(m().artContainer, I),
                    te = null;
                        ...
                        children: Y ? (0, r.jsx)(l.Spinner, {}) : (0, r.jsx)(r.Fragment, {
                            children: q ? (0, r.jsx)(r.Fragment, {
                                children: (0, r.jsx)(y.ZP, {
                                    onClose: N,
                                    type: v,
                                    subscriptionTier: null !== (Q = null == J || null === (n = J.subscription_trial) || void 0 === n ? void 0 : n.sku_id) && void 0 !== Q ? Q : b.Si.TIER_2,
                                    headingText: i,
                                    context: S,
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [null != k ? (0, r.jsx)(l.Button, {
                                ...
                                var n = q ? (0, p.Rt)({
                                    ...
                                    o = q ? null == J ? void 0 : J.trial_id : null;
                                return (0, r.jsx)(h.Z, {
            ...
            function i(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: i,
                        round: a
                    } = Math, l = e[0] | e[1] << 8 | e[2] << 16, c = e[3] | e[4] << 8, s = (63 & l) / 63, u = (l >> 6 & 63) / 31.5 - 1, f = (l >> 12 & 63) / 31.5 - 1, p = (l >> 18 & 31) / 31, d = l >> 23, h = (c >> 3 & 63) / 63, y = (c >> 9 & 63) / 63, b = c >> 15, g = o(3, b ? d ? 5 : 7 : 7 & c), _ = o(3, b ? 7 & c : d ? 5 : 7), v = d ? (15 & e[5]) / 15 : 1, m = (e[5] >> 4) / 15, E = d ? 6 : 5, O = 0, T = (t, n, r) => {
                        let o = [];
                        for (let i = 0; i < n; i++)
                            for (let a = i ? 0 : 1; a * n < t * (n - i); a++) o.push(((e[E + (O >> 1)] >> ((1 & O++) << 2) & 15) / 7.5 - 1) * r);
                        return o
                    }, A = T(g, _, p), j = T(3, 3, 1.25 * h), x = T(3, 3, 1.25 * y), S = d && T(5, 5, m), C = r(e), w = a(C > 1 ? 32 : 32 * C), I = a(C > 1 ? 32 / C : 32), P = new Uint8Array(w * I * 4), L = [], N = [];
                    for (let e = 0, r = 0; e < I; e++)
                        for (let a = 0; a < w; a++, r += 4) {
                            let l = s,
                                c = u,
                                p = f,
                                h = v;
                            for (let e = 0, n = o(g, d ? 5 : 3); e < n; e++) L[e] = i(t / w * (a + .5) * e);
                            for (let n = 0, r = o(_, d ? 5 : 3); n < r; n++) N[n] = i(t / I * (e + .5) * n);
                            for (let e = 0, t = 0; e < _; e++)
                                for (let n = e ? 0 : 1, r = 2 * N[e]; n * _ < g * (_ - e); n++, t++) l += A[t] * L[n] * r;
                            ...
                            if (d)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * N[e]; n < 5 - e; n++, t++) h += S[t] * L[n] * r;
                            let y = l - 2 / 3 * c,
                                b = (3 * l - y + p) / 2,
                                m = b - p;
                            P[r] = o(0, 255 * n(1, b));

        ...
        796909: (e, t, n) => {
            ...
            function F() {
                ...
                (0, c.cn)() && (0, s.x7)() && v.Z.getAddedToMessages().forEach((function(e) {
                    ...
                    null != t && (0, p.zi)(t.type) && C.set(t.id, w(t))
                }))
            }

            function P() {
                var e = h.Z.getMutablePrivateChannels();
                for (var t in e) C.set(t, w(e[t]))
            }
            var j, Z, N, U = (j = [], Z = [], N = [], function() {
                    var e = C.values(A.FAVORITE),
                        t = C.values(A.DEFAULT);
                    if (j !== e || Z !== t) {
                        N = [];
                ...
                L = function(e) {
                    ...
                    r.initialize = function() {
                        ...
                        this.syncWith([v.Z, f.Z], F)
                    };
                    r.getPrivateChannelIds = function() {
                        return U()
                    };
                    r.getSortedChannels = function() {
                        return [C.values(A.FAVORITE), C.values(A.DEFAULT)]
                    };
            ...
            const x = new L(a.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, p.hv)(e.type) || C.has(e.id)) && C.set(e.id, w(e))
                    }))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && C.set(t, w(r, n.id))
                },

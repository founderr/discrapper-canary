(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["24878"], {
        ...
        736978: function(e, t, n) {
            ...
            S.ErrorCodes = l, S.Fields = i, S.Sections = s, S.CARD_ERRORS = N, S.ADDRESS_ERRORS = p;
            var m = S
        },
        ...
        310688: function(e, t, n) {
            ...
            var eI = i.forwardRef(function(e, t) {
                ...
                } = (0, p.default)(T.default.INSTANT_INVITE_MODAL), W = (0, _.useStateFromStores)([y.default, G.default], () => {
                    let e = G.default.getVoiceChannelId();
                    if (null == e) return null;
                    let t = y.default.getChannel(e);
                    return (null == t ? void 0 : t.guild_id) === u.id ? t : null
                }), Y = null != W && !(0, S.default)(W) && [ei.InstantInviteSources.GUILD_CONTEXT_MENU, ei.InstantInviteSources.GUILD_HEADER].includes(d), K = (0, O.default)(u.id), Z = (0, _.useStateFromStores)([G.default, y.default, x.default], () => {
                ...
                let ee = null != o ? o.getGuildId() : null != u ? u.id : null,
                    et = (0, _.useStateFromStores)([P.default], () => {
                        let e = null != J ? J.id : null;
                        return null == e ? null : P.default.getInvite(e, {
                            targetType: $,
                            targetUserId: f,
                    ...
                    ed = (0, _.useStateFromStores)([b.default], () => null != J && b.default.can(ei.Permissions.CREATE_INSTANT_INVITE, J), [J]),
                    eI = null === et || !ed,
                    [eh] = i.useState(() => {
                        let e = new Set;
                ...
                let [eT] = (0, A.default)(null != I ? [I] : []), ep = (0, v.default)({
                    guildId: ee
                }), eA = null != et ? et.code : void 0, eS = null == et ? void 0 : et.maxAge, em = null == et ? void 0 : et.maxUses, ev = null == et ? void 0 : et.temporary, eC = u.vanityURLCode, eR = null != eC && eC.length > 0, {
                    enabled: eL
                ...
                let [eU, ey] = i.useState({
                    query: "",
                    maxAge: null !== (a = null != eS ? eS : ep) && void 0 !== a ? a : eE.value,
                    savedMaxAge: eS === ec.value ? null != ep ? ep : eE.value : ec.value,
                ...
                }, [eU.currentPage, ex]), ew = (eD || Y) && M !== el.InstantInviteModalPages.GUEST && !eO && !eI && !eM, {
                    enabled: eb
                    ...
                    e === el.InstantInviteModalPages.SETTINGS && null != t ? eP(t) : C()
                }, [eP, eU, C]), ej = i.useCallback(() => {
                ...
                }, [eO, J, d, null == eT ? void 0 : eT.id, $, f, eF, eG, eV, V, ex, eB]), ek = (0, N.default)(J), eW = (0, N.default)(V), eY = ek !== J, eK = eW !== V;
                return i.useEffect(() => {
                    (eY || eK) && ej()
                }, [ej, eY, eK]), (0, l.jsx)(j, {
                    children: (0, l.jsx)(ef, {
                        ...
                        shouldHideTemporaryInviteToggle: eb && ew || M === el.InstantInviteModalPages.GUEST,
                        modalState: eU,
                        setModalState: ex,
                        changePage: eP,
        ...
        235004: function(e, t, n) {
            ...
            var D = new O(o.default, {
                LOGOUT: function() {
                    g.clear(), N.clear(), m.clear(), v = !1, A = 0, p = 0
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    g.set(f.DEFAULT_SOUND_GUILD_ID, t), p = 2
                },
        ...
        19766: function(e, t, n) {
            ...
            function R(e, t, n) {
                let l = n === f.default.getId(),
                    ...
                    r = l ? p.default.getStatus() : T.default.getStatus(n, e),
                    s = l ? p.default.getActivities() : T.default.getActivities(n, e),
                    a = _.default.getStreamForUser(n, e),
                    o = A.default.getUser(n);
                return null == o ? null : {
                    type: "MEMBER",
            ...
            class P extends d.default.Store {
                initialize() {
                    this.waitFor(A.default, N.default, I.default, g.default, T.default, p.default, f.default, h.default, _.default), this.syncWith([p.default], x), this.syncWith([_.default], y)
                }
                getProps(e, t) {
                    let n = D.get(e, L(t));
                    return {
            ...
            P.displayName = "ChannelMemberStore";

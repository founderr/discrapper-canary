(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["78794"], {
        ...
        736978: function(e, t, r) {
            ...
            let f = new Set([s.CARD_NUMBER, s.CARD_CVC, s.CARD_EXPIRATION_DATE, s.CARD_NAME]),
                N = new Set([s.CARD_NUMBER, s.CARD_CVC, s.CARD_EXPIRATION_DATE, s.CARD_NAME, s.ADDRESS_POSTAL_CODE, s.ADDRESS_COUNTRY, s.ADDRESS_LINE_1, s.ADDRESS_CITY, s.ADDRESS_STATE]),
                S = new Set([s.ADDRESS_NAME, s.ADDRESS_LINE_1, s.ADDRESS_LINE_2, s.ADDRESS_CITY, s.ADDRESS_STATE, s.ADDRESS_POSTAL_CODE, s.ADDRESS_COUNTRY]);
            ...
            class T extends c.default {
                ...
                constructor(e, t) {
                    for (let r in super(e, t), this.paymentId = null, this.code === n.NEGATIVE_INVOICE_AMOUNT ? this.message = A.default.Messages.BILLING_ERROR_NEGATIVE_INVOICE_AMOUNT : this.code === n.INVALID_PAYMENT_SOURCE ? this.message = A.default.Messages.BILLING_PAYMENT_SOURCE_INVALID : this.code === n.UNKNOWN_PAYMENT_SOURCE ? this.message = A.default.Messages.BILLING_ERROR_UNKNOWN_PAYMENT_SOURCE : this.code === n.SUBSCRIPTION_RENEWAL_IN_PROGRESS ? this.message = A.default.Messages.BILLING_ERROR_PENDING_PAYMENT : this.code === n.BILLING_TRIAL_REDEMPTION_DISABLED ? this.message = A.default.Messages.BILLING_TRIAL_REDEMPTION_DISABLED : 429 === this.status ? this.message = A.default.Messages.BILLING_ERROR_RATE_LIMIT : this.code === n.UNKNOWN ? this.message = A.default.Messages.BILLING_ERROR_GENERIC : 400 === this.status && null != this.fields.captcha_key && (this.message = A.default.Messages.BILLING_ERROR_INVALID_CAPTCHA_RESPONSE), this.fields) {
                        let e = I[r] || D[r];
                        if (null != e) {
                            let t = this.fields[r];
            ...
            T.ErrorCodes = n, T.Fields = s, T.Sections = o, T.CARD_ERRORS = f, T.ADDRESS_ERRORS = S;
            var L = T
        },

    ...
    [46047], {
        ...
        189651: (e, t, n) => {
            ...
            function P(e, t) {
                ...
                if (null != n) {
                    ! function(e, t) {
                        var n = L(c.ZP.getSelectableChannelIds(e)).concat(L(c.ZP.getVocalChannelIds(e))),
                            r = Array.from(t);
                        c.ZP.addConditionalChangeListener((function() {
                            ...
                            var o = L(c.ZP.getSelectableChannelIds(e)).concat(L(c.ZP.getVocalChannelIds(e))).filter((function(e) {
                                return !n.includes(e)
                            }));
                            o.length > 0 && M(e, o, []);
                            return !1
        ...
        973424: (e, t, n) => {
            ...
            function d(e, t) {
                var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                    ...
                    T = function(n) {
                        if (L.includes(n.id)) {
                            u.Z.updateMemberRoles(t, e, L.filter((function(e) {
                                return e !== n.id
                            })), [], [n.id]);
                            R(l.jQ.REMOVE_ROLE)
                        } else {
                            u.Z.updateMemberRoles(t, e, L.concat([n.id]), [n.id], []);
                            R(l.jQ.ADD_ROLE)
                        }
                    },
                ...
                var S = s.Z.getHighestRole(A),
                    C = Object.values(A.roles).filter((function(e) {
                        return e.id !== A.id
                    })),
                    M = g ? C.map((function(e) {
                ...
                return 0 === M.filter(I.lm).length ? null : n ? M : (0, r.jsx)(a.MenuItem, {
                    id: "roles",

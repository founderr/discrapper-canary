    ...
    ["60814"], {
        ...
        627697: function(e, t, n) {
            ...
            function b(e) {
                ...
                } = (0, c.default)(d.default.ACTIVITY_BOOKMARK), w = (0, u.useAnalyticsContext)(), H = G.channel_id, F = (0, l.useStateFromStores)([E.default], () => E.default.getChannel(H), [H]), V = null == F ? void 0 : F.guild_id, Y = null != F && (F.isGuildVoice() || F.isPrivate()), W = (0, l.useStateFromStores)([A.default], () => A.default.getSelfEmbeddedActivityForChannel(H)), K = (null == W ? void 0 : W.application_id) === b, [z, Z] = (0, f.default)([b, null !== (n = null == W ? void 0 : W.application_id) && void 0 !== n ? n : ""]), J = (0, x.default)(null !== (i = null == z ? void 0 : z.maxParticipants) && void 0 !== i ? i : 0), [X] = (0, l.useStateFromStoresArray)([A.default], () => Y ? A.default.getEmbeddedActivitiesForChannel(H).filter(e => e.application_id === b) : [], [b, H, Y]), q = Array.from(null !== (C = null == X ? void 0 : X.connections.keys()) && void 0 !== C ? C : []), Q = (0, l.useStateFromStoresArray)([p.default], () => q.map(e => p.default.getUser(e)).filter(T.isNotNullish), [q]), $ = (0, O.default)({
                    applicationId: b,
                    size: U
        ...
        858291: function(e, t, n) {
            ...
            function g(e) {
                ...
                let U = () => (0, p.openGuildProductInfoModal)({
                        guildId: g,
        ...
        801177: function(e, t, n) {
            ...
            function B(e) {
                ...
                let {
                    ...
                    setPopout: H
                } = (0, T.default)(B.id, j.DEFAULT_POPOUTS), F = (0, I.useContextMenuMessage)(B, k, H, !0), V = A.GifAutoPlay.useSetting(), Y = (0, R.useIsWindowFocused)(), [W, K] = s.useState(!1), [z, Z] = s.useState((null == w ? void 0 : w.coverImage) == null), J = (0, c.default)([m.default], () => m.default.useReducedMotion), X = (0, c.default)([N.default, M.default], () => {
                    var e;
                        ...
                        switch ((0, c.getInviteType)(R)) {
                            ...
                            default:
                                ...
                                if ((0, c.isStageInviteEmbed)(R)) {
                                    ...
                                    break
                                }(0, c.isEmbeddedApplicationInvite)(R) && (G = (0, a.jsx)(_.default, {
                                    invite: R,
                                    getAcceptInviteContext: x
                                }))
                        }
        ...
        723931: function(e, t, n) {
            ...
            function ey(e) {
                ...
                }), U = (0, _.useShowImprovedMarkdownUserExperimentConfig)((null !== (t = i.editedTimestamp) && void 0 !== t ? t : i.timestamp).valueOf()), b = (0, _.useShowImprovedMarkdownGuildExperimentConfig)(null !== (n = l.guild_id) && void 0 !== n ? n : "", (null !== (s = i.editedTimestamp) && void 0 !== s ? s : i.timestamp).valueOf()), G = (0, P.default)(null == l ? void 0 : l.id), B = (0, j.default)(i), k = (0, A.useShouldRedactExplicitContent)(l.id, i.author.id);
                return (0, a.jsx)(eR, {
                    canSuppressEmbeds: x,
                    canDeleteAttachments: O,
                    ...D,
            ...
            let eM = Object.freeze({
                ...
                [eI.MessageTypes.RECIPIENT_ADD]: function(e) {
                    let {
                        ...
                        author: i
                    } = t, r = t.getChannelId(), o = (0, l.useStateFromStores)([B.default], () => B.default.getUser(t.mentions[0]), [t]), u = eh.default.getName(null, r, o), d = (0, eg.useUsernameHook)(i, r, n.guild_id), c = (0, eg.useUsernameHook)(o, r, n.guild_id);
                ...
                [eI.MessageTypes.RECIPIENT_REMOVE]: function(e) {
                    let {
                        ...
                        author: i
                    } = t, r = t.getChannelId(), o = (0, l.useStateFromStores)([B.default], () => B.default.getUser(t.mentions[0]), [t]), u = (0, eg.useUsernameHook)(i, r, n.guild_id), d = (0, eg.useUsernameHook)(o, r, n.guild_id);
                ...
                [eI.MessageTypes.GUILD_STREAM]: function(e) {
                    let {
                        ...
                        messageReference: u
                    } = t, c = t.getChannelId(), f = (0, l.useStateFromStores)([b.default], () => b.default.findActivity(o, e => e.type === eI.ActivityTypes.PLAYING), [o]), m = (0, l.useStateFromStores)([D.default], () => null != u ? D.default.getChannel(u.channel_id) : null, [u]), h = null == u ? void 0 : u.guild_id, E = (0, eg.useUsernameHook)(r, c, i.guild_id), p = s.useCallback(() => {
                ...
                return T = (0, a.jsxs)("span", {
                    ...
                    children: [(0, a.jsx)(o.default.GuildSplash, {
                        ...
                        children: [(0, a.jsxs)("div", {
                            ...
                            children: b ? G ? p.default.Messages.STAGE_CHANNEL_JOIN : p.default.Messages.INVITE_VOICE_CHANNEL_JOIN : j ? p.default.Messages.JOINED_GUILD : p.default.Messages.JOIN_GUILD
                        })]
        ...
        158783: function(e, t, n) {
            ...
            function _(e) {
                ...
                let U = A === I.id && null != D ? (0, a.jsx)(c.default.Channel, {
                    channel: D
        ...
        905206: function(e, t, n) {
            ...
            function C(e, t, n) {
                ...
                let j = null === (S = r.default.getChannel(e.getChannelId())) || void 0 === S ? void 0 : null === (C = S.getGuildId) || void 0 === C ? void 0 : C.call(S),
                    U = (0, m.getAvatarUrl)(y, j),
                    b = P ? null != L ? L : (0, E.formatExpirationLabel)(R.expiry) : "",
                    G = null == b && P,
                    {
                        selectedAnswerIds: B,
                        submitting: k,
                ...
                v = w ? {
                    ...
                    label: null != b ? b : _.default.Messages.POLL_EXPIRED,
                    presentation: "text",
                    enabled: !1
                };
                let ee = "normal";
                return G ? ee = "victor" : z && (ee = "voted"), {
                    question: R.question,
                    answers: Z,
                    layoutType: F,
                    ...
                    canShowVoteCounts: X,
                    hasVoted: z,
                    expirationLabel: null != b ? b : _.default.Messages.POLL_EXPIRED,
                    isExpired: G,
                    myAvatarUrl: U,
                    secondaryAction: v
                }
                        ...
                        children: [(() => {
                            ...
                            return (0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsx)(k, {
                                    ...
                                    postSuccessGuild: G || null == _ ? void 0 : _,
                            ...
                            let t = (null !== (e = null == _ ? void 0 : _.stickers) && void 0 !== e ? e : []).slice(0, 13).filter(e => e.id !== n.id).slice(0, 12),
                                s = null != _ ? c.default.createFromDiscoverableGuild(_) : c.default.createFromGuildRecord(b);
                            return (0, a.jsxs)("div", {
        ...
        994402: function(e, t, n) {
            ...
            let y = e => {
                ...
                P = e => {
                    ...
                    }, [B, d, z, Z, V, J, n, $, ee, Y, W, F, c, q]), el = s.useCallback(() => {
                        var e;
        ...
        292200: function(e, t, n) {
            ...
            function Z(e) {
                let {
                    ...
                    handleFocus: U,
                    handleBlur: W
                } = (0, C.useFocusInside)(x), K = (0, c.useStateFromStores)([m.default], () => m.default.keyboardModeEnabled), Z = (0, c.useStateFromStores)([A.default], () => A.default.can(G.Permissions.MANAGE_MESSAGES, r), [r]), {
                    ruleName: J,
                    embedChannel: X,
                    decisionId: q,
                    ...
                    null != et && null != X && (e.stopPropagation(), e.preventDefault(), (0, g.default)(G.Routes.CHANNEL(null == X ? void 0 : X.guild_id, null == X ? void 0 : X.id, et)))
        ...
        119715: function(e, t, n) {
            ...
            function y(e) {
                ...
                } = (0, h.useGuildIncidentsState)(P), U = (0, I.useContextMenuRaidAlert)(l.author.id, l.channel_id), b = s.useCallback(() => {
                    let e = null == y ? void 0 : y.guild_id;
                    null != e && (0, g.openRaidResolveModal)(l.id, e)
                }, [l.id, y]), G = x === m.AutomodRaidAlertTypes.DM_RAID;
                return (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsxs)("div", {

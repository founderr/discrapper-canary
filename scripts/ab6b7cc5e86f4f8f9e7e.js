    ...
    ["66787"], {
                    ...
                    updateGuildNotificationSettingsBulk(e, t) {
                        ...
                        r.default.saveUserGuildSettingsBulk(e), Object.entries(e).forEach(e => {
                            ...
                            a.default.dispatch({
                                ...
                                guildId: n,
                                settings: l
                            }), (0, u.trackGuildNotificationSettingsUpdate)(n, l, r, t)
                        })
                    },
        ...
        531674: function(e, t, n) {
            ...
            function T(e, t) {
                ...
                let C = _.default.Messages.MUTE_CHANNEL_GENERIC,
                    N = _.default.Messages.UNMUTE_CHANNEL_GENERIC;
                switch (e.type) {
                    case E.ChannelTypes.GUILD_CATEGORY:
                        C = _.default.Messages.MUTE_CATEGORY, N = _.default.Messages.UNMUTE_CATEGORY;
                        break;
                    case E.ChannelTypes.GROUP_DM:
                        C = _.default.Messages.MUTE_CONVERSATION, N = _.default.Messages.UNMUTE_CONVERSATION;
                        break;
                    case E.ChannelTypes.DM:
                        C = _.default.Messages.MUTE_CHANNEL.format({
                            name: h
                        ...
                        break;
                    default:
                        C = _.default.Messages.MUTE_CHANNEL_GENERIC, N = _.default.Messages.UNMUTE_CHANNEL_GENERIC
                }
        ...
        526887: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, h = (0, a.useConfettiCannon)(n, o), _ = (0, r.default)([s.default], () => s.default.useReducedMotion), I = l.useMemo(() => _ ? u : {
                    confettiCanvas: n,
                    cannon: h,
        ...
        823026: function(e, t, n) {
            ...
            function _(e) {
                let {
                    ...
                    channel: _,
                    context: I
                } = e, p = c.default.getGuild(n), T = (0, a.useStateFromStores)([f.default], () => null != p ? f.default.can(E.Permissions.MANAGE_GUILD, p) : null), C = (0, u.useContextIndexState)(_, !0, !0), N = (0, u.useUserIndexState)(!0, !0), {
                    isUserApp: S,
                    isGuildApp: g
                } = l.useMemo(() => {
                    var e, n, i, l;
                ...
                }, [C, N, null == t ? void 0 : t.id]), v = l.useCallback(() => {
                ...
                }, [null == t ? void 0 : t.id, null == p ? void 0 : p.id]), m = l.useCallback(() => {
                    o.default.open(E.UserSettingsSections.AUTHORIZED_APPS)
                }, []), A = I === E.AppContext.POPOUT;
                if (!(null == t ? void 0 : t.bot) || !T || A || !g && !S) return null;
                let M = [];
                return g && M.push((0, i.jsx)(r.MenuItem, {
                    id: "manage-integration",
                    label: h.default.Messages.MANAGE_INTEGRATION,
                    action: v
                }, "manage-integration")), S && M.push((0, i.jsx)(r.MenuItem, {
        ...
        424562: function(e, t, n) {
            ...
            function T() {
                _ = h.FormStates.CLOSED, I = {}, u = null, d = void 0, c = []
            }
            ...
            var v = new g(E.default, {
                GUILD_IDENTITY_SETTINGS_INIT: function(e) {
                    u = e.guild, _ = h.FormStates.OPEN, I = {}, d = e.source, c = e.analyticsLocations
                },
        ...
        752598: function(e, t, n) {
            ...
            let S = (e, t) => {
                ...
                let r = e.state === I.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : a.default.extractTimestamp(n) + 3e3) < Date.now(),
                    s = (null == t ? void 0 : t.data.interactionType) === u.InteractionTypes.APPLICATION_COMMAND,
                    o = e.isCommandType();
                if (s && i === h.InteractionState.QUEUED || o && e.state === I.MessageStates.SENDING && null != t) return 0;
                ...
                else if (null != e.interaction && !e.hasFlag(I.MessageFlags.LOADING) && r) return 3;
        ...
        650484: function(e, t, n) {
            ...
            function h(e) {
                ...
                l.useEffect(() => {
                    S(null)
                }, [p, S]), o(null != v, "Unknown step for current payment flow.");
                let m = null !== (u = null == v ? void 0 : null === (t = v.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    ...
                    M = void 0 !== _ && _ ? E.sliderBodyLarge : null == v ? void 0 : null === (a = v.options) || void 0 === a ? void 0 : a.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == v ? void 0 : null === (s = v.options) || void 0 === s ? void 0 : s.renderHeader) || void 0 === d || d ? h : null, v.renderStep(I), null == p || m ? null : (0, i.jsxs)(i.Fragment, {
        ...
        649844: function(e, t, n) {
            ...
            function _(e) {
                let {
                    ...
                    giftRecipient: U,
                    returnRef: G
                } = null != e ? e : {}, D = !1, P = (0, l.v4)(), x = u.default.getCurrentUser(), b = (0, f.isPremiumExactly)(x, h.PremiumTypes.TIER_2);
                (0, a.openModalLazy)(async () => {
                    let {
                        default: e
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: _,
                            onClose: (e, t) => {
                                l(), null == I || I(e), e && (null == T || T(), !v && null != t && t === h.PremiumSubscriptionSKUs.TIER_2 && !b && c.ComponentDispatch.dispatch(E.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
        ...
        130074: function(e, t, n) {
            ...
            var l = n("77078"),
                ...
                b = n("49111"),
                F = n("782340"),
                w = (0, s.default)((0, r.default)(function(e) {
                    let {
                        user: t,
                        channel: n,
                        channelSelected: r = !1,
                        ...
                        onSelect: V,
                        onHeightUpdate: B
                    } = e, k = (0, D.default)(t.id, null), Y = (0, R.default)(t, H), Z = (0, m.default)({
                        user: t,
                        context: H
                    }), W = (0, v.default)(t), K = (0, x.default)(t.id), z = (0, L.default)(n.id, r), Q = (0, y.default)(t), q = (0, u.default)(null, t), X = (0, P.default)(t.id), J = (0, U.default)(t.id, n.id), $ = (0, g.default)(t), ee = (0, G.default)(t.id), et = (0, O.default)(t.id, n.id), en = (0, M.default)(t), ei = (0, _.default)(n), el = (0, I.default)({
                        id: t.id,
                        label: F.default.Messages.COPY_ID_USER
                    }), ea = (0, I.default)({
                        id: n.id,
                        label: F.default.Messages.COPY_ID_CHANNEL
                    }), er = (0, h.default)(n), es = (0, f.default)(t.id), eo = (0, c.default)(n.id), eu = (0, S.default)(t), ed = (0, E.default)(t.id), ec = (0, A.default)({
                        commandType: o.ApplicationCommandType.USER,
                        commandTargetId: t.id,
                        channel: n,
                        guildId: void 0,
                        onHeightUpdate: B
                    }), ef = (0, p.useAddToFavoritesItem)(n), eE = (0, p.useRemoveFromFavoritesItem)(n), eh = (0, T.default)(n), e_ = (0, C.useMessageRequestItem)(n), eI = (0, N.useSafetyWarningsItem)(n), ep = n.isManaged(), eT = t.isNonUserBot();
                    return (0, i.jsxs)(l.Menu, {
                        ...
                        children: [(0, i.jsx)(l.MenuGroup, {
                            ...
                            children: [(0, i.jsx)(l.MenuGroup, {
                                ...
                                children: [d && ee, d && et, ec, w && Q, $, w && en, d && ed]
                            }), (0, i.jsx)(l.MenuGroup, {
                                children: s && ei
            ...
            var i = n("37983"),
                ...
                C = e => {
                    let t, {
                        ...
                        v = (0, s.useStateFromStores)([h.default], () => h.default.getGuild(null != N ? N : C.guild_id)),
                    ...
                    l.useEffect(() => {
                        L.current !== y.current && (y.current = L.current, null == S || S())
                    }, [L, S]);
        ...
        181114: function(e, t, n) {
            ...
            let p = e => {
                let {
                    ...
                    onlyShineOnHover: _,
                    ...p
                } = e, T = r.createRef(), C = (0, c.default)(T), N = !i && !l && !0 !== s && (!_ || C);

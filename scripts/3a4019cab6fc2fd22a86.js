    ...
    [30144], {
            ...
            var j = function(t) {
                ...
                u.render = function() {
                    ...
                    return (0, i.createElement)("img", R(w(R(w(R({}, d), {
                        key: this.key,
                        src: p,
                        alt: null !== (e = null != f ? f : u) && void 0 !== e ? e : void 0,
                        draggable: !1
                    }), t), {
                        className: o()("emoji", l, {
                            jumboable: "jumbo" === c
                ...
                var e = function(t) {
                    ...
                    n = function(t) {
                        ...
                        if (-1 !== n) {
                            ...
                            if (-1 !== (n = o.indexOf(t))) {
                                o.splice(n, 1);
                                n < u && o.length >= u && o[u - 1].forceUpdate()
                            }
                        } else 0
                    };
                        ...
                        t.forEach((function(t) {
                            ...
                            if (null != e) {
                                ...
                                if (t.intersectionRatio >= .7) {
                                    ...
                                    s ? o.unshift(n) : o.push(n);
                                    n.forceUpdate();
                                    s && o.length > u && o[u].forceUpdate()
                                } else {
                                    var l = o.indexOf(n);
                                    if (-1 !== l) {
                                        o.splice(l, 1);
                                        n.forceUpdate();
                                        l < u && o.length >= u && o[u - 1].forceUpdate()
                                    }
                                }
                            } else 0
                        }))
                        ...
                        return (0, r.jsx)(d.G.Consumer, {
                            children: function(n) {
                                return (0, r.jsx)(t, w(R({}, l), {
                                    autoplay: i || !1,
                                    shouldAnimate: -1 !== e && e < u && !n.disableAnimations && s
                                }))
                            }
                        })
                    };
        ...
        479373: (t, e, n) => {
            ...
            function g(t) {
                ...
                if (t.type !== l.nv.MODAL || null != t.name || !(0, y.Ez)().some((function(t) {
                    ...
                    (0, y.Ps)(t);
                    var u, o, s = null !== (u = null == i ? void 0 : i.guild_id) && void 0 !== u ? u : h.Z.getGuildId(),
                        a = null !== (o = null == i ? void 0 : i.channel_id) && void 0 !== o ? o : f.Z.getChannelId(s),
        ...
        158515: (t, e, n) => {
            ...
            function k(t, e) {
                ...
                switch (t) {
                    ...
                    case I.h8.USER:
                        i = n.filter((function(t) {
                            return t instanceof s.Sf && t.type === P.d4z.DM
                        }));
                        break;
                    case I.h8.GROUP_DM:
                        i = n.filter((function(t) {
                ...
                var u = {},
                    ...
                    c = void 0;
                try {
                    for (var f, h = i[Symbol.iterator](); !(o = (f = h.next()).done); o = !0) {
                        var d = f.value,
                            p = d.id,
                            y = b.Z.getScore(p);
                        if (t === I.h8.USER && d instanceof s.mn) {
                            if (d.type === P.d4z.DM) u[p = d.getRecipientId()] = 1 + y / r;
                            else if (d.type === P.d4z.GROUP_DM) {
                ...
                var k = v.Z.getDMUserIds(),
                    T = !0,
                    D = !1,
                    Z = void 0;
                try {
                    for (var x, G = k[Symbol.iterator](); !(T = (x = G.next()).done); T = !0) {
                        var q, B = x.value;
                        u[B] = (null !== (q = u[B]) && void 0 !== q ? q : 1) + .1
                    }
                } catch (t) {
                    D = !0;
                    Z = t
            ...
            var T = function() {
                function t(e, n) {
                    var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 100,
                        u = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : M,
                        o = this;
                    C(this, t);
                    this.query = "";
                    this.options = M;
                    ...
                    this.parseUserResults = function(t) {
                        ...
                        if (o._include(I.h8.USER)) {
                            ...
                            o._userResults.length > o._limit && (o._userResults.length = o._limit);
                            o.updateAllResults()
                        }
                    };
                    this.updateAllResults = function() {
                        clearTimeout(o._asyncTimeout);
                        o.results = i()(N(o._userResults).concat(N(o._groupDMResults), N(o._textChannelResults), N(o._voiceChannelResults), N(o._guildResults), N(o._linkResults))).uniqBy((function(t) {
                            return "".concat(t.type, "-").concat(t.record.id)
                        })).sort(S.Z).value();
                        o.onResultsChange(o.results, o.query)
                    };
                ...
                e.setResultTypes = function(t) {
                    ...
                    this._userResults = this._include(I.h8.USER) ? this._userResults : [];
                    this._groupDMResults = this._include(I.h8.GROUP_DM) ? this._groupDMResults : [];
                    this._textChannelResults = this._include(I.h8.TEXT_CHANNEL) ? this._textChannelResults : [];
                    this._voiceChannelResults = this._include(I.h8.VOICE_CHANNEL) ? this._voiceChannelResults : [];
                    this._guildResults = this._include(I.h8.GUILD) ? this._guildResults : [];
                    this._applicationResults = this._include(I.h8.APPLICATION) ? this._applicationResults : [];
                    this._linkResults = this._include(I.h8.LINK) ? this._linkResults : []
                };
                ...
                e.queryTextChannels = function(t, e) {
                    ...
                    var n = k(I.h8.TEXT_CHANNEL, this.options),
                ...
                e.queryVoiceChannels = function(t, e) {
                    ...
                    if (void 0 === n) return [];
                    var r = k(I.h8.VOICE_CHANNEL, this.options);
                    return O.ZP.queryChannels({
                        query: t,
                        guildId: n,
                        limit: e,
                ...
                e.queryGuilds = function(t, e) {
                    ...
                    var n = k(I.h8.GUILD, this.options),
                        r = this.options.blacklist,
                        i = null != r ? function(t) {
                ...
                e.queryApplications = function(t, e) {
                    return this._include(I.h8.APPLICATION) ? O.ZP.queryApplications({
                        query: t,
                        limit: e,
                        fuzzy: !0
                    }) : []
        ...
        456837: (t, e, n) => {
            ...
            const U = new(function(t) {
                ...
                function r() {
                        ...
                        setTimeout((function() {
                            ...
                            if (null != e) {
                                ...
                                for (var u in i)
                                    for (var o in i[u]) {
                                        var s, l, a = r[o],
                                            f = null !== (l = null === (s = i[u][o]) || void 0 === s ? void 0 : s.nick) && void 0 !== l ? l : p.ZP.getGlobalName(a);
                                        null != a && (a[u] = null != f && "" !== f ? f : null)
                                    }
                    ...
                    t._handleOverlayInitialize = function(e) {
                        var n = e.users,
                            ...
                            s = void 0;
                        try {
                            for (var l, a = n[Symbol.iterator](); !(u = (l = a.next()).done); u = !0) {
                                var c = l.value;
                                i.set(c.id, R(c))
                            }
                        } catch (t) {
                            ...
                            for (var y, v = f[Symbol.iterator](); !(h = (y = v.next()).done); h = !0) {
                                ...
                                if (null != _) {
                                    var m = Object.keys(_),
                                        ...
                                        E = void 0;
                                    try {
                                        for (var S, I = m[Symbol.iterator](); !(g = (S = I.next()).done); g = !0) {
                                            var P = S.value,
                                                U = i.get(P),
                                                C = _[P];
                    ...
                    t._handlePassiveUpdateV1 = function(e) {
                        null != e.members && t.updateUsers(I(e.members, e.guildId))
                    };
                ...
                var u = r.prototype;
                u._initialize = function() {
                    this.rebootWebworker()
                };
                u._terminate = function() {
                    if (null != this._worker) {
                        this._worker.terminate();
                        this._worker = null
                    }
                };
                u.rebootWebworker = function() {
                    if (null != this._worker) {
                        this._worker.terminate();
                        this._worker = null
                    }
                    this._worker = new(n(968761))
                };
                u.updateUsers = function(t) {
                    var e = this._worker;
                    if (null != e) {
                        t = t.filter(d.lm);
                        e.postMessage({
        ...
        73457: (t, e, n) => {
            ...
            function o(t, e, n, r) {
                ...
                return (l += t === i.a8.UP ? -1 : 1) < 0 || l >= u ? o(t, l < 0 ? u : -1, n, s) : n[l].type === i.h8.HEADER ? o(t, l, n, s) : l
            }
            const s = r.Z
        },
        381186: (t, e, n) => {
                ...
                switch (e) {
                    ...
                    default:
                        var i = v.Z.getGuild(t),
                            u = null != i ? i.getRole(e) : null;
                        return {
                            type: N.GROUP, key: e, id: e, title: null != u ? u.name : "", count: n, index: r
                        }
                }
            }
            ...
            function k(t, e, n) {
                var r = n === h.default.getId(),
                    ...
                    u = r ? _.Z.getStatus() : b.Z.getStatus(n, t),
                    o = r ? _.Z.getActivities() : b.Z.getActivities(n, t),
                    s = f.Z.getStreamForUser(n, t),
                    l = m.default.getUser(n);
                return null == l ? null : I(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
            ...
            function T(t) {
                ...
                return null == e ? M : null == e.memberListId ? function(t) {
                    if (c.ZP.canEveryone(g.Plq.VIEW_CHANNEL, t)) return M;
                    return o().v3(i()(t.permissionOverwrites).reduce((function(t, e) {
                        var n = e.id,
                            r = e.allow,
                            i = e.deny;
            ...
            var D = function() {
                    ...
                    e.setGroups = function(t) {
                        ...
                        this.groups = t.map((function(t) {
                            var r, i = n,
                                u = Math.max(0, null !== (r = t.count) && void 0 !== r ? r : 0);
                            n += u + 1;
                            return L(e.guildId, t.id, u, i)
                        }));
                        this.rows.length = n
                    };
                    e.sync = function(t, e) {
                    ...
                    e.invalidate = function(t) {
                        for (var e = C(t, 2), n = e[0], r = e[1], i = n; i <= r; i++) {
                            ...
                            if (null == u) break;
                            delete this.rows[i];
                            u.type === N.MEMBER && delete this.members[u.user.id]
                        }
                        this.version++
                    };
                    e.insert = function(t, e) {
                        var n = e.group,
                            r = e.member;
                        if (null != n) this.rows.splice(t, 0, L(this.guildId, n.id, n.count));
                        else if (null != r) {
                    ...
                    e.update = function(t, e) {
                        ...
                        if (null != n) this.rows[t] = L(this.guildId, n.id, n.count);
                        else if (null != r) {
                            var u = k(this.guildId, this.ownerId, r.user.id);
                            if (null == u) return;
                            this.rows[t] = u;
                            this.members[r.user.id] = u
                        }
                        this.version++
                    };
                    e.delete = function(t) {
                    ...
                    e.rebuildMember = function(t) {
                        ...
                        if (null != e) {
                            Object.assign(e, k(this.guildId, this.ownerId, t));
                            this.version++
                        }
                    };
            ...
            Q.displayName = "ChannelMemberStore";
            const F = new Q(a.Z, {
                CONNECTION_OPEN: x,
        ...
        213818: (t, e, n) => {
            ...
            var I = function(t) {
                ...
                r.__getLocalVars = function() {
                    return {
                        SELECTED_USAGE_HISTORY: g,
                        MAX_NUM_SELECTED_ITEMS: 100,
                        MAX_SAMPLES: 10,
                        SELECTION_BONUS: 100,
                        frecency: O,
                        lastSelected: E,
        ...
        771333: (t, e, n) => {
            ...
            function s() {
                var t = r.useContext(u.ZP).windowId;
                return (0, i.e7)([o.Z], (function() {
                    return o.Z.isFocused(t)
                }), [t])
            }
        },
        968761: (t, e, n) => {
            t.exports = function() {
                return new Worker(n.p + "e8fb4d9d82eabf06e37b.worker.js")
            }
        }
    }
]);
            ...
            function r(e) {
                let t = function(e) {
                    let {
                        ...
                        return i
                    }, N = S(_, p, (u >> 18 & 31) / 31), I = S(3, 3, 1.25 * ((o >> 3 & 63) / 63)), v = S(3, 3, 1.25 * ((o >> 9 & 63) / 63)), R = f && S(5, 5, h), m = a(e), y = l(m > 1 ? 32 : 32 * m), g = l(m > 1 ? 32 / m : 32), U = new Uint8Array(y * g * 4), P = [], O = [];
                    for (let e = 0, a = 0; e < g; e++)
                        for (let l = 0; l < y; l++, a += 4) {
                            let u = s,
                                ...
                                E = d,
                                h = T;
                            for (let e = 0, n = i(_, f ? 5 : 3); e < n; e++) P[e] = r(t / y * (l + .5) * e);
                            for (let n = 0, a = i(p, f ? 5 : 3); n < a; n++) O[n] = r(t / g * (e + .5) * n);
                            for (let e = 0, t = 0; e < p; e++)
                                for (let n = e ? 0 : 1, a = 2 * O[e]; n * p < _ * (p - e); n++, t++) u += N[t] * P[n] * a;
                            for (let e = 0, t = 0; e < 3; e++)
                                for (let n = e ? 0 : 1, a = 2 * O[e]; n < 3 - e; n++, t++) {
                                    let e = P[n] * a;
                                    o += I[t] * e, E += v[t] * e
                                }
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, a = 2 * O[e]; n < 5 - e; n++, t++) h += R[t] * P[n] * a;
                            let C = u - 2 / 3 * o,
                                A = (3 * u - C + E) / 2,
                                S = A - E;

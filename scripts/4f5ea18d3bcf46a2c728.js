    ...
    ["98449"], {
        ...
        247760: function(e, t, n) {
            ...
            var T = e => {
                ...
                let M = [null == r ? "UNUSED_QUANTITY_SELECT" : null, null == i ? "GUILD_SELECT" : null, "CONFIRM", "SUCCESS"].filter(e => null != e),
                    [v, O] = (0, u.useStateFromStoresArray)([f.default], () => [f.default.isModifyingAppliedBoost, f.default.applyBoostError]),
                    [x, U] = l.useState(""),
                    [P, y] = l.useState(M[0]),
                    [D, B] = l.useState(!1),
                    [F, G] = l.useState(i),
                    ...
                    k = {
                        ...
                        CONFIRM: {
                            ...
                            footer() {
                                let e = b.length,
                                    t = "CONFIRM" === M[0] ? H : () => y(M[M.indexOf(P) - 1]),
                                    n = async () => {

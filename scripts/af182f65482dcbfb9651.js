        ...
        318554: (e, t, r) => {
            ...
            function A(e) {
                var t = e.guildId,
                    ...
                    N = P(o.useState(!1), 1)[0],
                    R = P(o.useState(y.Fl), 2),
                    I = R[0],
                    x = R[1],
                    M = (0, c.e7)([b.Z], (function() {
                        return b.Z.getGuildIncident(t)
                    })),
                    C = (0, d.SG)(M),
                    T = (0, d.sN)(M),
                    Z = P(o.useState(!!m || C), 2),
                    k = Z[0],
                    L = Z[1],
                    U = P(o.useState(!!m || T), 2),
                    G = U[0],
                    B = U[1];
                if (null == D) {
                    j();
                        ...
                        children: [(0, n.jsx)(a.Button, {
                            onClick: function() {
                                ...
                                f.default.track(O.rMx.GUILD_RAID_INTERVENTION_STATE_CHANGE, {
                                    ...
                                    raid_alert_id: i,
                                    raid_alert_type: o,
                                    intervention_type_enabled: (0, d.sO)(k, G),
                                    intervention_type_disabled: (0, d.lk)(k, G),
                                    duration: 60 * I
                                });
                                j()
                            },

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [24777], {
            ...
            var _ = {
                ...
                setPinChat: function(t) {
                    ...
                    if (0 !== o.length && null != e && null != r && null != n) {
                        ...
                        if (t) {
                            var O = "auto" === b.width ? n.minSize.width : b.width;
                            O -= e.minSize.width;
                            var I = m((0, y.o4)(E, f(k({}, b), {
            ...
            const I = new O(a.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(t) {
                    ...
                    n.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == i ? void 0 : i.sku_id) === s.Si.TIER_2 && null == r.Z.getPremiumSubscription(!1) && null == _.tutorialExpirationTime && E()
                }
            })
        },
        156620: (t, i, o) => {
        ...
        305082: (t, i, o) => {
            ...
            function g() {
                return t = w, i = v, o = E("useMemoizedValueSyncedWithDismissibleContents"), r = (0, a.e7)([x.Z], (function() {
                    var t;
                    ...
                    return g(this, (function(s) {
                        switch (s.label) {
                            case 0:
                                ...
                                o = (0, n.Z)();
                                e = (0, b.k9)(t);
                                return null != o && !p.Lr.has(o.type) && null != e && C(i) && (0, E.D)() ? [4, (0, m.w)()] : [2];
                            case 1:
                                s.sent();
        ...
        933878: (t, i, o) => {
            ...
            function A(t, i, o) {
                var e, r = T(t),
                    ...
                    d = null !== (e = E.Z.getState().animationType) && void 0 !== e ? e : I.q.BASIC,
                    p = {
                        animation_type: d,
        ...
        285629: (t, i, o) => {
            ...
            var R, M = {
                ...
                j = {
                    BASIC: [r],
                    PREMIUM: [n, s, x, y, d, p, c, l, u, k, f, m, _, h, E, b, O, I, v, w, g]
                },
        ...
        138049: (t, i, o) => {
            ...
            function K(t) {
                ...
                U = C(A({}, U), S({}, i.id, i));
                if (!__OVERLAY__) {
                    f.default.track(b.rMx.USER_SETTINGS_KEYBIND_UPDATED, {
                        keybind_action: i.action,
                        keybind_is_bound: !0,
                        keybind_has_shortcut: i.shortcut.length > 0
                    });
                    i.action === b.kg4.TOGGLE_OVERLAY_INPUT_LOCK ? f.default.track(b.rMx.OVERLAY_SETTINGS_UPDATED, {
                        hotkey: i.action === b.kg4.TOGGLE_OVERLAY_INPUT_LOCK ? (0, h.BB)(i.shortcut) : null
                    }) : i.action === b.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET && f.default.track(b.rMx.OVERLAY_SETTINGS_UPDATED, {
                        text_activation_hotkey: i.action === b.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET ? (0, h.BB)(i.shortcut) : null
                    })
                }
                Y(i)
            }
            ...
            var q = [function() {
                ...
                return !!E.Z.enabled && X(b.kg4.TOGGLE_OVERLAY_INPUT_LOCK, "shift+`")
            }, function() {
                return !!E.Z.enabled && X(b.kg4.OVERLAY_ACTIVATE_REGION_TEXT_WIDGET, "]`")
            }, function() {
                return X(b.kg4.SOUNDBOARD_HOLD, I.D_, !1)
            }, function() {
                return X(b.kg4.SAVE_CLIP, O.D_)
            }];
            ...
            var J = function(t) {
                ...
                var e = o.prototype;
                e.initialize = function(t) {
                    __OVERLAY__ || this.waitFor(k.Z, E.Z);
                    U = null != t ? t : {}
                };
            ...
            J.migrations = [function() {
                ...
                return d().reduce(o, (function(t, i, o) {
                    if ((0, m.IJ)() && i.action === b.kg4.SOUNDBOARD_HOLD) {
            ...
            const Q = new J(c.Z, {
                ...
                KEYBINDS_DELETE_KEYBIND: function(t) {
                    var i = t.id,
                        o = U[i];
                    __OVERLAY__ || f.default.track(b.rMx.USER_SETTINGS_KEYBIND_UPDATED, {
        ...
        887643: (t, i, o) => {
                            ...
                            if (Array.isArray(t) && 0 !== t.length) {
                                ...
                                try {
                                    for (var a, r = t[Symbol.iterator](); !(i = (a = r.next()).done); i = !0) {
                                        var n = a.value;
                                        if (null != n) {
                                            var s, x, y, d, p, c, l, u = null != n.processName ? b.Z.getGameByExecutable(n.processName) : null;
            ...
            function bt() {
                bt = N((function() {
                    var t, i, o, e, a, r, n, s, x, y, d, c, l, u, k, f, m, _, h, E, b = arguments;
                    return W(this, (function(O) {
                        switch (O.label) {
                            case 0:
                                null == (t = b.length > 0 && void 0 !== b[0] ? b[0] : null) && (t = tt && ot ? I.ZP.getOverlayEligiblePIDs() : []);
                                switch (it) {
                                    case T.gl.Global:
                                        return [3, 1];
                                    case T.gl.Hook:
            ...
            var Zt = new Promise((function(t) {
                ...
                Ft = function(t) {
                    ...
                    e.initialize = function() {
                        if (T.iP && !__OVERLAY__) {
                            $.add(T.gl.Hook);
                            this.waitFor(I.ZP, E.default);
                            this.syncWith([I.ZP], Ct);
                            l.sr(Ut, jt);
                            E.default.addChangeListener(At);
                            Zt.then((function() {
                                gt(f.v.enabled);
            ...
            var Gt = new Ft(r.Z, __OVERLAY__ ? {} : {
                ...
                RPC_SERVER_READY: function(t) {
                    ...
                    a.append("build_id", "675b4b3271d514211181483093e9e290788efe9e");

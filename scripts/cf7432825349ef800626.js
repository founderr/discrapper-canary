    ...
    ["44893"], {
        ...
        319839: function(e, t, n) {
            ...
            class ee {
                ...
                constructor(e, t) {
                    var n, i;
                    this.id = e, this.sortedNamedCategories = null, this.sections = null, this.rows = null, this.firstVoiceChannel = void 0, this.allChannelsById = null, this.version = 0, this.hideMutedChannels = V.default.isGuildCollapsed(this.id), this.mutedChannelIds = V.default.getMutedChannels(this.id), this.optedInChannels = null !== (n = V.default.getOptedInChannelsWithPendingUpdates(this.id)) && void 0 !== n ? n : V.default.getOptedInChannels(this.id), this.optInEnabled = (0, w.isOptInEnabledForGuild)(this.id), this.hideResourceChannels = (0, I.canSeeOnboardingHome)(this.id), this.favoriteChannelIds = new Set(null !== (i = V.default.getGuildFavorites(this.id)) && void 0 !== i ? i : []), this.suggestedFavoriteChannelId = _.default.getSuggestedChannelId(this.id), this.collapsedCategoryIds = A.default.getCollapsedCategories();
            ...
            class el extends et {
                ...
                updateShownChannelIds(e) {
                    ...
                    if (e.lastMessageTimestamp > (null === (t = this.channels[this.shownChannelIds[0]]) || void 0 === t ? void 0 : t.lastMessageTimestamp)) {
                        ...
                        return t > -1 && this.shownChannelIds.splice(t, 1), this.shownChannelIds.splice(0, 0, e.id), this.shownChannelIds.length > el.MAX_RECENT_CHANNELS && (this.shownChannelIds = this.shownChannelIds.slice(0, el.MAX_RECENT_CHANNELS)), p.default.get("recent_channels_throttle") && (this.isThrottled = !0, setTimeout(() => {
                            this.isThrottled = !1
            ...
            class eo extends eh {
                computeState(e) {
                    ...
                    return (a = ep(this.record, c, n, i, d.hideMutedChannels), d.optInEnabled && d.hideResourceChannels && this.record.hasFlag(j.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) ? {
                        ...
                        renderLevel: 2,
                        threadIds: a
                    } : this.category.isCollapsed && (d.mutedChannelIds.has(this.id) || null != r && d.mutedChannelIds.has(r) || this.record.isGuildVocal() || this.record.type === W.ChannelTypes.GUILD_STORE || (0, R.isGuildReadableType)(this.record.type) && !1 === U.default.hasRelevantUnread(this.record)) ? {
                        renderLevel: 3,
                        threadIds: a
                    } : {
                        renderLevel: 4,

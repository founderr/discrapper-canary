(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["19836"], {
            ...
            class d extends i.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: S,
                        retrySuccess: R
                    } = this.state, m = i.Children.count(s) > 0 ? (0, r.jsx)(l.Card, {
        ...
        903016: function(e, t, n) {
            ...
            T.Header = h, T.ApplyBody = m, T.TransferBody = function(e) {
                var t, n;
                let {
                    imageClass: s,
                    blurb: a,
                    ...
                    slotCount: E = 1,
                    canceledCount: _ = 0
                } = e, h = i.useRef(l), m = null === (t = h.current) || void 0 === t ? void 0 : t.length, C = null === (n = h.current) || void 0 === n ? void 0 : n.reduce((e, t) => (!e.hasOwnProperty(t.id) && (e[t.id] = []), e[t.id].push(t), e), {});
                return (0, r.jsxs)(S, {
                    imageClass: s,
                    error: c,
                    onDismissError: f,
        ...
        247760: function(e, t, n) {
            ...
            var L = e => {
                ...
                let O = [null == r ? "UNUSED_QUANTITY_SELECT" : null, null == i ? "GUILD_SELECT" : null, "CONFIRM", "SUCCESS"].filter(e => null != e),
                    [M, v] = (0, u.useStateFromStoresArray)([f.default], () => [f.default.isModifyingAppliedBoost, f.default.applyBoostError]),
                    [x, U] = a.useState(""),
                    [P, D] = a.useState(O[0]),
                    [y, B] = a.useState(!1),
                    [F, G] = a.useState(i),
                    ...
                    k = {
                        ...
                        CONFIRM: {
                            body() {
                                ...
                                let e = b.filter(e => (0, h.isGuildBoostSlotCanceled)(e)).length,
                                    t = b.length,
                                    n = w.length;
                                return V ? (0, s.jsx)(S.default.TransferBody, {
                                    fromGuilds: w,
                                    toGuild: F,
                            ...
                            footer() {
                                let e = b.length,
                                    t = "CONFIRM" === O[0] ? H : () => D(O[O.indexOf(P) - 1]),
                                    n = async () => {
                                ...
                                return (0, s.jsx)(S.default.Footer, {
                        ...
                        SUCCESS: {
                            body: () => (0, s.jsx)(m.GuildBoostingConfirmation, {
                                guild: F,
                                isTransfer: V,
        ...
        936992: function(e, t, n) {
            ...
            function C(e) {
                let {
                    ...
                    onSelectGuild: s,
                    query: I
                } = e, m = (0, l.useStateFromStores)([E.default], () => E.default.getFlattenedGuildIds()), C = (0, l.useStateFromStoresArray)([f.default], () => m.reduce((e, t) => {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [0 === C.length && (0, r.jsx)("div", {
                        ...
                        children: (0, r.jsx)(o.Text, {
                            variant: "text-md/normal",
                            children: 0 === m.length ? S.default.Messages.PREMIUM_GUILD_SUBSCRIPTION_APPLY_NON_GUILD_MEMBER.format({
        ...
        540692: function(e, t, n) {
            ...
            class g extends i.default.Store {
                ...
                checkAndFetchReferralsRemaining() {
                    null == u && !E && h < 5 && (null == S || S < Date.now()) && (0, l.fetchReferralsRemaining)()
                }
            ...
            var L = new g(s.default, {
                ...
                BILLING_REFERRALS_REMAINING_FETCH_FAIL: function(e) {
                    let {} = e;
                    E = !1, h += 1, S = Date.now() + 1e3 * Math.pow(2, h)
                },
                ...
                LOGOUT: function() {
                    u = null, d = {}, c = [], f = new Set, E = !1, _ = new Set, I = new Set, p = {}, h = 0, S = null
                }
            })
        },
        ...
        467831: function(e, t, n) {
            ...
            class m extends f.PureComponent {
                ...
                render() {
                    ...
                    return (0, c.jsx)(h.default, {
                        className: _(S.sequencedAnimation, e),
            ...
            m.Scenes = r, (o = i || (i = {})).NORMAL = "normal", o.SPEED_START = "speed_start", o.SPEED_LOOP = "speed_loop", o.FINISH = "finish", o.IDLE = "idle";
            let C = {
                normal: {
                    BEG: 0,
                    END: 600,
            ...
            class A extends f.PureComponent {
                ...
                render() {
                    ...
                    return (0, c.jsxs)("div", {
                        className: _(S.tier2Animation, e),
            ...
            function U(e) {
                let {
                    animate: t
                } = e, [n, r] = f.useState(0), i = (0, I.useSprings)(v.length, v.map((e, i) => {

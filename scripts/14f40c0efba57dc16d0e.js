    ...
    ["28054"], {
        ...
        306588: function(e, t, n) {
            ...
            function B(e) {
                ...
                }), S = !!(null == o ? void 0 : o.hasVerificationGate()), M = (p || u.notClaimed) && S, T = (0, r.useStateFromStores)([_.default], () => _.default.shouldShowPopout(i)), I = (0, r.useStateFromStores)([D.default], () => D.default.can(P.Permissions.SEND_MESSAGES, s)), N = (0, r.useStateFromStores)([g.default], () => g.default.getRequest(i)), b = {
                    ...u,
                    guild: o,
                    isLurking: h,
                    isFollowable: d,
        ...
        194141: function(e, t, n) {
            ...
            function T(e) {
                let {
                    ...
                    onSubmit: x,
                    onClose: R
                } = e, y = (0, d.default)(r), [D, O] = s.useState(!1), [j, b] = s.useState(v), [P, F] = s.useState(null), [H, U] = s.useState(o.shuffle(r)), [k, B] = s.useState(""), G = (0, h.useUID)(), w = (0, C.default)(j), V = (0, C.default)(D), W = (0, C.default)(P), Z = (0, C.default)(x), K = (0, C.default)(k), z = null != P && T.includes(P);
                return s.useEffect(() => {
        ...
        556118: function(e, t, n) {
            ...
            function X(e) {
                ...
                }), ef = (0, O.default)(p, g, er), eh = (0, x.default)(m), eC = (0, y.getMessageAriaLabelledBy)(m, R), em = (0, y.getMessageAriaDescribedBy)(m), ep = (0, B.default)(e, ed, !1), eE = s.useCallback(() => (0, _.transitionToGuild)(M, g, p), [M, g, p]), eg = (0, E.useRoleIcon)({
                    guildId: M,
        ...
        144553: function(e, t, n) {
            ...
            let A = s.memo(function(e) {
                ...
                let {
                    ...
                    return null
                }, [R, y, I, D, O]), b = (0, l.useStateFromStores)([f.default], () => null != R && f.default.isBlocked(R.author.id), [R]), P = (0, g.useContextMenuUser)(null == R ? void 0 : R.author.id, I.id), F = (0, g.useClickReply)(M, R, b), H = (0, g.useClickReferencedMessageAuthorUsername)(R, I, L, x), U = (0, g.useClickReferencedMessageAuthorAvatar)(v, x), k = s.useCallback(() => x({
                    referencedUsernameProfile: !1,

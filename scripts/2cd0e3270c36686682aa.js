    ...
    ["49091"], {
        ...
        369404: function(e, t, n) {
            ...
            function R(e) {
                ...
                } = (0, d.useManageResourcePermissions)(null != R ? R : t), H = w(P), b = (0, C.default)(P), B = (0, G.useIsChannelPublic)(null == R ? void 0 : R.id, P.id), {
                    withinStartWindow: Y
                } = (0, L.getEventTimeData)(y), F = (0, r.useStateFromStores)([_.default], () => (null == R ? !void 0 : !R.isGuildVocal()) || _.default.can(p.Permissions.CONNECT, R), [R]), j = (0, s.useShowMemberVerificationGate)(x), k = (0, v.default)(m, O);

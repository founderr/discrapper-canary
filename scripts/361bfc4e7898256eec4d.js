    ...
    [50648], {
        ...
        350648: (e, t, n) => {
            ...
            function te(e) {
                ...
                i.useEffect((function() {
                    var e, t = (e = W((function() {
                        ...
                        return ee(this, (function(a) {
                            switch (a.label) {
                                case 0:
                                    e = l().basename(new URL(n).pathname);
                                    return [4, fetch(n)];
                                case 1:
                                    ...
                                    return ee(this, (function(r) {
                                        switch (r.label) {
                                            ...
                                            case 2:
                                                ...
                                                r.label = 3;
                                            case 3:
                                                m.Z.clearAll(n, T.d.ChannelMessage);
                                                r.label = 4;
                                            case 4:
                                                return [2]
                                        }
                ...
                i.useEffect((function() {
                    s === f.ModalTransitionState.EXITING && ae()
                }), [ae, s]);
                                ...
                                return ee(this, (function(l) {
                                    switch (l.label) {
                                        ...
                                        case 1:
                                            ...
                                            l.label = 2;
                                        case 2:
                                            o = C.Z.getUploads(a, T.d.ChannelMessage);
                                            s = E.Z.getChannel(a);
                                            y.Z.uploadFiles({
                                                channelId: a,
                                                uploads: o,
                                                parsedMessage: null != w ? S.ZP.parse(s, F.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_MOMENT_FROM_APP.format({
                                            ...
                                            m.Z.clearAll(a, T.d.ChannelMessage);
                                            return [2]
                                    }
                                }))
                            }));
                        ...
                        return ee(this, (function(s) {
                            switch (s.label) {
                                case 0:
                                    ...
                                    N.default.track(G.rMx.ACTIVITY_SHARE_MOMENT_SEND, {
                                ...
                                case 2:
                                    s.sent();
                                    null != w && (0, f.showToast)((0, f.createToast)(F.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_MOMENT_FROM_APP.format({
                                        applicationName: w.name
                                    }), f.ToastType.SUCCESS));
                                    return [3, 4];
                                case 3:
                                    a = s.sent();
                                    (0, f.showToast)((0, f.createToast)(F.Z.Messages.UPLOAD_ERROR_TITLE, f.ToastType.FAILURE));
                                    throw a;
                                case 4:
                                    oe();
                                    return [2]
                                ...
                                switch (r.label) {
                                    ...
                                    case 2:
                                        if ((n = Q(R)).includes(e.item.id)) {
                                            m.Z.clearAll(t, T.d.ChannelMessage);
            ...
            function ne(e) {
                ...
                switch (t.type) {
                    ...
                    case D.bm.FRIEND:
                        ...
                        l = U.ZP.getName(t.item);
                        u = U.ZP.getUserTag(t.item);
                        break;
                    case D.bm.GROUP_DM:
                        var c = (0, g.x)(t.item),
                        ...
                        l = (0, I.F6)(t.item, A.default, O.Z);
                        break;
                    case D.bm.CHANNEL:
                        var p = t.item,
                            m = w.Z.getGuild(p.guild_id);
                        if (null == m) return null;
                        l = "#".concat((0, I.F6)(p, A.default, O.Z));
                        u = m.name;
                        if (null != m.icon) {
                ...
                return (0, r.jsxs)(f.Clickable, {
                    onClick: n,
                    className: o()(V().rowContainer, Y({}, V().disabled, a)),
                    children: [(0, r.jsxs)("div", {
                        className: V().rowLeft,
                        children: [(0, r.jsx)("div", {
                            ...
                            children: [(0, r.jsx)(f.Text, {
                                variant: "text-md/semibold",
                                className: o()(V().rowName, Y({}, V().disabled, a)),
                                children: l
                            }), (0, r.jsx)(f.Text, {
                                variant: "text-xs/medium",
                                className: o()(V().rowSubName, Y({}, V().disabled, a)),
                                children: u
                            })]
                        })]
                    }), (0, r.jsx)(f.Checkbox, {
            ...
            function re(e) {
                ...
                function d() {
                    return (d = W((function() {
                        return ee(this, (function(e) {
                            switch (e.label) {
                                case 0:
                                    N.default.track(G.rMx.ACTIVITY_SHARE_MOMENT_COPY, {
                                        user_id: null == u ? void 0 : u.id,
                                        application_id: t,
                                        activity_session_id: a
                                    });
                                    return [4, k.ZP.copyImage(n)];
                                case 1:
                                    e.sent();
                                    l(!0);
                                    return [2]
                ...
                return P.FB && k.ZP.canCopyImage(n) ? (0, r.jsxs)(f.Button, {
                    ...
                    children: [s ? (0, r.jsx)(M.Z, {}) : (0, r.jsx)(x.Z, {}), s ? F.Z.Messages.COPIED : F.Z.Messages.COPY_IMAGE_MENU_ITEM]
                }) : (0, r.jsx)("div", {})
            }
        },
        537335: (e, t, n) => {
            ...
            var S, E, T, w, _, O, C, A = new Set,
                j = [],
                M = new Map;

            function x(e) {
                var t = new Set,
                    n = null == w || C === d.Iq.EMBEDDED_APPLICATION ? void 0 : w.id,
                    r = (0, s.rh)(A, n);
            ...
            var Z = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        ...
                        userIdsToOmit: A,
                        inviteSuggestions: j,
                        inviteSuggestionsMap: M,
                        initialCounts: S,
                        totalCount: E,
                        isFiltered: T,
                        currentGuild: w,
                        currentChannel: _,
                        currentApplicationId: O,
                        currentInviteTargetType: C
                    }
                };
                return n
            }(r.ZP.Store);

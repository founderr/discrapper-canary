    ...
    [58083], {
        ...
        858083: (e, t, a) => {
            ...
            const r = function(e, t, a) {
                ...
                return null != a && a.addSuffix ? a.comparison && a.comparison > 0 ? "след " + r : "преди " + r : r
            };
            var i = a(849526);
            const o = {
                date: (0, i.Z)({
            ...
            var u = a(619013),
                s = a(783772),
                d = ["неделя", "понеделник", "вторник", "сряда", "четвъртък", "петък", "събота"];
            ...
            var h = {
                lastWeek: function(e, t, a) {
                    var n = (0,
                            u.default)(e),
                        r = n.getUTCDay();
                    return (0, s.Z)(n, t, a) ? c(r) : function(e) {
                        var t = d[e];
                        switch (e) {
                            case 0:
                            case 3:
            ...
            const y = {
                ordinalNumber: function(e, t) {
                    ...
                    if (0 === a) return m(0, n, "ев", "ева", "ево");
                    if (a % 1e3 == 0) return m(a, n, "ен", "на", "но");
                    if (a % 100 == 0) return m(a, n, "тен", "тна", "тно");
                    var r = a % 100;
                    if (r > 20 || r < 10) switch (r % 10) {
                        case 1:
                            return m(a, n, "ви", "ва", "во");
                        case 2:
                            return m(a, n, "ри", "ра", "ро");
                        case 7:
                        case 8:
                            return m(a, n, "ми", "ма", "мо")
                    }
                    return m(a, n, "ти", "та", "то")
                },
                era: (0, l.Z)({
                    values: {
                        narrow: ["пр.н.е.", "н.е."],

            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var l, s, c, d, f, h, E, v, I, _, p, g, m, S, R, M, N = (l = u, f = Array(32768), l.forEach(function(n) {
                            ...
                            for (var i, o = 1, u = 0; u < 1e3;) {
                                ...
                                var a = function(t, n) {
                                        ...
                                        function I(t) {
                                            ...
                                            for (l = n[a]; l <= n[s]; l++)
                                                if (E[l] > h / 2) {
                                                    for (i = n.copy(), o = n.copy(), e = l - n[a], u = e <= (r = n[s] - l) ? Math.min(n[s] - 1, ~~(l + r / 2)) : Math.max(n[a], ~~(l - 1 - e / 2)); !E[u];) u++;
            ...
            let l = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
                ...
                h = (t, e) => {
                    ...
                    let u = o.SUPPORTS_WEBP ? "webp" : "png",
                        d = "",
                        f = "quality=lossless";
                    return (null != e && (d = "size=" + (0, i.getBestMediaProxySize)(e * (0, i.getDevicePixelRatio)()), f = c ? "" : "&" + f), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(l, "/").concat(n, "/").concat(r, ".").concat(u, "?").concat(d).concat(f) : "".concat(s).concat(a.Endpoints.ROLE_ICON(n, r), "?").concat(d)
                },
                E = t => t.startsWith(l) || t.startsWith("".concat(s, "/roles")) && t.includes("/icons/"),
                v = (t, e) => {
                    var n;
                ...
                let {
                    ...
                    fire: (r, i, o) => {
                        ...
                        let l = (null == o ? void 0 : o.settings) != null ? {
                            ...
                            s = n(l);
                        t(r, i, s, (null !== (u = null == o ? void 0 : o.count) && void 0 !== u ? u : l.confettiCount) * (null !== (a = null == o ? void 0 : o.countMultiplier) && void 0 !== a ? a : 1), {

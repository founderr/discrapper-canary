    ...
    [70409], {
        ...
        628177: (e, t, n) => {
            ...
            const b = (0, l.hN)((function(e) {
                ...
                return (0, c.jsxs)("svg", p(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            function A(e, t, n) {
                return function(e) {
                    ...
                    headerText: null !== (r = m(e)) && void 0 !== r ? r : "",
                    descriptionText: null !== (o = S(e, n)) && void 0 !== o ? o : "",
                    helperText: null !== (i = j(e, t)) && void 0 !== i ? i : null,
                    icon: null !== (u = M(e)) && void 0 !== u ? u : g.Z,
                    isEditable: _(e)
                } : null;
                var r, o, i, u
            }
        ...
        272112: (e, t, n) => {
            ...
            function G(e, t, n) {
                ...
                E.S.dispatchToLastSubscribed(m.CkL.TEXTAREA_FOCUS)
            }
        ...
        70409: (e, t, n) => {
            ...
            function F(e, t) {
                ...
                var G, F, K = e.split(" ").length,
                    B = function() {
                        if (null != t) {
                            (0, a.Zy)();
                            M.Z.open(t, A.pNK.GUILD_AUTOMOD);
                            setTimeout((function() {
                                s(t, k, {
                                    triggerMetadata: {
                                        keywordFilter: [e],
            ...
            function ge(e, t) {
                var n, i, a, c, l = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : E.O.NORMAL,
                ...
                return (0, r.jsx)(u.MenuItem, {
                    ...
                    label: v ? m || b > 0 ? I.Z.Messages.ADD_BURST_REACTION : I.Z.Messages.GET_SUPER_REACTIONS : I.Z.Messages.ADD_REACTION,
                    action: function() {
                        if (h) {
                            if (m) {
            ...
            function Ge(e, t) {
                ...
                var a, c = $.nc.useSetting(),
                    ...
                    s = (0, H.e7)([Q.Z], (function() {
                        return c && l && (t.isPrivate() || Q.Z.can(A.Plq.ADD_REACTIONS, t))
                    }), [t, l, c]);
            ...
            function ze(e, t) {
                var n, i, a, c = o.useContext(u.AccessibilityPreferencesContext).reducedMotion,
                    l = (0, J.$R)(t),
                    s = (0, H.e7)([Q.Z], (function() {
                        return Q.Z.can(A.Plq.MANAGE_MESSAGES, t) && l
                    }), [t, l]),
                ...
                var t = e.message,
                    ...
                    k = function(e, t) {
                        ...
                        return (0, we.Z)(e, n) && o && !i ? (0, r.jsx)(u.MenuItem, {
                            ...
                            action: function() {
                                return je.Z.startEditMessage(t.id, e.id, e.content)
                            },
                            icon: Ae.Z
                        }) : null
                    }(t, n),
        ...
        734777: (e, t, n) => {
            ...
            function j(e) {
                var t = e.type,
                    n = e.id,
                    h = e.name,
                    j = e.isInExpressionPicker,
                    M = void 0 !== j && j,
                    A = (0, c.O)().location,
                    w = o.useMemo((function() {
                        return m(_({}, A), {
                            section: M ? E.jXE.EXPRESSION_PICKER : E.jXE.CONTEXT_MENU
                        })
                    }), [A, M]),
                    I = (0, b.Go)(),
        ...
        893516: (e, t, n) => {
            ...
            var v = function(e, t) {
                ...
                S = "".concat(h, "/stickers"),
                j = new Set(["jpg", "jpeg", "png", "webp", "gif", "tiff", "bmp"]),
            ...
            function P(e, t, n) {
                ...
                if (!l.FB || null == e || !(i = e, s = new URL(i), b = A(i), (_.test(s.hostname) || s.origin === m) && !i.startsWith(S) && !(0, u.zt)(i) && null != b && j.has(b))) return null;
                var g, M = function(e) {
                        var t = new URL(e);
                    ...
                    P = (g = y((function() {
                        ...
                        return v(this, (function(t) {
                            switch (t.label) {
                                case 0:
                                    t.trys.push([0, 2, , 3]);
                                    return [4, f.ZP.saveImage(M)];
                                case 1:
                                    t.sent();
                                    c.default.track(p.rMx.CONTEXT_MENU_IMAGE_SAVED, E({}, (0, d.v)()));
                                    return [3, 3];
                                case 2:
                                    e = t.sent();
                                    c.default.track(p.rMx.CONTEXT_MENU_IMAGE_SAVE_FAILED, E({}, (0, d.v)()));
                        ...
                        var e = y((function() {
                            ...
                            return v(this, (function(t) {
                                switch (t.label) {
                                    case 0:
                                        t.trys.push([0, 2, , 3]);
                                        return [4, f.ZP.copyImage(M)];
                                    case 1:
                                        t.sent();
                                        c.default.track(p.rMx.CONTEXT_MENU_IMAGE_COPIED, E({}, (0, d.v)()));
                                        return [3, 3];
                                    case 2:
                                        e = t.sent();
                                        I(O.Z.Messages.ERROR_COPYING_IMAGE, e);
                                        c.default.track(p.rMx.CONTEXT_MENU_IMAGE_COPY_FAILED, E({}, (0, d.v)()));
                                        return [3, 3];
                                    case 3:
                                        return [2]
                                }

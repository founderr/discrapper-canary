...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [32632, 89005, 29202, 91683, 58635], {
        ...
        980604: (e, t, n) => {
            ...
            function K() {
                k = m.Z.getGuildCount() >= 3 || o().size(f.Z.getMutablePrivateChannels()) >= 20;
                z = []
            }
            ...
            function X() {
                var e, t, n = null !== (e = C.Z.getGuildId()) && void 0 !== e ? e : void 0,
                    r = null !== (t = w.Z.getChannelId()) && void 0 !== t ? t : void 0;
                switch (G) {
                    case l.h8.USER:
                        var i = b.default.getId();
                ...
                for (var u = [], c = [], a = 1; a < B.length; a += 1) {
                    var s = Y(B[a]);
                    null != s && ((s.type !== l.h8.TEXT_CHANNEL && s.type !== l.h8.VOICE_CHANNEL || I.Z.can(y.Plq.VIEW_CHANNEL, s.record)) && c.push(s))
                }
                if (c.length > 0) {
                    var d;
                    (d = u).push.apply(d, [(0, l.o6)(T.Z.Messages.QUICKSWITCHER_LAST_CHANNEL)].concat(D(c)))
                }
                var p = function(e) {
                    var t = [];
                    ...
                    return e === r || B.includes(e)
                }));
                if (p.length > 0) {
                    var v;
                    (v = u).push.apply(v, [(0, l.o6)(T.Z.Messages.QUICKSWITCHER_DRAFTS)].concat(D(p)))
                }
                var E = S.ZP.getMentionChannelIds().filter((function(e) {
                    return e !== r && !B.includes(e)
                })).map((function(e) {
                    return Y(e)
                })).filter(_.lm).reverse();
                if (E.length > 0) {
                    u.push((0, l.o6)(T.Z.Messages.QUICKSWITCHER_MENTIONS));
                    u = u.concat(E)
                }
                if (null != n) {
                    var m = g.ZP.getSelectableChannelIds(n).filter((function(e) {
                        var t = f.Z.getChannel(e);
                        return !(null == t || e === r || B.includes(e) || j.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && j.Z.isChannelMuted(t.guild_id, t.parent_id)) && S.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return Y(e)
                    })).filter((function(e) {
                        return e
                    ...
                    if (m.length > 0) {
                        u.push((0,
                            l.o6)(T.Z.Messages.QUICKSWITCHER_UNREAD_CHANNELS));
                        u = u.concat(m)
                    }
                }
            ...
            function $(e, t) {
                switch (G) {
                    case l.h8.USER:
                        var n = m.Z.getGuild(C.Z.getGuildId());
                        e.unshift((0, l.o6)(null != n ? T.Z.Messages.QUICKSWITCHER_QUERYMODE_USERS_IN_GUILD.format({
                            name: n.name
                        }) : T.Z.Messages.QUICKSWITCHER_QUERYMODE_USERS));
                        W = e;
                        break;
                    case l.h8.TEXT_CHANNEL:
                        e.unshift((0, l.o6)(T.Z.Messages.QUICKSWITCHER_QUERYMODE_TEXT_CHANNELS));
                        W = e;
                        break;
                    case l.h8.VOICE_CHANNEL:
                        e.unshift((0, l.o6)(T.Z.Messages.QUICKSWITCHER_QUERYMODE_VOICE_CHANNELS));
                        W = e;
                        break;
                    case l.h8.GUILD:
                        e.unshift((0, l.o6)(T.Z.Messages.QUICKSWITCHER_QUERYMODE_GUILDS));
                        W = e;
                        break;
                    case l.h8.APPLICATION:
                        e.unshift((0, l.o6)(T.Z.Messages.QUICKSWITCHER_QUERYMODE_APPLICATIONS));
                        W = e;
                        break;
                    default:
                        W = e
                ...
                if (t !== Q) {
                    ...
                    x = (0, l.gJ)(l.a8.DOWN, -1, W)
                } else {
                    var r = W[x];
                    null != r && r.type === l.h8.HEADER && (x = (0, l.gJ)(l.a8.DOWN, x, W))
                }
                re.emitChange()
            }
            ...
            function J(e) {
                var t, n = e.query,
                    ...
                    i = new Set(["user:".concat(b.default.getId())]);
                null != o && i.add("guild:".concat(o));
                M = null != M ? M : new l.ZP(ee, null, null != r ? 100 : 5, {
                    frecencyBoosters: !0,
                    blacklist: i
                });
                Q = null;
            ...
            var ne = function(e) {
                ...
                r.initialize = function(e) {
                    this.waitFor(E.ZP, m.Z, f.Z);
                    this.syncWith([v.Z], (function() {
                        return !0
                    }));
                    F = u.Z.get(V) || !1;
                    var t;
                    B = null !== (t = null == e ? void 0 : e.channelHistory) && void 0 !== t ? t : []
                };
                r.getState = function() {
                    return {
                        channelHistory: B
            ...
            var re = new ne(c.Z, {
                ...
                QUICKSWITCHER_SEARCH: function(e) {
                    ...
                    if (G !== r) {
                        ...
                        var i, u = null !== (i = C.Z.getGuildId()) && void 0 !== i ? i : void 0;
                        r === l.h8.USER && null != u ? M.setOptions({
                            userFilters: {
                                guild: u,
                                friends: !0
                            }
                        }, !0) : r === l.h8.VOICE_CHANNEL ? M.setOptions({
                    ...
                    G = r;
                    M.search(n, G === l.h8.USER ? o : void 0)
                },

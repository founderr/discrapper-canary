    ...
    ["93710"], {
        ...
        342676: function(e, t, a) {
            ...
            var g = e => {
                ...
                return (0, i.match)([a, x > 1]).with([s.CARD, !0], () => null).with([s.BANNER, !0], () => {
                ...
                return (0, s.jsxs)("div", {
                    ...
                    children: [null != L ? (0, s.jsx)(p, {
                        ...
                        children: (0, s.jsx)(p, {
                            amount: b.amount,
                            currency: b.currency,
                            priceTextDecorator: v ? e => E.default.Messages.COLLECTIBLES_NON_PREMIUM_PRICE.format({
                                price: e
                            }) : void 0,
        ...
        258556: function(e, t, a) {
            ...
            function J(e) {
                let {
                    ...
                    className: a,
                    isPremiumUser: r
                } = e, o = O.default.getProductsByItemType(t.skuId), c = (0, F.usePurchasedProductsSort)(null != o && i.CollectiblesItemType.AVATAR_DECORATION in o ? o[i.CollectiblesItemType.AVATAR_DECORATION] : []), f = (0, F.usePurchasedProductsSort)(null != o && i.CollectiblesItemType.PROFILE_EFFECT in o ? o[i.CollectiblesItemType.PROFILE_EFFECT] : []), m = f.length > 0, C = (0, B.isPremiumCollectiblesCategory)(t), E = [...m ? [u.DismissibleContent.PROFILE_EFFECT_SHOP_NEW_BADGE] : [], ...m && C ? [u.DismissibleContent.DISXCORE_PROFILE_EFFECTS_NEW_BADGE] : []], [g, p] = (0, h.useDismissibleContentGroup)(E);
                return (l.useEffect(() => () => {
            ...
            var $ = function(e) {
                ...
                } = (0, p.default)([...r, g.default.COLLECTIBLES_SHOP]), O = (0, c.default)([b.default], () => b.default.getLayers().includes(Y.Layers.COLLECTIBLES_SHOP)), {
                    source: F
        ...
        434393: function(e, t, a) {
            ...
            function X(e) {
                ...
                } = (0, m.default)(f.default.COLLECTIBLES_SHOP_CARD), I = l.useRef(null), X = (0, d.default)(I), [Z, q] = l.useState(!1), J = X || Z, Q = (0, o.default)([L.default], () => L.default.getCurrentUser()), $ = t.items.find(O.isAvatarDecorationRecord), ee = t.items.find(P.isProfileEffectRecord), {
                ...
                let em = (0, x.default)({
                    ...
                    eC = () => {
                        ...
                        else if (null != ee)(0, T.openProfileEffectModal)({
                            analyticsLocations: v,

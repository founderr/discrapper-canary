    ...
    ["88862"], {
        ...
        962199: function(e, t, n) {
            ...
            let o = !1,
                ...
                f = {},
                E = {},
                C = e => (E[e.guild_scheduled_event.id] = new a.default(e.guild_scheduled_event.guild), f[e.guild_scheduled_event.id] = e.guild_scheduled_event, {
        ...
        889486: function(e, t, n) {
            ...
            function o(e, t) {
                ...
                u(null != o, "attempted to transfer to unknown channel"), e.selfMute !== r.default.isSelfMute() && i.default.toggleSelfMute(), e.selfDeaf !== r.default.isSelfDeaf() && i.default.toggleSelfDeaf(), (0, s.default)(o, "discord_client", l), d.default.selectVoiceChannel(o, !1)
            }
        },
        261552: function(e, t, n) {
            ...
            function r() {
                let e = (0, l.useStateFromStores)([u.default], () => u.default.getId()),
                    t = (0, l.useStateFromStores)([d.default], () => d.default.getRemoteSessionId());
        ...
        742898: function(e, t, n) {
            ...
            function r() {
                return (0, l.useStateFromStoresArray)([u.default], () => [u.default.getAccount(null, d.PlatformTypes.XBOX), u.default.getAccount(null, d.PlatformTypes.PLAYSTATION), u.default.getAccount(null, d.PlatformTypes.PLAYSTATION_STAGING)].filter(i.isNotNullish))
            }
        },
        424024: function(e, t, n) {
            ...
            function r(e) {
                return null != e ? e === d.GameConsoleTypes.XBOX ? i.default : u.default : l.default
            }
        },
        379304: function(e, t, n) {
            ...
            function v(e) {
                let t = (0, u.default)([a.default], () => a.default.getChannelId() === e.id),
                    ...
                    _ = (0, r.default)(e),
                    I = (0, u.default)([s.default], () => s.default.isInChannel(e.id)),
                    T = !I && _ || N,
                    g = (0, f.default)();
                if (!h && 0 === g.length) return null;
                let m = t => {
                    if (!t.twoWayLink || t.revoked) {
                        (0, d.default)(t.type, "Console Transfer Item");
                        return
                    }
                    t.type === C.PlatformTypes.XBOX ? (0, i.openModalLazy)(async () => {
                        let {
                            default: t
                    ...
                    }) : (t.type === C.PlatformTypes.PLAYSTATION || t.type === C.PlatformTypes.PLAYSTATION_STAGING) && (0, i.openModalLazy)(async () => {
                        let {
                            default: u
        ...
        49129: function(e, t, n) {
            ...
            function r(e, t, n, l) {
                ...
                let o = i.default.extractTimestamp(e.id),
                    c = Math.min((null != n ? n : o) + d.NEW_EVENT_WINDOW_MILLISECONDS, a),
                    f = r.isBetween(o, c);
                if (f && null == t && !l) return d.UpcomingGuildEventNoticeTypes.NEW_EVENT
            }
        },
        ...
        534222: function(e, t, n) {
            ...
            function _(e, t) {
                return (0, u.useStateFromStoresArray)([a.default, i.default, c.default, s.default, d.default, r.default], () => {
            ...
            function I(e) {
                return (0, u.useStateFromStores)([c.default, d.default, s.default], () => {
            ...
            function g(e) {
                var t, n;
                let l = (t = e, (0, u.useStateFromStoresArray)([c.default, d.default, s.default], () => {
                    ...
                    a = (0, u.useStateFromStoresObject)([c.default], () => null == l ? {} : l.reduce((e, t) => {
        ...
        495194: function(e, t, n) {
            ...
            function s(e) {
                return (0, l.useStateFromStores)([i.default], () => null == e || !i.default.can(a.Permissions.CONNECT, e), [e])
            }

            function o(e) {
                return (0, l.useStateFromStores)([d.default, u.default], () => (0, r.isChannelFull)(e, d.default, u.default))
            }
        },

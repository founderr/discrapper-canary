    ...
    [33600], {
        133600: (e, t, n) => {
            ...
            var V = function(e, t) {
                ...
                Q = function(e) {
                    ...
                    function n() {
                        ...
                        e.handleGoToLibrary = function() {
                            ...
                            (0, d.uL)(N.Z5c.APPLICATION_LIBRARY, {
                                state: {
                        ...
                        e.getAnimationStatus = function() {
                            return e.step === N.wZ8.OPEN ? w.SR.IDLE : w.SR.ACTION
                        };
                        return e
                    }
                    var i = n.prototype;
                    ...
                    i.render = function() {
                        var e, t, n = this.props,
                            ...
                            g = b.default.getUser(l.userId),
                            y = this.state,
                            m = y.isCustomGift,
                            v = y.accepted,
                            C = y.opened,
                            S = b.default.getCurrentUser(),
                            I = null != (null == l ? void 0 : l.userId) && null != S && null != (null == S ? void 0 : S.id) && l.userId === S.id;
                        switch (this.step) {
                            case N.wZ8.ERROR:
                                null == d || d(l, !1);
                                break;
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(c.ModalRoot, {
                                ...
                                className: T().modal,
                                "aria-labelledby": u,
                                children: [null != l.giftStyle && !m && (0, r.jsx)(x.Z, {
                                    defaultAnimationState: this.getAnimationStatus(),
                                    giftStyle: l.giftStyle,
                                    className: T().seasonalGiftIcon
                                }), (0, r.jsx)("div", {
                                    className: m ? void 0 : T().backSplash
                                }), (0, r.jsxs)(c.ModalContent, {
                                    className: s()((e = {}, A(e, T().content, !m), A(e, T().contentCustomGift, m), e)),
                                    children: [(0, r.jsx)(c.ModalCloseButton, {
                                        ...
                                        id: u,
                                        className: s()((t = {}, A(t, T().customGiftHeader, m && !v), A(t, T().header, !m || v), t)),
                                        variant: "heading-sm/semibold",
                                        children: [(0, r.jsx)("div", {
                                            className: s()(A({}, T().customGiftHeaderText, m)),
                                    ...
                                    }), m && null != l.giftStyle && !v && (0, r.jsx)(x.Z, {
                                        defaultAnimationState: this.getAnimationStatus(),
                                        className: T().giftAnimation,
                                        giftStyle: l.giftStyle
                                    }), m && C && !v && null != h && "" !== h && (0, r.jsxs)(r.Fragment, {
                                        children: [(0, r.jsx)(c.FormTitle, {
                                            children: Z.Z.Messages.GIFT_SENDER_INFO.format({
                                                senderDisplayName: j.ZP.getName(g)
                                            })
                                        }), (0, r.jsx)(c.Heading, {
                                            id: u,
                                            className: T().customMessage,
                                            variant: "heading-sm/bold",
                                            children: this.props.customGiftMessage
                                        })]
                                    }), m && this.state.opened && !this.state.accepted && null != h && "" !== h && !I && (0, r.jsxs)(r.Fragment, {
                                        children: [(0, r.jsx)(c.FormTitle, {
                                            children: Z.Z.Messages.GIFT_SENDER_INFO.format({
                                                senderDisplayName: j.ZP.getName(g)
                                            })
                        ...
                        get: function() {
                            ...
                            if (t && !r) {
                                ...
                                return Z.Z.Messages.GIFT_RECIPIENT_INFO.format({
                                    recipientDisplayName: j.ZP.getName(b.default.getCurrentUser())
                                })
                            }
                            return null == this.props.sku ? null : (0,
                                S.dQ)(this.step, this.props.giftCode, this.props.sku)
                        }
                    }, {
                        key: "secondHeaderText",
                        get: function() {
                            if (!this.state.isCustomGift || this.state.opened || this.state.accepted) return null;
                            var e = b.default.getUser(this.props.giftCode.userId);
                            return Z.Z.Messages.GIFT_SENDER_INFO.format({
                                senderDisplayName: j.ZP.getName(e)
                            })
                        }
                    }, {
                        key: "bodyText",
                ...
                W = a.ZP.connectStores([y.Z, v.Z, h.Z, g.Z, m.Z, p.Z], (function(e) {
                    var t = e.giftCode,
                        n = v.Z.get(t.skuId),
                    ...
                    return {
                        ...
                        application: r,
                        subscriptionPlan: null != t.subscriptionPlanId ? (0, I.oE)(t.subscriptionPlanId) : null,
                        accepting: g.Z.getIsAccepting(t.code),
                        useReducedMotion: i
                    }
                }))(Q);
            const $ = function(e) {
                ...
                return null == c ? null : (0, r.jsx)(W, L(function(e) {

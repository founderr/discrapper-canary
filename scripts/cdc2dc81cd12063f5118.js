        ...
        652411: (e, t, n) => {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = R(e.minStart),
                                ...
                                _ = R(e.minDirection),
                                k = R(e.maxDirection);
                            return new y(new g(b(n.x, i.x), b(d.x, f.x), b(p.x, h.x), b(v.x, m.x), z(_.x, k.x), C(e.easingFunctions)[0]), new g(b(n.y, i.y), b(d.y, f.y), b(p.y, h.y), b(v.y, m.y), z(_.y, k.y), C(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = _(e.minStart),
                                ...
                                R = _(e.minDirection),
                                k = _(e.maxDirection);
                            return new m(new g(b(n.x, i.x), b(d.x, f.x), b(p.x, h.x), b(v.x, y.x), z(R.x, k.x), C(e.easingFunctions)[0]), new g(b(n.y, i.y), b(d.y, f.y), b(p.y, h.y), b(v.y, y.y), z(R.y, k.y), C(e.easingFunctions)[0]), new g(b(n.z, i.z), b(d.z, f.z), b(p.z, h.z), b(v.z, y.z), z(R.z, k.z), C(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var E = i.forwardRef((function(e, t) {
                var a = e.className,
                    ...
                    b = i.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == f || f(t), m.current.forEach((function(n, i) {
                                    var r = n.confetti,
                                        a = n.spriteCanvas;
                                    r.update(o), r.draw(a, t), r.shouldDestroy(e, o) && m.current.delete(i)
                                })), null == p || p(t), m.current.size > 0 ? w.current = window.requestAnimationFrame(b) : (t.clearRect(0, 0, e.width, e.height), w.current = null);
                                var n = Date.now();
                ...
                return i.useEffect((function() {
                    ...
                    return e("click", P, l), e("mousedown", E, c), e("mousemove", M, s), e("mouseup", O, d),
                        function() {
                            window.removeEventListener("click", P), window.removeEventListener("mousedown", E), window.removeEventListener("mousemove", M), window.removeEventListener("mouseup", M)
                        }
                }), [P, E, M, O, l, c, s, d]), i.useEffect((function() {
                    var e = y.current,
            ...
            var M = i.forwardRef((function(e, t) {
                            ...
                            h.current.forEach((function(e, n) {
                                var i = function(i, r) {
                                    ...
                                    if (t.drawImage(e.image, a, o, d, f), null != i) {
                                        for (var u = t.getImageData(a, o, d, f), l = function(e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
                                                    r: t >> 16 & 255,
                ...
                }), [s.length, f, d, c.length]), i.createElement("canvas", {
                    ref: p,

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["4633"], {
        ...
        991630: function(t, e, n) {
            ...
            function E(t) {
                let {
                    ...
                    onMouseLeave: N,
                    ...p
                } = t, [A, C] = u.useState(!1), h = u.useCallback(() => {
                    C(!0), null == T || T()
                }, [T]), m = u.useCallback(() => {
                    C(!1), null == _ || _()
                }, [_]), O = u.useCallback(() => {
        ...
        497660: function(t, e, n) {
            ...
            function f(t, e, n) {
                let f = s.default.getGuild(e),
                    T = (0, a.useStateFromStores)([d.default], () => null != f ? d.default.can(c.Permissions.MANAGE_GUILD, f) : null),
                    _ = u.useCallback(() => {
                ...
                return t.bot && T && !S ? (0, i.jsx)(r.MenuItem, {
        ...
        424562: function(t, e, n) {
            ...
            var m = new h(I.default, {
                GUILD_IDENTITY_SETTINGS_INIT: function(t) {
                    s = t.guild, T = f.FormStates.OPEN, _ = {}, d = t.source, c = t.analyticsLocations
                },
        ...
        752598: function(t, e, n) {
                    ...
                    if (!i.hasErr) {
                        ...
                        if (i.status >= 400 && i.status < 500 && i.body) {
                            if (i.body.code === _.AbortCodes.INVALID_FORM_BODY && i.body.errors) {
                                let u = (0, T.getFirstSkemaError)(i.body.errors);
            ...
            (u = i || (i = {}))[u.SENDING = 0] = "SENDING", u[u.CREATED = 1] = "CREATED", u[u.FAILED = 2] = "FAILED", u[u.TIMED_OUT = 3] = "TIMED_OUT";
            let C = (t, e) => {
                var n;
                let u = null == e ? void 0 : e.state,
                ...
                let l = t.state === _.MessageStates.SEND_FAILED && (null == (n = t.id) || "" === n || Number.isNaN(n) ? Date.now() : a.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    d = t.isCommandType();
                if (o && u === f.InteractionState.QUEUED || d && t.state === _.MessageStates.SENDING && null != e) return i.SENDING;
                if (o && u === f.InteractionState.CREATED || t.hasFlag(_.MessageFlags.LOADING) && !r) return i.CREATED;
                if (null != t.interaction && t.hasFlag(_.MessageFlags.LOADING) && r) return i.TIMED_OUT;
                else if (null != t.interaction && !t.hasFlag(_.MessageFlags.LOADING) && l) return i.TIMED_OUT;
                else if (d && t.state === _.MessageStates.SEND_FAILED) return i.FAILED
            };
        ...
        85166: function(t, e, n) {
            ...
            function f(t, e, n) {
                ...
                let T = r.default.getChannel(n),
                    ...
                    N = (null === (f = s.default.getCurrentUser()) || void 0 === f ? void 0 : f.id) === t.id,
                    p = (0, u.useStateFromStores)([o.default], () => null != n && o.default.canWithPartialContext(E.Permissions.MUTE_MEMBERS, {
                        channelId: n
                    }), [n]);
                return null != T && null != _ && (p || N) && S.speaker ? (0, i.jsx)(a.MenuItem, {
                    id: "audience",
                    ...
                    action: () => {
                        N ? (0, d.moveSelfToAudience)(T) : (0, d.moveUserToAudience)(t, T)
                    }
                }) : null
            }
        },
            ...
            var u = n("77078"),
                ...
                H = (0, l.default)((0, r.default)(function(t) {
                    let {
                        ...
                        onSelect: Y,
                        onHeightUpdate: V
                    } = t, K = (0, v.default)(e.id, n, r.id), W = (0, y.default)(e, n, k), Q = (0, R.default)(e.id, k), X = (0, F.default)(e.id), z = (0, D.default)(e, k), Z = (0, h.default)({
                        user: e,
                        guildId: n,
                        context: k
                        ...
                        context: k
                    }), te = (0, g.default)(e, n), tn = (0, s.default)(null, e), ti = (0, A.default)(e), tu = (0, M.default)(e), ta = (0, m.default)(e, n, r.id), tr = (0, P.default)(e.id, n), tl = (0, L.default)(e, n), to = (0, T.default)({
                        id: e.id,
                        label: B.default.Messages.COPY_ID_USER
                    }), ts = (0, G.default)(e.id, r.id), td = (0, E.default)(e.id), tc = (0, c.default)(r.id), tE = (0, N.default)(e), tI = (0, p.default)(e, n, r.id), tf = (0, O.default)({
                        commandType: o.ApplicationCommandType.USER,
                        commandTargetId: e.id,
                        channel: r,
                        guildId: n,
                        onShow: V
                    }), tT = (0, I.default)(e.id), t_ = (0, S.default)(e, n, k), tS = e.isNonUserBot(), tN = e.isClyde(), tp = (0, f.useIsDMsToClydeEnabled)();
                    return (0, i.jsxs)(u.Menu, {
                        ...
                        children: [!tS && (0, i.jsxs)(i.Fragment, {
                            children: [(0, i.jsxs)(u.MenuGroup, {
                                ...
                                children: [j && K, d && W, Q, z, j && Z, j && q, X]
                            }), l && (0, i.jsx)(u.MenuGroup, {
                                children: J
                            }), (0, i.jsx)(u.MenuGroup, {
                                children: j && tn
                            }), (0, i.jsxs)(u.MenuGroup, {
                                children: [l && $, l && ts, j && tt, tf, t_, j && te, ti, j && tu, H && tT]
                            }), (0, i.jsx)(u.MenuGroup, {
                                children: ta
                            }), (0, i.jsxs)(u.MenuGroup, {
                                children: [tr, tl]
                            }), H && (0, i.jsxs)(u.MenuGroup, {
                                children: [tc, td]
                            })]
            ...
            var i = n("37983"),
                ...
                p = t => {
                    let {
                        ...
                        guildId: p,
                        onShow: A
                    } = t, C = u.useRef(!1), h = u.useRef(0), m = (0, l.useStateFromStores)([T.default], () => T.default.getGuild(null != p ? p : a.guild_id)), {
                        hasMoreAfter: O,
                        scrollDown: M,
                    ...
                    }, [G, D, g]), L = u.useMemo(() => (0, c.canUseContextMenuCommands)(a, y.length, s.getCommandTypeCount(a, e, null == m ? void 0 : m.applicationCommandCounts)), [a, e, y.length, null == m ? void 0 : m.applicationCommandCounts]);
                    u.useEffect(() => {
                        if (L !== C.current) {
                            if (L) null == A || A();
                            C.current = L
                    ...
                    let U = u.useCallback(t => {
                            O && t + 500 > 34 * y.length - 40 && M(), h.current = t
                        }, [O, M, y]),
                        v = u.useCallback(t => {
        ...
        459870: function(t, e, n) {
            ...
            function h(t, e) {
                let n = (0, u.useStateFromStores)([c.default], () => c.default.getChannels(e)[c.GUILD_VOCAL_CHANNELS_KEY], [e]),
                    h = (0, u.useStateFromStores)([S.default, d.default], () => {
                        let n = S.default.getUserVoiceChannelId(e, t.id);
                        return d.default.getChannel(n)
                    }, [e, t.id]),
                    m = (0, u.useStateFromStores)([E.default], () => E.default.isGuestOrLurker(e, t.id), [e, t.id]);
                if (m || null == h) return null;
                let O = t.id === s.default.getId();
                if (!O && !f.default.can(A.Permissions.MOVE_MEMBERS, h)) return null;
                let M = n.filter(e => {
                    let {
                        channel: n
                    } = e;
                    return n.id !== h.id && (O ? f.default.can(A.Permissions.CONNECT, n) && !(0, N.isChannelFull)(n, S.default, I.default) : f.default.can(A.Permissions.MOVE_MEMBERS, n) && (f.default.can(A.Permissions.CONNECT, n) || p.default.can({
                        permission: A.Permissions.CONNECT,
                        user: t,
                        context: n
                    })) && !(0, N.isChannelFull)(n, S.default, I.default))
                });
                return 0 === M.length ? null : (0, i.jsx)(a.MenuItem, {
                    id: "voice-move",
                    ...
                    children: M.map(n => {
                        ...
                        return (0, i.jsx)(a.MenuItem, {
                            ...
                            label: (0, o.computeChannelName)(u, _.default, T.default)
                        }, u.id)
                    })
                })
            }

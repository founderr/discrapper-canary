            ...
            function b(e) {
                var r = e.defaultColor,
                    ...
                    v = p(o.useState((function() {
                        return 0 === c || c === r || t.some((function(e) {
                            return e === c
                        })) ? null : c
                    })), 2),
                    m = v[0],
                ...
                var g = o.useCallback((function(e) {
                    ...
                    C = o.useCallback((function(e) {
                        var r = (0, n.jsx)(u.T6, f(s({}, e), {
                            "aria-label": l.Z.Messages.CUSTOM_COLOR
                        }));
                        return d ? r : (0, n.jsx)(i.Popout, {
                            ...
                            children: function(e) {
                                return (0, n.jsx)(i.Tooltip, {
                                    text: l.Z.Messages.CUSTOM_COLOR,
                                    position: "bottom",
                                    children: function(t) {
                    ...
                    P = o.useCallback((function(e) {
                        var r = (0, n.jsx)(u.k3, s({}, e));
                        return d ? r : (0, n.jsx)(i.Tooltip, {
                            text: l.Z.Messages.DEFAULT,
                            position: "bottom",
                            children: function(e) {
        ...
        577939: (e, r, t) => {
            ...
            function J(e) {
                var r, t = e.color,
                    ...
                    O = e.onClick,
                    g = e["aria-label"],
                    j = (0, c.JA)("color-".concat(t)),
                    w = null != t ? (0, a.Rf)(t) : m.backgroundColor,
                    C = !1;
                f && !b ? C = !0 : (f || b) && (C = (0, a.Bd)(t) > .1);
                return (0, n.jsx)(s.FocusRing, {
                    offset: -2,
                    children: (0, n.jsxs)("button", L(M({
                        type: "button",
                        className: u()(A().colorPickerSwatch, (r = {}, T(r, A().disabled, h), T(r, A().default, i), T(r, A().custom, f), T(r, A().noColor, null == t), r)),
                        disabled: h,
                        onClick: function() {
                        ...
                        children: [f ? (0, n.jsx)(x.Z, {
                            ...
                            width: 14,
                            height: 14,
                            color: (0, d.Lq)(C ? S.Ilk.WHITE_500 : S.Ilk.BLACK_500)
                        }) : null, function() {
                            var e = 16,
                                r = 16;
                            if (f || i) {
                ...
                Q = function(e) {
                    ...
                    return (0, n.jsxs)(s.Dialog, {
                        ...
                        children: [(0, n.jsx)(C, {
                            ...
                            children: [f && null != p && (0, n.jsx)(k.JO, {
                                onClick: g,
                    ...
                    children: (0, n.jsx)(c.SJ, {
                        children: function(e) {
                            ...
                            return (0, n.jsxs)("div", L(M({
                                className: u()(A().container, r),
                                ref: i
                            }, l), {
                                children: [(0, n.jsx)("div", {
                                    className: u()(A().defaultContainer, d),
                                    children: p({
                                        value: a,
                                        color: t,
                                        onChange: f,
                                    ...
                                    className: u()(A().customContainer, d),
                                    children: b({
                                        value: a,
                                        customColor: o,
                                        disabled: s
...
//# sourceMappingURL=0933ae7fb4275bcb0135.js.map
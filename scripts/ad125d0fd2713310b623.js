(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [24795, 33600, 84832, 96043, 71402], {
            ...
            function P(t) {
                return function(t) {
                    switch (t.type) {
                        ...
                        case "static-random":
                            return new m(O(t.minValue, t.maxValue));
                        case "linear":
                            return new b(t.value, t.addValue);
                        case "linear-random":
                            return new b(O(t.minValue, t.maxValue), O(t.minAddValue, t.maxAddValue));
                        case "oscillating":
                            return new _(t.value, t.start, t.final, t.duration, t.direction, t.easingFunction);
                        case "oscillating-random":
                            return new _(O(t.minValue, t.maxValue), O(t.minStart, t.maxStart), O(t.minFinal, t.maxFinal), O(t.minDuration, t.maxDuration), E(t.minDirection, t.maxDirection), S(t.easingFunctions)[0])
                    }
                }(h(h({}, t), {
                    valueType: "number"
                }))
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating":
                            ...
                            var a = w(t.start),
                                ...
                                c = w(t.duration),
                                s = w(t.direction);
                            return new y(new _(e.x, a.x, l.x, c.x, s.x, t.easingFunction), new _(e.y, a.y, l.y, c.x, s.y, t.easingFunction));
                        case "oscillating-random":
                            n = w(t.minValue), r = w(t.maxValue);
                            var f = w(t.minStart),
                                d = w(t.maxStart),
                                ...
                                I = w(t.minDirection),
                                P = w(t.maxDirection);
                            return new y(new _(O(n.x, r.x), O(f.x, d.x), O(p.x, h.x), O(v.x, g.x), E(I.x, P.x), S(t.easingFunctions)[0]), new _(O(n.y, r.y), O(f.y, d.y), O(p.y, h.y), O(v.y, g.y), E(I.y, P.y), S(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating":
                            ...
                            var a = I(t.start),
                                ...
                                c = I(t.duration),
                                s = I(t.direction);
                            return new g(new _(e.x, a.x, l.x, c.x, s.x, t.easingFunction), new _(e.y, a.y, l.y, c.z, s.y, t.easingFunction), new _(e.z, a.z, l.z, c.z, s.z, t.easingFunction));
                        case "oscillating-random":
                            n = I(t.minValue), r = I(t.maxValue);
                            var f = I(t.minStart),
                                d = I(t.maxStart),
                                ...
                                w = I(t.minDirection),
                                P = I(t.maxDirection);
                            return new g(new _(O(n.x, r.x), O(f.x, d.x), O(p.x, h.x), O(v.x, y.x), E(w.x, P.x), S(t.easingFunctions)[0]), new _(O(n.y, r.y), O(f.y, d.y), O(p.y, h.y), O(v.y, y.y), E(w.y, P.y), S(t.easingFunctions)[0]), new _(O(n.z, r.z), O(f.z, d.z), O(p.z, h.z), O(v.z, y.z), E(w.z, P.z), S(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector3"
                }))
            ...
            var C = r.forwardRef((function(t, e) {
                    ...
                    O = r.useCallback((function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                })), null == p || p(e), g.current.size > 0 ? m.current = window.requestAnimationFrame(O) : (e.clearRect(0, 0, t.width, t.height), m.current = null);
                                var n = Date.now();
                ...
                var S = r.useCallback((function(t, e) {
                    ...
                    E = r.useCallback((function(t, e, n, r, o) {
                        var u, a = N(null !== (u = t.id) && void 0 !== u ? u : (0, i.v4)(), t, n, r, o);
                        return S(a, e), a
                    }), [S]),
                ...
                return r.useEffect((function() {
                    ...
                    return t("click", R, l), t("mousedown", C, c), t("mousemove", A, s), t("mouseup", x, f),
                        function() {
                            window.removeEventListener("click", R), window.removeEventListener("mousedown", C), window.removeEventListener("mousemove", A), window.removeEventListener("mouseup", A)
                        }
                }), [R, C, A, x, l, c, s, f]), r.useEffect((function() {
                    var t = y.current,
        ...
        396043: (t, e, n) => {
            ...
            function R(t) {
                ...
                return {
                    ...
                    guild_member_perms: String(null !== (n = h.Z.getGuildPermissions(e)) && void 0 !== n ? n : O.ZP.NONE),
            ...
            function A(t) {
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (e = h.Z.getChannelPermissions(t)) && void 0 !== e ? e : O.ZP.NONE),
                    channel_hidden: n
                }
            }
            ...
            function U(t) {
                ...
                if (!_.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== E.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = L(u, i),
                        c = P({}, e, R(a), null != i && null != o && (0, w.AB)(o) ? N(0, o) : A(u));
                    _.default.track(t, c, {
                        flush: n
                    })
                }
        ...
        133600: (t, e, n) => {
            ...
            function F(t, e) {
                return !e || "object" !== z(e) && "function" != typeof e ? A(t) : e
            }
            ...
            function V() {
                var t = i.useContext(d.E).createMultipleConfettiAt;
                i.useEffect((function() {
                    t(window.innerWidth / 2, window.innerHeight / 2)
                }), [t]);
                return null
            }
            var Y = function(t) {
                    ...
                    function n() {
                        ...
                        t.handleGoToLibrary = function() {
                            ...
                            (0, p.uL)(T.Z5c.APPLICATION_LIBRARY, {
                                state: {
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(l.ModalRoot, {
                                ...
                                children: [null != c.giftStyle && !m && (0, r.jsx)(I.Z, {
                                    ...
                                    className: C().seasonalGiftIcon
                                }), (0, r.jsx)("div", {
                                    className: m ? void 0 : C().backSplash
                                }), (0, r.jsxs)(l.ModalContent, {
                                    className: u()((t = {}, k(t, C().content, !m), k(t, C().contentCustomGift, m), t)),
                                    children: [(0, r.jsx)(l.ModalCloseButton, {
                                        ...
                                        id: s,
                                        className: u()((e = {}, k(e, C().customGiftHeader, m && !b), k(e, C().header, !m || b), e)),
                                        variant: "heading-sm/semibold",
                                        children: [(0, r.jsx)("div", {
                                            className: u()(k({}, C().customGiftHeaderText, m)),
                    ...
                    ! function(t, e, n) {
                            ...
                            if (e && !r) {
                                if (n) {
                                    ...
                                    return R.Z.Messages.GIFT_SUBSCRIPTION_INFO.format({
                                        ...
                                        timeInterval: (null == u ? void 0 : u.interval) === P.rV.MONTH ? R.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_MONTH : R.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_YEAR
                                    })
                                }
                        ...
                        get: function() {
                            var t = this.props,
                                ...
                                i = r.error,
                                o = r.accepted;
                            return (0, S.e$)(e, i, o, n, this.handleGoToLibrary)
                        }
                    }, {
                        key: "handleClick",
                        get: function() {
                ...
                W = a.ZP.connectStores([y.Z, b.Z, h.Z, v.Z, m.Z, f.Z], (function(t) {
                    var e = t.giftCode,
                        n = b.Z.get(e.skuId),
                    ...
                    return {
                        sku: n,
                        libraryApplication: null != n ? (0, S.z2)(e, n, y.Z) : null,
                        application: r,
                        subscriptionPlan: null != e.subscriptionPlanId ? (0, E.oE)(e.subscriptionPlanId) : null,
            ...
            const q = function(t) {
                var e = t.channelContext,
                    ...
                    o = Z(t, ["channelContext", "code", "customGiftMessage"]),
                    u = (0, O.Dt)(),
                    l = (0, a.e7)([v.Z], (function() {
                        return v.Z.get(n)
                    }));
                return null == l ? null : (0, r.jsx)(W, D(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
        ...
        18882: (t, e, n) => {
            ...
            function k() {
                ...
                A = {};
                U = p.Z.getChannelId();
                for (var t in j) clearTimeout(j[t]);
                j = {};
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[t] && null != C[t][e]) {
                        ...
                        if (null != r) {
                            ...
                            for (var a in C[t][e]) e === U ? d.ZP.isNewForumThread(a, e, r) && L[t][e]++ : o.default.compare(a, i) > 0 && !d.ZP.hasOpenedThread(a) && L[t][e]++
                        }
                    }
                }
            }
            ...
            function q() {
                var t = U;
                if ((U = p.Z.getChannelId()) === t) return !1;
                F(t);
                F(U)
            }
            ...
            var nt = {},
                ...
                at = function(t) {
                    ...
                    r.hasActiveJoinedUnreadThreads = function(t, e) {
                        return t in N && e in N[t]
                    };
                    r.getActiveUnjoinedThreadsForParent = function(t, e) {
                        var n;
                        return t in C && null !== (n = C[t][e]) && void 0 !== n ? n : ot
                    };
                    ...
                    r.getActiveUnjoinedThreadsForGuild = function(t) {
                        var e;
                        return null !== (e = C[t]) && void 0 !== e ? e : rt
                    };
                    ...
                    r.getActiveThreadCount = function(t, e) {
                        var n, r, o, u;
                        return i().size(null !== (o = null === (n = R[t]) || void 0 === n ? void 0 : n[e]) && void 0 !== o ? o : {}) + i().size(null !== (u = null === (r = C[t]) || void 0 === r ? void 0 : r[e]) && void 0 !== u ? u : {})
                    };
                    r.__getLocalVars = function() {
                        return {
                            ...
                            selectedChannelId: U,
                            timers: j,
                            NO_GUILD_UNJOINED_THREADS: rt,
                            NO_JOINED_THREADS: it,
                            NO_UNJOINED_THREADS: ot,
                            NO_NEW_THREADS: ut
                        }
                    };
                    return n
                ...
                CHANNEL_DELETE: function(t) {
                    ...
                    if (null != e.guild_id && null != e.parent_id) {
                        ...
                        if (e.guild_id in x && e.parent_id in x[e.guild_id]) {
                            Object.keys(x[e.guild_id][e.parent_id]).forEach(Q);
        ...
        641277: (t, e, n) => {
            ...
            function v(t) {
                var e = t.width,
                    ...
                    l = t.foreground,
                    c = h(t, ["width", "height", "color", "foreground"]);
                return (0, r.jsx)("svg", p(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
            ...
            var E = function(t) {
                var e, o = t.game,
                    ...
                    w = O(t, ["game", "guild", "skuId", "pid", "className", "guildClassName", "size"]);
                null != f && (e = function(t) {
                    if (null == t) return null;
                    switch (t) {
                        case y.Si.GUILD:
                ...
                return null == e ? (0, r.jsx)(v, {
                    className: u()(m().gameIcon, E, p)
                }) : (0, r.jsx)("div", _(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
        ...
        73105: (t, e, n) => {
            ...
            function E(t) {
                ...
                O.error("".concat(t, " is not a valid locale."))
            }
            var w = function() {
                    function t(e) {
                        var n = this;
                    ...
                    e.setLocale = function(t) {
                        ...
                        null === (e = S.setLocale(t)) || void 0 === e || e.then((function(e) {
                            O.info("Switching to ".concat(t), e ? "(available)" : "(unavailable)")
                        }))
                    };
                ...
                I = u().debounce((function(t, e) {
                    var n = function(t) {
                        if (null == t) return null;
                        if ((0, a.k)(t, HTMLInputElement) || (0,
                                a.k)(t, HTMLTextAreaElement)) return t.value;

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["2260"], {
        ...
        448105: function(e, t, n) {
            ...
            e.exports = function(e, t) {
                ...
                e: for (var a = 0, i = 0; a < r; a++) {
                    for (var s = e.charCodeAt(a); i < n;)
                        if (t.charCodeAt(i++) === s) continue e;
                    return !1
                }
                return !0
            }
                            ...
                            return {
                                ...
                                label: (0, r.jsxs)("div", {
                                    ...
                                    children: [null != t ? (0, r.jsx)(c.default, {
                                        ...
                                        className: s(p.paymentSourceLabel, {
                                            [p.error]: e.invalid
                                        }),
                                        children: n
                                    })]
        ...
        988268: function(e, t, n) {
            ...
            }), (i = r || (r = {}))[i.GAME = 1] = "GAME", i[i.TICKETED_EVENTS = 3] = "TICKETED_EVENTS", i[i.GUILD_ROLE_SUBSCRIPTIONS = 4] = "GUILD_ROLE_SUBSCRIPTIONS", (s = a || (a = {}))[s.BOT = 0] = "BOT", s[s.SERVER = 1] = "SERVER", s[s.SYSTEM_DM = 2] = "SYSTEM_DM", s[s.OFFICIAL = 3] = "OFFICIAL", s[s.STAFF_ONLY_DM = 4] = "STAFF_ONLY_DM", s[s.ORIGINAL_POSTER = 5] = "ORIGINAL_POSTER", s[s.AI = 6] = "AI", s[s.REMIX = 7] = "REMIX"
        },
        ...
        903016: function(e, t, n) {
            ...
            function A(e) {
                ...
                let {
                    ...
                    slotCount: _ = 1,
                    canceledCount: f = 0
                } = e, p = a.useRef(l), C = null === (t = p.current) || void 0 === t ? void 0 : t.length, A = null === (n = p.current) || void 0 === n ? void 0 : n.reduce((e, t) => (!e.hasOwnProperty(t.id) && (e[t.id] = []), e[t.id].push(t), e), {});
                return (0, r.jsxs)(T, {
                    imageClass: i,
                    error: c,
                    onDismissError: E,
        ...
        247760: function(e, t, n) {
            ...
            var O = e => {
                ...
                let D = [null == r ? a.UNUSED_QUANTITY_SELECT : null, null == l ? a.GUILD_SELECT : null, a.CONFIRM, a.SUCCESS].filter(e => null != e),
                    [P, U] = (0, u.useStateFromStoresArray)([E.default], () => [E.default.isModifyingAppliedBoost, E.default.applyBoostError]),
                    [v, M] = s.useState(""),
                    [y, G] = s.useState(D[0]),
                    [b, B] = s.useState(!1),
                    [x, F] = s.useState(l),
                    [k, w] = s.useState(null != r ? r : g.slice(0, 1)),
                    j = s.useMemo(() => null == k ? [] : k.map(e => {
                        let {
        ...
        936992: function(e, t, n) {
            ...
            function A(e) {
                let {
                    ...
                    onSelectGuild: i,
                    query: I
                } = e, C = (0, l.useStateFromStores)([_.default], () => _.default.getFlattenedGuildIds()), A = (0, l.useStateFromStoresArray)([E.default], () => C.reduce((e, t) => {
                    let r = E.default.getGuild(t);
                    return null == r || null != n && n.some(e => e.id === t) ? e : ((I.length <= 0 || s(I.toLowerCase(), null == r ? void 0 : r.name.toLowerCase())) && e.push(r), e)
                }, [])), {
                    enabled: N
        ...
        9294: function(e, t, n) {
            ...
            function o(e) {
                ...
                let s = r.parse(n),
                    l = (0, a.getFirstQueryStringValue)(s[i]);
                return {
                    baseCode: t,
        ...
        809071: function(e, t, n) {
            ...
            function f(e, t) {
                let {
                    preventFetch: n = !1
                } = e, [i, s] = (0, r.useState)(null), [l, u] = (0, r.useState)(null), d = (0, a.useStateFromStores)([o.default], () => o.default.getSubscriptions());
        ...
        540692: function(e, t, n) {
            ...
            function N(e) {
                ...
                if (!I.has(t) && !f.has(t)) {
                    var n;
                    n = t, f.add(n), i.default.wait(() => (0, l.resolveReferralTrialOffer)(t).catch(o.NOOP_NULL))
                }
            }
            class L extends a.default.Store {
                ...
                checkAndFetchReferralsRemaining() {
                    null == u && !_ && p < 5 && (null == T || T < Date.now()) && (0, l.fetchReferralsRemaining)()
                }
                ...
                getRecipientEligibility(e) {
                    return void 0 === d[e] && !E.has(e) && (0, l.checkRecipientEligibility)(e), d[e]
                }
            ...
            var O = new L(i.default, {
                BILLING_REFERRAL_TRIAL_OFFER_UPDATE: function(e) {
                    ...
                    if (!_ && (0, l.fetchReferralsRemaining)(), !E.has(n) && (0, l.checkRecipientEligibility)(n), !f.has(t)) {
                        var r;
                        r = t, f.add(r), i.default.wait(() => (0, l.resolveReferralTrialOffer)(t).catch(o.NOOP_NULL))
                    }
                },
                ...
                BILLING_CREATE_REFERRAL_SUCCESS: function(e) {
                    ...
                    (0, l.fetchReferralsRemaining)(), S[t.id] = t, c = [...c, t.user_id]
                },
        ...
        917247: function(e, t, n) {
            ...
            function o(e) {
                var t, n, o, u;
                let d = (0, s.useTrialOffer)(l.PREMIUM_TIER_2_TRIAL_FOR_EVERYONE_TRIAL_ID),
                    c = (0, s.useTrialOffer)(l.PREMIUM_TIER_2_LIKELIHOOD_TRIAL_ID),
                    E = (0, s.useTrialOffer)(l.PREMIUM_TIER_2_REACTIVATION_TRIAL_ID),
                    _ = (0, s.useTrialOffer)(a.default.getAnyOfUserTrialOfferId([l.PREMIUM_TIER_2_HFU_ONE_WEEK_TRIAL_ID, l.PREMIUM_TIER_2_HFU_TWO_WEEK_TRIAL_ID, l.PREMIUM_TIER_2_HFU_ONE_MONTH_TRIAL_ID, l.PREMIUM_TIER_0_LIKELIHOOD_TRIAL_ID])),
                    f = (0, s.useTrialOffer)(l.PREMIUM_TIER_2_AUTH3_TRIAL_ID),
        ...
        833516: function(e, t, n) {
            ...
            function d(e) {
                let t = (0, a.useStateFromStores)([l.default], () => l.default.getUserTrialOffer(e)),
                    [n, d] = r.useState(u(t)),
                    c = (0, a.useStateFromStores)([s.default], () => (0, o.isPremium)(s.default.getCurrentUser()));
                return r.useEffect(() => {
        ...
        345116: function(e, t, n) {
            ...
            let f = e => {
                ...
                let a = Math.max(n.premiumSubscriberCount + t, 0),
                    ...
                    s = i - (0, c.getGuildTierFromAppliedBoostCount)(n.premiumSubscriberCount, n.id);
        ...
        824734: function(e, t, n) {
            ...
            function d(e) {
                ...
                } = e, _ = (0, s.formatPrice)(t, n), f = null;
                return a === l.SubscriptionIntervalTypes.YEAR ? f = o.default.Messages.BILLING_PRICE_PER_YEAR_BOLD.format({
                    price: _
                }) : a === l.SubscriptionIntervalTypes.MONTH && 1 === c ? f = o.default.Messages.BILLING_PRICE_PER_MONTH_BOLD.format({
                    price: _
                }) : a === l.SubscriptionIntervalTypes.MONTH && c > 1 && (f = o.default.Messages.BILLING_PRICE_PER_MULTI_MONTHS_BOLD.format({
                    price: _,
                    intervalCount: c
                })), (0, r.jsx)("div", {
            ...
            var P = new D(o.default, {
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: a,
                        userId: i
                    } = e, s = (null !== (n = T.get(a)) && void 0 !== n ? n : 0) + 1, l = (null !== (r = L.get(i)) && void 0 !== r ? r : 0) + 1;
                    T.set(a, s), L.set(i, l), i !== (null === (t = c.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (O = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: a
                    } = e, i = (null !== (t = T.get(r)) && void 0 !== t ? t : 0) - 1, s = (null !== (n = L.get(a)) && void 0 !== n ? n : 0) - 1;
                    i <= 0 ? T.delete(r) : T.set(r, i), s <= 0 ? L.delete(a) : L.set(a, s)
                },
        ...
        364685: function(e, t, n) {
            ...
            var B = new b(l.default, {
                ...
                GUILD_STICKERS_UPDATE: e => {
                    ...
                    }, i = null !== (t = m.get(n)) && void 0 !== t ? t : [], s = i.filter(e => null == r.find(t => t.id === e.id));
                    s.forEach(e => {
                        A.delete(e.id), null != N && N.delete(e.id)
                    });
                    let l = r.map(e => a(e));
                    l.forEach(e => U(e)), g(n, l)
                }
            })
        },
        ...
        804888: function(e, t, n) {
            ...
            function l(e) {
                return s() && null != e.match(i) ? [!0, e.substring(a.length).trim()] : [!1, e]
            }
        },
        ...
        917219: function(e, t, n) {
            ...
            }), (i = r || (r = {}))[i.BACKGROUND = 0] = "BACKGROUND", (s = a || (a = {}))[s.OPTION_1 = 0] = "OPTION_1", s[s.OPTION_2 = 1] = "OPTION_2", s[s.OPTION_3 = 2] = "OPTION_3", s[s.OPTION_4 = 3] = "OPTION_4", s[s.OPTION_7 = 7] = "OPTION_7", s[s.OPTION_8 = 8] = "OPTION_8", s[s.OPTION_9 = 9] = "OPTION_9", s[s.OPTION_10 = 10] = "OPTION_10";
        ...
        340412: function(e, t, n) {
            ...
            class _ extends r.default.PersistedStore {
                initialize(e) {
                    u = null != e ? e : o, this.waitFor(i.default), this.syncWith([i.default], c), this.syncWith([l.default], E)
                }
                getUserTrialOffer(e) {
                ...
                getAcknowledgedOffers(e) {
                    ...
                    return (0, s.isPremium)(t) ? [] : Object.values(u.userTrialOffers).filter(t => e.includes(t.trial_id) && null != t.expires_at)
                }
        ...
        931138: function(e, t, n) {
            ...
            function d(e) {
                let {
                    ...
                    ...c
                } = e, E = a.Children.only(t), _ = (0, l.useRedesignIconContext)().enabled;
                return (0, r.jsxs)("div", {
        ...
        467831: function(e, t, n) {
            ...
            C.Scenes = l, (a = o || (o = {})).NORMAL = "normal", a.SPEED_START = "speed_start", a.SPEED_LOOP = "speed_loop", a.FINISH = "finish", a.IDLE = "idle";
            let A = {
                [o.NORMAL]: {
                    BEG: 0,
                    END: 600,
            ...
            m.Scenes = u, (s = d || (d = {})).ENTRY = "entry", s.IDLE = "idle", s.STARS = "stars", s.ERROR = "error", s.SUCCESS = "success";
            let g = {
                    [d.ENTRY]: {
                        BEG: 0,
                        END: 180
        ...
        273108: function(e, t, n) {
            ...
            class c extends a.PureComponent {
                async componentDidMount() {
                    ...
                    null != this.animationRef && (this.animation = o.loadAnimation({
                        ...
                        autoplay: !0,
                        animationData: l
                    }), this.animation.addEventListener("loopComplete", this.handleLoopComplete), this.animation.addEventListener("complete", this.handleComplete), this.playScene(t), (r && !i || a || s) && this.animation.pause())
                }
                componentWillUnmount() {
                ...
                componentDidUpdate(e) {
                    ...
                    a !== this.currentScene && this.shouldForcePlayAfter() && !s && this.playScene(a), null != this.animation && (i && !e.isWindowFocused && l && !o && !0 !== s ? this.animation.play() : (o || i && e.isWindowFocused && !l) && this.animation.pause()), !e.pause && s ? null === (t = this.animation) || void 0 === t || t.pause() : e.pause && !s && !o && (null === (n = this.animation) || void 0 === n || n.play()), e.nextScene !== a && s && (this.playScene(a), null === (r = this.animation) || void 0 === r || r.pause())
                }
            ...
            var E = e => {
                let {
                    componentRef: t,
                    ...n
                } = e, a = (0, l.useStateFromStores)([u.default], () => u.default.isFocused()), i = (0, l.useStateFromStores)([o.default], () => o.default.useReducedMotion);
                return (0, r.jsx)(c, {
                    ...n,
                    isWindowFocused: a,
                    useReducedMotion: i,
            ...
            function i(e, t, n) {
                ...
                return new Promise((t, n) => {
                    e(i).then(e => {
                        ...
                        var t, i;
                        let l = r.properties;
                        "function" == typeof r.properties && (l = r.properties(e)), (0, a.trackNetworkAction)(r.event, {
                            status_code: e.status,

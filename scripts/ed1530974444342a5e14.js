    ...
    ["79017"], {
        ...
        803427: function(e, t, s) {
            ...
            var n = s("37983"),
                ...
                B = s("36662"),
                U = s("258179");
            let x = [_.Steps.PAYMENT_TYPE, _.Steps.CREDIT_CARD_INFORMATION, _.Steps.REVIEW],
                ...
                H = (0, I.cssValueToNumber)(U.innerPadding);
                ...
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        let {
                            ...
                            paymentSources: s,
                            onBack: r
                        } = this.props, a = (0, _.getStepIndex)(e, t), l = (0, _.canGoBack)(a, s) ? b.default.Messages.BACK : b.default.Messages.CANCEL;
            ...
            var W = l.default.connectStores([E.default, S.default, p.default, h.default, f.default], () => ({
            ...
            var n = s("37983"),
                ...
                i = r.memo(function(e) {
                    ...
                    let {
                        ...
                        "aria-hidden": h = !1,
                        ...p
                    } = e, f = r.useContext(l.default);
                    return (0, n.jsx)(a.Avatar, {
                        src: (t = u, s = (0, a.getAvatarSize)(d), i = c, o = f, t.getAvatarURL(o, s, i)),
                        size: d,
        ...
        749432: function(e, t, s) {
            ...
            class b extends r.Component {
                ...
                get headerBlurb() {
                    ...
                    let {
                        ...
                        giftRecipient: r,
                        selectedGiftStyle: a
                    } = this.props, l = null != a && L.SeasonalGiftStyles2023.includes(a);
                ...
                render() {
                    ...
                    let {
                        ...
                        giftMessageError: i,
                        isSendingMessage: o
                    } = this.props, d = (0, N.isCustomGiftEnabled)(l);
                    return e = d || a && null == i ? M.default.Messages.APPLICATION_STORE_PURCHASE_GIFT_AND_MESSAGE_CONFIRMATION_TITLE : null != i ? M.default.Messages.APPLICATION_STORE_GIFT_PURCHASE_AND_MESSAGE_FAILED : M.default.Messages.APPLICATION_STORE_PURCHASE_GIFT_CONFIRMATION_TITLE, t = o ? (0, n.jsx)(u.Spinner, {
                        ...
                        children: [(0, n.jsx)(u.Heading, {
                            ...
                            children: e
                        }), a && null != l && null == i || (0, N.isCustomGiftEnabled)(l) ? this.renderConfirmSentGift() : this.renderRequestSendGift()]
                    }), (0, n.jsxs)(m.default, {
            ...
            let B = e => {
                ...
                let [a, o] = r.useState(), [p, E] = r.useState(!1), [_, C] = r.useState(!1), {
                    userAffinities: m,
                    isLoading: T
                } = (0, i.useStateFromStoresObject)([P.default], () => ({
                    userAffinities: P.default.getUserAffinitiesUserIds(),
                    isLoading: P.default.getFetching()
                })), R = Array.from(m.values()), N = (0, i.useStateFromStores)([A.default], () => A.default.getFriendIDs()), g = l.difference(N, R), O = [...R, ...g], L = (0, i.useStateFromStores)([I.default], () => I.default.filter(e => O.includes(e.id) && !e.bot), [O]), b = null == L || 0 === L.length;
                if (b) return null;
                let B = l.sortBy(L, e => O.indexOf(e.id));
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(u.FormTitle, {
                        ...
                        children: [(0, n.jsx)(u.SearchableSelect, {
                            ...
                            className: p ? D.giftRecipientInputError : void 0,
                        ...
                        className: p ? D.subtextError : D.subtext,
            ...
            var U = i.default.connectStores([_.default], () => ({
        ...
        787598: function(e, t, s) {
            ...
            class H extends l.PureComponent {
                ...
                renderPurchaseWarning() {
                    ...
                    let r = (0, F.nativePlatformTypeToSKUOperatingSystem)((0, B.getPlatform)()),
                        i = [];
                    return (null == r || !e.supportedOperatingSystems.includes(r)) && !s && i.push((0, a.jsx)(S.default, {
                        icon: L.default,
                    ...
                    return (0, a.jsxs)(u.ModalHeader, {
                        ...
                        children: [(0, a.jsx)(E.default, {
                            ...
                            children: [(0, a.jsx)(u.FormTitle, {
                                ...
                                children: (0, k.getSkuHeaderText)(n, l.type)
                            ...
                            children: [(0, a.jsxs)(y.default, {
                                ...
                                className: w.price,
                                children: null != o ? (0, U.formatPrice)(o.amount, o.currency) : (0, a.jsx)(u.Spinner, {
                                    type: u.Spinner.Type.PULSING_ELLIPSIS,
                                    className: w.priceSpinner
                                })
                            })]
                        }), this.renderPurchaseWarning(), this.renderGenericError(i, s), t.length > 1 ? (0, a.jsx)(g.default, {
                            activeId: e,
                            breadcrumbs: t,
                ...
                render() {
                    ...
                    return null == e || t ? (0, a.jsx)(u.Spinner, {}) : (0, a.jsx)(f.default, {
                        ...
                        needsToBeGift: e.type === Y.SKUTypes.DURABLE_PRIMARY && !0 === l,
                        isGiftable: this.isGiftable,
                        legalNotice: n ? (0, a.jsx)(p.default, {
                            isEmbeddedIAP: n
                        }) : null,
                        isPurchasing: s,
                        purchaseError: r,
                        ...
                        initialStep: i ? b.Steps.CONFIRM : null,
                ...
                constructor(...e) {
                    ...
                    super(...e), t = this, this.state = {
                        ...
                        }), this._stepStartTime = s, t === b.Steps.CONFIRM && h.showPurchaseConfirmationStep()
            ...
            let V = l.forwardRef((e, t) => {
                ...
                let {
                    ...
                    skuId: l,
                    ...i
                } = e, u = (0, o.useStateFromStores)([_.default], () => _.default.getApplication(r)), d = (0, D.hasFlag)(null !== (s = null == u ? void 0 : u.flags) && void 0 !== s ? s : 0, Y.ApplicationFlags.EMBEDDED) && (0, D.hasFlag)(null !== (n = null == u ? void 0 : u.flags) && void 0 !== n ? n : 0, Y.ApplicationFlags.EMBEDDED_IAP), [c, h, p, f, S, E, P, g, y] = (0, o.useStateFromStoresArray)([T.default], () => [T.default.getPricesForSku(l), T.default.isPurchasingSKU, T.default.error, T.default.analyticsLocation, T.default.promotionId, T.default.giftCode, T.default.isGift, T.default.isIAP, T.default.forceConfirmationStepOnMount]), [O, L] = (0, o.useStateFromStoresArray)([R.default], () => [R.default.get(l), R.default.isFetching(l)]), M = (0, o.useStateFromStores)([A.default, N.default], () => N.default.inTestModeForApplication(r) || A.default.inDevModeForApplication(r), [r]), b = (0, o.useStateFromStores)([m.default, I.default], () => m.default.isEntitledToSku(I.default.getCurrentUser(), l, r)), B = (0, o.useStateFromStores)([C.default], () => C.default.error);
                return (0, a.jsx)(H, {
                    ...i,
                    application: u,
                    applicationId: r,
        ...
        909469: function(e, t, s) {
            ...
            let d = new Set([o.CurrencyCodes.ARS, o.CurrencyCodes.CLP, o.CurrencyCodes.COP]),
                ...
                S = e => {
                    ...
                    } = t, I = 0 !== P.length, C = E(S), m = (0, l.formatPrice)(A, _, {
                        style: "currency",
                        currency: _,
            ...
            let p = (e, t) => {
                    ...
                    switch (e) {
                        ...
                        case h.PremiumGiftStyles.COFFEE:
                            ...
                            break;
                        case h.PremiumGiftStyles.SEASONAL_STANDARD_BOX:
                            switch (t) {
                                case "idle":
                                    n = () => s.el("158302").then(s.t.bind(s, "158302", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case "loop":
                                    n = () => s.el("610146").then(s.t.bind(s, "610146", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    n = () => s.el("294569").then(s.t.bind(s, "294569", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                            ...
                            break;
                        case h.PremiumGiftStyles.SEASONAL_CAKE:
                            switch (t) {
                                case "idle":
                                    n = () => s.el("124416").then(s.t.bind(s, "124416", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case "loop":
                                    n = () => s.el("335900").then(s.t.bind(s, "335900", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    n = () => s.el("566748").then(s.t.bind(s, "566748", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                            ...
                            break;
                        case h.PremiumGiftStyles.SEASONAL_CHEST:
                            switch (t) {
                                case "idle":
                                    n = () => s.el("846577").then(s.t.bind(s, "846577", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case "loop":
                                    n = () => s.el("355472").then(s.t.bind(s, "355472", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    n = () => s.el("262001").then(s.t.bind(s, "262001", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                            ...
                            break;
                        case h.PremiumGiftStyles.SEASONAL_COFFEE:
                            switch (t) {
                                case "idle":
                                    n = () => s.el("836477").then(s.t.bind(s, "836477", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case "loop":
                                    n = () => s.el("737995").then(s.t.bind(s, "737995", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    n = () => s.el("433750").then(s.t.bind(s, "433750", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t

        ...
        489030: (e, t, n) => {
            ...
            const ce = function() {
                ...
                return (0, i.useMemo)((function() {
                    ...
                    return [{
                        section: W.PURCHASE,
                        items: e.purchase.length > 0 ? [oe, ae].concat(re(e.purchase)) : e.purchase,
                        height: 12,
            ...
            function Ae(e) {
                var t = e.transitionState,
                    ...
                    d = (0, m.ZP)(),
                    p = d.categories,
                    h = d.isFetchingCategories,
                    v = d.isFetchingPurchases,
                    y = (0, o.e7)([x.default], (function() {
                        return x.default.getCurrentUser()
                    })),
                    g = (0, u.Z)(n, c.Z.EDIT_AVATAR_DECORATION_MODAL),
                    b = g.AnalyticsLocationProvider,
                    w = g.analyticsLocations,
                    C = h && v;
                ...
                return null == y ? null : (0, r.jsx)(b, {
                    children: (0, r.jsx)(a.ModalRoot, {
                        transitionState: t,
                        className: xe().modal,
                        size: C ? a.ModalSize.DYNAMIC : a.ModalSize.MEDIUM,

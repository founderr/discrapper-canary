(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [21747, 19887, 65614, 84832, 71402], {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = w(e.minStart),
                                ...
                                T = w(e.minDirection),
                                P = w(e.maxDirection);
                            return new y(new E(O(n.x, r.x), O(f.x, d.x), O(p.x, h.x), O(v.x, g.x), S(T.x, P.x), _(e.easingFunctions)[0]), new E(O(n.y, r.y), O(f.y, d.y), O(p.y, h.y), O(v.y, g.y), S(T.y, P.y), _(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = T(e.minStart),
                                ...
                                w = T(e.minDirection),
                                P = T(e.maxDirection);
                            return new g(new E(O(n.x, r.x), O(f.x, d.x), O(p.x, h.x), O(v.x, y.x), S(w.x, P.x), _(e.easingFunctions)[0]), new E(O(n.y, r.y), O(f.y, d.y), O(p.y, h.y), O(v.y, y.y), S(w.y, P.y), _(e.easingFunctions)[0]), new E(O(n.z, r.z), O(f.z, d.z), O(p.z, h.z), O(v.z, y.z), S(w.z, P.z), _(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var I = r.forwardRef((function(e, t) {
                ...
                var _ = r.useCallback((function(e, t) {
                    ...
                    S = r.useCallback((function(e, t, n, r, o) {
                        var a, u = A(null !== (a = e.id) && void 0 !== a ? a : (0, i.Z)(), e, n, r, o);
                        return _(u, t), u
                    }), [_]),
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", R, l), e("mousedown", I, c), e("mousemove", C, s), e("mouseup", N, f),
                        function() {
                            window.removeEventListener("click", R), window.removeEventListener("mousedown", I), window.removeEventListener("mousemove", C), window.removeEventListener("mouseup", C)
                        }
                }), [R, I, C, N, l, c, s, f]), r.useEffect((function() {
                    var e = y.current,
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != I[e] && null != I[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in I[e][t]) t === k ? d.ZP.isNewForumThread(u, t, r) && j[e][t]++ : o.default.compare(u, i) > 0 && !d.ZP.hasOpenedThread(u) && j[e][t]++
                        }
                    }
                }
            }
            ...
            var ne = {},
                ...
                ue = function(e) {
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, o, a;
                        return i().size(null !== (o = null === (n = R[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== o ? o : {}) + i().size(null !== (a = null === (r = I[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== a ? a : {})
                    };
                    return n
                }(a.ZP.Store);
        ...
        585798: (e, t, n) => {
            ...
            function x() {
                var e = i.useContext(f.AccessibilityPreferencesContext).reducedMotion.enabled ? P : T,
                    t = S((function(e) {
        ...
        58964: (e, t, n) => {
            ...
            function p(e, t) {
                ...
                var p, h, v, y, g, m = encodeURIComponent(c.toString()),
                    ...
                    E = (v = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), y = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(v)), g = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !y, "iOS" !== (null === i() || void 0 === i() || null === (h = i().os) || void 0 === h ? void 0 : h.family) || g ? 1 : 0),
                    O = null != r ? encodeURIComponent(r) : null,
                    _ = null != o ? encodeURIComponent(o) : null,
                    S = "".concat(s, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(b, "&efr=").concat(E);
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: o,
                        round: a
                    } = Math, u = e[0] | e[1] << 8 | e[2] << 16, l = e[3] | e[4] << 8, c = (63 & u) / 63, s = (u >> 6 & 63) / 31.5 - 1, f = (u >> 12 & 63) / 31.5 - 1, d = (u >> 18 & 31) / 31, p = u >> 23, h = (l >> 3 & 63) / 63, v = (l >> 9 & 63) / 63, y = l >> 15, g = i(3, y ? p ? 5 : 7 : 7 & l), m = i(3, y ? 7 & l : p ? 5 : 7), b = p ? (15 & e[5]) / 15 : 1, E = (e[5] >> 4) / 15, O = p ? 6 : 5, _ = 0, S = (t, n, r) => {
                        let i = [];
                        for (let o = 0; o < n; o++)
                            for (let a = o ? 0 : 1; a * n < t * (n - o); a++) i.push(((e[O + (_ >> 1)] >> ((1 & _++) << 2) & 15) / 7.5 - 1) * r);
                        return i
                    }, w = S(g, m, d), T = S(3, 3, 1.25 * h), P = S(3, 3, 1.25 * v), x = p && S(5, 5, E), R = r(e), A = a(R > 1 ? 32 : 32 * R), I = a(R > 1 ? 32 / R : 32), C = new Uint8Array(A * I * 4), N = [], j = [];
                    for (let e = 0, r = 0; e < I; e++)
                        for (let a = 0; a < A; a++, r += 4) {
                            let u = c,
                                l = s,
                                d = f,
                                h = b;
                            for (let e = 0, n = i(g, p ? 5 : 3); e < n; e++) N[e] = o(t / A * (a + .5) * e);
                            for (let n = 0, r = i(m, p ? 5 : 3); n < r; n++) j[n] = o(t / I * (e + .5) * n);
                            for (let e = 0, t = 0; e < m; e++)
                                for (let n = e ? 0 : 1, r = 2 * j[e]; n * m < g * (m - e); n++, t++) u += w[t] * N[n] * r;
                            ...
                            if (p)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * j[e]; n < 5 - e; n++, t++) h += x[t] * N[n] * r;
                            let v = u - 2 / 3 * l,
                                y = (3 * u - v + d) / 2,
                                E = y - d;
                            C[r] = i(0, 255 * n(1, y));
        ...
        498964: (e, t, n) => {
            ...
            const S = f(m((function(e) {
                ...
                T = e => Object.assign(f(e), {
                    startsWith: t => {
                        return T(y(e, (n = t, m((e => O(e) && e.startsWith(n))))));
                        var n
                    },
                    endsWith: t => {
                        return T(y(e, (n = t, m((e => O(e) && e.endsWith(n))))));
                        var n
                    },
                    minLength: t => T(y(e, (e => m((t => O(t) && t.length >= e)))(t))),
                    maxLength: t => T(y(e, (e => m((t => O(t) && t.length <= e)))(t))),
                    includes: t => {
                        return T(y(e, (n = t, m((e => O(e) && e.includes(n))))));
                        var n
                    },
                    regex: t => {
                        return T(y(e, (n = t, m((e => O(e) && Boolean(e.match(n)))))));
                        var n
                    }
                }),
                P = T(m(O)),

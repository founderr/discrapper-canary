    ...
    [4687, 67145, 96043, 71402], {
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = o(e),
                    ...
                    d = p.length;
                for (var I in e) !t && !c.call(e, I) || E && ("length" == I || _ && ("offset" == I || "parent" == I) || f && ("buffer" == I || "byteLength" == I || "byteOffset" == I) || u(I, d)) || p.push(I);
                return p
            }
        },
        70151: (e, t, n) => {
        ...
        444663: (e, t, n) => {
            ...
            function A(e) {
                ...
                t = R ? S.Z.Messages.UPLOAD_AREA_PREMIUM_TIER_UPSELL_BODY_LINE_2.format({
                    premiumPlan: (0, p.Px)(T.p9.TIER_0),
                    premiumMaxSize: S.Z.Messages.FILE_UPLOAD_LIMIT_PREMIUM_TIER_0_CORRECTED
                }) : S.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_2_INCREASE;
                var C = i.useMemo((function() {
                        var e = p.ZP.getUserMaxFileSize(L),
                            t = (0, E.BU)(e / 1024, {
                                useKibibytes: !0
                            }),
                            n = S.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1.format({
                                maxSize: t
                            });
                        switch (null == L ? void 0 : L.premiumType) {
                            case T.p9.TIER_0:
                                n = S.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1_PREMIUM_TIER_0.format({
                                    maxSize: t
                                });
                                break;
                            case T.p9.TIER_1:
                                n = S.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1_PREMIUM_TIER_1.format({
                                    maxSize: t
                                })
                        }
                        return n
                ...
                return (0, r.jsx)(O.Z, function(e) {
                    ...
                    body: U,
                    context: S.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_BODY_LINE_1.format({
                        maxSize: S.Z.Messages.FILE_UPLOAD_LIMIT_NEW_STANDARD
                    }),
                    glowUp: t,
                    analyticsLocation: {
        ...
        396043: (e, t, n) => {
            ...
            function R(e) {
                ...
                return {
                    ...
                    guild_member_perms: String(null !== (n = p.Z.getGuildPermissions(t)) && void 0 !== n ? n : S.ZP.NONE),
            ...
            function C(e) {
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (t = p.Z.getChannelPermissions(e)) && void 0 !== t ? t : S.ZP.NONE),
                    channel_hidden: n
                }
            }
            ...
            var r = n(318715),
                ...
                _ = function() {
                    var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
                        ...
                        d = f.collectEnabled,
                        I = E && d && null != i && !1 !== (null == i || null === (e = i.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible);
                    return {
                        viewAndUseEnabled: E,
                        collectEnabled: I,
        ...
        159895: (e, t, n) => {
            ...
            function m(e) {
                var t;
                return I(t = {}, T, e.non_subscriber), I(t, f.Si.TIER_0, e[f.Si.TIER_0]), I(t, f.Si.TIER_2, e[f.Si.TIER_2]), t
            }
            ...
            function f(e) {
                ...
                var O = u.L.useExperiment({
                    ...
                    T = n.useExperiment({
                        ...
                        autoTrackExposure: O && !I && !d && t
                    }),
                    h = T.enabled,
                    m = T.useExpectedValue,
                    S = T.useLikelihood,
                    g = (0, r.cj)([c.Z], (function() {
                        var e = c.Z.getState();
                        return {
                            fetched: e.fetched,

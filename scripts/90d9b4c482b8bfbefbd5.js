(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [45893], {
        ...
        171037: (e, t, r) => {
                    ...
                    action: function() {
                        (0, o.openModalLazy)(x((function() {
                            ...
                            return k(this, (function(c) {
                                switch (c.label) {
                                    case 0:
                                        return [4, Promise.all([r.e(40532), r.e(86502), r.e(10523), r.e(38501), r.e(12096)]).then(r.bind(r, 738501))];
                                    case 1:
            ...
            function W(e, t, i) {
                var c, u = (0, _.XJ)(null != i ? i : t).canManageGuildEvent,
                ...
                return a && (!f && !s) ? (0, n.jsx)(o.MenuItem, {
                    ...
                    action: function() {
                        null != l && (0, o.openModalLazy)(Y((function() {
                            var e, t;
                            return J(this, (function(o) {
                                switch (o.label) {
                                    case 0:
                                        return [4, Promise.all([r.e(40532), r.e(74544), r.e(62750)]).then(r.bind(r, 874544))];
                                    case 1:
                ...
                var t = e.guildEventId,
                    ...
                    I = function(e, t) {
                        return (0, P.Z)(t, e).isMember ? (0, n.jsx)(o.MenuItem, {
                            ...
                            action: function() {
                                (0, w.JG)("".concat(location.protocol, "//").concat(location.host).concat(T.Z5c.GUILD_EVENT_DETAILS(t, e)));
                    ...
                    x = function(e, t, r) {
                        var i, c = (0, b.e7)([h.ZP], (function() {
                            ...
                            l = (0, b.e7)([d.Z], (function() {
                                return d.Z.getGuild(t)
                            }), [t]);
                        if (c || null == u) return null;
                        i = u.entity_type === g.WX.EXTERNAL ? u.entity_metadata.location : null != r && null != l ? m.Z.Messages.CALENDAR_CHANNEL_LOCATION.format({
                            channelName: r.name,
                            guildName: l.name
                        }) : m.Z.Messages.NOTIFICATION_TITLE_DISCORD;
                        var s, w = f()(u.scheduled_start_time),
                            P = null != u.scheduled_end_time ? f()(u.scheduled_end_time) : w,
                            T = null != u.description && "" !== u.description ? O.ZP.unparse(u.description, null !== (s = null == r ? void 0 : r.id) && void 0 !== s ? s : "", !0) : "",
                            _ = function() {
                                var e = a()();
                                e.createEvent({
                                    start: w,
                        ...
                        return (0, n.jsxs)(o.MenuItem, {
                            ...
                            children: [(0, n.jsx)(o.MenuItem, {
                                ...
                                action: function() {
                                    var e = {
                                            text: u.name,
                                            dates: "".concat(w.format(j), "/").concat(P.format(j)),
                                            details: T,
                                            action: "TEMPLATE",
                                            location: i
                                        },
        ...
        476143: (e, t, r) => {
            ...
            function y(e, t, r) {
                var y = (0, c.XJ)(null != r ? r : t).canManageGuildEvent,
                    ...
                    d = (0, o.e7)([l.ZP], (function() {
                        return l.ZP.getGuildScheduledEvent(e)
                    }), [e]),
                    v = y(d);
                if (null == e || !v || !O) return null;
                if ((null == d ? void 0 : d.entity_type) === s.WX.EXTERNAL) return null;
                var h = function() {
                    if (null == r ? void 0 : r.isGuildStageVoice())(0, u.NZ)(r);
                    else {
            ...
            const l = function() {
                ...
                return {
                    ...
                    onCloseRequest: function() {
                        i.l.getState().canCloseModal && (0, n.closeModal)(u, e)
                    }
                }
            }
        },
        ...
        838956: (e, t, r) => {
            ...
            function O(e, t) {
                ...
                return null != n ? O(e[n], null != t ? t : n) : null
            }
            var d = r(2590);
            ...
            var E, w, P = (w = (E = function(e) {
                var t, r, i, c, p, b, y, O, v, h, j;
                return m(this, (function(m) {
                    switch (m.label) {
                        case 0:
                            t = e.componentType, r = e.messageId, i = e.messageFlags, c = e.customId, p = e.indices, b = e.applicationId, y = e.channelId, O = e.guildId, v = e.localState;
                    ...
                    if (!n.ok) {
                        if (!n.hasErr) {
                            if (n.status >= 400 && n.status < 500 && n.body) {
                                if (n.body.code === d.evJ.INVALID_FORM_BODY && n.body.errors) {
            ...
            var N = function(e, t) {
                var r, o = null == t ? void 0 : t.state,
                    i = e.state === d.yb.SENT && j(e.id) < Date.now(),
                    ...
                    a = e.isCommandType();
                return l && o === p.F.QUEUED || a && e.state === d.yb.SENDING && null != t ? _.SENDING : l && o === p.F.CREATED || e.hasFlag(d.iLy.LOADING) && !i ? _.CREATED : null != e.interaction && e.hasFlag(d.iLy.LOADING) && i || null != e.interaction && !e.hasFlag(d.iLy.LOADING) && c ? _.TIMED_OUT : a && e.state === d.yb.SEND_FAILED ? _.FAILED : void 0
            };

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [58969], {
        358969: (n, e, t) => {
            ...
            function V(n) {
                return function(n) {
                    ...
                    return Q.useExperiment({
                        ...
                        autoTrackExposure: !1
                    }).enabled || Boolean((null == e ? void 0 : e.hasFeature(L.oNc.COMMUNITY)) || (null == e ? void 0 : e.hasFeature(L.oNc.INTERNAL_EMPLOYEE_ONLY)))
                }(n)
            }

            function J(n, e, t) {
                var u = (0, a.e7)([m.Z], (function() {
                    return m.Z.hasLoaded(n.guild_id)
                }));
                r.useEffect((function() {
                    if (u) {
                        var r = M.Z.getThreadIds(n.id, e, t),
                            o = N.Z.getThreadIdsMissingCounts(n.guild_id, r).filter((function(n) {
                                return (0, k.nU)(n, [E.ZP])
            ...
            function X(n) {
                return (0, a.e7)([m.Z, O.Z], (function() {
                    var e = o()(m.Z.getThreadsForParent(n.guild_id, n.parent_id)).keys().filter((function(n) {
                        var e;
            ...
            function nn(n) {
                ...
                return r.useMemo((function() {
                    ...
                    return null !== (u = null === (r = null == n || null === (t = n.appliedTags) || void 0 === t ? void 0 : t.map((function(n) {
                        return e[n]
                    }))) || void 0 === r ? void 0 : r.filter(P.lm)) && void 0 !== u ? u : K
            ...
            function tn(n, e) {
                var t = (0,
                    a.Wu)([w.default], (function() {
                    return e.map((function(n) {
                        return w.default.getUser(n)
                    })).filter(P.lm)
                }));
                r.useEffect((function() {
                    t.forEach((function(e) {
                        Z.Z.requestMember(n.guild_id, e.id)
                    }))
                }), []);
                return t
            }
            ...
            function rn(n, e) {
                var t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : U.R6.DURATION_AGO,
            ...
            function an(n) {
                var e, t = (0, a.e7)([w.default], (function() {
                        return w.default.getUser(n.ownerId)
                    })),
                ...
                r.useEffect((function() {
                    null != n.ownerId && Z.Z.requestMember(n.guild_id, n.ownerId)
            ...
            function cn(n) {
                var e, t, r = w.default.getUser(n.ownerId),
            ...
            function fn(n) {
                return (0, a.Wu)([T.Z, w.default, S.Z], (function() {
                    var e = w.default.getCurrentUser();
                    return o()(T.Z.getTypingUsers(n.id)).keys().filter((function(n) {
                        return n !== (null == e ? void 0 : e.id)
                    })).reject(S.Z.isBlocked).map((function(n) {
                        return w.default.getUser(n)
                    })).filter(P.lm).map((function(n) {
                        return n.id
                    })).value()
                }))
            }
            ...
            function dn(n) {
                return (0,
                    a.e7)([_.Z], (function() {
                    return _.Z.can(L.Plq.MANAGE_CHANNELS, n)
                }))
            }
            var hn = {
                isNew: !1,
            ...
            function pn(n) {
                return (0, a.cj)([I.Z, E.ZP], (function() {
                    var e, t = I.Z.getGuild(null !== (e = n.getGuildId()) && void 0 !== e ? e : "");
                    return null == t ? hn : (0, k.FS)(n, t, [E.ZP])
                }))
            }
            ...
            function mn(n) {
                var e = (0, a.e7)([_.Z], (function() {
                    return _.Z.can(L.Plq.MANAGE_THREADS, n)
                }));
                return r.useMemo((function() {
            ...
            function yn(n) {
                return (0, a.e7)([_.Z], (function() {
                    return _.Z.can(L.Plq.READ_MESSAGE_HISTORY, n)
                }))
            }
                ...
                r.useEffect((function() {
                    if (null != i || null == a.current) {
                        if (null != i && 0 !== i.length && !t)
                                    ...
                                    var r = setTimeout(Y((function() {
                                        return H(this, (function(t) {
                                            switch (t.label) {
                                                ...
                                                case 1:
                                                    t.trys.push([1, 3, , 4]);
                                                    return [4, j.Z.searchForumPosts(n.guild_id, n.id, i, e)];
                                                case 2:
                                                    t.sent();
                                                    return [3, 4];
                                                case 3:
                            ...
                            } else j.Z.clearForumSearch(n.id)
                    } else {
                        j.Z.clearForumSearch(n.id);
                        a.current = null
                    }
            ...
            function _n(n) {
                var e = n.channel,
                    ...
                    i = (0, a.Wu)([M.Z], (function() {
                        return M.Z.getThreadIds(e.id, t, u)
                    })),
                    l = In(e.guild_id, e.id),
                    c = (0, a.e7)([M.Z], (function() {
                        return o && (l > 0 || M.Z.getCanAckThreads())
                    }), [o, l]);
                r.useEffect((function() {
                    c && (0, f.U6)(e)
                }), [e, c]);
            ...
            const b = new y(i.Z, {
                ...
                FORUM_UNREADS: function(n) {
                    n.threads.forEach((function(n) {
                        null != n.count && (m[n.threadId] = n.count)
                    }))
                },
        ...
        788169: (n, e, t) => {
            ...
            function p(n, e) {
                return !e || "object" !== m(e) && "function" != typeof e ? function(n) {
                    if (void 0 === n) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                    return n
                }(n) : e
            }
            ...
            function Z(n) {
                var e;
                return null !== (e = b[n]) && void 0 !== e ? e : O
            }
                    ...
                    var f = null == y || y.prevSend > r - 16e3 ? 1500 : 0,
                        s = setTimeout((function() {
                            if (null != y && y.channelId === e && t === i.default.getId() && null != y.timeout) {
                                ...
                                (function(n) {
                                    var e = Z(n);
                                    return e === O ? 0 : Object.keys(e).length
                                })(e) > 5 || u.ZP.post({
                                    url: a.ANM.TYPING(e),
                                    oldFormErrors: !0
                                }).then((function(n) {

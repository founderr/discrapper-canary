    ...
    [90469, 84237], {
                    ...
                    function e() {
                        ...
                        this._handleNativeUpdateNotAvailable = function() {
                            ...
                            Pn.ZP.get({
                                ...
                                if (null == e.body || "526616cff4bb027797b01c43aa51e29728d487f5" === e.body.hash) return n._handleUpdateNotAvailable();
        ...
        292376: (e, t, n) => {
            ...
            function pn(e) {
                ...
                return t ? 0 === n.length ? (0, r.jsx)(ze, {}) : (0,
                    r.jsx)(r.Fragment, {
            ...
            function Ln(e) {
                return (0, a.sv)() ? (0, r.jsx)(xn, Mn({}, e)) : (0,
                    r.jsx)(Zn, Mn({}, e))
            }
            ...
            function go(e) {
                var t = e.channel,
                    n = (0, i.cj)([u.default, io.Z, oo.Z], (function() {
            ...
            function ra(e, t) {
                ra = Object.setPrototypeOf || function(e, t) {
                    e.__proto__ = t;
                    return e
                };
                return ra(e, t)
                ...
                function n(e, r) {
                    ...
                    o.reloadMessages = function() {
                        o.setState({
                            channels: o.state.channels.map((function(e) {
                                return "messages" === e.type && e.hasLoadedAnything ? sa(e, !1, !0) : e
                            }))
                        })
                    };
                    ...
                    o.toggle = function(e) {
                        ...
                        o.setState({
                            ...
                            collapsedChannels: a,
                            loadState: l !== aa.Done || s || c.isFullyLoaded ? l : aa.Loaded,
                            channels: o.updateChannel(t, (function(e) {
                                return ta(ea({}, e), {
                                    collapsed: s
                                })
                    ...
                    o.handleUserGuildSettingsStoreChange = function() {
                        var e = o.state.channels.filter((function(e) {
                            return !Wi.Z.isGuildOrCategoryOrChannelMuted(e.guildId, e.channelId)
                        }));
                    ...
                    o.handleJoinedThreadsStoreChange = function() {
                        var e = o.state.channels.filter((function(e) {
                            return !Hi.Z.isMuted(e.channelId)
                        }));
                        e.length !== o.state.channels.length && o.setState({
                            channels: e
                        })
                    ...
                    if (n === aa.Loaded) {
                        var o = !1,
                            i = r.map((function(t) {
                                ...
                                if (t.collapsed) return t.hasLoadedAnything ? t : ta(ea({}, t), {
                                    hasLoadedAnything: !0
                                });
                        ...
                        o && !i.some((function(e, t) {
                            ...
                            channels: i,
                            loadState: o ? this.state.loadState : aa.Done
                        })
                    }
                };
                r.populateInitialStateFromStore = function(e) {
                    if ("messages" === e.type) return sa(e, !1);
                    if ("nsfw" === e.type) return ta(ea({}, e), {
                        isFullyLoaded: !0,
                        hasLoadedAnything: !0
                    });
                    if ("forum" === e.type) {
                    ...
                    n.then((function(n) {
                        t.setState({
                            ...
                            channels: t.updateChannel(e.channelId, (function(e) {
                                ...
                                var t = sa(e, !0);
                                0 !== t.messages.length && t.messages.length !== e.messages.length || (t = ta(ea({}, t), {
                                    hasLoadedAnything: !0,
                                    isFullyLoaded: !0,
                                    hasError: !n
                                }));
                ...
                var e = function() {
                    ...
                    t = function(e) {
                        ...
                        er.Z.getSortedPrivateChannels().forEach((function(n) {
                            return da(e, t, null, n.id)
                        }));
                        Ki.Z.getFlattenedGuildIds().forEach((function(n) {
                            if (null != n) {
                                var r = zi.ZP.getSelectableChannelIds(n),
                                    o = Vi.Z.getActiveJoinedUnreadThreadsForGuild(n);
                                r.forEach((function(r) {
                                    da(e, t, n, r);
                                    var i, a = null !== (i = o[r]) && void 0 !== i ? i : {};
                                    for (var l in a) da(e, t, n, l)
                                }))
                            }
                        }));
            ...
            function da(e, t, n, r) {
                if (null != r) {
                    ...
                    if (null != o) {
                        if (ir.Ec.has(o.type) || !Wi.Z.isGuildOrCategoryOrChannelMuted(n, o.id)) {
                            if (o.isPrivate()) {
                            ...
                            if (o.isPrivate() || Zi.Z.can(te.Plq.READ_MESSAGE_HISTORY, o)) {
                                ...
                                if (null != c && !(qi.Z.compare(i, c) >= 0)) {
                                    ...
                                    o.isNSFW() && Qi.Z.didAgree(o.guild_id) ? t.push(ta(ea({}, d), {
                                        type: "nsfw"
                                    })) : o.isForumLikeChannel() ? t.push(ta(ea({}, d), {
                                        type: "forum"
                                    })) : t.push(ta(ea({}, d), {
                                        type: "messages",
                                        messages: []
            ...
            function pa(e, t, n) {
                ...
                if (Bi.Z.isFavorite(t)) return ia.Favorite;
                if (r.isPrivate()) return ia.PrivateChannel;
                if (l.ZP.getMentionCount(t) > 0) return ia.Mentioned;
                if (null != n) {
                    var o = qi.Z.extractTimestamp(n);
                    if (Date.now() - o > 864e6) return ia.ReallyOldChannel;
                    if (Date.now() - o > 1728e5) return ia.OldChannel
                }
                if (r.isThread()) {
                    var i = (0, Yi.J)(r);
                    return i === ti.iN.ALL_MESSAGES ? ia.AllMessagesNotifications : i === ti.iN.NO_MESSAGES ? ia.NoNotifications : ia.GuildChannel
                }
                var a = Wi.Z.getChannelMessageNotifications(e, t),
                    u = a === te.bL.NULL ? Wi.Z.getMessageNotifications(e) : a;
                return u === te.bL.ALL_MESSAGES ? ia.AllMessagesNotifications : u === te.bL.NO_MESSAGES ? ia.NoNotifications : ia.GuildChannel
            }
            var ha = n(977166),
                ya = n.n(ha);
            ...
            function ga(e) {
                ...
                return (0, r.jsx)(k.FocusRing, {
                    offset: va,
                    children: (0, r.jsxs)("div", Ea(Oa({
                        className: ya().messageContainer,
                        onKeyDown: f
                    }, s), {
                        children: [(0, r.jsx)(Wr, {
                            className: ya().jumpButton,
                            onJump: function(e) {
                                return c(e, i.id)
                            }
                        }), (0, r.jsx)(Mi, {
            ...
            function Ra(e) {
                ...
                return (0,
                    r.jsx)(Zo.animated.div, {
                    ref: i,
                    style: b,
                    children: (0, r.jsx)(wa, Ta({}, e))
                })
            }
            const Ca = o.memo(Ra);
            ...
            function ja(e) {
                ...
                var s = function(e, r) {
                    (0, ko.yw)(te.rMx.INBOX_CHANNEL_CLICKED, {
                ...
                return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsx)(k.HeadingLevel, {
                        component: (0, r.jsxs)(yo, {
                            ...
                            children: [(0, r.jsx)(Wo, {
                                channel: u
                            }), (0, r.jsx)(Da, Ta({}, e)), "nsfw" === t.type ? null : (0, r.jsx)(Ma, Ta({}, e))]
                        }),
                        children: t.collapsed ? null : "messages" === t.type ? (0, r.jsx)(ma, {
                            channel: t,
                            channelRecord: u,
                            gotoChannel: s
            ...
            function Ma(e) {
                ...
                return (0, r.jsx)(k.Tooltip, {
                    ...
                    children: function(e) {
                        return (0, r.jsx)(k.Clickable, Na(Ta({}, e), {
                            className: m()(_a().collapseButton, Pa({}, _a().collapsed, t.collapsed)),
                            onClick: i,
            ...
            function Za(e, t, n) {
                ...
                return Lo().flatMap(e, (function(e) {
                    ...
                    c = e.sortOrder;
                    var s = [];
                    t && (e.hasLoadedAnything && e.sortOrder === ia.ReallyOldChannel ? s.push((0, r.jsx)(xo.Z, {
                        className: xa().divider,
                        contentClassName: xa().dividerContent,
                        children: Be.Z.Messages.UNREADS_OLD_CHANNELS_DIVIDER
                    }, "old-divider")) : e.hasLoadedAnything && e.sortOrder === ia.NoNotifications && s.push((0, r.jsx)(xo.Z, {
                        className: xa().divider,
                        contentClassName: xa().dividerContent,
            ...
            function Ya(e) {
                var t = e.setTab,
                    ...
                    f = Ha(function(e) {
                        ...
                        o.useEffect((function() {
                            Wi.Z.addChangeListener(n.handleUserGuildSettingsStoreChange);
                            return function() {
                                return Wi.Z.removeChangeListener(n.handleUserGuildSettingsStoreChange)
                            }
                        }), [n]);
                        o.useEffect((function() {
                            Hi.Z.addChangeListener(n.handleJoinedThreadsStoreChange);
                            return function() {
                                return Hi.Z.removeChangeListener(n.handleJoinedThreadsStoreChange)
                            }
                        }), [n]);
                        o.useEffect((function() {
                ...
                return (0, r.jsxs)("div", {
                    className: m()(Fa().container, "group-spacing-".concat(v)),
                        ...
                        children: (0, r.jsx)(ke.SJ, {
                            children: function(e) {
                                ...
                                return (0, r.jsxs)(k.AdvancedScrollerThin, Ga(function(e) {
                                    ...
                                    onScroll: h === aa.Done ? void 0 : b,
                                    className: Fa().scroller,
                                    children: [a ? (0, r.jsx)(za, {
                                        setSeenTutorial: l
                                    }) : null, Za(y, p, n), h === aa.Done ? null : (0, r.jsx)(k.Spinner, {
            ...
            function za(e) {
                ...
                return (0, r.jsxs)("div", {
                    className: Fa().tutorial,
                    children: [(0, r.jsx)("div", {
                        className: Fa().tutorialIcon,
                        children: (0, r.jsx)(E, {
                            width: 24,
                            height: 24
                        })
            ...
            function tl(e) {
                ...
                return (0, r.jsx)(Wa, {
                    ...
                    children: function(e, t, n) {
                        return (0, r.jsx)("div", {
                            className: Xa().recentsIcon,
                            children: (0, r.jsx)(v.JO, el($a({}, n), {
                                className: o,
                                onClick: e,
                                icon: E,
                                "aria-label": Be.Z.Messages.INBOX,

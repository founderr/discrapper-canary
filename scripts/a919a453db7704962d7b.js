    ...
    ["84817"], {
        ...
        152584: function(e, t, n) {
            ...
            function T(e) {
                ...
                return s.default.dispatch({
                    ...
                    return null != E.DEVICE_PUSH_VOIP_PROVIDER && null != c && (s.push_voip_provider = E.DEVICE_PUSH_VOIP_PROVIDER, s.push_voip_token = c), S(s)
                }, {
                    checkEnabled: !1,
                    modalProps: {
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: g
                } = (0, f.usePaymentContext)(), N = S.find(e => e.key === h);
                r.useEffect(() => {
                    C(null)
        ...
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, E = (0, l.useStateFromStores)([s.default], () => s.default.useReducedMotion), [_, p] = r.useState(d), I = r.useRef((0, u.getGiftAnimationData)(t, _)), [h, S] = r.useState(null == f), [T, v] = r.useState(!1), [C, g] = r.useState(-1), N = () => {
        ...
        708169: function(e, t, n) {
            ...
            function T(e) {
                ...
                return (0, f.useFocusLock)(n), s.useEffect(() => (E.default.disable(), E.default.enableTemp(function(e) {
                    return {
                        POP_LAYER: {
                            binds: ["esc"],
            ...
            function g() {
                let {
                    reducedMotion: e
                } = s.useContext(f.AccessibilityPreferencesContext), t = e.enabled, n = t ? C : v, i = S(e => e.fullScreenLayers);

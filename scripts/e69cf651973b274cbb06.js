    ...
    [24570, 33600, 65091, 96043, 71402], {
        ...
        652411: (t, e, n) => {
            ...
            function P(t) {
                return function(t) {
                    switch (t.type) {
                        ...
                        case "static-random":
                            return new b(_(t.minValue, t.maxValue));
                        case "linear":
                            return new m(t.value, t.addValue);
                        case "linear-random":
                            return new m(_(t.minValue, t.maxValue), _(t.minAddValue, t.maxAddValue));
                        case "oscillating":
            ...
            function T(t) {
                return function(t) {
                    switch (t.type) {
                        case "static":
                            var e = w(t.value);
                            return new y(new b(e.x), new b(e.y));
                        case "static-random":
                            var n = w(t.minValue),
                                r = w(t.maxValue);
                            return new y(new b(_(n.x, r.x)), new b(_(n.y, r.y)));
                        case "linear":
                            e = w(t.value);
                            var i = w(t.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = w(t.minAddValue),
                                u = w(t.maxAddValue);
                            return new y(new m(_(n.x, r.x), _(o.x, u.x)), new m(_(n.y, r.y), _(o.x, u.x)));
                        case "oscillating":
                            e = w(t.value);
                            var a = w(t.start),
                                l = w(t.final),
            ...
            function R(t) {
                return function(t) {
                    switch (t.type) {
                        case "static":
                            var e = I(t.value);
                            return new g(new b(e.x), new b(e.y), new b(e.z));
                        case "static-random":
                            var n = I(t.minValue),
                                r = I(t.maxValue);
                            return new g(new b(_(n.x, r.x)), new b(_(n.y, r.y)), new b(_(n.z, r.z)));
                        case "linear":
                            e = I(t.value);
                            var i = I(t.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = I(t.minAddValue),
                                u = I(t.maxAddValue);
                            return new g(new m(_(n.x, r.x), _(o.x, u.x)), new m(_(n.y, r.y), _(o.y, u.y)), new m(_(n.z, r.z), _(o.z, u.z)));
                        case "oscillating":
                            e = I(t.value);
                            var a = I(t.start),
                                l = I(t.final),
            ...
            var C = r.forwardRef((function(t, e) {
                    ...
                    _ = r.useCallback((function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                })), null == p || p(e), g.current.size > 0 ? b.current = window.requestAnimationFrame(_) : (e.clearRect(0, 0, t.width, t.height), b.current = null);
                                var n = Date.now();
                ...
                r.useEffect((function() {
                    null != b.current && (window.cancelAnimationFrame(b.current), b.current = window.requestAnimationFrame(_))
                }), [_]);
        ...
        396043: (t, e, n) => {
            ...
            function U(t, e, n) {
                ...
                i()(m.Z.getVoiceStates(t)).filter((function(t) {
            ...
            function k(t, e) {
                ...
                i()(m.Z.getVoiceStates(t)).forEach((function(t) {
        ...
        133600: (t, e, n) => {
            ...
            var Y = function(t) {
                    ...
                    i.render = function() {
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(l.ModalRoot, {
                                ...
                                className: C().modal,
                                "aria-labelledby": s,
                                children: [null != c.giftStyle && !b && (0, r.jsx)(I.Z, {
                                    giftStyle: c.giftStyle,
                                    className: C().seasonalGiftIcon
                                }), (0, r.jsx)("div", {
                                    className: b ? void 0 : C().backSplash
                                }), (0, r.jsxs)(l.ModalContent, {
                                    className: u()((t = {}, k(t, C().content, !b), k(t, C().contentCustomGift, b), t)),
                                    children: [(0, r.jsx)(l.ModalCloseButton, {
                                        onClick: a,
                                        className: C().closeButton
                                    }), (null == c.giftStyle || b && this.state.accepted) && (0, r.jsx)(O.Z, {
                                        size: O.Z.Sizes.LARGE,
                                        game: i,
                                        skuId: c.skuId
                                    }), (0, r.jsxs)(l.Heading, {
                                        id: s,
                                        className: u()((e = {}, k(e, C().customGiftHeader, b && !m),
                                            k(e, C().header, !b || m), e)),
                                        variant: "heading-sm/semibold",
                                        children: [(0, r.jsx)("div", {
                                            className: u()(k({}, C().customGiftHeaderText, b)),
                                            children: this.firstHeaderText
                                        }), (0, r.jsx)("div", {
                                            children: this.secondHeaderText
                                        })]
                                    }), !(b && !this.state.accepted) && (0, r.jsx)(l.Text, {
                                        className: C().body,
                                        variant: "text-sm/normal",
                                        children: this.bodyText
                                    }), b && null != c.giftStyle && !this.state.accepted && (0, r.jsx)(I.Z, {
                                        className: C().giftAnimation,
                                        giftStyle: c.giftStyle
                                    }), b && this.state.opened && !this.state.accepted && null != h && "" !== h && (0, r.jsxs)(r.Fragment, {
                ...
                W = a.ZP.connectStores([y.Z, m.Z, h.Z, v.Z, b.Z, f.Z], (function(t) {
                    var e = t.giftCode,
                        n = m.Z.get(e.skuId),
            ...
            const q = function(t) {
                var e = t.channelContext,
                    ...
                    o = D(t, ["channelContext", "code", "customGiftMessage"]),
                    u = (0, _.Dt)(),
                    l = (0, a.e7)([v.Z], (function() {
                        return v.Z.get(n)
                    }));
                return null == l ? null : (0, r.jsx)(W, Z(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[t] && null != C[t][e]) {
                        ...
                        if (null != r) {
                            ...
                            for (var a in C[t][e]) e === j ? d.ZP.isNewForumThread(a, e, r) && L[t][e]++ : o.default.compare(a, i) > 0 && !d.ZP.hasOpenedThread(a) && L[t][e]++
                        }
                    }
                }
            }
        ...
        491260: (t, e, n) => {
            ...
            function j(t) {
                ...
                delete R[t];
                if (null != I[t]) {
                    var e = m(u().sortBy(I[t], (function(t) {
                            return -t.timestamp
                        })), 1),
                        n = e[0];
        ...
        750203: (t, e, n) => {
            ...
            const O = (0, f.hN)((function(t) {
                var e = t.width,
                    ...
                    l = t.foreground,
                    c = m(t, ["width", "height", "color", "foreground"]);
        ...
        58964: (t, e, n) => {
            ...
            function h(t, e) {
                ...
                var p, h, v, y, g, b = encodeURIComponent(l.toString()),
                    ...
                    S = "".concat(f, "/?link=").concat(b, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(m, "&efr=").concat(O);

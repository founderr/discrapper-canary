    ...
    ["74941"], {
        ...
        833843: function(e, t, n) {
            ...
            function L(e) {
                let {
                    ...
                    isMember: u,
                    recurrenceId: d
                } = e, c = (0, E.isGuildScheduledEventActive)(t), f = (0, r.useStateFromStores)([E.default], () => E.default.isInterestedInEventRecurrence(t.id, d), [d, t]), C = (0, _.default)(t), h = (0, r.useStateFromStores)([o.default], () => o.default.isLurking(n.id), [n.id]), p = (0, v.useIsChannelPublic)(null == l ? void 0 : l.id, t.id), S = (0, y.default)({
                    guild: n,
                    channel: l,
            ...
            var O = e => {
                let {
                    ...
                    onClose: v
                } = e, [g, N] = l.useState(_), y = (0, r.useStateFromStores)([E.default], () => E.default.getGuildScheduledEvent(t), [t]), O = null == y ? void 0 : y.id, b = null == y ? void 0 : y.guild_id, {
                    guild: w,
                    isMember: M
                } = (0, h.default)(b, O), D = (0, a.default)(n), j = null == y ? void 0 : y.channel_id, V = (0, r.useStateFromStores)([u.default], () => u.default.getChannel(j), [j]), F = (0, d.useUID)(), [G, k] = l.useState(U.EventDetailSections.EVENT_INFO), H = (0, p.default)(O, g), B = (0, r.useStateFromStores)([E.default], () => E.default.getUserCount(O, g)), [Z, {
                    loading: W,
                    error: Y
                ...
                return (0, i.jsxs)(s.ModalRoot, {
                    ...
                    "aria-labelledby": F,
                    className: P.root,
                    children: [(null == y ? void 0 : y.image) != null && (0, i.jsx)(I.default, {
        ...
        360538: function(e, t, n) {
            ...
            function b(e) {
                let {
                    ...
                    recurrenceId: h,
                    setRecurrenceId: p
                } = e, y = (0, o.useStateFromStores)([C.default], () => null != C.default.getGuild(n.id), [n.id]), {
                    startTime: U,
                    endTime: b
                } = (0, g.default)(t.id, h), w = (0, o.useStateFromStores)([S.default], () => S.default.getUserCount(t.id, h)), M = l.useCallback(e => {
                    e.stopPropagation(), null != t && (0, d.transitionToGuildFromEventInvite)(t)
                }, [t]), D = (0, T.default)(t);
                l.useEffect(() => {
                    v.default.getGuildEventUserCounts(n.id, t.id, null != h ? [h] : []), v.default.getGuildEventsForCurrentUser(n.id)
                }, [n.id, t.id, h]);
                ...
                return (0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        onRecurrenceClick: p,
                        hideScroller: !0,
                        initialStartDate: null != h ? new Date(a.default.extractTimestamp(h)) : null
                    })]
                })
            }
        },
        586403: function(e, t, n) {
            ...
            function c(e) {
                let {
                    ...
                    channel: n,
                    onClose: c
                } = e, f = t.entity_type === u.GuildScheduledEventEntityTypes.EXTERNAL, C = l.useCallback(e => (0, a.createEventLocationClickHandler)(t, c)(e), [t, c]), E = (0, o.getLocationDataForEvent)(t, n);
                ...
                return (0, i.jsx)("div", {
                    className: d.row,
                    children: null != C ? (0, i.jsx)(r.Clickable, {
        ...
        403901: function(e, t, n) {
            ...
            function R(e) {
                ...
                let {
                    eventUser: n,
                    onContextMenu: l
                } = e, o = (0, s.useStateFromStores)([h.default], () => h.default.getUser(n.user_id)), d = null === (t = n.guild_member) || void 0 === t ? void 0 : t.guildId, p = (0, s.useStateFromStores)([_.default, E.default, C.default], () => n.user_id === C.default.getId() ? _.default.getStatus() : E.default.getStatus(n.user_id, d), [n.user_id, d]);
            ...
            function P(e) {
                ...
                let C = 0;
                return r.length >= S.MAX_RSVP_USER_DISPLAY_COUNT && f > S.MAX_RSVP_USER_DISPLAY_COUNT && (C = Math.max(f - r.length, 0)), 0 === r.length ? (0, i.jsx)(x, {
                    height: c,
                    children: (0, i.jsx)(N, {})
                }) : (0, i.jsx)(U, {
                    children: (0, i.jsx)(y, {
            ...
            let o = (0, l.createExperiment)({
                ...
                c = function() {
                    ...
                    let {
                        ...
                        user: l,
                        config: s
                    }), C = a && c && null != t && (null == t ? void 0 : null === (e = t.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible) !== !1;
                    return {
                        viewAndUseEnabled: a,
                        collectEnabled: C,
                        showTryPacksModalAndV2Copy: d,
        ...
        650484: function(e, t, n) {
            ...
            function E(e) {
                ...
                l.useEffect(() => {
                    g(null)
                }, [p, g]), o(null != N, "Unknown step for current payment flow.");
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == N ? void 0 : null === (a = N.options) || void 0 === a ? void 0 : a.renderHeader) || void 0 === d || d ? E : null, N.renderStep(h), null == p || m ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                L = !0, null == _ || _(), !g && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: h,
                            analyticsLocations: p,
                            analyticsObject: v,
                    ...
                    onCloseCallback: () => {
                        !L && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: y,
                            location_stack: p
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == E || E(L), L && (!g && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == h || h())
                    },
            ...
            let p = e => {
                ...
                return (0, r.jsxs)(d.Button, {
                    ...
                    children: [t, T ? (0, r.jsx)(h, {
                        shinePaused: f,
                        className: o(C.buttonShine, _ ? C.onlyShineOnHover : void 0, E),
                        shineSize: u
                    }) : null]
                })
            };

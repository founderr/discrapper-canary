...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [98847], {
        101566: (e, t, n) => {
            ...
            var E = new f.Z("UploaderBase.tsx"),
                I = function(e) {
                    ! function(e, t) {
                    ...
                    function n(e) {
                        ...
                        r._handleError = function(e) {
                            ...
                            if (!r._aborted) {
                                r._errored = !0;
                                E.log("_handleError: ".concat(t, " (").concat(JSON.stringify(n), ") for ").concat(r.id));
                        ...
                        r._handleComplete = function(e) {
                            r.clearProcessingMessageInterval();
                            E.log("_handleComplete for ".concat(r.id));
                            r.emit("complete", r._file, e);
                            r.removeAllListeners()
                        };
                        r.id = s().uniqueId("Uploader");
                        r._url = e;
                        r._method = i;
            ...
            var B = function(e, t) {
                ...
                F = new r.Z("CloudUploaderBase.tsx"),
                G = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        e.prototype = Object.create(t && t.prototype, {
                                ...
                                switch (v.label) {
                                    case 0:
                                        ...
                                        if (e.files.length > r.getMaxAttachmentsCount()) {
                                            ...
                                            e._handleError({
                                                code: x.evJ.TOO_MANY_ATTACHMENTS
                                            });
                                            return [2, !1]
                                        }
                                        return [3, 10];
                                    ...
                                    case 4:
                                        ...
                                        if (0 === (null !== (p = f.currentSize) && void 0 !== p ? p : 0)) {
                                            e._handleError({
                                                code: x.evJ.ENTITY_EMPTY
                                            });
                                            return [2, !1]
                                        }
                                        if ((null !== (m = f.currentSize) && void 0 !== m ? m : 0) > r.getMaxFileSize(f.channelId)) {
                                            e._handleError({
                                                code: x.evJ.ENTITY_TOO_LARGE,
                                                reason: {
                    ...
                    r._filesTooLarge = function() {
                        return this.files.some((function(e) {
                            return e.error === x.evJ.ENTITY_TOO_LARGE
                        }))
                    };
                    r.setUploadingTextForUI = function() {
                        var e = 1 === this.files.length && null != this.files[0].filename ? this.files[0].filename : A.Z.Messages.UPLOADING_FILES.format({
                            ...
                            return B(this, (function(l) {
                                switch (l.label) {
                                    case 0:
                                        ...
                                        if (n.status === i.m.CANCELED) return [2];
                                        r = t.files.indexOf(n);
                                        t.files = D(t.files.slice(0, r)).concat(D(t.files.slice(r + 1)));
                                        t._file = R(U({}, t._file), {
                                            items: t.files
                                        });
                                        return [4, (0, o.V)(n)];
                                    ...
                                    return new Promise((function(r, o) {
                                        switch (e.status) {
                                            ...
                                            case i.m.COMPLETED:
                                                ...
                                                break;
                                            case i.m.ERROR:
                                                t && e.error !== x.evJ.ENTITY_TOO_LARGE ? e.upload() : o(new Error("File failed to upload"));
                                                break;
                                            case i.m.CANCELED:
        ...
        698847: (e, t, n) => {
            ...
            function K(e, t) {
                c.ZP.enqueue({
                    ...
                    var r;
                    (0, y.Sg)(e.nonce, e.channelId, null !== (r = e.guildId) && void 0 !== r ? r : null, n);
                    n.ok && null != t && t()
                }))
            }

    ...
    ["19482"], {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var l, s, c, d, E, _, f, I, h, T, A, N, p, S, O, v, g = (l = u, E = Array(32768), l.forEach(function(n) {
                        ...
                        var D = (_ = u, f = g, A = 1e6, N = 0, p = 1e6, S = 0, O = 1e6, v = 0, _.forEach(function(e) {
                                I = e[0] >> t, h = e[1] >> t, T = e[2] >> t, I < A ? A = I : I > N && (N = I), h < p ? p = h : h > S && (S = h), T < O ? O = T : T > v && (v = T)
                            }), new i(A, N, p, S, O, v, f)),
        ...
        447651: function(t, e, n) {
            ...
            let I = "https://media.discordapp.net",
                h = /^.*\.discordapp\.net$/,
                T = "https://cdn.discordapp.com",
                A = "".concat(I, "/stickers"),
                N = new Set(["jpg", "jpeg", "png", "webp", "gif", "tiff", "bmp"]),
            ...
            function v(t, e, n) {
                ...
                if (o || (null == n ? void 0 : n.shouldHideMediaOptions) === !0 || !s.isPlatformEmbedded || null == t || ! function(t) {
                        let e = new URL(t),
                            n = S(t);
                        return (h.test(e.hostname) || e.origin === T) && !t.startsWith(A) && !(0, u.isRoleIconAssetUrl)(t) && null != n && N.has(n)
                    }(t)) return null;
                let c = function(t) {
                        let e = new URL(t);
                        return e.origin === T ? t : e.origin === I ? T + e.pathname : (e.searchParams.delete("width"), e.searchParams.delete("height"), e.searchParams.set("quality", "lossless"), e.toString())
                    }(t),
                    v = async () => {
                        try {
        ...
        235004: function(t, e, n) {
            ...
            class L extends a.default.Store {
                ...
                hasFetchedAllSounds() {
                    return S === r.FETCHED && p === r.FETCHED
                }
            }
            L.displayName = "SoundboardStore";
            var R = new L(l.default, {
                LOGOUT: function() {
                    T.clear(), A.clear(), v.clear(), g = !1, S = r.NOT_FETCHED, p = r.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(t) {
                    ...
                    let {
                        soundId: i,
                        userId: o
                    } = t, u = (null !== (n = A.get(i)) && void 0 !== n ? n : 0) + 1, a = (null !== (r = v.get(o)) && void 0 !== r ? r : 0) + 1;
                    A.set(i, u), v.set(o, a), o !== (null === (e = d.default.getCurrentUser()) || void 0 === e ? void 0 : e.id) && (g = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(t) {
                    ...
                    let {
                        soundId: r,
                        userId: i
                    } = t, o = (null !== (e = A.get(r)) && void 0 !== e ? e : 0) - 1, u = (null !== (n = v.get(i)) && void 0 !== n ? n : 0) - 1;
                    o <= 0 ? A.delete(r) : A.set(r, o), u <= 0 ? v.delete(i) : v.set(i, u)
                },
                ...
                USER_SETTINGS_PROTO_UPDATE: function(t) {
                    ...
                    } else n === h.UserSettingsTypes.PRELOADED_USER_SETTINGS && M(r)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(t) {
                    ...
                    T.set(f.DEFAULT_SOUND_GUILD_ID, e), p = r.FETCHED
                },
                ...
                OVERLAY_INITIALIZE: function(t) {
                    ...
                    T = new Map(Object.entries(e.soundboardSounds)), O = new Set(e.favoritedSoundIds), N = new Set(e.localSoundboardMutes)
                },

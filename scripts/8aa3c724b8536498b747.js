                    ...
                    for (let e = 0, n = 0; e < O; e++)
                        for (let u = 0; u < R; u++, n += 4) {
                            let l = o,
                                ...
                                E = d,
                                h = p;
                            for (let e = 0, r = i(_, f ? 5 : 3); e < r; e++) M[e] = a(t / R * (u + .5) * e);
                            for (let r = 0, n = i(C, f ? 5 : 3); r < n; r++) P[r] = a(t / O * (e + .5) * r);
        ...
        765221: function(e, t, r) {
            ...
            let L = () => 80,
                ...
                O = e => {
                    ...
                    }), h = (0, o.default)([E.default], () => E.default.isItemViewed(r)), L = T.default.canUseCollectibles(t), O = u === m.Section.PREMIUM_PURCHASE && !L, [N, M] = i.useState(l);
                    i.useEffect(() => {
                        l && M(!0)
                    }, [l]);
                    let P = i.useRef(null),
        ...
        216719: function(e, t, r) {
            ...
            var d = new c(a.default, {
                COLLECTIBLES_SHOP_OPEN: e => {
                    var t, r;
                    l = null !== (t = e.analyticsLocations) && void 0 !== t ? t : u, s = null !== (r = e.analyticsSource) && void 0 !== r ? r : null, n = e.initialItem
                },
        ...
        19287: function(e, t, r) {
            ...
            function c(e) {
                let {
                    ...
                    pendingAvatar: I
                } = (0, o.default)({}), T = (0, i.useStateFromStores)([l.default], () => null != r && null != t ? l.default.getMember(r, t.id) : null), m = n.useMemo(() => null != t ? (0, u.getPreviewAvatar)(d ? null != E ? E : I : void 0, T, t, {
                    canAnimate: S,
                    size: c

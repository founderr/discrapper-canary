            ...
            function w(e) {
                ...
                if (!b.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== m.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = U(u, i),
                        c = N({}, t, A(a), null != i && null != o && (0, T.AB)(o) ? R(0, o) : L(u));
                    b.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        43299: (e, t, n) => {
            ...
            var p, _ = new Set([l.pK.ARS, l.pK.CLP, l.pK.COP]),
                ...
                I = function(e) {
                    ...
                    E.has(I) && (S = c.Z.Messages.LOCALIZED_PRICING_BANNER_BODY_EXISTING_CURRENCY.format({
                        helpCenterLink: o.Z.getArticleURL(a.BhN.LOCALIZED_PRICING),
                        localizedPriceWithCurrencySymbol: T
                    }));
                    _.has(I) && (S = c.Z.Messages.LOCALIZED_PRICING_BANNER_BODY_NEW_CURRENCY_WITH_AMBIGUOUS_SYMBOL.format({
                        helpCenterLink: o.Z.getArticleURL(a.BhN.LOCALIZED_PRICING),
                        currencyISOCode: I.toUpperCase(),
                        localizedPriceWithCurrencySymbol: T
                    }));
                    ...
                    I === l.pK.EUR && (S = s ? c.Z.Messages.LOCALIZED_PRICING_BANNER_NO_LOWERED_PRICE_SINGLE_STRING.format({
                        country: (0, i.q9)(p),
                        currencyISOCode: I.toUpperCase(),
                        helpCenterLink: o.Z.getArticleURL(a.BhN.LOCALIZED_PRICING)
                    ...
                    if (y) {
                        var N = h.filter((function(e) {
                            ...
                            A = d(N).concat(d(P)).slice(0, 2).map((function(e) {
                                var t, n;

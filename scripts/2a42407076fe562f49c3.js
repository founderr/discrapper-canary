        ...
        309244: (e, t, r) => {
            ...
            const k = function(e) {
                var t = e.user,
                    ...
                    g = A.dN.useSetting() && null != a ? C.ZP.parse(void 0, a).content : a,
                    h = {
                        user: t,
            ...
            const fe = function(e) {
                var t, r = e.user,
                    ...
                    b = E.ZP.canUsePremiumProfileCustomization(r),
                    y = a.length > 0,
                    O = 0 === u.length,
            ...
            function he(e) {
                var t, r = e.transitionState,
                    ...
                    L = D.AnalyticsLocationProvider,
                    Z = D.analyticsLocations,
                    N = (0, S.hi)("pfx modal"),
                    T = (0, m.Z)(null !== (t = null == A ? void 0 : A.id) && void 0 !== t ? t : ""),
                    _ = (0, i.e7)([v.Z], (function() {
                        return v.Z.getPendingProfileEffectID()
                    })),
                    M = Oe(o.useState(null != (null == T ? void 0 : T.profileEffectID) ? null == T ? void 0 : T.profileEffectID : _), 2),
                    R = M[0],
                    B = M[1],
                    H = Oe(o.useState(!1), 2),
                    U = H[0],
                ...
                o.useEffect((function() {
                    null != O ? B(O) : null != b ? B(b) : null === _ && B(_)
                }), []);
                o.useEffect((function() {
                    F(z.some((function(e) {
                    ...
                    children: (0, n.jsx)(c.ModalRoot, {
                        ...
                        children: (0, n.jsxs)(n.Fragment, {
                            children: [(0, n.jsxs)(c.ModalHeader, {
                                ...
                                onApply: function() {
                                    (0, g.$C)(R, null == T ? void 0 : T.profileEffectID);
                                    h()
                                },
                                onClose: h,
                                selectedEffectIsOwned: N || U,
                                user: A
                            })]
                        })
                    })

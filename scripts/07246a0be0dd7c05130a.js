        ...
        630689: (e, t, n) => {
            ...
            var L, R, g = (S(_ = {}, N.NORMAL, {
                ...
                b = function(e) {
                    ...
                    a.render = function() {
                        ...
                        return (0, r.jsx)(c.Z, {
                            className: i()(f().sequencedAnimation, t),
                            importData: this.importDefault,
                            nextScene: u ? N.IDLE : n,
                            sceneSegments: g,
                            onScenePlay: o,
                            onSceneComplete: a,
            ...
            var w, C, j = (S(P = {}, v.IDLE_ENTRY, {
                ...
                V = function(e) {
                    ...
                    function o() {
                        d(this, o);
                        var e;
                        (e = t.apply(this, arguments)).backgroundAnimation = new s.Z.ValueXY({
                            x: 0,
                            y: 0
                        });
                        ...
                        e.animateIdleLoopBackground = function() {
                            if (!e.didUnmount) {
                                ...
                                s.Z.timing(e.backgroundAnimation.x, {
                                    ...
                                    duration: M.IDLE_LOOP.duration * Z,
                                    easing: s.Z.Easing.linear
                    ...
                    a.animateEntry = function(e) {
                        s.Z.parallel([s.Z.timing(this.foregroundAnimation.y, {
                            ...
                            toValue: e.toValue,
                            duration: e.duration * Z,
                            delay: e.delay || 0
                        })]).start()
                    };
                    a.animateIdleEntry = function() {
                        this.animateEntry(M.IDLE_ENTRY)
                    };
                    a.animateError = function() {
                        this.animateEntry(M.ERROR)
                    };
                    a.animateIdleLoop = function() {
                        this.animateIdleLoopBackground();
                        this.animateIdleLoopForeground()
                    };
                    a.animateBoostStart = function() {
                        s.Z.parallel([s.Z.timing(this.foregroundAnimation.y, {
                            ...
                            toValue: M.BOOST_START.toValue,
                            duration: M.BOOST_START.duration * Z,
                            delay: M.BOOST_START.delay
                        })]).start()
                    };
                    a.render = function() {
                        var e = this.props,
                            ...
                            a = e.onSceneComplete;
                        return (0, r.jsxs)("div", {
                            className: i()(f().tier2Animation, t),
            ...
            function W(e) {
                var t = e.animate,
                    ...
                    a = n[0],
                    i = n[1],
                    s = (0, u.useSprings)(U.length, U.map((function(e, n) {
                        var r, o, u = n > 0 ? F.DELAY_STAGGER * n + Math.random() * (F.DELAY_MAX - F.DELAY_MIN) + F.DELAY_MIN : 0,
                            s = Math.random() * (F.SIZE_MAX - F.SIZE_MIN) + F.SIZE_MIN;
                        return {
                            from: {
                                scale: F.SCALE_INITIAL,
                                rotate: F.ROTATE_INITIAL,
                                top: e.top,
                                left: e.left,
                                width: s,
                                height: s
                            ...
                            to: (o = (r = function(e) {
                                return A(this, (function(r) {
                                    switch (r.label) {
                                        case 0:
                                            return t ? [4, e({
                                                scale: F.SCALE_MIDDLE,
                                                rotate: F.ROTATE_MIDDLE,
                                                delay: u,
                                                config: {
                                                    duration: F.DURATION_MIDDLE,
                                                    easing: F.EASING_MIDDLE
                                                }
                                            })] : [3, 4];
                                        case 1:
                                            r.sent();
            ...
            var H = function(e) {
                ...
                a.render = function() {
                    var e = this.props,
                        ...
                        s = e.pauseWhileUnfocused;
                    return (0, r.jsxs)("div", {
                        className: i()(f().guildWrapper, t),
                        children: [(0, r.jsx)(c.Z, {
                            className: f().guildBackground,
                            importData: this.importData,
                            nextScene: o ? w.IDLE : n,
                            sceneSegments: Y,
                            onScenePlay: a,
                            onSceneComplete: u,
                            pauseWhileUnfocused: s,
...
//# sourceMappingURL=07246a0be0dd7c05130a.js.map
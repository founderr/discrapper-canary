(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["51381"], {
        ...
        730647: function(e, t, a) {
            ...
            var n, l, s, i, d, r, u, o, E = a("316693"),
                _ = a("991170"),
                c = a("49111"),
                T = a("782340");
                ...
                o = (e, t) => {
                    let a = (0, l.useStateFromStores)([d.default], () => d.default.getGuild(e), [e]),
                        ...
                        c = (0, l.useStateFromStores)([r.default], () => {
                            if (r.default.can(u.Permissions.ADMINISTRATOR, a) || o) return !0;
                            for (let {
                                    channel: e
                                }
                                of _) {
        ...
        194250: function(e, t, a) {
            ...
            function S(e) {
                let {
                    ...
                    guildId: null != d ? d : ""
                }), F = (0, _.useStageBlockedUsersCount)(y), Y = null != t && (0, I.isGuildScheduledEventActive)(t), w = l.useMemo(() => {
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [(0, n.jsx)("div", {
                        ...
                        children: null != y && !Y && F > 0 && (0, n.jsx)(c.BlockedUsersNotice, {
                            channelId: y
                        })
                    }), (0, n.jsxs)("div", {
                        className: m.form,
                        children: [(0, n.jsxs)(u.FormItem, {
                            ...
                            schedule: w,
                            recurrenceRule: H,
                            showEndDate: U === A.GuildScheduledEventEntityTypes.EXTERNAL,
                            requireEndDate: U === A.GuildScheduledEventEntityTypes.EXTERNAL,
                            ...
                            children: [(0, n.jsx)(u.Text, {
                                ...
                                children: [(0, n.jsx)(o.default, {
                                    ...
                                    makeURL: e => {
                                        ...
                                        if (null != d) {
                                            var a;
                                            return null !== (a = (0, L.default)((0, f.convertToFakeGuildEvent)(t, d, s))) && void 0 !== a ? a : null
                                        }
                                    },
                                    onChange: Z,
        ...
        590942: function(e, t, a) {
            ...
            function B(e) {
                let {
                    ...
                    valid: !0
                }], [_]), O = Object.keys(l).length, U = (0, h.isGuildScheduledEventActive)(a), y = U ? l.SETTINGS : l.ENTITY, P = e => Math.max(0, Math.min(e, O - 1)), [V, B] = i.useState(y), [H, b] = i.useState(!1), F = i.useMemo(() => m.slice(0, V + 1).map(e => e.valid).every(Boolean), [m, V]), Y = V >= m.length ? l.SUCCESS : m[P(V)].slideId, w = Y === l.SUCCESS, k = (0, g.useGuildEventModalStore)(e => e.onUpdateCanCloseModal);
                k(w);
                let X = (0, d.useStateFromStores)([o.default], () => o.default.useReducedMotion),
                    Z = i.useRef(null),
                    z = e => {
                        b(!1), B(P(e))
                    };
            ...
            function H(e) {
                let {
                    ...
                    if (v && null != n) return await A.default.saveEvent(n, g, t, e), o();
                    let a = await A.default.createGuildEvent(g, t, e);
                    return R(a.body), a
                ...
                return (0, s.jsx)(B, {
                    ...
                    onChange: e => {
                        if (null != e.entityType) {
                            ...
                            e.channelId = null !== (a = null == l ? void 0 : l.id) && void 0 !== a ? a : null, e.entityType !== U.GuildScheduledEventEntityTypes.EXTERNAL && g.entityType === U.GuildScheduledEventEntityTypes.EXTERNAL && (e.entityMetadata = null)
                        }
                        S(t => ({
                            ...t,
                            ...e
                    ...
                    onSave: () => {
                        null != g.recurrenceRule && v ? (0, r.openModalLazy)(async () => {
                            let {
                                ConfirmModal: e
        ...
        560309: function(e, t, a) {
            ...
            var n = a("37983"),
                ...
                D = a("782340"),
                O = a("869785");
            let U = e => e === v.GuildScheduledEventEntityTypes.EXTERNAL,
                y = (e, t) => {
                ...
                x = e => {
                    let {
                        ...
                        disabled: i,
                        entityType: d
                    } = e, o = a === G.ChannelTypes.GUILD_STAGE_VOICE, E = (0, m.isChannelPublic)(l, d), _ = (0, M.useGetEventChannelsByType)(t, a);
            ...
            function B(e) {
                let {
                    ...
                    entityType: u,
                    channelId: E
                } = a, _ = (0, d.useStateFromStores)([o.default], () => o.default.getChannel(E), [E]), c = l.useRef(null);
                l.useEffect(() => {
                    if (i && U(u)) {
                        var e;
                ...
                let T = P(s),
                    ...
                    L = (0, A.isGuildScheduledEventActive)(a);
                return null == u || u === v.GuildScheduledEventEntityTypes.NONE ? null : U(u) ? (0, n.jsx)(r.FormItem, {
            ...
            function H(e) {
                let {
                    ...
                    guildEvent: a,
                    onChange: s
                } = e, i = (0, d.useStateFromStores)([E.default], () => E.default.getGuild(t), [t]), u = (0, p.default)(t, void 0), o = (0, p.default)(t, G.ChannelTypes.GUILD_VOICE), _ = (0, p.default)(t, G.ChannelTypes.GUILD_STAGE_VOICE), c = (0, M.useGetEventChannelsByType)(t, G.ChannelTypes.GUILD_VOICE), T = (0, N.useChannelsUserCanStartStageIn)(i), C = null == i ? void 0 : i.hasFeature(G.GuildFeatures.COMMUNITY), h = (0, A.isGuildScheduledEventActive)(a), m = j(s, a), g = l.useMemo(() => {
                    let e = [{
            ...
            function b(e) {
                let {
                    ...
                    entityType: o
                } = l, c = (0, d.useStateFromStores)([E.default], () => E.default.getGuild(t), [t]), T = (0, N.useChannelsUserCanStartStageIn)(c), I = (0, d.useStateFromStores)([_.default], () => _.default.can(G.Permissions.MANAGE_CHANNELS, c)), f = null == c ? void 0 : c.hasFeature(G.GuildFeatures.COMMUNITY), C = j(i, l), L = f && !U(o) && 0 === T.length && I && null != o;
                return (0, n.jsxs)("div", {
        ...
        151859: function(e, t, a) {
            ...
            function A(e) {
                ...
                let {
                    ...
                    image: D,
                    description: O
                } = S, U = (0, s.useStateFromStores)([u.default], () => u.default.getChannel(v), [v]), y = (0, s.useStateFromStores)([o.default], () => o.default.getGuild(M), [M]), x = (0, T.getLocationFromEvent)(S), R = (0, s.useStateFromStores)([E.default], () => null != N.creatorId ? E.default.getUser(N.creatorId) : E.default.getCurrentUser(), [N.creatorId]), P = (0, s.useStateFromStores)([r.default], () => r.default.isLurking(M), [M]), V = (0, d.getChannelIconComponent)(U, y);
                return (0, n.jsxs)("div", {
                    className: h.content,
                    children: [(0, n.jsx)(f.default, {
                        ...
                        name: G,
                        description: O,
                        imageSource: (A = (0, c.convertToFakeGuildEvent)(N, M, m), null == (p = D) && null == A.image ? null : null != p && /^data:/.test(p) ? p : (0, I.default)(A)),
                        isActive: !1,
                        isUserLurking: P,
                        speakers: [],
                        speakerCount: 0,
                        ...
                        children: [(0, n.jsx)(i.Heading, {
                            ...
                            children: null != location ? L.default.Messages.GUILD_EVENT_PREVIEW_EXTERNAL_EVENT_BODY : L.default.Messages.GUILD_EVENT_PREVIEW_BODY.format({
                                channelName: null !== (a = null == U ? void 0 : U.name) && void 0 !== a ? a : "",
        ...
        499950: function(e, t, a) {
            ...
            function g(e) {
                ...
                }, [G]), O = (0, l.useStateFromStores)([_.default], () => _.default.getGuild(G), [G]), U = (null == O ? void 0 : O.vanityURLCode) != null && (null == O ? void 0 : O.vanityURLCode.length) > 0, {
                    enabled: y
                ...
                let V = y && null !== (t = null == O ? void 0 : O.vanityURLCode) && void 0 !== t ? t : null == P ? void 0 : P.code,
                    j = null != V ? (0, i.generateInviteKeyFromExtraData)({
                        baseCode: V,
                        guildScheduledEventId: R
                    }) : null,
                    B = null == j || null == P,
                    H = (0, r.default)(null != j ? j : ""),
                    ...
                    children: [(0, n.jsx)(s.Clickable, {
                        ...
                        children: [(0, n.jsx)(u.RawInviteCopyInputConnected, {
                            ...
                            onCopy: e => {
                                ...
                                f.default.track(A.AnalyticEvents.COPY_INSTANT_INVITE, {
                                    server: v.guild_id,
                                    channel: x,
                                    channel_type: t,
                                    location: A.InstantInviteSources.GUILD_EVENTS,
                                    code: P.code,
        ...
        656913: function(e, t, a) {
            ...
            function f(e) {
                let {
                    ...
                    ..._
                } = e, f = (0, d.default)(), C = (0, i.isThemeDark)(f) ? T : I, L = {
                    height: 18,
                    width: 18,
                    color: (0, r.getColor)(C)
                };
        ...
        608684: function(e, t, a) {
            ...
            class f extends l.PureComponent {
                ...
                render() {
                    ...
                    if (null != (t = null != d && /^data:/.test(d) ? d : C(d)) ? a = 'url("'.concat(t, '")') : null != f && (l = (0, n.jsx)("div", {
                    ...
                    let R = null !== (e = null != x ? x : r) && void 0 !== e ? e : c.default.Messages.CHANGE_AVATAR;
                    return (0, n.jsxs)("div", {
                        className: i(T.imageUploader, M),
                        children: [(0, n.jsx)(u.FocusRing, {
                            within: !0,
                            children: (0, n.jsxs)("div", {
                                className: A ? i(T.imageUploaderIconWrapper, g) : void 0,
                                children: [(0, n.jsxs)("div", {
                                    className: i(T.imageUploaderInner, N),
                                    style: {
                                        ...G,
        ...
        650484: function(e, t, a) {
            ...
            function T(e) {
                ...
                l.useEffect(() => {
                    p(null)
                }, [C, p]), r(null != N, "Unknown step for current payment flow.");
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [null === (o = null == N ? void 0 : null === (d = N.options) || void 0 === d ? void 0 : d.renderHeader) || void 0 === o || o ? T : null, N.renderStep(f), null == C || m ? null : (0, n.jsxs)(n.Fragment, {
        ...
        79798: function(e, t, a) {
            ...
            let E = e => {
                ...
                })), t = l === r.BotTagTypes.AI ? o.botTagAI : a ? o.botTagInvert : o.botTagRegular;
                let p = e => (0, n.jsxs)("span", {
                    ...e,
                    className: s(E, t, T ? o.rem : o.px, {
                        [o.botTagOP]: L,
                        [o.botTagRemix]: h
                    }),
                    children: [c ? null : A, I, (0, n.jsx)("span", {
                        className: o.botText,
                        children: f
                    })]
                });
                ...
                return (0, n.jsx)("div", {
                    ...
                    children: t.map((e, t) => {
                        ...
                        return (0, n.jsxs)(i.Clickable, {
                            onClick: () => l(t),
                            className: r.stepContainer,
                            children: [(0, n.jsx)("div", {
                                className: s(r.progressBar, {
                                    [r.selectedProgressBar]: u
                                })
                            }), (0, n.jsx)(d.default, {
                                color: u ? d.default.Colors.BRAND : d.default.Colors.MUTED,
                                size: d.default.Sizes.SIZE_12,
                                children: e
                            })]
                        }, e)
                    })
        ...
        461380: function(e, t, a) {
            ...
            let c = {
                ...
                T = e => {
                    ...
                    if (!0 === L ? p = c.DOWN : !1 === L && (p = c.RIGHT), A) {
                        let e = {
                            [c.UP]: u.ChevronSmallUpIcon,
                            [c.DOWN]: i.ChevronSmallDownIcon,
                            [c.LEFT]: d.ChevronSmallLeftIcon,
                            [c.RIGHT]: r.ChevronSmallRightIcon
                        } [p];
                        return (0, n.jsx)(e, {
                            ...h,
                            className: f,

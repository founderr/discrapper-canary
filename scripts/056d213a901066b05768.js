(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [78095, 19887, 58093, 84832, 71402], {
        ...
        652411: (e, t, n) => {
            ...
            function T(e) {
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            return new m(E(e.minValue, e.maxValue));
                        case "linear":
                            return new b(e.value, e.addValue);
                        case "linear-random":
                            return new b(E(e.minValue, e.maxValue), E(e.minAddValue, e.maxAddValue));
                        case "oscillating":
                            return new O(e.value, e.start, e.final, e.duration, e.direction, e.easingFunction);
                        case "oscillating-random":
                            return new O(E(e.minValue, e.maxValue), E(e.minStart, e.maxStart), E(e.minFinal, e.maxFinal), E(e.minDuration, e.maxDuration), S(e.minDirection, e.maxDirection), _(e.easingFunctions)[0])
                    }
                }(h(h({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = w(e.minValue),
                                r = w(e.maxValue);
                            return new y(new m(E(n.x, r.x)), new m(E(n.y, r.y)));
                        case "linear":
                            t = w(e.value);
                            var i = w(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = w(e.minAddValue),
                                a = w(e.maxAddValue);
                            return new y(new b(E(n.x, r.x), E(o.x, a.x)), new b(E(n.y, r.y), E(o.x, a.x)));
                        case "oscillating":
                            t = w(e.value);
                            var u = w(e.start),
                                l = w(e.final),
                                c = w(e.duration),
                                s = w(e.direction);
                            return new y(new O(t.x, u.x, l.x, c.x, s.x, e.easingFunction), new O(t.y, u.y, l.y, c.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = w(e.minValue), r = w(e.maxValue);
                            var f = w(e.minStart),
                                d = w(e.maxStart),
                                ...
                                P = w(e.minDirection),
                                T = w(e.maxDirection);
                            return new y(new O(E(n.x, r.x), E(f.x, d.x), E(p.x, h.x), E(v.x, g.x), S(P.x, T.x), _(e.easingFunctions)[0]), new O(E(n.y, r.y), E(f.y, d.y), E(p.y, h.y), E(v.y, g.y), S(P.y, T.y), _(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = P(e.minValue),
                                r = P(e.maxValue);
                            return new g(new m(E(n.x, r.x)), new m(E(n.y, r.y)), new m(E(n.z, r.z)));
                        case "linear":
                            t = P(e.value);
                            var i = P(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = P(e.minAddValue),
                                a = P(e.maxAddValue);
                            return new g(new b(E(n.x, r.x), E(o.x, a.x)), new b(E(n.y, r.y), E(o.y, a.y)), new b(E(n.z, r.z), E(o.z, a.z)));
                        case "oscillating":
                            t = P(e.value);
                            var u = P(e.start),
                                l = P(e.final),
                                c = P(e.duration),
                                s = P(e.direction);
                            return new g(new O(t.x, u.x, l.x, c.x, s.x, e.easingFunction), new O(t.y, u.y, l.y, c.z, s.y, e.easingFunction), new O(t.z, u.z, l.z, c.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = P(e.minValue), r = P(e.maxValue);
                            var f = P(e.minStart),
                                d = P(e.maxStart),
                                ...
                                w = P(e.minDirection),
                                T = P(e.maxDirection);
                            return new g(new O(E(n.x, r.x), E(f.x, d.x), E(p.x, h.x), E(v.x, y.x), S(w.x, T.x), _(e.easingFunctions)[0]), new O(E(n.y, r.y), E(f.y, d.y), E(p.y, h.y), E(v.y, y.y), S(w.y, T.y), _(e.easingFunctions)[0]), new O(E(n.z, r.z), E(f.z, d.z), E(p.z, h.z), E(v.z, y.z), S(w.z, T.z), _(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var A = r.forwardRef((function(e, t) {
                    ...
                    E = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == p || p(t), g.current.size > 0 ? m.current = window.requestAnimationFrame(E) : (t.clearRect(0, 0, e.width, e.height), m.current = null);
                                var n = Date.now();
                ...
                r.useEffect((function() {
                    null != m.current && (window.cancelAnimationFrame(m.current), m.current = window.requestAnimationFrame(E))
                }), [E]);
        ...
        585798: (e, t, n) => {
            ...
            var E, _ = (0, p.Mg)(s.Z.FULL_SCREEN_LAYER_ANIMATION_DURATION);
            ! function(e) {
        ...
        498964: (e, t, n) => {
            ...
            const S = f(m((function(e) {
                ...
                P = e => Object.assign(f(e), {
                    startsWith: t => {
                        return P(y(e, (n = t, m((e => E(e) && e.startsWith(n))))));
                        var n
                    },
                    endsWith: t => {
                        return P(y(e, (n = t, m((e => E(e) && e.endsWith(n))))));
                        var n
                    },
                    minLength: t => P(y(e, (e => m((t => E(t) && t.length >= e)))(t))),
                    maxLength: t => P(y(e, (e => m((t => E(t) && t.length <= e)))(t))),
                    includes: t => {
                        return P(y(e, (n = t, m((e => E(e) && e.includes(n))))));
                        var n
                    },
                    regex: t => {
                        return P(y(e, (n = t, m((e => E(e) && Boolean(e.match(n)))))));
                        var n
                    }
                }),
                T = P(m(E)),
                x = (e, t) => m((n => O(n) && e <= n && t >= n)),
                R = e => m((t => O(t) && t < e)),
                C = e => m((t => O(t) && t > e)),
                A = e => m((t => O(t) && t <= e)),
                I = e => m((t => O(t) && t >= e)),

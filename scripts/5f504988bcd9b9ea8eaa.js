(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["34419"], {
        ...
        376507: function(e, t, n) {
            ...
            var d = {
                ...
                T = {
                    ...
                    clientExtensionResults: i(h, e => e.getClientExtensionResults())
                },
                g = {
                    mediation: u(o),
                    publicKey: c({
            ...
            async function m(e) {
                let t = await navigator.credentials.create(s(r, p, e));
                return s(a, T, t)
            }
            async function E(e) {
                let t = await navigator.credentials.get(s(r, g, e));
                return s(a, v, t)
            }
        },
        327037: function(e, t, n) {
            ...
            async function g(e) {
                ...
                try {
                    ...
                    return null == i || i(c.body, a), s.default.dispatch({
                        type: "USER_UPDATE",
                        user: c.body.user
                    }), s.default.dispatch({
                        type: "USER_PROFILE_FETCH_SUCCESS",
                        ...c.body
                    }), null != a && null != c.body.guild_member && s.default.dispatch({
                        type: "GUILD_MEMBER_PROFILE_UPDATE",
                        guildId: a,
                        guildMember: c.body.guild_member
                    }), c.body
                } catch (t) {
                    throw null != t && (null == t ? void 0 : t.body) != null && d.warn("fetchProfile error: ".concat(t.body.code, " - ").concat(t.body.message)), s.default.dispatch({
            ...
            async function v(e) {
                ...
                try {
                    ...
                    throw (null == t ? void 0 : t.body) != null && d.warn("fetchMutualFriends error: ".concat(t.body.code, " - ").concat(t.body.message)), s.default.dispatch({
        ...
        970254: function(e, t, n) {
            ...
            var r, a, o = n("862205");
            (r = a || (a = {})).ALLOWED = "allowed", r.DEFAULT = "default";
            var l = (0, o.createExperiment)({
                kind: "user",
        ...
        755993: function(e, t, n) {
            ...
            function T(e) {
                let {
                    ...
                    onClose: v,
                    redirectUri: m
                } = e, [E, C] = a.useState(!1), y = a.useCallback(async e => {
                    let n, {
                            location: r
                        } = e,
                        {
                    ...
                    try {
                        n = await i.default.completeTwoWayLink(t, r, a, o)
                    } catch (e) {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [null != v && (0, r.jsx)(s.ModalCloseButton, {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsxs)(a.ModalHeader, {
                        ...
                        children: (0, r.jsxs)(a.Button, {
                            ...
                            onClick: t,
                            children: [s.default.Messages.TRY_AGAIN, (0, r.jsx)(l.default, {
                ...
                let {
                    ...
                    try {
                        if (e = await (0, d.openProviderAuthorize)(t, {
                                twoWayLinkType: s.TwoWayLinkType.DESKTOP
                            }), null == e) throw Error("missing authorizeURL")
                    } catch (e) {
                        v.error("Error opening provider authorize page", e), E();
                        return
                    }
                    let {
                        state: n
                ...
                return a.useEffect(() => (c.default.subscribe("USER_CONNECTIONS_LINK_CALLBACK", I), () => {
                    ...
                    children: [(0, r.jsxs)(i.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(i.Text, {
                            ...
                            variant: "heading-xl/extrabold",
                            children: N
                        }), null != C && (0, r.jsx)(i.ModalCloseButton, {
        ...
        997511: function(e, t, n) {
            ...
            function i(e, t) {
                let [n, i] = r.useState(l.TwoWayLinkModalSlideTypes.LANDING), c = (0, a.default)(n), [u, d] = r.useState(null), [f, h] = r.useState(null), p = r.useCallback(() => {
                    switch (n) {
                        case l.TwoWayLinkModalSlideTypes.LANDING:
                            i(l.TwoWayLinkModalSlideTypes.PRE_CONNECT);
                            break;
                        case l.TwoWayLinkModalSlideTypes.DISCORD_CONSENT:
                            i(l.TwoWayLinkModalSlideTypes.SUCCESS);
                            break;
                        case l.TwoWayLinkModalSlideTypes.ERROR:
                            i(l.TwoWayLinkModalSlideTypes.PRE_CONNECT)
                    }
                }, [n]), T = r.useCallback(() => {
                    d(null), i(l.TwoWayLinkModalSlideTypes.ERROR)
                }, []), g = r.useCallback(e => {
                    d(e), i(l.TwoWayLinkModalSlideTypes.PRE_CONNECT_WAITING)
                }, []), v = r.useCallback(e => {
                    d(null), h(e), i(l.TwoWayLinkModalSlideTypes.DISCORD_CONSENT)
                }, []);
                return r.useEffect(() => {
                    n !== c && o.default.track(s.AnalyticEvents.ACCOUNT_LINK_STEP, {
                        location_stack: e,
                        previous_step: c,
                        current_step: n,
                        platform_type: t
        ...
        79798: function(e, t, n) {
            ...
            let d = e => {
                ...
                })), t = a === i.BotTagTypes.AI ? u.botTagAI : n ? u.botTagInvert : u.botTagRegular;

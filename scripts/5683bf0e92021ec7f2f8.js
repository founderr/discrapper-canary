(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["56854"], {
        960476: function(e, t, n) {
            ...
            let g = l.debounce(h, 250);

            function y(e, t) {
                let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                    r = arguments.length > 3 ? arguments[3] : void 0;
                "" === e ? m() : (s.default.dispatch({
            ...
            function N(e) {
                ...
                T(F.GIFPickerResultTypes.TRENDING_GIFS), i.default.get({
                    ...
                    R(r, F.GIFPickerResultTypes.TRENDING_GIFS, {
                        startTime: t,
                        limit: e
                    }), s.default.dispatch({
                        type: "GIF_PICKER_QUERY_SUCCESS",
            ...
            let i = e => {
                ...
                return (0, r.jsx)("svg", {
                    ...
                    children: (0, r.jsx)("path", {
                        fillRule: "evenodd",
                        clipRule: "evenodd",
                        d: "M2.06611 10.9395C1.0895 10.2299 1.59141 8.6852 2.79857 8.6852H8.92244L10.8148 2.86106C11.1878 1.71298 12.8121 1.71298 13.1851 2.86106L15.0775 8.6852H21.2013C22.4085 8.6852 22.9104 10.2299 21.9338 10.9395L16.9795 14.539L18.8719 20.3631C19.2449 21.5112 17.9309 22.4659 16.9543 21.7564L12 18.1568L7.04565 21.7564C6.06904 22.4659 4.75501 21.5112 5.12805 20.3631L7.02042 14.539L2.06611 10.9395ZM13.6244 10.6852H18.8812L14.6284 13.7751L16.2528 18.7746L12 15.6847L7.74713 18.7746L9.37156 13.7751L5.11873 10.6852H10.3755L12 5.68569L13.6244 10.6852Z",
            ...
            var r = n("37983"),
                ...
                F = l.memo(function(e) {
                    let {
                        ...
                        format: S,
                        className: p
                    } = e, [G, T] = l.useState(!1), R = (0, c.useIsFavoriteGIF)(F), h = R ? _.default.Messages.GIF_TOOLTIP_REMOVE_FROM_FAVORITES : _.default.Messages.GIF_TOOLTIP_ADD_TO_FAVORITES, g = R ? d.default : o.default;
                    l.useEffect(() => {
                        if (!G) return;
                        let e = setTimeout(() => {
                            T(!1)
                    ...
                    let y = e => {
                        e.preventDefault(), e.stopPropagation(), T(!0), R ? (0, s.removeFavoriteGIF)(F) : ((0, s.addFavoriteGIF)({
                            url: F,
                            src: a,
                            width: t,
                            height: n,

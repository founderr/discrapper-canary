                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = C(t.minStart),
                                ...
                                O = C(t.minDirection),
                                j = C(t.maxDirection);
                            return new y(new x(w(n.x, r.x), w(f.x, h.x), w(p.x, d.x), w(v.x, g.x), z(O.x, j.x), _(t.easingFunctions)[0]), new x(w(n.y, r.y), w(f.y, h.y), w(p.y, d.y), w(v.y, g.y), z(O.y, j.y), _(t.easingFunctions)[0]))
                    }
                }(d(d({}, t), {
                    valueType: "Vector2"
                }))
            ...
            var A = r.forwardRef(function(t, e) {
                    ...
                    R = r.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                }), null == y || y(e), S.current.size > 0 ? k.current = window.requestAnimationFrame(R) : (e.clearRect(0, 0, t.width, t.height), k.current = null);
                                var n = Date.now();
                                0 !== E.current && (P.current = 1e3 / (n - E.current)), E.current = n
                            }
                        }
                    }, [a, y, v]);
                r.useEffect(function() {
                    null != k.current && (window.cancelAnimationFrame(k.current), k.current = window.requestAnimationFrame(R))
                }, [R]);
                var M = r.useCallback(function(t, e) {
                    ...
                    V = r.useCallback(function(t, e, n, r, o) {
                        var a, u, c, f, h, p, v, y, C, A, S, k, E, P, R, V = (a = null !== (R = t.id) && void 0 !== R ? R : (0, i.v4)(), u = t, c = n, f = r, h = o, y = j((v = (p = u, d(d({
                            id: a
                        }, l), p))).size), A = (C = function(t, e) {
                            if (null != t) {
                            ...
                            id: a,
                            position: j(v.position),
                            velocity: j(v.velocity),
                                ...
                                switch (t.type) {
                                    ...
                                    case "linear-random":
                                        ...
                                        var o = O(t.minAddValue),
                                            a = O(t.maxAddValue);
                                        return new g(new b(w(n.x, r.x), w(o.x, a.x)), new b(w(n.y, r.y), w(o.y, a.y)), new b(w(n.z, r.z), w(o.z, a.z)));
                                    case "oscillating":
                                        e = O(t.value);
                                        var u = O(t.start),
                                            c = O(t.final),
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var f = O(t.minStart),
                                            ...
                                            C = O(t.minDirection),
                                            j = O(t.maxDirection);
                                        return new g(new x(w(n.x, r.x), w(f.x, h.x), w(p.x, d.x), w(v.x, y.x), z(C.x, j.x), _(t.easingFunctions)[0]), new x(w(n.y, r.y), w(f.y, h.y), w(p.y, d.y), w(v.y, y.y), z(C.y, j.y), _(t.easingFunctions)[0]), new x(w(n.z, r.z), w(f.z, h.z), w(p.z, d.z), w(v.z, y.z), z(C.z, j.z), _(t.easingFunctions)[0]))
                                }
                            }(d(d({}, E), {
                                valueType: "Vector3"
                            }))),
                            dragCoefficient: j(v.dragCoefficient),
                            size: y,
                            opacity: (P = v.opacity, function(t) {
                                switch (t.type) {
                                    ...
                                    case "oscillating-random":
                                        return new x(w(t.minValue, t.maxValue), w(t.minStart, t.maxStart), w(t.minFinal, t.maxFinal), w(t.minDuration, t.maxDuration), z(t.minDirection, t.maxDirection), _(t.easingFunctions)[0])
                                }
                            }(d(d({}, P), {
                                valueType: "number"
                            }))),
                            spriteX: k * c.spriteWidth + 2 * k,
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(a, u) {
                        ...
                        var c, s, l, f, h, p, d, v, y, g, m, b, x, w, _, z, C = (c = a, h = Array(32768), c.forEach(function(n) {
                        ...
                        var j = (p = a, d = C, m = 1e6, b = 0, x = 1e6, w = 0, _ = 1e6, z = 0, p.forEach(function(e) {
                                v = e[0] >> t, y = e[1] >> t, g = e[2] >> t, v < m ? m = v : v > b && (b = v), y < x ? x = y : y > w && (w = y), g < _ ? _ = g : g > z && (z = g)
                            }), new i(m, b, x, w, _, z, d)),
                        ...
                        A.push(j), S(A, .75 * u);
                        for (var k = new n(function(t, e) {
                                return r.naturalOrder(t.count() * t.volume(), e.count() * e.volume())
                            }); A.size();) k.push(A.pop());
                        S(k, u - k.size());
                        for (var E = new o; k.size();) E.push(k.pop());
                        return E
                    }
                }
            }();

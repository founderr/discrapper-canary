(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [60765, 81580, 66557, 71831, 96043, 53686, 1459, 71402], {
        737264: e => {
            "use strict";
        ...
        971402: (e, t, n) => {
            ...
            function d(e, t, n, r) {
                ...
                if (null == e.currentTarget.contains || e.currentTarget.contains(e.target)) {
                    ...
                    if (0 === d && 0 === _) {
                        var p, h = null === (p = e.target) || void 0 === p ? void 0 : p.getBoundingClientRect(),
                            E = null != h ? h : {},
                            I = E.left,
                            v = void 0 === I ? 0 : I,
                            T = E.top,
                    ...
                    if (null != r && null != r.guild_id) {
                        ...
                        if (null != i[e]) {
                            ...
                            var f = !0,
                                ...
                                h = void 0;
                            try {
                                for (var E, I = s[Symbol.iterator](); !(f = (E = I.next()).done); f = !0) {
                                    _(E.value, t, n)
                                }
                            } catch (e) {
                                p = !0;
        ...
        77413: (e, t, n) => {
            ...
            var P = function(e) {
                ...
                o.getSrc = function() {
                    ...
                    return null != r ? h.ZP.getURL(r) : void 0
                };
                o.render = function() {
            ...
            function w(e) {
                ...
                if (!O.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== g.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = M(u, i),
                        c = b({}, t, R(a), null != i && null != o && (0, S.AB)(o) ? C(0, o) : P(u));
                    O.default.track(e, c, {
                        flush: n
                    })
                }
                        ...
                        return v(this, (function(R) {
                            switch (R.label) {
                                ...
                                case 3:
                                    ...
                                    m || h || o.default.selectVoiceChannel(t.id);
                                    !__OVERLAY__ && (h || N || T || g) && function(e) {
                                        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                            n = e.getGuildId();
        ...
        866893: (e, t, n) => {
            ...
            function j(e) {
                return function(t, n) {
                    return (0, E.yv)(t) ? -1 : (0, E.yv)(n) ? 1 : e === o.z.LATEST_ACTIVITY ? u.default.compare(k(n), k(t)) : u.default.compare(n, t)
                }
            }
            ...
            function V(e) {
                var t = d.Z.getChannel(R);
                if (null != t) {
                    if (null == e ? void 0 : e.refreshThreadIds) {
                        w = Object.values(c.Z.getThreadsForParent(t.guild_id, t.id)).map((function(e) {
                            return e.id
                        }));
                        P = 0;
                        M = !0
                    ...
                    if (0 !== F.size) {
                        w = Array.from(new Set(y(w).concat(y(F))));
                        F.clear()
                    }
                    if ((null == e ? void 0 : e.refreshThreadIds) || (null == e ? void 0 : e.sortThreadIds)) {
                        G = i().chain(w).sort(j(o.z.LATEST_ACTIVITY));
                        D = i().chain(w).sort(j(o.z.CREATION_DATE))
                    }
                    var n, r = (L === o.z.LATEST_ACTIVITY ? G : D).value(),
                        u = (U = 0 === C.size ? r : r.filter((n = C, function(e) {
            ...
            const W = new Y(l.Z, {
                ...
                THREAD_LIST_SYNC: function(e) {
                    var t, n = e.guildId;
                    if (null == R) return !1;
                    if (n !== (null === (t = d.Z.getChannel(R)) || void 0 === t ? void 0 : t.guild_id)) return !1;
                    V({
                        refreshThreadIds: !0
                    })
                },
                THREAD_CREATE: function(e) {
                    ...
                    if (null == t.parent_id || t.parent_id !== R) return !1;
                    if (!n) return !1;
                    t.ownerId !== f.default.getId() ? P++ : N = t.id
                },
                            ...
                            return function(e) {
                                ...
                                try {
                                    for (var d, _ = Object.keys(i)[Symbol.iterator](); !(c = (d = _.next()).done); c = !0) {
                                        var p = d.value,
                                            h = i[p].computeSeenTimeDestructive(u);
                                        if (h > 0) {
                                            a.push(p);
                                            l.push(h)
                                        }
        ...
        165586: (e, t, n) => {
            ...
            var E = [h(r.RESOLUTION_720), h(r.RESOLUTION_1080), h(r.RESOLUTION_1440), h(r.RESOLUTION_SOURCE, (function() {
                ...
                I = [h(r.RESOLUTION_720), h(r.RESOLUTION_1080), h(r.RESOLUTION_1440)],
                v = function(e) {
                    return "".concat(e, "p")
                },
                T = [h(r.RESOLUTION_480, (function() {
                ...
                O = [h(i.FPS_15), h(i.FPS_30), h(i.FPS_60)],
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != L[e] && null != L[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var a in L[e][t]) t === w ? d.ZP.isNewForumThread(a, t, r) && M[e][t]++ : o.default.compare(a, i) > 0 && !d.ZP.hasOpenedThread(a) && M[e][t]++
                        }
                    }
                }
            }
            ...
            var ne = {},
                ...
                ae = function(e) {
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, o, u;
                        return i().size(null !== (o = null === (n = R[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== o ? o : {}) + i().size(null !== (u = null === (r = L[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== u ? u : {})
                    };
                    return n
                }(u.ZP.Store);
        ...
        225386: (e, t, n) => {
            ...
            function T(e) {
                var t = (0, u.e7)([_.Z], (function() {
                    return _.Z.can(o.Z.combine(h.Plq.CREATE_PRIVATE_THREADS), e)
                }), [e]);
            ...
            function y(e) {
                ...
                return function(e, t, n) {
                    ...
                    return _.Z.can(h.Plq.VIEW_CHANNEL, t)
                }), [t]), e, t)
            }
                ...
                return (0, u.cj)([p.Z, _.Z], (function() {
                    var t = p.Z.getActiveJoinedThreadsForParent(e.guild_id, e.id),
                        ...
                        o = i()(n).some((function(e) {
                            return _.Z.can(h.Plq.VIEW_CHANNEL, e.channel)
                        })),
                        u = i()(t).some((function(e) {
                            return !(e.channel.id in n) && _.Z.can(h.Plq.VIEW_CHANNEL, e.channel)
                        })),
                        a = i()(r).some((function(e) {
                            return _.Z.can(h.Plq.VIEW_CHANNEL, e)
                        }));
                    return {
            ...
            function S(e) {
                var t = (0, u.e7)([d.Z], (function() {
                    ...
                    n = (0, u.e7)([_.Z], (function() {
                        return null != t && _.Z.can(h.Plq.MANAGE_THREADS, t)
                    }), [t]),
            ...
            function C(e) {
                var t, n = (0, u.e7)([_.Z], (function() {
                    return null != e && _.Z.can(h.Plq.SEND_MESSAGES_IN_THREADS, e)
                }));
            ...
            function L(e) {
                var t;
                return null != e && (!e.isThread() || e.isActiveThread() || e.isArchivedThread() && !0 !== (null === (t = e.threadMetadata) || void 0 === t ? void 0 : t.locked) && _.Z.can(h.Plq.SEND_MESSAGES_IN_THREADS, e))
            }

            function P(e) {
                var t = _.Z.can(h.Plq.MANAGE_THREADS, e);
            ...
            function D(e) {
                var t = (0, l.Z)(),
                    n = (0, u.e7)([_.Z], (function() {
                        return _.Z.can(h.Plq.CONNECT, e)
                    })),
                    r = C(e),
                    i = E.useExperiment({
                        guildId: e.guild_id,
        ...
        52317: (e, t, n) => {
            ...
            function b() {
                g = E({}, l.Z.getCollapsedCategories())
            }
            ...
            function C() {
                return (C = d((function(e, t) {
                    return y(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, L(null != t ? p({}, null != e ? e : s.ME, t) : {})];
                            case 1:
                                n.sent();
                                return [2]
                        }
                            ...
                            case 0:
                                ...
                                for (var p in r)
                                    if (null != (u = c.Z.getChannel(p)) && null != u.guild_id) {
                                        ...
                                        e[u.guild_id].channel_overrides[u.id] = I(E({}, e[u.guild_id].channel_overrides[u.id]), {
                                            collapsed: u.id in n
                                        });
                                        t = !0
                                    } if (!t) return [2];
                    ...
                    try {
                        for (var s, f = t[Symbol.iterator](); !(a = (s = f.next()).done); a = !0) {
                            var d = s.value,
                                ...
                                h = void 0;
                            try {
                                for (var E, v = d.channel_overrides[Symbol.iterator](); !(_ = (E = v.next()).done); _ = !0) {
                                    var T = E.value;
        ...
        877475: (e, t, n) => {
            ...
            L.displayName = "GuildCategoryStore";
            const P = new L(i.Z, {
                CHANNEL_SELECT: function(e) {
                    var t = e.guildId;
                    v = null != t ? t : null;

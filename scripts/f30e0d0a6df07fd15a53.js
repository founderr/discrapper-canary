...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [70232], {
                ...
                S = function(e) {
                    ...
                    s.renderLegalTerms = function() {
                        ...
                        return this.canSkipTOSCheckbox() || !n && t || a ? null : (0, r.jsx)(u.Checkbox, {
                            ...
                            disabled: c,
                            className: i()(_().checkbox, o),
                            children: (0, r.jsx)("div", {
                                className: i()(_().checkboxLabel, l),
                    ...
                    s.render = function() {
                        ...
                        return c || !s || null != t && !o || L ? (0, r.jsxs)("div", {
                            className: I,
                            children: [!N && (0, r.jsx)(u.FormTitle, {
                                ...
                                children: [(0, r.jsx)(u.Checkbox, {
                                    ...
                                    disabled: h,
                                    className: i()(_().checkbox, P),
                                    children: (0, r.jsx)("div", {
                                        className: i()(_().checkboxLabel, T),
        ...
        717902: (e, t, n) => {
            ...
            var y = "select",
                b = function(e) {
                    ...
                    a.sendChange = function(e) {
                        ...
                        (0,
                            t.onChange)(e, null != n[e] && !1 === n[e].hasPermission || !this.hasEnoughDiskSpace(e))
                    };
            ...
            const O = s.ZP.connectStores([l.Z], (function() {
                return {
        ...
        910740: (e, t, n) => {
                ...
                w = function(e) {
                    ...
                    s.componentDidMount = function() {
                        var e = this.props,
                            ...
                            a = e.manifestIds,
                            s = e.sku;
                        !e.isIAP && (0, v._f)(s) && (null == r || null == a ? o.Z.wait((function() {
                            return (0, l.l)(t.id, n)
                    ...
                    s.getHeaderBlurb = function() {
                        ...
                        if (r || [N.epS.DURABLE, N.epS.CONSUMABLE].includes(t.type)) return E.Z.Messages.APPLICATION_ADDON_PURCHASE_CONFIRMATION_BLURB.format({
                            applicationName: n.name,
                            itemName: t.name
                        });
                        if (t.type === N.epS.BUNDLE) return E.Z.Messages.APPLICATION_STORE_BUNDLE_PURCHASE_CONFIRMATION_BLURB.format({
                            name: t.name
                        });
            ...
            const x = s.ZP.connectStores([T.Z, P.Z, A.Z, _.Z], (function(e) {
                var t, n = e.application,
                    r = A.Z.getActiveLibraryApplication(n.id);
                t = null != r ? r.id : n.id;
                var a = P.Z.getTargetBuildId(n.id, t);
                return {
                    ...
                    buildSizeKB: null != a ? P.Z.getBuildSize(a) : null,

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [21391, 74871], {
        ...
        521391: (t, e, n) => {
            ...
            var w = (C(r = {}, h.Us.BAN, [u.Z, m().redIcon]), C(r, h.Us.GLOBAL_QUARANTINE, [b.Z, m().warningIcon]), C(r, h.Us.DISABLE_SUSPICIOUS_ACTIVITY, [b.Z, m().warningIcon]), C(r, h.Us.LIMITED_ACCESS, [p.Z, m().warningIcon]), C(r, h.Us.REQUIRE_VERIFICATION, [b.Z, m().warningIcon]), C(r, h.Us.TEMP_BAN, [p.Z, m().warningIcon]), C(r, h.Us.USER_MESSAGE_REMOVAL, [d.Z, m().redIcon]), C(r, h.Us.USER_SPAMMER, [b.Z, m().warningIcon]), C(r, h.Us.USER_USERNAME_MANGLE, [O.Z, m().warningIcon]), C(r, h.Us.USER_WARNING, [f.Z, m().warningIcon]), r),
                L = b.Z,
                x = function(t) {
                ...
                R = function(t) {
                    var e = t.action,
                        n = N(e.action_type in w ? w[e.action_type] : [L, m().warningIcon], 2),
                        r = n[0],
                        o = n[1];
            ...
            const Z = function(t) {
                ...
                o.useEffect((function() {
                    S.default.track(v.rMx.SAFETY_HUB_ACTION, {
            ...
            const V = function(t) {
                ...
                return (0,
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: f ? (0, i.jsx)(c.Spinner, {}) : (0, i.jsx)(Z, {
                            classificationId: r,
                            source: u
                        })

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [8574, 88110, 96043, 71402], {
        ...
        971402: (e, t, n) => {
            ...
            function d(e, t, n, r) {
                ...
                if (null == e.currentTarget.contains || e.currentTarget.contains(e.target)) {
                    ...
                    if ((null == n ? void 0 : n.enableSpellCheck) && (0, o.nI)()) var m = (0, u.RD)((function() {
                        m();
                        s(S)
                    }));
                    else {
            ...
            var O = function(e) {
                ...
                n.prototype.render = function() {
                    var e, t = this.props,
                        ...
                        y = I.errorMessage,
                        g = I.retrySuccess,
                        T = i.Children.count(c) > 0 ? (0, r.jsx)(a.Card, {
            ...
            function D(e) {
                ...
                if (!y.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== b.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = U(u, i),
                        c = A({}, t, P(a), null != i && null != o && (0, S.AB)(o) ? C(0, o) : L(u));
                    y.default.track(e, c, {
                        flush: n
                    })
                }
            ...
            function S(e) {
                var t = e.guildId,
                    ...
                    C = (0, o.e7)([_.default], (function() {
                        return _.default.getUser(O)
                    })),
                    R = (0, o.e7)([f.ZP], (function() {
                        return f.ZP.isGuestOrLurker(t, O)
                    }), [t, O]);
                (0, o.e7)([p.Z], (function() {
                ...
                (0, a.$)(L);
                var M = m === E.IlC.POPOUT,
                    U = (0, l.Z)({
                        guild: N,
                        analyticsLocation: v
                    });
                if (null == N || M) return null;
                var D = P === O && (p.Z.can(E.Plq.CHANGE_NICKNAME, N) || p.Z.can(E.Plq.MANAGE_NICKNAMES, N)),
                    w = P === O,
                    G = p.Z.canManageUser(E.Plq.MANAGE_NICKNAMES, O, N);
                if (!(D || G || w)) return null;
                if (null == C || R) return null;
                var j = N.hasFeature(E.oNc.HUB) ? h.Z.Messages.HUB_EDIT_PROFILE : h.Z.Messages.CHANGE_IDENTITY,
                    Z = w ? j : h.Z.Messages.CHANGE_NICKNAME;
        ...
        825781: (e, t, n) => {
            ...
            var d, p, _, E, h, O, I, v, y, g = o.QZA.CLOSED,
                T = {},
                b = !1;
            ...
            var P = function(e) {
                ...
                r.showNotice = function() {
                    return void 0 !== d || void 0 !== p || void 0 !== _ || void 0 !== E || void 0 !== h || void 0 !== O
                };
            ...
            const C = new P(i.Z, {
                ...
                GUILD_IDENTITY_SETTINGS_SUBMIT_FAILURE: function(e) {
                    if (g !== o.QZA.SUBMITTING) return !1;
                    g = o.QZA.OPEN;
                    var t;
        ...
        189651: (e, t, n) => {
            ...
            function b(e, t) {
                p.default.track(h.rMx.VIEW_AS_ROLES_SELECTED, g(y({
            ...
            function A(e) {
                var t = f.Z.getChannelId(e),
                    n = u.Z.getChannel(t);
                if (!(null != t && (0, O.AB)(t)) && !s.Z.can(h.Plq.VIEW_CHANNEL, n)) {
            ...
            function P(e, t) {
                ...
                if (null != n) {
                    ! function(e, t) {
                        var n = T(a.ZP.getSelectableChannelIds(e)).concat(T(a.ZP.getVocalChannelIds(e))),
                            r = Array.from(t);
                        a.ZP.addConditionalChangeListener((function() {
                            ...
                            var i = T(a.ZP.getSelectableChannelIds(e)).concat(T(a.ZP.getVocalChannelIds(e))).filter((function(e) {
                                return !n.includes(e)
                            }));
                            i.length > 0 && N(e, i, []);
                            return !1
                                    ...
                                    for (var l, s = t[Symbol.iterator](); !(n = (l = s.next()).done); n = !0) {
                                        ...
                                        if (p.Z.isMember(d) && !k.has(d)) {
                                            var h = !0,
                                                ...
                                                I = void 0;
                                            try {
                                                for (var v, y = E[Symbol.iterator](); !(h = (v = y.next()).done); h = !0) {
                                                    var g = v.value;
                                                    H(g, !0, _.Z.getGuild(d))
                                                }
                                            } catch (e) {
                                                O = !0;
                                                I = e
                ...
                ie = function(e) {
                    ...
                    r.__getLocalVars = function() {
                        return {
                            ...
                            lastFetchedPremiumStickerPacks: j,
                            isFetchingStickerPacks: Z,
            ...
            const oe = new ie(o.Z, {
                ...
                GUILD_CREATE: function(e) {
                    ...
                    if (!f.Z.isLurking(t.id)) {
                        z(t);
                        1 === M && null == t.stickers && null != t.stickerUpdates && (M = 0)
                    }
                },
        ...
        190022: (e, t, n) => {
            ...
            var R = n(536130),
                L = n(973424);
            const M = (0, c.Z)((0, l.Z)((function(e) {
                var t, n = e.user,
                    l = e.guildId,
                    c = e.channelId,
                    M = e.context,
                    ...
                    j = e.onCloseContextMenu,
                    Z = (0, d.Z)(f.Z.CONTEXT_MENU).analyticsLocations,
                    k = (0, s.O)(),
                    B = null !== (t = null == G ? void 0 : G[0]) && void 0 !== t ? t : Z[0],
                    x = (0, E.sE)(l, {
                        location: B,
                        targetUserId: n.id
                    }),
                    F = (0, o.e7)([O.Z], (function() {
                        var e;
                        return null !== (e = O.Z.getUserVoiceChannelId(l, n.id)) && void 0 !== e ? e : void 0
                    }), [l, n.id]),
                    ...
                    J = function(e, t) {
                        var n = (0, o.e7)([N.Z], (function() {
                            ...
                            i = (0, o.e7)([m.Z], (function() {
                                return m.Z.getChannel(e)
                            }), [e]),
                            a = (0, o.e7)([A.Z], (function() {
                                return null != e && null != t ? A.Z.getMessage(e, t) : null
                            })),
                            l = (0, b.NK)(null != a ? a : null);
                        if (null == i || null == a) return null;
                        var c = null != l && l.actions.hasOwnProperty(T.d.SET_COMPLETED) ? T.d.UNSET_COMPLETED : T.d.SET_COMPLETED,
                            s = c === T.d.SET_COMPLETED ? C.Z.Messages.GUILD_AUTOMOD_ALERT_SET_COMPLETED : C.Z.Messages.GUILD_AUTOMOD_ALERT_UNSET_COMPLETED;
        ...
        430198: (e, t, n) => {
            ...
            function G(e, t, A, N) {
                ...
                (0, c.$)(D);
                (0, o.e7)([O.Z], (function() {
                    return O.Z.getGuildVersion(t)
                }), [t]);
                var j, Z = (0, o.e7)([h.Z], (function() {
                        return h.Z.getGuild(t)
                    }), [t]),
                    k = (0, o.e7)([I.default], (function() {
                        var t;
                    ...
                    F = M((0, d.ZP)(e.id, t), 2)[1],
                    H = null == x ? void 0 : x.isGuildStageVoice(),
                    V = (0, o.cj)([v.Z], (function() {
                        var n, r, i, o = v.Z.getVoiceState(t, e.id);
                        return {
                    ...
                    Q = (0, f.Z)(t, e.id),
                    X = null != q && null != A && O.Z.canWithPartialContext(T.Plq.VIEW_CHANNEL, {
                        channelId: q
                    }) && !B ? [(!H || H && !W) && O.Z.canWithPartialContext(T.Plq.MUTE_MEMBERS, {
                        channelId: A
                    }) ? (0, r.jsx)(u.MenuCheckboxItem, {
                        id: "voice-mute",
                        label: m.Z.Messages.SERVER_VOICE_MUTE,
                        checked: Y,
                        color: "danger",
                        action: function() {
                            !1 === Y && J(p.jQ.MUTE);
                    ...
                    }, "voice-mute") : null, (!H || H && !W) && O.Z.canWithPartialContext(T.Plq.DEAFEN_MEMBERS, {
                        channelId: A
                    }) ? (0, r.jsx)(u.MenuCheckboxItem, {
                        id: "voice-deafen",
                        label: m.Z.Messages.SERVER_DEAFEN,
                        checked: K,
                        color: "danger",
                        action: function() {
                            return l.Z.setServerDeaf(t, e.id, !K)
                        }
                    }, "voice-deafen") : null, !k && null != Z && O.Z.canWithPartialContext(T.Plq.MOVE_MEMBERS, {
                        channelId: A
                    }) ? (0, r.jsx)(u.MenuItem, {
                        id: "voice-disconnect",
                        label: k ? m.Z.Messages.DISCONNECT_SELF : m.Z.Messages.DISCONNECT_OTHER,
                        color: "danger",
                        action: function() {
                    ...
                    $ = (j = P((function(t, n, r) {
                        ...
                        return w(this, (function(o) {
                            switch (o.label) {
                                ...
                                case 1:
                                    o.trys.push([1, 3, , 4]);
                                    return [4, a.Z.setCommunicationDisabledDuration(n, r, b.UK.DURATION_60_SEC, null, N)];
                                case 2:
                                    o.sent();
                                    J(p.jQ.TIMEOUT);
                                    (0, u.showToast)((0, u.createToast)(m.Z.Messages.GUILD_COMMUNICATION_DISABLED_SUCCESS.format({
                                        user: null !== (i = g.ZP.getName(n, null, e)) && void 0 !== i ? i : ""
                                    }), u.ToastType.SUCCESS));
                                    return [3, 4];
                                case 3:
                                    o.sent();
                                    (0, u.showToast)((0,
                                        u.createToast)(m.Z.Messages.APPLICATION_STORE_LISTING_PURCHASE_GENERIC_ERROR, u.ToastType.FAILURE));
                                    return [3, 4];
                                case 4:
                                    return [2]
                            }
                    ...
                    ee = null;
                if (!k && null != Z && null != z && null != z.joinedAt && (O.Z.canManageUser(T.Plq.MODERATE_MEMBERS, e, Z) || O.Z.canManageUser(T.Plq.MANAGE_ROLES, e, Z)) && Z.hasFeature(T.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
                    var te;
                    if ((0, y.yE)(null !== (te = z.flags) && void 0 !== te ? te : 0, S.q.BYPASSES_VERIFICATION)) {
                        var ne;
                        ee = (0, r.jsx)(u.MenuItem, {
                            id: "verify",
                            label: m.Z.Messages.MANUALLY_UNVERIFY_MEMBER,
                            action: function() {
                                return l.Z.setMemberFlags(Z.id, e.id, (0, y.mB)(null !== (ne = z.flags) && void 0 !== ne ? ne : 0, S.q.BYPASSES_VERIFICATION, !1))
                            }
                        }, "verify")
                    } else {
                        var re;
                        ee = (0, r.jsx)(u.MenuItem, {
                            id: "verify",
                            label: m.Z.Messages.MANUALLY_VERIFY_MEMBER,
                            action: function() {
                                return l.Z.setMemberFlags(Z.id, e.id, (0, y.mB)(null !== (re = z.flags) && void 0 !== re ? re : 0, S.q.BYPASSES_VERIFICATION, !0))
                            }
                        }, "verify")
                    }
                }
                var ie = k || null == Z ? [] : [ee, Q && !B ? F ? (0, r.jsx)(u.MenuItem, {
                    id: "removetimeout",
                    label: m.Z.Messages.ENABLE_GUILD_COMMUNICATION_FOR_USER.format({
                        user: e.username
                    }),
                    color: "danger",
                    action: function() {
                    ...
                    id: "timeout",
                    label: m.Z.Messages.DISABLE_GUILD_COMMUNICATION_FOR_USER.format({
                        user: e.username
                    }),
                    color: "danger",
                    action: function(n) {
                ...
                }, "timeout") : null, O.Z.canManageUser(T.Plq.KICK_MEMBERS, e, Z) ? (0, r.jsx)(u.MenuItem, {
                    id: "kick",
                    label: m.Z.Messages.KICK_USER.format({
                        user: e.username
                    }),
                    color: "danger",
                    action: function() {
                ...
                }, "kick") : null, O.Z.canManageUser(T.Plq.BAN_MEMBERS, e, Z) ? (0, r.jsx)(u.MenuItem, {
                    id: "ban",
                    label: m.Z.Messages.BAN_USER.format({
                        user: e.username
                    }),
                    color: "danger",
                    action: function() {
        ...
        100856: (e, t, n) => {
            ...
            function T(e, t) {
                var n = (0, i.e7)([f.ZP], (function() {
                    ...
                    T = (0, i.e7)([O.Z, s.Z], (function() {
                        var n = O.Z.getUserVoiceChannelId(t, e.id);
                ...
                if (null == T) return null;
                var b = e.id === c.default.getId();
                if (!b && !_.Z.can(y.Plq.MOVE_MEMBERS, T)) return null;
                var S = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== T.id && (b ? _.Z.can(y.Plq.CONNECT, n) && !(0, I.rY)(n, O.Z, p.Z) : _.Z.can(y.Plq.MOVE_MEMBERS, n) && (_.Z.can(y.Plq.CONNECT, n) || v.ZP.can({
        ...
        973424: (e, t, n) => {
            ...
            function v(e, t) {
                var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                    ...
                    h = function(n) {
                        if (T.includes(n.id)) {
                            c.Z.updateMemberRoles(t, e, T.filter((function(e) {
                                return e !== n.id
                            })), [], [n.id]);
                            y(l.jQ.REMOVE_ROLE)
                        } else {
                            c.Z.updateMemberRoles(t, e, T.concat([n.id]), [n.id], []);
                            y(l.jQ.ADD_ROLE)
                        }
                    },
                    O = (0, o.e7)([f.Z], (function() {
                    ...
                    g = (0, o.cj)([s.ZP, d.Z], (function() {
                        var n = s.ZP.getMember(t, e);
                        return {
                            userRoles: null != n ? n.roles : [],
                            isGuildMember: null != n,
                            canManageRoles: null != O && d.Z.can(_.Plq.MANAGE_ROLES, O)
                        }
                    }), [e, t, O]),
                    T = g.userRoles,
                    b = g.isGuildMember,
                ...
                if (!b) return null;
                var m = d.Z.getHighestRole(O),
                    A = Object.values(O.roles).filter((function(e) {
                        return e.id !== O.id
                    })),
                    N = S ? A.map((function(e) {
                        var t = e.managed || !d.Z.isRoleHigher(O, m, e),
                            n = -1 !== T.indexOf(e.id);
                        ...
                        return e.id === O.id ? null : (0, r.jsx)(u.MenuItem, {
                            id: e.id,
                            label: function() {
                                return I(e, v)
                            }
        ...
        491260: (e, t, n) => {
            ...
            function D(e) {
                ...
                delete P[e];
                if (null != m[e]) {
                    var t = v(u().sortBy(m[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                ...
                M = null !== (n = e.section) && void 0 !== n ? n : y;
                null != e.subsection && null != y && (g[y] = e.subsection);
                null != e.scrollPosition && null != y && (T[y] = e.scrollPosition);
            ...
            var j = function(e) {
                ...
                r.hasChanges = function() {
                    return null != m && null != S && (!(!this.isOpen() && P !== l.cII.USER_SETTINGS) && !i().isEqual(m, S))
                };
                r.isOpen = function() {
                    return A
                };
                ...
                r.getSubsection = function() {
                    return null != y ? g[y] : null
                };
                r.getScrollPosition = function() {
                    return null != y ? T[y] : null
                };
                ...
                r.getProps = function() {
                    return {
                        ...
                        section: y,
                        subsection: null != y ? g[y] : null,
                        scrollPosition: null != y ? T[y] : null,
                        settings: m,
                        errors: b,
            ...
            const Z = new j(u.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    ...
                    null != e.subsection && (g[y] = e.subsection)
                },
                USER_SETTINGS_MODAL_CLEAR_SUBSECTION: function(e) {
                    var t = e.forSection;
                    null != t ? delete g[t] : null != y && delete g[y]
                },
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete T[t] : null != y && delete T[y]
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    P = e.tab;
                    return null == y && P === l.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

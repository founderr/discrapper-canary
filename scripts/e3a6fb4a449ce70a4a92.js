        ...
        58964: (r, n, t) => {
            ...
            function l(r, n) {
                return function(r) {
                    ...
                    if ("Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)) return u(r, n)
                }(r, n) || function() {
            ...
            function d(r, n) {
                var t = n.utmSource,
                    ...
                    a = n.iosFallbackLink,
                    u = c(n, ["utmSource", "androidFallbackLink", "iosFallbackLink"]),
                    l = new URL(r);
                for (var s in u) {
                    var v = u[s];
                    null != v && l.searchParams.set(s, v)
                }
                var d, p, h, y, m, b = encodeURIComponent(l.toString()),
                    g = encodeURIComponent(i()),
                    ...
                    O = "".concat(f, "/?link=").concat(b, "&utm_source=").concat(t, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(g, "&efr=").concat(x);

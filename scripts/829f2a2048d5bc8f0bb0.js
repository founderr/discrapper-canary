...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [95132], {
        195132: (t, n, e) => {
                ...
                function i(l) {
                    return function(i) {
                        return function(l) {
                            ...
                            for (; a;) try {
                                if (e = 1, r && (o = 2 & l[0] ? r.return : l[0] ? r.throw || ((o = r.return) && o.call(r),
            ...
            const M = function(t) {
                var n = t.transitionState,
                    e = t.closeParentModal,
                    d = t.onClose,
                    p = t.dropsQuestId,
                    y = t.platform,
                    M = t.code,
                    x = t.singlePlatformClaim,
                    C = m(o.useState(null), 2),
                    g = C[0],
                    w = C[1],
                    j = m(o.useState(null != M ? M : null), 2),
                    I = j[0],
                    A = j[1],
                    k = (0, s.EW)(p);
                ...
                var E = function(t, n) {
                        (0,
                            u.Nw)(t, n).then((function(t) {
                            return A(t)
                        })).catch((function(t) {
                            var n;
                            return w(null == t || null === (n = t.body) || void 0 === n ? void 0 : n.code)
                        })).then((function() {
                            i.Z.wait(b((function() {
                ...
                return (0, r.jsx)(a.ModalRoot, {
                    transitionState: n,
                    children: null != g ? (0, r.jsx)(c.L1, {
                        onClose: function() {
                            N()
                        },
                        errorCode: g
                    }) : null !== I ? (0, r.jsx)(c.o1, {
                        bodyText: k.messages.claimTip(),
                        onClose: N,
                        copyInputTitle: f.Z.Messages.REDEMPTION_CODE,
                        code: I
                    }) : (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsxs)(a.ModalHeader, {
                            ...
                            children: [(0, r.jsx)(a.Heading, {
                                ...
                                children: f.Z.Messages.DROPS_MODAL_PLATFORM_CONFIRMATION_TITLE.format({
                                    platform: (0, s.Un)(y)
                                })
                            ...
                            children: (0, r.jsx)(a.Text, {
                                ...
                                children: f.Z.Messages.DROPS_MODAL_CONFIRMATION_WARNING
                            })

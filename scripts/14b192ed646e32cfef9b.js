    ...
    [99271], {
        ...
        242735: (e, t, n) => {
            ...
            function E(e, t, n, r, u, i, a) {
                ...
                l.done ? t(c) : Promise.resolve(c).then(r, u)
            }
            ...
            const _ = {
                ...
                endEvent: function(e, t) {
                    return r.ZP.patch({
                        url: o.ANM.GUILD_EVENT(t, e),
                        body: {
                            status: s.p1.COMPLETED
                        }
                    })
                },
                joinVoiceEvent: function(e, t) {
                    i.default.selectVoiceChannel(t);
                    (0, a.uL)(o.Z5c.CHANNEL(e, t))
                },
                saveEvent: function(e, t, n, u) {
                    var i = s.pg.has(t.entityType) ? t.channelId : null,
                        a = s._U.has(t.entityType) ? t.entityMetadata : null,
                ...
                fetchUsersForGuildEvent: function(e, t) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : s.rC;
                    return f((function() {
                        var i;
        ...
        201441: (e, t, n) => {
            ...
            function y(e, t) {
                return (0, u.Wu)([c.Z, i.Z, o.ZP, d.Z, a.Z, l.ZP], (function() {
                    var n = c.Z.getGuild(e);
                    if (null == n) return p;
                    if (n.hasFeature(h.oNc.HUB)) {
                        var r, u, E = null === (r = l.ZP.getDefaultChannel(n.id)) || void 0 === r ? void 0 : r.id;
                        return (null !== (u = i.Z.getEventDirectoryEntries(E)) && void 0 !== u ? u : []).map((function(e) {
                            var t = e.scheduledEventId,
                                n = o.ZP.getGuildScheduledEvent(t);
                            return null != n ? n : i.Z.getCachedGuildScheduledEventById(t)
                        })).filter(s.lm)
                    }
                    return o.ZP.getGuildScheduledEventsByIndex(null != t ? t : o.bN.GUILD_EVENT_UPCOMING(n.id)).filter((function(e) {
                        var t = e.channel_id;
                        if (null == t) return !0;
                        var n = a.Z.getChannel(t);
                        return d.Z.can(h.Plq.VIEW_CHANNEL, n)
                    }))
                }), [t, e])
            }

            function I(e) {
                return (0, u.e7)([o.ZP, a.Z, d.Z], (function() {
                    var t = a.Z.getChannel(e);
                    if (!d.Z.can(h.Plq.VIEW_CHANNEL, t)) return null;
                    if (null == (null == t ? void 0 : t.guild_id)) return null;
                    var n = o.ZP.getGuildScheduledEventsByIndex(o.bN.CHANNEL_EVENT_ACTIVE(e));
                    return n.length > 0 ? n[0] : null
                }), [e])
            }

            function N(e) {
                var t = (0, u.Wu)([o.ZP], (function() {
            ...
            function g(e) {
                return (0, u.e7)([o.ZP, a.Z, d.Z], (function() {
                    return o.ZP.getGuildScheduledEventsByIndex(o.bN.GUILD_EVENT_ACTIVE(e)).find((function(e) {
                        if (e.entity_type === f.WX.NONE || !(0, o.xt)(e)) return !1;
                        if (null == e.channel_id) return !0;
                        var t = a.Z.getChannel(e.channel_id);
                        return d.Z.can(h.Plq.VIEW_CHANNEL, t)
                    }))
                }), [e])
            }

            function m(e) {
                return (0, u.e7)([o.ZP], (function() {
                    return o.ZP.getGuildScheduledEventsByIndex(o.bN.CHANNEL_EVENT_UPCOMING(e))
                }), [e])
            }

            function Z(e) {
                return (0, u.e7)([a.Z, o.ZP], (function() {
                    var t = o.ZP.getGuildScheduledEventsByIndex(o.bN.GUILD_EVENT_ACTIVE(e)).find((function(e) {
            ...
            function b(e) {
                ...
                var a = (0, u.e7)([o.ZP], (function() {
                        return o.ZP.getGuildScheduledEventsByIndex(o.bN.CHANNEL_EVENT_UPCOMING(e))
                    }), [e, n]),
                    l = r.useMemo((function() {
                        return a.filter((function(e) {
                            var t = (0, E.ub)(e.scheduled_start_time, e.scheduled_end_time),
                                n = t.withinStartWindow,
                                r = t.diffMinutes;
                            return e.status !== f.p1.ACTIVE && n && r < 15
                        }))
                    }), [a]);
                return l
            }
        ...
        371188: (e, t, n) => {
            ...
            function s(e, t, n) {
                null == n && (n = u()());
                var r = u()(e),
                    i = null != t && "" !== t ? u()(t) : void 0,
                    a = null != t && r.isSame(i, "day");
                return {
                    startDateTimeString: d(r, n),
                    endDateTimeString: null != i ? a ? i.format("LT") : c(i, n) : void 0,
                    currentOrPastEvent: r <= n,
                    upcomingEvent: r <= u()().add(1, "hour"),
                    withinStartWindow: r <= u()().add(15, "minute"),

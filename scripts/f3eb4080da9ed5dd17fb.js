(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["71780"], {
        ...
        469421: function(e, t, l) {
            ...
            function g(e) {
                var t;
                let l = (0, i.useStateFromStores)([h.default], () => null !== (t = h.default.getPendingResponseOptions(e)) && void 0 !== t ? t : x, [e]);
                ...
                let n = a.useCallback((t, l, a) => {
                    let n = h.default.getOnboardingResponses(e),
                        {
                            addedRoleIds: i,
                            removedRoleIds: C
                        } = function(e, t, l, a) {
                        ...
                        }(t, l, a, n),
                        {
                            ...
                            return (0, d.hasNotSetUpChannelOptIn)(r) && C.push(...h.default.getDefaultChannelIds(r)), {
                                addedChannelIds: C,
                                removedChannelIds: x
                            }
                        }({
                        ...
                        N = x.reduce((t, l) => {
                            ...
                            return t[l] = {
                                flags: (0, u.setFlag)(a, m.ChannelNotificationSettingsFlags.OPT_IN_ENABLED, !0)
                            }, t
                        }, {}),
                        p = g.reduce((t, l) => {
                            let a = o.default.getGuildChannelFlags(e, l);
                            return t[l] = {
                                flags: (0, u.setFlag)(a, m.ChannelNotificationSettingsFlags.OPT_IN_ENABLED, !1)
                            }, t
                        }, {}),
                        S = {
                            ...N,
        ...
        126623: function(e, t, l) {
            ...
            function c(e) {
                ...
                let {
                    ...
                    itemHook: x
                } = e, g = (0, a.useStateFromStoresArray)([s.default, r.default, i.default], () => Array.from(C).map(e => s.default.getChannel(e)).filter(d.isNotNullish).map(e => (0, n.computeChannelName)(e, r.default, i.default, !0))), N = Array.from(m).map(e => {
                    var l;
                    return null === (l = (null !== (t = null == f ? void 0 : f.roles) && void 0 !== t ? t : {})[e]) || void 0 === l ? void 0 : l.name
                }).filter(d.isNotNullish).map(e => "@".concat(e)), p = (null == h ? void 0 : h.singleSelect) ? "" : o.default.Messages.ONBOARDING_CHOOSE_ALL_OPTIONS, S = "";
            ...
            function f(e) {
                ...
                let {
                    ...
                    itemHook: h
                } = e, m = (0, a.useStateFromStoresArray)([s.default, r.default, i.default], () => Array.from(f).map(e => s.default.getChannel(e)).filter(d.isNotNullish).map(e => (0, n.computeChannelName)(e, r.default, i.default, !0))), C = Array.from(c).map(e => {
                    var a;
                ...
                return 0 === m.length && C.length > 0 ? x = o.default.Messages.CUSTOMIZE_COMMUNITY_ADD_ROLES.format({
                    count: C.length,
                    extraCount: Math.max(C.length - 2, 0),
                    role1: C[0],
                    role2: C[1],
                    itemHook: h
                }) : m.length > 0 && 0 === C.length ? x = o.default.Messages.CUSTOMIZE_COMMUNITY_ADD_CHANNELS.format({
                    count: m.length,
                    extraCount: Math.max(m.length - 2, 0),
                    channel1: m[0],
                    channel2: m[1],
                    itemHook: h
                }) : m.length > 0 && C.length > 0 && (x = o.default.Messages.CUSTOMIZE_COMMUNITY_ADD_CHANNELS_AND_ROLES.format({
                    channelCount: m.length,
                    extraChannelCount: Math.max(m.length - 2, 0),
                    channel1: m[0],
                    channel2: m[1],
                    itemHook: h,
                    roleCount: C.length,
        ...
        534702: function(e, t, l) {
            ...
            function B(e) {
                ...
                let h = (0, r.useStateFromStores)([E.default], () => E.default.getLastSelectedChannelId(t)),
                    m = (0, r.useStateFromStores)([p.default], () => p.default.getCurrentSidebarChannelId(R.StaticChannelRoute.CHANNEL_BROWSER)),
                    N = null != m && c === A.GuildOnboardingTab.BROWSE,
                    _ = (0, r.useStateFromStores)([S.default], () => S.default.getChannel(h)),
        ...
        961727: function(e, t, l) {
            ...
            function et(e) {
                ...
                n.useEffect(() => {
                    (0, I.default)(s.id, s.getAvatarURL(l.id, (0, m.getAvatarSize)($)), {
                        guildId: l.id
                    })
                }, []);
            ...
            function el(e) {
                ...
                let {
                    prompt: l,
                    guild: s
                } = e, [r, d] = n.useState(null), [u, h] = n.useState(new Set), C = null == l ? void 0 : null === (t = l.options) || void 0 === t ? void 0 : t.filter(e => u.has(e.id)), x = (0, k.getSelectedRoleIds)(C), g = (0, k.getSelectedChannelIds)(C), N = (0, c.useStateFromStoresArray)([H.default], () => H.default.getOnboardingResponsesForPrompt(s.id, l.id)), {
                    helpText: p,
                ...
                } = (0, F.default)(s.id), _ = (0, m.useToken)(f.default.unsafe_rawColors.BRAND_500), I = (0, o.useSpring)({
                    from: {
                        color: l.isNew ? _.hex({
                            opacity: 1
                        }) : _.hex({
            ...
            function ea(e) {
                ...
                let {
                    ...
                    E(l, e, null != t && t), l.singleSelect && t && l.options.forEach(e => u.delete(e.id)), t ? u.add(e.id) : u.delete(e.id), h(new Set(u)), d(null)
                }, I = (0, m.useToken)(f.default.unsafe_rawColors.BRAND_500), T = (0, o.useSpring)({
                    from: {
                        color: l.isNew ? I.hex({
                            opacity: 1
                        }) : I.hex({
            ...
            function en(e) {
                let {
                    guildId: t,
                    onBrowseChannels: l
                } = e, s = (0, h.isThemeDark)((0, g.default)()), r = (0, c.useStateFromStores)([A.default], () => A.default.getGuild(t)), d = (0, c.useStateFromStores)([b.default], () => b.default.getCurrentUser()), o = (0, x.default)("(min-width: 1344px)") && null != d, u = n.useCallback(() => {
        ...
        667712: function(e, t, l) {
            ...
            function S(e) {
                ...
                let {
                    ...
                    hideMemberCount: E,
                    canBeNew: _
                } = e, I = (0, u.isThemeDark)((0, h.default)()), [T, O] = n.useState(!1), j = T && !E, A = n.useRef(null), {
                    reducedMotion: R
                } = n.useContext(c.AccessibilityPreferencesContext), b = (0, d.default)([m.default], () => {
                    var e, l, a;
                    return (null === (e = s.emoji) || void 0 === e ? void 0 : e.id) != null && null !== (t = null === (l = m.default.getCustomEmojiById(null === (a = s.emoji) || void 0 === a ? void 0 : a.id)) || void 0 === l ? void 0 : l.animated) && void 0 !== t && t
                    ...
                    return (0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsxs)("div", {
                            ...
                            children: (0, a.jsx)(d.Text, {
                                variant: "text-xs/normal",
                                color: "always-white",
                                children: h.default.Messages.ONBOARDING_OPTION_ROLE_COUNTS.format({
                                    memberCount: i
                                })
                            })
                        })]
        ...
        5973: function(e, t, l) {
            ...
            function j(e) {
                let {
                    guildId: t
                } = e, [s, o] = n.useState(""), u = (0, r.useStateFromStores)([m.default], () => m.default.getGuild(t)), O = (0, r.useStateFromStores)([h.default], () => h.default.getChannels(t)), j = (0, r.useStateFromStores)([f.default], () => f.default.getCategories(t)), A = (0, p.useFilterCategoriesByQuery)(t, j, O, s), R = (0, r.useStateFromStores)([C.default], () => C.default.canWithPartialContext(v.Permissions.MANAGE_CHANNELS, {
                    guildId: t
        ...
        724268: function(e, t, l) {
            ...
            function F(e) {
                let {
                    ...
                    onChannelClick: c
                } = (0, O.default)(l.id), f = (0, h.useIsDismissibleContentDismissed)(d.DismissibleContent.CHANNEL_BROWSER_NUX), m = f ? 0 : -1, C = n.useCallback(e => {
                    let {
                        section: n
                    } = e;
                    if (0 === n && -1 === m) return null;
                    let s = t._categories[n + m];
                    return (0, a.jsx)(B, {
                        channel: s.channel,
                        guild: l,
                        onCategoryClick: c
                    }, s.channel.id)
                }, [t, l, m, c]), x = n.useCallback(e => {
                    let {
                        section: n,
                        row: s
                    } = e;
                    if (0 === n && -1 === m) return (0, a.jsx)(A.default, {
                        guild: l
                    });
                    let i = t._categories[n + m],
                        r = t[i.channel.id][s];
                ...
                }, [t, l, m, o, c]), g = (0, A.useNuxCardHeight)(l.id), N = (0, T.useChannelBrowserSections)(l.id, t, 64, g);
                ...
                let p = l ? (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsxs)("div", {
                        children: [(0, a.jsx)(r.Heading, {
                            ...
                            onClick: () => {
                                o.default.open(t.id, h.GuildSettingsSections.ONBOARDING), (0, d.markDismissibleContentAsDismissed)(N, {

    ...
    ["77576"], {
        ...
        578411: function(e, t, a) {
            ...
            let A = e => {
                ...
                }), H = (0, m.useUID)(), P = (0, d.default)([C.default], () => null != C.default.getPackByPackId({
                    packId: t.id,
                    allowDuplicateGuildPack: !0
                })), D = V && !P, [j, O] = n.useState(!1), G = async () => {
                    let e = I.default.isLurking(A);
                    await f.default.leaveGuild(A), j && (M.default.track(g.AnalyticEvents.INVENTORY_PACK_ACTION_COMPLETED, {
                ...
                return (0, l.jsxs)(r.ConfirmModal, {
                    className: u(L.confirmModal, {
                        [L.widthForAddPack]: D
                    }),
                    bodyClassName: u(L.confirmModalBody, {
                        [L.widthForAddPack]: D
                    }),
                    header: x.default.Messages.LEAVE_SERVER_TITLE.format({
                        name: t.name
                    }),
                    confirmText: t.hasFeature(g.GuildFeatures.HUB) ? x.default.Messages.LEAVE_HUB : x.default.Messages.LEAVE_SERVER,
                    cancelText: x.default.Messages.CANCEL,
                    onConfirm: G,
                    ...e,
                    children: [(0, l.jsx)(r.Text, {
                        variant: "text-md/normal",
                        children: t.hasFeature(g.GuildFeatures.HUB) ? x.default.Messages.LEAVE_HUB_BODY.format({
                            name: t.name
                        }) : x.default.Messages.LEAVE_SERVER_BODY.format({
                            name: t.name
                        })
                    }), D && (0, l.jsxs)("div", {
                        className: L.addPackSection,
                        children: [(0, l.jsxs)(r.FormSwitch, {
                            className: L.addPackHeader,
                            value: j,
                            disabled: S,
                            onChange: e => {
                                O(e)
                            ...
                            hideBorder: !0,
                            children: [x.default.Messages.INVENTORY_ADD_PACK, " ", (0, l.jsx)(c.default, {
                                className: L.betaTag,
                                color: "white"
                            })]
                        }), (0, l.jsxs)(r.Text, {
                            variant: "text-sm/medium",
                            className: L.inventoryLeaveServerDescription,
                            children: [(0, l.jsx)(v.default, {
                                className: L.nitroWheel
                            }), x.default.Messages.INVENTORY_LEAVE_SERVER_DESCRIPTION]
                        }), S && !T && (0, l.jsx)(r.Text, {
                            variant: "text-sm/normal",
                            className: L.maxPacksNoticeText,
                            children: x.default.Messages.INVENTORY_ADD_NITRO_DESCRIPTION_WITH_PLURAL.format({
        ...
        230947: function(e, t, a) {
            ...
            function N(e) {
                let {
                    ...
                    context: M,
                    icon: g
                } = e, p = f.default.getGuild(t), x = o.default.getId(), L = (0, s.useStateFromStores)([h.default], () => h.default.getUser(N)), A = (0, s.useStateFromStores)([c.default], () => c.default.isGuestOrLurker(t, N), [t, N]);
                (0, s.useStateFromStores)([E.default], () => E.default.getGuildVersion(t), [t]);
                let T = n.useMemo(() => ({
                    [t]: [N]
                }), [t, N]);
                (0, d.useSubscribeGuildMembers)(T);
                let V = M === C.AppContext.POPOUT,
                    S = (0, i.default)({
                        guild: p,
                        analyticsLocation: m
                    });
                if (null == p || V) return null;
                let H = x === N && (E.default.can(C.Permissions.CHANGE_NICKNAME, p) || E.default.can(C.Permissions.MANAGE_NICKNAMES, p)),
                    P = x === N,
                    D = E.default.canManageUser(C.Permissions.MANAGE_NICKNAMES, N, p);
                if (!(H || D || P) || null == L || A) return null;
                let j = p.hasFeature(C.GuildFeatures.HUB),
                    O = j ? I.default.Messages.HUB_EDIT_PROFILE : I.default.Messages.CHANGE_IDENTITY,
                    G = P ? O : I.default.Messages.CHANGE_NICKNAME;
                return (0, l.jsx)(u.MenuItem, {
                    ...
                    icon: g,
                    action: () => {
                        P ? ((0, r.default)(L.id, L.getAvatarURL(t, 80), {
                            guildId: t
                ...
                let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    ...
                    C = n.useCallback(() => {
                        let t = {
                            ...
                            alertType: (0, i.getIncidentAlertType)(h)
                        };
        ...
        58622: function(e, t, a) {
            ...
            function f(e) {
                ...
                }), c = (0, n.useStateFromStores)([i.default], () => (0, u.canViewInviteModal)(i.default, a, l, s)), f = E(t, a, c && null != l ? l : r), C = h(t);
                return null == l && t === o.InstantInviteSources.GUILD_CONTEXT_MENU ? null : c || null != r ? f : C
            }

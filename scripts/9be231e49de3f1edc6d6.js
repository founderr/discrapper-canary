...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [29581], {
        ...
        479373: (_, I, E) => {
            ...
            function o(_) {
                for (var I = 1; I < arguments.length; I++) {
                    var E = null != arguments[I] ? arguments[I] : {},
                        T = Object.keys(E);
                    "function" == typeof Object.getOwnPropertySymbols && (T = T.concat(Object.getOwnPropertySymbols(E).filter((function(_) {
            ...
            function M(_) {
                var I = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    ...
                    T = _.type,
                    S = _.properties;
                if (_.type !== e.nv.MODAL || null != _.name || !(0, P.Ez)().some((function(_) {
                        var I;
                        return null === (I = _._stackContext) || void 0 === I ? void 0 : I.isSlide
                    }))) {
                    (0, P.Ps)(_);
                    var O, N, R = null !== (O = null == S ? void 0 : S.guild_id) && void 0 !== O ? O : n.Z.getGuildId(),
                        A = null !== (N = null == S ? void 0 : S.channel_id) && void 0 !== N ? N : t.Z.getChannelId(R),
                        D = (0, r.expandEventProperties)(o({
                            impression_type: T,
                            location: (0, P.k$)()
                        }, (0, i.hH)(R), (0, i.v_)(C.Z.getChannel(A)), S));
                    if (I)(0, P.dT)(null, null);
                    else {
                        if (null != E && null != T) {
                            (0, r.debugLogEvent)(E, D);
                            a(E, D)
                        }(0, P.dT)(E, D)
                    }
                }
            ...
            function L(_) {
                ...
                }), I.trackOnInitialLoad ? [] : void 0)
            }

            function l(_, I) {
                var E = _.impressionName,
                    T = _.impressionProperties,
                    S = "function" == typeof T ? T(I.params) : T;
                L({
                    type: e.nv.PAGE,
                    name: E,
                    properties: S
        ...
        638042: (_, I, E) => {
            ...
            function C(_, I) {
                if (null == _) return {};
                var E, T, S = function(_, I) {
                    if (null == _) return {};
                    var E, T, S = {},
                        O = Object.keys(_);
                    for (T = 0; T < O.length; T++) {
                        E = O[T];
                        I.indexOf(E) >= 0 || (S[E] = _[E])
                    }
                    return S
                }(_, I);
                if (Object.getOwnPropertySymbols) {
                    ...
                    for (T = 0; T < O.length; T++) {
                        E = O[T];
                        I.indexOf(E) >= 0 || Object.prototype.propertyIsEnumerable.call(_, E) && (S[E] = _[E])
                    }
                }
                return S
            }
            var t = (0, S.Mg)(O.Z.ASPECT_STABLE_IMAGE_CONTAINER_PADDING);

            function n(_) {
                var I = _.listing,
                    E = _.imageSize,
                    S = _.alt,
                    O = C(_, ["listing", "imageSize", "alt"]),
                    R = (0, N.U)(I, E);
                return (0, T.jsx)("img", A({
                    src: R,
                    alt: S
                }, O))
            }
            ...
            function r(_) {
                var I = _.listing,
                    ...
                    S = void 0 === E ? 16 / 9 : E,
                    O = _.height,
                    e = C(_, ["listing", "aspectRatio", "height"]),
                    n = (O - 2 * t) * S,
                    r = (0, N.U)(I, n),
                    i = (0, N.U)(I, n, {
                        shouldAnimate: !1
                    });
                return (0, T.jsx)(R.Z, A({
                    src: r,
                    backgroundSrc: i,
                    aspectRatio: S
                }, e))
        ...
        929581: (_, I, E) => {
            ...
            function l(_) {
                ...
                return (0, T.jsx)(p.Z, {
                    ...
                    locked: !I.has_entitlement
                })
            }

            function s(_) {
                var I, E = _.transitionState,
                    S = _.guildProductListingId,
                    p = _.guildId,
                    M = _.onClose,
                    s = (0, R.e7)([P.Z], (function() {
                        return P.Z.getGuildProduct(S)
                    }));
                O()(null != s, "guildProductListing cannot be null");
                (0, C.Z)({
                    type: N.nv.MODAL,
                    name: N.zs.GUILD_PRODUCT_LISTING_INFO_MODAL,
                    properties: {
                        guild_product_listing_id: S,
                        has_entitlement: !0 === s.has_entitlement
                    }
                });
                var G, c, x = null !== (I = (0, D.C)(s)) && void 0 !== I ? I : "",
                    u = (0, D.k)(s),
                    d = (0, R.e7)([r.Z], (function() {
                        return r.Z.getGuild(p)
                    })),
                    H = (0, R.e7)([r.Z], (function() {
                        var _;
                        return null === (_ = r.Z.getGuild(s.guild_id)) || void 0 === _ ? void 0 : _.roles[null !== (G = s.role_id) && void 0 !== G ? G : ""]
                    }));
                return (0, T.jsxs)(e.ModalRoot, {
                    className: L().modal,
                    size: e.ModalSize.MEDIUM,
                    transitionState: E,
                    "aria-label": s.name,
                    children: [(0, T.jsxs)(e.ModalHeader, {
                        separator: !1,
                        children: [(0, T.jsx)(n.e, {
                            ...
                            alt: ""
                        }), (0, T.jsx)(e.ModalCloseButton, {
                            className: L().closeButton,
                            onClick: M,
                            withCircleBackground: !0
                        })]
                    }), (0,
                        T.jsx)(e.ModalContent, {
                        children: (0, T.jsxs)("div", {
                            className: L().body,
                            children: [(0, T.jsx)(e.Heading, {
                                ...
                                children: a.Z.Messages.GUILD_PRODUCT_INFO_MODAL_PRODUCT_OFFER.format({
                                    productType: x,
                                    personName: null !== (c = null == d ? void 0 : d.name) && void 0 !== c ? c : ""
                                })
                            }), null != H && (0, T.jsxs)(T.Fragment, {
                                ...
                                color: "header-primary",
                                children: a.Z.Messages.GUILD_PRODUCT_INFO_MODAL_DETAIL_HEADER
                            }), (0, T.jsx)(i.Z, {
                                size: 12
                            }), (0, T.jsx)(t.Z, {
                    ...
                    }), (0, T.jsxs)(e.ModalFooter, {
                        className: L().footer,
                        children: [(0, T.jsx)(o.Z, {
                            guildId: p,
                            guildProductListingId: S,
                            sourceAnalyticsLocations: A.Z.GUILD_PRODUCT_INFO_MODAL
                        }), (0, T.jsx)(e.Text, {
                            tag: "div",

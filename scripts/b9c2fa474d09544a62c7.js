        ...
        287850: function(e, t, n) {
            ...
            function S() {
                y.clear(), Object.values(h.default.getMutablePrivateChannels()).forEach(e => {
                    ...
                    null != t && (0, E.isGuildTextChannelType)(t.type) && y.set(t.id, R(t))
                })
            }
            ...
            var L = new M(f.default, {
                ...
                CHANNEL_UPDATES: function(e) {
                    ...
                    t.forEach(e => {
                        ((0, E.isPrivate)(e.type) || y.has(e.id)) && y.set(e.id, R(e))
                    })
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != i && y.set(t, R(i, n.id))
                },

    ...
    [33600], {
        133600: (t, e, n) => {
            ...
            var Y = function(t, e) {
                ...
                W = function(t) {
                    ...
                    function n() {
                        ...
                        t.getIdleAnimationStatus = function() {
                            if (t.step !== T.wZ8.OPEN) return j.SR.LOOP
                        };
                        return t
                    }
                    var i = n.prototype;
                    ...
                    i.trackStepAnalytics = function() {
                        ...
                        C.default.track(T.rMx.GIFT_ACCEPT_STEP, {
                            to_step: this.step,
                            has_custom_message: r,
                            is_custom_message_edited: r && n !== Z.Z.Messages.DEFAULT_CUSTOM_GIFT_MESSAGE,
                    ...
                    i.render = function() {
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(c.ModalRoot, {
                                ...
                                className: k().modal,
                                "aria-labelledby": f,
                                children: [null != u.giftStyle && !O && (0, r.jsx)(x.Z, {
                                    defaultAnimationState: this.getDefaultAnimationStatus(),
                                    idleAnimationState: this.getIdleAnimationStatus(),
                                    giftStyle: u.giftStyle,
                                    className: k().seasonalGiftIcon
                                }), (0, r.jsx)("div", {
                                    className: O ? void 0 : k().backSplash
                                }), (0, r.jsxs)(c.ModalContent, {
                                    className: s()((t = {}, D(t, k().content, !O), D(t, k().contentCustomGift, O), t)),
                                    children: [(0, r.jsx)(c.ModalCloseButton, {
                                        onClick: l,
                                        className: k().closeButton
                                    }), (null == u.giftStyle || O && S) && (0, r.jsx)(v.Z, {
                                        size: v.Z.Sizes.LARGE,
                                        game: o,
                                        skuId: u.skuId
                                    }), (0, r.jsxs)(c.Heading, {
                                        id: f,
                                        className: s()((e = {}, D(e, k().customGiftHeader, O && !S), D(e, k().header, !O || S), e)),
                                        variant: "heading-sm/semibold",
                                        children: [(0, r.jsx)("div", {
                                            className: s()(D({}, k().customGiftHeaderText, O)),
                                    ...
                                    }), O && null != u.giftStyle && !S && (0, r.jsx)(x.Z, {
                                        defaultAnimationState: this.getDefaultAnimationStatus(),
                                        idleAnimationState: this.getIdleAnimationStatus(),
                                        className: k().giftAnimation,
                                        giftStyle: u.giftStyle
                                    }), O && this.state.opened && !this.state.accepted && null != g && "" !== g && !w && (0, r.jsxs)(r.Fragment, {
                                        children: [(0,
                                            r.jsx)(c.FormTitle, {
                                            children: Z.Z.Messages.GIFT_SENDER_INFO.format({
                                                senderDisplayName: P.ZP.getName(y)
                                            })
                                        }), (0, r.jsx)(c.Heading, {
                                            id: f,
                            ...
                            if (e && !r) {
                                if (n) {
                                    ...
                                    return Z.Z.Messages.GIFT_SUBSCRIPTION_INFO.format({
                                        ...
                                        timeInterval: (null == s ? void 0 : s.interval) === _.rV.MONTH ? Z.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_MONTH : Z.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_YEAR
                                    })
                                }
                ...
                $ = a.ZP.connectStores([y.Z, O.Z, h.Z, g.Z, m.Z, f.Z], (function(t) {
                    var e = t.giftCode,
                        n = O.Z.get(e.skuId),
                    ...
                    return {
                        sku: n,
                        libraryApplication: null != n ? (0, I.z2)(e, n, y.Z) : null,
                        application: r,

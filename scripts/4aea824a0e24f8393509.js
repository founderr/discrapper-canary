            ...
            var l = n("37983"),
                ...
                g = e => {
                    let {
                        ...
                        left: 0,
                        right: 0
                    }), [L, y] = i.useState(!1), [U, D] = i.useState(1), [P, b] = i.useState({
                        x: 0,
                        y: 0
                    ...
                    let Z = () => {
                        ...
                        Y = i.useCallback(() => {
                            ...
                            H({
                                width: n,
                                height: l
                            }), S(i), O((0, f.calculateDragBoundaries)(n, l, i))
                        }, [C, U]),
                        X = i.useCallback(e => {
                            let {
                                x: t,
                                ...
                                children: [(0, l.jsxs)("div", {
                                    ...
                                    children: [(0, l.jsx)(c.default, {
                                        ...
                                        asValueChanges: e => {
                                            ...
                                            (!(0, r.inRange)(i, l.right, l.left) || !(0, r.inRange)(a, l.top, l.bottom)) && z(i, a, l), D(e), O(l)
                                        },
                                        disabled: G,
                                        equidistant: !0,
                                        hideBubble: !0,
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, l.jsx)(e, {
                            ...
                            onComplete: () => {
                                y = !0, null == _ || _(), !I && ((0, s.setIsPersistentHelperHidden)(!0), (0, s.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: A,
                            analyticsObject: T,
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: S,
                            location_stack: A
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == h || h(y), y && (!I && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },
                ...
                w = function(e) {
                    let {
                        ...
                        if (null == w || w(e), (null == W ? void 0 : W.status) === R.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                            (0, c.trackPremiumSettingsPaneOpened)(), s.default.open(R.UserSettingsSections.PREMIUM), null == D || D(!1);
                            return
                        }! function(e) {
                            let {
                                isClaimed: t,
                            ...
                            null != s ? p = R.AnalyticsObjectTypes.TRIAL : r && (p = R.AnalyticsObjectTypes.GIFT), (0, d.default)({
                                isGift: r,
                                initialPlanId: null,
                                subscriptionTier: a,
                                analyticsLocations: f,
        ...
        181114: function(e, t, n) {
            ...
            let A = e => {
                let {
                    ...
                    onlyShineOnHover: _,
                    ...A
                } = e, T = a.createRef(), g = (0, d.default)(T), m = !l && !i && !0 !== o && (!_ || g);

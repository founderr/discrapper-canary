                ...
                (0, a.openModalLazy)(async () => {
                    ...
                    return l => {
                        ...
                        return (0, n.jsx)(e, {
                            ...
                            onComplete: () => {
                                v = !0, null == E || E(), !M && ((0, r.setIsPersistentHelperHidden)(!0), (0, r.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: S,
                            analyticsObject: m,
            ...
            var s = l("414456"),
                ...
                L = function(e) {
                    let {
                        ...
                        if (null == L || L(e), (null == V ? void 0 : V.status) === R.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                    ...
                    let K = C.default.Messages.APPLICATION_STORE_GET_PREMIUM,
                    ...
                    J && (K = C.default.Messages.BILLING_SWITCH_PLAN_UPGRADE);
                    let Q = null != V && V.status !== R.SubscriptionStatusTypes.ACCOUNT_HOLD && !(0, T.isNoneSubscription)(V.planId) && !J,
                        X = Q ? null != G ? G : function(e) {
                            ...
                            return null != u && null != i && i < u ? (n = C.default.Messages.APPLICATION_STORE_GET_PREMIUM, s = C.default.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP) : null != a && null != l && a === l ? (n = C.default.Messages.BILLING_SWITCH_PLAN_CURRENT_PLAN, s = C.default.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP) : null == a && null != l && l === M.PremiumTypes.TIER_2 && (s = C.default.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP), {
                                disabledButtonText: n,
                                disabledButtonTooltipText: s
                            }
                        }({
        ...
        292890: function(e, t, l) {
            ...
            function I(e) {
                let {
                    ...
                    title: M,
                    description: R
                } = e, C = (0, a.useStateFromStores)([c.default], () => c.default.getCurrentUser()), {
                    ...
                    children: (0, n.jsxs)(i.ModalRoot, {
                        ...
                        children: [(0, n.jsxs)(i.ModalHeader, {
                            ...
                            children: [(0, n.jsx)(o.default, {
                                ...
                                buttonText: f.default.isPremium(C) ? S.default.Messages.USER_SETTINGS_PROFILE_THEMES_UPSELL_UPGRADE : S.default.Messages.USER_SETTINGS_CUSTOMIZATION_UPSELL
                            }), (0, n.jsx)(i.Button, {
                                onClick: () => {
                                    P(), A()
                                },

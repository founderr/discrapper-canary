            ...
            const h = {
                ...
                toggleSelfMute: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        o = e.syncRemote,
                        i = void 0 === o || o;
                    return I() ? Promise.resolve() : a.Z.isEnabled() ? r.Z.dispatch({
                ...
                setMode: function(e) {
                    ...
                    I() || r.Z.dispatch({
                        ...
                        context: n,
                        mode: e,
                        options: d({}, a.Z.getModeOptions(n), t)
                    })
                },
            ...
            function f(e, t, n, r) {
                ...
                if (null == e.currentTarget.contains || e.currentTarget.contains(e.target)) {
                    ...
                    var g = {
                        ...
                        config: l({
                            context: __OVERLAY__ ? a.IlC.OVERLAY : null !== (p = (0, o.GB)()) && void 0 !== p ? p : a.IlC.APP
                        }, n)
                    };
                    if ((null == n ? void 0 : n.enableSpellCheck) && (0, i.nI)()) var v = (0, u.RD)((function() {
                        v();
                        s(g)
                    }));
                    else {
        ...
        550254: (e, t, n) => {
            ...
            var E = function(e) {
                ...
                r.hasHotspot = function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        n = !t && d[e];
                    return !u.a && (!i.s.isDisallowPopupsSet() && (n || !_.has(e)))
                };
        ...
        159895: (e, t, n) => {
            ...
            function S(e, t, n, r) {
                if (null != e && !(0, s.I5)(e) && n) {
                    ...
                    if (r) {
                        l.Z.isLoadedForSKU(f.Si.TIER_0) || l.Z.isFetchingForSKU(f.Si.TIER_0) || (0, a.GZ)(f.Si.TIER_0);
                        l.Z.isLoadedForSKU(f.Si.TIER_2) || l.Z.isFetchingForSKU(f.Si.TIER_2) || (0, a.GZ)(f.Si.TIER_2)
                    }
                }
            }
        },
            ...
            var d = function(e) {
                ...
                r.getSoundpack = function() {
                    ...
                    return i.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).allowAprilFoolsSoundpack && (e = _.soundpack, Object.values(u.Y).includes(e)) ? _.soundpack : u.Y.CLASSIC
                };
                return n
            }(r.ZP.PersistedStore);
        ...
        763361: (e, t, n) => {
            ...
            function w(e) {
                var t = e.transitionState,
                    ...
                    g = e.onEnable,
                    R = e.onClose,
                    N = O.Z.getCameraComponent(),
                    P = (0, I.Dt)(),
                    w = (0, E.Z)(),
                    j = p.qF.useSetting(),
                    G = C(o.useState((0,
                        f.P)(b.default.getCurrentUser())), 2),
                    x = G[0],
                    k = G[1],
                    H = (0, c.O)(),
                    ...
                    children: (0, r.jsx)(a.Z, {
                        ...
                        children: (0, r.jsxs)(i.ModalRoot, {
                            ...
                            children: [(0, r.jsxs)(i.ModalContent, {
                                ...
                                children: [(V = n ? W : K, Y = n ? S.Z.Messages.CAMERA_PREVIEW_VIDEO_BACKGROUND_CHANGE_BACKGROUND : S.Z.Messages.CAMERA_ON, (0, r.jsx)(i.Button, {
                                    onClick: V,
            ...
            function _(e) {
                ...
                if (!s.Z.disableSounds) {
                    var r, i = c(o.Z.getSoundpack()),
                        u = f(null !== (r = i[e]) && void 0 !== r ? r : e, e, t);
                    ...
                    function e(t) {
                        ...
                        this.languageDetector = new _(o, (function(e) {
                            ...
                            if (-1 !== t.indexOf(r)) n.setLocale(r);
                                ...
                                var i, a = null !== (i = u[e]) && void 0 !== i ? i : d[o];

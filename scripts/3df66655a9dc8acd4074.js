    ...
    ["69073"], {
        ...
        145079: function(e, t, n) {
            ...
            var T = e => {
                let {
                    ...
                    forcePomelo: f,
                    ...I
                } = e, T = (0, a.useStateFromStores)([s.default], () => s.default.hidePersonalInformation), C = T || t || n.isNonUserBot(), S = n.toString(), N = d.default.getName(n), p = l ? S : null != i ? i : N, m = n.isPomelo() || f;
                if (m || p !== S) {
                    let e = p === S && m && l ? d.default.getUserTag(n, {
                            forcePomelo: f
                        }) : p,
                        t = u && e !== "@".concat(S) ? d.default.getUserTag(n) : void 0;
                    return (0, r.jsx)(_, {
                        primary: e,
                        secondary: t,
                ...
                return (0, r.jsx)(c.default, {
                    ...
                    botType: E(n),
                    botVerified: n.isVerifiedBot(),
                    discriminator: C || p !== S ? null : null != o ? o : n.discriminator,
                    ...I
                })
            }
        },
        ...
        478272: function(e, t, n) {
            ...
            function s(e) {
                ...
                c && (0, l.default)(u.PopoutWindowKeys.CHANNEL_CALL_POPOUT);
        ...
        245187: function(e, t, n) {
            ...
            function N(e) {
                let {
                    className: t
                } = e, n = (0, o.default)(), i = (0, u.isThemeDark)(n) ? C : S;
                return (0, r.jsxs)("div", {
        ...
        752598: function(e, t, n) {
            ...
            let S = async e => {
                let {
                    ...
                    guildId: _,
                    localState: C
                } = e, S = l.default.fromTimestamp(Date.now());
                if (!I.default.canQueueInteraction(n, S)) return;
                await c.default.unarchiveThreadIfNecessary(E), (0, f.addQueued)(S, {
                    messageId: n,
                    data: {
                ...
                }), null != C && (0, f.queueInteractionComponentState)(n, S, C, u);
                let m = {
            ...
            let m = (e, t) => {
                ...
                let r = null == t ? void 0 : t.state,
                    i = e.state === T.MessageStates.SENT && C(e.id) < Date.now();
        ...
        559362: function(e, t, n) {
            ...
            function C(e) {
                ...
                } = (0, d.usePaymentContext)(), p = (0, a.default)(_.RESPONSIVE_MOBILE_WIDTH_SIZE_QUERY), m = (0, u.isApplicationUserSubscription)(n.sku_flags), h = (0, l.useStateFromStores)([c.default], () => c.default.getGuild(null == N ? void 0 : N.guild_id)), A = i.useCallback(() => C(f.Step.REVIEW), [C]);
                return (0, r.jsxs)(r.Fragment, {
        ...
        671672: function(e, t, n) {
            ...
            function m(e) {
                ...
                a(null != O, "Expected plan to selected"), a(null != P, "Expected selectedSkuId"), a(null != g, "Step should be set");
                ...
                return l ? v ? t = (0, r.jsx)(f.BenefitsConfirmationLite, {
                    ...
                    children: [(0, r.jsxs)(C.PaymentPortalBody, {
                        children: [(0, r.jsx)(S.default, {}), t]
                    }), null != n && (0, r.jsx)(C.PaymentPortalFooter, {
                        children: n
                    })]
                })
            }
        ...
        101432: function(e, t, n) {
            ...
            function I(e) {
                let {
                    ...
                    isGift: P
                } = (0, o.useGiftContext)(), [g, R] = i.useState(!S || !N || p);
                return (i.useEffect(() => {
                    R(!S || !N || p)
                }, [p, N, S]), i.useEffect(() => {
                    null != I && O({
                    ...
                    }), null != e && (h(null == e ? void 0 : e.skuId), C(t)))
                }, [T, n, P, g, L, m, E, A, h, C, t]), g) ? (0, r.jsx)(d.default, {}) : T ? (0, r.jsx)(l.BlockedPaymentsContentModal, {
                    onClose: _
                }) : null
            }
        },
        458985: function(e, t, n) {
            ...
            function h(e) {
                ...
                a(null != j, "Expected plan to be selected"), a(null != K, "Step should be set");
                let X = i.useRef(null),
                ...
                return Z === E.PurchaseState.PURCHASING ? (0, r.jsx)(T.default, {}) : (0, r.jsxs)(r.Fragment, {
                    ...
                    }), (0, r.jsxs)(C.PaymentPortalBody, {
                        children: [(0, r.jsx)(S.default, {}), et && (0, r.jsxs)("div", {
        ...
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, I = (0, l.useStateFromStores)([a.default], () => a.default.useReducedMotion), [E, _] = i.useState(d), T = i.useRef((0, s.getGiftAnimationData)(t, E)), [C, S] = i.useState(null == f), [N, p] = i.useState(!1), [m, h] = i.useState(-1), A = () => {
        ...
        967241: function(e, t, n) {
            ...
            function h(e, t, n) {
                o.MainWindowDispatch.dispatch(p.ComponentActions.POPOUT_CLOSE);
                let r = !a.isEmpty(C.default.getVoiceStatesForChannel(e.id));
                ...
                e.parent_id !== l && !(0, m.isGuildHomeChannel)(l) && (0, I.transitionToChannel)(e.parent_id), (0, f.transitionTo)(p.Routes.CHANNEL_THREAD_VIEW((0, d.getGuildIdForGenericRedirect)(e), (0, m.isGuildHomeChannel)(l) ? m.StaticChannelRoute.GUILD_HOME : e.parent_id, e.id), void 0, e.isForumPost() ? N.OpenThreadAnalyticsLocations.FORUM : void 0), setTimeout(() => {
            ...
            function A(e, t, n) {
                i(!e.isForumLikeChannel(), "cannot open thread creation sidebar in forums"), i(!__OVERLAY__, "Cannot create threads in the overlay."), (0, c.trackWithMetadata)(p.AnalyticEvents.THREAD_CREATION_STARTED, {
                    location: n,
                    channel_id: e.id,
                    guild_id: e.guild_id
                }), o.MainWindowDispatch.dispatch(p.ComponentActions.POPOUT_CLOSE), T.default.getChannelId() !== e.id && (0, I.transitionToChannel)(e.id);
            ...
            function L(e, t) {
                (0, f.transitionTo)(p.Routes.CHANNEL(e, (0, m.isGuildHomeChannel)(t) ? m.StaticChannelRoute.GUILD_HOME : t)), u.default.dispatch({
                    type: "SIDEBAR_CLOSE",
                    baseChannelId: t
                })
            }
                ...
                render() {
                    ...
                    return (0, r.jsx)(o.Popout, {
                        ...
                        children: n => (0, r.jsxs)("div", {
                            className: a(e, C.container, function() {

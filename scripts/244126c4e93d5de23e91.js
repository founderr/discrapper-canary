    ...
    ["95876"], {
        ...
        846883: function(e, t, i) {
            ...
            function H(e, t) {
                let {
                ...
                }, [t, e]), Q = (0, F.default)(), q = (0, a.useStateFromStores)([v.default], () => null == e || e.isPrivate() || v.default.can(P.Permissions.SEND_MESSAGES, e), [e]), W = (0, a.useStateFromStoresArray)([O.default], () => [...B.map(e => null != e.application_id && O.default.getState(e.application_id, P.ActivityActionTypes.JOIN) === P.ActivityActionStates.LOADING), ...K.map(e => O.default.getState(e.application_id, P.ActivityActionTypes.JOIN) === P.ActivityActionStates.LOADING)], [B, K]), Z = (0, c.default)([...B.filter(e => (null == e ? void 0 : e.application_id) != null).map(e => e.application_id), ...K.map(e => e.application_id)]), $ = null == e ? void 0 : e.id, ee = (0, a.useStateFromStoresArray)([T.default, E.default, y.default, m.default, h.default, g.default, v.default], () => [...B.map(e => (0, U.default)({
                    user: null != t ? t : k,
                    activity: e,
                    ...
                    VoiceStateStore: g.default,
                    PermissionStore: v.default
                }))], [B, Z, $, k, K, t]), et = (0, a.useStateFromStoresArray)([r.default, S.default], () => B.map(e => e.type === P.ActivityTypes.LISTENING && null != t ? (0, p.default)(r.default, S.default, t, e) : void 0), [t, B]), ei = (0, s.useAnalyticsContext)();
                if (!q) return null;
                let en = (i, n) => {
                ...
                return null == X || X.forEach(i => {
                    ...
                    if (i.type === P.ActivityTypes.PLAYING && (0, j.default)(i, P.ActivityFlags.JOIN) && null != i.session_id && null != i.application_id) {
                        ...
                        eu.push((0, n.jsx)(l.MenuItem, {
                            ...
                            subtext: S ? (0, I.default)(d, J.SpotifyActionTypes.USER_ACTIVITY_SYNC, null != e ? b.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: S

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [90866, 81580, 95327, 18966, 57678, 58621, 96043, 71402, 1459], {
        737264: e => {
            "use strict";
        ...
        866893: (e, t, n) => {
            ...
            function V(e) {
                ...
                if (null != t) {
                    ...
                    if (0 !== F.size) {
                        D = Array.from(new Set(O(D).concat(O(F))));
                        F.clear()
                    }
                    ...
                    var n, r = (C === o.z.LATEST_ACTIVITY ? G : w).value(),
                        u = (U = 0 === L.size ? r : r.filter((n = L, function(e) {
            ...
            const W = new Y(l.Z, {
                ...
                THREAD_LIST_SYNC: function(e) {
                    var t, n = e.guildId;
                    if (null == R) return !1;
                    if (n !== (null === (t = f.Z.getChannel(R)) || void 0 === t ? void 0 : t.guild_id)) return !1;
                    V({
                        refreshThreadIds: !0
                    })
                },
                THREAD_CREATE: function(e) {
                    ...
                    if (null == t.parent_id || t.parent_id !== R) return !1;
                    if (!n) return !1;
                    t.ownerId !== d.default.getId() ? P++ : N = t.id
                },

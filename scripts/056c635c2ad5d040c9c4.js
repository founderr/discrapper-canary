    ...
    [16501, 96043], {
        ...
        392354: (t, e, n) => {
            ...
            function I(t) {
                ...
                return null != l && (l.isDM() || l.isGroupDM() ? a.Z.getFriendIDs().includes(t.author.id) ? E(r) : E(i) : E(n))
            }
            ...
            function g() {
                return !!(0, f.Kh)() && (null != u.default.getCurrentUser() && E(h().explicitContentGuilds))
            }! function(t) {

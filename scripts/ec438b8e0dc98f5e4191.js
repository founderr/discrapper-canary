    ...
    ["52831"], {
        ...
        110374: function(e, t, n) {
            ...
            function N(e) {
                let {
                    ...
                    recurrenceId: n,
                    isRecurrenceItem: R
                }), p = (0, E.default)(t, g, N), A = (0, T.default)(t, g, N), O = (0, s.default)(t, g.id, n), L = (0, f.default)(t), y = (0, d.default)({
                    id: null != n ? n : t,
                    label: v.default.Messages.COPY_ID_EVENT
                }), G = (0, r.default)(t, g.id, N, n), x = (0, S.default)({
                    guildEventId: t,
                    guildId: g.id,
                    recurrenceId: n
                });
                return (0, l.jsx)(i.default, {
                    ...
                    children: (0, l.jsxs)(u.Menu, {
                        ...
                        children: [(0, l.jsxs)(u.MenuGroup, {
                            children: [G, !R && A, h, !R && p, M, C, O, R && x]
        ...
        455933: function(e, t, n) {
            ...
            function C(e, t, n, u) {
                var i, C, M;
                let h;
                let p = (0, s.useStateFromStores)([S.default], () => S.default.isActive(e)),
                    {
                        startTime: A,
                        endTime: O
                ...
                h = L.entity_type === N.GuildScheduledEventEntityTypes.EXTERNAL ? L.entity_metadata.location : null != n && null != y ? g.default.Messages.CALENDAR_CHANNEL_LOCATION.format({
                    channelName: n.name,
                    guildName: y.name
                }) : g.default.Messages.NOTIFICATION_TITLE_DISCORD;
                let G = d(L.scheduled_start_time),
                    x = null != L.scheduled_end_time ? d(L.scheduled_end_time) : G,
                    U = null != L.description && "" !== L.description ? E.default.unparse(L.description, null !== (i = null == n ? void 0 : n.id) && void 0 !== i ? i : "", !0) : "",
                    V = (0, I.recurrenceRuleFromServer)(L.recurrence_rule),
                    P = null != V ? (0, v.getRRule)(V) : null,
                    b = null !== (C = d(A)) && void 0 !== C ? C : G,
                    w = null !== (M = d(null != O ? O : A)) && void 0 !== M ? M : G,
                    F = () => {
                        let e = a();
                        e.createEvent({
                            start: G,
                    ...
                    children: [(0, l.jsx)(o.MenuItem, {
                        ...
                        action: () => {
                            ...
                            let t = null == P ? void 0 : P.toString(),
                                n = {
                                    text: L.name,
                                    dates: "".concat(G.format(m), "/").concat(x.format(m)),
                                    details: U,
                                    action: "TEMPLATE",
                                    location: h,
        ...
        385752: function(e, t, n) {
            ...
            function f(e) {
                ...
                } = (0, i.useManageResourcePermissions)(null != _ ? _ : f), [I, v] = (0, u.useStateFromStoresArray)([r.default], () => [r.default.isActive(t), r.default.getGuildScheduledEvent(t)]), N = (0, o.default)(n, null == v ? void 0 : v.id), g = null != v && T(v), m = (null == v ? void 0 : v.recurrence_rule) != null && !S, {
                    startTime: R
                } = (0, c.default)(t, n);
                if (!g || I && !m && !S || S && !S || null == v) return null;
                if (I && S) {
                    var D;
                ...
                let C = () => {
                        if (null != n) {
                            if (null != N) s.default.updateGuildEventException({
                    ...
                    M = e => {
                        (0, a.openModal)(n => (0, l.jsxs)(a.ConfirmModal, {
                            ...
                            onConfirm: () => S && !e ? C() : s.default.deleteGuildEvent(t, f.id),
        ...
        222971: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    canManageGuildEvent: T
                } = (0, i.useManageResourcePermissions)(null != f ? f : E), I = (0, u.useStateFromStores)([d.default], () => d.default.getGuildScheduledEvent(t)), v = T(I), N = (0, o.default)(), g = (0, r.default)(_, null == I ? void 0 : I.id), m = (0, s.default)(t, _);
                if (!v || null == I) return null;
                let R = null != I.recurrence_rule && !S,
                    D = e => {
        ...
        601131: function(e, t, n) {
            ...
            function E(e, t, n) {
                ...
                } = (0, i.useManageResourcePermissions)(null != n ? n : t), f = (0, u.useStateFromStores)([r.default], () => r.default.isActive(e)), _ = (0, u.useStateFromStores)([r.default], () => r.default.getGuildScheduledEvent(e), [e]), S = E(_);
        ...
        367989: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = (0, i.useManageResourcePermissions)(null != E ? E : c), [S, T] = (0, u.useStateFromStoresArray)([d.default], () => [d.default.isActive(t), d.default.getGuildScheduledEvent(t)]), I = (0, s.default)(n, null == T ? void 0 : T.id), v = null != T && _(T), N = f && (null == I ? void 0 : I.is_canceled) && v;
        ...
        891603: function(e, t, n) {
            ...
            function f(e) {
                let {
                    ...
                    guildId: n,
                    recurrenceId: f
                } = e, _ = (0, u.useStateFromStores)([i.default], () => i.default.isLurking(n), [n]), S = (0, u.useStateFromStores)([d.default], () => d.default.getId()), {
                    rsvped: T,
                    baseRsvp: I,
                    recurrenceRsvp: v
        ...
        510692: function(e, t, n) {
            ...
            function o(e, t, o) {
                ...
                let {
                    canManageGuildEvent: E
                } = (0, i.useManageResourcePermissions)(null != o ? o : t), f = (0, u.useStateFromStores)([d.default], () => d.default.getGuildScheduledEvent(e), [e]), _ = E(f), S = null != (0, r.useActiveEvent)(null !== (c = null == o ? void 0 : o.id) && void 0 !== c ? c : ""), T = null != f && (0, d.isGuildScheduledEventActive)(f);
        ...
        936965: function(e, t, n) {
            ...
            function v(e, t, n, l) {
                ...
                if (null == u) return;
                let i = null != t ? t : (0, c.getNextRecurrenceIdInEvent)(u),
                    r = S(u.id, i);
                null == i ? (T(e, null, n, E.GuildScheduledEventUserResponses.INTERESTED), null == l || l()) : null != r ? (T(e, i, n, E.GuildScheduledEventUserResponses.UNINTERESTED), null == l || l()) : (0, d.openModalLazy)(() => Promise.resolve(e => (0, a.jsx)(I, {
                    ...e,
                    event: u,
                    recurrenceId: i,
                    guildId: n,
        ...
        244480: function(e, t, n) {
            ...
            function g(e, t) {
                ...
                return d === T.RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK && !t && (0, s.trackWithMetadata)(I.AnalyticEvents.PROMOTED_TO_SPEAKER, {
                    ...(0, _.getStageChannelMetadata)(e)
                }), i.default.patch({
            ...
            function D(e, t) {
                ...
                let n = t.getGuildId();
                return u(null != n, "This channel cannot be guildless."), R(t, e.id, !0), i.default.patch({
        ...
        708169: function(e, t, n) {
            ...
            var l, u, a = n("37983"),
                ...
                S = n("983782"),
                T = n("275495");
            let I = (0, _.cssValueToNumber)(c.default.FULL_SCREEN_LAYER_ANIMATION_DURATION);
            ...
            function N(e) {
                ...
                return (0, E.useFocusLock)(n), i.useEffect(() => (f.default.disable(), f.default.enableTemp(function(e) {
                    return {
                        POP_LAYER: {
                            binds: ["esc"],
            ...
            function R() {
                let {
                    reducedMotion: e
                } = i.useContext(E.AccessibilityPreferencesContext), t = e.enabled, n = t ? m : g, l = v(e => e.fullScreenLayers);

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [21391, 74871], {
        ...
        521391: (t, e, n) => {
            ...
            var w = (j(r = {}, h.Us.BAN, [f.Z, N().redIcon]), j(r, h.Us.GLOBAL_QUARANTINE, [_.Z, N().warningIcon]), j(r, h.Us.DISABLE_SUSPICIOUS_ACTIVITY, [_.Z, N().warningIcon]), j(r, h.Us.LIMITED_ACCESS, [O.Z, N().warningIcon]), j(r, h.Us.REQUIRE_VERIFICATION, [_.Z, N().warningIcon]), j(r, h.Us.TEMP_BAN, [O.Z, N().warningIcon]), j(r, h.Us.USER_MESSAGE_REMOVAL, [d.Z, N().redIcon]), j(r, h.Us.USER_SPAMMER, [_.Z, N().warningIcon]), j(r, h.Us.USER_USERNAME_MANGLE, [S.Z, N().warningIcon]), j(r, h.Us.USER_WARNING, [p.Z, N().warningIcon]), r),
                L = _.Z,
                R = function(t) {

    ...
    [87816], {
        563726: (e, t, n) => {
                ...
                _ = f((function(e) {
                    ...
                    return E(this, (function(d) {
                        switch (d.label) {
                            ...
                            case 2:
                                if (null == (r = d.sent()).application_id || r.application_id === l.RQ) return [3, 6];
                                if (null != s.Z.getGame(r.application_id)) return [3, 6];
                                d.label = 3;
                            case 3:
                                d.trys.push([3, 5, , 6]);
                                return [4, c.Z.fetchApplication(r.application_id)];
                            case 4:
                                d.sent();
                                return [3, 6];
                            case 5:
            ...
            const h = function(e) {
                        ...
                        return E(this, (function(s) {
                            switch (s.label) {
                                ...
                                case 1:
                                    s.trys.push([1, 3, , 4]);
                                    return [4, r.ZP.post({
                                        url: a.ANM.USER_GIFT_CODE_CREATE,
                                        body: {
                                            sku_id: e,
                                            subscription_plan_id: t,
                                            gift_style: n
                            ...
                            switch (t.label) {
                                ...
                                case 1:
                                    ...
                                    return [4, r.ZP.delete({
                                        url: a.ANM.USER_GIFT_CODE_REVOKE(e),
                                        oldFormErrors: !0
                                    })];
                                case 2:
                                    t.sent();
                ...
                openNativeGiftCodeModal: function(e) {
                    o.Z.openNativeAppModal(e, a.Etm.GIFT_CODE_BROWSER)
                }
            }, n(18727).Z)
        },
        18727: (e, t, n) => {
            ...
            function f() {
                f = a((function(e) {
                    var t, n, c, a, f, p, E, _, h, b, v, y = arguments;
                    return l(this, (function(l) {
                        switch (l.label) {
                            case 0:
                                t = y.length > 1 && void 0 !== y[1] ? y[1] : d;
                                n = t.channelId, c = void 0 === n ? null : n, a = t.paymentSource, f = void 0 === a ? null : a;
                                i.Z.dispatch({
                            ...
                            case 1:
                                ...
                                return [4, (0, s.cn)(f)];
                            case 2:
                                return [4, E.apply(r.ZP, [(_.body = (h.gateway_checkout_context = l.sent(), h), _.oldFormErrors = !0, _)])];
                            case 3:
                                p = l.sent();
                                i.Z.dispatch({
            ...
            var m = function(e) {
                    ...
                    return (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(u.Avatar, {
                            ...
                            r.jsx)(_.Z, {
                            size: o ? _.Z.Sizes.SIZE_12 : _.Z.Sizes.SIZE_14,
            ...
            const g = function(e) {
                var t = e.stageInstance,
                    ...
                    O = i.useMemo((function() {
                        return null == n ? null : n instanceof c.Z ? n : new c.Z(n)
                    }), [n]);
                if (null == t || null == O) return null;
                var I, T = t.topic,
                    x = t.speaker_count,
                    A = t.participant_count,
                    R = null !== (I = t.members) && void 0 !== I ? I : [],
                    D = C ? R.slice(0, 3) : R,
                    w = x - D.length;
                C && (w += R.length - D.length);
                return (0, r.jsxs)("div", {
                    children: [(0, r.jsxs)("div", {
                        ...
                        className: s()(y().guild, S({}, y().embed, C)),
                        children: [(0, r.jsx)(h.ZP, {
                            mask: h.ZP.Masks.SQUIRCLE,
                            width: 20,
                            height: 20,
                        ...
                        size: a || C ? E.Z.Sizes.SIZE_16 : E.Z.Sizes.SIZE_20,
                        className: s()(y().header, S({}, y().embed, C)),
                        children: T
                    }), (0, r.jsxs)("div", {
                        className: s()(y().members, S({}, y().embed, C)),
                        children: [D.length > 0 && (0, r.jsxs)("div", {
                            ...
                            children: [D.map((function(e) {
                                ...
                                className: y().speaker,
                                children: [(0, r.jsx)("div", {
                                    className: s()(y().icon, S({}, y().embed, C)),
                                    children: (0, r.jsx)(f.Z, {
                                        height: C ? 12 : 14,
                                        className: y().listeners
                                    })
                                }), (0, r.jsxs)(_.Z, {
                                    size: C ? _.Z.Sizes.SIZE_12 : _.Z.Sizes.SIZE_14,
                                    color: _.Z.Colors.HEADER_SECONDARY,
            ...
            var _ = Object.freeze({
                ...
                h = function(e) {
                    ...
                    ! function(e, t, n) {
                        ...
                        get: function() {
                            return !(0, s.yE)(this.flags, _.NOT_SELF_REDEEMABLE)
                        }
                    }, {
                        key: "isExistingPremiumSubscriptionDisallowed",
                        get: function() {
                            return (0, s.yE)(this.flags, _.EXISTING_PREMIUM_SUBSCRIPTION_DISALLOWED)
                        }
                    }, {
                        key: "analyticsData",
                        get: function() {
        ...
        70321: (e, t, n) => {
            ...
            function P(e) {
                ...
                var n = (0, p.Fp)(e) ? (0,
                    p.Q_)(null != (null == e ? void 0 : e.embeds) ? null == e ? void 0 : e.embeds[0].url : void 0) : (0, p.Q_)(e.content);
                if (0 === n.length) return !1;
                n.forEach((function(e) {
                    if (!T.includes(e) && !A.includes(e)) {
                        F({
                            code: e
                        });
                        a.Z.wait((function() {
            ...
            var M = function(e) {
                ...
                r.getForGifterSKUAndPlan = function(e, t, n) {
                    return i().values(I).filter((function(r) {
                ...
                r.__getLocalVars = function() {
                    return {
                        MAX_TIMEOUT_MS: g,
                        giftCodeExpirationTimeouts: O,
                        giftCodes: I,
                        resolvingCodes: T,
                        acceptingCodes: x,
                        resolvedCodes: A,
                        userGiftCodesFetching: R,
                        userGiftCodesLoadedAt: D,
                        giftCodeErrors: w,
                        loadedChannels: j,
                        GiftCodeStoreInstance: L
                    }
                };
                return n
            }(u.ZP.Store);
            M.displayName = "GiftCodeStore";
            var L = new M(a.Z, {
                ...
                GIFT_CODE_RESOLVE_SUCCESS: function(e) {
                    ...
                    A.includes(t.code) || (A = S(A).concat([t.code]));
                    return Z(t)
                },
                ...
                GIFT_CODE_UPDATE: function(e) {
                    var t = e.uses,
                        n = e.code,
                        r = I[n];
                    null != r && (I[n] = r.set("uses", Math.max(r.uses, t)))
                },
...
//# sourceMappingURL=877144e8a2c1ff349e1f.js.map
            ...
            var l = n("77078"),
                ...
                f = (0, u.default)(function(e) {
                    let {
                        ...
                        onMessage: p,
                        onSelect: C
                    } = e, M = t.isNonUserBot(), h = [], E = (0, o.useIsIarUserReportingEnabled)("User Profile Actions Menu");
                    if (!M) switch (n) {
                        case c.RelationshipTypes.BLOCKED:
                            h.push((0, s.jsx)(l.MenuItem, {
                                id: "user-unblock",
                    ...
                    }!M && n !== c.RelationshipTypes.BLOCKED && h.push((0, s.jsx)(l.MenuItem, {
                        id: "user-message",

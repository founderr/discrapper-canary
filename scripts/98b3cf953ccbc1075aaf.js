                        ...
                        return l.map((l, m) => {
                            ...
                            switch (l.type) {
                                ...
                                case u.ComponentType.BUTTON:
                                    if (E.includes(t) && null != l.custom_id && p.test(l.custom_id) && !(0, r.default)(n)) return null;
                                ...
                                case u.ComponentType.STRING_SELECT:
                                    return {
                                        ...
                                        })), placeholder: null !== (f = l.placeholder) && void 0 !== f ? f : c.default.Messages.MESSAGE_SELECT_COMPONENT_DEFAULT_PLACEHOLDER, minValues: l.min_values, maxValues: l.max_values, indices: O, applicationId: t
                                    };
                ...
                return e.map(e => {
                    switch (e.type) {
                        case n.SnowflakeSelectDefaultValueTypes.USER:
                            ...
                            return {
                                type: c.SelectOptionType.USER, value: o.id, label: null !== (l = null != d ? d : o.globalName) && void 0 !== l ? l : o.username
                            };
                        case n.SnowflakeSelectDefaultValueTypes.ROLE:
                            ...
                            return {
                                type: c.SelectOptionType.ROLE, value: r.id, label: r.name
                            };
                        case n.SnowflakeSelectDefaultValueTypes.CHANNEL:
                            if (null == a) return null;
                            let E = u.default.getChannel(e.id);
                            if (null == E || E.guild_id !== a.id || t.length > 0 && !t.includes(E.type)) return null;
                            return {

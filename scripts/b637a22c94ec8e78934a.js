    ...
    [46663, 58093, 84832, 33973], {
                ...
                return function(t) {
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            return new x(b(t.minValue, t.maxValue), b(t.minStart, t.maxStart), b(t.minFinal, t.maxFinal), b(t.minDuration, t.maxDuration), C(t.minDirection, t.maxDirection), O(t.easingFunctions)[0])
                    }
                }(p(p({}, t), {
                    valueType: "number"
                }))
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = z(t.minStart),
                                ...
                                P = z(t.minDirection),
                                S = z(t.maxDirection);
                            return new y(new x(b(n.x, r.x), b(f.x, h.x), b(d.x, p.x), b(v.x, g.x), C(P.x, S.x), O(t.easingFunctions)[0]), new x(b(n.y, r.y), b(f.y, h.y), b(d.y, p.y), b(v.y, g.y), C(P.y, S.y), O(t.easingFunctions)[0]))
                    }
                }(p(p({}, t), {
                    valueType: "Vector2"
                }))
            ...
            function A(t) {
                return function(t) {
                    switch (t.type) {
                        ...
                        case "linear-random":
                            n = P(t.minValue), r = P(t.maxValue);
                            var o = P(t.minAddValue),
                                a = P(t.maxAddValue);
                        ...
                        case "oscillating-random":
                            ...
                            var f = P(t.minStart),
                                ...
                                z = P(t.minDirection),
                                S = P(t.maxDirection);
                            return new g(new x(b(n.x, r.x), b(f.x, h.x), b(d.x, p.x), b(v.x, y.x), C(z.x, S.x), O(t.easingFunctions)[0]), new x(b(n.y, r.y), b(f.y, h.y), b(d.y, p.y), b(v.y, y.y), C(z.y, S.y), O(t.easingFunctions)[0]), new x(b(n.z, r.z), b(f.z, h.z), b(d.z, p.z), b(v.z, y.z), C(z.z, S.z), O(t.easingFunctions)[0]))
                    }
                }(p(p({}, t), {
                    valueType: "Vector3"
                }))
            ...
            var R = r.forwardRef((function(t, e) {
                    ...
                    b = r.useCallback((function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                })), null == d || d(e), g.current.size > 0 ? m.current = window.requestAnimationFrame(b) : (e.clearRect(0, 0, t.width, t.height), m.current = null);
                                var n = Date.now();
                ...
                var O = r.useCallback((function(t, e) {
                    ...
                    C = r.useCallback((function(t, e, n, r, o) {
                        var a, u = k(null !== (a = t.id) && void 0 !== a ? a : (0, i.v4)(), t, n, r, o);
                        return O(u, e), u
                    }), [O]),
                ...
                return r.useEffect((function() {
                    ...
                    return t("click", A, c), t("mousedown", R, l), t("mousemove", E, s), t("mouseup", _, f),
                        function() {
                            window.removeEventListener("click", A), window.removeEventListener("mousedown", R), window.removeEventListener("mousemove", E), window.removeEventListener("mouseup", E)
                        }
                }), [A, R, E, _, c, l, s, f]), r.useEffect((function() {
                    var t = y.current,
        ...
        58964: (t, e, n) => {
            ...
            function d(t) {
                ...
                try {
                    ...
                    var r, i = decodeURIComponent(n),
                        ...
                        l = void 0;
                    try {
                        for (var h, d = o.entries()[Symbol.iterator](); !(u = (h = d.next()).done); u = !0) {
                            var p = s(h.value, 2),
                                v = p[0],
                                y = p[1];
                            a[v] = y
            ...
            function p(t, e) {
                ...
                var d, p, v, y, g, m = encodeURIComponent(c.toString()),
                    w = encodeURIComponent(u()),
                    x = (v = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), y = null != (null === i() || void 0 === i() || null === (d = i().ua) || void 0 === d ? void 0 : d.match(v)), g = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !y,
                        "iOS" !== (null === i() || void 0 === i() || null === (p = i().os) || void 0 === p ? void 0 : p.family) || g ? 1 : 0),
                    b = null != r ? encodeURIComponent(r) : null,
                    O = null != o ? encodeURIComponent(o) : null,
                    C = "".concat(f, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(w, "&efr=").concat(x);
                null != b && (C += "&afl=".concat(b));
        ...
        498964: (t, e, n) => {
            ...
            const C = f(m((function(t) {
                ...
                P = t => Object.assign(f(t), {
                    startsWith: e => {
                        return P(y(t, (n = e, m((t => b(t) && t.startsWith(n))))));
                        var n
                    },
                    endsWith: e => {
                        return P(y(t, (n = e, m((t => b(t) && t.endsWith(n))))));
                        var n
                    },
                    minLength: e => P(y(t, (t => m((e => b(e) && e.length >= t)))(e))),
                    maxLength: e => P(y(t, (t => m((e => b(e) && e.length <= t)))(e))),
                    includes: e => {
                        return P(y(t, (n = e, m((t => b(t) && t.includes(n))))));
                        var n
                    },
                    regex: e => {
                        return P(y(t, (n = e, m((t => b(t) && Boolean(t.match(n)))))));
                        var n
                    }
                }),
                S = P(m(b)),
                j = (t, e) => m((n => x(n) && t <= n && e >= n)),
                A = t => m((e => x(e) && e < t)),
                k = t => m((e => x(e) && e > t)),
                R = t => m((e => x(e) && e <= t)),
                E = t => m((e => x(e) && e >= t)),
                _ = () => m((t => x(t) && Number.isInteger(t))),
                F = () => m((t => x(t) && Number.isFinite(t))),
                I = () => m((t => x(t) && t > 0)),
                V = () => m((t => x(t) && t < 0)),
                D = t => Object.assign(f(t), {
                    between: (e, n) => D(y(t, j(e, n))),
                    lt: e => D(y(t, A(e))),
                    gt: e => D(y(t, k(e))),
                    lte: e => D(y(t, R(e))),
                    gte: e => D(y(t, E(e))),
            ...
            class J {
                ...
                with(...t) {
                    ...
                    const u = (t, e) => {
                        ...
                        l = !n.some((t => c(t, this.input, u))) || r && !Boolean(r(this.input)) ? q : {
                            matched: !0,

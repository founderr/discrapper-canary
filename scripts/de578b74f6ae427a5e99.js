(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["62428"], {
            ...
            var l = function() {
                ...
                return l.prototype = {
                    ...
                    quantize: function(a, s) {
                        ...
                        var o, u, d, c, E, _, I, f, T, h, N, g, p, A, m, S, C = (o = a, E = Array(32768), o.forEach(function(n) {
                        ...
                        var L = (_ = a, I = C, N = 1e6, g = 0, p = 1e6, A = 0, m = 1e6, S = 0, _.forEach(function(t) {
                                f = t[0] >> e, T = t[1] >> e, h = t[2] >> e, f < N ? N = f : f > g && (g = f), T < p ? p = T : T > A && (A = T), h < m ? m = h : h > S && (S = h)
                            }), new l(N, g, p, A, m, S, I)),
        ...
        442939: function(e, t, n) {
            ...
            function s(e) {
                return i.useEffect(() => {
                    r.default.fetchApplications(e, !1)
                }, e), (0, l.useStateFromStoresArray)([a.default], () => e.map(e => a.default.getApplication(e)), e)
            }
        ...
        310688: function(e, t, n) {
            ...
            var ef = l.forwardRef(function(e, t) {
                ...
                }), K = null != W && !(0, m.default)(W) && [el.InstantInviteSources.GUILD_CONTEXT_MENU, el.InstantInviteSources.GUILD_HEADER].includes(d), Y = (0, R.default)(u.id), Z = (0, _.useStateFromStores)([F.default, P.default, G.default], () => {
                    var e;
                ...
                let [eg] = (0, A.default)(null != f ? [f] : []), ep = (0, C.default)({
                    guildId: ee
                }), eA = null != et ? et.code : void 0, em = null == et ? void 0 : et.maxAge, eS = null == et ? void 0 : et.maxUses, eC = null == et ? void 0 : et.temporary, eO = u.vanityURLCode, eL = null != eO && eO.length > 0, {
                    enabled: ev
                ...
                }), eR = ev && !(null == J ? void 0 : J.isGuildVocal()) && eL, eM = (null == J ? void 0 : J.type) === el.ChannelTypes.GUILD_VOICE, eU = (0, m.default)(J);
                !ed && (null == eN ? void 0 : eN.invite_code) != null && (eA = eN.invite_code);
                let [eD, eP] = l.useState({
                    query: "",
                    maxAge: null !== (s = null != em ? em : ep) && void 0 !== s ? s : eE.value,
                    savedMaxAge: em === ec.value ? null != ep ? ep : eE.value : ec.value,
        ...
        235004: function(e, t, n) {
            ...
            class R extends s.default.Store {
                ...
                hasFetchedAllSounds() {
                    return A === i.FETCHED && p === i.FETCHED
                }
            }
            R.displayName = "SoundboardStore";
            var M = new R(o.default, {
                LOGOUT: function() {
                    h.clear(), N.clear(), S.clear(), C = !1, A = i.NOT_FETCHED, p = i.NOT_FETCHED
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    h.set(I.DEFAULT_SOUND_GUILD_ID, t), p = i.FETCHED
                },
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    h = new Map(Object.entries(t.soundboardSounds)), m = new Set(t.favoritedSoundIds), g = new Set(t.localSoundboardMutes)
                },
        ...
        866353: function(e, t, n) {
            ...
            let u = (e, t, n) => {
                    ...
                    if ((0, s.isStandardSticker)(e)) return l.SENDABLE;
        ...
        19766: function(e, t, n) {
            ...
            function O(e, t, n, l) {
                switch (t) {
                    ...
                    default:
                        ...
                        return {
                            type: i.GROUP, key: t, id: t, title: null != a ? a.name : "", count: n, index: l
                        }
                }
            }

            function L(e, t, n) {
                let l = n === I.default.getId(),
                    r = g.default.isMobileOnline(n),
                    a = l ? p.default.getStatus() : g.default.getStatus(n, e),
                    s = l ? p.default.getActivities() : g.default.getActivities(n, e),
            ...
            function v(e) {
                ...
                return null == t ? C : null == t.memberListId ? function(e) {
                    return E.default.canEveryone(m.Permissions.VIEW_CHANNEL, e) ? C : o.v3(a(e.permissionOverwrites).reduce((e, t) => {
                        let {
                            id: n,
                            allow: i,
                            deny: l
                        } = t;
                        return u.default.has(i, m.Permissions.VIEW_CHANNEL) ? e.push("allow:".concat(n)) : u.default.has(l, m.Permissions.VIEW_CHANNEL) && e.push("deny:".concat(n)), e
                    }, []).sort().join(",")).toString()
                }(t) : t.memberListId
            ...
            class R {
                ...
                invalidate(e) {
                    ...
                    for (let e = t; e <= n; e++) {
                        let t = this.rows[e];
                        if (null == t) break;
                        delete this.rows[e], t.type === i.MEMBER && delete this.members[t.user.id]
                    }
                    this.version++
                }
                insert(e, t) {
                ...
                update(e, t) {
                    ...
                    if (null != r && r.type === i.MEMBER && delete this.members[r.user.id], null != n) this.rows[e] = O(this.guildId, n.id, n.count);
                    else if (null != l) {
                ...
                delete(e) {
                    let t = this.rows[e];
                    null != t && (t.type === i.MEMBER && delete this.members[t.user.id], this.rows.splice(e, 1), this.version++)
                }
                rebuildMember(e) {
            ...
            class y extends d.default.Store {
                initialize() {
                    this.waitFor(A.default, N.default, f.default, h.default, g.default, p.default, I.default, T.default, _.default), this.syncWith([p.default], G), this.syncWith([_.default], P)
                }
                getProps(e, t) {
                    let n = M.get(e, v(t));
                    return {

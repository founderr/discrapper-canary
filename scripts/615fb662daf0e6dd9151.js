    ...
    ["94548"], {
        ...
        479273: function(e, t, a) {
            ...
            function eM(e) {
                ...
                let {
                ...
                }, [et, en, f.length, C.length, H, V, eM, T, ej, eO, eF]), eb = n.useMemo(() => {
                    if (!H && en) return [
                        [],
                        []
                    ];
                ...
                }, [en, H, V, T, f, C]), eP = n.useCallback((e, a) => {
                    ...
                    channel: t,
                    coords: a
                }, "archived-missing-reading-history-perm"), [en, V, T, H, t, D, P, b, U]), ew = (0, h.useStateFromStores)([B.default], () => B.default.hasHidden(t.id));
                n.useEffect(() => {
                    var e, t;
                    let a = et ? eW : Q,
                        ...
                        children: [null != i.guild_id ? (0, s.jsx)(E.default, {
                            ...
                            children: [ev && (0, s.jsxs)("div", {
                                ...
                                children: [(0, s.jsx)(g.Heading, {
                                    ...
                                    color: "text-normal",
                                    children: T ? ef.default.Messages.FORUM_SEARCHING : 0 === N ? ef.default.Messages.FORUM_SEARCH_NO_MATCHING_POSTS : ef.default.Messages.FORUM_SEARCH_MATCHING_POSTS_ALT.format({
                                        numPosts: N,
                                        query: I
                                    })
        ...
        131600: function(e, t, a) {
            ...
            let Z = (e, t, n) => {
                    let l = (0, _.default)(t) ? c.default.combine(G.Permissions.VIEW_CHANNEL, G.Permissions.SEND_MESSAGES) : G.Permissions.SEND_MESSAGES,
                        r = null != e ? (0, P.getAllExistingRolesWithPermission)(e, t, l).filter(a => t.permissionOverwrites.hasOwnProperty(a.id) || (0, T.isEveryoneRoleId)(e.id, a.id)) : [],
                        i = r.length > 0,
                ...
                ec = e => {
                    let {
                        ...
                        hasAnyThread: s,
                        handleHide: l
                    } = e, [r, i] = n.useState(!1), o = (0, w.isOnboardingDismissed)(a.id), u = (0, h.useStateFromStores)([L.default], () => L.default.hasHidden(a.id)), d = ee(t, a, s, i), c = d.isAllDone(), m = o || u || !ea(a.id);
                    return en(c, m, r, l), {
                        onboardingSteps: d,
                        isHidden: u,
                        isDismissed: o,
            ...
            var eg = e => {
                let {
                    ...
                    hasAnyThread: t,
                    handleHide: _
                }), F = !M && !N, L = (0, H.useForumPostComposerStoreApi)(), b = a.isMediaChannel(), P = e => L.getState().setOnboardingExpanded(e);
                return (el(A, F, _), er({
                    isAllDone: A,
                    isVisible: F,
                    canManageChannel: c,
                    ...
                    (!t || !F) && P(!0)
                }, []), null == o) ? null : F && c ? b ? t ? null : (0, s.jsx)(S.default, {
                    channel: a
                }) : (0, s.jsx)(s.Fragment, {
        ...
        729608: function(e, t, a) {
            ...
            function x(e) {
                let {
                    ...
                    tagFilter: C,
                    channel: _
                } = e, T = (0, c.useCanManageChannel)(_), S = (0, r.useCanStartThread)(_), p = _.isMediaChannel(), E = n.useCallback(() => {
                ...
                }, [x]), N = C.size > 0, M = S || T, A = !N && T && !p, v = n.useCallback(() => A ? E() : S ? void d.ComponentDispatch.dispatch(h.ComponentActions.FOCUS_COMPOSER_TITLE) : (0, h.NOOP_NULL)(), [E, A, S]);
                return (0, s.jsxs)("div", {
        ...
        530474: function(e, t, a) {
            ...
            function ef(e) {
                let {
                ...
                }, [C]), T = (0, m.useStateFromStores)([P.default], () => P.default.can(eu.Permissions.ATTACH_FILES, t)), S = (0, m.useStateFromStoresArray)([D.default], () => D.default.getUploads(t.id, b.DraftType.FirstThreadMessage)), p = c && T && i, A = (null == t ? void 0 : t.isMediaChannel()) === !0, v = function(e, t) {
                    let a = (0, en.useForumPostComposerStoreApi)(),
                        ...
                        l = n.useCallback(() => {
                            ...
                            }, 0), (o && r.length > 0 || i.textValue.trim().length > 0 && i.textValue.trim() !== s || D.default.getUploads(e.id, b.DraftType.FirstThreadMessage).length > 0) && l())
                        }, [a, e.id, s, t]);
                    return l
                }(t, o), R = function(e) {
                    let {
            ...
            let eg = n.memo(function(e) {
                    ...
                    }, [m, t.id, t.guild_id, l]), _ = n.useMemo(() => a && !r ? (0, s.jsx)(ev, {}) : a || r || 0 !== o.textValue.trim().length && o.textValue.trim() !== x ? !r && (i.trim().length > 0 || o.textValue.trim().length > 0 && o.textValue.trim() !== x || D.default.getUploads(t.id, b.DraftType.FirstThreadMessage).length > 0) && d ? (0, s.jsx)(z.default, {
                ...
                ex = n.memo(function(e) {
                    ...
                    }, u.default), x = (0, en.useForumPostComposerStoreApi)(), C = null != t.topic && 0 !== t.topic.length, _ = J.default.hasSeen(t.id), T = (0, $.useChannelTemplate)(t), S = (0, m.useStateFromStores)([U.default], () => U.default.getCurrentUser());
                    ...
                    let p = n.useCallback(e => {
                            ...
                            null != a && a.type.startsWith("image/") && (e.preventDefault(), (0, Z.promptToUpload)([a], t, b.DraftType.FirstThreadMessage), x.getState().setFormOpenFromUserAction())
                        }, [t, x]),
                        E = (0, q.renderError)(d, {
                            content: c
                        });
                    return (0, s.jsxs)("div", {
                        ...
                        children: [i && g ? (0, s.jsx)(h.Heading, {
                            ...
                            value: c,
                            placeholder: l ? i || f.textValue.length > 0 && f.textValue.trim() !== T ? ec.default.Messages.FORUM_POST_TITLE_PLACEHOLDER_FOCUSED : ec.default.Messages.FORUM_POST_TITLE_PLACEHOLDER_SEARCH : ec.default.Messages.SEARCH,
                            flex: !0,
                            autosize: i,
                            rows: 1,
                            ...
                            children: [g ? (0, s.jsx)(e_, {
                                ...
                                children: (0, s.jsx)(T.default, {
                                    ...
                                    onKeyDown: e => {
                                        ...
                                        _ && "Escape" === e.key && !S.getState().submitting && (null == i || i.blur(), S.getState().setFormOpen(!1), S.getState().setTitleFocused(!1), S.getState().setBodyFocused(!1), S.getState().setPreviewing(!1))
                                    },
            ...
            function eA(e) {
                let {
                    ...
                    containerRef: f,
                    containerWidth: g
                } = (0, ei.default)(), x = n.useRef(null), [C, _] = n.useState(!0), T = (0, $.useVisibleForumTags)(t), [S, p] = n.useState(0);
                    ...
                    children: (0, s.jsxs)("div", {
                        ...
                        children: [(0, s.jsx)(K.default, {
                                ...
                                children: (0, s.jsx)(d.ListNavigatorContainer, {
                                    children: e => {
                                        ...
                                        return (0, s.jsx)("div", {
                                            ...
                                            ref: t,
                                            ...n,
                                            children: T.map(e => (0, s.jsx)(el.default, {
                            ...
                            children: e => (0, s.jsxs)(h.Button, {
                                ...
                                children: [ec.default.Messages.FORUM_TAG_SEE_MORE_A11Y_LABEL, (0, s.jsx)(w.default, {
                                    width: 16
                                })]
                            })
                        }), (0, s.jsxs)(h.Button, {
        ...
        592633: function(e, t, a) {
            ...
            function z(e) {
                let {
                    ...
                    observePostVisibilityAnalytics: C
                } = e, E = (0, o.useStateFromStores)([S.default], () => S.default.getChannel(a.parent_id)), N = a.id, M = n.useRef(null), A = (0, o.useStateFromStores)([T.default], () => T.default.getCurrentSidebarChannelId(a.parent_id) === a.id), {
                    firstMessage: v,
                    loaded: F
            ...
            let K = e => e.preventDefault(),
                ...
                X = n.memo(function(e) {
                    let {
                        ...
                        containerWidth: l,
                        containerHeight: i
                    }), T = (0, h.useShouldRedactExplicitContentForForum)(), S = n.useMemo(() => x.map((e, t) => {
                        var n;
        ...
        193695: function(e, t, a) {
            ...
            var eR = n.memo(function(e) {
                ...
                return (0, s.jsxs)("div", {
                    ...
                    children: [(0, s.jsx)(x.Clickable, {
                        ...
                        }), T ? (null == C ? void 0 : C.blocked) || null == S ? null : (0, s.jsx)(eH, {
                            channel: d,
                            firstMedia: S,
                            firstMessage: C,
                            isEmbed: p,
            ...
            function eL(e) {
                let {
                    ...
                    hasUnreads: c
                } = (0, es.useForumPostReadStates)(a), m = (0, f.useStateFromStores)([et.default], () => et.default.getFirstNoReplyThreadId()), h = (0, U.useIsNonModInLockedThread)(a), g = (0, I.useNullableMessageAuthor)(u);
                if (n > 0) {
                    var C, _;
                    return (0, s.jsxs)(x.Clickable, {
                        onClick: e => {
                            ...
                            }), e.shiftKey ? (0, P.transitionToThreadMessage)(a, u.id, eT.OpenThreadAnalyticsLocations.BROWSER) : y.default.openThreadAsSidebar({
                                guildId: a.guild_id,
                                channelId: a.id,
                        ...
                        children: [(0, s.jsxs)(x.HiddenVisually, {
                            children: ["Latest message:", null != g ? null !== (C = g.nick) && void 0 !== C ? C : ep.default.Messages.UNKNOWN_USER : null, " ", null == (_ = null == u ? void 0 : u.content) ? "" : _.length > 120 ? "".concat(_.substring(0, 120), "...") : _]
                ...
                return h ? (0, s.jsx)("div", {
                    ...
                    "aria-hidden": !0,
                    className: eE.replies,
                    children: o.length > 0 ? (0, s.jsx)(eb, {
                        channel: a,
                        typingUserIds: o,
                        facepileRef: i
                    }) : (0, s.jsx)(ej, {
            ...
            function eP(e) {
                let {
                    ...
                    let t = (0, f.useStateFromStores)([er.default], () => er.default.getHasSearchResults(e.parent_id)),
                        ...
                        s = n.useMemo(() => (0, T.createASTHighlighter)(t && null != a ? a : ""), [t, a]),
            ...
            let ey = n.memo(function(e) {
                ...
                let {
                    ...
                    mostRecentMessage: l,
                    hasUnreads: i
                } = e, o = (0, I.useNullableMessageAuthor)(l), u = (0, f.useStateFromStores)([V.default], () => null != l && V.default.isBlocked(l.author.id)), d = (0, f.useStateFromStores)([B.default], () => B.default.can(eC.Permissions.MANAGE_MESSAGES, a)), c = w.RenderSpoilers.useSetting(), m = (0, eo.useIsRecentMessageDeleted)(a), {
                    content: h
                ...
                let _ = null != o ? null !== (t = o.nick) && void 0 !== t ? t : ep.default.Messages.UNKNOWN_USER : null,
                    T = (0, b.useUsernameHook)(null == l ? void 0 : l.author, a.id, a.guild_id, !0)(null != o ? o : void 0)((0, s.jsxs)(s.Fragment, {
            ...
            function eD(e) {
                let {
                    ...
                    ref: g,
                    width: x
                } = (0, _.default)(), [C, T] = n.useState(10), [S, p] = n.useState(!0);
                return n.useEffect(() => {
                    ...
                    ref: g,
                    children: [h && null != i ? (0, s.jsx)(L.Reaction, {
            ...
            function ek(e) {
                let {
                    ...
                    isNew: n,
                    containsTags: l
                } = e, r = t.hasFlag(e_.ChannelFlags.PINNED), i = (0, f.useStateFromStores)([V.default], () => null != a && V.default.isBlocked(a.author.id));
                return (0, s.jsxs)("div", {
                    className: eE.header,
            ...
            function eH(e) {
                let {
                    ...
                    isEmbed: l,
                    contentHeight: i
                } = e, o = (0, f.useStateFromStores)([z.default], () => z.default.isFocused()), u = (0, p.isAnimatedImageUrl)(a.src), d = w.GifAutoPlay.useSetting(), {
                    src: c,
                    width: m,
                    height: h,
                    alt: g
                } = a, [C, _] = (0, E.useShouldObscure)({
                    media: a,
                    channel: t
                }), T = (0, E.getObscuredAlt)(_);
                return (0, s.jsx)(x.FocusBlock, {
                    enabled: !0,
                    children: (0, s.jsxs)("div", {

    ...
    [32632, 89005, 29202, 91683, 58635], {
        ...
        980604: (e, t, n) => {
            ...
            var V, x = "seenQSTutorial",
                F = [l.h8.USER, l.h8.GROUP_DM, l.h8.TEXT_CHANNEL, l.h8.GUILD, l.h8.APPLICATION, l.h8.LINK],
                G = 0,
                k = !1,
                W = !1,
                Q = null,
            ...
            function X() {
                W = I.Z.getGuildCount() >= 3 || o().size(f.Z.getMutablePrivateChannels()) >= 20;
                B = []
            }
            ...
            function J() {
                var e, t, n = null !== (e = P.Z.getGuildId()) && void 0 !== e ? e : void 0,
                ...
                for (var u = [], c = [], a = 1; a < Y.length; a += 1) {
                    var s = $(Y[a]);
                ...
                if (null != n) {
                    var m = E.ZP.getSelectableChannelIds(n).filter((function(e) {
                        ...
                        return !(null == t || e === r || Y.includes(e) || j.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && j.Z.isChannelMuted(t.guild_id, t.parent_id)) && w.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return $(e)
                    })).filter((function(e) {
                        return e
            ...
            function ee(e, t) {
                switch (Q) {
                    case l.h8.USER:
                        var n = I.Z.getGuild(P.Z.getGuildId());
                ...
                if (t !== z) {
                    ...
                    G = (0, l.gJ)(l.a8.DOWN, -1, q)
                } else {
                    var r = q[G];
                    null != r && r.type === l.h8.HEADER && (G = (0, l.gJ)(l.a8.DOWN, G, q))
                }
                ie.emitChange()
            }
            ...
            function te(e) {
                var t, n = e.query,
                    r = e.queryMode,
                    o = (0,
                        h.O7)() ? void 0 : null !== (t = P.Z.getGuildId()) && void 0 !== t ? t : void 0,
                    i = new Set(["user:".concat(O.default.getId())]);
                null != o && i.add("guild:".concat(o));
                V = null != V ? V : new l.ZP(ne, F, null != r ? 100 : 5, {
                    frecencyBoosters: !0,
                    blacklist: i
                });
                z = null;
            ...
            var oe = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    k = u.Z.get(x) || !1;
                    var t;
                    Y = null !== (t = null == e ? void 0 : e.channelHistory) && void 0 !== t ? t : []
                };
                r.getState = function() {
                    return {
                        channelHistory: Y
            ...
            oe.displayName = "QuickSwitcherStore";
            oe.persistKey = "QuickSwitcherStore";
            var ie = new oe(c.Z, {
                CONNECTION_OPEN: X,
                ...
                QUICKSWITCHER_SEARCH: function(e) {
                    var t, n = e.query,
                        r = e.queryMode;
                    if (null == V) return !1;
                    var o = null !== (t = P.Z.getGuildId()) && void 0 !== t ? t : null;
                    if (Q !== r) {
                        V.setResultTypes(null != r ? [r] : F);
                        V.setLimit(null != r ? 100 : 5);
                        var i, u = null !== (i = P.Z.getGuildId()) && void 0 !== i ? i : void 0;
                    ...
                    Q = r;
                    V.search(n, Q === l.h8.USER ? o : void 0)
                },
        ...
        796909: (e, t, n) => {
            ...
            function A() {
                ...
                (0, l.cn)() && (0, a.x7)() && v.Z.getAddedToMessages().forEach((function(e) {
                    ...
                    null != t && (0, d.zi)(t.type) && j.set(t.id, T(t))
                }))
            }

            function N() {
                var e = p.Z.getMutablePrivateChannels();
                for (var t in e) j.set(t, T(e[t]))
            }
            var R, Z, L, D = (R = [], Z = [], L = [], function() {
                    var e = j.values(w.FAVORITE),
                        t = j.values(w.DEFAULT);
                    if (R !== e || Z !== t) {
                        L = [];
                ...
                U = function(e) {
                    ...
                    r.getSortedChannels = function() {
                        return [j.values(w.FAVORITE), j.values(w.DEFAULT)]
                    };
                    r.serializeForOverlay = function() {
                        var e = {};
                        j.values().forEach((function(t) {
                            var n = t.channelId,
                                r = t.lastMessageId;
                            e[n] = r
                        }));
            ...
            const H = new U(c.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, d.hv)(e.type) || j.has(e.id)) && j.set(e.id, T(e))
                    }))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && j.set(t, T(r, n.id))
                },

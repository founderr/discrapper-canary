        ...
        374278: function(e, t, n) {
            ...
            function E(e) {
                ...
                let n, {
                    ...
                    L = T ? g < p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED : (null == M ? void 0 : M.premiumTier) !== p.BoostedGuildTiers.TIER_3 && g <= p.MAX_STAGE_VIDEO_USER_LIMIT_TIER2,
                    A = a.default.can(h.MODERATE_STAGE_CHANNEL_PERMISSIONS, E);
                n = T && (null == M ? void 0 : M.premiumTier) === p.BoostedGuildTiers.TIER_3 ? g <= p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED ? C.default.Messages.STAGE_FULL_BOOST_MORE_BODY : C.default.Messages.STAGE_FULL_MAX_BODY : L ? C.default.Messages.STAGE_FULL_BODY : C.default.Messages.STAGE_FULL_MAX_BODY;
                let N = () => {

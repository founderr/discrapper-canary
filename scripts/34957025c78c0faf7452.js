(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [68455, 70054, 67145, 96043, 71402], {
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = o(e),
                    ...
                    E = d.length;
                for (var O in e) !t && !c.call(e, O) || p && ("length" == O || f && ("offset" == O || "parent" == O) || _ && ("buffer" == O || "byteLength" == O || "byteOffset" == O) || l(O, E)) || d.push(O);
                return d
            }
        },
        70151: (e, t, n) => {
        ...
        625091: (e, t, n) => {
                    ...
                    if (s !== b.evJ.EXPLICIT_CONTENT)
                        if (s !== b.evJ.AUTOMOD_MESSAGE_BLOCKED) {
                            if (s !== b.evJ.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS) {
                                ...
                                ! function() {
                                    "" !== N.content && "" === y.Z.getDraft(t, r) && o.Z.saveDraft(t, N.content, r);
            ...
            const C = {
                ...
                upload: function e(t) {
                    ...
                    var E = new _.Z(b.ANM.MESSAGES(n));
                    ...
                    E.on("error", (function(t, _) {
                        ...
                        if (_ !== b.evJ.EXPLICIT_CONTENT) {
                            ...
                            "" !== f.content && "" === y.Z.getDraft(n, c) && o.Z.saveDraft(n, f.content, c)
                ...
                cancel: function(e) {
                    ...
                    if (null != e.draftContent && null != e.channelId) {
                        "" === y.Z.getDraft(e.channelId, y.d.ChannelMessage) && i.Z.dispatch({
                            type: "DRAFT_SAVE",
            ...
            function w(e) {
                ...
                if (!y.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== b.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = u.Z.getChannel(o),
                        l = M(a, i),
                        c = A({}, t, R(l), null != i && null != o && (0, v.AB)(o) ? P(0, o) : C(a));
                    y.default.track(e, c, {
                        flush: n
                    })
                }
            ...
            var r = n(318715),
                ...
                f = function() {
                    var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
                        ...
                        E = _.collectEnabled,
                        O = p && E && null != i && !1 !== (null == i || null === (e = i.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible);
                    return {
                        viewAndUseEnabled: p,
                        collectEnabled: O,
        ...
        159895: (e, t, n) => {
            ...
            function y(e) {
                var t;
                return O(t = {}, I, e.non_subscriber), O(t, _.Si.TIER_0, e[_.Si.TIER_0]), O(t, _.Si.TIER_2, e[_.Si.TIER_2]), t
            }
            ...
            function b(e, t, n, r) {
                if (null != e && !(0,
                    ...
                    if (r) {
                        c.Z.isLoadedForSKU(_.Si.TIER_0) || c.Z.isFetchingForSKU(_.Si.TIER_0) || (0, l.GZ)(_.Si.TIER_0);
                        c.Z.isLoadedForSKU(_.Si.TIER_2) || c.Z.isFetchingForSKU(_.Si.TIER_2) || (0, l.GZ)(_.Si.TIER_2)
                    }
                }
            }
        },
        ...
        442212: (e, t, n) => {
            ...
            function v(e) {
                ...
                var ee, te = B ? a()(y().artContainer, y().artContainerBoxShadow, N) : a()(y().artContainer, N),
                    ne = null;
        ...
        15084: (e, t, n) => {
            ...
            function y(e, t) {
                var n = f.default.getCurrentUser(),
                    ...
                    m = void 0;
                try {
                    for (var b, v = t[Symbol.iterator](); !(y = (b = v.next()).done); y = !0) {
                        var S = b.value;
                        s += 1;
                        l += S.size;
                        o.push(S.size);

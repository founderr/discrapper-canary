(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [24285, 29202, 91683, 58635, 84832, 88110, 86502, 96043, 53686, 71402], {
        ...
        980604: (e, t, n) => {
            ...
            function X() {
                B = T.Z.getGuildCount() >= 3 || i().size(s.Z.getMutablePrivateChannels()) >= 20;
                z = []
            }
            ...
            function $() {
                ...
                if (null != n) {
                    var g = y.ZP.getSelectableChannelIds(n).filter((function(e) {
                        ...
                        return !(null == t || e === r || Q.includes(e) || P.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && P.Z.isChannelMuted(t.guild_id, t.parent_id)) && S.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return J(e)
                    })).filter((function(e) {
                        return e

    ...
    [64991], {
        464991: (e, n, t) => {
            ...
            function Y(e) {
                ...
                var D, j = (0, l.cj)([v.Z], (function() {
                        var e = v.Z.get(i.planId);
                        return {
                            premiumSubscriptionPlan: e,
                            premiumGuildPlan: null != e ? v.Z.getForSkuAndInterval(P.Si.GUILD, e.interval, e.intervalCount) : null
                        }
                    })),
                    ...
                    F = null != G ? (0, O.Zx)(i, null !== (D = null === (n = M[0]) || void 0 === n ? void 0 : n.quantity) && void 0 !== D ? D : 0, G.id) : null,
                    V = U((0, f.ED)({
                        subscriptionId: i.id,
                        items: F,
                        renewal: !0,
            ...
            function V(e) {
                var n = e.guildBoostSlot,
                    ...
                    i = e.onClose;
                a.useEffect((function() {
                    N.Z.hasFetchedSubscriptions() || (0, u.jg)()
                }), []);
                var o, c = (0, l.e7)([N.Z], (function() {
                        return N.Z.getPremiumTypeSubscription()
                    })),
                    f = U(a.useState(j.START), 2),
                    p = f[0],
                    E = f[1],
        ...
        646875: (e, n, t) => {
            ...
            function Z(e) {
                    ...
                    N = function(e, n, t, r) {
                        ...
                        switch (e.subscriptionPlanId) {
                            ...
                            case b.Xh.PREMIUM_6_MONTH_GUILD:
                                return L.Z.Messages.PREMIUM_GUILD_NUM_MULTI_MONTHS_GUILD_SUBSCRIPTIONS.format({
                                    num: e.quantity,
                                    intervalCount: n.intervalCount
                                });
                            case b.Xh.PREMIUM_MONTH_GUILD:
                                return L.Z.Messages.PREMIUM_GUILD_NUM_MONTH_GUILD_SUBSCRIPTIONS.format({
                                    num: e.quantity
                                });
                            case b.Xh.PREMIUM_YEAR_GUILD:
                                return L.Z.Messages.PREMIUM_GUILD_NUM_YEAR_GUILD_SUBSCRIPTIONS.format({
                                    num: e.quantity
                                })
                        }
                        switch (n.interval) {
                            case b.rV.MONTH:
                                return 1 === n.intervalCount ? L.Z.Messages.MONTHLY_GUILD_SUBSCRIPTION.format({
                                    planName: n.name
                                }) : L.Z.Messages.MULTI_MONTHS_GUILD_SUBSCRIPTION.format({
                                    planName: n.name,
                                    intervalCount: n.intervalCount
                                });
                            case b.rV.YEAR:
                                return L.Z.Messages.YEARLY_GUILD_SUBSCRIPTION.format({
                                    planName: n.name
                                })
                        }
                ...
                !0 === i && (N = (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        text: L.Z.Messages.PREMIUM_SUBSCRIPTION_GUILD_SUBSCRIPTION_ADJUSTMENT_TOOLTIP.format(),
                        "aria-label": L.Z.Messages.PREMIUM_SUBSCRIPTION_GUILD_SUBSCRIPTION_ADJUSTMENT_TEXT,
                        tooltipClassName: M().invoiceItemTooltip,
                        children: function(e) {
                            return (0, r.jsx)(_.Z, x(D({}, e), {
                                className: M().invoiceItemLabelIcon
                            }))
                        }
                    })]
                }));
                var y = (0, v.T4)(null != a ? a : t.amount, o),
                    R = I ? y : (0, v.og)(y, p.interval, p.intervalCount);
                return (0, r.jsx)(O.i$, {
                    label: N,
                    value: R,
            ...
            function G(e) {
                var n = e.invoice,
                    ...
                    s = null != o ? o.amount : 0,
                    c = (0, v.T4)(s, n.currency),
                    d = null != l ? (0, v.og)(c, l.interval, l.intervalCount) : 0;
                return (0, r.jsxs)(r.Fragment, {
                    children: [null != i ? (0, r.jsx)(Z, {
                        ...
                        label: L.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_INVOICE_ROW_CONTENT.format({
                        ...
                        label: (n.taxInclusive ? t ? L.Z.Messages.BILLING_INVOICE_TOTAL_TAX_INCLUSIVE : L.Z.Messages.BILLING_INVOICE_TODAY_TOTAL_TAX_INCLUSIVE : L.Z.Messages.BILLING_INVOICE_TODAY_TOTAL).format(),
                        value: n.currency === P.pKx.USD ? (0, v.T4)(n.total, n.currency) : "".concat((0, v.T4)(n.total, n.currency), "*")
                    })]
                })
            }
            ...
            function w(e) {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(Z, {
                        ...
                        label: (0, r.jsx)(B, {
                            label: L.Z.Messages.PREMIUM_SUBSCRIPTION_PLAN_ADJUSTMENT.format({
                                planName: (0, T.PV)(t.id) ? (0, T.aq)(t.id) : t.name
                            }),
                            tooltipText: L.Z.Messages.PREMIUM_SUBSCRIPTION_ADJUSTMENT_TOOLTIP
                        }),
                        value: (0, v.T4)(p, n.currency)
                    }), 0 !== E ? (0, r.jsx)(O.R$, {
                        label: (0, r.jsx)(B, {
                            label: L.Z.Messages.PREMIUM_SUBSCRIPTION_GUILD_SUBSCRIPTION_ADJUSTMENT,
                            tooltipText: L.Z.Messages.PREMIUM_SUBSCRIPTION_GUILD_SUBSCRIPTION_ADJUSTMENT_TOOLTIP.format(),
                            tooltipAriaLabel: L.Z.Messages.PREMIUM_SUBSCRIPTION_GUILD_SUBSCRIPTION_ADJUSTMENT_TEXT
                        }),
                        value: (0, v.T4)(E, n.currency)
                    }) : null, (0, r.jsx)(R.Z, {
                        invoice: n
                    }), (0, r.jsx)(O.KU, {}), (0, r.jsx)(O.Ji, {
                        label: (n.taxInclusive ? a ? L.Z.Messages.BILLING_INVOICE_TOTAL_TAX_INCLUSIVE : L.Z.Messages.BILLING_INVOICE_TODAY_TOTAL_TAX_INCLUSIVE : L.Z.Messages.BILLING_INVOICE_TODAY_TOTAL).format(),
                        value: n.currency === P.pKx.USD ? (0, v.T4)(n.total, n.currency) : "".concat((0, v.T4)(n.total, n.currency), "*")
                    })]
                })
            }
            ...
            function F(e) {
                ...
                return i !== s || o !== u || n.subscriptionPeriodEnd.getTime() === t.subscriptionPeriodStart.getTime() ? null : (0, r.jsx)("div", {
                    ...
                    children: L.Z.Messages.PREMIUM_SUBSCRIPTION_PERIOD_RESET_NOTICE.format({
            ...
            function V(e) {
                var n = e.isUpdate,
                    t = e.currentInvoice,
                    a = e.newInvoice,
                    i = null != t ? (0, y.j)(t.invoiceItems) : null,
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(O.KU, {
                        ...
                        children: [(0, r.jsx)(O.q9, {
                            children: L.Z.Messages.PREMIUM_SUBSCRIPTION_CURRENT_LABEL
                        }), Y(k((0, y.j)(t.invoiceItems))).map((function(e) {
                            return (0, r.jsx)(Z, {
                                invoiceItem: e,
                                currency: t.currency
                            }, e.id)
                        ...
                        children: L.Z.Messages.PREMIUM_SUBSCRIPTION_NEW_LABEL
                    }), Y(k((0, y.j)(a.invoiceItems))).map((function(e) {
                        ...
                        label: L.Z.Messages.PREMIUM_SUBSCRIPTION_NEW_TOTAL,
                        value: (0, v.og)((0, v.T4)(a.total, a.currency), u, c),
            ...
            function W(e) {
                ...
                if (i) {
                    var E = (0, T.if)({
                        ...
                        m = (null == u ? void 0 : u.interval) === b.rV.DAY && (null == u ? void 0 : u.interval_count) < 28 ? 2 : 7;
                    return (0, r.jsx)(r.Fragment, {
                        children: null != s ? s : L.Z.Messages.PREMIUM_SUBSCRIPTION_RENEWAL_FOOTER_TRIAL_DURATION.format({
                            duration: E,
                            days: m,
                            contactLink: P.EYA.CONTACT,
                            helpdeskArticle: S.Z.getArticleURL(P.BhN.PREMIUM_TRIAL)
                        })
                    })
                }
                var _ = a.taxInclusive ? L.Z.Messages.PREMIUM_SUBSCRIPTION_RENEWAL_FOOTER : L.Z.Messages.PREMIUM_SUBSCRIPTION_RENEWAL_FOOTER_TAX_EXCLUSIVE;
                return (0, r.jsx)(r.Fragment, {
                    children: _.format({
                        rate: (0, v.og)((0, v.T4)(a.subtotal, a.currency), d, I),
                        renewalDate: null != l ? l : o ? null != t ? t.subscriptionPeriodEnd : a.subscriptionPeriodStart : a.subscriptionPeriodEnd,
                        contactLink: P.EYA.CONTACT,
                        helpdeskArticle: S.Z.getArticleURL(P.BhN.BILLING)
                    })
                })
            }
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [S ? null : (0, r.jsx)(O.HE, {
                        ...
                        children: [(0, r.jsxs)(c.Clickable, {
                            ...
                            children: [A ? L.Z.Messages.PREMIUM_SUBSCRIPTION_HIDE_DETAILS : L.Z.Messages.PREMIUM_SUBSCRIPTION_SHOW_DETAILS, (0,
                                r.jsx)(m.Z, {
            ...
            function X(e) {
                ...
                return (0, r.jsx)(O.PO, {
                    ...
                    children: (0, r.jsx)(O.R$, {
                        label: L.Z.Messages.BILLING_INVOICE_GIFT_PLAN.format({
                            planName: (0, T.Gf)(n.id, !1, o)
                        }),
                        value: (0, v.T4)(l.amount, l.currency),
                        className: M().subscriptionCostRow
                    })
                })
            }
            ...
            function q(e) {
                var n = e.invoice,
                    t = e.plan,
                    a = (0, y.j)(n.invoiceItems).find((function(e) {
                        return e.subscriptionPlanId === t.id
                    }));
                s()(null != a, "newPlanInvoiceItem can not be null");
                if (t.interval === b.rV.MONTH) return (0, r.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: L.Z.Messages.BILLING_TRIAL_MONTHLY_PRICE_AFTER_TRIAL.format({
                        price: (0, v.T4)(a.subscriptionPlanPrice, n.currency)
                    })
                });
                if (t.interval === b.rV.YEAR) return (0, r.jsx)(c.Text, {
                    variant: "text-md/normal",
                    children: L.Z.Messages.BILLING_TRIAL_YEARLY_PRICE_AFTER_TRIAL.format({
                        price: (0, v.T4)(a.subscriptionPlanPrice, n.currency)
                    })
                });

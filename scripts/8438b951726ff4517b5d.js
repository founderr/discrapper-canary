...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [45353], {
        ...
        245353: (e, t, n) => {
            ...
            var ne, ie = [M.UX.TOP_GUILD_EMOJI.toString(), M.UX.FAVORITES.toString(), M.UX.RECENT.toString(), M.UX.CUSTOM.toString()].concat(R.ZP.getCategories()),
                re = {
                    pendingUsages: []
                },
                oe = function() {
                    ...
                    t.isUsable = function(e) {
                        ...
                        var t = U.ZP.getMember(this.id, this._userId);
                        if (null == t) return !1;
                            ...
                            try {
                                for (var o, u = t[Symbol.iterator](); !(n = (o = u.next()).done); n = !0) {
                                    var l = Q(o.value, 2),
                                        s = l[0],
                                        c = l[1];
                                    !Object.hasOwn(ce, s) && P.Z.isMember(s) && Se(s, c)
                                }
                            } catch (e) {
                                i = !0;
                                r = e
            ...
            var ve = new c.Z({
                ...
                afterCompute: function() {
                    ...
                    })) || se.splice(ie.indexOf(M.UX.CUSTOM), 1)
                },
            ...
            function _e() {
                ...
                if (r().isEmpty(u) && r().isEmpty(re.pendingUsages) && w.Z.hasLoaded(Z.yP.FRECENCY_AND_FAVORITES_SETTINGS)) {
                    ve.track("thumbsup");
                    ve.track("thumbsup");
                    ve.track("eyes");
                    ve.track("eyes");
            ...
            var Pe = function(e) {
                ...
                i.initialize = function(e) {
                    this.waitFor(d.Z, P.Z, U.ZP, b.Z, _.Z, I.default, j.Z, G.Z, T.default);
                    null != e && (re = e);
                    this.syncWith([w.Z], _e);
                    this.syncWith([_.Z], Ue)
                };
                i.getState = function() {
                    return re
                };
            ...
            Pe.displayName = "EmojiStore";
            Pe.persistKey = "EmojiStoreV2";
            const Ce = new Pe(s.Z, {
                ...
                USER_SETTINGS_PROTO_UPDATE: function(e) {
                    ...
                    if (t !== Z.yP.FRECENCY_AND_FAVORITES_SETTINGS || !n) return !1;
                    re.pendingUsages = []
                },
                ...
                INVENTORY_FETCH_SUCCESS: function(e) {
                    e = null !== e ? e : $(new TypeError("Cannot destructure undefined"));
                    Ue()
                },

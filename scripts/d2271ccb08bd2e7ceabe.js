(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [4909], {
        535169: (e, t, n) => {
            e.exports = n.p + "5656f17248cf747f56433a1d60c8c1bf.svg"
        },
        55146: (e, t, n) => {
        ...
        442830: (e, t, n) => {
            ...
            var A = function(e) {
                ...
                function a(e) {
                    ...
                    var r, o = e.location.search,
                        i = null != o && "" !== o ? (0, s.parse)(o) : {};
                    n.state = {
                        key: null !== (r = i.key) && void 0 !== r ? r : "",
                        stage: "true" === i.done ? T : E
                    };
                    return n
                }
                var o = a.prototype;
                o.componentDidMount = function() {
                    var e = this,
                        ...
                        n = t.stage,
                        r = t.key;
                    n === T ? R() : u.default.isAuthenticated() ? i.ZP.post({
                        url: m.ANM.HANDOFF,
                        body: {
                            key: r
                        },
                        ...
                        return e.handoff(t.body.handoff_token)
                    }), (function() {
                        return e.handoff()
                    })) : this.handoff()
                };
                o.handoff = function(e) {
                    c.default.requestRedirect(m.Etm.BROWSER_HANDOFF, {
                        handoffToken: e,
                        fingerprint: u.default.getFingerprint()
                    }).then(this.done, this.failed)
                };
                o.renderDone = function() {
                    return (0, r.jsxs)(f.ZP, {
                        children: [(0, r.jsx)(f.Ee, {
                            ...
                            children: p.Z.Messages.BROWSER_HANDOFF_DONE_TITLE
                        }), (0, r.jsx)(f.DK, {
                            className: b().marginBottom40,
                            children: p.Z.Messages.BROWSER_HANDOFF_DONE_SAFE_TO_CLOSE
                        }), (0, r.jsx)(f.zx, {
                ...
                o.renderFailed = function() {
                    return (0, r.jsxs)(f.ZP, {
                        children: [(0, r.jsx)(f.Ee, {
                            ...
                            className: b().marginBottom8,
                            children: p.Z.Messages.BROWSER_HANDOFF_FAILED_TITLE
                        }), (0, r.jsx)(f.DK, {
                            className: b().marginBottom40,
                            children: p.Z.Messages.BROWSER_HANDOFF_DONE_SAFE_TO_CLOSE
                        }), (0, r.jsx)(f.zx, {
                ...
                o.renderHandoff = function() {
                    return (0, r.jsxs)(f.ZP, {
                        children: [(0, r.jsx)(f.Hh, {}), (0, r.jsx)(f.Dx, {
                            className: b().marginBottom8,
                            children: p.Z.Messages.BROWSER_HANDOFF_AUTHENTICATING_TITLE
                        }), (0, r.jsx)(f.DK, {
                            children: p.Z.Messages.BROWSER_HANDOFF_AUTHENTICATING_DESCRIPTION
                        })]
                    })
                };
                o.render = function() {
        ...
        621647: (e, t, n) => {
            ...
            function l(e) {
                ...
                switch (e.type) {
                    case o.d4z.DM:
                        var i = c(e.recipients.map(r.default.getUser).filter(s.lm), 1),
                            l = i[0];
        ...
        558820: (e, t, n) => {
            ...
            var j = function(e) {
                ...
                E = function(e) {
                    ...
                    return (0, r.jsx)("img", {
                        alt: "",
                        src: n,
                        className: s()(b().image, t)
                    })
                },
                T = function(e) {
                    var t, n = e.className,
                        a = g(e, ["className"]),
                        i = a.look === o.Button.Looks.LINK;
                    return (0, r.jsx)(o.Button, function(e) {
                        ...
                        fullWidth: !i,
                        className: s()(n, (t = {}, N(t, b().button, !i), N(t, b().linkButton, i), t))
                    }, a))
                };
            T.Looks = o.Button.Looks;
            T.Colors = o.Button.Colors;
            T.Sizes = o.Button.Sizes;
            var _ = function(e) {
                    var t = e.className,
                        n = e.src,
                        a = e.size;
                    return (0, r.jsx)(y, {
                        src: n,
                        size: a,
                        className: s()(b().inviteLargeIcon, t),
                        "aria-hidden": !0
                    })
                },
                R = function(e) {
            ...
            var A = function(e) {
                ...
                return (0, r.jsx)(y, {
                    src: (0, i.x)(n),
                    size: a,
                    className: s()(b().inviteIcon, t),
                    "aria-hidden": !0
                })
            };
            A.Sizes = o.AvatarSizes;
            var I = function(e) {
                    var t = e.label,
                        n = e.error,
                        a = e.placeholder,
                    ...
                    return (0, r.jsxs)(o.FormItem, {
                        ...
                        children: [(0, r.jsx)(o.TextInput, {
                            ...
                            inputRef: d,
                            placeholder: a,
                            inputClassName: s()(l, N({}, b().inputError, null != n)),
                            "aria-label": t,
                            onChange: p,
                            autoComplete: h,
                            autoFocus: v,
                ...
                B = function(e) {
                    ...
                    null != n && n > 0 && (t = (0, r.jsxs)("div", {
                        className: s()(b().pill, b().pillOnline, l && b().pillFlat),
                        children: [(0, r.jsx)("i", {
                            className: b().pillIconOnline
                        }), (0, r.jsx)(o.Text, {
                            tag: "span",
                            className: s()(b().pillMessage, u),
                    ...
                    return (0, r.jsxs)(c.Z, {
                        ...
                        children: [t, (0, r.jsxs)("div", {
                            className: s()(b().pill, l && b().pillFlat),
                            children: [(0, r.jsx)("i", {
                    ...
                    return (0, r.jsxs)(S, {
                        ...
                        children: [(0, r.jsx)(T, {
                            ...
                            children: v.Z.Messages.INCOMPATIBLE_BROWSER.format({
                                supportedBrowserURL: m.Z.getArticleURL(h.BhN.SUPPORTED_BROWSERS)
                            })
                        })]
                    })
                };
            const P = function(e) {
                ...
                return (0, r.jsxs)(o, {
                    onSubmit: i,
                    style: m,
                    className: s()(u ? b().authBoxExpanded : b().authBox, (0, p.Q)(f), t),
                    children: [(0, r.jsx)("div", {
                        className: b().discordLogo
                    }), (0, r.jsx)("div", {
                        className: s()(b().centeringWrapper, n),
                        children: c
                    })]
                })
            }
        ...
        408481: (e, t, n) => {
            ...
            function z(e) {
                ...
                if (O > 52 || -1 === O) {
                    E.unshift((0, r.jsx)("source", {
                        src: g,
                        type: "video/webm"
                    }, "webm"));
                    _.unshift((0, r.jsx)("source", {
                        src: j,
                        type: "video/webm"
                    }, "webm"))
                }
                ...
                return M(t = {}, N.BRd.DARK, E), M(t, N.BRd.LIGHT, _), t
            }
            var U = o()("5/13/2022 10:00 -0800").valueOf(),
                ...
                K = o()("11/3/2022 11:00 -0800").valueOf(),
                V = z({
                    webmDark: Z(),
                    webmLight: k(),
                    movDark: h(),
            ...
            const J = function(e) {
                var t = e.loop,
                    ...
                    u = e.className,
                    d = e.onReady,
                    f = (0, c.useThemeContext)().theme,
                    m = a.useContext(c.AccessibilityPreferencesContext).reducedMotion,
                    p = Date.now(),
                    h = q;
                p >= U && p <= H ? h = W : p >= G && p <= K && (h = V);
                var v, x = null !== (v = h[(0, i.wj)(f) ? N.BRd.DARK : N.BRd.LIGHT]) && void 0 !== v ? v : h[N.BRd.DARK];
                return (0, r.jsx)(b.Z, {
                    ref: l,
                    onLoadedData: d,
                    className: u,
...
//# sourceMappingURL=d2271ccb08bd2e7ceabe.js.map
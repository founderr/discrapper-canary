    ...
    ["55039"], {
        230947: function(e, t, l) {
            ...
            function A(e) {
                ...
                let v = T === M.AppContext.POPOUT,
                    b = (0, i.default)({
                        guild: N,
                        analyticsLocation: g
                    });
                if (null == N || v) return null;
                let h = I === A && (E.default.can(M.Permissions.CHANGE_NICKNAME, N) || E.default.can(M.Permissions.MANAGE_NICKNAMES, N)),
                    F = I === A,
        ...
        726750: function(e, t, l) {
            ...
            function M(e) {
                ...
                let l = (0, E.default)(),
                    ...
                    R = (0, c.default)(),
                    T = (0, a.useStateFromStores)([f.default], () => f.default.getPermissionsForUser(e.id, M), [M, e.id]),
        ...
        459870: function(e, t, l) {
            ...
            function C(e, t) {
                let l = (0, a.useStateFromStores)([f.default], () => f.default.getChannels(t)[f.GUILD_VOCAL_CHANNELS_KEY], [t]),
                    C = (0, a.useStateFromStores)([m.default, o.default], () => {
                ...
                if (!I && !_.default.can(R.Permissions.MOVE_MEMBERS, C)) return null;
                let O = l.filter(t => {
                    let {
                        channel: l
                    } = t;
                    return l.id !== C.id && (I ? _.default.can(R.Permissions.CONNECT, l) && !(0, A.isChannelFull)(l, m.default, E.default) : _.default.can(R.Permissions.MOVE_MEMBERS, l) && (_.default.can(R.Permissions.CONNECT, l) || g.default.can({
        ...
        97508: function(e, t, l) {
            ...
            function A(e, t) {
                ...
                if (__OVERLAY__ || null == R || null == S || !T) return null;

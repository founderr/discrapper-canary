        ...
        359891: (e, t, n) => {
                ...
                Z = function(e) {
                    ...
                    return (0, r.jsxs)(a.ModalFooter, {
                        ...
                        children: [s(), (0, r.jsx)(a.Button, {
                            ...
                            onClick: c ? i : u,
                            children: c ? M.Z.Messages.NEXT : M.Z.Messages.PAYMENT_SOURCE_CONNECT_TO_PAYPAL
                        })]
                    })
                },
                U = n(19120),
            ...
            var Q = function(e) {
                    var t = e.legalNotice,
                        ...
                        O = [],
                        b = null != s ? n[s] : null;
                    null != b && b.invalid && O.push((0, r.jsx)(U.Z, {
                        icon: F.Z,
                ...
                q = function(e) {
                    ...
                    return (0, r.jsxs)(a.ModalFooter, {
                        ...
                        children: [s(), (0, r.jsx)(a.Button, {
                            ...
                            color: c ? a.Button.Colors.BRAND : a.Button.Colors.PRIMARY,
                            onClick: c ? i : u,
                            children: c ? M.Z.Messages.NEXT : M.Z.Messages.PAYMENT_SOURCE_CONNECT_TO_VENMO
                        })]
                    })
                },
                J = n(2590),
            ...
            var pe = function(e, t) {
                ...
                ye = [b.Rg.PAYMENT_TYPE, b.Rg.CREDIT_CARD_INFORMATION, b.Rg.REVIEW],
                he = [b.Rg.PAYMENT_TYPE, b.Rg.CREDIT_CARD_INFORMATION, b.Rg.ADDRESS, b.Rg.REVIEW],
                Oe = [b.Rg.PAYMENT_TYPE, b.Rg.PAYPAL, b.Rg.PAYPAL_ADDRESS, b.Rg.REVIEW],
                be = [b.Rg.PAYMENT_TYPE, b.Rg.PAYMENT_REQUEST_INFO, b.Rg.REVIEW],
                Ee = [b.Rg.PAYMENT_TYPE, b.Rg.ADDRESS, b.Rg.REVIEW],
                Se = [b.Rg.PAYMENT_TYPE, b.Rg.ADDRESS, b.Rg.REVIEW],
                _e = [b.Rg.PAYMENT_TYPE, b.Rg.VENMO, b.Rg.VENMO_ADDRESS, b.Rg.REVIEW],
                    ...
                    function n() {
                        ...
                        e.handleStripePaymentRequestAdd = (u = ne((function(e) {
                            ...
                            return pe(this, (function(n) {
                                switch (n.label) {
                                    ...
                                    case 2:
                                        t = n.sent();
                                        c.props.onPaymentSourceAdd(t.id);
                                        return [3, 4];
                                    case 3:
                                        n.sent();
                                        return [3, 4];
                        ...
                        e.handleVenmoAdd = ne((function() {
                            ...
                            return pe(this, (function(i) {
                                switch (i.label) {
                                    case 0:
                                        e = y.props, t = e.venmoUsername, n = e.braintreeNonce, r = e.billingAddressInfo;
                                        if (0 === t.length || null == n) return [2];
                                        i.label = 1;
                                    case 1:
                                        i.trys.push([1, 3, , 4]);
                                    ...
                                    case 2:
                                        o = i.sent();
                                        y.props.onPaymentSourceAdd(o.id);
                                        return [3, 4];
                                    case 3:
                                        i.sent();
                                        return [3, 4];
                        ...
                        e.renderBackButton = function() {
                            var t = e.props,
                                ...
                                s = (0, b.Yp)(n, o),
                                c = (0,
                                    b.NW)(s, i) ? M.Z.Messages.BACK : M.Z.Messages.CANCEL;
                        ...
                        e.stepRenderer = ae((ie(f = {}, b.Rg.PAYMENT_TYPE, {
                            renderBody: function() {
                                var t = e.props,
                        ...
                        }), ie(f, b.Rg.PAYMENT_REQUEST_INFO, {
                            renderBody: function() {
                                return (0, r.jsx)(j.k, {
                        ...
                        }), ie(f, b.Rg.CREDIT_CARD_INFORMATION, {
                            renderBody: function() {
                            ...
                            renderBody: J.VqG,
                            renderFooter: J.VqG
                        }), ie(f, b.Rg.AWAITING_AUTHENTICATION, {
                            renderBody: function() {
            ...
            const ve = u.ZP.connectStores([O.Z, y.Z, m.Z, g.Z, v.Z], (function() {
                return {
                    submitting: m.Z.isBusy,
                    paymentSources: O.Z.paymentSources,
                    defaultPaymentSourceId: O.Z.defaultPaymentSourceId,
                    stripePaymentMethod: y.Z.stripePaymentMethod,
                    creditCardInfo: y.Z.getCreditCardInfo(),
                    isCardInfoValid: y.Z.isCardInfoValid,
                    billingAddressInfo: y.Z.getBillingAddressInfo(),
                    isBillingAddressInfoValid: y.Z.isBillingAddressInfoValid,
                    braintreeEmail: y.Z.braintreeEmail,
                    braintreeNonce: y.Z.braintreeNonce,
                    venmoUsername: y.Z.venmoUsername,
                    billingError: y.Z.error,
                    paypalClient: v.Z.getPayPalClient(),
                    venmoClient: v.Z.getVenmoClient(),
                ...
                Fe = function(e) {
                    ...
                    function n(e) {
                        ...
                        var i = e.defaultPaymentSourceId,
                            ...
                            c = a;
                        null == c && (c = s ? b.Rg.REVIEW : b.Rg.PAYMENT_TYPE);
                        r.state = {
                            paymentSourceId: i,
                            steps: s ? de : ye,
                            step: c,
            ...
            const Ge = o.forwardRef((function(e, t) {
                var n = Me((0, u.Wu)([O.Z], (function() {
                        return [O.Z.paymentSources, O.Z.defaultPaymentSourceId]
                    })), 2),
                    o = n[0],
                    i = n[1],
                    a = (0, u.e7)([y.Z], (function() {
                        return y.Z.error
                    })),
                    s = Me((0, u.Wu)([h.Z], (function() {
                        return [h.Z.error, h.Z.isAwaitingAuthentication]
                    })), 2),
                    c = s[0],
                    l = s[1];
                return (0, r.jsx)(Fe, we(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            var Rt = function(e) {
                    ...
                    function n() {
                        ...
                        var u, s = lt(e);
                        e.handlePurchase = (u = pt((function(e) {
                            var t, n, r, o, i, u, a;
                            return At(this, (function(f) {
                                switch (f.label) {
                                    ...
                                    case 1:
                                        f.trys.push([1, 3, , 4]);
                                        et.default.track(J.rMx.PAYMENT_FLOW_COMPLETED, St(Et({}, s.getBaseAnalyticsData()), {
                                            duration_ms: Date.now() - s._flowStartTime
                                        }));
                                        return [4, l.ZZ(n, r.id, {
                                            expectedAmount: i,
                                            expectedCurrency: u,
                                            paymentSource: e,
                                    ...
                                    case 3:
                                        a = f.sent();
                                        et.default.track(J.rMx.PAYMENT_FLOW_FAILED, St(Et({}, s.getBaseAnalyticsData()), {
                        ...
                        e.renderHeader = function(t, n, o) {
                            ...
                            return t === b.Rg.CONFIRM ? null != i ? (0, r.jsx)(He.Z, {
                                application: i,
                                splashSize: 880
                    ...
                    u.componentDidMount = function() {
                        var e = this,
                            ...
                            r = t.skuId,
                            o = t.applicationId;
                        null == n ? l.jU(o, r).catch((function(t) {
                    ...
                    u.checkPriceChange = function(e, t) {
                        var n = this.props,
                            r = n.sku,
                            o = n.onClose;
                    ...
                    u.getBaseAnalyticsData = function() {
                        var e = this.props,
                            t = e.sku,
                    ...
                    u.renderPurchaseWarning = function() {
                        var e = this.props,
                            t = e.sku,
                            n = e.isInTestMode,
                            i = e.isIAP,
                        ...
                        var a = (0, rt.hX)((0, P.Xf)()),
                            s = [];
                        null != a && t.supportedOperatingSystems.includes(a) || i || s.push((0, r.jsx)(U.Z, {
                            icon: F.Z,
                        ...
                        !0 === u && this.isGiftable && s.push((0, r.jsx)(U.Z, {
                            icon: F.Z,
                            iconSize: U.Z.Sizes.SMALL,
                            color: U.Z.Colors.PRIMARY,
                            className: st().errorBlock,
                    ...
                    u.render = function() {
                        ...
                        return null == n || o ? (0, r.jsx)(a.Spinner, {}) : (0, r.jsx)(Ge, {
                            ...
                            needsToBeGift: n.type === J.epS.DURABLE_PRIMARY && !0 === c,
                            isGiftable: this.isGiftable,
                            legalNotice: u ? (0, r.jsx)(f.Z, {
                                isEmbeddedIAP: u
                            }) : null,
                            isPurchasing: i,
                            purchaseError: s,
                ...
                Nt = o.forwardRef((function(e, t) {
                    var n, o, i = e.applicationId,
                        ...
                        l = (0, tt.yE)(null !== (n = null == c ? void 0 : c.flags) && void 0 !== n ? n : 0, J.udG.EMBEDDED) && (0, tt.yE)(null !== (o = null == c ? void 0 : c.flags) && void 0 !== o ? o : 0, J.udG.EMBEDDED_IAP),
                        f = vt((0, u.Wu)([Ke.Z], (function() {
                            return [Ke.Z.getPricesForSku(a), Ke.Z.isPurchasingSKU, Ke.Z.error, Ke.Z.analyticsLocation, Ke.Z.promotionId, Ke.Z.giftCode, Ke.Z.isGift, Ke.Z.isIAP, Ke.Z.forceConfirmationStepOnMount]
                        })), 9),
                        p = f[0],
                        d = f[1],
                        y = f[2],
                        ...
                        T = (0, u.e7)([Qe.Z, ze.default], (function() {
                            return Qe.Z.isEntitledToSku(ze.default.getCurrentUser(), a, i)
                        })),

    ...
    [96710], {
        896710: (e, s, a) => {
            ...
            var r = a(785893),
                ...
                I = a.n(_),
                T = function(e) {
                    var s = e.currentNumber,
                        a = e.thresholdNumber,
                        i = e.currentLabel,
                        c = e.isPercent,
                        _ = void 0 !== c && c,
                        T = null != a ? Math.floor(s / a * 100) : 0,
                        S = d.Z.Messages.NUMBERS_ONLY.format({
                            count: s
                        }),
                        N = null != a ? d.Z.Messages.NUMBERS_ONLY.format({
                            count: a
                        }) : "--",
                        m = (0, l.useToken)(t.Z.unsafe_rawColors.RED_400).hex(),
                        E = (0, l.useToken)(t.Z.unsafe_rawColors.YELLOW_300).hex();
                    return (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsxs)("div", {
                            className: I().progressWrapper,
                            children: [(0, r.jsx)("div", {
                                className: I().progressBackground
                            }), (0, r.jsx)(n.Spring, {
                                from: {
                                    width: 0
                                },
                                ...
                                children: function(e) {
                                    ...
                                    return (0, r.jsx)(n.animated.div, {
                                        ...
                                        style: {
                                            width: s.interpolate((function(e) {
                                                return "".concat(e, "%")
                                            })),
                                            backgroundColor: s.interpolate((function(e) {
                                                return e < 33 ? m : E
                                            }))
                                        }
                                    })
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)(o.Z, {
                                    color: T < 33 ? o.Z.Colors.ERROR : o.Z.Colors.STATUS_YELLOW,
                                    className: I().bold,
                                    children: _ ? "".concat(S, "%") : S
                                }), (0, r.jsxs)(l.Text, {
            ...
            const S = function(e) {
                var s, a, n, t = e.guildChecklist,
                    o = e.transitionState,
                    _ = e.onClose,
                    S = (0,
                        i.Dt)(),
                    N = t.retentionHealthy,
                    m = t.engagementHealthy,
                    E = t.healthScore,
                    h = E.avg_nonnew_participators,
                    C = E.avg_nonnew_communicators,
                    x = E.perc_ret_w1_intentful;
                !m && null != h && h < c.b0 && (a = (0, r.jsxs)("div", {
                    className: I().failingBlock,
                    children: [(0, r.jsx)(l.Heading, {
                        className: I().marginAfter,
                ...
                !m && null != C && C < c.md && (n = (0, r.jsxs)("div", {
                    className: I().failingBlock,
                    children: [(0, r.jsx)(l.Heading, {
                        className: I().marginAfter,
                        variant: "heading-md/semibold",
...
//# sourceMappingURL=6681a554d2a28c7081a0.js.map
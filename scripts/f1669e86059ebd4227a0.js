        ...
        354023: function(e, t, n) {
            ...
            let d = (e, t) => null != e && i.default.isMember(e, t),
                o = e => {
                    ...
                    if (null != n)
                        for (let e of n) {
                            ...
                            !(null == n || d(s, n.id)) && (l.add(n.id), a.push({
                                type: I.FRIEND,
                                item: n,
                                isSuggested: !0
                            }), i.numFriends++)
                ...
                c = e => {
                    ...
                    s === N.InviteTargetTypes.EMBEDDED_APPLICATION && E.default.queryChannels({
                        query: t,
                        limit: 3,
                        guildId: void 0
                    }).forEach(e => {
                ...
                m = e => {
                    ...
                    E.default.queryFriends({
                        ...
                        !(s.has(t.id) || l.has(t.id)) && (l.add(t.id), n.push({
                            type: I.FRIEND,
                            item: t,
                            isSuggested: !1
                        }), u.numFriends++)

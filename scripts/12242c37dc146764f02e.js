        ...
        953143: function(e, t, n) {
            ...
            function I(e) {
                ...
                return null != O && c.default.trackExposure({
                    guildId: null != n ? n : "",
                    location: x[0]
                }), g && (A = null != N.endDate || S ? (0, l.jsxs)(l.Fragment, {
        ...
        590942: function(e, t, n) {
            ...
            function b(e) {
                let {
                    ...
                    valid: !0
                }], [E]), R = Object.keys(l).length, D = (0, N.isGuildScheduledEventActive)(n), L = e => Math.max(0, Math.min(e, R - 1)), [j, P] = r.useState(D ? 1 : 0), [b, B] = r.useState(!1), H = r.useMemo(() => x.slice(0, j + 1).map(e => e.valid).every(Boolean), [x, j]), w = j >= x.length ? 3 : x[L(j)].slideId, F = 3 === w, k = (0, C.useGuildEventModalStore)(e => e.onUpdateCanCloseModal);
                k(F);
            ...
            function B(e) {
                let {
                    ...
                    transitionState: a,
                    onClose: d
                } = e, c = (0, i.useStateFromStores)([h.default], () => h.default.getGuild(t)), _ = (0, i.useStateFromStores)([N.default], () => N.default.getGuildScheduledEvent(l), [l]), I = (0, i.useStateFromStores)([f.default], () => f.default.getDefaultChannel(t), [t]), T = (0, p.getInitialGuildEventData)(c, _, I), [C, A] = r.useState(T), [O] = r.useState((0, p.isEditingEvent)(_)), [y, M] = r.useState(null), U = e => {
                    var t;
                ...
                }, G = (0, E.default)(c, null == _ ? void 0 : _.id, C), [B, {
                    loading: H,
                    error: w
                }] = (0, m.default)(async () => {
                    if (null != y) return;
                    ...
                    if (O && null != l) return await v.default.saveEvent(l, C, t, e), d();
                    let n = await v.default.createGuildEvent(C, t, e);
                    return U(n.body), n
                ...
                return (0, s.jsx)(b, {
                    ...
                    onChange: e => {
                        if (null != e.entityType) {
                            ...
                            e.channelId = null !== (n = null == a ? void 0 : a.id) && void 0 !== n ? n : null, e.entityType !== D.GuildScheduledEventEntityTypes.EXTERNAL && C.entityType === D.GuildScheduledEventEntityTypes.EXTERNAL && (e.entityMetadata = null)
                        }
                        A(t => ({
                            ...t,
                            ...e
        ...
        560309: function(e, t, n) {
            ...
            function B(e) {
                let {
                    ...
                    guildEvent: n,
                    onChange: s
                } = e, r = (0, i.useStateFromStores)([c.default], () => c.default.getGuild(t), [t]), o = (0, g.default)(t, void 0), d = (0, g.default)(t, y.ChannelTypes.GUILD_VOICE), E = (0, g.default)(t, y.ChannelTypes.GUILD_STAGE_VOICE), f = (0, S.useGetEventChannelsByType)(t, y.ChannelTypes.GUILD_VOICE), h = (0, p.useChannelsUserCanStartStageIn)(r), T = null == r ? void 0 : r.hasFeature(y.GuildFeatures.COMMUNITY), N = (0, v.isGuildScheduledEventActive)(n), x = G(s, n), C = a.useMemo(() => {
                    let e = [{
        ...
        151859: function(e, t, n) {
            ...
            function v(e) {
                ...
                let {
                    ...
                    image: y,
                    description: M
                } = C, R = (0, s.useStateFromStores)([o.default], () => o.default.getChannel(A), [A]), D = (0, s.useStateFromStores)([d.default], () => d.default.getGuild(g), [g]), L = (0, h.getLocationFromEvent)(C), V = (0, s.useStateFromStores)([c.default], () => null != S.creatorId ? c.default.getUser(S.creatorId) : c.default.getCurrentUser(), [S.creatorId]), U = (0, s.useStateFromStores)([u.default], () => u.default.isLurking(g), [g]), j = (0, i.getChannelIconComponent)(R, D);
                return (0, l.jsxs)("div", {
                    className: N.content,
        ...
        499950: function(e, t, n) {
            ...
            function C(e) {
                ...
                let P = L && null !== (t = null == R ? void 0 : R.vanityURLCode) && void 0 !== t ? t : null == j ? void 0 : j.code,
                    ...
                    H = null !== (n = null == j ? void 0 : j.maxAge) && void 0 !== n ? n : p.value,
                    w = null !== (C = null == j ? void 0 : j.maxUses) && void 0 !== C ? C : x.value;
                return (0, l.jsxs)("div", {
                ...
                render() {
                    ...
                    return (0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsx)(o.FocusRing, {
                            within: !0,
                            children: (0, l.jsxs)("div", {
                                className: v ? r(h.imageUploaderIconWrapper, C) : void 0,
                                children: [(0, l.jsxs)("div", {
                                    className: r(h.imageUploaderInner, p),
                                    style: {
                                        ...y,

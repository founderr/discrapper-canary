    ...
    [59852, 96043], {
            ...
            function Z(t) {
                ...
                if (!m.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== I.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        o = a.Z.getChannel(u),
                        l = R(o, i),
                        c = P({}, e, C(l), null != i && null != u && (0, S.AB)(u) ? N(0, u) : L(o));
                    m.default.track(t, c, {
                        flush: n
                    })
                }
        ...
        174333: (t, e, n) => {
            ...
            function _(t) {
                ...
                return null != u && (u.isDM() || u.isGroupDM() ? l.Z.getFriendIDs().includes(t.author.id) ? E(r) : E(i) : E(n))
            }
            var b, m = function(t) {
                var e = h();
            ...
            function O() {
                return !!(0, s.Kh)() && (null != a.default.getCurrentUser() && E(h().explicitContentGuilds))
            }! function(t) {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["62844"], {
        ...
        736978: function(e, t, n) {
            ...
            h.ErrorCodes = r, h.Fields = i, h.Sections = s, h.CARD_ERRORS = T, h.ADDRESS_ERRORS = R;
            var D = h
        },
                    ...
                    D = async () => {
                        try {
                            ...
                            o.default.track(c.AnalyticEvents.CONTEXT_MENU_IMAGE_SAVE_FAILED, {
                                ...(0, E.getNativeContextMenuChannelAnalytics)()
                            }), h(I.default.Messages.ERROR_SAVING_IMAGE, e)
                        }
                    }, p = async () => {
                        try {
                            ...
                            h(I.default.Messages.ERROR_COPYING_IMAGE, e), o.default.track(c.AnalyticEvents.CONTEXT_MENU_IMAGE_COPY_FAILED, {
                                ...(0, E.getNativeContextMenuChannelAnalytics)()
                            })
                        }
                    };
        ...
        235004: function(e, t, n) {
            ...
            var U = new M(o.default, {
                LOGOUT: function() {
                    N.clear(), T.clear(), D.clear(), p = !1, O = 0, R = 0
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: i,
                        userId: a
                    } = e, s = (null !== (n = T.get(i)) && void 0 !== n ? n : 0) + 1, l = (null !== (r = D.get(a)) && void 0 !== r ? r : 0) + 1;
                    T.set(i, s), D.set(a, l), a !== (null === (t = _.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (p = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: i
                    } = e, a = (null !== (t = T.get(r)) && void 0 !== t ? t : 0) - 1, s = (null !== (n = D.get(i)) && void 0 !== n ? n : 0) - 1;
                    a <= 0 ? T.delete(r) : T.set(r, a), s <= 0 ? D.delete(i) : D.set(i, s)
                },
                ...
                USER_SETTINGS_PROTO_UPDATE: function(e) {
                    ...
                    if (n === A.UserSettingsTypes.FRECENCY_AND_FAVORITES_SETTINGS) {
                        var i, a;
                        h = new Set(null !== (a = null == r ? void 0 : null === (i = r.favoriteSoundboardSounds) || void 0 === i ? void 0 : i.soundIds) && void 0 !== a ? a : [])
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    N = new Map(Object.entries(t.soundboardSounds)), h = new Set(t.favoritedSoundIds), S = new Set(t.localSoundboardMutes)
                },

        ...
        634080: (e, t, n) => {
            ...
            var p, T = function(e, t) {
                ...
                N = (p = u((function(e) {
                    return T(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                if (0 === l.ZP.getGuildScheduledEventsForGuild(e).length) return [2];
                                if (A.has(e)) return [2];
                                t.label = 1;
                            case 1:
                                t.trys.push([1, 3, , 4]);
                                return [4, a.Z.getGuildEventsForCurrentUser(e)];
                            case 2:
                                t.sent();
                                A.add(e);
                                return [3, 4];
            ...
            const L = new(function(e) {
                ...
                r.getGuildEventUserCounts = function(e) {
                    return u((function() {
                        return T(this, (function(t) {
                            switch (t.label) {
                                case 0:
                                    if (null != f && Date.now() - f[e] < 18e5) return [2];
                                    f[e] = Date.now();
                                    t.label = 1;
                                case 1:
                                    t.trys.push([1, 3, , 4]);
                                    return [4, a.Z.fetchGuildEventsForGuild(e, !0)];
                                case 2:
                                    t.sent();
                                    return [3, 4];
                                case 3:
                ...
                r.getGuildEventUsers = function(e, t) {
                    return a.Z.fetchUsersForGuildEvent(e, t)
                };

    ...
    ["24417"], {
        ...
        736978: function(e, t, n) {
            ...
            class p extends _.default {
                ...
                hasCardError() {
                    return 2 === (0, E.reducedPaymentInfoExperiment)().bucket ? this._isInFieldSet(N) : this._isInFieldSet(A)
                }
                hasAddressError() {
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: p
                } = (0, f.usePaymentContext)(), C = A.find(e => e.key === m);
                r.useEffect(() => {
                    g(null)
                }, [m, g]), o(null != C, "Unknown step for current payment flow.");
                let T = null !== (u = null == C ? void 0 : null === (t = C.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    R = null == C ? void 0 : null === (n = C.options) || void 0 === n ? void 0 : n.bodyClassName,
                    O = void 0 !== I && I ? E.sliderBodyLarge : null == C ? void 0 : null === (l = C.options) || void 0 === l ? void 0 : l.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == C ? void 0 : null === (a = C.options) || void 0 === a ? void 0 : a.renderHeader) || void 0 === d || d ? _ : null, C.renderStep(h), null == m || T ? null : (0, i.jsxs)(i.Fragment, {
        ...
        817963: function(e, t, n) {
            ...
            let f = {
                ...
                I = e => {
                    let [t, n] = e instanceof a.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : _(e), [r, s, d, I] = (0, l.useStateFromStoresArray)([o.default], () => [o.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e), o.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e), o.default.can(t, e), o.default.can(n, e)]), h = (0, l.useStateFromStores)([u.default], () => u.default.getCurrentUser()), m = i.useCallback(e => E(e, h, s, r), [r, s, h]), A = i.useCallback(e => E(e, h, I, d), [I, d, h]);
                    return null == e ? f : {
                ...
                h = function(e) {
                    ...
                    return null == e ? f : {
                        ...
                        canManageAllExpressions: s,
                        canManageAllEvents: I,
                        canManageGuildExpression: e => E(e, h, s, l),
                        canManageGuildEvent: e => E(e, h, I, d)
                    }
                },
                m = e => {
        ...
        716849: function(e, t, n) {
            ...
            function A(e, t, n, i) {
                null != e && !(0, d.isPremium)(e) && n && (t && I(), i && (!u.default.isLoadedForSKU(f.PremiumSubscriptionSKUs.TIER_0) && !u.default.isFetchingForSKU(f.PremiumSubscriptionSKUs.TIER_0) && (0, a.fetchSubscriptionPlansForSKU)(f.PremiumSubscriptionSKUs.TIER_0), !u.default.isLoadedForSKU(f.PremiumSubscriptionSKUs.TIER_2) && !u.default.isFetchingForSKU(f.PremiumSubscriptionSKUs.TIER_2) && (0, a.fetchSubscriptionPlansForSKU)(f.PremiumSubscriptionSKUs.TIER_2)))
            }
        },
        ...
        460029: function(e, t, n) {
            ...
            var m = r.memo(function(e) {
                ...
                let {
                    ...
                    audio: N
                } = (0, c.useAudioTrimmerStore)(), [S, g] = r.useState(!1), [p, C] = r.useState(h), {
                ...
                let M = r.useCallback(e => {
                    ...
                    U = r.useCallback(() => {
                        if (null != N) {
                            ...
                            T >= R ? N.currentTime = (0, E.toSeconds)(O) : N.currentTime = (0, E.toSeconds)(T), N.volume = (0, d.default)(l), N.play(), g(!0)
                        }
                    }, [N, R, M, T, S, O, l]),
                    P = r.useCallback(e => {
                        C(e), null == A || A({
        ...
        278175: function(e, t, n) {
            ...
            var I = s.memo(function(e) {
                let {
                    ...
                    audio: h
                } = (0, d.useAudioTrimmerStore)(), m = null != h, A = s.useRef(null), N = s.useRef(null), S = s.useRef(null), [g, p] = s.useState(0), [C, T] = s.useState(0), [R, O] = s.useState(0), [v, L] = s.useState(!1), [D, M] = s.useState(!1), [U, P] = s.useState(!1), [b, y] = s.useState(0), [w, x] = s.useState(-1), F = s.useMemo(() => b / I.fineTuningScale, [I.fineTuningScale, b]);
                s.useEffect(() => {
                    if (null == h) return;
                ...
                let V = s.useCallback((e, t) => {
                    ...
                    B = s.useCallback(e => {
                        ...
                        let t = parseInt(e.target.value),
                            n = t > R ? R : t;
                        i((0, c.toSeconds)(n)), p(n), T(n)
                    }, [h, i, R, v]),
                    k = s.useCallback(e => {
                        if (null == h || !D) return;
                        let t = parseInt(e.target.value);
                        t < g ? (i((0, c.toSeconds)(g)), T(g)) : t > R ? (i((0, c.toSeconds)(R)), T(R)) : (i((0, c.toSeconds)(t)), T(t))
                    }, [h, i, R, D, g]),
                    H = s.useCallback(e => {
                        if (null == h || !U) return;
                        let t = parseInt(e.target.value),
                            n = t > g ? t : g;
                        i((0, c.toSeconds)(g)), T(g), O(n)
                    }, [h, i, U, g]);
                return s.useEffect(() => {
                    null != r && m && r({
                        startPositionMs: g,
                ...
                }, [g, R, r, m, C]), s.useEffect(() => {
                    let e;
                    if (null != h) return t && (e = setInterval(() => {
                        h.currentTime < (0, c.toSeconds)(R) ? h.currentTime >= (0, c.toSeconds)(C) && T(1e3 * h.currentTime) : (n((0, c.toSeconds)(g)), T(g))
                    }, 16)), () => {
                        clearInterval(e)
                    }
                }, [h, R, n, C, t, g]), s.useEffect(() => {
                    if (I.fineTuningDelay <= 0) return;
                    let e = setTimeout(() => {
                        v && g == g && -1 === w ? x(g) : U && R == R && -1 === w ? x(R) : D && C == C && -1 === w && x(C)
                    }, I.fineTuningDelay);
                    return () => {
                        clearTimeout(e)
                    }
                }, [I.fineTuningDelay, U, R, w, D, C, v, g]), (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsxs)("div", {
                            ...
                            children: (0, l.jsx)("div", {
                                ...
                                style: {
                                    left: "".concat((0, c.getStartHandleValue)(C, w, F, b), "%")
                                }
                            })
                        })]
                    }), (0, l.jsx)("div", {
        ...
        477633: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                h = r.memo(function(e) {
                    ...
                    }, [n, h]), g = (0, f.useAudioBufferData)(t), p = (0, f.useAudioWaveformData)(g, N.current, S), C = (0, d.default)(), T = (0, c.useColorValue)((0, o.isThemeDark)(C) ? _.Color.PRIMARY_300 : _.Color.PRIMARY_700), R = null == g || null == p, O = 0 === m.width || 0 === m.height, v = (O || R) && null != t, L = r.useCallback(() => {
                        null != N.current && A({
                ...
                I = r.memo(function(e) {
                    ...
                    return r.useEffect(() => {
                        ...
                        children: [(0, i.jsx)(l.Clickable, {
                            ...
                            "aria-label": h ? E.default.Messages.STOP : E.default.Messages.PLAY,
        ...
        823749: function(e, t, n) {
            ...
            function O(e) {
                ...
                let ee = function(e) {
                        switch (e) {
                            case "encoding":
                                return C.default.Messages.SOUNDBOARD_MODAL_AUDIO_STATE_ENCODING;
                            case "encoding-failed":
                                return C.default.Messages.SOUNDBOARD_MODAL_AUDIO_STATE_ENCODING_FAILED;
                            case "uploading":
                                return C.default.Messages.SOUNDBOARD_MODAL_AUDIO_STATE_UPLOADING
                        }
                        return null
                    }(q),
                ...
                return (0, l.jsxs)(c.ModalRoot, {
                    ...
                    children: [(0, l.jsx)(c.ModalCloseButton, {
                        ...
                        children: (0, l.jsx)(c.Heading, {
                            ...
                            children: en ? C.default.Messages.SOUNDBOARD_SOUND_UPDATE_MODAL_HEADER : C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_HEADER
                        })
                        ...
                        children: [null != W && !W.hasFieldErrors() && (0, l.jsx)(c.FormErrorBlock, {
                            ...
                            required: !0,
                            className: T.section,
                            title: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT,
                            ...
                            className: T.section,
                            title: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_FILE,
                            children: (0, l.jsx)(_.default, {
                                filename: null !== (r = null == V ? void 0 : V.name) && void 0 !== r ? r : "",
                                buttonText: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_BROWSE,
                                placeholder: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_INPUT_PLACEHOLDER,
                                onFileSelect: J,
                                filters: R
                            })
                        }), (0, l.jsxs)("div", {
                            ...
                            children: [(0, l.jsx)(c.FormItem, {
                                ...
                                title: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SOUND_NAME,
                                children: (0, l.jsx)(c.TextInput, {
                                    placeholder: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SOUND_NAME,
                                    value: M,
                                    onChange: U,
                            ...
                            className: T.section,
                            title: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SOUND_VOLUME,
                        ...
                        children: [(0, l.jsx)(c.Button, {
                            ...
                            onClick: es,
                            children: en ? C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SAVE : C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_UPLOAD
                        }), (0, l.jsx)(c.Button, {
                            disabled: H,
                            onClick: v,
                            size: c.Button.Sizes.SMALL,
                            ...
                            children: C.default.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_CANCEL
                        }), null != ee && (0, l.jsx)("div", {
        ...
        876189: function(e, t, n) {
            ...
            function C(e) {
                let {
                    ...
                    className: n,
                    onChange: l
                } = e, I = (0, a.useStateFromStoresObject)([f.default, c.default, E.default, d.default], () => {
                    let e = {};
                    ...
                    return e
                }), C = (0, a.useStateFromStoresObject)([A.default], () => {
                    let e = {};
                ...
                let T = r.useMemo(() => Object.values(I).map(e => {
                        let {
                            name: t,
                            id: n
                        } = e;
                ...
                return (0, i.jsx)(o.SearchableSelect, {
                    ...
                    renderOptionLabel: v,
                    placeholder: 0 === T.length ? S.default.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT_NONE_AVAILABLE : S.default.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT_PLACEHOLDER
                })
            }
        },
        ...
        461380: function(e, t, n) {
            ...
            let E = {
                ...
                _ = e => {
                    ...
                    if (!0 === A ? g = E.DOWN : !1 === A && (g = E.RIGHT), S) {
                        let e = {

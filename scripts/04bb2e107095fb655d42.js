...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [96043], {
        83797: (t, e, n) => {
            ...
            function r(t) {
                return null != t && t.type !== i.IIU.CUSTOM_STATUS && (null != t.details || null != t.assets && (null != t.assets.large_image || null != t.assets.small_text) || null != t.party || null != t.secrets || null != t.state)
            }
        },
        396043: (t, e, n) => {
            n.d(e, {
            ...
            function P(t) {
                ...
                var n, i = a.default.getId(),
                    r = f.ZP.getMember(t, i),
                    u = c.ZP.getChannels(t),
                    l = u[c.sH].length,
                    s = u[c.Zb].length,
                    v = I.Z.getVoiceStates(t);
                return {
                    guild_id: e.id,
                    guild_size_total: o.Z.getMemberCount(t),
                    guild_num_channels: l + s,
            ...
            function M(t) {
                ...
                if (null != i) {
                    var r = function(t) {
                        if (null == t) return !1;
                        var e = t.permissionOverwrites[i];
                        return null != e && u.Z.has(e.deny, b.Plq.VIEW_CHANNEL)
                    };
                    n = l.Ec.has(t.type) && null != t.parent_id ? r(s.Z.getChannel(t.parent_id)) : r(t)
                }
                return {
                    channel_id: t.id,
                    channel_type: t.type,
                    channel_size_total: t.isPrivate() ? t.recipients.length : 0,
                    channel_member_perms: String(null != i && null !== (e = p.Z.getChannelPermissions(t)) && void 0 !== e ? e : m.ZP.NONE),
                    channel_hidden: n
                }
            }
            ...
            function Z(t) {
                ...
                var e = s.Z.getChannel(t);
                if (null == e) return null;
                var n, i = v.Z.isVideoEnabled(),
                    r = g.Z.getMediaSessionId();
                return N({
                    channel_id: e.id,
                    channel_type: e.type,
                    guild_id: e.getGuildId(),
                    media_session_id: r
                }, k(e.getGuildId(), e.id, i), {
            ...
            function U(t, e) {
                return null == t ? null != e ? e : null : t.isPrivate() ? null : null !== (i = null !== (n = t.getGuildId()) && void 0 !== n ? n : e) && void 0 !== i ? i : null;
                var n, i
            }
            ...
            function L(t) {
                ...
                if (!S.default.isThrottled(t)) {
                    var i = !("location" in e) || e.location !== b.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        r = "guild_id" in e ? e.guild_id : i ? h.Z.getGuildId() : null,
                        u = "channel_id" in e ? e.channel_id : i ? y.Z.getChannelId(r) : null,
                        l = s.Z.getChannel(u),
                        a = U(l, r),
                        c = N({}, e, P(a), null != r && null != u && (0, O.AB)(u) ? C(0, u) : M(l));
                    S.default.track(t, c, {
                        flush: n
                    })
                }
            ...
            function k(t, e, n) {
                ...
                r()(I.Z.getVoiceStates(t)).filter((function(t) {
                    return t.channelId === e
                })).filter((function(t) {
                    return t.userId !== a.default.getId()
                })).forEach((function(t) {
                    i.voice_state_count++;
                    (t.selfVideo || t.selfStream) && i.video_stream_count++
                }));
                return i
            }
            ...
            function F(t, e) {
                ...
                r()(I.Z.getVoiceStates(t)).forEach((function(t) {
                    t.channelId === e && null != _.Z.findActivity(t.userId, (function(t) {
        ...
        491260: (t, e, n) => {
                ...
                return function(t) {
                    ...
                    if (null != n) {
                        var i, r, u = [],
                            ...
                            a = !1;
                        try {
                            for (n = n.call(t); !(l = (i = n.next()).done); l = !0) {
                                u.push(i.value);
            ...
            function E(t, e) {
                if (t) {
                    ...
                    return "Map" === n || "Set" === n ? Array.from(n) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? v(t, e) : void 0
                }
            }
            ...
            function U(t, e) {
                return function(t, e) {
                    ...
                    var n, i;
                    return (null !== (n = e.created_at) && void 0 !== n ? n : 0) - (null !== (i = t.created_at) && void 0 !== i ? i : 0)
                }(t, e)
            }
            ...
            function L(t) {
                ...
                if (null != A[t]) {
                    ...
                    if (n.status !== d.Skl.OFFLINE) {
                        N[t] = n.status;
                        T[t] = n.activities;
                        null != n.clientStatus && (P[t] = n.clientStatus)
            ...
            function F(t) {
                ...
                var a = A[n];
                if (null == a) {
                    if (i === d.Skl.OFFLINE) return !1;
                    a = A[n] = {}
                }
                if (i === d.Skl.OFFLINE) a[e] = {
                    status: i,
                    clientStatus: u,
                    activities: O,
                    timestamp: Date.now()
                    ...
                    var s = l.length > 1 ? S(l).sort(U) : l,
                        c = a[e];
                    l = null != c && r()(c.activities, s) ? c.activities : s;
                    a[e] = {
                        status: i,
                        clientStatus: u,
                        activities: l,
            ...
            function G(t) {
                var e = !0,
                    ...
                    i = void 0;
                try {
                    for (var r, u = Object.keys(A)[Symbol.iterator](); !(e = (r = u.next()).done); e = !0) {
                        j(t, r.value)
                    }
                } catch (t) {
                    n = !0;
            ...
            var D = function(t) {
                ...
                i.setCurrentUserOnConnectionOpen = function(t, e) {
                    N[o.default.getId()] = t;
                    T[o.default.getId()] = e
                };
                i.getStatus = function(t) {
                    ...
                    null != i && i.hasFlag(d.xW$.BOT_HTTP_INTERACTIONS) && (n = d.Skl.UNKNOWN);
                    if (null == i ? void 0 : i.isClyde()) return d.Skl.ONLINE;
                    if (null == e) {
                        var r;
                        return null !== (r = N[t]) && void 0 !== r ? r : n
                    }
                    var u, l = w(t, e);
                    return null !== (u = null == l ? void 0 : l.status) && void 0 !== u ? u : n
                };
                i.getActivities = function(t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                    if (null == e) {
                        var n;
                        return null !== (n = T[t]) && void 0 !== n ? n : O
                    }
                    var i = w(t, e);
                    return null == i || null == i.activities ? O : i.activities
                };
                i.getPrimaryActivity = function(t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                        n = this.getActivities(t, e);
                    return n[0]
                };
                i.getAllApplicationActivities = function(t) {
                    var e = [],
                        n = !0,
                        i = !1,
                        r = void 0;
                    try {
                        for (var u, l = Object.keys(T)[Symbol.iterator](); !(n = (u = l.next()).done); n = !0) {
                            var a = u.value,
                                ...
                                f = void 0;
                            try {
                                for (var d, v = s[Symbol.iterator](); !(c = (d = v.next()).done); c = !0) {
                                    var p = d.value;
            ...
            const V = new D(s.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(t) {
                    ...
                    if (N[e] === t.status && T[e] === t.activities) return !1;
                    N[e] = t.status;
                    T[e] = t.activities;
                    delete C[e]
                }

    ...
    ["3471"], {
        ...
        273619: function(e, r, l) {
            ...
            var E = l("454589"),
                ...
                C = l("782340"),
                T = l("129429");
            let _ = new Set([f.Step.SKU_SELECT, f.Step.AWAITING_AUTHENTICATION, f.Step.AWAITING_PURCHASE_TOKEN_AUTH, f.Step.CONFIRM]);
            ...
            function v(e) {
                ...
                null != v && null == (0, f.errorToStep)(v) ? B = v : null != M ? B = M : null != g && (B = g);
                let O = null != B ? B.message : "";
                null != B && B instanceof u.BillingError && (B.code === p.ErrorCodes.CARD_DECLINED && k && (O += " ".concat(C.default.Messages.BILLING_ERROR_TRY_ANOTHER)), B.code === p.ErrorCodes.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED && (O = C.default.Messages.GIFT_CODE_SMITE_REJECT_HELP_TEXT), B.code === x.AbortCodes.BILLING_NON_REFUNDABLE_PAYMENT_SOURCE && (O = C.default.Messages.GIFT_CODE_PAYMENT_SOURCE_INVALID));
                let {
                    stripe: U
                ...
                t.useEffect(() => {
                    let e = G.current;
                    return null != U || e.isStarted() ? null != U && e.stop() : e.start(10 * S.default.Millis.SECOND, () => {
                ...
                return (0, n.jsxs)(s.Elements, {
                    ...
                    children: [I, (0, n.jsxs)("div", {
                        ...
                        children: [P && l !== f.Step.CONFIRM ? (0, n.jsx)(d.default, {
                            className: T.paymentNote,
                            iconSize: d.default.Sizes.SMALL,
                            icon: N.default,
                            color: null == A ? d.default.Colors.PRIMARY : d.default.Colors.SECONDARY,
                            children: A
                        }) : null, R ? null : (0, n.jsx)("div", {
                            className: T.breadcrumbsWrapper,
                            children: (0, n.jsx)(E.default, {
                                activeId: f.COLLAPSED_PAYMENT_BREADCRUMB_STEPS.has(l) ? Y : l,
                                breadcrumbs: r.filter(e => !f.COLLAPSED_PAYMENT_BREADCRUMB_STEPS.has(e) && !_.has(e)).map(e => ({
                                    id: e,

        ...
        752598: function(e, t, n) {
            ...
            let C = (e, t) => {
                ...
                let l = e.state === S.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : a.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    d = e.isCommandType();
                if (o && r === E.InteractionState.QUEUED || d && e.state === S.MessageStates.SENDING && null != t) return i.SENDING;
                if (o && r === E.InteractionState.CREATED || e.hasFlag(S.MessageFlags.LOADING) && !s) return i.CREATED;
                if (null != e.interaction && e.hasFlag(S.MessageFlags.LOADING) && s) return i.TIMED_OUT;
                else if (null != e.interaction && !e.hasFlag(S.MessageFlags.LOADING) && l) return i.TIMED_OUT;
                else if (d && e.state === S.MessageStates.SEND_FAILED) return i.FAILED
            };

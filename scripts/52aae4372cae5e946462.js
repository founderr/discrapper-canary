...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [14891], {
        314891: (e, t, r) => {
            ...
            function _(e) {
                var t, r, o = (0, p.V)().setEditingRule,
                    l = m(a.useState(!1), 2),
                    s = l[0],
                    c = l[1],
                    y = (0, f.pH)(e.guildId).removeRule,
                    v = (r = (t = function() {
                        var t, r, n;
                        return E(this, (function(a) {
                            switch (a.label) {
                                case 0:
                                    return s ? [2] : [4, (0, h.gK)(e.name)];
                                case 1:
                                    if (!a.sent()) return [2];
                                    c(!0);
                                    a.label = 2;
                                case 2:
                                    a.trys.push([2, 4, 5, 6]);
                                    return [4, (0, d.mm)(e.id, e.guildId)];
                                case 3:
                                    a.sent();
                                    o(null);
                                    y(e.id, e.guildId);
                                ...
                                case 4:
                                    ...
                                    r = new i.Hx(t);
                                    (0, u.showToast)((0,
                                        u.createToast)(null !== (n = r.getAnyErrorMessage()) && void 0 !== n ? n : b.Z.Messages.ERROR_OCCURRED_TRY_AGAIN, u.ToastType.FAILURE));
                                    return [3, 6];
                                case 5:
                                    c(!1);
                                    return [7];
                ...
                return (0, n.jsx)(u.MenuItem, {
                    ...
                    label: b.Z.Messages.GUILD_AUTOMOD_DELETE_RULE,
                    action: v
                })
            }
                ...
                var t = e.rule,
                    ...
                    f = function(e) {
                        ...
                        return (0, n.jsx)(u.MenuItem, {
                            ...
                            label: b.Z.Messages.GUILD_AUTOMOD_EDIT_RULE,
                            action: function() {
                                a(e)
                            },
                            disabled: o
                    ...
                    h = (0, s.Z)({
                        id: t.id,
                        label: b.Z.Messages.COPY_ID_AUTOMOD_RULE
                    });
                return (0, n.jsx)(l.Z, {
                    context: r,
                    ...
                    children: (0, n.jsxs)(u.Menu, {
                        ...
                        onClose: o.Zy,
                        "aria-label": b.Z.Messages.GUILD_AUTOMOD_RULE_CONTEXT_MENU,
                        onSelect: a,
                        children: [(0, n.jsxs)(u.MenuGroup, {
                            children: [f, i && d]
                        }), i && (0, n.jsx)(u.MenuGroup, {
                            children: h
                        })]
                    })
                })
...
//# sourceMappingURL=52aae4372cae5e946462.js.map
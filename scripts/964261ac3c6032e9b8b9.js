(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["8188"], {
        610174: function(e, t, a) {
            ...
            function _(e) {
                let t = (0, o.useStateFromStores)([n.default], () => n.default.getGuild(e)),
                    a = (0, o.useStateFromStores)([r.default], () => null != t && l.default.hasAny(r.default.computePermissions(t), i.IncidentAlertModeratorPermissions)),
                    s = d.useExperiment({
                        guildId: e,
                        location: "c3fae3_1"
                    }, {
            ...
            function c(e) {
                let t = n.default.getGuild(e),
                    a = null != t && l.default.hasAny(r.default.computePermissions(t), i.IncidentAlertModeratorPermissions),
                ...
                return {
                    ...
                    alsoShowMemberSafety: o.alsoShowMemberSafety || s.alsoShowMemberSafety
                }
            }
        },
        311340: function(e, t, a) {
            ...
            function c(e) {
                ...
                0 !== t.length && d.default.track(_.AnalyticEvents.GUILD_RAID_REPORTED, {
            ...
            async function R(e, t) {
                ...
                a.has(_.GuildFeatures.COMMUNITY) ? t ? a.delete(_.GuildFeatures.RAID_ALERTS_DISABLED) : a.add(_.GuildFeatures.RAID_ALERTS_DISABLED) : t ? a.add(_.GuildFeatures.NON_COMMUNITY_RAID_ALERTS) : a.delete(_.GuildFeatures.NON_COMMUNITY_RAID_ALERTS), await r.default.saveGuild(e.id, {
                    features: a
                }, {
                    throwErr: !0
                })
            ...
            async function f(e, t, a) {
                let {
                    showAlertMode: l
                } = (0, u.getGuildAlertModeEnabled)(e), o = i.default.getGuild(e), n = null == o ? void 0 : o.getSafetyAlertsChannelId();
            ...
            async function E(e) {
                let {
                    showAlertMode: t
                } = (0, u.getGuildAlertModeEnabled)(e), a = i.default.getGuild(e), l = null == a ? void 0 : a.getSafetyAlertsChannelId();
        ...
        421127: function(e, t, a) {
            ...
            let n = 2,
                ...
                d = l.default.combine(o.Permissions.ADMINISTRATOR, o.Permissions.MANAGE_GUILD, o.Permissions.BAN_MEMBERS, o.Permissions.KICK_MEMBERS, o.Permissions.MODERATE_MEMBERS)
        },

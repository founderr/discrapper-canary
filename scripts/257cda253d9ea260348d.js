        ...
        506838: function(e, t, n) {
            ...
            let T = d(g(function(e) {
                ...
                N = e => Object.assign(d(e), {
                    startsWith: t => N(v(e, g(e => C(e) && e.startsWith(t)))),
                    endsWith: t => N(v(e, g(e => C(e) && e.endsWith(t)))),
                    minLength: t => {
                        var n;
                        return N(v(e, (n = t, g(e => C(e) && e.length >= n))))
                    },
                    maxLength: t => {
                        var n;
                        return N(v(e, (n = t, g(e => C(e) && e.length <= n))))
                    },
                    includes: t => N(v(e, g(e => C(e) && e.includes(t)))),
                    regex: t => N(v(e, g(e => C(e) && !!e.match(t))))
                }),
                I = N(g(C)),
                A = (e, t) => g(n => m(n) && e <= n && t >= n),
                y = e => g(t => m(t) && t < e),
                R = e => g(t => m(t) && t > e),
                U = e => g(t => m(t) && t <= e),
                x = e => g(t => m(t) && t >= e),
                b = () => g(e => m(e) && Number.isInteger(e)),
                w = () => g(e => m(e) && Number.isFinite(e)),
                O = () => g(e => m(e) && e > 0),
                P = () => g(e => m(e) && e < 0),
                L = e => Object.assign(d(e), {
                    between: (t, n) => L(v(e, A(t, n))),
                    lt: t => L(v(e, y(t))),
                    gt: t => L(v(e, R(t))),
                    lte: t => L(v(e, U(t))),
                    gte: t => L(v(e, x(t))),
        ...
        833843: function(e, t, n) {
            ...
            function b(e) {
                let {
                    ...
                    isMember: o,
                    recurrenceId: c
                } = e, d = (0, v.isGuildScheduledEventActive)(t), f = (0, s.useStateFromStores)([v.default], () => v.default.hasRsvp(t.id, c), [c, t]), h = (0, p.default)(t), E = (0, s.useStateFromStores)([u.default], () => u.default.isLurking(n.id), [n.id]), g = (0, _.useIsChannelPublic)(null == l ? void 0 : l.id, t.id), m = (0, y.default)({
                    guild: n,
                    channel: l,
            ...
            var w = e => {
                let {
                    ...
                    recurrenceId: p,
                    onClose: _
                } = e, C = (0, s.useStateFromStores)([v.default], () => v.default.getGuildScheduledEvent(t), [t]), T = null == C ? void 0 : C.id, y = null == C ? void 0 : C.guild_id, {
                    guild: w,
                    isMember: O
                } = (0, g.default)(y, T), P = (0, o.default)(n), L = null == C ? void 0 : C.channel_id, M = (0, s.useStateFromStores)([c.default], () => c.default.getChannel(L), [L]), j = (0, d.useUID)(), [D, V] = l.useState(R.EventDetailSections.EVENT_INFO), k = (0, s.useStateFromStoresArray)([v.default], () => Object.values(v.default.getUsersForGuildEvent(T, p)), [T, p]), G = (0, s.useStateFromStores)([v.default], () => v.default.getUserCount(T, p)), [F, {
                    loading: B,
                    error: H
                }] = (0, h.default)(() => E.default.getGuildEventUsers(null == C ? void 0 : C.id, p, y));
                l.useEffect(() => {
                    null == C ? _() : f.default.track(U.AnalyticEvents.OPEN_MODAL, {
                ...
                if (l.useLayoutEffect(() => {
                    ...
                    }, [Z]), null == C || null == w || !O && !P) return null;
                let z = e => {
                        e !== D && (e === R.EventDetailSections.RSVP_LIST && F(), V(e))
                    },
                    K = null == p && null != C.recurrence_rule ? r.default.fromTimestamp(Math.floor(new Date(C.scheduled_start_time).getTime() / U.Durations.SECOND)) : p;
                return (0, i.jsxs)(a.ModalRoot, {
                    size: a.ModalSize.MEDIUM,
                    transitionState: u,
                    "aria-labelledby": j,
                    className: x.root,
                    children: [(null == C ? void 0 : C.image) != null && (0, i.jsx)(S.default, {
                        source: (0, m.default)(C),
                        className: x.banner
                    }), (0, i.jsx)(N.default, {
                        onClose: _,
                        selectedTab: D,
                        onTabSelected: z,
                        userCount: G,
                        hasBanner: (null == C ? void 0 : C.image) != null,
                        isHub: P
                    }), (0, i.jsx)("div", {
        ...
        360538: function(e, t, n) {
            ...
            function b(e) {
                ...
                let {
                    ...
                    startTime: b,
                    endTime: w
                } = (0, C.default)(r.id, I), O = (0, a.useStateFromStores)([_.default], () => _.default.getUserCount(r.id, I)), P = l.useCallback(e => {
                    e.stopPropagation(), null != r && (0, u.transitionToGuildFromEventInvite)(r)
                }, [r]), L = (0, m.default)(r);
                return l.useEffect(() => {
                    g.default.getGuildEventUserCounts(s.id, r.id, null != I ? [I] : []), g.default.getGuildEventsForCurrentUser(s.id)
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(T.GuildEventTimeStatus, {
                            ...
                            endTime: null !== (n = null == w ? void 0 : w.toISOString()) && void 0 !== n ? n : r.scheduled_end_time,
                            status: r.status,
        ...
        403901: function(e, t, n) {
            ...
            function N() {
                return (0, i.jsx)(T, {
                    children: (0, i.jsx)(a.Heading, {
                        ...
                        className: S.title,
                        children: C.default.Messages.GUILD_EVENT_DETAILS_USER_LIST_EMPTY_TITLE
                    })
                })
            }
            ...
            function I() {
                return (0, i.jsx)(T, {
                    children: (0, i.jsx)(a.Heading, {
                        ...
                        children: C.default.Messages.GUILD_EVENT_DETAILS_USER_LIST_FETCH_ERROR
                    })
                })
            }
                ...
                return (0, i.jsx)(i.Fragment, {
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)("div", {
                            ...
                            children: C.default.Messages.GUILD_EVENT_DETAILS_USER_LIST_REMAINING.format({
                                userRemainCount: t
                            })
                        })]
                    })
            ...
            function y(e) {
                ...
                let {
                    eventUser: n,
                    onContextMenu: l
                } = e, o = (0, s.useStateFromStores)([p.default], () => p.default.getUser(n.user_id)), c = null === (t = n.guild_member) || void 0 === t ? void 0 : t.guildId, g = (0, s.useStateFromStores)([v.default, E.default, h.default], () => n.user_id === h.default.getId() ? v.default.getStatus() : E.default.getStatus(n.user_id, c), [n.user_id, c]);
            ...
            function b(e) {
                let {
                    ...
                    error: u,
                    containerHeight: c
                } = e, d = (0, s.useStateFromStores)([_.default], () => _.default.getUserCount(t.id, null));
                if (r && 0 === l.length) return (0, i.jsx)(x, {
                    height: c,
                ...
                if (null != u && 0 === l.length) return (0, i.jsx)(x, {
                    height: c,
                    children: (0, i.jsx)(I, {})
                });
                let f = 0;
                return l.length >= m.MAX_RSVP_USER_DISPLAY_COUNT && d > m.MAX_RSVP_USER_DISPLAY_COUNT && (f = Math.max(d - l.length, 0)), 0 === l.length ? (0, i.jsx)(x, {
                    height: c,
                    children: (0, i.jsx)(N, {})
                }) : (0, i.jsx)(U, {
                    children: (0, i.jsx)(R, {
        ...
        650484: function(e, t, n) {
            ...
            function E(e) {
                ...
                let I = null !== (u = null == N ? void 0 : null === (t = N.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    ...
                    y = void 0 !== v && v ? h.sliderBodyLarge : null == N ? void 0 : null === (r = N.options) || void 0 === r ? void 0 : r.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (c = null == N ? void 0 : null === (a = N.options) || void 0 === a ? void 0 : a.renderHeader) || void 0 === c || c ? E : null, N.renderStep(p), null == g || I ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                w = !0, null == v || v(), !S && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: g,
                            analyticsObject: _,
                    ...
                    onCloseCallback: () => {
                        !w && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: R,
                            location_stack: g
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == E || E(w), w && (!S && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },
        ...
        181114: function(e, t, n) {
            ...
            let g = e => {
                let {
                    ...
                    onlyShineOnHover: v,
                    ...g
                } = e, _ = s.createRef(), m = (0, d.default)(_), C = !i && !l && !0 !== a && (!v || m);
        ...
        461380: function(e, t, n) {
            ...
            let h = {
                ...
                E = e => {
                    ...
                    if (!0 === _ ? S = h.DOWN : !1 === _ && (S = h.RIGHT), C) {
                        let e = {

    ...
    ["22018"], {
        ...
        485261: function(e, t, n) {
            ...
            function I(e) {
                ...
                })), T = (0, s.useStateFromStores)([a.default], () => a.default.getGuild(n)), N = (0, f.useClydeProfilesEnabled)(T), [R, M] = l.useState(!1);
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsxs)(r.ModalHeader, {
                        ...
                        className: _.content,
                        children: C || null == I ? (0, i.jsx)(r.Spinner, {
                    ...
                    children: [(0, i.jsxs)(r.FormText, {
                        ...
                        children: [(0, i.jsx)(r.Button, {
                            ...
                            onClick: () => {
                                ...
                                null != v && "" !== v.trim() && (d.default.track(E.AnalyticEvents.CLYDE_AI_GENERATE_PERSONALITY_CLICKED, {
                                    guild_id: n.guild_id
                                }), I(!0), (0, c.generatePersonality)(v).then(e => {
                                    null != e && (N(v), g(e), (0, c.setPendingPersonality)(e, !0)), I(!1)
                                }))
                            },
        ...
        709594: function(e, t, n) {
            ...
            function v(e) {
                ...
                } = (0, r.useStateFromStoresObject)([_.default], () => _.default.getPendingUpdates()), a = (0, r.useStateFromStores)([h.default], () => h.default.getMember(t, I.CLYDE_AI_USER_ID));
                return (0, i.jsxs)("div", {
            ...
            function S(e) {
                ...
                } = (0, r.useStateFromStoresObject)([_.default], () => _.default.getPendingUpdates()), c = (0, r.useStateFromStores)([p.default], () => p.default.getUser(I.CLYDE_AI_USER_ID));
                ...
                render() {
                    ...
                    return (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(u.FocusRing, {
                            within: !0,
                            children: (0, i.jsxs)("div", {
                                className: g ? r(E.imageUploaderIconWrapper, R) : void 0,
                                children: [(0, i.jsxs)("div", {
                                    className: r(E.imageUploaderInner, T),
                                    style: {
                                        ...L,
                ...
                (0, s.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                y = !0, null == p || p(), !v && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: m,
                            analyticsLocations: _,
                            analyticsObject: I,
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: A,
                            location_stack: _
                        }), (0, r.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == E || E(y), y && (!v && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == m || m())
                    },
        ...
        409214: function(e, t, n) {
            ...
            function C(e) {
                let {
                    ...
                    colorPickerFooter: T,
                    showEyeDropper: N
                } = e, R = l.useRef(null), M = (0, d.useToken)(u.default.colors.BACKGROUND_PRIMARY).hex(), A = u.default.colors.BACKGROUND_ACCENT.css, L = (0, p.isColorDark)(s), x = (0, o.int2hex)(s), P = x === M ? A : x, y = (0, f.getColor)(L ? m.Color.WHITE_500 : m.Color.PRIMARY_530), O = (0, c.default)(S), b = (0, c.default)(T), [U, j] = l.useState((0, a.v4)());
                return l.useEffect(() => {
                    (O !== S || b !== T) && j((0, a.v4)())
        ...
        121370: function(e, t, n) {
            ...
            function I(e) {
                ...
                return (0, i.jsx)(p.default, {
                    ...
                    disabled: !A && !I,
                    className: s(_.profileThemesSection, g),
                    showPremiumIcon: v,
                    forcedDivider: T,
                    children: (0, i.jsxs)("div", {
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: _,
                    ...I
                } = e, C = r.createRef(), g = (0, c.default)(C), v = !i && !a && !0 !== u && (!_ || g);

    ...
    [24251], {
        859917: (e, t, r) => {
            ...
            function g(e) {
                var t = e.children,
                    ...
                    a = h(e, ["children", "size", "className", "flowerStarClassName"]),
                    s = o.Children.only(t),
                    p = {
                        width: c,
                        height: c
                ...
                return (0, n.jsxs)("div", {
                    className: i()(b().flowerStarContainer, l),
                    style: p,
                    children: [(0, n.jsx)(f, d(y({}, a), {
                        className: i()(u, b().flowerStar)
                    })), (0, n.jsx)("div", {
        ...
        206986: (e, t, r) => {
            ...
            function x(e) {
                ...
                e[e.VERIFIED_AND_PARTNERED = 3] = "VERIFIED_AND_PARTNERED";
                e[e.VERIFIED_AND_HUB = 4] = "VERIFIED_AND_HUB";
                e[e.HUB = 5] = "HUB";
                e[e.NONE = 6] = "NONE"
            }(D || (D = {}));
            const N = function(e) {
                ...
                var o = r.prototype;
                o.renderBadge = function(e, t, r) {
                    var o = this.props,
                        c = o.className,
                        s = o.badgeStrokeColor,
                        f = o.tooltipColor,
                        p = void 0 === f ? l.Tooltip.Colors.BRAND : f,
                        b = o.tooltipPosition,
                        O = o.size,
                        y = void 0 === O ? 16 : O,
                        d = o.badgeColor,
                        h = o.iconClassName,
                        g = o.flowerStarClassName,
                        v = function(e) {
                            switch (e) {
                                case D.VERIFIED:
                                    return j.Z.Messages.GUILD_VERIFIED;
                                case D.PARTNERED:
                                    return j.Z.Messages.GUILD_PARTNERED;
                                case D.VERIFIED_AND_PARTNERED:
                                    return j.Z.Messages.GUILD_VERIFIED_AND_PARTNERED;
                                case D.VERIFIED_AND_HUB:
                                    return j.Z.Messages.HUB_VERIFIED_DISCORD_HUB;
                                case D.HUB:
                                    return j.Z.Messages.HUB_DISCORD_HUB;
                                case D.STAFF:
                                    return j.Z.Messages.INTERNAL_EMPLOYEE_ONLY;
                                case D.NONE:
                                    return null;
                                default:
                                    (0, u.vE)(e)
                    ...
                    return (0, n.jsx)(l.Tooltip, {
                        ...
                        text: v,
                        children: function(o) {
                            if (e === D.HUB || e === D.VERIFIED_AND_HUB) {
                                var l = {
                                    width: y,
                                    height: y
                                };
                                return (0, n.jsx)("div", E(m({}, o), {
                                    className: i()(r, c),
                                    style: l,
                                    children: (0, n.jsx)(t, {
                                        className: i()(w().icon, h)
                                    })
                                }))
                            }
                            return (0, n.jsx)(a.Z, E(m({}, o), {
                                className: i()(r, c),
                ...
                o.render = function() {
                    ...
                    return t.has(g.oNc.INTERNAL_EMPLOYEE_ONLY) ? this.renderBadge(D.STAFF, d.Z, w().staff) : t.has(g.oNc.VERIFIED) && t.has(g.oNc.HUB) ? this.renderBadge(D.VERIFIED_AND_HUB, O, w().verifiedHub) : t.has(g.oNc.HUB) ? this.renderBadge(D.HUB, O, w().hub) : t.has(g.oNc.VERIFIED) && t.has(g.oNc.PARTNERED) ? this.renderBadge(D.VERIFIED_AND_PARTNERED, h.Z, w().verified) : t.has(g.oNc.VERIFIED) ? this.renderBadge(D.VERIFIED, h.Z, w().verified) : t.has(g.oNc.PARTNERED) ? this.renderBadge(D.PARTNERED, y.Z, w().partnered) : null
                };
                return r
            }(o.PureComponent)
        },
        124251: (e, t, r) => {
            ...
            var V, H, G = {
                ...
                z = (N(V = {}, G.SMOL, 16), N(V, G.MINI, 20), N(V, G.SMALLER, 24), N(V, G.SMALL, 30),
                    N(V, G.MEDIUM, 40), N(V, G.LARGE, 50), N(V, G.LARGER, 64), N(V, G.XLARGE, 100), V),
                X = (N(H = {}, G.SMOL, [10, 10, 8, 6, 6, 4]), N(H, G.MINI, [12, 12, 10, 10, 8, 6, 4]), N(H, G.SMALLER, [13, 13, 11, 11, 9, 7, 5]), N(H, G.SMALL, [14, 14, 12, 12, 10, 8, 6]), N(H, G.MEDIUM, [16, 16, 14, 14, 12, 10, 8]), N(H, G.LARGE, [18, 18, 16, 16, 14, 12, 10]), N(H, G.LARGER, [19, 19, 17, 17, 15, 13, 11]), N(H, G.XLARGE, [20, 20, 18, 18, 16, 14, 12]), H),
                Y = function(e) {
                    k(r, e);
                    var t = F(r);
                    ...
                    var c = r.prototype;
                    c.renderAcronym = function() {
                        var e = this.props,
                            t = e.guild,
                            r = e.iconSrc;
                        return null != t.icon || null != r ? null : (0, n.jsx)("div", {
                            className: I().acronym,
                            children: t.acronym
                        })
                    };
                    c.renderBadge = function() {
                        ...
                        return t && null != r.hasFeature ? (0, n.jsx)(R.Z, {
                    ...
                    c.renderIcon = function() {
                        var e, t, r, o = this.props,
                            c = o.guild,
                            l = o.className,
                            u = (o.showBadge, o.active),
                            a = o.size,
                            f = o.style,
                            p = void 0 === f ? {} : f,
                            b = o.textScale,
                            O = (o.showTooltip, o.tooltipPosition,
                                o.onClick),
                            y = o.to,
                            d = (o.badgeStrokeColor, o.animate, o.tabIndex),
                            h = (o.iconSrc, o["aria-hidden"]),
                            g = Z(o, ["guild", "className", "showBadge", "active", "size", "style", "textScale", "showTooltip", "tooltipPosition", "onClick", "to", "badgeStrokeColor", "animate", "tabIndex", "iconSrc", "aria-hidden"]),
                            j = X[a],
                            v = null != O ? s.Clickable : "div";
                        return (0, n.jsxs)(v, M(A({
                            className: i()(I().icon, l, (0, S.l)(I(), "iconSize", a), (r = {}, N(r, null !== (e = (0, S.l)(I(), "iconActive", a)) && void 0 !== e ? e : "", u), N(r, I().iconInactive, !u), N(r, I().noIcon, null == c.icon), r)),
                            "aria-hidden": h,
                            style: null == c.icon ? A({
                                fontSize: (null !== (t = j[c.acronym.length]) && void 0 !== t ? t : j[j.length - 1]) * b
                            }, p) : p,
                            onClick: null != y || null == O ? void 0 : O,
                            tabIndex: d
                        }, g), {
                    ...
                    c.renderTooltip = function() {
                        var e = this,
                            ...
                            c = t.showTooltip,
                            i = t.tooltipPosition;
                        return c ? (0, n.jsx)(s.Tooltip, {
                            text: r.name,
                            position: i,
                            "aria-label": !1,
                            children: function(t) {
                                return o.cloneElement(o.Children.only(e.renderIcon()), A({}, t))
                            }
                        }) : this.renderIcon()
                    };
                    c.render = function() {
                ...
                W = u.ZP.connectStores([m.Z], (function(e) {
                    var t = e.guild,
                        r = e.animate,
                        n = e.iconSrc,
                        o = e.style,
                    ...
                    return {
                        style: M(A({}, o), {
                            backgroundImage: (0, E.rv)(null != n ? n : t.getIconURL(z[c], r && m.Z.isFocused()))
                        })
                    }
                }))(function(e) {
                    var t = function(t) {
                        ...
                        function o(e) {
                            ...
                            var t;
                            (t = r.call(this, e)).cachedURLs = [];
                            t.canceller = null;
                            var n = e.style,
                                c = null != n ? P(n.backgroundImage) : null;
                            t.cachedURLs = [c];
                            t.state = {
                                cached: c,
                                loaded: !0
                        ...
                        c.componentDidUpdate = function(e, t) {
                            ...
                            if (t !== this.state) {
                                var n = this.state,
                                    ...
                                    c = n.loaded,
                                    i = this.props.style,
                                    l = null != i ? P(i.backgroundImage) : null;
                                null == l && l !== o || this.cachedURLs.indexOf(l) >= 0 ? this.setState({
                                    loaded: !0,
                                    cached: l
                                }) : null != l && l !== o && !0 === c && this.setState({
                                    loaded: !1
                                }, (function() {
                                    return r.preloadURL(l)
                                }))
                            }
                        };
                        c.preloadURL = function(e) {
                            ...
                            this.canceller = (0, b.po)(e, (function(r) {
                                t.canceller && (t.canceller = null);
                                if (!r) {
                                    t.cachedURLs.push(e);
                                    t.setState({
                                        cached: e,
                                ...
                                var n = t.props.onBackgroundImageLoad;
                                n && n(r, e)
                            }))
                        };
                        c.componentWillUnmount = function() {
                            this.canceller && this.canceller();
                            this.cachedURLs.length = 0
                        };
                        c.render = function() {
                            var t, r = this.props,
                                o = r.style,
                                c = (r.onBackgroundImageLoad, g(r, ["style", "onBackgroundImageLoad"])),
                                i = this.state,
                                l = i.loaded,
                                u = i.cached;
                            l || null == o || (o = h(d({}, o), {
                                backgroundImage: (t = u,
                                    null == t || "" === t || "none" === t ? "none" : "url(".concat(t, ")"))
                            }));
                            return (0, n.jsx)(e, d({
                                style: o
                            }, c))
            ...
            q.defaultProps = {
                ...
                active: !1,
                tooltipPosition: "top",
                badgeStrokeColor: a.Z.unsafe_rawColors.WHITE_500.css,
                animate: !1
            };
            const J = q
        },

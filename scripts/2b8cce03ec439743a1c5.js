...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [95338, 96043, 71402], {
        ...
        385028: (e, t, n) => {
            ...
            const s = i.memo((function(e) {
                var t = e.user,
                    ...
                    p = e["aria-hidden"],
                    h = void 0 !== p && p,
                    v = a(e, ["user", "size", "animate", "aria-hidden"]),
                    O = i.useContext(u.Z);
            ...
            var y = function(e) {
                ...
                n.prototype.render = function() {
                    var e, t = this.props,
                        ...
                        _ = g.errorMessage,
                        E = g.retrySuccess,
                        S = i.Children.count(c) > 0 ? (0, r.jsx)(l.Card, {
                    ...
                    return (0, r.jsx)(l.ModalRoot, {
                        ...
                        children: (0, r.jsxs)("form", {
                            ...
                            children: [(0, r.jsx)(l.ModalHeader, {
                                ...
                                children: [null != v ? (0, r.jsx)(l.Text, {
                                    color: "text-normal",
                                    variant: "text-md/normal",
                                    className: s().spacing,
                                    children: v
                                }) : null, S, P, (0, r.jsxs)(l.FormItem, {
            ...
            function Z(e) {
                ...
                if (!_.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== m.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = a.Z.getChannel(o),
                        l = L(u, i),
                        c = I({}, t, w(l), null != i && null != o && (0, P.AB)(o) ? N(0, o) : j(u));
                    _.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        165586: (e, t, n) => {
            ...
            var O = [v(r.RESOLUTION_720), v(r.RESOLUTION_1080), v(r.RESOLUTION_1440), v(r.RESOLUTION_SOURCE, (function() {
                    return c.Z.Messages.SCREENSHARE_SOURCE
                }))],
                y = [v(r.RESOLUTION_720), v(r.RESOLUTION_1080), v(r.RESOLUTION_1440)],
                g = function(e) {
                    return "".concat(e, "p")
                },
        ...
        189651: (e, t, n) => {
            ...
            function m(e, t) {
                p.default.track(O.rMx.VIEW_AS_ROLES_SELECTED, E(_({
            ...
            function I(e) {
                var t = f.Z.getChannelId(e),
                    n = u.Z.getChannel(t);
                if (!(null != t && (0, y.AB)(t)) && !s.Z.can(O.Plq.VIEW_CHANNEL, n)) {
            ...
            function w(e, t) {
                ...
                if (null != n) {
                    ! function(e, t) {
                        var n = S(l.ZP.getSelectableChannelIds(e)).concat(S(l.ZP.getVocalChannelIds(e))),
                            r = Array.from(t);
                        l.ZP.addConditionalChangeListener((function() {
                            ...
                            var i = S(l.ZP.getSelectableChannelIds(e)).concat(S(l.ZP.getVocalChannelIds(e))).filter((function(e) {
                                return !n.includes(e)
                            }));
                            i.length > 0 && A(e, i, []);
                            return !1
        ...
        18882: (e, t, n) => {
            ...
            function J(e) {
                var t = d.ZP.getMentionCount(e.id) > 0,
                    n = d.ZP.hasRelevantUnread(e) && (!v.Z.isMuted(e.id) || t) || (0, a.c)() && t,
            ...
            var ne = {},
                ...
                le = function(e) {
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, o, u;
                        return i().size(null !== (o = null === (n = w[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== o ? o : {}) + i().size(null !== (u = null === (r = R[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== u ? u : {})
                    };
        ...
        491260: (e, t, n) => {
            ...
            var F = function(e) {
                ...
                r.getActivities = function(e) {
                    ...
                    if (null == t) {
                        var n;
                        return null !== (n = A[e]) && void 0 !== n ? n : P
                    }
                    var r = R(e, t);
            ...
            const G = new F(a.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(e) {
                    ...
                    if (I[t] === e.status && A[t] === e.activities) return !1;
                    I[t] = e.status;
                    A[t] = e.activities;
                    delete N[t]
                }
            ...
            var d = {
                ...
                p = function(e) {
                    var t = e.direction,
                        ...
                        h = void 0 === p ? 24 : p,
                        v = e.color,
                        O = void 0 === v ? "currentColor" : v,
                        y = e.transition,
                        g = void 0 === y ? a().transition : y,
                        b = e.className,
                        _ = e.foreground,
                        E = e.expanded,
                        S = f(e, ["direction", "width", "height", "color", "transition", "className", "foreground", "expanded"]),
                        m = n;
                    !0 === E ? m = d.DOWN : !1 === E && (m = d.RIGHT);

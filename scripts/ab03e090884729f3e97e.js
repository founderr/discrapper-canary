                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = b(e.minStart),
                                ...
                                _ = b(e.minDirection),
                                R = b(e.maxDirection);
                            return new y(new w(C(n.x, i.x), C(d.x, f.x), C(p.x, h.x), C(v.x, g.x), S(_.x, R.x), E(e.easingFunctions)[0]), new w(C(n.y, i.y), C(d.y, f.y), C(p.y, h.y), C(v.y, g.y), S(_.y, R.y), E(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector2"
                }))
            ...
            var M = i.forwardRef(function(e, t) {
                var a = e.className,
                    ...
                    D = i.useCallback(function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == v || v(t), T.current.forEach(function(n, i) {
                                    var r = n.confetti,
                                        a = n.spriteCanvas;
                                    r.update(u), r.draw(a, t), r.shouldDestroy(e, u) && T.current.delete(i)
                                }), null == y || y(t), T.current.size > 0 ? P.current = window.requestAnimationFrame(D) : (t.clearRect(0, 0, e.width, e.height), P.current = null);
                                var n = Date.now();
                                0 !== F.current && (N.current = 1e3 / (n - F.current)), F.current = n
                            }
                        }
                    }, [u, y, v]);
                ...
                var I = i.useCallback(function(e, t) {
                    ...
                    z = i.useCallback(function(e, t, n, i, a) {
                        var u, o, l, d, f, p, v, y, b, M, T, P, F, N, D, z = (u = null !== (D = e.id) && void 0 !== D ? D : (0, r.v4)(), o = e, l = n, d = i, f = a, y = R((v = (p = o, h(h({
                            id: u
                            ...
                            rotation: (F = v.rotation, function(e) {
                                switch (e.type) {
                                    case "static":
                                        var t = _(e.value);
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var d = _(e.minStart),
                                            ...
                                            b = _(e.minDirection),
                                            R = _(e.maxDirection);
                                        return new g(new w(C(n.x, i.x), C(d.x, f.x), C(p.x, h.x), C(v.x, y.x), S(b.x, R.x), E(e.easingFunctions)[0]), new w(C(n.y, i.y), C(d.y, f.y), C(p.y, h.y), C(v.y, y.y), S(b.y, R.y), E(e.easingFunctions)[0]), new w(C(n.z, i.z), C(d.z, f.z), C(p.z, h.z), C(v.z, y.z), S(b.z, R.z), E(e.easingFunctions)[0]))
                                }
                            }(h(h({}, F), {
                                valueType: "Vector3"
                            }))),
                            ...
                            size: y,
                            opacity: (N = v.opacity, function(e) {
                                switch (e.type) {
                                    case "static":
                ...
                return i.useEffect(function() {
                    ...
                    return e("click", L, l), e("mousedown", O, d), e("mousemove", H, f), e("mouseup", j, p),
                        function() {
                            window.removeEventListener("click", L), window.removeEventListener("mousedown", O), window.removeEventListener("mousemove", H), window.removeEventListener("mouseup", H)
                        }
                }, [L, O, H, j, l, d, f, p]), i.useEffect(function() {
                    var e = M.current,
        ...
        473031: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    image: U,
                    recurrence_rule: A
                } = n, L = (0, a.useStateFromStores)([v.default], () => v.default.hasRsvp(F, N), [F, N]), O = (0, a.useStateFromStores)([o.default], () => o.default.isLurking(N), [N]), H = (0, a.useStateFromStores)([s.default], () => s.default.getStageInstanceByChannel(D), [D]), j = (0, a.useStateFromStores)([c.default], () => c.default.getChannel(D), [D]), G = (0, a.useStateFromStores)([p.default], () => p.default.getUser(I), [I]), {
                    speakers: B
                } = (0, g.default)({
                    id: D,
                    data: {
                ...
                }), q = (0, a.useStateFromStores)([f.default], () => f.default.getChannelId()), Y = (0, v.isGuildScheduledEventActive)(n), W = q === D && null != q && Y, X = B.filter(e => e.type === l.StageChannelParticipantTypes.VOICE), K = X.length, Q = (0, a.useStateFromStores)([d.default], () => d.default.can(b.Permissions.CONNECT, j), [j]), J = (0, y.default)(n), {
                    isMember: Z,
                    guild: $
                } = (0, m.default)(N, F), ee = null != n.recurrence_rule ? r.default.fromTimestamp(new Date(n.scheduled_start_time).getTime()) : void 0, et = (0, S.default)({
                    guild: $,
                    channel: j,
                ...
                return (0, i.jsx)(E.default, {
                    ...
                    imageSource: null != U ? (0, C.default)(n) : void 0,
                    ...
                    isNew: P,
                    guildEventId: F,
                    recurrenceRule: (0, x.recurrenceRuleFromServer)(A),
                    recurrenceId: ee
                })
            }
        },
        ...
        659707: function(e, t, n) {
            ...
            function I(e) {
                let {
                    ...
                    onClose: a,
                    guildId: I
                } = e, z = (0, g.useUID)(), V = (0, l.useStateFromStores)([v.default], () => v.default.getGuild(I)), k = (0, S.default)(null == V ? void 0 : V.id), U = (0, b.default)(I), A = r.useRef(y.default.ackMessageId(I, F.ReadStateTypes.GUILD_EVENT)), L = (0, M.default)();
                return r.useEffect(() => {
                    E.default.getGuildEventUserCounts(I), E.default.getGuildEventsForCurrentUser(I)
                }, [I]), r.useEffect(() => {
                    let e = v.default.getGuild(I);
                    if (!(null == e ? void 0 : e.hasFeature(P.GuildFeatures.HUB))) return;
                    let {
                        showHubEventsList: t
                    ...
                    w.default.track(P.AnalyticEvents.OPEN_MODAL, {
                        type: T.ANALYTICS_GUILD_EVENTS_MODAL_NAME,
                        guild_id: I,
                        guild_events_count: U.length
                    })
                }, []), r.useEffect(() => {
                    u(U).map(e => e.creator_id).filter(C.isNotNullish).uniq().forEach(e => {
                        h.default.requestMember(I, e)
                    })
                }, [I, U]), r.useEffect(() => {
                    null != I && (0, c.ackGuildFeature)(I, F.ReadStateTypes.GUILD_EVENT)
                    ...
                    children: [(0, i.jsxs)(s.ModalHeader, {
                        ...
                        children: [(0, i.jsx)(m.default, {
                            ...
                            children: U.length > 0 ? N.default.Messages.GUILD_EVENTS_PLURAL.format({
                                number: U.length
                            }) : N.default.Messages.GUILD_EVENTS
                            ...
                            children: [(0, i.jsx)("div", {
                                ...
                                children: N.default.Messages.SCHEDULE_EVENT
                            })]
                        }), (0, i.jsx)(s.Clickable, {
                            onClick: a,
                        ...
                        className: D.content,
                        children: U.length > 0 ? U.map(e => (0, i.jsx)(_.default, {
                            guildEvent: e,
                            guildId: I,
                            onActionTaken: a,
                            isNew: null != A.current && o.default.compare(e.id, A.current) > 0
                        }, e.id)) : (0, i.jsx)(R.default, {
                            guildId: I,
                            onClose: a
                        })
                    })]

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [89681], {
            ...
            var C = function(e) {
                ...
                t.prototype.render = function() {
                    ...
                    c && (e = (0, r.jsx)(h.Z, {
                        ...
                        children: y.Z.Messages.DELETE_MESSAGE_CONTEXT_MENU_HINT.format()
                    }));
                    (0, g.vc)(s) && (n = (0, r.jsx)(a.FormSwitch, {
                        ...
                        hideBorder: !0,
                        className: S().spacingTop,
                        children: y.Z.Messages.DELETE_MESSAGE_REPORT
                    }));
                    return (0, r.jsx)(f.Z.Provider, {
                        value: i.guild_id,
                        children: (0, r.jsxs)(a.ConfirmModal, A(M({
                            header: l ? y.Z.Messages.MODIFY_FOLLOWED_NEWS_HEADER : y.Z.Messages.DELETE_MESSAGE_TITLE,
                            confirmText: y.Z.Messages.DELETE,
                            ...
                            children: [(0, r.jsx)(a.Text, {
                                ...
                                className: S().spacing,
                                children: l ? y.Z.Messages.DELETE_FOLLOWED_NEWS_BODY : y.Z.Messages.DELETE_MESSAGE_BODY
                            }), (0, r.jsx)("div", {
                                className: S().message,
            ...
            const R = {
                confirmPin: function(e, n) {
                    (0, a.openModal)((function(t) {
                        ...
                        o = e.isPrivate() ? y.Z.Messages.PIN_MESSAGE_BODY_PRIVATE_CHANNEL : y.Z.Messages.PIN_MESSAGE_BODY.format({
                            channelName: i
                        });
                        return (0, r.jsx)(f.Z.Provider, {
                            value: e.guild_id,
                            children: (0, r.jsxs)(a.ConfirmModal, A(M({
                                header: y.Z.Messages.PIN_MESSAGE_TITLE,
                                confirmText: y.Z.Messages.PIN_CONFIRM,
                                cancelText: y.Z.Messages.CANCEL,
                ...
                confirmUnpin: function(e, n) {
                    (0, a.openModal)((function(t) {
                        return (0, r.jsx)(f.Z.Provider, {
                            value: e.guild_id,
                            children: (0, r.jsxs)(a.ConfirmModal, A(M({
                                header: y.Z.Messages.UNPIN_MESSAGE_TITLE,
                                confirmText: y.Z.Messages.UNPIN_CONFIRM,
                                cancelText: y.Z.Messages.CANCEL,
                                onConfirm: function() {
                                ...
                                children: [(0, r.jsx)(a.Text, {
                                    variant: "text-md/normal",
                                    className: S().spacing,
                                    children: y.Z.Messages.UNPIN_MESSAGE_BODY
                                }), (0, r.jsx)("div", {
                                    ...
                                    children: y.Z.Messages.UNPIN_MESSAGE_CONTEXT_MENU_HINT.format()
                                })]
                            }))
                        })
                    }))
                ...
                confirmEdit: function(e, n, t) {
                    (0, a.openModal)((function(o) {
                        return (0, r.jsx)(a.ConfirmModal, A(M({
                            header: y.Z.Messages.MODIFY_FOLLOWED_NEWS_HEADER,
                            confirmText: y.Z.Messages.CONFIRM,
                            cancelText: y.Z.Messages.CANCEL,
                            confirmButtonColor: a.Button.Colors.BRAND,
                            onConfirm: function() {
                            ...
                            children: (0, r.jsx)(a.Text, {
                                variant: "text-md/normal",
                                className: S().spacing,
                                children: y.Z.Messages.EDIT_FOLLOWED_NEWS_BODY
                            })
                        }))
                    }))
                }
        ...
        272112: (e, n, t) => {
            ...
            function j(e, n) {
                (0, N.Z)(e, n, void 0, m.Z.getOptions(n.id))
            }
        ...
        646161: (e, n, t) => {
            ...
            function S(e) {
                var n;
                return (u(n = {}, O, "Windows"), u(n, g, "Mac"), u(n, m, "Linux"), n)[N(e)]
            }

            function v() {
                var e = N();
                return y(e, !1, e === m ? "tar.gz" : null)
            }

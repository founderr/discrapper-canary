    ...
    [1162], {
        437763: (e, n, t) => {
            ...
            function u(e) {
                ...
                (0, r.useEffect)((function() {
                    n === o.A.PURCHASING ? p(u) : n === o.A.FAIL && p(c)
                }), [n, u, c]);
                (0, r.useEffect)((function() {
                    t === a.h8.CONFIRM && p(l)
                }), [t, l]);
        ...
        301162: (e, n, t) => {
            ...
            function O(e) {
                var n = e.width,
                    ...
                    u = e.foreground,
                    c = m(e, ["width", "height", "color", "foreground"]);
            ...
            function R(e, n) {
                ...
                switch (r) {
                    case g.rV.MONTH:
                        return A.Z.Messages.BILLING_PRICE_PER_MONTH.format({
                            price: a
                        });
                    case g.rV.YEAR:
                        return A.Z.Messages.BILLING_PRICE_PER_YEAR.format({
                            price: a
                        })
                }
            }
            var b = function(e) {
                ...
                return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsx)(s.Text, {
                        ...
                        className: o()(_().trialOfferText, v({}, _().tier0TrialOffer, n)),
                        children: void 0 !== t ? A.Z.Messages.PREMIUM_DISCOUNT_AMOUNT_OFF_BADGE.format({
                            percent: t
                        }) : A.Z.Messages.BILLING_TRIAL_FREE_TRIAL_TEXT
                    })
                })
            };
            const P = function(e) {
                var n, t, a = e.hideCloseButton,
                    c = void 0 !== a && a,
                    ...
                    m = e.onClose,
                    T = e.isGift,
                    C = e.upgradeToPremiumType,
                    A = e.headerTheme,
                    D = void 0 === A ? f.nL.DEFAULT : A,
                    P = e.className,
                    x = e.showTrialBadge,
                    j = void 0 !== x && x,
                    w = e.showDiscountBadge,
                    B = void 0 !== w && w,
                    M = C === g.p9.TIER_2;
                t = C === g.p9.TIER_0 ? S.Z : C === g.p9.TIER_1 ? O : p.Z;
                var Z, F = (0, i.e7)([u.Z], (function() {
                        return u.Z.useReducedMotion
                    })),
                    G = (0, I.Ng)(),
                    H = null == G || null === (n = G.discount) || void 0 === n ? void 0 : n.amount;
                return (0, r.jsxs)("div", {
                    "aria-hidden": !0,
                    className: o()((Z = {}, v(Z, _().headerBackground, !M), v(Z, D === f.nL.WINTER ? _().tier2HeaderBackgroundWinterTheme : _().tier2HeaderBackground, M), Z), P),
                    children: [F || D !== f.nL.WINTER ? null : (0, r.jsx)(N.Z, {
                        className: _().snow,
                        wind: 5
                    }), (j || B) && (0, r.jsx)(y, {
                        ...
                        children: [(0, r.jsxs)("div", {
                            children: [(0, r.jsx)(t, {
                                className: o()(_().headerIcon, v({}, _().nonTier2, !M))
                            }), (j || B) && (0, r.jsx)(b, {
                                isTier0: C === g.p9.TIER_0,
                                discountAmount: B ? H : void 0
                            })]
                        }), !c && (0, r.jsx)(s.ModalCloseButton, {
                            hideOnFullscreen: l,
                            onClick: m,
            ...
            function M(e) {
                var n = e.currentStep,
                    ...
                    i = B((0, j.z)({
                        purchaseState: t,
                        currentStep: n,
                        initialScene: x.NQ.Scenes.NORMAL,
                        purchaseScene: x.NQ.Scenes.SPEED_START,
                        errorScene: x.NQ.Scenes.NORMAL,
                        successScene: x.NQ.Scenes.FINISH
                    }), 2),
                    s = i[0],
                    u = i[1];
                return (0, r.jsx)(x.NQ, {
            ...
            function Z(e) {
                var n = e.currentStep,
                    ...
                    i = B((0, j.z)({
                        purchaseState: t,
                        currentStep: n,
                        initialScene: x.HC.Scenes.NORMAL,
                        purchaseScene: x.HC.Scenes.SPEED_START,
                        errorScene: x.HC.Scenes.NORMAL,
                        successScene: x.HC.Scenes.FINISH
                    }), 2),
                    s = i[0],
                    u = i[1];
                return (0, r.jsx)(x.HC, {
            ...
            function F(e) {
                var n = e.currentStep,
                    ...
                    i = B((0, j.z)({
                        purchaseState: t,
                        currentStep: n,
                        initialScene: x.Db.Scenes.IDLE_ENTRY,
                        purchaseScene: x.Db.Scenes.BOOST_START,
                        errorScene: x.Db.Scenes.ERROR,
                        successScene: x.Db.Scenes.BOOST_END
                    }), 2),
                    s = i[0],
                    u = i[1];
                return (0, r.jsx)(x.Db, {
            ...
            function k(e) {
                var n = e.currentStep,
                    ...
                    h = e.hideCloseButton,
                    L = e.showTrialBadge,
                    m = e.showDiscountBadge,
                    O = e.giftRecipient,
                    y = (0, i.e7)([u.Z], (function() {
                        return u.Z.useReducedMotion
                    })),
                    N = S ? f.nL.WINTER : f.nL.DEFAULT;
                return (0, l.a8)(O) && n !== c.h8.CONFIRM ? (0, r.jsxs)(s.ModalHeader, {
                            ...
                            children: function() {
                                switch (n) {
                                    case c.h8.PLAN_SELECT:
                                        return A.Z.Messages.GIFT_NITRO_ACTION;
                                    case c.h8.ADD_PAYMENT_STEPS:
                                        return A.Z.Messages.PAYMENT_METHOD_SELECTION;
                                    case c.h8.REVIEW:
                                        return A.Z.Messages.GIFT_PURCHASE_REVIEW;
                                    default:
                                        return A.Z.Messages.GIFT_NITRO_ACTION
                                }
                            }()
                    ...
                    children: (0, r.jsx)(P, {
                        ...
                        renderAnimation: function() {
                            return d === g.p9.TIER_0 ? (0, r.jsx)(M, {
                                className: H().headerAnimation,
                                currentStep: n,
                                purchaseState: a,
                                pause: y
                            }) : d === g.p9.TIER_1 ? (0, r.jsx)(Z, {
                                className: H().headerAnimation,
                                currentStep: n,
                                purchaseState: a,
                                pause: y
        ...
        630689: (e, n, t) => {
            ...
            function p(e, n, t, r, a, o, i) {
                ...
                s.done ? n(u) : Promise.resolve(u).then(r, a)
            }
            ...
            var j, w, B = (E(b = {}, R.IDLE_ENTRY, {
                ...
                G = function(e) {
                    ...
                    function a() {
                        S(this, a);
                        var e;
                        (e = n.apply(this, arguments)).backgroundAnimation = new u.Z.ValueXY({
                            x: 0,
                            y: 0
                        });
                        e.foregroundAnimation = new u.Z.ValueXY({
                            x: 0,
                            y: 0
                        });
                        e.didUnmount = !1;
                        e.animateIdleLoopBackground = function() {
                            if (!e.didUnmount) {
                                ...
                                u.Z.timing(e.backgroundAnimation.x, {
                        ...
                        e.animateIdleLoopForeground = function() {
                            if (!e.didUnmount) {
                                ...
                                u.Z.timing(e.foregroundAnimation.x, {
                                    toValue: Z.IDLE_LOOP.toValue,
                    ...
                    o.animateEntry = function(e) {
                        u.Z.parallel([u.Z.timing(this.foregroundAnimation.y, {
                            toValue: e.toValue,
                            duration: e.duration,
                            delay: e.delay || 0
                        }), u.Z.timing(this.backgroundAnimation.y, {
                            toValue: e.toValue,
            ...
            var H = (E(w = {}, j.ENTRY, {
                ...
                Y = Object.freeze({
                    ...
                    SIZE_MIN: 7,
                    SIZE_MAX: 15,
                    EASING_MIDDLE: u.Z.Easing.bezier(.3, .01, 0, .99),
                    EASING_END: u.Z.Easing.bezier(0, -.01, .99, 0)
                });
            ...
            function V(e) {
                var n = e.animate,
                    ...
                    o = t[0],
                    i = t[1],
                    u = (0, s.useSprings)(U.length, U.map((function(e, t) {
                        var r, a, s = t > 0 ? Y.DELAY_STAGGER * t + Math.random() * (Y.DELAY_MAX - Y.DELAY_MIN) + Y.DELAY_MIN : 0,
                            u = Math.random() * (Y.SIZE_MAX - Y.SIZE_MIN) + Y.SIZE_MIN;
                        return {
                            from: {

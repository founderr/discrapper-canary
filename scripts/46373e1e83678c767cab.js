(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["40317"], {
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = j(t.minStart),
                                ...
                                z = j(t.minDirection),
                                O = j(t.maxDirection);
                            return new y(new w(b(n.x, r.x), b(f.x, h.x), b(p.x, d.x), b(v.x, g.x), C(z.x, O.x), _(t.easingFunctions)[0]), new w(b(n.y, r.y), b(f.y, h.y), b(p.y, d.y), b(v.y, g.y), C(z.y, O.y), _(t.easingFunctions)[0]))
                    }
                }(d(d({}, t), {
                    valueType: "Vector2"
                }))
            ...
            var A = r.forwardRef(function(t, e) {
                var o = t.className,
                    ...
                    R = r.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                e.clearRect(0, 0, t.width, t.height), null == v || v(e), S.current.forEach(function(n, r) {
                                    var i = n.confetti,
                                        o = n.spriteCanvas;
                                    i.update(a), i.draw(o, e), i.shouldDestroy(t, a) && S.current.delete(r)
                                }), null == y || y(e), S.current.size > 0 ? E.current = window.requestAnimationFrame(R) : (e.clearRect(0, 0, t.width, t.height), E.current = null);
                                var n = Date.now();
                                0 !== k.current && (P.current = 1e3 / (n - k.current)), k.current = n
                            }
                        }
                    }, [a, y, v]);
                r.useEffect(function() {
                    null != E.current && (window.cancelAnimationFrame(E.current), E.current = window.requestAnimationFrame(R))
                }, [R]);
                var V = r.useCallback(function(t, e) {
                    ...
                    F = r.useCallback(function(t, e, n, r, o) {
                        var a, u, c, f, h, p, v, y, j, A, S, E, k, P, R, F = (a = null !== (R = t.id) && void 0 !== R ? R : (0, i.v4)(), u = t, c = n, f = r, h = o, y = O((v = (p = u, d(d({
                            id: a
                        }, l), p))).size), A = (j = function(t, e) {
                            if (null != t) {
                                ...
                                switch (t.type) {
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var f = z(t.minStart),
                                            ...
                                            j = z(t.minDirection),
                                            O = z(t.maxDirection);
                                        return new g(new w(b(n.x, r.x), b(f.x, h.x), b(p.x, d.x), b(v.x, y.x), C(j.x, O.x), _(t.easingFunctions)[0]), new w(b(n.y, r.y), b(f.y, h.y), b(p.y, d.y), b(v.y, y.y), C(j.y, O.y), _(t.easingFunctions)[0]), new w(b(n.z, r.z), b(f.z, h.z), b(p.z, d.z), b(v.z, y.z), C(j.z, O.z), _(t.easingFunctions)[0]))
                                }
                            }(d(d({}, k), {
                                valueType: "Vector3"
                            }))),
                            ...
                            opacity: (P = v.opacity, function(t) {
                                switch (t.type) {
                                    ...
                                    case "oscillating-random":
                                        return new w(b(t.minValue, t.maxValue), b(t.minStart, t.maxStart), b(t.minFinal, t.maxFinal), b(t.minDuration, t.maxDuration), C(t.minDirection, t.maxDirection), _(t.easingFunctions)[0])
                                }
                            }(d(d({}, P), {
                                valueType: "number"
                            }))),
                            spriteX: E * c.spriteWidth + 2 * E,
                            spriteY: S * c.spriteHeight + 2 * S,
                ...
                return r.useEffect(function() {
                    ...
                    return t("click", T, c), t("mousedown", N, f), t("mousemove", H, h), t("mouseup", B, p),
                        function() {
                            window.removeEventListener("click", T), window.removeEventListener("mousedown", N), window.removeEventListener("mousemove", H), window.removeEventListener("mouseup", H)
                        }
                }, [T, N, H, B, c, f, h, p]), r.useEffect(function() {
                    var t = A.current,
        ...
        516863: function(t, e, n) {
            var r = n("367753")(n("690516"), "Map");
            t.exports = r
        },
        664007: function(t, e, n) {
            var r = n("679991"),
                i = n("169789"),
                o = n("406449"),
                a = n("66703"),
        ...
        745011: function(t, e, n) {
            var r = n("690516")["__core-js_shared__"];
            t.exports = r
        },
        74590: function(t, e, n) {
            var r = n("963201");
            t.exports = function(t, e) {
                var n = t.__data__;
        ...
        128534: function(t, e, n) {
            t.exports = function(t, e) {
                return null == t ? void 0 : t[e]
            }
        },
        843879: function(t, e, n) {
            var r = n("870811");
            t.exports = function() {
                this.__data__ = r ? r(null) : {}, this.size = 0
            }
        },
        169160: function(t, e, n) {
            t.exports = function(t) {
                var e = this.has(t) && delete this.__data__[t];
                return this.size -= e ? 1 : 0, e
            }
        },
        927794: function(t, e, n) {
            var r = n("870811"),
        ...
        963201: function(t, e, n) {
            t.exports = function(t) {
                var e = typeof t;
                return "string" == e || "number" == e || "symbol" == e || "boolean" == e ? "__proto__" !== t : null === t
            }
        },
        43332: function(t, e, n) {
            var r, i = n("745011");
        ...
        186489: function(t, e, n) {
            t.exports = function() {
                this.__data__ = [], this.size = 0
            }
        },
        235723: function(t, e, n) {
            var r = n("523119"),
        ...
        285445: function(t, e, n) {
            var r = n("523119");
            t.exports = function(t) {
                return r(this.__data__, t) > -1
            }
        },
        956285: function(t, e, n) {
            var r = n("523119");
            t.exports = function(t, e) {
                var n = this.__data__,
                    i = r(n, t);
        ...
        406449: function(t, e, n) {
            var r = n("74590");
            t.exports = function(t) {
                return r(this, t).get(t)
            }
        },
        66703: function(t, e, n) {
            var r = n("74590");
            t.exports = function(t) {
                return r(this, t).has(t)
            }
        },
        245510: function(t, e, n) {
            var r = n("74590");
            t.exports = function(t, e) {
                var n = r(this, t),
                    i = n.size;
        ...
        506838: function(t, e, n) {
            ...
            let _ = f(g(function(t) {
                    return !0
                })),
                C = t => Object.assign(f(t), {
                    startsWith: e => C(v(t, g(t => w(t) && t.startsWith(e)))),
                    endsWith: e => C(v(t, g(t => w(t) && t.endsWith(e)))),
                    minLength: e => {
                        var n;
                        return C(v(t, (n = e, g(t => w(t) && t.length >= n))))
                    },
                    maxLength: e => {
                        var n;
                        return C(v(t, (n = e, g(t => w(t) && t.length <= n))))
                    },
                    includes: e => C(v(t, g(t => w(t) && t.includes(e)))),
                    regex: e => C(v(t, g(t => w(t) && !!t.match(e))))
                }),
                j = C(g(w)),
                z = (t, e) => g(n => x(n) && t <= n && e >= n),
                O = t => g(e => x(e) && e < t),
                A = t => g(e => x(e) && e > t),
                S = t => g(e => x(e) && e <= t),
                E = t => g(e => x(e) && e >= t),
                k = () => g(t => x(t) && Number.isInteger(t)),
                P = () => g(t => x(t) && Number.isFinite(t)),
                R = () => g(t => x(t) && t > 0),
                V = () => g(t => x(t) && t < 0),

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [6624, 97539, 84832, 88110, 96043, 53686, 56645, 71402], {
        737264: e => {
            "use strict";
        ...
        609853: (e, t, n) => {
            ...
            var h = function(e) {
                var t = e.invertColor,
                    ...
                    y = void 0 === v ? [] : v,
                    S = null,
                    I = c.Z.Messages.VERIFIED_BOT_TOOLTIP;
                switch (s) {
                    case l.H.SYSTEM_DM:
                    case l.H.OFFICIAL:
                        E = !0;
                        I = c.Z.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP;
                        S = c.Z.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    case l.H.SERVER:
                        S = c.Z.Messages.BOT_TAG_SERVER;
                        break;
                    case l.H.ORIGINAL_POSTER:
                        S = c.Z.Messages.BOT_TAG_FORUM_ORIGINAL_POSTER;
                        break;
                    case l.H.STAFF_ONLY_DM:
                        S = c.Z.Messages.STAFF_BADGE_TOOLTIP;
                        break;
                    case l.H.AI:
                        E = !0;
                        I = c.Z.Messages.AI_GENERATED_TOOLTIP;
                        S = c.Z.Messages.AI_TAG;
                        break;
                    case l.H.REMIX:
                        E = !1;
                        S = c.Z.Messages.REMIXING_TAG;
                        break;
                    case l.H.BOT:
                    default:
                        S = c.Z.Messages.BOT_TAG_BOT
                }
        ...
        58964: (e, t, n) => {
            ...
            function p(e, t) {
                ...
                var p, _, h, E, O, b = encodeURIComponent(c.toString()),
                    ...
                    S = "".concat(s, "/?link=").concat(b, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(g, "&efr=").concat(m);

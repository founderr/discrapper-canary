        ...
        220109: (e, t, n) => {
            ...
            function j(e) {
                var t = e.className,
                    ...
                    N = (0, l.e7)([d.ZP], (function() {
                        return d.ZP.getGuildScheduledEvent(g)
                    })),
                    x = null != N ? N : j,
                ...
                var w = x.entity_type,
                    P = x.status,
                    I = x.scheduled_start_time,
                    S = x.user_count,
                    C = void 0 === S ? 1 : S,
                    T = x.recurrence_rule;
                return (0, r.jsxs)("div", {
                    className: o()(O().statusContainer, t),
                    children: [(0, r.jsx)(v.z, {
                        ...
                        className: O().spacer
                    }), !m && null != n && (0, r.jsx)(a.Tooltip, {
                        text: b.Z.Messages.GUILD_EVENT_CREATED_BY.format({
                        ...
                        text: b.Z.Messages.GUILD_EVENT_INTERESTED_COUNT.format({
                            count: C
                        }),
                        children: function(e) {
                            return (0, r.jsxs)("div", y(h({
                                className: O().rsvpCount
                            }, e), {
                                children: [(0, r.jsx)(s.Z, {
                                    width: 12,
                                    height: 12,
                                    className: O().rsvpIcon
                                }), (0, r.jsx)(a.Text, {
            ...
            function N(e) {
                var t = e.headerVariant,
                    ...
                    d = e.imageSource;
                return (0, r.jsxs)("div", {
                    className: o()(g({}, O().withThumbnail, null != d)),
                    children: [(0, r.jsxs)("div", {
                        className: o()(g({}, O().descriptionWithThumbnail, null != d)),
            ...
            function x(e) {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(j, {
                        className: O().eventInfoStatusContainer,
                        creator: i,
                        guildId: d,
                        isHub: s,
                        isNew: f,
        ...
        616918: (e, t, n) => {
            ...
            function P(e) {
                var t = e.startTime,
                    ...
                    P = e.isNew,
                    I = e.recurrenceRule,
                    S = (0, s.O0)(b.tP.TEXT_BRAND),
                    C = (0, s.O0)(b.tP.TEXT_POSITIVE);
                null == O && (O = o === v.WX.EXTERNAL ? m.Z.Messages.STAGE_CHANNEL_HAPPENING_NOW : m.Z.Messages.STAGE_CHANNEL_LIVE_NOW);
                var T = N(i.useState((0, p.ub)(t, f)), 2),
                    D = T[0],
                    A = D.startDateTimeString,
                    _ = D.endDateTimeString,
                    Z = D.currentOrPastEvent,
                    k = D.upcomingEvent,
                    R = D.diffMinutes,
                    L = T[1];
                ...
                var M = A;
                null != _ && "" !== _ && (M = m.Z.Messages.START_DATE_TO_END_DATE.format({
                    start: A,
                    end: _
                }));
                var B = i.useMemo((function() {
                        return n === v.p1.ACTIVE ? x.STARTED : v.$I.has(n) ? x.ENDED : Z ? x.READY : k ? x.STARTING_SOON : x.SCHEDULED
                    }), [n, Z, k]),
                    G = function(e, t, n, i, o) {
                        switch (e) {
                            case x.STARTING_SOON:
                                return o > 0 ? m.Z.Messages.STARTING_IN_MINUTES.format({
                                    minutes: o
                                }) : m.Z.Messages.STARTING_SOON;
                            case x.READY:
                                return m.Z.Messages.STARTING_SOON;
                            case x.STARTED:
                                return null != i && "" !== i ? m.Z.Messages.START_DATE_TO_END_DATE_WITH_COLOR.format({
                                    start: n,
                ...
                if (null != I) {
                    var Y = (0, p.Ho)(I);
                    X = m.Z.Messages.GUILD_SCHEDULED_EVENT_RECURRENCE_RULE.format({
                        recurrenceRule: Y.toText()
                    })
                }
                return (0, r.jsxs)(w, {
                    className: l()(a, y({}, g().isRecurring, null != X)),
                    tooltipText: W,
                    children: [P ? (0, r.jsx)(E, {}) : (0, r.jsx)(U, {
                        color: z,
                        width: 20,
                        height: 20
                    }), (0,
            ...
            var _ = function(e, t) {
                ...
                k = i.memo((function(e) {
                    var t = e.guild,
                        ...
                        o = e.channel,
                        l = e.isMember,
                        u = (0, a.e7)([v.Z], (function() {
                            return null == t ? null : null !== (e = v.Z.getGuild(t.id)) && void 0 !== e ? e : new f.Z(t);
                            var e
                        }), [t]),
                        d = (0, I.u)(n, o),
                    ...
                    var g, h = null == d ? void 0 : d.IconComponent,
                        y = (0, r.jsxs)(r.Fragment, {
                            children: [null != h && (0, r.jsx)(h, {
                                ...
                                variant: "text-xs/normal",
                                children: (0, N.m)(null !== (g = null == d ? void 0 : d.locationName) && void 0 !== g ? g : "", !0)
                            })]
                        });
                    return (0, r.jsxs)("div", {
            ...
            var P = function(e) {
                ...
                S = function(e) {
                    ...
                    var N = null == i || null != i.icon,
                        x = l()((0, v.l)(y(), "guildIcon", N ? "Image" : "", null != u ? "Joined" : ""), g);
                    return null != n ? (0, r.jsx)(m.Z, {
                        ...
                        className: x,
                        "aria-label": h
                    }) : null != b ? (0, r.jsx)(a.Avatar, {
                        onClick: u,
                        src: b.getAvatarURL(null, 56),
                        size: a.AvatarSizes.SIZE_56,
                        className: x,
                        "aria-label": h
                    }) : null
                ...
                C = function(e) {
                    var t = e.title,
                        ...
                        l = (0, r.jsx)(a.Heading, {
                            ...
                            className: (0, v.l)(y(), "inviteDestination", i ? "Expired" : null != n ? "Joined" : ""),
                            children: t
                        });
                    return (0, r.jsxs)(b.Z, {

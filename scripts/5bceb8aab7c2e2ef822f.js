    ...
    [46106, 70801, 83081], {
        652411: (e, t, n) => {
            ...
            function R(e) {
                return function(e) {
                    switch (e.type) {
                        ...
                        case "linear-random":
                            return new O(g(e.minValue, e.maxValue), g(e.minAddValue, e.maxAddValue));
                        case "oscillating":
                            return new T(e.value, e.start, e.final, e.duration, e.direction, e.easingFunction);
                        case "oscillating-random":
                            return new T(g(e.minValue, e.maxValue), g(e.minStart, e.maxStart), g(e.minFinal, e.maxFinal), g(e.minDuration, e.maxDuration), y(e.minDirection, e.maxDirection), I(e.easingFunctions)[0])
                    }
                }(_(_({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = A(e.minValue),
                                r = A(e.maxValue);
                            return new h(new m(g(n.x, r.x)), new m(g(n.y, r.y)));
                        case "linear":
                            t = A(e.value);
                            var i = A(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = A(e.minAddValue),
                                a = A(e.maxAddValue);
                            return new h(new O(g(n.x, r.x), g(o.x, a.x)), new O(g(n.y, r.y), g(o.x, a.x)));
                        case "oscillating":
                            t = A(e.value);
                            var u = A(e.start),
                                l = A(e.final),
                                c = A(e.duration),
                                s = A(e.direction);
                            return new h(new T(t.x, u.x, l.x, c.x, s.x, e.easingFunction), new T(t.y, u.y, l.y, c.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = A(e.minValue), r = A(e.maxValue);
                            var d = A(e.minStart),
                                f = A(e.maxStart),
                                ...
                                C = A(e.minDirection),
                                R = A(e.maxDirection);
                            return new h(new T(g(n.x, r.x), g(d.x, f.x), g(p.x, _.x), g(E.x, v.x), y(C.x, R.x), I(e.easingFunctions)[0]), new T(g(n.y, r.y), g(d.y, f.y), g(p.y, _.y), g(E.y, v.y), y(C.y, R.y), I(e.easingFunctions)[0]))
                    }
                }(_(_({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = C(e.minValue),
                                r = C(e.maxValue);
                            return new v(new m(g(n.x, r.x)), new m(g(n.y, r.y)), new m(g(n.z, r.z)));
                        case "linear":
                            t = C(e.value);
                            var i = C(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = C(e.minAddValue),
                                a = C(e.maxAddValue);
                            return new v(new O(g(n.x, r.x), g(o.x, a.x)), new O(g(n.y, r.y), g(o.y, a.y)), new O(g(n.z, r.z), g(o.z, a.z)));
                        case "oscillating":
                            t = C(e.value);
                            var u = C(e.start),
                                l = C(e.final),
                                c = C(e.duration),
                                s = C(e.direction);
                            return new v(new T(t.x, u.x, l.x, c.x, s.x, e.easingFunction), new T(t.y, u.y, l.y, c.z, s.y, e.easingFunction), new T(t.z, u.z, l.z, c.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = C(e.minValue), r = C(e.maxValue);
                            var d = C(e.minStart),
                                f = C(e.maxStart),
                                ...
                                A = C(e.minDirection),
                                R = C(e.maxDirection);
                            return new v(new T(g(n.x, r.x), g(d.x, f.x), g(p.x, _.x), g(E.x, h.x), y(A.x, R.x), I(e.easingFunctions)[0]), new T(g(n.y, r.y), g(d.y, f.y), g(p.y, _.y), g(E.y, h.y), y(A.y, R.y), I(e.easingFunctions)[0]), new T(g(n.z, r.z), g(d.z, f.z), g(p.z, _.z), g(E.z, h.z), y(A.z, R.z), I(e.easingFunctions)[0]))
                    }
                }(_(_({}, e), {
                    valueType: "Vector3"
                }))
            ...
            function S(e, t, n, r, i) {
                ...
                return new c({
                    id: e,
                    position: b(o.position),
                    velocity: b(o.velocity),
                    rotation: N(o.rotation),
                    dragCoefficient: b(o.dragCoefficient),
                    size: a,
                    opacity: R(o.opacity),
                    ...
                    g = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == p || p(t), v.current.size > 0 ? m.current = window.requestAnimationFrame(g) : (t.clearRect(0, 0, e.width, e.height), m.current = null);
                                var n = Date.now();
                                0 !== O.current && (T.current = 1e3 / (n - O.current)), O.current = n
                            }
                        }
                    }), [a, p, f]);
                r.useEffect((function() {
                    null != m.current && (window.cancelAnimationFrame(m.current), m.current = window.requestAnimationFrame(g))
                }), [g]);
                var I = r.useCallback((function(e, t) {
                        v.current.set(e.id, {
                            confetti: e,
                            spriteCanvas: t
                        }), null == m.current && g()
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, m()];
                                    case 1:
                                        return e.sent(), v(), E.current = !0, O(!0), [2]
                                }
                            }))
                        }))
                    }), [O, m, v]);
        ...
        294882: (e, t, n) => {
            ...
            const v = function(e) {
                var t = e.message,
                    ...
                    m = e.onSaveText,
                    O = e.onResetText,
                    T = e.onSaveButtonColor,
                    g = e.disabled,
                    I = e.saveButtonTooltip,
                    y = i.useRef(null),
                    A = h((0, o.useSpring)((function() {
                        return {
                            spring: 0
                        }
                    })), 2),
                        ...
                        children: (0, r.jsxs)(u.FocusRingScope, {
                            ...
                            children: [(0, r.jsx)("div", {
                                ...
                                children: (0, r.jsx)(o.animated.div, {
                                    ...
                                    children: null !== (b = null != n ? n : t) && void 0 !== b ? b : s.Z.Messages.SETTINGS_NOTICE_MESSAGE
                                })
                            }), (0, r.jsxs)("div", {
                                className: f().actions,
                                children: [null != p && (0, r.jsx)(u.Button, {
                                    ...
                                    text: I,
                                    children: function(e) {
                                        return (0, r.jsx)(u.Button, E(function(e) {
                                            ...
                                            size: u.Button.Sizes.SMALL,
                                            color: null != T ? T : u.Button.Colors.GREEN,
                                            submitting: d,
                                            disabled: g,
                                            onClick: v
                                        }, e), {
        ...
        370801: (e, t, n) => {
            ...
            const O = function(e) {
                ...
                return T === d.t ? null : (0, r.jsxs)(r.Fragment, {
        ...
        18882: (e, t, n) => {
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != P[e] && null != P[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in P[e][t]) t === w ? f.ZP.isNewForumThread(u, t, r) && U[e][t]++ : o.default.compare(u, i) > 0 && !f.ZP.hasOpenedThread(u) && U[e][t]++
                        }
                    }
                }
            }
            ...
            function q(e) {
                var t = f.ZP.getMentionCount(e.id) > 0,
                    n = f.ZP.hasRelevantUnread(e) && (!E.Z.isMuted(e.id) || t) || (0, l.c)() && t,
        ...
        698011: (e, t, n) => {
            ...
            var O = {
                ...
                T = function(e) {
                    ...
                    i.animateTo = function(e) {
                        return u.Z.spring(this.animation, _(function(e) {
                            for (var t = 1; t < arguments.length; t++) {
                                var n = null != arguments[t] ? arguments[t] : {},
                                    r = Object.keys(n);
                                "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            T.contextType = l.AccessibilityPreferencesContext;
            const g = T
        },
        218372: (e, t, n) => {
            "use strict";
...
//# sourceMappingURL=5bceb8aab7c2e2ef822f.js.map
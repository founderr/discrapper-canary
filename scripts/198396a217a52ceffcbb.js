    ...
    [24795, 33600, 84832, 96043, 71402], {
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = w(t.minStart),
                                ...
                                P = w(t.minDirection),
                                I = w(t.maxDirection);
                            return new y(new O(_(n.x, r.x), _(f.x, d.x), _(p.x, h.x), _(v.x, g.x), E(P.x, I.x), S(t.easingFunctions)[0]), new O(_(n.y, r.y), _(f.y, d.y), _(p.y, h.y), _(v.y, g.y), E(P.y, I.y), S(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = P(t.minStart),
                                ...
                                w = P(t.minDirection),
                                I = P(t.maxDirection);
                            return new g(new O(_(n.x, r.x), _(f.x, d.x), _(p.x, h.x), _(v.x, y.x), E(w.x, I.x), S(t.easingFunctions)[0]), new O(_(n.y, r.y), _(f.y, d.y), _(p.y, h.y), _(v.y, y.y), E(w.y, I.y), S(t.easingFunctions)[0]), new O(_(n.z, r.z), _(f.z, d.z), _(p.z, h.z), _(v.z, y.z), E(w.z, I.z), S(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector3"
                }))
            ...
            function j(t) {
                ...
                if (!O.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== E.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = L(u, i),
                        c = I({}, e, R(a), null != i && null != o && (0, w.AB)(o) ? N(0, o) : A(u));
                    O.default.track(t, c, {
                        flush: n
                    })
                }
                    ...
                    i.render = function() {
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(l.ModalRoot, {
                                ...
                                className: C().modal,
                                "aria-labelledby": s,
                                children: [null != c.giftStyle && !b && (0, r.jsx)(P.Z, {
                                    ...
                                    children: [(0, r.jsx)(l.ModalCloseButton, {
                                        ...
                                        id: s,
                                        className: u()((e = {}, k(e, C().customGiftHeader, b && !m), k(e, C().header, !b || m), e)),
                                    ...
                                    }), b && null != c.giftStyle && !this.state.accepted && (0, r.jsx)(P.Z, {
                            ...
                            if (e && !r) {
                                if (n) {
                                    ...
                                    return R.Z.Messages.GIFT_SUBSCRIPTION_INFO.format({
                                        ...
                                        timeInterval: (null == u ? void 0 : u.interval) === I.rV.MONTH ? R.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_MONTH : R.Z.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_YEAR
                                    })
                                }
        ...
        491260: (t, e, n) => {
            ...
            function j(t) {
                ...
                delete R[t];
                if (null != P[t]) {
                    var e = m(u().sortBy(P[t], (function(t) {
                            return -t.timestamp
                        })), 1),
                        n = e[0];
            ...
            var F = function(t) {
                ...
                r.getStatus = function(t) {
                    ...
                    if (null == e) {
                        var i;
                        return null !== (i = I[t]) && void 0 !== i ? i : n
                    }
                    var o, u = C(t, e);
            ...
            const G = new F(l.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(t) {
                    ...
                    if (I[e] === t.status && T[e] === t.activities) return !1;
                    I[e] = t.status;
                    T[e] = t.activities;
                    delete N[e]
                }
        ...
        750203: (t, e, n) => {
            ...
            var R = function(t) {
                var e, o = t.game,
                    ...
                    g = I(t, ["game", "guild", "skuId", "pid", "className", "guildClassName", "size"]);
                null != f && (e = function(t) {
                    if (null == t) return null;
                    switch (t) {
                        case _.Si.GUILD:
        ...
        58964: (t, e, n) => {
            ...
            function h(t, e) {
                ...
                var p, h, v, y, g, b = encodeURIComponent(l.toString()),
                    ...
                    E = "".concat(f, "/?link=").concat(b, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(m, "&efr=").concat(O);

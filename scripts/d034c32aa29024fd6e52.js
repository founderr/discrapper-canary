(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["44005"], {
        ...
        111633: function(e, t, r) {
            ...
            e.exports = function(e) {
                var t, r;
                return (e = String(e).toLowerCase()).length < 3 ? e : (121 === e.charCodeAt(0) && (t = !0, e = "Y" + e.substr(1)), x.test(e) ? e = e.substr(0, e.length - 2) : b.test(e) && (e = e.substr(0, e.length - 1)), (r = g.exec(e)) ? o.test(r[1]) && (e = e.substr(0, e.length - 1)) : (r = E.exec(e)) && d.test(r[1]) && (e = r[1], _.test(e) ? e += "e" : C.test(e) ? e = e.substr(0, e.length - 1) : f.test(e) && (e += "e")), (r = v.exec(e)) && d.test(r[1]) && (e = r[1] + "i"), (r = y.exec(e)) && o.test(r[1]) && (e = r[1] + n[r[2]]), (r = N.exec(e)) && o.test(r[1]) && (e = r[1] + i[r[2]]), (r = T.exec(e)) ? c.test(r[1]) && (e = r[1]) : (r = m.exec(e)) && c.test(r[1]) && (e = r[1]), (r = h.exec(e)) && (c.test(r[1]) || u.test(r[1]) && !f.test(r[1])) && (e = r[1]), p.test(e) && c.test(e) && (e = e.substr(0, e.length - 1)), t && (e = "y" + e.substr(1)), e)
            };
            var n = {
                    ational: "ate",
                    tional: "tion",
        ...
        287850: function(e, t, r) {
            ...
            function A(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function(e) {
                    var t, r;
                    let n = null !== (r = null !== (t = b.default.lastMessageId(e.id)) && void 0 !== t ? t : e.lastMessageId) && void 0 !== r ? r : e.id,
                        i = e.isMessageRequestTimestamp;
                    if (null != i) {
                        let e = u(i).valueOf(),
                            t = y.default.fromTimestamp(e);
                        return y.default.compare(n, t) > 0 ? n : t
                    }
                    return n
                }(e);
                return {
            ...
            function S() {
                T.clear(), Object.values(_.default.getMutablePrivateChannels()).forEach(e => {
                    T.set(e.id, A(e))
                }), (0, p.isInMainTabsExperiment)() && (0, h.isSplitMessagesTab)() && x.default.getAddedToMessages().forEach(e => {
                    let t = _.default.getChannel(e);
                    null != t && (0, E.isGuildTextChannelType)(t.type) && T.set(t.id, A(t))
                })
            }
            ...
            class R extends c.default.Store {
                initialize() {
                    this.waitFor(_.default, g.default, C.default, v.default, x.default), this.syncWith([x.default, v.default], S)
                }
            ...
            var L = new R(f.default, {
                ...
                CHANNEL_UPDATES: function(e) {
                    ...
                    t.forEach(e => {
                        ((0, E.isPrivate)(e.type) || T.has(e.id)) && T.set(e.id, A(e))
                    })
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != n && T.set(t, A(n, r.id))
                },
        ...
        664336: function(e, t, r) {
            ...
            let v = e => {
                    ...
                    return null == j && "string" == typeof _ && (j = _), (0, n.jsx)(u.Tooltip, {
                        text: _,
                        color: g,
                        position: b,
                        hideOnClick: x,
                        ...
                        children: (0, n.jsxs)(u.FocusRingScope, {
                            ...
                            children: [(0, n.jsxs)("div", {
                                ...
                                children: [(0, n.jsxs)("div", {
                                    ...
                                    onDoubleClick: p,
                                    children: [o.isMobile && null != x ? (0, n.jsx)(a.default, {
                                        onClick: x,
            ...
            }, E.Divider = m, E.Caret = function(e) {
                let {
                    direction: t = "right"
                } = e;

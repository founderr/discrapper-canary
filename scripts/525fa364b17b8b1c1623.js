    ...
    ["33107"], {
            ...
            var n = l("872717"),
                ...
                c = {
                    resolveGiftCode: async function e(e) {
                        ...
                        try {
                            ...
                            if (null != n.application_id && n.application_id !== o.PREMIUM_SUBSCRIPTION_APPLICATION) {
                                let e = s.default.getApplication(n.application_id);
                                if (null == e) try {
                    ...
                    openNativeGiftCodeModal(e) {
                        r.default.openNativeAppModal(e, d.RPCCommands.GIFT_CODE_BROWSER)
                    },
                    ...l("812495").default
                }
        },
        ...
        534438: function(e, t, l) {
            ...
            var g = e => {
                ...
                let {
                    ...
                    speaker_count: O,
                    participant_count: T
                } = l, D = null !== (t = l.members) && void 0 !== t ? t : [], A = I ? D.slice(0, 3) : D, R = O - A.length;
                return I && (R += D.length - A.length), (0, n.jsxs)("div", {
        ...
        210721: function(e, t, l) {
            ...
            var n, i, s = l("627445"),
                ...
                c = l("659632"),
                f = l("78345");
            (i = n || (n = {})).ACTION = "action", i.LOOP = "loop", i.IDLE = "idle";
            let E = (e, t) => {
                    let i;
                    switch (e) {
                        case f.PremiumGiftStyles.SNOWGLOBE:
                            i = () => l.el("452661").then(l.t.bind(l, "452661", 19)).then(e => {
                                let {
                                    default: t
                                } = e;
                                return t
                        ...
                        case f.PremiumGiftStyles.BOX:
                            i = () => l.el("726871").then(l.t.bind(l, "726871", 19)).then(e => {
                                let {
                                    default: t
                                } = e;
                                return t
                        ...
                        case f.PremiumGiftStyles.CUP:
                            i = () => l.el("544929").then(l.t.bind(l, "544929", 19)).then(e => {
                                let {
                                    default: t
                                } = e;
                                return t
                        ...
                        case f.PremiumGiftStyles.STANDARD_BOX:
                            switch (t) {
                                case n.IDLE:
                                    i = () => l.el("973372").then(l.t.bind(l, "973372", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case n.LOOP:
                                    i = () => l.el("353540").then(l.t.bind(l, "353540", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    i = () => l.el("303473").then(l.t.bind(l, "303473", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                        ...
                        case f.PremiumGiftStyles.CAKE:
                            switch (t) {
                                case n.IDLE:
                                    i = () => l.el("127891").then(l.t.bind(l, "127891", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case n.LOOP:
                                    i = () => l.el("953820").then(l.t.bind(l, "953820", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    i = () => l.el("311972").then(l.t.bind(l, "311972", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                        ...
                        case f.PremiumGiftStyles.CHEST:
                            switch (t) {
                                case n.IDLE:
                                    i = () => l.el("269055").then(l.t.bind(l, "269055", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case n.LOOP:
                                    i = () => l.el("120467").then(l.t.bind(l, "120467", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    i = () => l.el("451680").then(l.t.bind(l, "451680", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                        ...
                        case f.PremiumGiftStyles.COFFEE:
                            switch (t) {
                                case n.IDLE:
                                    i = () => l.el("863089").then(l.t.bind(l, "863089", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                case n.LOOP:
                                    i = () => l.el("949233").then(l.t.bind(l, "949233", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t
                                    ...
                                    break;
                                default:
                                    i = () => l.el("361896").then(l.t.bind(l, "361896", 19)).then(e => {
                                        let {
                                            default: t
                                        } = e;
                                        return t

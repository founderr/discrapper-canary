...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [1025], {
        101025: (e, t, r) => {
            r.r(t);
            r.d(t, {
                useGuildFeedHideItem: () => M,
                useGuildFeedRemoveItem: () => _,
                targetToContext: () => v,
                default: () => w
            });
            var n = r(785893),
            ...
            function M(e, t) {
                return (0, n.jsx)(i.MenuItem, {
                    ...
                    label: h.Z.Messages.GUILD_FEED_HIDE_MESSAGE_ITEM,
                    action: function(r) {
                        r.stopPropagation();
                        return (0, E.NO)(e, t)
                    },
            ...
            function P(e, t) {
                t ? (0, i.openModal)((function(t) {
                    return (0, n.jsx)(i.ConfirmModal, m(function(e) {
                        ...
                        header: h.Z.Messages.GUILD_FEED_REMOVE_MESSAGE_ITEM_HEADER,
                        confirmText: h.Z.Messages.GUILD_FEED_REMOVE_CONFIRM,
                        ...
                        children: (0, n.jsx)(i.Text, {
                            ...
                            children: h.Z.Messages.GUILD_FEED_REMOVE_MESSAGE_ITEM_CONFIRM_TEXT
                        })
                    }))
                })) : (0, E.AT)(e)
            }
            ...
            function _(e, t, r) {
                var o = (0,
                        c.ZP)([d.default], (function() {
                        return d.default.getId()
                    })),
                    u = (0, c.ZP)([O.Z], (function() {
                        return O.Z.can(y.Plq.MANAGE_MESSAGES, r)
                    }), [r]);
                if (!(t.author.id === o || u)) return null;
                return (0, n.jsx)(i.MenuItem, {
                    id: "remove-feed-message",
                    label: h.Z.Messages.GUILD_FEED_REMOVE_MESSAGE_ITEM,
                    action: function(t) {
                        t.stopPropagation();
                        var r = !0;
                        t.shiftKey && (r = !1);
            ...
            function w(e) {
                var t = e.channel,
                    ...
                    E = O.textContent,
                    y = (0, a.Z)(r, t),
                    j = (0, p.Z)(null != b ? b : g, E),
                    m = (0, f.Z)(g),
                    P = (0, s.Z)({
                        id: r.id,
                        label: h.Z.Messages.COPY_ID_MESSAGE,
                ...
                return (0,
                    ...
                    navId: "message",
                    onClose: u.Zy,
                    "aria-label": h.Z.Messages.MESSAGE_ACTIONS_MENU_LABEL,
                    onSelect: d,
...
//# sourceMappingURL=72ca9876a73b855257b4.js.map
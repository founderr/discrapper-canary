                            ...
                            for (var r, o = 1, a = 0; a < 1e3;) {
                                ...
                                var u = function(e, n) {
                                        ...
                                        function _(e) {
                                            ...
                                            for (l = n[u]; l <= n[s]; l++)
                                                if (p[l] > E / 2) {
                                                    for (r = n.copy(), o = n.copy(), t = l - n[u], a = t <= (i = n[s] - l) ? Math.min(n[s] - 1, ~~(l + i / 2)) : Math.max(n[u], ~~(l - 1 - t / 2)); !p[a];) a++;
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: o,
                        round: a
                    } = Math, u = e[0] | e[1] << 8 | e[2] << 16, l = e[3] | e[4] << 8, s = (63 & u) / 63, c = (u >> 6 & 63) / 31.5 - 1, d = (u >> 12 & 63) / 31.5 - 1, f = u >> 23, E = l >> 15, p = r(3, E ? f ? 5 : 7 : 7 & l), h = r(3, E ? 7 & l : f ? 5 : 7), _ = f ? (15 & e[5]) / 15 : 1, g = (e[5] >> 4) / 15, I = f ? 6 : 5, m = 0, v = (t, n, i) => {
                        let r = [];
                        for (let o = 0; o < n; o++)

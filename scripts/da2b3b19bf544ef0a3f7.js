    ...
    ["76381"], {
        ...
        359113: function(e, t, s) {
            ...
            function C(e) {
                let {
                    onClose: t,
                    transitionState: s
                } = e, [l, c] = r.useState(""), [I, C] = r.useState(""), [R, p] = r.useState(null), [O, v] = r.useState(!1), [M, g] = r.useState(n.DOMAIN), T = () => {
                    v(!0), p(null), a.default.post({
                        url: N.Endpoints.CONNECTION(N.PlatformTypes.DOMAIN, l),
                        body: {}
                    }).then(() => {
                        t()
                    }).catch(e => {
                        var t, s, l, o, r, a, i;
                        (null === (t = e.body) || void 0 === t ? void 0 : t.proof) && M === n.DOMAIN ? (C(e.body.proof), g(n.PROOF_DNS)) : p((null === (a = e.body) || void 0 === a ? void 0 : null === (r = a.errors) || void 0 === r ? void 0 : null === (o = r.domain) || void 0 === o ? void 0 : null === (l = o._errors) || void 0 === l ? void 0 : null === (s = l[0]) || void 0 === s ? void 0 : s.message) || (null === (i = e.body) || void 0 === i ? void 0 : i.message) || e.message)
                    }).finally(() => {
                        v(!1)
                    })
                };
        ...
        188525: function(e, t, s) {
            ...
            f.contextType = a.FormContext, f.defaultProps = {
                ...
                mode: I.DEFAULT
            }, f.Modes = I, f.ButtonColors = a.ButtonColors, f.ButtonLooks = a.ButtonLooks;
            var N = f
        },

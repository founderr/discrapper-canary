    ...
    [9096], {
        ...
        693150: (e, r, t) => {
            ...
            function D(e) {
                ...
                return (0, n.jsxs)("div", {
                    ...
                    style: {
                        ...
                        backgroundImage: "url(".concat((0, I.uV)(r.banner, {
                            size: A
                        }), ")"),
                        ...
                        children: [Z && (0, n.jsx)(f.Tooltip, {
                            ...
                            children: [i && (0, n.jsx)(f.Text, {
                                ...
                                children: [(0, n.jsxs)("div", {
                                    ...
                                    children: (we = (0, T.Ch)(N), i || null != Y ? null == Y && Z ? (0, n.jsxs)("div", {
            ...
            function Me() {
                ...
                return (0, n.jsxs)("div", {
                    className: Ie().heroBanner,
                    children: [(0, n.jsxs)("div", {
                        className: Ie().heroDescription,
                        children: [(0, n.jsxs)(f.Text, {
                            color: "always-white",
                            variant: "eyebrow",
                            className: Ie().premiumBadgeWrapper,
                            children: [(0,
                                n.jsx)(K.Z, {
                                className: Ie().premiumBadge
                            }), (0, n.jsx)("span", {
                                className: Ie().premiumBadgeText,
                                children: oe.Z.Messages.REMIXING_TOOLTIP_NITRO_EARLY_ACCESS
                            })]
                        }), (0, n.jsx)(f.Heading, {
                            className: Ie().bannerTitle,
                            color: "always-white",
                            variant: "display-lg",
                            children: oe.Z.Messages.COLLECTIBLES_SHOP_HERO_BANNER_TITLE
                        }), (0, n.jsx)(f.Text, {
                            className: Ie().heroSubtitle,
                            color: "always-white",
                            variant: "text-lg/normal",
                            children: oe.Z.Messages.COLLECTIBLES_SHOP_HERO_BANNER_SUBTITLE
                        }), r ? null : (0, n.jsx)(W.Z, {
                            className: Ie().subscribeButton,
                            isTrialCTA: !0,
                            buttonText: oe.Z.Messages.COLLECTIBLES_NON_PREMIUM_SHOP_CTA,
                            subscriptionTier: ne.Si.TIER_2
                        })]
                    }), (0, n.jsx)("div", {
                        className: Ie().bannerBackgroundWrapper,
                        children: (0, n.jsx)("img", {
                            className: Ie().bannerBackground,
                            alt: "",
                            src: _e()
                        })
                    }), (0, n.jsx)("img", {
                        className: Ie().bannerForeground,
                        alt: "",
                        src: ke()
                    }), (0, n.jsx)("img", {
                        className: Ie().bannerHand,
                        alt: "",
                        src: Ze()
                    }), (0, n.jsx)("img", {
                        className: s()(Ie().largeSparkle, Ie().largeTopSparkle),
                        alt: "",
                        src: Re()
                    }), (0, n.jsx)("img", {
                        className: s()(Ie().smallSparkle, Ie().smallTopSparkle),
                        alt: "",
                        src: Re()
                    }), (0, n.jsx)("img", {
                        className: s()(Ie().largeSparkle, Ie().largeLeftSparkle),
                        alt: "",
                        src: Re()
                    }), (0, n.jsx)("img", {
                        className: s()(Ie().smallSparkle, Ie().smallLeftSparkle),
                        alt: "",
                        src: Re()
                    }), (0, n.jsx)("img", {
                        className: s()(Ie().largeSparkle, Ie().largeRightSparkle),
                        alt: "",
                        src: Re()
                    }), (0, n.jsx)("img", {
                        className: s()(Ie().smallSparkle, Ie().smallRightSparkle),
                        alt: "",
                        src: Re()
                    })]
                })

    ...
    [92465], {
        ...
        99440: (e, n, t) => {
            ...
            function R(e, n) {
                ...
                if (null == e) return [];
                var u = e.embeds;
                return t && i && null != u ? u.map((function(e) {
            ...
            function b(e, n) {
                ...
                })) && r.isForumPost() && r.ownerId === (null === (t = c.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && 0 === u.Z.getCount(r.id) && (0 === i.attachments.length || null == i.attachments.find((function(e) {
                    return h(e) || _(e)
                }))))
            }
        ...
        327930: (e, n, t) => {
            ...
            var r = t(61209),
                ...
                v = new RegExp("^/events/(\\d+)(?:/)(\\d+)?"),
                p = new RegExp("^https://(?:canary\\.|ptb\\.)?discord.com/channels/(\\d+|".concat(l.ME, ")(?:/(\\d+|[a-zA-Z-]+))?(?:/(\\d+|[a-zA-Z-]+))?")),
            ...
            function y(e) {
                return !!e.isPrivate() || u.Z.can(l.Plq.VIEW_CHANNEL, e)
            }

            function m(e) {
                var n = e.guildId,
                    t = e.channelId;
                if (null == i.Z.getGuild(n) && n !== l.ME) return !1;
                if (null == t) return !0;
                var u = r.Z.getChannel(t);
                return null != u && y(u)
            }
        },
        970286: (e, n, t) => {
            ...
            function d(e) {
                ...
                var h = (0,
                    ...
                    m = null != E ? l.ZP.getName(i.guild_id, i.channel_id, E) : void 0,
                    O = null == E ? void 0 : E.getAvatarURL(null == u ? void 0 : u.id, 40);
                null != O && v === i.guild_id || (O = o.ZP.getGuildIconURL({
                    id: i.guild_id,
                    icon: i.guild_icon,
                    size: 40,
                    canAnimate: !1
            ...
            const Z = new U(o.Z, {
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    for (var t in A) {
                        ...
                        null != r && (n[t].mostRecentMessage = new s.Z(m(y({}, r), {
        ...
        176758: (e, n, t) => {
            ...
            var o = t(913302),
                ...
                _ = t(473708),
                y = g.d4z.GUILD_VOICE,
                m = g.d4z.GUILD_CATEGORY,
                O = g.d4z.GUILD_STAGE_VOICE;
            ...
            function S(e, n, t) {
                var i = p.ZP.NONE;
                ((0, c.r8)(n) || n === m) && (i = r.Z.add(i, g.Plq.VIEW_CHANNEL));
                if (R(n, y)) {
            ...
            function C(e, n, t) {
                var r, i, u = e.getGuildId(),
                    ...
                    p = !1;
                p = e.type === O ? null != u && (n.hasVideo(e.id) || (0, o.a)(f)) && c > 0 && s >= c : null != u && n.hasVideo(e.id) && a > 0 && s >= a + (E ? 1 : 0);

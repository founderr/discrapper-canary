(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["63930"], {
        ...
        178261: function(e, t, a) {
            ...
            function f(e) {
                let t = (0, s.useStateFromStores)([i.default, d.default], () => {
        ...
        852275: function(e, t, a) {
            ...
            function r(e) {
                let t = (0, s.useStateFromStores)([i.default], () => i.default.isCollapsed(e.id), [e.id]);
        ...
        308798: function(e, t, a) {
            ...
            function E(e) {
                let t = e.isForumPost(),
                    ...
                    g = (0, s.useStateFromStores)([r.default], () => {
                        var t;
                        return null !== (t = r.default.getCount(e.id)) && void 0 !== t ? t : 0
                    }, [e.id]),
                    {
                        firstMessage: S
                    } = (0, s.useStateFromStores)([d.default], () => d.default.getMessage(e.id), [e.id]),
                    L = t && (_ || E && g < 1),
                    T = t && E && !_ && g > 0 && null != S;
                return N && (_ || L || T) ? (0, n.jsx)(l.MenuItem, {
                    id: "delete-channel",
                    label: (() => {
        ...
        531674: function(e, t, a) {
            ...
            function S(e, t) {
                let [a, s] = (0, u.useStateFromStoresArray)([f.default], () => [f.default.isChannelMuted(e.guild_id, e.id), f.default.getChannelMuteConfig(e.guild_id, e.id)]), l = (0, o.useMutedUntilText)(s), E = (0, c.default)(e, !0);
                    ...
                    children: N().map(a => {
                        ...
                        return (0, n.jsx)(i.MenuItem, {
                            ...
                            action: () => (function(a) {
                                ...
                                let n = g(a);
                                r.default.updateChannelOverrideSettings(e.guild_id, e.id, n, t)
                            })(s)
                        }, s)
                    })
                })
        ...
        619436: function(e, t, a) {
            ...
            function f(e) {
                let t = e.getGuildId(),
                    a = e.id,
                    f = (0, s.useStateFromStores)([i.default], () => i.default.getChannelOverrides(t)[a], [t, a]),
                    ...
                    M = (0, s.useStateFromStores)([i.default], () => i.default.getNewForumThreadsCreated(e)),
                    E = null == f ? d.UserNotificationSettings.NULL : f.message_notifications,
                    _ = o(e);
                return null == _ ? null : (0, n.jsxs)(n.Fragment, {
                    children: [e.isForumLikeChannel() ? (0, n.jsxs)(n.Fragment, {
                        ...
                        return (0, n.jsx)(l.MenuRadioItem, {
                            ...
                            action: () => {
                                var e;
                                return e = s, void(null != t && u.default.updateChannelOverrideSettings(t, a, {
            ...
            function c(e) {
                var t, a;
                let u = f(e),
                    c = (0, s.useStateFromStores)([i.default], () => i.default.resolvedMessageNotifications(e), [e]),
                    M = (0, s.useStateFromStores)([i.default], () => i.default.getChannelOverrides(e.guild_id)[e.id], [e.guild_id, e.id]),
                ...
                return null != u ? (0, n.jsx)(l.MenuItem, {

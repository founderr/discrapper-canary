(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["39608"], {
            ...
            function l(e) {
                let [t, n] = r.useState(!1), [l, o] = r.useState(null), s = r.useCallback(async function() {
                    ...
                    try {
                        ...
                        e.message !== u.default.Messages.MFA_V2_CANCELED && o(new i.default(e))
                    } finally {
                        n(!1)
                    }
                }, [e]);
            ...
            function o(e) {
                ...
                switch (e.type) {
                    case l.ChannelTypes.DM:
                        let [o] = e.recipients.map(r.default.getUser).filter(u.isNotNullish);
        ...
        531034: function(e, t, n) {
            ...
            var r = n("161585"),
                i = n("782340");
            let u = () => [i.default.Messages.ROLE_SUBSCRIPTION_JOIN_CTA_LABEL1, i.default.Messages.ROLE_SUBSCRIPTION_JOIN_CTA_LABEL2],
                l = () => [i.default.Messages.ROLE_SUBSCRIPTION_RENEW_CTA_LABEL1, i.default.Messages.ROLE_SUBSCRIPTION_RENEW_CTA_LABEL2],
                o = [{
        ...
        795228: function(e, t, n) {
            ...
            function s(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                    n = (0, i.useStateFromStores)([l.default], () => l.default.getRoleMemberCount(e));
                return r.useEffect(() => {
                    if (null == e) return;
                    let n = o[e],
                        r = null != n && t > 0 && Date.now() - n < t;
                    !r && (o[e] = Date.now(), u.fetchMemberCounts(e))
                }, [e, t]), n
            }
        },
            ...
            var i = n("469563"),
                ...
                o = (0, i.replaceIcon)(function(e) {
                    ...
                    return (0, r.jsxs)("svg", {
                        ...
                        viewBox: "0 0 24 24",
                        xmlns: "http://www.w3.org/2000/svg",
                        children: [null != u ? (0, r.jsx)("circle", {
                            r: 8,
                            cx: 12,
                            cy: 12,
                            fill: u
                ...
                }, u.CircleInformationIcon, void 0, {
                    size: 24
                })
        },
        ...
        498574: function(e, t, n) {
            ...
            }), n("222007"), (i = r || (r = {}))[i.IS_GUEST_INVITE = 1] = "IS_GUEST_INVITE", i[i.IS_VIEWED = 2] = "IS_VIEWED", i[i.IS_ENHANCED = 4] = "IS_ENHANCED"
        }
    }
]);
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["62218"], {
        ...
        294135: function(e, t, s) {
            ...
            var eR = (0, m.default)((0, P.default)(c.default.connectStores([B.default, v.default, U.default, F.default, k.default, G.default, H.default, C.default, g.default, j.default, D.default, y.default], e => {
                var t;
                let s, a, n, {
                    inputSkuId: r,
                    applicationId: l,
                ...
                if (null == l) {
                    ...
                    s = r, null != (l = null != (a = G.default.get(r)) ? a.applicationId : null) && (n = g.default.getApplication(l))
                } else if (null == r) {
                    if (null == l) throw Error("Needs applicationId or skuId");
                    null != (n = g.default.getApplication(l)) && (s = n.destinationSkuId), a = null != s ? G.default.get(s) : null
                ...
                return {
                    skuId: s,
                    application: null != l ? g.default.getApplication(l) : null,
        ...
        404247: function(e, t, s) {
            ...
            var M = (0, l.withRouter)((0, c.default)((0, E.default)(L)))
        },
            ...
            class h extends l.PureComponent {
                ...
                getTitle(e) {
                    switch (e) {
                        ...
                        case a.DLC_REQUIRES_BASE_APPLICATION:
                        ...
                        case a.UNAVAILABLE_IN_LANGUAGE:
                ...
                getColorClass(e) {
                    if (e === a.RESTRICTED_IN_REGION) return C.red;
                    return C.yellow
                }
                renderWarning(e) {
                ...
                render() {
                    ...
                    return (e.restricted && l.push(this.renderWarning(a.RESTRICTED_IN_REGION)), (0, p.isWeb)() ? l.push(this.renderWarning(a.REQUIRES_DESKTOP_APP)) : !e.supportedOperatingSystems.includes((0, N.nativePlatformTypeToSKUOperatingSystem)((0, p.getPlatform)())) && l.push(this.renderWarning(a.UNAVAILABLE_OPERATING_SYSTEM)), null != t && !s && l.push(this.renderWarning(a.DLC_REQUIRES_BASE_APPLICATION)), e.accessType === m.SKUAccessTypes.EARLY_ACCESS && l.push(this.renderWarning(a.EARLY_ACCESS)), 0 === l.length) ? null : (0, r.jsx)("div", {
                        className: n,
                        children: l
                    })
                }
        ...
        886680: function(e, t, s) {
            ...
            function A(e, t) {
                let s = e.applicationId,
                    a = (0, T.getPrimarySKUForApplication)(s, d.default, E.default);
        ...
        729199: function(e, t, s) {
            ...
            var h = (0, E.default)(u.default.connectStores([S.default, _.default], e => {
                let {
                    guild: t
        ...
        104385: function(e, t, s) {
            ...
            var C = e => {
                ...
                let {
                    ...
                    location: C
                }), O = n.useRef(null), h = (0, i.default)([E.default], () => E.default.getCurrentUser()), L = g && !I.default.canUseCollectibles(h);
                return n.useEffect(() => {
                    _.default.track(S.AnalyticEvents.PREMIUM_UPSELL_VIEWED, {
                        type: t,
                        location_stack: R
                    })
                }, [t, R]), (0, a.jsxs)("div", {
                    ref: O,
                    className: l(p.container, s ? p.marketingPage : p.containerDefaultMargin, L ? p.shopForAllBackgroundImage : p.falloweenBackgroundImage, r),
                    children: [L ? (0, a.jsx)(P, {}) : (0, a.jsx)(m, {}), (0, a.jsx)(u.Button, {
                        onClick: () => {
        ...
        595426: function(e, t, s) {
            ...
            var a = s("37983"),
                ...
                B = function(e) {
                    ...
                    } = (0, f.default)(T.default.PREMIUM_MARKETING), G = (0, i.useStateFromStores)([m.default], () => m.default.hasFetchedSubscriptions()), k = (0, i.useStateFromStores)([N.default], () => N.default.getCurrentUser()), H = (0, x.usePremiumTrialOffer)(), F = (0, M.usePremiumDiscountOffer)(), K = (0, R.useSubscriptionPlansLoaded)(), [w, W] = n.useState(!0), V = n.useRef(0), Y = (0, C.isPremiumExactly)(k, D.PremiumTypes.TIER_2), z = (0, L.useLocalizedPromoQuery)(), Q = null == z ? void 0 : z.countryCode;
                    n.useEffect(() => {
                        d.default.wait(async () => {
                            let e = Date.now();
                            await Promise.all([c.fetchSubscriptions(), (0, E.fetchGuildBoostSlots)(), c.fetchPaymentSources(), (0, _.fetchPremiumSubscriptionPlans)(Q, null, b.RevenueSurfaces.DISCOVERY)]), V.current = Date.now() - e, W(!1)
                        })
                    }, [Q]), n.useEffect(() => {
                        if (s && (null != H || null != F)) {
                            let {
                    ...
                    let [X, Z] = n.useState(!1), J = (0, i.useStateFromStores)([p.default], () => p.default.enabled);
            ...
            var a = s("37983"),
                ...
                R = e => {
                    let {
                        subscriptionTrial: t,
                        expiresAt: s
                    } = e, R = (0, c.formatPriceString)((0, c.getDefaultPrice)(_.SubscriptionPlans.PREMIUM_MONTH_TIER_2), _.SubscriptionIntervalTypes.MONTH), A = (0, c.formatIntervalDuration)({
                        ...
                        duration: A,
                        price: R
                    }), N = p.split(" "), [m, P] = n.useState(!1), [C, g] = n.useState(!1), [O, h] = n.useState(!1), L = (0, r.default)([u.default], () => u.default.useReducedMotion), [M, x] = (0, o.useDismissibleContentGroup)([l.DismissibleContent.Q4_MARKETING_PAGE_HEADER_ANIMATION]);
                    return (n.useEffect(() => () => {
                        M === l.DismissibleContent.Q4_MARKETING_PAGE_HEADER_ANIMATION && x(T.ContentDismissActionType.TAKE_ACTION)
                    }, [M, x]), L || M !== l.DismissibleContent.Q4_MARKETING_PAGE_HEADER_ANIMATION) ? (0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)(i.Text, {
                            ...
                            children: (0, a.jsx)(i.Text, {
                                ...
                                children: (0, E.getOfferEndsText)(s)
                            })
                        }), (0, a.jsx)("div", {
        ...
        958966: function(e, t, s) {
            ...
            var n = s("414456"),
                ...
                m = e => {
                    ...
                    } = (0, u.default)(i.default.PREMIUM_MARKETING_HERO_CTA), C = (0, c.useHasActiveTrial)(), g = (0, d.useIsInPremiumOfferExperience)(), O = (0, I.useIsEligibleForBogoPromotion)(), h = (0, _.usePremiumTrialOffer)(), L = (null == h ? void 0 : h.trial_id) === A.PREMIUM_TIER_2_TRIAL_FOR_EVERYONE_TRIAL_ID, {
                        enabled: M
        ...
        830648: function(e, t, s) {
            ...
            var O = e => {
                let {
                    ...
                    location: "PerkCard",
                    autoTrackExposure: !1
                }), L = [_.emoji, _.streaming, _.upload, h ? _.customAppIcons : null, _.soundboard, O ? _.remix : _.videoBackground, R ? _.superReactions : _.longerMessages, _.stickersPerkDiscoverability, _.badgeAlt, h ? null : _.moreGuilds];
                return (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)(u.Heading, {
                        ...
                        children: L.map(e => null != e && (0, a.jsx)(g, {
                            ...e
                        }, e.title))
        ...
        558566: function(e, t, s) {
            ...
            let g = e => {
                    let {
                        ...
                        forceShadow: I
                    } = e, T = (0, u.default)([d.default], () => d.default.useReducedMotion), [f, S] = n.useState(!1), [p, N] = n.useState(!1), h = (0, A.default)(), [L] = (0, E.useDangerouslyPeekDismissibleContents)(null != r && s ? [r] : []), {
                        easterEggLevel: M,
                ...
                O = e => {
                    let {
                        ...
                        onMouseEnter: A,
                        className: m
                    } = e, g = (0, S.usePremiumTrialOffer)(), O = null == g ? void 0 : g.subscription_trial, h = (0, f.usePremiumDiscountOffer)(), L = (0, I.formatTrialCtaIntervalDuration)({
        ...
        881155: function(e, t, s) {
            ...
            var S = e => {
                ...
                }), O = (0, u.usePremiumDiscountOffer)(), h = null != C && E === C.sku_id, L = S ? _.default.Messages.BOGO_CLAIM_OFFER : null != O ? f(E, A, R, O.discount.amount) : T({
                    showTrialCTA: h,
                    subscriptionTier: E,
                    shouldShowUpsells: P,
                    trialDurationCopy: g,
        ...
        367226: function(e, t, s) {
            ...
            var a = s("884691"),
                ...
                _ = s("646718");
            let I = [
                    [n.DismissibleContent.WHATS_NEW_AVATAR_DECOS_NOTIF_BADGE, E.WhatsNewAvatarDecoRollout, n.DismissibleContent.WHATS_NEW_AVATAR_DECOS_FLIP],
                    [n.DismissibleContent.WHATS_NEW_PROFILE_EFFECTS_NOTIF_BADGE, E.WhatsNewProfileFXRollout, n.DismissibleContent.WHATS_NEW_PROFILE_EFFECTS_FLIP]
                ],
                T = () => I.some(e => {
                    let [t, s, a] = e, {
                        flipped: n
                ...
                f = () => {
                    ...
                    let l = o.default.getCurrentUser(),
                        ...
                        T = E && !(0, i.isDismissibleContentDismissed)(n.DismissibleContent.Q4_2023_NITRO_DROP_NITRO_TAB_BADGE) && (0, d.isPremiumExactly)(l, _.PremiumTypes.TIER_2);
            ...
            var S = () => {
                ...
                let [s] = (0, u.useGetDismissibleContent)(e ? [] : t), {
                    ...
                    enabled: f
                } = (0, c.useQ4DropExperiment)(), S = f && !(0, i.isDismissibleContentDismissed)(n.DismissibleContent.Q4_2023_NITRO_DROP_NITRO_TAB_BADGE) && (0, d.isPremiumExactly)(T, _.PremiumTypes.TIER_2), R = null != s && t.includes(s);
                return (R || S) && !e && !(null != E)
            }
        },
            ...
            class c extends n.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this.renderBreadcrumb = (e, t) => {
                        ...
                        } = this.props, E = e.id === s, _ = t === r.length - 1, I = null != u ? u(e, E) : (0, a.jsx)("span", {
                            className: l(d.breadcrumb, {
                                [d.activeBreadcrumb]: E,
        ...
        519311: function(e, t, s) {
            ...
            function T(e) {
                return _(a.ORGANIZATION, e)
            }

            function f(e) {
                return _(a.PRODUCT, e)
            }

            function S(e) {
                return _(a.ITEM_PAGE, e)
            }
            ...
            function A(e) {
                return _(a.QUANTITATIVE_VALUE, e)
            }

            function p(e) {
                return _(a.UNIT_PRICE_SPECIFICATION, e)
            }

            function N(e) {
                return _(a.AGGREGATE_OFFER, e)
            }

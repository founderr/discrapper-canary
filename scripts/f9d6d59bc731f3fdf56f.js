(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["96205"], {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var l, s, c, d, f, E, p, h, _, g, I, m, v, S, T, C, A = (l = u, f = Array(32768), l.forEach(function(n) {
                        ...
                        var N = (E = u, p = A, I = 1e6, m = 0, v = 1e6, S = 0, T = 1e6, C = 0, E.forEach(function(t) {
                            ...
                            for (var i, o = 1, u = 0; u < 1e3;) {
                                ...
                                var a = function(e, n) {
                                        ...
                                        function _(e) {
                                            ...
                                            for (l = n[a]; l <= n[s]; l++)
                                                if (p[l] > E / 2) {
                                                    for (i = n.copy(), o = n.copy(), t = l - n[a], u = t <= (r = n[s] - l) ? Math.min(n[s] - 1, ~~(l + r / 2)) : Math.max(n[a], ~~(l - 1 - t / 2)); !p[u];) u++;
                                                    for (c = h[u]; !c && p[u - 1];) c = h[--u];
        ...
        723251: function(e, t, n) {
            ...
            function i(e, t, n) {
                ...
                for (let e = 0, i = 0, u = r - 1; e < t; e++, u += r - 1)
                    for (o.push(e + 1 < t ? 0 : 1, 255 & r, r >> 8, 255 & ~r, r >> 8 ^ 255, 0), l = (l + a) % 65521; i < u; i++) {
                        let e = 255 & n[i];
                        o.push(e), l = (l + (a = (a + e) % 65521)) % 65521
                    }
                for (let [e, t] of(o.push(l >> 8, 255 & l, a >> 8, 255 & a, 0, 0, 0, 0, 0, 0, 0, 0, 73, 69, 78, 68, 174, 66, 96, 130), [
                        [12, 29],
                        [37, 41 + i]
                    ])) {
                    let n = -1;
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: o,
                        round: u
                    } = Math, a = e[0] | e[1] << 8 | e[2] << 16, l = e[3] | e[4] << 8, s = (63 & a) / 63, c = (a >> 6 & 63) / 31.5 - 1, d = (a >> 12 & 63) / 31.5 - 1, f = a >> 23, E = l >> 15, p = i(3, E ? f ? 5 : 7 : 7 & l), h = i(3, E ? 7 & l : f ? 5 : 7), _ = f ? (15 & e[5]) / 15 : 1, g = (e[5] >> 4) / 15, I = f ? 6 : 5, m = 0, v = (t, n, r) => {
                        let i = [];
                        for (let o = 0; o < n; o++)
                            for (let u = o ? 0 : 1; u * n < t * (n - o); u++) i.push(((e[I + (m >> 1)] >> ((1 & m++) << 2) & 15) / 7.5 - 1) * r);
                        return i
                    }, S = v(p, h, (a >> 18 & 31) / 31), T = v(3, 3, 1.25 * ((l >> 3 & 63) / 63)), C = v(3, 3, 1.25 * ((l >> 9 & 63) / 63)), A = f && v(5, 5, g), R = r(e), N = u(R > 1 ? 32 : 32 * R), M = u(R > 1 ? 32 / R : 32), b = new Uint8Array(N * M * 4), y = [], O = [];
                    for (let e = 0, r = 0; e < M; e++)
                        for (let u = 0; u < N; u++, r += 4) {
                            let a = s,
                                l = c,
                                E = d,
                                g = _;
                            for (let e = 0, n = i(p, f ? 5 : 3); e < n; e++) y[e] = o(t / N * (u + .5) * e);
                            for (let n = 0, r = i(h, f ? 5 : 3); n < r; n++) O[n] = o(t / M * (e + .5) * n);
                            for (let e = 0, t = 0; e < h; e++)
                                for (let n = e ? 0 : 1, r = 2 * O[e]; n * h < p * (h - e); n++, t++) a += S[t] * y[n] * r;
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * O[e]; n < 5 - e; n++, t++) g += A[t] * y[n] * r;
                            let I = a - 2 / 3 * l,
                                m = (3 * a - I + E) / 2,
                                v = m - E;
                            b[r] = i(0, 255 * n(1, m)), b[r + 1] = i(0, 255 * n(1, v)), b[r + 2] = i(0, 255 * n(1, I)), b[r + 3] = i(0, 255 * n(1, g))
                        }
                    return {
                        w: N,
                        h: M,
            ...
            let l = (0, i.createExperiment)({
                ...
                d = function() {
                    ...
                    let {
                        ...
                        autoTrackExposure: !0
                    }, i = (0, r.default)([o.default], () => o.default.getCurrentUser()), u = l.useExperiment({
                ...
                (0, o.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, r.jsx)(e, {
                            ...
                            followupSKUInfo: E,
                            onClose: e => {
                                i(), null == p || p(e), e && (null == _ || _())
                            },
                            onComplete: () => {
                                L = !0, null == h || h(), !S && ((0, l.setIsPersistentHelperHidden)(!0), (0, l.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: _,
                            analyticsLocations: g,
                            analyticsObject: I,
                    ...
                    onCloseCallback: () => {
                        !L && s.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: M,
                            location_stack: g
                        }), (0, u.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == p || p(L), L && (!S && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == _ || _())
                    },
        ...
        78345: function(e, t, n) {
            ...
            }), (o = r || (r = {}))[o.DEFAULT = 0] = "DEFAULT", o[o.WINTER = 1] = "WINTER", (u = i || (i = {}))[u.SNOWGLOBE = 1] = "SNOWGLOBE", u[u.BOX = 2] = "BOX", u[u.CUP = 3] = "CUP", u[u.STANDARD_BOX = 4] = "STANDARD_BOX", u[u.CAKE = 5] = "CAKE", u[u.CHEST = 6] = "CHEST", u[u.COFFEE = 7] = "COFFEE", u[u.SEASONAL_STANDARD_BOX = 8] = "SEASONAL_STANDARD_BOX", u[u.SEASONAL_CAKE = 9] = "SEASONAL_CAKE", u[u.SEASONAL_CHEST = 10] = "SEASONAL_CHEST", u[u.SEASONAL_COFFEE = 11] = "SEASONAL_COFFEE";
            let a = Object.freeze({
                IS_BLOCKED_IOS: 32,
        ...
        716849: function(e, t, n) {
            ...
            function g(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), o = (0, i.default)([d.default], () => d.default.shouldFetchPremiumLikelihood()), u = (0, i.default)([l.default], () => l.default.getCurrentUser());
                r.useEffect(() => {
                    I(u, o, t, n)
                }, [u, o, t, n])
            }
        ...
        15733: function(e, t, n) {
            ...
            function c() {
                ...
                return r.useEffect(() => {
                    o.default.wait(() => {
                        n && !l.default.isPaymentSourceFetching && !s.default.hasFetchedPaymentSources && u.fetchPaymentSources()
                    })
                }, [n]), r.useEffect(() => {
                    n && !l.default.ipCountryCodeLoaded && u.fetchIpCountryCode()
                }, [t, n]), {
        ...
        804888: function(e, t, n) {
            ...
            function a(e) {
                return u() && null != e.match(o) ? [!0, e.substring(i.length).trim()] : [!1, e]
            }
        },
        ...
        181114: function(e, t, n) {
            ...
            let g = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...g
                } = e, I = u.createRef(), m = (0, d.default)(I), v = !r && !i && !0 !== a && (!h || m);
                return (0, o.jsxs)(c.Button, {
                    ...
                    children: [t, v ? (0, o.jsx)(_, {
                        shinePaused: f,
                        className: l(E.buttonShine, h ? E.onlyShineOnHover : void 0, p),
                        shineSize: s
                    }) : null]
                })
            };

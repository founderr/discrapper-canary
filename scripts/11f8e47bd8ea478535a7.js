...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [24501], {
        624501: (e, t, n) => {
                    ...
                    return w(this, (function(l) {
                        switch (l.label) {
                            ...
                            case 1:
                                ...
                                l.label = 2;
                            case 2:
                                return null == n ? [2] : n.state !== m.r2o.EXPIRED && n.state !== m.r2o.BANNED && n.state !== m.r2o.ERROR ? [3, 4] : [4, C(n, e.code)];
                            case 3:
                                l.sent();
                                return [2];
                            case 4:
                                o = g.Z.getFlattenedGuildIds();
            ...
            function M(e) {
                ...
                if (null != o && o.type === c.g.APP_DIRECTORY_PROFILE) return function(e) {
                    ...
                    S.default.track(m.rMx.APP_DIRECTORY_PROFILE_EMBED_URL_CLICKED, {
                        application_id: r,
                ...
                if (C && (null == g ? void 0 : g.startsWith("/application-directory"))) {
                    var N = A(g.split("/"), 4),
                        Z = N[2],
                        M = N[3],
                ...
                var F = (0, h.Ao)(g);
                if (null != g && C && null != F) return function(e) {
                    null == e || e.preventDefault();
                    var t = E.Z.getGuildId();
                    null != F.guildId && "" !== F.guildId && F.guildId !== t && (0, b.Z)(m.Z5c.CHANNEL(F.guildId));
                ...
                if (C && (null == g ? void 0 : g.startsWith("/settings/"))) {
                    var H = n(421774),
                        V = H.default,
                        Y = V(g);
        ...
        362345: (e, t, n) => {
            ...
            function s(e, t) {
                var n, s = (0, l.yV)(t),
                    f = (0, o.wE)(i.z$.SERVER_SHOP_PHANTOM_PREVIEW),
                    d = (0, r.ZP)([a.Z], (function() {
                    ...
                    h = (0, u.y)(null == e ? void 0 : e.id, "useGuildShopPreviewVisible"),
                    b = [c.oNc.CREATOR_MONETIZABLE, c.oNc.CREATOR_MONETIZABLE_PROVISIONAL, c.oNc.ROLE_SUBSCRIPTIONS_ENABLED].some((function(t) {
                        return !0 === (null == e ? void 0 : e.hasFeature(t))
                    }));
                return null != e && d && !p && b && s && h && !f
            }
        },
        858503: (e, t, n) => {
            n.d(t, {
            ...
            function l(e) {
                var t = (0, o.pX)(),
                    n = (0, o.RF)(null == e ? void 0 : e.id, "channel_list"),
            ...
            function c(e) {
                var t = (0, o.vw)(),
                    n = (0, o.C4)(null == e ? void 0 : e.id, "channel_list"),
        ...
        927617: (e, t, n) => {
            ...
            function g(e, t, n) {
                return (0, i.e7)([u.Z, o.Z], (function() {
                    var r = o.Z.getGuild(e);
                    return null != r && (t && u.Z.canManageUser(s.Plq.BAN_MEMBERS, n, r))
                }), [t, e, n])
            }
                    ...
                    return R(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                ...
                                if (null == (r = _.Z.getGuild(t)) && t !== g.ME) return [2, !1];
                                if (null == n) return [2, !0];
                                if ((0, S.AB)(n)) switch (n) {
                                    ...
                                    case S.oC.CHANNEL_BROWSER:
                                        return [2, null != r && r.hasFeature(g.oNc.COMMUNITY)];
                    ...
                    return Z(this, (function(d) {
                        switch (d.label) {
                            ...
                            case 2:
                                ...
                                null != f.threadId ? (0, u.uL)(g.Z5c.CHANNEL_THREAD_VIEW(f.guildId, f.channelId, f.threadId, f.messageId), t, o) : (0, u.uL)(g.Z5c.CHANNEL(f.guildId, f.channelId, f.messageId), t, o);
                                return [2]
                        }
                    }))
                }))).apply(this, arguments)

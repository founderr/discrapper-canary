                        ...
                        return e = "todo" === j ? N.default.Messages.DESIGNATE_OTHER_CHANNEL_GUIDE_TODO : "resource" === j ? N.default.Messages.DESIGNATE_OTHER_CHANNEL_GUIDE_RESOURCE : N.default.Messages.DESIGNATE_OTHER_CHANNEL_ONBOARDING, (0, l.jsxs)(i.ModalRoot, {
                            ...
                            children: [(0, l.jsx)(i.ModalHeader, {
                                ...
                                children: [(0, l.jsx)(i.Text, {
                                    ...
                                    children: e.format({
                                        onClick: () => {
                                            if (null != A) E.default.open(A.id, S.GuildSettingsSections.ONBOARDING), null == _ || _()
                                        }
                                    })
                                })]
                            ...
                            children: [(0, l.jsx)(i.ModalHeader, {
                                ...
                                children: [(0, l.jsx)(i.Text, {
                                    ...
                                    children: N.default.Messages.DESIGNATE_OTHER_CHANNEL.format({
                                        onClick: () => {
                                            E.default.open(A.id, S.GuildSettingsSections.COMMUNITY), null == _ || _()
                                        }
                                    })
                                })]
                            }), (0, l.jsx)(i.ModalFooter, {
        ...
        817653: function(e, t, s) {
                ...
                return a.isCategory() ? (f.title = G.default.Messages.PRIVATE_CATEGORY, f.subtitle = G.default.Messages.CHANNEL_PERMISSIONS_PRIVATE_CATEGORY_DESCRIPTION, f.formLabel = G.default.Messages.FORM_LABEL_CATEGORY_PERMISSIONS) : a.type === U.ChannelTypes.GUILD_VOICE && (f.subtitle = G.default.Messages.CHANNEL_PERMISSIONS_PRIVATE_CHANNEL_DESCRIPTION_VOICE), (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsx)(P.default, {
                        ...
                        onChange: function() {
                            ...
                            if (F.toggleChannelEveryonePermission(a, e, n), !n && null != s) !(null == t ? void 0 : t.isOwner(s)) && !c && F.grantUserChannelAccess(a, e)
                        },
                        value: n
                    }), (0, l.jsxs)("div", {
                        className: V.cardFolder,
            ...
            var K = r.default.connectStores([N.default, p.default, C.default, _.default], () => {
                ...
                if (null != t) {
                    ...
                    let s = C.default.getMemberIds(null === (r = e) || void 0 === r ? void 0 : r.id);
        ...
        823362: function(e, t, s) {
            ...
            function eN() {
                ...
                let {
                    ...
                    submitting: n,
                    subsection: i
                } = (0, d.useStateFromStoresObject)([b.default], () => b.default.getProps()), r = (0, d.useStateFromStores)([w.default], () => w.default.getRegions(null !== (e = null == s ? void 0 : s.getGuildId()) && void 0 !== e ? e : null)), o = (0, d.useStateFromStores)([D.default], () => D.default.theme), u = (0, d.useStateFromStores)([P.default], () => P.default.getGuild(null == s ? void 0 : s.getGuildId())), c = (0, L.useCanManageThread)(s), h = (0, L.useIsThreadModerator)(s), {
                    canManageChannels: E,
                    canSendMessages: f
                } = (0, d.useStateFromStoresObject)([H.default], () => ({
                    canManageChannels: H.default.can(Q.Permissions.MANAGE_CHANNELS, s),
                    canSendMessages: H.default.can(Q.Permissions.SEND_MESSAGES, s)
                })), m = (0, S.default)(s), g = F.default.getId(), N = (0, x.useForumChannelStoreApi)(), C = null == s ? void 0 : s.id, _ = (0, T.useChannelSummariesExperiment)(s, !1, !0), p = a.useCallback(e => {
                    null != C && N.getState().setLayoutType(C, e)
                }, [C, N]);
                return (0, l.jsx)(eS, {
                    errors: t,
                    channel: s,
                    ...
                    showChannelSummariesSettings: _
                })
            }
        },

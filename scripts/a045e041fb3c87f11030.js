                ...
                constructor(e = h) {
                    ...
                    this.updateAvailable = !1, this.hasNativeUpdate = !1, this._callbacks = [], this._bootstrapper = null, this.checkForUpdates = function() {
                        ...
                        this._handleCheckingForUpdates(), l.default.get({
                            ...
                            if (null == e.body || "1248654913dd9694a85514da4e4dcf83359d9f53" === e.body.hash) return this._handleUpdateNotAvailable();
        ...
        957825: function(e, t, n) {
            ...
            function h(e) {
                let {
                    ...
                    location: p,
                    includeGuildMute: S
                } = e, g = (0, r.useChannelNotificationRadioItems)(t), N = (0, o.useChannelNotificationSettingsItemInner)(t), _ = (0, l.useStateFromStores)([f.default], () => f.default.getGuild(t.guild_id)), T = (0, u.default)(_), I = (0, d.useShouldUseNewNotificationSystem)("ChannelNotificationSettingsPopoutMenu") && c.CHANNEL_ELIGIBLE_FOR_UNREAD_SETTING.has(t.type);

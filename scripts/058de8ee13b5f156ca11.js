            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        return i
                    }, y = v(O, h, _), b = v(3, 3, 1.25 * E), A = v(3, 3, 1.25 * p), N = d && v(5, 5, g), R = r(e), L = a(R > 1 ? 32 : 32 * R), P = a(R > 1 ? 32 / R : 32), C = new Uint8Array(L * P * 4), U = [], M = [];
                        ...
                        for (let a = 0; a < L; a++, r += 4) {
                            ...
                            if (d)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * M[e]; n < 5 - e; n++, t++) E += N[t] * U[n] * r;
                            let p = u - 2 / 3 * l,
                                I = (3 * u - p + _) / 2,
                                g = I - _;
                            C[r] = i(0, 255 * n(1, I));

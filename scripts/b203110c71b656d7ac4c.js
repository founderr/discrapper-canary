/*! For license information please see b203110c71b656d7ac4c.js.LICENSE.txt */
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [68087], {
            ...
            var o = r(610329),
                ...
                _ = {
                    insertAtomicBlock: function(t, e, r) {
                        ...
                        var E = [new y(S), new y(w)],
                            x = o.createFromArray(E),
                            k = c.replaceWithFragment(_, d, x),
                            C = k.merge({
                                selectionBefore: u,
                    ...
                    moveAtomicBlock: function(t, e, r, n) {
                        ...
                        if ("before" === n || "after" === n) {
                            ...
                            else if (f.getEndOffset() === p.getLength()) i = d(s, e, p, "after");
                            else {
            ...
            var n = r(629407),
                ...
                f = {
                    generate: function(t, e, r) {
                        ...
                        var u = [],
                            f = r ? r.getDecorations(e, t) : o(a(null, i)),
                            d = e.getCharacterList();
                        n(f, h, s, (function(t, e) {
                            u.push(new l({
                                start: t,
                                end: e,
                                decoratorKey: f.get(t),
                    ...
                    function e(e) {
                        return t.call(this, function(t) {
                            ...
                            var e = t.characterList,
                                r = t.text;
                            r && !e && (t.characterList = a(l(n.EMPTY, r.length)));
                            return t
                        }(e)) || this
                    }
                    var r = e.prototype;
                ...
                y = function(t) {
                    ...
                    e.createFromText = function(t) {
                        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : /\r\n?|\n/g,
                            ...
                            u = n.map((function(t) {
                                t = p(t);
                                return new(l("draft_tree_data_support") ? a : o)({
                                    key: c(),
                                    text: t,
                                    type: "unstyled",
                        ...
                        return e.createFromBlockArray(u)
                    };
                    return e
                }(d({
                    entityMap: null,
            ...
            var i = r(977249),
                ...
                h = function() {
                    ...
                    e.stopAndFlushMutations = function() {
                        var t = this.observer;
                        if (t) {
                            this.registerMutations(t.takeRecords());
                            t.disconnect()
                        } else this.container.removeEventListener("DOMCharacterDataModified", this.onCharData);
        ...
        37163: (t, e, r) => {
            ...
            var n = r(819785),
                ...
                C = {
                    ...
                    convertFromHTML: r(267841),
                    convertFromRaw: w,
                    convertToRaw: S,
                    genKey: E,
                    getDefaultKeyBinding: x,
                    getVisibleSelectionRect: k
                };
            t.exports = C
        },
        387210: (t, e, r) => {
            ...
            var c = r(600526),
                ...
                L = function(t) {
                    ...
                    n.componentDidMount = function() {
                        ...
                        if (!B && O("draft_ods_enabled")) {
                            B = !0;
                            v.initODS()
                        }
                        this.setMode("edit");
                        A && (this.editor ? this.editor.ownerDocument.execCommand("AutoUrlDetect", !1, !1) : r.g.execCommand("AutoUrlDetect", !1, !1))
                    };
            ...
            var u = r(442282),
                ...
                w = function(t) {
                    ...
                    function e() {
                        ...
                        a(o(e = t.call.apply(t, [this].concat(n)) || this), "_node", void 0);
                        return e
                    }
                    var r = e.prototype;
                            ...
                            if (t.getHasFocus() && e === this.props.block.getKey()) {
                                ...
                                if (null != r) {
                                    ...
                                    if (i === window) {
                                        ...
                                        _(r) || m(!1);
                                        (n = r.offsetHeight + r.offsetTop - (i.offsetTop + i.offsetHeight + o.y)) > 0 && l.setTop(i, l.getTop(i) + n + 10)
                                    }
                                }
                            }
                        }
                    ...
                    r._renderChildren = function() {
                        ...
                        return this.props.tree.map((function(l, f) {
                            ...
                            var S = m.getPropsForKey(v),
                                ...
                                O = h.getHTMLDirIfDifferent(p.getDirection(k), t.props.direction),
                                D = {
                            ...
                            return c.createElement(_, i({}, S, D, {
                                key: w
                            }), y)
                        })).toArray()
                    };
        ...
        425821: (t, e, r) => {
            ...
            var s = r(859513),
                ...
                E = function(t) {
                    ...
                    function e() {
                        for (var e, r = arguments.length, n = new Array(r), i = 0; i < r; i++) n[i] = arguments[i];
                        u(o(e = t.call.apply(t, [this].concat(n)) || this), "wrapperRef", l.createRef());
                        return e
                    }
                    var r = e.prototype;
                    r.shouldComponentUpdate = function(t) {
                        var e = this.props,
                            ...
                            a = r !== t.block || i !== t.tree || n !== t.direction || _(t.selection, t.block.getKey()) && t.forceSelection;
                        return o || a
                    };
                    r.componentDidMount = function() {
                        var t = this.props.selection,
                        ...
                        if (t.getHasFocus() && e === this.props.block.getKey()) {
                            ...
                            if (r) {
                                ...
                                if (i === window) {
                                    ...
                                    m(r) || v(!1);
                                    var u = r;
                                    (n = u.offsetHeight + u.offsetTop - (i.offsetHeight + o.y)) > 0 && f.setTop(i, f.getTop(i) + n + 10)
                                }
                            }
                        }
                    };
                    r.render = function() {
                        var t = this,
                            ...
                            k = r.tree,
                            C = null;
                        n.children.size && (C = n.children.reduce((function(r, n) {
                            ...
                            r.push(l.createElement(m, E, l.createElement(y, x)));
                            if (!_ || function(t, e) {
                        ...
                        var O = n.getKey(),
                            ...
                            K = S(n, u),
                            T = K.CustomComponent,
                            A = null != T ? l.createElement(T, i({}, this.props, {
                        ...
                        if (n.getParentKey()) return A;
                        var M = b(n, o).Element,
                            I = w(n, d, D, f, K, this.wrapperRef);
                        return l.createElement(M, I, A)
                    };
                    return e
                }(l.Component);
            t.exports = E
        ...
        433418: (t, e, r) => {
            ...
            var y = {
                ...
                onKeyDown: function(t, e) {
                    if (d) e.which !== u.RIGHT && e.which !== u.LEFT || e.preventDefault();
                    else {
                        y.resolveComposition(t);
                        t._onKeyDown(e)
                    }
                },
        ...
        488795: (t, e, r) => {
            ...
            var u = r(937898),
                ...
                d = function(t) {
                    ...
                    r.render = function() {
                        for (var t = this.props, e = t.blockRenderMap, r = t.blockRendererFn, n = t.blockStyleFn, a = t.customStyleMap, l = t.customStyleFn, d = t.editorState, g = t.editorKey, y = t.preventScroll, v = t.textDirectionality, m = d.getCurrentContent(), _ = d.getSelection(), b = d.mustForceSelection(), S = d.getDecorator(), w = p(d.getDirectionMap()), E = m.getBlocksAsArray(), x = [], k = null, C = null, O = 0; O < E.length; O++) {
                            var D = E[O],
                                K = D.getKey(),
                                T = D.getType(),
                                A = r(D),
                            ...
                            var R = v || w.get(K),
                                ...
                                N = {
                                    ...
                                    preventScroll: y,
                                    selection: _,
                                    tree: d.getBlockTree(K)
                                },
                                F = e.get(T) || e.get("unstyled"),
                                P = F.wrapper,
                                z = F.element || e.get("unstyled").element,
                                j = D.getDepth(),
                                U = "";
                            n && (U = n(D));
                            if ("li" === z) {
                                U = f(U, h(T, j, C !== P || null === k || j > k, R))
                            }
                            var q = M || u,
                                H = {
                                    className: U,
                            ...
                            var W = c.createElement(z, H, c.createElement(q, i({}, N, {
                                key: K
                            })));
                            x.push({
                                block: W,
                        ...
                        for (var V = [], G = 0; G < x.length;) {
                            ...
                            if (J.wrapperTemplate) {
                                ...
                                do {
                                    $.push(x[G].block);
                                    G++
                                } while (G < x.length && x[G].wrapperTemplate === J.wrapperTemplate);
                                var Y = c.cloneElement(J.wrapperTemplate, {
                                    key: J.key + "-wrap",
        ...
        487791: (t, e, r) => {
            "use strict";
            var n = r(168642)("draft_tree_data_support");
            t.exports = r(n ? 769459 : 488795)
        },
        769459: (t, e, r) => {
            "use strict";
            var n = r(727418);
            ...
            var o = r(425821),
                ...
                c = function(t) {
                    ...
                    r.render = function() {
                        for (var t = this.props, e = t.blockRenderMap, r = t.blockRendererFn, n = t.blockStyleFn, c = t.customStyleMap, l = t.customStyleFn, f = t.editorState, p = t.editorKey, h = t.textDirectionality, d = f.getCurrentContent(), g = f.getSelection(), y = f.mustForceSelection(), v = f.getDecorator(), m = s(f.getDirectionMap()), _ = [], b = d.getBlocksAsArray()[0]; b;) {
                            var S = b.getKey(),
                                w = {
                                    blockRenderMap: e,
                                    blockRendererFn: r,
                        ...
                        for (var k = [], C = 0; C < _.length;) {
                            ...
                            if (O.wrapperTemplate) {
                                ...
                                do {
                                    D.push(_[C].block);
                                    C++
                                } while (C < _.length && _[C].wrapperTemplate === O.wrapperTemplate);
                                var K = u.cloneElement(O.wrapperTemplate, {
                                    key: O.key + "-wrap",
            ...
            var h = {
                ...
                onDrop: function(t, e) {
                    ...
                    if (null != h) {
                        var y = r.getFiles();
                        if (y.length > 0) {
                            if (t.props.handleDroppedFiles && f(t.props.handleDroppedFiles(h, y))) return;
                            s(y, (function(e) {
                                e && t.update(g(l, h, e))
                            }))
                        } else {
                            var v = t._internalDrag ? "internal" : "external";
                            t.props.handleDrop && f(t.props.handleDrop(h, r, v)) || (t._internalDrag ? t.update(function(t, e) {
                                var r = i.moveText(t.getCurrentContent(), t.getSelection(), e);
                                return o.push(t, r, "insert-fragment")
                            }(l, h)) : t.update(g(l, h, r.getText())));
                            d(t)
                        }
                    }
                }
        ...
        804083: (t, e, r) => {
            "use strict";
            var n = r(973935).unstable_flushControlled;
            t.exports = n
        },
        442282: (t, e, r) => {
            "use strict";
            ...
            var a = r(480052),
                ...
                s = r(152286),
                c = r(916581),
                l = r(845412).setDraftEditorSelection,
                f = function(t) {
                    ! function(t, e) {
                        t.prototype = Object.create(e.prototype);
                        t.prototype.constructor = t;
                    ...
                    function e() {
                        ...
                        o(i(e = t.call.apply(t, [this].concat(n)) || this), "leaf", void 0);
                        return e
                    }
                    var r = e.prototype;
        ...
        822146: t => {
            ...
            var e = "-",
                r = {
                    ...
                    decode: function(t) {
                        var r = t.split(e).reverse(),
                            n = r[0],
                            i = r[1];
                        return {
                            blockKey: r.slice(2).reverse().join(e),
        ...
        773932: (t, e, r) => {
            "use strict";
            var n = "\\s|(?![_])" + r(590295).getPunctuation(),
                i = new RegExp("^(?:" + n + ")*(?:" + "['‘’]|(?!" + n + ").)*(?:(?!" + n + ").)"),
                o = new RegExp("(?:(?!" + n + ").)(?:" + "['‘’]|(?!" + n + ").)*(?:" + n + ")*$");
                ...
                s = {
                    fromRawTreeStateToRawState: function(t) {
                        var e = t.blocks,
                            r = [];
                        Array.isArray(e) || a(!1);
                        if (!Array.isArray(e) || !e.length) return t;
                        ! function(t, e) {
                            ...
                            if (u(t)) {
                                ...
                                if (null != t.children && t.children.length > 0) return
                            }
                            delete e.children;
                            r.push(e)
                        }));
            ...
            t.exports = {
                isValidBlock: function(t, e) {
                    var r = t.getKey(),
                        n = t.getParentKey();
                    if (null != n) {
                        if (!e.get(n).getChildKeys().includes(r)) return !1
                    }
                    ...
                    if (null != i) {
                        if (e.get(i).getNextSiblingKey() !== r) return !1
                    }
                    var o = t.getNextSiblingKey();
                    if (null != o) {
                        if (e.get(o).getPrevSiblingKey() !== r) return !1
                    }
                ...
                h = function() {
                    ...
                    e.create = function(t) {
                        var r = t.currentContent,
                            i = function(t) {
                                ...
                                treeMap: g(r, t.decorator),
                                directionMap: a.getDirectionMap(r)
                            });
                        return new e(new p(i))
                    };
                    e.set = function(t, r) {
                    ...
                    e.push = function(t, r, n) {
                        ...
                        var u = t.getSelection(),
                            ...
                            c = t.getUndoStack(),
                            l = r;
                        if (u !== s.getSelectionAfter() || y(t, n)) {
                            c = c.push(s);
                            l = l.set("selectionBefore", u)
                        } else "insert-characters" !== n && "backspace-character" !== n && "delete-character" !== n || (l = l.set("selectionBefore", s.getSelectionBefore()));
                        var p = t.getInlineStyleOverride(),
                            h = ["adjust-depth", "change-block-type", "split-block"]; - 1 === h.indexOf(n) && (p = null);
                        var d = {
                            currentContent: l,
                            directionMap: o,
                            undoStack: c,
            ...
            var n = r(142307),
                ...
                u = {
                    ...
                    toggleInlineStyle: function(t, e) {
                        ...
                        var a, u = t.getCurrentContent();
                        a = o.has(e) ? n.removeInlineStyle(u, r, e) : n.applyInlineStyle(u, r, e);
                        return i.push(t, a, "change-inline-style")
                    },
        ...
        902835: (t, e, r) => {
            ...
            t.exports = function(t, e, r, i) {
                for (var o = e, a = t.getCharacterList(); o < r;) {
                    a = a.set(o, n.applyEntity(a.get(o), i));
                    o++
                }
        ...
        267841: (t, e, r) => {
            ...
            var a = r(704516),
                ...
                R = (o(n = {}, p("public/DraftStyleDefault/depth0"), 0), o(n, p("public/DraftStyleDefault/depth1"), 1), o(n, p("public/DraftStyleDefault/depth2"), 2), o(n, p("public/DraftStyleDefault/depth3"), 3), o(n, p("public/DraftStyleDefault/depth4"), 4), n),
                L = m({
                    b: "BOLD",
                    code: "CODE",
                    del: "STRIKETHROUGH",
                ...
                P = function(t) {
                    if (!b(t)) return !1;
                    var e = t;
                    return !(!e.href || "http:" !== e.protocol && "https:" !== e.protocol && "mailto:" !== e.protocol)
                },
                z = function(t) {
                    if (!E(t)) return !1;
                    var e = t;
                ...
                j = function(t, e) {
                    ...
                    return e.withMutations((function(t) {
                        A.indexOf(n) >= 0 ? t.add("BOLD") : M.indexOf(n) >= 0 && t.remove("BOLD");
                ...
                q = function() {
                                ...
                                if (void 0 === s)
                                    if ("#text" !== o)
                                        if ("br" !== o)
                                            ...
                                            else if (P(i)) this._addAnchorNode(i, r, e);
                                else {
                                    var c = e;
                                    L.has(o) && (c = c.add(L.get(o)));
                                    c = j(i, c);
                                    ...
                                    if (!x && w(i) && ("unordered-list-item" === s || "ordered-list-item" === s)) {
                                        var p = i;
                                        this.currentDepth = F(p, this.currentDepth)
                                    }
                                    var d = h(),
                                        g = this._toBlockConfigs(Array.from(i.childNodes), e);
                                    this._trimCurrentText();
                    ...
                    e._trimCurrentText = function() {
                        ...
                        if ((e = void 0 !== n ? Math.min(e, n[0]) : e) > (r = void 0 !== (n = this.characterList.reverse().findEntry((function(t) {
                                return null !== t.getEntity()
                            }))) ? Math.max(r, t - n[0]) : r)) {
                            this.currentText = "";
                            this.characterList = v()
                    ...
                    e._addTextNode = function(t, e) {
                        ...
                        "pre" !== this.wrapper && (r = (r = r.replace(O, "")).replace(C, " "));
                    ...
                    e._addImgNode = function(t, e) {
                        if (E(t)) {
                            ...
                            g("draftjs_fix_paste_for_img") ? "presentation" !== r.getAttribute("role") && this._appendText("📷", e) : this._appendText("📷", e);
                            this.currentEntity = null
                        }
                    };
                    ...
                    e._toFlatContentBlocks = function(t) {
                        ...
                        this._hoistContainersInBlockConfigs(t).forEach((function(t) {
                            var r = e._extractTextFromBlockConfigs(t.childConfigs),
                                n = r.text,
                                o = r.characterList;
                            e.contentBlocks.push(new u(i({}, t, {
                                text: t.text + n,
            ...
            t.exports = function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : d,
                    ...
                    n = e(t = t.trim().replace(k, "").replace(D, " ").replace(K, "").replace(T, ""));
                if (!n) return null;
                var i = N(r),
                    o = function(t, e) {
            ...
            var o = r(402641),
                ...
                E = function(t, e) {
                    var r = t.text,
                        ...
                        a = i || [];
                    return f(h(r, o || []), p(r, a.filter((function(t) {
        ...
        426396: (t, e, r) => {
            ...
            t.exports = function(t, e) {
                if (void 0 !== t._pendingStateFromBeforeInput) {
                ...
                if (n)
                    if (t.props.handleBeforeInput && u(t.props.handleBeforeInput(n, r, e.timeStamp))) e.preventDefault();
                        ...
                        var o = r.getSelection(),
                            ...
                            d = o.getAnchorKey();
                        if (o.isCollapsed()) {
                            var g, y = p(r, n, r.getCurrentInlineStyle(), a(r.getCurrentContent(), r.getSelection()), !1),
                                v = !1;
                            v || (v = s(t._latestCommittedEditorState));
                            if (!v) {
                            ...
                            v || (v = (g = n, f && ("'" == g || "/" == g)));
                            v || (v = c(y.getDirectionMap()).get(d) !== c(r.getDirectionMap()).get(d));
                            if (v) {
                                e.preventDefault();
                                y = i.set(y, {
                                    forceSelection: !0
            ...
            t.exports = function(t, e) {
                ...
                if (!((null == a ? void 0 : a.nodeType) !== Node.TEXT_NODE && (null == a ? void 0 : a.nodeType) !== Node.ELEMENT_NODE)) {
                    ...
                    var g = a.textContent,
                        ...
                        E = w.start,
                        x = w.end,
                        k = y.getCurrentContent(),
                        C = k.getBlockForKey(_),
                        O = C.getText().slice(E, x);
                    g.endsWith("\n\n") && (g = g.slice(0, -1));
                    if (g !== O) {
                        var D, K, T, A, M = y.getSelection(),
                            I = M.merge({
                                anchorOffset: E,
                                focusOffset: x,
                                isBackward: !1
                            ...
                            B = C.getEntityAt(E),
                            R = u(B) ? k.getEntity(B) : null,
                            L = "MUTABLE" === (null != R ? R.getMutability() : null),
                            N = L ? "spellcheck-change" : "apply-entity",
                            F = n.replaceText(k, I, g, C.getInlineStyleAt(E), L ? C.getEntityAt(E) : null);
                        if (f) {
                            D = r.anchorOffset;
                            K = r.focusOffset;
                            A = (T = E + Math.min(D, K)) + Math.abs(D - K);
                            D = T;
                            K = A
                        } else {
                        ...
                        t.update(o.push(y, z, N))
                    } else {
                        var j = e.nativeEvent.inputType;
                        if (j) {
                            var U = function(t, e) {
                                return "deleteContentBackward" === t ? c(e) : e
                            }(j, y);
                            if (U !== y) {
                                t.restoreEditorDOM();
                                t.update(U);
        ...
        946397: (t, e, r) => {
            ...
            t.exports = function(t, e) {
                ...
                switch (r) {
                    case a.RETURN:
                        e.preventDefault();
                        if (t.props.handleReturn && c(t.props.handleReturn(e, o))) return;
                        break;
                    case a.ESC:
                        e.preventDefault();
                        if (s("onEscape")) return;
                        break;
                    case a.TAB:
                        if (s("onTab")) return;
                        break;
                ...
                if (null != w && "" !== w)
                    if ("undo" !== w) {
                        e.preventDefault();
                        if (!t.props.handleKeyCommand || !c(t.props.handleKeyCommand(w, o, e.timeStamp))) {
                    ...
                    var x = n.replaceText(o.getCurrentContent(), o.getSelection(), " ");
                        ...
                        if (_) {
                            ...
                            if (w) {
                                var E = w.contentBlocks,
                                    x = w.entityMap;
                                if (E) {
                                    var k = n.createFromArray(E);
                                    t.update(d(t._latestEditorState, k, x));
                                    return
                                }
                            }
                        }
            ...
            t.exports = function(t) {
                if (t._blockSelectEvents || t._latestEditorState !== t.props.editorState) {
                    ...
                    var r = t.props.editorState,
                        ...
                        s = u.selectionState;
                    if (s !== r.getSelection()) {
                        r = u.needsRecovery ? i.forceSelection(r, s) : i.acceptSelection(r, s);
                        t.update(r)
                    }
                }
            }
        ...
        388182: (t, e, r) => {
            ...
            t.exports = function(t) {
                ...
                for (; u(o(t), r);) {
                    ...
                    c.parentNode || a(!1);
                    t.setStartBefore(c);
                    if (1 === c.nodeType && "inline" !== getComputedStyle(c).display) break
                }
                for (var f = c, p = l - 1;;) {
        ...
        25027: t => {
            ...
            var e = {},
                r = Math.pow(2, 24);
            t.exports = function() {
                for (var t; void 0 === t || e.hasOwnProperty(t) || !isNaN(+t);) t = Math.floor(Math.random() * r).toString(32);
                e[t] = !0;
                return t
            }
        },
        ...
        42128: (t, e, r) => {
            "use strict";
            var n = r(99407).notEmptyKey;

            function i(t, e) {
                if (n(e)) {
                    return "MUTABLE" === t.__get(e).getMutability() ? e : null
                }
                return null
            }
            t.exports = function(t, e) {
        ...
        169769: (t, e, r) => {
            ...
            t.exports = function(t) {
                var e, r = null;
                if (!o && document.implementation && document.implementation.createHTMLDocument) {
            ...
            t.exports = function(t, e) {
                ...
                t.forEach((function(s) {
                    ! function(t, e) {
                        ...
                        a++;
                        r && u.push(r.slice(0, 5e3));
                        a == t.length && e(u.join("\r"))
                    }))
                }))
            }
        },
        ...
        354542: (t, e, r) => {
            ...
            var n = r(610329),
                ...
                f = function(t, e, r, o, a, u) {
                    var s = r.first() instanceof i,
                        ...
                        g = d.getLength(),
                        y = d.getKey(),
                        v = s && (!p.getChildKeys().isEmpty() || !h.getChildKeys().isEmpty());
                    r.forEach((function(t, e) {
                        if (e === a) {
                            v ? l.push(t) : l.push(function(t, e, r) {
                                var n = t.getText(),
                                    i = t.getCharacterList(),
                                    o = n.slice(0, e),
                                    a = i.slice(0, e),
            ...
            t.exports = function(t, e, r) {
                ...
                return 1 === a.size ? l(t, e, o, a.first(), c, p, n) : f(t, e, o, a, c, p)
            }
        },
        340779: t => {
            "use strict";
        ...
        940258: t => {
            ...
            t.exports = function(t) {
                ...
                n.some((function(t) {
                    ...
                    return i < t.get("end") && t.get("leaves").some((function(t) {
                        var e = t.get("start");
                        if (i === e) {
                            o = !0;
                            return !0
        ...
        649779: (t, e, r) => {
            ...
            t.exports = function(t, e) {
                var r = u(t, (function(t) {
                    ...
                    n = i(n);
                    return o(t, null, n.endContainer, n.endOffset, n.startContainer, n.startOffset).selectionState
                }), "backward");
        ...
        753318: (t, e, r) => {
            ...
            t.exports = function(t) {
                ...
                if (0 === r) return t;
                var a, u, s = e.getAnchorKey(),
                    c = t.getCurrentContent(),
                    l = c.getBlockForKey(s).getLength();
                if (l <= 1) return t;
                if (r === l) {
                    a = e.set("anchorOffset", r - 1);
                    u = e
                } else u = (a = e.set("focusOffset", r + 1)).set("anchorOffset", r + 1);
                var f = o(c, a),
        ...
        487051: (t, e, r) => {
            ...
            t.exports = function(t, e, r) {
                ...
                if ("spellcheck-change" !== e.getLastChangeType()) {
                    t.preventDefault();
                    if (e.getNativelyRenderedContent()) {
                        r(n.set(e, {
                            nativelyRenderedContent: null
                        }));
                        setTimeout((function() {
            ...
            t.exports = function(t, e) {
                ...
                if (e > o) {
                    ...
                    if (null == s) a = i;
                        ...
                        a = s;
                        u = n.getBlockForKey(s).getText().length
                    }
                } else u = o - e;
                return r.merge({
                    focusKey: a,
        ...
        619417: (t, e, r) => {
            ...
            t.exports = function(t, e) {
                var r, n = t.getSelection(),
                    ...
                    u = i;
                if (e > a.getBlockForKey(i).getText().length - o) {
                    u = a.getKeyAfter(i);
                    r = 0
                } else r = o + e;
                return n.merge({
        ...
        914017: (t, e, r) => {
            ...
            function a(t, e, r) {
                ...
                if (l && l === c) {
                    if ("MUTABLE" !== t.__get(l).getMutability()) {
                        for (var f, p = function(t, e, r) {
                                var n;
                                i(t, (function(t, e) {
                                    return t.getEntity() === e.getEntity()
                                }), (function(t) {
                                ...
                                "object" != typeof n && o(!1);
                                return n
                            }(a, l, r), h = p.start, d = p.end; h < d;) {
                            f = a.get(h);
                            a = a.set(h, n.applyEntity(f, null));
                            h++
                        }
            ...
            t.exports = function(t, e) {
                ...
                var h = a(n, p, f);
                h !== p && (i[l] = h);
                return Object.keys(i).length ? t.merge({
                    blockMap: r.merge(i),
                    selectionAfter: e
        ...
        254879: (t, e, r) => {
            ...
            var n = r(767953),
                ...
                f = function(t, e, r, n) {
                    return t.withMutations((function(o) {
                        ...
                        if (null == t.get(e.getKey()) && null != t.get(r.getKey()) && r.getParentKey() === e.getKey() && null == r.getPrevSiblingKey()) {
                            ...
                            u(e.getChildKeys().find((function(e) {
            ...
            t.exports = function(t, e) {
                ...
                r = d === g ? p(d.getCharacterList(), c, h) : d.getCharacterList().slice(0, c).concat(g.getCharacterList().slice(h));
                var b = d.merge({
                        text: d.getText().slice(0, c) + g.getText().slice(h),
                        characterList: r
                    }),
                    S = y && 0 === c && 0 === h && g.getParentKey() === u && null == g.getPrevSiblingKey() ? a([
                        [u, null]
                    ]) : o.toSeq().skipUntil((function(t, e) {
                        return e === u
                    })).takeUntil((function(t, e) {
                        return e === l
                    })).filter((function(t, e) {
        ...
        14730: (t, e, r) => {
            "use strict";
            var n = r(142307),
                i = r(168642)("draft_tree_data_support");
            t.exports = function(t, e, r) {
        ...
        845412: (t, e, r) => {
            ...
            function h(t, e) {
                ...
                for (var o = t.childNodes, a = 0; a < o.length; a++) i.appendChild(h(o[a], e));
                return i
            }
            ...
            function y(t, e, r, n) {
                var o = u();
                if (t.extend && a(o, e)) {
                    r > g(e) && i.logSelectionStateFailure({
                        anonymizedDom: d(e),
                        extraParams: JSON.stringify({
                            offset: r
                        }),
        ...
        747642: (t, e, r) => {
            ...
            function c(t, e) {
                ...
                return r.length > 1 ? r.some((function(t) {
                    ...
                    var r = t.split(a);
                    r.length > 0 && r.length <= 2 || n(!1);
                    if (1 === r.length) return l(r[0], e);
                    var i = r[0],
                        o = r[1];
                    g(i) && g(o) || n(!1);
                    return l(">=" + i, e) && l("<=" + o, e)
        ...
        143393: function(t) {
            t.exports = function() {
                ...
                function C(t) {
                    void 0 === t.size && (t.size = t.__iterate(D));
                    return t.size
                }
                ...
                G.Set = Y;
                G.Indexed = $;
                var X, Z, Q, tt = "@@__IMMUTABLE_SEQ__@@";
                G.prototype[tt] = !0;
                e(et, $);
                ...
                function ut(t) {
                    var e = Array.isArray(t) ? new et(t).fromEntrySeq() : q(t) ? new it(t).fromEntrySeq() : U(t) ? new nt(t).fromEntrySeq() : "object" == typeof t ? new rt(t) : void 0;
                ...
                function lt(t) {
                    return V(t) ? new et(t) : q(t) ? new it(t) : U(t) ? new nt(t) : void 0
                }
                ...
                function dt(t, e, r, n) {
                    return Array.isArray(e) ? t.call(n, r, $(e).map((function(r, n) {
                        return dt(t, r, n, e)
                    }))) : yt(e) ? t.call(n, r, J(e).map((function(r, n) {
                        return dt(t, r, n, e)
                    }))) : e
                }

                function gt(t) {
                    return Array.isArray(t) ? $(t).map(gt).toList() : yt(t) ? J(t).map(gt).toMap() : t
                }
                ...
                _t.prototype.slice = function(t, e) {
                    var r = this.size;
                    return K(t, e, r) ? this : new _t(this._value, A(e, r) - T(t, r))
                };
                ...
                St.prototype.slice = function(t, e) {
                    ...
                    t = T(t, this.size);
                    return (e = A(e, this.size)) <= t ? new St(0, 0) : new St(this.get(t, this._end), this.get(e, this._end), this._step)
                };
                ...
                function Dt(t) {
                    ...
                    if ("string" === e) return t.length > Pt ? Kt(t) : Tt(t);
                ...
                function At(t) {
                    ...
                    if (Lt) Rt.set(t, e);
                        ...
                        if (It) Object.defineProperty(t, Ft, {
                            enumerable: !1,
                            configurable: !1,
                            writable: !1,
                            value: e
                ...
                var Rt, Lt = "function" == typeof WeakMap;
                Lt && (Rt = new WeakMap);
                var Nt = 0,
                ...
                function Ht(t) {
                    return null == t ? ie() : Wt(t) && !l(t) ? t : ie().withMutations((function(e) {
                        var r = n(t);
                        qt(r.size);
                ...
                Ht.prototype.__ensureOwner = function(t) {
                    ...
                    return ne(this.size, this._root, t, this.__hash)
                };
                ...
                $t.prototype.update = function(t, e, r, n, i, o, a) {
                    ...
                    if (!u || 1 !== s.length) {
                        ...
                        var p = t && t === this.ownerID,
                            h = p ? s : k(s);
                        f ? u ? c === l - 1 ? h.pop() : h[c] = h.pop() : h[c] = [n, i] : h.push([n, i]);
                        if (p) {
                            this.entries = h;
                            return this
                        }
                ...
                Zt.prototype.update = function(t, e, r, n, i, o, a) {
                    ...
                    E(a);
                    (u || !f) && E(o);
                    if (u && 2 === l) return new Qt(t, this.keyHash, s[1 ^ c]);
                    var p = t && t === this.ownerID,
                        h = p ? s : k(s);
                    f ? u ? c === l - 1 ? h.pop() : h[c] = h.pop() : h[c] = [n, i] : h.push([n, i]);
                    if (p) {
                    ...
                    return new Zt(t, this.keyHash, h)
                };
                ...
                Qt.prototype.update = function(t, e, r, n, i, o, a) {
                    ...
                    if (!u) {
                        if (s) {
                            ...
                            return new Qt(t, this.keyHash, [n, i])
                        }
                        E(o);
                        return se(this, t, e, Dt(n), [n, i])
                    }
                    E(o)
                };
                $t.prototype.iterate = Zt.prototype.iterate = function(t, e) {
                    for (var r = this.entries, n = 0, i = r.length - 1; n <= i; n++)
                        if (!1 === t(r[e ? i - n : n])) return !1
                };
                Yt.prototype.iterate = Xt.prototype.iterate = function(t, e) {
                ...
                function se(t, e, r, n, i) {
                    ...
                    var o, a = (0 === r ? t.keyHash : t.keyHash >>> r) & m,
                        u = (0 === r ? n : n >>> r) & m;
                    return new Yt(e, 1 << a | 1 << u, a === u ? [se(t, e, r + y, n, i)] : (o = new Qt(e, n, i), a < u ? [t, o] : [o, t]))
                }
                ...
                function xe(t) {
                    ...
                    if (0 === n) return e;
                    qt(n);
                    return n > 0 && n < v ? Ie(0, n, y, null, new De(r.toArray())) : e.withMutations((function(t) {
                        t.setSize(n);
                ...
                xe.prototype.slice = function(t, e) {
                    var r = this.size;
                    return K(t, e, r) ? this : Pe(this, T(t, r), A(e, r))
                };
                ...
                xe.prototype.__ensureOwner = function(t) {
                    ...
                    return Ie(this._origin, this._capacity, this._level, this._root, this._tail, t, this.__hash)
                };
                ...
                Oe[g] = Oe.remove;
                Oe.setIn = Jt.setIn;
                Oe.deleteIn = Oe.removeIn = Jt.removeIn;
                Oe.update = Jt.update;
                Oe.updateIn = Jt.updateIn;
                Oe.mergeIn = Jt.mergeIn;
                Oe.mergeDeepIn = Jt.mergeDeepIn;
                Oe.withMutations = Jt.withMutations;
                Oe.asMutable = Jt.asMutable;
                Oe.asImmutable = Jt.asImmutable;
                Oe.wasAltered = Jt.wasAltered;
                ...
                function Re(t, e, r) {
                    ...
                    var n = t._tail,
                        i = t._root,
                        o = w(S);
                    e >= je(t._capacity) ? n = Le(n, t.__ownerID, 0, e, r, o) : i = Le(i, t.__ownerID, t._level, e, r, o);
                    if (!o.value) return t;
                    if (t.__ownerID) {
                        t._root = i;
                        t._tail = n;
                    ...
                    return Ie(t._origin, t._capacity, t._level, i, n)
                }
                ...
                function Pe(t, e, r) {
                    ...
                    for (var f = je(o), p = je(u); p >= 1 << s + y;) {
                        c = new De(c && c.array.length ? [c] : [], n);
                        s += y
                    }
                    var h = t._tail,
                        d = p < f ? Fe(t, u - 1) : p > f ? new De([], n) : h;
                    if (h && p > f && a < o && h.array.length) {
                        for (var g = c = Ne(c, n), v = s; v > y; v -= y) {
                            var _ = f >>> v & m;
                            g = g.array[_] = Ne(g.array[_], n)
                        }
                        g.array[f >>> y & m] = h
                    }
                    u < o && (d = d && d.removeAfter(n, 0, u));
                    if (a >= p) {
                        a -= p;
                        u -= p;
                        s = y;
                ...
                Je.prototype.cacheResult = Ge.prototype.cacheResult = $e.prototype.cacheResult = Ye.prototype.cacheResult = _r;
                ...
                function nr(t, e, r, n) {
                    ...
                    c.__iteratorUncached = function(e, r) {
                        ...
                        return new P((function() {
                            ...
                            if (++s > u) return j();
                            var t = i.next();
                            return n || e === B ? t : z(e, s - 1, e === I ? void 0 : t.value[1], t)
                        }))
                    };
                    return c
                }
                ...
                function or(t, e, r, n) {
                    ...
                    i.__iteratorUncached = function(i, o) {
                        ...
                        return new P((function() {
                            var t, o, l;
                            do {
                                if ((t = u.next()).done) return n || i === B ? t : z(i, c++, i === I ? void 0 : t.value[1], t);
                                var f = t.value;
                                o = f[0];
                                l = f[1];
                                s && (s = e.call(r, l, o, a))
                ...
                function ar(t, e) {
                    var r = u(t),
                        i = [t].concat(e).map((function(t) {
                            a(t) ? r && (t = n(t)) : t = r ? ut(t) : st(Array.isArray(t) ? t : [t]);
                            return t
                        })).filter((function(t) {
                            return 0 !== t.size
                        }));
                    ...
                    n.__iterateUncached = function(n, i) {
                        ...
                        function s(t, c) {
                            ...
                            t.__iterate((function(t, i) {
                                (!e || c < e) && a(t) ? s(t, c + 1) : !1 === n(t, r ? i : o++, l) && (u = !0);
                                return !u
                            }), i)
                        }
                        s(t, 0);
                        ...
                        return new P((function() {
                            for (; o;) {
                                ...
                                if (!1 === t.done) {
                                    var c = t.value;
                                    n === R && (c = c[1]);
                                    if (e && !(u.length < e) || !a(c)) return r ? t : z(n, s++, c, t);
                                    u.push(o);
                                    o = c.__iterator(n, i)
                                } else o = u.pop()
                            }
                ...
                function hr(t, e, n) {
                    var i = mr(t);
                    i.size = new et(n).map((function(t) {
                        return t.size
                    })).min();
                    ...
                    i.__iteratorUncached = function(t, i) {
                        ...
                        return new P((function() {
                            ...
                            return u ? j() : z(t, a++, e.apply(null, r.map((function(t) {
                                return t.value
                            }))))
                        }))
                    };
                ...
                function mr(t) {
                    return Object.create((u(t) ? J : s(t) ? $ : Y).prototype)
                }
                ...
                var Er = wr.prototype;
                Er[g] = Er.remove;
                Er.deleteIn = Er.removeIn = Jt.removeIn;
                Er.merge = Jt.merge;
                Er.mergeWith = Jt.mergeWith;
                Er.mergeIn = Jt.mergeIn;
                Er.mergeDeep = Jt.mergeDeep;
                Er.mergeDeepWith = Jt.mergeDeepWith;
                Er.mergeDeepIn = Jt.mergeDeepIn;
                Er.setIn = Jt.setIn;
                Er.update = Jt.update;
                Er.updateIn = Jt.updateIn;
                Er.withMutations = Jt.withMutations;
                Er.asMutable = Jt.asMutable;
                Er.asImmutable = Jt.asImmutable;
                ...
                function Dr(t) {
                    return null == t ? Rr() : Kr(t) && !l(t) ? t : Rr().withMutations((function(e) {
                        var r = o(t);
                        qt(r.size);
                ...
                Dr.isSet = Kr;
                var Tr, Ar = "@@__IMMUTABLE_SET__@@",
                    Mr = Dr.prototype;
                Mr[Ar] = !0;
                Mr[g] = Mr.remove;
                Mr.mergeDeep = Mr.merge;
                Mr.mergeDeepWith = Mr.mergeWith;
                Mr.withMutations = Jt.withMutations;
                Mr.asMutable = Jt.asMutable;
                Mr.asImmutable = Jt.asImmutable;
                Mr.__empty = Rr;
                Mr.__make = Br;
                ...
                function Lr(t) {
                    return null == t ? jr() : Nr(t) ? t : jr().withMutations((function(e) {
                        var r = o(t);
                        qt(r.size);
                        r.forEach((function(t) {
                            return e.add(t)
                ...
                function Ur(t) {
                    return null == t ? Jr() : qr(t) ? t : Jr().unshiftAll(t)
                }
                Ur.of = function() {
                    return this(arguments)
                };
                ...
                Ur.prototype.slice = function(t, e) {
                    if (K(t, e, this.size)) return this;
                    var r = T(t, this.size);
                    if (A(e, this.size) !== this.size) return xt.prototype.slice.call(this, t, e);
                ...
                Ur.prototype.__ensureOwner = function(t) {
                    ...
                    return Gr(this.size, this._head, t, this.__hash)
                };
                ...
                Ur.isStack = qr;
                var Hr, Wr = "@@__IMMUTABLE_STACK__@@",
                    Vr = Ur.prototype;
                Vr[Wr] = !0;
                Vr.withMutations = Jt.withMutations;
                Vr.asMutable = Jt.asMutable;
                Vr.asImmutable = Jt.asImmutable;
                Vr.wasAltered = Jt.wasAltered;
                ...
                Yr[f] = !0;
                Yr[F] = Yr.values;
                Yr.__toJS = Yr.toArray;
                Yr.__toStringMapper = rn;
                Yr.inspect = Yr.toSource = function() {
                    return this.toString()
                };
                Yr.chain = Yr.flatMap;
                ...
                ! function() {
                    try {
                        Object.defineProperty(Yr, "length", {
                            get: function() {
                ...
                Xr[p] = !0;
                Xr[F] = Yr.entries;
                Xr.__toJS = Yr.toObject;
                Xr.__toStringMapper = function(t, e) {
                ...
                $r(i, {
                    ...
                    splice: function(t, e) {
                        ...
                        return dr(this, 1 === r ? n : n.concat(k(arguments, 2), this.slice(t + e)))
                    },
                    ...
                    get: function(t, e) {
                        return (t = O(this, t)) < 0 || this.size === 1 / 0 || void 0 !== this.size && t > this.size ? e : this.find((function(e, r) {
                            return r === t
                        }), void 0, e)
                    },
                    has: function(t) {
                    ...
                    zip: function() {
                        return dr(this, hr(this, nn, [this].concat(k(arguments))))
                    },
                    zipWith: function(t) {
                        var e = k(arguments);
                        e[0] = this;
                        return dr(this, hr(this, t, e))
                    }
                });
                i.prototype[h] = !0;
                i.prototype[d] = !0;
                ...
                function un(t, e) {
                    ...
                    return e = Ot((e = Ct(e ^ e >>> 13, 3266489909)) ^ e >>> 16)
                }
        ...
        470661: t => {
            ...
            t.exports = function(t) {
                var i, o;
                if ((t = String(t).toLowerCase()).length < 3) return t;
                if (t.charCodeAt(0) === e) {
                    i = !0;
                    t = "Y" + t.substr(1)
                }
                b.test(t) ? t = t.substr(0, t.length - 2) : _.test(t) && (t = t.substr(0, t.length - 1));
                if (o = m.exec(t)) u.test(o[1]) && (t = t.substr(0, t.length - 1));
                else if ((o = y.exec(t)) && l.test(o[1])) {
                    t = o[1];
                    v.test(t) ? t += "e" : S.test(t) ? t = t.substr(0, t.length - 1) : f.test(t) && (t += "e")
                }(o = d.exec(t)) && l.test(o[1]) && (t = o[1] + "i");
                (o = w.exec(t)) && u.test(o[1]) && (t = o[1] + r[o[2]]);
                (o = E.exec(t)) && u.test(o[1]) && (t = o[1] + n[o[2]]);
                (o = x.exec(t)) ? c.test(o[1]) && (t = o[1]): (o = g.exec(t)) && c.test(o[1]) && (t = o[1]);
                (o = h.exec(t)) && (c.test(o[1]) || s.test(o[1]) && !f.test(o[1])) && (t = o[1]);
                p.test(t) && c.test(t) && (t = t.substr(0, t.length - 1));
                i && (t = "y" + t.substr(1));
                return t
            };
            var e = "y".charCodeAt(0),
                r = {
                    ational: "ate",
                    tional: "tion",
                    enci: "ence",
                ...
                c = new RegExp("^([^aeiou][^aeiouy]*)?(" + a + o + "){2,}"),
                l = new RegExp("^([^aeiou][^aeiouy]*)?" + i),
                ...
                b = /^.+?(ss|i)es$/,
                S = /([^aeiouylsz])\1$/,
                w = new RegExp("^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$"),
                E = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,
                x = new RegExp("^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$")
        },
        108717: (t, e, r) => {
            "use strict";
            r.d(e, {
            ...
            const f = function(t) {
                ...
                return (0, n.jsxs)("button", c(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var r = null != arguments[e] ? arguments[e] : {},
                            n = Object.keys(r);
                        "function" == typeof Object.getOwnPropertySymbols && (n = n.concat(Object.getOwnPropertySymbols(r).filter((function(t) {
                    ...
                    type: "button",
                    className: o()(u().btnHamburger, s({}, u().btnHamburgerOpen, r), i)
                }, a), {
            ...
            function i() {
                ...
                return {
                    Provider: function(e) {
                        ...
                        return (0, n.createElement)(t.Provider, {
                            value: a.current
                        }, o)
                    },
                    useStore: function(e) {
                        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Object.is,
                            i = (0, n.useContext)(t);
        ...
        42238: function(t, e, r) {
            ...
            ! function(i, o) {
                ...
                var a = "function",
                    ...
                    q = function(t, e) {
                        return typeof t === c && -1 !== H(e).indexOf(H(t))
                    },
                    H = function(t) {
                    ...
                    W = function(t, e) {
                        if (typeof t === c) {
                            t = t.replace(/^\s\s*/, "");
                            return typeof e === u ? t : t.substring(0, 350)
                        }
                    },
                    V = function(t, e) {
                        for (var r, n, i, u, c, l, f = 0; f < e.length && !c;) {
                            var p = e[f],
                                h = e[f + 1];
                            r = n = 0;
                            for (; r < p.length && !c && p[r];)
                                if (c = p[r++].exec(t))
                                    for (i = 0; i < h.length; i++) {
                                        l = c[++n];
                                        typeof(u = h[i]) === s && u.length > 0 ? 2 === u.length ? typeof u[1] == a ? this[u[0]] = u[1].call(this, l) : this[u[0]] = u[1] : 3 === u.length ? typeof u[1] !== a || u[1].exec && u[1].test ? this[u[0]] = l ? l.replace(u[1], u[2]) : o : this[u[0]] = l ? u[1].call(this, l, u[2]) : o : 4 === u.length && (this[u[0]] = l ? u[3].call(this, l.replace(u[1], u[2])) : o) : this[u] = l || o
                                    }
                            f += 2
                        }
                    },
                        ...
                        for (var r in e)
                            if (typeof e[r] === s && e[r].length > 0) {
                                for (var n = 0; n < e[r].length; n++)
                                    if (q(e[r][n], t)) return "?" === r ? o : r
                            } else if (q(e[r], t)) return "?" === r ? o : r;
                        return t
                    },
                    J = {
                        ME: "4.90",
                    ...
                    Y = function(t, e) {
                        ...
                        if (!(this instanceof Y)) return new Y(t, e).getResult();
                        var r = typeof i !== u && i.navigator ? i.navigator : o,
                            n = t || (r && r.userAgent ? r.userAgent : ""),
                            l = r && r.userAgentData ? r.userAgentData : o,
                            f = e ? function(t, e) {
                                var r = {};
                        ...
                        this.getBrowser = function() {
                            ...
                            e.name = o;
                            e.version = o;
                            V.call(e, n, f.browser);
                            e.major = typeof(t = e.version) === c ? t.replace(/[^\d\.]/g, "").split(".")[0] : o;
                            r && r.brave && typeof r.brave.isBrave == a && (e.name = "Brave");
                            return e
                        };
                        ...
                        this.getDevice = function() {
                            ...
                            t.type = o;
                            V.call(t, n, f.device);
                            !t.type && l && l.mobile && (t.type = m);
                            if ("Macintosh" == t.model && r && typeof r.standalone !== u && r.maxTouchPoints && r.maxTouchPoints > 2) {
                                t.model = "iPad";
                                t.type = _
                            }
                            return t
                        ...
                        this.getOS = function() {
                            ...
                            t.version = o;
                            V.call(t, n, f.os);
                            !t.name && l && "Unknown" != l.platform && (t.name = l.platform.replace(/chrome os/i, z).replace(/macos/i, j));
                            return t
                        };
                        ...
                        this.setUA = function(t) {
                            n = typeof t === c && t.length > 350 ? W(t, 350) : t;
                            return this
                        };
                        this.setUA(n);
                        return this
                ...
                Y.BROWSER = U([p, g, l]);
                Y.CPU = U([y]);
                Y.DEVICE = U([f, d, h, v, m, b, _, S, w]);
                Y.ENGINE = Y.OS = U([p, g]);
                if (typeof e !== u) {
                    t.exports && (e = t.exports = Y);
                    e.UAParser = Y
                } else r.amdO ? (n = function() {
                    return Y
                }.call(e, r, e, t)) !== o && (t.exports = n) : typeof i !== u && (i.UAParser = Y);
                var X = typeof i !== u && (i.jQuery || i.Zepto);
                if (X && !X.ua) {
                    var Z = new Y;
                    X.ua = Z.getResult();
                    X.ua.get = function() {
...
//# sourceMappingURL=b203110c71b656d7ac4c.js.map
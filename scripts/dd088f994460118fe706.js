...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [44118, 21375], {
        ...
        919810: (e, t, r) => {
            ...
            function O(e) {
                var t = y(arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [c.Z], 1),
                    r = t[0],
                    n = h(e),
                    o = n.entityType,
                    i = n.channelId,
                    l = o === p.WX.EXTERNAL;
                if (l) return !0;
                var a = r.getChannel(i);
                return null != a && s.ZP.canEveryoneRole(d.Plq.VIEW_CHANNEL, a)
            }

            function v(e) {
                var t = y(arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [l.ZP, c.Z, a.Z, i.Z], 4),
                    r = t[0],
                    n = t[1],
                    s = t[2],
                    d = t[3];
                ...
                var b = e.guild_id,
                    h = e.channel_id,
                    v = e.entity_type === p.WX.EXTERNAL,
                    g = v ? r.getDefaultChannel(e.guild_id) : n.getChannel(h),
                    m = s.getGuild(b),
                    j = d.getStageInstanceByChannel(h);
                return !!(0, o.b)(u.Z, m, g, j) && (null != g && O(e, [n]))
            }

            function g(e) {
                return (0, n.e7)([l.ZP, c.Z, a.Z, i.Z], (function() {
                    return v(e, [l.ZP, c.Z, a.Z, i.Z])
                }), [e])
            }
        },
        876003: (e, t, r) => {
            ...
            function m(e) {
                ...
                return (0, n.jsx)(f.Z, h({
                    className: i()((t = {},
                        y(t, b().avatarUploader, r), y(t, b().avatarUploaderDisabled, !r), t)),
                    imageClassName: i()(o, b().avatarUploaderInnerSquare, y({}, b().avatarUploaderInnerSquareDisabled, !r)),
        ...
        888291: (e, t, r) => {
            ...
            function E(e) {
                var t = e.className,
                    ...
                    o = void 0 === r ? null : r;
                return (0, n.jsx)("div", {
                    className: c()(y().imageUploaderIcon, t),
                    children: o
                })
            }
            var Z = function(e) {
                ...
                i.render = function() {
                    var e, t, r, o, i, l = this.props,
                        ...
                        _ = l.onFileSizeError,
                        M = l.onOpenImageSelectModal,
                        L = l["aria-label"];
                    null != (e = null != a && /^data:/.test(a) ? a : O(a)) ? t = 'url("'.concat(e, '")') : null != h && (r = (0, n.jsx)("div", {
                        className: y().imageUploaderAcronym,
                        children: (0, s.Zg)(h)
                    }));
                    if (v) return (0, n.jsx)("div", {
                        className: c()(y().imageUploader, y().disabled, C),
                        children: (0, n.jsxs)("div", {
                            className: c()(y().imageUploaderInner, Z),
                            style: m(g({}, R), {
                                backgroundImage: t
                            }),
                            children: [r, P && (0, n.jsx)("div", {
                                className: c()(y().imageUploaderIcon, y().imageUploaderIconDisabled, I),
                                children: N
                            })]
                        })
                    });
                    null != a ? o = (0, n.jsx)(u.Anchor, {
                        ...
                        className: y().sizeInfo,
                        children: d.Z.Messages.MINIMUM_SIZE.format({
                            size: p.IXf
                        })
                    }));
                    var T = null !== (i = null != L ? L : b) && void 0 !== i ? i : d.Z.Messages.CHANGE_AVATAR;
                    return (0, n.jsxs)("div", {
                        className: c()(y().imageUploader, C),
                        children: [(0, n.jsx)(u.FocusRing, {
                            within: !0,
                            children: (0, n.jsxs)("div", {
                                className: w ? c()(y().imageUploaderIconWrapper, S) : void 0,
                                children: [(0, n.jsxs)("div", {
                                    className: c()(y().imageUploaderInner, Z),
                                    style: m(g({}, R), {
                                        backgroundImage: t
                                    ...
                                    children: [(0, n.jsx)("span", {
                                        "aria-hidden": !0,
                                        children: r
                                    }), null != M ? (0, n.jsx)(u.Clickable, {
                                        className: y().imageUploaderFileInput,
                                        "aria-label": T,
                                        onClick: M
                                    }) : (0, n.jsx)(f.ZP, {
                                        ref: this.inputRef,
        ...
        796909: (e, t, r) => {
            ...
            function S(e) {
                var t, r, n = null !== (r = null !== (t = y.ZP.lastMessageId(e.id)) && void 0 !== t ? t : e.lastMessageId) && void 0 !== r ? r : e.id,
            ...
            var D, A, _, M = (D = [], A = [], _ = [], function() {
                ...
                L = function(e) {
                    ...
                    n.initialize = function() {
                        this.waitFor(d.Z, b.Z, O.default, s.Z, h.Z);

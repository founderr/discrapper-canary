        ...
        734901: (t, e, n) => {
            ...
            const g = new(function() {
                ...
                t.prototype.getForumChannelSessionId = function(t) {
                    null == this.session && (this.session = v(t));
                    this.session.channelId !== t && (this.session = v(t));
            ...
            function I(t) {
                return g.getForumChannelSessionId(t)
            }

            function C(t) {
                switch (t) {
                    case r.z.CREATION_DATE:
                        return m.SX.CREATION_DATE;
                    case r.z.LATEST_ACTIVITY:
                        return m.SX.LATEST_ACTIVITY;
                    default:
            ...
            function Z(t) {
                ...
                return null != u && u.isForumLikeChannel() ? {
                    ...
                    forum_channel_tag_required: u.hasFlag(E.zZ.REQUIRE_TAG),
                    forum_channel_can_create_post: d.Z.can(y.Plq.SEND_MESSAGES, u),
                    forum_channel_filter_tag_ids: _.Z.getFilterTagIdsAnalytics(),
                    forum_channel_sort_order: _.Z.getSortOrderAnalytics(u.id),
                    forum_channel_session_id: null != a ? a : I(u.id),
            ...
            function L(t) {
                ...
                return null != v && v.isForumLikeChannel() ? S(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(t) {
                    ...
                    forum_post_num_reactions: R(h.id),
                    forum_post_num_unique_reactions: w(h.id),
                    ...
                    forum_post_attachment_mimetypes: N(h.id)
                }) : null
            }
        },
        883069: (t, e, n) => {

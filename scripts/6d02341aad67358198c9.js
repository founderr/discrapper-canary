    ...
    ["55039"], {
        230947: function(e, t, l) {
            ...
            function A(e) {
                let {
                    ...
                    context: C,
                    icon: T
                } = e, N = c.default.getGuild(t), I = o.default.getId(), O = (0, n.useStateFromStores)([_.default], () => _.default.getUser(A)), U = (0, n.useStateFromStores)([f.default], () => f.default.isGuestOrLurker(t, A), [t, A]);
                (0, n.useStateFromStores)([E.default], () => E.default.getGuildVersion(t), [t]);
                let v = a.useMemo(() => ({
                    [t]: [A]
                }), [t, A]);
                (0, d.useSubscribeGuildMembers)(v);
                let h = C === M.AppContext.POPOUT,
                    p = (0, i.default)({
                        guild: N,
                        analyticsLocation: g
                    });
                if (null == N || h) return null;
                let b = I === A && (E.default.can(M.Permissions.CHANGE_NICKNAME, N) || E.default.can(M.Permissions.MANAGE_NICKNAMES, N)),
                    F = I === A,
                    L = E.default.canManageUser(M.Permissions.MANAGE_NICKNAMES, A, N);
                if (!(b || L || F) || null == O || U) return null;
                let x = N.hasFeature(M.GuildFeatures.HUB),
                ...
                return (0, u.jsx)(r.MenuItem, {
                    ...
                    icon: T,
                    action: () => {
                        F ? ((0, s.default)(O.id, O.getAvatarURL(t, 80), {
                            guildId: t
                        }), p()) : (0, r.openModalLazy)(async () => {
                            let {
                                default: e
        ...
        130037: function(e, t, l) {
            ...
            function M(e) {
                ...
                return t
            }(u = n || (n = {})).UNUSUAL_DM_ACTIVITY = "unusual_dm_activity", u.COMMUNICATION_DISABLED = "communication_disabled", u.UNUSUAL_ACCOUNT_ACTIVITY = "unusual_account_activity", u.USERNAME_QUARANTINED = "username_quarantined";
        ...
        459870: function(e, t, l) {
            ...
            function T(e, t) {
                let l = (0, a.useStateFromStores)([f.default], () => f.default.getChannels(t)[f.GUILD_VOCAL_CHANNELS_KEY], [t]),
                    ...
                    N = (0, a.useStateFromStores)([c.default], () => c.default.isGuestOrLurker(t, e.id), [t, e.id]);
                ...
                return 0 === O.length ? null : (0, u.jsx)(n.MenuItem, {
                    id: "voice-move",
        ...
        97508: function(e, t, l) {
            ...
            function A(e, t) {
                ...
                let N = c.default.getHighestRole(S),
                    I = Object.values(S.roles).filter(e => e.id !== S.id),
                    O = T ? I.map(l => {
                        let a = l.managed || !c.default.isRoleHigher(S, N, l),
                            n = -1 !== R.indexOf(l.id);
                ...
                return 0 === O.filter(E.isNotNullish).length ? null : l ? O : (0, u.jsx)(r.MenuItem, {
                    id: "roles",

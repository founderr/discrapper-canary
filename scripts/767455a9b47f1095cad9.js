        ...
        705955: function(e, t, n) {
            ...
            function S(e) {
                let t = new Set,
                    ...
                    i = (0, I.getMostRecentDMedUser)(p, n);
                for (let e of (null != i && !T.default.isBlocked(i.id) && t.add(i.id), h.default.getUserAffinitiesUserIds())) t.add(e);
                let l = new Set;
                if (u === g.InviteTargetTypes.EMBEDDED_APPLICATION) {
                    let e = E.default.getChannelHistory();
                    e.map(e => f.default.getChannel(e)).filter(_.isNotNullish).filter(e => e.type === N.ChannelTypes.GUILD_TEXT).slice(0, 3).forEach(e => l.add(e.id))
                }
            ...
            class O extends d.default.Store {
                initialize() {
                    this.waitFor(T.default, h.default)
                }
                ...
                getSelectedInviteMetadata(e) {
                    let t = m.get(e),
                        n = h.default.getUserAffinitiesUserIds();
                    return null != t ? {
                        rowNum: t.index,
            ...
            O.displayName = "InviteSuggestionsStore";
            var L = new O(c.default, {
                LOAD_INVITE_SUGGESTIONS: function(e) {
                    ...
                    a = null != d ? n : null, s = d, o = c, u = E;
                    let _ = T.default.getRelationships(),
                        f = Object.keys(_).filter(e => _[e] === N.RelationshipTypes.BLOCKED),
                        h = (0, I.getUsersAlreadyJoined)({
                            channel: s,
                            applicationId: o,
                            inviteTargetType: E
                        });

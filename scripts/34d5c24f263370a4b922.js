    ...
    ["94106"], {
        ...
        455933: function(e, t, n) {
            ...
            function N(e, t, n) {
                ...
                let C = d(m.scheduled_start_time),
                    h = null != m.scheduled_end_time ? d(m.scheduled_end_time) : C,
                    A = null != m.description && "" !== m.description ? E.default.unparse(m.description, null !== (u = null == n ? void 0 : n.id) && void 0 !== u ? u : "", !0) : "",
                    p = () => {
                        let e = a();
                        e.createEvent({
                            start: C,
                ...
                return (0, l.jsxs)(o.MenuItem, {
                    ...
                    children: [(0, l.jsx)(o.MenuItem, {
                        ...
                        action: () => {
                            let e = {
                                    text: m.name,
                                    dates: "".concat(C.format(v), "/").concat(h.format(v)),
                                    details: A,
                                    action: "TEMPLATE",
                                    location: i
                                },

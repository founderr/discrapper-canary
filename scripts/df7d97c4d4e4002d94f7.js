    ...
    ["31662"], {
            ...
            var l = n("759843"),
                ...
                f = {
                    createChannel(e) {
                        ...
                        }).then(e => (r.default.isOptInEnabled(t) && d.default.updateChannelOverrideSettings(t, e.body.id, {
                ...
                E = {
                    ...
                    updateGuildNotificationSettingsBulk(e, t) {
                        ...
                        s.default.saveUserGuildSettingsBulk(e), Object.entries(e).forEach(e => {
                            ...
                            a.default.dispatch({
                                ...
                                guildId: n,
                                settings: i
                            }), (0, d.trackGuildNotificationSettingsUpdate)(n, i, s, t)
                        })
                    },
                    updateChannelOverrideSettings(e, t, n, l) {
                        ...
                        s.default.saveUserGuildSettings(e, {
                            ...
                            channelId: t,
                            settings: n
                        }), i.AccessibilityAnnouncer.announce(f.default.Messages.A11Y_ANNOUNCEMENT_CHANNEL_SETTINGS_UPDATED), (0, d.trackChannelNotificationSettingsUpdate)(e, t, n, r, l)
                    },
        ...
        617347: function(e, t, n) {
            ...
            function U(e) {
                ...
                } = (0, _.useManageResourcePermissions)(t), i = (0, d.useStateFromStores)([C.default], () => !t.isGuildVocal() || C.default.can(L.Permissions.CONNECT, t), [t]), r = s.useMemo(() => (0, E.default)(t), [t]), c = (0, h.getChannelIconComponent)(t);
            ...
            function k(e) {
                ...
                let {
                    ...
                    recurrenceRule: J,
                    recurrenceId: Q
                } = e, $ = (0, T.isChannelPublic)(i, d), ee = d === x.GuildScheduledEventEntityTypes.EXTERNAL, {
                ...
                return (0, a.jsxs)(o.ClickableContainer, {
                    ...
                    children: [(0, a.jsxs)("div", {
                        ...
                        children: [0 === h && (0, a.jsx)(I.default, {
                            ...
                            eventPreview: X,
                            recurrenceId: Q
                        }), C && null != l && null != G && U > 0 && (0, a.jsx)(O.default, {
                            guild: l,
                            speakers: G,
                            speakerCount: U,
                            className: M.spacing
        ...
        298843: function(e, t, n) {
            ...
            function N(e) {
                ...
                } = (0, o.useManageResourcePermissions)(null != R ? R : O), L = x(a), G = (0, r.useStateFromStores)([d.default], () => d.default.isLurking(m), [m]), M = a.entity_type === p.GuildScheduledEventEntityTypes.STAGE_INSTANCE, [U, w] = i.useState(M), [k, {
                    loading: P,
                    error: D
                }] = (0, C.default)();
                if (!L) return null;
                ...
                return (0, l.jsx)(u.ModalRoot, {
                    ...
                    children: (0, l.jsxs)(u.ModalContent, {
                        ...
                        }), null != D && null != D.getAnyErrorMessage() ? (0, l.jsx)(u.Text, {
                            color: "text-danger",
                            variant: "text-sm/normal",
        ...
        244480: function(e, t, n) {
            ...
            function S(e, t) {
                ...
                return r === C.RequestToSpeakStates.REQUESTED_TO_SPEAK_AND_AWAITING_USER_ACK && !t && (0, d.trackWithMetadata)(g.AnalyticEvents.PROMOTED_TO_SPEAKER, {
                    ...(0, h.getStageChannelMetadata)(e)
                }), s.default.patch({
            ...
            function I(e, t, n) {
                ...
                n ? (d.allow = a.default.add(d.allow, t), d.deny = a.default.remove(d.deny, t)) : (d.allow = a.default.remove(d.allow, t), d.deny = a.default.add(d.deny, t)), r.default.updatePermissionOverwrite(e.id, d)
            }

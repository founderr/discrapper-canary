...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [19630, 56620], {
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            return new h(I(e.minValue, e.maxValue), I(e.minStart, e.maxStart), I(e.minFinal, e.maxFinal), I(e.minDuration, e.maxDuration), g(e.minDirection, e.maxDirection), S(e.easingFunctions)[0])
                    }
                }(O(O({}, e), {
                    valueType: "number"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = T(e.minStart),
                                ...
                                m = T(e.minDirection),
                                P = T(e.maxDirection);
                            return new y(new h(I(n.x, r.x), I(f.x, p.x), I(d.x, O.x), I(_.x, E.x), g(m.x, P.x), S(e.easingFunctions)[0]), new h(I(n.y, r.y), I(f.y, p.y), I(d.y, O.y), I(_.y, E.y), g(m.y, P.y), S(e.easingFunctions)[0]))
                    }
                }(O(O({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = m(e.minStart),
                                ...
                                T = m(e.minDirection),
                                P = m(e.maxDirection);
                            return new E(new h(I(n.x, r.x), I(f.x, p.x), I(d.x, O.x), I(_.x, y.x), g(T.x, P.x), S(e.easingFunctions)[0]), new h(I(n.y, r.y), I(f.y, p.y), I(d.y, O.y), I(_.y, y.y), g(T.y, P.y), S(e.easingFunctions)[0]), new h(I(n.z, r.z), I(f.z, p.z), I(d.z, O.z), I(_.z, y.z), g(T.z, P.z), S(e.easingFunctions)[0]))
                    }
                }(O(O({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var N = r.forwardRef((function(e, t) {
                    ...
                    I = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == d || d(t), E.current.size > 0 ? b.current = window.requestAnimationFrame(I) : (t.clearRect(0, 0, e.width, e.height), b.current = null);
                                var n = Date.now();
                ...
                var S = r.useCallback((function(e, t) {
                    ...
                    g = r.useCallback((function(e, t, n, r, i) {
                        var c, u = R(null !== (c = e.id) && void 0 !== c ? c : (0, o.v4)(), e, n, r, i);
                        return S(u, t), u
                    }), [S]),
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", w, a), e("mousedown", N, l), e("mousemove", A, s), e("mouseup", x, f),
                        function() {
                            window.removeEventListener("click", w), window.removeEventListener("mousedown", N), window.removeEventListener("mousemove", A), window.removeEventListener("mouseup", A)
                        }
                }), [w, N, A, x, a, l, s, f]), r.useEffect((function() {
                    var e = y.current,
        ...
        305082: (e, t, n) => {
            ...
            function P() {
                return e = m, t = T, n = h("useMemoizedValueSyncedWithDismissibleContents"), i = (0, o.e7)([a.Z], (function() {
                    var e;
        ...
        518197: (e, t, n) => {
            ...
            function h(e) {
                var t, n, b = e.channel,
                    h = e.transitionState,
                    I = e.onClose,
                    S = c.Z.getGuild(b.guild_id),
                    g = null !== (t = null == S ? void 0 : S.maxStageVideoChannelUsers) && void 0 !== t ? t : 0,
                    T = O.AI.getCurrentConfig({
                        guildId: b.guild_id,
                        location: "cf0105_1"
                    }, {
                        autoTrackExposure: !0
                    }).enabled,
                    m = E.Z.Messages.STAGE_FULL_TITLE,
                    P = T ? g < _.TU7 : (null == S ? void 0 : S.premiumTier) !== _.Eu4.TIER_3 && g <= _.eez,
                    C = u.Z.can(d.yP, b);
                n = T && (null == S ? void 0 : S.premiumTier) === _.Eu4.TIER_3 ? g <= _.TU7 ? E.Z.Messages.STAGE_FULL_BOOST_MORE_BODY : E.Z.Messages.STAGE_FULL_MAX_BODY : P ? E.Z.Messages.STAGE_FULL_BODY : E.Z.Messages.STAGE_FULL_MAX_BODY;
                var w = function() {
                        I();
                        s.default.track(_.rMx.BOOSTING_UPSELL_CLICKED, {
                            guild_id: b.guild_id,
                            type: y.cd.VIDEO_STAGE_LIMIT,
                            is_moderator: C,
                            action: y.T7.DISMISS
                        })
                    },
                    R = f.Z.getMutableParticipants(b.id, p.pV.SPEAKER).filter((function(e) {
                        return e.type === p.Ui.VOICE
                    })).length,
                    N = f.Z.getParticipantCount(b.id, p.pV.AUDIENCE);
        ...
        585798: (e, t, n) => {
            ...
            var I, S = (0, d.Mg)(s.Z.FULL_SCREEN_LAYER_ANIMATION_DURATION);
            ! function(e) {

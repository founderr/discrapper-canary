    ...
    [11569], {
            ...
            var _ = {
                ...
                setPinChat: function(t) {
                    ...
                    if (0 !== o.length && null != e && null != r && null != s) {
                        ...
                        if (t) {
                            var O = "auto" === E.width ? s.minSize.width : E.width;
                            O -= e.minSize.width;
                            ...
                            var P = "auto" === u.width ? r.minSize.width : u.width;
                            P += e.minSize.width;
                            var N = m((0, y.o4)(_, {
                                    height: h.height,
                                    width: P
        ...
        980559: (t, i, o) => {
            ...
            var y = function(t) {
                ...
                return (0, e.jsx)("svg", n(function(t) {
                    for (var i = 1; i < arguments.length; i++) {
                        var o = null != arguments[i] ? arguments[i] : {},
                            e = Object.keys(o);
                        "function" == typeof Object.getOwnPropertySymbols && (e = e.concat(Object.getOwnPropertySymbols(o).filter((function(t) {
            ...
            const I = new O(a.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(t) {
                    ...
                    s.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == i ? void 0 : i.sku_id) === n.Si.TIER_2 && null == r.Z.getPremiumSubscription(!1) && null == _.tutorialExpirationTime && b()
                }
            })
        },
        156620: (t, i, o) => {
                ...
                function n(r) {
                    return function(n) {
                        return function(r) {
                            ...
                            for (; s;) try {
                                if (o = 1,
                                    e && (a = 2 & r[0] ? e.return : r[0] ? e.throw || ((a = e.return) && a.call(e), 0) : e.next) && !(a = a.call(e, r[1])).done) return a;
            ...
            function M(t, i, o) {
                (0, x.PS)(t, (function(e) {
                    var a = i.guildId === O.X8,
                        ...
                        s = null != e.joinSound ? h.MW.UPDATED : h.MW.ADDED;
                    e.joinSound = {
                        soundId: i.soundId,
            ...
            var P, N, L, D = (N = (P = function(t) {
                ...
                j = function(t, i, o, e) {
                    var a = (0, h.sp)([i], t.getGuildId()),
                        ...
                        p = a.animated,
                        c = R[e];
                    n.ZP.trackWithMetadata(f.rMx.VOICE_CHANNEL_EFFECT_SENT, {
                        channel_id: t.id,
        ...
        710981: (t, i, o) => {
            ...
            l.displayName = "VoiceChannelEffectsPersistedStore";
            l.persistKey = "VoiceChannelEffectsPersistedStore";
            const u = new l(a.Z, {
        ...
        986279: (t, i, o) => {
            ...
            var h = [],
                ...
                w = function(t) {
                    ...
                    o.prototype.getEffectForUserId = function(t) {
                        return b[t]
                    };
                    ! function(t, i, o) {
                        i && p(t.prototype, i);
            ...
            w.displayName = "VoiceChannelEffectsStore";
            const g = new w(s.Z, {
                ...
                VOICE_CHANNEL_EFFECT_SENT_LOCAL: function() {
                    ...
                    if ((I = [t].concat(k(I)).slice(0, 20)).length >= 20) {
                        ...
                        o < 1e4 && (f = new Date(t.getTime() + 1e4 - o))
                    }
                },
        ...
        285629: (t, i, o) => {
            ...
            var R, j = {
                ...
                M = {
                    BASIC: [r],
                    PREMIUM: [s, n, x, y, d, p, c, l, u, k, f, m, _, h, b, E, O, I, v, w, g]
                },
                U = (D(R = {}, N.q.BASIC, M.BASIC), D(R, N.q.PREMIUM, M.PREMIUM), R),
            ...
            function G(t) {
                var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : N.v;
                if (null != t.id) {
                    var o;
                ...
                var e = S.ZP.convertSurrogateToName(t.name, !1),
                    a = S.ZP.getByName(e);
                return null != a ? P.ZP.getURL(a.surrogates) : ""
            }
        ...
        138049: (t, i, o) => {
            ...
            function N(t, i) {
                N = Object.setPrototypeOf || function(t, i) {
                    t.__proto__ = i;
                    return t
                };
                return N(t, i)
            ...
            function Y(t) {
                if (F && !__OVERLAY__) {
                    ...
                    if ("" !== i && null != i && o !== E.kg4.UNASSIGNED && e)
                        ...
                        } else j.error("[kb store] KeybindStore: Looking for callback action ".concat(o, " but it doesn't exist in this version. Skipping"))
                }
            }
                ...
                e.hasKeybind = function(t, i, o) {
                    for (var e in U) {
                        var a = !0,
                            ...
                            s = void 0;
                        try {
                            for (var n, x = U[e].shortcut[Symbol.iterator](); !(a = (n = x.next()).done); a = !0) {
                                var y = n.value;
                ...
                KEYBINDS_REGISTER_GLOBAL_KEYBIND_ACTIONS: function(t) {
                    ...
                    d().forEach(U, (function(t) {
                        ...
                        try {
                            ...
                            j.error("Failed to register keybind", t, i)
                        }
                    }));
                    F = !0
                }
        ...
        887643: (t, i, o) => {
                            ...
                            if (Array.isArray(t) && 0 !== t.length) {
                                ...
                                try {
                                    for (var a, r = t[Symbol.iterator](); !(i = (a = r.next()).done); i = !0) {
                                        var s = a.value;
                                        if (null != s) {
                                            var n, x, y, d, p, c, l, u = null != s.processName ? E.Z.getGameByExecutable(s.processName) : null;
            ...
            function Et() {
                Et = P((function() {
                    var t, i, o, e, a, r, s, n, x, y, d, c, l, u, k, f, m, _, h, b, E, O, v, g, S, A, C, P, N, L, D, R, j, M, U, Z, F, G, H = arguments;
                    return W(this, (function(V) {
                        switch (V.label) {
                            case 0:
                                null == (t = H.length > 0 && void 0 !== H[0] ? H[0] : null) && (t = tt && ot ? I.ZP.getOverlayEligiblePIDs() : []);
                                switch (it) {
                                    case T.gl.Global:
                                        return [3, 1];
                                    case T.gl.Hook:
                                ...
                                return [3, 28];
                            case 1:
                                i = I.ZP.getVisibleGame();
                                e = -1 !== t.indexOf(null !== (o = null == i ? void 0 : i.pid) && void 0 !== o ? o : -1);
                                if (null == i || !e) return [3, 8];
                                d = i.pid;
                                return [4, It()];
                            case 2:
                                c = V.sent();
                            ...
                            case 3:
                                V.trys.push([3, 5, , 6]);
                                c += "&pid=".concat(d);
                                return [4, null === p.Z || void 0 === p.Z || null === (l = p.Z.globalOverlay) || void 0 === l || null === (u = l.openOverlay) || void 0 === u ? void 0 : u.call(l, c)];
                            case 4:
                                V.sent();
                                return [3, 6];
                            case 5:
                                k = V.sent();
                                yt.log("globalOverlay: Failed to open overlay: ".concat(k), k);
                                return [3, 6];
                            case 6:
                                return [4, null === p.Z || void 0 === p.Z || null === (a = p.Z.globalOverlay) || void 0 === a || null === (r = a.getWindowHandles) || void 0 === r ? void 0 : r.call(a)];
                            case 7:
                                m = null !== (f = V.sent()) && void 0 !== f ? f : [];
                                null === (n = (s = w.ZP.getDiscordUtils()).globalOverlaySetWindowHandles) || void 0 === n || n.call(s, m);
                                _ = function() {
                                    var t;
                                    St(d);
                                    null === p.Z || void 0 === p.Z || null === (t = p.Z.globalOverlay) || void 0 === t || t.showOverlay()
                                };
                                h = function() {
                                    var t;
                                    St(0);
                                    null === p.Z || void 0 === p.Z || null === (t = p.Z.globalOverlay) || void 0 === t || t.hideOverlay()
                                };
                                b = function() {
                                    var t;
                                    null === p.Z || void 0 === p.Z || null === (t = p.Z.globalOverlay) || void 0 === t || t.hideOverlay()
                                ...
                                null === (y = (x = w.ZP.getDiscordUtils()).globalOverlaySetTrackedGame) || void 0 === y || y.call(x, i.pid, i.windowHandle, _, h, b, E);
                                return [3, 10];
                            case 8:
                                return [4, null === p.Z || void 0 === p.Z || null === (O = p.Z.globalOverlay) || void 0 === O || null === (v = O.closeOverlay) || void 0 === v ? void 0 : v.call(O)];
                            case 9:
                                V.sent();
                                null === (S = (g = w.ZP.getDiscordUtils()).globalOverlayClearTrackedGame) || void 0 === S || S.call(g);
                                V.label = 10;
                            case 10:
                                return [3, 29];
                            case 11:
                                ...
                                V.label = 12;
                            case 12:
                                V.trys.push([12, 17, 18, 19]);
                                N = t[Symbol.iterator]();
                                V.label = 13;
                            case 13:
                                if (A = (L = N.next()).done) return [3, 16];
                                D = L.value;
                                return z.has(D) ? [3, 15] : [4, ut(D)];
                            case 14:
                                V.sent();
                                V.label = 15;
                            case 15:
                            ...
                            case 19:
                                ...
                                V.label = 20;
                            case 20:
                                V.trys.push([20, 25, 26, 27]);
                                U = z.keys()[Symbol.iterator]();
                                V.label = 21;
                            case 21:
                                if (R = (Z = U.next()).done) return [3, 24];
                                F = Z.value;
                                return t.includes(F) ? [3, 23] : [4, ft(F)];
                            case 22:
                                V.sent();
                                V.label = 23;
                            case 23:
                ...
                gt = dt(q, (vt = P((function(t) {
                    ...
                    return W(this, (function(a) {
                        switch (a.label) {
                            ...
                            case 5:
                                a.sent();
                                return [4, null === p.Z || void 0 === p.Z || null === (o = p.Z.globalOverlay) || void 0 === o || null === (e = o.closeOverlay) || void 0 === e ? void 0 : e.call(o)];
                            case 6:
                                a.sent();
                                a.label = 7;
                            case 7:
                    ...
                    return W(this, (function(x) {
                        switch (x.label) {
                            ...
                            case 1:
                                ...
                                t ? null === (r = (a = w.ZP.getDiscordUtils()).globalOverlayFocusTrackedGame) || void 0 === r || r.call(a) : null === (n = (s = w.ZP.getDiscordUtils()).globalOverlayFocusOverlay) || void 0 === n || n.call(s);
                                return [2]
                        }
                    }))
                }))).apply(this, arguments)
            ...
            function Lt(t) {
                t ? it === T.gl.Global ? Pt(t) : setTimeout((function() {
                    return Pt(t)
                }), 200) : Pt(t)
            }
            var Dt = null;
            ...
            function Rt(t) {
                ...
                "USER_SETTINGS_PROTO_UPDATE" === t.type && (t = M(j({}, t), {
                    settings: {
            ...
            var Gt = new Ft(r.Z, __OVERLAY__ ? {} : {
                ...
                RPC_SERVER_READY: function(t) {
                    ...
                    a.append("build_id", "218715a3aa6cfa4850a2266a9292ca36b6f2c3f7");

    ...
    ["89399"], {
        ...
        94973: function(e, t, n) {
            ...
            function x(e) {
                let {
                ...
                } = e, x = (0, r.useStateFromStores)([p.default], () => p.default.isSyncing), {
                    ...
                    onComplete: I,
                    forcesTransitionToGuild: g
                }), b = t.subscription_plans[0], O = 0 === b.price, w = (null == L ? void 0 : L.id) === t.id, V = (0, o.default)(), U = V && !P || x, D = () => {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(R, {
                            ...
                            children: [(0, i.jsx)(u.Text, {
                                ...
                                children: O ? C.default.Messages.APPLICATION_SUBSCRIPTION_FREE : C.default.Messages.APPLICATION_SUBSCRIPTION_AMOUNT_PER_PERIOD.format({
                                ...
                                if (w) return (0, i.jsx)(N, {
                                    children: (null == y ? void 0 : y.status) === m.SubscriptionStatusTypes.CANCELED ? C.default.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CANCELED_LABEL : C.default.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CURRENT_TIER_LABEL
                                });
        ...
        913678: function(e, t, n) {
            ...
            function h(e) {
                ...
                } = (0, u.useActiveSubscriptionListingForApplication)(o, n), m = (0, l.default)();
                s.useEffect(() => {
                    m && r.fetchSubscriptions()
                }, [m]);
                let C = null == S ? void 0 : S.id,
                    T = null == S ? void 0 : null === (t = S.subscription_listings) || void 0 === t ? void 0 : t.filter(e => e.published);
                return E && (null == n || v) ? null == C || null == T || 0 === T.length ? null : (0, i.jsx)("div", {
        ...
        467094: function(e, t, n) {
            ...
            function L(e) {
                c.FrecencyUserSettingsActionCreators.updateAsync("favoriteStickers", t => (t.stickerIds = y(t.stickerIds), s.size(t.stickerIds) >= E.MAX_FAVORITES) ? (l.default.show({

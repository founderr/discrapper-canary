(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [52209, 95331, 57678, 58621, 96043, 71402], {
        737264: e => {
            "use strict";
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = o(e),
                    ...
                    p = d.length;
                for (var I in e) !t && !s.call(e, I) || E && ("length" == I || _ && ("offset" == I || "parent" == I) || f && ("buffer" == I || "byteLength" == I || "byteOffset" == I) || u(I, p)) || d.push(I);
                return d
            }
        },
        70151: (e, t, n) => {
                ...
                r.prototype = {
                    ...
                    avg: function(t) {
                        ...
                        if (!n._avg || t) {
                            ...
                            n._avg = l ? [~~(s / l), ~~(c / l), ~~(_ / l)] : [~~(8 * (n.r1 + n.r2 + 1) / 2), ~~(8 * (n.g1 + n.g2 + 1) / 2), ~~(8 * (n.b1 + n.b2 + 1) / 2)]
                        }
                        return n._avg
                    },
                    contains: function(e) {
                    ...
                    if (r.count()) {
                        ...
                        if (u == i)
                            for (l = r.r1; l <= r.r2; l++) {
                                _ = 0;
                                for (s = r.g1; s <= r.g2; s++)
                                    for (c = r.b1; c <= r.b2; c++) _ += n[e(l, s, c)] || 0;
                                f += _;
                                E[l] = f
                            } else if (u == o)
                                for (l = r.g1; l <= r.g2; l++) {
                                    _ = 0;
                                    for (s = r.r1; s <= r.r2; s++)
                                        for (c = r.b1; c <= r.b2; c++) _ += n[e(s, l, c)] || 0;
                                    f += _;
                                    E[l] = f
                                } else
                                    for (l = r.b1; l <= r.b2; l++) {
                                        _ = 0;
                                        for (s = r.r1; s <= r.r2; s++)
                                            for (c = r.g1; c <= r.g2; c++) _ += n[e(s, c, l)] || 0;
                                        f += _;
                                        E[l] = f
                                    }
        ...
        444663: (e, t, n) => {
            ...
            function R(e) {
                var t, n = e.onClose,
                    ...
                    R = h.isLoading,
                    N = h.suggestedPremiumType,
                    L = !l && N === O.p9.TIER_0,
                    y = (0,
                        s.e7)([f.default], (function() {
                        return f.default.getCurrentUser()
                    })),
                    C = (0, r.jsx)(_.Z, {
                        icons: g.J6
                    });
                t = L ? v.Z.Messages.UPLOAD_AREA_PREMIUM_TIER_UPSELL_BODY_LINE_2.format({
                ...
                return (0, r.jsx)(T.Z, function(e) {
                    ...
                    onClose: n,
                    subscriptionTier: L ? O.Si.TIER_0 : O.Si.TIER_2,
                    isLoading: R
                }, u))
            }
            var N = n(443812),
        ...
        396043: (e, t, n) => {
            ...
            function U(e) {
                ...
                return R({
                    ...
                    game_name: null != (n = h.ZP.getCurrentGameForAnalytics()) ? n.name : null,
            ...
            function w(e) {
                ...
                if (!g.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        s = R({}, t, L(u), null != i && null != o && (0, b.AB)(o) ? y(0, o) : P(a));
                    g.default.track(e, s, {
                        flush: n
                    })
                }
        ...
        159895: (e, t, n) => {
            ...
            function g(e) {
                var t;
                return I(t = {}, O, e.non_subscriber), I(t, f.Si.TIER_0, e[f.Si.TIER_0]), I(t, f.Si.TIER_2, e[f.Si.TIER_2]), t
            }
            ...
            function v(e) {
                ...
                S(l.default.getCurrentUser(), i, n, r)
            }
            ...
            function S(e, t, n, r) {
                if (null != e && !(0, c.I5)(e) && n) {
                    ...
                    if (r) {
                        s.Z.isLoadedForSKU(f.Si.TIER_0) || s.Z.isFetchingForSKU(f.Si.TIER_0) || (0, u.GZ)(f.Si.TIER_0);
                        s.Z.isLoadedForSKU(f.Si.TIER_2) || s.Z.isFetchingForSKU(f.Si.TIER_2) || (0, u.GZ)(f.Si.TIER_2)
                    }
                }
            }
        },
            ...
            function f(e) {
                ...
                var T = u.L.useExperiment({
                    ...
                    O = n.useExperiment({
                        ...
                        autoTrackExposure: T && !I && !p && t
                    }),
                    m = O.enabled,
                    g = O.useExpectedValue,
                    v = O.useLikelihood,
                    h = (0, r.cj)([s.Z], (function() {
                        var e = s.Z.getState();
                        return {
                            fetched: e.fetched,
                ...
                if (T)
                    if (p) {
                        var L = d.subscription_trial;
                        (null == L ? void 0 : L.sku_id) === c.Si.TIER_0 ? N = c.p9.TIER_0 : (null == L ? void 0 : L.sku_id) === c.Si.TIER_2 && (N = c.p9.TIER_2)
                    } else if (!I && !R && m)
                    if (g) {
                        N = function(e, t, n) {
                            return null == e ? c.p9.TIER_2 : e[c.Si.TIER_0] * t > e[c.Si.TIER_2] * n ? c.p9.TIER_0 : c.p9.TIER_2
                        }(S, (0, a.aS)(c.Xh.PREMIUM_MONTH_TIER_0).amount, (0, a.aS)(c.Xh.PREMIUM_MONTH_TIER_2).amount)
                    } else v && (N = function(e) {
        ...
        442212: (e, t, n) => {
            ...
            function b(e) {
                ...
                var ee, te = F ? a()(g().artContainer, g().artContainerBoxShadow, C) : a()(g().artContainer, C),
                    ne = null;
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [null != G ? (0, r.jsx)(u.Button, {
                                ...
                                var t = Q ? J ? O.Z.Messages.MARKETING_PAGE_CTA_TRY_1_MONTH_FREE : (null == X || null === (e = X.subscription_trial) || void 0 === e ? void 0 : e.sku_id) === I.Si.TIER_2 ? O.Z.Messages.PREMIUM_TRIAL_CTA_BUTTON_VARIANT : O.Z.Messages.PREMIUM_TRIAL_TIER_0_CTA_BUTTON_VARIANT : void 0,
                            ...
                            color: u.Button.Colors.PRIMARY,
                            look: u.Button.Looks.LINK,
                            children: null != z ? z : O.Z.Messages.BACK
                        })]
                    })]
                })
            }
        ...
        491260: (e, t, n) => {
            ...
            function w(e) {
                ...
                delete L[e];
                if (null != A[e]) {
                    var t = m(a().sortBy(A[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
                    ...
                    try {
                        for (var o, a = Object.keys(N)[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                            var u = o.value,
                                ...
                                _ = void 0;
                            try {
                                for (var f, E = l[Symbol.iterator](); !(s = (f = E.next()).done); s = !0) {
                                    var d = f.value;
            ...
            const F = new B(l.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(e) {
                    ...
                    if (R[t] === e.status && N[t] === e.activities) return !1;
                    R[t] = e.status;
                    N[t] = e.activities;
                    delete y[t]
                }
        ...
        347117: (e, t, n) => {
            ...
            function f(e) {
                ...
                if (t !== r || n !== i) {
                    ...
                    var c = (n = Math.max(Math.round(n * s), l)) > i ? i / n : 1;
            ...
            function O(e, t, n) {
                ...
                var u = function(e, t, n) {
                        for (var r, i, o, a, u, l = [], s = 0; s < t; s += n) {
                            i = e[0 + (r = 4 * s)];
                            o = e[r + 1];
                            a = e[r + 2];
                    ...
                    s = l()(u, t);
                return "boolean" == typeof s ? T : s.palette()
            }
            var m = function(e) {
                    return g(e)
                },
                g = a().memoize((function(e) {

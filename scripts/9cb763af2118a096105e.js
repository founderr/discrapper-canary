    ...
    ["73178"], {
        ...
        643070: function(e, t, r) {
            ...
            var _ = () => {
                ...
                return (0, i.useMemo)(() => {
                    let e = (0, s.uniqBy)([...(0, d.getAvatarDecorationsFromPurchases)(a), ...(0, d.getAvatarDecorationsFromCategories)(_)], "id"),
                        i = e.reduce((e, r) => {
                            let n = a.get(r.skuId),
                                i = (0, d.isPremiumCollectiblesPurchase)(n);
                    ...
                    return [{
                        ...
                        section: i.premium_purchase.length > 0 ? n.PREMIUM_PURCHASE : n.PREMIUM_PREVIEW,

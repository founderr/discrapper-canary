...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [26974, 81580, 70584, 18966, 96043, 71402, 1459], {
        737264: e => {
                    ...
                    if (null != r && null != r.guild_id) {
                        ...
                        if (null != i[e]) {
                            ...
                            var d = !0,
                                ...
                                p = void 0;
                            try {
                                for (var h, I = s[Symbol.iterator](); !(d = (h = I.next()).done); d = !0) {
                                    _(h.value, t, n)
                                }
                            } catch (e) {
                                E = !0;
            ...
            function D(e) {
                ...
                if (!O.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        c = N({}, t, b(u), null != i && null != o && (0, A.AB)(o) ? L(0, o) : P(a));
                    O.default.track(e, c, {
                        flush: n
                    })
                }
                        ...
                        return v(this, (function(b) {
                            switch (b.label) {
                                ...
                                case 2:
                                    ...
                                    b.label = 3;
                                case 3:
                                    O = a.Z.getRemoteSessionId();
                                    g = f.Z.getVoiceStateForSession(s.default.getId(), O);
                                    y = (null == g ? void 0 : g.channelId) === t.id;
                                    R = y || d.Z.getChannelId() === f.Z.getCurrentClientVoiceChannelId(t.guild_id);
                                    if (!A && !m && (0, _._)(t)) return [2, new Promise((function(o) {
                                        var a = e;
                                    ...
                                    m || p || o.default.selectVoiceChannel(t.id);
                                    !__OVERLAY__ && (p || R || T || S) && function(e) {
                                        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                            n = e.getGuildId();
        ...
        866893: (e, t, n) => {
            ...
            function j(e) {
                return function(t, n) {
                    return (0, h.yv)(t) ? -1 : (0, h.yv)(n) ? 1 : e === o.z.LATEST_ACTIVITY ? a.default.compare(k(n), k(t)) : a.default.compare(n, t)
                }
            }
            ...
            function x(e) {
                ...
                if (null != t) {
                    ...
                    if (0 !== F.size) {
                        D = Array.from(new Set(g(D).concat(g(F))));
                        F.clear()
                    }
                    ...
                    var n, r = (C === o.z.LATEST_ACTIVITY ? G : w).value(),
                        a = (U = 0 === L.size ? r : r.filter((n = L, function(e) {
            ...
            const W = new Y(l.Z, {
                ...
                THREAD_LIST_SYNC: function(e) {
                    var t, n = e.guildId;
                    if (null == b) return !1;
                    if (n !== (null === (t = f.Z.getChannel(b)) || void 0 === t ? void 0 : t.guild_id)) return !1;
                    x({
                        refreshThreadIds: !0
                    })
                },
                THREAD_CREATE: function(e) {
                    ...
                    if (null == t.parent_id || t.parent_id !== b) return !1;
                    if (!n) return !1;
                    t.ownerId !== d.default.getId() ? P++ : R = t.id
                },
                            ...
                            return function(e) {
                                ...
                                try {
                                    for (var f, _ = Object.keys(i)[Symbol.iterator](); !(c = (f = _.next()).done); c = !0) {
                                        var E = f.value,
                                            p = i[E].computeSeenTimeDestructive(a);
                                        if (p > 0) {
                                            u.push(E);
                                            l.push(p)
                                        }
        ...
        165586: (e, t, n) => {
            ...
            var h = [p(r.RESOLUTION_720), p(r.RESOLUTION_1080), p(r.RESOLUTION_1440), p(r.RESOLUTION_SOURCE, (function() {
                ...
                O = [p(i.FPS_15), p(i.FPS_30), p(i.FPS_60)],
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[e] && null != C[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in C[e][t]) t === D ? f.ZP.isNewForumThread(u, t, r) && M[e][t]++ : o.default.compare(u, i) > 0 && !f.ZP.hasOpenedThread(u) && M[e][t]++
                        }
                    }
                }
            }
            ...
            var ne = {},
                ...
                ue = function(e) {
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, o, a;
                        return i().size(null !== (o = null === (n = b[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== o ? o : {}) + i().size(null !== (a = null === (r = C[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== a ? a : {})
                    };
                    r.__getLocalVars = function() {
                        return {
        ...
        52317: (e, t, n) => {
            ...
            var g = function(e, t) {
                ...
                S = {},
                A = new u.Z("UserGuildSettingsManager"),
                y = 0;
                    ...
                    return g(this, (function(_) {
                        switch (_.label) {
                            case 0:
                                ...
                                for (var E in r)
                                    if (null != (a = c.Z.getChannel(E)) && null != a.guild_id) {
                                        ...
                                        e[a.guild_id].channel_overrides[a.id] = I(h({}, e[a.guild_id].channel_overrides[a.id]), {
                                            collapsed: a.id in n
                                        });
                                        t = !0
                                    } if (!t) return [2];
                            ...
                            case 1:
                                ...
                                if ((d = u.shift()).guildId === s.I_8) return [3, 1];
                                _.label = 2;
                            case 2:
                                _.trys.push([2, 5, , 7]);
                                return [4, o.ZP.patch({
            ...
            const g = new m(i.Z, {
                        ...
                        for (var i, o = e.userGuildSettings.entries[Symbol.iterator](); !(t = (i = o.next()).done); t = !0) {
                            ...
                            if (null != a.channel_overrides) {
                                var u = !0,
                                    ...
                                    c = void 0;
                                try {
                                    for (var s, d = a.channel_overrides[Symbol.iterator](); !(u = (s = d.next()).done); u = !0) {
                                        var f = s.value;
                                        f.collapsed ? I[f.channel_id] = !0 : delete I[f.channel_id]
                                    }
                                } catch (e) {
                                    l = !0;
                                    c = e
                ...
                USER_GUILD_SETTINGS_FULL_UPDATE: function(e) {
                    ...
                    var u = !0,
                        ...
                        c = void 0;
                    try {
                        for (var s, d = t[Symbol.iterator](); !(u = (s = d.next()).done); u = !0) {
                            var f = s.value,
                                _ = !0,
                                E = !1,
                                p = void 0;
                            try {
                                for (var h, v = f.channel_overrides[Symbol.iterator](); !(_ = (h = v.next()).done); _ = !0) {
                                    var T = h.value;
        ...
        877475: (e, t, n) => {
            ...
            const P = new C(i.Z, {
                ...
                VOICE_CHANNEL_SELECT: function(e) {
                    var t = e.channelId;
                    return null == t && null != O ? b(l.Z.getChannel(O), null) : b(l.Z.getChannel(t), t)
                },
                VOICE_STATE_UPDATES: function(e) {
                    return e.voiceStates.reduce((function(e, t) {
                        var n = t.channelId,
                            r = t.sessionId;
                        return u.default.getSessionId() !== r ? e : b(l.Z.getChannel(n), n) || e
                    }), !1)
                }
            })
        },
        491260: (e, t, n) => {
            ...
            var j = function(e) {
                ...
                r.getActivities = function(e) {
                    ...
                    if (null == t) {
                        var n;
                        return null !== (n = R[e]) && void 0 !== n ? n : A
                    }
                    var r = C(e, t);
                ...
                _ = function() {
                    function e(t) {
                        ...
                        this.getTrackedFeedItem = function(e) {
                            null == a.trackedFeedItems[e] && (a.trackedFeedItems[e] = new f);

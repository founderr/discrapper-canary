    ...
    [79913], {
            ...
            const k = {
                ...
                disconnect: function() {
                    ...
                    if ((0, s.ur)()) this.selectVoiceChannel(null);
                        ...
                        u.xv(H.KJ3.CHANNEL_CALL_POPOUT);
                        if (n) {
        ...
        566706: (e, t, n) => {
            ...
            function J(e) {
                ...
                return null !== (t = k[e]) && void 0 !== t ? t : [r, T.dF.NONE]
            }

            function X(e) {
                return null != k[e] && D(k[e], 1)[0] !== T.dF.NONE
            }
        ...
        177570: (e, t, n) => {
            ...
            function Y(e) {
                ...
                return !!k(e.streamType, e.channelId) || null != t && (0, a.p9)(t, g.Z, d.Z, E.Z, o.Z)[0]
            }
            var F = function(e) {
                ! function(e, t) {
                    if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
        ...
        179913: (e, t, n) => {
            ...
            function we(e, t) {
                ...
                return null != n && (!z.Z.isBlocked(e.author.id) && (!!(0, T.ZP)({
                    message: e,
                    userId: t.id,
            ...
            function Ve(e) {
                ...
                if (!0 !== (null == t ? void 0 : t.isForumLikeChannel())) {
                    var r = Re[e.channelId],
                        ...
                        o = null != ve && ve.isInstanceFocused() && ve.isPinned(ee.Odu.TEXT);
                    if (!i && !o) return !1
                }
                ...
                if (!a && (u === ee.AEg.NO_CHAT || u === ee.AEg.FULL_SCREEN)) return !1;
            ...
            var Be = function() {
                ...
                t.rebuildChannelState = function(e) {
                    ...
                    if (this.hasUnread()) {
                        var o, u = X.default.getCurrentUser(),
                ...
                t.canHaveMentions = function() {
                    return 0 !== this.mentionCount && (!(this._isThread && !this._isJoinedThread) && (!(0, O.h3)(this.channelId, [N.Z, y.Z]) && (!((0, m.r1)(this._guildId) && this._lastMessageTimestamp < Ue) && this.canTrackUnreads())))
                };
                t.getGuildChannelUnreadState = function(e, t, n, r, i, o) {
                    ...
                    var u = (0, v.LS)({
                        ...
                        a = !1;
                    a = u === re.N.NULL || u === re.N.MENTIONS_AND_HIGHLIGHTS ? this.mentionCount > 0 || (0, h.Do)(this.channelId, this._ackMessageId) : this.getAckTimestamp() < this._lastMessageTimestamp;
                    return {
                        mentionCount: this.mentionCount,
                        hasNotableUnread: a
                    }
                ...
                t._ack = function(e, t) {
                    ...
                    if (null != r) {
                        ...
                        Fe((function() {
                            ...
                            if (null != r) {
                                Ce === o && i === k.default.getId() && (Ce = r.body.token);
                                if (t) {
                                    var u = F.Z.getChannel(n.channelId);
            ...
            function Ke(e) {
                ...
                ! function(e) {
                    var t = 24;
                    Be.get(e.id, ie.W.GUILD_HOME).lastMessageId = H.Z.fromTimestamp(u()(Date.now()).subtract(t, "h").valueOf())
                }(e);
                ! function(e) {
            ...
            function ze(e, t) {
                var n, r, i, o = F.Z.getChannel(t),
                    u = x.Z.getGuild(null != e ? e : null == o ? void 0 : o.guild_id),
                    a = (null == o ? void 0 : o.isForumPost()) ? 0 : Qe(u),
            ...
            function ut() {
                var e = Y.ZP.getCurrentSidebarChannelId(ye),
                    t = !1;
                if (Te !== e) {
                    t = st(Te);
                    Te = e
            ...
            var Et = function(e) {
                ...
                var r = n.prototype;
                r.initialize = function() {
                    this.waitFor(j.Z, X.default, x.Z, B.Z, F.Z, Q.Z, K.Z, q.Z, E.Z, M.Z, R.Z, Y.ZP, g.ZP, V.Z, _.Z, J.Z, $.Z, C.Z, N.Z, U.Z, y.Z);
                    this.syncWith([Y.ZP], ut)
                };
                ...
                r.getGuildChannelUnreadState = function(e, t, n, r, i, o) {
                    return Be.getValue(e.id, ie.W.CHANNEL, (function(u) {
            ...
            var _t = new Et(d.Z, {
                CONNECTION_OPEN: function(e) {
                    ...
                    o.entries.forEach((function(e) {
                        ...
                        var o = F.Z.getBasicChannel(e.id);
                        null == o || !(0,
                            D.Q5)(o.type) || null != e.last_message_id && 0 !== e.last_message_id ? i.ackMessageId = e.last_message_id : i.ackMessageId = H.Z.fromTimestamp(ze(o.guild_id, o.id));
                    ...
                    var u = null === (t = X.default.getCurrentUser()) || void 0 === t ? void 0 : t.id;
                    if (null != u) {
                        Be.get(u, ie.W.NOTIFICATION_CENTER).lastMessageId = H.Z.fromTimestamp(Date.now())
                    }
                    qe(r);
                    xe(i);
                    var a = !0,
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    Ce = null;
                    ye = n;
                    Te = Y.ZP.getCurrentSidebarChannelId(ye);
                    Be.clearAll();
                    t.forEach((function(e) {
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    var o, u, a = X.default.getCurrentUser(),
                    ...
                    if (!0 === (null == l ? void 0 : l.isReady())) {
                        ...
                        o = Q.Z.getChannelId();
                        u = Y.ZP.getCurrentSidebarChannelId(o)
                    }
                    var d = o === t || u === t;
                    ...
                    i.unreadCount++;
                    if (!(null != n.author && z.Z.isBlocked(n.author.id) || n.type === ee.uaV.RECIPIENT_REMOVE && (null == s ? void 0 : s.type) === ee.d4z.GROUP_DM) && (null != a && (0, T.Hl)({
                            rawMessage: n,
                            userId: a.id,
                ...
                CHANNEL_SELECT: function(e) {
                    ...
                    if (ye !== t) {
                        u = st(ye) || u;
                        u = st(Te) || u
                    }(ye === t || null != (null == r ? void 0 : r.type) && ee.TPd.GUILD_THREADS_ONLY.has(r.type)) && (u = Xe(t) || u);
                    ye === t && (u = Xe(n) || u);
                    ye = t;
                    Te = n;
                    return u
                ...
                NOTIFICATION_CENTER_ITEM_CREATE: function(e) {
                    ...
                    i.lastMessageId = n.id;
                    var o = (0, S.bY)();
                    !o && C.Z.active || o && C.Z.tabFocused ? ft(r, ie.W.NOTIFICATION_CENTER, n.id, !1) : i.mentionCount++
                },
                RELATIONSHIP_ADD: function(e) {
                    var t = X.default.getCurrentUser();
                    if (!(0, A.$N)()) return !1;
                    ...
                    if (o < i) {
                        ...
                        !u && C.Z.active || u && C.Z.tabFocused ? ft(t.id, ie.W.NOTIFICATION_CENTER, void 0, !1) : r ? n.mentionCount-- : n.mentionCount++
                    }
                },
                RELATIONSHIP_REMOVE: function(e) {
                    var t = X.default.getCurrentUser();
                ...
                USER_NON_CHANNEL_ACK: function(e) {
                    var t, n = e.ackType,
                        r = e.ackedId,
                        i = e.local,
                        o = null === (t = X.default.getCurrentUser()) || void 0 === t ? void 0 : t.id;
                    return null != o && ft(o, n, r, i)
                },
                PASSIVE_UPDATE_V1: function(e) {
                    var t, n = !1,
                        r = !0,

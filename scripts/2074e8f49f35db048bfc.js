            ...
            var a = n("37983"),
                ...
                S = e => {
                    let {
                        ...
                        guildId: S,
                        onShow: I
                    } = e, M = s.useRef(!1), R = s.useRef(0), v = (0, u.useStateFromStores)([g.default], () => g.default.getGuild(null != S ? S : i.guild_id)), {
                        hasMoreAfter: y,
                        scrollDown: A,
                    ...
                    }, [k, C, T]), L = s.useMemo(() => (0, o.canUseContextMenuCommands)(i, N.length, d.getCommandTypeCount(i, t, null == v ? void 0 : v.applicationCommandCounts)), [i, t, N.length, null == v ? void 0 : v.applicationCommandCounts]);
                    s.useEffect(() => {
                    ...
                    let O = s.useCallback(e => {
                            y && e + 500 > 34 * N.length - 40 && A(), R.current = e
                        }, [y, A, N]),
                        x = s.useCallback(e => {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["61946"], {
        960391: function(e, t, s) {
            ...
            let b = [a.PAYMENT_TYPE, a.CARD_INFO, a.ADDRESS],
                j = [a.PAYMENT_TYPE, a.SOFORT_INFO, a.ADDRESS],
                v = [a.PAYMENT_TYPE, a.PAYPAL, a.ADDRESS],
                L = [a.PAYMENT_TYPE, a.PAYMENT_REQUEST_INFO],
                w = [a.PAYMENT_TYPE, a.ADDRESS],
                U = [a.PAYMENT_TYPE, a.PRZELEWY24_INFO, a.ADDRESS],
                G = [a.PAYMENT_TYPE, a.ADDRESS];

            function W(e) {
                return e.hasCardError() ? a.CARD_INFO : e.hasAddressError() ? a.ADDRESS : null
            }
                    ...
                    super(...e), this.state = {
                        ...
                        [a.CARD_INFO]: {
                            renderBody: () => {
                                let {
                                    error: e
                                } = this.props, t = null != e && (null == e.code || W(e) === a.CARD_INFO);
                        ...
                        if (null != e) {
                            e === a.PAYMENT_TYPE && (0, P.clearError)();
                            this.setState({
                                step: e
                            })
                        }

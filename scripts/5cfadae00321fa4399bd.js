            ...
            (u = class extends a.Component {
                renderProvider(t) {
                    ...
                    let {
                        ...
                        objectType: l,
                        children: i
                    } = this.props, c = this.mergeLocation(t.location, this.getLocation(r, u, a, l)), d = this.getContext(c, null !== (e = this._loadDate) && void 0 !== e ? e : t.loadDate, null !== (n = this._loadId) && void 0 !== n ? n : t.loadId);
                    return (0, o.jsx)(s.AnalyticsContext.Provider, {
                        value: d,
                        children: i
                    })
                }
                render() {
                    ...
                    return null != t ? this.renderProvider(t) : (0, o.jsx)(s.AnalyticsContext.Consumer, {
                        children: t => this.renderProvider(t)
                    })
                }
                constructor(t) {
                    super(t), this._loadId = null, this._loadDate = this.props.root ? Date.now() : null, this.getLocation = (0, i.cachedFunction)((t, e, n, u) => {
                        let r = {};
                        return null != t && (r.page = t), null != e && (r.section = e), null != n && (r.object = n), null != u && (r.objectType = u), r
                    }), this.mergeLocation = (0, i.cachedFunction)((t, e) => ({
                        ...t,
                        ...e
                    })), this.getContext = (0, i.cachedFunction)((t, e, n) => ({
                        location: t,
                        loadDate: e,
                        loadId: n
                    })), null != t.loadId ? this._loadId = t.loadId : t.root && (this._loadId = (0, l.v4)())
                }
            }).Pages = c.AnalyticsPages, u.Sections = c.AnalyticsSections, u.Objects = c.AnalyticsObjects, u.ObjectTypes = c.AnalyticsObjectTypes, u.defaultProps = {
                root: !1
            }, r = u
        },

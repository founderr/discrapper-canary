...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [25968, 19861, 14929, 96043, 71402, 1459], {
        737264: e => {
            ...
            const d = {
                createChannel: function(e) {
                    ...
                    return u.Z.post({
                        ...
                        l.Z.isOptInEnabled(t) && s.Z.updateChannelOverrideSettings(t, e.body.id, {
            ...
            function E(e) {
                e.isCategory() ? function(e) {
                    ...
                    if (null != r && null != r.guild_id) {
                        var o = u.Z.getCategories(r.guild_id);
                        if (null != o[e]) {
        ...
        315804: (e, t, n) => {
                ...
                return (T = h((function(e, t) {
                    ...
                    return v(this, (function(i) {
                        switch (i.label) {
                            ...
                            case 1:
                                i.trys.push([1, 3, , 4]);
                                n = c.Z.inTestModeForApplication(e) || u.Z.inDevModeForApplication(e);
                            ...
                            case 3:
                                ...
                                throw new l.Z("Failed to fetch SKU ".concat(t));
                            case 4:
                                return [2]
                        }
                    }))
                    ...
                    return v(this, (function(a) {
                        switch (a.label) {
                            case 0:
                                ...
                                if (!(c.Z.inTestModeForApplication(e) || u.Z.inDevModeForApplication(e)) && t) throw new Error("this should only be used in test mode");
                    ...
                    return v(this, (function(a) {
                        switch (a.label) {
                            case 0:
                                ...
                                (c.Z.inTestModeForApplication(e) || u.Z.inDevModeForApplication(e)) && (r.test_mode = !0);
                                return [4, (0, E.Kb)({
            ...
            function L() {
                return (L = h((function(e, t, n) {
                    var l, s, E, S, h, g, b, T, R, A, m, P, N, C, D, L, w, j;
                    return v(this, (function(v) {
                        switch (v.label) {
                            case 0:
                                l = y({}, M, n), s = l.paymentSource, E = l.expectedAmount, S = l.expectedCurrency, h = l.analyticsLoadId, g = l.isGift, b = l.giftStyle, T = l.subscriptionPlanId, R = l.loadId, A = l.recipientId, m = l.customMessage;
                                o.Z.wait((function() {
                                    o.Z.dispatch({
                                        type: "SKU_PURCHASE_START",
                                        applicationId: e,
                                ...
                                P = c.Z.inTestModeForApplication(e) || u.Z.inDevModeForApplication(e);
                                v.label = 1;
                            case 1:
                                v.trys.push([1, 9, , 10]);
                                C = {
                            ...
                            case 8:
                                ...
                                o.Z.dispatch({
                                    type: "SKU_PURCHASE_SUCCESS",
                                    skuId: t,
                                    libraryApplications: null != L.body.library_applications ? L.body.library_applications.filter(d.lm) : [],
                            ...
                            case 9:
                                w = v.sent();
                                (j = w instanceof i.HF ? w : new i.HF(w)).code !== a.SM.CONFIRMATION_REQUIRED && j.code !== a.SM.AUTHENTICATION_REQUIRED || o.Z.dispatch({
                                ...
                                if (!w.body.payment_id) throw (0, O.SQ)("payment id cannot be null on redirected confirmations.");
                                return [2, (0, O.sk)(w.body, s)];
                            case 10:
                                return [2]
                        }
                    }))
        ...
        650332: (e, t, n) => {
            ...
            var A = function(e) {
                    ...
                    return (0, r.jsx)(l.Clickable, {
                        className: a()(u, O().iconLayout, _, (0, f.Q)(d), S({}, O().clear, o)),
                        onClick: function(e) {
                            e.stopPropagation();
                            null != i && i(e)
                        },
                ...
                m = function(e) {
                    ...
                    i.handleKeyDownList = function(e) {
                        ...
                        if (null != c) switch (e.keyCode) {
                            case d.yXg.BACKSPACE:
                                if ((null == l || 0 === l.length) && null != u && u.length > 0) {
                                    var f, p;
                                    e.preventDefault();
                                    e.stopPropagation();
                                    null === (p = (f = this.props).onRemoveTag) || void 0 === p || p.call(f, u.length - 1)
                                }
                                break;
                            case d.yXg.ARROW_DOWN:
                                e.preventDefault();
                        ...
                        if (null != I && I.length > 0)
                            if ("string" == typeof I[0]) {
                                I.forEach((function(t, n) {
                                    return C.push((0, r.jsxs)(l.Anchor, {
                                        focusProps: {
                                            offset: 4
                                        },
                                        className: O().tag,
                                ...
                                I.forEach((function(t, n) {
                                    return C.push((0, r.jsxs)(l.Anchor, {
                                        ...
                                        onClick: e.handleRemoveTag.bind(e, n),
                                        children: [(t.type === T.MEMBER || t.type === T.USER) && null != t.avatar && (0, r.jsx)(l.Avatar, {
                                            src: t.avatar,
                                            "aria-hidden": !0,
                            ...
                            children: (0, r.jsx)("div", {
                                ...
                                children: (0, r.jsxs)(l.ScrollerThin, {
                                    className: O().inner,
                                    style: {
                                        maxHeight: y
                                    },
            ...
            var S = function(e) {
                ...
                n.prototype.render = function() {
                    var e, t = this.props,
                        ...
                        y = h.errorMessage,
                        I = h.retrySuccess,
                        v = o.Children.count(s) > 0 ? (0, r.jsx)(l.Card, {
            ...
            function M(e) {
                ...
                if (null != r) {
                    var o = function(e) {
                        ...
                        return null != t && i.Z.has(t.deny, b.Plq.VIEW_CHANNEL)
                    };
                    n = a.Ec.has(e.type) && null != e.parent_id ? o(u.Z.getChannel(e.parent_id)) : o(e)
                }
                return {
                    channel_id: e.id,
                    channel_type: e.type,
            ...
            function w(e) {
                ...
                if (!y.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== b.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = u.Z.getChannel(i),
                        l = L(a, o),
                        s = A({}, t, P(l), null != o && null != i && (0, T.AB)(i) ? N(0, i) : M(a));
                    y.default.track(e, s, {
                        flush: n
                    })
                }
                        ...
                        description: function() {
                            switch (a) {
                                ...
                                case O.d4z.GUILD_FORUM:
                                    return (null == o ? void 0 : o.createPostsDisabled) && !e.isMediaChannel() ? s.getForumChannelPermissionText() : l.Z.Messages.ROLE_PERMISSIONS_SEND_MESSAGES_WITH_FORUMS_DESCRIPTION_TEXT;
        ...
        276190: (e, t, n) => {
            ...
            function x(e) {
                ...
                S ? t = [] : p ? t = I.Wx(n, a, l, O) : 0 === (t = I.ik(n, a, l, O)).length && ("" !== A.trim() || I.RD(n) || (t = I.aq()));
                var N = I.iI(P, a, n, l, O),
                    C = {
                ...
                return (0, r.jsx)(k, {
                    ...
                    onQueryChange: function(e) {
                        var t = e.trim(),
                            r = "@" === t.charAt(0);
                        g.Z.requestMembers(n.id, G(t, r), b.EQ);
                        m(e);
                        h(r)
                    },
                    onClickRow: function(e) {
                        ...
                        c((function(n) {
                            ...
                            if (t in r) delete r[t];
                                ...
                                var o;
                                e.rowType === b.aC.ROLE || e.rowType === b.aC.ADMINISTRATOR ? o = {
                                    type: u.Fj.ROLE,
                                    label: e.name,
                                    color: e.colorString
                                } : e.rowType !== b.aC.MEMBER && e.rowType !== b.aC.OWNER || (o = {
                                    type: u.Fj.MEMBER,
                                    label: e.name,
                                    avatar: e.avatarURL
                                });
            ...
            function H(e) {
                ...
                var P = u && 0 === Object.keys(I).length;
        ...
        270946: (e, t, n) => {
            ...
            function c(e) {
                ...
                return (0, r.jsx)(i.IG, u(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
        ...
        372518: (e, t, n) => {
            ...
            const h = {
                ...
                flushSeenItems: function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : u.cs.IMMEDIATE_WITH_COOLDOWN;
                    (0, l.rS)((0, s.UP)(e), t)
                },
            ...
            function V(e) {
                ...
                if (null != t) {
                    if (null == e ? void 0 : e.refreshThreadIds) {
                        w = Object.values(s.Z.getThreadsForParent(t.guild_id, t.id)).map((function(e) {
                            return e.id
                        }));
                        M = 0;
                        L = !0
                    ...
                    if (0 !== G.size) {
                        w = Array.from(new Set(v(w).concat(v(G))));
                        G.clear()
                    }
                    if ((null == e ? void 0 : e.refreshThreadIds) || (null == e ? void 0 : e.sortThreadIds)) {
                        U = o().chain(w).sort(k(i.z.LATEST_ACTIVITY));
                        j = o().chain(w).sort(k(i.z.CREATION_DATE))
                    }
                ...
                return (T = _((function(e) {
                    ...
                    return y(this, (function(_) {
                        switch (_.label) {
                            case 0:
                                n = a.default.getId();
                                o = (0, c.yE)(null !== (r = null === (t = l.ZP.getMember(e, n)) || void 0 === t ? void 0 : t.flags) && void 0 !== r ? r : 0, E.q.COMPLETED_ONBOARDING);
                                if (null == (i = u.Z.getGuild(e)) || !i.hasFeature(p.oNc.GUILD_ONBOARDING)) return [2, Promise.resolve()];
        ...
        404741: (e, t, n) => {
            ...
            function P(e) {
                var t, n, r, o, i, a, l, u, s, c = e.guildId,
                    f = e.updates,
                    d = null !== (i = null !== (o = f.onboardingPromptsSeen) && void 0 !== o ? o : null === (t = b[c]) || void 0 === t ? void 0 : t.onboardingPromptsSeen) && void 0 !== i ? i : {},
                    p = null !== (l = null !== (a = f.onboardingResponsesSeen) && void 0 !== a ? a : null === (n = b[c]) || void 0 === n ? void 0 : n.onboardingResponsesSeen) && void 0 !== l ? l : {},
                    E = m(null !== (s = null !== (u = f.prompts) && void 0 !== u ? u : null === (r = b[c]) || void 0 === r ? void 0 : r.prompts) && void 0 !== s ? s : [], d, p);
                b[c] = h(S({}, b[c], f), {
                    prompts: E
                })
            }
                ...
                L = function(e) {
                    ...
                    r.getOnboardingResponses = function(e) {
                        ...
                        if (l.Z.isFullServerPreview(e)) {
                            var r;
                            return Array.from(null !== (r = l.Z.getOnboardingResponses(e)) && void 0 !== r ? r : M)
                        }
                    ...
                    r.getEnabled = function(e) {
                        var t, n;
                        return l.Z.isFullServerPreview(e) ? null != b[e] : null !== (n = null === (t = b[e]) || void 0 === t ? void 0 : t.enabled) && void 0 !== n && n
                    };
            ...
            const w = new L(a.Z, {
                ...
                GUILD_ONBOARDING_SELECT_OPTION: function(e) {
                    ...
                    if (l.Z.isFullServerPreview(t)) return !0;
                    if (null == b[t]) return !1;
                    null != i && i.length > 0 && o().pullAll(b[t].responses, i);
                    r ? b[t].responses.push(n) : o().pull(b[t].responses, n);
                    null == T[t] && (T[t] = {});
                    T[t][n] = r;
        ...
        189651: (e, t, n) => {
            ...
            function b(e, t) {
                p.default.track(_.rMx.VIEW_AS_ROLES_SELECTED, I(y({
            ...
            function P(e, t) {
                ...
                if (null != n) {
                    ! function(e, t) {
                        var n = v(l.ZP.getSelectableChannelIds(e)).concat(v(l.ZP.getVocalChannelIds(e))),
                            r = Array.from(t);
                        l.ZP.addConditionalChangeListener((function() {
                            ...
                            var o = v(l.ZP.getSelectableChannelIds(e)).concat(v(l.ZP.getVocalChannelIds(e))).filter((function(e) {
                                return !n.includes(e)
                            }));
                            o.length > 0 && m(e, o, []);
                            return !1
        ...
        804808: (e, t, n) => {
            ...
            function E(e) {
                e.forEach((function(e) {
                    l.has(e.type) && null != e.content && (Array.isArray(e.content) ? E(e.content) : e.content = e.content.replace(/\n/g, " "))
                }));
                return e
            }
        },
        ...
        18882: (e, t, n) => {
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[e] && null != C[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var l in C[e][t]) t === w ? d.ZP.isNewForumThread(l, t, r) && L[e][t]++ : i.default.compare(l, o) > 0 && !d.ZP.hasOpenedThread(l) && L[e][t]++
                        }
                    }
                }
            }
            ...
            function J(e, t, n, r) {
                var i = t.guild_id,
                    a = t.parent_id,
                    l = t.id;
                if (null != i && null != a && null != l) {
                    i in e || (e[i] = {});
                    a in e[i] || (e[i][a] = {});
                    r && (e[i] = b(v({}, e[i]), y({}, a, v({}, e[i][a]))));
                    if (null === n) {
                        delete e[i][a][l];
        ...
        52317: (e, t, n) => {
            ...
            var v = function(e, t) {
                ...
                b = {},
                T = new l.Z("UserGuildSettingsManager"),
                R = 0;

            function A() {
                b = _({}, u.Z.getCollapsedCategories())
            }
                    ...
                    return v(this, (function(p) {
                        switch (p.label) {
                            ...
                            case 1:
                                ...
                                if ((f = l.shift()).guildId === c.I_8) return [3, 1];
                                p.label = 2;
                            case 2:
                                p.trys.push([2, 5, , 7]);
                                return [4, i.ZP.patch({
            ...
            const v = new I(o.Z, {
                        ...
                        for (var o, i = e.userGuildSettings.entries[Symbol.iterator](); !(t = (o = i.next()).done); t = !0) {
                            ...
                            if (null != a.channel_overrides) {
                                var l = !0,
                                    ...
                                    s = void 0;
                                try {
                                    for (var c, f = a.channel_overrides[Symbol.iterator](); !(l = (c = f.next()).done); l = !0) {
                                        var d = c.value;
                ...
                USER_GUILD_SETTINGS_FULL_UPDATE: function(e) {
                    ...
                    var l = !0,
                        ...
                        s = void 0;
                    try {
                        for (var c, f = t[Symbol.iterator](); !(l = (c = f.next()).done); l = !0) {
                            var d = c.value,
                                p = !0,
                                E = !1,
                                O = void 0;
                ...
                CATEGORY_COLLAPSE_ALL: function(e) {
                    var t = e.guildId;
                    u.ZP.getChannels(t)[s.d4z.GUILD_CATEGORY].forEach((function(e) {
                        var t = e.channel;
                        "null" !== t.id && (S[t.id] = !0)
                    }))
                },
        ...
        877475: (e, t, n) => {
            ...
            function b(e) {
                ...
                t[s.sH].forEach(r);
                t[s.Zb].forEach(r);
                (0, i.Z)(n._categories, n).forEach(v);
                g[e] = n;
                return n
            }
            ...
            var C = function(e) {
                ...
                var r = n.prototype;
                r.initialize = function() {
                    this.waitFor(s.ZP, c.Z, l.default, u.Z, a.Z);
                    this.syncWith([a.Z], N)
                };
            ...
            const M = new C(o.Z, {
                ...
                VOICE_CHANNEL_SELECT: function(e) {
                    var t = e.channelId;
                    return null == t && null != y ? P(u.Z.getChannel(y), null) : P(u.Z.getChannel(t), t)
                },
                VOICE_STATE_UPDATES: function(e) {
                    return e.voiceStates.reduce((function(e, t) {
                        var n = t.channelId,
                            r = t.sessionId;
                        return l.default.getSessionId() !== r ? e : P(u.Z.getChannel(n), n) || e
                    }), !1)
                }
            })
        },
        491260: (e, t, n) => {
            ...
            function w(e) {
                ...
                delete P[e];
                if (null != R[e]) {
                    var t = g(a().sortBy(R[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
            ...
            function U(e) {
                ...
                if (r === d.Skl.OFFLINE) l[t] = {
                    ...
                    var u = a.length > 1 ? y(a).sort(L) : a,
                        s = l[t];
                    a = null != s && o()(s.activities, u) ? s.activities : u;
                    l[t] = {
                        status: r,
                        clientStatus: i,
                        activities: a,
            ...
            function x(e) {
                var t = !0,
                    ...
                    r = void 0;
                try {
                    for (var o, i = Object.keys(R)[Symbol.iterator](); !(t = (o = i.next()).done); t = !0) {
                        G(e, o.value)
                    }
                } catch (e) {
                    n = !0;
            ...
            var k = function(e) {
                ...
                r.getAllApplicationActivities = function(e) {
                    var t = [],
                        ...
                        o = void 0;
                    try {
                        for (var i, a = Object.keys(m)[Symbol.iterator](); !(n = (i = a.next()).done); n = !0) {
                            var l = i.value,
                                u = m[l],
                                s = !0,
                                c = !1,
                                f = void 0;
                            try {
                                for (var d, p = u[Symbol.iterator](); !(s = (d = p.next()).done); s = !0) {
                                    var E = d.value;
        ...
        539273: (e, t, n) => {
            ...
            function g(e, t, n) {
                ...
                if (!(function(e, t) {
                        return t === _.SendMessage ? l.Z.can(u.Plq.MANAGE_CHANNELS, e) || l.Z.can(u.Plq.MANAGE_MESSAGES, e) : l.Z.can(u.Plq.MANAGE_THREADS, e)
                    }(e, t) || n <= 0)) {
                    var r = n + Date.now();
                    h[t][e.id] = {
                    ...
                    [_.SendMessage, _.CreateThread].forEach((function(e) {
                        ...
                        try {
                            for (var i, a = t[Symbol.iterator](); !(n = (i = a.next()).done); n = !0) {
                                var l = i.value,
                                    u = h[e][l.id],
                                    s = l.rateLimitPerUser;
                                if (null != u && u.rateLimitPerUser !== s) {
                                    var c;
                                    g(l, e, Math.min(null !== (c = null == u ? void 0 : u.cooldownMs) && void 0 !== c ? c : 0, 1e3 * s))
                                }
                            }
                        } catch (e) {
                            r = !0;
        ...
        223219: (e, t, n) => {
            ...
            function w(e) {
                var t, n, r, o, i, a, s = l.default.getCurrentUser();
                if (null == s) return j();
                ...
                L = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }
            ...
            var Z = function(e) {
                ...
                r.hasChanges = function() {
                    return null != R && null != T && (!(!this.isOpen() && P !== u.cII.USER_SETTINGS) && !o().isEqual(R, T))
                };
                r.isOpen = function() {
                    return A
                };
        ...
        609853: (e, t, n) => {
            ...
            var O = function(e) {
                ...
                _ && (T = (0, r.jsx)(a.u, {
                    ...
                    position: "top",
                    children: function(e) {
                        return (0, r.jsx)(l.Z, E(p({}, e), {
                            className: f().botTagVerified
                        }))
                    }
                }));
                I = c === u.H.AI ? f().botTagAI : n ? f().botTagInvert : f().botTagRegular;
                var R = function(e) {
                    var t;
                    return (0, r.jsxs)("span", E(p({}, e), {
                        className: i()(O, I, h ? f().rem : f().px, (t = {}, d(t, f().botTagOP, v), d(t, f().botTagRemix, b), t)),
        ...
        436622: (e, t, n) => {
            ...
            function u(e) {
                var t = e.width,
                    ...
                    d = e.className,
                    p = e.foreground,
                    E = l(e, ["width", "height", "color", "className", "foreground"]);
        ...
        127661: (e, t, n) => {
            ...
            function u(e) {
                var t = e.width,
                    ...
                    d = e.foreground,
                    p = e.backgroundColor,
                    E = l(e, ["width", "height", "color", "foreground", "backgroundColor"]);
            ...
            var S = function(e) {
                ...
                h = function(e) {
                    var t = e.text,
                        n = e.className,
                        o = e.color,
                        l = void 0 === o ? a.Z.STATUS_DANGER : o,
                        s = e.shape,
            ...
            var d = function() {
                    ...
                    t.computeSeenTimeDestructive = function(e) {
                        var t = 0,
                            ...
                            a = void 0;
                        try {
                            for (var l, u = this.seenIntervals[Symbol.iterator](); !(r = (l = u.next()).done); r = !0) {
                                var s = l.value;
                ...
                p = function() {
                    function e(t) {
                        ...
                        this.handleFeedItemSeen = function(e) {
                            ...
                            if (r === a._id)
                                if (a._paused) a._pausedFeedItemIds.add(i);
                                    ...
                                    var l = a.getTrackedFeedItem(i).maybeMarkSeen(o);
                                    null === (n = (t = a).onFeedItemSeen) || void 0 === n || n.call(t, i, l)
                                }
                        };
                        this.handleFeedItemUnseen = function(e) {
                            ...
                            if (r === a._id) {
                                ...
                                var l = a.getTrackedFeedItem(i).maybeMarkUnseen(o);
                                null === (n = (t = a).onFeedItemUnseen) || void 0 === n || n.call(t, i, l);
                    ...
                    e.prototype.maybeFlushSeenItems = function(e) {
                        ...
                        this._lastFlushTimeMillis = Date.now();
                        return e === c.IMMEDIATE || e === c.IMMEDIATE_WITH_COOLDOWN ? new Promise((t = l((function(e) {
        ...
        488110: (e, t, n) => {
            ...
            function _(e, t) {
                var n, o, a = null != t ? t : {},
                    u = a.checkEnabled,
                    c = void 0 === u ? null !== (o = null === (n = r.default.getCurrentUser()) || void 0 === n ? void 0 : n.mfaEnabled) && void 0 !== o && o : u,
                    f = s(a, ["checkEnabled"]);
                    ...
                    function e(t) {
                        ...
                        this.languageDetector = new p(o, (function(e) {
                            ...
                            if (-1 !== t.indexOf(r)) n.setLocale(r);
                                ...
                                var i, l = null !== (i = a[e]) && void 0 !== i ? i : E[o];

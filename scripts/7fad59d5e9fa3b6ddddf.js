...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [72722, 71402], {
            ...
            var y = function(e) {
                ...
                o.renderProvider = function(e) {
                    var t, n, o = this.props,
                        ...
                        p = this.getContext(f, null !== (t = this._loadDate) && void 0 !== t ? t : e.loadDate, null !== (n = this._loadId) && void 0 !== n ? n : e.loadId);
            ...
            function d(e) {
                return i.useCallback((function(t) {
                    ! function(e) {
                        ...
                        p(s.rMx.MOD_DASH_SEARCH_MEMBERS, t)
                    }(e)
                }), [e])
            }
            ...
            function g(e) {
                return i.useCallback((function(t) {
                    ! function(e, t) {
                        ...
                        p(s.rMx.MOD_DASH_FILTER_ROLES, n)
                    }(e, t)
                }), [e])
            }! function(e) {
            ...
            function h(e) {
                return i.useCallback((function(t) {
                    ! function(e, t) {
                        ...
                        p(s.rMx.MOD_DASH_FILTER_SAFETY_FLAGS, n)
                    }(e, t)
                }), [e])
            }! function(e) {
                e.BAN = "ban";
        ...
        189651: (e, t, n) => {
            ...
            function w(e, t) {
                d.default.track(y.rMx.VIEW_AS_ROLES_SELECTED, _(O({
            ...
            function A(e) {
                var t = f.Z.getChannelId(e),
                    n = u.Z.getChannel(t);
                if (!(null != t && (0, b.AB)(t)) && !s.Z.can(y.Plq.VIEW_CHANNEL, n)) {
            ...
            function S(e, t, n) {
                var r = new Set(p.Z.getOptedInChannels(e));
        ...
        632499: (e, t, n) => {
            ...
            var r = n(785893),
                ...
                f = n(2590),
                p = n(473708);
            const d = (0, a.Z)((0, u.Z)((function(e) {
                var t, n = e.user,
                    u = e.guildId,
                    a = e.onSelect,
                    f = e.analyticsLocations,
                    d = e.onCloseContextMenu,
                    g = (0, c.Z)(l.Z.CONTEXT_MENU).analyticsLocations,
                    h = null !== (t = null == f ? void 0 : f[0]) && void 0 !== t ? t : g[0],
                    y = (0, s.Z)(n.id, u, !0, h);
                return (0,
                    r.jsx)(o.Menu, {
        ...
        973424: (e, t, n) => {
            ...
            function v(e, t) {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: ["dot" === t ? (0, r.jsx)(u.RoleDot, {
                        className: b().roleDot,
                        color: null !== (n = e.colorString) && void 0 !== n ? n : (0, o.Rf)(g.p6O),
                        background: !1,
                        tooltip: !1
                    }) : (0, r.jsx)(u.RoleCircle, {
                        className: b().roleDot,
                        color: null !== (i = e.colorString) && void 0 !== i ? i : (0, o.Rf)(g.p6O)
                    }), (0, r.jsx)("div", {
                        children: e.name
                    })]
                })
            ...
            function m(e, t) {
                var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                    ...
                    y = function(n) {
                        if (E.includes(n.id)) {
                            c.Z.updateMemberRoles(t, e, E.filter((function(e) {
                                return e !== n.id
                            })), [], [n.id]);
                            O(l.jQ.REMOVE_ROLE)
                        } else {
                            c.Z.updateMemberRoles(t, e, E.concat([n.id]), [n.id], []);
                            O(l.jQ.ADD_ROLE)
                        }
                    },
                    ...
                    _ = (0, i.cj)([s.ZP, p.Z], (function() {
                        var n = s.ZP.getMember(t, e);
                        return {
                            userRoles: null != n ? n.roles : [],
                            isGuildMember: null != n,
                            canManageRoles: null != b && p.Z.can(g.Plq.MANAGE_ROLES, b)
                        }
                    }), [e, t, b]),
                    E = _.userRoles,
                    w = _.isGuildMember,
                ...
                if (!w) return null;
                var j = p.Z.getHighestRole(b),
                    A = Object.values(b.roles).filter((function(e) {
                        return e.id !== b.id
                    })),
                    S = P ? A.map((function(e) {
                        var t = e.managed || !p.Z.isRoleHigher(b, j, e),
                            n = -1 !== E.indexOf(e.id);
                        ...
                        return -1 !== E.indexOf(e.id)
                    })).map((function(e) {
                        return e.id === b.id ? null : (0, r.jsx)(u.MenuItem, {
                            id: e.id,
                            label: function() {
                                return v(e, m)
                            }
                ...
                return 0 === S.filter(d.lm).length ? null : n ? S : (0, r.jsx)(u.MenuItem, {
                    id: "roles",
                    label: h.Z.Messages.ROLES_LIST.format({
                        numRoles: S.length
                    }),
                    children: S
                })
                    ...
                    function e(t) {
                        ...
                        this.languageDetector = new d(o, (function(e) {
                            ...
                            if (-1 !== t.indexOf(r)) n.setLocale(r);
                                ...
                                var i, a = null !== (i = u[e]) && void 0 !== i ? i : g[o];

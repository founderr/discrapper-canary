        ...
        374705: function(e, t, n) {
            ...
            function j(e) {
                let {
                    ...
                    onSelect: a,
                    hideSettings: d
                } = e, o = t.id, j = g.default.getDefaultChannel(o), R = (0, E.useExpressionSourceGuildDataForGuildLeaveModal)(t), b = (0, r.useStateFromStores)([_.default], () => {
                    ...
                    channel: j
                }), U = (0, L.default)(o), y = (0, v.default)(t), D = (0, x.default)(t), H = (0, N.default)(t), w = (0, M.default)({
                    guildId: t.id,
                ...
                }), P = (0, I.default)(t), F = (0, f.default)(t.id), k = (0, c.default)({
                    id: t.id,
                    label: O.default.Messages.COPY_ID_GUILD
                }), V = (0, A.default)(t, {
                    section: C.AnalyticsSections.GUILD_LIST
                }), B = (0, h.default)(t.id), Z = (0, m.default)(t), z = t.hasFeature(C.GuildFeatures.HUB);
                ...
                return z ? (0, s.jsxs)(i.Menu, {
                    ...
                    "aria-label": O.default.Messages.GUILD_ACTIONS_MENU_LABEL,
                    onSelect: a,
                    children: [(0, s.jsxs)(i.MenuGroup, {
                        children: [G, (0, s.jsx)(i.MenuItem, {
                            id: "privacy",
                            label: O.default.Messages.HUB_PRIVACY_SETTINGS,
                        ...
                        children: (0, s.jsx)(i.MenuItem, {
                            id: "leave-guild",
                            label: O.default.Messages.LEAVE_HUB,
                            action: Y,
                            color: "danger"
                        })
                    }), (0, s.jsx)(i.MenuGroup, {
                    ...
                    children: [(0, s.jsx)(i.MenuGroup, {
                        ...
                        children: [y, __OVERLAY__ ? null : D, U, B]
                    }), (0, s.jsxs)(i.MenuGroup, {
                        children: [d ? null : H, __OVERLAY__ ? null : (0, s.jsx)(i.MenuItem, {
                            id: "privacy",
                            label: O.default.Messages.PRIVACY_SETTINGS,
                            action: () => (0, i.openModalLazy)(async () => {
                                let {
                                    default: e
                                } = await n.el("349406").then(n.bind(n, "349406"));
                        ...
                        children: [Z, !b && (0, s.jsx)(i.MenuItem, {
                            id: "leave-guild",
                            label: O.default.Messages.LEAVE_SERVER,
                            action: Y,
                            color: "danger"
                        })]
                    }), (0, s.jsx)(i.MenuGroup, {
        ...
        527660: function(e, t, n) {
            ...
            function _(e) {
                ...
                let S = function(e) {
                        ...
                        }), [e.id]), m = M === E.HighlightSettings.DISABLED, A = (0, u.default)(e.id), v = (0, o.useGuildUnreadsExperiment)();
                    ...
                    M = (0, a.useStateFromStores)([c.default], () => c.default.getMessageNotifications(e.id), [e.id]),
                    I = null === (_ = g()) || void 0 === _ ? void 0 : null === (t = _.find(e => {
                        let {
                            setting: t
                        } = e;
                        return t === M
            ...
            class m extends a.PureComponent {
                renderUsers() {
                    ...
                    for (; d < i && d < e.length;) {
                        ...
                        r.push(t ? (0, s.jsx)("div", {
                            ...
                            children: i
                        }, M(null !== (o = e[d]) && void 0 !== o ? o : null, d)) : (0, s.jsx)(g.default, {
                ...
                render() {
                    let {
                        ...
                        popoutUserId: f
                    } = this.state, h = n.find(e => null != e && e.id === f), p = i && null == E.default.getUser(f);

    ...
    ["74941"], {
        ...
        833843: function(e, t, n) {
            ...
            var O = e => {
                let {
                    ...
                    onClose: C
                } = e, [g, N] = l.useState(p), U = (0, r.useStateFromStores)([h.default], () => h.default.getGuildScheduledEvent(t), [t]), O = null == U ? void 0 : U.id, b = null == U ? void 0 : U.guild_id, {
                    guild: w,
                    isMember: M
                } = (0, _.default)(b, O), D = (0, a.default)(n), j = null == U ? void 0 : U.channel_id, V = (0, r.useStateFromStores)([u.default], () => u.default.getChannel(j), [j]), F = (0, d.useUID)(), [k, G] = l.useState(y.EventDetailSections.EVENT_INFO), H = (0, v.default)(O, g), B = (0, r.useStateFromStores)([h.default], () => h.default.getUserCount(O, g)), [Z, {
                    loading: W,
                    error: z
                }] = (0, f.default)(() => E.default.getGuildEventUsers(null == U ? void 0 : U.id, g, b));
                l.useEffect(() => {
                ...
                if (l.useLayoutEffect(() => {
                    ...
                    }, [Y, null == U ? void 0 : U.recurrence_rule]), null == U || null == w || !M && !D) return null;
                let X = e => {
        ...
        360538: function(e, t, n) {
            ...
            function O(e) {
                let {
                    ...
                    startTime: U,
                    endTime: O
                } = (0, T.default)(t.id, p), b = (0, a.useStateFromStores)([C.default], () => C.default.getUserCount(t.id, p)), w = l.useCallback(e => {
        ...
        403901: function(e, t, n) {
            ...
            function x(e) {
                ...
                let E = 0;
                return r.length >= S.MAX_RSVP_USER_DISPLAY_COUNT && f > S.MAX_RSVP_USER_DISPLAY_COUNT && (E = Math.max(f - r.length, 0)), 0 === r.length ? (0, i.jsx)(L, {
                    height: c,
                    children: (0, i.jsx)(N, {})
                }) : (0, i.jsx)(y, {
                    children: (0, i.jsx)(U, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                P = !0, null == p || p(), !g && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: _,
                            analyticsLocations: v,
                            analyticsObject: C,
                    ...
                    onCloseCallback: () => {
                        !P && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: U,
                            location_stack: v
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == h || h(P), P && (!g && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == _ || _())
                    },
        ...
        181114: function(e, t, n) {
            ...
            let v = e => {
                let {
                    ...
                    onlyShineOnHover: p,
                    ...v
                } = e, C = s.createRef(), S = (0, c.default)(C), T = !i && !l && !0 !== a && (!p || S);

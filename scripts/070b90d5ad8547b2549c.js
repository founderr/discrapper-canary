    ...
    [52555], {
            ...
            var H = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        ...
                        apiCodeVersion: M,
                        privateChannelsVersion: G,
                        guildIdsRequiringDeletedIdsSync: j,
                        lastSelectedGuildId: B,
                        hasConnected: Z
                    }
                };
        ...
        335072: (e, t, n) => {
            ...
            var j = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        DEFAULT_STORAGE_SENTINEL: N,
                        clips: D,
                        isSavingClip: P,
                        lastClipsWarningChannelId: w,
                        lastClipsSession: L,
                        clipsStatusByUser: U,
                        defaultClipsSettings: k,
                        state: M,
                        instance: B
                    }
                };
            ...
            j.displayName = "ClipsStore";
            j.persistKey = "ClipsStore";
        ...
        652555: (e, t, n) => {
            ...
            var K = function() {
                ...
                J = void 0 !== K ? K : q;
            P.s.isDiscordGatewayPlaintextSet() && (J = q);
            const Q = J;
            n(701456);
            var $ = n(473903),
                X = n(652591),
            ...
            function wn(e, t, n) {
                ...
                null != f && f.nick === a && f.avatar === o && i().isEqual(f.roles, r) && f.premiumSince === u && f.isPending === c && f.joinedAt === l && f.communicationDisabledUntil === d && f.flags === s || Pn({
            ...
            var Qn = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        logger: Hn,
                        MAX_GUILD_MEMBER_REQUEST_SIZE: 100,
                        lastTimeConnectedChanged: zn,
                        sessionId: Fn
                    }
                };
                return n
                ...
                ie = function(e) {
                    ...
                    r.__getLocalVars = function() {
                        return {
                            LoadState: R,
                            loaded: w,
                            stickerPacksByPackId: L,
                            stickersById: U,
                            stickerMetadata: k,
                            premiumStickerPacks: M,
                            lastFetchedPremiumStickerPacks: G,
                            isFetchingStickerPacks: j,
                            guildStickersByGuildId: B,
                            setGuildStickersByGuildId: Z,
                            FETCHED_STANDARD_STICKER_PACKS_TTL_MS: V,
                            loadSavedGuildStickers: x,
                            ingestSticker: H,
                            ingestStickerMetadata: z,
                            ingestStickerPack: F,
                            rebuildStickerMetadata: Y,
                            handleConnectionOpen: W,
                            handleBackgroundSync: K,
                            handleLogout: J,
                            handleStickerPacksFetchStart: Q,
                            handleStickerPacksFetchSuccess: $,
                            handleStickerPackFetchSuccess: X,
        ...
        227172: (e, t, n) => {
            ...
            var b = function(e, t) {
                ...
                T = "33kozedd0zs6fbauka98psnc7zwom2s",
                I = function(e) {
                    return "https://youtube.com/watch?v=".concat(e)
                },
                O = 3e5,
                C = "https://api.twitch.tv/helix",
                A = /live_user_(.*)-\{width\}/,
                R = null,
                N = 0,
                D = null,
            ...
            function L(e) {
                var t;
                return null === (t = A.exec(e)) || void 0 === t ? void 0 : t[1]
            }
            ...
            function M() {
                return (M = h((function(e, t) {
                    var n, r, i, a, o;
                    return b(this, (function(s) {
                        switch (s.label) {
                            case 0:
                                return null != (n = w[e]) ? [2, n] : [4, U("/games", {
                                    id: e
                                }, t)];
                            case 1:
                            ...
                            return b(this, (function(S) {
                                switch (S.label) {
                                    ...
                                    case 3:
                                        ...
                                        g = null !== (y = L(s)) && void 0 !== y ? y : e.name;
                                        return [2, {
                        ...
                        return h((function() {
                            ...
                            return b(this, (function(y) {
                                switch (y.label) {
                                    case 0:
                                        D = null;
                                        if (e.revoked || P.has(e.id)) return [2, null];
                                        y.label = 1;
                                    case 1:
                                        y.trys.push([1, 3, , 4]);
                                        return [4, o.ZP.get({
            ...
            var Z = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        ...
                        POLL_INTERVAL: 6e4,
                        YOUTUBE_VIDEO_URL: I,
                        YOUTUBE_POLL_INTERVAL: O,
                        TWITCH_API_ENDPOINT: C,
                        TWITCH_USERNAME_THUMBNAIL_REGEX: A,
                        stream: R,
                        youtubeNextCheck: N,
                        youtubeCachedResponse: D,
                        youtubeForbiddenLiveChannels: P,
                        twitchGameCache: w,
                        poller: j
                    }
                };
            ...
            Z.displayName = "ExternalStreamingStore";
            const V = new Z(s.Z, {
        ...
        436154: (e, t, n) => {
            ...
            function F() {
                ...
                if (t) {
                    ...
                    x = s.length > 0 ? j : null != a ? [a].concat(N(o()(V).filter((function(e) {
                        return e.type !== T.IIU.CUSTOM_STATUS
                    })).uniqBy((function(e) {
        ...
        69660: (e, t, n) => {
            ...
            var ye = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        sessionId: re,
                        selectedStreamKey: ie,
                        streamActionContexts: se,
                        streamApplications: ue,
                        streamApplicationPIDs: ce,
                        streamSourceIds: le,
                        streamLastLayout: de,
                        rtcConnections: fe,
                        statsHistory: _e,

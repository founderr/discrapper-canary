        ...
        649844: function(e, t, n) {
            ...
            function C(e) {
                let {
                    ...
                    giftRecipient: w,
                    returnRef: b
                } = null != e ? e : {}, P = !1, O = (0, l.v4)(), D = u.default.getCurrentUser(), M = (0, f.isPremiumExactly)(D, E.PremiumTypes.TIER_2);
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: C,
                            onClose: (e, t) => {
                                l(), null == p || p(e), e && (null == _ || _(), !m && null != t && t === E.PremiumSubscriptionSKUs.TIER_2 && !M && c.ComponentDispatch.dispatch(h.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                P = !0, null == v || v(), !m && (0, o.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: _,
                            analyticsLocations: g,
                            analyticsObject: S,
                    ...
                    onCloseCallback: () => {
                        !P && d.default.track(h.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: x,
                            location_stack: g
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == p || p(P), P && (null == _ || _())
                    },

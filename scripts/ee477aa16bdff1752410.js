    ...
    ["3502"], {
            ...
            async function E(e, t, n, _, E) {
                ...
                try {
                    let r = {
                        ...
                        o = {};
                    null != t && (o.country_code = t), null != n && (o.payment_source_id = n), null != _ && (o.include_unpublished = _), null != E && (o.revenue_surface = E), r.query = o, !a.default.ipCountryCodeLoaded && await (0, s.fetchIpCountryCode)();
                    ...
                    saveAccountChanges(e, t) {
                        ...
                        return (0, _.default)(e => {
                            ...
                            return s.default.track(E.AnalyticEvents.USER_AVATAR_UPDATED, {
                                ...
                                user: t,
                                newPassword: A
                            }), null != T && null != A && r.default.dispatch({
        ...
        75015: function(e, t, n) {
            ...
            let s = 568,
                ...
                m = s / R,
                h = s / p,
                L = o.BACKGROUND_REPLACEMENT_SIZE.width / o.BACKGROUND_REPLACEMENT_SIZE.height,
                f = s / L;
            ...
            var i = n("37983"),
                ...
                R = e => {
                    let {
                        ...
                        onCrop: S,
                        onClose: C,
                        uploadType: m = T.UploadTypes.AVATAR,
                    ...
                    l.useEffect(() => {
                        ...
                        K && h && E.default.track(I.AnalyticEvents.OPEN_MODAL, {
                            type: I.AnalyticsSections.CROP_GIF_MODAL,
                            location: {
                                page: L
                            }
                        })
                    ...
                    let j = () => {
                            switch (m) {
                                case T.UploadTypes.BANNER:
                                    return {
                                        height: T.USER_BANNER_MAX_HEIGHT, width: T.USER_BANNER_MAX_WIDTH
                                    };
                                case T.UploadTypes.VIDEO_BACKGROUND:
                                    return A.BACKGROUND_REPLACEMENT_SIZE;
                                case T.UploadTypes.AVATAR:
                                case T.UploadTypes.AVATAR_DECORATION:
                                    return {
                                        height: I.AVATAR_MAX_SIZE, width: I.AVATAR_MAX_SIZE
                                    };
                                case T.UploadTypes.GUILD_BANNER:
                                    return {
                                        height: T.GUILD_BANNER_MAX_HEIGHT, width: T.GUILD_BANNER_MAX_WIDTH
                                    };
                                case T.UploadTypes.SCHEDULED_EVENT_IMAGE:
                                    return {
                                        height: T.SCHEDULED_EVENT_IMAGE_MAX_HEIGHT, width: T.SCHEDULED_EVENT_IMAGE_MAX_WIDTH
                                    };
                                case T.UploadTypes.HOME_HEADER:
                                    return {
                                        height: T.HOME_HEADER_MAX_HEIGHT, width: T.HOME_HEADER_MAX_WIDTH
                                    }
                            }
                        },
                    ...
                    return l.useEffect(() => (window.addEventListener("mouseup", z), window.addEventListener("resize", X), () => {
                        ...
                        children: (0, i.jsxs)(a.ModalRoot, {
                            ...
                            children: [h && (0, i.jsx)(u.default, {
                                type: m,
                                analyticsPage: L,
                                analyticsSection: I.AnalyticsSections.CROP_GIF_MODAL,
                                isGIF: K,
                                banner: n
                                ...
                                children: [(0, i.jsxs)("div", {
                                    ...
                                    children: [(0, i.jsx)("img", {
                                        style: {
                                            ...
                                            ...(() => {
                                                ...
                                                let e = y.width / y.height,
                                                    t = q() && e > T.BANNER_ASPECT_RATIO ? f.height / y.height : 1;
                                                return {
                                                    width: y.width * G * t,
                                        ...
                                        className: m === T.UploadTypes.AVATAR ? O.overlayAvatar : O.overlayBanner,
                                        style: {
                                            opacity: null == y ? 0 : 1,
                                            width: f.width,
                                            height: f.height
                                    ...
                                    children: [(0, i.jsx)(_.default, {
                                        ...
                                        asValueChanges: e => {
                                            ...
                                            let {
                                                width: t,
                                                height: n
                                            } = y, i = (0, c.calculateDragBoundaries)(t * e, n * e, f), {
                                                x: l,
                                                y: a
                                            } = F.current;
        ...
        8731: function(e, t, n) {
            ...
            async function a(e, t, i, a, o) {
                let {
                    ...
                    scaledCropWidth: _,
                    scaledCropHeight: E
                } = r(t, i, a, o), c = await e.arrayBuffer(), d = new Worker(new URL(n.p + n.u("84300"), n.b)), T = new Promise((e, t) => {
                    d.onmessage = n => {
                        let {
                            data: i
                        } = n;
            ...
            function o(e, t, n, i) {
                ...
                E.width = u, E.height = _;
                let c = E.getContext("2d");
                return null != c && c.drawImage(e, l, a, o, s, 0, 0, E.width, E.height), E.toDataURL("image/png")
            }
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                D = !0, null == I || I(), !S && ((0, s.setIsPersistentHelperHidden)(!0), (0, s.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: A,
                            analyticsLocations: N,
                            analyticsObject: O,
                    ...
                    onCloseCallback: () => {
                        !D && u.default.track(E.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: M,
                            location_stack: N
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == T || T(D), D && (!S && _.ComponentDispatch.dispatch(E.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == A || A())
                    },
            ...
            var l = n("414456"),
                ...
                L = function(e) {
                    let {
                        ...
                        ...F
                    } = e, k = (0, a.useStateFromStores)([T.default], () => T.default.getCurrentUser()), W = (0, a.useStateFromStores)([A.default], () => A.default.isFocused()), K = (0, a.useStateFromStores)([I.default], () => I.default.getPremiumTypeSubscription()), {
                        ...
                        if (null == L || L(e), (null == K ? void 0 : K.status) === C.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                            (0, _.trackPremiumSettingsPaneOpened)(), s.default.open(C.UserSettingsSections.PREMIUM), null == v || v(!1);
                            return
                        }! function(e) {
                            let {
                                isClaimed: t,
                            ...
                            null != s ? A = C.AnalyticsObjectTypes.TRIAL : r && (A = C.AnalyticsObjectTypes.GIFT), (0, E.default)({
                                isGift: r,
                                initialPlanId: null,
                                subscriptionTier: a,
                                analyticsLocations: c,
                    ...
                    let X = m.default.Messages.APPLICATION_STORE_GET_PREMIUM,
                        ...
                        q = l === S.PremiumSubscriptionSKUs.TIER_2 && null != z && [S.PremiumTypes.TIER_0, S.PremiumTypes.TIER_1].includes(z);
                    q && (X = m.default.Messages.BILLING_SWITCH_PLAN_UPGRADE);
                    let J = null != K && K.status !== C.SubscriptionStatusTypes.ACCOUNT_HOLD && !(0, d.isNoneSubscription)(K.planId) && !q,
                        Q = J ? null != V ? V : function(e) {
                            let {
        ...
        26092: function(e, t, n) {
            ...
            function L(e) {
                ...
                if (null == _) return f();
                E = null !== (t = e.section) && void 0 !== t ? t : E, m = null !== (n = e.section) && void 0 !== n ? n : E, null != e.subsection && null != E && (c[E] = e.subsection), null != e.scrollPosition && null != E && (d[E] = e.scrollPosition), O = !!e.openWithoutBackstack, u = s.FormStates.OPEN, T = {}, A = {
                    ...I = {
                ...
                }, p = null !== (i = e.onClose) && void 0 !== i ? i : null, S = null !== (l = e.analyticsLocation) && void 0 !== l ? l : null, C = null !== (r = e.analyticsLocations) && void 0 !== r ? r : [], h = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }

            function f() {
                u = s.FormStates.CLOSED, N = !1, I = null, m = null, A = null, _ = null, E = null, c = {}, d = {}, p = null, S = null, C = [], h = null
            }
            ...
            class U extends r.default.Store {
                ...
                hasChanges() {
                    return null != A && null != I && (!!this.isOpen() || R === s.DrawerTabTypes.USER_SETTINGS) && !l.isEqual(A, I)
                }
                isOpen() {
                    return N
                }
            ...
            var g = new U(a.default, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(e) {
                    ...
                    u = s.FormStates.OPEN, E = s.UserSettingsSections.ACCOUNT, T = null !== (t = e.errors) && void 0 !== t ? t : {}
                },
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    var t;
                    _ = E, E = e.section, S = null, C = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [], null != e.subsection && (c[E] = e.subsection)
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return R = e.tab, null == E && R === s.DrawerTabTypes.USER_SETTINGS && L({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        181114: function(e, t, n) {
            ...
            let N = e => {
                let {
                    ...
                    onlyShineOnHover: N,
                    ...O
                } = e, R = a.createRef(), p = (0, E.default)(R), S = !i && !o && !0 !== u && (!N || p);
                return (0, r.jsxs)(_.Button, {
                    ...
                    children: [t, S ? (0, r.jsx)(A, {
                        shinePaused: T,
                        className: s(d.buttonShine, N ? d.onlyShineOnHover : void 0, I),
                        shineSize: c
                    }) : null]
                })
            };
        ...
        103603: function(e, t, n) {
            ...
            function I(e, t, n) {
                ...
                let o = l.getImageData(0, 0, r, a).data,
                    ...
                    _ = s(u, t);
                return "boolean" == typeof _ ? T : _.palette()
            }
            let A = e => N(e),

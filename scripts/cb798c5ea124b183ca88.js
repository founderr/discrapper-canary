    ...
    ["40751"], {
        ...
        952451: function(e, t, n) {
            ...
            function v(e) {
                ...
                if (0 === t) {
                    let t = e.isThread() ? f.default.isMuted(e.id) : N.default.isGuildOrCategoryOrChannelMuted(e.guild_id, e.id);
                    if (t) return !1
                }
                return !(!e.isPrivate() && (H(e, t, (0, r.isOptInEnabledForGuild)(e.guild_id)) || !c.default.can(e.accessPermissions, e))) && (t > 0 || N.default.isChannelRelevant(e))
            }
            ...
            function F(e, t) {
                let n = e.guild_id,
                    l = e.id;
                return !(N.default.isGuildOrCategoryOrChannelMuted(n, l) || H(e, C.default.getMentionCount(l), t)) && C.default.hasNotableUnread(e.id)
            }

            function b(e, t) {
                let n = C.default.hasUnread(e, t);
                if (t === h.ReadStateTypes.GUILD_EVENT) return !(N.default.isMuted(e) || N.default.isMuteScheduledEventsEnabled(e)) && n;
                return n
            }
                    ...
                    for (let t in _) {
                        ...
                        if (T || g) {
                            let e = function(e, t, n, l) {
                                ...
                                return !("flags" in e && e.hasFlag(U.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) && (t > 0 || !n || (0, S.isThread)(e.type) || N.default.resolvedMessageNotifications(e) === G.UserNotificationSettings.ALL_MESSAGES)
                            }(n, o, a, s);
            ...
            function q(e) {
                ...
                if (null != n.guild_id) {
                    let e = M(n.guild_id),
                        l = n.isThread() ? !f.default.hasJoined(n.id) || f.default.isMuted(n.id) : N.default.isGuildOrCategoryOrChannelMuted(n.guild_id, n.id);
            ...
            function eE(e) {
                ...
                let {
                    userGuildSettings: n
                } = e, l = new Set(n.map(e => null !== (t = e.guild_id) && void 0 !== t ? t : I));
            ...
            class eg extends A.default {
                ...
                constructor() {
                    ...
                    }), this.waitFor(g.default, T.default, C.default, c.default, _.default, L.default, N.default, o.default, f.default)
                }
            }

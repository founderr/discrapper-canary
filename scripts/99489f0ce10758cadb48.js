            ...
            function i(e) {
                let t = function(e) {
                    let {
                        ...
                        return a
                    }, T = m(C, _, (l >> 18 & 31) / 31), A = m(3, 3, 1.25 * ((s >> 3 & 63) / 63)), L = m(3, 3, 1.25 * ((s >> 9 & 63) / 63)), g = f && m(5, 5, p), v = n(e), R = u(v > 1 ? 32 : 32 * v), O = u(v > 1 ? 32 / v : 32), N = new Uint8Array(R * O * 4), M = [], y = [];
                        ...
                        for (let u = 0; u < R; u++, n += 4) {
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let r = e ? 0 : 1, n = 2 * y[e]; r < 5 - e; r++, t++) p += g[t] * M[r] * n;
                            let I = l - 2 / 3 * s,
                                S = (3 * l - I + E) / 2,
                                m = S - E;
        ...
        765221: function(e, t, r) {
            ...
            let v = () => 80,
                ...
                O = e => {
                    ...
                    }), p = (0, o.default)([E.default], () => E.default.isItemViewed(r)), v = m.default.canUseCollectibles(t), O = u === T.Section.PREMIUM_PURCHASE && !v, [N, M] = a.useState(l);
                    a.useEffect(() => {
                        l && M(!0)
                    }, [l]);
                    let y = a.useRef(null),

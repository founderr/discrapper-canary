    ...
    ["14368"], {
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: N
                } = (0, f.usePaymentContext)(), A = p.find(e => e.key === I);
                l.useEffect(() => {
                    C(null)
                }, [I, C]), o(null != A, "Unknown step for current payment flow.");
                let v = null !== (u = null == A ? void 0 : null === (t = A.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    T = null == A ? void 0 : null === (n = A.options) || void 0 === n ? void 0 : n.bodyClassName,
                    O = void 0 !== h && h ? E.sliderBodyLarge : null == A ? void 0 : null === (r = A.options) || void 0 === r ? void 0 : r.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == A ? void 0 : null === (a = A.options) || void 0 === a ? void 0 : a.renderHeader) || void 0 === d || d ? _ : null, A.renderStep(m), null == I || v ? null : (0, i.jsxs)(i.Fragment, {
        ...
        817963: function(e, t, n) {
            ...
            let f = {
                ...
                h = e => {
                    let [t, n] = e instanceof a.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : _(e), [l, s, d, h] = (0, r.useStateFromStoresArray)([o.default], () => [o.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e), o.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e), o.default.can(t, e), o.default.can(n, e)]), m = (0, r.useStateFromStores)([u.default], () => u.default.getCurrentUser()), I = i.useCallback(e => E(e, m, s, l), [l, s, m]), p = i.useCallback(e => E(e, m, h, d), [h, d, m]);
                    return null == e ? f : {
        ...
        460029: function(e, t, n) {
            ...
            var I = l.memo(function(e) {
                ...
                let {
                    ...
                    audio: g
                } = (0, c.useAudioTrimmerStore)(), [S, C] = l.useState(!1), [N, A] = l.useState(m), {
                    playheadPositionMs: v,
                    endPositionMs: T,
                    startPositionMs: O
                } = N, L = null != g, R = T - O, M = R > 1e3 * _.MAX_SOUND_LENGTH_SECONDS;
                l.useEffect(() => {
                    null != g && A({
                        playheadPositionMs: 0,
                ...
                let D = l.useCallback(e => {
                        null != g && (g.pause(), null != e && (g.currentTime = e), C(!1))
                    }, [g]),
                    b = l.useCallback(() => {
                        if (null != g) {
                            if (S) {
                            ...
                            v >= T ? g.currentTime = (0, E.toSeconds)(O) : g.currentTime = (0, E.toSeconds)(v), g.volume = (0, d.default)(r), g.play(), C(!0)
                        }
                    }, [g, T, D, v, S, O, r]),
                    U = l.useCallback(e => {
                        A(e), null == p || p({
        ...
        278175: function(e, t, n) {
            ...
            var h = s.memo(function(e) {
                let {
                    ...
                    audio: m
                } = (0, d.useAudioTrimmerStore)(), I = null != m, p = s.useRef(null), g = s.useRef(null), S = s.useRef(null), [C, N] = s.useState(0), [A, v] = s.useState(0), [T, O] = s.useState(0), [L, R] = s.useState(!1), [M, D] = s.useState(!1), [b, U] = s.useState(!1), [y, P] = s.useState(0), [w, x] = s.useState(-1), F = s.useMemo(() => y / h.fineTuningScale, [h.fineTuningScale, y]);
                s.useEffect(() => {
                    if (null == m) return;
                ...
                let V = s.useCallback((e, t) => {
                    ...
                    B = s.useCallback(e => {
                        ...
                        let t = parseInt(e.target.value),
                            n = t > T ? T : t;
                        i((0, c.toSeconds)(n)), N(n), v(n)
                    }, [m, i, T, L]),
                    k = s.useCallback(e => {
                        if (null == m || !M) return;
                        let t = parseInt(e.target.value);
                        t < C ? (i((0, c.toSeconds)(C)), v(C)) : t > T ? (i((0, c.toSeconds)(T)), v(T)) : (i((0, c.toSeconds)(t)), v(t))
                    }, [m, i, T, M, C]),
                    H = s.useCallback(e => {
                        if (null == m || !b) return;
                        let t = parseInt(e.target.value),
                            n = t > C ? t : C;
                        i((0, c.toSeconds)(C)), v(C), O(n)
                    }, [m, i, b, C]);
                return s.useEffect(() => {
                    null != l && I && l({
                        startPositionMs: C,
                ...
                }, [C, T, l, I, A]), s.useEffect(() => {
                    let e;
                    if (null != m) return t && (e = setInterval(() => {
                        m.currentTime < (0, c.toSeconds)(T) ? m.currentTime >= (0, c.toSeconds)(A) && v(1e3 * m.currentTime) : (n((0, c.toSeconds)(C)), v(C))
                    }, 16)), () => {
                        clearInterval(e)
                    }
                }, [m, T, n, A, t, C]), s.useEffect(() => {
                    if (h.fineTuningDelay <= 0) return;
                    let e = setTimeout(() => {
                        L && C == C && -1 === w ? x(C) : b && T == T && -1 === w ? x(T) : M && A == A && -1 === w && x(A)
                    }, h.fineTuningDelay);
                    return () => {
                        clearTimeout(e)
                    }
                }, [h.fineTuningDelay, b, T, w, M, A, L, C]), (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            style: {
                                left: "".concat((0, c.getStartHandleValue)(C, w, F, y), "%"),
                                right: "".concat((0, c.getEndHandleValue)(T, w, F, y), "%")
                            },
        ...
        527246: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                m = l.memo(function(e) {
                    ...
                    }, [n, m]), C = (0, f.useAudioBufferData)(t), N = (0, f.useAudioWaveformData)(C, g.current, S), A = (0, d.default)(), v = (0, c.useColorValue)((0, o.isThemeDark)(A) ? _.Color.PRIMARY_300 : _.Color.PRIMARY_700), T = null == C || null == N, O = 0 === I.width || 0 === I.height, L = (O || T) && null != t, R = l.useCallback(() => {
                        null != g.current && p({
                    ...
                    return l.useEffect(() => {
                        ...
                        if (0 !== I.width && 0 !== I.height && null != N && N.length > 0) {
                            let e = n / N.length,
            ...
            var i = n("37983"),
                ...
                h = l.memo(function(e) {
                    let {
                        ...
                        audio: S,
                        loadAudioFromFile: C
                    } = (0, d.useAudioTrimmerStore)(), N = l.useMemo(() => (0, o.default)(t.soundId), [t]);
                    return l.useEffect(() => {
                        null == p.current && (p.current = (0, c.loadAudioFileFromUrl)(N, t.name).then(C))
                    }, [N, C, t.name]), (0, i.jsxs)("div", {
                        className: _.previewContainer,
                        children: [(0, i.jsx)(r.Clickable, {
                            onClick: h ? void 0 : function() {
                                null != S && (S.paused ? (S.volume = (0, u.default)(n), S.currentTime = 0, S.play(), I(!0), S.addEventListener("ended", () => I(!1), {
                                    once: !0
                                })) : (S.pause(), I(!1)))
                            },
        ...
        823749: function(e, t, n) {
            ...
            function O(e) {
                ...
                let {
                    ...
                    transitionState: R,
                    showGuildPicker: M = !1
                } = e, [D, b] = s.useState(null !== (n = null !== (t = null == u ? void 0 : u.name) && void 0 !== t ? t : null == O ? void 0 : O.name) && void 0 !== n ? n : ""), [U, y] = s.useState(null !== (i = null == O ? void 0 : O.volume) && void 0 !== i ? i : 1), [P, w] = s.useState(null == O ? void 0 : O.emojiId), [x, F] = s.useState(null == O ? void 0 : O.emojiName), {
                    file: V,
                    loadAudioFromFile: G,
                    maxVolume: B,
                    setMaxVolume: k
                } = (0, p.useAudioTrimmerStore)(), [H, j] = s.useState(!1), [W, K] = s.useState(null), [z, Y] = s.useState(null), [q, Z] = s.useState("ready"), [X, J] = s.useState(a);
                async function Q(e) {
                    try {
            ...
            function A(e) {
                ...
                let v = l.useMemo(() => Object.values(h).map(e => {
                    ...
                    T = l.useCallback(e => null == e || "" === e.value ? null : (0, i.jsx)(_.default, {
                        className: s(C.guildSelectOptionIcon, {
                ...
                return (0, i.jsx)(o.SearchableSelect, {
                    ...
                    renderOptionLabel: L,
                    placeholder: 0 === v.length ? S.default.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT_NONE_AVAILABLE : S.default.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT_PLACEHOLDER
                })
            }
        },

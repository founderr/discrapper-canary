    ...
    ["38991"], {
            ...
            var i = n("37983"),
                ...
                O = function(e) {
                    let {
                        ...
                        transitionState: r,
                        onClose: O
                    } = e, y = (0, s.useStateFromStores)([S.default], () => S.default.getGuild(t), [t]), D = (0, s.useStateFromStores)([T.default], () => T.default.getId()), b = (0, s.useStateFromStores)([p.default], () => p.default.getMember(t, D)), [M, G] = l.useState([]), w = (0, f.default)(), x = (0, h.useUID)();
                    if (l.useEffect(() => {
                        ...
                        children: [(0, i.jsxs)(a.ModalHeader, {
                            ...
                            children: [(0, i.jsx)(a.Heading, {
                                ...
                                children: L.default.Messages.CONNECTIONS_ROLES_CHANNEL_CALL_TO_ACTION_LEARN_MORE.format({
                                    helpdeskArticleUrl: g.default.getArticleURL(R.HelpdeskArticles.CONNECTION_DETAILS)
                                })
                            }), (0, i.jsx)("div", {
                                ...
                                children: F.map(e => {
                                            ...
                                            for (let e of n.rules.flat()) {
                                                ...
                                                if (null != e.application_id) {
                                                    ...
                                                    s = (null == l ? void 0 : l.bot) != null ? (0, i.jsx)("img", {
                                                        ...
                                                        alt: "",
                                                        className: o(U.botAvatar, P.avatar)
                                                    }) : null
                                                } else {
                                    ...
                                    return (0, i.jsxs)(a.Clickable, {
                                        className: o(U.verifiedRole, r ? U.verifiedRoleHasRole : null),
                                        onClick: r ? void 0 : () => {
                                            var l, r;
                                        ...
                                        onContextMenu: r ? t => {
                                            var l, r, o;
                                            return l = y.id, r = e.id, o = t, void(0, c.openContextMenuLazy)(o, async () => {
                                                let {
                                                    default: e
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (c = null == g ? void 0 : null === (s = g.options) || void 0 === s ? void 0 : s.renderHeader) || void 0 === c || c ? _ : null, g.renderStep(T), null == p || m ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !y && a.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: L,
                            location_stack: p
                        }), (0, o.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == _ || _(y), y && (!C && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == T || T())
                    },
        ...
        865372: function(e, t, n) {
            ...
            class p extends r.default.PersistedStore {
                initialize(e) {
                    this.waitFor(a.default), null != e && (f = e), this.syncWith([a.default], I), this.syncWith([u.default], T)
                }
                getState() {
                    return f
                }
                ...
                renderUsers() {
                    ...
                    for (; a < s && a < e.length;) {
                        ...
                        o.push(t ? (0, i.jsx)("div", {
                            ...
                            children: s
                        }, h(null !== (c = e[a]) && void 0 !== c ? c : null, a)) : (0, i.jsx)(T.default, {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [92381], {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = E(e.minStart),
                                ...
                                O = E(e.minDirection),
                                S = E(e.maxDirection);
                            return new y(new x(w(n.x, r.x), w(d.x, f.x), w(p.x, h.x), w(v.x, m.x), A(O.x, S.x), C(e.easingFunctions)[0]), new x(w(n.y, r.y), w(d.y, f.y), w(p.y, h.y), w(v.y, m.y), A(O.y, S.y), C(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = O(e.minStart),
                                ...
                                E = O(e.minDirection),
                                S = O(e.maxDirection);
                            return new m(new x(w(n.x, r.x), w(d.x, f.x), w(p.x, h.x), w(v.x, y.x), A(E.x, S.x), C(e.easingFunctions)[0]), new x(w(n.y, r.y), w(d.y, f.y), w(p.y, h.y), w(v.y, y.y), A(E.y, S.y), C(e.easingFunctions)[0]), new x(w(n.z, r.z), w(d.z, f.z), w(p.z, h.z), w(v.z, y.z), A(E.z, S.z), C(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector3"
                }))
        ...
        592381: (e, t, n) => {
            ...
            const E = function(e) {
                ...
                return (0, i.useCallback)((function(t) {
                    ...
                    g.default.track(x.rMx.PREMIUM_FEATURE_TRY_OUT, {
                        ...
                        feature_tier: (0, p.mv)(s) ? w.h1.FREE : w.h1.PREMIUM_STANDARD,
            ...
            const M = function(e) {
                return {
                    product: (0, m.ZP)([b.Z], (function() {
                        return b.Z.getProduct(e)
                    })),
                    purchase: (0, m.ZP)([I.Z], (function() {
                        return I.Z.getPurchase(e)
                    }))
                }
            };
            var N = n(940594),
            ...
            var V = U.ZP.getEnableHardwareAcceleration() ? c.AnimatedAvatar : c.Avatar;
            const B = function(e) {
                var t = e.user,
                ...
                return (0, r.jsx)(V, function(e) {
                    ...
                    size: a,
                    status: i,
                    "aria-label": u ? void 0 : L.Z.Messages.USER_SETTINGS_AVATAR,
                    "aria-hidden": u
                }, p))
            };
            var G = n(675960),
                    ...
                    return (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(c.Text, {
                            ...
                            children: [(0, r.jsx)(c.Text, {
                                ...
                                variant: "text-sm/normal",
                                children: n ? L.Z.Messages.CHANGE_DECORATION_MODAL_STARTER_DESC : L.Z.Messages.COLLECTIBLES_ACQUIRED_DATE.format({
                ...
                q = function(e) {
                    var t = e.user,
                        ...
                        l = (0,
                            s.e7)([b.Z], (function() {
                            return b.Z.getCategoryForProduct(i.skuId)
                        })),
                        d = (0, Z.Z)(l).backgroundColors,
                        f = (0, p.mv)(l) ? L.Z.Messages.CHANGE_DECORATION_MODAL_PREVIEW_STARTER_PREMIUM : L.Z.Messages.CHANGE_DECORATION_MODAL_PREVIEW_PURCHASE_PREMIUM;
                    return (0, r.jsxs)("div", {
                        className: a()(W().modalPreview, W().shopPreviewContainer, u),
                        children: [(0, r.jsx)("div", {
                            className: W().shopPreviewBanner,
                            style: null != (null == l ? void 0 : l.banner) ? {
                                backgroundImage: "url(".concat((0, p.uV)(l.banner, {
                                    size: N.yV
                                }), ")")
                            } : {
            ...
            const X = function(e) {
                var t = e.user,
                    ...
                    l = c.purchase,
                    d = (0, p.qS)(l),
                    f = !R.ZP.canUsePremiumProfileCustomization(t) && d;
                return null == n || null == u || null != l && !f ? (0, r.jsxs)("div", {
                    ...
                    pendingAvatarDecoration: n,
                    product: u,
                    text: f ? L.Z.Messages.CHANGE_DECORATION_MODAL_PREVIEW_STARTER_CHURNED : void 0
                })
            };
            var Q, $ = n(517586),
                J = n(662478),
            ...
            var he = {
                ...
                ge = function(e) {
                    var t = e.user,
                        ...
                        u = a === Q.PREMIUM_PURCHASE && c && !R.ZP.canUseCollectibles(t),
                        l = i.useRef(null),
                        d = (0, J.Z)(null != o ? o : l),
                        f = (0, k.Z)({
                            user: t,
            ...
            const be = function(e) {
                var t = e.user,
                    ...
                    a = e.onSelect,
                    s = e.onOpenShop,
                    u = (0, m.ZP)([b.Z], (function() {
                        return b.Z.categories
                    })),
                    l = (0, m.ZP)([I.Z], (function() {
                        return I.Z.purchases
                    })),
                    d = i.useMemo((function() {
                        ...
                        return [{
                            ...
                            height: 12,
                            header: L.Z.Messages.CHANGE_DECORATION_MODAL_PURCHASE_HEADER
                        }, {
                            section: Q.PREMIUM_PURCHASE,
                            items: e.premiumPurchase,
                            height: 12,
                            header: L.Z.Messages.CHANGE_DECORATION_MODAL_PREMIUM_STARTER_HEADER
                        }, {
                            section: Q.PREVIEW,
                            items: e.preview,
                            height: 56,
                            header: L.Z.Messages.CHANGE_DECORATION_MODAL_SHOP_PREVIEW_HEADER
                        }].filter((function(e) {
                ...
                return (0, r.jsx)(c.MasonryList, {
                    ...
                    renderItem: function(e, i, u, l) {
                        var f = d[e],
                            p = f.section,
                            h = f.items;
                        return (0, v.EQ)(h[i]).with(he, (function() {
                            return (0, r.jsxs)(me, {
                                style: le({}, u),
                                isSelected: null === n,
                                onSelect: function() {
                            ...
                            return (0, r.jsxs)(me, {
                                ...
                                children: [(0, r.jsx)(re.Z, {
                                    ...
                                    variant: "text-xs/normal",
                                    color: "header-primary",
                                    children: L.Z.Messages.COLLECTIBLES_SHOP
                                })]
                            }, l)
                        ...
                        return (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(c.HeadingLevel, {
                                ...
                                children: n === Q.PREVIEW && (0, r.jsx)(c.Heading, {
                                    variant: "text-sm/normal",
                                    children: L.Z.Messages.CHANGE_DECORATION_MODAL_SHOP_PREVIEW_DESC
                                })
                            })
                        })
                    },
            ...
            var Ee = function(e) {
                ...
                return (0, s.e7)([_.Z], (function() {
                    ...
                    children: L.Z.Messages.AVATAR_DECORATION_MODAL_DISCOVER_MORE_PERKS
                })
            };
            ...
            function Oe(e) {
                var t = e.user,
                    ...
                    v = (0, s.e7)([_.Z], (function() {
                        return _.Z.getPendingAvatarDecoration()
                    })),
                    y = Ae(i.useState((function() {
                    ...
                    C = R.ZP.canUseCollectibles(t),
                    A = C || null === m || null != x && !(0, p.qS)(x),
                    P = (0, D.sr)(m, v),
                    j = i.useRef(null),
                    I = E(u),
                    M = function() {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsxs)(c.ModalHeader, {
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(c.HeadingLevel, {
                                component: (0, r.jsx)(c.Heading, {
                                    ...
                                    children: L.Z.Messages.USER_SETTINGS_CHANGE_AVATAR_DECORATION
                                }),
                                children: !C && (0, r.jsx)(c.Heading, {
                                    variant: "text-sm/normal",
                                    children: L.Z.Messages.CHANGE_DECORATION_MODAL_SHOP_PREVIEW_HEADER_STARTER_DESC
                                })
                            })
                    ...
                    }), A ? null === m || null != x ? (0, r.jsxs)(c.ModalFooter, {
                        className: we().modalFooter,
                        children: [(0, r.jsx)(c.Button, {
                            onClick: M,
                            disabled: P,
                            children: L.Z.Messages.AVATAR_DECORATION_MODAL_APPLY
                        }), (0, r.jsx)(c.Button, {
                            look: c.Button.Looks.LINK,
                            color: c.Button.Colors.PRIMARY,
                            onClick: d,
                            children: L.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_UNUSED_SLOTS_CANCEL
                        })]
                        ...
                        children: [(0, r.jsx)(c.Button, {
                            ...
                            onClick: N,
                            children: L.Z.Messages.COLLECTIBLES_CTA_GO_TO_SHOP
                        }), (0, r.jsx)(c.Button, {
                            look: c.Button.Looks.LINK,
                            color: c.Button.Colors.PRIMARY,
                            onClick: d,
                        ...
                        className: a()(we().modalFooter, we().modalFooterUpsell),
                        children: [(0, r.jsxs)("div", {
                            className: we().modalFooterUpsellButtons,
                            children: [(0, r.jsx)(c.Button, {
                                look: c.Button.Looks.LINK,
                                color: c.Button.Colors.PRIMARY,
                                onClick: d,
                                ...
                                buttonText: R.ZP.isPremium(t) ? L.Z.Messages.USER_SETTINGS_CUSTOMIZATION_UPGRADE_UPSELL : L.Z.Messages.USER_SETTINGS_CUSTOMIZATION_UPSELL
                            })]
                        }), (0, r.jsx)(Ee, {
                            onClose: d
                        })]
            ...
            function Se(e) {
                var t = e.transitionState,
                    ...
                    p = u.purchases,
                    v = u.isFetching,
                    y = (0, s.e7)([j.default], (function() {
                        return j.default.getCurrentUser()
                    })),
                    m = (0, d.Z)(n, l.Z.EDIT_AVATAR_DECORATION_MODAL),

            ...
            function Z(e) {
                ...
                if (!_.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = a.Z.getChannel(i),
                        l = L(u, o),
                        c = T({}, t, j(l), null != o && null != i && (0, P.AB)(i) ? N(0, i) : R(u));
                    _.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        491260: (e, t, n) => {
            ...
            const H = new F(a.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(e) {
                    ...
                    if (T[t] === e.status && I[t] === e.activities) return !1;
                    T[t] = e.status;
                    I[t] = e.activities;
                    delete N[t]
                }

        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let v = null !== (u = null == m ? void 0 : null === (t = m.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    ...
                    M = void 0 !== E && E ? h.sliderBodyLarge : null == m ? void 0 : null === (r = m.options) || void 0 === r ? void 0 : r.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == m ? void 0 : null === (s = m.options) || void 0 === s ? void 0 : s.renderHeader) || void 0 === d || d ? _ : null, m.renderStep(I), null == p || v ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: E,
                            onClose: (e, t) => {
                                l(), null == I || I(e), e && (null == T || T(), !m && null != t && t === _.PremiumSubscriptionSKUs.TIER_2 && !w && c.ComponentDispatch.dispatch(h.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                x = !0, null == p || p(), !m && (0, o.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: T,
                            analyticsLocations: C,
                            analyticsObject: S,
            ...
            var l = n("77078"),
                ...
                j = (0, s.default)((0, a.default)(function(e) {
                    let {
                        ...
                        onSelect: V,
                        onHeightUpdate: B
                    } = e, k = (0, D.default)(t.id, null), Y = (0, A.default)(t, H), Z = (0, v.default)({
                        user: t,
                        context: H
                    }), K = (0, m.default)(t), W = (0, P.default)(t.id), z = (0, R.default)(n.id, a), X = (0, y.default)(t), q = (0, u.default)(null, t), Q = (0, x.default)(t.id), J = (0, U.default)(t.id, n.id), $ = (0, g.default)(t), ee = (0, G.default)(t.id), et = (0, O.default)(t.id, n.id), en = (0, M.default)(t), ei = (0, E.default)(n), el = (0, I.default)({
                        id: t.id,
                        label: w.default.Messages.COPY_ID_USER
                    }), er = (0, I.default)({
                        id: n.id,
                        label: w.default.Messages.COPY_ID_CHANNEL
                    }), ea = (0, _.default)(n), es = (0, f.default)(t.id), eo = (0, c.default)(n.id), eu = (0, N.default)(t), ed = (0, h.default)(t.id), ec = (0, L.default)({
                        commandType: o.ApplicationCommandType.USER,
                        commandTargetId: t.id,
                        channel: n,
                        guildId: void 0,
                        onHeightUpdate: B
                    }), ef = (0, p.useAddToFavoritesItem)(n), eh = (0, p.useRemoveFromFavoritesItem)(n), e_ = (0, T.default)(n), eE = (0, C.useMessageRequestItem)(n), eI = (0, S.useSafetyWarningsItem)(n), ep = n.isManaged(), eT = t.isNonUserBot();

    ...
    ["29449"], {
        ...
        94973: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                S = n("782340"),
                g = n("208961");
            let T = (0, s.cssValueToNumber)(a.default.APPLICATION_SUBSCRIPTION_CARD_LISTING_IMAGE_SIZE),
                ...
                R = e => {
                    ...
                    let r = (0, I.getAssetURL)(t.application_id, n, T);
                    return (0, i.jsx)("div", {
            ...
            function x(e) {
                let {
                    ...
                    onComplete: I,
                    forcesTransitionToGuild: T
                }), O = t.subscription_plans[0], w = 0 === O.price, b = (null == P ? void 0 : P.id) === t.id, V = (0, o.default)(), U = V && !M || x, k = () => {
                    V ? L() : (0, c.redirectToLogin)({
                        [A]: "true"
                    })
                };
                return r.useEffect(() => {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(R, {
                            ...
                            children: [(0, i.jsx)(u.Text, {
                                ...
                                children: w ? S.default.Messages.APPLICATION_SUBSCRIPTION_FREE : S.default.Messages.APPLICATION_SUBSCRIPTION_AMOUNT_PER_PERIOD.format({
                                    amount: (0, p.formatPrice)(O.price, O.currency),
                                    period: (0, d.formatPlanInterval)(O)
                                })
                            }), (() => {
                                var e;
                                if (b) return (0, i.jsx)(N, {
                                    children: (null == y ? void 0 : y.status) === E.SubscriptionStatusTypes.CANCELED ? S.default.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CANCELED_LABEL : S.default.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CURRENT_TIER_LABEL
                                });
                        ...
                        children: t.sku_benefits.benefits.map((e, t) => (0, i.jsx)(m.default, {
                            benefit: e,
                            className: g.benefit
                        }, t))
                    }) : null]
        ...
        913678: function(e, t, n) {
            ...
            function p(e) {
                ...
                return _ && (null == n || m) ? null == S || null == g || 0 === g.length ? null : (0, i.jsx)("div", {
        ...
        467094: function(e, t, n) {
            ...
            function P(e) {
                c.FrecencyUserSettingsActionCreators.updateAsync("favoriteStickers", t => (t.stickerIds = y(t.stickerIds), r.size(t.stickerIds) >= _.MAX_FAVORITES) ? (a.default.show({
            ...
            class f extends r.Component {
                render() {
                    let {
                        ...
                        cta: S
                    } = this.props, g = null != r && r.length > 0, T = null != m ? m : this._textInputRef;

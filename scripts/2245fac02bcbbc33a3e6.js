        ...
        310688: function(e, t, n) {
            ...
            var eT = l.forwardRef(function(e, t) {
                ...
                let ee = null != u ? u.getGuildId() : null != o ? o.id : null,
                    ...
                    ed = (0, _.useStateFromStores)([x.default], () => null != q && x.default.can(el.Permissions.CREATE_INSTANT_INVITE, q), [q]),
                    eT = null === et || !ed,
                    [ef] = l.useState(() => {
                        let e = new Set;
                ...
                let [eD, eP] = l.useState({
                    ...
                    0 === eF && 0 === eb && !eB && ev ? eG({
                        ...
                        networkError: e,
                        showVanityURL: ev
                    }))), eb !== ec.value && eV !== ec.value && eG({
                        savedMaxAge: ec.value
                    })
                }, [ev, q, d, null == eh ? void 0 : eh.id, $, I, eb, eF, eB, B, eG, eV]), ej = (0, N.default)(q), eK = (0, N.default)(B), eW = ej !== q, eY = eK !== B;
                return l.useEffect(() => {
                    (eW || eY) && ek()
                }, [ek, eW, eY]), (0, i.jsx)(k, {
                    children: (0, i.jsx)(eI, {

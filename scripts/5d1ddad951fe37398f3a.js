...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [30027], {
        ...
        23925: (e, t, n) => {
            ...
            function y() {
                ...
                return (0, r.useMemo)((function() {
                    return e.some((function(e) {
                        return b(i.Z.getGuild(e), !1) === u.P.ClydeProfiles
                    }))
                }), [e])
            }
                ...
                if (null == t) {
                    if (null != n && n.isPrivate()) {
                        return !!n.hasFlag(s.zZ.CLYDE_AI) || !!a.getCurrentConfig({
                            ...
                            return m(i.Z.getGuild(e))
                        }))
                    }
                    return !1
                }
                return null != e && e !== u.P.None && l.Z.can(c.Plq.USE_CLYDE_AI, n)
            }
            ...
            function h(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                return b(e, t) === u.P.ClydeProfiles
            }
        ...
        944751: (e, t, n) => {
            ...
            var g = function(e) {
                ...
                n.prototype.isLaunchable = function(e) {
        ...
        766281: (e, t, n) => {
            ...
            function G(e, t, n, r) {
                if (!e.canViewChannel) return function(e, t) {
                    var n = {
                        type: "channel",
                        content: [M(e.roleSubscriptionGated ? e.name : _.Z.Messages.NO_ACCESS)],
                ...
                if (!e.isMentionable) return M("#".concat(e.name));
                var o = {
                        type: "channelMention",
                        channelId: e.id,
                        guildId: e.guildId,
                ...
                return null == i ? e.isDm ? Z(N({}, o), {
                    ...
                    return null != e ? k(e) : M("#".concat(_.Z.Messages.UNKNOWN_CHANNEL_PLACEHOLDER))
            ...
            const re = W(Q({}, u().defaultRules.list), {
                ...
                parse: function(e, t, n) {
                    var r = e[2],
                        ...
                        l = e[0].replace(K, "\n").match(X);
                    V()(null != l, "markup list items can not be parsed.");
                    var u = !1;
                    return {
                        ordered: o,
                        start: i,
            ...
            var Ne = function(e) {
                ...
                je = (0,
                    de.Z)([Re, se]),
                Te = o().omit(je, ["inlineCode", "codeBlock", "br", "blockQuote"]),
                xe = o().omit(je, ["inlineCode", "codeBlock", "br", "blockQuote", "url", "mention", "roleMention", "channelMention", "channelOrMessageUrl", "mediaPostLink"]),
                De = o().omit(je, ["codeBlock", "br", "mention", "channel", "roleMention"]),
                ke = o().omit((0, de.Z)([je, {
                    inlineCode: {
                        match: function(e, t, n) {
                            var r = je.codeBlock.match(e, t, n);
                            if (null != r) return r;
                            var o = je.inlineCode.match(e, t, n);
                            return null != o ? o : void 0
                        }
                    }
                }]), ["blockQuote", "codeBlock", "br"]),
                Me = o().omit(je, ["codeBlock", "br", "blockQuote"]),
                Ue = o().omit(je, ["codeBlock", "br", "mention", "roleMention", "channel", "paragraph", "newline"]),
                Ge = o().omit(je, ["codeBlock", "blockQuote", "br"]);
            ...
            const Be = {
                RULES: je,
                CHANNEL_TOPIC_RULES: Te,
                VOICE_CHANNEL_STATUS_RULES: xe,
                EMBED_TITLE_RULES: De,
                INLINE_REPLY_RULES: ke,
                GUILD_VERIFICATION_FORM_RULES: Me,
        ...
        30027: (e, t, n) => {
            ...
            var G = f.Z.RULES,
                ...
                Q = {
                    link: M(l().defaultRules.link),
                    autolink: M(l().defaultRules.autolink),
                    url: M(l().defaultRules.url),
                    inlineCode: M(G.inlineCode),
                    codeBlock: M(G.codeBlock),
                    rawUserMention: U(F),
                    rawRoleMention: U(B),
                    rawChannelMention: U(H),
                    rawEmoji: U(V),
                    mention: {
                        match: function(e, t, n) {
                            var r = n.split(" ").pop() + e;
                            if (/^[^ ]+@[^ ]+\.[^ .]+/.test(r)) return null;
                            var o = k("@", e, t.users, "mention");
                            if (o) return o;
                            if (o = k("@", e, t.mentionableRoles, "roleMention")) return o;
                            if (!(o = k("@", e, t.users.map((function(e) {
                                    return j(R({}, e), {
                                        text: e.text.split("#")[0]
                                    })
                                })), "mention"))) return null;
        ...
        166232: (e, t, n) => {
            ...
            I.displayName = "StickersPersistedStore";
            I.persistKey = "StickersPersistedStoreV2";
            const A = new I(l.Z, {
        ...
        770819: (e, t, n) => {
            ...
            var Q = (j(G = {}, L.iEv.NAME, V), j(G, L.iEv.PLATFORM, (function(e, t, n) {
                    var r = e.libraryApplication.getDistributor(),
                        o = t.libraryApplication.getDistributor();
                    return r === o ? (n === L.sHY.DESCENDING ? -1 : 1) * V(e, t) : null == r ? 1 : null == o ? -1 : r.localeCompare(o)
                })), j(G, L.iEv.LAST_PLAYED, (function(e, t) {
                    return e.isNew && !t.isNew ? -1 : !e.isNew && t.isNew ? 1 : e.lastPlayed === t.lastPlayed ? 0 : e.lastPlayed > t.lastPlayed ? -1 : 1
                })), j(G, L.iEv.ACTIONS, null), G),
                W = (0, w.oH)((function(e) {
            ...
            function ee() {
                var e = new Set(g.ZP.getRunningVerifiedApplicationIds()),
                    ...
                    u = k(i).concat(k(o)).sort((function(e, t) {
                        return e.lastPlayed === t.lastPlayed ? 0 : e.lastPlayed > t.lastPlayed ? -1 : 1
                    }));
                H = null != y.Z.lastFetched && v.Z.fetched;
        ...
        504275: (e, t, n) => {
            ...
            function pe(e) {
                for (var t = e.query, n = e.members, r = e.limit, i = e.filter, l = x.default.getUsers(), a = T.Z.getGuildId(), c = t.toLocaleLowerCase(), s = (0, q.Fv)(c), f = [], d = [], p = n.length, y = 0, v = 0; y < p;) {
                    var g, m = n[y],
                        h = void 0,
                        b = void 0;
                    if (m instanceof C.Z) {
                    ...
                    if (null == i || i(b)) {
                        ...
                        if (S.substring(0, c.length) === c || P.substring(0, c.length) === c || (null == h ? void 0 : h.substring(0, c.length)) === c || (null == _ ? void 0 : _.substring(0, c.length)) === c || (null == w ? void 0 : w.substring(0, c.length)) === c || (null == N ? void 0 : N.substring(0, c.length)) === c) {
                            ...
                            f.push({
                                ...
                                sortable: null !== (j = null != N ? N : _) && void 0 !== j ? j : P
                            })
                            ...
                            f.push({
                                ...
                                sortable: null !== (k = null != N ? N : _) && void 0 !== k ? k : P
                            })
                            ...
                            d.push({
                                ...
                                record: b,
                                score: 1,
                                comparator: null !== (M = null != w ? w : h) && void 0 !== M ? M : S,
            ...
            const be = {
                ...
                queryChannelUsers: function(e) {
                    ...
                    if (y.isPrivate()) {
                        ...
                        l && M.Z.requestMembers(y.guild_id, n, o)
                    }
                    return pe({
                        query: n,
                        members: d,
                ...
                queryGuildUsers: function(e) {
                    ...
                    if (0 === n.length && a) {
                        var s = he(j.Z.getChannelId(t), o);
                        if (s.length > 0) return s
                    }
                    var f = A.ZP.getMembers(t).filter(de);
                    l && n.length > 0 && M.Z.requestMembers(t, n, o);
                    return pe({
                        query: n,
                        members: f,
                        limit: o,
                ...
                queryUsers: function(e) {
                    ...
                    n && e.length > 0 && M.Z.requestMembers(null, e, t);
                    return pe({
                        query: e,
                ...
                queryChannels: function(e) {
                    ...
                    var A, _, L, Z = {},
                        ...
                        k = void 0;
                    try {
                        for (var M, U = t[Symbol.iterator](); !(T = (M = U.next()).done); T = !0) {
                            var q = M.value;
                            if ((A = g, _ = q.type, L = null != r, A === _ || (L || (0, P.Km)(_)) && (A === I.sH ? (0, P.r8)(_) : A === I.Zb && (0, P.bw)(_))) && (!(0, P.Km)(q.type) || N.Z.can(E ? q.accessPermissions : s.Plq.VIEW_CHANNEL, q)) && y(q)) {
                                ...
                                if (0 !== V) {
                                    ...
                                    0 === V || F.length > 1 || 1 === F.length && !F[0].isFullMatch || j.push({
                ...
                queryMentionResults: function(e) {
                    ...
                    if (!n.isPrivate() && i && p) {
                        ...
                        a && I < S && o()(L, ie().test) && T.push(ie())
                    }
                    v && o()(L, le().test) && T.push(le());
                    return {
                        users: C,
                        globals: T,
                        roles: N
                ...
                queryChoice: function(e) {
                    var t = e.query,
                        ...
                        f = l()(n).map((function(e, t) {
                            var n = fe(e.displayName.toLocaleLowerCase(), {
                                exactQuery: c,
                                containQuery: s,
                                queryLower: a
                            }, u);
                ...
                queryStaticRouteChannels: function(e) {
                    var t = e.query,
                        ...
                        a = [{
                            id: H.HY.SERVER_GUIDE,
                            name: V.Z.Messages.SERVER_GUIDE
                        }, {
                            id: H.HY.CHANNEL_BROWSER,
                            name: V.Z.Messages.CHANNEL_BROWSER_TITLE
                        }, {
                            id: H.HY.CUSTOMIZE_COMMUNITY,
                            name: V.Z.Messages.CHANNELS_AND_ROLES
                        }],
                        c = [],
                        f = !0,
                        d = !1,
                    ...
                    try {
                        for (var y, h = a[Symbol.iterator](); !(f = (y = h.next()).done); f = !0) {
                            var b = y.value;
                            if (!(b.id === H.HY.SERVER_GUIDE && !i || b.id === H.HY.CHANNEL_BROWSER && !l || b.id === H.HY.CUSTOMIZE_COMMUNITY && !u)) {

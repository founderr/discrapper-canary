(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [37246], {
                ...
                r.prototype = {
                    ...
                    avg: function(t) {
                        ...
                        if (!n._avg || t) {
                            ...
                            n._avg = l ? [~~(c / l), ~~(_ / l), ~~(s / l)] : [~~(8 * (n.r1 + n.r2 + 1) / 2), ~~(8 * (n.g1 + n.g2 + 1) / 2), ~~(8 * (n.b1 + n.b2 + 1) / 2)]
                        }
                        return n._avg
                    },
                    contains: function(e) {
                    ...
                    if (r.count()) {
                        ...
                        if (u == i)
                            for (l = r.r1; l <= r.r2; l++) {
                                s = 0;
                                for (c = r.g1; c <= r.g2; c++)
                                    for (_ = r.b1; _ <= r.b2; _++) s += n[e(l, c, _)] || 0;
                                E += s;
                                I[l] = E
                            } else if (u == o)
                                for (l = r.g1; l <= r.g2; l++) {
                                    s = 0;
                                    for (c = r.r1; c <= r.r2; c++)
                                        for (_ = r.b1; _ <= r.b2; _++) s += n[e(c, l, _)] || 0;
                                    E += s;
                                    I[l] = E
                                } else
                                    for (l = r.b1; l <= r.b2; l++) {
                                        s = 0;
                                        for (c = r.r1; c <= r.r2; c++)
                                            for (_ = r.g1; _ <= r.g2; _++) s += n[e(c, _, l)] || 0;
                                        E += s;
                                        I[l] = E
                                    }
                ...
                return {
                    quantize: function(a, u) {
                        ...
                        var c = function(e, t) {
                                ...
                                return new r(a, u, l, c, _, s, t)
                            }(a, l),
                            _ = new n((function(e, n) {
        ...
        614948: (e, t, n) => {
            ...
            function A(e) {
                return (0, i.cj)([l.default, c.ZP, E.Z, _.Z], (function() {
                    var t = {
                            nick: void 0,
                            bio: void 0
                        },
                    ...
                    if (u.has(p.q.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME))
                        if (null == e) {
                            ...
                            t.nick = [f.Z.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_USERNAME_IN_GUILD.format({
                                guildName: null !== (s = i.name) && void 0 !== s ? s : ""
                            })]
                        } else t.nick = [f.Z.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_USERNAME];
                    u.has(p.q.AUTOMOD_QUARANTINED_BIO) && (t.bio = [f.Z.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_BIO]);
                    return t
                }), [e])
            }
            ...
            function N(e) {
                var t = e.guildId,
                    ...
                    p = (0, i.ZP)([_.Z], (function() {
                        return _.Z.getGuild(t)
                    }), [t]),
                    f = (0, i.ZP)([s.Z], (function() {
                        return null != p && s.Z.can(T.Plq.CHANGE_NICKNAME, p)
                    }), [p]);
                return [r.useCallback((function() {
                    if (null != p) {
                        var e = T.oAB.PROFILE_CUSTOMIZATION,
                            t = O.NB.GUILD;
                        f ? (0, u.Fq)(p, null != c ? c : I) : t = O.NB.USER_PROFILE;
                        o.Z.open(e, t, {
                            scrollPosition: n,
                            analyticsLocation: l,
        ...
        813659: (e, t, n) => {
            ...
            function h(e) {
                var t, n = e.onClose,
                    ...
                    U = (0, o.ZP)([_.ZP], (function() {
                        return _.ZP.getMember(R, h)
                    }), [R, h]),
                    M = (0, o.ZP)([s.Z], (function() {
                        return s.Z.getGuild(R)
                    }), [R]),
                    C = null !== (t = null == M ? void 0 : M.name) && void 0 !== t ? t : "",
                    g = (0, p.no)(U),
                    P = (0, l.Z)(u.Z.AUTOMOD_PROFILE_QUARANTINE_ALERT).analyticsLocations,
                    v = m((0, O.ww)({
                        guildId: R,
                    ...
                    b = v[0],
                    D = v[1],
                    y = g.has(A.q.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME) ? N.Z.Messages.GUILD_AUTOMOD_USERNAME_INVALID_MODAL_DESCRIPTION_MOBILE : N.Z.Messages.GUILD_AUTOMOD_BIO_INVALID_MODAL_DESCRIPTION_MOBILE;
                ...
                return (s = l((function(e, t) {
                    ...
                    return c(this, (function(c) {
                        switch (c.label) {
                            ...
                            case 3:
                                _ = c.sent();
                                if (null != (null == (s = _.body) ? void 0 : s.username)) {
                                    s.nick = s.username;
                                    delete s.username
                                }
                                i.Z.dispatch({
        ...
        223219: (e, t, n) => {
            ...
            function y(e) {
                ...
                b = null !== (n = e.section) && void 0 !== n ? n : N;
                ...
                v = null !== (o = e.analyticsLocations) && void 0 !== o ? o : [];
            ...
            var B = function(e) {
                ...
                r.hasChanges = function() {
                    return null != h && null != m && (!(!this.isOpen() && C !== l.cII.USER_SETTINGS) && !i().isEqual(h, m))
                };
                r.isOpen = function() {
                    return U
                };
            ...
            const k = new B(a.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    ...
                    P = null;
                    var t;
                    v = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [];
                ...
                DRAWER_SELECT_TAB: function(e) {
                    C = e.tab;
                    return null == N && C === l.cII.USER_SETTINGS && y({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        347117: (e, t, n) => {
            ...
            function E(e) {
                ...
                if (t !== r || n !== i) {
                    ...
                    var _ = (n = Math.max(Math.round(n * c), l)) > i ? i / n : 1;
                    t = Math.max(Math.round(t * _), a);
                    n = Math.max(Math.round(n * _), l)
                }
                return {
                    width: t,
                    height: n

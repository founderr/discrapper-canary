        ...
        125667: function(e, t, s) {
            ...
            class B extends a.PureComponent {
                ...
                logShownEventIfNeeded() {
                    ...
                    null != e && -1 === k.indexOf(e) && (y.default.track(P.AnalyticEvents.SHOW_TUTORIAL, {
                        tutorial: "activity-invite-nux-inline",
                        application_id: e
                    }), k.push(e))
                }
                ...
                render() {
                    ...
                    if (_) {
                        if (j = (0, n.jsx)(w.default, {
                            ...
                            L = U.default.Messages.CHANNEL_SLOWMODE_DESC_HOURS.format({
                                hours: e,
                                minutes: t,
                                seconds: s
                            })
                            ...
                            L = U.default.Messages.CHANNEL_SLOWMODE_DESC_MINUTES.format({
                                minutes: e,
                                seconds: C - 60 * e
                            })
                        } else L = U.default.Messages.CHANNEL_SLOWMODE_DESC.format({
                            seconds: C
                        });
                        if (!f && h > 0) {
                            let e = d.duration(h);
            ...
            function W(e) {
                let {
                    ...
                    isFocused: (0, f.useStateFromStores)([L.default], () => L.default.isFocused()),
                    guildId: t.guild_id,
            ...
            let i = e => {
                ...
                return (0, n.jsx)("svg", {
                    ...
                    children: (0, n.jsx)("path", {
                        fillRule: "evenodd",
                        clipRule: "evenodd",
                        d: "M12 22C16.9706 22 21 17.9706 21 13C21 10.875 20.2635 8.92198 19.0319 7.38231L19.7071 6.70711C20.0976 6.31658 20.0976 5.68342 19.7071 5.29289C19.3166 4.90237 18.6834 4.90237 18.2929 5.29289L17.6177 5.9681C16.3229 4.93238 14.7359 4.24682 13 4.05493V3L15 3C15.5523 3 16 2.55228 16 2C16 1.44771 15.5523 1 15 1L9 1C8.44772 1 8 1.44772 8 2C8 2.55228 8.44772 3 9 3L11 3V4.05493C9.26415 4.24681 7.67708 4.93238 6.38231 5.9681L5.70711 5.29289C5.31658 4.90237 4.68342 4.90237 4.2929 5.29289C3.90237 5.68342 3.90237 6.31658 4.29289 6.70711L4.9681 7.38231C3.73647 8.92198 3 10.875 3 13C3 17.9706 7.02944 22 12 22ZM15.7071 10.7071C16.0976 10.3166 16.0976 9.68342 15.7071 9.29289C15.3166 8.90237 14.6834 8.90237 14.2929 9.29289L11.2929 12.2929C10.9024 12.6834 10.9024 13.3166 11.2929 13.7071C11.6834 14.0976 12.3166 14.0976 12.7071 13.7071L15.7071 10.7071Z",
        ...
        152637: function(e, t, s) {
            ...
            function ed(e) {
                ...
                return (0, n.jsxs)("div", {
                    ...
                    }), "number" == typeof l ? (0, n.jsx)(w.default, {
                        value: l,
                        digitWidth: 9,
            ...
            function eg(e) {
                let t, s, {
                    ...
                    r = (0, h.useStateFromStores)([L.default], () => L.default.isFocused()),
                ...
                return S > p ? s = ea : t = en, (0, n.jsx)(m.FocusBlock, {
                    ...
                    children: (0, n.jsxs)("div", {
                        ...
                        children: [g.startsWith("data:") ? (0, n.jsx)(y.default, {
                            src: g,
                            maxHeight: t,
                            maxWidth: s,
                            width: p,

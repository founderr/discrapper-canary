...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [93922], {
        ...
        941248: (e, n, t) => {
            ...
            var I = function() {
                var e = l.Z.getMessageRequestsCount() > 0 || s.Z.getSpamChannelsCount() > 0,
                    n = "home",
                    t = o.Ci.getCurrentConfig({
                        location: n
                    }).canViewShopButton,
                    r = i.WZ.getCurrentConfig({
                        location: n
                    }).canUseCollectiblesIAP;
                return [_.Z5c.FRIENDS, f.Z.hasLibraryApplication() && !d.bm.getSetting() ? _.Z5c.APPLICATION_LIBRARY : null, _.Z5c.APPLICATION_STORE, e ? _.Z5c.MESSAGE_REQUESTS : null, t && r ? _.Z5c.COLLECTIBLES_SHOP : null, d.Ex.getSetting() ? _.Z5c.FAMILY_CENTER : null].filter(p.lm)
            };
            ...
            function A(e) {
                var n, t = c.Z.getState(),
                    r = t.channelId,
                    i = t.path,
                    o = t.basePath,
                    a = E.Z.getPrivateChannelIds(),
                    u = __OVERLAY__ ? a : g(I()).concat(g(a)),
                    l = (null == r ? (n = null != i ? i : o, I().findIndex((function(e) {
                        return n.startsWith(e)
                    }))) : null != r ? u.indexOf(r) : 0) + e;
                l >= u.length ? l = 0 : l < 0 && (l = u.length - 1);
                var s, d, f = u[l];
                I().includes(f) ? (s = f, d = h.Z.getCurrentRoute(), s === _.Z5c.APPLICATION_STORE && null != d ? (0, C.z)(d) : (0, C.z)(s)) : y(_.ME, f)
            }

            function O(e, n) {
                var t = c.Z.getState().channelId,
                    i = (0, r.Z)(n).map((function(e) {
                        return e.id
                    }));
                ((0, a.YM)(n) || (0, u.s)(n)) && i.unshift(S.oC.GUILD_HOME);
                var o, l, s = null != t ? i.indexOf(t) : -1;
                y(n, i[(o = s + e, l = i.length, o < 0 ? l - 1 : o >= l ? 0 : o)])
            }

            function b() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1,
                    n = c.Z.getState().guildId;
                null == n ? A(e) : O(e, n)
            }
            var T = t(784426),
                L = t(934870),
                ...
                Z = {
                    ...
                    action: function() {
                        var e;
                        if (null != m.Z.getGuildId()) e = _.ME;
                        else {
                            var n = m.Z.getLastSelectedGuildId();
                            if (null != n) {
                                e = n;
                                (0, C.K)(n, N.Z.getChannelId(n))
                            }
                        }
                        null != e && (0, L.X)(e);
                        return !1

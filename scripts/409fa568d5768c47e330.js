(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["5525"], {
            ...
            function a(e) {
                let t = function(e) {
                    let {
                        ...
                        return i
                    }, N = A(I, p, (l >> 18 & 31) / 31), R = A(3, 3, 1.25 * E), g = A(3, 3, 1.25 * C), L = f && A(5, 5, m), O = r(e), P = s(O > 1 ? 32 : 32 * O), M = s(O > 1 ? 32 / O : 32), v = new Uint8Array(P * M * 4), y = [], x = [];
                    for (let e = 0, r = 0; e < M; e++)
                        for (let s = 0; s < P; s++, r += 4) {
                            ...
                            for (let n = 0, r = i(p, f ? 5 : 3); n < r; n++) x[n] = a(t / M * (e + .5) * n);
                            for (let e = 0, t = 0; e < p; e++)
                                for (let n = e ? 0 : 1, r = 2 * x[e]; n * p < I * (p - e); n++, t++) l += N[t] * y[n] * r;
                            for (let e = 0, t = 0; e < 3; e++)
                                for (let n = e ? 0 : 1, r = 2 * x[e]; n < 3 - e; n++, t++) {
                                    let e = y[n] * r;
                                    o += R[t] * e, E += g[t] * e
                                }
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * x[e]; n < 5 - e; n++, t++) C += L[t] * y[n] * r;
                            let _ = l - 2 / 3 * o,
                                m = (3 * l - _ + E) / 2,
                                T = m - E;
        ...
        917219: function(e, t, n) {
            ...
            }), n("808653"), (a = r || (r = {}))[a.BACKGROUND = 0] = "BACKGROUND", (s = i || (i = {}))[s.OPTION_1 = 0] = "OPTION_1", s[s.OPTION_2 = 1] = "OPTION_2", s[s.OPTION_3 = 2] = "OPTION_3", s[s.OPTION_4 = 3] = "OPTION_4", s[s.OPTION_7 = 7] = "OPTION_7", s[s.OPTION_8 = 8] = "OPTION_8", s[s.OPTION_9 = 9] = "OPTION_9", s[s.OPTION_10 = 10] = "OPTION_10";
        ...
        467831: function(e, t, n) {
            ...
            T.Scenes = r, (o = i || (i = {})).NORMAL = "normal", o.SPEED_START = "speed_start", o.SPEED_LOOP = "speed_loop", o.FINISH = "finish", o.IDLE = "idle";
            let S = {
                [i.NORMAL]: {
                    BEG: 0,
                    END: 600,
            ...
            A.Scenes = i, (u = a || (a = {})).IDLE_ENTRY = "idle_entry", u.IDLE_LOOP = "idle_loop", u.BOOST_START = "boost_start", u.BOOST_LOOP = "boost_loop", u.BOOST_END = "boost_end", u.VICTORY = "victory", u.ERROR = "error";
            let N = {
                [a.IDLE_ENTRY]: {
                    BEG: 0,
                    END: 50
            ...
            L.Scenes = a, (c = s || (s = {})).ENTRY = "entry", c.IDLE = "idle", c.STARS = "stars", c.ERROR = "error", c.SUCCESS = "success";
            let O = {
                    [s.ENTRY]: {
                        BEG: 0,
                        END: 180

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [85903, 81580, 38153, 97516, 96043, 71402, 1459], {
        737264: e => {
            "use strict";
            ...
            function w(e) {
                ...
                if (!O.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== g.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = M(u, i),
                        c = b({}, t, R(a), null != i && null != o && (0, S.AB)(o) ? P(0, o) : L(u));
                    O.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        866893: (e, t, n) => {
            ...
            function V(e) {
                ...
                if (null != t) {
                    ...
                    if (0 !== F.size) {
                        w = Array.from(new Set(m(w).concat(m(F))));
                        F.clear()
                    }
                    ...
                    var n, r = (C === o.z.LATEST_ACTIVITY ? G : D).value(),
                        u = (U = 0 === P.size ? r : r.filter((n = P, function(e) {
            ...
            const W = new Y(l.Z, {
                ...
                THREAD_CREATE: function(e) {
                    ...
                    if (null == t.parent_id || t.parent_id !== R) return !1;
                    if (!n) return !1;
                    t.ownerId !== f.default.getId() ? L++ : N = t.id
                },
            ...
            function K() {
                ...
                for (var l in C)
                    for (var c in C[l])
                        for (var s in C[l][c]) {
                            var f = C[l][c][s];
                            d.ZP.isForumPostUnread(s) && Q(L, f, f, !1)
                        }
                k()
            }
            ...
            function P() {
                return (P = d((function(e, t) {
                    return m(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, C(null != t ? p({}, null != e ? e : s.ME, t) : {})];
                            case 1:
                                n.sent();
                                return [2]
                        }

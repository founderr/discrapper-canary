...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [49607, 39023], {
        919810: (e, n, t) => {
            ...
            function v(e) {
                var n = m(arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [a.Z], 1),
                    t = n[0],
                    r = b(e),
                    i = r.entityType,
                    o = r.channelId,
                ...
                return null != c && u.ZP.canEveryoneRole(p.Plq.VIEW_CHANNEL, c)
            }

            function y(e) {
                var n = m(arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [l.ZP, a.Z, c.Z, o.Z], 4),
                    t = n[0],
                    r = n[1],
                    u = n[2],
                    p = n[3];
                ...
                var h = e.guild_id,
                    ...
                    g = y ? t.getDefaultChannel(e.guild_id) : r.getChannel(b),
                    j = u.getGuild(h),
                    O = p.getStageInstanceByChannel(b);
                return !!(0, i.b)(s.Z, j, g, O) && (null != g && v(e, [r]))
            }

            function g(e) {
                return (0,
                    r.e7)([l.ZP, a.Z, c.Z, o.Z], (function() {
                    return y(e, [l.ZP, a.Z, c.Z, o.Z])
                }), [e])
            }
        },
        383495: (e, n, t) => {
            ...
            function Z(e) {
                ...
                return (0, r.jsx)(c.Tooltip, {
                    ...
                    children: function(e) {
                        var i;
                        return (0, r.jsxs)(c.Clickable, E(I({}, e), {
                            className: a()(P().inline, P().channelContainer, (i = {}, k(i, P().channelContainerEnabled, p && null != t), k(i, P().channelContainerDisabled, !p && null != t), i)),
                            onClick: t,
                            children: [(0, r.jsx)(c.Tooltip, {
                                text: N.Z.Messages.GUILD_EVENT_PRIVATE_CHANNEL_TOOLTIP,
                                shouldShow: o && h && p && null != t,
                                children: function(e) {
                                    return null != m ? (0, r.jsx)(m, E(I({}, e), {
                                        width: 20,
                                        height: 20,
                                        className: P().icon
                                    })) : null
            ...
            function R(e) {
                ...
                return e.isHub ? null == n ? (0, r.jsx)("div", {}) : (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(h.Z, {
                        height: 20,
                        width: 20,
                        className: a()(P().channelContainer, P().icon)
                    }), (0, r.jsx)(c.Text, {
                        className: s ? P().externalLocation : P().channelLocation,
                        variant: "text-sm/normal",
                        children: (0, m.m)(l, !0)
                    })]
                })
            ...
            function A(e) {
                var n, t = e.className,
                    ...
                    H = e.onContextMenu,
                    V = e.onJoinClick,
                    B = e.onJoinGuildClick,
                    G = e.onGoToGuildClick,
                    z = e.onRsvpClick,
                    F = e.onStartClick,
                    W = e.onInviteClick,
                    J = e.onEndClick,
                ...
                return (0, r.jsxs)(c.ClickableContainer, {
                    ...
                    onClick: X,
                    onContextMenu: H,
                    className: a()(P().card, (n = {}, k(n, P().joined, w), k(n, P().lurking, x), n), t),
                    children: [p === S.BANNER && (0, r.jsx)(y.Z, {
                        source: h
                    }), (0, r.jsx)(g.ZP, {
                        creator: l,
                        name: s,
                        description: d,
                        imageSource: p === S.THUMBNAIL ? h : null,
                        truncate: D,
                        ...
                        guildEventId: Y,
                        eventPreview: K
                    }), m && null != i && null != _ && T > 0 && (0, r.jsx)(O.Z, {
                        guild: i,
                        speakers: _,
                        speakerCount: T,
                        className: P().spacing
        ...
        876003: (e, n, t) => {
            ...
            var y = f.Ilk.PRIMARY_400,
                g = f.Ilk.PRIMARY_500;

            function j(e) {
                var n, t = e.enabled,
                    i = e.imageClassName,
                    f = e.iconWrapperClassName,
                    p = v(e, ["enabled", "imageClassName", "iconWrapperClassName"]),
                    j = (0, l.ZP)(),
                    O = (0, a.wj)(j) ? y : g,
                    C = {
                        height: 18,
                ...
                return (0, r.jsx)(d.Z, b({
                    className: o()((n = {}, m(n, h().avatarUploader, t), m(n, h().avatarUploaderDisabled, !t), n)),
                    imageClassName: o()(i, h().avatarUploaderInnerSquare, m({}, h().avatarUploaderInnerSquareDisabled, !t)),
                    icon: null != p.image && "" !== p.image ? (0, r.jsx)(s.Z, b({}, C)) : (0, r.jsx)(u.Z, b({}, C)),
                    iconClassName: o()(h().avatarUploadIcon, h().hideDefaultIcon),
        ...
        888291: (e, n, t) => {
            ...
            function w(e) {
                var n = e.className,
                    ...
                    i = void 0 === t ? null : t;
                return (0, r.jsx)("div", {
                    className: a()(m().imageUploaderIcon, n),
                    children: i
                })
            }
            var P = function(e) {
                ...
                function t() {
                    b(this, t);
                    var e;
                    (e = n.apply(this, arguments)).inputRef = i.createRef();
                ...
                var o = t.prototype;
                o.handleExternalFileChange = function(e) {
                ...
                o.render = function() {
                    var e, n, t, i, o, l = this.props,
                        ...
                        L = l["aria-label"];
                    null != (e = null != c && /^data:/.test(c) ? c : v(c)) ? n = 'url("'.concat(e, '")') : null != b && (t = (0, r.jsx)("div", {
                        className: m().imageUploaderAcronym,
                        children: (0, u.Zg)(b)
                    }));
                    if (y) return (0, r.jsx)("div", {
                        className: a()(m().imageUploader, m().disabled, N),
                        children: (0, r.jsxs)("div", {
                            className: a()(m().imageUploaderInner, P),
                            style: j(g({}, Z), {
                                backgroundImage: n
                            }),
                            children: [t, x && (0, r.jsx)("div", {
                                className: a()(m().imageUploaderIcon, m().imageUploaderIconDisabled, k),
                                children: E
                            })]
                        })
                    });
                    null != c ? i = (0, r.jsx)(s.Anchor, {
                    ...
                    var M = null !== (o = null != L ? L : h) && void 0 !== o ? o : p.Z.Messages.CHANGE_AVATAR;
                    return (0, r.jsxs)("div", {
                        className: a()(m().imageUploader, N),
                        children: [(0, r.jsx)(s.FocusRing, {
                            within: !0,
                            children: (0, r.jsxs)("div", {
                                className: C ? a()(m().imageUploaderIconWrapper, I) : void 0,
                                children: [(0, r.jsxs)("div", {
                                    className: a()(m().imageUploaderInner, P),
                                    style: j(g({}, Z), {
                                        backgroundImage: n

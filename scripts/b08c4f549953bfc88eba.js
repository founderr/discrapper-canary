                    ...
                    i.render = function() {
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(c.ModalRoot, {
                                ...
                                className: k().modal,
                                "aria-labelledby": u,
                                children: [null != l.giftStyle && !b && (0, r.jsx)(I.Z, {
                                    giftStyle: l.giftStyle,
                                    className: k().seasonalGiftIcon
                                }), (0, r.jsx)("div", {
                                    className: b ? void 0 : k().backSplash
                                }), (0, r.jsxs)(c.ModalContent, {
                                    className: s()((e = {}, _(e, k().content, !b), _(e, k().contentCustomGift, b), e)),
                                    children: [(0, r.jsx)(c.ModalCloseButton, {
                                        onClick: a,
                                        className: k().closeButton
                                    }), (null == l.giftStyle || b && this.state.accepted) && (0, r.jsx)(O.Z, {
                                        size: O.Z.Sizes.LARGE,
                                        game: i,
                                        skuId: l.skuId
                                    }), (0, r.jsxs)(c.Heading, {
                                        id: u,
                                        className: s()((t = {}, _(t, k().customGiftHeader, b && !m), _(t, k().header, !b || m), t)),
                                        variant: "heading-sm/semibold",
                                        children: [(0, r.jsx)("div", {
                                            className: s()(_({}, k().customGiftHeaderText, b)),
                                            children: this.firstHeaderText
                                        }), (0, r.jsx)("div", {
                                            children: this.secondHeaderText
                                        })]
                                    }), !(b && !this.state.accepted) && (0, r.jsx)(c.Text, {
                                        className: k().body,
                                        variant: "text-sm/normal",
                                        children: this.bodyText
                                    }), b && null != l.giftStyle && !this.state.accepted && (0, r.jsx)(I.Z, {
                                        className: k().giftAnimation,
                                        giftStyle: l.giftStyle
                                    }), b && this.state.opened && !this.state.accepted && (0, r.jsxs)(r.Fragment, {
                                        children: [(0, r.jsx)(c.FormTitle, {
                                            children: Z.Z.Messages.GIFT_SENDER_INFO.format({
                                                senderDisplayName: S.ZP.getName(h)
                                            })
                                        }), (0, r.jsx)(c.Heading, {
                                            id: u,
...
//# sourceMappingURL=b08c4f549953bfc88eba.js.map
    ...
    [64045], {
        164045: (t, e, n) => {
            ...
            var O = [],
                _ = function(t, e, n) {
                    var r = (0, l.ED)() ? 0 : 1;
                    t === p.MoX.MOUSE_BUTTON && n === r || O.forEach((function(r) {
                ...
                C = function(t) {
                    ...
                    function n() {
                        ...
                        (t = e.call(this)).combo = [];
                        O.push(h(t));
                        1 === O.length && s.ZP.setOnInputEventCallback(_);
                        return t
                    }
                    var r = n.prototype;
                    r.destroy = function() {
                        ...
                        0 === (O = O.filter((function(e) {
                            return e !== t
                        }))).length && s.ZP.setOnInputEventCallback(null)
                    };
                    r.toString = function() {
                        return (0, f.BB)(this.combo)
                    };
            ...
            function M(t) {
                M = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) {
                    return t.__proto__ || Object.getPrototypeOf(t)
                };
                return M(t)
            }
            ...
            var W = (k(Z = {}, G.DEFAULT, B().default), k(Z, G.RECORDING, B().recording), Z),
                V = function(t) {
                    ! function(t, e) {
                        if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                        t.prototype = Object.create(e && e.prototype, {
                    ...
                    function n() {
                        P(this, n);
                        var t;
                        (t = e.apply(this, arguments))._inputId = T().uniqueId("key-recorder-");
                        ...
                        t.handleClick = function(e) {
                            ...
                            var n = t.props,
                                r = n.onClick;
                            n.disableOnClickWhileRecording && t._mousedownMode === G.RECORDING || r()
                        };
                    ...
                    i.componentDidUpdate = function(t) {
                        ...
                        if (t.mode !== e) {
                            ...
                            if (null != n.current) {
                                ...
                                e === G.DEFAULT && n.current === r && n.current.blur();
                                e === G.RECORDING && n.current !== r && n.current.focus()
                            }
                        }
                    };
                    i.render = function() {
                        var t, e = this,
                            ...
                            u = n.disabled,
                            c = (0, f.BB)(i, !0);
                        t = o === G.RECORDING ? U.Z.Messages.SHORTCUT_RECORDER_BUTTON_RECORDING : 0 === i.length ? U.Z.Messages.SHORTCUT_RECORDER_BUTTON : U.Z.Messages.SHORTCUT_RECORDER_BUTTON_EDIT;
                        var a, l = o === G.DEFAULT && i.length > 0;
                        return (0, r.jsx)(N.FocusRing, {
                            ...
                            children: (0, r.jsx)("div", {
                                ...
                                className: w()(B().container, W[o], (a = {}, k(a, B().hasValue, l), k(a, B().disabled, u), a)),
                                children: (0, r.jsxs)(I.Z, {
                                    className: B().layout,
                                    children: [(0, r.jsx)(I.Z.Child, {
                                        className: B().input,
                                        children: (0, r.jsx)("input", {
                                            id: this._inputId,
                                            placeholder: U.Z.Messages.SHORTCUT_RECORDER_NO_BIND,
                                            type: "text",
                                            ref: this.setInputRef,
                                            readOnly: !0,
                                            value: c,
                                            disabled: this.props.mode !== G.RECORDING || u
                                        })
                                    }), (0, r.jsx)(I.Z, {
                                        shrink: 1,
                                        grow: 0,
            ...
            function X(t) {
                X = Object.setPrototypeOf ? Object.getPrototypeOf : function(t) {
                    return t.__proto__ || Object.getPrototypeOf(t)
                };
                return X(t)
            }
            ...
            function tt(t, e) {
                if (t) {
                    ...
                    var n = Object.prototype.toString.call(t).slice(8, -1);
                    "Object" === n && t.constructor && (n = t.constructor.name);
                    return "Map" === n || "Set" === n ? Array.from(n) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? H(t, e) : void 0
                }
            }
            ...
            var nt = l.FB && null != s.ZP.getDiscordUtils().inputCaptureRegisterElement;
            const rt = function(t) {
                ! function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
                    t.prototype = Object.create(e && e.prototype, {
                ...
                function n(t) {
                    ...
                    r.toggleRecordMode = function() {
                        r.state.mode === G.DEFAULT ? r.recordStart() : r.recordEnd()
                    };
                    r.handleComboKeys = function(t, e, n) {
                        n.preventDefault();
                        if ("keydown" === n.type) {
                            var o = e.map((function(t) {
                                    return [p.MoX.KEYBOARD_KEY, u()(t), p.CgE.BROWSER]
                                })),
                                i = n.keyCode;
                            null == o.find((function(t) {
                                var e = q(t, 2)[1];
                                return i === e
                            })) && o.push([p.MoX.KEYBOARD_KEY, i, p.CgE.BROWSER]);
                ...
                o.render = function() {
                    ...
                    if (nt) {
                        e = s.ZP.getDiscordUtils().inputCaptureRegisterElement;
                        t = this.handleNativeChange
                    } else l.FB || (t = this.handleComboKeys);
                    return (0, r.jsx)(Y, {
                        disabled: u,
                        value: o,
                        mode: i,
                        ...
                        disableOnClickWhileRecording: nt
                    })
                };
                return n
            }(o.PureComponent)
...
//# sourceMappingURL=34ce081364be93169e6d.js.map
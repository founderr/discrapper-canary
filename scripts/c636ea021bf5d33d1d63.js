    ...
    ["69709"], {
        ...
        526887: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, I = (0, u.useConfettiCannon)(n, o), _ = (0, r.default)([a.default], () => a.default.useReducedMotion), T = l.useMemo(() => _ ? s : {
                    confettiCanvas: n,
                    cannon: I,
        ...
        424562: function(e, t, n) {
            ...
            function v() {
                l = void 0, u = void 0, r = void 0, o = void 0
            }
            class h extends E.default.Store {
                ...
                showNotice() {
                    return void 0 !== i || void 0 !== l || void 0 !== u || void 0 !== r || void 0 !== a || void 0 !== o
                }
                getPendingAvatar() {
                    return i
                }
        ...
        933326: function(e, t, n) {
            ...
            class c extends i.default {
                ...
                handleInviteResolveSuccess(e) {
                    ...
                    let {
                        invite: n
                    } = e, i = n.guild_scheduled_event, l = null === (t = n.guild) || void 0 === t ? void 0 : t.id;
                    null != i && null != l && d(l)
                }
        ...
        270161: function(e, t, n) {
            ...
            var i = n("316693"),
                l = n("923510"),
                u = n("49111");
            let r = u.Permissions.VIEW_CHANNEL,
                a = i.default.combine(r, u.Permissions.CONNECT),
        ...
        598639: function(e, t, n) {
            ...
            function r(e, t) {
                return (0, i.useStateFromStoresObject)([u.default, l.default], () => {
                    let n = u.default.getGuild(e),
                        i = null != n;
                    return null == n && null != t && (n = l.default.getCachedGuildByEventId(t)), {
                        isMember: i,
                        guild: n
                    }
                }, [e, t])
        ...
        369404: function(e, t, n) {
            ...
            function p(e) {
                ...
                } = (0, d.useManageResourcePermissions)(null != p ? p : t), w = y(M), b = (0, G.default)(M), H = (0, C.useIsChannelPublic)(null == p ? void 0 : p.id, M.id), {
                    withinStartWindow: B
                } = (0, v.getEventTimeData)(m), F = (0, l.useStateFromStores)([_.default], () => (null == p ? !void 0 : !p.isGuildVocal()) || _.default.can(D.Permissions.CONNECT, p), [p]), Y = (0, s.useShowMemberVerificationGate)(x);

                function j(e) {
                    e.stopPropagation(), P ? N.default.deleteRsvpForGuildEvent(O, x) : N.default.createRsvpForGuildEvent(O, x)
                }
                async function k(e) {
                    e.stopPropagation(), await a.default.joinGuild(x), I.default.addConditionalChangeListener(() => {
                ...
                return {
                    ...
                    onJoinClick: F || Y ? function(e) {
                        if (e.stopPropagation(), Y) {
                            null == U || U(), (0, o.openMemberVerificationModal)(x);
                            return
                        }(null == p ? void 0 : p.isGuildStageVoice()) ? ((0, E.connectAndOpen)(p), null == U || U()) : (null == p ? void 0 : p.isGuildVoice()) && (N.default.joinVoiceEvent(p.guild_id, p.id), null == U || U())
                    } : void 0,
                    onRsvpClick: j,
                    ...
                    onEndClick: w && V === L.GuildScheduledEventEntityTypes.EXTERNAL && R ? function(e) {
        ...
        817963: function(e, t, n) {
            ...
            let E = {
                ...
                _ = e => {
                    let [t, n] = e instanceof a.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : I(e), [l, r, d, _] = (0, u.useStateFromStoresArray)([o.default], () => [o.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e), o.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e), o.default.can(t, e), o.default.can(n, e)]), T = (0, u.useStateFromStores)([s.default], () => s.default.getCurrentUser()), S = i.useCallback(e => f(e, T, r, l), [l, r, T]), N = i.useCallback(e => f(e, T, _, d), [_, d, T]);
                    return null == e ? E : {
                ...
                T = function(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : o.default,
                        ...
                        [i, l] = e instanceof a.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : I(e),
                    ...
                    return null == e ? E : {
                        ...
                        canManageAllExpressions: r,
                        canManageAllEvents: _,
                        canManageGuildExpression: e => f(e, T, r, u),
        ...
        38766: function(e, t, n) {
            ...
            function s(e) {
                let {
                    ...
                    null != t && (0, r.initGuildIdentitySettings)(t, null != d ? d : E), l.default.open(a.UserSettingsSections.PROFILE_CUSTOMIZATION, null != t ? o.ProfileCustomizationSubsection.GUILD : o.ProfileCustomizationSubsection.USER_PROFILE, {
                        scrollPosition: n,
                        analyticsLocation: s,
                        analyticsLocations: d,

    ...
    [75625], {
        ...
        860123: (e, t, n) => {
            ...
            function te(e, t) {
                ...
                for (var y in t.framesEncodedByEncoder) {
                    var m, g = t.framesEncodedByEncoder[y],
                        _ = (0, o.lG)(y),
            ...
            function re() {
                return (re = z((function() {
                    var e, t, n, r, o, a, l, u, c, s, p, f, b, y;
                    ...
                    return X(this, (function(u) {
                        switch (u.label) {
                            ...
                            case 3:
                                ...
                                return [3, 4];
                            case 4:
                                O.jF.info("".concat(v.Z.getSettings().clipsLength / 1e3, "s clip save took ").concat(Math.round(performance.now() - i), "ms"));
                                return [2]
                        }
                    }))
                }))).apply(this, arguments)
                    ...
                    return X(this, (function(h) {
                        switch (h.label) {
                            ...
                            case 2:
                                ...
                                h.label = 3;
                            case 3:
                                return (a = (s = c.next()).done) ? [3, 6] : [4, A(Y(q({}, (d = s.value).metadata), {
                                    filepath: d.filepath
                                }))];
                            case 4:
        ...
        796308: (e, t, n) => {
            ...
            const g = i.forwardRef((function(e, t) {
                var n, o, h = e.body,
                    ...
                    D = void 0 !== Z && Z,
                    j = e.shouldUseHorizontalButtons,
                    N = void 0 !== j && j,
                    A = e.showGIFTag,
                    T = void 0 !== A && A,
                ...
                return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsxs)("div", {
                        className: a()(b().content, w, (n = {}, v(n, b().contentNoArt, null == g || P), v(n, b().contentPremium, D || F), n)),
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsxs)(l.Heading, {
                                className: a()(D ? b().headerWithPremiumIcon : b().header, _),
                                variant: "heading-md/bold",
                                color: "always-white",
                                children: [D && !F ? (0, r.jsx)(d.Z, {
                            ...
                            children: null != E ? (0, r.jsxs)(r.Fragment, {
                                children: [(0, r.jsx)(l.Button, {
                                    ...
                                    color: D || F ? l.Button.Colors.BRAND : l.Button.Colors.WHITE,
                                    look: D || F ? l.Button.Looks.INVERTED : l.Button.Looks.FILLED,
                                    children: null != O ? O : f.Z.Messages.EDUCATION_NEW_FEATURE_TRY_IT
                                }), (0, r.jsx)(l.Button, {
                                    className: b().button,
                                    size: H,
                                    onClick: function(e) {
                                    ...
                                    color: D || F ? l.Button.Colors.WHITE : l.Button.Colors.BRAND,
                                    look: D || F ? l.Button.Looks.LINK : l.Button.Looks.FILLED,

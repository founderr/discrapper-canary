    ...
    [89005, 29202, 91683, 58635], {
        ...
        796909: (e, t, n) => {
            ...
            var w = new u.Z((function(e) {
                var t = e.isRequest,
                    n = e.isFavorite;
                return t ? [] : [n ? T.FAVORITE : T.DEFAULT]
            }), (function(e) {
            ...
            function R() {
                ...
                (0, a.cn)() && (0, l.x7)() && v.Z.getAddedToMessages().forEach((function(e) {
                    var t = p.Z.getChannel(e);
                    null != t && (0, d.zi)(t.type) && w.set(t.id, N(t))
                }))
            }

            function C() {
                var e = p.Z.getMutablePrivateChannels();
                for (var t in e) w.set(t, N(e[t]))
            }
            var L, j, F, Z = (L = [], j = [], F = [], function() {
                    var e = w.values(T.FAVORITE),
                        t = w.values(T.DEFAULT);
                    if (L !== e || j !== t) {
                        F = [];
                ...
                U = function(e) {
                    ...
                    r.initialize = function() {
                        this.waitFor(p.Z, h.Z, b.default, f.Z, v.Z);
                        this.syncWith([v.Z, f.Z], R)
                    };
                    r.getPrivateChannelIds = function() {
                        return Z()
                    };
                    r.getSortedChannels = function() {
                        return [w.values(T.FAVORITE), w.values(T.DEFAULT)]
                    };
            ...
            const D = new U(c.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0,
                            d.hv)(e.type) || w.has(e.id)) && w.set(e.id, N(e))
                    }))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && w.set(t, N(r, n.id))
                },

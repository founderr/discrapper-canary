...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [30144], {
        ...
        456837: (t, e, n) => {
            ...
            function E(t) {
                if (null == t || c.Z.isBlocked(t.id)) return null;
                var e = {
                    id: t.id,
                    username: "0" !== t.discriminator ? "".concat(t.username, "#").concat(t.discriminator) : t.username
                };
                null != d.ZP.getGlobalName(t) && (e.globalName = t.globalName);
                t.bot && (e.isBot = !0);
                if (c.Z.isFriend(t.id)) {
                    e.isFriend = !0;
                    e.friendNickname = c.Z.getNickname(t.id)
                }
                return e
            }
            ...
            function w(t) {
                var e = [];
                if (null == t || !(0, s.hv)(t.type)) return e;
                var n = t.recipients;
                (void 0 === n ? [] : n).forEach((function(n) {
                    var r = E(f.default.getUser(n));
                    null != t && R(r, t.id);
                    e.push(r)
                }));
                return e
            ...
            var P = function() {
                function t(e, n) {
                    ...
                    this.handleMessages = function(t) {
                        var e = t.data;
                        if (null != e && e.type === O.USER_RESULTS && e.uuid === i._uuid) {
            ...
            const I = new(function(t) {
                ...
                function r() {
                    ...
                    t._handleConnectionOpen = function() {
                        setTimeout((function() {
                            ...
                            if (null != e) {
                                var n = E(e),
                                    r = y({}, n.id, n);
                                Object.values(f.default.getUsers()).forEach((function(t) {
                                    r[t.id] = E(t)
                                }));
                                var i = a.ZP.getMutableAllGuildsAndMembers();
                                for (var o in i)
                                    for (var u in i[o]) {
                                        var s, l, c = r[u],
                                            h = null !== (l = null === (s = i[o][u]) || void 0 === s ? void 0 : s.nick) && void 0 !== l ? l : d.ZP.getGlobalName(c);
                                        null != c && (c[o] = null != h && "" !== h ? h : null)
                                    }
                    ...
                    t._handlePassiveUpdateV1 = function(e) {
                        null != e.members && t.updateUsers(S(e.members, e.guildId))
                    };
                    t._handleRelationshipAdd = function(e) {
                        var n = E(e.relationship.user);
                        t.updateUsers([n])
                    };
                    t._handleRelationshipUpdate = function(e) {
                        var n = E(f.default.getUser(e.relationship.id));
                        t.updateUsers([n])
                    };
                    ...
                    t._handleDMCreate = function(e) {
                        var n = e.channel.id,
                            r = w(l.Z.getChannel(n));
                        if (0 !== r.length) {
                            var i = E(f.default.getCurrentUser());
                            R(i, n);
                            r.push(i);
                            t.updateUsers(r)
                        }
                    ...
                    t._handleDMUpdates = function(e) {
                        ...
                        try {
                            for (var u, s = n[Symbol.iterator](); !(r = (u = s.next()).done); r = !0) {
                                var a = u.value,
                                    c = w(l.Z.getChannel(a.id));
                                if (0 !== c.length) {
                                    var h = E(f.default.getCurrentUser());
                                    R(h, a.id);
                                    c.push(h);
                                    t.updateUsers(c)
                                }

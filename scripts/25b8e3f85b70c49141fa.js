(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [81322, 1982, 38479, 17183, 33928, 72935, 40056, 19887, 33973, 96043, 71402, 42643, 17363, 56620], {
        737264: e => {
            "use strict";
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var l = m(e.start),
                                ...
                                s = m(e.duration),
                                c = m(e.direction);
                            return new O(new b(t.x, l.x, u.x, s.x, c.x, e.easingFunction), new b(t.y, l.y, u.y, s.x, c.y, e.easingFunction));
                        case "oscillating-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var f = m(e.minStart),
                                p = m(e.maxStart),
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var l = S(e.start),
                                ...
                                s = S(e.duration),
                                c = S(e.direction);
                            return new h(new b(t.x, l.x, u.x, s.x, c.x, e.easingFunction), new b(t.y, l.y, u.y, s.z, c.y, e.easingFunction), new b(t.z, l.z, u.z, s.z, c.z, e.easingFunction));
                        case "oscillating-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var f = S(e.minStart),
                                p = S(e.maxStart),
            ...
            var A = r.forwardRef((function(e, t) {
                ...
                var y = r.useCallback((function(e, t) {
                    ...
                    T = r.useCallback((function(e, t, n, r, o) {
                        var a, l = N(null !== (a = e.id) && void 0 !== a ? a : (0, i.v4)(), e, n, r, o);
                        return y(l, t), l
                    }), [y]),
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", P, u), e("mousedown", A, s), e("mousemove", L, c), e("mouseup", w, f),
                        function() {
                ...
                }), [P, A, L, w, u, s, c, f]), r.useEffect((function() {
                    var e = O.current,
                            ...
                            E.current.forEach((function(e, n) {
                                var r = function(r, i) {
                                    ...
                                    if (t.drawImage(e.image, o, a, f, p), null != r) {
                                        for (var l = t.getImageData(o, a, f, p), u = function(e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
                                                    r: t >> 16 & 255,
                                            ...
                                            }(r), s = 0; s < l.data.length; s += 4) l.data[s] = u.r, l.data[s + 1] = u.g, l.data[s + 2] = u.b;
                                        t.putImageData(l, o, a)
                                    }
                                };
                    ...
                    i.prototype._checkForIntersections = function() {
                        ...
                        this._observationTargets.forEach((function(i) {
                            var o = i.element,
                                ...
                                s = i.entry,
                                c = t && u && this._computeTargetAndRootIntersection(o, n),
                                f = i.entry = new r({
                            ...
                            s ? t && u ? this._hasCrossedThreshold(s, f) && this._queuedEntries.push(f) : s && s.isIntersecting && this._queuedEntries.push(f) : this._queuedEntries.push(f)
                        }), this);
                        this._queuedEntries.length && this._callback(this.takeRecords(), this)
                    };
                    i.prototype._computeTargetAndRootIntersection = function(n, r) {
                        if ("none" != e.getComputedStyle(n).display) {
                            for (var i, o, a, u, c, f, p, d, E = l(n), _ = s(n), O = !1; !O;) {
                                var h = null,
                                ...
                                if (_ == this.root || _ == t) {
                                    O = !0;
                                    h = r
                                } else _ != t.body && _ != t.documentElement && "visible" != I.overflow && (h = l(_));
                                if (h && !(E = (i = h, o = E, a = void 0, u = void 0, c = void 0, f = void 0, p = void 0, d = void 0, a = Math.max(i.top, o.top), u = Math.min(i.bottom, o.bottom), c = Math.max(i.left, o.left), f = Math.min(i.right, o.right), d = u - a, (p = f - c) >= 0 && d >= 0 && {
                                        top: a,
                                        bottom: u,
                                        left: c,
                                        right: f,
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = o(e),
                    ...
                    _ = E.length;
                for (var O in e) !t && !s.call(e, O) || d && ("length" == O || f && ("offset" == O || "parent" == O) || p && ("buffer" == O || "byteLength" == O || "byteOffset" == O) || l(O, _)) || E.push(O);
                return E
            }
        },
        70151: (e, t, n) => {
            ...
            var c = n(500220),
                ...
                O = function(e) {
                    ...
                    n.render = function() {
                        ...
                        delete r.onExiting;
                        delete r.onExited;
                        if ("function" == typeof n) return l.createElement(c.Z.Provider, {
                            value: null
                        }, n(e, r));
                        var o = l.Children.only(n);
                        return l.createElement(c.Z.Provider, {
                            value: null
                        }, l.cloneElement(o, r))
                    };
                    return t
            ...
            var v = function(e, t) {
                ...
                b = function(e) {
                    ...
                    n.render = function() {
                        ...
                        return l.createElement(I, (0, r.Z)({}, t, {
            ...
            function f(e, t, n) {
                ...
                Object.keys(i).forEach((function(o) {
                    ...
                    if ((0, l.isValidElement)(a)) {
                        ...
                        !s || u && !p ? s || !u || p ? s && u && (0, l.isValidElement)(f) && (i[o] = (0, l.cloneElement)(a, {
            ...
            var p = Object.values || function(e) {
                ...
                d = function(e) {
                    ...
                    n.render = function() {
                        ...
                        delete i.enter;
                        delete i.exit;
                        return null === t ? l.createElement(u.Z.Provider, {
                            value: o
        ...
        661299: (e, t, n) => {
            ...
            const p = function(e) {
                ...
                return (0, r.jsxs)("svg", {
                    width: "18",
                    height: "18",
                    className: o()(s().button, i, (t = {}, c(t, s().open, n), c(t, s().withHighlight, l), t)),
            ...
            function U(e) {
                ...
                if (!b.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== T.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = u.Z.getChannel(o),
                        l = M(a, i),
                        s = R({}, t, P(l), null != i && null != o && (0, m.AB)(o) ? N(0, o) : L(a));
                    b.default.track(e, s, {
                        flush: n
                    })
                }
        ...
        761673: (e, t, n) => {
            ...
            function a(e) {
                ...
                if (a) {
                    var u;
                    l = null !== (u = e instanceof i.Z ? e.premiumSubscriberCount : e.premiumSubscriptionCount) && void 0 !== u ? u : 0
                }
        ...
        275086: (e, t, n) => {
            ...
            function O(e) {
                var t = e.analyticsLocations,
                    ...
                    o = e.isGIF,
                    a = e.banner,
                    p = o ? (0, l._p)(c.oNc.ANIMATED_BANNER) : (0, l._p)(c.oNc.BANNER);
                null != p && (0, u.Z)({
        ...
        596801: (e, t, n) => {
            ...
            function E(e, t) {
                var s = null != t ? t : "".concat(u.jXE.PREMIUM_GUILD_UPSELL_MODAL);
                ...
                O && (0, a.Z)(u.KJ3.CHANNEL_CALL_POPOUT);
        ...
        393299: (e, t, n) => {
            ...
            var h, I = (O(r = {}, d.Eu4.NONE, _().iconBackgroundTierNone), O(r, d.Eu4.TIER_1, _().iconBackgroundTierOne), O(r, d.Eu4.TIER_2, _().iconBackgroundTierTwo), O(r, d.Eu4.TIER_3, _().iconBackgroundTierThree), r),
                v = (O(h = {}, d.Eu4.NONE, _().iconTierNone), O(h, d.Eu4.TIER_1, _().iconTierOne), O(h, d.Eu4.TIER_2, _().iconTierTwo), O(h, d.Eu4.TIER_3, _().iconTierThree), h);
            ...
            function L(e) {
                var t = e.guild,
                    ...
                    o = (0, l.e7)([y.default, g.ZP], (function() {
        ...
        17363: (e, t, n) => {
            ...
            const R = function(e) {
                var t = e.file,
                    ...
                    q = Q[0],
                    $ = Q[1],
                    ee = (0, u.Z)(l.Z.IMAGE_CROPPING_MODAL).AnalyticsLocationProvider,
                    te = i.useRef({
                        x: 0,
                        y: 0
                    }),
                    ...
                    pe = (ae = (oe = function() {
                        ...
                        return S(this, (function(u) {
                            switch (u.label) {
                                ...
                                case 2:
                                    i = u.sent(), o = i.result, a = i.cancelFn;
                                    re.current = a;
                                    return [4, o];
                                case 3:
                                    r = u.sent();
                                ...
                                children: [(0, r.jsx)("img", {
                                    style: T({
                                        ...
                                        var e, t = X.width / X.height,
                                            n = (e = le()).width !== e.height && t > E.MY ? U.height / X.height : 1;
                                        return {
                                            width: X.width * V * n,
                                    ...
                                    asValueChanges: function(e) {
                                        if (null != X) {
                                            var t = X.width,
                                                ...
                                                a = i.x,
                                                l = i.y;
                                            (0, o.inRange)(a, r.right, r.left) && (0, o.inRange)(l, r.top, r.bottom) || ue(a, l, r);
                                            F(e);
                                            G(r)
                                        }
                                    },
        ...
        311260: (e, t, n) => {
            ...
            function p(e, t, n, r) {
                ...
                null != d && d.drawImage(e, o, a, l, u, 0, 0, p.width, p.height);
        ...
        338479: (e, t, n) => {
            ...
            function C(e) {
                var t = e.text,
                    ...
                    c = void 0 !== s && s;
                return (0, r.jsxs)("div", {
                    className: g()(c ? R().noticeWithoutRightPadding : R().noticeWithRightPadding, l),
                    children: [(0, r.jsxs)("div", {
            ...
            function x(e) {
                var t = e.analyticsSection,
                    ...
                    s = L.ZP.canUseAnimatedAvatar(u),
                    c = L.ZP.canUsePremiumProfileCustomization(u),
                    f = n === w.pC.BANNER && c || n === w.pC.AVATAR && s,
                    p = (0, l.Z)(v.Z.PREMIUM_PREVIEW_UPSELL_HEADER).sourceAnalyticsLocations;
                i.useEffect((function() {
            ...
            const T = new y(i.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(e) {
                    ...
                    a.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == t ? void 0 : t.sku_id) === l.Si.TIER_2 && null == o.Z.getPremiumSubscription(!1) && null == I.tutorialExpirationTime && b()
                }
            })
        },
        156620: (e, t, n) => {
        ...
        305082: (e, t, n) => {
            ...
            var g = function() {
                ...
                y = function() {
                    var e = (0, p.se)(),
                        ...
                        u = c.Z.getPreviousPremiumTypeSubscription();
                    i || !r || t || (0, a.ou)();
            ...
            function R() {
                return e = S, t = m, n = b("useMemoizedValueSyncedWithDismissibleContents"), o = (0, i.e7)([u.Z], (function() {
                    var e;
            ...
            const M = function(e) {
                var t = function(e) {
                        ...
                        return (0, r.jsxs)(h.C, A(N({
                            ...
                            color: m === g.Si.TIER_1 ? l.Button.Colors.PRIMARY : l.Button.Colors.GREEN,
                            size: P,
                            wrapperClassName: M,
                            pauseAnimation: !X || V
                        }, Y, e), {
                        ...
                        if (null != z) {
                            ...
                            if ((null == J ? void 0 : J.status) !== y.O0b.ACCOUNT_HOLD) ! function(e) {
                                ...
                                if (t)
                                    if (i) {
                                        var O = y.Qqv.BUY;
                                        null != u ? O = y.Qqv.TRIAL : o && (O = y.Qqv.GIFT);
                                        (0, f.Z)({
                                            isGift: o,
                                            initialPlanId: null,
                                            subscriptionTier: a,
                                    ...
                                    } else(0, l.openModalLazy)(C((function() {
                                        var e, t;
                                ...
                                (0, c.A3)();
                                u.Z.open(y.oAB.PREMIUM);
                                null == k || k(!1)
                            }
                        } else(0, p.uL)(y.Z5c.LOGIN)
                    };
                if (D) return (0, r.jsxs)(l.Button, A(N({
                    size: P,
                    className: M,
                    innerClassName: S().premiumSubscribeButton,
                ...
                if (i) return (0, r.jsxs)(l.Button, A(N({
                    size: P,
                    className: M,
                    ...
                    try {
                        for (var o, a = Object.keys(C)[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                            var l = o.value,
                                ...
                                f = void 0;
                            try {
                                for (var p, d = u[Symbol.iterator](); !(s = (p = d.next()).done); s = !0) {
                                    var E = p.value;
        ...
        223219: (e, t, n) => {
            ...
            var j = function(e) {
                ...
                r.hasChanges = function() {
                    return null != S && null != m && (!(!this.isOpen() && P !== u.cII.USER_SETTINGS) && !i().isEqual(S, m))
                };
                r.isOpen = function() {
                    return R
                };
            ...
            const G = new j(a.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    P = e.tab;
                    return null == b && P === u.cII.USER_SETTINGS && U({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        95891: (e, t, n) => {
            ...
            function u(e) {
                var t = e.width,
                    ...
                    E = e.foreground,
                    _ = l(e, ["width", "height", "color", "viewBox", "foreground"]);
                return (0, r.jsx)("svg", a(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);

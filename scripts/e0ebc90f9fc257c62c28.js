                            ...
                            children: [(0, l.jsxs)("div", {
                                ...
                                children: null != S ? (0, l.jsxs)(l.Fragment, {
                                    children: [(0, l.jsx)(r.Button, {
                                        ...
                                        size: b,
                                        onClick: e => {
                                            null == I || I(e), S(e), F(f.ContentDismissActionType.PRIMARY)
                                        },
            ...
            class er extends a.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this._list = null, this.unreadTopRef = a.createRef(), this.unreadBottomRef = a.createRef(), this.state = {
                        ...
                        if (s === u.id && i && (r += en.HEIGHT_HANG_STATUS), null != u.subtitle && (r += en.HEIGHT_CHANNEL_SUBTITLE), u.record.isGuildStageVoice()) {
                            var c, f;

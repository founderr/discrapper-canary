(() => {
    ...
    var n = /^#[0-9a-f]{3,8}$/i,
        ...
        a = function() {
            ...
            a.toHexString = function() {
                ...
                return "#" + (this.red > 15.5 ? r : "0" + r) + (this.green > 15.5 ? t : "0" + t) + (this.blue > 15.5 ? n : "0" + n)
            };
            a.toHSL = function() {
                return function(r) {
                    var t = r.red,
            ...
            r.parseString = function(r) {
                return null != r.match(e) ? this.parseColorFnString(r) : null != r.match(n) ? this.parseHexString(r) : void 0
            };
            r.parseRgbString = function(t) {
                return "transparent" === t ? new r(0, 0, 0, 0) : this.parseColorFnString(t)
            };
            r.parseHexString = function(e) {
                if (null != e.match(n) && ![6, 8].includes(e.length)) {
                    ...
                    var s = e.match(/.{1,2}/g);
                    if (null != s) return new r(parseInt(s[0], 16), parseInt(s[1], 16), parseInt(s[2], 16), null != s[3] ? parseInt(s[3], 16) / 255 : 1)
                }
            };
            r.parseColorFnString = function(n) {
                var a, i = t(null !== (a = n.match(e)) && void 0 !== a ? a : [], 3),
                    o = i[1],
                    u = i[2];
                if (null != o && null != u) {
                    var l = u.split(/\s*[,/\s]\s*/).map((function(r) {
                    ...
                    if ("hsl" === o.substr(0, 3)) {
                        var s = function(r) {
                            ...
                            var i = (1 - Math.abs(2 * e - 1)) * n,
                                ...
                                u = e - i / 2,
                                l = (t < 60 ? [i, o, 0] : t < 120 ? [o, i, 0] : t < 180 ? [0, i, o] : t < 240 ? [0, o, i] : t < 300 ? [o, 0, i] : [i, 0, o]).map((function(r) {
    ...
    function o(r) {
        return function(r) {
            ...
            if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return i(r, t)
        }(r) || function() {
    ...
    function s(r, t, n, e) {
        for (var a = function(r, t) {
                return {
                    x: r / 4 % t,
                    y: Math.floor(r / 4 / t)
                }
            }(t, n), i = a.x, o = a.y, s = e + i; s >= i; s--)
            for (var f = e + o; f >= o; f--)
                if (l(i, o, e, s, f)) {
                    var h = i - (s - i),
                        c = o - (f - o);

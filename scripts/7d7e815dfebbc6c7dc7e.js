                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: I,
                            onClose: (e, t) => {
                                r(), null == S || S(e), e && (null == h || h(), !v && null != t && t === _.PremiumSubscriptionSKUs.TIER_2 && !b && d.ComponentDispatch.dispatch(E.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                    ...
                    onCloseCallback: () => {
                        !D && c.default.track(E.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: y,
                            location_stack: T
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == S || S(D), D && (null == h || h())
                    },

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [92012, 88110, 96043, 71402], {
            ...
            function U(t) {
                ...
                if (!b.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        i = "guild_id" in e ? e.guild_id : r ? v.Z.getGuildId() : null,
                        o = "channel_id" in e ? e.channel_id : r ? _.Z.getChannelId(i) : null,
                        u = l.Z.getChannel(o),
                        a = j(u, i),
                        c = T({}, e, N(a), null != i && null != o && (0, I.AB)(o) ? R(0, o) : C(u));
                    b.default.track(t, c, {
                        flush: n
                    })
                }
            ...
            function E(t) {
                ...
                return (0, r.jsx)(u.ConfirmModal, {
                    ...
                    children: (0, r.jsx)(u.Text, {
                        variant: "text-md/normal",
                        className: v().spacing,
                        children: S ? (0, r.jsx)(u.Spinner, {}) : null != m && null != m.guildsFollowing && m.guildsFollowing > 0 ? (0, r.jsxs)(r.Fragment, {
                            children: [(0, r.jsx)(u.Text, {
                                className: v().spacing,
                                variant: "text-sm/normal",
        ...
        165586: (t, e, n) => {
            ...
            var g = [y(r.RESOLUTION_720), y(r.RESOLUTION_1080), y(r.RESOLUTION_1440), y(r.RESOLUTION_SOURCE, (function() {
                    return c.Z.Messages.SCREENSHARE_SOURCE
                }))],
                _ = [y(r.RESOLUTION_720), y(r.RESOLUTION_1080), y(r.RESOLUTION_1440)],
                v = function(t) {
                    return "".concat(t, "p")
                },
        ...
        189651: (t, e, n) => {
            ...
            function S(t, e) {
                d.default.track(g.rMx.VIEW_AS_ROLES_SELECTED, E(b({
            ...
            function T(t) {
                var e = f.Z.getChannelId(t),
                    n = u.Z.getChannel(e);
                if (!(null != e && (0, _.AB)(e)) && !s.Z.can(g.Plq.VIEW_CHANNEL, n)) {
                    var r = a.ZP.getDefaultChannel(t);
                    null != r && (0, o.uL)(g.Z5c.CHANNEL(t, r.id))
                }
            }
                ...
                if (null != n) {
                    ! function(t, e) {
                        ...
                        a.ZP.addConditionalChangeListener((function() {
                            ...
                            var i = m(a.ZP.getSelectableChannelIds(t)).concat(m(a.ZP.getVocalChannelIds(t))).filter((function(t) {
                                return !n.includes(t)
                            }));
                            i.length > 0 && w(t, i, []);
                            return !1
        ...
        82863: (t, e, n) => {
            ...
            var d = function(t) {
                ...
                n.prototype.getFollowerStatsForChannel = function(t) {
                    return p[t]
                };
                return n
            }(r.ZP.Store);
        ...
        73105: (t, e, n) => {
            ...
            function S(t) {
                ...
                E.error("".concat(t, " is not a valid locale."))
            }
            var I = function() {
                    function t(e) {
                        var n = this;
                    ...
                    e.setLocale = function(t) {
                        ...
                        null === (e = m.setLocale(t)) || void 0 === e || e.then((function(e) {
                            E.info("Switching to ".concat(t), e ? "(available)" : "(unavailable)")
                        }))
                    };

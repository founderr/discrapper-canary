            ...
            var a = n("37983"),
                ...
                S = e => {
                    let {
                        ...
                        guildId: S,
                        onShow: I
                    } = e, M = s.useRef(!1), A = s.useRef(0), R = (0, u.useStateFromStores)([E.default], () => E.default.getGuild(null != S ? S : i.guild_id)), {
                        hasMoreAfter: v,
                        scrollDown: y,
                    ...
                    }, [T, C, N]), L = s.useMemo(() => (0, o.canUseContextMenuCommands)(i, k.length, d.getCommandTypeCount(i, t, null == R ? void 0 : R.applicationCommandCounts)), [i, t, k.length, null == R ? void 0 : R.applicationCommandCounts]);
                    s.useEffect(() => {
                    ...
                    let O = s.useCallback(e => {
                            v && e + 500 > 34 * k.length - 40 && y(), A.current = e
                        }, [v, y, k]),
                        x = s.useCallback(e => {

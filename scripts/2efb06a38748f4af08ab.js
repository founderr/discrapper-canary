    ...
    ["24020"], {
        ...
        846883: function(e, t, n) {
            ...
            function w(e, t) {
                let {
                ...
                } = (0, o.default)(), J = (0, i.useStateFromStores)([h.default], () => h.default.getCurrentUser()), X = (0, i.useStateFromStores)([b.default], () => b.default.getSelfEmbeddedActivities()), B = (0, i.useStateFromStoresArray)([O.default], () => O.default.getActivities().filter(e => null != e.application_id && !(null == X ? void 0 : X.has(e.application_id)))), z = (0, i.useStateFromStoresArray)([M.default], () => null != t ? M.default.getActivities(t.id, null == e ? void 0 : e.getGuildId()) : [], [t, e]), K = (0, i.useStateFromStoresArray)([b.default], () => {
                    ...
                    VoiceStateStore: C.default,
                    PermissionStore: g.default
                }))], [z, Z, $, J, K, t]), et = (0, i.useStateFromStoresArray)([c.default, A.default], () => z.map(e => e.type === P.ActivityTypes.LISTENING && null != t ? (0, I.default)(c.default, A.default, t, e) : void 0), [t, z]), en = (0, s.useAnalyticsContext)();
                if (!Q) return null;
                let ea = (n, a) => {
                ...
                return null == X || X.forEach(n => {
                    ...
                    var n;
                    let i = e.connections.has(null !== (n = null == J ? void 0 : J.id) && void 0 !== n ? n : ""),
                        u = t + z.length,
                        d = q[u] || i,
                        s = k.default.Messages.EMBEDDED_ACTIVITIES_JOIN_ACTIVITY;
                    i ? s = k.default.Messages.USER_ACTIVITY_CANNOT_JOIN_SELF : q[u] && (s = k.default.Messages.USER_ACTIVITY_JOINING), ee[u] && ed.push((0, a.jsx)(l.MenuItem, {

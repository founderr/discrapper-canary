                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, g, M, U, F = j(S, p),
                                G = j(R, p),
                                V = null !== (U = null !== (M = null !== (g = null !== (E = j(C, p)) && void 0 !== E ? E : j(N, p)) && void 0 !== g ? g : j(P, p)) && void 0 !== M ? M : j(w, p)) && void 0 !== U ? U : j(L, p),
                                k = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
            ...
            const K = new W(u.Z, {
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    if (r) {
                        ...
                        if (!o.ready) return !1;
                        if (null != n.nonce && n.state !== N.yb.SENDING && Z.has(n.nonce)) {
                            o = o.remove(n.nonce);
                            Z.delete(n.nonce)
                        }

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["74740"], {
        ...
        786770: function(e, t, n) {
            ...
            function H(e) {
                let t = B.length;
                return (B = B.filter(t => t.type !== i.TEXT || t.channelId !== e || !1)).length !== t
            }

            function z(e) {
                let t = B.find(t => t.type === i.INCOMING_CALL && t.channelId === e);
            ...
            function W(e, t) {
                ...
                if (n.priority !== a.URGENT && !D.default.isInstanceFocused()) return null;
                let i = (0, d.v4)(),
                    l = {
                        id: i,
                ...
                B = [...B];
                let s = B.findIndex(e => e.priority <= n.priority);
                if (-1 === s ? B.push(l) : B.splice(s, 0, l), B.length > 10) {
                    let e = B.pop();
            ...
            function Y(e) {
                let {
                    channelId: t,
                    ringing: n
                } = e, l = z(t), s = n.includes(N.default.getId());
                if (!s) return F(l);
                if (null != l) return !1;
                let o = _.default.getChannel(t);
                if (null == o || !o.isPrivate() || x.default.getStatus() === b.StatusTypes.DND) return !1;
                let r = B.find(e => e.type === i.TEXT && e.channelId === t && e.messageType === b.MessageTypes.CALL);
                null != r && F(r.id), W((0, E.default)(o), {
                    priority: a.HIGH,
                    expirationExternallyManaged: !0,
                    type: i.INCOMING_CALL,
                    channelId: o.id
                })
            }
            ...
            var K = new Z(c.default, __OVERLAY__ ? {
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    let {
                        channelId: s,
                        message: o
                    } = e, d = _.default.getChannel(s), u = L.default.getUser(null === (t = o.author) || void 0 === t ? void 0 : t.id);
                    if (null == d || null == u) return !1;
                    if ((null === (n = o.activity) || void 0 === n ? void 0 : n.type) === b.ActivityActionTypes.JOIN || (null === (l = o.activity) || void 0 === l ? void 0 : l.type) === b.ActivityActionTypes.JOIN_REQUEST) {
                        if (!(0, j.shouldNotify)(o, s, !0, !0)) return !1;
                        let e = function(e, t, n) {
                            let i, l;
                            if (r(null != t.activity, "received null message activity"), n.id === N.default.getId()) return !1;
                            let s = P.default.getGame();
                            if (null == s) return !1;
                            switch (t.activity.type) {
                                case b.ActivityActionTypes.JOIN:
                                    if (null == (i = O.default.getApplicationActivity(n.id, s.id)) || null == i.party || i.party.id !== t.activity.party_id) return !1;
                                    l = (0, h.default)(e, t, n, s, i);
                                    break;
                                case b.ActivityActionTypes.JOIN_REQUEST:
                                    if (null == (i = x.default.getApplicationActivity(s.id)) || null == i.party || i.party.id !== t.activity.party_id) return !1;
                                    l = (0, m.default)(e, n, s, i)
                            }
                            if (null == l) return !1;
                            let o = W(l, {
                                priority: a.URGENT,
                    ...
                    if ((!D.default.isInstanceUILocked() || D.default.isPinned(b.OverlayWidgets.TEXT)) && s === A.default.getChannelId() || D.default.getTextChatNotificationMode() === b.OverlayNotificationTextChatTypes.DISABLED || R.default.disableNotifications || !(0, j.shouldNotify)(o, s)) return !1;
                ...
                ACTIVITY_USER_ACTION: function(e) {
                    let t, {
                        ...
                        o = P.default.getGame();
                    if (null == o || o.id !== s) return !1;
                    if (n === b.ActivityActionTypes.JOIN) t = (0, p.default)(l, o);
                    if (null == t) return !1;
                    W(t, {
                        priority: a.URGENT,
                        type: i.GENERIC
            ...
            class T extends s.Component {
                ...
                handleDragMove(e, t) {
                    ...
                    let {
                        ...
                        bottom: null,
                        right: null
                    }, l, s, E, m)), N = f ? (0, u.getAnchorCoordsFromFullCoords)(y) : v(i.RESIZE_SOUTH_EAST, y);
                ...
                handleResizeMove(e, t) {
                    ...
                    if (null != c) {
                        ...
                        g = Math.max(g + m, a.width), E = Math.max(E + S, a.height), this.setDOMSize({
                            width: g,
                            height: E
                ...
                constructor(e) {
                    super(e), this.ref = s.createRef(), this.dragState = {
                        ...
                        !(null == s || !o && 3 > h(a, l, t, n)) && (s === i.MOVE ? this.handleDragMove(t, n) : p.has(s) && this.handleResizeMove(t, n))
                        ...
                        let {
                            width: r,
                            height: d
                        } = S(a, this.size), c = (0, u.getFullCoordsFromAnchorCoords)(this.anchor, s, o, r, d);
                        if (e === i.MOVE) {
                            let {
                                x: e,
                                y: i

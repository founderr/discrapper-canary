    ...
    ["11519"], {
        ...
        420333: function(e, t, n) {
            ...
            function M(e) {
                ...
                } = e, H = (0, r.useStateFromStores)([p.default], () => p.default.isFocused()), B = (0, r.useStateFromStores)([_.default], () => _.default.getCurrentUser()), V = (0, r.useStateFromStores)([f.default], () => f.default.getGuildId()), j = (0, r.useStateFromStores)([E.default], () => E.default.getGuild(V)), W = (0, r.useStateFromStores)([u.default], () => u.default.isEditingClydeProfile()), {
                    reducedMotion: K
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                y = !0, null == p || p(), !C && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: S,
                            analyticsLocations: T,
                            analyticsObject: h,
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: L,
                            location_stack: T
                        }), (0, a.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == _ || _(y), y && (!C && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == S || S())
                    },
        ...
        364685: function(e, t, n) {
                    ...
                    if (null != t) {
                        for (let [e, n] of t)
                            if (_.default.isMember(e) && !O.has(e)) {
                                for (let t of n) U(t, !0, p.default.getGuild(e));
                                L(e, n)
                            }
                    }
                },
            ...
            class w extends a.default.Store {
                initialize() {
                    this.waitFor(o.default, _.default, p.default)
                }
                get isLoaded() {
                    return 0 !== I
                }
        ...
        26092: function(e, t, n) {
            ...
            function A(e) {
                ...
                if (null == d) return O();
                c = null !== (t = e.section) && void 0 !== t ? t : c, m = null !== (n = e.section) && void 0 !== n ? n : c, null != e.subsection && null != c && (E[c] = e.subsection), null != e.scrollPosition && null != c && (f[c] = e.scrollPosition), h = !!e.openWithoutBackstack, u = o.FormStates.OPEN, _ = {}, S = {
                    ...p = {
            ...
            function O() {
                u = o.FormStates.CLOSED, T = !1, p = null, m = null, S = null, d = null, c = null, E = {}, f = {}, g = null, C = null, v = [], N = null
            }
            ...
            class D extends r.default.Store {
                ...
                hasChanges() {
                    return null != S && null != p && (!!this.isOpen() || I === o.DrawerTabTypes.USER_SETTINGS) && !l.isEqual(S, p)
                }
                isOpen() {
                    return T
                }
        ...
        181114: function(e, t, n) {
            ...
            let T = e => {
                ...
                return (0, r.jsxs)(d.Button, {
                    ...
                    disabled: i,
                    submitting: s,
                    children: [t, C ? (0, r.jsx)(S, {
                        shinePaused: _,
                        className: o(f.buttonShine, T ? f.onlyShineOnHover : void 0, p),
                        shineSize: E
                    }) : null]
                })
            };

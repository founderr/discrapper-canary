...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [95839], {
        ...
        706148: (e, t, n) => {
            ...
            function g(e) {
                var t = e.activityItem,
                    ...
                    s = e.channelId,
                    f = e.guildId,
                    d = e.embeddedActivitiesManager,
                    y = e.analyticsLocations,
                    h = o.Z.getGuild(f),
                    I = u.default.getCurrentUser();
                if (null == h && !(0, b.I)(s) || null == I || null == t) return Promise.resolve(!1);
                var E = t.application,
                    A = t.activity;
                if (null == E) return Promise.resolve(!1);
                if (null == s) {
                    c.S.dispatch(C.CkL.SHOW_ACTIVITIES_CHANNEL_SELECTOR, {
                        applicationId: E.id
                    });
                ...
                if (T !== v.jy.CAN_LAUNCH) {
                    T === v.jy.NO_USE_EMBEDDED_ACTIVITIES_PERMISSION && (0, r.w)();
                    return Promise.resolve(!1)
                }
                var O = function() {
                    var e = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
                        ...
                        t = A.requires_age_gate && null == I.nsfwAllowed;
                    ...
                    return S(this, (function(O) {
                        switch (O.label) {
                            case 0:
                                ...
                                _ = i.Z.getChannel(t);
                                if (null == p || null == _) return [2, !1];
                                v = l.v.getCurrentConfig({
                                    location: "handleStartEmbeddedActivity"
                                }, {
                                    autoTrackExposure: !1
                                }).isActivitiesInTextEnabled;
                                b = (0, y.Z)(t);
                                T = A.wP.includes(_.type);
                                return b ? [4, (0, h.Z)({
                                    channelId: t,
                                    bypassChangeModal: c
                                })] : [3, 2];
                            case 1:
                                return O.sent() ? [3, 3] : [2, !1];
                            case 2:
                                if (!v || !T) return [2, !1];
                                O.label = 3;
                            case 3:
                ...
                return (O = f((function(e) {
                    ...
                    return A(this, (function(y) {
                        switch (y.label) {
                            case 0:
                                t = e.channelId,
                                    n = e.timeoutMs, s = void 0 === n ? 1e4 : n, f = e.bypassChangeModal, d = void 0 !== f && f;
        ...
        195034: (e, t, n) => {
            ...
            function o() {
                return (0, r.e7)([i.ZP], (function() {
                    var e = i.ZP.getConnectedActivityChannelId();
                    if (null != e) {
                        var t;
                        return null !== (t = i.ZP.getSelfEmbeddedActivityForChannel(e)) && void 0 !== t ? t : void 0
                    }
                }))
            }
        },
        ...
        595258: (e, t, n) => {
            ...
            function Q(e, t) {
                return !t || "object" !== te(t) && "function" != typeof t ? W(e) : t
            }
                    ...
                    return re(this, (function(g) {
                        switch (g.label) {
                            case 0:
                                ...
                                y = ae(p), h = y.isPremiumActivity, b = y.isFreePeriod, O = y.releasePhase;
                                return [4, (0, d.Z)()];
                            case 1:
                                S = g.sent();
                                oe[i] = function(e) {
                                    var t, n;
                                    ie[i] = e;
                                    E.default.track(K.rMx.ACTIVITY_SESSION_JOINED, {
                                        channel_id: o.id,
                    ...
                    return re(this, (function(A) {
                        switch (A.label) {
                            case 0:
                                ...
                                p = ae(f), v = p.isPremiumActivity, y = p.isFreePeriod, h = p.releasePhase;
                                return [4, (0, d.Z)()];
                            case 1:
                                b = A.sent();
                                E.default.track(K.rMx.ACTIVITY_SESSION_LEFT, {
                                    channel_id: a.id,
            ...
            function de(e) {
                var t, n, r = e.channelId,
                    ...
                    s = _.Z.getChannel(r);
                a === J.m2.ACTIVITY_STARTED && null !== (n = null == s ? void 0 : s.isPrivate()) && void 0 !== n && n && l.length <= 1 && void 0 === o.find((function(e) {
                    return e.user_id === u
                ...
                if (o.some((function(e) {
                    ...
                    if (null != d && null != v && null != f) {
                        null === (t = oe[d]) || void 0 === t || t.call(oe, {
                            mediaSessionId: f,
                            activitySessionId: v
                        });
                        delete oe[d]
            ...
            function pe(e) {
                ...
                if (null != t && null != n) {
                    ...
                    if (null != i && null != t && null != o) {
                        var a;
                        null === (a = oe[i]) || void 0 === a || a.call(oe, {
                            mediaSessionId: t,
                            activitySessionId: o
                        });
                        delete oe[i]
            ...
            var _e = function(e) {
                ...
                function n() {
                    ...
                    e.superHandleRPCDisconnect = function(t) {
                        ...
                        if (null != r && null != n) {
                            ...
                            n.code !== K.$VG.CLOSE_NORMAL && e.showErrorModal(n, r)
                        }
                    };
                    var r, i = W(e);
                    e.handleDeferredOpen = (r = z((function(e) {
                ...
                r._initialize = function() {
                    ...
                    o.Z.subscribe("EMBEDDED_ACTIVITY_OPEN", ue);
                    o.Z.subscribe("EMBEDDED_ACTIVITY_CLOSE", se);
                    o.Z.subscribe("EMBEDDED_ACTIVITY_INBOUND_UPDATE", de);
                    ...
                    o.Z.subscribe("MEDIA_SESSION_JOINED", pe)
                };
                r._terminate = function() {
                    ...
                    o.Z.unsubscribe("EMBEDDED_ACTIVITY_OPEN", ue);
                    o.Z.unsubscribe("EMBEDDED_ACTIVITY_CLOSE", se);
                    o.Z.unsubscribe("EMBEDDED_ACTIVITY_INBOUND_UPDATE", de);
                    ...
                    o.Z.unsubscribe("MEDIA_SESSION_JOINED", pe)
                };
                return n
            }(s.Z);
            ...
            var Se = function(e, t) {
                ...
                ge = function(e) {
                    ...
                    c.showErrorModal = function(e) {
                        var t = e.code,
                            n = e.message;
                        (0, i.openModalLazy)(ye((function() {
                            return Se(this, (function(e) {
                                return [2, function(e) {
                                    return (0, r.jsx)(a.default, be({
                    ...
                    return l(this, (function(l) {
                        switch (l.label) {
                            case 0:
                                ...
                                return (0,
                                    a.Z)(u) && null != c && null != c.sync_id ? [4, (0, i.KV)()] : [2];
                            case 1:
                                l.sent();
                                r.hY(c, s.id);
                                (0, o.Z)(t, s, c, n);

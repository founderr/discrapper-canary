(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [59152, 38479, 17183, 33928, 44609, 72935, 96043, 42643, 17363, 56620], {
        652411: (e, t, n) => {
            "use strict";
            n.d(t, {
                O_: () => N,
                ...
                y = function(e) {
                    function t(t, n, r, o, i, l) {
                        ...
                        var a = u.value / (u.max - u.min) * u.duration,
                            c = isNaN(a) ? 0 : a;
                        return u.timePassed = c < 0 ? u.duration - c : c, u.directionMultiplier = i, u.easingFunction = l, u
                    }
                    return d(t, e), t.prototype.update = function(e) {
            ...
            function C(e) {
                return function(e) {
                    switch (e.type) {
                        ...
                        case "linear-random":
                            return new T(h(e.minValue, e.maxValue), h(e.minAddValue, e.maxAddValue));
                        case "oscillating":
                            return new y(e.value, e.start, e.final, e.duration, e.direction, e.easingFunction);
                        case "oscillating-random":
                            return new y(h(e.minValue, e.maxValue), h(e.minStart, e.maxStart), h(e.minFinal, e.maxFinal), h(e.minDuration, e.maxDuration), g(e.minDirection, e.maxDirection), v(e.easingFunctions)[0])
                    }
                }(_(_({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "linear":
                            t = S(e.value);
                            var o = S(e.addValue);
                            return new O(new T(t.x, o.x), new T(t.y, o.y));
                        case "linear-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var i = S(e.minAddValue),
                                l = S(e.maxAddValue);
                            return new O(new T(h(n.x, r.x), h(i.x, l.x)), new T(h(n.y, r.y), h(i.x, l.x)));
                        case "oscillating":
                            t = S(e.value);
                            var u = S(e.start),
                                a = S(e.final),
                                c = S(e.duration),
                                s = S(e.direction);
                            return new O(new y(t.x, u.x, a.x, c.x, s.x, e.easingFunction), new y(t.y, u.y, a.y, c.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var f = S(e.minStart),
                                p = S(e.maxStart),
                                ...
                                m = S(e.minDirection),
                                C = S(e.maxDirection);
                            return new O(new y(h(n.x, r.x), h(f.x, p.x), h(d.x, _.x), h(E.x, I.x), g(m.x, C.x), v(e.easingFunctions)[0]), new y(h(n.y, r.y), h(f.y, p.y), h(d.y, _.y), h(E.y, I.y), g(m.y, C.y), v(e.easingFunctions)[0]))
                    }
                }(_(_({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "linear":
                            t = m(e.value);
                            var o = m(e.addValue);
                            return new I(new T(t.x, o.x), new T(t.y, o.y), new T(t.z, o.z));
                        case "linear-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var i = m(e.minAddValue),
                                l = m(e.maxAddValue);
                            return new I(new T(h(n.x, r.x), h(i.x, l.x)), new T(h(n.y, r.y), h(i.y, l.y)), new T(h(n.z, r.z), h(i.z, l.z)));
                        case "oscillating":
                            t = m(e.value);
                            var u = m(e.start),
                                a = m(e.final),
                                c = m(e.duration),
                                s = m(e.direction);
                            return new I(new y(t.x, u.x, a.x, c.x, s.x, e.easingFunction), new y(t.y, u.y, a.y, c.z, s.y, e.easingFunction), new y(t.z, u.z, a.z, c.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var f = m(e.minStart),
                                p = m(e.maxStart),
                                ...
                                S = m(e.minDirection),
                                C = m(e.maxDirection);
                            return new I(new y(h(n.x, r.x), h(f.x, p.x), h(d.x, _.x), h(E.x, O.x), g(S.x, C.x), v(e.easingFunctions)[0]), new y(h(n.y, r.y), h(f.y, p.y), h(d.y, _.y), h(E.y, O.y), g(S.y, C.y), v(e.easingFunctions)[0]), new y(h(n.z, r.z), h(f.z, p.z), h(d.z, _.z), h(E.z, O.z), g(S.z, C.z), v(e.easingFunctions)[0]))
                    }
                }(_(_({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var N = r.forwardRef((function(e, t) {
                    ...
                    h = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                var n = Date.now();
                                0 !== T.current && (y.current = 1e3 / (n - T.current)), T.current = n
                            }
                        }
                    }), [l, d, p]);
                ...
                var R = r.useCallback((function(e, t) {
                        var n, r, o = t.clickHandler,
                            i = t.mouseHandler;
                        if (null != o || null != i) {
                            var a = null === (n = O.current) || void 0 === n ? void 0 : n.getBoundingClientRect();
                            if (null != a) {
                                var c = function(e, t) {
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", P, a), e("mousedown", N, c), e("mousemove", w, s), e("mouseup", M, f),
                        function() {
                ...
                }), [P, N, w, M, a, c, s, f]), r.useEffect((function() {
                    var e = O.current,
            ...
            var w = r.forwardRef((function(e, t) {
                            ...
                            _.current.forEach((function(e, n) {
                                var r = function(r, o) {
                                    ...
                                    if (t.drawImage(e.image, i, l, f, p), null != r) {
                                        for (var u = t.getImageData(i, l, f, p), a = function(e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
                                                    r: t >> 16 & 255,
                                            ...
                                            }(r), c = 0; c < u.data.length; c += 4) u.data[c] = a.r, u.data[c + 1] = a.g, u.data[c + 2] = a.b;
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, b()];
                                    case 1:
                                        return e.sent(), I(), E.current = !0, T(!0), [2]
                                }
                            }))
                        }))
                    }), [T, b, I]);
                return r.useEffect((function() {
                    ...
                    ref: d,
                    className: l()(i, (n = {}, n["SpriteCanvas-module_spriteCanvasHidden__ndzQV"] = !a, n))
                })
            }));
            ...
            function M(e, t) {
                ...
                var u = r.useCallback((function(n, r) {
                        ...
                        if (null != a && null != u && 0 !== u.sprites.length) return null == e ? void 0 : e.createConfetti(n, a, u, i, l)
                    }), [e, t]),
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = i(e),
                    ...
                    E = _.length;
                for (var O in e) !t && !c.call(e, O) || d && ("length" == O || f && ("offset" == O || "parent" == O) || p && ("buffer" == O || "byteLength" == O || "byteOffset" == O) || u(O, E)) || _.push(O);
                return _
            }
        },
        70151: (e, t, n) => {
        ...
        661299: (e, t, n) => {
            ...
            const p = function(e) {
                ...
                return (0, r.jsxs)("svg", {
                    width: "18",
                    height: "18",
                    className: i()(c().button, o, (t = {}, s(t, c().open, n), s(t, c().withHighlight, u), t)),
        ...
        396043: (e, t, n) => {
            ...
            function w(e) {
                ...
                if (null != r) {
                    ...
                    n = l.Ec.has(e.type) && null != e.parent_id ? o(a.Z.getChannel(e.parent_id)) : o(e)
                }
                return {
                    channel_id: e.id,
                    channel_type: e.type,
            ...
            function D(e) {
                ...
                if (!y.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== g.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        l = a.Z.getChannel(i),
                        u = L(l, o),
                        c = C({}, t, P(u), null != o && null != i && (0, S.AB)(i) ? A(0, i) : w(l));
                    y.default.track(e, c, {
                        flush: n
                    })
                }
            ...
            function U(e, t, n) {
                ...
                o()(T.Z.getVoiceStates(e)).filter((function(e) {
            ...
            function j(e, t) {
                ...
                o()(T.Z.getVoiceStates(e)).forEach((function(e) {
        ...
        761673: (e, t, n) => {
            ...
            function l(e) {
                ...
                if (l) {
                    var a;
                    u = null !== (a = e instanceof o.Z ? e.premiumSubscriberCount : e.premiumSubscriptionCount) && void 0 !== a ? a : 0
                }
                var c = e instanceof o.Z ? e.premiumTier : i.Eu4.NONE;
                return {
        ...
        733274: (e, t, n) => {
            ...
            var T = n(2590),
                ...
                h = function() {
                    ...
                    return {
                        color: e,
                        icon: u.Z,
                        description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_ANIMATED_ICON
                    }
                },
                v = function() {
                    return {
                        ...
                        icon: a.Z,
                        description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_ROLE_ICON
                    }
                },
                g = function() {
                    ...
                    return {
                        color: e,
                        icon: p.Z,
                        description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_STICKERS
                    }
                },
                S = function(e) {
                    ...
                    return {
                        color: t,
                        icon: p.Z,
                        description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_STICKERS_AND_EMOJIS.format({
                            numStickers: n,
                            numEmojis: o
                        })
                    }
                ...
                m = function() {
                    return {
                        ...
                        icon: f.Z,
                        description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_VANITY_URL
                    }
                },
                C = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_OTHER;
                    return {
                ...
                R = function() {
                    ...
                    return {
                        color: e,
                        icon: s.Z,
                        description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_SCREEN_SHARE_1080P
                    }
                };
            ...
            function P() {
                return [v(), {
                    ...
                    icon: c.Z,
                    description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_GUILD_BANNER
                }, g(), C()]
            }

            function A() {
                return [v(), S(T.Eu4.TIER_2), R(), C()]
            }
            ...
            function N() {
                return [S(T.Eu4.TIER_3, r.Z.unsafe_rawColors.PREMIUM_PERK_GREEN.css), {
                    ...
                    icon: b,
                    description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_FILE_UPLOAD_TIER_3
                }, m(), C()]
            }
            ...
            function w() {
                return [m(), {
                    color: r.Z.unsafe_rawColors.PREMIUM_PERK_GREEN.css,
                    icon: u.Z,
                    description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_ANIMATED_GUILD_BANNER
                }, S(T.Eu4.TIER_3), C()]
            }
            ...
            function M() {
                return [{
                    color: r.Z.unsafe_rawColors.PREMIUM_PERK_GREEN.css,
                    icon: c.Z,
                    description: y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_UPSELL_PERKS_CUSTOM_INVITE
                }, g(), h(), C()]
            }
            ...
            function D() {
                return [{
                    ...
                    description: y.Z.Messages.PREMIUM_GUILD_USER_FEATURE_BOOST_CRYSTAL
                }, {
                    icon: a.Z,
                    color: r.Z.unsafe_rawColors.PREMIUM_PERK_YELLOW.css,
                    description: y.Z.Messages.PREMIUM_GUILD_USER_FEATURE_SPECIAL_ROLE
                }, {
                    icon: o.Z,
                    description: y.Z.Messages.PREMIUM_GUILD_USER_FEATURE_PROFILE_BADGE
                }, {
                    color: r.Z.unsafe_rawColors.PREMIUM_PERK_BLUE.css,
                    icon: i.Z,
                    description: y.Z.Messages.PREMIUM_GUILD_USER_FEATURE_OTHERS
                }]
            }
        },
        275086: (e, t, n) => {
        ...
        596801: (e, t, n) => {
            ...
            function _(e, t) {
                var c = null != t ? t : "".concat(a.jXE.PREMIUM_GUILD_UPSELL_MODAL);
                null != e.targetBoostedGuildTier && (c += " - Tier ".concat(e.targetBoostedGuildTier));
                u.default.track(a.rMx.OPEN_MODAL, {
                    type: c,
                    location: e.analyticsSourceLocation
                });
                var _ = e.openInPopoutEnabled,
                    E = p(e, ["openInPopoutEnabled"]),
                    O = i.Z.getWindowOpen(a.KJ3.CHANNEL_CALL_POPOUT) && null != _ && _;
                O && (0, l.Z)(a.KJ3.CHANNEL_CALL_POPOUT);
                ...
                (0, o.openModalLazy)(s((function() {
                    ...
                    onCloseCallback: function() {
                        u.default.track(a.rMx.MODAL_DISMISSED, {
                            type: c,
                            location: e.analyticsSourceLocation
                        })
                    },
        ...
        393299: (e, t, n) => {
            ...
            var I, b = (O(r = {}, d.Eu4.NONE, E().iconBackgroundTierNone), O(r, d.Eu4.TIER_1, E().iconBackgroundTierOne), O(r, d.Eu4.TIER_2, E().iconBackgroundTierTwo), O(r, d.Eu4.TIER_3, E().iconBackgroundTierThree), r),
                T = (O(I = {}, d.Eu4.NONE, E().iconTierNone), O(I, d.Eu4.TIER_1, E().iconTierOne), O(I, d.Eu4.TIER_2, E().iconTierTwo),
                    O(I, d.Eu4.TIER_3, E().iconTierThree), I);
            ...
            function y(e) {
                ...
                return (0, o.jsx)(f.Z, {
                    ...
                    children: (0, o.jsx)(p.Z, {
                        tier: t,
                        className: l()(r, E().boostedGuildIconGem, T[t])
                    })
                })
            }
            var h = n(21372),
            ...
            function w(e) {
                ...
                return (0, o.jsx)("div", {
                    ...
                    children: (0, o.jsx)(a.Tooltip, {
                        ...
                        "aria-label": null != p ? p : "",
                        children: function(e) {
                            return (0, o.jsx)(a.Clickable, N(function(e) {
                                for (var t = 1; t < arguments.length; t++) {
                                    var n = null != arguments[t] ? arguments[t] : {},
                                        r = Object.keys(n);
                                    "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            function L(e) {
                var t = e.guild,
                    n = e.isBannerVisible,
                    r = e.disableBoostClick;
                return (0, c.Z)(t) ? (0, o.jsx)(M, {
                    guild: t,
                    disableColor: !1,
                    disableBoostClick: r
                }) : t.hasFeature(d.oNc.VERIFIED) || t.hasFeature(d.oNc.PARTNERED) ? (0, o.jsx)(M, {
                    guild: t,
                    disableColor: !n
                }) : (0, o.jsx)(w, {
                    guild: t,
        ...
        17363: (e, t, n) => {
            ...
            const C = function(e) {
                var t = e.file,
                    ...
                    q = Q[0],
                    $ = Q[1],
                    ee = (0, a.Z)(u.Z.IMAGE_CROPPING_MODAL).AnalyticsLocationProvider,
                    te = o.useRef({
                        x: 0,
                        y: 0
                    }),
                ...
                var ie, le, ue = function() {
                    ...
                    ae = o.useCallback((function(e, t, n) {
                    ...
                    pe = (le = (ie = function() {
                        ...
                        return m(this, (function(a) {
                            switch (a.label) {
                                ...
                                case 2:
                                    o = a.sent(), i = o.result, l = o.cancelFn;
                                    re.current = l;
                                    return [4, i];
                                case 3:
                                    r = a.sent();
                        ...
                        children: [w && (0, r.jsx)(c.Z, {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)("img", {
                                    ...
                                    className: A === _.pC.AVATAR ? T().overlayAvatar : T().overlayBanner,
                                    style: {
                                        opacity: null == X ? 0 : 1,
                                        width: D.width,
                                        height: D.height
                                    ...
                                    asValueChanges: function(e) {
                                        if (null != X) {
                                            var t = X.width,
                                                ...
                                                l = o.x,
                                                u = o.y;
                                            (0, i.inRange)(l, r.right, r.left) && (0, i.inRange)(u, r.top, r.bottom) || ae(l, u, r);
                                            F(e);
                                            G(r)
                                        }
                                    },
        ...
        311260: (e, t, n) => {
            ...
            function f() {
                return (f = l((function(e, t, r, i, l) {
                    ...
                    return u(this, (function(u) {
                        switch (u.label) {
                            case 0:
                                s = c(t, r, i, l), f = s.x, p = s.y, d = s.scaledCropWidth, _ = s.scaledCropHeight;
            ...
            function p(e, t, n, r) {
                ...
                null != d && d.drawImage(e, i, l, u, a, 0, 0, p.width, p.height);
        ...
        338479: (e, t, n) => {
            ...
            function b(e) {
                var t = e.analyticsSection,
                    ...
                    y = (0, u.Z)().analyticsLocations;
                if (null == T || T.hasFeature(d.oNc.ANIMATED_BANNER) || !o && T.hasFeature(d.oNc.BANNER)) return null;
                return (0, r.jsxs)("div", {
            ...
            function j(e) {
                var t = e.analyticsSection,
                    n = e.type,
                    a = (0, i.e7)([A.default], (function() {
                        return A.default.getCurrentUser()
                    })),
                    c = w.ZP.canUseAnimatedAvatar(a),
                    s = w.ZP.canUsePremiumProfileCustomization(a),
                    f = n === M.pC.BANNER && s || n === M.pC.AVATAR && c,
                    p = (0, u.Z)(T.Z.PREMIUM_PREVIEW_UPSELL_HEADER).sourceAnalyticsLocations;
                o.useEffect((function() {
                ...
                return (0, r.jsx)(R, {
                    ...
                    className: U().nitroPreviewUpsell,
            ...
            function x(e) {
                var t = e.type,
                    ...
                    i = e.isGIF,
                    l = e.banner;
                return [M.pC.BANNER, M.pC.AVATAR].includes(t) && i ? (0, r.jsx)(j, {
                    analyticsSection: o,
                    type: t
                }) : t === M.pC.GUILD_BANNER ? (0, r.jsx)(b, {
                    analyticsSection: o,
                    analyticsPage: n,
                    isGIF: i,
                    banner: l
            ...
            const g = new v(o.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(e) {
                    ...
                    l.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == t ? void 0 : t.sku_id) === u.Si.TIER_2 && null == i.Z.getPremiumSubscription(!1) && null == b.tutorialExpirationTime && y()
                }
            })
        },
        156620: (e, t, n) => {
        ...
        305082: (e, t, n) => {
            ...
            function C() {
                return e = m, t = S, n = y("useMemoizedValueSyncedWithDismissibleContents"), i = (0, o.e7)([a.Z], (function() {
                    var e;
            ...
            const L = function(e) {
                var t = function(e) {
                        ...
                        return (0, r.jsxs)(I.C, N(A({
                            ...
                            children: [H && (0,
                                ...
                                children: null !== (n = null !== (t = null == ie ? void 0 : ie.disabledButtonText) && void 0 !== t ? t : j) && void 0 !== n ? n : ee
                            })]
                        }))
                    },
                    o = e.isGift,
                        ...
                        if (null != X) {
                            ...
                            if ((null == Q ? void 0 : Q.status) !== v.O0b.ACCOUNT_HOLD) ! function(e) {
                                ...
                                if (t)
                                    if (o) {
                                        var O = v.Qqv.BUY;
                                        null != a ? O = v.Qqv.TRIAL : i && (O = v.Qqv.GIFT);
                                        (0, f.Z)({
                                            isGift: i,
                                            initialPlanId: null,
                                            subscriptionTier: l,
                                ...
                                (0, s.A3)();
                                a.Z.open(v.oAB.PREMIUM);
                                null == B || B(!1)
                            }
                        } else(0, p.uL)(v.Z5c.LOGIN)
                    };
                if (U) return (0, r.jsxs)(u.Button, N(A({
                    size: P,
                    className: L,
                    innerClassName: m().premiumSubscribeButton,
                    ...
                    children: [H && (0, r.jsx)(T.Z, {
                        ...
                        className: i()(m().buttonText, x),
                        children: null != j ? j : g.Z.Messages.PREMIUM_TRIAL_CTA_BUTTON_VARIANT
                    })]
                }));
                if (o) return (0, r.jsxs)(u.Button, N(A({
                    ...
                    children: [(0, r.jsx)(b.Z, {
                        ...
                        className: i()(m().buttonText, x),
                        children: null != j ? j : g.Z.Messages.PREMIUM_GIFTING_BUTTON
                    })]
                }));
                var ee = g.Z.Messages.APPLICATION_STORE_GET_PREMIUM,
                    te = null != Q ? (0, y.Af)(Q) : null,
                    ne = null != te ? y.ZP.getPremiumType(te.planId) : null == X ? void 0 : X.premiumType,
        ...
        491260: (e, t, n) => {
            ...
            function j(e) {
                ...
                if (r === p.Skl.OFFLINE) u[t] = {
                    ...
                    var a = l.length > 1 ? y(l).sort(L) : l,
                        c = u[t];
                    l = null != c && o()(c.activities, a) ? c.activities : a;
                    u[t] = {
                        status: r,
                        clientStatus: i,
                        activities: l,
                    ...
                    try {
                        for (var i, l = Object.keys(R)[Symbol.iterator](); !(n = (i = l.next()).done); n = !0) {
                            var u = i.value,
                                ...
                                f = void 0;
                            try {
                                for (var p, d = a[Symbol.iterator](); !(c = (p = d.next()).done); c = !0) {
                                    var _ = p.value;
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                var t, n, r, o, i, l, c = u.default.getCurrentUser();
                if (null == c) return U();
            ...
            var x = function(e) {
                ...
                r.hasChanges = function() {
                    return null != m && null != S && (!(!this.isOpen() && P !== a.cII.USER_SETTINGS) && !o().isEqual(m, S))
                };
                r.isOpen = function() {
                    return C
                };
            ...
            const G = new x(l.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    P = e.tab;
                    return null == y && P === a.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        521723: (e, t, n) => {
            ...
            function V(e) {
                var t = e.badgeType,
                    n = e.guildTraits,
                    o = function(e, t) {
                        var n = t === f.PZ.PUBLIC ? U.Z.Messages.SERVER_BADGE_DESCRIPTION_ANYONE_CAN_JOIN : U.Z.Messages.SERVER_BADGE_DESCRIPTION_INVITE_ONLY;
                        switch (e) {
                            case s.Q.STAFF:
                                return {
                            ...
                            case s.Q.VERIFIED:
                                return {
                                    tooltipTitle: U.Z.Messages.SERVER_BADGE_TITLE_COMMUNITY, tooltipSubtitle: U.Z.Messages.GUILD_VERIFIED, tooltipDescription: n
                                };
                            case s.Q.PARTNERED:
                                return {
                                    tooltipTitle: U.Z.Messages.SERVER_BADGE_TITLE_COMMUNITY, tooltipSubtitle: U.Z.Messages.GUILD_PARTNERED, tooltipDescription: n
                                };
                            case s.Q.VERIFIED_AND_PARTNERED:
                                return {
                                    tooltipTitle: U.Z.Messages.SERVER_BADGE_TITLE_COMMUNITY, tooltipSubtitle: U.Z.Messages.GUILD_VERIFIED_AND_PARTNERED, tooltipDescription: n
                                };
                            case s.Q.COMMUNITY:
                                return {
            ...
            function F(e) {
                var t = e.guild,
                    n = e.tooltipColor,
                    o = void 0 === n ? c.Tooltip.Colors.BRAND : n,
                    i = e.tooltipPosition,
                    u = e.className,
                ...
                var N, w, M = k[A],
                    L = M.IconComponent,
                    U = M.backgroundDarkColor,
                    j = M.backgroundLightColor,
                    G = M.foregroundDarkColor,
                    H = M.foregroundLightColor,
                    F = M.premiumBackgroundColor,
                    K = M.premiumForegroundColor;

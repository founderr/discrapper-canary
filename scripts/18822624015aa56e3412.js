    ...
    [74968, 88110, 96043], {
            ...
            const O = {
                ...
                saveAccountChanges: function(t, e) {
                    ...
                    return (0, h.Z)((function(t) {
                        ...
                        checkEnabled: !1,
                        modalProps: {
                            title: v.Z.Messages.TWO_FA_CHANGE_ACCOUNT
                        },
                        hooks: {
                ...
                var e = t.channelId,
                    ...
                    p = E({
                        onSuccess: i.useCallback((function() {
                            a.Z.pop();
                            (0, l.showToast)((0, l.createToast)(I.Z.Messages.OBSCURED_CONTENT_MARK_FALSE_POSITIVE_SUCCESS, l.ToastType.CUSTOM));
                            s()
                        }), [s]),
                        onError: function() {
        ...
        223219: (t, e, n) => {
            ...
            function L(t) {
                ...
                null != t.scrollPosition && null != O && (m[O] = t.scrollPosition);
            ...
            var U = function(t) {
                ...
                r.getProps = function() {
                    return {
                        submitting: b === a.QZA.SUBMITTING,
                        section: O,
                        subsection: null != O ? S[O] : null,
                        scrollPosition: null != O ? m[O] : null,
                        settings: I,
                        errors: g,
            ...
            const Z = new U(u.Z, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(t) {
                    if (b !== a.QZA.SUBMITTING) return !1;
                    b = a.QZA.OPEN;
                    O = a.oAB.ACCOUNT;
                    var e;
                    g = null !== (e = t.errors) && void 0 !== e ? e : {}
                },
                ...
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(t) {
                    var e = t.forSection;
                    null != e ? delete m[e] : null != O && delete m[O]
                },

    ...
    ["7840"], {
        ...
        208548: function(e, t, n) {
            ...
            function h(e) {
                let {
                    ...
                    emojiId: h,
                    emojiName: N
                }), v = (0, o.useStateFromStores)([E.default], () => null != n ? E.default.getDefaultChannel(n) : null), O = r.createRef(), M = (0, d.default)(O), L = e => (t, n) => {
                    let i = (null == t ? void 0 : t.id) == null;
                    i ? g(null == t ? void 0 : t.optionallyDiverseSequence) : (A && g(null == t ? void 0 : t.name), R(null == t ? void 0 : t.id)), n && e()
                }, P = e => {
                    e.stopPropagation(), g(void 0), R(void 0)
                };
        ...
        26092: function(e, t, n) {
            ...
            function m(e) {
                ...
                if (null == c) return v();
                d = null !== (t = e.section) && void 0 !== t ? t : d, R = null !== (n = e.section) && void 0 !== n ? n : d, null != e.subsection && null != d && (f[d] = e.subsection), null != e.scrollPosition && null != d && (E[d] = e.scrollPosition), S = !!e.openWithoutBackstack, s = u.FormStates.OPEN, _ = {}, I = {
                    ...T = {
                ...
                }, N = null !== (i = e.onClose) && void 0 !== i ? i : null, C = null !== (r = e.analyticsLocation) && void 0 !== r ? r : null, A = null !== (l = e.analyticsLocations) && void 0 !== l ? l : [], g = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }

            function v() {
                s = u.FormStates.CLOSED, p = !1, T = null, R = null, I = null, c = null, d = null, f = {}, E = {}, N = null, C = null, A = [], g = null
            }
            ...
            var L = new M(a.default, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return h = e.tab, null == d && h === u.DrawerTabTypes.USER_SETTINGS && m({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
            ...
            let d = e => {
                ...
                switch (r) {
                    ...
                    case u.BotTagTypes.OFFICIAL:
                        f = !0, p = s.default.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP, I = s.default.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    ...
                    case u.BotTagTypes.AI:
                        f = !0, p = s.default.Messages.AI_GENERATED_TOOLTIP, I = s.default.Messages.AI_TAG;
                        break;
                ...
                let S = r === u.BotTagTypes.ORIGINAL_POSTER,
        ...
        882641: function(e, t, n) {
            ...
            var h = function(e) {
                let {
                    ...
                    "aria-controls": C,
                    focusProps: A
                } = e, [R, g] = r.useState(!1), [m, v] = r.useState(0), O = (0, u.useStateFromStores)([E.default], () => E.default.getGuildId()), M = R || h, L = (0, _.getClass)(p, "emojiButton", M ? "Hovered" : "Normal"), P = function(e) {
                    ...
                    g(!0), v(e), (0, d.maybeFetchTopEmojisByGuild)(O), (0, f.maybeGetPacksForUser)("emoji button - mouse enter"), (0, c.maybeGetEmojiCaptionsForUser)("emoji button - mouse enter")
                }, [M, g, v, O]), D = r.useCallback(() => {
                    g(!1)
                }, [g]), y = r.useCallback(() => {

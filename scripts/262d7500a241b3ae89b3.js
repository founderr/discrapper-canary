(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["88953"], {
                ...
                (0, s.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                b = !0, null == v || v(), !_ && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: C,
                            analyticsLocations: E,
                            analyticsObject: m,
                    ...
                    onCloseCallback: () => {
                        !b && c.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: w,
                            ...
                            application_id: R,
                            location_stack: E
                        }), (0, r.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == p || p(b), b && (!_ && u.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == C || C())
                    },
        ...
        374278: function(e, t, n) {
            ...
            function m(e) {
                ...
                let n, {
                    ...
                    _ = r.default.getGuild(m.guild_id),
                    L = null !== (t = null == _ ? void 0 : _.maxStageVideoChannelUsers) && void 0 !== t ? t : 0,
                    S = !!(null == _ ? void 0 : _.isCommunity()),
                    M = C.default.Messages.STAGE_FULL_TITLE,
                    x = S ? L < p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED : (null == _ ? void 0 : _.premiumTier) !== p.BoostedGuildTiers.TIER_3 && L <= p.MAX_STAGE_VIDEO_USER_LIMIT_TIER2,
                    A = a.default.can(h.MODERATE_STAGE_CHANNEL_PERMISSIONS, m);
                n = S && (null == _ ? void 0 : _.premiumTier) === p.BoostedGuildTiers.TIER_3 ? L <= p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED ? C.default.Messages.STAGE_FULL_BOOST_MORE_BODY : C.default.Messages.STAGE_FULL_MAX_BODY : x ? C.default.Messages.STAGE_FULL_BODY : C.default.Messages.STAGE_FULL_MAX_BODY;
                let R = () => {
                        g(), u.default.track(p.AnalyticEvents.BOOSTING_UPSELL_CLICKED, {
                            guild_id: m.guild_id,
                    ...
                    N = d.default.getMutableParticipants(m.id, f.StageChannelParticipantNamedIndex.SPEAKER),
                    T = N.filter(e => e.type === f.StageChannelParticipantTypes.VOICE),
                    y = T.length,
                    b = d.default.getParticipantCount(m.id, f.StageChannelParticipantNamedIndex.AUDIENCE);
                    ...
                    children: [(0, i.jsxs)(l.ModalHeader, {
                        ...
                        children: x ? (0, i.jsxs)(i.Fragment, {
                            children: [(0, i.jsx)(l.Button, {
                                ...
                                onClick: () => {
                                    g(), (0, s.openGuildBoostingMarketingModal)({
                                        guildId: m.guild_id,
                                        location: {
        ...
        476263: function(e, t, n) {
            ...
            class g extends l.PureComponent {
                ...
                renderIcon() {
                    ...
                    let {
                        ...
                        "aria-hidden": S,
                        ...M
                    } = this.props, x = I[o], A = null != v ? u.Clickable : "div";
                    return (0, i.jsxs)(A, {
            ...
            let _ = o.default.connectStores([f.default], e => {
                let {
                    guild: t,
                    animate: n,
                    iconSrc: i,
                ...
                return {
                    style: {
                        ...l,
                        backgroundImage: (0, h.makeCssUrlString)(null != i ? i : t.getIconURL(m[s], n && f.default.isFocused()))
                    }
                }
            })((0, d.backgroundImagePreloader)(e => (0, i.jsx)(g, {
                ...e
            })));
        ...
        181114: function(e, t, n) {
            ...
            let E = e => {
                let {
                    ...
                    onlyShineOnHover: v,
                    ...E
                } = e, m = r.createRef(), I = (0, d.default)(m), g = !i && !l && !0 !== a && (!v || I);
                return (0, s.jsxs)(u.Button, {
                    ...
                    children: [t, g ? (0, s.jsx)(C, {
                        shinePaused: f,
                        className: o(h.buttonShine, v ? h.onlyShineOnHover : void 0, p),
                        shineSize: c
                    }) : null]
                })
            };
        ...
        708169: function(e, t, n) {
            ...
            function I(e) {
                ...
                return (0, f.useFocusLock)(n), r.useEffect(() => (h.default.disable(), h.default.enableTemp(function(e) {
                    return {
                        POP_LAYER: {
                            binds: ["esc"],
            ...
            let g = {
                ...
                _ = {
                    enter: C.enterReducedMotion,
                    enterActive: C.enterActiveReducedMotion,
                    enterDone: C.enterDoneReducedMotion,
                    exit: C.exitReducedMotion,
                    exitActive: C.exitActiveReducedMotion,
                    exitDone: C.exitDoneReducedMotion
                };

            function L() {
                let {
                    reducedMotion: e
                } = r.useContext(f.AccessibilityPreferencesContext), t = e.enabled, n = t ? _ : g, i = m(e => e.fullScreenLayers);
                return (0, s.jsx)(c.TransitionGroup, {
                    children: i.map(e => (0, s.jsx)(c.CSSTransition, {
                        classNames: n,
                        timeout: E,
                        onEntered: () => {
                            m.setState({
            ...
            function S(e) {
                ...
                return m.setState(t => ({
                    fullScreenLayers: [...t.fullScreenLayers, {
                        key: l,
                        transitionState: 1,
                        LayerComponent: null != i ? i : v.default,
                        render: e
                    }]
                })), l
            }

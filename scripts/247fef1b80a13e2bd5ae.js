    ...
    ["99220"], {
        ...
        485261: function(e, t, n) {
            ...
            function I(e) {
                ...
                l.useEffect(() => ((0, c.startEditingClydeProfile)(), () => {
        ...
        879253: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    settings: n
                } = e, [_, I] = l.useState(!1), [C, g] = l.useState(), {
                ...
                })), [T, N] = l.useState(), R = null != v && C === v, M = null != S && Number(S.code) === E.AbortCodes.CLYDE_UNSAFE_PERSONALITY ? S.message : void 0, A = R ? p.default.Messages.CLYDE_GENERATE_PERSONALITY_UNDO : p.default.Messages.CLYDE_GENERATE_PERSONALITY_HINT;
                return (0, i.jsxs)(a.default, {
                    ...
                    children: [(0, i.jsxs)(s.FormText, {
                        ...
                        children: [(0, i.jsx)(s.Button, {
                            ...
                            onClick: () => {
                                if (R && null != T) {
                                    (0, d.setPendingPersonality)(T), N(void 0);
                                    return
                                }
                                null != v && "" !== v.trim() && (c.default.track(E.AnalyticEvents.CLYDE_AI_GENERATE_PERSONALITY_CLICKED, {
                                    guild_id: n.guild_id
                                }), I(!0), (0, d.generatePersonality)(v).then(e => {
                                    null != e && (N(v), g(e), (0, d.setPendingPersonality)(e, !0)), I(!1)
                                }))
                            },
        ...
        709594: function(e, t, n) {
            ...
            function S(e) {
                ...
                } = (0, s.useStateFromStoresObject)([_.default], () => _.default.getPendingUpdates()), d = (0, s.useStateFromStores)([p.default], () => p.default.getUser(I.CLYDE_AI_USER_ID));
            ...
            var f = {
                openMemberVerificationModal(e, t) {
                    ...
                    (0, l.openModalLazy)(async () => {
                        ...
                        onCloseRequest: () => {
                            c(), a.useMemberVerificationFormNoticeStore.getState().hasUnsubmittedChanges ? (0, a.setShowWarning)(!0) : (0, l.closeModal)(o.IN_APP_MEMBER_VERIFICATION_MODAL_KEY)
                        },
                        onCloseCallback: t
                    })
                },
                closeMemberVerificationModal() {
                    let e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                    !e && c(), (0, l.closeModal)(o.IN_APP_MEMBER_VERIFICATION_MODAL_KEY)
                }
            }
        },
        608684: function(e, t, n) {
            ...
            class m extends l.PureComponent {
                ...
                render() {
                    ...
                    let b = null !== (e = null != U ? U : o) && void 0 !== e ? e : h.default.Messages.CHANGE_AVATAR;
                    return (0, i.jsxs)("div", {
                        className: s(E.imageUploader, S),
                        children: [(0, i.jsx)(u.FocusRing, {
                            within: !0,
                            children: (0, i.jsxs)("div", {
                                className: g ? s(E.imageUploaderIconWrapper, R) : void 0,
                                children: [(0, i.jsxs)("div", {
                                    className: s(E.imageUploaderInner, T),
                                    style: {
                                        ...L,
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !O && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: A,
                            location_stack: _
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == E || E(O), O && (!v && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == m || m())
                    },
        ...
        716849: function(e, t, n) {
            ...
            function m(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), i = d.default.shouldFetchPremiumLikelihood(), l = o.default.getCurrentUser();
                I(l, i, t, n)
            }
            ...
            function _(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), r = (0, l.default)([d.default], () => d.default.shouldFetchPremiumLikelihood()), s = (0, l.default)([o.default], () => o.default.getCurrentUser());
                i.useEffect(() => {
                    I(s, r, t, n)
                }, [s, r, t, n])
            }
        ...
        409214: function(e, t, n) {
            ...
            function C(e) {
                let {
                    ...
                    colorPickerFooter: T,
                    showEyeDropper: N
                } = e, R = l.useRef(null), M = (0, c.useToken)(u.default.colors.BACKGROUND_PRIMARY).hex(), A = u.default.colors.BACKGROUND_ACCENT.css, L = (0, p.isColorDark)(r), x = (0, o.int2hex)(r), P = x === M ? A : x, O = (0, f.getColor)(L ? m.Color.WHITE_500 : m.Color.PRIMARY_530), y = (0, d.default)(S), U = (0, d.default)(T), [b, w] = l.useState((0, a.v4)());
                return l.useEffect(() => {
                    (y !== S || U !== T) && w((0, a.v4)())
                }, [T, S, U, y]), (0, i.jsx)(c.Popout, {
                    positionKey: b,
                ...
                return (0, i.jsx)(u.default, {
                    ...
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(S, {
                            ...
                            onClick: () => (0, o.handleOpenSelectImageModal)(c.UploadTypes.AVATAR, m, C, C ? h : void 0),
                            ...
                            size: s.Button.Sizes.SMALL,
                            onClick: () => l(null),
                            children: null != m ? d.default.Messages.USER_SETTINGS_RESET_AVATAR : d.default.Messages.USER_SETTINGS_REMOVE_AVATAR
                        })]
                    })
                })
            }
                ...
                return (0, i.jsx)("div", {
                    ...
                    children: (0, i.jsxs)(d.default, {
                        ...
                        children: [(0, i.jsxs)(a.FormTitle, {
                            className: h.title,
                            id: l,
                            children: [t, N && (0, i.jsx)(c.default, {}), n]
        ...
        121370: function(e, t, n) {
            ...
            function I(e) {
                let {
                    ...
                    forcedDivider: T
                } = e, N = (0, d.default)(t.id, C), [R, M] = (0, f.default)(t, N, {
                    pendingThemeColors: l,
                    isPreview: !0
                }), A = h.default.canUsePremiumProfileCustomization(t), L = null != n ? n : t.getAvatarURL(C, 80), x = (0, u.useToken)(o.default.unsafe_rawColors.PRIMARY_530).hex(), P = (0, c.useAvatarColors)(L, x, !1);
                ...
                return (0, i.jsx)(p.default, {
                    ...
                    disabled: !A && !I,
                    className: r(_.profileThemesSection, g),
                    showPremiumIcon: v,
                    forcedDivider: T,
                    children: (0, i.jsxs)("div", {
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: _,
                    ...I
                } = e, C = s.createRef(), g = (0, d.default)(C), v = !i && !a && !0 !== u && (!_ || g);

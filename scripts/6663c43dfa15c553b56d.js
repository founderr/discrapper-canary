        ...
        273523: (e, t, n) => {
            ...
            const S = function(e) {
                var t = e.captchaService,
                    ...
                    d = e.onClose,
                    u = e.onChalExpired,
                    h = j(e, ["captchaService", "sitekey", "rqdata", "onRender", "onVerify", "onError", "onOpen", "onClose", "onChalExpired"]),
                    v = a.useRef(null),
                    g = b().v4(),
                    w = k(a.useState(!1), 2),
                    S = w[0],
                    ...
                    A = a.useCallback((function(e) {
                        O.default.track(R.rMx.CAPTCHA_EVENT, {
                ...
                null != i && "" !== i || (i = R.OL7);
                return n === C.hP.RECAPTCHA ? (0, r.jsx)(y.Z, _(x({}, h), {
                    onLoad: T,
                    onRender: M,
                    onVerify: N,
                    onError: L,
                    sitekey: i
                })) : n === C.hP.HCAPTCHA ? (0, r.jsx)(f, _(x({
                    ref: v
                }, h), {
                    sitekey: i,
                    onLoad: T,
            ...
            var H = new Set([i.ModalTransitionState.ENTERING, i.ModalTransitionState.ENTERED]);
            ...
            function z(e) {
                var t = e.onClose,
                    ...
                    p = e.bodyText,
                    l = e.rqtoken,
                    d = q(e, ["onClose", "onCaptchaVerify", "onReject", "transitionState", "headerText", "bodyText", "rqtoken"]),
                    u = function(e) {
                        var t = a.useRef(!0);
                        a.useEffect((function() {
                            return function() {
                        ...
                        a.useEffect((function() {
                            ...
                            return function() {
                                t.current && O.default.track(R.rMx.MODAL_DISMISSED, {
                                    type: "Guild Join Captcha"
                                })
                            }
                        }), [t]);
                ...
                a.useEffect((function() {
                    P.S.subscribe(R.CkL.LAYER_POP_ESCAPE_KEY, t)
                }), [t]);
                return null != c && H.has(c) ? (0, r.jsx)(i.ModalRoot, {
                    transitionState: c,
                    "aria-label": "CAPTCHA",
                    className: D().modal,
                        ...
                        children: [(0, r.jsx)(i.ModalCloseButton, {
                            ...
                            children: c !== i.ModalTransitionState.ENTERED ? (0, r.jsx)(i.Spinner, {
                                ...
                                children: [(0, r.jsx)("div", {
                                    ...
                                    className: D().title,
                                    "aria-hidden": !0,
                                    children: null != s ? s : I.Z.Messages.GENERIC_CAPTCHA_HEADER
                                }), (0, r.jsx)("div", {
                                    children: null != p ? p : I.Z.Messages.GENERIC_CAPTCHA_DESCRIPTION
                                }), (0, r.jsx)("div", {
                                    className: D().captchaContainer,

    ...
    ["66484"], {
        ...
        284016: function(e, t, n) {
            ...
            function l() {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a.default,
                    t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : s.default;
            ...
            var C = e => {
                let {
                    ...
                    if (null != n) try {
                        ...
                        if (e.guild) null == l || l(), (0, _.transitionTo)(E.Routes.CHANNEL(e.guild.id))
                    } catch (e) {
                        T(new u.APIError(e))
                    }
        ...
        42963: function(e, t, n) {
            ...
            let _ = (0, a.default)((e, t) => ({
                ...
                activeFlow: () => {
                    var e;
                    let n = null !== (e = t().currentFlow) && void 0 !== e ? e : s.default.get(c);
                    if (null == n) return null;
                    let {
                        [n]: a
                    } = t().flows, l = null != a ? a : u(n);
            ...
            function N(e, t) {
                let {
                    [e]: n, ...a
                } = _.getState().flows, s = null != n ? n : u(e);
            ...
            function E(e, t) {
                ...
                if (e === r.FlowType.ANY) {
                    var s;
                    a = null !== (s = _.getState().activeFlow()) && void 0 !== s ? s : r.FlowType.UNKNOWN
                }
                let {
                    [a]: l, ...i
            ...
            _.subscribe(e => {
                ...
                if (null != e && (! function(e) {
                        ...
                        e.ended ? (s.default.remove(t), s.default.remove(c)) : (s.default.set("".concat(d, "-").concat(e.type), {
                            ...e,
                            version: 1

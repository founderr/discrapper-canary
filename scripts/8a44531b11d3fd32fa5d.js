    ...
    ["64594"], {
        ...
        333805: function(e, t, n) {
            ...
            var r = n("872717"),
                i = n("49111"),
                o = n("782340");
            class s extends r.default.V6OrEarlierAPIError {
                constructor(e, t) {
        ...
        312165: function(e, t, n) {
            ...
            let a = [],
                u = (e, t, n) => {
                    ...
                    (e !== l.KeyboardDeviceTypes.MOUSE_BUTTON || n !== r) && a.forEach(r => r._handleEvent(e, t, n))
                };
            class c extends r.EventEmitter {
                destroy() {
                    this.removeAllListeners(), 0 === (a = a.filter(e => e !== this)).length && o.default.setOnInputEventCallback(null)
                }
                toString() {
                    return (0, s.toString)(this.combo)
                }
                _handleEvent(e, t, n) {
                    0 === t ? this.combo = this.combo.filter(t => {
                        let [r, i] = t;
                        return !(r === e && i === n)
                    }) : (this.combo.push([e, n, (0, s.getEnv)()]), this.emit("change", this))
                }
                constructor() {
                    super(), this.combo = [], a.push(this), 1 === a.length && o.default.setOnInputEventCallback(u)
                }
            }
        },
        ...
        866353: function(e, t, n) {
            ...
            let c = (e, t, n) => {
                    ...
                    let r = s.default.canUseStickersEverywhere(t);
                    ...
                    if ((0, a.isGuildSticker)(e) && null != n) return e.available ? null != n.guild_id && "" !== n.guild_id && n.guild_id === e.guild_id ? i.SENDABLE : null == n.guild_id || o.default.can({
        ...
        3958: function(e, t, n) {
            ...
            class I extends s.PureComponent {
                ...
                componentDidUpdate(e) {
                    ...
                    t === r.DEFAULT && i.current === o && i.current.blur(), t === r.RECORDING && i.current !== o && i.current.focus()
                }
                render() {
                    let e;
                    let {
                        ...
                        value: n,
                        disabled: i
                    } = this.props, s = (0, p.toString)(n, !0);
                    e = t === r.RECORDING ? _.default.Messages.SHORTCUT_RECORDER_BUTTON_RECORDING : 0 === n.length ? _.default.Messages.SHORTCUT_RECORDER_BUTTON : _.default.Messages.SHORTCUT_RECORDER_BUTTON_EDIT;
                    let l = t === r.DEFAULT && n.length > 0;

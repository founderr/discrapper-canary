        ...
        768596: function(e, t, n) {
            ...
            function h(e) {
                ...
                let {
                    ...
                    welcomeMessage: s,
                    className: h
                } = e, L = (0, c.default)(), R = (0, d.default)([S.default], () => S.default.getGuild(n)), p = (0, d.default)([N.default], () => N.default.syncProfileThemeWithUserTheme), x = (0, d.default)([N.default], () => N.default.useReducedMotion), P = (0, d.default)([m.default], () => m.default.getUser(null == s ? void 0 : s.authorIds[0])), M = (0, d.default)([m.default], () => m.default.getCurrentUser()), U = (0, E.default)(null == P ? void 0 : P.id, n), [v] = (0, f.default)(P, U), C = p ? L : null !== (t = (0, _.getProfileTheme)(v)) && void 0 !== t ? t : L, B = (0, o.useToken)(o.tokens.colors.BACKGROUND_SECONDARY, C).hex(), j = l.useMemo(() => {
                    var e;

    ...
    ["43503"], {
        ...
        145079: function(e, t, n) {
            ...
            var T = e => {
                let {
                    ...
                    forcePomelo: f,
                    ...I
                } = e, T = (0, l.useStateFromStores)([s.default], () => s.default.hidePersonalInformation), S = T || t || n.isNonUserBot(), N = n.toString(), p = d.default.getName(n), C = a ? N : null != i ? i : p, h = n.isPomelo() || f;
                if (h || C !== N) {
                    let e = C === N && h && a ? d.default.getUserTag(n, {
                            forcePomelo: f
                        }) : C,
        ...
        559362: function(e, t, n) {
            ...
            function S(e) {
                ...
                } = (0, d.usePaymentContext)(), C = (0, l.default)(_.RESPONSIVE_MOBILE_WIDTH_SIZE_QUERY), h = (0, u.isApplicationUserSubscription)(n.sku_flags), m = (0, a.useStateFromStores)([c.default], () => c.default.getGuild(null == p ? void 0 : p.guild_id)), A = i.useCallback(() => S(f.Step.REVIEW), [S]);
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(E.PaymentPortalBody, {
                        children: C ? (0, r.jsx)(o.BenefitsConfirmationLite, {
                            ...
                            subtitle: h ? T.default.Messages.APPLICATION_USER_SUBSCRIPTION_PURCHASE_MODAL_BENEFITS_LITE_SUBTITLE : T.default.Messages.APPLICATION_SUBSCRIPTION_PURCHASE_MODAL_BENEFITS_LITE_SUBTITLE.format({
                            ...
                            subtitle: h ? T.default.Messages.APPLICATION_USER_SUBSCRIPTION_LISTING_HEADER : T.default.Messages.APPLICATION_GUILD_SUBSCRIPTION_LISTING_HEADER,
                            description: h ? T.default.Messages.APPLICATION_USER_SUBSCRIPTION_LISTING_DETAILS.format({
        ...
        671672: function(e, t, n) {
            ...
            function h(e) {
                ...
                let M = (0, s.default)(p.RESPONSIVE_MOBILE_WIDTH_SIZE_QUERY),
                    ...
                    y = v === _.Step.CONFIRM,
                    x = (0, c.isApplicationUserSubscription)(m.sku_flags),
                    b = i.useMemo(() => {
                        let e = 0,
                            t = 0;
                ...
                return a ? M ? t = (0, r.jsx)(f.BenefitsConfirmationLite, {
                    ...
                    o.default.useReducedMotion && y && D(window.innerWidth / 2, window.innerHeight / 2)
        ...
        458985: function(e, t, n) {
            ...
            function m(e) {
                ...
                l(null != j, "Expected plan to be selected"), l(null != Z, "Step should be set");
                let J = i.useRef(null),
                    [$, ee] = (0, s.default)(!1, 500),
                    [et, en] = i.useState(null == z ? void 0 : z.guild_id),
                    er = (0, o.isApplicationUserSubscription)(D.sku_flags);
                i.useEffect(() => {
        ...
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, I = (0, a.useStateFromStores)([l.default], () => l.default.useReducedMotion), [E, _] = i.useState(d), T = i.useRef((0, s.getGiftAnimationData)(t, E)), [S, N] = i.useState(null == f), [p, C] = i.useState(!1), [h, m] = i.useState(-1), A = () => {
        ...
        967241: function(e, t, n) {
            ...
            function m(e, t, n) {
                ...
                e.parent_id !== a && !(0, h.isGuildHomeChannel)(a) && (0, I.transitionToChannel)(e.parent_id), (0, f.transitionTo)(C.Routes.CHANNEL_THREAD_VIEW((0, d.getGuildIdForGenericRedirect)(e), (0, h.isGuildHomeChannel)(a) ? h.StaticChannelRoute.GUILD_HOME : e.parent_id, e.id), void 0, e.isForumPost() ? p.OpenThreadAnalyticsLocations.FORUM : void 0), setTimeout(() => {
            ...
            function O(e, t) {
                (0, f.transitionTo)(C.Routes.CHANNEL(e, (0, h.isGuildHomeChannel)(t) ? h.StaticChannelRoute.GUILD_HOME : t)), u.default.dispatch({
                    type: "SIDEBAR_CLOSE",
                    baseChannelId: t
                })
            }
        ...
        506885: function(e, t, n) {
            ...
            async function d(e, t) {
                ...
                let h = o.default.getUserProfile(e),

        ...
        586611: (e, t, n) => {
            ...
            function Q(e) {
                var t = e.analyticsLocations,
                    ...
                    Ge = q(i.useState({
                        ...
                        eligible_for_discount: Ze
                    }), 2),
                    Ue = Ge[0],
                    Fe = Ge[1],
                    We = q(i.useState((0, E.a8)(De) ? Y.Z.Messages.DEFAULT_CUSTOM_GIFT_MESSAGE : void 0), 2),
                    Be = We[0],
                    Ye = We[1];
                i.useEffect((function() {
                    Fe((function(e) {
                        var t = null != we ? (0, w.aS)(we.id, !1, H, Me) : void 0;
                        return $(X({}, e), {
                            subscription_plan_id: null == we ? void 0 : we.id,
                ...
                i.useEffect((function() {
                    P.default.track(B.rMx.PAYMENT_FLOW_STARTED, $(X({}, Ue), {
                ...
                i.useEffect((function() {
                    ...
                    if (null != se) Ee(se);
                        ...
                        var e;
                        Ee(null === (e = g.Z.get(S)) || void 0 === e ? void 0 : e.skuId)
                    }
                }), [je, Ee, S, se]);
                var He = (0, u.Z)((function() {
                        return Date.now()
                    }), [Te]),
                    Ke = i.useCallback((function(e) {
                        ...
                        var o = null != n ? n : Te,
                            a = Date.now();
                        null !== o ? P.default.track(B.rMx.PAYMENT_FLOW_STEP, $(X({}, Ue, r), {
                            from_step: o,
                            to_step: e === m.h8.ADD_PAYMENT_STEPS ? m.h8.PAYMENT_TYPE : e,
                            step_duration_ms: a - He,
                            flow_duration_ms: a - Ce.startTime
                        })) : P.default.track(B.rMx.PAYMENT_FLOW_LOADED, $(X({}, Ue), {
                            initial_step: e,
                            has_saved_payment_source: Re
                        }))
                    }), [Ue, Ce.startTime, d, Ie, _e, Te, He, Re]),
                    Ve = i.useMemo((function() {
                        return function() {
                            return null == T ? void 0 : T(ge === _.A.COMPLETED)
                        }
                    }), [T, ge]);
                (0, h.bp)(Te, Ae, Ke);
                (0, m.dZ)(Te, ge, Se);
                ...
                var ze = {
                    ...
                    Xe = function(e) {
                        var t, n = e.isGift,
                            ...
                            g = (0, M.rK)();
                        i.useEffect((function() {
                            g && n && M.ZP.trackExposure({
                                location: "cbdb8c_2"
                            })
                        }), [g, n]);
                        var S = O && g && n && s === L.Si.TIER_2,
                            P = (S || (0, E.a8)(v)) && f === m.h8.CONFIRM && null != y,
                            w = null != o && null != f,
                            _ = f !== m.h8.SKU_SELECT && null != s,
                            I = (0, R.N)(a),
                            A = !n && null != I && null != s && L.nG[I.trial_id].skus.includes(s),
                            T = (0, b.Ng)(),
                            G = null == T || null === (t = T.discount) || void 0 === t ? void 0 : t.plan_ids.some((function(e) {
                        ...
                        return i.useMemo((function() {
                            if (null != f) {
                                ...
                                else if (w) e = o(null != d ? d : null, u, f);
                                else if (h === Z.GZ.ONE_TIME) e = (0, r.jsx)(k.t, {
                                    step: f,
                                    onClose: u
                                });
                                else if (_) {
                                    C()(s in L.y7, "invalid sku id: ".concat(s));
                                    e = (0, r.jsx)(D.Z, {
                ...
                return (0, r.jsx)(c.Shaker, {
                    className: K().shaker,
                    isShaking: de && ge === _.A.PURCHASING,
                    intensity: 2,
                    children: (0, r.jsx)(c.ModalRoot, {
                        className: a()(K().root, z({}, K().withHeader, null != Xe)),
                        transitionState: y,
                        hideShadow: he,
                        returnRef: me,
            ...
            function J(e) {
                var t = e.subscriptionTier,
                    ...
                    h = u.hasFetchedSubscriptionPlans,
                    v = u.currencyLoading,
                    O = u.selectedSkuId,
                    g = u.setSelectedPlanId,
                    P = u.isGift,
                    E = u.defaultPlanId,
                    w = u.startedPaymentFlowWithPaymentSourcesRef.current,
                    _ = (0, A.Z)({
                        isGift: P,
                        skuId: O,
                    ...
                    k = C[0],
                    x = C[1],
                    M = (0, l.ZP)([S.Z], (function() {
                        return S.Z.applicationIdsFetched.has(L.RQ)
                    }));
                i.useEffect((function() {
                    x(!b || !h || v)
                }), [v, h, b]);

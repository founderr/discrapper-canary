        ...
        439437: function(e, t, n) {
            ...
            class N extends r.Component {
                componentWillEnter(e) {
                    ...
                    n.setValue(t[t.length - 1]), s.setValue(0), e(), h.default.parallel([h.default.timing(s, {
                        toValue: 1,
                ...
                componentWillLeave(e) {
                    ...
                    h.default.parallel([h.default.timing(n, {
                        toValue: 0,
                ...
                componentDidMount() {
                    this.preloadNextImages(), m.default.disable(), m.default.enableTemp(p.MODAL_CAROUSEL_LAYOUT), C.ComponentDispatch.subscribe(I.ComponentActions.MODAL_CAROUSEL_NEXT, this.gotoNextThrottled), C.ComponentDispatch.subscribe(I.ComponentActions.MODAL_CAROUSEL_PREV, this.gotoPrevThrottled)
                }
                componentWillUnmount() {
                    m.default.disableTemp(), C.ComponentDispatch.unsubscribe(I.ComponentActions.MODAL_CAROUSEL_NEXT, this.gotoNextThrottled), C.ComponentDispatch.unsubscribe(I.ComponentActions.MODAL_CAROUSEL_PREV, this.gotoPrevThrottled)
                }
                preloadNextImages() {
                    var e, t;
                    let {
                ...
                render() {
                    ...
                    return (0, i.jsxs)(c.default, {
                        ...
                        children: [l.length > 1 ? (0, i.jsx)(f.CarouselPrevious, {
                            className: x.navPrev,
                            ...
                            directionHistory: s,
                            className: a
                        }, r.src), l.length > 1 ? (0, i.jsx)(f.CarouselNext, {
                            className: x.navNext,

        ...
        62981: function(t, e, i) {
            ...
            class h {
                ...
                constructor({
                    ...
                    r(null != c, "couldn't get canvas 2d context."), this.canvas = t, this.canvasContext = c, this.animation = null, this.dropped = !1, this.currentFrame = 0, this.currentFrameTime = 0, this.frameDuration = 1e3, this.animate = o, this.visible = h, this.requestAnimationFrameId = null, this.hasInitialFrame = !1, this.onInitialDraw = l, this.onError = u, this.key = "".concat(e, ":").concat(t.width, ":").concat(t.height), a.default.create(this.key, t.width, t.height, i, n).then(t => {

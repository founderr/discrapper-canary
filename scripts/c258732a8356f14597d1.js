    ...
    [19493], {
        ...
        644144: (e, t, n) => {
            ...
            var A = function(e, t) {
                ...
                w = I(["discord.com/billing/promotions", "promos.discord.gg"].map((function(e) {
                    return p.Z.escape(e)
                }))).join("|"),
                ...
                L = [M(4, 4), M(4, 6), M(5, 3), "[a-zA-Z]{4}-?[0-9a-zA-Z]{4}-?[a-zA-Z]{4}"].join("|"),
            ...
            function X(e) {
                var t = e.trim().split("/").pop().match(D);
                if (null == t) return null;
                var n = T(t, 3),
                    r = (n[0], n[1], n[2]);

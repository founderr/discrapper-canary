    ...
    ["70201"], {
        ...
        846883: function(e, t, a) {
            ...
            function K(e, t) {
                ...
                } = (0, o.default)(), H = (0, n.useStateFromStores)([g.default], () => g.default.getCurrentUser()), X = (0, n.useStateFromStores)([L.default], () => L.default.getSelfEmbeddedActivities()), z = (0, n.useStateFromStoresArray)([M.default], () => M.default.getActivities().filter(e => null != e.application_id && !(null == X ? void 0 : X.has(e.application_id)))), W = (0, n.useStateFromStoresArray)([y.default], () => null != t ? y.default.getActivities(t.id, null == e ? void 0 : e.getGuildId()) : [], [t, e]), q = (0, n.useStateFromStoresArray)([L.default], () => {
                ...
                }, [t, e]), Q = (0, G.default)(), Z = (0, n.useStateFromStores)([E.default], () => null == e || e.isPrivate() || E.default.can(J.Permissions.SEND_MESSAGES, e), [e]), $ = (0, n.useStateFromStoresArray)([b.default], () => [...W.map(e => null != e.application_id && b.default.getState(e.application_id, J.ActivityActionTypes.JOIN) === J.ActivityActionStates.LOADING), ...q.map(e => b.default.getState(e.applicationId, J.ActivityActionTypes.JOIN) === J.ActivityActionStates.LOADING)], [W, q]), ee = (0, r.default)([...W.filter(e => (null == e ? void 0 : e.application_id) != null).map(e => e.application_id), ...q.map(e => e.applicationId)]), et = null == e ? void 0 : e.id, ea = (0, n.useStateFromStoresArray)([v.default, m.default, _.default, N.default, C.default, h.default, E.default], () => [...W.map(e => (0, U.default)({
                    user: null != t ? t : H,
                    activity: e,
                    application: ee.find(t => (null == t ? void 0 : t.id) === e.application_id),
                    channelId: et,
                    currentUser: H,
                    isEmbedded: (0, D.default)(e),
                ...
                })], [W, ee, et, H, q, t]), ei = (0, n.useStateFromStoresArray)([c.default, S.default], () => W.map(e => e.type === J.ActivityTypes.LISTENING && null != t ? (0, p.default)(c.default, S.default, t, e) : void 0), [t, W]), en = (0, s.useAnalyticsContext)();
                if (!Z) return null;
                let el = (a, i) => {
                ...
                return null == X || X.forEach(a => {
                    let n = (null == t ? void 0 : t.id) != null && a.userIds.has(null == t ? void 0 : t.id),
                        d = E.default.can(J.Permissions.CREATE_INSTANT_INVITE, e),
                        u = ee.find(e => (null == e ? void 0 : e.id) === a.applicationId);
                    null != a.instanceId && !n && d && null != u && eo.push((0, i.jsx)(l.MenuItem, {
                    ...
                    e.type === J.ActivityTypes.PLAYING && (0, V.default)(e, J.ActivityFlags.JOIN) ? eo.push((0, i.jsx)(l.MenuItem, {
                        id: "invite-to-join",
                        label: w.default.Messages.USER_ACTIVITY_ACTION_INVITE_TO_JOIN,
                        subtext: e.name,
                        action: () => el(J.ActivityActionTypes.JOIN, e)
                    }, "self".concat(t))) : e.type === J.ActivityTypes.LISTENING && (0, V.default)(e, J.ActivityFlags.SYNC) && eo.push((0, i.jsx)(l.MenuItem, {
                        id: "invite-to-listen",
                        label: w.default.Messages.USER_ACTIVITY_ACTION_INVITE_TO_LISTEN_ALONG,
                        subtext: e.name,
                        action: () => el(J.ActivityActionTypes.LISTEN, e)
                    }, "self".concat(t)))
                }), eo.length > 0 && eo.push((0, i.jsx)(l.MenuSeparator, {})), W.forEach((a, n) => {
                    if (a.type === J.ActivityTypes.PLAYING && (0, V.default)(a, J.ActivityFlags.JOIN) && null != a.session_id && null != a.application_id) {
                        if (ea[n]) {
                            let e = $[n];
                            eo.push((0, i.jsx)(l.MenuItem, {
                                id: "join",
                        ...
                        } else eo.push((0, i.jsx)(l.MenuItem, {
                            id: "ask-to-join",
                            label: w.default.Messages.USER_ACTIVITY_ACTION_ASK_TO_JOIN,
                            subtext: a.name,
                            action: () => el(J.ActivityActionTypes.JOIN_REQUEST, a)
                        }, n))
                    } else if (a.type === J.ActivityTypes.LISTENING && (0, V.default)(a, J.ActivityFlags.SYNC) && null != ei[n]) {
                        let d = ei[n],
                            {
                                notPlayable: u,
                                playingSameTrack: s,
                        ...
                        eo.push((0, i.jsx)(l.MenuItem, {
                            ...
                            action: () => (0, A.default)(d, B.SpotifyActionTypes.USER_ACTIVITY_PLAY),
                            label: (0, f.default)(d, B.SpotifyActionTypes.USER_ACTIVITY_PLAY),
                            subtext: p ? (0, I.default)(d, B.SpotifyActionTypes.USER_ACTIVITY_PLAY, null != e ? O.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: p
                        }, "spotify-play-".concat(a.session_id)), (0, i.jsx)(l.MenuItem, {
                            id: "spotify-sync-".concat(a.session_id),
                            action: () => (0, T.default)(d, B.SpotifyActionTypes.USER_ACTIVITY_SYNC),
                            label: w.default.Messages.USER_ACTIVITY_LISTEN_ALONG,
                            subtext: S ? (0, I.default)(d, B.SpotifyActionTypes.USER_ACTIVITY_SYNC, null != e ? O.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: S
                        }, "spotify-sync-".concat(a.session_id)))
                    }
                }), q.forEach((e, t) => {
                    var a;
                    let n = e.userIds.has(null !== (a = null == H ? void 0 : H.id) && void 0 !== a ? a : ""),
                        d = t + W.length,
                        u = $[d] || n,
                        s = w.default.Messages.EMBEDDED_ACTIVITIES_JOIN_ACTIVITY;
                    n ? s = w.default.Messages.USER_ACTIVITY_CANNOT_JOIN_SELF : $[d] && (s = w.default.Messages.USER_ACTIVITY_JOINING);
                    let o = ee.find(t => (null == t ? void 0 : t.id) === e.applicationId);
                    ea[d] && null != o && eo.push((0, i.jsx)(l.MenuItem, {
                        id: "embedded-activity-join-".concat(e.applicationId),
                        label: s,
                        disabled: u,
                        hint: $[d] ? (0, i.jsx)(l.Spinner, {
                            type: l.Spinner.Type.PULSING_ELLIPSIS
                        }) : null,
                        subtext: o.name,
                        action: () => es(e)

        ...
        470648: function(e, t, l) {
            ...
            function j(e) {
                let {
                    ...
                    channelId: j,
                    inlinePreview: N = !1
                } = e, T = (0, i.useStateFromStores)([v.default], () => v.default.getUser(r)), C = (0, i.useStateFromStores)([m.default], () => m.default.getChannel(j)), L = null != C ? C.getGuildId() : null, A = N || null == T || null == L || null == j ? void 0 : e => {
                ...
                }, _ = g.default.useName(T), M = (0, i.useStateFromStores)([m.default, p.default, x.default], () => S.default.getNickname(L, j, T)), R = h.default.getGuild(L), P = (0, d.useClydeEnabled)(R, C), y = P && r === E.CLYDE_AI_USER_ID ? E.CLYDE_AI_MENTION_COLOR : null, b = e => (0, a.jsx)(I.default, {
                    className: t,
                    onContextMenu: A,
                    color: y,
                    ...e,

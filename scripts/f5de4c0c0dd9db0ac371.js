        ...
        171037: (e, t, r) => {
            ...
            function Z(e) {
                var t = e.guildEventId,
                    ...
                    c = e.channel,
                    l = null != r,
                    u = (0, T.XJ)(null != c ? c : i).canManageGuildEvent,
                    a = C((0, d.Wu)([h.ZP], (function() {
                        return [h.ZP.isActive(t), h.ZP.getGuildScheduledEvent(t)]
                    })), 2),
                    s = a[0],
                    f = a[1],
                    p = (0, I.Z)(r, null == f ? void 0 : f.id),
                    b = null != f && u(f),
                    y = null != (null == f ? void 0 : f.recurrence_rule) && !l;
                if (!b || s) return null;
                var O = function(e) {
                    (0, o.openModal)((function(c) {
                        return (0, n.jsxs)(o.ConfirmModal, A(function(e) {
                            for (var t = 1; t < arguments.length; t++) {
                                var r = null != arguments[t] ? arguments[t] : {},
                                    n = Object.keys(r);
                                "function" == typeof Object.getOwnPropertySymbols && (n = n.concat(Object.getOwnPropertySymbols(r).filter((function(e) {
                            ...
                            onConfirm: function() {
                                return l && !e ? function() {
                                    if (null != r)
                                        if (null != p) {
                                            var e = p.scheduled_start_time,
                                                n = p.scheduled_end_time;
                                            ...
                                            var o = D.Z.extractTimestamp(r);
                                            S.Z.createGuildEventException({
                                                original_scheduled_start_time: new Date(o).toISOString(),
                                                is_canceled: !0
                                            }, i.id, t)
                                        }
                                }() : S.Z.deleteGuildEvent(t, i.id)
                            },
                            children: [(0, n.jsx)(o.Text, {
                                variant: "text-md/normal",
                                children: E.Z.Messages.GUILD_EVENT_DELETE_CONFIRM_BODY
                            }), (0, n.jsx)("br", {}), (y || e) && (0, n.jsx)(o.Text, {
                                variant: "text-md/normal",
            ...
            function U(e, t, i) {
                var c = (0, (0, T.XJ)(null != i ? i : t).canManageGuildEvent)((0, d.e7)([h.ZP], (function() {
                    ...
                    action: function() {
                        (0, o.openModalLazy)(R((function() {
                            ...
                            return G(this, (function(c) {
                                switch (c.label) {
                                    case 0:
                                        return [4, Promise.all([r.e(40532), r.e(86502), r.e(35401), r.e(10523), r.e(14688), r.e(89663), r.e(44118)]).then(r.bind(r, 689663))];
                                    case 1:
            ...
            function $(e, t, i) {
                var c, l = (0, T.XJ)(null != i ? i : t).canManageGuildEvent,
                    u = (0, d.e7)([h.ZP], (function() {
                        return h.ZP.getGuildScheduledEvent(e)
                    }), [e]),
                    a = l(u),
                    s = null != (0, Y.qY)(null !== (c = null == i ? void 0 : i.id) && void 0 !== c ? c : ""),
                    f = null != u && (0, h.xt)(u);
                return a && (!f && !s) ? (0, n.jsx)(o.MenuItem, {
                    id: E.Z.Messages.START_EVENT,
                    label: E.Z.Messages.START_EVENT,
                    action: function() {
                        null != u && (0, o.openModalLazy)(K((function() {
                            var e, t;
                            return Q(this, (function(o) {
                                switch (o.label) {
                                    case 0:
                                        return [4, Promise.all([r.e(40532), r.e(35401), r.e(74544), r.e(78158)]).then(r.bind(r, 874544))];
                                    case 1:
                ...
                var t = e.guildEventId,
                    ...
                    A = function(e, t) {
                        return (0, P.Z)(t, e).isMember ? (0, n.jsx)(o.MenuItem, {
                            ...
                            action: function() {
                                (0, w.JG)("".concat(location.protocol, "//").concat(location.host).concat(_.Z5c.GUILD_EVENT_DETAILS(t, e)));
                                (0, o.showToast)((0, o.createToast)(E.Z.Messages.COPIED_LINK, o.ToastType.SUCCESS))
                            }
                        }) : null
                    }(t, s.id),
                    C = function(e) {
                        var t = (0, d.e7)([h.ZP], (function() {
                            return h.ZP.getGuildScheduledEvent(e)
                        }), [e]);
                    ...
                    L = function(e, t, r) {
                        var i, c = (0, d.e7)([h.ZP], (function() {
                                return h.ZP.isActive(e)
                            })),
                            l = (0, d.e7)([h.ZP], (function() {
                                return h.ZP.getGuildScheduledEvent(e)
                            }), [e]),
                            u = (0, d.e7)([O.Z], (function() {
                                return O.Z.getGuild(t)
                            }), [t]);
                        if (c || null == l) return null;
                        i = l.entity_type === g.WX.EXTERNAL ? l.entity_metadata.location : null != r && null != u ? E.Z.Messages.CALENDAR_CHANNEL_LOCATION.format({
                            channelName: r.name,
                            guildName: u.name
                        }) : E.Z.Messages.NOTIFICATION_TITLE_DISCORD;
                        var s, w = f()(l.scheduled_start_time),
                            P = null != l.scheduled_end_time ? f()(l.scheduled_end_time) : w,
                            _ = null != l.description && "" !== l.description ? y.ZP.unparse(l.description, null !== (s = null == r ? void 0 : r.id) && void 0 !== s ? s : "", !0) : "",
                            T = function() {
                                var e = a()();
                                e.createEvent({
                                    start: w,
                        ...
                        return (0, n.jsxs)(o.MenuItem, {
                            ...
                            children: [(0, n.jsx)(o.MenuItem, {
                                ...
                                action: function() {
                                    var e = {
                                            text: l.name,
                                            dates: "".concat(w.format(m), "/").concat(P.format(m)),
                                            details: _,
                                            action: "TEMPLATE",
                                            location: i
                                        },
                ...
                return (0, n.jsx)(c.Z, {
                    ...
                    children: (0, n.jsxs)(o.Menu, {
                        ...
                        children: [(0, n.jsxs)(o.MenuGroup, {
                            children: [null == r && L, null == r && M, I, null == r && N, S, null == r && A]
                        }), null == r && (0, n.jsx)(o.MenuGroup, {
                            children: C
                        }), null == r && (0, n.jsx)(o.MenuGroup, {
                            children: x
                        })]

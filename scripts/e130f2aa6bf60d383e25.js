            ...
            function w(e) {
                ...
                if (!m.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== y.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = U(a, i),
                        c = A({}, t, P(u), null != i && null != o && (0, g.AB)(o) ? R(0, o) : L(a));
                    m.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        43299: (e, t, n) => {
            ...
            var _, p = new Set([l.pK.ARS, l.pK.CLP, l.pK.COP]),
                ...
                v = function(e) {
                    ...
                    p.has(v) && (S = c.Z.Messages.LOCALIZED_PRICING_BANNER_BODY_NEW_CURRENCY_WITH_AMBIGUOUS_SYMBOL.format({
                        helpCenterLink: o.Z.getArticleURL(u.BhN.LOCALIZED_PRICING),
                        currencyISOCode: v.toUpperCase(),
                        localizedPriceWithCurrencySymbol: g
                    }));
        ...
        491260: (e, t, n) => {
            ...
            var B = function(e) {
                ...
                r.getActivities = function(e) {
                    ...
                    if (null == t) {
                        var n;
                        return null !== (n = N[e]) && void 0 !== n ? n : g
                    }
                    var r = C(e, t);

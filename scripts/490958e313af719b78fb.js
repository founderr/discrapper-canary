    ...
    ["86612"], {
        ...
        552022: function(e, t, l) {
            ...
            var y = function(e) {
                ...
                let {
                ...
                } = (0, m.default)(p.default.CLIPS_GALLERY_ITEM), M = i.useRef(null), y = (0, x.default)(null !== (a = null === (t = s.editMetadata) || void 0 === t ? void 0 : t.start) && void 0 !== a ? a : 0), D = i.useRef(new c.DelayedCall(500, () => {
                    var e;
                    let t = M.current;
                    ...
                    var e, t, l;
                    let a = M.current;
                    null === (e = D.current) || void 0 === e || e.cancel(), null != a && (a.pause(), a.currentTime = null !== (l = null === (t = s.editMetadata) || void 0 === t ? void 0 : t.start) && void 0 !== l ? l : 0)
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [null != i && (0, n.jsx)(u.Tooltip, {
                        ...
                        children: e => (0, n.jsx)(u.Button, {
                            ...
                            onClick: e => {
                                e.stopPropagation(), e.shiftKey ? (0, M.deleteClip)(t.filepath) : i(t), _.default.track(T.AnalyticEvents.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                                    type: "delete"
                                })
                            },
                            className: R.button,
                        ...
                        children: e => (0, n.jsx)(u.Button, {
                            ...
                            color: u.Button.Colors.PRIMARY,
                            onClick: e => {
                                e.stopPropagation(), o(t), _.default.track(T.AnalyticEvents.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                                    type: "edit"
                                })
                            },
                            className: R.button,
        ...
        167573: function(e, t, l) {
            ...
            function I(e) {
                let {
                    ...
                    onClose: n,
                    transitionState: o
                } = e, [I, j] = s.useState(""), [M, T] = s.useState("descending"), [A, R] = s.useState(!0), [y, H] = s.useState(null), b = s.useDeferredValue(I), D = (0, c.useStateFromStores)([v.default], () => v.default.getClips()), P = (0, c.useStateFromStores)([v.default], () => v.default.getSettings().storageLocation), w = (0, c.useStateFromStores)([v.default], () => v.default.getState().newClipIds), {
                ...
                (0, h.default)({
                    ...
                    properties: {
                        number_of_clips_loaded: D.length
                    }
                }, {
                    disableTrack: A
                }, [D.length, A]), s.useEffect(() => x.clearNewClipIds, []);
                let V = s.useMemo(() => d(D).filter(e => {
                    if ("" === b.trim()) return !0;
                    let t = b.toLowerCase();
                    return null != e.name && "" !== e.name && i(t, e.name.toLowerCase()) || i(t, e.applicationName.toLowerCase())
                }).sort((e, t) => "ascending" === M ? C.default.compare(e.id, t.id) : "descending" === M ? C.default.compare(t.id, e.id) : 0).chunk(3).value(), [D, b, M]);
                s.useEffect(() => {
                    (async function e() {
                        R(!0);
                        try {
                            await x.loadClipsDirectory(P)
                        } finally {
                            R(!1)
                        }
                    })()
                ...
                let B = s.useCallback(e => {
                    ...
                    G = A || 0 !== V.length ? A ? (0, a.jsx)("div", {
                        ...
                        isEmptyBecauseQuery: D.length > 0,
                        closePopout: n
                    });

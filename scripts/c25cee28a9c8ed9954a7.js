(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [90135], {
        ...
        945660: (e, t, n) => {
            ...
            function O(e, t, n) {
                ...
                if (r.isBetween(i.start, i.end)) {
                    if (null != t) {
                        var u = p()(t),
                            c = u.isBetween(i.start, i.end),
                            l = u.isBetween(p()(o).subtract(y.zV, "days"), o);
                        return c || l && !n ? void 0 : y.X_.EVENT_STARTING_SOON
                    }
                    return y.X_.EVENT_STARTING_SOON
                }
                var a = b.default.extractTimestamp(e.id),
                    s = Math.min(a + y.Fc, o);
                if (r.isBetween(a, s) && null == t && !n) return y.X_.NEW_EVENT
            }
            var v = n(744564),
                g = n(664625);
            ...
            N.displayName = "UpcomingEventNoticesDismissalsStore";
            N.persistKey = "upcomingEventNotices";
            const I = new N(v.Z, {
                ...
                GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
                    ...
                    if (t.status === y.p1.CANCELED || t.status === y.p1.COMPLETED) {
                        var n = w({}, T);
                        delete n[t.id];
                        T = n
                    }
                ...
                GUILD_SCHEDULED_EVENT_USER_ADD: function(e) {
                    ...
                    if (t === g.default.getId()) {
                        var r = f.ZP.getGuildScheduledEvent(n);
                        if (null != r && r.status === y.p1.SCHEDULED) {
                            if (null == T[n]) {
                                if (O(r, void 0, !1) === y.X_.NEW_EVENT) {
                                    var o = w({}, T);
                                    o[n] = Date.now();
                                    T = o
                                }
            ...
            function R(e, t) {
                return (0, o.Wu)([l.Z, i.Z, f.ZP, a.Z, u.Z, c.ZP], (function() {
                    var n = l.Z.getGuild(e);
                    if (null == n) return L;
                    if (n.hasFeature(C.oNc.HUB)) {
                        var r, o, d = null === (r = c.ZP.getDefaultChannel(n.id)) || void 0 === r ? void 0 : r.id;
                    ...
                    return f.ZP.getGuildScheduledEventsByIndex(null != t ? t : f.bN.GUILD_EVENT_UPCOMING(n.id)).filter((function(e) {
                        ...
                        return a.Z.can(C.Plq.VIEW_CHANNEL, n)
                    }))
                }), [t, e])
            }
            ...
            function G(e) {
                return (0,
                    o.e7)([f.ZP, u.Z, a.Z], (function() {
                    var t = u.Z.getChannel(e);
                    if (!a.Z.can(C.Plq.VIEW_CHANNEL, t)) return null;
            ...
            function k(e) {
                var t = function(e) {
                        return (0, o.Wu)([f.ZP, u.Z, a.Z], (function() {
                            return f.ZP.getGuildScheduledEventsByIndex(f.bN.GUILD_EVENT_UPCOMING(e)).filter((function(e) {
                                if (e.entity_type === y.WX.NONE || e.status !== y.p1.SCHEDULED) return !1;
                                if (null == e.channel_id) return !0;
                                var t = u.Z.getChannel(e.channel_id);
                                return a.Z.can(C.Plq.VIEW_CHANNEL, t)
                            }))
                        }), [e])
                    }(e),
                    n = (0, o.cj)([I], (function() {
                        return I.getAllEventDismissals()
                    })),
                    r = (0, o.cj)([f.ZP], (function() {
                        return null == t ? {} : t.reduce((function(e, t) {
                            return M(function(e) {
                                ...
                                return e
                            }({}, e), A({}, t.id, f.ZP.hasRsvp(t.id, t.guild_id)))
                        }), {})
                    }), [t]);
                if (null != t && null != r)
                    for (var i = 0; i < t.length; i++) {
                        var c, l = t[i],
                            s = O(l, n[l.id], null !== (c = r[l.id]) && void 0 !== c && c);
                        if (null != s) return {
                            upcomingEvent: l,
                            noticeType: s
                        }
            ...
            function U(e) {
                return (0, o.e7)([f.ZP, u.Z, a.Z], (function() {
                    return f.ZP.getGuildScheduledEventsByIndex(f.bN.GUILD_EVENT_ACTIVE(e)).find((function(e) {
                        if (e.entity_type === y.WX.NONE || !(0, f.xt)(e)) return !1;
                        if (null == e.channel_id) return !0;
                        var t = u.Z.getChannel(e.channel_id);
                        return a.Z.can(C.Plq.VIEW_CHANNEL, t)
                    }))
                    ...
                    c = r.useMemo((function() {
                        return u.filter((function(e) {
                            var t = (0, S.ub)(e.scheduled_start_time, e.scheduled_end_time),
                                ...
                                r = t.diffMinutes;
                            return e.status !== y.p1.ACTIVE && n && r < 15
                        }))
                    }), [u]);
                return c
            }
        ...
        171037: (e, t, n) => {
            ...
            function Z(e, t, n) {
                var i = (0,
                        D.XJ)(null != n ? n : t).canManageGuildEvent,
            ...
            function V(e, t, i) {
                var u = (0, (0, D.XJ)(null != i ? i : t).canManageGuildEvent)((0, p.e7)([g.ZP], (function() {
            ...
            function Q(e, t, i) {
                var u, c = (0,
                        D.XJ)(null != i ? i : t).canManageGuildEvent,
                ...
                return a && (!f && !s) ? (0, r.jsx)(o.MenuItem, {
                    ...
                    action: function() {
                        null != l && (0, o.openModalLazy)(X((function() {
                            var e, t;
            ...
            function q(e) {
                var t = e.guildEventId,
                    ...
                    x = function(e, t, n) {
                        ...
                        i = c.entity_type === h.WX.EXTERNAL ? c.entity_metadata.location : null != n && null != l ? E.Z.Messages.CALENDAR_CHANNEL_LOCATION.format({
                            channelName: n.name,
                            guildName: l.name
                        }) : E.Z.Messages.NOTIFICATION_TITLE_DISCORD;
                        var s, j = f()(c.scheduled_start_time),
                            P = null != c.scheduled_end_time ? f()(c.scheduled_end_time) : j,
                            _ = null != c.description && "" !== c.description ? y.ZP.unparse(c.description, null !== (s = null == n ? void 0 : n.id) && void 0 !== s ? s : "", !0) : "",
                            D = function() {
                                var e = a()();
                                e.createEvent({
                                    start: j,
        ...
        166076: (e, t, n) => {
                ...
                return O(this, (function(O) {
                    switch (O.label) {
                        case 0:
                            ...
                            return s.Z.canQueueInteraction(n, E) ? [4, c.Z.unarchiveThreadIfNecessary(v)] : [2];
                        case 1:
                            O.sent();
                            (0, a.kz)(E, {
                                messageId: n,
            ...
            var D = function(e, t) {
                var n, o = null == t ? void 0 : t.state,
                    ...
                    a = e.isCommandType();
                return l && o === f.F.QUEUED || a && e.state === d.yb.SENDING && null != t ? w.SENDING : l && o === f.F.CREATED || e.hasFlag(d.iLy.LOADING) && !i ? w.CREATED : null != e.interaction && e.hasFlag(d.iLy.LOADING) && i || null != e.interaction && !e.hasFlag(d.iLy.LOADING) && c ? w.TIMED_OUT : a && e.state === d.yb.SEND_FAILED ? w.FAILED : void 0
            };

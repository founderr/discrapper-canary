    ...
    ["3328"], {
        ...
        104182: function(e, t, l) {
            ...
            function f(e, t) {
                ...
                let [m, E] = a.useState(f.current), [h, L] = a.useState(""), [P, A] = a.useState(n.PollLayoutTypes.DEFAULT), [x, T] = a.useState(!1), g = m.filter(e => (0, d.isAnswerFilled)(e, P)), I = m.filter(e => (0, d.isIncompleteAnswer)(e, P)), v = h.length > 0 && g.length >= 1 && 0 === I.length, [C, {
                    loading: R
        ...
        487757: function(e, t, l) {
            ...
            function T(e) {
                let {
                    ...
                    handleEmojiSelect: k,
                    handleGifSelect: O
                } = (0, f.default)(t, o), j = n.useRef([]), {
                    togglePollExpressionPicker: U,
                    lastActiveParentIndex: M
                } = (0, h.default)(I), b = n.useMemo(() => {
                    let e = {
                            layout: I,
                        ...
                        l = u.map((l, n) => (0, a.jsx)(p.default, {
                            ...
                            index: n,
                            ref: e => j.current[n] = e,
                            handleTogglePollExpressionPicker: () => U(n),
                            ...e
                        }, n));
                    if (S && N) {
                        let n = u.length;

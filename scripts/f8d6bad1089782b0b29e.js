...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [37992, 96043, 71402], {
                ...
                return (0, r.jsx)(u.MenuItem, {
                    ...
                    action: function() {
                        if (w) {
                            ...
                            U()
                        } else(0, u.openModalLazy)(O((function() {
                            var e, i;
        ...
        825781: (e, t, n) => {
            ...
            var d, p, _, E, h, v, I, g, O, y = o.QZA.CLOSED,
                T = {},
                b = !1;
            ...
            const C = new P(i.Z, {
                ...
                GUILD_IDENTITY_SETTINGS_SUBMIT_FAILURE: function(e) {
                    if (y !== o.QZA.SUBMITTING) return !1;
                    y = o.QZA.OPEN;
                    var t;
        ...
        189651: (e, t, n) => {
            ...
            function b(e, t) {
                p.default.track(h.rMx.VIEW_AS_ROLES_SELECTED, y(O({
                                    ...
                                    for (var l, s = t[Symbol.iterator](); !(n = (l = s.next()).done); n = !0) {
                                        ...
                                        if (p.Z.isMember(d) && !k.has(d)) {
                                            var h = !0,
                                                ...
                                                I = void 0;
                                            try {
                                                for (var g, O = E[Symbol.iterator](); !(h = (g = O.next()).done); h = !0) {
                                                    var y = g.value;
                                                    H(y, !0, _.Z.getGuild(d))
                                                }
                                            } catch (e) {
                                                v = !0;
                                                I = e
        ...
        430198: (e, t, n) => {
            ...
            function G(e, t, A, N) {
                ...
                var j, Z = (0, o.e7)([h.Z], (function() {
                    ...
                    Q = (0, f.Z)(t, e.id),
                    X = null != q && null != A && v.Z.canWithPartialContext(T.Plq.VIEW_CHANNEL, {
                        channelId: q
                    }) && !B ? [(!H || H && !W) && v.Z.canWithPartialContext(T.Plq.MUTE_MEMBERS, {
                        channelId: A
                    ...
                    }, "voice-mute") : null, (!H || H && !W) && v.Z.canWithPartialContext(T.Plq.DEAFEN_MEMBERS, {
                        channelId: A
                    }) ? (0, r.jsx)(u.MenuCheckboxItem, {
                        id: "voice-deafen",
                    ...
                    }, "voice-deafen") : null, !k && null != Z && v.Z.canWithPartialContext(T.Plq.MOVE_MEMBERS, {
                        channelId: A
                    }) ? (0, r.jsx)(u.MenuItem, {
                        id: "voice-disconnect",
                            ...
                            switch (o.label) {
                                ...
                                case 2:
                                    ...
                                    (0, u.showToast)((0, u.createToast)(m.Z.Messages.GUILD_COMMUNICATION_DISABLED_SUCCESS.format({
                                        user: null !== (i = y.ZP.getName(n, null, e)) && void 0 !== i ? i : ""
                                    }), u.ToastType.SUCCESS));
                                    return [3, 4];
                                case 3:
                                    o.sent();
                    ...
                    ee = null;
                if (!k && null != Z && null != z && null != z.joinedAt && (v.Z.canManageUser(T.Plq.MODERATE_MEMBERS, e, Z) || v.Z.canManageUser(T.Plq.MANAGE_ROLES, e, Z)) && Z.hasFeature(T.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
                    var te;
                    if ((0, O.yE)(null !== (te = z.flags) && void 0 !== te ? te : 0, S.q.BYPASSES_VERIFICATION)) {
                        var ne;
                        ee = (0, r.jsx)(u.MenuItem, {
                            id: "verify",
                            label: m.Z.Messages.MANUALLY_UNVERIFY_MEMBER,
                            action: function() {
                                return l.Z.setMemberFlags(Z.id, e.id, (0, O.mB)(null !== (ne = z.flags) && void 0 !== ne ? ne : 0, S.q.BYPASSES_VERIFICATION, !1))
                            }
                        }, "verify")
                    } else {
                        var re;
                        ee = (0, r.jsx)(u.MenuItem, {
                            ...
                            action: function() {
                                return l.Z.setMemberFlags(Z.id, e.id, (0, O.mB)(null !== (re = z.flags) && void 0 !== re ? re : 0, S.q.BYPASSES_VERIFICATION, !0))
                            }
                        }, "verify")
                    }
                }
                ...
                }, "timeout") : null, v.Z.canManageUser(T.Plq.KICK_MEMBERS, e, Z) ? (0, r.jsx)(u.MenuItem, {
                    id: "kick",
                ...
                }, "kick") : null, v.Z.canManageUser(T.Plq.BAN_MEMBERS, e, Z) ? (0, r.jsx)(u.MenuItem, {
                    id: "ban",
        ...
        100856: (e, t, n) => {
            ...
            function T(e, t) {
                ...
                if (!b && !_.Z.can(O.Plq.MOVE_MEMBERS, T)) return null;
                var S = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== T.id && (b ? _.Z.can(O.Plq.CONNECT, n) && !(0, I.rY)(n, v.Z, p.Z) : _.Z.can(O.Plq.MOVE_MEMBERS, n) && (_.Z.can(O.Plq.CONNECT, n) || g.ZP.can({
                        permission: O.Plq.CONNECT,
                        user: e,
                        context: n
                    })) && !(0,
                        I.rY)(n, v.Z, p.Z))
        ...
        973424: (e, t, n) => {
            ...
            function g(e, t) {
                ...
                if (!b) return null;
                var m = d.Z.getHighestRole(v),
                    A = Object.values(v.roles).filter((function(e) {
                        return e.id !== v.id
                    })),
                    N = S ? A.map((function(e) {
                        var t = e.managed || !d.Z.isRoleHigher(v, m, e),
                            n = -1 !== T.indexOf(e.id);
        ...
        491260: (e, t, n) => {
            ...
            function D(e) {
                ...
                delete P[e];
                if (null != m[e]) {
                    var t = g(u().sortBy(m[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                ...
                if (null == c) return w();
                O = null !== (t = e.section) && void 0 !== t ? t : O;
                M = null !== (n = e.section) && void 0 !== n ? n : O;
                null != e.subsection && null != O && (y[O] = e.subsection);
                null != e.scrollPosition && null != O && (T[O] = e.scrollPosition);
            ...
            var j = function(e) {
                ...
                r.getProps = function() {
                    return {
                        ...
                        section: O,
                        subsection: null != O ? y[O] : null,
                        scrollPosition: null != O ? T[O] : null,
                        settings: m,
                        errors: b,
            ...
            const Z = new j(u.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    ...
                    null != e.subsection && (y[O] = e.subsection)
                },
                USER_SETTINGS_MODAL_CLEAR_SUBSECTION: function(e) {
                    var t = e.forSection;
                    null != t ? delete y[t] : null != O && delete y[O]
                },
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete T[t] : null != O && delete T[O]
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    P = e.tab;
                    return null == O && P === l.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

    ...
    ["67131"], {
        ...
        57155: function(e, t, n) {
            ...
            class Z extends a.PureComponent {
                render() {
                    ...
                    }(e, 24, Y.emoji, l(Y.emoji, Y.emojiText)), c = s === O.ReactionTypes.BURST, m = c ? z.default.Messages.BURST_REACTION_REACTORS_A11Y : z.default.Messages.REACTION_REACTORS_A11Y, f = m.format({
                        name: r,
                        n: t
                    }), T = {}, E = {};
                    if (c) {
            ...
            function et(e) {
                ...
                let {
                    ...
                    onClose: o,
                    transitionState: r
                } = e, u = (0, m.useStateFromStores)([b.default], () => b.default.getChannel(s.getChannelId())), c = null == u ? void 0 : u.getGuildId(), d = (0, m.useStateFromStores)([P.default, I.default, C.default], () => {
                    var e, t, n;
                    let i = null !== (n = null !== (t = P.default.getMessage(s.getChannelId(), s.id)) && void 0 !== t ? t : null === (e = I.default.getMessage(s.id)) || void 0 === e ? void 0 : e.firstMessage) && void 0 !== n ? n : null != c ? C.default.getCachedMessage(c, s.getChannelId(), s.id) : void 0;
        ...
        58533: function(e, t, n) {
            ...
            function R(e) {
                let {
                    ...
                    startPosition: R,
                    targetPosition: p
                } = e, [_, S] = a.useState(0), [g, I] = a.useState(0), [A, C] = a.useState(null), {
                    confettiCanvas: O
                } = a.useContext(u.ConfettiCannonContext), N = (0, s.useConfettiCannon)(O, A), v = a.useMemo(() => {
        ...
        13066: function(e, t, n) {
            ...
            var E = e => {
                let {
                    ...
                    closePopout: E,
                    ctaRef: R
                } = e, p = (0, c.useUID)(), [_, S] = l.useState(!1), g = (0, o.useStateFromStores)([m.default], () => m.default.isLurking(a.id), [a.id]);
                l.useEffect(() => {
                    _ && !g && E()
                }, [_, g, E]);
                let I = null,
        ...
        15935: function(e, t, n) {
            ...
            let o = {},
                ...
                d = (e, t) => {
                    ...
                    if (Object.keys(o).length >= 5 && e === i.EXTERNAL) {
                        for (let e in o)
        ...
        350134: function(e, t, n) {
                        ...
                        children: [(0, i.jsx)(h.Popout, {
                            ...
                            children: () => (0, i.jsx)("div", {
                                ...
                                children: (0, i.jsx)(r.default.div, {
                                    className: l(P.reaction, _, {
                                        [P.reactionMe]: this.isMe(),
                                        [P.reactionReadOnly]: f && !E && !p && !R,
                                        [P.shakeReaction]: A && N && null == M
                                    }),
                                    style: D,
                                    children: (0, i.jsx)(h.Popout, {
                ...
                constructor(...e) {
                    super(...e), this.isReactionEventActive = !1, this.isKeyboardNavigation = !1, this.scale = new r.default.Value(1), this.opacity = new r.default.Value(1), this.timeout = new m.Timeout, this.hideTimeout = new m.Timeout, this.ctaRef = a.createRef(), this.type = $.ReactionTypes.NORMAL, this.colors = {
                        ...
                        let E = i.getChannelId(),
                            R = c ? P.ReactionLocations.FORUM_TOOLBAR : P.ReactionLocations.MESSAGE;
                        if (l && !s && this.isMe()) f ? (0, P.removeReaction)(E, i.id, a, void 0, R, {
                            burst: l
                        }) : (0, P.removeReactionWithConfirmation)({
                            emoji: a,
                            channelId: E,
                            messageId: i.id,
                            reactionType: l ? $.ReactionTypes.BURST : $.ReactionTypes.NORMAL,
                            location: R,
                            isMe: this.isMe()
                        });
                            ...
                            if (l && !this.userCanBurstReact()) {
                                ...
                                return
                            } else o ? this.handleShowVerificationGate() : !s && (this.isMe() ? (0, P.removeReaction)(E, i.id, a, void 0, R) : (0, P.addReaction)(E, i.id, a, R, {
                                burst: l
                            }))
                        } else {
                            (0, L.openBurstReactionsUpsellModal)({
                                analytics: {
                                    type: eo.PremiumUpsellTypes.BURST_REACTION_UPSELL,
                                    page: (null == T ? void 0 : T.getGuildId()) != null ? el.AnalyticsPages.GUILD_CHANNEL : el.AnalyticsPages.DM_CHANNEL,
                        ...
                        l && this.isMe() && h && ((0, q.toggleFreeUserSentPopout)(null), (0, S.markDismissibleContentAsDismissed)(d.DismissibleContent.SUPER_REACTIONS_FREE_USER_FIRST_SENT))
                    }, this.handleEnter = e => {
                        let {
                            emoji: t,
                            message: n,
                        ...
                        o && !this.isReactionEventActive && !a && s && (0, P.playBurstReaction)({
                        ...
                        if (s && !this.userCanBurstReact() && !l && (o = eo.PremiumUpsellTypes.EMOJI_IN_BURST_REACTION_HOVER_UPSELL), _.default.trackWithMetadata(el.AnalyticEvents.EXPRESSION_TOOLTIP_VIEWED, {
                                type: o,
                                expression_id: e.id,
            ...
            let eR = a.memo(e => {
                    let {
                        ...
                        autoTrackExposure: !1
                    }), T = (0, C.useEmojiColorPalette)(l && null != n ? n : []), E = (0, c.useStateFromStores)([Z.default], () => void 0 !== Z.default.getEffectForEmojiId(a.getChannelId(), a.id, s)), _ = (0, c.useStateFromStores)([p.default], () => p.default.useReducedMotion), g = D.AnimateEmoji.useSetting(), I = (0, S.isDismissibleContentDismissed)(d.DismissibleContent.BURST_REACTIONS_REMOVE_MODAL), [A, O] = (0, c.useStateFromStoresArray)([Q.default], () => [Q.default.remainingBurstCurrency, Q.default.emojiReactionToTargetForCoachmark]), N = G.default.getCurrentUser(), M = (0, X.isPremium)(N), j = (0, S.isDismissibleContentDismissed)(d.DismissibleContent.SUPER_REACTIONS_FREE_USER_FIRST_SENT), x = o && !(0, X.isNewUser)(N) && A > 0 && !j && null != O && s.id === O.id && s.name === O.name;
                ...
                e_ = e => {
                    ...
                    let {
                        ...
                        return {
                            joinedEmojiSourceGuild: (null == e ? void 0 : e.type) === A.EmojiTypes.GUILD ? w.default.getGuild(null == e ? void 0 : e.guildId) : void 0
                        }
                    ...
                    }), C = g.autoUnfurlReactionTooltip, O = null !== (t = null == d ? void 0 : d.isDiscoverable()) && void 0 !== t && t, N = V.default.getGuildId(), v = null != N && (N === (null == d ? void 0 : d.id) || N === (null == u ? void 0 : u.id)), x = (0, ee.getEmojiPopoutData)({
                    ...
                    return C ? (0, i.jsxs)("div", {
                        children: [p ? P() : null, E ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                        ...
                        children: [L ? P() : U(), E ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                            className: eu.emojiDetailsLoader
                        }) : L && (0, i.jsx)(ep, {
                            emojiId: n,
                            expressionSourceGuild: d,
        ...
        512306: function(e, t, n) {
            ...
            function R(e) {
                ...
                } = e, u = l.useRef(null), f = o * h.ANIMATION_TO_EMOJI_RATIO, R = (f + o) / 2;
                return l.useEffect(() => {
                    let e;
        ...
        81924: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                R = a.memo(function(e) {
                    ...
                    } = (0, o.useBurstReactionsExperiment)(null, !1), I = (0, s.useStateFromStores)([d.default], () => d.default.getEffectForEmojiId(t, n, R)), A = p ? E : T, C = a.useMemo(() => (0, h.buildEffect)(R, _, t, {
                        key: I,
                        messageId: n
        ...
        85589: function(e, t, n) {
            ...
            function T(e) {
                ...
                let {
                    ...
                    hasUnlimited: R
                } = (0, l.useBurstReactionsExperiment)(null, !1), p = R ? m.default.Messages.SUPER_REACTIONS_UPSELL_UNLIMITED_BODY : m.default.Messages.SUPER_REACTIONS_UPSELL_BODY_LAUNCH, _ = p.format({
                    onClick: () => {
        ...
        166257: function(e, t, n) {
            ...
            async function M(e, t, n) {
                ...
                O("MESSAGE_REACTION_ADD", e, t, n, {
                    ...
                    r ? (o.AccessibilityAnnouncer.announce(E ? A.default.Messages.BURST_REACTION_ADD_UNLIMITED_SUCCESS_A11Y.format({
                        name: n.name
                    }) : A.default.Messages.BURST_REACTION_ADD_SUCCESS_A11Y.format({
                        name: n.name,
                        n: i
                        ...
                        animated: !1,
                        ...n
                    })) : o.AccessibilityAnnouncer.announce(A.default.Messages.REACTION_ADD_SUCCESS_A11Y.format({
                        name: n.name
                    }))
                }).catch(a => {
                    C(a, () => M(e, t, n, i, {
                        ...
                        burst: r
                    }), r ? o.AccessibilityAnnouncer.announce(E ? A.default.Messages.BURST_REACTION_ADD_UNLIMITED_ERROR_A11Y.format({
                        name: n.name
                    }) : A.default.Messages.BURST_REACTION_ADD_ERROR_A11Y.format({
                        name: n.name,
                        n: f.default.remainingBurstCurrency
                    })) : o.AccessibilityAnnouncer.announce(A.default.Messages.REACTION_ADD_ERROR_A11Y.format({
                        name: n.name
                    })))
                })
            }
            ...
            async function b(e, t, n, i) {
                ...
                O("MESSAGE_REACTION_REMOVE", e, t, n, {
                    ...
                    (null == r ? void 0 : r.burst) ? o.AccessibilityAnnouncer.announce(A.default.Messages.BURST_REACTION_REMOVE_SUCCESS_A11Y.format({
                        name: n.name
                    })): o.AccessibilityAnnouncer.announce(A.default.Messages.REACTION_REMOVE_SUCCESS_A11Y.format({
                        name: n.name
                    }))
                }).catch(async a => {
                    if (C(a, () => b(e, t, n, i, l, {
                        ...
                        O("MESSAGE_REACTION_ADD", e, t, n, {
                            ...
                            burst: u,
                            colors: a
                        }), (null == r ? void 0 : r.burst) ? o.AccessibilityAnnouncer.announce(A.default.Messages.BURST_REACTION_REMOVE_ERROR_A11Y.format({
                            name: n.name
                        })) : o.AccessibilityAnnouncer.announce(A.default.Messages.REACTION_REMOVE_ERROR_A11Y.format({
                            name: n.name
                        }))
                    }
                })

        ...
        187485: (e, t, r) => {
            ...
            function p(e) {
                var t = e.channel,
                    ...
                    h = (0, d.targetToContext)(p),
                    m = h.href,
                    y = h.src,
                    M = h.textContent,
                    j = (0, u.Z)(E, t),
                    S = (0, a.Z)(null != m ? m : y, M),
                    _ = (0, l.Z)(y),
                    v = (0, i.Z)({
                        id: b.id,
                        label: g.Z.Messages.COPY_ID_MESSAGE,
                        shiftId: "".concat(t.id, "-").concat(b.id)
                    }),
                    w = (0, d.useGuildFeedHideItem)(r, t.guild_id),
                    P = (0, d.useGuildFeedRemoveItem)(r, b, t);
        ...
        101025: (e, t, r) => {
            ...
            function j(e, t) {
                return (0, n.jsx)(c.MenuItem, {
                    ...
                    label: m.Z.Messages.GUILD_FEED_HIDE_MESSAGE_ITEM,
                    action: function(r) {
                        r.stopPropagation();
                        return (0, b.NO)(e, t)
                    },
            ...
            function S(e, t) {
                t ? (0, c.openModal)((function(t) {
                    return (0, n.jsx)(c.ConfirmModal, M(function(e) {
                        ...
                        header: m.Z.Messages.GUILD_FEED_REMOVE_MESSAGE_ITEM_HEADER,
                        confirmText: m.Z.Messages.GUILD_FEED_REMOVE_CONFIRM,
                        ...
                        children: (0, n.jsx)(c.Text, {
                            ...
                            children: m.Z.Messages.GUILD_FEED_REMOVE_MESSAGE_ITEM_CONFIRM_TEXT
                        })
                    }))
                })) : (0, b.AT)(e)
            }
            ...
            function _(e, t, r) {
                var o = (0, s.ZP)([g.default], (function() {
                        return g.default.getId()
                    })),
                    i = (0, s.ZP)([p.Z], (function() {
                        return p.Z.can(h.Plq.MANAGE_MESSAGES, r)
                    }), [r]);
                if (!(t.author.id === o || i)) return null;
                return (0, n.jsx)(c.MenuItem, {
                    id: "remove-feed-message",
                    label: m.Z.Messages.GUILD_FEED_REMOVE_MESSAGE_ITEM,
                    action: function(t) {
                        t.stopPropagation();
                        var r = !0;
                        t.shiftKey && (r = !1);
            ...
            function v(e) {
                for (var t, r, n, s = e;
                    (0, o.k)(s, Node);) {
                    (0, o.k)(s, HTMLImageElement) && null != s.src && (r = s.src);
                    if ((0, o.k)(s, HTMLAnchorElement) && null != s.href) {
                        t = s.href;
                        n = s.textContent
                    }
                    s = s.parentNode
            ...
            function w(e) {
                var t = e.channel,
                    ...
                    b = p.textContent,
                    h = (0, a.Z)(r, t),
                    y = (0, d.Z)(null != O ? O : E, b),
                    M = (0, f.Z)(E),
                    S = (0, u.Z)({
                        id: r.id,
                        label: m.Z.Messages.COPY_ID_MESSAGE,
                ...
                return (0, n.jsxs)(c.Menu, {
                    navId: "message",
                    onClose: i.Zy,
                    "aria-label": m.Z.Messages.MESSAGE_ACTIONS_MENU_LABEL,
                    onSelect: g,
        ...
        809518: (e, t, r) => {
            ...
            function u(e) {
                var t = e.width,
                    ...
                    d = e.foreground,
                    g = i(e, ["width", "height", "color", "foreground"]);
...
//# sourceMappingURL=bbe03c0d4e9b0a239217.js.map
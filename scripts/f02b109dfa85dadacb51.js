...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [7088], {
        407088: (i, a, e) => {
            ...
            const t = function(i, a, e) {
                var t, r = n[i];
                t = "string" == typeof r ? r : 1 === a ? r.one : r.other.replace("{{count}}", String(a));
                return null != e && e.addSuffix ? e.comparison && e.comparison > 0 ? "în " + t : t + " în urmă" : t
            };
            var r = e(849526);
            const o = {
                date: (0, r.Z)({
...
//# sourceMappingURL=f02b109dfa85dadacb51.js.map
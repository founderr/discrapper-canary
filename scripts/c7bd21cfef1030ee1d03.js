    ...
    [894], {
        652411: (e, t, n) => {
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = y(e.minValue),
                                r = y(e.maxValue);
                            return new f(new T(N(n.x, r.x)), new T(N(n.y, r.y)));
                        case "linear":
                            t = y(e.value);
                            var i = y(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = y(e.minAddValue),
                                c = y(e.maxAddValue);
                            return new f(new S(N(n.x, r.x), N(o.x, c.x)), new S(N(n.y, r.y), N(o.x, c.x)));
                        case "oscillating":
                            t = y(e.value);
                            var a = y(e.start),
                                l = y(e.final),
                        ...
                        case "oscillating-random":
                            ...
                            var _ = y(e.minStart),
                                ...
                                h = y(e.minDirection),
                                b = y(e.maxDirection);
                            return new f(new A(N(n.x, r.x), N(_.x, E.x), N(O.x, p.x), N(I.x, d.x), R(h.x, b.x), C(e.easingFunctions)[0]), new A(N(n.y, r.y), N(_.y, E.y), N(O.y, p.y), N(I.y, d.y), R(h.y, b.y), C(e.easingFunctions)[0]))
                    }
                }(p(p({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = h(e.minValue),
                                r = h(e.maxValue);
                            return new d(new T(N(n.x, r.x)), new T(N(n.y, r.y)), new T(N(n.z, r.z)));
                        case "linear":
                            t = h(e.value);
                            var i = h(e.addValue);
                            return new d(new S(t.x, i.x), new S(t.y, i.y), new S(t.z, i.z));
                        case "linear-random":
                            n = h(e.minValue), r = h(e.maxValue);
                            var o = h(e.minAddValue),
                                c = h(e.maxAddValue);
                            return new d(new S(N(n.x, r.x), N(o.x, c.x)), new S(N(n.y, r.y), N(o.y, c.y)), new S(N(n.z, r.z), N(o.z, c.z)));
                        case "oscillating":
                            t = h(e.value);
                            var a = h(e.start),
                                l = h(e.final),
                        ...
                        case "oscillating-random":
                            ...
                            var _ = h(e.minStart),
                                ...
                                y = h(e.minDirection),
                                b = h(e.maxDirection);
                            return new d(new A(N(n.x, r.x), N(_.x, E.x), N(O.x, p.x), N(I.x, f.x), R(y.x, b.x), C(e.easingFunctions)[0]), new A(N(n.y, r.y), N(_.y, E.y), N(O.y, p.y), N(I.y, f.y), R(y.y, b.y), C(e.easingFunctions)[0]), new A(N(n.z, r.z), N(_.z, E.z), N(O.z, p.z), N(I.z, f.z), R(y.z, b.z), C(e.easingFunctions)[0]))
                    }
                }(p(p({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var g = r.forwardRef((function(e, t) {
                var o = e.className,
                    ...
                    N = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == E || E(t), d.current.forEach((function(n, r) {
                                    var i = n.confetti,
                                        o = n.spriteCanvas;
                                    i.update(c), i.draw(o, t), i.shouldDestroy(e, c) && d.current.delete(r)
                                })), null == O || O(t), d.current.size > 0 ? T.current = window.requestAnimationFrame(N) : (t.clearRect(0, 0, e.width, e.height), T.current = null);
                                var n = Date.now();
                                0 !== S.current && (A.current = 1e3 / (n - S.current)), S.current = n
                            }
                        }
                    }), [c, O, E]);
                ...
                var C = r.useCallback((function(e, t) {
                    ...
                    R = r.useCallback((function(e, t, n, r, o) {
                        var c, a = P(null !== (c = e.id) && void 0 !== c ? c : (0, i.v4)(), e, n, r, o);
                        return C(a, t), a
                    }), [C]),
                ...
                var m = r.useCallback((function(e, t) {
                        var n, r, i = t.clickHandler,
                            o = t.mouseHandler;
                        if (null != i || null != o) {
                            var l = null === (n = f.current) || void 0 === n ? void 0 : n.getBoundingClientRect();
                            if (null != l) {
                                var u = function(e, t) {
                                ...
                                if (a(u, {
                                    ...
                                    if (null != i) {
                                        ...
                                        i(e, null !== (r = null == _ ? void 0 : _.confetti) && void 0 !== r ? r : null)
                                    }
                                }
                            }
                        }
                ...
                }), [v, g, L, M, l, u, s, _]), r.useEffect((function() {
                    var e = f.current,
            ...
            var L = r.forwardRef((function(e, t) {
                        ...
                        null != t && null != e && (t.clearRect(0, 0, e.width, e.height),
                            p.current.forEach((function(e, n) {
                                var r = function(r, i) {
                                    var o = _ * i + 2 * i,
                                        c = E * n + 2 * n;
                                    if (t.drawImage(e.image, o, c, _, E), null != r) {
                ...
                }), [s.length, E, _, u.length]), r.createElement("canvas", {
                    ref: O,
                    className: c()(o, (n = {}, n["SpriteCanvas-module_spriteCanvasHidden__ndzQV"] = !l, n))
                })
            }));
            ...
            function M(e, t) {
                ...
                var a = r.useCallback((function(n, r) {
                        ...
                        if (null != l && null != a && 0 !== a.sprites.length) return null == e ? void 0 : e.createConfetti(n, l, a, o, c)
                    }), [e, t]),
            ...
            var I = function(e) {
                ...
                return (0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsx)(l.Clickable, {
                        className: c()(O().closeButton, (t = {}, p(t, O().closeButtonBold, o === r.BOLD), p(t, O().closeButtonSolid, o === r.SOLID), t)),
                        onClick: n,
                    ...
                    T = i.useMemo((function() {
                        return d ? E : {
                            ...
                            createMultipleConfetti: function(e) {
                                ...
                                return f.createMultipleConfetti(s({}, u, e), t, n)
                            },
        ...
        518197: (e, t, n) => {
            ...
            function A(e) {
                var t, n, T = e.channel,
                    ...
                    m = a.Z.can(O.yP, T);
                n = y && (null == C ? void 0 : C.premiumTier) === I.Eu4.TIER_3 ? R <= I.TU7 ? d.Z.Messages.STAGE_FULL_BOOST_MORE_BODY : d.Z.Messages.STAGE_FULL_MAX_BODY : b ? d.Z.Messages.STAGE_FULL_BODY : d.Z.Messages.STAGE_FULL_MAX_BODY;
                var v = function() {
                        N();
        ...
        531441: (e, t, n) => {
            ...
            var d = function(e) {
                    var t = e.count,
                        n = e.color,
                        i = void 0 === n ? c.Z.STATUS_DANGER : n,
                        a = e.disableColor,
                        u = void 0 !== a && a,
                        d = e.shape,
                ...
                N = function(e) {
                    var t = e.className,
                        n = e.color,
                        i = void 0 === n ? c.Z.INTERACTIVE_ACTIVE : n,
                        a = e.shape,

    ...
    [93420, 63394, 88110, 71402], {
        ...
        971402: (e, t, n) => {
            ...
            function p(e, t, n, r) {
                ...
                if (null == e.currentTarget.contains || e.currentTarget.contains(e.target)) {
                    ...
                    if ((null == n ? void 0 : n.enableSpellCheck) && (0, i.nI)()) var R = (0, u.RD)((function() {
                        R();
                        s(m)
                    }));
                    else {
        ...
        248046: (e, t, n) => {
            ...
            function R(e) {
                ...
                return {
                    version: n.version,
                    guildId: n.guild_id,
                    id: [n.id].concat(m(_)).join(I.oQ),
                    name: [n.name].concat(m(_)).join(" "),
                    ...
                    permissions: t,
                    displayName: [null !== (l = n.name_localized) && void 0 !== l ? l : n.name].concat(m(O)).join(" "),
            ...
            function P(e) {
                ...
                if (n.hasOwnProperty("id")) {
                    if (null == n.options || 0 === n.options.length) return [R({
                        rootCommand: t,
                        command: n,
                        applicationId: r,
                        subCommandPath: o,
                ...
                } else if (n.type !== s.jw.SUB_COMMAND && n.type !== s.jw.SUB_COMMAND_GROUP && (null == n.options || 0 === n.options.length)) return [R({
                    rootCommand: t,
                    command: n,
                    applicationId: r,
                    subCommandPath: o,
                ...
                for (var a = n.options.filter((function(e) {
                        return e.type === s.jw.SUB_COMMAND_GROUP
                    })), l = 0; l < a.length; l++) {
                    var c, f;
                    (c = u).push.apply(c, m(P({
                        rootCommand: t,
                        command: a[l],
                        applicationId: r,
                ...
                0 === a.length && 0 === p.length && u.push(R({
                    rootCommand: t,
                    command: n,
                    applicationId: r,
                    subCommandPath: o,
            ...
            function D(e, t, n, r) {
                return !!M(E.Z, p.Z, !1, e) && (e.isPrivate() && n > 0 || (null !== (o = null == r ? void 0 : r[t]) && void 0 !== o ? o : 0) > 0);
                var o
            }
            var M = function(e, t, n, r) {
                    return !n && (r.isMultiUserDM() ? t.getIntegrations(r.id).length > 0 : r.isDM() ? !r.isSystemDM() && (null != r.rawRecipients.find((function(e) {
                        return e.bot
                    })) || t.getIntegrations(r.id).length > 0) : r.isArchivedLockedThread() ? e.can(c.Z.combine(T.Pl.USE_APPLICATION_COMMANDS, T.Pl.MANAGE_THREADS), r) : !!(0, _.Em)(r.type) && e.can(c.Z.combine(T.Pl.USE_APPLICATION_COMMANDS, T.Pl.SEND_MESSAGES), r))
                },
                j = c.Z.deserialize(0);
        ...
        948832: (e, t, n) => {
            ...
            const N = new b(o.Z, {
                ...
                PRIVATE_CHANNEL_INTEGRATION_CREATE: function(e) {
                    ...
                    if (null == n) return !1;
                    d.set(t.channel_id, h(p(n).concat([(0, u.F)(t)])))
                },
        ...
        223219: (e, t, n) => {
            ...
            function M(e) {
                ...
                D = null !== (u = e.impressionSource) && void 0 !== u ? u : null
            }
            ...
            var x = function(e) {
                ...
                r.hasChanges = function() {
                    return null != R && null != m && (!(!this.isOpen() && A !== l.cII.USER_SETTINGS) && !o().isEqual(R, m))
                };
                r.isOpen = function() {
                    return g
                };
            ...
            const G = new x(u.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    A = e.tab;
                    return null == y && A === l.cII.USER_SETTINGS && M({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
                    ...
                    function e(t) {
                        ...
                        this.languageDetector = new _(o, (function(e) {
                            ...
                            if (-1 !== t.indexOf(r)) n.setLocale(r);
                                ...
                                var i, a = null !== (i = u[e]) && void 0 !== i ? i : O[o];

    ...
    [88892, 89005, 29202, 91683, 58635], {
        ...
        796909: (e, t, n) => {
            ...
            function P(e) {
                ...
                if (null != u) {
                    var i = o()(u).valueOf(),
                        l = O.Z.fromTimestamp(i);
                    return O.Z.compare(r, l) > 0 ? r : l
                }
                return r
            }
            ...
            function j() {
                ...
                (0, c.cn)() && (0, a.x7)() && v.Z.getAddedToMessages().forEach((function(e) {
                    var t = p.Z.getChannel(e);
                    null != t && (0, d.zi)(t.type) && w.set(t.id, A(t))
                }))
            }

            function L() {
                var e = p.Z.getMutablePrivateChannels();
                for (var t in e) w.set(t, A(e[t]))
            }
            var R, N, Z, U = (R = [], N = [], Z = [], function() {
                    var e = w.values(_.FAVORITE),
                        t = w.values(_.DEFAULT);
                    if (R !== e || N !== t) {
                        Z = [];
                ...
                D = function(e) {
                    ...
                    r.initialize = function() {
                        ...
                        this.syncWith([v.Z, f.Z], j)
                    };
                    r.getPrivateChannelIds = function() {
                        return U()
                    };
                    r.getSortedChannels = function() {
                        return [w.values(_.FAVORITE), w.values(_.DEFAULT)]
                    };
            ...
            const H = new D(l.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0,
                            d.hv)(e.type) || w.has(e.id)) && w.set(e.id, A(e))
                    }))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && w.set(t, A(r, n.id))
                },

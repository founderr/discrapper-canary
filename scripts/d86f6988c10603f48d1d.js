        ...
        152584: function(e, t, n) {
            ...
            function C(e) {
                ...
                return o.default.dispatch({
                    ...
                    return null != f.DEVICE_PUSH_VOIP_PROVIDER && null != s && (o.push_voip_provider = f.DEVICE_PUSH_VOIP_PROVIDER, o.push_voip_token = s), A(o)
                }, {
                    checkEnabled: !1,
                    modalProps: {
        ...
        726750: function(e, t, n) {
            ...
            function S(e) {
                ...
                let n = (0, f.default)(),
                    ...
                    C = (null === (t = a.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === e.id,
                    I = (0, E.default)(),
                    g = (0, l.useStateFromStores)([c.default], () => c.default.getPermissionsForUser(e.id, S), [S, e.id]),
                    N = (0, s.useCanModerateRequestToSpeak)(S);
                if (null == n || null == p || null == A || g.speaker) return null;
                let R = () => {
                    C ? (0, d.audienceAckRequestToSpeak)(n, !1) : (0, d.inviteUserToStage)(n, e.id)
                };
                return N ? (0, i.jsx)(u.MenuItem, {
                    id: "invite-speaker",
                    label: C ? _.default.Messages.STAGE_CHANNEL_USER_SET_MYSELF_TO_SPEAKER : _.default.Messages.STAGE_CHANNEL_USER_INVITE_TO_SPEAK,
                    action: R
                }) : I && C ? (0, i.jsx)(u.MenuItem, {
                    id: "invite-speaker",

    ...
    [37246], {
        ...
        813659: (e, t, n) => {
            ...
            function h(e) {
                var t, n = e.onClose,
                    ...
                    C = (0, o.ZP)([_.Z], (function() {
                        return _.Z.getGuild(m)
                    }), [m]),
                    M = null !== (t = null == C ? void 0 : C.name) && void 0 !== t ? t : "",
                    U = (0, O.no)(g),
                    b = (0, l.Z)(u.Z.AUTOMOD_PROFILE_QUARANTINE_ALERT).analyticsLocations,
                    v = R((0, p.ww)({
                        guildId: m,
                    ...
                    P = v[0],
                    D = v[1],
                    y = U.has(A.q.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME) ? N.Z.Messages.GUILD_AUTOMOD_USERNAME_INVALID_MODAL_DESCRIPTION_MOBILE : N.Z.Messages.GUILD_AUTOMOD_BIO_INVALID_MODAL_DESCRIPTION_MOBILE;
        ...
        223219: (e, t, n) => {
            ...
            function y(e) {
                ...
                h = I({}, R);
                U = null !== (r = e.onClose) && void 0 !== r ? r : null;
            ...
            var B = function(e) {
                ...
                r.hasChanges = function() {
                    return null != h && null != R && (!(!this.isOpen() && M !== l.cII.USER_SETTINGS) && !i().isEqual(h, R))
                };
                r.isOpen = function() {
                    return g
                };
            ...
            const k = new B(a.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    M = e.tab;
                    return null == N && M === l.cII.USER_SETTINGS && y({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

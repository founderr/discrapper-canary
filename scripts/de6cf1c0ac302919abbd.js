            ...
            var r = function() {
                ...
                return r.prototype = {
                    ...
                    quantize: function(u, l) {
                        ...
                        var a, s, c, d, f, E, _, p, h, I, T, S, A, g, C, m, R = (a = u, f = Array(32768), a.forEach(function(n) {
                        ...
                        var N = (E = u, _ = R, T = 1e6, S = 0, A = 1e6, g = 0, C = 1e6, m = 0, E.forEach(function(t) {
                        ...
                        U(M, l - M.size());
                        for (var y = new o; M.size();) y.push(M.pop());
                        return y
                    }
                }
            }();
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        return r
                    }, g = A(_, p, (l >> 18 & 31) / 31), C = A(3, 3, 1.25 * ((a >> 3 & 63) / 63)), m = A(3, 3, 1.25 * ((a >> 9 & 63) / 63)), R = f && A(5, 5, I), v = i(e), N = u(v > 1 ? 32 : 32 * v), O = u(v > 1 ? 32 / v : 32), U = new Uint8Array(N * O * 4), M = [], y = [];
                    for (let e = 0, i = 0; e < O; e++)
                        for (let u = 0; u < N; u++, i += 4) {
                            let l = s,
                                ...
                                E = d,
                                I = h;
                            for (let e = 0, n = r(_, f ? 5 : 3); e < n; e++) M[e] = o(t / N * (u + .5) * e);
                            for (let n = 0, i = r(p, f ? 5 : 3); n < i; n++) y[n] = o(t / O * (e + .5) * n);
                            for (let e = 0, t = 0; e < p; e++)
                                for (let n = e ? 0 : 1, i = 2 * y[e]; n * p < _ * (p - e); n++, t++) l += g[t] * M[n] * i;
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, i = 2 * y[e]; n < 5 - e; n++, t++) I += R[t] * M[n] * i;
                            let T = l - 2 / 3 * a,
                                S = (3 * l - T + E) / 2,
                                A = S - E;
                            U[i] = r(0, 255 * n(1, S)), U[i + 1] = r(0, 255 * n(1, A)), U[i + 2] = r(0, 255 * n(1, T)), U[i + 3] = r(0, 255 * n(1, I))
                        }
                    return {
                        w: N,
                        h: O,

    ...
    ["39355"], {
            ...
            var l = n("759843"),
                ...
                f = {
                    createChannel(e) {
                        ...
                        }).then(e => (o.default.isOptInEnabled(t) && u.default.updateChannelOverrideSettings(t, e.body.id, {
                    ...
                    createRoleSubscriptionTemplateChannel: (e, t, n, r) => a.default.post({
            ...
            let s = e => {
                ...
                return (0, l.jsxs)("svg", {
                    ...
                    children: [(0, l.jsx)("g", {
                        ...
                        className: o,
                        children: (0, l.jsx)("path", {
                            d: "M1.232 21.132a1 1 0 0 1 0-1.414l7.475-7.475a.5.5 0 0 1 .707 0l2.122 2.121a.5.5 0 0 1 0 .707L4.06 22.546a1 1 0 0 1-1.414 0l-1.415-1.414ZM7.757 7.757l8.486 8.486a2 2 0 0 0 2.828 0l3.536-3.536a2 2 0 0 0 0-2.828l-2.94-2.94.657-.656a1 1 0 0 0 0-1.415L18.91 3.454a1 1 0 0 0-1.414 0l-.657.657-2.718-2.718a2 2 0 0 0-2.828 0L7.757 4.93a2 2 0 0 0 0 2.828Z"
                        })
                    }), (0, l.jsx)("defs", {
            ...
            function d(e) {
                ...
                switch (n.type) {
                    case o.ChannelTypes.DM:
                        t = d ? a.default.Messages.DIRECT_MESSAGE_A11Y_LABEL_WITH_UNREADS : a.default.Messages.DIRECT_MESSAGE_A11Y_LABEL;
                        break;
                    case o.ChannelTypes.GROUP_DM:
                        t = d ? a.default.Messages.GROUP_MESSAGE_A11Y_LABEL_WITH_UNREADS : a.default.Messages.GROUP_MESSAGE_A11Y_LABEL;
                        break;
                    ...
                    case o.ChannelTypes.GUILD_ANNOUNCEMENT:
                        t = c > 0 ? a.default.Messages.GUILD_SIDEBAR_ANNOUNCEMENT_CHANNEL_A11Y_LABEL_WITH_MENTIONS : d ? a.default.Messages.GUILD_SIDEBAR_ANNOUNCEMENT_CHANNEL_A11Y_LABEL_WITH_UNREADS : a.default.Messages.GUILD_SIDEBAR_ANNOUNCEMENT_CHANNEL_A11Y_LABEL;
                        break;
                    case o.ChannelTypes.GUILD_VOICE:
                        let S = [a.default.Messages.GUILD_SIDEBAR_VOICE_CHANNEL_A11Y_LABEL.format({
                            channelName: n.name
                        })];
                        if (c > 0 && S.push(a.default.Messages.GUILD_SIDEBAR_CHANNEL_A11Y_LABEL_MENTIONS.format({
                                mentionCount: c
                            })), d && S.push(a.default.Messages.GUILD_SIDEBAR_CHANNEL_A11Y_LABEL_UNREAD), null != f) {
                            let e = n.userLimit;
                    ...
                    case o.ChannelTypes.GUILD_STAGE_VOICE:
                        ...
                        break;
                    default:
                        t = l.THREAD_CHANNEL_TYPES.has(n.type) ? c > 0 ? a.default.Messages.GUILD_SIDEBAR_THREAD_A11Y_LABEL_WITH_MENTIONS : d ? a.default.Messages.GUILD_SIDEBAR_THREAD_A11Y_LABEL_WITH_UNREADS : a.default.Messages.GUILD_SIDEBAR_THREAD_A11Y_LABEL : c > 0 ? a.default.Messages.GUILD_SIDEBAR_DEFAULT_CHANNEL_A11Y_LABEL_WITH_MENTIONS : d ? a.default.Messages.GUILD_SIDEBAR_DEFAULT_CHANNEL_A11Y_LABEL_WITH_UNREADS : a.default.Messages.GUILD_SIDEBAR_DEFAULT_CHANNEL_A11Y_LABEL
                }
                let L = [t.format({
                        channelName: h,
                        mentionCount: c
        ...
        998940: function(e, t, n) {
            ...
            let u = () => ({
                ...
                c = (e, t) => {
                    var n;
                    let l = (n = t) === i.JOINED_AT ? u : n === i.ACCOUNT_AGE ? d : void 0;
        ...
        412013: function(e, t, n) {
            ...
            function a(e) {
                ...
                let {
                    ...
                    role: a,
                    className: u
                } = e, d = (0, r.useToken)(r.tokens.unsafe_rawColors.PRIMARY_300).hex(), c = null !== (t = null == a ? void 0 : a.colorString) && void 0 !== t ? t : d, f = i.useMemo(() => ({
        ...
        167109: function(e, t, n) {
            ...
            function F(e, t) {
                ...
                return l.useMemo(() => {
                    let e = {
                        ...null != n ? n : M.DEFAULT_PREVIEW_ROLE
                    };
                    if (void 0 !== r) {
                        var t, l;
            ...
            function y(e, t) {
                var n;
                let i = (0, C.default)(t, e),
                    r = l.useMemo(() => null !== (n = null == i ? void 0 : i.color) && void 0 !== n ? n : T.DEFAULT_ROLE_COLOR, [i]);
            ...
            function K(e) {
                ...
                let o = R(e, e => null == e ? void 0 : e.subscription_plans[0]),
                    [a] = N(e, "priceTier", void 0),
                    u = l.useMemo(() => ({
                        price: null !== (t = null != a ? a : null == o ? void 0 : o.price) && void 0 !== t ? t : 0,
                        currency: null !== (n = null == o ? void 0 : o.currency) && void 0 !== n ? n : T.CurrencyCodes.USD,
                        interval: null !== (i = null == o ? void 0 : o.interval) && void 0 !== i ? i : I.SubscriptionIntervalTypes.MONTH,
            ...
            async function J(e) {
                ...
                let i = l.role_id,
                    o = l.id,
                    a = g.useEditStateStore.getState().listings[n];
                ...
                if (void 0 !== u || void 0 !== E) await c.default.updateRole(t, i, {
                    color: u,
            ...
            async function X(e) {
                ...
                r(null != o, "no name provided"), r(null != a, "no description provided"), r(null != c, "no priceTier provided"), r(null != f, "no image provided");
                ...
                null != u && u.length > 0 && await (0, L.createChannelsFromTemplateTierBenefits)(t, u);
                let S = [...null != u ? u : [], ...null != d ? d : []],
                    m = (0, L.getTemplateTierCreationAnalyticsContext)(n, t);
                ...
                let [e, t] = l.useState(!1), [n, i] = l.useState(), o = l.useCallback(async e => {
                    ...
                    try {
                        ...
                        function(e) {
                            ...
                            let a = g.useEditStateStore.getState().listings[l];
                            r(null != a, "edit state does not exist");
                            let {
                                name: u,
                                description: d,
                            ...
                            if (u !== o.name && (L.name = u), d !== o.description && (L.description = d), E !== (null === (t = o.subscription_plans[0]) || void 0 === t ? void 0 : t.price) && (L.priceTier = E), null != h && (L.image = h), null != m && (L.can_access_all_channels = m === g.AllChannelAccessOptions.ALL_CHANNELS_ACCESS), null != c || null != f) {
            ...
            function $(e, t) {
                let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {
                    ...
                    a = (0, g.useEditStateStore)(e => e.setListing),
                    u = l.useMemo(() => [...i.map(e => {
                        let {
                            id: t
                        } = e;
                        ...
                        return s(t, e => [...null != e ? e : [], n]), e.listings.forEach(t => {
                            a(n, () => ({
                                ...
                                channelBenefits: t.channels.map(e => ({
                                    ref_id: e.id,
                                    ref_type: v.GuildRoleSubscriptionBenefitTypes.CHANNEL,
        ...
        65722: function(e, t, n) {
            ...
            function p(e) {
                let t = (0, r.useStateFromStores)([a.default], () => h(e), [e]);
                return t
            }

            function h(e) {
                return null != e && a.default.can(c.Permissions.ADMINISTRATOR, e)
            }
        },
        ...
        432153: function(e, t, n) {
            ...
            function S(e) {
                let t = (0, r.default)([a.default], () => a.default.getChannel(e)),
            ...
            function m(e, t, n) {
                ...
                let o = l.filter(e => !e.soft_deleted && !e.archived),
                    a = o.map(e => e.subscription_plans[0].price),
                    u = [];
        ...
        246506: function(e, t, n) {
            ...
            function m(e) {
                ...
                let {
                    ...
                    className: C
                } = e, A = (0, o.useStateFromStores)([f.default], () => f.default.getCurrentUser()), M = E.default.useName(n, null, A), g = (0, a.getRoleIconProps)(r), v = i.useMemo(() => (0, u.createMessageRecord)({
                    ...(0, d.default)({
                        channelId: "0",
                        content: L,
                        tts: void 0,
                ...
                return (0, l.jsx)("div", {
                    className: s((0, _.getThemeClass)(m), S.container, C),
        ...
        291655: function(e, t, n) {
            ...
            var l = n("37983"),
                ...
                E = i.memo(function(e) {
                    ...
                    } = e, L = (0, o.useShowImprovedMarkdownUserExperimentConfig)((null !== (t = r.editedTimestamp) && void 0 !== t ? t : r.timestamp).valueOf()), C = (0, o.useShowImprovedMarkdownGuildExperimentConfig)(null !== (n = null == E ? void 0 : E.guild_id) && void 0 !== n ? n : "", (null !== (i = r.editedTimestamp) && void 0 !== i ? i : r.timestamp).valueOf()), {
                        content: A
                    } = (0, u.default)(r, {
                        hideSimpleEmbedContent: S,
                        allowList: L.showListsAndHeaders || C.showListsAndHeaders,
                        allowHeading: L.showListsAndHeaders || C.showListsAndHeaders,
                        allowLinks: L.showMaskedLinks || C.showMaskedLinks,
                        previewLinkTarget: L.showMaskedLinks || C.showMaskedLinks
                    });
        ...
        941886: function(e, t, n) {
            ...
            class p extends i.PureComponent {
                render() {
                    ...
                    return (0, l.jsx)(_, {
                        children: E => (0, l.jsx)(u.default.Child, {
                            grow: 0,
            ...
            let h = e => {
                ...
                return (0, l.jsxs)(u.default.Child, {
                    grow: 0,
                    direction: u.default.Direction.VERTICAL,
                    style: o,
                    children: [null != t && (0, l.jsx)(a.H, {

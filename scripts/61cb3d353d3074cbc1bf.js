    ...
    [12295], {
        212295: (i, e, a) => {
            ...
            var t = {
                ...
                s = function(i, e, a, t) {
                    var r = i + " ";
                    return 1 === i ? r + n(0, e, a, t) : e ? t ? r + d(a)[1] : r + (o(i) ? d(a)[1] : d(a)[2]) : r + (o(i) ? d(a)[1] : d(a)[0])
                };
            ...
            const u = function(i, e, a) {
                var r, n = i.match(/about|over|almost|lessthan/i),
                    s = n ? i.replace(n[0], "") : i,
                    o = void 0 !== (null == a ? void 0 : a.comparison) && a.comparison > 0,
                    d = p[i];
                r = "string" == typeof d ? d : 1 === e ? d.one(e, !0 === (null == a ? void 0 : a.addSuffix), s.toLowerCase() + "_one", o) : d.other(e, !0 === (null == a ? void 0 : a.addSuffix), s.toLowerCase() + "_other", o);
                if (n) {
                    var u = n[0].toLowerCase();
                    r = t[u] + " " + r
                }
                return null != a && a.addSuffix ? a.comparison && a.comparison > 0 ? "po " + r : "prieš " + r : r
            };
            var m = a(849526);
            const l = {
                date: (0, m.Z)({

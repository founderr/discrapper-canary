...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [21245, 88110, 96043, 71402], {
        ...
        434651: (e, t, n) => {
            ...
            function S(e) {
                ...
                var D = P === h && (p.Z.can(E.Plq.CHANGE_NICKNAME, N) || p.Z.can(E.Plq.MANAGE_NICKNAMES, N)),
                    w = P === h,
                    G = p.Z.canManageUser(E.Plq.MANAGE_NICKNAMES, h, N);
                if (!(D || G || w)) return null;
                if (null == C || R) return null;
                var j = N.hasFeature(E.oNc.HUB) ? O.Z.Messages.HUB_EDIT_PROFILE : O.Z.Messages.CHANGE_IDENTITY,
                    Z = w ? j : O.Z.Messages.CHANGE_NICKNAME;
        ...
        825781: (e, t, n) => {
            ...
            var d, p, _, E, O, h, I, v, y, g = o.QZA.CLOSED,
                T = {},
                b = !1;
        ...
        189651: (e, t, n) => {
            ...
            function b(e, t) {
                p.default.track(O.rMx.VIEW_AS_ROLES_SELECTED, g(y({
                                    ...
                                    for (var l, s = t[Symbol.iterator](); !(n = (l = s.next()).done); n = !0) {
                                        ...
                                        if (p.Z.isMember(d) && !k.has(d)) {
                                            var O = !0,
                                                ...
                                                I = void 0;
                                            try {
                                                for (var v, y = E[Symbol.iterator](); !(O = (v = y.next()).done); O = !0) {
                                                    var g = v.value;
        ...
        190022: (e, t, n) => {
            ...
            const M = (0, c.Z)((0, l.Z)((function(e) {
                var t, n = e.user,
                    ...
                    F = (0, o.e7)([h.Z], (function() {
                        var e;
                        return null !== (e = h.Z.getUserVoiceChannelId(l, n.id)) && void 0 !== e ? e : void 0
                    }), [l, n.id]),
                    H = i.useCallback((function() {
                        x(E.jQ.COPY_ID)
                    }), [x]),
                    V = (0, o.e7)([O.ZP], (function() {
                        return O.ZP.isMember(l, n.id)
                    }), [l, n.id]),
                    Y = (0, R.Z)(n.id, l),
                    K = (0, y.Z)(n.id, M),
                    W = (0, _.Z)({
        ...
        430198: (e, t, n) => {
            ...
            function G(e, t, A, N) {
                ...
                var j, Z = (0, o.e7)([O.Z], (function() {
                    ...
                    Q = (0, f.Z)(t, e.id),
                    X = null != q && null != A && h.Z.canWithPartialContext(T.Plq.VIEW_CHANNEL, {
                        channelId: q
                    }) && !B ? [(!H || H && !W) && h.Z.canWithPartialContext(T.Plq.MUTE_MEMBERS, {
                        channelId: A
                    ...
                    }, "voice-mute") : null, (!H || H && !W) && h.Z.canWithPartialContext(T.Plq.DEAFEN_MEMBERS, {
                        channelId: A
                    }) ? (0, r.jsx)(u.MenuCheckboxItem, {
                        id: "voice-deafen",
                    ...
                    }, "voice-deafen") : null, !k && null != Z && h.Z.canWithPartialContext(T.Plq.MOVE_MEMBERS, {
                        channelId: A
                    }) ? (0, r.jsx)(u.MenuItem, {
                        id: "voice-disconnect",
                    ...
                    ee = null;
                if (!k && null != Z && null != z && null != z.joinedAt && (h.Z.canManageUser(T.Plq.MODERATE_MEMBERS, e, Z) || h.Z.canManageUser(T.Plq.MANAGE_ROLES, e, Z)) && Z.hasFeature(T.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
                    var te;
                ...
                }, "timeout") : null, h.Z.canManageUser(T.Plq.KICK_MEMBERS, e, Z) ? (0, r.jsx)(u.MenuItem, {
                    id: "kick",
                ...
                }, "kick") : null, h.Z.canManageUser(T.Plq.BAN_MEMBERS, e, Z) ? (0, r.jsx)(u.MenuItem, {
                    id: "ban",
        ...
        100856: (e, t, n) => {
            ...
            function T(e, t) {
                ...
                var S = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== T.id && (b ? _.Z.can(y.Plq.CONNECT, n) && !(0, I.rY)(n, h.Z, p.Z) : _.Z.can(y.Plq.MOVE_MEMBERS, n) && (_.Z.can(y.Plq.CONNECT, n) || v.ZP.can({
        ...
        973424: (e, t, n) => {
            ...
            function v(e, t) {
                ...
                if (!b) return null;
                var m = d.Z.getHighestRole(h),
                    A = Object.values(h.roles).filter((function(e) {
                        return e.id !== h.id
                    })),
                    N = S ? A.map((function(e) {
                        var t = e.managed || !d.Z.isRoleHigher(h, m, e),
                            n = -1 !== T.indexOf(e.id);

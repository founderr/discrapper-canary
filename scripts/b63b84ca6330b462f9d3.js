...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [67368, 71775], {
        71775: (e, n, t) => {
            ...
            function u(e, n) {
                var t = (0, i.e7)([o.ZP], (function() {
                    return o.ZP.getGuildScheduledEvent(n)
                }), [n]);
                return r.useMemo((function() {
                    return null == t ? void 0 : t.guild_scheduled_event_exceptions.find((function(n) {
                        return n.event_exception_id === e
                    }))
                }), [null == t ? void 0 : t.guild_scheduled_event_exceptions, e])
            }
        },
        389853: (e, n, t) => {
            t.r(n);
            ...
            function Q(e) {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(J.Z, {
                        ...
                        className: Y().title,
                        children: u ? K.Z.Messages.HUB_EVENTS_HEADER_TITLE : K.Z.Messages.GUILD_EVENT_MODAL_EMPTY_TITLE
                    }), (0, r.jsx)(l.Text, {
                        color: "header-secondary",
                        variant: "text-sm/normal",
                        className: Y().subtitle,
                        children: u ? K.Z.Messages.HUB_EVENTS_HEADER_DESCRIPTION : K.Z.Messages.GUILD_EVENT_MODAL_EMPTY_SUBTITLE
                    }), o && (0, r.jsx)(l.Text, {
                        color: "header-secondary",
                        variant: "text-sm/normal",
                        className: Y().roleTip,
            ...
            function ae(e) {
                var n = e.transitionState,
                    ...
                    x = (0, a.e7)([b.Z], (function() {
                        return b.Z.getGuild(P)
                    })),
                    N = (0, j.Z)(null == x ? void 0 : x.id),
                    I = (0, _.ZP)(P),
                    C = i.useRef(h.ZP.ackMessageId(P, ee.W.GUILD_EVENT)),
                    k = (0, X.Z)();
                i.useEffect((function() {
                    Z.Z.getGuildEventUserCounts(P);
                    Z.Z.getGuildEventsForCurrentUser(P)
                }), [P]);
                i.useEffect((function() {
                    var e = b.Z.getGuild(P);
                    if (null == e ? void 0 : e.hasFeature(V.oNc.HUB)) {
                        if (f.Z.getCurrentConfig({
                                guildId: P,
                                location: "d3755f_1"
                            }).showHubEventsList) {
                            var n = p.ZP.getDefaultChannel(P);
                            null != n && d.c(n.id)
                        }
                    }
                }), [P]);
                ...
                i.useEffect((function() {
                    u()(I).map((function(e) {
                        ...
                        g.Z.requestMember(P, e)
                    }))
                }), [P, I]);
                i.useEffect((function() {
                    null != P && (0, s.Ju)(P, ee.W.GUILD_EVENT)
                }), [P]);

        ...
        652411: (e, t, n) => {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = A(e.minStart),
                                ...
                                C = A(e.minDirection),
                                R = A(e.maxDirection);
                            return new h(new T(g(n.x, r.x), g(d.x, f.x), g(_.x, E.x), g(p.x, v.x), y(C.x, R.x), I(e.easingFunctions)[0]), new T(g(n.y, r.y), g(d.y, f.y), g(_.y, E.y), g(p.y, v.y), y(C.y, R.y), I(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = C(e.minStart),
                                ...
                                A = C(e.minDirection),
                                R = C(e.maxDirection);
                            return new v(new T(g(n.x, r.x), g(d.x, f.x), g(_.x, E.x), g(p.x, h.x), y(A.x, R.x), I(e.easingFunctions)[0]), new T(g(n.y, r.y), g(d.y, f.y), g(_.y, E.y), g(p.y, h.y), y(A.y, R.y), I(e.easingFunctions)[0]), new T(g(n.z, r.z), g(d.z, f.z), g(_.z, E.z), g(p.z, h.z), y(A.z, R.z), I(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector3"
                }))
                    ...
                    g = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == _ || _(t), v.current.size > 0 ? m.current = window.requestAnimationFrame(g) : (t.clearRect(0, 0, e.width, e.height), m.current = null);
                                var n = Date.now();
            ...
            var L = r.forwardRef((function(e, t) {
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, m()];
                                    case 1:
                                        return e.sent(), v(), p.current = !0, O(!0), [2]
                                }
                            }))
                        }))
                    }), [O, m, v]);
                return r.useEffect((function() {
                    ...
                    null != _.current && (_.current.width = (d + 2) * Math.max(s.length, 1), _.current.height = (f + 2) * c.length)
                    ...
                    children: (0, r.jsx)("div", {
                        ...
                        children: (0, r.jsxs)(u.FocusRingScope, {
                            ...
                            children: [(0, r.jsx)("div", {
                                ...
                                className: f().actions,
                                children: [null != _ && (0, r.jsx)(u.Button, {
                                    ...
                                    text: I,
                                    children: function(e) {
                                        return (0, r.jsx)(u.Button, p(function(e) {
        ...
        370801: (e, t, n) => {
            ...
            var r = n(785893),
                ...
                m = function() {
                    return (0, r.jsx)(l.Z, {
                        submitting: !1,
                        message: p.Z.Messages.MEMBER_VERIFICATION_PROGRESS_LOST_TITLE,
                        onReset: function() {
                            (0, f.PE)(!1)
                        },
                        onResetText: p.Z.Messages.CANCEL,
                        onSave: function() {
                            (0, f.PE)(!1);
                            (0, u.closeModal)(E.Pn)
                        },
                        onSaveText: p.Z.Messages.MEMBER_VERIFICATION_PROGRESS_LOST_CONTINUE,
            ...
            function h() {
                return (h = d((function(e) {
                    return f(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                return l.Z.shouldFetch(e) ? [4, _(e)] : [3, 2];
                            case 1:
                                t.sent();
                                t.label = 2;
                            case 2:
            ...
            const T = {
                ...
                removePhone: function(e, t) {
                    return u.getCurrentConfig({
                        ...
                        modalProps: {
                            title: _.Z.Messages.USER_SETTINGS_ACCOUNT_REMOVE_PHONE_NUMBER_BUTTON,
                            actionText: _.Z.Messages.USER_SETTINGS_ACCOUNT_REMOVE_PHONE_NUMBER_BUTTON
                        },
                        checkEnabled: !1
                    }) : i.ZP.delete({
                        url: f.ANM.PHONE,

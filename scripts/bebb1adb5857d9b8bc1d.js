...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [15408, 56620], {
            ...
            function A(e) {
                return function(e) {
                    switch (e.type) {
                        ...
                        case "linear-random":
                            return new h(v(e.minValue, e.maxValue), v(e.minAddValue, e.maxAddValue));
                        case "oscillating":
                            return new I(e.value, e.start, e.final, e.duration, e.direction, e.easingFunction);
                        case "oscillating-random":
                            return new I(v(e.minValue, e.maxValue), v(e.minStart, e.maxStart), v(e.minFinal, e.maxFinal), v(e.minDuration, e.maxDuration), b(e.minDirection, e.maxDirection), T(e.easingFunctions)[0])
                    }
                }(E(E({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "linear":
                            t = g(e.value);
                            var i = g(e.addValue);
                            return new O(new h(t.x, i.x), new h(t.y, i.y));
                        case "linear-random":
                            n = g(e.minValue), r = g(e.maxValue);
                            var o = g(e.minAddValue),
                                a = g(e.maxAddValue);
                            return new O(new h(v(n.x, r.x), v(o.x, a.x)), new h(v(n.y, r.y), v(o.x, a.x)));
                        case "oscillating":
                            t = g(e.value);
                            var u = g(e.start),
                                c = g(e.final),
                                l = g(e.duration),
                                s = g(e.direction);
                            return new O(new I(t.x, u.x, c.x, l.x, s.x, e.easingFunction), new I(t.y, u.y, c.y, l.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = g(e.minValue), r = g(e.maxValue);
                            var f = g(e.minStart),
                                d = g(e.maxStart),
                                ...
                                C = g(e.minDirection),
                                A = g(e.maxDirection);
                            return new O(new I(v(n.x, r.x), v(f.x, d.x), v(p.x, E.x), v(_.x, m.x), b(C.x, A.x), T(e.easingFunctions)[0]), new I(v(n.y, r.y), v(f.y, d.y), v(p.y, E.y), v(_.y, m.y), b(C.y, A.y), T(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "linear":
                            t = C(e.value);
                            var i = C(e.addValue);
                            return new m(new h(t.x, i.x), new h(t.y, i.y), new h(t.z, i.z));
                        case "linear-random":
                            n = C(e.minValue), r = C(e.maxValue);
                            var o = C(e.minAddValue),
                                a = C(e.maxAddValue);
                            return new m(new h(v(n.x, r.x), v(o.x, a.x)), new h(v(n.y, r.y), v(o.y, a.y)), new h(v(n.z, r.z), v(o.z, a.z)));
                        case "oscillating":
                            t = C(e.value);
                            var u = C(e.start),
                                c = C(e.final),
                                l = C(e.duration),
                                s = C(e.direction);
                            return new m(new I(t.x, u.x, c.x, l.x, s.x, e.easingFunction), new I(t.y, u.y, c.y, l.z, s.y, e.easingFunction), new I(t.z, u.z, c.z, l.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = C(e.minValue), r = C(e.maxValue);
                            var f = C(e.minStart),
                                d = C(e.maxStart),
                                ...
                                g = C(e.minDirection),
                                A = C(e.maxDirection);
                            return new m(new I(v(n.x, r.x), v(f.x, d.x), v(p.x, E.x), v(_.x, O.x), b(g.x, A.x), T(e.easingFunctions)[0]), new I(v(n.y, r.y), v(f.y, d.y), v(p.y, E.y), v(_.y, O.y), b(g.y, A.y), T(e.easingFunctions)[0]), new I(v(n.z, r.z), v(f.z, d.z), v(p.z, E.z), v(_.z, O.z), b(g.z, A.z), T(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector3"
                }))
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, y()];
                                    case 1:
                                        return e.sent(), m(), _.current = !0, h(!0), [2]
                                }
                            }))
                        }))
                    }), [h, y, m]);
            ...
            const b = new T(i.Z, {
                ...
                GIFT_CODE_REDEEM_SUCCESS: function(e) {
                    ...
                    a.Z.getCurrentConfig({
                        ...
                        autoTrackExposure: !1
                    }).enabled && (null == t ? void 0 : t.sku_id) === u.Si.TIER_2 && null == o.Z.getPremiumSubscription(!1) && null == y.tutorialExpirationTime && I()
                }
            })
        },
        156620: (e, t, n) => {
        ...
        305082: (e, t, n) => {
            ...
            function A() {
                return e = C, t = g, n = I("useMemoizedValueSyncedWithDismissibleContents"), o = (0, i.e7)([c.Z], (function() {
                    var e;
        ...
        585798: (e, t, n) => {
            ...
            var b = (0, l.Z)((function(e) {
                return {
                    ...
                    addLayer: function(t) {
                        return e((function(e) {
                            return {
                                fullScreenLayers: I(e.fullScreenLayers).concat([t])
                            }
                        }))
                    }
                }
            ...
            function R(e) {
                ...
                b.setState((function(t) {
                    return {
                        fullScreenLayers: I(t.fullScreenLayers).concat([{
                            key: i,

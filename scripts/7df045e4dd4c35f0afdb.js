(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["77320"], {
        ...
        458389: function(e, t, n) {
            ...
            e.exports = function(e, t) {
                var n = l(e),
                    ...
                    h = p.length;
                for (var g in e)(t || u.call(e, g)) && !(E && ("length" == g || d && ("offset" == g || "parent" == g) || f && ("buffer" == g || "byteLength" == g || "byteOffset" == g) || s(g, h))) && p.push(g);
                return p
            }
        },
        ...
        278108: function(e, t, n) {
            ...
            class E extends r.PureComponent {
                ...
                render() {
                    ...
                    return f ? (t = c.default.getDiscordUtils().inputCaptureRegisterElement, e = this.handleNativeChange) : !u.isPlatformEmbedded && (e = this.handleComboKeys), (0, i.jsx)(a.default, {
                        disabled: l,
                        value: n,
                        mode: r,
                ...
                constructor(e) {
                    super(e), this._mounted = !1, this.recordStart = () => {
                        ...
                        if (n.preventDefault(), "keydown" === n.type) {
                            let e = t.map(e => [d.KeyboardDeviceTypes.KEYBOARD_KEY, o(e), d.KeyboardEnvs.BROWSER]),
                                {
                                    keyCode: i
                                } = n;
                            null == e.find(e => {
                                let [, t] = e;
                                return i === t
                            }) && e.push([d.KeyboardDeviceTypes.KEYBOARD_KEY, i, d.KeyboardEnvs.BROWSER]), this.handleComboChange(e)
                        }
            ...
            class c extends r.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: m,
                        retrySuccess: I
                    } = this.state, v = r.Children.count(l) > 0 ? (0, i.jsx)(s.Card, {
                    ...
                    return (0, i.jsx)(s.ModalRoot, {
                        ...
                        children: (0, i.jsxs)("form", {
                            ...
                            children: [(0, i.jsx)(s.ModalHeader, {
                                ...
                                children: [null != p ? (0, i.jsx)(s.Text, {
                                    color: "text-normal",
                                    variant: "text-md/normal",
                                    className: u.spacing,
                                    children: p
                                }) : null, v, C, (0, i.jsxs)(s.FormItem, {
        ...
        312165: function(e, t, n) {
            ...
            let u = [],
                c = (e, t, n) => {
                    let i = (0, l.isWindows)() ? 0 : 1;
                    (e !== a.KeyboardDeviceTypes.MOUSE_BUTTON || n !== i) && u.forEach(i => i._handleEvent(e, t, n))
                };
            i = class extends r.EventEmitter {
                ...
                constructor() {
                    super(), this.combo = [], u.push(this), 1 === u.length && o.default.setOnInputEventCallback(c)
                }
            }
        },
        ...
        479756: function(e, t, n) {
            ...
            function R(e) {
                ...
                if (!i && !c.default.can(g.Permissions.VIEW_CHANNEL, n)) {
                    let t = s.default.getDefaultChannel(e);
                    null != t && (0, l.transitionTo)(g.Routes.CHANNEL(e, t.id))
                }
            }
        ...
        644926: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    transitionState: n,
                    onClose: _
                } = e, m = (0, l.useStateFromStores)([c.default], () => c.default.getKeybindForAction(p.GlobalKeybindActions.SOUNDBOARD_HOLD)), [I, v] = r.useState(null !== (t = null == m ? void 0 : m.shortcut) && void 0 !== t ? t : []);
                return r.useEffect(() => (u.default.disable(), () => {
                    ...
                    children: [(0, i.jsxs)(o.ModalHeader, {
                        ...
                        children: [(0, i.jsx)(o.Button, {
                            onClick: function() {
                                if (0 === I.length) return null != m && s.default.deleteKeybind(m.id), _();
                                null == m ? s.default.addKeybind({
        ...
        865372: function(e, t, n) {
            ...
            class _ extends l.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (f = e), this.syncWith([u.default], h), this.syncWith([a.default], g)
                }
                getState() {
                    return f
                }
        ...
        3958: function(e, t, n) {
            ...
            var i, r, l = n("37983"),
                ...
                g = n("782340"),
                _ = n("523192");
            (r = i || (i = {})).DEFAULT = "DEFAULT", r.RECORDING = "RECORDING";
            let m = {
                DEFAULT: _.default,
            ...
            class I extends o.PureComponent {
                ...
                render() {
                    ...
                    let {
                        ...
                        value: n,
                        disabled: i
                    } = this.props, r = (0, p.toString)(n, !0);
                    e = "RECORDING" === t ? g.default.Messages.SHORTCUT_RECORDER_BUTTON_RECORDING : 0 === n.length ? g.default.Messages.SHORTCUT_RECORDER_BUTTON : g.default.Messages.SHORTCUT_RECORDER_BUTTON_EDIT;
                    ...
                    return (0, l.jsx)(E.FocusRing, {
                        ...
                        children: (0, l.jsx)("div", {
                            ...
                            className: a(_.container, m[t], {
                                [_.hasValue]: o,
                                [_.disabled]: i
                            }),
                            children: (0, l.jsxs)(h.default, {
                                className: _.layout,
                                children: [(0, l.jsx)(h.default.Child, {
                                    className: _.input,

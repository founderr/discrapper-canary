...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [32162], {
        32162: (t, e, n) => {
            ...
            const s = {
                setDesktopType: function(t) {
                    r.Z.dispatch({
                        type: "NOTIFICATIONS_SET_DESKTOP_TYPE",
                        desktopType: t
                    })
                },
                setTTSType: function(t) {
                    r.Z.dispatch({
                        type: "NOTIFICATIONS_SET_TTS_TYPE",
                        ttsType: t
                    })
                },
                setDisabledSounds: function(t) {
                    r.Z.dispatch({
                ...
                showNotification: function(t, e, n, i) {

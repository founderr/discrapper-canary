(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [36401, 29202, 91683, 58635, 84832, 86502, 96043, 71402], {
        737264: e => {
            "use strict";
            ...
            function D(e) {
                ...
                if (!T.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== m.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = M(u, i),
                        c = A({}, t, R(a), null != i && null != o && (0, y.AB)(o) ? P(0, o) : L(u));
                    T.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        980604: (e, t, n) => {
            ...
            function z() {
                V = S.Z.getGuildCount() >= 3 || i().size(s.Z.getMutablePrivateChannels()) >= 20;
                K = []
            }
            ...
            function X() {
                ...
                switch (B) {
                    case l.h8.USER:
                        var o = O.default.getId();
                        return b.ZP.getRecentlyTalked(r, 100).filter((function(e) {
                ...
                for (var u = [], a = [], c = 1; c < q.length; c += 1) {
                    var f = Q(q[c]);
                    null != f && ((f.type !== l.h8.TEXT_CHANNEL && f.type !== l.h8.VOICE_CHANNEL || g.Z.can(E.Plq.VIEW_CHANNEL, f.record)) && a.push(f))
                }
                if (a.length > 0) {
                    var d;
                    (d = u).push.apply(d, [(0, l.o6)(P.Z.Messages.QUICKSWITCHER_LAST_CHANNEL)].concat(w(a)))
                }
                var _ = function(e) {
                    var t = [];
                    h.Z.getRecentlyEditedDrafts(h.d.ChannelMessage).forEach((function(n) {
                        var r = n.channelId;
                        if (!e(r)) {
                            var i = Q(r);
                            null != i && t.push(i)
                ...
                if (_.length > 0) {
                    var I;
                    (I = u).push.apply(I, [(0, l.o6)(P.Z.Messages.QUICKSWITCHER_DRAFTS)].concat(w(_)))
                }
                var T = m.ZP.getMentionChannelIds().filter((function(e) {
                    return e !== r && !q.includes(e)
                })).map((function(e) {
                    return Q(e)
                })).filter(R.lm).reverse();
                ...
                if (null != n) {
                    var S = v.ZP.getSelectableChannelIds(n).filter((function(e) {
                        var t = s.Z.getChannel(e);
                        return !(null == t || e === r || q.includes(e) || A.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && A.Z.isChannelMuted(t.guild_id, t.parent_id)) && m.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return Q(e)
                    })).filter((function(e) {
                        return e
            ...
            function J(e, t) {
                switch (B) {
                    case l.h8.USER:
                        var n = S.Z.getGuild(N.Z.getGuildId());
                ...
                if (t !== Y) {
                    ...
                    H = (0, l.gJ)(l.a8.DOWN, -1, x)
                } else {
                    var r = x[H];
                    null != r && r.type === l.h8.HEADER && (H = (0, l.gJ)(l.a8.DOWN, H, x))
                }
                re.emitChange()
            }
            ...
            function $(e) {
                var t, n = e.query,
                    ...
                    o = new Set(["user:".concat(O.default.getId())]);
            ...
            var re = new ne(a.Z, {
                ...
                QUICKSWITCHER_SEARCH: function(e) {
                    ...
                    B = r;
                    j.search(n, B === l.h8.USER ? i : void 0)
                },
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[e] && null != C[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var a in C[e][t]) t === D ? d.ZP.isNewForumThread(a, t, r) && M[e][t]++ : o.default.compare(a, i) > 0 && !d.ZP.hasOpenedThread(a) && M[e][t]++
                        }
                    }
                }
            }
        ...
        491260: (e, t, n) => {
            ...
            var H = function(e) {
                ...
                r.getActivities = function(e) {
                    ...
                    if (null == t) {
                        var n;
                        return null !== (n = b[e]) && void 0 !== n ? n : y
                    }
                    var r = C(e, t);
        ...
        788169: (e, t, n) => {
            ...
            function g(e) {
                var t;
                return null !== (t = T[e]) && void 0 !== t ? t : S
            }
            ...
            const b = new A(o.Z, {
                ...
                TYPING_START_LOCAL: function(e) {
                    ...
                    if (null == n) return !1;
                    if (t === c.V) return !1;
                    if (null != h && h.channelId !== t) {
                        null != h.timeout && clearTimeout(h.timeout);
                        h = null
                    }
                    var r = Date.now();
                    if (null != h && (null != h.timeout || h.prevSend + 8e3 > r)) return !1;
                    var s = null == h || h.prevSend > r - 16e3 ? 1500 : 0,
                        f = setTimeout((function() {
                            if (null != h && h.channelId === t && n === u.default.getId() && null != h.timeout) {
                                h.timeout = null;
                                (function(e) {
                                    var t = g(e);
                ...
                TYPING_STOP_LOCAL: function(e) {
                    var t = e.channelId,
                        n = u.default.getId();
                    if (null == n) return !1;
                    if (null != h && h.channelId === t && null != h.timeout) {
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    e.optimistic && function(e) {
                        if (null == h || h.channelId !== e) return !1;
                        null != h.timeout && clearTimeout(h.timeout);
                        h = null
                    }(t);
                    return y({
        ...
        796909: (e, t, n) => {
            ...
            function C() {
                ...
                (0, l.cn)() && (0, c.x7)() && I.Z.getAddedToMessages().forEach((function(e) {
                    ...
                    null != t && (0, d.zi)(t.type) && b.set(t.id, P(t))
                }))
            }

            function L() {
                var e = _.Z.getMutablePrivateChannels();
                for (var t in e) b.set(t, P(e[t]))
            }
            var U, M, D, w = (U = [], M = [], D = [], function() {
                    var e = b.values(y.FAVORITE),
                        t = b.values(y.DEFAULT);
                    if (U !== e || M !== t) {
                        D = [];
                ...
                G = function(e) {
                    ...
                    var r = n.prototype;
                    r.initialize = function() {
                        this.waitFor(_.Z, E.Z, O.default, s.Z, I.Z);
                    ...
                    r.getSortedChannels = function() {
                        return [b.values(y.FAVORITE), b.values(y.DEFAULT)]
                    };
            ...
            const Z = new G(a.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, d.hv)(e.type) || b.has(e.id)) && b.set(e.id, P(e))
                    }))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && b.set(t, P(r, n.id))
                },
                GUILD_CREATE: function(e) {
                    var t = e.guild.id;
                    return b.delete(t)
            ...
            var v = function(e, t) {
                ...
                T = function(e) {
                    var t = e.omitUserIds,
                        ...
                        h = void 0;
                    try {
                        for (var T, S = f.Z.getPrivateChannelIds()[Symbol.iterator](); !(I = (T = S.next()).done); I = !0) {
                            var g = T.value;
                    ...
                    for (var o, a = f.Z.getPrivateChannelIds()[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                        ...
                        if (null != d && d.isDM() && null != l.ZP.lastMessageId(d.id)) {
                            ...
                            if (null != _ && !e.has(_)) {
                                ...
                                if (null == E || E.bot || v(t, E.id)) continue;
                                return E
                            }
                        }
                    }
        ...
        58964: (e, t, n) => {
            ...
            function E(e, t) {
                ...
                var _, E, p, I, O, h = encodeURIComponent(l.toString()),
                    v = encodeURIComponent(a()),
                    T = (p = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), I = null != (null === i() || void 0 === i() || null === (_ = i().ua) || void 0 === _ ? void 0 : _.match(p)), O = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !I, "iOS" !== (null === i() || void 0 === i() || null === (E = i().os) || void 0 === E ? void 0 : E.family) || O ? 1 : 0),
                    S = null != r ? encodeURIComponent(r) : null,
                    g = null != o ? encodeURIComponent(o) : null,
                    m = "".concat(f, "/?link=").concat(h, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(v, "&efr=").concat(T);
                null != S && (m += "&afl=".concat(S));

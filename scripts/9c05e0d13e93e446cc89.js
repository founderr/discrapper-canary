(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["27660"], {
        ...
        783480: function(e, t, n) {
            ...
            function N(e) {
                ...
                let c, {
                    ...
                    j = new f.default(I.Endpoints.MESSAGES(d)),
                    U = {
                        content: "",
                        nonce: "",
                        channel_id: d,
                ...
                null != M && (U.content = null == M ? void 0 : M.content);
                let b = _.default.getPendingReply(d);
                null != b && (U.type = I.MessageTypes.REPLY, U.message_reference = y.messageReference, U.allowed_mentions = y.allowedMentions, (0, R.deletePendingReply)(d));
                let [x, L] = (0, g.default)(U.content);
                x && (U.content = L, U.flags = (0, C.addFlag)(null !== (t = U.flags) && void 0 !== t ? t : 0, I.MessageFlags.SUPPRESS_NOTIFICATIONS));
                let P = null !== (n = y.nonce) && void 0 !== n ? n : (0, p.createNonce)(),
                    D = (0, p.default)({
                        channelId: d,
                        content: U.content,
                ...
                j.on("error", (e, t, n, i) => {
                    if (a.default.dispatch({
                        ...
                        }), t === I.AbortCodes.EXPLICIT_CONTENT) {
                        l.default.sendClydeError(d, t);
                        return
                    }
                    if (t === I.AbortCodes.AUTOMOD_MESSAGE_BLOCKED) {
                        let e = {
                                code: t,
                    ...
                    t !== I.AbortCodes.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS && ((0, r.openUploadError)({
                        title: O.default.Messages.UPLOAD_AREA_UPLOAD_FAILED_TITLE,
                        help: O.default.Messages.UPLOAD_AREA_UPLOAD_FAILED_RETRY_HELP
                    }), "" !== U.content && "" === S.default.getDraft(d, v) && s.default.saveDraft(d, U.content, v), 0 === A.default.getUploadCount(d, v) && o.default.setUploads({
                        channelId: d,
                        uploads: N,
                        draftType: v
                    }))
                ...
                upload: function e(t) {
                    ...
                    if (null != c) {
                        ...
                        if (null != e) {
                            ...
                            h.type = I.MessageTypes.REPLY, h.message_reference = t.messageReference, h.allowed_mentions = t.allowedMentions, (0, R.deletePendingReply)(n)
                        }
                    }
                    let p = new f.default(I.Endpoints.MESSAGES(n));
                    p.on("start", e => {
                        a.default.dispatch({
                            type: "UPLOAD_START",
                            channelId: n,
                        ...
                        if (a.default.dispatch({
                                ...
                                fileItems: t.items,
                                failureCode: d
                            }), d === I.AbortCodes.EXPLICIT_CONTENT) {
        ...
        57155: function(e, t, n) {
            ...
            let ee = f.default.connectStores([L.default], e => {
                let {
                    message: t,
                    reaction: n,
                    reactionType: i
                } = e, a = L.default.getReactions(t.getChannelId(), t.id, n.emoji, Y.DEFAULT_NUM_REACTION_USERS, i);
                if (null == a) return {
                    reactors: [],
                    hasMore: !1
                };
            ...
            function et(e) {
                ...
                let {
                    ...
                    onClose: o,
                    transitionState: r
                } = e, u = (0, f.useStateFromStores)([b.default], () => b.default.getChannel(s.getChannelId())), c = null == u ? void 0 : u.getGuildId(), d = (0, f.useStateFromStores)([P.default, A.default, I.default], () => {
                    var e, t, n;
                    let i = null !== (n = null !== (t = P.default.getMessage(s.getChannelId(), s.id)) && void 0 !== t ? t : null === (e = A.default.getMessage(s.id)) || void 0 === e ? void 0 : e.firstMessage) && void 0 !== n ? n : null != c ? I.default.getCachedMessage(c, s.getChannelId(), s.id) : void 0;
        ...
        58533: function(e, t, n) {
            ...
            function T(e) {
                let {
                    ...
                    startPosition: T,
                    targetPosition: R
                } = e, [_, g] = a.useState(0), [S, A] = a.useState(0), [C, I] = a.useState(null), {
                    confettiCanvas: O
        ...
        350134: function(e, t, n) {
                            ...
                            children: () => (0, i.jsx)("div", {
                                ...
                                children: (0, i.jsx)(r.default.div, {
                                    className: l(L.reaction, R, {
                                        ...
                                        [L.reactionReadOnly]: f && !m && !T && !E,
                                        [L.shakeReaction]: A && O && null == v
                                    }),
                                    style: P,
                                    children: (0, i.jsx)(h.Popout, {
                ...
                constructor(...e) {
                    super(...e), this.isReactionEventActive = !1, this.isKeyboardNavigation = !1, this.scale = new r.default.Value(1), this.opacity = new r.default.Value(1), this.timeout = new f.Timeout, this.hideTimeout = new f.Timeout, this.ctaRef = a.createRef(), this.type = $.ReactionTypes.NORMAL, this.colors = {
                        ...
                        let E = t.getChannelId(),
                            T = r ? P.ReactionLocations.FORUM_TOOLBAR : P.ReactionLocations.MESSAGE;
                        if (a && !i && this.isMe()) c ? (0, P.removeReaction)(E, t.id, n, void 0, T, {
                            burst: a
                            ...
                            if (a && !this.userCanBurstReact()) {
                                ...
                                return
                            } else s ? this.handleShowVerificationGate() : !i && (this.isMe() ? (0, P.removeReaction)(E, t.id, n, void 0, T) : (0, P.addReaction)(E, t.id, n, T, {
                                burst: a
                            }))
                        } else {
            ...
            let eT = a.memo(e => {
                    let {
                        ...
                        autoTrackExposure: !1
                    }), p = (0, I.useEmojiColorPalette)(l && null != n ? n : []), E = (0, c.useStateFromStores)([Z.default], () => void 0 !== Z.default.getEffectForEmojiId(a.getChannelId(), a.id, s)), _ = (0, c.useStateFromStores)([R.default], () => R.default.useReducedMotion), S = B.AnimateEmoji.useSetting(), A = (0, g.isDismissibleContentDismissed)(d.DismissibleContent.BURST_REACTIONS_REMOVE_MODAL), [C, O] = (0, c.useStateFromStoresArray)([Q.default], () => [Q.default.remainingBurstCurrency, Q.default.emojiReactionToTargetForCoachmark]), N = G.default.getCurrentUser(), M = (0, X.isPremium)(N), y = (0, g.isDismissibleContentDismissed)(d.DismissibleContent.SUPER_REACTIONS_FREE_USER_FIRST_SENT), j = o && !(0, X.isNewUser)(N) && C > 0 && !y && null != O && s.id === O.id && s.name === O.name;
                ...
                e_ = e => {
                    ...
                    }), I = S.autoUnfurlReactionTooltip, O = null !== (t = null == d ? void 0 : d.isDiscoverable()) && void 0 !== t && t, N = V.default.getGuildId(), v = null != N && (N === (null == d ? void 0 : d.id) || N === (null == u ? void 0 : u.id)), j = (0, ee.getEmojiPopoutData)({
                    ...
                    return I ? (0, i.jsxs)("div", {
                        children: [R ? P() : null, E ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                        ...
                        children: [L ? P() : x(), E ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                            className: eu.emojiDetailsLoader
                        }) : L && (0, i.jsx)(eR, {
                            emojiId: n,
                            expressionSourceGuild: d,
        ...
        81924: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                T = a.memo(function(e) {
                    ...
                    } = (0, o.useBurstReactionsExperiment)(null, !1), A = (0, s.useStateFromStores)([d.default], () => d.default.getEffectForEmojiId(t, n, T)), C = R ? E : p, I = a.useMemo(() => (0, h.buildEffect)(T, _, t, {
                        key: A,
                        messageId: n

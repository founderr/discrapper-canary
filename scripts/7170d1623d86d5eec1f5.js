            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(o, a) {
                        ...
                        var l, s, c, d, f, E, _, p, h, I, T, S, A, g, C, R, N = (l = o, f = Array(32768), l.forEach(function(n) {
                        ...
                        var v = (E = o, _ = N, T = 1e6, S = 0, A = 1e6, g = 0, C = 1e6, R = 0, E.forEach(function(t) {
                                p = t[0] >> e, h = t[1] >> e, I = t[2] >> e, p < T ? T = p : p > S && (S = p), h < A ? A = h : h > g && (g = h), I < C ? C = I : I > R && (R = I)
                            }), new i(T, S, A, g, C, R, _)),
            ...
            function u(e) {
                let t = function(e) {
                    let {
                        ...
                        return i
                    }, g = A(_, p, (a >> 18 & 31) / 31), C = A(3, 3, 1.25 * ((l >> 3 & 63) / 63)), R = A(3, 3, 1.25 * ((l >> 9 & 63) / 63)), N = f && A(5, 5, I), m = r(e), v = o(m > 1 ? 32 : 32 * m), O = o(m > 1 ? 32 / m : 32), M = new Uint8Array(v * O * 4), U = [], y = [];
                    for (let e = 0, r = 0; e < O; e++)
                        for (let o = 0; o < v; o++, r += 4) {
                            let a = s,
                                l = c,
                                E = d,
                                I = h;
                            for (let e = 0, n = i(_, f ? 5 : 3); e < n; e++) U[e] = u(t / v * (o + .5) * e);
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * y[e]; n < 5 - e; n++, t++) I += N[t] * U[n] * r;
                            let T = a - 2 / 3 * l,
                                S = (3 * a - T + E) / 2,
                                A = S - E;
                ...
                (0, u.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, r.jsx)(e, {
                            ...
                            onComplete: () => {
                                L = !0, null == p || p(), !g && ((0, l.setIsPersistentHelperHidden)(!0), (0, l.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: h,
                            analyticsLocations: I,
                            analyticsObject: T,
                    ...
                    onCloseCallback: () => {
                        !L && s.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: O,
                            location_stack: I
                        }), (0, o.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == _ || _(L), L && (!g && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == h || h())
                    },

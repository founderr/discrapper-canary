    ...
    ["51077"], {
        ...
        393745: function(e, t, l) {
            ...
            function A(e) {
                ...
                null == o && (o = a === x.GuildScheduledEventEntityTypes.EXTERNAL ? S.default.Messages.STAGE_CHANNEL_HAPPENING_NOW : S.default.Messages.STAGE_CHANNEL_LIVE_NOW);
                let [{
                ...
                let U = r.useMemo(() => l === x.GuildScheduledEventStatus.CANCELED ? n.CANCELED : l === x.GuildScheduledEventStatus.ACTIVE ? n.STARTED : x.GuildScheduledEventStatusDone.has(l) ? n.ENDED : O ? n.READY : G ? n.STARTING_SOON : n.SCHEDULED, [l, O, G]),
                    H = function(e, t, l, a, r) {
                        switch (e) {
                            case n.STARTING_SOON:
                            ...
                            case n.STARTED:
                                return null != a && "" !== a ? S.default.Messages.START_DATE_TO_END_DATE_WITH_COLOR.format({
                                    start: l,

    ...
    [98753, 17586, 65614, 84832, 4350, 93364, 74996], {
            ...
            function D(t) {
                return function(t) {
                    switch (t.type) {
                        case "static":
                            var e = b(t.value);
                            return new f(new T(e.x), new T(e.y));
                        case "static-random":
                            var r = b(t.minValue),
                                n = b(t.maxValue);
                            return new f(new T(A(r.x, n.x)), new T(A(r.y, n.y)));
                        case "linear":
                            e = b(t.value);
                            var a = b(t.addValue);
                            return new f(new p(e.x, a.x), new p(e.y, a.y));
                        case "linear-random":
                            r = b(t.minValue), n = b(t.maxValue);
                            var i = b(t.minAddValue),
                                o = b(t.maxAddValue);
                            return new f(new p(A(r.x, n.x), A(i.x, o.x)), new p(A(r.y, n.y), A(i.x, o.x)));
                        case "oscillating":
                            e = b(t.value);
                            var u = b(t.start),
                                l = b(t.final),
                                c = b(t.duration),
                                s = b(t.direction);
                            return new f(new O(e.x, u.x, l.x, c.x, s.x, t.easingFunction), new O(e.y, u.y, l.y, c.x, s.y, t.easingFunction));
                        case "oscillating-random":
                            r = b(t.minValue), n = b(t.maxValue);
                            var v = b(t.minStart),
                                d = b(t.maxStart),
                                ...
                                y = b(t.minDirection),
                                I = b(t.maxDirection);
                            return new f(new O(A(r.x, n.x), A(v.x, d.x), A(_.x, E.x), A(R.x, h.x), g(y.x, I.x), N(t.easingFunctions)[0]), new O(A(r.y, n.y), A(v.y, d.y), A(_.y, E.y), A(R.y, h.y), g(y.y, I.y), N(t.easingFunctions)[0]))
                    }
                }(E(E({}, t), {
                    valueType: "Vector2"
                }))
            ...
            function C(t) {
                return function(t) {
                    switch (t.type) {
                        case "static":
                            var e = y(t.value);
                            return new h(new T(e.x), new T(e.y), new T(e.z));
                        case "static-random":
                            var r = y(t.minValue),
                                n = y(t.maxValue);
                            return new h(new T(A(r.x, n.x)), new T(A(r.y, n.y)), new T(A(r.z, n.z)));
                        case "linear":
                            e = y(t.value);
                            var a = y(t.addValue);
                            return new h(new p(e.x, a.x), new p(e.y, a.y), new p(e.z, a.z));
                        case "linear-random":
                            r = y(t.minValue), n = y(t.maxValue);
                            var i = y(t.minAddValue),
                                o = y(t.maxAddValue);
                            return new h(new p(A(r.x, n.x), A(i.x, o.x)), new p(A(r.y, n.y), A(i.y, o.y)), new p(A(r.z, n.z), A(i.z, o.z)));
                        case "oscillating":
                            e = y(t.value);
                            var u = y(t.start),
                                l = y(t.final),
                                c = y(t.duration),
                                s = y(t.direction);
                            return new h(new O(e.x, u.x, l.x, c.x, s.x, t.easingFunction), new O(e.y, u.y, l.y, c.z, s.y, t.easingFunction), new O(e.z, u.z, l.z, c.z, s.z, t.easingFunction));
                        case "oscillating-random":
                            r = y(t.minValue), n = y(t.maxValue);
                            var v = y(t.minStart),
                                d = y(t.maxStart),
                                ...
                                b = y(t.minDirection),
                                I = y(t.maxDirection);
                            return new h(new O(A(r.x, n.x), A(v.x, d.x), A(_.x, E.x), A(R.x, f.x), g(b.x, I.x), N(t.easingFunctions)[0]), new O(A(r.y, n.y), A(v.y, d.y), A(_.y, E.y), A(R.y, f.y), g(b.y, I.y), N(t.easingFunctions)[0]), new O(A(r.z, n.z), A(v.z, d.z), A(_.z, E.z), A(R.z, f.z), g(b.z, I.z), N(t.easingFunctions)[0]))
                    }
                }(E(E({}, t), {
                    valueType: "Vector3"
                }))
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                e.clearRect(0, 0, t.width, t.height), null == d || d(e), h.current.forEach((function(r, n) {
                                    var a = r.confetti,
                                        i = r.spriteCanvas;
                                    a.update(o), a.draw(i, e), a.shouldDestroy(t, o) && h.current.delete(n)
                                })), null == _ || _(e), h.current.size > 0 ? T.current = window.requestAnimationFrame(A) : (e.clearRect(0, 0, t.width, t.height), T.current = null);
                                var r = Date.now();
            ...
            var U = n.forwardRef((function(t, e) {
                ...
                var h = n.useCallback((function() {
                    ...
                    p = n.useCallback((function(t) {
                        for (var e in f.current) f.current[e](t)
                    }), []),
                            ...
                            return function(t, e) {
                                ...
                                switch (t.label) {
                                    case 0:
                                        return [4, T()];
                                    case 1:
                                        return t.sent(), h(), R.current = !0, p(!0), [2]
                                }
                            }))
                        }))
                    }), [p, T, h]);
        ...
        58964: (t, e, r) => {
            ...
            function E(t, e) {
                ...
                var _, E, R, f, h, T = encodeURIComponent(l.toString()),
                    p = encodeURIComponent(u()),
                    O = (R = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), f = null != (null === a() || void 0 === a() || null === (_ = a().ua) || void 0 === _ ? void 0 : _.match(R)), h = "Safari" === (null === a() || void 0 === a() ? void 0 : a().name) && !f, "iOS" !== (null === a() || void 0 === a() || null === (E = a().os) || void 0 === E ? void 0 : E.family) || h ? 1 : 0),
            ...
            function i(t) {
                let e = function(t) {
                    let {
                        ...
                        cos: i,
                        round: o
                    } = Math, u = t[0] | t[1] << 8 | t[2] << 16, l = t[3] | t[4] << 8, c = (63 & u) / 63, s = (u >> 6 & 63) / 31.5 - 1, v = (u >> 12 & 63) / 31.5 - 1, d = (u >> 18 & 31) / 31, _ = u >> 23, E = (l >> 3 & 63) / 63, R = (l >> 9 & 63) / 63, f = l >> 15, h = a(3, f ? _ ? 5 : 7 : 7 & l), T = a(3, f ? 7 & l : _ ? 5 : 7), p = _ ? (15 & t[5]) / 15 : 1, O = (t[5] >> 4) / 15, A = _ ? 6 : 5, N = 0, g = (e, r, n) => {
                        let a = [];
                        for (let i = 0; i < r; i++)
                            for (let o = i ? 0 : 1; o * r < e * (r - i); o++) a.push(((t[A + (N >> 1)] >> ((1 & N++) << 2) & 15) / 7.5 - 1) * n);
                        return a
                    }, b = g(h, T, d), y = g(3, 3, 1.25 * E), I = g(3, 3, 1.25 * R), D = _ && g(5, 5, O), C = n(t), S = o(C > 1 ? 32 : 32 * C), B = o(C > 1 ? 32 / C : 32), U = new Uint8Array(S * B * 4), m = [], G = [];
                    for (let t = 0, n = 0; t < B; t++)
                        for (let o = 0; o < S; o++, n += 4) {
                            let u = c,
                                ...
                                d = v,
                                E = p;
                            for (let t = 0, r = a(h, _ ? 5 : 3); t < r; t++) m[t] = i(e / S * (o + .5) * t);
                            for (let r = 0, n = a(T, _ ? 5 : 3); r < n; r++) G[r] = i(e / B * (t + .5) * r);
                            for (let t = 0, e = 0; t < T; t++)
                                for (let r = t ? 0 : 1, n = 2 * G[t]; r * T < h * (T - t); r++, e++) u += b[e] * m[r] * n;
        ...
        498964: (t, e, r) => {
            ...
            const g = v(T((function(t) {
                ...
                y = t => Object.assign(v(t), {
                    startsWith: e => {
                        return y(f(t, (r = e, T((t => A(t) && t.startsWith(r))))));
                        var r
                    },
                    endsWith: e => {
                        return y(f(t, (r = e, T((t => A(t) && t.endsWith(r))))));
                        var r
                    },
                    minLength: e => y(f(t, (t => T((e => A(e) && e.length >= t)))(e))),
                    maxLength: e => y(f(t, (t => T((e => A(e) && e.length <= t)))(e))),
                    includes: e => {
                        return y(f(t, (r = e, T((t => A(t) && t.includes(r))))));
                        var r
                    },
                    regex: e => {
                        return y(f(t, (r = e, T((t => A(t) && Boolean(t.match(r)))))));
                        var r
                    }
                }),
                I = y(T(A)),

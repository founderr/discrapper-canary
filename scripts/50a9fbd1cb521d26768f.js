    ...
    [86345], {
            ...
            var m = function(e, t) {
                    ...
                    n.map((function(e, t) {
                        ...
                        var t, r, i = p(e, 2),
                            o = i[0],
                            a = i[1],
                            l = null !== (r = null === (t = o.application.embeddedActivityConfig) || void 0 === t ? void 0 : t.shelf_rank) && void 0 !== r ? r : a;
                        if (l < a) {
                            var c = n[a];
                            n.splice(a, 1);
            ...
            function C(e) {
                ...
                return Z(C).concat(Z(M)).map((function(e) {
                    ...
                    return [t[0], t[1].filter((function(e) {
                        return v || !g || "" === O || e.application.name.toLocaleLowerCase().includes(O.toLocaleLowerCase())
                    }))]
                }))
            }
        },
                ...
                try {
                    for (var y, p = e[Symbol.iterator](); !(f = (y = p.next()).done); f = !0) {
                        var v = y.value,
                            ...
                            h = void 0;
                        try {
                            for (var g, O = v.connections.keys()[Symbol.iterator](); !(b = (g = O.next()).done); b = !0) {
                                var A = g.value;
                                u.add(A)
                            }
                        } catch (e) {
        ...
        565957: (e, t, n) => {
            ...
            function h(e) {
                ...
                var k = t.activity.client_platform_config[(0, d.Z)((0, a.Ij)())].release_phase,
                ...
                return r.useMemo((function() {
                    ...
                    p.forEach((function(r) {
                        var o, l = function(e, t) {
                                return (0, b.Z)(e.activity) || null == e.activity.premium_tier_requirement || (0, a.M5)(t, h.p9.TIER_2) ? m.Qy.UNLOCKED : m.Qy.NEEDS_NITRO
                            }(r, n),
                    ...
                    if (!a.ZP.canUsePremiumActivities(n)) {
                        var l = o.sort((function(e, t) {
                            return Number((0,
                                b.Z)(t.activity)) - Number((0, b.Z)(e.activity))
                        }));
        ...
        652221: (e, t, n) => {
            ...
            function y(e) {
                var t = e.name,
                    ...
                    y = e.showTooltip,
                    p = void 0 !== y && y,
                    v = n === a.ww.NEW ? c.Z.Messages.NEW : c.Z.Messages.UPDATED,
                    b = n === a.ww.NEW ? f().activityNewBadge : f().activityUpdatedBadge,
                    m = d(i.useState(s ? "" : v), 2),
                    h = m[0],
                    g = m[1];

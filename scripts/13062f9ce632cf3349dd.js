    ...
    ["78329"], {
            ...
            function d(e) {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [null != t && t.length > 0 ? (0, r.jsxs)(r.Fragment, {
                        children: [null != s ? (0, r.jsx)(l.FormTitle, {
        ...
        722525: function(e, t, n) {
            ...
            function u(e, t) {
                ...
                !(0, r.hasAnyModalOpen)() && (n && i.default.channelListScrollTo(e, t), u && null != t && s.default.updateChatOpen(t, !0), l.default.getState().updatePath(a.Routes.CHANNEL(e, t)))
            }

            function o(e) {
                !(0, r.hasAnyModalOpen)() && l.default.getState().updatePath(e)
            }
        },
        ...
        765105: function(e, t, n) {
            ...
            let f = function(e) {
                let {
                    ...
                    applicationId: n,
                    section: s
                } = t.params, i = (0, l.default)(c.ApplicationDirectoryProfileSections, s);
        ...
        94973: function(e, t, n) {
            ...
            var r = n("37983"),
                ...
                g = n("782340"),
                S = n("208961");
            let _ = (0, i.cssValueToNumber)(a.default.APPLICATION_SUBSCRIPTION_CARD_LISTING_IMAGE_SIZE),
                ...
                A = e => {
                    ...
                    let s = (0, p.getAssetURL)(t.application_id, n, _);
                    return (0, r.jsx)("div", {
            ...
            function x(e) {
                let {
                ...
                } = e, x = (0, l.useStateFromStores)([C.default], () => C.default.isSyncing), {
                    activeSubscription: L,
                    activeSubscriptionListing: P
                } = (0, I.useActiveSubscriptionListingForApplication)(t.application_id, i), {
                    openModal: M,
                    canOpenModal: j,
                    cannotOpenReason: y
                } = (0, m.default)({
                    ...
                    onComplete: p,
                    forcesTransitionToGuild: _
                }), w = t.subscription_plans[0], O = 0 === w.price, V = (null == P ? void 0 : P.id) === t.id, b = (0, o.default)(), U = b && !j || x, D = () => {
                    b ? M() : (0, c.redirectToLogin)({
                        [R]: "true"
                    })
                };
                return s.useEffect(() => {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: t.sku_benefits.benefits.map((e, t) => (0, r.jsx)(E.default, {
                            benefit: e,
                            className: S.benefit
                        }, t))
                    }) : null]
        ...
        913678: function(e, t, n) {
            ...
            function h(e) {
                ...
                return v && (null == n || E) ? null == g || null == S || 0 === S.length ? null : (0, r.jsx)("div", {
        ...
        467094: function(e, t, n) {
            ...
            function P(e) {
                c.FrecencyUserSettingsActionCreators.updateAsync("favoriteStickers", t => (t.stickerIds = L(t.stickerIds), s.size(t.stickerIds) >= v.MAX_FAVORITES) ? (a.default.show({
            ...
            var d = new c(s.default, {
                MESSAGE_START_EDIT: function(e) {
                    let {
                        ...
                        messageId: n,
                        content: r
                    } = e, s = a.UseLegacyChatInput.getSetting(), u = l.default.unparse(r, t);
                    o[t] = {
                        channelId: t,
                        messageId: n,
                        textValue: u,
        ...
        287850: function(e, t, n) {
            ...
            function N(e) {
                ...
                return {
                    channelId: e.id,
                    lastMessageId: t,
                    isFavorite: g.default.isMessagesFavorite(e.id) && (0, C.isInMainTabsExperiment)(),
                    isRequest: p.default.isMessageRequest(e.id) || I.default.isSpam(e.id)
                }
            }

            function x() {
                A.clear(), Object.values(E.default.getMutablePrivateChannels()).forEach(e => {
                    A.set(e.id, N(e))
                }), (0, C.isInMainTabsExperiment)() && (0, h.isSplitMessagesTab)() && g.default.getAddedToMessages().forEach(e => {
                    let t = E.default.getChannel(e);
                    null != t && (0, v.isGuildTextChannelType)(t.type) && A.set(t.id, N(t))
                })
            }

            function L() {
                let e = E.default.getMutablePrivateChannels();
                for (let t in e) A.set(t, N(e[t]))
            }
            let P = (r = [], s = [], i = [], () => {
            ...
            class M extends c.default.Store {
                initialize() {
                    this.waitFor(E.default, m.default, S.default, p.default, g.default), this.syncWith([g.default, p.default], x)
                }
            ...
            var j = new M(f.default, {
                ...
                CHANNEL_UPDATES: function(e) {
                    ...
                    t.forEach(e => {
                        ((0, v.isPrivate)(e.type) || A.has(e.id)) && A.set(e.id, N(e))
                    })
                },
                CHANNEL_CREATE: function(e) {
                    ...
                    if (!(0, v.isPrivate)(t.type) || t.id === R.FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) return !1;
                    A.set(t.id, N(t))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && A.set(t, N(r, n.id))
                },
        ...
        265836: function(e, t, n) {
            ...
            class l extends s.Component {
                ...
                componentDidUpdate(e, t) {
                    ...
                    let a = (n = l, r = this.state, !n.disable && !(r.hovered && n.pauseOnHover));
        ...
        646240: function(e, t, n) {
            ...
            class f extends s.Component {
                render() {
                    let {
                        ...
                        cta: g
                    } = this.props, S = null != s && s.length > 0, _ = null != E ? E : this._textInputRef;
                    return (0, r.jsx)(a.FocusRing, {
                        ...
                        children: (0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)(a.TextInput, {
                                ...
                                className: d.cta,
                                children: g
                            }) : null, S ? (0, r.jsx)(a.Clickable, {
                                onClick: this.handleClear,
                                className: d.clear,
                                "aria-label": c.default.Messages.SEARCH_CLEAR,
                                children: (0, r.jsx)(u.default, {
                                    className: l(d.clearIcon, m)
                                })
                            }) : (0, r.jsx)(o.default, {
            ...
            var C = s.forwardRef((e, t) => (0, r.jsx)(f, {
                forwardedRef: t,
                ...e
            }))
        },

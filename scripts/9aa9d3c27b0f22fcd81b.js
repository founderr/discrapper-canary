        ...
        823674: function(e, t, n) {
            ...
            function e_(e) {
                let {
                    ...
                    let {
                        ...
                        author: c
                    } = n, f = (0, u.useStateFromStores)([D.default], () => D.default.getGuild(t.guild_id), [t.guild_id]), h = (0, u.useStateFromStores)([x.default], () => x.default.getId()), m = (0, v.useIsActiveChannelOrUnarchivableThread)(t), E = (0, v.useIsNonModInLockedThread)(t), g = R.RenderReactions.useSetting(), _ = R.DeveloperMode.useSetting(), M = (0, u.useStateFromStores)([P.default], () => null == t.guild_id || P.default.canChatInGuild(t.guild_id), [t]), {
                        canManageMessages: I,
                    ...
                    }), [t, M]), y = (0, L.useCanReplyToMessage)(t, n), j = (0, v.useCanStartPublicThread)(t, n), F = (0, v.useCanViewThreadForMessage)(n), U = (0, u.useStateFromStores)([S.default], () => null != t.guild_id && S.default.isLurking(t.guild_id), [t]), H = (0, u.useStateFromStores)([O.default], () => null != t.guild_id && O.default.isCurrentUserGuest(t.guild_id), [t]), k = c.id === h, G = (I || k) && m && n.type in ef.MessageTypesDeletable;
                ...
                }, [$, eS, n]), eP = s.useCallback(() => {
                    eS({
                        emojiPicker: !ed
                    })
                }, [ed, eS]), eb = s.useCallback(() => {
                    eS({
                        emojiBurstPicker: !ep
                    })
                }, [ep, eS]), {
                ...
                return ej && !eF && [].push(d.DismissibleContent.BURST_REACTION_BUTTON_SPARKLE), (0, a.jsxs)(a.Fragment, {
                    children: [Y ? (0, a.jsxs)(a.Fragment, {
                        children: [l && eN ? eg({
                            ...
                            channel: t,
                            message: n,
                            label: e_ ? eC.default.Messages.MESSAGE_REMINDERS_MARK_AS_DONE : eC.default.Messages.MESSAGE_REMINDERS_MARK_AS_TODO,
                            icon: e_ ? F.default : V.default,
                            onClick: e_ ? eo.markMessageRemindersAsComplete : eo.markMessageAsReminder
                        }) : null, eU ? eg({
                            key: "mark-unread",
                            channel: t,
                            message: n,
                        ...
                        onClick: () => {
                            let e = !ey;
                            eO(e), ex(!1), e && (0, m.openClydeFeedbackModal)(n.id, eI, ex, eO)
                        }
                        ...
                        shouldShow: ed,
                        isFocused: ev
                    }) : null, M && !eL && ej && eF ? (0, a.jsx)(eu.default, {
                        channel: t,
                        message: n,
                        togglePopout: eb,
                        renderEmojiPicker: eA,
            ...
            function eS(e) {
                let {
                    channel: t,
                    message: n
                } = e, s = (0, u.useStateFromStores)([g.default], () => null != g.default.getMessage(n.id), [n.id]), l = null == n.interaction || null != n.interactionData && (0, _.canRetryInteractionData)(n.interactionData);
                return (0, a.jsxs)(a.Fragment, {
                    children: [!s && l && eg({
                        key: "retry",

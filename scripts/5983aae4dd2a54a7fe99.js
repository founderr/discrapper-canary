    ...
    ["47456"], {
        ...
        723251: function(e, t, r) {
            ...
            function a(e, t, r) {
                ...
                for (let e = 0, a = 0, u = n - 1; e < t; e++, u += n - 1)
                    for (i.push(e + 1 < t ? 0 : 1, 255 & n, n >> 8, 255 & ~n, n >> 8 ^ 255, 0), l = (l + s) % 65521; a < u; a++) {
                        let e = 255 & r[a];
                        i.push(e), l = (l + (s = (s + e) % 65521)) % 65521
                    }
                for (let [e, t] of(i.push(l >> 8, 255 & l, s >> 8, 255 & s, 0, 0, 0, 0, 0, 0, 0, 0, 73, 69, 78, 68, 174, 66, 96, 130), [
                        [12, 29],
                        [37, 41 + a]
                    ])) {
                    let r = -1;
            ...
            function i(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: i,
                        round: u
                    } = Math, s = e[0] | e[1] << 8 | e[2] << 16, l = e[3] | e[4] << 8, o = (63 & s) / 63, c = (s >> 6 & 63) / 31.5 - 1, d = (s >> 12 & 63) / 31.5 - 1, f = s >> 23, E = l >> 15, _ = a(3, E ? f ? 5 : 7 : 7 & l), C = a(3, E ? 7 & l : f ? 5 : 7), p = f ? (15 & e[5]) / 15 : 1, h = (e[5] >> 4) / 15, S = f ? 6 : 5, I = 0, T = (t, r, n) => {
                        let a = [];
                        for (let i = 0; i < r; i++)
                            for (let u = i ? 0 : 1; u * r < t * (r - i); u++) a.push(((e[S + (I >> 1)] >> ((1 & I++) << 2) & 15) / 7.5 - 1) * n);
                        return a
                    }, m = T(_, C, (s >> 18 & 31) / 31), A = T(3, 3, 1.25 * ((l >> 3 & 63) / 63)), g = T(3, 3, 1.25 * ((l >> 9 & 63) / 63)), v = f && T(5, 5, h), L = n(e), R = u(L > 1 ? 32 : 32 * L), O = u(L > 1 ? 32 / L : 32), N = new Uint8Array(R * O * 4), M = [], P = [];
        ...
        791050: function(e, t, r) {
            ...
            function N(e) {
                ...
                }), F = (0, m.isEqualAvatarDecoration)(v, void 0 === S ? null == t ? void 0 : t.avatarDecoration : S), b = () => {
                    I(v), u()
                }, x = () => {
        ...
        659117: function(e, t, r) {
            ...
            let I = [{
                ...
                T = e => {
                    let {
                        purchase: t
                    } = e, r = (0, s.useStateFromStores)([E.default], () => E.default.locale), a = (0, c.isPremiumCollectiblesPurchase)(t);
                    return (0, n.jsxs)("div", {
            ...
            var m = e => {
                let {
                    ...
                    className: a
                } = e, E = (0, s.useStateFromStores)([_.default], () => _.default.getStatus(t.id)), {
                    category: m,
                    product: A,
                    purchase: g
        ...
        795158: function(e, t, r) {
            ...
            var a = r("77078"),
                ...
                u = r("50885"),
                s = r("782340");
            let l = u.default.getEnableHardwareAcceleration() ? a.AnimatedAvatar : a.Avatar;
            var o = e => {
                let {
                    user: t,
                    avatarDecorationOverride: r,
        ...
        765221: function(e, t, r) {
            ...
            let L = () => 80,
                ...
                O = e => {
                    ...
                    }), h = (0, o.default)([E.default], () => E.default.isItemViewed(r)), L = T.default.canUseCollectibles(t), O = u === m.Section.PREMIUM_PURCHASE && !L, [N, M] = a.useState(s);
                    a.useEffect(() => {
                        s && M(!0)
                    }, [s]);
                    let P = a.useRef(null),
        ...
        643070: function(e, t, r) {
            ...
            var h = () => {
                let e = (0, s.default)([f.default], () => f.default.getCurrentUser()),
                    ...
                    [a, h] = (0, s.useStateFromStoresArray)([l.default], () => [l.default.categories, l.default.categorySkuIdsByProductSkuId]);
                return (0, i.useMemo)(() => {
                    let e = (0, u.uniqBy)([...(0, d.getAvatarDecorationsFromPurchases)(n), ...(0, d.getAvatarDecorationsFromCategories)(a)], "id"),
                        ...
                        s = !!t || !!r || i.purchase.length > 0;
                    return [{
                        section: "purchase",
                        items: s ? [C, p, ...i.purchase] : [],
                        height: 12,
        ...
        473591: function(e, t, r) {
            ...
            function S() {
                n = void 0, a = void 0, i = void 0, u = void 0, s = void 0, E = null
            }
            class I extends o.default.Store {
                ...
                hasPendingChanges() {
                    return void 0 !== n || void 0 !== a || void 0 !== i || void 0 !== u || void 0 !== s
                }
                getPendingUpdates() {
                    return {
                        pendingAvatar: i,
                ...
                c = () => ({
                    categoryItemViews: {
                        [n.CollectiblesCategorySkuId.FANTASY]: {
                            [a.CollectiblesItemType.AVATAR_DECORATION]: l,
        ...
        216719: function(e, t, r) {
            ...
            var c = new o(a.default, {
                COLLECTIBLES_SHOP_OPEN: e => {
                    var t, r;
                    u = null !== (t = e.analyticsLocations) && void 0 !== t ? t : i, s = null !== (r = e.analyticsSource) && void 0 !== r ? r : null
                },
        ...
        235898: function(e, t, r) {
            ...
            function o() {
                ...
                let {
                    ...
                    let [t, r, l, o] = (0, a.useStateFromStoresArray)([s.default], () => {
                        var e;
                    ...
                    let [t, r, s, o, c] = (0, a.useStateFromStoresArray)([l.default], () => [l.default.isFetching, l.default.isClaiming, l.default.fetchError, l.default.claimError, l.default.purchases]);
                    return (0, n.useEffect)(() => {
        ...
        75015: function(e, t, r) {
            ...
            let l = 568,
                ...
                g = l / I,
                v = l / T,
                L = s.BACKGROUND_REPLACEMENT_SIZE.width / s.BACKGROUND_REPLACEMENT_SIZE.height,
                R = l / L;
        ...
        716849: function(e, t, r) {
            ...
            function h(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), i = (0, a.default)([d.default], () => d.default.shouldFetchPremiumLikelihood()), u = (0, a.default)([l.default], () => l.default.getCurrentUser());
                n.useEffect(() => {
                    S(u, i, t, r)
                }, [u, i, t, r])
            }
            ...
            function S(e, t, r, n) {
                null != e && !(0, c.isPremium)(e) && r && (t && C(), n && (!o.default.isLoadedForSKU(f.PremiumSubscriptionSKUs.TIER_0) && !o.default.isFetchingForSKU(f.PremiumSubscriptionSKUs.TIER_0) && (0, s.fetchSubscriptionPlansForSKU)(f.PremiumSubscriptionSKUs.TIER_0), !o.default.isLoadedForSKU(f.PremiumSubscriptionSKUs.TIER_2) && !o.default.isFetchingForSKU(f.PremiumSubscriptionSKUs.TIER_2) && (0, s.fetchSubscriptionPlansForSKU)(f.PremiumSubscriptionSKUs.TIER_2)))
            }
        },
        ...
        771325: function(e, t, r) {
            ...
            function p(e, t, r) {
                ...
                return u && null == t ? l.default.getDefaultAvatarURL(r.id, r.discriminator) : u || (null == t ? void 0 : t.avatar) == null ? r.getAvatarURL(void 0, a, i) : r.getAvatarURL(null == t ? void 0 : t.guildId, a, i)
            }
        ...
        106435: function(e, t, r) {
            ...
            function l(e) {
                let {
                    ...
                    user: t,
                    size: (0, i.getDecorationSizeForAvatarSize)(l),
                    showPending: o,
                    animateOnHover: d,
                    avatarDecorationOverride: f,
                    showTryItOut: c
        ...
        19287: function(e, t, r) {
            ...
            function c(e) {
                let {
                    ...
                    animateOnHover: f = !1,
                    avatarOverride: E
                } = e, [_, C] = n.useState(!1), p = (0, a.useStateFromStores)([i.default], () => i.default.useReducedMotion), h = (0, a.useStateFromStores)([l.default], () => l.default.isFocused()), S = h && (_ || !p && !f), {
                    pendingAvatar: I
                } = (0, o.default)({}), T = (0, a.useStateFromStores)([s.default], () => null != r && null != t ? s.default.getMember(r, t.id) : null), m = n.useMemo(() => null != t ? (0, u.getPreviewAvatar)(d ? null != E ? E : I : void 0, T, t, {
                    canAnimate: S,
                    size: c
        ...
        181114: function(e, t, r) {
            ...
            let h = e => {
                let {
                    ...
                    onlyShineOnHover: C,
                    ...h
                } = e, S = u.createRef(), I = (0, d.default)(S), T = !n && !a && !0 !== s && (!C || I);
                return (0, i.jsxs)(c.Button, {
                    ...
                    children: [t, T ? (0, i.jsx)(p, {
                        shinePaused: f,
                        className: l(E.buttonShine, C ? E.onlyShineOnHover : void 0, _),
                        shineSize: o
                    }) : null]
                })
            };

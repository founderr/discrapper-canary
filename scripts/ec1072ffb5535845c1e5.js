    ...
    ["17389"], {
        ...
        526887: function(e, t, n) {
            ...
            function d(e) {
                ...
                } = e, p = (0, l.useConfettiCannon)(n, o), v = (0, r.default)([a.default], () => a.default.useReducedMotion), C = s.useMemo(() => v ? u : {
                    confettiCanvas: n,
                    cannon: p,
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: h,
                            onClose: e => {
                                s(), null == p || p(e), e && (null == C || C())
                            },
                            onComplete: () => {
                                y = !0, null == v || v(), !M && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: C,
                            analyticsLocations: _,
                            analyticsObject: E,
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: N,
                            location_stack: _
                        }), (0, r.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == p || p(y), y && (!M && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == C || C())
                    },
        ...
        374278: function(e, t, n) {
            ...
            function E(e) {
                ...
                let n, {
                    ...
                    M = r.default.getGuild(E.guild_id),
                    g = null !== (t = null == M ? void 0 : M.maxStageVideoChannelUsers) && void 0 !== t ? t : 0,
                    T = !!(null == M ? void 0 : M.isCommunity()),
                    S = C.default.Messages.STAGE_FULL_TITLE,
                    A = T ? g < p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED : (null == M ? void 0 : M.premiumTier) !== p.BoostedGuildTiers.TIER_3 && g <= p.MAX_STAGE_VIDEO_USER_LIMIT_TIER2,
                    L = a.default.can(h.MODERATE_STAGE_CHANNEL_PERMISSIONS, E);
                n = T && (null == M ? void 0 : M.premiumTier) === p.BoostedGuildTiers.TIER_3 ? g <= p.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED ? C.default.Messages.STAGE_FULL_BOOST_MORE_BODY : C.default.Messages.STAGE_FULL_MAX_BODY : A ? C.default.Messages.STAGE_FULL_BODY : C.default.Messages.STAGE_FULL_MAX_BODY;
                let N = () => {
                    ...
                    R = x.filter(e => e.type === f.StageChannelParticipantTypes.VOICE),
                    O = R.length,
                    ...
                    children: [(0, i.jsxs)(s.ModalHeader, {
                        ...
                        children: A ? (0, i.jsxs)(i.Fragment, {
                            children: [(0, i.jsx)(s.Button, {
                                ...
                                onClick: () => {
                                    m(), (0, l.openGuildBoostingMarketingModal)({
                                        guildId: E.guild_id,
                                        location: {
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: v,
                    ..._
                } = e, E = r.createRef(), I = (0, d.default)(E), m = !i && !s && !0 !== a && (!v || I);
        ...
        235855: function(e, t, n) {
            ...
            class u extends i.Component {
                ...
                constructor(e) {
                    ...
                    t ? a.has(t) ? this.elementId = a.get(t) || "" : a.set(t, (0, s.v4)()) : this.elementId = r;

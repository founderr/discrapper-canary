    ...
    ["5373"], {
        ...
        502155: function(e, l, t) {
            ...
            var s = t("37983"),
                ...
                h = e => {
                    ...
                    let [v, m] = (0, n.useStateFromStoresArray)([u.default], () => [u.default.getOnlineCount(h.id), u.default.getMemberCount(h.id)], [h.id]);
        ...
        324105: function(e, l, t) {
            ...
            var N = function(e) {
                ...
                let {
                    ...
                    presenceCount: j,
                    className: M
                } = e, _ = (0, u.default)(), [S, D] = a.useState(!1);
                if (null == n || I) return (0, s.jsx)("div", {
                    className: i(M, x.card, x.cardPlaceholder, {
                        [x.cardSmall]: R,
                        [x.cardDisabled]: N
                    })
                });
                let {
                    name: T
                } = n, A = null != n.discoverySplash && /^data:/.test(n.discoverySplash) ? n.discoverySplash : L.default.getGuildDiscoverySplashURL({
                    id: n.id,
                    splash: n.discoverySplash,
                    size: 240 * (0, c.getDevicePixelRatio)()
                }), w = (0, r.isThemeDark)(_) ? v : m, B = null !== (l = L.default.getGuildIconURL({
                    id: n.id,
                    icon: n.icon,
                    size: 40
                })) && void 0 !== l ? l : void 0, O = null != n.description ? n.description : p, V = null != g ? g : null == n ? void 0 : n.memberCount, F = null != j ? j : null == n ? void 0 : n.presenceCount, U = null;
                if (null != B) U = (0, s.jsx)("img", {
                    src: B,
                    alt: "",
                    className: x.avatar
                });
                    ...
                    U = (0, s.jsx)("div", {
                        ...
                        children: (0, s.jsx)(d.Text, {
                            className: x.acronym,
                            style: {
                                fontSize: null !== (t = E[e.length]) && void 0 !== t ? t : E[E.length - 1]
                            },
                ...
                return (0, s.jsxs)("div", {
                    ...
                    children: [(0, s.jsxs)("div", {
                        ...
                        children: [(0, s.jsxs)("div", {
                            ...
                            children: [null != F && (0, s.jsxs)("div", {
                                className: x.memberCount,
                                children: [(0, s.jsx)("div", {
                                    className: x.dotOnline
                                }), (0, s.jsx)(d.Text, {
                                    variant: "text-xs/normal",
                                    children: R ? h.default.Messages.NUMBERS_ONLY.format({
                                        count: F
        ...
        580357: function(e, l, t) {
            ...
            var s, a, n = t("37983"),
                ...
                v = t("782340"),
                m = t("465835");
            (a = s || (s = {}))[a.PARTNERED = 0] = "PARTNERED", a[a.STAFF = 1] = "STAFF", a[a.VERIFIED = 2] = "VERIFIED", a[a.VERIFIED_AND_PARTNERED = 3] = "VERIFIED_AND_PARTNERED", a[a.VERIFIED_AND_HUB = 4] = "VERIFIED_AND_HUB", a[a.HUB = 5] = "HUB", a[a.NONE = 6] = "NONE";
            class E extends i.PureComponent {
                renderBadge(e, l, t) {
                    ...
                    } = this.props, x = function(e) {
                        switch (e) {
                            case 2:
                                return v.default.Messages.GUILD_VERIFIED;
                            case 0:
                                return v.default.Messages.GUILD_PARTNERED;
                            case 3:
                                return v.default.Messages.GUILD_VERIFIED_AND_PARTNERED;
                            case 4:
                                return v.default.Messages.HUB_VERIFIED_DISCORD_HUB;
                            case 5:
                                return v.default.Messages.HUB_DISCORD_HUB;
                            case 1:
                                return v.default.Messages.INTERNAL_EMPLOYEE_ONLY;
                            case 6:
                                return null;
                            default:
                                (0, c.assertNever)(e)
                    ...
                    return (0, n.jsx)(u.Tooltip, {
                        ...
                        position: r,
                        text: x,
                        children: i => 5 === e || 4 === e ? (0, n.jsx)("div", {
                            ...i,
                            className: d(t, s),
                            style: {
                                width: C,
                ...
                render() {
                    ...
                    return l.has(x.GuildFeatures.INTERNAL_EMPLOYEE_ONLY) ? this.renderBadge(1, f.default, m.staff) : l.has(x.GuildFeatures.VERIFIED) && l.has(x.GuildFeatures.HUB) ? this.renderBadge(4, C.default, m.verifiedHub) : l.has(x.GuildFeatures.HUB) ? this.renderBadge(5, C.default, m.hub) : l.has(x.GuildFeatures.VERIFIED) && l.has(x.GuildFeatures.PARTNERED) ? this.renderBadge(3, h.default, m.verified) : l.has(x.GuildFeatures.VERIFIED) ? this.renderBadge(2, h.default, m.verified) : l.has(x.GuildFeatures.PARTNERED) ? this.renderBadge(0, L.default, m.partnered) : null
                }
            }
            var N = E
        },

    ...
    [14136], {
            ...
            function g(e) {
                var n, t = (0, M.Z)(),
                    ...
                    C = (0, i.e7)([a.Z], (function() {
                        return null != g ? a.Z.getVoiceStateForChannel(g, e.id) : null
                    }), [g, e.id]),
                ...
                return P ? (0, r.jsx)(u.MenuItem, {
                    id: "invite-speaker",
                    label: v ? _.Z.Messages.STAGE_CHANNEL_USER_SET_MYSELF_TO_SPEAKER : _.Z.Messages.STAGE_CHANNEL_USER_INVITE_TO_SPEAK,
                    action: I
                }) : p && v ? (0, r.jsx)(u.MenuItem, {
                    id: "invite-speaker",
                ...
                var n = e.user,
                    ...
                    Pe = function(e, n, t) {
                        var u, l = C.Z.getChannel(t),
                            o = (0, h.e7)([v.Z], (function() {
                                return v.Z.getGuild(n)
                            }), [n]),
                            a = (0, h.e7)([I.ZP], (function() {
                                return I.ZP.getPermissionsForUser(e.id, t)
                            }), [t, e.id]),
                            s = (null === (u = S.default.getCurrentUser()) || void 0 === u ? void 0 : u.id) === e.id,
                            d = (0, h.e7)([p.Z], (function() {
                                return null != t && p.Z.canWithPartialContext(U.Plq.MUTE_MEMBERS, {
                                    channelId: t
                                })
                            }), [t]);
                        return null == l || null == o ? null : (d || s) && a.speaker ? (0, r.jsx)(i.MenuItem, {
                            id: "audience",
                            label: s ? T.Z.Messages.STAGE_CHANNEL_USER_MOVE_TO_AUDIENCE : T.Z.Messages.STAGE_CHANNEL_USER_MOVE_TO_AUDIENCE_OTHER,
                            action: function() {
                                s ? (0, P.yi)(l) : (0, P.hz)(e, l)
                            }
                        }) : null
                    }(n, t, l.id),
                    Ie = (0, m.Z)({
                ...
                return (0, r.jsxs)(i.Menu, {
                    ...
                    children: [!Ae && (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsxs)(i.MenuGroup, {
                            ...
                            children: [z && te, B && re, ie, le, z && oe, z && ae, ue]
                        }), d && (0,
                            r.jsx)(i.MenuGroup, {
                            children: se
                        }), (0, r.jsx)(i.MenuGroup, {
        ...
        982348: (e, n, t) => {
            ...
            function c(e, n) {
                ...
                return (0, i.e7)([o.Z, a.Z], (function() {
                    var t = a.Z.isInChannel(n, e) && a.Z.hasVideo(n),
                        r = o.Z.getLayout(n),
        ...
        100856: (e, n, t) => {
            ...
            function p(e, n) {
                ...
                var S = e.id === s.default.getId();
                if (!S && !f.Z.can(C.Plq.MOVE_MEMBERS, p)) return null;
                var P = t.filter((function(n) {
                    var t = n.channel;
                    return t.id !== p.id && (S ? f.Z.can(C.Plq.CONNECT, t) && !(0, O.rY)(t, g.Z, E.Z) : f.Z.can(C.Plq.MOVE_MEMBERS, t) && (f.Z.can(C.Plq.CONNECT, t) || h.ZP.can({
                ...
                return 0 === P.length ? null : (0, r.jsx)(u.MenuItem, {
                    ...
                    children: P.map((function(t) {
                        ...
                        return (0, r.jsx)(u.MenuItem, {
                            ...
                            action: function() {
                                return function(t) {
                                    e.id === s.default.getId() ? o.default.selectVoiceChannel(t.id) : l.Z.setChannel(n, e.id, t.id)
                                }(i)
                            },
                            label: (0, a.F6)(i, _.default, M.Z)
                        }, i.id)
                    }))
                })
            }
        ...
        234617: (e, n, t) => {
            ...
            function _(e) {
                var n, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : c.Yn.DEFAULT,
                    ...
                    _ = e === (null === (n = a.default.getCurrentUser()) || void 0 === n ? void 0 : n.id),
                    g = t === c.Yn.STREAM;
                return _ ? null : (0, r.jsx)(u.MenuControlItem, {
                    ...
                    control: function(n, i) {
                        return (0, r.jsx)(u.MenuSliderControl, M(f({}, n), {
                            ...
                            onChange: function(n) {
                                return l.Z.setLocalVolume(e, (0, s.A)(n), t)
                            },
...
//# sourceMappingURL=89209db1a8b071165c3a.js.map
        ...
        473031: function(e, t, n) {
            ...
            function x(e) {
                ...
                let {
                    ...
                    image: O,
                    recurrence_rule: F
                } = n, b = (0, C.getNextRecurrenceIdInEvent)(n), H = (0, u.useStateFromStores)([v.default], () => v.default.isInterestedInEventRecurrence(U, b), [U, b]), k = (0, u.useStateFromStores)([a.default], () => a.default.isLurking(y), [y]), w = (0, u.useStateFromStores)([s.default], () => s.default.getStageInstanceByChannel(M), [M]), B = (0, u.useStateFromStores)([d.default], () => d.default.getChannel(M), [M]), W = (0, u.useStateFromStores)([f.default], () => f.default.getUser(A), [A]), {
                    speakers: z
                } = (0, g.default)({
                    id: M,
                    data: {
                    ...
                    recurrenceId: b,
                    onActionTaken: D
                }), en = (0, i.default)(x), el = k ? void 0 : e => (0, E.openGuildEventDetails)({
                    eventId: U,
                    parentGuildId: x,
                    recurrenceId: e
                });

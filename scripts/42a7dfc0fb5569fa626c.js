    ...
    ["62935"], {
                    ...
                    let p = e(function() {
                        ...
                        m = () => {
                            ...
                            return u(i.getItem.bind(i))(s.name).then(e => {
                                ...
                                var t;
                                return r(l = s.merge(e, null != (t = a()) ? t : p), !0), f()
                            }).then(() => {
        ...
        8731: function(e, t, r) {
            ...
            async function l(e, t, a, l, s) {
                let {
                    ...
                    scaledCropWidth: d,
                    scaledCropHeight: c
                } = i(t, a, l, s), _ = await e.arrayBuffer(), E = new Worker(new URL(r.p + r.u("39703"), r.b)), f = new Promise((e, t) => {
                    E.onmessage = r => {
                        let {
                            data: a
                        } = r;
                        ...
                        } else a.type === n.MessageTypes.CROP_GIF_ERROR && (t(Error("Error cropping GIF")), E.terminate())
                    }
                });
        ...
        54666: function(e, t, r) {
            ...
            async function x(e) {
                ...
                let a = (0, f.downsizeImage)(r, 320, 320);
            ...
            function j(e) {
                ...
                let {
                    ...
                    file: null,
                    filename: null !== (f = (0, y.getFilenameForSticker)(V)) && void 0 !== f ? f : ""
                }), [et, er] = n.useState(null == W ? void 0 : W.id), [ea, en] = n.useState(null !== (v = null == W ? void 0 : W.name) && void 0 !== v ? v : null == V ? void 0 : V.tags), [ei, el] = n.useState(null !== (w = null == V ? void 0 : V.description) && void 0 !== w ? w : ""), [es, eo] = n.useState(!1), [eu, ed] = n.useState(null), ec = (0, o.useStateFromStores)([p.default], () => p.default.getGuild(k)), e_ = (null == ec ? void 0 : ec.hasFeature(U.GuildFeatures.PARTNERED)) || (null == ec ? void 0 : ec.hasFeature(U.GuildFeatures.VERIFIED)), eE = null != V, ef = eE || (null == $ ? void 0 : $.file) != null, eI = 0 === ei.length || ei.length >= 2 && ei.length <= 100, ep = !es && (null == eu ? void 0 : eu.isBlocking) !== !0 && J.length >= 2 && (null != et || null != ea || (null == V ? void 0 : V.tags) != null && (null == V ? void 0 : V.tags) !== "") && ef && eI, em = async e => {
                    var t;
                    if (null == e) return;
                    ...
                    try {
                        if (eo(!0), eE) await (0, O.updateGuildSticker)(k, null !== (a = null == V ? void 0 : V.id) && void 0 !== a ? a : "", {
                            name: J,
                            tags: s,
                            description: ei
                        });
                            ...
                            ;
                            let e = new FormData;
                            e.append("name", J), e.append("tags", s), e.append("description", ei), (null == $ ? void 0 : $.file) != null && e.append("file", $.file), l = null !== (i = null === (n = $.file) || void 0 === n ? void 0 : n.type) && void 0 !== i ? i : "", S.default.track(U.AnalyticEvents.STICKER_UPLOAD_STARTED, {
                                filetype: l
                    ...
                    previewData: Z,
                    onStickerError: eT
                }), eg = e_ ? C.default.Messages.GUILD_STICKER_UPLOAD_DESCRIPTION : C.default.Messages.GUILD_STICKER_UPLOAD_DESCRIPTION_NO_LOTTIE;
                        ...
                        children: [(0, a.jsxs)(d.ModalContent, {
                            ...
                            children: [(0, a.jsxs)(d.ModalHeader, {
                                ...
                                children: [(0, a.jsx)(d.Heading, {
                                    ...
                                    children: eg.format({
                                        fileSize: (0, g.formatKbSize)(R.MAX_STICKER_FILE_SIZE, {
                                            useKibibytes: !0
                                        })
                                    })
                                })]
                                ...
                                children: [(0, a.jsx)(d.FormItem, {
                                    title: eE ? C.default.Messages.GUILD_STICKER_UPLOAD_FILE_TITLE_BLOCKED : C.default.Messages.GUILD_STICKER_UPLOAD_FILE_TITLE,
                                    required: !0,
                                    className: N.formItemRowChild,
                                    children: eE ? (0, a.jsx)(d.TextInput, {
                                        disabled: !0,
                            ...
                            children: [(0, a.jsx)(d.Button, {
                                type: "submit",
                                disabled: !ep,
                                children: eE ? C.default.Messages.GUILD_STICKERS_UPDATE : C.default.Messages.UPLOAD
                            }), (0, a.jsx)(d.Button, {

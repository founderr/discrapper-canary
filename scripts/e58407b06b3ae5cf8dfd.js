        ...
        829253: (n, e, s) => {
            ...
            function m(n) {
                ...
                return (0, a.jsx)(t.ModalRoot, {
                    ...
                    children: (0, a.jsxs)(t.ModalContent, {
                        className: u().content,
                        children: [(0, a.jsx)(r.Z, {
                            ...
                            children: d.Z.Messages.STAGE_SPEAK_INVITE_HEADER
                        }), (0, a.jsx)(t.Text, {
                            color: "header-secondary",
                            className: u().description,
                            variant: "text-sm/normal",
                            children: d.Z.Messages.STAGE_SPEAK_INVITE_MODAL.format({
                                stageChannelHook: function() {
                                    return (0, a.jsxs)("div", {
                                        className: u().channel,

        ...
        565559: function(t, e, u) {
            ...
            class _ extends i.default.Store {
                getGuildProductsForGuildFetchState(t) {
                    var e;
                    return null !== (e = E[t]) && void 0 !== e ? e : l.NOT_FETCHED
                }
                getGuildProduct(t) {
                    return s.get(t)
                }
                ...
                getGuildProductFetchState(t) {
                    var e;
                    return null !== (e = o[t]) && void 0 !== e ? e : l.NOT_FETCHED
                }
            ...
            var F = new _(a.default, {
                ...
                GUILD_PRODUCTS_FETCH_SUCCESS: function(t) {
                    ...
                    E[e] = l.FETCHED, c[e] = Date.now(), u.forEach(t => {
                        s.set(t.id, t), o[t.id] = l.FETCHED
                    })
                },
                ...
                GUILD_PRODUCT_FETCH_FAILURE: function(t) {
                    ...
                    o[e] = l.FETCHED, 404 === u.status && s.delete(e)
                }
            })
        }
    }

        ...
        318554: (e, t, r) => {
            ...
            function D(e) {
                var t = e.guildId,
                    ...
                    v = e.onClose,
                    D = e.analyticsData,
                    w = (0, a.e7)([c.Z], (function() {
                        return c.Z.getGuild(t)
                    }), [t]),
                    N = I(o.useState(!1), 1)[0],
                    C = I(o.useState(b.Fl), 2),
                    T = C[0],
                    L = C[1],
                    A = (0, a.e7)([h.Z], (function() {
                        return h.Z.getGuildIncident(t)
                    })),
                    M = (0, p.SG)(A),
                    k = (0, p.sN)(A),
                    P = I(o.useState(!!j || M), 2),
                    R = P[0],
                    Z = P[1],
                    B = I(o.useState(!!j || k), 2),
                    G = B[0],
                    U = B[1];
                if (null == w) {
                    v();
                ...
                return (0, n.jsxs)(l.ModalRoot, {
                    ...
                    children: [(0, n.jsx)(l.ModalHeader, {
                        ...
                        children: [(0, n.jsx)(l.Button, {
                            onClick: function() {
                                if (!M && !k || R || G)(0, f.n)(w.id, R, G, T);
                                else {
                                    (0, f.n)(w.id, !1, !1);
                                    (0, l.openModalLazy)(x((function() {
                                        var e, o;
...
//# sourceMappingURL=81e7cc169eee3eb5001d.js.map
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["82114"], {
        ...
        997289: function(e, t, n) {
            ...
            var i = n("884691"),
                l = n("599110");
            let s = () => i.useContext(l.AnalyticsContext)
        },
        ...
        246511: function(e, t, n) {
            ...
            }), (s = i || (i = {}))[s.GRID_NAVIGATOR_EVENT = 0] = "GRID_NAVIGATOR_EVENT", s[s.MOUSE_EVENT = 1] = "MOUSE_EVENT", (r = l || (l = {})).EMOJI = "emoji", r.STICKER = "sticker", r.PACK_ICON = "pack-icon"
        },
        270161: function(e, t, n) {
            ...
            var i = n("316693"),
                l = n("923510"),
                s = n("49111");
            let r = s.Permissions.VIEW_CHANNEL,
                a = i.default.combine(r, s.Permissions.CONNECT),
                o = i.default.combine(r, l.MODERATE_STAGE_CHANNEL_PERMISSIONS)
        },
            ...
            let o = (0, l.createExperiment)({
                ...
                c = function() {
                    ...
                    let {
                        ...
                        autoTrackExposure: !0
                    }, l = (0, i.default)([s.default], () => s.default.getCurrentUser()), r = o.useExperiment({
                        ...
                        user: l,
                        config: r
                    }), m = a && c && null != t && (null == t ? void 0 : null === (e = t.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible) !== !1;
                    return {
                        viewAndUseEnabled: a,
                        collectEnabled: m,
                        showTryPacksModalAndV2Copy: d,
        ...
        650484: function(e, t, n) {
            ...
            function h(e) {
                ...
                let {
                    ...
                    setReadySlideId: C
                } = (0, f.usePaymentContext)(), A = p.find(e => e.key === S);
                l.useEffect(() => {
                    N(null)
                }, [S, N]), o(null != A, "Unknown step for current payment flow.");
                let b = null !== (u = null == A ? void 0 : null === (t = A.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    I = null == A ? void 0 : null === (n = A.options) || void 0 === n ? void 0 : n.bodyClassName,
                    O = void 0 !== g && g ? m.sliderBodyLarge : null == A ? void 0 : null === (s = A.options) || void 0 === s ? void 0 : s.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (d = null == A ? void 0 : null === (a = A.options) || void 0 === a ? void 0 : a.renderHeader) || void 0 === d || d ? h : null, A.renderStep(E), null == S || b ? null : (0, i.jsxs)(i.Fragment, {
                        children: [(0, i.jsx)(c.ModalContent, {
                            className: r(m.body, I),
        ...
        817963: function(e, t, n) {
            ...
            let f = {
                ...
                g = e => {
                    let [t, n] = e instanceof a.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : h(e), [l, r, d, g] = (0, s.useStateFromStoresArray)([o.default], () => [o.default.can(c.Permissions.CREATE_GUILD_EXPRESSIONS, e), o.default.can(c.Permissions.MANAGE_GUILD_EXPRESSIONS, e), o.default.can(t, e), o.default.can(n, e)]), E = (0, s.useStateFromStores)([u.default], () => u.default.getCurrentUser()), S = i.useCallback(e => m(e, E, r, l), [l, r, E]), p = i.useCallback(e => m(e, E, g, d), [g, d, E]);
                    return null == e ? f : {
                ...
                E = function(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : o.default,
                        ...
                        [i, l] = e instanceof a.default ? [c.Permissions.CREATE_EVENTS, c.Permissions.MANAGE_EVENTS] : h(e),
                    ...
                    return null == e ? f : {
                        ...
                        canManageAllExpressions: r,
                        canManageAllEvents: g,
                        canManageGuildExpression: e => m(e, E, r, s),
                        canManageGuildEvent: e => m(e, E, g, d)
                    }
                },
                S = e => {
                    let t = (0, s.useStateFromStores)([o.default], () => o.default.can(c.Permissions.MANAGE_GUILD, e)),
                        {
        ...
        716849: function(e, t, n) {
            ...
            function p(e, t, n, i) {
                null != e && !(0, d.isPremium)(e) && n && (t && g(), i && (!u.default.isLoadedForSKU(f.PremiumSubscriptionSKUs.TIER_0) && !u.default.isFetchingForSKU(f.PremiumSubscriptionSKUs.TIER_0) && (0, a.fetchSubscriptionPlansForSKU)(f.PremiumSubscriptionSKUs.TIER_0), !u.default.isLoadedForSKU(f.PremiumSubscriptionSKUs.TIER_2) && !u.default.isFetchingForSKU(f.PremiumSubscriptionSKUs.TIER_2) && (0, a.fetchSubscriptionPlansForSKU)(f.PremiumSubscriptionSKUs.TIER_2)))
            }
        },
        ...
        876189: function(e, t, n) {
            ...
            function A(e) {
                let {
                    ...
                    className: n,
                    onChange: s
                } = e, g = (0, a.useStateFromStoresObject)([f.default, c.default, m.default, d.default], () => {
                    let e = {};
                    ...
                    return e
                }), A = (0, a.useStateFromStoresObject)([p.default], () => {
                    let e = {};
        ...
        865372: function(e, t, n) {
            ...
            function E() {
                ...
                if (null == t) return !1;
                m.overwriteHistory(l.mapValues(t, e => ({
                    ...e,
            ...
            class S extends s.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (f = e), this.syncWith([u.default], g), this.syncWith([o.default], E)
                }
                getState() {
                    return f
                }
            ...
            var p = new S(r.default, {
                STICKER_TRACK_USAGE: e => {
                    ...
                    null == t || t.forEach(e => {
                        m.track(e), f.pendingUsages.push({
                            key: e,
                            timestamp: Date.now()
                        })
                    }), h()
        ...
        181114: function(e, t, n) {
            ...
            class E extends r.PureComponent {
                render() {
                    ...
                    return (0, s.jsx)(u.default.div, {
                        ...i,
                        className: o(m.shineContainer, e, {
                            [m.shinePaused]: n
                        }),
                        children: (0, s.jsx)(f.default, {
            ...
            let S = e => {
                let {
                    ...
                    onlyShineOnHover: g,
                    ...S
                } = e, p = r.createRef(), v = (0, c.default)(p), _ = !i && !l && !0 !== a && (!g || v);
                return (0, s.jsxs)(d.Button, {
                    buttonRef: p,
                    ...S,
                    className: o(m.shinyButton, n),
                    disabled: i,
                    submitting: l,
                    children: [t, _ ? (0, s.jsx)(E, {
                        shinePaused: f,
                        className: o(m.buttonShine, g ? m.onlyShineOnHover : void 0, h),
                        shineSize: u
                    }) : null]
                })
            };
        ...
        461380: function(e, t, n) {
            ...
            let m = {
                ...
                h = e => {
                    ...
                    if (!0 === p ? N = m.DOWN : !1 === p && (N = m.RIGHT), _) {
                        let e = {
                            [m.UP]: u.ChevronSmallUpIcon,
                            [m.DOWN]: r.ChevronSmallDownIcon,
                            [m.LEFT]: a.ChevronSmallLeftIcon,

    ...
    ["79614"], {
            ...
            var l = n("414456"),
                ...
                c = e => {
                    let t, n, l, {
                        ...
                        h = f.hasFeature(c),
                        T = (0, o.minimumRequiredTierForGuildFeature)(c);
                    return (h ? (null != T && (l = u.default.Messages.PREMIUM_GUILD_INCLUDED), t = (0, i.jsxs)(i.Fragment, {
                    ...
                    })) : (null != T && (l = u.default.Messages.CLICK_TO_LEARN_MORE), t = (0, i.jsxs)(i.Fragment, {
                        children: [(0, i.jsx)(s.default, {
                            className: d.icon
                        }), (0, i.jsx)(a.Heading, {
                            variant: "eyebrow",
                            className: d.description,
                            children: null != T && (0, o.getShortenedTierName)(T)
                        })]
                    ...
                    }), null == p || h) ? n : (0, i.jsx)(a.Clickable, {
                        onClick: p,
        ...
        420333: function(e, t, n) {
            ...
            function w(e) {
                ...
                } = e, H = (0, r.useStateFromStores)([S.default], () => S.default.isFocused()), B = (0, r.useStateFromStores)([_.default], () => _.default.getCurrentUser()), V = (0, r.useStateFromStores)([E.default], () => E.default.getGuildId()), j = (0, r.useStateFromStores)([f.default], () => f.default.getGuild(V)), W = (0, r.useStateFromStores)([u.default], () => u.default.isEditingClydeProfile()), {
                    reducedMotion: Y
                } = l.useContext(a.AccessibilityPreferencesContext), K = (0, a.useModalContext)(), z = !C.default.canUseAnimatedAvatar(B) && I === v.UploadTypes.AVATAR && !W, {
                    analyticsLocations: Z
                } = (0, o.default)(b, s.default.SELECT_IMAGE_MODAL);
                ...
                return l.useEffect(() => {
                    z && g.default.track(N.AnalyticEvents.PREMIUM_UPSELL_VIEWED, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                R = !0, null == S || S(), !I && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: h,
                            analyticsObject: T,
                    ...
                    onCloseCallback: () => {
                        !R && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: P,
                            ...
                            application_id: D,
                            location_stack: h
                        }), (0, a.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == _ || _(R), R && (!I && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },
        ...
        235004: function(e, t, n) {
            ...
            class L extends s.default.Store {
                ...
                hasFetchedAllSounds() {
                    return I === l.FETCHED && C === l.FETCHED
                }
            }
            L.displayName = "SoundboardStore";
            var U = new L(o.default, {
                LOGOUT: function() {
                    h.clear(), T.clear(), N.clear(), v = !1, I = l.NOT_FETCHED, C = l.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: l,
                        userId: r
                    } = e, a = (null !== (n = T.get(l)) && void 0 !== n ? n : 0) + 1, s = (null !== (i = N.get(r)) && void 0 !== i ? i : 0) + 1;
                    T.set(l, a), N.set(r, s), r !== (null === (t = c.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (v = !0)
                },
                ...
                USER_SETTINGS_PROTO_UPDATE: function(e) {
                    ...
                    } else n === p.UserSettingsTypes.PRELOADED_USER_SETTINGS && D(i)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    h.set(_.DEFAULT_SOUND_GUILD_ID, t), C = l.FETCHED
                },
        ...
        865372: function(e, t, n) {
            ...
            class h extends r.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (f = e), this.syncWith([u.default], S), this.syncWith([o.default], p)
                }
                getState() {
                    return f
                }
        ...
        364685: function(e, t, n) {
            ...
            function M(e) {
                null != e.stickers && (e.stickers.forEach(t => y(t, !0, e)), D(e.id, e.stickers))
            }
            ...
            var F = new b(s.default, {
                BACKGROUND_SYNC: () => {
                    m = null, I = new Map, O = new Map, g = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    m = null, I = new Map, O = new Map, t.forEach(M), g = t.every(e => null != e.stickers) ? 1 : 0
                },
                GUILD_CREATE: function(e) {
                    let {
                        guild: t
                    } = e;
                    !f.default.isLurking(t.id) && (M(t), 1 === g && null == t.stickers && null != t.stickerUpdates && (g = 0))
                },
                GUILD_DELETE: function(e) {
                    var t;
                    let {
                ...
                LOGOUT: () => {
                    g = 0, N = [], I.clear(), C.clear(), m = null, O.clear(), O = new Map(O), A = !1, v = null
                },
                ...
                GUILD_STICKERS_CREATE_SUCCESS: e => {
                    ...
                    D(i, [...null !== (n = r.filter(e => e.id !== l.id)) && void 0 !== n ? n : [], l]), y(l)
                },
        ...
        26092: function(e, t, n) {
            ...
            function A(e) {
                ...
                if (null == d) return O();
                c = null !== (t = e.section) && void 0 !== t ? t : c, N = null !== (n = e.section) && void 0 !== n ? n : c, null != e.subsection && null != c && (f[c] = e.subsection), null != e.scrollPosition && null != c && (E[c] = e.scrollPosition), T = !!e.openWithoutBackstack, u = o.FormStates.OPEN, _ = {}, p = {
                    ...S = {
                ...
                }, C = null !== (i = e.onClose) && void 0 !== i ? i : null, I = null !== (l = e.analyticsLocation) && void 0 !== l ? l : null, m = null !== (r = e.analyticsLocations) && void 0 !== r ? r : [], v = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }

            function O() {
                u = o.FormStates.CLOSED, h = !1, S = null, N = null, p = null, d = null, c = null, f = {}, E = {}, C = null, I = null, m = [], v = null
            }
            ...
            class L extends r.default.Store {
                ...
                hasChanges() {
                    return null != p && null != S && (!!this.isOpen() || g === o.DrawerTabTypes.USER_SETTINGS) && !l.isEqual(p, S)
                }
                isOpen() {
                    return h
                }
            ...
            var U = new L(a.default, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return g = e.tab, null == c && g === o.DrawerTabTypes.USER_SETTINGS && A({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        181114: function(e, t, n) {
            ...
            let h = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...T
                } = e, g = a.createRef(), C = (0, c.default)(g), I = !i && !s && !0 !== u && (!h || C);
                return (0, r.jsxs)(d.Button, {
                    ...
                    disabled: i,
                    submitting: s,
                    children: [t, I ? (0, r.jsx)(p, {
                        shinePaused: _,
                        className: o(E.buttonShine, h ? E.onlyShineOnHover : void 0, S),
                        shineSize: f
                    }) : null]
                })
            };

    ...
    [5013], {
        621647: (e, t, n) => {
            ...
            function c(e) {
                ...
                switch (e.type) {
                    case l.d4z.DM:
                        var o = s(e.recipients.map(r.default.getUser).filter(a.lm), 1),
                            c = o[0];
        ...
        599467: (e, t, n) => {
            ...
            var c = s(o({}, r.Z.guildEventRules.link), {
                    react: (0, a.Z)({
                        enableBuildOverrides: !1,
                        mustConfirmExternalLink: !0
                    }).react
                }),
                u = s(o({}, r.Z.guildEventRules.channelMention), {
                    react: (0, i.Z)({
                        enableBuildOverrides: !1,
                ...
                d = r.Z.reactParserFor(s(o({}, r.Z.guildEventRules), {
                    link: c,
                    channelMention: u
                }))
        },
        434149: (e, t, n) => {
            ...
            function o(e) {
                ...
                r.useEffect((function() {
                    null == t && null != (null == e ? void 0 : e.creator_id) && a.Z.requestMembersById(e.guild_id, e.creator_id)
                }), [e, t]);
                return t
            }
        },
        32421: (e, t, n) => {
            ...
            function i(e, t) {
                var n = null;
                e === r.WX.EXTERNAL && null != t && "location" in t && (n = t.location);
                return n
            }
        ...
        371188: (e, t, n) => {
            ...
            function u(e, t, n) {
                ...
                var r = i()(e),
                    ...
                    l = null != t && r.isSame(a, "day");
                return {
                    startDateTimeString: c(r, n),
                    endDateTimeString: null != a ? l ? a.format("LT") : s(a, n) : void 0,
        ...
        205316: (e, t, n) => {
            ...
            function l(e, t) {
                ...
                if (null != l) {
                    var o;
                    n = "".concat(null !== (o = a.env.API_PROTOCOL) && void 0 !== o ? o : location.protocol, "//").concat(l, "/guild-events/").concat(e.id, "/").concat(e.image)
        ...
        314597: (e, t, n) => {
            ...
            function m(e) {
                ...
                return (0, r.jsx)("div", {
                    className: l()(c().descriptionText, n, d().markup, f({}, c().truncate, u)),
                    children: m
                })
            }
        },
        ...
        220109: (e, t, n) => {
            ...
            function j(e) {
                var t = e.className,
                    ...
                    S = (0, l.e7)([s.ZP], (function() {
                        return s.ZP.getNick(h, null == i ? void 0 : i.id)
                    }), [h, i]);
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(m.z, {
                        ...
                        className: b().spacer
                    }), !x && null != i && (0, r.jsx)(o.Tooltip, {
                        text: p.Z.Messages.GUILD_EVENT_CREATED_BY.format({
                            username: null != S ? S : u.ZP.getName(i)
                        }),
                        children: function(e) {
                            return (0, r.jsx)(o.Avatar, y(g({}, e), {
                                src: i.getAvatarURL(h, 20),
                                size: o.AvatarSizes.SIZE_20,
                                "aria-label": null != S ? S : i.username,
                                className: b().creator
                            }))
                        }
                    }), null != n && (0, r.jsx)(o.Tooltip, {
                        text: p.Z.Messages.GUILD_EVENT_INTERESTED_COUNT.format({
                            count: n
                        }),
                        children: function(e) {
                            return (0, r.jsxs)("div", y(g({
            ...
            function O(e) {
                var t = e.headerVariant,
                    ...
                    m = e.imageSource;
                return (0, r.jsxs)("div", {
                    className: a()(h({}, b().withThumbnail, null != m)),
                    children: [(0, r.jsxs)("div", {
                        className: a()(h({}, b().descriptionWithThumbnail, null != m)),
        ...
        616918: (e, t, n) => {
            ...
            function x(e) {
                var t = e.children,
                    ...
                    i = e.tooltipText;
                return (0, r.jsx)("div", {
                    className: b().eventStatusContainer,
                    children: (0, r.jsx)(s.Tooltip, {
                        position: "right",
                        text: i,
                        shouldShow: null != i,
                        children: function(e) {
                            return (0, r.jsx)("div", y(function(e) {
                                for (var t = 1; t < arguments.length; t++) {
                                    var n = null != arguments[t] ? arguments[t] : {},
                                        r = Object.keys(n);
                                    "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
                                ...
                                className: l()(b().eventStatusContainer, n),
                                children: t
                            }))
                        }
                    })
            ...
            function S(e) {
                var t = e.text,
                    n = e.endDateTimeString,
                    i = e.textVariant,
                    a = e.className,
                    l = e.isNew,
                    o = t;
                null != n && "" !== n && (o = p.Z.Messages.START_DATE_TO_END_DATE_WITH_COLOR.format({
                    start: t,
                    startHook: function(e) {
                        return (0, r.jsx)(s.Text, {
                            color: "text-positive",
                            variant: "text-sm/semibold",
                            className: b().liveEventEndTime,
                            children: e
                        })
                    },
                    end: n
                ...
                return (0, r.jsxs)(x, {
                    className: a,
                    children: [l ? (0, r.jsx)(N, {}) : (0, r.jsx)(c.Z, {
                        className: b().eventStatusGreen,
                        width: O,
                        height: O
                    }), (0, r.jsx)(s.Text, {
                        color: null == n ? "text-positive" : void 0,
                        variant: i,
                        className: b().eventStatusLabel,
                        children: o
                    })]
                })
            }
            ...
            function w(e) {
                var t = e.textVariant,
                    n = e.startDateTimeString,
                    i = e.className,
                    a = e.isNew;
                return (0, r.jsxs)(x, {
                    className: i,
                    tooltipText: n,
                    children: [a ? (0, r.jsx)(N, {}) : (0, r.jsx)(u.Z, {
                        className: b().eventStatusBrand,
                        width: O,
                        height: O
                    }), (0, r.jsx)(s.Text, {
                        color: "text-brand",
            ...
            function E(e) {
                ...
                return (0, r.jsxs)(x, {
                    className: i,
                    children: [a ? (0, r.jsx)(N, {}) : (0, r.jsx)(c.Z, {
                        className: b().eventStatusBrand,
                        width: O,
                        height: O
                    }), (0, r.jsx)(s.Text, {
            ...
            function T(e) {
                var t = e.startTime,
                    ...
                    c = e.liveText,
                    u = e.textVariant,
                    d = void 0 === u ? "text-sm/semibold" : u,
                    v = e.isNew;
                null == c && (c = l === m.WX.EXTERNAL ? p.Z.Messages.STAGE_CHANNEL_HAPPENING_NOW : p.Z.Messages.STAGE_CHANNEL_LIVE_NOW);
                var b = j(i.useState((0,
                        f.ub)(t, s)), 2),
                    h = b[0],
                    g = h.startDateTimeString,
                    y = h.endDateTimeString,
                    O = h.currentOrPastEvent,
                    N = h.upcomingEvent,
                    x = h.diffMinutes,
                    T = b[1];
                ...
                var C = g;
                null != y && "" !== y && (C = p.Z.Messages.START_DATE_TO_END_DATE.format({
                    start: g,
                    end: y
                }));
                return n ? (0, r.jsx)(S, {
        ...
        605013: (e, t, n) => {
            ...
            var _ = function(e, t) {
                    switch (null == e ? void 0 : e.entity_type) {
                        case T.WX.STAGE_INSTANCE:
                            return function(e, t) {
                                return function(n) {
                                    var r = m.Z.getChannel(e.channel_id);
                                    if (null != r) {
                                        n.stopPropagation();
                                        (0, d.Cq)(r);
                                        null == t || t(n)
                ...
                Z = function(e, t) {
                    return t && [T.WX.STAGE_INSTANCE, T.WX.VOICE].includes(null == e ? void 0 : e.entity_type)
                },
                k = i.memo((function(e) {
                    var t = e.guild,
                        ...
                        a = e.channel,
                        l = e.isMember,
                        u = (0, o.e7)([p.Z], (function() {
                            return null == t ? null : null !== (e = p.Z.getGuild(t.id)) && void 0 !== e ? e : new f.Z(t);
                            var e
                        }), [t]),
                        d = (0, E.u)(n, a),
                    ...
                    var g, y = null == d ? void 0 : d.IconComponent,
                    ...
                    return (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(b.Z.Icon, {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: Z(n, l) ? (0, r.jsx)(s.Clickable, {
                ...
                L = i.memo((function(e) {
                    var t = e.guildId,
                        ...
                        f = (0, o.e7)([j.ZP], (function() {
                            return j.ZP.hasRsvp(n, t)
                        }), [t, n]),
                        m = function(e) {
                            e.stopPropagation();
                            l ? i && d() : u()
                        };
                    return l ? i ? (0, r.jsx)(s.Button, {
                        className: D().button,
                        ...
                        children: c ? C.Z.Messages.GUILD_SCHEDULED_EVENT_VIEW_DETAIL : C.Z.Messages.JOIN_GUILD
                    }) : a ? (0, r.jsx)(s.Button, {
                        className: D().button,
                        size: s.Button.Sizes.SMALL,
                        disabled: !0,
                        ...
                        onClick: function(e) {
                            e.stopPropagation();
                            f ? O.Z.deleteRsvpForGuildEvent(n, t) : O.Z.createRsvpForGuildEvent(n, t)
                        },
            ...
            const M = i.memo((function(e) {
                ...
                var m, p = (0, j.xt)(t),
                    v = (0,
                        j.Z2)(t),
                    h = t.entity_type === T.WX.EXTERNAL;
                return (0, r.jsx)(b.Z, {
                    className: l()(A({}, D().clickable, o)),
                    children: (0, r.jsxs)(s.Clickable, {
                        ...
                        children: [null != t.image && (0, r.jsx)(w.Z, {
                            ...
                            name: t.name,
                            description: null !== (m = t.description) && void 0 !== m ? m : void 0,
                            isActive: p,
                            isEnded: v,
            ...
            var I = function(e) {
                ...
                T = function(e) {
                    ...
                    return null != n ? (0, r.jsx)(b.Z, {
                        ...
                        className: x,
                        animate: O
                    }) : null != a ? (0, r.jsx)(o.Avatar, {
                        onClick: u,
                        src: (0, s.x)(a),
                        size: o.AvatarSizes.SIZE_56,
                        className: x,
                        "aria-label": y
                    }) : null != v ? (0, r.jsx)(o.Avatar, {
                        onClick: u,
                ...
                C = function(e) {
                    var t = e.title,
                        ...
                        l = (0, r.jsx)(o.Heading, {
                            ...
                            className: (0, p.l)(j(), "inviteDestination", i ? "Expired" : null != n ? "Joined" : ""),
                            children: t
                        });
                    return (0, r.jsxs)(v.Z, {
                        ...
                        children: [null == n ? l : (0, r.jsx)(o.Clickable, {
                            onClick: n,
                            children: l
                        }), (0, r.jsx)(o.Text, {
                            tag: "strong",
                ...
                A = function(e) {
                    var t = e.children,
                        ...
                        i = e.className,
                        a = e.isDisabled,
                        s = S(e, ["children", "onClick", "className", "isDisabled"]);
                    return (0, r.jsx)(o.Button, x(function(e) {
                        for (var t = 1; t < arguments.length; t++) {
                            var n = null != arguments[t] ? arguments[t] : {},
                                r = Object.keys(n);
                            "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
                        ...
                        onClick: n,
                        size: j().buttonSize,
                        className: l()(j().button, i),
                        children: t
                    }))
                };
            A.Colors = o.Button.Colors;
            A.Looks = o.Button.Looks;
            A.defaultProps = {
                className: null,
                isDisabled: !1
            };
                ...
                Z = function(e) {
                    ...
                    return null == s ? null : (0, r.jsx)("div", {
                        ...
                        children: (0, r.jsx)("img", {
                            src: s,
                            alt: "",
                            className: l()(j().inviteSplashImage, N({}, j().inviteSplashImageLoaded, a)),
                            onLoad: function() {
                                return o(!0)
                            }
                        })
        ...
        312682: (e, t, n) => {
            ...
            function s(e) {
                var t = e.width,
                    ...
                    f = e.foreground,
                    m = o(e, ["width", "height", "color", "foreground"]);
...
//# sourceMappingURL=54548eb3816de4d097d4.js.map
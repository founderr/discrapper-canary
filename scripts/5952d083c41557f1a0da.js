    ...
    [71041, 96043, 71402], {
            ...
            function M(e) {
                ...
                if (!v.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== _.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = u.Z.getChannel(o),
                        l = D(a, i),
                        s = N({}, t, U(l), null != i && null != o && (0, b.AB)(o) ? R(0, o) : y(a));
                    v.default.track(e, s, {
                        flush: n
                    })
                }
        ...
        525135: (e, t, n) => {
            ...
            function g(e) {
                var t, n, s = e.transitionState,
                    ...
                    U = null != g ? g : u.Z.Messages.GUILD_PRODUCT_SETTINGS_WARNING_MODAL_TITLE;
        ...
        922093: (e, t, n) => {
            ...
            function w(e) {
                var t, n = e.hasError,
                    ...
                    o = e.text;
                return (0, r.jsxs)("div", {
                    className: a()(R().maxLength, y({}, R().errorOverflow, n)),
                    "aria-hidden": "true",
            ...
            function x(e) {
                var t, n = e["aria-labelledby"],
                    ...
                    U = b[1],
                    R = i.useRef(!0 === u),
                    P = null != n ? n : null == T ? void 0 : T.titleId,
            ...
            function Lt(e) {
                ...
                return (0, r.jsx)("svg", Pt(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            function vn(e) {
                var t, o, a, l, g, m, h, v = e.guildId,
                    ...
                    Y = Q[0],
                    J = Q[1],
                    $ = An(i.useState(null !== (g = null == R ? void 0 : R.price_tier) && void 0 !== g ? g : void 0), 2),
                    ee = $[0],
                    te = $[1],
                    ...
                    Pe = null != (null == R ? void 0 : R.attachments) && (null == R ? void 0 : R.attachments.length) > 0,
                    ye = null != be ? be : Ee,
                    Le = null != Te && "published" in Te,
                    De = null != Te && !Le,
                    Me = null !== (h = null == R ? void 0 : R.role_id) && void 0 !== h ? h : null,
                    je = An(i.useState(), 2),
                    we = je[0],
                    xe = je[1],
                    Ze = null != we || null != Me,
                    ...
                    Ge = "";
                Ze && he ? Ge = C.Z.Messages.GUILD_PRODUCT_CARD_TYPE_DOWNLOADABLE_AND_ROLE : Ze ? Ge = C.Z.Messages.GUILD_PRODUCT_CARD_TYPE_ROLE : he && (Ge = C.Z.Messages.GUILD_PRODUCT_CARD_TYPE_DOWNLOADABLE);
                var Ve = function() {
                        ve(!1);
                        Re()
                    },
                    ...
                    Ke = i.useMemo((function() {
                        return function(e) {
                            ...
                            isImageChanged: de,
                            newRoleParams: we,
                            hasSavedAttachments: Pe,
                            hasUnsavedAttachmentChanges: Ue
                        })
                    }), [R, X, ee, Y, ie, se, de, we, Pe, Ue]),
                    We = Ke.changes,
                    ...
                    children: [(0, r.jsxs)(d.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(d.ScrollerThin, {
                            ...
                            children: (0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)(Nt, {
                                    disabled: !Je,
                                    disabledTooltip: P ? C.Z.Messages.GUILD_PRODUCT_UNPUBLISH_REQUIRES_SAVE : C.Z.Messages.GUILD_PRODUCT_PUBLISH_REQUIRES_SAVE,
                                    published: P,
                                    onClick: function() {
                                        u()(Je, "Attempting to publish/unpublish when not allowed");
                                        He(P ? dn.UNPUBLISH : dn.PUBLISH);
                                        it(cn(sn({}, We), {
                                            published: !P
                                        }))
                                    },
        ...
        442212: (e, t, n) => {
            ...
            function b(e) {
                ...
                var ee, te = V ? a()(v().artContainer, v().artContainerBoxShadow, P) : a()(v().artContainer, P),
                    ne = null;
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != P[e] && null != P[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var l in P[e][t]) t === M ? d.ZP.isNewForumThread(l, t, r) && D[e][t]++ : o.default.compare(l, i) > 0 && !d.ZP.hasOpenedThread(l) && D[e][t]++
                        }
                    }
                }
            }
            ...
            var ne = {},
                ...
                le = function(e) {
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, o, a;
                        return i().size(null !== (o = null === (n = U[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== o ? o : {}) + i().size(null !== (a = null === (r = P[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== a ? a : {})
                    };

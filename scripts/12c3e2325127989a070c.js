            ...
            var A = i.forwardRef(function(t, e) {
                    ...
                    V = i.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                }), null == y || y(e), O.current.size > 0 ? E.current = window.requestAnimationFrame(V) : (e.clearRect(0, 0, t.width, t.height), E.current = null);
                                var n = Date.now();
                ...
                var F = i.useCallback(function(t, e) {
                    ...
                    j = i.useCallback(function(t, e, n, i, a) {
                        var o, u, l, h, f, d, v, y, k, A, O, E, P, S, V, j = (o = null !== (V = t.id) && void 0 !== V ? V : (0, r.v4)(), u = t, l = n, h = i, f = a, y = _((v = (d = u, p(p({
                            id: o
                        }, c), d))).size), A = (k = function(t, e) {
                            if (null != t) {

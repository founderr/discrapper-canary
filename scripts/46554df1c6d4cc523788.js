        ...
        676143: function(e, t, n) {
            ...
            function S(e, t, n, r) {
                ...
                let s = (0, C.useCanSeeOnboardingHome)(e),
                    a = l.useCallback((e, t) => !(s && e.channel.hasFlag(M.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) && e.channel.type !== I.ChannelTypes.GUILD_DIRECTORY && (0 === t.length || i(t, e.channel.name.toLowerCase()) || e.channel.topic.toLowerCase().includes(t)), [s]);
                return l.useMemo(() => {
                    let e = {
                        null: [],
                        _categories: []
            ...
            function T(e, t, n, l) {
                let r = (0, h.useIsDismissibleContentDismissed)(c.DismissibleContent.CHANNEL_BROWSER_NUX),
                    i = (0, o.useStateFromStoresObject)([p.default], () => {
                        let t = {},

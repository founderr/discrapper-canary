...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [73679], {
        673679: (e, t, n) => {
            ...
            function K() {
                return (K = b((function(e, t) {
                    var n, r, i, a;
                    return O(this, (function(s) {
                        switch (s.label) {
                            case 0:
                                if (null == e || null == t) throw x("Stripe or elements not loaded");
                                if (null == (n = t.getElement(o.CardNumberElement))) throw x("Unable to load card elements from Stripe");
                                return [4, e.createToken(n)];
                            case 1:
                                r = s.sent(), i = r.token;
                                if (null != (a = r.error)) throw x(a);
                                if (null == i) throw x("token not available with successful stripe call");
                                return [2, i.id]
                        }
                    }))
                }))).apply(this, arguments)
                    ...
                    return O(this, (function(I) {
                        switch (I.label) {
                            case 0:
                                ...
                                if (null == i) throw x("Name required for EPS");
                                u.Z.dispatch({
                                    type: "BILLING_PAYMENT_SOURCE_CREATE_START"
                                });
                                return [4, F(n)];
                            ...
                            case 2:
                                ...
                                if (null != (E = y.error)) throw x(E);
                                if (null == d) throw x("paymentMethod not available with successful stripe call");
                    ...
                    return O(this, (function(I) {
                        switch (I.label) {
                            case 0:
                                ...
                                o = n.email, i = n.name, a = n.line1, s = n.line2, c = n.city, l = n.state, p = n.postalCode, _ = n.country;
                                if (null == i) throw x("Name required for iDEAL");
                                u.Z.dispatch({
                                    type: "BILLING_PAYMENT_SOURCE_CREATE_START"
                                });
                                return [4, F(n)];
                    ...
                    return O(this, (function(R) {
                        switch (R.label) {
                            case 0:
                                if (null == e) throw x("Stripe not loaded");
                                o = n.email, i = n.name, a = n.line1, s = n.line2, c = n.city, l = n.state, p = n.postalCode, _ = n.country;
                                if (null == o) throw x("Email required for Przelewy24");
                                u.Z.dispatch({
                                    type: "BILLING_PAYMENT_SOURCE_CREATE_START"
                                });
                                return [4, F(n)];
                            ...
                            case 2:
                                ...
                                if (null != (I = d.error)) throw x(I);
                                if (null == E) throw x("paymentMethod not available with successful stripe call");
                    ...
                    return O(this, (function(E) {
                        switch (E.label) {
                            ...
                            case 2:
                                ...
                                if (null != (d = f.error)) throw x(d);
                                if (null == y) throw x("paymentMethod not available with successful stripe call");
                    ...
                    return O(this, (function(R) {
                        switch (R.label) {
                            ...
                            case 6:
                                ...
                                if (null != (I = d.error)) throw x(I);
                                if (null == (null == E ? void 0 : E.payment_method)) throw x("setupIntent.payment_method not available with successful stripe call");
                    ...
                    return O(this, (function(I) {
                        switch (I.label) {
                            ...
                            case 2:
                                y = I.sent(), d = y.paymentMethod;
                                if (null != (E = y.error)) throw x(E);
                                if (null == d) throw x("stripePaymentMethod not available with successful stripe call");
                ...
                return (le = b((function(e, t, n) {
                    ...
                    return O(this, (function(f) {
                        switch (f.label) {
                            ...
                            case 2:
                                i = f.sent();
                                a = s.ZP.getAPIBaseURL() + h.ANM.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(t, null != i ? i : "", "success");
                                f.label = 3;
                            case 3:
                                f.trys.push([3, 5, , 6]);
                                return [4, Y(h.gg$.ADYEN, JSON.stringify(o), e, {
                                    billingAddressToken: r,
                                    analyticsLocation: n,
                                    returnUrl: a
                                })];
                            case 4:
                                return [2, {
                                    paymentSource: f.sent(),
                                    redirectConfirmation: !1
                                }];
                            case 5:
                                if ((p = f.sent()).code !== l.SM.CONFIRMATION_REQUIRED) {
                                    u.Z.dispatch({
                                        type: "BILLING_PAYMENT_SOURCE_CREATE_FAIL",
                                        error: new c.HF("Unable to create payment source token: code: ".concat(null == p ? void 0 : p.code, " message: ").concat(null == p ? void 0 : p.message), c.HF.ErrorCodes.UNKNOWN)
                                    });
                                    throw p
                                }
                                if (null == (_ = p.fields.adyen_redirect_url)) throw x("redirect url cannot be null on a redirect for adyen.");
                                Be(_);
                                return [2, {
                    ...
                    return O(this, (function(P) {
                        switch (P.label) {
                            case 0:
                                ...
                                t = (0, d.gB)(t);
                                f = null;
                                return null != n && S.QL.has(n.type) ? [4, nt(n.type)] : [3, 2];
                            case 1:
                                I = P.sent();
                            ...
                            case 8:
                                ...
                                if (!L.body.payment_id) throw x("payment id cannot be null on redirected confirmations.");
                                return [2, Ce(L.body, n)];
                            case 9:
                                return [2]
                        }
                    }))
            ...
            function Oe() {
                return (Oe = b((function(e, t, n, r) {
                    var o, i, a, p, _, f, y, d, E;
                    return O(this, (function(I) {
                        switch (I.label) {
                            case 0:
                                o = null;
                                return null != n && S.Uk.has(n.type) ? [4, nt(n.type)] : [3, 2];
                            case 1:
                                i = I.sent();
                            ...
                            case 7:
                                ...
                                if (!d.body.payment_id) throw x("payment id cannot be null on redirected confirmations.");
                                return [2, Ce(d.body, n)];
                            case 8:
                                return [2]
                        }
                    }))
                    ...
                    return O(this, (function(s) {
                        switch (s.label) {
                            ...
                            case 2:
                                ...
                                return h.j8d.has(t.type) ? [4, nt(t.type)] : [3, 5];
                            case 3:
                                a = s.sent();
                                return [4, Fe({
                                    stripe: n,
                    ...
                    return O(this, (function(o) {
                        switch (o.label) {
                            ...
                            case 1:
                                ...
                                if (!h.j8d.has(r.type)) throw x("unsupported redirect payment source");
                                if ((null == n || null === (t = n.body) || void 0 === t ? void 0 : t.status) === S.Py.FAILED) throw x("payment failed");
                                return r.paymentGateway === h.gg$.STRIPE ? [2, ge(e)] : [2, !0]
                        }
                    }))
                }))).apply(this, arguments)
            }
                    ...
                    return O(this, (function(a) {
                        switch (a.label) {
                            case 0:
                                return [4, I.d2()];
                            case 1:
                                if (null == (t = a.sent())) throw x("Stripe has not loaded.");
                            ...
                            case 3:
                                ...
                                if (null != (i = r.error)) throw x(i);
                                if (null == o) throw x("paymentIntent not available with successful stripe call");
                                if (null != o.last_payment_error) throw x("unable to retrieve payment intent ".concat(o.last_payment_error));
                                return [2, !0]
                        }
                    }))
                }))).apply(this, arguments)
                    ...
                    return O(this, (function(c) {
                        switch (c.label) {
                            case 0:
                                ...
                                i = {};
                                if (n.type !== S.He.SEPA_DEBIT) throw x("Unsupported redirected payment source type.");
                            ...
                            case 1:
                                ...
                                if (null != (u = a.error)) throw x(u);
                                if (null == s) throw x("paymentIntent not available with successful stripe call");
                                return [2]
                        }
                    }))
                }))).apply(this, arguments)
                    ...
                    return O(this, (function(f) {
                        switch (f.label) {
                            case 0:
                                ...
                                switch (n.type) {
                                    ...
                                    case S.He.SOFORT:
                                        ...
                                        break;
                                    case S.He.PRZELEWY24:
                                        if (null == n.bank) throw x("PaymentSource (".concat(n.id, ") missing bank info for p24."));
                                        c = {
                                            p24: {
                                                bank: n.bank
                                            },
                                        ...
                                        break;
                                    case S.He.EPS:
                                        if (null == n.bank) throw x("PaymentSource (".concat(n.id, ") missing bank info for EPS."));
                                        c = {
                                            eps: {
                                                bank: n.bank
                                            },
                                        ...
                                        break;
                                    case S.He.IDEAL:
                                        if (null == n.bank) throw x("PaymentSource (".concat(n.id, ") missing bank info for iDEAL."));
                                        c = {
                                            ideal: {
                                                bank: n.bank
                                            },
                            ...
                            case 1:
                                ...
                                if (null != (_ = l.error)) throw x(_);
                                if (null == p) throw x("paymentIntent not available with successful api call");
                                if (null == (null === (i = p.next_action) || void 0 === i || null === (a = i.redirect_to_url) || void 0 === a ? void 0 : a.url)) throw x("confirm payment did not return a redirect url");
                    ...
                    return O(this, (function(A) {
                        switch (A.label) {
                            ...
                            case 1:
                                ...
                                return null == t.paymentSource ? [3, 3] : [4, _e(t.paymentSource)];
                            case 2:
                                p = A.sent();
                                return [3, 4];
                            case 3:
                            ...
                            case 5:
                                ...
                                return null != t.paymentSource && S.QL.has(t.paymentSource.type) ? [4, nt(t.paymentSource.type)] : [3, 7];
                            case 6:
                                _ = A.sent();
                            ...
                            case 9:
                                ...
                                if (!I.body.payment_id) throw x("payment id cannot be null on redirected confirmations.");
                                return [2, Ce(I.body, t.paymentSource)];
                            case 10:
                                return [2]
                        }
                    }))
            ...
            function y() {
                return (y = u((function() {
                    ...
                    return l(this, (function(r) {
                        switch (r.label) {
                            case 0:
                                t = new Uint8Array(_().split("").map((function(e) {
                            ...
                            case 1:
                                n = r.sent();
                                return [2, btoa((e = String).fromCharCode.apply(e, c(new Uint8Array(n))))]
                        }
                    }))
                }))).apply(this, arguments)
            }
                ...
                I = u((function(e) {
                    ...
                    return _(this, (function(_) {
                        switch (_.label) {
                            ...
                            case 3:
                                s = _.sent(), u = s.error, c = s.paymentIntent;
                                if (null != u) return [2, {
                                    error: u.message
                                }];
                                if (null == c) return [2, {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [53329, 46025, 30527, 96043, 53686, 71402], {
        737264: e => {
            "use strict";
        ...
        444663: (e, t, n) => {
            ...
            function A(e) {
                ...
                t = L ? T.Z.Messages.UPLOAD_AREA_PREMIUM_TIER_UPSELL_BODY_LINE_2.format({
                ...
                return (0, r.jsx)(h.Z, function(e) {
                    ...
                    onClose: n,
                    subscriptionTier: L ? I.Si.TIER_0 : I.Si.TIER_2,
                    isLoading: A
                }, l))
            }
            var P = n(443812),
        ...
        101566: (e, t, n) => {
            ...
            var S = new p.Z("UploaderBase.tsx"),
                A = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        e.prototype = Object.create(t && t.prototype, {
                    ...
                    function n(e) {
                        ...
                        r._handleProgress = function(e, t, n) {
                            ...
                            if (null != n) {
                                var u;
                                null === (u = r._file.items) || void 0 === u || u.forEach((function(e) {
                        ...
                        r._handleError = function(e) {
                            ...
                            if (!r._aborted) {
                                r._errored = !0;
                                S.log("_handleError: ".concat(t, " (").concat(JSON.stringify(n), ") for ").concat(r.id));
                        ...
                        r._handleComplete = function(e) {
                            r.clearProcessingMessageInterval();
                            S.log("_handleComplete for ".concat(r.id));
                            r.emit("complete", r._file, e);
                            r.removeAllListeners()
                        };
                        r.id = f().uniqueId("Uploader");
                        r._url = e;
                        r._method = o;
                    ...
                    r.cancel = function() {
                        S.log("cancel() for ".concat(this.id));
                        this._aborted = !0;
            ...
            var F = function(e, t) {
                ...
                V = function(e) {
                                    ...
                                    case 4:
                                        ...
                                        if ((null !== (_ = f.currentSize) && void 0 !== _ ? _ : 0) > r.getMaxFileSize(f.channelId)) {
                                            e._handleError({
                                                ...
                                                reason: {
                                                    type: d.xi.POSTCOMPRESSION_INDIVIDUAL_FILE_TOO_LARGE
                                                }
                                            });
                                            return [2, !1]
                                        }
                    ...
                    r.setUploadingTextForUI = function() {
                        var e = 1 === this.files.length && null != this.files[0].filename ? this.files[0].filename : L.Z.Messages.UPLOADING_FILES.format({
                    ...
                    r._recomputeProgressByFile = function() {
                        ...
                        this.files.forEach((function(t) {
                            e[t.id] = (0, l.S)(t.loaded, t.currentSize)
                        }));
                        return e
                    };
                    r.cancel = function() {
                            ...
                            return F(this, (function(a) {
                                switch (a.label) {
                                    case 0:
                                        ...
                                        if (n.status === o.m.CANCELED) return [2];
                                        r = t.files.indexOf(n);
            ...
            function w(e) {
                ...
                if (!g.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== b.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = u.Z.getChannel(o),
                        l = M(a, i),
                        c = A({}, t, L(l), null != i && null != o && (0, v.AB)(o) ? R(0, o) : C(a));
                    g.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        245325: (e, t, n) => {
            ...
            function f(e) {
                ...
                var O = n.useExperiment({
                        ...
                        autoTrackExposure: !E && !_ && t
                    }),
                    h = O.enabled,
                    I = O.useExpectedValue,
                    y = O.useLikelihood,
                    g = (0, r.cj)([u.Z], (function() {
                        var e = u.Z.getState();
                        return {
                            fetched: e.fetched,
                    ...
                    S = c.p9.TIER_2;
                if (_) {
                    var A = d.subscription_trial;
                    (null == A ? void 0 : A.sku_id) === c.Si.TIER_0 ? S = c.p9.TIER_0 : (null == A ? void 0 : A.sku_id) === c.Si.TIER_2 && (S = c.p9.TIER_2)
                } else if (!E && !v && h)
                    if (I) {
                        S = function(e, t, n) {
        ...
        442212: (e, t, n) => {
            ...
            function v(e) {
                ...
                i.useEffect((function() {
                    Y || (X ? f.default.track(h.rMx.PREMIUM_GUILD_UPSELL_VIEWED, {
                ...
                var $, ee = B ? a()(g().artContainer, g().artContainerBoxShadow, N) : a()(g().artContainer, N),
                    te = null;
                        ...
                        children: Y ? (0, r.jsx)(l.Spinner, {}) : (0, r.jsx)(r.Fragment, {
                            children: J ? (0, r.jsx)(r.Fragment, {
                                children: (0, r.jsx)(E.ZP, {
                                    onClose: M,
                                    type: y,
                                    subscriptionTier: null !== ($ = null == q || null === (n = q.subscription_trial) || void 0 === n ? void 0 : n.sku_id) && void 0 !== $ ? $ : O.Si.TIER_2,
                                    headingText: o,
                                    context: P,
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [null != j ? (0, r.jsx)(l.Button, {
                                ...
                                var n = J ? (0, p.Rt)({
                                    ...
                                    i = J ? null == q ? void 0 : q.trial_id : null;
                                return (0, r.jsx)(_.Z, {
        ...
        15084: (e, t, n) => {
            ...
            function g(e, t) {
                ...
                if (c > i) {
                    (0,
                        u.yw)(O.rMx.FILE_SIZE_LIMIT_EXCEEDED, {
                        channel_id: e.id,
                        guild_id: r,
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: o,
                        round: a
                    } = Math, l = e[0] | e[1] << 8 | e[2] << 16, u = e[3] | e[4] << 8, c = (63 & l) / 63, s = (l >> 6 & 63) / 31.5 - 1, f = (l >> 12 & 63) / 31.5 - 1, p = (l >> 18 & 31) / 31, d = l >> 23, _ = (u >> 3 & 63) / 63, E = (u >> 9 & 63) / 63, O = u >> 15, h = i(3, O ? d ? 5 : 7 : 7 & u), I = i(3, O ? 7 & u : d ? 5 : 7), y = d ? (15 & e[5]) / 15 : 1, g = (e[5] >> 4) / 15, T = d ? 6 : 5, m = 0, b = (t, n, r) => {
                        let i = [];
                        for (let o = 0; o < n; o++)
                            for (let a = o ? 0 : 1; a * n < t * (n - o); a++) i.push(((e[T + (m >> 1)] >> ((1 & m++) << 2) & 15) / 7.5 - 1) * r);
                        return i
                    }, v = b(h, I, p), S = b(3, 3, 1.25 * _), A = b(3, 3, 1.25 * E), P = d && b(5, 5, g), L = r(e), R = a(L > 1 ? 32 : 32 * L), N = a(L > 1 ? 32 / L : 32), C = new Uint8Array(R * N * 4), U = [], M = [];
                    for (let e = 0, r = 0; e < N; e++)
                        for (let a = 0; a < R; a++, r += 4) {
                            let l = c,
                                ...
                                p = f,
                                _ = y;
                            for (let e = 0, n = i(h, d ? 5 : 3); e < n; e++) U[e] = o(t / R * (a + .5) * e);
                            for (let n = 0, r = i(I, d ? 5 : 3); n < r; n++) M[n] = o(t / N * (e + .5) * n);
                            for (let e = 0, t = 0; e < I; e++)
                                for (let n = e ? 0 : 1, r = 2 * M[e]; n * I < h * (I - e); n++, t++) l += v[t] * U[n] * r;
                            ...
                            if (d)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * M[e]; n < 5 - e; n++, t++) _ += P[t] * U[n] * r;
                            let E = l - 2 / 3 * u,
                                O = (3 * l - E + p) / 2,
                                g = O - p;
                            C[r] = i(0, 255 * n(1, O));

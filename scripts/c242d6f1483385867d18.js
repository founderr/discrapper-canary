...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [98655], {
        598655: (e, t, r) => {
            r.r(t);
            r.d(t, {
                CreateEmojiWithRolesModal: () => B,
                UpdateEmojiRolesModal: () => z
            });
            var n = r(785893),
                i = r(667294),
                o = r(294184),
            ...
            var U = function(e, t) {
                ...
                Z = function(e) {
                    ...
                    return (0, n.jsx)(d.Checkbox, {
                        size: 24,
                        className: a()(A().checklistRow, t),
                        value: s,
                        onChange: r,
                        type: d.Checkbox.Types.INVERTED,
                        children: (0, n.jsxs)("div", {
                            className: A().checklistLabel,
                            children: [(0, n.jsx)(d.Text, {
                                color: "interactive-active",
                                variant: o,
                                children: l
                            }), c && (0, n.jsx)(y.IG, {
                                text: w.Z.Messages.GUILD_ROLE_SUBSCRIPTION_TIER_MANAGEMENT_ARCHIVED_LABEL
                            })]
                        })
                    })
                };
            ...
            function G(e) {
                ...
                return (0, n.jsxs)(d.ModalRoot, {
                    ...
                    children: [(0, n.jsxs)(d.ModalHeader, {
                        ...
                        children: [(0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsx)(b.Z, {
                                ...
                                children: [(0, n.jsx)(d.Heading, {
                                    ...
                                    children: w.Z.Messages.GUILD_ROLE_SUBSCRIPTIONS_MANAGE_EMOJI_ROLES_MODAL_HEADER
                                }), (0, n.jsx)(v.Z, {
                                    size: 2
                                }), (0, n.jsx)(d.Text, {
                                    variant: "text-sm/normal",
                                    color: "header-secondary",
                                    children: w.Z.Messages.GUILD_ROLE_SUBSCRIPTIONS_MANAGE_EMOJI_ROLES_MODAL_DESCRIPTION
                                })]
                            })]
                        ...
                        className: A().seperator
                    }), (0, n.jsx)(d.ModalContent, {
                        className: A().modalContent,
                        children: (0, n.jsxs)("div", {
                            className: A().checklistContainer,
                            children: [(0, n.jsx)(Z, {
                                className: A().selectAllCheckbox,
                                label: w.Z.Messages.GUILD_ROLE_SUBSCRIPTIONS_MANAGE_EMOJI_ROLES_MODAL_SELECT_ALL_LABEL,
                        ...
                        children: (0, n.jsx)(d.Tooltip, {
                            shouldShow: !j,
                            text: w.Z.Messages.GUILD_ROLE_SUBSCRIPTIONS_MANAGE_EMOJI_ROLES_MODAL_NEEDS_ONE_ROLE,
                            children: function(e) {
                                return (0, n.jsx)(d.Button, P(D({}, e), {
                                    "aria-label": w.Z.Messages.SAVE,
                                    disabled: !j,
                                    submitting: c,
                                    onClick: S,
                                    children: w.Z.Messages.SAVE
                                }))
                            }
                        })
                    })]
                        ...
                        return U(this, (function(i) {
                            switch (i.label) {
                                case 0:
                                    ...
                                    d(!0);
                                    n = c().v4();
                                    O.default.track(I.rMx.EMOJI_UPLOAD_STARTED, {
                                        guild_id: r,
                                        upload_id: n
                                    });
                                    return [4, (0, p.G)({
            ...
            function z(e) {
                ...
                var b = function(e) {
                        var t = (0, S.e7)([_.Z], (function() {
                                return _.Z.getGuild(e)
                            })),
                            r = (0, S.e7)([x.Z], (function() {
                                return x.Z.getSubscriptionRoles(e)
                            }));
                        return i.useMemo((function() {
                            return null == (null == t ? void 0 : t.roles) ? E : Object.values(t.roles).filter((function(e) {
                                return r.has(e.id)
                            }))

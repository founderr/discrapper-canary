            ...
            function w(e) {
                ...
                if (!g.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== v.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        c = A({}, t, N(u), null != i && null != o && (0, b.AB)(o) ? L(0, o) : C(a));
                    g.default.track(e, c, {
                        flush: n
                    })
                }
            ...
            function _(e) {
                ...
                if (O)
                    if (p) {
                        ...
                        (null == N ? void 0 : N.sku_id) === s.Si.TIER_0 ? R = s.p9.TIER_0 : (null == N ? void 0 : N.sku_id) === s.Si.TIER_2 && (R = s.p9.TIER_2)
                    } else if (!I && !A && T)
                    if (g) {
                        R = function(e, t, n) {
        ...
        491260: (e, t, n) => {
            ...
            var B = function(e) {
                ...
                r.getActivities = function(e) {
                    ...
                    if (null == t) {
                        var n;
                        return null !== (n = R[e]) && void 0 !== n ? n : b
                    }
                    var r = P(e, t);

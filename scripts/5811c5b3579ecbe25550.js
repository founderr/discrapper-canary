(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [19493], {
        ...
        384482: (e, t, n) => {
            ...
            var O = a.parse(location.search.slice(1)),
                b = parseInt(null != O.rpc && "" !== O.rpc ? O.rpc : f.V6Z, 10),
                T = null;
            const I = new(function(e) {
                ! function(e, t) {
                    if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                    e.prototype = Object.create(t && t.prototype, {
                        constructor: {
                ...
                r.connect = function() {
                    ...
                    if (null == T)
                        if (b > y) {
                            ...
                            try {
                                T = new WebSocket("ws://127.0.0.1:".concat(this.port, "/?v=").concat(f.X6Q))
                            } catch (e) {
                                this.disconnect({
                                    code: f.$VG.CLOSE_ABNORMAL
                                });
                                return
                            }
                            if (null != T) {
                                T.onmessage = function(t) {
                                    ...
                                    if (r !== f.Etm.DISPATCH) {
                                        ...
                                        if (o === f.zMe.ERROR) {
                                            e.emit("error", new s.Z(u.code, u.message));
                                            e.disconnect();
                                            return
                                        }
                                        e.emit(g(r, o), u)
                                ...
                                T.onclose = T.onerror = function(t) {
                ...
                r.subscribe = function(e, t, n) {
                    this.on(g(f.Etm.DISPATCH, e), n);
                    return this.request(f.Etm.SUBSCRIBE, t, e)
                };
                r.unsubscribe = function(e, t, n) {
                    this.removeListener(g(f.Etm.DISPATCH, e), n);
                    return this.request(f.Etm.UNSUBSCRIBE, t, e)
                };
                ...
                r.requestOnce = function(e, t, n) {
                    return c.ZP.post({
                        ...
                        var t = e.body,
                            n = t.evt,
                            r = t.data;
                        if (n === f.zMe.ERROR) throw new s.Z(r.code, r.message);
                        return r
                    }))
                };
                r.requestRedirect = function(e, t, n) {
                    ...
                    window.open("http://127.0.0.1:".concat(this.port, "/rpc?v=").concat(f.X6Q, "&payload=").concat(r, "&callback=").concat(o), "_self");

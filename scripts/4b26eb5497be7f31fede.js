            ...
            function p(e) {
                (0, i.openModalLazy)(s((function() {
                    ...
                    return d(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                return [4, Promise.all([r.e(40532), r.e(38999)]).then(r.bind(r, 738999))];
                            case 1:
                ...
                return e.map((function(e, a) {
                    ...
                    switch (e.type) {
                        ...
                        case o.re.STRING_SELECT:
                            var j;
                            return {
                                type: o.re.STRING_SELECT, customId: e.custom_id, disabled: e.disabled,
                        ...
                        case o.re.ROLE_SELECT:
                            ...
                            return {
                                type: o.re.ROLE_SELECT,
                                    customId: e.custom_id, disabled: e.disabled, placeholder: null !== (v = e.placeholder) && void 0 !== v ? v : f.Z.Messages.MESSAGE_SELECT_COMPONENT_DEFAULT_PLACEHOLDER, minValues: e.min_values, maxValues: e.max_values, defaultValues: e.default_values, indices: m, applicationId: t, selectedOptions: (0, s.tx)(e.default_values, r)
                            };
                        case o.re.MENTIONABLE_SELECT:
                            var w;
                            return {
                        ...
                        case o.re.CHANNEL_SELECT:
                            var E, P;
                            return {
                                type: o.re.CHANNEL_SELECT, customId: e.custom_id, disabled: e.disabled, placeholder: null !== (E = e.placeholder) && void 0 !== E ? E : f.Z.Messages.MESSAGE_SELECT_COMPONENT_DEFAULT_PLACEHOLDER, minValues: e.min_values, maxValues: e.max_values, indices: m, channelTypes: e.channel_types, defaultValues: e.default_values,
                                    applicationId: t, selectedOptions: (0, s.tx)(e.default_values, r, null !== (P = e.channel_types) && void 0 !== P ? P : [])
                            };
                        default:
                            return null
                    }

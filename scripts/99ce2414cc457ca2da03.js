    ...
    ["86514"], {
        ...
        504219: function(e, t, l) {
            ...
            let x = e => {
                let {
                    ...
                    guildId: s,
                    children: r
                } = e, m = (0, i.useStateFromStores)([C.default], () => C.default.getHardwareClassification()), E = m === h.ClipsHardwareClassification.MEETS_MINIMUM || m === h.ClipsHardwareClassification.UNKNOWN, p = m === h.ClipsHardwareClassification.BELOW_MINIMUM, x = l && (E || p) && !t, [R, A] = (0, c.useGetDismissibleContent)(x ? [u.DismissibleContent.CLIPS_ONBOARDING_GO_LIVE_COACHMARK] : []), v = R === u.DismissibleContent.CLIPS_ONBOARDING_GO_LIVE_COACHMARK;
                a.useEffect(() => {
            ...
            var n = l("37983"),
                ...
                E = a.forwardRef(function(e, t) {
                    let {
                        ...
                        shouldUseHorizontalButtons: R = !1,
                        showGIFTag: A = !1,
                        ...
                        maxWidth: M = 280
                    } = e, j = R ? i.Button.Sizes.LARGE : i.Button.Sizes.MAX, [D, P] = a.useState(!1), {
                        ref: b,
                        width: U
                    } = (0, u.default)();
                    ...
                    return a.useEffect(() => {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsxs)("div", {
                                ...
                                ref: b,
                                className: D || !R ? S.buttonContainerVertical : S.buttonContainerHorizontal,
        ...
        636909: function(e, t, l) {
            ...
            function Y(e) {
                let {
                    ...
                    sourceChanged: a,
                    onChangeSource: s
                } = e, r = (0, i.useStateFromStores)([N.default, x.default], () => (0, D.isWindows)() ? (0, b.default)(N.default, x.default) : null), o = (0, i.useStateFromStores)([d.default], () => (null == r ? void 0 : r.id) != null ? d.default.getApplication(r.id) : null), c = (0, i.useStateFromStores)([N.default], () => N.default.getRunningGames()), f = (0, i.useStateFromStoresArray)([d.default], () => c.map(e => null != e.id ? d.default.getApplication(e.id) : null).filter(j.isNotNullish), [c]), m = null;
            ...
            function X(e) {
                ...
                let {
                    guildId: l
                } = e, s = (0, i.useStateFromStores)([h.default], () => null !== (t = h.default.getMemberCount(l)) && void 0 !== t ? t : 0), o = E.NotifyFriendsOnGoLive.useSetting(), d = a.useCallback((e, t) => {
                    E.NotifyFriendsOnGoLive.updateSetting(t), M.default.track(H.AnalyticEvents.NOTIFY_STREAM_SETTING_UPDATE, {
                        value: t
                    })
            ...
            function Q(e) {
                let {
                    ...
                    onChangeGuild: O,
                    isAnimationDone: M
                } = e, j = (0, i.useStateFromStores)([I.default, C.default], () => C.default.getChannel(I.default.getVoiceChannelId())), D = (0, i.useStateFromStores)([P.default], () => P.default.GPUDriversOutdated), b = (0, i.useStateFromStores)([_.default], () => _.default.getSoundshareEnabled()), k = (0, i.useStateFromStores)([p.default], () => p.default.getCurrentUser()), B = (0, f.useEnableClips)(), V = (0, f.useShouldSeeClipsPremiumEarlyAccessGoLiveRoadblock)({
                    autoTrackExposure: !B
                }), z = (0, U.default)();
                ...
                let K = B ? (0, n.jsx)(S.default, {
                        guildId: E,
                        isAnimationDone: M
                    }) : V ? (0, n.jsx)(m.default, {}) : void 0,
                    Q = !!(null == t ? void 0 : t.id.startsWith("camera")),
                    q = null != k && k.verified && !k.bot,
                    $ = null != j && !(0, c.isPrivateGuildChannel)(j);
        ...
        451863: function(e, t, l) {
            ...
            function H(e) {
                ...
                let {
                    ...
                    resolution: Q,
                    fps: q
                } = (0, d.useStateFromStoresObject)([g.default], () => g.default.getState()), $ = (0, d.useStateFromStores)([x.default, _.default], () => _.default.getChannel(x.default.getVoiceChannelId())), ee = (0, d.useStateFromStores)([p.default, A.default], () => (0, O.isWindows)() ? (0, P.default)(p.default, A.default) : null), et = (0, d.useStateFromStores)([R.default], () => {
                ...
                }), [en, ea] = null !== (t = (0, D.default)(X, et, el)) && void 0 !== t ? t : [y.ApplicationStreamResolutions.RESOLUTION_720, y.ApplicationStreamFPS.FPS_30];
                X !== y.ApplicationStreamPresets.PRESET_CUSTOM && (Q = en, q = ea);
                let es = (0, T.useUID)();
                let [er, ei] = r.useState((i = W, H = z, i ? n.GUILD : H ? n.SOURCE : n.CONFIRM)), [eu, eo] = r.useState(null), [ed, ec] = r.useState(!1), [ef, em] = r.useState(null), [eS, eE] = r.useState(null), [eC, eh] = r.useState(null), [eg, e_] = r.useState(X), [eN, eI] = r.useState(Q), [ep, ex] = r.useState(q), [eR, eA] = r.useState(null != K ? K : null), ev = null !== (a = null == $ ? void 0 : $.id) && void 0 !== a ? a : ef;
                r.useEffect(() => {
                    let e = (0, O.isWindows)() ? (0, P.default)(p.default, A.default) : null,
                ...
                function eT() {
                    ! function() {
                        ...
                        let s = eg,
                            r = eN,
                            i = ep;
                        !(0, j.default)(s, r, i, et, el) && (s = y.ApplicationStreamPresets.PRESET_VIDEO, r = y.ApplicationStreamResolutions.RESOLUTION_720, i = y.ApplicationStreamFPS.FPS_30), (0, S.updateStreamSettings)({
                            preset: s,
                            resolution: r,
                            frameRate: i
                        });
                ...
                let eL = r.useCallback((e, t, l) => {
                    ...
                    if (e !== eg && (t = a, l = s), !(0, j.default)(e, t, l, et, el)) {
                        let [e, n] = (0, D.default)(y.ApplicationStreamPresets.PRESET_VIDEO, et, el);
                        t = e, l = n
                    }
                    l !== ep && ex(l), t !== eN && eI(t), a !== t || s !== l ? e_(y.ApplicationStreamPresets.PRESET_CUSTOM) : e !== eg && e_(e)
                }, [et, el, ep, eN, eg]);
                async function eO(e) {
                    if (e.preventDefault(), er === n.SOURCE) return ei(n.CONFIRM);
                    let t = (0, F.default)(ee, eS, p.default.getRunningGames()),
                        a = M.default.supportsFeature(k.NativeFeatures.ELEVATED_HOOK) && (null == t ? void 0 : t.elevated);
                    if ((0, O.isMac)() && null != eS) {
                        ...
                        if (t.startsWith("screen") && e.length > 0 && !e.some(e => e.includes(t))) {
                            var r, i;
                            r = t, i = e, L.default.track(k.AnalyticEvents.SCREENSHARE_FAILED, {
                                source_id: r,
                                screens: i.length
                        ...
                        children: [(0, s.jsx)(c.Slide, {
                            ...
                            children: (0, s.jsx)("div", {
                                ...
                                children: (0, s.jsx)(b.default, {
                                    ...
                                    onChangeSelectedPreset: e => eL(e, eN, ep),
        ...
        23922: function(e, t, l) {
            ...
            function M(e) {
                ...
                }), i = m.default.supports(R.Features.GO_LIVE_HARDWARE), [o, f] = a.useState(null), [S, E] = a.useState(null), [g, N] = a.useState(null), I = null != g && g.length > 0, [L, O] = a.useState(u.DesktopSources.WINDOW), [M, j] = a.useState(!1), D = a.useRef(null), P = a.useRef(new d.Interval);
                a.useEffect(() => {
                    let e = P.current;
                    return T().then(e => {
                        let {
        ...
        985997: function(e, t, l) {
            ...
            function D(e) {
                let {
                ...
                }), U = _.default.isPremiumExactly(b, R.PremiumTypes.TIER_0), G = _.default.isPremium(b), F = (0, u.useStateFromStores)([S.default], () => {
                    var e;
                    ...
                    autoTrackExposure: !1
                }), B = (k || !G) && !w, V = P ? p.GoLiveDeviceResolutionButtons : p.ApplicationStreamResolutionButtons, H = {
                    ...y,

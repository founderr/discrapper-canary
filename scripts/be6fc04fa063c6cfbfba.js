        ...
        586611: (e, n, t) => {
            ...
            function J(e) {
                var n = e.analyticsLocations,
                    ...
                    ke = Ge[0],
                    Fe = Ge[1],
                    De = q(i.useState((0, b.a8)(Ze) ? B.Z.Messages.DEFAULT_CUSTOM_GIFT_MESSAGE : void 0), 2),
                    Ue = De[0],
                    We = De[1];
                i.useEffect((function() {
                    Fe((function(e) {
                        var n = null != _e ? (0, T.aS)(_e.id, !1, Y, Le) : void 0;
                        return Q(z({}, e), {
                            subscription_plan_id: null == _e ? void 0 : _e.id,
                ...
                i.useEffect((function() {
                    v.default.track(H.rMx.PAYMENT_FLOW_STARTED, Q(z({}, ke), {
                ...
                i.useEffect((function() {
                    ...
                    if (null != ue) Te(ue);
                        ...
                        var e;
                        Te(null === (e = I.Z.get(E)) || void 0 === e ? void 0 : e.skuId)
                    }
                }), [ge, Te, E, ue]);
                var He = (0, l.Z)((function() {
                        return Date.now()
                    }), [je]),
                    Be = i.useCallback((function(e) {
                        ...
                        var a = null != t ? t : je,
                            s = Date.now();
                        null !== a ? v.default.track(H.rMx.PAYMENT_FLOW_STEP, Q(z({}, ke, r), {
                            from_step: a,
                            to_step: e === y.h8.ADD_PAYMENT_STEPS ? y.h8.PAYMENT_TYPE : e,
                            step_duration_ms: s - He,
                            flow_duration_ms: s - Ce.startTime
                        })) : v.default.track(H.rMx.PAYMENT_FLOW_LOADED, Q(z({}, ke), {
                            initial_step: e,
                            has_saved_payment_source: we
                        }))
                    }), [ke, Ce.startTime, p, Oe, Ae, je, He, we]),
                    Ye = i.useMemo((function() {
                        return function() {
                            return null == x ? void 0 : x(Ee === g.A.COMPLETED)
                        }
                    }), [x, Ee]);
                (0, S.bp)(je, xe, Be);
                (0, y.dZ)(je, Ee, ve);
                ...
                return (0, r.jsx)(c.Shaker, {
                    className: K().shaker,
                    isShaking: pe && Ee === g.A.PURCHASING,
                    intensity: 2,
                    children: (0, r.jsx)(c.ModalRoot, {
                        className: s()(K().root, $({}, K().withHeader, null != Ve)),
                        transitionState: m,
                        hideShadow: ye,
                        returnRef: he,

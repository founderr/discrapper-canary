        ...
        125667: function(e, t, s) {
            ...
            class G extends a.PureComponent {
                ...
                render() {
                    ...
                    let {
                        ...
                        rateLimitPerUser: C
                    } = m, N = O.default.getCurrentUser(), E = I.default.getGuild(t), _ = C > 0, M = p ? [] : u(r).keys().filter(e => e !== (null == N ? void 0 : N.id)).reject(A.default.isBlocked).map(e => O.default.getUser(e)).filter(b.isNotNullish).map(e => D.default.getName(t, this.props.channel.id, e)).value();
            ...
            function W(e) {
                let {
                    ...
                    ...a
                } = e, l = (0, f.useStateFromStores)([M.default], () => M.default.findActivity(e => null != e.application_id)), i = (0, f.useStateFromStores)([C.default, E.default], () => C.default.getUserCombo(E.default.getId(), t.id)), r = (0, f.useStateFromStores)([N.default, v.default], () => (0, S.default)(t, l, N.default, v.default)), u = (0, f.useStateFromStores)([F.default], () => F.default.getSlowmodeCooldownGuess(t.id, s ? F.SlowmodeType.CreateThread : F.SlowmodeType.SendMessage)), o = (0, f.useStateFromStores)([_.default], () => s ? _.default.can(P.Permissions.MANAGE_THREADS, t) : _.default.can(P.Permissions.MANAGE_CHANNELS, t) || _.default.can(P.Permissions.MANAGE_MESSAGES, t)), d = {
                    ...a,
            ...
            let i = e => {
                ...
                return (0, n.jsx)("svg", {
                    ...
                    children: (0, n.jsx)("path", {
                        ...
                        fillRule: "evenodd",
                        d: "M12 22a9 9 0 0 0 7.032-14.618l.675-.675a1 1 0 0 0-1.414-1.414l-.675.675A8.957 8.957 0 0 0 13 4.055V3h2a1 1 0 1 0 0-2H9a1 1 0 0 0 0 2h2v1.055a8.957 8.957 0 0 0-4.618 1.913l-.675-.675a1 1 0 0 0-1.414 1.414l.675.675A9 9 0 0 0 12 22Zm3.707-11.293a1 1 0 0 0-1.414-1.414l-3 3a1 1 0 0 0 1.414 1.414l3-3Z",
                        clipRule: "evenodd",
                        className: r
                    })
                })
            ...
            var a = s("414456"),
                ...
                c = e => {
                    ...
                    let {
                        ...
                        user: m,
                        author: g
                    } = (0, u.useForumPostAuthor)(c), p = null !== (s = null !== (t = null == g ? void 0 : g.nick) && void 0 !== t ? t : null == m ? void 0 : m.username) && void 0 !== s ? s : "", S = (0, r.useUsernameHook)(null == a ? void 0 : a.author, c.id, c.guild_id, !0, o.default.Messages.FORUM_POST_AUTHOR_A11Y_LABEL.format({
                        name: p

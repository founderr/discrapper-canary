        ...
        141861: (e, n, t) => {
            ...
            function tt(e) {
                var n = e.selectedSource,
                    ...
                    P = b.Z.supports(Le.AN.SOUNDSHARE) ? (0, x.ED)() && !Re().satisfies(null === Te.Z || void 0 === Te.Z ? void 0 : Te.Z.os.release, Pe.I9) ? F.Z.Messages.GO_LIVE_SCREENSHARE_UPDATE_WINDOWS_FOR_SOUNDSHARE : (0, x.V5)() && !Re().satisfies(null === Te.Z || void 0 === Te.Z ? void 0 : Te.Z.os.release, Pe.Ec) ? F.Z.Messages.GO_LIVE_SCREENSHARE_UPDATE_MACOS_FOR_SOUNDSHARE : null : Ze.GO_LIVE_SCREENSHARE_NO_SOUND;
                null != n && n.id.startsWith("screen") ? P = F.Z.Messages.GO_LIVE_SCREENSHARE_NO_SOUND : null == P && b.Z.supportsEnableSoundshare() && A !== B.rtk.ENABLED && (P = F.Z.Messages.GO_LIVE_SCREENSHARE_ENABLE_FOR_SOUNDSHARE.format({
            ...
            function ut(e) {
                let n = function(e) {
                    let {
                        ...
                        cos: l,
                        round: o
                    } = Math, a = e[0] | e[1] << 8 | e[2] << 16, i = e[3] | e[4] << 8, s = (63 & a) / 63, u = (a >> 6 & 63) / 31.5 - 1, c = (a >> 12 & 63) / 31.5 - 1, d = (a >> 18 & 31) / 31, f = a >> 23, m = (i >> 3 & 63) / 63, h = (i >> 9 & 63) / 63, p = i >> 15, g = r(3, p ? f ? 5 : 7 : 7 & i), v = r(3, p ? 7 & i : f ? 5 : 7), S = f ? (15 & e[5]) / 15 : 1, b = (e[5] >> 4) / 15, E = f ? 6 : 5, C = 0, y = (n, t, r) => {
                        let l = [];
                        for (let o = 0; o < t; o++)
                            for (let a = o ? 0 : 1; a * t < n * (t - o); a++) l.push(((e[E + (C >> 1)] >> ((1 & C++) << 2) & 15) / 7.5 - 1) * r);
                        return l
                    }, O = y(g, v, d), I = y(3, 3, 1.25 * m), _ = y(3, 3, 1.25 * h), j = f && y(5, 5, b), x = function(e) {
                        let n = e[3],
                            t = 128 & e[2],
                            r = 128 & e[4];
                        return (r ? t ? 5 : 7 : 7 & n) / (r ? 7 & n : t ? 5 : 7)
                    }(e), N = o(x > 1 ? 32 : 32 * x), A = o(x > 1 ? 32 / x : 32), R = new Uint8Array(N * A * 4), Z = [], T = [];
                    for (let e = 0, o = 0; e < A; e++)
                        for (let a = 0; a < N; a++, o += 4) {
                            let i = s,
                                d = u,
                                m = c,
                                h = S;
                            for (let e = 0, t = r(g, f ? 5 : 3); e < t; e++) Z[e] = l(n / N * (a + .5) * e);
            ...
            function bt(e, n) {
                bt = Object.setPrototypeOf || function(e, n) {
                    e.__proto__ = n;
                    return e
                };
                return bt(e, n)
            }
            var Et, Ct = function(e) {
                    ...
                    return Mt(this, (function(s) {
                        switch (s.label) {
                            case 0:
                                ...
                                n = (0, dt.Z)(b.Z.getMediaEngine(), [ct.vA.WINDOW, ct.vA.SCREEN], {
                                    width: 176,
                                    height: 99
                                });
                                return [4, Ut()];
                            ...
                            case 2:
                                ...
                                i = Object.entries(e).filter((function(e) {
                                    ...
                                    var t = Lt(e, 2),
                                        r = (t[0], t[1]),
                                        l = a[n % a.length],
                                        o = ut(Uint8Array.from(atob(l), (function(e) {
            ...
            function Vt(e) {
                var n = e.selectedSource,
                    ...
                    i = b.Z.supports(Le.AN.GO_LIVE_HARDWARE),
                    ...
                    v = p[1],
                    S = null != g && g.length > 0,
                    E = Lt(l.useState(ct.vA.WINDOW), 2),
                    C = E[0],
                    y = E[1],
                    O = Lt(l.useState(!1), 2),
                    _ = O[0],
                ...
                var n, o = e.selectGuild,
                    ...
                    k = function() {
                        ! function() {
                            ...
                            var u = Jn(X, ve, E.ZP.getRunningGames()),
                        ...
                        return $t(this, (function(a) {
                            switch (a.label) {
                                case 0:
                                    ...
                                    n = Jn(X, ve, E.ZP.getRunningGames());
                                    t = N.ZP.supportsFeature(B.eRX.ELEVATED_HOOK) && (null == n ? void 0 : n.elevated);
                                    return (0, x.V5)() && null != ve ? [4, b.Z.getMediaEngine().getDesktopSources()] : [3, 2];
                                case 1:
                                    l = a.sent();

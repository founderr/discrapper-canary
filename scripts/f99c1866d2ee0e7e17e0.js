    ...
    [92465], {
            ...
            const _ = new h(i.Z, {
                ...
                DEVELOPER_ACTIVITY_SHELF_FETCH_SUCCESS: function(e) {
                    ...
                    g = n.filter((function(e) {
                        return null != e.flags && (0, u.yE)(e.flags, o.udG.EMBEDDED)
                    }))
                },
        ...
        99440: (e, n, t) => {
            ...
            function O(e) {
                return function(e) {
                    ...
                    return null == e || null == n ? [] : n.filter(_).map((function(e) {
                        ...
                        return {
                            src: s ? "".concat(n, "?format=jpeg") : null != n ? n : t,
                            width: o,
                            height: l,
                            spoiler: null != i && i,
                            flags: u,
            ...
            function T(e, n) {
                var t, r, i = O(e),
                    u = m(e, n);
                return null !== (r = null !== (t = i[0]) && void 0 !== t ? t : u[0]) && void 0 !== r ? r : null
            }
            ...
            function A(e, n) {
                var t, r = o.Z.getChannel(n);
                if (null == r) return !1;
                var u = l.Z.getMessage(r.id, r.id);
                return null != u && (e.length > 0 && null != e.find((function(e) {
                    return e.isImage || e.isVideo
                })) && r.isForumPost() && r.ownerId === (null === (t = a.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && 0 === i.Z.getCount(r.id) && (0 === u.attachments.length || null == u.attachments.find((function(e) {
                    return g(e) || h(e)
                }))))
            }
        ...
        970286: (e, n, t) => {
            ...
            function d(e) {
                ...
                var h = (0, a.EY)(i.thumbnail),
                    ...
                    m = null == E ? void 0 : E.getAvatarURL(null == u ? void 0 : u.id, 40);
                null != m && v === i.guild_id || (m = o.ZP.getGuildIconURL({
                    id: i.guild_id,
                    icon: i.guild_icon,
                    size: 40,
                    canAnimate: !1
                ...
                return {
                    ...
                    canAccess: g,
                    guildId: i.guild_id,
                    guildName: null !== (S = null == u ? void 0 : u.name) && void 0 !== S ? S : i.guild_name,
        ...
        525261: (e, n, t) => {
            ...
            function l(e, n) {
                return (0, i.e7)([u.Z], (function() {
                    return null == e || null == n ? r.NONE : o(u.Z.getVoiceStateForChannel(n, e))
                }), [e, n])
            }
        },
        591684: (e, n, t) => {
            ...
            const Z = new U(o.Z, {
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    var u = d.Z.getChannel(n.channel_id);
                    if (null == u || !c.Ec.has(u.type)) return !1;
                    if (! function(e, n) {
                ...
                MESSAGE_DELETE: function(e) {
                    ...
                    C(r, (function(e) {
                        ...
                        e.count = i && u ? Math.max(e.count - 1, 0) : e.count;
                        I.add(n)
                    }))
                },
                ...
                LOAD_MESSAGES_SUCCESS: function(e) {
                    var n = !1,
                        ...
                        i = void 0;
                    try {
                        for (var u, o = e.messages[Symbol.iterator](); !(t = (u = o.next()).done); t = !0) {
                            n = D(u.value.thread) || n
                        }
                    } catch (e) {
                        r = !0;
                        i = e
                ...
                GUILD_FEED_FETCH_SUCCESS: function(e) {
                    var n = e.data,
                        ...
                        u = void 0;
                    try {
                        for (var o, a = (0, l.J)(n)[Symbol.iterator](); !(r = (o = a.next()).done); r = !0) {
                            t = D(o.value) || t
                        }
                    } catch (e) {
                        i = !0;
        ...
        325213: (e, n, t) => {
            ...
            var A = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    h = m.applicationId;
                    _ = m.originURL;
                    this.waitFor(l.Z, u.Z);
                    this.syncWith([l.Z, u.Z], (function() {
                        return !0
                    }));
                ...
                r.shouldDisplayTestMode = function(e) {
                    return o.Sb.getSetting() && this.inTestModeForApplication(e)
                };
                r.getState = function() {
                    return m
                };
        ...
        176758: (e, n, t) => {
            ...
            function I(e, n, t) {
                var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
                    u = [];
                (t.length > 0 || r) && u.push(S(e, n, i.BN.ROLE));
                t.forEach((function(e) {
                    u.push(T(e, n, i.BN.ROLE))
                }));
                return u
            }
            ...
            function C(e, n, t) {
                var r, i, u = e.getGuildId(),
                    ...
                    p = !1;
                p = e.type === m ? null != u && (n.hasVideo(e.id) || (0, o.a)(f)) && c > 0 && s >= c : null != u && n.hasVideo(e.id) && a > 0 && s >= a + (E ? 1 : 0);
                    ...
                    n.forEach((function(e) {
                        if (e.id !== r && e.id !== t) {
                            ...
                            null != n && (e.isGuildStageVoice() ? n.forEach((function(e) {
                                (0, a.gf)(e.voiceState) === a.xO.ON_STAGE && u.push(e)
                            })) : n.forEach((function(e) {
                                return u.push(e)
                            })))
                        }
            ...
            function Z(e, n, t, r) {
                var i = e.getGuildId(),
                    u = (0, l.BC)(i, n);
                return null != n && u ? function(e, n, t, r) {
        ...
        773148: (e, n, t) => {
            ...
            function c(e, n, t) {
                if (null == t) return null;
                if (null != e) return u.ZP.getNick(e, t.id);
                if (null != n) {
                    var r = i.Z.getChannel(n);
                    if (null == r ? void 0 : r.isPrivate()) return o.Z.getNickname(t.id)
                }
                return null
            }
            ...
            const f = {
                ...
                useName: function(e, n, t) {
                    return (0, r.e7)([u.ZP, i.Z, o.Z], (function() {
                        return s(e, n, t)
                    }))
                }
            }

            ...
            var i = n("37983"),
                ...
                O = function(e) {
                    let {
                        ...
                        transitionState: r,
                        onClose: O
                    } = e, y = (0, s.useStateFromStores)([T.default], () => T.default.getGuild(t), [t]), D = (0, s.useStateFromStores)([p.default], () => p.default.getId()), b = (0, s.useStateFromStores)([S.default], () => S.default.getMember(t, D)), [M, G] = l.useState([]), w = (0, f.default)(), x = (0, h.useUID)();
                    if (l.useEffect(() => {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !y && a.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: L,
                            location_stack: S
                        }), (0, o.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == _ || _(y), y && (!C && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },

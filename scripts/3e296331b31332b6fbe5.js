        ...
        437763: (e, r, n) => {
            ...
            function c(e) {
                ...
                (0, t.useEffect)((function() {
                    r === o.A.PURCHASING ? d(c) : r === o.A.FAIL && d(l)
                }), [r, c, l]);
                (0, t.useEffect)((function() {
                    n === a.h8.CONFIRM && d(u)
                }), [n, u]);
        ...
        159330: (e, r, n) => {
            ...
            const x = function(e) {
                var r = e.daysLeft,
                    ...
                    R = e.analyticsSource,
                    x = A(e, ["daysLeft", "premiumType", "premiumSubscription", "analyticsSource"]),
                    Z = (0,
                        l.ZP)(),
                    w = j(a.useState(!1), 2),
                    U = w[0],
                    ...
                    K = Q.intervalCount,
                    $ = n === E.p9.TIER_1,
                    J = null != z ? (0, I.T4)(z.amount, z.currency) : null;
                ...
                return (0, t.jsx)(s.ModalRoot, v(function(e) {
                        ...
                        footer: (0, t.jsxs)("div", {
                            children: [null !== J ? (0, t.jsx)(s.Text, {
                                ...
                                children: [(0, t.jsx)(s.Button, {
                                    ...
                                    onClick: function() {
                                        if (null != g) {
                                            var e = (0, O.tD)(F, g.currency, null == G ? void 0 : G.id);
                                    ...
                                    color: (0, i.wj)(Z) ? s.Button.Colors.WHITE : s.Button.Colors.PRIMARY,
                                    onClick: x.onClose,
        ...
        301162: (e, r, n) => {
            ...
            function S(e) {
                var r = e.width,
                    ...
                    c = e.foreground,
                    l = O(e, ["width", "height", "color", "foreground"]);
                return (0, t.jsxs)("svg", I(function(e) {
                    for (var r = 1; r < arguments.length; r++) {
                        var n = null != arguments[r] ? arguments[r] : {},
                            t = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (t = t.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            var M = function(e) {
                ...
                return (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsx)(s.Text, {
                        ...
                        className: o()(g().trialOfferText, P({}, g().tier0TrialOffer, r)),
                        children: T.Z.Messages.BILLING_TRIAL_FREE_TRIAL_TEXT
                    })
                })
            };
            const v = function(e) {
                var r, n = e.hideCloseButton,
                    a = void 0 !== n && n,
                    ...
                    I = e.onClose,
                    O = e.isGift,
                    y = e.upgradeToPremiumType,
                    h = e.headerTheme,
                    T = void 0 === h ? f.nL.DEFAULT : h,
                    b = e.className,
                    v = e.showTrialBadge,
                    A = void 0 !== v && v,
                    j = y === E.p9.TIER_2;
                r = y === E.p9.TIER_0 ? C.Z : y === E.p9.TIER_1 ? S : d.Z;
                var x, Z = (0, i.e7)([c.Z], (function() {
                    return c.Z.useReducedMotion
                }));
                return (0, t.jsxs)("div", {
                    "aria-hidden": !0,
                    className: o()((x = {}, P(x, g().headerBackground, !j), P(x, T === f.nL.WINTER ? g().tier2HeaderBackgroundWinterTheme : g().tier2HeaderBackground, j), x), b),
                    children: [Z || T !== f.nL.WINTER ? null : (0, t.jsx)(m.Z, {
                        className: g().snow,
                        wind: 5
                    }), A && (0, t.jsx)(N, {
                        ...
                        children: [(0, t.jsxs)("div", {
                            children: [(0, t.jsx)(r, {
                                className: o()(g().headerIcon, P({}, g().nonTier2, !j))
                            }), A && (0, t.jsx)(M, {
                                isTier0: y === E.p9.TIER_0
                            })]
                        }), !a && (0, t.jsx)(s.ModalCloseButton, {
                            hideOnFullscreen: l,
                            onClick: I,
                            className: g().closeButton
                        })]
                    }), u && null != p ? (0, t.jsx)("div", {
                        className: g().price,
                        children: R(p, O)
                    }) : null]
                })
            ...
            function H(e) {
                var r = e.currentStep,
                    ...
                    N = C ? f.nL.WINTER : f.nL.DEFAULT;
                return (0, u.a8)(O) && r !== l.h8.CONFIRM ? (0, t.jsxs)(s.ModalHeader, {
                    ...
                    children: (0, t.jsx)(v, {
                        ...
                        renderAnimation: function() {
                            return L === E.p9.TIER_0 ? (0, t.jsx)(w, {
                                className: G().headerAnimation,
                                currentStep: r,
                                purchaseState: a,
                                pause: S
                            }) : L === E.p9.TIER_1 ? (0, t.jsx)(U, {
                                className: G().headerAnimation,
                                currentStep: r,
                                purchaseState: a,
                                pause: S

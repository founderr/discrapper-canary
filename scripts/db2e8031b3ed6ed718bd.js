        ...
        698847: (e, t, n) => {
            ...
            function H() {
                return (H = L((function(e) {
                    var t, n, r, l, c, s, p, m, y, h, g, O, w, S, I, x, T, M, N, U, R, k, L, D, G, H, V, K, $, q, W, X, Q, ee, te, ne, re, oe, ie, le, ae, ue, ce, se, fe, de, pe, me, ye, he;
                    return z(this, (function(z) {
                        switch (z.label) {
                            ...
                            case 1:
                                ...
                                if (null != r.autocomplete)(0, E.GV)(t, r, ye);
                                else {
                    ...
                    return z(this, (function(d) {
                        switch (d.label) {
                            ...
                            case 1:
                                ...
                                if ((c = a.largestUploadedFileSize) > Math.max(i, N.Y1) || u > I.zz) {
                                    l(c);
                                    return [2, !1]
                                }
                                d.label = 2;
                                ...
                                if (null != S)
                                    if (S.isPrivate()) {
                                        var I = !0,
                                            ...
                                            x = void 0;
                                        try {
                                            for (var A, T = S.recipients[Symbol.iterator](); !(I = (A = T.next()).done); I = !0) {
                                                var C = A.value;
                                                if (_(a, c, C)) return {
                                                    type: "userMention",
                                                    userId: C,
                                ...
                                for (var v, b = p.k1[Symbol.iterator](); !(m = (v = b.next()).done); m = !0) {
                                    ...
                                    if (g !== c.sH) {
                                        var _ = c.ZP.getChannels(t)[g],
                                            ...
                                            S = void 0;
                                        try {
                                            for (var I, E = _[Symbol.iterator](); !(O = (I = E.next()).done); O = !0) {
                                                var x = I.value.channel;
                                                if (x.name === n) return {
                                                    type: "channelMention",
                                                    channelId: x.id,
                                                    children: [{

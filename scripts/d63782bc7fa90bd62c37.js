...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [32859, 56620], {
        652411: (e, t, n) => {
                ...
                h = function(e) {
                    function t(t, n, r, o, i, c) {
                        ...
                        var l = u.value / (u.max - u.min) * u.duration,
                            a = isNaN(l) ? 0 : l;
                        return u.timePassed = a < 0 ? u.duration - a : a, u.directionMultiplier = i, u.easingFunction = c, u
                    }
                    return d(t, e), t.prototype.update = function(e) {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var u = T(e.start),
                                ...
                                a = T(e.duration),
                                s = T(e.direction);
                            return new y(new h(t.x, u.x, l.x, a.x, s.x, e.easingFunction), new h(t.y, u.y, l.y, a.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = T(e.minValue), r = T(e.maxValue);
                            var f = T(e.minStart),
                                p = T(e.maxStart),
                                ...
                                m = T(e.minDirection),
                                C = T(e.maxDirection);
                            return new y(new h(I(n.x, r.x), I(f.x, p.x), I(d.x, O.x), I(_.x, E.x), g(m.x, C.x), S(e.easingFunctions)[0]), new h(I(n.y, r.y), I(f.y, p.y), I(d.y, O.y), I(_.y, E.y), g(m.y, C.y), S(e.easingFunctions)[0]))
                    }
                }(O(O({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var u = m(e.start),
                                ...
                                a = m(e.duration),
                                s = m(e.direction);
                            return new E(new h(t.x, u.x, l.x, a.x, s.x, e.easingFunction), new h(t.y, u.y, l.y, a.z, s.y, e.easingFunction), new h(t.z, u.z, l.z, a.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var f = m(e.minStart),
                                p = m(e.maxStart),
                                ...
                                T = m(e.minDirection),
                                C = m(e.maxDirection);
                            return new E(new h(I(n.x, r.x), I(f.x, p.x), I(d.x, O.x), I(_.x, y.x), g(T.x, C.x), S(e.easingFunctions)[0]), new h(I(n.y, r.y), I(f.y, p.y), I(d.y, O.y), I(_.y, y.y), g(T.y, C.y), S(e.easingFunctions)[0]), new h(I(n.z, r.z), I(f.z, p.z), I(d.z, O.z), I(_.z, y.z), g(T.z, C.z), S(e.easingFunctions)[0]))
                    }
                }(O(O({}, e), {
                    valueType: "Vector3"
                }))
            ...
            function R(e, t, n, r, o) {
                ...
                return new a({
                    ...
                    dragCoefficient: P(i.dragCoefficient),
                    size: c,
                    opacity: C(i.opacity),
            ...
            var N = r.forwardRef((function(e, t) {
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", w, l), e("mousedown", N, a), e("mousemove", A, s), e("mouseup", x, f),
                        function() {
                ...
                }), [w, N, A, x, l, a, s, f]), r.useEffect((function() {
                    var e = y.current,
                            ...
                            O.current.forEach((function(e, n) {
                                var r = function(r, o) {
                                    ...
                                    if (t.drawImage(e.image, i, c, f, p), null != r) {
                                        for (var u = t.getImageData(i, c, f, p), l = function(e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
                                                    r: t >> 16 & 255,
                                            ...
                                            }(r), a = 0; a < u.data.length; a += 4) u.data[a] = l.r, u.data[a + 1] = l.g, u.data[a + 2] = l.b;
            ...
            function x(e, t) {
                ...
                var u = r.useCallback((function(n, r) {
                        ...
                        if (null != l && null != u && 0 !== u.sprites.length) return null == e ? void 0 : e.createConfetti(n, l, u, i, c)
                    }), [e, t]),
                    ...
                    b = o.useMemo((function() {
                        return E ? p : {
                            ...
                            createConfetti: function(e, t) {
                                return y.createConfetti(s({}, a, e), t)
                            },
                            createConfettiAt: function(e, t, n, r) {
                                return y.createConfetti(s(f(s({}, a), {
                                    position: {
                                        type: "static",
                                        value: {
                                            x: e,
                            ...
                            createMultipleConfetti: function(e) {
                                ...
                                return y.createMultipleConfetti(s({}, a, e), t, n)
                            },
                            createMultipleConfettiAt: function(e, t, n) {
                                var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 20,
                                    o = arguments.length > 4 ? arguments[4] : void 0;
                                return y.createMultipleConfetti(s(f(s({}, a), {
                                    position: {
                                        type: "static",
                                        value: {
                                            x: e,
        ...
        305082: (e, t, n) => {
            ...
            function C() {
                return e = m, t = T, n = h("useMemoizedValueSyncedWithDismissibleContents"), i = (0, o.e7)([l.Z], (function() {
                    var e;
        ...
        518197: (e, t, n) => {
            ...
            function h(e) {
                var t, n, b = e.channel,
                    ...
                    C = T ? g < _.TU7 : (null == S ? void 0 : S.premiumTier) !== _.Eu4.TIER_3 && g <= _.eez,
                    P = u.Z.can(d.yP, b);
                n = T && (null == S ? void 0 : S.premiumTier) === _.Eu4.TIER_3 ? g <= _.TU7 ? E.Z.Messages.STAGE_FULL_BOOST_MORE_BODY : E.Z.Messages.STAGE_FULL_MAX_BODY : C ? E.Z.Messages.STAGE_FULL_BODY : E.Z.Messages.STAGE_FULL_MAX_BODY;
                var w = function() {
                        I();

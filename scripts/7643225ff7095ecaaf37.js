        ...
        768560: (e, t, n) => {
            ...
            function C(e) {
                var t, n, o, c = e.guildId,
                    ...
                    O = A.enableDeveloperActivityShelf,
                    j = A.filter,
                    D = (0, I.Z)(c, d, v),
                    Z = w.useExperiment({
                    ...
                    C = null != Z ? Z : r.None,
                    T = (t = D, n = C, o = (0, i.cj)([s.Z], (function() {
                ...
                return M(B).concat(M(T)).map((function(e) {
                    var t = _(e, 2);
                    return [t[0], t[1].filter((function(e) {
                        return g || !O || "" === j || e.application.name.toLocaleLowerCase().includes(j.toLocaleLowerCase())
                    }))]
                }))
            }
        },
                ...
                try {
                    for (var b, y = e[Symbol.iterator](); !(f = (b = y.next()).done); f = !0) {
                        var v = b.value,
                            ...
                            m = void 0;
                        try {
                            for (var g, A = v.connections.keys()[Symbol.iterator](); !(p = (g = A.next()).done); p = !0) {
                                var O = g.value;
                                u.add(O)
                            }
                        } catch (e) {
            ...
            function O(e, t, n) {
                var y = (0, i.e7)([a.default], (function() {
                    ...
                    g = function(e) {
                        ...
                        return r.useMemo((function() {
                            return v(g).concat(v(A)).filter((function(e) {
                                var n = e.activity;
                    ...
                    w = O.enableBigShelf,
                    S = O.enableMinimalActivityDetails,
                    j = O.enableSocialProofActivityDetails,
                    E = w || S || j;
                return r.useMemo((function() {
                    var e = new Map;
                    if (null == y) return [];
        ...
        652221: (e, t, n) => {
            ...
            function b(e) {
                var t = e.name,
                    ...
                    b = e.showTooltip,
                    y = void 0 !== b && b,
                    v = n === o.ww.NEW ? c.Z.Messages.NEW : c.Z.Messages.UPDATED,
                    p = n === o.ww.NEW ? f().activityNewBadge : f().activityUpdatedBadge,
                    h = d(i.useState(s ? "" : v), 2),
                    m = h[0],
                    g = h[1];

        ...
        652555: (e, t, n) => {
            ...
            var ye = function(e) {
                ...
                r.voiceStateUpdate = function(e) {
                    ...
                    this.send(he.VOICE_STATE_UPDATE, m)
                };
                r.voiceServerPing = function() {
                    this.send(he.VOICE_SERVER_PING, null)
                };
                r.embeddedActivityClose = function(e, t, n) {
                    this.send(he.EMBEDDED_ACTIVITY_CLOSE, {
                        guild_id: null != e ? e : "0",
                        channel_id: t,
                        application_id: n
                    })
                ...
                r.requestGuildMembers = function(e, t) {
                    var n = t.query,
                        ...
                        i = t.userIds,
                        a = t.presences;
                    this.send(he.REQUEST_GUILD_MEMBERS, {
                        guild_id: e,
                        query: n,
                        limit: r,
                        user_ids: i,
                ...
                r.searchRecentMembers = function(e, t) {
                    ...
                    this.send(he.SEARCH_RECENT_MEMBERS, {
                        guild_id: e,
                        query: null != n ? n : "",
                ...
                r.updateGuildSubscriptions = function(e, t) {
                    this.send(he.GUILD_SUBSCRIPTIONS, function(e) {
                        for (var t = 1; t < arguments.length; t++) {
                            var n = null != arguments[t] ? arguments[t] : {},
                                r = Object.keys(n);
                            "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
                ...
                r.callConnect = function(e) {
                    this.send(he.CALL_CONNECT, {
                        channel_id: e
                    })
                };
                r.lobbyConnect = function(e, t) {
                    this.send(he.LOBBY_CONNECT, {
                        lobby_id: e,
                        lobby_secret: t
                    })
                };
                r.lobbyDisconnect = function(e) {
                    this.send(he.LOBBY_DISCONNECT, {
                        lobby_id: e
                    })
                };
                r.lobbyVoiceStatesUpdate = function(e) {
                    this.send(he.LOBBY_VOICE_STATES_UPDATE, e.map((function(e) {
                        return {
                            lobby_id: e.lobbyId,
                ...
                r.streamWatch = function(e) {
                    this.send(he.STREAM_WATCH, {
                        stream_key: e
                    })
                };
                r.streamPing = function(e) {
                    this.send(he.STREAM_PING, {
                        stream_key: e
                    })
                };
                r.streamDelete = function(e) {
                    this.send(he.STREAM_DELETE, {
                        stream_key: e
                    })
                };
                r.streamSetPaused = function(e, t) {
                    this.send(he.STREAM_SET_PAUSED, {
                        stream_key: e,
                        paused: t
                    })
                };
                r.speedTestCreate = function() {
                    ...
                    this.send(he.SPEED_TEST_CREATE, {
                        preferred_region: e
                    })
                };
                r.speedTestDelete = function() {
                    this.send(he.SPEED_TEST_DELETE, null)
                };
                r.requestForumUnreads = function(e, t, n) {
                    this.send(he.REQUEST_FORUM_UNREADS, {
                        guild_id: e,
                        channel_id: t,
                ...
                r.requestSoundboardSounds = function(e) {
                    this.send(he.REQUEST_SOUNDBOARD_SOUNDS, {
                        guild_ids: e
                    })
                };
                r.requestLastMessages = function(e, t) {
                    this.send(he.REQUEST_LAST_MESSAGES, {
                        guild_id: e,
                        channel_ids: t
                    })
                };
                r.getDeletedEntityIdsNotMatchingHash = function(e, t, n, r, i) {
                    this.send(he.GET_DELETED_ENTITY_IDS_NOT_MATCHING_HASH, {
                        guild_id: e,
                        channel_ids_hash: t,
                        role_ids_hash: n,
                        emoji_ids_hash: r,
            ...
            function be(e) {
                be = Object.setPrototypeOf ? Object.getPrototypeOf : function(e) {
                    return e.__proto__ || Object.getPrototypeOf(e)
                };
                return be(e)
            }
                ...
                if (null != c) {
                    ...
                    if (c.state.gateway !== r) {
                        ...
                        null != p.messages && (p.messages = p.messages.map((function(e) {
                            return null != e.data && "string" == typeof e.data ? Ie(Te({}, e), {
            ...
            var je = window.GLOBAL_ENV.GATEWAY_ENDPOINT,
                Be = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        e.prototype = Object.create(t && t.prototype, {
                    ...
                    function n() {
                        ...
                        var e;
                        (e = t.call(this)).dispatchExceptionBackoff = new b.Z(1e3, ke);
                    ...
                    r.addAnalytics = function(e) {
                        this.analytics = Te({}, this.analytics, e)
                    };
                    ...
                    r._connect = function() {
                        ...
                        if (this.willReconnect())
                            if (ge) De.info("Skipping _connect because socket is paused");
                            else {
                                this.connectionState = Le.CONNECTING;
                                ...
                                Pe({
                                    ...
                                    onMessage: Me(this.compressionHandler, (function(t, n) {
                                        var r = Date.now(),
                                            i = Ne.unpack(t),
                                            a = i.op,
                                            o = i.s,
                                            s = i.t,
                                            u = i.d;
                                        a !== he.DISPATCH && T.Z.mark("🌐", "GatewaySocket.onMessage ".concat(a, " ").concat(he[a]));
                                        var c = Date.now() - r;
                    ...
                    r._handleReconnect = function() {
                        ...
                        this.connectionState = Le.WILL_RECONNECT;
                        this._connect()
                    };
                    ...
                    r._handleDispatch = function(e, t, n) {
                        ...
                        if (this.connectionState === Le.RESUMING) {
                        ...
                        this.connectionState === Le.RESUMING && (this.resumeAnalytics.dispatchTime += performance.now() - r)
                    };
                    r._handleDispatchWithoutQueueing = function(e, t, n) {
                        ...
                        if ("READY_SUPPLEMENTAL" === t) {
                            ...
                            this.connectionState = Le.SESSION_ESTABLISHED;
                    ...
                    r._getGatewayUrl = function() {
                        return null != this.resumeUrl ? this.resumeUrl : je
                    };
                    ...
                    r._handleClose = function(e, t, n) {
                        ...
                        if (t === Ue) {
                            this.connectionState = Le.CLOSED;
                    ...
                    r._cleanup = function(e) {
                        ...
                        this.compressionHandler = new F(Ne)
                    };
                    r._doResume = function() {
                        this.connectionState = Le.RESUMING;
                    ...
                    r._doIdentify = function() {
                        ...
                        if (null !== e) {
                            this.connectionState = Le.IDENTIFYING;
                            ...
                            this.send(he.IDENTIFY, p, !1)
                        } else this._handleClose(!0, Ue, "No connection info provided")
                    };
                    ...
                    r._sendHeartbeat = function() {
                        this.send(he.HEARTBEAT, this.seq, !1)
                    };
                    r.getLogger = function() {
                        return De
                    };
                    r.willReconnect = function() {
                        return this.connectionState === Le.WILL_RECONNECT
                    };
                    r.isClosed = function() {
                        return this.connectionState === Le.CLOSED
                    };
                    r.isSessionEstablished = function() {
                        return this.connectionState === Le.SESSION_ESTABLISHED || this.connectionState === Le.RESUMING
                    };
                    r.isConnected = function() {
                        return this.connectionState === Le.IDENTIFYING || this.connectionState === Le.RESUMING || this.connectionState === Le.SESSION_ESTABLISHED
                    };
                    r.connect = function() {
                        if (!this.isClosed()) {
                    ...
                    r.resetSocketOnError = function(e, t) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {
                            ...
                            r = this;
                        De.error("resetSocketOnError", e.stack);
                    ...
                    r.resetBackoff = function() {
                        ...
                        this.willReconnect() ? this._connect() : t && this.connectionState !== Le.SESSION_ESTABLISHED && this._handleClose(!0, 0, e)
                    };
                    ! function(e, t, n) {
                        t && Se(e.prototype, t);
                        n && Se(e, n)
            ...
            var qe = function() {
                ...
                t.update = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        n = this.getNextState(We({}, this.state, e));
                    if (t) this.dirty = !Fe()(n, this.getInitialState());
                    else {
                        var r = !0,
                            i = !1,
                            a = void 0;
                        try {
                            for (var o, s = Object.keys(n)[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                                var u = o.value;
                                this.dirty = this.dirty || !Fe()(this.state[u], n[u])
                            }
                        } catch (e) {
                            i = !0;
                            a = e
            ...
            function Ke(e, t, n) {
                Ke = "undefined" != typeof Reflect && Reflect.get ? Reflect.get : function(e, t, n) {
                    var r = function(e, t) {
            ...
            var tt = function(e) {
                ...
                r.forceUpdate = function() {
                    this._hadLobbyVoiceStates && Ke(Je(n.prototype), "forceUpdate", this).call(this)
                };
                return n
            }(qe);
            ...
            function at(e) {
                at = Object.setPrototypeOf ? Object.getPrototypeOf : function(e) {
                    return e.__proto__ || Object.getPrototypeOf(e)
                };
                return at(e)
            }
            ...
            function ot(e, t) {
                return !t || "object" !== ut(t) && "function" != typeof t ? it(e) : t
            }
            ...
            var lt = function(e) {
                    ...
                    function n(e) {
                        ...
                        r.didCommit = (i = 5, a = 2e4, o = r.emitPresenceUpdate.bind(it(r)), u = [], c = function() {
            ...
            var St = function(e) {
                ...
                r.computeVoiceFlags = function() {
                    ...
                    return e = (0, _t.mB)(e, ee.BVn.CLIPS_ENABLED, ft.Z.getSettings().clipsEnabled && (0, dt.T4)(this.guildId))
                };
                r.getInitialState = function() {
                    return {
                        guildId: null,
            ...
            var Tt = new u.Z("ConnectionStore"),
                It = new Be,
                Ot = new lt(It),
                Ct = new St(It),
                At = new tt(It),
                Rt = null;
            It.handleIdentify = function() {
                var e = l.default.getToken();
                Tt.log("handleIdentify called", {
                    hasToken: null != e
                });
                return null == e ? null : {
                    token: e,
                    properties: X.default.getSuperProperties(),
                    presence: Ot.getState()
                }
            };
            0;
            (0,
                Y.nI)() && xe.Z.remotePowerMonitor.on("resume", (function() {
                It.expeditedHeartbeat(5e3, "power monitor resumed")
            }));
            Ve.Z.addOfflineCallback((function() {
                It.networkStateChange(15e3, "network detected offline.", !1)
            }));
            Ve.Z.addOnlineCallback((function() {
                It.networkStateChange(5e3, "network detected online.")
            }));
            It.on("disconnect", (function(e) {
                var t = e.code,
                    n = e.reason;
                o.Z.dispatch({
            ...
            var Dt = [],
                Nt = null,
                Pt = 33,
                wt = new Set(["READY", "INITIAL_GUILD"]);
            It.on("dispatch", (function(e, t) {
                Dt.push([e, t]);
                if (wt.has(e)) {
                    null != Nt && clearTimeout(Nt);
                    Lt()
                } else null == Nt && (Nt = setTimeout(Lt, Pt))
            }));
            ...
            function Lt() {
                ...
                var e = Date.now(),
                    t = Dt.slice();
                Dt.length = 0;
                if (null == Rt) throw Error("setDispatchSocketMessageFunction needs to be called first!");
                var n = "none";
                try {
                    Ze.Z.Emitter.batched((function() {
                        t.forEach((function(e) {
                            var t = bt(e, 2),
                                r = t[0],
                                i = t[1];
                    ...
                    It.resetSocketOnError(e, n)
                }
                var r = Date.now() - e;
                if (r > 100) {
                    Tt.log("Dispatched ".concat(t.length, " messages in ").concat(r, "ms"));
                    Pt = 250
                } else Pt = 33
            }
            n(887235);
            ...
            var ln = new u.Z("ReadyPayloadUtils"),
                dn = {},
                fn = null,
                _n = {};
            ...
            function pn(e, t) {
                var n = e.users,
                    ...
                    o = e.merged_members,
                    u = e.guilds,
                    c = cn(e, ["users", "relationships", "private_channels", "merged_members", "guilds"]);
                ! function() {
                    e = Kt.Z.database(), null != e && !1 === Qt.Z.okSync(e) && s.Z.replaceDisableAllDatabases("ReadyPayloadUtils: database was not ok");
                    var e;
                    dn = {};
                    var t = Object.values(nn.Z.getGuilds()),
                        n = en.Z.getGuilds(),
                        r = tn.Z.getRawStickersByGuild(),
                        i = rn.ZP.getReadStatesByChannel(),
                        a = (0, Xt.O)() ? Jt.Z.getCommittedVersions() : new Map,
                        o = (0, Xt.O)() ? $t.Z.getGuildIdsSync() : new Set,
                        u = !0,
                        c = !1,
                        l = void 0;
                    try {
                ...
                var l, d = En(_n = i().keyBy(n, (function(e) {
                    return e.id
                })), r);
                null == a || a.forEach((function(e) {
                    var t = e.recipient_ids;
                    null != t && (e.recipients = t.map((function(e) {
                        S()(null != _n[e], "Missing user in compressed ready payload");
                        return _n[e]
                    })));
                ...
                var f = null !== (l = null == u ? void 0 : u.map((function(e, t) {
                        ...
                        e.members = En(_n, null == o ? void 0 : o[t]);
                        return yn(e)
                    }))) && void 0 !== l ? l : [],
                    _ = hn(t, u, (function(e) {
                        return yn(e)
            ...
            function hn(e, t, n) {
                return null == fn || fn.identifyTime !== e || null != t && t.some((function(e) {
                    return e.id === fn.guild.id
                })) ? null : n(fn.guild)
            }
            ...
            function yn(e) {
                var t, n, r, i, a, o, s, u, c, l, d = mn(e.id);
                if ("partial" !== e.data_mode) {
                    ...
                    return {
                        ...
                        threads: null !== (_ = null === (f = e.threads) || void 0 === f ? void 0 : f.map((function(t) {
                            return (0, Zt.q_)(t, e.id)
                        }))) && void 0 !== _ ? _ : [],
                        threadMessages: Sn(e.threads),
                ...
                if (null == d) {
                    ln.log("no cache entry for partial guild (guild: ".concat(e.id, ", type: ready)"));
                ...
                return {
                    ...
                    emojis: null == d.emojis ? null : vn(d.emojis, e.partial_updates.emojis, e.partial_updates.deleted_emoji_ids),
                    emojiUpdates: {
                    ...
                    roles: an.EO(e.id, d.roles, e.partial_updates.roles, e.partial_updates.deleted_role_ids),
                    stage_instances: e.stage_instances,
                    stickers: null == d.stickers ? null : vn(d.stickers, e.partial_updates.stickers, e.partial_updates.deleted_sticker_ids),
                    stickerUpdates: {
            ...
            function gn(e, t) {
                ...
                if (null == t) {
                    ln.log("no cache entry for partial guild (guild: ".concat(e.id, ", type: post_ready)"));
                    throw Error("Guild data was missing from store, but hash was still available.")
                }
                return {
                    id: e.id,
                    ...
                    channelTimestampUpdates: e.channel_updates,
                    embedded_activities: e.embedded_activities,
                    emojis: null == t.emojis ? null : vn(t.emojis, e.partial_updates.emojis, e.partial_updates.deleted_emoji_ids),
                    emojiUpdates: {
                    ...
                    roles: an.EO(e.id, t.roles, e.partial_updates.roles, e.partial_updates.deleted_role_ids),
                    stage_instances: e.stage_instances,
                    stickers: null == t.stickers ? null : vn(t.stickers, e.partial_updates.stickers, e.partial_updates.deleted_sticker_ids),
                    stickerUpdates: {
            ...
            var Cn = new u.Z("ConnectionStore"),
                An = new He(It, (function(e, t) {
                    e = null != e ? e : {
                    ...
                    var n, r = (0,
                        ...
                        a = null == i ? void 0 : i.merge(In(Tn({}, r), {
            ...
            function Nn(e) {
                o.Z.dispatch(e).catch((function(t) {
                    return It.resetSocketOnError(t, e.type)
                }))
            }
            ...
            function Pn(e, t, n) {
                var r = n.roles,
                    ...
                    _ = Ht.ZP.getMember(e, t.id);
                null != _ && _.nick === a && _.avatar === o && i().isEqual(_.roles, r) && _.premiumSince === u && _.isPending === c && _.joinedAt === l && _.communicationDisabledUntil === d && _.flags === s && _.unusualDMActivityUntil === f || Nn({
            ...
            function Un() {
                It.isSessionEstablished() && _.Z.getPendingLobbies().forEach((function(e) {
                    It.lobbyConnect(e.id, e.secret)
                }))
            }
            ...
            function Bn(e, t) {
                Bn = Object.setPrototypeOf || function(e, t) {
                    e.__proto__ = t;
                    return e
                };
                return Bn(e, t)
                ...
                switch (e) {
                    case "INITIAL_GUILD":
                        A.Z.initialGuild.measure((function() {
                            a.ZP.Emitter.batched((function() {
                                var e = function(e, t) {
                                    var n, r, i, a = nn.Z.getGuild(e.id),
                                        o = gn(e, null == a ? void 0 : {
                                            properties: an.tK(a),
                                            roles: a.roles,
                                            emojis: null !== (r = null === (n = en.Z.getGuilds()[a.id]) || void 0 === n ? void 0 : n.rawEmojis) && void 0 !== r ? r : null,
                                            stickers: null !== (i = tn.Z.getRawStickersByGuild().get(a.id)) && void 0 !== i ? i : null,
                                            readStates: {}
                                        });
                                    fn = {
                                        guild: e,
                                ...
                                if (null != $.default.getCurrentUser()) {
                                    ...
                                    Cn.log("Dispatched INITIAL_GUILD ".concat(t.id))
                                }
                            }))
                        }));
                        break;
                                ...
                                t = A.Z.hydrateReadySupplemental.measure((function() {
                                    return function(e, t) {
                                        var n, r = e.guilds,
                                            i = e.merged_members,
                                            a = e.merged_presences,
                                            o = cn(e, ["guilds", "merged_members", "merged_presences"]),
                                            s = En(_n, null == a ? void 0 : a.friends),
                                            u = null !== (n = null == r ? void 0 : r.map((function(e, t) {
                                                var n = En(_n, null == a ? void 0 : a.guilds[t]),
                                                    r = En(_n, null == i ? void 0 : i[t]);
                                                return un(sn({}, e), {
                        ...
                        A.Z.ready.measure((function() {
                            a.ZP.Emitter.batched((function() {
                                var e = (t = A.Z.hydrateReady.measure((function() {
                                        return pn(t, It.identifyStartTime)
                                ...
                                var i = null == t.user_settings_proto ? void 0 : (0, Bt.ac)(t.user_settings_proto);
                    ...
                    case "THREAD_LIST_SYNC":
                        Nn({
                            ...
                            members: t.members ? i().map(t.members, jt.Z) : void 0,
                    ...
                    case "USER_SETTINGS_PROTO_UPDATE":
                        var d = (0, Bt.kI)(t.settings.type, t.settings.proto);
                        if (null == d) break;
                        if ("string" == typeof d) {
                    ...
                    case "VOICE_STATE_UPDATE":
                        ...
                        Nn({
                            ...
                            voiceStates: [{
                                ...
                                oldChannelId: Ft.Z.getUserVoiceChannelId(t.guild_id, t.user_id)
                            }]
                        });
                        break;
                    ...
                    case "USER_PAYMENT_SOURCES_UPDATE":
                        if (zt.Z.hasLayers()) {
                            n(673679).tZ();
                            kt.Gn(Yt.Z.getFetchedSKUIDs())
                        }
                        break;
                    case "USER_SUBSCRIPTIONS_UPDATE":
                        Mt.k();
                        zt.Z.hasLayers() && n(673679).jg();
                        break;
                    case "USER_PREMIUM_GUILD_SUBSCRIPTION_SLOT_CREATE":
                        Nn({
                            type: "GUILD_BOOST_SLOT_CREATE",
                            guildBoostSlot: xt.Z.createFromServer(t, Wt.Z.getSubscriptionById(t.subscription_id))
                        });
                        break;
            ...
            var Vn = new u.Z("ConnectionStore"),
                Hn = 0,
                zn = null;
            ...
            function qn(e) {
                It.isSessionEstablished() && It.streamDelete(e)
            }
            ...
            var Jn = function(e) {
                ...
                r.initialize = function() {
                    ...
                    this.syncWith([p.Z], Fn);
                    this.syncWith([m.Z], Yn)
                };
                ...
                r.isConnected = function() {
                    return It.isSessionEstablished()
                };
                r.isConnectedOrOverlay = function() {
                    return It.isSessionEstablished() || __OVERLAY__
                };
            ...
            Jn.displayName = "GatewayConnectionStore";
            const Qn = new Jn(o.Z, {
                START_SESSION: function() {
                    if (It.isClosed()) {
                        Vn.log("Socket is reconnecting because of starting new session");
                        return It.connect()
                    }
                    Vn.log("Socket is not reconnecting during a new session because it is not closed");
                    return !1
                },
                LOGIN_SUCCESS: function() {
                    Vn.log("session refresh dispatched", {
                        isEstablished: It.isSessionEstablished()
                    });
                    if (It.isSessionEstablished()) {
                        It.close();
                        return It.connect()
                    }
                    return !1
                ...
                LOGOUT: function(e) {
                    e.isSwitchingAccount && Ot.handleAccountSwitch();
                    Vn.log("Closing socket because of logout");
                    It.close()
                },
                CLEAR_CACHES: function(e) {
                    It.close();
                    It.clearDispatchQueue();
                    It.connect();
                    return !1
                },
                CONNECTION_OPEN: function(e) {
                ...
                CONNECTION_CLOSED: function() {
                    Vn.log("connection closed dispatched");
                    Hn = Date.now()
                },
                RTC_CONNECTION_STATE: function(e) {
                    if (e.state !== ee.hes.DISCONNECTED) return !1;
                    e.willReconnect && (null != e.streamKey ? It.streamPing(e.streamKey) : It.voiceServerPing())
                },
                ...
                VOICE_STATE_UPDATES: function(e) {
                    return e.voiceStates.reduce((function(e, t) {
                        ...
                        if (t.sessionId === zn) Ct.setState({
                            guildId: t.guildId,
                            channelId: t.channelId
                        });
                        else {
                            if (t.guildId !== Ct.guildId) return e;
                            Ct.setState({
                                guildId: null,
                                channelId: null
                            })
                ...
                GUILD_DELETE: function(e) {
                    e.guild.id === Ct.guildId && Ct.setState({
                        guildId: null,
                        channelId: null
                    })
                },
                CHANNEL_DELETE: function(e) {
                    e.channel.id === Ct.channelId && Ct.setState({
                        guildId: null,
                        channelId: null
                    })
                },
                CALL_DELETE: function(e) {
                    e.channelId === Ct.channelId && Ct.setState({
                        guildId: null,
                        channelId: null
                    })
                },
                APP_STATE_UPDATE: function(e) {
                    if (e.state === ee.$7l.ACTIVE) {
                        ge = !1;
                        l.default.isAuthenticated() && It.resetBackoff("App state is active")
                    }
                    return !1
                },
                GUILD_MEMBERS_REQUEST: function(e) {
                    It.isSessionEstablished() && ("userIds" in e ? i()(e.userIds).chunk(100).forEach((function(t) {
                        It.requestGuildMembers(e.guildIds, {
                            userIds: t,
                            presences: !!e.presences
                        })
                    })) : It.requestGuildMembers(e.guildIds, {
                ...
                GUILD_SEARCH_RECENT_MEMBERS: function(e) {
                    ...
                    It.isSessionEstablished() && It.searchRecentMembers(t, {
                        query: n,
                        continuationToken: r
                    })
                },
                GUILD_SUBSCRIPTIONS_FLUSH: function(e) {
                    var t = e.guildId,
                        n = e.subscriptions;
                    It.isSessionEstablished() && It.updateGuildSubscriptions(t, n);
                    return !1
                },
                CALL_CONNECT: function(e) {
                    var t = e.channelId;
                    It.isSessionEstablished() && It.callConnect(t);
                    return !1
                },
                CALL_CONNECT_MULTIPLE: function(e) {
                    var t = e.channelIds;
                    It.isSessionEstablished() && t.forEach((function(e) {
                        It.callConnect(e)
                    }));
                    return !1
                },
                LOBBY_CONNECT: function(e) {
                    var t = e.lobbyId,
                        n = e.lobbySecret;
                    It.isSessionEstablished() && It.lobbyConnect(t, n);
                    return !1
                },
                LOBBY_DISCONNECT: function(e) {
                    var t = e.lobbyId;
                    It.isSessionEstablished() && It.lobbyDisconnect(t);
                    At.update();
                    return !1
                },
                LOBBY_VOICE_CONNECT: Wn,
                LOBBY_VOICE_DISCONNECT: Wn,
                RPC_APP_DISCONNECTED: Wn,
                STREAM_START: function(e) {
                    ...
                    if (It.isSessionEstablished()) {
                        ...
                        It.streamCreate(t, n, r, null != o ? o : h.Z.getPreferredRegion())
                    }
                    return !1
                },
                ...
                STREAM_SET_PAUSED: function(e) {
                    var t = e.streamKey,
                        n = e.paused;
                    It.isSessionEstablished() && It.streamSetPaused(t, n)
                },
                PUSH_NOTIFICATION_CLICK: function() {
                    It.expeditedHeartbeat(5e3, "user clicked on notification", !0);
                    return !1
                },
                EMBEDDED_ACTIVITY_DISCONNECT: function(e) {
                    ...
                    It.embeddedActivityClose(a, r, i)
                },
                REQUEST_FORUM_UNREADS: function(e) {
                    var t = e.guildId,
                        n = e.channelId,
                        r = e.threads;
                    It.requestForumUnreads(t, n, r)
                },
                REQUEST_SOUNDBOARD_SOUNDS: function(e) {
                    var t = e.guildIds;
                    It.requestSoundboardSounds(t)
                },
                REMOTE_COMMAND: function(e) {
                    var t = e.sessionId,
                        n = e.payload;
                    It.isSessionEstablished() && It.remoteCommand(t, n);
                    return !1
                },
                RESET_CONNECTION: function(e) {
                    if (It.connectionState !== Le.WILL_RECONNECT)
                        if (e.badCache) {
                            s.Z.replaceDisableAllDatabases("RESET_CONNECTION");
                            It.resetSocketOnError(new Error("Guild data was missing from store (via RESET_CONNECTION)"), "RESET_CONNECTION_DATA_MISSING")
                        } else It.resetSocketOnError(new Error("Connection reset requested (via RESET_CONNECTION)"), "RESET_CONNECTION")
                },
                RTC_SPEED_TEST_START_TEST: function() {
                    It.isSessionEstablished() && It.speedTestCreate(h.Z.getPreferredRegion());
                    return !1
                },
                RTC_SPEED_TEST_STOP_TEST: function() {
                    It.isSessionEstablished() && It.speedTestDelete();
                    return !1
                },

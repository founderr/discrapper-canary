            ...
            var i = n("37983"),
                ...
                y = function(e) {
                    let {
                        ...
                        transitionState: r,
                        onClose: y
                    } = e, O = (0, s.useStateFromStores)([T.default], () => T.default.getGuild(t), [t]), D = (0, s.useStateFromStores)([p.default], () => p.default.getId()), b = (0, s.useStateFromStores)([S.default], () => S.default.getMember(t, D)), [G, w] = l.useState([]), M = (0, f.default)(), x = (0, h.useUID)();
                    if (l.useEffect(() => {
                            0 !== G.length && v.default.track(U.AnalyticEvents.PASSPORT_ENTRY_VIEWED, {
                                role_ids: G.map(e => {
                                    let {
                                        role_id: t
                                    } = e;
                                        ...
                                        s = function(e) {
                                            ...
                                            for (let e of n.rules.flat()) {
                                                ...
                                                if (null != e.application_id) {
                                                    ...
                                                    s = (0, i.jsx)("img", {
                                                        src: (0, u.isThemeLight)(M) ? t.icon.lightSVG : t.icon.darkSVG,
                                                        alt: "",
                                                        className: P.avatar
                                                    })
                                                }
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (c = null == g ? void 0 : null === (s = g.options) || void 0 === s ? void 0 : s.renderHeader) || void 0 === c || c ? _ : null, g.renderStep(p), null == S || m ? null : (0, i.jsxs)(i.Fragment, {
        ...
        649844: function(e, t, n) {
            ...
            function I(e) {
                let {
                    ...
                    giftRecipient: O,
                    returnRef: D
                } = null != e ? e : {}, b = !1, G = (0, l.v4)(), w = a.default.getCurrentUser(), M = (0, f.isPremiumExactly)(w, _.PremiumTypes.TIER_2);
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: I,
                            onClose: (e, t) => {
                                l(), null == p || p(e), e && (null == T || T(), !g && null != t && t === _.PremiumSubscriptionSKUs.TIER_2 && !M && d.ComponentDispatch.dispatch(E.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                b = !0, null == S || S(), !g && (0, u.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: T,
                            analyticsLocations: h,
                            analyticsObject: N,
                    ...
                    onCloseCallback: () => {
                        !b && c.default.track(E.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: P,
                            location_stack: h
                        }), (0, o.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == p || p(b), b && (null == T || T())
                    },
        ...
        181114: function(e, t, n) {
            ...
            let S = e => {
                let {
                    ...
                    onlyShineOnHover: I,
                    ...S
                } = e, T = o.createRef(), h = (0, d.default)(T), N = !i && !l && !0 !== s && (!I || h);

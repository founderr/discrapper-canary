    ...
    [19493], {
                        ...
                        return R(this, (function(n) {
                            switch (n.label) {
                                case 0:
                                    ...
                                    t = (0, p.F)(e.item.target).getDeleteUploadURL(e.uploadedFilename);
                                    n.label = 1;
                                case 1:
                                    n.trys.push([1, 3, , 4]);
        ...
        861323: (e, t, n) => {
            ...
            var r, o, i, u, a, l, c = n(608575),
                ...
                b = L(window.GLOBAL_ENV.INVITE_HOST),
                A = L(window.GLOBAL_ENV.GUILD_TEMPLATE_HOST),
                S = L(null !== (r = window.GLOBAL_ENV.WEBAPP_ENDPOINT) && void 0 !== r ? r : "//canary.".concat(E.$R1)),
                R = L("//canary.".concat(E.$R1)),
                C = L("//ptb.".concat(E.$R1)),
                N = L("discordapp.com"),
                P = L("discord.com"),
                w = [p.Z.escape(null !== (o = b.host) && void 0 !== o ? o : ""), p.Z.escape(null !== (i = A.host) && void 0 !== i ? i : ""), p.Z.escape(null !== (u = S.host) && void 0 !== u ? u : ""), p.Z.escape(null !== (a = N.host) && void 0 !== a ? a : ""), p.Z.escape(null !== (l = P.host) && void 0 !== l ? l : "")].filter(Boolean),
                M = new RegExp("((https?://[^ ]*)|^|[^/][^/.])(".concat(w.join("|"), ")"), "g");
            ...
            function U(e) {
                var t, n, r, o;
                return null !== (o = null !== (r = null !== (n = null !== (t = D(S, e)) && void 0 !== t ? t : D(R, e)) && void 0 !== n ? n : D(C, e)) && void 0 !== r ? r : D(N, e)) && void 0 !== o ? o : D(P, e)
            }
            ...
            function Z(e) {
                ...
                var t = new Set,
                    n = [];
                e = e.replace(M, (function(e, t, n, r) {
                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, g, w, L, U = D(b, p),
                                Z = D(A, p),
                                G = null !== (L = null !== (w = null !== (g = null !== (E = D(S, p)) && void 0 !== E ? E : D(R, p)) && void 0 !== g ? g : D(C, p)) && void 0 !== w ? w : D(N, p)) && void 0 !== L ? L : D(P, p),
                                B = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
                            ...
                            if (null != (null == U ? void 0 : U.match(v))) {
                                var V = (0, f.mb)(U.substring(1), p.search);
                                d.Z.getInvite(V);
                                B(_.g.INVITE, V)
                            }
                            null != (null == Z ? void 0 : Z.match(v)) && B(_.g.TEMPLATE, Z.substring(1));
                            var k = null == G ? void 0 : G.match(y);
                            if (null != k) {
                                var x = k[1].toUpperCase();
                                if (x === _.g.INVITE) {
                                    var Y = (0, f.mb)(k[2], p.search);
                                    B(_.g.INVITE, Y)
                                } else B(x, k[2])
                            }
                            null != (null == G ? void 0 : G.match(m)) && B(_.g.CHANNEL_LINK, G.replace("/channels/", ""));
                            var H = j(p.pathname);
                            null != H && B(_.g.EVENT, "".concat(H.guildId, "-").concat(H.guildEventId));
                            var z = null == G ? void 0 : G.match(O);
                            if (null != z) {
                                var W = z[1];
                                B(_.g.APP_DIRECTORY_PROFILE, W)
                            }
                            var K = null == G ? void 0 : G.match(T),
                            ...
                            if (null != K && q) {
                                var Q = K[1];
                                B(_.g.ACTIVITY_BOOKMARK, Q)
                            }
                            var X = null == G ? void 0 : G.match(I);
                            null != X && B(_.g.GUILD_PRODUCT, "".concat(X[1], "-").concat(X[2]))
                        }
                    }
                } catch (e) {
                    i = !0;
        ...
        649536: (e, t, n) => {
            ...
            function L(e) {
                ...
                return new m.Z(P(N({}, e, S), {
                    ...
                    blocked: O.Z.isBlocked(e.author.id) || null != w && O.Z.isBlocked(w),
                    timestamp: g,
        ...
        473291: (e, t, n) => {
            ...
            var r = n(496486),
                ...
                _ = new Set([c.hBH.AUTO_MODERATION_MESSAGE, c.hBH.AUTO_MODERATION_NOTIFICATION, c.hBH.RICH, c.hBH.SAFETY_POLICY_NOTICE]);
            ...
            function m(e, t, n) {
                ...
                if (null != n.thumbnail && E(n.thumbnail)) switch (r.type) {
                    case c.hBH.ARTICLE:
                    case c.hBH.IMAGE:
                ...
                if (null != n.video) {
                    null == r.thumbnail && null != n.video.proxy_url && E(n.video) && (r.thumbnail = {
                        width: n.video.width,
                        height: n.video.height,
                        url: "".concat(n.video.proxy_url, "?format=jpeg")
                    });
                    null != r.thumbnail && E(n.video) && function(e, t, n) {
            ...
            function I(e) {
                return e.type === c.hBH.ARTICLE && null != e.url && h.test(e.url)
            }
        },
        644144: (e, t, n) => {
            "use strict";
            ...
            var F = function(e) {
                ...
                G = function(e) {
                    ...
                    for (; null != (t = P.exec(e)) && n.size < 3;) n.add(Z(t[1]));
                    return Array.from(n)
                };

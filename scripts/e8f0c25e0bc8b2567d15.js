    ...
    ["99211"], {
        ...
        478098: function(e, A, t) {
            ...
            e.exports = function(e, A, t) {
                ...
                function m() {
                    var e, t, a, n, r = l();
                    if (p(r)) return U(r);
                    c = setTimeout(m, (t = (e = r) - f, a = e - C, n = A - t, T ? s(n, u - a) : n))
                }

                function U(e) {
                    return (c = void 0, h && o) ? I(e) : (o = i = void 0, d)
                }
                ...
                function v() {
                    ...
                    if (o = arguments, i = this, f = t, a) {
                        if (void 0 === c) {
                            ;
                            return C = e = f, c = setTimeout(m, A), g ? I(e) : d
                        }
                        if (T) return clearTimeout(c), c = setTimeout(m, A), I(f)
                    }
                    return void 0 === c && (c = setTimeout(m, A)), d
                }
                return v.cancel = function() {
                    void 0 !== c && clearTimeout(c), C = 0, o = f = i = c = void 0
                }, v.flush = function() {
                    return void 0 === c ? d : U(l())
                }, v
            }
        },
            ...
            var a = t("872717"),
                ...
                r = {
                    async createApplication(e) {
                        ...
                        return null != t && null != r && l.default.dispatch({
                    ...
                    async getApplicationsForGuild(e) {
                        let {
                            includeTeam: A,
                            ...t
                        } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = await a.default.get({
        ...
        168804: function(e, A, t) {
            ...
            function U(e, A) {
                ...
                let [T, I] = a.useState(), [p, U] = a.useState(), v = a.useCallback(e => {
        ...
        155539: function(e, A, t) {
            ...
            function q(e) {
                ...
                let {
                    ...
                    null == o || o(t.id)
                }, [o, t.id]), c = n >= 1, f = n < 0, T = c || f, h = null !== (A = t.filename) && void 0 !== A ? A : t.id, p = (0, I.describeUploadProgressError)(n);
        ...
        795785: function(e, A, t) {
            ...
            function T(e) {
                let {
                    ...
                    disabled: m = !1
                } = e, U = n === C, [v, E] = l.useState(U ? t : null), [q, N] = l.useState(null), O = l.useRef(null), x = l.useRef(null);
                l.useEffect(() => {
                    T !== C && (E(null), N(null))
                }, [T]);
        ...
        48175: function(e, A, t) {
            ...
            function $(e) {
                let {
                    ...
                    disabled: l,
                    warning: r
                } = e, s = (0, L.useUID)(), i = l ? "text-muted" : "text-normal";
            ...
            function eA(e) {
                let {
                    ...
                    priceTiers: l
                } = (0, p.usePriceTiers)(A, Q.PriceTierTypes.GUILD_PRODUCTS), s = r.useMemo(() => (null != l ? l : null != t ? [t] : []).map(e => ({
                    value: e,
            ...
            function et(e) {
                ...
                } = (0, U.useShouldRestrictUpdatingCreatorMonetizationSettings)(L);
                r.useEffect(() => {
                ...
                ez && eP ? eZ = H.default.Messages.GUILD_PRODUCT_CARD_TYPE_DOWNLOADABLE_AND_ROLE : ez ? eZ = H.default.Messages.GUILD_PRODUCT_CARD_TYPE_ROLE : eP && (eZ = H.default.Messages.GUILD_PRODUCT_CARD_TYPE_DOWNLOADABLE);
                let eH = () => {
                        eV(!1), eF()
                    },
                    [ew, ek] = r.useState(),
                ...
                r.useEffect(() => {
                    (0, C.updateModal)(z.GUILD_PRODUCT_EDIT_MODAL_KEY, e => (0, n.jsx)(ea, {
                        guildId: L,
                        productId: en,
                        ...e
                    }), e6)
                ...
                let e3 = async e => {
                    ...
                    if (ex(!1), null != t) {
                        if (null != e.name && eh(t.name), null != e.description && ep(t.description), null != eB) {
                            let e = t.role_id;
                            u(null != e, "Cannot update role without role ID"), await g.default.updateRole(L, e, eB)
                        }
                        ey(void 0), er(t.id), "published" in e && !0 === e.published && el()
                    }
                };
                r.useEffect(() => {
                    if (null != e_) {
                        var e;
                        (0, W.showPublishErrorDialog)(e_, L, null == ei ? void 0 : null === (e = ei.team) || void 0 === e ? void 0 : e.id)
                    }
                }, [e_, L, ei]), r.useEffect(() => {
                    eJ && ek(void 0)
                }, [eJ]);
                        ...
                        children: [(0, n.jsx)(C.ScrollerThin, {
                            children: (0, n.jsxs)("div", {
                                ...
                                children: [(0, n.jsx)(C.FormItem, {
                                    ...
                                    children: (0, n.jsx)(m.default, {
                                        ...
                                        showCharacterCount: eI.length > 0,
                            ...
                            children: (0, n.jsxs)("div", {
                                ...
                                children: [(0, n.jsx)(B.default, {
                                    ...
                                    description: "" === eI ? H.default.Messages.GUILD_PRODUCT_CARD_EMPTY_DESCRIPTION : eI,
                                    formattedPrice: eD,
                                    role: eQ,
                                    productType: eZ,
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsxs)("div", {
                                ...
                                children: [(0, n.jsx)($, {
                                    ...
                                    value: ez,
                                    onChange: e => {
                                        e ? ey((0, y.getInitialNewRoleParams)()) : ey(void 0)
                                    },
                                    warning: null === eB ? (0, n.jsx)(y.WarningIcon, {}) : void 0,
                                    disabled: null != eX
                                }), (0, n.jsx)($, {
            ...
            function ea(e) {
                ...
                return (0, n.jsx)(b.GuildProductAttachmentManagerContextProvider, {
                    ...
                    onFileSizeError: () => (0, v.default)(z.MAX_ATTACHMENT_UPLOAD_FILESIZE_BYTES),
                    children: (0, n.jsx)(et, {
                        ...e
                    })
                })
        ...
        973262: function(e, A, t) {
            ...
            function m(e) {
                let {
                    ...
                    onClick: g,
                    "aria-label": h
                } = e, p = (0, s.useListItem)("color-".concat(A)), m = null != A ? (0, o.int2hex)(A) : c.backgroundColor, U = !1;
                return l && !n ? U = !0 : (l || n) && (U = (0, o.getDarkness)(A) > .1), (0, a.jsx)(i.FocusRing, {
                    offset: -2,
                    children: (0, a.jsxs)("button", {
                        type: "button",
                        className: r(I.colorPickerSwatch, {
                            [I.disabled]: u,
                            [I.default]: t,
                            [I.custom]: l,
                            [I.noColor]: null == A
                        ...
                        children: [l ? (0, a.jsx)(C.default, {
                            ...
                            width: 14,
                            height: 14,
                            color: (0, d.getColor)(U ? T.Color.WHITE_500 : T.Color.BLACK_500)
                        }) : null, function() {
                            let e = 16,
                                A = 16;
            ...
            let E = l.memo(e => {
                let {
                    ...
                    footer: d,
                    showEyeDropper: f
                } = e, T = (0, u.default)(), [p, m] = l.useState(() => {
                    let e = null != A ? A : 0,
                        t = (0, o.int2hex)(e);
                    return {
                        current: e,
                ...
                return (0, a.jsx)(s.ListNavigatorProvider, {
                    ...
                    children: (0, a.jsx)(s.ListNavigatorContainer, {
                        children: e => {
                            ...
                            return (0, a.jsxs)("div", {
                                className: r(I.container, A),
                                ref: n,
                                ...s,
                                children: [(0, a.jsx)("div", {
                                    className: r(I.defaultContainer, f),
                                    children: d({
                                        value: o,
                                        color: t,
                                        onChange: u,
                                    ...
                                    className: r(I.customContainer, f),
                                    children: c({
                                        value: o,
                                        customColor: l,
                                        disabled: i

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [83238, 38479, 17183, 33928, 72935, 19887, 57678, 58621, 33973, 96043, 71402, 42643, 17363, 56620], {
        737264: e => {
            "use strict";
        ...
        652411: (e, t, n) => {
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            return new b(g(e.minValue, e.maxValue), g(e.minStart, e.maxStart), g(e.minFinal, e.maxFinal), g(e.minDuration, e.maxDuration), y(e.minDirection, e.maxDirection), T(e.easingFunctions)[0])
                    }
                }(E(E({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = m(e.minValue),
                                r = m(e.maxValue);
                            return new O(new h(g(n.x, r.x)), new h(g(n.y, r.y)));
                        case "linear":
                            t = m(e.value);
                            var i = m(e.addValue);
                        ...
                        case "oscillating-random":
                            ...
                            var f = m(e.minStart),
                                ...
                                S = m(e.minDirection),
                                R = m(e.maxDirection);
                            return new O(new b(g(n.x, r.x), g(f.x, p.x), g(d.x, E.x), g(_.x, I.x), y(S.x, R.x), T(e.easingFunctions)[0]), new b(g(n.y, r.y), g(f.y, p.y), g(d.y, E.y), g(_.y, I.y), y(S.y, R.y), T(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = S(e.minValue),
                                r = S(e.maxValue);
                            return new I(new h(g(n.x, r.x)), new h(g(n.y, r.y)), new h(g(n.z, r.z)));
                        case "linear":
                            t = S(e.value);
                            var i = S(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = S(e.minAddValue),
                                a = S(e.maxAddValue);
                            return new I(new v(g(n.x, r.x), g(o.x, a.x)), new v(g(n.y, r.y), g(o.y, a.y)), new v(g(n.z, r.z), g(o.z, a.z)));
                        case "oscillating":
                            t = S(e.value);
                            var u = S(e.start),
                                l = S(e.final),
                        ...
                        case "oscillating-random":
                            ...
                            var f = S(e.minStart),
                                ...
                                m = S(e.minDirection),
                                R = S(e.maxDirection);
                            return new I(new b(g(n.x, r.x), g(f.x, p.x), g(d.x, E.x), g(_.x, O.x), y(m.x, R.x), T(e.easingFunctions)[0]), new b(g(n.y, r.y), g(f.y, p.y), g(d.y, E.y), g(_.y, O.y), y(m.y, R.y), T(e.easingFunctions)[0]), new b(g(n.z, r.z), g(f.z, p.z), g(d.z, E.z), g(_.z, O.z), y(m.z, R.z), T(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var A = r.forwardRef((function(e, t) {
                    ...
                    g = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == d || d(t), I.current.size > 0 ? h.current = window.requestAnimationFrame(g) : (t.clearRect(0, 0, e.width, e.height), h.current = null);
                                var n = Date.now();
                ...
                r.useEffect((function() {
                    null != h.current && (window.cancelAnimationFrame(h.current), h.current = window.requestAnimationFrame(g))
                }), [g]);
        ...
        393299: (e, t, n) => {
            ...
            function L(e) {
                var t = e.guild,
                    ...
                    o = (0, u.e7)([T.default, g.ZP], (function() {
                    ...
                    pe = (ae = (oe = function() {
                        ...
                        return S(this, (function(l) {
                            switch (l.label) {
                                ...
                                case 1:
                                    l.trys.push([1, 4, , 5]);
                                    return [4, (0, p.$p)(t, e, U, te.current, n)];
                                case 2:
        ...
        338479: (e, t, n) => {
            ...
            function C(e) {
                var t = e.text,
                    ...
                    s = void 0 !== c && c;
                return (0, r.jsxs)("div", {
                    className: g()(s ? R().noticeWithoutRightPadding : R().noticeWithRightPadding, u),
                    children: [(0, r.jsxs)("div", {
        ...
        63509: (e, t, n) => {
            ...
            var G = new j(c.Z, {
                POPOUT_WINDOW_OPEN: function(e) {
                    ...
                    var T = window.open(E.Z5c.POPOUT_WINDOW, t, function(e) {
                        var t = "",
                            n = !0,
                            r = !1,
                            i = void 0;
            ...
            const M = function(e) {
                var t = function(e) {
                    ...
                    q = function(e) {
                        ...
                        if (null != z) {
                            null == R || R(e);
                            if ((null == J ? void 0 : J.status) !== T.O0b.ACCOUNT_HOLD) ! function(e) {
                                var t = e.isClaimed,
                                    i = e.isVerified,
                                    o = e.isGift,
                                ...
                                if (t)
                                    if (i) {
                                        var O = T.Qqv.BUY;
                                        null != l ? O = T.Qqv.TRIAL : o && (O = T.Qqv.GIFT);
                                        (0, f.Z)({
                                            isGift: o,
                                            initialPlanId: null,
                                            subscriptionTier: a,
                ...
                var re = null != J && J.status !== T.O0b.ACCOUNT_HOLD && !(0, d.Q)(J.planId) && !ne,
                    ie = re ? null != K ? K : function(e) {
                        ...
                        if (null != u && null != a && a < u) {
                            ...
                            i = y.Z.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP
                        } else null == o && null != n && n === g.p9.TIER_2 && (i = y.Z.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP);
                        return {
                            disabledButtonText: r,
                            disabledButtonTooltipText: i
                        }
        ...
        585798: (e, t, n) => {
            ...
            var g, T = (0, d.Mg)(s.Z.FULL_SCREEN_LAYER_ANIMATION_DURATION);
            ! function(e) {

    ...
    [54602], {
        ...
        782912: (t, e, n) => {
            ...
            const _ = new(function(t) {
                ...
                n.prototype.handleThreadCreate = function(t) {
                    var e = t.channel;
                    if (e.isForumPost()) {
        ...
        854602: (t, e, n) => {
            ...
            function y(t) {
                var e = t.guildId,
                    ...
                    o = t.postIds,
                    a = t.additionalTimes;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_SEEN_BATCH, g(v({}, (0, _.xl)({
                    channelId: n,
                    sessionId: r
                })), {
                    guild_id: e,
            ...
            function E(t) {
                ...
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_SEARCHED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n,
            ...
            function m(t) {
                var e = t.guildId,
                    n = t.channelId;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_SEARCH_CLEARED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n
            ...
            function O(t) {
                var e = t.guildId,
                    ...
                    a = t.added,
                    u = t.location;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_TAG_FILTER_CLICKED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n,
            ...
            function S(t) {
                var e = t.guildId,
                    n = t.channelId;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_CREATE_NEW_POST_CLICKED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n
            ...
            function I(t) {
                var e = t.guildId,
                    n = t.channelId;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_CREATE_NEW_POST_KEYBIND_USED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n
            ...
            function C(t) {
                ...
                if (null != c) {
                    var d = u.Z.getThreadSettings(l),
                        ...
                        b = null == h || 0 === h.length || (null == h ? void 0 : h.trim()) === f,
                    ...
                    b && y && E || i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_NEW_POST_DRAFT_CREATED, g(v({}, (0, _.xl)({
                        channelId: l
                    })), {
                        guild_id: s,
                        channel_id: l,
            ...
            function T(t) {
                var e = t.guildId,
                    n = t.channelId;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_NEW_POST_DRAFT_CLEARED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n
            ...
            function A(t) {
                var e = t.guildId,
                    ...
                    r = t.postId,
                    o = function() {
                        i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_POST_CREATED, g(v({}, (0, _.n4)({
                            channelId: r
                        })), {
                            guild_id: e,
                            channel_id: n
            ...
            function M(t) {
                var e = t.guildId,
                    n = t.channelId;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_SCROLLED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n
            ...
            function P(t) {
                var e = t.guildId,
                    ...
                    u = t.filterTagIds,
                    l = t.sortOrder;
                s.default.track(p.rMx.FORUM_CHANNEL_MORE_POSTS_LOADED, g(v({}, (0, i.hH)(e), (0, i.v_)(a.Z.getChannel(n)), (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n,
            ...
            function w(t) {
                var e = t.guildId,
                    ...
                    r = t.postId,
                    o = t.location;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_POST_CLICKED, g(v({}, (0, _.n4)({
                    channelId: r
                })), {
                    guild_id: e,
                    channel_id: n,
            ...
            function R(t) {
                var e = t.guildId,
                    n = t.channelId,
                    r = t.sortOrder;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_POSTS_SORTED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n,
            ...
            function D(t) {
                ...
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_LAYOUT_UPDATED, g(v({}, (0, _.xl)({
                    channelId: n
                })), {
                    guild_id: e,
                    channel_id: n,
            ...
            function N(t) {
                var e = t.postId,
                    n = t.location;
                i.ZP.trackWithMetadata(p.rMx.FORUM_POST_LINK_COPIED, {
                    forum_post_id: e,
                    location: n
                })
            }
            ...
            function Z(t) {
                ...
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_ONBOARDING_CLICKED, {
            ...
            function L(t) {
                var e = t.forumDemoId;
                i.ZP.trackWithMetadata(p.rMx.FORUM_UPSELL_MODAL_CLICKED, {
                    forum_demo_id: e
                })
            }
            ...
            function j(t) {
                var e = t.added;
                i.ZP.trackWithMetadata(p.rMx.FORUM_ADD_MEDIA_TO_ORIGINAL_POST_CLICKED, {
                    added: e
                })
            }
            ...
            function U(t) {
                ...
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_HELPER_CARD_CLICKED, {
                    read_guide_cta: e
                })
            }
            ...
            function F(t) {
                var e = t.isMobile;
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_MEDIA_UPLOADER_CLICKED, {
                    is_mobile: e
                })
            }

            function x() {
                i.ZP.trackWithMetadata(p.rMx.FORUM_CHANNEL_ENABLE_AUTOMOD_CLICKED)
            }

            function H(t) {
                i.ZP.trackWithMetadata(p.rMx.CHANNEL_OPENED, g(v({}, (0, i.hH)(t.guild_id), (0, i.v_)(t), (0, o.K)(t, !0)), {
                    channel_id: t.id,
                    guild_id: t.guild_id,
            ...
            function k() {
                i.ZP.trackWithMetadata(p.rMx.OPEN_MODAL, {
            ...
            function G(t) {
                var e = t.guildId,
                    n = t.channelId;
                i.ZP.trackWithMetadata(p.rMx.THREAD_CREATION_STARTED, g(v({}, (0, o.K)(a.Z.getChannel(n))), {
                    channel_id: n,
                    guild_id: e
                }))
            }
        ...
        734901: (t, e, n) => {
            ...
            function j(t) {
                ...
                var _, b, v = l.Z.getChannel(h.parent_id);
                return null != v && v.isForumLikeChannel() ? I(function(t) {
                    ...
                    thread_auto_archive_duration_minutes: null !== (b = null === (r = h.threadMetadata) || void 0 === r ? void 0 : r.autoArchiveDuration) && void 0 !== b ? b : 0,
                    ...
                    forum_post_is_new: null === (o = p.Z.getReadStateSnapshotAnalytics(h.id)) || void 0 === o ? void 0 : o.isNew,
                    forum_post_is_unread: null === (c = p.Z.getReadStateSnapshotAnalytics(h.id)) || void 0 === c ? void 0 : c.hasUnreads,
                    forum_post_is_following: a.Z.hasJoined(h.id),
                    forum_post_attachment_mimetypes: Z(h.id)
                }) : null
            }
        },
        883069: (t, e, n) => {
        ...
        512291: (t, e, n) => {
            ...
            var v = function() {
                    ...
                    e.subscribeUser = function(t, e) {
                        b(t) && this._members.subscribe(t, e)
                    };
                    e.unsubscribeUser = function(t, e) {
                        b(t) && this._members.unsubscribe(t, e)
                    };
                    e.subscribeChannel = function(t, e, n) {
                        return !!b(t) && this._channels.subscribe(t, e, n)
                    };
                    e.subscribeThreadMemberList = function(t, e, n) {
                        return !!b(t) && this._threadMemberLists.subscribe(t, e, n)
                    };
                    e.unsubscribeThreadMemberList = function(t, e) {
                        return !!b(t) && this._threadMemberLists.unsubscribe(t, e)
                    };
            ...
            function x(t, e) {
                F.forEach((function(n) {
                    var r;
                    if (n !== M.Z.getGuildId() && n !== C.Z.getGuildId() && n !== (null === (r = m.Z.getChannel(A.Z.getChannelId())) || void 0 === r ? void 0 : r.getGuildId()) && (null == L || L.guildId !== n)) {
            ...
            function z() {
                ...
                if (null == t) {
                    if (null != L) {
                        F.unsubscribeUser(L.guildId, L.userId);
                        L = null
                    }
                } else {
                    var e = t.userId;
                    if (null != L && L.userId === e) return !1;

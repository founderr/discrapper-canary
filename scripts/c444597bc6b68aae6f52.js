        ...
        531674: function(e, t, n) {
            ...
            function M(e, t) {
                ...
                let m = g.default.Messages.MUTE_CHANNEL_GENERIC,
                    S = g.default.Messages.UNMUTE_CHANNEL_GENERIC;
                switch (e.type) {
                    case h.ChannelTypes.GUILD_CATEGORY:
                        m = g.default.Messages.MUTE_CATEGORY, S = g.default.Messages.UNMUTE_CATEGORY;
                        break;
                    case h.ChannelTypes.GROUP_DM:
                        m = g.default.Messages.MUTE_CONVERSATION, S = g.default.Messages.UNMUTE_CONVERSATION;
                        break;
                    case h.ChannelTypes.DM:
                        m = g.default.Messages.MUTE_CHANNEL.format({
                            name: E
                        }), S = g.default.Messages.UNMUTE_CHANNEL.format({
                            name: E
                        });
                        break;
                    default:
                        m = g.default.Messages.MUTE_CHANNEL_GENERIC, S = g.default.Messages.UNMUTE_CHANNEL_GENERIC
                }
        ...
        374705: function(e, t, n) {
            ...
            function L(e) {
                let {
                    ...
                    onSelect: s,
                    hideSettings: d
                } = e, o = t.id, L = _.default.getDefaultChannel(o), O = (0, h.useExpressionSourceGuildDataForGuildLeaveModal)(t), b = (0, r.useStateFromStores)([p.default], () => {
                    ...
                    channel: L
                }), H = (0, A.default)(o), G = (0, N.default)(t), y = (0, v.default)(t), D = (0, T.default)(t), w = (0, m.default)({
                    guildId: t.id,
                ...
                }), P = (0, S.default)(t), V = (0, f.default)(t.id), F = (0, c.default)({
                    id: t.id,
                    label: x.default.Messages.COPY_ID_GUILD
                }), B = (0, I.default)(t, {
                    section: U.AnalyticsSections.GUILD_LIST
                }), k = (0, E.default)(t.id), Z = (0, C.default)(t), Y = t.hasFeature(U.GuildFeatures.HUB);
                ...
                return Y ? (0, l.jsxs)(u.Menu, {
                    ...
                    children: [(0, l.jsx)(u.MenuGroup, {
                        ...
                        children: [d ? null : D, __OVERLAY__ ? null : (0, l.jsx)(u.MenuItem, {
                            id: "privacy",
                        ...
                        children: [Z, !b && (0, l.jsx)(u.MenuItem, {
                            id: "leave-guild",
        ...
        527660: function(e, t, n) {
            ...
            function p(e) {
                ...
                let M = function(e) {
                        ...
                        }), [e.id]), C = m === h.HighlightSettings.DISABLED, I = (0, i.default)(e.id), N = (0, o.useGuildUnreadsExperiment)();
                        ...
                        return (0, l.jsxs)(l.Fragment, {
                            children: [(0, l.jsx)(r.MenuGroup, {
                                ...
                                children: [N && (0, l.jsx)(r.MenuCheckboxItem, {
                                    ...
                                    action: () => {
                                        (0, d.setGuildUnreadSetting)(e.id, !S)
                                    },
                                    checked: S
                                    ...
                                    action: () => {
                                        v({
                                            notify_highlights: C ? h.HighlightSettings.ENABLED : h.HighlightSettings.DISABLED
                                        })
                                    },
                                    checked: C
                                }), I]
                    ...
                    S = null === (p = _()) || void 0 === p ? void 0 : null === (t = p.find(e => {
                        let {
                            setting: t
                        } = e;
                        return t === m
        ...
        676143: function(e, t, n) {
            ...
            function R(e, t, n, s) {
                ...
                let r = (0, E.useCanSeeOnboardingHome)(e),
                    u = l.useCallback((e, t) => !(r && e.channel.hasFlag(I.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) && e.channel.type !== C.ChannelTypes.GUILD_DIRECTORY && (0 === t.length || a(t, e.channel.name.toLowerCase()) || e.channel.topic.toLowerCase().includes(t)), [r]);
                return l.useMemo(() => {
                    let e = {
                        null: [],
                        _categories: []
            ...
            function x(e, t) {
                ...
                }))), null != n && (0, p.transitionTo)(C.Routes.CHANNEL(e, n))
            }
            ...
            function b(e) {
                ...
                return T.default.Messages.CHANNEL_BROWSER_ACTIVE_TEXT.format({
                    timeAgo: u(i.default.extractTimestamp(null !== (t = S.default.lastMessageId(e)) && void 0 !== t ? t : e)).fromNow()
                })
            }
        },
                ...
                renderUsers() {
                    ...
                    for (; d < u && d < e.length;) {
                        ...
                        r.push(t ? (0, l.jsx)("div", {
                            ...
                            children: u
                        }, m(null !== (o = e[d]) && void 0 !== o ? o : null, d)) : (0, l.jsx)(_.default, {
                ...
                render() {
                    ...
                    return (0, l.jsx)(d.Popout, {
                        ...
                        children: n => (0, l.jsxs)("div", {
                            className: r(e, p.container, function() {

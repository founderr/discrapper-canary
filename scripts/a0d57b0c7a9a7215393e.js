    ...
    ["93181"], {
        ...
        822516: function(e, t, n) {
            ...
            function A(e) {
                let t = function(e) {
                    ...
                    return null !== (t = p(1, n, new Date)[0]) && void 0 !== t ? t : null
                }(e);
        ...
        844808: function(e, t, n) {
            ...
            function f(e) {
                ...
                }(t), _ = e => e.toString(), g = (0, l.jsxs)("div", {
                    className: d.title,
        ...
        813934: function(e, t, n) {
            ...
            function y(e) {
                ...
                let {
                    ...
                    defaultOptions: H,
                    isSlideReady: Y = !0
                } = e, F = a.useMemo(() => C.default.getStageInstanceByChannel(M.id), [M.id]), [Z, W] = a.useState(null !== (n = null !== (t = null == H ? void 0 : H.topic) && void 0 !== t ? t : null == F ? void 0 : F.topic) && void 0 !== n ? n : ""), [K, q] = a.useState(null !== (r = null == H ? void 0 : H.description) && void 0 !== r ? r : ""), [z] = a.useState(b), [X, J] = a.useState(null !== (_ = null == H ? void 0 : H.schedule) && void 0 !== _ ? _ : {
                    startDate: (0, d.getInitialEventStartDate)()
                }), [Q, $] = a.useState(z && (null == H ? void 0 : H.schedule) != null), ee = (0, N.useCanSendStageStartNotification)(M), et = (0, N.useDefaultSendStartStageNotificationToggle)(M), en = null == F && ee && !z, [el, ea] = a.useState(en && et), er = (0, i.useStateFromStores)([h.default], () => h.default.hasHotspot(p.HotspotLocations.LIVE_STAGE_NOTIFICATION_BADGE)), es = R.GuildScheduledEventPrivacyLevel.GUILD_ONLY, [ei] = a.useState(null !== (S = null !== (g = null == H ? void 0 : H.privacyLevel) && void 0 !== g ? g : null == F ? void 0 : F.privacy_level) && void 0 !== S ? S : es), [eu, eo] = a.useState(null == H ? void 0 : H.recurrenceRule), ec = (0, T.useStageBlockedUsersCount)(M.id), [ed, ef] = a.useState(!1), eE = (0, o.default)(M), eh = (0, c.useChannelsUserCanStartStageIn)(O), e_ = null != U, eg = eh.length > 1;
                a.useEffect(() => {
                ...
                } : j === R.GuildScheduledEventPrivacyLevel.PUBLIC && (null == y ? void 0 : y.privacy_level) !== R.GuildScheduledEventPrivacyLevel.PUBLIC ? {
                    color: u.Button.Colors.BRAND,
                    ...
                    children: [(0, l.jsxs)(u.ModalContent, {
                        ...
                        children: [w, (0, l.jsx)("div", {
                            ...
                            children: [(0, l.jsxs)(u.FormItem, {
                                title: b ? A.default.Messages.GUILD_EVENT_CREATE_TOPIC_LABEL : A.default.Messages.START_STAGE_CHANNEL_EVENT_MODAL_TOPIC_LABEL,

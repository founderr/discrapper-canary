(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [62718, 38479, 75313, 25171, 64441, 72935, 96043, 56620, 17363], {
        652411: (e, t, n) => {
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            return new h(v(e.minValue, e.maxValue), v(e.minStart, e.maxStart), v(e.minFinal, e.maxFinal), v(e.minDuration, e.maxDuration), g(e.minDirection, e.maxDirection), T(e.easingFunctions)[0])
                    }
                }(_(_({}, e), {
                    valueType: "number"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "linear-random":
                            ...
                            var o = m(e.minAddValue),
                                l = m(e.maxAddValue);
                            return new E(new b(v(n.x, r.x), v(o.x, l.x)), new b(v(n.y, r.y), v(o.x, l.x)));
                        case "oscillating":
                            t = m(e.value);
                            var u = m(e.start),
                                c = m(e.final),
                                a = m(e.duration),
                                s = m(e.direction);
                            return new E(new h(t.x, u.x, c.x, a.x, s.x, e.easingFunction), new h(t.y, u.y, c.y, a.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var f = m(e.minStart),
                                p = m(e.maxStart),
                                ...
                                S = m(e.minDirection),
                                A = m(e.maxDirection);
                            return new E(new h(v(n.x, r.x), v(f.x, p.x), v(d.x, _.x), v(O.x, I.x), g(S.x, A.x), T(e.easingFunctions)[0]), new h(v(n.y, r.y), v(f.y, p.y), v(d.y, _.y), v(O.y, I.y), g(S.y, A.y), T(e.easingFunctions)[0]))
                    }
                }(_(_({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = S(e.minValue),
                                r = S(e.maxValue);
                            return new I(new y(v(n.x, r.x)), new y(v(n.y, r.y)), new y(v(n.z, r.z)));
                        case "linear":
                            t = S(e.value);
                            var i = S(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = S(e.minAddValue),
                                l = S(e.maxAddValue);
                            return new I(new b(v(n.x, r.x), v(o.x, l.x)), new b(v(n.y, r.y), v(o.y, l.y)), new b(v(n.z, r.z), v(o.z, l.z)));
                        case "oscillating":
                            t = S(e.value);
                            var u = S(e.start),
                                c = S(e.final),
                                a = S(e.duration),
                                s = S(e.direction);
                            return new I(new h(t.x, u.x, c.x, a.x, s.x, e.easingFunction), new h(t.y, u.y, c.y, a.z, s.y, e.easingFunction), new h(t.z, u.z, c.z, a.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var f = S(e.minStart),
                                p = S(e.maxStart),
                                ...
                                m = S(e.minDirection),
                                A = S(e.maxDirection);
                            return new I(new h(v(n.x, r.x), v(f.x, p.x), v(d.x, _.x), v(O.x, E.x), g(m.x, A.x), T(e.easingFunctions)[0]), new h(v(n.y, r.y), v(f.y, p.y), v(d.y, _.y), v(O.y, E.y), g(m.y, A.y), T(e.easingFunctions)[0]), new h(v(n.z, r.z), v(f.z, p.z), v(d.z, _.z), v(O.z, E.z), g(m.z, A.z), T(e.easingFunctions)[0]))
                    }
                }(_(_({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var N = r.forwardRef((function(e, t) {
                    ...
                    v = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == d || d(t), I.current.size > 0 ? y.current = window.requestAnimationFrame(v) : (t.clearRect(0, 0, e.width, e.height), y.current = null);
                                var n = Date.now();
                                0 !== b.current && (h.current = 1e3 / (n - b.current)), b.current = n
                            }
                        }
                    }), [l, d, p]);
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", R, c), e("mousedown", N, a), e("mousemove", w, s), e("mouseup", L, f),
                        function() {
                ...
                }), [R, N, w, L, c, a, s, f]), r.useEffect((function() {
                    var e = E.current,
        ...
        393299: (e, t, n) => {
            ...
            function w(e) {
                var t = e.guild,
                    ...
                    o = (0, u.e7)([T.default, v.ZP], (function() {
            ...
            function M(e) {
                var t = e.guild,
                    n = e.isBannerVisible,
                    r = e.disableBoostClick;
                return (0, a.Z)(t) ? (0, i.jsx)(L, {
                    guild: t,
                    disableColor: !1,
                    disableBoostClick: r
                }) : t.hasFeature(d.oNc.VERIFIED) || t.hasFeature(d.oNc.PARTNERED) ? (0, i.jsx)(L, {
                    guild: t,
                    disableColor: !n
                }) : (0, i.jsx)(w, {
                    guild: t,
        ...
        338479: (e, t, n) => {
            ...
            function P(e) {
                var t = e.text,
                    ...
                    s = void 0 !== a && a;
                return (0, r.jsxs)("div", {
                    className: v()(s ? A().noticeWithoutRightPadding : A().noticeWithRightPadding, u),
                    children: [(0, r.jsxs)("div", {
            ...
            function x(e) {
                var t = e.type,
                    ...
                    o = e.isGIF,
                    l = e.banner;
                return [L.pC.BANNER, L.pC.AVATAR].includes(t) && o ? (0, r.jsx)(U, {
                    analyticsSection: i,
                    type: t
        ...
        63509: (e, t, n) => {
            ...
            function M(e) {
                ...
                if (null != t) {
                    ...
                    var o = (0, u.s)(r.getElementById(C));
        ...
        305082: (e, t, n) => {
            ...
            function A() {
                return e = S, t = m, n = h("useMemoizedValueSyncedWithDismissibleContents"), o = (0, i.e7)([c.Z], (function() {
                    var e;
            ...
            const M = function(e) {
                var t = function(e) {
                        ...
                        return (0, r.jsxs)(I.C, N(C({
                            ...
                            color: m === v.Si.TIER_1 ? u.Button.Colors.PRIMARY : u.Button.Colors.GREEN,
                            size: R,
                            className: Y,
                            wrapperClassName: M,
                            pauseAnimation: !J || V
                ...
                var ie = null != q && q.status !== T.O0b.ACCOUNT_HOLD && !(0, d.Q0)(q.planId) && !re,
                    oe = ie ? null != K ? K : function(e) {
                        ...
                        if (null != u && null != l && l < u) {
                            ...
                            i = g.Z.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP
                        } else null == o && null != n && n === v.p9.TIER_2 && (i = g.Z.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP);
                        return {
                            disabledButtonText: r,
                            disabledButtonTooltipText: i
                        }
        ...
        223219: (e, t, n) => {
            ...
            function j(e) {
                ...
                null != e.scrollPosition && null != h && (T[h] = e.scrollPosition);
            ...
            var x = function(e) {
                ...
                r.getProps = function() {
                    return {
                        ...
                        scrollPosition: null != h ? T[h] : null,
                        settings: S,
                        errors: g,
            ...
            const G = new x(l.Z, {
                ...
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete T[t] : null != h && delete T[h]
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    R = e.tab;
                    return null == h && R === c.cII.USER_SETTINGS && j({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        585798: (e, t, n) => {
            ...
            var v, T = (0, d.Mg)(s.Z.FULL_SCREEN_LAYER_ANIMATION_DURATION);
            ! function(e) {

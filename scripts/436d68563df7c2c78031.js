    ...
    ["27660"], {
        ...
        783480: function(e, t, n) {
            ...
            async function M(e) {
                ...
                let d, {
                    ...
                    x = new m.default(N.Endpoints.MESSAGES(f)),
                    P = new O.Future,
                    L = {
                        content: "",
                        nonce: "",
                ...
                let [B, k] = (0, S.default)(L.content);
                B && (L.content = k, L.flags = (0, C.addFlag)(null !== (t = L.flags) && void 0 !== t ? t : 0, N.MessageFlags.SUPPRESS_NOTIFICATIONS));
                let w = null !== (n = U.nonce) && void 0 !== n ? n : (0, E.createNonce)(),
                    F = (0, E.default)({
                        channelId: f,
                        content: L.content,
                ...
                return (L.nonce = w, x.on("start", e => {
                    ...
                    t !== N.AbortCodes.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS && (b ? P.reject(new u.APIError({
                        status: t,
                        body: null != n ? n : {}
                ...
                }), await x.uploadFiles(M, L), P.resolve(), P.promise
            }
            var y = {
        ...
        57155: function(e, t, n) {
            ...
            function Q(e) {
                ...
                let m = (0, j.useIsActiveChannelOrUnarchivableThread)(s),
            ...
            function et(e) {
                ...
                let E = (t = d, n = p, a.useMemo(() => {
                    ...
                    j = (0, f.useStateFromStores)([_.default], () => _.default.saturation),
                    x = (0, f.useStateFromStores)([U.default], () => (0, m.isThemeDark)(U.default.theme));
                if (a.useEffect(() => {
                        ...
                        children: [(0, i.jsx)(h.Scroller, {
                            ...
                            children: E.map(e => {
                                ...
                                return (0, i.jsx)(Z, {
                                    ...
                                    colors: null != e.burst_colors ? (0, S.buildEmojiColorPalette)(e.burst_colors, j, x) : void 0
        ...
        350134: function(e, t, n) {
            ...
            class eE extends a.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this.isReactionEventActive = !1, this.isKeyboardNavigation = !1, this.scale = new r.default.Value(1), this.opacity = new r.default.Value(1), this.timeout = new f.Timeout, this.hideTimeout = new f.Timeout, this.ctaRef = a.createRef(), this.type = $.ReactionTypes.NORMAL, this.colors = {
                        ...
                        return a && null != l ? (0, i.jsx)(j.default, {
                            ctaRef: this.ctaRef,
                            type: j.LurkerModeUpsellPopoutTypes.REACTIONS,
                            guild: l,
                            closePopout: t
                        }) : (0, i.jsx)(i.Fragment, {})
            ...
            let eT = a.memo(e => {
                    ...
                    return (0, i.jsx)(eE, {
                        ...
                        shouldShowFreeUserSentCoachmark: j,
                        onRenderFreeUserSentPopout: () => (0, i.jsx)(b.default, {}),
                        hasBurstShake: r,
                        hasBurstGlow: u,
                        animationStartPosition: U,
                ...
                e_ = e => {
                    ...
                    } = (0, c.useStateFromStoresObject)([A.default, w.default], () => {
                        let e = A.default.getCustomEmojiById(n);
                        return {
                            joinedEmojiSourceGuild: (null == e ? void 0 : e.type) === I.EmojiTypes.GUILD ? w.default.getGuild(null == e ? void 0 : e.guildId) : void 0
                        }
                    ...
                    }), C = S.autoUnfurlReactionTooltip, O = null !== (t = null == d ? void 0 : d.isDiscoverable()) && void 0 !== t && t, N = V.default.getGuildId(), v = null != N && (N === (null == d ? void 0 : d.id) || N === (null == u ? void 0 : u.id)), j = (0, ee.getEmojiPopoutData)({
                    ...
                    let b = () => {
                        ...
                        L = () => (0, i.jsxs)(i.Fragment, {
                            ...
                            }), null != j.emojiDescription && j.type !== ee.EmojiPopoutType.UNAVAILABLE && (0, i.jsx)(h.Text, {
                                variant: "text-sm/normal",
                                "aria-label": j.type,

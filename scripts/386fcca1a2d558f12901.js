/*! For license information please see 386fcca1a2d558f12901.js.LICENSE.txt */
"use strict";
    ...
    [55571], {
        470661: e => {
            e.exports = function(e) {
                ...
                b.test(e) ? e = e.substr(0, e.length - 2) : E.test(e) && (e = e.substr(0, e.length - 1));
                    ...
                    if (c !== O.evJ.EXPLICIT_CONTENT)
                        if (c !== O.evJ.AUTOMOD_MESSAGE_BLOCKED) {
                            if (c !== O.evJ.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS) {
                                ...
                                ! function() {
                                    "" !== P.content && "" === b.Z.getDraft(t, r) && o.Z.saveDraft(t, P.content, r);
            ...
            const D = {
                ...
                upload: function e(t) {
                    ...
                    _.on("error", (function(t, d) {
                        ...
                        if (d !== O.evJ.EXPLICIT_CONTENT) {
                            ...
                            "" !== f.content && "" === b.Z.getDraft(n, l) && o.Z.saveDraft(n, f.content, l)
                ...
                cancel: function(e) {
                    ...
                    if (null != e.draftContent && null != e.channelId) {
                        "" === b.Z.getDraft(e.channelId, b.d.ChannelMessage) && i.Z.dispatch({
                            type: "DRAFT_SAVE",
        ...
        234798: (e, t, n) => {
            ...
            function w(e, t) {
                if (!E.hasRequested(e.id, t)) {
                    var n = (0, l.U)(e.id),
                        r = n.findIndex((function(e) {
                            return e === t
                        })),
                        i = n.slice(r, r + 5).filter((function(t) {
                            return !E.hasRequested(e.id, t)
                        }));
                    T(e, i)
                }
            }
                ...
                return (R = _((function() {
                    return m(this, (function(e) {
                        switch (e.label) {
                            case 0:
                                e.trys.push([0, , 3, 4]);
                                return E.hasNext() ? [4, P(E.next())] : [3, 2];
                            case 1:
                                e.sent();
                                return [3, 0];
                            case 2:
        ...
        926578: (e, t, n) => {
            ...
            const S = new T(i.Z, {
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    e.message.channel_id === e.message.id ? b(e.message.channel_id, null) : b(e.message.channel_id, e.message)
                },
                ...
                LOAD_FORUM_POSTS: function(e) {
                    var t = e.threads;
                    for (var n in t) b(n, t[n].most_recent_message)
                },
            ...
            function D(e) {
                var t, n = e.threadId,
                    ...
                    F = (0, o.e7)([p.Z], (function() {
                        return p.Z.getGuild(null == C ? void 0 : C.getGuildId())
                    }), [C]),
                    U = (0, o.e7)([f.Z], (function() {
                        return f.Z.getChannel(null == C ? void 0 : C.parent_id)
                    }), [C]),
                    Z = null === (t = T[0]) || void 0 === t ? void 0 : t.item,
                    N = M(i.useState(null), 2),
                    j = N[0],
                    x = N[1];
        ...
        15084: (e, t, n) => {
            ...
            function b(e, t) {
                var n = f.default.getCurrentUser(),
                    ...
                    I = void 0;
                try {
                    for (var O, A = t[Symbol.iterator](); !(b = (O = A.next()).done); b = !0) {
                        var T = O.value;
                        c += 1;
                        u += T.size;
                        o.push(T.size);
                ...
                if (l > i) {
                    ...
                    title: E.Z.Messages.UPLOAD_AREA_TOO_LARGE_TITLE,
                    help: E.Z.Messages.UPLOAD_AREA_REQUEST_LIMIT_HELP.format({
                        maxSize: p.Ng(p.OC())
                    })
                })
            }
            ...
            function g(e, t, n) {
                ...
                if (!(e.length < 1)) {
                    ...
                    if ((0,
                        ...
                        (0, a.openUploadError)({
                            title: E.Z.Messages.ATTACHMENT_TOO_MANY_ERROR_TITLE,
                            help: E.Z.Messages.ATTACHMENT_TOO_MANY_ERROR_MESSAGE.format({
                                limit: y.dN1
                            })
                        });
...
//# sourceMappingURL=386fcca1a2d558f12901.js.map
    ...
    ["71780"], {
        ...
        462998: function(e, t, l) {
            ...
            function y(e) {
                ...
                } = e, F = (0, s.useStateFromStores)([S.default], () => S.default.getChannel(t)), w = (0, s.useStateFromStores)([_.default], () => _.default.getGuild(null == F ? void 0 : F.getGuildId())), U = (0, s.useStateFromStores)([A.default], () => A.default.getCurrentUser()), k = (0, s.useStateFromStores)([I.default], () => I.default.didAgree(null == F ? void 0 : F.guild_id)), G = (null == U ? void 0 : U.nsfwAllowed) === !0, P = (0, j.default)(F), W = (0, s.useStateFromStores)([N.default], () => (null == w ? void 0 : w.id) != null && N.default.isLurking(w.id), [w]), z = (0, s.useStateFromStores)([v.default], () => v.default.can(L.Permissions.SEND_MESSAGES, F)), Y = (0, f.useHasPendingMemberAction)(null == w ? void 0 : w.id, null == F ? void 0 : F.id), V = (0, m.default)(t), Z = (0, s.useStateFromStores)([h.default], () => {
                    var e;
                    return null === (e = h.default.getResourceForChannel(null == w ? void 0 : w.id, t)) || void 0 === e ? void 0 : e.title
                }), X = a.useRef(!1);
                if (a.useEffect(() => {
                    ...
                    }, [F, B, z, Y]), null == F || null == w) return null;
                let q = [];
                ...
                }, "close")), !F.isNSFW() || G && k) ? (0, n.jsxs)(n.Fragment, {
        ...
        469421: function(e, t, l) {
            ...
            function N(e) {
                let t = (0, i.useStateFromStores)([f.default], () => {
                    var t;
                    return null !== (t = f.default.getPendingResponseOptions(e)) && void 0 !== t ? t : x
                }, [e]);
                    ...
                    let a = f.default.getOnboardingResponses(e),
                        ...
                        }(t, l, n, a),
                        {
                            ...
                            if (o.singleSelect && h) {
                                ...
                                C = s.difference(null !== (t = u.channelIds) && void 0 !== t ? t : [], null !== (l = null == e ? void 0 : e.channelIds) && void 0 !== l ? l : []), x = s.difference(null !== (n = null == e ? void 0 : e.channelIds) && void 0 !== n ? n : [], null !== (a = u.channelIds) && void 0 !== a ? a : [])
                            } else if (h) C = null !== (i = u.channelIds) && void 0 !== i ? i : [], x = [];
                            else {
                        ...
                        g = x.reduce((t, l) => {
                            let n = o.default.getGuildChannelFlags(e, l);
                            return t[l] = {
        ...
        534702: function(e, t, l) {
            ...
            function B(e) {
                ...
                let f = (0, d.useStateFromStores)([I.default], () => I.default.getLastSelectedChannelId(t)),
                    ...
                    T = (0, d.useStateFromStores)([N.default], () => N.default.getNewChannelIds(t).size > 0),
                ...
                return null == s ? null : (0, n.jsxs)(n.Fragment, {
                    ...
                    }), g && (0, n.jsx)(x.ChannelBrowserSidebar, {
                        channelId: m
                    })]
                })
            }
        ...
        961727: function(e, t, l) {
            ...
            function et(e) {
                ...
                let {
                    ...
                    animateOnHover: !h
                }), C = (0, c.useStateFromStores)([O.default], () => O.default.getSelfMember(l.id)), x = (0, c.useStateFromStoresArray)([O.default], () => O.default.getMemberRoleWithPendingUpdates(l.id, s.id)), N = r(x).filter(e => l.roles.hasOwnProperty(e)).map(e => l.roles[e]).orderBy("position", "desc").value(), S = (0, v.default)(s.id, l.id);
                a.useEffect(() => {
            ...
            function el(e) {
                ...
                let {
                    prompt: l,
                    guild: s
                } = e, [d, r] = a.useState(null), [u, f] = a.useState(new Set), C = null == l ? void 0 : null === (t = l.options) || void 0 === t ? void 0 : t.filter(e => u.has(e.id)), x = (0, w.getSelectedRoleIds)(C), N = (0, w.getSelectedChannelIds)(C), g = (0, c.useStateFromStoresArray)([F.default], () => F.default.getOnboardingResponsesForPrompt(s.id, l.id)), {
                    helpText: p,
            ...
            function ea(e) {
                let {
                    guildId: t,
                    onBrowseChannels: l
                } = e, s = (0, f.isThemeDark)((0, N.default)()), d = (0, c.useStateFromStores)([R.default], () => R.default.getGuild(t)), r = (0, c.useStateFromStores)([b.default], () => b.default.getCurrentUser()), o = (0, x.default)("(min-width: 1344px)") && null != r, u = a.useCallback(() => {
                ...
                a.useEffect(() => {
                    if ((null == d ? void 0 : d.id) != null) !E.default.isFullServerPreview(d.id) && (F.default.shouldFetchPrompts(d.id) || h) && (0, H.fetchOnboardingPrompts)(d.id)
        ...
        724268: function(e, t, l) {
            ...
            var n = l("37983"),
                ...
                L = l("782340"),
                M = l("360330");
            let D = new Set([j.ChannelTypes.GUILD_FORUM, j.ChannelTypes.GUILD_MEDIA]),
                y = new Set([j.ChannelTypes.GUILD_VOICE, j.ChannelTypes.GUILD_STAGE_VOICE]);
            ...
            function B(e) {
                let {
                    ...
                    channel: a,
                    onCategoryClick: s
                } = e, d = (0, O.useIsChecked)(t.id, a.id, a.id), r = (0, O.useIsDisabled)(t.id, a.id, a.id);
                return (0, n.jsxs)("div", {
                    className: i(M.categoryRow, {
                        [M.uncategorized]: "null" === a.id
                    }),
                    onContextMenu: e => {
                    ...
                    children: [(0, n.jsx)(u.Text, {
                        ...
                        children: [(0, n.jsx)(u.Checkbox, {
                            ...
                            color: "text-muted",
                            variant: "text-xs/medium",
                            children: L.default.Messages.CHANNEL_BROWSER_SELECT_ALL
                        })]
                    })]
                })
            }
            let H = a.memo(function() {
                ...
                w = a.memo(function(e) {
                    let {
                    ...
                    } = (0, m.default)(t.id), w = (0, O.useIsChecked)(s.id, t.id, a.id), U = (0, O.useIsDisabled)(s.id, t.id, a.id), k = (0, O.useDisabledTooltip)(s.id, a.id), G = (0, d.useStateFromStores)([I.default], () => I.default.getActiveThreadCount(s.id, t.id)), P = (0, d.useStateFromStores)([h.default], () => h.default.getHighlightedMessageIdCount(t.id)), W = (0, d.useStateFromStores)([g.default], () => g.default.shouldIndicateNewChannel(s.id, t.id)), z = e => {
                        if (!U) return e.stopPropagation(), A(s.id, t.id, a.id), !0
                    }, Y = e => {
                        ...
                        let a = [];
                        return l > 0 && a.push((0, n.jsx)(u.Text, {
                            variant: "text-xs/medium",
                            className: M.channelSubtitle,
                            color: "text-brand",
                            children: L.default.Messages.CHANNEL_HIGHLIGHTS_COUNT.format({
                                count: l
                            })
                        }, "thread-count")), j.ChannelTypesSets.GUILD_THREADS_ONLY.has(e.type) && t >= 1 && a.push((0, n.jsx)(u.Text, {
                            variant: "text-xs/normal",
                            className: M.channelSubtitle,
                            children: L.default.Messages.ACTIVE_FORUM_POST_COUNT.format({
                                count: t
                            })
                        }, "thread-count")), !y.has(e.type) && a.push((0, n.jsx)(u.Text, {
                            variant: "text-xs/normal",
                            className: M.channelSubtitle,
                            children: (0, v.getActiveAgoTimestamp)(e.id)
                        }, "active")), null != e.topic && e.topic.length > 0 && a.push((0, n.jsx)(_.default, {
                            children: (0, n.jsx)(u.Text, {
                                className: M.topic,
                                variant: "text-xs/normal",
                        ...
                        }, "topic")), [a.map((e, t) => [e, (0, n.jsx)(F, {
                            index: t
                        }, "subtitle-separator-".concat(t))])].flat(2).slice(0, -1)
                    }(t, G, P), Z = e => (e.stopPropagation(), D.has(t.type) || e.shiftKey) ? ((0, p.transitionToGuild)(s.id, t.id), !0) : t.isGuildStageVoice() || t.isGuildVoice() ? ((0, E.connectAndOpen)(t), !0) : (S.default.openChannelAsSidebar({
                        guildId: t.guild_id,
                        channelId: t.id,
                        baseChannelId: b.StaticChannelRoute.CHANNEL_BROWSER
                    }), !0), X = L.default.Messages.CHANNEL_BROWSER_VIEW;
                    t.isGuildStageVoice() || t.isGuildVoice() ? X = L.default.Messages.JOIN : t.isForumLikeChannel() && (X = L.default.Messages.OPEN);
                    let q = U ? "text-muted" : "text-normal",
                        K = (0, u.useToken)(U ? o.default.colors.TEXT_MUTED : o.default.colors.TEXT_NORMAL).hex();
                            ...
                            children: e => (0, n.jsxs)(u.Clickable, {
                                ...
                                children: [(0, n.jsxs)("div", {
                                    ...
                                    children: [(0, n.jsxs)("div", {
                                        ...
                                        children: [(0, n.jsx)(x.ChannelItemIcon, {
                                            channel: t,
                                            guild: s
                                        }), (0, n.jsx)(_.default, {
                                            className: M.name,
                                        ...
                                        }) : null, W ? (0, n.jsx)(T.TextBadge, {
                                            text: L.default.Messages.NEW,
                                            color: o.default.unsafe_rawColors.BRAND_260.css,
                                            className: M.titleBadge
                                        }) : null]
                                    }), (0, n.jsx)("div", {
                                        className: M.channelSubtitles,
                                        children: V
                                    })]
                                }), (0, n.jsxs)("div", {
                                    className: M.channelActions,
                                    children: [(0, n.jsx)(u.Button, {
                                        look: u.ButtonLooks.OUTLINED,
                                        color: u.ButtonColors.PRIMARY,
                                        size: u.ButtonSizes.SMALL,
                                        className: M.viewChannelButton,
                                        onClick: Z,
                                        children: X
                                    }), (0, n.jsx)(u.Checkbox, {
                                        "aria-checked": w,
                                        ...
                                        type: u.Checkbox.Types.INVERTED,
                                        disabled: U,
                                        innerClassName: M.checkboxInner,
                                        displayOnly: !0
                                    })]
                                })]
                            })
            ...
            function U(e) {
                let {
                    ...
                    onChannelClick: c
                } = (0, A.default)(l.id), h = (0, f.useIsDismissibleContentDismissed)(r.DismissibleContent.CHANNEL_BROWSER_NUX), m = h ? 0 : -1, C = a.useCallback(e => {
                    let {
                        section: a
                    } = e;
                ...
                }, [t, l, m, c]), x = a.useCallback(e => {
                    let {
                        section: a,
                        row: s
                    } = e;
                    if (0 === a && -1 === m) return (0, n.jsx)(R.default, {
                        guild: l
                    });
                    let i = t._categories[a + m],
                        d = t[i.channel.id][s];
                    return null == d ? null : (0, n.jsx)(w, {
                        category: i.channel,
                        channel: d.channel,
                        guild: l,
                        isFirstChannel: 0 === s,
                ...
                }, [t, l, m, o, c]), N = (0, R.useNuxCardHeight)(l.id), g = (0, v.useChannelBrowserSections)(l.id, t, 64, N);
                return (0, n.jsx)(u.ListAuto, {
                    className: s,
                    innerClassName: i(d, M.scrollerInner),
                    sectionHeight: 48,

            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(l, u) {
                        ...
                        var a, s, c, d, f, p, E, h, _, g, I, m, C, v, S, T, R = (a = l, f = Array(32768), a.forEach(function(n) {
                        ...
                        var M = (p = l, E = R, I = 1e6, m = 0, C = 1e6, v = 0, S = 1e6, T = 0, p.forEach(function(t) {
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: o,
                        round: l
                    } = Math, u = e[0] | e[1] << 8 | e[2] << 16, a = e[3] | e[4] << 8, s = (63 & u) / 63, c = (u >> 6 & 63) / 31.5 - 1, d = (u >> 12 & 63) / 31.5 - 1, f = u >> 23, p = a >> 15, E = i(3, p ? f ? 5 : 7 : 7 & a), h = i(3, p ? 7 & a : f ? 5 : 7), _ = f ? (15 & e[5]) / 15 : 1, g = (e[5] >> 4) / 15, I = f ? 6 : 5, m = 0, C = (t, n, r) => {
                        let i = [];
                        for (let o = 0; o < n; o++)
                            for (let l = o ? 0 : 1; l * n < t * (n - o); l++) i.push(((e[I + (m >> 1)] >> ((1 & m++) << 2) & 15) / 7.5 - 1) * r);
                        return i
                    ...
                    for (let e = 0, r = 0; e < b; e++)
                        for (let l = 0; l < M; l++, r += 4) {
                            ...
                            let I = u - 2 / 3 * a,
                                m = (3 * u - I + p) / 2,
                                C = m - p;
                            N[r] = i(0, 255 * n(1, m)), N[r + 1] = i(0, 255 * n(1, C)), N[r + 2] = i(0, 255 * n(1, I)), N[r + 3] = i(0, 255 * n(1, g))
                        }
                    return {
                        w: M,
                        h: b,
        ...
        181114: function(e, t, n) {
            ...
            let g = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...g
                } = e, I = l.createRef(), m = (0, d.default)(I), C = !r && !i && !0 !== u && (!h || m);

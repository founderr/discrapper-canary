                ...
                T = (e, t) => {
                    ...
                    switch (e) {
                        ...
                        case d.AutomodActionType.BLOCK_MESSAGE:
                            return null;
                        case d.AutomodActionType.FLAG_TO_CHANNEL: {
                            let e = null == t ? void 0 : null === (l = t.metadata) || void 0 === l ? void 0 : l.channelId;
                            if (null == e) return null;
                            let s = r.default.getChannel(e);
                            if (null == s) return null;
                            let u = (0, n.computeChannelName)(s, o.default, a.default);
                            return L.default.Messages.GUILD_AUTOMOD_ACTIONS_FLAG_TO_CHANNEL_DISPLAY_HELPER.format({
                                channelName: u
                            })
                        }
                        case d.AutomodActionType.USER_COMMUNICATION_DISABLED: {
                            let e = null !== (u = null == t ? void 0 : null === (s = t.metadata) || void 0 === s ? void 0 : s.durationSeconds) && void 0 !== u ? u : 0,
            ...
            var r = l("469563"),
                ...
                s = (0, r.replaceIcon)(function(e) {
                    ...
                    return (0, n.jsxs)("svg", {
                        ...
                        height: l,
                        viewBox: "0 0 14 14",
                        children: [null != s ? (0, n.jsx)("circle", {
                            r: 5,
                            cx: 7,
                            cy: 7,
                            fill: s

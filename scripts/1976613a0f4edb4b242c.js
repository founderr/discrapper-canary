    ...
    ["35389"], {
        ...
        570687: function(e, t, n) {
            ...
            function W(e) {
                let {
                    ...
                    animateOnHover: !(s || G)
                }), q = (0, f.useStateFromStores)([R.default], () => R.default.isChannelMuted(t.getGuildId(), t.id)), J = (0, f.useStateFromStores)([L.default], () => L.default.getMentionCount(t.id) > 0), $ = (0, _.default)(t), ee = (0, f.useStateFromStores)([S.default], () => S.default.isFavorite(t.id)), et = () => {
                    K(!0)
                }, en = () => {
                    K(!1)
                }, el = function(e) {
        ...
        951039: function(e, t, n) {
            ...
            function h(e) {
                let {
                    isActive: t
                } = e, [n, h, C] = (0, a.useStateFromStoresArray)([i.default, u.default], () => [u.default.getCurrentDesktopIcon(), u.default.isEditorOpen, o.default.isPremium(i.default.getCurrentUser())]), p = f.ICONS_BY_ID[n], m = n !== d.FreemiumAppIconIds.DEFAULT && (C || h), E = (0, s.useRedesignIconContext)().enabled, g = (0, l.jsx)(r.default, {
                    width: 30,
                    height: E ? 30 : 22
                });
                return t && null != p && m ? (0, l.jsx)(c.default, {
                    id: n,
                    width: 48
                }) : g
            }
            ...
            function M(e) {
                ...
                if (f || c)
                    for (let e = E.length - 1; e >= 0; e--) {
                        let t = E[e];
                        (v(t.id) || i.some(t.threadIds, v)) && (null == o && (o = t.id), T = !0), (R(t.id) || i.some(t.threadIds, R)) && (null == r && (r = t.id), I += p.default.getMentionCount(t.id) + i.sumBy(t.threadIds, p.default.getMentionCount))
                    }
                if (f || c)
                        ...
                        switch (T.type) {
                            ...
                            case ei.ChannelTypes.GUILD_STAGE_VOICE:
                                ...
                                return (0, l.jsx)(q.default, {
                                    ...
                                    voiceStates: null !== (v = f[I.id]) && void 0 !== v ? v : [],
                                    speakerVoiceStates: null !== (R = C[I.id]) && void 0 !== R ? R : [],
                                    disableManageChannels: h,
                                    isFavoriteCategory: N
                                }, L);
        ...
        37416: function(e, t, n) {
            ...
            class q extends V.default {
                ...
                render() {
                    ...
                    return _ && (M = C(M)), g && (M = f(h(M))), S && (M = (0, l.jsx)(O.default, {
            ...
            function $(e) {
                ...
                }), m = (0, i.useStateFromStores)([w.default], () => w.default.hasVideo(s.id)), g = (0, h.default)(s), _ = (0, E.default)(s), I = (0, A.useActiveEvent)(s.id), {
        ...
        199334: function(e, t, n) {
            ...
            function _(e) {
                let {
                    ...
                    subtitle: _,
                    onClick: S
                } = e, I = (0, r.useStateFromStores)([u.default], () => u.default.getChannelStatus(t)), N = null != I && I.length > 0, T = (0, r.useStateFromStores)([c.default], () => c.default.can(p.Permissions.SET_VOICE_CHANNEL_STATUS, t)), A = null != _ && _.length > 0;
                a.useEffect(() => {
                ...
                if (N) return (0, l.jsx)(o.Clickable, {
                    ...
                    children: (0, l.jsx)(o.Text, {
                        ...
                        children: (0, l.jsx)(f.default, {
                            children: d.default.parseVoiceChannelStatus(I, !0, {
                                channelId: t.id
                            })
                        })
                    })
        ...
        21841: function(e, t, n) {
            ...
            function _(e) {
                ...
                let _ = (0, s.useStateFromStores)([m.default], () => m.default.isMuted(e)),
                    ...
                    B = !1,
                    V = !1;
                return R ? (U = !0, P = (null == N ? void 0 : N.channel_id) === v, w = T, F = R && D, B = x, V = G) : !_ && (U = O, P = null != N, w = I, F = y, B = b, V = j), l.useMemo(() => ({
                    audio: U,
                    video: F,
                    screenshare: B,
                    liveStage: w,
        ...
        798573: function(e, t, n) {
            ...
            function W(e) {
                let {
                    ...
                    link: p,
                    showProgressBadge: m
                } = e, S = (0, i.useStateFromStores)([c.default], () => c.default.isEditorOpen), [I, N] = a.useState(!1), [A, L] = a.useState(!1), [v, R] = a.useState(null), [x, M] = a.useState(0), [O, G] = a.useState(!1), {
                    canViewBroadcasts: P
        ...
        189771: function(e, t, n) {
            ...
            function O(e, t, n) {
                ...
                let i = n.getGuildId();
                return !(null != i && s.default.isLurking(i) || t.id === e.id || E.default.isBlocked(t.id) || !l && S.default.getStatus() === R.StatusTypes.DND || !a && I.default.allowNoMessages(n)) && !0
            }
            ...
            function D(e, t) {
                ...
                return !(null == a || null == s || null == i || a.isManaged() || i.hasFlag(R.UserFlags.SPAMMER) || E.default.isBlocked(i.id) || i.id === s.id || S.default.getStatus() === R.StatusTypes.DND || I.default.allowNoMessages(a)) && !0
            }

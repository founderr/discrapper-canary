    ...
    [35457, 81580, 1459], {
        ...
        496916: (e, t, n) => {
            ...
            function E(e) {
                ...
                }(e.id, !0, !0) : e.isForumLikeChannel() ? f(e.id, !0, !0, r.default.fromTimestamp(Date.now())) : f(e.id, !0, !0)
            }
        ...
        77413: (e, t, n) => {
            ...
            var b = function(e) {
                ...
                o.render = function() {
                    ...
                    return (0, i.createElement)("img", m(R(m(R(m({}, f), {
                        key: this.key,
                        src: E,
                        ...
                        return O(this, (function(y) {
                            switch (y.label) {
                                ...
                                case 3:
                                    ...
                                    if (!R && !A && (0, f._)(t)) return [2, new Promise((function(o) {
                                        var a = e;
        ...
        866893: (e, t, n) => {
            ...
            function H(e) {
                return function(t, n) {
                    return (0, p.yv)(t) ? -1 : (0, p.yv)(n) ? 1 : e === o.z.LATEST_ACTIVITY ? a.default.compare(j(n), j(t)) : a.default.compare(n, t)
                }
            }
            ...
            function Y(e) {
                ...
                if (null != t) {
                    ...
                    var n, r = (U === o.z.LATEST_ACTIVITY ? w : G).value(),
                        a = (P = 0 === v.size ? r : r.filter((n = v, function(e) {
            ...
            const K = new x(l.Z, {
                ...
                THREAD_LIST_SYNC: function(e) {
                    var t, n = e.guildId;
                    if (null == y) return !1;
                    if (n !== (null === (t = d.Z.getChannel(y)) || void 0 === t ? void 0 : t.guild_id)) return !1;
                    Y({
                        refreshThreadIds: !0
                    })
                },
                THREAD_CREATE: function(e) {
                    ...
                    if (null == t.parent_id || t.parent_id !== y) return !1;
                    if (!n) return !1;
                    t.ownerId !== _.default.getId() ? b++ : g = t.id
                },
        ...
        52317: (e, t, n) => {
            ...
            var N = function(e, t) {
                ...
                m = {},
                R = new u.Z("UserGuildSettingsManager"),
                L = 0;

            function C() {
                m = p({}, l.Z.getCollapsedCategories())
            }
            ...
            function v() {
                return (v = d((function(e, t) {
                    return N(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, U(null != t ? E({}, null != e ? e : s.ME, t) : {})];
                            case 1:
                                n.sent();
                                return [2]
                        }
                    ...
                    return N(this, (function(f) {
                        switch (f.label) {
                            case 0:
                                ...
                                r = P();
                                for (var E in r)
                                    if (null != (a = c.Z.getChannel(E)) && null != a.guild_id) {
            ...
            function P() {
                ...
                for (var n in t) t[n] !== m[n] && (e[n] = !0);
                for (var r in m) t[r] !== m[r] && (e[r] = !0);
                return e
            }
                    ...
                    try {
                        for (var s, _ = t[Symbol.iterator](); !(u = (s = _.next()).done); u = !0) {
                            var d = s.value,
                                ...
                                I = void 0;
                            try {
                                for (var p, O = d.channel_overrides[Symbol.iterator](); !(f = (p = O.next()).done); f = !0) {
                                    var h = p.value;
        ...
        877475: (e, t, n) => {
            ...
            const b = new U(i.Z, {
                ...
                VOICE_CHANNEL_SELECT: function(e) {
                    var t = e.channelId;
                    return null == t && null != S ? y(l.Z.getChannel(S), null) : y(l.Z.getChannel(t), t)
                },
                VOICE_STATE_UPDATES: function(e) {
                    return e.voiceStates.reduce((function(e, t) {
                        var n = t.channelId,
                            r = t.sessionId;
                        return u.default.getSessionId() !== r ? e : y(l.Z.getChannel(n), n) || e
                    }), !1)
                }
            })
        },

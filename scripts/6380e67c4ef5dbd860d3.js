        ...
        248046: (e, t, n) => {
            ...
            function m(e) {
                ...
                return {
                    ...
                    permissions: t,
                    displayName: [null !== (l = n.name_localized) && void 0 !== l ? l : n.name].concat(g(O)).join(" "),
        ...
        223219: (e, t, n) => {
            ...
            var x = function(e) {
                ...
                r.hasChanges = function() {
                    return null != m && null != g && (!(!this.isOpen() && v !== l.cII.USER_SETTINGS) && !o().isEqual(m, g))
                };
                r.isOpen = function() {
                    return R
                };
            ...
            const G = new x(u.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    v = e.tab;
                    return null == y && v === l.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

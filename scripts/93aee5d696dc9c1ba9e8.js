            ...
            function a(e) {
                let t = function(e) {
                    let {
                        ...
                        return i
                    }, A = T(_, C, (l >> 18 & 31) / 31), m = T(3, 3, 1.25 * ((s >> 3 & 63) / 63)), v = T(3, 3, 1.25 * ((s >> 9 & 63) / 63)), g = f && T(5, 5, h), L = n(e), R = u(L > 1 ? 32 : 32 * L), O = u(L > 1 ? 32 / L : 32), N = new Uint8Array(R * O * 4), P = [], M = [];
                        ...
                        for (let u = 0; u < R; u++, n += 4) {
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let r = e ? 0 : 1, n = 2 * M[e]; r < 5 - e; r++, t++) h += g[t] * P[r] * n;
                            let S = l - 2 / 3 * s,
                                I = (3 * l - S + E) / 2,
                                T = I - E;
        ...
        791050: function(e, t, r) {
            ...
            function N(e) {
                let {
                    ...
                    category: P,
                    purchase: M
                } = (0, E.default)(null == g ? void 0 : g.skuId), y = T.default.canUseCollectibles(t), D = i.useRef(null), H = (0, C.default)(a), {
                    shopForAllEnabled: U
                } = (0, d.default)({
                    location: "AvatarDecorationModal"
                }), x = (0, A.isEqualAvatarDecoration)(g, void 0 === S ? null == t ? void 0 : t.avatarDecoration : S), F = () => {
                    I(g), u()
                }, b = i.useCallback(() => {
        ...
        659117: function(e, t, r) {
            ...
            var A = e => {
                let {
                    ...
                    product: m,
                    purchase: v
                } = (0, d.default)(null == r ? void 0 : r.skuId), g = C.default.canUseCollectibles(t), L = (0, c.isPremiumCollectiblesPurchase)(v), R = (0, c.isPremiumCollectiblesCategory)(A), {
                    shopForAllEnabled: O
                } = (0, o.default)({
        ...
        765221: function(e, t, r) {
            ...
            let L = () => 80,
                ...
                O = e => {
                    ...
                    }), h = (0, o.default)([E.default], () => E.default.isItemViewed(r)), L = T.default.canUseCollectibles(t), O = u === A.Section.PREMIUM_PURCHASE && !L, [N, P] = i.useState(l);
                    i.useEffect(() => {
                        l && P(!0)
                    }, [l]);
                    let M = i.useRef(null),
                    ...
                    return (0, n.jsxs)(R, {
                        ...
                        children: [(0, n.jsx)("img", {
                            ...
                            let e = u === A.Section.PURCHASE || u === A.Section.PREMIUM_PURCHASE && L;
                            if (e) return null;
                            let t = !h && !l && !N;

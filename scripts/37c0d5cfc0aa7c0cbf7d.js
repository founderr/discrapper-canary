        ...
        309244: (e, t, r) => {
            ...
            var ie = function() {
                ...
                ce = function(e) {
                    ...
                    return (0, n.jsx)(c.Clickable, te(ee({
                        className: k()($().effectGridItem, J({}, $().selected, o))
                    }, i), {
                        onClick: i.onSelect,
                        children: t
                    }))
            ...
            const ue = function(e) {
                var t, r = e.user,
                    ...
                    g = (0, H.bl)(u, a),
                    O = g.purchased.map((function(e) {
                        return f.Z.getProfileEffectById(e.id)
                    })),
                    h = g.shopPreviews.map((function(e) {
                        return f.Z.getProfileEffectById(e.id)
                    })),
                    m = o.useMemo((function() {
                        var e = {
                                section: oe.PURCHASED,
                                items: [se, ae].concat(ne(O)),
                    ...
                    children: (0, n.jsx)(c.MasonryList, {
                        ...
                        renderItem: function(e, t, r, o) {
                            var l = m[e],
                                a = l.section,
                                u = l.items;
                            return (0, R.EQ)(u[t]).with(se, (function() {
                                return (0, n.jsxs)(ce, {
                                    style: ee({}, r),
                                    isSelected: !v,
                                    onSelect: function() {
                                        return v ? p(null, !0) : null
                                    },
                        ...
                        getItemKey: function(e, r) {
                            var n;
                            return null !== (t = null === (n = m[e].items[r]) || void 0 === n ? void 0 : n.id) && void 0 !== t ? t : null
                        },
                        getItemHeight: ie,
            ...
            function ge(e) {
                ...
                var b = E.ZP.isPremium(s) ? W.Z.Messages.USER_SETTINGS_CUSTOMIZATION_UPGRADE_UPSELL : W.Z.Messages.USER_SETTINGS_CUSTOMIZATION_UPSELL;
            ...
            function Oe(e) {
                var t, r = e.transitionState,
                    ...
                    Z = ye(o.useState(null != (null == D ? void 0 : D.profileEffectID) ? null == D ? void 0 : D.profileEffectID : T), 2),
                    _ = Z[0],
                    M = Z[1],
                    k = ye(o.useState(!1), 2),
                    R = k[0],

    ...
    [21635, 78367, 88110, 71402], {
        ...
        248046: (e, t, n) => {
            ...
            function P(e) {
                ...
                0 === l.length && 0 === p.length && u.push(g({
                    rootCommand: t,
                    command: n,
                    applicationId: r,
                    subCommandPath: o,
        ...
        223219: (e, t, n) => {
            ...
            var x = function(e) {
                ...
                r.hasChanges = function() {
                    return null != g && null != R && (!(!this.isOpen() && A !== a.cII.USER_SETTINGS) && !o().isEqual(g, R))
                };
                r.isOpen = function() {
                    return m
                };

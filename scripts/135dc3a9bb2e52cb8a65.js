                ...
                o.useEffect((function() {
                    if (p && e && null != f) {
                        ...
                        return function() {
                            f.forEach((function(t) {
                                t.elements.forEach((function(t) {
                                    t.removeAttribute(c.OF)
                                }))
                            }))
                        }
                    }
                }), [f, p, e]);
                return p && null != f && 0 !== f.length ? (0, r.jsxs)("div", {
                    style: {
                        backgroundColor: l.Z.INFO_DANGER_BACKGROUND,
                        color: l.Z.INFO_DANGER_TEXT,
                        display: "flex",
                        alignItems: "center",
                        padding: "8px 12px"
                    },

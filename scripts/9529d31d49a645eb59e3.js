...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [55052], {
        655052: (e, a, n) => {
            ...
            function N(e) {
                var a = e.text,
                    n = e.color;
                return (0, t.jsxs)("div", {
                    className: U().upsellFooter,
                    children: [(0, t.jsx)(M.Z, {
                        className: U().upsellFooterIcon,
                        color: n
                    }), (0, t.jsx)("div", {
                        children: a
                    })]
            ...
            function ie(e, a) {
                return function(e) {
                    ...
                    if ("Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return ne(e, a)
                }(e, a) || function() {
            ...
            function se(e) {
                var a = e.amount,
                    ...
                    l = void 0 === r ? 1 : r,
                    i = (0, q.T4)(a, n);
                return t === Q.rV.YEAR ? z.Z.Messages.BILLING_PRICE_PER_YEAR_EACH.format({
                    price: i
                }) : t === Q.rV.MONTH && 1 === l ? z.Z.Messages.BILLING_PRICE_PER_MONTH_EACH.format({
                    price: i
                }) : t === Q.rV.MONTH && l > 1 ? z.Z.Messages.BILLING_PRICE_PER_MULTI_MONTH_EACH.format({
                    price: i
                }) : null
            }

            function oe(e) {
                var a = e.intervalType,
                    n = e.intervalCount,
                    t = void 0 === n ? 1 : n;
                return a === Q.rV.YEAR ? z.Z.Messages.PREMIUM_GUILD_PLAN_SINGLE_YEAR : a === Q.rV.MONTH && 1 === t ? z.Z.Messages.PREMIUM_GUILD_PLAN_SINGLE_MONTH : null
            }

            function ce(e) {
                var a, n, r = e.guildId,
                    l = e.premiumSubscriptionPlan,
                    s = e.numGuildBoosts,
                    c = e.setNumGuildBoosts,
                    d = e.setForceDisableSubmitButton,
                    m = e.premiumSubscription,
                    _ = e.onClickPremiumSubscriptionLink,
                    P = e.existingAvailableSlots,
                    y = void 0 === P ? [] : P,
                    O = e.priceOptions,
                    R = (0,
                        C.Z)(),
                    g = l.interval,
                    M = l.intervalCount,
                    L = (0, u.e7)([w.Z], (function() {
                        return w.Z.getForSkuAndInterval(Q.Si.GUILD, g, M)
                    })),
                    U = (0, u.e7)([Z.default], (function() {
                        return Z.default.getCurrentUser()
                    })),
                    D = (0, u.e7)([x.Z], (function() {
                        return x.Z.getGuild(r)
                    }), [r]);
                o()(null != L, "Missing guildBoostingSubscriptionPlan");
                o()(null != D, "Unknown guild: ".concat(r));
                var b = [{
                        planId: L.id,
                        quantity: 1
                    }],
                    H = null == m ? void 0 : m.items.find((function(e) {
                        return e.planId === Q.Xh.PREMIUM_MONTH_TIER_2 || e.planId === Q.Xh.PREMIUM_YEAR_TIER_2
                    }));
                null != H && b.push(H);
                var k = null == m ? void 0 : m.items.find((function(e) {
                        return e.planId === Q.Xh.PREMIUM_MONTH_GUILD || e.planId === Q.Xh.PREMIUM_YEAR_GUILD
                    })),
                    ee = !X.useExperiment({
                        location: "32b64a_1"
                    }).enabled || null == R || !Q.Tp.has(R) || null == k,
                    ne = (0, f.Z)().analyticsLocations,
                    ce = ie((0, E.ED)({
                        ...
                        currency: O.currency,
                        preventFetch: ee,
                        analyticsLocations: ne,
                        analyticsLocation: S.Z.GUILD_BOOSTING_PLAN_SELECT
                    }), 2),
                    ue = ce[0],
                    he = ce[1],
                    pe = !ee && null == ue && null == he,
                    de = (null === (a = (0, v.N)()) || void 0 === a || null === (n = a.subscription_trial) || void 0 === n ? void 0 : n.sku_id) === Q.Si.TIER_2,
                    Ie = K.ZP.hasBoostDiscount(U) && null != L.premiumUserPrice,
                    me = null == ue ? void 0 : ue.invoiceItems.find((function(e) {
                        return e.subscriptionPlanId === L.id
                    })),
                    _e = null != me ? {
                        amount: me.amount,
                        tax: 0,
                        taxInclusive: !0,
                        currency: O.currency
                    } : K.ZP.getPrice(L.id, Ie, !1, O),
                    Se = s * _e.amount,
                    fe = K.ZP.hasBoostDiscount(U) && null != m ? z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_FOOTER_DISCOUNT.format({
                        planName: K.ZP.getDisplayPremiumType(m.planId)
                    }) : (de ? z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_FOOTER_UPSELL_TRIAL_VARIANT : z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_FOOTER_UPSELL).format({
                        onPremiumSubscriptionClick: _,
                        discountPercentage: (0, q.T3)(j.default.locale, Q.Rr / 100),
                        freeSubscriptionCount: Q.cb
                    }),
                    Ee = y.filter((function(e) {
                        return (0, Y.tl)(e)
                    })).length,
                    Pe = (0, K.Ap)(O.paymentSourceId),
                    Te = "HR" === (0, T.Z)().ipCountryCode && _e.currency === $.pK.EUR;
                d(pe);
                return (0,
                    t.jsxs)("div", {
                    className: ae().planSelectStep,
                    children: [(0, t.jsx)("div", {
                        className: i()(ae().planSelectText, ae().bodyText),
                        children: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_STEP_SELECT_DESCRIPTION
                    }), y.length > 0 ? (0, t.jsxs)("div", {
                        className: ae().existingSlotNotice,
                        children: [(0, t.jsx)(V.Z, {
                            className: ae().existingSlotIcon,
                            color: h.Z.unsafe_rawColors.GUILD_BOOSTING_PINK.css
                        }), (0, t.jsxs)("div", {
                            children: [z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_UNUSED_SLOT_NOTICE.format({
                                slotCount: y.length
                            }), Ee > 0 && null != m ? (0, t.jsx)(p.Tooltip, {
                                text: z.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_CANCEL_WARNING.format({
                                    canceledCount: Ee,
                                    date: m.currentPeriodEnd
                                }),
                                children: function(e) {
                                    return (0, t.jsx)(F.Z, le(re({}, e), {
                                        className: ae().existingSlotTooltipWarningIcon,
                        ...
                        className: ae().planSelectRow,
                        children: [(0, t.jsxs)("div", {
                            className: ae().planSelectorWrapper,
                            children: [(0, t.jsx)(G.Z, {
                                value: s,
                                onChange: function(e) {
                                    return c(e)
                                },
                                className: ae().planSelector,
                                minValue: 1,
                                maxValue: 30
                            }), (0, t.jsx)("div", {
                                className: ae().planSelectorLabel,
                                children: Pe ? oe({
                                    intervalType: g,
                                    intervalCount: M
                                }) : z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_COUNTER
                            })]
                        }), (0, t.jsx)("div", {
                            className: i()(ae().planSelectorPreviewPrice, te({}, ae().loadingSpinner, pe)),
                            children: pe ? (0, t.jsx)(p.Spinner, {}) : Pe ? (0, q.T4)(_e.amount, _e.currency) : se({
                                intervalType: g,
                                intervalCount: M,
                                amount: _e.amount,
                        ...
                        className: ae().planSelectDivider
                    }), (0, t.jsxs)("div", {
                        className: ae().planSelectRow,
                        children: [(0, t.jsx)("div", {
                            className: ae().planSelectorSubtotal,
                            children: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_SUBTOTAL
                        }), (0, t.jsx)("div", {
                            className: i()(ae().planSelectorSubtotalPrice, te({}, ae().loadingSpinner, pe)),
                            children: pe ? (0, t.jsx)(p.Spinner, {}) : (0, t.jsx)(A.Z, {
                                price: Se,
                                currency: _e.currency,
                                intervalType: g,
                                intervalCount: M,
                                isPrepaidPaymentSource: Pe
                            })
                        })]
                    }), Te && (0, t.jsx)(I.Z, {
                        message: z.Z.Messages.LOCALIZED_PRICING_HRK_EURO_WARNING.format({
                            kunaPriceWithCurrency: (0, q.T4)(7.5345 * Se, $.pK.HRK)
                        })
                    }), (0, t.jsx)(I.Z, {
                        message: z.Z.Messages.BILLING_FINAL_PRICE_MAY_CHANGE.format({
                            documentationLink: W.Z.getArticleURL(J.BhN.LOCALIZED_PRICING)
                        })
                    }), (0, t.jsx)(N, {
                        text: fe,
            ...
            function ue(e) {
                var a = e.premiumSubscription,
                    n = e.premiumSubscriptionPlan,
                    r = e.proratedInvoicePreview,
                    l = e.renewalInvoicePreview,
                    i = e.priceOptions,
                    s = n.interval,
                    c = n.intervalCount,
                    h = (0, u.e7)([w.Z], (function() {
                        return w.Z.getForSkuAndInterval(Q.Si.GUILD, s, c)
                    }));
                o()(null != h, "Missing guildBoostingSubscriptionPlan");
                var p = function(e) {
                        return (0, P.j)(r.invoiceItems).find((function(a) {
                            return Q.Z1.has(a.subscriptionPlanId) && e(a)
                        }))
                    },
                    d = p((function(e) {
                        return e.amount >= 0
                    }));
                o()(null != d, "Missing guild boosting invoice item");
                var I = p((function(e) {
                        return e.amount < 0
                    })),
                    m = null != I ? d.quantity - I.quantity : d.quantity,
                    _ = r.invoiceItems.filter((function(e) {
                        return (0, K.uZ)(e.subscriptionPlanId)
                    })),
                    S = _.reduce((function(e, a) {
                        return e + a.amount
                    }), 0),
                    f = (0, E.pV)(d) * m,
                    T = (0, q.T4)(f, r.currency),
                    v = (0, q.og)(T, s, c),
                    C = (0, q.T4)(r.total, r.currency) + (r.currency !== $.pK.USD ? "*" : ""),
                    A = r.total - f - S,
                    O = d.discounts.map((function(e) {
                        var a = e.amount / d.quantity;
                        return le(re({}, e), {
                            amount: a * m
                        })
                    })),
                    R = (0, K.Ap)(i.paymentSourceId);
                return (0, t.jsxs)(t.Fragment, {
                    children: [R ? null : (0, t.jsx)(g.hG, {
                        proratedInvoice: r,
                        renewalInvoice: l
                    }), (0, t.jsxs)(y.PO, {
                        children: [(0, t.jsx)(y.q9, {
                            children: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_PURCHASE_DETAILS_HEADER
                        }), (0, t.jsx)(y.i$, {
                            label: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_INVOICE_ROW_CONTENT.format({
                                numGuildSubscriptions: m,
                                planName: (0, K.Gf)(h.id, !1, R)
                            }),
                            value: R ? T : v,
                            discounts: O,
                            originalAmount: d.subscriptionPlanPrice * m,
                            currency: r.currency,
                            interval: h.interval,
                            intervalCount: h.intervalCount
                        }), 0 !== S ? (0, t.jsx)(y.R$, {
                            label: (0, t.jsx)(g.As, {
                                label: z.Z.Messages.PREMIUM_SUBSCRIPTION_PLAN_ADJUSTMENT.format({
                                    planName: (0, K.aq)(_[0].subscriptionPlanId)
                                }),
                                tooltipText: z.Z.Messages.PREMIUM_SUBSCRIPTION_ADJUSTMENT_TOOLTIP
                            }),
                            value: (0, q.T4)(S, r.currency)
                        }) : null, 0 !== A ? (0, t.jsx)(y.R$, {
                            label: (0, t.jsx)(g.As, {
                                label: z.Z.Messages.PREMIUM_SUBSCRIPTION_GUILD_SUBSCRIPTION_ADJUSTMENT,
                                tooltipText: z.Z.Messages.PREMIUM_SUBSCRIPTION_ADJUSTMENT_TOOLTIP
                            }),
                            value: (0, q.T4)(A, r.currency)
                        }) : null, (0, t.jsx)(y.KU, {}), (0, t.jsx)(y.Ji, {
                            label: (r.taxInclusive ? R ? z.Z.Messages.BILLING_INVOICE_TOTAL_TAX_INCLUSIVE : z.Z.Messages.BILLING_INVOICE_TODAY_TOTAL_TAX_INCLUSIVE : z.Z.Messages.BILLING_INVOICE_TODAY_TOTAL).format(),
                            value: C
                        }), null != a ? (0, t.jsx)(g.nd, {
            ...
            function he(e) {
                var a, n, r = e.paymentSources,
                    l = e.priceOptions,
                    i = e.currentPremiumSubscription,
                    s = e.premiumSubscriptionPaymentSourceId,
                    o = e.premiumSubscriptionPlan,
                    h = e.newAdditionalPlans,
                    I = e.onPaymentSourceChange,
                    P = e.onPaymentSourceAdd,
                    T = e.onPurchaseTermsChange,
                    v = e.legalTermsNodeRef,
                    C = e.hasLegalTermsFlash,
                    y = l.paymentSourceId,
                    A = (0, u.e7)([H.Z], (function() {
                        return null != s ? H.Z.getPaymentSource(s) : null
                    })),
                    O = (0, u.e7)([D.Z], (function() {
                        return D.Z.hidePersonalInformation
                    }));
                n = null != i ? (0, K.Zx)(i, h[0].quantity, h[0].planId) : h;
                var g, M = (0, f.Z)().analyticsLocations,
                    L = ie((0, E.ED)({
                    ...
                    N = c.M.EEA_COUNTRIES.has(b.Z.ipCountryCodeWithFallback);
                return (0,
                    t.jsxs)("div", {
                    className: ae().reviewStep,
                    children: [null != L && null != U ? (0, t.jsx)(ue, {
                        ...
                        children: [(0, t.jsx)(p.FormTitle, {
                            tag: p.FormTitleTags.H5,
                            children: z.Z.Messages.PAYMENT_SOURCE_PAYMENT_REQUEST_INFO_TITLE
                        }), null != s ? null != A ? (0, t.jsx)(p.TooltipContainer, {
                            text: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_PAYMENT_SOURCE_TOOLTIP,
                            children: (0, t.jsx)(m.Z, {
                                paymentSources: [A],
                        ...
                        children: (0, t.jsx)(_.Z, {
                            ...
                            finePrint: (0, t.jsx)(d.Z, {
                                subscriptionPlan: o,
                                paymentSourceType: null === (a = r[null != y ? y : ""]) || void 0 === a ? void 0 : a.type
                            }),
                            showPricingLink: (null !== (g = null == L ? void 0 : L.currency) && void 0 !== g ? g : $.pK.USD) !== $.pK.USD,
            ...
            function pe(e) {
                var a, n = e.onClose,
                    ...
                    I = ie(r.useState(k.fe.Scenes.ENTRY), 2),
                    m = I[0],
                    _ = I[1],
                    S = ie(r.useState(!1), 2),
                    f = S[0],
                    E = S[1];
                a = o ? null == l ? z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_TRANSFERRED_DESCRIPTION_GENERIC_GUILD.format() : z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_TRANSFERRED_DESCRIPTION.format({
                    guildName: l.name
                }) : null == l ? z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_ACTIVATED_DESCRIPTION_GENERIC_GUILD.format({
                    guildSubscriptionQuantity: i
                }) : z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_ACTIVATED_DESCRIPTION.format({
                    guildName: l.name,
                    guildSubscriptionQuantity: i
                });
                return (0, t.jsxs)("div", {
                    className: ae().confirmationContainer,
                    children: [u ? (0, t.jsx)(k.fe, {
                        className: ae().confirmationAnimation,
                        nextScene: m,
                        onScenePlay: function(e) {
                            if (!f) switch (e) {
                                case k.fe.Scenes.ENTRY:
                                    return _(k.fe.Scenes.IDLE);
                                case k.fe.Scenes.IDLE:
                                    return _(k.fe.Scenes.SUCCESS);
                        ...
                        className: ae().confirmationUpgradedBanner,
                        theme: d,
                        premiumType: Q.p9.TIER_2,
                        type: $.X7.has(null != h ? h : $.He.UNKNOWN) ? O.C.Types.PREMIUM_PAYMENT_STARTED : O.C.Types.GUILD_BOOST_APPLIED
                    }), (0, t.jsx)("div", {
                        className: ae().confirmationText,
                        children: a
                    }), (0, t.jsx)(p.Button, {
                        onClick: n,
                        children: z.Z.Messages.GUILD_SUBSCRIPTION_PURCHASE_MODAL_ACTIVATED_CLOSE_BUTTON
                    })]
                })
            }
        },
        671687: (e, a, n) => {
            ...
            function T(e, a) {
                if (null == e) return {};
                var n, t, r = function(e, a) {
                    if (null == e) return {};
                    var n, t, r = {},
                        l = Object.keys(e);
                    for (t = 0; t < l.length; t++) {
                        n = l[t];
                        a.indexOf(n) >= 0 || (r[n] = e[n])
                    }
                    return r
                }(e, a);
                if (Object.getOwnPropertySymbols) {
                    ...
                    for (t = 0; t < l.length; t++) {
                        n = l[t];
                        a.indexOf(n) >= 0 || Object.prototype.propertyIsEnumerable.call(e, n) && (r[n] = e[n])
                    }
                }
                return r
            }
            ...
            function v(e, a) {
                return !a || "object" !== O(a) && "function" != typeof a ? function(e) {
            ...
            function C(e, a) {
                C = Object.setPrototypeOf || function(e, a) {
                    e.__proto__ = a;
                    return e
                };
                return C(e, a)
            }
            var y, A, O = function(e) {
            ...
            var g, M = Object.freeze({
                DURATION: (y = {}, f(y, I.p9.TIER_0, 1e3), f(y, I.p9.TIER_1, 1e3), f(y, I.p9.TIER_2, 1500), y),
                DELAY: (A = {}, f(A, I.p9.TIER_0, 400), f(A, I.p9.TIER_1, 400), f(A, I.p9.TIER_2, 2200), A),
            ...
            var L = function(e) {
                ...
                function n() {
                    S(this, n);
                    var e;
                    (e = a.apply(this, arguments)).animation = new s.Z.Value(0);
                    return e
                }
                var r = n.prototype;
                ...
                r.animate = function() {
                    ...
                    s.Z.timing(this.animation, {
                        toValue: 1,
                        delay: M.DELAY[e],
                        duration: M.DURATION[e]
                    }).start()
                };
                r.getContainerStyle = function() {
                    var e = this.props.flashColor,
                        a = M.FLASH_TIME_PERCENT,
                        n = M.FLASH_DURATION_PERCENT,
                        t = (0, d.Cj)(e, 0);
                    return {
                        backgroundColor: this.animation.interpolate({
                            inputRange: [0, a, a, a + n, 1],
                            outputRange: [t, t, e, e, t]
                        })
                    }
                };
                ...
                r.getSvgBorderGradientId = function() {
                    ...
                    switch (e.type) {
                        case g.GUILD_BOOST_APPLIED:
                            return h.Rj.PREMIUM_GUILD;
                        case g.PREMIUM_ACTIVATED:
                        case g.PREMIUM_PAYMENT_STARTED:
                        case g.PREMIUM_UPGRADED:
                        case g.PREMIUM_UPDATED:
                            return a === I.p9.TIER_0 ? h.Rj.PREMIUM_TIER_0 : a === I.p9.TIER_1 ? h.Rj.PREMIUM_TIER_1 : h.Rj.PREMIUM_TIER_2;
                        default:
                ...
                r.render = function() {
                    ...
                    return (0, t.jsxs)("div", {
                        className: i()(_().container, e),
                        children: [this.renderSvgBorder(), (0, t.jsxs)(s.Z.div, {
            ...
            function U(e) {
                var a = e.theme,
                    n = T(e, ["theme"]),
                    r = (0, u.useToken)(o.Z.unsafe_rawColors.WHITE_500).hex(),
                    l = (0, u.useToken)(o.Z.unsafe_rawColors.BRAND_500).hex(),
                    i = (0, c.wj)(a) ? r : l;
                return (0, t.jsx)(L, P(function(e) {
                    for (var a = 1; a < arguments.length; a++) {
                        var n = null != arguments[a] ? arguments[a] : {},
                            t = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (t = t.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
...
//# sourceMappingURL=9529d31d49a645eb59e3.js.map
            ...
            function i(e) {
                let t = function(e) {
                    let {
                        ...
                        return a
                    }, m = T(_, C, (l >> 18 & 31) / 31), A = T(3, 3, 1.25 * ((s >> 3 & 63) / 63)), v = T(3, 3, 1.25 * ((s >> 9 & 63) / 63)), g = f && T(5, 5, h), L = n(e), R = u(L > 1 ? 32 : 32 * L), O = u(L > 1 ? 32 / L : 32), N = new Uint8Array(R * O * 4), M = [], P = [];
                        ...
                        for (let u = 0; u < R; u++, n += 4) {
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let r = e ? 0 : 1, n = 2 * P[e]; r < 5 - e; r++, t++) h += g[t] * M[r] * n;
                            let S = l - 2 / 3 * s,
                                I = (3 * l - S + E) / 2,
                                T = I - E;
        ...
        791050: function(e, t, r) {
            ...
            function N(e) {
                let {
                    ...
                    category: M,
                    purchase: P
                } = (0, E.default)(null == g ? void 0 : g.skuId), y = T.default.canUseCollectibles(t), D = a.useRef(null), H = (0, C.default)(i), {
                    shopForAllEnabled: U
                } = (0, d.default)({
                    location: "AvatarDecorationModal"
                }), x = (0, m.isEqualAvatarDecoration)(g, void 0 === S ? null == t ? void 0 : t.avatarDecoration : S), F = () => {
                    I(g), u()
                }, b = () => {
        ...
        659117: function(e, t, r) {
            ...
            var m = e => {
                let {
                    ...
                    product: A,
                    purchase: v
                } = (0, d.default)(null == r ? void 0 : r.skuId), g = C.default.canUseCollectibles(t), L = (0, c.isPremiumCollectiblesPurchase)(v), R = (0, c.isPremiumCollectiblesCategory)(m), {
                    shopForAllEnabled: O
                } = (0, o.default)({
        ...
        19287: function(e, t, r) {
            ...
            function c(e) {
                let {
                    ...
                    canAnimate: S,
                    size: c
                }) : void 0, [d, I, T, t, S, c, E]), A = n.useCallback(() => C(!0), []), v = n.useCallback(() => C(!1), []);
                return {
                    avatarSrc: m,
                    isAvatarAnimating: S,
                    eventHandlers: {

    ...
    ["92309"], {
            ...
            var a = n("414456"),
                ...
                C = e => {
                    let {
                        ...
                        style: C,
                        children: p
                    } = e, E = (0, o.default)([i.default], () => i.default.saturation);
                    return (0, r.jsx)("div", {
                        ...
                        style: (() => {
                            ...
                            let r = (0, u.hexOpacityToRgba)(s.default.unsafe_rawColors.BLACK_500, 1 - E);
                            return {
                                ...C,
        ...
        658756: function(e, t, n) {
            ...
            let P = e => {
                ...
                let {
                    ...
                    backgroundColors: D,
                    buttonColors: j
                } = (0, O.default)(P), k = (0, c.default)([_.default], () => {
                ...
                } = (0, E.default)([...R, p.default.COLLECTIBLES_COLLECTED_MODAL]), Z = (0, m.default)({
                    analyticsLocations: G
                });
                return null == H && null == w ? null : (0, r.jsxs)(z, {
                    children: [(0, r.jsxs)("div", {
                        ...
                        ref: V,
                        style: null != D ? {
                            background: (0, N.getBackgroundGradient)(D)
                        } : void 0,
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)(d.Heading, {
                                    ...
                                    color: "always-white",
                                    children: y.default.Messages.COLLECTIBLES_YOU_COLLECTED.format({
                                        itemName: l.name
                                    })
                                }), (0, r.jsx)(d.Text, {
                                    color: "always-white",
                                    variant: "text-sm/normal",
                                    children: null != w ? y.default.Messages.COLLECTIBLES_PROFILE_EFFECT_PERMANENT_COLLECTION : y.default.Messages.COLLECTIBLES_PERMANENT_COLLECTION
                                })]
                            }), (0, r.jsx)(d.Button, {
                                onClick: () => {
                                    o(), (0, f.popLayer)(), Z(), null != H ? (0, S.openAvatarDecorationModal)({
                                ...
                                style: null != j ? {
                                    background: (0, N.getBackgroundGradient)(j, 90)
                                } : void 0,
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(s.ConfettiCanvas, {
                        ...
                        children: (0, r.jsx)(d.ModalContent, {
                            className: o(M.modalInner, M.modalContentOverrides),
                            children: (0, r.jsx)(P, {
                                product: n,
                                category: l,
                                onClose: i,
            ...
            let d = a(s.default.unsafe_rawColors.WHITE_500.resolve({
                ...
                h = {
                    ...
                    [l.CollectiblesCategorySkuId.DISXCORE]: {
                        ...
                        buttonColors: E(s.default.unsafe_rawColors.PREMIUM_TIER_2_PURPLE_FOR_GRADIENTS.resolve({
                            saturation: 1
        ...
        894742: function(e, t, n) {
            ...
            function I(e) {
                ...
                } = (0, s.default)([..._, o.default.COLLECTIBLES_PAYMENT_MODAL]), A = a.useRef(new l.Environment), [N, O] = a.useState(null), y = [f.ONE_TIME_PAYMENT_PREDICATE_STEP_CONFIG, f.ONE_TIME_PAYMENT_ADD_PAYMENT_STEP_CONFIG, ...f.SHARED_STEP_CONFIGS, f.REVIEW_STEP_CONFIG, {
                    key: c.Step.CONFIRM,
        ...
        217796: function(e, t, n) {
            ...
            function u(e) {
                let {
                    ...
                    application: C
                } = (0, o.usePaymentContext)(), [p, E] = a.useState(!0);
                return (a.useEffect(() => {
                    let e = null != C;
                    c && f && e && E(!1)
                }, [c, f, C]), a.useEffect(() => {
                    !p && !u && (0 === Object.keys(d).length ? t(s.Step.ADD_PAYMENT_STEPS) : t(s.Step.REVIEW))
        ...
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, C = (0, l.useStateFromStores)([o.default], () => o.default.useReducedMotion), [p, E] = a.useState(d), S = a.useRef((0, i.getGiftAnimationData)(t, p)), [h, m] = a.useState(null == f), [I, v] = a.useState(!1), [_, g] = a.useState(-1), x = () => {
                    S.current = (0, i.getGiftAnimationData)(t, p), g(e => e + 1)
                }, T = () => {
                    m(!1), v(!0), g(-1), E(d)
                };
                a.useEffect(() => {
            ...
            class v extends a.PureComponent {
                renderUsers() {
                    ...
                    for (; u < s && u < e.length;) {
                        ...
                        o.push(t ? (0, r.jsx)("div", {
                            ...
                            children: s
                        }, I(null !== (c = e[u]) && void 0 !== c ? c : null, u)) : (0, r.jsx)(S.default, {
                ...
                render() {
                    let {
                        ...
                        popoutUserId: f
                    } = this.state, p = n.find(e => null != e && e.id === f), E = s && null == C.default.getUser(f);

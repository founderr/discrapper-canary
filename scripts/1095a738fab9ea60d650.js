    ...
    [82932, 21375], {
        ...
        383495: (e, t, n) => {
            ...
            function R(e) {
                var t = e.channel,
                    ...
                    d = (0,
                        a.e7)([p.Z], (function() {
                        return !t.isGuildVocal() || p.Z.can(P.Plq.CONNECT, t)
                    }), [t]),
                ...
                return (0, r.jsx)(l.Tooltip, {
                    text: C.Z.Messages.GUILD_EVENT_CANNOT_CONNECT,
                    shouldShow: !d && null != n,
                    children: function(e) {
                        var o;
                        return (0, r.jsxs)(l.Clickable, I(S({}, e), {
                            ...
                            children: [(0, r.jsx)(l.Tooltip, {
                                text: C.Z.Messages.GUILD_EVENT_PRIVATE_CHANNEL_TOOLTIP,
            ...
            function _(e) {
                ...
                return (0, r.jsxs)(l.ClickableContainer, {
                    ...
                    onClick: W,
                    onContextMenu: V,
                    className: c()(N().card, (t = {}, x(t, N().joined, E), x(t, N().lurking, P), t), n),
                    children: [d === Z.BANNER && (0, r.jsx)(y.Z, {
                        source: h
                    }), (0, r.jsx)(g.ZP, {
                        creator: a,
                        name: s,
                        description: f,
                        imageSource: d === Z.THUMBNAIL ? h : null,
                        truncate: H,
                        ...
                        guildEventId: K,
                        eventPreview: X
                    }), v && null != o && null != k && A > 0 && (0, r.jsx)(j.Z, {
                        guild: o,
                        speakers: k,
                        speakerCount: A,
                        className: N().spacing
            ...
            var N = function(e) {
                ...
                i.render = function() {
                    ...
                    if (y) return (0, r.jsx)("div", {
                        className: c()(v().imageUploader, v().disabled, C),
                        children: (0, r.jsxs)("div", {
                            className: c()(v().imageUploaderInner, N),
                            style: m(g({}, R), {
                                backgroundImage: t
                            }),
                            children: [n, P && (0, r.jsx)("div", {
        ...
        796909: (e, t, n) => {
            ...
            var T, _, k, A = (T = [], _ = [], k = [], function() {
                    var e = x.values(C.FAVORITE),
                        t = x.values(C.DEFAULT);
                    if (T !== e || _ !== t) {
                        k = [];
                ...
                D = function(e) {
                    ...
                    r.getSortedChannels = function() {
                        return [x.values(C.FAVORITE), x.values(C.DEFAULT)]
                    };

        ...
        572579: function(e, t, n) {
            ...
            function et(e) {
                let {
                    ...
                    guildId: a,
                    role: i
                } = e, [c, r] = s.useState(l.CHECKS_REQUIRED), [d, C] = s.useState(null), [E, _] = s.useState(!1), [O, S] = s.useState(!0), [M, R] = s.useState(!1), [j, G] = s.useState(!0), [b, P] = s.useState(!1), B = (0, N.useStateFromStores)([g.default], () => g.default.getAccounts()), H = (0, N.useStateFromStores)([v.default], () => v.default.getId()), [Y, Q] = s.useState(null), [Z, J] = s.useState(null), [et, en] = s.useState(null), el = (0, m.default)(), ea = (0, N.useStateFromStores)([L.default], () => L.default.locale), eo = (0, N.useStateFromStores)([D.default], () => D.default.getMember(a, H)), es = (0, N.useStateFromStores)([U.default], () => U.default.getMutableGuildChannelsForGuild(a)), ei = Object.values(es).filter(e => y.default.can(z.Permissions.VIEW_CHANNEL, e) && y.default.can(z.Permissions.SEND_MESSAGES, e) && (0, I.default)(e).includes(i));
                ...
                async function ed() {
                    R(!0), await f.default.assignGuildRoleConnection(a, i.id)
                }

                function eC() {
                    F.default.track(z.AnalyticEvents.PASSPORT_CHALLENGE_STARTED, {
                        role_id: i.id,
                        ...(0, p.collectGuildAnalyticsMetadata)(a)
                    })
                }

                function eN(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                    Q(e), J(t), r(l.ACCOUNT_CONNECTED), null != t && (0, w.fetchUserApplicationRoleConnections)().then(e => {
                        en(e)
                    }).catch(() => {})
                }
                return s.useEffect(() => {
                    f.default.fetchGuildRoleConnectionsEligibility(a, i.id).then(e => {
                        C(e), _(e.some(e => e.every(e => e.result))), S(!1)
                    })
                }, [a, i.id, B]), s.useEffect(() => {
                    ...
                    if (M && null != eo && eo.roles.includes(i.id)) {
                        if (R(!1), ei.length > 0) r(l.ROLE_GRANTED);
                        else null == n || n();
                ...
                }, [M, ei.length, eo, a, i.id, n]), (0, o.jsxs)(T.ModalRoot, {
                    ...
                    children: [function() {
                        ...
                        step: c,
                        steps: [l.CHECKS_REQUIRED, l.ACCOUNT_CONNECTED, l.ROLE_GRANTED],
                        children: function() {
                            switch (c) {
                                case l.CHECKS_REQUIRED: {

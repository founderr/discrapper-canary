        ...
        670535: function(e, t, n) {
            ...
            class a extends u.default.Store {
                getPriceTiersFetchStateForGuildAndType(e, t) {
                    var n, i;
                    return null !== (i = null === (n = o.get(e)) || void 0 === n ? void 0 : n.get(t)) && void 0 !== i ? i : r.NOT_FETCHED
                }
            ...
            var d = new a(s.default, {
                ...
                CREATOR_MONETIZATION_PRICE_TIERS_FETCH: function(e) {
                    ...
                    !o.has(t) && o.set(t, new Map), o.get(t).set(n, r.FETCHING)
                },
                CREATOR_MONETIZATION_PRICE_TIERS_FETCH_SUCCESS: function(e) {
                    ...
                    !o.has(t) && o.set(t, new Map), o.get(t).set(n, r.FETCHED), !l.has(t) && l.set(t, new Map), l.get(t).set(n, i)
                },
                CREATOR_MONETIZATION_PRICE_TIERS_FETCH_FAILURE: function(e) {
                    ...
                    !o.has(t) && o.set(t, new Map), o.get(t).set(n, r.FETCHED)
                }
            })
        },

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["39248"], {
            ...
            var i = n("37983"),
                ...
                M = function(e) {
                    let {
                        ...
                        transitionState: l,
                        onClose: M
                    } = e, P = (0, o.useStateFromStores)([S.default], () => S.default.getGuild(t), [t]), v = (0, o.useStateFromStores)([N.default], () => N.default.getId()), G = (0, o.useStateFromStores)([f.default], () => f.default.getMember(t, v)), [y, b] = r.useState([]), B = (0, c.default)(), F = (0, A.useUID)();
                    if (r.useEffect(() => {
                            0 !== y.length && C.default.track(h.AnalyticEvents.PASSPORT_ENTRY_VIEWED, {
                                role_ids: y.map(e => {
                                    let {
                                        role_id: t
                                    } = e;
        ...
        424562: function(e, t, n) {
            ...
            function S() {
                T = I.FormStates.CLOSED, N = {}, u = null, E = void 0, _ = []
            }

            function A() {
                O(), p(), N = {}, T = I.FormStates.OPEN
            }
            ...
            var L = new C(d.default, {
                GUILD_IDENTITY_SETTINGS_INIT: function(e) {
                    u = e.guild, T = I.FormStates.OPEN, N = {}, E = e.source, _ = e.analyticsLocations
                },
        ...
        479756: function(e, t, n) {
            ...
            function S(e, t) {
                d.default.track(N.AnalyticEvents.VIEW_AS_ROLES_SELECTED, {
            ...
            function A(e, t) {
                ...
                null != n && n.type === t.type && (d.default.track(N.AnalyticEvents.VIEW_AS_ROLES_SELECTED, {
        ...
        650484: function(e, t, n) {
            ...
            function I(e) {
                ...
                let {
                    ...
                    setReadySlideId: C
                } = (0, c.usePaymentContext)(), L = S.find(e => e.key === f);
                r.useEffect(() => {
                    p(null)
                }, [f, p]), s(null != L, "Unknown step for current payment flow.");
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (E = null == L ? void 0 : null === (o = L.options) || void 0 === o ? void 0 : o.renderHeader) || void 0 === E || E ? I : null, L.renderStep(N), null == f || R ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !P && u.default.track(_.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: m,
                            location_stack: f
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == I || I(P), P && (!p && E.ComponentDispatch.dispatch(_.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == N || N())
                    },
        ...
        235004: function(e, t, n) {
            ...
            var g = new D(s.default, {
                LOGOUT: function() {
                    f.clear(), S.clear(), L.clear(), R = !1, p = r.NOT_FETCHED, O = r.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_DELETE: function(e) {
                    ...
                    null != i && null != r && !(r < 0) && (i.splice(r, 1), f.set(n, [...i]))
                },
                ...
                USER_SETTINGS_PROTO_UPDATE: function(e) {
                    ...
                    } else n === N.UserSettingsTypes.PRELOADED_USER_SETTINGS && m(i)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    f.set(I.DEFAULT_SOUND_GUILD_ID, t), O = r.FETCHED
                },
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    f = new Map(Object.entries(t.soundboardSounds)), C = new Set(t.favoritedSoundIds), A = new Set(t.localSoundboardMutes)
                },
        ...
        865372: function(e, t, n) {
            ...
            class f extends l.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (c = e), this.syncWith([u.default], T), this.syncWith([s.default], N)
                }
                getState() {
                    return c
                }
        ...
        364685: function(e, t, n) {
            ...
            var B = new b(o.default, {
                ...
                CONNECTION_OPEN: e => {
                    ...
                    C = null, p = new Map, h = new Map, t.forEach(y), A = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    A = 0, L = [], p.clear(), O.clear(), C = null, h.clear(), h = new Map(h), U = !1, R = null
                },
            ...
            let _ = e => {
                ...
                switch (r) {
                    ...
                    case s.BotTagTypes.OFFICIAL:
                        c = !0, f = u.default.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP, N = u.default.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    case s.BotTagTypes.SERVER:
                        N = u.default.Messages.BOT_TAG_SERVER;
                        break;
                    case s.BotTagTypes.ORIGINAL_POSTER:
                        N = u.default.Messages.BOT_TAG_FORUM_ORIGINAL_POSTER;
                        break;
                    case s.BotTagTypes.STAFF_ONLY_DM:
                        N = u.default.Messages.STAFF_BADGE_TOOLTIP;
                        break;
                    case s.BotTagTypes.AI:
                        c = !0, f = u.default.Messages.AI_GENERATED_TOOLTIP, N = u.default.Messages.AI_TAG;
                        break;
                    case s.BotTagTypes.REMIX:
                        c = !1, N = u.default.Messages.REMIXING_TAG;
                        break;
                    case s.BotTagTypes.BOT:
                    default:
                        N = u.default.Messages.BOT_TAG_BOT
                }
        ...
        181114: function(e, t, n) {
            ...
            let f = e => {
                let {
                    ...
                    onlyShineOnHover: f,
                    ...S
                } = e, A = a.createRef(), O = (0, _.default)(A), p = !i && !o && !0 !== u && (!f || O);
                return (0, l.jsxs)(E.Button, {
                    ...
                    disabled: i,
                    submitting: o,
                    children: [t, p ? (0, l.jsx)(N, {
                        shinePaused: I,
                        className: s(d.buttonShine, f ? d.onlyShineOnHover : void 0, T),
                        shineSize: c
                    }) : null]
                })
            };
            ...
            let d = {
                ...
                I = e => {
                    let {
                        ...
                        enabled: O
                    } = (0, E.useRedesignIconContext)(), p = t;
                    if (!0 === S ? p = d.DOWN : !1 === S && (p = d.RIGHT), O) {
                        let e = {
                ...
                renderUsers() {
                    ...
                    for (; u < o && u < e.length;) {
                        ...
                        a.push(t ? (0, i.jsx)("div", {
                            ...
                            children: o
                        }, A(null !== (E = e[u]) && void 0 !== E ? E : null, u)) : (0, i.jsx)(N.default, {

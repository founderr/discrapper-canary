    ...
    ["81423"], {
        ...
        473532: function(e, t, n) {
            ...
            let S = () => {
                ...
                return [C.Routes.FRIENDS, r.default.hasLibraryApplication() && !s.DisableGamesTab.getSetting() ? C.Routes.APPLICATION_LIBRARY : null, C.Routes.APPLICATION_STORE, e ? C.Routes.MESSAGE_REQUESTS : null, C.Routes.COLLECTIBLES_SHOP, s.FamilyCenterEnabled.getSetting() ? C.Routes.FAMILY_CENTER : null].filter(c.isNotNullish)
            };
            ...
            function f() {
                ...
                null == t ? ! function(e) {
                    ...
                    let E = (n = r + e, a = s.length, n < 0 ? a - 1 : n >= a ? 0 : n);
                    I(t, s[E])
                }(e, t)
            }
        },
        ...
        829072: function(e, t, n) {
            ...
            function G() {
                let e = d.default.getFavoriteChannels(),
                    t = N.default.isGuildCollapsed(D.FAVORITES_RAW_GUILD_ID),
                    n = O.default.getChannelId(),
                ...
                let S = null,
                    ...
                    g = l(e).values().filter(e => e.type === a.FavoriteChannelType.CATEGORY).sortBy(e => e.order).map(e => {
                        ...
                        let {
                            id: n,
                            order: i
                        } = e, o = d.default.getCategoryRecord(n), l = null !== (t = r[n]) && void 0 !== t ? t : [], a = N.default.isChannelMuted(D.FAVORITES_RAW_GUILD_ID, n), u = A.default.isCollapsed(n), s = null;
                        return {
                            isMuted: a,
                            isCollapsed: u,
                            record: o,

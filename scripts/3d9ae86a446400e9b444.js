    ...
    ["59211"], {
        ...
        594203: function(e, t, n) {
            ...
            var u = e => {
                ...
                } = e, [v, g] = o.useState(!1), m = o.useRef(0), x = o.useRef(null == t ? 0 : t);
                return o.useLayoutEffect(() => {
                    if (!v || null == n.current) return;

                    function e(e) {
                        let t = c(h) === s.HORIZONTAL ? e.screenX : e.screenY,
                            n = h === r.VERTICAL_TOP || h === r.HORIZONTAL_LEFT,
                            o = (t - m.current) * (n ? -1 : 1),
                            u = x.current + o;
                        return (0, l.clamp)(u, null != a ? a : 0, null != i ? i : u)
                    }
                    let t = (0, l.throttle)(u, p),
                        o = r => {
                            if (null == n.current) return null;
                            let i = e(r),
                                a = c(h) === s.HORIZONTAL ? "width" : "height";
                        ...
                        E = f ? "pointerup" : "mouseup",
                        D = f ? "pointermove" : "mousemove",
                        L = n.current.ownerDocument;
                    return L.addEventListener(E, O), L.addEventListener(D, o), () => {
                        L.removeEventListener(E, O), L.removeEventListener(D, o), t.cancel()
                    }
                }, [v, u, a, i, h, n, p, d, f]), o.useCallback(e => {
                    let t = c(h) === s.HORIZONTAL;
                    null != n.current && (x.current = t ? n.current.offsetWidth : n.current.offsetHeight), m.current = t ? e.screenX : e.screenY, g(!0)
                }, [h, n])
            }
        },
        ...
        882641: function(e, t, n) {
            ...
            var v = function(e) {
                let {
                    ...
                    "aria-controls": m,
                    focusProps: x
                } = e, [O, E] = s.useState(!1), [D, L] = s.useState(0), b = O || v, T = (0, u.getClass)(h, "emojiButton", b ? "Hovered" : "Normal"), j = function(e) {
            ...
            let v = e => {
                ...
                m = e => {
                    let {
                        ...
                        scrollable: x,
                        transparent: O = !1
                    } = e, E = s.useRef(null), D = s.useContext(u.default);
                        ...
                        children: (0, r.jsxs)(c.FocusRingScope, {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsxs)("div", {
                                    ...
                                    onDoubleClick: h,
                                    children: [l.isMobile && null != D ? (0, r.jsx)(o.default, {
                                        onClick: D,

        ...
        673187: function(e, t, a) {
            ...
            function O(e) {
                let {
                    transitionState: t,
                    source: l
                } = e, s = (0, d.useStateFromStores)([_.default], () => _.default.getCurrentUser()), u = (0, d.useStateFromStores)([h.default, A.default], () => A.default.getChannel(h.default.getChannelId())), [O, C] = o.useState(null), [S, N] = o.useState(null), [k, D] = o.useState(!1), [I, F] = o.useState(n.AGE_GATE_FORM), B = o.createRef(), j = o.createRef(), L = (0, m.useUID)(), U = null != O ? c().diff(O, "years") : null;

                function w() {
                    let e = null == u ? void 0 : u.getGuildId();
                    E.default.nsfwReturnToSafety(e), (0, T.closeAgeGateModal)(l)
                }
                async function Y() {
                    i(null != O, "Cannot submit null birthday.");
                    try {
                        return N(null), D(!0), await (0, G.submitDateOfBirth)(O, l)
                    } catch (t) {
                        if (null != t.body && null != t.body.date_of_birth)(0, T.openFailureAgeGateModal)(l, t.body.date_of_birth);
                        else {
                            var e;
                ...
                async function z() {
                    let e = await Y();
                    null == e && F(n.AGE_GATE_FORM)
                }
                o.useEffect(() => {
                    null != s && null != s.nsfwAllowed && (0, T.openSuccessAgeGateModal)(l)
                }), o.useEffect(() => {
                ...
                return I === n.AGE_GATE_FORM ? function() {
                    let e = (() => {
                            if (l === M.AgeGateSource.FAMILY_CENTER) return R.default.Messages.AGE_GATE_FAMILY_CENTER_HEADER;

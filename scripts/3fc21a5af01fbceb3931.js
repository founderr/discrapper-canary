(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["31820"], {
        ...
        162426: function(e, t, n) {
            ...
            function a(e) {
                let [t, n] = i.useState(!1), [a, l] = i.useState(null), u = i.useCallback(async function() {
                    for (var t = arguments.length, i = Array(t), a = 0; a < t; a++) i[a] = arguments[a];
                    try {
                        return l(null), n(!0), await e(...i)
                    } catch (e) {
                        e.message !== s.default.Messages.MFA_V2_CANCELED && l(new r.default(e))
                    } finally {
                        n(!1)
                    }
                }, [e]);
        ...
        752598: function(e, t, n) {
            ...
            let P = (e, t) => {
                ...
                let a = e.state === E.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : s.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    u = e.isCommandType();
                if (l && i === S.InteractionState.QUEUED || u && e.state === E.MessageStates.SENDING && null != t) return 0;
                if (l && i === S.InteractionState.CREATED || e.hasFlag(E.MessageFlags.LOADING) && !r) return 1;
        ...
        307367: function(e, t, n) {
            ...
            function I(e) {
                let {
                    ...
                    contextMetadata: C
                } = (0, o.usePaymentContext)(), [P, h] = r.useState(!1);
                return r.useEffect(() => {
                    var e;
                    !P && (h(!0), (0, l.startBrowserCheckout)(C.loadId), ! function(e, t, n, i) {
        ...
        992049: function(e, t, n) {
            ...
            function m(e) {
                ...
                return r.useEffect(() => {
                ...
                }, [h, R, b, j, U, D, k, w, I]), s = null != _ ? _(N, L, M) : h ? (0, i.jsx)(o.PremiumSubscriptionGiftPurchaseConfirmation, {
                    planId: N.id,
                    selectedGiftStyle: v,
                    onClose: L,
                    hasSentMessage: j,
                    giftMessageError: F,
                    isSendingMessage: k
                }) : O.current === N.id ? (0, i.jsx)(o.default, {
                    planId: N.id,
                    postSuccessGuild: T,
                    onClose: L,
        ...
        646139: function(e, t, n) {
            ...
            let k = [{
                ...
                renderStep: e => (0, i.jsx)(y.PremiumPaymentSKUSelectStep, {
                    ...e
                }),
                options: {
                    renderHeader: !1,
                ...
                renderStep: e => (0, i.jsx)(x.PremiumPaymentWhatYouLoseStep, {
                    ...e
                }),
                options: {
                    renderHeader: !1,
                ...
                key: m.Step.REVIEW,
                renderStep: e => (0, i.jsx)(P.PaymentModalReviewStep, {
                    ...e
                }),
                options: {
                    renderHeader: !0,
        ...
        97461: function(e, t, n) {
            ...
            function j(e) {
                ...
                let {
                    ...
                    giftRecipient: es
                } = (0, A.usePaymentContext)(), ea = null != z ? q[z] : null, {
                    newPlans: el
                } = d.default.useExperiment({
                    location: "d17fd6_3"
                }, {
                    autoTrackExposure: !1
                }), eu = (0, l.default)([I.default], () => I.default.getCurrentUser()), eo = !Q && null != X && X === L.PremiumSubscriptionSKUs.TIER_2 && null != eu && eu.hasHadPremium() && Z && null == Y && (0, d.isPaymentSourceEligibleForMultiMonthPlans)(ea), ed = (0, S.usePremiumTrialOffer)(w), ec = !Q && null != ed && null != X && (0, L.SubscriptionTrials)[ed.trial_id].skus.includes(X), ef = (0, p.usePremiumDiscountOffer)(), ep = null == ef ? void 0 : null === (t = ef.discount) || void 0 === t ? void 0 : t.plan_ids.some(e => L.SubscriptionPlanInfo[e].skuId === X), eS = !Q && null != ef && null != X && ep, em = null !== (n = ec || eS) && void 0 !== n && n, {
                    defaultToMonthlyPlan: eE
                } = f.TrialRedemptionDefaultPlanExperiment.useExperiment({
                    location: "d17fd6_4"
                }, {
                    autoTrackExposure: !1
                }), eI = r.useMemo(() => (0, h.getPremiumPlanOptions)({
                    skuId: X,
                    isPremium: en,
                    ...
                    defaultPlanId: ee,
                    defaultToMonthlyPlan: eE
                }), [X, en, el, Y, eo, Q, ec, ee, eE]), e_ = eS && eI.includes(L.SubscriptionPlans.PREMIUM_MONTH_TIER_2) ? L.SubscriptionPlans.PREMIUM_MONTH_TIER_2 : eI[0], eT = (0, l.default)([_.default], () => _.default.get(e_)), eC = [{
                    planId: null == eT ? void 0 : eT.id,
                    quantity: 1
                }], [eP, eh] = r.useState(em), [eA, eg] = (0, c.useSubscriptionInvoicePreview)({
                    items: eC,
                    renewal: !1,
                    preventFetch: !em,
                    applyEntitlements: !0,
                ...
                let eN = null !== (s = null == eg ? void 0 : eg.message) && void 0 !== s ? s : R.default.Messages.ERROR_GENERIC_TITLE,
                    ey = em && null == eg,
                    ex = em && null != eg;
                return ey && (null == eA ? void 0 : eA.subscriptionPeriodEnd) == null ? (0, i.jsx)(y.default, {}) : (a(null != $, "Step should be set"), a(eI.length > 0, "Premium plan options should be set"), (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsx)(M.GiftNote, {
                        giftMessage: j
                    }), !(Q && (0, C.shouldShowCustomGiftExperience)(es, !0, "PremiumPaymentPlanSelectStep")) && (0, i.jsx)(N.default, {
                        isEligibleForTrial: ec
                        ...
                        children: [ey && (0, i.jsx)("hr", {
                            ...
                            isGift: Q,
                            plan: J
                        }), (0, i.jsx)(v.default, {}), ex ? (0, i.jsx)(u.FormErrorBlock, {
                            children: eN
        ...
        403365: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    setSelectedPlanId: E
                } = (0, o.usePaymentContext)(), _ = (0, s.usePremiumTrialOffer)(r);
                return (0, i.jsx)(I, {
        ...
        498475: function(e, t, n) {
            ...
            function E(e) {
                ...
                return s(null != A, "Expected premium type"), (0, i.jsx)(o.default, {
                    premiumType: A,

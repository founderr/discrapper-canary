    ...
    [73177], {
        ...
        47635: (n, e, t) => {
            ...
            const j = {
                ...
                updateOnboardingResponses: i().debounce(U, 1e3),
                ...
                completeOnboarding: function(n, e) {
                    var t = e.length > 0 ? e[e.length - 1] : null,
                        ...
                        L = (0, S.v)(n, new Set(N), D, !0).length,
                        Z = null == t ? [] : t.options.map((function(n) {
                            return n.id
                        }));
                    ...
                    (function(n) {
                        return new Promise((function(e) {
                            d.ZP.addConditionalChangeListener((function() {
                                ...
                                if ((0,
                                        f.yE)(null !== (t = null == r ? void 0 : r.flags) && void 0 !== t ? t : 0, p.q.COMPLETED_ONBOARDING)) {
        ...
        347834: (n, e, t) => {
            ...
            var D = (0, r.debounce)((function(n, e) {
                return function(n, e) {
            ...
            function w(n, e, t, r) {
                if (null != n && !c.Z.isFullServerPreview(n)) {
                    var i = p.Z.getGuildChannelFlags(n, e);
                    !(0, v.yE)(i, b.ic.OPT_IN_ENABLED) && t && (i = (0,
                        v.mB)(i, b.ic.OPT_IN_ENABLED, !0));
        ...
        18882: (n, e, t) => {
            ...
            function j() {
                ...
                w = {};
                Z = p.Z.getChannelId();
                for (var n in U) clearTimeout(U[n]);
                U = {};
                ...
                if (null != t && t.isForumLikeChannel()) {
                    ...
                    if (null != C[n] && null != C[n][e]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in C[n][e]) e === Z ? f.ZP.isNewForumThread(u, e, r) && L[n][e]++ : o.default.compare(u, i) > 0 && !f.ZP.hasOpenedThread(u) && L[n][e]++
                        }
                    }
                }
            }
            ...
            function K() {
                var n = Z;
                if ((Z = p.Z.getChannelId()) === n) return !1;
                B(n);
                B(Z)
            }
            ...
            var tn = {},
                ...
                an = function(n) {
                    ...
                    r.getActiveJoinedThreadsForParent = function(n, e) {
                        var t;
                        return n in D && null !== (t = D[n][e]) && void 0 !== t ? t : on
                    };
                    ...
                    r.computeAllActiveJoinedThreads = function(n) {
                        ...
                        for (var t in D)
                            if (t === n || null == n)
                                for (var r in D[t])
                                    for (var i in D[t][r]) e.push(D[t][r][i].channel);
                        return e
                    };
                    ...
                    r.getActiveThreadCount = function(n, e) {
                        var t, r, o, l;
                        return i().size(null !== (o = null === (t = D[n]) || void 0 === t ? void 0 : t[e]) && void 0 !== o ? o : {}) + i().size(null !== (l = null === (r = C[n]) || void 0 === r ? void 0 : r[e]) && void 0 !== l ? l : {})
                    };
                    return t
                }(l.ZP.Store);
        ...
        877475: (n, e, t) => {
            ...
            const w = new C(i.Z, {
                ...
                VOICE_CHANNEL_SELECT: function(n) {
                    var e = n.channelId;
                    return null == e && null != y ? D(a.Z.getChannel(y), null) : D(a.Z.getChannel(e), e)
                },
                VOICE_STATE_UPDATES: function(n) {
                    return n.voiceStates.reduce((function(n, e) {
                        var t = e.channelId,
                            r = e.sessionId;
                        return u.default.getSessionId() !== r ? n : D(a.Z.getChannel(t), t) || n
                    }), !1)
                }
            })
        },

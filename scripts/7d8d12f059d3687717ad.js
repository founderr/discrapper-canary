    ...
    [36759], {
        436759: (e, t, r) => {
            ...
            function d(e) {
                ...
                var d = o.useRef(p[Math.floor(Math.random() * p.length)]).current;
                return (0, n.jsx)(l.ModalRoot, {
                    className: f().bugReporterSubmitModalRoot,
                    transitionState: t,
                    "aria-label": a.Z.Messages.SUBMIT_BUG,
        ...
        319086: (e, t, r) => {
            ...
            const p = o.forwardRef((function(e, t) {
                var r = e.href,
                    ...
                    b = e.onKeyPress,
                    d = e.focusProps,
                    y = f(e, ["href", "children", "onClick", "onKeyPress", "focusProps"]),
                    h = o.useCallback((function(e) {
                        if (!e.repeat) {
                            if (e.charCode === s.yXg.SPACE || e.charCode === s.yXg.ENTER) {
                                e.preventDefault();
                                null != r && (0, i.uL)(r);
                                null == p || p()
                            }
                ...
                return (0, n.jsx)(l.FocusRing, u(a({}, d), {
                    children: j
                }))
            }))
        }

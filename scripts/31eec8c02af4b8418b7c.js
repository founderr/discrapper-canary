            ...
            function R(e) {
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            return new y(g(e.minValue, e.maxValue));
                        case "linear":
                            return new b(e.value, e.addValue);
                        case "linear-random":
                            return new b(g(e.minValue, e.maxValue), g(e.minAddValue, e.maxAddValue));
                        case "oscillating":
                            return new v(e.value, e.start, e.final, e.duration, e.direction, e.easingFunction);
                        case "oscillating-random":
                            return new v(g(e.minValue, e.maxValue), g(e.minStart, e.maxStart), g(e.minFinal, e.maxFinal), g(e.minDuration, e.maxDuration), w(e.minDirection, e.maxDirection), I(e.easingFunctions)[0])
                    }
                }(d(d({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var r = P(e.minValue),
                                n = P(e.maxValue);
                            return new E(new y(g(r.x, n.x)), new y(g(r.y, n.y)));
                        case "linear":
                            t = P(e.value);
                            var o = P(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var i = P(e.minAddValue),
                                c = P(e.maxAddValue);
                            return new E(new b(g(r.x, n.x), g(i.x, c.x)), new b(g(r.y, n.y), g(i.x, c.x)));
                        case "oscillating":
                            t = P(e.value);
                            var l = P(e.start),
                                a = P(e.final),
                                u = P(e.duration),
                                s = P(e.direction);
                            return new E(new v(t.x, l.x, a.x, u.x, s.x, e.easingFunction), new v(t.y, l.y, a.y, u.x, s.y, e.easingFunction));
                        case "oscillating-random":
                            r = P(e.minValue), n = P(e.maxValue);
                            var f = P(e.minStart),
                                p = P(e.maxStart),
                                ...
                                C = P(e.minDirection),
                                R = P(e.maxDirection);
                            return new E(new v(g(r.x, n.x), g(f.x, p.x), g(O.x, d.x), g(_.x, h.x), w(C.x, R.x), I(e.easingFunctions)[0]), new v(g(r.y, n.y), g(f.y, p.y), g(O.y, d.y), g(_.y, h.y), w(C.y, R.y), I(e.easingFunctions)[0]))
                    }
                }(d(d({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var r = C(e.minValue),
                                n = C(e.maxValue);
                            return new h(new y(g(r.x, n.x)), new y(g(r.y, n.y)), new y(g(r.z, n.z)));
                        case "linear":
                            t = C(e.value);
                            var o = C(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var i = C(e.minAddValue),
                                c = C(e.maxAddValue);
                            return new h(new b(g(r.x, n.x), g(i.x, c.x)), new b(g(r.y, n.y), g(i.y, c.y)), new b(g(r.z, n.z), g(i.z, c.z)));
                        case "oscillating":
                            t = C(e.value);
                            var l = C(e.start),
                                a = C(e.final),
                                u = C(e.duration),
                                s = C(e.direction);
                            return new h(new v(t.x, l.x, a.x, u.x, s.x, e.easingFunction), new v(t.y, l.y, a.y, u.z, s.y, e.easingFunction), new v(t.z, l.z, a.z, u.z, s.z, e.easingFunction));
                        case "oscillating-random":
                            r = C(e.minValue), n = C(e.maxValue);
                            var f = C(e.minStart),
                                p = C(e.maxStart),
                                ...
                                P = C(e.minDirection),
                                R = C(e.maxDirection);
                            return new h(new v(g(r.x, n.x), g(f.x, p.x), g(O.x, d.x), g(_.x, E.x), w(P.x, R.x), I(e.easingFunctions)[0]), new v(g(r.y, n.y), g(f.y, p.y), g(O.y, d.y), g(_.y, E.y), w(P.y, R.y), I(e.easingFunctions)[0]), new v(g(r.z, n.z), g(f.z, p.z), g(O.z, d.z), g(_.z, E.z), w(P.z, R.z), I(e.easingFunctions)[0]))
                    }
                }(d(d({}, e), {
                    valueType: "Vector3"
                }))
            ...
            function m(e, t, r, n, o) {
                var i = function(e, t) {
                    ...
                    p = function(e, t, r) {
                        ...
                        return -1 !== n ? n : Math.floor(g(0, r.colors.length - 1))
                    }(null != n ? n : a, o, r);
                return new u({
                    id: e,
            ...
            var j = n.forwardRef((function(e, t) {
                    ...
                    g = n.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == O || O(t), h.current.size > 0 ? y.current = window.requestAnimationFrame(g) : (t.clearRect(0, 0, e.width, e.height), y.current = null);
                                var r = Date.now();
                                0 !== b.current && (v.current = 1e3 / (r - b.current)), b.current = r
                            }
                        }
                    }), [c, O, p]);
                n.useEffect((function() {
                    null != y.current && (window.cancelAnimationFrame(y.current), y.current = window.requestAnimationFrame(g))
                }), [g]);
                var I = n.useCallback((function(e, t) {
                    ...
                    w = n.useCallback((function(e, t, r, n, i) {
                        var c, l = m(null !== (c = e.id) && void 0 !== c ? c : (0, o.v4)(), e, r, n, i);
                        return I(l, t), l
                    }), [I]),
        ...
        393299: (e, t, r) => {
            ...
            function N(e) {
                var t = e.guild,
                    ...
                    i = (0, l.e7)([I.default, g.ZP], (function() {
        ...
        338479: (e, t, r) => {
            ...
            function T(e) {
                var t = e.text,
                    ...
                    s = void 0 !== u && u;
                return (0, n.jsxs)("div", {
                    className: g()(s ? R().noticeWithoutRightPadding : R().noticeWithRightPadding, l),
                    children: [(0, n.jsxs)("div", {
                ...
                var t = e.badgeType,
                    ...
                    o = function(e, t) {
                        ...
                        switch (e) {
                            ...
                            case s.Q.PARTNERED:
                                return {
                                    tooltipTitle: k.Z.Messages.SERVER_BADGE_TITLE_COMMUNITY, tooltipSubtitle: k.Z.Messages.GUILD_PARTNERED, tooltipDescription: r
                                };

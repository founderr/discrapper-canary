(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [24285, 29202, 91683, 58635, 84832, 88110, 86502, 96043, 71402], {
        ...
        980604: (e, t, n) => {
            ...
            function X() {
                var e, t, n = null !== (e = b.Z.getGuildId()) && void 0 !== e ? e : void 0,
                ...
                for (var u = [], a = [], c = 1; c < q.length; c += 1) {
                    var f = Q(q[c]);
                    null != f && ((f.type !== l.h8.TEXT_CHANNEL && f.type !== l.h8.VOICE_CHANNEL || T.Z.can(p.Plq.VIEW_CHANNEL, f.record)) && a.push(f))
                }
                if (a.length > 0) {
                    var d;
                ...
                var _ = function(e) {
                    var t = [];
                    I.Z.getRecentlyEditedDrafts(I.d.ChannelMessage).forEach((function(n) {
                        var r = n.channelId;
                        if (!e(r)) {
                            var i = Q(r);
                            null != i && t.push(i)
                ...
                if (_.length > 0) {
                    var h;
                    (h = u).push.apply(h, [(0, l.o6)(R.Z.Messages.QUICKSWITCHER_DRAFTS)].concat(D(_)))
                }
                var y = m.ZP.getMentionChannelIds().filter((function(e) {
                    return e !== r && !q.includes(e)
                })).map((function(e) {
                    return Q(e)
                })).filter(A.lm).reverse();
                ...
                if (null != n) {
                    var g = v.ZP.getSelectableChannelIds(n).filter((function(e) {
                        var t = s.Z.getChannel(e);
                        return !(null == t || e === r || q.includes(e) || N.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && N.Z.isChannelMuted(t.guild_id, t.parent_id)) && m.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return Q(e)
                    })).filter((function(e) {
                        return e
            ...
            function J(e, t) {
                switch (x) {
                    case l.h8.USER:
                        var n = g.Z.getGuild(b.Z.getGuildId());
                ...
                if (t !== Y) {
                    ...
                    k = (0, l.gJ)(l.a8.DOWN, -1, B)
                } else {
                    var r = B[k];
                    null != r && r.type === l.h8.HEADER && (k = (0, l.gJ)(l.a8.DOWN, k, B))
                }
                re.emitChange()
            }
            ...
            function $(e) {
                var t, n = e.query,
                    r = e.queryMode,
                    i = null !== (t = b.Z.getGuildId()) && void 0 !== t ? t : void 0,
            ...
            var ne = function(e) {
                ...
                r.initialize = function(e) {
                    this.waitFor(y.ZP, g.Z, s.Z);
                    this.syncWith([h.Z], (function() {
                        return !0
                    }));
                    F = u.Z.get(H) || !1;
                    var t;
            ...
            var re = new ne(a.Z, {
                ...
                QUICKSWITCHER_SEARCH: function(e) {
                    var t, n = e.query,
                        r = e.queryMode;
                    if (null == Z) return !1;
                    var i = null !== (t = b.Z.getGuildId()) && void 0 !== t ? t : null;
                    if (x !== r) {
                        Z.setResultTypes(null != r ? [r] : null);
                        Z.setLimit(null != r ? 100 : 5);
                        var o, u = null !== (o = b.Z.getGuildId()) && void 0 !== o ? o : void 0;

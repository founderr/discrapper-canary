        ...
        590942: function(e, t, n) {
            ...
            function B(e) {
                let {
                    ...
                    valid: !0
                }], [E]), G = Object.keys(a).length, U = (0, m.isGuildScheduledEventActive)(n), O = U ? a.SETTINGS : a.ENTITY, j = e => Math.max(0, Math.min(e, G - 1)), [V, B] = r.useState(O), [b, H] = r.useState(!1), w = r.useMemo(() => N.slice(0, V + 1).map(e => e.valid).every(Boolean), [N, V]), F = V >= N.length ? a.SUCCESS : N[j(V)].slideId, Y = F === a.SUCCESS, k = (0, v.useGuildEventModalStore)(e => e.onUpdateCanCloseModal);
                k(Y);
                ...
                return F === a.PREVIEW && (q = c ? x.default.Messages.SAVE_EVENT : x.default.Messages.SCHEDULE_EVENT), (0, s.jsx)(s.Fragment, {
            ...
            }(l = a || (a = {}))[l.ENTITY = 0] = "ENTITY", l[l.SETTINGS = 1] = "SETTINGS", l[l.PREVIEW = 2] = "PREVIEW", l[l.SUCCESS = 3] = "SUCCESS"
        },

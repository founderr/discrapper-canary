        ...
        552022: function(e, t, l) {
            ...
            var b = function(e) {
                ...
                let {
                    ...
                    onEdit: N,
                    onShare: S
                } = e, E = (0, u.useStateFromStoresArray)([x.default], () => s.users.map(e => x.default.getUser(e)).filter(M.isNotNullish)), {
                    AnalyticsLocationProvider: _
                } = (0, h.default)(m.default.CLIPS_GALLERY_ITEM), I = i.useRef(null), R = (0, g.default)(null !== (a = null === (t = s.editMetadata) || void 0 === t ? void 0 : t.start) && void 0 !== a ? a : 0), A = i.useRef(new f.DelayedCall(500, () => {
                    var e;
                    let t = I.current;
                    ...
                    children: [(0, n.jsx)(w, {
                        ...
                        children: [s && (0, n.jsx)("div", {
                            ...
                            children: (0, n.jsx)(p.Text, {
                                variant: "text-md/medium",
                                color: "always-white",
                                children: P.default.Messages.CLIPS_PROCESSING_BADGE
                            })
                        }), !s && l && (0, n.jsxs)(p.Text, {
                            ...
                            children: [(0, n.jsx)(S.default, {
                                className: H.newIcon
                            }), P.default.Messages.NEW.toUpperCase()]
                        }), !s && (0, n.jsxs)("div", {
            ...
            function k(e) {
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [null != i && (0, n.jsx)(p.Tooltip, {
                        text: P.default.Messages.DELETE,
                        ...
                        text: s ? P.default.Messages.SHARE : P.default.Messages.CLIPS_CANNOT_ATTACH_FILE_TO_CHANNEL,
                        children: e => (0, n.jsx)(p.Button, {
                            ...e,
                            disabled: a && !l || !s,
                            submitting: l,
        ...
        548405: function(e, t, l) {
            ...
            function C(e) {
                let {
                    ...
                    closePopout: l
                } = e, n = (0, o.default)([c.default], () => c.default.getKeybindForAction(p.GlobalKeybindActions.SAVE_CLIP)), C = (0, o.default)([f.default], () => f.default.getSettings().clipsEnabled), v = t ? h.noSearchResultsImage : h.noClipsImage, x = s.useCallback(() => {
        ...
        167573: function(e, t, l) {
            ...
            function I(e) {
                ...
                (0, h.default)({
                    ...
                    disableTrack: R
                }, [B.length, R]), s.useEffect(() => x.clearNewClipIds, []);
                let O = s.useMemo(() => d(B).filter(e => {
                    if ("" === H.trim()) return !0;
                    let t = H.toLowerCase();
                    return null != e.name && "" !== e.name && i(t, e.name.toLowerCase()) || i(t, e.applicationName.toLowerCase())
                }).sort((e, t) => "ascending" === M ? C.default.compare(e.id, t.id) : "descending" === M ? C.default.compare(t.id, e.id) : 0).chunk(3).value(), [B, H, M]);
                s.useEffect(() => {
                    (async function e() {
                        A(!0);
                        try {
                            await x.loadClipsDirectory(w)
                        } finally {
                            A(!1)
                        }
                    })()
            ...
            async function m(e, t) {
                ...
                if (null != v) try {
                    ...
                    let t = await (0, u.exportClip)(e, h),
                        l = null !== (x = e.name) && void 0 !== x ? x : (0, f.CLIP_NAME_TEMPLATE)(d.default.extractTimestamp(e.id)),
                        a = (0, c.default)(l);
            ...
            var a = l("884691"),
                ...
                c = e => {
                    let {
                        ...
                        l(a.id);
                        try {
                            var r, u, f, p, m, h, C, v, x, L;
                            await (0, d.shareClip)(a, {
                                channelId: t,
                                analyticsLocations: c,
                                editMetadata: {
                                    start: null !== (h = null !== (m = null == s ? void 0 : s.start) && void 0 !== m ? m : null === (r = a.editMetadata) || void 0 === r ? void 0 : r.start) && void 0 !== h ? h : 0,
                                    end: null !== (v = null !== (C = null == s ? void 0 : s.end) && void 0 !== C ? C : null === (u = a.editMetadata) || void 0 === u ? void 0 : u.end) && void 0 !== v ? v : a.length / 1e3,
                                    applicationAudio: null === (x = null != n ? n : null === (f = a.editMetadata) || void 0 === f ? void 0 : f.applicationAudio) || void 0 === x || x,
                                    voiceAudio: null === (L = null != i ? i : null === (p = a.editMetadata) || void 0 === p ? void 0 : p.voiceAudio) || void 0 === L || L
                                }
                            })
                        } catch (e) {} finally {
                            null == o || o(), l(null)

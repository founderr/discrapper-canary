    ...
    [27713], {
        327713: (t, n, i) => {
            ...
            const a = function(t, n, i) {
                ...
                return null != i && i.addSuffix ? i.comparison && i.comparison > 0 ? a + " nữa" : a + " trước" : a
            };
            var h = i(849526);
            const r = {
                date: (0, h.Z)({
            ...
            const d = {
                ordinalNumber: function(t, n) {
                    ...
                    if ("quarter" === e) switch (i) {
                        ...
                        if ("week" === e) return 1 === i ? "thứ nhất" : "thứ " + i;
                        if ("dayOfYear" === e) return 1 === i ? "đầu tiên" : "thứ " + i
                    }
                    return String(i)
                },
                era: (0, u.Z)({
...
//# sourceMappingURL=b2c9072459f2fbcec93e.js.map
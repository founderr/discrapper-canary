            ...
            class _ extends r.Component {
                ...
                render() {
                    ...
                    return null != E && E.length > 0 && ("string" == typeof E[0] ? E.forEach((e, t) => m.push((0, s.jsxs)(u.Anchor, {
                        ...
                        onClick: this.handleRemoveTag.bind(this, t),
                        children: [(e.type === a.MEMBER || e.type === a.USER) && null != e.avatar && (0, s.jsx)(u.Avatar, {
                            src: e.avatar,
                            "aria-hidden": !0,
                            size: u.AvatarSizes.SIZE_16
                        }), e.type === a.ROLE && null != e.color && (0, s.jsx)("span", {
                            className: g.tagRoleColor,
                            style: {
                                backgroundColor: e.color
                            }
                        }), e.type === a.GUILD && null != e.guild && (0, s.jsx)(d.default, {
                            guild: e.guild,
                            active: !0,
                        ...
                        children: (0, s.jsx)("div", {
                            ...
                            className: o(R, g.container, f, (0, S.getThemeClass)(n), {
                                [g.disabled]: r
                            }),
        ...
        194051: function(e, t, l) {
            ...
            let S = new Set,
                ...
                T = new i.default(function(e) {
                    let t = S.has(e.userId) ? a.VALID_USER_ONLY : a.INVALID;
                    return null != e.viewers && (t = a.VALID), [E.BROADCASTS_BY_USER_ID(e.userId), E.BROADCASTS_BY_CHANNEL_ID(e.channelId), E.BROADCASTS_BY_VALIDITY(t)]
                }, e => e.channelId);
            ...
            class p extends r.default.Store {
                getBroadcasts() {
                    return T.values(E.BROADCASTS_BY_VALIDITY(a.VALID))
                }
                getBroadcastsToValidateChannels() {
                    return T.values(E.BROADCASTS_BY_VALIDITY(a.VALID_USER_ONLY))
                }

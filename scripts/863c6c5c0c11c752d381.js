(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["2186"], {
        ...
        331306: function(e, t, n) {
            ...
            var L = function(e) {
                (0, a.useEffect)(() => {
                    m.default.track(I.AnalyticEvents.OPEN_POPOUT, {
                        type: "RTC Connection"
                    })
                }, []);
        ...
        524110: function(e, t, n) {
            ...
            var x = o.default.connectStores([p.default, h.default, C.default], () => {
        ...
        749387: function(e, t, n) {
            ...
            function N(e) {
                ...
                let {
                    userId: n,
                    applicationId: a
                } = e, i = (0, s.useStateFromStores)([f.default], () => f.default.getUser(n)), o = null !== (t = p.default.getGlobalName(i)) && void 0 !== t ? t : p.default.getUserTag(i), u = (0, s.useStateFromStores)([c.default], () => c.default.getDetectableGame(a));
            ...
            function T(e) {
                let {
                    closePopout: t
                } = e, n = (0, E.default)(), s = n.slice(0, 3), c = (0, m.default)(), f = n.length - s.length;
                return a.useEffect(() => {
        ...
        880730: function(e, t, n) {
            ...
            var b = e => {
                ...
                let {
                    ...
                    id: I
                } = n, v = (0, S.getGuildTierFromAppliedBoostCount)(m, I), O = (0, S.getNextTier)(v, n.id), y = null == O, b = null != O ? O : v, j = (0, o.useStateFromStores)([N.default], () => null !== (t = N.default.getCountForGuild(I)) && void 0 !== t ? t : 0), G = (0, o.useStateFromStores)([f.default], () => f.default.useReducedMotion), U = (0, o.useStateFromStores)([E.default], () => E.default.can(L.Permissions.MANAGE_GUILD, n));
                a.useEffect(() => {
                    j !== m && (0, _.updateGuildPremiumSubscriptionCount)(I, m)
                }, [I, j, m]);
        ...
        268760: function(e, t, n) {
            ...
            function v(e) {
                ...
                let o = null,
                    ...
                    E = null !== (n = null == m ? void 0 : m.getShownChannelIds()) && void 0 !== n ? n : [],
                    [g, I, N] = s.getSlicedChannels(r);
                for (let e = 0; e < I.length; e++) {
                    let t = I[e];
                    if ((L(t.id) || i.some(t.threadIds, L)) && (h = !1), (R(t.id) || i.some(t.threadIds, R)) && (f = !1), E.includes(t.id) && (p = !0), !h && !f && p) break
                }
                let v = 0,
                    M = !1,
                    O = 0,
                ...
                let D = null,
                    b = null,
                    j = null !== (l = null == m ? void 0 : m.getChannelRecords()) && void 0 !== l ? l : [];
                f && O > 0 ? D = {
                    mode: a.MENTIONS,
                    mentionCount: O,
                    targetChannelId: d
            ...
            function b(e) {
                ...
                if (null == n) return !1;
                let l = h.default.getGuild(n.guild_id);
                return !!(null != l && l.hasFeature(I.GuildFeatures.COMMUNITY)) && p.default.getGuildId() === n.guild_id && M(n.guild_id)
            }
        ...
        783735: function(e, t, n) {
            ...
            function O(e) {
                let {
                    ...
                    tabIndex: a,
                    forceShowButtons: s
                } = e, d = (0, r.useStateFromStores)([g.default, S.default], () => n || S.default.getGuildId() === L.FAVORITES || !g.default.can(L.Permissions.MANAGE_CHANNELS, t) && !g.default.can(L.Permissions.MANAGE_ROLES, t) && !g.default.can(L.Permissions.MANAGE_WEBHOOKS, t) || (0, p.isGuildSelectableChannelType)(t.type) && !g.default.can(L.Permissions.VIEW_CHANNEL, t) || t.isGuildVocal() && !g.default.can(L.Permissions.CONNECT, t) || !p.EDITABLE_CHANNEL_TYPES.has(t.type));
                if (d) return null;
            ...
            function y(e) {
                let {
                    ...
                    tabIndex: u,
                    forceShowButtons: f
                } = e, p = (0, r.useStateFromStores)([E.default], () => E.default.getGuild(t.getGuildId())), S = (0, r.useStateFromStores)([h.default], () => h.default.getStageInstanceByChannel(t.id), [t.id]), I = (0, r.useStateFromStores)([d.default], () => d.default.getActiveEventByChannel(t.id), [t.id]), _ = (0, r.useStateFromStores)([g.default], () => (0, c.canViewInviteModal)(g.default, p, t, S)), N = (0, r.useStateFromStores)([g.default], () => g.default.can(L.Permissions.CREATE_INSTANT_INVITE, t) ? R.default.Messages.CREATE_INSTANT_INVITE : R.default.Messages.INVITE_TO_SERVER);
                if (s || !_) return null;
        ...
        39347: function(e, t, n) {
            ...
            function v(e) {
                ...
                let {
                    ...
                    isNewChannel: P,
                    muted: w
                } = e, F = (0, a.useStateFromStores)([p.default], () => p.default.getMentionCount(v.id)), B = (0, r.default)(v), V = (0, a.useStateFromStores)([C.default], () => !C.default.can(L.Permissions.CONNECT, v)), H = (0, a.useStateFromStores)([m.default], () => m.default.hasVideo(v.id)), k = (0, c.useStageHasMedia)(v.id) && v.isGuildStageVoice(), Y = (0, _.default)({
                    channel: v,
                    locked: V,
                    video: H || k,
                    selected: O
                        ...
                        switch (A.type) {
                            ...
                            case el.ChannelTypes.GUILD_STAGE_VOICE:
                                return (0, l.jsx)(z.default, {
                                    ...
                                    speakerVoiceStates: null !== (n = p[N.id]) && void 0 !== n ? n : [],
                                    disableManageChannels: C,
                                    isFavoriteCategory: T
                                }, L);
        ...
        37416: function(e, t, n) {
            ...
            class X extends B.default {
                ...
                render() {
                    ...
                    return g && (x = h(x)), p && (x = c(f(x))), S && (x = (0, l.jsx)(v.default, {
            ...
            function J(e) {
                ...
                let {
                    ...
                    collapsed: c,
                    voiceStates: f
                } = e, p = (0, i.useStateFromStoresObject)([j.default], () => ({
                    unread: j.default.hasUnread(r.id),
                    mentionCount: j.default.getMentionCount(r.id)
                })), m = (0, i.useStateFromStoresObject)([O.default, D.default, b.default], () => {
        ...
        744925: function(e, t, n) {
            ...
            function P(e) {
                ...
                let I = null !== (t = null == p ? void 0 : p.filter(R.isNotNullish)) && void 0 !== t ? t : [],
        ...
        199334: function(e, t, n) {
            ...
            function S(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }).enabled, I = null != t.status && t.status.length > 0, _ = (0, r.useStateFromStores)([c.default], () => c.default.can(p.Permissions.SET_VOICE_CHANNEL_STATUS, t));
                if (a.useEffect(() => {
                        ...
                        S && I && C.default.track(p.AnalyticEvents.VOICE_CHANNEL_TOPIC_VIEWED, {
                            guild_id: t.guild_id,
                            channel_id: t.id
                        })
        ...
        270382: function(e, t, n) {
            ...
            let _ = (0, C.cachedFunction)((e, t, n) => ["null", ...t, ...e, g, p.ViewHistoryKeys.E3_SERVER_DISCOVERY_BADGE, E]);
            ...
            var l = n("37983"),
                ...
                I = a.memo(function(e) {
                    let {
                        guildNode: t,
                        lowerBadge: n
                    } = e, I = t.id, _ = (0, s.useStateFromStores)([h.default], () => h.default.getGuild(I)), N = (0, i.useCurrentUserGuildBadgeStatus)(I), T = (0, s.useStateFromStores)([p.default], () => p.default.isFocused()), A = (0, s.useStateFromStores)([c.default], () => c.default.isUnavailable(I)), L = (0, s.useStateFromStores)([C.default], () => C.default.isMuted(I)), R = (0, d.default)(e => e.guildId), {
                        burstPreviewData: x
        ...
        934743: function(e, t, n) {
            ...
            var e_ = (0, g.default)(function(e) {
                let {
                    ...
                    showDropsSparkles: p
                } = (0, x.useActivityPanelDrop)(em.PartnerGame.FORTNITE, s, d.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP, d.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP), [m, E, g] = (0, u.useStateFromStoresArray)([Y.default, W.default, _.default, H.default, k.default], () => {
                    let e = !1,
                        n = null;
                ...
                }), I = (0, u.useStateFromStores)([K.default], () => (0, j.default)(K.default) && (0, ef.isWindows)()), N = (0, u.useStateFromStores)([Z.default], () => null != a ? Z.default.findActivity(a, e => e.type === ep.ActivityTypes.PLAYING) : null), T = null != r && r.ownerId === a && r.state !== ep.ApplicationStreamStates.ENDED, L = (0, u.useStateFromStores)([X.default], () => X.default.getBroadcast()), R = (0, A.default)() && null != s;
                return (0, l.jsx)(eI, {
                    ...n,
                    guildId: t,
                    canGoLive: I,
        ...
        189857: function(e, t, n) {
            ...
            class ee extends a.default.Store {
                initialize() {
                    this.waitFor(b.default, A.default, R.default, L.default, _.default, v.default, x.default, j.default, m.default)
                }
            }
        ...
        189771: function(e, t, n) {
            ...
            function y(e, t) {
                ...
                let u = N.default.getCurrentUser(),
                    p = N.default.getUser(null === (n = e.author) || void 0 === n ? void 0 : n.id);
                if (null == r || null == u || null == p || r.type === x.ChannelTypes.GROUP_DM && e.type === x.MessageTypes.RECIPIENT_REMOVE || !O(u, p, r, s) || i.default.isMessageRequest(t)) return !1;
                if (!a) {

        ...
        565559: function(t, e, u) {
            ...
            class D extends d.default.Store {
                getGuildProductsForGuildFetchState(t) {
                    var e;
                    return null !== (e = c[t]) && void 0 !== e ? e : r.NOT_FETCHED
                }
                getGuildProduct(t) {
                    return C.get(t)
                }
                ...
                getGuildProductFetchState(t) {
                    var e;
                    return null !== (e = o[t]) && void 0 !== e ? e : r.NOT_FETCHED
                }
            ...
            var T = new D(a.default, {
                ...
                GUILD_PRODUCTS_FETCH_SUCCESS: function(t) {
                    ...
                    c[e] = r.FETCHED, s[e] = Date.now(), u.forEach(t => {
                        C.set(t.id, t), o[t.id] = r.FETCHED
                    })
                },
                ...
                GUILD_PRODUCT_FETCH_FAILURE: function(t) {
                    ...
                    o[e] = r.FETCHED, 404 === u.status && C.delete(e)
                }
            })
        },

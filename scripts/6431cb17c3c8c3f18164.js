(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["10524"], {
        ...
        534222: function(e, t, n) {
            ...
            function g(e, t) {
                return (0, a.useStateFromStoresArray)([d.default, u.default, f.default, s.default, r.default, i.default], () => {
                    ...
                    if (l) {
                        ...
                        let e = null === (a = i.default.getDefaultChannel(n.id)) || void 0 === a ? void 0 : a.id,
                            t = null !== (o = u.default.getEventDirectoryEntries(e)) && void 0 !== o ? o : [];
                        return t.map(e => {
            ...
            function I(e) {
                return (0, a.useStateFromStores)([f.default, r.default, s.default], () => {
            ...
            function m(e) {
                let t = (0, a.useStateFromStoresArray)([f.default], () => f.default.getGuildScheduledEventsForGuild(e), [e]),
                    n = l.useMemo(() => {
                        let e = new Map;
                        return t.forEach(t => {
                            let n = t.channel_id;
            ...
            function A(e) {
                var t, n;
                let l = (t = e, (0, a.useStateFromStoresArray)([f.default, r.default, s.default], () => {
                    ...
                    u = (0, a.useStateFromStoresObject)([C.default], () => C.default.getAllEventDismissals()),
                    i = (0, a.useStateFromStoresObject)([C.default], () => C.default.getAllUpcomingNoticeSeenTimes()),
                    d = (0, a.useStateFromStoresObject)([f.default], () => null == l ? {} : l.reduce((e, t) => {
            ...
            function y(e) {
                return (0, a.useStateFromStores)([f.default], () => f.default.getGuildScheduledEventsByIndex(f.StaticGuildEventIndexes.CHANNEL_EVENT_UPCOMING(e)), [e])
            }

            function L(e) {
                return (0, a.useStateFromStores)([r.default, f.default], () => {
            ...
            function O(e) {
                ...
                let u = (0, a.useStateFromStores)([f.default], () => null == e ? [] : f.default.getGuildScheduledEventsByIndex(f.StaticGuildEventIndexes.CHANNEL_EVENT_UPCOMING(e)), [e, t]),
                    r = l.useMemo(() => u.filter(e => {
                        ...
                        return e.status !== h.GuildScheduledEventStatus.ACTIVE && l && a < 15
                    }), [u]);
                return r
            }
        },

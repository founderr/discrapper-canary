    ...
    ["42488"], {
        ...
        506838: function(e, t, n) {
            ...
            let C = d(I(function(e) {
                ...
                O = e => I(t => T(t) && t <= e),
                L = e => I(t => T(t) && t >= e),
                U = () => I(e => T(e) && Number.isInteger(e)),
                P = () => I(e => T(e) && Number.isFinite(e)),
                M = () => I(e => T(e) && e > 0),
                b = () => I(e => T(e) && e < 0),
        ...
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, E = (0, l.useStateFromStores)([s.default], () => s.default.useReducedMotion), [_, h] = r.useState(d), p = r.useRef((0, u.getGiftAnimationData)(t, _)), [I, S] = r.useState(null == f), [T, g] = r.useState(!1), [v, C] = r.useState(-1), m = () => {
                    p.current = (0, u.getGiftAnimationData)(t, _), C(e => e + 1)
                }, N = () => {
                    S(!1), g(!0), C(-1), h(d)
                };
                r.useEffect(() => {

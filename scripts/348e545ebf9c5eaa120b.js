    ...
    ["40202"], {
        ...
        629109: function(e, t, n) {
            ...
            function _(e, t, n, s, a) {
                ...
                let u = e[t],
                    d = e[n];
                o.default.track(p.AnalyticEvents.MEDIA_DEVICE_CHANGED, {
            ...
            var g = {
                ...
                setLocalPan(e, t, n) {
                    let a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : l.MediaEngineContextTypes.DEFAULT;
                    s.default.dispatch({
        ...
        412905: function(e, t, n) {
            ...
            var a = n("77078"),
                ...
                r = n("180524"),
                p = n("782340");
            let l = new i.default("AudioActionCreators");
            ...
            function m(e) {
                o.default.track(c.AnalyticEvents.PERMISSIONS_ACKED, {
                    type: "audio",
                    action: e
                })
            }
            ...
            function E() {
                ...
                return _() ? Promise.resolve(!1) : (o.default.track(c.AnalyticEvents.PERMISSIONS_REQUESTED, {
                    type: "audio"
                    ...
                    u.default.dispatch({
                        ...
                        enabled: !0,
                        unmute: e
                    }), m(r.NativePermissionStates.ACCEPTED)
                }, e => {
                    switch (e) {
                        case c.UserMediaErrors.NO_DEVICES_FOUND:
                            m(r.NativePermissionStates.NO_DEVICES);
                            break;
                        case c.UserMediaErrors.PERMISSION_DENIED:
                            m(r.NativePermissionStates.DENIED);
                            break;
                        case c.UserMediaErrors.PERMISSION_DISMISSED:
                            m(r.NativePermissionStates.DISMISSED);
                            break;
                        default:
                            m(r.NativePermissionStates.ERROR), l.warn("unknown getUserMedia error: ".concat(e))
                    }
                }).then(() => !0))
            }
        },
            ...
            function A(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : E.MediaEngineContextTypes.DEFAULT,
                    n = (0, a.useStateFromStores)([l.default], () => {
                        var t;
                        return (null === (t = l.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === e
                    }),
                    ...
                    v = n ? null : (0, s.jsx)(u.MenuCheckboxItem, {
            ...
            function l() {
                null != window.navigator.mediaDevices && window.navigator.mediaDevices.enumerateDevices().then(e => {
                    let t = d.default.getOutputDevices(),
                        ...
                        i = u[n];
                    null != s && (null == i || i.label !== s.name) && (i = u.find(e => e.label === s.name)), r = null != i ? i.deviceId : c
                }).catch(() => {
                    r = c
                })
            }
                ...
                _ensureAudio() {
                    ...
                    return this._audio = null !== (e = this._audio) && void 0 !== e ? e : new Promise((e, t) => {
                        ...
                        s.src = n("895637")("../../sounds/".concat(this.name, ".mp3").replace("../../sounds/", "./")), s.onloadeddata = () => {
                            s.volume = Math.min(d.default.getOutputVolume() / 100 * this._volume, 1), o.isPlatformEmbedded && s.setSinkId(r), e(s)

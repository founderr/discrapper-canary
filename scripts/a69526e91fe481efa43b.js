    ...
    ["5023"], {
        ...
        962199: function(e, t, n) {
            ...
            let o = !1,
                ...
                f = {},
                E = {},
                C = e => (E[e.guild_scheduled_event.id] = new r.default(e.guild_scheduled_event.guild), f[e.guild_scheduled_event.id] = e.guild_scheduled_event, {
        ...
        986373: function(e, t, n) {
            ...
            function E(e) {
                let {
                    favoritesEnabled: t,
                    isFavoritesPerk: n
                } = (0, o.useFavoritesServerExperiment)("useCanFavoriteChannel"), l = (0, a.useStateFromStores)([s.default], () => s.default.isFavorite(e.id)), u = (0, a.useStateFromStores)([r.default], () => r.default.getCurrentUser()), i = e.isDM() || e.isThread(), d = !i || n && (null == u ? void 0 : u.isStaff()) === !0;
                return t && !__OVERLAY__ && !l && d
            }

            function C(e) {
                let t = (0, a.useStateFromStores)([s.default], () => s.default.getFavorite(e));
                return t
            }

            function S() {
                let e = (0, a.useStateFromStores)([i.default], () => i.default.getChannels(f.FAVORITES))[u.ChannelTypes.GUILD_CATEGORY];
                return e.map(e => ({
            ...
            function h() {
                let e = (0, a.useStateFromStores)([d.default], () => d.default.getGuildId());
        ...
        424024: function(e, t, n) {
            ...
            function d(e) {
                return null != e ? e === i.GameConsoleTypes.XBOX ? a.default : u.default : l.default
            }
        },
        ...
        49129: function(e, t, n) {
            ...
            function d(e, t, n, l) {
                ...
                let o = a.default.extractTimestamp(e.id),
                    ...
                    f = d.isBetween(o, c);
                if (f && null == t && !l) return i.UpcomingGuildEventNoticeTypes.NEW_EVENT
            }
        },
        431934: function(e, t, n) {
            ...
            var E = new f(u.default, {
                ...
                GUILD_SCHEDULED_EVENT_USER_ADD: function(e) {
                    ...
                    if (null != c) return;
                    let f = o[n],
                        E = (0, d.getNextShownUpcomingEventNoticeType)(u, void 0, f, !1);
        ...
        534222: function(e, t, n) {
                ...
                return (0, u.useStateFromStoresArray)([r.default, a.default, c.default, s.default, i.default, d.default], () => {
                    ...
                    if (l) {
                        ...
                        let e = null === (u = d.default.getDefaultChannel(n.id)) || void 0 === u ? void 0 : u.id,
                            t = null !== (f = a.default.getEventDirectoryEntries(e)) && void 0 !== f ? f : [];
                        return t.map(e => {
            ...
            function g(e) {
                ...
                let l = (t = e, (0, u.useStateFromStoresArray)([c.default, i.default, s.default], () => {
                    ...
                    a = (0, u.useStateFromStoresObject)([E.default], () => E.default.getAllEventDismissals()),
                    d = (0, u.useStateFromStoresObject)([E.default], () => E.default.getAllUpcomingNoticeSeenTimes()),

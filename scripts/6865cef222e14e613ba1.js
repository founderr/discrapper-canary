    ...
    [6652], {
        ...
        106652: (e, i, n) => {
            ...
            function w(e, i, n, o) {
                var t;
                if ((0, s.Z)(i, n, o)) t = c;
                else if ("lastWeek" === e) t = d;
                else {
                    if ("nextWeek" !== e) throw new Error("Cannot determine adjectives for token ".concat(e));
                    t = p
                }
                var a = i.getUTCDay(),
                    r = t[m[a]];
                return "'".concat(r, "' eeee 'o' p")
            }
            var l = {
                lastWeek: w,
...
//# sourceMappingURL=6865cef222e14e613ba1.js.map
                    ...
                    f = i.useMemo((function() {
                        return p ? s : {
                            ...
                            createConfetti: function(e, t) {
                                return O.createConfetti(E({}, c, e), t)
                            },
                            createConfettiAt: function(e, t, n, r) {
                                return O.createConfetti(E(_(E({}, c), {
                                    position: {
                                        type: "static",
                                        value: {
                                            x: e,
                            ...
                            createMultipleConfetti: function(e) {
                                ...
                                return O.createMultipleConfetti(E({}, c, e), t, n)
                            },
                            createMultipleConfettiAt: function(e, t, n) {
                                var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 20,
                                    i = arguments.length > 4 ? arguments[4] : void 0;
                                return O.createMultipleConfetti(E(_(E({}, c), {
                                    position: {
                                        type: "static",
                                        value: {
                                            x: e,
        ...
        634080: (e, t, n) => {
            ...
            const A = new(function(e) {
                ...
                r.getGuildEventUserCounts = function(e) {
                    return a((function() {
                        return T(this, (function(t) {
                            switch (t.label) {
                                case 0:
                                    if (Date.now() - L < f || null != O && Date.now() - O[e] < f) return [2];
                                    O[e] = Date.now();
                                    t.label = 1;
                                case 1:
                                    t.trys.push([1, 3, , 4]);
                ...
                r.__getLocalVars = function() {
                    return {
                        guildEventUserCountFetchTimestamp: O,
                        CURRENT_USER_GUILD_EVENT_FETCHES: p,
                        FETCH_INTERVAL_MS: f,
                        connectedTimestamp: L,
                        getGuildEventsForCurrentUser: N
                    }
                };
                return n
            }(r.Z))
        ...
        363582: (e, t, n) => {
            ...
            function u(e) {
                var t = e.width,
                    ...
                    s = e.foreground,
                    I = a(e, ["width", "height", "color", "foreground"]);
            ...
            var p = function(e) {
                ...
                A = function(e) {
                    var t = e.className,
                        ...
                        a = e.shape,
                        c = void 0 === a ? I.ROUND : a,
                        _ = e.disableColor,
                        d = void 0 !== _ && _,
                        T = e.style,
                        O = s(e, ["className", "color", "shape", "disableColor", "style"]);
                    return (0,
                        r.jsx)("div", E({

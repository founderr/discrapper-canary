                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = A(e.minStart),
                                ...
                                C = A(e.minDirection),
                                R = A(e.maxDirection);
                            return new h(new T(g(n.x, r.x), g(d.x, f.x), g(_.x, p.x), g(E.x, v.x), y(C.x, R.x), I(e.easingFunctions)[0]), new T(g(n.y, r.y), g(d.y, f.y), g(_.y, p.y), g(E.y, v.y), y(C.y, R.y), I(e.easingFunctions)[0]))
                    }
                }(p(p({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = C(e.minStart),
                                ...
                                A = C(e.minDirection),
                                R = C(e.maxDirection);
                            return new v(new T(g(n.x, r.x), g(d.x, f.x), g(_.x, p.x), g(E.x, h.x), y(A.x, R.x), I(e.easingFunctions)[0]), new T(g(n.y, r.y), g(d.y, f.y), g(_.y, p.y), g(E.y, h.y), y(A.y, R.y), I(e.easingFunctions)[0]), new T(g(n.z, r.z), g(d.z, f.z), g(_.z, p.z), g(E.z, h.z), y(A.z, R.z), I(e.easingFunctions)[0]))
                    }
                }(p(p({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var O = {
                ...
                T = function(e) {
                    ...
                    i.animateTo = function(e) {
                        return u.Z.spring(this.animation, p(function(e) {
                            for (var t = 1; t < arguments.length; t++) {
                                var n = null != arguments[t] ? arguments[t] : {},
                                    r = Object.keys(n);
                                "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {

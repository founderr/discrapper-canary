(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [62790], {
                ...
                saveAccountChanges: function(e, t) {
                    ...
                    return (0, u.Z)((function(e) {
                        var t = y(d({
                                ...
                                discriminator: null != j && "" !== j ? j : void 0
                            }),
                            r = o.Z.get(p.JkL),
                            i = (0, a.xJ)();
                        if (null != i && null != r) {
                        ...
                        null != h && null != g && i.Z.dispatch({
                            type: "PASSWORD_UPDATED",
                            userId: t.id
                        });
                        S ? r.close() : r.submitComplete();
                        return e
                    }), (function(e) {
                        i.Z.dispatch({
                            type: "USER_SETTINGS_MODAL_SUBMIT_FAILURE",
            ...
            var j = function(e) {
                ...
                S = function(e) {
                    var t = e.user,
                        ...
                        i = e.speaker,
                        l = e.channelId,
                        s = (0, o.e7)([O.ZP], (function() {
                            return O.ZP.isModerator(t.id, l)
                        })),
                        b = null;
                    r && (b = i ? d.Z.Messages.STAGE_SPEAKER : s ? d.Z.Messages.STAGE_MODERATOR_TOOLTIP : d.Z.Messages.STAGE_AUDIENCE);
                    return (0, n.jsxs)("div", {
                        className: h().user,
        ...
        270897: (e, t, r) => {
            ...
            function m(e) {
                var t, r = e.channel,
                    b = e.transitionState,
                    y = e.onClose,
                    m = j(e, ["channel", "transitionState", "onClose"]),
                    E = (0, i.Dt)(),
                    w = (0, a._d)(r.id),
                    P = (t = h((function() {
        ...
        223219: (e, t, r) => {
            ...
            function D(e) {
                var t, r, n, o, i, c, u = l.default.getCurrentUser();
                if (null == u) return x();
                j = null !== (t = e.section) && void 0 !== t ? t : j;
                Z = null !== (r = e.section) && void 0 !== r ? r : j;
                null != e.subsection && null != j && (S[j] = e.subsection);
                null != e.scrollPosition && null != j && (m[j] = e.scrollPosition);
            ...
            var L = function(e) {
                ...
                n.hasChanges = function() {
                    return null != P && null != w && (!(!this.isOpen() && T !== s.cII.USER_SETTINGS) && !o().isEqual(P, w))
                };
                n.isOpen = function() {
                    return _
                };
                ...
                n.getSubsection = function() {
                    return null != j ? S[j] : null
                };
                n.getScrollPosition = function() {
                    return null != j ? m[j] : null
                };
                ...
                n.getProps = function() {
                    return {
                        ...
                        section: j,
                        subsection: null != j ? S[j] : null,
                        scrollPosition: null != j ? m[j] : null,
                        settings: P,
                        errors: E,
            ...
            const U = new L(c.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    ...
                    null != e.subsection && (S[j] = e.subsection)
                },
                USER_SETTINGS_MODAL_CLEAR_SUBSECTION: function(e) {
                    var t = e.forSection;
                    null != t ? delete S[t] : null != j && delete S[j]
                },
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete m[t] : null != j && delete m[j]
                },
                USER_SETTINGS_MODAL_UPDATE_ACCOUNT: function(e) {
                    var t = e.settings;
                    null == P && (P = {});
                    var r = P[s.oAB.ACCOUNT];
                    P[s.oAB.ACCOUNT] = O({}, r, t)
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    T = e.tab;
                    return null == j && T === s.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

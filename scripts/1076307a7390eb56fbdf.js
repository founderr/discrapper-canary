    ...
    ["95876"], {
        ...
        846883: function(e, t, i) {
            ...
            function H(e, t) {
                ...
                }, [t, e]), Q = (0, x.default)(), q = (0, a.useStateFromStores)([E.default], () => null == e || e.isPrivate() || E.default.can(P.Permissions.SEND_MESSAGES, e), [e]), W = (0, a.useStateFromStoresArray)([O.default], () => [...B.map(e => null != e.application_id && O.default.getState(e.application_id, P.ActivityActionTypes.JOIN) === P.ActivityActionStates.LOADING), ...K.map(e => O.default.getState(e.application_id, P.ActivityActionTypes.JOIN) === P.ActivityActionStates.LOADING)], [B, K]), Z = (0, c.default)([...B.filter(e => (null == e ? void 0 : e.application_id) != null).map(e => e.application_id), ...K.map(e => e.application_id)]), $ = null == e ? void 0 : e.id, ee = (0, a.useStateFromStoresArray)([T.default, v.default, y.default, m.default, h.default, g.default, E.default], () => [...B.map(e => (0, j.default)({
                    user: null != t ? t : k,
                    activity: e,
                ...
                return null == X || X.forEach(i => {
                    ...
                    e.type === P.ActivityTypes.PLAYING && (0, G.default)(e, P.ActivityFlags.JOIN) ? eu.push((0, n.jsx)(l.MenuItem, {
                        id: "invite-to-join",
                        label: w.default.Messages.USER_ACTIVITY_ACTION_INVITE_TO_JOIN,
                        subtext: e.name,
                        action: () => en(P.ActivityActionTypes.JOIN, e)
                    }, "self".concat(t))) : e.type === P.ActivityTypes.LISTENING && (0, G.default)(e, P.ActivityFlags.SYNC) && eu.push((0, n.jsx)(l.MenuItem, {
                        id: "invite-to-listen",
                    ...
                    if (i.type === P.ActivityTypes.PLAYING && (0, G.default)(i, P.ActivityFlags.JOIN) && null != i.session_id && null != i.application_id) {
                        if (ee[a]) {
                            let e = W[a];
                    ...
                    } else if (i.type === P.ActivityTypes.LISTENING && (0, G.default)(i, P.ActivityFlags.SYNC) && null != et[a]) {
                        let d = et[a],
                            {
                                notPlayable: u,
                                playingSameTrack: s,
        ...
        972701: function(e, t, i) {
            ...
            function I(e) {
                let t = (0, a.useStateFromStores)([d.default], () => d.default.getChannels(c.FAVORITES))[c.ChannelTypes.GUILD_CATEGORY].filter(e => "null" !== e.channel.id),
                    ...
                    r = (0, a.useStateFromStores)([u.default], () => u.default.isFavorite(e.id));
                if (__OVERLAY__ || r || !i) return null;
            ...
            function p(e) {
                ...
                return __OVERLAY__ || !t ? null : (0, n.jsx)(l.MenuItem, {
                    ...
                    action: () => (0, l.openModalLazy)(async () => {
                        let {
                            default: t
                        } = await i.el("338052").then(i.bind(i, "338052"));
                        return i => (0, n.jsx)(t, {
                            ...i,
                            onConfirm: () => {
                                i.onClose(), (0, s.removeFavoriteChannel)(e.id)
                            },
                            channel: e
                        })
                    })
        ...
        58622: function(e, t, i) {
            ...
            function f(e) {
                let {
                    ...
                    channel: n,
                    stageInstance: l
                } = e, o = (0, a.useStateFromStores)([u.default], () => u.default.getDefaultChannel(i.id, !0, c.Permissions.CREATE_INSTANT_INVITE)), r = (0, a.useStateFromStores)([s.default], () => (0, d.canViewInviteModal)(s.default, i, n, l)), f = I(t, i, r && null != n ? n : o), _ = p(t);

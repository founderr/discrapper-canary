        ...
        17363: (e, t, n) => {
            ...
            const M = function(e) {
                var t = e.file,
                    ...
                    S = e.onClose,
                    R = e.uploadType,
                    _ = void 0 === R ? p.pC.AVATAR : R,
                    j = e.showUpsellHeader,
                    O = void 0 !== j && j,
                    k = e.analyticsPage,
                    N = C(i.useState({
                        width: 0,
                ...
                i.useEffect((function() {
                    ie && O && h.default.track(y.rMx.OPEN_MODAL, {
                ...
                var ae, oe, ue = function() {
                        switch (_) {
                            case p.pC.BANNER:
                                return {
                                    height: p.f, width: p.L0
                                };
                            ...
                            case p.pC.AVATAR_DECORATION:
                                return {
                                    height: y.dGM, width: y.dGM
                                };
                            case p.pC.GUILD_BANNER:
                                return {
                                    height: p._T, width: p.X_
                                };
                            case p.pC.SCHEDULED_EVENT_IMAGE:
                                return {
                                    height: p.xT, width: p.d6
                                };
                            case p.pC.HOME_HEADER:
                                return {
                                    height: p.Uo, width: p.N8
                                }
                        }
                    },
                    le = i.useCallback((function(e, t, n) {
                        te.current = (0, f.U$)(e, t, n);
                    ...
                    fe = (oe = (ae = function() {
                        ...
                        return L(this, (function(l) {
                            switch (l.label) {
                                ...
                                case 1:
                                    l.trys.push([1, 4, , 5]);
                                    return [4, (0, f.$p)(t, e, P, te.current, n)];
                                case 2:
                                    i = l.sent(), a = i.result, o = i.cancelFn;
                                    re.current = o;
                                    return [4, a];
                                case 3:
                                    r = l.sent();
                    ...
                    children: (0, r.jsxs)(o.ModalRoot, {
                        ...
                        children: [O && (0, r.jsx)(c.Z, {
                            ...
                            children: (0, r.jsx)(o.FormTitle, {
                                ...
                                children: A.Z.Messages.AVATAR_UPLOAD_EDIT_MEDIA
                            })
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)("img", {
                                    style: x({
                                        ...
                                        if (null == $) return {};
                                        var e, t = $.width / $.height,
                                            n = (e = ue()).width !== e.height && t > p.MY ? P.height / $.height : 1;
                                        return {
                                            width: $.width * z * n,
                                            minWidth: $.width * z * n,
                                            height: $.height * z * n
                                    ...
                                    className: _ === p.pC.AVATAR ? m().overlayAvatar : m().overlayBanner,
                                    style: {
                                        opacity: null == $ ? 0 : 1,
                                        width: P.width,
                                        height: P.height
                                ...
                                children: [(0, r.jsx)(s.Z, {
                                    ...
                                    asValueChanges: function(e) {
                                        if (null != $) {
                                            var t = $.width,
                                                ...
                                                o = i.x,
                                                u = i.y;
                                            (0, a.inRange)(o, r.right, r.left) && (0, a.inRange)(u, r.top, r.bottom) || le(o, u, r);
                                            F(e);
                                            B(r)
                                        }
                                    },
                                    ...
                                    equidistant: !0,
                                    hideBubble: !0,
                                    "aria-label": A.Z.Messages.FORM_LABEL_AVATAR_SIZE
                                }), (0, r.jsx)(s.Z, {
                                    className: m().icon,
                                    width: 48,
                                    height: 48
                            ...
                            children: [E ? (0, r.jsx)(o.Button, {
                                ...
                                children: A.Z.Messages.AVATAR_UPLOAD_SKIP
                            }) : null, (0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsx)(o.Button, {
                                    ...
                                    children: A.Z.Messages.AVATAR_UPLOAD_CANCEL
                                }), (0, r.jsx)(o.Button, {
                                    submitting: J,
                                    size: o.ButtonSizes.SMALL,
                                    onClick: fe,
                                    children: A.Z.Messages.AVATAR_UPLOAD_APPLY
                                })]
                            })]
                        })]
                    })

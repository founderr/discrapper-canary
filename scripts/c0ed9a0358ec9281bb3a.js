    ...
    ["67131"], {
        ...
        57155: function(e, t, n) {
            ...
            let ee = m.default.connectStores([L.default], e => {
                let {
                    ...
                    reaction: n,
                    reactionType: i
                } = e, a = L.default.getReactions(t.getChannelId(), t.id, n.emoji, z.DEFAULT_NUM_REACTION_USERS, i);
                if (null == a) return {
                    reactors: [],
                    hasMore: !1
                };
            ...
            function et(e) {
                ...
                let {
                    ...
                    onClose: o,
                    transitionState: r
                } = e, u = (0, m.useStateFromStores)([b.default], () => b.default.getChannel(s.getChannelId())), c = null == u ? void 0 : u.getGuildId(), d = (0, m.useStateFromStores)([P.default, C.default, A.default], () => {
                    var e, t, n;
                    let i = null !== (n = null !== (t = P.default.getMessage(s.getChannelId(), s.id)) && void 0 !== t ? t : null === (e = C.default.getMessage(s.id)) || void 0 === e ? void 0 : e.firstMessage) && void 0 !== n ? n : null != c ? A.default.getCachedMessage(c, s.getChannelId(), s.id) : void 0;
            ...
            let l = e => {
                ...
                return (0, i.jsxs)("svg", {
                    ...
                    children: [(0, i.jsx)("path", {
                        d: "M19.3786 11.3787C20.5502 12.5503 22.4497 12.5503 23.6212 11.3787L23.6464 11.3536C23.8416 11.1583 23.8416 10.8417 23.6464 10.6465L13.3535 0.35354C13.1582 0.158276 12.8417 0.158276 12.6464 0.353541L12.6212 0.378695C11.4497 1.55027 11.4497 3.44975 12.6213 4.62132L12.9999 4.99999L10.0832 7.91668L6.43283 7.58482C5.84171 7.53108 5.25726 7.74268 4.83756 8.16238L4.20703 8.79289C3.8165 9.18342 3.81649 9.81659 4.20702 10.2071L13.7928 19.7929C14.1834 20.1834 14.8165 20.1834 15.207 19.7929L15.8375 19.1624C16.2572 18.7427 16.4688 18.1582 16.4151 17.5671L16.0832 13.9167L18.9999 11L19.3786 11.3787Z",
                        fill: "string" == typeof l ? l : l.css,
                        className: o
                    }), (0, i.jsx)("path", {
                        d: "M9.06866 17.0687C9.29176 17.2918 9.25498 17.6633 8.99245 17.8383L3.84098 21.2726C3.64267 21.4048 3.37861 21.3787 3.21008 21.2102L2.78977 20.7898C2.62123 20.6213 2.59509 20.3573 2.72729 20.1589L6.16161 15.0075C6.33663 14.7449 6.70808 14.7082 6.93119 14.9313L9.06866 17.0687Z",
                        fill: "string" == typeof l ? l : l.css,
                        className: o
                    })]
                })
        ...
        58533: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    startPosition: E,
                    targetPosition: p
                } = e, [_, g] = a.useState(0), [S, C] = a.useState(0), [I, A] = a.useState(null), {
                    confettiCanvas: N
                } = a.useContext(u.ConfettiCannonContext), O = (0, s.useConfettiCannon)(N, I), v = a.useMemo(() => {
        ...
        331011: function(e, t, n) {
            ...
            function m(e, t) {
                ...
                let _ = {
                    ...
                    C = Math.max(0, S - p.length),
                    I = (0, s.getReactionEmojiName)(t);
                if (1 === p.length) return C > 0 ? null != m ? g.reactionTooltip1NInteractive.format({
                    a: p[0],
                    n: C,
                    emojiName: I,
                    onClick: m
                ...
                if (2 === p.length) return C > 0 ? null != m ? g.reactionTooltip2NInteractive.format({
                    a: p[0],
                    b: p[1],
                    n: C,
                    emojiName: I,
                ...
                if (3 === p.length) return C > 0 ? null != m ? g.reactionTooltip3NInteractive.format({
                    a: p[0],
                    b: p[1],
                    c: p[2],
                    n: C,
        ...
        350134: function(e, t, n) {
                        ...
                        children: [(0, i.jsx)(h.Popout, {
                            ...
                            children: () => (0, i.jsx)("div", {
                                ...
                                children: (0, i.jsx)(r.default.div, {
                                    className: l(L.reaction, p, {
                                        [L.reactionMe]: this.isMe(),
                                        [L.reactionReadOnly]: m && !f && !E && !R,
                                        [L.shakeReaction]: C && N && null == v
                                    }),
                                    style: P,
                                    children: (0, i.jsx)(h.Popout, {
                ...
                constructor(...e) {
                    super(...e), this.isReactionEventActive = !1, this.isKeyboardNavigation = !1, this.scale = new r.default.Value(1), this.opacity = new r.default.Value(1), this.timeout = new m.Timeout, this.hideTimeout = new m.Timeout, this.ctaRef = a.createRef(), this.type = $.ReactionTypes.NORMAL, this.colors = {
                        ...
                        let R = t.getChannelId(),
                            E = r ? P.ReactionLocations.FORUM_TOOLBAR : P.ReactionLocations.MESSAGE;
                        if (a && !i && this.isMe()) c ? (0, P.removeReaction)(R, t.id, n, void 0, E, {
                            burst: a
                            ...
                            if (a && !this.userCanBurstReact()) {
                                ...
                                return
                            } else s ? this.handleShowVerificationGate() : !i && (this.isMe() ? (0, P.removeReaction)(R, t.id, n, void 0, E) : (0, P.addReaction)(R, t.id, n, E, {
                                burst: a
                            }))
                        } else {
            ...
            let eE = a.memo(e => {
                    let {
                        ...
                        autoTrackExposure: !1
                    }), T = (0, A.useEmojiColorPalette)(l && null != n ? n : []), R = (0, c.useStateFromStores)([Z.default], () => void 0 !== Z.default.getEffectForEmojiId(a.getChannelId(), a.id, s)), _ = (0, c.useStateFromStores)([p.default], () => p.default.useReducedMotion), S = B.AnimateEmoji.useSetting(), C = (0, g.isDismissibleContentDismissed)(d.DismissibleContent.BURST_REACTIONS_REMOVE_MODAL), [I, N] = (0, c.useStateFromStoresArray)([Q.default], () => [Q.default.remainingBurstCurrency, Q.default.emojiReactionToTargetForCoachmark]), O = G.default.getCurrentUser(), M = (0, X.isPremium)(O), j = (0, g.isDismissibleContentDismissed)(d.DismissibleContent.SUPER_REACTIONS_FREE_USER_FIRST_SENT), x = o && !(0, X.isNewUser)(O) && I > 0 && !j && null != N && s.id === N.id && s.name === N.name;
                ...
                e_ = e => {
                    ...
                    } = (0, c.useStateFromStoresObject)([C.default, w.default], () => {
                    ...
                    return A ? (0, i.jsxs)("div", {
                        children: [p ? P() : null, R ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                        ...
                        children: [L ? P() : U(), R ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                            className: eu.emojiDetailsLoader
                        }) : L && (0, i.jsx)(ep, {
                            emojiId: n,
                            expressionSourceGuild: d,
        ...
        81924: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                E = a.memo(function(e) {
                    ...
                    } = (0, o.useBurstReactionsExperiment)(null, !1), C = (0, s.useStateFromStores)([d.default], () => d.default.getEffectForEmojiId(t, n, E)), I = p ? R : T, A = a.useMemo(() => (0, h.buildEffect)(E, _, t, {
                        key: C,
                        messageId: n
                    }), [_, C, E, t, n]), [N, O] = a.useState(!1), v = (0, s.useStateFromStores)([r.default], () => r.default.useReducedMotion), M = c.AnimateEmoji.useSetting(), j = a.useCallback(() => {
                        l.default.dispatch({
                    ...
                    }, [M, t, g, E, E.name, S, N, n, v]), null == C) ? null : (0, i.jsx)(f.default, {
                        className: I.effect,
                        effect: A,
                        onComplete: j
                    })
        ...
        166257: function(e, t, n) {
            ...
            function O(e) {
                ...
                return null == a ? C.Endpoints.REACTIONS(t, n, o) : s ? C.Endpoints.REACTION_WITH_TYPE(t, n, o, a, l) : C.Endpoints.REACTION(t, n, o, a)
            }
            async function v(e) {
                let {
                    channelId: t,
            ...
            async function y(e, t, n, i) {
                ...
                s.default.delete({
                    url: C.Endpoints.REMOVE_EMOJI_REACTIONS(e, t, l),
                    oldFormErrors: !0
                }).catch(i => {
                    A(i, () => y(e, t, n, {
                        isRetry: !0

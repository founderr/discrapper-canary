        ...
        278175: function(e, t, n) {
            ...
            var h = s.memo(function(e) {
                let {
                    ...
                    audio: m
                } = (0, d.useAudioTrimmerStore)(), p = null != m, I = s.useRef(null), g = s.useRef(null), S = s.useRef(null), [N, A] = s.useState(0), [v, C] = s.useState(0), [T, O] = s.useState(0), [L, R] = s.useState(!1), [M, b] = s.useState(!1), [D, y] = s.useState(!1), [U, P] = s.useState(0), [x, w] = s.useState(-1), F = s.useMemo(() => U / h.fineTuningScale, [h.fineTuningScale, U]);
                s.useEffect(() => {
                    if (null == m) return;
                ...
                return s.useEffect(() => {
                    ...
                    let e = setTimeout(() => {
                        L && N == N && -1 === x ? w(N) : D && T == T && -1 === x ? w(T) : M && v == v && -1 === x && w(v)
                    }, h.fineTuningDelay);
                    return () => {
                        clearTimeout(e)
                    }
                }, [h.fineTuningDelay, D, T, x, M, v, L, N]), (0, l.jsxs)("div", {
        ...
        823749: function(e, t, n) {
            ...
            function O(e) {
                ...
                let {
                    ...
                    transitionState: R,
                    showGuildPicker: M = !1
                } = e, [b, D] = s.useState(null !== (n = null !== (t = null == u ? void 0 : u.name) && void 0 !== t ? t : null == O ? void 0 : O.name) && void 0 !== n ? n : ""), [y, U] = s.useState(null !== (i = null == O ? void 0 : O.volume) && void 0 !== i ? i : 1), [P, x] = s.useState(null == O ? void 0 : O.emojiId), [w, F] = s.useState(null == O ? void 0 : O.emojiName), {
                    file: V,
                    loadAudioFromFile: B,
                    maxVolume: G,
                    setMaxVolume: j
                ...
                let ee = function(e) {
                    ...
                    en = null != O,
                    ei = b.length >= 2 && (en || null != V) && null != X && function(e) {
                        if (null == e) return !0;

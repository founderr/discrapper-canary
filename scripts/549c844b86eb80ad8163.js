...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [20182, 68690], {
        ...
        796909: (e, n, t) => {
            ...
            var I = new a.Z((function(e) {
                var n = e.isRequest,
                    t = e.isFavorite;
                return n ? [] : [t ? w.FAVORITE : w.DEFAULT]
            }), (function(e) {
                return -e.lastMessageId
            }));

            function x(e) {
                var n, t, r = null !== (t = null !== (n = v.ZP.lastMessageId(e.id)) && void 0 !== n ? n : e.lastMessageId) && void 0 !== t ? t : e.id,
                    i = e.isMessageRequestTimestamp;
                if (null != i) {
                    var a = o()(i).valueOf(),
                        c = y.Z.fromTimestamp(a);
                    return y.Z.compare(r, c) > 0 ? r : c
                }
                return r
            }

            function S(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : x(e);
                return {
                    channelId: e.id,
                    lastMessageId: n,
            ...
            function Z() {
                ...
                (0, l.cn)() && (0, s.x7)() && O.Z.getAddedToMessages().forEach((function(e) {
                    ...
                    null != n && (0, d.zi)(n.type) && I.set(n.id, S(n))
                }))
            }

            function R() {
                var e = p.Z.getMutablePrivateChannels();
                for (var n in e) I.set(n, S(e[n]))
            }
            var T, _, k, A = (T = [], _ = [], k = [], function() {
                    var e = I.values(w.FAVORITE),
                        n = I.values(w.DEFAULT);
                    if (T !== e || _ !== n) {
                        k = [];
                ...
                L = function(e) {
                    ...
                    r.initialize = function() {
                        this.waitFor(p.Z, h.Z, b.default, u.Z, O.Z);
                    ...
                    r.getSortedChannels = function() {
                        return [I.values(w.FAVORITE), I.values(w.DEFAULT)]
                    };
                    r.serializeForOverlay = function() {
                        var e = {};
                        I.values().forEach((function(n) {
                            var t = n.channelId,
                                r = n.lastMessageId;
                            e[t] = r
                        }));
            ...
            const D = new L(c.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, d.hv)(e.type) || I.has(e.id)) && I.set(e.id, S(e))
                    }))
                },
                CHANNEL_CREATE: function(e) {
                    var n = e.channel;
                    if (!(0, d.hv)(n.type)) return !1;
                    if (n.id === m.V) return !1;
                    I.set(n.id, S(n))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && I.set(n, S(r, t.id))
                },

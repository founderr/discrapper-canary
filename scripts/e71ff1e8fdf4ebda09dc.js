                ...
                if (e > 1) {
                    if (a + e > (n = this._capacity)) {
                        for (var t = e - 1; t >= 0; t--) {
                            ...
                            this[E = (this._front - 1 & n - 1 ^ n) - n] = arguments[t];
                            a++;
                            this._length = a;
                            this._front = E
                        }
                    ...
                    for (t = e - 1; t >= 0; t--) {
                        var E;
                        this[E = (_ - 1 & n - 1 ^ n) - n] = arguments[t];
                        _ = E
                    }
                    this._front = _;
                    this._length = a + e;
        ...
        753074: r => {
            ...
            r.exports = function(r, n, _) {
                if ("string" != typeof n) {
                    ...
                    t && (E = E.concat(Object.getOwnPropertySymbols(n)));
                    for (var o = 0; o < E.length; ++o)
                        if (!(a[E[o]] || e[E[o]] || _ && _[E[o]])) try {
                            r[E[o]] = n[E[o]]
                        } catch (r) {}
                }
                return r

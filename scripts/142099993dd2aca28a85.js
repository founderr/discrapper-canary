    ...
    ["53827"], {
        ...
        892845: function(e, t, a) {
            ...
            function p(e) {
                let t, {
                    ...
                    [U, b] = n.useState(y ? C.PomeloModalSlides.SUGGESTIONS : C.PomeloModalSlides.INFO),
                    [j, k] = n.useState(!1),
                    [D, G] = n.useState(null),
                ...
                n.useEffect(() => {
                    w === R.EditState.EDIT_USERNAME && H(!0), g.default.track(v.AnalyticEvents.POMELO_EDIT_STEP_VIEWED, {
                        source: a,
                        step: w
                    })
                }, [w, a]), n.useEffect(() => {
                ...
                let [K, Q] = n.useState({
                    ...
                    if (K.globalName.length <= 0) {
                        ...
                        G(e), g.default.track(v.AnalyticEvents.POMELO_ERRORS, {
                            reason: e,
                    ...
                    try {
                        ...
                        g.default.track(v.AnalyticEvents.POMELO_ERRORS, {
                            reason: t,
                            display_name_error: !0,
                            location: "modal"
                        }), G(t)
                    ...
                    try {
                        ...
                        G(t), g.default.track(v.AnalyticEvents.POMELO_ERRORS, {
                            reason: t,
                            username_error: !0,
                            location: "modal",
                            one_click_flow: y
                    ...
                    G(null), U === C.PomeloModalSlides.EDIT_SCREEN ? w === R.EditState.EDIT_USERNAME ? es ? (F(R.EditState.NONE), b(J[Math.max(0, U - 1)].slideId)) : F(R.EditState.EDIT_DISPLAY_NAME) : w === R.EditState.EDIT_DISPLAY_NAME ? (F(R.EditState.NONE), b(J[Math.max(0, U - 1)].slideId)) : w === R.EditState.PREVIEW && F(R.EditState.EDIT_USERNAME) : b(J[Math.max(0, U - 1)].slideId)
                }, [J, U, w, es]), el = n.useCallback(() => {
                    b(C.PomeloModalSlides.FINISH_LATER)
                }, []), er = n.useMemo(() => {
                    if (U === C.PomeloModalSlides.EDIT_SCREEN && w === R.EditState.EDIT_DISPLAY_NAME) return et;
                    if (U === C.PomeloModalSlides.EDIT_SCREEN && w === R.EditState.EDIT_USERNAME) return ea;
                    if (U === C.PomeloModalSlides.SUGGESTIONS && w === R.EditState.SUGGESTION) return ea;
                    else return en
                ...
                return !B && null == D && (w === R.EditState.EDIT_USERNAME ? t = P.default.Messages.POMELO_SUGGESTION_ORIGIN_NOTICE.format({
                    source: Y.username
        ...
        303270: function(e, t, a) {
            ...
            var L = n.forwardRef(function(e, t) {
                ...
                return n.useEffect(() => {
                    if (!F && x === h.EditState.PREVIEW) a.username.includes(h.POMELO_KEYWORD) && (B(window.innerWidth / 2 + 150, 0, {
                        velocity: {
                            type: "static-random",
                            minValue: {
                                x: 0,
                ...
                }, [B, x, a, F]), (0, s.jsxs)("div", {
                    className: l(O.userCardContainer, {
                        [O.shinyCard]: x === h.EditState.PREVIEW
                    }),
                    children: [(0, s.jsxs)("div", {
                        ...
                        children: [(0, s.jsx)(E.default, {
                            ...
                            profileType: I.UserProfileTypes.POMELO_POPOUT,
                            animateOnHover: !1
                        }), x === h.EditState.PREVIEW && null != V && (0, s.jsx)("div", {
                    ...
                    }), x !== h.EditState.PREVIEW && (0, s.jsxs)(r.animated.div, {
                        style: {
                            opacity: G.opacity,
                            y: G.y
                        },
                        className: O.inputContainer,
                        children: [x === h.EditState.EDIT_DISPLAY_NAME && (0, s.jsxs)(s.Fragment, {
                        ...
                        }), (x === h.EditState.EDIT_USERNAME || x === h.EditState.SUGGESTION) && (0, s.jsxs)(s.Fragment, {
                            children: [(0, s.jsx)(d.Text, {
                                className: O.textPadding,
                                color: "text-muted",
                                variant: "text-sm/semibold",
                            ...
                            children: (() => {
                                ...
                                if (null != p) {
                                    if (x !== h.EditState.SUGGESTION) return (0, s.jsx)(d.Text, {
                                ...
                                return null == p && null == i && (x === h.EditState.EDIT_USERNAME || x === h.EditState.SUGGESTION) ? (0, s.jsx)(_.default, {
                                    username: U,
                                    oneClickFlow: y
                                }) : null
                            })()
                        })]
                    }), x === h.EditState.PREVIEW && (0, s.jsxs)("div", {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [27764], {
                ...
                y = function() {
                    ...
                    t.loadComplete = function(e) {
                        var t, n, r, a, c, s, f, d, p, h, _, E = this,
                            ...
                            A = o()(m).reverse().map(i.getCurrentConfig({
                                location: "2ecb25_2"
                            }, {
                                autoTrackExposure: !1
                            }).enabled ? function(e) {
                            ...
                            R = null;
                        return R = (R = (y || O) && null == I && this.ready ? this.merge(A, y, !0) : this.reset(A)).mutate({
                            ready: !0,
                            loadingMore: !1,
                            jumpType: null !== (f = null == I ? void 0 : I.jumpType) && void 0 !== f ? f : u.S.ANIMATED,
                            jumpFlash: null !== (d = null == I ? void 0 : I.flash) && void 0 !== d && d,
                            jumped: null != I,
                            jumpedToPresent: null !== (p = null == I ? void 0 : I.present) && void 0 !== p && p,
                            ...
                            hasMoreBefore: null == I && O ? R.hasMoreBefore : T,
                            hasMoreAfter: null == I && y ? R.hasMoreAfter : b,
                            cached: S,
            ...
            const F = new(function(e) {
                ...
                r.startQueueMetricTimers = function(e) {
                    var t = j.map((function(e) {
                        return setTimeout((function() {
                            (0, l.yw)(g.rMx.SEND_MESSAGE_QUEUED, {
                ...
                r.createResponseHandler = function(e, t) {
                    ...
                    return function(r) {
                        ...
                        (null == r.body || r.body.code !== g.evJ.SLOWMODE_RATE_LIMITED && r.body.code !== g.evJ.CHANNEL_FOLLOWING_EDIT_RATE_LIMITED) && 429 === r.status ? t({
                ...
                r.handleSend = function(e, t) {
                    ...
                    if (s.ZP.get("send_fail_100")) {
                        ...
                        null != M && (M.isInstanceUILocked() ? h = {
                            location: N.OVERLAY_LOCKED_ACTIVATED
                        } : M.isInstanceUILocked() || (h = M.isPinned(g.Odu.TEXT) ? {
                            location: N.OVERLAY_UNLOCKED_PINNED
                        } : {
                            location: N.OVERLAY_UNLOCKED
                        }));
                        var _ = this.createResponseHandler(e.nonce, t),
                            E = new AbortController;
                        this.startQueueMetricTimers(e.nonce);
                        if (null != o && null != a && "" !== a) u.ZP.post({
                            url: g.ANM.MESSAGES(r),
                ...
                r.handleCommand = function(e, t) {
                    ...
                    if (null != f) {
                        ...
                        n = [];
                        var y = f;
                        m.data.attachments = y.map((function(e, t) {
        ...
        384482: (e, t, n) => {
            ...
            var I = a.parse(location.search.slice(1)),
                T = parseInt(null != I.rpc && "" !== I.rpc ? I.rpc : d.V6Z, 10),
                b = null;
        ...
        598143: (e, t, n) => {
            ...
            0;
            var C, w = new a.Z("CloudUpload.tsx"),
                P = n(392445).Z;
            ! function(e) {
            ...
            var N = function(e) {
                            ...
                            switch (E.label) {
                                ...
                                case 3:
                                    ...
                                    if (null == t.filename || "" === t.filename || 0 === e.currentSize) {
                                        w.error("File does not have a filename or size is 0.", JSON.stringify(t));
                                ...
                                case 4:
                                    E.trys.push([4, 6, , 7]);
                                    w.log("Requesting upload url for ".concat(e.id));
                                ...
                                case 6:
                                    ...
                                    if ((f = null !== (c = null == i || null === (a = i.body) || void 0 === a ? void 0 : a.code) && void 0 !== c ? c : i.status) !== h.evJ.ENTITY_TOO_LARGE) {
                                        w.error("Requesting upload url failed with code ".concat(null != f ? f : JSON.stringify(i.body), " for ").concat(e.id));
                                ...
                                case 9:
                                    ...
                                    if (e.status === C.CANCELED) e.handleComplete(_);
                                        ...
                                        w.info("Error: status ".concat(_.status, " for ").concat(e.id));
                                        e.handleError(_)
                                    }
                                    return [3, 10];
                                case 10:
                            ...
                            switch (d.label) {
                                case 0:
                                    ...
                                    if (!0 === e.reactNativeFilePrepped) {
                                        w.log("reactNativeCompressAndExtractData() file already prepped - ".concat(e.id));
                                        return [2]
                                    }
                                    w.log("Starting compression/conversion for ".concat(e.id));
                                ...
                                case 1:
                                    ...
                                    if (null == o || null == r || null == i) {
                                        w.error("Insufficient file data: ".concat({
                                            filename: o,
                                            uri: r,
                                            mimeType: i
                                        }, " for ").concat(e.id));
                                ...
                                case 4:
                                    ...
                                    e.currentSize = a;
                                    if (null == a) {
                                        w.error("Size missing from file data for ".concat(e.id));
                                        throw new Error("Size missing from file data")
                                    }
                                    w.log("Completed compression and conversion. Output size=".concat(a, " bytes; filename=").concat(o, " for ").concat(e.id));
                                    s = {
                                        uri: r,
                                        filename: o,
                                        mimeType: i
                ...
                r.resetState = function() {
                    ...
                    return m(y(n.prototype), "resetState", this).call(this)
                };
                r.delete = function() {
                    var e = this;
                    return v((function() {
        ...
        861323: (e, t, n) => {
            ...
            var r, o, i, u, a, l, c = n(608575),
                ...
                b = M(window.GLOBAL_ENV.INVITE_HOST),
                S = M(window.GLOBAL_ENV.GUILD_TEMPLATE_HOST),
                A = M(null !== (r = window.GLOBAL_ENV.WEBAPP_ENDPOINT) && void 0 !== r ? r : "//canary.".concat(E.$R1)),
                R = M("//canary.".concat(E.$R1)),
                C = M("//ptb.".concat(E.$R1)),
                w = M("discordapp.com"),
                P = M("discord.com"),
                N = [p.Z.escape(null !== (o = b.host) && void 0 !== o ? o : ""), p.Z.escape(null !== (i = S.host) && void 0 !== i ? i : ""), p.Z.escape(null !== (u = A.host) && void 0 !== u ? u : ""), p.Z.escape(null !== (a = w.host) && void 0 !== a ? a : ""), p.Z.escape(null !== (l = P.host) && void 0 !== l ? l : "")].filter(Boolean),
                L = new RegExp("((https?://[^ ]*)|^|[^/][^/.])(".concat(N.join("|"), ")"), "g");
            ...
            function U(e) {
                var t, n, r, o;
                return null !== (o = null !== (r = null !== (n = null !== (t = D(A, e)) && void 0 !== t ? t : D(R, e)) && void 0 !== n ? n : D(C, e)) && void 0 !== r ? r : D(w, e)) && void 0 !== o ? o : D(P, e)
            }
                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, y, N, M, U = D(b, p),
                                F = D(S, p),
                                G = null !== (M = null !== (N = null !== (y = null !== (E = D(A, p)) && void 0 !== E ? E : D(R, p)) && void 0 !== y ? y : D(C, p)) && void 0 !== N ? N : D(w, p)) && void 0 !== M ? M : D(P, p),
                                B = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
                            ...
                            null != (null == F ? void 0 : F.match(v)) && B(_.g.TEMPLATE, F.substring(1));
                            var k = null == G ? void 0 : G.match(m);
                            if (null != k) {
                            ...
                            null != (null == G ? void 0 : G.match(g)) && B(_.g.CHANNEL_LINK, G.replace("/channels/", ""));
                            var H = j(p.pathname);
        ...
        269300: (e, t, n) => {
            ...
            function M(e) {
                var t, n, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : w;
                if (r !== w && (null === (t = N.orphaned) || void 0 === t ? void 0 : t.has(e))) {
                    D(e, r);
                    U(e, w)
                }
                return Boolean(null === (n = N[r]) || void 0 === n ? void 0 : n.has(e))
            }

            function D(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : w;
                null == N[t] && (N[t] = new Set);
                N[t].add(e);
                P += 1
            }

            function U(e) {
                var t, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : w;
                null === (t = N[n]) || void 0 === t || t.delete(e);
                P += 1
            }
            var j = {};
            ...
            var x = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        scheduledEventIndex: S,
                        guildScheduledEvents: A,
                        ORPHANED_GUILD_ID: w,
                        guildScheduledEventRSVPVersion: P,
                        guildScheduledEventRSVPs: N,
                        previousDirectoryGuildEventsSnapshot: L,
                        usersForGuildEvent: j
                    }
                };
                return n
            }(i.ZP.Store);
            x.displayName = "GuildScheduledEventStore";
            const Y = new x(a.Z, {
                ...
                GUILD_SCHEDULED_EVENT_USERS_FETCH_SUCCESS: function(e) {
                    var t, n = e.guildEventId,
                        r = e.rsvpUsers,
                        o = e.guildId;
                    t = v(E({}, j), h({}, n, r.reduce((function(e, t) {
                ...
                EVENT_DIRECTORY_FETCH_SUCCESS: function(e) {
                    ...
                    try {
                        for (var a, l = n[Symbol.iterator](); !(r = (a = l.next()).done); r = !0) {
                            var c = a.value;
                            R(c);
                            null != c.user_rsvp ? D(c.id, c.guild_id) : U(c.id, c.guild_id)
                        }
                    } catch (e) {
                        i = !0;
                        u = e
        ...
        327930: (e, t, n) => {
            ...
            var r = n(61209),
                ...
                _ = new RegExp("^https://(?:canary\\.|ptb\\.)?discord.com/channels/(\\d+|".concat(a.ME, ")(?:/(\\d+|[a-zA-Z-]+))?(?:/(\\d+|[a-zA-Z-]+))?")),
                ...
                b = function(e) {
                    ...
                    r.__getLocalVars = function() {
                        return {
                            initialState: E,
                            state: v,
                            handleSetCreditBalance: g,
                            handleFetchFromAPI: m,
                            handleEmojiPickerBurstToggle: y,
                            handleShowFreeUserSentPopout: O,
                            handleGuildPreviewSet: I,
        ...
        649536: (e, t, n) => {
            ...
            function L(e) {
                return null == e.author ? N : null != e.webhook_id ? new c.Z(e.author) : null !== (t = I.default.getUser(e.author.id)) && void 0 !== t ? t : new c.Z(e.author);
                var t
            }
            ...
            function M(e) {
                var t, n, r, i, a, l, c, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    I = e.type === R.uaV.THREAD_CREATED ? [] : (0, u.ZP)(e.content),
                    T = L(e),
                    A = null,
                    C = null != e.interaction ? v.createFromServer(e.interaction) : null,
                    N = e.type === R.uaV.THREAD_STARTER_MESSAGE ? null === (n = e.referenced_message) || void 0 === n || null === (r = n.author) || void 0 === r ? void 0 : r.id : void 0,
                ...
                return new g.Z(P(w({}, e, A), {
                    author: T,
                    webhookId: e.webhook_id,
                    blocked: O.Z.isBlocked(e.author.id) || null != N && O.Z.isBlocked(N),
                    timestamp: y,
            ...
            function D(e, t) {
                return null != t.edited_timestamp ? P(w({}, t), {
        ...
        708299: (e, t, n) => {
            ...
            var h = function(e) {
                ...
                r.__getLocalVars = function() {
                    return {
                        previews: d,
                        threadCreationPreviews: p,
                        stickerMessagePreviewStore: _
                    }
                };
                return n
            }(r.Z.Store);
        ...
        513586: (e, t, n) => {
            ...
            var r = n(179936),
                ...
                v = p.ASSET_ENDPOINT,
                g = p.CDN_HOST,
                m = Object.values(s.og),
                y = decodeURIComponent(d.ANM.STICKER_ASSET("[\\d]+", "(".concat(m.join("|"), ")"))),
                O = new RegExp("(".concat(location.protocol).concat(v, "|").concat(location.protocol).concat(_, ")(").concat(y, ")"), "ig"),
                I = new RegExp("".concat(location.protocol).concat(h, "(").concat(y, ")"), "ig"),
                T = function(e) {
                ...
                C = function(e, t) {
                    ...
                    if (null == r) return null;
                    var i = a.$k ? "webp" : "png";
                    n = null != g ? "".concat(location.protocol, "//").concat(g, "/app-assets/").concat(f.Ks, "/store/").concat(r, ".").concat(i) : "".concat(location.protocol).concat(h).concat(d.ANM.STORE_ASSET(f.Ks, r, i));
                    null != t && (n += "?size=".concat((0, o.oO)(t)));
                    return n
                },
                w = function(e) {
                    return e.match("development" !== E ? O : I)
                },
                P = function(e) {
        ...
        284610: (e, t, n) => {
            ...
            var P = function(e) {
                            ...
                            for (var r, o = Object.entries(b)[Symbol.iterator](); !(e = (r = o.next()).done); e = !0) {
                                ...
                                try {
                                    for (var f, d = Object.entries(a)[Symbol.iterator](); !(l = (f = d.next()).done); l = !0) {
                                        var p = m(f.value, 2),
                                            h = p[0],
                                            _ = p[1][I.ChannelMessage];
                                        null != _ && ("" !== _.draft && "" !== _.draft.trim() || R(h, I.ChannelMessage, u))
                                    }
                                } catch (e) {
                                    c = !0;
                                    s = e
                ...
                r.getThreadSettings = function(e) {
                    ...
                    if (null == t) return null;
                    var n = S(t)[e];
                    return null == n ? null : n[I.ThreadSettings]
                };
                r.__getLocalVars = function() {
                    return {
                        MAX_DRAFT_SIZE: T,
            ...
            P.migrations = [function(e) {
                if (null == e) return {};
                for (var t in e) "timestamp" in e[t] && (e[t] = h({}, I.ChannelMessage, e[t]));
                return e
            }, function(e) {
                var t = l.default.getId();
            ...
            const N = new P(u.Z, {
                ...
                THREAD_CREATE: function(e) {
                    ...
                    var r = S(n),
                        o = r[t.parent_id];
                    if (null == o) return !1;
                    var i = o[I.ThreadSettings];
                    if (null == i) return !1;
                    if (i.parentMessageId !== t.id) return !1;
                    var u, a, c = r[t.parent_id];
                    if (null == c) return !1;
                    var s = null !== (a = null === (u = c[I.FirstThreadMessage]) || void 0 === u ? void 0 : u.draft) && void 0 !== a ? a : "";
                    "" !== s && (r[t.id] = h({}, I.ChannelMessage, {
                        timestamp: Date.now(),
                        draft: s
                    }));
                    R(t.parent_id, I.ThreadSettings);
                    R(t.parent_id, I.FirstThreadMessage)
                },
                DRAFT_SAVE: A,
                DRAFT_CHANGE: A,
                ...
                THREAD_SETTINGS_DRAFT_CHANGE: function(e) {
                    ...
                    if (null != r) {
                        var o = S(r),
                            i = o[t];
                        null == i && (i = o[t] = {});
                        i[I.ThreadSettings] = E(function(e) {
                            for (var t = 1; t < arguments.length; t++) {
                                var n = null != arguments[t] ? arguments[t] : {},
                                    r = Object.keys(n);
                                "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
        ...
        757753: (e, t, n) => {
            ...
            function m(e, t) {
                ...
                t(a);
                E = f(s({}, E), l({}, e, a));
                null != (null === (n = a.guild) || void 0 === n ? void 0 : n.id) && (g = f(s({}, g), l({}, a.guild.id, e)))
            }
            ...
            const I = new O(o.Z, {
                ...
                FRIEND_INVITE_CREATE_SUCCESS: function(e) {
                    return m(e.invite.code, (function(t) {
                        t.state = u.r2o.RESOLVED;
                        t.inviter = e.invite.inviter
                    }))
                },
                    ...
                    o().forEach(V, (function(e, o) {
                        ...
                        try {
                            for (var f, d = function() {
                                    ...
                                    a = n = !0;
                                    var l = u().v4();
                                    r = new b(L(N({}, t.getWidgetDefaultSettings(e)), {
                                        type: e,
                                        id: l,
                                        layoutId: o,
                                        zIndex: i.length
            ...
            q.migrations = [function() {
                ...
                i.forEach((function(e) {
                    ...
                    r.widgets.find((function(e) {
                        ...
                        if (null == t) return !1;
                        null == a && t[1].type === A.Odu.VOICE && (a = t[0]);
                        null == i && t[1].type === A.Odu.TEXT && (i = t[1].pinned);
                        return null != i && null != a || void 0
                    }));
                    if (!i && null != a) {
                        var l = u().v4();
                        r.widgets = [a, l];
                        o.push([l, L(N({}, K(A.Odu.GUILDS_TEXT)), {
                            type: A.Odu.GUILDS_TEXT,
                            id: l,
                            layoutId: n,
                            zIndex: 2
                        })])
            ...
            const Q = new q(c.Z, {
                LAYOUT_CREATE: function(e) {
                    ...
                    n.forEach((function(e, t) {
                        ...
                        "" === i.id && (i.id = u().v4());
                        if (null != n) {
                            i.pinned = n.pinned; - 1 !== n.anchor.left && (i.anchor = (0, S.jL)(n.anchor, r)); - 1 !== n.size.width && (i.size = (0, S.Ox)(n.size, r))
                        }
                        k = L(N({}, k), w({}, i.id, new b(i)));
                        o.push(i.id)
                    }));
                    V = L(N({}, V), w({}, t, new E({
                        id: t,
                ...
                LAYOUT_SET_PINNED: function(e) {
                    return z(e.widgetId, (function(e, t) {
                        ! function(e) {
                            k = L(N({}, k), w({}, e.id, e.set("pinned", !e.pinned)))
                        }(e)
                    }))
                },
                ...
                LAYOUT_CREATE_WIDGETS: function(e) {
                    e.widgetConfigs.forEach((function(e) {
                        ...
                        V = L(N({}, V), w({}, n.id, n.set("widgets", r)))
                    }))
                }
            })
        },
        352980: (e, t, n) => {
            ...
            function W(e) {
                ...
                u = u.update(o, (function(e) {
                    ...
                    "MESSAGE_SEND_FAILED_AUTOMOD" === t && (e = e.set("flags", (0, g.pj)(e.flags, P.iLy.EPHEMERAL)));
                    return e
                }));
                a.Z.commit(u)
            }
            var K = function(e) {
                ...
                r.initialize = function() {
                    this.waitFor(w.default, y.Z, O.Z, T.ZP, v.default, R.Z, C.Z, b.Z, A.Z, I.ZP);
                ...
                r.getMessages = function(e) {
                    if (d.Z.hasViewingRoles()) {
                        ...
                        if (d.Z.isViewingRoles(n) && !S.Z.can(P.Plq.VIEW_CHANNEL, t)) return new a.Z(e)
                    }
                ...
                r.getLastEditableMessage = function(e) {
                    var t = w.default.getCurrentUser();
            ...
            const q = new K(u.Z, {
                ...
                MESSAGE_SEND_FAILED: function(e) {
                    ...
                    o = o.update(n, (function(e) {
                        (e = e.set("state", P.yb.SEND_FAILED)).isCommandType() && (e = (e = e.set("interactionError", null != r ? r : "")).set("flags", (0, g.pj)(e.flags, P.iLy.EPHEMERAL)));
                        return e
                    }));
                    a.Z.commit(o)
                },
        ...
        449852: (e, t, n) => {
            ...
            g.displayName = "PremiumPaymentModalStore";
            const m = new g(o.Z, {
        ...
        674482: (e, t, n) => {
            ...
            var L = {
                    ...
                    displayUserMode: m.OYC.ALWAYS,
                    displayNameMode: m.wC$.ALWAYS,
                    avatarSizeMode: m.ipw.LARGE,
                    notificationPositionMode: m._vf.TOP_LEFT,
                    textChatNotifications: m.Ypu.ENABLED,
            ...
            var Q = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    if (__OVERLAY__) {
                        _.FB && (Z = E.ZP.requireModule("discord_overlay2"));
                        j.delete((0, v.QF)())
                    }
                    if (null != e) {
                        D = e;
                        ...
                        if (null != t) {
                            null == (Y = x(t)).textChatNotifications && (Y.textChatNotifications = L.textChatNotifications);
                            null == Y.textWidgetOpacity && (Y.textWidgetOpacity = L.textWidgetOpacity)
                        }
                    }
                };
                r.getState = function() {
                ...
                r.getTextChatNotificationMode = function() {
                    return Y.notificationPositionMode === m._vf.DISABLED ? m.Ypu.DISABLED : Y.textChatNotifications
                };
                ...
                r.__getLocalVars = function() {
                    return {
                        ...
                        overlay: Z,
                        isDispatching: G,
                        hasReceivedInitialPayload: B,
                        activeRegions: V,
                        isPreviewingInGame: k,
                        currentUserSettings: Y,
                        interceptedActionTypes: H
                    }
                };
                ! function(e, t, n) {
                    t && I(e.prototype, t);
            ...
            const X = new Q(i.Z, {
                ...
                OVERLAY_SET_TEXT_WIDGET_OPACITY: function(e) {
                    var t = e.opacity,
                        n = Y.textWidgetOpacity !== t;
                    Y.textWidgetOpacity = t;
                    return n
                },
        ...
        901654: (e, t, n) => {
            ...
            var m = function(e) {
                ...
                r.isElementFullScreen = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : (0, a.UU)();
                    return g(e).isElementFullscreen
                };
                r.windowSize = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : (0, a.UU)();
                    return g(e).windowSize
                };
                r.__getLocalVars = function() {
                    return {
                        windowStates: v
            ...
            m.displayName = "WindowStore";
            const y = new m(u.Z, {
                WINDOW_INIT: function(e) {
                    o()(!v.has(e.windowId), "Window initialized multiple times");
                    var t = e.width,
                        n = e.height,
        ...
        644144: (e, t, n) => {
            ...
            var b = function(e, t) {
                ...
                S = d.Z.escape(window.GLOBAL_ENV.GIFT_CODE_HOST),
                A = ["discordapp.com/gifts", "discord.com/gifts"].map((function(e) {
                    return d.Z.escape(e)
                })),
                R = [S].concat(I(A)).join("|"),
                ...
                L = [N(4, 4), N(4, 6), N(5, 3), "[a-zA-Z]{4}-?[0-9a-zA-Z]{4}-?[a-zA-Z]{4}"].join("|"),
        ...
        534681: (e, t, n) => {
            ...
            function N(e, t, n, r) {
                ...
                "webp" !== r || C || (r = "png");
                var a = null !== (i = I.env.API_PROTOCOL) && void 0 !== i ? i : location.protocol;
                    ...
                    return R(this, (function(E) {
                        switch (E.label) {
                            case 0:
                                ...
                                n = [];
                                h.Z.hasFetchedPaymentSources || n.push(null !== (r = p.Z.paymentSourcesFetchRequest) && void 0 !== r ? r : (0,
                                    f.tZ)());

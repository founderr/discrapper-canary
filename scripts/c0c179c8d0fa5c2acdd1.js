    ...
    [37246], {
            ...
            const N = {
                ...
                saveAccountChanges: function(e, t) {
                    ...
                    return (0, T.Z)((function(e) {
                        ...
                        var t = e.body,
                            r = t.token;
                        E.default.track(a.rMx.USER_AVATAR_UPDATED, {
                            animated: (0, I.xR)(t.avatar)
                        });
                        delete t.token;
                        o.Z.dispatch({
                            type: "UPDATE_TOKEN",
            ...
            function A(e) {
                return (0, i.cj)([l.default, c.ZP, E.Z, s.Z], (function() {
                    ...
                    var o = l.default.getId(),
                        u = c.ZP.getMember(r, o),
                        a = (0, I.Ow)(null == u ? void 0 : u.flags);
                    ...
                    a.has(O.q.AUTOMOD_QUARANTINED_BIO) && (t.bio = [f.Z.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_BIO]);
                    return t
                }), [e])
            }
                ...
                return [r.useCallback((function() {
                    if (null != O) {
                        var e = T.oAB.PROFILE_CUSTOMIZATION,
                            t = p.NB.GUILD;
                        f ? (0, a.Fq)(O, null != c ? c : I) : t = p.NB.USER_PROFILE;
                        o.Z.open(e, t, {
                            scrollPosition: n,
                            analyticsLocation: l,
        ...
        813659: (e, t, n) => {
            ...
            function R(e) {
                var t, n = e.onClose,
                    ...
                    C = (0, O.no)(g),
                    b = (0, l.Z)(a.Z.AUTOMOD_PROFILE_QUARANTINE_ALERT).analyticsLocations,
                    v = h((0, p.ww)({
                        guildId: m,
                ...
                return null == M ? null : (0, r.jsxs)(u.ModalRoot, {
                    transitionState: S,
        ...
        223219: (e, t, n) => {
            ...
            function y(e) {
                ...
                b = null !== (i = e.analyticsLocation) && void 0 !== i ? i : null;
            ...
            var B = function(e) {
                ...
                r.hasChanges = function() {
                    return null != R && null != h && (!(!this.isOpen() && U !== l.cII.USER_SETTINGS) && !i().isEqual(R, h))
                };
                r.isOpen = function() {
                    return g
                };

        ...
        166240: (e, n, t) => {
                        ...
                        return (0, r.jsxs)(r.Fragment, {
                            children: [(0, r.jsx)(a.MenuGroup, {
                                ...
                                children: [p && (0, r.jsx)(a.MenuCheckboxItem, {
                                    ...
                                    action: function() {
                                        n({
                                            notify_highlights: f ? w.gLR.ENABLED : w.gLR.DISABLED
                                        })
                                    },
                                    checked: f
                                }), b]
            ...
            function X(e) {
                var n = function(n) {
                    ...
                    i = function(e) {
                        var n = (0, u.cj)([V.Z], (function() {
                                return {
                                    canManageGuild: V.Z.can(w.Plq.MANAGE_GUILD, e),
                                    canManageRoles: V.Z.can(w.Plq.MANAGE_ROLES, e),
                                    canBanMembers: V.Z.can(w.Plq.BAN_MEMBERS, e),
                                    canManageNicknames: V.Z.can(w.Plq.MANAGE_NICKNAMES, e),
                                    canCreateEmojisAndStickers: V.Z.can(w.Plq.CREATE_GUILD_EXPRESSIONS, e),
                                    canManageEmojisAndStickers: V.Z.can(w.Plq.MANAGE_GUILD_EXPRESSIONS, e),
                                    canManageWebhooks: V.Z.can(w.Plq.MANAGE_WEBHOOKS, e),
                                    canViewAuditLog: V.Z.can(w.Plq.VIEW_AUDIT_LOG, e)
                                }
                            }), [e]),
                            t = n.canManageGuild,
                            r = n.canManageRoles,
                ...
                return n.hasFeature(w.oNc.HUB) ? (0, r.jsxs)(a.Menu, {
                    ...
                    children: [(0, r.jsxs)(a.MenuGroup, {
                        children: [A, (0, r.jsx)(a.MenuItem, {
                            ...
                            action: function() {
                                return (0, a.openModalLazy)(Q((function() {
                                    var e, i;
            ...
            function h(e) {
                ...
                return __OVERLAY__ ? null : e.id === c._ ? (0, r.jsx)(r.Fragment, {
                    children: (0, r.jsx)(o.MenuItem, {
                        ...
                        action: function() {
                            return (0, o.openModalLazy)(d((function() {
                                var e, n;

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["61388"], {
        ...
        545876: function(e, t, l) {
            ...
            class m extends a.Component {
                ...
                render() {
                    let {
                        ...
                        isDiscount: S,
                        subscriptionPlan: E,
                        finePrintClassname: _
                    } = this.props, {
                        hasAcceptedEULA: v,
                        hasAcceptedWithdrawalWaiver: C
                    } = this.state;
                    return (c(!g || null != E, "subscriptionPlan cannot be null if shouldShowUpdatedPaymentModal is true"), n || null != e && !a || N) ? (0, s.jsxs)("div", {
                        className: u,
                        children: [N && (0, s.jsx)(o.FormTitle, {
            ...
            var T = u.default.connectStores([d.default], e => {
                let {
                    eulaId: t
                } = e;
                return {
                ...
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        (0, d.installApplication)({
                            ...
                            analyticsLocation: a
                        }), (0, p.transitionTo)(S.Routes.APPLICATION_LIBRARY), this.close()
                    }, this.handleInstall = () => {
                        let {
                            application: e,
                            buildId: t,
        ...
        931138: function(e, t, l) {
            ...
            function o(e) {
                let {
                    ...
                    ...d
                } = e, h = a.Children.only(t), f = (0, r.useRedesignIconContext)().enabled;
                return (0, s.jsxs)("div", {
            ...
            let d = {
                ...
                h = e => {
                    ...
                    if (null != f && (t = function(e) {
                        ...
                        }(f)), null != a && null == t && (t = a.getIconURL(function(e) {
                            switch (e) {
                                case d.XSMALL:
                                    return 24;
                                case d.SMALL:

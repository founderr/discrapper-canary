        ...
        7194: (e, t, r) => {
            ...
            function P(e, t) {
                var l, c = t === E.IlC.POPOUT,
                    ...
                    P = (0, p.e7)([b.Z], (function() {
                        return null != u ? b.Z.getGuildIncident(u.id) : null
                    })),
                    M = (null == u ? void 0 : u.hasFeature(E.oNc.INVITES_DISABLED)) || h && null != (null == P ? void 0 : P.invitesDisabledUntil) && new Date(P.invitesDisabledUntil) > new Date,
                    C = S(o.useState(M), 2),
                    v = C[0],
                    U = C[1],
                    D = (l = g((function(t) {

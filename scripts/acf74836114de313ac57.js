    ...
    [70535], {
                ...
                switch (e.type) {
                    ...
                    case M.cd.MESSAGE_LENGTH_UPSELL:
                        if (t) {
                            ...
                            switch (e.type) {
                                case M.cd.UPLOAD_ERROR_UPSELL:
                                    s = A.Z.Messages.UPLOAD_AREA_PREMIUM_UPSELL_WITH_SIZE_AND_ACTION_V2.format({
                                        planName: (0, C.jP)(e.subscriptionTier),
                                    ...
                                    break;
                                case M.cd.BURST_REACTION_UPSELL:
                                    s = A.Z.Messages.SUPER_REACTIONS_LAUNCH_COACHMARK_DESCRIPTION_CLICK_V2.format({
                                        planName: (0, C.jP)(e.subscriptionTier),
                                        onClick: function() {
                                            var t;
                                            (0, b.uL)(j.Z5c.APPLICATION_STORE);
                                    ...
                                    break;
                                case M.cd.STREAM_QUALITY_UPSELL:
                                    s = A.Z.Messages.STREAM_PREMIUM_UPSELL_WITH_ACTION.format({
                                        onClick: function() {
                                            var t;
                                            (0, b.uL)(j.Z5c.APPLICATION_STORE);
                                            null === (t = e.onClose) || void 0 === t || t.call(e);
                                    ...
                                    break;
                                case M.cd.MESSAGE_LENGTH_UPSELL:
                                    s = A.Z.Messages.PREMIUM_CHAT_PERKS_MAX_MESSAGE_LENGTH_UPSELL.format({
        ...
        223219: (e, t, n) => {
            ...
            function w(e) {
                ...
                A = null !== (n = e.section) && void 0 !== n ? n : y;

    ...
    [56645], {
        ...
        656645: (e, t, n) => {
            ...
            function b(e, t, n, o, r) {
                if (t !== n) {
                    var a = e[t],
                        c = e[n];
                    u.default.track(s.rMx.MEDIA_DEVICE_CHANGED, {
                        device_from_name: i.Z.getCertifiedDeviceName(t, null != a ? a.name : ""),
                        device_to_name: i.Z.getCertifiedDeviceName(n, null != c ? c.name : ""),
                        device_type: o,
                        device_is_certified: i.Z.isCertified(n),
                        location: r
                    })
                }
            }
            ...
            const O = {
                ...
                toggleSelfMute: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        r = e.syncRemote,
                        a = void 0 === r || r;
                    return h() ? Promise.resolve() : c.Z.isEnabled() ? o.Z.dispatch({
                ...
                setLocalPan: function(e, t, n) {
                    var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : f.Yn.DEFAULT;
                    o.Z.dispatch({
                ...
                setMode: function(e) {
                    ...
                    h() || o.Z.dispatch({
                        ...
                        context: n,
                        mode: e,
                        options: _({}, c.Z.getModeOptions(n), t)
                    })
                },
                ...
                setInputDevice: function(e, t) {
                    if (!h()) {
                        if (null != t) {
                            b(c.Z.getInputDevices(), c.Z.getInputDeviceId(), e, "Audio Input", t)
                        }
                        o.Z.dispatch({
                ...
                setOutputDevice: function(e, t) {
                    if (!h()) {
                        if (null != t) {
                            b(c.Z.getOutputDevices(), c.Z.getOutputDeviceId(), e, "Audio Output", t)
                        }
                        o.Z.dispatch({
                ...
                setVideoDevice: function(e, t) {
                    if (!h()) {
                        if (null != t) {
                            b(c.Z.getVideoDevices(), c.Z.getVideoDeviceId(), e, "Video", t)
                        }
                        o.Z.dispatch({
                ...
                setGoLiveSource: function(e) {
                    null != (null == e ? void 0 : e.qualityOptions) && (0, d.Ye)(e.qualityOptions.preset, e.qualityOptions.resolution, e.qualityOptions.frameRate);
                    o.Z.dispatch({
        ...
        660977: (e, t, n) => {
            ...
            var E = function(e, t) {
                ...
                v = new i.Z("AudioActionCreators");

            function h() {
                (0, r.openModalLazy)(l((function() {
                    var e, t;
            ...
            function O() {
                if (c.Z.isSupported()) return !1;
                (0, r.openModal)((function(e) {
                    return (0, o.jsx)(r.ConfirmModal, b(m({
                        header: s.Z.Messages.UNSUPPORTED_BROWSER,
                        ...
                        children: (0, o.jsx)(r.Text, {
                            ...
                            children: s.Z.Messages.UNSUPPORTED_BROWSER_DETAILS
                        })
                    }))
                }));
                return !0
            ...
            function g(e) {
                u.default.track(p.rMx.PERMISSIONS_ACKED, {
                    type: "audio",
                    action: e
                })
            }
            ...
            function y() {
                ...
                u.default.track(p.rMx.PERMISSIONS_REQUESTED, {
                    type: "audio"
                });
                return c.Z.getMediaEngine().enable().then((function() {
                    a.Z.dispatch({
        ...
        292832: (e, t, n) => {
            ...
            function a() {
                return [{
                    value: o.CLASSIC,
                    label: r.Z.Messages.SOUNDPACK_CLASSIC_LABEL
                }, {
                    value: o.DETUNE,
                    label: r.Z.Messages.SOUNDPACK_DETUNE_LABEL
                }]
            }
        },
        669754: (e, t, n) => {
            ...
            var _ = function(e) {
                ...
                o.getSoundpack = function() {
                    var e;
                    return a.Z.getCurrentConfig({
                        location: "37bac2_1"
                    }, {
                        autoTrackExposure: !1
                    }).allowAprilFoolsSoundpack && (e = l.soundpack, Object.values(i.Y).includes(e)) ? l.soundpack : i.Y.CLASSIC
                };
        ...
        716118: (e, t, n) => {
            ...
            function s(e, t) {
                var n, o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1,
                    r = u(t);
                return f(null !== (n = r[e]) && void 0 !== n ? n : e, e, o)
            }
            ...
            function l(e) {
                ...
                if (!d.Z.disableSounds) {
                    var o, a = u(r.Z.getSoundpack()),
                        i = f(null !== (o = a[e]) && void 0 !== o ? o : e, e, t);
                    null != n ? i.playWithListener().then((function(e) {
                        e && n()
                    })) : i.play();
                    return i
                }
        ...
        162383: (e, t, n) => {
            ...
            function d() {
                null != window.navigator.mediaDevices && window.navigator.mediaDevices.enumerateDevices().then((function(e) {
                    var t = a.Z.getOutputDevices(),
                        n = r()(t).sortBy((function(e) {
                            return e.index
                        })).findIndex((function(e) {
                            return e.id === a.Z.getOutputDeviceId()
                        })),
                        o = t[a.Z.getOutputDeviceId()],
                        i = e.filter((function(e) {
                            return "audiooutput" === e.kind && "communications" !== e.deviceId
                        })),
                        c = i[n];
                    null == o || null != c && c.label === o.name || (c = i.find((function(e) {
                        return e.label === o.name
                    })));
                    p = null != c ? c.deviceId : u
                })).catch((function() {
                    p = u
                }))
            }
            if (i.FB) {
                a.Z.addChangeListener(d);
                d()
            }
            var s = function() {
                function e(t, n, o) {
                ...
                t._ensureAudio = function() {
                    var e, t = this;
                    this._audio = null !== (e = this._audio) && void 0 !== e ? e : new Promise((function(e, o) {
                        var r = new Audio;
                        r.src = n(614443)("./".concat(t.name, ".mp3"));
                        r.onloadeddata = function() {
                            r.volume = Math.min(a.Z.getOutputVolume() / 100 * t._volume, 1);
                            i.FB && r.setSinkId(p);
                            e(r)
                        };
                        r.onerror = function() {
                            return o(new Error("could not play audio"))
                        };
                        r.onended = function() {
...
//# sourceMappingURL=72c5744c1dd9c489f68e.js.map
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["27408"], {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var l, s, c, d, E, _, f, I, h, T, N, A, S, p, O, v, g = (l = u, E = Array(32768), l.forEach(function(n) {
                        ...
                        var D = (_ = u, f = g, N = 1e6, A = 0, S = 1e6, p = 0, O = 1e6, v = 0, _.forEach(function(e) {
                                I = e[0] >> t, h = e[1] >> t, T = e[2] >> t, I < N ? N = I : I > A && (A = I), h < S ? S = h : h > p && (p = h), T < O ? O = T : T > v && (v = T)
                            }), new i(N, A, S, p, O, v, f)),
        ...
        479756: function(t, e, n) {
            ...
            function p(t) {
                let e = d.default.getChannelId(t),
                    ...
                    r = null != e && (0, T.isStaticChannelRoute)(e);
            ...
            function O(t, e, n) {
                ...
                e.forEach(t => r.add(t)), n.forEach(t => r.delete(t)), A(t, {
        ...
        26051: function(t, e, n) {
            ...
            function h(t, e, n, h) {
                let T = (0, u.default)(null == n ? void 0 : n.getChannelId());
                if (!d.isPlatformEmbedded || null == t || "" === t || T || (null == h ? void 0 : h.shouldHideMediaOptions) === !0 || null != t && null != (0, a.isStickerAssetUrl)(t) || null != t && (0, o.isRoleIconAssetUrl)(t)) return null;
        ...
        235004: function(t, e, n) {
            ...
            function C(t) {
                let {
                    sound: e
                } = t, n = T.get(e.guildId), r = null == n ? void 0 : n.findIndex(t => t.soundId === e.soundId);
                null != n && null != r && -1 !== r ? (n[r] = e, T.set(e.guildId, [...n])) : null != n && (null == n || n.push(e), T.set(e.guildId, [...n]))
            }
            let D = u.debounce(t => {
            ...
            function L(t) {
                ...
                for (let [t, e] of Object.entries(r)) e.soundboardMuted ? A.add(t) : A.delete(t);
                for (let t of A.keys()) null == r[t] && A.delete(t)
            }
            class M extends a.default.Store {
                ...
                getSound(t, e) {
                    var n;
                    let r = null !== (n = T.get(t)) && void 0 !== n ? n : [];
                ...
                hasFetchedAllSounds() {
                    return p === r.FETCHED && S === r.FETCHED
                }
            }
            M.displayName = "SoundboardStore";
            var R = new M(l.default, {
                LOGOUT: function() {
                    T.clear(), N.clear(), v.clear(), g = !1, p = r.NOT_FETCHED, S = r.NOT_FETCHED
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(t) {
                    ...
                    T.set(f.DEFAULT_SOUND_GUILD_ID, e), S = r.FETCHED
                },
                ...
                OVERLAY_INITIALIZE: function(t) {
                    ...
                    T = new Map(Object.entries(e.soundboardSounds)), O = new Set(e.favoritedSoundIds), A = new Set(e.localSoundboardMutes)
                },

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [56790, 84346, 10848, 85572, 84832, 88110, 96043, 71402, 56645], {
        737264: e => {
            "use strict";
            ...
            var g = function(e) {
                ...
                n.prototype.render = function() {
                    var e, t = this.props,
                        ...
                        h = t.helpMessage,
                        E = t.retryPrompt,
                        g = t.retrySuccessMessage,
                        m = this.state,
                        O = m.code,
                        v = m.errorMessage,
                        b = m.retrySuccess,
                        I = i.Children.count(c) > 0 ? (0, r.jsx)(u.Card, {
            ...
            function w(e) {
                ...
                if (!v.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== y.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        c = A({}, t, R(u), null != i && null != o && (0, S.AB)(o) ? P(0, o) : C(a));
                    v.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        165586: (e, t, n) => {
            ...
            var E = [h(r.RESOLUTION_720), h(r.RESOLUTION_1080), h(r.RESOLUTION_1440), h(r.RESOLUTION_SOURCE, (function() {
                ...
                g = [h(r.RESOLUTION_720), h(r.RESOLUTION_1080), h(r.RESOLUTION_1440)],
                m = function(e) {
                    return "".concat(e, "p")
                },
                O = [h(r.RESOLUTION_480, (function() {
                ...
                v = [h(i.FPS_15), h(i.FPS_30), h(i.FPS_60)],
                b = [h(i.FPS_15, (function() {
            ...
            function g(e) {
                var t, n = (0,
                    ...
                    O = (0, i.e7)([a.Z], (function() {
                        return a.Z.getGuild(m)
                    }), [m]),
                    v = (0, i.e7)([l.Z], (function() {
                        return null != g ? l.Z.getVoiceStateForChannel(g, e.id) : null
                    }), [g, e.id]),
                    ...
                    y = (0, i.e7)([f.ZP], (function() {
                        return f.ZP.getPermissionsForUser(e.id, g)
                    }), [g, e.id]),
                    S = (0, s.B)(g);
                if (null == n || null == O || null == v) return null;
                if (y.speaker) return null;
                var T = function() {
                    b ? (0, c.RK)(n, !1) : (0, c._0)(n, e.id)
                };
                return S ? (0, r.jsx)(o.MenuItem, {
                    id: "invite-speaker",
                    label: b ? E.Z.Messages.STAGE_CHANNEL_USER_SET_MYSELF_TO_SPEAKER : E.Z.Messages.STAGE_CHANNEL_USER_INVITE_TO_SPEAK,
                    action: T
                }) : I && b ? (0, r.jsx)(o.MenuItem, {
                    id: "invite-speaker",
        ...
        18882: (e, t, n) => {
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != L[e] && null != L[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in L[e][t]) t === w ? d.ZP.isNewForumThread(u, t, r) && M[e][t]++ : o.default.compare(u, i) > 0 && !d.ZP.hasOpenedThread(u) && M[e][t]++
                        }
                    }
                }
            }
            ...
            function q(e) {
                var t = d.ZP.getMentionCount(e.id) > 0,
                    n = d.ZP.hasRelevantUnread(e) && (!h.Z.isMuted(e.id) || t) || (0,
                        l.c)() && t,
        ...
        810848: (e, t, n) => {
            ...
            var r = n(785893),
                ...
                y = n(2590),
                S = n(473708);
            const T = (0, u.Z)((0, a.Z)((function(e) {
                var t = e.user,
                    n = e.showMediaItems,
                    a = void 0 !== n && n,
                ...
                return (0, r.jsxs)(i.Menu, {
                    ...
                    children: [!Z && (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsx)(i.MenuGroup, {
                            ...
                            children: [y, T, A, N, R, P]
                        }), a && (0, r.jsx)(i.MenuGroup, {
                            children: L
                        }), (0, r.jsx)(i.MenuGroup, {
                            children: M
                        }), (0, r.jsxs)(i.MenuGroup, {
        ...
        598955: (e, t, n) => {
            ...
            function v(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : E.Yn.DEFAULT,
                    ...
                    I = v.deafened,
                    y = void 0 !== I && I,
                    S = v.localVideoDisabled,
                    T = void 0 !== S && S,
                    A = v.localVideoAutoDisabled,
                    N = void 0 !== A && A,
                    ...
                    P = n ? null : (0, r.jsx)(o.MenuCheckboxItem, {
        ...
        234617: (e, t, n) => {
            ...
            function E(e) {
                ...
                return E ? null : (0, r.jsx)(o.MenuControlItem, {
                    id: "user-volume",
                    label: g ? d.Z.Messages.STREAM_VOLUME : d.Z.Messages.USER_VOLUME,
                    control: function(t, i) {
                        return (0, r.jsx)(o.MenuSliderControl, h(_({}, t), {
                            ...
                            "aria-label": g ? d.Z.Messages.STREAM_VOLUME : d.Z.Messages.USER_VOLUME
                        }))
                    }
                })
            }
        ...
        491260: (e, t, n) => {
            ...
            function w(e) {
                ...
                delete R[e];
                if (null != T[e]) {
                    var t = O(a().sortBy(T[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
        ...
        223219: (e, t, n) => {
            ...
            function w(e) {
                ...
                null != e.scrollPosition && null != v && (I[v] = e.scrollPosition);
                ...
                L = null !== (i = e.analyticsLocation) && void 0 !== i ? i : null;
                C = null !== (o = e.analyticsLocations) && void 0 !== o ? o : [];
            ...
            var j = function(e) {
                ...
                r.getProps = function() {
                    return {
                        submitting: m === l.QZA.SUBMITTING,
                        section: v,
                        subsection: null != v ? b[v] : null,
                        scrollPosition: null != v ? I[v] : null,
                        settings: T,
                        errors: y,
            ...
            const Z = new j(a.Z, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(e) {
                    if (m !== l.QZA.SUBMITTING) return !1;
                    m = l.QZA.OPEN;
                    v = l.oAB.ACCOUNT;
                    var t;
                ...
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete I[t] : null != v && delete I[v]
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    R = e.tab;
                    return null == v && R === l.cII.USER_SETTINGS && w({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, h, E, g, m = encodeURIComponent(l.toString()),
                    O = encodeURIComponent(u()),
                    v = (h = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), E = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(h)), g = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !E, "iOS" !== (null === i() || void 0 === i() || null === (_ = i().os) || void 0 === _ ? void 0 : _.family) || g ? 1 : 0),
                    b = null != r ? encodeURIComponent(r) : null,
                    I = null != o ? encodeURIComponent(o) : null,
                    y = "".concat(f, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(O, "&efr=").concat(v);
                null != b && (y += "&afl=".concat(b));
                null != I && (y += "&ifl=".concat(I));
                return y
            }
        },
        426080: (e, t, n) => {
        ...
        717621: (e, t, n) => {
            ...
            ! function(i) {
                ...
                d.prototype = {
                    ...
                    toHex8: function(e) {
                        return function(e, t, n, r, i) {
                            var o = [x(l(e).toString(16)), x(l(t).toString(16)), x(l(n).toString(16)), x(Z(r))];
                ...
                function E(e, t, n, r) {
                    return [x(Z(r)), x(l(e).toString(16)), x(l(t).toString(16)), x(l(n).toString(16))].join("")
                }

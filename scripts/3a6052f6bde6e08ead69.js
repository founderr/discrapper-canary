        ...
        934869: (e, t, r) => {
            ...
            var W = function(e) {
                        ...
                        e.renderGiftCodeSection = function() {
                            ...
                            switch (i) {
                                case A.Z.Modes.SUCCESS:
                                    s = y.Z.Messages.BILLING_GIFT_COPIED;
                                    break;
                                case A.Z.Modes.ERROR:
                                    s = y.Z.Messages.FAILED;
                                    break;
                                default:
                                    s = y.Z.Messages.COPY
                            }
                            return (0, a.jsx)(M.Z, {
                                ...
                                children: (0, a.jsxs)(a.Fragment, {
                                    children: [(0, a.jsx)(c.FormTitle, {
                                        ...
                                        hideMessage: r ? y.Z.Messages.GIFT_INVENTORY_HIDDEN : null,
                                        value: (0, g.Nz)(n),
                                        mode: i,
                                        text: s,
                                        onCopy: function(t) {
                    ...
                    n.render = function() {
                        ...
                        e = (0, g.a8)(o) ? "" : i && null == l ? y.Z.Messages.APPLICATION_STORE_PURCHASE_GIFT_AND_MESSAGE_CONFIRMATION_TITLE : null != l ? y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_AND_MESSAGE_FAILED : y.Z.Messages.APPLICATION_STORE_PURCHASE_GIFT_CONFIRMATION_TITLE;
                    ...
                    ! function(e, t, r) {
                        ...
                        get: function() {
                            var e = this.props,
                                t = e.subscriptionPlan,
                                r = e.hasSentMessage;
                            return null != e.giftMessageError ? y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_FAILURE_GENERIC_BLURB : null == t ? y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_CONFIRMATION_BLURB : (t.interval === S.rV.MONTH ? r ? y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_AND_MESSAGE_CONFIRM_SUBSCRIPTION_MONTHLY : y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_CONFIRM_SUBSCRIPTION_MONTHLY : r ? y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_AND_MESSAGE_CONFIRM_SUBSCRIPTION_YEARLY : y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_CONFIRM_SUBSCRIPTION_YEARLY).format({
                                skuName: (0, L.aq)(t.id),
                ...
                Y = function(e) {
                    ...
                    return (0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)(c.FormTitle, {
                            ...
                            children: E ? y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_GIFT_ERROR_SENDING_LINK : y.Z.Messages.APPLICATION_STORE_GIFT_PURCHASE_GIFT_RECIPIENT_SUBTEXT
                        })]
                    })
                };
        ...
        396546: (e, t, r) => {
            ...
            function ve(e) {
                ...
                var s = (0, f.e7)([T.Z], (function() {
                    ...
                    o = Me((0, f.Wu)([v.Z, S.Z], (function() {
                        var e = v.Z.boostSlots,
                            t = new Map;
        ...
        637700: (e, t, r) => {
            ...
            function g(e) {
                ...
                if (null != O) t = (0, a.jsx)("div", {
                    ...
                    var y = I.Z.get(r);
                    i()(null != y, "Missing plan");
                    t = (0, a.jsx)("div", {
                        className: A().text,
                        children: P(y)
                    })
                }
                var v, Z = d.ZP.getPremiumType(r);
                i()(null != Z, "premium type should not be null in purchase confirmation");
                v = null != O ? T.Z.Messages.PREMIUM_PAYMENT_CONFIRMATION_BUTTON_IAP.format({
                    skuName: O.name
...
//# sourceMappingURL=3a6052f6bde6e08ead69.js.map
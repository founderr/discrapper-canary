        ...
        57155: function(e, t, n) {
            ...
            class X extends l.PureComponent {
                render() {
                    let {
                        ...
                        let r = null == e.id ? G.default.getURL(e.name) : k.default.getEmojiURL({
                            id: e.id,
                            animated: e.animated,
                            size: 24
                        });
            ...
            function Z(e) {
                ...
                let E = (0, v.useIsActiveChannelOrUnarchivableThread)(r),
                    ...
                    g = T || d.id === n.id,
                    _ = (0, f.useStateFromStores)([U.default, j.default, L.default], () => Y.default.getName(i, r.id, n));
            ...
            function ee(e) {
                ...
                let {
                    ...
                    onClose: s,
                    transitionState: u
                } = e, c = (0, f.useStateFromStores)([j.default], () => j.default.getChannel(n.getChannelId())), d = null == c ? void 0 : c.getGuildId(), E = (0, f.useStateFromStores)([D.default, S.default, O.default], () => {
                    var e, t, a;
                    let l = null !== (a = null !== (t = D.default.getMessage(n.getChannelId(), n.id)) && void 0 !== t ? t : null === (e = S.default.getMessage(n.id)) || void 0 === e ? void 0 : e.firstMessage) && void 0 !== a ? a : null != d ? O.default.getCachedMessage(d, n.getChannelId(), n.id) : void 0;
                ...
                if (l.useEffect(() => {
                    ...
                    }, [s, E.length, C, M]), null == M || null == C) return (0, a.jsx)(m.Spinner, {});
                if (null == c) throw Error("MessageReactions.render: Message does not have a channelId");
                return (0, a.jsx)(p.default.Provider, {
                        ...
                        children: [o ? null : (0, a.jsx)(m.Scroller, {
                            ...
                            children: h.map(e => {
                                ...
                                return (0, a.jsx)(X, {
                                    ...
                                    colors: null != e.burst_colors ? (0, _.buildEmojiColorPalette)(e.burst_colors, v, U) : void 0
        ...
        166257: function(e, t, n) {
            ...
            function _(e, t, n) {
                ...
                if (403 === a) switch (l && l.code) {
                    case T.AbortCodes.TOO_MANY_REACTIONS:
                        s.default.show({
                            title: g.default.Messages.TOO_MANY_REACTIONS_ALERT_HEADER,
                            body: g.default.Messages.TOO_MANY_REACTIONS_ALERT_BODY,
                            confirmText: g.default.Messages.OKAY
                        });
                        break;
                    case T.AbortCodes.REACTION_BLOCKED:
                        E.ComponentDispatch.dispatch(T.ComponentActions.SHAKE_APP, {
                            duration: 200,
                            intensity: 2
                        })
            ...
            function S(e, t, n, a, l) {
                ...
                o.default.dispatch({
                    ...
                    channelId: t,
                    messageId: n,
                    userId: null !== (r = null == l ? void 0 : l.userId) && void 0 !== r ? r : R.default.getId(),
                    emoji: a,
                    optimistic: !0,
            ...
            function p(e) {
                let {
                    ...
                    userId: l,
                    useTypeEndpoint: r = !1,
                    type: i = d.ReactionTypes.NORMAL
                } = e, o = null != a.id ? "".concat(a.name, ":").concat(a.id) : a.name;
                return null == l ? T.Endpoints.REACTIONS(t, n, o) : r ? T.Endpoints.REACTION_WITH_TYPE(t, n, o, l, i) : T.Endpoints.REACTION(t, n, o, l)
            }
            async function O(e) {
                let {
                    channelId: t,
            ...
            async function I(e, t, n) {
                let a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "Message",
                    ...
                    o = null != l && !!l.burst,
                    R = null != l && !!l.isRetry;
                if (!R && function(e, t, n, a) {
                        let l = m.default.getMessage(e, t);
                        return null != l && l.userHasReactedWithEmoji(n, a)
                    }(e, t, n, o)) {
                    s.default.show({
                        title: g.default.Messages.EMOJI_PICKER_DOUBLE_REACTION_SUPER_ERROR_TITLE,
                        body: g.default.Messages.EMOJI_PICKER_DOUBLE_REACTION_SUPER_ERROR_BODY,
                ...
                S("MESSAGE_REACTION_ADD", e, t, n, {
                    burst: o,
                    colors: E
                }), await f.default.unarchiveThreadIfNecessary(e), r.default.put({
                    url: p({
                        channelId: e,
                        messageId: t,
                        emoji: n,
                    ...
                    let a = c.default.remainingBurstCurrency;
                    o ? (i.AccessibilityAnnouncer.announce(g.default.Messages.BURST_REACTION_ADD_UNLIMITED_SUCCESS_A11Y.format({
                        name: n.name
                    })), A.default.triggerFullscreenAnimation({
                        channelId: e,
                        messageId: t,
                        emoji: {
                            ...n,
                    ...
                    }), a > 0 && (0, u.toggleFreeUserSentPopout)({
                        animated: !1,
                        ...n
                    })) : i.AccessibilityAnnouncer.announce(g.default.Messages.REACTION_ADD_SUCCESS_A11Y.format({
                        name: n.name
                    }))
                }).catch(l => {
                    _(l, () => I(e, t, n, a, {
                        ...
                        burst: o
                    }), o ? i.AccessibilityAnnouncer.announce(g.default.Messages.BURST_REACTION_ADD_UNLIMITED_ERROR_A11Y.format({
                        name: n.name
                    })) : i.AccessibilityAnnouncer.announce(g.default.Messages.REACTION_ADD_ERROR_A11Y.format({
                        name: n.name
                    })))
                })
            }
            ...
            async function N(e, t, n) {
                ...
                await f.default.unarchiveThreadIfNecessary(e), r.default.delete({
                    url: T.Endpoints.REMOVE_REACTIONS(e, t),
                    oldFormErrors: !0
                }).catch(n => {
                    _(n, () => N(e, t, {
                        isRetry: !0
            ...
            async function C(e, t, n, a) {
                ...
                r.default.delete({
                    url: T.Endpoints.REMOVE_EMOJI_REACTIONS(e, t, i),
                    oldFormErrors: !0
                }).catch(a => {
                    _(a, () => C(e, t, n, {
                        isRetry: !0
            ...
            async function y(e, t, n, a) {
                ...
                S("MESSAGE_REACTION_REMOVE", e, t, n, {
                    ...
                    url: p({
                        ...
                        emoji: n,
                        userId: null != a ? a : "@me",
                        type: s ? d.ReactionTypes.BURST : d.ReactionTypes.NORMAL,
                        useTypeEndpoint: !0
                    }),
                    query: {
                        location: l,
                    ...
                    (null == o ? void 0 : o.burst) ? i.AccessibilityAnnouncer.announce(g.default.Messages.BURST_REACTION_REMOVE_SUCCESS_A11Y.format({
                        name: n.name
                    })): i.AccessibilityAnnouncer.announce(g.default.Messages.REACTION_REMOVE_SUCCESS_A11Y.format({
                        name: n.name
                    }))
                }).catch(async r => {
                    if (_(r, () => y(e, t, n, a, l, {
                        ...
                        S("MESSAGE_REACTION_ADD", e, t, n, {
                            ...
                            burst: s,
                            colors: l
                        }), (null == o ? void 0 : o.burst) ? i.AccessibilityAnnouncer.announce(g.default.Messages.BURST_REACTION_REMOVE_ERROR_A11Y.format({
                            name: n.name
                        })) : i.AccessibilityAnnouncer.announce(g.default.Messages.REACTION_REMOVE_ERROR_A11Y.format({
                            name: n.name
                        }))
                    }
                })

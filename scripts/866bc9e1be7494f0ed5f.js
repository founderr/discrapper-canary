            ...
            var r = function() {
                ...
                return r.prototype = {
                    ...
                    quantize: function(u, l) {
                        ...
                        var A = (p = u, E = R, I = 1e6, m = 0, C = 1e6, v = 0, S = 1e6, T = 0, p.forEach(function(t) {
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        return r
                    }, v = C(E, h, (l >> 18 & 31) / 31), S = C(3, 3, 1.25 * ((a >> 3 & 63) / 63)), T = C(3, 3, 1.25 * ((a >> 9 & 63) / 63)), R = f && C(5, 5, g), M = i(e), A = u(M > 1 ? 32 : 32 * M), N = u(M > 1 ? 32 / M : 32), b = new Uint8Array(A * N * 4), y = [], L = [];
                    for (let e = 0, i = 0; e < N; e++)
                        for (let u = 0; u < A; u++, i += 4) {
                            let l = s,
                                a = c,
                                p = d,
                                g = _;
                            for (let e = 0, n = r(E, f ? 5 : 3); e < n; e++) y[e] = o(t / A * (u + .5) * e);

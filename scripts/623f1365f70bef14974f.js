    ...
    ["2186"], {
        ...
        120817: function(e, t, n) {
            ...
            class er extends a.PureComponent {
                ...
                isUnreadVisible() {
                    ...
                    return n.some(n => {
                        ...
                        return !!(0, x.isGuildReadableType)(i.record.type) && (!r.isCollapsed || !r.isMuted) && !i.isMuted && !!t.isItemVisible(l, a, !0) && (0, A.getHasImportantUnread)(i.record)
                    })
                }
                renderTopUnread() {
                    let {
            ...
            let eo = e => {
                ...
                } = (0, p.default)(C.default.GUILD_CHANNEL_LIST), d = (0, o.useStateFromStores)([v.default], () => v.default.getChannel(n)), c = (0, o.useStateFromStores)([v.default], () => v.default.getChannel(s)), m = (0, o.useStateFromStores)([y.default], () => y.default.getGuildId()), E = (0, T.useOptInEnabledForGuild)(t), g = a.useRef(null), _ = a.useCallback((e, t) => {
                    let n = g.current;
                    if (null != n) {
        ...
        37416: function(e, t, n) {
            ...
            class ee extends Y.default {
                ...
                render() {
                    ...
                    } = this.state, x = this.getVoiceStatesCount(), v = (0, l.jsxs)("li", {
                        className: s(this.getModeClass(), {
                    ...
                    return _ && (v = C(v)), m && (v = f(h(v))), S && (v = (0, l.jsx)(y.default, {
                ...
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        if (o) return (0, l.jsx)(x.default, {
                            type: x.GuildVerificationPopoutTypes.VOICE,
                            guildId: e.guild_id,
                            closePopout: this.closeGuildVerificationPopout
                        });
                        throw Error("VoiceChannel.renderPopout: There must always be something to render")

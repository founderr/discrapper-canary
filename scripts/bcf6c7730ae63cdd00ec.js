(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["38429"], {
        ...
        590514: function(e, t, n) {
            ...
            function F(e) {
                let {
                    ...
                    className: I,
                    listName: C
                } = e, y = a.useRef(null), P = (0, _.default)(C, y), x = (0, d.useStateFromStores)([m.default], () => m.default.hasNotice()), U = (0, d.useStateFromStores)([g.default], () => g.default.windowSize());
                a.useEffect(() => {
                ...
                constructor(e = 36e5) {
                    ...
                    this.updateAvailable = !1, this.hasNativeUpdate = !1, this._callbacks = [], this._bootstrapper = null, this.checkForUpdates = function() {
                        ...
                        this._handleCheckingForUpdates(), a.default.get({
                            ...
                            if (null == e.body || "0820ad0dd21a7e85fb1f39a6035d5862ed383823" === e.body.hash) return this._handleUpdateNotAvailable();
        ...
        531674: function(e, t, n) {
            ...
            function N(e, t) {
                let [n, a] = (0, i.useStateFromStoresArray)([c.default], () => [c.default.isChannelMuted(e.guild_id, e.id), c.default.getChannelMuteConfig(e.guild_id, e.id)]), s = (0, d.useMutedUntilText)(a), _ = (0, f.default)(e, !0);
                ...
                let p = h.default.Messages.MUTE_CHANNEL_GENERIC,
                    I = h.default.Messages.UNMUTE_CHANNEL_GENERIC;
                switch (e.type) {
                    case E.ChannelTypes.GUILD_CATEGORY:
                        p = h.default.Messages.MUTE_CATEGORY, I = h.default.Messages.UNMUTE_CATEGORY;
                        break;
                    case E.ChannelTypes.GROUP_DM:
                        p = h.default.Messages.MUTE_CONVERSATION, I = h.default.Messages.UNMUTE_CONVERSATION;
                        break;
                    case E.ChannelTypes.DM:
                        p = h.default.Messages.MUTE_CHANNEL.format({
                            name: _
                        }), I = h.default.Messages.UNMUTE_CHANNEL.format({
                            name: _
                        });
                        break;
                    default:
                        p = h.default.Messages.MUTE_CHANNEL_GENERIC, I = h.default.Messages.UNMUTE_CHANNEL_GENERIC
                }
        ...
        619436: function(e, t, n) {
            ...
            function f(e) {
                let t = e.getGuildId(),
                    ...
                    h = null == _ ? u.UserNotificationSettings.NULL : _.message_notifications,
            ...
            function E(e) {
                ...
                let i = f(e),
                    ...
                    h = null == _ ? u.UserNotificationSettings.NULL : _.message_notifications,
                    S = (0, r.useVoiceActivityNotificationSettingsExperiment)(e),
                    T = h === u.UserNotificationSettings.NULL && e.isGuildStageVoice() ? d.default.Messages.FORM_LABEL_ONLY_MENTIONS.format() : null === (n = c(e, S)) || void 0 === n ? void 0 : null === (t = n.find(e => {
                        let {
                            setting: t
                        } = e;
                        return t === E
        ...
        180273: function(e, t, n) {
            ...
            var R = new C(r.default, {
                ...
                STREAM_START: function(e) {
                    ...
                    null != T[h.dropsQuestId] && T[h.dropsQuestId].isEnrolled || N ? A(h, _, i) : r.default.wait(async () => {
                        var e;
                        await (0, c.fetchEnrolledUser)(h.dropsQuestId), (null === (e = T[h.dropsQuestId]) || void 0 === e ? void 0 : e.isEnrolled) && A(h, _, i)
                    })
                },
                LOGOUT: function() {
                    S = {}, T = {}, h = {}, p.stop()
        ...
        539938: function(e, t, n) {
                    ...
                    toolbar: function() {
                        ...
                        return i.isMobile ? T : (0, l.jsxs)(l.Fragment, {
                            children: [S, e ? (0, l.jsx)(E.default, {
                                className: A.search
                            }, null != s ? s : a) : null, (0, l.jsx)(I.default, {}), D && (0, l.jsx)(c.default, {}), (0, l.jsx)(f.default, {}), v ? (0, l.jsx)(p.default, {}) : (0, l.jsx)(N.default, {})]
                        })
                    }(),
                    transparent: u,
                    onDoubleClick: C,
            ...
            function O(e) {
                let {
                    ...
                    [A.forumOrHome]: null != n.channelType && m.ChannelTypesSets.GUILD_THREADS_ONLY.has(n.channelType) || n.channelId === g.StaticChannelRoute.GUILD_HOME
                });
                return (0, l.jsx)(a, {
        ...
        396539: function(e, t, n) {
            ...
            let f = e => {
                    let {
                        ...
                        withMentions: E = !1,
                        initialPageSize: _
                    } = e, h = (0, a.useStateFromStores)([d.default], () => d.default.shouldReload()), S = l.useRef(!1), [T, N] = l.useState(!1), {
                        initialized: p,
                        loading: I,
                        items: m,
                        hasMore: g,
            ...
            let y = a.memo(function(e) {
                    ...
                    let {
                        ...
                        if (null != r.deeplink) {
                            ...
                            _.default.track(A.AnalyticEvents.NOTIFICATION_CENTER_ACTION, {
        ...
        80649: function(e, t, n) {
            ...
            function L(e) {
                let {
                    ...
                    badgeState: d,
                    closePopout: c
                } = e, _ = (0, s.useStateFromStores)([f.default, E.default], () => f.default.getChannel(E.default.getChannelId())), {
                    messages: h,
                    hasMore: S,
                    loading: N,
                    guildFilter: I,
                ...
                a.useEffect(() => {
                    if (!T.default.hasLoadedEver) {
                        O(_, !0);
                        return
                    }(null != L && I !== L || null != v && m !== v || null != y && M !== y) && O(_, !0)
                }, [L, I, v, m, y, M, _, !0]);
                a.useEffect(() => () => {
                ...
                return (0, l.jsx)(l.Fragment, {
                    children: (0, l.jsx)(o.default, {
                        ...
                        loadMore: function() {
                            let e = null != h && h.length > 0 ? h[h.length - 1].id : null;
                            O(_, !0, e)
                        },
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsxs)(o.TabBar, {
                            ...
                            children: [(0, l.jsxs)(o.TabBar.Item, {
                                ...
                                children: [N.default.Messages.FOR_YOU, (null == _ ? void 0 : _.badgeForYou) ? (0, l.jsx)(S.CircleBadge, {
                ...
                return (0, l.jsx)(o.Popout, {
                    ...
                    renderPopout: function() {
                        return (0, l.jsx)(o.Dialog, {
                            ...
                            children: L === r.InboxTab.FOR_YOU && b ? (0, l.jsx)(h.default, {
                                setTab: v,
                                badgeState: A,
                                closePopout: P
        ...
        879165: function(e, t, n) {
            ...
            function p(e) {
                let {
                    ...
                    channelRecord: n,
                    deleteChannel: s
                } = e, p = (0, o.useStateFromStoresArray)([E.default, h.default], () => i(E.default.getThreadsForParent(n.guild_id, n.id)).values().filter(e => {
                    let {
                        id: n
                    } = e;
        ...
        320268: function(e, t, n) {
            ...
            function m() {
                ...
                for (let {
                    ...
                    _.default.applicationIdsFetching.has(l.id) || _.default.isEntitledToSku(E.default.getCurrentUser(), t, l.id, l.id) || !a.available ? null != N[t] && (delete N[t], e = !0) : (N[t] = {
                        skuId: t,
                        applicationId: n
                    }, e = !0)
                }
                    ...
                    for (let {
                        ...
                        if (null != t && n !== S.Distributors.DISCORD)
                            for (let {
                                ...
                                if (!(l !== t || I.includes(n))) null == p[n] && (!_.default.applicationIdsFetched.has(l) && !_.default.applicationIdsFetching.has(l) && null == _.default.getForSku(n) && o.fetchUserEntitlementsForApplication(l), p[n] = {
                                    skuId: n,
                                    applicationId: l
                                }, e = !0)
                            }
        ...
        381684: function(e, t, n) {
            ...
            class A extends r.default.PersistedStore {
                initialize(e) {
                    N = null != e ? e : T, this.syncWith([_.default], g)
                }
                getState() {
                    return N
                }
        ...
        600133: function(e, t, n) {
            ...
            let eF = [eI.NoticeTypes.QUARANTINED, eI.NoticeTypes.AUTOMOD_QUARANTINED_USER_PROFILE, eI.NoticeTypes.VIEWING_ROLES, eI.NoticeTypes.INVITED_TO_SPEAK, eI.NoticeTypes.LURKING_GUILD, eI.NoticeTypes.VOICE_DISABLED, eI.NoticeTypes.NO_INPUT_DETECTED, eI.NoticeTypes.HARDWARE_MUTE, eI.NoticeTypes.H264_DISABLED, eI.NoticeTypes.DISPATCH_ERROR, eI.NoticeTypes.DISPATCH_INSTALL_SCRIPT_PROGRESS, eI.NoticeTypes.SPOTIFY_AUTO_PAUSED, eI.NoticeTypes.DROPS_PROGRESS_INTERRUPTION, eI.NoticeTypes.WIN32_DEPRECATED_MESSAGE, eI.NoticeTypes.BLOCKED_BY_PROXY, eI.NoticeTypes.VOICE_CONNECTED_LAST_SESSION, eI.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION, eI.NoticeTypes.GUILD_RAID_NOTIFICATION, eI.NoticeTypes.ESLATAM_LANGUAGE_LAUNCH, eI.NoticeTypes.UNCLAIMED_ACCOUNT, eI.NoticeTypes.POMELO_ELIGIBLE, eI.NoticeTypes.PENDING_MEMBER, eI.NoticeTypes.OUTBOUND_PROMOTION, eI.NoticeTypes.CORRUPT_INSTALLATION, eI.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER, eI.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK, eI.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, eI.NoticeTypes.STREAMER_MODE, eI.NoticeTypes.SCHEDULED_MAINTENANCE, eI.NoticeTypes.BOUNCED_EMAIL_DETECTED, eI.NoticeTypes.UNVERIFIED_ACCOUNT, eI.NoticeTypes.PREMIUM_TIER_2_TRIAL_ENDING, eI.NoticeTypes.PREMIUM_TIER_0_TRIAL_ENDING, eI.NoticeTypes.PREMIUM_UNCANCEL, eI.NoticeTypes.PREMIUM_MISSING_PAYMENT, eI.NoticeTypes.PREMIUM_PAST_DUE_INVALID_PAYMENT, eI.NoticeTypes.PREMIUM_PAST_DUE_MISSING_PAYMENT, eI.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, eI.NoticeTypes.PREMIUM_REACTIVATE, eI.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION, eI.NoticeTypes.MFA_SMS_BACKUP, eI.NoticeTypes.APPLICATION_TEST_MODE, eI.NoticeTypes.LOCALIZED_PRICING, eI.NoticeTypes.DOWNLOAD_NAG, eI.NoticeTypes.CONNECT_SPOTIFY, eI.NoticeTypes.CONNECT_PLAYSTATION, eI.NoticeTypes.SURVEY, eI.NoticeTypes.SERVER_USAGE_SURVEY, eI.NoticeTypes.SAFETY_USER_SENTIMENT_NAGBAR, eI.NoticeTypes.DROPS_GO_LIVE_BANNER, eI.NoticeTypes.DROPS_ENDED_INCOMPLETE, eI.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR],
                ...
                ej = {
                    ...
                    [eI.NoticeTypes.DOWNLOAD_NAG]: {
                        predicate: () => !eh.isPlatformEmbedded && !eU(eI.NoticeTypes.DOWNLOAD_NAG)
                    },
                    ...
                    [eI.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION]: {
                        predicate: () => !eU(eI.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== h.default.getEligibleGuildsForNagActivate().length && (0, _.isCreatorMonetizationNagActivateEnabled)()
                    },
                    [eI.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR]: {
                        predicate: e => {
                            let {
            ...
            class ew extends s.default.Store {
                initialize() {
                    this.syncWith([es.default, J.default, Q.default, en.default, U.default, ef.default, H.default, K.default, w.default, A.default], eG), this.waitFor(er.default, el.default, W.default, z.default, $.default, q.default, ea.default, p.default, en.default, ei.default, G.default, ee.default, J.default, eT.default, eN.default, e_.default, Z.default, ec.default, ep.default, Q.default, ed.default, X.default, U.default, eE.default, ef.default, K.default, L.default, T.default, h.default, b.default)
                }
                hasNotice() {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["37528"], {
                        ...
                        if (!this._count_set || e) {
                            ...
                            for (r = this.r1; r <= this.r2; r++)
                                for (i = this.g1; i <= this.g2; i++)
                                    for (o = this.b1; o <= this.b2; o++) a += n[t(r, i, o)] || 0;
                        ...
                        if (!this._avg || e) {
                            ...
                            for (i = this.r1; i <= this.r2; i++)
                                for (o = this.g1; o <= this.g2; o++)
                                    for (a = this.b1; a <= this.b2; a++) u += r = n[t(i, o, a)] || 0, s += r * (i + .5) * l, c += r * (o + .5) * l, d += r * (a + .5) * l;
                            ...
                            for (var i, o = 1, a = 0; a < 1e3;) {
                                ...
                                var u = function(e, n) {
                                        ...
                                        function _(e) {
                                            ...
                                            for (l = n[u]; l <= n[s]; l++)
                                                if (E[l] > p / 2) {
                                                    for (i = n.copy(), o = n.copy(), t = l - n[u], a = t <= (r = n[s] - l) ? Math.min(n[s] - 1, ~~(l + r / 2)) : Math.max(n[u], ~~(l - 1 - t / 2)); !E[a];) a++;
        ...
        723251: function(e, t, n) {
            ...
            function i(e, t, n) {
                ...
                for (let e = 0, i = 0, a = r - 1; e < t; e++, a += r - 1)
                    for (o.push(e + 1 < t ? 0 : 1, 255 & r, r >> 8, 255 & ~r, r >> 8 ^ 255, 0), l = (l + u) % 65521; i < a; i++) {
                        let e = 255 & n[i];
            ...
            function o(e) {
                let t = function(e) {
                    let {
                        ...
                        cos: o,
                        round: a
                    } = Math, u = e[0] | e[1] << 8 | e[2] << 16, l = e[3] | e[4] << 8, s = (63 & u) / 63, c = (u >> 6 & 63) / 31.5 - 1, d = (u >> 12 & 63) / 31.5 - 1, f = u >> 23, p = l >> 15, E = i(3, p ? f ? 5 : 7 : 7 & l), h = i(3, p ? 7 & l : f ? 5 : 7), _ = f ? (15 & e[5]) / 15 : 1, g = (e[5] >> 4) / 15, I = f ? 6 : 5, m = 0, v = (t, n, r) => {
                        let i = [];
                        for (let o = 0; o < n; o++)
                            for (let a = o ? 0 : 1; a * n < t * (n - o); a++) i.push(((e[I + (m >> 1)] >> ((1 & m++) << 2) & 15) / 7.5 - 1) * r);
                        return i
                    }, S = v(E, h, (u >> 18 & 31) / 31), T = v(3, 3, 1.25 * ((l >> 3 & 63) / 63)), C = v(3, 3, 1.25 * ((l >> 9 & 63) / 63)), R = f && v(5, 5, g), A = r(e), M = a(A > 1 ? 32 : 32 * A), N = a(A > 1 ? 32 / A : 32), b = new Uint8Array(M * N * 4), y = [], L = [];
                    for (let e = 0, r = 0; e < N; e++)
                        for (let a = 0; a < M; a++, r += 4) {
                            let u = s,
                                ...
                                p = d,
                                g = _;
                            for (let e = 0, n = i(E, f ? 5 : 3); e < n; e++) y[e] = o(t / M * (a + .5) * e);
                            for (let n = 0, r = i(h, f ? 5 : 3); n < r; n++) L[n] = o(t / N * (e + .5) * n);
                            for (let e = 0, t = 0; e < h; e++)
                                for (let n = e ? 0 : 1, r = 2 * L[e]; n * h < E * (h - e); n++, t++) u += S[t] * y[n] * r;
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * L[e]; n < 5 - e; n++, t++) g += R[t] * y[n] * r;
                            let I = u - 2 / 3 * l,
                                m = (3 * u - I + p) / 2,
                                v = m - p;
            ...
            class c extends i.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: I,
                        retrySuccess: m
                    } = this.state, v = i.Children.count(o) > 0 ? (0, r.jsx)(u.Card, {
            ...
            var f = {
                openMemberVerificationModal(e, t) {
                    ...
                    (0, i.openModalLazy)(async () => {
                        ...
                        onCloseRequest: () => {
                            c(), u.useMemberVerificationFormNoticeStore.getState().hasUnsubmittedChanges ? (0, u.setShowWarning)(!0) : (0, i.closeModal)(l.IN_APP_MEMBER_VERIFICATION_MODAL_KEY)
                        },
                        onCloseCallback: t
                    })
                },
        ...
        716849: function(e, t, n) {
            ...
            function g(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), o = (0, i.default)([d.default], () => d.default.shouldFetchPremiumLikelihood()), a = (0, i.default)([l.default], () => l.default.getCurrentUser());
                r.useEffect(() => {
                    I(a, o, t, n)
                }, [a, o, t, n])
            }
        ...
        804888: function(e, t, n) {
            ...
            function u(e) {
                return a() && null != e.match(o) ? [!0, e.substring(i.length).trim()] : [!1, e]
            }
        },
        ...
        181114: function(e, t, n) {
            ...
            let g = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...g
                } = e, I = a.createRef(), m = (0, d.default)(I), v = !r && !i && !0 !== u && (!h || m);
        ...
        103603: function(e, t, n) {
            ...
            function h(e, t, n) {
                ...
                let u = i.getImageData(0, 0, o, a).data,
                    s = function(e, t, n) {
                        let r = [];
                        for (let i = 0, o, a, u, l, s; i < t; i += n) a = e[(o = 4 * i) + 0], u = e[o + 1], l = e[o + 2], (void 0 === (s = e[o + 3]) || s >= 125) && !(a > 250 && u > 250 && l > 250) && r.push([a, u, l]);
                        return r
                    }(u, o * a, n),
                    c = l(s, t);

    ...
    ["98695"], {
        ...
        312165: function(e, t, n) {
            ...
            class l extends s.EventEmitter {
                ...
                constructor() {
                    super(), this.combo = [], d.push(this), 1 === d.length && a.default.setOnInputEventCallback(r)
                }
            }
        },
        ...
        3958: function(e, t, n) {
            ...
            class S extends u.PureComponent {
                ...
                componentDidUpdate(e) {
                    ...
                    t === s.DEFAULT && i.current === a && i.current.blur(), t === s.RECORDING && i.current !== a && i.current.focus()
                }
                render() {
                    let e;
                    let {
                        ...
                        value: n,
                        disabled: i
                    } = this.props, u = (0, _.toString)(n, !0);
                    e = t === s.RECORDING ? h.default.Messages.SHORTCUT_RECORDER_BUTTON_RECORDING : 0 === n.length ? h.default.Messages.SHORTCUT_RECORDER_BUTTON : h.default.Messages.SHORTCUT_RECORDER_BUTTON_EDIT;
                    let o = t === s.DEFAULT && n.length > 0;
                            ...
                            children: (0, a.jsxs)(m.default, {
                                ...
                                children: [(0, a.jsx)(m.default.Child, {
                                    ...
                                    children: (0, a.jsx)("input", {
                                        ...
                                        readOnly: !0,
                                        value: u,
                                        disabled: this.props.mode !== s.RECORDING || i
                                    })
                                }), (0, a.jsx)(m.default, {
                                    shrink: 1,
                                    grow: 0,
                ...
                constructor(...e) {
                    super(...e), this._inputId = p.uniqueId("key-recorder-"), this._unregisterNativeRecorder = null, this._mousedownMode = null, this._inputRef = u.createRef(), this._containerRef = u.createRef(), this.setInputRef = e => {
                        ...
                        (!n || this._mousedownMode !== s.RECORDING) && t()

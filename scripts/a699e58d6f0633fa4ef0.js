...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [75625], {
            ...
            function j(e, t) {
                switch (e.type) {
                    ...
                    case D.d4z.PUBLIC_THREAD:
                        return e.isNSFW() ? w.Z : e.isForumPost() ? h.Z : C.Z;
        ...
        860123: (e, t, n) => {
            ...
            function O() {
                var e, t, n, r, i, o = u.Z.getStreamerActiveStreamMetadata(),
                    a = null == o ? void 0 : o.pid,
                    l = null != o ? null != a ? m.ZP.getGameForPID(a) : null : m.ZP.getVisibleGame(),
                    c = null !== (t = null !== (e = null == o ? void 0 : o.sourceName) && void 0 !== e ? e : null == l ? void 0 : l.name) && void 0 !== t ? t : "Unknown",
                    s = null !== (r = null !== (n = null == o ? void 0 : o.id) && void 0 !== n ? n : null == l ? void 0 : l.id) && void 0 !== r ? r : void 0,
                    d = Object.keys(g.Z.getVoiceStatesForChannel(null !== (i = v.Z.getChannelId()) && void 0 !== i ? i : ""));
                return {
                    id: _.Z.fromTimestamp(Date.now()),
                    version: w.Bg,
                    name: "Clip - ".concat((new Date).toLocaleString()),
                    applicationName: null != c ? c : "Unknown",
                    applicationId: s,
                    users: d,
                    clipMethod: "manual",
                    length: 0,
            ...
            function j(e) {
                return null != D ? D : D = e.object({
                    id: e.string().required(),
                    version: e.number().positive().integer().min(0).max(w.Bg).optional(),
                        ...
                        switch (o.label) {
                            ...
                            case 1:
                                ...
                                try {
                                    ...
                                    return [2, Z.slice(i.version).reduce((function(e, t) {
                                        return t(e)
                                    }), i)]
                                } catch (e) {
                                    return [2, null]
                ...
                return (F = k((function(e) {
                    ...
                    return M(this, (function(f) {
                        switch (f.label) {
                            ...
                            case 2:
                                f.sent();
                                A()(null != t.boxes, "mp4boxInputFile.boxes should not be null after parsing");
                                o = !0, a = !1, l = void 0;
                                try {
                ...
                return (J = H((function(e) {
                    ...
                    return Y(this, (function(a) {
                        switch (a.label) {
                            ...
                            case 1:
                                a.sent();
                                o && p.default.track(G.rMx.CLIPS_ENABLED_TOGGLED, {
                                    new_setting_value: t,
                                    guild_id: n
                                });
                                return [2]
            ...
            function $() {
                var e, t = c.default.getId(),
                    n = u.Z.getActiveStreamForUser(t, null),
                    r = null != n ? d.Z.getRTCConnection((0, a.V9)(n)) : null,
            ...
            function ee(e, t) {
                var n, r, i, a, u, c, d, f, h, y = new Map;
                for (var v in t.framesEncodedByEncoder) {
                    var m, g = t.framesEncodedByEncoder[v],
                        _ = (0, o.lG)(v),
                        w = null !== (m = y.get(_)) && void 0 !== m ? m : 0;
                    y.set(_, w + g)
                }
                p.default.track(G.rMx.CLIP_SAVED, q(W({}, e), {
                    frames_encoded_nvidia_cuda: null !== (n = y.get(o.Su.NVIDIA_CUDA)) && void 0 !== n ? n : 0,
                    frames_encoded_nvidia_direct3d: null !== (r = y.get(o.Su.NVIDIA_DIRECT_3D)) && void 0 !== r ? r : 0,
                    frames_encoded_openh264: null !== (i = y.get(o.Su.OPENH264)) && void 0 !== i ? i : 0,
                    frames_encoded_videotoolbox: null !== (a = y.get(o.Su.VIDEOTOOLBOX)) && void 0 !== a ? a : 0,
                    frames_encoded_amd_direct3d: null !== (u = y.get(o.Su.AMD_DIRECT_3D)) && void 0 !== u ? u : 0,
                    frames_encoded_intel: null !== (c = y.get(o.Su.INTEL)) && void 0 !== c ? c : 0,
                    frames_encoded_intel_direct3d: null !== (d = y.get(o.Su.INTEL_DIRECT_3D)) && void 0 !== d ? d : 0,
                    frames_encoded_uncategorized: null !== (f = y.get(o.Su.UNCATEGORIZED)) && void 0 !== f ? f : 0,
                    frames_encoded_unknown: null !== (h = y.get(o.Su.UNKNOWN)) && void 0 !== h ? h : 0,
                    ...
                    clip_hardware_encode_setting: s.Z.getHardwareClipEncode(),
            ...
            function ne() {
                return (ne = H((function() {
                    var e, t, n, r, o, a, l, u, c, d, f, h, v, m;
                    return Y(this, (function(g) {
                        switch (g.label) {
                            case 0:
                                ...
                                t = e.storageLocation;
                                n = O();
                                r = "".concat((0, y.Z)(n.applicationName.substring(0, 20)), "_").concat(n.id, ".mp4");
                                o = i.Z.fileManager.join(t, r);
                                a = s.Z.getMediaEngine();
                                l = $();
                                g.label = 1;
                            case 1:
                                g.trys.push([1, 5, , 6]);
                            ...
                            case 2:
                                u = g.sent(), c = u.duration, d = u.thumbnail, f = u.clipStats;
                                ee(l, f);
                                return [4, null != i.Z.clips.getClipProtocolURLFromPath ? (0, B.R)(i.Z.clips.getClipProtocolURLFromPath(o), 0) : (0, B.q)(d)];
                            case 3:
                                h = g.sent();
                                n.thumbnail = h;
                                n.length = c;
                                w.jF.info("Clip save succeeded with ".concat(c, "ms and thumbnail ").concat(null !== (v = null == h ? void 0 : h.length) && void 0 !== v ? v : 0, " bytes thumbnail."));
                            ...
                            case 5:
                                m = g.sent();
                                p.default.track(G.rMx.CLIP_SAVE_FAILURE, l);
                                throw m;
                            case 6:
                                return [2]
                        }
            ...
            function ie() {
                return (ie = H((function() {
                    ...
                    return Y(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                if (b.Z.getIsSavingClip() || !b.Z.getSettings().clipsEnabled || null == u.Z.getCurrentUserActiveStream()) return [2];
                                r.Z.dispatch({
                                    type: "CLIPS_SAVE_CLIP_START"
                                });
                                e = (0, h.GN)("clip_save", .5);
                                t = performance.now();
                                o.label = 1;
                            case 1:
                                o.trys.push([1, 3, , 4]);
                            ...
                            case 3:
                                i = o.sent();
                                w.jF.error("Clip Failed to Save", i);
                                null == e || e.stop();
                                (0, h.GN)("clip_error", .5);
                                r.Z.dispatch({
                                ...
                                return [3, 4];
                            case 4:
                                w.jF.info("".concat(b.Z.getSettings().clipsLength / 1e3, "s clip save took ").concat(Math.round(performance.now() - t), "ms"));
                                return [2]
                        }
                    }))
                }))).apply(this, arguments)
            ...
            function ae() {
                return (ae = H((function(e, t) {
                    var n, i;
                    return Y(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                n = b.Z.getClips().find((function(t) {
                                    return t.id === e
                                }));
                                if (null == n) return [2];
                                i = W({}, n, t);
                                return [4, s.Z.getMediaEngine().updateClipMetadata(i.filepath, JSON.stringify(i))];
                            case 1:
                                o.sent();
                                p.default.track(G.rMx.CLIP_EDITED);
                                r.Z.dispatch({
            ...
            function se() {
                return (se = H((function(e) {
                    var t, n, o, a, l, u, c, s, d, p, h;
                    return Y(this, (function(b) {
                        switch (b.label) {
                            case 0:
                                return (0, f.nI)() && null != (null === (t = i.Z.clips) || void 0 === t ? void 0 : t.loadClipsDirectory) ? [4, i.Z.clips.loadClipsDirectory(e)] : [2];
                            case 1:
                                n = b.sent();
                                o = [];
                                a = !0, l = !1, u = void 0;
                            ...
                            case 2:
                                ...
                                b.label = 3;
                            case 3:
                                return (a = (s = c.next()).done) ? [3, 6] : [4, N(q(W({}, (d = s.value).metadata), {
                                    filepath: d.filepath
                                }))];
                            case 4:
                                null != (p = b.sent()) && o.push(p);
                                b.label = 5;
                            case 5:
                                a = !0;
                                return [3, 3];
            ...
            function pe() {
                return (pe = H((function(e) {
                    var t;
                    return Y(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return (0,
                                    f.nI)() && null != (null === (t = i.Z.clips) || void 0 === t ? void 0 : t.deleteClip) ? [4, i.Z.clips.deleteClip(e)] : [2];
                            case 1:
                                n.sent();
                                r.Z.dispatch({
            ...
            function ye() {
                return (ye = H((function(e, t) {
                    return Y(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, s.Z.getMediaEngine().exportClip(e.filepath, t)];
                            case 1:
                                return [2, U(n.sent())]
                        }
                    }))
        ...
        796308: (e, t, n) => {
            ...
            const y = i.forwardRef((function(e, t) {
                var n, o, f = e.body,
                    ...
                    E = e.inlineArt,
                    S = void 0 !== E && E,
                    I = e.isPremiumFeature,
                    P = void 0 !== I && I,
                    C = e.shouldUseHorizontalButtons,
                    Z = void 0 !== C && C,
                    D = e.showGIFTag,
                    j = void 0 !== D && D,
                    ...
                    x = Z ? l.Button.Sizes.LARGE : l.Button.Sizes.MAX;
                ...
                return (0, r.jsx)("div", {
                    ...
                    children: (0, r.jsxs)("div", {
                        className: a()(h().content, (n = {}, b(n, h().contentNoArt, null == v || S), b(n, h().contentPremium, P), n)),
                        children: [(0, r.jsx)("div", {
                            className: a()(v, S ? h().artInline : h().artAbsolute),
                            ...
                            children: [(0, r.jsxs)(l.Heading, {
                                className: a()(P ? h().headerWithPremiumIcon : h().header, m),
                            ...
                            children: null != _ ? (0, r.jsxs)(r.Fragment, {
                                children: [(0, r.jsx)(l.Button, {
                                    ...
                                    color: P ? l.Button.Colors.BRAND : l.Button.Colors.WHITE,
                                    look: P ? l.Button.Looks.INVERTED : l.Button.Looks.FILLED,
                                    ...
                                    color: P ? l.Button.Colors.WHITE : l.Button.Colors.BRAND,
                                    look: P ? l.Button.Looks.LINK : l.Button.Looks.FILLED,

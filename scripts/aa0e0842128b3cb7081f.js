    ...
    [19493], {
                ...
                r.handleSend = function(e, t) {
                    ...
                    if (s.ZP.get("send_fail_100")) {
                        ...
                        null != L && (L.isInstanceUILocked() ? h = {
                            location: w.OVERLAY_LOCKED_ACTIVATED
                        } : L.isInstanceUILocked() || (h = L.isPinned(m.Odu.TEXT) ? {
                            location: w.OVERLAY_UNLOCKED_PINNED
                        } : {
                            location: w.OVERLAY_UNLOCKED
                        }));
        ...
        861323: (e, t, n) => {
            ...
            var r, o, i, u, a, l, c = n(608575),
                ...
                b = /^\/channels\/([0-9]+)\/shop$/,
                A = D(window.GLOBAL_ENV.INVITE_HOST),
                S = D(window.GLOBAL_ENV.GUILD_TEMPLATE_HOST),
                R = D(null !== (r = window.GLOBAL_ENV.WEBAPP_ENDPOINT) && void 0 !== r ? r : "//canary.".concat(E.$R1)),
                C = D("//canary.".concat(E.$R1)),
                N = D("//ptb.".concat(E.$R1)),
                P = D("discordapp.com"),
                w = D("discord.com"),
                M = [p.Z.escape(null !== (o = A.host) && void 0 !== o ? o : ""), p.Z.escape(null !== (i = S.host) && void 0 !== i ? i : ""), p.Z.escape(null !== (u = R.host) && void 0 !== u ? u : ""), p.Z.escape(null !== (a = P.host) && void 0 !== a ? a : ""), p.Z.escape(null !== (l = w.host) && void 0 !== l ? l : "")].filter(Boolean),
                L = new RegExp("((https?://[^ ]*)|^|[^/][^/.])(".concat(M.join("|"), ")"), "g");
            ...
            function j(e) {
                var t, n, r, o;
                return null !== (o = null !== (r = null !== (n = null !== (t = U(R, e)) && void 0 !== t ? t : U(C, e)) && void 0 !== n ? n : U(N, e)) && void 0 !== r ? r : U(P, e)) && void 0 !== o ? o : U(w, e)
            }
                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, g, M, D, j = U(A, p),
                                Z = U(S, p),
                                B = null !== (D = null !== (M = null !== (g = null !== (E = U(R, p)) && void 0 !== E ? E : U(C, p)) && void 0 !== g ? g : U(N, p)) && void 0 !== M ? M : U(P, p)) && void 0 !== D ? D : U(w, p),
                                V = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
                            ...
                            0;
                            if (null != (null == j ? void 0 : j.match(v))) {
                                var k = (0, f.mb)(j.substring(1), p.search);
                                d.Z.getInvite(k);
                                V(_.g.INVITE, k)
                            }
                            null != (null == Z ? void 0 : Z.match(v)) && V(_.g.TEMPLATE, Z.substring(1));
                            var x = null == B ? void 0 : B.match(y);
                            if (null != x) {
                                var Y = x[1].toUpperCase();
                                if (Y === _.g.INVITE) {
                                    var H = (0, f.mb)(x[2], p.search);
                                    V(_.g.INVITE, H)
                                } else V(Y, x[2])
                            }
                            null != (null == B ? void 0 : B.match(m)) && V(_.g.CHANNEL_LINK, B.replace("/channels/", ""));
                            var z = F(p.pathname);
                            null != z && V(_.g.EVENT, "".concat(z.guildId, "-").concat(z.guildEventId));
                            var W = null == B ? void 0 : B.match(O);
                            if (null != W) {
                                var K = W[1];
                                V(_.g.APP_DIRECTORY_PROFILE, K)
                            }
                            var q = null == B ? void 0 : B.match(T),
                            ...
                            if (null != q && Q) {
                                var X = q[1];
                                V(_.g.ACTIVITY_BOOKMARK, X)
                            }
                            var $ = null == B ? void 0 : B.match(I);
                            null != $ && V(_.g.GUILD_PRODUCT, "".concat($[1], "-").concat($[2]));
                            var J = null == B ? void 0 : B.match(b);
                            null != J && V(_.g.SERVER_SHOP, J[1])
                        }
                    }
                } catch (e) {
                    i = !0;
        ...
        269300: (e, t, n) => {
            ...
            function M(e) {
                ...
                if (r !== C && (null === (t = P.orphaned) || void 0 === t ? void 0 : t.has(e))) {
                    L(e, r);
                    D(e, C)
                }
                return Boolean(null === (n = P[r]) || void 0 === n ? void 0 : n.has(e))
            }

            function L(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : C;
                null == P[t] && (P[t] = new Set);
                P[t].add(e);
                N += 1
            }
            ...
            function D(e) {
                ...
                null === (t = P[n]) || void 0 === t || t.delete(e);
                N += 1
            }
            var U = {};
        ...
        649536: (e, t, n) => {
            ...
            function M(e) {
                return null == e.author ? w : null != e.webhook_id ? new c.Z(e.author) : null !== (t = T.default.getUser(e.author.id)) && void 0 !== t ? t : new c.Z(e.author);
                var t
            }
            ...
            function L(e) {
                var t, n, r, i, a, l, c, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    w = e.type === R.uaV.THREAD_STARTER_MESSAGE ? null === (n = e.referenced_message) || void 0 === n || null === (r = n.author) || void 0 === r ? void 0 : r.id : void 0,
                ...
                return new m.Z(P(N({}, e, S), {
                    author: I,
                    webhookId: e.webhook_id,
                    blocked: O.Z.isBlocked(I.id) || null != w && O.Z.isBlocked(w),
                    timestamp: g,
            ...
            function D(e, t) {
                return null != t.edited_timestamp ? P(N({}, t), {
        ...
        791707: (e, t, n) => {
            ...
            function i(e) {
                return !o.has(e.type) && e.type !== r.uaV.CHAT_INPUT_COMMAND && e.type !== r.uaV.CONTEXT_MENU_COMMAND && e.type !== r.uaV.INTERACTION_PREMIUM_UPSELL && e.type !== r.uaV.PREMIUM_REFERRAL && e.type !== r.uaV.CUSTOM_GIFT
            }
        },
        550131: (e, t, n) => {
            "use strict";
        ...
        284610: (e, t, n) => {
            ...
            P.displayName = "DraftStore";
            P.persistKey = "DraftStore";
            ...
            var q = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    o().forEach(H, (function(e, t) {
                        e.layoutPolicy === F.REQUIRED && r.push(t)
                    }));
                    o().forEach(V, (function(e, o) {
                        ...
                        try {
                            for (var f, d = function() {
                                    ...
                                    a = n = !0;
                                    var l = u().v4();
                                    r = new b(M(w({}, t.getWidgetDefaultSettings(e)), {
                                        type: e,
                                        id: l,
                                        layoutId: o,
                                        zIndex: i.length
            ...
            q.migrations = [function() {
                ...
                i.forEach((function(e) {
                    ...
                    if (!i && null != a) {
                        var l = u().v4();
                        r.widgets = [a, l];
                        o.push([l, M(w({}, K(S.Odu.GUILDS_TEXT)), {
            ...
            const Q = new q(c.Z, {
                ...
                LAYOUT_SET_PINNED: function(e) {
                    return z(e.widgetId, (function(e, t) {
                        ! function(e) {
                            k = M(w({}, k), N({}, e.id, e.set("pinned", !e.pinned)))
                        }(e)
                    }))
                },
                ...
                LAYOUT_CREATE_WIDGETS: function(e) {
                    e.widgetConfigs.forEach((function(e) {
                        ...
                        V = M(w({}, V), N({}, n.id, n.set("widgets", r)))
                    }))
                }
            })
        },
        352980: (e, t, n) => {
            ...
            function x() {
                a.Z.forEach((function(e) {
                    var t = e.channelId;
                    null == g.Z.getChannel(t) && a.Z.clear(t)
                }))
            }
            ...
            function z(e) {
                var t = e.type,
                    ...
                    l = a.Z.get(n);
                if (null == l) return !1;
                if (!(0, E.sm)(e)) return !1;
                var c = y.default.getId() === o;
            ...
            function W(e) {
                ...
                u = u.update(o, (function(e) {
                    ...
                    "MESSAGE_SEND_FAILED_AUTOMOD" === t && (e = e.set("flags", (0, m.pj)(e.flags, P.iLy.EPHEMERAL)));
                    return e
                }));
                a.Z.commit(u)
            }
            var K = function(e) {
                ...
                r.initialize = function() {
                    this.waitFor(N.default, g.Z, O.Z, I.ZP, v.default, R.Z, C.Z, b.Z, S.Z, T.ZP);
                    this.syncWith([d.Z], (function() {}))
                };
                r.getMessages = function(e) {
                    if (d.Z.hasViewingRoles()) {
                        var t = g.Z.getChannel(e),
                            n = null == t ? void 0 : t.getGuildId();
                        if (d.Z.isViewingRoles(n) && !A.Z.can(P.Plq.VIEW_CHANNEL, t)) return new a.Z(e)
                    }
                ...
                r.getLastEditableMessage = function(e) {
                    ...
                    return o()(this.getMessages(e).toArray()).reverse().find((function(e) {
                        return (0, _.Z)(e, null == t ? void 0 : t.id)
                    }))
                };
            ...
            const q = new K(u.Z, {
                BACKGROUND_SYNC_CHANNEL_MESSAGES: function(e) {
                    ...
                    for (var n in t) {
                        var r = a.Z.get(n);
                        if (null != r) {
                            r.cached || !0 ? r.mergeDelta(t[n].new_messages, t[n].modified_messages, t[n].deleted_message_ids) : B.log("Skipping background message sync for ".concat(n, " cached:").concat(r.cached, " ") + "ready:".concat(r.ready, " hasMoreAfter:").concat(r.hasMoreAfter, " ") + "isConnected:".concat(false))
                        }
                    }
                },
                CONNECTION_OPEN: V,
                ...
                CLEAR_MESSAGES: function(e) {
                    var t = e.channelId;
                    B.log("Clearing messages for ".concat(t));
                    a.Z.clear(t);
                    G.clear()
                },
                MESSAGE_CREATE: function(e) {
                    var t = e.channelId,
                        ...
                        o = a.Z.getOrCreate(t);
                    if (r) {
                        B.log("Inserting message tapped on from a push notification", n);
                        a.Z.commit(o.receivePushNotification(n))
                    } else {
                        if (!o.ready) return !1;
                        if ((0, p.Dn)() && null != n.nonce && n.state !== P.yb.SENDING && G.has(n.nonce)) {
                            o = o.remove(n.nonce);
                            G.delete(n.nonce)
                        }
                ...
                MESSAGE_SEND_FAILED: function(e) {
                    ...
                    o = o.update(n, (function(e) {
                        (e = e.set("state", P.yb.SEND_FAILED)).isCommandType() && (e = (e = e.set("interactionError", null != r ? r : "")).set("flags", (0, m.pj)(e.flags, P.iLy.EPHEMERAL)));
                        return e
                    }));
                    a.Z.commit(o)
                },
                ...
                GUILD_MEMBERS_CHUNK: H,
                THREAD_MEMBER_LIST_UPDATE: H,
                ...
                MESSAGE_REACTION_ADD_MANY: function(e) {
                    ...
                    o = o.update(n, (function(e) {
                        var t;
                        return e.addReactionBatch(r, null === (t = N.default.getCurrentUser()) || void 0 === t ? void 0 : t.id)
                    }));
                    a.Z.commit(o)
                },
            ...
            var q = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    if (null != e) {
                        ...
                        if (null != t) {
                            null == (x = k(t)).textChatNotifications && (x.textChatNotifications = M.textChatNotifications);
                            null == x.textWidgetOpacity && (x.textWidgetOpacity = M.textWidgetOpacity)
                        }
                    }
                };
                r.getState = function() {
                ...
                r.getTextChatNotificationMode = function() {
                    return x.notificationPositionMode === y._vf.DISABLED ? y.Ypu.DISABLED : x.textChatNotifications
                };
        ...
        644144: (e, t, n) => {
            ...
            var Z = function(e) {
                ...
                G = function(e) {
                    if (null == e) return [];
                    for (var t, n = new Set; null != (t = C.exec(e)) && n.size < 3;) n.add(F(t[1]));

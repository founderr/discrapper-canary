(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["67581"], {
        ...
        534222: function(e, t, n) {
            ...
            function C(e, t) {
                return (0, u.useStateFromStoresArray)([d.default, r.default, E.default, o.default, i.default, a.default], () => {
                    ...
                    if (l) {
                        ...
                        let e = null === (u = a.default.getDefaultChannel(n.id)) || void 0 === u ? void 0 : u.id,
                            t = null !== (s = r.default.getEventDirectoryEntries(e)) && void 0 !== s ? s : [];
                        return t.map(e => {
            ...
            function g(e) {
                return (0, u.useStateFromStores)([E.default, i.default, o.default], () => {
            ...
            function D(e) {
                var t, n;
                let l = (t = e, (0, u.useStateFromStoresArray)([E.default, i.default, o.default], () => {
                    ...
                    r = (0, u.useStateFromStoresObject)([_.default], () => _.default.getAllEventDismissals()),
                    a = (0, u.useStateFromStoresObject)([_.default], () => _.default.getAllUpcomingNoticeSeenTimes()),
                    d = (0, u.useStateFromStoresObject)([E.default], () => null == l ? {} : l.reduce((e, t) => {
                        let n = (0, h.getNextRecurrenceIdInEvent)(t);
                        return {
                            ...e,
            ...
            function I(e) {
                return (0, u.useStateFromStores)([E.default, i.default, o.default], () => {
                    ...
                    return t.find(e => {
                        if (e.entity_type === T.GuildScheduledEventEntityTypes.NONE || !(0, E.isGuildScheduledEventActive)(e)) return !1;
                        if (null == e.channel_id) return !0;
                        let t = i.default.getChannel(e.channel_id);
                        return o.default.can(S.Permissions.VIEW_CHANNEL, t)
                    })
            ...
            function y(e) {
                ...
                let r = (0, u.useStateFromStores)([E.default], () => null == e ? [] : E.default.getGuildScheduledEventsByIndex(E.StaticGuildEventIndexes.CHANNEL_EVENT_UPCOMING(e)), [e, t]),
                    i = l.useMemo(() => r.filter(e => {
                        let {
                            ...
                            withinStartWindow: l,
                            diffMinutes: u
                        } = (0, h.getEventTimeData)(t.toISOString(), null == n ? void 0 : n.toISOString());

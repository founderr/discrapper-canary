    ...
    [10848, 85572], {
        112897: (e, n, t) => {
            ...
            function s(e) {
                var n = e.id,
                    ...
                    c = e.showIconFirst,
                    d = i.Sb.useSetting();
                if (__OVERLAY__ || !d || !l.wS) return null;
            ...
            function E(e) {
                var n, t = (0, Z.Z)(),
                    ...
                    p = (0, o.e7)([s.Z], (function() {
                        return null != E ? s.Z.getVoiceStateForChannel(E, e.id) : null
                    }), [E, e.id]),
                    M = (null === (n = l.default.getCurrentUser()) || void 0 === n ? void 0 : n.id) === e.id,
                    S = function() {
                    ...
                    h = (0, o.e7)([d.ZP], (function() {
                        return d.ZP.getPermissionsForUser(e.id, E)
                    }), [E, e.id]),
                    j = (0, c.B)(E);
                if (null == t || null == v || null == p) return null;
                if (h.speaker) return null;
                var C = function() {
                    M ? (0, a.RK)(t, !1) : (0, a._0)(t, e.id)
                };
                return j ? (0, r.jsx)(i.MenuItem, {
                    id: "invite-speaker",
                    label: M ? g.Z.Messages.STAGE_CHANNEL_USER_SET_MYSELF_TO_SPEAKER : g.Z.Messages.STAGE_CHANNEL_USER_INVITE_TO_SPEAK,
                    action: C
                }) : S && M ? (0, r.jsx)(i.MenuItem, {
                    id: "invite-speaker",
        ...
        810848: (e, n, t) => {
            ...
            var r = t(785893),
                ...
                h = t(2590),
                j = t(473708);
            const C = (0, l.Z)((0, u.Z)((function(e) {
                var n = e.user,
                    t = e.showMediaItems,
                    u = void 0 !== t && t,
                    l = e.mediaEngineContext,
                    a = e.onSelect,
                    h = (0, p.Z)(n.id),
                    C = (0, _.Z)(n.id),
                    m = (0, g.Z)(n),
                ...
                return (0, r.jsxs)(o.Menu, {
                    ...
                    children: [!V && (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsx)(o.MenuGroup, {
                            ...
                            r.jsxs)(o.MenuGroup, {
                            children: [h, C, m, y, A, N]
                        }), u && (0, r.jsx)(o.MenuGroup, {
                            children: U
                        }), (0, r.jsx)(o.MenuGroup, {
                            children: I
        ...
        93439: (e, n, t) => {
            ...
            function c(e, n) {
                var t = l.default.getId(),
                    c = n === s.IlC.POPOUT;
                return t === e || c ? null : (0, r.jsx)(o.MenuItem, {
                    id: "message-user",
        ...
        598955: (e, n, t) => {
            ...
            function p(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : g.Yn.DEFAULT,
                    t = (0,
                    ...
                    S = p.deafened,
                    h = void 0 !== S && S,
                    j = p.localVideoDisabled,
                    C = void 0 !== j && j,
                    m = p.localVideoAutoDisabled,
                    y = void 0 !== m && m,
                    A = a.Z.supports(g.AN.DISABLE_VIDEO) && !t ? (0, r.jsx)(i.MenuCheckboxItem, {
                        id: "disable-video",
                        ...
                        action: function() {
                            if (y) u.Z.show({
                                ...
                                onConfirm: function() {
                                    return l.Z.setDisableLocalVideo(e, Z.ZUi.MANUAL_ENABLED)
                                }
                            });
                            else {
                                var t = C ? Z.ZUi.MANUAL_ENABLED : Z.ZUi.DISABLED;
                                l.Z.setDisableLocalVideo(e, t, n)
                            }
                        },
                        checked: C,
                        subtext: y ? (0, r.jsxs)("div", {
                    ...
                    N = t ? null : (0, r.jsx)(i.MenuCheckboxItem, {
        ...
        234617: (e, n, t) => {
            ...
            function g(e) {
                var n, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : d.Yn.DEFAULT,
                    ...
                    g = e === (null === (n = s.default.getCurrentUser()) || void 0 === n ? void 0 : n.id),
                    E = t === d.Yn.STREAM;
                return g ? null : (0, r.jsx)(i.MenuControlItem, {
                    id: "user-volume",
                    label: E ? f.Z.Messages.STREAM_VOLUME : f.Z.Messages.USER_VOLUME,
                    control: function(n, o) {
                        return (0, r.jsx)(i.MenuSliderControl, Z(b({}, n), {
                            ref: o,
                            value: (0, a.P)(O),
...
//# sourceMappingURL=e1d0039b98cb484d26f5.js.map
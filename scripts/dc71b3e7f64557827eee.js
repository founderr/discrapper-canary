...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [88310, 47428], {
                    ...
                    i.FB && !__OVERLAY__ && u.ZP.getGPUDriverVersions().then((function(e) {
                        h = function(t) {
                            ...
                            var n, r, o, u = !0,
                                ...
                                a = void 0;
                            try {
                                for (var s, p = Object.keys(t)[Symbol.iterator](); !(u = (s = p.next()).done); u = !0) {
                                    var y = s.value,
                                        d = t[y],
                                        b = e[y];
        ...
        488310: (t, e, n) => {
            ...
            function X() {
                X = W((function(t, e) {
                    var n, r, q, W, X, $, tt, et, nt, rt, ot, it, ut, ct, at, lt, ft, st, pt, yt, dt, bt, vt, Ot, ht, gt, St, It, Et, mt, Pt, _t, wt, Tt, Ct, jt, Rt, Zt, Nt, At, Dt, Lt, Vt, Bt, xt, kt, Mt = arguments;
                    return K(this, (function(K) {
                        switch (K.label) {
                            case 0:
                                n = Mt.length > 2 && void 0 !== Mt[2] ? Mt[2] : new i.Z;
                                return [4, new Promise((function(t) {
                                    return setImmediate(t)
                                }))];
                            case 1:
                                K.sent();
                                if (null == (r = M.default.getCurrentUser())) return [2, new Promise((function(r) {
                                    n.fail((function() {
                                        r(Q(t, e, n))
                                    }))
                                }))];
                                n.succeed();
                                q = Object.values(M.default.getUsers());
                                ...
                                Ot = Array.from(s.Z.getMessageRequestChannelIds());
                                ht = x.Z.getVoiceChannelId();
                                gt = z.Z.getFocusedPID();
                                St = z.Z.getSelectedGuildId();
                                It = z.Z.getSelectedChannelId();
                                Et = A.Z.getState();
                                mt = P.Z.games.map((function(t) {
                                    return t.toJS()
                                }));
                                Pt = Object.values(U.Z.paymentSources).map((function(t) {
                                    return t.toJS()
                                }));
                                _t = U.Z.defaultPaymentSourceId;
                                wt = U.Z.hasFetchedPaymentSources;
                                Tt = h.Z.getState();
                                ...
                                Nt = Array.from(f.Z.getState().hiddenHotspots);
                                At = a.Z.getSerializedState();
                                Dt = l.Z.getState();
                                Lt = y.Z.getInitialOverlayState();
                                Vt = d.Z.getInitialOverlayState();
                                Bt = b.Z.getInitialOverlayState();
                                xt = (0, O.xU)(u.o8, v.Z.settings);
                                kt = p.Z.getOverlaySerializedState();
                                return [2, {
                                    ...
                                    threadMembers: Vt,
                                    threadMessages: Bt,
                                    userSettingsProto: xt,
                                    soundboardStoreState: kt
                                }]
                        }
                    }))
                }));
                ...
                PRESENCE_UPDATES: function(t) {
                    return t.updates.map((function(t) {
                        var e = t.guildId,
                            ...
                            r = t.status,
                            o = t.activities;
                        return E(null != e ? e : f.ME, n.id, o, r)
                    })).some((function(t) {
                        return t
                    }))
                },
        ...
        517205: (t, e, n) => {
            ...
            const j = new C(u.Z, s.Z.isSupported() ? {
        ...
        3862: (t, e, n) => {
            ...
            const m = new E(u.Z, {
                ...
                LOBBY_VOICE_STATE_UPDATE: function(t) {
                    ...
                    if (g === n) return !1;
                    null == n ? delete(v = s({}, v))[o] : v = p(s({}, v), l({}, o, n));
                    S[i] = v
                },
                LOBBY_DELETE: I,
                LOBBY_DISCONNECT: I
        ...
        453007: (t, e, n) => {
            ...
            function O(t) {
                return v(u.OcF.COMPLETE, u.mFx.JOIN, t)
            }
            var h = function(t) {
                ! function(t, e) {
                    if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function");
            ...
            h.displayName = "ActivityLauncherStore";
            const g = new h(i.Z, {
                OVERLAY_INITIALIZE: function(t) {
                ...
                ACTIVITY_JOIN_LOADING: function(t) {
                    return v(u.OcF.LOADING, u.mFx.JOIN, t)
                },
                ACTIVITY_JOIN_FAILED: function(t) {
                    return v(u.OcF.FAILED, u.mFx.JOIN, t)
                },
                ACTIVITY_JOIN: O,

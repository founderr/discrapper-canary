...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [84441], {
        84441: (e, t, n) => {
            ...
            function k() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : v.Z5c.DEFAULT_LOGGED_OUT;
                w();
                var t = (0, d.PP)();
                if (null != e)
                    if (null != t) {
            ...
            const Z = {
                ...
                login: function(e) {
                    ...
                    E.Z.post(g({
                        ...
                        r === v.evJ.ACCOUNT_SCHEDULED_FOR_DELETION && null != o && "" !== o ? u.Z.dispatch({
                            type: "LOGIN_ACCOUNT_SCHEDULED_FOR_DELETION",
                            credentials: {
                                login: n,
                                password: o
                            }
                        }) : r === v.evJ.ACCOUNT_DISABLED && null != o && "" !== o ? u.Z.dispatch({
                            type: "LOGIN_ACCOUNT_DISABLED",
                            credentials: {
                                login: n,
                                password: o
                            }
                        }) : r === v.evJ.PHONE_VERIFICATION_REQUIRED ? u.Z.dispatch({
                ...
                loginMFA: function(e) {
                    ...
                    E.Z.post({
                        url: a ? v.ANM.LOGIN_WEBAUTHN : v.ANM.LOGIN_MFA,
                        body: {
                            code: t,
                            ticket: n,
                            login_source: o,
                ...
                loginMFAv2: function(e) {
                    var t, n = e.code,
                        ...
                        c = e.mfaType,
                        l = this;
                    t = "webauthn" === c ? v.ANM.LOGIN_WEBAUTHN : "sms" === c ? v.ANM.LOGIN_SMS : v.ANM.LOGIN_MFA;
                    return E.Z.post({
                        url: t,
                        body: {
                            code: n,
                        ...
                        var t;
                        if ((null === (t = e.body) || void 0 === t ? void 0 : t.code) === v.evJ.MFA_INVALID_CODE) throw new Error((0, f.mapError)(c));
                        throw e
                    }))
                },
                ...
                logout: function() {
                    var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : v.Z5c.DEFAULT_LOGGED_OUT,
                ...
                resetPassword: function(e, t, n) {
                    return A((function() {
                        var o, i, c, l, d, f, p, h, y, S, O, b, A, m;
                        return T(this, (function(g) {
                            switch (g.label) {
                                case 0:
                                    ...
                                    i = s.Z.get(v.JkL);
                                    if (null != (c = (0, _.xJ)()) && null != i) {
                                        o.push_provider = c;
                                        o.push_token = i
                                    }
                                    l = s.Z.get(v.scU);
                                    if (null != v.mvA && null != l) {
                                        o.push_voip_provider = v.mvA;
                                        o.push_voip_token = l
                                    }
                                    g.label = 1;
                                case 1:
                                ...
                                case 2:
                                    d = g.sent(), f = d.body, p = f.mfa, h = f.sms, y = f.webauthn, S = f.ticket, O = f.token, b = f.backup, A = f.totp;
                                    return [2, {
                        ...
                        return T(this, (function(o) {
                            switch (o.label) {
                                ...
                                case 3:
                                    t = o.sent();
                                    n = new a.yZ(t);
                                    n.code === v.evJ.PHONE_VERIFICATION_REQUIRED ? u.Z.dispatch({

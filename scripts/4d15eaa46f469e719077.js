    ...
    ["33085"], {
        ...
        506838: function(e, t, n) {
            ...
            let S = c(T(function(e) {
                ...
                y = e => T(t => N(t) && t <= e),
                M = e => T(t => N(t) && t >= e),
                D = () => T(e => N(e) && Number.isInteger(e)),
                R = () => T(e => N(e) && Number.isFinite(e)),
                L = () => T(e => N(e) && e > 0),
                V = () => T(e => N(e) && e < 0),
        ...
        844808: function(e, t, n) {
            ...
            function o(e) {
                ...
                } = e, d = a.useMemo(() => (0, r.recurrenceRuleToOption)(t, n), [n, t]), c = function(e) {
                    let t = e.toDate(),
                ...
                return (0, l.jsxs)(l.Fragment, {
                    children: [(0, l.jsx)("div", {
                        ...
                        children: [(0, l.jsxs)(o.FormItem, {
                            ...
                            schedule: k,
                            recurrenceRule: H,
                            showEndDate: R === v.GuildScheduledEventEntityTypes.EXTERNAL,
                            requireEndDate: R === v.GuildScheduledEventEntityTypes.EXTERNAL,
        ...
        590942: function(e, t, n) {
            ...
            function b(e) {
                let {
                    ...
                    valid: !0
                }], [E]), D = Object.keys(l).length, R = (0, N.isGuildScheduledEventActive)(n), L = e => Math.max(0, Math.min(e, D - 1)), [j, P] = r.useState(R ? 1 : 0), [b, H] = r.useState(!1), B = r.useMemo(() => x.slice(0, j + 1).map(e => e.valid).every(Boolean), [x, j]), w = j >= x.length ? 3 : x[L(j)].slideId, F = 3 === w, k = (0, C.useGuildEventModalStore)(e => e.onUpdateCanCloseModal);
                k(F);
            ...
            function H(e) {
                let {
                    ...
                    return U(n.body), n
                }), F = r.useMemo(() => (0, D.default)(C, O), [C, O]);
                return (0, s.jsx)(b, {
                    guildId: t,
                    guildEvent: C,
                    guildEventId: l,
                    ...
                    onChange: e => {
                        if (null != e.entityType) {
                            ...
                            e.channelId = null !== (n = null == a ? void 0 : a.id) && void 0 !== n ? n : null, e.entityType !== R.GuildScheduledEventEntityTypes.EXTERNAL && C.entityType === R.GuildScheduledEventEntityTypes.EXTERNAL && (e.entityMetadata = null)
                        }
                        A(t => ({
                            ...t,
                            ...e
        ...
        560309: function(e, t, n) {
            ...
            var l = n("37983"),
                ...
                M = n("782340"),
                D = n("869785");
            let R = e => e === O.GuildScheduledEventEntityTypes.EXTERNAL,
                L = (e, t) => {
            ...
            function b(e) {
                ...
                return null == o || o === O.GuildScheduledEventEntityTypes.NONE ? null : R(o) ? (0, l.jsx)(u.FormItem, {
            ...
            function B(e) {
                let {
                    ...
                    entityType: d
                } = a, f = (0, i.useStateFromStores)([c.default], () => c.default.getGuild(t), [t]), h = (0, p.useChannelsUserCanStartStageIn)(f), _ = (0, i.useStateFromStores)([E.default], () => E.default.can(y.Permissions.MANAGE_CHANNELS, f)), I = null == f ? void 0 : f.hasFeature(y.GuildFeatures.COMMUNITY), T = G(r, a), m = I && !R(d) && 0 === h.length && _ && null != d;
                return (0, l.jsxs)("div", {
        ...
        151859: function(e, t, n) {
            ...
            function v(e) {
                ...
                let {
                    ...
                    image: y,
                    description: M
                } = C, D = (0, s.useStateFromStores)([o.default], () => o.default.getChannel(A), [A]), R = (0, s.useStateFromStores)([d.default], () => d.default.getGuild(g), [g]), L = (0, h.getLocationFromEvent)(C), V = (0, s.useStateFromStores)([c.default], () => null != S.creatorId ? c.default.getUser(S.creatorId) : c.default.getCurrentUser(), [S.creatorId]), U = (0, s.useStateFromStores)([u.default], () => u.default.isLurking(g), [g]), j = (0, i.getChannelIconComponent)(D, R);
                return (0, l.jsxs)("div", {
                    className: N.content,
                            ...
                            children: null != location ? m.default.Messages.GUILD_EVENT_PREVIEW_EXTERNAL_EVENT_BODY : m.default.Messages.GUILD_EVENT_PREVIEW_BODY.format({
                                ...
                                channelHook: () => {
                                    ...
                                    return (0, l.jsxs)("div", {
                                        ...
                                        }), null !== (e = null == D ? void 0 : D.name) && void 0 !== e ? e : L]
                                    })
                                }
                            })
        ...
        499950: function(e, t, n) {
            ...
            function C(e) {
                ...
                }, [y]), D = (0, a.useStateFromStores)([E.default], () => E.default.getGuild(y), [y]), R = (null == D ? void 0 : D.vanityURLCode) != null && (null == D ? void 0 : D.vanityURLCode.length) > 0, {
                    enabled: L
                ...
                let P = L && null !== (t = null == D ? void 0 : D.vanityURLCode) && void 0 !== t ? t : null == j ? void 0 : j.code,
                ...
                return (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsx)(s.Clickable, {
                        ...
                        }), (null == D ? void 0 : D.vanityURLCode) == null && (0, l.jsx)(s.Text, {
                            variant: "text-xs/normal",
                            color: "header-secondary",

    ...
    [31203, 3039], {
        ...
        803039: (e, t, n) => {
            ...
            const M = function(e) {
                ...
                a.useEffect((function() {
                    ...
                    null != t && d.isReady && !b && (e = e.map((function(n, r) {
                        return setTimeout((function() {
                            r === e.length - 1 && y(!0);
                            d.createMultipleConfetti(P(t.getBoundingClientRect()), 50)
                        }), 100 * r)
                    })));
                    return function() {
                        var t = !0,
                ...
                return (0, r.jsx)(i.Ji, {
                    ref: s,
                    sprites: null != l ? l : I.CA,
                    colors: null != o ? o : I.Br,
                    spriteWidth: I.Ko,
                    spriteHeight: I.Ko
                })
            };
            ...
            var V = function(e) {
                var t, n, l = e.product,
                    ...
                    W = null !== (n = l.items.find(A.H)) && void 0 !== n ? n : null,
                    V = (0, p.Z)({
                        user: Z,
                    ...
                    U = a.useRef(null),
                    Y = (0, v.Z)(H(E).concat([y.Z.COLLECTIBLES_COLLECTED_MODAL])),

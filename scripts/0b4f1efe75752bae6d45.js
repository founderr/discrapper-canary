...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [98847], {
        101566: (e, t, n) => {
            ...
            var E = new d.Z("UploaderBase.tsx"),
                x = function(e) {
                    ! function(e, t) {
            ...
            var F = function(e, t) {
                ...
                G = new r.Z("CloudUploaderBase.tsx"),
                H = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        e.prototype = Object.create(t && t.prototype, {
                                ...
                                switch (v.label) {
                                    case 0:
                                        ...
                                        if (e.files.length > r.getMaxAttachmentsCount()) {
                                            G.log("Too many attachments for ".concat(e.id));
                                            e._handleError({
                                    ...
                                    case 4:
                                        ...
                                        if (f.status === i.m.CANCELED) {
                                            G.log("compressAndCheckFileSize() file has been cancelled for compression - ".concat(f.id));
                                            return [3, 6]
                                        }
                    ...
                    r.setUploadingTextForUI = function() {
                        var e = 1 === this.files.length && null != this.files[0].filename ? this.files[0].filename : T.Z.Messages.UPLOADING_FILES.format({
                            ...
                            r = this._fileSize();
                        G.log("setUploadingTextForUI - total content: ".concat(r, " bytes and ").concat(this.files.length, " attachments for ").concat(this.id));
                        this._file = k(R({}, this._file), {
                    ...
                    r.cancel = function() {
                        G.log("Cancel called for ".concat(this.id));
                        if (!this._aborted) {
                            this._aborted = !0;
                            null != this._cancel && this._cancel();
                    ...
                    r.cancelItem = function(e) {
                        ...
                        return M((function() {
                            ...
                            return F(this, (function(l) {
                                switch (l.label) {
                                    case 0:
                                        G.log("Cancel called for ".concat(t.id, " for item ").concat(e));

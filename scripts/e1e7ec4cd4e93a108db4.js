        ...
        986675: function(e, t, s) {
            ...
            let v = "2023_q4_nitro_drop",
                ...
                H = () => {
                    ...
                    let {
                        enabled: t
                    } = C.Q4DropExperiment.getCurrentConfig({
            ...
            function j(e) {
                let {
                    ...
                    onClose: s
                } = t, c = (0, a.useStateFromStores)([N.default], () => N.default.locale), f = c.split("-")[0], C = "en" === f ? "0" : "1", H = "zh-CN" === c ? "zh-Hans" : "zh-TW" === c ? "zh-Hant" : f, j = {
                    url: "".concat((0, h.YOUTUBE_EMBED_URL)(y), "?vq=large&rel=0&controls=0&showinfo=0&cc_load_policy=").concat(C, "&cc_lang_pref=").concat(H),
                    width: 498,
                    height: 280
                }, {
                    location: B
                ...
                } = (0, d.default)(_.default.PREMIUM_MARKETING_ANNOUNCEMENT_MODAL), k = (0, u.default)(), w = (0, I.usePremiumTrialOffer)(), Q = null == w ? void 0 : w.subscription_trial, F = (0, p.usePremiumDiscountOffer)(), V = (0, A.formatTrialCtaIntervalDuration)({
                    intervalType: null == Q ? void 0 : Q.interval,
                    intervalCount: null == Q ? void 0 : Q.interval_count
                }), W = (0, R.useResponseOnUserState)({
                    onCustomCriteria: () => {
                ...
                }), q = (0, l.isThemeDark)(k) ? M.PremiumPillAndSparklesColorOptions.PREMIUM_TIER_2_WHITE_FILL : M.PremiumPillAndSparklesColorOptions.PREMIUM_TIER_2_NEW_GRADIENT_FILL;
                return (0, n.jsx)(D.default, {
                    ...
                    modalTopExtra: () => null != Q ? (0, n.jsx)(M.PremiumPillWithSparkles, {
        ...
        837797: function(e, t, s) {
            ...
            function u(e) {
                let {
                    ...
                    onTier2Subscriber: f,
                    onCustomCriteria: m
                } = e, T = (0, i.usePremiumTrialOffer)(), O = (0, l.usePremiumDiscountOffer)(), A = (0, n.useStateFromStores)([a.default], () => a.default.getPremiumTypeSubscription()), C = r.default.getPremiumTypeFromSubscription(A);
                if (null != m) {
                    let e = m();
                    if (null != e) return e
                }
                return null != T && (0, o.SubscriptionTrials)[T.trial_id].skus.includes(o.PremiumSubscriptionSKUs.TIER_0) ? null != _ ? _ : t : null != T && (0, o.SubscriptionTrials)[T.trial_id].skus.includes(o.PremiumSubscriptionSKUs.TIER_2) ? null != d ? d : t : null != A && null != A.trialId && C === o.PremiumTypes.TIER_0 ? null != c ? c : t : null != A && null != A.trialId && C === o.PremiumTypes.TIER_2 ? null != E ? E : t : null != O ? null != s ? s : t : null == C ? null != u ? u : t : C === o.PremiumTypes.TIER_0 || C === o.PremiumTypes.TIER_1 ? null != N ? N : t : C === o.PremiumTypes.TIER_2 ? null != f ? f : t : t
            }
        },
        702542: function(e, t, s) {
            ...
            function C(e) {
                let {
                    ...
                    onClose: S,
                    transitionState: L
                } = s, P = (0, d.useUID)(), b = D.length % 2 == 0;
                return a.useEffect(() => {
                    (0, o.requestMarkDismissibleContentAsShown)(C);
                    let e = Date.now();
                    return E.default.track(f.AnalyticEvents.CHANGE_LOG_OPENED, {
                        ...
                        E.default.track(f.AnalyticEvents.CHANGE_LOG_CLOSED, {
                            change_log_id: g,
                            seconds_open: Math.round((Date.now() - e) / 1e3)
                        }), (0, o.markDismissibleContentAsDismissed)(C, {
                            dismissAction: m.ContentDismissActionType.DISMISS
                        })
                    }
                }, [C, g]), (0, n.jsxs)(i.ModalRoot, {
                    ...
                    children: [(0, n.jsx)(i.ModalCloseButton, {
                        ...
                        className: T.splash
                    }), null == R ? void 0 : R(), (0, n.jsxs)(i.ModalContent, {
                        className: T.content,
                        children: [(0, n.jsx)(i.Heading, {
                            variant: "display-md",

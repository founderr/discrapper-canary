    ...
    [7811], {
        707811: (t, e, a) => {
            ...
            var s = a(785893),
                ...
                M = a(597661),
                E = a.n(M),
                d = r.Z.getArticleURL(N.BhN.MISSING_ENTITLEMENT);
            const T = i.ZP.connectStores([o.Z], (function(t) {
                var e = t.applicationId;
                return {
                    application: o.Z.getGame(e)
                }
            }))((function(t) {
                var e = t.application,
                    a = t.transitionState,
                ...
                return (0, s.jsxs)(n.ModalRoot, {
                    ...
                    children: [(0, s.jsxs)(n.ModalHeader, {
                        ...
                        children: [(0, s.jsx)(n.FormTitle, {
                            ...
                            children: null != e ? c.Z.Messages.MISSING_ENTITLEMENT_MODAL_HEADER.format({
                        ...
                        children: [(0, s.jsx)("div", {
                            className: E().missingEntitlementImage
                        }), (0, s.jsx)(n.Text, {
                            className: E().text,
                            variant: "text-md/normal",
                            children: null != e ? c.Z.Messages.MISSING_ENTITLEMENT_MODAL_BODY.format({
                                applicationName: e.name,
                                supportArticleURL: d
...
//# sourceMappingURL=d2087bd028fd30dbd293.js.map
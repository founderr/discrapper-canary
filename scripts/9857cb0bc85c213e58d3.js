(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [51743, 84346, 10848, 85572, 84832, 57678, 58621, 96043, 71402, 56645], {
        737264: e => {
            "use strict";
            ...
            var v = function(e) {
                ...
                n.prototype.render = function() {
                    var e, t = this.props,
                        ...
                        b = m.errorMessage,
                        O = m.retrySuccess,
                        S = i.Children.count(c) > 0 ? (0, r.jsx)(u.Card, {
            ...
            function D(e) {
                ...
                if (!b.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== I.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        c = y({}, t, R(u), null != i && null != o && (0, T.AB)(o) ? L(0, o) : P(a));
                    b.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        165586: (e, t, n) => {
            ...
            var h = [E(r.RESOLUTION_720), E(r.RESOLUTION_1080), E(r.RESOLUTION_1440), E(r.RESOLUTION_SOURCE, (function() {
                ...
                v = [E(r.RESOLUTION_720), E(r.RESOLUTION_1080), E(r.RESOLUTION_1440)],
                m = function(e) {
                    return "".concat(e, "p")
                },
        ...
        575351: (e, t, n) => {
            ...
            function v(e) {
                ...
                return T ? (0, r.jsx)(o.MenuItem, {
                    id: "invite-speaker",
                    label: O ? h.Z.Messages.STAGE_CHANNEL_USER_SET_MYSELF_TO_SPEAKER : h.Z.Messages.STAGE_CHANNEL_USER_INVITE_TO_SPEAK,
                    action: A
                }) : S && O ? (0, r.jsx)(o.MenuItem, {
                    id: "invite-speaker",
            ...
            function K() {
                ...
                for (var l in C)
                    for (var c in C[l])
                        for (var s in C[l][c]) {
                            var f = C[l][c][s];
                            d.ZP.isForumPostUnread(s) && X(P, f, f, !1)
                        }
                G()
            }
        ...
        810848: (e, t, n) => {
            ...
            var r = n(785893),
                ...
                I = n(2590),
                T = n(473708);
            const A = (0, u.Z)((0, a.Z)((function(e) {
                var t = e.user,
                    n = e.showMediaItems,
                    a = void 0 !== n && n,
        ...
        598955: (e, t, n) => {
            ...
            function b(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : h.Yn.DEFAULT,
                    ...
                    S = b.deafened,
                    I = void 0 !== S && S,
                    T = b.localVideoDisabled,
                    A = void 0 !== T && T,
                    y = b.localVideoAutoDisabled,
                    N = void 0 !== y && y,
                    R = c.Z.supports(h.AN.DISABLE_VIDEO) && !n ? (0, r.jsx)(o.MenuCheckboxItem, {
                        id: "disable-video",
                        ...
                        action: function() {
                            if (N) a.Z.show({
                                ...
                                onConfirm: function() {
                                    return u.Z.setDisableLocalVideo(e, E.ZUi.MANUAL_ENABLED)
                                }
                            });
                            else {
                                var n = A ? E.ZUi.MANUAL_ENABLED : E.ZUi.DISABLED;
                    ...
                    L = n ? null : (0, r.jsx)(o.MenuCheckboxItem, {
                        id: "soundboard-sound-mute",
                        label: v.Z.Messages.MUTE_SOUNDBOARD,
                        action: function() {
                            var n = s.Z.getRTCConnection();
                            _.default.track(E.rMx.AUDIO_LOCAL_SOUNDBOARD_MUTE_TOGGLED, {
        ...
        491260: (e, t, n) => {
            ...
            function D(e) {
                ...
                delete R[e];
                if (null != A[e]) {
                    var t = g(a().sortBy(A[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
            ...
            const F = new j(l.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(e) {
                    ...
                    if (y[t] === e.status && N[t] === e.activities) return !1;
                    y[t] = e.status;
                    N[t] = e.activities;
                    delete L[t]
                }
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                ...
                null != e.scrollPosition && null != b && (S[b] = e.scrollPosition);
                ...
                P = null !== (o = e.analyticsLocations) && void 0 !== o ? o : [];
            ...
            var Z = function(e) {
                ...
                r.hasChanges = function() {
                    return null != A && null != T && (!(!this.isOpen() && R !== l.cII.USER_SETTINGS) && !i().isEqual(A, T))
                };
                r.isOpen = function() {
                    return y
                };
                ...
                r.getProps = function() {
                    return {
                        ...
                        scrollPosition: null != b ? S[b] : null,
                        settings: A,
                        errors: I,
            ...
            const k = new Z(a.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    ...
                    C = null;
                    var t;
                    P = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [];
                ...
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete S[t] : null != b && delete S[b]
                },
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, E, h, v, m = encodeURIComponent(l.toString()),
                    g = encodeURIComponent(u()),
                    b = (E = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), h = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(E)), v = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !h, "iOS" !== (null === i() || void 0 === i() || null === (_ = i().os) || void 0 === _ ? void 0 : _.family) || v ? 1 : 0),
                    O = null != r ? encodeURIComponent(r) : null,
                    S = null != o ? encodeURIComponent(o) : null,
                    I = "".concat(f, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(g, "&efr=").concat(b);
                null != O && (I += "&afl=".concat(O));
                null != S && (I += "&ifl=".concat(S));
                return I
            }
        },
        426080: (e, t, n) => {
        ...
        717621: (e, t, n) => {
            ...
            ! function(i) {
                ...
                d.prototype = {
                    ...
                    toName: function() {
                        return 0 === this._a ? "transparent" : !(this._a < 1) && (P[E(this._r, this._g, this._b, !0)] || !1)
                    },
                    toFilter: function(e) {
                ...
                var j, F, B, H = (F = "[\\s|\\(]+(" + (j = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + j + ")[,|\\s]+(" + j + ")\\s*\\)?", B = "[\\s|\\(]+(" + j + ")[,|\\s]+(" + j + ")[,|\\s]+(" + j + ")[,|\\s]+(" + j + ")\\s*\\)?", {

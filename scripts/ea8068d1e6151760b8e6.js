    ...
    [37010], {
                ...
                return (0, r.jsx)(r.Fragment, {
                    children: Object.keys(N).sort((function(e, t) {
                        ...
                        var t, o, i, u = N[e],
                            ...
                            m = null != (null == v ? void 0 : v.bot) ? new w.Z(v.bot) : null;
                        ...
                        var S, T, P, I, A = a[null !== (i = null == b ? void 0 : b.type) && void 0 !== i ? i : V.Kt],
                            L = !d && null != A && A <= O;
                        S = d ? (0, r.jsx)(x.Z, {
                        ...
                        (null == b ? void 0 : b.type) === z.ABu.STEAM && (T = W.Z.Messages.CONNECTIONS_STEAM_TOOLTIP);
            ...
            function ae(e) {
                ...
                o.useEffect((function() {
                    if (K && null != Ce && Ce.roles.includes(c.id)) {
                        Q(!1);
                        we.length > 0 ? S(ne.ROLE_GRANTED) : null == n || n();
                        k.default.track(z.rMx.PASSPORT_CHALLENGE_FINISHED, $({
                            role_id: c.id
                        }, (0, E.hH)(i)))
                    }
                }), [K, we.length, Ce, i, c.id, n]);
        ...
        223219: (e, t, n) => {
            ...
            function x(e) {
                ...
                D = null !== (c = e.impressionSource) && void 0 !== c ? c : null
            }
            ...
            var k = function(e) {
                ...
                r.hasChanges = function() {
                    return null != T && null != C && (!(!this.isOpen() && j !== l.cII.USER_SETTINGS) && !o().isEqual(T, C))
                };
                r.isOpen = function() {
                    return w
                };
            ...
            const U = new k(c.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    j = e.tab;
                    return null == g && j === l.cII.USER_SETTINGS && x({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

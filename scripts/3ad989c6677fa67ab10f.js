    ...
    [84832, 14136, 65091, 88110, 96043, 71402, 77357, 56645], {
        ...
        100856: (e, t, n) => {
            ...
            function g(e, t) {
                ...
                if (!m && !_.Z.can(b.Plq.MOVE_MEMBERS, g)) return null;
                var S = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== g.id && (m ? _.Z.can(b.Plq.CONNECT, n) && !(0, O.rY)(n, I.Z, p.Z) : _.Z.can(b.Plq.MOVE_MEMBERS, n) && (_.Z.can(b.Plq.CONNECT, n) || T.ZP.can({
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, E, h, I, O = encodeURIComponent(c.toString()),
                    ...
                    m = "".concat(f, "/?link=").concat(O, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(T, "&efr=").concat(b);

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [47311, 38657], {
        947311: (e, n, t) => {
            ...
            var K = function(e) {
                ...
                return null == t ? null : (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(w.Z, {
                        ...
                        children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_CANCEL_WARNING.format({
            ...
            ee.TransferBody = function(e) {
                var n, t, i = e.imageClass,
                    ...
                    C = void 0 === m ? 0 : m,
                    h = o.useRef(s),
                    S = null === (n = h.current) || void 0 === n ? void 0 : n.length,
                    y = null === (t = h.current) || void 0 === t ? void 0 : t.reduce((function(e, n) {
                ...
                return (0, r.jsxs)(X, {
                    ...
                    children: [(0, r.jsx)(a.Text, {
                        ...
                        children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_TRANSFER_FROM_GUILD.format({
                            guildCount: S
                        })
                    }), null != y ? Object.keys(y).map((function(e) {
                        return (0, r.jsx)(D, {
                        ...
                        className: F().transferGuildCardHeader,
                        children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_TRANSFER_TO_GUILD.format({
                            slotCount: p
                        })
                    }), (0, r.jsx)("div", {
            ...
            const pe = function(e) {
                var n, t, i = e.guildBoostSlots,
                    ...
                    y = e.transitionState,
                    b = e.onClose,
                    _ = (0, C.vx)(f.Z.boostSlots);
                l()(null != i || null != h, "Must either provide slots or an initial selected guild");
                l()(!(null == i ? void 0 : i.some((function(e) {
                    return e.isOnCooldown()
                }))), "If slots are provided, they must not be on cooldown");
                var v, g = [null == i ? de.UNUSED_QUANTITY_SELECT : null, null == h ? de.GUILD_SELECT : null, de.CONFIRM, de.SUCCESS].filter((function(e) {
                        return null != e
                    })),
                    I = ce((0, s.Wu)([c.Z], (function() {
                    ...
                    G = P[0],
                    T = P[1],
                    w = ce(o.useState(null != i ? i : _.slice(0, 1)), 2),
                    Z = w[0],
                    F = w[1],
                    k = o.useMemo((function() {
                        return null == Z ? [] : Z.map((function(e) {
                    ...
                    H = o.useMemo((function() {
                        var e;
                        return null != (null == Z || null === (e = Z[0]) || void 0 === e ? void 0 : e.premiumGuildSubscription)
                    }), [Z]),
                    q = function() {
                        b(O === de.SUCCESS);
                    ...
                    W = (ue(v = {}, de.UNUSED_QUANTITY_SELECT, {
                            body: function() {
                                l()(!(null == i && 0 === _.length), "Cannot provide no slots if there are no other available slots");
                                return (0, r.jsxs)("div", {
                                    className: le().quantitySelectorBody,
                                    children: [(0, r.jsx)(a.Heading, {
                                        variant: "heading-md/semibold",
                                        className: le().quantitySelectorHeader,
                                        children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_UNUSED_SLOTS_HEADER
                                    }), (0, r.jsx)(a.Text, {
                                        variant: "text-md/normal",
                                        className: le().quantitySelectorDescription,
                                        children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_UNUSED_SLOTS_DESCRIPTION
                                    }), (0, r.jsxs)("div", {
                                        className: le().quantitySelectorWrapper,
                                        children: [(0, r.jsx)(p.Z, {
                                            value: Z.length,
                                            onChange: function(e) {
                                                return F(_.slice(0, e))
                                            },
                                            minValue: 1,
                                            maxValue: _.length
                                        }), (0, r.jsx)(a.Text, {
                                            ...
                                            variant: "text-md/normal",
                                            children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_UNUSED_SLOTS_COUNTER
                                        })]
                                    })]
                                })
                            },
                            footer: function() {
                                return (0, r.jsxs)(a.ModalFooter, {
                                    children: [(0, r.jsx)(a.Button, {
                                        ...
                                        children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_UNUSED_SLOTS_NEXT
                                    }), (0, r.jsx)(a.Button, {
                                        look: a.Button.Looks.LINK,
                                        color: a.Button.Colors.PRIMARY,
                                        onClick: q,
                                        children: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_UNUSED_SLOTS_CANCEL
                                    })]
                                })
                            }
                            ...
                            body: function() {
                                ...
                                var e = Z.filter((function(e) {
                                    ...
                                    n = Z.length,
                                    t = k.length;
                                return H ? (0, r.jsx)(ne.TransferBody, {
                                    fromGuilds: k,
                                    toGuild: G,
                                    blurb: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_TRANSFER_BLURB.format({
                                        slotCount: n,
                                        guildCount: t
                                    }),
                                    ...
                                    guild: G,
                                    blurb: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_BLURB,
                                    warning: A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_COOLDOWN_WARNING.format({
                                        days: oe.o3l,
                                        slotCount: n
                                    }),
                            ...
                            footer: function() {
                                var e, n, t = Z.length,
                                    o = g[0] === de.CONFIRM ? q : function() {
                                        return N(g[g.indexOf(O) - 1])
                                    },
                                    i = (n = (e = function() {
                                        return fe(this, (function(e) {
                                            switch (e.label) {
                                                case 0:
                                                    if (null == G || 0 === (null == Z ? void 0 : Z.length)) return [2];
                                                    l()(!Z.some((function(e) {
                                                        return e.isOnCooldown()
                                                ...
                                                case 1:
                                                    e.trys.push([1, 4, , 5]);
                                                    return [4, Promise.all(Z.map((function(e) {
                                                        var n = e.premiumGuildSubscription;
                                                        return null != n ? (0, u.dG)(n.guildId, n.id) : Promise.resolve()
                                                    })))];
                                                case 2:
                                                    e.sent();
                                                    return [4, (0, u.W3)(G.id, Z.map((function(e) {
                                                        return e.id
                                                    })))];
                                                case 3:
                                                    e.sent();
                                ...
                                return (0, r.jsx)(ne.Footer, {
                                    confirmation: H ? A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_TRANSFER_CONFIRM_CONFIRMATION.format({
                                        slotCount: t
                                    }) : A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_CONFIRMATION.format({
                                        slotCount: t
                                    }),
                                    confirmationLabel: H ? A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_TRANSFER_CONFIRM_CONFIRMATION_LABEL.format({
                                        slotCount: t
                                    }) : A.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_CONFIRM_CONFIRMATION_LABEL.format({
                                        slotCount: t
                                    }),
                                    onConfirm: i,
                                    onCancel: o,
                ...
                return (0, r.jsxs)(a.ModalRoot, {
                    ...
                    children: [null === (n = z.header) || void 0 === n ? void 0 : n.call(z), (0, r.jsx)(a.ModalContent, {
                        className: z.bodyClass,
                        children: (0, r.jsx)(a.Sequencer, {
                            step: O,
                            steps: g,
                            children: z.body()
                        })
                    }), null === (t = z.footer) || void 0 === t ? void 0 : t.call(z), (0, r.jsx)(a.ModalCloseButton, {
        ...
        138657: (e, n, t) => {
            t.r(n);
            t.d(n, {
                GuildSelectModalHeader: () => I,
                GuildSelectModalBody: () => E,
                default: () => M
            });
            var r = t(785893),
                o = t(667294),
            ...
            function I(e) {
                ...
                return (0, r.jsxs)(a.ModalHeader, {
                    ...
                    children: [(0, r.jsx)(a.Heading, {
                        ...
                        variant: "heading-md/semibold",
                        children: t ? y.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_SELECT_GUILD_TRANSFER_HEADER : y.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_SELECT_GUILD_HEADER
                    }), (0, r.jsx)(C.Z, {
                        size: C.Z.Sizes.MEDIUM,
                        placeholder: y.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_SEARCH_GUILD_PLACEHOLDER,
                        "aria-label": y.Z.Messages.PREMIUM_GUILD_SUBSCRIBE_SEARCH_GUILD_PLACEHOLDER,
            ...
            function E(e) {
                var n = function() {
                    ...
                    b = e.onSelectGuild,
                    v = e.query,
                    g = (0, s.e7)([p.Z], (function() {
                        return p.Z.getFlattenedGuildIds()
                    })),
                    I = (0, s.Wu)([f.Z], (function() {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [0 === I.length && (0, r.jsx)("div", {
                        className: _().emptyStateWrapper,
                        children: (0, r.jsx)(a.Text, {
                            variant: "text-md/normal",
                            children: 0 === g.length ? y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_APPLY_NON_GUILD_MEMBER.format({
                            ...
                            }) : y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_APPLY_GUILD_NOT_FOUND
                        })
                    }), I.map((function(e) {
                        return (0, r.jsxs)(a.Clickable, {
                            ...
                            children: [(0, r.jsx)(m.Z, {
                                ...
                                children: o ? y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION_TRANSFER_HERE : y.Z.Messages.PREMIUM_GUILD_SUBSCRIPTION
                            })]
                        }, e.id)
                    }))]
                })

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [96799, 50865, 84832, 57678, 58621, 96043, 71402, 1459, 56645], {
        737264: e => {
            "use strict";
        ...
        380477: (e, t, n) => {
            ...
            function g(e, t) {
                var n = function(n) {
                    ...
                    b = (0, s.U)(g),
                    O = (0, d.ZP)(e, !0),
                    I = h.Z.Messages.MUTE_CHANNEL_GENERIC,
                    y = h.Z.Messages.UNMUTE_CHANNEL_GENERIC;
                switch (e.type) {
                    case p.d4z.GUILD_CATEGORY:
                        I = h.Z.Messages.MUTE_CATEGORY;
                        y = h.Z.Messages.UNMUTE_CATEGORY;
                        break;
                    case p.d4z.GROUP_DM:
                        I = h.Z.Messages.MUTE_CONVERSATION;
                        y = h.Z.Messages.UNMUTE_CONVERSATION;
                        break;
                    case p.d4z.DM:
                        I = h.Z.Messages.MUTE_CHANNEL.format({
                            name: O
                        });
                        y = h.Z.Messages.UNMUTE_CHANNEL.format({
                            name: O
                        });
                        break;
                    default:
        ...
        165586: (e, t, n) => {
            ...
            var E = [h(r.RESOLUTION_720), h(r.RESOLUTION_1080), h(r.RESOLUTION_1440), h(r.RESOLUTION_SOURCE, (function() {
                ...
                b = [h(i.FPS_15), h(i.FPS_30), h(i.FPS_60)],
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != P[e] && null != P[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in P[e][t]) t === D ? d.ZP.isNewForumThread(u, t, r) && U[e][t]++ : o.default.compare(u, i) > 0 && !d.ZP.hasOpenedThread(u) && U[e][t]++
                        }
                    }
                }
            }
        ...
        550865: (e, t, n) => {
            ...
            var M = n(982348),
                ...
                j = n(394212),
                x = n(2590);
            const k = (0, u.Z)((0, a.Z)((function(e) {
                var t = e.user,
                    n = e.channel,
                    a = e.channelSelected,
                    u = void 0 !== a && a,
                    ...
                    pe = (0, E.Z)({
                        id: n.id,
                        label: I.Z.Messages.COPY_ID_CHANNEL
                    }),
                    _e = (0, _.Z)(n),
                    he = (0, d.Z)(t.id),
                    Ee = (0, f.Z)(n.id),
                    ...
                    Ie = function(e) {
                        ...
                        return !0 !== (null == t ? void 0 : t.isStaff()) ? null : (0, r.jsxs)(r.Fragment, {
                            children: [!e.isMessageRequest && (0, r.jsx)(i.MenuItem, {
                                ...
                                label: I.Z.Messages.MESSAGE_REQUESTS_CONTEXT_MENU_MOVE_TO,
                                action: function() {
                                    return (0, b.Xy)(e.id)
                                }
                            }), (0, r.jsx)(i.MenuItem, {
                                id: "clear-message-request",
                                label: I.Z.Messages.MESSAGE_REQUESTS_CONTEXT_MENU_CLEAR,
                                action: function() {
                                    return (0, b.qR)(e.id)
                                }
                            })]
                ...
                return (0, r.jsxs)(i.Menu, {
                    ...
                    children: [(0, r.jsx)(i.MenuGroup, {
                        ...
                        children: [!Se && (0, r.jsxs)(r.Fragment, {
                            children: [Y && J, X, !ye && ae, Y && $, Y && ee, te]
                        }), ne]
                        ...
                        children: [(0, r.jsx)(i.MenuGroup, {
                            ...
                            children: [F && le, F && ce, ge, Y && re, ue, Y && se, F && me]
                        }), (0, r.jsx)(i.MenuGroup, {
                            children: x && fe
            ...
            const I = function(e) {
                var t = e.commandType,
                    ...
                    D = i.useMemo((function() {
                        return (0, f.nT)(o, t, M.length, null == S ? void 0 : S.applicationCommandCounts)
                    }), [o, t, null == S ? void 0 : S.applicationCommandCounts, M.length]);
        ...
        598955: (e, t, n) => {
            ...
            function b(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : E.Yn.DEFAULT,
                    ...
                    I = b.deafened,
                    y = void 0 !== I && I,
                    S = b.localVideoDisabled,
                    T = void 0 !== S && S,
                    A = b.localVideoAutoDisabled,
                    N = void 0 !== A && A,
        ...
        52317: (e, t, n) => {
            ...
            function A() {
                y = E({}, l.Z.getCollapsedCategories())
            }
            ...
            function M() {
                ...
                for (var n in t) t[n] !== y[n] && (e[n] = !0);
                for (var r in y) t[r] !== y[r] && (e[r] = !0);
                return e
            }
            ...
            const w = new(function(e) {
                ...
                n.prototype.__getLocalVars = function() {
                    return {
                        lastSavedCollapsedCategories: y,
                        logger: S,
                        syncTimer: T,
                        SYNC_DELAY_MS: 15e3
                    }
                    ...
                    try {
                        for (var s, f = t[Symbol.iterator](); !(u = (s = f.next()).done); u = !0) {
                            var d = s.value,
                                ...
                                h = void 0;
                            try {
                                for (var E, m = d.channel_overrides[Symbol.iterator](); !(p = (E = m.next()).done); p = !0) {
                                    var g = E.value;
        ...
        877475: (e, t, n) => {
            ...
            function y(e) {
                ...
                t[c.sH].forEach(r);
                t[c.Zb].forEach(r);
                (0, o.Z)(n._categories, n).forEach(I);
                g[e] = n;
                return n
            }
            ...
            const L = new P(i.Z, {
                ...
                VOICE_CHANNEL_SELECT: function(e) {
                    var t = e.channelId;
                    return null == t && null != b ? R(l.Z.getChannel(b), null) : R(l.Z.getChannel(t), t)
                },
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                ...
                M = null !== (n = e.section) && void 0 !== n ? n : b;
                null != e.subsection && null != b && (O[b] = e.subsection);
                null != e.scrollPosition && null != b && (I[b] = e.scrollPosition);
            ...
            const j = new G(a.Z, {
                ...
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete I[t] : null != b && delete I[b]
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    R = e.tab;
                    return null == b && R === l.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, h, E, v, m = encodeURIComponent(l.toString()),
                    g = encodeURIComponent(u()),
                    b = (h = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), E = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(h)),
                    ...
                    y = "".concat(f, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(g, "&efr=").concat(b);
                null != O && (y += "&afl=".concat(O));
        ...
        717621: (e, t, n) => {
            ...
            ! function(i) {
                ...
                d.prototype = {
                    ...
                    toHex8: function(e) {
                        return function(e, t, n, r, i) {
                            var o = [Z(l(e).toString(16)), Z(l(t).toString(16)), Z(l(n).toString(16)), Z(j(r))];
                ...
                function E(e, t, n, r) {
                    return [Z(j(r)), Z(l(e).toString(16)), Z(l(t).toString(16)), Z(l(n).toString(16))].join("")
                }
                ...
                var k, F, H, B = (F = "[\\s|\\(]+(" + (k = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + k + ")[,|\\s]+(" + k + ")\\s*\\)?", H = "[\\s|\\(]+(" + k + ")[,|\\s]+(" + k + ")[,|\\s]+(" + k + ")[,|\\s]+(" + k + ")\\s*\\)?", {
...
//# sourceMappingURL=8bbe1718bb1c40f4f3b9.js.map
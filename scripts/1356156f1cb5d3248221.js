        ...
        412448: (e, t, n) => {
            ...
            function Me(e, t, n) {
                ...
                if (i !== L.aib.GUILD || e !== L.dCx.FILTER_FROM && e !== L.dCx.FILTER_MENTIONS) {
                    ...
                    r = null != l ? l(u, n, null != o ? o : je) : []
                } else {
                    var c = Ce[n];
                    if (null == c) r = null;
                    else {
                        null != t && 0 !== t.getFullMatch().trim().length || (c.results = Ee.ZP.getRecentlyTalked(n, je).map((function(e) {
                            var t = e.record;
                            return {
                                user: t,
            ...
            var Ge = function(e) {
                ...
                r.getState = function(e) {
                    var t;
                    return null !== (t = Re[e]) && void 0 !== t ? t : we({
                        searchId: e
                    })
                };
                return n
            ...
            var Be = new Ge(de.Z, {
                ...
                SEARCH_CLEAR_HISTORY: function(e) {
                    var t = e.searchId;
                    null != t ? Fe(t) : Object.keys(Re).forEach(Fe)
                },
                LOGOUT: function() {
                    ...
                    function e() {
                        ...
                        this._handleNativeUpdateNotAvailable = function() {
                            ...
                            Pn.ZP.get({
                                ...
                                if (null == e.body || "010e978d6f2d14bb1fb6bac2a7bdaa201be7c7af" === e.body.hash) return n._handleUpdateNotAvailable();
        ...
        292376: (e, t, n) => {
            ...
            function Ln(e) {
                ...
                return (0, r.jsxs)(gn.h4, {
                    className: m()(jn().header, jn().expanded),
                    children: [(0, r.jsxs)("div", {
                        className: m()(jn().expandedInboxHeader),
                        children: [(0, r.jsx)(E, {
                            className: jn().inboxIcon
                        }), (0, r.jsx)(k.Text, {
                            className: jn().inboxTitle,
                        ...
                        className: m()(jn().expandedTabSection),
                        children: [(0, r.jsxs)(k.TabBar, {
                            ...
                            children: [(0, r.jsxs)(k.TabBar.Item, {
                                ...
                                className: m()(jn().tab, jn().expanded, wn({}, jn().active, t === Z.X.FOR_YOU)),
                                children: [Ge.Z.Messages.FOR_YOU, (null == i ? void 0 : i.badgeForYou) ? (0, r.jsx)(Sn.fW, {
                                    color: mn.Z.STATUS_DANGER,
                                    className: m()(jn().iconBadge)
                                }) : null]
                            }), (0, r.jsx)(k.TabBar.Item, {
                                id: Z.X.UNREADS,
                                className: m()(jn().tab, jn().expanded, wn({}, jn().active, t === Z.X.UNREADS)),
                                children: Ge.Z.Messages.UNREADS_TAB_LABEL
                            }), (0, r.jsx)(k.TabBar.Item, {
                                "aria-label": Ge.Z.Messages.MENTIONS,
                                id: Z.X.MENTIONS,
                                className: m()(jn().tab, jn().expanded, wn({}, jn().active, t === Z.X.MENTIONS)),
                                children: Ge.Z.Messages.MENTIONS
                            }), l ? (0, r.jsxs)(k.TabBar.Item, {
                                "aria-label": "todos",
                                id: Z.X.TODOS,
                                className: m()(jn().tab, jn().expanded, wn({}, jn().active, t === Z.X.TODOS)),
                ...
                return (0, r.jsxs)(gn.h4, {
                    ...
                    children: [(0, r.jsxs)(k.TabBar, {
                        ...
                        children: [l ? (0, r.jsx)(k.TabBar.Item, {
                            id: Z.X.FOR_YOU,
                            className: m()(jn().tab, wn({}, jn().active, t === Z.X.FOR_YOU)),
                            children: Ge.Z.Messages.FOR_YOU
                        }) : null, (0, r.jsx)(k.TabBar.Item, {
                            id: Z.X.MENTIONS,
                            className: m()(jn().tab, wn({}, jn().active, t === Z.X.MENTIONS)),
                            children: Ge.Z.Messages.MENTIONS
                        }), (0, r.jsx)(k.TabBar.Item, {
                            id: Z.X.UNREADS,
                            className: m()(jn().tab, wn({}, jn().active, t === Z.X.UNREADS)),
                            children: Ge.Z.Messages.UNREADS_TAB_LABEL
                        }), i ? (0, r.jsx)(k.TabBar.Item, {
                            id: Z.X.TODOS,
                            className: m()(jn().tab, wn({}, jn().active, t === Z.X.TODOS)),
                                            ...
                                            return jr(this, (function(o) {
                                                switch (o.label) {
                                                    ...
                                                    case 1:
                                                        e = o.sent(), t = e.default;
                                                        return [2, function(e) {
                                                            return (0, r.jsx)(t, Rr(function(e) {
                                                                for (var t = 1; t < arguments.length; t++) {
                                                                    var n = null != arguments[t] ? arguments[t] : {},
                                                                        r = Object.keys(n);
                                                                    "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
            ...
            function wi(e) {
                ...
                if (x) return (0, r.jsx)(wi, ji(Ci({}, e), {
                    message: g.message,
                    channel: S,
                    hasThread: !1
                }));
                ...
                return void 0 !== a ? (0, r.jsx)(Mi, {
                    ...
                    compact: f,
                    className: m()(d, (l = {}, Ri(l, Ai().ephemeral, (0, pi.yE)(c.flags, te.iLy.EPHEMERAL)), Ri(l, Ai().disableInteraction, b), Ri(l, Ai().groupStart, e.isGroupStart), l)),
                    childrenRepliedMessage: (0, Ii.Z)(c, u, v, g, f),
                    childrenHeader: (0, mi.Z)(ji(Ci({}, e), {
                        author: M,
                        guildId: u.guild_id
                    })),
        ...
        46268: (e, t, n) => {
                    ...
                    for (var o, i = te().values(Ee)[Symbol.iterator](); !(t = (o = i.next()).done); t = !0) {
                        ...
                        if (!ve.includes(l)) {
                            ...
                            if (null != c) {
                                var s = ue.Z.get(l);
                                if (null != s)
                                    if (le.Z.applicationIdsFetching.has(c.id) || le.Z.isEntitledToSku(j.default.getCurrentUser(), l, c.id, c.id) || !s.available) {
                                        if (null != Oe[l]) {
                                            delete Oe[l];
                                            e = !0
                                        }
            ...
            var Ot, Et, vt = [ce.kVF.QUARANTINED, ce.kVF.AUTOMOD_QUARANTINED_USER_PROFILE, ce.kVF.VIEWING_ROLES, ce.kVF.INVITED_TO_SPEAK, ce.kVF.LURKING_GUILD, ce.kVF.VOICE_DISABLED, ce.kVF.NO_INPUT_DETECTED, ce.kVF.HARDWARE_MUTE, ce.kVF.H264_DISABLED, ce.kVF.DISPATCH_ERROR, ce.kVF.DISPATCH_INSTALL_SCRIPT_PROGRESS, ce.kVF.SPOTIFY_AUTO_PAUSED, ce.kVF.DROPS_PROGRESS_INTERRUPTION, ce.kVF.WIN32_DEPRECATED_MESSAGE, ce.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, ce.kVF.GUILD_RAID_NOTIFICATION, ce.kVF.UNCLAIMED_ACCOUNT, ce.kVF.POMELO_ELIGIBLE, ce.kVF.PENDING_MEMBER, ce.kVF.OUTBOUND_PROMOTION, ce.kVF.CORRUPT_INSTALLATION, ce.kVF.VIDEO_UNSUPPORTED_BROWSER, ce.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK, ce.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, ce.kVF.STREAMER_MODE, ce.kVF.SCHEDULED_MAINTENANCE, ce.kVF.BOUNCED_EMAIL_DETECTED, ce.kVF.UNVERIFIED_ACCOUNT, ce.kVF.PREMIUM_TIER_2_TRIAL_ENDING, ce.kVF.PREMIUM_TIER_0_TRIAL_ENDING, ce.kVF.PREMIUM_UNCANCEL, ce.kVF.PREMIUM_MISSING_PAYMENT, ce.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, ce.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, ce.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, ce.kVF.PREMIUM_REACTIVATE, ce.kVF.ACTIVATE_SERVER_SUBSCRIPTION, ce.kVF.MFA_SMS_BACKUP, ce.kVF.APPLICATION_TEST_MODE, ce.kVF.LOCALIZED_PRICING, ce.kVF.DOWNLOAD_NAG, ce.kVF.CONNECT_SPOTIFY, ce.kVF.CONNECT_PLAYSTATION, ce.kVF.SURVEY, ce.kVF.SERVER_USAGE_SURVEY, ce.kVF.SAFETY_USER_SENTIMENT_NAGBAR, ce.kVF.DROPS_GO_LIVE_BANNER, ce.kVF.DROPS_ENDED_INCOMPLETE, ce.kVF.GUILD_ONBOARDING_UPSELL_NAGBAR],
                ...
                mt = (Je(Et = {}, ce.kVF.GUILD_RAID_NOTIFICATION, {
                        ...
                        predicate: function() {
                            return null != Re.Z.getRemoteDisconnectVoiceChannelId()
                        }
                        ...
                        predicate: function() {
                            return Re.Z.isConnected() && Pe.Z.isHardwareMute()
                        },
                        metadata: function() {
                    ...
                    Je(Et, ce.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, {
                        ...
                        predicate: function() {
                            return (0, R.e)() && !bt(ce.kVF.POMELO_ELIGIBLE)
                        }
            ...
            var It = function(e) {
                ...
                var r = n.prototype;
                r.initialize = function() {
                    this.syncWith([Me.Z, Ae.Z, Se, je.Z, H.Z, Ue.Z, q.Z, $.Z, K.Z, S.Z], St);
                    this.waitFor(j.default, we.Z, Ie.Z, _e.ZP, Re.Z, Pe.Z, De.Z, O.Z, je.Z, Le.Z, z.Z, ae.ZP, Ae.Z, Ve.Z, He.Z, Ge.Z, Te.Z, Fe.Z, Ye.Z, Se, ke.Z, Ne.Z, H.Z, le.Z, Ue.Z, $.Z, A.Z, y.Z, p.Z)
                };

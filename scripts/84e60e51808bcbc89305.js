/*! For license information please see 84e60e51808bcbc89305.js.LICENSE.txt */
                ...
                return (() => {
                    var e = {
                            ...
                            525: (e, t, i) => {
                                ...
                                function o() {
                                    return "undefined" != typeof Reflect && Reflect.get ? (e.exports = o = Reflect.get, e.exports.__esModule = !0,
                                        e.exports.default = e.exports) : (e.exports = o = function(e, t, i) {
                                        var o = r(e, t);
                                        if (o) {
                                    ...
                                    ! function() {
                                        ...
                                        function n(e, t, i) {
                                            ...
                                            if (this._context = o, this.output = i.output || o.destination, this.rate = o.sampleRate, this.channels = 2, i.bufferSize && (this.bufferSize = 0 | i.bufferSize), this.bufferThreshold = 2 * this.bufferSize, this._bufferQueue = new r(this.channels, this.bufferSize), this._playbackTimeAtBufferTail = o.currentTime, this._queuedTime = 0, this._delayedTime = 0, this._dropped = 0, this._liveBuffer = this._bufferQueue.createBuffer(this.bufferSize), o.createScriptProcessor) this._node = o.createScriptProcessor(this.bufferSize, 0, this.channels);
                                                ...
                                                if (!o.createJavaScriptNode) throw new Error("Bad version of web audio API?");
                                        ...
                                        n.prototype.bufferSize = 4096, n.prototype.bufferThreshold = 8192, n.prototype._volume = 1, Object.defineProperty(n.prototype, "volume", {
                                            ...
                                            Object.defineProperty(n.prototype, "muted", {
                                                ...
                                                var s = this._playbackTimeAtBufferTail;
                                                if (s < a && (this._delayedTime += a - s), this._bufferQueue.sampleCount() < this.bufferSize && this.onstarved && this.onstarved(), this._bufferQueue.sampleCount() < this.bufferSize) {
                                                    ...
                                                    this._queuedTime += this.bufferSize / this.rate, this._playbackTimeAtBufferTail = a + this.bufferSize / this.rate,
                                                        this._bufferQueue.sampleCount() < Math.max(this.bufferSize, this.bufferThreshold) && this.onbufferlow && o(this.onbufferlow.bind(this))
                                                }
                                                ...
                                                if (!n.sharedAudioContext && n.isSupported()) {
                                                    ...
                                                    if (i.createScriptProcessor) e = i.createScriptProcessor(1024, 0, 2);
                                                        ...
                                                        if (!i.createJavaScriptNode) throw new Error("Bad version of web audio API?");
                                        ...
                                        return function(e) {
                                            ...
                                            r = i(0), o = i(2), e.exports = function(e) {
                                                ...
                                                var m = 1 + (s >> 1),
                                                    ...
                                                    P = [],
                                                    x = [];
                                                for (p = 0; p < 2; p++) w.push(r.float_array(A)), E.push(r.float_array(A)), P.push(r.float_array(A)), x.push(r.float_array(m));
                                                ...
                                                var W = function(e, t, i) {
                                                    ...
                                                    N = function(e, t, i, r, o) {
                                                        var n = 2 * Math.PI / s * .5 * (r + t) * f;
                                                        return (function(e) {
                                                            return e - 2 * Math.PI * Math.round(e / (2 * Math.PI))
                                                        }(e - i - n) + n) * o
                                                    },
                                                    X = function(e, t, i, r, o, n) {
                                                        for (var u = e % 2, d = 1 - u, c = x[d], h = k[d], f = w[d], l = E[d], _ = P[d], p = x[u], m = 1; m < p.length; m++) p[m] = t[m] * t[m] + i[m] * i[m];
                                                        var V = w[u],
                                                            v = k[u] = function(e, t) {
                                                ...
                                                return G.process = function(e) {
                                                    ...
                                                    var V = L + i - (s - f),
                                                        v = 2 * Math.floor(Math.max(0, V) / (2 * f)),
                                                        g = U + l * v + Math.floor(I + j * v);
                                                    U > g && (g = U);
                                                    var y = r.float_array(g);
                                                    r.blit(h, 0, y, 0, U);
                                                    for (var b = 0, T = U, A = 0, k = 0;;) {
                                                        var w = s + f - L;
                                                        if (b + w > i) {
                                                            r.blit(o, b, c, L, i - b), L += i - b, b = i;
                                                            break
                                                        }
                                                        w <= 0 ? L -= 2 * f : (r.blit(o, b, c, L, w), b += w, L = s - f), k = H(), O += 2 * f / t, S += k / t, (A = T + k - g) < 0 && (A = 0), r.blit(h, 0, y, T, k - A), T += k
                                                    }
                                                    r.blit(h, k - A, h, 0, A), U = A;
                                                    var E = [];
                                            ...
                                            e.exports = function(e) {
                                                ...
                                                i.inplace = function(e) {
                                                    ...
                                                    for (var w, E, P = i.m_revTgt, x = 0; x < o; x++) P[x] > x && (E = t[w = P[x]], t[w] = t[x], t[x] = E, E = r[w], r[w] = r[x], r[x] = E)
                                                };
                                                var h = t >> 1;
                            ...
                            408: (e, t, i) => {
                                ...
                                var o = r(i(575)),
                                    ...
                                    d = function(e) {
                                        ...
                                        function i() {
                                            return (0, o.default)(this, i), t.apply(this, arguments)
                                        }
                            ...
                            964: (e, t, i) => {
                                ...
                                var o = r(i(575)),
                                    ...
                                    p = new(function(e) {
                                        ...
                                        function i() {
                                            var e;
                                            return (0, o.default)(this, i), (e = t.call(this)).scriptStatus = {}, e.scriptCallbacks = {}, e
                                        }
                                        return (0, n.default)(i, [{
                                            key: "getGlobal",
                                            value: function() {
                                            ...
                                            value: function(e, t, r) {
                                                (r = r || {}).worker ? this.workerProxy(e, t) : (0, a.default)((0, d.default)(i.prototype), "loadClass", this).call(this, e, t, r)
                                            }
                                        }, {
                                            key: "loadScript",
                                            value: function(e, t) {
                                            ...
                                            value: function(e, t) {
                                                var i = l[_[e]];
                                                if (!i) throw new Error("Requested worker for class with no proxy: " + e);
                                                var r, o = i.proxy,
                                                    n = i.worker,
                            ...
                            869: (e, t, i) => {
                                ...
                                o = "undefined" == typeof performance || void 0 === (0,
                                    h.default)(performance.now) ? Date.now : performance.now.bind(performance), j.prototype = Object.create(HTMLElement.prototype, {});
                                var L = function(e) {
                                    (0, u.default)(i, e);
                                    var t = function(e) {
                                        var t = function() {
                                    ...
                                    function i(e) {
                                        ...
                                        return r._enableThreading = !!e.threading, r._enableSIMD = !!e.simd,
                                            ...
                                            r._videoInfo = null, r._audioInfo = null, r._width = 0, r._height = 0, r._volume = 1, r._playbackRate = 1, Object.defineProperties((0, s.default)(r), {
                                                ...
                                                seekable: {
                                                    get: function() {
                                                        return this.duration < 1 / 0 && this._stream && this._stream.seekable && this._codec && this._codec.seekable ? new y.default([
                                                            [0, this._duration]
                                                        ]) : new y.default([])
                                                    }
                                                },
                                                ...
                                                poster: {
                                                    ...
                                                    set: function(e) {
                                                        ...
                                                        if (this._poster = e, !this._started) {
                                                            ...
                                                            var r = new Image;
                                                            r.crossOrigin = this.crossOrigin, r.src = this._poster, r.className = "ogvjs-poster", r.style.position = "absolute", r.style.top = "0", r.style.left = "0", r.style.width = "100%", r.style.height = "100%", r.style.objectFit = "contain", r.style.visibility = "hidden",
                                                                r.addEventListener("load", (function() {
                                                                    t._thumbnail === r && (i.styleManager.appendRule("." + t._instanceId, {
                                                ...
                                                readyState: {
                                                    get: function() {
                                                        return this._stream && this._codec && this._codec.loadedMetadata ? i.HAVE_ENOUGH_DATA : i.HAVE_NOTHING
                                                    }
                                                },
                                                networkState: {
                                                    get: function() {
                                                        return this._stream ? this._stream.waiting ? i.NETWORK_LOADING : i.NETWORK_IDLE : this.readyState == i.HAVE_NOTHING ? i.NETWORK_EMPTY : i.NETWORK_NO_SOURCE
                                                    }
                                                },
                                                playbackRate: {
                                                    get: function() {
                                            ...
                                            }), r.onframecallback = null, r.onloadstate = null, r.onprogress = null, r.onsuspend = null, r.onabort = null, r.onemptied = null, r.onstalled = null, r.onloadedmetadata = null, r.onloadeddata = null, r.oncanplay = null, r.oncanplaythrough = null, r.onplaying = null, r.onwaiting = null, r.onseeking = null, r.onseeked = null, r.onended = null,
                                            r.ondurationchange = null, r.ontimeupdate = null, r.onplay = null, r.onpause = null, r.onratechange = null, r.onresize = null, r.onvolumechange = null, r.onaudiofeedercreated = null, r
                                    }
                                    return (0, a.default)(i, [{
                                        ...
                                        value: function() {
                                            ...
                                            this._codec && (a.demuxerTime = this._codec.demuxerCpuTime - this._lastFrameDemuxerCpuTime, a.videoTime += this._currentVideoCpuTime - this._lastFrameVideoCpuTime, a.audioTime += this._codec.audioCpuTime - this._lastFrameAudioCpuTime), a.cpuTime += a.demuxerTime, this._lastFrameDecodeTime = 0, this._lastFrameTimestamp = i, this._codec ? (this._lastFrameVideoCpuTime = this._currentVideoCpuTime,
                                                this._lastFrameAudioCpuTime = this._codec.audioCpuTime, this._lastFrameDemuxerCpuTime = this._codec.demuxerCpuTime) : (this._lastFrameVideoCpuTime = 0, this._lastFrameAudioCpuTime = 0, this._lastFrameDemuxerCpuTime = 0), this._lastFrameDrawingTime = this._drawingTime, this._lastFrameBufferTime = this._bufferTime, this._lastFrameProxyTime = this._proxyTime, this._log("drew frame " + t.frameEndTimestamp + ": clock time " + s(r) + " (jitter " + s(n) + ") cpu: " + s(a.cpuTime) + " (mux: " + s(a.demuxerTime) + " buf: " + s(a.bufferTime) + " draw: " + s(a.drawingTime) + " proxy: " + s(a.proxyTime) + ") vid: " + s(a.videoTime) + " aud: " + s(a.audioTime)), this._fireEventAsync("framecallback", a), (!this._lastTimeUpdate || i - this._lastTimeUpdate >= this._timeUpdateInterval) && (this._lastTimeUpdate = i, this._fireEventAsync("timeupdate")), this._codec && t.yCbCrBuffer && this._codec.recycleFrame(t.yCbCrBuffer)
                                        }
                                    }, {
                                        key: "_seekStream",
                                        value: function(e) {
                                            var t = this;
                                            this._stream.seeking && this._stream.abort(), this._stream.buffering && this._stream.abort(), this._streamEnded = !1,
                                                this._dataEnded = !1, this._ended = !1, this._stream.seek(e).then((function() {
                                                    t._readBytesAndWait()
                                                })).catch((function(e) {
                                                    t._onStreamError(e)
                                                }))
                                        ...
                                        value: function(e, t) {
                                            ...
                                            if (this._stream && !this._stream.seekable) throw new Error("Cannot seek a non-seekable stream");
                                            if (this._codec && !this._codec.seekable) throw new Error("Cannot seek in a non-seekable file");
                                            var r = function(r) {
                                                i._stream && i._stream.buffering && i._stream.abort(), i._stream && i._stream.seeking && i._stream.abort(), i._actionQueue.splice(0, i._actionQueue.length), i._stopPlayback(), i._prebufferingAudio = !1,
                                                    i._audioFeeder && i._audioFeeder.flush(), i._state = O, i._seekTargetTime = e, i._seekMode = t, i._codec ? i._codec.flush(r) : r()
                                            };
                                            r((function() {
                                        ...
                                        value: function() {
                                            ...
                                            if (this._codec.hasVideo) t = this._codec.frameTimestamp, e = this._targetPerFrameTime / 1e3;
                                                ...
                                                if (!this._codec.hasAudio) throw new Error("Invalid seek state; no audio or video track available");
                                                t = this._codec.audioTimestamp, e = 1 / 256
                                            }
                                            t < 0 ? this._codec.process((function(e) {
                                                if (e) i._pingProcessing();
                                                else if (i._streamEnded) {
                                                    if (i._log("stream ended during bisection seek"), !i._seekBisector.right()) throw i._log("failed going back"), new Error("not sure what to do")
                                        ...
                                        key: "_setupVideo",
                                        value: function() {
                                            this._videoInfo.fps > 0 ? this._targetPerFrameTime = 1e3 / this._videoInfo.fps : this._targetPerFrameTime = 16.667, this._canvas.width = this._videoInfo.displayWidth,
                                                this._canvas.height = this._videoInfo.displayHeight, i.styleManager.appendRule("." + this._instanceId, {
                                        ...
                                        key: "_doProcessing",
                                        value: function() {
                                            if (this._didSeek && (this._didSeek = !1), this._nextProcessingTimer = null, this._isProcessing(), this._depth > 0) throw new Error("REENTRANCY FAIL: doProcessing recursing unexpectedly");
                                            var e = 0;
                                            do {
                                                if (this._needProcessing = !1, this._depth++, this._doProcessingLoop(), this._depth--, this._needProcessing && this._isProcessing()) throw new Error("REENTRANCY FAIL: waiting on input or codec but asked to keep processing");
                                        ...
                                        value: function() {
                                            if (this._actionQueue.length) this._actionQueue.shift()();
                                            else if (this._state == w) this._doProcessInitial();
                                            else if (this._state == E) this._doProcessSeekingEnd();
                                            else if (this._state == P) this._doProcessLoaded();
                                                ...
                                                if (this._state != S) throw new Error("Unexpected OGVPlayer state " + this._state);
                                        ...
                                        value: function() {
                                            ...
                                            if (this._codec.loadedMetadata) {
                                                if (!this._codec.hasVideo && !this._codec.hasAudio) throw new Error("No audio or video found, something is wrong");
                                                this._codec.hasAudio && (this._audioInfo = this._codec.audioFormat), this._codec.hasVideo && (this._videoInfo = this._codec.videoFormat, this._setupVideo()), isNaN(this._codec.duration) || (this._duration = this._codec.duration), null === this._duration && this._stream.seekable && "video/ogg" == this._detectedType ? (this._state = E,
                                                    this._lastSeenTimestamp = -1, this._codec.flush((function() {
                                                        e._seekStream(Math.max(0, e._stream.length - 131072))
                                                    }))) : (this._state = P, this._pingProcessing())
                                            } else this._codec.process((function(t) {
                                                if (t) e._pingProcessing();
                                                else {
                                                    if (e._streamEnded) throw new Error("end of file before headers found");
                                        ...
                                        value: function() {
                                            ...
                                            this._codec.frameReady ? (this._log("saw frame with " + this._codec.frameTimestamp), this._lastSeenTimestamp = Math.max(this._lastSeenTimestamp, this._codec.frameTimestamp), this._codec.discardFrame((function() {
                                                ...
                                                t ? e._pingProcessing() : e._stream.eof ? (e._log("seek-duration: we are at the end: " + e._lastSeenTimestamp), e._lastSeenTimestamp > 0 && (e._duration = e._lastSeenTimestamp), e._state = P, e._codec.flush((function() {
                                        ...
                                        value: function() {
                                            if (this._seekState == C) throw new Error("seeking in invalid state (not seeking?)");
                                            if (this._seekState == D) this._doProcessBisectionSeek();
                                            else if (this._seekState == M) this._doProcessBisectionSeek();
                                            else {
                                                if (this._seekState != B) throw new Error("Invalid seek state " + this._seekState);
                                            ...
                                            if (this._paused) this._log("paused during playback; stopping loop");
                                                    ...
                                                    if (this._prebufferingAudio) o && this._log("decoding a frame during prebuffering"), r = !1;
                                                        ...
                                                        if (l >= 0 && l != this._codec.frameTimestamp && a >= _) {
                                                            ...
                                                            for (var V = 0; V < this._pendingFrames.length; V++) {
                                                                ...
                                                                this._lateFrames++, this._framesProcessed++,
                                                                    this._frameEndTimestamp = v.frameEndTimestamp, u = 1e3 * (v.frameEndTimestamp - a), this._actualPerFrameTime = this._targetPerFrameTime - u, v.dropped = !0, this._doFrameComplete(v)
                                                            }
                                                ...
                                                if (o) {
                                                    ...
                                                    var k = this._codec.audioTimestamp,
                                                        w = this._time((function() {
                                                            e._codec.decodeAudio((function(t) {
                                                                if (e._pendingAudio--, e._log("play loop callback: decoded audio"),
                                                                    e._audioEndTimestamp = k, t) {
                                                    ...
                                                    this._pendingAudio && (this._proxyTime += w, this._codec.audioReady ? this._pingProcessing() : this._doProcessPlayDemux())
                                                } else if (r) {
                                                    ...
                                                    this._currentVideoCpuTime = E.videoCpuTime, this._drawingTime += this._time((function() {
                                                        e._drawFrame(E.yCbCrBuffer)
                                                    })), this._framesProcessed++, this._doFrameComplete(E), this._pingProcessing()
                                                    ...
                                                    if (this._dataEnded && !(this._pendingAudio || this._pendingFrame || this._decodedFrames.length)) {
                                                        ...
                                                        var P = 0;
                                                        this._codec.hasAudio && this._audioFeeder && (P = 1e3 * this._audioFeeder.durationBuffered), P > 0 ? (this._log("play loop: ending pending " + P + " ms"), this._pingProcessing(Math.max(0, P))) : (this._log("play loop: ENDING NOW: playback time " + this._getPlaybackTime() + "; frameEndTimestamp: " + this._frameEndTimestamp), this._stopPlayback(), this._prebufferingAudio = !1, this._initialPlaybackOffset = Math.max(this._audioEndTimestamp, this._frameEndTimestamp), this._ended = !0, this._paused = !0, this._fireEventAsync("pause"), this._fireEventAsync("ended"))
                                                    } else this._prebufferingAudio && (t.hasVideo && !t.frameReady || t.hasAudio && !t.audioReady) ? (this._log("play loop: prebuffering demuxing"),
                                                        this._doProcessPlayDemux()) : this._log("play loop: waiting on async/timers");
                                                else {
                                                    var x = u;
                                        ...
                                        value: function() {
                                            ...
                                            if (this._stream && this._stream.waiting) this._log("waiting on input");
                                                ...
                                                var i = -1 / 256;
                                                t > i ? this._nextProcessingTimer = setTimeout((function() {
                                                    e._pingProcessing()
                                        ...
                                        value: function(e) {
                                            ...
                                            this._stream.read(1024).then((function(i) {
                                                ...
                                                r.length > 4 && r[0] == "O".charCodeAt(0) && r[1] == "g".charCodeAt(0) && r[2] == "g".charCodeAt(0) && r[3] == "S".charCodeAt(0) ? t._detectedType = "video/ogg" : r.length > 4 && 26 == r[0] && 69 == r[1] && 223 == r[2] && 163 == r[3] ? t._detectedType = "video/webm" : t._detectedType = "video/ogg", e(i)
                                            }))
                                        }
                                    }, {
                                        key: "_prepForLoad",
                                        value: function(e) {
                                            var t = this;
                                            this._stopVideo();
                                            this._currentSrc = "", this._loading = !0, this._actionQueue.push((function() {
                                        ...
                                        key: "play",
                                        value: function() {
                                            this._muted || this._options.audioContext || i.initSharedAudioContext(), this._paused && (this._startedPlaybackInDocument = document.body.contains(this), this._paused = !1, this._state == O || (this._started && this._codec && this._codec.loadedMetadata ? (this._ended && this._stream && this._byteLength ? (this._log(".play() starting over after end"), this._seek(0)) : this._log(".play() while already started"), this._state = R,
                                                this._isProcessing() || this._pingProcessing()) : this._loading ? this._log(".play() while loading") : (this._log(".play() before started"), this._stream || this.load())))
                                        }
                                    }, {
                                ...
                                var o = r(i(575)),
                                    ...
                                    a = function() {
                                        ...
                                        return (0, n.default)(e, [{
                                            key: "start",
                                            value: function(e) {
                                                if (e < 0 || e > this.length || e !== (0 | e)) throw new RangeError("Invalid index");
                                ...
                                var u = function() {
                                    ...
                                    return (0, n.default)(e, [{
                                        ...
                                        value: function(e) {
                                            var t, i = this;
                                            this.processing = !0,
                                                t = "video/webm" === this.options.type || "audio/webm" === this.options.type ? "OGVDemuxerWebMW" : "OGVDemuxerOggW", a.default.loadClass(t, (function(t) {
                                                    t().then((function(t) {
                                        ...
                                        value: function(e) {
                                            var t = this;
                                            if (this.processing) throw new Error("reentrancy fail on OGVWrapperCodec.process");
                                            this.processing = !0;
                                            var i = function(i) {
                                                    t.processing = !1, e(i)
                                                },
                                            ...
                                            this.demuxer.loadedMetadata && !this.loadedDemuxerMetadata ? this.loadAudioCodec((function() {
                                                t.loadVideoCodec((function() {
                                                    t.loadedDemuxerMetadata = !0, t.loadedAudioMetadata = !t.audioDecoder,
                                                        t.loadedVideoMetadata = !t.videoDecoder, t.loadedAllMetadata = t.loadedAudioMetadata && t.loadedVideoMetadata, i(!0)
                                                }))
                                            ...
                                            }))) : r() : this.loadedVideoMetadata && !this.loadedMetadata && this.loadedAllMetadata ? (this.loadedMetadata = !0,
                                                i(!0)) : !this.loadedMetadata || this.hasAudio && !this.demuxer.audioReady || this.hasVideo && !this.demuxer.frameReady ? r() : i(!0)
                                        }
                                    }, {
                                        key: "decodeFrame",
                                        value: function(e) {
                                    ...
                                    s = new(function() {
                                        ...
                                        return (0, a.default)(e, [{
                                            ...
                                            value: function() {
                                                if (!this.tested) {
                                                    try {
                                                        "object" === ("undefined" == typeof WebAssembly ? "undefined" : (0, o.default)(WebAssembly)) ? this.testResult = function() {
                            ...
                            431: (e, t, i) => {
                                ...
                                var s = i(828),
                                    ...
                                    d = function(e) {
                                        function t() {
                                            return n(this, t), a(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
                                        }
                                        return function(e, t) {
                                            ...
                                            key: "initXHR",
                                            value: function() {
                                                o(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "initXHR", this).call(this), this.xhr.responseType = u
                                            }
                                        }, {
                                            key: "onXHRProgress",
                                            value: function() {}
                            ...
                            306: (e, t, i) => {
                                ...
                                var n = function(e) {
                                    function t(e) {
                                        ...
                                        return s.url = i, s.offset = r, s.length = o, s.cachever = a, s.loaded = !1, s.seekable = !1, s.headers = {}, s.eof = !1, s.bytesRead = 0, s.xhr = new XMLHttpRequest, s
                                    }
                                    return function(e, t) {
                                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                                        e.prototype = Object.create(t && t.prototype, {
                                                ...
                                                var n = function() {
                                                        if (2 == e.xhr.readyState) {
                                                            if (206 == e.xhr.status) {
                                                                ...
                                                                if (e.offset != n) return console.log("Expected start at " + e.offset + " but got " + n + "; working around Safari range caching bug: https://bugs.webkit.org/show_bug.cgi?id=82672"), e.cachever++, e.emit("cachever"), e.abort(), r(), void e.load().then(t).catch(i);
                                                                e.seekable = !0
                                                            }
                                                            ...
                                                            }(e.xhr), e.headers = function(e) {
                                                                var t = {};
                                                                return e.getAllResponseHeaders().split(/\r?\n/).forEach((function(e) {
                                                                    var i = e.split(/:\s*/, 2);
                                                                    i.length > 1 && (t[i[0].toLowerCase()] = i[1])
                                                                })), t
                                                            }(e.xhr), e.onXHRStart()) : (r(), i(new Error("HTTP error " + e.xhr.status)))
                                                        }
                                                    },
                                                    a = function() {
                                                        r(), i(new Error("network error"))
                                                    },
                                                    s = function() {
                                                        r(), t()
                                                    };
                            ...
                            761: (e, t, i) => {
                                ...
                                e.exports = function(e) {
                                    ...
                                    if (a || (a = r.supported() ? r : o.supported() ? o : null), !a) throw new Error("No supported backend class");
                                    return new a(e)
                                }
                            },
                            855: (e, t, i) => {
                                ...
                                var r = function() {
                                    function e() {
                                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                            ...
                                            u = void 0 === s ? 0 : s,
                                            d = t.end,
                                            c = void 0 === d ? u + (o ? o.byteLength : a ? a.length : 0) : d,
                                            h = t.prev,
                                            f = void 0 === h ? null : h,
                                            l = t.next,
                                            _ = void 0 === l ? null : l,
                                        ...
                                        i(this, e), this.start = u, this.end = c, this.prev = f,
                                            this.next = _, this.eof = m, this.empty = v, this.timestamp = y, this.buffer = o, this.string = a, Object.defineProperty(this, "length", {
                                                get: function() {
                                    ...
                                    return t(e, [{
                                        ...
                                        key: "split",
                                        value: function(t) {
                                            if (!this.empty || !this.contains(t)) throw new Error("invalid split");
                                            var i = new e({
                                                    start: this.start,
                                                    end: t
                                                }),
                                    ...
                                    a = function() {
                                        ...
                                        return r(e, [{
                                            ...
                                            value: function(e) {
                                                ...
                                                if (!t) throw new Error("read seek out of range");
                                            ...
                                            value: function(e) {
                                                ...
                                                if (!t) throw new Error("write seek out of range");
                                            ...
                                            value: function(e) {
                                                var t = this.bufferItem(e),
                                                    i = this.writeCursor;
                                                if (!i.empty) throw new Error("write cursor not empty");
                                                if (!i.contains(t.end) && i.end !== t.end) throw new Error("write cursor too small");
                                            ...
                                            key: "bufferItem",
                                            value: function(e) {
                                                if (e instanceof ArrayBuffer) return new n({
                                                    start: this.writeOffset,
                                                    end: this.writeOffset + e.byteLength,
                                                    buffer: e
                                                });
                                                if ("string" == typeof e) return new n({
                                                    start: this.writeOffset,
                                            ...
                                            value: function(e, t, i, r) {
                                                var o = this;
                                                if (e.start !== i.start) throw new Error("invalid splice head");
                                                if (!(t.end === r.end || t.eof && r.eof)) throw new Error("invalid splice tail");
                                                var n = e.prev,
                                                    a = t.next;
                                ...
                                var o = i(814),
                                    ...
                                    a = function() {
                                        function e(t) {
                                            ...
                                            ! function(e, t) {
                                                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                                            }(this, e), this.length = -1, this.loaded = !1, this.loading = !1, this.seekable = !1, this.buffering = !1, this.seeking = !1, this.progressive = c, Object.defineProperties(this, {
                                                offset: {
                                                    get: function() {
                                            ...
                                            }), this.url = r, this.headers = {}, this._cache = new o({
                                                cacheSize: u
                                        ...
                                        return r(e, [{
                                            ...
                                            value: function() {
                                                var e = this;
                                                return new Promise((function(t, i) {
                                                    if (e.loading) throw new Error("cannot load when loading");
                                                    if (e.loaded) throw new Error("cannot load when loaded");
                                                    e.loading = !0,
                                                        e._openBackend().then((function(i) {
                                            ...
                                            value: function() {
                                                ...
                                                return new Promise((function(t, i) {
                                                    if (e._backend) t(e._backend);
                                                    else if (e.eof) i(new Error("cannot open at end of file"));
                                                    else {
                                                        var r = e._cache,
                                                            o = e._chunkSize,
                                                            a = r.bytesReadable(o),
                                                        ...
                                                        if (0 === u) t(null);
                                                            ...
                                                            var d = e._backend = new n({
                                                                ...
                                                                c = null,
                                                                h = function() {
                                                                    d !== e._backend ? (c(), i(new Error("invalid state"))) : (d.on("buffer", (function(t) {
                                                                ...
                                                                f = function(t) {
                                                                    d !== e._backend ? i(new Error("invalid state")) : (e._backend = null, i(t))
                                                                };
                                                            c = function() {
                                            ...
                                            value: function(e) {
                                                var t = this;
                                                return new Promise((function(i, r) {
                                                    if (!t.loaded || t.buffering || t.seeking) throw new Error("invalid state");
                                                    if (e !== (0 | e) || e < 0) throw new Error("invalid input");
                                                    if (t.length >= 0 && e > t.length) throw new Error("seek past end of file");
                                                    if (!t.seekable) throw new Error("seek on non-seekable stream");
                                            ...
                                            value: function(e) {
                                                var t = this.bytesAvailable(e),
                                                    i = new Uint8Array(t);
                                                if (this.readBytes(i) !== t) throw new Error("failed to read expected data");
                                                return i.buffer
                                            }
                                        }, {
                                            key: "readBytes",
                                            value: function(e) {
                                                if (!this.loaded || this.buffering || this.seeking) throw new Error("invalid state");
                                                if (!(e instanceof Uint8Array)) throw new Error("invalid input");
                                ...
                                ! function() {
                                    ...
                                    function o(e) {
                                        ...
                                        return t.drawFrame = function(t) {
                                            var s = t.format;
                                            e.width === s.displayWidth && e.height === s.displayHeight || (e.width = s.displayWidth, e.height = s.displayHeight), null !== o && o.width == s.width && o.height == s.height || function(e, t) {
                                                for (var r = (o = i.createImageData(e, t)).data, n = e * t * 4, a = 0; a < n; a += 4) r[a + 3] = 255
                                            }(s.width, s.height), r.convertYCbCr(t, o.data);
                                            var u, d = s.cropWidth != s.displayWidth || s.cropHeight != s.displayHeight;
                                            d ? (n || function(e, t) {
                                                (n = document.createElement("canvas")).width = e, n.height = t, a = n.getContext("2d")
                                            }(s.cropWidth, s.cropHeight), u = a) : u = i, u.putImageData(o, -s.cropLeft, -s.cropTop, s.cropLeft, s.cropTop, s.cropWidth, s.cropHeight), d && i.drawImage(n, 0, 0, s.displayWidth, s.displayHeight)
                                        }, t.clear = function() {
                            ...
                            895: (e, t, i) => {
                                ! function() {
                                    ...
                                    function o(e) {
                                        ...
                                        if (null === a) throw new Error("WebGL unavailable");
                                        ...
                                        function s(e, t) {
                                            ...
                                            if (a.shaderSource(i, t), a.compileShader(i), !a.getShaderParameter(i, a.COMPILE_STATUS)) {
                                                ...
                                                throw a.deleteShader(i), new Error("GL shader compilation for " + e + " failed: " + r)
                                            }
                                            return i
                                        }
                                        ...
                                        function A(e, t, i, r, n) {
                                            ...
                                            if (a.activeTexture(a.TEXTURE0), o.stripe) {
                                                var d = !g[e + "_temp"] || t,
                                                    c = T(e + "_temp", t);
                                                a.bindTexture(a.TEXTURE_2D, c), d ? (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.NEAREST), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.NEAREST),
                                                    a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, i / 4, r, 0, a.RGBA, a.UNSIGNED_BYTE, n)) : a.texSubImage2D(a.TEXTURE_2D, 0, 0, 0, i / 4, r, a.RGBA, a.UNSIGNED_BYTE, n);
                                                var h = g[e + "_stripe"],
                                                    f = !h || t;
                                                f && (h = T(e + "_stripe", t)), a.bindTexture(a.TEXTURE_2D, h), f && (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.NEAREST), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.NEAREST), a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, i, 1, 0, a.RGBA, a.UNSIGNED_BYTE, function(e) {
                                                    if (b[e]) return b[e];
                                                    for (var t = e, i = new Uint32Array(t), r = 0; r < t; r += 4) i[r] = 255, i[r + 1] = 65280, i[r + 2] = 16711680, i[r + 3] = 4278190080;
                                                    return b[e] = new Uint8Array(i.buffer)
                                                }(i)))
                                            } else a.bindTexture(a.TEXTURE_2D, u), s ? (a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_S, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_WRAP_T, a.CLAMP_TO_EDGE), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MIN_FILTER, a.LINEAR), a.texParameteri(a.TEXTURE_2D, a.TEXTURE_MAG_FILTER, a.LINEAR),
                                                a.texImage2D(a.TEXTURE_2D, 0, a.ALPHA, i, r, 0, a.ALPHA, a.UNSIGNED_BYTE, n)) : a.texSubImage2D(a.TEXTURE_2D, 0, 0, 0, i, r, a.ALPHA, a.UNSIGNED_BYTE, n)
                                        }
                                        ...
                                        function k(e, t, r, o) {
                                            ...
                                            var p = g[e + "_stripe"];
                                            a.activeTexture(a.TEXTURE2), a.bindTexture(a.TEXTURE_2D, p), a.uniform1i(f, 2), a.bindBuffer(a.ARRAY_BUFFER, u), a.enableVertexAttribArray(d),
                                                a.vertexAttribPointer(d, 2, a.FLOAT, !1, 0, 0), a.bindBuffer(a.ARRAY_BUFFER, c), a.enableVertexAttribArray(h), a.vertexAttribPointer(h, 2, a.FLOAT, !1, 0, 0), a.viewport(0, 0, r, o), a.drawArrays(a.TRIANGLES, 0, v.length / 2), a.bindFramebuffer(a.FRAMEBUFFER, null)
                                        }
                                        ...
                                        function E(e, t) {
                                            ...
                                            if (a.attachShader(o, i), a.attachShader(o, r), a.linkProgram(o), !a.getProgramParameter(o, a.LINK_STATUS)) {
                                                ...
                                                throw a.deleteProgram(o), new Error("GL program linking failed: " + n)
                                            }
                                            return o
                                        }
                                        return n.drawFrame = function(s) {
                                            ...
                                            if (y && (e.width = g.displayWidth, e.height = g.displayHeight, n.clear()), t || function() {
                                                    if (o.stripe) {
                                                        i = E(r.vertexStripe, r.fragmentStripe), a.getAttribLocation(i, "aPosition"), c = a.createBuffer();
                                                    ...
                                                    t = E(r.vertex, r.fragment), u = a.createBuffer(), a.bindBuffer(a.ARRAY_BUFFER, u), a.bufferData(a.ARRAY_BUFFER, v, a.STATIC_DRAW), d = a.getAttribLocation(t, "aPosition"), _ = a.createBuffer(), p = a.getAttribLocation(t, "aLumaPosition"), m = a.createBuffer(), V = a.getAttribLocation(t, "aChromaPosition")
                                                }(), y) {
                                            ...
                                            A("uTextureY", y, s.y.stride, g.height, s.y.bytes), A("uTextureCb", y, s.u.stride, g.chromaHeight, s.u.bytes), A("uTextureCr", y, s.v.stride, g.chromaHeight, s.v.bytes), o.stripe && (k("uTextureY", y, s.y.stride, g.height), k("uTextureCb", y, s.u.stride, g.chromaHeight), k("uTextureCr", y, s.v.stride, g.chromaHeight)), a.useProgram(t), a.viewport(0, 0, e.width, e.height), w("uTextureY", a.TEXTURE0, 0), w("uTextureCb", a.TEXTURE1, 1), w("uTextureCr", a.TEXTURE2, 2), a.bindBuffer(a.ARRAY_BUFFER, u), a.enableVertexAttribArray(d), a.vertexAttribPointer(d, 2, a.FLOAT, !1, 0, 0), a.bindBuffer(a.ARRAY_BUFFER, _), a.enableVertexAttribArray(p), a.vertexAttribPointer(p, 2, a.FLOAT, !1, 0, 0), a.bindBuffer(a.ARRAY_BUFFER, m), a.enableVertexAttribArray(V), a.vertexAttribPointer(V, 2, a.FLOAT, !1, 0, 0), a.drawArrays(a.TRIANGLES, 0, v.length / 2)
                                        }, n.clear = function() {
                                        ...
                                        convertYCbCr: function(e, i) {
                                            ...
                                            if (1 == n && 1 == a)
                                                for (y = 0, b = l, O = 0, R = 0; R < o; R += 2) {
                                                    for (m = (p = R * c | 0) + c | 0, V = O * h | 0, v = O * f | 0, x = 0; x < r; x += 2) T = 0 | u[V++], w = (409 * (A = 0 | d[v++]) | 0) - 57088 | 0, E = (100 * T | 0) + (208 * A | 0) - 34816 | 0, P = (516 * T | 0) - 70912 | 0, k = 298 * s[p++] | 0, i[y] = k + w >> 8, i[y + 1] = k - E >> 8, i[y + 2] = k + P >> 8, y += 4, k = 298 * s[p++] | 0, i[y] = k + w >> 8, i[y + 1] = k - E >> 8, i[y + 2] = k + P >> 8, y += 4, k = 298 * s[m++] | 0, i[b] = k + w >> 8, i[b + 1] = k - E >> 8, i[b + 2] = k + P >> 8, b += 4, k = 298 * s[m++] | 0, i[b] = k + w >> 8, i[b + 1] = k - E >> 8, i[b + 2] = k + P >> 8, b += 4;
                                                    y += l, b += l, O++
                                                } else
                                                    for (g = 0, R = 0; R < o; R++)
                                                        for (F = 0, _ = R * c | 0, V = (O = R >> a) * h | 0, v = O * f | 0, x = 0; x < r; x++) T = 0 | u[V + (F = x >> n)], w = (409 * (A = 0 | d[v + F]) | 0) - 57088 | 0, E = (100 * T | 0) + (208 * A | 0) - 34816 | 0, P = (516 * T | 0) - 70912 | 0, k = 298 * s[_++] | 0, i[g] = k + w >> 8, i[g + 1] = k - E >> 8, i[g + 2] = k + P >> 8, g += 4
                                        }
                                    }
                                }()
                            },
                    ...
                    return (() => {
                        ...
                        var o = t(i(8)),
                            ...
                            d = t(i(869)),
                            c = t(i(168)),
                            h = "1.8.9-20220406232920-cb5f7ff";
                        e.OGVVersion = h, "object" === ("undefined" == typeof window ? "undefined" : (0, o.default)(window)) && (window.OGVCompat = n.default, window.OGVLoader = a.default, window.OGVMediaError = s.default, window.OGVMediaType = u.default, window.OGVTimeRanges = c.default, window.OGVPlayer = d.default, window.OGVVersion = h)
                    })(), r
                })()
            },
            e.exports = t();
...
//# sourceMappingURL=84e60e51808bcbc89305.js.map
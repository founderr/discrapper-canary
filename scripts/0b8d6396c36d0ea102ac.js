                                        ...
                                        try {
                                            for (var s, d = n.rules.flat()[Symbol.iterator](); !(o = (s = d.next()).done); o = !0) {
                                                ...
                                                if (null != f.application_id) {
                                                    var O, I = null === (O = n.applications) || void 0 === O ? void 0 : O[f.application_id];
                                                    ...
                                                    var T = _.Z.get(f.connection_type);
                                                    E = (0, r.jsx)("img", {
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != L[e] && null != L[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var a in L[e][t]) t === D ? f.ZP.isNewForumThread(a, t, r) && M[e][t]++ : o.default.compare(a, i) > 0 && !f.ZP.hasOpenedThread(a) && M[e][t]++
                        }
                    }
                }
            }
        ...
        96606: (e, t, n) => {
            ...
            var C = function(e) {
                ...
                o.renderUsers = function() {
                    for (var e = this.props, t = e.users, n = e.max, i = e.renderUser, o = void 0 === i ? this.defaultRenderUser : i, u = e.size, a = e.extraDetail, l = [], c = t.length === n ? t.length : n - 1, s = this.renderMoreUsers(c), d = 0; d < c && d < t.length;) {
                        var f, _ = null == s && null == a && d === t.length - 1,
                            E = o(t[d], _, d);
                        l.push(_ ? (0, r.jsx)("div", {
                            className: T().avatarContainer,
                            children: E
                        }, P(null !== (f = t[d]) && void 0 !== f ? f : null, d)) : (0, r.jsx)(O.ZP, {
                ...
                o.render = function() {
                    ...
                    return (0, r.jsx)(c.Popout, {
                        ...
                        renderPopout: function(t) {
                            ...
                            return (0, r.jsx)(d.Z, g(S(g(S({}, e.props), {

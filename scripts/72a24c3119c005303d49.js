        ...
        543315: (t, e, n) => {
            ...
            const m = function(t) {
                ...
                function n() {
                    h(this, n);
                    var t;
                    (t = e.apply(this, arguments)).handleClose = function() {
                        var e = t.props.onClose;
                        null == e || e()
                    };
                    t.handleStreamWithoutSound = function() {
                        var e = t.props,
                            n = e.handleStream,
                            o = e.onClose,
                            r = e.pid;
                        s.Z.continueNonelevatedProcess(r);
                        n();
                        o()
                    };
                    t.handleRequestElevated = function() {
                        var e = t.props,
                            n = e.handleStream,
                            o = e.onClose,
                            r = e.pid;
                        s.Z.requestElevatedProcess(r);
                        n();
                        o()
                    };
                    return t
                ...
                r.render = function() {
                    return (0, o.jsxs)(i.ModalRoot, {
                        ...
                        "aria-label": d.Z.Messages.ELEVATED_PERMISSIONS_SOUND_TITLE,
                        children: [(0, o.jsxs)(i.ModalHeader, {
                            justify: l.Z.Justify.BETWEEN,
                            separator: !1,
                            children: [(0, o.jsx)(i.Heading, {
                                variant: "heading-lg/semibold",
                                children: d.Z.Messages.ELEVATED_PERMISSIONS_SOUND_TITLE
                            ...
                            children: (0, o.jsx)(i.Text, {
                                ...
                                children: d.Z.Messages.ELEVATED_PERMISSIONS_SOUND_BODY
                            })
                        }), (0, o.jsxs)(i.ModalFooter, {
                            children: [(0, o.jsx)(i.Button, {
                                onClick: this.handleRequestElevated,
                                children: d.Z.Messages.ELEVATED_PERMISSIONS_SOUND_REQUEST_ACCESS_BUTTON
                            }), (0, o.jsx)(i.Button, {
                                look: i.Button.Looks.LINK,
                                color: i.Button.Colors.PRIMARY,
                                onClick: this.handleStreamWithoutSound,
                                children: d.Z.Messages.ELEVATED_PERMISSIONS_SOUND_NO_SOUND_BUTTON
                            })]
                        })]
                    })
                };
...
//# sourceMappingURL=72a24c3119c005303d49.js.map
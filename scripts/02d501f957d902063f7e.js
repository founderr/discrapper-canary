    ...
    ["92544"], {
        ...
        590514: function(e, t, n) {
            ...
            function F(e) {
                ...
                let G = null;
                null != n && n.length > 0 && null != f && (G = i ? (0, l.jsx)("div", {
        ...
        976789: function(e, t, n) {
            ...
            let c = a.default.get("lastNonRequiredUpdateShown", Date.now()),
                f = new i.default("AutoUpdateManager");
            class E {
                destroy() {
                ...
                constructor(e = 36e5) {
                    ...
                    this.updateAvailable = !1, this.hasNativeUpdate = !1, this._callbacks = [], this._bootstrapper = null, this.checkForUpdates = function() {
                        ...
                        this._handleCheckingForUpdates(), l.default.get({
                            ...
                            if (null == e.body || "9235e2dc874b1ed355e83a78a5b876470da192bf" === e.body.hash) return this._handleUpdateNotAvailable();
                ...
                C = e => {
                    switch (e.item_enum) {
                        ...
                        case o.ItemEnum.FIND_FRIENDS:
                            return r.FIND_FRIENDS;
                        case o.ItemEnum.FIRST_MESSAGE:
                            return r.FIRST_MESSAGE;
                        case o.ItemEnum.UPDATE_PROFILE:
                            return r.UPDATE_PROFILE;
                        default:
                            return r.NOTIFICATION_CENTER
                    }
                },
                R = e => {
                    switch (e.type) {
                        ...
                        case "missed_messages":
                            return r.MISSED_MESSAGES;
                        case "friend_request_reminder":
                            return r.FRIEND_REQUEST_REMINDER;
                        case "scheduled_guild_event_started":
                            return r.SCHEDULED_GUILD_EVENT;
                        case "top_messages":
                            return r.TOP_MESSAGES;
                        default:
                            return r.NOTIFICATION_CENTER
                    }
                },
                O = e => {
                    if ("icHighlight" === e) return r.TOP_MESSAGES;
                    return r.NOTIFICATION_CENTER
                },
                M = e => {
                    switch (e) {
            ...
            function B(e) {
                ...
                return null != s.dueAt && (s.dueAt > new Date ? (t = "text-muted", B = b.default.Messages.MESSAGE_REMINDERS_DUE_IN.format({
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        className: r(G.messageContainer, j.unloadedMessage, {
                            [j.disabledMessage]: i
                        }),
                        children: [(0, l.jsx)(A.default, {
                            message: f,
                ...
                return (0, l.jsx)(o.FocusRing, {
                    ...
                    children: (0, l.jsxs)("div", {
                        ...
                        onKeyDown: function(e) {
                            if (null != u && null != i && ("ArrowRight" === e.key && i.collapsed || "ArrowLeft" === e.key && !i.collapsed)) null == u || u(i)
                        },
                        children: [(0, l.jsx)(R, {
                            channel: t,
                            gotoChannel: a
            ...
            function N(e) {
                let {
                    ...
                    let t = (0, s.useStateFromStores)([c.default], () => {
                            var t;
                            return null !== (e = null === (t = c.default.settings.inbox) || void 0 === t ? void 0 : t.currentTab) && void 0 !== e ? e : r.InboxTab.UNREADS
                        }),
                        n = a.useCallback(e => {
        ...
        970268: function(e, t, n) {
            ...
            var l, a, s, r, i = n("884691"),
                ...
                j = n("49111"),
                G = n("648564");
            (l = s || (s = {}))[l.Favorite = 0] = "Favorite", l[l.PrivateChannel = 1] = "PrivateChannel", l[l.Mentioned = 2] = "Mentioned", l[l.AllMessagesNotifications = 3] = "AllMessagesNotifications", l[l.GuildChannel = 4] = "GuildChannel", l[l.OldChannel = 5] = "OldChannel", l[l.NoNotifications = 6] = "NoNotifications", l[l.ReallyOldChannel = 7] = "ReallyOldChannel", (a = r || (r = {})).Loading = "loading", a.Loaded = "loaded", a.Done = "done";
            let k = 25;
            class w extends o.EventEmitter {
                loadMore() {
                    ...
                    (!n || l.some((e, n) => e !== t[n])) && this.setState({
                        channels: l,
                        loadState: n ? this.state.loadState : r.Done
                    })
                }
                ...
                constructor(e, t) {
                    super(), this.state = e, this.scrollerRef = t, this.maybeLoadMore = () => {
                        ...
                        let {
                            ...
                            collapsedChannels: a,
                            loadState: s
                        } = this.state, i = f.findIndex(l, e => e.channelId === t), o = l[i], u = !o.collapsed;
                        a[t] = u, (0, A.updateUserChannelSettings)(n, t, e => {
                            e.collapsedInInbox = u
                        }, A.UserSettingsDelay.FREQUENT_USER_ACTION), this.setState({
                            scrollToChannelIndex: i,
                            collapsedChannels: a,
                            loadState: s !== r.Done || u || o.isFullyLoaded ? s : r.Loaded,
                            channels: this.updateChannel(t, e => ({
                                ...e,
                                collapsed: u
                            }))
            ...
            function Y(e, t, n, l) {
                ...
                if (null == a) return;
                let r = R.THREAD_CHANNEL_TYPES.has(a.type);
                if (!r && U.default.isGuildOrCategoryOrChannelMuted(n, a.id)) return;
                if (a.isPrivate()) {
            ...
            class U extends a.PureComponent {
                ...
                constructor(e) {
                    super(e), this.state = {
                        ...
                        let r = I.default.getTextChannelNameDisambiguations(s.getGuildId()),
                            i = r[s.id],
                            o = null != i ? i.name : s.name;
                ...
                Q = {
                    ...
                    [j.SearchAutocompleteGroups.HISTORY]: {
                        ...
                        component: function(e) {
                            ...
                            return (0, l.jsxs)(S.Clickable, {
                                className: r(k.option, k.history),
                                onClick: t,
                                onFocus: n,
                                ...c,
                    ...
                    [j.SearchAutocompleteGroups.SEARCH_OPTIONS]: {
                        ...
                        component: function(e) {
                            ...
                            return (0, l.jsxs)(S.Clickable, {
                                className: r(k.option, k.searchOption),
                                onClick: a,
                                onFocus: s,
                                ...u,
            ...
            var l = n("913144"),
                ...
                d = {
                    ...
                    openResourceChannelAsSidebar(e) {
                        ...
                        null != t && ((0, r.selectHomeResourceChannel)(t, n, !1), l.default.dispatch({
                            type: "SIDEBAR_VIEW_CHANNEL",
                            sidebarType: o.SidebarType.VIEW_CHANNEL,
                            guildId: t,
        ...
        600133: function(e, t, n) {
            ...
            function eU(e, t, n) {
                ...
                if (null == e) return;
                let r = eL[e];
                if (null != r && !t && u.default.set(r, !0), eD.has(e) && (ev[e] = !0), null != n && null != r) {
                    ;
            ...
            let eb = [em.NoticeTypes.QUARANTINED, em.NoticeTypes.AUTOMOD_QUARANTINED_USER_PROFILE, em.NoticeTypes.VIEWING_ROLES, em.NoticeTypes.INVITED_TO_SPEAK, em.NoticeTypes.LURKING_GUILD, em.NoticeTypes.VOICE_DISABLED, em.NoticeTypes.NO_INPUT_DETECTED, em.NoticeTypes.HARDWARE_MUTE, em.NoticeTypes.H264_DISABLED, em.NoticeTypes.DISPATCH_ERROR, em.NoticeTypes.DISPATCH_INSTALL_SCRIPT_PROGRESS, em.NoticeTypes.SPOTIFY_AUTO_PAUSED, em.NoticeTypes.DROPS_PROGRESS_INTERRUPTION, em.NoticeTypes.WIN32_DEPRECATED_MESSAGE, em.NoticeTypes.BLOCKED_BY_PROXY, em.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION, em.NoticeTypes.GUILD_RAID_NOTIFICATION, em.NoticeTypes.UNCLAIMED_ACCOUNT, em.NoticeTypes.POMELO_ELIGIBLE, em.NoticeTypes.PENDING_MEMBER, em.NoticeTypes.OUTBOUND_PROMOTION, em.NoticeTypes.CORRUPT_INSTALLATION, em.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER, em.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK, em.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, em.NoticeTypes.STREAMER_MODE, em.NoticeTypes.SCHEDULED_MAINTENANCE, em.NoticeTypes.BOUNCED_EMAIL_DETECTED, em.NoticeTypes.UNVERIFIED_ACCOUNT, em.NoticeTypes.PREMIUM_TIER_2_TRIAL_ENDING, em.NoticeTypes.PREMIUM_TIER_0_TRIAL_ENDING, em.NoticeTypes.PREMIUM_UNCANCEL, em.NoticeTypes.PREMIUM_MISSING_PAYMENT, em.NoticeTypes.PREMIUM_PAST_DUE_INVALID_PAYMENT, em.NoticeTypes.PREMIUM_PAST_DUE_MISSING_PAYMENT, em.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, em.NoticeTypes.PREMIUM_REACTIVATE, em.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION, em.NoticeTypes.MFA_SMS_BACKUP, em.NoticeTypes.APPLICATION_TEST_MODE, em.NoticeTypes.LOCALIZED_PRICING, em.NoticeTypes.DOWNLOAD_NAG, em.NoticeTypes.CONNECT_SPOTIFY, em.NoticeTypes.CONNECT_PLAYSTATION, em.NoticeTypes.SURVEY, em.NoticeTypes.SERVER_USAGE_SURVEY, em.NoticeTypes.SAFETY_USER_SENTIMENT_NAGBAR, em.NoticeTypes.DROPS_GO_LIVE_BANNER, em.NoticeTypes.DROPS_ENDED_INCOMPLETE, em.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR],
                ...
                eG = {
                    ...
                    [em.NoticeTypes.CORRUPT_INSTALLATION]: {
                        predicate: () => e_.isPlatformEmbedded && (!i.default.supported() || eI.default.isCorruptInstallation())
                    },
                    ...
                    [em.NoticeTypes.PREMIUM_TIER_2_TRIAL_ENDING]: {
                        predicate: () => {
                            let e = eE.default.getAlmostExpiringTrialOffers([eC.PremiumSubscriptionSKUs.TIER_2]);
                            return e.length > 0 && !eF(em.NoticeTypes.PREMIUM_TIER_2_TRIAL_ENDING)
                        }
                    },
                    [em.NoticeTypes.PREMIUM_TIER_0_TRIAL_ENDING]: {
                        predicate: () => {
                            let e = eE.default.getAlmostExpiringTrialOffers([eC.PremiumSubscriptionSKUs.TIER_0]);
                            return e.length > 0 && !eF(em.NoticeTypes.PREMIUM_TIER_0_TRIAL_ENDING)
                        }
                    },
                    [em.NoticeTypes.PREMIUM_UNCANCEL]: {
                        predicate: e => {
                            let {
                                ...
                                currentUser: n
                            } = e, l = null != t ? s(t.currentPeriodEnd).diff(s().startOf("day"), "days") : 0, a = (null == t ? void 0 : t.canceledAt) != null && (null == t ? void 0 : t.status) === em.SubscriptionStatusTypes.CANCELED && 1 >= s().diff(s(t.canceledAt), "days"), r = null != t && s(t.currentPeriodEnd).isBefore(s()), i = null != t && t.status === em.SubscriptionStatusTypes.CANCELED && !r && l <= 7 && l >= 0 && (0, eT.isPremiumExactly)(n, eC.PremiumTypes.TIER_2) && !a && !n.hasFreePremium() && !t.isPurchasedExternally;
                            return !eF(em.NoticeTypes.PREMIUM_UNCANCEL) && i
                        },
                        metadata: e => {
                            var t;
                            let {
                                premiumSubscription: n
                            } = e, l = null != n ? s(n.currentPeriodEnd).diff(s().startOf("day"), "days") : 0, a = null != n ? null === (t = (0, eT.getPremiumPlanItem)(n)) || void 0 === t ? void 0 : t.planId : null, r = null != a ? eT.default.getPremiumType(a) : null;
                            return {
                                daysLeft: l,
                                premiumType: r,
                                premiumSubscription: n
                    ...
                    [em.NoticeTypes.PREMIUM_MISSING_PAYMENT]: {
                        predicate: e => {
                            let {
                                premiumSubscription: t,
                                currentUser: n
                            } = e, l = null != t ? s(t.currentPeriodEnd).diff(s().startOf("day"), "days") : 0, a = null != t ? s(t.currentPeriodEnd).diff(s(t.currentPeriodStart).startOf("day"), "days") : 0, r = null != t && s(t.currentPeriodEnd).isBefore(s()), i = eh.default.applicationIdsFetched.has(eC.PREMIUM_SUBSCRIPTION_APPLICATION), o = eh.default.getForApplication(eC.PREMIUM_SUBSCRIPTION_APPLICATION), u = null != t ? (0, eT.getPremiumPlanItem)(t) : null, d = null != u ? eT.default.getSkuIdForPlan(u.planId) : null, c = null != o && null != u && Array.from(o).filter(e => {
                                let {
                                    skuId: t,
                                    consumed: n
                                } = e;
                                return !n && t === d
                            }).length > 0, f = null != t && l <= (a > 14 ? 7 : 2) && l >= 0 && t.status !== em.SubscriptionStatusTypes.PAST_DUE && !r && i && !c && null === t.paymentSourceId && !n.hasFreePremium() && !t.isPurchasedExternally;
                    ...
                    [em.NoticeTypes.PREMIUM_PAST_DUE_INVALID_PAYMENT]: {
                        predicate: e => {
                            let {
                                premiumSubscription: t,
                                currentUser: n
                            } = e, l = null != t && null != t.paymentSourceId ? ec.default.getPaymentSource(t.paymentSourceId) : null, a = null != t && s(t.currentPeriodEnd).isBefore(s()), r = null != t && t.status === em.SubscriptionStatusTypes.PAST_DUE && !a && null != l && l.invalid && !n.hasFreePremium() && !t.isPurchasedExternally;
                            return !eF(em.NoticeTypes.PREMIUM_PAST_DUE_INVALID_PAYMENT) && r
                        },
                        metadata: e => {
                            let {
                                premiumSubscription: t
                    ...
                    [em.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
                        predicate: e => {
                            let {
                                premiumSubscription: t,
                                currentUser: n
                            } = e, l = null != t && s(t.currentPeriodEnd).isBefore(s()), a = null != t && null != t.paymentSourceId ? ec.default.getPaymentSource(t.paymentSourceId) : null, r = null != a && eR.PREPAID_PAYMENT_SOURCES.has(a.type), i = null != t && t.status === em.SubscriptionStatusTypes.PAST_DUE && !l && r && !n.hasFreePremium() && !t.isPurchasedExternally;
                            return !eF(em.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT) && i
                        },
                        metadata: e => {
                            let {
                                premiumSubscription: t
                    ...
                    [em.NoticeTypes.DROPS_GO_LIVE_BANNER]: {
                        predicate: () => !eF(em.NoticeTypes.DROPS_GO_LIVE_BANNER) && (0, S.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP) && !(0, S.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP) && (0, T.getShowDropsNoticeBanner)(eA.PartnerGame.FORTNITE),
                        metadata: () => ({
                    ...
                    [em.NoticeTypes.DROPS_ENDED_INCOMPLETE]: {
                        predicate: () => !eF(em.NoticeTypes.DROPS_ENDED_INCOMPLETE) && (0, S.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP) && !(0, S.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP) && (0, T.getShowDropsEndedIncompleteBanner)(eA.PartnerGame.FORTNITE),
                        metadata: () => ({
                            partnerGame: eA.PartnerGame.FORTNITE
                        })
                    },
            ...
            function ek() {
                ...
                let t = ef.default.getPremiumSubscription(),
                    ...
                    r = eg.CONFERENCE_MODE_ENABLED ? ej : eb;
                for (let u of r)
                    if (null != eG[u] && eG[u].predicate({
                        ...
                        var i, o;
                        let n = null === (i = (o = eG[u]).metadata) || void 0 === i ? void 0 : i.call(o, {
                            currentUser: e,
                            premiumSubscription: t,
                            selectedGuildId: l
                        });
            ...
            class eB extends r.default.Store {
                initialize() {
                    this.syncWith([er.default, $.default, Q.default, el.default, U.default, eE.default, H.default, K.default, w.default, g.default], ek), this.waitFor(eo.default, ea.default, q.default, z.default, ee.default, Z.default, es.default, p.default, el.default, ei.default, G.default, et.default, $.default, ep.default, eN.default, eS.default, X.default, ef.default, eI.default, Q.default, ec.default, J.default, U.default, eh.default, eE.default, K.default, L.default, _.default, h.default, b.default)
                }
                hasNotice() {
                    return null != eP && null != eP.type
                }
                getNotice() {
                    return null == ei.default.getAction() ? eP : null
                }
                isNoticeDismissed(e) {
                    return eF(e)
                }

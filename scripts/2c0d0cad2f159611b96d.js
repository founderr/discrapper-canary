                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsxs)(r.ModalContent, {
                            ...
                            children: [(0, i.jsx)(r.Button, {
                                ...
                                disabled: x.disableNextStep,
                                children: U ? v : E.default.Messages.NEXT
                            }), h ? null : (0, i.jsx)(r.Button, {
        ...
        79536: function(e, t, s) {
            ...
            let H = e => {
                ...
                w = e => {
                    ...
                    n.useEffect(() => {
                        (0, x.trackEnableCommunityFlow)({
                            fromStep: h.EnableCommunityModalSteps.SAFETY_CHECK,
                            toStep: h.EnableCommunityModalSteps.BASICS,
                            guildId: _
                        })
                    }, [_]);
                ...
                k = e => {
                    ...
                    n.useEffect(() => {
                        (0, x.trackEnableCommunityFlow)({
                            fromStep: h.EnableCommunityModalSteps.BASICS,
                            toStep: h.EnableCommunityModalSteps.FINISH,
                            guildId: t.id
                        })
                    }, [t.id]);
            ...
            function X(e) {
                ...
                return t.length === h.MODERATOR_PERMISSIONS.length && (n = v.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_DISABLED), (0, i.jsxs)("div", {
                    className: G.tableContainer,
                    children: [(0, i.jsx)(d.Text, {
                        className: G.tableHeader,
                        variant: "text-xs/semibold",
            ...
            let q = e => {
                ...
                let c = n.useMemo(() => {
                    let e = [],
                        s = [];
                    return h.MODERATOR_PERMISSIONS.map(i => {
            ...
            var Q = e => {
                ...
                n.useEffect(() => {
                    D.default.track(U.AnalyticEvents.OPEN_MODAL, {
                        type: h.ENABLE_COMMUNITY_FLOW_MODAL_KEY
                    })
                }, []);
                let {
                    guild: l
                } = (0, o.useStateFromStoresObject)([I.default], () => I.default.getProps()), E = (0, o.useStateFromStores)([A.default], () => A.default.theme), [u, d] = n.useState(!1), [S, f] = n.useState(!h.MODERATOR_PERMISSIONS.some(e => P.default.canEveryone(e, l))), [O, g] = n.useState(h.CREATE_NEW_CHANNEL_VALUE), [p, x] = n.useState(h.CREATE_NEW_CHANNEL_VALUE), [B] = n.useState(null == l ? void 0 : l.defaultMessageNotifications), [b] = n.useState(null == l ? void 0 : l.verificationLevel), [j] = n.useState(null == l ? void 0 : l.explicitContentFilter), [y] = n.useState(S), F = null == l ? void 0 : l.getRole(null == l ? void 0 : l.id), Y = (0, o.useStateFromStores)([m.default], () => null != l ? m.default.getChannels(l.id) : null, [l]), K = (0, R.useUID)(), {
                    enabled: W
                } = (0, _.useIsMassMentionsDefaultDisabledExperiment)(null !== (t = null == l ? void 0 : l.id) && void 0 !== t ? t : "");
                if (null == l) return null;
                let X = [{
                    value: h.CREATE_NEW_CHANNEL_VALUE,
                ...
                let z = b !== U.VerificationLevels.NONE,
                    ...
                    Z = B === U.UserNotificationSettings.ONLY_MENTIONS,
                    J = async () => {
                        if (null == F || !u) return;
                        let e = new Set(l.features);
                        e.add(U.GuildFeatures.COMMUNITY);
                        let t = S ? r.default.remove(F.permissions, h.MODERATOR_PERMISSIONS_FLAG) : F.permissions,
                            s = {
                                ...F,
                                permissions: t
                            };

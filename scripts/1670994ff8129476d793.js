        ...
        787598: function(e, t, s) {
            ...
            class w extends i.PureComponent {
                ...
                renderDefaultHeader(e, t, s) {
                    ...
                    return (0, a.jsxs)(u.ModalHeader, {
                        ...
                        }), this.renderPurchaseWarning(), this.renderGenericError(l, s), t.length > 1 ? (0, a.jsx)(y.default, {
                            activeId: e,
                            breadcrumbs: t,
            ...
            let V = i.forwardRef((e, t) => {
                ...
                let {
                    ...
                    skuId: i,
                    ...l
                } = e, u = (0, o.useStateFromStores)([A.default], () => A.default.getApplication(r)), d = (0, B.hasFlag)(null !== (s = null == u ? void 0 : u.flags) && void 0 !== s ? s : 0, k.ApplicationFlags.EMBEDDED) && (0, B.hasFlag)(null !== (n = null == u ? void 0 : u.flags) && void 0 !== n ? n : 0, k.ApplicationFlags.EMBEDDED_IAP), [c, p, S, h, f, E, I, P, y] = (0, o.useStateFromStoresArray)([R.default], () => [R.default.getPricesForSku(i), R.default.isPurchasingSKU, R.default.error, R.default.analyticsLocation, R.default.promotionId, R.default.giftCode, R.default.isGift, R.default.isIAP, R.default.forceConfirmationStepOnMount]), [O, L] = (0, o.useStateFromStoresArray)([N.default], () => [N.default.get(i), N.default.isFetching(i)]), M = (0, o.useStateFromStores)([_.default, g.default], () => g.default.inTestModeForApplication(r) || _.default.inDevModeForApplication(r), [r]), D = (0, o.useStateFromStores)([m.default, C.default], () => m.default.isEntitledToSku(C.default.getCurrentUser(), i, r)), x = (0, o.useStateFromStores)([T.default], () => T.default.error);
                return (0, a.jsx)(w, {
                    ...l,
                    application: u,
                    applicationId: r,
        ...
        891865: function(e, t, s) {
            ...
            function B(e) {
                let {
                    ...
                    productLine: I
                } = (0, y.usePaymentContext)(), [P, B] = r.useState(C.default.Modes.DEFAULT), U = (0, u.useStateFromStores)([A.default], () => A.default.enabled), F = () => null != l ? l.skuId : null != a ? a.id : null, b = () => {
                    let e;
            ...
            let x = e => {
                ...
                let [a, i] = r.useState(), [l, E] = r.useState(!1), [A, C] = r.useState(!1), {
                    userAffinities: T,
                    isLoading: m
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(d.FormTitle, {
                        ...
                        children: [(0, n.jsx)(d.SearchableSelect, {
                            ...
                            className: l ? D.giftRecipientInputError : void 0,
                        ...
                        className: l ? D.subtextError : D.subtext,
                        children: l ? M.default.Messages.APPLICATION_STORE_GIFT_PURCHASE_GIFT_ERROR_SENDING_LINK : M.default.Messages.APPLICATION_STORE_GIFT_PURCHASE_GIFT_RECIPIENT_SUBTEXT
                    })]
                })
            }
        },

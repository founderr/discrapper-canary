(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [21391, 74871], {
        ...
        521391: (t, e, n) => {
            ...
            var w = (P(r = {}, h.Us.BAN, [f.Z, N().redIcon]), P(r, h.Us.GLOBAL_QUARANTINE, [_.Z, N().warningIcon]), P(r, h.Us.DISABLE_SUSPICIOUS_ACTIVITY, [_.Z, N().warningIcon]), P(r, h.Us.LIMITED_ACCESS, [O.Z, N().warningIcon]), P(r, h.Us.REQUIRE_VERIFICATION, [_.Z, N().warningIcon]), P(r, h.Us.TEMP_BAN, [O.Z, N().warningIcon]), P(r, h.Us.USER_MESSAGE_REMOVAL, [y.Z, N().redIcon]), P(r, h.Us.USER_SPAMMER, [_.Z, N().warningIcon]), P(r, h.Us.USER_USERNAME_MANGLE, [S.Z, N().warningIcon]), P(r, h.Us.USER_WARNING, [p.Z, N().warningIcon]), r),
                L = _.Z,
                R = function(t) {
                ...
                D = function(t) {
                    var e = t.action,
                        n = j(e.action_type in w ? w[e.action_type] : [L, N().warningIcon], 2),
                        r = n[0],
                        i = n[1];
                ...
                return (0, o.jsxs)(c.ModalRoot, {
                    ...
                    children: [(0, o.jsxs)("div", {
                        ...
                        children: (0, o.jsx)(c.Button, {
                            ...
                            onClick: function() {
                                n();
                                l.Z.open(v.oAB.PRIVACY_AND_SAFETY, I.SU.SUPPORT)
                            },
        ...
        223219: (t, e, n) => {
            ...
            var M = function(t) {
                ...
                r.hasChanges = function() {
                    return null != g && null != v && (!(!this.isOpen() && C !== a.cII.USER_SETTINGS) && !o().isEqual(g, v))
                };
                r.isOpen = function() {
                    return m
                };

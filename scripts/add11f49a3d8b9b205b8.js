        ...
        709863: function(e, t, s) {
            ...
            function h(e) {
                ...
                let {
                    ...
                    guildId: P,
                    userId: v
                } = i, O = null === (t = i.actionedByUser) || void 0 === t ? void 0 : t.id, D = (0, u.useStateFromStores)([f.default], () => f.default.getUser(O)), b = (0, u.useStateFromStores)([I.default], () => null != O ? I.default.getMember(P, O) : null, [O, P]), L = l.useCallback(() => {
                    (0, d.showToast)((0, d.createToast)(p.default.Messages.ERROR_GENERIC_TITLE, d.ToastType.FAILURE))
                }, []), F = async () => {
                    if (!g) {
                        C(!0);
                        try {
                            await m.default.updateGuildJoinRequest(P, v, M.GuildJoinRequestApplicationStatuses.APPROVED)
                        } catch {
                            L()
                        } finally {
                            C(!1)
                ...
                i.applicationStatus === M.GuildJoinRequestApplicationStatuses.APPROVED ? (B = p.default.Messages.GUILD_SETTINGS_MEMBER_VERIFICATION_APPROVED, J = (0, a.jsx)(T.default, {
                    width: 24,
                    height: 24,
                    className: A.iconApproved,
                    backgroundColor: o.default.unsafe_rawColors.WHITE_500.css
                })) : i.applicationStatus === M.GuildJoinRequestApplicationStatuses.REJECTED && (B = p.default.Messages.GUILD_SETTINGS_MEMBER_VERIFICATION_REJECTED, J = (0, a.jsx)(S.default, {
                    width: 24,
                    height: 24,

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [99947, 83238, 38479, 17183, 33928, 72935, 40056, 19887, 57678, 58621, 33973, 96043, 71402, 42643, 17363, 56620], {
        737264: e => {
            "use strict";
        ...
        652411: (e, t, n) => {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var u = m(e.start),
                                ...
                                s = m(e.duration),
                                c = m(e.direction);
                            return new O(new b(t.x, u.x, l.x, s.x, c.x, e.easingFunction), new b(t.y, u.y, l.y, s.x, c.y, e.easingFunction));
                        case "oscillating-random":
                            n = m(e.minValue), r = m(e.maxValue);
                            var f = m(e.minStart),
                                p = m(e.maxStart),
                                ...
                                S = m(e.minDirection),
                                R = m(e.maxDirection);
                            return new O(new b(g(n.x, r.x), g(f.x, p.x), g(d.x, E.x), g(_.x, h.x), T(S.x, R.x), y(e.easingFunctions)[0]), new b(g(n.y, r.y), g(f.y, p.y), g(d.y, E.y), g(_.y, h.y), T(S.y, R.y), y(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector2"
                }))
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating":
                            ...
                            var u = S(e.start),
                                ...
                                s = S(e.duration),
                                c = S(e.direction);
                            return new h(new b(t.x, u.x, l.x, s.x, c.x, e.easingFunction), new b(t.y, u.y, l.y, s.z, c.y, e.easingFunction), new b(t.z, u.z, l.z, s.z, c.z, e.easingFunction));
                        case "oscillating-random":
                            n = S(e.minValue), r = S(e.maxValue);
                            var f = S(e.minStart),
                                p = S(e.maxStart),
                                ...
                                m = S(e.minDirection),
                                R = S(e.maxDirection);
                            return new h(new b(g(n.x, r.x), g(f.x, p.x), g(d.x, E.x), g(_.x, O.x), T(m.x, R.x), y(e.easingFunctions)[0]), new b(g(n.y, r.y), g(f.y, p.y), g(d.y, E.y), g(_.y, O.y), T(m.y, R.y), y(e.easingFunctions)[0]), new b(g(n.z, r.z), g(f.z, p.z), g(d.z, E.z), g(_.z, O.z), T(m.z, R.z), y(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var A = r.forwardRef((function(e, t) {
                ...
                return r.useEffect((function() {
                    ...
                    return e("click", P, l), e("mousedown", A, s), e("mousemove", w, c), e("mouseup", L, f),
                        function() {
                            window.removeEventListener("click", P), window.removeEventListener("mousedown", A), window.removeEventListener("mousemove", w), window.removeEventListener("mouseup", w)
                        }
                }), [P, A, w, L, l, s, c, f]), r.useEffect((function() {
                    var e = O.current,
            ...
            var w = r.forwardRef((function(e, t) {
                                ...
                                var r = function(r, i) {
                                    ...
                                    if (t.drawImage(e.image, o, a, f, p), null != r) {
                                        for (var u = t.getImageData(o, a, f, p), l = function(e) {
                                            ...
                                            }(r), s = 0; s < u.data.length; s += 4) u.data[s] = l.r, u.data[s + 1] = l.g, u.data[s + 2] = l.b;
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, I()];
                                    case 1:
                                        return e.sent(), h(), _.current = !0, v(!0), [2]
                                }
                            }))
                        }))
                    }), [v, I, h]);
                return r.useEffect((function() {
                    ...
                    null != d.current && (d.current.width = (f + 2) * Math.max(c.length, 1), d.current.height = (p + 2) * s.length)
                }), [c.length, p, f, s.length]), r.createElement("canvas", {
                    ref: d,
                ...
                if ("IntersectionObserver" in e && "IntersectionObserverEntry" in e && "intersectionRatio" in e.IntersectionObserverEntry.prototype) "isIntersecting" in e.IntersectionObserverEntry.prototype || Object.defineProperty(e.IntersectionObserverEntry.prototype, "isIntersecting", {
                    ...
                    i.prototype._computeTargetAndRootIntersection = function(n, r) {
                        if ("none" != e.getComputedStyle(n).display) {
                            for (var i, o, a, l, c, f, p, d, E = u(n), _ = s(n), O = !1; !O;) {
                                var h = null,
                                    I = 1 == _.nodeType ? e.getComputedStyle(_) : {};
                                if ("none" == I.display) return;
                                if (_ == this.root || _ == t) {
                                    O = !0;
                                    h = r
                                } else _ != t.body && _ != t.documentElement && "visible" != I.overflow && (h = u(_));
                                if (h && !(E = (i = h, o = E, a = void 0, l = void 0, c = void 0, f = void 0, p = void 0, d = void 0, a = Math.max(i.top, o.top), l = Math.min(i.bottom, o.bottom), c = Math.max(i.left, o.left), f = Math.min(i.right, o.right), d = l - a, (p = f - c) >= 0 && d >= 0 && {
                                        top: a,
                                        bottom: l,
                                        left: c,
                                        right: f,
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = o(e),
                    ...
                    _ = E.length;
                for (var O in e) !t && !s.call(e, O) || d && ("length" == O || f && ("offset" == O || "parent" == O) || p && ("buffer" == O || "byteLength" == O || "byteOffset" == O) || u(O, _)) || E.push(O);
                return E
            }
        },
        70151: (e, t, n) => {
            ...
            function f(e, t, n) {
                ...
                Object.keys(i).forEach((function(o) {
                    ...
                    if ((0, u.isValidElement)(a)) {
                        ...
                        !s || l && !p ? s || !l || p ? s && l && (0, u.isValidElement)(f) && (i[o] = (0, u.cloneElement)(a, {
                ...
                d = function(e) {
                    ...
                    t.getDerivedStateFromProps = function(e, t) {
                        var n, r, i = t.children,
                            o = t.handleExited;
                        return {
                            children: t.firstRender ? (n = e, r = o, s(n.children, (function(e) {
                    ...
                    return d(this, (function(d) {
                        switch (d.label) {
                            ...
                            case 1:
                                ...
                                null != c && (E.include_unpublished = c);
        ...
        661299: (e, t, n) => {
            ...
            const p = function(e) {
                ...
                return (0, r.jsxs)("svg", {
                    width: "18",
                    height: "18",
                    className: o()(s().button, i, (t = {}, c(t, s().open, n), c(t, s().withHighlight, u), t)),
            ...
            function U(e) {
                ...
                if (!b.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== T.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        s = R({}, t, P(u), null != i && null != o && (0, m.AB)(o) ? N(0, o) : w(a));
                    b.default.track(e, s, {
                        flush: n
                    })
                }
                    ...
                    I = i.useMemo((function() {
                        return h ? p : {
                            ...
                            createConfetti: function(e, t) {
                                return O.createConfetti(c({}, s, e), t)
                            },
                            createConfettiAt: function(e, t, n, r) {
                                return O.createConfetti(c(f(c({}, s), {
                                    position: {
                                        type: "static",
                                        value: {
                                            x: e,
                            ...
                            createMultipleConfetti: function(e) {
                                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 20,
                                    n = arguments.length > 2 ? arguments[2] : void 0;
                                return O.createMultipleConfetti(c({}, s, e), t, n)
                            },
                            createMultipleConfettiAt: function(e, t, n) {
                                var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 20,
                                    i = arguments.length > 4 ? arguments[4] : void 0;
                                return O.createMultipleConfetti(c(f(c({}, s), {
                                    position: {
                                        type: "static",
                                        value: {
                                            x: e,
        ...
        761673: (e, t, n) => {
            ...
            function a(e) {
                ...
                var s = e instanceof i.Z ? e.premiumTier : o.Eu4.NONE;
                return {
        ...
        596801: (e, t, n) => {
            ...
            function E(e, t) {
                var s = null != t ? t : "".concat(l.jXE.PREMIUM_GUILD_UPSELL_MODAL);
        ...
        393299: (e, t, n) => {
            ...
            var h, I = (O(r = {}, d.Eu4.NONE, _().iconBackgroundTierNone), O(r, d.Eu4.TIER_1, _().iconBackgroundTierOne), O(r, d.Eu4.TIER_2, _().iconBackgroundTierTwo), O(r, d.Eu4.TIER_3, _().iconBackgroundTierThree), r),
                v = (O(h = {}, d.Eu4.NONE, _().iconTierNone),
                    O(h, d.Eu4.TIER_1, _().iconTierOne), O(h, d.Eu4.TIER_2, _().iconTierTwo), O(h, d.Eu4.TIER_3, _().iconTierThree), h);
            ...
            function w(e) {
                ...
                if (0 === s && a === d.Eu4.NONE) return null;
                var f = function(e) {
                        e.stopPropagation();
                        e.preventDefault();
                        o && !r && (0, c.f)({
        ...
        17363: (e, t, n) => {
            ...
            const R = function(e) {
                ...
                i.useEffect((function() {
                    ie && w && f.default.track(_.rMx.OPEN_MODAL, {
        ...
        311260: (e, t, n) => {
            ...
            function s(e, t, n, r) {
                ...
                return {
                    ...
                    scaledCropWidth: s,
                    scaledCropHeight: c,
                    canvasWidth: Math.min(s, r.width),
            ...
            function f() {
                return (f = a((function(e, t, r, o, a) {
                    ...
                    return u(this, (function(u) {
                        switch (u.label) {
                            case 0:
                                c = s(t, r, o, a), f = c.x, p = c.y, d = c.scaledCropWidth, E = c.scaledCropHeight;
        ...
        338479: (e, t, n) => {
            ...
            function x(e) {
                var t = e.analyticsSection,
                    ...
                    s = w.ZP.canUseAnimatedAvatar(l),
                    c = w.ZP.canUsePremiumProfileCustomization(l),
                    f = n === L.pC.BANNER && c || n === L.pC.AVATAR && s,
            ...
            function j(e) {
                var t = e.type,
                    ...
                    o = e.isGIF,
                    a = e.banner;
                return [L.pC.BANNER, L.pC.AVATAR].includes(t) && o ? (0, r.jsx)(x, {
                    analyticsSection: i,
                    type: t
            ...
            var G = new j(s.Z, {
                POPOUT_WINDOW_OPEN: function(e) {
                    ...
                    var o = n.defaultWidth,
                        ...
                        l = void 0 !== u && u,
                        s = I(n, ["defaultWidth", "defaultHeight", "defaultAlwaysOnTop"]),
                        c = l,
                        d = T[t];
                    if (null != d) {
                        var _ = d.width,
                    ...
                    var y = window.open(E.Z5c.POPOUT_WINDOW, t, function(e) {
                        var t = "",
                            n = !0,
                            r = !1,
                            i = void 0;
            ...
            var g = function() {
                ...
                y = function() {
                    var e = (0, p.se)(),
                        ...
                        l = c.Z.getPreviousPremiumTypeSubscription();
                    i || !r || t || (0, a.ou)();
                        ...
                        if (null != z) {
                            ...
                            if ((null == J ? void 0 : J.status) !== y.O0b.ACCOUNT_HOLD) ! function(e) {
                                ...
                                if (t)
                                    if (i) {
                                        var O = y.Qqv.BUY;
                                        null != l ? O = y.Qqv.TRIAL : o && (O = y.Qqv.GIFT);
                                        (0, f.Z)({
                                            isGift: o,
                                            initialPlanId: null,
                                            subscriptionTier: a,
        ...
        223219: (e, t, n) => {
            ...
            function U(e) {
                ...
                L = null !== (n = e.section) && void 0 !== n ? n : b;
        ...
        521723: (e, t, n) => {
            ...
            }), G(w, c.Q.VERIFIED_AND_PARTNERED, {
                IconComponent: M.Z,
                foregroundDarkColor: u.Z.unsafe_rawColors.WHITE_400.css,
                foregroundLightColor: u.Z.unsafe_rawColors.WHITE_400.css,
                backgroundDarkColor: u.Z.unsafe_rawColors.GREEN_360.css,
            ...
            function F(e) {
                var t = e.guild,
                    n = e.tooltipColor,
                    i = void 0 === n ? s.Tooltip.Colors.BRAND : n,
                    o = e.tooltipPosition,
                    u = e.className,
                ...
                var A, w, L = B[N],
                    M = L.IconComponent,
                    D = L.backgroundDarkColor,
                    x = L.backgroundLightColor,
                    G = L.foregroundDarkColor,
                    H = L.foregroundLightColor,
                    F = L.premiumBackgroundColor,
                    W = L.premiumForegroundColor;
            ...
            var p = o().v4(),
                ...
                _ = function(e) {
                    ...
                    function n(e) {
                        ...
                        var s = r.getVisibilityObserverId();
                        E.has(s) || E.set(s, new a.Z({
                            root: i,
                            rootMargin: u,
                            threshold: l
                        }));

            ...
            var y = function(e) {
                ...
                o.renderProvider = function(e) {
                    var t, n, o = this.props,
                        ...
                        c = o.objectType,
                        s = o.children,
                        f = this.mergeLocation(e.location, this.getLocation(a, i, l, c)),
        ...
        7194: (e, t, n) => {
            ...
            function R(e, t) {
                var a, l = t === p.IlC.POPOUT,
                    ...
                    R = (0, b.e7)([O.Z], (function() {
                        return null != c ? O.Z.getGuildIncident(c.id) : null
                    })),
                    M = (null == c ? void 0 : c.hasFeature(p.oNc.INVITES_DISABLED)) || E && null != (null == R ? void 0 : R.invitesDisabledUntil) && new Date(R.invitesDisabledUntil) > new Date,
                    k = A(o.useState(M), 2),
                    T = k[0],
                    D = k[1],
                    Z = (a = P((function(t) {

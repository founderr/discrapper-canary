    ...
    [34757], {
                        ...
                        switch (I.label) {
                            ...
                            case 2:
                                ...
                                i.Z.dispatch({
                                    ...
                                    categoryId: f,
                                    result: {
                                        results: _.body.results,
                                        countsByCategory: _.body.counts_by_category,
                                        totalCount: _.body.result_count,
                                        totalPages: _.body.num_pages,
                                        type: _.body.type,
                                        loadId: _.body.load_id
                                    }
                                });
                                null == u || u(_.body.result_count);
                                return [3, 4];
                            case 3:
                                I.sent();
                                i.Z.dispatch({
            ...
            var E = function(t) {
                ...
                r.__getLocalVars = function() {
                    return {
                        ...
                        similarApplicationsFetchStates: _
                    }
                };
                return n
            }(i.ZP.Store);
            ...
            var y = Object.freeze({
                ...
                O = function(t) {
                    ...
                    return (0, r.jsx)(c.H, {
                        ...
                        onContextMenu: v,
                        id: n,
                        className: i()(s, (e = {}, f(e, a().base, !0), f(e, I, !0), f(e, a().selectable, h), f(e, a().muted, u), f(e, a().uppercase, S), e)),
                        title: P,
                        style: null != E ? d(p({}, T), {
                            color: E
                        }) : T,
        ...
        646161: (t, e, n) => {
            ...
            function g() {
                ...
                return null == t ? b : -1 !== t.indexOf(s) || -1 !== t.indexOf(f) || -1 !== t.indexOf(p) || -1 !== t.indexOf(d) || -1 !== t.indexOf(y) || -1 !== t.indexOf(O) ? _ : -1 !== t.indexOf(I) ? h : b
            }

            function v(t) {
                var e;
                return (l(e = {}, b, "Windows"), l(e, h, "Mac"), l(e, _, "Linux"), e)[g(t)]
            }

            function T() {
                var t = g();
                return E(t, !1, t === _ ? "tar.gz" : null)
            }

        ...
        552022: function(e, t, l) {
            ...
            var y = function(e) {
                ...
                let {
                    ...
                    onEdit: g,
                    onShare: N
                } = e, E = (0, r.useStateFromStoresArray)([v.default], () => s.users.map(e => v.default.getUser(e)).filter(I.isNotNullish)), {
        ...
        548405: function(e, t, l) {
            ...
            function v(e) {
                let {
                    ...
                    closePopout: l
                } = e, n = (0, o.default)([c.default], () => c.default.getKeybindForAction(p.GlobalKeybindActions.SAVE_CLIP)), v = (0, o.default)([f.default], () => f.default.getSettings().clipsEnabled), C = t ? h.noSearchResultsImage : h.noClipsImage, x = s.useCallback(() => {
        ...
        167573: function(e, t, l) {
            ...
            function I(e) {
                let {
                    ...
                    onClose: n,
                    transitionState: o
                } = e, [I, j] = s.useState(""), [M, T] = s.useState("descending"), [A, R] = s.useState(!0), [y, H] = s.useState(null), b = s.useDeferredValue(I), D = (0, c.useStateFromStores)([C.default], () => C.default.getClips()), P = (0, c.useStateFromStores)([C.default], () => C.default.getSettings().storageLocation), w = (0, c.useStateFromStores)([C.default], () => C.default.getState().newClipIds), {
                ...
                }).sort((e, t) => "ascending" === M ? v.default.compare(e.id, t.id) : "descending" === M ? v.default.compare(t.id, e.id) : 0).chunk(3).value(), [D, b, M]);
                s.useEffect(() => {
                    (async function e() {
                        R(!0);
                        try {

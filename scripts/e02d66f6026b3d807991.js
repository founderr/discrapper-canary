        ...
        301603: function(e, t, n) {
            ...
            function l(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : s.MediaEngineContextTypes.DEFAULT,
                    ...
                    l = (0, a.useStateFromStores)([u.default], () => u.default.supports(s.Features.DISABLE_VIDEO) && u.default.isVideoEnabled()),
        ...
        873254: function(e, t, n) {
            ...
            function f(e) {
                let t = (0, r.useModalContext)(),
                    ...
                    c = (0, i.useStateFromStores)([o.default], () => o.default.getId() === e),
                    E = (0, u.default)();
            ...
            var a = n("37983"),
                ...
                p = e => {
                    let {
                        ...
                        guildId: p,
                        onShow: T
                    } = e, I = i.useRef(!1), m = i.useRef(0), v = (0, o.useStateFromStores)([N.default], () => N.default.getGuild(null != p ? p : r.guild_id)), {
                        hasMoreAfter: h,
                        scrollDown: g,
                        ...
                        placeholderCount: S.CONTEXT_MENU_PLACEHOLDER_COUNT,
                    ...
                    }, [M, R, y]), O = i.useMemo(() => (0, f.canUseContextMenuCommands)(r, F.length, l.getCommandTypeCount(r, t, null == v ? void 0 : v.applicationCommandCounts)), [r, t, F.length, null == v ? void 0 : v.applicationCommandCounts]);
                    i.useEffect(() => {
                        O !== I.current && (O && (null == T || T()), I.current = O)
                    }, [O, T]), i.useEffect(() => {
                        U(m.current)
                    }, [F]);
                    let U = i.useCallback(e => {
                            h && e + 500 > 34 * F.length - 40 && g(), m.current = e
                        }, [h, g, F]),
                        L = i.useCallback(e => {
                            if (e.inputType === d.ApplicationCommandInputType.PLACEHOLDER) return (0, a.jsx)(s.MenuItem, {

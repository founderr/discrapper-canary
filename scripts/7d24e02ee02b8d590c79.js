        ...
        728118: (e, t, r) => {
            ...
            function Be(e) {
                ...
                return (t = u.id, r = f.author.id, o = (0, c.e7)([I.ZP], (function() {
                    var e;
                    return (0, Pe.yE)(null !== (i = null === (e = I.ZP.getMember(t, r)) || void 0 === e ? void 0 : e.flags) && void 0 !== i ? i : 0, Ce.q.DID_REJOIN)
            ...
            function At(e) {
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [(0, n.jsx)("img", {
                        ...
                        src: r,
                        "aria-hidden": !0,
                        className: l()(m, Ct().avatar, (t = {}, Nt(t, Ct().compact, o), Nt(t, Ct().clickable, null != a), Nt(t, Ct().communicationDisabledOpacity, p), t)),
                        alt: " "
            ...
            function Mt(e) {
                var t, r = e.props,
                    ...
                    T = _.id,
                    I = _;
                _.isClyde() && null != o && null != (null == p ? void 0 : p.guildMemberAvatar) && (I = _.addGuildAvatarHash(o, p.guildMemberAvatar));
                var A = (0, yt.Z)({
                        user: I,
                        guildId: o,
                        size: y ? 32 : 80,
                    ...
                    L = A.avatarSrc,
                    M = A.avatarDecorationSrc,
                    D = A.eventHandlers;
                i.useEffect((function() {
                    if (null != g) {
                        xt.S.subscribeKeyed($.LPv.ANIMATE_CHAT_AVATAR, "".concat(g, ":").concat(T), C);
                        return function() {
                            xt.S.unsubscribeKeyed($.LPv.ANIMATE_CHAT_AVATAR, "".concat(g, ":").concat(T), C)
                        }
                    }
                }), [T, g]);
                if (!y || S) return null != l && null != w ? (0, n.jsx)(s.Popout, {
            ...
            function Rt(e) {
                var t, r, o, a = e.message,
                    ...
                    E = It((0, he.ZP)(a.author.id, e.guildId), 2)[1],
                    P = (0, c.e7)([we.Z], (function() {
                        return we.Z.getGuild(e.guildId)
                    }), [e.guildId]),
                    C = (0, u.y)(null !== (t = null == P ? void 0 : P.id) && void 0 !== t ? t : "", !1),
                    S = null != a.author && null != P && Ot.Z.canManageUser($.Plq.MODERATE_MEMBERS, a.author, P),
                    N = E && S,
                    _ = Mt({
                        props: e,
                        guildId: e.guildId,
                ...
                return (0,
                    ...
                    usernameClassName: l()(Ct().headerText, (D = {}, Nt(D, Ct().hasRoleIcon, null != I), Nt(D, Ct().hasBadges, null != o || L.length > 0), D)),
                    compact: p,
                    showTimestamp: G,

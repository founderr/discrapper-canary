(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["29734"], {
            ...
            var l = n("884691"),
                ...
                c = (e, t) => {
                    let n = (0, a.useStateFromStores)([r.default], () => r.default.getGuild(e), [e]),
                        ...
                        d = (0, a.useStateFromStores)([i.default], () => i.default.getChannels(e)[i.GUILD_VOCAL_CHANNELS_KEY], [e]),
        ...
        676143: function(e, t, n) {
            ...
            function A(e, t, n, a) {
                a = a.toLowerCase();
                let i = (0, h.useCanSeeOnboardingHome)(e),
                    r = l.useCallback((e, t) => !(i && e.channel.hasFlag(I.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) && e.channel.type !== E.ChannelTypes.GUILD_DIRECTORY && (0 === t.length || s(t, e.channel.name.toLowerCase()) || e.channel.topic.toLowerCase().includes(t)), [i]);
                return l.useMemo(() => {
                    let e = {
                        null: [],
                        _categories: []
            ...
            function L(e) {
                ...
                if (t[m.SECTION_INDEX_COMMUNITY] > 0) {
                    ...
                    switch (t) {
                        case S.ChannelListCommunityRow.GUILD_HOME:
                            return I.StaticChannelRoute.GUILD_HOME;
                        case S.ChannelListCommunityRow.GUILD_ROLE_SUBSCRIPTIONS:
                            return I.StaticChannelRoute.ROLE_SUBSCRIPTIONS;
                        case S.ChannelListCommunityRow.GUILD_MEMBER_APPLICATIONS:
            ...
            function U(e, t) {
                ...
                (0, g.bulkClearRecents)(e, t), (0, d.bulkAck)(t.map(e => ({
                    channelId: e,
                    readStateType: R.ReadStateTypes.CHANNEL,
                    messageId: _.default.lastMessageId(e)
                }))), null != n && (0, v.transitionTo)(E.Routes.CHANNEL(e, n))
            }

            function w(e, t, n, l) {
                let a = (0, C.useIsDismissibleContentDismissed)(c.DismissibleContent.CHANNEL_BROWSER_NUX),
                    s = (0, o.useStateFromStoresObject)([N.default], () => {
                        let t = {},
            ...
            function x(e) {
                var t, n;
                let l = (0, o.useStateFromStores)([p.default], () => p.default.getCategories(e)),
            ...
            class c extends a.PureComponent {
                ...
                defaultRender(e) {
                    let {
                        ...
                        showUnits: n,
                        className: a
                    } = this.props, s = [e.days, e.hours, e.minutes, e.seconds], r = o();
                    if (0 === e.days) s.shift();
                    else if (!t) {
                        let e = s.shift();
                        s[0] += 24 * e
                    }
                    let u = i(s).map(e => e < 10 ? "0".concat(e) : e).map((e, t) => [t > 0 && !n ? ":" : " ", (0, l.jsxs)("span", {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [90469, 84237], {
                    ...
                    function e() {
                        ...
                        this._handleNativeUpdateNotAvailable = function() {
                            ...
                            Pn.ZP.get({
                                ...
                                if (null == e.body || "58188da049ee5d7b0aae19dbe5b2c36dd496eeda" === e.body.hash) return n._handleUpdateNotAvailable();
        ...
        623183: (e, t, n) => {
            ...
            var vt, gt = (st(bt = {}, me.kVF.LOCALIZED_PRICING, l.z$.NAGBAR_NOTICE_LOCALIZED_PRICING), st(bt, me.kVF.DOWNLOAD_NAG, l.z$.NAGBAR_NOTICE_DOWNLOAD), st(bt, me.kVF.CONNECT_SPOTIFY, l.z$.NAGBAR_NOTICE_CONNECT_SPOTIFY),
                    st(bt, me.kVF.CONNECT_PLAYSTATION, l.z$.NAGBAR_NOTICE_CONNECT_PLAYSTATION), st(bt, me.kVF.MFA_SMS_BACKUP, l.z$.NAGBAR_NOTICE_MFA_SMS_BACKUP), st(bt, me.kVF.PREMIUM_TIER_2_TRIAL_ENDING, l.z$.NAGBAR_NOTICE_PREMIUM_TIER_TWO_TRIAL_ENDING), st(bt, me.kVF.PREMIUM_REACTIVATE, l.z$.NAGBAR_NOTICE_PREMIUM_REACTIVATE), st(bt, me.kVF.DROPS_GO_LIVE_BANNER, l.z$.QUEST_2_GO_LIVE_BANNER), st(bt, me.kVF.DROPS_ENDED_INCOMPLETE, l.z$.QUEST_2_ENDED_INCOMPLETE), st(bt, me.kVF.BOUNCED_EMAIL_DETECTED, l.z$.NAGBAR_BOUNCED_EMAIL_NOTICE), st(bt, me.kVF.ACTIVATE_SERVER_SUBSCRIPTION, l.z$.NAGBAR_ACTIVATE_SERVER_SUBSCRIPTION), st(bt, me.kVF.PREMIUM_TIER_0_TRIAL_ENDING, l.z$.NAGBAR_NOTICE_PREMIUM_TIER_0_TRIAL_ENDING), st(bt, me.kVF.GUILD_ONBOARDING_UPSELL_NAGBAR, l.z$.GUILD_ONBOARDING_UPSELL_NAGBAR), st(bt, me.kVF.POMELO_ELIGIBLE, l.z$.NAGBAR_NOTICE_POMELO), bt),
                mt = (st(vt = {}, me.kVF.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, "hideDetectedOffPlatformPremiumPerkUpsell"), st(vt, me.kVF.PREMIUM_UNCANCEL, "hideUncancelReminder"),
                    st(vt, me.kVF.PREMIUM_MISSING_PAYMENT, "hideMissingPaymentReminder"), st(vt, me.kVF.PREMIUM_PAST_DUE_MISSING_PAYMENT, "hidePastDueMissingPaymentReminder"), st(vt, me.kVF.PREMIUM_PAST_DUE_INVALID_PAYMENT, "hidePastDueInvalidPaymentReminder"), st(vt, me.kVF.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, "hidePastDueOneTimePaymentReminder"), st(vt, me.kVF.AUTO_MODERATION_MENTION_RAID_DETECTION, "hideAutoModerationMentionRaidDetectionNotice"), st(vt, me.kVF.GUILD_RAID_NOTIFICATION, "hideGuildRaidDetectionNotice"), st(vt, me.kVF.SERVER_USAGE_SURVEY, "hideServerUsageSurvey"), st(vt, me.kVF.WIN32_DEPRECATED_MESSAGE, "hideWin32DeprecationMessageNotice"), st(vt, me.kVF.PREMIUM_TIER_2_TRIAL_ENDING, "hidePremiumTier2TrialOfferEndingNotice"), vt),

    ...
    ["44526"], {
            ...
            var l = n("884691"),
                ...
                c = (e, t) => {
                    let n = (0, r.useStateFromStores)([a.default], () => a.default.getGuild(e), [e]),
                        ...
                        d = (0, r.useStateFromStores)([i.default], () => i.default.getChannels(e)[i.GUILD_VOCAL_CHANNELS_KEY], [e]),
        ...
        242757: function(e, t, n) {
            ...
            function r(e, t, n, r) {
                ...
                return i || null != t && null != t.vanityURLCode || (null == r ? void 0 : r.invite_code) != null
            }
        },
        676143: function(e, t, n) {
            ...
            function S(e, t, n, r) {
                ...
                let i = (0, C.useCanSeeOnboardingHome)(e),
                    a = l.useCallback((e, t) => !(i && e.channel.hasFlag(M.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL)) && e.channel.type !== I.ChannelTypes.GUILD_DIRECTORY && (0 === t.length || s(t, e.channel.name.toLowerCase()) || e.channel.topic.toLowerCase().includes(t)), [i]);
                return l.useMemo(() => {
                    let e = {
                        null: [],
                        _categories: []
                    ...
                    }), e._categories = t._categories.filter(t => "null" === t.channel.id || 0 === r.length || e[t.channel.id].length > 0), (0, f.default)(e._categories, e).forEach(w), e
                }, [t, n, a, r])
            }
            ...
            function A(e) {
                ...
                let i = null !== (n = null === (t = s.channel) || void 0 === t ? void 0 : t.id) && void 0 !== n ? n : "null",
                    a = l[i];
                return null == a ? 0 : 0 === a.length ? s.index + 2 - r : a[a.length - 1].index + 2 - r
            }

            function L(e) {
                var t;
                return E.default.Messages.CHANNEL_BROWSER_ACTIVE_TEXT.format({
        ...
        194704: function(e, t, n) {
            ...
            async function u(e, t) {
                await (0, s.updateUserGuildSettings)(e, e => (e.guildRecentsDismissedAt = l.Timestamp.fromDate(new Date), !0), s.UserSettingsDelay.INFREQUENT_USER_ACTION), r.default.dispatch({
                    type: "BULK_CLEAR_RECENTS",
                    guildId: e,
                    channelIds: t
                }), i.default.track(a.AnalyticEvents.CHANNEL_LIST_UPDATED, {
            ...
            class c extends r.PureComponent {
                ...
                defaultRender(e) {
                    let {
                        ...
                        showUnits: n,
                        className: r
                    } = this.props, s = [e.days, e.hours, e.minutes, e.seconds], a = o();
                    if (0 === e.days) s.shift();
                    else if (!t) {
                        let e = s.shift();
                        s[0] += 24 * e
                ...
                render() {
                    ...
                    let s = (0, a.diffAsUnits)(Date.now(), e, r);

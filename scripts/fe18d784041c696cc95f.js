            ...
            var m = function(e) {
                ...
                o.renderVoiceCallAvatar = function() {
                    var e = this.props,
                        ...
                        O = e.size,
                        y = e.renderIcon,
                        d = (0, u.getAvatarSize)(O),
                        h = (0, n.jsx)("img", {
                            src: r,
                            alt: " ",
                            className: c()(p().voiceAvatar, l, b({}, p().ringingOutgoing, o && i === g.OUTGOING))
                        });
                    if (t) return h;
                    var j = s.QS.AVATAR_DEFAULT;
                    null != y ? j = O === u.AvatarSizes.SIZE_32 ? s.QS.AVATAR_CALL_ICON_32 : s.QS.AVATAR_CALL_ICON : (a || f) && (j = s.QS.AVATAR_VOICE_CALL_80);
                    return (0, n.jsxs)("div", {
                ...
                o.render = function() {
                    var e, r = this.props,
                        ...
                        s = r.ringingType,
                        f = r.ringing,
                        O = c()(p().wrapper, (b(e = {}, p().clickable, null != o), b(e, p().ringingOutgoing, f && s === g.OUTGOING), b(e, p().ringingIncoming, f && s === g.INCOMING), e), a),
                        y = (0, u.getAvatarSize)(t),
                        d = function(e) {
                            for (var r = 1; r < arguments.length; r++) {
                                var t = null != arguments[r] ? arguments[r] : {},
                                    n = Object.keys(t);
...
//# sourceMappingURL=fe18d784041c696cc95f.js.map
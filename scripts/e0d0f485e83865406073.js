(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [95641, 73385, 95331, 57678, 58621, 96043, 71402], {
        737264: e => {
            "use strict";
        ...
        14636: (e, t, n) => {
            ...
            e.exports = function(e, t) {
                var n = o(e),
                    ...
                    E = d.length;
                for (var h in e) !t && !c.call(e, h) || p && ("length" == h || f && ("offset" == h || "parent" == h) || _ && ("buffer" == h || "byteLength" == h || "byteOffset" == h) || u(h, E)) || d.push(h);
                return d
            }
        },
        70151: (e, t, n) => {
            ...
            var n = function() {
                ...
                return {
                    quantize: function(a, u) {
                        ...
                        f(s, .75 * u);
                        for (var _ = new n((function(e, n) {
                                return t.naturalOrder(e.count() * e.volume(), n.count() * n.volume())
                            })); s.size();) _.push(s.pop());
                        f(_, u - _.size());
                        for (var p = new i; _.size();) p.push(_.pop());
                        return p
                    }
                }
            }();
        ...
        247250: (e, t, n) => {
            ...
            const s = {
                ...
                updateLayout: function(e, t) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u.IlC.APP;
                    o.default.track(u.rMx.VIDEO_LAYOUT_TOGGLED, c({
                        video_layout: t
                    }, (0, i.AB)(e)));
                    r.Z.dispatch({
                ...
                updateChatOpen: function(e, t) {
                    ...
                    }), 0) : a.S.dispatch(u.CkL.FOCUS_CHAT_BUTTON)
                }
            }
        },
        971402: (e, t, n) => {
        ...
        625091: (e, t, n) => {
            ...
            function N(e) {
                ...
                var C, M = P((0, T.ZP)(N.content), 2),
                    U = M[0],
                    w = M[1];
                if (U) {
                    N.content = w;
                    var D;
                    N.flags = (0, v.pj)(null !== (D = N.flags) && void 0 !== D ? D : 0, y.iLy.SUPPRESS_NOTIFICATIONS)
                }
                var j, G, x = null !== (C = S.nonce) && void 0 !== C ? C : (0, E.rv)(),
                    k = (0,
                        E.ZP)({
                        channelId: t,
                        content: N.content,
                ...
                A.on("error", (function(e, s, f, _) {
                    ...
                    if (s !== y.evJ.EXPLICIT_CONTENT)
                        if (s !== y.evJ.AUTOMOD_MESSAGE_BLOCKED) {
                            if (s !== y.evJ.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS) {
                                (0, l.openUploadError)({
                                    title: b.Z.Messages.UPLOAD_AREA_UPLOAD_FAILED_TITLE,
                                    help: b.Z.Messages.UPLOAD_AREA_UPLOAD_FAILED_RETRY_HELP
                                });
                                ! function() {
            ...
            const C = {
                ...
                upload: function e(t) {
                    ...
                    if (null != s) {
                        ...
                        var p = I.Z.getPendingReply(n);
                        if (null != p) {
                            var d = a.Z.getSendMessageOptionsForReply(p);
                            f.type = y.uaV.REPLY;
                            f.message_reference = d.messageReference;
                            f.allowed_mentions = d.allowedMentions;
                            (0, O.A6)(n)
                        }
                    }
                    var E = new _.Z(y.ANM.MESSAGES(n));
                    ...
                    E.on("error", (function(t, _) {
                        ...
                        if (_ !== y.evJ.EXPLICIT_CONTENT) {
                            (0, l.openUploadError)({
                                title: b.Z.Messages.UPLOAD_AREA_UPLOAD_FAILED_TITLE,
                                help: b.Z.Messages.UPLOAD_AREA_UPLOAD_FAILED_HELP.format({
                                    onClick: function() {
        ...
        444663: (e, t, n) => {
            ...
            function A(e) {
                var t, n = e.onClose,
                    ...
                    R = !l && L === I.p9.TIER_0,
                    P = (0, c.e7)([_.default], (function() {
                        return _.default.getCurrentUser()
                    })),
                    N = (0, r.jsx)(f.Z, {
                        icons: m.J6
                    });
                t = R ? g.Z.Messages.UPLOAD_AREA_PREMIUM_TIER_UPSELL_BODY_LINE_2.format({
                    premiumPlan: (0, d.Px)(I.p9.TIER_0),
                ...
                var C = i.useMemo((function() {
                        var e = d.ZP.getUserMaxFileSize(P),
                            t = (0, p.BU)(e / 1024, {
                                useKibibytes: !0
                            }),
                ...
                return (0, r.jsx)(O.Z, function(e) {
                    ...
                    artElement: N,
                    artContainerClassName: a()(y().artContainer),
        ...
        101566: (e, t, n) => {
            ...
            var A = new p.Z("UploaderBase.tsx"),
                L = function(e) {
                    ! function(e, t) {
                        if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
                        e.prototype = Object.create(t && t.prototype, {
            ...
            var H = function(e, t) {
                ...
                Y = function(e) {
                    ...
                    r.compressAndCheckFileSize = function() {
                        var e = this;
                        return M((function() {
                            var t, n, r, i, o, l, c, s, f, _, p, E, h;
                            return H(this, (function(O) {
                                switch (O.label) {
                                    case 0:
                                        r = (0, u.F)(null === (t = e.files[0]) || void 0 === t || null === (n = t.item) || void 0 === n ? void 0 : n.target);
                                    ...
                                    case 4:
                                        ...
                                        if (0 === (null !== (_ = f.currentSize) && void 0 !== _ ? _ : 0)) {
                                            e._handleError({
                    ...
                    r.setUploadingTextForUI = function() {
                        var e = 1 === this.files.length && null != this.files[0].filename ? this.files[0].filename : P.Z.Messages.UPLOADING_FILES.format({
                ...
                v = function(e) {
                    ...
                    c.uploadFiles = function(e, t) {
                        var r = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).addFilesTo,
                            ...
                            a = this,
                            u = function() {
                                return p(d(n.prototype), "upload", i)
                            };
                        return s((function() {
                            var n, i, c;
                                ...
                                switch (O.label) {
                                    case 0:
                                        ...
                                        o.files.forEach((function(e, t) {
                                            var n = (0, u.B)(e, t);
                                            e.item.platform === a.ow.WEB && l.push(E({}, n))
                                        }));
                                        c = null != n && null != t ? o._addAttachmentsToPayload(t, n, l) : h(E({}, t), {
                                            attachments: l
                                        });
                                        s = {
                                            url: o._url,
                                    ...
                                    case 2:
                                        _ = O.sent();
                                        o._handleComplete(_.body);
                                        return [2, _.body];
                                    case 3:
                                        p = O.sent();
                                        if (o._raiseEndpointErrors) throw new i.Hx(p);
                                        o._handleError({
                                            code: null == p || null === (d = p.body) || void 0 === d ? void 0 : d.code,
            ...
            function w(e) {
                ...
                if (!m.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== y.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = U(a, i),
                        c = A({}, t, R(u), null != i && null != o && (0, b.AB)(o) ? P(0, o) : C(a));
                    m.default.track(e, c, {
                        flush: n
                    })
                }
        ...
        159895: (e, t, n) => {
            ...
            function m(e) {
                var t;
                return h(t = {}, I, e.non_subscriber), h(t, _.Si.TIER_0, e[_.Si.TIER_0]), h(t, _.Si.TIER_2, e[_.Si.TIER_2]), t
            }
            ...
            function g(e) {
                ...
                y(l.default.getCurrentUser(), i, n, r)
            }
            ...
            function _(e) {
                ...
                if (O)
                    ...
                    if (m) {
                        ...
                        }(y, (0, a.aS)(s.Xh.PREMIUM_MONTH_TIER_0).amount, (0, a.aS)(s.Xh.PREMIUM_MONTH_TIER_2).amount)
                    } else g && (L = function(e) {
        ...
        442212: (e, t, n) => {
            ...
            function b(e) {
                ...
                var ee, te = F ? a()(m().artContainer, m().artContainerBoxShadow, N) : a()(m().artContainer, N),
                    ne = null;
                ...
                return (0, r.jsxs)(u.ModalRoot, {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            children: [null != j ? (0, r.jsx)(u.Button, {
        ...
        491260: (e, t, n) => {
            ...
            function w(e) {
                ...
                delete R[e];
                if (null != S[e]) {
                    var t = T(a().sortBy(S[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
            ...
            var O = function(e) {
                ...
                I = function(e) {
                    var t = e.text,
                        ...
                        h = void 0 !== E && E,
                        O = e.style,
                        I = _(e, ["text", "className", "color", "shape", "disableColor", "style"]);
                    return (0, r.jsx)("div", f(s({
                ...
                g = function(e) {
                    var t = e.className,
                        ...
                        d = void 0 !== f && f,
                        E = e.style,
                        h = _(e, ["className", "color", "shape", "disableColor", "style"]);
        ...
        15084: (e, t, n) => {
            ...
            function m(e, t) {
                var n = f.default.getCurrentUser(),
                    ...
                    v = void 0;
                try {
                    for (var y, b = t[Symbol.iterator](); !(m = (y = b.next()).done); m = !0) {
                        var S = y.value;
                        s += 1;
                        u += S.size;
                        o.push(S.size);
                        S.size > c && (c = S.size);
                        null != S.type ? _.push(S.type) : _.push("unknown")
                    }
                } catch (e) {
                    g = !0;
                    v = e
                ...
                if (c > i) {
                    (0, l.yw)(h.rMx.FILE_SIZE_LIMIT_EXCEEDED, {
                        channel_id: e.id,
                        guild_id: r,
...
//# sourceMappingURL=e0d0f485e83865406073.js.map
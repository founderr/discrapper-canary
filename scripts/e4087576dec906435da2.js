        ...
        649844: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    giftRecipient: U,
                    returnRef: F
                } = null != e ? e : {}, x = !1, b = (0, r.v4)(), H = o.default.getCurrentUser(), w = (0, f.isPremiumExactly)(H, h.PremiumTypes.TIER_2);
                (0, u.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: E,
                            onClose: (e, t) => {
                                r(), null == p || p(e), e && (null == m || m(), !v && null != t && t === h.PremiumSubscriptionSKUs.TIER_2 && !w && d.ComponentDispatch.dispatch(C.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                x = !0, null == _ || _(), !v && (0, s.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: m,
                            analyticsLocations: T,
                            analyticsObject: S,
                    ...
                    onCloseCallback: () => {
                        !x && c.default.track(C.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: b,
                            ...
                            application_id: P,
                            location_stack: T
                        }), (0, a.clearError)(), (0, l.clearPurchaseTokenAuthState)(), null == p || p(x), x && (null == m || m())
                    },

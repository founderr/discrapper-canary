(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [2458], {
        ...
        102458: (e, t, n) => {
            ...
            var B = F.ZP.getEnableHardwareAcceleration() ? a.AnimatedAvatar : a.Avatar;
            const W = function(e) {
                var t = e.user,
            ...
            var G = n(675960),
                ...
                X = function(e) {
                    var t = e.purchase,
                        n = (0, o.e7)([T.default], (function() {
                            return T.default.locale
                        })),
                        i = (0, l.qS)(t);
                    return (0, r.jsxs)("div", {
                        className: q().purchaseInfo,
                        children: [(0, r.jsx)(a.Text, {
                            ...
                            color: "text-muted",
                            children: i ? V.Z.Messages.CHANGE_DECORATION_MODAL_STARTER_DESC : V.Z.Messages.COLLECTIBLES_ACQUIRED_DATE.format({
            ...
            const Q = function(e) {
                var t = e.user,
                    n = e.pendingAvatarDecoration,
                    i = e.className,
                    u = (0, o.e7)([H.Z], (function() {
                        return H.Z.getStatus(t.id)
                    })),
                ...
                return null == f || null != d && !m ? (0, r.jsxs)("div", {
                    className: M()(q().modalPreview, i),
                    children: [(0, r.jsxs)("div", {
                        className: q().previewSections,
                        children: [(0, r.jsx)("div", {
                            className: q().decorationPreview,
                            children: (0, r.jsx)(W, {
                                user: t,
                                pendingAvatarDecoration: n
                            })
                        }), (0, r.jsx)("div", {
                            className: q().smallDecorationPreviewsContainer,
                            children: Y.map((function(e) {
                                var i = e.avatarSize,
                                    o = e.showStatus;
                                return (0,
                                    r.jsx)("div", {
                                    className: q().smallDecorationPreview,
                                    children: (0, r.jsx)(W, {
                                        user: t,
                                        avatarSize: i,
                                        pendingAvatarDecoration: n,
                    ...
                    className: M()(q().modalPreview, q().shopPreviewContainer, i),
                    children: [(0, r.jsx)(K, {
                        category: s,
                        children: (0, r.jsx)(W, {
                            user: t,
                        ...
                        className: q().shopPreviewTextContainer,
                        children: [(0, r.jsx)(a.Text, {
                            variant: "text-sm/semibold",
                            children: f.name
                        }), (0, r.jsx)(a.Text, {
                            variant: "text-sm/normal",
                            children: m ? V.Z.Messages.CHANGE_DECORATION_MODAL_PREVIEW_STARTER_CHURNED : (0, g.EQ)([v, p]).with([!0, !0], (function() {
            ...
            const he = function() {
                ...
                return (0, i.useMemo)((function() {
                    var e, r = (0, l.IM)(o).reduce((function(e, r) {
                        ...
                        e[$.PREVIEW].push(r);
                        return e
                    }), (ce(e = {}, $.PURCHASE, []), ce(e, $.PREMIUM_PURCHASE, []), ce(e, $.PREVIEW, []), e));
                    return [{
                        section: $.PURCHASE,
                        items: r[$.PURCHASE].length > 0 ? [de, pe].concat(le(r[$.PURCHASE])) : r[$.PURCHASE],
                        height: 12,
            ...
            var xe = function() {
                ...
                Ee = function(e) {
                    var t = e.children,
                        ...
                        o = e.isSelected,
                        u = void 0 !== o && o,
                        c = we(e, ["children", "className", "onSelect", "isSelected"]);
                    return (0, r.jsx)(a.Clickable, be(ge({
                        className: M()(ye().decorationGridItem, u ? ye().selected : void 0, n)
                    }, c), {
                        onClick: i,
                        children: t
                    }))
                ...
                Ae = function(e) {
                    ...
                    return (0, r.jsxs)(Ee, be(ge({
                        className: p ? ye().decorationGridItemChurned : void 0,
                        innerRef: null != o ? o : h
                    }, u), {
                        children: [(0, r.jsx)("img", {
                            className: ye().presetDecorationImg,
                            src: y,
                            alt: n.label
                        }), (a === $.PREVIEW || a === $.PREMIUM_PURCHASE && !s) && (0, r.jsx)(ae.G2, {
                            icon: c ? te.Z : re.Z,
                            color: J.Z.BACKGROUND_ACCENT,
                            className: ye().itemBadge
                        })]
                    }))
                };
            const Ce = function(e) {
                ...
                return (0, r.jsx)(a.MasonryList, {
                    ...
                    renderItem: function(e, s, l, f) {
                        var d = c[e],
                            p = d.section,
                            h = d.items;
                        return (0, g.EQ)(h[s]).with(de, (function() {
                            return (0, r.jsxs)(Ee, {
                                style: ge({}, l),
                                isSelected: null === n,
                                onSelect: function() {
                            ...
                            return (0, r.jsxs)(Ee, {
                                ...
                                children: [(0, r.jsx)(ie.Z, {
                                    ...
                                    foreground: ye().shopSparkleBig
                                }), (0, r.jsx)(oe.Z, {
                                    foreground: ye().shopSparkleSmall
                                }), (0, r.jsx)(a.Text, {
                                    variant: "text-xs/normal",
                                    color: "header-primary",
                    ...
                    renderSection: function(e) {
                        ...
                        return (0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(a.HeadingLevel, {
                                ...
                                children: n === $.PREVIEW && (0, r.jsx)(a.Heading, {
                                    variant: "text-sm/normal",
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0,
                        ...
                        children: [null != w && (!(0, l.qS)(w) || x) || null === v ? (0, r.jsx)(a.Button, {
                            ...
                            buttonText: j.ZP.isPremium(t) ? V.Z.Messages.USER_SETTINGS_CUSTOMIZATION_UPGRADE_UPSELL : V.Z.Messages.USER_SETTINGS_CUSTOMIZATION_UPSELL
                        }), (0, r.jsx)(a.Button, {

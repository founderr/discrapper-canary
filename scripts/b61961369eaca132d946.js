(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [19493], {
                ...
                y = function() {
                    ...
                    t.loadComplete = function(e) {
                        var t, n, r, a, c, s, f, d, p, h, _, E = this,
                            ...
                            R = null;
                        return R = (R = (y || O) && null == T && this.ready ? this.merge(S, y, !0) : this.reset(S)).mutate({
                            ready: !0,
                            loadingMore: !1,
                            ...
                            hasMoreAfter: null == T && y ? R.hasMoreAfter : b,
                            cached: A,
        ...
        769915: (e, t, n) => {
            ...
            var D = function(e) {
                    return e.type === L.EDIT
                },
                U = function(e) {
                    return function(e) {
                        return e.type === L.SEND
            ...
            const F = new(function(e) {
                ...
                r.handleSend = function(e, t) {
                    ...
                    if (s.ZP.get("send_fail_100")) {
                        ...
                        var h;
                        null != M && (M.isInstanceUILocked() ? h = {
                            location: w.OVERLAY_LOCKED_ACTIVATED
                        } : M.isInstanceUILocked() || (h = M.isPinned(m.Odu.TEXT) ? {
        ...
        861323: (e, t, n) => {
            ...
            var r, o, i, u, a, l, c = n(608575),
                ...
                w = U("discordapp.com"),
                L = U("discord.com"),
                M = [p.Z.escape(null !== (o = S.host) && void 0 !== o ? o : ""), p.Z.escape(null !== (i = R.host) && void 0 !== i ? i : ""), p.Z.escape(null !== (u = C.host) && void 0 !== u ? u : ""), p.Z.escape(null !== (a = w.host) && void 0 !== a ? a : ""), p.Z.escape(null !== (l = L.host) && void 0 !== l ? l : "")].filter(Boolean),
                D = new RegExp("((https?://[^ ]*)|^|[^/][^/.])(".concat(M.join("|"), ")"), "g");
            ...
            function F(e) {
                var t, n, r, o;
                return null !== (o = null !== (r = null !== (n = null !== (t = j(C, e)) && void 0 !== t ? t : j(N, e)) && void 0 !== n ? n : j(P, e)) && void 0 !== r ? r : j(w, e)) && void 0 !== o ? o : j(L, e)
            }
                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, y, M, U, F = j(S, p),
                                G = j(R, p),
                                V = null !== (U = null !== (M = null !== (y = null !== (E = j(C, p)) && void 0 !== E ? E : j(N, p)) && void 0 !== y ? y : j(P, p)) && void 0 !== M ? M : j(w, p)) && void 0 !== U ? U : j(L, p),
                                k = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
                            ...
                            0;
                            if (null != (null == F ? void 0 : F.match(v))) {
                                var x = (0, f.mb)(F.substring(1), p.search);
                                d.Z.getInvite(x);
                                k(_.g.INVITE, x)
                            }
                            null != (null == G ? void 0 : G.match(v)) && k(_.g.TEMPLATE, G.substring(1));
                            var Y = null == V ? void 0 : V.match(g);
                            if (null != Y) {
                ...
                EVENT_DIRECTORY_FETCH_SUCCESS: function(e) {
                    ...
                    try {
                        for (var a, l = n[Symbol.iterator](); !(r = (a = l.next()).done); r = !0) {
                            var c = a.value;
                            S(c);
                            null != c.user_rsvp ? M(c.id, c.guild_id) : D(c.id, c.guild_id)
                        }
                    } catch (e) {
                        i = !0;
                        u = e
        ...
        649536: (e, t, n) => {
            ...
            function M(e) {
                var t, n, r, i, a, l, c, s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    M = e.type === R.uaV.PREMIUM_REFERRAL ? e.content : void 0,
                    D = e.content;
        ...
        513586: (e, t, n) => {
            ...
            var r = n(179936),
                ...
                O = new RegExp("(".concat(location.protocol).concat(v, "|").concat(location.protocol).concat(_, ")(").concat(y, ")"), "ig"),
                T = new RegExp("".concat(location.protocol).concat(h, "(").concat(y, ")"), "ig"),
                I = function(e) {
                ...
                R = function(e) {
                    ...
                    if ("development" !== E) {
                        ...
                        var c = e.format_type === s.u3.APNG && r && !(0,
                                l.Dt)() ? "&passthrough=false" : "",
                            p = Math.min(2, (0, o.x_)());
                    ...
                    o().forEach(V, (function(e, o) {
                        ...
                        try {
                            for (var f, d = function() {
                                    ...
                                    a = n = !0;
                                    var l = u().v4();
                                    r = new b(L(w({}, t.getWidgetDefaultSettings(e)), {
                                        type: e,
                                        id: l,
                                        layoutId: o,
                                        zIndex: i.length
            ...
            q.migrations = [function() {
                ...
                i.forEach((function(e) {
                    ...
                    if (!i && null != a) {
                        var l = u().v4();
                        r.widgets = [a, l];
                        o.push([l, L(w({}, K(S.Odu.GUILDS_TEXT)), {
            ...
            const Q = new q(c.Z, {
                ...
                LAYOUT_SET_PINNED: function(e) {
                    return z(e.widgetId, (function(e, t) {
                        ! function(e) {
                            k = L(w({}, k), N({}, e.id, e.set("pinned", !e.pinned)))
                        }(e)
                    }))
                },
                ...
                LAYOUT_CREATE_WIDGETS: function(e) {
                    e.widgetConfigs.forEach((function(e) {
                        ...
                        V = L(w({}, V), N({}, n.id, n.set("widgets", r)))
                    }))
                }
            })
        },
        352980: (e, t, n) => {
            ...
            var K = function(e) {
                ...
                r.initialize = function() {
                    this.waitFor(N.default, y.Z, O.Z, I.ZP, v.default, R.Z, C.Z, b.Z, S.Z, T.ZP);
            ...
            var q = function(e) {
                ...
                r.initialize = function(e) {
                    ...
                    if (null != e) {
                        ...
                        if (null != t) {
                            null == (x = k(t)).textChatNotifications && (x.textChatNotifications = L.textChatNotifications);
                            null == x.textWidgetOpacity && (x.textWidgetOpacity = L.textWidgetOpacity)
                        }
                    }
                };
                r.getState = function() {
                ...
                r.getTextChatNotificationMode = function() {
                    return x.notificationPositionMode === g._vf.DISABLED ? g.Ypu.DISABLED : x.textChatNotifications
                };
        ...
        644144: (e, t, n) => {
            ...
            var b = function(e, t) {
                ...
                L = [w(4, 4), w(4, 6), w(5, 3), "[a-zA-Z]{4}-?[0-9a-zA-Z]{4}-?[a-zA-Z]{4}"].join("|"),
            ...
            function Q(e) {
                var t = e.trim().split("/").pop().match(M);
                if (null == t) return null;
                var n = O(t, 3),
                    r = (n[0], n[1], n[2]);
        ...
        534681: (e, t, n) => {
            ...
            function N(e, t) {
                ...
                return S({
                    pathname: null != u && null != a ? y.Z5c.CHANNEL(a, u, e) : y.Z5c.APPLICATION_STORE_LISTING_SKU(e, i)
                }, l)
            }
            ...
            function P(e, t) {
                ...
                return S({
                    pathname: y.Z5c.APPLICATION_STORE_LISTING_APPLICATION(e, o)
                }, i)
            }
            ...
            function w(e, t, n, r) {
                ...
                o = null != u ? "".concat(a, "//").concat(u, "/app-assets/").concat(e, "/store/").concat(t.id, ".").concat(r) : "".concat(a).concat(window.GLOBAL_ENV.API_ENDPOINT).concat(y.ANM.STORE_ASSET(e, t.id, r));
            ...
            function V(e, t, n) {
                ...
                var i = [];
                (0, v.yE)(r.flags, y.l4R.HAS_FREE_PREMIUM_CONTENT) && i.push({
                    type: y.AzA.HAS_FREE_PREMIUM_CONTENT
                });
                var a = r.releaseDate;
                null != a && u()().diff(a, "months") < 3 && (r.accessType === y.kGb.EARLY_ACCESS ? i.push({

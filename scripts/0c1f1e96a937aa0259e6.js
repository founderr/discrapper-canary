(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["57687"], {
        ...
        169626: function(e, t, n) {
            ...
            function T(e) {
                let {
                    ...
                    onSlideChange: g,
                    hasJoinButton: C
                } = e, [A, N] = i.useState(n), R = (0, u.default)(A), [v, M] = i.useState(null), [L, O] = i.useState(null), [y, D] = i.useState(null), [U, w] = i.useState(!1);
                i.useEffect(() => {
                    N(n)
                }, [N, n]), i.useEffect(() => {
                    A !== R && g(A)
                ...
                let x = i.useCallback(e => {
                    ...
                    P = i.useCallback(() => {
                        if (A === h.CreateGuildSlideTypes.CUSTOMIZE_GUILD) {
        ...
        110337: function(e, t, n) {
            ...
            let g = "hTKzmak",
                C = (0, _.uid)();
            let A = (r = window.GLOBAL_ENV.INVITE_HOST, i = "", null == r && (r = location.host, i = p.Routes.INVITE("")), "".concat(location.protocol, "//").concat(r).concat(i, "/")),
                N = [g, "".concat(A).concat(g), "".concat(A).concat("cool-people")],
                R = e => {
                    let {
                        onClick: t
                    } = e;

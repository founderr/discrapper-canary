    ...
    [84103, 96043, 71402], {
        ...
        396043: (e, t, n) => {
            ...
            function P(e) {
                ...
                return {
                    ...
                    guild_member_perms: String(null !== (n = E.Z.getGuildPermissions(t)) && void 0 !== n ? n : O.ZP.NONE),
            ...
            function M(e) {
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (t = E.Z.getChannelPermissions(e)) && void 0 !== t ? t : O.ZP.NONE),
                    channel_hidden: n
                }
            }
        ...
        434651: (e, t, n) => {
            ...
            function m(e) {
                ...
                var D = P === v && (p.Z.can(_.Plq.CHANGE_NICKNAME, N) || p.Z.can(_.Plq.MANAGE_NICKNAMES, N)),
                    w = P === v,
                    G = p.Z.canManageUser(_.Plq.MANAGE_NICKNAMES, v, N);
                if (!(D || G || w)) return null;
                if (null == C || R) return null;
                var Z = N.hasFeature(_.oNc.HUB) ? h.Z.Messages.HUB_EDIT_PROFILE : h.Z.Messages.CHANGE_IDENTITY,
        ...
        777302: (e, t, n) => {
            ...
            function f(e, t) {
                ...
                var E = d.isOwner(p) || a.ZP.can({
                    permission: l.Plq.ADMINISTRATOR,
                    user: p,
                    context: d
                });
                return !E && f.canManageUser(l.Plq.MODERATE_MEMBERS, p, d)
            }
        ...
        825781: (e, t, n) => {
            ...
            var d, p, E, _, h, v, g, I, y, O = o.QZA.CLOSED,
                b = {},
                T = !1;
            ...
            var P = function(e) {
                ...
                r.showNotice = function() {
                    return void 0 !== d || void 0 !== p || void 0 !== E || void 0 !== _ || void 0 !== h || void 0 !== v
                };
        ...
        189651: (e, t, n) => {
            ...
            function T(e, t) {
                p.default.track(h.rMx.VIEW_AS_ROLES_SELECTED, O(y({
                                    ...
                                    for (var l, s = t[Symbol.iterator](); !(n = (l = s.next()).done); n = !0) {
                                        ...
                                        if (p.Z.isMember(d) && !k.has(d)) {
                                            var h = !0,
                                                ...
                                                g = void 0;
                                            try {
                                                for (var I, y = _[Symbol.iterator](); !(h = (I = y.next()).done); h = !0) {
                                                    var O = I.value;
                                                    H(O, !0, E.Z.getGuild(d))
                                                }
                                            } catch (e) {
                                                v = !0;
                                                g = e
        ...
        18882: (e, t, n) => {
            ...
            function z(e) {
                var t = d.ZP.getMentionCount(e.id) > 0,
                    n = d.ZP.hasRelevantUnread(e) && (!_.Z.isMuted(e.id) || t) || (0,
                        l.c)() && t,
        ...
        430198: (e, t, n) => {
            ...
            function G(e, t, A, N) {
                ...
                var Z, j = (0, o.e7)([h.Z], (function() {
                    ...
                    V = (0, o.cj)([I.Z], (function() {
                        var n, r, i, o = I.Z.getVoiceState(t, e.id);
                        return {
                ...
                if (!k && null != j && null != z && null != z.joinedAt && (v.Z.canManageUser(b.Plq.MODERATE_MEMBERS, e, j) || v.Z.canManageUser(b.Plq.MANAGE_ROLES, e, j)) && j.hasFeature(b.oNc.GUILD_ONBOARDING_EVER_ENABLED)) {
                    ...
                    if ((0, y.yE)(null !== (te = z.flags) && void 0 !== te ? te : 0, m.q.BYPASSES_VERIFICATION)) {
                        ...
                        ee = (0, r.jsx)(u.MenuItem, {
                            ...
                            action: function() {
                                return l.Z.setMemberFlags(j.id, e.id, (0, y.mB)(null !== (ne = z.flags) && void 0 !== ne ? ne : 0, m.q.BYPASSES_VERIFICATION, !1))
                            }
                        }, "verify")
                    } else {
                        var re;
                        ee = (0, r.jsx)(u.MenuItem, {
                            ...
                            action: function() {
                                return l.Z.setMemberFlags(j.id, e.id, (0, y.mB)(null !== (re = z.flags) && void 0 !== re ? re : 0, m.q.BYPASSES_VERIFICATION, !0))
                            }
                        }, "verify")
                    }
                }
        ...
        100856: (e, t, n) => {
            ...
            function b(e, t) {
                ...
                var m = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== b.id && (T ? E.Z.can(y.Plq.CONNECT, n) && !(0, g.rY)(n, v.Z, p.Z) : E.Z.can(y.Plq.MOVE_MEMBERS, n) && (E.Z.can(y.Plq.CONNECT, n) || I.ZP.can({
                ...
                var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                    ...
                    O = (0, o.cj)([s.ZP, d.Z], (function() {
                        ...
                        return {
                            ...
                            canManageRoles: null != v && d.Z.can(E.Plq.MANAGE_ROLES, v)
                        }
                    }), [e, t, v]),
                    b = O.userRoles,
                    T = O.isGuildMember,
        ...
        491260: (e, t, n) => {
            ...
            function D(e) {
                ...
                delete P[e];
                if (null != S[e]) {
                    var t = I(u().sortBy(S[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                ...
                null != e.subsection && null != y && (O[y] = e.subsection);
            ...
            const j = new Z(u.Z, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    ...
                    null != e.subsection && (O[y] = e.subsection)
                },
                USER_SETTINGS_MODAL_CLEAR_SUBSECTION: function(e) {
                    var t = e.forSection;
                    null != t ? delete O[t] : null != y && delete O[y]
                },

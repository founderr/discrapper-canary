        ...
        130881: (t, e, n) => {
            ...
            var s = function() {
                ...
                e.drawInto = function(t, e, n, r) {
                    e %= this.frameCount;
                    this.requireFrame(e);
                    var i = o(u(e, this.frameWidth, this.frameHeight, this.cells), 4),
                        a = i[0],
                        s = i[1],
                        c = i[2],
                        l = i[3];
                    t.drawImage(this.canvas, a, s, c, l, 0, 0, n, r)
                };
                e.drop = function() {
                    var t;
                ...
                e.paint = function(t) {
                    if (null != this.native) {
                        var e, n = this.native.get_bgra(t, this.frameWidth, this.frameHeight),
                            ...
                            i = o(u(t, this.frameWidth, this.frameHeight, this.cells), 4),
                            a = i[0],
                            s = i[1],
                            c = i[2],
                            l = i[3];
                        null === (e = this.context) || void 0 === e || e.putImageData(r, a, s, 0, 0, c, l)
                    }
                };
                return t
            }();
            ...
            var m, d, v, p, y, w, b, g, k, A = function(t, e) {
                    var n, r, i, a, o = {
                        label: 0,
                        sent: function() {
                            if (1 & i[0]) throw i[1];
                ...
                C = (0, c.G)(h((function() {
                    ...
                    return A(this, (function(e) {
                        switch (e.label) {
                            ...
                            case 2:
                                t = e.sent();
                                v = t.cwrap("lottie_create", "number", ["string"]);
                                p = t._lottie_destroy;
                                y = t._lottie_draw_into_bgra;
                                w = t._lottie_draw_into_rgba;
                                b = t._lottie_frame_count;
            ...
            function I(t, e) {
                return new Uint8ClampedArray(m.HEAPU8.buffer, d, t * e * 4)
            }
            var x = function() {
                function t(e) {
                    ! function(t, e) {
                ...
                e.get_bgra = function(t, e, n) {
                    i()(e <= F, "width exceeds static allocation.");
                    i()(n <= F, "height exceeds static allocation.");
                    y(this.native, d, t, e, n);
                    return I(e, n)
                };
                e.get_rgba = function(t, e, n) {
                    i()(e <= F, "width exceeds static allocation.");
                    i()(n <= F, "height exceeds static allocation.");
                    w(this.native, d, t, e, n);
                    return I(e, n)
                };
                e.drop = function() {
                    p(this.native)
            ...
            function S() {
                return (S = E((function(t, e, n, r, i) {
                    var a, o, u;
                    return T(this, (function(c) {
                        switch (c.label) {
                            case 0:
                                return null != (a = i) ? [3, 3] : [4, fetch(r)];
                            case 1:
                                if (!(o = c.sent()).ok) throw new Error("Error fetching sticker at ".concat(r));
                                return [4, o.text()];
                            case 2:
                                a = c.sent();
                                c.label = 3;
                            case 3:
                                return null == a ? [2, null] : [4, C()];
                            case 4:
                                c.sent();
                                u = new x(a);
                                return [2, new s(u, t, e, n)]
                        }
                    }))
            ...
            const O = new(function() {
                ...
                e.create = function(t, e, n, r, i) {
                    var a = !(arguments.length > 5 && void 0 !== arguments[5]) || arguments[5],
                        o = this;
                    return this.getCached(t).then((function(s) {
                        var u;
                        o.referenceCounts.set(t, (null !== (u = o.referenceCounts.get(t)) && void 0 !== u ? u : 0) + 1);
                        if (s) return s;
                        var c = {
                            key: t,
                            promise: q(t, e, n, r, i)
            ...
            var D = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
                P = function() {
                    function t(e) {
                        var n = e.canvas,
                            r = e.id,
                        ...
                        this.animation = null;
                        this.onInitialAnimationTick = function(t) {
                            h.requestAnimationFrameId = null;
                            if ((performance.now() - t < 30 || D) && h.draw(0)) {
                                var e, n;
                                h.resumeAnimation();
                                null === (n = (e = h).onInitialDraw) || void 0 === n || n.call(e);
                                h.hasInitialFrame = !0
                            }
                            h.scheduleOrCancelTick()
                        };
                        this.onAnimationTick = function(t) {
                            h.requestAnimationFrameId = null;
                            var e = performance.now(),
                                n = (D ? e : t) - h.currentFrameTime,
                                r = Math.floor(n / h.frameDuration);
                            if (r > 0) {
                                if (e - t < 12 || D) {
                                    h.draw(h.currentFrame);
                                    h.currentFrame += r
                                }
                                h.currentFrameTime += r * h.frameDuration
                            }
                            h.scheduleOrCancelTick()
                        };
                        var f = n.getContext("2d");
                        i()(null != f, "couldn't get canvas 2d context.");
                        this.canvas = n;
                        ...
                        this.onError = l;
                        this.key = "".concat(r, ":").concat(n.width, ":").concat(n.height);
                        O.create(this.key, n.width, n.height, a, o).then((function(t) {
                            if (null != t)
                                if (h.dropped) O.drop(h.key);
                                else {
                                    h.animation = t;
                                    h.frameDuration = 1e3 / t.frameRate;
                                    h.scheduleOrCancelTick()
                                }
                        })).catch((function(t) {
                            null == l || l()
                    ...
                    e.setVisibility = function(t) {
                        var e = this.visible;
                        this.visible = t;
                        this.visible && !e && this.resumeAnimation();
                        this.scheduleOrCancelTick()
                    };
                    e.resumeAnimation = function() {
                    ...
                    e.draw = function(t) {
                        if (null != this.animation) {
                            this.clear();
                            this.animation.drawInto(this.canvasContext, t, this.canvas.width, this.canvas.height);
                            return !0
                        }
                        return !1
                    };
                    ...
                    e.scheduleOrCancelTick = function() {
                    ...
                    e.requestAnimationFrame = function(t) {
                        ...
                        if (null != t && null != this.requestAnimationFrameId) {
...
//# sourceMappingURL=a169f98c38bf3856c0da.js.map
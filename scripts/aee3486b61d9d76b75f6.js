(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [18797, 51775, 96043], {
        ...
        315804: (t, e, r) => {
                ...
                return (E = O((function(t, e) {
                    ...
                    return S(this, (function(o) {
                        switch (o.label) {
                            ...
                            case 1:
                                o.trys.push([1, 3, , 4]);
                                r = s.Z.inTestModeForApplication(t) || a.Z.inDevModeForApplication(t);
                    ...
                    return S(this, (function(c) {
                        switch (c.label) {
                            case 0:
                                ...
                                (s.Z.inTestModeForApplication(t) || a.Z.inDevModeForApplication(t)) && (n.test_mode = !0);
                                return [4, (0, y.Kb)({
            ...
            function Z() {
                return (Z = O((function(t, e, r) {
                    var u, l, y, v, O, g, w, E, j, P, I, A, N, C, R, Z, D, k;
                    return S(this, (function(S) {
                        switch (S.label) {
                            case 0:
                                u = _({}, T, r), l = u.paymentSource, y = u.expectedAmount, v = u.expectedCurrency, O = u.analyticsLoadId, g = u.isGift, w = u.giftStyle, E = u.subscriptionPlanId, j = u.loadId, P = u.recipientId, I = u.customMessage;
                                i.Z.wait((function() {
                                    i.Z.dispatch({
                                        type: "SKU_PURCHASE_START",
                                        applicationId: t,
                                ...
                                A = s.Z.inTestModeForApplication(t) || a.Z.inDevModeForApplication(t);
                                S.label = 1;
                            case 1:
                                S.trys.push([1, 9, , 10]);
                                C = {
                            ...
                            case 3:
                                ...
                                N.payment_source_id = l.id;
                                return [4, (0, h.Zv)(l)];
                            case 4:
                                N.payment_source_token = S.sent();
                                return b.QL.has(l.type) ? [4, (0, h.EH)(l.type)] : [3, 6];
                            case 5:
                                R = S.sent();
                                N.return_url = n.ZP.getAPIBaseURL() + b.ANM.BILLING_POPUP_BRIDGE_CALLBACK_REDIRECT_PREFIX(l.type, null != R ? R : "", "success");
                                S.label = 6;
                            case 6:
        ...
        396043: (t, e, r) => {
            ...
            function T(t) {
                ...
                if (null != n) {
                    ...
                    r = c.Ec.has(t.type) && null != t.parent_id ? i(a.Z.getChannel(t.parent_id)) : i(t)
                }
                return {
                    channel_id: t.id,
                    channel_type: t.type,
            ...
            function D(t) {
                ...
                if (!_.default.isThrottled(t)) {
                    var n = !("location" in e) || e.location !== w.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        c = a.Z.getChannel(o),
                        u = Z(c, i),
                        l = P({}, e, A(u), null != i && null != o && (0, E.AB)(o) ? N(0, o) : T(c));
                    _.default.track(t, l, {
                        flush: r
                    })
                }
        ...
        270946: (t, e, r) => {
            ...
            function s(t) {
                var e = t.className,
                    ...
                    f = l(t, ["className", "color"]);
                return (0, n.jsx)(o.IG, a(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var r = null != arguments[e] ? arguments[e] : {},
                            n = Object.keys(r);
                        "function" == typeof Object.getOwnPropertySymbols && (n = n.concat(Object.getOwnPropertySymbols(r).filter((function(t) {
        ...
        508778: (t, e, r) => {
            ...
            var u, a = "https://discord.com/community/creating-value-with-conversation";
            ! function(t) {
        ...
        491260: (t, e, r) => {
            ...
            function U(t) {
                ...
                if (n === p.Skl.OFFLINE) u[e] = {
                    ...
                    var a = c.length > 1 ? _(c).sort(Z) : c,
                        l = u[e];
                    c = null != l && i()(l.activities, a) ? l.activities : a;
                    u[e] = {
                        status: n,
                        clientStatus: o,
                        activities: c,
        ...
        349491: (t, e, r) => {
            ...
            const s = (0, i.hN)((function(t) {
                var e = t.width,
                    ...
                    p = t.className,
                    d = t.foreground,
                    y = l(t, ["width", "height", "color", "className", "foreground"]);
                return (0, n.jsx)("svg", a(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var r = null != arguments[e] ? arguments[e] : {},
                            n = Object.keys(r);

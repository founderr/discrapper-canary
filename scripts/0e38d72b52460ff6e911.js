    ...
    ["13553"], {
        ...
        793621: function(e, t, i) {
                ...
                return (0, l.jsx)(l.Fragment, {
                    children: Object.keys(n).map(e => {
                        ...
                        let d = n[e],
                            ...
                            p = T.officialApplicationIds.includes(null !== (t = null == j ? void 0 : j.id) && void 0 !== t ? t : "");
                        return p ? o = (0, l.jsx)(_.default, {
                            className: L.botTag,
                            color: r,
                            size: 16
            ...
            function D(e) {
                ...
                let f = (0, d.useStateFromStores)([p.default], () => {
                    var e, t;
                    return null !== (t = null === (e = p.default.getSelfMember(h)) || void 0 === e ? void 0 : e.roles.includes(o)) && void 0 !== t && t
                }, [h, o]);
            ...
            function U(e) {
                let {
                    ...
                    guild: i,
                    channel: n
                } = e, s = (0, M.default)(i, t, n.id, !0), o = (0, d.useStateFromStores)([I.default], () => I.default.getGuildRoleConnectionEligibility(null == s ? void 0 : s.id)), [c, h] = r.useState(null == o);
            ...
            var l = i("37983"),
                ...
                N = e => {
                    ...
                    let y = null != t.roleId ? i.roles[t.roleId] : void 0,
                        ...
                        I = T ? p.default.Messages.ROLE_ICON_POPOUT_DESCRIPTION_ROLE_SUBSCRIPTIONS.format({
                            name: N
                        ...
                        children: (0, l.jsx)(j.MessagePopoutContent, {
                            children: (0, l.jsxs)("div", {
                                ...
                                children: [(0, l.jsxs)("div", {
                                    ...
                                    fullWidth: !0,
                                    onClick: T ? () => {
                                        (0, c.transitionTo)(w.Routes.CHANNEL(i.id, v.StaticChannelRoute.ROLE_SUBSCRIPTIONS))
                                    } : () => {
        ...
        93332: function(e, t, i) {
            ...
            function Z(e) {
                let {
                    ...
                    showAvatarPopout: v
                } = t, [p, C] = r.useState(!1), N = (0, o.useStateFromStores)([I.default], () => {
                    var e;
                    return null !== (e = t.displayCompactAvatars) && void 0 !== e ? e : I.default.displayCompactAvatars
                }), M = null != h.messageReference && null != h.webhookId, E = h.author, {
                    id: _
                } = E, O = E;
                E.isClyde() && null != i && (null == u ? void 0 : u.guildMemberAvatar) != null && (O = E.addGuildAvatarHash(i, u.guildMemberAvatar));
                let {
                    avatarSrc: S,
                    ...
                    guildId: i,
                    size: f ? 32 : 80,
                    animateOnHover: null != x ? !p : !g,
                    showPending: !0
                });
                if (r.useEffect(() => {
                        if (null != x) return R.ComponentDispatch.subscribeKeyed(U.ComponentActionsKeyed.ANIMATE_CHAT_AVATAR, "".concat(x, ":").concat(_), C), () => void R.ComponentDispatch.unsubscribeKeyed(U.ComponentActionsKeyed.ANIMATE_CHAT_AVATAR, "".concat(x, ":").concat(_), C)
                    }, [_, x]), !f || N) {
                    if (null != n && null != v) return (0, l.jsx)(d.Popout, {
            ...
            let W = e => {
                !e && (0, v.navigateToPremiumMarketingPage)()
            };
            ...
            function Y(e) {
                ...
                let {
                    ...
                    className: b,
                    channel: k
                } = e, G = r.useMemo(() => null != N ? e => N(e, n) : void 0, [N, n]), [, W] = (0, f.default)(n.author.id, e.guildId), Y = (0, o.useStateFromStores)([M.default], () => M.default.getGuild(e.guildId), [e.guildId]), X = (0, c.useIsClydePersonalityModified)(null !== (t = null == Y ? void 0 : Y.id) && void 0 !== t ? t : "", !1), q = null != n.author && null != Y && E.default.canManageUser(U.Permissions.MODERATE_MEMBERS, n.author, Y), J = W && q, Q = Z({
                    props: e,
                    guildId: e.guildId,
                ...
                }), ee = (!v || $) && null != T && null != Y ? (0, l.jsx)(d.Popout, {
                ...
                }, "role-icon-children") : (!v || $) && null != T ? (0, l.jsx)(S.default, {
                    ...T,
                    className: H.roleIcon
                ...
                let eo = F(e, G, es),
                    ed = (0, m.getMessageUsernameId)(n, A),
                    ec = (0, m.getMessageTimestampId)(n),
                    eh = R ? "".concat(ed) : "".concat(ed, " ").concat(ec),
                    eu = (null == s ? void 0 : s.state) === p.ReferencedMessageState.LOADED ? (0, m.getMessageReplyId)(n) : void 0;
                return (0, l.jsx)(z, {
                    message: n,
                    avatar: Q,
                        ...
                        children: [J && (0, l.jsx)(d.Tooltip, {
                            ...
                            children: e => (0, l.jsxs)(l.Fragment, {
                                children: [(0, l.jsx)(O.default, {
                                    ...
                                    width: 12,
                                    height: 12,
                                    className: v ? H.compactCommunicationDisabled : H.communicationDisabled

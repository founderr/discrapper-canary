    ...
    ["38429"], {
                ...
                constructor(e = 36e5) {
                    ...
                    this.updateAvailable = !1, this.hasNativeUpdate = !1, this._callbacks = [], this._bootstrapper = null, this.checkForUpdates = function() {
                        ...
                        this._handleCheckingForUpdates(), a.default.get({
                            ...
                            if (null == e.body || "e75093db0589947e00701924825b6152854d9258" === e.body.hash) return this._handleUpdateNotAvailable();
        ...
        600133: function(e, t, n) {
                ...
                eb = {
                    ...
                    [eN.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER]: {
                        predicate: e => {
                            ...
                            return null != t && er.default.hasVideo(t) && !W.default.supports(eC.Features.VIDEO) && !ex(eN.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER)
                        }
                    },
                    ...
                    [eN.NoticeTypes.CONNECT_PLAYSTATION]: {
                        predicate: () => V.default.isSuggestedAccountType(eN.PlatformTypes.PLAYSTATION) && null == V.default.getAccount(null, eN.PlatformTypes.PLAYSTATION) && !ex(eN.NoticeTypes.CONNECT_PLAYSTATION)
                    },
                    ...
                    [eN.NoticeTypes.PREMIUM_MISSING_PAYMENT]: {
                        predicate: e => {
                            let {
                                premiumSubscription: t,
                                currentUser: n
                            } = e, l = null != t ? a(t.currentPeriodEnd).diff(a().startOf("day"), "days") : 0, s = null != t ? a(t.currentPeriodEnd).diff(a(t.currentPeriodStart).startOf("day"), "days") : 0, i = null != t && a(t.currentPeriodEnd).isBefore(a()), r = ef.default.applicationIdsFetched.has(eg.PREMIUM_SUBSCRIPTION_APPLICATION), o = ef.default.getForApplication(eg.PREMIUM_SUBSCRIPTION_APPLICATION), u = null != t ? (0, eS.getPremiumPlanItem)(t) : null, d = null != u ? eS.default.getSkuIdForPlan(u.planId) : null, c = null != o && null != u && Array.from(o).filter(e => {
                                let {
                                    skuId: t,
                                    consumed: n
                                } = e;
                    ...
                    [eN.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT]: {
                        predicate: e => {
                            let {
                                premiumSubscription: t,
                                currentUser: n
                            } = e, l = null != t && a(t.currentPeriodEnd).isBefore(a()), s = null != t && null != t.paymentSourceId ? eu.default.getPaymentSource(t.paymentSourceId) : null, i = null != s && eA.PREPAID_PAYMENT_SOURCES.has(s.type), r = null != t && t.status === eN.SubscriptionStatusTypes.PAST_DUE && !l && i && !n.hasFreePremium() && !t.isPurchasedExternally;
                    ...
                    [eN.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
                        predicate: e => {
                            ...
                            return null != t && null != C.default.getMentionRaidDetected(t) && (null == n ? void 0 : n.hasFeature(eN.GuildFeatures.COMMUNITY)) && !ex(eN.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION) || !1
                        },
                        metadata: e => {
                            let {
                                selectedGuildId: t
            ...
            class eG extends s.default.Store {
                initialize() {
                    this.syncWith([ea.default, X.default, K.default, et.default, x.default, ec.default, B.default, V.default, G.default, g.default], ej), this.waitFor(ei.default, en.default, z.default, Q.default, J.default, W.default, el.default, p.default, et.default, es.default, j.default, $.default, X.default, e_.default, eT.default, eE.default, q.default, ed.default, ep.default, K.default, eu.default, Z.default, x.default, ef.default, ec.default, V.default, M.default, _.default, h.default, F.default)
                }
                hasNotice() {

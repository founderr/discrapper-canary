    ...
    ["28054"], {
            ...
            var s = n("37983"),
                ...
                A = function(e) {
                    ...
                    return R || !j ? null : (0, s.jsx)(E.default, {
                        ...
                        onDrop: e => {
                            if (R) return !1;
                            j && null != A && ((0, p.promptToUpload)(e, A, T, {
                                requireConfirm: M,
        ...
        176347: function(e, t, n) {
            ...
            class eP extends a.PureComponent {
                ...
                render() {
                    ...
                    } = this.state, p = (0, s.jsx)(j.default, {
                            ...
                            children: (0, s.jsxs)(eS.ComponentDispatchGroupProvider, {
                                ...
                                children: [(0, s.jsx)(eS.ComponentAction, {
                                    ...
                                    children: [(0, s.jsx)(eL.default, {
                                        ...
                                        }), null == n.guild_id || L ? null : (0, s.jsx)(K.default, {
                                            guildId: n.guild_id,
                                            channel: n
        ...
        306588: function(e, t, n) {
            ...
            function B(e) {
                ...
                }), S = !!(null == o ? void 0 : o.hasVerificationGate()), T = (p || u.notClaimed) && S, M = (0, r.useStateFromStores)([_.default], () => _.default.shouldShowPopout(i)), I = (0, r.useStateFromStores)([D.default], () => D.default.can(P.Permissions.SEND_MESSAGES, a)), N = (0, r.useStateFromStores)([g.default], () => g.default.getRequest(i)), j = {
                    ...u,
                    guild: o,
                    isLurking: h,
                    isFollowable: d,
            ...
            function N(e) {
                ...
                function U() {
                    ...
                    null != a && (s = a[1], n = a[2], e = a[3], s += a[4]), (0, E.promptToUpload)([(0, p.makeFile)(new Blob([e], {
                        type: "text/plain"
                    }), "message.".concat(n))], t, R), m.ComponentDispatch.dispatchToLastSubscribed(_.ComponentActions.CLEAR_TEXT), "" !== s && m.ComponentDispatch.dispatchToLastSubscribed(_.ComponentActions.INSERT_TEXT, {
                        plainText: s
                    })
                }
        ...
        931922: function(e, t, n) {
            ...
            function j(e) {
                let {
                    channel: t
                } = e, [n, l] = a.useState(!1), r = (0, m.default)(t, !0), j = (0, c.useStateFromStores)([S.default], () => S.default.getGuild(t.guild_id)), P = (0, c.useStateFromStores)([A.default], () => A.default.getUser(null == j ? void 0 : j.ownerId)), F = a.useMemo(() => null != j ? o(j.roles).sortBy(e => -e.position).filter(e => e.id !== j.id).value() : [], [j]), U = a.useMemo(() => o(F).filter(e => {
                    if (null == j) return !1;
        ...
        194141: function(e, t, n) {
            ...
            function M(e) {
                let {
                    ...
                    onSubmit: R,
                    onClose: x
                } = e, y = (0, d.default)(r), [D, O] = a.useState(!1), [b, j] = a.useState(v), [P, F] = a.useState(null), [U, H] = a.useState(o.shuffle(r)), [k, B] = a.useState(""), G = (0, h.useUID)(), w = (0, C.default)(b), V = (0, C.default)(D), W = (0, C.default)(P), K = (0, C.default)(R), Z = (0, C.default)(k), z = null != P && M.includes(P);
                return a.useEffect(() => {
        ...
        557809: function(e, t, n) {
            ...
            function y(e) {
                ...
                switch (t.type) {
                    ...
                    case v.ChannelTypes.GUILD_MEDIA:
                        return (0, s.jsxs)(a.Fragment, {
                            children: [_ && D, b(A, t.type === v.ChannelTypes.GUILD_ANNOUNCEMENT ? R.default.Messages.NEWS_CHANNEL : R.default.Messages.TEXT_CHANNEL), !_ && D, (0, s.jsx)(N.default.Title, {
                                level: I,
                                onContextMenu: C,
                                onClick: d,
                                children: y
        ...
        51714: function(e, t, n) {
            ...
            function d(e) {
                ...
                return f.forEach(e => {
                    ...
                    F && e.id === U && null != P && (j.flashKey = P), f.jumpTargetId === e.id && (j.jumpTarget = !0), null != p && e.id === p.startId && p.count > 1 && E.push({
                        type: u.ChannelStreamTypes.DIVIDER,
                        content: p.topic,
        ...
        556118: function(e, t, n) {
            ...
            function Y(e) {
                ...
                let {
                    ...
                    handleMouseLeave: el,
                    isHovered: ei
                } = (0, x.useHoveredMessage)(P, p.author.id, Q), er = (0, d.useStateFromStores)([f.default], () => f.default.keyboardModeEnabled), eo = Q || er && z, eu = eo || ei, {
                    content: ed,
                    hasSpoilerEmbeds: ec
                } = (0, O.default)(p, {
                ...
                return (0, s.jsxs)("div", {
                    ...
                    children: [(0, s.jsx)(c.Clickable, {
                        ...
                        className: i(b, {
                            [K.message]: !0,
                            [K.cozyMessage]: !v,
                            [K.mentioned]: p.mentioned && !(0, N.default)(p),
                            [K.ephemeral]: (0, M.hasFlag)(p.flags, V.MessageFlags.EPHEMERAL),
                            [K.systemMessage]: (0, N.default)(p),
                            [K.groupStart]: p.id === P || p.type === V.MessageTypes.REPLY,
                            [K.selected]: eo
                        }),
                        zalgo: !0,
                        onKeyDown: ef,
            ...
            var q = a.memo(function(e) {
                ...
                let ee = V.MessageTypesWithLazyLoadedReferences.has(I.type) ? I.messageReference : void 0,
                    ...
                    eL = (0, h.useShowImprovedMarkdownGuildExperimentConfig)(z.guild_id, (null !== (l = I.editedTimestamp) && void 0 !== l ? l : I.timestamp).valueOf()),
                    {
                        content: ev,
                        hasSpoilerEmbeds: eR
                    } = (0, O.default)(I, {
            ...
            function eS(e) {
                let {
                    ...
                    let {
                        ...
                        author: c
                    } = n, f = (0, u.useStateFromStores)([O.default], () => O.default.getGuild(t.guild_id), [t.guild_id]), h = (0, u.useStateFromStores)([x.default], () => x.default.getId()), p = (0, v.useIsActiveChannelOrUnarchivableThread)(t), E = (0, v.useIsNonModInLockedThread)(t), g = R.RenderReactions.useSetting(), S = R.DeveloperMode.useSetting(), M = (0, u.useStateFromStores)([b.default], () => null == t.guild_id || b.default.canChatInGuild(t.guild_id), [t]), {
                        canManageMessages: I,
                    ...
                    }), [t, M]), y = (0, L.useCanReplyToMessage)(t, n), P = (0, v.useCanStartPublicThread)(t, n), F = (0, v.useCanViewThreadForMessage)(n), U = (0, u.useStateFromStores)([_.default], () => null != t.guild_id && _.default.isLurking(t.guild_id), [t]), H = (0, u.useStateFromStores)([D.default], () => null != t.guild_id && D.default.isCurrentUserGuest(t.guild_id), [t]), k = c.id === h, B = (I || k) && p && n.type in ef.MessageTypesDeletable;
                ...
                } = (0, h.useBurstReactionsExperiment)(t.getGuildId()), eU = (0, v.useIsActiveChannelOrUnarchivableThread)(t), eH = n.hasFlag(ef.MessageFlags.CROSSPOSTED), ek = (0, f.useRedesignIconContext)().enabled;
                return eP && !eF && [].push(d.DismissibleContent.BURST_REACTION_BUTTON_SPARKLE), (0, s.jsxs)(s.Fragment, {
                    children: [Y ? (0, s.jsxs)(s.Fragment, {
                        ...
                        onClick: () => {
                            let e = !ey;
                            eD(e), ex(!1), e && (0, p.openClydeFeedbackModal)(n.id, eI, ex, eD)
                        }
                    }) : null, M && !eL ? (0, s.jsx)(eu.default, {
                        channel: t,
                        message: n,
                        togglePopout: eb,
                        ...
                        shouldShow: ed,
                        isFocused: ev
                    }) : null, M && !eL && eP && eF ? (0, s.jsx)(eu.default, {
                        channel: t,
                        message: n,
                        togglePopout: ej,
                        renderEmojiPicker: eA,
            ...
            function X(e) {
                ...
                if (!eu && ea) eg.push((0, s.jsx)(h.RedactedMessages, {
                    ...
                    let e = $.map((e, t) => {
                        ...
                        if (e.type === K.ChannelStreamTypes.FORUM_POST_ACTION_BAR) return (0, s.jsx)(m.default, {
        ...
        144553: function(e, t, n) {
            ...
            let A = a.memo(function(e) {
                ...
                let {
                    ...
                    return null
                }, [x, y, I, D, O]), j = (0, l.useStateFromStores)([f.default], () => null != x && f.default.isBlocked(x.author.id), [x]), P = (0, g.useContextMenuUser)(null == x ? void 0 : x.author.id, I.id), F = (0, g.useClickReply)(T, x, j), U = (0, g.useClickReferencedMessageAuthorUsername)(x, I, L, R), H = (0, g.useClickReferencedMessageAuthorAvatar)(v, R), k = a.useCallback(() => R({
                    referencedUsernameProfile: !1,

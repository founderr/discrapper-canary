    ...
    ["57349"], {
        ...
        145079: function(e, t, n) {
            ...
            var T = e => {
                let {
                    ...
                    forcePomelo: E,
                    ...f
                } = e, T = (0, i.useStateFromStores)([u.default], () => u.default.hidePersonalInformation), h = T || t || n.isNonUserBot(), N = n.toString(), v = c.default.getName(n), m = s ? N : null != a ? a : v, S = n.isPomelo() || E;
                if (S || m !== N) {
                ...
                return (0, l.jsx)(o.default, {
                    ...
                    botType: _(n),
                    botVerified: n.isVerifiedBot(),
                    discriminator: h || m !== N ? null : null != d ? d : n.discriminator,
                    ...f
                })
            }
        },
        ...
        152475: function(e, t, n) {
            ...
            function I(e) {
                ...
                let {
                    guild_id: f,
                    channel_id: I
                } = e, T = e.entity_type === E.GuildScheduledEventEntityTypes.EXTERNAL, h = T ? t.getDefaultChannel(e.guild_id) : n.getChannel(I), N = l.getGuild(f), v = o.getStageInstanceByChannel(I);
                return !!(0, a.canViewInviteModal)(d.default, N, h, v) && null != h && _(e, [n])
            }
        ...
        953143: function(e, t, n) {
            ...
            function T(e) {
                ...
                return null != R && c.default.trackExposure({
                    ...
                    }), A, x && null != R && null != T && (0, l.jsx)(f.default, {
                        onRecurrenceChange: T,
                        startDate: R,
                        recurrenceRule: m
                    })]
        ...
        590942: function(e, t, n) {
            ...
            function H(e) {
                let {
                    ...
                    onClose: g,
                    createdEvent: p
                } = e, C = (0, h.useUID)(), x = i.useRef(n), D = !(0, r.isEqual)(x.current, n), y = i.useMemo(() => [{
                    slideId: 0,
                    ...
                    valid: !0
                }], [f, E, D]), U = Object.keys(l).length, P = (0, m.isGuildScheduledEventActive)(n), G = e => Math.max(0, Math.min(e, U - 1)), [H, F] = i.useState(P ? 1 : 0), [B, w] = i.useState(!1), k = i.useMemo(() => y.slice(0, H + 1).map(e => e.valid).every(Boolean), [y, H]), Y = H >= y.length ? 3 : y[G(H)].slideId, z = 3 === Y, K = (0, A.useGuildEventModalStore)(e => e.onUpdateCanCloseModal);
                K(z);
            ...
            function F(e) {
                let {
                    ...
                    transitionState: a,
                    onClose: c
                } = e, E = (0, u.useStateFromStores)([I.default], () => I.default.getGuild(t)), T = (0, u.useStateFromStores)([m.default], () => m.default.getGuildScheduledEvent(l), [l]), h = (0, u.useStateFromStores)([_.default], () => _.default.getDefaultChannel(t), [t]), N = (0, C.getInitialGuildEventData)(T, h), [A, R] = i.useState(N), [O] = i.useState((0, C.isEditingEvent)(T)), [L, M] = i.useState(null), j = e => {
                    var t;
                ...
                }, b = (0, f.default)(E, null == T ? void 0 : T.id, A), [F, {
                    loading: B,
                    error: w
                }] = (0, v.default)(async () => {
                    if (null != L) return;
                ...
                return (0, s.jsx)(H, {
                    ...
                    onSave: () => {
                        let e = (null == T ? void 0 : T.scheduled_start_time) !== A.scheduledStartTime || T.scheduled_end_time !== A.scheduledEndTime || !(0, r.isEqual)(T.recurrence_rule, A.recurrenceRule);
        ...
        560309: function(e, t, n) {
            ...
            let D = e => e === R.GuildScheduledEventEntityTypes.EXTERNAL,
                ...
                U = e => {
                    let {
                        ...
                        disabled: i,
                        entityType: r
                    } = e, o = n === O.ChannelTypes.GUILD_STAGE_VOICE, c = (0, C.isChannelPublic)(a, r), E = (0, g.useGetEventChannelsByType)(t, n);
            ...
            function b(e) {
                ...
                let _ = j(s),
                    I = P(s),
                    T = (0, x.getLocationFromEventData)(n),
                    h = (0, x.getChannelTypeFromEntity)(d),
            ...
            function H(e) {
                let {
                    ...
                    guildEvent: n,
                    onChange: s
                } = e, i = (0, r.useStateFromStores)([c.default], () => c.default.getGuild(t), [t]), d = (0, S.default)(t, void 0), o = (0, S.default)(t, O.ChannelTypes.GUILD_VOICE), E = (0, S.default)(t, O.ChannelTypes.GUILD_STAGE_VOICE), f = (0, g.useGetEventChannelsByType)(t, O.ChannelTypes.GUILD_VOICE), _ = (0, p.useChannelsUserCanStartStageIn)(i), h = null == i ? void 0 : i.hasFeature(O.GuildFeatures.COMMUNITY), v = (0, m.isGuildScheduledEventActive)(n), C = G(s, n), x = a.useMemo(() => {
                    let e = [{
            ...
            function F(e) {
                let {
                    ...
                    entityType: o
                } = a, f = (0, r.useStateFromStores)([c.default], () => c.default.getGuild(t), [t]), _ = (0, p.useChannelsUserCanStartStageIn)(f), I = (0, r.useStateFromStores)([E.default], () => E.default.can(O.Permissions.MANAGE_CHANNELS, f)), T = null == f ? void 0 : f.hasFeature(O.GuildFeatures.COMMUNITY), h = G(i, a), N = T && !D(o) && 0 === _.length && I && null != o;
                return (0, l.jsxs)("div", {
            ...
            function m(e) {
                ...
                return (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsx)(T.default, {
                        ...
                        name: R,
                        description: L,
                        imageSource: (n = (0, f.convertToFakeGuildEvent)(g, S, p), null == (m = O) && null == n.image ? null : null != m && /^data:/.test(m) ? m : (0, I.default)(n)),
                        isActive: !1,
                        isUserLurking: V,
                        speakers: [],
                        speakerCount: 0,
        ...
        499950: function(e, t, n) {
            ...
            function x(e) {
                ...
                let P = y && null !== (t = null == M ? void 0 : M.vanityURLCode) && void 0 !== t ? t : null == j ? void 0 : j.code,
                    ...
                    F = null !== (n = null == j ? void 0 : j.maxAge) && void 0 !== n ? n : p.value,
                    B = null !== (x = null == j ? void 0 : j.maxUses) && void 0 !== x ? x : C.value;
                return (0, l.jsxs)("div", {
                    ...
                    if (null != (t = null != r && /^data:/.test(r) ? r : h(r)) ? n = 'url("'.concat(t, '")') : null != T && (a = (0, l.jsx)("div", {
                        ...
                        children: (0, l.jsxs)("div", {
                            ...
                            children: [a, S && (0, l.jsx)("div", {
                                className: i(_.imageUploaderIcon, _.imageUploaderIconDisabled, C),
                                children: A
                            })]
                        })
                    });
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: g
                } = (0, E.usePaymentContext)(), p = N.find(e => e.key === h);
                a.useEffect(() => {
                    S(null)
                }, [h, S]), u(null != p, "Unknown step for current payment flow.");
                let C = null !== (d = null == p ? void 0 : null === (t = p.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== d && d,
                    x = null == p ? void 0 : null === (n = p.options) || void 0 === n ? void 0 : n.bodyClassName,
                    A = void 0 !== I && I ? f.sliderBodyLarge : null == p ? void 0 : null === (s = p.options) || void 0 === s ? void 0 : s.sliderBodyClassName;
                return (0, l.jsxs)(l.Fragment, {
                    children: [null === (o = null == p ? void 0 : null === (r = p.options) || void 0 === r ? void 0 : r.renderHeader) || void 0 === o || o ? _ : null, p.renderStep(T), null == h || C ? null : (0, l.jsxs)(l.Fragment, {
        ...
        287850: function(e, t, n) {
            ...
            class M extends o.default.Store {
                initialize() {
                    this.waitFor(N.default, v.default, g.default, I.default, S.default), this.syncWith([S.default, I.default], R)
                }
            ...
            var D = new M(E.default, {
                ...
                CHANNEL_UPDATES: function(e) {
                    ...
                    t.forEach(e => {
                        ((0, h.isPrivate)(e.type) || x.has(e.id)) && x.set(e.id, A(e))
                    })
                },
                CHANNEL_CREATE: function(e) {
                    ...
                    if (!(0, h.isPrivate)(t.type) || t.id === C.FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) return !1;
                    x.set(t.id, A(t))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != l && x.set(t, A(l, n.id))
                },

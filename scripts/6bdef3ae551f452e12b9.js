    ...
    [33350, 33600, 84832, 96043, 71402], {
            ...
            function T(t) {
                return function(t) {
                    switch (t.type) {
                        ...
                        case "linear":
                            return new _(t.value, t.addValue);
                        case "linear-random":
                            return new _(O(t.minValue, t.maxValue), O(t.minAddValue, t.maxAddValue));
                        case "oscillating":
                            return new b(t.value, t.start, t.final, t.duration, t.direction, t.easingFunction);
                        case "oscillating-random":
                            return new b(O(t.minValue, t.maxValue), O(t.minStart, t.maxStart), O(t.minFinal, t.maxFinal), O(t.minDuration, t.maxDuration), S(t.minDirection, t.maxDirection), E(t.easingFunctions)[0])
                    }
                }(h(h({}, t), {
                    valueType: "number"
                }))
                ...
                return function(t) {
                    switch (t.type) {
                        ...
                        case "linear":
                            e = w(t.value);
                            var i = w(t.addValue);
                            return new y(new _(e.x, i.x), new _(e.y, i.y));
                        case "linear-random":
                            n = w(t.minValue), r = w(t.maxValue);
                            var o = w(t.minAddValue),
                                u = w(t.maxAddValue);
                            return new y(new _(O(n.x, r.x), O(o.x, u.x)), new _(O(n.y, r.y), O(o.x, u.x)));
                        case "oscillating":
                            e = w(t.value);
                            var a = w(t.start),
                                l = w(t.final),
                                c = w(t.duration),
                                s = w(t.direction);
                            return new y(new b(e.x, a.x, l.x, c.x, s.x, t.easingFunction), new b(e.y, a.y, l.y, c.x, s.y, t.easingFunction));
                        case "oscillating-random":
                            n = w(t.minValue), r = w(t.maxValue);
                            var f = w(t.minStart),
                                d = w(t.maxStart),
                                ...
                                I = w(t.minDirection),
                                T = w(t.maxDirection);
                            return new y(new b(O(n.x, r.x), O(f.x, d.x), O(p.x, h.x), O(v.x, g.x), S(I.x, T.x), E(t.easingFunctions)[0]), new b(O(n.y, r.y), O(f.y, d.y), O(p.y, h.y), O(v.y, g.y), S(I.y, T.y), E(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector2"
                }))
                ...
                return function(t) {
                    switch (t.type) {
                        ...
                        case "linear":
                            e = I(t.value);
                            var i = I(t.addValue);
                            return new g(new _(e.x, i.x), new _(e.y, i.y), new _(e.z, i.z));
                        case "linear-random":
                            n = I(t.minValue), r = I(t.maxValue);
                            var o = I(t.minAddValue),
                                u = I(t.maxAddValue);
                            return new g(new _(O(n.x, r.x), O(o.x, u.x)), new _(O(n.y, r.y), O(o.y, u.y)), new _(O(n.z, r.z), O(o.z, u.z)));
                        case "oscillating":
                            e = I(t.value);
                            var a = I(t.start),
                                l = I(t.final),
                                c = I(t.duration),
                                s = I(t.direction);
                            return new g(new b(e.x, a.x, l.x, c.x, s.x, t.easingFunction), new b(e.y, a.y, l.y, c.z, s.y, t.easingFunction), new b(e.z, a.z, l.z, c.z, s.z, t.easingFunction));
                        case "oscillating-random":
                            n = I(t.minValue), r = I(t.maxValue);
                            var f = I(t.minStart),
                                d = I(t.maxStart),
                                ...
                                w = I(t.minDirection),
                                T = I(t.maxDirection);
                            return new g(new b(O(n.x, r.x), O(f.x, d.x), O(p.x, h.x), O(v.x, y.x), S(w.x, T.x), E(t.easingFunctions)[0]), new b(O(n.y, r.y), O(f.y, d.y), O(p.y, h.y), O(v.y, y.y), S(w.y, T.y), E(t.easingFunctions)[0]), new b(O(n.z, r.z), O(f.z, d.z), O(p.z, h.z), O(v.z, y.z), S(w.z, T.z), E(t.easingFunctions)[0]))
                    }
                }(h(h({}, t), {
                    valueType: "Vector3"
                }))
                    ...
                    O = r.useCallback((function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                var n = Date.now();
                                0 !== _.current && (b.current = 1e3 / (n - _.current)), _.current = n
                            }
                        }
                    }), [u, p, d]);
                            ...
                            return function(t, e) {
                                ...
                                switch (t.label) {
                                    case 0:
                                        return [4, m()];
                                    case 1:
                                        return t.sent(), g(), v.current = !0, _(!0), [2]
                                }
                            }))
                        }))
                    }), [_, m, g]);
            ...
            function U(t) {
                ...
                if (!b.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = L(u, i),
                        c = T({}, e, R(a), null != i && null != o && (0, w.AB)(o) ? N(0, o) : A(u));
                    b.default.track(t, c, {
                        flush: n
                    })
                }
        ...
        165586: (t, e, n) => {
            ...
            var y = [v(r.RESOLUTION_720), v(r.RESOLUTION_1080), v(r.RESOLUTION_1440), v(r.RESOLUTION_SOURCE, (function() {
                ...
                b = [v(i.FPS_15), v(i.FPS_30), v(i.FPS_60)],
        ...
        133600: (t, e, n) => {
            ...
            var W = function(t) {
                        ...
                        return (0, r.jsxs)("div", {
                            children: [(0, r.jsxs)(l.ModalRoot, {
                                ...
                                children: [null != c.giftStyle && !m && (0, r.jsx)(I.Z, {
                                    ...
                                    }), (null == c.giftStyle || m && this.state.accepted) && (0, r.jsx)(b.Z, {
                                        size: b.Z.Sizes.LARGE,
                                        game: i,
                                        skuId: c.skuId
                                    }), (0, r.jsxs)(l.Heading, {
                                        id: s,
                                        className: u()((e = {}, k(e, C().customGiftHeader, m && !_), k(e, C().header, !m || _), e)),
                ...
                Y = a.ZP.connectStores([y.Z, _.Z, h.Z, v.Z, m.Z, f.Z], (function(t) {
                    var e = t.giftCode,
                        n = _.Z.get(e.skuId),
        ...
        491260: (t, e, n) => {
            ...
            var F = function(t) {
                ...
                r.getActivities = function(t) {
                    ...
                    if (null == e) {
                        var n;
                        return null !== (n = P[t]) && void 0 !== n ? n : w
                    }
                    var r = C(t, e);
            ...
            const G = new F(l.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(t) {
                    ...
                    if (T[e] === t.status && P[e] === t.activities) return !1;
                    T[e] = t.status;
                    P[e] = t.activities;
                    delete N[e]
                }
        ...
        58964: (t, e, n) => {
            ...
            function h(t, e) {
                ...
                var p, h, v, y, g, m = encodeURIComponent(l.toString()),
                    ...
                    b = (v = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), y = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(v)), g = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !y,
                    ...
                    S = "".concat(f, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(_, "&efr=").concat(b);

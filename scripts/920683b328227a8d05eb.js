            ...
            let l = e => {
                ...
                return (0, a.jsx)("svg", {
                    ...
                    children: (0, a.jsx)("path", {
                        fillRule: "evenodd",
                        clipRule: "evenodd",
                        d: "M21 21.9344L21 2.06566C21 1.40434 20.3696 0.925145 19.7324 1.10214L17.2221 1.79943C16.748 1.93113 16.2487 1.94419 15.7684 1.83744L12.6508 1.14464C12.2222 1.04939 11.7778 1.04939 11.3492 1.14464L8.23161 1.83744C7.75125 1.94419 7.25201 1.93113 6.77789 1.79943L4.26765 1.10214C3.63045 0.925145 3 1.40434 3 2.06566L3 21.9344C3 22.5957 3.63045 23.0749 4.26765 22.8979L6.77789 22.2006C7.25201 22.0689 7.75125 22.0559 8.23161 22.1626L11.3492 22.8554C11.7778 22.9507 12.2222 22.9507 12.6508 22.8554L15.7684 22.1626C16.2487 22.0559 16.748 22.0689 17.2221 22.2006L19.7324 22.8979C20.3696 23.0749 21 22.5957 21 21.9344ZM7 8.00003C7 7.44774 7.44772 7.00003 8 7.00003L16 7.00003C16.5523 7.00003 17 7.44774 17 8.00003C17 8.55231 16.5523 9.00003 16 9.00003L8 9.00003C7.44772 9.00003 7 8.55231 7 8.00003ZM8 11C7.44771 11 7 11.4477 7 12C7 12.5523 7.44772 13 8 13L16 13C16.5523 13 17 12.5523 17 12C17 11.4477 16.5523 11 16 11L8 11ZM7 16C7 15.4477 7.44771 15 8 15L11 15C11.5523 15 12 15.4477 12 16C12 16.5523 11.5523 17 11 17L8 17C7.44772 17 7 16.5523 7 16ZM15 15C14.4477 15 14 15.4477 14 16C14 16.5523 14.4477 17 15 17H16C16.5523 17 17 16.5523 17 16C17 15.4477 16.5523 15 16 15H15Z",
                        fill: "string" == typeof l ? l : l.css,
                        className: o
                    })
                })
        ...
        383925: function(e, t, r) {
            ...
            function B() {
                ...
                let [{
                    ...
                    semanticTokens: A
                }), [b, _] = i.useState(""), [P, M] = i.useState({}), [O, B] = i.useState({}), D = i.useMemo(() => {
                    let e = Object.keys(a);

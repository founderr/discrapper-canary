        ...
        950603: (e, t, n) => {
                ...
                var t = function(e) {
                    switch (!0) {
                        case null != e.items.find(w.M):
                            return Z.Z.Messages.USER_SETTINGS_AVATAR_DECORATION;
                        case null != e.items.find(N.H):
                            return Z.Z.Messages.USER_SETTINGS_PROFILE_EFFECT;
                        default:
                            return null
                    }
                }(e.product);
            ...
            var se = function(e, t) {
                ...
                de = function(e) {
                    var t = e.product,
                        ...
                        D = null != M ? {
                            background: (0, H.nH)(M, 90),
                            color: (0, H.FB)(M)
                        } : void 0,
                        k = null != j ? {
                            background: (0, H.nH)(j, 135)
                        } : void 0,
                        W = (0, A.mv)(l),
                        ...
                        ae = te.avatarDecorationSrc,
                        ie = te.eventHandlers;
                    return (0, r.jsxs)("div", {
                        className: K().collectibleInfoContainer,
                        style: k,
                        children: [(0, r.jsxs)("div", {
                            className: K().titleContainer,
                            children: [(0, r.jsx)("div", {
                                className: K().titleImageWrapper,
                                children: (0, r.jsx)("img", {
                                    className: K().titleImage,
                                    src: (0, A.uV)(l.logo, {
                                        size: ue
                                    }),
                                    alt: l.name
                            ...
                            className: K().avatarPreviewContainer,
                            children: (0, r.jsx)(i.Avatar, re(ne({}, ie), {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [p && (0, r.jsx)(B, {
                                    product: t
                                }), (0, r.jsx)(i.Heading, {
                                    color: "always-white",
                                    variant: "heading-xl/extrabold",
                                    className: p ? K().headingWithItemTypePill : void 0,
                                    children: t.name
                                }), (0, r.jsx)(i.Text, {
                                    color: "always-white",
                                ...
                                onClick: function() {
                                    ...
                                    Q ? (0, d.ps)({
                                        analyticsLocations: E,
                                        initialSelectedDecoration: null != X ? X : null
                                    }) : J && (0, b.H)({
                                        analyticsLocations: E,
                                        initialSelectedEffectID: null == $ ? void 0 : $.id
                                    })
                                },
                                ...
                                children: J ? Z.Z.Messages.COLLECTIBLES_BUY_PROFILE_EFFECT : Z.Z.Messages.COLLECTIBLES_BUY_DECORATION
                            }) : (0, r.jsx)(y.Z, {
                                ...
                                variant: "text-xxs/normal",
                                children: null != g ? null : L ? W ? Z.Z.Messages.COLLECTIBLES_DETAILS_MODAL_INCLUDED_WITH_PREMIUM_DISCLAIMER : J ? Z.Z.Messages.COLLECTIBLES_DETAILS_MODAL_PROFILE_EFFECT_PREMIUM_PURCHASE_DISCLAIMER : Z.Z.Messages.COLLECTIBLES_DETAILS_MODAL_PREMIUM_PURCHASE_DISCLAIMER : J ? Z.Z.Messages.COLLECTIBLES_DETAILS_MODAL_PROFILE_EFFECTS_NON_PREMIUM_PURCHASE_DISCLAIMER : Z.Z.Messages.COLLECTIBLES_DETAILS_MODAL_NON_PREMIUM_PURCHASE_DISCLAIMER
                            })]
                        })]
                    })
                },
                fe = function(e) {
                    ...
                    return (0,
                        r.jsxs)("div", {
                        className: null != d ? K().previewsContainerInner : K().profileEffectPreviewsContainerInner,
                        children: [(0, r.jsx)(L.Z, re(ne({}, l), {
                            user: n,
                            canUsePremiumCustomization: s,
                            onAvatarChange: Y.dG,
                            onBannerChange: Y.dG,
                            bodyClassName: K().profileCustomizationBody,
                ...
                me = function(e) {
                    var t = e.product,
                        n = function(e) {
                            ...
                            r.author = new g.Z(re(ne({}, r.author), {
                    ...
                    return (0, r.jsx)(i.FocusBlock, {
                        children: (0, r.jsxs)(i.Card, {
                            className: K().chatPreview,
                            outline: !0,
                            "aria-hidden": !0,
                            children: [(0, r.jsx)(p.Z, {
                                className: K().mockMessage,
                                author: (0, E.ZH)(n),
                                message: n
                            }, n.id), (0, r.jsxs)("div", {
                                className: K().mockInput,
                                children: [(0, r.jsx)(M.Z, {
                                    className: K().mockInputButton,
                                    width: 24,
                                    height: 24
                                }), (0, r.jsx)(O.Z, {
                                    className: K().mockInputButton,
            ...
            const Ee = function(e) {
                var t = e.transitionState,
                    ...
                    p = (0, c.Z)(ae(m).concat([l.Z.COLLECTIBLES_SHOP_DETAILS_MODAL])),
                ...
                o.useEffect((function() {
                    ...
                    j.default.track(W.rMx.OPEN_MODAL, {
                        type: W.jXE.COLLECTIBLES_SHOP_DETAILS_MODAL,
                        source: f,
                        location_stack: h,
                        sku_id: s.skuId,
                        product_type: e
                    ...
                    children: (0, r.jsx)(i.ModalRoot, {
                        ...
                        children: (0, r.jsxs)(i.ModalContent, {
                            ...
                            children: [(0, r.jsx)(de, {
                                ...
                                className: null != C ? K().collectiblePreviewsContainerWithChat : K().collectiblePreviewsContainerNoChat,
                                children: [(0, r.jsx)("img", {
                                    className: K().categoryBanner,
                                    src: (0, A.uV)(u.banner, {
                                        size: 540
                                    }),
                                    alt: u.name

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [83316, 56620], {
                ...
                var t = e.guildEventId,
                    ...
                    C = function(e, t) {
                        return (0, P.Z)(t, e).isMember ? (0, r.jsx)(o.MenuItem, {
                            ...
                            action: function() {
                                (0, j.JG)("".concat(location.protocol, "//").concat(location.host).concat(T.Z5c.GUILD_EVENT_DETAILS(t, e)));
                                (0, o.showToast)((0,
                        ...
                        return (0, r.jsxs)(o.MenuItem, {
                            ...
                            children: [(0, r.jsx)(o.MenuItem, {
                                ...
                                action: function() {
                                    var e = {
                                            text: c.name,
                                            dates: "".concat(j.format(h), "/").concat(P.format(h)),
                                            details: T,
                                            action: "TEMPLATE",
                                            location: i
                                        },
        ...
        873934: (e, t, n) => {
            ...
            const T = new P(o.Z, {
                ...
                INTERACTION_FAILURE: function(e) {
                    ...
                    u.data.interactionType === i.B8.APPLICATION_COMMAND ? j(n) : g[n] = p(function(e) {
                        for (var t = 1; t < arguments.length; t++) {
                            var n = null != arguments[t] ? arguments[t] : {},
                                r = Object.keys(n);
                            "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
        ...
        166076: (e, t, n) => {
            ...
            var g, m, E = (m = (g = function(e) {
                var t, n, i, f, d, b, v, g, m, E, w;
                return O(this, (function(O) {
                    switch (O.label) {
                        case 0:
                            t = e.componentType, n = e.messageId, i = e.messageFlags, f = e.customId, d = e.indices, b = e.applicationId, v = e.channelId, g = e.guildId, m = e.localState;
                ...
                T = function(e, t) {
                    if (!t.ok) {
                        if (!t.hasErr) {
                            ...
                            var r;
                            (0,
                                a.yr)(e, null === (r = t.body) || void 0 === r ? void 0 : r.code);
                            return
                        }(0, a.yr)(e)
                    }
                };
            ...
            var _ = function(e, t) {
                var n, o = null == t ? void 0 : t.state,
                    i = e.state === p.yb.SENT && v(e.id) < Date.now(),
                    c = e.state === p.yb.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : r.default.extractTimestamp(n) + 3e3) < Date.now(),
                    l = (null == t ? void 0 : t.data.interactionType) === u.B8.APPLICATION_COMMAND,
                    a = e.isCommandType();
                return l && o === f.F.QUEUED || a && e.state === p.yb.SENDING && null != t ? w.SENDING : l && o === f.F.CREATED || e.hasFlag(p.iLy.LOADING) && !i ? w.CREATED : null != e.interaction && e.hasFlag(p.iLy.LOADING) && i || null != e.interaction && !e.hasFlag(p.iLy.LOADING) && c ? w.TIMED_OUT : a && e.state === p.yb.SEND_FAILED ? w.FAILED : void 0
            };
        ...
        305082: (e, t, n) => {
            ...
            function _() {
                return e = T, t = P, n = E("useMemoizedValueSyncedWithDismissibleContents"), i = (0, o.e7)([l.Z], (function() {
                    var e;

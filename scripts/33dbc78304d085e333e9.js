    ...
    ["57003"], {
        304580: function(e, t, n) {
            ...
            var o = n("414456"),
                ...
                f = n("782340"),
                h = n("955892");
            (s = l || (l = {})).DEFAULT = "", s.BOLD = "Bold", s.SOLID = "Solid";
            let p = e => {
                let {
                    closeAction: t,
                    variant: n,
                ...
                return (0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsx)(u.Clickable, {
                        className: r(h.closeButton, {
                            [h.closeButtonBold]: n === l.BOLD,
                            [h.closeButtonSolid]: n === l.SOLID
                        }),
                        onClick: t,
        ...
        366634: function(e, t, n) {
            ...
            var u = e => {
                ...
                return (0, s.jsxs)("svg", {
                    width: "18",
                    height: "18",
                    className: i(r.button, n, {
                        [r.open]: t,
                        [r.withHighlight]: l
                    }),
                    children: [l && (0, s.jsx)("defs", {
                        ...
                        children: [(0, s.jsx)("path", {
                            ...
                            stroke: l ? "url(#".concat(a, ")") : "currentColor",
                            d: "M4.5 4.5l9 9",
                            strokeLinecap: "round"
                        }), (0, s.jsx)("path", {
                            stroke: l ? "url(#".concat(a, ")") : "currentColor",
        ...
        526887: function(e, t, n) {
            ...
            function c(e) {
                let {
                ...
                } = e, p = (0, i.useConfettiCannon)(n, a), v = (0, o.default)([r.default], () => r.default.useReducedMotion), _ = l.useMemo(() => v ? u : {
                    confettiCanvas: n,
                    cannon: p,
                    ...
                    createConfettiAt: (e, t, n, s) => p.createConfetti({
                        ...c,
                        position: {
                            type: "static",
                            value: {
                    ...
                    createMultipleConfettiAt: function(e, t, n) {
                        let s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 20,
            ...
            function f(e) {
                ...
                return (0, s.jsx)(o.default, {
                    ...
                    children: (0, s.jsx)(r.default, {
                        tier: t,
                        className: i(l, u.boostedGuildIconGem, c[t])
                    })
                })
            }
        },
        836275: function(e, t, n) {
            ...
            function p(e) {
                let {
                    ...
                    isGIF: i,
                    banner: o
                } = e, f = i ? (0, r.minimumRequiredTierForGuildFeature)(d.GuildFeatures.ANIMATED_BANNER) : (0, r.minimumRequiredTierForGuildFeature)(d.GuildFeatures.BANNER);
                null != f && (0, a.default)({
                    analyticsLocations: t,
                    ...
                    perks: i ? (0, u.animatedGuildBannerUpsellPerks)() : (0, u.guildBannerUpsellPerks)()
                })
            }
        },
        974755: function(e, t, n) {
            ...
            function C(e) {
                let {
                    ...
                    isBannerVisible: n,
                    disableBoostClick: l
                } = e, i = (0, o.useStateFromStores)([f.default, c.default], () => {
                ...
                let p = e => {
                        e.stopPropagation(), e.preventDefault(), i && !l && (0, u.openGuildBoostingMarketingModal)({
                            guildId: t.id,
                            location: {
                    ...
                    C = a === _.BoostedGuildTiers.NONE ? I.default.Messages.PREMIUM_GUILD_HEADER_BADGE_NO_TIER : v.getTierName(a),
        ...
        507497: function(e, t, n) {
            ...
            function _(e) {
                let {
                    ...
                    isGIF: _,
                    banner: I
                } = e, E = (0, l.useStateFromStores)([d.default], () => d.default.getGuildId()), C = (0, l.useStateFromStores)([u.default], () => u.default.getGuild(E)), {
                    analyticsLocations: R
                } = (0, o.default)();
                return null == C || C.hasFeature(f.GuildFeatures.ANIMATED_BANNER) || !_ && C.hasFeature(f.GuildFeatures.BANNER) ? null : (0, s.jsxs)("div", {
        ...
        193867: function(e, t, n) {
            ...
            function R(e) {
                let {
                    analyticsSection: t,
                    type: n
                } = e, R = (0, i.useStateFromStores)([c.default], () => c.default.getCurrentUser()), g = p.default.canUseAnimatedAvatar(R), m = p.default.canUsePremiumProfileCustomization(R), M = n === _.UploadTypes.BANNER && m || n === _.UploadTypes.AVATAR && g, {
        ...
        652914: function(e, t, n) {
            ...
            function r(e) {
                ...
                return [o.UploadTypes.BANNER, o.UploadTypes.AVATAR].includes(t) && a ? (0, s.jsx)(i.default, {
                    analyticsSection: r,
                    type: t
                }) : t === o.UploadTypes.GUILD_BANNER ? (0, s.jsx)(l.default, {
                    analyticsSection: r,
                    analyticsPage: n,
                    isGIF: a,
                    banner: u
        ...
        870346: function(e, t, n) {
            ...
            function x(e) {
                ...
                null != t && (!t.closed && M(e), t.close(), ! function(e) {
                    let t = I[e];
                    l(null != t, "Popout window was null during unmount"), t.removeEventListener("focus", g), t.removeEventListener("blur", g), t.removeEventListener("resize", m);
                    let n = E[e];
                    l(null != n, "Window root was null while unmounting"), n.unmount(), delete I[e], delete _[e], delete C[e], delete E[e]
                }(e), L.emitChange())
            }
            ...
            function T(e) {
                ...
                if (null != n.key) switch (n.type) {
                    case p.PopoutEventTypes.LOADED:
                        var s;
                        return s = n.key, void(R.has(s) && (! function(e) {
                            let t = I[e],
                                n = C[e];
                            if (null == t) {
                            ...
                            let s = t.document;
                            (0, h.subscribeDocumentToFullScreenChange)(s, g), t.addEventListener("focus", g), t.addEventListener("blur", g), t.addEventListener("resize", m), ! function(e, t) {
                                let n = t.document,
                                ...
                                for (let e of s) {
                                    ...
                                    t.href = e.href, t.rel = e.rel, t.integrity = e.integrity, l(null != n.head, "Document head was null"), n.head.appendChild(t)
                                }
                            }(0, t);
                            let i = (0, r.createRoot)(s.getElementById("app-mount"));
                            l(null != i, "No render target for popout!"), E[e] = i, i.render(n(e))
                        }(s), R.delete(s), L.emitChange()));
            ...
            class N extends a.default.PersistedStore {
                initialize(e) {
                    window.addEventListener("message", T), window.addEventListener("beforeunload", w), v = null != e ? e : {}
                }
                getWindow(e) {
                    return I[e]
                }
            ...
            let L = new N(u.default, {
                POPOUT_WINDOW_OPEN: function(e) {
                    ...
                    if (c.isPlatformEmbedded && !f.default.supportsFeature(p.NativeFeatures.POPOUT_WINDOWS)) throw Error("Popout windows not supported on this native module version!");
                    let l = I[t];
                    if (null != l && !l.closed) return c.isPlatformEmbedded ? f.default.focus(t) : l.focus(), !1;
                    let {
                        defaultWidth: i,
                        defaultHeight: o,
                    ...
                    let E = window.open(p.Routes.POPOUT_WINDOW, t, function(e) {
                        let t = "";
                    ...
                    E.windowKey = t, null == E || E.focus(), I[t] = E, C[t] = s, c.isPlatformEmbedded && (f.default.setAlwaysOnTop(t, d), _[t] = d, f.default.isAlwaysOnTop(t).then(e => _[t] = e)), R.add(t)
                },
        ...
        974889: function(e, t, n) {
            ...
            function o(e) {
                ...
                null != n && !n.closed && (s.isPlatformEmbedded ? l.default.focus(e, t) : n.focus())
            }
        },
        67069: function(e, t, n) {
            ...
            function d(e) {
                let {
                    ...
                    textColor: l = a.default.Colors.STANDARD,
                    className: d,
                    button: c,
                    reducedRightPadding: f = !1
                } = e;
                return (0, s.jsxs)("div", {
                    className: i(f ? u.noticeWithoutRightPadding : u.noticeWithRightPadding, d),
                    children: [(0, s.jsxs)("div", {
        ...
        931138: function(e, t, n) {
            ...
            function d(e) {
                let {
                    ...
                    ...c
                } = e, f = l.Children.only(t), h = (0, r.useRedesignIconContext)().enabled;
                return (0, s.jsxs)("div", {
                    className: o(u.flowerStarContainer, i),
                    style: {
                        width: n,
                        height: n
                    },
            ...
            var l = n("469563"),
                ...
                r = (0, l.replaceIcon)(function(e) {
                    ...
                    return (0, s.jsxs)("svg", {
                        ...
                        height: n,
                        viewBox: "0 0 14 14",
                        children: [null != r ? (0, s.jsx)("circle", {
                            r: 5,
                            cx: 7,
                            cy: 7,
                            fill: r
        ...
        235855: function(e, t, n) {
            ...
            class u extends s.Component {
                ...
                constructor(e) {
                    ...
                    t ? r.has(t) ? this.elementId = r.get(t) || "" : r.set(t, (0, l.v4)()) : this.elementId = o;
                    let u = this.getVisibilityObserverId();
                    !a.has(u) && a.set(u, new i.default({
                        root: t,
                        rootMargin: n,
                        threshold: s
                    }))

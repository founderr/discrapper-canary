        ...
        152584: function(e, t, n) {
            ...
            function S(e) {
                ...
                return s.default.dispatch({
                    ...
                    return null != E.DEVICE_PUSH_VOIP_PROVIDER && null != d && (s.push_voip_provider = E.DEVICE_PUSH_VOIP_PROVIDER, s.push_voip_token = d), _(s)
                }, {
                    checkEnabled: !1,
                    modalProps: {
        ...
        833843: function(e, t, n) {
            ...
            function w(e) {
                let {
                    ...
                    isMember: u,
                    recurrenceId: d
                } = e, c = (0, h.isGuildScheduledEventActive)(t), f = (0, r.useStateFromStores)([h.default], () => h.default.isInterestedInEventRecurrence(t.id, d), [d, t]), E = (0, C.default)(t), p = (0, r.useStateFromStores)([o.default], () => o.default.isLurking(n.id), [n.id]), v = (0, _.useIsChannelPublic)(null == l ? void 0 : l.id, t.id), S = (0, U.default)({
                    guild: n,
                    channel: l,
            ...
            var b = e => {
                let {
                    ...
                    onClose: _
                } = e, [T, N] = l.useState(C), U = (0, r.useStateFromStores)([h.default], () => h.default.getGuildScheduledEvent(t), [t]), b = null == U ? void 0 : U.id, O = null == U ? void 0 : U.guild_id, {
                    guild: P,
                    isMember: D
                } = (0, p.default)(O, b), M = (0, a.default)(n), j = null == U ? void 0 : U.channel_id, V = (0, r.useStateFromStores)([u.default], () => u.default.getChannel(j), [j]), F = (0, d.useUID)(), [k, G] = l.useState(y.EventDetailSections.EVENT_INFO), B = (0, v.default)(b, T), H = (0, r.useStateFromStores)([h.default], () => h.default.getUserCount(b, T)), [Z, {
                    loading: W,
                    error: Y
                }] = (0, f.default)(() => E.default.getGuildEventUsers(null == U ? void 0 : U.id, T, O));
                l.useEffect(() => {
                ...
                if (l.useLayoutEffect(() => {
                    ...
                    }, [z, null == U ? void 0 : U.recurrence_rule]), null == U || null == P || !D && !M) return null;
                let X = e => {
                        e !== k && (e === y.EventDetailSections.RSVP_LIST && Z(), G(e))
                    },
                    J = null != T ? T : (0, S.getNextRecurrenceIdInEvent)(U);
        ...
        360538: function(e, t, n) {
            ...
            function b(e) {
                let {
                    ...
                    startTime: U,
                    endTime: b
                } = (0, g.default)(t.id, C), O = (0, a.useStateFromStores)([_.default], () => _.default.getUserCount(t.id, C)), P = l.useCallback(e => {
        ...
        403901: function(e, t, n) {
            ...
            function R(e) {
                ...
                let {
                    eventUser: n,
                    onContextMenu: l
                } = e, o = (0, s.useStateFromStores)([p.default], () => p.default.getUser(n.user_id)), d = null === (t = n.member) || void 0 === t ? void 0 : t.guildId, v = (0, s.useStateFromStores)([C.default, h.default, E.default], () => n.user_id === E.default.getId() ? C.default.getStatus() : h.default.getStatus(n.user_id, d), [n.user_id, d]);
        ...
        650484: function(e, t, n) {
            ...
            function h(e) {
                ...
                let {
                    ...
                    setReadySlideId: I
                } = (0, f.usePaymentContext)(), N = _.find(e => e.key === v);
                l.useEffect(() => {
                    T(null)
                }, [v, T]), o(null != N, "Unknown step for current payment flow.");
                let m = null !== (u = null == N ? void 0 : null === (t = N.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    ...
                    R = void 0 !== C && C ? E.sliderBodyLarge : null == N ? void 0 : null === (r = N.options) || void 0 === r ? void 0 : r.sliderBodyClassName;
        ...
        649844: function(e, t, n) {
            ...
            function C(e) {
                let {
                    ...
                    giftRecipient: w,
                    returnRef: b
                } = null != e ? e : {}, O = !1, P = (0, l.v4)(), D = u.default.getCurrentUser(), M = (0, f.isPremiumExactly)(D, h.PremiumTypes.TIER_2);
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: C,
                            onClose: (e, t) => {
                                l(), null == p || p(e), e && (null == _ || _(), !N && null != t && t === h.PremiumSubscriptionSKUs.TIER_2 && !M && c.ComponentDispatch.dispatch(E.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                O = !0, null == v || v(), !N && (0, o.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: _,
                            analyticsLocations: S,
                            analyticsObject: g,
                    ...
                    onCloseCallback: () => {
                        !O && d.default.track(E.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: P,
        ...
        181114: function(e, t, n) {
            ...
            let v = e => {
                let {
                    ...
                    onlyShineOnHover: C,
                    ...v
                } = e, _ = s.createRef(), S = (0, c.default)(_), g = !i && !l && !0 !== a && (!C || S);
                return (0, r.jsxs)(d.Button, {
                    ...
                    children: [t, g ? (0, r.jsx)(p, {
                        shinePaused: f,
                        className: o(E.buttonShine, C ? E.onlyShineOnHover : void 0, h),
                        shineSize: u
                    }) : null]
                })
            };
        ...
        461380: function(e, t, n) {
            ...
            let E = {
                ...
                h = e => {
                    ...
                    if (!0 === _ ? T = E.DOWN : !1 === _ && (T = E.RIGHT), g) {
                        let e = {

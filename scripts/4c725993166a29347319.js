        ...
        310688: function(e, t, n) {
            ...
            class eI extends l.PureComponent {
                ...
                renderFooter() {
                    ...
                    let {
                        ...
                        maxAge: d
                    } = o, c = null, E = (0, J.default)(null !== (e = this.getInviteKey()) && void 0 !== e ? e : "");
                    if (n) {
            ...
            var eT = l.forwardRef(function(e, t) {
                ...
                let {
                    ...
                    page: M,
                    analyticsLocation: F
                } = e, [V, H] = l.useState(M === ei.InstantInviteModalPages.GUEST ? E.GuildInviteFlags.IS_GUEST_INVITE : 0), {
                    AnalyticsLocationProvider: k,
                    analyticsLocations: j
                } = (0, g.default)(h.default.INSTANT_INVITE_MODAL), K = (0, _.useStateFromStores)([P.default, b.default], () => {
                    let e = b.default.getVoiceChannelId();
                    if (null == e) return null;
                    let t = P.default.getChannel(e);
                    return (null == t ? void 0 : t.guild_id) === o.id ? t : null
                }), W = null != K && !(0, m.default)(K) && [el.InstantInviteSources.GUILD_CONTEXT_MENU, el.InstantInviteSources.GUILD_HEADER].includes(d), Y = (0, v.default)(o.id), Q = (0, _.useStateFromStores)([b.default, P.default, G.default], () => {
                    var e;
                    if (W && ((0, Z.hasFlag)(V, E.GuildInviteFlags.IS_GUEST_INVITE) || M === ei.InstantInviteModalPages.GUEST)) return K;
                    if (M === ei.InstantInviteModalPages.GUEST) return 1 === Y.length ? Y[0] : void 0;
                    if (null != u) return u;
                    let t = b.default.getChannelId(),
                ...
                }, [W, V, M, u, o.id, K, Y]), [z, q] = l.useState(null), J = null != z ? z : Q, $ = null;
                ...
                let ee = null != u ? u.getGuildId() : null != o ? o.id : null,
                    ...
                    [en, ea, es, eu, eo] = (0, _.useStateFromStoresArray)([w.default, B.default, D.default], () => {
                        let e = null != J ? J.id : null;
                        return [w.default.getInviteSuggestionRows(), w.default.getTotalSuggestionsCount() >= 1, w.default.getInitialCounts(), null != u && null != J ? B.default.getVoiceStatesForChannel(J) : null, null != ee ? D.default.getProps(ee, e) : null]
                    }, [J, u, ee]),
                    ed = (0, _.useStateFromStores)([x.default], () => null != J && x.default.can(el.Permissions.CREATE_INSTANT_INVITE, J), [J]),
                    eT = null === et || !ed,
                    [ef] = l.useState(() => {
                        let e = new Set;
                ...
                }), ev = eR && !(null == J ? void 0 : J.isGuildVocal()) && eL, eU = (null == J ? void 0 : J.type) === el.ChannelTypes.GUILD_VOICE, eM = (0, m.default)(J);
                ...
                let [eD, eP] = l.useState({
                    ...
                    0 === eb && 0 === eF && !eV && ev ? eG({
                        ...
                        networkError: e,
                        showVanityURL: ev
                    }))), eF !== ec.value && eB !== ec.value && eG({
                        savedMaxAge: ec.value
                    })
                }, [ev, J, d, null == eh ? void 0 : eh.id, $, I, eF, eb, eV, V, eG, eB]), ej = (0, N.default)(J), eK = (0, N.default)(V), eW = ej !== J, eY = eK !== V;
                return l.useEffect(() => {
                    (eW || eY) && ek()
                }, [ek, eW, eY]), (0, i.jsx)(k, {
                    children: (0, i.jsx)(eI, {
                        ...
                        onClose: C,
                        canShowVanityURL: ev,
                        isGuestInviteCreationToggleEnabled: ex && ew,
                        shouldHideTemporaryInviteToggle: ex && ew || M === ei.InstantInviteModalPages.GUEST,
                        modalState: eD,
                        setModalState: eG,
                        changePage: ey,

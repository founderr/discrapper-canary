        ...
        918124: (e, t, n) => {
            ...
            var a = function(e) {
                var t = e.isPremium,
                    ...
                    T = !0 === (null == p ? void 0 : p.showTryPacksModalAndV2Copy),
                    C = !b && !y,
                    P = !t && (C || !S) && (E || O);
                if ((C || !S) && t && d) return {
                    type: c.JOIN_GUILD,
                ...
                if (b && !n && !y && t) return {
                    ...
                    description: T ? i.Z.Messages.INVENTORY_ADD_PACK_WITHOUT_JOINING_V2.format({
                        maxPacks: o.CJ
                    }) : i.Z.Messages.INVENTORY_ADD_PACK_WITHOUT_JOINING,
                    emojiDescription: I
                };
                if (b && !n && !y && !t) {
                    var R, h = (null !== (R = null == p ? void 0 : p.numPacksCollected) && void 0 !== R ? R : 0) > o.Lv,
                        N = h ? i.Z.Messages.INVENTORY_ADD_NITRO_DESCRIPTION_WITH_PLURAL.format({
                            maxFreePacks: o.Lv,
                            maxPacks: o.CJ
                    ...
                    return {
                        type: h ? c.GET_PREMIUM_INVENTORY_ENABLED : c.ADD_PACK,
                ...
                return b && !n && y ? {
                    ...
                    description: T ? null : i.Z.Messages.INVENTORY_REMOVE_PACK_DESCRIPTION,
                    emojiDescription: I
                } : {
                    type: c.UNAVAILABLE,
                    text: null,
...
//# sourceMappingURL=2a6ea24038b13b3ae277.js.map
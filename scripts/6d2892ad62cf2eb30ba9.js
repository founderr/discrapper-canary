    ...
    [24285, 29202, 91683, 58635, 84832, 88110, 86502, 96043, 53686, 71402], {
        ...
        980604: (e, t, n) => {
                ...
                var t = function(e) {
                    ...
                    switch (i.type) {
                        ...
                        case p.d4z.GUILD_STAGE_VOICE:
                            return {
                                type: _.h8.VOICE_CHANNEL, record: i, score: 0,
                                    comparator: o
                            };
                        default:
                            return {
            ...
            function $() {
                ...
                if (null != n) {
                    ...
                    if (T.length > 0) {
                        u.push((0, l.o6)(C.Z.Messages.QUICKSWITCHER_UNREAD_CHANNELS));
                        u = u.concat(T)
                    }
                }
            ...
            function te(e) {
                var t, n = e.query,
                    r = e.queryMode,
                    i = (0, E.O7)() ? void 0 : null !== (t = N.Z.getGuildId()) && void 0 !== t ? t : void 0,
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var _, p, E, h, O, I = encodeURIComponent(c.toString()),
                    ...
                    m = "".concat(s, "/?link=").concat(I, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(v, "&efr=").concat(y);

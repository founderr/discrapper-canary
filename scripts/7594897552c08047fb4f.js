    ...
    ["55514"], {
        ...
        264732: function(e, t, n) {
            ...
            var a = n("37983"),
                ...
                A = function(e) {
                    ...
                    }), D = (0, l.useStateFromStores)([u.default], () => u.default.didAgree(x)), j = D && !O, b = s.useMemo(() => !I && (A.isPrivate() && !A.isManaged() || null != x && (!A.isNSFW() || j) && v && d.default.canChatInGuild(x)), [v, j, A, x, I]), P = y ? S.ChannelTypesSets.GUILD_THREADS_ONLY.has(A.type) ? _.default.Messages.UPLOAD_TO_NEW_POST : _.default.Messages.UPLOAD_TO_NEW_THREAD : M ? _.default.Messages.UPLOAD_TO.format({
        ...
        176347: function(e, t, n) {
            ...
            class eO extends s.PureComponent {
                ...
                componentDidUpdate(e, t) {
                    ...
                    t.textValue.length < eI.MAX_MESSAGE_LENGTH && a.length >= eI.MAX_MESSAGE_LENGTH && eC.default.track(eI.AnalyticEvents.MESSAGE_LENGTH_LIMIT_REACHED, {})
                }
                ...
                constructor(...e) {
                    ...
                    super(...e), t = this, this.isFirstChange = !0, this.editorRef = null, this.state = {
                        ...
                        switch (e.which) {
                            ...
                            case eI.KeyboardKeys.ARROW_UP:
                                if (s || l) return;
                                if (e.preventDefault(), t) ec.default.getUploadCount(a.id, el.DraftType.ChannelMessage) > 0 ? em.ComponentDispatch.dispatchToLastSubscribed(eI.ComponentActions.FOCUS_ATTACHMENT_AREA) : em.ComponentDispatch.dispatchToLastSubscribed(eI.ComponentActions.FOCUS_MESSAGES, {
                                    atEnd: !0
                                });
                                else {
                                    let {
                        ...
                        if (null != s) {
                            if (s.inputType === v.ApplicationCommandInputType.BUILT_IN_INTEGRATION) return em.ComponentDispatch.dispatch(eI.ComponentActions.SHAKE_APP, {
                                duration: 200,
                                intensity: 2
                            }), Promise.resolve({
                                shouldClear: !1,
                        ...
                        return (0, eE.applyChatRestrictions)({
                            ...
                            if (!s) return l === eI.MessageRestrictionTypes.SLOWMODE_COOLDOWN ? (em.ComponentDispatch.dispatch(eI.ComponentActions.SHAKE_APP, {
                                duration: 200,
                                intensity: 2
                        ...
                        null != a && (P.SlateTransforms.select(a, []), a.insertText(e), null === (n = this.editorRef) || void 0 === n || n.focus())
                    ...
                    }), this.renderAppLauncherButton = () => (0, a.jsx)(O.default, {}), this.renderApplicationCommandIcon = (e, t, n) => (0, a.jsx)(D.default, {
                        className: n,
                        command: e,
                        section: t,
                        channel: this.props.channel
            ...
            class eD extends s.PureComponent {
                ...
                render() {
                    ...
                    t = N && n.type === eI.ChannelTypes.GUILD_VOICE ? ev.default.Messages.TEXT_IN_VOICE_A11Y_LABEL : N && n.type === eI.ChannelTypes.GUILD_STAGE_VOICE ? ev.default.Messages.TEXT_IN_STAGE_A11Y_LABEL : o.ChannelTypesSets.THREADS.has(n.type) ? ev.default.Messages.THREAD_A11Y_LABEL : ev.default.Messages.CHANNEL_A11Y_LABEL;
                    let I = (0, a.jsx)(en.default, {
                ...
                constructor(...e) {
                    super(...e), this.inputFormRef = s.createRef(), this.state = {
                        ...
                        return t.type === eI.ChannelTypes.DM && n ? (0, a.jsx)(J.default, {}) : null != l && (0, k.isCommunicationDisabled)(l) && null != s && !eu.default.can(eI.Permissions.ADMINISTRATOR, s) ? (0, a.jsx)(w.CommunicationDisabledBanner, {
                            guild: s,
                            disabledUntil: l
        ...
        952999: function(e, t, n) {
            ...
            function j(e) {
                ...
                let Q = "".concat(N.default.getArticleURL(R.HelpdeskArticles.GUILD_GETTING_STARTED), "?utm_source=discord&utm_medium=blog&utm_campaign=2020-06_help-new-user&utm_content=--t%3Apm");
                return (0, a.jsx)(L.default, {
                    channelId: t.id,
                    children: (0, a.jsx)("div", {
        ...
        986373: function(e, t, n) {
            ...
            function h(e) {
                let {
                    favoritesEnabled: t,
                    isFavoritesPerk: n
                } = (0, d.useFavoritesServerExperiment)("useCanFavoriteChannel"), a = (0, l.useStateFromStores)([u.default], () => u.default.isFavorite(e.id)), s = (0, l.useStateFromStores)([o.default], () => o.default.getCurrentUser()), i = e.isDM() || e.isThread(), r = !i || n && (null == s ? void 0 : s.isStaff()) === !0;
            ...
            function p() {
                let e = (0, l.useStateFromStores)([i.default], () => i.default.getChannels(f.FAVORITES))[s.ChannelTypes.GUILD_CATEGORY];
                return e.map(e => ({
        ...
        928328: function(e, t, n) {
            ...
            function M(e) {
                let {
                    ...
                    onSubmit: R,
                    onClose: x
                } = e, y = (0, d.default)(r), [O, D] = s.useState(!1), [j, b] = s.useState(L), [P, F] = s.useState(null), [U, H] = s.useState(o.shuffle(r)), [k, G] = s.useState(""), w = (0, h.useUID)(), B = (0, C.default)(j), V = (0, C.default)(O), W = (0, C.default)(P), z = (0, C.default)(R), Z = (0, C.default)(k), K = null != P && M.includes(P);
                return s.useEffect(() => {
                    !o.isEqual(y, r) && H((0, m.shuffleProblems)(r, N))
                }, [r, y, N]), s.useEffect(() => () => {
                    z.current({
                        rating: B.current,
                        problem: W.current,
                    ...
                    children: [(0, a.jsxs)(u.ModalHeader, {
                        ...
                        className: S.content,
                        children: [null == j || j === E.FeedbackRating.GOOD || K ? null : (0, a.jsx)(u.FormItem, {
                            title: l,
                    ...
                    if (r.has(p.GuildMemberFlags.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME)) {
                        if (null == e) {
                            ...
                            t.nick = [E.default.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_USERNAME_IN_GUILD.format({
                                guildName: null !== (c = s.name) && void 0 !== c ? c : ""
                            })]
        ...
        7643: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    onRejectSuccess: s,
                    onError: E
                } = e, g = (0, C.default)(), [S, _] = a.useState(!1), [A, T] = a.useState(!1), [M, N] = a.useState(!1), [I, v] = a.useState(!1), [L, R] = a.useState(!1), x = S || A || M, y = a.useCallback(async e => {
                    if (!x) {
                        _(!0);
                        try {
        ...
        789790: function(e, t, n) {
            ...
            function u(e) {
                ...
                } = e, g = C.state === r.MessageStates.SENDING, S = C.id === m, _ = (0, s.hasFlag)(C.flags, r.MessageFlags.EPHEMERAL), A = C.state === r.MessageStates.SEND_FAILED;
                return g || _ && !A ? null : (0, a.jsx)(i.default, {
                    className: o.buttons,
        ...
        227984: function(e, t, n) {
            ...
            let f = s.memo(function(e) {
                    let {
                        ...
                        repliedMessage: m,
                        roleIcon: E
                    } = e, g = (0, d.useContextMenuUser)(t.author.id, n.id), S = (0, d.useClickMessageAuthorUsername)(t, n, f, C), _ = (0, d.useClickMessageAuthorAvatar)(h, C), A = s.useCallback(() => C({
                        usernameProfile: !1,
                        avatarProfile: !1,
        ...
        144553: function(e, t, n) {
            ...
            let A = s.memo(function(e) {
                ...
                let {
                    ...
                    return null
                }, [x, y, N, O, D]), b = (0, l.useStateFromStores)([f.default], () => null != x && f.default.isBlocked(x.author.id), [x]), P = (0, g.useContextMenuUser)(null == x ? void 0 : x.author.id, N.id), F = (0, g.useClickReply)(T, x, b), U = (0, g.useClickReferencedMessageAuthorUsername)(x, N, v, R), H = (0, g.useClickReferencedMessageAuthorAvatar)(L, R), k = s.useCallback(() => R({
                    referencedUsernameProfile: !1,
            ...
            function C(e) {
                ...
                return Object.keys(e).filter(n => {
                    ...
                    let r = e[n].message_notifications !== o.UserNotificationSettings.NULL,
                        u = i.hasFlag(null !== (a = e[n].flags) && void 0 !== a ? a : 0, d.ChannelNotificationSettingsFlags.UNREADS_ALL_MESSAGES) || i.hasFlag(null !== (l = e[n].flags) && void 0 !== l ? l : 0, d.ChannelNotificationSettingsFlags.UNREADS_ONLY_MENTIONS);
                    return !t.ignoreUnreadSetting && u || !t.ignoreNotificationSetting && r || !t.ignoreMute && (0, s.computeIsMuted)(e[n])
                })
            }
        ...
        277796: function(e, t, n) {
            ...
            function l(e, t) {
                var n;
                return a.addFlag((n = e, a.removeFlags(n, s.GuildNotificationSettingsFlags.UNREADS_ALL_MESSAGES, s.GuildNotificationSettingsFlags.UNREADS_ONLY_MENTIONS)), t)
            }
            let i = e => a.removeFlags(e, s.ChannelNotificationSettingsFlags.UNREADS_ALL_MESSAGES, s.ChannelNotificationSettingsFlags.UNREADS_ONLY_MENTIONS);

            function r(e, t) {
                return a.addFlag(i(e), t)
            }
        },
        ...
        667137: function(e, t, n) {
            ...
            var I = s.memo(function(e) {
                let {
                    ...
                    ref: f,
                    width: p = 0
                } = (0, d.default)(), m = (0, o.useStateFromStores)([c.default], () => c.default.useReducedMotion), [S, A] = s.useState(!1), I = (0, _.default)(t), v = i && u && l;
                s.useEffect(() => {
                    v && A(!0);

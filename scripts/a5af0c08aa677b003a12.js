(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [12458], {
        ...
        727157: (e, t, n) => {
            e.exports = n.p + "543e3b4a61955716f951463b7cd1a18a.png"
        },
        727418: e => {
            "use strict";
            ...
            e.exports = function() {
                ...
                for (var c, u, a = o(e), l = 1; l < arguments.length; l++) {
                    c = Object(arguments[l]);
                    for (var s in c) n.call(c, s) && (a[s] = c[s]);
                    if (t) {
                        u = t(c);
                        for (var f = 0; f < u.length; f++) r.call(c, u[f]) && (a[u[f]] = c[u[f]])
                    }
                }
                return a
            }
        ...
        517563: (e, t, n) => {
            ...
            t.parse = function(e, t) {
                ...
                return Object.keys(r).sort().reduce((function(e, t) {
                    var n = r[t];
                    Boolean(n) && "object" == typeof n && !Array.isArray(n) ? e[t] = u(n) : e[t] = n;
                    return e
                }), Object.create(null))
            };
        ...
        285991: (e, t, n) => {
            ...
            function v() {
                v = p((function(e) {
                    var t, n, r, o, i, a, l, f, p, d = arguments;
                    return E(this, (function(E) {
                        switch (E.label) {
                            case 0:
                                t = d.length > 1 && void 0 !== d[1] ? d[1] : {}, n = t.friendToken, r = t.withMutualGuilds, o = t.withMutualFriendsCount, i = t.guildId, a = t.connectionsRoleId, l = d.length > 2 ? d[2] : void 0;
                                u.Z.dispatch({
                            ...
                            case 2:
                                ...
                                null != i && null != f.body.guild_member && u.Z.dispatch({
        ...
        258104: (e, t, n) => {
            ...
            function W(e, t, n, r) {
                var o = (0, p.Z)(n.application_id);
                if (null != o) {
                    var i = u.Z.getBasicChannel(t),
                        l = null != i && a.Z.canBasicChannel(E.S7T.CONNECT, i) || (null == i ? void 0 : i.type) === E.d4z.DM || (null == i ? void 0 : i.type) === E.d4z.GROUP_DM;
                    ! function(e, t) {
                        var n;
                    ...
                    if (l) {
                        var s, f = function(e, t, n, r, o) {
                                var i, c, u = new Map;
                                t.forEach((function(e) {
                                    u.set(e.user_id, e)
                                }));
                                return v(b({}, e), {
                                    name: null !== (i = e.name) && void 0 !== i ? i : O.Z.Messages.EMBEDDED_ACTIVITIES_UNKNOWN_ACTIVITY_NAME,
                                    type: null !== (c = e.type) && void 0 !== c ? c : E.IIU.PLAYING,
                                    url: n,
                                    connections: u,
                                    guildId: r,
                                    channelId: o
                            ...
                            d = c.default.getId(),
                            _ = w.get(f.application_id);
                        r.some((function(e) {
                            return e.user_id === d
                        })) && null != _ && w.set(_.application_id, b({}, _, f));
                        var I, y = (null !== (s = M.get(t)) && void 0 !== s ? s : []).filter((function(e) {
                                return e.application_id !== n.application_id
                            })),
                            T = Y(e),
                            S = (null !== (I = j.get(T)) && void 0 !== I ? I : []).filter((function(e) {
            ...
            var q = function(e) {
                ...
                r.getSelfEmbeddedActivityForChannel = function(e) {
                    var t;
                    return null !== (t = Array.from(w.values()).find((function(t) {
                        var n = t.channelId;
                        return e === n
                    }))) && void 0 !== t ? t : null
                };
                ...
                r.getEmbeddedActivitiesForGuild = function(e) {
                    var t;
                    return null !== (t = j.get(e)) && void 0 !== t ? t : D
                };
                ...
                r.getShelfActivities = function(e) {
                    var t, n = Y(e);
                    return null !== (t = x.get(n)) && void 0 !== t ? t : []
                };
                ...
                r.getGridOrientationLockStateForApp = function(e) {
                    var t, n;
                    return null !== (n = null !== (t = F.get(e)) && void 0 !== t ? t : H.get(e)) && void 0 !== n ? n : this.getOrientationLockStateForApp(e)
                };
            ...
            const $ = new q(o.Z, {
                ...
                CHANNEL_DELETE: function(e) {
                    ...
                    if (null != n) {
                        var r, o = Y(n),
                            i = (null !== (r = j.get(o)) && void 0 !== r ? r : []).filter((function(e) {
                ...
                EMBEDDED_ACTIVITY_LAUNCH_START: function(e) {
                    ...
                    L = !0;
                    K = t.channelId === l.Z.getChannelId() ? _.Ez.PANEL : _.Ez.PIP
                },
                ...
                EMBEDDED_ACTIVITY_OPEN: function(e) {
                    ...
                    if ((null === (t = w.get(o)) || void 0 === t ? void 0 : t.channelId) === n) return !1;
                    var l, f = u.Z.getChannel(n),
                        d = null == f ? void 0 : f.getGuildId(),
                        _ = s.default.getCurrentUser();
                    if (null == d && (null === (l = null == f ? void 0 : f.isPrivate()) || void 0 === l || !l) || null == _) return !1;
                    V = n;
                    var I, y = new Map,
                        T = _.id;
                    y.set(T, {
                    ...
                    w.set(o, {
                        ...
                        channelId: n,
                        application_id: o,
                        name: null !== (I = r.name) && void 0 !== I ? I : O.Z.Messages.EMBEDDED_ACTIVITIES_UNKNOWN_ACTIVITY_NAME,
                        url: i,
                        type: E.IIU.PLAYING,
                        connections: y,
                        connectedSince: Date.now()
                    });
                    Z.set(X(n, o), Date.now())
                },
                ...
                LOCAL_ACTIVITY_UPDATE: function(e) {
                    var t, n = e.activity;
                    if (null == n) return !1;
                    var r, o = w.get(null !== (t = n.application_id) && void 0 !== t ? t : "");
                    if (null == o) return !1;
                    w.set(o.application_id, v(b({}, o), {
                ...
                EMBEDDED_ACTIVITY_SET_CONFIG: function(e) {
                    var t = e.applicationId,
                        n = e.config,
                        r = w.get(t);
                    null != r && w.set(r.application_id, v(b({}, r), {
                        config: n
                    }))
                },
                ...
                EMBEDDED_ACTIVITY_FETCH_SHELF_SUCCESS: function(e) {
                    ...
                    n.forEach((function(e) {
                        var t = e.application_id,
                            n = e.client_platform_config[(0, d.Z)((0, f.Ij)())];
                        n.label_type === i.ww.NEW && null != n.label_until && new Date(n.label_until).getTime() > o && !m.seenActivities.includes(t) && (m.shouldShowNewActivityIndicator = !0);
                ...
                EMBEDDED_ACTIVITY_SET_ORIENTATION_LOCK_STATE: function(e) {
                    ...
                    null === o ? F.delete(t) : void 0 !== o && F.set(t, o)
                },
        ...
        959153: (e, t, n) => {
            ...
            var y = function(e, t) {
                ...
                T = new l.Z("TwoWayLinkDiscordConsentWeb");
            ...
            function S(e) {
                    ...
                    R = o.useCallback((n = (t = function(e) {
                        ...
                        return y(this, (function(u) {
                            switch (u.label) {
                                ...
                                case 1:
                                    u.trys.push([1, 3, , 4]);
                                    return [4, a.Z.completeTwoWayLink(i, t, n, r)];
                                case 2:
                                    o = u.sent();
                                    return [3, 4];
                                case 3:
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [null != v && (0, r.jsx)(u.ModalCloseButton, {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsxs)(o.ModalHeader, {
                        ...
                        children: (0, r.jsxs)(o.Button, {
                            ...
                            onClick: t,
                            children: [u.Z.Messages.TRY_AGAIN, (0, r.jsx)(c.Z, {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsxs)(i.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(i.Text, {
                            ...
                            color: "header-secondary",
                            children: a.Z.Messages.CONNECT_CONSOLE_LANDING_BODY_LEARN_MORE.format({
                                helpCenterLink: E
                            })
                        }) : null]
        ...
        797916: (e, t, n) => {
            ...
            function v(e) {
                ...
                o.useEffect((function() {
                    l.Z.subscribe("USER_CONNECTIONS_LINK_CALLBACK", g);
                    return function() {
                        l.Z.unsubscribe("USER_CONNECTIONS_LINK_CALLBACK", g)
                    }
                }), [g]);
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsxs)(a.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(a.Text, {
                            ...
                            variant: "heading-xl/extrabold",
                            children: A
                        }), null != v && (0, r.jsx)(a.ModalCloseButton, {
                        ...
                        children: (0, r.jsxs)(a.Button, {
                            ...
                            color: n ? a.Button.Colors.PRIMARY : a.Button.Colors.BRAND,
                            onClick: R,
        ...
        786648: (e, t, n) => {
            ...
            function s(e, t) {
                var n = l(r.useState(c.O.LANDING), 2),
                    a = n[0],
                    s = n[1],
                    f = (0, o.Z)(a),
                    p = l(r.useState(null), 2),
                    d = p[0],
                    _ = p[1],
                    E = l(r.useState(null), 2),
                    O = E[0],
                    I = E[1],
                ...
                r.useEffect((function() {
                    a !== f && i.default.track(u.rMx.ACCOUNT_LINK_STEP, {
                        location_stack: e,
                        previous_step: f,
                        current_step: a,
                        platform_type: t
        ...
        349491: (e, t, n) => {
            ...
            const s = (0, o.hN)((function(e) {
                var t = e.width,
                    ...
                    p = e.className,
                    d = e.foreground,
                    _ = l(e, ["width", "height", "color", "className", "foreground"]);
                return (0, r.jsx)("svg", a(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);

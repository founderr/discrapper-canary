            ...
            let u = e => {
                ...
                return (0, l.jsxs)("svg", {
                    ...
                    children: [(0, l.jsx)("path", {
                        d: "M7.70529 16.9545L11.3789 10.1863C11.5147 9.93598 11.5374 9.63963 11.4413 9.37157C11.3451 9.1035 11.1392 8.88916 10.8752 8.7823C9.77394 8.33652 9 7.25744 9 6C9 4.34314 10.3431 3 12 3C13.6569 3 15 4.34315 15 6C15 6.55228 15.4477 7 16 7C16.5523 7 17 6.55228 17 6C17 3.23857 14.7614 1 12 1C9.23858 1 7 3.23857 7 6C7 7.70185 7.85005 9.20359 9.14672 10.1062L5.94737 16.0007C4.86713 16.0286 4 16.913 4 18C4 19.1046 4.89543 20 6 20C6.74028 20 7.38663 19.5978 7.73244 19L16.2676 19C16.6134 19.5978 17.2597 20 18 20C19.1046 20 20 19.1046 20 18C20 16.8954 19.1046 16 18 16C17.2597 16 16.6134 16.4022 16.2676 17H7.73244C7.72358 16.9847 7.71453 16.9695 7.70529 16.9545Z",
                        fill: "string" == typeof u ? u : u.css,
                        className: i
                    }), (0, l.jsx)("path", {
                        d: "M13.8056 6.8612C13.9302 6.60038 14 6.30834 14 6C14 4.89543 13.1046 4 12 4C10.8954 4 10 4.89543 10 6C10 7.10457 10.8954 8 12 8C12.0529 8 12.1054 7.99794 12.1573 7.99391L16.676 14.5665C16.8625 14.8379 17.1707 15 17.5 15H18C19.6569 15 21 16.3431 21 18C21 19.6569 19.6569 21 18 21C17.2385 21 16.5454 20.7176 16.0159 20.2503C15.827 20.0836 15.5928 20.0011 15.3593 20H15.3498C15.0745 20.0013 14.801 20.1156 14.6044 20.3383C14.239 20.7523 14.2784 21.3843 14.6924 21.7497C15.5733 22.5272 16.7326 23 18 23C20.7614 23 23 20.7614 23 18C23 15.2473 20.7755 13.0141 18.0261 13.0001L13.8056 6.8612Z",
                        fill: "string" == typeof u ? u : u.css,
                        className: i
                    }), (0, l.jsx)("path", {
                        d: "M5.96844 13.8768C6.1061 14.4116 5.78411 14.9568 5.24926 15.0945C3.95512 15.4275 3 16.6035 3 18C3 19.6569 4.34315 21 6 21C6.7615 21 7.45461 20.7176 7.98406 20.2503C8.39813 19.8848 9.03007 19.9242 9.39553 20.3383C9.76099 20.7524 9.72157 21.3843 9.3075 21.7498C8.4267 22.5272 7.26735 23 6 23C3.23858 23 1 20.7614 1 18C1 15.6688 2.59442 13.7126 4.75074 13.1576C5.28559 13.0199 5.83078 13.3419 5.96844 13.8768Z",
                        fill: "string" == typeof u ? u : u.css,
                        className: i
                    })]
                })
            ...
            async function d(e, t) {
                ...
                try {
                    ...
                    return {
                        ...
                        body: {
                            guild_id: (C = u.body).guild_id,
                            members: C.members,
                            page_result_count: C.page_result_count,
                            total_result_count: C.total_result_count
                        }
                    }
                } catch (t) {

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["10524"], {
        ...
        458574: function(e, t, n) {
            ...
            function f(e, t, n) {
                let f = (0, u.default)([d.default], () => d.default.getChannel(e.parent_id));
        ...
        308798: function(e, t, n) {
            ...
            function C(e) {
                let t = e.isForumPost(),
                    C = (0, a.useStateFromStores)([o.default], () => e.isOwner(o.default.getId()), [e]),
                    {
                        canManageChannel: S,
                        canAccessChannel: v
                    ...
                    h = (0, a.useStateFromStores)([s.default], () => {
                        var t;
                    ...
                    N = t && (S || C && h < 1),
                    T = t && C && !S && h > 0 && null != _;
                return v && (S || N || T) ? (0, l.jsx)(u.MenuItem, {
                    id: "delete-channel",
                    label: (() => {
                    ...
                    action: () => (0, u.openModalLazy)(async () => {
                        ...
                        return n => (0, l.jsx)(t, {
                            ...n,
                            onConfirm: () => {
                                n.onClose(), T ? i.default.deleteMessage(e.id, e.id) : r.default.deleteChannel(e.id)
                            },
                            channel: e
                        })
                    })
        ...
        962199: function(e, t, n) {
            ...
            let o = !1,
                ...
                f = {},
                E = {},
                C = e => (E[e.guild_scheduled_event.id] = new d.default(e.guild_scheduled_event.guild), f[e.guild_scheduled_event.id] = e.guild_scheduled_event, {
        ...
        200008: function(e, t, n) {
            ...
            function c(e) {
                for (let t in e) {
                    ...
                    if (null == l || !l.isPrivate() && !i.default.can(s.Permissions.VIEW_CHANNEL, l)) {
                        delete e[t];
                        continue
                    }
                }
        ...
        986373: function(e, t, n) {
            ...
            function E(e) {
                ...
                } = (0, o.useFavoritesServerExperiment)("useCanFavoriteChannel"), l = (0, u.useStateFromStores)([s.default], () => s.default.isFavorite(e.id)), a = (0, u.useStateFromStores)([d.default], () => d.default.getCurrentUser()), r = e.isDM() || e.isThread(), i = !r || n && (null == a ? void 0 : a.isStaff()) === !0;
                return t && !__OVERLAY__ && !l && i
            }

            function C(e) {
                let t = (0, u.useStateFromStores)([s.default], () => s.default.getFavorite(e));
                return t
            }

            function S() {
                let e = (0, u.useStateFromStores)([r.default], () => r.default.getChannels(f.FAVORITES))[a.ChannelTypes.GUILD_CATEGORY];
                return e.map(e => ({
            ...
            function v() {
                let e = (0, u.useStateFromStores)([i.default], () => i.default.getGuildId());
            ...
            function h() {
                let {
                    isFavoritesPerk: e
                } = (0, o.useFavoritesServerExperiment)("useFavoriteAdded"), t = (0, c.useFavoritesTooltipStore)(), n = l.useCallback(() => {
                ...
                if (i.isBetween(s.start, s.end)) {
                    if (null != t) {
                        let e = a(t),
                            ...
                            u = e.isBetween(a(d).subtract(r.ACKED_RECENTLY_WINDOW_DAYS, "days"), d);
                        return n || u && !l ? void 0 : r.UpcomingGuildEventNoticeTypes.EVENT_STARTING_SOON
                    }
        ...
        534222: function(e, t, n) {
            ...
            function N(e, t) {
                return (0, a.useStateFromStoresArray)([d.default, u.default, c.default, s.default, r.default, i.default], () => {
                    let n = d.default.getGuild(e);
                    if (null == n) return _;
                    let l = n.hasFeature(h.GuildFeatures.HUB);
                    if (l) {
                        var a, f;
                        let e = null === (a = i.default.getDefaultChannel(n.id)) || void 0 === a ? void 0 : a.id,
                            t = null !== (f = u.default.getEventDirectoryEntries(e)) && void 0 !== f ? f : [];
                        return t.map(e => {
                            let t = e.scheduledEventId,
                                n = c.default.getGuildScheduledEvent(t);
                            return null != n ? n : u.default.getCachedGuildScheduledEventById(t)
            ...
            function T(e) {
                return (0, a.useStateFromStores)([c.default, r.default, s.default], () => {
            ...
            function I(e) {
                var t, n;
                let l = (t = e, (0, a.useStateFromStoresArray)([c.default, r.default, s.default], () => {
                    ...
                    u = (0, a.useStateFromStoresObject)([E.default], () => E.default.getAllEventDismissals()),
                    i = (0, a.useStateFromStoresObject)([E.default], () => E.default.getAllUpcomingNoticeSeenTimes()),
                    d = (0, a.useStateFromStoresObject)([c.default], () => null == l ? {} : l.reduce((e, t) => {
                ...
                if (null != l && null != d)
                    for (let e = 0; e < l.length; e++) {
                        ...
                        let t = l[e],
                            ...
                            o = (0, f.getNextShownUpcomingEventNoticeType)(t, a, r, s);
                        if (null != o) return {
                            upcomingEvent: t,
                            noticeType: o
                        }
            ...
            function p(e) {
                return (0, a.useStateFromStores)([r.default, c.default], () => {
            ...
            function y(e) {
                ...
                let u = (0, a.useStateFromStores)([c.default], () => null == e ? [] : c.default.getGuildScheduledEventsByIndex(c.StaticGuildEventIndexes.CHANNEL_EVENT_UPCOMING(e)), [e, t]),
                    r = l.useMemo(() => u.filter(e => {
                        let {
                            startTime: t,
                            endTime: n
                        ...
                        return e.status !== v.GuildScheduledEventStatus.ACTIVE && l && a < 15
                    }), [u]);
                return r
            }
        },

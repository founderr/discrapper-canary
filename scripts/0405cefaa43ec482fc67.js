(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [83966, 14136, 84832, 88110, 96043, 71402, 77357, 56645], {
        737264: e => {
            "use strict";
        ...
        825781: (e, t, n) => {
            ...
            var d, p, _, E, h, I, O, g, v, b = o.QZA.CLOSED,
                T = {},
                m = !1;
        ...
        100856: (e, t, n) => {
            ...
            function T(e, t) {
                ...
                if (!m && !_.Z.can(v.Plq.MOVE_MEMBERS, T)) return null;
                var S = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== T.id && (m ? _.Z.can(v.Plq.CONNECT, n) && !(0, O.rY)(n, I.Z, p.Z) : _.Z.can(v.Plq.MOVE_MEMBERS, n) && (_.Z.can(v.Plq.CONNECT, n) || g.ZP.can({
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, E, h, I, O = encodeURIComponent(c.toString()),
                    ...
                    v = (E = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), h = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(E)), I = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !h, "iOS" !== (null === i() || void 0 === i() || null === (_ = i().os) || void 0 === _ ? void 0 : _.family) || I ? 1 : 0),
                    b = null != r ? encodeURIComponent(r) : null,
                    T = null != o ? encodeURIComponent(o) : null,
                    m = "".concat(f, "/?link=").concat(O, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(g, "&efr=").concat(v);
                null != b && (m += "&afl=".concat(b));

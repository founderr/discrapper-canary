    ...
    [44299, 40056, 58093, 65091], {
                ...
                if (n > 1) {
                    if (e + n > (i = this._capacity)) {
                        for (var r = n - 1; r >= 0; r--) {
                            ...
                            this[s = (this._front - 1 & i - 1 ^ i) - i] = arguments[r];
                            e++;
                            this._length = e;
                            this._front = s
                        }
                    ...
                    for (r = n - 1; r >= 0; r--) {
                        var s;
                        this[s = (o - 1 & i - 1 ^ i) - i] = arguments[r];
                        o = s
                    }
                    this._front = o;
                    this._length = e + n;
                ...
                if ("IntersectionObserver" in t && "IntersectionObserverEntry" in t && "intersectionRatio" in t.IntersectionObserverEntry.prototype) "isIntersecting" in t.IntersectionObserverEntry.prototype || Object.defineProperty(t.IntersectionObserverEntry.prototype, "isIntersecting", {
                    ...
                    i.prototype._computeTargetAndRootIntersection = function(n, r) {
                        if ("none" != t.getComputedStyle(n).display) {
                            for (var i, o, s, c, l, h, f, p, v = a(n), g = u(n), d = !1; !d;) {
                                var y = null,
                                ...
                                if (g == this.root || g == e) {
                                    d = !0;
                                    y = r
                                } else g != e.body && g != e.documentElement && "visible" != m.overflow && (y = a(g));
                                if (y && !(v = (i = y, o = v, s = void 0, c = void 0, l = void 0, h = void 0, f = void 0, p = void 0, s = Math.max(i.top, o.top), c = Math.min(i.bottom, o.bottom), l = Math.max(i.left, o.left), h = Math.min(i.right, o.right), p = c - s, (f = h - l) >= 0 && p >= 0 && {
                                        top: s,
                                        bottom: c,
                                        left: l,
                                        right: h,
        ...
        58964: (t, e, n) => {
            ...
            function v(t, e) {
                ...
                var p, v, g, d, y, m = encodeURIComponent(c.toString()),
                    b = encodeURIComponent(a()),
                    _ = (g = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"),
                        d = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(g)), y = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !d, "iOS" !== (null === i() || void 0 === i() || null === (v = i().os) || void 0 === v ? void 0 : v.family) || y ? 1 : 0),
                    w = null != r ? encodeURIComponent(r) : null,
                    O = null != o ? encodeURIComponent(o) : null,
                    E = "".concat(h, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(b, "&efr=").concat(_);
                null != w && (E += "&afl=".concat(w));
                null != O && (E += "&ifl=".concat(O));
                return E
            }
        },
        426080: (t, e, n) => {
        ...
        498964: (t, e, n) => {
            ...
            const E = h(m((function(t) {
                    return !0
                }))),
                I = E,
                x = t => Object.assign(h(t), {
                    startsWith: e => {
                        return x(d(t, (n = e, m((t => w(t) && t.startsWith(n))))));
                        var n
                    },
                    endsWith: e => {
                        return x(d(t, (n = e, m((t => w(t) && t.endsWith(n))))));
                        var n
                    },
                    minLength: e => x(d(t, (t => m((e => w(e) && e.length >= t)))(e))),
                    maxLength: e => x(d(t, (t => m((e => w(e) && e.length <= t)))(e))),
                    includes: e => {
                        return x(d(t, (n = e, m((t => w(t) && t.includes(n))))));
                        var n
                    },
                    regex: e => {
                        return x(d(t, (n = e, m((t => w(t) && Boolean(t.match(n)))))));
                        var n
                    }
                }),
                R = x(m(w)),
                T = (t, e) => m((n => _(n) && t <= n && e >= n)),
                A = t => m((e => _(e) && e < t)),
                S = t => m((e => _(e) && e > t)),
                k = t => m((e => _(e) && e <= t)),
                C = t => m((e => _(e) && e >= t)),

    ...
    ["89995"], {
                    ...
                    children: [(0, n.jsx)("div", {
                        ...
                        children: [(0, n.jsxs)(u.FormItem, {
                            ...
                            onScheduleChange: e => {
                                ...
                                null != t && null != P && (null == a ? void 0 : a.isBefore(t)) && (n.scheduledEndTime = t.add(1, "hour").toISOString()), D(n)
                            },
                            ...
                            className: i(N.formItem, N.autoStartToggle),
                            children: (0, n.jsx)(u.Checkbox, {
                                type: u.Checkbox.Types.INVERTED,
                                value: B,
                                onChange: (e, t) => {
        ...
        590942: function(e, t, a) {
            ...
            function B(e) {
                let {
                    ...
                    valid: !0
                }], [_]), O = Object.keys(l).length, y = (0, h.isGuildScheduledEventActive)(a), U = y ? l.SETTINGS : l.ENTITY, j = e => Math.max(0, Math.min(e, O - 1)), [P, B] = i.useState(U), [H, b] = i.useState(!1), F = i.useMemo(() => N.slice(0, P + 1).map(e => e.valid).every(Boolean), [N, P]), Y = P >= N.length ? l.SUCCESS : N[j(P)].slideId, w = Y === l.SUCCESS, k = (0, g.useGuildEventModalStore)(e => e.onUpdateCanCloseModal);
                k(w);
            ...
            function H(e) {
                ...
                }, V = (0, _.default)(E, null == I ? void 0 : I.id, g), [H, {
                    loading: b,
                    error: F
                }] = (0, L.default)(async () => {
                    if (null != G) return;
                ...
                return (0, s.jsx)(B, {
                    ...
                    onChange: e => {
                        if (null != e.entityType) {
                            var a;
                            let n = (0, N.getChannelTypeFromEntity)(e.entityType),
        ...
        560309: function(e, t, a) {
            ...
            let y = e => e === v.GuildScheduledEventEntityTypes.EXTERNAL,
                ...
                x = e => {
                    let {
                        ...
                        disabled: i,
                        entityType: r
                    } = e, o = a === G.ChannelTypes.GUILD_STAGE_VOICE, E = (0, N.isChannelPublic)(l, r), _ = (0, M.useGetEventChannelsByType)(t, a);
            ...
            function H(e) {
                let {
                    ...
                    guildEvent: a,
                    onChange: s
                } = e, i = (0, r.useStateFromStores)([E.default], () => E.default.getGuild(t), [t]), u = (0, A.default)(t, void 0), o = (0, A.default)(t, G.ChannelTypes.GUILD_VOICE), _ = (0, A.default)(t, G.ChannelTypes.GUILD_STAGE_VOICE), c = (0, M.useGetEventChannelsByType)(t, G.ChannelTypes.GUILD_VOICE), T = (0, m.useChannelsUserCanStartStageIn)(i), C = null == i ? void 0 : i.hasFeature(G.GuildFeatures.COMMUNITY), h = (0, p.isGuildScheduledEventActive)(a), N = V(s, a), g = l.useMemo(() => {
                    let e = [{
            ...
            function b(e) {
                let {
                    ...
                    entityType: o
                } = l, c = (0, r.useStateFromStores)([E.default], () => E.default.getGuild(t), [t]), T = (0, m.useChannelsUserCanStartStageIn)(c), I = (0, r.useStateFromStores)([_.default], () => _.default.can(G.Permissions.MANAGE_CHANNELS, c)), f = null == c ? void 0 : c.hasFeature(G.GuildFeatures.COMMUNITY), C = V(i, l), L = f && !y(o) && 0 === T.length && I && null != o;
                return (0, n.jsxs)("div", {
        ...
        151859: function(e, t, a) {
            ...
            function p(e) {
                ...
                let {
                    ...
                    guildEventId: N,
                    error: g
                } = e, S = l.useMemo(() => (0, c.convertToFakeGuildEvent)(m, M), [m, M]), {
                    channel_id: v,
                    name: G,
                    image: D,
                    description: O
                } = S, y = (0, s.useStateFromStores)([u.default], () => u.default.getChannel(v), [v]), U = (0, s.useStateFromStores)([o.default], () => o.default.getGuild(M), [M]), x = (0, T.getLocationFromEvent)(S), R = (0, s.useStateFromStores)([E.default], () => null != m.creatorId ? E.default.getUser(m.creatorId) : E.default.getCurrentUser(), [m.creatorId]), j = (0, s.useStateFromStores)([d.default], () => d.default.isLurking(M), [M]), P = (0, r.getChannelIconComponent)(y, U);
                return (0, n.jsxs)("div", {
                    className: h.content,
                    children: [(0, n.jsx)(f.default, {
                        ...
                        name: G,
                        description: O,
                        imageSource: (p = (0, c.convertToFakeGuildEvent)(m, M, N), null == (A = D) && null == p.image ? null : null != A && /^data:/.test(A) ? A : (0, I.default)(p)),
                        isActive: !1,
                        isUserLurking: j,
                        speakers: [],
                        speakerCount: 0,
        ...
        499950: function(e, t, a) {
            ...
            function g(e) {
                ...
                let {
                    ...
                    channel_id: x,
                    id: R
                } = null != v ? v : {}, j = (0, l.useStateFromStores)([c.default], () => {
                    let e = null != x ? x : D;
                    return null == e ? null : c.default.getInvite(e)
                }, [x, D]);
                if (null == v) return S(), null;
                let P = U && null !== (t = null == O ? void 0 : O.vanityURLCode) && void 0 !== t ? t : null == j ? void 0 : j.code,
                    V = null != P ? (0, i.generateInviteKeyFromExtraData)({
                        baseCode: P,
                        guildScheduledEventId: R
                    }) : null,
                    B = null == V || null == j,
                    H = (0, d.default)(null != V ? V : ""),
                    b = null !== (a = null == j ? void 0 : j.maxAge) && void 0 !== a ? a : m.value,
                    F = null !== (g = null == j ? void 0 : j.maxUses) && void 0 !== g ? g : N.value;
                return (0, n.jsxs)("div", {
                    ...
                    if (null != (t = null != r && /^data:/.test(r) ? r : C(r)) ? a = 'url("'.concat(t, '")') : null != f && (l = (0, n.jsx)("div", {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [l, A && (0, n.jsx)("div", {
                                className: i(T.imageUploaderIcon, T.imageUploaderIconDisabled, N),
                                children: S
                            })]
                        })
                    });
        ...
        650484: function(e, t, a) {
            ...
            function T(e) {
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [null === (o = null == m ? void 0 : null === (r = m.options) || void 0 === r ? void 0 : r.renderHeader) || void 0 === o || o ? T : null, m.renderStep(f), null == C || N ? null : (0, n.jsxs)(n.Fragment, {

    ...
    [62790], {
            ...
            var g = function(e) {
                ...
                E = function(e) {
                    var t = e.user,
                        ...
                        d = null;
                    n && (d = i ? b.Z.Messages.STAGE_SPEAKER : s ? b.Z.Messages.STAGE_MODERATOR_TOOLTIP : b.Z.Messages.STAGE_AUDIENCE);
                    return (0, r.jsxs)("div", {
                        className: h().user,
        ...
        270897: (e, t, n) => {
            ...
            function _(e) {
                var t, n = e.channel,
                    d = e.transitionState,
                    y = e.onClose,
                    _ = g(e, ["channel", "transitionState", "onClose"]),
                    j = (0, i.Dt)(),
                    m = (0, a._d)(n.id),
                    C = (t = h((function() {
                ...
                return (0, r.jsx)(o.ModalRoot, v(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                ...
                null != e.scrollPosition && null != g && (_[g] = e.scrollPosition);
            ...
            var L = function(e) {
                ...
                r.hasChanges = function() {
                    return null != C && null != m && (!(!this.isOpen() && w !== s.cII.USER_SETTINGS) && !o().isEqual(C, m))
                };
                r.isOpen = function() {
                    return P
                };
                ...
                r.getProps = function() {
                    return {
                        submitting: S === s.QZA.SUBMITTING,
                        section: g,
                        subsection: null != g ? E[g] : null,
                        scrollPosition: null != g ? _[g] : null,
                        settings: C,
                        errors: j,
            ...
            const U = new L(c.Z, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(e) {
                    if (S !== s.QZA.SUBMITTING) return !1;
                    S = s.QZA.OPEN;
                    g = s.oAB.ACCOUNT;
                    var t;
                    j = null !== (t = e.errors) && void 0 !== t ? t : {}
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    w = e.tab;
                    return null == g && w === s.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

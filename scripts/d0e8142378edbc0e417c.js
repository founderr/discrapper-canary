    ...
    [33227], {
        ...
        505633: (e, t, n) => {
            ...
            function f(e) {
                ...
                return {
                    ...
                    userInstall: "true" === n.user_install
                }
            }
        },
        12212: (e, t, n) => {
            ...
            function h() {
                h = l((function(e) {
                    ...
                    return c(this, (function(c) {
                        switch (c.label) {
                            case 0:
                                t = e.authorize, n = e.clientId, r = e.scopes, o = e.responseType, a = e.redirectUri, l = e.codeChallenge,
                                    u = e.codeChallengeMethod, f = e.state, h = e.permissions, d = e.guildId, p = e.channelId, O = e.userInstall;
                                return [4, i.ZP.post({
            ...
            function p() {
                return (p = l((function(e) {
                    ...
                    return c(this, (function(c) {
                        switch (c.label) {
                            case 0:
                                t = e.clientId, n = e.scopes, r = e.responseType, o = e.redirectUri, a = e.codeChallenge, l = e.codeChallengeMethod, u = e.state, f = e.userInstall;
                                return [4, i.ZP.get({
                                    url: s.ANM.OAUTH2_AUTHORIZE,
                                    query: {
                                        client_id: t,
        ...
        933227: (e, t, n) => {
            ...
            n.d(t, {
                ...
                OAuth2AuthorizePage: () => Je,
                getOAuth2AuthorizeProps: () => ot,
                openOAuth2Modal: () => it,
                useOAuth2AuthorizeForm: () => nt
            });
            var r = n(785893),
                i = n(667294),
                o = n(751615),
            ...
            const k = (0, L.hN)((function(e) {
                var t = e.width,
                    ...
                    l = e.foreground,
                    c = G(e, ["width", "height", "color", "foreground"]);
            ...
            function K(e) {
                return null != e.privacy_policy_url && null != e.terms_of_service_url ? X.Z.Messages.OAUTH2_DETAILS_PRIVACY_POLICY_WITH_LINKS.format({
                    application: e.name,
                    privacyPolicyURL: e.privacy_policy_url,
                    termsOfServiceURL: e.terms_of_service_url
                }) : null != e.privacy_policy_url ? X.Z.Messages.OAUTH2_DETAILS_PRIVACY_POLICY_WITH_PRIVACY_POLICY_LINK.format({
                    application: e.name,
                    privacyPolicyURL: e.privacy_policy_url
                }) : null != e.terms_of_service_url ? X.Z.Messages.OAUTH2_DETAILS_PRIVACY_POLICY_WITH_TERMS_OF_SERVICE_LINK.format({
                    application: e.name,
                    termsOfServiceURL: e.terms_of_service_url
                }) : X.Z.Messages.OAUTH2_DETAILS_PRIVACY_POLICY.format({
                    application: e.name
                })
            }
            var $ = n(2590),
            ...
            function te(e) {
                var t, n, i = e.application,
                    ...
                    l = e.isEmbeddedFlow,
                    c = e.embeddedActivityConfig,
                    u = new Date(z.Z.extractTimestamp(i.id)),
                    f = (0,
                        N.W3)(o),
                    h = (0, Y.yE)(null !== (t = i.flags) && void 0 !== t ? t : 0, $.udG.EMBEDDED);
                if (null != s && !h && !l) {
                    var d = new URL(s);
                    n = null != d.host && d.host.length > 0 ? d.origin : d.href
                }
                return (0, r.jsxs)("div", {
                    className: ee().applicationDetails,
                    children: [null != n ? (0, r.jsx)(ne, {
                        className: ee().redirectWarning,
                        icon: W.Z,
                        text: X.Z.Messages.OAUTH2_DETAILS_REDIRECT.format({
                            origin: n
                        })
                    }) : null, (0, r.jsx)(ne, {
                        icon: q.Z,
                        ...
                        icon: D.Z,
                        text: X.Z.Messages.OAUTH2_DETAILS_CREATION_DATE.format({
                            date: u
                        })
                    }), o.includes(Q.xV.BOT) && null != a ? (0, r.jsx)(ne, {
                        icon: B.Z,
                        text: X.Z.Messages.OAUTH2_DETAILS_GUILDS.format({
                            guildCount: a
                        })
                    }) : null, (0, r.jsx)(ne, {
                        icon: F.Z,
                        text: f
                    }), (null == c ? void 0 : c.has_csp_exception) ? (0, r.jsx)(ne, {
                        icon: k,
                        text: X.Z.Messages.OAUTH2_SCOPES_IP_LOCATION_SCOPE
                    }) : null]
                })
            }
            ...
            function ne(e) {
                var t = e.icon,
                    ...
                    i = e.className;
                return (0, r.jsxs)("div", {
                    className: M()(ee().entry, i),
                    children: [(0, r.jsx)(t, {
                        className: ee().entryIcon
                    }), (0, r.jsx)(x.x, {
                        variant: "text-xs/medium",
                        color: "text-muted",
                        className: ee().entryInner,
                        children: n
                    })]
                })
            }
            ...
            function fe(e) {
                ...
                var l, c = n.map((function(e) {
                        var t, o = (0, N.jW)(e, n),
                            s = ue(null !== (t = null == i ? void 0 : i[e]) && void 0 !== t ? t : [], 1)[0];
                        return (0, r.jsxs)("div", {
                            className: le().scope,
                            children: [(0, r.jsx)("div", {
                                className: le().scopeCheck,
                                children: (0, r.jsx)(oe.Z, {
                                    className: le().icon
                                })
                            }), (0, r.jsxs)("div", {
                                className: le().scopeInner,
                    ...
                    u = (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            children: (0, r.jsx)(x.x, {
                                ...
                                className: le().scopeName,
                                children: a()
                            })
                        })]
                    }),
                    f = s ? X.Z.Messages.OAUTH2_SCOPES_LABEL_TRUSTED_NAME : X.Z.Messages.OAUTH2_SCOPES_LABEL;
                return (0, r.jsxs)("div", {
                    className: le().scopes,
                    children: [(0, r.jsx)(ie.X, {
                        variant: "heading-deprecated-12/semibold",
                        className: le().sectionLabel,
                        children: f.format({
            ...
            function ye(e) {
                ...
                var h = j.VY.filter((function(e) {
                    ...
                    d = h.filter((function(e) {
                        ...
                        var t = (0, j.wt)(e),
                            n = !a.Z.has(o, e);
                        return (0, r.jsx)("li", {
                            className: pe().permission,
                            children: (0, r.jsx)(he.X, {
                                value: n,
                                onChange: function(t, n) {
                                    return s(n, e)
                                },
                                type: he.X.Types.INVERTED,
                                children: (0, r.jsx)(x.x, {
                                    variant: "text-md/normal",
                                    children: t
                                })
                    ...
                    p = h.filter((function(e) {
                        ...
                        return (0, r.jsxs)("li", {
                            className: pe().permission,
                            children: [(0, r.jsx)("div", {
                                className: pe().disabledPermissionIcon,
                                children: (0, r.jsx)(se.Z, {
                                    className: pe().icon
                                })
                            }), (0, r.jsx)(x.x, {
                ...
                return (0, r.jsxs)("div", {
                    className: pe().botPermissions,
                    children: [(0, r.jsx)(x.x, {
                        variant: "text-sm/medium",
                        color: "header-secondary",
                        className: pe().permissionsLabel,
                        children: X.Z.Messages.OAUTH2_CONFIRM_BOT_PERMISSIONS.format({
                            applicationName: t.name,
                            guildName: l.name
                        })
                    }), (0, r.jsx)("ul", {
                        className: pe().permissionsList,
                        children: d
                    }), p.length > 0 ? (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsx)(x.x, {
                            variant: "text-sm/medium",
                            color: "header-secondary",
                            className: pe().disabledPermissionsLabel,
                            children: X.Z.Messages.OAUTH2_DISABLED_PERMISSIONS.format({
                                applicationName: t.name
                            })
                        }), (0, r.jsx)("ul", {
                            className: pe().permissionsList,
            ...
            function Ie(e) {
                var t = e.error,
                    ...
                    c = o.filter((function(e) {
                        return a.Z.has(e.permissions, $.Plq.MANAGE_GUILD)
                    })).map((function(e) {
                        return {
                            value: e.id,
                            label: e.name
                ...
                return (0, r.jsxs)("div", {
                    className: ve().selectorGroup,
                    children: [(0, r.jsx)(ie.X, {
                        variant: "heading-deprecated-12/semibold",
                        className: ve().sectionLabel,
                        children: X.Z.Messages.OAUTH2_ADD_TO_GUILD
                    }), null != t && "" !== t ? (0, r.jsx)(x.x, {
                        variant: "text-xs/normal",
                        color: "text-danger",
                        children: t
                    }) : null, (0, r.jsx)(be.V, {
                        wrapperClassName: ve().wrapper,
                        className: ve().select,
                        maxVisibleItems: 5,
                        value: n,
                        placeholder: X.Z.Messages.OAUTH2_ADD_TO_GUILD_PLACEHOLDER,
                        options: c,
                        onChange: function(e) {
                            i(e)
                        },
                        ...
                        color: "header-secondary",
                        className: ve().label,
                        children: X.Z.Messages.OAUTH2_ADD_TO_GUILD_DESCRIPTION.format()
                    })]
                })
            }
            ...
            function Te(e) {
                ...
                return null == t ? null : (0,
                    ...
                    children: [(0, r.jsx)(ie.X, {
                        variant: "heading-deprecated-12/semibold",
                        className: ve().sectionLabel,
                        children: X.Z.Messages.OAUTH2_ADD_WEBHOOK_INCOMING
                    }), null != s && "" !== s ? (0, r.jsx)(x.x, {
                        variant: "text-xs/normal",
                        color: "text-danger",
                        children: s
                    }) : null, (0, r.jsx)(be.V, {
                        ...
                        placeholder: X.Z.Messages.SCOPE_WEBHOOK_INCOMING_CHANNEL_PLACEHOLDER,
                        value: n,
                        options: u
                    }), (0, r.jsx)(x.x, {
                        variant: "text-xs/normal",
                        color: "header-secondary",
                        className: ve().label,
                        children: X.Z.Messages.SCOPE_WEBHOOK_INCOMING_DESCRIPTION
                    })]
                })
            }
            var we = n(325290),
            ...
            function De(e) {
                var t = e.id,
                    ...
                    l = e.location,
                    c = e.isTrustedName,
                    u = Ce.ZP.getApplicationIconURL({
                        id: i.id,
                        icon: i.icon
                    }),
                    f = Ce.ZP.getUserAvatarURL(n);
                return (0, r.jsxs)("header", {
                    id: t,
                    className: xe().header,
                    children: [(0,
                        r.jsxs)("div", {
                        className: xe().headerIcons,
                        children: [(0, r.jsx)(we.q, {
                            src: u,
                            size: Re.EF.SIZE_80,
                            "aria-label": i.name
                        }), (0, r.jsxs)("div", {
                            className: xe().ellipseGroup,
                            children: [(0, r.jsx)("div", {
                        ...
                        color: "header-secondary",
                        className: xe().label,
                        children: X.Z.Messages.OAUTH2_THIRD_PARTY_APPLICATION
                    }), (0, r.jsxs)(x.x, {
                        variant: "text-lg/bold",
                        color: "header-primary",
                        children: [i.name, null != o ? (0, r.jsx)(Ne.Z, {
                            className: xe().botTag,
                            verified: null != o.public_flags && (0, Y.yE)(o.public_flags, $.xW$.VERIFIED_BOT)
                        }) : null]
                    }), s.length > 0 ? (0, r.jsx)(x.x, {
                        variant: "text-md/normal",
                        color: "header-secondary",
                        className: xe().label,
                        children: X.Z.Messages.OAUTH2_REQUESTS_ACCOUNT_ACCESS
                    }) : (0, r.jsx)(x.x, {
                        variant: "text-md/normal",
                        color: "header-secondary",
                        className: xe().label,
                        children: X.Z.Messages.OAUTH2_CONNECT_TO_DISCORD
                    }), a ? (0, r.jsx)("div", {
                        className: xe().currentUser,
                        children: (0, r.jsxs)(x.x, {
                            variant: "text-sm/normal",
                            color: "text-muted",
                            children: [X.Z.Messages.OAUTH2_SIGNED_IN_AS.format({
                                userHook: function() {
                                    return (0, r.jsxs)(x.x, {
                                        className: xe().currentUserTag,
                                        variant: "text-sm/normal",
                                        children: [n.username, !n.isPomelo() && (0, r.jsx)(x.x, {
                                            className: xe().currentUserDiscriminator,
                                            variant: "text-sm/normal",
                                ...
                                tag: "a",
                                className: xe().logoutLink,
                                onClick: function() {
                                    return (0, P.c$)(l)
                                },
                                children: X.Z.Messages.OAUTH2_LOGOUT
                            })]
                        })
                    }) : null]
                })
            ...
            ! function(e) {
                e[e.INSTALL_TYPE = 0] = "INSTALL_TYPE";
                e[e.AUTHORIZE_SCOPES = 1] = "AUTHORIZE_SCOPES";
                e[e.AUTHORIZE_BOT_PERMISSIONS = 2] = "AUTHORIZE_BOT_PERMISSIONS"
            }(Ke || (Ke = {}));

            function Je() {
                var e = (0, o.TH)(),
                    t = i.useMemo((function() {
                        return (0, A.y)(e.search)
                    }), [e.search]);
                (0, E.Z)();
                return (0, r.jsx)(Le.G, {
                    children: (0, r.jsx)(tt, Fe(Be({}, t), {
                        showLogout: !0
                    }))
                })
            }
            ...
            function et(e) {
                var t = e.transitionState,
                    n = Ye(e, ["transitionState"]);
                return (0, r.jsx)(Le.j, {
                    transitionState: t,
                    "aria-labelledby": Qe,
                    children: (0, r.jsx)(tt, Fe(Be({}, n), {
                        scrollable: !0
                    }))
                })
            }
            ...
            function nt(e) {
                var t, n, u, f = e.clientId,
                    ...
                    U = e.permissions,
                    V = e.prompt,
                    H = e.disableGuildSelect,
                    G = e.showLogout,
                    k = void 0 !== G && G,
                    W = e.authorization,
                    q = e.callback,
                    B = e.callbackWithoutPost,
                    F = e.onClose,
                    Y = e.cancelCompletesFlow,
                    z = void 0 === Y || Y,
                    K = e.isTrustedName,
                    Q = void 0 !== K && K,
                    J = e.isEmbeddedFlow,
                ...
                y.Z.useExperiment({
                    location: "auth"
                }).userAppsTreatment === y.e.ALLOWED || (re = !1);
                var se, ae = ze(i.useState(Xe.NOT_LOADED), 2),
                    le = ae[0],
                    ce = ae[1],
                    ue = ze(i.useState(null), 2),
                    he = ue[0],
                    de = ue[1],
                    pe = ze(i.useState(m.ZP.NONE), 2),
                    Oe = pe[0],
                    Ee = pe[1],
                    be = ze(i.useState(Ke.AUTHORIZE_SCOPES), 2),
                    ge = be[0],
                    ve = be[1],
                    Se = ze(i.useState(null), 2),
                    me = Se[0],
                    _e = Se[1],
                    Ae = ze(i.useState(N.Qe.filter((function(e) {
                        return ie.includes(e)
                    }))), 1)[0],
                    Pe = ze(i.useState(null != L ? L : null), 2),
                    we = Pe[0],
                    je = Pe[1],
                    Ne = ze(i.useState(null != Z ? Z : null), 2),
                    Ce = Ne[0],
                    Re = Ne[1],
                    Me = ze(i.useState(!1), 2),
                    xe = Me[0],
                    Le = Me[1],
                    Ve = i.useMemo((function() {
                        var e;
                        return null == he || null === (e = he.guilds) || void 0 === e ? void 0 : e.find((function(e) {
                            return e.id === we
                        }))
                    }), [null == he ? void 0 : he.guilds, we]),
                    Ge = (0, l.cj)([d.Z, p.ZP], (function() {
                        var e, t, n = null === (e = p.ZP.getSelfEmbeddedActivities().values().next()) || void 0 === e ? void 0 : e.value,
                            r = d.Z.getIsEnabled();
                        if ((0, S.lm)(n)) {
                            t = p.ZP.getShelfActivities(n.guildId).find((function(e) {
                                return e.application_id === n.application_id
                            }));
                            if (r && void 0 === t) {
                                var i;
                                t = null === (i = d.Z.getDeveloperShelfItems().find((function(e) {
                                    return e.id === n.application_id
                                }))) || void 0 === i ? void 0 : i.embeddedActivityConfig
                            }
                            if ((0, S.lm)(t)) return Be({}, Ue.wT, t)
                        }
                        return {}
                    })),
                    ke = Object.keys(Ge).length > 0 ? Ge : null,
                    qe = i.useCallback((se = We((function(e) {
                        var t, n, r, i, o, l;
                            ...
                            switch (c.label) {
                                case 0:
                                    ...
                                    if (!e && !z) {
                                        if (null != q) {
                                            q({
                                                application: null == he ? void 0 : he.application,
                                                guild: Ve
                                            });
                                            null == F || F()
                                        }
                                ...
                                case 1:
                                    ...
                                    return [4, (0, P.Iq)({
                                        ...
                                        state: D,
                                        permissions: a.Z.remove(null != U ? U : m.ZP.NONE, Oe),
                                        guildId: null == we || re ? void 0 : we,
                                        channelId: null != Ce ? Ce : void 0,
                                        userInstall: re
                                    })];
                                case 2:
                                    t = c.sent();
                                    if (null != q) {
                                        ...
                                        _.Z.isDiscordHostname(r) && i === $.Z5c.OAUTH2_AUTHORIZED ? (0, b.uL)($.Z5c.OAUTH2_AUTHORIZED, {
                                            state: {
                                                application: null == he ? void 0 : he.application,
                                                guild: Ve
                                            }
                                ...
                                case 3:
                                    o = c.sent();
                                    if (null != (null == (l = o.body) ? void 0 : l.message) && "" !== l.message) {
                                        _e(new Error(l.message));
                                        ve(Ke.AUTHORIZE_SCOPES)
                                    } else {
                                        _e(l);
                                        ve(Ke.AUTHORIZE_SCOPES)
                                    }
                    ...
                    }), [q, B, f, M, x, Oe, F, U, R, I, ie, we, Ce, D, z, null == he ? void 0 : he.application, Ve, re]),
                    Fe = i.useRef(!1),
                    Ye = i.useCallback(We((function() {
                        var e, t, n, r, i;
                        return $e(this, (function(o) {
                            switch (o.label) {
                                case 0:
                                    if (le !== Xe.NOT_LOADED) return [2];
                                    ce(Xe.LOADING);
                                    if (!v.default.isAuthenticated()) {
                                        (0, P.c$)(oe);
                                        return [2]
                                    }
                                    if (Fe.current) return [2];
                                    Fe.current = !0;
                                    o.label = 1;
                                case 1:
                                    o.trys.push([1, 5, 6, 7]);
                                    if (null == W) return [3, 2];
                                    t = W;
                                    return [3, 4];
                                case 2:
                                    return [4, (0, P.Ww)({
                                ...
                                case 4:
                                    ...
                                    V === C.s.NONE && e.authorized ? qe(!0) : ce(Xe.LOADED);
                                ...
                                case 5:
                                    ...
                                    _e(new Error(null != i.message ? i.message : "".concat(Object.keys(i)[0], ": ").concat(Object.values(i)[0])));
                                    ce(Xe.LOADED);
                                    return [3, 7];
                                case 6:
                                    Fe.current = !1;
                    ...
                    })), [W, f, M, x, le, oe, V, R, I, ie, qe, D, re]),
                    Je = i.useCallback((function(e, t) {
                        Ee((function(n) {
                            return e ? a.Z.remove(n, t) : a.Z.add(n, t)
                        }))
                    }), []);
                i.useEffect((function() {
                    var e = ie.filter((function(e) {
                        return !N.ak.includes(e)
                    }));
                    if (0 === ie.length) {
                        _e(new Error("No scopes were provided."));
                        ce(Xe.LOADED)
                    } else if (e.length > 0) {
                        _e(new Error("Invalid scope: ".concat(e[0])));
                        ce(Xe.LOADED)
                    } else if ((0, j._$)(null != U ? U : m.ZP.NONE)) {
                        _e(new Error("Invalid permission(s) provided."));
                        ce(Xe.LOADED)
                    } else Ye()
                }), [Ye, ie, U]);
                var et = null != Ce ? null == he || null === (t = he.channels) || void 0 === t ? void 0 : t.find((function(e) {
                        return e.id === Ce
                    })) : null,
                    tt = null != we ? null == he || null === (n = he.guilds) || void 0 === n ? void 0 : n.find((function(e) {
                        return e.id === we
                    })) : null;
                i.useEffect((function() {
                    if (null != he)
                ...
                if (le !== Xe.LOADED || null == he) return {
                    body: (0, r.jsx)(h.$, {})
                };
                var nt, rt, it, ot, st = new g.Z(he.user),
                    at = null === (u = he.bot) || void 0 === u ? void 0 : u.approximate_guild_count,
                    lt = !1;
                switch (ge) {
                    case Ke.AUTHORIZE_SCOPES:
                        var ct, ut, ft, ht, dt = null == me || me instanceof Error ? {} : me,
                            pt = null === (ct = he.guilds) || void 0 === ct ? void 0 : ct.sort((function(e, t) {
                                return e.name.toLowerCase().localeCompare(t.name.toLowerCase())
                            })),
                            Ot = ie.includes($.xVR.BOT) || ie.includes($.xVR.WEBHOOK_INCOMING) || ie.includes($.xVR.APPLICATIONS_COMMANDS);
                        nt = (0, r.jsxs)(r.Fragment, {
                            children: [(0, r.jsx)(fe, {
                                application: he.application,
                                accountScopes: Ae,
                                errors: dt,
                                isTrustedName: Q
                            }), null == et && Ot && !re ? (0, r.jsx)(Ie, {
                                error: (null !== (ft = null !== (ut = dt[$.xVR.BOT]) && void 0 !== ut ? ut : dt[$.xVR.APPLICATIONS_COMMANDS]) && void 0 !== ft ? ft : [])[0],
                                selectedGuildId: we,
                                ...
                                guilds: null != pt ? pt : [],
                                disabled: "" !== we && !0 === H
                            }) : null, ie.includes($.xVR.WEBHOOK_INCOMING) ? (0, r.jsx)(Te, {
                                error: (null !== (ht = dt[$.xVR.WEBHOOK_INCOMING]) && void 0 !== ht ? ht : [])[0],
                                selectedChannelId: Ce,
                                selectedGuildId: we,
                        ...
                        ie.includes($.xVR.BOT) && !a.Z.equals(U, m.ZP.NONE) && (it = Ke.AUTHORIZE_BOT_PERMISSIONS);
                        var Et = Ot && null == tt && null == et,
                            yt = null != tt && ie.includes($.xVR.WEBHOOK_INCOMING) && null == Ce;
                        lt = !re && (Et || yt);
                        break;
                    case Ke.AUTHORIZE_BOT_PERMISSIONS:
                        nt = (0, r.jsx)(ye, {
                            application: he.application,
                            permissions: null != U ? U : m.ZP.NONE,
                            deniedPermissions: Oe,
                            onPermissionsChange: Je,
                            guild: tt
                        });
                        rt = Ke.AUTHORIZE_SCOPES
                }
                var bt = (0, r.jsx)(te, {
                        embeddedActivityConfig: ke,
                        application: he.application,
                        scopes: ie,
                        redirectUri: null !== (ot = he.redirect_uri) && void 0 !== ot ? ot : null,
                        approximateGuildCount: void 0 !== at ? at : null,
                        isEmbeddedFlow: ee
                    }),
                    gt = (0, r.jsxs)("div", {
                        className: He().footer,
                        children: [null != rt ? (0, r.jsx)(c.zx, {
            ...
            function rt(e, t) {
                if (null != t.location && (null == e || !e(t))) {
                    var n = s.parse(t.location, !0),
                        ...
                        o = n.path,
                        a = n.query,
                        l = _.Z.isDiscordHostname(i) || window.location.host === i;
                    if (l && o === $.Z5c.OAUTH2_AUTHORIZED)(0, u.h7)((function(e) {
                        return (0, r.jsx)(Le.j, Fe(Be({}, e), {
                            "aria-labelledby": Qe,
                            children: (0, r.jsx)(Ze.Jh, {
                                guild: t.guild,
                    ...
                    else if (l && (null == o ? void 0 : o.startsWith($.Z5c.OAUTH2_ERROR)))(0, u.h7)((function(e) {
                        var t = a.error_description || a.error || X.Z.Messages.OAUTH2_UNKNOWN_ERROR;
                        Array.isArray(t) && (t = t[0]);
                        return (0, r.jsxs)(Le.j, Fe(Be({}, e), {
                            "aria-labelledby": Qe,
                            children: [(0, r.jsx)(Ze.Lk, {
                                message: t,
                                onClose: e.onClose
                            }), ";"]
                        }))
            ...
            function it(e, t) {
                (0, u.h7)((function(t) {
                    return (0, r.jsx)(et, Fe(Be({}, t, e), {
                        cancelCompletesFlow: !1,
                        callback: rt.bind(null, e.callback)
                    }))
                }), {
                    onCloseCallback: t
                })
            ...
            function ot(e) {
                var t = s.parse(e),
                    ...
                    o = t.path,
                    a = t.query;
                return null == o || null == a || !_.Z.isDiscordHostname(r) && i !== window.location.host || !o.startsWith("/api".concat($.ANM.OAUTH2_AUTHORIZE)) && !o.startsWith($.Z5c.OAUTH2_AUTHORIZE) ? null : (0, A.y)(a)
            }
        },
        177309: (e, t, n) => {
            "use strict";
            ...
            function _(e) {
                ...
                return (0, r.jsx)(l.ThemeContextProvider, {
                    ...
                    children: (0, r.jsx)(u.Z, {
                        embedded: o,
                        className: s()((0, h.Q)(d.BRd.DARK), y().wave),
                        splash: (0, f.gK)(),
                        waveState: E,
                        showLogo: !0,
                        updateWaveState: g,
                        children: (0, r.jsx)("div", {
                            className: s()(y().oauth2Wrapper, n),
                            children: t
                        })
                    })
                })
            ...
            function A(e) {
                var t = e.children,
                    n = e.transitionState,
                    i = S(e, ["children", "transitionState"]);
                return (0, r.jsx)(a.Y0, v(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                        "function" == typeof Object.getOwnPropertySymbols && (r = r.concat(Object.getOwnPropertySymbols(n).filter((function(e) {
        ...
        772068: (e, t, n) => {
            ...
            function T(e) {
                var t = e.message,
                    ...
                    l = e.onClose;
                (0, p.Tt)({
                    location: v.Z.Messages.OAUTH2_TITLE
                });
            ...
            function j(e) {
                var t = e.guild,
                    n = e.application,
                    o = I(e, ["guild", "application"]),
                    s = o.onClose,
                    a = v.Z.Messages.AUTHORIZED_SUCCESS,
                    l = i.useCallback((function() {
                        if (null != (null == t ? void 0 : t.id)) {
                            (0, E.X)(null == t ? void 0 : t.id);
                            null == s || s();
                            y.default.track(g.rMx.OAUTH2_AUTHORIZE_SUCCESS_GO_TO_GUILD_CLICKED, {
                    ...
                    c = i.useCallback((function() {
                        null == s || s();
                        y.default.track(g.rMx.OAUTH2_AUTHORIZE_SUCCESS_CLOSE_CLICKED, {
                            application_id: null == n ? void 0 : n.id
                        })
                    }), [s, null == n ? void 0 : n.id]),
                    u = i.useMemo((function() {
                        return null != n ? null != t ? v.Z.Messages.AUTHORIZED_APP_TO_SERVER.format({
                            installedApplicationName: null == n ? void 0 : n.name,
                            guildName: null == t ? void 0 : t.name
                        }) : v.Z.Messages.AUTHORIZED_APP.format({
                            installedApplicationName: null == n ? void 0 : n.name
                        }) : v.Z.Messages.AUTHORIZED_GENERIC
                    }), [n, t]),
                    f = (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsx)(h.x, {
                            ...
                            children: [null != t && (0, r.jsx)(d.Button, {
                                ...
                                onClick: l,
                                className: m().button,
                                children: v.Z.Messages.OAUTH2_GO_TO_SERVER_NAME_CTA.format({
                                    guildName: null == t ? void 0 : t.name
                                })
                ...
                i.useEffect((function() {
                    y.default.track(g.rMx.OAUTH2_AUTHORIZE_SUCCESS_VIEWED, {
                        application_id: null == n ? void 0 : n.id
                    })
                }), [null == n ? void 0 : n.id]);
                return (0, r.jsx)("div", {
            ...
            function R(e) {
                ...
                var n, o, s = null != t ? (0, a.parse)(t.search) : {},
                    l = null !== (o = null !== (n = s.error_description) && void 0 !== n ? n : s.error) && void 0 !== o ? o : v.Z.Messages.OAUTH2_UNKNOWN_ERROR;
                return (0, r.jsx)(b.G, {
                    children: (0, r.jsx)(N, {
                        message: l,
                        showsCloseWindowText: !0
        ...
        609853: (e, t, n) => {
            ...
            var O = function(e) {
                var t = e.invertColor,
                    ...
                    m = void 0 === S ? [] : S,
                    _ = null,
                    A = c.Z.Messages.VERIFIED_BOT_TOOLTIP;
                switch (u) {
                    case l.H.SYSTEM_DM:
                    case l.H.OFFICIAL:
                        E = !0;
                        A = c.Z.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP;
                        _ = c.Z.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    case l.H.SERVER:
                        _ = c.Z.Messages.BOT_TAG_SERVER;
                        break;
                    case l.H.ORIGINAL_POSTER:
                        _ = c.Z.Messages.BOT_TAG_FORUM_ORIGINAL_POSTER;
                        break;
                    case l.H.STAFF_ONLY_DM:
                        _ = c.Z.Messages.STAFF_BADGE_TOOLTIP;
                        break;
                    case l.H.AI:
                        E = !0;
                        A = c.Z.Messages.AI_GENERATED_TOOLTIP;
                        _ = c.Z.Messages.AI_TAG;
                        break;
                    case l.H.REMIX:
                        E = !1;
                        _ = c.Z.Messages.REMIXING_TAG;
                        break;
                    case l.H.BOT:
                    default:
                        _ = c.Z.Messages.BOT_TAG_BOT
                }
                var P, I = u === l.H.ORIGINAL_POSTER,
                    T = u === l.H.REMIX,
                    w = null;
                E && (w = (0, r.jsx)(s.u, {
                    text: A,
                ...
                P = u === l.H.AI ? f().botTagAI : n ? f().botTagInvert : f().botTagRegular;
                var j = function(e) {
                    var t;
                    return (0, r.jsxs)("span", p(d({}, e), {
                        className: o()(O, P, v ? f().rem : f().px, (t = {}, h(t, f().botTagOP, I), h(t, f().botTagRemix, T), t)),
                        children: [b ? null : w, m, (0, r.jsx)("span", {
                            className: f().botText,
                            children: _
                        })]
                    }))
        ...
        515510: (e, t, n) => {
            ...
            b.contextType = l.AccessibilityPreferencesContext
        },
        630346: (e, t, n) => {
            "use strict";
            n.d(t, {
            ...
            const _ = function() {
                function e() {
                    ...
                    this.offscreenX = S.pg + this.size;
                    this.offscreenY = S.pg + this.size;
                ...
                t.render = function(e, t) {
                    ...
                    e.arc(this.x, this.y, this.size, 0, S.uo, !0);
            ...
            const N = function() {
                function e(t) {
                    ...
                    this.index = t;
                    this.spring.tension = S.O1 * Math.max(.1, t / 7) + S.O1;
                    this.count = j * t
                }
                var t = e.prototype;
            ...
            function L() {
                return Math.min(Math.max(Math.min(.8 * window.innerWidth, .8 * window.innerHeight), S.LE), S.pg)
            }
            var Z = 30;
            const U = function() {
                function e(t) {
                    ...
                    this._resizeWave = function() {
                        ...
                        r.points.forEach((function(t, n) {
                            var r = e * Math.cos(S.uo * D(0, .25, n, M)) - 40,
                                i = e * Math.sin(S.uo * D(0, .25, n, M)) - 40;
                    ...
                    this.resizeWave = w()(this._resizeWave, 200);
                    this.updateWaveState = t;
                    this.hasEntered = !1;
                    for (var i = 0; i <= M; i++) this.points.push(new N((n = i, Math.floor(7.5 - Math.floor(Math.abs(n - 7.5))))))
                }
                var t = e.prototype;
                t.initialize = function() {
                    this._resizeWave()
                ...
                t.update = function(e) {
                    if (0 !== this.points.length) {
                        ...
                        if (!this.hasEntered && this.points[0].x > x) {
                            this.hasEntered = !0;
                            this.updateWaveState(S.hO.ENTERED)
                        }
                        if (this.isFilling && this.points[0].x > this.points[0].targetX) {
                            this.isFilling = !1;
                            this.updateWaveState(S.hO.FILLED)
                        }
                    }
                };
                t.render = function(e) {
                ...
                t.fill = function() {
                    var e = this,
                        ...
                        n = L() - 140,
                        r = function(e, t, n, r) {
                            e.targetX = t * Math.cos(S.uo * D(0, .25, n, M)) - 40;
                            e.targetY = t * Math.sin(S.uo * D(0, .25, n, M)) - 40;
                            if (r) {
                                e.targetX += O(0, Z) - 15;
                                e.targetY += O(0, Z) - 15;
                                e.speedUp = 3;
                                e.spring.tension = S.O1 * Math.random() * .5 + S.O1
                            }
                        };
                    ...
                    setTimeout((function() {
                        e.points.forEach((function(e, n) {
                            ...
                            e.spring.tension = .7 * S.O1 + 80 * Math.random();
                            e.waveRange = 2 * e.waveRange
                        }));
                        e.isFilling = !0;
                        e.updateWaveState(S.hO.FILLING)
                    }), 250)
                };
                return e
            }();
            ...
            var X = (0, u.Mg)(l.Z.WAVE_SPLASH_RESPONSIVE_WIDTH_MOBILE),
                ...
                $ = function(e) {
                    ...
                    i.componentDidUpdate = function(e) {
                        ...
                        t === S.hO.FILLING && t !== e.waveState && this.waveFill()
                    };
                    i.componentWillUnmount = function() {
                        this.terminate()
                    };
                    ...
                    i.bindEvents = function() {
                        ...
                        p.S.subscribe(V.CkL.WAVE_EMPHASIZE, this.handleWaveEmphasize)
                    };
                    i.unbindEvents = function() {
                        ...
                        p.S.unsubscribe(V.CkL.WAVE_EMPHASIZE, this.handleWaveEmphasize)
                    };
                    i.advanceTransitionalState = function() {
                        var e = this.props.waveState;
                        e !== S.hO.INITIAL && e !== S.hO.FILLING || this.updateWaveState(e + 1)
                    };
                    i.waveFill = function() {
                        ...
                        return (0, r.jsx)(d.AccessibilityPreferencesContext.Consumer, {
                            children: function(t) {
                                ...
                                return t.reducedMotion.enabled ? (0, r.jsx)("div", {
                                    className: a()(G().fallbackImage, (s = {}, W(s, G().embedded, o), W(s, G().visible, !i && n >= S.hO.ENTERED), s))
                                }) : (0, r.jsx)("canvas", {
                    ...
                    return (0, r.jsxs)(o.Fragment, {
                        children: [this.renderWave(), (0, r.jsxs)("div", {
                            ...
                            children: [i ? (0, r.jsx)(f.Z, {
                                show: !c || n === S.hO.ENTERED && n !== S.hO.FILLING,

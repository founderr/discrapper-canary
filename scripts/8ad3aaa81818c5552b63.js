    ...
    [16673], {
                ...
                return e.map((function(e, o) {
                    ...
                    switch (e.type) {
                        ...
                        case l.re.BUTTON:
                            ...
                            return {
                                type: l.re.BUTTON, customId: e.custom_id, style: e.style, disabled: e.disabled, url: e.url, label: e.label, emoji: T, indices: m, applicationId: n
                            };
                        case l.re.STRING_SELECT:
                            var I;
                            return {
                                ...
                                })), placeholder: null !== (I = e.placeholder) && void 0 !== I ? I : d.Z.Messages.MESSAGE_SELECT_COMPONENT_DEFAULT_PLACEHOLDER, minValues: e.min_values, maxValues: e.max_values, indices: m, applicationId: n
                            };
                        case l.re.INPUT_TEXT:
                            return {
        ...
        727266: (e, n, t) => {
            ...
            var S = function(e) {
                ...
                t.prototype.getModalState = function(e) {
                    return e !== m ? null : v
                };
                return t
            }(l.ZP.Store);
        ...
        816673: (e, n, t) => {
            ...
            function R(e, n) {
                var t, a = e.application,
                    ...
                    g = R[0],
                    U = R[1],
                    D = (0, i.e7)([I.Z], (function() {
                        return I.Z.getModalState(g)
                    }), [g]),
                    Z = r.useMemo((function() {
                        return (0, T.J)(m, a.id, _)
                    }), [m, a.id, _]),
                    P = r.useRef(new Set),
                ...
                r.useEffect((function() {
                    ...
                    D === I.i.ERRORED && O(N.Z.Messages.INTERACTION_FORM_SUBMISSION_FAILED)
                }), [g, D, n, d]);
                var G = L(a);
                return {
                    components: Z,
                ...
                return n.map((function(n, r) {
                    ...
                    switch (n.type) {
                        ...
                        case c.re.STRING_SELECT:
                            ...
                            return {
                                type: n.type, custom_id: n.custom_id,
                                    values: (null == u ? void 0 : u.type) === n.type ? u.values : null
                            };
                        default:
                            l()(!1, "unreachable")
                    }

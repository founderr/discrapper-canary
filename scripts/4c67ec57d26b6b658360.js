    ...
    [21635, 78367, 88110, 71402], {
        ...
        727418: e => {
            ...
            e.exports = function() {
                ...
                for (var u, l, c = o(e), a = 1; a < arguments.length; a++) {
                    u = Object(arguments[a]);
                    for (var s in u) n.call(u, s) && (c[s] = u[s]);
                    if (t) {
                        l = t(u);
                        for (var f = 0; f < l.length; f++) r.call(u, l[f]) && (c[l[f]] = u[l[f]])
                    }
                }
                return c
            }
            ...
            var I = function(e) {
                ...
                n.prototype.render = function() {
                    var e, t = this.props,
                        ...
                        y = S.errorMessage,
                        h = S.retrySuccess,
                        b = o.Children.count(a) > 0 ? (0, r.jsx)(l.Card, {
        ...
        248046: (e, t, n) => {
            ...
            function m(e) {
                ...
                if (null != n.permissions && n.permissions.length > 0)
                    ...
                    } var l, c, p, _ = (null != i ? i : []).map((function(e) {
                        return e.name
                    })),
                ...
                return {
                    ...
                    rootCommand: n,
                    subCommandPath: i,
                    defaultMemberPermissions: null == n.default_member_permissions ? void 0 : a.Z.deserialize(n.default_member_permissions),
                    dmPermission: n.dm_permission,
                    permissions: t,
                    displayName: [null !== (c = n.name_localized) && void 0 !== c ? c : n.name].concat(R(O)).join(" "),
                ...
                for (var l = n.options.filter((function(e) {
                    ...
                    (a = u).push.apply(a, R(P({
                        ...
                        subCommandPath: (null != o ? o : []).concat([{
                            ...
                            displayName: null !== (f = l[c].name_localized) && void 0 !== f ? f : l[c].name
                        }]),
                        useKeyedPermissions: i
                    })))
                }
            ...
            var D = function(e, t, n, r) {
                    return !n && (r.isMultiUserDM() ? t.getIntegrations(r.id).length > 0 : r.isDM() ? !r.isSystemDM() && (null != r.rawRecipients.find((function(e) {
                        return e.bot
                    })) || t.getIntegrations(r.id).length > 0) : !r.isArchivedLockedThread() && (!!(0, _.Em)(r.type) && e.can(a.Z.combine(T.Pl.USE_APPLICATION_COMMANDS, T.Pl.SEND_MESSAGES), r)))
                },
                j = a.Z.deserialize(0);
            ...
            function U(e) {
                ...
                var s = x(r, l, o);
                return !("boolean" == typeof s && !s) && (null == u || !a.Z.equals(u, j) && t.can(u, n))
            }
            ...
            function x(e, t, n) {
                ...
                var o = !1,
                    ...
                    l = void 0;
                try {
                    for (var c, a = e.roles[Symbol.iterator](); !(i = (c = a.next()).done); i = !0) {
                        var s = c.value,
        ...
        223219: (e, t, n) => {
            ...
            var x = function(e) {
                ...
                r.hasChanges = function() {
                    return null != m && null != R && (!(!this.isOpen() && A !== c.cII.USER_SETTINGS) && !o().isEqual(m, R))
                };
                r.isOpen = function() {
                    return g
                };
            ...
            const G = new x(u.Z, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(e) {
                    if (S !== c.QZA.SUBMITTING) return !1;
                    S = c.QZA.OPEN;
                    y = c.oAB.ACCOUNT;
                    var t;
                ...
                DRAWER_SELECT_TAB: function(e) {
                    A = e.tab;
                    return null == y && A === c.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        488110: (e, t, n) => {
            ...
            function E(e) {
                var t = e.promiseFn,
                    ...
                    c = e.isModalOpen,
                    s = void 0 !== c && c,
                    f = a(e, ["promiseFn", "resolve", "reject", "code", "mfaCodeHandler", "isModalOpen"]);
                return t(null != o ? {
                    code: o
                } : {}).then(n, (function(e) {
                    if (function(e, t) {
        ...
        73105: (e, t, n) => {
            ...
            var R = function() {
                    function e(t) {
                        ...
                        this.misspelledWord = "";
                        this.corrections = [];
                        var r = T(a.default.locale.split("-"), 2),
                            o = r[0],
                            i = r[1];

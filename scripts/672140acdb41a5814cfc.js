            ...
            function l(e) {
                let t = function(e) {
                    let {
                        ...
                        return i
                    }, A = R(_, C, (o >> 18 & 31) / 31), T = R(3, 3, 1.25 * ((a >> 3 & 63) / 63)), g = R(3, 3, 1.25 * ((a >> 9 & 63) / 63)), N = f && R(5, 5, I), M = r(e), v = s(M > 1 ? 32 : 32 * M), S = s(M > 1 ? 32 / M : 32), P = new Uint8Array(v * S * 4), O = [], L = [];
                    for (let e = 0, r = 0; e < S; e++)
                        for (let s = 0; s < v; s++, r += 4) {
                            let o = u,
                                a = c,
                                E = d,
                                I = p;
                            for (let e = 0, n = i(_, f ? 5 : 3); e < n; e++) O[e] = l(t / v * (s + .5) * e);
                            for (let n = 0, r = i(C, f ? 5 : 3); n < r; n++) L[n] = l(t / S * (e + .5) * n);
                            for (let e = 0, t = 0; e < C; e++)
                                for (let n = e ? 0 : 1, r = 2 * L[e]; n * C < _ * (C - e); n++, t++) o += A[t] * O[n] * r;
                            ...
                            if (f)
                                for (let e = 0, t = 0; e < 5; e++)
                                    for (let n = e ? 0 : 1, r = 2 * L[e]; n < 5 - e; n++, t++) I += N[t] * O[n] * r;
                            let h = o - 2 / 3 * a,
                                m = (3 * o - h + E) / 2,
                                R = m - E;
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let N = null !== (u = null == g ? void 0 : null === (t = g.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    ...
                    v = void 0 !== C && C ? E.sliderBodyLarge : null == g ? void 0 : null === (l = g.options) || void 0 === l ? void 0 : l.sliderBodyClassName;
                return (0, r.jsxs)(r.Fragment, {
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, r.jsx)(e, {
                            ...
                            onComplete: () => {
                                y = !0, null == C || C(), !A && ((0, a.setIsPersistentHelperHidden)(!0), (0, a.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: I,
                            analyticsObject: h,
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: S,
                            location_stack: I
                        }), (0, s.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == _ || _(y), y && (!A && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },

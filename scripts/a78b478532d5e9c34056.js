    ...
    ["64108"], {
                    ...
                    async fetchApplications(e) {
                        ...
                        if (!t && (n = e.filter(e => {
                                ...
                                let i = a.default.getApplication(e),
                                    l = (0, r.hasFlag)(null !== (n = null == i ? void 0 : i.flags) && void 0 !== n ? n : 0, o.ApplicationFlags.EMBEDDED),
        ...
        526887: function(e, t, n) {
            ...
            function d(e) {
                ...
                } = e, _ = (0, r.useConfettiCannon)(n, s), p = (0, a.default)([o.default], () => o.default.useReducedMotion), I = l.useMemo(() => p ? u : {
                    confettiCanvas: n,
                    cannon: _,
            ...
            let s = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
                ...
                E = (e, t) => {
                    ...
                    let a = r.SUPPORTS_WEBP ? "webp" : "png",
                        d = "",
                        f = "quality=lossless";
                    return (null != t && (d = "size=" + (0, l.getBestMediaProxySize)(t * (0, l.getDevicePixelRatio)()), f = c ? "" : "&" + f), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(s, "/").concat(n, "/").concat(i, ".").concat(a, "?").concat(d).concat(f) : "".concat(u).concat(o.Endpoints.ROLE_ICON(n, i), "?").concat(d)
                },
        ...
        424562: function(e, t, n) {
            ...
            function S() {
                p = _.FormStates.CLOSED, I = {}, u = null, c = void 0, d = []
            }

            function T() {
                C(), g(), I = {}, p = _.FormStates.OPEN
            }
            ...
            class m extends f.default.Store {
                ...
                showNotice() {
                    return void 0 !== i || void 0 !== l || void 0 !== r || void 0 !== a || void 0 !== o || void 0 !== s
                }
                getPendingAvatar() {
                    return i
                }
            ...
            var v = new m(E.default, {
                GUILD_IDENTITY_SETTINGS_INIT: function(e) {
                    u = e.guild, p = _.FormStates.OPEN, I = {}, c = e.source, d = e.analyticsLocations
                },
        ...
        227439: function(e, t, n) {
            ...
            function s(e) {
                ...
                return !(0, a.default)(t) && (c || r) ? (0, i.jsx)(o, {
                    message: t,
                    channel: n,
                    author: l,
                    guildId: u,
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                let {
                    ...
                    setReadySlideId: m
                } = (0, f.usePaymentContext)(), v = S.find(e => e.key === h);
                l.useEffect(() => {
                    g(null)
                }, [h, g]), s(null != v, "Unknown step for current payment flow.");
                let A = null !== (u = null == v ? void 0 : null === (t = v.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    ...
                    L = void 0 !== p && p ? E.sliderBodyLarge : null == v ? void 0 : null === (r = v.options) || void 0 === r ? void 0 : r.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (c = null == v ? void 0 : null === (o = v.options) || void 0 === o ? void 0 : o.renderHeader) || void 0 === c || c ? _ : null, v.renderStep(I), null == h || A ? null : (0, i.jsxs)(i.Fragment, {
        ...
        649844: function(e, t, n) {
            ...
            function p(e) {
                let {
                    ...
                    returnRef: b,
                    subscription: D
                } = null != e ? e : {}, x = !1, O = (0, l.v4)(), M = u.default.getCurrentUser(), F = (0, f.isPremiumExactly)(M, _.PremiumTypes.TIER_2);
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: p,
                            onClose: (e, t) => {
                                l(), null == I || I(e), e && (null == S || S(), !v && null != t && t === _.PremiumSubscriptionSKUs.TIER_2 && !F && d.ComponentDispatch.dispatch(E.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                x = !0, null == h || h(), !v && (0, s.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: S,
                            analyticsLocations: T,
                            analyticsObject: C,
                    ...
                    onCloseCallback: () => {
                        !x && c.default.track(E.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: O,
                            ...
                            application_id: R,
                            location_stack: T
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == I || I(x), x && (null == S || S())
                    }
                })
            }
        },
                ...
                let {
                    ...
                    fire: (i, l, r) => {
                        ...
                        let s = (null == r ? void 0 : r.settings) != null ? {
                            ...
                            u = n(s);
                        e(i, l, u, (null !== (a = null == r ? void 0 : r.count) && void 0 !== a ? a : s.confettiCount) * (null !== (o = null == r ? void 0 : r.countMultiplier) && void 0 !== o ? o : 1), {
        ...
        38766: function(e, t, n) {
            ...
            function u(e) {
                let {
                    ...
                    null != t && (0, a.initGuildIdentitySettings)(t, null != c ? c : f), l.default.open(o.UserSettingsSections.PROFILE_CUSTOMIZATION, null != t ? s.ProfileCustomizationSubsection.GUILD : s.ProfileCustomizationSubsection.USER_PROFILE, {
                        scrollPosition: n,
                        analyticsLocation: u,
                        analyticsLocations: c,
        ...
        792105: function(e, t, n) {
            ...
            function r() {
                let e = (0, i.useStateFromStores)([l.default], () => l.default.isFetching());
                return e
            }
        },
        ...
        865372: function(e, t, n) {
            ...
            class h extends r.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (f = e), this.syncWith([u.default], p), this.syncWith([s.default], I)
                }
                getState() {
                    return f
                }
        ...
        931138: function(e, t, n) {
            ...
            function c(e) {
                let {
                    ...
                    ...d
                } = e, f = l.Children.only(t), E = (0, o.useRedesignIconContext)().enabled;
                return (0, i.jsxs)("div", {
        ...
        181114: function(e, t, n) {
            ...
            let h = e => {
                let {
                    ...
                    onlyShineOnHover: p,
                    ...h
                } = e, S = a.createRef(), T = (0, d.default)(S), C = !i && !l && !0 !== o && (!p || T);
        ...
        708169: function(e, t, n) {
            ...
            (l = i || (i = {}))[l.ENTERING = 1] = "ENTERING", l[l.ENTERED = 2] = "ENTERED", l[l.EXITING = 3] = "EXITING", l[l.EXITED = 4] = "EXITED";
            let S = (0, c.default)(e => ({
                fullScreenLayers: [],
                addLayer: t => e(e => {
                    let {
            ...
            function m() {
                ...
                return (0, r.jsx)(u.TransitionGroup, {
                    children: i.map(e => (0, r.jsx)(u.CSSTransition, {
                        classNames: n,
                        timeout: h,
                        onEntered: () => {
                            S.setState({

    ...
    ["55865"], {
        777273: function(e, t, s) {
            ...
            function u() {
                ...
                return n.default.needsRefresh() ? (i.default.dispatch({
        ...
        843823: function(e, t, s) {
            ...
            function d() {
                r.affinityUserIds = new Set(r.userAffinities.map(e => e.user_id).filter(e => !n.default.isBlocked(e)))
            }
            class o extends l.default.PersistedStore {
                initialize(e) {
                    this.waitFor(n.default), null != e && (r.userAffinities = e.userAffinities, r.affinityUserIds = new Set(e.affinityUserIds), r.lastFetched = e.lastFetched), this.syncWith([n.default], d)
                }
                needsRefresh() {
            ...
            var f = new o(i.default, {
                LOAD_USER_AFFINITIES_SUCCESS: function(e) {
                    var t;
                    let {
                        affinities: s
                    } = e;
                    r.userAffinities = null !== (t = s.user_affinities) && void 0 !== t ? t : [], r.lastFetched = Date.now(), d(), a = !1
                },
        ...
        920700: function(e, t, s) {
            ...
            class c extends i.PureComponent {
                ...
                renderInput(e) {
                    ...
                    return (0, l.jsx)("input", {
                        className: a((0, r.getClass)(f, "input", i), {
                            [f.inputHidden]: e
                        }),
                        ref: this.inputRef,
                        type: "text",
                ...
                render() {
                    ...
                    return (0, l.jsx)(u.FocusRing, {
                        ...
                        children: (0, l.jsx)("div", {
                            className: a((0, r.getClass)(f, "copyInput", s), n),
                            ref: this.containerRef,
                            children: (0, l.jsxs)(d.default, {
                                className: f.layout,
                                children: [(0, l.jsxs)(d.default, {
                                    className: f.inputWrapper,
                                    children: [this.renderInput(S), S ? (0, l.jsx)("div", {
            ...
            c.contextType = u.FormContext, c.defaultProps = {
                supportsCopy: !0,
                buttonColor: u.ButtonColors.PRIMARY,
                buttonLook: u.ButtonLooks.FILLED,
                mode: I.DEFAULT
            }, c.Modes = I, c.ButtonColors = u.ButtonColors, c.ButtonLooks = u.ButtonLooks;
            var S = c
        }
    }
]);
    ...
    ["79017"], {
        ...
        803427: function(e, t, s) {
            ...
            let F = [A.Steps.PAYMENT_TYPE, A.Steps.CREDIT_CARD_INFORMATION, A.Steps.REVIEW],
                ...
                w = (0, I.cssValueToNumber)(x.innerPadding);
                            ...
                            renderBody: () => {
                                ...
                                return e ? (0, n.jsx)(l.FormErrorBlock, {
                                    ...
                                    children: [(0, n.jsx)(T.default, {
                                        ...
                                        onChooseType: t,
                                        allowStripeRequestPayments: !C.isPlatformEmbedded,
        ...
        749432: function(e, t, s) {
            ...
            let U = e => {
                ...
                let [a, o] = r.useState(), [S, E] = r.useState(!1), [A, P] = r.useState(!1), {
                    userAffinities: T,
                    isLoading: m
                } = (0, l.useStateFromStoresObject)([C.default], () => ({
                    userAffinities: C.default.getUserAffinitiesUserIds(),
                    isLoading: C.default.getFetching()
                })), R = Array.from(T.values()), N = (0, l.useStateFromStores)([_.default], () => _.default.getFriendIDs()), g = i.difference(N, R), O = [...R, ...g], L = (0, l.useStateFromStores)([I.default], () => I.default.filter(e => O.includes(e.id) && !e.bot), [O]), B = null == L || 0 === L.length;
                if (B) return null;
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(u.FormTitle, {
                        ...
                        children: [(0, n.jsx)(u.SearchableSelect, {
                            ...
                            onClick: () => {
                                P(!0), (0, f.sendGiftMessage)(a, t).then(() => {
                                    s(), (0, d.popAllLayers)()
                                }).catch(() => {
                                    E(!0), P(!1)
                                })
        ...
        787598: function(e, t, s) {
            ...
            let V = i.forwardRef((e, t) => {
                ...
                let {
                    ...
                    skuId: i,
                    ...l
                } = e, u = (0, o.useStateFromStores)([A.default], () => A.default.getApplication(r)), d = (0, D.hasFlag)(null !== (s = null == u ? void 0 : u.flags) && void 0 !== s ? s : 0, k.ApplicationFlags.EMBEDDED) && (0, D.hasFlag)(null !== (n = null == u ? void 0 : u.flags) && void 0 !== n ? n : 0, k.ApplicationFlags.EMBEDDED_IAP), [c, p, S, h, f, E, C, g, y] = (0, o.useStateFromStoresArray)([m.default], () => [m.default.getPricesForSku(i), m.default.isPurchasingSKU, m.default.error, m.default.analyticsLocation, m.default.promotionId, m.default.giftCode, m.default.isGift, m.default.isIAP, m.default.forceConfirmationStepOnMount]), [O, L] = (0, o.useStateFromStoresArray)([R.default], () => [R.default.get(i), R.default.isFetching(i)]), M = (0, o.useStateFromStores)([_.default, N.default], () => N.default.inTestModeForApplication(r) || _.default.inDevModeForApplication(r), [r]), B = (0, o.useStateFromStores)([T.default, I.default], () => T.default.isEntitledToSku(I.default.getCurrentUser(), i, r)), U = (0, o.useStateFromStores)([P.default], () => P.default.error);
                return (0, a.jsx)(w, {
                    ...l,
                    application: u,
                    applicationId: r,
        ...
        909469: function(e, t, s) {
            ...
            let d = new Set([o.CurrencyCodes.ARS, o.CurrencyCodes.CLP, o.CurrencyCodes.COP]),
                ...
                f = e => {
                    ...
                    } = t, I = 0 !== C.length, P = E(f), T = (0, i.formatPrice)(_, A, {
                        style: "currency",
                        currency: A,
                    ...
                    if (c.has(A) && (m = u.default.Messages.LOCALIZED_PRICING_BANNER_BODY_EXISTING_CURRENCY.format({
                        ...
                        let e = S.filter(e => C.includes(e)),
                            t = C.filter(e => !S.includes(e)),
                            s = [...e, ...t],
                            n = s.slice(0, 2).map(e => {
                                var t, s;
                                return null !== (s = null === (t = p[e]) || void 0 === t ? void 0 : t.call(p)) && void 0 !== s ? s : u.default.Messages.PAYMENT_SOURCE_UNKNOWN
                            });
                        C.length >= 3 && n.push(u.default.Messages.LOCALIZED_PRICING_MORE_NEW_WAYS_TO_PAY);

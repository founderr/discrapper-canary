    ...
    ["78329"], {
        ...
        94973: function(e, t, n) {
            ...
            var r = n("37983"),
                ...
                g = n("782340"),
                S = n("208961");
            let A = (0, i.cssValueToNumber)(l.default.APPLICATION_SUBSCRIPTION_CARD_LISTING_IMAGE_SIZE),
                _ = "start_application_subscription",
                R = e => {
                    let {
                        listing: t
                    } = e, n = t.image_asset;
            ...
            function x(e) {
                let {
                ...
                } = e, x = (0, a.useStateFromStores)([h.default], () => h.default.isSyncing), {
                    ...
                    onComplete: I,
                    forcesTransitionToGuild: A
                }), w = t.subscription_plans[0], O = 0 === w.price, b = (null == P ? void 0 : P.id) === t.id, V = (0, o.default)(), U = V && !j || x, D = () => {
                ...
                return s.useEffect(() => {
                    ...
                    if (V && !U && "true" === e.searchParams.get(_)) {
                        e.searchParams.delete(_);
                        let t = e.pathname + e.search;
                        (0, f.replaceWith)(t), M()
                    }
                }, [V, M, t, U]), (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)(R, {
                            ...
                            children: [(0, r.jsx)(u.Text, {
                                ...
                                var e;
                                if (b) return (0, r.jsx)(N, {
                                    children: (null == L ? void 0 : L.status) === T.SubscriptionStatusTypes.CANCELED ? g.default.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CANCELED_LABEL : g.default.Messages.APPLICATION_SUBSCRIPTION_TIER_REVIEW_CURRENT_TIER_LABEL
                                });
                                if (O) return null == P ? (0, r.jsx)(N, {
                        ...
                        children: t.sku_benefits.benefits.map((e, t) => (0, r.jsx)(C.default, {
                            benefit: e,
                            className: S.benefit
                        }, t))
                    }) : null]
        ...
        913678: function(e, t, n) {
            ...
            function p(e) {
                ...
                let g = null == m ? void 0 : m.id,
                    S = null == m ? void 0 : null === (t = m.subscription_listings) || void 0 === t ? void 0 : t.filter(e => e.published);
                return E && (null == n || C) ? null == g || null == S || 0 === S.length ? null : (0, r.jsx)("div", {
        ...
        467094: function(e, t, n) {
            ...
            function P(e) {
                c.FrecencyUserSettingsActionCreators.updateAsync("favoriteStickers", t => (t.stickerIds = L(t.stickerIds), s.size(t.stickerIds) >= E.MAX_FAVORITES) ? (l.default.show({
        ...
        287850: function(e, t, n) {
            ...
            function N(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function(e) {
                    var t, n;
                    let r = null !== (n = null !== (t = T.default.lastMessageId(e.id)) && void 0 !== t ? t : e.lastMessageId) && void 0 !== n ? n : e.id,
                        s = e.isMessageRequestTimestamp;
                    if (null != s) {
                        let e = o(s).valueOf(),
                            t = A.default.fromTimestamp(e);
                        return A.default.compare(r, t) > 0 ? r : t
                    }
                    return r
                }(e);
                return {
            ...
            class M extends c.default.Store {
                initialize() {
                    this.waitFor(C.default, m.default, S.default, I.default, g.default), this.syncWith([g.default, I.default], x)
                }
            ...
            var j = new M(f.default, {
                ...
                CHANNEL_CREATE: function(e) {
                    ...
                    if (!(0, E.isPrivate)(t.type) || t.id === _.FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) return !1;
                    R.set(t.id, N(t))
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return null != r && R.set(t, N(r, n.id))
                },

    ...
    ["90382"], {
        ...
        354023: function(e, t, I) {
            ...
            var n, a, s = I("191225"),
                ...
                O = I("91366"),
                f = I("782340");
            u = I("591205"), (a = n || (n = {})).GROUP_DM = "GROUP_DM", a.DM = "DM", a.FRIEND = "FRIEND", a.CHANNEL = "CHANNEL";
            let d = (e, t) => null != e && l.default.isMember(e, t),
                o = e => {
                    ...
                    if (null != I)
                        for (let e of I) {
                            ...
                            !(null == I || d(a, I.id)) && (s.add(I.id), _.push({
                                type: n.FRIEND,
                                item: I,
                                isSuggested: !0
                            }), l.numFriends++)
                ...
                m = e => {
                    ...
                    a === O.InviteTargetTypes.EMBEDDED_APPLICATION && T.default.queryChannels({
                        query: t,
                        limit: 3,
                        guildId: void 0
                    }).forEach(e => {
                ...
                c = e => {
                    ...
                    T.default.queryFriends({
                        ...
                        !(a.has(t.id) || s.has(t.id)) && (s.add(t.id), I.push({
                            type: n.FRIEND,
                            item: t,
                            isSuggested: !1
                        }), u.numFriends++)

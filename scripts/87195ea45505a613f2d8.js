            ...
            const d = function(e) {
                ...
                if (p)
                    if (null != u && null != (null == T ? void 0 : T.subscriptionPeriodEnd)) M = l.Z.Messages.EMBEDDED_ACTIVITIES_IAP_NON_REFUNDABLE_SUBSCRIPTION_RATE_AND_RENEWAL.format({
                        ...
                        if (m === c.POd.COLLECTIBLES) M = l.Z.Messages.COLLECTIBLES_PURCHASE_DISCLAIMER_PAYMENT;
            ...
            var R = function(e, n) {
                ...
                S = function(e) {
                    ...
                    s.renderLegalTerms = function() {
                        ...
                        return this.canSkipTOSCheckbox() || !t && n || i || s ? null : (0, r.jsx)(u.Checkbox, {
                            type: u.Checkbox.Types.INVERTED,
                            value: d,
                            onChange: this.handleToggleTermsAcceptance,
                            disabled: I,
                            className: a()(f().checkbox, o),
                            children: (0, r.jsx)("div", {
                                className: a()(f().checkboxLabel, l),
                                children: null != c ? c : E.Z.Messages.BILLING_LEGAL_MUMBO_JUMBO_TERMS_LABEL.format({
                    ...
                    s.render = function() {
                        var e = this.props,
                            ...
                            U = this.state,
                            y = U.hasAcceptedEULA,
                            g = U.hasAcceptedWithdrawalWaiver;
                        o()(!O || null != A, "subscriptionPlan cannot be null if shouldShowUpdatedPaymentModal is true");
                        return l || !s || null != n && !c || L ? (0,
                            r.jsxs)("div", {
                            className: T,
                            children: [!O && !b && (0, r.jsx)(u.FormTitle, {
                                ...
                                variant: "text-xs/medium",
                                color: "interactive-normal",
                                children: E.Z.Messages.BILLING_DISCOUNT_LEGAL_COPY.format({
            ...
            function T(e) {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(p, {
                        ...
                        children: ["(", null != l && null != _ ? (0, c.og)(m, l, _) : m, ")"]
        ...
        646875: (e, n, t) => {
            ...
            function B(e) {
                var n, t = e.invoiceItem,
                    ...
                    v = null === (n = (0, M.N)(_)) || void 0 === n ? void 0 : n.subscription_trial;
                ...
                var L = (0, m.T4)(null != i ? i : t.amount, a),
                    b = d ? L : (0, m.og)(L, T.interval, T.intervalCount);
                return (0, r.jsx)(h.i$, {
                    label: P,
                    value: b,
            ...
            function Z(e) {
                var n = e.invoice,
                    ...
                    o = null != a ? a.amount : 0,
                    u = (0, m.T4)(o, n.currency),
                    I = null != c ? (0, m.og)(u, c.interval, c.intervalCount) : 0;
                return (0, r.jsxs)(r.Fragment, {
            ...
            function H(e) {
                var n = e.isUpdate,
                    t = e.currentInvoice,
                    i = e.newInvoice,
                    s = null != t ? (0, P.j)(t.invoiceItems) : null,
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(h.KU, {
                        ...
                        }), Y(G((0, P.j)(t.invoiceItems))).map((function(e) {
                            return (0, r.jsx)(B, {
                                invoiceItem: e,
                                currency: t.currency
                            }, e.id)
                    ...
                    }), Y(G((0, P.j)(i.invoiceItems))).map((function(e) {
                        ...
                        value: (0, m.og)((0, m.T4)(i.total, i.currency), l, u),
            ...
            function V(e) {
                ...
                if (s) {
                    ...
                    return (0, r.jsx)(r.Fragment, {
                        children: null != o ? o : A.Z.Messages.PREMIUM_SUBSCRIPTION_RENEWAL_FOOTER_TRIAL_DURATION.format({
                            duration: _,
                            days: p,
                ...
                var T = i.taxInclusive ? A.Z.Messages.PREMIUM_SUBSCRIPTION_RENEWAL_FOOTER : A.Z.Messages.PREMIUM_SUBSCRIPTION_RENEWAL_FOOTER_TAX_EXCLUSIVE;
                return (0, r.jsx)(r.Fragment, {
                    children: T.format({
                        rate: (0, m.og)((0, m.T4)(i.subtotal, i.currency), I, d),
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: [f ? null : (0, r.jsx)(h.HE, {
                        ...
                        children: [(0, r.jsxs)(u.Clickable, {
                            ...
                            children: [U ? A.Z.Messages.PREMIUM_SUBSCRIPTION_HIDE_DETAILS : A.Z.Messages.PREMIUM_SUBSCRIPTION_SHOW_DETAILS, (0, r.jsx)(T.Z, {
            ...
            function F(e) {
                ...
                return (0, r.jsx)(h.PO, {
                    ...
                    children: (0,
                        r.jsx)(h.R$, {
                        label: A.Z.Messages.BILLING_INVOICE_GIFT_PLAN.format({
                            planName: (0, f.Gf)(n.id, !1, a)
                        }),
                        value: (0, m.T4)(c.amount, c.currency),
                        className: S().subscriptionCostRow
                    })
                })
            }
            ...
            function X(e) {
                var n = e.invoice,
                    t = e.plan,
                    i = (0, P.j)(n.invoiceItems).find((function(e) {
                        return e.subscriptionPlanId === t.id
                    }));

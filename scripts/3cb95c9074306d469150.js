    ...
    [21391, 74871], {
        ...
        521391: (t, e, n) => {
            ...
            var w = (j(r = {}, h.Us.BAN, [f.Z, N().redIcon]), j(r, h.Us.GLOBAL_QUARANTINE, [_.Z, N().warningIcon]), j(r, h.Us.DISABLE_SUSPICIOUS_ACTIVITY, [_.Z, N().warningIcon]), j(r, h.Us.LIMITED_ACCESS, [O.Z, N().warningIcon]), j(r, h.Us.REQUIRE_VERIFICATION, [_.Z, N().warningIcon]), j(r, h.Us.TEMP_BAN, [O.Z, N().warningIcon]),
                    j(r, h.Us.USER_MESSAGE_REMOVAL, [y.Z, N().redIcon]), j(r, h.Us.USER_SPAMMER, [_.Z, N().warningIcon]), j(r, h.Us.USER_USERNAME_MANGLE, [S.Z, N().warningIcon]), j(r, h.Us.USER_WARNING, [p.Z, N().warningIcon]), r),
                L = _.Z,
                R = function(t) {
        ...
        223219: (t, e, n) => {
            ...
            function U(t) {
                var e, n, r, o, i, c, u = l.default.getCurrentUser();
                if (null == u) return D();
            ...
            var M = function(t) {
                ...
                r.hasChanges = function() {
                    return null != g && null != I && (!(!this.isOpen() && C !== a.cII.USER_SETTINGS) && !o().isEqual(g, I))
                };
                r.isOpen = function() {
                    return m
                };
            ...
            const Z = new M(c.Z, {
                ...
                USER_SETTINGS_MODAL_SUBMIT_FAILURE: function(t) {
                    if (_ !== a.QZA.SUBMITTING) return !1;
                    _ = a.QZA.OPEN;
                    h = a.oAB.ACCOUNT;
                    var e;
                ...
                USER_SETTINGS_MODAL_UPDATE_ACCOUNT: function(t) {
                    var e = t.settings;
                    null == g && (g = {});
                    var n = g[a.oAB.ACCOUNT];
                    g[a.oAB.ACCOUNT] = O({}, n, e)
                },
                ...
                DRAWER_SELECT_TAB: function(t) {
                    C = t.tab;
                    return null == h && C === a.cII.USER_SETTINGS && U({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        963659: (t, e, n) => {
            ...
            const s = (0, o.hN)((function(t) {
                var e = t.width,
                    ...
                    f = void 0 === s ? "currentColor" : s,
                    p = t.foreground,
                    O = u(t, ["width", "height", "color", "foreground"]);
                return (0, r.jsx)("svg", a(function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {},
                            r = Object.keys(n);

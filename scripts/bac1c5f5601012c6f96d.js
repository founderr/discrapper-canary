...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [49393], {
        949393: (e, n, t) => {
            ...
            const h = function(e) {
                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 7,
            ...
            const k = function(e) {
                var n = e.guild,
                    ...
                    c = s[0],
                    f = s[1],
                    d = M(o.useState(null), 2),
                    p = d[0],
                    S = d[1],
                    w = M(o.useState([]), 2),
                    x = w[0],
                    A = w[1],
                    k = o.useCallback(_((function() {
                        var e;
                ...
                var j = (0, u.Wu)([b.Z], (function() {
                    var e = b.Z.getHighestRole(n);
                    return i()(n.roles).sortBy((function(e) {
                        return e.position
                    })).filter((function(e) {
                        return e.id !== n.id
                    })).filter((function(t) {
                        return b.Z.isRoleHigher(n, e, t)
                ...
                return (0, r.jsxs)(l.ModalRoot, {
                    ...
                    children: [(0, r.jsx)(l.ModalHeader, {
                        ...
                        children: (0, r.jsxs)(l.Heading, {
                            ...
                            children: [g.Z.Messages.PRUNE_MEMBERS, "—", null != n ? n.toString() : ""]
                        })
                    }), (0, r.jsxs)("div", {
                        className: E().content,
                        children: [(0, r.jsx)(l.FormItem, {
                            title: g.Z.Messages.FORM_LABEL_LAST_SEEN,
                            children: (0, r.jsx)(l.RadioGroup, {
                                value: c,
                                options: [{
                                    name: g.Z.Messages.LAST_SEEN.format({
                                        days: 7
                                    }),
                                    value: 7
                                }, {
                            ...
                            title: g.Z.Messages.PRUNE_WITH_ROLES,
                            children: (0, r.jsx)(m.Z, {
                                ...
                                multiValueRenderer: function(e) {
                                    ...
                                    return (0, r.jsx)(v.U, {
                                        ...
                                        canRemove: !0,
                                        onRemove: function() {
                                            A(R(x.slice(0, a)).concat(R(x.slice(a + 1))))
                                        },
                            ...
                            className: E().spacing,
                            children: x.length > 0 ? g.Z.Messages.FORM_HELP_LAST_SEEN_WITH_ROLES_1.format({
                                members: p,
                                days: c
                            }) : g.Z.Messages.FORM_HELP_LAST_SEEN_1.format({
                                members: p,
                                days: c
                            })
                        })]

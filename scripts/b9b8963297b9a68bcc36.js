            ...
            var S = r.forwardRef(function(t, e) {
                    ...
                    V = r.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                var n = Date.now();
                                0 !== A.current && (P.current = 1e3 / (n - A.current)), A.current = n
                            }
                        }
                    }, [a, y, v]);
                ...
                var j = r.useCallback(function(t, e) {
                    ...
                    M = r.useCallback(function(t, e, n, r, o) {
                        var a, u, s, h, f, d, v, y, O, S, E, R, A, P, V, M = (a = null !== (V = t.id) && void 0 !== V ? V : (0, i.v4)(), u = t, s = n, h = r, f = o, y = _((v = (d = u, p(p({
                            id: a
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(a, u) {
                        ...
                        E(R, u - R.size());
                        for (var A = new o; R.size();) A.push(R.pop());
                        return A
                    }
                }
            }();

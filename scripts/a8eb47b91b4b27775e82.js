        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, h, E, g, O = encodeURIComponent(l.toString()),
                    ...
                    y = "".concat(f, "/?link=").concat(O, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(m, "&efr=").concat(v);

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [74968, 88110, 96043], {
        ...
        494889: (t, e, n) => {
            ...
            function f(t, e, n) {
                var r, i, o, u, l, a, f, d, p = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
                return {
            ...
            var _ = function(t) {
                ...
                function n() {
                    ...
                    t.getLabelText = function() {
                        var e;
                        return null !== (e = t.props.label) && void 0 !== e ? e : t.props.disallowBackupCodes ? a.Z.Messages.TWO_FA_ENTER_TOKEN_NO_BACKUP_LABEL : a.Z.Messages.TWO_FA_ENTER_TOKEN_LABEL
                    };
                    t.getSupportedCodeTypes = function() {
                        return t.props.disallowBackupCodes ? a.Z.Messages.TWO_FA_AUTH_CODE_NO_BACKUP : a.Z.Messages.TWO_FA_AUTH_CODE
                    };
                ...
                n.prototype.render = function() {
                    var t, e = this.props,
                        ...
                        O = E.errorMessage,
                        S = E.retrySuccess,
                        g = i.Children.count(c) > 0 ? (0, r.jsx)(l.Card, {
            ...
            function L(t) {
                ...
                if (!O.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== m.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = a.Z.getChannel(o),
                        l = j(u, i),
                        c = C({}, e, N(l), null != i && null != o && (0, T.AB)(o) ? P(0, o) : w(u));
                    O.default.track(t, c, {
                        flush: n
                    })
                }
        ...
        174333: (t, e, n) => {
            ...
            function E(t) {
                ...
                return null != o && (o.isDM() || o.isGroupDM() ? l.Z.getFriendIDs().includes(t.author.id) ? _(r) : _(i) : _(n))
            }
            var b = function(t) {
                var e = v();
            ...
            function O() {
                return !!(0, s.Kh)() && (null != a.default.getCurrentUser() && _(v().explicitContentGuilds))
            }

            function S(t, e) {
                var n = t.flags;
                return !!e && (i.ZP.get("obscure_blur_effect_enabled") || (0, c.yE)(null != n ? n : 0, f.J0y.CONTAINS_EXPLICIT_MEDIA))
            }
                ...
                var e = t.channelId,
                    ...
                    d = function(t, e, n) {
                        var r, i = (0, O.ZP)([S.Z], (function() {
                            ...
                            o = (0, g.yh)();
                        if (void 0 === i) return [];
                        var u, l = void 0 !== n ? function(t) {
                            return t.id === n
                        } : function(t) {
                            return (0, m.KP)(t, o)
                        };
                        return null !== (u = null == i || null === (r = i.attachments) || void 0 === r ? void 0 : r.filter(l)) && void 0 !== u ? u : []
                    }(e, n, o),
                    p = b({
                        onSuccess: i.useCallback((function() {
                            a.Z.pop();
                            (0, l.showToast)((0,
                                l.createToast)(I.Z.Messages.OBSCURED_CONTENT_MARK_FALSE_POSITIVE_SUCCESS, l.ToastType.CUSTOM));
                            s()
                        }), [s]),
                        onError: function() {
                            (0, l.showToast)((0, l.createToast)(I.Z.Messages.ERROR_GENERIC_TITLE, l.ToastType.FAILURE))
                        }
                    }),
                ...
                return (0, r.jsxs)(i.ModalRoot, {
                    ...
                    children: [(0, r.jsxs)(i.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(i.Heading, {
                            ...
                            variant: "text-sm/normal",
                            children: b ? c.Z.Messages.OBSCURED_CONTENT_LEARN_MORE_DESCRIPTION_ADULT : c.Z.Messages.OBSCURED_CONTENT_LEARN_MORE_DESCRIPTION_TEEN
                        }), (0, r.jsxs)("div", {
                            className: f().buttonContainer,
                            children: [b ? (0, r.jsx)(i.Button, {
                                color: i.Button.Colors.BRAND,
                                onClick: function() {
                                    o.Z.open(a.oAB.PRIVACY_AND_SAFETY);
                                    h()
                                },
                                fullWidth: !0,
        ...
        223219: (t, e, n) => {
            ...
            function L(t) {
                var e, n, r, i, o, u, c = l.default.getCurrentUser();
                if (null == c) return D();
            ...
            var U = function(t) {
                ...
                r.hasChanges = function() {
                    return null != I && null != T && (!(!this.isOpen() && N !== a.cII.USER_SETTINGS) && !i().isEqual(I, T))
                };
                r.isOpen = function() {
                    return C
                };
            ...
            const Z = new U(u.Z, {
                ...
                USER_SETTINGS_MODAL_UPDATE_ACCOUNT: function(t) {
                    var e = t.settings;
                    null == I && (I = {});
                    var n = I[a.oAB.ACCOUNT];
                    I[a.oAB.ACCOUNT] = p({}, n, e)
                },
                ...
                DRAWER_SELECT_TAB: function(t) {
                    N = t.tab;
                    return null == O && N === a.cII.USER_SETTINGS && L({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        786170: (t, e, n) => {
            ...
            var p = function(t) {
                var e = function() {
                        var t;
                        h && (null == b || null === (t = b.current) || void 0 === t || t.play())
                    },
                    n = function() {
                        var t;
                        h && (null == b || null === (t = b.current) || void 0 === t || t.pause())
                    },
                    c = function() {
                        return {
                            maxWidth: _.width,
        ...
        680918: (t, e, n) => {
            ...
            function a(t, e, n) {
                return (0, i.h7)(l(t, e, n), {
                    onCloseCallback: e
                })
            }

            function c(t, e, n, r) {
                return (0, i.o)(t, l(e, n, r))
            }
        },
        142520: (t, e, n) => {
            "use strict";

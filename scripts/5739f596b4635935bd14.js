    ...
    ["78789"], {
        ...
        247760: function(e, t, n) {
            ...
            var N = e => {
                ...
                o(null != r || null != l, "Must either provide slots or an initial selected guild"), o(!(null == r ? void 0 : r.some(e => e.isOnCooldown())), "If slots are provided, they must not be on cooldown");
                let y = [null == r ? a.UNUSED_QUANTITY_SELECT : null, null == l ? a.GUILD_SELECT : null, a.CONFIRM, a.SUCCESS].filter(e => null != e),
                    [v, P] = (0, u.useStateFromStoresArray)([f.default], () => [f.default.isModifyingAppliedBoost, f.default.applyBoostError]),
                    [L, x] = i.useState(""),
                    [b, D] = i.useState(y[0]),
                    [U, B] = i.useState(!1),
                    [G, j] = i.useState(l),
                    [F, w] = i.useState(null != r ? r : O.slice(0, 1)),
                    ...
                    Y = () => {
                        M(b === a.SUCCESS), I.default.track(g.AnalyticEvents.MODAL_DISMISSED, {
                    ...
                    H = {
                        [a.UNUSED_QUANTITY_SELECT]: {
                            body: () => (o(!(null == r && 0 === O.length), "Cannot provide no slots if there are no other available slots"), (0, s.jsxs)("div", {
                        ...
                        [a.CONFIRM]: {
                            ...
                            footer() {
                                let e = F.length,
                                    t = y[0] === a.CONFIRM ? Y : () => D(y[y.indexOf(b) - 1]),
                                    n = async () => {
        ...
        917219: function(e, t, n) {
            ...
            }), n("808653"), (s = a || (a = {}))[s.BACKGROUND = 0] = "BACKGROUND", (i = r || (r = {}))[i.OPTION_1 = 0] = "OPTION_1", i[i.OPTION_2 = 1] = "OPTION_2", i[i.OPTION_3 = 2] = "OPTION_3", i[i.OPTION_4 = 3] = "OPTION_4", i[i.OPTION_7 = 7] = "OPTION_7", i[i.OPTION_8 = 8] = "OPTION_8", i[i.OPTION_9 = 9] = "OPTION_9", i[i.OPTION_10 = 10] = "OPTION_10";
        ...
        467831: function(e, t, n) {
            ...
            var a, r, s, i, l, o, u, d, c = n("37983"),
                ...
                h = n("273108"),
                m = n("635233");
            (l = a || (a = {})).NORMAL = "normal", l.SPEED_START = "speed_start", l.SPEED_LOOP = "speed_loop", l.FINISH = "finish", l.IDLE = "idle";
            let S = {
                [a.NORMAL]: {
                    BEG: 0,
                    END: 600,
            ...
            C.Scenes = a, (o = r || (r = {})).NORMAL = "normal", o.SPEED_START = "speed_start", o.SPEED_LOOP = "speed_loop", o.FINISH = "finish", o.IDLE = "idle";
            let g = {
                [r.NORMAL]: {
                    BEG: 0,
                    END: 600,
            ...
            T.Scenes = r, (u = s || (s = {})).IDLE_ENTRY = "idle_entry", u.IDLE_LOOP = "idle_loop", u.BOOST_START = "boost_start", u.BOOST_LOOP = "boost_loop", u.BOOST_END = "boost_end", u.VICTORY = "victory", u.ERROR = "error";
            let R = {
                [s.IDLE_ENTRY]: {
                    BEG: 0,
                    END: 50
            ...
            M.Scenes = s, (d = i || (i = {})).ENTRY = "entry", d.IDLE = "idle", d.STARS = "stars", d.ERROR = "error", d.SUCCESS = "success";
            let O = {
                    [i.ENTRY]: {
                        BEG: 0,
                        END: 180

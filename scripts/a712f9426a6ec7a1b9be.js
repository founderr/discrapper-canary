...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [92465], {
        ...
        99440: (e, n, t) => {
            ...
            function g(e) {
                ...
                var n = e.filename,
                    t = e.height,
                    r = e.width;
                return d.IQ.test(n) && null != t && t > 0 && null != r && r > 0
            }
            ...
            function O(e) {
                return function(e) {
                    ...
                    return null == e || null == n ? [] : n.filter(_).map((function(e) {
                        var n = e.proxy_url,
                            t = e.url,
                            r = e.description,
                            i = e.spoiler,
                            ...
                            l = e.height,
                            a = e.filename,
                            s = e.content_scan_version;
                        if (null == u || null == l) return null;
                        var d = y(a),
                            E = null != e.flags && (0, c.yE)(e.flags, f.J0y.IS_THUMBNAIL);
                        return {
                            src: d ? "".concat(n, "?format=jpeg") : null != n ? n : t,
                            width: u,
                            height: l,
                            spoiler: null != i && i,
                            flags: o,
            ...
            function m(e, n) {
                var t = o.RS.useSetting(),
                    r = o.NA.useSetting();
                if (null == e) return [];
                var i = e.embeds;
                return t && r && null != i ? i.map((function(e) {
                    var t, r = null !== (t = e.image) && void 0 !== t ? t : e.thumbnail;
            ...
            function A(e, n) {
                var t, r = u.Z.getChannel(n);
                if (null == r) return !1;
                var o = l.Z.getMessage(r.id, r.id);
                return null != o && (e.length > 0 && null != e.find((function(e) {
                    return e.isImage || e.isVideo
                })) && r.isForumPost() && r.ownerId === (null === (t = a.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && 0 === i.Z.getCount(r.id) && (0 === o.attachments.length || null == o.attachments.find((function(e) {
                    return g(e) || h(e)
                }))))
            }
            ...
            function b(e) {
                return e.reduce((function(e, n) {
                    return {
                        ...
                        containsGif: e.containsGif || d.LR.test(n.src)
                    }
                }), {
                    containsVideo: !1,
                    containsGif: !1
        ...
        970286: (e, n, t) => {
            ...
            function d(e) {
                ...
                var R, S, T = function(e) {
                    ...
                    I = null != (null === (n = i.thumbnail) || void 0 === n ? void 0 : n.filename) && (null === (t = i.thumbnail) || void 0 === t || null === (r = t.filename) || void 0 === r ? void 0 : r.startsWith(s._j));
                return {
        ...
        591684: (e, n, t) => {
            ...
            function N(e) {
                var n;
                null === (n = e.threads) || void 0 === n || n.forEach(L)
            }
            ...
            var U = function(e) {
                ...
                r.getCount = function(e) {
                    var n, t;
                    return null !== (t = null === (n = A[e]) || void 0 === n ? void 0 : n.count) && void 0 !== t ? t : null
                };
            ...
            const Z = new U(u.Z, {
                ...
                GUILD_DELETE: function(e) {
                    var n, t = e.guild;
                    n = t.id, A = i().omitBy(A, (function(e) {
                        var t = e.guildId === n;

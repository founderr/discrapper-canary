            ...
            function D(e) {
                ...
                if (!m.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== w.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = c.Z.getChannel(i),
                        l = L(u, o),
                        a = S({}, t, T(l), null != o && null != i && (0, P.AB)(i) ? R(0, i) : A(u));
                    m.default.track(e, a, {
                        flush: n
                    })
                }
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[e] && null != C[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var l in C[e][t]) t === D ? d.ZP.isNewForumThread(l, t, r) && L[e][t]++ : i.default.compare(l, o) > 0 && !d.ZP.hasOpenedThread(l) && L[e][t]++
                        }
                    }
                }
            }
            ...
            var ne = {},
                ...
                le = function(e) {
                    ...
                    r.getActiveJoinedThreadsForParent = function(e, t) {
                        var n;
                        return e in T && null !== (n = T[e][t]) && void 0 !== n ? n : oe
                    };
                    ...
                    r.computeAllActiveJoinedThreads = function(e) {
                        ...
                        for (var n in T)
                            if (n === e || null == e)
                                for (var r in T[n])
                                    for (var o in T[n][r]) t.push(T[n][r][o].channel);
                        return t
                    };
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, i, u;
                        return o().size(null !== (i = null === (n = T[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== i ? i : {}) + o().size(null !== (u = null === (r = C[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== u ? u : {})
                    };
                    return n
                }(u.ZP.Store);
            ...
            var h = {
                ...
                v = function(e) {
                    var t = e.direction,
                        ...
                        S = e.foreground,
                        I = e.expanded,
                        T = g(e, ["direction", "width", "height", "color", "transition", "className", "foreground", "expanded"]),
                        R = (0, s.useRedesignIconContext)().enabled,
                        C = n;
                    !0 === I ? C = h.DOWN : !1 === I && (C = h.RIGHT);
                    if (R) {
                        var A, N = (A = {}, O(A, h.UP, a.u),
                            O(A, h.DOWN, u.C), O(A, h.LEFT, l.V), O(A, h.RIGHT, c.F), A)[C];
                        return (0, r.jsx)(N, y(b({}, T), {
                            width: d,
                            height: m,
                            color: E,
                            colorClass: S

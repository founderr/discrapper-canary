    ...
    ["14511"], {
        ...
        267235: function(e, t, s) {
            ...
            var z = e => {
                ...
                })), [J, X] = r.useState(null !== (t = null == U ? void 0 : U.formFields) && void 0 !== t ? t : []), [Q, Z] = r.useState(!1), [$, ee] = r.useState(null), [et, es] = r.useState(q ? l.CLAIM_ACCOUNT : l.VERIFICATION_FORM), [el, en] = r.useState(""), [ei, er] = r.useState(""), [ea, eu] = r.useState(null), [ed, eo] = r.useState(null), eI = (0, g.useIsMemberVerificationManualApproval)(n), ec = null == U ? void 0 : U.guild, em = r.useMemo(() => null != y ? y : null != ec ? new f.default(ec) : null, [y, ec]), {
                    emojisToRender: eE,
                    remainingEmojis: ef,
                    numGuildEmoji: eM
                } = r.useMemo(() => {
                ...
                r.useEffect(() => ((0, V.setHasUnsubmittedChanges)(!1), () => {
                    ...
                    h.default.fetchVerificationForm(n, T)
                }, [n, T]), r.useEffect(() => {
                    null != U && X(U.formFields)
                }, [U]), r.useEffect(() => {
                    null != w && w.isClaimed() && es(l.VERIFICATION_FORM)
                }, [w]), r.useEffect(() => {
                    et === l.EMAIL_CONFIRMATION && k && es(l.VERIFICATION_FORM)
                }, [et, k]), r.useEffect(() => {
                    null != n && A.default.track(p.AnalyticEvents.OPEN_MODAL, {
                ...
                let eC = async () => {
                    ...
                    var e, t;
                    Z(!0), ee(null);
                    let s = null != w ? R.default.getMember(n, w.id) : null;
                        ...
                        children: [(0, i.jsx)(o.ModalContent, {
                            ...
                            children: (0, i.jsx)(o.Sequencer, {
                                className: u(b.sequencer, {
                                    [b.centerContent]: et !== l.VERIFICATION_FORM
                                }),
                                steps: [l.CLAIM_ACCOUNT, l.EMAIL_CONFIRMATION, l.VERIFICATION_FORM],
                                step: et,
                                children: (() => {
                                    switch (et) {
                                        case l.CLAIM_ACCOUNT:
                                            return (0, i.jsx)(D, {
                                                headerId: s,
                                                email: el,
                                                password: ei,
                                        ...
                                        case l.EMAIL_CONFIRMATION:
                                            return (0, i.jsx)(H, {
                                                headerId: s,
                                                email: el
                                            });
                                        case l.VERIFICATION_FORM:
                                            return (0, i.jsx)(Y, {
                                                headerId: s,
                                                guildId: n,
                                                formState: J,

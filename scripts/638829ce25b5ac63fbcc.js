        ...
        788169: (e, t, n) => {
            ...
            const w = new g(i.Z, {
                ...
                TYPING_START_LOCAL: function(e) {
                    ...
                    var l = null == O || O.prevSend > r - 16e3 ? 1500 : 0,
        ...
        796909: (e, t, n) => {
            ...
            function Z() {
                ...
                (0, a.cn)() && (0, f.x7)() && v.Z.getAddedToMessages().forEach((function(e) {
                    ...
                    null != t && (0, p.zi)(t.type) && A.set(t.id, R(t))
                }))
            }
            ...
            var F, j, C, L = (F = [], j = [], C = [], function() {
                    var e = A.values(T.FAVORITE),
                        t = A.values(T.DEFAULT);
                    if (F !== e || j !== t) {
                        C = [];
                ...
                U = function(e) {
                    ...
                    r.initialize = function() {
                        ...
                        this.syncWith([v.Z, l.Z], Z)
                    };
                    r.getPrivateChannelIds = function() {
                        return L()
                    };
                    r.getSortedChannels = function() {
                        return [A.values(T.FAVORITE), A.values(T.DEFAULT)]
                    };
            ...
            const D = new U(c.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, p.hv)(e.type) || A.has(e.id)) && A.set(e.id, R(e))
                    }))
                },

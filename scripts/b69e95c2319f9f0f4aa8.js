            ...
            function D(e) {
                var n = e.className,
                    ...
                    _ = function(e) {
                        var n = e.emojiId,
                            t = e.emojiName,
                            r = (0, l.e7)([v.Z], (function() {
                                return null != n ? v.Z.getCustomEmojiById(n) : null
                            }));
                        if (null != r || null != t) {
                            if (null == n) {
                                y()(null != t, "emojiName must be defined if emojiId is not defined");
                        ...
                        children: function(e, n) {
                            ...
                            return (0, r.jsxs)("div", A(N({}, e), {
                                ...
                                children: [(0, r.jsx)(p.Z, {
                                    ...
                                    active: t,
                                    tabIndex: 0,
                                    renderButtonContents: null != m || null != w ? function() {
                                        return (0, r.jsx)(s.Z, {
                                            emojiName: w,
                                            emojiId: m
                                        })
        ...
        691762: (e, n, t) => {
            ...
            const A = (0, y.hN)((function(e) {
                var n = e.width,
                    ...
                    u = e.foreground,
                    s = N(e, ["width", "height", "color", "foreground"]);
                ...
                var n = e.width,
                    ...
                    o = void 0 === a ? 24 : a,
                    i = e.color,
                    l = void 0 === i ? v.Z.colors.INTERACTIVE_NORMAL : i,
                    u = e.colorClass,
                    s = void 0 === u ? "" : u,
                    c = w(e, ["width", "height", "color", "colorClass"]);
            ...
            function G() {
                return (G = C((function(e) {
                    ...
                    return T(this, (function(r) {
                        switch (r.label) {
                            case 0:
                                if (!e.type.startsWith("audio") && !e.type.startsWith("video") || !I.has(e.type)) throw new Error(_.Z.Messages.SOUNDBOARD_ERROR_INVALID_FILE_TYPE.format({
                                    fileType: e.type
                                }));
                                n = URL.createObjectURL(e);
                                return [4, F(t = new Audio(n))];
                            case 1:
                                r.sent();
                                return [2, t]
                        }
            ...
            var oe = function(e, n) {
                ...
                ie = new Worker(new URL(t.p + t.u(42762), t.b)),
                le = new AudioContext;

            function ue() {
                return (ue = te((function(e) {
                    var n;
            ...
            function se(e) {
                var n = ae(a.useState(null), 2),
                    t = n[0],
                    r = n[1],
                    o = ae(a.useState(null), 2),
                    i = o[0],
                    l = o[1];
            ...
            function fe(e, n, t) {
                var r = ae(a.useState(null), 2),
                    o = r[0],
                    i = r[1],
                    l = ae(a.useState(null), 2),
                    u = l[0],
                    s = l[1],
                    c = ae(a.useState(1), 2),
                    f = c[0],
                            ...
                            return new Promise((function(o) {
                                var i = (0, X.Z)(),
                                    l = function(e) {
                                        ...
                                        null == ie || ie.removeEventListener("message", l)
                                    };
                                null == ie || ie.addEventListener("message", l);
                                null == ie || ie.postMessage({
                                    id: i,
                                    options: t,
                                    config: r,
                                    width: n,
            ...
            const be = a.memo((function(e) {
                    var n = e.file,
                        ...
                        h = a.useMemo((function() {
                            ...
                            return function(e) {
                                ...
                                fineTuning: -1,
                                fineTuningResolution: n / P.fineTuningScale,
                                duration: n
                            }, null != l ? l : {})
                        }), [t, l]),
                        p = se(n),
                        ...
                        y = (0, K.ZP)(),
                        v = (0, Q.Sl)((0,
                            J.wj)(y) ? de.Il.PRIMARY_300 : de.Il.PRIMARY_700),
                        b = null == p || null == m,
                    ...
                    a.useEffect((function() {
                        if (null != d.current) {
                            var e = new ResizeObserver((0, $.debounce)(O, 50));
                            e.observe(d.current);
                            return function() {
                                e.disconnect()
                            }
                    ...
                    a.useEffect((function() {
                        if (null != d.current) {
                            ...
                            if (null != n) {
                                var t = e.width,
                                    r = e.height;
                                if (0 !== c.width && 0 !== c.height && null != m && m.length > 0) {
                                    var a = t / m.length,
                                        o = a * -(P.waveformBarWidth - 1);
                                    n.clearRect(0, 0, t, r);
                                    n.fillStyle = v.hex;
                    ...
                    return (0, r.jsxs)("div", {
                        className: i()(pe().container, o),
                        children: [(0, r.jsx)("canvas", {
                            className: pe().waveformCanvas,
                            ref: d,
                            width: 4 * c.width,
                            height: 4 * c.height
                        }), g && (0, r.jsx)("div", {
                ...
                a.useEffect((function() {
                    if (null != f) {
                        ...
                        n && (e = setInterval((function() {
                            if (f.currentTime < L(j)) f.currentTime >= L(O) && w(1e3 * f.currentTime);
                            else {
                                t(L(v));
                                w(v)
                            }
                    ...
                    if (!(c.fineTuningDelay <= 0)) {
                        var e = v,
                            ...
                            r = setTimeout((function() {
                                D && e === v && -1 === V ? Y(v) : C && n === j && -1 === V ? Y(j) : I && t === O && -1 === V && Y(O)
                            }), c.fineTuningDelay);
                        return function() {
                            clearTimeout(r)
                        }
                    }
                }), [c.fineTuningDelay, C, j, V, I, O, D, v]);
                return (0, r.jsxs)("div", {
                    className: i()(we().timeline, je({}, we().initialized, d)),
                    children: [(0, r.jsxs)("div", {
                        className: we().rangeHandleContainer,
                        children: [(0, r.jsxs)("div", {
                            className: we().rangeHandleFrame,
                            children: [(0,
                                r.jsx)("input", {
                                ref: h,
                                className: i()(we().rangeHandle, we().rangeHandleStart),
                                type: "range",
                                min: U(V, z, B),
                                max: R(V, z, B),
                                value: v,
                                ...
                                ref: m,
                                className: i()(we().rangeHandle, we().rangeHandleEnd),
                                type: "range",
                                min: U(V, z, B),
                                max: R(V, z, B),
                                value: j,
                            ...
                            className: we().handlePlayheadTrack,
                            children: (0, r.jsx)("input", {
                                ref: p,
                                className: i()(we().rangeHandle, we().rangeHandlePlayhead),
                                type: "range",
                                min: U(V, z, B),
                                max: R(V, z, B),
                                value: O,
                                onChange: X,
                                onMouseDown: function(e) {
                                    return J(e, Ae.PLAYHEAD)
                                },
                                onMouseUp: function() {
                                    return K(Ae.PLAYHEAD)
                                },
                                disabled: !d || s
                            })
                        })]
                    }), (0, r.jsxs)("div", {
                        className: we().handleContainer,
                        children: [(0, r.jsxs)("div", {
                            className: i()(we().handleFrame, ($ = {}, je($, we().startDragging, D), je($, we().endDragging, C), $)),
                            style: {
                                left: "".concat(k(v, V, z, B), "%"),
                                right: "".concat(Z(j, V, z, B), "%")
                            },
                            children: [(0, r.jsx)("div", {
                                className: i()(we().handleIconFrame, we().handleIconFrameStart),
                                children: (0, r.jsx)("div", {
                                    className: i()(we().handleIconContainer, we().start),
                                    children: (0, r.jsx)(W.Z, {
                                        direction: W.Z.Directions.RIGHT,
                                        className: we().handleIcon,
                                        width: 16,
                                        height: 16
                                    })
                                })
                            }), (0, r.jsx)("div", {
                                className: i()(we().handleIconFrame, we().handleIconFrameEnd),
                                children: (0, r.jsx)("div", {
                                    className: i()(we().handleIconContainer, we().end),
                                    children: (0, r.jsx)(W.Z, {
                                        direction: W.Z.Directions.LEFT,
                                        className: we().handleIcon,
                                        width: 16,
                                        height: 16
                                    })
                            ...
                            className: we().playheadTrack,
                            children: (0, r.jsx)("div", {
                                className: i()(we().playhead, je({}, we().dragging, I || D || C || n)),
                                style: {
                                    left: "".concat(k(O, V, z, B), "%")
                                }
                            })
                        })]
                    }), (0, r.jsx)("div", {
                        className: we().waveformContainer,
                        children: (0, r.jsx)(ge, {
                            fineTuning: V,
            ...
            const Te = a.memo((function(e) {
                var n = e.className,
                    ...
                    d = f[0],
                    h = f[1],
                    p = Me(a.useState(Ce), 2),
                    y = p[0],
                    v = p[1],
                    b = y.playheadPositionMs,
                    g = y.endPositionMs,
                    O = y.startPositionMs,
                    w = null != c,
                    S = g - O,
                ...
                var N, x, E = a.useCallback((function(e) {
                        if (null != c) {
                            c.pause();
                ...
                return (0, r.jsxs)("div", {
                    className: i()(Pe().container, (N = {}, _e(N, Pe().initialized, w), _e(N, Pe().disabled, !w || l), N), n),
                    children: [(0, r.jsxs)("div", {
                        className: Pe().playButtonContainer,
                        children: [(0, r.jsx)(s.Clickable, {
                            className: Pe().playButton,
                            onClick: w ? P : void 0,
                            children: d ? (0, r.jsx)(A, {
                                className: Pe().playButtonIcon
                            }) : (0, r.jsx)(m.Z, {
                                className: Pe().playButtonIcon
                            })
                        }), (0, r.jsx)("div", {
                            className: Pe().durationContainer,
                            children: (0, r.jsx)(s.Text, {
                                className: Pe().duration,
                                variant: "text-xs/normal",
                                color: j ? "text-warning" : "text-positive",
                                children: (x = S, "".concat(L(x).toFixed(2), "s"))
                            })
                        })]
                    }), (0, r.jsx)(De, {
                        playing: d,
            ...
            const Fe = a.memo((function(e) {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(s.Clickable, {
                        ...
                        className: Re().playButton,
                        "aria-label": l ? _.Z.Messages.STOP : _.Z.Messages.PLAY,
                        children: l ? (0, r.jsx)(A, {
                            className: Re().playIcon
                        }) : (0, r.jsx)(m.Z, {
                            className: Re().playIcon
                        })
                    }), (0, r.jsx)("div", {
                        className: Re().waveformContainer,
                        children: (0, r.jsx)(be, {
                            className: Re().waveform,
                            file: d,
                            audio: h
                        })
                    })]
            ...
            const He = a.memo((function(e) {
                ...
                return (0, r.jsx)(s.FormSection, {
                    ...
                    title: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_PREVIEW,
                    children: (0,
                        r.jsxs)("div", {
                        className: Ge().fakeInput,
                        children: [null != n && (0, r.jsx)(Fe, {
                            sound: n,
                            volume: t,
                            disabled: o
                        }), null == n && null != l && (0, r.jsx)(Te, {
                            className: Ge().audioTrimmer,
                            volume: t,
                            disabled: o,
                            onChange: i
                        })]
            ...
            var qe, We = function() {
                ...
                n.addPage = function(e) {
                    ...
                    var f = this._offset,
                        d = 0;
                    switch (e.pageType) {
                        case ze.CONTINUATION:
                            d = 1;
                            break;
                        case ze.BEGINNING_OF_STREAM:
                            d = 2;
                            break;
                        case ze.END_OF_STREAM:
                            d = 4
                    }
                    ...
                    var p = !0,
                        ...
                        y = void 0;
                    try {
                        for (var v, b = e.segments[Symbol.iterator](); !(p = (v = b.next()).done); p = !0) {
                            var g = v.value;
                            this.appendBytes(g)
                        }
                    } catch (e) {
            ...
            function $e(e, n) {
                var t = new Uint8Array([79, 112, 117, 115, 72, 101, 97, 100, 1, n.channelCount, 0, 15, 255 & n.inputSampleRate, n.inputSampleRate >> 8 & 255, n.inputSampleRate >> 16 & 255, n.inputSampleRate >> 24 & 255, 255 & n.outputGain, n.outputGain >> 8 & 255, n.channelMappingFamily]),
                    ...
                    a = new We;
                a.addPage({
                    pageType: ze.BEGINNING_OF_STREAM,
                    granulePosition: 0,
                    segments: [t]
                });
                var o = 0;
            ...
            function on() {
                return (on = Xe((function(e) {
                    var n;
                    return en(this, (function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, tn((function(n) {
                                    n.readAsDataURL(e)
                                }))];
                            case 1:
                                n = t.sent();
            ...
            function ln(e, n) {
                var t = n.startMs,
                    ...
                    l = Math.min(r, i);
                if (0 === t && l === i) return e;
                for (var u = Math.floor(t / i * e.length), s = Math.floor(l / i * e.length), c = s - u, f = nn.createBuffer(o, c, a), d = 0; d < o; d++)
                    for (var h = f.getChannelData(d), p = e.getChannelData(d), m = 0, y = u; y <= s; y++) {
                        h[m] = p[y];
                        m++
                    }
                return f
                    ...
                    return en(this, (function(u) {
                        switch (u.label) {
                            case 0:
                                ...
                                return [4, n];
                            case 1:
                                return [2, p.Dx.apply(void 0, [(l.sound = u.sent(), l.volume = a, l.emojiId = o, l.emojiName = i, l)])]
                        }
                    }))
                }))).apply(this, arguments)
            }
            ...
            function _n(e) {
                ...
                return (0, r.jsxs)(s.Text, {
                    className: i()(xn().suffixNode, t),
                    variant: "text-sm/medium",
                    color: "text-primary",
                    children: [(0, r.jsx)(jn.Z, {
                        className: xn().speakerIcon
                    }), _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT_AVAILABLE_COUNT.format({
                        slots: n
                    })]
                })
            }
            ...
            function Mn(e) {
                var n = e.value,
                    t = e.className,
                    o = e.onChange,
                    l = (0, yn.cj)([On.Z, gn.Z, wn.default, bn.Z], (function() {
                        var e = {},
                            n = !0,
                            t = !1,
                            r = void 0;
                        try {
                            for (var a, o = On.Z.getFlattenedGuildIds()[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                                var i = a.value,
                                    l = bn.Z.getGuild(i);
                                if (null != l) {
                                    (0, vn.Gw)(l, gn.Z, wn.default).canCreateExpressions && (e[l.id] = l)
                                }
                            }
                        } catch (e) {
                            t = !0;
                    ...
                    u = (0, yn.cj)([An.Z], (function() {
                        ...
                        try {
                            for (var a, o = Object.entries(l)[Symbol.iterator](); !(n = (a = o.next()).done); n = !0) {
                                var i, u = In(a.value, 2),
                                    s = u[0],
                                    c = u[1],
                                    f = (0, Nn.yw)(null !== (i = An.Z.getSoundsForGuild(s)) && void 0 !== i ? i : xe.Hy, c.premiumTier);
                                e[s] = f
                            }
                        } catch (e) {
                            t = !0;
                ...
                var c, f = a.useMemo((function() {
                    ...
                    d = a.useCallback((function(e) {
                        return null == e || "" === e.value ? null : (0, r.jsx)(Sn.Z, {
                            className: i()(xn().guildSelectOptionIcon, Pn({}, xn().disabledOption, e.disabled)),
                            guild: l[e.value],
                            size: Sn.Z.Sizes.SMOL,
                            active: !0
                        })
                    }), [l]),
                    h = a.useCallback((function(e) {
                        var n = null == e ? void 0 : e.value;
                        return null == n || "" === n ? null : (0, r.jsx)(_n, {
                            className: i()(Pn({}, xn().disabledOption, null == e ? void 0 : e.disabled)),
                            availableSlots: u[n]
                        })
                    }), [u]),
                    m = a.useCallback((function(e) {
                        return (0, r.jsx)("div", {
                            className: i()(Pn({}, xn().disabledOption, e.disabled)),
                            children: e.label
                        })
                    }), []),
                    ...
                    v = null == (c = u[null != n ? n : ""]) || c > 0 ? n : void 0;
                return (0, r.jsx)(s.SearchableSelect, {
                    ...
                    renderOptionLabel: m,
                    placeholder: 0 === f.length ? _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT_NONE_AVAILABLE : _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT_PLACEHOLDER
                })
            }
            var Cn = t(2590),
                Tn = t(439492),
            ...
            function Hn(e) {
                var n, t, o, l = e.guildId,
                    ...
                    S = Zn(a.useState(null !== (t = null !== (n = null == m ? void 0 : m.name) && void 0 !== n ? n : null == y ? void 0 : y.name) && void 0 !== t ? t : ""), 2),
                    j = S[0],
                    N = S[1],
                    A = Zn(a.useState(null !== (o = null == y ? void 0 : y.volume) && void 0 !== o ? o : 1), 2),
                    D = A[0],
                    x = A[1],
                    E = Zn(a.useState(null == y ? void 0 : y.emojiId), 2),
                    P = E[0],
                    I = E[1],
                    M = Zn(a.useState(null == y ? void 0 : y.emojiName), 2),
                    C = M[0],
                    T = M[1],
                    U = q(),
                    L = U.file,
                    ...
                    B = F[0],
                    G = F[1],
                    H = Zn(a.useState(null), 2),
                    V = H[0],
                    Y = H[1],
                    z = Zn(a.useState(null), 2),
                    W = z[0],
                    $ = z[1],
                    J = Zn(a.useState(Fn.READY), 2),
                    K = J[0],
                    Q = J[1],
                    X = Zn(a.useState(l), 2),
                    ee = X[0],
                    ne = X[1];
                a.useEffect((function() {
                    null != (null == m ? void 0 : m.file) && function(n) {
                ...
                var re, ae = function(e) {
                        switch (e) {
                            case Fn.ENCODING:
                                return _.Z.Messages.SOUNDBOARD_MODAL_AUDIO_STATE_ENCODING;
                            case Fn.ENCODING_FAILED:
                                return _.Z.Messages.SOUNDBOARD_MODAL_AUDIO_STATE_ENCODING_FAILED;
                            case Fn.UPLOADING:
                                return _.Z.Messages.SOUNDBOARD_MODAL_AUDIO_STATE_UPLOADING
                        }
                        return null
                    }(K),
                    oe = K === Fn.UPLOADING || K === Fn.ENCODING,
                    ie = null != y,
                    le = j.length >= 2 && (ie || null != L) && null != ee && function(e) {
                        if (null == e) return !0;
                        var n = (e.endMs - e.startMs) / 1e3;
                        return n > 0 && n <= xe.YW
                    }(W),
                    ue = a.useCallback((re = kn((function(e, n) {
                        var t, r;
                    ...
                    })), [ie, v, ee, y, j, D, P, C, se, Z]);
                a.useEffect((function() {
                    R(null);
                    h.default.track(Cn.rMx.OPEN_MODAL, {
                ...
                return (0, r.jsxs)(s.ModalRoot, {
                    ...
                    children: [(0, r.jsx)(s.ModalCloseButton, {
                        ...
                        className: Un().headerContainer,
                        separator: !1,
                        children: (0, r.jsx)(s.Heading, {
                            className: Un().header,
                            variant: "heading-xl/extrabold",
                            children: ie ? _.Z.Messages.SOUNDBOARD_SOUND_UPDATE_MODAL_HEADER : _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_HEADER
                        })
                    }), (0, r.jsxs)(s.ModalContent, {
                        className: Un().content,
                        children: [null != V && !V.hasFieldErrors() && (0, r.jsx)(s.FormErrorBlock, {
                            className: Un().section,
                            children: V.message
                        }), O ? (0, r.jsx)(s.FormItem, {
                            required: !0,
                            className: Un().section,
                            title: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_GUILD_SELECT,
                            children: (0, r.jsx)(Mn, {
                                value: ee,
                                onChange: ne
                            })
                        }) : null, (ie || null != L) && (0, r.jsx)(He, {
                            sound: y,
                            volume: D,
                            disabled: oe,
                            onChange: $
                        }), ie || null != m ? null : (0, r.jsx)(s.FormItem, {
                            required: !0,
                            error: null == V ? void 0 : V.getFirstFieldErrorMessage("sound"),
                            className: Un().section,
                            title: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_FILE,
                            children: (0, r.jsx)(d.Z, {
                                filename: null !== (fe = null == L ? void 0 : L.name) && void 0 !== fe ? fe : "",
                                buttonText: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_BROWSE,
                                placeholder: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_INPUT_PLACEHOLDER,
                            ...
                            className: Un().multiInput,
                            children: [(0, r.jsx)(s.FormItem, {
                                required: !0,
                                error: null == V ? void 0 : V.getFirstFieldErrorMessage("name"),
                                className: i()(Un().section, Un().halfInput),
                                title: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SOUND_NAME,
                                children: (0, r.jsx)(s.TextInput, {
                                    placeholder: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SOUND_NAME,
                                    value: j,
                                    onChange: N,
                                    maxLength: xe.Ek
                                })
                            ...
                            className: Un().section,
                            title: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SOUND_VOLUME,
                        ...
                        children: [(0, r.jsx)(s.Button, {
                            ...
                            onClick: ce,
                            children: ie ? _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_SAVE : _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_UPLOAD
                        }), (0, r.jsx)(s.Button, {
                            disabled: B,
                            onClick: v,
                            size: s.Button.Sizes.SMALL,
                            ...
                            children: _.Z.Messages.SOUNDBOARD_SOUND_UPLOAD_MODAL_CANCEL
                        }), null != ae && (0, r.jsx)("div", {
                            className: Un().soundStateHint,
                            children: (0, r.jsx)(s.Text, {
                                variant: "text-xs/normal",
                                color: "text-muted",
                                children: ae

        ...
        649844: function(e, t, l) {
            ...
            function E(e) {
                let {
                    ...
                    giftRecipient: b,
                    returnRef: v
                } = null != e ? e : {}, x = !1, g = (0, s.v4)(), B = o.default.getCurrentUser(), j = (0, f.isPremiumExactly)(B, _.PremiumTypes.TIER_2);
                (0, a.openModalLazy)(async () => {
                    ...
                    return l => {
                        ...
                        return (0, n.jsx)(e, {
                            ...
                            followupSKUInfo: E,
                            onClose: (e, t) => {
                                s(), null == p || p(e), e && (null == m || m(), !R && null != t && t === _.PremiumSubscriptionSKUs.TIER_2 && !j && d.ComponentDispatch.dispatch(T.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                x = !0, null == S || S(), !R && (0, r.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: m,
                            analyticsLocations: I,
                            analyticsObject: P,
                    ...
                    onCloseCallback: () => {
                        !x && c.default.track(T.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: g,
                            ...
                            application_id: O,
                            location_stack: I
                        }), (0, i.clearError)(), (0, u.clearPurchaseTokenAuthState)(), null == p || p(x), x && (null == m || m())
                    },

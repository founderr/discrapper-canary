            ...
            var o = function() {
                ...
                return o.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var s, c, l, f, h, v, p, d, b, g, m, w, y, x, z, O, _ = (s = u, h = Array(32768), s.forEach(function(e) {
                        ...
                        var S = (v = u, p = _, m = 1e6, w = 0, y = 1e6, x = 0, z = 1e6, O = 0, v.forEach(function(r) {
                                d = r[0] >> t, b = r[1] >> t, g = r[2] >> t, d < m ? m = d : d > w && (w = d), b < y ? y = b : b > x && (x = b), g < z ? z = g : g > O && (O = g)
                            }), new o(m, w, y, x, z, O, p)),

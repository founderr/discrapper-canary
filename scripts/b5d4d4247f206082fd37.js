    ...
    ["89695"], {
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                i.useEffect(() => {
                    g(null)
                }, [m, g]), o(null != A, "Unknown step for current payment flow.");
                let T = null !== (u = null == A ? void 0 : null === (t = A.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    M = null == A ? void 0 : null === (n = A.options) || void 0 === n ? void 0 : n.bodyClassName,
        ...
        273619: function(e, t, n) {
            ...
            var p = n("454589"),
                ...
                S = n("782340"),
                h = n("129429");
            let g = new Set([_.Step.SKU_SELECT, _.Step.AWAITING_AUTHENTICATION, _.Step.AWAITING_PURCHASE_TOKEN_AUTH, _.Step.CONFIRM]);
            ...
            function N(e) {
                let {
                    ...
                    footer: T,
                    isGift: M = !1,
                    giftMessage: C = S.default.Messages.PREMIUM_PAYMENT_IS_GIFT,
                    hideBreadcrumbs: R = !1,
                    isLoading: y = !1,
                    purchaseError: P,
                ...
                null != N && null == (0, _.errorToStep)(N) ? F = N : null != P ? F = P : null != x && (F = x);
                let U = null != F ? F.message : "";
                null != F && F instanceof d.BillingError && (F.code === E.ErrorCodes.CARD_DECLINED && D && (U += " ".concat(S.default.Messages.BILLING_ERROR_TRY_ANOTHER)), F.code === E.ErrorCodes.INVALID_GIFT_REDEMPTION_FRAUD_REJECTED && (U = S.default.Messages.GIFT_CODE_SMITE_REJECT_HELP_TEXT), F.code === v.AbortCodes.BILLING_NON_REFUNDABLE_PAYMENT_SOURCE && (U = S.default.Messages.GIFT_CODE_PAYMENT_SOURCE_INVALID));
                let {
                    stripe: V
                } = (0, f.usePaymentContext)();
                y = y || null == V;
                let j = i.useRef(new o.Timeout);
                i.useEffect(() => {
                    let e = j.current;
                ...
                let B = t.includes(_.Step.PAYMENT_TYPE) ? _.Step.PAYMENT_TYPE : _.Step.ADD_PAYMENT_STEPS;
                return (0, r.jsxs)(a.Elements, {
                    options: v.StripeElementsOptions,
                    stripe: V,
                    children: [A, (0, r.jsxs)("div", {
                        className: s("paymentModalContent", h.content),
                        children: [M && n !== _.Step.CONFIRM ? (0, r.jsx)(c.default, {
                            className: h.paymentNote,
                            iconSize: c.default.Sizes.SMALL,
                            icon: I.default,
                            color: null == C ? c.default.Colors.PRIMARY : c.default.Colors.SECONDARY,
                            children: C
                        }) : null, R ? null : (0, r.jsx)("div", {
                            className: h.breadcrumbsWrapper,
                            children: (0, r.jsx)(p.default, {
                                activeId: _.COLLAPSED_PAYMENT_BREADCRUMB_STEPS.has(n) ? B : n,
                                breadcrumbs: t.filter(e => !_.COLLAPSED_PAYMENT_BREADCRUMB_STEPS.has(e) && !g.has(e)).map(e => ({
                                    id: e,

        ...
        309244: (e, t, r) => {
            ...
            var k = function(e) {
                var t, r = e.effectIsOwned,
                    ...
                    u = (0, i.e7)([w.Z], (function() {
                        return w.Z.getProduct(null == o ? void 0 : o.skuId)
                    })),
            ...
            const H = function(e) {
                var t, r = e.user,
                    ...
                    g = E.ZP.isPremium(r),
                    O = (0, h.Z)(r.id),
                    j = Boolean(null == O ? void 0 : O.getPreviewBio(s).value),
                    P = Z.dN.useSetting() && null != s ? x.ZP.parse(void 0, s).content : s,
                    w = E.ZP.canUsePremiumProfileCustomization(r),
                    C = (null == O ? void 0 : O.canUsePremiumProfileCustomization) || w,
                    A = {
                        user: r,
            ...
            const ye = function(e) {
                var t, r = e.user,
                    ...
                    g = b[0],
                    O = b[1],
                    m = E.ZP.canUsePremiumProfileCustomization(r),
                    h = u.length > 0,
                    v = 0 === s.length,
            ...
            function Pe(e) {
                ...
                o.useEffect((function() {
                    P.default.track(K.rMx.OPEN_MODAL, {
                        type: K.jXE.PROFILE_EFFECT_CUSTOMIZATION,
                        location_stack: I
                    })
                }), [I]);
                return null == w ? null : (0, n.jsx)(x, {

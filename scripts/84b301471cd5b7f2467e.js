                ...
                return (0, r.jsx)(c.PaymentModal, d(function(e) {
                    ...
                    onClose: function(e) {
                        ...
                        if (e && null != n) {
                            ...
                            (0, o.i1)(n);
                            null == P || P();
                            null == n || !_ && u.Z.getGuildId() === n || (0, a.uL)(s.Z5c.CHANNEL(n))
                        }
                    },
        ...
        586611: (e, t, n) => {
            ...
            function $(e) {
                var t = e.analyticsLocations,
                    ...
                    be = (0,
                        w.usePaymentContext)(),
                    he = be.activitySessionId,
                    me = be.purchaseState,
                    ve = be.setPurchaseState,
                    Oe = be.selectedSkuId,
                    ge = be.setSelectedSkuId,
                    Ee = be.selectedPlan,
                    Se = be.setSelectedPlanId,
                    Pe = be.setStep,
                    _e = be.setPurchaseError,
                    we = be.paymentAuthenticationState,
                    je = be.step,
                    Ie = be.contextMetadata,
                    Te = be.purchaseTokenAuthState,
                    Ae = be.activeSubscription,
                    Ce = be.priceOptions,
                    Me = be.hasPaymentSources,
                    xe = be.purchaseType,
                    Re = be.giftRecipient,
                    ke = X(i.useState({
                        load_id: Ie.loadId,
                        payment_type: W.Zuq[xe],
                        location: null != n ? n : o,
                        source: l,
                        subscription_type: f,
                        subscription_plan_id: null == Ee ? void 0 : Ee.id,
                        is_gift: B,
                    ...
                    Ne = ke[0],
                    Le = ke[1],
                    De = X(i.useState((0, P.a8)(Re) ? F.Z.Messages.DEFAULT_CUSTOM_GIFT_MESSAGE : void 0), 2),
                    Ze = De[0],
                    Ge = De[1];
                i.useEffect((function() {
                    Le((function(e) {
                        var t = null != Ee ? (0, _.aS)(Ee.id, !1, B, Ce) : void 0;
                        return z(K({}, e), {
                            subscription_plan_id: null == Ee ? void 0 : Ee.id,
                            price: null == t ? void 0 : t.amount,
                            regular_price: null == Ee ? void 0 : Ee.price,
                ...
                i.useEffect((function() {
                    S.default.track(W.rMx.PAYMENT_FLOW_STARTED, z(K({}, Ne), {
                ...
                i.useEffect((function() {
                    ...
                    if (null != le) ge(le);
                        ...
                        var e;
                        ge(null === (e = g.Z.get(b)) || void 0 === e ? void 0 : e.skuId)
                    }
                }), [Se, ge, b, le]);
                var Ue = (0, u.Z)((function() {
                        return Date.now()
                    }), [je]),
                    We = i.useCallback((function(e) {
                        ...
                        var o = null != n ? n : je,
                            a = Date.now();
                        null !== o ? S.default.track(W.rMx.PAYMENT_FLOW_STEP, z(K({}, Ne, r), {
                            from_step: o,
                            to_step: e === m.h8.ADD_PAYMENT_STEPS ? m.h8.PAYMENT_TYPE : e,
                            step_duration_ms: a - Ue,
                            flow_duration_ms: a - Ie.startTime
                        })) : S.default.track(W.rMx.PAYMENT_FLOW_LOADED, z(K({}, Ne), {
                            initial_step: e,
                            has_saved_payment_source: Me
                        }))
                    }), [Ne, Ie.startTime, d, _e, Pe, je, Ue, Me]),
                    Fe = i.useMemo((function() {
                        return function() {
                            return null == T ? void 0 : T(me === j.A.COMPLETED)
                        }
                    }), [T, me]);
                (0, h.bp)(je, we, We);
                (0, m.dZ)(je, me, ve);
                ...
                var Be = {
                    ...
                    Ve = function(e) {
                        var t = e.isGift,
                            ...
                            f = u.selectedPlan,
                            d = u.purchaseState,
                            p = u.selectedGiftStyle,
                            y = u.purchaseType,
                            b = u.giftRecipient,
                            h = M.ZP.useExperiment({
                                location: "cbdb8c_1"
                            }, {
                                autoTrackExposure: !1
                            }).enabled,
                            v = (0, M.rK)();
                        i.useEffect((function() {
                            v && t && M.ZP.trackExposure({
                                location: "cbdb8c_2"
                            })
                        }), [v, t]);
                        var O = h && v && t && l === N.Si.TIER_2,
                            g = (O || (0, P.a8)(b)) && s === m.h8.CONFIRM && null != p,
                            E = null != n && null != s,
                            S = s !== m.h8.SKU_SELECT && null != l,
                            _ = (0, x.N)(o),
                            j = !t && null != _ && null != l && N.nG[_.trial_id].skus.includes(l);
                        return i.useMemo((function() {
                            if (null != s) {
                                ...
                                else if (E) e = n(null != f ? f : null, a, s);
                                else if (y === L.GZ.ONE_TIME) e = (0, r.jsx)(C.t, {
                                    step: s,
                                    onClose: a
                                });
                                else if (S) {
                                    A()(l in N.y7, "invalid sku id: ".concat(l));
                                    e = (0, r.jsx)(k.Z, {
                ...
                return (0, r.jsx)(c.Shaker, {
                    className: V().shaker,
                    isShaking: se && me === j.A.PURCHASING,
                    intensity: 2,
                    children: (0, r.jsx)(c.ModalRoot, {
                        className: a()(V().root, H({}, V().withHeader, null != Ve)),
                        transitionState: y,
                        hideShadow: ye,
                        size: de ? c.ModalSize.LARGE : c.ModalSize.SMALL,
                        children: (0, r.jsx)(U.ZP, K({
                            header: Ve,
                            isLargeModal: de
                        }, Be))
                    })
            ...
            function q(e) {
                var t = e.subscriptionTier,
                    ...
                    x = (0,
                        l.ZP)([E.Z], (function() {
                        return E.Z.applicationIdsFetched.has(N.RQ)
                    }));
                i.useEffect((function() {
                    M(!h || !v || O)
                }), [O, v, h]);
                ...
                i.useEffect((function() {
                    ...
                    if (!C && !p)
                        if (null != n) o(m.h8.REVIEW);
                            ...
                            if (e.enabled) {
                                var r = (0, y.D3)(e, g, c, _);
                                S(r);
                                o(m.h8.REVIEW)
                            } else o(null != t ? m.h8.PLAN_SELECT : m.h8.SKU_SELECT)
                        }
                }), [c, p, x, n, C, o, t, g, S, T, j, _, P]);
                return C ? (0, r.jsx)(G.Z, {}) : p ? (0, r.jsx)(d.Vq, {}) : null
            }
        },
        28648: (e, t, n) => {
            "use strict";

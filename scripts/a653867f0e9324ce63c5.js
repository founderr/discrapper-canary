(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["99384"], {
        ...
        775433: function(e, t, i) {
            ...
            async function u(e, t, i, c, u) {
                ...
                try {
                    let r = {
                        ...
                        s = {};
                    null != t && (s.country_code = t), null != i && (s.payment_source_id = i), null != c && (s.include_unpublished = c), null != u && (s.revenue_surface = u), r.query = s, !a.default.ipCountryCodeLoaded && await (0, o.fetchIpCountryCode)();
            ...
            function E(e, t) {
                return Promise.all(e.filter(e => e !== c.PremiumSubscriptionSKUs.NONE).map(e => u(e, t)))
            }

            function I(e, t, i) {
                return Promise.all(c.ACTIVE_PREMIUM_SKUS.filter(e => e !== c.PremiumSubscriptionSKUs.NONE).map(n => u(n, e, t, void 0, i)))
            }
            ...
            let d = e => {
                ...
                return (0, r.jsxs)("div", {
                    ...
                    children: [(0, r.jsx)(_.Clickable, {
                        className: s(I.closeButton, {
                            [I.closeButtonBold]: i === l.BOLD,
                            [I.closeButtonSolid]: i === l.SOLID
                        }),
                        onClick: t,
                        "aria-label": E.default.Messages.CLOSE,
                        children: i === l.SOLID ? (0, r.jsx)(u.default, {
                            width: 24,
                            height: 24,
                            "aria-hidden": !0
                        }) : (0, r.jsx)(c.default, {
        ...
        526887: function(e, t, i) {
            ...
            function u(e) {
                ...
                } = e, d = (0, r.useConfettiCannon)(i, o), T = (0, a.default)([s.default], () => s.default.useReducedMotion), A = l.useMemo(() => T ? _ : {
                    confettiCanvas: i,
                    cannon: d,
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return i => {
                        ...
                        return (0, n.jsx)(e, {
                            ...
                            followupSKUInfo: I,
                            onClose: e => {
                                l(), null == d || d(e), e && (null == A || A())
                            },
                            onComplete: () => {
                                v = !0, null == T || T(), !O && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: A,
                            analyticsLocations: C,
                            analyticsObject: L,
                    ...
                    onCloseCallback: () => {
                        !v && _.default.track(u.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: D,
                            ...
                            application_id: M,
                            location_stack: C
                        }), (0, a.clearError)(), (0, s.clearPurchaseTokenAuthState)(), null == d || d(v), v && (!O && c.ComponentDispatch.dispatch(u.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == A || A())
                    },
        ...
        374278: function(e, t, i) {
            ...
            function L(e) {
                ...
                let i, {
                    ...
                    O = a.default.getGuild(L.guild_id),
                    R = null !== (t = null == O ? void 0 : O.maxStageVideoChannelUsers) && void 0 !== t ? t : 0,
                    m = !!(null == O ? void 0 : O.isCommunity()),
                    S = A.default.Messages.STAGE_FULL_TITLE,
                    f = m ? R < d.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED : (null == O ? void 0 : O.premiumTier) !== d.BoostedGuildTiers.TIER_3 && R <= d.MAX_STAGE_VIDEO_USER_LIMIT_TIER2,
                    h = s.default.can(I.MODERATE_STAGE_CHANNEL_PERMISSIONS, L);
                i = m && (null == O ? void 0 : O.premiumTier) === d.BoostedGuildTiers.TIER_3 ? R <= d.MAX_STAGE_VIDEO_USER_LIMIT_UNCAPPED ? A.default.Messages.STAGE_FULL_BOOST_MORE_BODY : A.default.Messages.STAGE_FULL_MAX_BODY : f ? A.default.Messages.STAGE_FULL_BODY : A.default.Messages.STAGE_FULL_MAX_BODY;
                let M = () => {
                        N(), c.default.track(d.AnalyticEvents.BOOSTING_UPSELL_CLICKED, {
                            guild_id: L.guild_id,
                    ...
                    U = u.default.getMutableParticipants(L.id, E.StageChannelParticipantNamedIndex.SPEAKER),
                    P = U.filter(e => e.type === E.StageChannelParticipantTypes.VOICE),
                    g = P.length,
                    v = u.default.getParticipantCount(L.id, E.StageChannelParticipantNamedIndex.AUDIENCE);
                return c.default.track(d.AnalyticEvents.BOOSTING_UPSELL_VIEWED, {
                    guild_id: L.guild_id,
                    type: T.PremiumUpsellTypes.VIDEO_STAGE_LIMIT,
                    is_moderator: h,
                    listener_count: g + v
                    ...
                    children: [(0, n.jsxs)(l.ModalHeader, {
                        ...
                        children: f ? (0, n.jsxs)(n.Fragment, {
                            children: [(0, n.jsx)(l.Button, {
                                ...
                                onClick: () => {
                                    N(), (0, r.openGuildBoostingMarketingModal)({
                                        guildId: L.guild_id,
                                        location: {
                                            section: d.AnalyticsSections.STAGE_VIDEO_LIMIT
                                        }
                                    }), c.default.track(d.AnalyticEvents.BOOSTING_UPSELL_CLICKED, {
                                        guild_id: L.guild_id,
                                        type: T.PremiumUpsellTypes.VIDEO_STAGE_LIMIT,
                                        is_moderator: h,
        ...
        931138: function(e, t, i) {
            ...
            function c(e) {
                let {
                    ...
                    ...u
                } = e, E = l.Children.only(t), I = (0, s.useRedesignIconContext)().enabled;
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(o.default, {
                        ...u,
                        className: a(c, _.flowerStar)
                    }), (0, n.jsx)("div", {
                        className: a(_.childContainer, {
                            [_.redesignIconChildContainer]: I
                        }),
                        children: E
                    })]
                })
        ...
        181114: function(e, t, i) {
            ...
            let d = {
                    [l.DEFAULT]: I.shineDefault,
                    [l.SMALL]: I.shineSmall
                },
                T = {
                    [l.DEFAULT]: I.shineInnerDefault,
                    [l.SMALL]: I.shineInnerSmall
                };
            class A extends a.PureComponent {
                render() {
                    ...
                    return (0, r.jsx)(_.default.div, {
                        ...n,
                        className: o(I.shineContainer, e, {
                            [I.shinePaused]: i
                        }),
            ...
            let C = e => {
                let {
                    ...
                    onlyShineOnHover: C,
                    ...L
                } = e, p = a.createRef(), N = (0, u.default)(p), O = !n && !s && !0 !== _ && (!C || N);
                return (0, r.jsxs)(c.Button, {
                    buttonRef: p,
                    ...L,
                    className: o(I.shinyButton, i),
                    disabled: n,
                    submitting: s,
                    children: [t, O ? (0, r.jsx)(A, {
                        shinePaused: d,
                        className: o(I.buttonShine, C ? I.onlyShineOnHover : void 0, T),
                        shineSize: E
                    }) : null]
                })
            };

    ...
    ["56621"], {
        ...
        650484: function(e, t, n) {
            ...
            function _(e) {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (c = null == v ? void 0 : null === (a = v.options) || void 0 === a ? void 0 : a.renderHeader) || void 0 === c || c ? _ : null, v.renderStep(m), null == p || C ? null : (0, i.jsxs)(i.Fragment, {
        ...
        817963: function(e, t, n) {
            ...
            let f = {
                ...
                h = e => {
                    let [t, n] = e instanceof a.default ? [d.Permissions.CREATE_EVENTS, d.Permissions.MANAGE_EVENTS] : _(e), [r, s, c, h] = (0, l.useStateFromStoresArray)([o.default], () => [o.default.can(d.Permissions.CREATE_GUILD_EXPRESSIONS, e), o.default.can(d.Permissions.MANAGE_GUILD_EXPRESSIONS, e), o.default.can(t, e), o.default.can(n, e)]), m = (0, l.useStateFromStores)([u.default], () => u.default.getCurrentUser()), p = i.useCallback(e => E(e, m, s, r), [r, s, m]), I = i.useCallback(e => E(e, m, h, c), [h, c, m]);
                    return null == e ? f : {
        ...
        460029: function(e, t, n) {
            ...
            var p = r.memo(function(e) {
                ...
                let {
                    ...
                    audio: g
                } = (0, d.useAudioTrimmerStore)(), [S, N] = r.useState(!1), [A, v] = r.useState(m), {
                ...
                let b = r.useCallback(e => {
                    ...
                    D = r.useCallback(() => {
                        if (null != g) {
                            ...
                            C >= T ? g.currentTime = (0, E.toSeconds)(O) : g.currentTime = (0, E.toSeconds)(C), g.volume = (0, c.default)(l), g.play(), N(!0)
                        }
                    }, [g, T, b, C, S, O, l]),
                    y = r.useCallback(e => {
                        v(e), null == I || I({
        ...
        278175: function(e, t, n) {
            ...
            var h = s.memo(function(e) {
                let {
                    ...
                    audio: m
                } = (0, c.useAudioTrimmerStore)(), p = null != m, I = s.useRef(null), g = s.useRef(null), S = s.useRef(null), [N, A] = s.useState(0), [v, C] = s.useState(0), [T, O] = s.useState(0), [L, R] = s.useState(!1), [M, b] = s.useState(!1), [D, y] = s.useState(!1), [U, P] = s.useState(0), [x, w] = s.useState(-1), F = s.useMemo(() => U / h.fineTuningScale, [h.fineTuningScale, U]);
                s.useEffect(() => {
                    if (null == m) return;
                ...
                let V = s.useCallback((e, t) => {
                    ...
                    G = s.useCallback(e => {
                        ...
                        let t = parseInt(e.target.value),
                            n = t > T ? T : t;
                        i((0, d.toSeconds)(n)), A(n), C(n)
                    }, [m, i, T, L]),
                    j = s.useCallback(e => {
                        if (null == m || !M) return;
                        let t = parseInt(e.target.value);
                        t < N ? (i((0, d.toSeconds)(N)), C(N)) : t > T ? (i((0, d.toSeconds)(T)), C(T)) : (i((0, d.toSeconds)(t)), C(t))
                    }, [m, i, T, M, N]),
                    k = s.useCallback(e => {
                        if (null == m || !D) return;
                        let t = parseInt(e.target.value),
                            n = t > N ? t : N;
                        i((0, d.toSeconds)(N)), C(N), O(n)
                    }, [m, i, D, N]);
                return s.useEffect(() => {
                    null != r && p && r({
                        startPositionMs: N,
                    ...
                    if (null != m) return t && (e = setInterval(() => {
                        m.currentTime < (0, d.toSeconds)(T) ? m.currentTime >= (0, d.toSeconds)(v) && C(1e3 * m.currentTime) : (n((0, d.toSeconds)(N)), C(N))
                    }, 16)), () => {
                        clearInterval(e)
                    }
                    ...
                    children: [(0, l.jsxs)("div", {
                        ...
                        children: [(0, l.jsxs)("div", {
                            ...
                            children: [(0, l.jsx)("input", {
                                ...
                                type: "range",
                                min: (0, d.getMinValue)(x, F, U),
                                max: (0, d.getMaxValue)(x, F, U),
                                value: N,
                                onChange: G,
                                onMouseDown: e => V(e, 0),
                                onMouseUp: () => B(0),
                        ...
                        children: [(0, l.jsxs)("div", {
                            ...
                            style: {
                                left: "".concat((0, d.getStartHandleValue)(N, x, F, U), "%"),
                                right: "".concat((0, d.getEndHandleValue)(T, x, F, U), "%")
                            },
                            ...
                            children: (0, l.jsx)("div", {
                                ...
                                style: {
                                    left: "".concat((0, d.getStartHandleValue)(v, x, F, U), "%")
                                }
                            })
                        })]
                    }), (0, l.jsx)("div", {
        ...
        527246: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                m = r.memo(function(e) {
                    ...
                    }, [n, m]), N = (0, f.useAudioBufferData)(t), A = (0, f.useAudioWaveformData)(N, g.current, S), v = (0, c.default)(), C = (0, d.useColorValue)((0, o.isThemeDark)(v) ? _.Color.PRIMARY_300 : _.Color.PRIMARY_700), T = null == N || null == A, O = 0 === p.width || 0 === p.height, L = (O || T) && null != t, R = r.useCallback(() => {
                        null != g.current && I({
        ...
        723961: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                h = r.memo(function(e) {
                    ...
                    return r.useEffect(() => {
                        null == I.current && (I.current = (0, d.loadAudioFileFromUrl)(A, t.name).then(N))
            ...
            function O(e) {
                ...
                let ee = function(e) {
                    ...
                    es = s.useCallback(async () => {
                        c(null != X, "Cannot submit soundboard sound with no guildId"), H(!0), K(null);
                        try {
                ...
                return (0, l.jsxs)(d.ModalRoot, {
                    ...
                    children: [(0, l.jsx)(d.ModalCloseButton, {
                        ...
                        className: C.content,
                        children: [null != W && !W.hasFieldErrors() && (0, l.jsx)(d.FormErrorBlock, {
                            className: C.section,
                            children: W.message
                            ...
                            disabled: et,
                            onChange: z
                        }), en || null != u ? null : (0, l.jsx)(d.FormItem, {
                            required: !0,
        ...
        181114: function(e, t, n) {
            ...
            let p = e => {
                let {
                    ...
                    onlyShineOnHover: h,
                    ...p
                } = e, I = s.createRef(), g = (0, d.default)(I), S = !i && !r && !0 !== a && (!h || g);

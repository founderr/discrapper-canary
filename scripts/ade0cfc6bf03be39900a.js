    ...
    [75700], {
        ...
        456826: (t, e, n) => {
            ...
            function m(t, e, n) {
                ...
                c.Z.updateLayout(t, T.AEg.NO_CHAT)
            }
                    ...
                    return Z(this, (function(p) {
                        switch (p.label) {
                            ...
                            case 1:
                                ...
                                return [4, E.Z.post({
                                    url: T.ANM.ACTIVITY_CHANNEL_LAUNCH(t, c.application_id),
                                    body: {
                                        session_id: l,
                    ...
                    return Z(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                ...
                                return [4, r.ZP.post({
                                    url: T.ANM.ACTIVITY_UPLOAD_ATTACHMENT(t),
                                    attachments: [{
                                        name: "file",
                                        file: e
                                    }]
            ...
            function H() {
                return (H = g((function(t) {
                    var e, n, r, o, c, l, u, s, p, h, f, A, b, C, g, m, P;
                    return Z(this, (function(Z) {
                        switch (Z.label) {
                            ...
                            case 4:
                                b = Z.sent();
                                g = null !== (C = b.body.activities) && void 0 !== C ? C : [];
                                P = null !== (m = b.body.applications) && void 0 !== m ? m : [];
                                a.Z.dispatch({
            ...
            function V() {
                return (V = g((function(t) {
                    var e, n, i, r, a;
                    return Z(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                e = t.activityChannelId, n = t.invitedChannelId, i = t.applicationId,
                                    r = t.location;
                                return [4, l.Z.createInvite(e, {
                                    target_type: b.Iq.EMBEDDED_APPLICATION,
...
//# sourceMappingURL=ade0cfc6bf03be39900a.js.map
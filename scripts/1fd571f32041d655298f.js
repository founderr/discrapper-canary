    ...
    ["73641"], {
        ...
        176347: function(e, t, n) {
            ...
            var ej = a.memo(function(e) {
                ...
                }), m = (0, d.useStateFromStores)([Y.default], () => Y.default.isEnabled()), p = (0, J.default)(t.id), E = (0, B.default)(t.id);
                return (0, s.jsx)(eO, {
                    channel: t,
            ...
            var s = n("37983"),
                ...
                k = a.memo(function(e) {
                    ...
                    let k, {
                        ...
                        J = (0, r.useStateFromStoresArray)([p.default], () => {
                            var e;
                            return null !== (e = p.default.getNewClipIds()) && void 0 !== e ? e : []
                        }),
        ...
        928328: function(e, t, n) {
            ...
            function M(e) {
                let {
                    ...
                    onSubmit: x,
                    onClose: R
                } = e, y = (0, d.default)(r), [D, O] = a.useState(!1), [j, b] = a.useState(v), [P, F] = a.useState(null), [U, H] = a.useState(o.shuffle(r)), [k, G] = a.useState(""), w = (0, h.useUID)(), B = (0, C.default)(j), V = (0, C.default)(D), W = (0, C.default)(P), Z = (0, C.default)(x), z = (0, C.default)(k), K = null != P && M.includes(P);
                return a.useEffect(() => {
        ...
        554393: function(e, t, n) {
            ...
            function P(e) {
                let {
                    ...
                    isGuest: X,
                    isPendingMember: J
                } = (0, m.default)(W), Q = (0, y.useForumActivityExperiment)(null == W ? void 0 : W.guild_id), $ = (0, o.useStateFromStores)([T.default], () => T.default.getChannel(P)), ee = (0, v.useDefaultReactionEmoji)($), et = (0, o.useStateFromStores)([f.default], () => f.default.shouldDisplayPrompt(t) && !0 === n, [t, n]), en = a.useCallback(e => {
                    let t = e[0];
                    if (null != t && n) {
        ...
        556118: function(e, t, n) {
            ...
            function K(e) {
                ...
                let {
                    ...
                    popouts: C,
                    setPopout: m
                } = (0, D.default)(a.id, B.DEFAULT_POPOUTS), p = (0, L.default)(a), g = (0, x.getMessageAriaLabelledBy)(a), S = (0, x.getMessageAriaDescribedBy)(a);
        ...
        823674: function(e, t, n) {
            ...
            function em(e) {
                let {
                    ...
                    let {
                        ...
                        author: h
                    } = n, C = (0, u.useStateFromStores)([R.default], () => R.default.getGuild(t.guild_id), [t.guild_id]), m = (0, u.useStateFromStores)([L.default], () => L.default.getId()), p = (0, I.useIsActiveChannelOrUnarchivableThread)(t), _ = (0, I.useIsNonModInLockedThread)(t), A = N.RenderReactions.useSetting(), T = N.DeveloperMode.useSetting(), v = (0, u.useStateFromStores)([y.default], () => null == t.guild_id || y.default.canChatInGuild(t.guild_id), [t]), {
                        canManageMessages: O,
                ...
                }, [X, em, n]), ex = a.useCallback(() => {
                    em({
                        emojiPicker: !ei
                    })
                }, [ei, em]), eR = (0, I.useIsActiveChannelOrUnarchivableThread)(t), ey = n.hasFlag(eo.MessageFlags.CROSSPOSTED);
                return (0, s.jsxs)(s.Fragment, {
                    children: [Z ? (0, s.jsxs)(s.Fragment, {
                        ...
                        channel: t,
                        message: n,
                        label: ep ? ed.default.Messages.CLYDE_VIEW_SOURCE_HIDE_TOOLTIP : ed.default.Messages.CLYDE_VIEW_SOURCE_SHOW_TOOLTIP,
                        icon: F.default,
                        onClick: () => {
                            eg(!ep), J.default.track(eo.AnalyticEvents.CLYDE_AI_THOUGHTS_VIEWED, {
                                message_id: n.id
                            })
                        }
            ...
            function ep(e) {
                let {
                    channel: t,
                    message: n
                } = e, a = (0, u.useStateFromStores)([m.default], () => null != m.default.getMessage(n.id), [n.id]), l = null == n.interaction || null != n.interactionData && (0, p.canRetryInteractionData)(n.interactionData);
                return (0, s.jsxs)(s.Fragment, {
                    children: [!a && l && eC({
                        key: "retry",
            ...
            var eg = a.memo(function(e) {
                let {
                    ...
                    return n.state === eo.MessageStates.SEND_FAILED ? (0, s.jsx)(ep, {
                        channel: t,
                        message: n
                    }) : null
                }(e), o = function(e) {
                    ...
                    return t.state !== eo.MessageStates.SEND_FAILED ? (0, s.jsx)(em, {
                        ...e
                    }) : null
                }(e);
        ...
        818950: function(e, t, n) {
            ...
            let U = a.memo(function(e) {
                ...
                let B = (n = C, (0, o.useStateFromStores)([m.default], () => {

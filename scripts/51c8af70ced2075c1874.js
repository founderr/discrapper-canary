    ...
    ["98288"], {
                    ...
                    return (0, i.jsxs)(s.ModalHeader, {
                        ...
                        children: [(0, i.jsxs)(S.default.Child, {
                            ...
                            children: [(0, i.jsx)(s.Heading, {
                                ...
                                className: A.header,
                                children: E.default.parse(p.default.Messages.TWO_FA_SUCCESS_HEADER)
                            }), (0, i.jsx)(s.Text, {
        ...
        650484: function(e, t, n) {
            ...
            function I(e) {
                ...
                r.useEffect(() => {
                    p(null)
                }, [S, p]), s(null != O, "Unknown step for current payment flow.");
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                P = !0, null == T || T(), !p && ((0, s.setIsPersistentHelperHidden)(!0), (0, s.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: f,
                            analyticsLocations: S,
                            analyticsObject: N,
                    ...
                    onCloseCallback: () => {
                        !P && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: g,
                            location_stack: S
                        }), (0, o.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == I || I(P), P && (!p && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == f || f())
                    },
        ...
        235004: function(e, t, n) {
            ...
            var M = new U(s.default, {
                LOGOUT: function() {
                    S.clear(), N.clear(), O.clear(), R = !1, p = r.NOT_FETCHED, C = r.NOT_FETCHED
                },
        ...
        364685: function(e, t, n) {
            ...
            var F = new b(a.default, {
                BACKGROUND_SYNC: () => {
                    A = null, p = new Map, m = new Map, h = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    A = null, p = new Map, m = new Map, t.forEach(y), h = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    h = 0, O = [], p.clear(), C.clear(), A = null, m.clear(), m = new Map(m), L = !1, R = null
                },
            ...
            var i = n("37983"),
                ...
                I = r.forwardRef(function(e, t) {
                    let {
                        ...
                        transitionState: T,
                        reason: f
                    } = e, S = (0, l.useStateFromStores)([d.default], () => d.default.getCurrentUser()), N = (0, l.useStateFromStores)([u.default], () => u.default.getAction()), [h, C] = r.useState(null), [p, A] = r.useState(null), [O, R] = r.useState(null), [L, m] = r.useState(!1), g = r.useCallback(async e => {
                        m(!0);
                        try {
                            E.default.isPhoneReverification(S, N) ? await s.default.beginReverifyPhone(e, f) : await s.default.beginAddPhone(e, f), R(null), C(e)
                        } catch (e) {
                            R(new a.default(e))
                        }
                        m(!1)
                        ...
                        if (null != h && null != S) {
                            ...
                            try {
                                let {
                                    token: t
                                } = await s.default.verifyPhone(h, e);
                                R(null), A(t)
                            } catch (e) {
                                R(new a.default(e))
                            }
                        ...
                        null != p && (E.default.isPhoneReverification(S, N) ? await s.default.reverifyPhone(p, e, f) : await s.default.addPhone(p, e, f), null == n || n(), I())
                    }, [n, I, p, f, S, N]);
                    return null != p ? (0, i.jsx)(o.default, {
                        onClose: I,
                        transitionState: T,
        ...
        26092: function(e, t, n) {
            ...
            function L(e) {
                ...
                }, C = null !== (i = e.onClose) && void 0 !== i ? i : null, p = null !== (r = e.analyticsLocation) && void 0 !== r ? r : null, A = null !== (l = e.analyticsLocations) && void 0 !== l ? l : [], R = null !== (o = e.impressionSource) && void 0 !== o ? o : null
            }

            function m() {
                u = s.FormStates.CLOSED, S = !1, T = null, O = null, f = null, d = null, c = null, E = {}, _ = {}, C = null, p = null, A = [], R = null
            }
            ...
            class U extends l.default.Store {
                ...
                hasChanges() {
                    return null != f && null != T && (!!this.isOpen() || h === s.DrawerTabTypes.USER_SETTINGS) && !r.isEqual(f, T)
                }
                isOpen() {
                    return S
                }
            ...
            var M = new U(o.default, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    var t;
                    d = c, c = e.section, p = null, A = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [], null != e.subsection && (E[c] = e.subsection)
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return h = e.tab, null == c && h === s.DrawerTabTypes.USER_SETTINGS && L({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        181114: function(e, t, n) {
            ...
            let S = e => {
                let {
                    ...
                    onlyShineOnHover: S,
                    ...N
                } = e, h = o.createRef(), C = (0, c.default)(h), p = !i && !a && !0 !== u && (!S || C);
            ...
            let _ = {
                ...
                I = e => {
                    let {
                        ...
                        enabled: C
                    } = (0, d.useRedesignIconContext)(), p = t;

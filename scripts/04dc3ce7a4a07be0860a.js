(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["74928"], {
            ...
            var l = n("37983"),
                ...
                g = e => {
                    ...
                    i.useEffect(() => {
                        ...
                        W && N && d.default.track(p.AnalyticEvents.OPEN_MODAL, {
                            type: p.AnalyticsSections.CROP_GIF_MODAL,
                            location: {
                                page: w
                            }
                        })
                    ...
                    let Z = () => {
                            switch (C) {
                                ...
                                case h.UploadTypes.AVATAR_DECORATION:
                                    return {
                                        height: p.AVATAR_MAX_SIZE, width: p.AVATAR_MAX_SIZE
                                    };
                        ...
                        Y = i.useCallback(() => {
                            ...
                            let {
                                ...
                                width: n,
                                height: l
                            } = (0, f.adjustImageDimensionsForAspectRatio)(C, e, t), i = (0, f.calculateOverlaySize)(C, n, l, t);
                            H({
                                width: n,
                                height: l
                    ...
                    return i.useEffect(() => (window.addEventListener("mouseup", K), window.addEventListener("resize", Y), () => {
                        ...
                        children: (0, l.jsxs)(a.ModalRoot, {
                            ...
                            children: [N && (0, l.jsx)(u.default, {
                                type: C,
                                analyticsPage: w,
                                analyticsSection: p.AnalyticsSections.CROP_GIF_MODAL,
                                isGIF: W,
                                banner: n
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, l.jsx)(e, {
                            ...
                            followupSKUInfo: E,
                            onClose: e => {
                                i(), null == h || h(e), e && (null == A || A())
                            },
                            onComplete: () => {
                                y = !0, null == p || p(), !I && ((0, s.setIsPersistentHelperHidden)(!0), (0, s.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: A,
                            analyticsLocations: _,
                            analyticsObject: T,
                    ...
                    onCloseCallback: () => {
                        !y && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: v,
                            location_stack: _
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == h || h(y), y && (!I && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == A || A())
                    },
            ...
            var i = n("414456"),
                ...
                w = function(e) {
                    let {
                        ...
                        ...j
                    } = e, k = (0, a.useStateFromStores)([h.default], () => h.default.getCurrentUser()), F = (0, a.useStateFromStores)([A.default], () => A.default.isFocused()), W = (0, a.useStateFromStores)([p.default], () => p.default.getPremiumTypeSubscription()), {
                        ...
                        if (null == w || w(e), (null == W ? void 0 : W.status) === R.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                            (0, c.trackPremiumSettingsPaneOpened)(), s.default.open(R.UserSettingsSections.PREMIUM), null == U || U(!1);
                            return
                        }! function(e) {
                            let {
                                isClaimed: t,
                            ...
                            let A = R.AnalyticsObjectTypes.BUY;
                            null != s ? A = R.AnalyticsObjectTypes.TRIAL : r && (A = R.AnalyticsObjectTypes.GIFT), (0, d.default)({
                                isGift: r,
                                initialPlanId: null,
                                subscriptionTier: a,
                                analyticsLocations: f,
                    ...
                    let Y = C.default.Messages.APPLICATION_STORE_GET_PREMIUM,
                        ...
                        q = i === I.PremiumSubscriptionSKUs.TIER_2 && null != K && [I.PremiumTypes.TIER_0, I.PremiumTypes.TIER_1].includes(K);
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: p,
                    ..._
                } = e, T = a.createRef(), g = (0, d.default)(T), m = !l && !i && !0 !== o && (!p || g);
                return (0, r.jsxs)(c.Button, {
                    ...
                    disabled: l,
                    submitting: i,
                    children: [t, m ? (0, r.jsx)(A, {
                        shinePaused: f,
                        className: s(E.buttonShine, p ? E.onlyShineOnHover : void 0, h),
                        shineSize: u
                    }) : null]
                })
            };
        ...
        103603: function(e, t, n) {
            ...
            let A = e => "number" == typeof e ? null : _(e),

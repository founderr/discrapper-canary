    ...
    [37375, 71402], {
        ...
        971402: (e, t, n) => {
            ...
            function p(e, t, n, r) {
                ...
                if (null == e.currentTarget.contains || e.currentTarget.contains(e.target)) {
                    ...
                    if (0 === p && 0 === d) {
                        var b, y = null === (b = e.target) || void 0 === b ? void 0 : b.getBoundingClientRect(),
                            h = null != y ? y : {},
                            g = h.left,
                            v = void 0 === g ? 0 : g,
                            O = h.top,
                    ...
                    if ((null == n ? void 0 : n.enableSpellCheck) && (0, i.nI)()) var S = (0, u.RD)((function() {
                        S();
                        s(P)
                    }));
                    else {
        ...
        557233: (e, t, n) => {
            ...
            function v(e) {
                ...
                0 !== t.length && c.default.track(f.rMx.GUILD_RAID_REPORTED, h(y({}, (0, u.hH)(e)), {
                    guild_id: e,
                    raid_types: t
                }))
            }
            ...
            function _() {
                return (_ = d((function(e, t, n, r) {
                    var u, a;
                    return g(this, (function(l) {
                        switch (l.label) {
                            case 0:
                                u = o()().add(r, "hours").toISOString();
                                a = {
                    ...
                    return g(this, (function(a) {
                        switch (a.label) {
                            case 0:
                                ...
                                o = l.Z.getGuild(e);
                                u = null == o ? void 0 : o.getSafetyAlertsChannelId();
                                return r && null != u ? [4, i.ZP.post({
        ...
        189651: (e, t, n) => {
            ...
            function E(e, t) {
                d.default.track(h.rMx.VIEW_AS_ROLES_SELECTED, w(m({
            ...
            function j(e) {
                var t = f.Z.getChannelId(e),
                    n = u.Z.getChannel(t);
                if (!(null != t && (0, g.AB)(t)) && !s.Z.can(h.Plq.VIEW_CHANNEL, n)) {
                    var r = a.ZP.getDefaultChannel(e);
                    null != r && (0, i.uL)(h.Z5c.CHANNEL(e, r.id))
                }
            }
            ...
            function I(e, t) {
                ...
                if (null != n) {
                    ! function(e, t) {
                        var n = _(a.ZP.getSelectableChannelIds(e)).concat(_(a.ZP.getVocalChannelIds(e))),
                            r = Array.from(t);
                        a.ZP.addConditionalChangeListener((function() {
                            ...
                            var o = _(a.ZP.getSelectableChannelIds(e)).concat(_(a.ZP.getVocalChannelIds(e))).filter((function(e) {
                                return !n.includes(e)
                            }));
                            o.length > 0 && A(e, o, []);
                            return !1
        ...
        7194: (e, t, n) => {
            ...
            function M(e, t) {
                var a, l = t === p.IlC.POPOUT,
                    c = (0, b.e7)([w.Z], (function() {
                        return w.Z.getGuild(e)
                    }), [e]),
                    s = A(o.useState(!1), 2),
                    f = s[0],
                    _ = s[1],
                    E = (0, y.sw)(e).showAlertMode,
                    M = (0, b.e7)([O.Z], (function() {
                        return null != c ? O.Z.getGuildIncident(c.id) : null
                    })),
                    R = (null == c ? void 0 : c.hasFeature(p.oNc.INVITES_DISABLED)) || E && null != (null == M ? void 0 : M.invitesDisabledUntil) && new Date(M.invitesDisabledUntil) > new Date,
                    k = A(o.useState(R), 2),
                    D = k[0],
                    T = k[1],
                    N = (a = P((function(t) {
                ...
                return l ? null : (0, r.jsx)(i.MenuCheckboxItem, {
                    id: "pause-invites",
                    label: d.Z.Messages.DISABLE_INVITES,
                    action: function() {
                        N(!D)
                    },
                    checked: D
            ...
            var R = n(665458);
            const k = (0, l.Z)((0, a.Z)((function(e) {
                var t = e.guildId,
                    n = e.context,
                    o = e.onSelect,
                    a = function(e, t) {
                        return t === p.IlC.POPOUT ? null : (0, r.jsx)(i.MenuItem, {
                            id: "report-raid",
                            label: d.Z.Messages.GUILD_REPORT_RAID_BUTTON_TITLE,
                            action: function() {
                                (0, s.xf)();
                                (0, R.J)(e)
                            }
                    ...
                    c = function(e, t) {
                        return t === p.IlC.POPOUT ? null : (0, r.jsx)(i.MenuItem, {
                            ...
                            label: d.Z.Messages.SERVER_SETTINGS,
                            action: function() {
                                (0, s.xf)();
        ...
        73105: (e, t, n) => {
            ...
            var m = function(e, t) {
                ...
                w = new l.Z("Spellchecker"),
                _ = null === r.Z || void 0 === r.Z ? void 0 : r.Z.spellCheck;

            function E(e) {
                var t;
                e = null !== (t = b[e]) && void 0 !== t ? t : e;
                    ...
                    function e(t) {
                        ...
                        this.languageDetector = new d(o, (function(e) {
                            ...
                            if (-1 !== t.indexOf(r)) n.setLocale(r);
                                ...
                                var i, a = null !== (i = u[e]) && void 0 !== i ? i : b[o];

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["27404"], {
        ...
        397613: function(e, t, n) {
            ...
            class l extends r.Component {
                ...
                resetErrorBoundary() {
                    ...
                    if (null !== e) {
                        for (var t, n, r = arguments.length, s = Array(r), l = 0; l < r; l++) s[l] = arguments[l];
        ...
        111633: function(e, t, n) {
            ...
            e.exports = function(e) {
                var t, n;
                return (e = String(e).toLowerCase()).length < 3 ? e : (121 === e.charCodeAt(0) && (t = !0, e = "Y" + e.substr(1)), C.test(e) ? e = e.substr(0, e.length - 2) : b.test(e) && (e = e.substr(0, e.length - 1)), (n = E.exec(e)) ? u.test(n[1]) && (e = e.substr(0, e.length - 1)) : (n = _.exec(e)) && d.test(n[1]) && (e = n[1], g.test(e) ? e += "e" : x.test(e) ? e = e.substr(0, e.length - 1) : f.test(e) && (e += "e")), (n = v.exec(e)) && d.test(n[1]) && (e = n[1] + "i"), (n = I.exec(e)) && u.test(n[1]) && (e = n[1] + r[n[2]]), (n = N.exec(e)) && u.test(n[1]) && (e = n[1] + s[n[2]]), (n = y.exec(e)) ? c.test(n[1]) && (e = n[1]) : (n = m.exec(e)) && c.test(n[1]) && (e = n[1]), (n = h.exec(e)) && (c.test(n[1]) || o.test(n[1]) && !f.test(n[1])) && (e = n[1]), p.test(e) && c.test(e) && (e = e.substr(0, e.length - 1)), t && (e = "y" + e.substr(1)), e)
            };
            var r = {
                    ational: "ate",
                    tional: "tion",
        ...
        531674: function(e, t, n) {
            ...
            function E(e, t) {
                let [n, s] = (0, l.useStateFromStoresArray)([d.default], () => [d.default.isChannelMuted(e.guild_id, e.id), d.default.getChannelMuteConfig(e.guild_id, e.id)]), i = (0, c.useMutedUntilText)(s), v = (0, p.default)(e, !0);
                ...
                let b = m.default.Messages.MUTE_CHANNEL_GENERIC,
                    C = m.default.Messages.UNMUTE_CHANNEL_GENERIC;
                switch (e.type) {
                    case h.ChannelTypes.GUILD_CATEGORY:
                        b = m.default.Messages.MUTE_CATEGORY, C = m.default.Messages.UNMUTE_CATEGORY;
                        break;
                    case h.ChannelTypes.GROUP_DM:
                        b = m.default.Messages.MUTE_CONVERSATION, C = m.default.Messages.UNMUTE_CONVERSATION;
                        break;
                    case h.ChannelTypes.DM:
                        b = m.default.Messages.MUTE_CHANNEL.format({
                            name: v
                        }), C = m.default.Messages.UNMUTE_CHANNEL.format({
                            name: v
                        });
                        break;
                    default:
                        b = m.default.Messages.MUTE_CHANNEL_GENERIC, C = m.default.Messages.UNMUTE_CHANNEL_GENERIC
                }
                    ...
                    children: _().map(n => {
                        ...
                        return (0, r.jsx)(a.MenuItem, {
                            ...
                            action: () => (function(n) {
                                ...
                                let r = g(n);
                                o.default.updateChannelOverrideSettings(e.guild_id, e.id, r, f.NotificationLabels.Muted, t)
                            })(s)
                        }, s)
                    })
                })
        ...
        177589: function(e, t, n) {
            ...
            function o(e) {
                return (0, s.default)(e) ? u.XBOX_APPLICATION_ID_PREFIX + e.name : (0, r.default)(e) && null != e.party && null != e.party.id ? l.SpotifyApplication.id : (0, i.default)(e) && null != e.url ? a.TWITCH_APPLICATION_ID_PREFIX + e.url : null != e.application_id ? e.application_id : null
            }
        },
            ...
            class d extends s.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this.renderBreadcrumb = (e, t) => {
                        ...
                        } = this.props, f = e.id === n, p = t === i.length - 1, h = null != u ? u(e, f) : (0, r.jsx)("span", {
                ...
                render() {
                    ...
                    return (0, r.jsxs)(u.default, {
                        ...
                        children: [(0, r.jsx)("div", {
                            ...
                            align: u.default.Align.CENTER,
                            grow: 0,
                            children: [null != s ? (0, r.jsx)(a.Button, {
                                className: o.action,
        ...
        664336: function(e, t, n) {
            ...
            let v = e => {
                    ...
                    return null == A && "string" == typeof g && (A = g), (0, r.jsx)(o.Tooltip, {
                        text: g,
                        color: E,
                        position: b,
                        hideOnClick: C,
                ...
                _ = e => {
                    let {
                        ...
                        scrollable: g,
                        transparent: E = !1
                    } = e, b = s.useRef(null), C = s.useContext(c.default);
                        ...
                        children: (0, r.jsxs)(o.FocusRingScope, {
                            ...
                            children: [(0, r.jsxs)("div", {
                                ...
                                children: [(0, r.jsxs)("div", {
                                    ...
                                    onDoubleClick: p,
                                    children: [u.isMobile && null != C ? (0, r.jsx)(a.default, {
                                        onClick: C,

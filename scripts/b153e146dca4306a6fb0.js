        ...
        586611: (e, t, n) => {
            ...
            function $(e) {
                var t = e.analyticsLocations,
                    ...
                    me = (0,
                        P.usePaymentContext)(),
                    _e = me.activitySessionId,
                    ve = me.purchaseState,
                    Se = me.setPurchaseState,
                    ge = me.selectedSkuId,
                    Oe = me.setSelectedSkuId,
                    Ie = me.selectedPlan,
                    Pe = me.setSelectedPlanId,
                    be = me.setStep,
                    Te = me.setPurchaseError,
                    Me = me.paymentAuthenticationState,
                    Ae = me.step,
                    Ne = me.contextMetadata,
                    je = me.purchaseTokenAuthState,
                    Re = me.activeSubscription,
                    ke = me.priceOptions,
                    we = me.hasPaymentSources,
                    Ce = me.purchaseType,
                    xe = me.giftRecipient,
                    Le = q(i.useState({
                        load_id: Ne.loadId,
                        payment_type: F.Zuq[Ce],
                        location: null != n ? n : a,
                        source: o,
                        subscription_type: f,
                        ...
                        activity_session_id: _e
                    }), 2),
                    Ze = Le[0],
                    Ge = Le[1],
                    De = q(i.useState((0, O.a8)(xe) ? H.Z.Messages.DEFAULT_CUSTOM_GIFT_MESSAGE : void 0), 2),
                    Ue = De[0],
                    Ye = De[1];
                i.useEffect((function() {
                    Ge((function(e) {
                        var t = null != Ie ? (0, I.aS)(Ie.id, !1, K, ke) : void 0;
                        return Q(z({}, e), {
                            subscription_plan_id: null == Ie ? void 0 : Ie.id,
                ...
                i.useEffect((function() {
                    g.default.track(F.rMx.PAYMENT_FLOW_STARTED, Q(z({}, Ze), {
                ...
                i.useEffect((function() {
                    ...
                    if (null != ce) Oe(ce);
                        ...
                        var e;
                        Oe(null === (e = v.Z.get(S)) || void 0 === e ? void 0 : e.skuId)
                    }
                }), [Pe, Oe, S, ce]);
                var We = (0, l.Z)((function() {
                    ...
                    Fe = i.useCallback((function(e) {
                        ...
                        var a = null != n ? n : Ae,
                            s = Date.now();
                        null !== a ? g.default.track(F.rMx.PAYMENT_FLOW_STEP, Q(z({}, Ze, r), {
                            from_step: a,
                            to_step: e === h.h8.ADD_PAYMENT_STEPS ? h.h8.PAYMENT_TYPE : e,
                            step_duration_ms: s - We,
                            flow_duration_ms: s - Ne.startTime
                        })) : g.default.track(F.rMx.PAYMENT_FLOW_LOADED, Q(z({}, Ze), {
                            initial_step: e,
                            has_saved_payment_source: we
                        }))
                    }), [Ze, Ne.startTime, d, Te, be, Ae, We, we]),
                    He = i.useMemo((function() {
                        return function() {
                            return null == A ? void 0 : A(ve === b.A.COMPLETED)
                        }
                    }), [A, ve]);
                (0, y.bp)(Ae, Me, Fe);
                (0, h.dZ)(Ae, ve, Se);
                    ...
                    Be = function(e) {
                        ...
                        return i.useMemo((function() {
                            if (null != f) {
                                ...
                                else if (y === G.GZ.ONE_TIME) e = (0, r.jsx)(j.t, {
                                    step: f,
                                    onClose: l
                                });
                                else if (b) {
                ...
                return (0, r.jsx)(u.Shaker, {
                    className: B().shaker,
                    isShaking: de && ve === b.A.PURCHASING,
                    intensity: 2,
                    children: (0, r.jsx)(u.ModalRoot, {
                        className: s()(B().root, X({}, B().withHeader, null != Be)),
                        transitionState: E,
                        hideShadow: he,
            ...
            function J(e) {
                ...
                }), [u, p, w, n, R, a, t, v, g, N, A, I, O, b]);
                return R ? (0, r.jsx)(Y.Z, {}) : p ? (0, r.jsx)(d.Vq, {}) : null
            }
        },
        28648: (e, t, n) => {
            "use strict";

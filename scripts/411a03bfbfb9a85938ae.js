    ...
    ["99211"], {
        ...
        478098: function(e, t, A) {
            ...
            e.exports = function(e, t, A) {
                ...
                function m(t) {
                    var A = o,
                        a = i;
                    return o = i = void 0, f = t, u = e.apply(a, A)
                }
                ...
                function p(e) {
                    var A = e - C,
                        a = e - f;
                    return void 0 === C || A >= t || A < 0 || h && a >= d
                }

                function U() {
                    var e, A, a, n, r = l();
                    if (p(r)) return I(r);
                    c = setTimeout(U, (A = (e = r) - C, a = e - f, n = t - A, h ? s(n, d - a) : n))
                }
                ...
                function v() {
                    var e, A = l(),
                        a = p(A);
                    if (o = arguments, i = this, C = A, a) {
                        if (void 0 === c) {
                            ;
                            return f = e = C, c = setTimeout(U, t), g ? m(e) : u
                        }
                        if (h) return clearTimeout(c), c = setTimeout(U, t), m(C)
                    }
        ...
        17692: function(e, t, A) {
            ...
            function u(e) {
                let {
                    ...
                    text: u,
                    lineClamp: c
                } = e, C = (0, s.usePrivateHeadingLevel)(), f = l.useMemo(() => null == u ? null : (0, o.default)(u, !0, {
                    allowHeading: null == c,
                    allowList: null == c,
        ...
        435032: function(e, t, A) {
            ...
            function I(e) {
                ...
                let {
                    ...
                    parentModalKey: L
                } = e, O = (0, o.useFormContext)(), [R, D] = l.useState(() => (0, i.toRichValue)(N)), P = l.useRef(!0 === u), V = null != A ? A : null == O ? void 0 : O.titleId, j = null !== (t = null == O ? void 0 : O.errorId) && void 0 !== t ? t : T, b = l.useMemo(() => ({
        ...
        168804: function(e, t, A) {
            ...
            function I(e, t) {
                ...
                let {
                    editSkuId: n,
                    onFileSizeError: r
                } = t, o = (0, l.default)([C.default], () => C.default.getGuild(e)), [i, d] = a.useState({
                    editSkuId: n,
                    onFileSizeError: r
                }), u = a.useMemo(() => new U({
                    guildId: e,
                ...
                let {
                    uploads: q
                } = u, L = !q.every(e => u.existingAttachmentIds.has(e.id)) || q.length !== u.existingAttachmentIds.size;
                return {
                    addAttachment: E,
        ...
        492724: function(e, t, A) {
            ...
            function g(e) {
                ...
                return (0, a.jsxs)("div", {
                    className: n(f.productThumbnailContainer, A),
            ...
            function T(e) {
                ...
                return null == I ? (0, a.jsx)("article", {
                    className: n(f.productCard, E ? f.opaqueBackground : f.solidBackground),
                    "aria-labelledby": D,
                    children: P
                }) : (0, a.jsx)("div", {
                    style: {
                    ...
                    children: (0, a.jsx)(r.ClickableContainer, {
                        ...
                        className: n(f.productCard, E ? f.opaqueBackground : f.solidBackground, f.cardClickableContainer),
                        onClick: I,
                        children: P
                    })
                })
        ...
        155539: function(e, t, A) {
            ...
            function x(e) {
                ...
                let {
                    ...
                    null == o || o(A.id)
                }, [o, A.id]), c = n >= 1, C = n < 0, h = c || C, T = null !== (t = A.filename) && void 0 !== t ? t : A.id, p = (0, m.describeUploadProgressError)(n);
        ...
        795785: function(e, t, A) {
            ...
            function h(e) {
                let {
                    ...
                    disabled: U = !1
                } = e, I = n === f, [v, E] = l.useState(I ? A : null), [x, N] = l.useState(null), q = l.useRef(null), L = l.useRef(null);
                l.useEffect(() => {
                    h !== f && (E(null), N(null))
                }, [h]);
                let O = null != x ? c.default.Messages.CUSTOM_IMAGE_SELECTOR_YOUR_CUSTOM_IMAGE_WITH_FILENAME.format({
                        filename: x
                    ...
                    P = () => {
                        n === f && T(t[0].data, t[0].name), E(null), N(null)
                    };
                return l.useEffect(() => {
                    if (I && null != x) {
                        var e, t;
        ...
        48175: function(e, t, A) {
            ...
            function $(e) {
                let {
                    ...
                    disabled: l,
                    warning: r
                } = e, s = (0, O.useUID)(), i = l ? "text-muted" : "text-normal";
            ...
            function eA(e) {
                ...
                let {
                    ...
                    application: ei
                } = (0, m.default)(O, Z.ApplicationTypes.GUILD_ROLE_SUBSCRIPTIONS), ed = S.PRODUCT_IMAGE_PRESETS[0], eu = (0, c.default)([T.default], () => T.default.useReducedMotion), ec = E.GifAutoPlay.useSetting(), eC = (0, V.useIsWindowFocused)(), ef = r.useCallback(() => {
                    var e;
                    return (null == es ? void 0 : null === (e = es.image_asset) || void 0 === e ? void 0 : e.application_id) == null ? ed.data : (0, P.getAssetURL)(es.image_asset.application_id, es.image_asset, 600, eC && ec ? void 0 : "webp")
                }, [ed, es, eC, ec]), {
                    shouldRestrictUpdatingCreatorMonetizationSettings: eg
                } = (0, I.useShouldRestrictUpdatingCreatorMonetizationSettings)(O);
                r.useEffect(() => {
                ...
                let [eh, eT] = r.useState(null !== (l = null == es ? void 0 : es.name) && void 0 !== l ? l : ""), [em, ep] = r.useState(null !== (s = null == es ? void 0 : es.description) && void 0 !== s ? s : ""), [eU, eI] = r.useState(null !== (o = null == es ? void 0 : es.price_tier) && void 0 !== o ? o : void 0), [ev, eE] = r.useState(ef), [ex, eN] = r.useState(null !== (i = null == es ? void 0 : null === (t = es.image_asset) || void 0 === t ? void 0 : t.filename) && void 0 !== i ? i : ed.name), [eq, eL] = r.useState(!1), [eO, eR] = r.useState(), eD = r.useMemo(() => null != eU ? (0, D.formatPrice)(eU, Q.CurrencyCodes.USD) : void 0, [eU]), [eP, eV] = r.useState(!0), {
                    changesSaving: ej,
                    saveError: eb,
                    saveProductWithAttachments: eM,
                    hasUnsavedAttachmentChanges: eS,
                    cancelUnusedUploads: eF
                } = (0, j.useGuildProductAttachmentManagerContext)(), e_ = (null == es ? void 0 : es.attachments) != null && (null == es ? void 0 : es.attachments.length) > 0, eG = null != eb ? eb : eO, eK = null != ej && "published" in ej, eB = null != ej && !eK, eW = null !== (p = null == es ? void 0 : es.role_id) && void 0 !== p ? p : null, [eX, ez] = r.useState(), ey = null != eX || null != eW, eQ = (0, c.default)([x.default], () => {
                    if (null != eW && null !== eX) {
                        let e = x.default.getGuild(O);
                ...
                let eH = () => {
                    ...
                    e2 = r.useMemo(() => eJ || null == ew || "publish" === ew || null != eG ? null : (0, n.jsx)(q.default, {
                ...
                r.useEffect(() => {
                    (0, f.updateModal)(y.GUILD_PRODUCT_EDIT_MODAL_KEY, e => (0, n.jsx)(ea, {
                        guildId: O,
                        productId: en,
                        ...e
                    }), e6)
                ...
                r.useEffect(() => {
                    if (null != eG) {
                        var e;
                        (0, B.showPublishErrorDialog)(eG, O, null == ei ? void 0 : null === (e = ei.team) || void 0 === e ? void 0 : e.id)
                    }
                }, [eG, O, ei]), r.useEffect(() => {
                    eJ && ek(void 0)
                }, [eJ]);
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsxs)("div", {
                                ...
                                children: [(0, n.jsx)($, {
                                    ...
                                    value: eP,
                                    onChange: e => {
                                        e ? eV(!0) : eS ? (0, f.openModalLazy)(async () => {
                                            let {
                                                ConfirmModal: e
                ...
                return l && !n ? I = !0 : (l || n) && (I = (0, o.getDarkness)(t) > .1), (0, a.jsx)(i.FocusRing, {
                    ...
                    children: (0, a.jsxs)("button", {
                        ...
                        children: [l ? (0, a.jsx)(f.default, {
                            ...
                            let e = 16,
                                t = 16;
                            if ((l || A) && (e = 32, t = 24), n) return (0, a.jsx)(C.default, {
                                width: e,
                                height: t,
                                color: (0, u.getColor)(I ? h.Color.WHITE_500 : h.Color.BLACK_500)
                            })
            ...
            let E = l.memo(e => {
                ...
                return (0, a.jsxs)(i.Dialog, {
                    ...
                    children: [(0, a.jsx)(c.default, {
                        ...
                        children: [C && null != h && (0, a.jsx)(g.Icon, {
                            onClick: v,

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [12059, 96043, 71402], {
            ...
            function D(e) {
                ...
                if (!h.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== g.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = M(u, i),
                        c = R({}, t, b(a), null != i && null != o && (0, N.AB)(o) ? P(0, o) : C(u));
                    h.default.track(e, c, {
                        flush: n
                    })
                }
                ...
                return (0, r.jsxs)(c.ModalRoot, {
                    ...
                    children: [(0, r.jsxs)(c.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(N.Z, {
                            ...
                            children: y.Z.Messages.CONNECTIONS_ROLES_CHANNEL_NAME
                        ...
                        children: [(0, r.jsx)(c.Heading, {
                            ...
                            color: "header-primary",
                            children: y.Z.Messages.CONNECTIONS_ROLES_CHANNEL_CALL_TO_ACTION_LEARN_MORE.format({
            ...
            var ne = {},
                ...
                ae = function(e) {
                    ...
                    r.getActiveJoinedThreadsForParent = function(e, t) {
                        var n;
                        return e in b && null !== (n = b[e][t]) && void 0 !== n ? n : ie
                    };
                    r.getActiveJoinedThreadsForGuild = function(e) {
                        var t;
                        return null !== (t = b[e]) && void 0 !== t ? t : ne
                    };
                    ...
                    r.computeAllActiveJoinedThreads = function(e) {
                        ...
                        for (var n in b)
                            if (n === e || null == e)
                                for (var r in b[n])
                                    for (var i in b[n][r]) t.push(b[n][r][i].channel);
                        return t
                    };
                    ...
                    r.getActiveThreadCount = function(e, t) {
                        var n, r, o, u;
                        return i().size(null !== (o = null === (n = b[e]) || void 0 === n ? void 0 : n[t]) && void 0 !== o ? o : {}) + i().size(null !== (u = null === (r = L[e]) || void 0 === r ? void 0 : r[t]) && void 0 !== u ? u : {})
                    };
                    r.__getLocalVars = function() {
                        return {
                            activeJoinedThreads: b,
            ...
            const le = new ae(a.Z, {
                ...
                CHANNEL_DELETE: function(e) {
                    ...
                    if (null != t.guild_id && null != t.parent_id) {
                        if (t.guild_id in b && t.parent_id in b[t.guild_id]) {
                            delete b[t.guild_id][t.parent_id];
                            n = !0
                        }
        ...
        491260: (e, t, n) => {
            ...
            var F = function(e) {
                ...
                r.getActivities = function(e) {
                    ...
                    if (null == t) {
                        var n;
                        return null !== (n = y[e]) && void 0 !== n ? n : N
                    }
                    var r = L(e, t);
                ...
                r.getAllApplicationActivities = function(e) {
                    var t = [],
                        ...
                        i = void 0;
                    try {
                        for (var o, u = Object.keys(y)[Symbol.iterator](); !(n = (o = u.next()).done); n = !0) {
                            var a = o.value,
                                l = y[a],
                                c = !0,
                                s = !1,
            ...
            const H = new F(l.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(e) {
                    ...
                    if (R[t] === e.status && y[t] === e.activities) return !1;
                    R[t] = e.status;
                    y[t] = e.activities;
                    delete P[t]
                }
        ...
        96606: (e, t, n) => {
            ...
            function L() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : b.SIZE_24;
                switch (e) {
                    case b.SIZE_16:
                        return T().size16;
                    case b.SIZE_24:

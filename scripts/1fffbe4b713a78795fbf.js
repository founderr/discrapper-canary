    ...
    ["43800"], {
                    ...
                    children: [(0, n.jsxs)("div", {
                        ...
                        children: [m.type === u.CollectiblesItemType.AVATAR_DECORATION && (0, n.jsx)(A, {
                            ...
                            children: [(0, n.jsx)(i.Text, {
                                ...
                                children: m.type === u.CollectiblesItemType.AVATAR_DECORATION ? h.default.Messages.USER_SETTINGS_AVATAR_DECORATION : m.type === u.CollectiblesItemType.PROFILE_EFFECT ? h.default.Messages.USER_SETTINGS_PROFILE_EFFECT : null
                            })]
                        }), (0, n.jsx)(i.Text, {
                            variant: "text-md/semibold",
            ...
            var r = s("77078"),
                ...
                S = e => {
                    ...
                    let h = async e => {
                        ...
                        !s && _(f.default.Messages.COLLECTIBLES_GIFT_SEND_ERROR_OWNED), C(!1)
                    };
                    return (0, n.jsxs)("div", {
        ...
        639137: function(e, t, s) {
            ...
            function c(e) {
                let {
                    step: t,
                    onClose: s
                } = e, r = (0, i.match)(t).with(u.Step.REVIEW, () => o.default.Messages.COLLECTIBLES_SHOP_GIFT_MODAL_REVIEW_HEADER).with(u.Step.GIFT_CUSTOMIZATION, () => o.default.Messages.COLLECTIBLES_SHOP_GIFT_MODAL_SELECT_HEADER).with(u.Step.CONFIRM, () => "").otherwise(() => null);
                    ...
                    children: [(0, n.jsx)(p.PaymentPortalBody, {
                        ...
                        children: (0, n.jsx)(r.ModalFooter, {
                            ...
                            children: (0, n.jsx)(T, {
                                ...
                                showBackButton: !0,
                                onBackClick: s,
                                disabled: null != h || null == A || A.id === (null == O ? void 0 : O.id),
                                loading: m
                            })
                        })
                    })]
        ...
        891865: function(e, t, s) {
            ...
            function M(e) {
                let {
                    ...
                    productLine: h
                } = (0, x.usePaymentContext)(), [T, M] = r.useState(m.default.Modes.DEFAULT), y = (0, o.useStateFromStores)([C.default], () => C.default.enabled), U = () => null != a ? a.skuId : null != l ? l.id : null, b = () => {
                    let e;
                ...
                let B = (0, g.isCustomGiftEnabled)(S),
                    k = h === P.SKUProductLines.COLLECTIBLES;
                return (0, n.jsxs)("div", {
                    className: F.confirmation,
                    children: [null != s ? (0, n.jsx)(A.default, {
                        game: s,
            ...
            let j = e => {
                ...
                let [l, i] = r.useState(), [a, p] = r.useState(!1), [C, m] = r.useState(!1), {
                    userAffinities: A,
                    isLoading: N
        ...
        217796: function(e, t, s) {
            ...
            function S(e) {
                ...
                return (r.useEffect(() => {
                    ...
                    t(d.Step.REVIEW)
                }, [T, l, t, E, h, _, C]), T) ? (0, n.jsx)(c.default, {}) : l ? (0, n.jsx)(a.BlockedPaymentsContentModal, {
                    onClose: s
                }) : null
            }
        },
        65324: function(e, t, s) {
            ...
            function d(e) {
                ...
                } = e, S = (0, l.useStateFromStores)([i.default], () => i.default.useReducedMotion), [E, I] = r.useState(c), p = r.useRef((0, u.getGiftAnimationData)(t, E)), [_, C] = r.useState(null == f), [h, T] = r.useState(!1), [m, A] = r.useState(-1), N = () => {

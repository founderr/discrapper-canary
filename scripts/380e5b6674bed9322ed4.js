            ...
            class E extends l.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: N,
                        retrySuccess: p
                    } = this.state, C = l.Children.count(r) > 0 ? (0, i.jsx)(o.Card, {
            ...
            var i = n("37983"),
                ...
                p = e => {
                    let {
                        ...
                        onCrop: m,
                        onClose: O,
                        uploadType: h = I.UploadTypes.AVATAR,
                        ...
                        left: 0,
                        right: 0
                    }), [P, D] = l.useState(!1), [v, G] = l.useState(1), [w, b] = l.useState({
                        x: 0,
                        y: 0
                    }), [H, y] = l.useState(null), [B, V] = l.useState(!1), {
                        AnalyticsLocationProvider: x
                    } = (0, s.default)(o.default.IMAGE_CROPPING_MODAL), F = l.useRef({
                        x: 0,
                        y: 0
                    }), k = l.useRef(null), j = l.useRef(null), W = "image/gif" === t.type;
                    l.useEffect(() => {
                        (0, d.default)()
                    }, []), l.useEffect(() => {
                        W && L && c.default.track(T.AnalyticEvents.OPEN_MODAL, {
                    ...
                    let Y = () => {
                        ...
                        K = l.useCallback((e, t, n) => {
                            F.current = (0, _.getBoundedCoordinates)(e, t, n), null != k.current && (k.current.style.transform = "translate3d(".concat(F.current.x, "px, ").concat(F.current.y, "px, 0)"))
                        }, [k]),
                        X = l.useCallback(() => {
                            if (null == k.current || v > 1) return;
                            let {
                                width: e,
                                height: t
                                ...
                                width: n,
                                height: i
                            } = (0, _.adjustImageDimensionsForAspectRatio)(h, e, t), l = (0, _.calculateOverlaySize)(h, n, i, t);
                            y({
                                width: n,
                                height: i
                            }), S(l), U((0, _.calculateDragBoundaries)(n, i, l))
                        }, [h, v]),
                        Z = l.useCallback(e => {
                            let {
                                x: t,
                        ...
                        q = async () => {
                            ...
                            if (W) try {
                                let {
                                    result: l,
                                    cancelFn: r
                                } = await (0, _.cropGIF)(t, n, M, F.current, i);
                                j.current = r, e = await l, j.current = null
                            } catch (e) {
                                var l;
                                throw null === (l = j.current) || void 0 === l || l.call(j), j.current = null, Error("Error cropping GIF")
                            } else e = (0, _.cropStaticImage)(n, M, F.current, i);
                            await m(e, t), V(!1), O()
                        };
                            ...
                            children: [L && (0, i.jsx)(u.default, {
                                ...
                                children: [(0, i.jsxs)("div", {
                                    ...
                                    children: [(0, i.jsx)("img", {
                                        style: {
                                            ...
                                            ...(() => {
                                                ...
                                                let e = H.width / H.height,
                                                    t = J() && e > I.BANNER_ASPECT_RATIO ? M.height / H.height : 1;
                                                return {
                                                    width: H.width * v * t,
                                                    minWidth: H.width * v * t,
                                                    height: H.height * v * t
                                                }
                                            })()
                                        },
                                        ...
                                        className: h === I.UploadTypes.AVATAR ? N.overlayAvatar : N.overlayBanner,
                                        style: {
                                            opacity: null == H ? 0 : 1,
                                            width: M.width,
                                            height: M.height
                                    ...
                                    children: [(0, i.jsx)(E.default, {
                                        ...
                                        asValueChanges: e => {
                                            ...
                                            let {
                                                width: t,
                                                height: n
                                            } = H, i = (0, _.calculateDragBoundaries)(t * e, n * e, M), {
                                                x: l,
                                                y: a
                                            } = F.current;
                                            (!(0, r.inRange)(l, i.right, i.left) || !(0, r.inRange)(a, i.top, i.bottom)) && K(l, a, i), G(e), U(i)
                                        },
                                        disabled: B,
                                        equidistant: !0,
                                        hideBubble: !0,
        ...
        8731: function(e, t, n) {
            ...
            function r(e, t, n, i) {
                let l = e.naturalWidth / e.width,
                    ...
                    u = t.width * l,
                    E = t.height * l,
                    c = Math.min(u, i.width),
                    _ = Math.min(E, i.height);
                return {
                    x: o,
                    y: s,
                    scaledCropWidth: u,
            ...
            async function a(e, t, i, a, o) {
                let {
                    ...
                    scaledCropWidth: E,
                    scaledCropHeight: c
                } = r(t, i, a, o), _ = await e.arrayBuffer(), d = new Worker(new URL(n.p + n.u("39703"), n.b)), I = new Promise((e, t) => {
                    d.onmessage = n => {
                        let {
                            data: i
                        } = n;
            ...
            function o(e, t, n, i) {
                ...
                c.width = u, c.height = E;
                let _ = c.getContext("2d");
                return null != _ && _.drawImage(e, l, a, o, s, 0, 0, c.width, c.height), c.toDataURL("image/png")
            }
            ...
            let s = (0, l.createExperiment)({
                ...
                c = function() {
                    ...
                    let {
                        ...
                        user: l,
                        config: a
                    }), d = o && c && null != t && (null == t ? void 0 : null === (e = t.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible) !== !1;
                    return {
                        viewAndUseEnabled: o,
                        collectEnabled: d,
                        showTryPacksModalAndV2Copy: E,
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !D && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: S,
                            location_stack: R
                        }), (0, a.clearError)(), (0, o.clearPurchaseTokenAuthState)(), null == I || I(D), D && (!m && E.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == A || A())
                    },
            ...
            var l = n("414456"),
                ...
                f = function(e) {
                    let {
                        ...
                        ...F
                    } = e, k = (0, a.useStateFromStores)([I.default], () => I.default.getCurrentUser()), j = (0, a.useStateFromStores)([A.default], () => A.default.isFocused()), W = (0, a.useStateFromStores)([T.default], () => T.default.getPremiumTypeSubscription()), {
                        analyticsLocations: Y
                    } = (0, u.default)(), K = e => {
                        if (e.preventDefault(), null == k) {
                            (0, _.transitionTo)(O.Routes.LOGIN);
                            return
                        }
                        if (null == f || f(e), (null == W ? void 0 : W.status) === O.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                            (0, E.trackPremiumSettingsPaneOpened)(), s.default.open(O.UserSettingsSections.PREMIUM), null == G || G(!1);
                            return
                        }! function(e) {
                            let {
                                isClaimed: t,
                            ...
                            let A = O.AnalyticsObjectTypes.BUY;
                            null != s ? A = O.AnalyticsObjectTypes.TRIAL : r && (A = O.AnalyticsObjectTypes.GIFT), (0, c.default)({
                                isGift: r,
                                initialPlanId: null,
                                subscriptionTier: a,
                                analyticsLocations: _,
                    ...
                    if (U) return (0, i.jsxs)(o.Button, {
                        ...
                        onClick: K,
                        ...F,
                        children: [b && (0, i.jsx)(p.default, {
                            className: L.premiumIcon
                        }), (0, i.jsx)("span", {
                            className: r(L.buttonText, D),
                            children: null != P ? P : h.default.Messages.PREMIUM_TRIAL_CTA_BUTTON_VARIANT
                        })]
                    });
                    if (t) return (0, i.jsxs)(o.Button, {
                        ...
                        children: [(0, i.jsx)(N.default, {
                            ...
                            className: r(L.buttonText, D),
                            children: null != P ? P : h.default.Messages.PREMIUM_GIFTING_BUTTON
                        })]
                    });
                    let X = h.default.Messages.APPLICATION_STORE_GET_PREMIUM,
                        Z = null != W ? (0, C.getPremiumPlanItem)(W) : null,
                        z = null != Z ? C.default.getPremiumType(Z.planId) : null == k ? void 0 : k.premiumType,
                        J = l === m.PremiumSubscriptionSKUs.TIER_2 && null != z && [m.PremiumTypes.TIER_0, m.PremiumTypes.TIER_1].includes(z);
                    J && (X = h.default.Messages.BILLING_SWITCH_PLAN_UPGRADE);
                    let q = null != W && W.status !== O.SubscriptionStatusTypes.ACCOUNT_HOLD && !(0, d.isNoneSubscription)(W.planId) && !J,
                        Q = q ? null != V ? V : function(e) {
                            ...
                            return null != o && null != a && a < o ? (i = h.default.Messages.APPLICATION_STORE_GET_PREMIUM, l = h.default.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP) : null != r && null != n && r === n ? (i = h.default.Messages.BILLING_SWITCH_PLAN_CURRENT_PLAN, l = h.default.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP) : null == r && null != n && n === m.PremiumTypes.TIER_2 && (l = h.default.Messages.PREMIUM_SUBSCRIPTION_BUTTON_DISABLED_MANAGE_PLAN_TOOLTIP), {
                                disabledButtonText: i,
                                disabledButtonTooltipText: l
                            }
                        }({
        ...
        181114: function(e, t, n) {
            ...
            let R = e => {
                let {
                    ...
                    submitting: o,
                    pauseAnimation: u,
                    shineSize: _ = l.DEFAULT,
                    shinePaused: I,
                    buttonShineClassName: T,
                    onlyShineOnHover: R,
                    ...N
                } = e, p = a.createRef(), C = (0, c.default)(p), m = !i && !o && !0 !== u && (!R || C);
                return (0, r.jsxs)(E.Button, {
                    ...
                    children: [t, m ? (0, r.jsx)(A, {
                        shinePaused: I,
                        className: s(d.buttonShine, R ? d.onlyShineOnHover : void 0, T),
                        shineSize: _
                    }) : null]
                })
            };

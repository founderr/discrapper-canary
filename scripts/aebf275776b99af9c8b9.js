(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [12082, 67145, 96043, 71402], {
        ...
        14636: (t, e, n) => {
            ...
            t.exports = function(t, e) {
                var n = o(t),
                    ...
                    p = d.length;
                for (var I in t) !e && !s.call(t, I) || E && ("length" == I || _ && ("offset" == I || "parent" == I) || f && ("buffer" == I || "byteLength" == I || "byteOffset" == I) || l(I, p)) || d.push(I);
                return d
            }
        },
        70151: (t, e, n) => {
        ...
        971402: (t, e, n) => {
            ...
            function f(t, e, n, r) {
                ...
                if (null == t.currentTarget.contains || t.currentTarget.contains(t.target)) {
                    ...
                    if ((null == n ? void 0 : n.enableSpellCheck) && (0, o.nI)()) var v = (0, a.RD)((function() {
                        v();
                        c(N)
                    }));
                    else {
        ...
        810978: (t, e, n) => {
            ...
            function O(t, e, n) {
                return Promise.all(c.YQ.filter((function(t) {
                    return t !== c.Si.NONE
                })).map((function(r) {
        ...
        396043: (t, e, n) => {
            ...
            function L(t) {
                ...
                var n, r = l.default.getId(),
                    ...
                    a = o[s.sH].length,
                    u = o[s.Zb].length,
                    E = g.Z.getVoiceStates(t);
                return {
                    guild_id: e.id,
                    guild_size_total: c.Z.getMemberCount(t),
                    guild_num_channels: a + u,
                    guild_num_text_channels: a,
                    guild_num_voice_channels: u,
                    guild_num_roles: b(e.roles),
                    guild_member_num_roles: null != i ? i.roles.length : 0,
                    guild_member_perms: String(null !== (n = d.Z.getGuildPermissions(e)) && void 0 !== n ? n : S.ZP.NONE),
                    guild_is_vip: e.hasFeature(A.oNc.VIP_REGIONS),
                    is_member: null != i,
            ...
            function P(t) {
                ...
                if (null != r) {
                    var i = function(t) {
                        ...
                        return null != e && o.Z.has(e.deny, A.Plq.VIEW_CHANNEL)
                    };
                ...
                return {
                    ...
                    channel_member_perms: String(null != r && null !== (e = d.Z.getChannelPermissions(t)) && void 0 !== e ? e : S.ZP.NONE),
                    channel_hidden: n
                }
            }
            ...
            function w(t) {
                ...
                if (!h.default.isThrottled(t)) {
                    var r = !("location" in e) || e.location !== A.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        i = "guild_id" in e ? e.guild_id : r ? T.Z.getGuildId() : null,
                        o = "channel_id" in e ? e.channel_id : r ? O.Z.getChannelId(i) : null,
                        a = u.Z.getChannel(o),
                        l = M(a, i),
                        s = y({}, e, L(l), null != i && null != o && (0, N.AB)(o) ? R(0, o) : P(a));
                    h.default.track(t, s, {
                        flush: n
                    })
                }
            ...
            function G(t, e) {
                ...
                i()(g.Z.getVoiceStates(t)).forEach((function(t) {
                    t.channelId === e && null != p.Z.findActivity(t.userId, (function(t) {
                        return t.type === A.IIU.CUSTOM_STATUS
            ...
            var r = n(318715),
                ...
                _ = function() {
                    var t, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
                        ...
                        p = f.collectEnabled,
                        I = E && p && null != i && !1 !== (null == i || null === (t = i.inventorySettings) || void 0 === t ? void 0 : t.isEmojiPackCollectible);
                    return {
                        viewAndUseEnabled: E,
                        collectEnabled: I,
        ...
        442212: (t, e, n) => {
            ...
            function N(t) {
                ...
                var tt, et = F ? a()(h().artContainer, h().artContainerBoxShadow, C) : a()(h().artContainer, C),
                    nt = null;
        ...
        491260: (t, e, n) => {
            ...
            function w(t) {
                ...
                delete L[t];
                if (null != v[t]) {
                    var e = g(a().sortBy(v[t], (function(t) {
                            return -t.timestamp
                        })), 1),
                        n = e[0];
            ...
            function j(t, e) {
                ...
                delete n[t];
                0 === Object.keys(n).length && delete v[e];
                w(e)
            }
            ...
            function B(t) {
                var e = !0,
                    ...
                    r = void 0;
                try {
                    for (var i, o = Object.keys(v)[Symbol.iterator](); !(e = (i = o.next()).done); e = !0) {
                        j(t, i.value)
                    }
                } catch (t) {
                    n = !0;
            ...
            var x = function(t) {
                ...
                r.getStatus = function(t) {
                    ...
                    if (null == e) {
                        var i;
                        return null !== (i = y[t]) && void 0 !== i ? i : n
                    }
                    var o, a = C(t, e);
                ...
                r.getActivities = function(t) {
                    ...
                    if (null == e) {
                        var n;
                        return null !== (n = b[t]) && void 0 !== n ? n : N
                    }
                    var r = C(t, e);
                    ...
                    try {
                        for (var o, a = Object.keys(b)[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                            var l = o.value,
                                ...
                                _ = void 0;
                            try {
                                for (var f, E = u[Symbol.iterator](); !(s = (f = E.next()).done); s = !0) {
                                    var d = f.value;
            ...
            const F = new x(u.Z, {
                ...
                SELF_PRESENCE_STORE_UPDATE: function(t) {
                    var e = c.default.getId();
                    if (y[e] === t.status && b[e] === t.activities) return !1;
                    y[e] = t.status;
                    b[e] = t.activities;
                    delete R[e]
                }
        ...
        95891: (t, e, n) => {
            ...
            function u(t) {
                var e = t.width,
                    ...
                    d = t.foreground,
                    p = l(t, ["width", "height", "color", "viewBox", "foreground"]);
                    ...
                    function t(e) {
                        ...
                        this.languageDetector = new E(i, (function(t) {
                            ...
                            if (-1 !== e.indexOf(r)) n.setLocale(r);
                                ...
                                var o, l = null !== (o = a[t]) && void 0 !== o ? o : d[i];

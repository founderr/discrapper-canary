        ...
        919810: (n, e, t) => {
                ...
                return function(n) {
                    ...
                    if (null != t) {
                        var i, r, l = [],
                            ...
                            o = !1;
                        try {
                            for (t = t.call(n); !(a = (i = t.next()).done); a = !0) {
                                l.push(i.value);
            ...
            function g(n) {
                ...
                var p = n.guild_id,
                    ...
                    y = g ? t.getDefaultChannel(n.guild_id) : i.getChannel(f),
                    N = u.getGuild(p),
                    x = h.getStageInstanceByChannel(f);
                return !!(0, r.b)(s.Z, N, y, x) && (null != y && C(n, [i]))
            }

            function y(n) {
                return (0,
                    i.e7)([o.ZP, a.Z, c.Z, l.Z], (function() {
        ...
        383495: (n, e, t) => {
            ...
            function P(n) {
                ...
                return (0, i.jsx)(c.Tooltip, {
                    ...
                    children: function(n) {
                        var r;
                        return (0, i.jsxs)(c.Clickable, A(T({}, n), {
                            className: a()(Z().inline, Z().channelContainer, (r = {}, O(r, Z().channelContainerEnabled, h && null != t), O(r, Z().channelContainerDisabled, !h && null != t), r)),
                            onClick: t,
                            children: [(0, i.jsx)(c.Tooltip, {
                                text: k.Z.Messages.GUILD_EVENT_PRIVATE_CHANNEL_TOOLTIP,
                                shouldShow: l && p && h && null != t,
                                children: function(n) {
                                    return null != m ? (0, i.jsx)(m, A(T({}, n), {
                                        width: 20,
                                        height: 20,
                                        className: Z().icon
                                    })) : null
            ...
            function S(n) {
                var e = n.guild,
                    ...
                    o = n.location,
                    s = n.isExternal;
                return n.isHub ? null == e ? (0, i.jsx)("div", {}) : (0, i.jsxs)("div", {
                    className: Z().inline,
            ...
            function _(n) {
                var e, t = n.className,
                    ...
                    B = n.onContextMenu,
                    V = n.onJoinClick,
                    X = n.onJoinGuildClick,
                    W = n.onGoToGuildClick,
                    z = n.onRsvpClick,
                    q = n.onStartClick,
                    K = n.onInviteClick,
                    Q = n.onEndClick,
                ...
                return (0, i.jsxs)(c.ClickableContainer, {
                    ...
                    onClick: Y,
                    onContextMenu: B,
                    className: a()(Z().card, (e = {}, O(e, Z().joined, P), O(e, Z().lurking, E), e), t),
                    children: [m === I.BANNER && (0, i.jsx)(g.Z, {
                        source: j
                    }), (0, i.jsx)(y.ZP, {
                        userCount: s,
                        creator: o,
                        ...
                        description: v,
                        startTime: h,
                        imageSource: m === I.THUMBNAIL ? j : null,
                        isActive: k,
                        isEnded: T,
                        truncate: J,
                        ...
                        isHub: M,
                        isNew: F
                    }), k && null != r && null != R && G > 0 && (0, i.jsx)(x.Z, {
                        guild: r,
                        speakers: R,
                        speakerCount: G,
                        className: Z().spacing
                    ...
                    v = d.map((function(n) {
                        ...
                        return (0, i.jsxs)("div", {
                            ...
                            children: [(0, i.jsx)(a.Avatar, {
                                src: null == n || null === (t = n.user) || void 0 === t ? void 0 : t.getAvatarURL(e.id, 20),
...
//# sourceMappingURL=440385ef3341621d2ae2.js.map
        ...
        522019: function(e, t, n) {
            ...
            function eu(e) {
                ...
                let n = (0, r.useStateFromStores)([j.default, R.default], () => R.default.getChannel(j.default.getVoiceChannelId())),
                    a = (0, m.default)(n),
                    l = function(e) {
                        let [t] = (0, r.useStateFromStores)([V.default, I.default], () => null == e ? [
                            [], -1
                        ] : e.isGuildStageVoice() ? [I.default.getMutableParticipants(e.id, T.StageChannelParticipantNamedIndex.SPEAKER), I.default.getParticipantsVersion(e.id)] : [V.default.getVoiceStatesForChannel(e), V.default.getVoiceStateVersion(e.getGuildId())], [e], J.isVersionEqual);
                        return t
                    }(n),

    ...
    [27499], {
        327499: (e, t, n) => {
            ...
            var R = function(e, t) {
                ...
                w = function(e) {
                    G.Z.show({
                        title: O.Z.Messages.TOO_MANY_USER_GUILDS_ALERT_TITLE,
                        body: O.Z.Messages.TOO_MANY_USER_GUILDS_ALERT_DESCRIPTION.format({
                            quantity: e
                        })
                    })
                },
                ...
                M = function() {
                    G.Z.show({
                        ...
                        body: O.Z.Messages.PLEASE_TRY_AGAIN_LATER
                    })
                };

            function F() {
                F = A((function(e) {
                    var t, r, o, l, c, a, s, p, _, h, m, D, T, G, O, g, A, U, P, N = arguments;
                    return R(this, (function(Z) {
                        switch (Z.label) {
                            ...
                            case 6:
                                G = Z.sent();
                                if ((null === (O = G.body) || void 0 === O ? void 0 : O.code) === S.evJ.TOO_MANY_USER_GUILDS) {
                                    U = L.default.getCurrentUser();
                                    P = v.ZP.canUseIncreasedGuildCap(U) || (null == U ? void 0 : U.isStaff());
                                    w(P ? S.tHP : S.DZw)
                                }(null === (g = G.body) || void 0 === g ? void 0 : g.code) === S.evJ.GUILD_AT_CAPACITY && M();
                    ...
                    return A((function() {
                        ...
                        return R(this, (function(f) {
                            switch (f.label) {
                                case 0:
                                    r = {
                                        name: null != t && "" !== t ? t : O.Z.Messages.NEW_ROLE,
                                        color: null != n ? n : 0,

    ...
    ["28054"], {
        ...
        176347: function(e, t, n) {
            ...
            var eH = a.memo(function(e) {
                ...
                }), g = (0, Z.useShouldShowMessageRequestBanner)(t.id) && !i, E = (0, d.useStateFromStores)([J.default], () => J.default.isEnabled()), S = (0, et.default)(t.id), A = (0, W.default)(t.id);
                return (0, s.jsx)(eF, {
                    channel: t,
            ...
            var s = n("37983"),
                ...
                W = a.memo(function(e) {
                    ...
                    let W, {
                        ...
                        ea = (0, r.useStateFromStores)([E.HotspotStore], () => E.HotspotStore.hasHotspot(E.HotspotLocations.CLIPS_CHANNEL_ATTACH_REMINDER)),
                    ...
                    let eC = (e, t, n) => {
                        null != t && "ETOOLARGE" === t.code ? (0, H.showUploadFileSizeExceededError)(Z, []) : (0, H.promptToUpload)(e, Z, z, {
                            requireConfirm: !0,
                    ...
                    let ep = (0, N.useCanStartPublicThread)(Z),
                        eg = (0, N.useCanStartPrivateThread)(Z),
                        eE = !L.UseLegacyChatInput.useSetting() && !(0, F.isAndroidWeb)() && null != window.ResizeObserver,
                        ...
                        eT = (0, g.useIsDismissibleContentDismissed)(o.DismissibleContent.PREMIUM_TUTORIAL_FILE_UPLOAD_COMPOSER_TOOLTIP),
                    ...
                    let ex = (0, s.jsx)(u.Popout, {
                        ...
                        renderPopout: e => {
                            switch (eo) {
                                ...
                                case "attachMenu":
                                    return (0, T.dismissPremiumTutorialTooltip)(o.DismissibleContent.PREMIUM_TUTORIAL_FILE_UPLOAD_COMPOSER_TOOLTIP), (0, s.jsx)(U.default, {
                                        ...e,
                                        onClose: () => eu(null),
                                        options: eM,
                                        channel: Z,
        ...
        79254: function(e, t, n) {
            ...
            function N(e) {
                ...
                function b() {
                    C.default.track(_.AnalyticEvents.CHANNEL_ATTACH_MENU_USE_APPS_CLICKED), y("/", (0, E.toRichValue)("/"))
                }
                ...
                function H() {
                    let e = R,
                        ...
                        s = "",
                        a = R.match(I);
                    null != a && (s = a[1], n = a[2], e = a[3], s += a[4]), (0, g.promptToUpload)([(0, p.makeFile)(new Blob([e], {
                        type: "text/plain"
        ...
        194141: function(e, t, n) {
            ...
            function T(e) {
                let {
                    ...
                    onSubmit: x,
                    onClose: R
                } = e, y = (0, d.default)(r), [D, O] = a.useState(!1), [j, b] = a.useState(v), [P, F] = a.useState(null), [H, U] = a.useState(o.shuffle(r)), [k, B] = a.useState(""), G = (0, h.useUID)(), w = (0, C.default)(j), V = (0, C.default)(D), W = (0, C.default)(P), K = (0, C.default)(x), Z = (0, C.default)(k), z = null != P && T.includes(P);
                return a.useEffect(() => {
        ...
        554393: function(e, t, n) {
            ...
            function H(e) {
                let {
                    ...
                    isGuest: J,
                    isPendingMember: $
                } = (0, g.default)(Z), ee = (0, O.useForumActivityExperiment)(null == Z ? void 0 : Z.guild_id), et = (0, o.useStateFromStores)([I.default], () => I.default.getChannel(H)), en = (0, R.useDefaultReactionEmoji)(et), es = (0, o.useStateFromStores)([h.default], () => h.default.shouldDisplayPrompt(t) && !0 === n, [t, n]), ea = a.useCallback(e => {
                    let t = e[0];
                    if (null != t && n) {
                ...
                let ed = z.reactions.length > 0,
                    ...
                    ef = () => {
                        ...
                        }), (0, r.copy)((0, x.getChannelLinkToCopy)(Z, et)), K(!0)
                    },
        ...
        556118: function(e, t, n) {
            ...
            function q(e) {
                ...
                o(a.type === K.MessageTypes.THREAD_STARTER_MESSAGE, "Message must be a thread starter message");
                let {
                    ...f
                ...
                return a.type === K.MessageTypes.THREAD_STARTER_MESSAGE && null != h && h.state === S.ReferencedMessageState.LOADED ? (0, s.jsx)(X, {
                    ...e,
                    message: h.message,
            ...
            function X(e) {
                ...
                let {
                    ...
                    className: L,
                    groupId: R
                } = e, P = m.type === K.MessageTypes.REPLY ? m.messageReference : void 0, {
                    onFocus: H,
                    ...U
                ...
                return (0, s.jsxs)("div", {
                    ...
                    children: [(0, s.jsx)(c.Clickable, {
                        ...
                        className: i(L, {
                            ...
                            [z.ephemeral]: (0, N.hasFlag)(m.flags, K.MessageFlags.EPHEMERAL),
                            [z.systemMessage]: (0, v.default)(m),
                            [z.groupStart]: m.id === R || m.type === K.MessageTypes.REPLY,
                            [z.selected]: eo
                        }),
                        zalgo: !0,
                        onKeyDown: ef,
            ...
            var Q = a.memo(function(e) {
                ...
                o(L.type !== K.MessageTypes.THREAD_STARTER_MESSAGE, "Message must not be a thread starter message");
                let es = K.MessageTypesWithLazyLoadedReferences.has(L.type) ? L.messageReference : void 0,
                    {
                        onFocus: ea,
                        ...el
                    ...
                    eI = ed || eM || eT && eE,
                    eN = eI || eg,
                    eL = (0, d.useStateFromStores)([M.default], () => L.hasFlag(K.MessageFlags.HAS_THREAD) && M.default.getChannel(L.id)),
                    ...
                    eV = null != ek;
                r = L.type === K.MessageTypes.CUSTOM_GIFT ? "" : !eM && eV ? (0, H.default)(e, ey) : (0, B.default)(e, ey, eM);
                let eW = L.id === ee,
                    eK = (0, C.useHighlightColor)(),
                    eZ = et && eW ? (0, s.jsxs)("div", {
                        ...
                        children: (0, s.jsx)("li", {
                            ...
                            children: (0, s.jsx)(I.default, {
                                ...
                                className: i(J, {
                                    ...
                                    [z.highlighted]: et,
                                    [z.ephemeral]: (0, N.hasFlag)(L.flags, K.MessageFlags.EPHEMERAL),
                                    [z.systemMessage]: (0, v.default)(L),
                                    [z.groupStart]: !en && (eW || L.type === K.MessageTypes.REPLY),
                                    [z.selected]: eI,
                                    [z.replying]: (null == eb ? void 0 : eb.message.id) === L.id,
                                    [z.interactionSending]: L.isCommandType() && L.state === K.MessageStates.SENDING,
                                    [z.automodMessage]: eV
                                }),
                                zalgo: !eM,
                                childrenHighlight: eZ,
                                ...
                                onMouseMove: eC,
                                onMouseLeave: em,
                                hasThread: !en && L.hasFlag(K.MessageFlags.HAS_THREAD) && null != eL,
                                isSystemMessage: (0, v.default)(L),
                                hasReply: L.type === K.MessageTypes.REPLY,
                                messageRef: ew
                            })
                        })
                    });
            ...
            function eS(e) {
                let {
                    ...
                    let G = (0, es.canReportMessage)(n),
                        ...
                        Z = t.getGuildId(),
                        z = null != Z && (n.type === ef.MessageTypes.USER_JOIN || n.type === ef.MessageTypes.GUILD_INVITE_REMINDER) && b.default.canWithPartialContext(ef.Permissions.MANAGE_GUILD, {
                            guildId: Z
                        }),
                        {
                            showReminders: Y

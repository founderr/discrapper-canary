    ...
    ["17242"], {
        ...
        235898: function(e, t, n) {
            ...
            function u() {
                ...
                let [t, n, o, u] = (0, l.useStateFromStoresArray)([a.default], () => {
                    var e;
            ...
            function c() {
                ...
                let {
                    ...
                    let [t, n, a, u, c] = (0, l.useStateFromStoresArray)([o.default], () => [o.default.isFetching, o.default.isClaiming, o.default.fetchError, o.default.claimError, o.default.purchases]);
                    return (0, i.useEffect)(() => {
        ...
        649844: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    giftRecipient: F,
                    returnRef: O
                } = null != e ? e : {}, y = !1, w = (0, l.v4)(), H = u.default.getCurrentUser(), U = (0, f.isPremiumExactly)(H, C.PremiumTypes.TIER_2);
                (0, r.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: E,
                            onClose: (e, t) => {
                                l(), null == p || p(e), e && (null == v || v(), !T && null != t && t === C.PremiumSubscriptionSKUs.TIER_2 && !U && d.ComponentDispatch.dispatch(h.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
        ...
        970755: function(e, t, n) {
            ...
            function o() {
                ...
                }), l.default.get(a.Endpoints.APPLICATIONS_SHELF).then(e => r.default.dispatch({
            ...
            function c(e, t) {
                return l.default.delete(a.Endpoints.CHANNEL_INTEGRATION(e, t)).then(e => {
                    var t;
            ...
            let p = new C(s.default, {
                ...
                PRIVATE_CHANNEL_INTEGRATION_UPDATE(e) {
                    ...
                    let i = (0, o.createPrivateChannelIntegration)(t),
                        ...
                        r = [...n]; - 1 === l ? r.push(i) : r[l] = i, u.set(i.channel_id, E(r))
                },
        ...
        889793: function(e, t, n) {
                ...
                return (0, i.jsx)(a.ModalFooter, {
                    ...
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(a.Button, {
                            ...
                            let l = f || !(0, C.isPremiumCollectiblesCategory)(d);
            ...
            function M(e) {
                ...
                } = e, p = (0, s.useStateFromStores)([I.default], () => I.default.getPendingProfileEffectId()), [v, g] = l.useMemo(() => {
                    let e = (0, C.groupProfileEffects)(n, r);
                    return [e.purchased, e.shopPreviews]
                }, [n, r]), [m, N] = l.useState(() => null != u ? u : void 0 !== p ? p : null == c ? null : null != c ? c : null), [A, M] = l.useMemo(() => {
                    var e;
                ...
                }), [A]), y = l.useRef(null), w = S.default.canUseCollectibles(t), {
                    shopForAllEnabled: H
                } = (0, h.default)({
                    location: "AvatarDecorationModal"
                }), U = m === (void 0 === p ? null != c ? c : null : p), b = l.useCallback(e => {
                    N(e)
                }, [N]);
        ...
        717262: function(e, t, n) {
            ...
            let S = e => {
                    ...
                    let {
                        ...
                        category: c,
                        purchase: d
                    } = e, f = (0, l.useStateFromStores)([v.default], () => v.default.getCurrentUser()), h = (0, l.useStateFromStores)([a.default], () => a.default.getProduct(null == s ? void 0 : s.skuId)), E = (0, l.useStateFromStores)([C.default], () => C.default.locale), {
                        shopForAllEnabled: p
                    } = (0, o.default)({
            ...
            var L = e => {
                ...
                }), P = I.default.isPremium(n), x = (0, h.default)(n.id), M = !!(null == x ? void 0 : x.getPreviewBio(g).value), F = E.UseLegacyChatInput.useSetting(), O = F && null != g ? c.default.parse(void 0, g).content : g, y = I.default.canUsePremiumProfileCustomization(n), w = (null == x ? void 0 : x.canUsePremiumProfileCustomization) || y, H = {
                    user: n,
            ...
            let R = () => 80,
                ...
                x = e => {
                    ...
                    let {
                        ...
                        isSelected: c,
                        ...d
                    } = e, E = (0, u.default)([m.default], () => m.default.getProfileEffectById(r.id)), _ = (0, u.default)([f.default], () => {
                        let e = f.default.getProduct(r.skuId);
                        return (0, C.isPremiumCollectiblesProduct)(e)
                    }), T = (0, u.default)([h.default], () => h.default.isItemViewed(r)), R = l.useRef(null), {
                        accessibilityLabel: x,
                        thumbnailPreviewSrc: M,
                        title: F
                    } = null !== (t = null == E ? void 0 : E.config) && void 0 !== t ? t : {}, O = g.default.canUseCollectibles(n), y = a === S.Section.PREMIUM_PURCHASE && !O, [w, H] = l.useState(c);
                    return l.useEffect(() => {
                        c && H(!0)
                    }, [c]), (0, i.jsxs)(P, {
                        ...
                        children: [(0, i.jsx)("img", {
                            ...
                            let e = a === S.Section.PURCHASE || a === S.Section.PREMIUM_PURCHASE && O;
                            if (e) return null;
                            let t = !T && !c && !w;
        ...
        326054: function(e, t, n) {
            ...
            var _ = () => {
                let e = (0, a.default)([f.default], () => f.default.getCurrentUser()),
                    ...
                    [l, _] = (0, a.useStateFromStoresArray)([o.default], () => [o.default.categories, o.default.products]);
                return (0, r.useMemo)(() => {
                    let e = (0, s.uniqBy)([...(0, d.getProfileEffectsFromPurchases)(i), ...(0, d.getProfileEffectsFromCategories)(l)], "id"),
                        r = e.reduce((e, n) => {
                            let l = i.get(n.skuId),
                                r = (0, d.isPremiumCollectiblesPurchase)(l);
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: E,
                    ..._
                } = e, v = s.createRef(), I = (0, d.default)(v), g = !i && !l && !0 !== a && (!E || I);

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [79652, 88110, 96043, 53686, 71402], {
        ...
        825781: (e, t, n) => {
            ...
            var d, p, E, _, O, h, v, y, g, I = o.QZA.CLOSED,
                b = {},
                T = !1;
                                    ...
                                    for (var a, s = t[Symbol.iterator](); !(n = (a = s.next()).done); n = !0) {
                                        ...
                                        if (p.Z.isMember(d) && !k.has(d)) {
                                            var O = !0,
                                                ...
                                                v = void 0;
                                            try {
                                                for (var y, g = _[Symbol.iterator](); !(O = (y = g.next()).done); O = !0) {
                                                    var I = y.value;
        ...
        100856: (e, t, n) => {
            ...
            function b(e, t) {
                ...
                if (!T && !E.Z.can(g.Plq.MOVE_MEMBERS, b)) return null;
                var m = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== b.id && (T ? E.Z.can(g.Plq.CONNECT, n) && !(0, v.rY)(n, h.Z, p.Z) : E.Z.can(g.Plq.MOVE_MEMBERS, n) && (E.Z.can(g.Plq.CONNECT, n) || y.ZP.can({
        ...
        223219: (e, t, n) => {
            ...
            const Z = new G(u.Z, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    P = e.tab;
                    return null == g && P === a.cII.USER_SETTINGS && w({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,

    ...
    [45482, 70801, 83081, 53686], {
        652411: (e, t, n) => {
            ...
            function C(e) {
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            return new m(T(e.minValue, e.maxValue));
                        case "linear":
                            return new O(e.value, e.addValue);
                        case "linear-random":
                            return new O(T(e.minValue, e.maxValue), T(e.minAddValue, e.maxAddValue));
                        case "oscillating":
                            return new g(e.value, e.start, e.final, e.duration, e.direction, e.easingFunction);
                        case "oscillating-random":
                            return new g(T(e.minValue, e.maxValue), T(e.minStart, e.maxStart), T(e.minFinal, e.maxFinal), T(e.minDuration, e.maxDuration), I(e.minDirection, e.maxDirection), y(e.easingFunctions)[0])
                    }
                }(E(E({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = b(e.minValue),
                                r = b(e.maxValue);
                            return new h(new m(T(n.x, r.x)), new m(T(n.y, r.y)));
                        case "linear":
                            t = b(e.value);
                            var i = b(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = b(e.minAddValue),
                                a = b(e.maxAddValue);
                            return new h(new O(T(n.x, r.x), T(o.x, a.x)), new O(T(n.y, r.y), T(o.x, a.x)));
                        case "oscillating":
                            t = b(e.value);
                            var u = b(e.start),
                                l = b(e.final),
                        ...
                        case "oscillating-random":
                            ...
                            var d = b(e.minStart),
                                ...
                                A = b(e.minDirection),
                                C = b(e.maxDirection);
                            return new h(new g(T(n.x, r.x), T(d.x, f.x), T(p.x, E.x), T(_.x, v.x), I(A.x, C.x), y(e.easingFunctions)[0]), new g(T(n.y, r.y), T(d.y, f.y), T(p.y, E.y), T(_.y, v.y), I(A.y, C.y), y(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = A(e.minValue),
                                r = A(e.maxValue);
                            return new v(new m(T(n.x, r.x)), new m(T(n.y, r.y)), new m(T(n.z, r.z)));
                        case "linear":
                            t = A(e.value);
                            var i = A(e.addValue);
                        ...
                        case "linear-random":
                            ...
                            var o = A(e.minAddValue),
                                a = A(e.maxAddValue);
                            return new v(new O(T(n.x, r.x), T(o.x, a.x)), new O(T(n.y, r.y), T(o.y, a.y)), new O(T(n.z, r.z), T(o.z, a.z)));
                        case "oscillating":
                            t = A(e.value);
                            var u = A(e.start),
                                l = A(e.final),
                        ...
                        case "oscillating-random":
                            ...
                            var d = A(e.minStart),
                                ...
                                b = A(e.minDirection),
                                C = A(e.maxDirection);
                            return new v(new g(T(n.x, r.x), T(d.x, f.x), T(p.x, E.x), T(_.x, h.x), I(b.x, C.x), y(e.easingFunctions)[0]), new g(T(n.y, r.y), T(d.y, f.y), T(p.y, E.y), T(_.y, h.y), I(b.y, C.y), y(e.easingFunctions)[0]), new g(T(n.z, r.z), T(d.z, f.z), T(p.z, E.z), T(_.z, h.z), I(b.z, C.z), y(e.easingFunctions)[0]))
                    }
                }(E(E({}, e), {
                    valueType: "Vector3"
                }))
            ...
            var P = r.forwardRef((function(e, t) {
                    ...
                    T = r.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                ...
                                })), null == p || p(t), v.current.size > 0 ? m.current = window.requestAnimationFrame(T) : (t.clearRect(0, 0, e.width, e.height), m.current = null);
                                var n = Date.now();
                ...
                r.useEffect((function() {
                    null != m.current && (window.cancelAnimationFrame(m.current), m.current = window.requestAnimationFrame(T))
                }), [T]);
        ...
        225386: (e, t, n) => {
            ...
            function O(e) {
                ...
                return e.type === _.d4z.GUILD_TEXT && T(t, e)
            }

        ...
        564333: (e, t, n) => {
            ...
            function l() {
                if (a.Z.getApplicationsShelfFetchState() === a.M.NOT_FETCHED) {
                    ...
                    o.ZP.get(c.ANM.APPLICATIONS_SHELF).then((function(e) {
                        return i.Z.dispatch({
            ...
            function u(e) {
                ...
                o.ZP.get({
                    url: c.ANM.CHANNEL_INTEGRATIONS(e),
                    backoff: t,
                    retries: 10
                }).then((function(t) {
                    i.Z.dispatch({
            ...
            function f(e, t) {
                return o.ZP.delete(c.ANM.CHANNEL_INTEGRATION(e, t)).then((function(e) {
                    var t;
        ...
        948832: (e, t, n) => {
            ...
            var y = new Map,
                ...
                C = function(e) {
                    ...
                    r.__getLocalVars = function() {
                        return {
                            integrationsByChannel: y,
                            integrationsByChannelFetchState: g,
                            applicationsShelf: O,
                            applicationsShelfFetchState: b,
                            EMPTY: v,
                            store: _
                        }
                    };
            ...
            var _ = new C(o.Z, {
                ...
                PRIVATE_CHANNEL_INTEGRATION_CREATE: function(e) {
                    ...
                    if (null == n) return !1;
                    y.set(t.channel_id, T(p(n).concat([(0, a.F)(t)])))
                },
        ...
        953572: (e, t, n) => {
            ...
            function u(e) {
                ...
                return (0, r.jsxs)(o.Menu, {
                    "aria-label": l.Z.Messages.MANAGE_INTEGRATION,
                    ...
                    children: [(0, r.jsx)(o.MenuGroup, {
                        children: (0, r.jsx)(o.MenuItem, {
                            ...
                            label: l.Z.Messages.BOT_PROFILE_REMOVE_PRIVATE_CHANNEL_INTEGRATION,
                            action: function() {
                                (0, c.GB)(t.id, n.application.id);
                                null != u && u()
                            },
                            color: "danger"
                        })

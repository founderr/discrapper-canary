(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["63930"], {
        142047: function(e, t, a) {
            ...
            function A(e) {
                let {
                    channel: t,
                    onSelect: a
                } = e, u = (0, g.default)(t), i = (0, S.default)(t), r = (0, L.default)(t), M = (0, c.default)(t), E = (0, f.default)(t), N = (0, o.default)(t), C = (0, _.default)(t), O = (0, d.default)({
                    id: t.id,
            ...
            function U(e) {
                let {
                    ...
                    guild: a,
                    onSelect: u
                } = e, i = (0, g.default)(t), r = (0, S.default)(t), _ = (0, L.default)(t), A = (0, c.default)(t), U = (0, f.default)(t), h = (0, N.default)(t), m = (0, o.default)(t), I = (0, M.default)(t, a), p = (0, E.default)(t), G = (0, d.default)({
                    id: t.id,
                    label: T.default.Messages.COPY_ID_CHANNEL
                }), R = (0, C.default)(t), v = (0, O.default)(t);
                return (0, n.jsxs)(s.Menu, {
                    navId: "channel-context",
                    onClose: l.closeContextMenu,
                    "aria-label": T.default.Messages.CHANNEL_ACTIONS_MENU_LABEL,
        ...
        308798: function(e, t, a) {
            ...
            function _(e) {
                let t = e.isForumPost(),
                    _ = (0, s.useStateFromStores)([o.default], () => e.isOwner(o.default.getId()), [e]),
                    {
                        canManageChannel: E,
                        canAccessChannel: N
                    ...
                    L = t && (E || _ && g < 1),
                    C = t && _ && !E && g > 0 && null != S;
                return N && (E || L || C) ? (0, n.jsx)(l.MenuItem, {
                    id: "delete-channel",
                    label: (() => {
                    ...
                    action: () => (0, l.openModalLazy)(async () => {
                        ...
                        return a => (0, n.jsx)(t, {
                            ...a,
                            onConfirm: () => {
                                a.onClose(), C ? i.default.deleteMessage(e.id, e.id) : u.default.deleteChannel(e.id)
                            },
                            channel: e
                        })
                    })
        ...
        531674: function(e, t, a) {
            ...
            function S(e, t) {
                let [a, s] = (0, u.useStateFromStoresArray)([f.default], () => [f.default.isChannelMuted(e.guild_id, e.id), f.default.getChannelMuteConfig(e.guild_id, e.id)]), l = (0, o.useMutedUntilText)(s), _ = (0, c.default)(e, !0);
                ...
                let L = E.default.Messages.MUTE_CHANNEL_GENERIC,
                    C = E.default.Messages.UNMUTE_CHANNEL_GENERIC;
                switch (e.type) {
                    case M.ChannelTypes.GUILD_CATEGORY:
                        L = E.default.Messages.MUTE_CATEGORY, C = E.default.Messages.UNMUTE_CATEGORY;
                        break;
                    case M.ChannelTypes.GROUP_DM:
                        L = E.default.Messages.MUTE_CONVERSATION, C = E.default.Messages.UNMUTE_CONVERSATION;
                        break;
                    case M.ChannelTypes.DM:
                        L = E.default.Messages.MUTE_CHANNEL.format({
                            name: _
                        ...
                        break;
                    default:
                        L = E.default.Messages.MUTE_CHANNEL_GENERIC, C = E.default.Messages.UNMUTE_CHANNEL_GENERIC
                }
        ...
        619436: function(e, t, a) {
            ...
            function f(e) {
                let t = e.getGuildId(),
                    ...
                    _ = null == f ? d.UserNotificationSettings.NULL : f.message_notifications,
                    E = o(e);
            ...
            function c(e) {
                ...
                let u = f(e),
                    ...
                    _ = null == M ? d.UserNotificationSettings.NULL : M.message_notifications,
                    E = _ === d.UserNotificationSettings.NULL && e.isGuildStageVoice() ? r.default.Messages.FORM_LABEL_ONLY_MENTIONS.format() : null === (a = o(e)) || void 0 === a ? void 0 : null === (t = a.find(e => {
                        let {
                            setting: t
                        } = e;
                        return t === c

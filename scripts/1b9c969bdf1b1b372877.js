    ...
    ["40627"], {
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                O = !0, null == E || E(), !I && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: p,
                            analyticsLocations: _,
                            analyticsObject: v,
                    ...
                    onCloseCallback: () => {
                        !O && u.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: R,
                            location_stack: _
                        }), (0, s.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == C || C(O), O && (!I && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == p || p())
                    },
        ...
        889793: function(e, t, n) {
            ...
            function x(e) {
                let {
                    ...
                    l(), (0, o.pushLayer)(A.Layers.COLLECTIBLES_SHOP)
                };
                return (0, i.jsx)(a.ModalFooter, {
                    ...
                    children: (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(a.Button, {
                            ...
                            let l = c || !(0, E.isPremiumCollectiblesCategory)(u);
            ...
            function O(e) {
                ...
                }, [n, l]), [g, I] = r.useState(() => null != u ? u : void 0 !== d ? d : null == c ? null : null != c ? c : null), [S, A] = r.useMemo(() => {
                    var e;
                ...
                }), b = g === (void 0 === d ? null != c ? c : null : d), U = r.useCallback(e => {
                    I(e)
                }, [I]);
            ...
            function y(e) {
                ...
                let {
                    ...
                    categories: E,
                    purchases: _
                } = (0, p.default)(), v = (0, s.useStateFromStores)([I.default], () => I.default.getCurrentUser()), {
                    AnalyticsLocationProvider: m,
                    analyticsLocations: T
                } = (0, c.default)(o, u.default.EDIT_PROFILE_EFFECT_MODAL), L = (0, g.default)(null !== (t = null == v ? void 0 : v.id) && void 0 !== t ? t : ""), N = null == L ? void 0 : L.profileEffectID;
                return r.useEffect(() => {
        ...
        717262: function(e, t, n) {
            ...
            let S = e => {
                    ...
                    }), _ = g.default.canUseCollectibles(f), S = (0, u.isPremiumCollectiblesPurchase)(d), L = (0, u.isPremiumCollectiblesCategory)(c), N = T(!_ && S, L, _, p);
            ...
            var L = e => {
                ...
                }), P = g.default.isPremium(n), M = (0, h.default)(n.id), x = !!(null == M ? void 0 : M.getPreviewBio(m).value), O = E.UseLegacyChatInput.useSetting(), y = O && null != m ? c.default.parse(void 0, m).content : m, F = g.default.canUsePremiumProfileCustomization(n), w = (null == M ? void 0 : M.canUsePremiumProfileCustomization) || F, b = {
                    user: n,
                ...
                return (0, i.jsxs)("div", {
                    className: w ? I.previewContainerWithTheme : I.previewContainerWithoutTheme,
            ...
            let R = () => 80,
                ...
                M = e => {
                    ...
                    let {
                        ...
                        isSelected: c,
                        ...d
                    } = e, E = (0, u.default)([I.default], () => I.default.getProfileEffectById(l.id)), _ = (0, u.default)([f.default], () => {
                        ...
                        title: O
                    } = null !== (t = null == E ? void 0 : E.config) && void 0 !== t ? t : {}, y = m.default.canUseCollectibles(n), F = a === S.Section.PREMIUM_PURCHASE && !y, [w, b] = r.useState(c);
                    return r.useEffect(() => {
                        c && b(!0)
                    }, [c]), (0, i.jsxs)(P, {
        ...
        181114: function(e, t, n) {
            ...
            let _ = e => {
                let {
                    ...
                    onlyShineOnHover: E,
                    ..._
                } = e, v = s.createRef(), g = (0, d.default)(v), m = !i && !r && !0 !== a && (!E || g);
        ...
        461380: function(e, t, n) {
            ...
            let h = {
                ...
                C = e => {
                    ...
                    if (!0 === v ? I = h.DOWN : !1 === v && (I = h.RIGHT), m) {
                        let e = {

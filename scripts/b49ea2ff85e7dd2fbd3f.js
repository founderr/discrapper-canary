        ...
        344533: (e, t, n) => {
            ...
            const $e = u.ZP.connectStores([v.ZP, h.Z, ke.Z, Ae.Z], (function(e) {
                var t = e.context,
                    n = e.index,
                    r = v.ZP.getAllStats(t)[n],
                    o = t === Ue.Yn.STREAM ? Ae.Z.getHostname(Ae.Z.getActiveStreamKey()) : h.Z.getHostname();
                return {
                    ...
                    hostname: Me.Z.getShortHostname(o)
                }
            }))(Ye);
            var qe = n(2590);
            ...
            function rt() {
                var e, t, n = (0, u.e7)([v.ZP], (function() {
                        return {
                            defaultStats: v.ZP.getAllStats(Ue.Yn.DEFAULT),
                            streamStats: v.ZP.getAllStats(Ue.Yn.STREAM)
                        }
                    }), [], u.pF),
                    a = n.defaultStats,
                    i = n.streamStats,
                    ...
                    P = function(e) {
                        var t = e.defaultStats,
                            ...
                            u = t.flatMap((function(e, t) {
                                return nt(Ue.Yn.DEFAULT, e, t, o, null == c ? void 0 : c.getGuildId())
                            })),
                            l = n.flatMap((function(e, t) {
                                return nt(Ue.Yn.STREAM, e, t, o, null == c ? void 0 : c.getGuildId())
                            })),
                            f = [],
                            p = [],
                            m = {

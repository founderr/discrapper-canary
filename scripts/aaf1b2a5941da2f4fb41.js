        ...
        278175: function(e, t, n) {
            ...
            var S = s.memo(function(e) {
                let {
                    ...
                    audio: N
                } = (0, d.useAudioTrimmerStore)(), h = null != N, m = s.useRef(null), T = s.useRef(null), O = s.useRef(null), [p, g] = s.useState(0), [A, C] = s.useState(0), [v, R] = s.useState(0), [L, U] = s.useState(!1), [D, P] = s.useState(!1), [M, w] = s.useState(!1), [y, b] = s.useState(0), [F, x] = s.useState(-1), G = s.useMemo(() => y / I.fineTuningScale, [I.fineTuningScale, y]);
                s.useEffect(() => {
                    if (null == N) return;
                ...
                return s.useEffect(() => {
                    ...
                    children: [(0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsxs)("div", {
                            ...
                            style: {
                                left: "".concat((0, c.getStartHandleValue)(p, F, G, y), "%"),
        ...
        364685: function(e, t, n) {
            ...
            var F = new b(u.default, {
                ...
                CONNECTION_OPEN: e => {
                    ...
                    p = null, O = new Map, v = new Map, t.forEach(y), m = t.every(e => null != e.stickers) ? 1 : 0
                },

    ...
    ["70249"], {
                        ...
                        if (!this._avg || t) {
                            ...
                            for (i = this.r1; i <= this.r2; i++)
                                for (o = this.g1; o <= this.g2; o++)
                                    for (u = this.b1; u <= this.b2; u++) a += r = n[e(i, o, u)] || 0, l += r * (i + .5) * s, c += r * (o + .5) * s, f += r * (u + .5) * s;
                            ...
                            for (var i, o = 1, u = 0; u < 1e3;) {
                                ...
                                var a = function(t, n) {
                                        ...
                                        function p(t) {
                                            ...
                                            for (s = n[a]; s <= n[l]; s++)
                                                if (v[s] > h / 2) {
                                                    for (i = n.copy(), o = n.copy(), e = s - n[a], u = e <= (r = n[l] - s) ? Math.min(n[l] - 1, ~~(s + r / 2)) : Math.max(n[a], ~~(s - 1 - e / 2)); !v[u];) u++;
        ...
        506838: function(t, e, n) {
            ...
            let r = Symbol.for("@ts-pattern/matcher"),
                ...
                l = t => {
                    var e, n, i;
                    return u(t) ? a(t) ? null != (e = null == (n = (i = t[r]()).getSelectionKeys) ? void 0 : n.call(i)) ? e : [] : Array.isArray(t) ? c(t, l) : c(Object.values(t), l) : []
                },
                ...
                return f({
                    [r]: () => ({
                        match: t => {
                            ...
                            return c(e, l).forEach(t => r(t, void 0)), {
            ...
            function I() {
                ...
                return f({
                    [r]: () => ({
                        ...
                        getSelectionKeys: () => [null != i ? i : o].concat(void 0 === u ? [] : l(u))
                    })
                })
            }
            ...
            var Y = {
                ...
                instanceOf: function(t) {
                    var e;
                    return f(E((e = t, t => t instanceof e)))
                },
                shape: function(t) {
                    return f(E(function() {
                        for (var t = arguments.length, e = Array(t), n = 0; n < t; n++) e[n] = arguments[n];
        ...
        689226: function(t, e, n) {
            ...
            let s = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
                ...
                d = (t, e) => t.replace(/size=[0-9]+/g, "size=".concat((0, i.getBestMediaProxySize)(e * (0, i.getDevicePixelRatio)()))),
                h = (t, e) => {
                    let {
                        id: n,
                        icon: r
                    ...
                    let u = o.SUPPORTS_WEBP ? "webp" : "png",
                        f = "",
                        d = "quality=lossless";
                    return (null != e && (f = "size=" + (0, i.getBestMediaProxySize)(e * (0, i.getDevicePixelRatio)()), d = c ? "" : "&" + d), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(s, "/").concat(n, "/").concat(r, ".").concat(u, "?").concat(f).concat(d) : "".concat(l).concat(a.Endpoints.ROLE_ICON(n, r), "?").concat(f)
                },
                v = t => t.startsWith(s) || t.startsWith("".concat(l, "/roles")) && t.includes("/icons/"),
                g = (t, e) => {
                    var n;
            ...
            let d = async (t, e) => {
                ...
                try {
                    let e = await r.default.get({
                        url: f.Endpoints.GUILD_MEMBER_VERIFICATION(t),
                        query: {
                            with_guild: u,
                ...
                try {
                    let n = await r.default.put({
                            url: f.Endpoints.GUILD_MEMBER_REQUEST_TO_JOIN(t),
                            body: {
                                version: e.version,
        ...
        103603: function(t, e, n) {
            ...
            let p = t => E(t),
                E = u.memoize(t => new Promise((e, n) => {
                    let r = new Image;
                    r.crossOrigin = "Anonymous", r.onerror = t => {
                        n(t), r.onerror = r.onload = null, r = null
                    }, r.onload = () => {
                        e(g(r, 5, 10)), r.onerror = r.onload = null, r = null
                    }, r.src = t
                }));

            ...
            function ze(e) {
                ...
                if (null != c) {
                    ...
                    if (null != b && b.state === B.r2o.RESOLVED && null != b.inviter) {
                        ...
                        f.ZP.trackWithMetadata(B.rMx.INVITE_SENT, m)
                    }
                }
            }
            var qe = (Ge(He = {}, B.evJ.EMAIL_VERIFICATION_REQUIRED, {
                        ...
                        messageGetter: function() {
                            return Ne.Z.Messages.BOT_DM_SEND_FAILED_WITH_HELP_LINK.format({
                                helpUrl: Le.Z.getArticleURL(B.BhN.DM_COULD_NOT_BE_DELIVERED)
                            })
                        }
                ...
                Xe = (o().memoize((function(e) {
                    ...
                    sendClydeError: function(e) {
                        ...
                        if (null != n) {
                            ...
                            if (t === B.evJ.EXPLICIT_CONTENT)
                                ...
                                var a = ge.Z.getGuild(n.getGuildId());
                                if (null == a) return;
                                ...
                                r = i ? Ne.Z.Messages.BOT_DM_TOO_MANY_POSTS : Ne.Z.Messages.BOT_DM_TOO_MANY_THREADS;
                                o = "TOO_MANY_THREADS"
                    ...
                    jumpToMessage: function(e) {
                        var t = e.channelId,
                            ...
                            f = e.skipLocalFetch,
                            d = e.jumpType;
                        "string" == typeof i && Xe.trackJump(t, n, i, l);
                                    ...
                                    ye.Z.dispatchMessages.measure((function() {
                                        ...
                                        if (null != m) {
                                            var _ = Math.floor(d / 2),
                                                O = [m].concat(Ve(i.map((function(e) {
                                                    return e.id
                                                })))).filter((function(e, t, n) {
                                                    return n.indexOf(e) === t
                                                })).sort(we.Z.compare).indexOf(m);
                                            O < _ && (g = !1);
                                            i.length - O < _ && (v = !1);
                                            if (v && i.length > 0) {
                                        ...
                                        Ke.log("Fetched ".concat(i.length, " messages for ").concat(t, " isBefore:").concat(u, " isAfter:").concat(s));
                                        b.markComplete();
                                        if ((0,
                                                ae.m7)(null !== (a = null == h ? void 0 : h.guild_id) && void 0 !== a ? a : "") && (null == o ? void 0 : o.isHighlight)) {
                            ...
                            return Ye(this, (function(f) {
                                switch (f.label) {
                                    ...
                                    case 1:
                                        ...
                                        Ke.log("Fetched ".concat(i.messages.length, " messages from the cache after foregrounding. ").concat(c.length, " are new"));
                    ...
                    _tryFetchMessagesCached: function(e) {
                        ...
                        if (null != (null == a ? void 0 : a.messageId) || null != (null == i ? void 0 : i.messageId)) {
                            ...
                            var c = null != (null == a ? void 0 : a.messageId) ? we.Z.extractTimestamp(null == a ? void 0 : a.messageId) : 0,
                                f = s.first(),
                                d = s.last();
                    ...
                    _sendMessage: function(e, t, n) {
                        ...
                        var w, P = null != m ? B.uaV.REPLY : B.uaV.DEFAULT,
                        ...
                        if (!We && null != u && u.length > 0) {
                            ...
                            } else if (_e.Z.canWithPartialContext(B.Plq.USE_EXTERNAL_EMOJIS, {
                                    channelId: e
                                })) {
                        ...
                        null != _ && (x.message.sticker_ids = _);
                                ...
                                if (c.ok) {
                                    ...
                                    ! function(e, t, n, r, o) {
                                        (0, De.Q_)(e).forEach((function(e) {
                                            ...
                                            null != a && f.ZP.trackWithMetadata(B.rMx.GIFT_CODE_SENT, {
                                                location: r,
                                                gift_code: e,
                            ...
                            return Ye(this, (function(a) {
                                switch (a.label) {
                                    ...
                                    case 2:
                                        ...
                                        a.label = 3;
                                    case 3:
                                        (null == (o = _.Z.getMessage(e, t)) ? void 0 : o.type) === B.uaV.GUILD_INVITE_REMINDER && (0, oe.O)();
                                        return [2]
                                }
                            }))
                        }))()

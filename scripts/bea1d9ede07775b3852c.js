        ...
        752598: function(e, t, n) {
            ...
            let S = (e, t) => {
                ...
                let u = e.state === _.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : r.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    c = e.isCommandType();
                if (s && i === h.InteractionState.QUEUED || c && e.state === _.MessageStates.SENDING && null != t) return l.SENDING;
                ...
                else if (c && e.state === _.MessageStates.SEND_FAILED) return l.FAILED
            };
        ...
        650484: function(e, t, n) {
            ...
            function h(e) {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (c = null == v ? void 0 : null === (u = v.options) || void 0 === u ? void 0 : u.renderHeader) || void 0 === c || c ? h : null, v.renderStep(_), null == C || m ? null : (0, i.jsxs)(i.Fragment, {
                ...
                (0, r.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !O && o.default.track(d.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: A,
                            location_stack: C
                        }), (0, a.clearError)(), (0, u.clearPurchaseTokenAuthState)(), null == h || h(O), O && (!S && c.ComponentDispatch.dispatch(d.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == _ || _())
                    },
            ...
            var l = n("77078"),
                ...
                F = (0, u.default)((0, a.default)(function(e) {
                    let {
                        ...
                        user: t,
                        context: H
                    }), W = (0, v.default)(t), K = (0, P.default)(t.id), z = (0, R.default)(n.id, a), Q = (0, y.default)(t), q = (0, o.default)(null, t), X = (0, x.default)(t.id), J = (0, O.default)(t.id, n.id), $ = (0, g.default)(t), ee = (0, D.default)(t.id), et = (0, U.default)(t.id, n.id), en = (0, M.default)(t), ei = (0, I.default)(n), el = (0, _.default)({
                        id: t.id,
                        label: w.default.Messages.COPY_ID_USER
                    }), er = (0, _.default)({
                        id: n.id,
                        label: w.default.Messages.COPY_ID_CHANNEL
                    }), ea = (0, h.default)(n), eu = (0, f.default)(t.id), es = (0, d.default)(n.id), eo = (0, S.default)(t), ec = (0, E.default)(t.id), ed = (0, L.default)({
        ...
        563816: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                T = e => {
                    ...
                    }, [A, M, R]), O = l.useMemo(() => (0, d.canUseContextMenuCommands)(r, U.length, o.getCommandTypeCount(r, t, null == v ? void 0 : v.applicationCommandCounts)), [r, t, U.length, null == v ? void 0 : v.applicationCommandCounts]);
                    l.useEffect(() => {
                        if (O !== S.current) {
                            if (O) null == N || N();
                            S.current = O
        ...
        181114: function(e, t, n) {
            ...
            let C = e => {
                let {
                    ...
                    onlyShineOnHover: C,
                    ...p
                } = e, T = a.createRef(), N = (0, d.default)(T), S = !i && !u && !0 !== o && (!C || N);

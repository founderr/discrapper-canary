    ...
    ["74108"], {
                ...
                return {
                    ...
                    [u.HUB_SCHOOL_CLUB]: {
                        ...
                        roles: [{
                            ...
                            mentionable: !0,
                            hoist: !0,
                            permissions: E.default.combine(d.default.DEFAULT, c.Permissions.MANAGE_ROLES, c.Permissions.MANAGE_CHANNELS, c.Permissions.KICK_MEMBERS, c.Permissions.BAN_MEMBERS, c.Permissions.MANAGE_NICKNAMES, c.Permissions.MANAGE_GUILD_EXPRESSIONS, c.Permissions.MANAGE_MESSAGES, c.Permissions.SEND_TTS_MESSAGES),
                            color: 3066993
                        }],
        ...
        833843: function(e, t, n) {
            ...
            var v = e => {
                ...
                l.useEffect(() => {
                    null == O ? p() : d.default.track(h.AnalyticEvents.OPEN_MODAL, {
        ...
        965353: function(e, t, n) {
            ...
            function d(e) {
                ...
                let C = _.default.Messages.GUILD_EVENT_DETAILS_USER_LIST_TAB_TITLE.format({
                        userCount: d
                    }),
                    A = [(0, i.jsx)(r.TabBar.Item, {
                        className: E.tabBarItem,
                        id: u.EventDetailSections.EVENT_INFO,
                        children: _.default.Messages.GUILD_EVENT_DETAILS_INFO_TAB_TITLE
                    }, "event-details")];
                return !T && A.push((0, i.jsx)(r.TabBar.Item, {
                    className: E.tabBarItem,
                    ...
                    children: [(0, i.jsx)(r.Clickable, {
                        ...
                        children: (0, i.jsx)(o.default, {
                            className: s(E.closeIcon, c && E.closeIconBanner)
                        })
                    }), (0, i.jsx)(r.TabBar, {
                        className: E.tabBar,
                        "aria-label": _.default.Messages.OPTIONS,
                        selectedItem: n,
                        type: "top",
                        onItemSelect: a,
                        children: A
        ...
        360538: function(e, t, n) {
            ...
            function U(e) {
                ...
                let {
                    creator: n,
                    guildId: l
                } = e, a = (0, r.useStateFromStores)([E.default], () => E.default.getMember(l, n.id), [n, l]);
                return (0, i.jsxs)("div", {
                    className: m.row,
                            ...
                            usernameHook: function() {
                                ...
                                return (0, i.jsx)(o.Clickable, {
                                    onClick: () => (0, _.openUserProfileModal)({
                                        ...
                                        guildId: l,
                                        analyticsLocation: {
                                            section: S.AnalyticsSections.SCHEDULED_GUILD_EVENT_INFORMATION_DIALOG
                                        }
                                    }),
                                    className: m.creator,
                                    tag: "span",
                ...
                return l.useEffect(() => {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsx)(L.GuildEventTimeStatus, {
                            startTime: null !== (t = null == v ? void 0 : v.toISOString()) && void 0 !== t ? t : a.scheduled_start_time,
        ...
        586403: function(e, t, n) {
            ...
            function E(e) {
                let {
                    ...
                    channel: n,
                    onClose: E
                } = e, d = t.entity_type === u.GuildScheduledEventEntityTypes.EXTERNAL, c = l.useCallback(e => (0, r.createEventLocationClickHandler)(t, E)(e), [t, E]), T = (0, o.getLocationDataForEvent)(t, n);
                if (null == T) return null;
                let {
                    IconComponent: I,
                    locationName: C
                } = T, A = (0, i.jsxs)(i.Fragment, {
                ...
                return (0, i.jsx)("div", {
                    ...
                    children: null != c ? (0, i.jsx)(a.Clickable, {
                        className: d ? _.externalLocation : _.channelLocation,
                        onClick: c,
                        children: A
                    }) : A
                })
        ...
        403901: function(e, t, n) {
            ...
            function R(e) {
                ...
                let {
                    ...
                    user: o
                } = n, _ = null === (t = n.guild_member) || void 0 === t ? void 0 : t.guildId, C = (0, s.useStateFromStores)([I.default, T.default, c.default], () => o.id === c.default.getId() ? I.default.getStatus() : T.default.getStatus(o.id, _), [o.id, _]);
                return (0, i.jsx)(r.Popout, {
                    preload: () => (0, E.default)(o.id, o.getAvatarURL(_, 80), {
                        guildId: _
                    }),
            ...
            function h(e) {
                ...
                let E = null !== (t = null == l ? void 0 : l.user_count) && void 0 !== t ? t : 0,
                    d = 0;
                return a.length >= A.MAX_RSVP_USER_DISPLAY_COUNT && E > A.MAX_RSVP_USER_DISPLAY_COUNT && (d = Math.max(E - a.length, 0)), 0 === a.length ? (0, i.jsx)(M, {
                    height: _,
                    children: (0, i.jsx)(L, {})
                }) : (0, i.jsx)(U, {
                    children: (0, i.jsx)(m, {
            ...
            let o = (0, l.createExperiment)({
                ...
                E = function() {
                    ...
                    let {
                        ...
                        user: l,
                        config: s
                    }), c = r && E && null != t && (null == t ? void 0 : null === (e = t.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible) !== !1;
                    return {
                        viewAndUseEnabled: r,
                        collectEnabled: c,
                        showTryPacksModalAndV2Copy: _,
                ...
                d = (0, l.createExperiment)({
                    ...
                    treatments: [{
                        ...
                        config: {
                            ...
                            allowCollection: !1,
                            getNewSettingsDescription: () => r.default.Messages.INVENTORY_NEW_SETTING_DESCRIPTION_SOON_V2
                        }
                    }, {
                        id: 2,
        ...
        650484: function(e, t, n) {
            ...
            function T(e) {
                ...
                let R = null !== (u = null == S ? void 0 : null === (t = S.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== u && u,
                    m = null == S ? void 0 : null === (n = S.options) || void 0 === n ? void 0 : n.bodyClassName,
                    U = void 0 !== I && I ? c.sliderBodyLarge : null == S ? void 0 : null === (a = S.options) || void 0 === a ? void 0 : a.sliderBodyClassName;
                return (0, i.jsxs)(i.Fragment, {
                    children: [null === (_ = null == S ? void 0 : null === (r = S.options) || void 0 === r ? void 0 : r.renderHeader) || void 0 === _ || _ ? T : null, S.renderStep(C), null == A || R ? null : (0, i.jsxs)(i.Fragment, {
                        children: [(0, i.jsx)(E.ModalContent, {
                            className: s(c.body, m),
            ...
            function I(e) {
                ...
                return null == n ? null : _.createPortal(t, n)
            }
                ...
                (0, a.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: c,
                            onClose: e => {
                                l(), null == T || T(e), e && (null == C || C())
                            },
                            onComplete: () => {
                                v = !0, null == I || I(), !L && ((0, o.setIsPersistentHelperHidden)(!0), (0, o.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: C,
                            analyticsLocations: A,
                            analyticsObject: N,
                    ...
                    onCloseCallback: () => {
                        !v && u.default.track(E.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: M,
                            location_stack: A
                        }), (0, s.clearError)(), (0, r.clearPurchaseTokenAuthState)(), null == T || T(v), v && (!L && _.ComponentDispatch.dispatch(E.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == C || C())
                    },
        ...
        865372: function(e, t, n) {
            ...
            class A extends a.default.PersistedStore {
                initialize(e) {
                    this.waitFor(u.default), null != e && (d = e), this.syncWith([u.default], I), this.syncWith([o.default], C)
                }
                getState() {
                    return d
                }
        ...
        783142: function(e, t, n) {
            ...
            function d(e) {
                u.default.track(_.AnalyticEvents.PREMIUM_FEATURE_TRY_OUT, {
                    feature_name: e,
        ...
        931138: function(e, t, n) {
            ...
            function _(e) {
                let {
                    ...
                    ...E
                } = e, d = l.Children.only(t), c = (0, r.useRedesignIconContext)().enabled;
                return (0, i.jsxs)("div", {
        ...
        181114: function(e, t, n) {
            ...
            let T = {
                    [l.DEFAULT]: c.shineDefault,
                    [l.SMALL]: c.shineSmall
                },
                I = {
                    [l.DEFAULT]: c.shineInnerDefault,
                    [l.SMALL]: c.shineInnerSmall
                };
            ...
            let A = e => {
                ...
                return (0, a.jsxs)(_.Button, {
                    ...
                    disabled: i,
                    submitting: r,
                    children: [t, L ? (0, a.jsx)(C, {
                        shinePaused: T,
                        className: o(c.buttonShine, A ? c.onlyShineOnHover : void 0, I),
                        shineSize: d
                    }) : null]
                })
            };

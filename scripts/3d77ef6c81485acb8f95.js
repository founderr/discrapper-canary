(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["17832"], {
                ...
                class t extends r.Component {
                    componentDidUpdate(e, t) {
                        ...
                        let {
                            ...
                            style: r
                        } = this.props, a = null != r ? o(r.backgroundImage) : null;
                    ...
                    render() {
                        ...
                        if (!a && null != t) {
                            ...
                            t = {
                                ...t,
                                backgroundImage: null == (s = i) || "" === s || "none" === s ? "none" : "url(".concat(s, ")")
                            }
                        }
                        return (0, l.jsx)(e, {
                            style: t,
        ...
        956967: function(e, t, n) {
            ...
            function N(e) {
                return (0, r.default)([u.default, o.default], () => {
                    if (null == e) return !1;
                    let t = u.default.getId();
                    return (0, f.hasAutomodQuarantinedProfile)(o.default.getMember(e, t))
                }, [e])
            }

            function L(e) {
                return (0, r.useStateFromStoresObject)([u.default, o.default, I.default, d.default], () => {
                    let t = {
                            nick: void 0,
                            bio: void 0
                        },
                    ...
                    let a = u.default.getId(),
                        ...
                        s = (0, f.getAutomodQuarantinedProfileFlags)(null == i ? void 0 : i.flags);
                    if (0 === s.size) return t;
                    if (s.has(E.GuildMemberFlags.AUTOMOD_QUARANTINED_USERNAME_OR_GUILD_NICKNAME)) {
                        if (null == e) {
                            var c;
                            t.nick = [T.default.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_USERNAME_IN_GUILD.format({
                                guildName: null !== (c = r.name) && void 0 !== c ? c : ""
                            })]
                        } else t.nick = [T.default.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_USERNAME]
                    }
                    return s.has(E.GuildMemberFlags.AUTOMOD_QUARANTINED_BIO) && (t.bio = [T.default.Messages.GUILD_AUTOMOD_PROFILE_ERROR_QUARANTINE_BIO]), t
                }, [e])
            }
            ...
            function p(e) {
                ...
                } = (0, i.default)(), E = (0, r.default)([d.default], () => d.default.getGuild(t), [t]), T = (0, r.default)([c.default], () => null != E && c.default.can(_.Permissions.CHANGE_NICKNAME, E), [E]), N = l.useCallback(() => {
                    if (null == E) return;
                    let e = _.UserSettingsSections.PROFILE_CUSTOMIZATION,
                        t = h.ProfileCustomizationSubsection.GUILD;
                    T ? (0, s.initGuildIdentitySettings)(E, null != o ? o : f) : t = h.ProfileCustomizationSubsection.USER_PROFILE, a.default.open(e, t, {
                        scrollPosition: n,
                        analyticsLocation: u,
                        analyticsLocations: o,
                        openWithoutBackstack: I
        ...
        931138: function(e, t, n) {
            ...
            function d(e) {
                let {
                    ...
                    ...c
                } = e, I = r.Children.only(t), f = (0, s.useRedesignIconContext)().enabled;
                return (0, l.jsxs)("div", {
        ...
        476263: function(e, t, n) {
            ...
            class p extends r.PureComponent {
                ...
                renderIcon() {
                    ...
                    let {
                        ...
                        "aria-hidden": A,
                        ...D
                    } = this.props, M = L[u], R = null != E ? d.Clickable : "div";
                    return (0, l.jsxs)(R, {
                        className: i(h.icon, r, (0, _.getClass)(h, "iconSize", u), {
                            [null !== (e = (0, _.getClass)(h, "iconActive", u)) && void 0 !== e ? e : ""]: s,
                            [h.iconInactive]: !s,
                            [h.noIcon]: null == n.icon
                        }),
                        "aria-hidden": A,
                        style: null == n.icon ? {
                            fontSize: (null !== (t = M[n.acronym.length]) && void 0 !== t ? t : M[M.length - 1]) * c,
                            ...o
                        } : o,
            ...
            let S = u.default.connectStores([I.default], e => {
                ...
                return {
                    style: {
                        ...r,
                        backgroundImage: (0, f.makeCssUrlString)(null != l ? l : t.getIconURL(N[a], n && I.default.isFocused()))
                    }
                }
            })((0, c.backgroundImagePreloader)(e => (0, l.jsx)(p, {
                ...e
            })));

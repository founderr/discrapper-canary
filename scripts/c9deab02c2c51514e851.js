    ...
    ["27039"], {
        ...
        278999: function(e, t, a) {
            ...
            function A(e) {
                let {
                    guildId: t
                } = e, a = (0, r.useStateFromStores)([c.default], () => c.default.getGuild(t)), [A, M] = o.useState(null), [b, g] = o.useState(""), {
                    createMultipleConfettiAt: x
                } = o.useContext(d.ConfettiCannonContext), R = (0, r.useStateFromStores)([i.default], () => i.default.useReducedMotion, []), p = async t => {
                    let {
                        onClose: a,
                        guildId: n
                    } = e;
                    ...
                    transitionState: C
                } = e, H = Object.values(c.default.getGuilds()), L = H.filter(e => e.id !== t && e.hasFeature(E.GuildFeatures.HUB)).length > 0, N = !R && !L && (null == a ? void 0 : a.hasFeature(E.GuildFeatures.HUB)) && (0, m.backToSchoolEnabled)();
                return o.useEffect(() => {
                    if (N) {

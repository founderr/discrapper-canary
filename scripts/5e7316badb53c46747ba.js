    ...
    ["83032"], {
        ...
        64567: function(e, a, s) {
            ...
            var t, l, n = s("37983"),
                ...
                D = s("22686"),
                f = s("940374");
            (l = t || (t = {})).TAB_ID_FILE_UPLOAD = "tab-id-role-icon-file-upload", l.TAB_ID_EMOJI = "tab-id-role-icon-emoji";
            ...
            var h = function(e) {
                let {
                    ...
                    onClose: o,
                    transitionState: A
                } = e, B = (0, L.useUID)(), h = E.default.getDefaultChannel(a), [j, x] = i.useState(t.TAB_ID_FILE_UPLOAD), [M, T] = i.useState(!1), g = (0, c.useLazyValue)(N);
                return i.useEffect(() => {
                    T(!1)
                    ...
                    children: (0, n.jsxs)("div", {
                        ...
                        children: [(0, n.jsx)("nav", {
                            className: r(D.nav, {
                                [D.navUploadSelected]: j === t.TAB_ID_FILE_UPLOAD
                            }),
                            children: (0, n.jsxs)("div", {
                                className: D.navList,
                                role: "tablist",
                                ...
                                children: [(0, n.jsx)("div", {
                                    className: D.navItem,
                                    role: "tab",
                                    "aria-controls": t.TAB_ID_FILE_UPLOAD,
                                    "aria-selected": j === t.TAB_ID_FILE_UPLOAD,
                                    children: (0, n.jsx)(d.Button, {
                                        onClick: () => {
                                            x(t.TAB_ID_FILE_UPLOAD)
                                        },
                                        "aria-current": "page",
                                        className: r(D.navButton, {
                                            [D.navButtonActive]: j === t.TAB_ID_FILE_UPLOAD
                                        }),
                                    ...
                                    className: D.navItem,
                                    role: "tab",
                                    "aria-controls": t.TAB_ID_EMOJI,
                                    "aria-selected": j === t.TAB_ID_EMOJI,
                                    children: (0, n.jsx)(d.Button, {
                                        onClick: () => {
                                            x(t.TAB_ID_EMOJI)
                                        },
                                        "aria-current": "page",
                                        className: r(D.navButton, {
                                            [D.navButtonActive]: j === t.TAB_ID_EMOJI
                                        }),
                                        look: d.Button.Looks.BLANK,
                                        size: d.Button.Sizes.NONE,
                        ...
                        }), j === t.TAB_ID_FILE_UPLOAD ? (0, n.jsx)(d.ModalContent, {
                            children: (0, n.jsxs)("div", {
                        ...
                        }) : null, j === t.TAB_ID_EMOJI ? (0, n.jsx)(u.default, {
                            hasTabWrapper: !0,
                            closePopout: () => o(),
                            onSelectEmoji: async e => {
                                ...
                                if ((null == e ? void 0 : e.id) != null) {
                                    ...
                                    let s = null !== (t = null === (a = e.defaultDiversityChild) || void 0 === a ? void 0 : a.surrogates) && void 0 !== t ? t : e.surrogates;
                                    l(s)
                                }
                                o()
                            },

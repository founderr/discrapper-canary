        ...
        14636: (t, e, r) => {
            ...
            t.exports = function(t, e) {
                var r = i(t),
                    ...
                    f = !r && !c && !h && u(t),
                    p = r || c || h || f,
                    v = p ? a(t.length, String) : [],
                    b = v.length;
                for (var A in t) !e && !s.call(t, A) || p && ("length" == A || h && ("offset" == A || "parent" == A) || f && ("buffer" == A || "byteLength" == A || "byteOffset" == A) || o(A, b)) || v.push(A);
                return v
            }
        },
        70151: (t, e, r) => {
            ...
            function i(t) {
                let e = function(t) {
                    let {
                        ...
                        cos: i,
                        round: l
                    } = Math, o = t[0] | t[1] << 8 | t[2] << 16, u = t[3] | t[4] << 8, s = (63 & o) / 63, c = (o >> 6 & 63) / 31.5 - 1, h = (o >> 12 & 63) / 31.5 - 1, f = (o >> 18 & 31) / 31, p = o >> 23, v = (u >> 3 & 63) / 63, b = (u >> 9 & 63) / 63, A = u >> 15, y = n(3, A ? p ? 5 : 7 : 7 & u), M = n(3, A ? 7 & u : p ? 5 : 7), S = p ? (15 & t[5]) / 15 : 1, T = (t[5] >> 4) / 15, C = p ? 6 : 5, E = 0, g = (e, r, a) => {
                        let n = [];
                        for (let i = 0; i < r; i++)
                            for (let l = i ? 0 : 1; l * r < e * (r - i); l++) n.push(((t[C + (E >> 1)] >> ((1 & E++) << 2) & 15) / 7.5 - 1) * a);
                        return n
                    }, I = g(y, M, f), N = g(3, 3, 1.25 * v), _ = g(3, 3, 1.25 * b), d = p && g(5, 5, T), G = a(t), L = l(G > 1 ? 32 : 32 * G), B = l(G > 1 ? 32 / G : 32), R = new Uint8Array(L * B * 4), O = [], P = [];
                    for (let t = 0, a = 0; t < B; t++)
                        for (let l = 0; l < L; l++, a += 4) {
                            let o = s,
                                u = c,
                                f = h,
                                v = S;
                            for (let t = 0, r = n(y, p ? 5 : 3); t < r; t++) O[t] = i(e / L * (l + .5) * t);
                            for (let r = 0, a = n(M, p ? 5 : 3); r < a; r++) P[r] = i(e / B * (t + .5) * r);
                            for (let t = 0, e = 0; t < M; t++)
                                for (let r = t ? 0 : 1, a = 2 * P[t]; r * M < y * (M - t); r++, e++) o += I[e] * O[r] * a;
                            ...
                            if (p)
                                for (let t = 0, e = 0; t < 5; t++)
                                    for (let r = t ? 0 : 1, a = 2 * P[t]; r < 5 - t; r++, e++) v += d[e] * O[r] * a;
                            let b = o - 2 / 3 * u,
                                A = (3 * o - b + f) / 2,
                                T = A - f;
                            R[a] = n(0, 255 * r(1, A));

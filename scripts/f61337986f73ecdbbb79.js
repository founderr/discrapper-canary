    ...
    [95305, 81580, 96043, 71402, 1459], {
                        ...
                        return v(this, (function(R) {
                            switch (R.label) {
                                ...
                                case 2:
                                    ...
                                    R.label = 3;
                                case 3:
                                    T = u.Z.getRemoteSessionId();
                                    m = d.Z.getVoiceStateForSession(s.default.getId(), T);
                                    ...
                                    !__OVERLAY__ && (E || N || O || g) && function(e) {
                                        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                            n = e.getGuildId();
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != P[e] && null != P[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var a in P[e][t]) t === D ? d.ZP.isNewForumThread(a, t, r) && M[e][t]++ : o.default.compare(a, i) > 0 && !d.ZP.hasOpenedThread(a) && M[e][t]++
                        }
                    }
                }
            }
        ...
        877475: (e, t, n) => {
            ...
            const C = new P(i.Z, {
                ...
                VOICE_CHANNEL_SELECT: function(e) {
                    var t = e.channelId;
                    return null == t && null != T ? R(l.Z.getChannel(T), null) : R(l.Z.getChannel(t), t)
                },
        ...
        491260: (e, t, n) => {
            ...
            function D(e) {
                ...
                delete R[e];
                if (null != A[e]) {
                    var t = O(u().sortBy(A[e], (function(e) {
                            return -e.timestamp
                        })), 1),
                        n = t[0];

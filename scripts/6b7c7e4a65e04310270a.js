                ...
                try {
                    for (var a, l = r[Symbol.iterator](); !(o = (a = l.next()).done); o = !0) {
                        ...
                        if (null != p && null != p.pathname) {
                            var E, g, M, D, j = U(A, p),
                                F = U(S, p),
                                V = null !== (D = null !== (M = null !== (g = null !== (E = U(R, p)) && void 0 !== E ? E : U(C, p)) && void 0 !== g ? g : U(N, p)) && void 0 !== M ? M : U(P, p)) && void 0 !== D ? D : U(w, p),
                                B = function(e, r) {
                                    if (!t.has(r)) {
                                        t.add(r);
                                        n.push({
                            ...
                            null != (null == V ? void 0 : V.match(m)) && B(_.g.CHANNEL_LINK, V.replace("/channels/", ""));
                            var z = Z(p.pathname);
                            null != z && B(_.g.EVENT, "".concat(z.guildId, "-").concat(z.guildEventId));
                            var W = null == V ? void 0 : V.match(O);
                            if (null != W) {
                                var K = W[1];
                                B(_.g.APP_DIRECTORY_PROFILE, K)
                            }
                            ...
                            if (null != q && Q) {
                                var X = q[1];
                                B(_.g.ACTIVITY_BOOKMARK, X)
                            }
                            var $ = null == V ? void 0 : V.match(I);
                            null != $ && B(_.g.GUILD_PRODUCT, "".concat($[1], "-").concat($[2]));
                            var J = null == V ? void 0 : V.match(b);
                            null != J && B(_.g.SERVER_SHOP, J[1])
                        }
                    }
                } catch (e) {
                    i = !0;
            ...
            const Q = new q(c.Z, {
                ...
                LAYOUT_CREATE_WIDGETS: function(e) {
                    e.widgetConfigs.forEach((function(e) {
                        ...
                        B = M(w({}, B), N({}, n.id, n.set("widgets", r)))
                    }))
                }
            })
        },

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [52984, 14136, 84832, 57678, 58621, 96043, 71402, 77357, 56645], {
        737264: e => {
            "use strict";
            ...
            function S() {
                ...
                return u.Z.getMediaEngine().enable().then((function() {
                    ...
                    switch (e) {
                        ...
                        default:
                            m(s.PQ.ERROR);
                            v.warn("unknown getUserMedia error: ".concat(e))
                    }
                })).then((function() {
                    return !0
                }))
        ...
        825781: (e, t, n) => {
            ...
            var d, p, _, E, h, I, v, T, g, m = o.QZA.CLOSED,
                S = {},
                b = !1;
            ...
            const P = new R(i.Z, {
                ...
                GUILD_IDENTITY_SETTINGS_SUBMIT_FAILURE: function(e) {
                    if (m !== o.QZA.SUBMITTING) return !1;
                    m = o.QZA.OPEN;
                    var t;
            ...
            function I(e) {
                var t, n = (0, E.Z)(),
                    ...
                    T = (0, i.e7)([a.Z], (function() {
                        return a.Z.getGuild(v)
                    }), [v]),
                    g = (0, i.e7)([l.Z], (function() {
                        return null != I ? l.Z.getVoiceStateForChannel(I, e.id) : null
                    }), [I, e.id]),
                    m = (null === (t = u.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === e.id,
                    S = function() {
                    ...
                    O = (0, s.B)(I);
                if (null == n || null == T || null == g) return null;
                if (b.speaker) return null;
                var y = function() {
                    m ? (0, c.RK)(n, !1) : (0, c._0)(n, e.id)
                };
                return O ? (0, r.jsx)(o.MenuItem, {
                    id: "invite-speaker",
                    label: m ? h.Z.Messages.STAGE_CHANNEL_USER_SET_MYSELF_TO_SPEAKER : h.Z.Messages.STAGE_CHANNEL_USER_INVITE_TO_SPEAK,
                    action: y
                }) : S && m ? (0, r.jsx)(o.MenuItem, {
                    id: "invite-speaker",
        ...
        914136: (e, t, n) => {
            ...
            const Y = (0, u.Z)((0, a.Z)((function(e) {
                var t = e.user,
                    ...
                    be = (0, v.Z)(t),
                    Oe = function(e, t, n) {
                        var o, a = g.Z.getChannel(n),
                            u = (0, T.e7)([m.Z], (function() {
                                return m.Z.getGuild(t)
                            }), [t]),
                            l = (0, T.e7)([y.ZP], (function() {
                                return y.ZP.getPermissionsForUser(e.id, n)
                            }), [n, e.id]),
                            c = (null === (o = b.default.getCurrentUser()) || void 0 === o ? void 0 : o.id) === e.id,
                            s = (0, T.e7)([S.Z], (function() {
                ...
                return (0, r.jsxs)(i.Menu, {
                    ...
                    children: [!Re && (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsxs)(i.MenuGroup, {
                            ...
                            children: [s && se, s && ge, Q && fe, ye, Ne, Q && de, _e, Q && Ee, q && Ae]
                        }), (0, r.jsx)(i.MenuGroup, {
                            children: he
                        }), (0, r.jsxs)(i.MenuGroup, {
                            children: [Ie, ve]
            ...
            const S = function(e) {
                var t = e.commandType,
                    ...
                    D = i.useMemo((function() {
                        return (0, f.nT)(o, t, M.length, null == O ? void 0 : O.applicationCommandCounts)
                    }), [o, t, null == O ? void 0 : O.applicationCommandCounts, M.length]);
        ...
        100856: (e, t, n) => {
            ...
            function S(e, t) {
                ...
                if (!b && !_.Z.can(g.Plq.MOVE_MEMBERS, S)) return null;
                var O = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== S.id && (b ? _.Z.can(g.Plq.CONNECT, n) && !(0, v.rY)(n, I.Z, p.Z) : _.Z.can(g.Plq.MOVE_MEMBERS, n) && (_.Z.can(g.Plq.CONNECT, n) || T.ZP.can({
        ...
        223219: (e, t, n) => {
            ...
            function D(e) {
                ...
                null != e.scrollPosition && null != g && (S[g] = e.scrollPosition);
            ...
            var Z = function(e) {
                ...
                r.getProps = function() {
                    return {
                        ...
                        scrollPosition: null != g ? S[g] : null,
                        settings: y,
                        errors: b,
            ...
            const x = new Z(a.Z, {
                ...
                USER_SETTINGS_MODAL_CLEAR_SCROLL_POSITION: function(e) {
                    var t = e.forSection;
                    null != t ? delete S[t] : null != g && delete S[g]
                },
                USER_SETTINGS_MODAL_UPDATE_ACCOUNT: function(e) {
                    var t = e.settings;
                    null == y && (y = {});
                    var n = y[l.oAB.ACCOUNT];
                    y[l.oAB.ACCOUNT] = p({}, n, t)
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    R = e.tab;
                    return null == g && R === l.cII.USER_SETTINGS && D({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, E, h, I, v = encodeURIComponent(l.toString()),
                    T = encodeURIComponent(u()),
                    g = (E = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), h = null != (null === i() || void 0 === i() || null === (p = i().ua) || void 0 === p ? void 0 : p.match(E)), I = "Safari" === (null === i() || void 0 === i() ? void 0 : i().name) && !h, "iOS" !== (null === i() || void 0 === i() || null === (_ = i().os) || void 0 === _ ? void 0 : _.family) || I ? 1 : 0),
                    m = null != r ? encodeURIComponent(r) : null,
                    S = null != o ? encodeURIComponent(o) : null,
                    b = "".concat(f, "/?link=").concat(v, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(T, "&efr=").concat(g);
                null != m && (b += "&afl=".concat(m));
                null != S && (b += "&ifl=".concat(S));
                return b
            }
        },
        426080: (e, t, n) => {
        ...
        717621: (e, t, n) => {
            ...
            ! function(i) {
                ...
                d.prototype = {
                    ...
                    toHex8: function(e) {
                        return function(e, t, n, r, i) {
                            var o = [G(l(e).toString(16)), G(l(t).toString(16)), G(l(n).toString(16)), G(x(r))];
                ...
                function h(e, t, n, r) {
                    return [G(x(r)), G(l(e).toString(16)), G(l(t).toString(16)), G(l(n).toString(16))].join("")
                }
                ...
                var j, F, H, B = (F = "[\\s|\\(]+(" + (j = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + j + ")[,|\\s]+(" + j + ")\\s*\\)?", H = "[\\s|\\(]+(" + j + ")[,|\\s]+(" + j + ")[,|\\s]+(" + j + ")[,|\\s]+(" + j + ")\\s*\\)?", {

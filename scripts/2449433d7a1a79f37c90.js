        ...
        287850: function(e, t, n) {
            ...
            function N(e) {
                ...
                return {
                    channelId: e.id,
                    lastMessageId: t,
                    isFavorite: A.default.isMessagesFavorite(e.id) && (0, p.isInMainTabsExperiment)(),
            ...
            function L() {
                R.clear(), Object.values(_.default.getMutablePrivateChannels()).forEach(e => {
                    R.set(e.id, N(e))
                }), (0, p.isInMainTabsExperiment)() && (0, h.isSplitMessagesTab)() && A.default.getAddedToMessages().forEach(e => {
            ...
            class P extends c.default.Store {
                initialize() {
                    this.waitFor(_.default, v.default, S.default, I.default, A.default), this.syncWith([A.default, I.default], L)
                }
            ...
            class f extends i.Component {
                render() {
                    let {
                        ...
                        cta: A
                    } = this.props, S = null != i && i.length > 0, m = null != _ ? _ : this._textInputRef;
                    return (0, s.jsx)(r.FocusRing, {
                        ...
                        children: (0, s.jsxs)("div", {
                            ...
                            children: [(0, s.jsx)(r.TextInput, {
                                ...
                                className: d.cta,
                                children: A
                            }) : null, S ? (0, s.jsx)(r.Clickable, {
                                onClick: this.handleClear,
                                className: d.clear,
                                "aria-label": c.default.Messages.SEARCH_CLEAR,
                                children: (0, s.jsx)(u.default, {
                                    className: l(d.clearIcon, v)
                                })
                            }) : (0, s.jsx)(o.default, {

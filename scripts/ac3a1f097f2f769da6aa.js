        ...
        135521: (e, t, n) => {
            ...
            function F(e) {
                var t = e.activityItem,
                    ...
                    m = G(e, ["activityItem", "analyticsLocations"]),
                    y = (0, o.e7)([g.default], (function() {
                        return g.default.getCurrentUser()
                    })),
                    v = (0, d.Z)(n).analyticsLocations;
                (0, p.Z)({
                    type: a.nv.MODAL,
                    name: a.zs.ACTIVITY_BOOKMARK_SHARE_MODAL,
                    properties: {
                        application_id: t.application.id,
                        location_stack: v
                    }
                });
                var b = B(i.useState(""), 2),
                    S = b[0],
                    O = b[1],
                    T = B(i.useState([]), 2),
                    j = T[0],
                    ...
                    k = "".concat(window.location.origin).concat(_.Z5c.ACTIVITY_DETAILS(t.application.id)),
                    P = (0, o.Wu)([h.Z], (function() {
                        return h.Z.getInviteSuggestionRows()
                    }));
                i.useEffect((function() {
                    (0, s.x)({
                        omitUserIds: new Set,
                        applicationId: t.application.id,
                        inviteTargetType: N.Iq.EMBEDDED_APPLICATION
                    })
                }), [t.application.id]);
                i.useEffect((function() {
                    return (0, s.C)(S)
                }), [S]);
                var M = i.useCallback(R((function() {
                    var e, n, r, i;
                        ...
                        switch (a.label) {
                            case 0:
                                e = function(e, t) {
                                    ...
                                    return e.type === x.bm.GROUP_DM || e.type === x.bm.CHANNEL ? u.Z.sendActivityBookmark(e.item.id, t, f.Z.ACTIVITY_DETAIL_PAGE, null) : e.type === x.bm.DM || e.type === x.bm.FRIEND ? l.Z.ensurePrivateChannel(e.item.id).then((function(e) {
                                        return u.Z.sendActivityBookmark(e, k, f.Z.ACTIVITY_DETAIL_PAGE, null)
                                    })) : Promise.resolve()
                                };
                                n = 0;
                                r = 0;
                                i = 0;
                                return [4, h.Z.getInviteSuggestionRows().filter((function(e) {
                                    return j.includes(e.item.id)
                                })).map((function(t) {
                                    return e(t, k)
                                }))];
                            case 1:
                                a.sent();
                                w.default.track(_.rMx.ACTIVITY_BOOKMARK_SHARED, {
                                    user_id: null == y ? void 0 : y.id,
                                    application_id: t.application.id,
                                    n_users: n,
                                    n_gdms: r,
                                    n_channels: i
                ...
                return (0, r.jsxs)(c.ModalRoot, L(function(e) {
                    ...
                    children: [(0, r.jsxs)(c.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(c.Heading, {
                            ...
                            children: Z.Z.Messages.EMBEDDED_ACTIVITIES_SHARE_ACTIVITY_WITH.format({
                                activityName: t.application.name
                            })
                        }), (0,
                            r.jsx)(c.ModalCloseButton, {
                            onClick: m.onClose
                        })]
            ...
            function K(e) {
                ...
                switch (t.type) {
                    ...
                    case x.bm.FRIEND:
                        ...
                        o = C.ZP.getName(t.item);
                        l = C.ZP.getUserTag(t.item);
                        break;
                    case x.bm.GROUP_DM:
                        var s = (0, m.x)(t.item),
                            u = (0, y.F6)(t.item, g.default, b.Z);
                        a = (0, r.jsx)(c.Avatar, {
                            src: s,
                            "aria-label": u,
                            size: c.AvatarSizes.SIZE_40
                        });
                        o = (0, y.F6)(t.item, g.default, b.Z);
                        break;
                    case x.bm.CHANNEL:
                        var f = t.item,
                            d = v.Z.getGuild(f.guild_id);
                        if (null == d) return null;
                        o = "#".concat((0, y.F6)(f, g.default, b.Z));
                        l = d.name;
                        if (null != d.icon) {
                            var p = T.ZP.getGuildIconURL({
                                id: f.guild_id,
                                icon: d.icon,
                                size: 40
                            });
            ...
            function Y(e) {
                ...
                return (0, r.jsxs)(c.Button, {
                    ...
                    onClick: function() {
                        w.default.track(_.rMx.ACTIVITY_BOOKMARK_COPY_URL, {
                    ...
                    children: [s ? (0, r.jsx)(S.Z, {}) : (0, r.jsx)(O.Z, {}), s ? Z.Z.Messages.COPIED : Z.Z.Messages.COPY_LINK]
                })
            }
        },
        537335: (e, t, n) => {
            ...
            var S, O, w, T, j, x, A, C = new Set,
                E = [],
                _ = new Map;

            function N(e) {
                var t = new Set,
                    n = null == T || A === d.Iq.EMBEDDED_APPLICATION ? void 0 : T.id,
                    r = (0, c.rh)(C, n);
                ...
                var i = !0,
                    ...
                    m = void 0;
                try {
                    for (var y, v = u.Z.getUserAffinitiesUserIds()[Symbol.iterator](); !(i = (y = v.next()).done); i = !0) {
                        var h = y.value;
                        t.add(h)
                    }
                } catch (e) {
                ...
                var b = new Set;
                if (A === d.Iq.EMBEDDED_APPLICATION) {
            ...
            var k = function(e) {
                ...
                r.getSelectedInviteMetadata = function(e) {
                    var t = _.get(e),
                        n = u.Z.getUserAffinitiesUserIds();
                    return null != t ? {
                        rowNum: t.index,
                ...
                r.__getLocalVars = function() {
                    return {
                        MAX_INVITE_SUGGESTION_COUNT: 100,
                        userIdsToOmit: C,
                        inviteSuggestions: E,
                        inviteSuggestionsMap: _,
                        initialCounts: S,
                        totalCount: O,
                        isFiltered: w,
                        currentGuild: T,
                        currentChannel: j,
                        currentApplicationId: x,
                        currentInviteTargetType: A
                    }
                };
                return n
            }(r.ZP.Store);
            k.displayName = "InviteSuggestionsStore";
            const D = new k(i.Z, {

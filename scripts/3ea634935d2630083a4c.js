    ...
    ["12917"], {
        ...
        404432: function(e, t, s) {
            ...
            var n = s("37983"),
                ...
                m = s("173791"),
                g = s("926622"),
                C = o.default.connectStores([f.default, u.default, _.default, E.default], e => {
                    let {
                        giftCode: t
        ...
        331085: function(e, t, s) {
            ...
            function D(e) {
                ...
                switch (t.step) {
                    case n.INITIALIZING:
                    case n.PENDING_REMOTE_INIT:
                        return (0, o.jsxs)(o.Fragment, {
                            children: [(0, o.jsx)(M, {
                                text: t.step === n.PENDING_REMOTE_INIT ? "https://discord.com/ra/".concat(t.fingerprint) : ""
                            }), (0, o.jsx)(N.Title, {
                    ...
                    case n.PENDING_TICKET:
                    case n.PENDING_FINISH: {
                        let {
                            user: e
                        } = t;
                        return (0, o.jsxs)(o.Fragment, {
            ...
            function x(e) {
                let {
                    ...
                    let [t, s] = i.useState(0), [a, l] = i.useState(!1), [r, o] = i.useState({
                        step: n.INITIALIZING
                    }), [d, c] = i.useState(null), E = (0, _.default)(), f = i.useMemo(() => new u.default(1500, 3e4), []), h = i.useRef();
                    h.current = i.useCallback(() => {
                        o({
                            step: n.INITIALIZING
                        }), E ? s(e => e + 1) : (O.info("document is not visible, will defer reconnection when document becomes visible."), l(!0))
                    }, [E]);
                    let N = i.useCallback(() => {
                            (function(e) {
                                let {
                    ...
                    return i.useEffect(() => {
                        E && a && r.step === n.INITIALIZING && (O.info("reconnecting, now that document is visible"), l(!1), s(e => e + 1))
                    }, [r, E, a, l]), i.useEffect(() => {
                        let t = Date.now(),
                            s = () => "".concat(Date.now() - t, "ms"),
                            a = "wss:".concat(window.GLOBAL_ENV.REMOTE_AUTH_ENDPOINT, "/?v=2"),
                            l = new WebSocket(a);
                        O.info("[0ms] connecting to ".concat(a));
                        ...
                        let m = () => {
                            _ ? (_ = !1, l.send(JSON.stringify({
                                op: "heartbeat"
                            }))) : (r("heartbeat timeout, reconnecting."), l.close(), A())
                        };
                        return l.onmessage = async t => {
                            let {
                                data: s
                            } = t, a = JSON.parse(s);
                            switch (a.op) {
                                case "nonce_proof": {
                                    ...
                                    r("computed nonce proof"), l.send(JSON.stringify({
                                        op: "nonce_proof",
                                        nonce: t
                                    }));
                                    return
                                ...
                                case "pending_remote_init": {
                                    ...
                                    if (e !== a.fingerprint) throw Error("bad fingerprint ".concat(e, " !== ").concat(a.fingerprint));
                                    r("handshake complete awaiting remote auth."), o({
                                        step: n.PENDING_REMOTE_INIT,
                                        fingerprint: e
                                    });
                                    return
                                }
                                ...
                                case "cancel":
                                    ...
                                    return;
                                case "hello": {
                                    r("got hello, auth timeout=".concat(a.timeout_ms, "ms"));
                            ...
                            r("connected, handshaking with fingerprint: ".concat(e)), l.send(JSON.stringify({
                                op: "init",
                            ...
                            r("cleaning up"), l.onopen = () => null, l.onmessage = () => null, l.onclose = () => null, l.onerror = () => null, l.close(1e3), f.cancel(), null != E && clearTimeout(E), null != d && clearInterval(d)
                        }
                    }, [N, e, t, f, A]), {
                        state: r,
                        rsaKeyPair: d,
                ...
                return i.useEffect(() => {
                    s.step === n.PENDING_LOGIN && null != s.ticket && d.default.post({
                        ...
                        if (null != l) try {
                            let s = await (0, T.decryptEncodedCiphertext)(l, e.body.encrypted_token);
                            t(s)
                        } catch (e) {
                            E()
                        } else E()
        ...
        382236: function(e, t, s) {
            ...
            let C = new Set([n.NONCE_MISSING, n.NONCE_EXPIRED, n.HANDOFF_EXCHANGE]),
                p = new Set([n.NULL_HANDOFF_TOKEN]),
                L = () => {
            ...
            var O = () => {
                let e = (0, u.useStateFromStores)([N.default], () => N.default.getFingerprint()),
                    ...
                    a = Array.isArray(t) ? t.length > 1 ? t[0] : null : t,
                    O = null != a ? a : null !== e ? e : void 0;
                r.useEffect(() => {
                    null !== a && e !== a && _.default.dispatch({
                        type: "FINGERPRINT",
                        fingerprint: a
                    })
                }, [a, e]);
                ...
                if ("null" === s && null === M && D(n.NULL_HANDOFF_TOKEN), null != s && "null" !== s && null == x && null === M && D(n.NONCE_MISSING), r.useEffect(() => {
                        if (null != x) {
                            let e = c.default.get(g);
                            (null == e || Date.now() >= e) && (D(n.NONCE_EXPIRED), L())
                        }
                    }, [x, D]), r.useEffect(() => {
                        ...
                        children: [(0, l.jsx)(d.Avatar, {
                            ...
                            children: [!M && (0, l.jsx)(d.Button, {
                                onClick: function() {
                                    ...
                                    }), S.switchAccount(s.id), a(n.SWITCHED, s.id)
                                },

    ...
    ["92309"], {
        ...
        658756: function(e, t, n) {
            ...
            let F = e => {
                ...
                } = (0, p.default)([...R, E.default.COLLECTIBLES_COLLECTED_MODAL]), Z = (0, m.default)({
                    analyticsLocations: G
                });
        ...
        894742: function(e, t, n) {
            ...
            var r = n("37983"),
                ...
                S = n("843455"),
                h = n("322859");
            let m = (e, t, n) => (0, r.jsx)(E.CollectiblesPaymentModalHeader, {
                step: n,
                onClose: () => t(!1)
            });
            ...
            function I(e) {
                ...
                } = (0, s.default)([..._, o.default.COLLECTIBLES_PAYMENT_MODAL]), T = a.useRef(new l.Environment), [N, O] = a.useState(null), y = [f.ONE_TIME_PAYMENT_PREDICATE_STEP_CONFIG, f.ONE_TIME_PAYMENT_ADD_PAYMENT_STEP_CONFIG, ...f.SHARED_STEP_CONFIGS, f.REVIEW_STEP_CONFIG, {
                    key: c.Step.CONFIRM,
        ...
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, C = (0, l.useStateFromStores)([o.default], () => o.default.useReducedMotion), [E, p] = a.useState(d), S = a.useRef((0, i.getGiftAnimationData)(t, E)), [h, m] = a.useState(null == f), [I, v] = a.useState(!1), [_, g] = a.useState(-1), x = () => {
                    S.current = (0, i.getGiftAnimationData)(t, E), g(e => e + 1)
                }, A = () => {
                    m(!1), v(!0), g(-1), p(d)
                };
                a.useEffect(() => {

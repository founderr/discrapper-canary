    ...
    ["35090"], {
        ...
        629109: function(e, t, n) {
            ...
            function _(e, t, n, s, a) {
                ...
                let u = e[t],
                    d = e[n];
                o.default.track(l.AnalyticEvents.MEDIA_DEVICE_CHANGED, {
                    device_from_name: i.default.getCertifiedDeviceName(t, null != u ? u.name : ""),
            ...
            var g = {
                ...
                toggleSelfMute() {
                    ...
                    return S() ? Promise.resolve() : d.default.isEnabled() ? s.default.dispatch({
        ...
        412905: function(e, t, n) {
            ...
            function _() {
                return !d.default.isSupported() && ((0, a.openModal)(e => (0, s.jsx)(a.ConfirmModal, {
                    header: l.default.Messages.UNSUPPORTED_BROWSER,
                    ...
                    children: (0, s.jsx)(a.Text, {
                        ...
                        children: l.default.Messages.UNSUPPORTED_BROWSER_DETAILS
                    })
                })), !0)
            }

            function m(e) {
                o.default.track(r.AnalyticEvents.PERMISSIONS_ACKED, {
                    type: "audio",
                    action: e
                })
            }
            ...
            function E() {
                ...
                return _() ? Promise.resolve(!1) : (o.default.track(r.AnalyticEvents.PERMISSIONS_REQUESTED, {
                    type: "audio"
                    ...
                    u.default.dispatch({
                        ...
                        enabled: !0,
                        unmute: e
                    }), m(c.NativePermissionStates.ACCEPTED)
                }, e => {
                    switch (e) {
                        case r.UserMediaErrors.NO_DEVICES_FOUND:
                            m(c.NativePermissionStates.NO_DEVICES);
                            break;
                        case r.UserMediaErrors.PERMISSION_DENIED:
                            m(c.NativePermissionStates.DENIED);
                            break;
                        case r.UserMediaErrors.PERMISSION_DISMISSED:
                            m(c.NativePermissionStates.DISMISSED);
                            break;
                        default:
                            m(c.NativePermissionStates.ERROR), p.warn("unknown getUserMedia error: ".concat(e))
                    }
                }).then(() => !0))
            }
        },
        242757: function(e, t, n) {
            ...
            function a(e, t, n, a) {
                let u = null != n ? n : t,
                    i = null != u && e.can(s.Permissions.CREATE_INSTANT_INVITE, u);
        ...
        709681: function(e, t, n) {
            ...
            function d(e, t) {
                ...
                let s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1,
                    a = (0, u.default)(t);
                return o(null !== (n = a[e]) && void 0 !== n ? n : e, e, s)
            }
            ...
            function r(e) {
                ...
                let d = (0, u.default)(a.default.getSoundpack()),
                    r = o(null !== (t = d[e]) && void 0 !== t ? t : e, e, n);
            ...
            function p() {
                null != window.navigator.mediaDevices && window.navigator.mediaDevices.enumerateDevices().then(e => {
                    let t = d.default.getOutputDevices(),
                        ...
                        i = u[n];
                    null != s && (null == i || i.label !== s.name) && (i = u.find(e => e.label === s.name)), c = null != i ? i.deviceId : r
                }).catch(() => {
                    c = r
                })
            }
            o.isPlatformEmbedded && (d.default.addChangeListener(p), p());
            class f {
                get volume() {
                    return this._volume
                }

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [13185, 17586, 40056, 58093, 84832], {
                ...
                if ("IntersectionObserver" in t && "IntersectionObserverEntry" in t && "intersectionRatio" in t.IntersectionObserverEntry.prototype) "isIntersecting" in t.IntersectionObserverEntry.prototype || Object.defineProperty(t.IntersectionObserverEntry.prototype, "isIntersecting", {
                    ...
                    o.prototype._computeTargetAndRootIntersection = function(e, n) {
                        if ("none" != t.getComputedStyle(e).display) {
                            for (var o, i, a, c, _, l, E, v, d = s(e), h = u(e), R = !1; !R;) {
                                var T = null,
                                    O = 1 == h.nodeType ? t.getComputedStyle(h) : {};
                                if ("none" == O.display) return;
                                if (h == this.root || h == r) {
                                    R = !0;
                                    T = n
                                } else h != r.body && h != r.documentElement && "visible" != O.overflow && (T = s(h));
                                if (T && !(d = (o = T, i = d, a = void 0, c = void 0, _ = void 0, l = void 0, E = void 0, v = void 0, a = Math.max(o.top, i.top), c = Math.min(o.bottom, i.bottom), _ = Math.max(o.left, i.left), l = Math.min(o.right, i.right), v = c - a, (E = l - _) >= 0 && v >= 0 && {
                                        top: a,
                                        bottom: c,
                                        left: _,
                                        right: l,
        ...
        58964: (t, r, e) => {
            ...
            function v(t) {
                ...
                try {
                    ...
                    var n, o = decodeURIComponent(e),
                        ...
                        u = void 0;
                    try {
                        for (var E, v = i.entries()[Symbol.iterator](); !(s = (E = v.next()).done); s = !0) {
                            var d = _(E.value, 2),
                                h = d[0],
                                R = d[1];
                            a[h] = R
            ...
            function d(t, r) {
                var e = r.utmSource,
                    ...
                    i = r.iosFallbackLink,
                    a = u(r, ["utmSource", "androidFallbackLink", "iosFallbackLink"]),
                    c = new URL(t);
                for (var _ in a) {
                    var E = a[_];
                    null != E && c.searchParams.set(_, E)
                }
                var v, d, h, R, T, O = encodeURIComponent(c.toString()),
                    p = encodeURIComponent(s()),
                    g = (h = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), R = null != (null === o() || void 0 === o() || null === (v = o().ua) || void 0 === v ? void 0 : v.match(h)), T = "Safari" === (null === o() || void 0 === o() ? void 0 : o().name) && !R, "iOS" !== (null === o() || void 0 === o() || null === (d = o().os) || void 0 === d ? void 0 : d.family) || T ? 1 : 0),
                    f = null != n ? encodeURIComponent(n) : null,
                    N = null != i ? encodeURIComponent(i) : null,
                    A = "".concat(l, "/?link=").concat(O, "&utm_source=").concat(e, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(p, "&efr=").concat(g);
                null != f && (A += "&afl=".concat(f));
        ...
        593549: (t, r, e) => {
            ...
            function c(t, r) {
                return !r || "object" !== _(r) && "function" != typeof r ? function(t) {
            ...
            function u(t, r) {
                u = Object.setPrototypeOf || function(t, r) {
                    t.__proto__ = r;
                    return t
                };
                return u(t, r)
                ...
                h = function(t) {
                    ...
                    function e(t) {
                        ...
                        var o = t.root,
                            s = t.rootMargin,
                            c = t.threshold;
                        o ? v.has(o) ? n.elementId = v.get(o) || "" : v.set(o, i().v4()) : n.elementId = E;
                        var u = n.getVisibilityObserverId();
                        d.has(u) || d.set(u, new a.Z({
                            root: o,
                            rootMargin: s,
                            threshold: c
                        }));
        ...
        498964: (t, r, e) => {
            ...
            const A = l(O((function(t) {
                    return !0
                }))),
                b = A,
                I = t => Object.assign(l(t), {
                    startsWith: r => {
                        return I(R(t, (e = r, O((t => f(t) && t.startsWith(e))))));
                        var e
                    },
                    endsWith: r => {
                        return I(R(t, (e = r, O((t => f(t) && t.endsWith(e))))));
                        var e
                    },
                    minLength: r => I(R(t, (t => O((r => f(r) && r.length >= t)))(r))),
                    maxLength: r => I(R(t, (t => O((r => f(r) && r.length <= t)))(r))),
                    includes: r => {
                        return I(R(t, (e = r, O((t => f(t) && t.includes(e))))));
                        var e
                    },
                    regex: r => {
                        return I(R(t, (e = r, O((t => f(t) && Boolean(t.match(e)))))));
                        var e
                    }
                }),
                D = I(O(f)),
                y = (t, r) => O((e => g(e) && t <= e && r >= e)),
                U = t => O((r => g(r) && r < t)),
                B = t => O((r => g(r) && r > t)),
                m = t => O((r => g(r) && r <= t)),
                C = t => O((r => g(r) && r >= t)),
                S = () => O((t => g(t) && Number.isInteger(t))),
                G = () => O((t => g(t) && Number.isFinite(t))),
                L = () => O((t => g(t) && t > 0)),
                P = () => O((t => g(t) && t < 0)),

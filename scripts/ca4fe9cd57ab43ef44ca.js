    ...
    ["44436"], {
        ...
        719451: function(e, t, n) {
            ...
            var _ = e => {
                ...
                let M = null != m.guild ? new u.default(m.guild) : null,
                    ...
                    j = y || null == m.inviter ? null : new c.default(m.inviter),
                ...
                if (null != M) k = null == j ? C.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_JOIN : C.default.Messages.AUTH_MESSAGE_INVITED_BY.format({
                ...
                }), m.target_type === I.InviteTargetTypes.STREAM && null != m.target_user && (k = C.default.Messages.AUTH_MESSAGE_INVITED_TO_STREAM.format({
                    username: E.default.getFormattedName(m.target_user)
                })), m.target_type === I.InviteTargetTypes.EMBEDDED_APPLICATION && null != m.target_application && (k = null != j ? C.default.Messages.AUTH_MESSAGE_INVITED_TO_PLAY_USERNAME.format({
                    username: E.default.getFormattedName(j)
                    ...
                    a = C.default.Messages.INSTANT_INVITE_YOU_HAVE_BEEN_INVITED_TO_CHAT.format({
                        username: e
                    }), P = !0, h = null != _ ? null : (0, i.jsx)(g.SubTitle, {
                ...
                return (0, i.jsxs)("div", {
                    ...
                    }), h, null != D || P || (null == m ? void 0 : null === (t = m.guild) || void 0 === t ? void 0 : t.id) === v.INVITE_ROUTING_HUB_GUILD_ID ? null : (0, i.jsx)(g.ActivityCount, {
        ...
        676143: function(e, t, n) {
            ...
            function x(e) {
                ...
                if (t[g.SECTION_INDEX_COMMUNITY] > 0) {
                    ...
                    switch (t) {
                        case y.ChannelListCommunityRow.GUILD_HOME:
                            return N.StaticChannelRoute.GUILD_HOME;
                        case y.ChannelListCommunityRow.GUILD_ROLE_SUBSCRIPTIONS:
                            return N.StaticChannelRoute.ROLE_SUBSCRIPTIONS;
                        case y.ChannelListCommunityRow.GUILD_MEMBER_APPLICATIONS:
        ...
        357506: function(e, t, n) {
            ...
            function ef() {
                ...
                })), s = (0, p.useStateFromStores)([G.default], () => G.default.windowSize()), o = (0, p.useStateFromStores)([H.default], () => H.default.getOverlayKeybind()), r = (0, p.useStateFromStores)([P.default], () => P.default.getVoiceChannelId()), d = (0, p.useStateFromStores)([j.default], () => j.default.getChannel(r)), u = (0, p.useStateFromStores)([w.default], () => null != d ? w.default.getGuild(d.guild_id) : null), c = (0, p.useStateFromStores)([k.default, U.default], () => (0, x.default)(k.default, U.default)), f = (0, p.useStateFromStores)([b.default], () => (0, A.default)(b.default)), {
                    canBroadcast: h
        ...
        522019: function(e, t, n) {
            ...
            function eo(e) {
                ...
                }), v = (0, o.useStateFromStores)([P.default], () => P.default.showKeybindIndicators), I = (0, o.useStateFromStores)([x.default], () => x.default.getId()), C = (0, o.useStateFromStores)([L.default], () => L.default.isLocalMute(l.id)), N = (0, o.useStateFromStores)([A.default], () => A.default.getCurrentUserActiveStream()), y = (0, o.useStateFromStoresArray)([A.default], () => null != N ? A.default.getViewerIds(N) : []), T = (0, g.default)({
                    userId: l.id,
                    context: p
                }), _ = (0, o.useStateFromStores)([w.default], () => w.default.isPrioritySpeaker(l.id, p)), O = (0, o.useStateFromStores)([A.default], () => null != A.default.getStreamForUser(l.id, m)), R = a.useMemo(() => null != N && N.ownerId !== l.id && y.includes(l.id), [N, l.id, y]);
                ...
                let n = (0, o.useStateFromStores)([j.default, R.default], () => R.default.getChannel(j.default.getVoiceChannelId())),
                    ...
                    s = function(e) {
                        let [t] = (0, o.useStateFromStores)([k.default, y.default], () => null == e ? [
                            [], -1
                        ] : e.isGuildStageVoice() ? [y.default.getMutableParticipants(e.id, T.StageChannelParticipantNamedIndex.SPEAKER), y.default.getParticipantsVersion(e.id)] : [k.default.getVoiceStatesForChannel(e), k.default.getVoiceStateVersion(e.getGuildId())], [e], J.isVersionEqual), n = (0, o.useStateFromStores)([x.default], () => x.default.getId()), {
        ...
        246458: function(e, t, n) {
            ...
            function k(e) {
                ...
                let {
                    ...
                    return t
                }), R = (0, s.useStateFromStores)([y.default], () => y.default.getVoiceChannelId()), L = (0, s.useStateFromStores)([N.default], () => N.default.getGuildVersion(n)), D = (0, s.useStateFromStores)([g.default], () => g.default.version), j = (0, s.useStateFromStores)([I.default], () => I.default.getGuildChangeSentinel(n)), {
                    enableHangStatus: w
                } = f.HangStatusExperiment.useExperiment({
                    guildId: n,
                    location: "GuildSidebar"
                }), k = (0, r.useEmbeddedAppsByChannel)(null == a ? void 0 : a.id), P = (0, d.useActiveEventsByChannel)(null == a ? void 0 : a.id), V = null !== (t = null == a ? void 0 : a.hasFeature(M.GuildFeatures.COMMUNITY)) && void 0 !== t && t;
                return (0, i.jsx)(b, {
                    guildId: n,
                    guild: a,
                    channels: l,

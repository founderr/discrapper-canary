    ...
    ["49650"], {
        ...
        130037: function(e, t, n) {
            ...
            function A(e) {
                ...
                return t
            }(l = o || (o = {})).UNUSUAL_DM_ACTIVITY = "unusual_dm_activity", l.COMMUNICATION_DISABLED = "communication_disabled", l.UNUSUAL_ACCOUNT_ACTIVITY = "unusual_account_activity", l.USERNAME_QUARANTINED = "username_quarantined";
        ...
        97508: function(e, t, n) {
            ...
            function v(e, t) {
                let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                    ...
                    M = (0, o.useStateFromStores)([s.default], () => s.default.getGuild(t), [t]),
                    v = (0, o.useStateFromStores)([u.default], () => u.default.roleStyle),
                    T = (0, a.useTrackModerationAction)(t, {
                        location: i,
                        targetUserId: e
                    }),
                    {
                        ...
                        isGuildMember: O,
                        canManageRoles: m
                    } = (0, o.useStateFromStoresObject)([c.default, _.default], () => {
                        let n = c.default.getMember(t, e);
                        return {
                            userRoles: null != n ? n.roles : [],
                            isGuildMember: null != n,
                            canManageRoles: null != M && _.default.can(E.Permissions.MANAGE_ROLES, M)
                        }
                    }, [e, t, M]);
                if (__OVERLAY__ || null == g || null == M || !O) return null;
                let R = _.default.getHighestRole(M),
                    b = Object.values(M.roles).filter(e => e.id !== M.id),
                    S = m ? b.map(n => {
                        let i = n.managed || !_.default.isRoleHigher(M, R, n),
                            o = -1 !== g.indexOf(n.id);
                        return i && !o ? null : (0, l.jsx)(r.MenuCheckboxItem, {
                            ...
                            action: () => {
                                var l;
                                return l = n, void(g.includes(l.id) ? (d.default.updateMemberRoles(t, e, g.filter(e => e !== l.id), [], [l.id]), T(a.ModerationActionType.REMOVE_ROLE)) : (d.default.updateMemberRoles(t, e, g.concat([l.id]), [l.id], []), T(a.ModerationActionType.ADD_ROLE)))
                            },
                            checked: o
                        }, n.id)
                    }) : b.filter(e => -1 !== g.indexOf(e.id)).map(e => e.id === M.id ? null : (0, l.jsx)(r.MenuItem, {
                        id: e.id,
                        label: () => h(e, v)
                    }, e.id));
                return 0 === S.filter(f.isNotNullish).length ? null : n ? S : (0, l.jsx)(r.MenuItem, {
                    id: "roles",
                    label: A.default.Messages.ROLES_LIST.format({
                        numRoles: S.length
                    }),
                    children: S
                })

    ...
    ["9674"], {
        ...
        145079: function(e, t, n) {
            ...
            let _ = e => {
                ...
                return (0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsx)(u.Tooltip, {
                        ...
                        children: n
                    }) : void 0, null != r && (0, i.jsx)(o.default, {
                        type: r,
            ...
            var T = e => {
                let {
                    ...
                    forcePomelo: f,
                    ...I
                } = e, T = (0, l.useStateFromStores)([s.default], () => s.default.hidePersonalInformation), S = T || t || n.isNonUserBot(), N = n.toString(), p = d.default.getName(n), C = a ? N : null != r ? r : p, m = n.isPomelo() || f;
                if (m || C !== N) {
        ...
        245187: function(e, t, n) {
            ...
            function p(e) {
                let {
                    className: t
                } = e, n = (0, o.default)(), r = (0, u.isThemeDark)(n) ? S : N;
                return (0, i.jsxs)("div", {
        ...
        526887: function(e, t, n) {
            ...
            function d(e) {
                ...
                } = e, E = (0, a.useConfettiCannon)(n, s), _ = (0, l.default)([u.default], () => u.default.useReducedMotion), T = r.useMemo(() => _ ? o : {
                    confettiCanvas: n,
                    cannon: E,
            ...
            let s = "".concat(location.protocol, "//").concat(window.GLOBAL_ENV.CDN_HOST, "/role-icons"),
                ...
                I = (e, t) => {
                    ...
                    let l = a.SUPPORTS_WEBP ? "webp" : "png",
                        d = "",
                        f = "quality=lossless";
                    return (null != t && (d = "size=" + (0, r.getBestMediaProxySize)(t * (0, r.getDevicePixelRatio)()), f = c ? "" : "&" + f), null != window.GLOBAL_ENV.CDN_HOST) ? "".concat(s, "/").concat(n, "/").concat(i, ".").concat(l, "?").concat(d).concat(f) : "".concat(o).concat(u.Endpoints.ROLE_ICON(n, i), "?").concat(d)
                },
        ...
        424562: function(e, t, n) {
            ...
            function m() {
                r = void 0, a = void 0, l = void 0, s = void 0
            }
            class h extends f.default.Store {
                ...
                showNotice() {
                    return void 0 !== i || void 0 !== r || void 0 !== a || void 0 !== l || void 0 !== u || void 0 !== s
                }
                getPendingAvatar() {
                    return i
                }
        ...
        752598: function(e, t, n) {
            ...
            let m = (e, t) => {
                ...
                let u = e.state === T.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : a.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    c = e.isCommandType();
                if (s && i === E.InteractionState.QUEUED || c && e.state === T.MessageStates.SENDING && null != t) return r.SENDING;
                if (s && i === E.InteractionState.CREATED || e.hasFlag(T.MessageFlags.LOADING) && !l) return r.CREATED;
            ...
            function S(e) {
                ...
                return (0, i.jsxs)(i.Fragment, {
                    children: [(0, i.jsx)(E.PaymentPortalBody, {
                        children: C ? (0, i.jsx)(o.BenefitsConfirmationLite, {
                            ...
                            showOpenDiscord: !1
                        }) : (0, i.jsx)(s.BenefitsConfirmation, {
                            listing: n,
                            application: t,
        ...
        671672: function(e, t, n) {
            ...
            function m(e) {
                ...
                let v = (0, s.default)(p.RESPONSIVE_MOBILE_WIDTH_SIZE_QUERY),
                    {
                ...
                if (a) {
                    if (v) t = (0, i.jsx)(f.BenefitsConfirmationLite, {
                ...
                } else t = v ? (0, i.jsx)(f.PurchaseConfirmationLite, {
                    listing: h,
                    onConfirm: y,
                    subscription: g
                ...
                return r.useEffect(() => {
                    o.default.useReducedMotion && U && D(window.innerWidth / 2, window.innerHeight / 2)
        ...
        101432: function(e, t, n) {
            ...
            function f(e) {
                ...
                } = (0, o.usePaymentContext)(), [P, R] = r.useState(!S || !N || p);
                return (r.useEffect(() => {
                    R(!S || !N || p)
                }, [p, N, S]), r.useEffect(() => {
                    null != f && L({
        ...
        458985: function(e, t, n) {
            ...
            function h(e) {
                ...
                let J = r.useRef(null),
                    ...
                    ei = (0, o.isApplicationUserSubscription)(D.sku_flags);
                r.useEffect(() => {
                ...
                let {
                    ...
                    fire: (i, r, a) => {
                        ...
                        let s = (null == a ? void 0 : a.settings) != null ? {
                            ...
                            o = n(s);
                        e(i, r, o, (null !== (l = null == a ? void 0 : a.count) && void 0 !== l ? l : s.confettiCount) * (null !== (u = null == a ? void 0 : a.countMultiplier) && void 0 !== u ? u : 1), {
        ...
        716849: function(e, t, n) {
            ...
            function S(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), a = (0, r.default)([d.default], () => d.default.shouldFetchPremiumLikelihood()), l = (0, r.default)([s.default], () => s.default.getCurrentUser());
                i.useEffect(() => {
                    N(l, a, t, n)
                }, [l, a, t, n])
            }
        ...
        65324: function(e, t, n) {
            ...
            function c(e) {
                ...
                } = e, I = (0, a.useStateFromStores)([l.default], () => l.default.useReducedMotion), [E, _] = r.useState(d), T = r.useRef((0, s.getGiftAnimationData)(t, E)), [S, N] = r.useState(null == f), [p, C] = r.useState(!1), [m, h] = r.useState(-1), A = () => {
        ...
        661128: function(e, t, n) {
            ...
            function I(e, t) {
                let n = (0, r.useStateFromStores)([l.default], () => null != e ? l.default.get(e) : null),
                    ...
                    o = i.useMemo(() => Array.from(a).filter(e => {
                        let {
                            parentId: t,
                            consumed: n
                        } = e;
        ...
        38766: function(e, t, n) {
            ...
            function o(e) {
                let {
                    ...
                    null != t && (0, l.initGuildIdentitySettings)(t, null != c ? c : f), r.default.open(u.UserSettingsSections.PROFILE_CUSTOMIZATION, null != t ? s.ProfileCustomizationSubsection.GUILD : s.ProfileCustomizationSubsection.USER_PROFILE, {
                        scrollPosition: n,
                        analyticsLocation: o,
                        analyticsLocations: c,

    ...
    ["28054"], {
        ...
        228800: function(e, t, n) {
            ...
            var s = n("37983"),
                ...
                W = a.memo(function(e) {
                    ...
                    let eC = (e, t, n) => {
                        null != t && "ETOOLARGE" === t.code ? (0, H.showUploadFileSizeExceededError)(z, []) : (0, H.promptToUpload)(e, z, K, {
                            requireConfirm: !0,
                    ...
                    let eR = (0, s.jsx)(u.Popout, {
                        ...
                        renderPopout: e => {
                            switch (eo) {
                                ...
                                case "attachMenu":
                                    return (0, M.dismissPremiumTutorialTooltip)(o.DismissibleContent.PREMIUM_TUTORIAL_FILE_UPLOAD_COMPOSER_TOOLTIP), (0, s.jsx)(U.default, {
                                        ...e,
                                        onClose: () => eu(null),
                                        options: eT,
                                        channel: z,
        ...
        931922: function(e, t, n) {
            ...
            function b(e) {
                let {
                    channel: t
                } = e, [n, l] = a.useState(!1), r = (0, m.default)(t, !0), b = (0, c.useStateFromStores)([S.default], () => S.default.getGuild(t.guild_id)), P = (0, c.useStateFromStores)([A.default], () => A.default.getUser(null == b ? void 0 : b.ownerId)), F = a.useMemo(() => null != b ? o(b.roles).sortBy(e => -e.position).filter(e => e.id !== b.id).value() : [], [b]), H = a.useMemo(() => o(F).filter(e => {
                    if (null == b) return !1;
        ...
        194141: function(e, t, n) {
            ...
            function M(e) {
                let {
                    ...
                    onSubmit: R,
                    onClose: x
                } = e, y = (0, d.default)(r), [D, O] = a.useState(!1), [j, b] = a.useState(v), [P, F] = a.useState(null), [H, U] = a.useState(o.shuffle(r)), [k, B] = a.useState(""), G = (0, h.useUID)(), w = (0, C.default)(j), V = (0, C.default)(D), W = (0, C.default)(P), Z = (0, C.default)(R), z = (0, C.default)(k), K = null != P && M.includes(P);
                return a.useEffect(() => {
        ...
        554393: function(e, t, n) {
            ...
            function H(e) {
                let {
                    ...
                    isGuest: J,
                    isPendingMember: $
                } = (0, E.default)(z), ee = (0, O.useForumActivityExperiment)(null == z ? void 0 : z.guild_id), et = (0, o.useStateFromStores)([I.default], () => I.default.getChannel(H)), en = (0, x.useDefaultReactionEmoji)(et), es = (0, o.useStateFromStores)([h.default], () => h.default.shouldDisplayPrompt(t) && !0 === n, [t, n]), ea = a.useCallback(e => {
                    let t = e[0];
                    if (null != t && n) {
        ...
        51714: function(e, t, n) {
            ...
            function d(e) {
                ...
                return f.forEach(e => {
                    ...
                    F && e.id === H && null != P && (b.flashKey = P), f.jumpTargetId === e.id && (b.jumpTarget = !0), null != p && e.id === p.startId && p.count > 1 && E.push({
                        type: u.ChannelStreamTypes.DIVIDER,
                        content: p.topic,
        ...
        556118: function(e, t, n) {
            ...
            function Y(e) {
                ...
                }), ef = (0, y.default)(_, A, er), eh = (0, L.default)(p), eC = (0, R.getMessageAriaLabelledBy)(p, P), em = (0, R.getMessageAriaDescribedBy)(p), ep = (0, U.default)(e, ed, !1), eE = a.useCallback(() => (0, g.transitionToGuild)(I, A, _), [I, A, _]), eg = (0, m.useRoleIcon)({
                    guildId: I,
            ...
            var q = a.memo(function(e) {
                ...
                let ee = V.MessageTypesWithLazyLoadedReferences.has(I.type) ? I.messageReference : void 0,
                    ...
                    eB = null != eF;
                r = I.type === V.MessageTypes.CUSTOM_GIFT ? "" : !eS && eB ? (0, P.default)(e, ev) : (0, U.default)(e, ev, eS);
                let eG = I.id === J,
        ...
        823674: function(e, t, n) {
            ...
            function eg(e) {
                let {
                    ...
                    }), [t, M]), b = (0, N.useCanReplyToMessage)(t, n), P = (0, L.useCanStartPublicThread)(t, n), F = (0, L.useCanViewThreadForMessage)(n), H = (0, u.useStateFromStores)([S.default], () => null != t.guild_id && S.default.isLurking(t.guild_id), [t]), U = (0, u.useStateFromStores)([y.default], () => null != t.guild_id && y.default.isCurrentUserGuest(t.guild_id), [t]), k = c.id === m, B = (I || k) && p && n.type in ec.MessageTypesDeletable;
                ...
                } = (0, f.useBurstReactionsExperiment)(t.getGuildId()), eF = (0, L.useIsActiveChannelOrUnarchivableThread)(t), eH = n.hasFlag(ec.MessageFlags.CROSSPOSTED);
                return eb && !eP && [].push(d.DismissibleContent.BURST_REACTION_BUTTON_SPARKLE), (0, s.jsxs)(s.Fragment, {
                    children: [K ? (0, s.jsxs)(s.Fragment, {
                        ...
                        channel: t,
                        message: n,
                        label: eH ? eh.default.Messages.NEWS_CHANNEL_PUBLISHED : eh.default.Messages.NEWS_CHANNEL_PUBLISH,
                        icon: G.default,
        ...
        818950: function(e, t, n) {
            ...
            let H = a.memo(function(e) {
                ...
                let {
                    ...
                    showingSpamBanner: x,
                    showingQuarantineBanner: H
                } = e, [U, k] = a.useState(!1), B = a.useMemo(() => S ? (0, y.generateMessageSpecs)({
                    compact: !0,
                    messageGroups: 30,
                    groupRange: 4,
                    attachments: 8,
                ...
                return L.current = n, s.useCallback(n => {
                    ...
                    switch (n.key.toLowerCase()) {
                        ...
                        case "e":
                            if (D) {
                                ;
                                if (s = U, v = H, R = F, !v.isSystemDM() && (0, _.default)(R, s)) n.preventDefault(), (0, M.editMessage)(H, F)
                            }
                            break;
                        case "p":
                            if (D || P) {
                                ;
                                if (x = H, y = F, !x.isSystemDM() && !(0, A.default)(y) && (N(x) || x.isPrivate())) n.preventDefault(), (0, M.pinMessage)(H, F, n)
                            }
                            break;
                        case "+":
                            (D || P) && function(e) {
        ...
        144553: function(e, t, n) {
            ...
            let A = a.memo(function(e) {
                ...
                let {
                    ...
                    return null
                }, [x, y, I, D, O]), b = (0, l.useStateFromStores)([f.default], () => null != x && f.default.isBlocked(x.author.id), [x]), P = (0, g.useContextMenuUser)(null == x ? void 0 : x.author.id, I.id), F = (0, g.useClickReply)(T, x, b), H = (0, g.useClickReferencedMessageAuthorUsername)(x, I, L, R), U = (0, g.useClickReferencedMessageAuthorAvatar)(v, R), k = a.useCallback(() => R({
                    referencedUsernameProfile: !1,

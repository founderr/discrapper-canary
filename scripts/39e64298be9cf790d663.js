    ...
    [22251, 74996], {
        652411: (e, t, n) => {
            ...
            var s = function() {
                    ...
                    return e.prototype.getNewForces = function(e, t) {
                        var n = e.wind * t,
                            i = -e.gravity * t;
                        return {
                            x: n + o(this.dragCoefficient.x, this.velocity.x),
                            y: i + o(this.dragCoefficient.y, this.velocity.y)
                        }
                        ...
                        var i = this.getNewForces(e, n),
                            a = i.x,
                            r = i.y;
                        this.velocity.update(n), this.velocity.x += a, this.velocity.y += r, this.position.update(n), this.position.x += this.velocity.x * n, this.position.y += this.velocity.y * n, this.size.update(n), this.opacity.update(n), this._lastUpdatedAt = t
                    }, e.prototype.previewPositionUpdate = function(e, t) {
                        var n = t / 100,
                            i = this.velocity.previewUpdate(n),
                            a = this.getNewForces(e, n),
                            r = a.x,
                            l = a.y;
                        i.x += r, i.y += l;
            ...
            var p = function(e) {
                ...
                g = function(e) {
                    function t(t, n, i, a, r, l) {
                        var u = e.call(this, t) || this;
                        u.min = n, u.max = i, u.duration = a;
                        var o = u.value / (u.max - u.min) * u.duration,
                            s = isNaN(o) ? 0 : o;
                        return u.timePassed = s < 0 ? u.duration - s : s, u.directionMultiplier = r, u.easingFunction = l, u
                    }
                    return f(t, e), t.prototype.update = function(e) {
                        var t = this.doUpdate(e),
                            ...
                            i = t[1],
                            a = t[2];
                        this.value = n, this.directionMultiplier = a, this.timePassed = i
                    }, t.prototype.previewUpdate = function(e) {
                        ...
                        var t = this.max - this.min,
                            ...
                            a = n < 0 || n > this.duration ? -1 * this.directionMultiplier : this.directionMultiplier,
                            r = this.easingFunction(i, this.min, t, this.duration);
                        return [isNaN(r) ? 0 : r, i, a]
                    }, t
                }(p);
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            return new g(x(e.minValue, e.maxValue), x(e.minStart, e.maxStart), x(e.minFinal, e.maxFinal), x(e.minDuration, e.maxDuration), M(e.minDirection, e.maxDirection), C(e.easingFunctions)[0])
                    }
                }(h(h({}, e), {
                    valueType: "number"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = z(e.minValue),
                                i = z(e.maxValue);
                            return new y(new m(x(n.x, i.x)), new m(x(n.y, i.y)));
                        case "linear":
                            t = z(e.value);
                            var a = z(e.addValue);
                            return new y(new b(t.x, a.x), new b(t.y, a.y));
                        case "linear-random":
                            n = z(e.minValue), i = z(e.maxValue);
                            var r = z(e.minAddValue),
                                l = z(e.maxAddValue);
                            return new y(new b(x(n.x, i.x), x(r.x, l.x)), new b(x(n.y, i.y), x(r.x, l.x)));
                        case "oscillating":
                            t = z(e.value);
                            var u = z(e.start),
                                o = z(e.final),
                                s = z(e.duration),
                                c = z(e.direction);
                            return new y(new g(t.x, u.x, o.x, s.x, c.x, e.easingFunction), new g(t.y, u.y, o.y, s.x, c.y, e.easingFunction));
                        case "oscillating-random":
                            n = z(e.minValue), i = z(e.maxValue);
                            var d = z(e.minStart),
                                v = z(e.maxStart),
                                ...
                                A = z(e.minDirection),
                                N = z(e.maxDirection);
                            return new y(new g(x(n.x, i.x), x(d.x, v.x), x(f.x, h.x), x(p.x, w.x), M(A.x, N.x), C(e.easingFunctions)[0]), new g(x(n.y, i.y), x(d.y, v.y), x(f.y, h.y), x(p.y, w.y), M(A.y, N.y), C(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector2"
                }))
                ...
                return function(e) {
                    switch (e.type) {
                        ...
                        case "static-random":
                            var n = A(e.minValue),
                                i = A(e.maxValue);
                            return new w(new m(x(n.x, i.x)), new m(x(n.y, i.y)), new m(x(n.z, i.z)));
                        case "linear":
                            t = A(e.value);
                            var a = A(e.addValue);
                            return new w(new b(t.x, a.x), new b(t.y, a.y), new b(t.z, a.z));
                        case "linear-random":
                            n = A(e.minValue), i = A(e.maxValue);
                            var r = A(e.minAddValue),
                                l = A(e.maxAddValue);
                            return new w(new b(x(n.x, i.x), x(r.x, l.x)), new b(x(n.y, i.y), x(r.y, l.y)), new b(x(n.z, i.z), x(r.z, l.z)));
                        case "oscillating":
                            t = A(e.value);
                            var u = A(e.start),
                                o = A(e.final),
                                s = A(e.duration),
                                c = A(e.direction);
                            return new w(new g(t.x, u.x, o.x, s.x, c.x, e.easingFunction), new g(t.y, u.y, o.y, s.z, c.y, e.easingFunction), new g(t.z, u.z, o.z, s.z, c.z, e.easingFunction));
                        case "oscillating-random":
                            n = A(e.minValue), i = A(e.maxValue);
                            var d = A(e.minStart),
                                v = A(e.maxStart),
                                ...
                                z = A(e.minDirection),
                                N = A(e.maxDirection);
                            return new w(new g(x(n.x, i.x), x(d.x, v.x), x(f.x, h.x), x(p.x, y.x), M(z.x, N.x), C(e.easingFunctions)[0]), new g(x(n.y, i.y), x(d.y, v.y), x(f.y, h.y), x(p.y, y.y), M(z.y, N.y), C(e.easingFunctions)[0]), new g(x(n.z, i.z), x(d.z, v.z), x(f.z, h.z), x(p.z, y.z), M(z.z, N.z), C(e.easingFunctions)[0]))
                    }
                }(h(h({}, e), {
                    valueType: "Vector3"
                }))
            ...
            function k(e, t, n, i, a) {
                ...
                return new s({
                    ...
                    rotation: P(r.rotation),
                    dragCoefficient: R(r.dragCoefficient),
                    size: l,
                    opacity: N(r.opacity),
            ...
            var O = i.forwardRef((function(e, t) {
                var r = e.className,
                    ...
                    x = i.useCallback((function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == v || v(t), w.current.forEach((function(n, i) {
                                    var a = n.confetti,
                                        r = n.spriteCanvas;
                                    a.update(l), a.draw(r, t), a.shouldDestroy(e, l) && w.current.delete(i)
                                })), null == f || f(t), w.current.size > 0 ? m.current = window.requestAnimationFrame(x) : (t.clearRect(0, 0, e.width, e.height), m.current = null);
                                var n = Date.now();
                                0 !== b.current && (g.current = 1e3 / (n - b.current)), b.current = n
                            }
                        }
                    }), [l, f, v]);
                ...
                var C = i.useCallback((function(e, t) {
                    ...
                    M = i.useCallback((function(e, t, n, i, r) {
                        var l, u = k(null !== (l = e.id) && void 0 !== l ? l : (0, a.Z)(), e, n, i, r);
                        return C(u, t), u
                    }), [C]),
                ...
                var R = i.useCallback((function(e, t) {
                        var n, i, a = t.clickHandler,
                            r = t.mouseHandler;
                        if (null != a || null != r) {
                            var o = null === (n = y.current) || void 0 === n ? void 0 : n.getBoundingClientRect();
                            if (null != o) {
                                var s = function(e, t) {
                                ...
                                if (u(s, {
                                    ...
                                    if (null != a) {
                                        ...
                                        a(e, null !== (i = null == d ? void 0 : d.confetti) && void 0 !== i ? i : null)
                                    }
                                }
                            }
                        }
                ...
                return i.useEffect((function() {
                    ...
                    return e("click", P, o), e("mousedown", O, s), e("mousemove", V, c), e("mouseup", I, d),
                        function() {
                            window.removeEventListener("click", P), window.removeEventListener("mousedown", O), window.removeEventListener("mousemove", V), window.removeEventListener("mouseup", V)
                        }
                }), [P, O, V, I, o, s, c, d]), i.useEffect((function() {
                    var e = y.current,
                            ...
                            ! function(e) {
                                if (null != e) {
                                    var t = e.getBoundingClientRect(),
                                        i = t.width,
                                        a = t.height;
                                    e.width = i * n.g.devicePixelRatio, e.height = a * n.g.devicePixelRatio
                                }
                            }(y.current)
                        }));
            ...
            ! function(e, t) {
                ...
                if ("undefined" != typeof document) {
                    ...
                    a.type = "text/css",
                        "top" === n && i.firstChild ? i.insertBefore(a, i.firstChild) : i.appendChild(a), a.styleSheet ? a.styleSheet.cssText = e : a.appendChild(document.createTextNode(e))
                }
            ...
            var V = i.forwardRef((function(e, t) {
                        ...
                        null != t && null != e && (t.clearRect(0, 0, e.width, e.height),
                            h.current.forEach((function(e, n) {
                                var i = function(i, a) {
                                    var r = d * a + 2 * a,
                                        l = v * n + 2 * n;
                                    if (t.drawImage(e.image, r, l, d, v), null != i) {
                                        for (var u = t.getImageData(r, l, d, v), o = function(e) {
                                                "#" === e[0] && (e = e.slice(1));
                                                var t = parseInt(e, 16);
                                                return {
                                                    r: t >> 16 & 255,
                                            ...
                                            }(i), s = 0; s < u.data.length; s += 4) u.data[s] = o.r, u.data[s + 1] = o.g, u.data[s + 2] = o.b;
                                        t.putImageData(u, r, l)
                                    }
                                };
                            ...
                            return function(e, t) {
                                ...
                                switch (e.label) {
                                    case 0:
                                        return [4, m()];
                                    case 1:
                                        return e.sent(), w(), p.current = !0, b(!0), [2]
                                }
                            }))
                        }))
                    }), [b, m, w]);
                return i.useEffect((function() {
                    ...
                    ref: f,
                    className: l()(r, (n = {}, n["SpriteCanvas-module_spriteCanvasHidden__ndzQV"] = !o, n))
                })
            }));

            function I(e, t) {
                var n, a = i.useState(null !== (n = null == t ? void 0 : t.isReady) && void 0 !== n && n),
                    r = a[0],
                    l = a[1];
                i.useEffect((function() {
                ...
                var u = i.useCallback((function(n, i) {
                        ...
                        if (null != o && null != u && 0 !== u.sprites.length) return null == e ? void 0 : e.createConfetti(n, o, u, r, l)
                    }), [e, t]),

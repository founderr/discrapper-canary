    ...
    ["73641"], {
        ...
        176347: function(e, t, n) {
            ...
            var ej = a.memo(function(e) {
                ...
                }), m = (0, d.useStateFromStores)([Y.default], () => Y.default.isEnabled()), p = (0, J.default)(t.id), E = (0, w.default)(t.id);
                return (0, s.jsx)(eO, {
                    channel: t,
            ...
            var s = n("37983"),
                ...
                H = a.memo(function(e) {
                    ...
                    let H, {
                            ...
                            editorTextContent: w,
                            setValue: V,
                            canOnlyUseTextCommands: W
                        } = e,
                        Z = a.useRef(null),
                        z = (0, r.useStateFromStores)([N.default], () => N.default.getActivities()),
                        K = (0, r.useStateFromStores)([m.default], () => m.default.getSettings().clipsEnabled),
                        Y = (0, r.useStateFromStores)([m.default], () => m.default.getLastClipsSession()),
                        q = (0, r.useStateFromStores)([m.default], () => m.default.getState().newClipIds),
                        X = (0, r.useStateFromStores)([T.default], () => null == T.default.getCurrentSidebarChannelId(G.id)),
                        J = (0, r.useStateFromStores)([E.HotspotStore], () => E.HotspotStore.hasHotspot(E.HotspotLocations.CLIPS_CHANNEL_ATTACH_REMINDER)),
                        Q = (0, u.useModalsStore)(e => (0, u.hasModalOpenSelector)(e, P.CLIPS_GALLERY_MODAL_KEY)),
                        $ = (0, r.useStateFromStores)([M.default], () => M.default.hasLayers()),
                        ee = (0, r.useStateFromStores)([m.default], () => m.default.hasClips()),
                        [et, en] = a.useState(null),
                        es = (0, C.useEnableClips)() && (K || ee),
                        ea = G.isPrivate(),
                        el = (0, r.useStateFromStores)([I.default], () => ea || I.default.can(b.Permissions.ATTACH_FILES, G) && I.default.can(b.Permissions.SEND_MESSAGES, G)),
                        ei = (0, c.default)(Y);
                    (null == ei ? void 0 : ei.newClipIds.length) !== (null == Y ? void 0 : Y.newClipIds.length) && (null !== (t = null == Y ? void 0 : Y.newClipIds.length) && void 0 !== t ? t : 0) > 0 && null == et && J && X && !Q && !$ && en("recentClips");
                    let er = (e, t, n) => {
                        null != t && "ETOOLARGE" === t.code ? (0, D.showUploadFileSizeExceededError)(G, []) : (0, D.promptToUpload)(e, G, B, {
                            requireConfirm: !0,
                            showLargeMessageDialog: n
                        }), R.ComponentDispatch.dispatchToLastSubscribed(b.ComponentActions.TEXTAREA_FOCUS)
                    };
                    ...
                    a.useEffect(() => {
                        let e = () => {
                            var e;
                            return null === (e = Z.current) || void 0 === e ? void 0 : e.activateUploadDialogue()
                        };
                        return R.ComponentDispatch.subscribe(b.ComponentActions.UPLOAD_FILE, e), () => {
                            R.ComponentDispatch.unsubscribe(b.ComponentActions.UPLOAD_FILE, e)
                        }
                    });
                    let eu = (0, _.useCanStartPublicThread)(G),
                        ed = (0, _.useCanStartPrivateThread)(G),
                        ec = !A.UseLegacyChatInput.useSetting() && !(0, y.isAndroidWeb)() && null != window.ResizeObserver,
                        ef = (0, r.useStateFromStores)([I.default, S.default], () => (0, h.canUseApplicationCommands)(I.default, S.default, W, G)),
                        eh = (0, g.useCanPostPollsInChannel)(null != G ? G : void 0),
                        eC = (0, u.useRedesignIconContext)().enabled,
                        em = null !== (l = null == q ? void 0 : q.length) && void 0 !== l ? l : 0,
                        ep = (0, j.default)({
                            canAttachFiles: el,
                            canStartThreads: eu || ed,
                            useSlate: ec,
                            hasClips: es,
                            canUseApplicationCommands: ef,
                            channel: G,
                            activities: z,
                            newClipsCount: em,
                            canPostPolls: eh
                    ...
                    let eE = z.some(e => (0, f.default)(e, b.ActivityFlags.SYNC)),
                        eg = z.some(e => (0, f.default)(e, b.ActivityFlags.JOIN) && !(0, f.default)(e, b.ActivityFlags.EMBEDDED)) || eE;
                    H = eC ? (0, s.jsx)(o.CirclePlusIcon, {
                        className: U.attachButtonIcon,
                        colorClass: U.attachButtonPlus
                    }) : eg ? (0, s.jsx)(x.default, {
                        className: U.attachButtonIcon,
                        foreground: U.attachButtonPlay,
                        background: U.attachButtonPlus,
                        width: 24,
                        height: 24
                    }) : em > 0 ? (0, s.jsx)(v.default, {
                        className: U.attachButtonIcon,
                    ...
                    let eS = (0, s.jsx)(u.Popout, {
                        shouldShow: null != et,
                        animation: u.Popout.Animation.NONE,
                        align: "recentClips" === et ? "center" : "left",
                        position: "top",
                        positionKey: null != et ? et : "null",
                        onRequestOpen: () => en("attachMenu"),
                        onRequestClose: () => {
                            !(0, u.hasAnyModalOpen)() && en(null)
                        },
                        renderPopout: e => {
                            switch (et) {
                                case "recentClips":
                    ...
                    return (0, s.jsxs)(s.Fragment, {
                        children: [(0, s.jsx)("div", {
                            ...
                            children: (0, s.jsx)(d.default, {
                                ref: Z,
                                onChange: e => {
                                    er(e.currentTarget.files, e.currentTarget.err), e.currentTarget.value = ""
                                },
        ...
        928328: function(e, t, n) {
            ...
            function M(e) {
                let {
                    ...
                    onSubmit: x,
                    onClose: R
                } = e, y = (0, d.default)(r), [D, O] = a.useState(!1), [j, b] = a.useState(v), [P, F] = a.useState(null), [U, H] = a.useState(o.shuffle(r)), [k, G] = a.useState(""), B = (0, h.useUID)(), w = (0, C.default)(j), V = (0, C.default)(D), W = (0, C.default)(P), Z = (0, C.default)(x), z = (0, C.default)(k), K = null != P && M.includes(P);
                return a.useEffect(() => {
        ...
        556118: function(e, t, n) {
            ...
            function Y(e) {
                ...
                let {
                    ...
                    handleMouseLeave: el,
                    isHovered: ei
                } = (0, R.useHoveredMessage)(P, p.author.id, J), er = (0, d.useStateFromStores)([f.default], () => f.default.keyboardModeEnabled), eo = J || er && K, eu = eo || ei, {
                    content: ed,
                    hasSpoilerEmbeds: ec
                } = (0, O.default)(p, {
            ...
            function eg(e) {
                let {
                    ...
                    let {
                        ...
                        author: c
                    } = n, f = (0, u.useStateFromStores)([D.default], () => D.default.getGuild(t.guild_id), [t.guild_id]), m = (0, u.useStateFromStores)([x.default], () => x.default.getId()), p = (0, L.useIsActiveChannelOrUnarchivableThread)(t), E = (0, L.useIsNonModInLockedThread)(t), g = v.RenderReactions.useSetting(), T = v.DeveloperMode.useSetting(), M = (0, u.useStateFromStores)([O.default], () => null == t.guild_id || O.default.canChatInGuild(t.guild_id), [t]), {
                        canManageMessages: I,
                    ...
                    let B = (0, en.canReportMessage)(n),
                        ...
                        X = (0, ed.default)(),
                        J = (0, u.useStateFromStores)([h.default], () => h.default.keyboardModeEnabled),
                        Q = (0, C.useIsClydePersonalityModified)(t.getGuildId(), n.author.isClyde());
                    return {
                        channel: t,
                        message: n,
                        canPin: w,
                    ...
                    !Q && $.default.track(ec.AnalyticEvents.MESSAGE_POPOUT_MENU_OPENED_DESKTOP, {
                        message_id: n.id,
                        channel: n.channel_id
                    }), eS({
                        moreUtilities: !Q
                    })
                }, [Q, eS, n]), eO = a.useCallback(() => {
                    eS({
                        emojiPicker: !eu
                    })
                ...
                return eb && !eP && [].push(d.DismissibleContent.BURST_REACTION_BUTTON_SPARKLE), (0, s.jsxs)(s.Fragment, {
                    children: [K ? (0, s.jsxs)(s.Fragment, {
                        ...
                        onClick: () => {
                            let e = !eR;
                            ey(e), ex(!1), e && (0, m.openClydeFeedbackModal)(n.id, eM, ex, ey)
                        }
                ...
                return L.current = n, s.useCallback(n => {
                    ...
                    switch (n.key.toLowerCase()) {
                        ...
                        case "e":
                            if (D) {
                                ;
                                if (s = H, v = U, x = F, !v.isSystemDM() && (0, _.default)(x, s)) n.preventDefault(), (0, M.editMessage)(U, F)
                            }
                            break;
                        case "p":
                            if (D || P) {
                                ;
                                if (R = U, y = F, !R.isSystemDM() && !(0, A.default)(y) && (N(R) || R.isPrivate())) n.preventDefault(), (0, M.pinMessage)(U, F, n)
                            }
                            break;
                        case "+":
                            (D || P) && function(e) {
        ...
        144553: function(e, t, n) {
            ...
            let A = a.memo(function(e) {
                ...
                let {
                    ...
                    return null
                }, [R, y, I, D, O]), b = (0, l.useStateFromStores)([f.default], () => null != R && f.default.isBlocked(R.author.id), [R]), P = (0, g.useContextMenuUser)(null == R ? void 0 : R.author.id, I.id), F = (0, g.useClickReply)(T, R, b), U = (0, g.useClickReferencedMessageAuthorUsername)(R, I, L, x), H = (0, g.useClickReferencedMessageAuthorAvatar)(v, x), k = a.useCallback(() => x({
                    referencedUsernameProfile: !1,
                    referencedAvatarProfile: !1
                }), [x]), G = (0, p.useNullableMessageAuthor)(T);

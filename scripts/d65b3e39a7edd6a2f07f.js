            ...
            class S extends a.Component {
                ...
                render() {
                    ...
                    return null != g && g.length > 0 && ("string" == typeof g[0] ? g.forEach((e, t) => R.push((0, l.jsxs)(u.Anchor, {
                        ...
                        onClick: this.handleRemoveTag.bind(this, t),
                        children: [(e.type === n.MEMBER || e.type === n.USER) && null != e.avatar && (0, l.jsx)(u.Avatar, {
                            src: e.avatar,
                            "aria-hidden": !0,
                            size: u.AvatarSizes.SIZE_16
                        }), e.type === n.ROLE && null != e.color && (0, l.jsx)("span", {
                            className: p.tagRoleColor,
                            style: {
                                backgroundColor: e.color
                            }
                        }), e.type === n.GUILD && null != e.guild && (0, l.jsx)(c.default, {
                            guild: e.guild,
                            active: !0,
                        ...
                        children: (0, l.jsx)("div", {
                            ...
                            className: o(C, p.container, f, (0, E.getThemeClass)(s), {
                                [p.disabled]: a
                            }),
        ...
        86678: function(e, t, i) {
            ...
            var eI = s.memo(s.forwardRef(function(e, t) {
                ...
                ec(eI, eG), ed(eI, e3, eF, ex), s.useEffect(() => {
                    ...
                    guild_id: eV
                }), A.EmojiPickerStore.resetStoreState), [e1, eV]), s.useEffect(() => () => (0, M.hideHotspot)(M.HotspotLocations.FAVORITE_EMOJI_TOOLTIP), []), s.useLayoutEffect(() => {
                    var e;
                    let {
                        columnIndex: t,
                        rowIndex: i
        ...
        83017: function(e, t, i) {
            ...
            let D = e => {
                let {
                    ...
                    newlyAddedEmojis: w,
                    backfillEmojis: k
                } = (0, M.default)(_, s), G = (0, E.useStateFromStoresArray)([y.default], () => y.default.getFlattenedGuildIds(), []), F = (0, E.useStateFromStoresArray)([h.default], () => h.default.getSortedPackIds(), []), {
                        ...
                        let S = Math.floor(a / (o + 2 * r)),
                            C = (l, a) => {
                                let r = new Map,
                                    ...
                                    T = g.length;
                                null != C && h === C.id && V && (g.length < C.getMaxEmojiSlots() && a.sectionId !== x.EmojiCategoryTypes.TOP_GUILD_EMOJI || g.length < 9 && a.sectionId === x.EmojiCategoryTypes.TOP_GUILD_EMOJI) && T++;
                                let N = Math.ceil(T / S),
                                    A = [];
                                for (let e = 0; e < N; e++) {
                                    let t = e * S,
                                        i = g.slice(t, t + S).map((e, t) => {
                                            ...
                                            return {
                                                ...
                                                visibleRowIndex: p,
                                                category: a.type,
                                                subCategory: a.sectionId === x.EmojiCategoryTypes.TOP_GUILD_EMOJI ? (0, j.getEmojiSubCategory)(U, w, null !== (s = null !== (i = e.id) && void 0 !== i ? i : e.uniqueName) && void 0 !== s ? s : e.name) : x.EmojiSubCategory.NONE
                                            }
                                        });
                                    if (A.push(i), !c) {
                            ...
                            for (let e of c)
                                if (e === x.EmojiCategories.CUSTOM) {
                                    let i = i => {
                                            let n = J[i];
                                            if (null == n) return;
                                            let l = n.filter(e => v.default.getEmojiUnavailableReason({
                                                emoji: e,
                                                channel: t,
                                                intention: s,
                                                canViewAndUsePackEmoji: H
                ...
                }, [S, a, o, r, l, i, t, s, c, m, J, G, F, H, w, U, k, b, D, V])
            };
            ...
            let b = e => {
                    ...
                    return u.useCallback((e, u) => {
                        switch (e.type) {
                            case n.CREATE_EMOJI:
                                s(void 0, u.isFinalSelection, u.isBurst);
                                return;
                            case n.EMOJI: {
                                let {
                                    emoji: n
                                ...
                                if (u.toggleFavorite) {
                                    c.isFavoriteEmojiWithoutFetchingLatest(n) || null != f ? (0, m.unfavoriteEmoji)(n) : (null == o || o(e), (0, m.favoriteEmoji)(n));
                                    return
                                }
                                ...
                                if (f === P.EmojiDisabledReasons.ROLE_SUBSCRIPTION_LOCKED && n.type === p.EmojiTypes.GUILD) {
                                    a({
                                        type: l.ROLE_SUBSCRIPTION,
                                        guildId: n.guildId,
                                        emojiId: n.id
                                    });
                                    return
                                ...
                                null == r || r(e), s(n, u.isFinalSelection, u.isBurst)
                            }
                        }
                    }, [i, t, d, s, a, c, r, o])
                },

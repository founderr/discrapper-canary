...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [31066, 71402, 42643], {
        ...
        971402: (e, n, t) => {
            ...
            function f(e, n, t, r) {
                ...
                if (null == e.currentTarget.contains || e.currentTarget.contains(e.target)) {
                    ...
                    if (0 === f && 0 === E) {
                        var p, I = null === (p = e.target) || void 0 === p ? void 0 : p.getBoundingClientRect(),
                            O = null != I ? I : {},
                            S = O.left,
                            T = void 0 === S ? 0 : S,
                            d = O.top,
                    ...
                    if ((null == t ? void 0 : t.enableSpellCheck) && (0, i.nI)()) var A = (0, a.RD)((function() {
                        A();
                        s(y)
                    }));
                    else {
                    ...
                    return E(this, (function(E) {
                        switch (E.label) {
                            ...
                            case 1:
                                ...
                                p = {};
                                null != n && (p.country_code = n);
                                null != t && (p.payment_source_id = t);
        ...
        248046: (e, n, t) => {
            ...
            function A(e) {
                ...
                if (null != t.permissions && t.permissions.length > 0)
                    ...
                    } var u, l, f, E = (null != i ? i : []).map((function(e) {
                        return e.name
                    })),
                    p = (null != i ? i : []).map((function(e) {
                        return e.displayName
                    }));
                return {
                    version: t.version,
                    guildId: t.guild_id,
                    id: [t.id].concat(y(E)).join(S.oQ),
                    name: [t.name].concat(y(E)).join(" "),
                    ...
                    permissions: n,
                    displayName: [null !== (l = t.name_localized) && void 0 !== l ? l : t.name].concat(y(p)).join(" "),
            ...
            function b(e) {
                return null == e ? void 0 : e.map((function(e) {
                    ...
                    return e.type === s.jw.CHANNEL && "channel_types" in e ? C(h({}, o), {
                        channelTypes: e.channel_types
                    }) : e.type !== s.jw.NUMBER && e.type !== s.jw.INTEGER || !("min_value" in e) && !("max_value" in e) ? e.type === s.jw.STRING && ("min_length" in e || "max_length" in e) ? C(h({}, o), {
                ...
                for (var f = t.options.filter((function(e) {
                    ...
                    a.push(A({
                        ...
                        subCommandPath: (null != o ? o : []).concat([{
                            ...
                            displayName: null !== (p = f[E].name_localized) && void 0 !== p ? p : f[E].name
                        }]),
                        useKeyedPermissions: i
                    }))
                }
                0 === u.length && 0 === f.length && a.push(A({
                    rootCommand: n,
                    command: t,
                    applicationId: r,
                    subCommandPath: o,
            ...
            function D(e, n, t, r) {
                return !!U(I.Z, f.Z, !1, e) && (e.isPrivate() && t > 0 || (null !== (o = null == r ? void 0 : r[n]) && void 0 !== o ? o : 0) > 0);
                var o
            }
            var U = function(e, n, t, r) {
                    return !t && (r.isMultiUserDM() ? n.getIntegrations(r.id).length > 0 : r.isDM() ? !r.isSystemDM() && (null != r.rawRecipients.find((function(e) {
                        return e.bot
                    })) || n.getIntegrations(r.id).length > 0) : !r.isArchivedLockedThread() && (!!(0, E.Em)(r.type) && e.can(c.Z.combine(d.Pl.USE_APPLICATION_COMMANDS, d.Pl.SEND_MESSAGES), r)))
                },
                w = c.Z.deserialize(0);
            ...
            function G(e, n, t) {
                var r = t[(0, _.rE)(e.userId, O.Kw.USER)];
                ...
                if (o) return !1;
                var E = t[(0, _.rE)(n, O.Kw.ROLE)];
                return null != E ? E.permission : null
            }

            function x(e) {
                switch (e) {
                    case O.bB.CHAT:
                        return p.d.ChannelMessage;
                    case O.bB.APPLICATION_LAUNCHER:
                        return p.d.ApplicationLauncherCommand
                }
            }

            function H(e) {
                if (null != e) return e.id === S.bi.BUILT_IN ? O.ub.BUILT_IN : e.id === S.bi.FRECENCY ? O.ub.FRECENCY : O.ub.APP
            }
        ...
        165586: (e, n, t) => {
            ...
            var O = [I(r.RESOLUTION_720), I(r.RESOLUTION_1080), I(r.RESOLUTION_1440), I(r.RESOLUTION_SOURCE, (function() {
                    return c.Z.Messages.SCREENSHARE_SOURCE
                }))],
                S = [I(r.RESOLUTION_720), I(r.RESOLUTION_1080), I(r.RESOLUTION_1440)],
                T = function(e) {
                    return "".concat(e, "p")
                },
                d = [I(r.RESOLUTION_480, (function() {
        ...
        948832: (e, n, t) => {
            ...
            var O = new Map,
                ...
                R = function(e) {
                    ...
                    r.getIntegrations = function(e) {
                        var n;
                        return null !== (n = O.get(e)) && void 0 !== n ? n : N
                    };
                    r.getIntegration = function(e, n) {
                        var t;
                        return null === (t = O.get(e)) || void 0 === t ? void 0 : t.find((function(e) {
                    ...
                    r.getIntegrationsFetchState = function(e) {
                        var n;
                        return null !== (n = S.get(e)) && void 0 !== n ? n : E.NOT_FETCHED
                    };
            ...
            var C = new R(o.Z, {
                ...
                CHANNEL_SELECT: function(e) {
                    var n = e.channelId;
                    if (null == n || S.get(n) !== E.FETCH_FAILED) return !1;
                    S.set(n, E.NOT_FETCHED)
                },
                ...
                FETCH_PRIVATE_CHANNEL_INTEGRATIONS_FAIL: function(e) {
                    var n = e.channelId;
                    S.set(n, E.FETCH_FAILED)
                },
                PRIVATE_CHANNEL_INTEGRATION_CREATE: function(e) {
                    var n = e.integration,
                        t = O.get(n.channel_id);
                    if (null == t) return !1;
                    O.set(n.channel_id, h(f(t).concat([(0, a.F)(n)])))
                },
                ...
                PRIVATE_CHANNEL_INTEGRATION_DELETE: function(e) {
                    var n = e.channelId,
                        ...
                        r = O.get(n);
                    if (null == r) return !1;
                    O.set(n, r.filter((function(e) {
                        return e.application.id !== t
                    })))
                },
                CHANNEL_DELETE: function(e) {
                    var n = e.channel;
                    return O.delete(n.id)
                }
            });
            const y = C
        },
        223219: (e, n, t) => {
            ...
            var G = function(e) {
                ...
                r.hasChanges = function() {
                    return null != A && null != y && (!(!this.isOpen() && P !== l.cII.USER_SETTINGS) && !o().isEqual(A, y))
                };
                r.isOpen = function() {
                    return b
                };
        ...
        73105: (e, n, t) => {
            ...
            var y = function() {
                    function e(n) {
                        ...
                        this.languageDetector = new E(o, (function(e) {
                            var r = "".concat(e, "-").concat(t.regionPreference);
                            if (-1 !== n.indexOf(r)) t.setLocale(r);
                            else {
                                var i, u = null !== (i = a[e]) && void 0 !== i ? i : p[o];

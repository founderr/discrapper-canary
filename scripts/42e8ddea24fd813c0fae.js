    ...
    [31203, 3039], {
        ...
        803039: (e, t, r) => {
                ...
                n.useEffect((function() {
                    ...
                    null != t && d.isReady && !b && (e = e.map((function(r, a) {
                        return setTimeout((function() {
                            a === e.length - 1 && v(!0);
                            d.createMultipleConfetti(I(t.getBoundingClientRect()), 50)
                        }), 100 * a)
                    })));
                    return function() {
                        var t = !0,
            ...
            function F(e, t) {
                if (e) {
                    ...
                    var r = Object.prototype.toString.call(e).slice(8, -1);
                    "Object" === r && e.constructor && (r = e.constructor.name);
                    return "Map" === r || "Set" === r ? Array.from(r) : "Arguments" === r || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r) ? k(e, t) : void 0
                }
            }
            var _ = function(e) {
                var t, r = e.product,
                    ...
                    L = null !== (t = r.items.find(h.M)) && void 0 !== t ? t : null,
                    k = (0, y.Z)({
                        user: M,
        ...
        940594: (e, t, r) => {
            ...
            var a = r(795308),
                ...
                u = function(e) {
                    var t = (0, n.J2)((0, o.dX)(e[0]), (0, o.dX)(e[1]), .5),
                        r = new l.Z(t[0], t[1], t[2], 1).toHSL();
                    return {
                        background: "linear-gradient(to right, ".concat(e.join(", "), ")"),
                        color: r.lightness > .66 ? a.Z.unsafe_rawColors.BLACK_500.css : a.Z.unsafe_rawColors.WHITE_500.css
                    }
                }
        },
        584228: (e, t, r) => {
            ...
            const i = function(e) {
                ...
                switch (e.skuId) {
                    ...
                    case a.T.BREAKFAST:
                        return {
                            backgroundColors: ["#E8B26B", "#7A3A00"], buttonColors: ["#FFC355", "#FF9537"],
                                confettiSprites: [r(297206), r(578862)], confettiColors: ["#DD9C98", "#FFC037", "#FF6B00", "#FDE081", "#DD923E", "#FFEECC"]
                        };
                    case a.T.DISXCORE:
                        return {
                            backgroundColors: ["#732565", "#111D40"], buttonColors: [n.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE_FOR_GRADIENTS.css, n.Z.unsafe_rawColors.PREMIUM_TIER_2_PURPLE_FOR_GRADIENTS_2.css], confettiSprites: o, confettiColors: ["#F53273", "#9595FF", "#A7FA4E", "#331EAF"]
                        };
                    default:
                        return t
                }
            ...
            var g = r(882723),
                ...
                w = function(e) {
                    var t = e.step,
                        r = e.onClose,
                        n = (0, A.Z)(O.X);
                    return t === u.h8.CONFIRM || t === u.h8.BENEFITS ? (0, a.jsx)("div", {}) : (0, a.jsxs)("div", {

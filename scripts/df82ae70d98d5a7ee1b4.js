...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [52171], {
        ...
        661098: (e, n, t) => {
            ...
            var Y = function(e) {
                ...
                o.query = function(e, n, t) {
                    ...
                    var u, c = b.Z.getGuild(e.guild_id),
                        s = g.Z.can(x.Plq.USE_APPLICATION_COMMANDS, e),
                        d = y.xM.getSetting(),
                    ...
                    w.default.track(x.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
                        miss: null == i,
            ...
            Y.displayName = "ApplicationCommandIndexStore";
            var J = new Y(d.Z, {
                LOGOUT: Q,
                CONNECTION_OPEN: Q,
                ...
                return o.useMemo((function() {
                    ...
                    var t = {
                        ...
                        o = a.filter((function(e) {
                            ...
                            var r = _.ZP.getScoreWithoutLoadingLatest(t, e);
                            return _.ZP.getScoreWithoutLoadingLatest(t, n) - r
                        })).splice(0, j.hz);
                    return 0 === o.length ? {
                        descriptors: l,
                        commands: a,
            ...
            function ne(e, n, t, i) {
                var l, a = (0, s.cj)([O.default], (function() {
                    ...
                    d = (0, s.e7)([g.Z], (function() {
                        return g.Z.can(x.Plq.USE_APPLICATION_COMMANDS, e)
                    })),
            ...
            function te(e) {
                var n, t, r = e.context,
                    ...
                    C = r.channel.guild_id,
                    T = null != a,
                    E = T ? Object.keys(a) : i,
                    P = r.channel.isThread() ? r.channel.parent_id : r.channel.id;
                l()(null != P, "permissions channel id is null");
                var L, D, M = g.Z.computePermissions(r.channel, void 0, a),
                    U = null != C && !c.Z.has(M, x.Plq.ADMINISTRATOR),
                    k = (0, S.Kh)(s, !0, p),
                    B = k.length > 0 ? [{
                        descriptor: S.Tm[j.bi.BUILT_IN],
                        commands: k
                    }] : [],
                    F = m ? [] : H(null !== (L = null == b || null === (n = b.result) || void 0 === n ? void 0 : n.sections) && void 0 !== L ? L : []).concat(H(null !== (D = null == O || null === (t = O.result) || void 0 === t ? void 0 : t.sections) && void 0 !== D ? D : []));
                F.sort((function(e, n) {
                    return e.descriptor.name.localeCompare(n.descriptor.name)
                }));
                var G, K = H(F).concat(H(B));
                G = r.channel.isPrivate() ? r.channel.type === x.d4z.DM ? f.u_.BOT_DM : f.u_.PRIVATE_CHANNEL : f.u_.GUILD;
                var z, V = [],
                    W = !0,
                    Q = !1,
                    q = void 0;
                try {
                    for (var X, Y = K[Symbol.iterator](); !(W = (X = Y.next()).done); W = !0) {
                        var J = X.value;
                            ...
                            try {
                                for (var le, ce = J.commands[Symbol.iterator](); !(re = (le = ce.next()).done); re = !0) {
                                    ...
                                    if (!(se.type !== s || se.nsfw && !y || null != se.predicate && !se.predicate(r) || null != se.contexts && !se.contexts.includes(G))) {
                                        ...
                                        var pe = void 0;
                                        if (null != w && null != A) {
                                            if (0 === (pe = (0, I.wm)(w, A, se, J.descriptor))) continue
                                        } else pe = 1;
                                        te.push(Z(R({}, se), {
                                            score: pe
                                        }))
                ...
                if (h) {
                    ...
                    z.sort((function(e, n) {
                        ...
                        var t = _.ZP.getScoreWithoutLoadingLatest(r, e),
                            o = _.ZP.getScoreWithoutLoadingLatest(r, n);
            ...
            function ae(e, n, t) {
                var r = e[(0, m.rE)(n, T.Kw.CHANNEL)];
                if (null != r) return r.permission;
                var o = e[(0, m.rE)((0, N.bD)(t), T.Kw.CHANNEL)];
            ...
            function ue(e, n, t, r, o) {
                ...
                try {
                    for (var s, d = t[Symbol.iterator](); !(a = (s = d.next()).done); a = !0) {
                        var f = s.value,
                            p = e[(0, m.rE)(f, T.Kw.ROLE)];
                        if (null != p) {
                            if (p.permission) return !0;
                            l = !0
                        }
                        if (l) return !1;
                        var y = e[(0, m.rE)(r, T.Kw.ROLE)];
            ...
            function b(e, n, t) {
                ...
                return r.useMemo((function() {
                    ...
                    if (A) {
                        ...
                        if (null != t) t.data = y(T).concat(y(t.data));
                        else {
        ...
        242922: (e, n, t) => {
            ...
            function g(e) {
                var n, t = e.section,
                    ...
                    S = e.onMouseOver,
                    C = e.onMouseLeave,
                    _ = h(e, ["section", "isSelected", "width", "height", "className", "selectable", "onFocus", "onBlur", "onMouseOver", "onMouseLeave"]),
                    I = b(i.useState(!1), 2),
                    T = I[0],
                    E = I[1],
                ...
                return (0, o.jsx)("div", v(function(e) {
                    ...
                    children: (0, o.jsx)(u.ZP, {
                        className: d().mask,
                        mask: O && (l || T) ? u.QS.SQUIRCLE : u.QS.AVATAR_DEFAULT,
                        width: s,
                        height: f,
            ...
            function E(e) {
                var n, t = e.section,
                    ...
                    s = e.selectable,
                    d = void 0 !== s && s,
                    f = T(e, ["section", "className", "width", "height", "padding", "isSelected", "selectable"]),
                    m = function(e) {
                        switch (e.id) {
                            case A.bi.BUILT_IN:
                                return O.Z;
                ...
                return (0, o.jsx)("div", {
                    className: a()(C().wrapper, r, (n = {}, _(n, C().selectable, d), _(n, C().selected, d && c), n)),
                    style: {
                        width: i,
                        height: l,
                        padding: null != u ? u : 0
                    },
                    children: null != m ? (0, o.jsx)(m, I({
                        className: C().icon,
                        width: i,
                        height: l
                    }, f)) : null
            ...
            t(2590).UF9.DAY;
            var P = function(e) {
                return e.type === r.Qi.BUILT_IN ? E : g
            };

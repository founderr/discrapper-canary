(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [24285, 29202, 91683, 58635, 84832, 88110, 86502, 96043, 71402], {
        737264: e => {
            "use strict";
            ...
            function w(e) {
                ...
                if (!y.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== m.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        u = l.Z.getChannel(o),
                        a = M(u, i),
                        c = N({}, t, A(a), null != i && null != o && (0, S.AB)(o) ? R(0, o) : L(u));
                    y.default.track(e, c, {
                        flush: n
                    })
                }
                ...
                open: function() {
                    (0,
                        ...
                        return l(this, (function(i) {
                            switch (i.label) {
                                case 0:
                                    return [4, Promise.all([n.e(40532), n.e(85157), n.e(47405), n.e(89975), n.e(27499), n.e(3790), n.e(88110), n.e(96043), n.e(67147)]).then(n.bind(n, 834883))];
                                case 1:
        ...
        980604: (e, t, n) => {
            ...
            function Q() {
                x = T.Z.getGuildCount() >= 3 || i().size(s.Z.getMutablePrivateChannels()) >= 20;
                q = []
            }
            ...
            function J() {
                ...
                if (null != n) {
                    var g = y.ZP.getSelectableChannelIds(n).filter((function(e) {
                        var t = s.Z.getChannel(e);
                        return !(null == t || e === r || z.includes(e) || P.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && P.Z.isChannelMuted(t.guild_id, t.parent_id)) && S.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return X(e)
                    })).filter((function(e) {
                        return e
            ...
            function $(e, t) {
                switch (B) {
                    case l.h8.USER:
                        var n = T.Z.getGuild(N.Z.getGuildId());
                ...
                if (t !== W) {
                    W = t;
                    K = Math.max(t.length, K);
                    F = (0, l.gJ)(l.a8.DOWN, -1, Y)
                } else {
                    var r = Y[F];
                    null != r && r.type === l.h8.HEADER && (F = (0, l.gJ)(l.a8.DOWN, F, Y))
                }
                ie.emitChange()
            }
            ...
            function ee(e) {
                ...
                H = null != H ? H : new l.ZP(te, null, null != r ? 100 : 5, {
                    frecencyBoosters: !0,
                    blacklist: o
                });
                W = null;
            ...
            var ie = new re(a.Z, {
                ...
                QUICKSWITCHER_SEARCH: function(e) {
                    ...
                    if (B !== r) {
                        H.setResultTypes(null != r ? [r] : null);
                    ...
                    B = r;
                    H.search(n, B === l.h8.USER ? i : void 0)
                },
        ...
        796909: (e, t, n) => {
            ...
            function R(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : A(e);
                return {
                    channelId: e.id,
                    lastMessageId: t,
            ...
            function C() {
                ...
                (0, l.cn)() && (0, c.x7)() && h.Z.getAddedToMessages().forEach((function(e) {
                    ...
                    null != t && (0, d.zi)(t.type) && P.set(t.id, R(t))
                }))
            }

            function L() {
                var e = _.Z.getMutablePrivateChannels();
                for (var t in e) P.set(t, R(e[t]))
            }
            var U, M, w, D = (U = [], M = [], w = [], function() {
                    var e = P.values(S.FAVORITE),
                        t = P.values(S.DEFAULT);
                    if (U !== e || M !== t) {
                        w = [];
                ...
                j = function(e) {
                    ...
                    r.getSortedChannels = function() {
                        return [P.values(S.FAVORITE), P.values(S.DEFAULT)]
                    };
            ...
            const G = new j(a.Z, {
                ...
                CHANNEL_UPDATES: function(e) {
                    e.channels.forEach((function(e) {
                        ((0, d.hv)(e.type) || P.has(e.id)) && P.set(e.id, R(e))
                    }))
                },
            ...
            var v = function(e, t) {
                ...
                y = function(e) {
                    var t = e.omitUserIds,
                        ...
                        I = void 0;
                    try {
                        for (var y, g = f.Z.getPrivateChannelIds()[Symbol.iterator](); !(h = (y = g.next()).done); h = !0) {
                            var T = y.value;
                            if (null != n && n > 0 && a.length >= n) break;
                            if (null != p && E >= p) break;
                            var m = u.Z.getChannel(T);

            ...
            var s = a("37983"),
                ...
                l = r.memo(function(e) {
                    ...
                    return (0, s.jsx)(n.Avatar, {
                        src: (t = d, a = (0, n.getAvatarSize)(u), l = c, o = E, t.getAvatarURL(o, a, l)),
                        size: u,
                    ...
                    return ! function(e) {
                        ...
                        let l = null !== (t = null == i ? void 0 : i.guild_id) && void 0 !== t ? t : f.default.getGuildId(),
                            ...
                            N = (0, R.expandEventProperties)({
                                ...
                                ...(0, E.collectChannelAnalyticsMetadata)(u.default.getChannel(d)),
                                ...i
                            });
                        if (s) {
                        ...
                        null != r && null != n && ((0, R.debugLogEvent)(r, N), T(r, N)), (0, _.setDebugTrackedData)(r, N)
                    }(N, t.disableTrack), () => {

    ...
    ["5654"], {
        ...
        649844: function(e, t, n) {
            ...
            function p(e) {
                let {
                    ...
                    giftRecipient: P,
                    returnRef: M
                } = null != e ? e : {}, L = !1, b = (0, r.v4)(), w = s.default.getCurrentUser(), F = (0, E.isPremiumExactly)(w, _.PremiumTypes.TIER_2);
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            followupSKUInfo: p,
                            onClose: (e, t) => {
                                r(), null == T || T(e), e && (null == h || h(), !C && null != t && t === _.PremiumSubscriptionSKUs.TIER_2 && !F && c.ComponentDispatch.dispatch(f.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED))
                            },
                            onComplete: () => {
                                L = !0, null == S || S(), !C && (0, u.setCanPlayWowMoment)(!0)
                            },
                            onSubscriptionConfirmation: h,
                            analyticsLocations: I,
                            analyticsObject: A,
                    ...
                    onCloseCallback: () => {
                        !L && d.default.track(f.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            load_id: b,
                            ...
                            application_id: y,
                            location_stack: I
                        }), (0, o.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == T || T(L), L && (null == h || h())
                    },
        ...
        497296: function(e, t, n) {
            ...
            function f(e) {
                ...
                }), h = S === u.PremiumTypes.TIER_0 ? u.PremiumSubscriptionSKUs.TIER_0 : u.PremiumSubscriptionSKUs.TIER_2, I = h === u.PremiumSubscriptionSKUs.TIER_0 ? d.default.Messages.VIDEO_BACKGROUND_UPSELL_BODY_TIER_0.format({
                    onLearnMore: p

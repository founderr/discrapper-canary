        ...
        752598: function(e, t, n) {
            ...
            let S = (e, t) => {
                ...
                let u = e.state === h.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : r.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    c = e.isCommandType();
                if (s && l === _.InteractionState.QUEUED || c && e.state === h.MessageStates.SENDING && null != t) return i.SENDING;
                if (s && l === _.InteractionState.CREATED || e.hasFlag(h.MessageFlags.LOADING) && !a) return i.CREATED;
                if (null != e.interaction && e.hasFlag(h.MessageFlags.LOADING) && a) return i.TIMED_OUT;
                else if (null != e.interaction && !e.hasFlag(h.MessageFlags.LOADING) && u) return i.TIMED_OUT;
                else if (c && e.state === h.MessageStates.SEND_FAILED) return i.FAILED
            };

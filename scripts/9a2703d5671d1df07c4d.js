    ...
    ["63236"], {
        ...
        846883: function(e, t, n) {
            ...
            function w(e, t) {
                ...
                } = (0, o.default)(), X = (0, i.useStateFromStores)([g.default], () => g.default.getCurrentUser()), k = (0, i.useStateFromStores)([F.default], () => F.default.getSelfEmbeddedActivities()), z = (0, i.useStateFromStoresArray)([m.default], () => m.default.getActivities().filter(e => null != e.application_id && !(null == k ? void 0 : k.has(e.application_id)))), K = (0, i.useStateFromStoresArray)([v.default], () => null != t ? v.default.getActivities(t.id, null == e ? void 0 : e.getGuildId()) : [], [t, e]), B = (0, i.useStateFromStoresArray)([F.default], () => {
                ...
                }, [t, e]), W = (0, j.default)(), Q = (0, i.useStateFromStores)([N.default], () => null == e || e.isPrivate() || N.default.can(D.Permissions.SEND_MESSAGES, e), [e]), q = (0, i.useStateFromStoresArray)([M.default], () => [...K.map(e => null != e.application_id && M.default.getState(e.application_id, D.ActivityActionTypes.JOIN) === D.ActivityActionStates.LOADING), ...B.map(e => M.default.getState(e.application_id, D.ActivityActionTypes.JOIN) === D.ActivityActionStates.LOADING)], [K, B]), Z = (0, r.default)([...K.filter(e => (null == e ? void 0 : e.application_id) != null).map(e => e.application_id), ...B.map(e => e.application_id)]), $ = null == e ? void 0 : e.id, ee = (0, i.useStateFromStoresArray)([T.default, y.default, S.default, C.default, h.default, O.default, N.default], () => [...K.map(e => (0, R.default)({
                    user: null != t ? t : X,
                    activity: e,
                ...
                let ea = (n, a) => {
                        null != e ? u.default.sendActivityInvite({
                            ...
                            channelId: e.id,
                            activity: a,
                            location: D.AnalyticsLocations.CONTEXT_MENU
                    ...
                    ei = (i, u) => {
                        let d = T.default.getChannel(i),
                            s = null == d ? void 0 : y.default.getGuild(d.guild_id);
                        if (null != d && null != s) {
                            if (null != t) return b.sendEmbeddedActivityInviteUser({
                                channelId: d.id,
                                applicationId: u,
                                userId: t.id,
                                location: D.InstantInviteSources.CONTEXT_MENU
                            });
                            if (null != e && e.type === D.ChannelTypes.GUILD_VOICE) return (0, l.openModalLazy)(async () => {
                                let {
                                    default: t
                                ...
                                return n => (0, a.jsx)(t, {
                                    ...
                                    channel: d,
                                    applicationId: u,
                                    analyticsLocation: e.type === D.ChannelTypes.GUILD_VOICE ? D.AnalyticsPages.GUILD_CHANNEL : D.AnalyticsPages.DM_CHANNEL,
                ...
                return null == k || k.forEach(n => {
                    let i = (null == t ? void 0 : t.id) != null && n.connections.has(null == t ? void 0 : t.id),
                        u = N.default.can(D.Permissions.CREATE_INSTANT_INVITE, e);
                    ...
                    e.type === D.ActivityTypes.PLAYING && (0, x.default)(e, D.ActivityFlags.JOIN) ? ed.push((0, a.jsx)(l.MenuItem, {
                        id: "invite-to-join",
                        label: J.default.Messages.USER_ACTIVITY_ACTION_INVITE_TO_JOIN,
                        subtext: e.name,
                        action: () => ea(D.ActivityActionTypes.JOIN, e)
                    }, "self".concat(t))) : e.type === D.ActivityTypes.LISTENING && (0, x.default)(e, D.ActivityFlags.SYNC) && ed.push((0, a.jsx)(l.MenuItem, {
                        id: "invite-to-listen",
                        label: J.default.Messages.USER_ACTIVITY_ACTION_INVITE_TO_LISTEN_ALONG,
                        subtext: e.name,
                        action: () => ea(D.ActivityActionTypes.LISTEN, e)
                    }, "self".concat(t)))
                }), ed.length > 0 && ed.push((0, a.jsx)(l.MenuSeparator, {})), K.forEach((n, i) => {
                    if (n.type === D.ActivityTypes.PLAYING && (0, x.default)(n, D.ActivityFlags.JOIN) && null != n.session_id && null != n.application_id) {
                        if (ee[i]) {
                            let e = q[i];
                            ...
                            subtext: n.name,
                            action: () => ea(D.ActivityActionTypes.JOIN_REQUEST, n)
                        }, i))
                    } else if (n.type === D.ActivityTypes.LISTENING && (0, x.default)(n, D.ActivityFlags.SYNC) && null != et[i]) {
                        let u = et[i],
                            {
                                notPlayable: d,
                                playingSameTrack: s,
                        ...
                        ed.push((0, a.jsx)(l.MenuItem, {
                            ...
                            action: () => (0, A.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_PLAY),
                            label: (0, f.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_PLAY),
                            subtext: _ ? (0, I.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_PLAY, null != e ? L.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: _
                        }, "spotify-play-".concat(n.session_id)), (0, a.jsx)(l.MenuItem, {
                            id: "spotify-sync-".concat(n.session_id),
                            action: () => (0, p.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_SYNC),
                            label: J.default.Messages.USER_ACTIVITY_LISTEN_ALONG,
                            subtext: E ? (0, I.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_SYNC, null != e ? L.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: E
        ...
        972701: function(e, t, n) {
            ...
            function I(e) {
                let t = (0, i.useStateFromStores)([u.default], () => u.default.getChannels(r.FAVORITES))[r.ChannelTypes.GUILD_CATEGORY].filter(e => "null" !== e.channel.id),
                    ...
                    c = (0, i.useStateFromStores)([d.default], () => d.default.isFavorite(e.id));
            ...
            function _(e) {
                let t = (0, i.useStateFromStores)([d.default], () => d.default.isFavorite(e.id));
                return __OVERLAY__ || !t ? null : (0, a.jsx)(l.MenuItem, {
                    id: "favorite-channel",
                    label: f(e, !0),
                    color: "danger",
                    action: () => e.type === r.ChannelTypes.GUILD_CATEGORY ? (0, l.openModalLazy)(async () => {
                        let {
                            default: t

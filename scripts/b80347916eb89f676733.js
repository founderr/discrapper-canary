/*! For license information please see b80347916eb89f676733.js.LICENSE.txt */
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [28e3], {
        877522: function(t, e, n) {
            t = n.nmd(t);
            var r;
            (function() {
                var o = n.amdO,
                    ...
                    s = i[typeof e] && e && !e.nodeType && e,
                    a = i[typeof window] && window || this,
                    c = s && i.object && t && !t.nodeType && "object" == typeof n.g && n.g;
                !c || c.global !== c && c.window !== c && c.self !== c || (a = c);

                function l(t, e) {
                    t || (t = a.Object());
                    e || (e = a.Object());
                    var n = t.Number || a.Number,
                        r = t.String || a.String,
                        o = t.Object || a.Object,
                        s = t.Date || a.Date,
                        c = t.SyntaxError || a.SyntaxError,
                    ...
                    function b(t) {
                        if (null != b[t]) return b[t];
                        var o;
                        if ("bug-string-char-index" == t) o = "a" != "a" [0];
                        else if ("json" == t) o = b("json-stringify") && b("date-serialization") && b("json-parse");
                        else if ("date-serialization" == t) {
                            if (o = b("json-stringify") && y) {
                                var i = e.stringify;
                                v((function() {
                            ...
                            if ("json-stringify" == t) {
                                var l = "function" == typeof(i = e.stringify);
                                if (l) {
                                    (a = function() {
                                        return 1
                                    }).toJSON = a;
                                    v((function() {
                                        l = "0" === i(0) && "0" === i(new n) && '""' == i(new r) && i(m) === p && i(p) === p && i() === p && "1" === i(a) && "[1]" == i([a]) && "[null]" == i([p]) && "null" == i(null) && "[null,null,null]" == i([p, m, null]) && i({
                                            a: [a, !0, !1, null, "\0\b\n\f\r\t"]
                                        }) == c && "1" === i(null, a) && "[\n 1,\n 2\n]" == i([1, 2], null, 1)
                                    }), (function() {
                                        l = !1
                            ...
                            if ("json-parse" == t) {
                                var u, h = e.parse;
                                "function" == typeof h && v((function() {
                                    if (0 === h("0") && !h(!1)) {
                                        a = h(c);
                                        if (u = 5 == a.a.length && 1 === a.a[0]) {
                                            v((function() {
                                                u = !h('"\t"')
                                            }));
                                            u && v((function() {
                    ...
                    if (!b("json")) {
                        var w = "[object Function]",
                            ...
                            T = function(t, e) {
                                ...
                                r = new n;
                                for (o in r) g.call(r, o) && s++;
                                n = r = null;
                                if (s) T = function(t, e) {
                                    var n, r, o = m.call(t) == w;
                                    for (n in t) o && "prototype" == n || !g.call(t, n) || (r = "constructor" === n) || e(n);
                                    (r || g.call(t, n = "constructor")) && e(n)
                                };
                                else {
                                    r = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"];
                                    T = function(t, e) {
                                        var n, o, s = m.call(t) == w,
                                            a = !s && "function" != typeof t.constructor && i[typeof t.hasOwnProperty] && t.hasOwnProperty || g;
                                ...
                                j = function(t) {
                                    ...
                                    if (y) e = function(t) {
                                        ...
                                        var u = h.floor,
                                            ...
                                            p = function(t, e) {
                                                return f[e] + 365 * (t - 1970) + u((t - 1969 + (e = +(e > 1))) / 4) - u((t - 1901 + e) / 100) + u((t - 1601 + e) / 400)
                                            };
                                        e = function(t) {
                                            o = u(t / 864e5);
                                            for (n = u(o / 365.2425) + 1970 - 1; p(n + 1, 0) <= o; n++);
                                            for (r = u((o - p(n, 0)) / 30.42); p(n, r + 1) <= o; r++);
                                            o = 1 + o - p(n, r);
                                            s = u((i = (t % 864e5 + 864e5) % 864e5) / 36e5) % 24;
                                            a = u(i / 6e4) % 60;
                                            c = u(i / 1e3) % 60;
                                            l = i % 1e3
                                        }
                                    ...
                                    j = function(t) {
                                        if (t > -1 / 0 && t < 1 / 0) {
                                            e(t);
                                            t = (n <= 0 || n >= 1e4 ? (n < 0 ? "-" : "+") + O(6, n < 0 ? -n : n) : O(4, n)) + "-" + O(2, r + 1) + "-" + O(2, o) + "T" + O(2, s) + ":" + O(2, a) + ":" + O(2, c) + "." + O(3, l) + "Z";
                                            n = r = o = s = a = c = l = null
                                        } else t = null;
                                        return t
                                    };
                            ...
                            if (b("json-stringify") && !b("date-serialization")) {
                                ...
                                var I = function(t) {
                                        var e = t.charCodeAt(0),
                                            n = C[e];
                                        return n || "\\u00" + O(2, e.toString(16))
                                    },
                                    k = /[\x00-\x1f\x22\x5c]/g,
                                    R = function(t) {
                                        k.lastIndex = 0;
                                        return '"' + (k.test(t) ? t.replace(k, I) : t) + '"'
                                    },
                                    U = function(t, e, n, r, o, i, a) {
                                        var c, l, h, f, d, g, y, b, w;
                                        v((function() {
                                            c = e[t]
                                        }));
                                        "object" == typeof c && c && (c.getUTCFullYear && "[object Date]" == m.call(c) && c.toJSON === s.prototype.toJSON ? c = j(c) : "function" == typeof c.toJSON && (c = c.toJSON(t)));
                                        n && (c = n.call(e, t, c));
                                        if (c == p) return c === p ? c : "null";
                                        "object" == (l = typeof c) && (h = m.call(c));
                                        switch (h || l) {
                                            case "boolean":
                                            case "[object Boolean]":
                                                return "" + c;
                                ...
                                e.stringify = function(t, e, n) {
                                    ...
                                    if (i[typeof e] && e)
                                        ...
                                        s = {};
                                        for (var c, l = 0, u = e.length; l < u;) {
                                            c = e[l++];
                                            "[object String]" != (a = m.call(c)) && "[object Number]" != a || (s[c] = 1)
                                        }
                                    }
                                    if (n)
                                        if ((a = m.call(n)) == x) {
                                        ...
                                        } else a == _ && (r = n.length <= 10 ? n : n.slice(0, 10));
                                    return U("", ((c = {})[""] = t, c), o, s, r, "", [])
                                }
                            }
                        }
                        if (!b("json-parse")) {
                            var P, L, M = r.fromCharCode,
                                D = {
                                    92: "\\",
                                    34: '"',
                                    47: "/",
                                ...
                                q = function() {
                                    for (var t, e, n, r, o, i = L, s = i.length; P < s;) switch (o = i.charCodeAt(P)) {
                                        case 9:
                                        case 10:
                                        case 13:
                                        case 32:
                                        ...
                                        case 34:
                                            for (t = "@", P++; P < s;)
                                                if ((o = i.charCodeAt(P)) < 32) W();
                                                else if (92 == o) switch (o = i.charCodeAt(++P)) {
                                                case 92:
                                                case 34:
                                                case 47:
                                                case 98:
                                                ...
                                                case 117:
                                                    e = ++P;
                                                    for (n = P + 4; P < n; P++)(o = i.charCodeAt(P)) >= 48 && o <= 57 || o >= 97 && o <= 102 || o >= 65 && o <= 70 || W();
                                                    t += M("0x" + i.slice(e, P));
                                                    break;
                                                default:
                                                    W()
                                                ...
                                                o = i.charCodeAt(P);
                                                e = P;
                                                for (; o >= 32 && 92 != o && 34 != o;) o = i.charCodeAt(++P);
                                                t += i.slice(e, P)
                                            }
                                        ...
                                        default:
                                            ...
                                            if (o >= 48 && o <= 57) {
                                                48 == o && ((o = i.charCodeAt(P + 1)) >= 48 && o <= 57) && W();
                                                r = !1;
                                                for (; P < s && ((o = i.charCodeAt(P)) >= 48 && o <= 57); P++);
                                                ...
                                                if (101 == (o = i.charCodeAt(P)) || 69 == o) {
                                                    43 != (o = i.charCodeAt(++P)) && 45 != o || P++;
                                                    for (n = P; n < s && !((o = i.charCodeAt(n)) < 48 || o > 57); n++);
                                                    n == P && W();
                                                    P = n
                                                }
                                                return +i.slice(e, P)
                                            ...
                                            if ("fals" == a && 101 == i.charCodeAt(P + 4)) {
                                                P += 5;
                                                return !1
                                            }
                                            if ("null" == a) {
                                    ...
                                    if ("string" == typeof t) {
                                        ...
                                        if ("{" == t) {
                                            ...
                                            for (;
                                                "}" != (t = q());) {
                                                n ? "," == t ? "}" == (t = q()) && W() : W() : n = !0;
                                                "," != t && "string" == typeof t && "@" == (S ? t.charAt(0) : t[0]) && ":" == q() || W();
                                                e[t.slice(1)] = J(q())
                                            }
                                            return e
                                        }
                                ...
                                B = function(t, e, n) {
                                    var r = G(t, e, n);
                                    r === p ? delete t[e] : t[e] = r
                                },
                                G = function(t, e, n) {
                                    var r, o = t[e];
                                    if ("object" == typeof o && o)
                                        if (m.call(o) == E)
                                            for (r = o.length; r--;) B(m, T, o);
                                        else T(o, (function(t) {
                                            B(o, t, n)
                                        }));
                                    return n.call(t, e, o)
                            ...
                            e.parse = function(t, e) {
                                ...
                                "$" != q() && W();
                                P = L = null;
                                return e && m.call(e) == w ? G(((r = {})[""] = n, r), "", e) : n
                            }
                        }
                    }
                    e.runInContext = l;
                            ...
                            if (o.origin === n) {
                                ...
                                if (a.windowId === c.currentWindowId) switch (a.type) {
                                    case "s":
                                        ...
                                        if (!r.isOriginEqual(d, l.href) || !r.isOriginEqual(m, l.href)) throw new Error("Can't connect to different domain from within an iframe. (" + l.href + ", " + d + ", " + m + ")");
                                        e = new s(new u[p](d, m));
                                        break;
                                    case "m":
                                        e._send(a.data);
        ...
        316311: (t, e, n) => {
            ...
            function c(t) {
                ...
                this.ir.once("finish", (function(t, n) {
                    e.ir = null;
                    e.emit("message", i.stringify([t, n]))
                }))
            }
            r(c, o);
        ...
        593616: (t, e, n) => {
            ...
            function l(t, e) {
                ...
                r.call(this);
                var l = function() {
                    var n = o.ifr = new a(c.transportName, e, t);
                ...
                n.g.document.body ? l() : s.attachEvent("load", l)
            }
            o(l, r);
            l.enabled = function() {
                return a.enabled()
        ...
        885172: (t, e, n) => {
            ...
            f._getReceiver = function(t, e, n) {
                return n.sameOrigin ? new h(e, c) : a.enabled ? new h(e, a) : s.enabled && n.sameScheme ? new h(e, s) : u.enabled() ? new u(t, e) : new h(e, l)
            };
            f.prototype.doXhr = function(t, e) {
                var n = this,
                    r = i.addPath(t, "/info");
                this.xo = f._getReceiver(t, r, e);
        ...
        493626: (t, e, n) => {
            ...
            function x(t, e, n) {
                ...
                this.extensions = "";
                this.protocol = "";
                (n = n || {}).protocols_whitelist && d.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead.");
            ...
            x.prototype.send = function(t) {
                "string" != typeof t && (t = "" + t);
                if (this.readyState === x.CONNECTING) throw new Error("InvalidStateError: The connection has not been established yet");
            ...
            x.prototype._connect = function() {
                for (var t = this._transports.shift(); t; t = this._transports.shift()) {
                    t.transportName;
                    if (t.needBody && (!n.g.document.body || void 0 !== n.g.document.readyState && "complete" !== n.g.document.readyState && "interactive" !== n.g.document.readyState)) {
                        this._transports.unshift(t);
                        u.attachEvent("load", this._connect.bind(this));
                        return
                    }
                    var e = this._rto * t.roundTrips || 5e3;
                    this._transportTimeoutId = setTimeout(this._transportTimeout.bind(this), e);
                    var r = l.addPath(this._transUrl, "/" + this._server + "/" + this._generateSessionId()),
            ...
            x.prototype._transportClose = function(t, e) {
                ...
                _(t) || 2e3 === t || this.readyState !== x.CONNECTING ? this._close(t, e) : this._connect()
            };
            x.prototype._open = function() {
                this._transport.transportName, this.readyState;
                if (this.readyState === x.CONNECTING) {
            ...
            x.prototype._close = function(t, e, n) {
                ...
                if (this.readyState === x.CLOSED) throw new Error("InvalidStateError: SockJS has already been closed");
        ...
        221247: () => {
            ...
            var u = function(e, r, o) {
                    for (var i in r) n.hasOwnProperty.call(r, i) && t(e, i, r[i], o)
                },
                h = function(t) {
            ...
            u(r, {
                bind: function(t) {
                    var e = this;
                    if (!a(e)) throw new TypeError("Function.prototype.bind called on incompatible " + e);
                    for (var n = i.call(arguments, 1), r = function() {
                            if (this instanceof l) {
                                var r = e.apply(this, n.concat(i.call(arguments)));
                                return Object(r) === r ? r : this
                            }
                            return e.apply(t, n.concat(i.call(arguments)))
                        }, o = Math.max(0, e.length - n.length), s = [], c = 0; c < o; c++) s.push("$" + c);
            ...
            u(e, {
                indexOf: function(t) {
                    var e = m && c(this) ? this.split("") : h(this),
                        n = e.length >>> 0;
                    if (!n) return -1;
                    var r = 0;
                    arguments.length > 1 && (r = f(arguments[1]));
            ...
            var v, y = o.split;
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? (v = void 0 === /()??/.exec("")[1], o.split = function(t, n) {
                var r = this;
                if (void 0 === t && 0 === n) return [];
                if ("[object RegExp]" !== s.call(t)) return y.call(this, t, n);
                var o, i, a, c, l = [],
                    u = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.extended ? "x" : "") + (t.sticky ? "y" : ""),
                    h = 0;
                t = new RegExp(t.source, u + "g");
                r += "";
                v || (o = new RegExp("^" + t.source + "$(?!\\s)", u));
                n = void 0 === n ? -1 >>> 0 : n >>> 0;
                for (; i = t.exec(r);) {
                    if ((a = i.index + i[0].length) > h) {
                        l.push(r.slice(h, i.index));
                        !v && i.length > 1 && i[0].replace(o, (function() {
                            for (var t = 1; t < arguments.length - 2; t++) void 0 === arguments[t] && (i[t] = void 0)
                        }));
                        i.length > 1 && i.index < r.length && e.push.apply(l, i.slice(1));
                        c = i[0].length;
                        h = a;
                        if (l.length >= n) break
                    }
                ...
                h === r.length ? !c && t.test("") || l.push("") : l.push(r.slice(h));
            ...
            u(o, {
                substr: function(t, e) {
                    return b.call(this, t < 0 && (t = this.length + t) < 0 ? 0 : t, e)
                }
            }, w)
        },
        987581: (t, e, n) => {
            "use strict";
            t.exports = [n(22412), n(369842), n(894620), n(643004), n(540882)(n(643004)), n(565616), n(540882)(n(565616)), n(509201), n(69998), n(540882)(n(509201)), n(395375)]
        },
        182940: (t, e, n) => {
            "use strict";
            var r = n(263212).v,
            ...
            c.prototype._start = function(t, e, n, r) {
                ...
                if (this.xhr) {
                    ...
                    r && r.noCredentials || !c.supportsCORS || (this.xhr.withCredentials = !0);
                    if (r && r.headers)
                        for (var l in r.headers) this.xhr.setRequestHeader(l, r.headers[l]);
            ...
            if (!c.enabled && l in n.g) {
                a = function() {
                    try {
                        return new n.g[l]("Microsoft.XMLHTTP")
                    } catch (t) {
                        return null
                    }
                };
                ...
                i.call(this, t, e, function(t) {
                    return function(e, n, r) {
                        ...
                        a.once("finish", (function(t) {
                            a = null;
                            if (200 !== t && 204 !== t) return r(new Error("http status " + t));
                            r()
                        }));
                        return function() {
                            a.close();
        ...
        461265: (t, e, n) => {
            ...
            i.prototype._scheduleReceiver = function() {
                ...
                e.once("close", (function(n, r) {
                    ...
                    t.poll = e = null;
                    if (!t.pollIsClosing)
                        if ("network" === r) t._scheduleReceiver();
                        else {
        ...
        653608: (t, e, n) => {
            ...
            var l = ["Active"].concat("Object").join("X");
            if (l in n.g) try {
                c.htmlfileEnabled = !!new n.g[l]("htmlfile")
            } catch (t) {}
            c.enabled = c.htmlfileEnabled || o.iframeEnabled;
            t.exports = c
        },
        900514: (t, e, n) => {
            "use strict";
            ...
            l.prototype._createScript = function(t) {
                ...
                if (void 0 === s.async && n.g.document.attachEvent)
                    if (i.isOpera()) {
                        (e = this.script2 = n.g.document.createElement("script")).text = "try{var a = document.getElementById('" + s.id + "'); if(a)a.onerror();}catch(x){};";
                        s.async = e.async = !1
                    } else {
                        try {
                            s.htmlFor = s.id;
        ...
        320771: (t, e, n) => {
            ...
            t.exports = function(t, e, a) {
                r || function() {
                    (r = n.g.document.createElement("form")).style.display = "none";
                    r.style.position = "absolute";
                    r.method = "POST";
                    r.enctype = "application/x-www-form-urlencoded";
                    r.acceptCharset = "UTF-8";
                    (o = n.g.document.createElement("textarea")).name = "d";
                    r.appendChild(o);
        ...
        856073: (t, e, n) => {
            ...
            o(c, r);
            c.prototype._start = function(t, e, r) {
                var o = this,
                ...
                s.onload = function() {
                    o.emit("finish", 200, s.responseText);
                    o._cleanup(!1)
                };
                this.xdr = s;
                this.unloadRef = i.unloadAdd((function() {
            ...
            c.enabled = !(!n.g.XDomainRequest || !s.hasDomain());
            t.exports = c
        },
        879033: (t, e, n) => {
            "use strict";
            ...
            r(i, o);
            i.enabled = o.enabled && o.supportsCORS;
            t.exports = i
        },
        57103: (t, e, n) => {
            "use strict";
        ...
        22412: (t, e, n) => {
            ...
            function c(t, e, n) {
                ...
                s.call(this);
                var i = this,
                    l = o.addPath(t, "/websocket");
                l = "https" === l.slice(0, 5) ? "wss" + l.slice(5) : "ws" + l.slice(4);
                this.url = l;
                ...
                quote: function(t) {
                    ...
                    r || (r = function(t) {
                        ...
                        r.join("").replace(t, (function(t) {
                            n[t] = "\\u" + ("0000" + t.charCodeAt(0).toString(16)).slice(-4);
                            return ""
                        }));
                        t.lastIndex = 0;
                        return n
                    }(i));
                    return e.replace(i, (function(t) {
                        return r[t]
                    }))
                }
            }
        ...
        897705: (t, e, n) => {
            ...
            t.exports = {
                attachEvent: function(t, e) {
                    if (void 0 !== n.g.addEventListener) n.g.addEventListener(t, e, !1);
                    else if (n.g.document && n.g.attachEvent) {
                        n.g.document.attachEvent("on" + t, e);
                        n.g.attachEvent("on" + t, e)
                    }
                },
                detachEvent: function(t, e) {
                    if (void 0 !== n.g.addEventListener) n.g.removeEventListener(t, e, !1);
                    else if (n.g.document && n.g.detachEvent) {
                        n.g.document.detachEvent("on" + t, e);
        ...
        3683: (t, e, n) => {
            ...
            t.exports = {
                ...
                postMessage: function(e, r) {
                    n.g.parent !== n.g && n.g.parent.postMessage(o.stringify({
                ...
                createIframe: function(t, e) {
                    var o, i, s = n.g.document.createElement("iframe"),
                        a = function() {
                            clearTimeout(o);
                            try {
                                s.onload = null
                ...
                createHtmlfile: function(e, o) {
                    ...
                    l.open();
                    l.write('<html><script>document.domain="' + n.g.document.domain + '";<\/script></html>');
                    l.close();
                    l.parentWindow[t.exports.WPrefix] = n.g[t.exports.WPrefix];
            ...
            n.g.document && (t.exports.iframeEnabled = ("function" == typeof n.g.postMessage || "object" == typeof n.g.postMessage) && !i.isKonqueror())
        },
        954886: (t, e, n) => {
            "use strict";
            var r = {};
                    ...
                    filterToEnabled: function(e, n) {
                        ...
                        t.forEach((function(t) {
                            if (t && ("websocket" !== t.transportName || !1 !== n.websocket))
                                if (e.length && -1 === e.indexOf(t.transportName)) t.transportName;
                                else if (t.enabled(n)) {
                                t.transportName;
                                r.main.push(t);
                                t.facadeTransport && r.facade.push(t.facadeTransport)
                            } else t.transportName
                        }));
                        return r
                    }
                }
        ...
        584564: (t, e, n) => {
            ...
            function g(t, e) {
                ...
                "file:" === o ? c >= 2 && (n = n.slice(2)) : m(o) ? n = r[4] : o ? i && (n = n.slice(2)) : c >= 2 && m(e.protocol) && (n = r[4]);
                return {
                    protocol: o,
                    slashes: i || m(o),
                    slashesCount: c,
            ...
            function v(t, e, n) {
                ...
                i = !(a = g(t || "", e = d(e))).protocol && !a.slashes;
                x.slashes = a.slashes || i && e.slashes;
                x.protocol = a.protocol || e.protocol || "";
                t = a.rest;
                ("file:" === a.protocol && (2 !== a.slashesCount || u.test(t)) || !a.slashes && (a.protocol || a.slashesCount < 2 || !m(x.protocol))) && (b[3] = [/(.*)/, "pathname"]);
                for (; _ < b.length; _++)
                    if ("function" != typeof(l = b[_])) {
                        c = l[0];
                        y = l[1];
                        if (c != c) x[y] = t;
                        else if ("string" == typeof c) {
                            if (~(p = "@" === c ? t.lastIndexOf(c) : t.indexOf(c)))
                        ...
                        x[y] = x[y] || i && l[3] && e[y] || "";
                        l[4] && (x[y] = x[y].toLowerCase())
                    } else t = l(t, x);
                n && (x.query = n(x.query));
                i && e.slashes && "/" !== x.pathname.charAt(0) && ("" !== x.pathname || "" !== e.pathname) && (x.pathname = function(t, e) {
                    if ("" === t) return e;
                    for (var n = (e || "/").split("/").slice(0, -1).concat(t.split("/")), r = n.length, o = n[r - 1], i = !1, s = 0; r--;)
                        if ("." === n[r]) n.splice(r, 1);
                        else if (".." === n[r]) {
                        n.splice(r, 1);
                        s++
                ...
                if (x.auth) {
                    ...
                    } else x.username = encodeURIComponent(decodeURIComponent(x.auth));
            ...
            v.prototype = {
                set: function(t, e, n) {
                    ...
                    switch (t) {
                        ...
                        case "port":
                            i[t] = e;
                            if (r(e, i.protocol)) e && (i.host = i.hostname + ":" + e);
                            else {
                                i.host = i.hostname;
                                i[t] = ""
                            }
                ...
                toString: function(t) {
                    ...
                    var s = i + (n.protocol && n.slashes || m(n.protocol) ? "//" : "");
                    if (n.username) {
                        s += n.username;
                        ...
                        s += ":" + n.password;
                        s += "@"
                    } else "file:" !== n.protocol && m(n.protocol) && !r && "/" !== n.pathname && (s += "@");
...
//# sourceMappingURL=b80347916eb89f676733.js.map
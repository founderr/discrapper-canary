        ...
        379639: (e, t, n) => {
            ...
            const v = function(e) {
                ...
                s.componentDidMount = function() {
                    u.default.track(l.rMx.ACCOUNT_LINK_STEP, {
                        previous_step: null,
                        current_step: "landing page",
                        platform_type: l.ABu.XBOX
                    })
                };
                s.handleLinkAccountPressed = function() {
                    var e = this;
                    o.ZP.get({
                        ...
                        u.default.track(l.rMx.ACCOUNT_LINK_FAILED, {
                            error_message: n,
                ...
                s.goBack = function() {
                    window.location = l.Z5c.CONNECTIONS(l.ABu.XBOX)
                };
                s.renderXboxButtons = function() {
                    return (0, r.jsxs)("div", {
                        className: g().xboxButtonContainer,
                        children: [(0, r.jsx)(c.Z.Button, {
                            type: c.Z.Button.A,
                            text: f.Z.Messages.XBOX_LINK,
                            style: g().gamepadButton,
                            onClick: this.handleLinkAccountPressed
                        }), (0, r.jsx)(c.Z.Button, {
                            type: c.Z.Button.B,
                            text: f.Z.Messages.CANCEL,
                            style: g().gamepadButton,
                            onClick: this.goBack
                        ...
                        children: [(0, r.jsx)("img", {
                            ...
                            children: [(0, r.jsxs)(i.Z.Child, {
                                ...
                                children: [(0, r.jsx)("div", {
                                    ...
                                    children: f.Z.Messages.DISCORD_RICH_PRESENCE
                                }), (0, r.jsx)("div", {
                                    className: p().sectionSubtitle,
                                    children: f.Z.Messages.LINK_YOUR_XBOX_ACCOUNT_1
                                }), (0, r.jsx)("div", {
                                    className: p().sectionSubtitle,
                                    children: f.Z.Messages.LINK_YOUR_XBOX_ACCOUNT_2

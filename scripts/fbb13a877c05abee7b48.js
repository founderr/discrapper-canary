...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [97516, 81580, 1459], {
                        ...
                        return T(this, (function(C) {
                            switch (C.label) {
                                ...
                                case 3:
                                    ...
                                    g = L || _.Z.getChannelId() === f.Z.getCurrentClientVoiceChannelId(t.guild_id);
                                    ...
                                    !__OVERLAY__ && (p || g || h || N) && function(e) {
                                        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                            n = e.getGuildId();
            ...
            function p(e) {
                var t = function(e) {
                    var t = (0, u.n2)(e.guild_id, e.id),
                        n = (0, i.e7)([f.ZP, _.Z, l.Z, c.Z], (function() {
                            ...
                            if (e.type === d.d4z.GUILD_CATEGORY) {
                                ...
                                if (t[e.id].some((function(e) {
                                        var t = e.channel;
                                        return (0,
                                            s.Em)(t.type) && f.ZP.hasUnread(t.id)
                                    }))) return !0;
        ...
        866893: (e, t, n) => {
            ...
            function H(e) {
                return function(t, n) {
                    return (0, I.yv)(t) ? -1 : (0, I.yv)(n) ? 1 : e === o.z.LATEST_ACTIVITY ? a.default.compare(j(n), j(t)) : a.default.compare(n, t)
                }
            }
            ...
            const K = new x(l.Z, {
                ...
                THREAD_LIST_SYNC: function(e) {
                    var t, n = e.guildId;
                    if (null == C) return !1;
                    if (n !== (null === (t = f.Z.getChannel(C)) || void 0 === t ? void 0 : t.guild_id)) return !1;
                    Y({
                        refreshThreadIds: !0
                    })
                },
                THREAD_CREATE: function(e) {
                    ...
                    if (null == t.parent_id || t.parent_id !== C) return !1;
                    if (!n) return !1;
                    t.ownerId !== _.default.getId() ? U++ : g = t.id
                },
        ...
        52317: (e, t, n) => {
                            ...
                            case 0:
                                ...
                                for (var E in r)
                                    if (null != (a = c.Z.getChannel(E)) && null != a.guild_id) {
                                        ...
                                        e[a.guild_id].channel_overrides[a.id] = O(I({}, e[a.guild_id].channel_overrides[a.id]), {
                                            collapsed: a.id in n
                                        });
                                        t = !0
                                    } if (!t) return [2];
            ...
            const G = new(function(e) {
                ...
                n.prototype.__getLocalVars = function() {
                    return {
                        lastSavedCollapsedCategories: N,
                        logger: R,
                        syncTimer: L,
                        SYNC_DELAY_MS: 15e3
                    }

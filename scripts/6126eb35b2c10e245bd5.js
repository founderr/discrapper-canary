(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["38429"], {
                ...
                constructor(e = h) {
                    ...
                    this.updateAvailable = !1, this.hasNativeUpdate = !1, this._callbacks = [], this._bootstrapper = null, this.checkForUpdates = function() {
                        ...
                        this._handleCheckingForUpdates(), l.default.get({
                            ...
                            if (null == e.body || "9dbe2ed455c129510e904eae8cc00397fd1c3887" === e.body.hash) return this._handleUpdateNotAvailable();
        ...
        531674: function(e, t, n) {
            ...
            function N(e, t) {
                let [n, l] = (0, i.useStateFromStoresArray)([c.default], () => [c.default.isChannelMuted(e.guild_id, e.id), c.default.getChannelMuteConfig(e.guild_id, e.id)]), s = (0, d.useMutedUntilText)(l), m = (0, h.default)(e, !0);
                ...
                switch (e.type) {
                    case E.ChannelTypes.GUILD_CATEGORY:
                        _ = p.default.Messages.MUTE_CATEGORY, T = p.default.Messages.UNMUTE_CATEGORY;
                        break;
                    case E.ChannelTypes.GROUP_DM:
                        _ = p.default.Messages.MUTE_CONVERSATION, T = p.default.Messages.UNMUTE_CONVERSATION;
                        break;
                    case E.ChannelTypes.DM:
                        _ = p.default.Messages.MUTE_CHANNEL.format({
                            name: m
                        }), T = p.default.Messages.UNMUTE_CHANNEL.format({
                            name: m
                        });
                        break;
                    default:
                        _ = p.default.Messages.MUTE_CHANNEL_GENERIC, T = p.default.Messages.UNMUTE_CHANNEL_GENERIC
                }
                    ...
                    children: g().map(n => {
                        ...
                        return (0, a.jsx)(r.MenuItem, {
                            ...
                            action: () => (function(n) {
                                ...
                                let a = S(n);
                                u.default.updateChannelOverrideSettings(e.guild_id, e.id, a, f.NotificationLabels.Muted, t)
                            })(l)
                        }, l)
                    })
                })
        ...
        619436: function(e, t, n) {
            ...
            function h(e) {
                let t = e.getGuildId(),
                    ...
                    g = (0, r.useVoiceActivityNotificationSettingsExperiment)(e),
                    S = f(e, g);
            ...
            function E(e) {
                ...
                let i = h(e),
                    ...
                    g = m === d.UserNotificationSettings.NULL && e.isGuildStageVoice() ? c.default.Messages.FORM_LABEL_ONLY_MENTIONS.format() : null === (n = f(e, p)) || void 0 === n ? void 0 : null === (t = n.find(e => {
                        let {
                            setting: t
                        } = e;
                        return t === u
        ...
        64016: function(e, t, n) {
            ...
            function u(e, t) {
                let n = (0, l.useStateFromStores)([i.default], () => i.default.hasJoined(e.id));
        ...
        957825: function(e, t, n) {
            ...
            function h(e) {
                let {
                    ...
                    location: p,
                    includeGuildMute: g
                } = e, S = (0, r.useChannelNotificationRadioItems)(t), N = (0, o.useChannelNotificationSettingsItemInner)(t), _ = (0, l.useStateFromStores)([f.default], () => f.default.getGuild(t.guild_id)), T = (0, u.default)(_), I = (0, d.useShouldUseNewNotificationSystem)("ChannelNotificationSettingsPopoutMenu") && c.CHANNEL_ELIGIBLE_FOR_UNREAD_SETTING.has(t.type);
        ...
        459776: function(e, t, n) {
            ...
            var a = n("888400"),
                ...
                i = n("913491"),
                r = n("49111");
            let o = 7 * l.default.Millis.MINUTE;
            ...
            function d(e, t, n) {
                ...
                return !!((0, i.default)(t) || t.author.id !== n.author.id || t.hasFlag(r.MessageFlags.EPHEMERAL) !== n.hasFlag(r.MessageFlags.EPHEMERAL) || null != n.webhookId && t.author.username !== n.author.username || (null == e ? void 0 : e.isForumPost()) && t.id === e.id || !(0, a.isWithinInterval)(t.timestamp, n.timestamp, o) || n.hasFlag(r.MessageFlags.SUPPRESS_NOTIFICATIONS) && !t.hasFlag(r.MessageFlags.SUPPRESS_NOTIFICATIONS) || t.hasFlag(r.MessageFlags.SUPPRESS_NOTIFICATIONS) && !n.hasFlag(r.MessageFlags.SUPPRESS_NOTIFICATIONS) && (n.mentions.length > 0 || n.mentionRoles.length > 0 || n.mentionEveryone) || (0, s.default)(n)) || !1
            }
        },
        ...
        899779: function(e, t, n) {
            ...
            let u = e => {
                ...
                d = l.memo(function(e) {
                    ...
                    if (null != t.icon_name) n = (0, a.jsx)("img", {
                        alt: "",
        ...
        609023: function(e, t, n) {
            ...
            function R(e) {
                ...
                let {
                    ...
                    autoTrackExposure: !1
                }), T = m.MessageDisplayCompact.useSetting(), v = (0, o.useStateFromStores)([g.default], () => g.default.can(C.Permissions.CREATE_INSTANT_INVITE, s)), R = (0, h.isSpamSupported)(s), L = !1, O = 0 === l.messages.length || l.messages[0].timestamp.isSame(i(), "day"), b = null !== (n = null === (t = S.default.getUser(p.default.getId())) || void 0 === t ? void 0 : t.hasFlag(C.UserFlags.SPAMMER)) && void 0 !== n && n, y = [];
                if (!l.collapsed) {
                    let e = null,
                        t = null,
        ...
        92790: function(e, t, n) {
            ...
            var F = d.default.connectStores([g.default, T.default], () => {
                var e;
        ...
        712611: function(e, t, n) {
            ...
            class x extends a.default.Store {
                ...
                getState(e) {
                    var t;
                    return null !== (t = g[e]) && void 0 !== t ? t : N({
                        searchId: e
                    })
                }
            }
            ...
            let R = new x(l.default, {
                ...
                SEARCH_EDITOR_STATE_CLEAR: function(e) {
                    ...
                    null != n && (n.context.destroy(), n.results = [], delete S[t]), delete g[t]
                },
                CHANNEL_CREATE: A,
                CHANNEL_DELETE: A,

        ...
        14636: (t, r, e) => {
            ...
            t.exports = function(t, r) {
                var e = a(t),
                    ...
                    g = h.length;
                for (var _ in t) !r && !c.call(t, _) || v && ("length" == _ || f && ("offset" == _ || "parent" == _) || l && ("buffer" == _ || "byteLength" == _ || "byteOffset" == _) || u(_, g)) || h.push(_);
                return h
            }
        },
        70151: (t, r, e) => {
            ...
            var e = function() {
                ...
                return {
                    quantize: function(i, u) {
                        ...
                        f(l, u - l.size());
                        for (var v = new o; l.size();) v.push(l.pop());
                        return v
                    }
                }
            }();

    ...
    [89984], {
        ...
        366007: (_, I, e) => {
            ...
            var r = e(785893),
                ...
                O = e(795308),
                T = Object.freeze({
                    PREMIUM_TIER_0: (0, t.Z)(),
                    PREMIUM_TIER_1: (0, t.Z)(),
                    PREMIUM_TIER_2: (0, t.Z)(),
                    PREMIUM_GUILD: (0, t.Z)(),
                    PREMIUM_TRIAL_TUTORIAL: (0, t.Z)(),
                    PREMIUM_GUILD_BADGE_V2_BACKGROUND: (0, t.Z)()
                }),
                o = {
                    PREMIUM_TIER_0: "url(#".concat(T.PREMIUM_TIER_0, ")"),
                    PREMIUM_TIER_1: "url(#".concat(T.PREMIUM_TIER_1, ")"),
                    PREMIUM_TIER_2: "url(#".concat(T.PREMIUM_TIER_2, ")"),
                    PREMIUM_GUILD: "url(#".concat(T.PREMIUM_GUILD, ")"),
                    PREMIUM_TRIAL_TUTORIAL: "url(#".concat(T.PREMIUM_TRIAL_TUTORIAL, ")"),
                    PREMIUM_GUILD_BADGE_V2_BACKGROUND: "url(#".concat(T.PREMIUM_GUILD_BADGE_V2_BACKGROUND, ")")
                };
            const n = E.memo((function() {
                return (0, r.jsxs)("svg", {
                    ...
                    children: [(0, r.jsxs)("linearGradient", {
                        ...
                        id: T.PREMIUM_GUILD_BADGE_V2_BACKGROUND,

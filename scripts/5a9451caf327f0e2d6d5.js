    ...
    [9096], {
        ...
        693150: (e, r, t) => {
            ...
            function We() {
                ...
                return (0, n.jsxs)("div", {
                    className: ke().heroBanner,
                    children: [(0, n.jsxs)("div", {
                        className: ke().heroDescription,
                        children: [(0, n.jsxs)(f.Text, {
                            color: "always-white",
                            variant: "eyebrow",
                            className: ke().premiumBadgeWrapper,
                            children: [(0, n.jsx)(q.Z, {
                                className: ke().premiumBadge
                            }), (0, n.jsx)("span", {
                                className: ke().premiumBadgeText,
                                children: ae.Z.Messages.REMIXING_TOOLTIP_NITRO_EARLY_ACCESS
                            })]
                        }), (0, n.jsx)(f.Heading, {
                            className: ke().bannerTitle,
                            color: "always-white",
                            variant: "display-lg",
                            children: ae.Z.Messages.COLLECTIBLES_SHOP_HERO_BANNER_TITLE
                        }), (0, n.jsx)(f.Text, {
                            className: ke().heroSubtitle,
                            color: "always-white",
                            variant: "text-lg/normal",
                            children: ae.Z.Messages.COLLECTIBLES_SHOP_HERO_BANNER_SUBTITLE
                        }), r ? null : (0, n.jsx)(G.Z, {
                            className: ke().subscribeButton,
                            isTrialCTA: !0,
                            buttonText: ae.Z.Messages.COLLECTIBLES_NON_PREMIUM_SHOP_CTA,
                            subscriptionTier: oe.Si.TIER_2
                        })]
                    }), (0, n.jsx)("div", {
                        className: ke().bannerBackgroundWrapper,
                        children: (0, n.jsx)("img", {
                        ...
                        className: ke().bannerForeground,
                        alt: "",
                        src: Be()
                    }), (0, n.jsx)("img", {
                        className: ke().bannerHand,
                        alt: "",
                        src: Fe()
                    }), (0, n.jsx)("img", {
                        className: s()(ke().largeSparkle, ke().largeTopSparkle),
                        alt: "",
                        src: He()
                    }), (0, n.jsx)("img", {
                        className: s()(ke().smallSparkle, ke().smallTopSparkle),
                        alt: "",
                        src: He()
                    }), (0, n.jsx)("img", {
                        className: s()(ke().largeSparkle, ke().largeLeftSparkle),
                        alt: "",
                        src: He()
                    }), (0, n.jsx)("img", {
                        className: s()(ke().smallSparkle, ke().smallLeftSparkle),
                        alt: "",
                        src: He()
                    }), (0, n.jsx)("img", {
                        className: s()(ke().largeSparkle, ke().largeRightSparkle),
                        alt: "",
                        src: He()
                    }), (0, n.jsx)("img", {
                        className: s()(ke().smallSparkle, ke().smallRightSparkle),
                        alt: "",
                        src: He()
                    })]
                })
                    ...
                    children: (0, n.jsx)(f.ScrollerAuto, {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsxs)("main", {
                                className: Ve().page,
                                children: [(0, n.jsx)(ze, {}), g || null == k ? null : (0, n.jsx)(cr, {
                                    category: k

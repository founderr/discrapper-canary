...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [32632, 89005, 29202, 91683, 58635], {
        ...
        980604: (e, t, n) => {
            ...
            function X() {
                var e, t, n = null !== (e = w.Z.getGuildId()) && void 0 !== e ? e : void 0,
                ...
                for (var u = [], c = [], a = 1; a < z.length; a += 1) {
                    var s = K(z[a]);
                    null != s && ((s.type !== l.h8.TEXT_CHANNEL && s.type !== l.h8.VOICE_CHANNEL || m.Z.can(y.Plq.VIEW_CHANNEL, s.record)) && c.push(s))
                }
                if (c.length > 0) {
                    var d;
                    (d = u).push.apply(d, [(0, l.o6)(T.Z.Messages.QUICKSWITCHER_LAST_CHANNEL)].concat(U(c)))
                }
                var p = function(e) {
                    var t = [];
                ...
                if (p.length > 0) {
                    var v;
                    (v = u).push.apply(v, [(0, l.o6)(T.Z.Messages.QUICKSWITCHER_DRAFTS)].concat(U(p)))
                }
                ...
                if (null != n) {
                    var I = g.ZP.getSelectableChannelIds(n).filter((function(e) {
                        var t = f.Z.getChannel(e);
                        return !(null == t || e === r || z.includes(e) || C.Z.isChannelMuted(t.guild_id, e) || null != t.parent_id && C.Z.isChannelMuted(t.guild_id, t.parent_id)) && S.ZP.hasRelevantUnread(t)
                    })).map((function(e) {
                        return K(e)
                    })).filter((function(e) {
                        return e
            ...
            function $(e, t) {
                switch (k) {
                    case l.h8.USER:
                        var n = I.Z.getGuild(w.Z.getGuildId());
                ...
                if (t !== W) {
                    ...
                    V = (0, l.gJ)(l.a8.DOWN, -1, Q)
                } else {
                    var r = Q[V];
                    null != r && r.type === l.h8.HEADER && (V = (0, l.gJ)(l.a8.DOWN, V, Q))
                }
                re.emitChange()
            }
            ...
            function J(e) {
                var t, n = e.query,
                    r = e.queryMode,
                    o = null !== (t = w.Z.getGuildId()) && void 0 !== t ? t : void 0,
                    i = new Set(["user:".concat(b.default.getId())]);
                null != o && i.add("guild:".concat(o));
                H = null != H ? H : new l.ZP(ee, null, null != r ? 100 : 5, {
                    frecencyBoosters: !0,
                    blacklist: i
                });
                W = null;
            ...
            var re = new ne(c.Z, {
                ...
                QUICKSWITCHER_SEARCH: function(e) {
                    var t, n = e.query,
                        r = e.queryMode;
                    if (null == H) return !1;
                    var o = null !== (t = w.Z.getGuildId()) && void 0 !== t ? t : null;
                    if (k !== r) {
                        H.setResultTypes(null != r ? [r] : null);
                        H.setLimit(null != r ? 100 : 5);
                        var i, u = null !== (i = w.Z.getGuildId()) && void 0 !== i ? i : void 0;
                    ...
                    k = r;
                    H.search(n, k === l.h8.USER ? o : void 0)
                },
        ...
        796909: (e, t, n) => {
            ...
            function T(e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : j(e);
                return {
                    channelId: e.id,
                    lastMessageId: t,
            ...
            var N, L, Z, U = (N = [], L = [], Z = [], function() {
                    var e = P.values(_.FAVORITE),
                        t = P.values(_.DEFAULT);
                    if (N !== e || L !== t) {
                        Z = [];
                ...
                D = function(e) {
                    ...
                    r.getSortedChannels = function() {
                        return [P.values(_.FAVORITE), P.values(_.DEFAULT)]
                    };

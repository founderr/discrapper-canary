...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [96006], {
        ...
        696006: (e, n, t) => {
            ...
            function y(e) {
                return (0,
                    f.e7)([b.Z, p.Z], (function() {
                    var n = p.Z.getMutableBasicGuildChannelsForGuild(e.guild_id),
                        t = Object.values(n).filter((function(e) {
                            return e.type === O.d4z.GUILD_CATEGORY
                        }));
                    return 0 === t.length || t.every((function(e) {
                        return b.Z.isCollapsed(e.id)
                    }))
                })) ? null : (0, r.jsx)(i.MenuItem, {
                    id: "collapse-all-categories",
                    label: h.Z.Messages.COLLAPSE_ALL_CATEGORIES,
                    action: function() {
                        return (0, d.N5)(e.guild_id)
                    }
                })
            }

            function g(e) {
                var n = (0, f.e7)([b.Z], (function() {
                    return b.Z.isCollapsed(e.id)
                }), [e.id]);
                return (0, r.jsx)(i.MenuCheckboxItem, {
                    id: "collapse-category",
                    label: h.Z.Messages.COLLAPSE_CATEGORY,
                    action: function() {
                        return n ? (0, d.mJ)(e.id) : (0, d.c4)(e.id)
                    },
                    checked: n
                })
            }
            ...
            function A(e) {
                return (0, r.jsx)(i.MenuItem, {
                    id: "delete-channel",
                    label: h.Z.Messages.DELETE_CATEGORY,
                    color: "danger",
                    action: function() {
                        return (0, i.openModalLazy)(Z((function() {
                            var n, i;
                            return P(this, (function(o) {
                                switch (o.label) {
                                    case 0:
                                        return [4, Promise.all([t.e(40532), t.e(56054)]).then(t.bind(t, 656054))];
                                    case 1:
            ...
            const k = (0, a.Z)((function(e) {
                return (0, l.Z)() ? (0, r.jsx)(G, x({}, e)) : (0, r.jsx)(D, x({}, e))
                ...
                var O = function() {
                    (0,
                        ...
                        return p(this, (function(o) {
                            switch (o.label) {
                                case 0:
                                    return [4, Promise.all([t.e(40532), t.e(57645), t.e(14929)]).then(t.bind(t, 957645))];
                                case 1:
                                    n = o.sent(), i = n.default;
                                    return [2, function(n) {
                                        return (0, r.jsx)(i, b(d({}, n), {
                                            channelType: l,
                                            guildId: e.guild_id,
                ...
                switch (l) {
                    case u.d4z.GUILD_TEXT:
                        return (0, r.jsx)(o.MenuItem, {
                            ...
                            label: c.Z.Messages.CREATE_TEXT_CHANNEL,
                            action: O
                        });
                    case u.d4z.GUILD_VOICE:
                        return (0, r.jsx)(o.MenuItem, {
                            id: "create-voice-channel",
                            label: c.Z.Messages.CREATE_VOICE_CHANNEL,
                            action: O
                        });
                    default:
                        return null
        ...
        787301: (e, n, t) => {
            ...
            function s(e) {
                var n = (0, i.cj)([u.Z], (function() {
                        return {
                            canManageChannels: u.Z.can(c.Plq.MANAGE_CHANNELS, e),
                            canManageRoles: u.Z.can(c.Plq.MANAGE_ROLES, e),
                            canManageWebhooks: u.Z.can(c.Plq.MANAGE_WEBHOOKS, e),
                    ...
                    d = n.canAccessChannel;
                return __OVERLAY__ ? null : d && (t || s || f) ? (0, r.jsx)(o.MenuItem, {
                    id: "edit-channel",
                    label: e.type === c.d4z.GUILD_CATEGORY ? l.Z.Messages.EDIT_CATEGORY : l.Z.Messages.EDIT_CHANNEL,
                    action: function() {
            ...
            function O(e) {
                var n = function(e) {
                    var n = (0, u.n2)(e.guild_id, e.id),
                        t = (0, i.e7)([d.ZP, f.Z, c.Z, l.Z], (function() {
                            ...
                            if (e.type === b.d4z.GUILD_CATEGORY) {
                                ...
                                for (var i in r)
                                    if (t.has(i))
                                        for (var o in r[i])
                                            if (l.Z.hasJoined(o) && !l.Z.isMuted(o) && d.ZP.hasUnread(o)) return !0;
                                return !1
                            }
        ...
        249971: (e, n, t) => {
            ...
            function f(e) {
                var n = (0, u.DM)(e.guild_id),
                    t = (0, i.e7)([c.Z], (function() {
                        return c.Z.isChannelOptedIn(e.guild_id, e.id)
                    })),
                    f = (0, i.e7)([c.Z], (function() {
                        return null != e.parent_id && c.Z.isChannelOptedIn(e.guild_id, e.parent_id)
                    })),
                    d = (0, i.e7)([c.Z], (function() {
                        return c.Z.isFavorite(e.guild_id, e.id)
                    })),
                    b = function() {
                ...
                return !n || e.isThread() ? null : e.isCategory() ? (0, r.jsx)(o.MenuItem, {
                    ...
                    children: [(0, r.jsx)(o.MenuItem, {
                        ...
                        label: d ? s.Z.Messages.REMOVE_FAVORITE : s.Z.Messages.ADD_FAVORITE,
                        action: function() {
                            (0, a.dM)(e.guild_id, e.id, !d, {
                                section: l.jXE.CONTEXT_MENU
                            })
                        }
                    }), f ? (0, r.jsx)(o.MenuItem, {
                        id: "opt-out-category",
        ...
        143343: (e, n, t) => {
            ...
            function d(e) {
                var n = (0, c.nH)(e),
                    t = function(e) {
                        return [{
                            setting: s.N.NULL,
                            label: null != e.parent_id ? f.Z.Messages.FORM_LABEL_DEFAULT_CATEGORY : f.Z.Messages.FORM_LABEL_DEFAULT
                        }, {
                            setting: s.N.ALL_MESSAGES,
                            label: f.Z.Messages.FORM_LABEL_ALL_MESSAGES
                        }, {
                            setting: s.N.MENTIONS_AND_HIGHLIGHTS,
                            label: f.Z.Messages.HIGHLIGHTS_AND_MENTIONS
                        }]
                    }(e);
                return (0, r.jsx)(r.Fragment, {
                    children: t.map((function(t) {
                        ...
                        return (0, r.jsx)(o.MenuRadioItem, {
                            ...
                            id: "".concat(i),
                            label: u,
                            subtext: i === s.N.NULL ? f.Z.Messages.HIGHLIGHTS_AND_MENTIONS : void 0,
                            action: function() {
                                return function(n) {
            ...
            function b(e) {
                var n = (0, c.nH)(e),
                    ...
                    b = t && a,
                    p = d(e);
                return b ? (0, r.jsx)(o.MenuItem, {
                    id: "channel-unreads",
                    label: f.Z.Messages.UNREAD_SETTINGS,
                    subtext: n === s.N.ALL_MESSAGES ? f.Z.Messages.FORM_LABEL_ALL_MESSAGES : f.Z.Messages.HIGHLIGHTS_AND_MENTIONS,
                    children: p
                }) : null
            }
        },
        ...
        589822: (e, n, t) => {
            ...
            function p(e) {
                ...
                return __OVERLAY__ || n !== u.I_8 ? null : (0, r.jsx)(o.MenuItem, {

        ...
        586611: (e, n, t) => {
            ...
            function J(e) {
                var n = e.analyticsLocations,
                    ...
                    Pe = (0,
                        g.usePaymentContext)(),
                    Ie = Pe.activitySessionId,
                    Ee = Pe.purchaseState,
                    ve = Pe.setPurchaseState,
                    be = Pe.selectedSkuId,
                    Te = Pe.setSelectedSkuId,
                    _e = Pe.selectedPlan,
                    ge = Pe.setSelectedPlanId,
                    Ae = Pe.setStep,
                    Oe = Pe.setPurchaseError,
                    xe = Pe.paymentAuthenticationState,
                    je = Pe.step,
                    Ce = Pe.contextMetadata,
                    Ne = Pe.purchaseTokenAuthState,
                    Me = Pe.activeSubscription,
                    Le = Pe.priceOptions,
                    we = Pe.hasPaymentSources,
                    Re = Pe.purchaseType,
                    Ze = Pe.giftRecipient,
                    Ge = (0, S.Ng)(),
                    ke = null != x && !Y && (0, S.Wp)(Ge, x),
                    Fe = q(i.useState({
                        load_id: Ce.loadId,
                        payment_type: H.Zuq[Re],
                        location: null != t ? t : a,
                        source: o,
                        subscription_type: d,
                        subscription_plan_id: null == _e ? void 0 : _e.id,
                        is_gift: Y,
                        ...
                        eligible_for_discount: ke
                    }), 2),
                    De = Fe[0],
                    Ue = Fe[1],
                    We = q(i.useState((0, T.a8)(Ze) ? B.Z.Messages.DEFAULT_CUSTOM_GIFT_MESSAGE : void 0), 2),
                    He = We[0],
                    Be = We[1];
                i.useEffect((function() {
                    Ue((function(e) {
                        var n = null != _e ? (0, _.aS)(_e.id, !1, Y, Le) : void 0;
                        return Q(z({}, e), {
                            subscription_plan_id: null == _e ? void 0 : _e.id,
                            price: null == n ? void 0 : n.amount,
                            regular_price: null == _e ? void 0 : _e.price,
                ...
                i.useEffect((function() {
                    b.default.track(H.rMx.PAYMENT_FLOW_STARTED, Q(z({}, De), {
                        has_saved_payment_source: we
                    }))
                }), []);
                i.useEffect((function() {
                    ge(v);
                    if (null != ue) Te(ue);
                        ...
                        var e;
                        Te(null === (e = E.Z.get(v)) || void 0 === e ? void 0 : e.skuId)
                    }
                }), [ge, Te, v, ue]);
                var Ye = (0, l.Z)((function() {
                        return Date.now()
                    }), [je]),
                    Ke = i.useCallback((function(e) {
                        ...
                        var a = null != t ? t : je,
                            s = Date.now();
                        null !== a ? b.default.track(H.rMx.PAYMENT_FLOW_STEP, Q(z({}, De, r), {
                            from_step: a,
                            to_step: e === h.h8.ADD_PAYMENT_STEPS ? h.h8.PAYMENT_TYPE : e,
                            step_duration_ms: s - Ye,
                            flow_duration_ms: s - Ce.startTime
                        })) : b.default.track(H.rMx.PAYMENT_FLOW_LOADED, Q(z({}, De), {
                            initial_step: e,
                            has_saved_payment_source: we
                        }))
                    }), [De, Ce.startTime, p, Oe, Ae, je, Ye, we]),
                    Ve = i.useMemo((function() {
                        return function() {
                            return null == j ? void 0 : j(Ee === A.A.COMPLETED)
                        }
                    }), [j, Ee]);
                (0, y.bp)(je, xe, Ke);
                (0, h.dZ)(je, Ee, ve);
                ! function(e, n, t) {
                    i.useEffect((function() {
                        null != e && e !== h.h8.AWAITING_PURCHASE_TOKEN_AUTH && n === P.I.PENDING ? t(h.h8.AWAITING_PURCHASE_TOKEN_AUTH) : e === h.h8.AWAITING_PURCHASE_TOKEN_AUTH && n === P.I.SUCCESS && t(h.h8.REVIEW)
                    }), [e, n, t])
                }(je, Ne, Ke);
                (0, f.Z)(Ve);
                (0, I.w)(Me, (function() {
                ...
                var $e = {
                        initialPlanId: v,
                        giftMessage: O,
                        customGiftMessage: He,
                        setCustomGiftMessage: Be,
                        subscriptionTier: x,
                        handleStepChange: Ke,
                        handleClose: Ve,
                        analyticsData: De,
                    ...
                    ze = function(e) {
                        var n, t = e.isGift,
                            ...
                            E = (0, L.rK)();
                        i.useEffect((function() {
                            E && t && L.ZP.trackExposure({
                                location: "cbdb8c_2"
                            })
                        }), [E, t]);
                        var v = I && E && t && u === G.Si.TIER_2,
                            b = (v || (0, T.a8)(P)) && d === h.h8.CONFIRM && null != m,
                            _ = null != a && null != d,
                            A = d !== h.h8.SKU_SELECT && null != u,
                            O = (0, w.N)(s),
                            x = !t && null != O && null != u && G.nG[O.trial_id].skus.includes(u),
                            j = (0, S.Ng)(),
                            F = null == j || null === (n = j.discount) || void 0 === n ? void 0 : n.plan_ids.some((function(e) {
                        ...
                        return i.useMemo((function() {
                            if (null != d) {
                                ...
                                else if (_) e = a(null != p ? p : null, l, d);
                                else if (y === k.GZ.ONE_TIME) e = (0, r.jsx)(N.t, {
                                    step: d,
                                    onClose: l
                                });
                                else if (A) {
                                    C()(u in G.y7, "invalid sku id: ".concat(u));
                                    e = (0, r.jsx)(Z.Z, {
                ...
                return (0, r.jsx)(c.Shaker, {
                    ...
                    children: (0, r.jsx)(c.ModalRoot, {
                        className: s()(K().root, $({}, K().withHeader, null != ze)),
                        transitionState: m,
                        hideShadow: ye,
                        returnRef: he,
            ...
            function X(e) {
                var n = e.subscriptionTier,
                    ...
                    y = l.hasFetchedSubscriptionPlans,
                    P = l.currencyLoading,
                    I = l.selectedSkuId,
                    E = l.setSelectedPlanId,
                    b = l.isGift,
                    T = l.defaultPlanId,
                    _ = l.startedPaymentFlowWithPaymentSourcesRef.current,
                    A = (0, x.Z)({
                        isGift: b,
                        skuId: I,

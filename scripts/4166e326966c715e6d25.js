(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [37246], {
        ...
        813659: (t, n, e) => {
            ...
            function m(t) {
                var n, e = t.onClose,
                    S = t.transitionState,
                    g = t.guildId,
                    m = (0, i.ZP)([l.default], (function() {
                        return l.default.getId()
                    })),
                    w = (0, i.ZP)([s.ZP], (function() {
                        return s.ZP.getMember(g, m)
                    }), [g, m]),
        ...
        223219: (t, n, e) => {
            ...
            var Z = function(t) {
                ...
                r.hasChanges = function() {
                    return null != m && null != T && (!(!this.isOpen() && D !== a.cII.USER_SETTINGS) && !o().isEqual(m, T))
                };
                r.isOpen = function() {
                    return w
                };
            ...
            const G = new Z(u.Z, {
                ...
                USER_SETTINGS_MODAL_UPDATE_ACCOUNT: function(t) {
                    var n = t.settings;
                    null == m && (m = {});
                    var e = m[a.oAB.ACCOUNT];
                    m[a.oAB.ACCOUNT] = d({}, e, n)
                },
        ...
        901654: (t, n, e) => {
            ...
            Promise.resolve().then(e.bind(e, 652591)).then((function(t) {
                (0, t.addExtraAnalyticsDecorator)((function(t) {
                    t.client_app_state = b.isFocused() ? "focused" : "unfocused"
                }))
            }));
            const S = b
        },

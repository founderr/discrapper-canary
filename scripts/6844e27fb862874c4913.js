    ...
    ["91517"], {
        ...
        675454: function(e, t, n) {
                ...
                return (0, i.jsxs)(d.ModalHeader, {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [null != r ? (0, i.jsx)(d.Avatar, {
                            ...
                            className: D.acronym,
                            children: t.acronym
                        }), l === s.SUBMITTED ? (0, i.jsx)(S.default, {
            ...
            function L(e) {
                ...
                return n === s.SUBMITTED ? null : (0, i.jsxs)("div", {
                    className: D.tableContainer,
                    children: [(0, i.jsx)(d.Text, {
                        className: D.tableHeader,
                        variant: "text-xs/semibold",
                        color: "text-muted",
                        children: n === s.DEFAULT ? M.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_ENABLED_PERMISSIONS : M.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_DISABLING_PERMISSIONS
                    }), (0, i.jsx)("div", {
                        className: D.permissionsTable,
                        children: t.map((e, t) => (0, i.jsxs)("div", {
                            className: D.permissionRow,
                            children: [(0, i.jsx)("div", {
                                className: n === s.DEFAULT ? D.bulletPositive : D.bulletWarning
                            }), (0, i.jsx)(d.Text, {
            ...
            function h(e) {
                ...
                return 0 === t.length && n !== s.SUBMITTED ? null : (n === s.SUBMITTED && (t = A.MODERATOR_PERMISSIONS), (0, i.jsxs)("div", {
                    className: D.tableContainer,
                    children: [(0, i.jsx)(d.Text, {
                        className: D.tableHeader,
                        variant: "text-xs/semibold",
                        color: "text-muted",
                        children: n === s.SUBMITTED ? M.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_DISABLED : M.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_DISABLED_PERMISSIONS
                    }), (0, i.jsx)("div", {
                        className: D.permissionsTable,
                        children: t.map((e, t) => (0, i.jsxs)("div", {
                            className: D.permissionRow,
            ...
            function x(e) {
                ...
                return 0 === a.length && n !== s.SUBMITTED ? null : (0, i.jsxs)("div", {
                    className: D.table,
                    children: [n !== s.SUBMITTED ? (0, i.jsx)(L, {
                        permissions: a,
                        step: n
                    }) : null, (0, i.jsx)(h, {
                        permissions: o,
            ...
            function v(e) {
                ...
                return (0, i.jsxs)(d.ModalFooter, {
                    ...
                    children: [(0, i.jsx)(d.Button, {
                        onClick: t,
                        submitting: o === s.SUBMITTING,
                        children: o === s.DEFAULT ? a ? M.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_NOTICE_CONFIRMATION : M.default.Messages.UPDATE_COMMUNICATION_NOTIFICATIONS_CONFIRMATION : M.default.Messages.DISABLE_UNSAFE_DEFAULT_PERMISSIONS_NOTICE_CONFIRMATION_DONE
                    }), o === s.DEFAULT ? (0, i.jsx)(d.Button, {
            ...
            function F(e) {
                let {
                    ...
                    transitionState: c,
                    onClose: I
                } = e, [_, S] = o.useState(s.DEFAULT), N = o.useMemo(() => {
                    let e = [],
                        n = [];
                ...
                return (0, i.jsxs)(d.ModalRoot, {
                    ...
                    children: [(0, i.jsx)(R, {
                        ...
                        onConfirm: () => {
                            var e, a;
                            !n && (C(), I(), (0, f.markContentAsDismissed)(r.DismissibleGuildContent.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, null !== (e = null == t ? void 0 : t.id) && void 0 !== e ? e : "", !0, m.ContentDismissActionType.PRIMARY)), _ === s.DEFAULT ? (S(s.SUBMITTING), setTimeout(() => S(s.SUBMITTED), 3e3)) : _ === s.SUBMITTED && (C(), I(), (0, f.markContentAsDismissed)(r.DismissibleGuildContent.DISABLE_UNSAFE_COMMUNITY_PERMISSIONS_NOTICE, null !== (a = null == t ? void 0 : t.id) && void 0 !== a ? a : "", !0, m.ContentDismissActionType.PRIMARY))
                        },
                        onDismiss: () => {

            ...
            function w(e) {
                ...
                if (!v.default.isThrottled(e)) {
                    var r = !("location" in t) || t.location !== S.Sbl.GUILD_CREATE_INVITE_SUGGESTION,
                        ...
                        a = l.Z.getChannel(o),
                        u = M(a, i),
                        c = A({}, t, R(u), null != i && null != o && (0, y.AB)(o) ? P(0, o) : L(a));
                    v.default.track(e, c, {
                        flush: n
                    })
                }
                ...
                if (null != n && n.isForumLikeChannel()) {
                    ...
                    if (null != C[e] && null != C[e][t]) {
                        ...
                        if (null != r) {
                            ...
                            for (var u in C[e][t]) t === w ? d.ZP.isNewForumThread(u, t, r) && M[e][t]++ : o.default.compare(u, i) > 0 && !d.ZP.hasOpenedThread(u) && M[e][t]++
                        }
                    }
                }
            }
        ...
        223219: (e, t, n) => {
            ...
            var j = function(e) {
                ...
                r.hasChanges = function() {
                    return null != T && null != y && (!(!this.isOpen() && R !== l.cII.USER_SETTINGS) && !i().isEqual(T, y))
                };
                r.isOpen = function() {
                    return A
                };
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, h, E, g, m = encodeURIComponent(l.toString()),
                    ...
                    S = "".concat(f, "/?link=").concat(m, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(O, "&efr=").concat(v);
                null != b && (S += "&afl=".concat(b));
                null != I && (S += "&ifl=".concat(I));
                return S
            }
        },
        426080: (e, t, n) => {
                ...
                d.prototype = {
                    ...
                    toHex8: function(e) {
                        return function(e, t, n, r, i) {
                            var o = [x(l(e).toString(16)), x(l(t).toString(16)), x(l(n).toString(16)), x(k(r))];

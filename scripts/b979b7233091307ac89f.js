    ...
    ["92544"], {
            ...
            function b(e) {
                ...
                function y(e, n) {
                    ...
                    if (a) f.default.show({
                        ...
                        null != e && (E.default.trackJump(i, l, t), (0, _.transitionTo)(O.Routes.CHANNEL(e.getGuildId(), i, l))), null == c || c(n)
                    }
                }
                a.useEffect(() => {
                    n(s)
                ...
                constructor(e = 36e5) {
                    ...
                    this.updateAvailable = !1, this.hasNativeUpdate = !1, this._callbacks = [], this._bootstrapper = null, this.checkForUpdates = function() {
                        ...
                        this._handleCheckingForUpdates(), l.default.get({
                            ...
                            if (null == e.body || "767a7e617dc696b50645ef95e75d89207653a3a4" === e.body.hash) return this._handleUpdateNotAvailable();
                    ...
                    toolbar: function() {
                        ...
                        return i.isMobile ? S : (0, l.jsxs)(l.Fragment, {
                            children: [h, e ? (0, l.jsx)(c.default, {
                                className: m.search
                            }, null != s ? s : a) : null, (0, l.jsx)(p.default, {}), (0, l.jsx)(d.default, {}), O ? (0, l.jsx)(T.default, {}) : (0, l.jsx)(_.default, {})]
                        })
                    }(),
                    transparent: u,
                    onDoubleClick: g,
                ...
                return (0, l.jsxs)("div", {
                    ...
                    children: [(0, l.jsx)(T.default, {
                        ...
                        children: L ? (0, l.jsx)(m, {
                            onClick: () => {
                                null != M && (E.NotificationCenterAckedBeforeId.updateSetting(M.id), _.default.track(p.AnalyticEvents.NOTIFICATION_CENTER_ACTION, {
        ...
        519540: function(e, t, n) {
            ...
            function B(e) {
                ...
                let r = s.complete,
                    ...
                    y = (0, T.default)(m, !0),
                    U = null != y ? y : I.name,
                    x = (0, c.useStateFromStores)([O.default], () => O.default.getGuild(null == I ? void 0 : I.guild_id)),
        ...
        80649: function(e, t, n) {
            ...
            function L(e) {
                ...
                })), L = (0, u.default)(I), D = (0, u.default)(m), y = (0, u.default)(M);
                a.useEffect(() => {
                    if (!T.default.hasLoadedEver) {
                        O(h, !0);
                        return
                    }(null != L && I !== L || null != D && m !== D || null != y && M !== y) && O(h, !0)
                }, [L, I, D, m, y, M, h, !0]);
                a.useEffect(() => () => {
        ...
        263362: function(e, t, n) {
            ...
            function N(e) {
                let {
                    ...
                    popoutPosition: m,
                    popoutAlign: g
                } = e, [A, C] = a.useState(!1), [R, M] = function() {
                    var e;
                ...
                a.useEffect(() => {
                    !P && R === i.InboxTab.TODOS && M(i.InboxTab.MENTIONS)
                });
                ...
                if (!a.collapsed) {
                    ...
                    n.forEach(n => {
                        if (!(0, c.default)(n, M)) {
                            ...
                            t = n, D = D || (0, E.isSpam)(n), P.push((0, l.jsx)(O, {
                                channel: s,
                                message: n,
                                compact: m,
                                isGroupStart: a,
        ...
        970268: function(e, t, n) {
            ...
            class w extends o.EventEmitter {
                loadMore() {
                    ...
                    (!n || l.some((e, n) => e !== t[n])) && this.setState({
                        channels: l,
                        loadState: n ? this.state.loadState : a.Done
                    })
                }
            ...
            function H() {
                let e = function() {
                    ...
                    t = function(e) {
                        ...
                        return n.forEach(n => {
                            if (null == n) return;
                            let l = O.default.getSelectableChannelIds(n),
            ...
            function Y(e, t, n, a) {
                if (null == a) return;
                let s = M.default.getChannel(a);
                if (null == s) return;
                let i = R.THREAD_CHANNEL_TYPES.has(s.type);
                if (!i && x.default.isGuildOrCategoryOrChannelMuted(n, s.id)) return;
                if (s.isPrivate()) {
                    if (0 === P.default.getMentionCount(a)) return
                } else if (!P.default.hasRelevantUnread(s) && 0 === P.default.getMentionCount(a)) return;
                if (!s.isPrivate() && !y.default.can(j.Permissions.READ_MESSAGE_HISTORY, s)) return;
                let r = P.default.ackMessageId(a);
                if (null == r) {
                    let e = D.default.getGuild(s.guild_id);
                    if (null == e || null == e.joinedAt) return;
                    r = b.default.fromTimestamp(e.joinedAt.getTime())
                }
                let o = P.default.getOldestUnreadMessageId(a),
                    u = P.default.lastMessageId(a),
                    d = P.default.getMentionCount(a),
                    c = d > 0 || s.isPrivate();
                ...
                let f = {
                    ...
                    sortOrder: function(e, t, n) {
                        let a = M.default.getChannel(t);
                        if (T.default.isFavorite(t)) return l.Favorite;
                        if (a.isPrivate()) return l.PrivateChannel;
                        if (P.default.getMentionCount(t) > 0) return l.Mentioned;
                        if (null != n) {
                            let e = b.default.extractTimestamp(n);
                            if (Date.now() - e > 864e6) return l.ReallyOldChannel;
                            if (Date.now() - e > 1728e5) return l.OldChannel
                        }
                        if (a.isThread()) {
                            let e = (0, g.computeThreadNotificationSetting)(a);
                            return e === G.ThreadMemberFlags.ALL_MESSAGES ? l.AllMessagesNotifications : e === G.ThreadMemberFlags.NO_MESSAGES ? l.NoNotifications : l.GuildChannel
                        } {
                            let n = x.default.getChannelMessageNotifications(e, t),
                                a = n === j.UserNotificationSettings.NULL ? x.default.getMessageNotifications(e) : n;
                            return a === j.UserNotificationSettings.ALL_MESSAGES ? l.AllMessagesNotifications : a === j.UserNotificationSettings.NO_MESSAGES ? l.NoNotifications : l.GuildChannel
                        }
                    }(n, a, o)
                };
                s.isNSFW() && L.default.didAgree(s.guild_id) ? t.push({
                    ...f,
                    type: "nsfw"
        ...
        92790: function(e, t, n) {
            ...
            var F = d.default.connectStores([T.default, m.default], () => {
                ...
                let t = m.default.getCurrentSearchId(),
                    ...
                    a = null != t && null !== (e = m.default.getEditorState(t)) && void 0 !== e ? e : R.createEmptyEditorState(O.generateDecorators(S.default)),
        ...
        600133: function(e, t, n) {
            ...
            let eb = [em.NoticeTypes.QUARANTINED, em.NoticeTypes.AUTOMOD_QUARANTINED_USER_PROFILE, em.NoticeTypes.VIEWING_ROLES, em.NoticeTypes.INVITED_TO_SPEAK, em.NoticeTypes.LURKING_GUILD, em.NoticeTypes.VOICE_DISABLED, em.NoticeTypes.NO_INPUT_DETECTED, em.NoticeTypes.HARDWARE_MUTE, em.NoticeTypes.H264_DISABLED, em.NoticeTypes.DISPATCH_ERROR, em.NoticeTypes.DISPATCH_INSTALL_SCRIPT_PROGRESS, em.NoticeTypes.SPOTIFY_AUTO_PAUSED, em.NoticeTypes.DROPS_PROGRESS_INTERRUPTION, em.NoticeTypes.WIN32_DEPRECATED_MESSAGE, em.NoticeTypes.BLOCKED_BY_PROXY, em.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION, em.NoticeTypes.GUILD_RAID_NOTIFICATION, em.NoticeTypes.UNCLAIMED_ACCOUNT, em.NoticeTypes.POMELO_ELIGIBLE, em.NoticeTypes.PENDING_MEMBER, em.NoticeTypes.OUTBOUND_PROMOTION, em.NoticeTypes.CORRUPT_INSTALLATION, em.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER, em.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK, em.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL, em.NoticeTypes.STREAMER_MODE, em.NoticeTypes.SCHEDULED_MAINTENANCE, em.NoticeTypes.BOUNCED_EMAIL_DETECTED, em.NoticeTypes.UNVERIFIED_ACCOUNT, em.NoticeTypes.PREMIUM_TIER_2_TRIAL_ENDING, em.NoticeTypes.PREMIUM_TIER_0_TRIAL_ENDING, em.NoticeTypes.PREMIUM_UNCANCEL, em.NoticeTypes.PREMIUM_MISSING_PAYMENT, em.NoticeTypes.PREMIUM_PAST_DUE_INVALID_PAYMENT, em.NoticeTypes.PREMIUM_PAST_DUE_MISSING_PAYMENT, em.NoticeTypes.PREMIUM_PAST_DUE_ONE_TIME_PAYMENT, em.NoticeTypes.PREMIUM_REACTIVATE, em.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION, em.NoticeTypes.MFA_SMS_BACKUP, em.NoticeTypes.APPLICATION_TEST_MODE, em.NoticeTypes.LOCALIZED_PRICING, em.NoticeTypes.DOWNLOAD_NAG, em.NoticeTypes.CONNECT_SPOTIFY, em.NoticeTypes.CONNECT_PLAYSTATION, em.NoticeTypes.SURVEY, em.NoticeTypes.SERVER_USAGE_SURVEY, em.NoticeTypes.SAFETY_USER_SENTIMENT_NAGBAR, em.NoticeTypes.DROPS_GO_LIVE_BANNER, em.NoticeTypes.DROPS_ENDED_INCOMPLETE, em.NoticeTypes.GUILD_ONBOARDING_UPSELL_NAGBAR],
                ...
                eG = {
                    [em.NoticeTypes.GUILD_RAID_NOTIFICATION]: {
                        predicate: () => (0, g.shouldShowRaidNotificationNagbar)().show && !eF(em.NoticeTypes.GUILD_RAID_NOTIFICATION),
                        metadata: () => {
                            let e = {
                    ...
                    [em.NoticeTypes.NO_INPUT_DETECTED]: {
                        predicate: e => {
                            let {
                                voiceChannelId: t,
                                voiceState: n
                            } = e, l = K.default.getChannel(t), a = (null == l ? void 0 : l.isGuildStageVoice()) && (null == n ? void 0 : n.suppress);
                    ...
                    [em.NoticeTypes.BLOCKED_BY_PROXY]: {
                        predicate: () => !eF(em.NoticeTypes.BLOCKED_BY_PROXY) && j.default.blockedByProxy && b.default.getCurrentConfig({
                    ...
                    [em.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER]: {
                        predicate: e => {
                            ...
                            return null != t && eu.default.hasVideo(t) && !Z.default.supports(eM.Features.VIDEO) && !eF(em.NoticeTypes.VIDEO_UNSUPPORTED_BROWSER)
                        }
                    },
                    [em.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK]: {
                        predicate: e => {
                            ...
                            return eT.default.canRedeemPremiumPerks(t) && W.default.getDetectedOffPlatformPremiumPerks().length > 0
                        },
                        metadata: () => {
                            let e = W.default.getDetectedOffPlatformPremiumPerks();
                            return e[0]
                        }
                    },
                    [em.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL]: {
                        predicate: () => !eF(em.NoticeTypes.DETECTED_OFF_PLATFORM_PREMIUM_PERK_UPSELL) && W.default.getDetectedOffPlatformPremiumPerks().length > 0,
                        metadata: () => {
                            let e = W.default.getDetectedOffPlatformPremiumPerks();
                            return e[0]
                        }
                    ...
                    [em.NoticeTypes.CONNECT_SPOTIFY]: {
                        predicate: () => !k.default.hasConnectedAccount() && et.default.isObservedAppRunning(f.default.get(em.PlatformTypes.SPOTIFY).name) && !eF(em.NoticeTypes.CONNECT_SPOTIFY)
                    },
                    ...
                    [em.NoticeTypes.CONNECT_PLAYSTATION]: {
                        predicate: () => Q.default.isSuggestedAccountType(em.PlatformTypes.PLAYSTATION) && null == Q.default.getAccount(null, em.PlatformTypes.PLAYSTATION) && !eF(em.NoticeTypes.CONNECT_PLAYSTATION)
                    },
                    ...
                    [em.NoticeTypes.PREMIUM_REACTIVATE]: {
                        predicate: () => !eF(em.NoticeTypes.PREMIUM_REACTIVATE) && y.default.shouldShowReactivateNotice()
                    },
                    ...
                    [em.NoticeTypes.DROPS_GO_LIVE_BANNER]: {
                        predicate: () => !eF(em.NoticeTypes.DROPS_GO_LIVE_BANNER) && (0, _.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP) && !(0, _.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP) && (0, p.getShowDropsNoticeBanner)(eA.PartnerGame.FORTNITE),
                        metadata: () => ({
                    ...
                    [em.NoticeTypes.POMELO_ELIGIBLE]: {
                        predicate: () => (0, v.isEligibleForPomelo)() && !eF(em.NoticeTypes.POMELO_ELIGIBLE)
                    },
                    [em.NoticeTypes.DROPS_ENDED_INCOMPLETE]: {
                        predicate: () => !eF(em.NoticeTypes.DROPS_ENDED_INCOMPLETE) && (0, _.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_ENROLLMENT_TOOLTIP) && !(0, _.isDismissibleContentDismissed)(o.DismissibleContent.QUEST_2_COMPLETION_TOOLTIP) && (0, p.getShowDropsEndedIncompleteBanner)(eA.PartnerGame.FORTNITE),
                        metadata: () => ({
                            partnerGame: eA.PartnerGame.FORTNITE
                        })
                    },
                    [em.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION]: {
                        predicate: e => {
                            ...
                            return null != t && null != M.default.getMentionRaidDetected(t) && (0, R.isInMentionRaidNoticeExperiment)(t) && !eF(em.NoticeTypes.AUTO_MODERATION_MENTION_RAID_DETECTION)
                        },
                        metadata: e => {
                            let {
                                selectedGuildId: t
                    ...
                    [em.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION]: {
                        predicate: () => !eF(em.NoticeTypes.ACTIVATE_SERVER_SUBSCRIPTION) && 0 !== S.default.getEligibleGuildsForNagActivate().length && (0, h.isCreatorMonetizationNagActivateEnabled)()
                    },
            ...
            function ek() {
                ...
                let t = ef.default.getPremiumSubscription(),
                    ...
                    i = eg.CONFERENCE_MODE_ENABLED ? ej : eb;
                for (let u of i)
            ...
            class eB extends i.default.Store {
                initialize() {
                    this.syncWith([ei.default, $.default, W.default, el.default, F.default, eE.default, Y.default, Q.default, B.default, A.default], ek), this.waitFor(eo.default, ea.default, q.default, z.default, ee.default, Z.default, es.default, N.default, el.default, er.default, k.default, et.default, $.default, ep.default, eN.default, eS.default, X.default, ef.default, eI.default, W.default, ec.default, J.default, F.default, eh.default, eE.default, Q.default, D.default, T.default, S.default, j.default)
                }
                hasNotice() {
            ...
            var eH = new eB(d.default, {
                ...
                GUILD_MEMBER_ADD: function(e) {
                    return e.user.id === H.default.getId() && ek()
                },
                ...
                NOTICE_DISMISS: function(e) {
                    return null != eP && (null == e.id || e.id === eP.id) && (ex(eP.type, e.isTemporary, e.untilAtLeast), ek())
                },

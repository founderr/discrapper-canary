            ...
            var l = n("77078"),
                ...
                A = (0, u.default)(function(e) {
                    let {
                        ...
                        includeTopic: u = !1,
                        onSelect: d
                    } = e, A = (0, I.default)(t), g = (0, C.default)(t), S = (0, p.default)(t), N = (0, o.default)(t), M = (0, E.default)(t), v = (0, _.default)(t, n), O = (0, s.default)(t, n), L = (0, c.default)(t, n, h.ChannelTypes.GUILD_TEXT), x = (0, c.default)(t, n, h.ChannelTypes.GUILD_VOICE), y = (0, f.default)(t), V = (0, r.default)({
                        id: t.id,
                        label: T.default.Messages.COPY_ID_CHANNEL
                    }), b = (0, m.default)(t, "title_context_menu");
        ...
        731390: function(e, t, n) {
            ...
            function _(e, t) {
                let n = (0, s.useOpenInPopoutExperiment)(t),
                    u = l.useCallback(() => {
                        r.open("".concat(c.PopoutWindowKeys.CHANNEL_POPOUT, "-").concat(e.id), t => (0, a.jsx)(E, {
                            windowKey: t,
                            channel: e
                        }), {
                            defaultWidth: 854,
        ...
        58622: function(e, t, n) {
            ...
            function f(e) {
                let {
                    ...
                    channel: a,
                    stageInstance: i
                } = e, s = (0, l.useStateFromStores)([d.default, r.default], () => {
                    var e;
                    let t = d.default.getChannels(n.id);
                    return null === (e = t[0, d.GUILD_SELECTABLE_CHANNELS_KEY].find(e => r.default.can(o.Permissions.CREATE_INSTANT_INVITE, e.channel))) || void 0 === e ? void 0 : e.channel
                }), c = (0, l.useStateFromStores)([r.default], () => (0, u.canViewInviteModal)(r.default, n, a, i)), f = E(t, n, c && null != a ? a : s), C = _(t);
                return null == a && t === o.InstantInviteSources.GUILD_CONTEXT_MENU ? null : c || null != s ? f : C
            }
                ...
                render() {
                    ...
                    return (0, a.jsxs)(r.default, {
                        ...
                        children: [(0, a.jsx)("div", {
                            className: u(s.image, f)
                        }), (0, a.jsx)("div", {
                            className: u(s.title, o.marginBottom8),
                            children: e
                        }), (0, a.jsx)("div", {
                            className: u(s.description, o.marginBottom20),
                            children: t
                        }), (0, a.jsxs)(r.default, {
                            justify: r.default.Justify.CENTER,
                            align: r.default.Align.CENTER,

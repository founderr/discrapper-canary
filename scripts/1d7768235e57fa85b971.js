(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["78794"], {
        ...
        736978: function(e, t, r) {
            ...
            var n, s, i, a, o, u, l, d, E = r("486196"),
                _ = r("614247"),
                c = r("821879"),
                I = r("333805"),
                R = r("782340");
            ...
            let N = new Set(["cardNumber", "cvc", "expirationDate", "name"]),
                ...
                L = new Set(["name", "line1", "line2", "city", "state", "postalCode", "country"]);
            ...
            class O extends I.default {
                ...
                hasCardError() {
                    return 2 === (0, c.reducedPaymentInfoExperiment)().bucket ? this._isInFieldSet(D) : this._isInFieldSet(N)
                }
                hasAddressError() {
                    return this._isInFieldSet(L)
                }
                constructor(e, t) {
                    for (let r in super(e, t), this.paymentId = null, 100027 === this.code ? this.message = R.default.Messages.BILLING_ERROR_NEGATIVE_INVOICE_AMOUNT : 50048 === this.code ? this.message = R.default.Messages.BILLING_PAYMENT_SOURCE_INVALID : 100002 === this.code ? this.message = R.default.Messages.BILLING_ERROR_UNKNOWN_PAYMENT_SOURCE : 100042 === this.code ? this.message = R.default.Messages.BILLING_ERROR_PENDING_PAYMENT : 100078 === this.code ? this.message = R.default.Messages.BILLING_TRIAL_REDEMPTION_DISABLED : 429 === this.status ? this.message = R.default.Messages.BILLING_ERROR_RATE_LIMIT : 0 === this.code ? this.message = R.default.Messages.BILLING_ERROR_GENERIC : 400 === this.status && null != this.fields.captcha_key && (this.message = R.default.Messages.BILLING_ERROR_INVALID_CAPTCHA_RESPONSE), this.fields) {
                        let e = f[r] || A[r];
                        if (null != e) {
                            let t = this.fields[r];
            ...
            O.ErrorCodes = n, O.Fields = s, O.Sections = a, O.CARD_ERRORS = N, O.ADDRESS_ERRORS = L;
            var p = O
        },

    ...
    [52171], {
        ...
        661098: (e, n, t) => {
            ...
            function ae() {
                var e, n;
                ce.indices = {};
                ce.oldLocale = null === (e = g.Z.settings.localization) || void 0 === e || null === (n = e.locale) || void 0 === n ? void 0 : n.value
            }
            var ue = function(e) {
                ! function(e, n) {
                ...
                i.getContextState = function(e) {
                    return ve(e) ? null !== (t = this.indices[null !== (n = e.guild_id) && void 0 !== n ? n : e.id]) && void 0 !== t ? t : re : te;
                    var n, t
                };
                i.getUserState = function() {
                    var e;
                    return null !== (e = this.indices[J]) && void 0 !== e ? e : re
                };
                i.query = function(e, n, t) {
                    ...
                    var l, a = this.getContextState(e),
                        u = this.getUserState(),
                        c = S.Z.getGuild(e.guild_id),
                        s = _.Z.can(R.Plq.USE_APPLICATION_COMMANDS, e),
                        d = h.xM.getSetting(),
                        f = null != e.guild_id && null !== (l = y.Z.getViewingRoles(e.guild_id)) && void 0 !== l ? l : void 0,
                        p = null != e.guild_id ? null === (i = O.ZP.getMember(e.guild_id, o.id)) || void 0 === i ? void 0 : i.roles : void 0;
                    N.default.track(R.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
                        miss: null == a.result,
                    ...
                    E.loading = E.loading || v;
                    return E
                };
                return t
            }(f.ZP.Store);
            ue.displayName = "ApplicationCommandIndexStore";
            var ce = new ue(p.Z, {
                LOGOUT: ae,
                CONNECTION_OPEN: ae,
                ...
                APPLICATION_COMMAND_INDEX_FETCH_SUCCESS: function(e) {
                    ...
                    try {
                        for (var s, d = r.applications[Symbol.iterator](); !(a = (s = d.next()).done); a = !0) {
                            var f = s.value,
                                p = {
                                    descriptor: Y(B({}, (0, Z.X0)(ye(f))), {
                                        permissions: null != f.permissions ? (0, m.tk)(ge(f.permissions, i)) : void 0
                                    }),
                                    commands: []
                                };
                            o.push(p);
                        ...
                        for (var g, A = (0, Z.nG)(r.application_commands.map((function(e) {
                                return function(e, n) {
                                    var t, r, i, o, l, a = Y(B({}, e), {
                                        ...
                                        options: null !== (l = null === (t = e.options) || void 0 === t ? void 0 : t.map(he)) && void 0 !== l ? l : [],
                                        permissions: null != e.permissions ? ge(e.permissions, n) : void 0
                                    });
                    ...
                    var _ = null !== (v = r.version) && void 0 !== v ? v : ee;
                    oe(t, {
                        serverVersion: _,
                        result: {
                            sections: o,
                ...
                return i.useMemo((function() {
                    ...
                    var t = {
                        ...
                        i = a.filter((function(e) {
                            ...
                            var r = I.ZP.getScoreWithoutLoadingLatest(t, e);
                            return I.ZP.getScoreWithoutLoadingLatest(t, n) - r
                        })).splice(0, x.hz);
                    return 0 === i.length ? {
                        descriptors: l,
                        commands: a,
                        ...
                        descriptors: [E.Tm[x.bi.FRECENCY]].concat(V(l)),
                        commands: i.concat(a),
                        sectionedCommands: [{
                            section: E.Tm[x.bi.FRECENCY],
                            data: i
                        }].concat(V(u)),
                        loading: c
                    }
            ...
            function fe(e, n, t, o) {
                var l, a = M.Z.useExperiment({
                    ...
                    d = (0, f.e7)([_.Z], (function() {
                        return _.Z.can(R.Plq.USE_APPLICATION_COMMANDS, e)
                    })),
                    p = (0, f.e7)([O.ZP], (function() {
                        var t;
                        if (null != n && null != c) return null === (t = O.ZP.getMember(e.guild_id, c)) || void 0 === t ? void 0 : t.roles
                    })),
                    ...
                    b = function(e, n) {
                        var t = z(i.useState(!0), 2),
                            r = t[0],
                            o = t[1],
                            l = (0,
                                f.cj)([ce], (function() {
                                return ce.getContextState(e)
                            }));
                        i.useEffect((function() {
                            N.default.track(R.rMx.APPLICATION_COMMAND_CACHE_FETCH, {
                                miss: null == l.result,
                                size: Object.keys(ce.indices).length
                            })
                        }), [l]);
                        i.useEffect((function() {
                            if (r && me(l) && n && ve(e)) {
                    ...
                    g = function(e, n) {
                        var t = z(i.useState(!0), 2),
                            o = t[0],
                            l = t[1],
                            a = (0, f.cj)([ce], (function() {
                                return ce.getUserState()
                            })),
                            u = U.useExperiment({
                                location: n
                            });
                        i.useEffect((function() {
                            if (o) {
                                me(a) && e && u.userAppsTreatment === r.ALLOWED && T.aA({
                                    type: "user"
                                });
                                l(!1)
                            }
                ...
                }), [e, n, c, p, v, t.commandType, t.text, t.builtIns, o.sortByScore, m, s, A, a, b, g])
            }
            ...
            function pe(e) {
                var n, t, r = e.context,
                    ...
                    T = void 0 !== N && N,
                    w = null == p ? void 0 : p.toLowerCase(),
                    M = null == w ? void 0 : w.split(" "),
                    P = r.channel.guild_id,
                    j = null != l,
                    U = j ? Object.keys(l) : o,
                    F = r.channel.isThread() ? r.channel.parent_id : r.channel.id;
                u()(null != F, "permissions channel id is null");
                var W, k, H = _.Z.computePermissions(r.channel, void 0, l),
                    X = null != P && !d.Z.has(H, R.Plq.ADMINISTRATOR),
                    G = y === L.D.ONLY_TEXT,
                    z = y !== L.D.DENY ? (0, E.Kh)(f, !0, G) : [],
                    K = z.length > 0 ? [{
                        descriptor: E.Tm[x.bi.BUILT_IN],
                        commands: z
                    }] : [],
                    Q = g ? V(null !== (W = null === (n = a.result) || void 0 === n ? void 0 : n.sections) && void 0 !== W ? W : []).concat(V(null !== (k = null === (t = c.result) || void 0 === t ? void 0 : t.sections) && void 0 !== k ? k : [])) : [];
                Q.sort((function(e, n) {
                    return e.descriptor.name.localeCompare(n.descriptor.name)
                }));
                var q, J = V(Q).concat(V(K));
                q = r.channel.isPrivate() ? r.channel.type === R.d4z.DM ? v.u_.BOT_DM : v.u_.PRIVATE_CHANNEL : v.u_.GUILD;
                var $, ee = [],
                    ne = !0,
                    te = !1,
                    re = void 0;
                                ...
                                for (var ve, me = le.commands[Symbol.iterator](); !(de = (ve = me.next()).done); de = !0) {
                                    ...
                                    if (!(ye.type !== f || ye.nsfw && !O || null != ye.predicate && !ye.predicate(r) || null != ye.contexts && !ye.contexts.includes(q))) {
                                        ...
                                        if (X) {
                                            ...
                                            if (null == ge && null == ce && null != ye.defaultMemberPermissions && (d.Z.equals(ye.defaultMemberPermissions, Z.BO) || !d.Z.has(H, ye.defaultMemberPermissions))) continue
                                        }
                                        var Se = void 0;
                                        if (C && null != w && null != M) {
                                            if (0 === (Se = T ? -_e(w, ye, le.descriptor) : (0, D.wm)(w, M, ye, le.descriptor))) continue
                                        } else Se = 0;
                                        se.push(Y(B({}, ye), {
                                            score: Se
                                        }))
                ...
                if (C) {
                    ...
                    $.sort((function(e, n) {
                        ...
                        var t = I.ZP.getScoreWithoutLoadingLatest(r, e),
                            i = I.ZP.getScoreWithoutLoadingLatest(r, n);
            ...
            function ve(e) {
                var n;
                return null != e.guild_id || e.type === R.d4z.DM && !0 === (null === (n = C.default.getUser(e.getRecipientId())) || void 0 === n ? void 0 : n.bot)
            }
            ...
            function Ae(e, n, t) {
                var r = e[(0, m.rE)(n, P.Kw.CHANNEL)];
                if (null != r) return r.permission;
                var i = e[(0, m.rE)((0, Z.bD)(t), P.Kw.CHANNEL)];
                return null != i ? i.permission : null
            }

            function Oe(e, n, t, r, i) {
                if (!i) {
                    var o = e[(0, m.rE)(n, P.Kw.USER)];
                ...
                try {
                    for (var s, d = t[Symbol.iterator](); !(a = (s = d.next()).done); a = !0) {
                        var f = s.value,
                            p = e[(0, m.rE)(f, P.Kw.ROLE)];
                        if (null != p) {
                            if (p.permission) return !0;
                            l = !0
                        }
                        if (l) return !1;
                        var v = e[(0, m.rE)(r, P.Kw.ROLE)];
            ...
            function _e(e, n, t) {
                ...
                if (e === o || e === a) return Se.COMMAND_NAME_EXACT;
                if (o.startsWith(e) || (null == a ? void 0 : a.startsWith(e))) return Se.COMMAND_NAME_STARTS_WITH;
                if (e.startsWith(o) || null != a && e.startsWith(a)) return Se.STARTS_WITH_COMMAND_NAME;
                var u = null == t ? void 0 : t.name.toLocaleLowerCase();
                if (u === e) return Se.SECTION_NAME_EXACT;
                if (null == u ? void 0 : u.startsWith(e)) return Se.SECTION_NAME_STARTS_WITH;
                ...
                if (null == c ? void 0 : c.some((function(n) {
                    ...
                    }))) return Se.TAG_STARTS_WITH;
                if (o.includes(e) || (null == a ? void 0 : a.includes(e))) return Se.COMMAND_NAME_CONTAINS;
                if (null == u ? void 0 : u.includes(e)) return Se.SECTION_NAME_CONTAINS;
                var s = n.description.toLocaleLowerCase();
                return (null == s ? void 0 : s.includes(e)) ? Se.COMMAND_DESC_CONTAINS : null != o && l()(e, o) || null != a && l()(e, a) ? Se.COMMAND_NAME_FUZZY : null != u && l()(e, u) ? Se.SECTION_NAME_FUZZY : null != s && l()(e, s) ? Se.COMMAND_DESC_FUZZY : Se.NO_MATCH
            }
        },
        219217: (e, n, t) => {
            t.d(n, {
        ...
        242922: (e, n, t) => {
            ...
            function w(e) {
                ...
                return (0, i.jsx)("div", {
                    className: a()(C().wrapper, r, (n = {}, N(n, C().selectable, d),
                        N(n, C().selected, d && c), n)),
                    style: {
                        width: o,
                        height: l,
                        padding: null != u ? u : 0

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["78579"], {
        ...
        376507: function(e, t, n) {
            ...
            async function m(e) {
                let t = await navigator.credentials.get(i(r, T, e));
                return i(a, v, t)
            }
        },
                ...
                return a.useEffect(() => (c.default.subscribe("USER_CONNECTIONS_LINK_CALLBACK", I), () => {
                    ...
                    children: [(0, r.jsxs)(s.ModalHeader, {
                        ...
                        children: [(0, r.jsx)(s.Text, {
                            className: T.stepHeader,
                            variant: "text-xs/bold",
                            color: "header-secondary",
                            children: g.default.Messages.BIDIRECTIONAL_STEP_HEADER.format({
                                number: 1,
                                total: 2
                            })
                        }), (0, r.jsxs)("div", {
                            className: T.illustration,
                            children: [y, " "]
                        }), (0, r.jsx)(s.Heading, {
                            className: T.title,
                            variant: "heading-xl/extrabold",
                        ...
                        children: [(0, r.jsx)(s.Text, {
                            ...
                            variant: "text-sm/normal",
                            color: "header-secondary",
                            children: g.default.Messages.CONSOLE_REDIRECT_NOTICE.format({
                                redirectUrl: R
                            })
                        })]
                        ...
                        children: (0, r.jsxs)(s.Button, {
                            ...
                            onClick: _,
                            children: [n ? g.default.Messages.RETRY : g.default.Messages.CONTINUE, (0, r.jsx)(p.default, {
            ...
            let d = e => {
                ...
                switch (a) {
                    ...
                    case s.BotTagTypes.OFFICIAL:
                        f = !0, v = c.default.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP, T = c.default.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    case s.BotTagTypes.SERVER:
                        T = c.default.Messages.BOT_TAG_SERVER;
                        break;
                    case s.BotTagTypes.ORIGINAL_POSTER:
                        T = c.default.Messages.BOT_TAG_FORUM_ORIGINAL_POSTER;
                        break;
                    case s.BotTagTypes.STAFF_ONLY_DM:
                        T = c.default.Messages.STAFF_BADGE_TOOLTIP;
                        break;
                    case s.BotTagTypes.AI:
                        f = !0, v = c.default.Messages.AI_GENERATED_TOOLTIP, T = c.default.Messages.AI_TAG;
                        break;
                    case s.BotTagTypes.REMIX:
                        f = !1, T = c.default.Messages.REMIXING_TAG;
                        break;
                    case s.BotTagTypes.BOT:
                    default:
                        T = c.default.Messages.BOT_TAG_BOT
                }
                ...
                let y = e => (0, r.jsxs)("span", {
                    ...
                    children: [h ? null : C, g, (0, r.jsx)("span", {
                        className: u.botText,
                        children: T
                    })]
                });

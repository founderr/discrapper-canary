            ...
            function N(e) {
                var t = e.guildId,
                    ...
                    w = a.useCallback((function() {
                        if (null != N) {
                            if (!(null != m && (null == m ? void 0 : m.size) > 0 && v)) return;
                            N(t, S(m), R, C)
                        } else {
                            if (null == E) return;
                            l.Z.banUser(t, null == E ? void 0 : E.id, R, C)
                        }
                        H(u.jQ.BAN);
                        h()
                    }), [N, H, h, m, v, t, R, C, E]),
                    ...
                    G = null != N && null != m ? d.Z.Messages.BAN_MULTIPLE_CONFIRM_TITLE.format({
        ...
        786170: (e, t, n) => {
            ...
            var d = function(e) {
                var t = function() {
                    ...
                    p = e.responsive,
                    b = e.mediaLayoutType,
                    A = O(e, ["externalRef", "autoPlay", "playOnHover", "responsive", "mediaLayoutType"]),
                    S = !(0,
                        s.e7)([l.Z], (function() {

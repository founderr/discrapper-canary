    ...
    ["87895"], {
        ...
        478098: function(t, e, r) {
            ...
            t.exports = function(t, e, r) {
                ...
                e = o(e) || 0, n(r) && (h = !!r.leading, s = (g = "maxWait" in r) ? a(o(r.maxWait) || 0, e) : s, b = "trailing" in r ? !!r.trailing : b);

                function y(t) {
                    var r = t - v,
                        n = t - d;
                    return void 0 === v || r >= e || r < 0 || g && n >= s
                }

                function w() {
                    var t, r, n, o, a = i();
                    if (y(a)) return x(a);
                    p = setTimeout(w, (r = (t = a) - v, n = t - d, o = e - r, g ? c(o, s - n) : o))
                }

                function x(t) {
                    return (p = void 0, b && l) ? m(t) : (l = u = void 0, f)
                }

                function O() {
                    var t, r = i(),
                        n = y(r);
                    if (l = arguments, u = this, v = r, n) {
                        if (void 0 === p) {
                            ;
                            return d = t = v, p = setTimeout(w, e), h ? m(t) : f
                        }
                        if (g) return clearTimeout(p), p = setTimeout(w, e), m(v)
                    }
                    return void 0 === p && (p = setTimeout(w, e)), f
                }
                return O.cancel = function() {
                    void 0 !== p && clearTimeout(p), d = 0, l = v = u = p = void 0
                }, O.flush = function() {
                    ...
                    let g = t(function() {
                        ...
                        b = () => {
                            ...
                            return u(o.getItem.bind(o))(c.name).then(t => {
                                ...
                                var e;
                                return r(a = c.merge(t, null != (e = n()) ? e : g), !0), d()
                            }).then(() => {

...
(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [32978], {
        32978: (o, e, n) => {
            ...
            const i = function(o, e, n) {
                var i, a = t[o];
                i = "string" == typeof a ? a : 1 === e ? null != n && n.addSuffix ? n.comparison && n.comparison > 0 ? a.one.withPrepositionIn : a.one.withPrepositionAgo : a.one.standalone : e % 10 > 1 && e % 10 < 5 && "1" !== String(e).substr(-2, 1) ? a.dual.replace("{{count}}", String(e)) : a.other.replace("{{count}}", String(e));
                return null != n && n.addSuffix ? n.comparison && n.comparison > 0 ? "za " + i : "prije " + i : i
            };
            var a = n(849526);
            const r = {
                date: (0, a.Z)({

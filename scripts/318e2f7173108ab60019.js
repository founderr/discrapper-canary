        ...
        616918: (e, t, r) => {
            ...
            function N(e) {
                var t = e.startTime,
                    ...
                    D = (0, a.O0)(O.tP.TEXT_DANGER);
                null == y && (y = i === b.WX.EXTERNAL ? v.Z.Messages.STAGE_CHANNEL_HAPPENING_NOW : v.Z.Messages.STAGE_CHANNEL_LIVE_NOW);
                var A = E(o.useState((0,
                        p.ub)(t, d)), 2),
                    Z = A[0],
                    I = Z.startDateTimeString,
                    _ = Z.endDateTimeString,
                    R = Z.currentOrPastEvent,
                    M = Z.upcomingEvent,
                    V = Z.diffMinutes,
                    k = A[1];
                ...
                var L = I;
                null != _ && "" !== _ && (L = v.Z.Messages.START_DATE_TO_END_DATE.format({
                    start: I,
                    end: _
                }));
                var G = o.useMemo((function() {
                        return r === b.p1.CANCELED ? w.CANCELED : r === b.p1.ACTIVE ? w.STARTED : b.$I.has(r) ? w.ENDED : R ? w.READY : M ? w.STARTING_SOON : w.SCHEDULED
                    }), [r, R, M]),
                    H = function(e, t, r, o, i) {
                        switch (e) {
                    ...
                    U = o.useMemo((function() {
                        return function(e) {
                            var t, r = e.timeStatus,
                                ...
                                o = e.textPositive,
                                i = e.textDanger,
                                c = e.endDateTimeString,
                                l = e.startDateTimeString,
                                u = s.Z,
                                a = n,
                                d = "header-secondary";
                            switch (r) {
                ...
                if (null != S) {
                    ...
                    z = v.Z.Messages.GUILD_SCHEDULED_EVENT_RECURRENCE_RULE.format({
                        recurrenceRule: W.toText()
                    })
                }
                return (0, n.jsxs)(C, {
                    className: c()(l, j({}, g().isRecurring, null != z)),
                    tooltipText: Y,
                    children: [N ? (0, n.jsx)(P, {}) : (0, n.jsx)(B, {
                        color: X,
                        width: 20,
                        height: 20
                    }), (0, n.jsxs)("div", {

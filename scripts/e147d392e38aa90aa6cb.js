    ...
    [68093, 14136, 84832, 88110, 96043, 71402, 77357, 56645], {
        ...
        100856: (e, t, n) => {
            ...
            function g(e, t) {
                ...
                if (!S && !_.Z.can(v.Plq.MOVE_MEMBERS, g)) return null;
                var m = n.filter((function(t) {
                    var n = t.channel;
                    return n.id !== g.id && (S ? _.Z.can(v.Plq.CONNECT, n) && !(0, T.rY)(n, I.Z, p.Z) : _.Z.can(v.Plq.MOVE_MEMBERS, n) && (_.Z.can(v.Plq.CONNECT, n) || O.ZP.can({
        ...
        58964: (e, t, n) => {
            ...
            function _(e, t) {
                ...
                var p, _, E, h, I, T = encodeURIComponent(c.toString()),
                    ...
                    S = "".concat(f, "/?link=").concat(T, "&utm_source=").concat(n, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(O, "&efr=").concat(v);

    ...
    [23279, 96043, 71402], {
        971402: (e, t, n) => {
            ...
            function d(e, t, n, r) {
                ...
                if (null == e.currentTarget.contains || e.currentTarget.contains(e.target)) {
                    ...
                    if (0 === d && 0 === p) {
                        var O, g = null === (O = e.target) || void 0 === O ? void 0 : O.getBoundingClientRect(),
                            b = null != g ? g : {},
                            y = b.left,
                            h = void 0 === y ? 0 : y,
                            v = b.top,
        ...
        385028: (e, t, n) => {
            ...
            const s = i.memo((function(e) {
                var t = e.user,
                    ...
                    p = e["aria-hidden"],
                    O = void 0 !== p && p,
                    g = l(e, ["user", "size", "animate", "aria-hidden"]),
                    b = i.useContext(u.Z);
                return (0, r.jsx)(o.Avatar, function(e) {
                    ...
                    src: c(t, (0, o.getAvatarSize)(s), d, b),
                    size: s,
        ...
        396043: (e, t, n) => {
            ...
            function M(e, t) {
                ...
                i()(v.Z.getVoiceStates(e)).forEach((function(e) {
                    e.channelId === t && null != g.Z.findActivity(e.userId, (function(e) {
        ...
        721376: (e, t, n) => {
            ...
            var r = n(785893),
                ...
                O = n(682776),
                g = n(2590),
                b = f.Z.combine(g.Plq.VIEW_CHANNEL, g.Plq.MANAGE_MESSAGES, g.Plq.READ_MESSAGE_HISTORY);
            var y = n(473708);
            ...
            function S(e, t) {
                var f = e.guild_id,
                    ...
                    _ = (0, u.e7)([l.ZP], (function() {
                        return l.ZP.getIsItemFeatured(h)
                    }), [h]),
                    S = (0, s.Xb)(e),
                    P = function(e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            ...
                            o = (0, d.N2)(i, !1);
                        return !!(r && null !== n && o && (null != e.parentChannelThreadType && g.TPd.GUILD_THREADS_ONLY.has(e.parentChannelThreadType) || t) && (0, c.fx)(e))
                    }(e);
                return S && P ? _ ? (0, r.jsx)(a.MenuItem, {
                    id: "guild-feed-unfeature",
                    label: y.Z.Messages.GUILD_FEED_UNFEATURE_FORUM_POST,
                    action: function() {
                    ...
                    label: y.Z.Messages.GUILD_FEED_FEATURE_FORUM_POST,
        ...
        165586: (e, t, n) => {
            ...
            var b = [g(r.RESOLUTION_720), g(r.RESOLUTION_1080), g(r.RESOLUTION_1440), g(r.RESOLUTION_SOURCE, (function() {
                    return c.Z.Messages.SCREENSHARE_SOURCE
                }))],
                y = [g(r.RESOLUTION_720), g(r.RESOLUTION_1080), g(r.RESOLUTION_1440)],
                h = function(e) {
                    return "".concat(e, "p")
                },
                v = [g(r.RESOLUTION_480, (function() {
                    return h(r.RESOLUTION_480)
                })), g(r.RESOLUTION_720, (function() {
                    return h(r.RESOLUTION_720)
                })), g(r.RESOLUTION_1080, (function() {
                    return h(r.RESOLUTION_1080)
                })), g(r.RESOLUTION_1440, (function() {
                    return h(r.RESOLUTION_1440)
                })), g(r.RESOLUTION_SOURCE, (function() {
                    return c.Z.Messages.SCREENSHARE_SOURCE
                }))],
                _ = [g(i.FPS_15), g(i.FPS_30), g(i.FPS_60)],
                m = [g(i.FPS_15, (function() {
        ...
        189651: (e, t, n) => {
            ...
            function S(e, t) {
                p.default.track(b.rMx.VIEW_AS_ROLES_SELECTED, m(_({
                    num_roles: Object.keys(t.roles).length
                }, (0, i.hH)(e)), {
                    is_viewing_as_member: t.type === g.z.NEW_MEMBER
                }));
                r.Z.dispatch({
            ...
            function I(e) {
                var t = f.Z.getChannelId(e),
                    n = u.Z.getChannel(t);
                if (!(null != t && (0, y.AB)(t)) && !s.Z.can(b.Plq.VIEW_CHANNEL, n)) {
                    var r = a.ZP.getDefaultChannel(e);
                    null != r && (0, o.uL)(b.Z5c.CHANNEL(e, r.id))
                }
            }
        ...
        489981: (e, t, n) => {
            ...
            var h = function(e) {
                ...
                r.recentlyFetched = function() {
                    return (new Date).getTime() - y < 1 * o.Z.Millis.MINUTE
                };
            ...
            const v = new h(i.Z, {
                SAVED_MESSAGES_UPDATE: function(e) {
                    ...
                    t.forEach((function(e) {
                        null != e.dueAt && e.dueAt > new Date && b.delete(e.messageId);
                        null != e.dueAt && e.dueAt < new Date && b.add(e.messageId)
                    }))
                },
        ...
        18882: (e, t, n) => {
            ...
            function K(e) {
                var t = d.ZP.getMentionCount(e.id) > 0,
                    n = d.ZP.hasRelevantUnread(e) && (!g.Z.isMuted(e.id) || t) || (0, l.c)() && t,
        ...
        225386: (e, t, n) => {
            ...
            function y(e, t) {
                return m((0, u.e7)([p.Z], (function() {
                    var t = e.isForumLikeChannel() ? g.Plq.SEND_MESSAGES : o.Z.combine(g.Plq.CREATE_PUBLIC_THREADS, g.Plq.READ_MESSAGE_HISTORY);
                    return p.Z.can(t, e)
                }), [e]), e, t)
            }

            function h(e, t) {
                var n = e.isForumLikeChannel() ? g.Plq.SEND_MESSAGES : o.Z.combine(g.Plq.CREATE_PUBLIC_THREADS, g.Plq.READ_MESSAGE_HISTORY);
                return m(p.Z.can(n, e), e, t)
            }

            function v(e) {
                var t = (0, u.e7)([p.Z], (function() {
                    return p.Z.can(o.Z.combine(g.Plq.CREATE_PRIVATE_THREADS), e)
                }), [e]);
                return e.type === g.d4z.GUILD_TEXT && m(t, e)
            }
            ...
            function m(e, t, n) {
                ...
                if (null != n) {
                    if (n.hasFlag(g.iLy.HAS_THREAD)) return !1;
                    if ((0, c.Z)(n)) return !1
                }
                return !0
            }
            ...
            function E(e) {
                ...
                return function(e, t, n) {
                    ...
                    return p.Z.can(g.Plq.VIEW_CHANNEL, t)
                }), [t]), e, t)
            }
                ...
                return (0, u.cj)([O.Z, p.Z], (function() {
                    var t = O.Z.getActiveJoinedThreadsForParent(e.guild_id, e.id),
                        ...
                        o = i()(n).some((function(e) {
                            return p.Z.can(g.Plq.VIEW_CHANNEL, e.channel)
                        })),
                        u = i()(t).some((function(e) {
                            return !(e.channel.id in n) && p.Z.can(g.Plq.VIEW_CHANNEL, e.channel)
                        })),
                        a = i()(r).some((function(e) {
                            return p.Z.can(g.Plq.VIEW_CHANNEL, e)
                        }));
                    return {
            ...
            function P(e) {
                var t = (0, u.e7)([d.Z], (function() {
                    ...
                    n = (0, u.e7)([p.Z], (function() {
                        return null != t && p.Z.can(g.Plq.MANAGE_THREADS, t)
                    }), [t]),
            ...
            function C(e) {
                var t, n = (0, u.e7)([p.Z], (function() {
                    return null != e && p.Z.can(g.Plq.SEND_MESSAGES_IN_THREADS, e)
                }));
            ...
            function A(e) {
                var t;
                return null != e && (!e.isThread() || e.isActiveThread() || e.isArchivedThread() && !0 !== (null === (t = e.threadMetadata) || void 0 === t ? void 0 : t.locked) && p.Z.can(g.Plq.SEND_MESSAGES_IN_THREADS, e))
            }

            function R(e) {
                var t = p.Z.can(g.Plq.MANAGE_THREADS, e);
            ...
            function Z(e) {
                var t = (0, l.Z)(),
                    n = (0, u.e7)([p.Z], (function() {
                        return p.Z.can(g.Plq.CONNECT, e)
                    })),
                    r = C(e),
                    i = b.useExperiment({
                        guildId: e.guild_id,
        ...
        95891: (e, t, n) => {
            ...
            function l(e) {
                var t = e.width,
                    ...
                    O = e.foreground,
                    g = a(e, ["width", "height", "color", "viewBox", "foreground"]);
                return (0, r.jsx)("svg", u(function(e) {
                    for (var t = 1; t < arguments.length; t++) {
                        var n = null != arguments[t] ? arguments[t] : {},
                            r = Object.keys(n);
                    ...
                    function e(t) {
                        ...
                        this.languageDetector = new p(i, (function(e) {
                            ...
                            if (-1 !== t.indexOf(r)) n.setLocale(r);
                                ...
                                var o, a = null !== (o = u[e]) && void 0 !== o ? o : O[i];

(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    [67147], {
        ...
        193694: (e, t, n) => {
            ...
            function h() {
                h = c((function(e, t, n, a, l) {
                    var E, f, d, _, p, S, O, N, I, A, h, T, M;
                        ...
                        switch (g.label) {
                            ...
                            case 19:
                                ...
                                r.Z.dispatch({
                                    ...
                                    message: null !== (M = null === (T = h.body) || void 0 === T ? void 0 : T.message) && void 0 !== M ? M : Object.values(h.body)[0]
                                });
                                return [2];
                            case 20:
                                r.Z.dispatch({
        ...
        189651: (e, t, n) => {
            ...
            function M(e, t) {
                d.default.track(S.rMx.VIEW_AS_ROLES_SELECTED, h(A({
                ...
                if (null != n) {
                    ! function(e, t) {
                        ...
                        a.ZP.addConditionalChangeListener((function() {
                            ...
                            var o = T(a.ZP.getSelectableChannelIds(e)).concat(T(a.ZP.getVocalChannelIds(e))).filter((function(e) {
                                return !n.includes(e)
                            }));
                            o.length > 0 && y(e, o, []);
                            return !1
        ...
        361557: (e, t, n) => {
            ...
            const N = function(e) {
                var t = e.className,
                    ...
                    I = e.onPrevPressed,
                    A = e.onComplete,
                    h = e.sequencerClassName,
                    T = e.initialStep,
                    M = void 0 === T ? 0 : T,
                    g = e.forceStep,
                    b = e.submitting,
                    m = void 0 !== b && b,
                    y = e.autoCloseOnComplete,
                    v = void 0 === y || y,
                    P = _(o.useState([]), 2),
                    L = P[0],
                    C = P[1],
        ...
        834883: (e, t, n) => {
            ...
            const de = function(e) {
                ...
                var i, s = (0, l.cj)([h.Z], (function() {
                    ...
                    Y = null == s ? void 0 : s.getRole(null == s ? void 0 : s.id),
                    k = (0, l.e7)([b.ZP], (function() {
                        return null != s ? b.ZP.getChannels(s.id) : null
                    }), [s]),
                    H = (0, P.Dt)(),
                ...
                k[b.sH].forEach((function(e) {
                    var t = e.channel;
                    t.type === S.d4z.GUILD_TEXT && K.push({
                        value: t.id,
                        label: (0, d.F6)(t, v.default, y.Z, !0)
                    })
                }));
                var W, X, z = B !== S.sFg.NONE,
                    ...
                    ce = (X = (W = function() {
                        ...
                        return oe(this, (function(o) {
                            switch (o.label) {
                                case 0:
                                    if (null == Y || !E) return [2];
                                    (e = new Set(s.features)).add(S.oNc.COMMUNITY);
                                    t = N ? a.Z.remove(Y.permissions, j.mu) : Y.permissions;
                                    r = ne(te({}, Y), {
                                        permissions: t
                                    });
                                    return t === Y.permissions ? [3, 2] : [4, (0, A.Gf)(s.id, [r])];
                                case 1:
                                    o.sent();
                                    o.label = 2;
                                case 2:

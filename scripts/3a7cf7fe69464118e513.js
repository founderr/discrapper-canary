            ...
            function i(t) {
                let r = function(t) {
                    let {
                        ...
                        cos: i,
                        round: u
                    } = Math, f = t[0] | t[1] << 8 | t[2] << 16, c = t[3] | t[4] << 8, s = (63 & f) / 63, a = (f >> 6 & 63) / 31.5 - 1, h = (f >> 12 & 63) / 31.5 - 1, v = f >> 23, l = (c >> 3 & 63) / 63, p = (c >> 9 & 63) / 63, b = c >> 15, g = e(3, b ? v ? 5 : 7 : 7 & c), m = e(3, b ? 7 & c : v ? 5 : 7), x = v ? (15 & t[5]) / 15 : 1, d = (t[5] >> 4) / 15, y = v ? 6 : 5, w = 0, T = (r, n, o) => {
                        let e = [];
                        for (let i = 0; i < n; i++)
                            for (let u = i ? 0 : 1; u * n < r * (n - i); u++) e.push(((t[y + (w >> 1)] >> ((1 & w++) << 2) & 15) / 7.5 - 1) * o);
                        return e
                    }, _ = T(g, m, (f >> 18 & 31) / 31), k = T(3, 3, 1.25 * l), E = T(3, 3, 1.25 * p), z = v && T(5, 5, d), C = o(t), M = u(C > 1 ? 32 : 32 * C), O = u(C > 1 ? 32 / C : 32), R = new Uint8Array(M * O * 4), S = [], j = [];
                    for (let t = 0, o = 0; t < O; t++)
                        for (let u = 0; u < M; u++, o += 4) {
                            let f = s,
                                ...
                                l = h,
                                p = x;
                            for (let t = 0, n = e(g, v ? 5 : 3); t < n; t++) S[t] = i(r / M * (u + .5) * t);
                            for (let n = 0, o = e(m, v ? 5 : 3); n < o; n++) j[n] = i(r / O * (t + .5) * n);
                            for (let t = 0, r = 0; t < m; t++)
                                for (let n = t ? 0 : 1, o = 2 * j[t]; n * m < g * (m - t); n++, r++) f += _[r] * S[n] * o;
                            for (let t = 0, r = 0; t < 3; t++)
                                for (let n = t ? 0 : 1, o = 2 * j[t]; n < 3 - t; n++, r++) {
                                    let t = S[n] * o;
                                    c += k[r] * t, l += E[r] * t
                                }
                            if (v)
                                for (let t = 0, r = 0; t < 5; t++)
                                    for (let n = t ? 0 : 1, o = 2 * j[t]; n < 5 - t; n++, r++) p += z[r] * S[n] * o;
                            let b = f - 2 / 3 * c,
                                d = (3 * f - b + l) / 2,
                                y = d - l;
                            R[o] = e(0, 255 * n(1, d)), R[o + 1] = e(0, 255 * n(1, y)), R[o + 2] = e(0, 255 * n(1, b)), R[o + 3] = e(0, 255 * n(1, p))
                        }
                    return {
                        w: M,
                        h: O,

    ...
    [20554], {
        20554: (e, n, t) => {
            ...
            var v, h, d = function(e, n) {
                ...
                I = Math.min(4, Math.ceil(navigator.hardwareConcurrency / 2)),
                    ...
                    return d(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return [3, 1];
                            case 1:
                                return [4, t.e(14096).then(t.t.bind(t, 507167, 23)).then((function(e) {
                                    h = e.default
                                }))];
                            case 2:
                                n.sent();
                                for (e = 0; e < I; e++) b.push({
                                    worker: new h,
                                    numActive: 0
                                });
                                n.label = 3;
                ...
                A = (0, o.G)(u((function() {
                    ...
                    return d(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, t.e(30881).then(t.bind(t, 130881))];
                            case 1:
                                e = n.sent();
                                v = e.default;
                                return [2]
            ...
            var E = function() {
                function e(n) {
                    ...
                    this.initializationPromise = p ? m().then((function() {
                        var e, n, a;
                            ...
                            switch (s.label) {
                                ...
                                case 1:
                                    ...
                                    if (p) {
                                        ...
                                        if (null == (a = y.get(e.canvasId))) throw new Error("No worker index assigned for asset ".concat(e.canvasId));
                                        y.delete(e.canvasId);
                                        b[a].numActive--
                ...
                ! function(e, n, t) {
                    ...
                    key: "workerIndex",
                    get: function() {
                        var e = y.get(this.canvasId);
                        if (null == e) {
                            var n = w.get(this.assetUrl);
                            if (null != n) e = n;
                            else {
                                var t, r, i = null !== (r = null === (t = b[0]) || void 0 === t ? void 0 : t.numActive) && void 0 !== r ? r : 0,
                                    a = !0,
                                    o = !1,
                                    s = void 0;
                                try {
                                    for (var l, u = b.entries()[Symbol.iterator](); !(a = (l = u.next()).done); a = !0) {
                                        var c = f(l.value, 2),
                                            v = c[0],
                                            h = c[1];
                                        if (h.numActive <= i) {
                                ...
                                w.set(this.assetUrl, e)
                            }
                            y.set(this.canvasId, e);
                            b[e].numActive++
                        }
                        return e
                    }
                    ...
                    get: function() {
                        ...
                        if (null == b[e]) throw new Error("No worker in pool at index ".concat(e));
                        return b[e].worker
                    }
                }]);
                return e

    ...
    ["27660"], {
        ...
        783480: function(e, t, n) {
            ...
            function N(e) {
                ...
                let c, {
                    ...
                    U = new f.default(C.Endpoints.MESSAGES(d)),
                    j = {
                        content: "",
                        nonce: "",
                        channel_id: d,
                        type: C.MessageTypes.DEFAULT,
                        sticker_ids: null == y ? void 0 : y.stickerIds,
                        poll: null == y ? void 0 : y.poll
                    };
                null != M && (j.content = null == M ? void 0 : M.content);
                let b = _.default.getPendingReply(d);
                null != b && (j.type = C.MessageTypes.REPLY, j.message_reference = y.messageReference, j.allowed_mentions = y.allowedMentions, (0, R.deletePendingReply)(d));
                let [x, P] = (0, g.default)(j.content);
                x && (j.content = P, j.flags = (0, I.addFlag)(null !== (t = j.flags) && void 0 !== t ? t : 0, C.MessageFlags.SUPPRESS_NOTIFICATIONS));
                let L = null !== (n = y.nonce) && void 0 !== n ? n : (0, p.createNonce)(),
                    D = (0, p.default)({
                        channelId: d,
                        content: j.content,
                        ...
                        flags: j.flags,
                        nonce: L,
                        poll: (0, T.createPollServerDataFromCreateRequest)(y.poll)
                    });
                j.nonce = L, U.on("start", e => {
                    c = (0, h.createMessageRecord)({
                        ...D,
                        id: e.id
                    }), a.default.dispatch({
                        type: "UPLOAD_START",
                ...
                U.on("error", (e, t, n, i) => {
                    if (a.default.dispatch({
                        ...
                        }), t === C.AbortCodes.EXPLICIT_CONTENT) {
                        l.default.sendClydeError(d, t);
                        return
                    }
                    if (t === C.AbortCodes.AUTOMOD_MESSAGE_BLOCKED) {
                        let e = {
                                code: t,
                        ...
                        (0, r.openUploadError)({
                            ...
                            help: (0, m.getAutomodErrorMessage)(i, e)
                        });
                        return
                    }
                    t !== C.AbortCodes.GUILD_FILE_UPLOAD_RATE_LIMITED_ACCESS && ((0, r.openUploadError)({
                        title: O.default.Messages.UPLOAD_AREA_UPLOAD_FAILED_TITLE,
                        help: O.default.Messages.UPLOAD_AREA_UPLOAD_FAILED_RETRY_HELP
                    }), "" !== j.content && "" === S.default.getDraft(d, v) && s.default.saveDraft(d, j.content, v), 0 === A.default.getUploadCount(d, v) && o.default.setUploads({
                        channelId: d,
                        uploads: N,
                        draftType: v
                    }))
            ...
            var v = {
                ...
                upload: function e(t) {
                    ...
                    if (null != c) {
                        ...
                        let e = _.default.getPendingReply(n);
                        if (null != e) {
                            let t = l.default.getSendMessageOptionsForReply(e);
                            h.type = C.MessageTypes.REPLY, h.message_reference = t.messageReference, h.allowed_mentions = t.allowedMentions, (0, R.deletePendingReply)(n)
                        }
                    }
                    let p = new f.default(C.Endpoints.MESSAGES(n));
                    p.on("start", e => {
                        a.default.dispatch({
                            type: "UPLOAD_START",
                            channelId: n,
                        ...
                        if (a.default.dispatch({
                                ...
                                fileItems: t.items,
                                failureCode: d
                            }), d === C.AbortCodes.EXPLICIT_CONTENT) {
                        ...
                        }), "" !== h.content && "" === S.default.getDraft(n, u) && s.default.saveDraft(n, h.content, u)
                    }), p.on("complete", e => {
                        a.default.dispatch({
                            type: "UPLOAD_COMPLETE",
                            channelId: n,
        ...
        57155: function(e, t, n) {
            ...
            class Z extends a.PureComponent {
                render() {
                    ...
                    }(e, 24, z.emoji, l(z.emoji, z.emojiText)), c = s === O.ReactionTypes.BURST, f = c ? W.default.Messages.BURST_REACTION_REACTORS_A11Y : W.default.Messages.REACTION_REACTORS_A11Y, m = f.format({
                        name: r,
                        n: t
                    }), p = {}, E = {};
                    if (c) {
                        ...
                        if (E.color = i, n) {
                            var T;
                            p.background = null !== (T = (0, d.hex2rgb)(e, t)) && void 0 !== T ? T : ""
                        }
                    }
            ...
            function Q(e) {
                let {
                    ...
                    reactionType: o,
                    onRemoveReactor: u
                } = e, c = k.default.getCurrentUser(), d = (0, f.useStateFromStores)([k.default], () => k.default.getUser(n.id), [n]);
                r(null != c, "Reactor: currentUser cannot be undefined");
                let m = (0, U.useIsActiveChannelOrUnarchivableThread)(s),
                    p = (0, f.useStateFromStores)([D.default], () => D.default.can(Y.Permissions.MANAGE_MESSAGES, s) && m),
                    R = p || c.id === n.id,
                    _ = (0, f.useStateFromStores)([x.default, b.default, B.default], () => H.default.getName(l, s.id, n));
                    ...
                    children: [(0, i.jsx)(F.default.Child, {
                        ...
                        children: (0, i.jsxs)(h.Text, {
                            ...
                            children: [null != _ && "" !== _ && (0, i.jsx)("span", {
                                ...
                                user: n,
                                className: null != _ && "" !== _ ? z.tagFaded : null,
            ...
            let ee = f.default.connectStores([P.default], e => {
                let {
                    message: t,
                    reaction: n,
                    reactionType: i
                } = e, a = P.default.getReactions(t.getChannelId(), t.id, n.emoji, Y.DEFAULT_NUM_REACTION_USERS, i);
                if (null == a) return {
                    reactors: [],
                    hasMore: !1
                };
                let s = Object.values(a),
                    l = i === O.ReactionTypes.BURST ? n.burst_count : n.count,
                    o = l > s.length;
                return {
                    reactors: s,
                    hasMore: o
            ...
            function et(e) {
                ...
                let {
                    ...
                    onClose: o,
                    transitionState: r
                } = e, u = (0, f.useStateFromStores)([b.default], () => b.default.getChannel(s.getChannelId())), c = null == u ? void 0 : u.getGuildId(), d = (0, f.useStateFromStores)([L.default, A.default, C.default], () => {
                    var e, t, n;
                    let i = null !== (n = null !== (t = L.default.getMessage(s.getChannelId(), s.id)) && void 0 !== t ? t : null === (e = A.default.getMessage(s.id)) || void 0 === e ? void 0 : e.firstMessage) && void 0 !== n ? n : null != c ? C.default.getCachedMessage(c, s.getChannelId(), s.id) : void 0;
                    return null != i ? i.reactions : []
                }, [s, c]), {
                    enabled: p
                } = (0, R.useBurstReactionsExperiment)(c);
                let E = (t = d, n = p, a.useMemo(() => {
                        let e = [];
                        return t.forEach(t => {
                    ...
                    g = null != T ? {
                        emoji: T.emoji,
                        reactionType: T.burst_count > 0 ? O.ReactionTypes.BURST : O.ReactionTypes.NORMAL
                    } : null,
                    [N, v] = function(e, t, n) {
                    ...
                    M = a.useMemo(() => {
                        var e;
                        return null == N ? null : null !== (e = d.find(e => (0, y.emojiEquals)(e.emoji, N.emoji))) && void 0 !== e ? e : null
                    }, [d, N]),
                    U = (0, f.useStateFromStores)([_.default], () => _.default.saturation),
                    x = (0, f.useStateFromStores)([j.default], () => (0, m.isThemeDark)(j.default.theme));
                if (a.useEffect(() => {
                        ...
                        children: [(0, i.jsx)(h.Scroller, {
                            ...
                            children: E.map(e => {
                                ...
                                return (0, i.jsx)(Z, {
                                    ...
                                    colors: null != e.burst_colors ? (0, S.buildEmojiColorPalette)(e.burst_colors, U, x) : void 0
        ...
        58533: function(e, t, n) {
            ...
            function T(e) {
                ...
                }, [n.name, n.id]), M = R.x - R.width / 2 * .5, y = R.y - R.height / 2 * .5, U = (0, l.useSpring)({
                    from: {
                        y: T.y
                    },
                    to: {
        ...
        13066: function(e, t, n) {
            ...
            var E = e => {
                let {
                    ...
                    closePopout: a,
                    ctaRef: E
                } = e, T = (0, c.useUID)(), [R, _] = l.useState(!1), g = (0, o.useStateFromStores)([f.default], () => f.default.isLurking(i.id), [i.id]);
                l.useEffect(() => {
                    R && !g && a()
                }, [R, g, a]);
                let S = null,
            ...
            var m = new f(l.default, {
                ...
                BURST_REACTION_EFFECT_PLAY: e => {
                    ...
                    let m = null !== (t = r[a]) && void 0 !== t ? t : {},
                        ...
                        E = m[f];
                    if ("HOVER" !== o || null == E) {
                        "HOVER" === E && "EXTERNAL" === o && null != p && ("function" == typeof p.destroy && p.destroy(), null === (i = u[a]) || void 0 === i || delete i[f], E = void 0);
                        null == E && (null != r[a] ? r[a][f] = o : r[a] = {
                            [f]: o
                        })
                    }
                },
        ...
        331011: function(e, t, n) {
            ...
            function f(e, t) {
                ...
                let _ = {
                    ...
                    g = T ? _.burst : _.standard,
                    S = null !== (n = T ? null == E ? void 0 : E.burst_count : null == E ? void 0 : E.count) && void 0 !== n ? n : 0,
        ...
        350134: function(e, t, n) {
            ...
            class eE extends a.PureComponent {
                        ...
                        children: [(0, i.jsx)(h.Popout, {
                            ...
                            children: () => (0, i.jsx)("div", {
                                ...
                                children: (0, i.jsx)(r.default.div, {
                                    className: l(P.reaction, R, {
                                        [P.reactionMe]: this.isMe(),
                                        [P.reactionReadOnly]: f && !m && !T && !E,
                                        [P.shakeReaction]: A && O && null == v
                                    }),
                                    style: L,
                                    children: (0, i.jsx)(h.Popout, {
                ...
                constructor(...e) {
                    super(...e), this.isReactionEventActive = !1, this.isKeyboardNavigation = !1, this.scale = new r.default.Value(1), this.opacity = new r.default.Value(1), this.timeout = new f.Timeout, this.hideTimeout = new f.Timeout, this.ctaRef = a.createRef(), this.type = $.ReactionTypes.NORMAL, this.colors = {
                        ...
                        let {
                            hasUnlimited: e
                        } = T.BurstReactionsUserExperiment.getCurrentConfig({
                        ...
                        } = this.props, m = k.default.getChannel(t.getChannelId());
                        if (l || o) {
                            var h, p;
                            null === (p = this.ctaRef) || void 0 === p || null === (h = p.current) || void 0 === h || h.focus();
                            return
                        }
                        let E = t.getChannelId(),
                            T = r ? L.ReactionLocations.FORUM_TOOLBAR : L.ReactionLocations.MESSAGE;
                        if (a && !i && this.isMe()) c ? (0, L.removeReaction)(E, t.id, n, void 0, T, {
                            burst: a
                            ...
                            if (a && !this.userCanBurstReact()) {
                                ...
                                return
                            } else s ? this.handleShowVerificationGate() : !i && (this.isMe() ? (0, L.removeReaction)(E, t.id, n, void 0, T) : (0, L.addReaction)(E, t.id, n, T, {
                                burst: a
                            }))
                        } else {
                            (0, P.openBurstReactionsUpsellModal)({
                                analytics: {
                                    ...
                                    page: (null == m ? void 0 : m.getGuildId()) != null ? el.AnalyticsPages.GUILD_CHANNEL : el.AnalyticsPages.DM_CHANNEL,
                                    section: null != m ? (0, D.getBurstAnalyticsSection)(m) : void 0,
                                    object: el.AnalyticsObjects.EMOJI_REACTION_UPSELL
                                }
                            });
                            return
                        }
                        a && this.isMe() && f && ((0, q.toggleFreeUserSentPopout)(null), (0, g.markDismissibleContentAsDismissed)(d.DismissibleContent.SUPER_REACTIONS_FREE_USER_FIRST_SENT))
                    }, this.handleEnter = e => {
                        let {
                            emoji: t,
                            message: n,
                        ...
                        let {
                            ...
                            message: n,
                            isLurking: a
                        } = this.props, s = k.default.getChannel(n.getChannelId()), l = F.default.getGuild(null == s ? void 0 : s.getGuildId());
                        return a && null != l ? (0, i.jsx)(U.default, {
                            ctaRef: this.ctaRef,
                            type: U.LurkerModeUpsellPopoutTypes.REACTIONS,
                            guild: l,
                            closePopout: t
                        }) : (0, i.jsx)(i.Fragment, {})
                        ...
                        }, E = "string" == typeof d, T = E ? "" === d.trim() : null == d, R = () => T || null == d ? null : (0, i.jsx)(h.Text, {
                            variant: "text-sm/normal",
                            className: ef.reactionTooltipText,
                            "aria-label": d,
                            children: d
                        });
                        if (n === $.ReactionTypes.BURST) {
                            ...
                            return (0, i.jsxs)(m.Dialog, {
                                className: ef.reactionTooltip,
                                onMouseEnter: this.handleEnterTooltip,
                                onMouseLeave: this.handleLeave,
                                children: [(0, i.jsxs)(h.Clickable, {
                                    className: ef.burstReactionTooltipInner,
                                    onClick: f,
                                    children: [(0, i.jsxs)("div", {
                                        className: l(ef.burstReactionTooltipMessage, {
                                            [ef.burstReactionTooltipSpacer]: u
                                        }),
                                        children: [(0, i.jsx)(p.default, {
                                            className: ef.reactionTooltipEmoji,
                                            emojiId: e.id,
                                            emojiName: e.name,
                                            animated: e.animated,
                                        ...
                                        className: ef.burstReactionTooltipPrompt,
                                        children: [(0, X.isPremium)(t) && (0, i.jsx)(z.default, {
                                            className: ef.burstReactionTooltipNitroIcon,
                                            ...
                                            children: [(0, i.jsx)(h.Text, {
                                                ...
                                                className: ef.burstAnimatedCounter,
                                                value: null != a ? a : 0,
                                                animationSpeed: 600,
                                            ...
                                            children: (0, X.isPremium)(t) ? (0, i.jsx)(h.Text, {
                                                ...
                                                children: !this.isKeyboardNavigation && (0, i.jsxs)("div", {
                                                    children: [(0, i.jsx)(h.Text, {
                                                        ...
                                                        className: ef.burstReactionTooltipUpsellCta,
                        ...
                        return (0, i.jsxs)(m.Dialog, {
                            ...
                            children: [(0, i.jsx)(h.Clickable, {
                                onClick: f,
                                children: (0, i.jsxs)("div", {
                                    className: ef.reactionTooltipInner,
                                    children: [(0, i.jsx)(p.default, {
                                        className: ef.reactionTooltipEmoji,
                                        emojiId: e.id,
                                        emojiName: e.name,
            ...
            let eT = a.memo(e => {
                    let {
                        ...
                        hasSendAnimation: f,
                        hasUnlimited: m
                    } = (0, T.useBurstReactionsExperiment)(), {
                        autoUnfurlReactionTooltip: h
                    } = (0, v.useInventoryGuildPacksUserExperiment)({
                        autoTrackExposure: !1
                    }), p = (0, C.useEmojiColorPalette)(l && null != n ? n : []), E = (0, c.useStateFromStores)([Z.default], () => void 0 !== Z.default.getEffectForEmojiId(a.getChannelId(), a.id, s)), _ = (0, c.useStateFromStores)([R.default], () => R.default.useReducedMotion), S = B.AnimateEmoji.useSetting(), A = (0, g.isDismissibleContentDismissed)(d.DismissibleContent.BURST_REACTIONS_REMOVE_MODAL), [I, O] = (0, c.useStateFromStoresArray)([Q.default], () => [Q.default.remainingBurstCurrency, Q.default.emojiReactionToTargetForCoachmark]), N = G.default.getCurrentUser(), M = (0, X.isPremium)(N), y = (0, g.isDismissibleContentDismissed)(d.DismissibleContent.SUPER_REACTIONS_FREE_USER_FIRST_SENT), U = o && !(0, X.isNewUser)(N) && I > 0 && !y && null != O && s.id === O.id && s.name === O.name;
                    U && M && ((0, q.toggleFreeUserSentPopout)(null), (0, g.markDismissibleContentAsDismissed)(d.DismissibleContent.SUPER_REACTIONS_FREE_USER_FIRST_SENT));
                    let j = (0, c.useStateFromStores)([Z.default], () => Z.default.getReactionPickerAnimation(a.id, s.name, s.id)),
                        x = l && (E || null != j && f);
                    return (0, i.jsx)(eE, {
                        ...e,
                        colors: p,
                        ...
                        reduceMotion: _,
                        animateEmoji: S,
                        hasDismissedRemoveModal: A,
                        shouldShowFreeUserSentCoachmark: U,
                        onRenderFreeUserSentPopout: () => (0, i.jsx)(b.default, {}),
                        hasBurstShake: r,
                        hasBurstGlow: u,
                        animationStartPosition: j,
                        hasBurstSendAnimation: f,
                        hasUnlimitedBurstReactions: m,
                        autoUnfurlReactionTooltip: h
                    })
                }),
                eR = e => {
                ...
                e_ = e => {
                    ...
                    } = (0, c.useStateFromStoresObject)([A.default, F.default], () => {
                        let e = A.default.getCustomEmojiById(n);
                        return {
                            joinedEmojiSourceGuild: (null == e ? void 0 : e.type) === I.EmojiTypes.GUILD ? F.default.getGuild(null == e ? void 0 : e.guildId) : void 0
                        }
                    }), [d, f] = a.useState(void 0), [m, p] = a.useState(!1), [E, T] = a.useState(!1), [R, _] = a.useState(!1), g = null != u, S = (0, M.usePackCollectionData)({
                        expressionSourceGuild: d
                    }), C = S.autoUnfurlReactionTooltip, O = null !== (t = null == d ? void 0 : d.isDiscoverable()) && void 0 !== t && t, N = V.default.getGuildId(), v = null != N && (N === (null == d ? void 0 : d.id) || N === (null == u ? void 0 : u.id)), U = (0, ee.getEmojiPopoutData)({
                    ...
                    a.useEffect(() => {
                        ...
                        let i = async () => {
                            s(), T(!0);
                            let e = await y.default.getGuildFromEmojiId(n);
                            f(e), T(!1), _(!0), s()
                        };
                        i()
                    }, [n, C, m, R, s]);
                    let j = !S.viewAndUseEnabled || g;
                    if (j) return null;
                    let b = () => {
                            p(!m)
                        },
                            ...
                            return (0, i.jsxs)(h.Clickable, {
                                ...
                                children: [(0, i.jsx)(h.Text, {
                                    ...
                                    className: l(eu.reactionEmojiDetailsArrow, {
                                        [eu.reactionEmojiDetailsArrowCollapsed]: !m
                                    })
                                })]
                            })
                        },
                        ...
                        L = () => (0, i.jsxs)(i.Fragment, {
                            ...
                            }), null != U.emojiDescription && U.type !== ee.EmojiPopoutType.UNAVAILABLE && (0, i.jsx)(h.Text, {
                                variant: "text-sm/normal",
                                "aria-label": U.type,
                    ...
                    return C ? (0, i.jsxs)("div", {
                        children: [R ? L() : null, E ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                        ...
                        children: [P ? L() : x(), E ? (0, i.jsx)(ei.PopoutLoadingAnimation, {
                            className: eu.emojiDetailsLoader
                        }) : P && (0, i.jsx)(eR, {
                            emojiId: n,
                            expressionSourceGuild: d,
        ...
        81924: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                T = a.memo(function(e) {
                    ...
                    } = (0, o.useBurstReactionsExperiment)(null, !1), A = (0, s.useStateFromStores)([d.default], () => d.default.getEffectForEmojiId(t, n, T)), I = R ? E : p, C = a.useMemo(() => (0, h.buildEffect)(T, _, t, {
                        key: A,
                        messageId: n
                    }), [_, A, T, t, n]), [O, N] = a.useState(!1), v = (0, s.useStateFromStores)([r.default], () => r.default.useReducedMotion), M = c.AnimateEmoji.useSetting(), y = a.useCallback(() => {
                        l.default.dispatch({
                    ...
                    return (a.useEffect(() => {
                        let e = () => {
                            if (O) return;
                            let e = (0, f.getBurstAnimationHash)("".concat(Date.now()).concat(t).concat(n).concat(T.name)),
                                i = e % 10;
                            (i += g > 4 ? 4 : g - 1) > 7 && (N(!0), (0, u.playBurstReaction)({
                                channelId: t,
                                messageId: n,
                                emoji: T,
                    ...
                    }, [M, t, g, T, T.name, S, O, n, v]), null == A) ? null : (0, i.jsx)(m.default, {
                        className: I.effect,
                        effect: C,
                        onComplete: y
                    })
        ...
        85589: function(e, t, n) {
            ...
            function p(e) {
                ...
                let {
                    ...
                    hasUnlimited: T
                } = (0, l.useBurstReactionsExperiment)(null, !1), R = T ? f.default.Messages.SUPER_REACTIONS_UPSELL_UNLIMITED_BODY : f.default.Messages.SUPER_REACTIONS_UPSELL_BODY_LAUNCH, _ = R.format({
                    onClick: () => {
                ...
                return (0, i.jsx)(u.default, {
                    artURL: h,
                    artContainerClassName: m.artContainer,
                    modalClassName: m.modalContainer,
                    bodyClassName: m.bodyContainer,
                    type: c.PremiumUpsellTypes.BURST_REACTION_UPSELL,
                    title: f.default.Messages.SUPER_REACTIONS_UPSELL_TITLE,
                    body: _,
                    glowUp: _,
                    analyticsSource: p,
                    analyticsLocation: {
                    ...
                    onClose: a,
                    subscribeButtonText: null != g || null != S ? void 0 : f.default.Messages.PREMIUM_SETTINGS_GET,
                    ...
                    backButtonText: f.default.Messages.NO_THANKS,
                    ...E
                })
            }
        ...
        166257: function(e, t, n) {
            ...
            function N(e) {
                ...
                return null == a ? A.Endpoints.REACTIONS(t, n, o) : s ? A.Endpoints.REACTION_WITH_TYPE(t, n, o, a, l) : A.Endpoints.REACTION(t, n, o, a)
            }
            async function v(e) {
                let {
                    channelId: t,
            ...
            async function M(e, t, n) {
                ...
                if (l && !m.default.hasAvailableBurstCurrency && !d) return;
                if (!r && function(e, t, n, i) {
                        let a = T.default.getMessage(e, t);
                ...
                O("MESSAGE_REACTION_ADD", e, t, n, {
                    burst: l,
                    colors: E
                }), await p.default.unarchiveThreadIfNecessary(e), s.default.put({
                    url: N({
                        channelId: e,
                        messageId: t,
                        emoji: n,
                    ...
                    let i = m.default.remainingBurstCurrency;
                    l ? (o.AccessibilityAnnouncer.announce(d ? I.default.Messages.BURST_REACTION_ADD_UNLIMITED_SUCCESS_A11Y.format({
                        name: n.name
                    ...
                    }), i > 0 && (0, f.toggleFreeUserSentPopout)({
                        animated: !1,
                        ...n
                    })) : o.AccessibilityAnnouncer.announce(I.default.Messages.REACTION_ADD_SUCCESS_A11Y.format({
                        name: n.name
                    }))
                }).catch(a => {
                    C(a, () => M(e, t, n, i, {
                        ...
                        burst: l
                    }), l ? o.AccessibilityAnnouncer.announce(d ? I.default.Messages.BURST_REACTION_ADD_UNLIMITED_ERROR_A11Y.format({
                        name: n.name
                    }) : I.default.Messages.BURST_REACTION_ADD_ERROR_A11Y.format({
                        name: n.name,
                        n: m.default.remainingBurstCurrency
                    })) : o.AccessibilityAnnouncer.announce(I.default.Messages.REACTION_ADD_ERROR_A11Y.format({
                        name: n.name
                    })))
                })
            }
            ...
            async function U(e, t, n) {
                ...
                await p.default.unarchiveThreadIfNecessary(e), s.default.delete({
            ...
            async function j(e, t, n, i) {
                ...
                await p.default.unarchiveThreadIfNecessary(e);
                let l = null === n.id ? n.name : "".concat(n.name, ":").concat(n.id);
                s.default.delete({
                    url: A.Endpoints.REMOVE_EMOJI_REACTIONS(e, t, l),
                    oldFormErrors: !0
                }).catch(i => {
                    C(i, () => j(e, t, n, {
                        isRetry: !0
            ...
            async function b(e, t, n, i) {
                ...
                O("MESSAGE_REACTION_REMOVE", e, t, n, {
                    ...
                    (null == l ? void 0 : l.burst) ? o.AccessibilityAnnouncer.announce(I.default.Messages.BURST_REACTION_REMOVE_SUCCESS_A11Y.format({
                        name: n.name
                    })): o.AccessibilityAnnouncer.announce(I.default.Messages.REACTION_REMOVE_SUCCESS_A11Y.format({
                        name: n.name
                    }))
                }).catch(async s => {
                    if (C(s, () => b(e, t, n, i, a, {
                        ...
                        O("MESSAGE_REACTION_ADD", e, t, n, {
                            ...
                            burst: r,
                            colors: a
                        }), (null == l ? void 0 : l.burst) ? o.AccessibilityAnnouncer.announce(I.default.Messages.BURST_REACTION_REMOVE_ERROR_A11Y.format({
                            name: n.name
                        })) : o.AccessibilityAnnouncer.announce(I.default.Messages.REACTION_REMOVE_ERROR_A11Y.format({
                            name: n.name
                        }))
                    }
                })
            ...
            function P(e) {
                let {
                    ...
                    location: o,
                    isMe: r = !0
                } = e, u = a === h.ReactionTypes.BURST, f = () => {
                    b(t, n, i, s, o, {
                        burst: u
                    })
                }, m = (0, d.isDismissibleContentDismissed)(l.DismissibleContent.BURST_REACTIONS_REMOVE_MODAL), {
                    hasUnlimited: p
                } = c.BurstReactionsUserExperiment.getCurrentConfig({

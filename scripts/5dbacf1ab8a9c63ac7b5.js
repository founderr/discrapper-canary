    ...
    [85242, 17586, 40056, 65614, 84832], {
                ...
                if ("IntersectionObserver" in t && "IntersectionObserverEntry" in t && "intersectionRatio" in t.IntersectionObserverEntry.prototype) "isIntersecting" in t.IntersectionObserverEntry.prototype || Object.defineProperty(t.IntersectionObserverEntry.prototype, "isIntersecting", {
                    ...
                    o.prototype._computeTargetAndRootIntersection = function(e, n) {
                        if ("none" != t.getComputedStyle(e).display) {
                            for (var o, i, a, c, _, l, E, v, h = s(e), d = u(e), R = !1; !R;) {
                                var T = null,
                                ...
                                if (T && !(h = (o = T, i = h, a = void 0, c = void 0, _ = void 0, l = void 0, E = void 0, v = void 0, a = Math.max(o.top, i.top), c = Math.min(o.bottom, i.bottom), _ = Math.max(o.left, i.left), l = Math.min(o.right, i.right), v = c - a, (E = l - _) >= 0 && v >= 0 && {
                                        top: a,
                                        bottom: c,
                                        left: _,
                                        right: l,
        ...
        58964: (t, r, e) => {
            ...
            function h(t, r) {
                ...
                var v, h, d, R, T, O = encodeURIComponent(c.toString()),
                    p = encodeURIComponent(s()),
                    f = (d = new RegExp("(".concat(["WebView", "(iPhone|iPod|iPad)(?!.*Safari/)"].join("|"), ")"), "ig"), R = null != (null === o() || void 0 === o() || null === (v = o().ua) || void 0 === v ? void 0 : v.match(d)), T = "Safari" === (null === o() || void 0 === o() ? void 0 : o().name) && !R, "iOS" !== (null === o() || void 0 === o() || null === (h = o().os) || void 0 === h ? void 0 : h.family) || T ? 1 : 0),
                    g = null != n ? encodeURIComponent(n) : null,
                    N = null != i ? encodeURIComponent(i) : null,
                    b = "".concat(l, "/?link=").concat(O, "&utm_source=").concat(e, "&apn=").concat("com.discord", "&isi=").concat(985746746, "&ibi=").concat("com.hammerandchisel.discord", "&sd=").concat(p, "&efr=").concat(f);
            ...
            function i(t) {
                let r = function(t) {
                    let {
                        ...
                        cos: i,
                        round: a
                    } = Math, s = t[0] | t[1] << 8 | t[2] << 16, c = t[3] | t[4] << 8, u = (63 & s) / 63, _ = (s >> 6 & 63) / 31.5 - 1, l = (s >> 12 & 63) / 31.5 - 1, E = (s >> 18 & 31) / 31, v = s >> 23, h = (c >> 3 & 63) / 63, d = (c >> 9 & 63) / 63, R = c >> 15, T = o(3, R ? v ? 5 : 7 : 7 & c), O = o(3, R ? 7 & c : v ? 5 : 7), p = v ? (15 & t[5]) / 15 : 1, f = (t[5] >> 4) / 15, g = v ? 6 : 5, N = 0, b = (r, e, n) => {
                        let o = [];
                        for (let i = 0; i < e; i++)
                            for (let a = i ? 0 : 1; a * e < r * (e - i); a++) o.push(((t[g + (N >> 1)] >> ((1 & N++) << 2) & 15) / 7.5 - 1) * n);
                        return o
                    }, A = b(T, O, E), I = b(3, 3, 1.25 * h), D = b(3, 3, 1.25 * d), y = v && b(5, 5, f), U = n(t), B = a(U > 1 ? 32 : 32 * U), m = a(U > 1 ? 32 / U : 32), C = new Uint8Array(B * m * 4), S = [], G = [];
                    for (let t = 0, n = 0; t < m; t++)
                        for (let a = 0; a < B; a++, n += 4) {
                            let s = u,
                                ...
                                E = l,
                                h = p;
                            for (let t = 0, e = o(T, v ? 5 : 3); t < e; t++) S[t] = i(r / B * (a + .5) * t);
                            for (let e = 0, n = o(O, v ? 5 : 3); e < n; e++) G[e] = i(r / m * (t + .5) * e);
                            ...
                            if (v)
                                for (let t = 0, r = 0; t < 5; t++)
                                    for (let e = t ? 0 : 1, n = 2 * G[t]; e < 5 - t; e++, r++) h += y[r] * S[e] * n;
                            let d = s - 2 / 3 * c,
                                R = (3 * s - d + E) / 2,
                                f = R - E;
                            C[n] = o(0, 255 * e(1, R));

                    ...
                    resolveSemanticColor(_, E, I) {
                        ...
                        if (null != I && "gradient" in R) {
                            ...
                            if ("color" in _) {
                                ...
                                e = a(I.colors[E]).set("hsl.l", R.toString()).set("hsl.s", A.toString()).hex(), o = t
                            } else {
                                let E = _[I.theme];
                                null != E && (e = L[E.raw], o = E.opacity)
                            }
                        }
                        if (1 === o) return e;
                        {

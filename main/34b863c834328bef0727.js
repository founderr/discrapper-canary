    ...
    ["31717"], {
        819689: function(e, t, n) {
            ...
            function eh(e) {
                ...
                } = e, r = (0, A.parseExtraDataFromInviteKey)(t), d = K.default.getChannel(n);
                if (null != d) {
                    let e = null;
                ...
                eS = {
                    ...
                    fetchMessages(e) {
                        let {
                            ...
                            skipLocalFetch: c,
                            truncate: E
                        } = e, f = K.default.getChannel(t), g = M.default.isConnectedOrOverlay(), h = Date.now();
                        if (null != f && f.type === ed.ChannelTypes.GUILD_STORE) return !1;
                        if (t === eu.FAKE_PLACEHOLDER_PRIVATE_CHANNEL_ID) return;
                        if (eE.log("Fetching messages for ".concat(t, " between ").concat(n, " and ").concat(a, ". jump=").concat(JSON.stringify(d))), eS._tryFetchMessagesCached({
                                channelId: t,
                                before: n,
                                after: a,
                                limit: l,
                        ...
                        let T = null == m ? void 0 : m.messageId,
                            C = new eg;
                        return !c && this.fetchLocalMessages(t, n, a, l, C), s.default.get({
                            ...
                            let r = e.body,
                                ...
                                o = null != a,
                                c = null == n && null == a,
                                m = null != T || r.length === l && (u || c),
                                S = null != T || o && r.length === l;
                            if (null != T) {
                                let e = Math.floor(l / 2),
                                    ...
                                    a = n.indexOf(T);
                                if (a < e && (m = !1), r.length - a < e && (S = !1), S && r.length > 0) {
                                    let e = z.default.lastMessageId(t);
                                    r[0].id === e && (S = !1)
                                }
                            }
                            eE.log("Fetched ".concat(r.length, " messages for ").concat(t, " isBefore:").concat(u, " isAfter:").concat(o)), C.markComplete();
                            let p = (0, b.isChannelHighlightsEnabledForGuild)(null !== (s = null == f ? void 0 : f.guild_id) && void 0 !== s ? s : "");
                            if (p && (null == d ? void 0 : d.isHighlight)) {
                                let e = (0, _.getUnreadChannelHighlights)(t, z.default.ackMessageId(t));
                                if (e.length >= 0) {
                                    let n = e[0];
                                    if (null == r.find(e => e.id === n)) return eS.jumpToMessage({
                                        channelId: t,
                                        messageId: n,
                            ...
                            i.default.dispatch({
                                ...
                                limit: l,
                                jump: d,
                                isStale: !g || M.default.lastTimeConnectedChanged() >= h,
                                truncate: E
                            })
                        }), !0), () => (eE.log("Failed to fetch messages for ".concat(t)), i.default.dispatch({
                    ...
                    async fetchLocalMessages(e, t, n, a, s) {
                        ...
                        if (eE.log("fetched ".concat(f.messages.length, " messages from local database (channel_id: ").concat(e, ", remote_fetch_completed: ").concat(s.completed, ")")), H.default.addLocalMessages(e, f.messages.length), !s.completed && f.messages.length > 0) {
                    ...
                    _tryFetchMessagesCached(e) {
                        ...
                        if ((null == l ? void 0 : l.messageId) != null || (null == r ? void 0 : r.messageId) != null) {
                            if ((null == l ? void 0 : l.messageId) != null && u.has(l.messageId, !1)) return i.default.dispatch({
                                type: "LOAD_MESSAGES_SUCCESS_CACHED",
                                channelId: t,
                                jump: l,
                                limit: s,
                            ...
                            let e = (null == l ? void 0 : l.messageId) != null ? ei.default.extractTimestamp(null == l ? void 0 : l.messageId) : 0,
                                n = u.first(),
                                a = u.last();
                            if (!u.hasMoreBefore && null != n && ei.default.extractTimestamp(n.id) >= e || !u.hasMoreAfter && null != a && ei.default.extractTimestamp(a.id) <= e || null != n && null != a && ei.default.extractTimestamp(n.id) < e && ei.default.extractTimestamp(a.id) > e) return i.default.dispatch({
                                type: "LOAD_MESSAGES_SUCCESS_CACHED",
                                channelId: t,
                                jump: l,
                                limit: ed.MAX_MESSAGES_FOR_JUMP
                                ...
                                if (d.ok) v.default.donateSentMessage(o, e), eS.receiveMessage(e, d.body, !0, {
                                    ...
                                    (0, m.default)(t).forEach(e => {
                                        ...
                                        if (t === h.CodedLinkType.INVITE) eh({
                                            ...
                                            let e = C.default.getGuildTemplate(d);
        ...
        39141: function(e, t, n) {
            ...
            }), n("808653"), n("222007"), (i = a || (a = {}))[i.CHAT_INPUT = 0] = "CHAT_INPUT", i[i.REACTION = 1] = "REACTION", i[i.MEMBER_USER = 2] = "MEMBER_USER", i[i.CALL_TILE = 3] = "CALL_TILE", (r = s || (s = {}))[r.CHAT_INPUT = 0] = "CHAT_INPUT", r[r.VOICE_USER = 1] = "VOICE_USER", r[r.MENTION = 2] = "MENTION", (d = l || (l = {}))[d.LEVEL_1 = 0] = "LEVEL_1", d[d.LEVEL_2 = 1] = "LEVEL_2", d[d.LEVEL_3 = 2] = "LEVEL_3", d[d.LEVEL_4 = 3] = "LEVEL_4", d[d.LEVEL_5 = 4] = "LEVEL_5";
            let u = {
                    0: [
                        [1, 1e-4],
                        [25, .05],
        ...
        256572: function(e, t, n) {
            ...
            var a, s, l = n("693566"),
                ...
                f = n("377253"),
                _ = n("49111");
            (s = a || (a = {}))[s.LOADED = 0] = "LOADED", s[s.NOT_LOADED = 1] = "NOT_LOADED", s[s.DELETED = 2] = "DELETED";
            let g = Object.freeze({
                    state: 1
                }),
                h = new Set;
            ...
            let S = new class e {
                ...
                set(e, t, n) {
                    ...
                    null == a && (a = new m, this._channelCaches.set(e, a)), a.set(t, n)
                }
            ...
            function M(e) {
                let t = !1;
                if (S.updateExistingMessageIfCached(e) && (t = !0), _.MessageTypesWithLazyLoadedReferences.has(e.type)) {
                    ...
                    if ("referenced_message" in e) {
                        ...
                        null != t ? (S.set(t.channel_id, t.id, {
                            state: 0,
                            message: (0, c.createMessageRecord)(t)
                        }), e.type === _.MessageTypes.THREAD_STARTER_MESSAGE && M(t)) : S.set(e.channel_id, a, {
                            state: 2
                        })
                    } else {
                        let e = f.default.getMessage(n.channel_id, a);
                        null != e ? S.set(n.channel_id, a, {
                            state: 0,
                            message: e
                        }) : S.set(n.channel_id, a, g)
                    }
                    t = !0
                }
                return t
            ...
            class D extends r.default.Store {
                ...
                getMessageByReference(e) {
                    let t;
                    return null != e && (t = S.get(e.channel_id, e.message_id)), null != t ? t : g
                }
                getMessage(e, t) {
                    var n;
                    return null !== (n = S.get(e, t)) && void 0 !== n ? n : g
                }
                getReplyIdsForChannel(e) {
                    let t;
                    return null != e && (t = S.getCachedMessageIdsForChannel(e)), null != t ? t : h
                }
            }
            ...
            let O = new D(d.default, {
                CACHE_LOADED: function(e) {
                    ...
                    return p(Object.values(t), e => p(Object.values(e), e => M(e)))
                },
                ...
                SEARCH_FINISH: function(e) {
                    ...
                    return p(t, e => p(e, e => M(e)))
                },
                GUILD_FEED_FETCH_SUCCESS: function(e) {
                    let {
                        data: t
                    } = e, n = (0, o.getMessagesFromGuildFeedFetch)(t);
                    return p(n, e => M(e))
                },
                ...
                MESSAGE_EXPLICIT_CONTENT_SCAN_TIMEOUT: function(e) {
                    ...
                    S.set(n, t, {
                        state: 0,
                        message: (0, u.handleExplicitMediaScanTimeoutForMessage)(a.message)
                    })
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    return !!f.default.getMessages(t.channel_id).ready && M(t)
                },
                MESSAGE_UPDATE: function(e) {
                    let {
                        message: t
                    } = e, n = t.id, a = t.channel_id;
                    if (!S.has(a, n)) return !1;
                    let s = S.get(a, n);
                ...
                GUILD_DELETE: function() {
                    let e = S.retainWhere(e => null != E.default.getChannel(e));
                    if (0 === e) return !1
                },
                CONNECTION_OPEN: I,
                LOGOUT: I
        ...
        401848: function(e, t, n) {
            ...
            var a, s, l = n("446674"),
                ...
                u = n("957255"),
                o = n("49111");
            (s = a || (a = {}))[s.SendMessage = 0] = "SendMessage", s[s.CreateThread = 1] = "CreateThread";
            let c = {
                0: {},
                1: {}
            };

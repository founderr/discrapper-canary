    ...
    ["56145"], {
        ...
        865453: function(e, t, n) {
            ...
            let m = e => {
                ...
                }), g = null != m && [i.EmojiPopoutType.ADD_PACK, i.EmojiPopoutType.REMOVE_PACK, i.EmojiPopoutType.GET_PREMIUM_INVENTORY_ENABLED].includes(m.type);
                return l.useEffect(() => {
                    var e;
                    a.default.dispatch({
        ...
        781423: function(e, t, n) {
            ...
            function M(e) {
                ...
                let {
                    ...
                    output: f,
                    state: g
                } = e, _ = (0, s.useStateFromStores)([m.default, p.default], () => m.default.getChannel(null !== (t = r.channelId) && void 0 !== t ? t : p.default.getChannelId()), [r.channelId]), {
                    ...
                    if (null == N || null == _ || N.name !== r.commandName || T) return !1;
                    let e = _.isPrivate(),
                        t = (0, d.computeIsReadOnlyThread)(_);
                    if (t || !e && !x) return !1;
                    let n = (null == N ? void 0 : N.applicationId) === v.BuiltInSectionId.BUILT_IN;
                    return !!e || !!n || !!M || !1
                }, [_, N, x, M, r.commandName, T]), R = a.useCallback(e => {
        ...
        605160: function(e, t, n) {
            ...
            let g = (e, t) => {
                    ...
                    return i && (0, o.isPendingScan)(s) ? a.POTENTIAL_EXPLICIT_CONTENT : i && ((0, f.hasFlag)(l, p.MessageAttachmentFlags.CONTAINS_EXPLICIT_MEDIA) || r.default.get("obscure_blur_effect_enabled")) ? a.EXPLICIT_CONTENT : n || (0, f.hasFlag)(l, p.MessageAttachmentFlags.IS_SPOILER) ? a.SPOILER : null
                },
                C = (e, t, n, l) => {
                    let {
                        flags: s = 0,
                    ...
                    return d && (0, o.isPendingScan)(i) ? a.POTENTIAL_EXPLICIT_CONTENT : d && ((0, f.hasFlag)(s, p.MessageEmbedFlags.CONTAINS_EXPLICIT_MEDIA) || r.default.get("obscure_blur_effect_enabled")) ? a.EXPLICIT_CONTENT : l ? a.SPOILER : null
                };
            ...
            let v = e => {
                ...
                I = e => {
                    let {
                        ...
                        enableClick: c = !0
                    } = e, [g, v] = a.useState(String(Date.now())), [I, x] = a.useState(!1), S = function() {
                        let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        ...
                        onTooltipShow: () => {
                            x(!0), c && (_({
                                ...
                                type: "EMOJI_INTERACTION_INITIATED",
                                interaction: E.EmojiInteractionPoint.CustomEmojiTooltipShown
                            }))
                        },
                        children: t => (0, l.jsx)(o.Clickable, {
                            ...e,
        ...
        933629: function(e, t, n) {
            ...
            function es(e) {
                ...
                } = i.useContext(L.MessagesInteractionContext), [g, M] = i.useState(null), N = i.useRef(null), [R, j] = i.useState(null), b = i.useRef(null), y = (0, m.useStateFromStoresArray)([x.default], () => {
                    var e;
            ...
            function er(e) {
                ...
                let {
                    ...
                    disableInteractions: u
                } = i.useContext(L.MessagesInteractionContext), [p, E] = i.useState(null), g = i.useRef(null), [M, N] = i.useState(null), T = i.useRef(null), R = (0, m.useStateFromStoresArray)([x.default], () => {
                    var e;
                    return null !== (e = x.default.summaries(a.id)) && void 0 !== e ? e : []
                }, [a]), j = (0, v.default)(R);
                i.useEffect(() => {
                ...
                let b = (0, m.useStateFromStores)([A.default], () => {
                    ...
                    y = null !== (n = (0, m.useStateFromStores)([x.default], () => x.default.visibleSummaryIndex())) && void 0 !== n ? n : -1,
                    P = null == R ? void 0 : null === (t = R[y]) || void 0 === t ? void 0 : t.topic;
                null == P && null == p && (null == R ? void 0 : R.length) >= 1 && (P = null === (l = R[0]) || void 0 === l ? void 0 : l.topic);
                ...
                return R.length > 0 && (ea = "" === P || null == P ? W.default.Messages.SUMMARIES_VIEW_ALL : P), u ? null : (0, s.jsxs)("div", {
                    ref: g,
        ...
        305122: function(e, t, n) {
            ...
            }), g(e), C("SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS")) : Promise.resolve(), I = () => {
        ...
        793237: function(e, t, n) {
            ...
            async function v(e) {
                ...
                m = s.takeRight(m, 75), u.default.dispatch({
        ...
        347738: function(e, t, n) {
            ...
            class k extends m.default.PersistedStore {
                ...
                topicForRange(e, t, n) {
                    var l, s, i, r, o, u;
                    let d = null === (l = R[e]) || void 0 === l ? void 0 : l.filter(e => e.source === P);
            ...
            let V = new k(f.default, {
                ...
                CHANNEL_SELECT(e) {
                    ...
                    (null === (t = i) || void 0 === t ? void 0 : t.channelId) !== n && (i = null), c.isFunction(D) && (D(), D = null), null != l && (T.ChannelSummarizationModelSwapGuildExperiment.getCurrentConfig({
                        guildId: l,
                        location: "93448c_4"
        ...
        981913: function(e, t, n) {
            ...
            function p(e) {
                let {
                    ...
                    className: s(null == E ? a : m.staticButton, m.centerButton, h[v])
                }), _ = null;
        ...
        876308: function(e, t, n) {
            ...
            var S = a.memo(function(e) {
                ...
                a.useEffect(() => {
                    var e, t;
                    if (Y || W) {
                        if (W) em.current = performance.now(), null == P || P(!1, k, (null !== (t = null === (e = U.current) || void 0 === e ? void 0 : e.duration) && void 0 !== t ? t : 0) * 1e3);
                        else {
        ...
        534107: function(e, t, n) {
            ...
            function _(e) {
                ...
                if (0 === m) return;
                let f = o / 2 - m / 2;
                t = i, n = 6 * d * r, l = f * r, a = m * r, s = 1 * r, t.moveTo(n, l + s), t.lineTo(n, l + a - s), t.arc(n + s, l + a - s, s, Math.PI, 0, !0), t.lineTo(n + 2 * s, l + s), t.arc(n + s, l + s, s, 0, Math.PI, !0), t.closePath()
            }
            ...
            function M(e) {
                let {
                    ...
                    return i
                }(n, j), O = a.useRef(C), P = a.useRef(M), D = a.useRef(null), w = window.devicePixelRatio, {
                ...
                a.useEffect(() => {
                    ...
                    y.current = L.map((t, n) => new f.default(n < e ? t : 0))
                }, [L]), a.useEffect(() => {
                    let e = y.current;
                    if (null == e) return;
                    let t = I({
            ...
            class h extends a.Component {
                ...
                render() {
                    let {
                        ...
                        hasMouseOver: O,
                        hasFocus: P
                    } = this.state, D = null != n, w = this.getRatio(), U = (0, s.clamp)(Math.round(g * w), null != v ? v : 0, null != _ ? _ : 1 / 0), k = (0, s.clamp)(Math.round(C * w), null != I ? I : 0, null != x ? x : 1 / 0), V = {
                        alt: e,
                        readyState: L,
                    ...
                    switch ((D || null != M) && (V.onClick = this.onClick), a && (V.original = null != o && "" !== o ? o : V.src), L) {
                        ...
                        case m.ImageReadyStates.READY:
                            if (h.isAnimated(this.props)) {
                                ...
                                let e = (r || O || P) && (null == E || E) && h.visibilityObserver.isVisible(this);
                                e ? (V.src = this.getSrc(w), V.renderAccessory = N) : (V.src = this.getSrc(w, !p || !r), V.renderAccessory = this.renderAccessory), null != f && (V.children = t => {
                                    let {
                                        src: n,
                                        size: l,
                                        alt: a,
        ...
        924444: function(e, t, n) {
            ...
            function x(e) {
                let {
                    ...
                    width: R,
                    height: j
                } = (0, m.zoomFit)(i, o), b = r.isMobile && null != M;
                a.useEffect(() => {
                    if (null != M) return c.ComponentDispatch.subscribe(g.ComponentActions.MEDIA_MODAL_CLOSE, M), () => {
                        c.ComponentDispatch.unsubscribe(g.ComponentActions.MEDIA_MODAL_CLOSE, M)
                    }
                }, [M]);
                let y = N ? e => {
                    e.stopPropagation(), e.preventDefault()
            ...
            function S(e) {
                let {
                    ...
                    width: h,
                    height: E
                } = (0, m.zoomFit)(n, a), g = r.isMobile && null != s, x = u ? e => {
                    e.stopPropagation(), e.preventDefault()
                } : c.onContextMenu;
                return (0, l.jsxs)("div", {
        ...
        170113: function(e, t, n) {
            ...
            class U extends a.PureComponent {
                ...
                renderControls() {
                    ...
                    return d || n || t === b.AUDIO ? (0, l.jsx)(P, {
                        buffers: r,
                        currentTime: o,
                        duration: u,
                ...
                renderMetadata() {
                    ...
                    return null == e || null == t ? null : a === b.AUDIO ? (0, l.jsx)(D, {
                        fileName: e,
                        fileSize: t,
                        src: n,
                        disabled: !s,
        ...
        839952: function(e, t, n) {
            ...
            function M(e) {
                ...
                M && s && p > C ? N = "\n..." : !M && (N = "..."), "" !== N && (M ? N += " " + E.default.Messages.PREVIEW_LINES_LEFT.format({
                    lines: p - C
                }) : N += " " + E.default.Messages.PREVIEW_BYTES_LEFT.format({
                    formattedBytes: (0, d.formatKbSize)(m)
                }));
                let T = (null == h ? void 0 : h.slice(0, C).join("\n")) + N,
                    A = s || C < p;
                return (0, l.jsxs)("div", {
                    className: i(f, g.container),
                    children: [(0, l.jsx)("div", {
            ...
            function N(e) {
                ...
                return 0 !== i && (m += "... ".concat(E.default.Messages.PREVIEW_BYTES_LEFT.format({

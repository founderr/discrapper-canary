    ...
    ["4327"], {
        ...
        235004: function(e, t, n) {
            ...
            class p extends r.default.Store {
                ...
                hasFetchedAllSounds() {
                    return S === l.FETCHED && O === l.FETCHED
                }
            }
            p.displayName = "SoundboardStore";
            var G = new p(E.default, {
                LOGOUT: function() {
                    A.clear(), D.clear(), U.clear(), g = !1, S = l.NOT_FETCHED, O = l.NOT_FETCHED
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(e) {
                    ...
                    A.set(I.DEFAULT_SOUND_GUILD_ID, t), O = l.FETCHED
                },

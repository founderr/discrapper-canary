            ...
            class T {
                ...
                constructor(e, t, l = 10) {
                    this.handleMessages = e => {
                        let t = e.data;
                        null != t && t.type === s.USER_RESULTS && t.uuid === this._uuid && (!1 !== this._currentQuery && this._callback(t.payload), null != this._currentQuery && (this._currentQuery = null), this._setNextQuery())

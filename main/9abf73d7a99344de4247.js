    ...
    ["23777"], {
        ...
        650509: function(t, e, n) {
            ...
            let m = t => {
                ...
                y = () => {
                    let [t, e] = r.useState(u.NOT_LOADED);
                    return r.useEffect(() => {
                        e(u.LOADING), (0, a.fetchUserEntitlements)({
                            withSku: !0,
                            withApplication: !0,
                            entitlementType: N.EntitlementTypes.APPLICATION_SUBSCRIPTION
                        }).catch(() => {
        ...
        186211: function(t, e, n) {
            ...
            class U extends a.default.Store {
                getSubscriptionGroupListingsForApplicationFetchState(t) {
                    var e;
                    return null !== (e = C[t]) && void 0 !== e ? e : u.NOT_FETCHED
                }
                ...
                getEntitlementsForGuildFetchState(t) {
                    var e;
                    return null !== (e = N[t]) && void 0 !== e ? e : u.NOT_FETCHED
                }
        ...
        85336: function(t, e, n) {
            ...
            let S = new Set([u.CREDIT_CARD_INFORMATION, u.PAYMENT_REQUEST_INFORMATION, u.PAYPAL_INFORMATION, u.VENMO_INFORMATION, u.CASH_APP_INFORMATION, u.ADDRESS, u.CLAIM_FREE_SKU, u.SKU_PREVIEW, u.PREMIUM_UPSELL, u.SOFORT_INFORMATION, u.PRZELEWY24_INFORMATION]);
            ...
            function f(t) {
                if (null != t) {
                    ...
                    if (t.hasCardError()) return u.CREDIT_CARD_INFORMATION;
                    if (t.hasAddressError()) return u.ADDRESS
                }
                return null
            }
            ...
            function _(t, e, n) {
                r.useEffect(() => {
                    null != t && t !== u.REVIEW && e !== s.PurchaseState.WAITING && e !== s.PurchaseState.COMPLETED && n(s.PurchaseState.WAITING)
                }, [t, e, n])
            }
        },

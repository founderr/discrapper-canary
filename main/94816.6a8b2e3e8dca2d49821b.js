    ...
    ["94816"], {
        ...
        988721: function(e, t, n) {
            ...
            class V extends u.default.Store {
                ...
                getContextState(e) {
                    var t, n;
                    return null != e && ee(e) ? null !== (n = this.indices[null !== (t = e.guild_id) && void 0 !== t ? t : e.id]) && void 0 !== n ? n : w : H
                }
                getUserState() {
                    var e;
            ...
            let q = new V(d.default, {
                ...
                APPLICATION_COMMAND_INDEX_FETCH_REQUEST: function(e) {
                    ...
                    if (et(null !== (t = q.indices[x(n)]) && void 0 !== t ? t : w)) {
                ...
                APPLICATION_COMMAND_INDEX_FETCH_SUCCESS: function(e) {
                    ...
                    for (let e of ("guild" === i.type && r.size > 0 && c.default.requestMembersById(i.guildId, [...r]), (0, v.buildApplicationCommands)(l.application_commands.map(e => (function(e, t) {
                            ...
                            let o = {
                                ...
                                options: null !== (s = null === (n = e.options) || void 0 === n ? void 0 : n.map(en)) && void 0 !== s ? s : [],
            ...
            function j(e, t, n) {
                let [i, l] = a.useState(!0), s = (0, u.useStateFromStoresObject)([q], () => q.getContextState(e));
                return a.useEffect(() => {
                    if (i && null != e) {
                        if (n) {
                            let n = t && ee(e);
                            n && (E.default.track(P.AnalyticEvents.APPLICATION_COMMAND_CACHE_FETCH, {
                                miss: null == s.result,
                                size: Object.keys(q.indices).length
                            }), et(s) && (null != e.guild_id ? (0, M.requestApplicationCommandIndex)({
                                type: "guild",
                                guildId: e.guild_id
                            }) : (0, M.requestApplicationCommandIndex)({
                                type: "channel",
            ...
            function z(e, t) {
                let [n, i] = a.useState(!0), l = (0, u.useStateFromStoresObject)([q], () => q.getUserState()), s = (0, u.useStateFromStores)([T.default], T.default.getGuildId), o = (0, v.useIsInUserAppExperiment)(s, {
            ...
            function $(e) {
                ...
                if (T.length > 0 || !0 === r) {
                    let e = J(N.BUILT_IN_SECTIONS[R.BuiltInSectionId.BUILT_IN], T, E);
                    null != e && A.push(e)
                }
            ...
            function J(e, t, n) {
                ...
                return 0 !== (i = o !== O.ScoreMethod.NONE && null != l && null != a ? function(e, t, n, i, l) {
                    ...
                    return s
                }(l, a, I, e, o) : I).length || s ? ((o === O.ScoreMethod.NONE || o === O.ScoreMethod.APPLICATION_ONLY) && i.sort((e, t) => ea(e.displayName, t.displayName)), {
                    section: e,
                    data: i
                }) : null
            }

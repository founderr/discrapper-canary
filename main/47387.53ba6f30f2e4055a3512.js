    ...
    ["47387"], {
        ...
        956597: function(e, t, n) {
            ...
            function F(e) {
                ...
                return (0, i.jsxs)("div", {
                    className: a(l, v.gradientUpsellWrapper, {
                        [v.gradientUpsellWrapperTier0]: _ === N.PremiumSubscriptionSKUs.TIER_0,
                        [v.gradientUpsellWrapperTier2]: _ === N.PremiumSubscriptionSKUs.TIER_2,
                        [v.gradientUpsellWrapperWithBottomMargin]: o
                    }),
                    children: [(0, i.jsxs)("div", {
                        className: v.logo,
            ...
            function y(e) {
                ...
                return (0, i.jsx)(f.Text, {
                    ...
                    className: a(v.trialBadge, e.className, {
                            ...
                            children: [(0, i.jsx)(f.Clickable, {
                                ...
                                children: [(0, i.jsx)("img", {
                                    ...
                                    children: x.default.Messages.STICKER_PICKER_PREMIUM_UPSELL_DESCRIPTION_NO_BOLD_V2.format({
                                        ...
                                        onClick: () => (0, p.transitionTo)(A.Routes.APPLICATION_STORE)
                                    })
                                })]
                            }), (0, i.jsx)(w, {
                                subscriptionTier: d,
                        ...
                        switch (u) {
                            case N.PremiumUpsellTypes.UPLOAD_ERROR_UPSELL:
                                h = x.default.Messages.UPLOAD_AREA_PREMIUM_UPSELL_WITH_SIZE_AND_ACTION_V2.format({
                                    ...
                                    onClick: () => {
                                        (0, p.transitionTo)(A.Routes.APPLICATION_STORE), null == s || s()
                                    }
                                });
                                break;
                            case N.PremiumUpsellTypes.BURST_REACTION_UPSELL:
                            ...
                            case N.PremiumUpsellTypes.STREAM_QUALITY_UPSELL:
                                h = x.default.Messages.STREAM_PREMIUM_UPSELL_WITH_ACTION.format({
                                    onClick: () => {
                                        (0, p.transitionTo)(A.Routes.APPLICATION_STORE), null == s || s(), (0, m.closeAllModals)()
                                    }
                                });
                                break;
                            case N.PremiumUpsellTypes.MESSAGE_LENGTH_UPSELL:
                    ...
                    case N.PremiumUpsellTypes.PREMIUM_CLIENT_THEME_TRY_IT_OUT:
                        return o(null != l, "You must specify children for this upsell type"), (0, i.jsx)(F, {
                            ...
                            children: x.default.Messages.CLIENT_THEMES_EDITOR_UPSELL.format({
                                onClick: () => {
                                    (0, p.transitionTo)(A.Routes.APPLICATION_STORE), (0, I.closeEditor)()
                                }
                            })
                        });
                    case N.PremiumUpsellTypes.MESSAGE_LENGTH_IN_EDITOR_UPSELL:
                        return (0, i.jsxs)("div", {
                            className: a(v.messageLengthUpsellContainer, {
                                [v.messageLengthUpsellAppearAnimation]: !g
                            }),
        ...
        400307: function(e, t, n) {
            ...
            function ec(e) {
                let {
                    ...
                    enabled: i,
                    hasUnlimited: r
                } = (0, p.useBurstReactionsExperiment)(), l = (0, f.useStateFromStores)([M.default], () => M.default.locale), a = (0, f.useStateFromStores)([H.default], () => H.default.affinities), {
                ...
                n && a.length > 0 && G.default.trackExposure({
                    location: "planSelection"
                });
                let o = s && a.length > 0 && n;
                if (1 === t) return (0, u.jsxs)(u.Fragment, {
                    children: [(0, u.jsx)(es, {
                        ...
                        text: J.default.Messages.PREMIUM_TIER_SERVER_BOOST_WITH_PERCENTAGE_ITEM.format({
                            ...
                            percentageOff: (0, B.formatPercent)(l, W.GUILD_BOOST_COST_FOR_PREMIUM_USER_DISCOUNT_PERCENT / 100)
                        })
                    }), (0, u.jsx)(es, {
                        Icon: j.default,
                        text: J.default.Messages.PREMIUM_TIER_UPLOAD_ITEM.format({
                ...
                return (0, u.jsxs)(u.Fragment, {
                    children: [(0, u.jsx)(es, {
                        ...
                        Icon: h.default,
                        text: r ? J.default.Messages.PREMIUM_MARKETING_SUPER_REACTIONS_PERK_TITLE_UNLIMITED : J.default.Messages.PREMIUM_TIER_SUPER_REACTIONS_ITEM.format({
        ...
        332291: function(e, t, n) {
            ...
            function _() {
                let e = (0, s.useStateFromStores)([d.default], () => d.default.affinities.slice(0, 3)),
                    ...
                    f = r.useMemo(() => 3 === e.length ? c.default.Messages.AFFINITIES_MARKETING_HEADER_3.format({
                        username: e[0].globalName
                    }) : 2 === e.length ? c.default.Messages.AFFINITIES_MARKETING_HEADER_2.format({
                        username: e[0].globalName,
        ...
        19287: function(e, t, n) {
            ...
            function d(e) {
                let {
                    ...
                    canAnimate: p,
                    size: d
                }) : void 0, [c, P, S, t, p, d, _]), C = i.useCallback(() => E(!0), []), O = i.useCallback(() => E(!1), []);
                return {
                    avatarSrc: R,
                    isAvatarAnimating: p,
                    eventHandlers: {

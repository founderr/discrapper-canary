        ...
        860957: function(e, t, l) {
            ...
            async function et() {
                ...
                switch (null == e && (e = V && W ? v.default.getOverlayEligiblePIDs() : []), w) {
                    case U.OverlayMethod.Global:
                        var t, l, n, a, i, o, E, d, r, _, u, c, s, O, A, S, I, N, f, L;
                        ...
                        } else await (null === (N = T.default) || void 0 === N ? void 0 : null === (I = N.globalOverlay) || void 0 === I ? void 0 : null === (S = I.closeOverlay) || void 0 === S ? void 0 : S.call(I)), null === (f = (L = h.default.getDiscordUtils()).globalOverlayClearTrackedGame) || void 0 === f || f.call(L), F = null;
                        break;
            ...
            class eI extends d.default.Store {
                initialize() {
                    !(!U.OVERLAY_SUPPORTED || __OVERLAY__) && (H.add(U.OverlayMethod.Hook), this.waitFor(v.default, D.default), this.syncWith([v.default], er), S.setReceiveCommandHandler(eA, eT), D.default.addChangeListener(ed), eS.then(() => {
                        ei(f.OverlayStoredSettings.enabled), r.default.addInterceptor(es)
                    }))
                }
                isInputLocked(e) {
                    return !x.has(e)
            ...
            let eN = new eI(r.default, __OVERLAY__ ? {} : {
                ...
                RPC_SERVER_READY: function(e) {
                    ...
                    a.append("build_id", "4b8f72d6710ca347d4f446a71fd76af988bfafef"), a.append("rpc", String(t)), a.append("rpc_auth_token", k), n = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(a.toString())
                },

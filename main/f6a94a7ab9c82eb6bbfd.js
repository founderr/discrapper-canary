    ...
    ["84009"], {
        ...
        512330: function(e, t, l) {
            ...
            let p = {
                    ...
                    [s.DAYS]: e => e / 60 / 24,
                    [s.WEEKS]: e => e / 60 / 24 / 7,
                    [s.MONTHS]: e => e / 60 / 24 / 31,
                    [s.YEARS]: e => e / 60 / 24 / 365
                },
                T = [{
                    unit: s.NONE,
                    max: 0
                ...
                _ = {
                    [n.ACTIVITY_FEED]: {
                        [a.START]: {
                            [s.SECONDS]: () => E.default.Messages.GAME_FEED_USER_PLAYING_JUST_STARTED,
                            [s.MINUTES]: e => E.default.Messages.GAME_FEED_USER_PLAYING_FOR_MINUTES.format({
                                time: e
                            }),
                            [s.HOURS]: e => E.default.Messages.GAME_FEED_USER_PLAYING_FOR_HOURS.format({
                                time: e
                            }),
                            [s.DAYS]: e => E.default.Messages.GAME_FEED_USER_PLAYING_FOR_DAYS.format({
                                time: e
                            })
                        },
                        [a.END]: {
                            [s.SECONDS]: () => E.default.Messages.GAME_FEED_USER_PLAYING_JUST_ENDED,
                            [s.MINUTES]: e => E.default.Messages.GAME_FEED_USER_PLAYED_MINUTES_AGO.format({
                                time: e
                            }),
                            [s.HOURS]: e => E.default.Messages.GAME_FEED_USER_PLAYED_HOURS_AGO.format({
                                time: e
                            }),
                            [s.DAYS]: e => E.default.Messages.GAME_FEED_USER_PLAYED_DAYS_AGO.format({
                                time: e
                            }),
                            [s.WEEKS]: e => E.default.Messages.GAME_FEED_USER_PLAYED_WEEKS_AGO.format({
                                time: e
                            }),
                            [s.MONTHS]: e => E.default.Messages.GAME_FEED_USER_PLAYED_MONTHS_AGO.format({
                                time: e
                            }),
                            [s.YEARS]: e => E.default.Messages.GAME_FEED_USER_PLAYED_YEARS_AGO.format({
                                time: e
                            })
                        }
                    },
                    [n.ACTIVITY_FEED_NEW]: {
                        [a.START]: {
                            [s.SECONDS]: h(() => E.default.Messages.ACTIVITY_FEED_USER_PLAYING_JUST_STARTED),
                            [s.MINUTES]: h(() => E.default.Messages.ACTIVITY_FEED_USER_PLAYING_FOR_MINUTES),
                            [s.HOURS]: h(() => E.default.Messages.ACTIVITY_FEED_USER_PLAYING_FOR_HOURS),
                            [s.DAYS]: h(() => E.default.Messages.ACTIVITY_FEED_USER_PLAYING_FOR_DAYS)
                        },
                        [a.END]: {
                            [s.SECONDS]: e => E.default.Messages.DURATION_SECONDS_AGO.format({
                                seconds: e
                            }),
                            [s.MINUTES]: e => E.default.Messages.DURATION_MINUTES_AGO.format({
                                minutes: e
                            }),
                            [s.HOURS]: e => E.default.Messages.DURATION_HOURS_AGO.format({
                                hours: e
                            }),
                            [s.DAYS]: e => E.default.Messages.DURATION_DAYS_AGO.format({
                                days: e
                            })
                        }
                    },
                    ...
                    [n.GAME_LIBRARY_TIME_PLAYED]: {
                        [a.TIME]: {
                            [s.NONE]: () => E.default.Messages.GAME_LIBRARY_TIME_PLAYED_NONE,
                            [s.SECONDS]: e => E.default.Messages.GAME_LIBRARY_TIME_PLAYED_SECONDS.format({
                                time: e
                            }),
                            [s.MINUTES]: e => E.default.Messages.GAME_LIBRARY_TIME_PLAYED_MINUTES.format({
                                time: e
                            }),
                            [s.HOURS]: e => E.default.Messages.GAME_LIBRARY_TIME_PLAYED_HOURS.format({
                                time: e
                            })
                        }
                    },
                    [n.GAME_LIBRARY_LAST_PLAYED]: {
                        [a.END]: {
                            [s.NONE]: () => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_NONE,
                            [s.SECONDS]: () => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_JUST_NOW,
                            [s.MINUTES]: e => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_MINUTES.format({
                                time: e
                            }),
                            [s.HOURS]: e => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_HOURS.format({
                                time: e
                            }),
                            [s.DAYS]: e => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_DAYS.format({
                                time: e
                            }),
                            [s.WEEKS]: e => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_WEEKS.format({
                                time: e
                            }),
                            [s.MONTHS]: e => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_MONTHS.format({
                                time: e
                            }),
                            [s.YEARS]: e => E.default.Messages.GAME_LIBRARY_LAST_PLAYED_YEARS.format({
                                time: e
                            })
                        }
                    }
            ...
            function S(e, t) {
                let l = null != e ? I(e, e => t.includes(e)) : s.NONE,
                    n = null != l ? p[l] : null;
                return {
                    unit: l,
            ...
            function g(e) {
                ...
                return (t = class extends d.PureComponent {
                    ...
                    getType() {
                        ...
                        if (null != e) return a.START;
                        if (null != t) return a.END;
                        if (null != l) return a.TIME;
                        return null
                    }
                    transformTime(e, t) {
                        return p[e](t)
        ...
        19766: function(e, t, l) {
            ...
            function N(e, t, l, s) {
                switch (t) {
                    ...
                    case A.StatusTypes.UNKNOWN:
                        return {
                            type: n.GROUP, key: t, id: t, get title() {
                                switch (t) {
                                    case A.StatusTypes.ONLINE:
                    ...
                    default:
                        ...
                        return {
                            type: n.GROUP, key: t, id: t, title: null != i ? i.name : "", count: l, index: s
                        }
                }
            }

            function M(e, t, l) {
                let s = l === E.default.getId(),
                    a = I.default.isMobileOnline(l),
                    i = s ? S.default.getStatus() : I.default.getStatus(l, e),
                    r = s ? S.default.getActivities() : I.default.getActivities(l, e),
            ...
            }(s = n || (n = {})).GROUP = "GROUP", s.MEMBER = "MEMBER";
            class O {
                updateOwnerId() {
                ...
                invalidate(e) {
                    ...
                    for (let e = t; e <= l; e++) {
                        let t = this.rows[e];
                        if (null == t) break;
                        delete this.rows[e], t.type === n.MEMBER && delete this.members[t.user.id]
                    }
                    this.version++
                }
                insert(e, t) {
                ...
                update(e, t) {
                    ...
                    if (null != a && a.type === n.MEMBER && delete this.members[a.user.id], null != l) this.rows[e] = N(this.guildId, l.id, l.count);
                    else if (null != s) {
                        let t = M(this.guildId, this.ownerId, s.user.id);
                        if (null == t) return;
                        this.rows[e] = t, this.members[s.user.id] = t
                    }
                    this.version++
                }
                delete(e) {
                    let t = this.rows[e];
                    null != t && (t.type === n.MEMBER && delete this.members[t.user.id], this.rows.splice(e, 1), this.version++)
                }
                rebuildMember(e) {
        ...
        313873: function(e, t, l) {
            ...
            var n, s, a = l("37983"),
                ...
                U = l("782340"),
                F = l("843616");
            (s = n || (n = {})).USER_POPOUT = "UserPopout", s.USER_POPOUT_V2 = "UserPopoutV2", s.ACTIVITY_FEED = "ActivityFeed", s.PROFILE = "Profile", s.PROFILE_V2 = "ProfileV2", s.STREAM_PREVIEW = "StreamPreview", s.VOICE_CHANNEL = "VoiceChannel";
            let w = {
                    [n.STREAM_PREVIEW]: [108, 60],
                    [n.USER_POPOUT]: [108, 60],
                    [n.USER_POPOUT_V2]: [108, 60],
                    [n.VOICE_CHANNEL]: [108, 60],
                    [n.PROFILE]: [162, 90],
                    [n.PROFILE_V2]: [162, 90],
                    [n.ACTIVITY_FEED]: [900, 500]
                },
                {
                    getAssetImage: G
                } = l("550368"),
            ...
            class Y extends i.PureComponent {
                ...
                isStreamerOnTypeProfile() {
                    return (0, g.default)(this.activity) && (this.props.type === n.PROFILE || this.props.type === n.PROFILE_V2)
                }
                isStreamerOnTypeActivityFeed() {
                    return (0, g.default)(this.activity) && this.props.type === n.ACTIVITY_FEED
                }
                renderHeader(e) {
                    var t;
                    let l;
                    ...
                    return null != r && (l = r.name), (0, a.jsxs)("div", {
                        ...
                        children: [null != r && null !== E ? (0, a.jsx)(E, {
                            ...
                            color: d === n.PROFILE_V2 ? "header-primary" : void 0,
                ...
                renderGameImage(e) {
                    ...
                    return null != e.assets || (0, h.default)(e) || e.type !== D.ActivityTypes.PLAYING || l === n.ACTIVITY_FEED || t.bot ? null : null == s && null != i ? (0, a.jsx)("div", {
                ...
                renderTimeBar(e) {
                    ...
                    return null == l || null == s ? null : (0, a.jsx)(y.default, {
                        start: l,
                        end: s,
                        className: this.getTypeClass("timeBar"),
                        themed: this.props.type === n.VOICE_CHANNEL || this.props.type === n.USER_POPOUT || this.props.type === n.USER_POPOUT_V2 || this.props.type === n.PROFILE_V2
                    })
                }
                renderState(e, t) {
                    var l, n;
                ...
                render() {
                    ...
                    let u = t === n.USER_POPOUT || t === n.USER_POPOUT_V2,
                        d = t === n.PROFILE || t === n.PROFILE_V2,
                        c = t === n.ACTIVITY_FEED,
                        f = t === n.STREAM_PREVIEW,
                        m = !1;
                    ...
                    return (0, a.jsxs)("div", {
                        className: o(this.getTypeClass("activity"), s),

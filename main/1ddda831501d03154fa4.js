    ...
    ["11033"], {
        ...
        123377: function(e, t, n) {
            ...
            function A(e) {
                ...
                let {
                    ...
                    disableCopy: C,
                    showCopyIcon: N
                } = e, [g, v] = s.useState(0), [I, p] = s.useState(!1), [M, O] = s.useState(!1);
                ...
                let h = [T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_1, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_2, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_3, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_4, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_5, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_6, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_7, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_8, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_9, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_10, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_11],
                    U = Math.min(Math.max(g - 1, 0), h.length - 1),
                    R = null !== (t = h[U]) && void 0 !== t ? t : h[0],
                    P = g >= h.length - 1,
                    ...
                    D = e => {
                        (0, E.copy)(r), f.default.track(_.AnalyticEvents.TEXT_COPIED, {
                            type: A
                        }), "function" == typeof e && e(), !M && v(g + 1), O(!0), p(!0), l.start(1e3, () => O(!1)), a.start(2e3, () => v(0))
                    };
        ...
        935409: function(e, t, n) {
            ...
            function B(e) {
                ...
                } = e, s = (0, u.useStateFromStores)([p.default], () => p.default.getUserProfile(t.id), [t]), r = (0, u.useStateFromStores)([S.default], () => S.default.getGuild(n), [n]), d = (0, E.useClydeProfilesEnabled)(r);
                return (0, l.jsxs)(l.Fragment, {
                    children: [(null == s ? void 0 : s.profileFetchFailed) && (!t.isClyde() || d) && (0, l.jsx)(c.Tooltip, {
                        ...
                        className: i ? j.profileBadgesCompactNoTouch : j.profileBadges,
                        user: t,
                        guildId: n,
                        isTryItOutFlow: a,
            ...
            function Y(e) {
                let {
                    ...
                    profileTheme: B
                } = a.useContext(R.UserProfileContext), Y = a.useContext(g.AnalyticsContext), k = t.isNonUserBot() && !t.isClyde(), z = v.default.isPremiumAtLeast(null == n ? void 0 : n.premiumType, D.PremiumTypes.TIER_2), V = a.useMemo(() => (0, _.shouldDisableUserPresenceInChannel)(t, S), [t, S]), W = C || t.isClyde(), {
                ...
                }).with(L.UserProfileTypes.POMELO_POPOUT, () => j.avatarPositionPomelo).with(L.UserProfileTypes.PANEL, () => j.avatarPositionPanel).exhaustive();
                return (0, l.jsx)(l.Fragment, {
                    children: (0, l.jsxs)(c.Clickable, {
                        className: s({
                            [j.clickable]: !W,
                            [j.avatarWrapperNonUserBot]: k,
                            [j.avatarWrapperNormal]: !k
                        }, $),
            ...
            function k(e) {
                let {
                    ...
                    upsell: S
                } = e, C = (0, u.useStateFromStores)([m.default], () => m.default.getCurrentUser()), N = (0, u.useStateFromStores)([A.default], () => A.default.getTryItOutProfileEffectID()), g = null;
                return _ && t.id === (null == C ? void 0 : C.id) && null != N && (g = N), null === g && (g = null == n ? void 0 : n.profileEffectID), (0, l.jsxs)(l.Fragment, {
                    children: [S, (0, l.jsx)(O.default, {
                        user: t,
                        displayProfile: n,
                        onClose: s,
                        guildId: a,
        ...
        369869: function(e, t, n) {
            ...
            function N(e) {
                let {
                    ...
                    location: M
                } = (0, u.useAnalyticsContext)(), O = (0, s.useStateFromStores)([o.default], () => o.default.getCurrentUser()), h = f.default.canUsePremiumGuildMemberProfile(O);
                    ...
                    children: [(0, l.jsxs)(r.Heading, {
                        ...
                        children: [S.default.Messages.USER_POPOUT_ABOUT_ME, null != t && N && (0, l.jsx)(r.Tooltip, {
                            ...
                            children: e => (0, l.jsx)(c.default, {
                                ...
                                onClick: () => {
                                    var t;
                                    null == (t = e.onClick) || t(), null != O && !h && (0, r.openModalLazy)(async () => {
                                        let {
                                            default: e

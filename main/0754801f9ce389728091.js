    ...
    ["43870"], {
            ...
            var n = r("884691"),
                ...
                T = t => {
                    let {
                        ...
                        isTryItOut: d
                    }), O = f && (S || !I && !T), R = E && void 0 !== N && void 0 !== A && A === (null == e ? void 0 : e.id) ? N : null != v ? v : null == e ? void 0 : e.avatarDecoration, g = n.useMemo(() => (0, s.getAvatarDecorationURL)({
        ...
        853987: function(t, e, r) {
            ...
            var v = new A(l.default, {
                ...
                COLLECTIBLES_CATEGORIES_FETCH_SUCCESS: t => {
                    0 === t.categories.length ? (_ = c, S = T, C = E, I = d) : !(0, i.isEqual)([..._.values()], t.categories) && (_ = new Map(t.categories.map(t => [t.skuId, t])), S = new Map((0, s.getProductsFromCategories)(_).map(t => [t.skuId, t])), C = t.categories.reduce((t, e) => (e.products.forEach(r => {
                        t[r.skuId] = e.skuId
                ...
                LOGOUT: t => {
                    _ = c, S = T, C = E, I = d, o = void 0, f = !1, n = void 0
                }
            })
        },
        491232: function(t, e, r) {
            ...
            let T = t => (null == t ? void 0 : t.skuId) === o.CollectiblesCategorySkuId.DISXCORE,
                E = t => (null == t ? void 0 : t.purchaseType) === c.EntitlementTypes.PREMIUM_PURCHASE,
                d = (t, e) => {
                    let r = _(t, e ? c.PriceSetAssignmentPurchaseTypes.PREMIUM_TIER_2 : c.PriceSetAssignmentPurchaseTypes.DEFAULT);
                ...
                C = (t, e) => {
                    ...
                    if (e === i.CollectiblesItemType.PROFILE_EFFECT) {
                        let e = (0, n.flatMap)([...t.values()], "items").filter(s.isProfileEffectRecord);
                        return (0, n.uniqBy)(e, "id")
                    }
                },
                I = (t, e) => {
                    ...
                    if (e === i.CollectiblesItemType.PROFILE_EFFECT) {
                        let t = (0, n.flatMap)(r, "items").filter(s.isProfileEffectRecord);
                        return (0, n.uniqBy)(t, "id")
                    }
                },
                ...
                v = (t, e) => {
                    ...
                    if (null != n) return "".concat(location.protocol, "//").concat(n, "/app-assets/").concat(c.COLLECTIBLES_APPLICATION_ID, "/").concat(t, ".").concat(a, "?size=").concat(i);
                    let l = c.Endpoints.APPLICATION_ASSET(c.COLLECTIBLES_APPLICATION_ID, t, a);
        ...
        91653: function(t, e, r) {
            ...
            var n = r("884691"),
                ...
                c = t => {
                    ...
                    } = t, c = (0, o.default)([l.default], () => l.default.getCurrentUser()), T = (0, i.default)(r), {
                        pendingAvatar: E,
                    ...
                    })), _ = (0, n.useCallback)(t => (0, u.setNewPendingAvatar)(t, null == c ? void 0 : c.avatar), [null == c ? void 0 : c.avatar]), S = (0, n.useCallback)(t => {
                        (0, u.setNewPendingAvatarDecoration)(t, null == c ? void 0 : c.avatarDecoration), null != t && T(t)
        ...
        790618: function(t, e, r) {
            "use strict";
            let n, o, i, u, a, l, s, c, T, E, d, _, S, C;
            r.r(e), r.d(e, {
                default: function() {
                    return y
                }
            ...
            function L() {
                a = void 0, l = void 0, s = void 0, c = void 0, T = void 0, u = void 0
            }
            ...
            class F extends f.default.Store {
                ...
                showNotice() {
                    return void 0 !== n || void 0 !== a || void 0 !== l || void 0 !== s || void 0 !== c || void 0 !== T || void 0 !== i || void 0 !== u || void 0 !== o
                }
                getPendingAvatar() {
                    return n
                }

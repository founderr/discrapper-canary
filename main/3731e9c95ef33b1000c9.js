            ...
            function b(e) {
                ...
                ! function(e, t, l, n) {
                    if (S.isPlatformEmbedded) I.default.inputEventRegister(parseInt(e), t, l, n);
                        ...
                        n.keyup && i.bindGlobal((0, f.toString)(t), () => l(!1), "keyup"), n.keydown && i.bindGlobal((0, f.toString)(t), () => l(!0), "keydown"), v[e] = i
                    }
                }(i, t, e => (function(e, t) {
                    let l = p[e];
        ...
        860957: function(e, t, l) {
            ...
            function q(e, t) {
                ...
                if ((null === l || n === l) && n !== t) {
                    ...
                    x.delete(e), Q.info("pid=".concat(e, " status transition ").concat(null != n ? n : "DISCONNECTED", " -> ").concat(null != t ? t : "DISCONNECTED")), M = Array.from(m.values()).some(e => "READY" === e)
                }
            }
            async function Z(e) {
            ...
            async function J(e) {
                ...
                null == n ? (q(e, "CONNECTING", "ATTACHING"), await Z(l), l.connectProcess(e)) : (q(e, "HOOK_FAILED", "ATTACHING"), Q.warn("Could not hook to pid=".concat(e, ", error=").concat(n)))
            }
            async function $(e) {
                if (!m.has(e)) {
            ...
            async function et() {
                ...
                switch (null == e && (e = V && W ? v.default.getOverlayEligiblePIDs() : []), w) {
                    case U.OverlayMethod.Global:
                        var t, l, n, a, i, o, E, d, r, _, u, c, s, O, A, S;
                        let I = v.default.getVisibleGame(),
                            f = -1 !== e.indexOf(null !== (t = null == I ? void 0 : I.pid) && void 0 !== t ? t : -1);
                        if (null != I && f) {
                            let e = I.pid;
                            F !== e && await (null === T.default || void 0 === T.default ? void 0 : null === (r = T.default.globalOverlay) || void 0 === r ? void 0 : null === (d = r.closeOverlay) || void 0 === d ? void 0 : d.call(r)), F = e;
                            let t = await en();
                            try {
                                t += "&pid=".concat(e), await (null === T.default || void 0 === T.default ? void 0 : null === (u = T.default.globalOverlay) || void 0 === u ? void 0 : null === (_ = u.openOverlay) || void 0 === _ ? void 0 : _.call(u, t))
                            } catch (e) {
                                Q.log("globalOverlay: Failed to open overlay: ".concat(e), e)
                            }
                            let s = null !== (c = await (null === T.default || void 0 === T.default ? void 0 : null === (n = T.default.globalOverlay) || void 0 === n ? void 0 : null === (l = n.getWindowHandles) || void 0 === l ? void 0 : l.call(n))) && void 0 !== c ? c : [];
                            null === (a = (i = g.default.getDiscordUtils()).globalOverlaySetWindowHandles) || void 0 === a || a.call(i, s);
                            null === (o = (E = g.default.getDiscordUtils()).globalOverlaySetTrackedGame) || void 0 === o || o.call(E, I.pid, I.windowHandle, () => {
                                var t;
                                eo(e), null === T.default || void 0 === T.default || null === (t = T.default.globalOverlay) || void 0 === t || t.showOverlay()
                            }, () => {
                                var e;
                                eo(0), null === T.default || void 0 === T.default || null === (e = T.default.globalOverlay) || void 0 === e || e.hideOverlay()
                            }, () => {
                                var e;
                                ...
                                if (K === e) {
                                    var t;
                                    null === T.default || void 0 === T.default || null === (t = T.default.globalOverlay) || void 0 === t || t.showOverlay()
                                }
                            })
                        } else await (null === T.default || void 0 === T.default ? void 0 : null === (O = T.default.globalOverlay) || void 0 === O ? void 0 : null === (s = O.closeOverlay) || void 0 === s ? void 0 : s.call(O)), null === (A = (S = g.default.getDiscordUtils()).globalOverlayClearTrackedGame) || void 0 === A || A.call(S), F = null;
                        break;
            ...
            let ea = (() => {
                ...
                ei = j(b, async e => {
                    ...
                    if (V) await Z(t), el();
                        ...
                        var l, n;
                        await ee(), await Z(t), await (null === T.default || void 0 === T.default ? void 0 : null === (n = T.default.globalOverlay) || void 0 === n ? void 0 : null === (l = n.closeOverlay) || void 0 === l ? void 0 : l.call(n))
                    }
                });
            ...
            function eE(e, t, l) {
                ...
                }), p.default.track(G.AnalyticEvents.OVERLAY_HOOK_RESULT, o), Q.info("Overlay connection to ".concat(e, " ").concat(t ? "succeeded" : "failed"), o), t ? q(e, "CONNECTED", "CONNECTING") : q(e, "CONNECT_FAILED", "CONNECTING")
            }
            ...
            async function e_(e) {
                var t, l, n, a, i, o;
                let E = await ea();
                null != K && K !== P.DEV_PID && E.sendCommand(K, {
            ...
            function eA(e) {
                switch (0, e.type) {
                    case G.OverlayEventTypes.CONNECT:
                        ...
                        if (null == t) break;
                        (0, c.createLayout)(P.OVERLAY_LAYOUT_ID, R.default.getDefaultLayout(P.OVERLAY_LAYOUT_ID)), Promise.all([(0, L.default)(t, e.pid), d.default.PersistedStore.getAllStates()]).then(t => {
                            let [l, n] = t, {
                                pid: a,
                                token: i
                            } = e;
            ...
            let eS = new Promise(e => {
                f.default.subscribe({
                    ...
                    null != t && t.useGlobalOverlay && H.add(U.OverlayMethod.Global), w = N.OverlayStoredSettings.method, e()
                })
            });
            class eI extends d.default.Store {
                initialize() {
                    !(!U.OVERLAY_SUPPORTED || __OVERLAY__) && (H.add(U.OverlayMethod.Hook), this.waitFor(v.default, D.default), this.syncWith([v.default], er), S.setReceiveCommandHandler(eA, eT), D.default.addChangeListener(ed), eS.then(() => {
                        ei(N.OverlayStoredSettings.enabled), r.default.addInterceptor(es)
                    }))
                }
                isInputLocked(e) {
                    return !x.has(e)
            ...
            let ef = new eI(r.default, __OVERLAY__ ? {} : {
                ...
                OVERLAY_SET_METHOD: function(e) {
                    if (e.method !== w) return b(async () => {
                        await et([]), w = e.method, N.OverlayStoredSettings.update({
                            method: w
                        }), await et(), ef.emitChange()
                    }), !1
                },
                ...
                RPC_SERVER_READY: function(e) {
                    ...
                    a.append("build_id", "371931775875bad2befc968edb2ed2f0cefd9431"), a.append("rpc", String(t)), a.append("rpc_auth_token", k), n = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(a.toString())
                },

        ...
        943722: function(e, t, n) {
            ...
            var p = e => {
                ...
                let {
                    ...
                    hideEmoji: T = !1,
                    user: p
                } = e, M = null != n ? n.find(e => e.type === C.ActivityTypes.CUSTOM_STATUS) : null, h = null != n ? n.find(e => e.type === C.ActivityTypes.HANG_STATUS) : null, O = (0, r.useStateFromStores)([m.default, S.default], () => {
                    var e;
                    return null != h && null != p ? S.default.getChannel(null === (e = m.default.getVoiceStateForUser(p.id)) || void 0 === e ? void 0 : e.channelId) : null
                }), {
                    enableHangStatus: U
                } = E.HangStatusExperiment.useExperiment({
                    guildId: null !== (t = null == O ? void 0 : O.guild_id) && void 0 !== t ? t : "",
                    location: "ActivityStatus"
                }), R = null, P = U && null != h && A.default.can(C.Permissions.CONNECT, O);
                P ? R = (0, a.jsx)(_.default, {
                    className: u,
                    hangStatusActivity: h
                }) : null != M && null != M.emoji && !T && (R = (0, a.jsx)(v, {
                    emoji: M.emoji,
                    animate: o,
                    hideTooltip: f,
                    className: u
                }));
                let x = (0, c.default)(n, l, void 0, P),
                    L = null != x && x.length > 0;
                return null != R || L ? (0, a.jsxs)("div", {
                    className: i,
                    children: [R, (0, a.jsx)(I, {
                        text: x,
                        className: s
                    }), null != n && n.some(d.default) ? (0, a.jsx)(g.default, {
                        width: 16,
                        height: 16,
                        className: N.icon
                    }) : null]
        ...
        935409: function(e, t, n) {
            ...
            function Y(e) {
                let {
                    ...
                    hasProfileEffect: U
                } = e, B = (0, u.useStateFromStores)([m.default], () => m.default.getCurrentUser()), {
                    profileTheme: Y
                } = l.useContext(R.UserProfileContext), k = l.useContext(N.AnalyticsContext), z = t.isNonUserBot() && !t.isClyde(), V = v.default.isPremiumAtLeast(null == n ? void 0 : n.premiumType, D.PremiumTypes.TIER_2), W = l.useMemo(() => (0, _.shouldDisableUserPresenceInChannel)(t, S), [t, S]), Z = g || t.isClyde(), {
            ...
            function k(e) {
                let {
                    ...
                    upsell: S
                } = e, g = (0, u.useStateFromStores)([m.default], () => m.default.getCurrentUser()), C = (0, u.useStateFromStores)([A.default], () => A.default.getTryItOutProfileEffectID()), N = _ && t.id === (null == g ? void 0 : g.id) && null != C ? C : null == n ? void 0 : n.profileEffectID;
                return (0, a.jsxs)(a.Fragment, {
